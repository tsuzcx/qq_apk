...
public class adlh
{
  ...
  private static adlh jdField_a_of_type_Adlh;
  public static final String a;
  public static long b;
  public static final String b;
  public Handler a;
  public HandlerThread a;
  HashMap<String, adli> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public MqqHandler a;
  adlj[] jdField_a_of_type_ArrayOfAdlj = null;
  ...
  private adlh()
  {
    ...
    this.jdField_a_of_type_ArrayOfAdlj = new adlj[6];
    adlj[] arrayOfadlj = this.jdField_a_of_type_ArrayOfAdlj;
    int k = arrayOfadlj.length;
    i = j;
    while (i < k)
    {
      adlj localadlj = arrayOfadlj[i];
      localadlj = new adlj(this);
      localadlj.jdField_a_of_type_Int = 1;
      localadlj.jdField_a_of_type_Long = -1L;
      i += 1;
    }
  ...
  {
    if (jdField_a_of_type_Adlh == null) {}
    try
    {
      if (jdField_a_of_type_Adlh == null) {
        jdField_a_of_type_Adlh = new adlh();
      }
      return jdField_a_of_type_Adlh;
    }
    finally {}
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject1 = new adli(this);
      ((adli)localObject1).jdField_a_of_type_ArrayOfAdlk = new adlk[6];
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    Object localObject2 = (adli)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localObject2 == null)
    {
      paramQQAppInterface = new HashMap();
      paramQQAppInterface.put(BaseConstants.RDM_NoChangeFailCode, "");
      awrn.a(BaseApplication.getContext()).a(null, "pokeStrengthNullPoint", false, 0L, 0L, paramQQAppInterface, "");
      return 0;
    }
    Object localObject1 = ((adli)localObject2).jdField_a_of_type_ArrayOfAdlk;
    paramInt2 = ((adli)localObject2).jdField_a_of_type_Int;
    if (paramInt1 - 1 == -1) {
      paramInt1 = 0;
    }
    while ((paramInt1 >= 0) && (paramInt1 < 6))
    {
      ...
      {
        localObject1[paramInt1] = new adlk(this);
      ...
      if (paramInt3 != -1)
      {
        ...
        ((adli)localObject2).jdField_a_of_type_Int = paramInt1;
      ...
      else
      {
        ...
        {
          if (paramInt2 != -1) {
            awqx.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
          }
          localObject1[paramInt1].jdField_a_of_type_Long = l1;
          if (QLog.isColorLevel()) {
    ...
    {
      awqx.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
      ((adli)localObject2).jdField_a_of_type_Int = -1;
    }
    return 0;
  }
  ...
  public void a(View paramView)
  {
    ...
    Object localObject;
    if (adfq.class.isInstance(paramView))
    {
      localObject = (adfq)paramView;
      if (QLog.isColorLevel()) {
        QLog.d("GivingHeart", 2, new Object[] { "==>to be remove obj:", Integer.valueOf(((adfq)localObject).jdField_b_of_type_Int) });
      }
      if ((((adfq)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForPoke))
      {
        paramView = (MessageForPoke)((adfq)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if (adll.a(paramView.interactType)) {
          break label82;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        } while (!((adfq)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a());
        localObject = ((adfq)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a();
        paramView.mUnlimitedState.jdField_a_of_type_Int = ((aduf)localObject).jdField_a_of_type_Int;
        paramView.mUnlimitedState.jdField_b_of_type_Int = ((aduf)localObject).jdField_b_of_type_Int;
        paramView.mUnlimitedState.jdField_a_of_type_Long = ((aduf)localObject).jdField_a_of_type_Long;
        paramView.mFrameState.c = ((aduf)localObject).jdField_b_of_type_Boolean;
        paramView.mFrameState.jdField_a_of_type_Boolean = ((aduf)localObject).jdField_a_of_type_Boolean;
        return;
        localObject = ((adfq)localObject).jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getBackground();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new befq(Looper.getMainLooper(), paramFitSystemWindowsRelativeLayout);
  }
}
