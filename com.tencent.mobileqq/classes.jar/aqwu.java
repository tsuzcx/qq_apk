...
{
  aqwu(aqwl paramaqwl, aqwz paramaqwz) {}
  ...
  public void a(WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp paramCrossBidProxyCopyFileToOtherBidMsgRsp)
  {
    ...
    if (paramCrossBidProxyCopyFileToOtherBidMsgRsp.length() < 1)
    {
      ...
      if (this.jdField_a_of_type_Aqwz != null) {
        this.jdField_a_of_type_Aqwz.a(-3, "copyFileToOtherBid_fail");
      }
    }
    do
    {
    ...
    } while (this.jdField_a_of_type_Aqwz == null);
    this.jdField_a_of_type_Aqwz.a(paramCrossBidProxyCopyFileToOtherBidMsgRsp);
  }
}
