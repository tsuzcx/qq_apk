  ...
  extends ajiw
{
  ...
  public ajmu(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Bdvp = new ajmv(this);
  ...
  public void a(ajmw paramajmw)
  {
    this.jdField_a_of_type_Ajmw = paramajmw;
  }
  
  public void a(View paramView)
  {
    super.a(paramView);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131377827));
    this.jdField_a_of_type_ComTencentWidgetAlphaClickableRelativeLayout = ((AlphaClickableRelativeLayout)paramView.findViewById(2131376360));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376366));
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)paramView.findViewById(2131370819));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362206));
