...
public class ajmu
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbuv.a(ajsf.aW + "/.apollo");
    ...
    for (Object localObject = jdField_a_of_type_JavaLangString + "/shader_code_64/";; localObject = jdField_a_of_type_JavaLangString + "/shader_code/")
    {
      ...
      ((StringBuilder)localObject).append("?client=androidQQ").append("&version=").append("8.2.8.4440").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE);
      ...
      aC = ajyc.a(2131700309);
      aD = ajyc.a(2131700308);
