  ...
  extends BusinessHandler
{
  ...
  anzj(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (k == 0)
        {
          ...
          ((antl)this.app.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(k);
      ...
      try
      {
        ...
        ((bfgz)this.app.getManager(QQManagerFactory.MGR_TROOP_CREATE)).a(paramFromServiceMsg, false, paramToServiceMsg);
        bdla.b(this.app, "dc00899", "Grp_create_new", "", "suc_create", "face_create", 0, 0, "" + paramFromServiceMsg, "" + m, "", "");
