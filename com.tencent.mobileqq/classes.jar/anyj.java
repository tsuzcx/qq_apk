  ...
  extends ReportDialog
{
  ...
  public anyj(Activity paramActivity, MapView paramMapView, ARScanEntryView paramARScanEntryView)
  {
  ...
  private void a(aogp paramaogp)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, 2131368727);
    ...
    this.d = getLayoutInflater().inflate(2131560966, null);
    localObject1 = (TextView)this.d.findViewById(2131372800);
    Object localObject3 = (TextView)this.d.findViewById(2131365657);
    Object localObject2 = (TextView)this.d.findViewById(2131372799);
    ((TextView)localObject1).setText(amtj.a(2131699875));
    if (paramaogp.c < 1000)
    {
      ((TextView)localObject3).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131698017, new Object[] { String.valueOf(paramaogp.c) }));
      localObject3 = new StringBuilder().append(paramaogp.jdField_a_of_type_JavaLangString).append("|");
      if (!TextUtils.isEmpty(paramaogp.jdField_b_of_type_JavaLangString)) {
        break label550;
      }
      localObject1 = "";
      label204:
      localObject1 = (String)localObject1;
      if (TextUtils.isEmpty(paramaogp.jdField_a_of_type_JavaLangString)) {
        break label558;
      }
      localObject1 = new SpannableString((CharSequence)localObject1);
      ((SpannableString)localObject1).setSpan(new StyleSpan(1), 0, paramaogp.jdField_a_of_type_JavaLangString.length(), 17);
      ((TextView)localObject2).setText((CharSequence)localObject1);
    }
    for (;;)
    {
      this.d.setOnClickListener(new anyl(this));
      ...
      paramaogp = new LatLng(paramaogp.jdField_a_of_type_Int * 1.0D / 1000000.0D, paramaogp.jdField_b_of_type_Int * 1.0D / 1000000.0D);
      ((TencentMap)localObject1).moveCamera(CameraUpdateFactory.newLatLng(paramaogp));
      this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsMapView.getMap().addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromView(this.d)).position(paramaogp));
      ...
      {
        paramaogp = this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsMapView.getMap().getProjection();
        if ((paramaogp != null) && (((TencentMap)localObject1).getCameraPosition() != null))
        {
          localObject2 = paramaogp.toScreenLocation(((TencentMap)localObject1).getCameraPosition().target);
          ((Point)localObject2).offset(0, AIOUtils.dp2px(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * -1);
          ((TencentMap)localObject1).moveCamera(CameraUpdateFactory.newLatLng(paramaogp.fromScreenLocation((Point)localObject2)));
        }
      }
      ...
      return;
      float f = Math.round(paramaogp.c / 1000.0F * 100.0F) / 100.0F;
      ((TextView)localObject3).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131698015, new Object[] { String.valueOf(f) }));
      break;
      label550:
      localObject1 = paramaogp.jdField_b_of_type_JavaLangString;
      break label204;
      label558:
      ((TextView)localObject2).setText((CharSequence)localObject1);
    }
  ...
  private void c()
  {
    setContentView(2131560962);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131368727));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)findViewById(2131372802));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131372812));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378226));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131366599));
    this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)findViewById(2131372961));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131372962));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131373018));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131364624));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new anyk(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131365106));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131372804);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131363675);
    this.jdField_c_of_type_AndroidViewView = findViewById(2131370564);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131370563));
  ...
  public void a(aogp paramaogp, ArLBSActivity paramArLBSActivity)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ARLBSPOIDialog", 2, "bindView");
    }
    this.jdField_a_of_type_Aogp = paramaogp;
    ...
    if (!TextUtils.isEmpty(paramArLBSActivity.d))
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850605);
      ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850605);
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131699876));
    a(paramaogp);
  }
  ...
  public void b()
  {
    ...
    localAnimationSet.setFillAfter(true);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.startAnimation(localAnimationSet);
    localAnimationSet.setAnimationListener(new anym(this));
  }
