  ...
  extends lrp
{
  ...
  protected lrg a;
  protected lrj a;
  private lzw jdField_a_of_type_Lzw;
  ...
  public mdy(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString)
  {
    this(paramContext, paramVideoAppInterface, paramString, 0L);
  }
  
  public mdy(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong)
  {
    this(paramContext, paramVideoAppInterface, paramString, paramLong, true);
  }
  
  public mdy(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong, boolean paramBoolean)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Lqf = new lqf();
    this.t = AIOUtils.dp2px(6.0F, paramContext.getResources());
    this.u = AIOUtils.dp2px(10.0F, paramContext.getResources());
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture = new lrn(this.jdField_a_of_type_AndroidContentContext, this, paramString, paramLong);
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(new mdz(this, paramVideoAppInterface));
    }
  ...
  Bitmap a(Bitmap paramBitmap)
  {
    ...
    //   81: astore_1
    //   82: aload_0
    //   83: getfield 147	mdy:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   86: iconst_2
    ...
    //   118: astore_1
    //   119: aload_0
    //   120: getfield 147	mdy:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   123: iconst_2
  ...
  public mec a(lqb paramlqb)
  {
    ...
    for (;;)
    {
      if (i1 != 0)
      {
        ...
        {
          paramlqb = this.jdField_a_of_type_Lrf.a(paramlqb);
          i1 = this.jdField_a_of_type_Lrf.e();
          i2 = this.jdField_a_of_type_Lrf.f();
          this.jdField_a_of_type_Mec.a(paramlqb[0], i1, i2);
        ...
        if (!c())
        {
          ...
          label449:
          a(paramlqb, i1);
          paramlqb.a(i7 * 90, 0.0F, 0.0F, 1.0F);
          if (i2 == 0) {
            break label553;
          }
          this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqb, 0, 0, i5, i6);
        }
        for (;;)
        {
          paramlqb.c();
          ...
          this.jdField_a_of_type_Mec.a(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId(), i5, i6);
          return this.jdField_a_of_type_Mec;
          i1 = this.A;
          break;
          label548:
          ...
          break label449;
          label553:
          this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqb, 0, 0, i6, i5);
        }
      }
    }
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_c_of_type_Lre != null))
    {
      paramlqb = this.jdField_c_of_type_Lre.a(paramlqb);
      i1 = this.jdField_c_of_type_Lre.c();
      i2 = this.jdField_c_of_type_Lre.d();
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Mec.a(-1, 0, 0);
    return this.jdField_a_of_type_Mec;
  }
  ...
  {
    if (this.jdField_c_of_type_Lrf != null)
    {
      this.jdField_c_of_type_Lrf.a();
      this.jdField_c_of_type_Lrf = null;
    }
    this.jdField_c_of_type_Lrf = new lrf(mum.a(this.jdField_a_of_type_AndroidContentContext, paramInt1));
    this.jdField_c_of_type_Lrf.a(false);
    if (this.jdField_b_of_type_Lrf != null)
    {
      this.jdField_b_of_type_Lrf.a();
      this.jdField_b_of_type_Lrf = null;
    }
    this.jdField_b_of_type_Lrf = new lrf(mum.a(this.jdField_a_of_type_AndroidContentContext, paramInt2));
    this.jdField_b_of_type_Lrf.a(false);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (this.jdField_a_of_type_Lzw != null)
      {
        this.jdField_a_of_type_Lzw.a();
        this.jdField_a_of_type_Lzw = null;
      }
      return;
    }
    if (this.jdField_a_of_type_Lzw == null)
    {
      ...
      int i1 = b();
      int i2 = c();
      this.jdField_a_of_type_Lzw.a(i1);
      this.jdField_a_of_type_Lzw.b(i2);
    }
    this.jdField_a_of_type_Lzw.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  protected void a(lqb paramlqb, int paramInt)
  {
    if (this.jdField_d_of_type_Boolean)
    {
      if (paramInt % 2 == 0) {
        paramlqb.b(-1.0F, 1.0F, 1.0F);
      }
    }
    else {
      return;
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Lzw != null)
      {
        this.jdField_a_of_type_Lzw.a(paramInt1);
        this.jdField_a_of_type_Lzw.b(paramInt2);
      }
      return;
    }
    catch (Exception localException)
  ...
  public void b(Bitmap paramBitmap)
  {
    ...
    this.jdField_a_of_type_Lrf = new lrf(paramBitmap);
  }
  ...
  protected void c(lqb paramlqb)
  {
    ...
    paramlqb.a(-i1 / 2, -i2 / 2);
    if (this.jdField_p_of_type_Boolean)
    {
      this.jdField_a_of_type_Lqf.a(-9013642);
      if (localRect.left > 0)
      {
        this.jdField_a_of_type_Lqf.a(localRect.left);
        paramlqb.a(localRect.left / 2, 0.0F, localRect.left / 2, i2, this.jdField_a_of_type_Lqf);
      }
      if (localRect.top > 0)
      {
        this.jdField_a_of_type_Lqf.a(localRect.top);
        paramlqb.a(0.0F, localRect.top / 2, i1, localRect.top / 2, this.jdField_a_of_type_Lqf);
      }
      if (localRect.right > 0)
      {
        this.jdField_a_of_type_Lqf.a(localRect.right);
        paramlqb.a(i1 - localRect.right / 2, 0.0F, i1 - localRect.right / 2, i2, this.jdField_a_of_type_Lqf);
      }
      if (localRect.bottom > 0)
      {
        this.jdField_a_of_type_Lqf.a(localRect.bottom);
        paramlqb.a(0.0F, i2 - localRect.bottom / 2, i1, i2 - localRect.bottom / 2, this.jdField_a_of_type_Lqf);
      }
    }
    paramlqb.a(i1 / 2, i2 / 2);
    if (this.jdField_p_of_type_Boolean) {
      if (((!e()) || (!this.f)) && (this.jdField_a_of_type_Lre != null)) {
        this.jdField_a_of_type_Lre.a(paramlqb, 0, 0, i3, i4);
      }
    }
    do
    {
      ...
      paramlqb.a(0, 0, i3, i4, this.jdField_g_of_type_Int);
      return;
      if (((!e()) || (!this.f)) && (this.jdField_a_of_type_Lre != null))
      {
        this.jdField_a_of_type_Lre.a(paramlqb, 0, 0, i1, i2);
        return;
      }
    } while (this.jdField_m_of_type_Boolean);
    paramlqb.a(0.0F, 0.0F, i1, i2, this.jdField_g_of_type_Int);
  }
  ...
  protected void d(lqb paramlqb)
  {
    ...
    for (float f1 = f5;; f1 = f6)
    {
      ...
      if ((!this.jdField_m_of_type_Boolean) && (a(i8)))
      {
        ...
        paramlqb.a(2);
        a(paramlqb, i1);
        paramlqb.a(i8 * 90, 0.0F, 0.0F, 1.0F);
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a((int)this.jdField_c_of_type_AndroidGraphicsRectF.width());
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.b((int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        this.jdField_a_of_type_Lrf.a(paramlqb, i9, i10, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        if (QLog.isColorLevel())
        {
          if (this.jdField_a_of_type_Mea == null) {
            this.jdField_a_of_type_Mea = new mea();
          }
          localObject = this.jdField_a_of_type_Mea;
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        break label400;
        if ((this.jdField_a_of_type_Lzw != null) && (this.jdField_a_of_type_Lzw.f()))
        {
          paramlqb.a((4 - i7) * 90, 0.0F, 0.0F, 1.0F);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Lzw.a(paramlqb, i9, i10, i2, i3);
            break;
            i4 = i2;
            i2 = i3;
            i3 = i4;
        ...
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqb, i9, i10, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        break label601;
      }
      label1174:
      f4 = f5;
  ...
  protected void e(lqb paramlqb)
  {
    ...
    if (this.jdField_m_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Lzw.a(paramlqb, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
    for (;;)
    {
      paramlqb.c();
      lba.f(this.jdField_c_of_type_JavaLangString, "renderDoubleScreenOfPC:|" + b() + "|" + h() + "|" + i2 + "|" + i3 + "|" + i4 + "|" + i5 + "|" + this.jdField_b_of_type_AndroidGraphicsRectF.toString() + "|" + this.jdField_c_of_type_AndroidGraphicsRectF.toString());
      return;
      i1 = this.A;
      break;
      label398:
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqb, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
  }
  ...
  protected void f(lqb paramlqb)
  {
    ...
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_c_of_type_Lre != null))
    {
      ...
      i1 = super.b();
      i2 = super.c();
      i4 = this.jdField_c_of_type_Lre.c();
      i3 = this.jdField_c_of_type_Lre.d();
      if (i4 <= i1) {
        break label201;
      }
    }
    for (;;)
    {
      ...
      {
        paramlqb.a(2);
        this.jdField_c_of_type_Lre.a(paramlqb, 0, 0, i1, i2);
        paramlqb.c();
  ...
  protected void finalize()
  {
    try
    {
      if (this.jdField_d_of_type_Lre != null)
      {
        this.jdField_d_of_type_Lre.a();
        this.jdField_d_of_type_Lre = null;
      }
      ...
      if (this.jdField_c_of_type_Lre != null)
      {
        this.jdField_c_of_type_Lre.a();
        this.jdField_c_of_type_Lre = null;
      }
      if (this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture != null)
      {
      ...
      if (this.jdField_e_of_type_Lre != null)
      {
        this.jdField_e_of_type_Lre.a();
        this.jdField_e_of_type_Lre = null;
      }
  ...
  public void g(int paramInt)
  {
    if (this.jdField_p_of_type_Int != paramInt) {
      this.jdField_a_of_type_Lrg = new lrg(paramInt);
    }
  }
  
  protected void g(lqb paramlqb)
  {
    int i1;
    int i2;
    int i3;
    ...
    if (this.jdField_q_of_type_Boolean)
    {
      ...
      if (this.jdField_d_of_type_Lre != null)
      {
        ...
        i4 = localRect.left;
        i4 = localRect.bottom;
        this.jdField_d_of_type_Lre.a(paramlqb, 0, 0, i1 - i2 - i3, 36);
      }
      if (this.jdField_i_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Lrj.a();
        this.jdField_a_of_type_Lrj.a(this.jdField_a_of_type_JavaLangString);
        this.jdField_a_of_type_Lrj.a(this.jdField_h_of_type_Float);
        this.jdField_a_of_type_Lrj.c(this.jdField_n_of_type_Int);
        this.jdField_a_of_type_Lrj.d(this.jdField_o_of_type_Int);
        this.jdField_a_of_type_Lrj.e(super.b() - this.u);
        this.jdField_a_of_type_Lrj.e();
        this.jdField_i_of_type_Boolean = false;
      }
      if ((this.jdField_a_of_type_Lrj != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        i6 = super.b();
        i5 = super.c();
        i3 = this.jdField_a_of_type_Lrj.c();
        i4 = this.jdField_a_of_type_Lrj.d();
        if (!this.jdField_g_of_type_Boolean) {
          break label312;
        }
        i1 = this.u;
        i2 = i5 - this.jdField_a_of_type_Lrj.j() - this.t;
      }
    }
    for (;;)
    {
      ...
      i5 = (i4 - i5) / 2;
      paramlqb.a(i6, i5);
      this.jdField_a_of_type_Lrj.a(paramlqb, i1, i2, i3, i4);
      paramlqb.c();
      return;
      label312:
  ...
  {
    if ((this.jdField_l_of_type_Boolean) && (this.jdField_a_of_type_Lrg != null)) {
      this.jdField_a_of_type_Lrg.a(paramlqb, 0, 0, b(), c());
    }
  }
  ...
  protected void i(lqb paramlqb)
  {
    ...
    int i6;
    int i1;
    if ((this.jdField_q_of_type_Boolean) && (this.jdField_a_of_type_Lrj != null))
    {
      locallrf = null;
      if (this.jdField_q_of_type_Int != 2) {
        break label168;
      }
      locallrf = this.jdField_c_of_type_Lrf;
      if (locallrf != null)
      {
        i3 = super.b();
        i4 = super.c();
    ...
    for (int i2 = i4 - this.jdField_a_of_type_Lrj.j() - this.t + this.jdField_a_of_type_Lrj.k() - i6 + (i6 - this.jdField_a_of_type_Lrj.k()) / 2;; i2 = this.y + this.jdField_a_of_type_Lrj.k() - i6 + Math.abs((i6 - this.jdField_a_of_type_Lrj.k()) / 2))
    {
      paramlqb.a(3);
      paramlqb.a((i5 - i3) / 2, (i6 - i4) / 2);
      locallrf.a(paramlqb, i1, i2, i5, i6);
      paramlqb.c();
      return;
      label168:
      ...
      locallrf = this.jdField_b_of_type_Lrf;
      break;
      label185:
      i1 = AIOUtils.dp2px(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + this.jdField_a_of_type_Lrj.c() + this.u;
    }
  }
  ...
  public void j(boolean paramBoolean)
  {
    if (this.jdField_e_of_type_Boolean != paramBoolean)
    {
      ...
      if (this.jdField_c_of_type_Lre == null) {
        this.jdField_c_of_type_Lre = new lri(this.jdField_a_of_type_AndroidContentContext, 2130842317);
      }
      localGLRootView = a();
      if (localGLRootView != null) {
  ...
  public void m(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.z = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297911);
    }
  }
