...
public class aapl
  extends MqqHandler
{
  public aapl(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
    ...
    do
    {
      do
      {
        ...
        else
        {
          ...
          DiscussionInfoCardActivity.a(this.a).setText(ajjy.a(2131637556) + i + ajjy.a(2131637557));
          ...
          DiscussionInfoCardActivity.a(this.a, new aapm(this.a));
        ...
        for (;;)
        {
          removeMessages(0);
          return;
          this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetFollowImageTextView.setText(this.a.getString(2131628791));
          if (!AppSetting.c) {
            break;
          }
          this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetFollowImageTextView.setContentDescription(ajjy.a(2131637562) + this.a.getString(2131628791) + ajjy.a(2131637554));
          break;
