  ...
  extends aapy
{
  ...
  public aapl(aapz paramaapz, String paramString1, List<String> paramList, String paramString2, String paramString3)
  {
    super(paramaapz, paramString1, paramList);
    this.jdField_a_of_type_JavaLangString = paramString3;
    Object localObject;
    this.b = localObject;
    this.jdField_a_of_type_JavaUtilList = paramString2;
    this.jdField_a_of_type_Aapy = new aapw(paramaapz, paramString1, paramList);
  }
  
  public File a(File paramFile, String paramString, aapi paramaapi)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aapa.jdField_a_of_type_Zmn.a((String)localObject, paramFile.getAbsolutePath(), str3, i, j, new aaps(this, paramaapi, str3));
    }
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_JavaUtilList, str, new aapm(this, localaapk));
  }
  
  public void a(List<String> paramList, String paramString, aapi paramaapi)
  {
    if ((paramList == null) || (this.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      paramaapi.a(null, false, "videoFiles empty!");
      return;
    }
    if (paramList.size() == 1)
    {
      paramaapi.a((String)this.jdField_a_of_type_JavaUtilList.get(0), true, "combineVideos Success size = 1");
      return;
    }
    try
    {
      ...
      a(this.jdField_a_of_type_JavaUtilList, paramList.getAbsolutePath(), new aapq(this, l, paramaapi, paramList));
      return;
    }
  ...
  public void a(List<String> paramList, String paramString, aapv paramaapv)
  {
    ...
    this.jdField_a_of_type_Aapa.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        ((zmt)localObject4).jdField_a_of_type_Int = 5;
        ((zmt)localObject4).jdField_a_of_type_JavaUtilArrayList = new VideoCombineHelper.CombineTask.3(this, (String)localObject2, (String)localObject3);
        ((zmt)localObject4).jdField_a_of_type_Zmv = new aapr(this, paramaapv);
    ...
    paramString.jdField_a_of_type_Zmv = paramaapv;
    ((ArrayList)localObject1).add(paramString);
    if (this.jdField_a_of_type_Aapa.jdField_a_of_type_Zmn.a()) {
      try
      {
        this.jdField_a_of_type_Aapa.jdField_a_of_type_Zmn.b((ArrayList)localObject1);
        return;
      }
    ...
    try
    {
      this.jdField_a_of_type_Aapa.jdField_a_of_type_Zmn.a((ArrayList)localObject1);
      return;
    }
    catch (FFmpegCommandAlreadyRunningException paramList)
    {
  ...
  public boolean a(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      zkh.a(localBitmap, Bitmap.CompressFormat.PNG, 100, paramString2);
      zkh.a(localBitmap);
      bool = true;
    }
