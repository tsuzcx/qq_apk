...
{
  public adwt(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramCompoundButton == AuthDevActivity.a(this.a).a())
    {
      ...
      if (AuthDevActivity.a(this.a).a())
      {
        ...
        QQToast.a(this.a, this.a.getString(2131691989), 0).b(this.a.getTitleBarHeight());
      }
    }
    label127:
    do
    {
      do
      {
        ...
        bool = true;
        break;
        localObject = (aohe)this.a.app.a(34);
      } while (localObject == null);
      if (!AuthDevActivity.a(this.a).a()) {}
      for (bool = true;; bool = false)
      {
        ((aohe)localObject).a(bool);
        break;
      }
      if (paramCompoundButton == AuthDevActivity.b(this.a).a())
      {
        ...
        {
          localObject = "0";
          bdll.b(null, "dc00898", "", "", "0X800AC54", "0X800AC54", 0, 0, (String)localObject, "", "", "");
    ...
    {
      localObject = "1";
      bdll.b(null, "dc00898", "", "", "0X800AC53", "0X800AC53", 0, 0, (String)localObject, "", "", "");
      localObject = this.a.app;
      if (!paramBoolean) {
        break label484;
      }
      i = 1;
      bdll.b((QQAppInterface)localObject, "CliOper", "", "", "Setting_tab", "Mobile_pc_online", 0, i, "", "", "", "");
      if (!paramBoolean) {
        break label489;
      }
