...
public class bbxf
{
  ...
  public bbxf(Context paramContext, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131560472, paramViewGroup, false);
    e();
  ...
  private CharSequence a(String paramString1, String paramString2, int paramInt)
  {
    ...
    paramString2.setSpan(new bcmj(this.jdField_a_of_type_AndroidContentContext, 0, 20, 1, 7, 14, paramInt, paramString1), 0, paramString1.length(), 33);
    return paramString2;
  }
  ...
  private void a(String paramString)
  {
    ...
    paramString.setDownloadListener(new bbxi(this));
  ...
  private void e()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379429);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378654));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368752));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379418);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379034));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378718));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378914));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379419);
    this.e = this.jdField_a_of_type_AndroidViewView.findViewById(2131379421);
    this.f = this.jdField_a_of_type_AndroidViewView.findViewById(2131379431);
    this.g = this.jdField_a_of_type_AndroidViewView.findViewById(2131375845);
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView = ((SpriteVideoView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377248));
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    default: 
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView.getMeasuredHeight() > 0)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(a(alpo.a(2131713606), paramString.toString(), paramInt1));
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(a(alpo.a(2131713604), String.valueOf(paramInt2), paramInt1));
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_d_of_type_AndroidWidgetTextView.setText(a(alpo.a(2131713605), String.valueOf(paramInt3), paramInt1));
        if (this.g.getMeasuredHeight() != 0) {
          break label440;
        }
        this.g.getViewTreeObserver().addOnGlobalLayoutListener(new bbxh(this, paramBoolean));
      }
      break;
    }
    for (;;)
    {
      ...
      break;
      paramInt1 = paramString.getColor(2131167192);
      m = 2130843358;
      j = 2130843376;
      i = paramInt1;
      break;
      ...
      i = paramInt1;
      break;
      this.jdField_a_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bbxg(this, str2));
      break label168;
      label440:
  ...
  public void c()
  {
    ...
    if ((localObject1 instanceof QQAppInterface)) {
      bclv.a((QQAppInterface)localObject1, "qb_troop_hw_recite_result.mp4", "http://pub.idqqimg.com/pc/misc/files/20180312/59583551a1c748dfaae1e64f6e04ca20.mp4");
    }
