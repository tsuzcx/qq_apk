  ...
  extends Handler
{
  ...
  public aoch(MessageHandler paramMessageHandler, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void a(Message paramMessage)
  {
    synchronized (this.jdField_a_of_type_JavaUtilHashSet)
    {
      ...
      if ((paramMessage != null) && (paramMessage.containsKey("update_unread_uin")) && (paramMessage.containsKey("update_unread_time")))
      {
        ...
        this.jdField_a_of_type_JavaUtilHashSet.add(adak.a(str, i) + "&" + l);
      }
      return;
    }
  }
  ...
  void a(String paramString, int paramInt, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilHashSet)
    {
      if (this.jdField_a_of_type_JavaUtilHashSet.contains(adak.a(paramString, paramInt) + "&" + paramLong)) {
        this.jdField_a_of_type_JavaUtilHashSet.remove(adak.a(paramString, paramInt) + "&" + paramLong);
      }
      return;
    }
  }
  ...
  public boolean a(Message paramMessage)
  {
    synchronized (this.jdField_a_of_type_JavaUtilHashSet)
    {
      ...
      if ((paramMessage != null) && (paramMessage.containsKey("update_unread_uin")) && (paramMessage.containsKey("update_unread_time")))
      {
        ...
        int i = paramMessage.getInt("update_unread_type", 0);
        long l = paramMessage.getLong("update_unread_time");
        boolean bool = this.jdField_a_of_type_JavaUtilHashSet.contains(adak.a(str, i) + "&" + l);
        return bool;
      }
      return false;
    }
