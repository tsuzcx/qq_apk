...
public class adlq
{
  ...
  static void a(Activity paramActivity)
  {
    ...
    h(paramActivity);
    f(paramActivity);
    if (bhtb.b(paramActivity, "KEY_DELAY_LOAD_PROXY", true))
    {
      c(paramActivity);
      b(paramActivity);
    }
  ...
  private static void a(Activity paramActivity, ImageView paramImageView)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject instanceof aoot)) {
        ((aoot)localObject).b();
      }
  ...
  private static void a(View paramView)
  {
    ...
    //   5: aload_0
    //   6: aconst_null
    //   7: invokevirtual 353	android/view/View:setOnClickListener	(Landroid/view/View$OnClickListener;)V
    //   10: aload_0
    //   11: aconst_null
    //   12: invokevirtual 357	android/view/View:setOnCreateContextMenuListener	(Landroid/view/View$OnCreateContextMenuListener;)V
    //   15: aload_0
    //   16: aconst_null
    //   17: invokevirtual 361	android/view/View:setOnFocusChangeListener	(Landroid/view/View$OnFocusChangeListener;)V
    //   20: aload_0
    //   21: aconst_null
    //   22: invokevirtual 365	android/view/View:setOnKeyListener	(Landroid/view/View$OnKeyListener;)V
    //   25: aload_0
    //   26: aconst_null
    //   27: invokevirtual 369	android/view/View:setOnLongClickListener	(Landroid/view/View$OnLongClickListener;)V
    //   30: aload_0
    //   31: aconst_null
    //   32: invokevirtual 353	android/view/View:setOnClickListener	(Landroid/view/View$OnClickListener;)V
    //   35: aload_0
    //   36: aconst_null
    //   37: invokevirtual 373	android/view/View:setOnTouchListener	(Landroid/view/View$OnTouchListener;)V
    //   40: aload_0
    //   41: invokevirtual 376	android/view/View:getBackground	()Landroid/graphics/drawable/Drawable;
    //   44: astore_1
    //   45: aload_1
    //   46: ifnull +27 -> 73
    //   49: aload_1
    //   50: aconst_null
    //   51: invokevirtual 167	android/graphics/drawable/Drawable:setCallback	(Landroid/graphics/drawable/Drawable$Callback;)V
    //   54: aload_1
    //   55: instanceof 169
    //   58: ifeq +10 -> 68
    //   61: aload_1
    //   62: checkcast 169	aoot
    //   65: invokevirtual 171	aoot:b	()V
    //   68: aload_0
    //   69: aconst_null
    //   70: invokevirtual 379	android/view/View:setBackgroundDrawable	(Landroid/graphics/drawable/Drawable;)V
    //   73: aload_0
    //   74: invokevirtual 382	android/view/View:destroyDrawingCache	()V
    //   77: return
    //   78: astore_0
    ...
    //   94: new 349	java/lang/IncompatibleClassChangeError
    //   97: dup
    //   98: ldc_w 384
    ...
    //   108: checkcast 349	java/lang/IncompatibleClassChangeError
    //   111: checkcast 349	java/lang/IncompatibleClassChangeError
    //   114: athrow
    //   115: astore_0
    ...
    //   131: new 349	java/lang/IncompatibleClassChangeError
    //   134: dup
    //   135: ldc_w 384
    ...
    //   145: checkcast 349	java/lang/IncompatibleClassChangeError
    //   148: checkcast 349	java/lang/IncompatibleClassChangeError
    //   151: athrow
    //   152: astore_0
    ...
    //   168: new 349	java/lang/IncompatibleClassChangeError
    //   171: dup
    //   172: ldc_w 384
    ...
    //   182: checkcast 349	java/lang/IncompatibleClassChangeError
    //   185: checkcast 349	java/lang/IncompatibleClassChangeError
    //   188: athrow
    //   189: astore_0
    ...
    //   205: new 349	java/lang/IncompatibleClassChangeError
    //   208: dup
    //   209: ldc_w 384
    ...
    //   219: checkcast 349	java/lang/IncompatibleClassChangeError
    //   222: checkcast 349	java/lang/IncompatibleClassChangeError
    //   225: athrow
    //   226: astore_0
    ...
    //   242: new 349	java/lang/IncompatibleClassChangeError
    //   245: dup
    //   246: ldc_w 384
    ...
    //   256: checkcast 349	java/lang/IncompatibleClassChangeError
    //   259: checkcast 349	java/lang/IncompatibleClassChangeError
    //   262: athrow
    //   263: astore_0
    ...
    //   279: new 349	java/lang/IncompatibleClassChangeError
    //   282: dup
    //   283: ldc_w 384
    ...
    //   293: checkcast 349	java/lang/IncompatibleClassChangeError
    //   296: checkcast 349	java/lang/IncompatibleClassChangeError
    //   299: athrow
    //   300: astore_0
    ...
    //   316: new 349	java/lang/IncompatibleClassChangeError
    //   319: dup
    //   320: ldc_w 384
    ...
    //   330: checkcast 349	java/lang/IncompatibleClassChangeError
    //   333: checkcast 349	java/lang/IncompatibleClassChangeError
    //   336: athrow
    //   337: astore_1
    //   338: goto -328 -> 10
    //   341: astore_1
  ...
  private static void a(android.widget.ListView paramListView)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 422	android/widget/ListView:getSelector	()Landroid/graphics/drawable/Drawable;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnull +8 -> 14
    //   9: aload_1
    //   10: aconst_null
    //   11: invokevirtual 167	android/graphics/drawable/Drawable:setCallback	(Landroid/graphics/drawable/Drawable$Callback;)V
    //   14: aload_0
    //   15: invokevirtual 426	android/widget/ListView:getAdapter	()Landroid/widget/ListAdapter;
    //   18: ifnull +8 -> 26
    //   21: aload_0
    //   22: aconst_null
    //   23: invokevirtual 430	android/widget/ListView:setAdapter	(Landroid/widget/ListAdapter;)V
    //   26: aload_0
    //   27: aconst_null
    //   28: invokevirtual 434	android/widget/ListView:setOnScrollListener	(Landroid/widget/AbsListView$OnScrollListener;)V
    //   31: aload_0
    //   32: aconst_null
    //   33: invokevirtual 438	android/widget/ListView:setOnItemClickListener	(Landroid/widget/AdapterView$OnItemClickListener;)V
    //   36: aload_0
    //   37: aconst_null
    //   38: invokevirtual 442	android/widget/ListView:setOnItemLongClickListener	(Landroid/widget/AdapterView$OnItemLongClickListener;)V
    //   41: aload_0
    //   42: aconst_null
    //   43: invokevirtual 446	android/widget/ListView:setOnItemSelectedListener	(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    //   46: return
    //   47: astore_0
    ...
    //   63: new 349	java/lang/IncompatibleClassChangeError
    //   66: dup
    //   67: ldc_w 384
    ...
    //   77: checkcast 349	java/lang/IncompatibleClassChangeError
    //   80: checkcast 349	java/lang/IncompatibleClassChangeError
    //   83: athrow
    //   84: astore_0
    ...
    //   100: new 349	java/lang/IncompatibleClassChangeError
    //   103: dup
    //   104: ldc_w 384
    ...
    //   114: checkcast 349	java/lang/IncompatibleClassChangeError
    //   117: checkcast 349	java/lang/IncompatibleClassChangeError
    //   120: athrow
    //   121: astore_0
    ...
    //   137: new 349	java/lang/IncompatibleClassChangeError
    //   140: dup
    //   141: ldc_w 384
    ...
    //   151: checkcast 349	java/lang/IncompatibleClassChangeError
    //   154: checkcast 349	java/lang/IncompatibleClassChangeError
    //   157: athrow
    //   158: astore_0
    ...
    //   174: new 349	java/lang/IncompatibleClassChangeError
    //   177: dup
    //   178: ldc_w 384
    ...
    //   188: checkcast 349	java/lang/IncompatibleClassChangeError
    //   191: checkcast 349	java/lang/IncompatibleClassChangeError
    //   194: athrow
    //   195: astore_0
    ...
    //   211: new 349	java/lang/IncompatibleClassChangeError
    //   214: dup
    //   215: ldc_w 384
    ...
    //   225: checkcast 349	java/lang/IncompatibleClassChangeError
    //   228: checkcast 349	java/lang/IncompatibleClassChangeError
    //   231: athrow
    //   232: astore_1
    //   233: goto -202 -> 31
    //   236: astore_1
  ...
  private static void a(com.tencent.widget.ListView paramListView)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 468	com/tencent/widget/ListView:getSelector	()Landroid/graphics/drawable/Drawable;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnull +8 -> 14
    //   9: aload_1
    ...
    //   11: invokevirtual 167	android/graphics/drawable/Drawable:setCallback	(Landroid/graphics/drawable/Drawable$Callback;)V
    //   14: aload_0
    //   15: invokevirtual 469	com/tencent/widget/ListView:getAdapter	()Landroid/widget/ListAdapter;
    //   18: ifnull +8 -> 26
    //   21: aload_0
    //   22: aconst_null
    //   23: invokevirtual 470	com/tencent/widget/ListView:setAdapter	(Landroid/widget/ListAdapter;)V
    //   26: aload_0
    //   27: aconst_null
    //   28: invokevirtual 473	com/tencent/widget/ListView:setOnScrollListener	(Lblih;)V
    //   31: aload_0
    //   32: aconst_null
    //   33: invokevirtual 476	com/tencent/widget/ListView:setOnItemClickListener	(Lbljm;)V
    //   36: aload_0
    //   37: aconst_null
    //   38: invokevirtual 479	com/tencent/widget/ListView:setOnItemLongClickListener	(Lbljn;)V
    //   41: aload_0
    //   42: aconst_null
    //   43: invokevirtual 482	com/tencent/widget/ListView:setOnItemSelectedListener	(Lbljo;)V
    //   46: return
    //   47: astore_0
    //   48: invokestatic 58	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   51: ifeq +12 -> 63
        ...
        if (localObject1 != null) {
          try
          {
            ...
            if (localObject1 != null)
            {
              ...
              Field localField3 = Class.forName("android.view.View").getDeclaredField("mContext");
              localField3.setAccessible(true);
              if ((localObject2 != null) && (localField3.get(localObject2) == paramActivity)) {
                localField1.set(localObject1, null);
              }
              if ((localObject3 != null) && (localField3.get(localObject3) == paramActivity))
              {
          ...
          catch (Throwable paramActivity)
          {
            ...
            bhtb.a(BaseApplicationImpl.sApplication, false, "KEY_ENABLE_MEMORY_LEAK", paramActivity);
          }
        }
      }
    }
