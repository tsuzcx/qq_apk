...
public class adlq
{
  ...
  WeakReference<adlk> jdField_a_of_type_JavaLangRefWeakReference;
  LinkedList<WeakReference<adlk>> jdField_a_of_type_JavaUtilLinkedList;
  ...
  public adlq()
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new adlr(this, Looper.getMainLooper());
    akoa.a().a(new adls(this));
  }
  
  public static adlq a()
  {
    return adlt.a;
  }
  ...
  public static void a(WeakReference<adlk> paramWeakReference)
  {
    if (!jdField_a_of_type_Boolean) {
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      adlk localadlk = (adlk)localWeakReference.get();
      if (localadlk != null)
      {
  ...
  public static void b(WeakReference<adlk> paramWeakReference)
  {
    if (!jdField_a_of_type_Boolean) {
      return;
    }
  ...
  public static void c(WeakReference<adlk> paramWeakReference)
  {
    if (!jdField_a_of_type_Boolean) {
      return;
    }
  ...
  private void d(WeakReference<adlk> paramWeakReference)
  {
  ...
  private void e(WeakReference<adlk> paramWeakReference)
  {
    if (paramWeakReference == null)
    {
  ...
  private void f(WeakReference<adlk> paramWeakReference)
  {
    if (paramWeakReference == null)
    {
  ...
  private void g(WeakReference<adlk> paramWeakReference)
  {
    if (paramWeakReference == null)
    {
