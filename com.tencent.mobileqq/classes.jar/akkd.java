  ...
  implements Manager
{
  ...
  private WeakReference<akkf> jdField_a_of_type_MqqUtilWeakReference;
  private WeakReference<akkg> b;
  
  public akkd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Akkf = new akke(this);
  ...
  private boolean a()
  {
    ...
    if ((akji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) && (localakji != null) && (1 == localakji.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
      return true;
    }
  ...
  public void a(int paramInt, apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    for (;;)
    {
      ...
      ((aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramSTPushMsgElem);
      ...
      if ((!TextUtils.isEmpty(str)) && (!str.equals(localObject))) {
        akji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, "apllo_redPack_action");
      }
      if ((TextUtils.isEmpty(str)) || (str.equals(paramSTPushMsgElem))) {
        break;
      }
      akji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSTPushMsgElem, "apllo_redPack_action");
      return;
  ...
  public void a(akkf paramakkf)
  {
    ...
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramakkf);
  }
  
  public void a(akkg paramakkg)
  {
    if (paramakkg == null)
    {
      this.b = null;
    ...
    this.b = new WeakReference(paramakkg);
  }
  ...
  public void a(ApolloActionPush paramApolloActionPush)
  {
    ...
    if (paramApolloActionPush.mWordShowType == 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        localObject2 = ((aleh)localObject1).a(localSpriteTaskParam.f);
        if (localObject2 == null) {
          break label253;
        }
        if (TextUtils.isEmpty(localSpriteTaskParam.jdField_c_of_type_JavaLangString)) {
          localSpriteTaskParam.jdField_c_of_type_JavaLangString = albu.a(((ApolloActionData)localObject2).bubbleText);
        }
      }
    }
    for (;;)
    {
      localObject1 = akwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        ((akwq)localObject1).a().a(localSpriteTaskParam);
      }
      ...
      ((aleh)localObject1).a((List)localObject2);
    }
  }
  ...
  public void a(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if ((a()) && ("tab_list_android_json_v665".equals(localObject1)))
          {
            ...
            if (m > i)
            {
              ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "onLinePush", 1);
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            if ((a()) && (amly.a().equals(localObject1)))
            {
              i = 0;
              localObject1 = new File(alef.av);
              if (!((File)localObject1).exists())
              {
                ...
                i = 1;
                localObject1 = alef.av + "base.zip";
                if (i != 0)
                {
                  localObject2 = new Bundle();
                  ((Bundle)localObject2).putLong("version", m);
                  akzg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, alef.at, (Bundle)localObject2, new amma());
                }
                if (!QLog.isColorLevel()) {
                  continue;
                }
              ...
              if ("apollo_thunder_json_v670".equals(localObject1)) {
                albd.a(null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, false);
              }
            }
          }
        }
      ...
      for (;;)
      {
        try
        {
          ...
          l = ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(1, i) / 1000L;
          if (l != m) {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!akji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (localObject2 == null) || (1 != ((akji)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
          break;
        }
        i = Integer.parseInt(localException1);
        l = ((akji)localObject2).a(2, i) / 1000L;
        if (l != m) {
          akzg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, -1, new int[] { i }, -1, -1, true);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    if ((localObject2 != null) && (((List)localObject2).size() > 0))
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if (localSTPushMsgElem0x3.dotId.get() != 1003)
        {
          ...
          ((awbw)localObject1).b((awbv)localObject3);
          ...
          ApolloGameUtil.a((awbw)localObject1);
        }
        for (;;)
        {
          break;
          ...
          if (this.b != null)
          {
            ...
            if (this.b.get() != null)
            {
              ...
              {
                j = 2;
                ((akkg)this.b.get()).a(1, localObject3);
              }
            }
          }
          i = j;
      ...
      localObject1 = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (localObject1 != null) {
        ((aleh)localObject1).a(paramSTPushMsgElem, i);
      }
      for (;;)
      {
        ((alpr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(NetConnInfoCenter.getServerTimeMillis());
        return;
