...
public class bghk
{
  ...
  public static ArrayList<bghl> a(long paramLong, DataInputStream paramDataInputStream, int paramInt1, int paramInt2)
  {
                ...
                if (!TextUtils.isEmpty(localObject4))
                {
                  ...
                  if (l != -1L)
                  {
                    ...
                    if (localObject1 == null) {
                      localObject3 = new bghl();
                    }
                    ((bghl)localObject3).jdField_a_of_type_Long = paramLong;
                    ((bghl)localObject3).jdField_a_of_type_Int = paramInt2;
                    ((bghl)localObject3).b = l;
                    ((bghl)localObject3).jdField_a_of_type_JavaLangString = localObject4;
  ...
  public static ArrayList<bghl> a(long paramLong, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      ...
      while (j < k)
      {
        bghl localbghl = (bghl)localArrayList2.get(j);
        if (!localHashMap.containsKey(Long.valueOf(localbghl.b)))
        {
          localArrayList1.add(localbghl);
          localHashMap.put(Long.valueOf(localbghl.b), Boolean.valueOf(true));
        }
        j += 1;
      }
      i += 1;
