  ...
  extends BusinessHandler
{
  ...
  antw(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, long paramLong2, long paramLong3, long paramLong4)
  {
    ...
    localGetUserEqqListRequest.begin.set(bhbx.a(paramLong1));
    localGetUserEqqListRequest.limit.set(bhbx.a(paramLong2));
    localGetUserEqqListRequest.seqno.set(bhbx.a(paramLong3));
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      notifyUI(100, bool, localaoax);
      ((PublicAccountHandler)this.app.getBusinessHandler(BusinessHandlerFactory.HANDLER_PUBLIC_ACCOUNT)).notifyUI(100, true, localaoax);
      return;
      i = 0;
      continue;
      if (paramToServiceMsg.seqno.has())
      {
        ...
        bool = true;
        localaoax.jdField_a_of_type_Boolean = bool;
        paramObject = ((aoan)this.app.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(paramFromServiceMsg, l2);
        i = 0;
        paramFromServiceMsg = this.app.getProxyManager().a();
        ...
        else
        {
          ...
          if (!localaoax.jdField_a_of_type_Boolean) {
          ...
          if (paramToServiceMsg.ret_info.has())
          {
            ...
            if (i != 0)
            {
              ...
              if (paramFromServiceMsg.err_info.has())
              {
                ...
                i = paramToServiceMsg.seqno.get();
                aslc.a(this.app).a(this.app, paramFromServiceMsg, i, paramToServiceMsg);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   34: iconst_m1
    //   35: istore 4
    //   37: new 405	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse
    //   40: dup
    //   41: invokespecial 406	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse:<init>	()V
    //   44: astore_1
    //   45: aload_1
    //   46: aload_3
    //   47: checkcast 193	[B
    //   50: checkcast 193	[B
    //   53: invokevirtual 407	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   56: pop
    //   57: iload 4
    //   59: istore 5
    //   61: aload_1
    //   62: getfield 408	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse:ret_info	Lcom/tencent/crmqq/structmsg/StructMsg$RetInfo;
    //   65: invokevirtual 367	com/tencent/crmqq/structmsg/StructMsg$RetInfo:has	()Z
    //   68: ifeq +76 -> 144
    //   71: aload_1
    //   72: getfield 408	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse:ret_info	Lcom/tencent/crmqq/structmsg/StructMsg$RetInfo;
    //   75: invokevirtual 368	com/tencent/crmqq/structmsg/StructMsg$RetInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   78: checkcast 366	com/tencent/crmqq/structmsg/StructMsg$RetInfo
    //   81: astore_1
    //   82: aload_1
    //   83: getfield 369	com/tencent/crmqq/structmsg/StructMsg$RetInfo:ret_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   86: invokevirtual 214	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   89: ifeq +12 -> 101
    //   92: aload_1
    //   93: getfield 369	com/tencent/crmqq/structmsg/StructMsg$RetInfo:ret_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    ...
    //   112: istore 5
    //   114: aload_1
    //   115: getfield 373	com/tencent/crmqq/structmsg/StructMsg$RetInfo:err_info	Lcom/tencent/mobileqq/pb/PBStringField;
    //   118: invokevirtual 376	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   121: ifeq +23 -> 144
    //   124: aload_1
    //   125: getfield 373	com/tencent/crmqq/structmsg/StructMsg$RetInfo:err_info	Lcom/tencent/mobileqq/pb/PBStringField;
    //   128: invokevirtual 378	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   131: pop
    //   132: iload 4
    //   134: ifne -111 -> 23
    //   137: return
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, mqq.observer.BusinessObserver paramBusinessObserver)
  {
    ...
    {
      long l = Long.valueOf(paramString).longValue();
      paramString = new NewIntent(this.app.getApplication().getApplicationContext(), oln.class);
