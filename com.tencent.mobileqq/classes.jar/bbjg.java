...
public abstract class bbjg
{
  ...
  protected void a(ToServiceMsg paramToServiceMsg, appy paramappy, Class<? extends MSFServlet> paramClass)
  {
    ...
    paramToServiceMsg = new PeakJceServiceBase.1(this, paramToServiceMsg, paramappy, paramClass);
  ...
  public void a(boolean paramBoolean, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Exception paramException)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: invokevirtual 204	bbjg:a	()Lcom/tencent/common/app/AppInterface;
    //   9: astore 8
    ...
    //   79: aload_0
    //   80: getfield 32	bbjg:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   83: fload 5
    //   85: f2d
    ...
    //   130: invokevirtual 250	bbjg:a	(Ljava/lang/String;)Laafe;
    //   133: astore 9
    //   135: iload_1
    //   136: ifeq +323 -> 459
    //   139: aload 9
    ...
    //   146: aload_2
    //   147: aload_3
    //   148: invokevirtual 253	aafe:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   151: aload 9
    //   153: aload_2
    //   154: aload_3
    //   155: invokevirtual 256	aafe:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)Ljava/lang/Object;
    //   158: astore 4
    //   160: aload_0
    //   161: aload_3
    //   162: invokevirtual 258	bbjg:a	(Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   165: aload 9
    //   167: ifnull -163 -> 4
    //   170: invokestatic 263	ampk:b	()Ljava/util/Map;
    //   173: aload_3
    ...
    //   387: aload_0
    //   388: getfield 32	bbjg:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   391: fload 5
    //   393: f2d
  ...
  public void b(ToServiceMsg paramToServiceMsg, appy paramappy, Class<? extends MSFServlet> paramClass)
  {
    int i = 1;
    AppInterface localAppInterface = a();
    Object localObject1 = paramToServiceMsg.getServiceCmd();
    aafe localaafe = a((String)localObject1);
    Object localObject2;
    int j;
    if (localaafe != null)
    {
      ...
      if (localaafe.a())
      {
        localObject2 = localaafe.a(paramToServiceMsg);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return;
          if (!localaafe.a(paramToServiceMsg, (UniPacket)localObject2)) {
            break label314;
          }
          paramToServiceMsg.putWupBuffer(((UniPacket)localObject2).encode());
          break;
        } while (localaafe == null);
        paramappy = new FromServiceMsg(localAppInterface.getCurrentAccountUin(), (String)localObject1);
        paramClass = (int[])ampk.a().get(localObject1);
