...
{
  public xqo(RecentItemBaseBuilder paramRecentItemBaseBuilder, int paramInt1, int paramInt2, int[] paramArrayOfInt1, int paramInt3, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (paramInt < paramArrayOfSwipRightMenuItem.length)
          {
            ...
            if ((j & 0xF) == 1)
            {
              paramArrayOfSwipRightMenuItem[paramInt].b = 0;
          ...
          if (i < paramArrayOfSwipRightMenuItem.length)
          {
            ...
            {
              paramArrayOfSwipRightMenuItem[i].b = 6;
              paramArrayOfSwipRightMenuItem[i].a = 1;
              paramInt = i + 1;
            }
          }
