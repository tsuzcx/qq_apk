  ...
  implements acpi
{
  private static void a(acnk paramacnk, MsgType0x210 paramMsgType0x210)
  {
    ...
    try
    {
      ...
      paramacnk.a().setDevLockIntent(paramMsgType0x210);
      paramacnk.a(8007, true, new Object[] { Boolean.valueOf(localRecommendDeviceLock.canCancel.get()), localRecommendDeviceLock.wording.get(), localRecommendDeviceLock.str_title.get(), localRecommendDeviceLock.str_second_title.get(), localRecommendDeviceLock.str_third_title.get(), localArrayList });
      return;
    }
    catch (Exception paramMsgType0x210)
    {
      ...
      paramacnk.a(8007, false, new Object[] { Boolean.valueOf(true), "" });
    }
  }
