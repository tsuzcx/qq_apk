  ...
  implements View.OnClickListener
{
  ...
  wuy jdField_a_of_type_Wuy;
  boolean jdField_a_of_type_Boolean;
  
  public xjw(@NonNull Context paramContext, String paramString, int paramInt, wuy paramwuy, boolean paramBoolean)
  {
    super(paramContext, 16973841);
    super.requestWindowFeature(1);
    super.setContentView(LayoutInflater.from(paramContext).inflate(2131561919, null));
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = xiz.a();
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Wuy = paramwuy;
    this.jdField_a_of_type_ComTencentMobileqqAppTroopManager = ((TroopManager)xiz.a().getManager(52));
    this.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  void a()
  {
    ((ElasticImageView)findViewById(2131364599)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)findViewById(2131381075));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView = ((LeftTabBarView)findViewById(2131378343));
    ...
    int i;
    if ((this.jdField_a_of_type_Wuy != null) && (this.jdField_a_of_type_Boolean))
    {
      if ((this.jdField_a_of_type_Wuy.a != null) && (!this.jdField_a_of_type_Wuy.a.isEmpty()))
      {
        ArrayList localArrayList2 = new ArrayList(this.jdField_a_of_type_Wuy.a.size());
        Iterator localIterator = this.jdField_a_of_type_Wuy.a.iterator();
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView.setOnTabChangeListener(new xjx(this));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setAdapter(new xjz(this, localArrayList1));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new xjy(this));
    ...
    for (;;)
    {
      yup.a("pub_control", "exp_list", 0, 0, new String[] { String.valueOf(i), "", "", this.jdField_a_of_type_JavaLangString });
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoMyVideoVisiblePersonPageView = new MyVideoVisiblePersonPageView(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      break;
      label438:
