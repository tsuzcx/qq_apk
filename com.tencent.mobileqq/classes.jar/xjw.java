  ...
  extends WebViewPlugin
{
  ...
  private static xjw jdField_a_of_type_Xjw;
  ...
  public static final void b()
  {
    ...
    if (!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_Xjw.callJs(jdField_a_of_type_JavaLangString, new String[] { String.valueOf(true) });
    }
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_AndroidHardwareSensorManager != null) && (this.jdField_a_of_type_Xjx != null))
    {
      this.jdField_a_of_type_AndroidHardwareSensorManager.unregisterListener(this.jdField_a_of_type_Xjx);
      this.jdField_a_of_type_Xjx = null;
    }
  ...
  public final boolean a(String paramString)
  {
    ...
    if (albg.a())
    {
      ...
      if (this.jdField_a_of_type_Xjx != null) {
        a();
      }
      this.jdField_a_of_type_Xjx = new xjx(this, (byte)3, paramString);
      if (!Build.MODEL.equalsIgnoreCase("Nexus 5X")) {
        break label194;
      }
      this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Xjx, (Sensor)localObject, 3);
      label141:
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      break;
      label194:
      this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Xjx, (Sensor)localObject, 1);
      break label141;
      label211:
