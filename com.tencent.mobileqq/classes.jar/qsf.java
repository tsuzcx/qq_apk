...
public class qsf
{
  ...
  private TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramBaseArticleInfo.mProteusTemplateBean != null) && (!((tmh)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory).a(paramBaseArticleInfo.mProteusTemplateBean))) {
          return paramBaseArticleInfo.mProteusTemplateBean;
        }
        if (this.jdField_a_of_type_Qoc == null) {
          return null;
        }
        JSONObject localJSONObject = this.jdField_a_of_type_Qoc.a(147, paramBaseArticleInfo);
        localTemplateBean = this.jdField_a_of_type_Qoc.a(147, localJSONObject);
        try
        {
  ...
  private void a(qfw paramqfw, VafContext paramVafContext)
  {
    paramVafContext = paramqfw.a();
    if (paramVafContext != null)
    {
      paramqfw = paramVafContext.b(paramqfw.g() + 1);
      if ((paramqfw != null) && (paramqfw.mProteusTemplateBean == null)) {
        paramqfw.mProteusTemplateBean = a(paramqfw);
      }
    }
  }
  ...
  private static void b(ProteusItemView paramProteusItemView)
  {
    ...
    do
    {
      ...
      if ((localContainer != null) && (localContainer.getVisibility() == 8))
      {
        ...
        AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("container.getVisibility() == View.GONE"));
      }
    ...
    AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("proteusItemView.getVisibility() == View.GONE"));
  }
  ...
  public int a()
  {
    if (b == 2147483647)
    {
      AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(anvx.a(2131703056)));
  ...
  public int a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(anvx.a(2131703057)));
      return 147;
    }
  ...
  public ProteusItemView a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        uda.a(str, (String)localObject3, "DynamicPTS.getView", l2 - l1);
        localObject1 = localObject2;
      }
      catch (Exception localException)
      {
        ...
        AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "getView:", new IllegalArgumentException(paramBaseArticleInfo.proteusItemsData, localException));
        continue;
      }
  ...
  public ProteusItemView a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    //   0: ldc_w 343
    //   3: iconst_1
    //   4: invokestatic 346	tmh:a	(Ljava/lang/String;Z)Ltmh;
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +64 -> 73
    //   12: aload_3
    //   13: aload_2
    //   14: invokevirtual 350	tmh:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   17: astore_2
    //   18: aload_1
    ...
    //   54: aconst_null
    //   55: aload_2
    //   56: invokestatic 355	piv:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   59: aload_3
    //   60: aload_2
    //   61: invokevirtual 359	com/tencent/biz/pubaccount/readinjoy/proteus/item/ProteusItemView:setTemplateBean	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   64: aload 4
    //   66: aload_1
    //   67: aload_2
    //   68: invokestatic 362	piv:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/core/VafContext;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   71: aload_3
    //   72: areturn
    //   73: aconst_null
    //   74: astore_2
    ...
    //   79: aconst_null
    //   80: astore_1
    //   81: getstatic 18	qsf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: aload_2
    //   86: iconst_0
    //   87: anewarray 4	java/lang/Object
    //   90: invokestatic 335	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   93: aload_1
    //   94: areturn
    //   95: astore_2
    //   96: aload_3
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, FaceDecoder paramFaceDecoder, szd paramszd, qfw paramqfw, int paramInt2)
  {
    blfz.a("DynamicPTS.bindData");
    long l1 = System.currentTimeMillis();
    ...
    if (qsh.a()) {
      qsh.a(jdField_a_of_type_JavaLangString, "[bindData] " + paramBaseArticleInfo + " adapterViewType: " + paramInt1);
    }
    Object localObject1 = localObject2;
    if (localObject2 != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        {
          blfz.a("DynamicPTS.bindData.reuseView");
          localObject1 = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
          if (localObject1 != null)
          {
            ((Container)localObject1).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841743));
            paramProteusItemView.d();
            paramProteusItemView.a((Container)localObject1);
            piv.a((Container)localObject1, null, localTemplateBean);
          }
          paramBaseArticleInfo.mProteusTemplateBean = localTemplateBean;
          localObject1 = null;
          blfz.a();
    ...
    if (localTemplateBean != null)
    {
      blfz.a("DynamicPTS.bindData.compareWithOldTemplateBean");
      piv.a((Container)localObject2, (TemplateBean)localObject1, localTemplateBean);
      blfz.a();
    }
    blfz.a("DynamicPTS.bindData.bindView");
    this.jdField_a_of_type_Qoc.a(paramInt1, (Container)localObject2, paramqfw, paramInt2);
    blfz.a();
    piv.a(paramInt1, paramProteusItemView, paramVafContext, paramFaceDecoder, paramszd, paramqfw, paramBaseArticleInfo);
    a(paramqfw, paramVafContext);
    piv.a((Container)localObject2, paramqfw, localTemplateBean);
    long l2 = System.currentTimeMillis();
    ...
    {
      uda.a(paramBaseArticleInfo, paramProteusItemView, "DynamicPTS.bindData", l2 - l1);
      blfz.a();
      return;
    }
  }
