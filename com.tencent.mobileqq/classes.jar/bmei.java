...
public class bmei
{
  ...
  public static PluginRecord a(File paramFile)
  {
    ...
    //   33: aload_0
    //   34: iconst_0
    //   35: invokestatic 112	bgku:decode	([BI)[B
  ...
  public static void a(Context paramContext, Map<String, PluginRecord> paramMap)
  {
    ...
    boolean bool = blfz.a((File)localObject);
  ...
  public static void a(Context paramContext, Map<String, PluginRecord> paramMap, bmdw parambmdw)
  {
      ...
      if (i < j)
      {
        ...
        if (localFile.exists())
        {
          ...
          if (localPluginRecord != null)
          {
            boolean bool = true;
            if (parambmdw != null) {
              bool = parambmdw.a(localPluginRecord, localFile);
            }
            if (!bool) {
              break label98;
            }
  ...
  private static boolean a(File paramFile, PluginRecord paramPluginRecord)
  {
    ...
    //   51: iconst_0
    //   52: invokestatic 355	bgku:encode	([BI)[B
    //   55: astore_1
  ...
  {
    return paramFile.listFiles(new bmej());
  }
