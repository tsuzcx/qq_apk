  ...
  extends anii
{
  ...
  public avsy(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        this.a.c(false, paramInt1, paramString);
        continue;
        if ((paramInt2 != 2) || (this.a == null)) {
          continue;
        }
        this.a.b(false, paramInt1, paramString);
        continue;
      }
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (this.a != null) {
          if (paramInt2 == 1) {
            ...
            this.a.a(false, new ListenTogetherSession(paramInt1, paramString), paramInt2, true);
          }
        }
      }
    }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localListenTogetherSession.jdField_g_of_type_Int = paramToServiceMsg.enum_aio_state.get();
          ...
          if (!TextUtils.isEmpty(localListenTogetherSession.f)) {
            localListenTogetherSession.jdField_g_of_type_JavaLangString = avtq.a(this.app, str, i, localListenTogetherSession.f);
          }
          localListenTogetherSession.h = paramToServiceMsg.enum_user_state.get();
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   1: ifnull +55 -> 56
    //   4: aload_1
    //   5: getfield 239	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   8: ldc_w 519
    //   11: invokevirtual 523	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   14: istore 8
    //   16: aload_1
    //   17: ifnull +11 -> 28
    //   20: aload_2
    ...
    //   25: ifnonnull +37 -> 62
    //   28: aload_0
    //   29: getfield 20	avsy:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   32: ifnull +14 -> 46
    //   35: aload_0
    //   36: getfield 20	avsy:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   39: iconst_0
    //   40: aconst_null
    //   41: iload 8
    //   43: invokevirtual 526	com/tencent/mobileqq/listentogether/ListenTogetherManager:a	(ZLjava/util/List;Z)V
    //   46: ldc 45
    //   48: iconst_1
    //   49: ldc_w 528
    ...
    //   63: istore 7
    //   65: aload_1
    //   66: getfield 239	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   69: ldc 241
    //   71: invokevirtual 324	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   74: istore 6
    //   76: aload_1
    //   77: getfield 239	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   80: ldc 249
    //   82: invokevirtual 328	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   85: astore 12
    //   87: aconst_null
    //   88: astore 11
    //   90: aconst_null
    ...
    //   102: istore 5
    //   104: aload_2
    //   105: invokevirtual 351	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   108: ifeq +383 -> 491
    //   111: aload 10
    //   113: astore 9
    //   115: iload 4
    //   117: istore 5
    //   119: new 530	tencent/aio/media/aio_media$RspSongExtendedInfo
    //   122: dup
    //   123: invokespecial 531	tencent/aio/media/aio_media$RspSongExtendedInfo:<init>	()V
    //   126: astore_2
    //   127: aload 10
    //   129: astore 9
    //   131: iload 4
    ...
    //   137: checkcast 358	[B
    //   140: checkcast 358	[B
    //   143: invokevirtual 532	tencent/aio/media/aio_media$RspSongExtendedInfo:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   146: pop
    //   147: aload 10
    //   149: astore 9
    //   151: iload 4
    //   153: istore 5
    //   155: aload_2
    //   156: getfield 533	tencent/aio/media/aio_media$RspSongExtendedInfo:msg_result	Ltencent/aio/media/aio_media$ResultInfo;
    //   159: invokevirtual 371	tencent/aio/media/aio_media$ResultInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   162: checkcast 368	tencent/aio/media/aio_media$ResultInfo
    //   165: astore_3
    //   166: aload_3
    //   167: ifnull +309 -> 476
    //   170: aload 10
    ...
    //   176: istore 5
    //   178: aload_3
    //   179: getfield 375	tencent/aio/media/aio_media$ResultInfo:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   182: invokevirtual 378	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   185: istore 4
    //   187: iload 4
    //   189: ifne +343 -> 532
    //   192: aload 10
    ...
    //   198: istore 5
    //   200: aload_2
    //   201: getfield 534	tencent/aio/media/aio_media$RspSongExtendedInfo:rpt_msg_song_list	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   204: invokevirtual 138	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   207: invokestatic 140	avsy:a	(Ljava/util/List;)Ljava/util/List;
    //   210: astore_2
    //   211: aload_2
    //   212: ifnull +14 -> 226
    //   215: aload_2
    ...
    //   223: ifne +259 -> 482
    //   226: new 92	java/util/ArrayList
    //   229: dup
    //   230: invokespecial 95	java/util/ArrayList:<init>	()V
    //   233: astore_3
    //   234: aload_3
    //   235: astore 9
    //   237: iload 4
    //   239: istore 5
    //   241: aload_1
    //   242: getfield 239	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   245: ldc_w 536
    //   248: invokevirtual 540	android/os/Bundle:getStringArrayList	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   251: astore_1
    //   252: aload_1
    //   253: ifnull +229 -> 482
    //   256: aload_3
    ...
    //   291: istore 5
    //   293: aload_1
    //   294: invokeinterface 553 1 0
    //   299: checkcast 62	java/lang/String
    //   302: astore_2
    //   303: aload_3
    //   304: astore 9
    //   306: iload 4
    //   308: istore 5
    //   310: new 109	com/tencent/mobileqq/listentogether/data/MusicInfo
    //   313: dup
    //   314: invokespecial 554	com/tencent/mobileqq/listentogether/data/MusicInfo:<init>	()V
    //   317: astore 10
    //   319: aload_3
    //   320: astore 9
    //   322: iload 4
    ...
    //   326: aload 10
    //   328: aload_2
    //   329: putfield 555	com/tencent/mobileqq/listentogether/data/MusicInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   332: aload_3
    //   333: astore 9
    //   335: iload 4
    //   337: istore 5
    ...
    //   365: ldc_w 557
    //   368: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   371: aload_2
    //   372: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   375: invokevirtual 165	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   378: invokestatic 70	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   381: goto -111 -> 270
    //   384: astore_1
    //   385: iload 5
    //   387: istore 4
    ...
    //   392: ldc_w 559
    //   395: aload_1
    //   396: invokestatic 284	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   399: invokestatic 43	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   402: ifeq +53 -> 455
    //   405: ldc 45
    //   407: iconst_2
    //   408: ldc_w 561
    //   411: iconst_5
    //   412: anewarray 49	java/lang/Object
    //   415: dup
    //   416: iconst_0
    //   417: iload 6
    //   419: invokestatic 60	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   422: aastore
    //   423: dup
    //   424: iconst_1
    //   425: aload 12
    ...
    //   429: iconst_2
    //   430: iload 7
    //   432: invokestatic 493	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   435: aastore
    //   436: dup
    //   437: iconst_3
    //   438: iload 4
    //   440: invokestatic 60	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   443: aastore
    //   444: dup
    //   445: iconst_4
    //   446: aload 9
    //   448: aastore
    //   449: invokestatic 66	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   452: invokestatic 70	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   455: aload_0
    //   456: getfield 20	avsy:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   459: ifnull -404 -> 55
    //   462: aload_0
    //   463: getfield 20	avsy:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   466: iload 7
    //   468: aload 9
    //   470: iload 8
    //   472: invokevirtual 526	com/tencent/mobileqq/listentogether/ListenTogetherManager:a	(ZLjava/util/List;Z)V
    //   475: return
    //   476: iconst_m1
    //   477: istore 4
    //   479: goto -292 -> 187
    ...
    //   502: ldc_w 563
    //   505: iconst_0
    //   506: anewarray 49	java/lang/Object
    //   509: invokestatic 66	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   512: invokestatic 70	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   515: iconst_m1
    //   516: istore 4
    //   518: aload 11
    //   520: astore 9
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg == null) || (paramObject == null))
    {
      ...
      for (;;)
      {
        ...
        label88:
        if (k == 2) {
          this.a.b(false, j, str);
        } else if (k == 3) {
          this.a.d(false, j, str);
        } else if (k == 4) {
          this.a.a(false, j, str, m);
        }
      }
    }
    bool = false;
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    this.a.a(false, paramToServiceMsg, i, true);
    return;
    label181:
    bool2 = false;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        ...
        this.a.a(bool1, (ListenTogetherSession)localObject, i, true);
        continue;
        paramToServiceMsg = "";
        continue;
      }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      this.a.a(false, new Object[] { Integer.valueOf(-1), "" });
      return;
    }
  ...
  public void a(int paramInt, String paramString, List<avtr> paramList, boolean paramBoolean)
  {
    if ((paramList == null) || (paramList.size() == 0))
    {
      if (this.a != null) {
        this.a.a(false, null, paramBoolean);
      }
    ...
    try
    {
      ...
      {
        avtr localavtr = (avtr)paramList.next();
        aio_media.SongExtendedReqParam localSongExtendedReqParam = new aio_media.SongExtendedReqParam();
        localSongExtendedReqParam.str_song_id.set(localavtr.jdField_a_of_type_JavaLangString);
        localSongExtendedReqParam.bool_need_lyric.set(localavtr.jdField_b_of_type_Boolean);
        localSongExtendedReqParam.bool_need_url.set(localavtr.jdField_a_of_type_Boolean);
        localArrayList2.add(localSongExtendedReqParam);
        localArrayList1.add(localavtr.jdField_a_of_type_JavaLangString);
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramFromServiceMsg != null)
        {
          ...
          this.a.a(true, paramFromServiceMsg);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        if (!paramFromServiceMsg.isSuccess())
        {
          this.a.b(false, new Object[] { Integer.valueOf(-1), "" });
          return;
        }
        ...
        if (paramToServiceMsg != null)
        {
          ...
          this.a.b(true, new Object[] { Integer.valueOf(j), paramFromServiceMsg, paramObject });
          return;
        }
      }
      catch (Exception paramToServiceMsg)
    ...
    this.a.b(false, new Object[] { Integer.valueOf(i), paramToServiceMsg });
  }
