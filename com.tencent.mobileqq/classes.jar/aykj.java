  ...
  extends BaseAdapter
{
  ...
  public aykj(List<AssociateSearchWordsFragment.AssociateItem> paramList)
  {
    Object localObject;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localObject2 = new aykl(this.jdField_a_of_type_ComTencentMobileqqSearchFragmentAssociateSearchWordsFragment);
      paramViewGroup = new LinearLayout((Context)localObject1);
      paramViewGroup.setPadding(bdaq.a((Context)localObject1, 12.0F), 0, bdaq.a((Context)localObject1, 12.0F), 0);
    ...
    default: 
      ...
      paramView.setBackgroundResource(2130841984);
      paramViewGroup = paramView;
      paramView = (aykl)paramViewGroup.getTag();
      switch (getItemViewType(paramInt))
      {
      default: 
        label192:
        if (bool) {
          paramViewGroup.setBackgroundResource(2130839209);
        }
        break;
      }
      break;
    ...
    for (;;)
    {
      paramViewGroup.setTag(2131379972, Integer.valueOf(paramInt));
      paramViewGroup.setTag(2131379971, localAssociateItem);
      return paramViewGroup;
      paramView = new TextView((Context)localObject1);
      paramView.setBackgroundColor(Color.parseColor("#F7F7F9"));
      paramView.setHeight(bdaq.a((Context)localObject1, 10.0F));
      Object localObject3 = new LinearLayout.LayoutParams(-1, -2);
      ((aykl)localObject2).c = paramView;
      paramViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject3);
      paramView = new TextView((Context)localObject1);
      paramView.setTextColor(((Context)localObject1).getResources().getColor(2131166977));
      ...
      paramView.setPadding(bdaq.a((Context)localObject1, 12.0F), 0, bdaq.a((Context)localObject1, 12.0F), 0);
      ...
      ((aykl)localObject2).a = paramView;
      paramView = paramViewGroup;
      break;
      paramView = new TextView((Context)localObject1);
      paramView.setGravity(19);
      paramView.setTextColor(((Context)localObject1).getResources().getColor(2131166903));
      label444:
      Object localObject4;
      if (getItemViewType(paramInt) == 5)
      {
        ...
        paramViewGroup.addView((View)localObject3, new LinearLayout.LayoutParams(-1, bdaq.a((Context)localObject1, 52.0F)));
        if (!ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, "")) {
          break label717;
        }
        localObject4 = ((Context)localObject1).getResources().getDrawable(2130849741);
        ((Drawable)localObject4).setColorFilter(BaseApplicationImpl.sApplication.getResources().getColor(2131166830), PorterDuff.Mode.SRC_ATOP);
        paramView.setCompoundDrawablesWithIntrinsicBounds((Drawable)localObject4, null, null, null);
        label562:
        paramView.setCompoundDrawablePadding(bdaq.a((Context)localObject1, 8.0F));
        ...
        ((ImageView)localObject4).setImageResource(2130849746);
        ((ImageView)localObject4).setColorFilter(BaseApplicationImpl.sApplication.getResources().getColor(2131166830));
        label648:
        ((LinearLayout)localObject3).addView((View)localObject4, new LinearLayout.LayoutParams(-2, -1));
        ((ImageView)localObject4).setOnClickListener(new aykk(this, localAssociateItem.jdField_a_of_type_JavaLangString, paramInt));
      }
      for (;;)
      {
        ((aykl)localObject2).a = paramView;
        ...
        break label444;
        label717:
        paramView.setCompoundDrawablesWithIntrinsicBounds(((Context)localObject1).getResources().getDrawable(2130849741), null, null, null);
        break label562;
        label737:
        ((ImageView)localObject4).setImageResource(2130849746);
        break label648;
        label748:
        paramView.setCompoundDrawablesWithIntrinsicBounds(((Context)localObject1).getResources().getDrawable(2130849740), null, null, null);
        paramView.setCompoundDrawablePadding(bdaq.a((Context)localObject1, 4.0F));
        localObject3 = new LinearLayout.LayoutParams(-1, -2);
        ((LinearLayout.LayoutParams)localObject3).setMargins(0, bdaq.a((Context)localObject1, 16.0F), 0, bdaq.a((Context)localObject1, 16.0F));
        paramViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject3);
      }
      paramView = new TextView((Context)localObject1);
      paramView.setTextColor(((Context)localObject1).getResources().getColor(2131166903));
      ...
      paramViewGroup.addView(paramView);
      paramViewGroup.setPadding(bdaq.a((Context)localObject1, 12.0F), 0, 0, 0);
      ((aykl)localObject2).c = paramView;
      paramViewGroup.setClickable(false);
      paramViewGroup.setFocusable(false);
      paramView = paramViewGroup;
      ...
      for (;;)
      {
        ...
        if (bool) {
          paramView.c.setBackgroundColor(((Context)localObject1).getResources().getColor(2131166843));
        } else {
          paramView.c.setBackgroundColor(((Context)localObject1).getResources().getColor(2131166842));
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqSearchFragmentAssociateSearchWordsFragment.b)
      {
        ...
        {
          localObject1 = ayvm.a(paramView.a, 2.147484E+009F, 1, localAssociateItem.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqSearchFragmentAssociateSearchWordsFragment.jdField_a_of_type_JavaLangString, false, false, true);
          paramView.a.setText((CharSequence)localObject1);
          break label192;
        }
        localObject1 = ayvm.a(localAssociateItem.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqSearchFragmentAssociateSearchWordsFragment.jdField_a_of_type_JavaLangString, false);
        paramView.a.setText((CharSequence)localObject1);
        break label192;
      }
      paramView.a.setText(localAssociateItem.jdField_a_of_type_JavaLangString);
      ...
      if (TextUtils.isEmpty(localAssociateItem.jdField_a_of_type_JavaLangString))
      {
        ...
        ((LinearLayout.LayoutParams)paramView.b.getLayoutParams()).setMargins(0, bdaq.a((Context)localObject1, 16.0F), 0, bdaq.a((Context)localObject1, 16.0F));
        break label192;
      }
      paramView.a.setVisibility(0);
      localObject2 = (LinearLayout.LayoutParams)paramView.a.getLayoutParams();
      ((LinearLayout.LayoutParams)localObject2).setMargins(0, bdaq.a((Context)localObject1, 12.0F), 0, 0);
      ...
      ((LinearLayout.LayoutParams)localObject2).setMargins(0, bdaq.a((Context)localObject1, 5.0F), 0, bdaq.a((Context)localObject1, 12.0F));
