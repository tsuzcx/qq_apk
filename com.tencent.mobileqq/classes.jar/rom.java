  ...
  implements View.OnClickListener
{
  ...
  private URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new ror(this);
  private URLImageView jdField_a_of_type_ComTencentImageURLImageView;
  public HotWordSearchEntryDataModel a;
  protected String a;
  private osp jdField_a_of_type_Osp = new ron(this);
  ...
  private ros jdField_c_of_type_Ros;
  
  public rom(Context paramContext)
  {
    this.jdField_a_of_type_Akjc = new roo(this);
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new rop(this);
    ...
    Object localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131377214);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView = ((ReadInJoyCapsuleView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363877));
    this.jdField_a_of_type_Ros = new ros(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView);
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView = ((ReadInJoyCapsuleView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363876));
    this.jdField_b_of_type_Ros = new ros(this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView);
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView = ((ReadInJoyCapsuleView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363875));
    this.jdField_c_of_type_Ros = new ros(this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368595));
    a(a(osj.a().a(0)));
  ...
  private URLDrawable a(ChannelCoverInfo paramChannelCoverInfo, boolean paramBoolean)
  {
    ...
    paramChannelCoverInfo = URLDrawable.getDrawable(see.a(paramChannelCoverInfo.externalExposureBackgroundUrl), (URLDrawable.URLDrawableOptions)localObject);
  ...
  private List<ChannelCoverInfo> a(List<ChannelCoverInfo> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localChannelCoverInfo.isExternalExposure) && (((bhvh.i()) && (!bhvh.j())) || (localChannelCoverInfo.mChannelCoverId != 56)))
      {
        paramList = localChannelCoverInfo.externalExposureBackgroundUrl;
        if ((!TextUtils.isEmpty(paramList)) && (!TextUtils.equals(bhvh.d(localChannelCoverInfo.mChannelCoverId), paramList)))
        {
          if (localChannelCoverInfo.isExternalExposurePersist) {
            paramList = "";
          }
          bhvh.a(paramList, localChannelCoverInfo.mChannelCoverId);
          bhvh.a(localChannelCoverInfo.mChannelCoverId, false);
        }
  ...
  private void a(ChannelCoverInfo paramChannelCoverInfo)
  {
    ...
    if (localURLDrawable.getStatus() == 1)
    {
      if ((localURLDrawable.getCurrDrawable() instanceof GifDrawable))
      {
        ...
        if ((localAbstractGifImage instanceof sef))
        {
          this.jdField_a_of_type_Sef = ((sef)localAbstractGifImage);
          ((sef)localAbstractGifImage).a(new roq(this, paramChannelCoverInfo));
        }
      }
  ...
  private void a(List<ChannelCoverInfo> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localChannelCoverInfo.mChannelCoverId == 56)
      {
        ...
        paramList = this.jdField_a_of_type_Ros;
      }
      for (;;)
      {
        ...
        if (localChannelCoverInfo.mChannelCoverId == 1000000)
        {
          ...
          paramList = this.jdField_b_of_type_Ros;
        }
        ...
        else
        {
          ...
          paramList = this.jdField_c_of_type_Ros;
        }
      }
    }
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Ros.a() != null) {
      a("0X8008B88", this.jdField_a_of_type_Ros.a());
    }
    if (this.jdField_b_of_type_Ros.a() != null) {
      a("0X8008B89", this.jdField_b_of_type_Ros.a());
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Ros.b();
    this.jdField_b_of_type_Ros.b();
    this.jdField_c_of_type_Ros.b();
  ...
  public void f()
  {
    ...
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377214)).setText(this.jdField_a_of_type_JavaLangString);
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      return;
    case 2131377214: 
      onk.d(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
      awso.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), new ReportModelDC02528().opername("Kdian_inner_search").module("kd_web_search").action("active_search").ver1(this.jdField_a_of_type_JavaLangString).ver7("{experiment_id:" + awso.b + "}"));
      return;
    case 2131363877: 
      paramView = this.jdField_a_of_type_Ros.a();
      ...
      a("0X8008B84", this.jdField_a_of_type_Ros.a());
      return;
    case 2131363876: 
      this.jdField_b_of_type_Ros.a();
      rwa.a(this.jdField_a_of_type_AndroidContentContext, ajyc.a(2131713019), "https://kandian.qq.com/viola/bundle_hotTopic.js?v_bid=3256&statusColor=1", null);
      a("0X8008B85", this.jdField_b_of_type_Ros.a());
      return;
    }
    Object localObject = (ChannelCoverInfo)paramView.getTag();
    onk.a(paramView.getContext(), ((ChannelCoverInfo)localObject).mChannelJumpUrl);
