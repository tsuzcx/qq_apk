...
public class abbj
{
  ...
  public abbj(AppInterface paramAppInterface)
  {
  ...
  private JSONObject a(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokestatic 73	nku:a	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_3
    //   7: aload_3
    ...
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual 102	abbj:c	(Ljava/lang/String;)V
    //   54: aconst_null
    //   55: areturn
    //   56: getstatic 107	nko:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +42 -> 101
    //   62: getstatic 107	nko:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload_1
    //   66: invokevirtual 113	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   69: ifeq +32 -> 101
    //   72: getstatic 107	nko:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   75: aload_1
    ...
    //   138: astore_3
    //   139: aload 4
    //   141: invokestatic 137	nme:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   144: astore_2
    //   145: aload 4
    //   147: astore_3
    //   148: getstatic 107	nko:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   151: aload_1
    //   152: aload_2
    ...
    //   281: aload_0
    //   282: aload_1
    //   283: invokevirtual 102	abbj:c	(Ljava/lang/String;)V
    //   286: getstatic 107	nko:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   289: aload_1
  ...
  public static void c()
  {
    try
    {
      Object localObject = new File(BaseApplicationImpl.getApplication().getApplicationContext().getFilesDir(), bgwh.e.jdField_a_of_type_JavaLangString);
  ...
  public void a(OfflineWebRes paramOfflineWebRes)
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject1 = nku.a(paramOfflineWebRes.bid);
          ...
          if (((File)localObject1).exists())
          {
            ...
            bgmg.a((File)localObject1, new File((File)localObject2, paramOfflineWebRes.hashName));
            if (QLog.isColorLevel()) {
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = nko.d(paramString);
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = nme.a(((MessageDigest)localObject3).digest());
        ...
        try
        {
          ...
          QLog.i("OfflineWebResManager", 2, "add or update url " + nko.d(paramString) + ", cost: " + (System.currentTimeMillis() - l));
          return;
        }
