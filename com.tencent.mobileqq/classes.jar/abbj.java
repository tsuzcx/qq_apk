  ...
  implements Handler.Callback
{
  ...
  private abbl jdField_b_of_type_Abbl;
  private ImageSwitcher jdField_b_of_type_AndroidWidgetImageSwitcher;
  private boolean jdField_b_of_type_Boolean;
  private abbl c;
  private abbl d;
  
  public abbj(ImageSwitcher paramImageSwitcher1, ImageSwitcher paramImageSwitcher2, ImageView paramImageView, MqqHandler paramMqqHandler, QQAppInterface paramQQAppInterface)
  {
  ...
  private abbl a(String paramString)
  {
    if (this.d != null)
    {
  ...
  private String a(int paramInt)
  {
    ...
    case 3: 
    default: 
      return ajjy.a(2131640218);
    case 0: 
      return ajjy.a(2131640220);
    case 1: 
      return ajjy.a(2131640222);
    case 2: 
      return ajjy.a(2131640221);
    }
    return ajjy.a(2131640223);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size()) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 2)) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size() - 1))) {
      if ((this.d != null) && (this.jdField_b_of_type_Int != 4))
      {
        ...
        this.c = this.d;
        this.d = null;
        this.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.c.jdField_a_of_type_Azwp);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Azwp);
        this.jdField_a_of_type_Abbl = this.jdField_b_of_type_Abbl;
        this.jdField_b_of_type_Abbl = this.d;
        this.d = null;
      }
    }
    for (;;)
    {
      ...
      return true;
      label287:
      this.c = abbl.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label302:
      ...
      this.jdField_b_of_type_Abbl = abbl.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.jdField_b_of_type_Abbl.jdField_a_of_type_Azwp);
      continue;
      label478:
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Azwp);
      this.jdField_a_of_type_Abbl = this.jdField_b_of_type_Abbl;
      ...
      this.d = null;
      if (QLog.isColorLevel()) {
        QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "isPlayFinished play one" + this.jdField_b_of_type_Abbl.jdField_a_of_type_JavaLangString);
      }
    }
    label553:
    return false;
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Abbl != null) && (!this.jdField_a_of_type_Abbl.a()))
    {
      this.jdField_a_of_type_Abbl.a();
      this.jdField_a_of_type_Abbl = null;
    }
    if ((this.jdField_b_of_type_Abbl != null) && (!this.jdField_b_of_type_Abbl.a()))
    {
      this.jdField_b_of_type_Abbl.a();
      this.jdField_b_of_type_Abbl = null;
    }
    if ((this.c != null) && (!this.c.a()))
    {
      this.c.a();
  ...
  void a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 1) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          this.jdField_b_of_type_Abbl = this.c;
          this.c = null;
          localObject = this.jdField_b_of_type_Abbl.a();
          this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject);
          if (QLog.isColorLevel()) {
            QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play two" + this.jdField_b_of_type_Abbl.jdField_a_of_type_JavaLangString);
          }
          this.c = a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1));
          if (this.c == null) {
            this.c = abbl.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          ...
          this.d = abbl.a((String)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          return;
        }
      }
      catch (Throwable localThrowable)
      {
        ...
        bgfy.a(localThrowable, ajjy.a(2131640219));
        return;
      }
      g();
      continue;
      ...
      if (!this.c.a())
      {
        ...
        continue;
        label541:
        if ((this.jdField_b_of_type_Abbl == null) || ((!this.jdField_b_of_type_Abbl.a()) && (!this.jdField_b_of_type_Abbl.jdField_a_of_type_JavaLangString.equals(localThrowable))))
        {
          this.jdField_b_of_type_Abbl = abbl.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
          label587:
          this.jdField_b_of_type_Abbl = a(localThrowable);
          if (this.jdField_b_of_type_Abbl == null) {
            this.jdField_b_of_type_Abbl = abbl.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          azwp localazwp = this.jdField_b_of_type_Abbl.a();
          if (localazwp != null)
          {
            this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(localazwp);
            if (QLog.isColorLevel()) {
              QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play one" + this.jdField_b_of_type_Abbl.jdField_a_of_type_JavaLangString);
            }
          }
        }
      }
    ...
    {
      this.d = abbl.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (this.jdField_a_of_type_Boolean)
      {
        this.c = abbl.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
        label772:
        if (QLog.isColorLevel())
        {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      this.d = abbl.a(paramArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  void a(boolean paramBoolean)
  {
    ...
    localAlphaAnimation1.setAnimationListener(new abbk(this, paramBoolean));
