...
public class sxx
  implements Runnable
{
  public sxx(LoginVerifyCodeActivity2 paramLoginVerifyCodeActivity2) {}
  
  public void run()
  {
    if (LoginVerifyCodeActivity2.a(this.a) == 1)
    {
      LoginVerifyCodeActivity2.a(this.a).setText(2131434260);
    ...
    LoginVerifyCodeActivity2.a(this.a).setText(this.a.getString(2131434260) + "(" + LoginVerifyCodeActivity2.a(this.a) + ")");
