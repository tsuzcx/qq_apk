...
public class baqx
  extends baqp
{
  public static final baqx a = new baqx();
  ...
  protected void _onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    if (!ThemeUtil.isIOSTheme(paramString1))
    {
      ...
      if (paramInt1 != 0)
      {
        ...
        bapf.a(null, "individual_v2_theme_download_fail", String.valueOf(paramInt1), "from" + paramString3 + ",httpCode=" + paramInt2 + ",errorCode:" + paramInt1 + ", scid:" + paramString1 + ", cfgScid:" + paramString2, paramQQAppInterface, String.valueOf(paramInt2), null, 0.0F, 0.0F);
        paramQQAppInterface = new HashMap();
        paramQQAppInterface.put("reportKey", "errorCode:" + paramInt1);
        awrn.a(BaseApplication.getContext()).a("", "individual_v2_theme_download_fail", false, 0L, -1L, paramQQAppInterface, "", true);
      }
      return;
    }
  ...
  public boolean deleteFiles(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    if (paramQQAppInterface != null) {
      if (!ThemeUtil.isIOSTheme(paramString))
      {
        ...
        {
          localObject = new axmb().a((String)localObject);
          if (paramString.startsWith("theme.android.")) {}
          for (paramQQAppInterface = ((axmb)localObject).a(paramQQAppInterface.getApp(), paramString, "").c();; paramQQAppInterface = ((axmb)localObject).b(paramQQAppInterface.getApp()))
          {
      ...
      if (!ThemeUtil.isIOSTheme(paramString))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          if (paramString.startsWith("theme.android."))
          {
            ...
            localTagItemInfo.strSavePath = ((axmb)localObject).a(paramQQAppInterface.getApp(), paramString, "").c();
            return localTagItemInfo;
          }
          localTagItemInfo.bPreConfig = true;
          localTagItemInfo.bSaveInDir = false;
          localTagItemInfo.strSavePath = ((axmb)localObject).b(paramQQAppInterface.getApp());
          return localTagItemInfo;
        }
      }
      else
