  ...
  implements Handler.Callback, bjxg, bkyh, HWDecodeListener
{
  ...
  public bjyp(@NonNull bjww parambjww)
  {
    super(parambjww);
  ...
  public static Bitmap a(Context paramContext, Bitmap paramBitmap, bkxk parambkxk)
  {
    if ((paramBitmap == null) || (parambkxk == null)) {
      return null;
    }
    Object localObject = vzx.a(paramBitmap.getWidth(), paramBitmap.getHeight(), axli.jdField_a_of_type_Int, axli.jdField_b_of_type_Int);
    int j = ((Integer)((Pair)localObject).first).intValue();
    int k = ((Integer)((Pair)localObject).second).intValue();
    int i = bkxd.jdField_a_of_type_Int;
    if (k > i) {
      j = (int)(j * i / k);
    }
    for (;;)
    {
      ...
      {
        paramContext = bbdr.a(paramContext, bbdr.c(paramBitmap), 0.4F, 25.0F);
        parambkxk = paramContext;
        ...
        label205:
        for (parambkxk = paramContext;; parambkxk = paramContext.copy(paramContext.getConfig(), true))
        {
          localCanvas.setBitmap(parambkxk);
          localCanvas.drawColor(Color.parseColor("#3F000000"), PorterDuff.Mode.SRC_OVER);
          parambkxk = paramContext;
          paramContext = vxy.a(vxy.a(parambkxk, j, i, true), paramBitmap);
  ...
  private Bitmap a(@NonNull bjyr parambjyr, boolean paramBoolean)
  {
    long l1 = 0L;
    int i = 180;
    Object localObject2 = bjyr.a(parambjyr);
    long l2 = this.jdField_a_of_type_Bjww.c() / 1000000L;
    Object localObject1;
    if ((l2 != 0L) && (paramBoolean))
    {
      localObject1 = bkya.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo, l2);
    ...
    for (;;)
    {
      ...
      label126:
      Object localObject3;
      if (vzx.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo))
      {
        i = 0;
        ...
        localObject1 = a(a(), (Bitmap)localObject1, localbkxk);
        localObject3 = biho.a(biho.jdField_c_of_type_Int);
        localObject2 = localObject1;
        if (localObject3 != null)
        {
          ...
          {
            if (paramBoolean) {
              l1 = this.jdField_a_of_type_Bjww.c();
            }
            localObject3 = localbkxk.a((Bitmap)localObject1, l1);
            localObject2 = localObject1;
            if (localObject3 != null) {
        ...
        if ((!bjyr.a(parambjyr)) || (!bkxj.a(bjyr.a(parambjyr)))) {
          break label635;
        }
        switch (bjyr.a(parambjyr))
        {
        default: 
          localObject1 = null;
          label251:
          if (localObject1 != null)
          {
            ...
            veg.a("Q.qqstory.record.HWEditImportVideoPlayer", "updateFragmentThumbBitmapIfNeeded, filterThumbBitmap = %s", localObject3);
            if (localObject3 != null) {
      ...
      for (;;)
      {
        ...
        {
          localObject2 = localObject1;
          if (bjyr.b(parambjyr) != null)
          {
            bkxo localbkxo = (bkxo)bkxj.a(106);
            localbkxo.a(bjyr.b(parambjyr));
            localbkxo.init();
            localObject2 = localbkxk.a((Bitmap)localObject1, localbkxo);
            veg.a("Q.qqstory.record.HWEditImportVideoPlayer", "updateFragmentThumbBitmapIfNeeded, mosaicThumbBitmap = %s", localObject2);
            if (localObject2 != null) {
              localObject1 = localObject2;
            }
            localbkxo.destroy();
        ...
        if ((localObject3 != null) && (localObject3 != bjyr.a(parambjyr)) && (localObject3 != localObject2)) {
          ((Bitmap)localObject3).recycle();
        }
        localbkxk.a();
        localObject1 = localObject2;
        if (i != 0) {
          localObject1 = vzo.a((Bitmap)localObject2, 360 - i);
        }
        localObject2 = localObject1;
        if (this.jdField_e_of_type_Boolean) {
          localObject2 = vzo.a((Bitmap)localObject1, 90.0F);
        }
        if ((localObject2 != bjyr.a(parambjyr)) || (bjyr.a(parambjyr)) || (bjyr.b(parambjyr)))
        {
          return localObject2;
          ...
          {
            localObject2 = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
            localObject1 = a(localbkxk, (Bitmap)localObject1, a(), a().getString(2131699515, new Object[] { localObject2 }));
            break label126;
          }
          localbkxk.a(((Bitmap)localObject1).getWidth(), ((Bitmap)localObject1).getHeight());
          break label126;
        ...
        return parambjyr.jdField_c_of_type_AndroidGraphicsBitmap;
        localObject1 = localObject2;
        continue;
        label635:
        localObject3 = null;
  ...
  public static Bitmap a(bkxk parambkxk, Bitmap paramBitmap, Context paramContext, String paramString)
  {
    ...
    for (j = (int)(k * i / j);; j = k)
    {
      ...
      i = avtc.a(i);
      parambkxk.a(j, i);
      parambkxk = new bkxy(paramContext, paramString);
      parambkxk.a(k, m, j, i);
      paramContext = new GLImage();
      paramContext.loadTextureSync(paramBitmap);
      paramBitmap = GlUtil.captureFrame(parambkxk.a(paramContext.getTexture()), j, i);
      parambkxk.a();
      return paramBitmap;
      i = j;
    }
  ...
  private void a(@NonNull bjyr parambjyr)
  {
    veg.b("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayInfo，index : %d => %d", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(parambjyr.jdField_c_of_type_Int));
    if (parambjyr.jdField_a_of_type_JavaLangString == null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setPlayRange((int)bjyr.a(parambjyr), (int)bjyr.b(parambjyr));
      if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter != null) {
        this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter.a(3, ajyc.a(2131705667));
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = parambjyr.jdField_c_of_type_Int;
      return;
      if (!this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a().equalsIgnoreCase(parambjyr.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c();
        this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setFilePath(parambjyr.jdField_a_of_type_JavaLangString, parambjyr.jdField_b_of_type_JavaLangString, true, this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean);
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Bjww.a() != null) && (!this.jdField_a_of_type_Bjww.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      ...
      i = axli.jdField_b_of_type_Int;
      if (axli.a(a())) {
        break label333;
      }
    }
    label333:
    for (int i = axli.c(a());; i = axli.jdField_b_of_type_Int)
    {
      k = (int)(j / f1);
  ...
  public int a()
  {
    ...
    {
      bjyr localbjyr = (bjyr)this.jdField_a_of_type_JavaUtilList.get(i);
      if (localbjyr != null) {
        return bjyr.a(localbjyr);
      }
    }
    return 0;
  }
  ...
  public long a(int paramInt)
  {
    ...
    {
      bjyr localbjyr = (bjyr)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      return bjyr.b(localbjyr) - bjyr.a(localbjyr);
    }
    veg.e("Q.qqstory.record.HWEditImportVideoPlayer", "getDurationOfFragment with invalid index = %d", new Object[] { Integer.valueOf(paramInt) });
    return 0L;
  }
  ...
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return a((bjyr)this.jdField_a_of_type_JavaUtilList.get(paramInt), true);
    }
    veg.e("Q.qqstory.record.HWEditImportVideoPlayer", "getDurationOfFragment with invalid index = %d", new Object[] { Integer.valueOf(paramInt) });
    return null;
  }
  ...
  public void a()
  {
    ...
    {
      localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaWidth == 0) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaHeight == 0))
      {
        ...
        blbs.a(this.jdField_a_of_type_JavaLangString, (blbt)localObject);
      ...
      veg.d("Q.qqstory.record.HWEditImportVideoPlayer", "recordMultiVideoFragment = %s, supportMultiVideoFragment = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
      if ((!bool1) || (!bool2)) {
        break label642;
      }
      bool1 = true;
      ...
      if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) {
        break label647;
      }
      this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
      label334:
      this.jdField_c_of_type_Boolean = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_fit_center", false);
      this.jdField_d_of_type_Boolean = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_need_gaussion_blur", false);
      if (this.jdField_d_of_type_Boolean) {
        if (!vzx.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo)) {
          break label758;
        }
    ...
    for (int i = -90;; i = 0)
    {
      ...
      {
        localObject = (VideoStoryDataBean)this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getSerializable("KEY_VIDEO_STORY_CAMERA_TYPE");
      ...
      else if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("is_video_forward", false))
      {
        if (!vzx.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo)) {
          break label753;
        }
      ...
      for (i = j;; i = 0)
      {
        localObject = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(a().getString(2131699515, new Object[] { localObject }), i);
        ...
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setTrackerCallback(new bjyq(this));
        a(bjxg.class, this);
        ...
        bool1 = false;
        break;
        if (((this.jdField_a_of_type_Bjww.a() != null) && (this.jdField_a_of_type_Bjww.a().isLandTakePicToVideo())) || (!vzx.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo))) {
          this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        }
        for (;;)
        {
  ...
  public void a(int paramInt)
  {
    ...
    {
      localbjyr = (bjyr)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int);
      if (localbjyr.jdField_a_of_type_JavaLangString == null)
      {
    ...
    for (;;)
    {
      ...
      return;
      veg.b("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayMode change to iframe video");
      a(localbjyr);
      break;
  ...
  public void a(int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    if ((f1 == 0.0F) || (f1 > 0.95F))
    {
      ...
      a(paramInt1);
      veg.a("Q.qqstory.record.HWEditImportVideoPlayer", "setSlideMode lefPlayMode=%s rightMode=%s, offset=%s", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Float.valueOf(paramFloat));
    }
    do
    {
      return;
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    ...
    if (i > 1) {
      if (paramInt < i)
      {
        localObject = (bjyr)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        parambkkm.a.hasFragments = true;
        parambkkm.a.videoNeedRotate = false;
        parambkkm.a.videoRangeStart = ((int)bjyr.a((bjyr)localObject));
        parambkkm.a.videoRangeEnd = ((int)bjyr.b((bjyr)localObject));
        veg.b("Q.qqstory.record.HWEditImportVideoPlayer", "editVideoPrePublish : %s", localObject);
      }
    }
    for (;;)
    {
      parambkkm.a.putExtra("local_import", Boolean.valueOf(true));
      parambkkm.a.putExtra("video_rotation", Integer.valueOf(this.jdField_d_of_type_Int));
      ...
      parambkkm.a.putExtra("landscape_video", Boolean.valueOf(bool));
      parambkkm.a.putExtra("extra_is_need_gaussion_blur", Boolean.valueOf(this.jdField_d_of_type_Boolean));
      if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("is_video_forward", false))
      {
        localObject = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
        parambkkm.a.putExtra("video_forward_watermark", a().getString(2131699515, new Object[] { localObject }));
        parambkkm.a.putExtra("is_video_forward", Boolean.valueOf(true));
      }
      return;
      veg.d("Q.qqstory.record.HWEditImportVideoPlayer", "editVideoPrePublish : get invalid fragment index = %d, fragment count = %d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(i) });
      continue;
      if (i == 1)
      {
        localObject = (bjyr)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        parambkkm.a.videoNeedRotate = false;
        parambkkm.a.videoRangeStart = this.jdField_b_of_type_Int;
        parambkkm.a.videoRangeEnd = this.jdField_c_of_type_Int;
        parambkkm.a.hwEncodeRecordVideo = true;
      }
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      localbjyr = (bjyr)this.jdField_a_of_type_JavaUtilList.get(i);
      bjyr.a(localbjyr, paramBitmap);
      if ((!bjyr.b(localbjyr)) && (!paramBoolean)) {
        break label73;
      }
    }
    label73:
  ...
  public void a(boolean paramBoolean)
  {
    int i = this.jdField_a_of_type_Bjww.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size()) {
      bjyr.b((bjyr)this.jdField_a_of_type_JavaUtilList.get(i), paramBoolean);
    }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    if (paramMessage.what == 6)
    {
      ...
      paramMessage = (bjyr)this.jdField_a_of_type_JavaUtilList.get(i);
      veg.b("Q.qqstory.record.HWEditImportVideoPlayer", "MESSAGE_PLAYING_FRAGMENT_CHANGED : fragment = %s", paramMessage);
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setColorFilterType(b(bjyr.a(paramMessage)));
      a(bjyr.a(paramMessage));
      a(paramMessage);
    ...
    for (;;)
    {
      return false;
      label180:
      veg.e("Q.qqstory.record.HWEditImportVideoPlayer", "MESSAGE_PLAYING_FRAGMENT_CHANGED : get invalid index=%d, video fragment count = %d", new Object[] { Integer.valueOf(i), Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
    }
  }
  ...
  {
    veg.a("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayMode mode=%s", Integer.valueOf(paramInt));
    int i = this.jdField_a_of_type_Bjww.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      bjyr localbjyr = (bjyr)this.jdField_a_of_type_JavaUtilList.get(i);
      if (bjyr.a(localbjyr) != paramInt)
      {
        bjyr.a(localbjyr, paramInt);
        bjyr.c(localbjyr, true);
      }
    }
  }
  ...
  public void g()
  {
    ...
    super.g();
    if ((bjil.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j > 100) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c > 0L))
    {
      ...
      if (vel.a((int)f1, 0L, 30L)) {
        vel.a("CamEditFreq", true, 0L, new String[] { String.valueOf(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int), String.valueOf(f1), vel.b(i), String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j), String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c) });
      }
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if ((localBitmap != null) && (localBitmap != paramMessage.jdField_c_of_type_AndroidGraphicsBitmap))
      {
        ...
        veg.b("Q.qqstory.record.HWEditImportVideoPlayer", "update fragment bitmap : %s", paramMessage);
