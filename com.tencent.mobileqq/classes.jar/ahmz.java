  ...
  extends agem
{
  ...
  public ahmz(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahna(this);
  }
  ...
  protected View a(MessageRecord paramMessageRecord, agen paramagen, View paramView, LinearLayout paramLinearLayout, agjk paramagjk)
  {
    ...
    if (paramView == null) {
      paramLinearLayout = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558841, null);
    }
    ...
    paramMessageRecord = (ahnb)paramagen;
    Object localObject3 = localPAMessage.items;
    paramagen = (ViewGroup)paramLinearLayout.findViewById(2131372222);
    Object localObject1 = (ImageView)paramLinearLayout.findViewById(2131372225);
    TextView localTextView1 = (TextView)paramLinearLayout.findViewById(2131372224);
    TextView localTextView2 = (TextView)paramLinearLayout.findViewById(2131372217);
    TextView localTextView3 = (TextView)paramLinearLayout.findViewById(2131372218);
    TextView localTextView4 = (TextView)paramLinearLayout.findViewById(2131372219);
    TextView localTextView5 = (TextView)paramLinearLayout.findViewById(2131372220);
    TextView localTextView6 = (TextView)paramLinearLayout.findViewById(2131372221);
    ...
    for (int i = ((List)localObject1).size();; i = 0)
    {
      ...
      paramagen.setTag(paramMessageRecord);
