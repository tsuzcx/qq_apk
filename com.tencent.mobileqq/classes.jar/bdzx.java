  ...
  extends SSLSocketFactory
{
  ...
  public bdzx(SSLSocketFactory paramSSLSocketFactory)
  {
  ...
  private Socket a(Socket paramSocket)
  {
    ...
    {
      paramSocket = new beaa(this, (SSLSocket)paramSocket, null);
      ((beaa)paramSocket).setEnabledProtocols(new String[] { "TLSv1.1", "TLSv1.2" });
      return paramSocket;
    }
    return paramSocket;
  }
