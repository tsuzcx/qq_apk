  ...
  extends azus
{
  ...
  String am;
  String an;
  private View.OnClickListener b = new azzw(this);
  public boolean b;
  public long c;
  public boolean c;
  boolean d;
  ...
  public azzv()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new azzz(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new baaa(this);
    this.jdField_a_of_type_JavaLangString = "video";
    this.jdField_a_of_type_Int = 14;
  }
  
  public azzv(String paramString1, int paramInt1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, String paramString5, String paramString6, String paramString7, int paramInt7, long paramLong)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new azzz(this);
  ...
  public azzv(String paramString1, String paramString2, boolean paramBoolean)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new azzz(this);
  ...
  private void a(Context paramContext)
  {
    ...
    do
    {
      ...
      paramContext = azuw.a(b());
    } while (TextUtils.isEmpty(paramContext));
    azqs.b(null, "CliOper", "", "", "0X8005F58", "0X8005F58", 0, 0, "", "", paramContext, "");
  }
  ...
  private void a(Context paramContext, View paramView)
  {
    if (this.k == 1)
    {
      if ((paramView instanceof AnyScaleTypeImageView)) {
        ((AnyScaleTypeImageView)paramView).setImageResource(2130839223);
      }
      if (this.jdField_a_of_type_Baad == null) {
        this.jdField_a_of_type_Baad = new baad(this);
      }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(b()))
    {
      ...
      if (!TextUtils.isEmpty(paramContext)) {
        azqs.b(null, "CliOper", "", "", "0X8005F57", "0X8005F57", 0, 0, "", "", paramContext, "");
      }
    }
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (this.Y = localBundle.getString("VIDEO_PUB_ACCOUNT_NAME");; this.Y = String.valueOf(((StructMsgForGeneralShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg).mSourceName))
    {
      ...
      if (paramView.getTag(2131377133) != null)
      {
        paramContext = paramView.getTag(2131377133);
        if ((paramContext instanceof baac))
        {
          paramContext = (baac)paramContext;
    ...
    paramBundle.setId(2131377133);
    paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramBundle.setContentDescription(((Resources)localObject1).getText(2131720350));
    ...
    if (bool1)
    {
      ...
      if (this.n >= this.o)
      {
        ...
        ((ImageView)localObject2).setImageResource(2130842836);
        ((ImageView)localObject2).setVisibility(8);
        i = aepi.a(62.0F, (Resources)localObject1);
        if (bool1) {
          i = aepi.a(50.0F, (Resources)localObject1);
        }
        localObject3 = new RelativeLayout.LayoutParams(i, i);
        ((RelativeLayout.LayoutParams)localObject3).addRule(13);
        if (bool1)
        {
          i = aepi.a(10.0F, (Resources)localObject1) / 2;
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(5, 2131377133);
        ((RelativeLayout.LayoutParams)localObject4).addRule(7, 2131377133);
        ((RelativeLayout.LayoutParams)localObject4).addRule(8, 2131377133);
        if (!bool1) {
          break label1361;
        }
        i = aepi.a(7.0F, (Resources)localObject1);
        if (!bool1) {
          break label1429;
        }
        ...
        j = aepi.a(10.0F, (Resources)localObject1) + i;
        i1 = i;
      }
    }
    for (;;)
    {
      ...
      ((TextView)localObject4).setId(2131377132);
      ...
      if (bool1)
      {
        ...
        ((LinearLayout.LayoutParams)localObject5).rightMargin = aepi.a(7.0F, (Resources)localObject1);
        ...
        localObject5 = new baac();
        ((baac)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView = paramBundle;
        ((baac)localObject5).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject4);
        ((baac)localObject5).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localObject2);
        ((baac)localObject5).b = ((TextView)localObject1);
        ((baac)localObject5).jdField_a_of_type_AndroidViewView = ((View)localObject3);
        paramView.setTag(2131377133, localObject5);
        paramView.setTag(this);
        ((baac)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.a(this, (baac)localObject5);
        boolean bool2 = azun.a().a(paramContext, 3, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.uinType);
        if (QLog.isColorLevel()) {
        ...
        ((baac)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.d();
      }
      for (;;)
      {
        if (this.m > 0) {
          ((baac)localObject5).b.setText(ShortVideoUtils.a(this.m * 1000));
        }
        if (!TextUtils.isEmpty(this.ak)) {
          paramView.setTag(2131377139, this.ak);
        }
        ...
        break label547;
        label1361:
        i = aepi.a(12.0F, (Resources)localObject1);
        break label628;
        label1374:
        i1 = aepi.a(10.0F, (Resources)localObject1) + i;
        j = i;
        break label680;
        ...
        break label823;
        label1418:
        ((baac)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.f();
      }
      label1429:
      j = i;
      i1 = i;
  ...
  protected void a(Context paramContext, StructMsgForGeneralShare paramStructMsgForGeneralShare, long paramLong)
  {
    ...
    do
    {
      ...
      for (Object localObject = paramStructMsgForGeneralShare.mCreateTime.substring(0, paramStructMsgForGeneralShare.mCreateTime.indexOf(" "));; localObject = paramStructMsgForGeneralShare.mCreateTime)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null)) {
          azqs.b(null, "dc00899", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message.frienduin, "0X8006830", "0X8006830", 0, 0, this.U, "" + this.r, "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.msgId, "");
        }
        ...
        if (((paramStructMsgForGeneralShare.mSourceName == null) || (!paramStructMsgForGeneralShare.mSourceName.equals(alud.a(2131717453)))) && (((AladdinConfig)localObject).getIntegerFromString("enable_floating_layer_style", 0) == 1) && (bkbx.a(paramContext, this.Z, localBundle))) {
          break;
        }
        bool1 = false;
        try
  ...
  public boolean a(azwj paramazwj)
  {
    ...
    for (;;)
    {
      ...
      String str1 = paramazwj.a("load");
      this.U = paramazwj.a("vInfo");
      this.V = paramazwj.a("tInfo");
      String str2 = paramazwj.a("preTime");
      if (str2 != null) {}
      try
      {
        this.m = Integer.valueOf(str2).intValue();
        label81:
        str2 = paramazwj.a("preWidth");
        if (str2 == null) {}
      }
            ...
            try
            {
              ...
              catch (RuntimeException localNumberFormatException4)
              {
                try
                {
                  ...
                  label199:
                  this.Z = paramazwj.a("aID");
                  this.ak = paramazwj.a("jumpUrl");
                  this.jdField_d_of_type_Boolean = "1".equals(paramazwj.a("isJump2Web"));
                  str1 = paramazwj.a("preStartPosi");
                  if (!TextUtils.isEmpty(str1)) {}
                  try
                  {
                    this.l = Integer.valueOf(str1).intValue();
                    this.al = paramazwj.a("apurl");
                    this.am = paramazwj.a("rl");
                    this.an = paramazwj.a("disType");
                    str1 = paramazwj.a("feedId");
                    if (TextUtils.isEmpty(str1)) {}
                  }
                  catch (Exception localNumberFormatException4)
                  {
                        ...
                        catch (NumberFormatException localNumberFormatException4)
                        {
                          ...
                          catch (NumberFormatException localNumberFormatException4)
                          {
                            try
                            {
                              ...
                              this.r = paramazwj.a("advertiser_id");
                              this.s = paramazwj.a("aid");
                              this.t = paramazwj.a("app_download_schema");
                              this.u = paramazwj.a("canvas_json");
                              this.v = paramazwj.a("customized_invoke_url");
                              this.w = paramazwj.a("effect_url");
                              this.x = paramazwj.a("landing_page");
                              this.y = paramazwj.a("landing_page_report_url");
                              this.z = paramazwj.a("noco_id");
                              this.A = paramazwj.a("product_id");
                              this.C = paramazwj.a("subordinate_product_id");
                              this.D = paramazwj.a("traceid");
                              this.E = paramazwj.a("via");
                              this.F = paramazwj.a("video_url");
                              this.G = paramazwj.a("appname");
                              this.H = paramazwj.a("customized_invoke_url");
                              this.I = paramazwj.a("pkg_name");
                              this.J = paramazwj.a("pkgurl");
                              this.B = paramazwj.a("rl");
                              this.q = paramazwj.a("apurl");
                              this.N = paramazwj.a("corporate_image_name");
                              this.O = paramazwj.a("corporate_logo");
                              if (this.jdField_a_of_type_Int >= 14)
                              {
                                str1 = paramazwj.a("mini_program_type");
                                if (TextUtils.isEmpty(str1)) {}
                              }
                            }
                            catch (NumberFormatException localNumberFormatException4)
                                ...
                                try
                                {
                                  for (;;)
                                  {
                                    for (;;)
                                    {
                                      ...
                                      paramazwj = paramazwj.a("is_hidden");
                                      if (bdnn.a(paramazwj)) {
                                        break;
                                      }
                                      try
                                      {
                                        this.h = Integer.parseInt(paramazwj);
                                        return true;
                                      }
  ...
  protected View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle.getBoolean("has_cnr"))
    {
      ...
      for (;;)
      {
        paramView.setImageResource(2130845018);
        paramView.setTag(this);
        try
        {
          localObject2 = new azuy(-16777216, j, j, i);
          if (TextUtils.isEmpty(this.S))
          {
            ...
            paramView.setContentDescription(((Resources)localObject1).getString(2131694906));
            paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            paramView.setContentDescription(((Resources)localObject1).getText(2131720350));
            localObject1 = paramView;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBundle.getBoolean("has_cnr")) {
          localURLDrawable.setDecodeHandler(new baab(this, i, j, j));
        }
