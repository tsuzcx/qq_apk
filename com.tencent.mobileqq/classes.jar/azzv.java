  ...
  implements bagg
{
  ...
  public azzv(String paramString, int paramInt, azzu paramazzu)
  {
  ...
  private boolean b()
  {
    return (c()) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_a_of_type_Azzu != null);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.e = 0;
        if ((!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Bage != null)) {
          continue;
        }
        this.jdField_a_of_type_Bage = new bage();
        this.jdField_a_of_type_Bage.a(CodecParam.mAudioSampleRate);
        this.jdField_a_of_type_Bage.a(this);
        this.jdField_a_of_type_Bage.a(this.jdField_b_of_type_JavaLangString);
        bmbx.a("AudioChangerManager", "New mHwAudioEncoder");
        return;
      }
      ...
      for (;;)
      {
        ...
        if (localObject != null) {
          try
          {
            ...
            if ((this.jdField_a_of_type_Bage != null) && (this.jdField_b_of_type_Boolean))
            {
  ...
  public void b()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bage != null) {
        this.jdField_a_of_type_Bage.c();
      }
      if (!this.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Azzu.onAudioChangeCaptured(this.jdField_c_of_type_JavaLangString);
      }
      return;
    }
    catch (IOException localIOException)
  ...
  public void h()
  {
    bmbx.a("AudioChangerManager", "[onAudioFileEncoded]");
    this.jdField_a_of_type_Azzu.onAudioChangeCaptured(this.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Bage = null;
  }
  
  public void i()
  {
    bmbx.a("AudioChangerManager", "[onAudioFileEncodeFailed]");
