...
public class scv
{
  ...
  private static String a(ArticleCenter.GetUrlByVidResponse paramGetUrlByVidResponse)
  {
    ...
    for (;;)
    {
      ...
      label363:
      localObject1 = paramGetUrlByVidResponse;
      ocd.a(null, null, "0X8009824", "0X8009824", 0, 0, "", "", "", "", false);
      return paramGetUrlByVidResponse;
      localObject1 = localException2;
      ocd.a(null, null, "0X8009825", "0X8009825", 0, 0, "", "", "", "", false);
      return null;
    }
    label422:
    return null;
  ...
  public static scv a(String paramString, ArticleCenter.VideoInfo paramVideoInfo)
  {
    scv localscv = new scv();
    boolean bool;
    if (paramVideoInfo != null)
    {
      localscv.jdField_b_of_type_JavaLangString = paramString;
      if (paramVideoInfo.url.get() == null) {
        break label111;
      }
      paramString = paramVideoInfo.url.get().toStringUtf8();
      localscv.jdField_a_of_type_JavaLangString = paramString;
      if (paramVideoInfo.encode_type.get() != 1) {
        break label117;
      }
      bool = true;
      label56:
      localscv.jdField_a_of_type_Boolean = bool;
    ...
    {
      localscv.jdField_c_of_type_JavaLangString = paramString;
      localscv.jdField_b_of_type_Int = paramVideoInfo.width.get();
      localscv.jdField_c_of_type_Int = paramVideoInfo.height.get();
      return localscv;
      paramString = "";
      break;
      bool = false;
  ...
  static boolean a(ArticleCenter.GetUrlByVidResponse paramGetUrlByVidResponse, scv paramscv)
  {
    boolean bool2 = false;
    paramscv.jdField_a_of_type_JavaLangString = ozs.a(paramGetUrlByVidResponse.url);
    paramscv.jdField_d_of_type_Int = paramGetUrlByVidResponse.ret_info.ret_code.get();
    paramscv.jdField_a_of_type_Int = paramGetUrlByVidResponse.video_type.get();
    if (paramGetUrlByVidResponse.encode_type.get() == 1) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      paramscv.jdField_a_of_type_Boolean = bool1;
      paramscv.jdField_b_of_type_Int = paramGetUrlByVidResponse.width.get();
      paramscv.jdField_c_of_type_Int = paramGetUrlByVidResponse.height.get();
      paramscv.jdField_c_of_type_JavaLangString = ozs.a(paramGetUrlByVidResponse.rate);
      paramscv.jdField_a_of_type_Long = paramGetUrlByVidResponse.file_size.get();
      if (paramscv.jdField_a_of_type_Boolean) {
        paramscv.e = a(paramGetUrlByVidResponse);
      }
      Object localObject = ozs.a(paramGetUrlByVidResponse.json_video_detail);
      bool1 = bool2;
      ...
      try
      {
        ...
        if (paramscv.jdField_a_of_type_Boolean) {
          paramscv.jdField_b_of_type_Boolean = localJSONObject.optBoolean("isH265HWCodec", true);
        }
        paramscv.jdField_d_of_type_JavaLangString = localJSONObject.optString("reportInfo", "");
        bool1 = bool2;
        if (QLog.isColorLevel())
        {
      ...
      while (paramGetUrlByVidResponse.hasNext())
      {
        ...
        localObject = a(paramscv.jdField_b_of_type_JavaLangString, (ArticleCenter.VideoInfo)localObject);
        paramscv.jdField_a_of_type_JavaUtilArrayList.add(localObject);
      }
    }
    return bool1;
  }
