  ...
  implements bhko
{
  ...
  private void a(bhst parambhst)
  {
    int i = 0;
    if (TextUtils.isEmpty(parambhst.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (TextUtils.isEmpty(parambhst.jdField_a_of_type_JavaLangString)) {
      i = 101;
    ...
    while (i != 0)
    {
      ...
      try
      {
        ...
        localJSONObject2.put("id", parambhst.jdField_a_of_type_Int);
        localJSONObject2.put("url", "");
        localJSONObject1.put("data", localJSONObject2);
        localJSONObject1.put("msg", "");
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(parambhst.c, new String[] { localJSONObject1.toString() });
        return;
      }
      catch (JSONException parambhst)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "JSONException error !", parambhst);
        return;
        parambhst.d = bhsr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), parambhst.jdField_a_of_type_JavaLangString);
        if ((!TextUtils.isEmpty(parambhst.d)) && (new File(parambhst.d).exists()))
        {
          this.jdField_a_of_type_JavaUtilMap.put(parambhst.d, Integer.valueOf(parambhst.jdField_a_of_type_Int));
          if (!bhsr.a(parambhst.d, parambhst.b)) {
            i = 102;
          }
        }
        else
      ...
      catch (Exception parambhst)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "parentPlugin.callJs error !", parambhst);
      }
    }
  }
  ...
  protected void a(String... paramVarArgs)
  {
    ...
    //   30: invokespecial 202	bhst:<init>	(Lbhss;I)V
    //   33: astore_1
    //   34: aload_1
    //   35: aload_2
    //   36: ldc 204
    //   38: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   41: putfield 42	bhst:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   44: aload_1
    //   45: aload_2
    //   46: ldc 206
    //   48: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   51: putfield 156	bhst:b	Ljava/lang/String;
    //   54: aload_1
    //   55: aload_2
    //   56: ldc 184
    //   58: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   61: putfield 103	bhst:c	Ljava/lang/String;
    //   64: aload_1
    //   65: ifnull +26 -> 91
    //   68: aload_0
    //   69: getfield 31	bhss:jdField_b_of_type_JavaUtilMap	Ljava/util/Map;
    //   72: aload_1
    //   73: getfield 86	bhst:jdField_a_of_type_Int	I
    ...
    //   86: aload_0
    //   87: aload_1
    //   88: invokespecial 208	bhss:a	(Lbhst;)V
    //   91: return
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_1
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (bhst)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(j));
    if (paramBundle == null)
    {
