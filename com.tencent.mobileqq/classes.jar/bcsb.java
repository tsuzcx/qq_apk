...
public class bcsb
{
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      Object localObject = afuf.a;
      if ((localObject == null) || (((afue)localObject).f != 1)) {
        continue;
      }
      b = true;
      ...
      try
      {
        ...
        bctj.a(BaseApplicationImpl.getContext()).a(str3, "FightReporter_deviceid", true, 0L, 0L, localHashMap, null);
  ...
  public static void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    do
    {
      try
      {
        ...
        afue localafue2 = afuf.a;
        localafue1 = localafue2;
        if (!a) {
          continue;
        }
        localafue1 = localafue2;
      ...
      return;
    } while (localafue1 != null);
  }
  
  public static void a(String paramString)
  {
    bcrp.a(new Throwable(paramString));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    bcrp.a(new Throwable(paramString1), paramString2);
  }
  ...
  public static void b()
  {
    ...
    for (Object localObject = Build.SUPPORTED_ABIS[0];; localObject = Build.CPU_ABI)
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a(str, "FightReporter_cpu_abi", true, 0L, 0L, localHashMap, null);
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  {
    afue localafue = afuf.a;
    if ((localafue != null) && (localafue.e == 1)) {
