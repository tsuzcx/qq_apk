  ...
  extends ShareActionSheetBuilder
{
  ...
  public bdnc(Context paramContext)
  {
  ...
  public View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562647, null);
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)localView.findViewById(2131367308));
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(new bdmw(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            this.jdField_b_of_type_AndroidWidgetGridView = ((GridView)localView.findViewById(2131367309));
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            this.jdField_b_of_type_AndroidWidgetGridView.setNumColumns(i);
            this.jdField_b_of_type_AndroidWidgetGridView.setAdapter(new bdmw(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new bdnd(this));
            if (j == 0) {
            ...
            for (;;)
            {
              ...
              localObject1 = (RelativeLayout)localView.findViewById(2131376577);
              ...
              for (;;)
              {
                localObject1 = (ImageView)localView.findViewById(2131376576);
