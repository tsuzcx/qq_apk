...
{
  public babi(azxt paramazxt, azrb paramazrb)
  {
  ...
  {
    Object localObject = ((azrb)this.b).jdField_a_of_type_Azri.a.get("commonItemContentColor");
    if (localObject != null)
    {
  ...
  private boolean a(Card paramCard)
  {
    ...
    boolean bool4 = false;
    boolean bool1 = false;
    Object localObject2 = (azrb)this.b;
    ...
    do
    {
      do
      {
        ...
        if (((azrb)localObject2).jdField_a_of_type_Azri == null) {
          break;
        }
        i = 1;
    ...
    for (;;)
    {
        ...
        if ((localObject1 instanceof ProfileContentTitleView))
        {
          ...
          for (bool1 = true;; bool1 = false)
          {
            ...
            if (paramCard.miniAppInfoArrayList.size() > 1)
            {
              ...
              paramCard.setTag(new azpb(96, Boolean.valueOf(true)));
      ...
      else if ((localObject1 instanceof ProfileContentTitleView))
      {
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          {
            paramCard = ((ProfileContentTitleView)localObject2).b;
            paramCard.setTag(new azpb(96, Boolean.valueOf(false)));
            paramCard.setOnClickListener(this);
          }
          paramCard = (Card)localObject1;
          bool1 = bool2;
  ...
  public void onClick(View paramView)
  {
    ...
    boolean bool = ((Boolean)((azpb)paramView.getTag()).jdField_a_of_type_JavaLangObject).booleanValue();
    MiniAppUtils.reportProfileCardClick(((azrb)this.b).jdField_a_of_type_ComTencentMobileqqDataCard, bool);
    Context localContext = paramView.getContext();
    if (bool) {}
    for (String str = ((azrb)this.b).jdField_a_of_type_ComTencentMobileqqDataCard.tabJumpUrl;; str = ((azrb)this.b).jdField_a_of_type_ComTencentMobileqqDataCard.guestJumpUrl)
    {
      MiniAppController.startAppByLink(localContext, str, 2, localLaunchParam, null);
      azyh.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (azrb)this.b);
