  ...
  implements babk
{
  ...
  public babi(JSONObject paramJSONObject)
  {
  ...
  public static JSONObject a(babi parambabi)
  {
    JSONObject localJSONObject = new JSONObject().put("type", "recite").put("troop_uin", parambabi.jdField_f_of_type_JavaLangString).put("subtype", 1).put("title", parambabi.jdField_b_of_type_JavaLangString).put("desc", parambabi.c).put("kid", parambabi.jdField_a_of_type_JavaLangString).put("error_count", parambabi.jdField_d_of_type_Int).put("remind_count", parambabi.jdField_e_of_type_Int).put("waste_time", parambabi.jdField_a_of_type_Long).put("grade", parambabi.jdField_f_of_type_Int).put("lyric", parambabi.jdField_g_of_type_JavaLangString);
    if (!TextUtils.isEmpty(parambabi.jdField_e_of_type_JavaLangString)) {
      localJSONObject.put("file_url", parambabi.jdField_e_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(parambabi.jdField_d_of_type_JavaLangString)) {
      localJSONObject.put("file_path", parambabi.jdField_d_of_type_JavaLangString);
    }
    if (parambabi.jdField_a_of_type_JavaUtilList != null) {
      localJSONObject.put("pid_list", new JSONArray(parambabi.jdField_a_of_type_JavaUtilList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(ajya.a(2131705695)).append(paramString2);
    if ((paramList != null) && (!paramList.isEmpty())) {
      localStringBuilder.append(baam.a(paramList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(ajya.a(2131705697)).append(paramString2);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (this.jdField_a_of_type_Bhxj != null)
    {
      ...
      this.jdField_a_of_type_Bhxj = null;
    }
