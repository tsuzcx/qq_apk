...
public class bbrm
{
  private static volatile bbrm a;
  protected List<aydi> a;
  protected List<bbro> b;
  ...
  public static bbrm a()
  {
    if (jdField_a_of_type_Bbrm == null) {}
    try
    {
      if (jdField_a_of_type_Bbrm == null) {
        jdField_a_of_type_Bbrm = new bbrm();
      }
      return jdField_a_of_type_Bbrm;
    }
    finally {}
  }
  ...
  public static ArrayList<Long> a(List<? extends aydj> paramList)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        Object localObject = (aydj)paramList.get(i);
        if ((localObject instanceof aycp))
        {
          localObject = (aycp)localObject;
          try
          {
            if ((((aycp)localObject).a() == 0) || (((aycp)localObject).a() == 3)) {
              break label116;
            }
            localArrayList.add(Long.valueOf(Long.parseLong(((aycp)localObject).d())));
          }
  ...
  public final aycp a(String paramString)
  {
    ...
    while (i < j)
    {
      aydi localaydi = (aydi)this.jdField_a_of_type_JavaUtilList.get(i);
      if (((localaydi instanceof aycp)) && (paramString.equals(localaydi.d()))) {
        return (aycp)localaydi;
      }
      i += 1;
    }
    return null;
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    if (this.b == null)
    {
      ...
      localObject = (bbro)this.b.get(j);
      if (!((bbro)localObject).a.equals(paramString2)) {
        break label143;
      }
    }
    label143:
    label152:
    for (Object localObject = bbro.a(paramString1, (bbro)localObject);; localObject = null)
    {
  ...
  public List<aydi> a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList1 = new ArrayList();
    ExecutorService localExecutorService = Executors.newFixedThreadPool(1);
    ArrayList localArrayList2 = new ArrayList();
    localArrayList2.add(localExecutorService.submit(new bbrn(this, paramContext, paramQQAppInterface, aydi.E, paramInt)));
    paramInt = 0;
    try
    {
  ...
  @SuppressLint({"UseSparseArrays"})
  public List<aydi> a(Context paramContext, QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    if (localaloz != null)
    {
      ...
      if (localObject != null)
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          localObject = localaloz.a(String.valueOf(localGroups.group_id));
          if (localObject != null)
          {
            ...
            label176:
            for (localObject = paramContext.getResources().getString(2131721189);; localObject = localGroups.group_name)
            {
              localArrayList.add(new aycp(paramContext, paramQQAppInterface, localFriends, (String)localObject, 0L, paramLong));
              break label105;
              break;
            }
          }
    ...
    if (paramBoolean)
    {
      ...
      localArrayList.add(new aycp(paramContext, paramQQAppInterface, (Friends)localObject, paramContext.getResources().getString(2131721189), 0L, paramLong));
    }
  ...
  public List<bbro> a(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList = new ArrayList();
    aloz localaloz = (aloz)paramQQAppInterface.getManager(51);
    if (localaloz != null)
    {
      Object localObject1 = localaloz.b();
      if (localObject1 != null)
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = localaloz.a(String.valueOf(((Groups)((Iterator)localObject1).next()).group_id));
          if (localObject2 != null)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localArrayList.add(new bbro(paramContext, localFriends.uin, localFriends.name, localFriends.remark));
            }
          }
        }
      }
    ...
    if (paramBoolean) {
      localArrayList.add(new bbro(paramContext, paramQQAppInterface.getCurrentAccountUin(), paramQQAppInterface.getCurrentNickname(), null));
    }
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
