...
public class bbrm
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, bbrx parambbrx, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bbrq(paramInt, paramActivity, parambbrx), new bbrr(parambbrx, paramInt), new bbrs(parambbrx, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bbsc.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = bbsc.c(localBaseApplication, str);
    ...
    Object localObject = new ajvi(paramQQAppInterface);
    ajvj localajvj = new ajvj(paramQQAppInterface);
    localajvj.a(new bbro(paramQQAppInterface, localajvj));
    paramQQAppInterface.addObserver(localajvj);
    ((ajvi)localObject).a(2);
    bbsc.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = baig.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      baig.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      paramConfig = amnh.b(paramConfig, j, paramInt);
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            baig.a(paramQQAppInterface.getApp(), paramQQAppInterface.c(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = bbsc.a((Context)localObject, str);
        long l3 = bbsc.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        bbsc.a((Context)localObject, str, l1);
        ajvi localajvi = new ajvi(paramQQAppInterface);
        ajvj localajvj = new ajvj(paramQQAppInterface);
        localajvj.a(new bbrn((Context)localObject, str, paramQQAppInterface, localajvj));
        paramQQAppInterface.addObserver(localajvj);
        localajvi.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, bbrx parambbrx)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131627080);
        str2 = paramActivity.getString(2131627083);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131627086);
        String str4 = bbsc.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131627079);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambbrx, paramInt);
        return false;
        if ((paramInt == 2) || (paramInt == 4))
        {
          str1 = paramActivity.getString(2131627082);
          str2 = paramActivity.getString(2131627085);
          i = 1;
        }
        else if (paramInt == 3)
        {
          str1 = paramActivity.getString(2131627081);
          str2 = paramActivity.getString(2131627084);
          i = 1;
        }
        else if (paramInt == 5)
        {
          str1 = paramActivity.getString(2131627038);
          str2 = paramActivity.getString(2131627085);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new bbrw()).setCustomInstaller(new bbrv()).setCustomThreadPool(new bbru()).setCustomReporter(new bbrt()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new bbrz(), new bbsa());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = bbsc.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    ajvi localajvi = new ajvi(paramQQAppInterface);
    ajvj localajvj = new ajvj(paramQQAppInterface);
    localajvj.a(new bbrp(paramQQAppInterface, localajvj));
    paramQQAppInterface.addObserver(localajvj);
    localajvi.a(3);
    bbsc.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    bbsb localbbsb = bbsb.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbbsb.jdField_a_of_type_Int + " jumpUrl: " + localbbsb.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbbsb.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbbsb.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbbsb.jdField_a_of_type_JavaLangString);
