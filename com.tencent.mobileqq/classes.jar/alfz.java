...
public class alfz
{
  ...
  public static CopyOnWriteArrayList<WeakReference<alga>> a;
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (alga)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((alga)localObject2).a(paramInt);
          }
        }
      }
    }
  ...
  public static void a(alga paramalga)
  {
    if (paramalga == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((localWeakReference != null) && (paramalga == localWeakReference.get()))
            {
              QLog.i("ApolloSoLoader", 1, "already add, cb:" + paramalga);
              break;
            }
          }
        }
      ...
      jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramalga));
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    if ((jdField_d_of_type_Boolean) && (akji.a(BaseApplicationImpl.getContext()))) {}
    ...
    for (;;)
    {
      ...
      synchronized (bhol.a)
      {
        ...
        if (i < j)
        {
          ...
          alda.a(10, 300, new Object[] { "load [" + ((File)localObject1).getAbsolutePath() + "]" });
        }
      }
      return;
      label223:
  ...
  /* Error */
  public static void b(alga paramalga)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: aload_0
    //   4: ifnull +14 -> 18
    //   7: getstatic 70	alfz:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   20: monitorexit
    //   21: return
    //   22: getstatic 70	alfz:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   57: if_acmpne -28 -> 29
    //   60: getstatic 70	alfz:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: aload_3
  ...
  public static boolean b()
  {
    ...
    try
    {
      ...
      {
        str3 = arrayOfString[i];
        bool = bdcs.d(str2 + "/" + str3);
        if (!bool) {
          return false;
        }
        i += 1;
      }
      bdcs.a(bhol.a(1), false);
      return true;
    }
  ...
  private static boolean b(int paramInt)
  {
    try
    {
      synchronized (bhol.a)
      {
        File localFile1 = new File(bhol.a(paramInt));
        String str1 = bhol.a();
        if (localFile1.exists())
        {
          ...
          while (i < j)
          {
            ...
            if (jdField_e_of_type_Boolean) {
              alda.a(10, 100, new Object[] { localStringBuilder.toString() });
            }
            if (!bool) {
              return false;
            }
          ...
          bdcs.a(localFile1.getAbsolutePath());
  ...
  private static void c(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (l < 120000L)
      {
        ...
        if (jdField_e_of_type_Boolean) {
          alda.a(10, 200, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
        }
      }
    }
    do
    {
      do
      {
        return;
        if (jdField_e_of_type_Boolean) {
          alda.a(10, 200, new Object[] { "startDownload:", Long.valueOf(l) });
        }
    ...
    alda.a(10, 201, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
    return;
    jdField_a_of_type_Long = System.currentTimeMillis();
    if (jdField_e_of_type_Boolean) {
      alda.a(10, 201, new Object[] { "startDownload:", Long.valueOf(l) });
    }
    apgp.a();
  }
  ...
  private static void f()
  {
    try
    {
      File localFile = new File(aljq.aX + "pddata/prd/early", "android.qq.apollo.js.833g1");
      if (!localFile.exists())
      {
        c(1);
        return;
      ...
      {
        bhol.a(localFile.getAbsolutePath(), 1);
    ...
    for (;;)
    {
      try
      {
        ...
        if (k())
        {
          ...
          alda.a(10, 100, new Object[] { "reinstall delete old so, oldRes:", str, ",newRes:", "android.qq.apollo.js.833g1" });
          return true;
        }
      }
      catch (Throwable localThrowable)
      {
        QLog.e("ApolloSoLoader", 1, localThrowable, new Object[0]);
        if (jdField_e_of_type_Boolean) {
          alda.a(10, 100, new Object[] { "reinstall th:", localThrowable });
        }
        b();
        return false;
      }
  ...
  {
    String str1 = bhol.a() + "libsava.so" + "." + "android.qq.apollo.js.833g1";
    if (new File(str1).exists())
    {
      QLog.i("ApolloSoLoader", 1, "Bingo, the latest sava has been predownloaded.");
      String str2 = bhol.a() + "libsava.so";
      bdcs.d(str2);
      if (!bdcs.c(str1, str2))
      {
    ...
    for (;;)
    {
      try
      {
        if (ApolloGameUtil.a())
        {
          ...
          alda.a(10, 300, 1002, new Object[] { "arch=x86" });
          break;
        }
        if (!UpdateArkSo.a(BaseApplicationImpl.getContext(), UpdateArkSo.a()))
        {
          ...
          alda.a(10, 300, 1003, new Object[] { "png-armeabi-v7a load failed" });
          jdField_a_of_type_Boolean = true;
          break label531;
        }
        ...
        localObject = (apgj)((AppInterface)localObject).getManager(77);
        if (localObject == null) {
          break label524;
        }
        ...
        localObject = ((apgp)localObject).a();
        if (localObject == null) {
          break label524;
        }
        ...
        if (jdField_e_of_type_Boolean) {
          alda.a(10, 300, new Object[] { "[so info], str:android.qq.apollo.js.833g1,ver:" + i });
        }
        if (a(jdField_d_of_type_ArrayOfJavaLangString))
        {
          ...
          alda.a(10, 300, 0, new Object[] { "loadAllSo success" });
          break label533;
        }
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (jdField_e_of_type_Boolean)
        {
          alda.a(10, 300, 1004, new Object[] { "[loadAllSo], Something unexpected happened.", localThrowable });
          jdField_a_of_type_Boolean = true;
        }
        return false;
      }
      ...
      if (!UpdateAvSo.a())
      {
        ...
        alda.a(10, 299, 1005, new Object[] { "sharpp load fail" });
        return false;
      }
      alda.a(10, 299, 0, new Object[0]);
      continue;
      label519:
      int i = 4;
      continue;
  ...
  private static boolean m()
  {
    ...
    boolean bool = new aley(-1, 3, "", "").a();
    QLog.i("ApolloSoLoader", 1, "[isSavaSoExists], check result:" + bool);
    if (jdField_e_of_type_Boolean) {
      alda.a(10, 100, new Object[] { "[isSavaSoExists], check result:" + bool });
    }
    return bool;
  }
  ...
  private static boolean n()
  {
    ...
    if ((BaseApplicationImpl.sProcessId == 2) || (BaseApplicationImpl.sProcessId == 8))
    {
      if (a(jdField_b_of_type_ArrayOfJavaLangString))
      {
        ...
        if (new File(bhol.a() + "checkList_jsc").exists())
        {
          bool = new aley(-1, 4, "", "").a();
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        for (;;)
        {
          try
          {
            synchronized (bhol.a)
            {
              ...
              str3 = arrayOfString[i];
              bool = bdcs.d(str1 + "/" + str3, (String)localObject2 + str3);
              if (bool) {
                continue;
              }
              return false;
        ...
        {
          str3 = arrayOfString[i];
          bool = bdcs.d(str2 + "/" + str3, (String)localObject2 + str3);
          if (!bool) {
            return false;
          }
          i += 1;
  ...
  private static boolean o()
  {
    ...
    try
    {
      if (TextUtils.isEmpty(akji.f)) {
        akji.f = bdcs.b(new File(a("brick.js"), "brick.js"));
      }
      if (TextUtils.isEmpty(akji.g)) {
        akji.g = bdcs.b(new File(a("ticker.js"), "ticker.js"));
      }
      if (TextUtils.isEmpty(akji.h)) {
        akji.h = bdcs.b(new File(a("scene.js"), "scene.js"));
      }
      if (TextUtils.isEmpty(akji.i)) {
        akji.i = bdcs.b(new File(a("game.js"), "game.js"));
      }
      return true;
    }
    catch (Throwable localThrowable)
    {
      ...
      if (jdField_e_of_type_Boolean) {
        alda.a(10, 100, new Object[] { "[initScriptLib], th:", localThrowable });
      }
      return false;
    }
    finally
