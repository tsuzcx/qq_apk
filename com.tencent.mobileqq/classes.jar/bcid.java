...
{
  protected static volatile bcid a;
  ...
  protected bcid(Context paramContext)
  {
  ...
  public static bcid a()
  {
    try
    {
      if (jdField_a_of_type_Bcid == null) {
        jdField_a_of_type_Bcid = new bcid(bbtm.a().a());
      }
      if (jdField_a_of_type_Bcid.jdField_a_of_type_Long == 0L)
      {
        jdField_a_of_type_Bcid.jdField_a_of_type_Long = bbtm.a().a();
        if (jdField_a_of_type_Bcid.jdField_a_of_type_Long == 0L) {
          jdField_a_of_type_Bcid.jdField_a_of_type_Long = bbtm.a().b();
        }
      }
      bcid localbcid = jdField_a_of_type_Bcid;
      return localbcid;
    }
    finally {}
  }
  ...
  protected DownloadInfo a(String paramString, String[] paramArrayOfString)
  {
    ...
    //   6: aconst_null
    //   7: astore 6
    //   9: getstatic 80	bcid:jdField_a_of_type_ArrayOfByte	[B
    //   12: astore 7
    //   14: aload 7
    //   16: monitorenter
    //   17: aload_0
    //   18: invokevirtual 148	bcid:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   21: astore_3
    //   22: aload_3
    //   23: ldc 150
    //   25: getstatic 78	bcid:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   28: aload_1
    //   29: aload_2
    //   30: aconst_null
    //   31: aconst_null
    ...
    //   56: aload_0
    //   57: aload_2
    //   58: invokevirtual 166	bcid:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   61: astore_1
    //   62: aload_2
    //   63: ifnull +9 -> 72
    //   66: aload_2
    ...
    //   92: aconst_null
    //   93: astore_1
    //   94: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   97: ldc 172
    //   99: aload_3
    //   100: invokestatic 178	bcds:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: aload_2
    //   104: ifnull +9 -> 113
    //   107: aload_2
  ...
  protected String a()
  {
    ...
    {
      this.jdField_a_of_type_Long = bbtm.a().a();
      if (this.jdField_a_of_type_Long == 0L) {
        bcds.e(jdField_a_of_type_JavaLangString, "getUin() is empty!");
      }
    }
  ...
  public java.util.Map<String, DownloadInfo> a()
  {
    ...
    //   3: aconst_null
    //   4: astore_3
    //   5: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   8: ldc 191
    //   10: invokestatic 193	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   13: new 195	java/util/concurrent/ConcurrentHashMap
    //   16: dup
    //   17: invokespecial 197	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   20: astore 7
    //   22: getstatic 80	bcid:jdField_a_of_type_ArrayOfByte	[B
    //   25: astore 6
    //   27: aload 6
    //   29: monitorenter
    //   30: aload_0
    //   31: invokevirtual 148	bcid:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   34: astore_2
    //   35: aload_2
    //   36: ldc 150
    //   38: getstatic 78	bcid:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   41: aconst_null
    //   42: aconst_null
    //   43: aconst_null
    //   44: aconst_null
    ...
    //   77: astore_3
    //   78: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   100: invokestatic 193	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   103: aload_0
    //   104: aload 4
    //   106: invokevirtual 166	bcid:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   109: astore 5
    //   111: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   137: invokestatic 193	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: aload 7
    //   142: aload_3
    //   143: aload 5
    ...
    //   196: aload 5
    //   198: astore_3
    //   199: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   202: ldc 223
    //   204: aload 4
    //   206: invokestatic 178	bcds:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   209: aload_3
    //   210: ifnull +9 -> 219
    //   213: aload_3
  ...
  public void a(DownloadInfo paramDownloadInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramDownloadInfo.jdField_c_of_type_Boolean)
        {
          ...
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
          bcds.a(jdField_a_of_type_JavaLangString, "addDownloadInfo>>>update affected rowNum=" + i);
          if (i == 0)
          {
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            ...
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            bcds.a(jdField_a_of_type_JavaLangString, "addDownloadInfo>>>insert rowID = " + l);
          }
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
      ...
      catch (Exception paramDownloadInfo)
      {
        ...
        bcds.c(jdField_a_of_type_JavaLangString, "addDownloadExceptionInfo>>>", paramDownloadInfo);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bcds.c(jdField_a_of_type_JavaLangString, "addDownloadExceptionInfo>>>", localException);
      }
    }
  }
  ...
  {
    // Byte code:
    //   0: getstatic 80	bcid:jdField_a_of_type_ArrayOfByte	[B
    //   3: astore 5
    //   5: aload 5
    //   7: monitorenter
    //   8: aconst_null
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokevirtual 249	bcid:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 4
    //   18: aload 4
    //   20: astore_2
    //   21: aload 4
    //   23: astore_3
    //   24: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   57: invokestatic 193	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   60: aload 4
    //   62: astore_2
    //   63: aload 4
    //   65: astore_3
    ...
    //   100: aload_2
    //   101: astore_3
    //   102: getstatic 20	bcid:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   105: ldc_w 372
    //   108: aload_1
    //   109: invokestatic 178	bcds:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   112: aload_2
    //   113: ifnull -18 -> 95
    //   116: aload_2
  ...
  {
    bcds.c(jdField_a_of_type_JavaLangString, "onDowngrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
  
  public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    bcds.c(jdField_a_of_type_JavaLangString, "onUpgrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
}
