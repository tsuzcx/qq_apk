  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    acik.a((Map)localObject, localLabelInfo.msgId);
    ...
    if (avmd.a(localLabelInfo.redInfo))
    {
      ...
      acik.a(anbd.a(), "769", "205614", localLabelInfo.appId, "76903", "1", "160", (Map)localObject);
      avmd.a(localLabelInfo.redInfo.redPointId);
      ((avjh)paramView.getTag()).a.setVisibility(8);
      if (!localLabelInfo.isFriend) {
        break label301;
      }
      new LinearLayout.LayoutParams(-1, -2).gravity = 80;
      new avmw(this.a.itemView.getContext(), this.a.jdField_a_of_type_Aviu.a().gameAppId, localLabelInfo.friendType).show();
      acik.a(anbd.a(), "769", "205355", this.a.jdField_a_of_type_Aviu.a().gameAppId, "76902", "1", "160", new String[] { "", "", "20" });
    }
    for (;;)
    {
