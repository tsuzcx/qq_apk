  ...
  extends zjd
{
  ...
  public avjm(Context paramContext, PicInfo paramPicInfo)
  {
  ...
  public View a(int paramInt, Handler paramHandler, avjo paramavjo)
  {
    ...
    else
    {
      ...
      localURLImageView.setURLDrawableDownListener(new avjn(this, paramavjo, paramInt));
      if (!bool1) {
        break label619;
      }
      l = 1000L;
      paramHandler.postDelayed(new PicBrowserImage.3(this, (URLDrawable)localObject1, paramavjo, paramInt), l);
    }
    for (;;)
    {
      label441:
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a))
        {
          ...
          try
          {
            localObject2 = bauz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a);
            localObject1 = localFile;
            ...
            ((URLDrawable)localObject2).setDownloadListener(new auue(this.jdField_a_of_type_AndroidContentContext, "actNearbyPicBrowser"));
            localObject1 = localObject2;
            localURLImageView.setImageDrawable((Drawable)localObject2);
            localObject1 = localObject2;
            bool1 = baqn.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a);
            localObject1 = localObject2;
          }
  ...
  public void a()
  {
    ...
    try
    {
      localObject = bauz.a((String)localObject);
      if (localObject != null)
      {
        ...
        ((URLDrawable)localObject).setDownloadListener(new auue(this.jdField_a_of_type_AndroidContentContext));
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.b)) {
        try
        {
          ...
          if (baqn.b(((URL)localObject4).toString()))
          {
