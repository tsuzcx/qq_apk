  ...
  extends bnig
{
  ...
  private static final String jdField_a_of_type_JavaLangString = bnid.class.getSimpleName();
  private static String jdField_b_of_type_JavaLangString;
  private static boolean jdField_c_of_type_Boolean;
  private static int o;
  private static int p;
  private bnpm jdField_a_of_type_Bnpm = new bnpm();
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      {
        Bitmap localBitmap;
        if (this.jdField_a_of_type_Bnif == null) {
          continue;
        }
        this.jdField_a_of_type_Bnif.b(103);
        return;
      }
      ...
      if (this.jdField_a_of_type_Bnif != null) {
        this.jdField_a_of_type_Bnif.a(localBitmap);
      }
      m();
      return;
      label130:
  ...
  {
    if (this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) {}
    while ((!bqcb.a().b()) || (!f()) || (!this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.canUseLargeImage())) {
      return false;
    }
    return true;
  }
  ...
  private void i()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bnra == null) {
        this.jdField_a_of_type_Bnra = new bnra();
      }
      return;
    }
    finally {}
  ...
  private void l()
  {
    ...
    int j = 100;
    Object localObject = bnyp.a().a("app_alg_filter_timeout_id", "", 4);
    int i = j;
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.setOnMaterialLoadFinishListener(new bnie(this));
  ...
  public int a(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Bnra.a(localFrame).getTextureId();
  }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    ...
    for (;;)
    {
      ...
      {
        bnzb.d(jdField_a_of_type_JavaLangString, "[setVideoMaterial] material is same");
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (bnpm.jdField_a_of_type_Boolean)
    {
      if (!this.jdField_a_of_type_Bnpm.a())
      {
        this.jdField_a_of_type_Bnpm.c();
        this.g = this.jdField_a_of_type_Bnpm.a();
        this.h = this.jdField_a_of_type_Bnpm.b();
      }
      localObject = this.jdField_b_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Bnpm.c(), this.e, this.f);
    }
    for (;;)
    {
      int i;
      ...
      if ((bool) && (g()))
      {
        bnlm.a.jdField_a_of_type_Boolean = true;
