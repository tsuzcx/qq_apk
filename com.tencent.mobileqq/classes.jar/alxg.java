  ...
  extends amgf
{
  ...
  public alxg(DiscussionMemberListInnerFrame paramDiscussionMemberListInnerFrame)
  {
  ...
  private void b()
  {
    ...
    bjxa localbjxa = (bjxa)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app.getManager(QQManagerFactory.QIDIAN_MANAGER);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localObject3 != null) && ((localObject3 == null) || (!localbjxa.f(((DiscussionMemberInfo)localObject3).memberUin)))) {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mIsPutMySelfFirst) && (localObject1 != null))
    {
      ...
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(anvx.a(2131702841), localObject3);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562851, paramViewGroup, false);
      localalxh = new alxh(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame, null);
      paramView.setTag(localalxh);
      localalxh.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376837));
      localalxh.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379987));
      localalxh.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131364612));
      localalxh.c = ((ImageView)paramView.findViewById(2131368381));
      localalxh.b = ((TextView)paramView.findViewById(2131371803));
    }
    for (;;)
    {
      localalxh = (alxh)paramView.getTag();
      Object localObject;
      if (i < 0)
      {
        i = -(i + 1) - 1;
        ...
        {
          localalxh.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
          localalxh.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          localalxh.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          localalxh.c.setImageBitmap(a(((DiscussionMemberInfo)localObject).memberUin));
          localalxh.b.setText(ContactUtils.getDiscussionMemberName((DiscussionMemberInfo)localObject, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
          localalxh.jdField_a_of_type_JavaLangString = ((DiscussionMemberInfo)localObject).memberUin;
          ...
          localalxh.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          label316:
          if ((AppSetting.c) && (localalxh.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            if (!localalxh.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
              break label430;
            }
            paramView.setContentDescription(ContactUtils.getDiscussionMemberName((DiscussionMemberInfo)localObject, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) + anvx.a(2131702847));
          }
          label382:
      ...
      for (;;)
      {
        ...
        return paramView;
        localalxh.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break;
        label418:
        localalxh.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
        break label316;
        label430:
        paramView.setContentDescription(ContactUtils.getDiscussionMemberName((DiscussionMemberInfo)localObject, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) + anvx.a(2131702830));
        break label382;
        localalxh.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        localalxh.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
        localalxh.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        localalxh.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691767), new Object[] { ((String)localObject).toLowerCase() }));
      }
    }
  }
}
