  ...
  implements Manager
{
  ...
  public anho(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<EmosmPb.SmallYellowItem> a(List<EmosmPb.SmallYellowItem> paramList)
  {
    ...
    for (;;)
    {
      if (angd.a().a(i).a(j))
      {
        ...
        m = n;
        break;
        j = axjs.jdField_a_of_type_AndroidUtilSparseIntArray.get(i);
        i = j;
  ...
  private List<EmosmPb.SmallYellowItem> a(List<EmosmPb.SmallYellowItem> paramList1, List<EmosmPb.SmallYellowItem> paramList2)
  {
    ...
    for (localList = paramList2;; localList = null)
    {
      ...
      for (;;)
      {
        ...
        Collections.sort(localList, new anhp(this));
        if (QLog.isColorLevel())
        {
        ...
        while (paramList2.hasNext())
        {
          ...
          if ((paramList1.contains(localObject2)) || (angd.a().a(((EmosmPb.SmallYellowItem)localObject1).type.get()).a(((EmosmPb.SmallYellowItem)localObject1).id.get()))) {
            paramList2.remove();
          } else {
  ...
  public List<EmosmPb.SmallYellowItem> a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() < 1))
    {
      ...
      if (i < this.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        if (j > awbk.b.length)
        {
          ...
          k = axjs.jdField_a_of_type_AndroidUtilSparseIntArray.get(j);
          j = k;
          ...
          label187:
          if (!angd.a().a(((EmosmPb.SmallYellowItem)localObject2).type.get()).a(((EmosmPb.SmallYellowItem)localObject2).id.get())) {
            break label315;
          }
          if (QLog.isColorLevel()) {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (localList != null))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (angd.a().a(localSmallYellowItem.type.get()).a(localSmallYellowItem.id.get())) {
  ...
  public void a(File paramFile1, File paramFile2)
  {
    ...
    {
      localObject2 = bace.a(paramFile1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if (localSmallYellowItem.id.get() == axjs.c[i]) {
            ((Iterator)localObject2).remove();
          }
        }
        else
        {
          ...
          bace.a(paramFile2.getAbsolutePath(), paramFile1.toByteArray(), false);
          return;
        }
      }
  ...
  public void a(List<EmosmPb.SmallYellowItem> paramList)
  {
    ...
    this.jdField_a_of_type_Boolean = anmh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    if (i < paramList.size())
    {
      ...
      if (j == 1) {
        if ((m >= 0) && (m < awbk.b.length))
        {
          ...
          if ((j >= axjs.jdField_a_of_type_Int) || (j < 0))
          {
      ...
      for (;;)
      {
        ...
        if (j == 2)
        {
          k = axjs.jdField_a_of_type_AndroidUtilSparseIntArray.get(m);
          j = k;
          if (jdField_a_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(k)))
          {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      bace.a(((File)localObject2).getAbsolutePath(), localSubCmd0x13Rsp.toByteArray(), false);
      try
      {
  ...
  public List<EmosmPb.SmallYellowItem> b()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      localObject3 = bace.a((File)localObject3);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((k >= 0) && (k < axjs.jdField_a_of_type_Int)) {
          break label776;
        }
