  ...
  implements aira
{
  ...
  aiqz jdField_a_of_type_Aiqz = aiqz.a();
  String jdField_a_of_type_JavaLangString;
  List<aiqy> jdField_a_of_type_JavaUtilList;
  Paint b = new Paint();
  int c;
  int d;
  
  public aiqw(Resources paramResources)
  {
  ...
  public List<aiqy> a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        List localList1 = this.jdField_a_of_type_Aiqz.a(this);
        ...
        if (i < localList1.size())
        {
          ...
          this.jdField_a_of_type_JavaUtilList.add(new aiqx(this, i, localDiyPendantSticker.angle, localDiyPendantSticker.text, localDiyPendantSticker.fontId, localDiyPendantSticker.fontType, j));
          i += 1;
          continue;
        }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((aiqy)((Iterator)localObject).next()).a(paramCanvas, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
    }
  }
