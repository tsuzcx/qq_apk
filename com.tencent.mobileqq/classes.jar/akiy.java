  ...
  extends ajtd
{
  ...
  public akiy(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      awmj localawmj = new awmj(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new awmk(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      awhl.a.put(awhl.a(localawmj.a), localArrayList2);
      ...
      localObject1 = new awmi((String)localObject1, (String)localObject2);
      awhl.b.put(awhl.a(localawmj.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localawmj, localArrayList2, (awmi)localObject1));
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          localawkw.jdField_a_of_type_JavaLangString = localAssociationItem.word.get().toStringUtf8();
          localawkw.jdField_b_of_type_JavaLangString = localAssociationItem.sub_word.get().toStringUtf8();
          localawkw.d = localAssociationItem.pic_url.get().toStringUtf8();
          localawkw.jdField_c_of_type_JavaLangString = localAssociationItem.jmp_url.get().toStringUtf8();
          localawkw.jdField_b_of_type_Int = localAssociationItem.type.get();
          localawkw.jdField_c_of_type_Int = localAssociationItem.group_mask.get();
          localArrayList.add(localawkw);
          continue;
        }
  ...
  private void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new axra(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, vel.a(null) }).a();
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        awvy.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new awoa((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bbjn.s(BaseApplicationImpl.getContext(), i);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (((UnifyTabSearch.RspBody)localObject1).search_ver.has()) {
          awvy.a("UnifySearch.Tab", arrayOfLong, ((UnifyTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
        ...
        Object localObject3 = new awqf();
        if (bool2) {
          ((awqf)localObject3).a(true);
        }
        paramToServiceMsg = ((awqf)localObject3).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public List<awof> a(Object... paramVarArgs)
  {
    ...
    label193:
    for (boolean bool1 = awvv.b(i);; bool1 = true)
    {
  ...
  public void a()
  {
    ...
    localReqBody.version.set(ByteStringMicro.copyFromUtf8("8.2.8"));
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bbjn.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(awvy.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bbjn.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", awiu.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (awhl.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              awvy.a("sub_result", "active_search", new String[] { paramString1, awvy.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = awhl.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((awmk)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<awof> paramList)
  {
    ...
    {
      localObject1 = new awpm(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((awpm)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((awpm)localObject1).c(null);
      ((awpm)localObject1).a(bool2);
      if ((localObject1 != null) && (((awop)localObject1).b()))
      {
        ((awop)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((awop)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        l2 = paramLong;
        break label315;
        switch (((UnifySearchCommon.ResultItem)localObject3).layout_id.get())
        {
        case 5: 
        case 10: 
        default: 
          break;
        case 2: 
          localObject1 = new awon(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 3: 
          localObject1 = new awpj(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 4: 
          localObject1 = new awoo(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 7: 
          localObject1 = new awow(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 6: 
          localObject1 = new awpf(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 8: 
          localObject1 = new awpc(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 9: 
          localObject1 = new awpd(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 11: 
          localObject1 = new awot(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 12: 
          localObject1 = new awor(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 13: 
          localObject1 = new awou(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 14: 
          localObject1 = new awpe(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 15: 
          localObject1 = new awpb(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 16: 
          localObject1 = new awoz(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 17: 
          localObject1 = new awpa(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 18: 
          localObject1 = new awoy(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
          l2 = l1 - 1L;
          continue;
          label939:
          ...
          {
            localObject1 = new awpp(paramString, str7, -4, str5);
            ((awpp)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            localArrayList2.add(localObject1);
            l2 = l1;
          }
          else
          {
            localObject1 = new awne(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
            l2 = l1;
            if (localObject1 != null)
            {
              ((awne)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
              ((awne)localObject1).c = bool1;
              ((awne)localObject1).g = i;
              ((awne)localObject1).a = paramInt;
              localArrayList2.add(localObject1);
              l2 = l1;
            }
          }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new awnz(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label1262:
      paramList.add(new awnd(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  {
    return bbdj.a(BaseApplication.getContext().getFileStreamPath(paramString));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bbjn.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = awpn.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
