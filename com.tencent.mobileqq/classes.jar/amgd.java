...
public class amgd
{
  ...
  public static amgd a()
  {
    if (jdField_a_of_type_Amgd == null) {}
    try
    {
      if (jdField_a_of_type_Amgd == null) {
        jdField_a_of_type_Amgd = new amgd();
      }
      return jdField_a_of_type_Amgd;
    }
    finally {}
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject2.length == 3)
    {
      ...
      {
        localObject1 = new File(bgks.c((String)localObject1));
        if (((File)localObject1).exists())
        {
          ...
          localObject1 = bggl.a(((File)localObject1).getAbsolutePath());
  ...
  public Bitmap a(amga paramamga, int paramInt)
  {
    if ((paramamga == null) || (TextUtils.isEmpty(paramamga.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramamga.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramamga.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamga);
      paramamga = BaseApplicationImpl.getApplication().getRuntime();
      if ((paramamga instanceof QQAppInterface)) {
        a((QQAppInterface)paramamga, 500);
      }
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramamga.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramamga.jdField_a_of_type_JavaLangString);
    }
  }
  
  public Bitmap a(amge paramamge, String paramString, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    Object localObject = bgks.a(String.valueOf(paramInt1));
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isFontLoaded(paramInt1))
    {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamge);
      if (bgks.a(String.valueOf(paramInt1)))
      {
        if (QLog.isColorLevel()) {
    ...
    paramamge = new ETFont(paramInt1, (String)localObject, paramFloat);
    paramamge.setColor(paramInt3);
    try
    {
      localObject = Bitmap.createBitmap(paramInt4, paramInt5, Bitmap.Config.ARGB_8888);
      if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isPaintableChar(paramString.charAt(0), paramamge)) {
        break label590;
      }
      for (paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramamge, paramPaint); paramInt1 > paramInt4; paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramamge, paramPaint)) {
        paramamge.mFontSize -= 1;
      }
      paramInt2 = (paramInt4 - paramInt1) / 2;
    }
    catch (OutOfMemoryError paramamge)
    {
      QLog.d("DiyPendantFetcher", 1, "fetchTextWithFont Bitmap.createBitmap OutOfMemoryError: " + paramamge.getMessage());
      return null;
    }
    paramInt1 = 0;
    paramPaint = new Paint.FontMetrics();
    if (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getFontMetrics(paramPaint, paramamge))
    {
      paramFloat = paramPaint.bottom;
      float f = paramPaint.top;
      paramInt1 = (int)((paramInt5 - (paramFloat - f)) / 2.0F);
    }
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_drawText(paramString, (Bitmap)localObject, paramInt2, paramInt1, paramamge))
    {
  ...
  public Typeface a(amge paramamge, int paramInt1, int paramInt2)
  {
    if ((paramamge == null) || (paramInt1 <= 0)) {
      return null;
    }
    gb localgb = (gb)this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(Integer.valueOf(paramInt1));
    if ((localgb != null) && (localgb.jdField_a_of_type_AndroidGraphicsTypeface != null)) {
      return localgb.jdField_a_of_type_AndroidGraphicsTypeface;
    }
    if (QLog.isColorLevel()) {
  ...
  public DiyPendantEntity a(QQAppInterface paramQQAppInterface, String paramString, anil paramanil)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramString))
      {
        ...
        if (paramanil != null) {
          paramanil.onUpdate(1, true, paramQQAppInterface);
        }
    ...
    } while (paramanil == null);
    paramanil.onUpdate(1, true, paramString);
    return localObject;
    if (QLog.isColorLevel()) {
    ...
    ((amgf)paramQQAppInterface.a(114)).a((List)localObject, paramanil);
    return null;
  }
  ...
  public List<DiyPendantSticker> a(amga paramamga)
  {
    if ((paramamga == null) || (TextUtils.isEmpty(paramamga.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramamga.jdField_a_of_type_JavaLangString)) {
      return ((DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramamga.jdField_a_of_type_JavaLangString)).getStickerInfoList();
    }
    if (QLog.isColorLevel()) {
      QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramamga.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    String str = bgks.a(String.valueOf(paramInt1));
    if (!this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.containsKey(Integer.valueOf(paramInt1)))
    {
      gb localgb = new gb(paramInt1, str);
      localgb.b = paramInt2;
      this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.put(Integer.valueOf(paramInt1), localgb);
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, List<DiyPendantEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramBoolean)
      {
        ...
        ExtensionInfo localExtensionInfo = localanmw.a(localDiyPendantEntity.uinAndDiyId.split("_")[0]);
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localgb = (gb)this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(Integer.valueOf(Integer.parseInt(paramString)));
      if (localgb != null)
      {
        if (localgb.b != 1) {
          break label128;
        ...
        if ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(localgb.jdField_a_of_type_JavaLangString, Integer.parseInt(paramString), true))) {
          d();
        }
      }
    }
    label128:
    while (!new File(localgb.jdField_a_of_type_JavaLangString).exists()) {
      return;
    }
    localgb.jdField_a_of_type_AndroidGraphicsTypeface = Typeface.createFromFile(localgb.jdField_a_of_type_JavaLangString);
  }
