  ...
  extends Thread
{
  ...
  public amgd(TraeAudioManager arg1, TraeAudioManager paramTraeAudioManager2)
  {
  ...
  void a(int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new amgg(this);
  ...
  void a(HashMap paramHashMap)
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeMediaPlayer == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeMediaPlayer = new TraeMediaPlayer(this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext, new amge(this));
    }
  ...
  void b()
  {
    ...
    for (;;)
    {
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgl != null)
      {
        if (QLog.isColorLevel()) {
          QLog.w("TRAE", 2, "_switchThread:" + this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgl.a());
        }
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgl.f();
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgl = null;
      }
      if (this.jdField_a_of_type_ComTencentSharpJniTraeMediaPlayer != null) {
  ...
  void c()
  {
    ...
    try
    {
      ...
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc = this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.a(this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_ComTencentSharpJniTraeAudioManager$DeviceConfigManager);
      IntentFilter localIntentFilter = new IntentFilter();
      localIntentFilter.addAction("android.intent.action.HEADSET_PLUG");
      localIntentFilter.addAction("android.media.AUDIO_BECOMING_NOISY");
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc.b(localIntentFilter);
  ...
  void d()
  {
    ...
    {
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidMediaAudioManager = ((AudioManager)this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext.getSystemService("audio"));
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc == null) {
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc = this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.a(this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_ComTencentSharpJniTraeAudioManager$DeviceConfigManager);
      }
  ...
  void e()
  {
    ...
    {
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc != null) {
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc.a();
      }
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Amgc = null;
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext != null)
      {
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_ComTencentSharpJniTraeAudioManager);
        IntentFilter localIntentFilter = new IntentFilter();
  ...
  public void run()
  {
    AudioDeviceInterface.LogTraceEntry("");
    Looper.prepare();
    this.jdField_a_of_type_AndroidOsHandler = new amgf(this);
    c();
    synchronized (this.jdField_a_of_type_ArrayOfBoolean)
    {
