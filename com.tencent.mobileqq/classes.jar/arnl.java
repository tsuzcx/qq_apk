...
public class arnl
{
  ...
  public arnl(arnm paramarnm)
  {
    this.jdField_a_of_type_Arnm = paramarnm;
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender = new TextureRender();
    this.jdField_a_of_type_Int = arnh.a(paramarnm.jdField_c_of_type_Int, paramarnm.jdField_b_of_type_Int);
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer = new RenderBuffer(paramarnm.jdField_c_of_type_Int, paramarnm.jdField_b_of_type_Int);
    arni.a(false);
    this.jdField_a_of_type_Long = RecogProxy.QCodeInit(this.jdField_a_of_type_Arnm.jdField_a_of_type_Int, this.jdField_a_of_type_Arnm.jdField_b_of_type_Int, this.jdField_a_of_type_Arnm.jdField_c_of_type_Int, this.jdField_a_of_type_Arnm.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Arnm.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Arnm.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Arnm.d, 0.35F);
  ...
  public List<akut> a(int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Long != 0L)
        {
          ...
          if (j < i)
          {
            ...
            localakut.jdField_a_of_type_Int = m;
            localakut.jdField_a_of_type_Float = localObject2[4];
      ...
      for (;;)
      {
        ...
        try
        {
          ??? = arnh.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_Arnm.jdField_c_of_type_Int, this.jdField_a_of_type_Arnm.jdField_b_of_type_Int);
          ...
          arni.a((Bitmap)???, (String)localObject2);
