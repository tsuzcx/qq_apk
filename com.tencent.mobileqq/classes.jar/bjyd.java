...
public abstract class bjyd
  extends BusinessHandler
{
  private bjyc jdField_a_of_type_Bjyc;
  public bjyh a;
  private INetEngine jdField_a_of_type_ComTencentMobileqqTransfileINetEngine;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private List<bjyg> jdField_a_of_type_JavaUtilList = new ArrayList();
  private final AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger();
  
  protected bjyd(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_Bjyh = new bjye(this);
    this.jdField_a_of_type_Bjyc = ((bjyc)this.app.getBusinessHandler(BusinessHandlerFactory.BIG_DATA_GET_IP_HANDLER));
  ...
  protected bjyd(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Bjyh = new bjye(this);
    this.jdField_a_of_type_Bjyc = ((bjyc)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BIG_DATA_GET_IP_HANDLER));
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Bjyh);
  ...
  {
    int i = 1;
    String str = this.jdField_a_of_type_Bjyc.a();
    if (this.jdField_a_of_type_Bjyc.a() == null) {
      if (paramBoolean) {
        i = 2;
      }
    }
    do
    {
      do
      {
        ...
        {
          return i;
        } while (this.jdField_a_of_type_Bjyc.a(paramInt1, paramMessageMicro, paramInt2, paramObject));
        return 3;
        if (this.jdField_a_of_type_Bjyc.b() != null) {
          break;
        }
        if (paramBoolean) {
          return 4;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          bjyg localbjyg = (bjyg)localIterator.next();
          a(localbjyg.a(), localbjyg.a(), true, localbjyg.b(), localbjyg.a());
        }
      }
  ...
  private void a(int paramInt1, MessageMicro<?> paramMessageMicro, boolean paramBoolean, int paramInt2, Object paramObject)
  {
    ...
    if (i == 1)
    {
      ...
      if (!paramBoolean) {
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          this.jdField_a_of_type_JavaUtilList.add(new bjyg(paramInt1, paramMessageMicro, paramInt2, paramObject));
          return;
        }
      }
    }
    else
    {
      ...
      try
      {
        ...
        localObject2 = new Cryptor().encrypt(paramMessageMicro.toByteArray(), this.jdField_a_of_type_Bjyc.a());
        ...
        while (i < "8.4.10".length())
        {
          ??? = paramMessageMicro;
          if ("8.4.10".charAt(i) != '.') {
            ??? = paramMessageMicro.concat(Character.toString("8.4.10".charAt(i)));
          }
          i += 1;
      ...
      ((im_msg_head.LoginSig)???).bytes_sig.set(ByteStringMicro.copyFrom(this.jdField_a_of_type_Bjyc.b()));
      ...
      try
      {
        ...
        ((HttpNetReq)localObject2).mCallback = new bjyf(paramInt1, this, this.jdField_a_of_type_Bjyc.a(), paramInt2, paramObject);
  ...
  private void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          bjyg localbjyg = (bjyg)localIterator.next();
          a(localbjyg.a(), false, null, localbjyg.b(), localbjyg.a());
        }
      }
      this.jdField_a_of_type_JavaUtilList.clear();
    }
