...
public class aiik
  implements bbvd
{
  public aiik(ShortVideoPreviewActivity paramShortVideoPreviewActivity) {}
  ...
  public void a(bbva parambbva)
  {
    ...
    do
    {
      ...
      {
        return;
        bbar.a(this.a.jdField_a_of_type_AndroidViewSurfaceView, this.a.e, this.a.f, this.a.jdField_a_of_type_Bbva.d(), this.a.jdField_a_of_type_Bbva.e());
      } while (this.a.j != 10);
      parambbva.a(localSurfaceHolder);
      this.a.jdField_a_of_type_Int = parambbva.c();
