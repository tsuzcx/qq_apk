  ...
  extends bdom
{
  ...
  private void a(Context paramContext, Resources paramResources, RelativeLayout paramRelativeLayout, View paramView, LinearLayout paramLinearLayout, TextView paramTextView1, TextView paramTextView2)
  {
    ...
    paramResources.setId(2131377823);
    paramView = new ImageView(paramContext);
    paramView.setImageResource(2130850465);
    ...
    paramTextView2.setId(2131377824);
    ...
    paramResources.addRule(3, 2131377823);
    ...
    paramResources.setId(2131377825);
    paramResources.setImageResource(2130850467);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(14);
    paramView.addRule(3, 2131377824);
    paramRelativeLayout.addView(paramResources, paramView);
    paramResources = new RelativeLayout(paramContext);
    paramView = new ImageView(paramContext);
    paramView.setId(2131377827);
    paramView.setImageResource(2130850468);
    ...
    paramContext.setImageResource(2130850464);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(15);
    paramView.addRule(0, 2131377827);
    ...
    paramContext.addRule(1, 2131377827);
    ...
    paramContext.addRule(3, 2131377825);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localRelativeLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, agej.a(290.0F, localResources)));
      ...
      paramView = (bdol)localIterator.next();
      localObject5 = paramView.a;
      if ((!"type".equals(localObject5)) || (!(paramView instanceof bdtr))) {
        break label264;
      }
      j = ((bdtr)paramView).o;
      i = j;
    ...
    for (;;)
    {
      ...
      else
      {
        if (("picture".equals(localObject5)) && (localObject4 == null))
        {
          ...
          {
            float f = localResources.getDimensionPixelSize(2131296395);
        ...
        {
          if (("head".equals(localObject5)) && ((paramView instanceof bdqh)) && (localObject2 == null))
          {
            ((bdqh)paramView).o = i;
            ...
            continue;
            label531:
            paramView = new bdsx(paramContext.getString(2131718299)).a(paramContext, null, null);
            paramBundle = new LinearLayout.LayoutParams(-1, -2);
            j = agej.a(15.0F, localResources);
            paramView.setLayoutParams(paramBundle);
            paramView.setPadding(j, j, j, j);
            paramBundle = (TextView)paramView.findViewById(2131378096);
            ...
            paramBundle.setImageResource(2130850458);
            ...
            ((RelativeLayout.LayoutParams)localObject4).rightMargin = agej.a(7.0F, localResources);
            paramView.addView(paramBundle, (ViewGroup.LayoutParams)localObject4);
            paramContext = new ImageView(paramContext);
            paramContext.setImageResource(2130850459);
            paramBundle = new RelativeLayout.LayoutParams(-2, -2);
            paramBundle.addRule(1, localObject1.getId());
            paramBundle.addRule(15);
            paramBundle.leftMargin = agej.a(7.0F, localResources);
            paramView.addView(paramContext, paramBundle);
            paramContext = new RelativeLayout.LayoutParams(-1, -2);
            paramContext.topMargin = agej.a(5.0F, localResources);
            paramContext.addRule(3, 2131377826);
            paramView.setLayoutParams(paramContext);
            paramView.setId(2131377824);
            localRelativeLayout.addView(paramView);
            paramContext = new RelativeLayout.LayoutParams(-2, -2);
            paramContext.addRule(14);
            paramContext.addRule(3, 2131377824);
            paramContext.topMargin = agej.a(10.0F, localResources);
            if (localObject2 != null)
            {
              localObject2.setId(2131377823);
