...
public class bdrp
  extends bdrm
{
  static azia jdField_a_of_type_Azia = new bdrq();
  private static bdrp jdField_a_of_type_Bdrp;
  private static bdrr jdField_a_of_type_Bdrr = new bdrr();
  private static int b;
  
  public bdrp(bdqs parambdqs, AppRuntime paramAppRuntime, int paramInt)
  {
    super(parambdqs, paramAppRuntime, paramInt);
  }
  ...
  public static void b(Context paramContext)
  {
    ...
    paramContext.registerReceiver(jdField_a_of_type_Bdrr, new IntentFilter("com.tencent.qplus.THEME_INVALIDATE"), "com.tencent.msg.permission.pushnotify", null);
  }
  
  public static void c(Context paramContext)
  {
    paramContext.unregisterReceiver(jdField_a_of_type_Bdrr);
  }
  
  public static void d()
  {
    ((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).addObserver(jdField_a_of_type_Azia);
  }
  
  private static void d(int paramInt1, int paramInt2)
  {
    if (jdField_a_of_type_Bdrp != null) {
      jdField_a_of_type_Bdrp.c();
    }
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    bdqs localbdqs = new bdqs(localAppRuntime, paramInt1);
    jdField_a_of_type_Bdrp = new bdrp(localbdqs, localAppRuntime, paramInt2);
    localbdqs.a(jdField_a_of_type_Bdrp);
  }
