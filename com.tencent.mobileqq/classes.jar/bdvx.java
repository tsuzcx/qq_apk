  ...
  implements zop
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new bhht((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((bhht)localObject).a(paramString);
    ((bhht)localObject).setCancelable(false);
    ((bhht)localObject).setOnDismissListener(new bdvz(this));
    this.jdField_a_of_type_Bhht = ((bhht)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      QQToast.a((Context)localObject, 2131694062, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131719318));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693203));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694201));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694202));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131695598));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131719323));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bjnw localbjnw = (bjnw)bjon.a(this.mRuntime.a(), null);
    localbjnw.a(2131719316);
    localbjnw.a(2131719317, 3);
    localbjnw.c(2131690620);
    localbjnw.setOnDismissListener(new bdwa(this));
    localbjnw.a(new bdwb(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!NetworkUtil.isNetSupport(localBaseActivity)) {
      QQToast.a(localBaseActivity, 2131694062, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	bdvx:mRuntime	Lbgve;
    //   4: invokevirtual 70	bgve:a	()Landroid/app/Activity;
    //   7: astore_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          bdvw.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Zon;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Zon.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        paramJsBridgeListener.a("8.4.8.4810");
        break label2264;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bhzh.d(bhpc.a().a())));
        break label2264;
      }
    ...
    else
    {
      ...
      if ("updateTroopBindedPubAccount".equals(paramString3))
      {
        try
        {
          ...
          if (j > 0)
          {
            ...
            this.jdField_a_of_type_Zon.a(l, paramString1);
          }
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("getLastSpeakMessage".equals(paramString3))
      {
        try
        {
          ...
          paramString2 = paramString2.optString("callback");
          this.jdField_a_of_type_Zon.a(paramJsBridgeListener, paramString1, new bdvy(this, paramString2));
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("notifyTroopEnterEffectStatus".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Zon.a(i, j, k, paramString1);
      ...
      else if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Zon, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2264;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Zon.a(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Zon.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      if (bool) {
        QQToast.a((Context)localObject2, 2131719315, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        QQToast.a((Context)localObject2, 2131719320, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131719327);
    }
    for (;;)
    {
      ...
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131719314);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131719319);
      }
    }
  }
