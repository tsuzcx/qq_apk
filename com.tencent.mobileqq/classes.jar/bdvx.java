...
{
  public bdvx(MiniAppTextArea paramMiniAppTextArea, JSONObject paramJSONObject1, JSONObject paramJSONObject2, int paramInt, JSONObject paramJSONObject3, bdfs parambdfs) {}
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramCharSequence != null) && (paramCharSequence.length() == 0))
    {
      if (this.jdField_a_of_type_OrgJsonJSONObject != null)
      {
        ...
        this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageWidgetMiniAppTextArea.setTextColor(bdyk.a(this.jdField_a_of_type_OrgJsonJSONObject.optString("color")));
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt3 == 0)
        {
          ...
          this.jdField_a_of_type_Bdfs.a("onKeyboardValueChange", localJSONObject.toString(), MiniAppTextArea.a(this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageWidgetMiniAppTextArea).b());
          return;
          if (this.b == null) {
            break;
          }
          this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageWidgetMiniAppTextArea.setTextSize(2, this.b.optInt("fontSize"));
          this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageWidgetMiniAppTextArea.setTextColor(bdyk.a(this.b.optString("color")));
          break;
        }
        if (paramInt2 != 0)
        {
      ...
      {
        bdnw.d("MiniAppTextArea", "onTextChanged error", paramCharSequence);
        return;
      }
      continue;
      label299:
