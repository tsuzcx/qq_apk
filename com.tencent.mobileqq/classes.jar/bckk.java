...
public class bckk
  extends bcjd
{
  private TextView a(Context paramContext, List<bcgw> paramList)
  {
    ...
    for (int i = paramList.size();; i = 0)
    {
      ...
      {
        paramList = (bcgw)paramList.get(i - 1);
        if ((paramList instanceof bcgy))
        {
          paramContext.setText(((bcgy)paramList).b());
  ...
  private void a(LinearLayout paramLinearLayout)
  {
    ...
    paramLinearLayout.getViewTreeObserver().addOnGlobalLayoutListener(new bckl(this, paramLinearLayout));
  }
  ...
  protected int a(Resources paramResources, int paramInt, bcgw parambcgw)
  {
    int i = 4;
    if (paramInt == 1) {
      i = 7;
  ...
  protected ArrayList<bcgw> a(ArrayList<bcgw> paramArrayList)
  {
    ...
    if (j < m)
    {
      localObject2 = (bcgw)paramArrayList.get(j);
      if ((j == 0) && ((localObject2 instanceof StructMsgItemTitle)))
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.hasTSum()) && (localStructMsgItemTitle.b().endsWith(amtj.a(2131713654))))
        {
          k = 1;
          label92:
          if (k == 0) {
          ...
          i = 1;
          label99:
          if (!(localObject2 instanceof bcjb)) {
            break label254;
          }
        }
      }
    ...
    {
      if (i == 0) {
        paramArrayList = new StructMsgItemTitle(amtj.a(2131713640));
      }
      for (;;)
      {
        paramArrayList.f("34");
        ...
        {
          localObject1 = (bcgw)paramArrayList.next();
          if ((localObject1 instanceof bcgy))
          {
            localObject2 = (bcgy)localObject1;
            ((bcgy)localObject2).f("26");
            ((bcgy)localObject2).e("#777777");
            ((bcgy)localObject2).g("12");
            ((bcgy)localObject2).h("2");
            ((bcgw)localObject1).jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg;
        ...
        break label92;
        label254:
        if (((localObject2 instanceof StructMsgItemTitle)) || ((localObject2 instanceof bclv))) {
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int i = localResources.getDimensionPixelSize(2131298985);
    int m = localResources.getDimensionPixelSize(2131298986);
    int n = localResources.getDimensionPixelSize(2131298984);
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (bcgw)((ArrayList)localObject1).get(i);
      ...
      localView = ((bcgw)localObject2).a(paramContext, localLinearLayout2.getChildAt(i), paramBundle);
      if (localView != null) {
        break label390;
      }
    }
    ...
    do
    {
      ...
      paramView.setBackgroundResource(2130850396);
      paramView.setPadding(i, 0, 0, 0);
      paramView.setTextSize(1, 13.0F);
      paramView.setGravity(16);
      if (Build.VERSION.SDK_INT > 22) {}
      for (i = localResources.getColor(2131165665, paramContext.getTheme());; i = localResources.getColor(2131165665))
      {
      ...
      if (i > 0) {
        ((LinearLayout.LayoutParams)localObject3).topMargin = a(localResources, i, (bcgw)localObject2);
      }
      localObject2 = ((bcgw)localObject2).jdField_a_of_type_JavaLangString;
      ...
      localObject3 = (bcgw)((ArrayList)localObject1).get(i);
      ((bcgw)localObject3).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      if ((localObject3 instanceof StructMsgItemTitle)) {
        ((StructMsgItemTitle)localObject3).a(a(), this.p);
      }
      localView = ((bcgw)localObject3).a(paramContext, null, paramBundle);
    } while (localView == null);
    AIOUtils.dp2px(10.0F, localResources);
    Object localObject2 = new LinearLayout.LayoutParams(-1, -2);
    if (i > 0) {
      ((LinearLayout.LayoutParams)localObject2).topMargin = a(localResources, i, (bcgw)localObject3);
    }
    Object localObject3 = ((bcgw)localObject3).jdField_a_of_type_JavaLangString;
    ...
    paramContext = (bcgw)this.jdField_a_of_type_JavaUtilArrayList.get(i - 1);
    if ((paramContext instanceof bcgy)) {
      paramView.setText(((bcgy)paramContext).ai);
    }
