...
public class qfm
{
  static void a(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo)
  {
    if (paramRspBody.bytes_proteus_json_data.has())
    {
      ...
      if (!TextUtils.isEmpty(paramRspBody))
      {
        ...
        tjf.a(paramRspBody, paramFastWebArticleInfo.jdField_a_of_type_AndroidUtilSparseArray);
      }
    }
  }
  
  static void a(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, qfj paramqfj)
  {
    if (paramRspBody.rpt_msg_style_card.has())
    {
      ...
      if (paramqfj != null) {
        paramqfj.a(paramFastWebArticleInfo.j);
      }
    }
  }
  
  static void a(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, qfj paramqfj, String paramString)
  {
    if (paramRspBody.msg_rsp_biu_count.has())
    {
      ...
      if (paramqfj != null) {
        paramqfj.a(paramFastWebArticleInfo.c, paramString);
      }
    }
  }
  
  static void b(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, qfj paramqfj)
  {
    Object localObject;
    int i;
    ...
    for (paramRspBody = ((oidb_cmd0xb54.ArticleBusiness)localObject).bytes_business_cash_info.get().toStringUtf8();; paramRspBody = "")
    {
      ...
      if (paramqfj != null) {
        paramqfj.a(paramFastWebArticleInfo, i, paramRspBody);
      }
      return;
      if (paramqfj != null) {
        paramqfj.a(paramFastWebArticleInfo, 0, "");
      }
  ...
  static void b(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, qfj paramqfj, String paramString)
  {
    if (paramRspBody.uint32_like_count.has())
    {
      paramFastWebArticleInfo.jdField_a_of_type_Int = paramRspBody.uint32_like_count.get();
      if (paramqfj != null) {
        paramqfj.a(paramFastWebArticleInfo.jdField_a_of_type_Int, paramString);
      }
      QLog.d("FastWebModuleUtils", 2, "0xb54 resp like count is : " + paramFastWebArticleInfo.jdField_a_of_type_Int);
    }
  }
  
  static void c(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, qfj paramqfj, String paramString)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      if (paramqfj != null) {
        paramqfj.a(paramFastWebArticleInfo.jdField_a_of_type_Boolean, paramString);
      }
