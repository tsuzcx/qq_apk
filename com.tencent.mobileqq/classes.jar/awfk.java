...
public class awfk
  implements View.OnClickListener, ViewTreeObserver.OnPreDrawListener, awfo, awft, hk
{
  ...
  bbqe jdField_a_of_type_Bbqe;
  bbrk jdField_a_of_type_Bbrk;
  private bbrq jdField_a_of_type_Bbrq = new awfl(this);
  public ETTextView a;
  ...
  public Observer a;
  WeakReference<awfp> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean;
  long jdField_b_of_type_Long;
  View jdField_b_of_type_AndroidViewView;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  SingleLineTextView jdField_b_of_type_ComTencentWidgetSingleLineTextView;
  WeakReference<awft> jdField_b_of_type_MqqUtilWeakReference;
  ...
  public awfk(Context paramContext, AppInterface paramAppInterface, View paramView, String paramString)
  {
    this.jdField_a_of_type_JavaUtilObserver = new awfm(this);
    ...
    this.h = actn.a(12.0F, paramContext.getResources());
    this.i = 2130845270;
    m();
    a();
  ...
  private void m()
  {
    if (jdField_a_of_type_ArrayOfInt == null)
    {
      ...
      jdField_a_of_type_ArrayOfInt[8] = actn.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[9] = actn.a(17.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[10] = actn.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[11] = actn.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[12] = actn.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  private void n()
  {
    ...
    if (bool1)
    {
      localObject = bbkb.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.time * 1000L);
  ...
  private void o()
  {
    int j;
    Object localObject;
    if (this.jdField_a_of_type_Bbqe.jdField_a_of_type_Bbqg != null)
    {
      j = 1;
      if (j == 0) {
        break label229;
      }
      localObject = this.jdField_a_of_type_Bbqe.n;
      label24:
      ...
      if ((this.jdField_a_of_type_Bbqe.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (TextUtils.isEmpty(this.jdField_a_of_type_Bbqe.n))) {
        break label246;
      }
      localObject = this.jdField_a_of_type_Bbqe.n;
      label86:
      ...
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHint(2131699388);
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextMsg(new ayki((CharSequence)localObject, 1, 20));
  ...
  public View a(RichStatus paramRichStatus)
  {
    ...
    this.jdField_a_of_type_Bbqe = a();
    paramRichStatus.signType = this.jdField_a_of_type_Bbqe.g;
    boolean bool;
    if (this.jdField_a_of_type_Bbqe.jdField_a_of_type_Bbqg != null)
    {
      bool = true;
      this.jdField_a_of_type_Boolean = bool;
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bbqe.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get();
  ...
  protected bbqe a()
  {
    ...
    return awei.a().a(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
  }
  ...
  protected CharSequence a(RichStatus paramRichStatus, awft paramawft, int paramInt)
  {
    ...
    aweo localaweo = (aweo)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(15);
    Resources localResources = this.jdField_a_of_type_AndroidContentContext.getResources();
    SpannableString localSpannableString = new SpannableString(paramRichStatus.toSpannableStringWithoutAction(paramawft));
    if ((paramRichStatus != null) && (localResources != null) && (!TextUtils.isEmpty(paramRichStatus.actionText)))
    {
      ...
      paramawft = (awft)localObject;
      if (!TextUtils.isEmpty(paramRichStatus.dataText)) {
        paramawft = (String)localObject + paramRichStatus.dataText;
      }
      Drawable localDrawable = localResources.getDrawable(2130848540);
      localObject = new SpannableStringBuilder(localSpannableString);
      ((SpannableStringBuilder)localObject).insert(0, "[S] ");
      int j;
      if (localaweo != null)
      {
        paramRichStatus = localaweo.a(paramRichStatus.actionId, 200);
        paramRichStatus = new bcrj(localResources, paramRichStatus, false, false);
      ...
      label273:
      for (paramRichStatus = new awcz(paramRichStatus, 1, paramawft, j, localDrawable, paramInt);; paramRichStatus = new awcz(paramRichStatus, 0, paramawft, j, localDrawable, paramInt))
      {
        ((SpannableStringBuilder)localObject).setSpan(paramRichStatus, 0, "[S]".length(), 17);
        return new ayki((CharSequence)localObject, 1);
        paramRichStatus = bawu.a(localResources, 2130848533);
        break;
      }
    }
    return new ayki(localSpannableString, 1);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561109, null, false));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131375385);
    this.e = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369371);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369459);
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369460);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131365269);
    this.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131378375));
    this.jdField_b_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131378247));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131368538));
    vzo.a(this.jdField_b_of_type_AndroidWidgetImageView, m, m, m, m);
    ...
    vzo.a(this.jdField_a_of_type_AndroidWidgetImageView, m, m, m, m);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131378349));
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setOnTextOrFontChangeListener(this);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setMovementMethod(awfu.a());
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(muf.a);
  ...
  public void a(awfp paramawfp)
  {
    if (paramawfp != null)
    {
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramawfp);
      return;
    }
  ...
  {
    QLog.d("BaseSignViewHolder", 1, new Object[] { "onClick topic=", paramawfs });
    if (this.jdField_b_of_type_MqqUtilWeakReference != null) {}
    for (awft localawft = (awft)this.jdField_b_of_type_MqqUtilWeakReference.get();; localawft = null)
    {
      if (localawft != null) {
        localawft.a(paramawfs, paramView);
      }
      return;
    }
  }
  
  public void a(awft paramawft)
  {
    if (paramawft != null)
    {
      this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(paramawft);
      return;
    }
  ...
  {
    awfy.a(paramETTextView, paramETTextView.getText(), 1);
  }
  
  public void a(ETTextView paramETTextView, CharSequence paramCharSequence)
  {
    awfy.a(paramETTextView, paramCharSequence, 0);
  }
  ...
  protected void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845270);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376204, Integer.valueOf(-1));
    e();
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848607);
  ...
  protected void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable == null)
    {
      ...
      localbbsb = new bbsb(this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable, this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.i);
      this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable.a(localbbsb);
      if (a() != -1) {
        break label190;
      }
    }
    ...
    {
      localbbsb.a(bool);
      this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable.a(this.jdField_a_of_type_Bbrq);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376204, Integer.valueOf(this.jdField_a_of_type_Bbqe.f));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376207, Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId));
  ...
  protected void g()
  {
    ...
    {
      this.jdField_a_of_type_Bbrk = new bbrk(this.jdField_a_of_type_ComTencentCommonAppAppInterface, j);
      localbbse = new bbse(this.jdField_a_of_type_Bbrk, this.jdField_a_of_type_ComTencentCommonAppAppInterface, k);
      ...
      {
        localbbse.a(localETTextView, f1, bool);
        this.jdField_a_of_type_Bbrk.a(localbbse);
        localbbse.a(a());
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376205, Integer.valueOf(j));
        return;
      }
    }
    bbse localbbse = (bbse)this.jdField_a_of_type_Bbrk.a();
    ...
    {
      localbbse.a(localETTextView, f1, bool);
      ((bbse)this.jdField_a_of_type_Bbrk.a()).a(j, k);
      break;
      bool = false;
    }
  }
  ...
  protected void h()
  {
    ...
    int n = jdField_a_of_type_ArrayOfInt[3];
    this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.setShadowColor(n);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Bbqe.e)) {
      j = Color.parseColor(this.jdField_a_of_type_Bbqe.e);
    }
    boolean bool = a(j);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(j);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHintTextColor(k);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848608);
  ...
  public void j()
  {
    ...
    label59:
    for (localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131720839);; localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131720838))
    {
  ...
  public void k()
  {
    ...
    if ((this.jdField_a_of_type_Bbrk != null) && (this.jdField_a_of_type_Bbrk.a() != null)) {
      this.jdField_a_of_type_Bbrk.a().c();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      localawfp = (awfp)this.jdField_a_of_type_MqqUtilWeakReference.get();
    ...
    for (;;)
    {
      ...
      if ((j > 0) && (localawfp != null)) {
        localawfp.a(paramView, j, this);
      }
      return;
      localawfp = null;
      break;
