...
public class bcrx
{
  public static final Comparator<? super acoo> a = new bcry();
  
  public static int a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    return ((acos)paramQQAppInterface.getMessageFacade().getRegistry().a().a(Integer.valueOf(paramInt))).a();
  }
  ...
  public static int a(im_msg_body.RichText paramRichText, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        bcrz localbcrz = new bcrz(paramRichText, paramString, paramArrayList, i, j, localStringBuilder, k).a();
        i = localbcrz.a();
        j = localbcrz.b();
        k = localbcrz.c() + 1;
      }
      ...
      {
        b(paramRichText, localStringBuilder.toString());
        j = i + 1;
      }
      return j;
    }
    ...
    for (;;)
    {
      ...
      if (((im_msg_body.Elem)localObject).secret_file.has())
      {
        ...
        if ((((im_msg_body.SecretFileMsg)localObject).elem_flags2.has()) && (((im_msg_body.SecretFileMsg)localObject).elem_flags2.uint32_color_text_id.has()))
        {
          ...
          continue;
          if (l1 == 4294967295L) {}
          for (long l2 = paramMessageHandler.app.getMessageFacade().getLastC2CBubbleIDFromCache(paramString1, paramString2);; l2 = -1L)
          {
            if (l1 != 4294967295L) {
              l2 = l1;
            }
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, bffl parambffl)
  {
        ...
        for (;;)
        {
          ...
          else if (localInvalidProtocolBufferMicroException.msgtype == -1049)
          {
            try
            {
              ...
              localObject2 = apab.a(localMessageForReplyText.mSourceMsgInfo);
    ...
    paramList = (MessageForMixedMsg)bcsa.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((parambffl != null) && (parambffl.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = parambffl.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      bgcz.a(parambffl.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + bcsc.a.length);
        }
        j = i;
  ...
  private static List<acoo> a(List<im_msg_body.Elem> paramList, QQMessageFacade paramQQMessageFacade)
  {
    ArrayList localArrayList = new ArrayList();
    paramQQMessageFacade = paramQQMessageFacade.getRegistry().a();
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, bcsf parambcsf, long paramLong, int paramInt2)
  {
    if (parambcsf == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | parambcsf.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + parambcsf);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(parambcsf.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(parambcsf.jdField_a_of_type_Int);
        paramString = paramString.replace("+", "");
        ((msg_svc.Trans0x211)localObject).to_uin.set(mry.a(paramString));
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(parambcsf.jdField_a_of_type_ArrayOfByte));
      ...
      parambcsf = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (parambcsf == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(parambcsf));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = bcsc.a(l);
      localbcrg = paramQQAppInterface.getMsgCache();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramMessageRecord = localbcrg.a();
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = bdpo.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131693521);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131693522), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = anvx.a(2131706122);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = HexUtil.bytes2HexStr(apab.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((bdnv)localObject2).a;
              if (localObject2 != null)
              {
                localObject2 = ((List)localObject2).iterator();
                if (((Iterator)localObject2).hasNext())
                {
                  bdnu localbdnu = (bdnu)((Iterator)localObject2).next();
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)apab.a(HexUtil.hexStr2Bytes((String)localObject4));
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bffl parambffl)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, parambffl, null, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bffl parambffl, bcse parambcse, bcre parambcre)
  {
    ...
    do
    {
      ...
      localObject2 = a(localList, paramMessageHandler.app.getMessageFacade());
      a(localList, paramMsg, paramList, (StringBuilder)localObject1, paramMessageHandler.app.getMessageFacade(), paramBoolean2, paramBoolean1, parambffl, (List)localObject2, parambcse, parambcre);
    } while (!QLog.isColorLevel());
  ...
  private static void a(List<acoo> paramList1, List<acoo> paramList2)
  {
    paramList2 = paramList2.iterator();
    while (paramList2.hasNext())
    {
      acoo localacoo = (acoo)paramList2.next();
      if (localacoo != null) {
        localacoo.a(paramList1);
      }
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, List<acoo> paramList1, List<acoo> paramList2)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      while (localIterator.hasNext())
      {
        acoo localacoo = (acoo)localIterator.next();
        if ((localacoo != null) && (localacoo.a(localElem))) {
          paramList1.add(localacoo);
        }
      }
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, bffl parambffl)
  {
    bcrt localbcrt = new bcrt();
    if (paramList1.isEmpty()) {
      localbcrt.f(paramList, paramList1, paramStringBuilder, paramMsg, parambffl);
    }
    if (paramList1.isEmpty()) {
      localbcrt.i(paramList, paramList1, paramStringBuilder, paramMsg, parambffl);
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, QQMessageFacade paramQQMessageFacade, boolean paramBoolean1, boolean paramBoolean2, bffl parambffl, List<acoo> paramList2, bcse parambcse, bcre parambcre)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localacoo = (acoo)paramQQMessageFacade.next();
      } while (localacoo == null);
      bool = localacoo.a(paramList, paramMsg, paramList1, paramStringBuilder, paramBoolean1, paramBoolean2, parambffl, parambcse, parambcre);
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "dispatchDecodePBMsgElements() decoder = [" + localacoo + "], handled = [" + bool + "]");
      }
    } while (!bool);
    a(paramList, paramMsg, paramList1, paramStringBuilder, parambffl);
    b(paramList2);
    paramQQMessageFacade = paramList2.iterator();
    while (paramQQMessageFacade.hasNext())
    {
      paramList2 = (acoo)paramQQMessageFacade.next();
      if (paramList2 != null)
      {
        bool = paramList2.a(paramList, paramMsg, paramList1, paramStringBuilder, paramBoolean1, paramBoolean2, parambffl, parambcse, parambcre);
        if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    int i = b(paramMessageRecord.istroop, paramQQAppInterface);
    return ((acos)paramQQAppInterface.getMessageFacade().getRegistry().a().a(Integer.valueOf(i))).a(paramRoutingHead, paramMessageRecord, paramQQAppInterface);
  }
  
  public static int b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    return paramQQAppInterface.getMessageFacade().getRegistry().a().a(paramInt);
  }
  ...
  private static im_msg_body.Elem b(im_msg_body.RichText paramRichText, String paramString)
  {
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(anvx.a(2131706125)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = bdpo.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    if (((MessageForArkApp)localObject1).ark_app_message.containStructMsg != null)
    {
      ...
      if (!"1".equals(paramChatMessage.getExtInfoFromExtStr(bcrn.e))) {
        break label466;
      }
    }
    label466:
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131693522), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(bhbx.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(bhbx.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(bhbx.a(localApolloMessage.peer_ts));
    ...
    localObject1 = anvx.a(2131706126);
  ...
  private static void b(List<acoo> paramList)
  {
    int i = paramList.size() - 1;
    while (i >= 0)
    {
      if (((acoo)paramList.get(i)).a() > -1000) {
        paramList.remove(i);
      }
      i -= 1;
    }
  ...
  private static void b(List<acoo> paramList1, List<acoo> paramList2)
  {
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = bdpo.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(bcsc.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = bdpo.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = anvx.a(2131706124);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = anvx.a(2131706129);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(anvx.a(2131706121)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
