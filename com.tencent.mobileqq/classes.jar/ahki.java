...
class ahki
  implements bhue
{
  ahki(ahkf paramahkf, boolean paramBoolean) {}
  ...
  public void a(View paramView)
  {
    ...
    float f1 = ((AnimationTextView)localObject).touchL - ahkf.e;
    float f2 = ((AnimationTextView)localObject).touchT;
    float f3 = ahkf.c;
    if (this.jdField_a_of_type_Boolean) {
      f1 = ((AnimationTextView)localObject).touchL - ahkf.f;
    }
    ...
    for (int i = k;; i = -1)
    {
      ...
      {
        arze.a((bdoa[])localObject, f1, f2 - f3, bool2, i, j, this.jdField_a_of_type_Ahkf.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Ahkf.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Activity)this.jdField_a_of_type_Ahkf.jdField_a_of_type_AndroidContentContext, bool1);
        return;
        label307:
        bool2 = false;
        break;
