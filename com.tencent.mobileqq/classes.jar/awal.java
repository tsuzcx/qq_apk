...
public class awal
{
  ...
  public awal(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(MessageRecord paramMessageRecord)
  {
    if (paramMessageRecord != null)
    {
      ...
      if ((paramMessageRecord instanceof ayoz)) {
        return (int)((ayoz)paramMessageRecord).c();
      }
    }
    return -1;
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        ((akfw)this.a.a(13)).a(paramMessageRecord);
  ...
  public void a(MessageRecord paramMessageRecord, akav paramakav, awap paramawap)
  {
    ...
    if (paramawap != null) {
      paramawap.a(paramMessageRecord);
    }
    this.a.a().b(paramMessageRecord, paramakav);
  }
  ...
  public int b(MessageRecord paramMessageRecord)
  {
    ...
    for (int i = ((ayoz)paramMessageRecord).e();; i = -1)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(MessageRecord paramMessageRecord)
  {
    ...
    {
      axfh localaxfh = new axfh(this.a, this.a.getApplication(), (MessageForShortVideo)paramMessageRecord, null);
      axfg.a().a(paramMessageRecord.uniseq, localaxfh);
      bool = true;
    }
    return bool;
  }
