  ...
  extends ThirdAppProxy
{
  ...
  private bnym jdField_a_of_type_Bnym = new blak(this);
  private bnyq jdField_a_of_type_Bnyq;
  ...
  public void init()
  {
    ...
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Bnyq = new bnyq();
    this.jdField_a_of_type_Bnyq.a(this.jdField_a_of_type_Bnym);
  }
  
  public boolean installApp(String paramString, AsyncResult paramAsyncResult)
  {
    if ((this.jdField_a_of_type_Bnyq == null) || (TextUtils.isEmpty(paramString)) || (paramAsyncResult == null)) {
      return false;
    }
    ...
    this.jdField_a_of_type_Bnyq.b(localWadlParams1);
  ...
  public void queryApkDownloadInfo(String paramString, AsyncResult paramAsyncResult)
  {
    ...
    paramString = new blal(this, paramString, paramAsyncResult);
  ...
  public void queryDownloadTask(String paramString, AsyncResult paramAsyncResult)
  {
    ...
    if ((this.jdField_a_of_type_Bnyq == null) || (TextUtils.isEmpty(paramString))) {
      paramAsyncResult.onReceiveResult(false, null);
    }
    this.b.put(paramString, paramAsyncResult);
    paramAsyncResult = new ArrayList();
    paramAsyncResult.add(paramString);
    this.jdField_a_of_type_Bnyq.a(paramAsyncResult);
  }
  ...
  public void startDownload(String paramString, JSONObject paramJSONObject, boolean paramBoolean, ThirdAppProxy.AppDownloadListener paramAppDownloadListener)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString.b(7);
        paramString.b = 2;
        this.jdField_a_of_type_Bnyq.a(paramString);
        return;
      }
  ...
  public boolean stopDownloadTask(String paramString)
  {
    ...
    localWadlParams.b(2);
    localWadlParams.b = 3;
    this.jdField_a_of_type_Bnyq.a(6, paramString);
    return true;
  }
  ...
  public void unInit()
  {
    ...
    {
      this.jdField_a_of_type_Bnyq.b(this.jdField_a_of_type_Bnym);
      this.jdField_a_of_type_Bnyq.d();
      this.jdField_a_of_type_Bnyq = null;
    }
  }
}
