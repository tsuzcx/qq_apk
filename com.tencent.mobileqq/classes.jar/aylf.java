...
public class aylf
{
  ...
  public static void a(Activity paramActivity, String paramString, aylk paramaylk)
  {
    ...
    paramActivity = bbcv.a(paramActivity, 0, null, paramActivity.getString(2131719366), paramActivity.getString(2131690596), paramActivity.getString(2131691035), new ayli(paramaylk), new aylj(paramaylk));
    paramActivity.show();
    paramActivity.setCancelable(false);
    a("0X800A5C9");
  }
  
  public static void a(aymm paramaymm)
  {
    if (b()) {
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    String str = localBaseActivity.getString(2131719369);
    if (!paramBoolean1) {
      str = localBaseActivity.getString(2131719365);
    }
    paramString1 = bbcv.a(localBaseActivity, 0, null, str, localBaseActivity.getString(2131690596), localBaseActivity.getString(2131691035), new aylg(paramBoolean1, paramBoolean2), new aylh(paramString1, paramString2));
    paramString1.show();
  ...
  public static boolean a(Activity paramActivity, String paramString, aylk paramaylk)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing())) {}
    while (!b()) {
      return false;
    ...
    if ((paramActivity.getResources().getConfiguration().uiMode & 0x30) == 32)
    {
      ...
      a(paramActivity, paramString, paramaylk);
    }
    for (;;)
    {
      return true;
      ...
      break;
      label141:
      ThreadManager.getUIHandler().post(new DarkModeManager.6(paramActivity, paramString, paramaylk));
    }
  }
  ...
  private static void b(aymm paramaymm)
  {
    Object localObject;
    if (axmt.b())
    {
      int i = axmt.d();
      localObject = axmo.b[i];
    }
    for (;;)
    {
      QLog.d("DarkModeManager", 1, "closedNightMode is called, will set themeID=" + (String)localObject);
      ThemeSwitcher.a((String)localObject, "202", paramaymm);
      return;
      localObject = ayml.a(b());
  ...
  private static void b(boolean paramBoolean1, boolean paramBoolean2, aymm paramaymm)
  {
