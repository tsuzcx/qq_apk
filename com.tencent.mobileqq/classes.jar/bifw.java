  ...
  implements MessageQueue.IdleHandler
{
  ...
  public boolean queueIdle()
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Bihj.getActivity().getIntent().getExtras();
    ...
    for (localObject = "null";; localObject = str6)
    {
      ...
      localObject = new bism(str4);
      ((bism)localObject).b = str1;
      ((bism)localObject).c = str2;
      ((bism)localObject).d = str3;
      this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.setLinkerObject((bism)localObject);
      this.a.jdField_a_of_type_Bigb.a(Message.obtain(null, 15, 1, 0));
      return false;
      localObject = str4;
      break label168;
      localObject = str1;
