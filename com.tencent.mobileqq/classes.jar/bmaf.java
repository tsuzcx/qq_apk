...
public final class bmaf
{
  ...
  public static FileManagerEntity a(Bundle paramBundle, String paramString, int paramInt)
  {
    ...
    return auea.a(str1, str2, paramBundle, str3, l, HexUtil.bytes2HexStr(arrayOfByte), paramString, paramInt);
  }
  ...
  public static FileManagerEntity a(FavFileInfo paramFavFileInfo, String paramString, int paramInt)
  {
    ...
    return auea.a(str1, str2, str4, str3, l, paramFavFileInfo.n, paramString, paramInt);
  }
  ...
  {
    a(paramContext, paramString1, paramBoolean1, paramString2, paramBoolean2, 2131692127);
  }
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = paramContext.getString(2131692171);
        if (!paramBoolean2) {
          continue;
        }
        paramString1 = paramContext.getString(2131692166);
        paramString1 = bhdj.a(paramContext, 230, paramString2, paramString1, 2131690697, 2131692169, new bmag(), null);
      ...
      localQQToast.b(paramContext.getResources().getDimensionPixelSize(2131299080) - (int)(5.0F * paramContext.getResources().getDisplayMetrics().density));
      return;
      paramString1 = paramContext.getString(2131692170);
      continue;
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    ...
    return (paramChatMessage != null) && ((aqxn.c.equals(paramChatMessage.ark_app_message.appName)) || ("com.tencent.structmsg".equals(paramChatMessage.ark_app_message.appName)) || ("com.tencent.miniapp_01".equals(paramChatMessage.ark_app_message.appName)));
  }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bmah((Runnable)localObject2));
