  ...
  implements View.OnClickListener
{
  ...
  private String jdField_a_of_type_JavaLangString = bjwa.a(1);
  private boolean jdField_a_of_type_Boolean;
  
  public bnau(@NonNull bnbg parambnbg)
  {
    super(parambnbg);
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      a(l);
      paramString = bjfh.a(l);
      if (paramString == null) {
        return false;
      }
      this.jdField_a_of_type_Bnbg.jdField_d_of_type_Int = paramString.jdField_a_of_type_Int;
      this.jdField_a_of_type_Bnbg.jdField_e_of_type_Int = paramString.b;
      this.jdField_a_of_type_Bnbg.jdField_d_of_type_JavaLangString = paramString.jdField_a_of_type_JavaLangString;
      int i = this.jdField_a_of_type_Bnbg.jdField_d_of_type_Int;
      if (i > 0) {
        return true;
      }
    }
  ...
  private void j()
  {
    RelativeLayout localRelativeLayout1 = (RelativeLayout)a(2131365607);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)LayoutInflater.from(a()).inflate(2131562038, localRelativeLayout1, false));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, aekt.a(50.0F, a()));
    RelativeLayout localRelativeLayout2 = this.jdField_a_of_type_AndroidWidgetRelativeLayout;
    if (this.jdField_a_of_type_Bnbg.i)
    {
      i = 0;
      localRelativeLayout2.setVisibility(i);
      localLayoutParams.addRule(12);
      if (bngs.jdField_e_of_type_Int <= 0) {
        break label110;
      }
    }
    label110:
    for (int i = bngs.jdField_e_of_type_Int;; i = aekt.a(60.0F, a()))
    {
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setTextEffect(this.jdField_a_of_type_Bnbg.jdField_e_of_type_JavaLangString);
    String str = bjfh.a(this.jdField_a_of_type_Bnbg.jdField_d_of_type_Int, null, null, null);
    if (TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_Bnbg.jdField_d_of_type_Int = -1;
    }
    for (;;)
    {
  ...
  public void a()
  {
    super.a();
    j();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131366512));
    this.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)a(2131366562));
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText = ((ExtendEditText)a(2131366513));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)a(2131366556));
    this.jdField_a_of_type_AndroidViewView = a(2131366561);
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setEditableFactory(baiv.c);
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    if (!this.jdField_a_of_type_Bnbg.k) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    if ((this.jdField_a_of_type_Bnbg.h) || (this.jdField_a_of_type_Bnbg.j))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new bnav(this));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if (paramIntent != null)
      {
        ...
        if (paramIntent.containsKey("permission_code")) {
          this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int = paramIntent.getInt("permission_code");
        }
        if (paramIntent.containsKey("uin_list"))
        {
          if (this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList == null) {
            this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          }
          this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.clear();
          localObject = paramIntent.getStringArrayList("uin_list");
          if (localObject != null) {
            this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.addAll((Collection)localObject);
          }
        }
        if (a(this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int))
        {
          this.jdField_a_of_type_Bnbg.b = paramIntent.getString("key_setting_raw_json");
          this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaLangString = paramIntent.getString("key_selected_tag");
        }
        if (xir.a().b() == 22) {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bnbg.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_Bnbg.jdField_a_of_type_AndroidViewView.setVisibility(8);
      }
      this.jdField_a_of_type_Bmix.a(Message.obtain(null, 22));
    ...
    if (localBundle.containsKey("contentIntentKey"))
    {
      ...
      this.jdField_a_of_type_Bnbg.jdField_c_of_type_JavaLangString = paramIntent;
      if (xir.a().b() == 22) {
    ...
    this.jdField_a_of_type_Bnbg.jdField_d_of_type_Int = localBundle.getInt("extra_key_font_id", -1);
    this.jdField_a_of_type_Bnbg.jdField_e_of_type_Int = localBundle.getInt("extra_key_font_format_type");
    this.jdField_a_of_type_Bnbg.jdField_d_of_type_JavaLangString = localBundle.getString("extra_key_font_url");
    this.jdField_a_of_type_Bnbg.f = localBundle.getInt("extra_key_super_font_id", -1);
    this.jdField_a_of_type_Bnbg.jdField_e_of_type_JavaLangString = localBundle.getString("extra_key_super_font_info");
    k();
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    {
      if ((this.jdField_a_of_type_Bnbg.i) && (!this.jdField_a_of_type_Boolean)) {}
  ...
  public void d()
  {
    this.jdField_a_of_type_JavaLangString = bjwa.a(this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i == 2131366556)
      {
        paramView = QzoneConfig.getInstance().getConfig("H5Url", "UgcPermitSetting", "https://h5.qzone.qq.com/ugc/setting?_wv=3&type=mood&uin={uin}&qua={qua}&_proxy=1").replace("{uin}", QQStoryContext.a().a()).replace("{qua}", bizf.a());
        this.jdField_a_of_type_Bnbg.d(3004);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putInt("permission_code", this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int);
        if ((this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ((Bundle)localObject1).putStringArrayList("uin_list", this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList);
          localObject2 = new ArrayList(this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.size());
          localObject3 = this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        if ((a(this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bnbg.b))) {
          ((Bundle)localObject1).putString("key_setting_raw_json", this.jdField_a_of_type_Bnbg.b);
        }
        if (xir.a().b() == 22)
        {
        ...
        bizm.a((BaseActivity)this.jdField_a_of_type_Bmkf, paramView, 1, (Bundle)localObject1, "");
        return;
      }
    } while (i != 2131366513);
    this.jdField_a_of_type_Bnbg.d(3001);
    Object localObject1 = bizt.a();
    Object localObject2 = new Bundle();
    ((Bundle)localObject2).putInt("permission_code", this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int);
    if ((this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ((Bundle)localObject2).putStringArrayList("uin_list", this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList);
      paramView = new ArrayList(this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.size());
      localObject3 = this.jdField_a_of_type_Bnbg.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject3).hasNext()) {
    ...
    if ((a(this.jdField_a_of_type_Bnbg.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bnbg.b))) {
      ((Bundle)localObject2).putString("key_setting_raw_json", this.jdField_a_of_type_Bnbg.b);
    }
    ((Bundle)localObject2).putBoolean("is_need_auto_close_from_pri", true);
    if (this.jdField_a_of_type_Bnbg.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Bnbg.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
    paramView = "";
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText != null) {
    ...
    this.jdField_a_of_type_Bmix.a(Message.obtain(null, 21));
    BaseActivity localBaseActivity = (BaseActivity)this.jdField_a_of_type_Bmkf;
    if (this.jdField_a_of_type_Bnbg.h) {}
    for (int i = 0;; i = 1)
    {
      bizm.a(localBaseActivity, (bizt)localObject1, 1009, "", paramView, "", "", 0, i, 1, 0, 0, 0, "", 10000, (Bundle)localObject2, this.jdField_a_of_type_Bnbg.h, this.jdField_a_of_type_Bnbg.g, this.jdField_a_of_type_Bnbg.jdField_d_of_type_Int, this.jdField_a_of_type_Bnbg.f, false, (Bundle)localObject3);
      return;
    }
  }
}
