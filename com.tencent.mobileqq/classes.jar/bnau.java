...
public class bnau
  extends QIPCModule
{
  private static bnau a;
  
  private bnau(String paramString)
  {
    super(paramString);
  }
  
  /* Error */
  public static bnau a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bnau:a	Lbnau;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bnau:a	Lbnau;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bnau
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bnau:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bnau:a	Lbnau;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bnau:a	Lbnau;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_start_send".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        localObject1 = bbqf.a(3, 0);
        localObject2 = bbqf.a(0, paramBundle, (bbqx)localObject1);
        ((bbqj)localObject2).c = true;
        ((bbqx)localObject1).a((bbqj)localObject2);
        bbqf.a((bbqx)localObject1, paramString);
      }
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        bahm.a(paramBundle, (String)localObject2, l2);
        bool2 = bool3;
        if (localObject1 != null) {
          ...
          for (;;)
          {
            ...
            if ("action_re_send".equals(paramString))
            {
              ...
              if ((paramBundle instanceof MessageForShortVideo))
              {
                ...
                {
                  ((bahm)paramString.getManager(326)).a(((MessageForShortVideo)localObject1).frienduin, (MessageRecord)localObject1, ((MessageForShortVideo)localObject1).videoFileName);
                  localObject1 = bbqf.a(4, 0);
                  localObject2 = bbqf.a(0, paramBundle, (bbqx)localObject1);
                  ((bbqj)localObject2).c = true;
                  ((bbqx)localObject1).a((bbqj)localObject2);
                  bbqf.a((bbqx)localObject1, paramString);
              ...
              for (paramString = paramBundle.toString();; paramString = "")
              {
                ...
                localObject2 = new ayec();
                ((ayec)localObject2).a(((MessageForPic)localObject1).path);
                ((ayec)localObject2).d(5);
                ((ayec)localObject2).d(((MessageForPic)localObject1).frienduin);
                if (((MessageForPic)localObject1).fileSizeFlag == 1) {
                  ((ayec)localObject2).c(TranDbRecord.PicDbRecord.EXTRA_FLAG_SEND_RAW_PHOTO);
                }
                for (;;)
                {
                  ((ayec)localObject2).e(((MessageForPic)localObject1).senderuin);
                  ((ayec)localObject2).c(((MessageForPic)localObject1).selfuin);
                  ((ayec)localObject2).e(((MessageForPic)localObject1).istroop);
                  ((ayec)localObject2).l(((MessageForPic)localObject1).getConfessTopicId());
                  ((ayec)localObject2).jdField_i_of_type_Int = ((MessageForPic)localObject1).extLong;
                  ((ayec)localObject2).jdField_i_of_type_JavaLangString = ((MessageForPic)localObject1).extStr;
                  ((ayec)localObject2).b(true);
                  localObject3 = new ayed();
                  ((ayed)localObject3).a = ((MessageForPic)localObject1).msgseq;
                  ((ayed)localObject3).b = ((MessageForPic)localObject1).shmsgseq;
                  ((ayed)localObject3).c = ((MessageForPic)localObject1).msgUid;
                  ((ayec)localObject2).a((ayed)localObject3);
                  ((ayec)localObject2).b(((MessageForPic)localObject1).uniseq);
                  ((bahm)paramString.getManager(326)).a(((MessageForPic)localObject1).frienduin, ((MessageForPic)localObject1).uniseq);
                  localObject3 = aydj.a(4, 5);
                  ((ayds)localObject3).a(((ayec)localObject2).a());
                  ((ayds)localObject3).a = ((MessageForPic)localObject1).picExtraData;
                  aydj.a((ayds)localObject3, paramString);
                  bool1 = true;
                  break;
                  ((ayec)localObject2).c(TranDbRecord.PicDbRecord.EXTRA_FLAG_SEND_PHOTO);
                }
              }
            }
