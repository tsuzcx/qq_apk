...
public class alqq
  implements alqu
{
  private static final int jdField_a_of_type_Int = bqja.a(172.0F);
  private static final int b = bqja.a(31.5F);
  private static final int c = jdField_a_of_type_Int + bqja.a(16.0F);
  private static final int d = b + bqja.a(14.0F);
  private static final int e = c / 2;
  private static final int f = bqja.a(65.0F);
  private static final int g = bqja.a(10.0F);
  private static final int h = bgtn.b(30.0F);
  private static final int i = bgtn.b(8.0F);
  private static final int j = bgtn.b(12.0F);
  private static final int k = bqja.a(4.0F);
  ...
  public void a(@NonNull View paramView1, int paramInt1, int paramInt2, @NonNull View paramView2, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetPopupWindow == null)
    {
      ...
      a("create popWindow ");
      paramView2 = ((LayoutInflater)paramView1.getContext().getSystemService("layout_inflater")).inflate(2131559288, null, false);
      this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView = ((RoundImageView)paramView2.findViewById(2131362413));
