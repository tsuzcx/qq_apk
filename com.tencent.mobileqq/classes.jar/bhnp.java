...
import com.tencent.mobileqq.vas.IndividuationUrlHelper.2;
...
public final class bhnp
{
  ...
  public static bhnt a;
  private static final String jdField_a_of_type_JavaLangString;
  public static HashMap<String, bhns> a;
  private static List<SoftReference<bhnr>> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    ((StringBuilder)localObject).append("uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.10.4875").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.10.4875").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&_bid=182").append("&_wv=3");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.10.4875").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&adtag=mvip.gxh.android.search").append("&_bid=2229").append("&_wv=1027");
  ...
  public static String a(String paramString, ImageView paramImageView)
  {
    ...
    {
      jdField_a_of_type_JavaUtilList.add(new SoftReference(new bhnr(paramString, paramImageView)));
      paramImageView = localObject;
      if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        paramImageView = a(paramString, jdField_a_of_type_Bhnt);
      }
  ...
  public static String a(String paramString, bhnt parambhnt)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (TextUtils.isEmpty(localObject2)) {
        if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
        {
          ...
          ThreadManager.post(new IndividuationUrlHelper.2(parambhnt), 5, null, true);
        }
      }
      for (;;)
      {
        parambhnt = (String)jdField_b_of_type_JavaUtilMap.get(paramString);
        localObject1 = parambhnt;
        if (QLog.isColorLevel())
        {
          QLog.d("IndividuationUrlHelper", 2, "getUrl, from default, id=" + paramString + ", url=" + parambhnt);
          localObject1 = parambhnt;
        }
        parambhnt = (bhnt)localObject1;
  ...
  public static String a(AppRuntime paramAppRuntime, String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 632	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   4: ifeq +5 -> 9
    //   7: aload_1
    //   8: areturn
    //   9: aload_1
    ...
    //   12: ldc_w 703
    //   15: ldc_w 705
    //   18: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   21: astore_1
    //   22: aload_1
    //   23: astore_3
    //   24: aload_1
    //   25: ldc_w 711
    //   28: ldc 79
    //   30: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   33: astore_1
    //   34: aload_1
    //   35: astore_3
    //   36: aload_1
    //   37: ldc_w 713
    //   40: ldc_w 715
    //   43: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   46: astore_1
    //   47: aload_1
    //   48: astore_3
    //   49: aload_1
    ...
    //   56: ldc_w 719
    //   59: invokestatic 725	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   62: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   65: astore_1
    //   66: aload_1
    //   67: astore_3
    //   68: aload_1
    ...
    //   75: ldc_w 719
    //   78: invokestatic 725	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   81: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   84: astore_1
    //   85: aload_0
    //   86: astore 4
    //   88: aload_0
    //   89: ifnonnull +11 -> 100
    //   92: getstatic 687	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   95: invokevirtual 691	com/tencent/common/app/BaseApplicationImpl:getRuntime	()Lmqq/app/AppRuntime;
    //   98: astore 4
    //   100: aload 4
    //   102: ifnull +36 -> 138
    //   105: aload_1
    //   106: ldc_w 729
    //   109: aload 4
    //   111: invokevirtual 734	mqq/app/AppRuntime:getAccount	()Ljava/lang/String;
    //   114: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   117: astore_0
    //   118: aload_0
    //   119: astore_3
    //   120: aload_0
    //   121: ldc_w 736
    //   124: aload 4
    //   126: invokevirtual 740	mqq/app/AppRuntime:getApplication	()Lmqq/app/MobileQQ;
    //   129: invokestatic 746	com/tencent/mobileqq/theme/ThemeUtil:getThemeDensity	(Landroid/content/Context;)Ljava/lang/String;
    //   132: invokevirtual 709	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   135: astore_1
    //   136: aload_1
    //   137: areturn
    //   138: ldc_w 650
    ...
    //   155: aload_2
    //   156: aastore
    //   157: invokestatic 752	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   160: invokestatic 754	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   163: goto -27 -> 136
    //   166: astore_0
    //   167: ldc_w 650
    //   170: iconst_1
    ...
    //   187: iconst_2
    //   188: aload_0
    //   189: invokestatic 762	com/tencent/mobileqq/msf/sdk/MsfSdkUtils:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   192: aastore
    //   193: invokestatic 752	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   196: invokestatic 754	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   199: goto -63 -> 136
    //   202: astore_0
    //   203: aload_3
    //   204: astore_1
