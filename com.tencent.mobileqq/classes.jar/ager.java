  ...
  implements biog
{
  ...
  private MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new ages(this);
  public FragmentActivity a;
  private View jdField_a_of_type_AndroidViewView;
  public ViewGroup a;
  private biog jdField_a_of_type_Biog = new ageu(this);
  ...
  public ager(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetDrawerFrame.setDrawerCallbacks(this.jdField_a_of_type_Biog);
    m();
  ...
  {
    boolean bool = true;
    if ((ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null)) || (bdfk.b())) {
      bool = false;
    }
    return bool;
  }
  ...
  private void m()
  {
    ...
    if (localNavBarAIO != null) {
      localNavBarAIO.addOnLayoutChangeListener(new aget(this, localNavBarAIO));
    }
  }
