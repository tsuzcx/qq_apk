...
public class bitb
{
  public static final String a = bigv.a(c() + "tencent/MobileQQ/webso/offline/");
  ...
  {
    Object localObject = "Android Qzone/" + bmsw.a();
    String str;
    switch (nnr.a())
    {
    case 0: 
    ...
    for (;;)
    {
      ...
      ((StringBuilder)localObject).append(" ").append("QQ/").append("8.4.5").append(".").append("4745").append(str).append(" Pixel/").append(a()).append(" StatusBarHeight/" + i);
  ...
  public static boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   16: astore 7
    //   18: ldc_w 314
    //   21: invokestatic 206	bitb:a	(Ljava/lang/String;)V
    //   24: aload_0
    //   25: ifnull +10 -> 35
    //   28: aload_1
