...
public class anud
  extends anii
{
  public anud(QQAppInterface paramQQAppInterface)
  {
  ...
  protected String a(MarkFaceMessage paramMarkFaceMessage)
  {
    ...
    return arpm.a(paramMarkFaceMessage.sbufID, paramMarkFaceMessage.mediaType);
  }
  ...
  {
    asdu localasdu = new asdu();
    localasdu.jdField_a_of_type_Int = paramInt;
    localasdu.jdField_a_of_type_JavaUtilList = new ArrayList();
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        asdv localasdv = new asdv();
        ByteStringMicro localByteStringMicro = ((oidb_0xe9c.ImgInfo)localObject).bytes_img_md5.get();
        if (localByteStringMicro != null) {
          localasdv.jdField_a_of_type_JavaLangString = localByteStringMicro.toStringUtf8();
        }
        localByteStringMicro = ((oidb_0xe9c.ImgInfo)localObject).bytes_img_down_url.get();
        if (localByteStringMicro != null) {
          localasdv.jdField_b_of_type_JavaLangString = localByteStringMicro.toStringUtf8();
        }
        localByteStringMicro = ((oidb_0xe9c.ImgInfo)localObject).bytes_img_other.get();
        if (localByteStringMicro != null) {
          localasdv.d = localByteStringMicro.toStringUtf8();
        }
        localasdv.jdField_b_of_type_Int = ((oidb_0xe9c.ImgInfo)localObject).uint32_img_height.get();
        localasdv.jdField_a_of_type_Int = ((oidb_0xe9c.ImgInfo)localObject).uint32_img_width.get();
        localasdv.jdField_a_of_type_Long = ((oidb_0xe9c.ImgInfo)localObject).uint64_img_size.get();
        localObject = ((oidb_0xe9c.ImgInfo)localObject).bytes_resource_id.get();
        if (localObject != null) {
          localasdv.c = ((ByteStringMicro)localObject).toStringUtf8();
        }
        localasdu.jdField_a_of_type_JavaUtilList.add(localasdv);
      }
    }
    notifyUI(1, true, localasdu);
  }
  ...
  protected void a(List<String> paramList, MarkFaceMessage paramMarkFaceMessage, String paramString1, String paramString2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramMarkFaceMessage = ((awmr)this.app.getManager(14)).a(paramString2, paramString1);
        if (paramMarkFaceMessage != null) {
  ...
  public void b(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if ((paramChatMessage instanceof MessageForPic))
    {
      ...
      localObject2 = arze.b((MessageForPic)paramChatMessage);
      str1 = arze.a((MessageForPic)paramChatMessage);
    ...
    for (;;)
    {
      ...
      paramChatMessage.uint32_aio_type.set(arze.b(paramInt));
      paramChatMessage.str_client_ver.set("8.4.1");
      paramChatMessage.relatedFaceReqBody.set(localRelatedFaceReq);
      localObject1 = (anmw)this.app.getManager(51);
      if (localObject1 != null)
      {
        localObject1 = ((anmw)localObject1).b(this.app.getCurrentAccountUin());
        if (localObject1 != null) {
      ...
      if ((paramChatMessage instanceof MessageForMarketFace))
      {
        ...
        if (localMarkFaceMessage != null)
        {
          ...
          if (localObject3 != null)
          {
            ...
            localObject2 = bgmj.a(MD5.getFileMd5(arze.s.replace("[epId]", str2).replace("[eId]", (CharSequence)localObject3)));
            String str3 = arze.h.replace("[eIdSub]", ((String)localObject3).substring(0, 2)).replace("[eId]", (CharSequence)localObject3);
