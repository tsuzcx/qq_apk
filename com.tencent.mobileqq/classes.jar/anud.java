  ...
  extends anty
{
  ...
  protected anud(AppInterface paramAppInterface)
  {
  ...
  protected anud(QQAppInterface paramQQAppInterface)
  {
  ...
  protected void checkReportErrorToMM(FromServiceMsg paramFromServiceMsg)
  {
    if (reportErrorToMM(paramFromServiceMsg))
    {
      ...
      bjqh.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), getCurrentAccountUin(), 1000277, anzj.a(2131700177) + paramFromServiceMsg.getServiceCmd(), true);
    }
  }
