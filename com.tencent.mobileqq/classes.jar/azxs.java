...
public class azxs
{
  ...
  private Map<Integer, azxt> e = new ConcurrentHashMap();
  ...
  public azxs(AppInterface paramAppInterface)
  {
  ...
  {
    return antf.cq + "defaultCard" + File.separator + paramString + ".json";
  }
  ...
  {
    return bhhz.c(paramContext) + paramLong + ".zip";
  }
  ...
  public azxt a(int paramInt, boolean paramBoolean)
  {
    try
    {
      azxt localazxt = (azxt)this.e.get(Integer.valueOf(paramInt));
      if (localazxt == null)
      {
        localazxt = new azxt(this, paramInt);
        this.e.put(Integer.valueOf(paramInt), localazxt);
      }
      for (;;)
      {
        Object localObject2;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        try
        {
          bhmi.a(paramQQAppInterface.getAbsolutePath(), paramString1, false);
          ...
          if (paramString2.exists())
          {
            ...
            bhmi.a(paramString2.getAbsolutePath(), str, false);
