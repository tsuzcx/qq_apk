...
public class ajva
  extends Handler
{
  public ajva(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((ChatHistoryTroopMemberFragment.b(this.a)) && (ChatHistoryTroopMemberFragment.d(this.a)))
        {
          ...
          paramMessage.obj = this.a.jdField_a_of_type_Ajvt.a();
          ChatHistoryTroopMemberFragment.a(this.a, paramMessage);
        }
        return;
        this.a.z();
        ...
        {
          if (this.a.jdField_a_of_type_Ajvt.b != null) {
            this.a.jdField_a_of_type_Ajvt.b.clear();
          }
        ...
        QQToast.a(this.a.getActivity(), this.a.getString(2131691443), 0).b(this.a.jdField_b_of_type_AndroidViewView.getHeight());
        ChatHistoryTroopMemberFragment.a(this.a);
        return;
        if ((this.a.jdField_c_of_type_AndroidAppDialog != null) && (this.a.jdField_c_of_type_AndroidAppDialog.isShowing())) {
          this.a.jdField_c_of_type_AndroidAppDialog.dismiss();
        }
        QQToast.a(this.a.getActivity(), this.a.getString(2131691442), 0).b(this.a.jdField_b_of_type_AndroidViewView.getHeight());
        return;
      ...
      return;
    } while (this.a.jdField_a_of_type_Ajvt == null);
    this.a.jdField_a_of_type_Ajvt.a();
    return;
    ...
    for (this.a.o = "0"; this.a.jdField_a_of_type_Ajvt != null; this.a.o = "1")
    {
      label1154:
      this.a.jdField_a_of_type_Ajvt.a();
      return;
