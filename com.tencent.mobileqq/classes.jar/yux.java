  ...
  implements View.OnTouchListener
{
  ...
  private yuy jdField_a_of_type_Yuy;
  ...
  String a(String paramString, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      i = 1;
      j = axli.b(BaseApplicationImpl.getContext());
      k = axli.a(BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      ...
      {
        String str;
        yxs.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", localException);
        continue;
        paramString = "?";
        continue;
      }
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if (!paramString.contains("&s={"))
        {
          ...
          yxs.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString click url result : " + (String)localObject);
        }
      }
      return localObject;
      i = 0;
  ...
  public void a()
  {
    this.jdField_a_of_type_Yuy = null;
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Yuy != null) {
        this.jdField_a_of_type_Yuy.a(this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c, this.d);
      }
    }
  }
}
