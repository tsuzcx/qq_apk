  ...
  implements BusinessObserver
{
  ...
  public yux(ApolloWebStatistics paramApolloWebStatistics, String paramString1, String paramString2)
  {
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      while (localIterator.hasNext()) {
        ((yuw)localIterator.next()).a(this, this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloWebStatistics);
      }
  ...
  public void a(yuw paramyuw)
  {
    if (paramyuw != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramyuw);
    }
  }
