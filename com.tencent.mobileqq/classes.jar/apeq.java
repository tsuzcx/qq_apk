  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    if (paramArrayOfByte != null)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForYanZhi)ayvw.a(-2070);
        ...
        paramArrayOfByte.msg = (localMsgBody.uint32_like_count.get() + BaseApplicationImpl.getContext().getString(2131694561));
        ...
        paramArrayOfByte.frienduin = aljq.H;
        paramArrayOfByte.senderuin = aljq.ap;
