  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  apek jdField_a_of_type_Apek;
  apep jdField_a_of_type_Apep = new apep();
  ...
  private aper[] jdField_a_of_type_ArrayOfAper = new aper[300];
  ...
  public apeq(apef paramapef)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Apef = paramapef;
    this.jdField_a_of_type_Apek = paramapef.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844847, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Apef.a().getResources(), 2130844848, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Apek.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Apek.c = 0L;
    this.jdField_a_of_type_Apek.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Apep != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Apep.a(paramSize.getHeight(), paramSize.getWidth(), appa.jdField_a_of_type_Int, appa.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localaper2 = this.jdField_a_of_type_ArrayOfAper[i4];
      if ((localaper2 != null) && (!localaper2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localaper2.jdField_b_of_type_Float * 0.35F - Math.abs(localaper2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localaper2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localaper2 != null)
        {
          localaper1 = localaper2;
          i3 = i2;
          if (!localaper2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localaper2.jdField_b_of_type_Float;
      localaper2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localaper2.jdField_b_of_type_Float + f2 + f4);
      if (localaper2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localaper2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localaper2 == null)
      {
        localaper1 = new aper(this);
        this.jdField_a_of_type_ArrayOfAper[i4] = localaper1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localaper1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localaper1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localaper1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localaper1 == null) || (localaper1.jdField_a_of_type_Boolean) || (localaper1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAper[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAper[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localaper1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Apek.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Apek.c > this.jdField_a_of_type_Apek.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Apek;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Apep != null) && (this.u == 2)) {
        this.jdField_a_of_type_Apep.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    a();
    if (apjb.a() != null) {
      this.jdField_a_of_type_Apep.a(BaseApplicationImpl.getContext());
    }
  }
}
