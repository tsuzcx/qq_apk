...
public class moo
{
  ...
  public moo(VideoAppInterface paramVideoAppInterface, Context paramContext)
  {
  ...
  private boolean a(long paramLong, ViewGroup paramViewGroup)
  {
    ...
    {
      this.jdField_a_of_type_Lil.b();
      lio locallio = this.jdField_a_of_type_Lil.a();
      if (locallio != null) {
        paramViewGroup.removeView((View)locallio);
      }
      this.jdField_a_of_type_Lil = null;
      return true;
    }
    return false;
  }
  ...
  {
    this.jdField_a_of_type_Lil = null;
    this.jdField_a_of_type_Lil = lip.a(paramLong, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString);
    paramString = (GamePlayView)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559705, null);
    if (this.jdField_a_of_type_Lil == null)
    {
      QLog.w("ZimuViewProxy", 1, "creatARZimuTask, fail");
      return false;
    }
    int i = this.jdField_a_of_type_Lil.a();
    String str = this.jdField_a_of_type_Lil.c();
    ...
    this.jdField_a_of_type_Lil.a(paramString);
    paramViewGroup.addView(paramString);
    this.jdField_a_of_type_Lil.a();
    return true;
  }
  ...
  {
    float f2 = 0.0F;
    this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView = mol.a(paramLong, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString);
    float f1;
    ...
    if (this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView != null)
    {
      ...
      f1 = paramInt2 - localResources.getDimension(2131297716);
  ...
  public ZimuItem a()
  {
    ...
    {
      a();
      return (ZimuItem)this.jdField_a_of_type_Lir.a();
    }
    return null;
  }
  ...
  public lir a()
  {
    ...
    return this.jdField_a_of_type_Lir;
  }
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            new mci(AudioHelper.b(), "maybeShowZimu", 1, (String)localObject).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
          }
        }
      }
    }
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Lil != null)
    {
      this.jdField_a_of_type_Lir.a(paramLong, null);
      this.jdField_a_of_type_Lir.a("DisableARZimu", paramLong);
      this.jdField_a_of_type_Lil.b();
      this.jdField_a_of_type_Lil = null;
    }
  }
  ...
  public void a(VideoLayerUI paramVideoLayerUI, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView != null)
    {
      ...
      f = paramVideoLayerUI.c() - mit.b(paramVideoLayerUI.b());
      localLayoutParams.bottomMargin = ((int)(localResources.getDimension(2131297612) + f));
    }
    for (;;)
    {
      ...
      return;
      label91:
      localLayoutParams.bottomMargin = ((int)(paramInt2 - localResources.getDimension(2131297716)));
      continue;
      label110:
      f = paramInt1;
      localLayoutParams.topMargin = ((int)(localResources.getDimension(2131297730) + f));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView != null) {
      this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView.a(paramlgc);
    }
    while (this.jdField_a_of_type_Lil == null) {
      return;
    }
    this.jdField_a_of_type_Lil.a(paramlgc);
  }
  ...
  public void a(boolean paramBoolean)
  {
    a();
    liq.a(paramBoolean);
    this.jdField_a_of_type_Lir.a(paramBoolean);
  }
  ...
  public boolean a(ViewGroup paramViewGroup, long paramLong)
  {
    ...
    a(paramLong, paramViewGroup);
    this.jdField_a_of_type_Lir.a(paramLong, null);
    this.jdField_a_of_type_Lir.a("stopZimuView", paramLong);
    return true;
  }
