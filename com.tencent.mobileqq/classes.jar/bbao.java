  ...
  extends bban
{
  ...
  private RedAppInfo a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    for (paramString = axaw.a(paramQQAppInterface, paramString);; paramString = ((bbav)paramQQAppInterface.getManager(36)).a(paramString)) {
      return bbaz.a(paramString);
    }
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((bbav)paramQQAppInterface.getManager(36)).b(paramString);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      for (i = Integer.parseInt(paramString.split("\\.")[0]);; i = Integer.parseInt(paramString))
      {
        ...
        try
        {
          paramString = ((bbav)paramQQAppInterface.getManager(36)).a(paramString);
          ...
          ((bbav)paramQQAppInterface.getManager(36)).c(paramString, localJSONObject.toString());
          return;
        }
