  ...
  implements INetInfoHandler
{
  ...
  {
    Iterator localIterator = avpd.a(this.a).iterator();
    while (localIterator.hasNext()) {
      ((avpg)localIterator.next()).a(5);
    }
  ...
  {
    paramString = avpd.a(this.a).iterator();
    while (paramString.hasNext()) {
      ((avpg)paramString.next()).a(4);
    }
    if (QLog.isColorLevel()) {
