...
public class beka
{
  ...
  {
    if ((bekc.jdField_a_of_type_Boolean) || (bekc.b))
    {
      StringBuilder localStringBuilder = new StringBuilder("_tcvassp_0_=");
      if ((bekc.jdField_a_of_type_Int != -1) && (bekc.jdField_a_of_type_JavaUtilArrayList.size() != 0))
      {
        localStringBuilder.append(bekc.jdField_a_of_type_Int);
        if (bekc.b) {}
        for (Object localObject = "shp";; localObject = "webp")
        {
          ...
          ((Bundle)localObject).putStringArrayList("domains", bekc.jdField_a_of_type_JavaUtilArrayList);
          if (QLog.isColorLevel())
          {
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, arg: " + localStringBuilder.toString());
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, domainList: " + TextUtils.join(", ", bekc.jdField_a_of_type_JavaUtilArrayList));
          }
          return localObject;
        }
      }
  ...
  public static Bundle a(WebViewFragment paramWebViewFragment, Intent paramIntent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        ...
        {
          paramWebViewFragment.a.evaluateJavascript("document.querySelector(\"meta[itemprop='name']\").getAttribute('content')", new bekb(paramWebViewFragment));
          paramIntent = null;
        }
      }
    }
  ...
  public static String a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (WebpSoLoader.b())
      {
        ...
        if (!TextUtils.isEmpty(str2)) {
          bekc.jdField_a_of_type_Boolean = true;
        }
        bekc.b = paramBoolean;
        ...
        localObject = localStringBuilder.append((String)localObject).append(" ").append(bjdt.a());
    ...
    {
      return paramString1 + " QQ/" + "8.3.5" + "." + "4555" + str1 + str2 + " Pixel/" + j + " StatusBarHeight/" + k + " SimpleUISwitch/" + i + " QQTheme/" + ThemeUtil.getCurrentThemeId();
  ...
  {
    int j = 0;
    if ((bekc.jdField_a_of_type_JavaUtilArrayList.size() != 0) && (bekc.jdField_a_of_type_Int != -1)) {}
    Object localObject1;
    do
    {
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          bekc.jdField_a_of_type_JavaUtilArrayList.clear();
          k = localObject2.length;
          i = 0;
          if (i < k)
          {
            arrayOfString = localObject2[i];
            bekc.jdField_a_of_type_JavaUtilArrayList.add(arrayOfString.trim());
            i += 1;
            continue;
          }
        }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramString.equalsIgnoreCase(paramJSONObject.optString("business", ""))))
    {
      ...
      if (bool2)
      {
        ...
        if (paramJSONObject.has("minVersion"))
        {
          ...
          {
            bool1 = bool2;
            if (!bdtg.a(paramString, "8.3.5.4555")) {
              bool1 = false;
            }
          }
        }
      ...
      if (bool1)
      {
        ...
        if (paramJSONObject.has("maxVersion"))
        {
          ...
          {
            bool2 = bool1;
            if (!bdtg.a("8.3.5.4555", paramString)) {
              bool2 = false;
            }
          }
        }
  ...
  public static void b()
  {
    ...
    bekd.jdField_a_of_type_JavaLangString = localSharedPreferences.getString("http_proxy_address", "");
    bekd.jdField_a_of_type_Boolean = localSharedPreferences.contains("need_set_proxy");
