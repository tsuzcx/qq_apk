...
public class lda
{
  ...
  private List<ldb> jdField_a_of_type_JavaUtilList;
  private ldc jdField_a_of_type_Ldc;
  ...
  public lda(@NonNull VideoAppInterface paramVideoAppInterface, String paramString)
  {
    ...
    this.d = 0L;
    this.jdField_a_of_type_Ldc = new ldc(this);
  ...
  private void a(int paramInt)
  {
    ...
    Map localMap = bbdh.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp());
  ...
  private void a(long paramLong, Map<String, Integer> paramMap)
  {
    ...
    this.jdField_a_of_type_JavaUtilList.add(new ldb(a(), a(paramMap, "summary.total-pss"), a(paramMap, "summary.java-heap"), a(paramMap, "summary.native-heap"), a(paramMap, "summary.code"), a(paramMap, "summary.graphics"), paramLong));
  }
  ...
  private void c()
  {
    ...
    if (j >= 4)
    {
      l1 = ((ldb)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_a_of_type_Long;
      l2 = ((ldb)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_a_of_type_Long;
      l3 = ((ldb)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_b_of_type_Long;
      l4 = ((ldb)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Long;
      l5 = ((ldb)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_c_of_type_Long;
      l6 = ((ldb)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Long;
      i = 1;
      if (i >= j - 1 - 1) {
        break label1067;
      }
      localObject3 = (ldb)this.jdField_a_of_type_JavaUtilList.get(i);
      localldb = (ldb)this.jdField_a_of_type_JavaUtilList.get(i + 1);
      if ((((ldb)localObject3).jdField_a_of_type_Int != 0) && (((ldb)localObject3).jdField_a_of_type_Int != localldb.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            ...
            continue;
            this.jdField_c_of_type_Int = localldb.jdField_a_of_type_Int;
            if ((!((ldb)localObject3).a()) || (!localldb.a())) {
              if (QLog.isColorLevel()) {
      ...
      do
      {
        ...
        {
          return;
          d1 = localldb.f - ((ldb)localObject3).f;
          d2 = localldb.jdField_a_of_type_Long - ((ldb)localObject3).jdField_a_of_type_Long;
          d3 = localldb.jdField_b_of_type_Long - ((ldb)localObject3).jdField_b_of_type_Long;
          double d4 = localldb.jdField_c_of_type_Long - ((ldb)localObject3).jdField_c_of_type_Long;
          if (d1 <= 0.0D)
          {
            if (QLog.isColorLevel()) {
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            ...
            ((HashMap)localObject2).put("device_memory", String.valueOf(bbdh.d() / 1024L));
