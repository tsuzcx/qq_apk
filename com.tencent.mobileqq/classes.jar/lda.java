...
public class lda
{
  ...
  public lda(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = moo.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          lfe locallfe = ((VideoController)localObject1).a();
          str1 = locallfe.jdField_d_of_type_JavaLangString;
          str2 = locallfe.e;
          i = locallfe.F;
          j = locallfe.jdField_d_of_type_Int;
          bool1 = locallfe.N;
          bool2 = locallfe.P;
          bool3 = locallfe.g;
  ...
  public void a()
  {
    ...
    {
      ldb.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((lfe)localObject).j, ((lfe)localObject).jdField_d_of_type_JavaLangString, ((lfe)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      ldb.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = lbz.a(j, (String)localObject1, new int[0]);
        localObject3 = lbz.a().a((String)localObject3, false);
        ((lfe)localObject3).j = 0;
        ((lfe)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((lfe)localObject3).e = ((String)localObject2);
        ((lfe)localObject3).F = j;
        ((lfe)localObject3).ai = true;
        ((lfe)localObject3).i = l2;
        ((lfe)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((lfe)localObject3).S = true;
        ((lfe)localObject3).N = bool1;
        ((lfe)localObject3).g = bool3;
        ...
        if (lzr.f())
        {
          lzr.a(l3, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((muy)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          ldb.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      lzr.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label589:
