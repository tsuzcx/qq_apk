...
class bhkc
{
  private static bhkc jdField_a_of_type_Bhkc;
  private static bhkc jdField_b_of_type_Bhkc;
  ...
  public static bhkc a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Bhkc == null) {
        jdField_a_of_type_Bhkc = new bhkc(0);
      }
      return jdField_a_of_type_Bhkc;
    }
    if (jdField_b_of_type_Bhkc == null) {
      jdField_b_of_type_Bhkc = new bhkc(1);
    }
    return jdField_b_of_type_Bhkc;
  }
