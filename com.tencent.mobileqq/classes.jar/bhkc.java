...
public class bhkc
{
  ...
  private CopyOnWriteArrayList<bhke> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public bhkc()
  {
    bhle.a("MobileQQprotect.QSecCb", new bhkd(this));
    a();
  }
  ...
  private String a()
  {
    return bhil.a() + File.separator + "QSecCb.dat";
  }
  
  private void a()
  {
    byte[] arrayOfByte = new bhla().a(a(), null, 1);
    if (arrayOfByte != null) {
      a(arrayOfByte);
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        ((bhke)paramString.next()).a(localLinkedList);
        continue;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	bhkc:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   42: iload_3
  ...
  private byte[] a()
  {
    ...
    //   16: astore 4
    //   18: aload_0
    //   19: getfield 18	bhkc:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  private void b()
  {
    byte[] arrayOfByte = a();
    if (arrayOfByte != null) {
      new bhla().a(a(), arrayOfByte, null, 1);
    }
  }
  ...
  public void a(bhke parambhke)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambhke);
  }
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      bhle.a("MobileQQprotect.QSecCb", localQSecCbQuery.toByteArray());
      return;
    }
