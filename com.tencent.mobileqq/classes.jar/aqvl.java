...
public class aqvl
  extends ajjh
{
  public aqvl(ListenTogetherManager paramListenTogetherManager) {}
  ...
  protected void onUpdateDelFriend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      String str = aqvv.a(2, String.valueOf(paramObject));
      if (ListenTogetherManager.a(this.a).equals(str))
      {
        ...
        aquy.b(ListenTogetherManager.a(this.a), String.valueOf(paramObject), false);
