...
public class nsc
{
  ...
  private final akui jdField_a_of_type_Akui = new nsj(this, "readinjoy_weather");
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new nsd(this);
  ...
  private final osm jdField_a_of_type_Osm = new nsk(this);
  private int jdField_b_of_type_Int = -1;
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new nsf(this);
  private final View.OnClickListener c = new nsg(this);
  private final View.OnClickListener d = new nsh(this);
  private View.OnClickListener e;
  
  public nsc(@NonNull VafContext paramVafContext)
  {
  ...
  private static Container a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = rpr.a("daily_dynamic_header", true);
        if (localObject != null)
        {
          paramJSONObject = ((rpr)localObject).getTemplateBean(paramJSONObject);
          if (paramJSONObject != null)
          {
            paramVafContext = paramVafContext.getViewFactory().inflate(paramVafContext, paramJSONObject);
            olo.a(paramVafContext, null, paramJSONObject);
  ...
  private Container a(JSONObject paramJSONObject, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_b_of_type_Int == -1) || (this.jdField_b_of_type_Int == 0))
    {
      ...
      {
        Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130842603);
    ...
    for (;;)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842603);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130842603);
  ...
  private void a(int paramInt)
  {
    ...
    bhvy.a("sp_key_daily_dynamic_header_state", Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  private void a(@NonNull View paramView, @NonNull Container paramContainer, @NonNull Drawable paramDrawable, JSONObject paramJSONObject)
  {
    ...
    DailyTitleBarSwitcher localDailyTitleBarSwitcher = (DailyTitleBarSwitcher)paramView.findViewById(2131364887);
    ...
    ReadInJoyDailyPullToZoomHeaderXListView localReadInJoyDailyPullToZoomHeaderXListView = (ReadInJoyDailyPullToZoomHeaderXListView)paramView.findViewById(2131376714);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363002));
    nsa.a(paramDrawable);
    nsa.a(this.jdField_a_of_type_AndroidWidgetImageView);
  ...
  private static void a(Container paramContainer, String paramString, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new nsm(paramString, paramJSONObject));
  }
  ...
  private void a(@NonNull BaseActivity paramBaseActivity, @NonNull Runnable paramRunnable)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        paramBaseActivity.requestPermissions(new nsl(this, paramRunnable), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      paramRunnable.run();
      return;
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher == null) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher = ((DailyTitleBarSwitcher)this.jdField_a_of_type_AndroidViewView.findViewById(2131364887));
      }
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher.setOnTitleClickWeatherListener(new nse(this, paramJSONObject));
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bhvy.a("sp_key_daily_dynamic_header_last_refresh_time", Long.valueOf(0L))).longValue();
  ...
  private static boolean a(Container paramContainer, JSONObject paramJSONObject)
  {
    ...
    if ((localObject instanceof TemplateBean))
    {
      ...
      try
      {
        rpr localrpr = rpr.a("daily_dynamic_header", true);
        if (localrpr != null) {}
        for (paramJSONObject = localrpr.getTemplateBean(paramJSONObject); (paramJSONObject != null) && (TextUtils.equals(paramJSONObject.getStyleName(), ((TemplateBean)localObject).getStyleName())) && (((TemplateBean)localObject).getId() == paramJSONObject.getId()); paramJSONObject = null)
        {
          QLog.i("DailyHeaderViewController", 1, "[bindDataForProteusHeader] template match, bind data");
          olo.a(paramContainer, (TemplateBean)localObject, paramJSONObject);
          return true;
        }
        return false;
      }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131364887).setVisibility(8);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376714)).removeHeaderView(this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localJSONObject.putOpt("error_reason", ajya.a(2131702711)).putOpt("operation_text", ajya.a(2131702716));
      View.OnClickListener localOnClickListener = this.c;
      for (;;)
      {
        a(localJSONObject, localOnClickListener);
        return;
        localJSONObject.putOpt("error_reason", ajya.a(2131702717)).putOpt("operation_text", ajya.a(2131702714));
        localOnClickListener = this.d;
        continue;
        localJSONObject.putOpt("error_reason", ajya.a(2131702718)).putOpt("operation_text", ajya.a(2131702715));
  ...
  private void b(View paramView)
  {
    ...
    a(((Integer)bhvy.a("sp_key_daily_dynamic_header_state", Integer.valueOf(0))).intValue());
  }
  ...
  private static void b(String paramString, JSONObject paramJSONObject)
  {
    ...
    localono.b("model_type", a(paramString));
    localono.b("topic_id", paramJSONObject.optString("topic_id", ""));
    nol.a(null, "CliOper", "", "", "0X8009D12", "0X8009D12", 0, 0, "", "", "", localono.a(), false);
  }
  ...
  private void c()
  {
    JSONObject localJSONObject = osg.a().a();
    Object localObject;
  ...
  private static void c(String paramString, JSONObject paramJSONObject)
  {
    ...
    localono.b("model_type", a(paramString));
    localono.b("topic_id", paramJSONObject.optString("topic_id", ""));
    nol.a(null, "CliOper", "", "", "0X8009D13", "0X8009D13", 0, 0, "", "", "", localono.a(), false);
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      ((JSONObject)localObject).putOpt("error_reason", ajya.a(2131702709));
      for (;;)
      {
        ((JSONObject)localObject).putOpt("operation_text", ajya.a(2131702710));
        break;
        ((JSONObject)localObject).putOpt("error_reason", ajya.a(2131702713));
        continue;
        ((JSONObject)localObject).putOpt("error_reason", ajya.a(2131702712));
      }
    }
  }
