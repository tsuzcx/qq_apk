  ...
  extends azbw
{
  ...
  public azbz(JSONObject paramJSONObject)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      while (i1 < paramJSONObject.length())
      {
        ...
        {
          localObject = new azbx(l1, ((JSONObject)localObject).optString("name") + ajyc.a(2131715098), this.jdField_e_of_type_JavaLangString.replace("${bid}", String.valueOf(l1)));
  ...
  public static ArrayList<azbz> a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      if (i1 < paramJSONArray.length()) {
        try
        {
          azbz localazbz = new azbz(paramJSONArray.optJSONObject(i1));
          if (localazbz != null) {
            localArrayList.add(new azbz(paramJSONArray.optJSONObject(i1)));
          }
          i1 += 1;
        }
