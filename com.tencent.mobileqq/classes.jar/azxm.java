  ...
  extends Handler
{
  ...
  public azxm(PublishHomeWorkFragment paramPublishHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
  ...
  void a()
  {
    ...
    localObject = localPublishHomeWorkFragment.getString(2131697694, new Object[] { Integer.valueOf(i), Integer.valueOf(j), localPublishHomeWorkFragment.jdField_a_of_type_JavaLangString }).trim();
    String str1 = localPublishHomeWorkFragment.getString(2131697694, new Object[] { Integer.valueOf(i), Integer.valueOf(j), "" }).trim();
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      case 3: 
        ...
        localPublishHomeWorkFragment.jdField_a_of_type_Bfol.c(false);
        return;
      case 515: 
      ...
      case 102: 
        ...
        if (i < 1000)
        {
          bcpw.a(localPublishHomeWorkFragment.getActivity(), ajyc.a(2131708833), 0).a();
          localPublishHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCommonRecordSoundPanel.b();
          return;
        }
        if (!bbev.d(localPublishHomeWorkFragment.getActivity()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("PublishHomeWorkFragment", 2, "no network toast");
          }
          bcpw.a(localPublishHomeWorkFragment.getActivity(), 2131697483, 0).a();
          localPublishHomeWorkFragment.f = false;
          localPublishHomeWorkFragment.l();
          return;
        }
        ...
        {
          paramMessage = new baar(paramMessage, null, i / 1000, (int)l, localPublishHomeWorkFragment.b);
