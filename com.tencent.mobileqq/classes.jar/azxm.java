  ...
  extends azut
{
  ...
  View a(View paramView, Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (paramView == null)
      {
        azxn localazxn1 = new azxn(this);
        paramView = View.inflate(paramContext, 2131561700, null);
        localazxn1.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramView.findViewById(2131370977));
        localazxn1.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367819));
        localazxn1.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366626));
        localazxn1.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131369767);
        paramView.setTag(localazxn1);
        localazxn1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(paramString);
        if (i != 1) {
          break label331;
        }
        localazxn1.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        localazxn1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(Color.parseColor("#777777"));
        localazxn1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextSize(14.0F);
        localazxn1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawables(null, null);
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.setText(this.U);
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.setEnabled(true);
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(paramContext.getResources().getDrawable(2130839144));
        paramView.setTag(2131374006, this.b);
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.setTag(2131374006, this.b);
        i = aepi.a(17.0F, paramContext.getResources());
        int j = aepi.a(16.0F, paramContext.getResources());
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.setPadding(j, 0, j, 0);
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.post(new StructMsgItemLayout20.1(this, i, localazxn1));
        paramView.setOnClickListener(this);
        localazxn1.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
        return paramView;
      }
    }
    catch (Exception localException)
    {
      ...
      do
      {
        for (;;)
        {
          ...
          i = 0;
          continue;
          localazxn2 = (azxn)paramView.getTag();
        }
      } while (i != 0);
      localazxn2.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      paramString = paramContext.getResources().getDrawable(2130840085);
      if (TextUtils.isEmpty(this.T)) {
        break label639;
      }
    }
    int i = aepi.a(40.0F, paramContext.getResources());
    ...
    paramString.setTag(bcyz.b(i, i, i / 2));
    paramString.setDecodeHandler(bcyz.c);
    localazxn2.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
    label446:
    if (this.jdField_a_of_type_Boolean)
    {
      paramString = paramContext.getResources().getDrawable(2130841432);
      localazxn2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablePadding(aepi.a(3.0F, paramContext.getResources()));
      paramString.setBounds(0, 0, aepi.a(15.0F, paramContext.getResources()), aepi.a(15.0F, paramContext.getResources()));
      localazxn2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawables(null, paramString);
      localazxn2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(Color.parseColor("#000000"));
      localazxn2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextSize(17.0F);
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setTag(localazxn2);
      if (!((alzl)((BaseActivity)paramContext).app.getManager(56)).a(Long.valueOf(Long.parseLong(this.V)))) {
        break label664;
      }
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(null);
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setText(alud.a(2131714986));
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
    }
    for (;;)
    {
      label514:
      paramView.setTag(2131374008, this.V);
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setTag(2131374008, this.V);
      break;
      label639:
      localazxn2.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
      break label446;
      localazxn2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawables(null, null);
      break label514;
      label664:
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(paramContext.getResources().getDrawable(2130839144));
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setText(alud.a(2131714992));
      localazxn2.jdField_a_of_type_AndroidWidgetTextView.setEnabled(true);
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)) && (((LinearLayout)paramView).getChildCount() == this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          if ("content".equals(localazus.jdField_a_of_type_JavaLangString))
          {
            localObject = ((azwu)localazus).Y;
    ...
    {
      localObject = (azus)paramBundle.next();
      ((azus)localObject).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      if (("content".equals(((azus)localObject).jdField_a_of_type_JavaLangString)) && ((localObject instanceof azwu))) {
        paramView.addView(a(null, paramContext, ((azwu)localObject).Y), new LinearLayout.LayoutParams(-1, -2));
      }
    }
    return paramView;
  }
  ...
  public void onClick(View paramView)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 21	azxm:S	Ljava/lang/String;
    ...
    //   52: aload_3
    //   53: bipush 88
    //   55: invokevirtual 408	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lalpd;
    ...
    //   140: aload_0
    //   141: getfield 448	azxm:jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   144: ifnull -122 -> 22
    //   147: new 450	nug
    //   150: dup
    ...
    //   161: aload_1
    //   162: aload_0
    //   163: getfield 448	azxm:jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    ...
    //   173: aload_3
    //   174: sipush 139
    //   177: invokevirtual 408	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lalpd;
    ...
    //   270: ldc_w 494
    //   273: aload_0
    //   274: getfield 448	azxm:jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   277: getfield 497	com/tencent/mobileqq/structmsg/AbsStructMsg:uin	Ljava/lang/String;
    //   280: aload_0
    //   281: getfield 448	azxm:jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    ...
    //   320: checkcast 29	azxn
    //   323: astore_1
    //   324: aload_1
    //   325: getfield 61	azxn:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   328: iconst_4
    //   329: invokevirtual 508	android/widget/TextView:setVisibility	(I)V
    //   332: aload_1
    //   333: getfield 65	azxn:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   336: iconst_0
    ...
    //   349: aload_0
    //   350: aload_1
    //   351: invokespecial 514	azxo:<init>	(Lazxm;Lazxn;)V
    //   354: iconst_1
    //   355: iconst_3
    //   356: invokestatic 517	syb:a	(Lcom/tencent/common/app/AppInterface;Landroid/content/Context;Ljava/lang/String;Lalzr;ZI)V
    //   359: new 450	nug
    //   362: dup
    ...
    //   381: aload_1
    //   382: aload_0
    //   383: getfield 448	azxm:jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    ...
    //   393: aload_3
    //   394: sipush 139
    //   397: invokevirtual 408	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lalpd;
