...
public class azxm
{
  ...
  private static void a(azxg paramazxg)
  {
    boolean bool = a(paramazxg.jdField_a_of_type_JavaLangCharSequence);
    if (((paramazxg.jdField_b_of_type_Boolean) && (paramazxg.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramazxg.jdField_c_of_type_Int = 0;
      return;
    }
    paramazxg.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<azxg> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new azxn());
    ...
    localazxg.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localazxg.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localazxg.jdField_e_of_type_Int = 2;
      localazxg.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localazxg.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localazxg.jdField_b_of_type_Boolean = true;
        localazxg.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localazxg.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localazxg.jdField_b_of_type_Boolean = true;
        if (localazxg.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localazxg.jdField_a_of_type_Float = (m * paramFloat);
            localazxg.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localazxg.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localazxg.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localazxg.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localazxg);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localazxg.d = true;
            localazxg.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localazxg.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (azxg)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (azxg)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new azxg();
                ((azxg)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((azxg)localObject2).jdField_c_of_type_Boolean = true;
                ((azxg)localObject2).jdField_b_of_type_Boolean = false;
                ((azxg)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((azxg)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
