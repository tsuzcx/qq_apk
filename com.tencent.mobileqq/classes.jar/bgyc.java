  ...
  implements Manager
{
  ...
  public bgyc(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bgmg.a(str, paramString1);
        if (!bool) {
          continue;
        }
        bgsg.c(BaseApplicationImpl.getContext(), paramInt, paramString2);
        return;
      }
      finally {}
    }
