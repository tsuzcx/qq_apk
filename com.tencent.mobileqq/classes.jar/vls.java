  ...
  extends vtt
{
  ...
  private LruCache<String, vma> c = new LruCache(200);
  ...
  private DownloadingUrlEntry a(String paramString, int paramInt)
  {
    ...
    localObject = vuu.a(QQStoryContext.a().a().createEntityManager(), DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
  ...
  public static String a(String paramString)
  {
    ...
    {
      xvv.d("Q.qqstory.DownloadUrlManager", "getIpOfDomain url: %s", new Object[] { paramString });
    }
    return null;
  }
  
  private void a(@NonNull String paramString, @NonNull vmb paramvmb)
  {
    xvv.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary , vid = %s", paramString);
    Bosses.get().postJob(new vlx(this, "Q.qqstory.DownloadUrlManager", paramString, paramvmb));
  }
  ...
  private boolean a(String paramString)
  {
    // Byte code:
    //   0: iconst_5
    //   1: invokestatic 164	vux:a	(I)Lvuf;
    //   4: checkcast 71	vuu
    //   7: aload_1
    //   8: invokevirtual 167	vuu:a	(Ljava/lang/String;)Lcom/tencent/biz/qqstory/model/item/StoryVideoItem;
    //   11: astore_3
    //   12: aload_3
    //   13: ifnonnull +11 -> 24
    //   16: ldc 169
    //   18: aload_1
    //   19: invokestatic 173	xvv:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   22: iconst_0
    //   23: ireturn
    //   24: aload_3
    ...
    //   83: invokestatic 208	xvv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   86: new 210	wfe
    //   89: dup
    //   90: invokespecial 211	wfe:<init>	()V
    //   93: astore 4
    //   95: aload 4
    ...
    //   105: putfield 217	wfe:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload 4
    //   110: getfield 217	wfe:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: aload_1
    //   114: invokeinterface 221 2 0
    //   119: pop
    //   120: aload 4
    //   122: ldc2_w 222
    //   125: putfield 225	wfe:jdField_a_of_type_Long	J
    ...
    //   163: aload 5
    //   165: aload 6
    //   167: invokespecial 236	vlz:<init>	(Lvls;Ljava/lang/String;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    //   170: astore_1
    //   171: invokestatic 241	vqn:a	()Lvqn;
    //   174: aload 4
    //   176: aload_1
    //   177: invokevirtual 244	vqn:a	(Lvqr;Lvqp;)V
    //   180: aload_3
    ...
    //   191: ldc 118
    //   193: ldc 246
    //   195: invokestatic 208	xvv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   198: iconst_0
    //   199: ireturn
    //   200: aload_2
    //   201: monitorenter
    //   202: ldc 118
    //   204: ldc 248
    //   206: invokestatic 208	xvv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   209: aload 5
  ...
  private vma b(String paramString, int paramInt)
  {
    paramString = DownloadingUrlEntry.makeKey(paramString, paramInt);
    paramString = (vma)this.c.get(paramString);
  ...
  @Deprecated
  private void b(@NonNull String paramString, @NonNull vmb paramvmb)
  {
    xvv.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessaryInner , vid = %s", paramString);
    Object localObject = ((vuu)vux.a(5)).a(paramString);
    if (localObject == null)
    {
      xvv.e("Q.qqstory.DownloadUrlManager", "DownloadUrlQueryResult:: error video is null");
      paramvmb.a(false);
      return;
    }
    ...
    xvv.d("Q.qqstory.DownloadUrlManager", ((StoryVideoItem)localObject).mVid + " request video url is expire :" + ((StoryVideoItem)localObject).videoUrlExpireTime);
    localObject = new wfe();
    ((wfe)localObject).jdField_a_of_type_JavaUtilList = new ArrayList(1);
    ((wfe)localObject).jdField_a_of_type_JavaUtilList.add(paramString);
    ((wfe)localObject).jdField_a_of_type_Long = 10000L;
    paramString = new vly(this, paramvmb, paramString);
    vqn.a().a((vqr)localObject, paramString);
  }
  ...
  public List<VideoUrlEntry> a(String paramString)
  {
    ...
    List localList = vuu.a(QQStoryContext.a().a().createEntityManager(), VideoUrlEntry.class, VideoUrlEntry.class.getSimpleName(), "vid=?", new String[] { paramString });
  ...
  public vma a(String paramString, int paramInt)
  {
    yos.b();
    vma localvma = new vma();
    localvma.jdField_a_of_type_JavaLangString = paramString;
    localvma.jdField_a_of_type_Int = paramInt;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          i = 1;
          localvma.jdField_a_of_type_Boolean = true;
          localObject2 = null;
            ...
            if (a())
            {
              ...
              if (localList != null)
              {
                ...
                if (localList.size() > 0)
                {
                  ...
                  localvma.jdField_b_of_type_Int = 2;
                  localvma.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
                  localvma.c = ((VideoUrlEntry)localObject2).videoUrlLevel;
                }
              }
            }
          }
          if (localvma.jdField_b_of_type_Int != -1) {
            break label644;
          }
          localObject2 = localvuu.a(paramString);
          ...
          if (paramInt == 0)
          {
            ...
            ((DownloadingUrlEntry)localObject1).key = DownloadingUrlEntry.makeKey(((DownloadingUrlEntry)localObject1).vid, ((DownloadingUrlEntry)localObject1).fileType);
            localvma.jdField_b_of_type_Int = 3;
            localvma.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
            if ((localObject1 != null) && (!TextUtils.isEmpty(((DownloadingUrlEntry)localObject1).url)))
            {
              localObject2 = vmq.a(paramString, paramInt, false, false);
            ...
            if (i != 0)
            {
              xvv.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: video url have expire,so we need to handle the temOrphan~~");
              paramString = a(paramString, paramInt);
              if ((paramString == null) || (!TextUtils.equals(paramString.url, localvma.jdField_b_of_type_JavaLangString))) {
                break label598;
              }
              xvv.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan false,cache entry url=" + paramString.url + " result url=" + localvma.jdField_b_of_type_JavaLangString);
              localvma.jdField_a_of_type_Boolean = false;
            }
            return localvma;
          }
        }
        else
        {
          ...
          localvma.jdField_b_of_type_Int = 0;
          localvma.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
          localvma.c = ((DownloadingUrlEntry)localObject1).compressLevel;
          return localvma;
        }
        if (paramInt == 1)
        {
      ...
      if (paramString == null)
      {
        xvv.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url");
      }
      else
      {
        xvv.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url :" + paramString.url);
        continue;
        continue;
        i = 0;
      }
  ...
  public vma a(String paramString, int paramInt, boolean paramBoolean)
  {
    yos.b();
    ...
    for (;;)
    {
      ...
      {
        localvma.a();
        localvma.jdField_a_of_type_Long = System.currentTimeMillis();
        this.c.put(str, localvma);
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
      }
      ((DownloadingUrlEntry)localObject1).url = ((StoryVideoItem)localObject2).getThumbUrl();
      continue;
  ...
  {
    if ((paramInt != 0) || (yns.a(paramString))) {
      return;
    }
    Bosses.get().postJob(new vlv(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  
  public void a(String paramString, int paramInt, vmc paramvmc)
  {
    vma localvma = b(paramString, paramInt);
    if (localvma != null)
    {
      paramvmc.a(localvma);
      return;
    ...
    if (paramInt == 0)
    {
      a(paramString, new vlt(this, paramString, paramInt, paramvmc));
      return;
    }
    Bosses.get().postJob(new vlu(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt, paramvmc));
  }
  ...
  public void a(List<List<VideoUrlEntry>> paramList)
  {
    ...
    xvv.a("Q.qqstory.DownloadUrlManager", "update video url:%s", paramList);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(localVideoUrlEntry2.videoUrl))
        {
          ...
          xvv.d("Q.qqstory.DownloadUrlManager", "%s url error!", new Object[] { localVideoUrlEntry2.vid });
          continue;
        }
  ...
  {
    xvv.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip domain - url: %s", paramString);
    ...
    for (;;)
    {
          ...
          if ((localObject != null) && (((List)localObject).size() > 0))
          {
            ...
            if (i < ((List)localObject).size())
            {
              ...
              else
              {
                ...
                xvv.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip ip - url: %s", str1);
                i += 1;
                continue;
              }
              str1 = str2 + "&txhost=" + str3;
      ...
      {
        xvv.b("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip MalformedURLException: %s", localMalformedURLException);
      }
  ...
  {
    Bosses.get().postJob(new vlw(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  ...
  public void c(String paramString, int paramInt)
  {
    try
    {
      ...
      paramString = vuu.a((EntityManager)localObject, DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
