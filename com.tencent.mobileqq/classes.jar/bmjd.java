...
public class bmjd
{
  private bmjf jdField_a_of_type_Bmjf;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger;
  
  public bmjd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(1);
    this.jdField_a_of_type_Bmjf = new bmjf(paramQQAppInterface);
  }
  ...
  private int a(String paramString, Bundle paramBundle, Handler paramHandler, long paramLong)
  {
    ...
    try
    {
      this.jdField_a_of_type_Bmjf.a(paramHandler);
      return i;
    }
  ...
  public void a()
  {
    ...
    localPluginCommunicationHandler.register(new bmje(this, "qlink.notify"));
  }
