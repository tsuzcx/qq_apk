...
public class bmjd
{
    ...
    if (ShortVideoTrimmer.initVideoTrim(paramContext, 0, 0))
    {
      ...
      if (localObject != null)
      {
        ...
        if (((ShortVideoTrimmer.CompressConfig)localObject).isNeedCompress)
        {
          ...
          localObject = new bmje(paramString2, (int)(((ShortVideoTrimmer.CompressConfig)localObject).srcBitrate * 1024L), (int)((ShortVideoTrimmer.CompressConfig)localObject).srcFrameRate);
          if ((!new VideoConverter().start(localFile, (VideoConverter.Processor)localObject, true)) || (((bmje)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 301	bmjd:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  private static JSONObject a(AppRuntime paramAppRuntime, String paramString, Bundle paramBundle1, Bundle paramBundle2)
  {
    try
    {
      paramString = nwf.a(paramAppRuntime.getApplication().getApplicationContext(), paramString, paramBundle1, paramBundle2);
