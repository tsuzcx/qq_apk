  ...
  extends WtloginObserver
{
  ...
  bhiv(Intent paramIntent, String paramString, bhiw parambhiw)
  {
  ...
  public void OnRegGetSMSVerifyLoginAccountWithLhSig(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte1 = BaseApplicationImpl.getContext().getString(2131715770);
        ...
        if (QLog.isDevelopLevel()) {
          bhix.a("LHLoginMng -- OnRegGetSMSVerifyLoginAccountWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bhiw != null) {
          this.jdField_a_of_type_Bhiw.a(localIntent, bool, this.jdField_a_of_type_JavaLangString, paramArrayOfByte4, paramArrayOfByte1);
        }
