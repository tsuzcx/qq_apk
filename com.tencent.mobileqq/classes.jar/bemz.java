...
public class bemz
{
  ...
  bemz(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if ((paramFullListGroupAppEntity == null) || (bend.a(paramFullListGroupAppEntity.troopAIOAppInfos)))
    {
  ...
  public void a()
  {
    ...
    if (!bend.a((Collection)localObject))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (!bend.a(localFullListGroupAppEntity.troopAIOAppInfos))
        {
          localbemy.a = localFullListGroupAppEntity.troopAIOAppInfos;
          QLog.i("FullListGroupAppsDbHelper", 1, "buildFullListFromDb: invoked. " + localbemy.a);
          return;
        }
      }
    }
