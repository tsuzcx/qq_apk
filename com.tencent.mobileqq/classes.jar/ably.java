...
public class ably
  extends MqqHandler
{
  public ably(LoginInfoActivity paramLoginInfoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      paramMessage = this.a.getString(2131717244);
      ...
      for (;;)
      {
        ...
        return;
        paramMessage = paramMessage + this.a.getString(2131719163);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        paramMessage = paramMessage + this.a.getString(2131719164);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        paramMessage = paramMessage + this.a.getString(2131719165);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        LoginInfoActivity.a(this.a).setText(paramMessage);
      }
