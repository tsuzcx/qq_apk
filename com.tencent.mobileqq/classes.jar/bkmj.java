...
{
  public bkmj(bkme parambkme) {}
  
  protected List<LocalMediaInfo> a(Object... paramVarArgs)
  {
    aimj localaimj = this.a.jdField_a_of_type_Bkmu.a;
    if (localaimj.selectedPhotoList == null) {
      localaimj.selectedPhotoList = new ArrayList();
    }
    Object localObject2 = localaimj.selectedPhotoList;
    if (localaimj.selectedMediaInfoHashMap == null) {
      localaimj.selectedMediaInfoHashMap = new HashMap();
    }
    Object localObject1 = localaimj.selectedMediaInfoHashMap;
    bddw.a();
    paramVarArgs = this.a.jdField_a_of_type_Bkmu.a();
    ...
    for (;;)
    {
      ...
      for (int j = ((Integer)QAlbumUtil.sLastAlbumPhotoCountMap.get(localaimj.albumId)).intValue();; j = 0)
      {
        Object localObject3;
        Object localObject4;
        if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isShowCamera) && (localaimj.albumId.equals("$RecentAlbumId")))
        {
        ...
        int i;
        if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.showCameraInVideo) && (localaimj.albumId.equals("$VideoAlbumId")))
        {
          localObject3 = paramVarArgs.iterator();
          while (((Iterator)localObject3).hasNext())
          {
        ...
        {
          break;
          this.a.jdField_a_of_type_Bkmu.a(paramVarArgs);
          ...
          if (i < paramVarArgs.size())
          {
            ...
            for (;;)
            {
              ...
              if (((ArrayList)localObject2).contains(((LocalMediaInfo)localObject4).path))
              {
                ...
                if (!localaimj.selectedIndex.contains(((LocalMediaInfo)localObject4).position)) {
                  localaimj.selectedIndex.add(((LocalMediaInfo)localObject4).position);
                }
              ...
              else if ((((ArrayList)localObject2).size() < localaimj.maxSelectNum) && (((LocalMediaInfo)localObject4).path.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.currentPhotoPath)))
              {
                ((LocalMediaInfo)localObject4).selectStatus = 1;
          ...
          if (this.a.jdField_a_of_type_Bkmu.a())
          {
            ...
            for (;;)
            {
              ...
              while (((Iterator)localObject2).hasNext())
              {
                ...
                if ((localaimj.allMediaInfoHashMap.containsKey(localObject4)) && (!((HashMap)localObject1).containsKey(localObject4))) {
                  ((HashMap)localObject1).put(localObject4, localaimj.allMediaInfoHashMap.get(localObject4));
                }
              }
              localaimj.allMediaInfoHashMap.clear();
              break;
              localaimj.allMediaInfoHashMap.put(((LocalMediaInfo)localObject1).path, localObject1);
            }
          }
          localaimj.mediaPathsList = ((ArrayList)localObject3);
  ...
  {
    this.a.jdField_a_of_type_Bkmu.a(paramList);
  }
