  ...
  extends LinearLayout
{
  ...
  public bkgv(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bkgn parambkgn)
  {
    super(paramContext);
    ...
    paramInt1 = bkik.a(getContext(), 6.0F);
    this.jdField_c_of_type_Int = ((this.jdField_a_of_type_Int - paramInt1 * ((this.b - 1) * 2)) / this.b);
    a();
  }
  
  private URLDrawable a(bkgd parambkgd)
  {
    Object localObject1 = (bjfr)bjav.a().c(12);
    Object localObject2 = bjfr.a();
    localObject1 = parambkgd.b + "_static.png";
    ...
    for (;;)
    {
      ...
      return URLDrawable.getDrawable(parambkgd, (URLDrawable.URLDrawableOptions)localObject1);
  ...
  private void a()
  {
    setOrientation(0);
    setGravity(17);
    int j = bkik.a(getContext(), 12.0F);
    int k = (int)((this.jdField_c_of_type_Int - j * 2) * this.jdField_a_of_type_Float);
    int i = 0;
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131561275, null);
  ...
  private void a(bkgd parambkgd, URLImageView paramURLImageView, QIMCommonLoadingView paramQIMCommonLoadingView, ProgressBar paramProgressBar, bkgx parambkgx, boolean paramBoolean, bkgn parambkgn)
  {
    Object localObject1 = (bjfr)bjav.a().c(12);
    Object localObject2 = bjfr.a();
    localObject1 = parambkgd.b + "_dynamic.png";
    localObject2 = new File((String)localObject2);
    String str;
    if (((File)localObject2).exists())
    {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = bbqz.a(BaseApplicationImpl.sApplication.getRuntime(), ((File)localObject2).getAbsolutePath(), "-Dynamic-", aywm.a, new int[] { 13 }, "-Dynamic-", null);
        ...
        parambkgx.onLoadSuccessed(paramURLImageView, (URLDrawable)localObject1);
      }
    ...
    for (;;)
    {
      if (!bool1)
      {
        ...
        new java.lang.ref.WeakReference(parambkgn);
        parambkgn = parambkgd.jdField_c_of_type_JavaLangString;
        localObject1 = new ayrx();
        ((ayrx)localObject1).jdField_a_of_type_Aysc = new bkgw(this, (File)localObject2, paramQIMCommonLoadingView, paramURLImageView, str, paramBoolean, parambkgx, paramProgressBar);
        ((ayrx)localObject1).jdField_a_of_type_JavaLangString = parambkgn;
        if (QLog.isColorLevel()) {
          QLog.d("InformationFaceAdapter", 2, "apng url:" + parambkgn);
        }
        ((ayrx)localObject1).jdField_a_of_type_Int = 0;
        ((ayrx)localObject1).jdField_c_of_type_JavaLangString = ((File)localObject2).getAbsolutePath();
        ((ayrx)localObject1).jdField_c_of_type_Int = bbfj.a(ayta.a().a());
        ((ayrx)localObject1).a(parambkgd);
        lch.a().a((aysy)localObject1);
      }
      return;
      ((File)localObject2).mkdirs();
      break;
  ...
  public void a(bkga parambkga, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject1 = parambkga.b(paramInt2);
      label111:
      if (localObject1 != null) {
        break label163;
      }
      ved.e("InformationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambkga.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      break;
      label153:
      localObject1 = parambkga.a(paramInt2);
      break label111;
      label163:
      ...
      else
      {
        ...
        localObject2 = new bkgx((String)localObject1, localURLImageView, localProgressBar);
        localURLImageView.setURLDrawableDownListener((URLDrawableDownListener)localObject2);
        if ((this.jdField_a_of_type_AndroidContentContext instanceof EditPicActivity))
        {
          localObject1 = a((bkgd)parambkga.a.get(paramInt2));
          if (localObject1 != null)
          {
            if (((URLDrawable)localObject1).getStatus() != 1) {
              ((URLDrawable)localObject1).restartDownload();
            ...
            if (((URLDrawable)localObject1).getStatus() == 1) {
              ((bkgx)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
            }
            if (paramBoolean) {}
            for (;;)
            {
        ...
        {
          a((bkgd)parambkga.a.get(paramInt2), localURLImageView, localQIMCommonLoadingView, localProgressBar, (bkgx)localObject2, paramBoolean, this.jdField_a_of_type_Bkgn);
        }
      }
    }
  }
