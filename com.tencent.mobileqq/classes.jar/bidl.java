  ...
  extends WebViewClient
{
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    ...
    {
      QLog.w("AbsWebView", 1, paramWebView + ", pageUrl=" + nwo.b(str, new String[0]));
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AbsWebView", 2, "shouldOverrideUrlLoading " + nwo.b(paramString, new String[0]));
    }
    ...
    if (((paramString.startsWith("http")) || (paramString.startsWith("data:"))) && (!paramString.contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(nwo.b(paramString, new String[0]));
    }
    try
    {
      if ((paramString.startsWith("http://")) || (paramString.startsWith("https://")))
