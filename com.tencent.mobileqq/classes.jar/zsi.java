...
public class zsi
{
  private static zsi jdField_a_of_type_Zsi = new zsi();
  public long a;
  public final Object a;
  public Map<String, zsc> a;
  public JSONObject a;
  ...
  static
  {
    Bosses.initWithBoss(BaseApplicationImpl.getApplication(), new sge(BaseApplicationImpl.getApplication()));
  }
  ...
  private static String a(android.content.Context paramContext, String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 59	java/io/InputStreamReader
    //   5: dup
    //   6: aload_0
    //   7: invokevirtual 65	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   10: invokevirtual 71	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   13: aload_1
    //   14: invokevirtual 77	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   17: invokespecial 80	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   20: astore_1
    //   21: aload_1
    //   22: astore_0
    //   23: new 82	java/io/BufferedReader
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 85	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   31: astore_2
    //   32: aload_1
    //   33: astore_0
    //   34: new 87	java/lang/StringBuilder
    //   37: dup
    //   38: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   41: astore 4
    //   43: aload_1
    //   44: astore_0
    //   45: aload_2
    //   46: invokevirtual 92	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   49: astore 5
    //   51: aload 5
    //   53: ifnull +47 -> 100
    //   56: aload_1
    ...
    //   68: aload 4
    //   70: bipush 10
    //   72: invokevirtual 99	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   75: pop
    //   76: goto -33 -> 43
    //   79: astore_2
    //   80: aload_1
    //   81: astore_0
    //   82: aload_2
    //   83: invokevirtual 102	java/lang/Exception:printStackTrace	()V
    //   86: aload_3
    //   87: astore_0
    //   88: aload_1
    //   89: ifnull +9 -> 98
    //   92: aload_1
    //   93: invokevirtual 105	java/io/InputStreamReader:close	()V
    //   96: aload_3
    //   97: astore_0
    //   98: aload_0
    //   99: areturn
    ...
    //   111: ifnull -13 -> 98
    //   114: aload_1
    //   115: invokevirtual 105	java/io/InputStreamReader:close	()V
    //   118: aload_2
    //   119: areturn
    //   120: astore_0
    //   121: aload_2
    ...
    //   127: ifnull +7 -> 134
    //   130: aload_0
    //   131: invokevirtual 105	java/io/InputStreamReader:close	()V
    //   134: aload_1
    //   135: athrow
    //   136: astore_0
    //   137: aconst_null
  ...
  private boolean a(String paramString)
  {
    ...
    if ((zsc)this.jdField_a_of_type_JavaUtilMap.get(paramString) != null) {
      return true;
    }
  ...
  public zsc a(String paramString)
  {
    ...
    {
      return localObject;
      localzsc = (zsc)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      localObject = localzsc;
    } while (localzsc != null);
      ...
      if (localJSONObject2 != null)
      {
        ...
        if (localJSONArray != null)
        {
          ...
          for (i = 1;; i = 0)
          {
            ...
            paramString = new zsc((String)localObject, localJSONObject2.optString("name"));
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 43	zsi:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   39: aload 4
    //   41: ldc 214
    //   43: invokestatic 164	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   46: ifeq +52 -> 98
    //   49: aload_3
    //   50: ldc 216
    //   52: aconst_null
    ...
    //   70: aload_0
    //   71: aload 4
    //   73: invokespecial 222	zsi:b	(Ljava/lang/String;)Z
    //   76: istore_2
    //   77: iload_2
    //   78: istore_1
    //   79: iload_2
    ...
    //   113: ldc 200
    //   115: invokestatic 235	zsi:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   118: astore_3
    //   119: aload_3
    ...
    //   126: aload_0
    //   127: aload_3
    //   128: invokespecial 222	zsi:b	(Ljava/lang/String;)Z
    //   131: istore_1
    //   132: iload_1
    //   133: ifne +11 -> 144
    //   136: ldc 177
    ...
    //   144: aload_0
    //   145: iconst_1
    //   146: putfield 43	zsi:jdField_a_of_type_Boolean	Z
    //   149: goto -138 -> 11
    //   152: astore_3
    //   153: aload_0
    //   154: monitorexit
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, zss paramzss)
  {
    paramString1 = armw.a().a(paramString2, paramInt, 1, false, null, 1);
    if (paramString1 != null)
    {
      ThreadManager.getUIHandler().post(new DefaultDoraemonAppInfoHelper.2(this, paramzss, paramString1));
      return;
    }
    paramString1 = new armr(paramString2, paramInt);
    paramString1.k = paramString3;
    paramString1.i = paramString4;
    paramString1.j = paramString5;
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new zsp(null)).map(new zsq(null)).map(new zsk(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new zsj(this, paramzss));
  }
  
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, zss paramzss)
  {
    armr localarmr = armw.a().a(paramString2, paramInt, 1, false, null, 1);
    paramString1 = localarmr;
    if (localarmr == null) {
      paramString1 = new armr(paramString2, paramInt);
    }
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new zsp(null)).map(new VerifyUrlJobSegment(paramString3)).map(new zsq(null)).map(new zsn(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new zsm(this, paramzss));
  }
