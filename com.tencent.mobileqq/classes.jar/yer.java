  ...
  extends ajtb
{
  ...
  akge jdField_a_of_type_Akge = new yeu(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new yet(this);
  public HashMap<String, List<ybw>> a;
  private List<Long> jdField_a_of_type_JavaUtilList = new ArrayList();
  public ConcurrentHashMap<Long, MessageRecord> a;
  public ybp a;
  private ybw jdField_a_of_type_Ybw = new yes(this);
  public yel a;
  ...
  public yer(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Ybw);
    this.jdField_a_of_type_Yep = new yep(paramQQAppInterface);
    this.jdField_a_of_type_Yel = new yel(paramQQAppInterface);
    this.jdField_a_of_type_Ybp = new ybp();
    this.jdField_a_of_type_Yeq = new yeq(paramQQAppInterface);
    a(f, this.jdField_a_of_type_Ybp);
    a(e, this.jdField_a_of_type_Ybp);
    a(g, this.jdField_a_of_type_Ybp);
    a(g, this.jdField_a_of_type_Yel);
    a(g, this.jdField_a_of_type_Yeq);
    a(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Yep);
    a(c, this.jdField_a_of_type_Yep);
    a(d, this.jdField_a_of_type_Yep);
    a(h, this.jdField_a_of_type_Yep);
    a("8000-NASDevMusicFile", this.jdField_a_of_type_Yep);
    a("8001-NASDevVideoFile", this.jdField_a_of_type_Yep);
    a("8002-NASDevDocumentFile", this.jdField_a_of_type_Yep);
    a("8003-NASDevCommonFile", this.jdField_a_of_type_Yep);
    a("", this.jdField_a_of_type_Yep);
    a("", this.jdField_a_of_type_Ybp);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Akge);
    paramQQAppInterface = (akgd)paramQQAppInterface.a(34);
  ...
  private void a()
  {
    DeviceInfo[] arrayOfDeviceInfo = ((yah)this.app.a(51)).a();
  ...
  {
    MessageForDeviceText localMessageForDeviceText = (MessageForDeviceText)axas.a(-4508);
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong)
  {
    ...
    String str = aany.f + "http://maps.google.com/maps?q=" + paramString2 + "," + paramString3 + "&iwloc=A&hl=zh-CN (" + paramString5 + ")";
    ...
    for (paramContext = paramContext.getResources().getString(2131691295) + " " + paramString4;; paramContext = paramContext.getResources().getString(2131691295))
    {
      ...
      paramContext = new axum(StructMsgForGeneralShare.class).c(32).a(paramContext).d(str).a("plugin", paramString2, paramString2, paramString2, paramString2).a();
      ...
      paramContext = axas.a(this.app, this.app.getCurrentAccountUin(), paramString1, this.app.getCurrentAccountUin(), 9501, 100L, paramContext);
  ...
  public ybp a()
  {
    return this.jdField_a_of_type_Ybp;
  }
  
  public yel a()
  {
    return this.jdField_a_of_type_Yel;
  }
  
  public yep a()
  {
    return this.jdField_a_of_type_Yep;
  }
  
  public yeq a()
  {
    return this.jdField_a_of_type_Yeq;
  }
  ...
  public void a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      long l = ((JSONObject)localObject).optLong("msg_time", awzy.a());
  ...
  {
    ArrayList localArrayList = bbbr.a(paramString, 560, 20, null, new ArrayList());
    int i = 0;
    if (i < localArrayList.size())
    {
      ...
      paramString = "";
      if (str1 != null) {
        paramString = axau.a(str1, true, null);
      }
      int j = (int)awzy.a();
      ...
      localMessageForDeviceText.shmsgseq = axau.a(i, paramSessionInfo.jdField_a_of_type_Int);
      ...
      for (;;)
      {
        if (localMessageForDeviceText.extraflag != 32768)
        {
          ...
          ((yah)paramQQAppInterface.a(51)).a(localMessageForDeviceText.msg, Long.parseLong(localMessageForDeviceText.frienduin), l, localMessageForDeviceText.msgseq);
        }
        i += 1;
        break;
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    default: 
      paramInt = i;
      localMessageForGrayTips = (MessageForGrayTips)axas.a(paramInt);
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      i = -5001;
      localMessageForNewGrayTips = (MessageForNewGrayTips)axas.a(i);
  ...
  public boolean a(String paramString, ybw paramybw)
  {
    ...
    if (!((List)localObject).contains(paramybw)) {
      ((List)localObject).add(paramybw);
    }
    return true;
  }
  
  public boolean b(String paramString, ybw paramybw)
  {
    paramString = (List)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {
      paramString.remove(paramybw);
    }
    return true;
  }
  ...
  {
    super.onDestroy();
    b(f, this.jdField_a_of_type_Ybp);
    b(e, this.jdField_a_of_type_Ybp);
    b(g, this.jdField_a_of_type_Ybp);
    b(g, this.jdField_a_of_type_Yel);
    b(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Yep);
    b(c, this.jdField_a_of_type_Yep);
    b(d, this.jdField_a_of_type_Yep);
    b(h, this.jdField_a_of_type_Yep);
    b("8000-NASDevMusicFile", this.jdField_a_of_type_Yep);
    b("8001-NASDevVideoFile", this.jdField_a_of_type_Yep);
    b("8002-NASDevDocumentFile", this.jdField_a_of_type_Yep);
    b("8003-NASDevCommonFile", this.jdField_a_of_type_Yep);
    b("", this.jdField_a_of_type_Yep);
    b("", this.jdField_a_of_type_Ybp);
    this.app.removeObserver(this.jdField_a_of_type_Ybw);
    this.app.getApp().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.app.removeObserver(this.jdField_a_of_type_Akge);
    this.jdField_a_of_type_Yep = null;
    this.jdField_a_of_type_Yel = null;
    this.jdField_a_of_type_Ybp = null;
    this.jdField_a_of_type_Yeq = null;
  }
