...
public class aakt
{
  ...
  private ShareActionSheet.OnItemClickListener jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet$OnItemClickListener = new aakx(this);
  private ShareActionSheet jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet;
  private final String b = "https://h5.qzone.qq.com/subscription/jump?_wv=3&_proxy=1&schema=";
  private final String c = anhk.ba + "subscribe_card/";
  private String d;
  
  static
  {
    jdField_a_of_type_JavaLangString = anhk.ba + "subscribe_shared_card/";
  }
  
  public aakt(Activity paramActivity)
  {
  ...
  {
    if ((this.jdField_a_of_type_Aabx != null) && (this.jdField_a_of_type_Aabx.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null)) {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Aabx.jdField_a_of_type_Int == 1) {
        return new SubScribePersonalSharedCardView(this.jdField_a_of_type_AndroidAppActivity);
      }
      if (this.jdField_a_of_type_Aabx.jdField_a_of_type_Int == 3) {
        return new SubscribeVideoSharedCardView(this.jdField_a_of_type_AndroidAppActivity);
      }
    } while (this.jdField_a_of_type_Aabx.jdField_a_of_type_Int != 4);
    return new SubscribeMultiPicSharedCardView(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private String a(android.content.Context paramContext, String paramString)
  {
    ...
    //   54: invokestatic 187	yqp:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   57: aload_1
  ...
  {
    boolean bool = anhk.bg.equals(paramString);
    bgmg.c(paramString + ".nomedia");
    if ((this.jdField_a_of_type_Aabx != null) && (this.jdField_a_of_type_Aabx.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null) && (this.jdField_a_of_type_Aabx.a() != null))
    {
      switch (this.jdField_a_of_type_Aabx.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType)
      {
      case 7003: 
      ...
      case 7000: 
      case 7001: 
        localStringBuilder = new StringBuilder().append(paramString).append(((CertifiedAccountMeta.StFeed)this.jdField_a_of_type_Aabx.a().get()).id.get());
        if (bool) {}
        for (paramString = Long.valueOf(System.currentTimeMillis());; paramString = "") {
          return paramString + ".png";
        }
      }
      StringBuilder localStringBuilder = new StringBuilder().append(paramString).append(bisz.a(this.jdField_a_of_type_Aabx.a().poster.id.get()));
      if (bool) {}
      for (paramString = Long.valueOf(System.currentTimeMillis());; paramString = "") {
        return paramString + ".png";
      }
  ...
  private void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_AndroidAppActivity != null)
    {
      ...
      if (this.jdField_a_of_type_Aakq == null) {
        this.jdField_a_of_type_Aakq = new aakq(this.jdField_a_of_type_AndroidAppActivity, "卡片生成中...");
      }
      if ((!this.jdField_a_of_type_Aakq.isShowing()) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        this.jdField_a_of_type_Aakq.show();
      }
    }
    label64:
    while ((this.jdField_a_of_type_Aakq == null) || (!this.jdField_a_of_type_Aakq.isShowing()) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
      return;
    }
    this.jdField_a_of_type_Aakq.dismiss();
  }
  ...
  {
    Object localObject2 = "";
    CertifiedAccountRead.StGetMainPageRsp localStGetMainPageRsp = zzz.a();
    ...
    try
    {
      ...
      ((StringBuilder)localObject2).append(URLEncoder.encode(aakz.a(this.jdField_a_of_type_Aabx.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get(), this.jdField_a_of_type_Aabx.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.nick.get(), this.jdField_a_of_type_Aabx.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.icon.get()), "UTF-8"));
  ...
  private String c()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_Aabx.h())) {
      try
      {
        Object localObject = new StringBuilder("https://h5.qzone.qq.com/subscription/jump?_wv=3&_proxy=1&schema=");
        ((StringBuilder)localObject).append(URLEncoder.encode(aakz.a(this.jdField_a_of_type_Aabx.a()), "UTF-8"));
    ...
    return this.jdField_a_of_type_Aabx.h();
  }
  ...
  private void c()
  {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      bool = aoqb.a(this.jdField_a_of_type_AndroidAppActivity);
    }
    if (!bool)
    {
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bihh = new aaky(this);
  ...
  {
    if (Build.VERSION.SDK_INT >= 23) {}
    for (boolean bool = aoqb.a(this.jdField_a_of_type_AndroidAppActivity);; bool = true)
    {
      if (!bool)
      {
        bglp.b(this.jdField_a_of_type_AndroidAppActivity);
      ...
      if ((paramaabx == null) || (!bgnt.g(this.jdField_a_of_type_AndroidAppActivity)))
      {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, 2131716030, 1).a();
