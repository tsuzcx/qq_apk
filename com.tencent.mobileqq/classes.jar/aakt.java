...
public class aakt
  extends ajuc
{
  public aakt(ChatSettingForTroop paramChatSettingForTroop) {}
    ...
    do
    {
      for (;;)
      {
        ...
        if ((1 == paramInt1) && ((this.a.isResume()) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.cGroupOption == 1)))
        {
          ...
          case -1: 
          default: 
            this.a.jdField_a_of_type_Bbmv.b(2, 2131628045, 1500);
          }
          for (;;)
          {
            this.a.b = null;
            return;
            ((ajtg)this.a.app.a(20)).b(Long.parseLong(paramString), Long.parseLong(this.a.app.getAccount()));
            continue;
            this.a.jdField_a_of_type_Bbmv.b(2, 2131628046, 1500);
            this.a.finish();
            ...
            if (localObject != null)
            {
              ...
              continue;
              this.a.jdField_a_of_type_Bbmv.b(2, 2131654599, 1500);
            }
          }
        }
        if (this.a.isResume())
        {
          ...
          if (paramInt2 == 0)
          {
            ...
            for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin))
            {
              ...
              this.a.c.setText(ajjy.a(2131635959) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + ajjy.a(2131635961));
              return;
            }
          }
        }
  ...
  protected void a(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      bbmy.a(this.a, 2, 2131652917, 1).b(this.a.getTitleBarHeight());
    }
    for (;;)
    {
      this.a.finish();
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, ArrayList<azkr> paramArrayList)
  {
