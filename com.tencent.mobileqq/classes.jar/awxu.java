  ...
  implements View.OnClickListener
{
  ...
  public awxu(Context paramContext)
  {
  ...
  private void b(String paramString)
  {
    ...
    acqv.a(this.jdField_a_of_type_AndroidContentContext, localIntent, paramString);
  }
  ...
  void a(View paramView)
  {
    if (paramView != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363144));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370652));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365051));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369733));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131363741));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131363742));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131363743));
      this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131363145);
      this.jdField_a_of_type_ArrayOfAndroidViewView[0] = paramView.findViewById(2131363319);
      this.jdField_a_of_type_ArrayOfAndroidViewView[1] = paramView.findViewById(2131363321);
      this.jdField_a_of_type_ArrayOfAndroidViewView[2] = paramView.findViewById(2131363320);
      this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131363744);
      if ((this.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_a_of_type_AndroidWidgetImageView).setMaskShape(bfwr.jdField_c_of_type_Int);
      }
      if ((this.jdField_b_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_b_of_type_AndroidWidgetImageView).setMaskShape(bfwr.jdField_c_of_type_Int);
      }
      this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new awxv(this));
      paramView.setOnClickListener(new awxw(this));
    }
  }
  ...
  void b()
  {
    ...
    label363:
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new awxx(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      ...
      if (this.jdField_d_of_type_Int == 1) {
        awsq.a(null, this.jdField_c_of_type_Int, 0, "0X8009D2D", this.jdField_b_of_type_Int, i, this.g);
      }
      break;
    }
    for (;;)
    {
      ...
      i = 3;
      break;
      awsq.a(null, this.jdField_c_of_type_Int, 0, "0X8009D41", this.jdField_b_of_type_Int, i, this.g);
    }
    label203:
    bbeg localbbeg = bbex.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, paramView);
    if (localbbeg != null)
    {
      localbbeg.c();
      return;
