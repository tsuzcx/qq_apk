  ...
  implements View.OnClickListener
{
  ...
  protected String a;
  private List<bgzp> jdField_a_of_type_JavaUtilList = new ArrayList();
  protected View b;
  protected boolean b;
  ...
  public bgzl(Activity paramActivity)
  {
  ...
  private void b()
  {
    ...
    for (View localView = View.inflate(BaseApplicationImpl.getContext(), 2131561530, null);; localView = View.inflate(BaseApplicationImpl.getContext(), 2131561532, null))
    {
      ...
      this.jdField_a_of_type_Asdu = ((asdu)localView.findViewById(2131369717));
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131369719));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131369718));
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Bgzi != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
    ...
    try
    {
      ...
      label109:
      if (this.jdField_a_of_type_Bgzi.a())
      {
        bgzi localbgzi = this.jdField_a_of_type_Bgzi;
        localbgzi.a(new bgzm(this, localbgzi));
        return;
      }
  ...
  public View a(String paramString1, String paramString2, bgzo parambgzo)
  {
    return a(paramString1, paramString2, false, parambgzo);
  }
  
  public View a(String paramString1, String paramString2, boolean paramBoolean, bgzo parambgzo)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new bgzp(this);
        ((bgzp)localObject1).jdField_a_of_type_JavaLangString = paramString1;
        ((bgzp)localObject1).jdField_a_of_type_Boolean = paramBoolean;
        ((bgzp)localObject1).b = paramString2;
        ((bgzp)localObject1).jdField_a_of_type_Bgzo = parambgzo;
        this.jdField_a_of_type_JavaUtilList.add(localObject1);
        return null;
      }
      if ((this.jdField_a_of_type_Bgzi != null) && (this.jdField_a_of_type_Bgzi.a())) {
        return null;
      }
      if (this.jdField_a_of_type_AndroidAppActivity == null) {
        return null;
      }
      this.jdField_a_of_type_Ascp = bgzi.a(paramString1, paramString2);
      if (this.jdField_a_of_type_Ascp == null) {
        return null;
      }
      this.jdField_a_of_type_JavaLangString = paramString1;
      b();
      this.jdField_a_of_type_Bgzi = new bgzi(this);
      ...
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.updateViewLayout((View)this.jdField_a_of_type_Asdu, (ViewGroup.LayoutParams)localObject2);
      if (!paramBoolean) {
        a(0);
      }
      ...
      if (paramBoolean)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).topMargin = bbkx.a(75.0F);
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = bbkx.a(75.0F);
        ((FrameLayout.LayoutParams)localObject1).leftMargin = bbkx.a(15.0F);
        ((FrameLayout.LayoutParams)localObject1).rightMargin = bbkx.a(15.0F);
        this.jdField_a_of_type_Asdu.setIsFullScreen(false);
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setTouchEffect(true);
        ((View)this.jdField_a_of_type_Asdu).setClickable(false);
        ((View)this.jdField_a_of_type_Asdu).setFocusable(false);
      ...
      this.jdField_a_of_type_Asdu.setIsFullScreen(this.jdField_a_of_type_Ascp.jdField_b_of_type_Boolean);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Asdu;
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((View)localObject1).setVisibility(0);
      ((SurfaceView)localObject1).setZOrderOnTop(true);
      ((SurfaceView)localObject1).getHolder().setFormat(-2);
      localObject2 = new asdp();
      ((asdp)localObject2).a((asdb)localObject1);
      this.jdField_a_of_type_Bgzi.a((asdp)localObject2);
      this.jdField_a_of_type_Bgzi.a(new bgzn(this, l, parambgzo));
      this.jdField_a_of_type_Bgzi.a(paramString1, paramString2);
    }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Bgzi != null) && (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8))
    {
      c();
      return true;
    }
