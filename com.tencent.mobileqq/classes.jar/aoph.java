...
class aoph
  implements acmg
{
  aoph(aooy paramaooy, long paramLong1, long paramLong2, structmsg.ReqSystemMsgRead paramReqSystemMsgRead) {}
  
  public ToServiceMsg a()
  {
    ToServiceMsg localToServiceMsg = aooy.c(this.jdField_a_of_type_Aooy).createToServiceMsg("ProfileService.Pb.ReqSystemMsgRead");
