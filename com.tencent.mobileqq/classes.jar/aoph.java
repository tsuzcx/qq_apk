  ...
  extends anii
{
  ...
  public aoph(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + ancb.ax, 0L);
  }
  
  public static String a()
  {
    return "client_script_config_" + ancb.au;
  }
  
  public static void a(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + ancb.ax, paramLong).commit();
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      b(0L);
      aoph localaoph = (aoph)paramQQAppInterface.a(115);
      if (localaoph == null) {
        break label49;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (i == 0) {
      ((amhd)paramQQAppInterface.getManager(153)).a(true, "checkApolloPanelJsonVer : local ver==0", paramInt);
    }
    for (;;)
    {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + ancb.au, 0L);
  }
  
  public static String b()
  {
    return "client_script_config_" + ancb.ax;
  }
  
  public static void b(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + ancb.au, paramLong).commit();
    QLog.i("ApolloContentUpdateHandler", 1, "updateApolloBaseResVersion version: " + paramLong);
  }
  
  private static void b(QQAppInterface paramQQAppInterface)
  {
    amxb.a(paramQQAppInterface, ancb.av + "base.zip", ancb.at, null, new aopj());
  }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    ...
    if (i == 0)
    {
      ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "login : local ver==0", 1);
      return null;
    }
    ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(false, "login : check action", 1);
  ...
  protected void a(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    if ((paramRspAppInfo.rpt_msg_rspiteminfo.has()) && (paramRspAppInfo.rpt_msg_rspiteminfo.size() > 0))
    {
      ...
      ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "12h update...", 1);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b();
      }
  ...
  public void a(ArrayList<ClubContentUpdateInfoPb.ReqAppInfo> paramArrayList)
  {
    ...
    if (paramArrayList == null)
    {
      ...
      if (amhd.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
      {
        i = ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
        if (2 != i)
        {
    ...
    for (;;)
    {
      ...
      break;
      if (atwl.a(ApolloUtil.a)) {
        amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    {
      amyz.a(null, (AppInterface)localObject, i, bool);
  ...
  {
    if (!amhd.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
  ...
  public ClubContentUpdateInfoPb.ReqAppInfo c()
  {
    ...
    Object localObject2 = new File(ancb.c, "/def/role/0/config.json");
    ...
    for (;;)
    {
      try
      {
        long l = new JSONObject(bgmg.a((File)localObject2)).optLong("version");
        ...
        localObject2 = new File(ancb.g);
        if ((((File)localObject2).exists()) && (((File)localObject2).isDirectory())) {
          ((File)localObject2).listFiles(new aopi(this, (SparseArray)localObject1));
        }
        localObject2 = new ArrayList();
        i = 0;
  ...
  public void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    for (;;)
    {
      localObject = ancb.av + "base.zip";
      Bundle localBundle;
      if ((1 == (j & 0x1)) || (bool))
      {
        localBundle = new Bundle();
        localBundle.putLong("version", i);
        amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, ancb.at, localBundle, new aopj());
      }
      ...
      if ((((File)localObject).list() == null) || (((File)localObject).list().length == 0))
      {
        ...
        for (;;)
        {
          localObject = ancb.ay + "base.zip";
          if ((1 == (j & 0x1)) || (bool))
          {
            localBundle = new Bundle();
            localBundle.putLong("version", i);
            amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, ancb.aw, localBundle, new aopk());
          }
