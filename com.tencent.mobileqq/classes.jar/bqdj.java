  ...
  implements Handler.Callback, View.OnClickListener
{
    ...
    if (wta.f())
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (wta.h())
        {
          ...
          wta.d();
          yup.a("video_edit", "exp_qztip", 0, 0, new String[0]);
        }
      }
    }
    for (;;)
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageButton = ((PressDarkImageButton)a(2131378311));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131378307));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131378308));
  ...
  public void a(int paramInt, @NonNull bqua parambqua)
  {
    ...
    yuk.d("Q.qqstory.publish.edit.EditSyncQzonePart", "story_sync_qzone : %s", new Object[] { Boolean.valueOf(bool) });
    parambqua.a.putExtra("story_sync_qzone", Boolean.valueOf(bool));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bqgk.a() != null) {
        this.jdField_a_of_type_Bqgk.a().a.add(Integer.valueOf(11));
      }
      bpvq.a(paramView, 200L, new bqdk(this));
      if (this.jdField_a_of_type_Boolean) {}
      for (String str = "1";; str = "2")
      {
        yup.a("video_edit", "clk_qzone", 0, 0, new String[] { str });
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
        break;
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
      yup.a("video_edit", "clk_qztip", 0, 0, new String[0]);
    }
  }
}
