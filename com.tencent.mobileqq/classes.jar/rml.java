...
public class rml
{
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, FastWebActivity paramFastWebActivity, JSONObject paramJSONObject, List<BaseData> paramList, ArrayList<String> paramArrayList)
  {
    ...
    try
    {
          ...
          if (bool) {
            try
            {
              ...
              if (((ProteusItemData)localObject).s == 2) {
                paramArrayList.add(onh.f(((ProteusItemData)localObject).b.getString("articleImageUrl")));
              }
            }
      ...
      badv.a(paramFastWebActivity, paramArrayList.indexOf(onh.f(paramJSONObject)), paramArrayList, null, null, false, true, "4", 1000, null, null, null, null, "", true);
    }
    ...
    {
      rno.a(paramArticleInfo, "0X8008996", onh.a(paramFastWebActivity, paramArticleInfo, 0, paramFastWebArticleInfo).toString());
      return;
    }
  }
