  ...
  extends asbj
{
  ...
  protected void onGetDiscVideoThumbInfo(boolean paramBoolean, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, long paramLong, Bundle paramBundle)
  {
    ...
    asgs localasgs = asgq.a(this.a, paramLong, false);
    if (localasgs == null)
    {
    ...
    if (!paramBoolean)
    {
      this.a.a.getFileManagerNotifyCenter().a(false, 50, new Object[] { localasgs.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity });
      this.a.a(paramLong);
      this.a.a(paramLong, false, null, 0, null, null, paramString2, false, null, (short)0, null);
      return;
    }
    ...
    paramString5 = "/ftn_video_pic/rkey=" + paramString3 + "&filetype=" + localasgs.b + "&size=" + this.a.a(localasgs.jdField_a_of_type_Int) + "&";
    paramBoolean = false;
    short s1 = 0;
    if ((asld.h(this.a.a)) && (paramBundle != null))
    {
