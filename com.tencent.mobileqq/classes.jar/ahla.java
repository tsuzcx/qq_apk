  ...
  extends ahlb
{
  ...
  private void d()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("RMRecordState", 2, "[@] [startRecordVideo]Lock.CAPTURE_LOCK=" + awjh.jdField_a_of_type_Boolean);
    }
    if (!awjh.jdField_a_of_type_Boolean) {}
    synchronized (awjh.jdField_a_of_type_JavaLangObject)
    {
      awjh.jdField_a_of_type_Boolean = true;
      awjh.jdField_a_of_type_JavaLangObject.notifyAll();
      if (QLog.isColorLevel()) {
        QLog.d("RMRecordState", 2, "[@] [startRecordVideo]Lock.CAPTURE_LOCK=" + awjh.jdField_a_of_type_Boolean);
      }
  ...
  {
    RMVideoStateMgr localRMVideoStateMgr = RMVideoStateMgr.a();
    localRMVideoStateMgr.jdField_a_of_type_Ahlj.p();
  ...
  {
    paramawhf = RMVideoStateMgr.a();
    if (paramawhf.jdField_b_of_type_Boolean) {}
    for (paramawhf.jdField_a_of_type_Double = (System.currentTimeMillis() - paramawhf.jdField_a_of_type_Long);; paramawhf.jdField_a_of_type_Double = paramInt1)
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_Boolean = paramBoolean;
        if ((paramawhf.h()) && (!paramawhf.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceAudioCapture.e) && (!paramawhf.h)) {
          paramawhf.jdField_a_of_type_AndroidOsHandler.post(new RMVideoRecordState.2(this));
        }
        if (QLog.isColorLevel()) {
          QLog.d("RMRecordState", 2, "[@] timeExpire: mIsRecordOver=" + this.jdField_a_of_type_Boolean + " mStateMgr.mTotalTime=" + paramawhf.jdField_a_of_type_Double);
        }
        paramawhf.jdField_a_of_type_Ahlj.a((int)(paramawhf.jdField_a_of_type_Double + awjj.a().a().a()), this.jdField_a_of_type_Boolean);
        if (this.jdField_a_of_type_Boolean) {
          paramawhf.jdField_a_of_type_AndroidOsHandler.post(new RMVideoRecordState.3(this));
        }
      }
      return;
    }
  ...
  public void c()
  {
    RMVideoStateMgr localRMVideoStateMgr = RMVideoStateMgr.a();
    if (QLog.isColorLevel()) {
      QLog.d("RMRecordState", 2, "[@] [stopRecordVideo]Lock.CAPTURE_LOCK = " + awjh.jdField_a_of_type_Boolean);
    }
    if (awjh.jdField_a_of_type_Boolean)
    {
      awjh.jdField_a_of_type_Boolean = false;
      ...
      if (this.jdField_a_of_type_Boolean) {
        localRMVideoStateMgr.jdField_a_of_type_Double = awje.c;
      }
      localRMVideoStateMgr.jdField_a_of_type_Ahlj.u();
      ...
      if (localRMVideoStateMgr.b(3))
      {
        if (localRMVideoStateMgr.jdField_a_of_type_Awky != null) {
          localRMVideoStateMgr.jdField_b_of_type_JavaLangString = localRMVideoStateMgr.jdField_a_of_type_Awky.a(localRMVideoStateMgr);
        }
      ...
      long l2 = localRMVideoStateMgr.jdField_a_of_type_Ahlj.d();
      if (QLog.isColorLevel()) {
      ...
      {
        localRMVideoStateMgr.jdField_a_of_type_Ahlj.g(true);
        localRMVideoStateMgr.a(true);
      }
      if (QLog.isColorLevel()) {
        QLog.d("RMRecordState", 2, "[@] stopRecordVideo end Lock.CAPTURE_LOCK = " + awjh.jdField_a_of_type_Boolean);
      }
    }
  }
