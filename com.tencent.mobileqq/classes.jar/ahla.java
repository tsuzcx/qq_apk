...
public class ahla
{
  ...
  {
    int i = 0 + baba.a().a(paramQQAppInterface) + alws.b(paramQQAppInterface);
  ...
  {
    if ((parambcws == null) || (paramString == null) || (paramInt == -1)) {
      return null;
    }
    if (parambcws.a()) {
      parambcws.b();
    }
    Bitmap localBitmap2 = parambcws.a(paramInt, paramString);
    Bitmap localBitmap1 = localBitmap2;
    if (localBitmap2 == null)
    {
      parambcws.a(paramString, paramInt, true);
      if (paramInt != 4) {
        break label68;
      }
    }
    label68:
    for (localBitmap1 = bdda.f();; localBitmap1 = bdda.a()) {
