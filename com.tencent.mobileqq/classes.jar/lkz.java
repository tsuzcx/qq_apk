  ...
  extends ljg
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new lla(this);
  Handler jdField_a_of_type_AndroidOsHandler;
  HandlerThread jdField_a_of_type_AndroidOsHandlerThread = new HandlerThread("VideoNodeReportThread");
  public List<llb> a;
  
  public lkz(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private void b(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    {
      localObject1 = new llb();
      ((llb)localObject1).a = paramLong1;
    ...
    if (((llb)localObject1).a == locallid.b()) {
      ((llb)localObject1).a(locallid, (String)localObject2);
    }
    localObject2 = ((llb)localObject1).a();
    localObject1 = ((llb)localObject1).a(paramInt, paramLong2);
  ...
  private void c(long paramLong)
  {
    ...
    localEditor.commit();
    lek.d("VideoNodeReporter", "removeSpSessionRecord,roomId = " + paramLong);
  }
  
  llb a(long paramLong)
  {
  ...
  protected void a()
  {
    lek.d("VideoNodeReporter", "onCreate ");
    c();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    {
      lek.d("VideoNodeReporter", " report error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lek.d("VideoNodeReporter", " report error 1 ,exit has been called,node = " + paramInt);
      return;
    }
  ...
  public void a(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a() == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a() == null))
    {
      lek.d("VideoNodeReporter", " reportByRoomId error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lek.d("VideoNodeReporter", " reportByRoomId error 1 ,exit has been called,node = " + paramInt);
      return;
    }
    if (paramLong1 == 0L)
    {
  ...
  {
    lek.d("VideoNodeReporter", " onSessionStatusChanged :" + paramInt + ",para = " + paramString2);
    switch (paramInt)
    {
    case 2: 
    case 3: 
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (paramString1.hasNext()) {
        ((llb)paramString1.next()).b = System.currentTimeMillis();
      }
    }
