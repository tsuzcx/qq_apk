...
{
  private static boolean jdField_a_of_type_Boolean = axhq.c(axhq.z);
  ...
  private blcv a()
  {
    blcv localblcv = this.jdField_a_of_type_Blcn.a.b();
    if (localblcv != null) {
      return localblcv;
    }
    localblcv = this.jdField_a_of_type_Blcn.a.a();
    if (localblcv != null)
    {
      this.jdField_a_of_type_Blcp.a(localblcv.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localblcv;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Blco.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Blco.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Blco.jdField_b_of_type_Int = 0;
    bksx.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Blco.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (blcn.a(this.jdField_a_of_type_Blcn))
    {
      Object localObject2 = blcn.a(this.jdField_a_of_type_Blcn);
  ...
  private void f()
  {
    if (this.jdField_a_of_type_Blcp != null) {
      this.jdField_a_of_type_Blcp.c();
    }
    this.jdField_a_of_type_Blcp = null;
    a();
  ...
  {
    b(false);
    bkpu.a("destroy OffScreenGLSurface");
  }
  
  public void a(int paramInt1, int paramInt2, bkrp parambkrp)
  {
    this.jdField_c_of_type_Int = paramInt1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_a_of_type_Int = parambkrp.jdField_c_of_type_Int;
    this.jdField_b_of_type_Int = parambkrp.jdField_d_of_type_Int;
    ...
    this.jdField_e_of_type_Int = axhr.a().b();
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Blcp = new blcp();
        this.jdField_a_of_type_Blcp.a(false, false);
        b();
      }
      blcb.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (bkrp)paramMessage.obj);
      this.h = true;
      if (this.i)
      {
        a(a());
        bkpu.a("SETPREVIEW OffScreenGLSurface");
      }
    }
    do
    {
      do
      {
        ...
        bkpu.a("RANDER_DATA_INIT OffScreenGLSurface");
        return true;
        if (paramMessage.what != -16716522) {
          break;
        }
        d();
        this.jdField_a_of_type_Blcn.a();
        this.jdField_a_of_type_Blcn.a = null;
        this.jdField_a_of_type_Blco.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Blco.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Blco.jdField_a_of_type_Int = -1;
        f();
      } while (!QLog.isColorLevel());
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("CAMERA_OPENGL_RANDER_DATA");; localStringBuilder = null)
    {
      ...
      if (j != 0)
      {
        bksx.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
      }
      if (this.jdField_a_of_type_Blcp != null) {
        blcb.a(PtvFilterUtils.a() / 1000L);
      }
      Object localObject;
      ...
      for (;;)
      {
        ...
        blcb.d((PtvFilterUtils.a() - l) / 1000L);
        ...
        if (this.jdField_a_of_type_Blcp != null)
        {
          if (this.jdField_a_of_type_Blcn.a == null)
          {
            bksx.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
            return true;
            ...
            localObject = ((blbl)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
            continue;
          }
          l = PtvFilterUtils.a();
          blcv localblcv = a();
          if (localblcv != null)
          {
            this.jdField_a_of_type_Blcp.a(localblcv.jdField_a_of_type_Int);
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("bind t=").append(localblcv.jdField_a_of_type_Int).append("|");
            ...
            for (boolean bool1 = true;; bool1 = false)
            {
              ...
              localAVIOStruct = ((blbl)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
            ...
            {
              this.jdField_a_of_type_Blco.jdField_a_of_type_Boolean = true;
              localObject = localAVIOStruct;
            }
            label752:
            ...
            localblcv.a(j, localObject, bool1);
            localblcv.d();
            bool1 = this.jdField_a_of_type_Blcn.a.a();
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("write ns=").append(this.jdField_a_of_type_Blco.jdField_a_of_type_Boolean).append("|");
            ...
            if (!bool1)
            {
              if (this.jdField_a_of_type_Blco.jdField_a_of_type_Boolean) {
                a((AVIOStruct)localObject);
              }
              localblcv.a();
            }
            label905:
            blcb.c((PtvFilterUtils.a() - l) / 1000L);
          }
        }
        for (;;)
        {
          ...
          break label752;
          bksx.a("handleMessage:byteBufferProcessFrame: no texture");
          break label905;
          bksx.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
        }
        label1133:
        localObject = null;
      }
