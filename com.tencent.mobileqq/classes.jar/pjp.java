...
public abstract class pjp
{
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext()) {
      ((pjo)localIterator.next()).cancel(true);
    }
    this.b.clear();
  ...
  public void b(pjo parampjo)
  {
    if (parampjo == null) {
      return;
    }
    this.b.remove(parampjo);
  }
