...
public class ybh
  extends ntd
{
  public ybh(StoryMessageListActivity paramStoryMessageListActivity)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null)) {
      try
      {
        ...
        if ((localRspStoryMessageList.errinfo.error_code.has()) && (localRspStoryMessageList.errinfo.error_code.get() == 0))
        {
          ...
          {
            ybe localybe = new ybe((qqstory_710_message.StoryMessage)localIterator.next());
            if (localybe.d) {
              paramArrayOfByte.add(localybe);
            }
          }
        }
