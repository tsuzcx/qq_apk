...
public class uyk
{
  ...
  public static int a(View paramView)
  {
    ...
    do
    {
      ...
      j = vzl.d(paramView.getContext()) / 2;
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    ved.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, uxw paramuxw)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            uyj.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          ved.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramuxw == null) {
            break;
          }
          return paramuxw.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          ved.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = ajya.a(2131714461);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = ajya.a(2131714462);
      break;
      localObject1 = ajya.a(2131714460);
      break;
      localObject1 = ajya.a(2131714489);
      break;
      localObject1 = ajya.a(2131714453);
      break;
      localObject1 = ajya.a(2131714450);
      break;
      localObject1 = ajya.a(2131714486);
      break;
      localObject1 = ajya.a(2131714464);
      break;
      localObject1 = ajya.a(2131714454);
      break;
      localObject1 = ajya.a(2131714475);
      break;
      localObject1 = ajya.a(2131714476);
      break;
      localObject1 = ajya.a(2131714491);
      break;
      localObject1 = ajya.a(2131714471);
      break;
      localObject1 = ajya.a(2131714490);
      break;
      localObject1 = ajya.a(2131714484);
      break;
      localObject1 = ajya.a(2131714469);
      break;
      localObject1 = ajya.a(2131714468);
      break;
      localObject1 = ajya.a(2131714458);
      break;
      localObject1 = ajya.a(2131714485);
      break;
      localObject1 = ajya.a(2131714449);
      break;
      localObject1 = ajya.a(2131714455);
      break;
      localObject1 = ajya.a(2131714463);
      break;
      localObject1 = ajya.a(2131714472);
      break;
      localObject1 = ajya.a(2131714483);
      break;
      localObject1 = ajya.a(2131714467);
      break;
      localObject1 = ajya.a(2131714480);
      break;
      localObject1 = ajya.a(2131714451);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return ajya.a(2131714473) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((sst)paramQQAppInterface.getManager(181)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    ved.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    uyu localuyu = new uyu();
    localuyu.a = paramArrayList;
    stb.a().dispatch(localuyu);
  }
  ...
  public static int b(View paramView)
  {
    ...
    ved.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), ajya.a(2131714470), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), ajya.a(2131714459), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    do
    {
      ...
      paramView.getLocationOnScreen(arrayOfInt);
      i = paramView.getHeight();
      j = vzl.d(paramView.getContext());
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    ved.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
