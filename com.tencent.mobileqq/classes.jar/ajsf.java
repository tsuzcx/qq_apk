  ...
  implements InputFilter
{
  ...
  public ajsf(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    ajse localajse = ExtendEditText.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localajse == null)
    {
