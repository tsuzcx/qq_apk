...
public class ajsf
  extends anyu
{
  private ajsf(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, anzj.a(2131699145), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, anzj.a(2131699146), 0).a();
          return;
        }
      }
