...
public class afqo
  ...
  implements aels
{
  public afqo(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  public View a(ChatMessage paramChatMessage, aelt paramaelt, View paramView, BaseChatItemLayout paramBaseChatItemLayout, aeov paramaeov)
  {
    ...
    if ((localMessageForLongTextMsg.getExtInfoFromExtStr("long_text_recv_state").equals("0")) || (localMessageForLongTextMsg.getExtInfoFromExtStr("long_text_recv_state").equals("1")))
    {
      if ((paramView != null) && ((paramView instanceof TextView))) {
        return super.a(paramChatMessage, paramaelt, paramView, paramBaseChatItemLayout, paramaeov);
      }
      return super.a(paramChatMessage, paramaelt, null, paramBaseChatItemLayout, paramaeov);
    }
    ...
    else
    {
      ...
      paramaelt.setPadding(paramView.getDimensionPixelSize(2131296294), paramView.getDimensionPixelSize(2131296296), paramView.getDimensionPixelSize(2131296293), paramView.getDimensionPixelSize(2131296295));
      ...
      i = aekt.a(6.0F, ((Context)localObject1).getResources());
      int j = aekt.a(7.0F, ((Context)localObject1).getResources());
      int k = aekt.a(13.0F, ((Context)localObject1).getResources());
      int m = aekt.a(15.0F, ((Context)localObject1).getResources());
      ...
      paramView.setId(2131364172);
      paramView.setOrientation(1);
      paramView.setBackgroundResource(2130849781);
      ...
      ((ETTextView)localObject2).setId(2131364174);
      ...
      ((View)localObject2).setBackgroundColor(((Context)localObject1).getResources().getColor(2131166273));
      ...
      ((ETTextView)localObject1).setId(2131364173);
    ...
    paramView = (TextView)paramaelt.findViewById(2131364174);
    Object localObject2 = paramaelt.findViewById(2131364172);
    localObject1 = (TextView)paramaelt.findViewById(2131364173);
    ...
    if (!TextUtils.isEmpty(localMessageForLongTextMsg.sb)) {
      if (!TextUtils.isEmpty(localMessageForLongTextMsg.sb2))
      {
        ...
        ((View)localObject2).setOnTouchListener(paramaeov);
        ...
        ((TextView)localObject1).setText(alpo.a(2131706763));
        ((View)localObject2).setTag(null);
        paramaelt.setClickable(false);
    ...
    for (;;)
    {
      ...
      {
        ((TextView)localObject1).setText(alpo.a(2131706764));
