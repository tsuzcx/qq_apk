...
{
  private FilenameFilter jdField_a_of_type_JavaIoFilenameFilter = new bgsw(this);
  ...
  {
    boolean bool2 = false;
    File localFile1 = new File(ajsf.aV, "/Tencent/ReaderZone/");
  ...
  {
    String[] arrayOfString = new File(ajsf.aV, "/Tencent/ReaderZone/").list(this.jdField_a_of_type_JavaIoFilenameFilter);
  ...
  {
    return new File(new File(ajsf.aV, "/Tencent/ReaderZone/"), paramString);
  }
  ...
  public String[] reportHistoryFileInfo()
  {
    ...
    File localFile = new File(ajsf.aV, "/Tencent/ReaderZone/");
