  ...
  extends acme
{
  ...
  public acmh(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    super(paramQQAppInterface, paramMessageHandler);
    this.jdField_a_of_type_JavaUtilComparator = new acmj(this);
  }
  
  private byte a(msg_comm.MsgHead paramMsgHead, long paramLong, bffl parambffl, byte paramByte, MessageRecord paramMessageRecord)
  {
    byte b = paramByte;
    if (paramMsgHead.msg_flag.has())
    {
      ...
      if ((paramMsgHead.msg_flag.get() & 1L) == 1L)
      {
        ...
        {
          paramByte = 1;
          parambffl.jdField_a_of_type_Bffm.a(17, paramLong, paramMessageRecord.uniseq);
          b = paramByte;
  ...
  private acmk a(ArrayList<MessageRecord> paramArrayList, bcsd parambcsd, boolean paramBoolean, bffl parambffl1, msg_comm.MsgHead paramMsgHead, long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, String paramString1, int paramInt1, int paramInt2, int paramInt3, List<MessageRecord> paramList, List<im_msg_body.Elem> paramList1, bffl parambffl2, byte paramByte, String paramString2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      paramString2.istroop = parambcsd.jdField_e_of_type_Int;
      paramString2.senderuin = String.valueOf(paramLong1);
      paramString2.frienduin = String.valueOf(parambcsd.jdField_e_of_type_Long);
      ...
      b(paramString2);
      paramByte = a(paramMsgHead, paramLong2, parambffl2, paramByte, paramString2);
      b(paramLong2, parambffl2, paramString2);
      a(paramLong2, parambffl2, paramString2);
      c(paramLong2, parambffl2, paramString2);
      h(paramLong2, parambffl2, paramString2);
      g(paramLong2, parambffl2, paramString2);
      a(parambcsd, paramLong2, paramList1, parambffl2, paramString2);
      n(paramLong2, parambffl2, paramString2);
      f(paramLong2, parambffl2, paramString2);
      c(paramString2);
      if ((paramString2.msgtype == -2058) && (parambffl1.jdField_a_of_type_Bffm.a == -1L) && (parambffl1.jdField_a_of_type_Bffm.b == -1L)) {}
      m(paramLong2, parambffl2, paramString2);
      l(paramLong2, parambffl2, paramString2);
      k(paramLong2, parambffl2, paramString2);
      j(paramLong2, parambffl2, paramString2);
      e(paramLong2, parambffl2, paramString2);
      d(paramLong2, parambffl2, paramString2);
      i(paramLong2, parambffl2, paramString2);
      d(paramString2);
      a(parambcsd, parambffl1, paramLong2, parambffl2, paramString2);
      a(paramArrayList, parambcsd, paramList1, paramString2);
      paramList = a(parambcsd, paramList1, paramList, paramString2);
      paramArrayList.add(paramString2);
    }
    return new acmk(this, paramArrayList, parambcsd, paramBoolean, paramMsgHead, paramLong1, paramLong2, paramLong3, paramLong5, paramList1, paramByte, paramList).a();
  }
  
  private TroopMemberInfo a(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList, int paramInt, acmk paramacmk)
  {
    int i = paramacmk.a();
    int j = paramacmk.b();
    int k = paramacmk.c();
    ...
    int n = paramacmk.e();
    int i1 = paramacmk.f();
    paramacmk = paramacmk.a();
    int i2 = bcrx.a(paramMsg);
    int i3 = bcrx.e(paramMsg);
    int i4 = bcrx.c(paramMsg);
    int i5 = bcrx.b(paramMsg);
    int i6 = bcrx.d(paramMsg);
    ...
    while (paramMsg.hasNext())
    {
      ...
      paramArrayList.vipBubbleID = aocy.a(paramInt, i2);
  ...
  private String a(bcsd parambcsd, List<im_msg_body.Elem> paramList, String paramString, MessageRecord paramMessageRecord)
  {
    Iterator localIterator;
    if (parambcsd.jdField_e_of_type_Int != 1)
    {
      localObject = paramString;
      if (parambcsd.jdField_e_of_type_Int != 1026) {}
    }
    else
    {
      localObject = paramString;
    ...
    do
    {
      ...
      if (((im_msg_body.Elem)localObject).extra_info.has()) {
        paramList = a(parambcsd, (im_msg_body.Elem)localObject);
      }
      paramString = paramList;
    } while (!((im_msg_body.Elem)localObject).group_business_msg.has());
    Object localObject = bgja.a(((im_msg_body.Elem)localObject).group_business_msg);
    bgiz.a(paramMessageRecord, (bgja)localObject);
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramMessageRecord.frienduin == null) {}
    for (paramString = "";; paramString = paramMessageRecord.frienduin)
    {
      bdla.b(localQQAppInterface, "P_CliOper", "Grp_AIO", "", "five_m", "revice_msg", 0, 0, paramString, paramMessageRecord.msgtype + "", ((bgja)localObject).c, "");
      paramString = paramList;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  @NotNull
  private String a(bcsd parambcsd, im_msg_body.Elem paramElem)
  {
    ...
    {
      parambcsd = parambcsd.jdField_e_of_type_Long + "";
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getTroopMask(parambcsd) != paramElem.uint32_new_group_flag.get()) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.setTroopMsgFilterToServer(parambcsd, Integer.valueOf(paramElem.uint32_new_group_flag.get()));
      }
    }
    return str;
  }
  ...
  private void a(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (((paramMessageRecord instanceof MessageForTroopConfess)) && (((MessageForTroopConfess)paramMessageRecord).isToSelf)) {
      parambffl.jdField_a_of_type_Bffm.a(10, paramLong, paramMessageRecord.uniseq);
    }
  }
  
  private void a(long paramLong, bffl parambffl, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    Object localObject2 = new acmb(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    Object localObject1 = ((acmb)localObject2).jdField_a_of_type_Aoxz;
    localObject2 = ((acmb)localObject2).jdField_a_of_type_JavaUtilMap;
    localObject1 = (RecentUser)((aoxz)localObject1).findRecentUserByUin(paramStructMsgForGeneralShare, 1);
    TroopManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord.frienduin, StructMsgForGeneralShare.eventId, paramMessageRecord.shmsgseq, new acmi(this, false, parambffl, paramLong, l, (RecentUser)localObject1, paramStructMsgForGeneralShare, paramMessageRecord, (Map)localObject2));
  }
  
  private void a(bcsd parambcsd, long paramLong, List<im_msg_body.Elem> paramList, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (((parambcsd.jdField_e_of_type_Int == 1) || (parambcsd.jdField_e_of_type_Int == 1026)) && (paramList != null))
    {
      parambcsd = paramList.iterator();
      while (parambcsd.hasNext())
      {
        paramList = (im_msg_body.Elem)parambcsd.next();
        if ((paramList.general_flags.has()) && (paramList.general_flags.bytes_pb_reserve.has()))
        {
          ...
          {
            parambffl.jdField_a_of_type_Bffm.a(23, paramLong, paramMessageRecord.uniseq);
            if (QLog.isColorLevel()) {
  ...
  private void a(bcsd parambcsd, bffl parambffl1, long paramLong, bffl parambffl2, MessageRecord paramMessageRecord)
  {
    if (parambffl1 != null)
    {
      parambffl2.jdField_a_of_type_Bffm.a(13, paramMessageRecord.uniseq);
      parambffl2.jdField_a_of_type_Bffm.a(24, paramMessageRecord.uniseq);
      if ((paramLong > this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().a(String.valueOf(parambcsd.jdField_e_of_type_Long), parambcsd.jdField_e_of_type_Int)) && (parambffl2.a()))
      {
        parambffl1.a(parambffl2);
        paramMessageRecord.mMessageInfo = parambffl2;
      }
    }
  }
  
  private void a(MessageRecord paramMessageRecord, MessageForApollo paramMessageForApollo, ArrayList<ApolloBaseInfo> paramArrayList, amme paramamme, StringBuilder paramStringBuilder)
  {
    ...
    {
      paramamme = paramamme.b(paramMessageForApollo.mApolloMessage.peer_uin + "");
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("\n peer: ").append(paramamme.uin).append(", update time: ").append(paramamme.apolloUpdateTime);
      }
      if ((paramMessageRecord.time > paramamme.apolloUpdateTime) && ((paramamme.apolloServerTS < paramMessageForApollo.mApolloMessage.peer_ts) || (paramamme.apolloStatus != paramMessageForApollo.mApolloMessage.peer_status) || (paramamme.superYellowDiamondFlag != (paramMessageForApollo.mApolloMessage.flag >> 31 & 0x1)) || ((paramMessageForApollo.is3dAction()) && (paramMessageForApollo.mApollo3DMessage != null) && (paramamme.cmshow3dFlag != paramMessageForApollo.mApollo3DMessage.peerStatus_3D))))
      {
        paramamme.apolloStatus = paramMessageForApollo.mApolloMessage.peer_status;
        paramamme.apolloServerTS = paramMessageForApollo.mApolloMessage.peer_ts;
        paramamme.superYellowDiamondFlag = (paramMessageForApollo.mApolloMessage.flag >> 31 & 0x1);
        if ((paramMessageForApollo.is3dAction()) && (paramMessageForApollo.mApollo3DMessage != null)) {
          paramamme.cmshow3dFlag = paramMessageForApollo.mApollo3DMessage.peerStatus_3D;
        }
        paramamme.apolloUpdateTime = paramMessageRecord.time;
        paramArrayList.add(paramamme);
        if (QLog.isColorLevel()) {
          paramStringBuilder.append("\n save apollo info ").append(paramamme.apolloVipFlag).append("|").append(paramamme.apolloStatus).append("|").append(paramamme.apolloLocalTS).append("|").append(paramamme.apolloServerTS).append("|").append(paramamme.cmshow3dFlag).append("|").append(paramamme.apolloUpdateTime);
        }
      }
    }
  }
  ...
  private void a(MessageRecord paramMessageRecord, im_msg_body.Elem paramElem)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = "";
        paramMessageRecord.saveExtInfoToExtStr("anonymous", nty.a(i, paramElem, (String)localObject1, j, k, (String)localObject2));
  ...
  private void a(ArrayList<MessageRecord> paramArrayList, bcsd parambcsd, List<im_msg_body.Elem> paramList, MessageRecord paramMessageRecord)
  {
    boolean bool;
    if (((parambcsd.jdField_e_of_type_Int == 1) || (parambcsd.jdField_e_of_type_Int == 1026) || (parambcsd.jdField_e_of_type_Int == 3000)) && (paramList != null) && (!TextUtils.equals(paramMessageRecord.selfuin, paramMessageRecord.senderuin)))
    {
      parambcsd = paramList.iterator();
      bool = false;
      if (parambcsd.hasNext())
      {
        if (!((im_msg_body.Elem)parambcsd.next()).anon_group_msg.has()) {
          break label102;
        }
        bool = true;
      }
  ...
  private void b(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if ((paramMessageRecord.istroop == 1) && (bhsv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramMessageRecord.msg, paramMessageRecord.frienduin))) {
      parambffl.jdField_a_of_type_Bffm.a(16, paramLong, paramMessageRecord.uniseq);
    }
  }
  ...
  private void b(MessageRecord paramMessageRecord, MessageForApollo paramMessageForApollo, ArrayList<ApolloBaseInfo> paramArrayList, amme paramamme, StringBuilder paramStringBuilder)
  {
    if (!paramMessageRecord.isSend())
    {
      paramamme = paramamme.b(paramMessageForApollo.senderuin);
      if (QLog.isColorLevel()) {
        paramStringBuilder.append(", update time: ").append(paramamme.apolloUpdateTime);
      }
      if ((paramMessageRecord.time > paramamme.apolloUpdateTime) && ((paramamme.apolloServerTS < paramMessageForApollo.mApolloMessage.sender_ts) || (paramamme.apolloStatus != paramMessageForApollo.mApolloMessage.sender_status) || (paramamme.superYellowDiamondFlag != (paramMessageForApollo.mApolloMessage.flag >> 30 & 0x1)) || ((paramMessageForApollo.is3dAction()) && (paramMessageForApollo.mApollo3DMessage != null) && (paramamme.cmshow3dFlag != paramMessageForApollo.mApollo3DMessage.senderStatus_3D))))
      {
        paramamme.apolloStatus = paramMessageForApollo.mApolloMessage.sender_status;
        paramamme.apolloServerTS = paramMessageForApollo.mApolloMessage.sender_ts;
        paramamme.superYellowDiamondFlag = (paramMessageForApollo.mApolloMessage.flag >> 30 & 0x1);
        if ((paramMessageForApollo.is3dAction()) && (paramMessageForApollo.mApollo3DMessage != null)) {
          paramamme.cmshow3dFlag = paramMessageForApollo.mApollo3DMessage.senderStatus_3D;
        }
        paramamme.apolloUpdateTime = paramMessageRecord.time;
        paramArrayList.add(paramamme);
        if (QLog.isColorLevel()) {
  ...
  private void c(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (a(paramMessageRecord)) {
      parambffl.jdField_a_of_type_Bffm.a(5, paramLong, paramMessageRecord.uniseq);
    }
  }
  ...
  private boolean c(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      {
        bool1 = bool2;
        if (apwl.a(paramMessageRecord.ark_app_message.appName)) {
          bool1 = true;
        }
      }
    }
  ...
  private void d(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (bgiy.a(paramMessageRecord)) {
      parambffl.jdField_a_of_type_Bffm.a(8, paramLong, paramMessageRecord.uniseq);
    }
  }
  ...
  private void d(MessageRecord paramMessageRecord)
  {
    if (paramMessageRecord.msgtype == -2039)
    {
      ...
      b(paramMessageRecord, localMessageForApollo, localArrayList, localamme, localStringBuilder);
      a(paramMessageRecord, localMessageForApollo, localArrayList, localamme, localStringBuilder);
      ...
      anjt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, localMessageForApollo, localamme);
    }
  }
  
  private void e(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if ((paramMessageRecord instanceof MessageForTroopFile)) {
      parambffl.jdField_a_of_type_Bffm.a(3, paramLong, paramMessageRecord.uniseq);
    }
  }
  
  private void f(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (paramMessageRecord.msgtype == -5015) {
      parambffl.jdField_a_of_type_Bffm.a(6, paramLong, paramMessageRecord.uniseq);
    }
  }
  
  private void g(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (c(paramMessageRecord)) {
      parambffl.jdField_a_of_type_Bffm.a(20, paramLong, paramMessageRecord.uniseq);
    }
  }
  
  private void h(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if (b(paramMessageRecord)) {
      parambffl.jdField_a_of_type_Bffm.a(19, paramLong, paramMessageRecord.uniseq);
    }
  }
  
  private void i(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    if ((paramMessageRecord.msgtype == -5008) && ((paramMessageRecord instanceof MessageForArkApp)))
    {
      ...
      if ((localMessageForArkApp.ark_app_message != null) && (localMessageForArkApp.ark_app_message.appName.equals("com.tencent.mannounce"))) {
        parambffl.jdField_a_of_type_Bffm.a(11, paramLong, paramMessageRecord.uniseq);
      }
    }
  }
  
  private void j(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    Object localObject;
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      localObject = bdof.a(paramMessageRecord.msgData);
      if ((localObject instanceof StructMsgForGeneralShare))
      {
        ...
        a(paramLong, parambffl, paramMessageRecord, (StructMsgForGeneralShare)localObject);
      }
    }
    label59:
    do
    {
      ...
      {
        return;
        if ((localObject != null) && (((StructMsgForGeneralShare)localObject).mMsgServiceID == 19) && (!((StructMsgForGeneralShare)localObject).mMsgBrief.startsWith(anvx.a(2131700523))) && (!((StructMsgForGeneralShare)localObject).mMsgBrief.equals(anvx.a(2131700517))))
        {
          parambffl.jdField_a_of_type_Bffm.a(2, paramLong, paramMessageRecord.uniseq);
          return;
        }
      ...
      parambffl.jdField_a_of_type_Bffm.a(24, paramLong, paramMessageRecord.uniseq);
      return;
    } while ((localObject == null) || (((StructMsgForGeneralShare)localObject).mMsgServiceID != 107));
    parambffl.jdField_a_of_type_Bffm.a(12, paramLong, paramMessageRecord.uniseq);
  }
  
  private void k(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    boolean bool = true;
    Object localObject;
    if (axoi.a(paramMessageRecord))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() != null)
      {
        ...
        parambffl = parambffl.jdField_a_of_type_Bffm;
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (paramMessageRecord.istroop != 1) {
          break label98;
        }
        parambffl.a((QQAppInterface)localObject, bool, paramMessageRecord.frienduin, paramLong, paramMessageRecord.uniseq);
      }
    }
    label98:
    label104:
    ...
    parambffl.jdField_a_of_type_Bffm.a(7, paramLong, paramMessageRecord.uniseq);
  }
  
  private void l(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      parambffl = (bggl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.AIO_ANIMATION_MANAGER);
      if (parambffl != null) {
        parambffl.b(localMessageForDeliverGiftTips);
      }
      return;
      label202:
      bool = false;
  ...
  private void m(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
    Object localObject;
    int i;
    if (paramMessageRecord.msgtype == -1035)
    ...
    for (;;)
    {
      if (i < ((MessageForMixedMsg)localObject).msgElemList.size())
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(((MessageForReplyText)localObject).mSourceMsgInfo.mSourceMsgSenderUin + ""))) {
          parambffl.jdField_a_of_type_Bffm.a(22, paramLong, paramMessageRecord.uniseq);
        }
      }
      return;
      label135:
  ...
  private void n(long paramLong, bffl parambffl, MessageRecord paramMessageRecord)
  {
  ...
  protected TroopMemberInfo a(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList, bcsd parambcsd, boolean paramBoolean, bffl parambffl)
  {
    for (;;)
    {
      long l1;
      ...
      try
      {
        ...
        if ((parambcsd == null) || (paramMsg == null) || (paramArrayList == null)) {
          break;
        }
        ...
        if (parambcsd.jdField_e_of_type_Int == 1026)
        {
          l3 = bhbx.a(localMsgHead.msg_seq.get());
          l2 = bhbx.a(localMsgHead.msg_time.get());
        }
        int i = 0;
        int j = 0;
        int k = 0;
        ...
        long l8 = bcrx.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, String.valueOf(l6), String.valueOf(l6));
        localArrayList = new ArrayList();
        localRichText = null;
        localbffl = new bffl();
        if (paramMsg.appshare_info.has())
        {
          bcsg.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, localArrayList, paramMsg, parambcsd.jdField_e_of_type_Long, l2, false);
          localObject = localRichText;
          l4 = l1;
          a(j, localArrayList);
          parambcsd = a(paramArrayList, parambcsd, paramBoolean, parambffl, localMsgHead, l6, l3, l2, l4, l7, str, i, j, k, localArrayList, (List)localObject, localbffl, (byte)0, null);
          paramMsg = a(paramMsg, paramArrayList, (int)l8, parambcsd);
      ...
      if (paramMsg.msg_body.has())
      {
        ...
        if (localMsgBody.rich_text.has())
        {
          ...
          if (localRichText.attr.has()) {
            l1 = bcsc.a(((im_msg_body.Attr)localRichText.attr.get()).random.get());
          }
          localObject = localRichText.elems.get();
          if (localRichText.ptt.has())
          {
            new bcsm().a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localArrayList, null);
            l4 = l1;
          }
          else
          {
            localbffl.jdField_a_of_type_JavaLangString = String.valueOf(parambcsd.jdField_e_of_type_Long);
            localbffl.jdField_a_of_type_Int = parambcsd.jdField_e_of_type_Int;
            bcrx.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, localArrayList, paramMsg, false, false, localbffl);
            l4 = l1;
          }
        }
      }
  ...
  protected void a(MessageRecord paramMessageRecord)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(paramMessageRecord))
    {
      ...
      if (acnh.q(paramMessageRecord.msgtype))
      {
        ...
        localanza.b = 1000;
        localanza.c = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgHandler().notifyUI(5006, true, new Object[] { Long.valueOf(paramMessageRecord.uniseq), localanza });
      }
    }
  }
}
