  ...
  extends RelativeLayout
{
  ...
  public ajbe(ApolloGameInfoFragment paramApolloGameInfoFragment, Context paramContext, String paramString)
  {
    super(paramContext);
    a(paramString);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    setOnClickListener(new ajbh(this, paramString, paramInt));
  }
  ...
  public void a(Bitmap paramBitmap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      setOnClickListener(new ajbg(this));
      return;
  ...
  public void a(String paramString)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject).setMargins(aciy.a(12.0F, getResources()), aciy.a(17.0F, getResources()), 100, aciy.a(20.0F, getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848311);
    paramString = new RelativeLayout.LayoutParams(aciy.a(9.0F, getResources()), aciy.a(18.0F, getResources()));
    paramString.addRule(11);
    paramString.addRule(15);
    paramString.rightMargin = aciy.a(27.0F, getResources());
    ...
    paramString.rightMargin = aciy.a(11.0F, getResources());
    paramString.addRule(11);
    paramString.rightMargin = aciy.a(27.0F, getResources());
    paramString.addRule(15);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(4);
    paramString = new RelativeLayout.LayoutParams(aciy.a(25.0F, getResources()), aciy.a(25.0F, getResources()));
    paramString.rightMargin = aciy.a(11.0F, getResources());
    paramString.addRule(0, this.c);
    paramString.addRule(15);
    setBackgroundResource(2130839069);
    addView(this.jdField_a_of_type_ComTencentImageURLImageView, paramString);
    setOnClickListener(new ajbf(this));
  }
