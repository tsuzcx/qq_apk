...
{
  bebn(bebl parambebl, TicketManager paramTicketManager, ReSendCmd paramReSendCmd) {}
  ...
  public void Done(Ticket paramTicket)
  {
    ...
    for (;;)
    {
      ...
      paramTicket = this.jdField_a_of_type_MqqManagerTicketManager.getSkey(this.jdField_a_of_type_Bebl.mApp.getCurrentAccountUin());
      if ((!TextUtils.isEmpty(paramTicket)) && (paramTicket.length() > 0))
      {
        bebl.b(this.jdField_a_of_type_Bebl, 0);
        QLog.i("TeamWorkHandler", 1, "getSkeyFromServerAndRetry get skey from server success!");
      }
      bebl.a(this.jdField_a_of_type_Bebl, this.jdField_a_of_type_ComTencentMobileqqTeamworkReSendCmd);
      return;
