...
public class azww
  extends anud
{
  public azww(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(Activity paramActivity, String paramString, QQAppInterface paramQQAppInterface, PersonalityLabel paramPersonalityLabel, azxr paramazxr)
  {
    byte[] arrayOfByte = PersonalityLabel.convertToBytes(paramPersonalityLabel);
    paramActivity.runOnUiThread(new PersonalityLabelHandler.1(paramString, paramQQAppInterface, paramazxr, arrayOfByte));
    paramActivity = (anyw)paramQQAppInterface.getManager(51);
  ...
  {
    aggr localaggr = (aggr)this.mApp.getManager(282);
    Object localObject = localaggr.a(paramString2, 0, 3);
    if (localObject != null) {
    ...
    for (int i = 0;; i = 1) {
      for (;;)
      {
        ...
        try
        {
          ...
          localaggr.a((BeancurdMsg)localObject);
          return;
        ...
        do
        {
          for (;;)
          {
            ...
            else
            {
              ...
              paramFromServiceMsg = localanyw.a(paramObject);
            ...
            try
            {
              ...
              for (paramToServiceMsg = ((PersonalityLabelPhoto)paramToServiceMsg.personalityLabelPhotos.get(0)).get128SizeUrl() + azvv.d;; paramToServiceMsg = "")
              {
