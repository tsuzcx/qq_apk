...
public class bhct
{
  ...
  public final Queue<bhcy> a;
  
  public bhct(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", nmp.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bhjx.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public bhcz a(Context paramContext)
  {
    bhcz localbhcz = new bhcz(this);
    localbhcz.jdField_a_of_type_JavaLangString = (bhlo.h() + " " + bhlo.d());
    localbhcz.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbhcz.c = "8.4.5.4745";
    bhlp localbhlp = bhlo.a(paramContext);
    localbhcz.d = localbhlp.jdField_a_of_type_JavaLangString;
    localbhcz.e = localbhlp.c;
    localbhcz.jdField_a_of_type_Int = bhlo.b();
    localbhcz.jdField_a_of_type_Long = bhlo.a();
    localbhcz.jdField_b_of_type_Long = bhlo.d();
    localbhcz.f = bhlo.g();
    localbhcz.jdField_a_of_type_Boolean = a(paramContext);
    localbhcz.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbhcz.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbhcz.jdField_b_of_type_Boolean = bool;
      return localbhcz;
    }
  }
  ...
  public String a()
  {
    bhcs localbhcs = bhcr.a("getprop net.dns1");
    if (localbhcs.jdField_a_of_type_Boolean)
    {
      if (!localbhcs.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbhcs.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbhcs.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 524	bhdd:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bhcw(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bhdd.a(localArrayList, paramContext);
            bhdd.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new bhcu(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 702
    //   14: ldc_w 383
    //   17: invokestatic 705	birz:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   79: invokestatic 729	noe:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 733	noe:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 524	bhdd:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bhdd.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new bhcy(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bhcv(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bhde(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      bhcy localbhcy = (bhcy)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbhcy != null) && (localbhcy.jdField_b_of_type_Long == paramLong))
      {
        localbhcy = (bhcy)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbhcy != null)
        {
          b(paramContext, localbhcy.jdField_a_of_type_JavaLangString, localbhcy.jdField_a_of_type_Int, localbhcy.jdField_a_of_type_Long, localbhcy.jdField_b_of_type_Long, localbhcy.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbhcy.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bhdd.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bhcx(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
