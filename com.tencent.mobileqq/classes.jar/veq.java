...
public class veq
{
  ...
  public static final String a(String paramString)
  {
    ...
    File localFile = new File(sfm.f);
    if ((!localFile.exists()) || (!localFile.isDirectory())) {
      localFile.mkdirs();
    }
    paramString = sfm.f + becz.a(paramString) + "." + vlm.c(paramString);
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt)
  {
    ...
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { babp.a(), "", Integer.valueOf(paramInt) }));
