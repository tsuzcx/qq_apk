...
public class avde
{
  ...
  private void a(long paramLong1, long paramLong2, submsgtype0x122.MsgBody paramMsgBody)
  {
    ...
    try
    {
      paramMsgBody = aqva.a(new String(paramMsgBody, "utf-8"));
      if (paramMsgBody != null)
      {
        localObject7 = paramMsgBody.a();
        if (((aqus)localObject7).a() != 6) {
          QLog.e("PushDialogHandler", 1, new Object[] { "error note type:", Integer.valueOf(((aqus)localObject7).a()) });
        }
      }
      else
      {
    ...
    catch (UnsupportedEncodingException paramMsgBody)
    {
      do
      {
        ...
        localObject2 = "";
        localObject4 = "";
        localObject7 = ((aqus)localObject7).a();
    ...
    for (;;)
    {
      ...
      {
        localObject8 = (aqus)localIterator1.next();
        localObject9 = ((aqus)localObject8).a();
        localObject7 = ((aqus)localObject8).a();
        if (((aqus)localObject8).a() == 7)
        {
        ...
        else if (((aqus)localObject8).a() == 8)
        {
          ...
          {
            localObject7 = (aqus)((Iterator)localObject9).next();
            localObject10 = ((aqus)localObject7).a();
            if ((((aqus)localObject7).a() == 2) && (localObject10 != null))
            {
    ...
    for (;;)
    {
      ...
      break;
      if ((((aqus)localObject8).a() == 9) && (localObject7 != null))
      {
        ...
        {
          localObject7 = (aqus)localIterator2.next();
          String str2;
          Object localObject11;
          if (((aqus)localObject7).a() == 10)
          {
            localObject7 = ((aqus)localObject7).a();
          ...
          for (;;)
          {
            ...
            abtu.a((Intent)localObject7, PublicTransFragmentActivity.class, RiskHintDlgFragment.class);
            return;
          }
        }
        localObject7 = localObject2;
  ...
  public void a(submsgtype0x122.MsgBody paramMsgBody, MsgInfo paramMsgInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    avdc.a().b(this.jdField_a_of_type_Aukn, paramMsgBody);
  }
