...
public class avde
{
  ...
  public avde(String paramString, double paramDouble)
  {
    this(paramString, paramDouble, 0.0D, -1, 0);
  }
  
  public avde(String paramString, double paramDouble1, double paramDouble2, int paramInt1, int paramInt2)
  {
  ...
  public avde(String paramString1, double paramDouble1, double paramDouble2, String paramString2, String paramString3)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = 0;
