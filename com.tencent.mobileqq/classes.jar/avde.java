  ...
  extends avdf
{
  ...
  public avde(QQAppInterface paramQQAppInterface, avcw paramavcw)
  {
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    localObject2 = new avcq(i, (String)localObject3);
    localObject3 = this.jdField_a_of_type_Avcw.a((avcq)localObject2);
    ...
    if (localIterator.hasNext())
    {
      ...
      avco localavco1 = new avco(str, new LatLng(localUserData.lat.get(), localUserData.lon.get()), localUserData.direction.get());
      if ((localavco1.a().latitude == 0.0D) && (localavco1.a().longitude == 0.0D))
      {
        avco localavco2 = ((LocationRoom)localObject3).a(str);
        if (localavco2 != null)
        {
          localObject1 = "[filter]";
          localavco1.a(localavco2.a(), Double.valueOf(localavco2.a()));
          ((List)localObject4).add(localavco1);
          label590:
          if (!QLog.isColorLevel()) {
            break label794;
          }
    ...
    this.jdField_a_of_type_Avcw.a((avcq)localObject2, paramObject, (List)localObject4);
  }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Avcw.a(new avcq(localInteger.intValue(), str), (LocationRoom.Venue)localObject, paramObject.intValue(), paramBoolean, i);
      if (paramBoolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("LocationObserver", 2, new Object[] { "[venue] onVenueOpt: invoked. success ", " uin: ", str, " uinType: ", localInteger, " optType: ", paramObject });
        }
        this.jdField_a_of_type_Avcw.a.a(localInteger.intValue(), str);
        return;
      }
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new avcq(paramObject.intValue(), str);
    this.jdField_a_of_type_Avcw.a(paramObject, ((Integer)localObject).intValue());
  }
  ...
  protected void d(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new avcq(paramObject.intValue(), (String)localObject);
    this.jdField_a_of_type_Avcw.b(paramObject, -1);
  }
  ...
  protected void e(boolean paramBoolean, Object paramObject)
  {
    ...
    case 2: 
    case 3: 
      avct.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
      return;
    }
    avct.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
  }
  ...
  protected void f(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      avdk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
    }
    label80:
    do
    {
      ...
      if (i == 101)
      {
        avdk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
        return;
      }
      if (i == 102)
      {
  ...
  protected void g(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Avcw.a.a(localInteger.intValue(), (String)localObject);
      this.jdField_a_of_type_Avcw.a.b(localInteger.intValue(), (String)localObject);
      if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Avcw.b(localInteger.intValue(), (String)localObject);
        bcef.b(null, "CliOper", "", "", "0X800A764", "0X800A764", 0, 0, "", "0", "0", "");
      }
      for (;;)
      {
        this.jdField_a_of_type_Avcw.a(false);
        return;
        if (paramObject.intValue() == 2)
        {
          this.jdField_a_of_type_Avcw.b(localInteger.intValue(), (String)localObject);
          if (this.jdField_a_of_type_Avcw.a()) {
            bcef.b(null, "CliOper", "", "", "0X800A76B", "0X800A76B", avcw.a(this.jdField_a_of_type_Avcw.a()), 0, "", "0", "0", "");
          }
        }
      }
    }
    ...
    avcq localavcq = new avcq(localInteger.intValue(), (String)localObject);
    this.jdField_a_of_type_Avcw.a(localavcq, true);
    this.jdField_a_of_type_Avcw.a(localavcq, j, paramObject.intValue());
    int i = 0;
    if (j == 10101) {}
    for (i = 3;; i = 2) {
      do
      {
        this.jdField_a_of_type_Avcw.a(localInteger.intValue(), (String)localObject, this.jdField_a_of_type_Avcw.a(), i);
        return;
