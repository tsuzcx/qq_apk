  ...
  extends arzt
{
  ...
  public arzx(Intent paramIntent)
  {
    super(paramIntent);
  ...
  private void G()
  {
    ...
    for (;;)
    {
      ...
      if ((m == 10000) || (m == 10001) || (m == 10002) || (m == 10004) || (m == 10003))
      {
        ...
        if (localObject1 != null) {
          arqo.a((FileManagerEntity)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, m, 12);
        }
      }
      else if (m == 10006)
      {
        ...
        {
          localObject2 = bcnt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject2);
          ...
          arsx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, null, null, l1, (bbtn)localObject2, (String)localObject1, l2, -1, 12, null, false, false);
          return;
          if (bdhb.b(this.jdField_i_of_type_JavaLangString)) {
            try
            {
              localObject1 = arrr.a(new FileInfo(this.jdField_i_of_type_JavaLangString));
              if (localObject1 != null)
              {
                arqo.a((FileManagerEntity)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, 12);
                return;
              }
            }
  ...
  public static int a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    case 7: 
      ...
      {
        return 10000;
      } while (arso.b(paramFileManagerEntity.getFilePath()));
      return 10009;
    case 1: 
      return 10002;
    case 2: 
  ...
  private Drawable a()
  {
    ...
    if (bdhb.b(str))
    {
      ...
      localURLDrawableOptions.mLoadingDrawable = bayu.b();
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      bdhj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), paramString, str, 600, 800);
      return str;
    }
  ...
  protected View a()
  {
    ...
    int m = aepi.a(8.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int n = aepi.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i1 = aepi.a(15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i2 = aepi.a(16.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i3 = aepi.a(20.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i4 = aepi.a(32.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i5 = aepi.a(40.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidAppActivity);
    Object localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    localRelativeLayout.setOnClickListener(new arzz(this));
    localRelativeLayout.setOnTouchListener(new asaa(this));
    ...
    if (i6 == 2)
    {
      ...
      ((URLImageView)localObject1).setId(2131366770);
      ((URLImageView)localObject1).setAdjustViewBounds(true);
      ((URLImageView)localObject1).setMaxHeight(bdoo.a(140.0F));
      ...
      ((View)localObject2).setId(2131366765);
      ((View)localObject2).setBackgroundColor(Color.argb(0, 0, 0, 0));
      localObject3 = new RelativeLayout.LayoutParams(-1, -1);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131366770);
      ((RelativeLayout.LayoutParams)localObject3).addRule(8, 2131366770);
      ((RelativeLayout.LayoutParams)localObject3).addRule(5, 2131366770);
      ((RelativeLayout.LayoutParams)localObject3).addRule(7, 2131366770);
    ...
    if (i6 == 3)
    {
      ...
      ((ImageView)localObject2).setId(2131366771);
      ...
      ((ImageView)localObject2).setImageResource(2130839711);
      return localRelativeLayout;
    }
    if (i6 == 1)
    {
      ...
      ((ImageView)localObject1).setId(2131366764);
      ((ImageView)localObject1).setImageResource(2130839709);
      ...
      ((AsyncImageView)localObject3).setId(2131366766);
      localObject1 = new RelativeLayout.LayoutParams(i4, i4);
      ((RelativeLayout.LayoutParams)localObject1).addRule(15);
      ((RelativeLayout.LayoutParams)localObject1).addRule(0, 2131366764);
      ...
      ((LinearLayout)localObject1).setId(2131366769);
      ...
      ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131366766);
      ...
      ((TextView)localObject4).setId(2131366767);
      ...
      localTextView.setId(2131366768);
      ...
      localObject1 = new LinearLayout(this.jdField_a_of_type_AndroidAppActivity);
      ((LinearLayout)localObject1).setId(2131366765);
      ((LinearLayout)localObject1).setOrientation(1);
      ((LinearLayout)localObject1).setBackgroundColor(Color.argb(0, 0, 0, 0));
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
      localLayoutParams.addRule(6, 2131366769);
      localLayoutParams.addRule(8, 2131366769);
      ...
      {
        arrr.a((AsyncImageView)localObject3, (String)localObject1);
        ((TextView)localObject4).setText((CharSequence)localObject1);
        localTextView.setText(arso.a(l1, this.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics().densityDpi));
        return localRelativeLayout;
    ...
    ((RelativeLayout.LayoutParams)localObject2).bottomMargin = azkz.a(10.0F);
    localRelativeLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1006) || (a(aryl.h))) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 7000)) {
        if (this.jdField_j_of_type_Boolean)
        {
          if (((localRecentUser.getType() == 1) && (!a(localRecentUser.uin))) || ((localRecentUser.getType() == 0) && (!ndv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 3000) || (-1L != arrr.a(localRecentUser.getType()))) {
            localArrayList.add(localRecentUser);
          } else if ((localRecentUser.uin.equalsIgnoreCase(alof.z)) && (a(aryl.jdField_f_of_type_JavaLangInteger)) && (p())) {
            localArrayList.add(localRecentUser);
          }
        }
        else if (this.l)
        ...
        else if ((localRecentUser != null) && (!bdeu.a(localRecentUser.uin)))
        {
          if (((localRecentUser.getType() == 0) && (!ndv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 3000) || ((localRecentUser.getType() == 1) && (a(c)) && (!a(localRecentUser.uin))) || (-1L != arrr.a(localRecentUser.getType()))) {
            localArrayList.add(localRecentUser);
          }
        }
        else if ((localRecentUser.uin.equalsIgnoreCase(alof.z)) && (a(aryl.jdField_f_of_type_JavaLangInteger)) && (p())) {
  ...
  protected void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo != null) {
      if (alqo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo.b())))
      {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if ((localForwardFileInfo == null) || (!alqo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localForwardFileInfo.b())))) {
          break;
        }
        this.jdField_a_of_type_JavaUtilSet.add(jdField_f_of_type_JavaLangInteger);
        this.jdField_a_of_type_JavaUtilSet.add(jdField_k_of_type_JavaLangInteger);
  ...
  {
    if ((this.jdField_j_of_type_Boolean) && (!this.jdField_i_of_type_Boolean) && (-1L != arrr.a(paramBundle.getInt("uintype"))))
    {
      bdgm.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getString(2131698095), this.jdField_a_of_type_AndroidAppActivity.getString(2131698049), null, this.jdField_a_of_type_AndroidAppActivity.getString(2131720972), new arzy(this), null).show();
      return;
    }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", this.jdField_a_of_type_AndroidAppActivity.getString(2131720582));
  ...
  public DeviceInfo[] a(DeviceInfo[] paramArrayOfDeviceInfo)
  {
    ...
    if (m < n)
    {
      ...
      {
        int i1 = arrr.a(f());
        localProductInfo = localztp.a(localDeviceInfo.productId);
        if ((i1 != 2) || (!localztp.c(localDeviceInfo.din)) || (!localztp.a(localDeviceInfo.din, 17))) {
          break label105;
        }
      }
      for (;;)
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if (bool)
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", alud.a(2131705144));
        ...
        if (this.jdField_f_of_type_Boolean)
        {
          ...
          if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_i_of_type_Boolean))
          {
            ...
            while (((Iterator)localObject).hasNext())
            {
              ...
              bfav.a().a(4, f(), localResultRecord.a(), localResultRecord.a);
              bfav.a().a();
            }
          }
        }
    ...
    if (m == 1008)
    {
      ...
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", alud.a(2131705143));
      localIntent.addFlags(268435456);
      localIntent.addFlags(67108864);
      localIntent.putExtras(this.jdField_a_of_type_AndroidOsBundle);
      bool = a(localIntent);
      ...
      if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_i_of_type_Boolean))
      {
        bfav.a().a(4, f(), m, (String)localObject);
        bfav.a().a();
      }
    }
    for (;;)
  ...
  protected int d()
  {
    ...
    {
      if (!new biva(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, jdField_a_of_type_ComTencentMobileqqDataChatMessage, true)) {
        break label131;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo != null)
      {
        ...
        if ((localFileManagerEntity != null) && (new biva(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localFileManagerEntity, null, true)))
        {
          jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = null;
          m = 0;
          continue;
  ...
  protected void y()
  {
    ...
    for (;;)
    {
      zxz localzxz = (zxz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49);
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(str1);
      localzxz.a().a((String)localObject, str2, localArrayList, null);
      this.jdField_a_of_type_AndroidAppActivity.finish();
      return;
      label92:
      localObject = (ztp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
      if ((localObject != null) && (((ztp)localObject).a(Long.parseLong(this.jdField_a_of_type_AndroidOsBundle.getString("uin")), 17)))
      {
        ((ztp)localObject).a(Long.parseLong(str2), "", "", "", 0, null);
        if (m == 0)
        {
