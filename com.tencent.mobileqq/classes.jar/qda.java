  ...
  implements qft
{
  ...
  private roq jdField_a_of_type_Roq = new qdb(this);
  ...
  private void a(@NotNull ArticleInfo paramArticleInfo)
  {
    ...
    localHashMap.put("column_id", Integer.valueOf(localrfu.jdField_a_of_type_Int));
    localHashMap.put("column_card_bg_style", Integer.valueOf(localrfu.e));
  ...
  private void a(@NotNull ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localHashMap.put("column_id", Integer.valueOf(localrfu.jdField_a_of_type_Int));
      localHashMap.put("column_card_bg_style", Integer.valueOf(localrfu.e));
      snh.a(paramArticleInfo, str, str, (int)paramArticleInfo.mChannelID, localHashMap);
      return;
      str = "0x800A7D3";
      break;
    }
  ...
  private void a(@Nullable NativeTextImp paramNativeTextImp, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramNativeTextImp.setText(pha.g(2131694658));
    ...
    for (;;)
    {
      ...
      return;
      paramNativeTextImp.setText(pha.g(2131694659));
      paramNativeTextImp.setTextColor(Color.parseColor("#FFFFFF"));
    }
  }
  
  private void a(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    String str = paramrfu.jdField_a_of_type_JavaLangString;
    if (str.isEmpty()) {
      QLog.e("ColumnTwoVideoProteusItem", 1, "column Name is empty.");
    }
    if ((jdField_a_of_type_JavaUtilSet.contains(Integer.valueOf(paramrfu.e))) && (!paramrfu.g.isEmpty()))
    {
      paramJSONObject.put("column_info_name_text", paramrfu.g + "·" + str);
      return;
    }
    paramJSONObject.put("column_info_name_text", str);
  }
  
  private void a(JSONObject paramJSONObject, @NotNull rfu paramrfu, rhx paramrhx1, rhx paramrhx2)
  {
    if (c.contains(Integer.valueOf(paramrfu.e)))
    {
      if (paramrhx1.jdField_b_of_type_JavaLangString.isEmpty()) {
        break label65;
      }
      paramJSONObject.put("column_show_video_left_title", paramrhx1.jdField_b_of_type_JavaLangString);
    }
    while (!paramrhx2.jdField_b_of_type_JavaLangString.isEmpty())
    {
      paramJSONObject.put("column_show_video_right_title", paramrhx2.jdField_b_of_type_JavaLangString);
      return;
      label65:
  ...
  private void a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      paramJSONObject.put("subscribe_title", pha.g(2131694658));
    ...
    paramJSONObject.put("subscribe_title", pha.g(2131694659));
  ...
  private void a(rfu paramrfu, int paramInt)
  {
    ...
    localReqBody.msg_subscribe_video_column_req.uint32_video_column_id.set(paramrfu.jdField_a_of_type_Int);
    ...
    localBundle.putString("columnIconUrl", paramrfu.jdField_b_of_type_JavaLangString);
    localBundle.putInt("columnId", paramrfu.jdField_a_of_type_Int);
    nir.a(pha.a(), new qdh(paramrfu, paramInt), localReqBody.toByteArray(), "OidbSvc.0xd4b", 3403, 1, localBundle);
  }
  
  private void a(rfu paramrfu, JSONObject paramJSONObject)
  {
    paramJSONObject.put("column_cover_image_url", paramrfu.jdField_b_of_type_JavaLangString);
    paramJSONObject.put("column_logo_image_url", paramrfu.jdField_c_of_type_JavaLangString);
    a(paramJSONObject, paramrfu);
    b(paramJSONObject, paramrfu);
    a(paramJSONObject, paramrfu.jdField_a_of_type_Boolean);
  }
  
  private void b(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    String str = pha.g(2131716912);
    if ((jdField_b_of_type_JavaUtilSet.contains(Integer.valueOf(paramrfu.e))) && (paramrfu.d != 0) && (!str.isEmpty())) {
      paramJSONObject.put("column_info_subscription_text", String.format(str, new Object[] { bmqa.b(paramrfu.d) }));
    }
  }
  
  private void b(JSONObject paramJSONObject, @NotNull rfu paramrfu, rhx paramrhx1, rhx paramrhx2)
  {
    if (e.contains(Integer.valueOf(paramrfu.e)))
    {
      if (paramrhx1.jdField_b_of_type_Int == 0) {
        break label65;
      }
      paramJSONObject.put("column_card_play_left_time_text", bmqa.c(paramrhx1.jdField_b_of_type_Int));
    }
    while (paramrhx2.jdField_b_of_type_Int != 0)
    {
      paramJSONObject.put("column_card_play_right_time_text", bmqa.c(paramrhx2.jdField_b_of_type_Int));
      return;
      label65:
  ...
  private void b(rfu paramrfu, JSONObject paramJSONObject)
  {
    rhx localrhx1 = (rhx)paramrfu.jdField_a_of_type_JavaUtilList.get(0);
    rhx localrhx2 = (rhx)paramrfu.jdField_a_of_type_JavaUtilList.get(1);
    paramJSONObject.put("column_left_item_cover_url", localrhx1.jdField_c_of_type_JavaLangString);
    paramJSONObject.put("column_right_item_cover_url", localrhx2.jdField_c_of_type_JavaLangString);
    a(paramJSONObject, paramrfu, localrhx1, localrhx2);
    c(paramJSONObject, paramrfu);
    b(paramJSONObject, paramrfu, localrhx1, localrhx2);
  }
  
  private void c(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    if (d.contains(Integer.valueOf(paramrfu.e)))
    {
  ...
  private void d(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    if (f.contains(Integer.valueOf(paramrfu.e)))
    {
      if ((!paramrfu.h.isEmpty()) && (!paramrfu.g.isEmpty()))
      {
        paramJSONObject.put("column_bottom_icon_view_visibility", "1");
        paramJSONObject.put("column_bottom_icon_url", paramrfu.h);
        paramJSONObject.put("column_bottom_name", paramrfu.g);
      }
    }
    else {
      return;
  ...
  private void e(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    String str2 = "";
    String str3 = pha.g(2131716916);
    String str1 = str2;
    if (paramrfu.jdField_c_of_type_Int > 0)
    {
      str1 = str2;
      if (!str3.isEmpty()) {
        str1 = String.format(str3, new Object[] { Integer.valueOf(paramrfu.jdField_c_of_type_Int) });
      }
    }
    if ((g.contains(Integer.valueOf(paramrfu.e))) && (!str1.isEmpty()))
    {
      if ((paramrfu.jdField_a_of_type_Boolean) && (f.contains(Integer.valueOf(paramrfu.e)))) {
        paramJSONObject.remove("column_bottom_video_count");
      }
    }
    else
    {
      str1 = pha.g(2131716917);
      if ((!paramrfu.jdField_a_of_type_Boolean) || (paramrfu.jdField_b_of_type_Int == 0) || (str1.isEmpty())) {
        break label178;
      }
      paramJSONObject.put("column_bottom_video_update_count", String.format(str1, new Object[] { Integer.valueOf(paramrfu.jdField_b_of_type_Int) }));
    }
    label178:
    do
    {
      ...
      break;
      paramrfu = a(paramrfu.jdField_a_of_type_Long, System.currentTimeMillis());
    } while (paramrfu.isEmpty());
    paramJSONObject.put("column_bottom_video_update_time", paramrfu);
  }
  
  private void f(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    JsonArray localJsonArray = new JsonArray();
    Iterator localIterator = paramrfu.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localJsonArray.add(((rhx)localIterator.next()).jdField_a_of_type_JavaLangString);
    }
    paramJSONObject.put("rowkey", localJsonArray);
    paramJSONObject.put("column_id", paramrfu.jdField_a_of_type_Int);
    paramJSONObject.put("column_card_bg_style", paramrfu.e);
    if (paramrfu.jdField_a_of_type_Boolean) {}
    for (int i = 1;; i = 0)
    {
  ...
  private void g(JSONObject paramJSONObject, @NotNull rfu paramrfu)
  {
    if (h.contains(Integer.valueOf(paramrfu.e)))
    {
      paramJSONObject.put("column_top_view_visibility", "1");
      paramJSONObject.remove("column_middle_view_visibility");
    }
    while (c.contains(Integer.valueOf(paramrfu.e)))
    {
  ...
  {
    parampxk = parampxk.a();
    if ((parampxk == null) || (parampxk.multiVideoColumnInfo == null)) {
      return;
    }
    if (paramContainer.getTag(2131362195) == null)
    {
      paramContainer.setTag(2131362195, "true");
      paramContainer.addOnAttachStateChangeListener(new qdc(this));
    }
    paramContainer = paramContainer.getVirtualView();
    parampxk = paramContainer.findViewBaseByName("id_top_subscribe_view");
    if ((parampxk != null) && (parampxk.getNativeView() != null) && ((parampxk.getNativeView() instanceof NativeLayoutImpl))) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewLayoutHelperNativelayoutNativeLayoutImpl = ((NativeLayoutImpl)parampxk.getNativeView());
    }
    parampxk = paramContainer.findViewBaseByName("id_middle_subscribe_view");
    if ((parampxk != null) && (parampxk.getNativeView() != null) && ((parampxk.getNativeView() instanceof NativeLayoutImpl))) {
      this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewLayoutHelperNativelayoutNativeLayoutImpl = ((NativeLayoutImpl)parampxk.getNativeView());
    }
  ...
  public boolean a(int paramInt, Container paramContainer, pxk parampxk, ViewBase paramViewBase)
  {
    ...
    do
    {
      ...
      parampxk = parampxk.a();
      localrfu = parampxk.multiVideoColumnInfo;
      paramContainer = paramContainer.getContext();
      if ("cmd_column_card_click".equals(str))
      {
        paramViewBase.setOnClickListener(new qdd(this, paramContainer, localrfu, parampxk));
        return true;
      }
      if ("cmd_column_left_item_click".equals(str))
      {
        paramViewBase.setOnClickListener(new qde(this, paramContainer, localrfu, parampxk));
        return true;
      }
      if ("cmd_column_right_item_click".equals(str))
      {
        paramViewBase.setOnClickListener(new qdf(this, paramContainer, localrfu, parampxk));
        return true;
      }
    } while (!"cmd_subscription_click".equals(str));
    paramViewBase.setOnClickListener(new qdg(this, localrfu, parampxk));
    return true;
  }
}
