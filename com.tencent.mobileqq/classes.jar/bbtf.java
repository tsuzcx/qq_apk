  ...
  implements bbsz
{
  ...
  public bbtf(bbta parambbta)
  {
    bbsx localbbsx = parambbta.a;
    if (localbbsx != null) {
      localbbsx.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bbta = parambbta;
  }
  
  public void a(bbtg parambbtg)
  {
    this.jdField_a_of_type_Bbtg = parambbtg;
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bbta == null);
          paramObject1 = this.jdField_a_of_type_Bbta.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bbtg.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bbta.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bbsx)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bbsy)localObject4).encode(localObject1);
        }
        ((bbsx)localObject2).send(paramString);
        return;
      }
      try
      {
