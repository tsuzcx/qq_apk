  ...
  implements Handler.Callback
{
  ...
  asjr jdField_a_of_type_Asjr;
  EglHandlerThread jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread;
  String jdField_a_of_type_JavaLangString;
  List<alje> jdField_a_of_type_JavaUtilList = new ArrayList();
  private CopyOnWriteArrayList<WeakReference<asjt>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  ...
  public asjq(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private int a()
  {
    ...
    asjs localasjs = new asjs();
    localasjs.jdField_a_of_type_Int = this.jdField_d_of_type_Int;
    localasjs.jdField_b_of_type_Int = 256;
    localasjs.jdField_c_of_type_Int = 256;
    localasjs.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localasjs.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    localasjs.jdField_a_of_type_JavaLangString = asjo.a(this.jdField_b_of_type_JavaLangString);
    localasjs.jdField_d_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("runType").append("=").append(localasjs.jdField_a_of_type_Int).append("\n");
    localStringBuilder.append("netHeight").append("=").append(localasjs.jdField_b_of_type_Int).append("\n");
    localStringBuilder.append("netWidth").append("=").append(localasjs.jdField_c_of_type_Int).append("\n");
    localStringBuilder.append("paramPath").append("=").append(localasjs.jdField_b_of_type_JavaLangString).append("\n");
    localStringBuilder.append("anchorPath").append("=").append(localasjs.jdField_c_of_type_JavaLangString).append("\n");
    localStringBuilder.append("kernelBinaryIndex").append("=").append(localasjs.jdField_d_of_type_JavaLangString).append("\n");
    localStringBuilder.append("modelString").append("=").append(localasjs.jdField_a_of_type_JavaLangString).append("\n");
    if (QLog.isColorLevel()) {
      QLog.i("MiniRecog.detector", 2, localStringBuilder.toString());
    }
    if ((this.jdField_b_of_type_Int > 0) && (this.jdField_c_of_type_Int > 0)) {
      this.jdField_a_of_type_Int = asjm.a(this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    }
    this.jdField_a_of_type_Asjr = new asjr(localasjs);
    if (this.jdField_a_of_type_Asjr.a()) {
      return 1;
    }
    return 0;
  }
  ...
  private static void a(int paramInt, Bitmap paramBitmap)
  {
    ...
    asjm.a("glBindTexture");
    GLES20.glTexParameterf(3553, 10241, 9729.0F);
    GLES20.glTexParameterf(3553, 10240, 9729.0F);
    GLES20.glTexParameteri(3553, 10242, 33071);
    GLES20.glTexParameteri(3553, 10243, 33071);
    asjm.a("glTexParameteri");
  ...
  private boolean a(long paramLong, boolean paramBoolean)
  {
    ...
    if ((((Bitmap)localObject).getWidth() != this.jdField_b_of_type_Int) || (((Bitmap)localObject).getHeight() != this.jdField_c_of_type_Int) || (this.jdField_a_of_type_Int < 0))
    {
      ...
      try
      {
        int j = avyi.a(3553, (Bitmap)localObject);
        i = j;
      }
    ...
    if (this.jdField_a_of_type_Int >= 0)
    {
      List localList = this.jdField_a_of_type_Asjr.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, paramLong, paramBoolean);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_AndroidOsHandler != null)
      {
        ...
        boolean bool1 = asjn.jdField_b_of_type_Boolean;
        ...
        if ((this.jdField_b_of_type_AndroidOsHandler != null) && (bool1))
        {
          ...
          {
            localasjt = (asjt)((WeakReference)((Iterator)localObject).next()).get();
            if (localasjt != null) {
              localasjt.a(this.jdField_a_of_type_JavaUtilList, ((Long)paramMessage[1]).longValue());
            }
          }
          this.jdField_b_of_type_Boolean = false;
          return false;
          ...
          {
            localObject = (asjt)((WeakReference)paramMessage.next()).get();
            if (localObject != null) {
              ((asjt)localObject).a(i);
            }
          }
          paramMessage = (Object[])paramMessage.obj;
          ...
          while (((Iterator)localObject).hasNext())
          {
            localasjt = (asjt)((WeakReference)((Iterator)localObject).next()).get();
            if (localasjt != null) {
              localasjt.a(((Long)paramMessage[0]).longValue());
            }
          }
        }
      }
