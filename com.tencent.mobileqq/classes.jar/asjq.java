  ...
  implements bhqp
{
  ...
  private asjs jdField_a_of_type_Asjs;
  private bcws jdField_a_of_type_Bcws = new bcws(this.jdField_a_of_type_AndroidContentContext, akro.a());
  private bdqc jdField_a_of_type_Bdqc = new asjr(this);
  private String jdField_a_of_type_JavaLangString;
  private List<FeedsItemData.FriendInfo> jdField_a_of_type_JavaUtilList;
  
  protected asjq(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  public asjq(Context paramContext, String paramString, int paramInt)
  {
    this(paramContext);
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = paramString;
    f();
    akro.a().addObserver(this.jdField_a_of_type_Bdqc);
    ((bdpx)akro.a().getBusinessHandler(71)).a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
  ...
  private String a(long paramLong)
  {
    ...
    if (paramLong < 60L) {
      return paramLong / 60L + alpo.a(2131710669);
    }
    if ((paramLong >= 60L) && (paramLong < 3600L)) {
      return paramLong / 60L + alpo.a(2131710672);
    }
    if ((paramLong >= 3600L) && (paramLong < paramLong / 86400L)) {
      return paramLong / 3600L + alpo.a(2131710670);
    }
    int i = (int)(paramLong / 86400L);
    if (i >= 30) {
      return i / 30 + alpo.a(2131710675);
    }
    if (i >= 7) {
      return i / 7 + alpo.a(2131710673);
    }
    return i + alpo.a(2131710674);
  }
  
  private void f()
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, aekt.a(500.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    ((ImageView)localObject2).setId(2131367031);
    Object localObject1 = new RelativeLayout.LayoutParams(-1, (int)(bdcb.k() / 750L * 36L));
    ...
    ((TextView)localObject2).setText(alpo.a(2131710671));
    Object localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(9);
    ((RelativeLayout.LayoutParams)localObject3).setMargins(aekt.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0);
    ((TextView)localObject2).setTextSize(18.0F);
    ((TextView)localObject2).setTextColor(-16777216);
    ((RelativeLayout)localObject1).addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
    ((TextView)localObject2).setId(2131367033);
    localObject3 = new ListView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Asjs = new asjs(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaUtilList);
    ((ListView)localObject3).setAdapter(this.jdField_a_of_type_Asjs);
    ...
    ((ListView)localObject3).setSelector(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849999));
  ...
  {
    super.dismiss();
    akro.a().removeObserver(this.jdField_a_of_type_Bdqc);
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = (aloz)akro.a().getManager(51);
