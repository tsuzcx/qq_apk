  ...
  extends anud
{
  ...
  public abvz a;
  private abwg jdField_a_of_type_Abwg = new abzc(this);
  public abyv a;
  private abyz jdField_a_of_type_Abyz;
  public abza a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new abzd(this);
  aohf jdField_a_of_type_Aohf = new abze(this);
  public HashMap<String, List<abwg>> a;
  ...
  public abzb(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Abwg);
    this.jdField_a_of_type_Abyz = new abyz(paramQQAppInterface);
    this.jdField_a_of_type_Abyv = new abyv(paramQQAppInterface);
    this.jdField_a_of_type_Abvz = new abvz();
    this.jdField_a_of_type_Abza = new abza(paramQQAppInterface);
    a(f, this.jdField_a_of_type_Abvz);
    a(e, this.jdField_a_of_type_Abvz);
    a(g, this.jdField_a_of_type_Abvz);
    a(g, this.jdField_a_of_type_Abyv);
    a(g, this.jdField_a_of_type_Abza);
    a(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Abyz);
    a(c, this.jdField_a_of_type_Abyz);
    a(d, this.jdField_a_of_type_Abyz);
    a(h, this.jdField_a_of_type_Abyz);
    a("8000-NASDevMusicFile", this.jdField_a_of_type_Abyz);
    a("8001-NASDevVideoFile", this.jdField_a_of_type_Abyz);
    a("8002-NASDevDocumentFile", this.jdField_a_of_type_Abyz);
    a("8003-NASDevCommonFile", this.jdField_a_of_type_Abyz);
    a("", this.jdField_a_of_type_Abyz);
    a("", this.jdField_a_of_type_Abvz);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Aohf);
  ...
  private void a()
  {
    DeviceInfo[] arrayOfDeviceInfo = ((abur)this.app.a(51)).a();
  ...
  {
    MessageForDeviceText localMessageForDeviceText = (MessageForDeviceText)bcry.a(-4508);
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong)
  {
    ...
    String str = aeam.f + "http://maps.google.com/maps?q=" + paramString2 + "," + paramString3 + "&iwloc=A&hl=zh-CN (" + paramString5 + ")";
    ...
    for (paramContext = paramContext.getResources().getString(2131691132) + " " + paramString4;; paramContext = paramContext.getResources().getString(2131691132))
    {
      ...
      paramContext = new bdoi(StructMsgForGeneralShare.class).c(32).a(paramContext).d(str).a("plugin", paramString2, paramString2, paramString2, paramString2).a();
      ...
      paramContext = bcry.a(this.app, this.app.getCurrentAccountUin(), paramString1, this.app.getCurrentAccountUin(), 9501, 100L, paramContext);
  ...
  public abvz a()
  {
    return this.jdField_a_of_type_Abvz;
  }
  
  public abyv a()
  {
    return this.jdField_a_of_type_Abyv;
  }
  ...
  public abza a()
  {
    return this.jdField_a_of_type_Abza;
  }
  ...
  {
    ArrayList localArrayList = bhjx.a(paramString, 560, 20, null, new ArrayList());
    int i = 0;
    if (i < localArrayList.size())
    {
      ...
      paramString = "";
      if (str1 != null) {
        paramString = bcsa.a(str1, true, null);
      }
      int j = (int)bcrg.a();
      ...
      localMessageForDeviceText.shmsgseq = bcsa.a(i, paramSessionInfo.jdField_a_of_type_Int);
      ...
      for (;;)
      {
        if (localMessageForDeviceText.extraflag != 32768)
        {
          ...
          ((abur)paramQQAppInterface.a(51)).a(localMessageForDeviceText.msg, Long.parseLong(localMessageForDeviceText.frienduin), l, localMessageForDeviceText.msgseq);
        }
        i += 1;
        break;
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    default: 
      paramInt = i;
      localMessageForGrayTips = (MessageForGrayTips)bcry.a(paramInt);
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      i = -5001;
      localMessageForNewGrayTips = (MessageForNewGrayTips)bcry.a(i);
  ...
  public boolean a(String paramString, abwg paramabwg)
  {
    ...
    if (!((List)localObject).contains(paramabwg)) {
      ((List)localObject).add(paramabwg);
    }
    return true;
  }
  
  public boolean b(String paramString, abwg paramabwg)
  {
    paramString = (List)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {
      paramString.remove(paramabwg);
    }
    return true;
  }
  ...
  {
    super.onDestroy();
    b(f, this.jdField_a_of_type_Abvz);
    b(e, this.jdField_a_of_type_Abvz);
    b(g, this.jdField_a_of_type_Abvz);
    b(g, this.jdField_a_of_type_Abyv);
    b(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Abyz);
    b(c, this.jdField_a_of_type_Abyz);
    b(d, this.jdField_a_of_type_Abyz);
    b(h, this.jdField_a_of_type_Abyz);
    b("8000-NASDevMusicFile", this.jdField_a_of_type_Abyz);
    b("8001-NASDevVideoFile", this.jdField_a_of_type_Abyz);
    b("8002-NASDevDocumentFile", this.jdField_a_of_type_Abyz);
    b("8003-NASDevCommonFile", this.jdField_a_of_type_Abyz);
    b("", this.jdField_a_of_type_Abyz);
    b("", this.jdField_a_of_type_Abvz);
    this.app.removeObserver(this.jdField_a_of_type_Abwg);
    this.app.getApp().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.app.removeObserver(this.jdField_a_of_type_Aohf);
    this.jdField_a_of_type_Abyz = null;
    this.jdField_a_of_type_Abyv = null;
    this.jdField_a_of_type_Abvz = null;
    this.jdField_a_of_type_Abza = null;
  }
