...
public class zzo
  extends RecyclerView.Adapter<zzr>
  implements Handler.Callback
{
  ...
  public zzr a(ViewGroup paramViewGroup, int paramInt)
  {
    return new zzr(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131562968, null));
  }
  ...
  {
    VSNetworkHelper.getInstance().sendRequest(new BatchGetMusicInfoRequest(paramArrayList), new zzq(this, paramBoolean));
  }
  ...
  public void a(zzr paramzzr, int paramInt)
  {
    if (a() == 0) {}
    int i;
    label31:
    ...
    do
    {
      EventCollector.getInstance().onRecyclerBindViewHolder(paramzzr, paramInt, getItemId(paramInt));
      return;
      if (paramInt >= a()) {
        break;
      }
    ...
    for (;;)
    {
      UIUtils.setRoundCornerViewByURL(zzr.a(paramzzr), localVsMusicItemInfo.mAlbumUrl, UIUtils.dip2px(paramzzr.itemView.getContext(), 60.0F), UIUtils.dip2px(paramzzr.itemView.getContext(), 60.0F), UIUtils.dip2px(paramzzr.itemView.getContext(), 30.0F), paramzzr.itemView.getContext().getResources().getDrawable(2130838918), null);
      paramzzr.itemView.setOnClickListener(new zzp(this, paramInt, localVsMusicItemInfo));
      break;
      i = a(paramInt);
      break label31;
      paramzzr.b(false);
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Zzd = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
