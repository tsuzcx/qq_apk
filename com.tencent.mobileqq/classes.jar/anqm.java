  ...
  extends baua
{
  ...
  public anqm(QQAppInterface paramQQAppInterface, SelectCoverActivity paramSelectCoverActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      return;
      localObject = (baoj)paramMessage.obj;
      ...
      default: 
        return;
      case 1003: 
        if (((baoj)localObject).b == 48)
        {
          paramMessage = ((baqs)((baoj)localObject).a).a;
          if (QLog.isColorLevel()) {
            QLog.i("SelectCoverActivity", 2, "mPhotoUploadHandler.handleMessage(), static avatar upload success. photoId = " + paramMessage);
          }
          paramMessage = (alkv)localQQAppInterface.a(2);
          if (paramMessage != null) {
            paramMessage.a(true, localQQAppInterface.getCurrentAccountUin(), 0);
          }
          bcyw.a(null);
          if (((Integer)aush.a(localQQAppInterface.getAccount(), "qq_avatar_type", Integer.valueOf(-1))).intValue() != 1) {
            aush.a(localQQAppInterface.getAccount(), "qq_avatar_type", Integer.valueOf(1));
          }
          if (localSelectCoverActivity.jdField_d_of_type_Int != 3)
          {
            ...
            {
              paramMessage = "1";
              azmj.b(localQQAppInterface, "dc00898", "", "", "0X800711D", "0X800711D", 0, 0, String.valueOf(i), (String)localObject, str, paramMessage);
            }
          }
          else
          {
          ...
          for (;;)
          {
            ...
            if (localSelectCoverActivity.jdField_d_of_type_Int == 3)
            {
              ...
              azmj.b(localQQAppInterface, "dc00898", "", "", "0X8009DFA", "0X8009DFA", 0, 0, (String)localObject, "", "", "");
        ...
        if (((baoj)localObject).b == 36)
        {
          paramMessage = ((baqs)((baoj)localObject).a).b;
          if (QLog.isColorLevel()) {
