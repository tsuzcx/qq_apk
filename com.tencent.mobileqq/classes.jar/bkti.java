...
public class bkti
{
  ...
  private bksx jdField_a_of_type_Bksx = new bktj(this);
  private bktn jdField_a_of_type_Bktn;
  private JsCallParams jdField_a_of_type_CooperationQqreaderJsJsCallParams;
  
  public bkti(Activity paramActivity)
  {
  ...
  private Intent a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramActivity == null)
      {
        ...
        paramBundle.putExtras(bksr.a(paramBundle, 1));
      }
    ...
    str1 = DeviceInfoUtil.getNetInfo(paramActivity).networkType;
    String str2 = bkvi.a(paramActivity);
    if (l2 != 0L) {}
    for (paramBundle = String.valueOf(l2);; paramBundle = "")
    {
      bkvg.a(str1, str2, "2198", paramBundle, "2", "");
      paramActivity = a(paramActivity);
  ...
  private View a()
  {
    ...
    localTextView.setText(2131693499);
    localTextView.setTextColor(-16777216);
    localTextView.setGravity(17);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(13);
    localTextView.setPadding(0, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidAppActivity, 120.0F), 0, 0);
    localRelativeLayout.addView(localTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = localTextView;
    bktq.a().a(this.jdField_a_of_type_AndroidAppActivity, localImageView);
  ...
  {
    boolean bool = bkun.a();
    bkvd.e("ReaderSplashImpl", "jumpToPlugin: isUseShadow = " + bool);
    if (bool)
    {
      bkun.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, "com.qqreader.pureader.SSReaderActivity", new bktl(this));
      return;
    }
  ...
  private void a(View paramView)
  {
    ...
    {
      bkvd.a("ReaderSplashImpl", "showLoadingView: mContentView == null");
      return;
    }
  ...
  private void a(JsCallParams paramJsCallParams)
  {
    if (bksw.a().a())
    {
      ReaderJsPluginProxy localReaderJsPluginProxy = bksw.a().a(new bktk(this));
      ...
      for (;;)
      {
        d();
        return;
        bkvd.a("ReaderSplashImpl", "checkPluginForHandleSpecialJsCall: plugin is ready but jsPluginProxy is null");
      }
    }
  ...
  private void b(@NonNull Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidAppActivity == null) {
      bkvd.a("ReaderSplashImpl", "doJump: activity is null");
    }
    Intent localIntent;
    do
    {
    ...
    localIntent.putExtra("login_interval", bkvi.a(BaseApplicationImpl.getApplication()));
  ...
  private void c()
  {
    ...
    {
      bkvd.a("ReaderSplashImpl", "handlePendingJumpPluginIntent: mPendingJumpPluginIntent == null");
      return;
    }
    ...
    {
      bkvd.b("ReaderSplashImpl", "handlePendingJumpPluginIntent: activity is destroyed");
      return;
    }
    bksr.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, "com.qqreader.pureader.SSReaderActivity", new bktm(this));
  ...
  public void a()
  {
    bkvd.d("ReaderSplashImpl", "onCreate");
    Object localObject = new IntentFilter();
    ((IntentFilter)localObject).addAction("cooperation.qqreader.start_reader_act_completed");
    if (this.jdField_a_of_type_Bktn == null)
    {
      this.jdField_a_of_type_Bktn = new bktn(this, null);
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_Bktn, (IntentFilter)localObject);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bktn != null)
    {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_Bktn);
      this.jdField_a_of_type_Bktn = null;
    }
  }
}
