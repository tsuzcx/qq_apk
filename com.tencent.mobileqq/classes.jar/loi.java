  ...
  implements log
{
  ...
  public loi(Context paramContext, lps paramlps)
  {
  ...
  private void a(int paramInt, PendantItem paramPendantItem, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_Lps != null) {
        this.jdField_a_of_type_Lps.a(paramPendantItem.getGestureType());
      }
      return;
    }
    if (this.jdField_a_of_type_Lps != null) {
  ...
  public int a(int paramInt, boolean paramBoolean1, lpa paramlpa, boolean paramBoolean2)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAESticker != null) || (this.jdField_b_of_type_Boolean))
    {
      ...
      lpr.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.hasAEDetectorInited());
    }
    for (;;)
    {
      paramBoolean1 = bool;
      ...
      paramlpa.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getFaceAttr(), (float)this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getWindowScale(), paramBoolean2);
      return i;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.cameraInterFace == null)) {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.cameraInterFace = lhi.a();
      }
      return;
      label69:
  ...
  public void a(PendantItem paramPendantItem, VideoMaterial paramVideoMaterial)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((lpr.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) && (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial == paramVideoMaterial));
  ...
  public void a(low paramlow, lpa paramlpa)
  {
    ...
    for (boolean bool1 = this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem.hasFace();; bool1 = false)
    {
      ...
      if ((lhp.a(this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        String str2;
        String str1;
        if (paramlpa.jdField_a_of_type_Int <= 0)
        {
          str2 = str4;
          str1 = str3;
          if (bool1) {}
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            ...
            if (localGestureKeyInfo.vaild)
            {
              str2 = str4;
              str1 = str3;
              if (localGestureKeyInfo.type.equals("")) {}
            }
            else
            {
              str2 = str4;
              ...
              if (this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem != null)
              {
                str1 = this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem.getGestureType();
                str2 = this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem.getGestureWording();
              }
            }
          }
        }
        if (this.jdField_a_of_type_Lps != null) {
          this.jdField_a_of_type_Lps.a(paramlow, paramlpa.jdField_a_of_type_Int, this.jdField_a_of_type_Boolean, bool1, str2, str1);
        }
        return;
      }
    }
  ...
  public boolean a(lon paramlon)
  {
    boolean bool = false;
    if (paramlon != null) {}
    for (int i = paramlon.a("BEAUTY_SKIN");; i = 0)
    {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      lbc.c("AEFilterOldWrapper", "mQQFilterRenderManager surfaceChange" + str);
    }
  }
