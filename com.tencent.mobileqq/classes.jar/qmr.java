  ...
  extends qms
{
  ...
  public qmr(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsTopicViewGroup = ((VideoFeedsTopicViewGroup)paramView.findViewById(2131379039));
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131378978);
    int k;
  ...
  public static qmr a(View paramView)
  {
    boolean bool;
    ...
    if (Aladdin.getConfig(260).getIntegerFromString("interact_button_style", 0) == 1)
    {
      ...
      localViewStub1 = (ViewStub)paramView.findViewById(2131378990);
      localViewStub2 = (ViewStub)paramView.findViewById(2131378983);
      ((ViewStub)paramView.findViewById(2131378988)).inflate();
      localViewStub1.inflate();
      localViewStub2.inflate();
    }
    for (;;)
    {
      paramView = new qmr(paramView);
      paramView.jdField_a_of_type_Boolean = bool;
      return paramView;
      bool = false;
      break;
      label86:
      localViewStub1 = (ViewStub)paramView.findViewById(2131378986);
      localViewStub2 = (ViewStub)paramView.findViewById(2131378984);
      ((ViewStub)paramView.findViewById(2131378987)).inflate();
      localViewStub1.inflate();
      localViewStub2.inflate();
    }
  }
