  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  private bdxu jdField_a_of_type_Bdxu;
  ...
  public bdxs(@NonNull Context paramContext)
  {
  ...
  public void a(int paramInt1, int paramInt2, bdxu parambdxu)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTimePicker.setOnTimeChangedListener(new bdxt(this));
    this.jdField_a_of_type_Bdxu = parambdxu;
  }
  ...
  {
    if (this.jdField_a_of_type_Bdxu != null) {
      this.jdField_a_of_type_Bdxu.onTimeCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bdxu != null)
    {
      ...
      this.jdField_a_of_type_Bdxu.onTimeConfirm(paramView, (String)localObject);
    }
    a();
  }
}
