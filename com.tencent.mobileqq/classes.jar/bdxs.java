  ...
  implements Manager
{
  ...
  public bdxs(QQAppInterface paramQQAppInterface)
  {
  ...
  SubAccountMessage a(String paramString)
  {
    ...
    localSubAccountMessage.sendername = anvx.a(2131719077);
  ...
  public List<SubAccountMessage> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = null;; localObject1 = "containsKey=" + this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
      {
        ...
        label239:
        if ((localargg == null) || (localargg.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_Boolean)) {
          break;
        }
        localArrayList.add(0, a(paramString));
        break;
  ...
  public void a(bdxt parambdxt)
  {
    ...
    {
      if ((parambdxt != null) && (parambdxt.jdField_b_of_type_JavaLangString != null) && (parambdxt.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (parambdxt = "data == null";; parambdxt = "data.mMainAccount=" + parambdxt.jdField_b_of_type_JavaLangString + " data.mSubUin=" + parambdxt.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, parambdxt);
      return;
      localObject1 = "data.mMainAccount=" + parambdxt.jdField_b_of_type_JavaLangString + " data.mSubUin=" + parambdxt.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = parambdxt.a();
    Object localObject1 = parambdxt.c();
    ArrayList localArrayList3 = parambdxt.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!parambdxt.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = parambdxt.jdField_b_of_type_JavaLangString;
          ((SubAccountInfo)localObject2).serverErrorType = parambdxt.jdField_b_of_type_Int;
          ((SubAccountInfo)localObject2).serverErrorMsg = parambdxt.jdField_a_of_type_JavaLangString;
      ...
      {
        parambdxt = localArrayList3.iterator();
        while (parambdxt.hasNext()) {
          a((String)parambdxt.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      parambdxt = localArrayList1.iterator();
      while (parambdxt.hasNext()) {
        a((SubAccountInfo)parambdxt.next());
      }
      break;
      label629:
      localObject1 = null;
          ...
          if (paramString2 != null)
          {
            ...
            if (bool)
            {
              ...
              if (localSubAccountMessage.istroop == 1)
              {
                ...
                bdxj.a(paramQQAppInterface, paramString1, 6);
  ...
  public void c(String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      {
        localbdxo = bdxj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSubAccountInfo.subuin);
        ...
        if ((localbdxo.jdField_a_of_type_Boolean) || (j == localbdxo.jdField_a_of_type_Int)) {
          break label429;
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().d(localSubAccountInfo.subuin, 7000, localbdxo.jdField_a_of_type_Int - j);
      }
    }
    label338:
    acmw localacmw;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("SUB_ACCOUNT", 2, "updateAnotherSubAccountUnreadMsg" + " info.subuin=" + localSubAccountInfo.subuin + " anotherC2cUnread=" + j + " anotherTroopUnread=" + k + " item.showRedDot=" + localbdxo.jdField_a_of_type_Boolean + " item.unReadCount=" + localbdxo.jdField_a_of_type_Int);
        break label198;
        break;
        if ((localbdxo.jdField_a_of_type_Boolean) && (localbdxo.jdField_a_of_type_Int != k))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 != null) && (((ArrayList)localObject2).size() != 0))
            {
              ...
              if (((Iterator)localObject2).hasNext())
              {
                ...
                localSubAccountMessage.mTimeString = bhid.a(localSubAccountMessage.time * 1000L, true, paramString);
                if (i == 0) {
                  break label332;
                }
                i = 0;
