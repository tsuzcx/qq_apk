...
public class aend
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, bgmm parambgmm)
  {
    if (paramContext == null) {}
    while ((paramString == null) || ("".equals(paramString)) || (paramQQAppInterface == null)) {
      return;
    }
    ThreadManager.post(new LebaIconDownloader.1(paramContext, paramString, paramQQAppInterface, parambgmm), 5, null, true);
  }
