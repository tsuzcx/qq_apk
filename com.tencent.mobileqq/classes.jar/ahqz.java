...
public class ahqz
{
  ...
  private static HashMap<String, List<ahpo>> c = new HashMap();
  ...
  public static List<ahpo> a(String paramString)
  {
  ...
  public static List<ahof> a(ArrayList<ahpo> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      String str = String.valueOf(((ahpo)paramArrayList.get(i)).jdField_a_of_type_Long);
      ...
      if ((localTroopInfo != null) && (localTroopInfo.troopname != null) && (!localTroopInfo.troopname.isEmpty()))
      {
        ...
        localahof.jdField_a_of_type_ComTencentMobileqqDataTroopInfo = localTroopInfo;
        localahof.jdField_a_of_type_JavaLangString = str;
        localahof.jdField_a_of_type_Int = ((ahpo)paramArrayList.get(i)).jdField_a_of_type_Int;
        localArrayList.add(localahof);
      }
      i += 1;
    }
    return localArrayList;
  ...
  public static void a(String paramString1, String paramString2, String paramString3, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramString2 = (amdu)paramQQAppInterface.a(20);
  ...
  public static void a(String paramString, List<ahpo> paramList)
  {
  ...
  public static boolean a(long paramLong, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (asig)paramQQAppInterface.a(153);
    if (!a(str))
    {
