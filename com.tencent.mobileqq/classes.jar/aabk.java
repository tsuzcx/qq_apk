...
{
  private static aabk jdField_a_of_type_Aabk;
  ...
  {
    if (jdField_a_of_type_Aabk == null) {}
    try
    {
      if (jdField_a_of_type_Aabk == null)
      {
        jdField_a_of_type_Aabk = new aabk();
        new HardCoderManager.1().start();
      }
      return jdField_a_of_type_Aabk;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = aabg.a().a();
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, long paramLong, int paramInt7, String paramString, boolean paramBoolean)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      return aabg.a().a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramLong, paramInt7, paramString);
    }
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
    aabh localaabh = (aabh)aabg.a.obtain(aabh.class);
    localaabh.jdField_a_of_type_Int = paramInt1;
    localaabh.c = paramInt2;
    localaabh.d = paramInt3;
    localaabh.e = paramInt4;
    localaabh.b = paramInt5;
    localaabh.f = paramInt6;
    localaabh.jdField_a_of_type_Long = paramLong;
    localaabh.jdField_a_of_type_JavaLangString = paramString;
    localMessage.obj = localaabh;
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((Math.abs(System.currentTimeMillis() - l) <= 86400000L) || (!bbev.h(BaseApplicationImpl.getContext()))) {
          continue;
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      Object localObject = (aabh)paramMessage.obj;
      jdField_a_of_type_AndroidOsBundle.putInt("key_delay", ((aabh)localObject).jdField_a_of_type_Int);
      jdField_a_of_type_AndroidOsBundle.putInt("key_cpu", ((aabh)localObject).c);
      jdField_a_of_type_AndroidOsBundle.putInt("key_io", ((aabh)localObject).d);
      jdField_a_of_type_AndroidOsBundle.putInt("key_bind", ((aabh)localObject).e);
      jdField_a_of_type_AndroidOsBundle.putInt("key_timeout", ((aabh)localObject).b);
      jdField_a_of_type_AndroidOsBundle.putInt("key_scene", ((aabh)localObject).f);
      jdField_a_of_type_AndroidOsBundle.putLong("key_action", ((aabh)localObject).jdField_a_of_type_Long);
      jdField_a_of_type_AndroidOsBundle.putString("key_tag", ((aabh)localObject).jdField_a_of_type_JavaLangString);
