...
public class bdrl
  extends anii
{
  public bdrl(QQAppInterface paramQQAppInterface)
  {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      if ("QQAIOMediaSvc.get_latest_playing_state".equals(paramFromServiceMsg.getServiceCmd()))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            paramObject = ((bdrb)this.mApp.getManager(339)).a(i);
            if (paramObject == null)
            {
              if (QLog.isColorLevel()) {
    ...
    return;
    bdrb.a(this.app).a(paramFromServiceMsg);
    label443:
