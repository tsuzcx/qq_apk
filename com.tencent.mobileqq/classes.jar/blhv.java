...
public class blhv
{
  ...
  public static blhw a(String paramString)
  {
    int i = 0;
    if (paramString == null) {}
    blhw localblhw;
    ...
    for (;;)
    {
      localblhw.a = paramString.getString("k=");
      localblhw.b = d(paramString.getString("u="));
      localObject = b(paramString.getString("n="));
      if (localObject != null)
      {
        localblhw.c = URLDecoder.decode((String)localObject, "UTF-8");
        if (localblhw.c != null) {}
      }
      for (localblhw.c = localblhw.b;; localblhw.c = localblhw.b)
      {
        localblhw.d = paramString.getString("o=");
        localblhw.e = paramString.getString("p=");
        localblhw.f = paramString.getString("d=");
        if ((localblhw.a == null) || (localblhw.b == null) || (localblhw.d == null)) {
          break;
        }
        return localblhw;
      }
