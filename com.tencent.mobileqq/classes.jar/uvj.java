...
{
  uvj(uvh paramuvh, Intent paramIntent) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    uvh.c(this.jdField_a_of_type_Uvh);
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        uvh.a(this.jdField_a_of_type_Uvh).startActivityForResult(this.jdField_a_of_type_AndroidContentIntent, (byte)1);
      }
