...
public class uvj
  implements Runnable
{
  public uvj(PressToSpeakPanel paramPressToSpeakPanel, MotionEvent paramMotionEvent) {}
  ...
  public void run()
  {
    ...
    {
      QQToast.a(BaseApplication.getContext(), 2131433804, 0).b(i);
      return;
    }
    if (AudioHelper.b(1))
    {
    ...
    try
    {
      PressToSpeakPanel.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelPressToSpeakPanel).setBackgroundResource(2130845690);
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        QLog.i("PressToSpeakPanel", 1, "onTouch setBackgroundResource error" + localThrowable.getMessage());
      }
    }
  }
}
