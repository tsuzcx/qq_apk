  ...
  extends bdtj
{
  ...
  public bdtg(String paramString)
  {
    this();
    this.ai = paramString;
  }
  
  public bdtg(String paramString1, String paramString2)
  {
    this(paramString1);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      ((TextView)paramContext.findViewById(2131380000)).setText(this.ai);
      ((TextView)paramContext.findViewById(2131380002)).setText(this.as);
      return paramContext;
    }
    paramView = new LinearLayout(paramContext);
    paramView.setOrientation(0);
    paramBundle = new TextView(paramContext);
    paramBundle.setId(2131380000);
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    this.as = bcsa.a(parambdqc.a("unit"), false);
