  ...
  extends MagicFaceDataEntity
{
  ...
  public lhk(VideoAppInterface paramVideoAppInterface, String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      ...
      if (paramVideoAppInterface.has("multiresult")) {
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataMultiResultJason = ((MagicfaceDataMultiResultJason)bgzr.a(paramVideoAppInterface.getJSONObject("multiresult"), MagicfaceDataMultiResultJason.class));
      }
      ...
      lbd.h("MagicFaceDataEntityMultiResult", "multi: " + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataMultiResultJason.toString());
      ...
      if (((paramBoolean) && (this.jdField_a_of_type_JavaUtilBitSet.get(1))) || ((!paramBoolean) && (this.jdField_a_of_type_JavaUtilBitSet.get(0))))
      {
        ...
        lbd.f("MagicFaceDataEntityMultiResult", "MagicFaceDataEntityMultiResult constructor:");
        return;
      }
    }
  ...
  {
    lbd.f("MagicFaceDataEntityMultiResult", " getResultString:" + paramInt2 + "|" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataMultiResultJason.divers_ani_start);
    switch (paramInt2)
    {
    default: 
      return "";
  ...
  private void a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      lbd.f("MagicFaceDataEntityMultiResult", "isShot:" + this.jdField_b_of_type_Int + "|" + this.d + "|" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataMultiResultJason.divers_ani_start + "|" + this.jdField_a_of_type_AndroidGraphicsRect.toString() + "|" + paramArrayOfByte.length);
    ...
    {
      lbd.f("MagicFaceDataEntityMultiResult", "onReceiveFaceFeature Kill is:|" + f1 + "|" + f2 + "|" + this.jdField_a_of_type_AndroidGraphicsRect.toString());
    ...
    label291:
    lbd.f("MagicFaceDataEntityMultiResult", "isShot ERROR");
  }
  ...
  protected String a()
  {
    ...
    {
      str = str;
      lbd.f("MagicFaceDataEntityMultiResult", "getMirrorPath:" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason.hasMirrorRes + "|" + this.jdField_a_of_type_Boolean + "|" + str);
      return str;
    }
  }
  ...
  public String a(int paramInt)
  {
    ...
    {
      int i = a();
      lbd.f("MagicFaceDataEntityMultiResult", " getResPath:" + paramInt + "|" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataMultiResultJason.divers_ani_start + "|" + i);
  ...
  public String a(MagicfaceDataPendantJason paramMagicfaceDataPendantJason)
  {
    ...
    lbd.f("MagicFaceDataEntityMultiResult", "getDecorateName :" + paramMagicfaceDataPendantJason.toString());
    String str1 = str2;
    if (!TextUtils.isEmpty(str2))
    {
      ...
      str1 = c();
      lbd.f("MagicFaceDataEntityMultiResult", "getDecorateName 2:" + paramMagicfaceDataPendantJason.trigger + "|" + str1);
    ...
    for (;;)
    {
      lbd.f("MagicFaceDataEntityMultiResult", "getDecorateName 3:" + str1);
      return str1;
      label137:
      str1 = null;
      continue;
  ...
  public void c()
  {
    ...
    lbd.f("MagicFaceDataEntityMultiResult", "processStart:" + this.jdField_a_of_type_JavaUtilBitSet.get(2));
