  ...
  extends WebViewPlugin
{
  ...
  private bgoz jdField_a_of_type_Bgoz;
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.CALL_PHONE") != 0) {
          ((AppActivity)localActivity).requestPermissions(new abbo(this), 1, new String[] { "android.permission.CALL_PHONE" });
        }
      }
      else {
        return;
  ...
  private void c()
  {
    bcst.b(null, "CliOper", "", "", "0X8004B43", "0X8004B43", 0, 0, "", "", "", "");
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.SEND_SMS") != 0) {
          ((AppActivity)localActivity).requestPermissions(new abbp(this), 1, new String[] { "android.permission.SEND_SMS" });
        }
      }
      else {
        return;
  ...
  private void e()
  {
    bcst.b(null, "CliOper", "", "", "0X8004B44", "0X8004B44", 0, 0, "", "", "", "");
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.WRITE_CONTACTS") != 0) {
          ((AppActivity)localActivity).requestPermissions(new abbq(this), 1, new String[] { "android.permission.WRITE_CONTACTS" });
        }
      }
      else {
        return;
  ...
  private void g()
  {
    ...
    if (this.jdField_a_of_type_Bgoz == null)
    {
      ...
      localbguh.a(1, localActivity.getString(2131698446));
      localbguh.a(2, localActivity.getString(2131698447));
      localbguh.a(String.format(localActivity.getString(2131698445), new Object[] { this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_Bgoz = bglp.a(localActivity, localbguh, new abbr(this));
      if (this.jdField_a_of_type_Bgoz != null) {}
    }
    else
    {
      this.jdField_a_of_type_Bgoz.setTitle(String.format(localActivity.getString(2131698445), new Object[] { this.jdField_a_of_type_JavaLangString }));
    }
    this.jdField_a_of_type_Bgoz.show();
  }
  ...
  private void i()
  {
    bcst.b(null, "CliOper", "", "", "0X8004B45", "0X8004B45", 0, 0, "", "", "", "");
    a("android.intent.action.INSERT", "vnd.android.cursor.dir/contact");
  }
  
  private void j()
  {
    bcst.b(null, "CliOper", "", "", "0X8004B46", "0X8004B46", 0, 0, "", "", "", "");
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bkho = bkho.a(this.mRuntime.a());
      this.jdField_a_of_type_Bkho.c(String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131691437), this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_Bkho.b(2131698448);
      this.jdField_a_of_type_Bkho.b(2131698445);
      this.jdField_a_of_type_Bkho.b(2131691140);
      this.jdField_a_of_type_Bkho.c(2131690582);
      this.jdField_a_of_type_Bkho.a(new abbn(this));
    }
    for (;;)
    {
      this.jdField_a_of_type_Bkho.show();
      return;
      this.jdField_a_of_type_Bkho.a(0, String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131691437), this.jdField_a_of_type_JavaLangString }));
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      if (((this.jdField_a_of_type_Bkho == null) || (!this.jdField_a_of_type_Bkho.isShowing())) && ((this.jdField_a_of_type_Bgoz == null) || (!this.jdField_a_of_type_Bgoz.isShowing())))
      {
