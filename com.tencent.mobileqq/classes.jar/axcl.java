  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg != null)
        {
          paramFromServiceMsg = (ClientOnlineNotfiyRsp)bgfv.a(ClientOnlineNotfiyRsp.class, paramFromServiceMsg.BusiBuff);
          if (paramFromServiceMsg != null)
          {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    byte[] arrayOfByte = bbdm.a(paramIntent);
    if (QLog.isDevelopLevel()) {
      QLog.d("NotifyQZoneServer", 4, "onSend lastPushMsgTime:" + l + ",attachinfo:" + paramIntent);
    }
    bgwv localbgwv = new bgwv(l, arrayOfByte);
    arrayOfByte = localbgwv.encode();
    paramIntent = arrayOfByte;
    if (arrayOfByte == null)
    {
      QLog.e("NotifyQZoneServer", 1, "onSend request encode result is null.cmd=" + localbgwv.uniKey());
      paramIntent = new byte[4];
    }
    paramPacket.setTimeout(30000L);
    paramPacket.setSSOCommand("SQQzoneSvc." + localbgwv.uniKey());
