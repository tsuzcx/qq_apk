...
public final class ruy
  implements Runnable
{
  public ruy(QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, Context paramContext, SessionInfo paramSessionInfo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new ruz(this, (MessageForMarketFace)localObject2, (EmoticonPackage)localObject1);
