...
public class rzf
  implements ComponentConstant.Event, qvs, ryu, ryx, rze
{
  private int a;
  ...
  public rzf(Activity paramActivity, ryt paramryt, VVideoView paramVVideoView)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a(paramryt);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a(this);
    this.jdField_a_of_type_Ryt = paramryt;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVVideoView = paramVVideoView;
    this.jdField_a_of_type_Ryt.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager);
    this.jdField_a_of_type_Ryt.setEventListener(this);
  ...
  public void a(VVideoView paramVVideoView, JSONObject paramJSONObject)
  {
    ...
    paramVVideoView = this.jdField_a_of_type_Ryt.a();
    try
    {
      paramVVideoView = new rzd(paramVVideoView, paramJSONObject);
      if (paramVVideoView != null)
      {
        ...
        if (paramVVideoView.b)
        {
          ...
          this.jdField_a_of_type_Ryt.a(paramVVideoView);
        }
      }
      else
      {
  ...
  {
    boolean bool = false;
    this.jdField_a_of_type_Ryt.a(0, paramBoolean);
    try
    {
      paramVVideoView = new JSONObject();
      paramBoolean = bool;
  ...
  public void a(rzd paramrzd, long paramLong)
  {
    ...
    {
      paramrzd = new JSONObject();
      paramrzd.put("currentTime", a(paramLong));
      paramrzd.put("totalTime", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a() / 1000L);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVVideoView.a("playTimeChange", paramrzd);
      return;
    }
    catch (Exception paramrzd)
    {
      paramrzd.printStackTrace();
    }
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Ryt.a();
  }
  ...
  public void b(VVideoView paramVVideoView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Ryt.setControlType(this.jdField_a_of_type_Int);
  }
  ...
  {
    boolean bool = true;
    this.jdField_a_of_type_Ryt.a(1);
    try
    {
      paramVVideoView = new JSONObject();
      if (this.jdField_a_of_type_Int == 2) {}
  ...
  {
    this.jdField_a_of_type_Ryt.setFullScreenDisable(paramBoolean);
  }
  ...
  {
    this.jdField_a_of_type_Ryt.setEndWithLastFrame(paramBoolean);
  }
