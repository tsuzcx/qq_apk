...
public class agfx
  extends bhll
  implements bhoe, bhox, bhst, bhsx
{
  protected abcr a;
  private agfu a;
  
  public agfx(Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
    super(paramContext, paramActivity, paramAppInterface);
    super.preInitPluginEngine();
    this.mWebview = new TouchWebView(paramContext);
    buildBaseWebView(this.mInterface);
    this.jdField_a_of_type_Agfu = new agfu(paramActivity, this.mWebview);
  }
  ...
  protected abcr a()
  {
    ...
    {
      this.jdField_a_of_type_Abcr = new abcr(this.mInterface, this.mInActivity);
      this.jdField_a_of_type_Abcr.a(this);
    }
    return this.jdField_a_of_type_Abcr;
  }
  ...
  public void bindJavaScript(ArrayList<WebViewPlugin> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      paramArrayList.add(new abcx());
      paramArrayList.add(new obg());
    }
  }
  ...
  {
    this.jdField_a_of_type_Agfu.a(a());
  }
