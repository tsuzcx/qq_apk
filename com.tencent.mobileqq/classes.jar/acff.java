  ...
  extends acew
{
  ...
  {
    MessageForShortVideo localMessageForShortVideo = (MessageForShortVideo)bbli.a(-2022);
    ...
    for (localMessageForShortVideo.msg = ShortVideoConstants.MESSAGE_FOR_SHORT_VIDEO_PTV;; localMessageForShortVideo.msg = ShortVideoConstants.MESSAGEFORSHORTVIDEO_MSG)
    {
      ...
      try
      {
        ...
        ((amoa)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(53)).a(arrayOfByte);
      }
      ...
      if (localMessageForShortVideo.redBagType == LocalMediaInfo.REDBAG_TYPE_GET)
      {
        ...
        bbwb.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), false);
