...
public class aktg
{
  ...
  public static ResourceInfo a(String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    String str = aksg.a(paramString, paramInt2);
  ...
  public static List<akth> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (str.startsWith("url_last_use_time")) {
          localArrayList.add(new akth(str.substring("url_last_use_time".length(), str.length()), ((Long)localEntry.getValue()).longValue(), paramInt));
        }
      }
    }
  ...
  public static void a(int paramInt, PreloadConfig paramPreloadConfig)
  {
    ...
    return;
    Object localObject = aksg.a(paramInt);
    long l2 = System.currentTimeMillis();
    long l3 = bgmg.b((String)localObject);
    ...
    if (l3 > 209715200L)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        akth localakth = (akth)((Iterator)localObject).next();
        if ((localakth != null) && (!TextUtils.isEmpty(localakth.jdField_a_of_type_JavaLangString)) && (l1 - localakth.jdField_a_of_type_Long > 2592000000L) && (!paramPreloadConfig.isUrlInConfig(localakth.jdField_a_of_type_JavaLangString)))
        {
          ResourceInfo localResourceInfo = a(localakth.jdField_a_of_type_JavaLangString, false, 0, localakth.jdField_a_of_type_Int);
          if (localResourceInfo != null)
          {
            b(localakth.jdField_a_of_type_JavaLangString, localakth.jdField_a_of_type_Int);
            akww.a(localResourceInfo.filePath);
            akww.a(localResourceInfo.folderPath);
            aktf.a(localakth.jdField_a_of_type_JavaLangString, 8, localakth.jdField_a_of_type_Int);
          }
        }
      }
    }
