  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  public bfek(@NonNull Context paramContext)
  {
  ...
  public void a(int paramInt1, int paramInt2, bfem parambfem)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTimePicker.setOnTimeChangedListener(new bfel(this));
    this.jdField_a_of_type_Bfem = parambfem;
  }
  ...
  {
    if (this.jdField_a_of_type_Bfem != null) {
      this.jdField_a_of_type_Bfem.onTimeCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bfem != null)
    {
      ...
      this.jdField_a_of_type_Bfem.onTimeConfirm(paramView, (String)localObject);
    }
    a();
  }
}
