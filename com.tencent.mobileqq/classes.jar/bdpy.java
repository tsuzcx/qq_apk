  ...
  extends bdol
{
  ...
  public bdpy(String paramString)
  {
    this(paramString, "tag");
  }
  
  public bdpy(String paramString1, String paramString2)
  {
    this.a = paramString2;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramBundle = (URLImageView)paramView.findViewById(2131368523);
      paramContext = (TextView)paramView.findViewById(2131380118);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = new ColorDrawable(2131167247);
        ...
        catch (Exception paramBundle)
        {
          try
          {
            for (;;)
            {
              ...
              paramView.setMinimumHeight(agej.a(14.0F, (Resources)localObject));
              paramView.setLayoutParams(new LinearLayout.LayoutParams(-2, -1));
              paramView.setGravity(16);
              paramView.setPadding(agej.a(5.0F, (Resources)localObject), agej.a(2.0F, (Resources)localObject), agej.a(5.0F, (Resources)localObject), agej.a(2.0F, (Resources)localObject));
              paramBundle = new URLImageView(paramContext);
              paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
              LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(agej.a(9.0F, (Resources)localObject), agej.a(9.0F, (Resources)localObject));
              paramBundle.setId(2131368523);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.ag = bcsa.a(paramObjectInput.readUTF(), false);
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    {
      return true;
      this.ae = parambdqc.a("color");
      this.af = parambdqc.a("style");
      this.ag = parambdqc.a("size");
      this.ah = bcsa.a(bdow.a(parambdqc), false);
      this.ac = parambdqc.a("bgColor");
      this.ad = parambdqc.a("icon");
      parambdqc = parambdqc.a("radius");
      try
      {
        this.p = Integer.valueOf(parambdqc).intValue();
        return true;
      }
      catch (NumberFormatException parambdqc) {}
    } while (!QLog.isColorLevel());
    QLog.e("Q..troop.faceScore.StructMsgItemTag", 2, "StructMsgItemTag fromXml radius is not a integer value.", parambdqc);
    return true;
  }
