  ...
  extends bdmk
{
  ...
  public bdpy(String paramString, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
    super(paramString, paramMiniAppBaseInfo);
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public static bdpy a(String paramString1, String paramString2, MiniAppInfo paramMiniAppInfo)
  {
    if ((TextUtils.isEmpty(paramString1)) || (!new File(paramString1).exists())) {
      return null;
    }
    paramString1 = new bdpy(paramString1, paramMiniAppInfo);
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        this.b = bdgo.b(new File(e() + "/" + paramString, "game.json"));
      ...
      this.b = bdgo.b(new File(e(), "game.json"));
    }
  }
  
  public void a(String paramString, bdpx parambdpx)
  {
    bdpp.a(bdlx.a().a(), this, paramString, parambdpx);
  }
