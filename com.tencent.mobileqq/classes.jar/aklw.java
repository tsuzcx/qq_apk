...
public class aklw
  implements akww, View.OnClickListener
{
  private aklw(FriendCardApolloViewController paramFriendCardApolloViewController) {}
  ...
  public void a()
  {
    ...
    if ((localObject2 != null) && (((awmk)localObject2).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne != null)) {}
    for (localObject1 = ((awmk)localObject2).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a;; localObject1 = null)
    {
      if ((TextUtils.isEmpty((CharSequence)localObject1)) && (localObject2 != null) && (((awmk)localObject2).jdField_a_of_type_ComTencentMobileqqDataCard != null)) {}
      for (localObject2 = ((awmk)localObject2).jdField_a_of_type_ComTencentMobileqqDataCard.uin;; localObject2 = localObject1)
      {
        akji localakji = (akji)localQQAppInterface.getManager(153);
        localObject1 = localObject3;
        if (!FriendCardApolloViewController.a(this.a)) {
          localObject1 = localakji.a(localQQAppInterface, (String)localObject2, new int[] { 4 });
        }
        int i = 5;
        ...
        for (;;)
        {
          akwt.a(FriendCardApolloViewController.a(this.a), i, (ApolloActionData)localObject1);
          new akoz((String)localObject2).a(FriendCardApolloViewController.a(this.a), localFriendProfileCardActivity, localQQAppInterface, alpo.a(2131705244));
          return;
          i = 12;
        }
      }
