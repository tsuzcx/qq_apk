...
public abstract class apro
{
  public static final String a;
  public static final String b = asoa.jdField_a_of_type_JavaLangString + "file/";
  protected QQAppInterface a;
  
  static
  {
    jdField_a_of_type_JavaLangString = asoa.jdField_a_of_type_JavaLangString + "fileThumb/";
  }
  ...
  protected MsgBackupResEntity a(MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    ...
    asog.a(paramMessageRecord, localMsgBackupResEntity);
    localMsgBackupResEntity.extraDataStr = a(apue.a((ChatMessage)paramMessageRecord), paramInt);
    ...
    if (bbdj.b(paramString)) {
      localMsgBackupResEntity.fileSize = bbdj.a(paramString);
    }
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if ((!TextUtils.isEmpty(paramMsgBackupResEntity)) && (!TextUtils.isEmpty(str)) && (paramMsgBackupResEntity.equals(str)))
      {
        if (QLog.isDebugVersion()) {
          QLog.i("FileMsgBackupHandler<QFile>", 1, "isResourceRelateToMsg: multi msg match res. fileId[" + str + "] " + apvk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
        }
        return true;
      }
      return false;
