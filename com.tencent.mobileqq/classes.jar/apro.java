...
public class apro
{
  ...
  public static String m = aljq.cu + "[epId]" + File.separator;
  public static String n = aljq.bS + "[epId]" + File.separator;
  ...
  public static aube a()
  {
    try
    {
      AppInterface localAppInterface = (AppInterface)BaseApplicationImpl.getApplication().getRuntime();
      if (localAppInterface != null) {
        return (aube)localAppInterface.getManager(14);
      }
    }
  ...
  public static List<apsm> a(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    paramQQAppInterface.add(new apsm(7, 7, null));
    paramQQAppInterface.add(new apsm(4, 4, null));
    paramQQAppInterface.add(new apsm(11, 4, null));
    return paramQQAppInterface;
  }
  
  public static List<apsm> a(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    List localList2 = Collections.synchronizedList(new ArrayList());
    Object localObject = (aube)paramQQAppInterface.getManager(14);
    List localList1 = ((aube)localObject).a(paramInt);
    localList2.add(new apsm(7, 7, null));
    if (paramInt == 0)
    {
      localList2.add(new apsm(4, 4, null));
      paramQQAppInterface = (apjf)paramQQAppInterface.getManager(334);
      if ((paramQQAppInterface != null) && (paramQQAppInterface.c())) {
        localList2.add(new apsm(11, 4, null));
      }
    }
    paramQQAppInterface = ((aube)localObject).a(false, paramInt, paramBoolean);
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0)) {
      localList2.add(new apsm(8, 3, null));
    }
    if (localList1 != null)
    {
      ...
      if (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.type != 1) && (3 != localEmoticonPackage.jobType) && (1 != localEmoticonPackage.jobType) && (5 != localEmoticonPackage.jobType))
        {
          ...
          {
            paramQQAppInterface = new apsm(10, 7, localEmoticonPackage);
            i1 = paramInt;
        ...
        {
          aprl.a(paramQQAppInterface, bool);
          paramInt = i1;
          break;
          ...
          paramQQAppInterface = new apsm(6, 4, localEmoticonPackage);
          break label260;
          ...
          localList2.add(new apsm(9, 4, localEmoticonPackage));
          i1 = 1;
          break label277;
        }
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt)
  {
    ...
    {
      paramQQAppInterface = (apnf)paramQQAppInterface.getManager(43);
  ...
  public static void a(bain[] paramArrayOfbain, float paramFloat1, float paramFloat2, boolean paramBoolean1, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Activity paramActivity, boolean paramBoolean2)
  {
    if ((paramArrayOfbain == null) || (paramQQAppInterface == null) || (paramSessionInfo == null) || (paramActivity == null)) {}
    Object localObject1;
    int i2;
    do
    {
      ...
      i2 = paramInt1;
      paramInt1 = i1;
      while (paramInt1 < paramArrayOfbain.length)
      {
        Object localObject2 = paramArrayOfbain[paramInt1];
        boolean bool = paramBoolean1;
        int i3 = i2;
        i1 = paramInt2;
        if ((localObject2 instanceof baip))
        {
          localObject2 = (baip)localObject2;
          float f1 = ((baip)localObject2).a;
          float f2 = ((baip)localObject2).b;
          float f3 = ((baip)localObject2).c;
          float f4 = ((baip)localObject2).d;
          int i4 = ((baip)localObject2).e;
          int i5 = ((baip)localObject2).f;
    ...
    {
      ((aube)paramQQAppInterface.getManager(14)).b(String.valueOf(i2), 0, new aprp(paramSessionInfo, paramQQAppInterface, i2, paramActivity));
      return;
    }
    paramSessionInfo = ((TreeSet)localObject1).iterator();
    for (paramArrayOfbain = ""; paramSessionInfo.hasNext(); paramArrayOfbain = paramArrayOfbain + localObject1 + ",") {
      localObject1 = (Integer)paramSessionInfo.next();
    }
    paramSessionInfo = paramArrayOfbain;
    if (!paramArrayOfbain.equals("")) {
      paramSessionInfo = paramArrayOfbain.substring(0, paramArrayOfbain.length() - 1);
    }
    EmojiHomeUiPlugin.openSmallEmojiListPage(paramActivity, paramQQAppInterface.getAccount(), 11, paramSessionInfo);
    azmj.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X8007000", 0, 0, String.valueOf(i2), String.valueOf(paramInt2), "", "");
  }
  ...
  public static List<apsm> b(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    paramQQAppInterface.add(new apsm(7, 7, null));
    return paramQQAppInterface;
  ...
  {
    return bdee.a(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean c()
  {
    ...
    int i1 = bdee.a(localBaseApplication);
    boolean bool = SettingCloneUtil.readValue(localBaseApplication, null, localBaseApplication.getString(2131695480), "qqsetting_auto_receive_magic_face_key", true);
