  ...
  implements ActionMode.Callback
{
  ...
  public afoa(OCRRecognitionResultActivity paramOCRRecognitionResultActivity, TextView paramTextView)
  {
  ...
  {
    if (paramMenuItem.getItemId() == 2131375384)
    {
      paramActionMode = a();
    ...
    while (paramMenuItem.getItemId() != 2131375385)
    {
      return false;
