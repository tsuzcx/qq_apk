  ...
  extends bfyi
{
  ...
  public bghh(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, TroopChatPie paramTroopChatPie)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(agej.a(9.0F, paramBaseActivity.getActivity().getResources()), agej.a(9.0F, paramBaseActivity.getActivity().getResources()));
    localLayoutParams.addRule(7, 2131376741);
    localLayoutParams.addRule(6, 2131376741);
    localLayoutParams.rightMargin = agej.a(4.0F, paramBaseActivity.getActivity().getResources());
    localLayoutParams.topMargin = agej.a(11.0F, paramBaseActivity.getActivity().getResources());
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig)
  {
    ...
    if (i != j)
    {
      paramConfig = arry.a(paramConfig);
      ...
      if ((paramConfig != null) && (paramConfig.size() > 0))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramConfig.has("keywordConfigs"))
            {
              ...
              ((bgqd)paramQQAppInterface.getManager(262)).a((String)localObject);
            }
        ...
        localObject = (bfyj)paramQQAppInterface.getManager(289);
        if ((((bfyj)localObject).a instanceof bghh))
        {
          ((bghh)((bfyj)localObject).a).a(l2);
          ((bghh)((bfyj)localObject).a).d();
        }
        ((bgqm)paramQQAppInterface.getManager(109)).a(paramConfig);
        localEditor.apply();
  ...
  {
    bhju.a(paramQQAppInterface, paramString, "homework", "AioAssign_Show", 0, 0, new String[] { paramString, "", "", bhju.a(paramQQAppInterface, paramString) });
    bhju.a(paramQQAppInterface, paramString, "Grp_notice", "CreateNotice_Show", 0, 0, new String[] { paramString, "", "", "" });
  }
  
  private boolean a()
  {
    arfc localarfc = arfd.a();
    return (localarfc != null) && (localarfc.g());
  }
  ...
  {
    if ((paramTroopChatPie.jdField_a_of_type_Aivk != null) && (paramTroopChatPie.jdField_a_of_type_Aivk.a(paramTroopChatPie.a()))) {}
    do
    {
      do
      {
        return;
        if (!((awpf)paramTroopChatPie.a(33)).c()) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("HomeworkTroopController", 2, "showHomeworkTroopIdentityAIOTip. isListenTogetherTime");
      return;
      if (!((aiwa)paramTroopChatPie.a(75)).d()) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramTroopChatPie.jdField_a_of_type_Aivk == null) {
        paramTroopChatPie.jdField_a_of_type_Aivk = new aivk(paramTroopChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
      paramTroopChatPie.jdField_a_of_type_Aivk.a(paramTroopChatPie.a(), true);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, bgpm parambgpm, TroopChatPie paramTroopChatPie)
  {
    ...
    if ((localTroopInfo != null) && (localTroopInfo.isHomeworkTroop())) {
      if (parambgpm != null) {
        bgpk.a(paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), parambgpm, paramBoolean);
      }
    }
    while (!QLog.isColorLevel())
    {
      return;
      if (this.jdField_a_of_type_Bgpm == null) {
        this.jdField_a_of_type_Bgpm = new bghl(this, paramTroopChatPie);
      }
      bgpk.a(paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Bgpm, paramBoolean);
      return;
    }
  ...
  {
    a(paramBoolean, new bghk(this), paramTroopChatPie);
  }
  ...
  public void a(boolean paramBoolean1, TroopChatPie paramTroopChatPie, boolean paramBoolean2)
  {
    ...
    {
      if (paramTroopChatPie.jdField_a_of_type_Aivk != null) {
        paramTroopChatPie.jdField_a_of_type_Aivk.a(paramTroopChatPie.a(), false);
      }
      e(false);
      b(false);
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramBoolean = bgpk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_homework");
      if (QLog.isColorLevel()) {
      ...
      {
        a(1, 500L);
        bgpk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_homework", true);
        return;
      }
      paramBoolean = bgpk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_notification");
      if (QLog.isColorLevel()) {
    ...
    a(2, 500L);
    bgpk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_notification", true);
    return;
    label238:
    a();
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Blrr != null) && (this.jdField_a_of_type_Blrr.isShowing()) && (this.jdField_a_of_type_Int > 0)) {
  ...
  public void c(TroopChatPie paramTroopChatPie)
  {
    ...
    {
      localaguv = (aguv)paramTroopChatPie.a(73);
      if ((localaguv != null) && ((localaguv.a == null) || (!localaguv.a.a(paramTroopChatPie.a())))) {
        break label40;
      }
    }
    label40:
    ...
    {
      return;
      awpf localawpf = (awpf)paramTroopChatPie.a(33);
      if ((localawpf == null) || (!localawpf.c())) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    if (localaguv.a == null) {
      localaguv.a = new aivh(paramTroopChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    }
    localaguv.a.a(paramTroopChatPie.a(), true);
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B27F", "0X800B27F", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "", "");
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      ...
      if (!bool)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bghi(this));
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843741);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      bhju.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework", "AioSee_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "", bhju.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a) });
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean) && (!bool))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetRedDotAnimateView.getVisibility() != 0) {
        bhju.a("Grp_edu", "homework", "AioSee_Reddot_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a });
      }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      int i = bgpk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
      if (QLog.isColorLevel()) {
