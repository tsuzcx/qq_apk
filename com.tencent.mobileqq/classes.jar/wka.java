  ...
  implements wja
{
  ...
  aofu jdField_a_of_type_Aofu = new wkb(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = wzk.b;
  }
      ...
      if (localIterator.hasNext())
      {
        ...
        else
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_Aoep.a(str1, localTroopInfo.troopcode, (ArrayList)localObject1);
            localObject1 = new ArrayList(20);
            i = 1;
          }
        }
