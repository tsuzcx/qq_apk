  ...
  implements mwt, mwu
{
  ...
  public lbt(VideoController paramVideoController)
  {
  ...
  private void e()
  {
    ...
    {
      return;
      locallcu = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a();
    } while (locallcu == null);
    locallcu.a();
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Lkw != null) {
      abdm.a(null, "Usr_TV_Video", 4, 0, 0);
    }
  }
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    lcs.a(paramArrayOfByte);
    if (this.jdField_a_of_type_Lkw == null)
    {
      bcef.b(null, "CliOper", "", "", "0X80088AE", "0X80088AE", 0, 0, "", "", "", "");
      a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), paramLong, paramArrayOfByte);
      return;
    }
    this.jdField_a_of_type_Lkw.b(paramArrayOfByte, paramLong);
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_Lkw == null) {
      abdm.a(null, "Usr_TV_Video", 2, 0, 0);
    }
    d();
    if (QLog.isColorLevel()) {
  ...
  void a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QavNetChannel", 2, "sendSharpMsg selfUin: " + paramString + ", toUin: " + mrb.a(paramLong) + ", uinType = " + locallez.j);
    }
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), lcx.class);
    if (locallez.j == 25) {
    ...
    for (;;)
    {
      bcef.b(null, "CliOper", "", "", "0X80088AF", "0X80088AF", 0, 0, "", "", "", "");
      localNewIntent.putExtra("selfuin", mrb.a(paramString));
  ...
  void a(String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    localNewIntent.putExtra("toUin", lcs.a(paramString2));
    localNewIntent.putExtra("vMsg", paramArrayOfByte);
    a(localNewIntent);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Lkw != null;
  }
  ...
  public void b(byte[] paramArrayOfByte)
  {
    ...
    lez locallez = lbu.a().a();
    a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), locallez.d, paramArrayOfByte);
  }
  ...
  public void c(Bundle paramBundle)
  {
    ...
    paramBundle = paramBundle.getByteArray("buffer");
    this.jdField_a_of_type_ComTencentAvVideoController.I();
  ...
  public void d()
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Lkw != null);
      this.jdField_a_of_type_Lkw = new lkw(this, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      lbu.a().a().j = 9500;
    } while (!QLog.isColorLevel());
