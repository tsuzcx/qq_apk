  ...
  extends WebViewPlugin
{
  ...
  private aqsq jdField_a_of_type_Aqsq;
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aqsq != null))
    {
      Context localContext = a();
      if (localContext != null) {
        localContext.getContentResolver().unregisterContentObserver(this.jdField_a_of_type_Aqsq);
      }
    }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_Aqsp == null) {
            this.jdField_a_of_type_Aqsp = new aqsp(this);
          }
          if (this.jdField_a_of_type_Aqsq == null) {
            this.jdField_a_of_type_Aqsq = new aqsq(this.jdField_a_of_type_Aqsp, (Context)localObject, paramString, str);
          }
          this.jdField_a_of_type_Boolean = true;
          ((Context)localObject).getContentResolver().registerContentObserver(Uri.parse("content://sms/"), true, this.jdField_a_of_type_Aqsq);
          this.jdField_a_of_type_Aqsp.removeMessages(2);
          this.jdField_a_of_type_Aqsp.sendEmptyMessageDelayed(2, i * 1000);
          return;
        }
      }
      ...
      if (this.jdField_a_of_type_Aqsq != null) {
        this.jdField_a_of_type_Aqsq.a(paramString, str);
      }
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Aqsq != null)
    {
      this.jdField_a_of_type_Aqsq.a();
      this.jdField_a_of_type_Aqsq = null;
    }
    if (this.jdField_a_of_type_Aqsp != null)
    {
      this.jdField_a_of_type_Aqsp.a();
