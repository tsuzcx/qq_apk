...
public class avvd
  extends RecyclerView.Adapter<avve>
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  public avvd(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView)
  {
  ...
  private void a(avve paramavve, int paramInt, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if ((localRecentBaseData instanceof MsgBackupMsgUserData))
    {
      ...
      if (this.jdField_a_of_type_Aklg != null) {
        paramDrawable = this.jdField_a_of_type_Aklg.a(localRecentBaseData);
      }
      if (!a(localRecentBaseData)) {
        break label233;
      }
      localQQAppInterface = ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app;
      int j = ((Integer)aklg.a(localQQAppInterface, localRecentBaseData.getRecentUserType(), localRecentBaseData.getRecentUserUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      RecentDynamicAvatarView localRecentDynamicAvatarView = paramavve.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramavve.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
      paramavve.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(localRecentBaseData.mTitleName);
      avve.a(paramavve).setChecked(((Boolean)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(paramInt)).booleanValue());
      if (AppSetting.c) {
        paramavve.jdField_a_of_type_AndroidViewView.setContentDescription(localMsgBackupMsgUserData.name);
      }
      return;
      label224:
      break;
  ...
  private void b(avve paramavve, int paramInt, Drawable paramDrawable)
  {
    ...
    } while ((paramavve == null) || (localRecentBaseData == null));
    Drawable localDrawable = paramDrawable;
    if (paramDrawable == null)
    {
      int i = localRecentBaseData.getRecentUserType();
      localDrawable = this.jdField_a_of_type_Aklg.a(i, localRecentBaseData.getRecentUserUin());
    }
    a(paramavve, paramInt, localDrawable);
  }
  
  public avve a(ViewGroup paramViewGroup, int paramInt)
  {
    return new avve(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562695, paramViewGroup, false), this.jdField_a_of_type_Avvf);
  }
  ...
  public void a(avve paramavve, int paramInt)
  {
    a(paramavve, paramInt, null);
    EventCollector.getInstance().onRecyclerBindViewHolder(paramavve, paramInt, getItemId(paramInt));
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        paramBitmap = (avve)this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildViewHolder(paramBitmap);
        ...
        j = ((Integer)aklg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, j, ((RecentBaseData)localObject).getRecentUserUin()).first).intValue();
        if (j == -2147483648) {
          break label438;
        }
