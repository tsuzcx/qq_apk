...
{
  public aaep(TroopMemberApiService paramTroopMemberApiService) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1003: 
      do
      {
        ...
        paramMessage = (axqt)((QQAppInterface)TroopMemberApiService.k(this.a)).getBusinessHandler(BusinessHandlerFactory.NEARBY_CARD_HANDLER);
        ...
        if (localFileMsg.fileType == 39)
        {
          ...
          axqn.a((QQAppInterface)TroopMemberApiService.l(this.a), this.a.jdField_a_of_type_JavaLangString);
          return;
        }
