...
public class amiv
{
  ...
  public static amjh a(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static List<ColorNote> a(int paramInt)
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        if (amhi.a(localColorNote, (ColorNote)localIterator2.next())) {
  ...
  public static void a(ColorNote paramColorNote)
  {
    ...
    localamgp.a(paramColorNote.getServiceType(), paramColorNote.getSubType(), 2);
    localamgp.a(new amiw(localamgp, paramColorNote));
  ...
  private static void a(List<ColorNote> paramList)
  {
    if ((paramList != null) && (paramList.size() >= 20))
    {
      ...
      while (i < paramList.size())
      {
        ...
        localamgp.a(localColorNote.getServiceType(), localColorNote.getSubType(), 2);
        i += 1;
      }
    }
  }
