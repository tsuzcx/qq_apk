  ...
  implements Handler.Callback
{
  ...
  public aloa(ChatXListView paramChatXListView)
  {
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView = paramChatXListView;
    this.jdField_a_of_type_Int = ViewConfiguration.get(paramChatXListView.getContext()).getScaledTouchSlop();
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramChatXListView.getContext(), new benn());
  ...
  {
    float f1 = 0.0F;
    float f2 = (Math.abs(paramFloat) - (BaseChatItemLayout.U + BaseChatItemLayout.V)) / aciy.a(20.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
    if (f2 < 0.0F) {}
    for (;;)
    {
  ...
  private int a()
  {
    return aciy.a(59.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private int a(ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        paramChatMessage = new axkd(((MessageForText)paramChatMessage).sb, 8);
        if ((paramChatMessage.a != null) && (paramChatMessage.a.length > 0))
        {
          ...
          while (i < j)
          {
            if ((paramChatMessage[i] instanceof axkl)) {
              return 7;
            }
            i += 1;
          }
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    ...
    if ((f1 > this.jdField_a_of_type_Int) || (paramFloat2 > this.jdField_a_of_type_Int))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter() instanceof bejx))
      {
        ListAdapter localListAdapter = ((bejx)this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter()).getWrappedAdapter();
        if ((localListAdapter instanceof acka)) {
          ((acka)localListAdapter).d();
        }
      }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt >= a())
    {
      ...
      {
        bool = azyg.b(BaseApplicationImpl.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_e_of_type_Boolean) {
      if (paramInt >= i)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new alob(this));
  ...
  private void a(View paramView1, View paramView2)
  {
    ...
    for (int i = paramView1.getScrollX();; i = 0)
    {
      if (i != 0)
      {
        ...
        if ((i >= j) && (!this.jdField_c_of_type_Boolean)) {
          b();
        }
      }
      if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    if (!b())
    {
      ...
      if (localObject != null)
      {
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A92F", "0X800A92F", a((ChatMessage)localObject), b((ChatMessage)localObject), "", "", "", "");
        ...
        if ((localObject instanceof MessageForStructing))
        {
          ...
          if ((((MessageForStructing)localObject).structingMsg != null) && (((MessageForStructing)localObject).structingMsg.mMsgServiceID == 81) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
            urp.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, (MessageForStructing)localObject, "reply");
          }
        }
      }
    }
  ...
  private boolean b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) && (((azjh)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true).jdField_a_of_type_Boolean))
    {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131631942, 0).b(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getContext().getResources().getDimensionPixelSize(2131167766));
      return true;
    }
    return false;
  }
  ...
  private int c()
  {
    return aciy.a(89.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private boolean c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aloc != null) && (aloc.a(this.jdField_a_of_type_Aloc, localChatMessage))) {
        return aloc.b(this.jdField_a_of_type_Aloc, localChatMessage);
      }
  ...
  private boolean d()
  {
    if (this.f == 0)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager.a() == a()) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager.b())) {
        this.f = 2;
      }
    }
    return this.f == 2;
  ...
  public void a(View paramView)
  {
    ...
    {
      paramView = (acju)paramView.getTag();
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramBaseChatPie instanceof aedo)) || ((paramBaseChatPie instanceof aejb)) || ((paramBaseChatPie instanceof aede))) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
        this.jdField_a_of_type_Aloc = new aloc(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null);
      }
      return;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("hidePanelFromGesture", 2, "mSlideStartDir : " + this.jdField_a_of_type_Byte + ", forceCloseSoftInput: " + this.jdField_a_of_type_Boolean);
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    boolean bool1;
    if ((this.jdField_c_of_type_Boolean) && (paramMotionEvent.getAction() != 1) && (paramMotionEvent.getAction() != 3)) {
      bool1 = true;
    }
    do
    {
      do
      {
        ...
        do
        {
          ...
          case 0: 
            ...
            this.jdField_e_of_type_Boolean = false;
            if (k < this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getWidth() - BaseChatItemLayout.i - aciy.a(5.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getContext().getResources()) - BaseChatItemLayout.Q) {}
            for (;;)
            {
              bool1 = bool2;
              if (i == 0) {
              ...
              this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131298575);
              return false;
              i = 0;
            }
          case 2: 
  ...
  public boolean b(MotionEvent paramMotionEvent)
  {
    ...
    int i;
    int j;
    if ((this.jdField_b_of_type_Boolean) && (!BaseChatItemLayout.jdField_a_of_type_Boolean))
    {
