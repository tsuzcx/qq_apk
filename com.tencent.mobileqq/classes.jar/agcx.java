...
{
  public agcx(PhotoPreviewActivity paramPhotoPreviewActivity) {}
    ...
    if (PhotoPreviewActivity.d(this.a))
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          awqx.b(null, "CliOper", "", "", "0X800A6DB", "0X800A6DB", 0, 0, String.valueOf(this.a.jdField_b_of_type_JavaUtilArrayList.size()), "", "", "");
        }
      }
    }
    if (this.a.G)
    {
      AIOLongShotHelper.a(this.a, (String)this.a.jdField_b_of_type_JavaUtilArrayList.get(0), new agcy(this));
    ...
    if (this.a.getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      if (this.a.jdField_b_of_type_JavaUtilArrayList.size() == 0)
      {
        ...
        if (i < this.a.jdField_a_of_type_JavaUtilArrayList.size()) {
          bace.a((String)this.a.jdField_a_of_type_JavaUtilArrayList.get(i));
        }
      }
      if (apck.a()) {
        apbx.a(this.a, 2131627035, 2131627040, new agcz(this));
      }
    }
    for (;;)
    {
