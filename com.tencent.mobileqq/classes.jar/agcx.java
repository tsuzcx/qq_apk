...
{
  agcx(agch paramagch, String paramString) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    paramDialogInterface.dismiss();
    paramDialogInterface = new Intent(this.jdField_a_of_type_Agch.a, SearchContactsActivity.class);
    ...
    this.jdField_a_of_type_Agch.a.startActivity(paramDialogInterface);
  }
}
