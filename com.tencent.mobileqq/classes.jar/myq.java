  ...
  implements Application.ActivityLifecycleCallbacks
{
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FloatWindowController", 2, "onActivityResumed: " + paramActivity.getClass().getName() + " mHoldByPermission: " + this.a.b + " mIsFloatWindowShowing: " + myl.b(this.a) + " mIgnoreByOpenSdkForeGround: " + myl.c(this.a));
    }
    if ((this.a.b) && (!myl.b(this.a)))
    {
