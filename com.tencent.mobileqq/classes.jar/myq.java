...
public class myq
  extends mwx
{
  private static myq jdField_a_of_type_Myq;
  ...
  {
    paramString = aqnx.a().a(paramString);
  ...
  {
    List localList = aqnx.a().a(paramInt);
  ...
  private String a(mxq parammxq, String paramString)
  {
    if (("over".equals(paramString)) || (parammxq == null) || (parammxq.b() != 3))
    {
    ...
    parammxq = ((myl)parammxq).a(i);
    if (parammxq == null)
    {
      QLog.d("AvGameMusicPlayer", 1, "isVideoEffectValid() res is null ");
      return null;
    }
    parammxq = myv.a(parammxq.b(), ".mp3");
    if (!bgmg.a(parammxq))
    {
      QLog.d("AvGameMusicPlayer", 1, String.format("isVideoEffectValid() effectFile is not exist [effectFile] %s ", new Object[] { parammxq }));
      return null;
    }
    return parammxq;
  }
  ...
  public static myq a()
  {
    if (jdField_a_of_type_Myq == null) {}
    try
    {
      if (jdField_a_of_type_Myq == null) {
        jdField_a_of_type_Myq = new myq();
      }
      return jdField_a_of_type_Myq;
    }
    finally {}
  }
  ...
  private boolean a(int paramInt1, String paramString, int paramInt2, float paramFloat)
  {
    ...
    try
    {
      ...
      {
        bool1 = bool3;
        bool3 = mvy.a().a(paramInt1);
        bool1 = bool3;
        mvy.a().a(paramString, 1, paramFloat, paramInt2);
        bool2 = bool3;
        bool1 = bool3;
  ...
  private void e()
  {
    ...
    ndt.b().a(this);
    this.jdField_a_of_type_JavaLangString = myr.b();
  ...
  public void a(String paramString, boolean paramBoolean, float paramFloat)
  {
    ...
    {
      bcst.b(null, "dc00898", "", "", paramString, str, mxl.a().a().d(), 0, "", "", "", "");
      return;
      i = 1;
      break label86;
      break;
  ...
  public void a(mxq parammxq, String paramString)
  {
    String str = a(parammxq, paramString);
    parammxq = str;
    if (TextUtils.isEmpty(str)) {
      parammxq = this.jdField_a_of_type_JavaLangString + paramString + ".mp3";
    }
    b(parammxq, false, 0.5F);
  }
