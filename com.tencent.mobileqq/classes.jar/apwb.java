  ...
  extends aksv
{
  ...
  public apwb(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
  }
  
  private void a(UniformDownloadBPTransEntity paramUniformDownloadBPTransEntity, akte paramakte)
  {
    ...
    if (localUniformDownloadBPTransEntity.getStatus() == 1000) {
      paramakte.a(localUniformDownloadBPTransEntity);
    }
    for (;;)
    {
      paramakte.a();
  ...
  private UniformDownloadBPTransEntity b(String paramString)
  {
    ...
    localObject = localaukn.a(UniformDownloadBPTransEntity.class, (String)localObject, null);
    if (localObject == null)
    {
      localaukn.a();
      return null;
  ...
  private void c()
  {
    ...
    aukn localaukn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_JavaUtilList = localaukn.a(UniformDownloadBPTransEntity.class, (String)localObject, null);
    if (this.jdField_a_of_type_JavaUtilList == null) {
