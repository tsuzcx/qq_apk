...
public class ampe
  implements amxl
{
  public ampe(CmGameServerQIPCModule.5 param5) {}
  ...
  public void a(boolean paramBoolean, String paramString, List<amxj> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString = amvs.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloScriptSpriteTaskParam, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkIPCSpriteContext, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkCmShowRenderView$PlayActionConfig);
