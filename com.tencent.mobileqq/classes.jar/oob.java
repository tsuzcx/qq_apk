    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130847113);
            paramTextView.setVisibility(0);
            paramTextView.setText(anvx.a(2131703096));
            localObject1 = paramContext.getResources().getDrawable(2130847116);
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131559617, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131370318);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new ooc(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new ood(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
