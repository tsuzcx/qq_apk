  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, int paramInt, FromServiceMsg paramFromServiceMsg)
  {
    ...
    notifyObserver(paramIntent, 0, false, localBundle, aezu.class);
  }
  
  private byte[] a(byte[] paramArrayOfByte)
  {
    byte[] arrayOfByte = new byte[paramArrayOfByte.length + 4];
    bbmx.a(arrayOfByte, 0, paramArrayOfByte.length + 4);
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            paramFromServiceMsg = aezl.a((QQAppInterface)paramIntent);
            if (i == 1)
            {
              bool = true;
              paramFromServiceMsg.c(bool);
              long l = System.currentTimeMillis();
              aezl.a((QQAppInterface)paramIntent).a(l);
              return;
            }
          }
    ...
    if (localObject != null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            localObject = (ZhituResponse)bazp.b(new JSONObject(str), ZhituResponse.class);
            Bundle localBundle = new Bundle();
            ...
            notifyObserver(paramIntent, 0, true, localBundle, aezu.class);
            return;
          }
        }
