...
public class ailp
{
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - aekt.a(65.0F, paramActivity.getResources());
  ...
  public static String a()
  {
    ...
    if (bdag.a())
    {
      localStringBuilder.append(aljq.cU).append("tmp/").append(System.currentTimeMillis()).append("_photo.tmp");
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131719795);
    }
    if (paramInt == 1) {
    ...
    if (paramInt == 5) {
      return paramContext.getString(2131696559);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131696543);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131696544);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131696541);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131696545);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131693617);
    }
    return paramContext.getString(2131696558);
  }
  
  public static String a(List<aiiy> paramList, TroopInfo paramTroopInfo)
  {
    String str = aiiy.a;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(aiiy.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static URL a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = baqq.a(paramString);
        return paramString;
      }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(bcgh.b(bcgh.a(str, paramString2, 1)));
    if (localURL != null)
    {
      paramInt = a(paramString1, bame.d(localURL.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
        com.tencent.TMG.utils.QLog.d("TroopPhotoUtil", 0, "cacheFileFromLocal origin photo,result:" + paramInt);
      }
    }
    paramString2 = a(bcgh.a(bcgh.a(str, paramString2, 1)));
    if (paramString2 != null)
    {
      paramInt = b(paramString1, bame.d(paramString2.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (awiz.a(paramString[0])) && (awiz.a(paramString[1])) && (awiz.a(paramString[2])) && (awiz.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = bdda.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = bdda.a(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        int i = bclo.a(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = bdda.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          bdda.a(paramString1, paramString2);
          return 0;
        }
      }
