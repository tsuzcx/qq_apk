  ...
  implements View.OnTouchListener
{
  ...
  private ScaleGestureDetector.OnScaleGestureListener jdField_a_of_type_AndroidViewScaleGestureDetector$OnScaleGestureListener = new bmbo(this);
  private ScaleGestureDetector jdField_a_of_type_AndroidViewScaleGestureDetector;
  private VelocityTracker jdField_a_of_type_AndroidViewVelocityTracker;
  private View jdField_a_of_type_AndroidViewView;
  private bmbj jdField_a_of_type_Bmbj;
  ...
  public bmbn(View paramView, Context paramContext, bmbj parambmbj, bmbx parambmbx)
  {
    this.jdField_a_of_type_Bmbj = parambmbj;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = parambmbx.a();
    this.jdField_b_of_type_Int = parambmbx.b();
    this.jdField_c_of_type_Int = parambmbx.d();
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    if (this.jdField_a_of_type_Bmbj != null) {
      this.jdField_a_of_type_Bmbj.a(paramFloat1, paramFloat2);
    }
    this.g += paramFloat1;
    this.h += paramFloat2;
    if (this.g > 90.0F) {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    while (paramMotionEvent.getAction() != 2)
    {
      ...
      if (paramMotionEvent.getAction() == 1)
      {
        ...
        if ((Math.abs(f1 - this.i) <= m) && (Math.abs(f2 - this.j) <= m) && (this.jdField_a_of_type_Bmbj != null)) {
          this.jdField_a_of_type_Bmbj.a();
        }
