...
public class bioa
  extends BaseAdapter
{
  public bioa(DraggableGridView paramDraggableGridView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == DraggableGridView.a())
    {
      if (paramView == null)
      {
        localObject = (MeasureGridView)LayoutInflater.from(this.a.getContext()).inflate(2131560640, paramViewGroup, false);
        ((MeasureGridView)localObject).setClickable(false);
        ((MeasureGridView)localObject).setNumColumns(DraggableGridView.a(this.a));
        ((MeasureGridView)localObject).setAdapter(new biob(this.a, paramInt / 2));
      ...
      for (;;)
      {
        ...
        ((biob)((MeasureGridView)localObject).getAdapter()).a(paramInt / 2);
      }
    }
    if (paramView == null) {
