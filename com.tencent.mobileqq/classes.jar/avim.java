  ...
  implements avja
{
  ...
  {
    Intent localIntent = new Intent(avip.a(avil.a(this.a)));
    ...
    case 5: 
      for (;;)
      {
        avil.a(this.a).sendBroadcast(localIntent);
        return;
        ...
        if (avip.a(avil.a(this.a)))
        {
          avjb.a("2691709");
        }
        else if (avip.b(avil.a(this.a)))
        {
          avjb.a("2597857");
          continue;
          ...
          else if (avip.b(avil.a(this.a)))
          {
            avjb.a("2597858");
            continue;
            if ("download".equals(avil.b(this.a)))
            {
              ...
              avil.a(this.a, localInstalledPlugin, bool, l);
            }
            if (avip.a(avil.a(this.a)))
            {
              avjb.a("2691703");
