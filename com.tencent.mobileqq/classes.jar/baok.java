  ...
  implements INetEngine.INetEngineListener
{
  ...
  public baok(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
      ...
      if (paramNetResp.mResult == 0)
      {
        ...
        if (!TextUtils.isEmpty(this.d))
        {
          if (baom.a(this.d, false))
          {
            ...
            baoi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_JavaLangString);
            return;
          }
          baoi.a(this.b, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
