...
{
  atlc(FileManagerEntity paramFileManagerEntity, Activity paramActivity, boolean paramBoolean) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      if ((bool1) && (!bgmg.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath()))) {
        QQToast.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131718477), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131298998));
      }
      for (;;)
      {
        EventCollector.getInstance().onViewClicked(paramView);
        return;
        bcst.b(localQQAppInterface, "dc00898", "", "", "0X8009063", "0X8009063", 0, 0, "", "", "", "");
        break;
        label241:
        ...
        bdho.a(localTeamWorkFileImportInfo, this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface, localTeamWorkFileImportInfo.jdField_d_of_type_Int);
        continue;
