  ...
  extends RelativeLayout
{
  ...
  public uiy(PanelAdapter paramPanelAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    while (i < m)
    {
      ...
      for (localLayoutParams.topMargin = (XPanelContainer.d / (m + 1));; localLayoutParams.topMargin = (j * i + XPanelContainer.d * (i + 2) / (m + 1) / 2))
      {
        ...
        while (j < k)
        {
          ...
          ((PanelAdapter.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363678));
          ((PanelAdapter.ViewHolder)localObject).b = ((ImageView)localView.findViewById(2131363679));
          ((PanelAdapter.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362943));
