...
public class mtn
{
  static volatile mtn jdField_a_of_type_Mtn;
  public int a;
  ...
  mtp jdField_a_of_type_Mtp;
  public int b;
  Runnable b;
  int c = 0;
  int d = -1;
  
  private mtn(Context paramContext)
  {
  ...
  public static mtn a(Context paramContext)
  {
    if (jdField_a_of_type_Mtn == null) {}
    try
    {
      if (jdField_a_of_type_Mtn == null) {
        jdField_a_of_type_Mtn = new mtn(paramContext);
      }
  ...
  private String b()
  {
    ...
    {
      lbc.c("SignalStrengthReport", "getGateway e:" + localException);
    }
    return "";
  }
  ...
  private int g()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          ...
          {
            lbc.c("SignalStrengthReport", "getPingInterval config:" + (String)localObject);
    ...
    {
      lbc.c("SignalStrengthReport", "getPingInterval e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  int a(SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      ...
      {
        lbc.c("SignalStrengthReport", "getLevelPercentBySignalStrength reflect getLevel e:" + paramSignalStrength);
        return 0;
      }
    }
  }
  ...
  public void a()
  {
    ...
    {
      return;
      lbc.c("SignalStrengthReport", "report start");
    ...
    } while ((this.jdField_a_of_type_Mtp == null) || (this.jdField_a_of_type_AndroidTelephonyTelephonyManager == null));
    this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtp, 256);
  }
  ...
  int b(SignalStrength paramSignalStrength)
  {
    ...
    //   112: invokestatic 148	lbc:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: iconst_m1
    //   116: istore_2
    //   117: goto -74 -> 43
    //   120: aload_1
    ...
    //   183: invokestatic 148	lbc:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   186: iconst_m1
    //   187: ireturn
    //   188: iload_2
    //   189: ireturn
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Int = -1;
    if ((this.jdField_a_of_type_Mtp != null) && (this.jdField_a_of_type_AndroidTelephonyTelephonyManager != null)) {
      this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtp, 0);
    }
    ...
    this.jdField_a_of_type_JavaLangString = "";
    lbc.c("SignalStrengthReport", "report stop");
  }
  ...
  public int c()
  {
    ...
    {
      lbc.c("SignalStrengthReport", "getWifiLevelPercent e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  public int d()
  {
    ...
    {
      lbc.c("SignalStrengthReport", "getWifiDbm e:" + localException);
    }
    return -1;
  }
}
