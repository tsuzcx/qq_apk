...
public class aorq
{
  ...
  {
    if (bhca.d(paramMessage.msgtype)) {
      return asdi.a(paramQQAppInterface.getApp(), paramMessage);
    }
    ...
    {
      paramMessage = paramQQAppInterface.getApp().getString(2131690140);
      paramQQAppInterface = paramQQAppInterface.getApp().getString(2131690139);
      return paramMessage + " " + paramQQAppInterface;
    }
    if (paramMessage.msgtype == -2011) {
      return a(paramQQAppInterface, paramMessage, "");
    }
    if (anud.a(paramMessage)) {
      return paramQQAppInterface.getApp().getString(2131691254);
    }
    if (paramMessage.msgtype == -7001) {
      return paramQQAppInterface.getApp().getString(2131694162);
    }
    ...
    if (bgls.b(paramMessage))
    {
      ...
      paramQQAppInterface = bgls.b(paramMessage);
    ...
    for (;;)
    {
      ...
      if ((paramMessage instanceof QQText))
      {
        ...
        if ((paramMessage.msgtype == -5040) && (axnc.a(paramQQAppInterface, paramMessage))) {
          paramQQAppInterface = axnc.a(paramMessage.msg);
        }
      }
      else
      {
  ...
  private static String a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage, String paramString)
  {
    try
    {
      paramMessage = bdof.a(paramMessage.msgData);
      ...
      else
      {
        if (paramMessage.mMsgServiceID == 61) {
          return paramQQAppInterface.getApp().getResources().getString(2131698402);
        }
        if (paramMessage.mMsgServiceID == 107) {
          return paramQQAppInterface.getApp().getResources().getString(2131698221);
        }
