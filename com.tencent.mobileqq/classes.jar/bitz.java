  ...
  extends anud
{
  ...
  public bitz(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new LruCache(100);
    this.jdField_a_of_type_Biuh = new biuh();
    this.jdField_a_of_type_Biup = null;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new biuf(this);
  ...
  public biup a(String paramString)
  {
    if (this.jdField_a_of_type_Biup == null) {
      this.jdField_a_of_type_Biup = new biup(paramString);
    }
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_Biup.jdField_a_of_type_JavaLangString = paramString;
    }
    return this.jdField_a_of_type_Biup;
  }
  
  protected nkq a(biug<oidb_0x8e4.RspBody> parambiug)
  {
    return new biud(this, parambiug);
  }
  ...
  public void a(int paramInt1, int paramInt2, biug<oidb_0x8e4.RspBody> parambiug)
  {
    ...
    nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_1", 2276, 1, new Bundle(), 5000L);
  }
  ...
  public void a(TextView paramTextView, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (((anyw)localObject).b(paramString1))
      {
        paramString1 = bhlg.j(this.app, paramString1);
        try
        {
      ...
      localObject = ((anyw)localObject).a(paramString1);
  ...
  public void a(biug<oidb_0x8e4.RspBody> parambiug)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "reqInviteId");
    }
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_6", 2276, 6, new Bundle(), 5000L);
  }
  ...
  public void a(HotChatInfo paramHotChatInfo, int paramInt1, int paramInt2, biug<oidb_0x8e4.RspBody> parambiug)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    oidb_0x8ed.ReqBody localReqBody = new oidb_0x8ed.ReqBody();
    biub localbiub = new biub(this, parambiug);
    try
    {
      long l = Long.parseLong(paramHotChatInfo.troopUin);
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      nkm.a(this.app, b(new biuc(this, localbiub, paramHotChatInfo, l, paramInt2, paramInt1, parambiug)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      return;
    }
    catch (Exception paramHotChatInfo)
    {
  ...
  public void a(HotChatInfo paramHotChatInfo, biug<oidb_0x8ed.RspBody> parambiug)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    ...
    try
    {
      ...
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      nkm.a(this.app, b(new biua(this, parambiug, paramHotChatInfo)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      axxr.a().a(l);
      axws.a(this.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(bcrg.a()));
      try
      {
  ...
  public void a(String paramString, long paramLong, biug<oidb_0x8e4.RspBody> parambiug)
  {
    if (QLog.isColorLevel()) {
    ...
    nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_5", 2276, 5, new Bundle(), 5000L);
  }
  
  public void a(String paramString, biug<oidb_0x8e4.RspBody> parambiug)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    localReqBody.string_invite_id.set(ByteStringMicro.copyFromUtf8(paramString), true);
    nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_3", 2276, 3, new Bundle(), 5000L);
  }
  
  public void a(String paramString, boolean paramBoolean, biug<oidb_0x8e4.RspBody> parambiug)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_2", 2276, 2, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void a(TroopTips0x857.WereWolfPush paramWereWolfPush, byte[] paramArrayOfByte)
  {
    ...
    for (paramWereWolfPush = "";; paramWereWolfPush = str1.substring(0, 1) + "***" + str1.substring(str1.length() - 1) + "|msg len:" + str1.length())
    {
      ...
      this.jdField_a_of_type_Biup.a("WereWolfPush", paramArrayOfByte);
      return;
    }
  }
  ...
  protected nkq b(biug<oidb_0x8ed.RspBody> parambiug)
  {
    return new biue(this, parambiug);
  }
  
  public void b(int paramInt1, int paramInt2, biug<oidb_0x8e4.RspBody> parambiug)
  {
    if (QLog.isColorLevel()) {
    ...
    localReqBody.uint32_zone_id.set(paramInt2);
    nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_4", 2276, 4, new Bundle(), 5000L);
  }
  
  public void b(String paramString, biug<oidb_0x8e4.RspBody> parambiug)
  {
    if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, boolean paramBoolean, biug<oidb_0x8e4.RspBody> parambiug)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    ...
    {
      paramString.set(i);
      nkm.a(this.app, a(parambiug), localReqBody.toByteArray(), "OidbSvc.0x8e4_7", 2276, 7, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Biuh.removeCallbacksAndMessages(null);
    super.onDestroy();
  }
    ...
    if ("ProfileService.GetSimpleInfo".equals(localObject))
    {
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if ((localObject != null) && (paramToServiceMsg != null) && (((ArrayList)localObject).size() > 0) && (paramToServiceMsg.size() > 0))
        {
          ...
          this.jdField_a_of_type_Biuh.sendMessage(paramFromServiceMsg);
        }
      }
    }
  }
