...
public class amby
  extends Handler
{
  public amby(QQSpecialCareSettingActivity paramQQSpecialCareSettingActivity) {}
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              QQSpecialCareSettingActivity.a(this.a, new bisl(this.a, this.a.getTitleBarHeight()));
