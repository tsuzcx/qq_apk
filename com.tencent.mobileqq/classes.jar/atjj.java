  ...
  extends atjw
{
  ...
  atjj(atiy paramatiy, MessageRecord paramMessageRecord)
  {
    super(paramatiy);
  ...
  void a(String paramString, int paramInt, atju paramatju)
  {
    ...
    atiy.a(this.jdField_a_of_type_Atiy).getFileManagerEngine().a().a(paramString, paramInt, this.d, 3, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.c, new atjk(this, paramString, paramatju));
  }
}
