...
public class vjw
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      vju localvju = (vju)paramQQAppInterface.getManager(208);
      String str = a(paramString);
      paramString = localvju.a(paramString);
      if (paramString != null) {
  ...
  {
    return ("gs_" + paramMessageForShortVideo.frienduin + '_' + paramMessageForShortVideo.getMd5() + '_' + bcdu.d(paramMessageForShortVideo.uuid) + "-700").toLowerCase();
  }
  ...
  {
    return (sga.i()) && (paramInt == 1) && ((paramMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)paramMessageRecord).busiType == 1);
  }
