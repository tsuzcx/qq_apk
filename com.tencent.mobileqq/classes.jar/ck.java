...
{
  ck(LiteActivity paramLiteActivity) {}
  ...
  protected Uri a(Object... paramVarArgs)
  {
    ...
    //   28: astore 12
    //   30: getstatic 30	com/tencent/mobileqq/app/AppConstants:SDCARD_SHARE_VCARD	Ljava/lang/String;
    //   33: astore 10
    //   35: aload 11
    ...
    //   86: aload 10
    //   88: invokestatic 63	com/tencent/mobileqq/utils/FileUtils:fileExists	(Ljava/lang/String;)Z
    //   91: ifne +16 -> 107
    //   94: new 65	com/tencent/mm/vfs/VFSFile
    //   97: dup
    //   98: aload 10
    //   100: invokespecial 68	com/tencent/mm/vfs/VFSFile:<init>	(Ljava/lang/String;)V
    //   103: invokevirtual 71	com/tencent/mm/vfs/VFSFile:mkdirs	()Z
    //   106: pop
    //   107: new 73	com/tencent/mm/vfs/VFSFileOutputStream
    //   110: dup
    //   111: new 65	com/tencent/mm/vfs/VFSFile
    //   114: dup
    ...
    //   135: invokespecial 68	com/tencent/mm/vfs/VFSFile:<init>	(Ljava/lang/String;)V
    //   138: invokespecial 87	com/tencent/mm/vfs/VFSFileOutputStream:<init>	(Lcom/tencent/mm/vfs/VFSFile;)V
    //   141: astore 5
    //   143: aload 7
    //   145: astore_3
    //   146: aload 8
    ...
    //   154: aload 12
    //   156: ldc 89
    //   158: invokevirtual 93	android/content/ContentResolver:openAssetFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    //   161: astore 9
    //   163: aload 9
    //   165: ifnull +149 -> 314
    //   168: aload 7
    ...
    //   173: astore_1
    //   174: aload 9
    //   176: invokevirtual 99	android/content/res/AssetFileDescriptor:createInputStream	()Ljava/io/FileInputStream;
    //   179: astore 4
    //   181: aload 4
    //   183: astore_3
    //   184: aload 4
    ...
    //   200: aload 4
    //   202: aload 7
    //   204: invokevirtual 105	java/io/InputStream:read	([B)I
    //   207: istore_2
    //   208: iload_2
    //   209: iconst_m1
    ...
    //   223: iconst_0
    //   224: iload_2
    //   225: invokevirtual 109	com/tencent/mm/vfs/VFSFileOutputStream:write	([BII)V
    //   228: goto -34 -> 194
    //   231: astore 4
    //   233: aload 5
    //   235: astore_1
    //   236: aload 4
    //   238: invokevirtual 112	java/lang/Exception:printStackTrace	()V
    //   241: aload_3
    //   242: ifnull +7 -> 249
    //   245: aload_3
    ...
    //   250: ifnull +7 -> 257
    //   253: aload_1
    //   254: invokevirtual 114	com/tencent/mm/vfs/VFSFileOutputStream:close	()V
    //   257: new 75	java/lang/StringBuilder
    //   260: dup
    //   261: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   264: ldc 116
    ...
    //   274: aload 6
    //   276: invokevirtual 80	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   279: invokevirtual 84	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   282: invokestatic 120	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   285: areturn
    //   286: aload_1
    //   287: ifnull +9 -> 296
    //   290: aload_1
    ...
    //   308: astore_1
    //   309: aload 5
    //   311: invokevirtual 125	com/tencent/mm/vfs/VFSFileOutputStream:flush	()V
    //   314: aload 4
    //   316: ifnull +8 -> 324
    //   319: aload 4
    //   321: invokevirtual 113	java/io/InputStream:close	()V
    //   324: aload 5
    //   326: ifnull +8 -> 334
    //   329: aload 5
    //   331: invokevirtual 114	com/tencent/mm/vfs/VFSFileOutputStream:close	()V
    ...
    //   359: invokestatic 120	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   362: areturn
    //   363: astore_1
    //   364: aload_1
    //   365: invokevirtual 126	java/io/IOException:printStackTrace	()V
    //   368: goto -44 -> 324
    //   371: astore_1
    //   372: aload_1
    //   373: invokevirtual 126	java/io/IOException:printStackTrace	()V
    //   376: goto -42 -> 334
    //   379: astore_3
    //   380: aload_3
    //   381: invokevirtual 126	java/io/IOException:printStackTrace	()V
    //   384: goto -135 -> 249
    //   387: astore_1
    //   388: aload_1
    //   389: invokevirtual 126	java/io/IOException:printStackTrace	()V
    //   392: goto -135 -> 257
    //   395: astore 4
    //   397: aconst_null
    //   398: astore 5
    ...
    //   404: ifnull +7 -> 411
    //   407: aload_1
    //   408: invokevirtual 113	java/io/InputStream:close	()V
    //   411: aload 5
    //   413: ifnull +8 -> 421
    //   416: aload 5
    //   418: invokevirtual 114	com/tencent/mm/vfs/VFSFileOutputStream:close	()V
    //   421: new 75	java/lang/StringBuilder
    //   424: dup
    //   425: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   428: ldc 116
    ...
    //   438: aload 6
    //   440: invokevirtual 80	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   443: invokevirtual 84	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   446: invokestatic 120	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   449: pop
    //   450: aload 4
    //   452: athrow
    //   453: astore_1
    //   454: aload_1
    //   455: invokevirtual 126	java/io/IOException:printStackTrace	()V
    //   458: goto -47 -> 411
    //   461: astore_1
    //   462: aload_1
    //   463: invokevirtual 126	java/io/IOException:printStackTrace	()V
    //   466: goto -45 -> 421
    //   469: astore 4
    //   471: goto -68 -> 403
    //   474: astore 4
