...
public class bjva
{
  ...
  {
    PackageManager localPackageManager = bjjo.a().a().getPackageManager();
    try
    {
    ...
    {
      bjtx.b("AppUtil", "getApkVersonCode>>>", paramString);
    }
    return 0;
  }
  ...
  public static Bitmap a(String paramString)
  {
    try
    {
      ...
      if ((paramString != null) && (paramString.applicationInfo != null))
      {
        ...
        if (paramString != null)
        {
          paramString = bjtv.b(paramString);
          return paramString;
        }
      }
    }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = bjjo.a().a().getPackageManager().getPackageArchiveInfo(paramString, 1);
        if (paramString != null)
        {
      ...
      {
        bjtx.c("AppUtil", "getApkName>>>", paramString);
      }
    }
    return null;
  }
    ...
    catch (Exception localException)
    {
      ...
      if (paramString1 != null)
      {
        ...
        catch (Exception paramString1)
        {
          ...
          Toast.makeText(paramContext, anzj.a(2131699546), 0).show();
          return;
        }
      }
      Toast.makeText(paramContext, anzj.a(2131699547), 0).show();
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      bjtx.c("add", ">>has add appCustom=" + paramString3);
    }
    paramString1.putExtra("platformId", "qzone_m");
    bjtx.c("add", ">>has add platformid=qzone_m");
    try
    ...
    {
      Toast.makeText(paramContext, anzj.a(2131699548), 0).show();
    }
  }
  ...
  public static boolean a(Context paramContext)
  {
    if (paramContext == null)
    {
      bjtx.e("AppUtil", "isPackageScanAllowed context is null");
      return true;
    }
    try
    {
      boolean bool = bjjo.a().a().getSharedPreferences("package_scan", 0).getBoolean("qqsetting_package_scan_flag", true);
      return bool;
    }
    catch (Exception paramContext)
    {
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((aohr)((BaseActivity)paramContext).app.a(23)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
          catch (Exception paramBundle)
          {
            for (;;)
            {
              try
              {
                new aohr((QQAppInterface)null).a(paramString.trim(), paramContext, localIntent);
              }
              catch (Exception paramString)
              {
      ...
      {
        Toast.makeText(paramContext, anzj.a(2131699549), 0).show();
        return false;
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (new File(paramString1).exists())
      {
        ...
        {
          bjtx.b("AppUtil", "installApp>>> put source " + paramString2);
          paramString1.putExtra("big_brother_source_key", paramString2);
        }
        if (!TextUtils.isEmpty(paramString3))
        {
          bjtx.b("AppUtil", "installApp>>> put ref id " + paramString3);
    ...
    {
      bjtx.c("AppUtil", "installApp>>>", paramContext);
    }
    return false;
  }
  ...
  {
    return bhny.a(bjjo.a().a(), paramString);
  }
  ...
  public static int b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bjtx.c("AppUtil", "getApkVersonCodeFromApkFile>>>", paramString);
      }
    }
    return 0;
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    {
      bjtx.b("AppUtil", "getCurProcessName err", paramContext);
    }
    return null;
  }
  ...
  {
    bjtx.b("AppUtil", "getAppVersionCode: " + paramString);
    localObject1 = null;
    try
    {
      a(paramString);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bjtx.e("AppUtil", "openManifest failed: " + localException.getMessage());
      }
    }
    ...
    for (;;)
    {
      ...
      {
        String str;
        bjtx.e("AppUtil", "error: " + paramString.getMessage());
        localObject1.close();
        return 0;
      }
      ...
      if ((!TextUtils.isEmpty(str)) && (str.equals("manifest")))
      {
        ...
        if (i < localObject1.getAttributeCount())
        {
          if (localObject1.getAttributeName(i).equals("versionCode"))
          {
            ...
            localObject1.close();
            bjtx.b("AppUtil", "apkPath:" + paramString + ",versionCode:" + str);
