  ...
  implements spo
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = sfm.g + "filter";
  ...
  private static void a(String paramString)
  {
    ...
    if (paramString.isFile()) {
      urk.d("VideoFilterManager", "delete file : %s", new Object[] { Boolean.valueOf(paramString.delete()) });
    }
    if (!paramString.exists()) {
      urk.d("VideoFilterManager", "create folder : %s", new Object[] { Boolean.valueOf(paramString.mkdirs()) });
    }
  }
  ...
  private boolean a()
  {
    ...
    //   13: getstatic 55	sre:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   32: invokestatic 154	vlm:d	(Ljava/lang/String;)Z
    //   35: pop
    ...
    //   56: aload_3
    //   57: aload_0
    //   58: getfield 166	sre:jdField_a_of_type_Long	J
    //   61: invokevirtual 170	java/io/ObjectOutputStream:writeLong	(J)V
    //   64: aload_3
    //   65: aload_0
    //   66: getfield 172	sre:jdField_a_of_type_Int	I
    //   69: invokevirtual 175	java/io/ObjectOutputStream:writeInt	(I)V
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 75	sre:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   99: getstatic 55	sre:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   141: ldc 196
    //   143: aload_0
    //   144: getfield 75	sre:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   147: invokeinterface 202 1 0
    //   152: invokestatic 207	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   155: invokestatic 210	urk:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   158: aload_2
    //   159: ifnull +7 -> 166
    //   162: aload_2
    ...
    //   214: ldc 215
    //   216: aload_3
    //   217: invokestatic 218	urk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   220: aload_2
    //   221: ifnull +7 -> 228
    //   224: aload_2
  ...
  public static boolean a(String paramString, boolean paramBoolean)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((localFile.exists()) && (localFile.isDirectory()))
      {
        ...
        if (paramBoolean) {
          urk.d("VideoFilterManager", "remove illegal filter folder : %s", new Object[] { paramString });
        }
      }
    }
    try
  ...
  private boolean b()
  {
    ...
    //   18: getstatic 55	sre:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   21: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: ldc 107
    //   26: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: ldc 149
    ...
    //   40: invokestatic 242	vlm:b	(Ljava/io/File;)[B
    ...
    //   60: astore 5
    //   62: aload_0
    //   63: getfield 75	sre:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   82: putfield 166	sre:jdField_a_of_type_Long	J
    //   85: aload_3
    //   86: astore 4
    //   88: aload_2
    //   89: astore 5
    ...
    //   96: putfield 172	sre:jdField_a_of_type_Int	I
    //   99: aload_3
    //   100: astore 4
    //   102: aload_2
    //   103: astore 5
    ...
    //   123: astore 5
    //   125: aload_0
    //   126: getfield 75	sre:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   129: aload 6
    ...
    //   171: invokestatic 210	urk:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   174: aload_2
    //   175: ifnull +7 -> 182
    //   178: aload_2
    ...
    //   203: ldc 118
    //   205: ldc_w 274
    //   208: invokestatic 276	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   211: aload_2
    //   212: ifnull +7 -> 219
    //   215: aload_2
    ...
    //   243: ldc_w 278
    //   246: aload 6
    //   248: invokestatic 218	urk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   251: aload_2
    //   252: ifnull +7 -> 259
    //   255: aload_2
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        ...
        if ((localFilterItem.isLocalType()) || (a(localFilterItem)))
        {
          ...
          urk.a("VideoFilterManager", "add to display : %s", localFilterItem);
        }
      }
      urk.a("VideoFilterManager", "ignore display : %s", localFilterItem);
    }
  ...
  @Nullable
  public srb a(FilterItem paramFilterItem)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (srb)this.jdField_a_of_type_JavaUtilMap.get(str);
      ...
      catch (Exception paramFilterItem)
      {
        for (;;)
        {
          urk.b("VideoFilterManager", "getFilterItemConfig, parse config file failed", paramFilterItem);
        }
      }
      paramFilterItem = (FilterItem)localObject;
    } while (localObject == null);
  ...
  protected srb a(File paramFile)
  {
    if ((!paramFile.exists()) || (!paramFile.isFile()) || (!paramFile.canRead()))
    {
      urk.d("VideoFilterManager", "parseFilterConfigFile failed, file is illegal %s", new Object[] { paramFile });
      return null;
    }
    long l = SystemClock.uptimeMillis();
    paramFile = (srb)JsonORM.a(new JSONObject(new String(vlm.a(paramFile), "UTF-8")), srb.class);
    urk.a("VideoFilterManager", "parseFilterConfigFile success, cost = %d ms", Long.valueOf(SystemClock.uptimeMillis() - l));
    return paramFile;
  }
  
  public void a()
  {
    urk.d("VideoFilterManager", "onInit");
  ...
  protected void a(boolean paramBoolean, int paramInt)
  {
    if (paramBoolean)
    {
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        urk.a("VideoFilterManager", "fireGetFilterListFinish, filter count %d -> %d", Integer.valueOf(this.jdField_b_of_type_JavaUtilList.size()), Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()));
      ...
      urk.a("VideoFilterManager", "fireGetFilterListFinish, download pending list size = %d", Integer.valueOf(this.jdField_a_of_type_JavaUtilQueue.size()));
      d();
    }
  ...
  public boolean a(boolean paramBoolean)
  {
    if ((Math.abs(System.currentTimeMillis() - this.jdField_a_of_type_Long) > this.jdField_a_of_type_Int * 1000) || (paramBoolean))
    {
      ...
      {
        urk.d("VideoFilterManager", "fireGetFilterList full list");
        this.c = "";
        this.jdField_a_of_type_JavaUtilList.clear();
        c();
        return true;
      }
      urk.d("VideoFilterManager", "fireGetFilterList ignore because we are requesting ..");
    }
    for (;;)
    {
      return false;
      urk.d("VideoFilterManager", "fireGetFilterList ignore because you request too frequently, frequency = %d s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) });
    }
  }
  
  public void b()
  {
    urk.d("VideoFilterManager", "onDestroy");
    e();
  }
  ...
  protected void c()
  {
    urk.a("VideoFilterManager", "fireGetFilterListInner %s", this.c);
    slv.a().a(new srh(this.c), new srg(this, null));
  }
  ...
  protected void d()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      ...
      {
        urk.d("VideoFilterManager", "start to download filter resource : %s", new Object[] { localFilterItem });
        new srf(this, this.jdField_a_of_type_Shd).executeOnExecutor(Bosses.get().getExecutor(16), new ssi[] { new ssi(localFilterItem.filterConfigUrl, b(localFilterItem), localFilterItem.filterConfigMd5) });
      }
      return;
    }
  }
  ...
  public void e()
  {
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      urk.a("VideoFilterManager", "trimMemory, download pending list %d", Integer.valueOf(this.jdField_a_of_type_JavaUtilQueue.size()));
      this.jdField_a_of_type_JavaUtilQueue.clear();
      urk.a("VideoFilterManager", "trimMemory, filter list %d", Integer.valueOf(this.jdField_b_of_type_JavaUtilList.size()));
      this.jdField_b_of_type_JavaUtilList.clear();
      urk.a("VideoFilterManager", "trimMemory, picture config cache %d", Integer.valueOf(this.jdField_a_of_type_JavaUtilMap.size()));
