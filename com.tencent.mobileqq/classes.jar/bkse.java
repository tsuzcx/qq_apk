...
public class bkse
{
  ...
  public bkse(int paramInt, float paramFloat)
  {
    a();
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    } while (this.jdField_a_of_type_Bksj == null);
    TraceCompat.beginSection("onPagerChanged");
    this.jdField_a_of_type_Bksj.a(localViewHolder);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bksk = new bksk(this, null);
    this.jdField_a_of_type_Bksh = new bksh(this, null);
    this.jdField_a_of_type_Bksi = new bksi(this, null);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnTouchListener(this.jdField_a_of_type_Bksk);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnScrollListener(this.jdField_a_of_type_Bksk);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnFlingListener(this.jdField_a_of_type_Bksk);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bksh);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bksi);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getAdapter().registerAdapterDataObserver(new bksf(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.removeOnScrollListener(this.jdField_a_of_type_Bksk);
  ...
  {
    return new bksg(this, this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getContext(), paramLinearLayoutManager);
  }
