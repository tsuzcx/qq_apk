...
public class bkse
{
  public static final bksj a;
  private static final bmab<bksi> jdField_a_of_type_Bmab;
  private static final List<Feature> jdField_a_of_type_JavaUtilList;
  private static final List<Pair<String, Integer>> b;
  private static final List<bksi> c;
  
  static
  {
    jdField_a_of_type_Bksj = new bksj();
    jdField_a_of_type_JavaUtilList = new LinkedList();
    b = new LinkedList();
    c = new LinkedList();
    jdField_a_of_type_Bmab = new bmab();
    if (a())
    {
      a();
      b();
  ...
  public static bmab<bksi> a()
  {
    return jdField_a_of_type_Bmab;
  }
  
  public static List<bksi> a(@Nullable bksi parambksi)
  {
    LinkedList localLinkedList = new LinkedList(c);
    if ((parambksi == null) || (TextUtils.isEmpty(parambksi.jdField_a_of_type_JavaLangString))) {
      return localLinkedList;
    }
    Iterator localIterator = localLinkedList.iterator();
    while (localIterator.hasNext())
    {
      bksi localbksi = (bksi)localIterator.next();
      if ((localbksi != null) && (!TextUtils.isEmpty(localbksi.jdField_a_of_type_JavaLangString)) && (localbksi.jdField_a_of_type_JavaLangString.equals(parambksi.jdField_a_of_type_JavaLangString)))
      {
        localbksi.b = parambksi.b;
        localbksi.c = parambksi.c;
      }
    }
    return localLinkedList;
  }
  ...
  public static void a(@Nullable bksv parambksv, long paramLong)
  {
    ThreadManager.getUIHandler().postDelayed(new AEDashboardUtil.1(parambksv), paramLong);
  }
  ...
  private static void b(@Nullable bksv parambksv)
  {
    ThreadManager.excute(new AEDashboardUtil.2(parambksv), 64, null, true);
  }
  
  private static void b(@Nullable bksv parambksv, @NonNull List<bksh> paramList, @NonNull List<bksg> paramList1)
  {
    if (parambksv == null) {
      return;
    }
    ThreadManager.getUIHandler().post(new AEDashboardUtil.3(parambksv, paramList, paramList1));
  }
  
  private static List<bksh> c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bksh localbksh = new bksh();
      try
      {
        localbksh.jdField_a_of_type_JavaLangString = ((Feature)localObject1).getName();
        localbksh.jdField_a_of_type_Boolean = ((Feature)localObject1).isFunctionReady();
        ...
        {
          localStringBuilder.append((String)localObject1);
          localbksh.c = localStringBuilder.toString();
          localLinkedList.add(localbksh);
          break;
          localObject1 = "GPU";
          break label94;
        }
      ...
      {
        localbksh.jdField_a_of_type_Boolean = false;
        localbksh.b = localException.getMessage();
        localLinkedList.add(localbksh);
      }
      finally
      {
    ...
    Collections.sort(localLinkedList, new bksf());
    return localLinkedList;
  }
  
  private static void c()
  {
    c.add(new bksi("CameraModuleSvc.GetCameraConfig"));
    c.add(new bksi("CameraModuleSvc.GetCompressedCategoryMaterial.MqStoryCamera"));
    c.add(new bksi("CameraModuleSvc.GetCompressedCategoryMaterial.MqEmoCamera"));
    c.add(new bksi("CameraModuleSvc.GetPlayShowCatMatTree"));
  }
  
  private static List<bksg> d()
  {
    LinkedList localLinkedList = new LinkedList();
    ...
    while (localIterator.hasNext())
    {
      ...
      bksg localbksg = new bksg();
      localbksg.jdField_a_of_type_JavaLangString = ((String)localPair.first);
      localbksg.b = blev.a().a((String)localPair.first, "null", ((Integer)localPair.second).intValue());
      localLinkedList.add(localbksg);
    }
    return localLinkedList;
  }
}
