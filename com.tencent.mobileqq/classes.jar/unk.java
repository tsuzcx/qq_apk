...
public class unk
{
  protected static ulk<String, unl> a = new ulk(200);
  ...
  public static File a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((xpq.a(paramString)) && (a(paramString, paramInt) != null))
    {
  ...
  {
    return ulg.h + a(paramString, false, 0L) + "/" + b(paramString, paramInt, paramBoolean1, paramBoolean2);
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (xpq.a(paramString)) {}
    for (String str = ulg.h;; str = ulg.i) {
  ...
  public static void a(StoryVideoItem paramStoryVideoItem, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        localuvx.a(paramStoryVideoItem.mVid, paramStoryVideoItem);
        return;
  ...
  {
    unl localunl = new unl();
    localunl.a = paramString2;
    a.a(paramString1, localunl);
  }
  ...
  {
    paramString = (unl)a.a(paramString);
    if (paramString != null) {
