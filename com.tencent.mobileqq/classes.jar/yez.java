...
public class yez
{
  ...
  public static long a()
  {
    ...
    bckd.b(jdField_a_of_type_JavaLangString, "getResAvilTime ts" + l);
    return l;
  }
  ...
  {
    // Byte code:
    //   0: getstatic 103	yez:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   3: invokestatic 79	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifne +9 -> 15
    //   9: getstatic 103	yez:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   12: astore_0
    //   13: aload_0
    //   14: areturn
    //   15: aconst_null
    ...
    //   180: astore_0
    //   181: aload_0
    //   182: putstatic 103	yez:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   185: getstatic 103	yez:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   188: areturn
    //   189: aload_3
    //   190: invokevirtual 67	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   193: putstatic 103	yez:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   196: getstatic 103	yez:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   199: astore_3
    //   200: aload_3
    //   201: astore_0
    //   202: aload_2
  ...
  public static List<DownloadInfo> a(String[] paramArrayOfString, String paramString, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        {
          bckd.b(jdField_a_of_type_JavaLangString, localDownloadInfo.c + "exception and no installed", localException);
          continue;
          label221:
          if (localPackageManager.getPackageInfo(localDownloadInfo.e.trim(), 0) == null)
          {
            localArrayList.add(localDownloadInfo);
            if (QLog.isColorLevel()) {
              bckd.b(jdField_a_of_type_JavaLangString, localDownloadInfo.c + "no installed");
            }
          }
          else
          {
            if (QLog.isColorLevel()) {
              bckd.b(jdField_a_of_type_JavaLangString, localDownloadInfo.c + "installed");
            }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = Arrays.asList(new String[] { NetConnInfoCenter.getServerTime() + "", "1", "8.2.6", "gamecenter_ver", "2", Build.BRAND, str2, localObject, "0", "0", "gamecenter_src", paramString1, paramString2, "0", paramString3, paramString4, "", "", "", "", "", "", "", "", "", paramString5, paramString6, "", Build.MODEL, Build.VERSION.RELEASE, "1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" });
        if (!(paramAppInterface instanceof QQAppInterface)) {
          break label457;
        }
        paramAppInterface = (QQAppInterface)paramAppInterface;
        bezp.a(paramAppInterface, "dc00087", paramString1);
        return;
      }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, Map<Integer, String> paramMap)
  {
    ...
    for (;;)
    {
      ...
      paramString1 = Arrays.asList(new String[] { NetConnInfoCenter.getServerTime() + "", "1", "8.2.6", "gamecenter_ver", "2", Build.BRAND, localObject3, localObject1, "0", "0", "gamecenter_src", paramString1, paramString2, "0", paramString3, paramString4, "", "", "", "", "", "", "", "", "", paramString5, paramString6, "", Build.MODEL, Build.VERSION.RELEASE, "1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" });
  ...
  {
    bckd.b(jdField_a_of_type_JavaLangString, "startDownload delay task pParamsJson=" + paramString + ",autoInstallBySdk=" + paramBoolean + ",from=" + paramInt + ",isWifi=" + AppNetConnInfo.isWifiConn());
    try
    {
    ...
    {
      bckd.a(jdField_a_of_type_JavaLangString, "startDownload exception", paramString);
    }
  }
  ...
  public static void a(Map<Integer, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if ((TextUtils.isEmpty(paramString)) || (apyr.a == null)) {
          break;
        }
        ...
        localObject = (String)apyr.a.get(paramString + "_orted_configs");
  ...
  {
    if (QLog.isColorLevel()) {
      bckd.b(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadDelayApp:" + paramArrayOfString);
    }
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          bckd.b(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadDelayApp params.size=0:");
        }
      }
      else
      {
  ...
  public static boolean a()
  {
    if ((badq.h(BaseApplicationImpl.getContext())) && ((PowerManager)BaseApplicationImpl.getContext().getSystemService("power") != null) && ((yev.a >= 20) || (yev.jdField_b_of_type_Boolean))) {
      return true;
    }
  ...
  public static boolean a(long paramLong)
  {
    ...
    bckd.b(jdField_a_of_type_JavaLangString, "saveResAvilTime: ts=" + paramLong + ",flag:" + bool);
    return bool;
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      bckd.b(jdField_a_of_type_JavaLangString, "yuyue:saveAppDetail,appid:" + paramString1 + ",detail:" + paramString2 + ",keyPre:" + paramString3);
    }
  ...
  public static void b(String[] paramArrayOfString)
  {
    int k = 0;
    if (QLog.isColorLevel()) {
      bckd.b(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadAppointApp:" + paramArrayOfString);
    }
    if ((paramArrayOfString == null) || (paramArrayOfString.length < 1)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() < 1)
      {
        ...
        bckd.b(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadAppointApp params.size=0:");
        return;
      }
      ...
      bgtf.a().a(paramArrayOfString, null);
      return;
    }
  }
  ...
  public static boolean c(String paramString1, String paramString2)
  {
    ...
    if (QLog.isColorLevel()) {
      bckd.b(jdField_a_of_type_JavaLangString, "yuyue:addAppidToList,appid:" + paramString1 + ",key:" + paramString2);
    }
  ...
  public static boolean e(String paramString1, String paramString2)
  {
    ...
    return apdh.a(paramString1 + "/" + paramString2);
  }
}
