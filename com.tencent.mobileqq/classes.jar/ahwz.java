...
public class ahwz
  extends ajjh
{
  public ahwz(SpecailCareListActivity paramSpecailCareListActivity) {}
    ...
    for (boolean bool = Arrays.equals(SpecailCareListActivity.a(this.a), paramArrayOfObject);; bool = false)
    {
      if (bool) {
        if (paramArrayOfObject.length >= 1)
        {
          ...
          if (paramBoolean) {
            ...
            {
              this.a.d();
              bbmy.a(BaseApplication.getContext(), 2, 2131624099, 0).b(this.a.getTitleBarHeight());
              this.a.a();
              this.a.jdField_a_of_type_Ahxf.notifyDataSetChanged();
            }
          }
        }
      }
      while (!paramBoolean)
      {
        do
        {
          ...
          {
            return;
            bbmy.a(BaseApplication.getContext(), 2, 2131633727, 0).b(this.a.getTitleBarHeight());
          }
          if (this.a.c != null)
          {
            bbmy.a(BaseApplication.getContext(), 1, 2131633710, 0).b(this.a.getTitleBarHeight());
            return;
          }
          bbmy.a(BaseApplication.getContext(), 1, 2131633726, 0).b(this.a.getTitleBarHeight());
          return;
        } while (!paramBoolean);
        this.a.a();
        this.a.jdField_a_of_type_Ahxf.notifyDataSetChanged();
