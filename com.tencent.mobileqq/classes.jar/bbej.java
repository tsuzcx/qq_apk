  ...
  extends bbee
{
  ...
  public Bundle a(int paramInt, Bundle paramBundle)
  {
    ...
    if (paramInt == 16)
    {
      bbeg.a("PTV.RichmediaClient", "ICallBack.Stub() getData start. ICALLBACK_CMD_GET_PRESEND_MGR_HANDLER");
    ...
    for (;;)
    {
      ...
      return localBundle;
      label113:
      paramBundle = new Messenger(localPresendPicMgr.jdField_a_of_type_Azqx).getBinder();
      bbeg.a("PTV.RichmediaClient", "ICallBack.Stub() getData. ICALLBACK_CMD_GET_PRESEND_MGR_HANDLER , b = " + paramBundle);
    }
  }
  
  public void a(int paramInt, Bundle paramBundle)
  {
    bbeg.a("PTV.RichmediaClient", "sendRequest. cmd = " + paramInt + ",data = " + paramBundle);
    if (paramBundle != null)
    {
    ...
    do
    {
          ...
          do
          {
            do
            {
              ...
              if (paramBundle != null)
              {
                ...
                paramBundle = PresendPicMgr.b(azpt.a(paramBundle.a));
                bbeg.a("PTV.RichmediaClient", "ICALLBACK_CMD_INIT_PRESEND_PIC_MGR  presendMgr = " + paramBundle);
                return;
              }
              bbeg.a("PTV.RichmediaClient", "ICALLBACK_CMD_INIT_PRESEND_PIC_MGR  failed, bw is null ! ");
              return;
      ...
      azro.e = paramBundle[0];
      azro.f = paramBundle[1];
      azro.g = paramBundle[2];
      azro.h = paramBundle[3];
      azro.i = paramBundle[4];
      azro.j = paramBundle[5];
      azro.a = paramBundle[6];
      azro.b = paramBundle[7];
      azro.c = paramBundle[8];
  ...
  {
    bbeg.a("PTV.RichmediaClient", "ICallBack.Stub() compress start. info.src = " + paramCompressInfo.c + ",uuid = " + paramCompressInfo.a);
    azrm.a(paramCompressInfo);
    bbeg.a("PTV.RichmediaClient", "ICallBack.Stub() compress finish. info = " + paramCompressInfo);
  }
}
