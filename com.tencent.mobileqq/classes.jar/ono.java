...
public class ono
  implements onr
{
  private onp jdField_a_of_type_Onp;
  ...
  public ono()
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        this.jdField_a_of_type_Onq = ((pfg)localObject).a().a();
        if (this.jdField_a_of_type_Onq != null) {
          this.jdField_a_of_type_Onq.a(this);
        }
  ...
  private ons a(oidb_cmd0xe16.RspBody paramRspBody, int paramInt, ToServiceMsg paramToServiceMsg)
  {
    ons localons = new ons();
    localons.a(paramInt);
    if (paramRspBody.msg_key_info.has())
    {
      if (paramRspBody.msg_key_info.uint64_feeds_id.has()) {
        localons.b(String.valueOf(paramRspBody.msg_key_info.uint64_feeds_id.get()));
      }
      if (paramRspBody.msg_key_info.uint32_feeds_type.has()) {
        localons.b(paramRspBody.msg_key_info.uint32_feeds_type.get());
      }
      if ((!paramRspBody.msg_key_info.str_sub_comment_id.has()) || (TextUtils.isEmpty(paramRspBody.msg_key_info.str_sub_comment_id.get()))) {
        break label455;
      }
      localons.a(paramRspBody.msg_key_info.str_sub_comment_id.get());
    }
    for (;;)
    {
      if (paramRspBody.msg_card_jump_info.has())
      {
        if ((paramRspBody.msg_card_jump_info.bytes_card_jump_url.has()) && (!TextUtils.isEmpty(paramRspBody.msg_card_jump_info.bytes_card_jump_url.get().toStringUtf8()))) {
          localons.h(paramRspBody.msg_card_jump_info.bytes_card_jump_url.get().toStringUtf8());
        }
        if ((paramRspBody.msg_card_jump_info.bytes_comment_btn_url.has()) && (!TextUtils.isEmpty(paramRspBody.msg_card_jump_info.bytes_comment_btn_url.get().toStringUtf8()))) {
          localons.i(paramRspBody.msg_card_jump_info.bytes_comment_btn_url.get().toStringUtf8());
        }
        if (paramRspBody.msg_card_jump_info.uint32_available.has()) {
          localons.e(paramRspBody.msg_card_jump_info.uint32_available.get());
        }
        if (paramRspBody.msg_card_jump_info.bytes_share_url.has()) {
          localons.c(paramRspBody.msg_card_jump_info.bytes_share_url.get().toStringUtf8());
        }
      }
      if ((paramToServiceMsg != null) && (paramToServiceMsg.getAttributes() != null))
      {
        ...
        {
          localons.d(paramRspBody.getContentString());
          localons.d(paramRspBody.getListShowType());
          localons.c(paramRspBody.getCommentType());
          localons.e(paramRspBody.getReplyCommentId());
          localons.f(paramRspBody.getReplyParentCommentId());
          localons.g(paramRspBody.getReplyUin());
          localons.a(paramRspBody.isIsSecondReply());
          localons.f(paramRspBody.getContentSrc());
        }
        paramRspBody = paramToServiceMsg.getAttributes().get("article_attributes");
        if ((paramRspBody instanceof ArticleInfo)) {
          localons.a((ArticleInfo)paramRspBody);
        }
      }
      QLog.d("RIJBiuAndCommentMixDataManager", 1, "onBiuAndCommentMixSend RIJBiuAndCommentRespData info is" + localons.toString());
      return localons;
      label455:
      if ((paramRspBody.msg_key_info.str_comment_id.has()) && (!TextUtils.isEmpty(paramRspBody.msg_key_info.str_comment_id.get()))) {
        localons.a(paramRspBody.msg_key_info.str_comment_id.get());
      }
    }
  }
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean, String paramString3, String paramString4, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      paramString1 = otv.a(paramArticleInfo);
  ...
  private void a(ons paramons)
  {
    if ((paramons == null) || (paramons.a() == null))
    {
      QLog.d("RIJBiuAndCommentMixDataManager", 2, "reportMixCommentBiuResult | respData or mArticleInfo is null");
      return;
    }
    ArticleInfo localArticleInfo = paramons.a();
    paramons = "";
    try
    {
    ...
    ocd.a(null, osp.a(localArticleInfo), "0X800AC6A", "0X800AC6A", 0, 0, String.valueOf(localArticleInfo.mArticleID), "", localArticleInfo.innerUniqueID, paramons, false);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Onp = null;
  ...
  public void a(ArticleInfo paramArticleInfo, RIJBiuAndCommentRequestData paramRIJBiuAndCommentRequestData)
  {
    ...
    while (this.jdField_a_of_type_Onq == null) {
      return;
    }
    QLog.d("RIJBiuAndCommentMixDataManager", 1, "requestCreateBiuAndCommentMixComment goTo pbRequest");
    this.jdField_a_of_type_Onq.a(paramArticleInfo, paramRIJBiuAndCommentRequestData);
  }
  ...
  public void a(onp paramonp)
  {
    this.jdField_a_of_type_Onp = paramonp;
