...
public class ono
{
  ...
  private void a()
  {
    ...
    if ((this.jdField_a_of_type_Int != a()) || (onm.a().a))
    {
  ...
  private void b(int paramInt)
  {
    if (paramInt < this.h.size())
    {
      ...
      awrn.a(null).a(this.jdField_a_of_type_JavaLangString, "event_simple_p_info", false, 1000L, 1000L, localHashMap, null);
    }
  }
  ...
  private void e()
  {
    ...
    {
      return;
      localObject1 = ((akeu)localObject1).a(false);
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            localObject2 = ahay.a(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
            localObject2 = ahay.a().a((String)localObject2);
  ...
  private void h()
  {
    ...
    {
      return;
      localObject1 = (List)((ajhh)localObject1).a().clone();
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
  ...
  private void i()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localObject2 != null)
      {
        ...
        ArrayList localArrayList = localajjj.a(String.valueOf(((Groups)localObject2).group_id));
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          ...
          {
            atmo localatmo = (atmo)((Iterator)localObject3).next();
            if (localatmo != null)
            {
              Friends localFriends = (Friends)localatmo;
              localArrayList.add(((Friends)localatmo).uin);
              if (localajjj.a(localFriends.uin) != null) {
