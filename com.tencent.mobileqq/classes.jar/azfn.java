...
{
  public azfn(Camera2Control paramCamera2Control, long paramLong) {}
  
  public void onError(int paramInt)
  {
    azfu.a(1, "[Camera2]Samsung Capture onError:" + paramInt);
  ...
  {
    azfu.a(1, "[Camera2]Samsung Capture cost:" + (float)(System.currentTimeMillis() - this.jdField_a_of_type_Long) / 1000.0F);
    azft.a(2, Camera2Control.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control), System.currentTimeMillis() - this.jdField_a_of_type_Long);
  ...
  {
    azfu.a(1, "[Camera2]samsungCapture onShutter!");
  }
}
