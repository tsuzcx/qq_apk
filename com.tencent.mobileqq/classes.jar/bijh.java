  ...
  extends VasWebviewJsPlugin
{
  ...
  bijg jdField_a_of_type_Bijg = new biji(this);
  public bijk a;
  public String a;
  ...
  {
    biij.a(paramJSONObject.optInt("useWebBundle"));
  }
  ...
  private void b(JSONObject paramJSONObject)
  {
    ...
    bikk.a(str1, false, bikk.b);
    for (;;)
    {
      a(localIntent.getExtras());
      biij.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      bikk.a(str1, false, bikk.e);
    }
  }
  ...
  private static String c()
  {
    ...
    return bduw.a("tencent/MobileQQ/qqcomic/cache/");
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bijk != null) {
      this.jdField_a_of_type_Bijk.a();
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 121	bijh:f	Ljava/lang/String;
    //   6: getstatic 26	bijh:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   9: invokevirtual 284	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   12: istore_2
    //   13: iload_2
    //   14: ifeq +6 -> 20
    //   17: aload_0
    //   18: monitorexit
    //   19: return
    //   20: getstatic 26	bijh:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 287	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 289	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 290	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lbijh;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
    //   38: invokestatic 294	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   41: goto -24 -> 17
    //   44: astore_1
    //   45: aload_0
    //   46: monitorexit
  ...
  public void a(String paramString1, JSONObject paramJSONObject, String paramString2)
  {
    if (this.jdField_a_of_type_Bijk == null)
    {
      ...
      this.jdField_a_of_type_Bijk = bijy.a(this.mRuntime, this.jdField_a_of_type_Bijg);
    }
    if (this.jdField_a_of_type_Bijk != null) {
      this.jdField_a_of_type_Bijk.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)biij.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", alpo.a(2131710554));
    ...
    else
    {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.a.a(new bebr(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2111;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2111;
            label1078:
            paramVarArgs.a.a(new bebs(paramJsBridgeListener, j, paramString2));
            break label2111;
          }
          if ("getTitleBarHeight".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            j = this.mRuntime.a().getResources().getDimensionPixelSize(2131298914);
            i = j;
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            biij.a(paramString1, paramString2, -1);
            break label2111;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (bebt)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", biij.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", biij.c);
            paramString1.put("obj_ownerid", biij.b);
            paramJsBridgeListener.put("data", paramString1);
