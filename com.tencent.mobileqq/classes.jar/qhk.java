...
public class qhk
  extends ailn
  implements View.OnClickListener, View.OnLongClickListener, asko, qgw<ObservableArrayList<ResultRecord>>
{
  private static final qhq jdField_a_of_type_Qhq = new qhq(null);
  private final int jdField_a_of_type_Int;
  protected final Context a;
  private final SparseArray<List<auko>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new qhl(this);
  private ExpandableListView jdField_b_of_type_ComTencentWidgetExpandableListView;
  private final boolean jdField_b_of_type_Boolean;
  private final View.OnClickListener c = new qhn(this);
  
  public qhk(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Int = ((int)bbdv.a(this.jdField_a_of_type_AndroidContentContext, 12.0F));
    this.jdField_b_of_type_Int = ((int)bbdv.a(this.jdField_a_of_type_AndroidContentContext, 9.0F));
  ...
  private void a(List<qho> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Qhq);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131378332);
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) || ((paramView.getTag() instanceof qhs)))
    {
      ...
      paramViewGroup.e = ((TextView)paramView.findViewById(2131377035));
      paramView.setTag(paramViewGroup);
      if (this.jdField_b_of_type_AndroidViewView$OnClickListener == null) {
        break label483;
      }
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (qhr)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
        ...
        if (localPublicAccountInfo.certifiedGrade > 0L)
        {
          ...
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130841310);
        }
        for (;;)
        {
      ...
      if (localObject3 != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              if ((((RecentUser)localObject4).getType() == 0) && (Long.parseLong(((RecentUser)localObject4).uin) >= 10000L) && (!((RecentUser)localObject4).uin.equals(localObject2)) && (!bbbr.b(((RecentUser)localObject4).uin)))
              {
                localObject4 = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(((RecentUser)localObject4).uin);
                if ((localObject4 != null) && (((Friends)localObject4).isFriend()) && (!bduf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject4).uin))) {
        ...
        if (!((List)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131718638);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        localObject2 = localajxl.a(String.valueOf(localGroups.group_id));
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new qho((Friends)((Iterator)localObject5).next(), -1));
          }
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((qho)((Iterator)localObject4).next()).a);
        }
        ...
        if (((Iterator)localObject4).hasNext())
        {
          ...
          int j = bbcz.a(((Friends)localObject5).detalStatusFlag, ((Friends)localObject5).iTermType);
          if ((j == 0) || (j == 6)) {
            break label557;
          }
          i += 1;
      ...
      for (;;)
      {
        ...
        while (i < ((List)localObject2).size())
        {
          ...
          if ((!((Friends)localObject5).uin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (!bbbr.b(((Friends)localObject5).uin)) && (!bduf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject5).uin))) {
  ...
  protected View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if (paramViewGroup.jdField_a_of_type_AndroidViewView != null)
      {
        if (!bail.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramViewGroup.jdField_a_of_type_JavaLangString)) {
          break label342;
        }
    ...
    {
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(null);
      localObject = bbcz.a(localFriends);
      ...
      if ((AppSetting.d) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + ajya.a(2131713736));
      }
      return paramView;
      paramViewGroup = (qhs)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    label355:
    paramView.setContentDescription((String)localObject + ajya.a(2131713741));
    return paramView;
  }
  ...
  {
    qhp localqhp = (qhp)paramView.getTag();
    if (localqhp == null)
    {
      localqhp = new qhp();
      paramView.findViewById(2131368567).setVisibility(0);
      localqhp.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367211));
      paramView.setTag(localqhp);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localqhp.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      ((CheckBox)paramView.findViewById(2131368567)).setChecked(this.jdField_b_of_type_ComTencentWidgetExpandableListView.c(paramInt));
      return;
    }
  }
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (qhp)paramView.getTag();
      ...
      if (AppSetting.d)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajya.a(2131713768));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajya.a(2131713730));
    }
  }
  ...
  {
    paramView = (qhp)paramView.getTag();
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    localbbmf.a(0, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131693226));
    bbcq.a(paramView, localbbmf, this.c, new qhm(this));
    return true;
  }
