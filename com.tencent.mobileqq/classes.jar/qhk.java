  ...
  implements qfw
{
  ...
  public qhk(Context paramContext, ArticleInfo paramArticleInfo1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, int paramInt5, ArticleInfo paramArticleInfo2, szd paramszd)
  {
  ...
  public szd a()
  {
    return this.jdField_a_of_type_Szd;
  }
  ...
  public int b()
  {
    ...
    return this.jdField_a_of_type_Szd.getItemViewType(this.jdField_b_of_type_Int + 1);
  }
  ...
  public int c()
  {
    return rjl.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
  }
  ...
  public boolean g()
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_a_of_type_Int == 41403) || (plm.a(this.jdField_a_of_type_Int)) || (bmhv.a(this.jdField_a_of_type_Int)));
      localBaseArticleInfo = this.jdField_a_of_type_Szd.a(this.jdField_a_of_type_Int);
    ...
    if (pqw.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))
    {
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null) {}
    while ((!bmhv.a(this.d)) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mGroupId == -1L) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mGroupCount <= 0L) || ((c() != 1) && (c() != 2))) && (!rjl.b(a()))) {
      return false;
    }
    return true;
  }
