  ...
  extends pbh
{
  ...
  private List<qbc> jdField_a_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_a_of_type_Boolean = true;
  private long jdField_b_of_type_Long;
  private List<qbb> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private long jdField_c_of_type_Long;
  private List<qbc> jdField_c_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_c_of_type_Boolean = true;
  private String j = "";
  private String k = "";
  
  public paq(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramToServiceMsg = qee.a((Iterable)localObject, new par(this));
    ...
    {
      paramToServiceMsg = qee.a((Iterable)localObject, new pas(this));
    ...
    paramToServiceMsg = qee.a((Iterable)localObject, new pat(this));
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    localReqBody.uint64_uin.set(onk.a());
    ...
    for (paramInt1 = 0;; paramInt1 = 1)
    {
      ...
      localObject = pow.a("OidbSvc.0x977", 2423, 5, localReqBody.toByteArray());
