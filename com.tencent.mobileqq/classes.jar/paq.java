...
public class paq
{
  ...
  {
    Long localLong = (Long)bkwm.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(0L));
    if (localLong != null) {}
  ...
  public static void a(String paramString)
  {
    ...
    bkwm.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(l1));
  }
  
  public static void a(qln paramqln)
  {
    if (paramqln != null)
    {
