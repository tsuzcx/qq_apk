  ...
  extends AladdinRequestHandler
{
  ...
  private static void b(Bundle paramBundle)
  {
    ...
    paramBundle = bdmc.a(ozs.a().getApplication());
    String str = ozs.a();
    if (i == 0) {}
  ...
  public void onSend(byte[] paramArrayOfByte, Bundle paramBundle, AladdinResponseHandler paramAladdinResponseHandler)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localAppRuntime.getApplication(), par.class);
    ...
    localNewIntent.putParcelableArrayListExtra("key_aladdin_listeners", pam.a);
