...
public class axfp
{
  ...
  public static void a(axfs paramaxfs, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (int i = 2;; i = 3)
    {
      ThreadManagerV2.executeOnFileThread(new QzoneGiftUtil.1(paramaxfs, i, paramString1, paramString2, paramString3));
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, QzoneZipCacheHelperCallBack paramQzoneZipCacheHelperCallBack)
  {
    ...
    if (localDownloader != null) {
      localDownloader.download(paramString1, a(paramString1, paramString2), false, new axfr(paramQzoneZipCacheHelperCallBack));
    }
  }
  
  private static boolean b(String paramString1, String paramString2)
  {
    return arof.a(a(paramString1, paramString2));
  }
}
