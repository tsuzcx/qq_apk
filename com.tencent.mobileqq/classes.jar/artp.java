...
public class artp
{
  ...
  /* Error */
  public static artr a(String paramString)
  {
    // Byte code:
    //   0: lconst_0
    //   1: lstore_3
    ...
    //   25: aconst_null
    //   26: lconst_0
    //   27: invokespecial 215	artr:<init>	(Ljava/lang/String;J)V
    //   30: areturn
    ...
    //   1080: aload 12
    //   1082: lload_3
    //   1083: invokespecial 215	artr:<init>	(Ljava/lang/String;J)V
    //   1086: areturn
    //   1087: aload 12
    //   1089: astore 13
    //   1091: goto -461 -> 630
  ...
  public static void a(String paramString, arts paramarts)
  {
    arsd.a().execute(new UniformDownloadUtil.2(paramString, paramarts));
  }
  
  public static void a(String paramString, artt paramartt)
  {
    ThreadManager.getSubThreadHandler().post(new UniformDownloadUtil.1(paramString, paramartt));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    a(paramString1, new artq(paramString1, paramString2));
  }
  
  public static boolean a(String paramString)
  {
    return (paramString != null) && (arso.a(paramString).equalsIgnoreCase(".apk"));
  }
  
  public static void b(String paramString1, String paramString2)
  {
    QLog.i("UniformDownloadUtil", 1, "[UniformDL] >>>openFileWithOtherApp. localPath:" + paramString1);
    if ((paramString1 == null) || (!arso.a(paramString1)))
    {
      QLog.e("UniformDownloadUtil", 1, "[UniformDL] openFileWithOtherApp. file is not existed. localPath:" + paramString1);
      return;
    }
    BaseApplication localBaseApplication = BaseApplication.getContext();
    String str = bazw.a(localBaseApplication, paramString1);
