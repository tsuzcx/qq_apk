...
public class osy
  implements blgx
{
  public osy(ReadInJoyBaseDeliverActivity paramReadInJoyBaseDeliverActivity) {}
  ...
  public View onCreatePanel(int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      ...
      {
        ReadInJoyBaseDeliverActivity.a(this.a, (EmoticonMainPanel)View.inflate(this.a, 2131559158, null));
    ...
    if (ReadInJoyBaseDeliverActivity.a(this.a) == null)
    {
      ReadInJoyBaseDeliverActivity.a(this.a, (PublicAccountHotPicPanel)View.inflate(this.a, 2131559652, null));
