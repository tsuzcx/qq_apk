  ...
  extends aquk
{
  ...
  protected void a()
  {
    ...
    {
      return;
      localFileManagerEntity = this.jdField_a_of_type_Aqug.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
  ...
  protected void a(int paramInt)
  {
    ...
    while (paramInt != 0)
    {
      ...
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Aqug.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Aquk.a() + "->StateChangeToOffWhenPause)");
      this.jdField_a_of_type_Aquk = new aquq(this.jdField_a_of_type_Aqug);
      paramInt = 0;
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean == true)
    {
      ...
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Aqug.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Aquk.a() + "->StateLocalFailedWhenPause)");
