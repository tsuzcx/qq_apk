  ...
  implements aqsw
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aqre(this);
  private aqrz jdField_a_of_type_Aqrz;
  private int b;
  private int c;
  private int d;
  
  public aqrd(Context paramContext, FullPopData paramFullPopData, String paramString1, String paramString2, boolean paramBoolean)
  {
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData != null)
    {
      ...
      ((ObjectAnimator)localObject2).addListener(new aqrf(this));
  ...
  private void f()
  {
    int i = this.jdField_a_of_type_AndroidWidgetRelativeLayout.getTop() + actn.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    int j = this.jdField_a_of_type_AndroidWidgetRelativeLayout.getBottom() - actn.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Aqrz = new aqrz(i, j, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLeft(), this.jdField_a_of_type_AndroidWidgetRelativeLayout.getRight());
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Aqrz);
  ...
  private void g()
  {
    ...
    {
      aqrz localaqrz = this.jdField_a_of_type_Aqrz;
      localaqrz.jdField_a_of_type_Int -= this.jdField_a_of_type_Int;
      localaqrz = this.jdField_a_of_type_Aqrz;
      localaqrz.jdField_b_of_type_Int += this.jdField_b_of_type_Int;
      if (Build.VERSION.SDK_INT >= 21)
      {
        this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Aqrz);
        this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setClipToOutline(true);
      }
      if (this.jdField_a_of_type_Aqrz.jdField_a_of_type_Int <= 0) {
  ...
  private void h()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(new aqrg(this));
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Aqrz != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Aqrz);
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setClipToOutline(true);
      if (this.jdField_a_of_type_Aqrz.jdField_a_of_type_Int > this.jdField_a_of_type_Aqrz.jdField_b_of_type_Int)
      {
  ...
  private void j()
  {
    ...
    localObjectAnimator.addListener(new aqrh(this));
  }
