...
public class biva
{
  ...
  public biva(int paramInt)
  {
    this.a = new Intent();
    this.a.putExtra("nType", paramInt);
  }
  
  public biva(Intent paramIntent)
  {
    this.a = paramIntent;
  }
  
  public static biva a(float paramFloat1, float paramFloat2, String paramString1, String paramString2, String paramString3)
  {
    return new biva(7).b("sLocation", paramString2).b("sBrief", paramString3).b("sPublisher", paramString1).a("fLatitude", paramFloat1).a("fLongitude", paramFloat2);
  }
  
  public static biva a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, byte[] paramArrayOfByte, boolean paramBoolean, long paramLong)
  {
    ...
    {
      paramArrayOfByte = bivs.a(paramArrayOfByte);
      str6 = bivs.a(paramArrayOfByte[0], paramString1);
      str5 = bivs.a(paramArrayOfByte[1], paramString2);
      str4 = bivs.a(paramArrayOfByte[2], paramString3);
      str3 = bivs.a(paramArrayOfByte[3], paramString4);
      str2 = bivs.a(paramArrayOfByte[4], paramString5);
      str1 = bivs.a(paramArrayOfByte[5], paramString6);
    }
    paramString1 = new biva(6).a("nLinkType", paramInt).b("sTitle", str6).b("sUrl", str5).a("bAppShare", paramBoolean).a("lAppId", paramLong).b("sPublisher", str4).b("sBrief", str3).b("sPath", str2).b("sResUrl", str1);
    if (paramBoolean) {}
  ...
  public static biva a(Intent paramIntent)
  {
    int i = 1;
    if (paramIntent == null) {
      return null;
    ...
    for (i = (int)new File((String)localObject).length();; i = paramIntent.getIntExtra("file_thumb_Size", 0))
    {
      ...
      localObject = new biva(5);
      ((biva)localObject).a.putExtra("shortVideoContents", localContentValues);
      return ((biva)localObject).c(paramIntent.getStringExtra("from_uin"));
      i = j;
      break;
      l = 0L;
      break label132;
  ...
  public static biva a(awge paramawge)
  {
    return new biva(2).c(paramawge);
  }
  
  public static biva a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return null;
    }
    biva localbiva = new biva(8).c(paramMessageForStructing);
    if (!bivs.a(paramMessageForStructing))
    {
      localbiva.c(paramMessageForStructing);
      return localbiva;
    }
    ArrayList localArrayList = new ArrayList();
    byte[] arrayOfByte = bivs.a(paramMessageForStructing.uniseq, paramMessageForStructing.structingMsg);
    if (arrayOfByte != null) {
    ...
    {
      arrayOfByte = bivs.a(paramMessageForStructing.uniseq, l);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      arrayOfByte = bivs.a(-1L, paramMap);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      bivs.a(paramQQAppInterface, paramMessageForStructing, paramList, paramMap, localArrayList);
      if (localArrayList != null) {
        localbiva.b("sBizDataList", localArrayList);
      }
      return localbiva;
    }
  }
  
  public static biva a(MessageForShortVideo paramMessageForShortVideo)
  {
    ContentValues localContentValues = new ContentValues();
    ...
    for (long l1 = new File(str).length();; l1 = paramMessageForShortVideo.thumbFileSize)
    {
      ...
      paramMessageForShortVideo = new biva(5);
  ...
  public static biva a(String paramString)
  {
    return new biva(6).b("sUrl", paramString);
  }
  
  public static biva a(String paramString1, int paramInt, String paramString2)
  {
    return new biva(4).b("sPath", paramString1).a("nDuration", paramInt).b("sBrief", paramString2);
  }
  
  public static biva a(String paramString1, int paramInt, String paramString2, long paramLong1, String paramString3, long paramLong2)
  {
    paramInt = bivs.b(paramInt);
    ...
    for (;;)
    {
      ...
      return new biva(2).b("sMD5", paramString1).b("sPath", paramString3).a("nPicType", paramInt).b("sPicId", paramString2).a("lSize", paramLong2);
    }
  }
  
  public static biva a(String paramString1, String paramString2)
  {
    return new biva(1).b("sText", paramString2).b("sTitle", paramString1);
  }
  
  public static biva a(ArrayList<String> paramArrayList, boolean paramBoolean1, String paramString1, String paramString2, boolean paramBoolean2, long paramLong, String paramString3)
  {
    paramArrayList = new biva(8).a("sPathList", paramArrayList).b("sTitle", paramString1).a("bOnlyPic", paramBoolean1).b("sText", paramString2).a("bAppShare", paramBoolean2).a("lAppId", paramLong).b("sAppName", paramString3);
    if (paramBoolean2) {}
    for (paramLong = 4L;; paramLong = 1L) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      bivc.a(paramActivity, str, bool, null, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    {
      return;
      localObject2 = (MessageForArkApp)anny.a(1, ((MessageForArkApp)localObject1).ark_app_message.appName, localObject1, localObject1);
      ...
      try
      {
        ...
        if (aolb.c.equals(((MessageForArkApp)localObject1).ark_app_message.appName))
        {
          ...
          bivo.a(paramQQAppInterface, 11, 0, paramChatMessage.istroop);
          return;
        }
      }
    ...
    {
      localObject3 = paramContext.getString(2131719571);
    ...
    for (i = 4;; i = 5)
    {
      ...
      bivo.a(paramQQAppInterface, 9, 0, paramChatMessage.istroop);
      return;
      bivo.a(paramQQAppInterface, 8, 0, paramChatMessage.istroop);
      return;
      break label50;
      break;
      i = 1;
  ...
  public static biva b(awge paramawge)
  {
    return new biva(8).c(paramawge);
  }
  
  public static biva b(String paramString)
  {
    return new biva(2).b("sPath", paramString);
  }
  ...
  public biva a(int paramInt, long paramLong1, String paramString1, long paramLong2, String paramString2)
  {
  ...
  public biva a(long paramLong)
  {
    return a("requestId", paramLong);
  }
  
  public biva a(long paramLong, String paramString)
  {
    this.a.putExtra("nAuthorType", 1).putExtra("lUin", paramLong).putExtra("sName", paramString);
    return this;
  }
  
  public biva a(QQAppInterface paramQQAppInterface)
  {
  ...
  public biva a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public biva a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if (paramQQAppInterface == null) {
      return this;
    }
    int i = bivs.a(paramInt2);
    String str2 = "";
    long l6 = 0L;
    Object localObject4 = "";
    long l5 = 0L;
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          l3 = l1;
          localObject1 = bcmm.a(paramMessageRecord);
          ...
          paramString1 = (String)localObject4;
          l3 = l1;
          paramMessageRecord = ((bcmn)localObject1).c;
        }
        ...
        paramString1 = paramMessageRecord;
        l3 = l1;
        localObject3 = bdgc.a(paramQQAppInterface, (String)localObject1, true);
        l4 = l2;
        localObject2 = localObject3;
        paramString1 = paramMessageRecord;
        l3 = l1;
        ...
        try
        {
          localObject1 = bdgc.c(paramQQAppInterface, paramString2);
          paramString1 = (String)localObject1;
        ...
        if (str1 != null)
        {
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bdgc.b(paramQQAppInterface, str1, paramInt2);
          l1 = 0L;
          l2 = l5;
          localObject3 = localObject4;
          continue;
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bdgc.b(paramQQAppInterface, paramString2, paramInt2);
          l4 = l5;
          localObject2 = localObject4;
          paramString1 = (String)localObject1;
          l3 = l6;
    ...
    for (;;)
    {
      ...
      paramString1 = str2;
      l3 = l6;
      localObject3 = bdgc.b(paramQQAppInterface, str1, 0);
      ...
      if (((String)localObject3).equals(str1))
      {
        ...
        if (paramInt2 == 3000)
        {
          ...
          paramString1 = (String)localObject3;
          l3 = l6;
          localObject1 = bdgc.a(paramQQAppInterface, paramString2, str1);
        }
      }
      l4 = l5;
      localObject2 = localObject4;
      ...
      for (localObject3 = bdgc.a(paramQQAppInterface, paramString2, true);; localObject3 = bdgc.c(paramQQAppInterface, paramString2))
      {
        l4 = l5;
        localObject2 = localObject3;
        paramString1 = (String)localObject1;
  ...
  public biva a(String paramString, float paramFloat)
  {
    this.a.putExtra(paramString, paramFloat);
    return this;
  }
  
  public biva a(String paramString, int paramInt)
  {
    this.a.putExtra(paramString, paramInt);
    return this;
  }
  
  public biva a(String paramString, long paramLong)
  {
    this.a.putExtra(paramString, paramLong);
    return this;
  }
  
  public biva a(String paramString, ArrayList<String> paramArrayList)
  {
    this.a.putStringArrayListExtra(paramString, paramArrayList);
    return this;
  }
  
  public biva a(String paramString, boolean paramBoolean)
  {
  ...
  {
    return a(paramActivity, paramString, 2131692402, null);
  }
  ...
  public boolean a(Activity paramActivity, String paramString, int paramInt, Intent paramIntent, boolean paramBoolean)
  {
    ...
    } while ((paramIntent.getIntExtra("nPicType", 1) != 1) || (!bivs.a(str, paramIntent.getLongExtra("lSize", -1L))));
    paramIntent.putExtra("nReasonInt", 2131695352);
    if (QLog.isColorLevel()) {
      QLog.i("qqfav", 1, "QfavBuilder.add: picture too big [" + str + "]");
    }
    bivo.a(null, "Net_AddFav", 3, 3, -3);
    return false;
  }
  
  public boolean a(Activity paramActivity, String paramString, int paramInt, bivb parambivb)
  {
    ...
    if (!bool)
    {
      ...
      if (this.a != null) {
        localObject1 = paramActivity.getString(this.a.getIntExtra("nReasonInt", 2131692403));
      }
    }
    bivc.a(paramActivity, paramString, bool, (String)localObject1, false, paramInt);
    if (parambivb != null) {
      parambivb.b(bool);
    }
    return bool;
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity, ChatMessage paramChatMessage, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    for (Object localObject1 = new File(paramString);; localObject1 = null)
    {
      ...
      if (paramFileManagerEntity != null)
      {
        ...
        str = arso.a((String)localObject2);
        m = 6;
      ...
      for (localObject1 = paramFileManagerEntity.fileName.getBytes();; localObject1 = ((File)localObject1).getName().getBytes())
      {
        ...
        if (!paramBoolean1) {
          bivs.a(paramContext, 2131692405, 1);
        }
        bivo.a(paramQQAppInterface, "User_AddFav", 6, -80010, m, i, str, null);
        paramQQAppInterface = new ContentValues();
        paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692419));
      ...
      label282:
      if (paramBoolean2) {}
      for (int n = 3;; n = arrr.a(paramFileManagerEntity)) {
        switch (n)
        {
        default: 
          if (!paramBoolean1) {
            bivs.a(paramContext, 2131692406, 0);
          }
          bivo.a(paramQQAppInterface, "User_AddFav", 6, -80003, m, i, str, null);
          paramQQAppInterface = new ContentValues();
          paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692421));
          this.a.putExtra("fileContents", paramQQAppInterface);
          return false;
        }
      }
      ...
      {
        if (!paramBoolean1) {
          bivs.a(paramContext, 2131692404, 1);
        }
        bivo.a(paramQQAppInterface, "User_AddFav", 6, -80011, m, i, str, null);
        paramQQAppInterface = new ContentValues();
      ...
      while (paramFileManagerEntity == null)
      {
        ...
        case 3: 
          ...
          if (!paramBoolean1)
          {
            paramString = (String)localObject1;
            if (this.a != null) {
              paramString = paramContext.getString(this.a.getIntExtra("nReasonInt", 2131692403));
            }
          }
          paramQQAppInterface.runOnUiThread(new QfavBuilder.1(this, paramContext, paramQQAppInterface, paramBoolean1, paramString));
          if (paramChatMessage != null) {
            bivo.a(paramQQAppInterface, 5, paramFileManagerEntity.nFileType, paramChatMessage.istroop);
          }
          bivo.a(paramQQAppInterface, "User_AddFav", 6, 0, m, i, str, null);
  ...
  public biva b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public biva b(String paramString1, String paramString2)
  {
    this.a.putExtra(paramString1, paramString2);
    return this;
  }
  
  public biva b(String paramString, ArrayList<byte[]> paramArrayList)
  {
  ...
  public biva c(awge paramawge)
  {
    this.a.putExtra("cvEntityContents", bivs.a(paramawge, ""));
    this.a.putExtra("sEntityClassName", paramawge.getClass().getName());
    return this;
  }
  
  public biva c(String paramString)
  {
    try
    {
  ...
  public boolean c(Activity paramActivity, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    bivc.a(paramActivity, paramString, bool, "", false, 2131692402);
    return bool;
  }
}
