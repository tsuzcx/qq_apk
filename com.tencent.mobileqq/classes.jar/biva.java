...
public class biva
{
  ...
  public biva()
  {
    this.jdField_a_of_type_AndroidOsHandler = new bivb(this, Looper.getMainLooper());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    if (paramBoolean == true) {
      localTranslateAnimation.setAnimationListener(new bivc(this));
    }
  ...
  public boolean a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561949, null);
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362716);
