      ...
      if (this.a.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IRewardVideoAdListener != null)
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (paramJSONObject.isValid())
          {
            ...
            bjvl localbjvl = this.a;
            i = j;
            if (this.a.c == 90) {
              i = 0;
            }
            localbjvl.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMotiveVideoPageData = RewardedVideoAdPlugin.mockMVPageData(paramJSONObject, str, i);
