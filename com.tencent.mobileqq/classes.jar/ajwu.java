  ...
  implements InputFilter
{
  ...
  public ajwu(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    ajwt localajwt = ExtendEditText.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localajwt == null)
    {
