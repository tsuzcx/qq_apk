  ...
  extends aryv
{
  ...
  public asca(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  {
    if (!this.i) {}
    for (this.jdField_a_of_type_JavaLangString = alud.a(2131705165);; this.jdField_a_of_type_JavaLangString = null)
    {
  ...
  protected void b()
  {
    ...
    TextView localTextView = this.jdField_a_of_type_Bdjz.getMessageTextView();
  ...
  protected void b(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      bhsb.a(true, (String)localObject1);
      return;
    }
  }
  ...
  public void v()
  {
    ...
    if (bool)
    {
      localObject1 = aepi.a((Intent)localObject2, null);
    ...
    label290:
    bivo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "User_BatchForwardSendBtnClick", 0, 0, localArrayList.size());
  }
}
