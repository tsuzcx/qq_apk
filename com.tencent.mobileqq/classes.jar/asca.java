  ...
  extends asbv
{
  ...
  public asca(QQAppInterface paramQQAppInterface)
  {
  ...
  public void b()
  {
    boolean bool = FileUtil.deleteFile(new File(apnl.a()));
    if (QLog.isColorLevel()) {
  ...
  {
    int i = 0;
    long l1 = apno.a("report_tag_so_cover", 0L);
    ...
    for (;;)
    {
      apno.a(paramBoolean, i, str);
      apno.a("report_tag_so_cover", l2);
      return;
      label102:
      paramBoolean = false;
      continue;
