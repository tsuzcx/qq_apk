  ...
  extends ajfb
{
  ...
  public bapf(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, ArrayList<String> paramArrayList, ArrayList<Float> paramArrayList1, String paramString2)
  {
    try
    {
      paramString2 = "uip:" + zpj.k() + ", " + paramString2;
    ...
    paramArrayList.qqversion.set("8.2.6.4370");
    ...
    ((bapf)paramQQAppInterface.a(103)).sendPbReq(paramArrayList1);
    if (QLog.isColorLevel()) {
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (bapf)paramAppRuntime.a(103);
      if (!((bapf)localObject).b.get()) {
        ((bapf)localObject).a(paramAppRuntime, false);
      }
      if (((bapf)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (((bapf)localObject).jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramString1))
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      ThreadManager.post(new VasMonitorHandler.1(paramAppRuntime, paramString1, a(new String[] { "109", "8.2.6", paramString2, localObject, paramString4, paramString5 }), a(new Float[] { Float.valueOf(1.0F), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) }), paramString3), 5, null, false);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    QLog.i("VasMonitorHandler", 2, "onReceive res.isSuccess=" + paramFromServiceMsg.isSuccess() + ",data=" + bakz.a((byte[])paramObject));
  }
}
