...
public class ryo
  implements Runnable
{
  public ryo(BaseChatPie paramBaseChatPie, String paramString, int paramInt1, long paramLong, Context paramContext, int paramInt2, LightReplyEmojs paramLightReplyEmojs) {}
  ...
  public void run()
  {
    ...
    if (localChatMessage != null) {
      ThreadManager.getUIHandler().post(new ryp(this, localChatMessage));
    }
  }
}
