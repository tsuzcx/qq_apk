...
public class ryw
  extends AVObserver
{
  private ryw(BaseChatPie paramBaseChatPie) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          DialogUtil.b(this.a.jdField_a_of_type_AndroidContentContext, 230, null, str1, 2131429048, 2131428674, new ryx(this), null).show();
          return;
          if (paramLong2 != 35L) {
            break;
          }
  ...
  protected void a(long paramLong1, int paramInt, long paramLong2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == paramInt) && (Long.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue() == paramLong1)) {
      DialogUtil.b(this.a.jdField_a_of_type_AndroidContentContext, 230, null, paramString, 2131429048, 2131428674, new ryy(this), null).show();
    }
  }
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    {
      TextView localTextView = (TextView)this.a.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar.a(new Object[0]).findViewById(2131363022);
      ...
      if (localTextView != null)
      {
        ...
        String.format(this.a.jdField_a_of_type_AndroidContentContext.getString(2131433762), new Object[] { Long.valueOf(l) });
        if (i != 5) {
    ...
    for (;;)
    {
      j = this.a.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131494226);
