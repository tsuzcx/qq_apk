...
public class ryw
  implements qvs, qyt, ryx
{
  private int jdField_a_of_type_Int = -1;
  private long jdField_a_of_type_Long;
  protected Activity a;
  protected VVideoView a;
  qyu jdField_a_of_type_Qyu;
  @Nullable
  ...
  public ryw(Activity paramActivity, VVideoView paramVVideoView, int paramInt)
  {
    this.jdField_a_of_type_Qyu = new qyu(paramInt);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVVideoView = paramVVideoView;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    qvr.a().a(paramActivity);
    qvr.a().a(this);
    this.jdField_a_of_type_Qyu.a(this);
    this.jdField_a_of_type_Qyu.a(paramVVideoView);
  }
  
  private int a()
  {
    switch (this.jdField_a_of_type_Qyu.a())
    {
    case 6: 
    default: 
      return 6;
  ...
  private void a(int paramInt, Object paramObject)
  {
    try
    {
      ...
      paramObject.put("width", this.jdField_a_of_type_Qyu.b());
      paramObject.put("height", this.jdField_a_of_type_Qyu.c());
  ...
  {
    if (paramInt == 0) {
      this.jdField_a_of_type_Qyu.e(true);
    }
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == -1) {
          this.jdField_a_of_type_Int = qvr.a().a(3);
        }
      ...
      this.jdField_a_of_type_Qyu.e(false);
    }
  }
  ...
  public void a(long paramLong)
  {
    try
    {
      ...
      localJSONObject.put("totalTime", this.jdField_a_of_type_Qyu.a() / 1000L);
  ...
  {
    this.jdField_a_of_type_Qyu.a.a(paramVideoPreDownloadMgr);
  }
  
  public void a(VVideoView paramVVideoView)
  {
    if ((this.jdField_a_of_type_Ryz != null) && (!this.jdField_a_of_type_Qyu.a()))
    {
      this.jdField_a_of_type_Qyu.a(this.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Qyu.a(this.jdField_a_of_type_Ryz.jdField_a_of_type_Int, this.jdField_a_of_type_Ryz.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ryz.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Ryz.jdField_d_of_type_Int);
    }
  }
  
  public void a(VVideoView paramVVideoView, int paramInt)
  {
    this.jdField_a_of_type_Qyu.b(paramInt);
  }
  
  public void a(VVideoView paramVVideoView, String paramString)
  {
    if (paramString.equals("contain")) {
      this.jdField_a_of_type_Qyu.a(0);
    }
    while (!paramString.equals("cover")) {
      return;
    }
    this.jdField_a_of_type_Qyu.a(2);
  }
  ...
  public void a(VVideoView paramVVideoView, String paramString, VComponentAdapter.OnVideoViewMethodListener paramOnVideoViewMethodListener)
  {
    try
    {
      ...
      paramVVideoView.put("currentTime", a(this.jdField_a_of_type_Qyu.b()));
      paramVVideoView.put("totalTime", this.jdField_a_of_type_Qyu.a() / 1000L);
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("width", this.jdField_a_of_type_Qyu.b());
      localJSONObject.put("height", this.jdField_a_of_type_Qyu.c());
  ...
  public void a(VVideoView paramVVideoView, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ryz = new ryz(paramJSONObject.getJSONObject("video_info"));
      this.jdField_a_of_type_Qyu.e(paramJSONObject.optBoolean("muted", false));
      if (bool1)
      {
        this.jdField_a_of_type_Qyu.a(this.jdField_a_of_type_Ryz.jdField_a_of_type_Int, this.jdField_a_of_type_Ryz.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ryz.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Ryz.jdField_d_of_type_Int);
        return;
  ...
  {
    this.jdField_a_of_type_Qyu.e(paramBoolean);
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("VVideoControlListenerImpl", 2, "play: status=" + this.jdField_a_of_type_Qyu.a() + ", isPreload=" + this.jdField_a_of_type_Qyu.a() + ", videoinfo=" + this.jdField_a_of_type_Ryz + ", mStartPosition:" + this.jdField_a_of_type_Long);
    }
    if ((this.jdField_a_of_type_Ryz != null) && (this.jdField_a_of_type_Qyu.a())) {
      this.jdField_a_of_type_Qyu.a(this.jdField_a_of_type_Ryz.jdField_a_of_type_Int, this.jdField_a_of_type_Ryz.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ryz.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Ryz.jdField_d_of_type_Int);
    }
    ...
    {
      return;
      if (this.jdField_a_of_type_Qyu.b())
      {
        this.jdField_a_of_type_Qyu.a();
        return;
      }
    } while (this.jdField_a_of_type_Ryz == null);
    this.jdField_a_of_type_Qyu.a(this.jdField_a_of_type_Ryz.jdField_a_of_type_Int, this.jdField_a_of_type_Ryz.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ryz.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Ryz.jdField_d_of_type_Int);
  }
  ...
  {
    this.jdField_a_of_type_Qyu.d(paramBoolean);
  }
  ...
  {
    this.jdField_a_of_type_Qyu.b();
  }
  
  public void c(VVideoView paramVVideoView, int paramInt)
  {
    this.jdField_a_of_type_Qyu.c(paramInt);
  }
  ...
  {
    this.jdField_a_of_type_Qyu.b(paramBoolean);
  }
  ...
  {
    this.jdField_a_of_type_Qyu.f();
  }
  
  public void h()
  {
    if (this.jdField_a_of_type_Qyu.g()) {
      a(2, null);
    }
    while (!this.jdField_a_of_type_Qyu.f()) {
      return;
    }
    a(4, null);
  }
  ...
  public void n()
  {
    this.jdField_a_of_type_Qyu.h();
    qvr.a().a(true, "viola video");
  }
  
  public void o()
  {
    this.jdField_a_of_type_Qyu.g();
    qvr.a().a(false, "viola video");
  }
  ...
  public void q()
  {
    this.jdField_a_of_type_Qyu.i();
    qvr.a().b(this.jdField_a_of_type_AndroidAppActivity);
    qvr.a().b(this);
