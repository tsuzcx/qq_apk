...
{
  qcw(qcv paramqcv, ArticleInfo paramArticleInfo, Context paramContext) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      return;
      str1 = ((rgc)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).b;
    } while (TextUtils.isEmpty(str1));
    String str2 = pay.a("1", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
