...
public class bmxk
{
  private static bmxk jdField_a_of_type_Bmxk;
  private WeakReference<DoodleLayout> jdField_a_of_type_JavaLangRefWeakReference;
  private WeakReference<DoodleLayout> b;
  
  public static bmxk a()
  {
    if (jdField_a_of_type_Bmxk == null) {
      jdField_a_of_type_Bmxk = new bmxk();
    }
    return jdField_a_of_type_Bmxk;
  }
