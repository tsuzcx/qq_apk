...
{
  public atbs(QFileSendBarManager.5 param5) {}
  
  protected Void a(Void... paramVarArgs)
  {
    paramVarArgs = atbn.a(this.a.this$0);
    Object localObject1 = atbn.b(this.a.this$0);
    int i = atbn.a(this.a.this$0);
    if (i == 5)
    {
    ...
    if (paramVarArgs.equals(AppConstants.DATALINE_PC_UIN))
    {
      ...
      paramVarArgs = (amqd)this.a.this$0.a.getBusinessHandler(8);
    ...
    for (;;)
    {
      ...
      else if (!paramVarArgs.a().a((FileManagerEntity)localObject2))
      {
        ...
        continue;
        if (aslg.e().size() > 0) {
          this.a.this$0.a.getFileManagerEngine().a().a(aslg.e(), AppConstants.DATALINE_PC_UIN, 6000, null);
        }
        if ((i & 0x2) == 0) {
          break;
        }
        ...
        if (i == 6002)
        {
          localObject1 = new ArrayList();
          ((ArrayList)localObject1).addAll(aslg.a());
          ((RouterHandler)this.a.this$0.a.getBusinessHandler(48)).a((ArrayList)localObject1, null, null, Long.parseLong(paramVarArgs));
          return null;
        }
        if (i == 9501)
        {
          localObject1 = (aavk)this.a.this$0.a.getBusinessHandler(49);
