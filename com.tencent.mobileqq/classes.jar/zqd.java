...
public class zqd
{
  ...
  public static zqe a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      j = 1;
      if (bhsr.a(paramObject))
      {
        paramObject = "weishi://camera?logsour=3006";
        i = k;
        label105:
        localzqe = new zqe();
        localzqe.jdField_a_of_type_JavaLangString = str1;
        localzqe.jdField_b_of_type_JavaLangString = str3;
        localzqe.jdField_c_of_type_JavaLangString = str2;
        localzqe.jdField_a_of_type_Int = i;
        localzqe.e = str4;
        localzqe.f = paramObject;
        localzqe.g = ((String)localObject);
        localzqe.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localzqe.jdField_d_of_type_JavaLangString = "DOV";
          return localzqe;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localzqe.jdField_d_of_type_JavaLangString = anzj.a(2131715683);
              return localzqe;
              break label105;
            }
          }
  ...
  public static zsg a(Context paramContext, Object paramObject)
  {
    zqe localzqe = a(paramObject);
    if (localzqe == null) {
      return null;
    }
    String str1 = localzqe.jdField_a_of_type_JavaLangString;
    String str2 = localzqe.jdField_b_of_type_JavaLangString;
    String str3 = localzqe.f;
    int j = localzqe.jdField_a_of_type_Int;
    String str4 = localzqe.e;
    int k = localzqe.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bhny.a(paramContext, "com.tencent.qim"))
        {
          bdll.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bhny.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          bdll.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          xjq.a(paramContext);
        }
      }
      label174:
      ...
      {
        bdll.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        bdll.b(null, "dc00899", "grp_story", "", "weishi_share", localzqe.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        bdll.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        bdll.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      bdll.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localzqe.jdField_c_of_type_JavaLangString;
      bdll.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new zsg(paramContext, 2131756036, paramObject);
  ...
  {
    if (!zot.b(paramContext))
    {
      QQToast.a(paramContext, anzj.a(2131715685), 0).a();
      return;
    }
    brhm.a().a();
    ...
    {
      yuk.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    bdll.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    return blhx.a(paramContext, "com.tencent.weishi");
  }
}
