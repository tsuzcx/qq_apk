  ...
  implements bizg
{
  ...
  public aawk(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    // Byte code:
    //   0: new 227	java/util/jar/JarFile
    //   3: dup
    //   4: new 229	java/io/File
    //   7: dup
    //   8: aload_1
    //   9: invokevirtual 100	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   12: invokevirtual 104	android/content/Context:getApplicationInfo	()Landroid/content/pm/ApplicationInfo;
    //   15: getfield 109	android/content/pm/ApplicationInfo:sourceDir	Ljava/lang/String;
    //   18: invokespecial 232	java/io/File:<init>	(Ljava/lang/String;)V
    //   21: invokespecial 235	java/util/jar/JarFile:<init>	(Ljava/io/File;)V
    //   24: invokevirtual 239	java/util/jar/JarFile:entries	()Ljava/util/Enumeration;
    //   27: astore_1
    //   28: new 241	java/util/HashSet
    //   31: dup
    //   32: invokespecial 242	java/util/HashSet:<init>	()V
    //   35: astore_2
    //   36: aload_1
    //   37: invokeinterface 247 1 0
    //   42: ifeq +45 -> 87
    //   45: aload_1
    //   46: invokeinterface 251 1 0
    //   51: checkcast 253	java/util/jar/JarEntry
    //   54: invokevirtual 257	java/util/jar/JarEntry:getName	()Ljava/lang/String;
    //   57: astore_3
    //   58: aload_2
    //   59: aload_3
    //   60: invokeinterface 263 2 0
    //   65: iconst_1
    //   66: if_icmpne +5 -> 71
    //   69: iconst_1
    //   70: ireturn
    ...
    //   82: astore_1
    //   83: aload_1
    //   84: invokevirtual 269	java/lang/Exception:printStackTrace	()V
    //   87: iconst_0
    //   88: ireturn
    //   89: astore_1
    //   90: aload_1
    //   91: invokevirtual 270	java/lang/OutOfMemoryError:printStackTrace	()V
    //   94: goto -7 -> 87
  ...
  private void b()
  {
    ...
    do
    {
      ...
      localObject3 = bkxn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 1;; i = 0)
    {
      String str1 = bkxn.a((Context)localObject1);
      ...
      if (localObject3 != null) {
        localObject1 = ((bizf)localObject3).encode(localObject2);
      }
