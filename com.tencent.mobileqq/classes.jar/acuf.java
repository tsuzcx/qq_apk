...
public class acuf
  implements Runnable
{
  public acuf(FileTransferHandler paramFileTransferHandler, FileManagerEntity paramFileManagerEntity, hummer_resv_21.FileImgInfo paramFileImgInfo, SubMsgType0x4.MsgBody paramMsgBody, FileTransferObserver paramFileTransferObserver, Handler paramHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new acuh(this, arrayOfByte, localFMTransC2CMsgInfo));
      return;
      if ((!this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.hasNoThumb()) && ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nFileType == 0) || (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nFileType == 2))) {
        new Handler(Looper.getMainLooper()).postDelayed(new acug(this), 1000L);
      }
    }
  }
}
