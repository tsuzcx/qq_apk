...
public class qvx
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new qwa(this, Looper.getMainLooper());
  ...
  public qvx(Activity paramActivity, AppRuntime paramAppRuntime, View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131378754));
  }
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    do
    {
      ...
      i = bhvy.K(this.jdField_a_of_type_MqqAppAppRuntime);
    } while (i >= 3);
    bhvy.C(this.jdField_a_of_type_MqqAppAppRuntime, i + 1);
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131378761);
    if (!TextUtils.isEmpty(paramVideoInfo.g)) {
      localTextView.setText(ajya.a(2131716172));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new qvy(this));
      this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new qvz(this));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new VideofeedsUserGuideController.4(this), 300L);
      return;
      localTextView.setText(ajya.a(2131716171));
    }
  }
