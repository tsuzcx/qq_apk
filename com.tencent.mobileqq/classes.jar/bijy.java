...
public class bijy
{
  public static bijf a;
  public static bijj a;
  public static bijw a;
  ...
  public static bijk a(becq parambecq, bijg parambijg)
  {
    if (jdField_a_of_type_Bijj == null) {
      return null;
    }
    return jdField_a_of_type_Bijj.a(parambecq, parambijg);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localbimp.b = "comic_plugin.apk";
    localbimp.d = "comic_plugin";
  ...
  {
    if (jdField_a_of_type_Bijw == null) {
      jdField_a_of_type_Bijw = new bijw();
    }
    for (;;)
    {
      jdField_a_of_type_Bijw.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bijw.deleteObservers();
    }
  }
  
  public static boolean a(Activity paramActivity, Intent paramIntent, String paramString, asor paramasor)
  {
    ...
    localbimp.jdField_a_of_type_JavaLangClass = VipComicProxyActivity.a(paramString);
    localbimp.jdField_a_of_type_AndroidContentIntent = paramIntent;
    localbimp.c = 10000;
    localbimp.jdField_a_of_type_Asor = paramasor;
  ...
  public static boolean a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      do
      {
        ...
        paramAppRuntime = (bimg)paramAppRuntime.getManager(27);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean, bikb arg2)
  {
    boolean bool = false;
  ...
  {
    if (jdField_a_of_type_Bikf == null) {
      jdField_a_of_type_Bikf = new bikf();
    }
    for (;;)
    {
      jdField_a_of_type_Bikf.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bikf.deleteObservers();
    }
  }
}
