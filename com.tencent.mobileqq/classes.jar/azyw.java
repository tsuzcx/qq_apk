...
public class azyw
{
  ...
  public azyw(Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  private CharSequence a(String paramString1, String paramString2, int paramInt)
  {
    ...
    paramString2.setSpan(new banw(this.jdField_a_of_type_AndroidContentContext, 0, 20, 1, 7, 14, paramInt, paramString1), 0, paramString1.length(), 33);
    return paramString2;
  }
  ...
  private void a(String paramString)
  {
    ...
    paramString.setDownloadListener(new azyz(this));
  ...
  private void e()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378809);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378099));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368558));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378799);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378422));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378158));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378324));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378800);
    this.e = this.jdField_a_of_type_AndroidViewView.findViewById(2131378802);
    this.f = this.jdField_a_of_type_AndroidViewView.findViewById(2131378811);
    this.g = this.jdField_a_of_type_AndroidViewView.findViewById(2131375360);
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView = ((SpriteVideoView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376737));
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    default: 
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView.getMeasuredHeight() > 0)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(a(ajya.a(2131713234), paramString.toString(), paramInt1));
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(a(ajya.a(2131713232), String.valueOf(paramInt2), paramInt1));
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_d_of_type_AndroidWidgetTextView.setText(a(ajya.a(2131713233), String.valueOf(paramInt3), paramInt1));
        if (this.g.getMeasuredHeight() != 0) {
          break label440;
        }
        this.g.getViewTreeObserver().addOnGlobalLayoutListener(new azyy(this, paramBoolean));
      }
      break;
    }
    for (;;)
    {
      ...
      i = paramInt1;
      break;
      this.jdField_a_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new azyx(this, str2));
      break label168;
      label440:
  ...
  public void c()
  {
    ...
    if ((localObject1 instanceof QQAppInterface)) {
      bani.a((QQAppInterface)localObject1, "qb_troop_hw_recite_result.mp4", "http://pub.idqqimg.com/pc/misc/files/20180312/59583551a1c748dfaae1e64f6e04ca20.mp4");
    }
