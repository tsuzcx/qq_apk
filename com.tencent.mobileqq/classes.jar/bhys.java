...
public class bhys
{
  private static volatile bhys jdField_a_of_type_Bhys;
  private ITMAssistantExchangeURLListenner jdField_a_of_type_ComTencentTmdatasourcesdkITMAssistantExchangeURLListenner = new bhyt(this);
  ...
  private int a(Bundle paramBundle, String paramString, ApkUpdateDetail paramApkUpdateDetail)
  {
    ...
    bhzm.b("DownloadResolver", "[doDownloadActionBySDK] pParmas =" + paramBundle);
    String str1 = paramBundle.getString(bibw.j);
    if (TextUtils.isEmpty(str1))
    {
      bhzm.e("DownloadResolver", "[doDownloadActionBySDK] url is empty");
      return -1;
    }
    String str14 = paramBundle.getString(bibw.f);
    int i = paramBundle.getInt(bibw.k);
    String str15 = paramBundle.getString(bibw.i);
    String str16 = paramBundle.getString(bibw.l);
    String str13 = paramBundle.getString(bibw.D);
    int j = paramBundle.getInt(bibw.H);
    String str12 = paramBundle.getString(bibw.I);
    ...
    boolean bool4 = paramBundle.getBoolean(bibw.jdField_h_of_type_JavaLangString, true);
    boolean bool5 = paramBundle.getBoolean(bibw.x);
    int k = paramBundle.getInt(bibw.C, 0);
    boolean bool6 = paramBundle.getBoolean(bibw.J, false);
    ...
    String str4 = paramBundle.getString(bibw.K, "");
    ...
    for (;;)
    {
      ...
      try
      {
        ((DownloadInfo)localObject1).jdField_b_of_type_Int = paramBundle.getInt(bibw.jdField_e_of_type_JavaLangString);
        ((DownloadInfo)localObject1).jdField_d_of_type_Long = paramBundle.getLong(bibw.G);
        label534:
        ...
        bhzm.b("DownloadResolver", "[doDownloadActionBySDK] action == Downloader.ACTION_DOWNLOAD");
        bhyo.a().b((DownloadInfo)localObject1);
        continue;
        ...
        ((DownloadInfo)localObject1).a();
        bhyo.a().b((DownloadInfo)localObject1);
        bhzm.c("DownloadResolver", "[doDownloadActionBySDK] action == Downloader.ACTION_UPDATE " + bool1);
        continue;
        return bhyo.a().a(str1);
        localObject1 = localObject2;
        if (!bool2) {
          continue;
        }
        bias.a("305", str15, str17, str12);
        paramString = bhyo.a().b(str1);
        ...
        if (paramString == null)
        {
          ...
          ((DownloadInfo)localObject1).j = paramBundle.getString(bibw.jdField_c_of_type_JavaLangString);
          ((DownloadInfo)localObject1).jdField_b_of_type_Int = paramBundle.getInt(bibw.jdField_e_of_type_JavaLangString);
          ((DownloadInfo)localObject1).jdField_c_of_type_Boolean = paramBundle.getBoolean(bibw.y, true);
          ((DownloadInfo)localObject1).jdField_h_of_type_Int = k;
          ((DownloadInfo)localObject1).n = str13;
          ((DownloadInfo)localObject1).jdField_d_of_type_Int = 0;
          ((DownloadInfo)localObject1).o = str12;
        ...
        ((DownloadInfo)localObject1).a("big_brother_ref_source_key", str10);
        ((DownloadInfo)localObject1).a("hideInstallSuccessPage", str11);
        bhyo.a().a((DownloadInfo)localObject1);
        continue;
        bhyo.a().a(str1, true);
        localObject1 = localObject2;
      }
  ...
  public static bhys a()
  {
    if (jdField_a_of_type_Bhys == null) {}
    try
    {
      if (jdField_a_of_type_Bhys == null) {
        jdField_a_of_type_Bhys = new bhys();
      }
      return jdField_a_of_type_Bhys;
    }
    finally {}
  }
  ...
  {
    bibs.a(paramActivity, paramBundle);
  }
  ...
  public static boolean a(Bundle paramBundle)
  {
    if (paramBundle.getInt(bibw.k) == 5)
    {
      ...
      if (TextUtils.isEmpty(str1))
      {
        bhzm.e("DownloadResolver", "[installApp] url is empty");
        return false;
      }
      String str2 = paramBundle.getString(bibw.f);
      String str3 = paramBundle.getString(bibw.i);
      String str4 = paramBundle.getString(bibw.l);
      ...
      String str8 = paramBundle.getString(bibw.K, "");
      ...
      bias.a("305", str3, str5, (String)localObject);
      localObject = bhyo.a().b(str1);
      if (localObject == null)
      {
        ...
        ((DownloadInfo)localObject).j = paramBundle.getString(bibw.jdField_c_of_type_JavaLangString);
        ((DownloadInfo)localObject).k = paramBundle.getString(bibw.jdField_d_of_type_JavaLangString);
        ((DownloadInfo)localObject).jdField_b_of_type_Int = paramBundle.getInt(bibw.jdField_e_of_type_JavaLangString);
        ((DownloadInfo)localObject).o = paramBundle.getString(bibw.I);
  ...
  {
    bhzm.b("DownloadResolver", "[doDownloadActionByMyApp] pParmas =" + paramBundle + " myAppConfig = " + paramInt);
    ...
    Object localObject1;
    if (paramBundle.getInt(bibw.jdField_e_of_type_JavaLangString, -10) < 0)
    {
      ??? = TMAssistantGetAppDetailTool.getInstance(this.jdField_a_of_type_ComTencentTmdatasourcesdkITMAssistantExchangeURLListenner, bhpc.a().a());
    ...
    do
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        try
        {
          ...
          {
            bhyo.a().b(bhpc.a().a().getString(2131694238));
            return;
          }
        }
      ...
      paramBundle.putInt(bibw.jdField_e_of_type_JavaLangString, ((Integer)localObject1).intValue());
      ...
      if (paramInt == 1)
      {
        ...
        bicl.a().a(paramActivity, paramBundle, new bhyu(this, paramBundle, paramString, paramApkUpdateDetail));
        return;
      }
    } while ((paramInt != 2) && (paramInt != 0));
    bicl.a().b(paramActivity, paramBundle, new bhyv(this, paramBundle, paramString, paramApkUpdateDetail));
  }
  ...
  public List<DownloadInfo> a()
  {
    ...
    {
      bhzm.b("DownloadResolver", localObject1);
      if ((localObject2 != null) && (((Map)localObject2).size() != 0)) {
        break;
      }
      bhzm.e("DownloadResolver", "infos is null!!");
    ...
    if (((Map)localObject2).size() > 0)
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((((DownloadInfo)localObject3).jdField_c_of_type_Int == 0) && (!TextUtils.isEmpty(((DownloadInfo)localObject3).jdField_e_of_type_JavaLangString)) && (((DownloadInfo)localObject3).jdField_c_of_type_Boolean))
        {
          ...
          localObject4 = bhyo.a().a(((DownloadInfo)localObject3).jdField_d_of_type_JavaLangString);
          bhzm.b("DownloadResolver", "\ninfo=" + ((DownloadInfo)localObject3).toString() + "\ntaskInfo:" + a((TMAssistantDownloadTaskInfo)localObject4));
        }
        for (;;)
        {
          ((List)localObject1).add(Long.valueOf(System.currentTimeMillis() - l2));
          break;
          bhzm.e("DownloadResolver", "Info is not SDK && APK task!! \ninfo=" + ((DownloadInfo)localObject3).toString());
        }
      }
    }
    else
    {
      bhzm.e("DownloadResolver", "infos is empty!!");
    }
    localObject2 = new Long[((List)localObject1).size()];
    ((List)localObject1).toArray((Object[])localObject2);
    bhzm.e("DownloadResolver", "Total time Cost:" + (System.currentTimeMillis() - l1) + ";Every loop time cost:" + Arrays.toString((Object[])localObject2));
    return localArrayList;
  }
  ...
  public void a(List<DownloadInfo> paramList, bicf parambicf)
  {
    if (paramList == null)
    {
      bhzm.b("DownloadResolver", "[queryByDownloadManagerV2] infos == null");
      return;
    }
    if (parambicf == null) {
      bhzm.b("DownloadResolver", "[queryByDownloadManagerV2] listener == null");
    }
    ThreadManager.getSubThreadHandler().post(new DownloadProxy.2(this, paramList, parambicf));
  }
