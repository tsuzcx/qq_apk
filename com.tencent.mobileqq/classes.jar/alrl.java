  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public alrl(NewFlowCameraActivity paramNewFlowCameraActivity, Context paramContext)
  {
  ...
  public boolean onDoubleTap(MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaNewFlowCameraActivity.r == 10002) {
      ykv.a("video_shoot", "camera_clkdouble", 0, 0, new String[0]);
    }
    ...
    } while ((alps.a != 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaNewFlowCameraActivity.a != null));
