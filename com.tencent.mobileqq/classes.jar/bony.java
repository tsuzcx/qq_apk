...
public abstract class bony
  extends bopk
{
  private final RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new bonz(this);
  ...
  {
    return new booa(this, this.jdField_a_of_type_DovComQqImCaptureViewSpeedFlexibleRecyclerView.getContext());
  }
