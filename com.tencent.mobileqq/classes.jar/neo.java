  ...
  extends nep
{
  ...
  static
  {
    int[] arrayOfInt1 = { 2, 2, 2 };
    int[] arrayOfInt2 = { 3, 3, 3 };
    int[] arrayOfInt3 = { 3, 3, 2, 2 };
    int[] arrayOfInt4 = { 3, 3, 4, 4 };
    jdField_a_of_type_Array2dOfInt = new int[][] { { 1 }, { 1, 1 }, { 1, 2 }, { 2, 2 }, { 2, 2, 1 }, arrayOfInt1, { 2, 2, 3 }, { 2, 3, 3 }, arrayOfInt2, arrayOfInt3, { 3, 3, 3, 2 }, { 3, 3, 3, 3 }, { 3, 3, 3, 4 }, arrayOfInt4, { 3, 4, 4, 4 }, { 4, 4, 4, 4 } };
  ...
  public neo(Context paramContext, AVGameAppInterface paramAVGameAppInterface)
  {
  ...
  {
    paramArrayOfnes2 = new ArrayList(8);
    int j = paramArrayOfnes1.length;
    int i = 0;
    while (i < j)
    {
      paramList = paramArrayOfnes1[i];
      if (paramList.a()) {
        paramArrayOfnes2.add(paramList);
      }
      i += 1;
    }
    if (paramArrayOfnes2.isEmpty()) {
      return;
    }
    i = paramArrayOfnes2.size();
    i = Math.min(i, i);
    ...
    for (;;)
    {
      paramArrayOfnes1 = a(i, paramInt1, paramInt2);
      paramInt1 = 0;
      for (;;)
      {
        if (paramInt1 >= i) {
        ...
        paramList = (Rect)paramArrayOfnes1.get(paramInt1);
        if (paramList == null) {
          break;
        }
        ((nes)paramArrayOfnes2.get(paramInt1)).b(paramList.left, paramList.top, paramList.right, paramList.bottom);
        ((nes)paramArrayOfnes2.get(paramInt1)).a(0, 0, 0, 0);
        paramInt1 += 1;
      }
      label176:
      break;
