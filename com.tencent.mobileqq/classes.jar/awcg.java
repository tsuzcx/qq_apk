  ...
  extends ContentObserver
{
  ...
  private awch jdField_a_of_type_Awch;
  
  public awcg(Handler paramHandler, Context paramContext)
  {
    super(paramHandler);
  ...
  public void a(awch paramawch)
  {
    this.jdField_a_of_type_Awch = paramawch;
  }
  ...
  public void onChange(boolean paramBoolean, Uri paramUri)
  {
    ...
    if (paramUri == null)
    {
      ...
      if ((localCursor != null) && (localCursor.moveToFirst()))
      {
        ...
        if ((Math.abs(System.currentTimeMillis() / 1000L - l) <= 3L) && (str.toLowerCase().contains("screenshot")) && (this.jdField_a_of_type_Awch != null)) {
          this.jdField_a_of_type_Awch.a(paramUri);
        }
      }
      if (localCursor != null) {
        localCursor.close();
