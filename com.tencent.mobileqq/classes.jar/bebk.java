...
public class bebk
{
  ...
  public TextView a;
  bdjy<Integer> jdField_a_of_type_Bdjy = new bebl(this);
  public beey a;
  public befb a;
  public befy a;
  TouchWebView.OnScrollChangedListener jdField_a_of_type_ComTencentBizUiTouchWebView$OnScrollChangedListener = new bebm(this);
  ...
  public bebk(beey parambeey)
  {
    this.jdField_a_of_type_Beey = parambeey;
    this.jdField_a_of_type_Befb = parambeey.jdField_a_of_type_Befb;
    this.jdField_a_of_type_Befy = new befy(parambeey);
  }
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      localObject2 = null;
      if ((paramInt < this.jdField_c_of_type_Int) || (!this.jdField_a_of_type_Befb.v)) {
        break label94;
      }
      this.jdField_a_of_type_Befb.v = false;
      if (!paramBoolean) {
        break label80;
      }
    ...
    for (;;)
    {
      ...
      {
        localObject1 = localObject2;
        if (!this.jdField_a_of_type_Befb.v)
        {
          this.jdField_a_of_type_Befb.v = true;
          if (paramBoolean)
          {
        ...
        try
        {
          ...
          if (i >= 40300)
          {
            ...
            if (i <= 40313)
            {
              ...
              {
                str1 = str2;
                if (str2.contains(alpo.a(2131715078))) {
  ...
  {
    LayoutInflater.from(this.jdField_a_of_type_Beey.d.getContext()).inflate(2131558692, this.jdField_a_of_type_Beey.d);
    this.jdField_b_of_type_AndroidContentIntent = paramIntent;
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_Beey.d.findViewById(2131375812));
    a(this.jdField_a_of_type_AndroidViewViewGroup);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375959);
    this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidViewView.setPadding(0, -bdkf.b(12.0F), 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368613));
    ...
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368616));
    ...
    a(paramIntent);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368659));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375939));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368644));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368627));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Beey.d.findViewById(2131378058);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378056));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378059));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378054);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bebn(this));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377935));
    e();
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    int j = 0;
    if ((paramIntent == null) || (TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean)) {
      return;
    }
    Object localObject;
    if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x4) == 0L)
    {
      if (!befr.a()) {
    ...
    else
    {
      ...
      this.jdField_a_of_type_Befb.j = paramIntent.getBooleanExtra("ishiderefresh", false);
      this.jdField_a_of_type_Befb.k = paramIntent.getBooleanExtra("ishidebackforward", false);
      boolean bool = paramIntent.getBooleanExtra("hide_left_button", false);
      this.jdField_a_of_type_Befb.l = paramIntent.getBooleanExtra("show_right_close_button", false);
      ...
      if (!this.jdField_a_of_type_Befb.jdField_e_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        localObject = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130840105);
        if ((!this.jdField_a_of_type_Beey.jdField_a_of_type_Befb.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Befb.m)) {
          break label700;
        }
        paramString = bdda.a((Drawable)localObject, -1);
        label306:
    ...
    label844:
    label857:
    for (int i = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity) + 0;; i = 0)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Befb.p)
        {
          ...
          label506:
          if (this.jdField_a_of_type_Befb.l) {
            a(paramIntent.getStringExtra("left_close_button_text"));
          }
          if (TextUtils.isEmpty(this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangString)) {
            break label844;
          }
        }
        try
        {
          paramIntent = new JSONObject(URLDecoder.decode(this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangString));
          i = k;
          ...
          for (paramIntent = paramIntent.getJSONArray("subTextArray");; paramIntent = null)
          {
            ...
            paramString = bdda.a((Drawable)localObject, this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_e_of_type_Int);
            break label306;
            label732:
            if (this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle == null) {
              break label372;
            }
            c(this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_e_of_type_Int);
            break label372;
            m = this.jdField_a_of_type_AndroidViewViewGroup.getTop();
            n = this.jdField_a_of_type_AndroidViewViewGroup.getBottom();
          ...
          a(new bebr(this.jdField_a_of_type_Befb.jdField_a_of_type_Int, i, null, null, paramString));
        }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bdjs localbdjs = new bdjs(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), new bebo(this, paramView, paramInt2));
    localbdjs.setDuration(paramInt3);
    this.jdField_a_of_type_Befb.x = true;
    paramView.startAnimation(localbdjs);
  }
  
  public void a(bebr parambebr)
  {
    int i = -1;
    if (parambebr != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView = new WebViewTopTabView(BaseApplicationImpl.getContext());
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonNum(parambebr.jdField_b_of_type_Int, parambebr.jdField_a_of_type_Int);
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonText(parambebr.jdField_a_of_type_ArrayOfJavaLangString);
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonBackgroundResource(2130850111, 2130850112, 2130850113);
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonTextColorStateList(2131167181);
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setLeftAndRightPaddingByDp(10);
      a(this.jdField_a_of_type_Befb.v);
    }
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setOnCheckedChangeListener(new bebq(this));
      if (this.jdField_a_of_type_Befy != null) {
        this.jdField_a_of_type_Befy.a(parambebr.jdField_b_of_type_JavaLangString, true);
      }
      localTouchWebView = this.jdField_a_of_type_Beey.a();
      if ((localTouchWebView != null) && (!TextUtils.isEmpty(parambebr.jdField_a_of_type_JavaLangString)))
      {
        str = "ok";
        if (!TextUtils.isEmpty(parambebr.jdField_b_of_type_JavaLangString)) {
          break label263;
        }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localTouchWebView.callJs(parambebr.jdField_a_of_type_JavaLangString, new String[] { localJSONObject.toString() });
          return;
  ...
  public void a(bebs parambebs)
  {
    Object localObject1;
    Object localObject2;
    boolean bool;
    if ((parambebs != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null))
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView;
      localObject2 = parambebs.jdField_a_of_type_ArrayOfInt;
      if (parambebs.jdField_a_of_type_Int != 1) {
        break label56;
      }
      bool = true;
      ((WebViewTopTabView)localObject1).setRedHotStatus((int[])localObject2, bool);
      localObject2 = this.jdField_a_of_type_Beey.a();
      if (localObject2 != null) {
        break label61;
      }
    }
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          if (TextUtils.isEmpty(parambebs.jdField_a_of_type_JavaLangString)) {
            break;
          }
          ((TouchWebView)localObject2).callJs(parambebs.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject3).toString() });
          return;
          try
          {
  ...
  public void a(TouchWebView paramTouchWebView)
  {
    ...
    if ((this.jdField_a_of_type_Befb.s) && (localViewGroup != null) && (!this.jdField_a_of_type_Befb.w) && (a()))
    {
      this.jdField_a_of_type_Befb.w = true;
      this.jdField_a_of_type_Befb.t = true;
      this.jdField_a_of_type_Befb.v = true;
      localViewGroup.setBackgroundResource(2130850128);
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
        this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
      }
      paramTouchWebView.setOnScrollChangedListenerForBiz(new bebp(this));
    }
  }
  ...
  public void a(TouchWebView paramTouchWebView, boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation = new bdjs(Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), this.jdField_a_of_type_Bdjy);
      ...
      this.jdField_b_of_type_AndroidViewAnimationAnimation = new bdjs(Integer.valueOf(paramInt3), Integer.valueOf(paramInt2), this.jdField_a_of_type_Bdjy);
  ...
  {
    if ((this.jdField_a_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
      localObject = (RelativeLayout)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131377935);
    } while (localObject == null);
    paramWebView = (TextView)((RelativeLayout)localObject).findViewById(2131377975);
    Object localObject = (TextView)((RelativeLayout)localObject).findViewById(2131377914);
    if (paramBoolean)
    {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      label70:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131690884);
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt1, int paramInt2, JsBridgeListener paramJsBridgeListener, View.OnClickListener paramOnClickListener, absf paramabsf)
  {
      ...
      if (paramInt1 == 0)
      {
        ...
        try
        {
          ...
          if ((paramString1 != null) && (i == 0))
          {
            ...
            if (this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject.has("txtclr"))
            {
              paramString2 = this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject.optString("txtclr", "");
              if (!TextUtils.isEmpty(paramString2))
              {
          ...
          try
          {
            ...
            paramString1 = bdda.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), paramInt1);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
    if ((this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) || (!(this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)))
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      j();
    }
      ...
      default: 
        ...
        if (paramInt1 != 0)
        {
          if (this.jdField_b_of_type_AndroidWidgetImageView == null)
          {
            ...
            paramString3 = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375938);
            paramString3 = new RelativeLayout.LayoutParams(-2, -2);
            paramString3.addRule(7, 2131368627);
            paramString3.addRule(6, 2131368627);
    ...
    for (;;)
    {
      ...
      paramBoolean = false;
      break label457;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843440, 2130843439);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(bdda.a(this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130843440), this.jdField_a_of_type_AndroidWidgetImageView.getResources().getColor(2131166898)));
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692821));
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843438, 2130843438);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692820));
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130840105, 2130840105);
      ...
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839192, 2130839192);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692824));
      break label597;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843483);
      ...
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130842155, 2130842158);
      ...
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130849499, 2130849503);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131689628));
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130838650, 2130838650);
      ...
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130849641, 2130849641);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692823));
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130845832, 2130845831);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692823));
      break label597;
      ...
      localLayoutParams.rightMargin = bdkf.b(10.0F);
      paramString3.setLayoutParams(localLayoutParams);
      break label597;
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130840105, 2130840105);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131719870));
      break label597;
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130843261);
      break label785;
  ...
  public void a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      if ((paramJSONObject.length() > 0) && (!this.jdField_a_of_type_Befb.w))
      {
        this.jdField_a_of_type_Befb.w = a();
        if ((this.jdField_a_of_type_Befb.C) && (this.jdField_a_of_type_Beey.jdField_c_of_type_AndroidViewView != null)) {
          this.jdField_a_of_type_Beey.jdField_c_of_type_AndroidViewView.setPadding(0, (int)bdcq.a(BaseApplicationImpl.getApplication(), 30.0F), 0, 0);
        }
      }
      if (paramJSONObject == null) {
        return;
      }
      if (!this.jdField_a_of_type_Befb.w) {
        return;
      }
      if (QLog.isColorLevel()) {
    ...
    catch (Exception paramJSONObject)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        this.jdField_a_of_type_Befb.jdField_d_of_type_Int = j;
        return;
        continue;
        i = -1;
        continue;
    ...
    if ((this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null))
    {
      ...
      {
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(i);
        azib.a(true, i, this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity.getWindow());
      }
    }
    else
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        {
          localObject1 = bdda.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), i);
        ...
        localObject1 = bdda.a(this.jdField_a_of_type_AndroidWidgetTextView.getBackground(), i);
        if (localObject1 != null) {
          this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable((Drawable)localObject1);
        }
        localObject1 = bdda.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), i);
        if (localObject1 != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
          c(i);
        }
        localObject1 = this.jdField_c_of_type_AndroidViewView.findViewById(2131370555);
        localObject2 = bdda.a(((View)localObject1).getBackground(), i);
        if (localObject2 != null) {
        ...
        {
          if ((TextUtils.isEmpty(this.jdField_b_of_type_AndroidWidgetTextView.getText())) && (!TextUtils.isEmpty(this.jdField_a_of_type_Beey.jdField_a_of_type_JavaLangString))) {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Beey.jdField_a_of_type_JavaLangString);
          }
          ...
          if ((paramBoolean) && (i > 0))
          {
            a(localViewGroup, this.jdField_a_of_type_Befb.jdField_d_of_type_Int, j, i);
            return;
          }
        }
      }
  ...
  {
    this.jdField_a_of_type_Befb.v = paramBoolean;
  ...
  public boolean a()
  {
    if ((!this.jdField_a_of_type_Beey.jdField_a_of_type_Befb.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Befb.m) && (this.jdField_a_of_type_AndroidViewViewGroup != null) && (this.jdField_a_of_type_Beey.d != null) && (Build.VERSION.SDK_INT >= 17))
    {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Befb.E)
    {
      if ((!this.jdField_a_of_type_Befb.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Befb.m))
      {
        Resources localResources = this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity.getResources();
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(localResources.getColor(2131167114));
        if ((this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)) {
          this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(0);
        }
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetTextView, true, 2130849477, 2130849987);
      this.jdField_a_of_type_Beey.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130840105, 2130840101);
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)) {
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.getBackground().mutate().setAlpha(paramInt);
      }
  ...
  public void b(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Beey.a();
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Beey.a() == null) || (this.jdField_a_of_type_Beey.a().getPluginEngine() == null)) {}
    WebViewPlugin localWebViewPlugin;
    do
    {
      return false;
      localWebViewPlugin = this.jdField_a_of_type_Beey.a().getPluginEngine().a(45, false);
    } while (((localWebViewPlugin instanceof UiApiPlugin)) && (((UiApiPlugin)localWebViewPlugin).g));
    if ((this.jdField_a_of_type_Befb.F) || (this.jdField_a_of_type_Befb.G)) {}
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!this.jdField_a_of_type_Beey.jdField_a_of_type_Befb.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity.getWindow().clearFlags(1024);
      }
    }
    for (;;)
    {
      ...
      b(0);
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
      this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity.getWindow().addFlags(1024);
    }
  }
  ...
  public void c(int paramInt)
  {
    if (b())
    {
      View localView = this.jdField_c_of_type_AndroidViewView.findViewById(2131370555);
      localView.setBackgroundDrawable(bdda.a(localView.getBackground(), paramInt));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
    {
      if ((paramBoolean) && (b()))
      {
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.n = 100;
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.q();
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.e(true);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.e(false);
  }
  ...
  public void f(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentWidgetFadeIconImageView != null) && (this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getVisibility() == 0))
    {
      localDrawable1 = bdda.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), paramInt);
    ...
    if (localDrawable2 != null)
    {
      ...
      localDrawable2 = bdda.a(localDrawable2, paramInt);
      if (localDrawable2 != null) {
    ...
    if (localDrawable1 != null)
    {
      ...
      localDrawable1 = bdda.a(localDrawable1, paramInt);
      if (localDrawable1 != null)
      {
  ...
  public void g()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColorStateList(2131166895));
    this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColorStateList(2131166895));
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColor(2131166898));
    Object localObject;
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
    ...
    if (c())
    {
      localObject = this.jdField_c_of_type_AndroidViewView.findViewById(2131370555);
  ...
  {
    this.jdField_a_of_type_Befb.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null) {
  ...
  public void h()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Befb.v) && (this.jdField_a_of_type_Befb.u))
      {
        this.jdField_a_of_type_Befb.u = false;
        this.jdField_a_of_type_Befb.u = true;
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130850128);
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        return;
      }
    } while ((this.jdField_a_of_type_Befb.v) || (!this.jdField_a_of_type_Befb.u));
    this.jdField_a_of_type_Befb.u = false;
    this.jdField_a_of_type_Befb.u = true;
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131166957));
    g();
  }
