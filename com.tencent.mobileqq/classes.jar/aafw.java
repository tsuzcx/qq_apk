...
public class aafw
  implements Runnable
{
  public aafw(ARWorldCupGlobalSceneRenderable paramARWorldCupGlobalSceneRenderable, int paramInt1, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        ThreadManager.getSubThreadHandler().post(new aafx(this));
        break;
      } while (this.b != 1);
      ...
      ThreadManager.getUIHandler().post(new aafy(this));
      i += 1;
    } while ((i <= 0) || (i >= 14));
