...
public class albq
  extends BaseAdapter
{
  public albq(DraggableGridView paramDraggableGridView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == DraggableGridView.a())
    {
      if (paramView == null)
      {
        paramViewGroup = (MeasureGridView)LayoutInflater.from(this.a.getContext()).inflate(2130969874, paramViewGroup, false);
        paramViewGroup.setClickable(false);
        paramViewGroup.setNumColumns(DraggableGridView.a(this.a));
        paramViewGroup.setAdapter(new albr(this.a, paramInt / 2));
      ...
      for (;;)
      {
        ...
        ((albr)paramViewGroup.getAdapter()).a(paramInt / 2);
      }
    }
    if (paramView == null) {
