...
public class rpj
  extends pzf<ColumnInfo, ByteString>
{
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = (QQAppInterface)pha.a();
  private boolean jdField_a_of_type_Boolean;
  private int b;
  
  private void a(pzk<ColumnInfo, ByteString> parampzk, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          parampzk.a(true, paramArrayOfByte.is_end.get(), paramArrayOfByte.total.get(), localArrayList, ByteString.encodeUtf8(paramArrayOfByte.cookie.get().toStringUtf8()), paramInt, "");
          return;
        }
      }
      catch (Exception paramArrayOfByte)
      {
        ...
        parampzk.a(false, true, 0, new ArrayList(), null, paramInt, "");
        return;
      }
      i += 1;
    }
  ...
  public void a(ByteString paramByteString, pzk<ColumnInfo, ByteString> parampzk)
  {
    ...
    nir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new rpk(this, parampzk), paramByteString.toByteArray(), "OidbSvc.0xe31", 3633, 3);
  }
  
  public void a(pzj<ColumnInfo> parampzj) {}
}
