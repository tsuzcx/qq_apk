...
public abstract class rpj<BEAN, HOLDER extends rpk>
  extends BaseAdapter
{
  @NotNull
  ...
  public rpj(@NotNull Context paramContext)
  {
  ...
  public View getView(int paramInt, @Nullable View paramView, @Nullable ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      a(this.jdField_a_of_type_JavaUtilList.get(paramInt), (rpk)localObject);
