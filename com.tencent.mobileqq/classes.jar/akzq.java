  ...
  implements akzo
{
  ...
  private final String jdField_a_of_type_JavaLangString = ajyc.a(2131700752);
  ...
  public akzq(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqArARRecordARVideoRecordButtonView = ((ARVideoRecordButtonView)paramView.findViewById(2131369654));
    this.c = paramView.findViewById(2131363901);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362722);
    this.jdField_a_of_type_Boolean = akzh.a();
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    }
    this.c.setOnClickListener(null);
    this.c.setOnTouchListener(new akzr(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362724));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362723));
  ...
  public void a(akzp paramakzp)
  {
    this.jdField_a_of_type_Akzp = paramakzp;
  }
