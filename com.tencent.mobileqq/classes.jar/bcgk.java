...
public class bcgk
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)ayvw.a(-2043);
    ...
    if (paramTroopTipsEntity.highlightNum != 0) {
      bclk.a(localMessageForGrayTips, paramTroopTipsEntity.highlightItems);
    }
    if (paramTroopTipsEntity.optShowLatest == 1) {
      localMessageForGrayTips.shmsgseq = 0L;
    }
    if (!alsh.a(paramQQAppInterface, localMessageForGrayTips, false))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((bcic)paramQQAppInterface.getManager(132)).a(paramTroopTipsEntity.troopUin))
      {
        bbku localbbku = new bbku();
        Object localObject1 = new bbku();
        ((bbku)localObject1).r.a(localMessageForGrayTips.shmsgseq, localMessageForGrayTips.uniseq);
        localbbku.a((bbku)localObject1);
        localMessageForGrayTips.mMessageInfo = ((bbku)localObject1);
        ((aubr)paramQQAppInterface.getManager(37)).a(paramTroopTipsEntity.troopUin, localbbku);
        Object localObject2 = new abnu(paramQQAppInterface);
        localObject1 = ((abnu)localObject2).jdField_a_of_type_Amjk;
        localObject2 = ((abnu)localObject2).jdField_a_of_type_JavaUtilMap;
        localObject1 = ((amjk)localObject1).a(paramTroopTipsEntity.troopUin, 1);
        int i = localbbku.a(paramQQAppInterface, true, paramTroopTipsEntity.troopUin);
        if (i >= ((RecentUser)localObject1).msgType)
        {
          ((RecentUser)localObject1).msgType = i;
          ((RecentUser)localObject1).msg = bbku.a(paramQQAppInterface, paramTroopTipsEntity.troopUin, localbbku, ((RecentUser)localObject1).msg, localMessageForGrayTips, true);
          ((Map)localObject2).put(abot.a(paramTroopTipsEntity.troopUin, 1), localObject1);
        }
        ((alzf)paramQQAppInterface.a(20)).notifyUI(80, true, null);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((alzf)paramQQAppInterface.a(20)).notifyUI(61, true, new Object[] { paramString, str, Boolean.valueOf(false) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong)
  {
    ...
    String str = ((Resources)localObject).getString(2131697939);
    localObject = ((Resources)localObject).getString(2131697935);
    ...
    for (String str = "";; str = paramString1)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString1)) {
          bckr.a(paramQQAppInterface, paramString1, i);
        }
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, bcgm parambcgm, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      if (QLog.isColorLevel())
      {
        parambcgm = new StringBuilder().append("checkIdentity error. app null: ");
      ...
      {
        parambcgm = parambcgm.append(String.valueOf(paramBoolean)).append(", troopUin: ");
        paramQQAppInterface = paramString1;
        if (TextUtils.isEmpty(paramString1)) {
          paramQQAppInterface = "";
        }
        paramString1 = parambcgm.append(paramQQAppInterface).append(", memberUin: ");
    ...
    ((TroopManager)paramQQAppInterface.getManager(52)).a(paramString1, paramString2, new bcgl(paramString1, paramString2, paramBoolean, paramQQAppInterface, parambcgm));
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      Object localObject2 = arni.a(localFileInfo);
  ...
  private static void b(bcgm parambcgm, int paramInt)
  {
    if (parambcgm == null) {
      return;
    }
    ...
    {
      parambcgm.a(paramInt);
      return;
    }
    ThreadManager.getUIHandler().post(new HWTroopUtils.2(parambcgm, paramInt));
  }
