  ...
  extends BaseAdapter
{
  ...
  private azvp(ProfileLabelPanelAdapter paramProfileLabelPanelAdapter) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      ((View)localObject1).setBackgroundResource(2130850561);
      ...
      if (((ProfileLabelInfo)localObject2).labelStatus == ProfileLabelInfo.STATUS_CHECKED) {
        this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileLabelPanelAdapter.jdField_a_of_type_Azvn.a((ProfileLabelInfo)localObject2, paramView);
      }
    }
    for (;;)
    {
