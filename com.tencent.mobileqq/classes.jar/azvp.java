  ...
  extends azuz
{
  ...
  public azvp(QQAppInterface paramQQAppInterface, View paramView, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof agcx)))
    {
      paramQQAppInterface = (agcx)paramQQAppInterface;
    ...
    {
      return;
      if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof akie)))
      {
        paramQQAppInterface = (akie)paramQQAppInterface;
  ...
  public boolean a(View paramView, String paramString)
  {
    ...
    {
      return false;
      paramView = paramView.findViewById(2131371014);
      if (paramView == null)
      {
        int i;
        ...
        for (paramView = ((azus)this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mStructMsgItemLists.get(0)).h;; paramView = "")
        {
      ...
      paramView = (azxh)paramView.getTag();
    ...
    if ((paramView != null) && (paramView.size() > 0))
    {
      ...
      if ((!bool1) && (!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(paramString)) && (!bool2))
      {
        ...
        {
          if (paramView != null) {
            auud.a(paramView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext, 1);
          }
          return true;
        }
      }
      ...
      alxn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006390");
    }
    for (;;)
    {
      return true;
      label272:
      alxn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B3");
      continue;
      label284:
      if (bool2) {
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          alxn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006391");
        } else {
          alxn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B4");
        }
      }
    }
  }
  ...
  public boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        bjdt.a((Activity)localContext, localException1, (BaseBusinessAlbumInfo)localObject3, -1, paramString);
        continue;
        long l = 0L;
        continue;
        ...
        bjdt.a((Activity)localContext, paramString, this.c, 0, 0, 0);
        continue;
        if (!bjdt.a((Activity)localContext, localException1, "biz_src_jc_aio")) {
          continue;
        }
        return true;
        ...
        return true;
        if ((!baic.a(paramString)) && (localStructMsgForGeneralShare.mSourceAppid != baic.jdField_a_of_type_Long)) {
          continue;
        }
        ...
        return true;
        if ((!(localContext instanceof BaseActivity)) || (!auet.a((BaseActivity)localContext, (String)localObject2, localStructMsgForGeneralShare.message))) {
          continue;
        }
        return true;
        ...
        if ((TextUtils.isEmpty(str2)) || (!bdeu.b(localStructMsgForGeneralShare.uin))) {
          continue;
        }
        ...
        paramString = bdib.a(localNumberFormatException, localContext, Uri.parse("mqqapi://card/show_pslcard?" + ndd.a(paramString)).toString());
        if (paramString == null) {
          continue;
        }
        paramString.c();
        ...
        if (!bkbx.a(this.jdField_a_of_type_AndroidContentContext, str2)) {
          continue;
        }
        return true;
        ...
        return true;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataChatMessage == null) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.istroop != 0) || (!bdeu.b(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie")))) {
          continue;
        }
        paramString = bdeu.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie"));
        if (paramString == null) {
          continue;
        }
        ...
        try
        {
          ...
          if (localStructMsgForGeneralShare.uinType == 0)
          {
            ...
            aeoy.a((Intent)localObject4, localNumberFormatException, localStructMsgForGeneralShare.message);
            ...
            bool = aojt.a(localNumberFormatException, localStructMsgForGeneralShare.uin);
            ...
            {
              paramString = "https://ti.qq.com/honest-say/group.html?_bid=3104&_qStyle=1&_wv=9191&_nav_alpha=0&_nav_txtclr=FFFFFF&_nav_titleclr=FFFFFF&_nav_anim=true&_wwv=128&gc=$GCODE$&src_type=share&from=appstore_aio&adtag=qq_to_qq".replace("$GCODE$", auwx.a(localStructMsgForGeneralShare.uin));
              ...
              if ((localContext instanceof FragmentActivity))
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if ((paramString != null) && ((paramString instanceof TroopChatPie))) {
                    aojt.a((TroopChatPie)paramString);
                  }
                }
              }
            }
            ...
            QQToast.a(BaseApplicationImpl.getContext(), aojt.jdField_a_of_type_JavaLangString, 0).a();
            return false;
          }
        }
        ...
        paramString = bclg.a(localStructMsgForGeneralShare, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(paramString)) {
          continue;
        }
        ((Intent)localObject4).removeExtra("url");
        ...
        catch (Exception localException2)
        {
          ...
          continue;
          azri.a(BaseApplication.getContext()).a(localNumberFormatException, "sha_click", 1, "", "", String.valueOf(localStructMsgForGeneralShare.mSourceAppid));
        }
        ...
        aemu.a(localContext, (Intent)localObject4, str2);
        azqs.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, str2, "", "", "");
        if (!bool) {
          continue;
        }
        azri.a(BaseApplication.getContext()).a(localNumberFormatException, str1, "Game_center", "Clk_game_in", 0, 1, null, String.valueOf(localStructMsgForGeneralShare.mSourceAppid), null, null, null);
        continue;
        if (!QLog.isColorLevel()) {
          continue;
        }
        ...
        azqs.b(localNumberFormatException, "CliOper", "", "", "0X80052BB", "0X80052BB", 0, 0, "", "", "", "");
        continue;
        azqs.b(localNumberFormatException, "CliOper", "", "", "0X80052BC", "0X80052BC", 0, 0, "", "", "", "");
        continue;
        i = 2;
        continue;
        continue;
      ...
      azqs.b(null, "CliOper", "", (String)localObject3, "0X80061B0", "0X80061B0", i, 0, str1, (String)localObject4, (String)localObject1, str2);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mMsgServiceID == 107)
      {
        ...
        {
          StructMsgForGeneralShare.receiptServer = new azvq(this, "receipt_msg");
      ...
      l = bdff.a(localStructMsgForGeneralShare.mSourceAppid);
      ...
      if ((localContext instanceof FragmentActivity))
      {
        ...
        if (localObject3 != null)
        {
          ...
          {
            localObject4 = (agti)localObject3;
            ((agti)localObject4).z += 1;
            localObject3 = (agti)localObject3;
            ((agti)localObject3).x += 1;
          }
        }
      }
      if (!c(paramString)) {
      ...
      localObject1 = bjea.a();
      ((bjea)localObject1).jdField_a_of_type_JavaLangString = str1;
      ((bjea)localObject1).b = localQQAppInterface.getCurrentNickname();
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        continue;
      }
      bjdt.a((Activity)localContext, (bjea)localObject1, paramString, "mqqChat", -1);
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      paramString1 = bdib.a(localQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
      if (paramString1 == null) {
        break;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (bdeu.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.senderuin))) {
