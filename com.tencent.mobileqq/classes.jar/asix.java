...
public class asix
  implements ashs, asnm
{
  protected int a;
  public long a;
  private asdv jdField_a_of_type_Asdv = new asiy(this);
  public asic a;
  ...
  public asix(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  {
    a(1005);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.uniseq, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType, 15, null, paramasdr.jdField_a_of_type_Int, paramasdr.jdField_a_of_type_JavaLangString);
    ...
    int i = paramasdr.jdField_a_of_type_Int;
    String str = paramasdr.jdField_a_of_type_JavaLangString;
    if (paramasdr.jdField_a_of_type_Int == 0)
    {
      i = 9048;
  ...
  private void a(asdr paramasdr, List<String> paramList)
  {
    boolean bool2 = false;
    boolean bool3 = true;
    String str1 = null;
    short s = paramasdr.jdField_a_of_type_Short;
    boolean bool1;
    if ((asld.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (paramasdr.jdField_d_of_type_Int == 2) && (!TextUtils.isEmpty(paramasdr.jdField_c_of_type_JavaLangString)))
    {
      str1 = paramasdr.jdField_c_of_type_JavaLangString;
      s = paramasdr.jdField_b_of_type_Short;
      if (s == 0)
      {
        s = 443;
        bool1 = true;
    ...
    for (;;)
    {
      ...
      localArrayList.add(0, paramasdr.jdField_b_of_type_JavaLangString + ":" + s);
      Object localObject = new ArrayList();
      if (paramList != null) {
        ((List)localObject).addAll(paramList);
      }
      ((List)localObject).add(0, paramasdr.jdField_b_of_type_JavaLangString);
      if (!d()) {
        this.jdField_c_of_type_Boolean = bool1;
      }
      if (b(paramasdr))
      {
        QLog.i("OfflineSendWorker<FileAssistant>", 1, "[IPv6-File] offline upload. is config enable IPv6. domain[" + paramasdr.jdField_d_of_type_JavaLangString + "]");
        paramList = new asgw(paramasdr.jdField_d_of_type_JavaLangString, s);
        paramList = asgv.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 1);
        if ((paramList != null) && (!paramList.a()))
        {
          ...
          asgv.a(paramList.jdField_a_of_type_JavaUtilList, localArrayList, false, false);
          asgv.a(paramList.jdField_a_of_type_JavaUtilList, (List)localObject, true, false);
      ...
      for (;;)
      {
        a(paramasdr, bool1, str1, s, localArrayList, (List)localObject, bool2);
        return;
  ...
  private void a(asdr paramasdr, boolean paramBoolean1, String paramString, short paramShort, List<String> paramList1, List<String> paramList2, boolean paramBoolean2)
  {
    ThreadManager.post(new OfflineSendWorker.4(this, paramasdr, paramBoolean1, paramString, paramList1, paramList2, paramShort, paramBoolean2), 5, null, false);
  }
  ...
  private void a(String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    if (QLog.isColorLevel()) {
      QLog.i("OfflineSendWorker<FileAssistant>", 1, "start OfflineFileHitReq:" + bbko.a());
    }
    atae.a().execute(new OfflineSendWorker.2(this, paramString, paramLong, paramArrayOfByte3, paramArrayOfByte4, paramArrayOfByte2, paramArrayOfByte1));
    this.jdField_e_of_type_Boolean = false;
    this.jdField_a_of_type_Int = 1;
  }
  
  private void a(String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong, asdv paramasdv, FileManagerEntity paramFileManagerEntity)
  {
    paramasdv = new asyo();
    paramasdv.jdField_a_of_type_JavaLangString = paramFileManagerEntity.peerUin;
    paramasdv.jdField_b_of_type_ArrayOfByte = paramArrayOfByte2;
    paramasdv.jdField_a_of_type_ArrayOfByte = paramArrayOfByte1;
    paramasdv.jdField_a_of_type_Long = paramFileManagerEntity.fileSize;
    paramFileManagerEntity.strFileMd5 = asnl.a(paramArrayOfByte3);
    paramasdv.jdField_c_of_type_ArrayOfByte = paramArrayOfByte3;
    ...
    while (i != 0)
    {
      ...
      paramasdv.jdField_a_of_type_Boolean = true;
      paramasdv.jdField_a_of_type_Int = 1700;
      paramString = aszt.a(new String(paramArrayOfByte1));
      if (paramString == null)
      {
        a(null, 0);
        return;
      ...
      {
        k();
        paramFileManagerEntity.strFileSHA = asnl.a(paramString);
        a(paramString);
        paramasdv.e = paramString;
        a(false, paramasdv.e);
        paramasdv.jdField_d_of_type_ArrayOfByte = aszt.b(new String(paramArrayOfByte1));
        paramasdv.f = aszt.d(new String(paramArrayOfByte1));
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(paramasdv, this.jdField_a_of_type_Asdv, paramFileManagerEntity);
      return;
      ...
      {
        paramasdv.jdField_a_of_type_Int = 1600;
        arrayOfByte = aszt.d(new String(paramArrayOfByte1));
        if (arrayOfByte == null)
        {
          a(null, 0);
          return;
  ...
  private boolean a(asdr paramasdr)
  {
    return (!paramasdr.jdField_b_of_type_Boolean) && ((paramasdr.jdField_b_of_type_JavaLangString == null) || (paramasdr.jdField_b_of_type_JavaLangString.length() == 0));
  }
  ...
  private void b(asdr paramasdr)
  {
    ...
    if (paramasdr.jdField_a_of_type_JavaLangString != null) {
      str = paramasdr.jdField_a_of_type_JavaLangString;
    }
    b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, i, str);
    a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, i, str);
  }
  
  private boolean b(asdr paramasdr)
  {
    return (!TextUtils.isEmpty(paramasdr.jdField_d_of_type_JavaLangString)) && (asgv.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1));
  }
  ...
  private void o()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bUseMediaPlatform, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_Asdv);
    aszs localaszs = new aszs();
    localaszs.jdField_b_of_type_JavaLangString = "send_file_suc";
  ...
  public asic a(asdr paramasdr, List<String> paramList, int paramInt, boolean paramBoolean, String paramString)
  {
    return null;
  }
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    {
      l1 = l2;
      if (this.jdField_a_of_type_Asic != null)
      {
        l1 = l2;
        if (this.jdField_a_of_type_Asic.a() > this.jdField_a_of_type_Asic.b()) {
          l1 = this.jdField_a_of_type_Asic.a() - this.jdField_a_of_type_Asic.b();
        }
      }
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUp", this.jdField_a_of_type_Long, null, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, null, paramString2, 0, paramString1, null, localBundle);
      return;
    }
    aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUp", this.jdField_a_of_type_Long, this.jdField_a_of_type_Asic.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Asic.a(), paramString2, this.jdField_a_of_type_Asic.b(), paramString1, null, localBundle);
  }
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    {
      paramInt = 9001;
      paramString1 = "[Http_RespValue_Null]" + aszt.a();
    }
    for (;;)
    {
  ...
  protected void b(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_a_of_type_Long, null, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, null, null, 0, paramString2, null, localBundle);
      return;
    }
    aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_a_of_type_Long, this.jdField_a_of_type_Asic.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Asic.a(), paramString2, this.jdField_a_of_type_Asic.b(), paramString1, null, localBundle);
  }
  ...
  protected void b(String paramString)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      {
        l1 = l2;
        if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize > this.jdField_a_of_type_Asic.b()) {
          l1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize - this.jdField_a_of_type_Asic.b();
        }
      }
    }
    Bundle localBundle = new Bundle();
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUp", this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, this.jdField_a_of_type_Asic.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, l1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Asic.b(), paramString, localBundle);
      if (!d()) {
        aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, this.jdField_a_of_type_Asic.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, l1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Asic.b(), paramString, localBundle);
      }
    }
    label327:
    do
    ...
    aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, null, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, l1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, 0, paramString, localBundle);
  }
  ...
  public int c()
  {
    ...
    while (this.jdField_a_of_type_Asic == null) {
      return 0;
    }
    return (int)(this.jdField_a_of_type_Asic.a() * 100L / this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize);
  }
  ...
  protected int d()
  {
    ...
    return ataw.c(this.jdField_a_of_type_Asic.a());
  }
  ...
  public void d()
  {
    ...
    l = 0L;
    if (this.jdField_a_of_type_Asic != null) {
      l = this.jdField_a_of_type_Asic.a();
    }
    a(l, 9037, str);
    b(l, 9037, str);
  }
  ...
  {
    c(System.currentTimeMillis());
    if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Asic != null)) {
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Asic.a();
    }
    o();
  }
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.setCloudType(3);
    a(1003);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.uniseq, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType, 14, new Object[] { this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize), Boolean.valueOf(true), this.jdField_a_of_type_Asic.a() }, 0, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bUseMediaPlatform, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_Asdv);
    aszs localaszs = new aszs();
    localaszs.jdField_b_of_type_JavaLangString = "send_file_suc";
    localaszs.jdField_a_of_type_Int = 1;
  ...
  public void m()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        arrayOfByte3 = aszt.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath());
      ...
      a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, arrayOfByte2, localUnsupportedEncodingException, arrayOfByte3, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Asdv, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
