...
{
  public aqrx(SwipePostTableLayout paramSwipePostTableLayout) {}
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    for (boolean bool = SwipePostTableLayout.a(this.a).a(localColorNote.getServiceType(), localColorNote.getSubType());; bool = false)
    {
      ...
      if ((f1 < 0.0F) && (f2 < 0.5F))
      {
        ...
        this.a.jdField_a_of_type_Aqrt.sendEmptyMessage(1);
        this.a.postInvalidate();
      }
      for (;;)
      {
        if (this.a.jdField_a_of_type_Aqrw != null) {
          this.a.jdField_a_of_type_Aqrw.a();
        }
        return super.onFling(paramMotionEvent1, paramMotionEvent2, paramFloat1, paramFloat2);
        label254:
