...
public class uvg
  extends uur
  implements View.OnClickListener, azgl, behi, sse
{
  ...
  WeakReference<uvl> jdField_a_of_type_MqqUtilWeakReference;
  ...
  public uvg(@NonNull uut paramuut)
  {
    super(paramuut);
  ...
  private void k()
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302847)).setText(ajjy.a(2131638054));
      ...
      g();
      j();
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new uvh(this));
      this.jdField_a_of_type_Vfe = new vfe(a());
      this.jdField_a_of_type_Vfe.a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)a(2131307634));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        a(true);
      } while (!(paramObject instanceof uts));
      paramObject = (uts)paramObject;
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramObject.jdField_a_of_type_Uvl);
      paramObject = paramObject.jdField_a_of_type_JavaLangString;
      a(this.jdField_b_of_type_JavaUtilArrayList, paramObject);
    } while (this.jdField_a_of_type_Vfe == null);
    this.jdField_a_of_type_Vfe.a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
  ...
  {
    urk.b("Q.qqstory.publish.edit.EditVideoPoi", "onPOIListRequestResult.");
    ...
    if ((paramInt == 0) && (paramssf != null)) {
      if (!paramssf.a())
      {
        ...
        urk.a("Q.qqstory.publish.edit.EditVideoPoi", "onPOIListRequestResult, CurrentPOIList : %s , CurrentPOI : %s .", this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
        ...
        paramssf = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI.d;
        label221:
        a(1, new String[] { paramssf });
      }
    }
    for (;;)
    {
      ...
      break label193;
      label276:
      paramssf = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI.c;
      break label221;
      label287:
      a(0, new String[0]);
      continue;
  ...
  {
    urk.b("Q.qqstory.publish.edit.EditVideoPoi", "requestSosoPoi");
    a(2, new String[0]);
    if (this.jdField_a_of_type_AndroidViewViewStub != null) {
      new auua((Activity)this.jdField_a_of_type_AndroidViewViewStub.getContext(), new uvj(this, paramBoolean)).a();
    }
  }
  ...
  public void f()
  {
    urk.b("Q.qqstory.publish.edit.EditVideoPoi", "requestPoiList");
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader == null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader = ((PullRefreshHeader)LayoutInflater.from(a()).inflate(2131493891, null, false));
    }
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollListener(new uvi(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      return;
    case 2131302804: 
      paramView = (uvl)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (paramView != null) {
        paramView.a();
      }
      b();
    ...
    case 2131309933: 
    case 2131309956: 
      this.jdField_a_of_type_Uut.a(4, this.jdField_a_of_type_MqqUtilWeakReference.get());
      return;
    }
    f();
    a(false, true);
  ...
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (paramInt < 0) || (paramInt >= this.jdField_a_of_type_JavaUtilArrayList.size()) || (this.jdField_a_of_type_Vfe == null)) {
      return;
    }
    paramView = this.jdField_a_of_type_Uut;
