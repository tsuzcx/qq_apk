...
public class lhd
  ...
  implements lha, lhm
{
  public static final String d = lbh.a() + 176 + File.separator;
  ...
  lhf jdField_a_of_type_Lhf = new lhf();
  private lhq jdField_a_of_type_Lhq = new lhq();
  private lin jdField_a_of_type_Lin;
  private WeakReference<lhn> jdField_a_of_type_MqqUtilWeakReference = new WeakReference(null);
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<lhe> b = new ArrayList();
  private String e;
  private String f;
  
  public lhd(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private MagicFaceDataEntity a(FaceItem paramFaceItem, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      lbd.f(this.jdField_a_of_type_JavaLangString, String.format("createMagicEntity: id=%s, senderType%s.", new Object[] { paramFaceItem.getId(), Integer.valueOf(paramInt) }));
      str1 = paramFaceItem.getId();
      str2 = paramFaceItem.getType();
      if (!"multi_result".equalsIgnoreCase(paramFaceItem.getAttr())) {
        break label100;
      }
      paramString = new lhk(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
    }
    for (;;)
    {
      ...
      if ("huanlian".equalsIgnoreCase(paramFaceItem.getAttr())) {
        paramString = new map(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
      } else {
  ...
  private MagicFaceDataEntity a(String paramString, boolean paramBoolean)
  {
    ...
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_Lgt.a(paramString, a(paramString), b(paramString), localArrayList, false);
      lbd.h(this.jdField_a_of_type_JavaLangString, "prepareEntity FILE not exist: " + ((File)localObject).getPath());
    }
    return null;
  }
  
  private void a(long paramLong, MagicFaceDataEntity paramMagicFaceDataEntity, lhn paramlhn)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      if (localFaceItem != null)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          this.jdField_a_of_type_Lhq.a(paramLong, str, paramMagicFaceDataEntity, paramlhn, this);
        }
      }
    }
  }
  ...
  private boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() > 0)
    {
      ...
      a(paramLong, localMagicFaceDataEntity, (lhn)this.jdField_a_of_type_MqqUtilWeakReference.get());
  ...
  private int b()
  {
    ...
    int i = localVideoController.b(locallfe.d);
    if ((i == 2) || (i == 3) || (i == 4))
    {
      i = 1;
      if (i != 0) {
    ...
    do
    {
      ...
      i = 0;
      break;
      k = localVideoController.c(locallfe.d);
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if ((bool1) || (bool2)) {
        if ((!"0".equalsIgnoreCase(str2)) && (!"0_iOS".equalsIgnoreCase(str2)))
        {
          ...
          new mdc(l, str2, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    for (;;)
    {
      ...
      if ("STOP".equals(str1))
      {
        continue;
        if (paramInt == 1) {
          new mdc(l, paramString, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
        }
      }
    }
  }
  ...
  public FaceItem a()
  {
    if ((this.jdField_a_of_type_Lgx != null) && (((FaceItem)this.jdField_a_of_type_Lgx).isSameType("creativecop"))) {
      return (FaceItem)this.jdField_a_of_type_Lgx;
    }
    return null;
  }
      ...
      else if (paramInt == 370)
      {
        if (((JSONObject)localObject1).has("blessingTips"))
        {
          ...
          while (i < localJSONArray.length())
          {
            ...
            lhe locallhe = new lhe();
            locallhe.jdField_a_of_type_JavaLangString = localJSONObject.optString("id");
            if (localJSONObject.has("start_date")) {
              locallhe.jdField_a_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("start_date")).getTime();
            }
            if (localJSONObject.has("end_date")) {
              locallhe.jdField_b_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("end_date")).getTime();
            }
            if (localJSONObject.has("text")) {
              locallhe.jdField_b_of_type_JavaLangString = localJSONObject.getString("text");
            }
            if (localJSONObject.has("image_url")) {
              locallhe.c = localJSONObject.getString("image_url");
            }
            if (localJSONObject.has("call_time_len")) {
              locallhe.jdField_a_of_type_Int = localJSONObject.getInt("call_time_len");
            }
            if (localJSONObject.has("show_time_len")) {
              locallhe.jdField_b_of_type_Int = localJSONObject.getInt("show_time_len");
            }
            this.b.add(locallhe);
            QLog.w(this.jdField_a_of_type_JavaLangString, 1, "parseConfig, blessingTips[" + locallhe + "]");
            i += 1;
          }
        }
        ...
        {
          this.jdField_a_of_type_Lhf.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("exposure_show_time_len", 5);
          this.jdField_a_of_type_Lhf.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("exposure_call_time", 2);
          this.jdField_a_of_type_Lhf.c = ((JSONObject)localObject1).optInt("click_call_time", 2);
          this.jdField_a_of_type_Lhf.d = ((JSONObject)localObject1).optInt("click_show_time_len", 5);
          this.jdField_a_of_type_Lhf.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("exposure_show_text", this.jdField_a_of_type_Lhf.jdField_a_of_type_JavaLangString);
        }
      }
    }
  ...
  public lhf a()
  {
    return this.jdField_a_of_type_Lhf;
  }
  ...
  public void a()
  {
    ...
    if (locallgz != null) {
      locallgz.a(3003, this);
    }
    this.jdField_a_of_type_Lin = ((lin)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5));
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        ...
        this.f = null;
        a(l, null);
        if (this.jdField_a_of_type_Lhq.a()) {
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    case 2: 
      ...
      new mdd(paramLong, "onSessionStatusChanged", 5, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      lhg.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString1);
      lhg.a(2, paramString1);
      lhg.a(2);
      return;
    }
    a(paramLong, 6101, null, Boolean.valueOf(false));
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity.a((lho)localObject);
      bool1 = bool2;
      if (bool2)
      {
        bool1 = bool2;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          ((lid)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2)).a(paramLong, this.e);
          a(paramLong, 6102, null, null);
          this.e = null;
        }
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      lhg.a(4, paramString2);
      lhg.a(4);
    } while (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13));
    ((lhs)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13)).a(l, "stopInteractiveVideo");
  }
  ...
  public boolean a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.clear();
        lbd.h(this.jdField_a_of_type_JavaLangString, "stop dequeue" + paramString);
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity = null;
        if (paramBoolean) {
          e(paramString);
        }
        ...
        {
          this.jdField_a_of_type_Lhq.b();
          lbd.h(this.jdField_a_of_type_JavaLangString, "stop " + paramString + ", mStopType =" + paramInt);
        }
      }
    }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem)
  {
    ...
    if ((paramFaceItem != null) && (paramFaceItem.isSameType("creativecop")))
    {
      ...
      ((FaceItem)this.jdField_a_of_type_Lgx).setDesc((String)localObject);
      bdla.b(null, "CliOper", "", "", "0X800A74C", "0X800A74C", 0, 0, "", "", paramFaceItem.getId(), "");
      j = b();
      if (this.jdField_a_of_type_Lin.a(3, "creative") != 1) {
        break label282;
      }
      bool1 = true;
      i = 0;
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        mbf.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1010, i);
      }
      if (bool2)
      {
        this.jdField_a_of_type_AndroidOsHandler.obtainMessage(101, this.jdField_a_of_type_Lgx).sendToTarget();
        if (paramFaceItem != null)
        {
          paramFaceItem = paramFaceItem.getType();
          if ((!paramFaceItem.equalsIgnoreCase("face")) && (!paramFaceItem.equalsIgnoreCase("voicesticker")))
          {
            localObject = (lgz)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(12);
            if (localObject != null) {
              ((lgz)localObject).a(3003, paramFaceItem);
            }
          }
        }
      }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem, String paramString, boolean paramBoolean, lhn paramlhn)
  {
    boolean bool2 = true;
    if (AudioHelper.f()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, id[" + paramString + "], curData[" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity + "], isSender[" + paramBoolean + "], queue[" + this.jdField_a_of_type_JavaUtilQueue.size() + "], isPlaying[" + this.jdField_a_of_type_Lhq.a() + "], mLastPendantId[" + this.e + "], seq[" + paramLong + "]");
    }
    boolean bool1;
    ...
    if (bool3)
    {
      ...
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramlhn);
      if ((this.jdField_a_of_type_Lhq == null) || (!this.jdField_a_of_type_Lhq.a())) {
        break label468;
      }
      if (bool3) {
        break label554;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramFaceItem != null) || (bool3))
        {
          ...
          paramFaceItem = (lid)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
        ...
        for (;;)
        {
          QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, step[" + i + "], mLastPendantId[" + paramlhn + "->" + this.e + "]");
          ...
          a(paramLong, (MagicFaceDataEntity)localObject, paramlhn);
          paramFaceItem = (FaceItem)localObject;
          break label276;
          label506:
          i = 2;
  ...
  {
    if (lot.b()) {
      lot.b(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    }
    return true;
  }
