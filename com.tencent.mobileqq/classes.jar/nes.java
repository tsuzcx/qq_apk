...
public class nes
  extends ajfb
{
  static final String a = "Q.pubaccount.video." + net.class.getSimpleName();
  
  public nes(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public nes(QQAppInterface paramQQAppInterface)
  {
