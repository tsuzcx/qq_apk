...
public class bdzm
{
  ...
  public static String a(int paramInt)
  {
    try
    {
      ...
      String str2 = babp.e();
      String str3 = babp.a(MobileQQ.sMobileQQ);
      String str4 = bdzl.a();
      String str5 = bdzl.b();
      ...
      localbdzp.a((byte[])localObject).a(str2).a(str3).a(str4).a(str5).a(str6).a(str7).a(str8);
      if (paramInt >= 2) {
        localbdzp.a(bdzl.c()).a(AppSetting.a()).a(babp.f()).a("").a("");
      }
      localObject = localbdzp.toString();
    }
  ...
  private static void b(QQAppInterface paramQQAppInterface, SafeReport.ReqBody paramReqBody)
  {
    ...
    for (;;)
    {
      mmj.a(paramQQAppInterface, new bdzn(), paramReqBody.toByteArray(), "MqqSafeDataRpt.MQDun");
      return;
    }
  }
