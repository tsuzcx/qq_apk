  ...
  implements Manager
{
  ...
  private awuw jdField_a_of_type_Awuw;
  private awux jdField_a_of_type_Awux;
  private awuy jdField_a_of_type_Awuy;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<awuv>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<awut>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<awuu>> d = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> e = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> f = new HashMap(5);
  
  public awus(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Auox = ((auox)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	awus:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	awus:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, awuv paramawuv)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramawuv));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, awut paramawut)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramawut));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, awuu paramawuu)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramawuu));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Auox.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Awuw != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awuw);
      this.jdField_a_of_type_Awuw = null;
    }
    if (this.jdField_a_of_type_Awux != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awux);
      this.jdField_a_of_type_Awux = null;
    }
    if (this.jdField_a_of_type_Awuy != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awuy);
  ...
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, awut paramawut)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramawut != null) && (??? != null))
      {
        if (bgnt.d(paramContext)) {
          break;
        }
        a(paramLong, ???, paramawut);
      }
      return;
    }
    ...
    a(paramLong, ???, paramawut);
    paramawut = new WeakReference(paramawut);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramawut);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramawut = new ArrayList(1);
      paramawut.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramawut);
      ((auov)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, awuu paramawuu)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramawuu != null) && (paramArrayList != null))
      {
        if (bgnt.d(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramawuu);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramawuu);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Auox.a(paramString, paramIntimateInfo);
