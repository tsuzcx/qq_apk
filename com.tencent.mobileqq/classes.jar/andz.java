...
public class andz
{
  ...
  public andz(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageRecord;
    this.jdField_a_of_type_Boolean = paramQQAppInterface.isRingerSilent();
    this.b = bfrf.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
    this.c = b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    this.d = bfrf.b(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
  ...
  private void a(int paramInt)
  {
    ...
    while (j < k)
    {
      ((andy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.vibrateListenerList.get(j)).b(paramInt);
      j += 1;
    }
  }
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    for (int j = 0;; j = localAudioManager.getStreamVolume(2))
    {
      ...
      if (localapka != null)
      {
        if (!apka.a(paramMessageRecord)) {
          break;
        }
        localapka.b(paramMessageRecord);
      }
      return;
    }
    localapka.b();
  ...
  private void c(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool1;
    boolean bool2;
    if ((paramMessageRecord != null) && (localapka != null))
    {
      boolean bool3 = localapka.b(paramMessageRecord.frienduin, paramMessageRecord.istroop);
      boolean bool4 = localapka.a(paramMessageRecord.senderuin);
      bool1 = bool4;
      bool2 = bool3;
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      if (((paramBoolean1) && (bool2) && (bool1)) || ((bgjy.a(paramMessageRecord)) && (localapka != null))) {
        localapka.b(paramMessageRecord);
      }
      return;
      bool1 = false;
  ...
  void a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if (localapka != null)
    {
      ...
      if (paramMessageRecord != null) {
        bool1 = localapka.b(this.h, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      }
    }
    if (QLog.isColorLevel()) {
  ...
  void a(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localObject = apka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    if (localObject != null)
    {
      bool1 = bool2;
      if (paramMessageRecord != null) {
        bool1 = ((apka)localObject).a(this.i, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      }
    }
    ...
    if (paramMessageRecord != null)
    {
      ...
      if (paramMessageRecord.istroop == 1001)
      {
        ...
        if (!aquz.b(paramMessageRecord))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.e("SpecialCare", 2, "message.istroop = " + paramMessageRecord.istroop + " MsgBoxUtil.shouldInMsgBox(message) = " + aquz.b(paramMessageRecord));
            }
  ...
  public void b(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool2 = a(bfyq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  ...
  {
    avre localavre = (avre)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(349);
    if (localavre != null) {
      return localavre.a(paramMessageRecord);
    }
    return true;
  }
