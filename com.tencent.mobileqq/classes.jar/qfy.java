...
public class qfy
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new qgq(this, null);
  private mzv jdField_a_of_type_Mzv;
  private qgl jdField_a_of_type_Qgl;
  rug jdField_a_of_type_Rug;
  ...
  public qfy(Activity paramActivity, QQAppInterface paramQQAppInterface, VideoFeedsPlayManager paramVideoFeedsPlayManager, int paramInt1, boolean paramBoolean, qgl paramqgl, int paramInt2)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager = paramVideoFeedsPlayManager;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Qgl = paramqgl;
    this.e = paramBoolean;
    this.jdField_a_of_type_Mzv = ((mzv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(136));
    this.jdField_a_of_type_Mzv.a();
  ...
  public static Intent a(VideoInfo paramVideoInfo)
  {
    ...
    localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131630985, new Object[] { paramVideoInfo.jdField_c_of_type_JavaLangString }));
    if (paramVideoInfo.jdField_a_of_type_Int == 6)
    {
      ...
      localAbsStructMsg = awuw.a(localIntent.getExtras());
  ...
  public static Bundle a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int == 6)
    {
      ((Bundle)localObject).putInt("VIDEO_FEED_TYPE", paramVideoInfo.jdField_k_of_type_Int);
      ...
      ((Bundle)localObject).putInt("PREVIEW_START_POSI", qhv.a(paramInt, paramVideoInfo.a()));
      localObject = (StructMsgForGeneralShare)awuw.a((Bundle)localObject);
      if ((!TextUtils.isEmpty(((StructMsgForGeneralShare)localObject).mMsgBrief)) && (((StructMsgForGeneralShare)localObject).mMsgBrief.indexOf(ajjy.a(2131650415)) == -1)) {
        ((StructMsgForGeneralShare)localObject).mMsgBrief = (ajjy.a(2131650437) + ((StructMsgForGeneralShare)localObject).mMsgBrief);
      }
      rse.a((StructMsgForGeneralShare)localObject);
      str1 = paramVideoInfo.E;
      str2 = paramVideoInfo.D;
    ...
    label640:
    label649:
    for (((StructMsgForGeneralShare)localObject).mSourceIcon = str1;; ((StructMsgForGeneralShare)localObject).mSourceIcon = "http://post.mp.qq.com/kan/video/201197226-1955dc60def689ah-j0032zp3bhx.html?_wv=2281701505&sig=2556997e505f84ff05decf79e0d001af&time=1573267470&iid=MzczOTc1NDQ5OQ==&sourcefrom=0")
    {
  ...
  public static void a(VideoInfo paramVideoInfo, Activity paramActivity, int paramInt)
  {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int == 0)
    {
      ...
      aphp.a(paramActivity, localIntent);
      return;
    }
    ...
    {
      aphp.a(paramActivity, a(paramVideoInfo), 21);
      return;
    }
    paramVideoInfo = a(paramVideoInfo, paramInt);
    Intent localIntent = new Intent();
    localIntent.putExtras(paramVideoInfo);
    aphp.a(paramActivity, localIntent, 21);
  }
  ...
  private void a(VideoInfo paramVideoInfo, String paramString1, String paramString2, String paramString3, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localJSONObject.put("network", nzv.a(this.jdField_a_of_type_AndroidAppActivity));
    ...
    ndn.a(null, "", "0X8009546", "0X8009546", 0, 0, "", String.valueOf(paramString2), String.valueOf(paramLong), paramVideoInfo, false);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localObject[0] = ajjy.a(2131650439);
    localObject[1] = ajjy.a(2131650368);
    localObject[2] = ajjy.a(2131650402);
    localObject[3] = ajjy.a(2131650350);
    localObject[4] = ajjy.a(2131650397);
    localObject[5] = ajjy.a(2131650361);
    localObject[6] = ajjy.a(2131650419);
    localObject[7] = ajjy.a(2131650380);
    localObject[8] = ajjy.a(2131650373);
    ...
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      ...
      bbmy.a(this.jdField_a_of_type_AndroidAppActivity, 0, 2131653595, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131167766));
      return;
    }
    ...
    try
    {
      ...
      paramString3.putExtra("big_brother_source_key", obz.f(i));
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, long paramLong, int paramInt2, int paramInt3, int paramInt4, String paramString6, boolean paramBoolean)
  {
    ...
    paramString4 = new qmv(paramString4, paramString1, paramString5, paramString3).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager.a()).c(paramInt1 * 1000);
    if (!paramBoolean) {
    ...
    for (;;)
    {
      ndn.a(null, paramString1, str1, str1, 0, 0, "0", paramString2, paramString3, paramString4.a().a(), false);
      return;
      paramString3 = "0";
    }
  }
  ...
  private static void b(Context paramContext, int paramInt1, int paramInt2, VideoInfo paramVideoInfo, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("network", nzv.a(paramContext));
        localJSONObject.put("os", "1");
      ...
      ndn.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramVideoInfo.g), String.valueOf(paramVideoInfo.jdField_f_of_type_Long), paramContext, false);
      return;
      paramInt1 = 1;
    }
  }
  ...
  private void e()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        int i = qcn.b(this.jdField_a_of_type_AndroidAppActivity)[0];
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new qgh(this));
  ...
  private void f()
  {
    ...
    Object localObject = new qgi(this);
    ...
    ((ReadInJoyDisLikeDialogView)localObject).setOnUninterestConfirmListener(new qgj(this, localVideoInfo));
    ((ReadInJoyDisLikeDialogView)localObject).setOnComplainListener(new qga(this, localVideoInfo));
      ...
      try
      {
        if (!this.jdField_a_of_type_Begr.isShowing())
        {
          if ((befo.g()) && (!ShortVideoUtils.c()))
          {
            ...
            this.jdField_a_of_type_Begr.setOnShowListener(new qgb(this));
          }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Rug == null) {
      this.jdField_a_of_type_Rug = new rug(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new qgk(this), new qgm(this));
    }
    this.jdField_a_of_type_Rug.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Rug.a.a(new qge(this));
    this.jdField_a_of_type_Rug.a.a(new qgf(this));
    try
    {
      if (!this.jdField_a_of_type_Rug.a.a())
      {
        if ((befo.g()) && (!ShortVideoUtils.c()))
        {
          this.jdField_a_of_type_Rug.a.a().setFlags(8, 8);
          this.jdField_a_of_type_Rug.a.a().getDecorView().setSystemUiVisibility(this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().getSystemUiVisibility());
          this.jdField_a_of_type_Rug.a.a(new qgg(this));
        }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Qgl != null) {
        this.jdField_a_of_type_Qgl.e();
      }
      ...
      return;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.l == 1) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a(this.jdField_a_of_type_AndroidAppActivity))) {
        f();
      } else {
        a();
      }
  ...
  void a(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    String str1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131653710);
    String str2 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131653668);
    String str3 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131653711);
    String str4 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131653688);
    String str5 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131625035);
    ...
    {
      localObject = begr.b(this.jdField_a_of_type_AndroidAppActivity);
      ((begr)localObject).c(str1);
      ((begr)localObject).setOnDismissListener(new qfz(this));
      if (paramMessageForShortVideo.videoFileStatus != 5001) {
        ((begr)localObject).c(str3);
      }
      if (!bool1) {
        break label334;
      }
      ((begr)localObject).c(str2);
      ((begr)localObject).c(str4);
    }
    for (;;)
    {
      ((begr)localObject).d(str5);
      if (!((begr)localObject).isShowing())
      {
        if ((befo.g()) && (!ShortVideoUtils.c()))
        {
          ((begr)localObject).getWindow().setFlags(8, 8);
          if (befo.g()) {
            ((begr)localObject).getWindow().getDecorView().setSystemUiVisibility(this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().getSystemUiVisibility());
          }
          ((begr)localObject).setOnShowListener(new qgc(this, (begr)localObject));
        }
        ((begr)localObject).show();
      }
      ((begr)localObject).a(new qgd(this, (begr)localObject, str1, paramMessageForShortVideo, str3, bool1, str6, str2, str4));
      return;
      localObject = begr.a(this.jdField_a_of_type_AndroidAppActivity);
      break;
      label334:
      ((begr)localObject).a(str2, 7);
      ((begr)localObject).a(str4, 7);
    }
  }
  
  public List<Integer>[] a()
  {
    List localList = rug.a();
    ArrayList localArrayList = new ArrayList();
