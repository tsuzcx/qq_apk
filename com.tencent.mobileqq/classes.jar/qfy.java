  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      if ((j ^ i) != 0)
      {
        ...
        localDrawable.setBounds(0, 0, bbkx.b(16.0F), bbkx.b(16.0F));
    ...
    for (;;)
    {
      ...
      osj.a().h(ReadInJoyUgcSearchTopicFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyUgcSearchTopicFragment));
      return;
      i = 0;
      break;
      label156:
