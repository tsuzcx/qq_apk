...
public class sla
  extends qeg
{
  private sla(VideoFeedsRecommendFragment paramVideoFeedsRecommendFragment) {}
  ...
  public void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramString1.e)
    {
      ...
      paramString2.b(this.a.getActivity().getApplicationContext().getResources().getDimensionPixelSize(2131299080) - (int)bhdz.a(this.a.getActivity().getApplicationContext(), 5.0F));
    }
    for (;;)
    {
