...
public class bbtl
  extends QIPCModule
{
  private static volatile bbtl a;
  
  private bbtl(String paramString)
  {
    super(paramString);
  }
  
  public static bbtl a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = new bbtl("open_sdk_qipc_module");
      }
      return a;
    }
    finally {}
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_get_accountInfo".equals(paramString))
    {
      ...
      if ((!TextUtils.isEmpty(paramBundle)) && ((localAppRuntime instanceof QQAppInterface))) {
        paramString.putString("key_nickname", babh.i((QQAppInterface)localAppRuntime, paramBundle));
      }
