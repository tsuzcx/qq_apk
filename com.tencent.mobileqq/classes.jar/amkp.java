...
{
  private static volatile amkp jdField_a_of_type_Amkp;
  ...
  {
    if (jdField_a_of_type_Amkp == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Amkp == null) {
        jdField_a_of_type_Amkp = new amkp();
      }
      return jdField_a_of_type_Amkp;
    }
  }
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getContext(), amko.class);
    amko.a(localNewIntent, BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
