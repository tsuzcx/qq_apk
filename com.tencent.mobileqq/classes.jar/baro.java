  ...
  implements View.OnClickListener, TopGestureLayout.OnGestureListener
{
  ...
  private ascr jdField_a_of_type_Ascr;
  private aycd jdField_a_of_type_Aycd;
  private aych jdField_a_of_type_Aych = new barr(this);
  private balg jdField_a_of_type_Balg = new barq(this);
  public barz a;
  private basa jdField_a_of_type_Basa;
  ...
  public baro(BaseChatPie paramBaseChatPie, Activity paramActivity, AppInterface paramAppInterface)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout = ((TopGestureLayout)View.inflate(BaseApplicationImpl.getContext(), 2131560398, null));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.setOnFlingGesture(this);
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView = ((SpriteGLView)this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131377900));
      if ((this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView instanceof TroopGiftToPersonalSurfaceView)) {
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131377898));
      }
      try
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846264);
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
        return;
        label109:
        this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout = ((TopGestureLayout)View.inflate(BaseApplicationImpl.getContext(), 2131560399, null));
      }
  ...
  public Drawable a(String paramString, bayi parambayi)
  {
    Object localObject1 = (AppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (ajxl)((AppInterface)localObject1).getManager(51);
    ...
    {
      i = 1;
      if ((localObject2 == null) || (!((ajxl)localObject2).b(paramString))) {
        break label130;
      }
      j = 1;
      ...
      paramString = BaseApplicationImpl.getApplication().getResources().getDrawable(2130843044);
      parambayi = URLDrawable.getDrawable(myb.a(myb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips).b), paramString, paramString);
    }
    label130:
    label136:
    do
    {
      ...
      j = 0;
      break label74;
      if (((k != 1010) && (k != 1001) && (k != 10002) && ((i == 0) || ((j != 0) && (!paramString.equals(((AppInterface)localObject1).getCurrentAccountUin()))))) || (localObject2 == null) || (((ajxl)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin))) {
        break label252;
      }
      localObject1 = bayh.a((AppInterface)localObject1, 200, paramString, 3, parambayi, true);
      parambayi = (bayi)localObject1;
    } while (!QLog.isColorLevel());
    QLog.d("TroopGiftAnimationController", 2, "getFaceDrawable, uin = " + paramString);
    return localObject1;
    label252:
    localObject2 = bayh.a(1, 3);
    return bayh.a((AppInterface)localObject1, 1, String.valueOf(paramString), 3, (Drawable)localObject2, (Drawable)localObject2, parambayi);
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Barz != null)
    {
      this.jdField_a_of_type_Barz.a();
      this.jdField_a_of_type_Barz = null;
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips != null) && (this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.isToAll())) {
      if (this.jdField_a_of_type_Int >= 4) {
        akbj.a("cartoon", "clk_close", this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, "", "", "");
      }
    }
    while ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips == null) || (this.jdField_a_of_type_Int >= 4))
    {
      ...
      for (str = "0";; str = "1")
      {
        axqy.b(null, "dc00899", "Grp_flower", "", "forall", "Clk_close", 0, 0, "" + this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, "" + balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips), str, "" + mua.a(localAppInterface, localAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin));
        break;
      }
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) {}
    ...
    {
      axqy.b(null, "dc00899", "Grp_flower", "", "video_mall", "Clk_comctn_close", 0, 0, "" + this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, "" + balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips), str, "" + mua.a(localAppInterface, localAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin));
      break;
    }
  }
  ...
  public void a(int paramInt, ascr paramascr)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView instanceof TroopGiftToPersonalSurfaceView))
    {
      ((TroopGiftToPersonalSurfaceView)this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView).a(new bars(this));
      if ((!this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.isToAll()) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.animationBrief))) {
        a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.animationBrief, this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.giftCount, paramInt, paramascr);
      }
    }
    label155:
    while (QLog.isColorLevel())
    {
      ...
      {
        this.jdField_a_of_type_Basa = new basa(this);
        ((TroopGiftToAllSurfaceView)this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView).a(this.jdField_a_of_type_Basa);
        String str;
        label218:
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          ...
          akbj.a("cartoon", "exp_cartoon", this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips) + "", "", "");
        }
        for (;;)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.showButton)
          {
            ((TroopGiftToAllSurfaceView)this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView).a(this.jdField_a_of_type_Aych);
            if (this.jdField_a_of_type_Int >= 4)
            {
              akbj.a("cartoon", "exp_inter", this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips) + "", "", "");
              break;
              str = "1";
              break label218;
              label375:
              axqy.b(null, "dc00899", "Grp_flower", "", "forall", "exp_anime", 0, 0, "" + this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, "" + balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips), str, "" + mua.a(localAppInterface, localAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin));
              continue;
            }
            axqy.b(null, "dc00899", "Grp_flower", "", "forall", "exp_grab", 0, 0, "" + this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, "" + balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips), str, "" + mua.a(localAppInterface, localAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin));
            break;
          }
        }
    ...
    label647:
    for (paramInt = paramascr.m;; paramInt = paramascr.n)
    {
      ((TroopGiftToAllSurfaceView)this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.resultText, paramInt, baxn.a(this.jdField_a_of_type_AndroidAppActivity, 16.0F));
      break label155;
      break;
    }
  }
  ...
  public void a(ahfh paramahfh)
  {
    if (this.jdField_a_of_type_Ahfh != null) {
      this.jdField_a_of_type_Ahfh.a();
    }
    this.jdField_a_of_type_Ahfh = paramahfh;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopGiftAnimationController", 2, "play TroopGiftAnimation Start,packageId:" + balu.b(paramMessageForDeliverGiftTips));
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aeqb))
    {
      int i = ((aeqb)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).j();
      if (i == 2) {
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localEmoticon.epId = balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
      this.jdField_a_of_type_Ascr = asdj.a(localEmoticon, 1, 2, paramMessageForDeliverGiftTips.animationType);
  ...
  public void a(String paramString, int paramInt1, int paramInt2, ascr paramascr)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if ((paramascr == null) || (paramascr.e))
      {
        ...
        localSpannableStringBuilder.setSpan(new AbsoluteSizeSpan(baxn.c(this.jdField_a_of_type_AndroidAppActivity, 17.0F)), paramString.length(), paramString.length() + 1, 18);
        AbsoluteSizeSpan localAbsoluteSizeSpan = new AbsoluteSizeSpan(baxn.c(this.jdField_a_of_type_AndroidAppActivity, 19.0F));
        ...
        paramString = new RelativeLayout.LayoutParams(-2, (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131297883));
        paramString.addRule(14);
        paramString.setMargins(baxn.a(this.jdField_a_of_type_AndroidAppActivity, 10.0F), paramInt2, baxn.a(this.jdField_a_of_type_AndroidAppActivity, 10.0F), 0);
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130843285);
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131167134));
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding(baxn.a(this.jdField_a_of_type_AndroidAppActivity, 30.0F), this.jdField_a_of_type_AndroidWidgetTextView.getPaddingTop(), baxn.a(this.jdField_a_of_type_AndroidAppActivity, 30.0F), this.jdField_a_of_type_AndroidWidgetTextView.getPaddingBottom());
        label419:
      ...
      {
        if (paramascr.g != null) {
          this.jdField_a_of_type_AndroidWidgetTextView.getBackground().setColorFilter(new LightingColorFilter(-16777216, Color.parseColor(paramascr.g)));
        }
        for (;;)
        {
      ...
      catch (IllegalArgumentException paramString)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e(".troop.send_gift", 2, "parse detail strip bg clor failed. Color value is " + paramascr.g, paramString);
          }
        }
      }
    }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Basa = null;
      this.jdField_a_of_type_AndroidWidgetImageView = null;
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.hasFetchButFailed = false;
        axqy.b(null, "P_CliOper", "BizTechReport", "troop_gift_animation", "", "play_success", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, balu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips), "", "");
      }
      if (this.jdField_a_of_type_Aycd != null) {
        this.jdField_a_of_type_Aycd.a();
      }
      if ((this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((this.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bayh))) {
        ((bayh)this.jdField_a_of_type_AndroidGraphicsDrawableDrawable).a();
      }
      if ((this.b != null) && ((this.b instanceof bayh)))
      {
        ((bayh)this.b).a();
        if (this.jdField_a_of_type_Ahfh != null)
        {
          this.jdField_a_of_type_Ahfh.a();
          this.jdField_a_of_type_Ahfh = null;
        }
        return;
      }
    }
