...
public class mtx
{
  ...
  public mtx(mtx parammtx, long paramLong)
  {
    this.o = paramLong;
    this.jdField_a_of_type_Mtx = parammtx;
  }
  ...
  {
    float f2 = 0.0F;
    for (mtx localmtx = this.jdField_a_of_type_Mtx; (localmtx != null) && (!localmtx.jdField_a_of_type_Boolean); localmtx = localmtx.jdField_a_of_type_Mtx) {
      localmtx.jdField_b_of_type_Boolean = true;
    }
    this.jdField_a_of_type_Mtx = localmtx;
    if (localmtx != null)
    {
      if (localmtx.jdField_a_of_type_Long != 0L) {
        this.jdField_b_of_type_Long = (this.jdField_a_of_type_Long - localmtx.jdField_a_of_type_Long);
      }
      if (localmtx.k != 0L) {
        this.l = (this.k - localmtx.k);
      }
    }
    if (localmtx == null)
    {
    ...
    label137:
    for (float f1 = f2;; f1 = localmtx.jdField_b_of_type_Float)
    {
      this.jdField_b_of_type_Float = a(f1, this.l / 1000L);
      return;
      f1 = localmtx.jdField_a_of_type_Float;
      break;
    }
  }
  ...
  boolean c()
  {
    ...
    mtx localmtx = this.jdField_a_of_type_Mtx;
    if (localmtx != null)
    {
      if ((localmtx.jdField_b_of_type_Int != this.jdField_b_of_type_Int) || (localmtx.jdField_c_of_type_Int != this.jdField_c_of_type_Int) || (localmtx.jdField_d_of_type_Int != this.jdField_d_of_type_Int) || (localmtx.jdField_e_of_type_Int != this.jdField_e_of_type_Int) || (localmtx.jdField_f_of_type_Int != this.jdField_f_of_type_Int) || (localmtx.jdField_g_of_type_Int != this.jdField_g_of_type_Int) || (localmtx.n != this.n) || (localmtx.jdField_c_of_type_Boolean != this.jdField_c_of_type_Boolean) || (localmtx.jdField_d_of_type_Boolean != this.jdField_d_of_type_Boolean) || (localmtx.jdField_h_of_type_Int != this.jdField_h_of_type_Int) || (localmtx.jdField_a_of_type_Int != this.jdField_a_of_type_Int) || (localmtx.o + 1L != this.o))
      {
        m = System.currentTimeMillis();
        return true;
      }
