  ...
  implements Handler.Callback
{
  ...
  private bjjn jdField_a_of_type_Bjjn;
  private int b;
  private int c;
  
  public bjjm(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    if (bjki.jdField_a_of_type_Boolean)
    {
      ...
      if (paramMessage.jdField_a_of_type_Double >= awje.c) {
        bool1 = true;
      }
      bool2 = bool1;
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bjjn != null) {
        this.jdField_a_of_type_Bjjn.a(this.jdField_a_of_type_Bjjn, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
