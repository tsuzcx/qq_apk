...
public class bkhl
{
  ...
  public bkhl(AbsSpinner paramAbsSpinner) {}
  ...
  public void b()
  {
    ...
    if (i < j)
    {
      ...
      if ((localView == null) || (!(localView.getTag(2131367289) instanceof Boolean))) {
        break label94;
      }
    }
    label94:
    for (boolean bool = ((Boolean)localView.getTag(2131367289)).booleanValue();; bool = true)
    {
