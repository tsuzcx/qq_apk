...
public class bkhl
{
  ...
  private static bkhk a(Cursor paramCursor)
  {
    bkhk localbkhk = new bkhk();
    localbkhk.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbkhk.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbkhk.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbkhk.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbkhk.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbkhk.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbkhk.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbkhk.f = paramCursor.getString(7);
    localbkhk.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbkhk.g = paramCursor.getString(9);
    localbkhk.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbkhk.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbkhk.h = paramCursor.getString(12);
    localbkhk.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbkhk.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbkhk.i = paramCursor.getString(15);
    localbkhk.j = paramCursor.getString(16);
    localbkhk.k = paramCursor.getString(17);
    localbkhk.l = paramCursor.getString(18);
    return localbkhk;
  }
  
  /* Error */
  public static java.util.ArrayList<bkhk> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	bkhm:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	bkhl:a	(Landroid/database/Cursor;)Lbkhk;
