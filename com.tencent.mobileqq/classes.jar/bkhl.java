  ...
  implements TypeEvaluator<ArrayList<Integer>>
{
  ...
  private ArrayList<bkhm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  {
    int i = this.c.size();
    paramString = new bkhm(paramLong1, paramLong2, i);
  ...
  public ArrayList<Integer> a(float paramFloat, ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    if (i < j)
    {
      ...
      long l1 = ((bkhm)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Long;
      long l2 = ((bkhm)this.jdField_a_of_type_JavaUtilArrayList.get(i)).b;
