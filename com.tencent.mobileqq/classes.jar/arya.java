...
{
  public arya(HotChatFlashPicActivity paramHotChatFlashPicActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      do
      {
        ...
        do
        {
          ...
          HotChatFlashPicActivity.a(this.a).setImageResource(2130842596);
          if (HotChatFlashPicActivity.b(this.a)) {
            HotChatFlashPicActivity.a(this.a).setText(2131693125);
          }
          while (HotChatFlashPicActivity.a(this.a).a())
          {
            HotChatFlashPicActivity.a(this.a).b();
            return false;
            HotChatFlashPicActivity.a(this.a).setText(2131690990);
          }
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            HotChatFlashPicActivity.a(this.a).setImageResource(2130842598);
            if (HotChatFlashPicActivity.b(this.a)) {
              HotChatFlashPicActivity.a(this.a).setText(2131693129);
            }
            while (HotChatFlashPicActivity.a(this.a).a())
            {
              HotChatFlashPicActivity.a(this.a).b();
              return false;
              HotChatFlashPicActivity.a(this.a).setText(2131690998);
            }
          }
          HotChatFlashPicActivity.a(this.a).sendEmptyMessage(1);
          return false;
    ...
    case 4: 
      if (HotChatFlashPicActivity.b(this.a)) {
        if (HotChatFlashPicActivity.a(this.a) >= 2) {
          paramMessage = this.a.getString(2131693128);
        }
      }
      break;
    }
    for (;;)
    {
      HotChatFlashPicActivity.a(this.a, bhdj.a(this.a, paramMessage, 0, 2131718822, null, new aryb(this)));
      ...
      return false;
      paramMessage = this.a.getString(2131693127);
      continue;
      if (HotChatFlashPicActivity.a(this.a) == 2)
      {
        paramMessage = this.a.getString(2131690997);
        localObject = paramMessage;
        if (!HotChatFlashPicActivity.e(this.a))
        {
          if (HotChatFlashPicActivity.b(this.a) == 0)
          {
            bdla.b(this.a.app, "dc00898", "", "", "0X80069A3", "0X80069A3", 0, 0, "", "", "", "");
            continue;
          }
          if (HotChatFlashPicActivity.b(this.a) == 3000)
          {
            bdla.b(this.a.app, "dc00898", "", "", "0X80069A4", "0X80069A4", 0, 0, "", "", "", "");
            continue;
          }
          localObject = paramMessage;
          if (HotChatFlashPicActivity.b(this.a) == 1) {
            bdla.b(this.a.app, "dc00898", "", "", "0X80069A5", "0X80069A5", 0, 0, "", "", "", "");
          }
        }
      }
      else if (HotChatFlashPicActivity.a(this.a) < 2)
      {
        paramMessage = this.a.getString(2131690992);
        localObject = paramMessage;
        if (!HotChatFlashPicActivity.e(this.a))
        {
          if (HotChatFlashPicActivity.b(this.a) == 0)
          {
            bdla.b(this.a.app, "dc00898", "", "", "0X80069A0", "0X80069A0", 0, 0, "", "", "", "");
            continue;
          }
          if (HotChatFlashPicActivity.b(this.a) == 3000)
          {
            bdla.b(this.a.app, "dc00898", "", "", "0X80069A1", "0X80069A1", 0, 0, "", "", "", "");
            continue;
          }
          localObject = paramMessage;
          if (HotChatFlashPicActivity.b(this.a) == 1) {
            bdla.b(this.a.app, "dc00898", "", "", "0X80069A2", "0X80069A2", 0, 0, "", "", "", "");
          }
        }
      }
      else
