...
public class usu
{
  ...
  private static QQHashMap<Integer, usv> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  public static Drawable a(Context paramContext, int paramInt)
  {
    ...
    {
    default: 
      return paramContext.getResources().getDrawable(2130840348);
    case 1: 
      return paramContext.getResources().getDrawable(2130840441);
    }
    return paramContext.getResources().getDrawable(2130840446);
  }
  ...
  {
    usv localusv = a(paramQQAppInterface, paramContext, paramInt);
    if (localusv != null) {
      return localusv.a();
    }
  ...
  public static usv a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (usv)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      localSet = bhhs.a(localSharedPreferences, "big_data_share_channel_urls", null);
      if (localSet != null) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (!a(paramQQAppInterface, paramContext, bhhr.e(paramContext)))
    {
      localObject = new usv(paramQQAppInterface, paramContext, 1, 2131696164, 2130840441);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(1), localObject);
    }
    Object localObject = bhhr.h(paramContext);
    String str = bhhr.i(paramContext);
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str)))
    {
      paramQQAppInterface = new usv(paramQQAppInterface, paramContext, 2, 2131694995, 2130840446);
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new usv(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<usv> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        usv localusv = (usv)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localusv.jdField_a_of_type_Int), localusv);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new usv(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          uqm.a(paramQQAppInterface, bool, (String)localObject1);
          uqm.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
            localObject2 = (WebProcessManager)paramQQAppInterface.getManager(QQManagerFactory.WEBPROCESS_MANAGER);
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          uqm.a(paramQQAppInterface, bool);
          uqm.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bhhr.b((Context)localObject1, bool);
        }
        localObject1 = paramString.getElementsByTagName("channel_version");
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          i1 = Integer.valueOf(((Element)((NodeList)localObject1).item(0)).getFirstChild().getNodeValue()).intValue();
          i2 = bmhv.b(paramQQAppInterface);
          if (i1 <= i2) {
            break label2993;
          }
          ...
          bmhv.a(paramQQAppInterface, i3, (String)localObject2, i4);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bhhr.c((Context)localObject1, bool);
          localObject1 = sqp.a();
          if (i1 != 0) {
            break label3034;
          }
          bool = true;
          ((sqp)localObject1).a(bool);
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bmhv.b(paramQQAppInterface, bool);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bhhr.a((Context)localObject1, bool, paramQQAppInterface.getCurrentUin());
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bmhv.d(paramQQAppInterface, bool);
        }
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bmhv.i(paramQQAppInterface, bool);
        }
  ...
  public static String b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return paramContext.getString(2131696164);
    }
    return paramContext.getString(2131694995);
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((NodeList)localObject).getLength() > 0))
          {
            ...
            if (i1 > bhhr.x(paramQQAppInterface.getApp()))
            {
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(paramString))) {
                bhhr.a(paramQQAppInterface.getApp(), (String)localObject, paramString);
              }
              bhhr.o(paramQQAppInterface.getApp(), i1);
              return false;
            }
          }
        }
