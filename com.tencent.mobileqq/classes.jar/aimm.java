...
public class aimm
  extends aimk
{
  public aimm(QQAppInterface paramQQAppInterface)
  {
  ...
  int a(SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramSessionInfo != null) {
      i = ((Integer)algy.a(paramQQAppInterface, paramSessionInfo.curType, paramSessionInfo.curFriendUin).first).intValue();
    }
    return i;
  }
  ...
  public ColorNote a(List<MessageRecord> paramList, long paramLong, int paramInt, SessionInfo paramSessionInfo)
  {
    ...
    if (paramLong != -1L)
    {
      str3 = this.a.getApplication().getString(2131690012) + ": " + aiml.a(paramLong);
    ...
    for (int i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        for (i = 1;; i = a(paramSessionInfo, this.a))
        {
          ...
          localObject = new aqoi();
          ((aqoi)localObject).a(17235968).a(aimq.a(paramLong)).b(0).b(str2).c(str3).d(str4).a(a(paramList, paramInt, str1, paramSessionInfo.troopUin));
          return ((aqoi)localObject).a();
          str3 = this.a.getApplication().getString(2131690011);
          break;
          str4 = str1;
          break label137;
          label353:
          ...
          str2 = aimq.a(this.a, (MessageRecord)localObject);
          break label199;
