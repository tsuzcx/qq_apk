...
{
  anmk(anmf paramanmf, int paramInt1, int paramInt2, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, structmsg.StructMsg paramStructMsg, long paramLong) {}
  ...
  public void onProtoResp(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    {
      this.jdField_a_of_type_Anmf.a(4012, false, localToServiceMsg);
    ...
    for (;;)
    {
      ...
      {
        paramProtoReq = (FriendListHandler)anmf.a(this.jdField_a_of_type_Anmf).getBusinessHandler(1);
      ...
      this.jdField_a_of_type_Anmf.a(4011, bool1, localToServiceMsg);
      return;
