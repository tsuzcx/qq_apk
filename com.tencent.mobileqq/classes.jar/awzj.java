...
public class awzj
{
  ...
  private MsgBackupUserData a(submsgtype0x11a.UserData paramUserData)
  {
    ...
    if (paramUserData.bytes_ip.has()) {
      localaxar.a(paramUserData.bytes_ip.get().toStringUtf8());
    }
    if (paramUserData.rpt_fixed32_port.has()) {
      localaxar.a(paramUserData.rpt_fixed32_port.get());
    }
    if (paramUserData.bytes_bssid.has()) {
      localaxar.c(paramUserData.bytes_bssid.get().toStringUtf8());
    }
    if (paramUserData.bytes_ssid.has()) {
      localaxar.b(paramUserData.bytes_ssid.get().toStringUtf8());
    }
    if (paramUserData.enum_platform.has()) {
      localaxar.a(paramUserData.enum_platform.get());
    }
    return localaxar.a();
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject1 = new bcsf();
    localObject2 = ((SubMsgType0x7.MsgBody)localObject2).toByteArray();
    ((bcsf)localObject1).jdField_a_of_type_Int = 7;
    ((bcsf)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject2);
    long l1 = auea.b();
    long l2 = auea.a();
    localObject1 = bcrx.a(paramString, 13, paramString.getCurrentUin(), (bcsf)localObject1, l2, bcsc.b(l1));
    ...
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.enum_result.has())
      {
        ...
        if (paramMsgBody.bytes_token.has()) {
          localaxad.a(paramMsgBody.bytes_token.get().toStringUtf8());
        }
        if (paramMsgBody.bytes_encrypt_key.has()) {
          localaxad.b(paramMsgBody.bytes_encrypt_key.get().toStringUtf8());
        }
        if (paramMsgBody.msg_user_data.has()) {
          localaxad.a(a((submsgtype0x11a.UserData)paramMsgBody.msg_user_data.get()));
        }
        if (paramMsgBody.enum_biz_type.has()) {
          localaxad.a(paramMsgBody.enum_biz_type.get());
        }
        paramMsgBody = localaxad.a();
        if (QLog.isColorLevel()) {
          QLog.d("MsgBackup.MsgBackupPushHandler", 2, "processOnLinePush receive processOnLinePush0x11a response = " + paramMsgBody);
        }
        awzs.a().a(paramMsgBody);
      }
    }
    label180:
    do
  ...
  public void a(submsgtype0x11b.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      axal localaxal = new axal();
      if (paramMsgBody.bytes_qr_sig.has()) {
        localaxal.a(paramMsgBody.bytes_qr_sig.get().toStringUtf8());
      }
      if (paramMsgBody.enum_biz_type.has()) {
        localaxal.a(paramMsgBody.enum_biz_type.get());
      }
      paramMsgBody = localaxal.a();
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (paramGenericSubCmd.length() == 1)
      {
        ...
        if ("exit".equals(paramGenericSubCmd.optString("cmd")))
        {
          ...
          if (TextUtils.equals(paramGenericSubCmd, awzh.a().a())) {
            axcm.a().b(true);
          }
        }
      }
