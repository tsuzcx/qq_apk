...
public class anmn
{
  ...
  public anmn(String paramString1, String paramString2)
  {
    this.b = paramString1;
    this.a = paramString2;
  }
  ...
  public static boolean a(byte[] paramArrayOfByte1, String paramString, byte[] paramArrayOfByte2)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(bhcu.decode(paramString.getBytes("UTF-8"), 0)));
