  ...
  implements Manager
{
  ...
  public String a;
  HashMap<String, nyx> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public nyv(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bghi = new nyw(this);
  ...
  public nyx a(String paramString, long paramLong)
  {
    nyx localnyx2 = (nyx)this.jdField_a_of_type_JavaUtilHashMap.get(paramString + paramLong);
    nyx localnyx1 = localnyx2;
    if (localnyx2 == null)
    {
      localnyx1 = new nyx(this);
      localnyx1.jdField_a_of_type_JavaLangString = paramString;
      localnyx1.jdField_a_of_type_Long = paramLong;
      this.jdField_a_of_type_JavaUtilHashMap.put(localnyx1.a(), localnyx1);
    }
    return localnyx1;
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    new bghh("https://now.qq.com/cgi-bin/now/web/room/get_live_room_url", "GET", this.jdField_a_of_type_Bghi, 1001, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    paramString2.put("CONTEXT", MobileQQ.getContext());
    new bghh("https://now.qq.com/cgi-bin/now/web/room/check_live_stat", "GET", this.jdField_a_of_type_Bghi, 1003, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public boolean b()
  {
    ...
    Iterator localIterator = ((bbbq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH)).a().iterator();
