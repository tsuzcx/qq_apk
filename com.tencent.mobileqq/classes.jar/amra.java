...
public class amra
{
  ...
  private Comparator<CmGamePushItem> jdField_a_of_type_JavaUtilComparator = new amrb(this);
  ...
  private void a(List<CmGamePushItem> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	amra:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   18: astore_2
    //   19: aload_2
    //   20: monitorenter
    //   21: aload_0
    //   22: getfield 23	amra:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: aload_1
    ...
    //   33: monitorexit
    //   34: aload_0
    //   35: getfield 43	amra:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   46: ifnull -33 -> 13
    //   49: aload_2
    //   50: invokevirtual 55	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   53: invokevirtual 61	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   56: astore_3
    //   57: aload_3
    //   58: ifnull -45 -> 13
    //   61: aload_3
    //   62: invokevirtual 67	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   65: astore_2
    //   66: aload_2
    //   67: invokevirtual 72	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   70: aload_1
    ...
    //   93: checkcast 127	com/tencent/mobileqq/apollo/data/CmGamePushItem
    //   96: invokevirtual 76	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   99: pop
    //   100: goto -23 -> 77
    //   103: astore_1
    //   104: invokestatic 95	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   107: ifeq +12 -> 119
    //   110: ldc 97
    //   112: iconst_2
    //   113: ldc 129
    //   115: aload_1
    //   116: invokestatic 103	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   119: aload_2
    //   120: invokevirtual 86	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   123: return
    //   124: astore_1
    //   125: aload_2
    //   126: monitorexit
    ...
    //   128: athrow
    //   129: aload_2
    //   130: invokevirtual 83	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   133: aload_2
    //   134: invokevirtual 86	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   137: return
    //   138: astore_1
    //   139: aload_2
    //   140: invokevirtual 86	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   143: aload_1
    //   144: athrow
  ...
  public void a(CmGamePushItem paramCmGamePushItem)
  {
    ...
    if ((localObject1 != null) && (paramCmGamePushItem.msg_type == 1)) {
      ((bbbq)((QQAppInterface)localObject1).getManager(QQManagerFactory.MGR_RED_TOUCH)).c(String.valueOf("103100.103200.103240.103248"));
    }
