...
public class amra
{
  ...
  public amra()
  {
    DisplayMetrics localDisplayMetrics = amox.a().a().a().getDisplayMetrics();
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    if (paramBitmap != null)
    {
      ...
      if ((!paramBitmap.isRecycled()) && (!amox.a().a().c())) {
        paramBitmap.recycle();
      }
    }
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    {
      amrq.a("BitmapCacheManager", "create bitmap out of memory", localOutOfMemoryError);
    }
    return localObject1;
  }
  ...
  public void a()
  {
    ...
    {
      Bitmap localBitmap = (Bitmap)localIterator.next();
      if ((localBitmap != null) && (!localBitmap.isRecycled()) && (!amox.a().a().c())) {
        localBitmap.recycle();
      }
    }
