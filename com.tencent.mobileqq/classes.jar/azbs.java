  ...
  implements View.OnClickListener
{
  ...
  public azbs(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment, View paramView)
  {
  ...
  {
    azcb localazcb = (azcb)this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int);
    String str;
    ...
    case 2131366590: 
      ...
      do
      {
        do
        {
          ...
          str = "2";
          break;
          paramView = new ProfileActivity.AllInOne(String.valueOf(localazcb.jdField_c_of_type_Long), 86);
          ...
          boolean bool = BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(String.valueOf(localazcb.jdField_c_of_type_Long));
          ...
          for (;;)
          {
            axqy.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_poster", 0, 0, localazcb.d, localazcb.b + "", "", str);
            return;
        ...
        } while (localazcb.jdField_c_of_type_Boolean);
        ...
        this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(1, String.valueOf(localazcb.jdField_c_of_type_Long), new azbt(this, localazcb, str));
        return;
        ...
        for (paramView = "" + localazcb.h;; paramView = "")
        {
          axqy.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localazcb.d, localazcb.b + "", paramView, str);
          return;
        ...
        for (;;)
        {
          axqy.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localazcb.d, localazcb.b + "", "", str);
          return;
        ...
        for (;;)
        {
          axqy.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_share", 0, 0, localazcb.d, localazcb.b + "", "", str);
          return;
          if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_c_of_type_Boolean)
          {
            if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_a_of_type_ComTencentBizUiTouchWebView != null) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(localazcb.b, localazcb.d, new azbu(this, localazcb));
      axqy.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_like", 0, 0, localazcb.d, localazcb.b + "", "", str);
      return;
    }
    ...
    paramView.putExtra("url", localazcb.g);
    this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.getActivity().startActivity(paramView);
    axqy.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_detail", 0, 0, localazcb.d, localazcb.b + "", "", str);
  }
}
