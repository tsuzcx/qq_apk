...
public class syb
{
  ...
  public static int a(String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      } else if ((localRecentUserBaseData.mUser.getType() == 1008) && (ssp.b((QQAppInterface)ors.a(), localRecentUserBaseData.mUser.uin))) {
        ((Iterator)localObject2).remove();
      }
    }
    int i = 0;
  ...
  public static String a(ArticleInfo paramArticleInfo, pgr parampgr)
  {
    ...
    for (;;)
    {
      ...
      parampgr = ReadInJoyUserInfoModule.a(Long.valueOf(paramArticleInfo.msgBoxBriefPreFix).longValue(), parampgr);
      if (parampgr == null)
      {
        localObject1 = ReadInJoyUserInfoModule.a() + ": ";
        break;
      }
      localObject1 = parampgr.nick + ": ";
      break;
        ...
        for (;;)
        {
          ...
          if (paramBaseArticleInfo.mTopicRecommendFeedsInfo != null)
          {
            ...
            if (paramBaseArticleInfo.mTopicRecommendFeedsInfo.a != null)
            {
              ...
              {
                localObject = ((qno)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c;
                str1 = ((qno)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_JavaLangString;
              }
            }
          }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return nbv.a(paramString, "_kdSkinVoice=0");
      label123:
      Object localObject2 = null;
    }
  }
  ...
  public static NewIntent a(QQAppInterface paramQQAppInterface, Context paramContext, MqqHandler paramMqqHandler, String paramString)
  {
    ...
    //   36: ifnull +7 -> 43
    //   39: aload_2
    //   40: putstatic 399	syb:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   43: ldc 2
    //   45: monitorexit
    ...
    //   130: dup
    //   131: aload_0
    //   132: invokespecial 458	syc:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    ndv.a(paramContext, paramIntent, paramString, false, -1, true, -1);
  }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    } while (!nbp.a(paramActivity, paramString));
    a(paramIntent, paramActivity, paramString, paramInt2, paramInt3);
    return;
    ndv.a(paramActivity, paramIntent, paramString, false, 5, true, paramInt2);
  }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        break;
      case -6: 
        if (!nbp.a(paramContext, paramString)) {
          break;
        }
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, alzr paramalzr, int paramInt)
  {
    ...
    for (;;)
    {
      nrt.a(paramAppInterface, paramString, 0);
      return;
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, alzr paramalzr, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new NewIntent(paramContext.getApplicationContext(), nrz.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean1, alzr paramalzr, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean2) || (paramContext == null) || (a(paramContext.accountFlag) != -4))
    {
      ...
      if ((!paramBoolean2) && (paramContext != null) && (a(paramContext.accountFlag) == -4))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApp().getApplicationContext(), nrz.class);
  ...
  public static String b(QQAppInterface paramQQAppInterface, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBaseArticleInfo.mFeedType == 4) || (paramBaseArticleInfo.mFeedType == 5))
      {
        ...
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qme.a, null);
          if (paramBaseArticleInfo != null) {}
      ...
      else
      {
        ...
        if (paramBaseArticleInfo.mFeedType == 28)
        {
          ...
          {
            paramQQAppInterface.append(i + 1).append(".").append(((qkz)paramBaseArticleInfo.hotWordInfo.a.get(i)).jdField_a_of_type_JavaLangString).append("  ");
            i += 1;
          }
          continue;
        }
  ...
  private static void b(AppInterface paramAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      localNewIntent.setObserver(new syn(paramContext, paramAppInterface, paramInt, paramString));
  ...
  public static void c(String paramString)
  {
    ...
    nrt.a(null, "CliOper", "", "", "0X8009A7C", "0X8009A7C", 0, 0, paramString, "", "", "", false);
  }
  ...
  public static boolean e(String paramString)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("https://www.urlshare.cn")))
    {
      ...
      return (!TextUtils.isEmpty(paramString)) && (c(paramString));
    }
    return false;
  }
