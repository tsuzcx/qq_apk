...
public abstract class ysw
{
  ...
  public static ysw a(String paramString, JSONObject paramJSONObject)
  {
    if ("dex".equals(paramString))
    {
      ...
      do
      {
        ...
        if (PatchCommonUtil.isDalvik()) {
          return new ysz(paramJSONObject);
        }
        if (PatchCommonUtil.isArtLM()) {
          return new ysy(paramJSONObject);
        }
      } while (!PatchCommonUtil.isArtGeN());
      return new ysx(paramJSONObject);
    }
    if ("Native".equals(paramString)) {
      return new yta(paramJSONObject);
    }
