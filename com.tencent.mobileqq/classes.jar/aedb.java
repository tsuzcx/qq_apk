  ...
  extends BaseBubbleBuilder
{
  ...
  public aedb(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aedc(this);
  ...
  {
    paramacuj = (aedd)paramacuj;
    paramBaseChatItemLayout = (MessageForTroopFee)paramChatMessage;
    if ((paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (paramacuj.jdField_a_of_type_Long == paramChatMessage.uniseq)) {
      return paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    ...
    {
      paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView);
      paramacuj.b = paramChatMessage.frienduin;
      paramacuj.jdField_a_of_type_Long = paramChatMessage.uniseq;
      paramView = (TextView)paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377776);
      TextView localTextView1 = (TextView)paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377775);
      ImageView localImageView = (ImageView)paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377773);
      TextView localTextView2 = (TextView)paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377774);
      localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377777);
      ...
      localImageView.setImageResource(2130846331);
    ...
    {
      localQQWalletTransferBubbleView.setBubbleBackground(2130846329, i1, bool);
      paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramBaseChatItemLayout.title + paramBaseChatItemLayout.summary + paramBaseChatItemLayout.source);
      ...
      return paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout;
      paramacuj.jdField_a_of_type_AndroidWidgetRelativeLayout = a(this.jdField_a_of_type_AndroidContentContext);
      break;
      label378:
      if (f1 <= this.m * 14) {
        break label210;
  ...
  protected RelativeLayout a(Context paramContext)
  {
    ...
    ((RelativeLayout)localObject1).setBackgroundResource(2130846330);
