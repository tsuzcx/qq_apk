  ...
  implements View.OnTouchListener
{
  ...
  public ymd(TribeVideoPlugin paramTribeVideoPlugin, String paramString)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      Object localObject1 = yme.a((yme)TribeVideoPlugin.a(paramView).get(this.jdField_a_of_type_JavaLangString));
      if ((localObject1 != null) && (ymc.a((ymc)localObject1) == 2))
      {
        ...
        if ((Math.abs(TribeVideoPlugin.a(paramView).y - TribeVideoPlugin.b(paramView).y) < 8) && (Math.abs(TribeVideoPlugin.a(paramView).x - TribeVideoPlugin.b(paramView).x) < 8))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            Object localObject2 = yme.a((yme)TribeVideoPlugin.a(paramView).get(str));
            SeekBar localSeekBar = ymc.a(yme.a((yme)TribeVideoPlugin.a(paramView).get(str)));
