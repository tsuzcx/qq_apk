  ...
  extends Handler
{
  ...
  public vga(WSPlayerManager paramWSPlayerManager, Looper paramLooper)
  {
    super(paramLooper);
  ...
  public void dispatchMessage(Message paramMessage)
  {
    ...
    {
      return;
      if (!(paramMessage.obj instanceof vgb)) {
        break;
      }
    } while (!WSPlayerManager.a(localWSPlayerManager, (vgb)paramMessage.obj));
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case -4: 
      ...
      if (WSPlayerManager.b(localWSPlayerManager).jdField_a_of_type_Vgi == null) {
        break;
      }
    case -3: 
      for (paramMessage = WSPlayerManager.b(localWSPlayerManager).jdField_a_of_type_Vgi.b;; paramMessage = "videoInfo is null.")
      {
        vmp.d("WS_VIDEO_PLAYER", paramMessage);
        ...
        return;
        vmp.e("WS_VIDEO_PRE_PLAY", "[WSPlayerManager.java][handleMessage] MSG_PRE_PLAY_TIME_OUT. prePlay timeout, try rePlay");
        paramMessage = WSPlayerManager.a(localWSPlayerManager, WSPlayerManager.b(localWSPlayerManager));
        if ((paramMessage != null) && (paramMessage.e()) && (paramMessage.a() == WSPlayerManager.b(localWSPlayerManager).jdField_a_of_type_Vgi))
        {
          vmp.e("WS_VIDEO_PLAYER", "[WSPlayerManager.java][handleMessage] MSG_PRE_PLAY_TIME_OUT. startVideoAfterPrepared!");
    ...
    long l1;
    boolean bool;
    if ((paramMessage != null) && (paramMessage.b()) && ((((vgb)localObject).jdField_a_of_type_Vfs == null) || (!((vgb)localObject).jdField_a_of_type_Vfs.a((vgb)localObject))) && (!paramMessage.f()))
    {
      l1 = paramMessage.a();
      long l2 = paramMessage.b();
      if (((vgb)localObject).jdField_a_of_type_Vfs != null) {
        ((vgb)localObject).jdField_a_of_type_Vfs.a((vgb)localObject, l1, l2);
      }
      if (l1 < l2 - 300L) {
        break label508;
      }
      ...
      int i = (int)(l2 - l1);
      vmp.e("WS_VIDEO_PLAYER", "[WSPlayerManager.java][handleMessage] MSG_FOR_UPDATE_VIDEO_PLAY_POSITION onVideoEndSoon pos:" + l1 + ", duration:" + l2 + ", remainDuration:" + i + ", mHasCallEndingSoon:" + WSPlayerManager.g(localWSPlayerManager));
      if ((!WSPlayerManager.g(localWSPlayerManager)) && (WSPlayerManager.a(localWSPlayerManager) != null))
      {
        ...
        if ((((vgb)localObject).jdField_a_of_type_Vfs != null) && (!WSPlayerManager.h(localWSPlayerManager)))
        {
          if ((!WSPlayerManager.e(localWSPlayerManager)) && (!WSPlayerManager.i(localWSPlayerManager))) {
            break label502;
          }
          bool = true;
          ((vgb)localObject).jdField_a_of_type_Vfs.a(WSPlayerManager.b(localWSPlayerManager), i, bool);
        }
      }
    }
    for (;;)
    {
      ...
      {
        vmp.e("WS_VIDEO_PLAYER", "[WSPlayerManager.java][handleMessage] MSG_FOR_UPDATE_VIDEO_PLAY_POSITION onVideoReplayOnLoop pos:" + l1);
        ...
        if (WSPlayerManager.a(localWSPlayerManager) != null)
        {
          ...
          while (paramMessage.hasNext()) {
            ((vgc)paramMessage.next()).a(WSPlayerManager.b(localWSPlayerManager), WSPlayerManager.c(localWSPlayerManager));
          }
        }
      }
    }
