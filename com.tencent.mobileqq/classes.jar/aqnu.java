...
public class aqnu
{
  public static Intent a(Activity paramActivity, Intent paramIntent, boolean paramBoolean)
  {
    if (paramIntent == null)
    {
      aqmb.a().a().a("ForwardUtils", 4, "getForwardData return null from main process");
      paramActivity = null;
    }
    Intent localIntent;
    do
  ...
  public static void a(Activity paramActivity, Intent paramIntent, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    if (!paramBoolean)
    {
      ...
      aqbc.a(paramActivity, paramIntent, 103, paramInt, paramString);
      return;
    }
    aqbc.a(paramActivity, paramIntent, 21, paramInt, paramString);
  }
}
