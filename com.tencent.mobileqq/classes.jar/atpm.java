...
public class atpm
{
  ...
  private static Map<String, atpn> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  public static void a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    localatpn.jdField_a_of_type_JavaLangString = paramString;
    localatpn.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localatpn);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      audr.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131692466), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131692473);
      audr.a(0, str + FileUtil.filesizeToString(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      str = str.toLowerCase();
      if (!becr.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
  ...
  public static boolean b(FileInfo paramFileInfo)
  {
    ...
    } while (!becr.jdField_a_of_type_JavaLangString.contains(paramFileInfo));
    return true;
  }
  ...
  public static boolean b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    } while (!becr.jdField_a_of_type_JavaLangString.contains(paramFileManagerEntity));
    return true;
  }
