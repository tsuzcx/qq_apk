  ...
  implements BluetoothProfile.ServiceListener
{
  ...
  public bhqn(TraeAudioManager paramTraeAudioManager)
  {
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_Bhqr.a("DEVICE_BLUETOOTHHEADSET", true);
            localObject = this.jdField_a_of_type_Bhqr;
            if (paramIntent == null) {
              break label525;
            }
          }
          ...
          {
            ((bhqr)localObject).a(paramContext);
            return;
            paramContext = " ";
            break;
            paramContext = "null";
      ...
      if (QLog.isColorLevel()) {
        QLog.w("BluetoohHeadsetCheck", 2, "   EXTRA_SCO_AUDIO_STATE " + b(i) + "  Bluetooth visible:" + this.jdField_a_of_type_Bhqr.b("DEVICE_BLUETOOTHHEADSET"));
      }
    } while (!QLog.isColorLevel());
    label519:
    label525:
  ...
  public boolean a(Context paramContext, bhqr parambhqr)
  {
    ...
    if ((paramContext == null) || (parambhqr == null)) {
      if (QLog.isColorLevel()) {
