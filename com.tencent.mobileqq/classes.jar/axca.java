  ...
  extends MSFServlet
{
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/if_proxy", "application/json", localJSONObject.toString(), new axcb(paramBusinessObserver));
      return;
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(paramQQAppInterface.getApp(), axca.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, atzp paramatzp)
  {
    paramString = new FaceSecureCheck.SecureCheckRequest();
    Object localObject = oxj.a(BaseApplicationImpl.getApplication());
    boolean bool;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      localObject = new NewIntent(paramQQAppInterface.getApp(), axca.class);
      ((NewIntent)localObject).setObserver(paramatzp);
  ...
  public static void a(String paramString1, long paramLong, String paramString2, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/appconf", "application/json", localJSONObject.toString(), new axcc(paramBusinessObserver));
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  private static void a(String paramString1, String paramString2, String paramString3, axce paramaxce)
  {
    ThreadManager.getNetExcutor().execute(new LoginVerifyServlet.3(paramString1, paramString2, paramString3, paramaxce));
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (localObject2 = bbma.b(paramFromServiceMsg.getWupBuffer());; localObject2 = null)
    {
