  ...
  implements AladdinConfigHandler
{
  ...
  {
    Float localFloat = (Float)bmhv.a("readinjoy_daily_mode_drag_threshold", Float.valueOf(1.0F));
  ...
  public static int a()
  {
    ...
    Integer localInteger = (Integer)bmhv.a("readinjoy_daily_mode_plan_number", Integer.valueOf(-1));
  ...
  public static String a()
  {
    ...
    jdField_b_of_type_JavaLangString = (String)bmhv.a("readinjoy_daily_mode_bottom_jump", "");
    return jdField_b_of_type_JavaLangString;
  }
  ...
  public static JSONObject a()
  {
    if (TextUtils.isEmpty(d)) {
      d = (String)bmhv.a("readinjoy_daily_mode_footer_pts", "");
    }
    ...
    catch (JSONException localJSONException1)
    {
      ...
      try
      {
        ...
        localJSONObject2.put("title_CN", anvx.a(2131702203));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (jdField_a_of_type_JavaLangString != null) {
          bmhv.a("readinjoy_daily_mode_bottom_text", jdField_a_of_type_JavaLangString);
        }
        if (jdField_b_of_type_JavaLangString != null) {
          bmhv.a("readinjoy_daily_mode_bottom_jump", jdField_b_of_type_JavaLangString);
        }
        if (c != null) {
          bmhv.a("readinjoy_daily_mode_bottom_jump_src", c);
        }
        if (d != null)
        {
          bmhv.a("readinjoy_daily_mode_footer_pts", d);
          return;
        }
      }
  ...
  public static String b()
  {
    ...
    c = (String)bmhv.a("readinjoy_daily_mode_bottom_jump_src", "0");
    return c;
  }
  
  public static void b()
  {
    jdField_a_of_type_Boolean = "1".equals((String)bmhv.a("readinjoy_daily_mode_refresh_mode", "0"));
    jdField_a_of_type_Int = ((Integer)bmhv.a("readinjoy_daily_mode_channel_id", Integer.valueOf(41505))).intValue();
    if (!bmhv.h())
    {
    ...
    if (pqf.jdField_a_of_type_Boolean) {
      jdField_a_of_type_Int = 41697;
    }
  }
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str1, "daily_plan_number")) {
        bmhv.a("readinjoy_daily_mode_plan_number", Integer.valueOf(str2));
      } else if (TextUtils.equals(str1, "daily_drag_threshold")) {
        bmhv.a("readinjoy_daily_mode_drag_threshold", Float.valueOf(str2));
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    bmhv.a("readinjoy_daily_mode_plan_number", Integer.valueOf(-1));
  }
}
