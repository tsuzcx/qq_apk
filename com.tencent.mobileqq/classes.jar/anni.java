  ...
  extends ajxj
{
  ...
  protected void onGetHeadInfo(boolean paramBoolean, Setting paramSetting)
  {
    ...
    for (paramSetting = annh.a(32, paramSetting.url, paramSetting.bHeadType, paramSetting.bFaceFlags);; paramSetting = null)
    {
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        for (;;)
        {
          ...
          String str2;
          i = 0;
          anml.b("StrangerHdHeadUrlFetcher", new Object[] { localNumberFormatException1.toString() });
      ...
      catch (Exception localException1)
      {
        for (;;)
        {
          label186:
          int i = 0;
          anml.b("StrangerHdHeadUrlFetcher", new Object[] { localException1.toString() });
      ...
      str1 = null;
      break;
      anml.b("StrangerHdHeadUrlFetcher", new Object[] { "setting.url is null" });
    }
  }
  ...
  protected void onUpdateStrangerHead(boolean paramBoolean1, String paramString, int paramInt, boolean paramBoolean2)
  {
    ...
    {
      String str1 = annh.a(32, paramInt, paramString);
