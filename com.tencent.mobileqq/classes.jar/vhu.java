  ...
  implements vhv
{
  ...
  public vhu(@NonNull vhm paramvhm)
  {
    super(paramvhm);
  }
  ...
  private int a()
  {
    int i = ((Integer)((tcs)tcz.a(10)).b("key_last_used_permission", Integer.valueOf(10000))).intValue();
    ved.a("Q.qqstory.publish.edit.EditVideoPermission", "get default permission from local. type is %d.", Integer.valueOf(i));
    return i;
  }
  ...
  private void b(int paramInt)
  {
    ...
    default: 
      ...
      paramInt = 1;
      switch (this.jdField_a_of_type_Vhm.a.b())
      {
      case 2: 
      default: 
        ved.e("Q.qqstory.publish.edit.EditVideoPermission", "unKnown entrance:%s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Vhm.a.b()) });
        i = 99;
      }
      break;
    }
  ...
  private void g()
  {
    ...
    {
    default: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699533));
      return;
    case 10004: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699541));
      return;
    case 10000: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699533));
      return;
    case 10001: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699537));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699542));
  }
  
  public void X_()
  {
    ved.b("Q.qqstory.publish.edit.EditVideoPermission", "onStop, set jump flag false.");
  ...
  public void a(int paramInt, @NonNull vsa paramvsa)
  {
    ...
    try
    {
      for (;;)
      {
        ...
        ved.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionType:" + i);
        ved.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionUinList:" + localObject.toString());
        ...
        paramvsa.a.readerConfBytes = localVideoReaderConf.toByteArray();
        if ((paramInt == 0) && (this.jdField_b_of_type_Int != this.jdField_a_of_type_Int))
        {
          ved.b("Q.qqstory.publish.edit.EditVideoPermission", "user has changed permission during editing session. default permission is %d, new permission is %d.", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Int));
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        ved.e("Q.qqstory.publish.edit.EditVideoPermission", "MyUin , can't format uin:%s", new Object[] { this.jdField_a_of_type_JavaLangString });
      }
    }
  }
}
