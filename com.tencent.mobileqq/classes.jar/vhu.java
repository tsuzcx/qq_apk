...
{
  public vhu(TroopWantGiftItemBuilder paramTroopWantGiftItemBuilder, ChatMessage paramChatMessage, MessageForWantGiftMsg paramMessageForWantGiftMsg) {}
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131362152)
    {
      ...
      paramView = SharedPreUtils.k(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemTroopWantGiftItemBuilder.jdField_a_of_type_AndroidContentContext, "url");
