...
public class vhu
{
  private static vhu jdField_a_of_type_Vhu;
  private Map<String, ArrayList<FeedCloudMeta.StComment>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private vrp jdField_a_of_type_Vrp = vrp.a(61);
  private Map<String, Integer> b = new HashMap();
  private Map<String, String> c = new HashMap();
  private Map<String, vig> d = new HashMap();
  
  public static vhu a()
  {
    if (jdField_a_of_type_Vhu == null) {}
    try
    {
      if (jdField_a_of_type_Vhu == null) {
        jdField_a_of_type_Vhu = new vhu();
      }
      return jdField_a_of_type_Vhu;
    }
    finally {}
  }
  ...
  private void a(int paramInt, boolean paramBoolean1, long paramLong, String paramString, FeedCloudRead.StGetCommentListRsp paramStGetCommentListRsp, FeedCloudMeta.StFeed paramStFeed, boolean paramBoolean2, boolean paramBoolean3, QQCircleFeedBase.StBusiInfoCommentListData paramStBusiInfoCommentListData)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      ...
      zwp.a().a(new QCircleCommentUpdateEvent(2, paramString, paramStGetCommentListRsp.vecComment.get(), a(paramStFeed.id.get()), paramInt));
      return;
    }
    paramString = paramStFeed.id.get();
    str = paramString;
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (this.d.get(paramString1) == null)
    {
      ...
      localvig.jdField_a_of_type_JavaLangString = paramString2;
      localvig.jdField_a_of_type_Boolean = paramBoolean1;
      localvig.b = paramBoolean2;
      this.d.put(paramString1, localvig);
      QLog.d("QCircleCommentBusiness", 1, "getDetailCommentSize: feedAttachInfo:" + paramString2);
      return;
    }
    ((vig)this.d.get(paramString1)).jdField_a_of_type_Boolean = paramBoolean1;
    ((vig)this.d.get(paramString1)).jdField_a_of_type_JavaLangString = paramString2;
  }
  
  private void a(String paramString, boolean paramBoolean)
  {
    if ((this.d != null) && (this.d.get(paramString) != null)) {
      ((vig)this.d.get(paramString)).b = paramBoolean;
    }
  }
  ...
  private void b(int paramInt1, int paramInt2, FeedCloudMeta.StFeed paramStFeed, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      VSNetworkHelper.a().a(paramInt1, paramString, new via(this, paramInt1, paramStFeed, paramBoolean1, paramBoolean2));
      return;
      bool1 = false;
      break;
    }
  ...
  private void b(int paramInt, FeedCloudMeta.StFeed paramStFeed, String paramString, boolean paramBoolean)
  {
    ...
    {
      paramString.setEnableCache(bool1);
      VSNetworkHelper.a().a(paramInt, paramString, new vib(this, paramInt, paramStFeed, paramBoolean));
      return;
      bool1 = false;
      break;
    }
  ...
  public String a(String paramString)
  {
    ...
    paramString = (vig)this.d.get(paramString);
    if (paramString != null)
    {
  ...
  public void a(int paramInt1, int paramInt2, FeedCloudMeta.StFeed paramStFeed, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (zzk.a("2004"))
    {
      ...
      zzk.a("2004", new vhv(this, paramInt1, paramStFeed, paramBoolean2));
      return;
    }
  ...
  public void a(int paramInt, FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment)
  {
    ...
    VSNetworkHelper.a().a(paramInt, localQCircleDoStickyRequest, new vhw(this, paramStFeed, paramStComment, paramInt));
  }
  ...
  public void a(int paramInt1, FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      zwp.a().a(new QCircleCommentUpdateEvent(4, paramStFeed.id.get(), paramStComment, a(paramStFeed.id.get()), paramInt1));
      return;
    }
    ...
    VSNetworkHelper.a().a(paramInt1, localQCircleDoCommentRequest, new vid(this, paramStComment, paramStFeed, paramInt1));
  }
  ...
  public void a(int paramInt1, FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment, FeedCloudMeta.StReply paramStReply, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      zwp.a().a(new QCircleCommentUpdateEvent(6, paramStFeed.id.get(), paramStComment, paramStReply, a(paramStFeed.id.get()), paramInt1));
      return;
    }
    ...
    VSNetworkHelper.a().a(paramInt1, localQCircleDoReplyRequest, new vif(this, paramStReply, paramStFeed, paramStComment, paramInt1));
  }
  ...
  public void a(int paramInt, FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment, FeedCloudMeta.StReply paramStReply, boolean paramBoolean)
  {
    ...
    VSNetworkHelper.a().a(paramInt, localQCircleDoReplyRequest, new vie(this, paramStFeed, paramStComment, paramStReply, paramInt));
  }
  ...
  public void a(int paramInt, FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment, boolean paramBoolean)
  {
    ...
    VSNetworkHelper.a().a(paramInt, localQCircleDoCommentRequest, new vic(this, paramStFeed, paramStComment, paramInt));
  }
  ...
  public void a(int paramInt, FeedCloudMeta.StFeed paramStFeed, String paramString, boolean paramBoolean)
  {
    ...
    {
      QLog.i("QCircleCommentBusiness", 1, "runPreload");
      zzk.a("2004", new vhy(this, paramInt, paramStFeed));
      return;
    }
  ...
  public void a(int paramInt, FeedCloudMeta.StFeed paramStFeed, QQCircleFeedBase.StBusiInfoCommentListData paramStBusiInfoCommentListData)
  {
    ...
    VSNetworkHelper.a().a(paramInt, localQCircleGetCommentListRequest, new vhz(this, paramInt, paramStFeed, paramStBusiInfoCommentListData));
  ...
  public void b(int paramInt, FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment)
  {
    ...
    VSNetworkHelper.a().a(paramInt, localQCircleDoStickyRequest, new vhx(this, paramStFeed, paramStComment, paramInt));
  }
}
