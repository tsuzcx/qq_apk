  ...
  extends WebViewPlugin
{
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.CALL_PHONE") != 0) {
          ((AppActivity)localActivity).requestPermissions(new aaro(this), 1, new String[] { "android.permission.CALL_PHONE" });
        }
      }
      else {
        return;
  ...
  private void c()
  {
    bdla.b(null, "CliOper", "", "", "0X8004B43", "0X8004B43", 0, 0, "", "", "", "");
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.SEND_SMS") != 0) {
          ((AppActivity)localActivity).requestPermissions(new aarp(this), 1, new String[] { "android.permission.SEND_SMS" });
        }
      }
      else {
        return;
  ...
  private void e()
  {
    bdla.b(null, "CliOper", "", "", "0X8004B44", "0X8004B44", 0, 0, "", "", "", "");
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.WRITE_CONTACTS") != 0) {
          ((AppActivity)localActivity).requestPermissions(new aarq(this), 1, new String[] { "android.permission.WRITE_CONTACTS" });
        }
      }
      else {
        return;
  ...
  private void g()
  {
    ...
    if (this.jdField_a_of_type_Bhgi == null)
    {
      ...
      localbhjq.a(1, localActivity.getString(2131699125));
      localbhjq.a(2, localActivity.getString(2131699126));
      localbhjq.a(String.format(localActivity.getString(2131699124), new Object[] { this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_Bhgi = bhdj.a(localActivity, localbhjq, new aarr(this));
      if (this.jdField_a_of_type_Bhgi != null) {}
    }
    else
    {
      this.jdField_a_of_type_Bhgi.setTitle(String.format(localActivity.getString(2131699124), new Object[] { this.jdField_a_of_type_JavaLangString }));
    }
    this.jdField_a_of_type_Bhgi.show();
  }
  ...
  private void i()
  {
    bdla.b(null, "CliOper", "", "", "0X8004B45", "0X8004B45", 0, 0, "", "", "", "");
    a("android.intent.action.INSERT", "vnd.android.cursor.dir/contact");
  }
  
  private void j()
  {
    bdla.b(null, "CliOper", "", "", "0X8004B46", "0X8004B46", 0, 0, "", "", "", "");
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bkzi = bkzi.a(this.mRuntime.a());
      this.jdField_a_of_type_Bkzi.c(String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131691565), this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_Bkzi.b(2131699127);
      this.jdField_a_of_type_Bkzi.b(2131699124);
      this.jdField_a_of_type_Bkzi.b(2131691264);
      this.jdField_a_of_type_Bkzi.c(2131690697);
      this.jdField_a_of_type_Bkzi.a(new aarn(this));
    }
    for (;;)
    {
      this.jdField_a_of_type_Bkzi.show();
      return;
      this.jdField_a_of_type_Bkzi.a(0, String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131691565), this.jdField_a_of_type_JavaLangString }));
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      if (((this.jdField_a_of_type_Bkzi == null) || (!this.jdField_a_of_type_Bkzi.isShowing())) && ((this.jdField_a_of_type_Bhgi == null) || (!this.jdField_a_of_type_Bhgi.isShowing())))
      {
