...
public class awtz
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    awua.a(paramQQAppInterface, 0, paramString, false);
    a(paramQQAppInterface, 0, paramString, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bfoy parambfoy)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (parambfoy != null) {}
      for (paramQQAppInterface = parambfoy.a;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)bcry.a(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131718334);
  ...
  {
    awua.a(paramQQAppInterface, 1, paramString, false);
