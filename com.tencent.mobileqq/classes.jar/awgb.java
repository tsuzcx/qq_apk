  ...
  extends ImageSpan
{
  ...
  public awgb(Context paramContext, int paramInt1, String paramString, int paramInt2, Drawable.Callback paramCallback)
  {
  ...
  public awgb(Context paramContext, int paramInt, String paramString, Drawable.Callback paramCallback)
  {
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_MqqUtilWeakReference != null)
          {
            ...
            this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new awgc(this));
            if (QLog.isColorLevel())
            {
