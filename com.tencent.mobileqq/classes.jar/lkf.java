...
public abstract class lkf
{
  ...
  public lkf(String paramString1, String paramString2, String paramString3)
  {
    lek.c("AVMagicfaceData", "init|config=" + paramString2 + "|" + paramString3 + "|" + paramString1);
    ...
    catch (JSONException paramString1)
    {
      ...
      lek.e("AVMagicfaceData", "MagicfaceData:: " + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason.toString());
  ...
  public boolean a(lkf paramlkf)
  {
    ...
    if (paramlkf != null)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        if ((!TextUtils.isEmpty(paramlkf.jdField_b_of_type_JavaLangString)) && (!paramlkf.jdField_b_of_type_JavaLangString.equalsIgnoreCase("face")))
        {
          bool1 = bool2;
          if (!paramlkf.jdField_b_of_type_JavaLangString.equalsIgnoreCase("voicesticker")) {}
        }
        else
        {
          bool1 = bool2;
