  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      if (SosoInterface.a() >= 12)
      {
        ...
        paramString = anpc.a();
        axrn.a(BaseApplicationImpl.getContext()).a(paramString, "actSoSoNoCityCodeTimeout", true, 0L, 0L, paramTencentLocation, "");
      }
    ...
    if (SosoInterface.a() > 0)
    {
      ...
      localObject2 = anpc.a();
      axrn.a(BaseApplicationImpl.getContext()).a((String)localObject2, "actSoSoNoCityCode", true, 0L, 0L, (HashMap)localObject1, "");
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool3)
        {
          ...
          localObject4 = (akuo)SosoInterface.a().get(j);
          if ((((akuo)localObject4).reqLocation == bool3) && ((!((akuo)localObject4).reqLocation) || (((akuo)localObject4).level <= k)))
          {
            if (!((akuo)localObject4).uiThread) {
              continue;
            }
            SosoInterface.a((akuo)localObject4, paramInt, (SosoInterface.SosoLbsInfo)localObject5);
            ...
            if (!((akuo)localObject4).goonListener) {
              break label1054;
            }
            if (QLog.isColorLevel()) {
              QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akuo)localObject4).tag + " goon...");
            }
          }
          if (akuo.access$1500((akuo)localObject4)) {
            break label1820;
          }
          if (!((akuo)localObject4).goonListener) {
            break label1135;
          ...
          label872:
          if (!akuo.access$1600((akuo)localObject4)) {
            break label1814;
          }
          ...
          ((akuo)localObject4).onConsecutiveFailure(paramInt, SosoInterface.d());
        ...
        continue;
        ((akuo)localObject4).onLocationFinish(paramInt, (SosoInterface.SosoLbsInfo)localObject5);
        continue;
        if (str.equals(((akuo)localObject4).tag)) {
          break label1833;
        }
      }
      finally {}
      ...
      akuo.access$1502((akuo)localObject4, true);
      if (QLog.isColorLevel())
      {
        QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akuo)localObject4).tag + " removed normally.");
        continue;
        label1115:
        if (((akuo)localObject3).level >= ((akuo)localObject4).level) {
          break label1817;
        }
        localObject3 = localObject4;
      }
    ...
    label1135:
    if (SystemClock.elapsedRealtime() - ((akuo)localObject4).sTime > 30000L)
    {
      SosoInterface.a().remove(j);
      akuo.access$1502((akuo)localObject4, true);
      if (((akuo)localObject4).reqLocation)
      {
        localObject6 = SosoInterface.a(((akuo)localObject4).level, true);
        break label1839;
        ((akuo)localObject4).onLocationFinish(i, (SosoInterface.SosoLbsInfo)localObject6);
        if (!QLog.isColorLevel()) {
          break label1852;
        }
        QLog.d("SOSO.LBS", 2, "lis=" + ((akuo)localObject4).tag + " err_timeout.reqRaw=" + ((akuo)localObject4).reqLocation + ". Force 2 remove it.");
        break label1852;
      }
      else
      {
    ...
    else if (((akuo)localObject4).reqLocation)
    {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akuo)localObject4).tag + " goon=" + ((akuo)localObject4).goonListener + " reqLocation=" + ((akuo)localObject4).reqLocation + " hasReqRaw=" + bool1);
        break label1871;
        if (((akuo)localObject1).level < ((akuo)localObject4).level)
        {
          ...
          if (m != 0)
          {
            ...
            for (paramTencentLocation = "";; paramTencentLocation = " goonLis been truncated:" + localObject7.tag)
            {
              ...
              if (localObject4 != null) {
                akuo.access$1602((akuo)localObject4, false);
              }
          ...
          if (localObject6 != null)
          {
            ...
            for (paramTencentLocation = "";; paramTencentLocation = " goonLis been truncated:" + localObject7.tag)
            {
              QLog.d("SOSO.LBS", 2, paramTencentLocation + " start:" + ((akuo)localObject6).tag);
              if (localObject4 != null) {
                akuo.access$1602((akuo)localObject4, false);
              }
              SosoInterface.d();
              ((akuo)localObject6).maxCacheInterval = 0L;
              SosoInterface.a((akuo)localObject6);
              return;
            }
          }
          if (localObject7 == null) {
          ...
          if ((akuo.access$1600(localObject7)) || (akuo.access$1500(localObject7))) {
            break;
          }
          SosoInterface.d();
  ...
  public void onStatusUpdate(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      synchronized (SosoInterface.a())
      {
        ...
        localakuo = (akuo)SosoInterface.a().get(i);
        if (localakuo == null) {
          break label161;
        }
        if (localakuo.uiThread) {
          ThreadManager.getUIHandler().post(new SosoInterface.3.1(this, localakuo, paramString1, paramInt, paramString2));
        }
      }
      localakuo.onStatusUpdate(paramString1, paramInt, paramString2);
      break label161;
      label157:
      return;
      label161:
