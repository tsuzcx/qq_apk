...
public class akum
  extends aktf
{
  protected akum(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("PhotoListActivity", 2, "PhotoListLogicDataline isConfirmed=" + paramBoolean + " allowUploadInXGTime=" + bcwu.b);
        }
        if ((!bhnv.b(BaseApplicationImpl.getContext())) || (paramBoolean) || (i == 0)) {
          break;
        }
        paramArrayList = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131717873);
        paramIntent = new PhotoListLogicDataline.1(this, paramIntent, i2, (String)localObject1, (String)localObject2);
        if (bjhk.a(this.mActivity, 4, new akun(this, paramIntent))) {
          bhlq.a(this.mActivity, 232, null, paramArrayList, new akuo(this, paramIntent), new akup(this)).show();
        }
        if (QLog.isColorLevel()) {
      ...
      bdll.b(null, "CliOper", "", "", "0X8009AB0", "0X8009AB0", i2, 0, (String)localObject1, (String)localObject2, "", "");
      return;
    }
  }
}
