...
public class bdno
{
  ...
  private ConcurrentHashMap<String, bdna> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private ConcurrentHashMap<String, Bundle> c = new ConcurrentHashMap();
  private ConcurrentHashMap<String, List<bczs>> d = new ConcurrentHashMap();
  private ConcurrentHashMap<String, aqaq> e = new ConcurrentHashMap();
  ...
  private void a(bdna parambdna, String paramString, JSONObject paramJSONObject, bdnx parambdnx)
  {
    ...
    paramString = new bdns(this, parambdna, parambdnx, paramString, paramJSONObject);
    bdnz.a("oidb_0xc7f_25", parambdna, paramJSONObject.toString(), paramString);
  }
  ...
  private boolean a(preAuth.PreAuthResponse paramPreAuthResponse)
  {
    ...
    if (paramPreAuthResponse.auth_items.has())
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = new bczs();
        ((bczs)localObject4).jdField_b_of_type_JavaLangString = ((appType.AuthItem)localObject3).api_list.get();
        ((bczs)localObject4).jdField_a_of_type_Int = ((appType.AuthItem)localObject3).default_flag.get();
        ((bczs)localObject4).jdField_b_of_type_Int = ((appType.AuthItem)localObject3).id.get();
        if (((appType.AuthItem)localObject3).is_new.get() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          ((bczs)localObject4).jdField_a_of_type_Boolean = bool;
          ((bczs)localObject4).jdField_a_of_type_JavaLangString = ((appType.AuthItem)localObject3).title.get();
          QLog.d("OpenSdkVirtualManager", 1, new Object[] { "onPreAuthResponse Permission=", ((bczs)localObject4).toString() });
    ...
    if (paramPreAuthResponse.android_info.has()) {
      this.e.put(str, aqaq.a(paramPreAuthResponse, paramPreAuthResponse.android_info));
    }
  ...
  public aqaq a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return (aqaq)this.e.get(paramString);
  }
  
  public bdna a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      return (bdna)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    }
    return null;
  }
  ...
  public preAuth.PreAuthRequest a(bdna parambdna, Activity paramActivity, String paramString1, String paramString2, Bundle paramBundle)
  {
    QLog.d("OpenSdkVirtualManager", 1, new Object[] { "-->createPreAuthRequest pkgName=", paramString1, ", appid=", paramString2, ", accountInfo=", parambdna });
    ...
    localPBStringField.set(paramActivity);
    localPreAuthRequest.qqv.set(bcxm.a().d());
    ...
    for (paramActivity = "";; paramActivity = Build.VERSION.RELEASE)
    {
      ...
      localPBStringField.set(paramActivity);
      localPreAuthRequest.skey.set(parambdna.jdField_b_of_type_JavaLangString);
  ...
  public List<bczs> a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
  ...
  public void a(long paramLong, String paramString1, String paramString2, bdnx parambdnx)
  {
    bdna localbdna = (bdna)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramLong));
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (localbdna == null))
    {
      QLog.d("OpenSdkVirtualManager", 1, "OpenVirtual.createVirtual.return for params error");
      if (parambdnx != null) {
        parambdnx.a(false, null, -1);
      }
      return;
    }
    ...
    try
    {
      ...
      QLog.d("OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.createVirtual.start:", bdnz.a(localJSONObject.toString(), localbdna.jdField_a_of_type_JavaLangString) });
      ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.1(this, localbdna, localJSONObject, parambdnx));
      return;
    }
  ...
  public void a(preAuth.PreAuthRequest paramPreAuthRequest, Activity paramActivity, bdna parambdna, bdny parambdny, int paramInt)
  {
    QLog.d("OpenSdkVirtualManager", 1, "preAuthWithRetry");
    if (paramActivity == null)
    {
      QLog.d("OpenSdkVirtualManager", 1, new Object[] { "preAuthWithRetry activity==null, preAuthCallback=", parambdny });
      if (parambdny != null) {
        parambdny.a(-1, "");
      }
      return;
    ...
    {
      localObject = bdnz.a(paramActivity, paramPreAuthRequest.appUniqueIdentifier.get());
    ...
    Object localObject = new NewIntent(BaseApplicationImpl.getApplication(), bdfa.class);
    ((NewIntent)localObject).putExtra("uin", parambdna.jdField_a_of_type_JavaLangString);
    ((NewIntent)localObject).putExtra("data", bdnz.a(paramPreAuthRequest.toByteArray(), parambdna));
    ...
    aqgh.a("KEY_PRE_AUTH");
    ((NewIntent)localObject).setObserver(new bdnv(this, parambdna, parambdny, paramInt, paramPreAuthRequest, paramActivity));
    BaseApplicationImpl.getApplication().getRuntime().startServlet((NewIntent)localObject);
  }
  
  public void a(OpenSDKAppInterface paramOpenSDKAppInterface, String paramString, bdnw parambdnw)
  {
    QLog.d("OpenSdkVirtualManager", 1, "getTicketNoPasswd uin=" + bdem.a(paramString));
    new bdna().jdField_a_of_type_JavaLangString = paramString;
    bdnb.a().a(paramString, 4096, new bdnu(this, paramOpenSDKAppInterface, parambdnw), false);
  }
  ...
  public void a(String paramString, long paramLong, bdnx parambdnx)
  {
    bdna localbdna = (bdna)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString));
    if (localbdna == null)
    {
    ...
    try
    {
      ...
      ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.2(this, localbdna, localJSONObject, parambdnx));
      return;
    }
  ...
  public void a(String paramString1, Activity paramActivity, String paramString2, Bundle paramBundle, bdny parambdny)
  {
    bdna localbdna = (bdna)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString1));
    if ((localbdna == null) || (paramActivity == null))
    {
      QLog.d("OpenSdkVirtualManager", 1, new Object[] { "updatePreAuthFromServer account=", localbdna, ", context=", paramActivity });
      if (parambdny != null) {
        parambdny.a(-1, "");
      }
      return;
    }
    a(a(localbdna, paramActivity, paramString2, paramString1, paramBundle), paramActivity, localbdna, new bdnr(this, parambdny), 2);
  }
  ...
  public void a(String paramString, bdna parambdna)
  {
    if ((!TextUtils.isEmpty(paramString)) && (parambdna != null)) {
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, parambdna);
    }
  }
  
  public void a(String paramString1, String paramString2, bdnx parambdnx)
  {
    bdna localbdna = (bdna)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString1));
    if ((TextUtils.isEmpty(paramString2)) || (localbdna == null))
    {
      QLog.d("OpenSdkVirtualManager", 1, "OpenVirtual.uploadAvatarImage.return for params error");
      if (parambdnx != null) {
        parambdnx.a(false, paramString2, null, -1);
      }
      return;
    }
    ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.4(this, paramString2, paramString1, localbdna, parambdnx));
  }
  
  public void a(boolean paramBoolean, String paramString1, List<bczs> paramList, long paramLong, bdnx parambdnx, String paramString2, Activity paramActivity)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    bdna localbdna = (bdna)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
    Object localObject1 = (Bundle)this.c.get(paramString1);
    if ((localAppRuntime == null) || (localObject1 == null) || (localbdna == null))
    {
      QLog.e("OpenSdkVirtualManager", 1, "OpenVirtual.doAuthorize return for param is null.");
      if (parambdnx != null) {
        parambdnx.a(false, -1, null);
      }
      return;
    }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        localObject3 = (bczs)((Iterator)localObject2).next();
        if (((bczs)localObject3).jdField_b_of_type_Boolean)
        {
          localAuthorizeRequest.openapi.add(Integer.valueOf(((bczs)localObject3).jdField_b_of_type_Int));
          ((StringBuilder)localObject1).append(((bczs)localObject3).jdField_b_of_type_Int).append(",");
        }
      }
    }
    ...
    for (localObject1 = localObject1.toString();; localObject1 = "")
    {
      ...
      break label453;
      label728:
      localObject2 = bdnz.a(paramActivity, paramString2);
    ...
    localAuthorizeRequest.skey.set(localbdna.jdField_b_of_type_JavaLangString);
    if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      ((NewIntent)localObject1).putExtra("uin", localbdna.jdField_a_of_type_JavaLangString);
      ((NewIntent)localObject1).putExtra("data", bdnz.a(localAuthorizeRequest.toByteArray(), localbdna));
      ((NewIntent)localObject1).putExtra("cmd", "ConnAuthSvr.sdk_auth_api_emp");
      ((NewIntent)localObject1).setObserver(new bdnt(this, System.currentTimeMillis(), localbdna, parambdnx, paramString1, "ConnAuthSvr.sdk_auth_api_emp", paramBoolean, paramList, paramLong, paramString2, paramActivity));
      localAppRuntime.startServlet((NewIntent)localObject1);
      QLog.d("OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.doAuthorize.send | cmd: " + "s_a_a_emp", " | uin : *" + bdem.a(localbdna.jdField_a_of_type_JavaLangString) });
      return;
