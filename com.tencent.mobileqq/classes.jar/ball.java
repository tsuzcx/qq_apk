  ...
  implements balk
{
  ...
  public static balk a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.richmedia.ICallBack");
    if ((localIInterface != null) && ((localIInterface instanceof balk))) {
      return (balk)localIInterface;
    }
    return new balm(paramIBinder);
  }
