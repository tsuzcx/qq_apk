...
class yce
  implements Runnable
{
  yce(ycd paramycd, QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, Bundle paramBundle, Handler paramHandler) {}
  ...
  public void run()
  {
    ...
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      ...
      {
        TroopListAdapter.a((QQAppInterface)TroopListAdapter.a(this.jdField_a_of_type_Ycd.a).b.get(), TroopListAdapter.a(this.jdField_a_of_type_Ycd.a), localArrayList);
        return;
      }
      this.jdField_a_of_type_AndroidOsHandler.post(new ycf(this));
    }
  }
}
