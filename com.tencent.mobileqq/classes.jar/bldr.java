...
public final class bldr
{
  ...
  public static void a(Bitmap paramBitmap, bldv parambldv)
  {
    a(paramBitmap, parambldv, false);
  }
  
  public static void a(Bitmap paramBitmap, bldv parambldv, boolean paramBoolean)
  {
    if (parambldv == null) {
      return;
    }
    ...
    a(new FaceChangeUtils.5(paramBitmap, parambldv), paramBoolean, "GLThread-cropFace");
  }
  
  public static void a(Bitmap paramBitmap, List<String> paramList, blds paramblds)
  {
    if ((paramBitmap == null) || (paramList == null) || (paramList.isEmpty()))
    {
      ...
      paramblds.a(new ArrayList());
      return;
    }
    a(new FaceChangeUtils.2(paramList, paramBitmap, paramblds), false, "GLThread-changeFaceBatch");
  }
  ...
  private static bldt b(Bitmap paramBitmap, String paramString)
  {
    if ((paramBitmap == null) || (paramString == null))
    {
      blfg.d("FaceChangeUtils", "changeFaceInternal---null parameters: userFace, materialDir");
      return bldt.a(-1, "null parameters, material=" + paramString);
    }
    ...
    {
      blfg.d("FaceChangeUtils", "changeFaceInternal---failed to parse CrazyFace: " + paramString);
      return bldt.a(-2, "failed to parse material, material=" + paramString);
    }
    ...
    {
      blfg.d("FaceChangeUtils", "changeFaceInternal---failed to detect face");
      return bldt.a(-3, "failed to detect face");
    }
    Object localObject3 = a(((PTFaceAttr)localObject1).getAllFacePoints(), ((PTFaceAttr)localObject1).getFaceDetectScale());
    if (((List)localObject3).isEmpty())
    {
      blfg.d("FaceChangeUtils", "changeFaceInternal---userFacePointsList is empty");
      return bldt.a(-4, "no face points");
    }
    ...
    blfg.b("FaceChangeUtils", "success : + result");
    return bldt.a(paramString);
  }
  
  private static void c(Bitmap paramBitmap, bldv parambldv)
  {
    ...
    parambldv.a((Bitmap)localObject2);
  }
}
