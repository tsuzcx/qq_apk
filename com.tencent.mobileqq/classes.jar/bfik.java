...
public class bfik
  extends bfhq
{
  public bfik(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  public bfhr a(int paramInt1, List<Long> paramList, long paramLong1, Object paramObject, long paramLong2, long paramLong3, int paramInt2)
  {
    ...
    Object localObject = (annl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255);
    paramList = "";
    if (localObject != null)
    {
      localObject = ((annl)localObject).a(paramObject);
    ...
    for (;;)
    {
      if (paramInt1 != 0)
      {
        return new bfhr(true, paramList, null, null, paramObject);
        paramInt1 = 0;
        paramObject = null;
        break;
      }
  ...
  {
    paramString = anni.a(2131713835);
    paramTextView2.setMaxWidth((int)paramTextView2.getPaint().measureText(paramString));
    paramTextView2.requestLayout();
    paramTextView1.setVisibility(8);
    paramTextView2.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166225));
    paramImageView.setBackgroundResource(2130838515);
  }
