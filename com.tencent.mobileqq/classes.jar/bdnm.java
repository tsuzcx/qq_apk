...
public class bdnm
{
  ...
  private List<bdnk> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bdnm(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_Int = bahs.a(paramQQAppInterface, paramInt1, NetworkCenter.getInstance().getNetType());
    bahi.a(paramString);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bahi.a(this.jdField_a_of_type_JavaLangString);
  }
  
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    bahi.a(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, paramInt);
  }
