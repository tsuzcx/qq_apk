...
public class bdnm
  implements Manager
{
  private static bdnq jdField_a_of_type_Bdnq = new bdnq(null);
  public static final String a;
  public static AtomicBoolean a;
  public Handler a;
  private apnt jdField_a_of_type_Apnt = new bdno(this);
  public bdnt a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new bdnp(this);
  private Vector<Integer> jdField_a_of_type_JavaUtilVector = new Vector();
  public ConcurrentHashMap<Integer, bdns> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = bduw.a(aljq.aX + ".CorlorNick/");
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  }
  
  public bdnm(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bdnt = new bdnt(this);
  }
  
  public static int a(List<bejq> paramList, Paint paramPaint, Rect paramRect)
  {
    ...
    {
      bejq localbejq = (bejq)paramList.next();
      switch (localbejq.c)
      {
      }
      for (;;)
      {
        break;
        int j = (int)Math.ceil(paramPaint.measureText(localbejq.jdField_a_of_type_JavaLangString));
        paramPaint.getTextBounds(localbejq.jdField_a_of_type_JavaLangString, 0, localbejq.jdField_a_of_type_JavaLangString.length(), localRect);
        paramRect.bottom = Math.max(paramRect.bottom, localRect.height());
        i += j;
        continue;
        i += ((bain)localbejq.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        paramRect.bottom = Math.max(paramRect.bottom, ((bain)localbejq.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().height());
      }
    }
    paramRect.left = 0;
    paramRect.right = i;
  ...
  public static bdnm a(QQAppInterface paramQQAppInterface)
  {
    return ((bdqa)paramQQAppInterface.getManager(235)).a;
  }
  
  private bdns a(File paramFile, int paramInt)
  {
    int i = 0;
    paramFile = bdcs.a(paramFile, -1);
    try
    {
      paramFile = new JSONObject(paramFile);
      bdns localbdns = new bdns();
      paramFile = paramFile.optJSONArray("baseInfo");
      if ((paramFile != null) && (paramFile.length() > 0))
      {
        Object localObject = paramFile.getJSONObject(0);
        localbdns.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("type");
        if (localbdns.jdField_a_of_type_Int == 5)
        {
          ...
          localbdns.jdField_a_of_type_AndroidGraphicsBitmap = bdda.a((String)localObject, null);
          return localbdns;
        }
        localbdns.b = ((JSONObject)localObject).optInt("orientation");
        paramFile = ((JSONObject)localObject).optJSONArray("colors");
        if ((paramFile != null) && (paramFile.length() > 0))
        {
          localbdns.jdField_a_of_type_ArrayOfInt = new int[paramFile.length()];
          paramInt = 0;
          while (paramInt < paramFile.length())
          {
            String str = paramFile.getString(paramInt);
            localbdns.jdField_a_of_type_ArrayOfInt[paramInt] = Color.parseColor(str);
            paramInt += 1;
          }
        }
        if ((localbdns.jdField_a_of_type_Int != 1) && (localbdns.jdField_a_of_type_Int != 2))
        {
          paramFile = localbdns;
          if (localbdns.jdField_a_of_type_Int != 3) {
            return paramFile;
          }
        }
        ...
        localbdns.jdField_a_of_type_ArrayOfFloat = new float[((JSONArray)localObject).length()];
        paramInt = i;
        for (;;)
        {
          paramFile = localbdns;
          ...
          if (TextUtils.isDigitsOnly(paramFile))
          {
            ...
            localbdns.jdField_a_of_type_ArrayOfFloat[paramInt] = (i / 100.0F);
          }
          paramInt += 1;
        }
      }
  ...
  public static CharSequence a(MessageRecord paramMessageRecord, MsgSummary paramMsgSummary)
  {
    ...
    {
      if (!TextUtils.isEmpty(paramMsgSummary.strPrefix)) {
        localSpannableString = new bahs(paramMsgSummary.strPrefix, 16).a();
      }
      ...
      paramMsgSummary.strContent = new baig((CharSequence)localObject, 5, 16);
  ...
  public static CharSequence a(String paramString, MessageRecord paramMessageRecord, int paramInt1, int paramInt2)
  {
    ...
    {
      str = paramMessageRecord.getExtInfoFromExtStr(ayvj.i);
      ...
      str = bcek.a(localMessageForReplyText.mSourceMsgInfo.mSourceMsgSenderUin, str);
    }
    label71:
    for (;;)
    {
      return a(paramString, str, paramInt1, paramMessageRecord, paramInt2);
      return new baig(paramString, paramInt2, paramInt1, paramMessageRecord);
    }
  }
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramString2 != null) && (paramString2.size() > 0))
      {
        ...
        while (i < paramString2.size())
        {
          ...
          {
            bdnr localbdnr = new bdnr(null);
            localbdnr.jdField_a_of_type_Int = localAtTroopMemberInfo.startPos;
            ...
            {
              localbdnr.b = j;
              localbdnr.jdField_a_of_type_AndroidTextSpannableString = new bahs(paramString1.subSequence(localbdnr.jdField_a_of_type_Int, localbdnr.b), paramInt1).a();
              ((ArrayList)localObject).add(localbdnr);
              break;
        ...
        {
          paramString2 = (bdnr[])((ArrayList)localObject).toArray(new bdnr[((ArrayList)localObject).size()]);
          Arrays.sort(paramString2, jdField_a_of_type_Bdnq);
          localObject = new SpannableStringBuilder();
          ...
          if (i < m)
          {
            ...
            if (localAtTroopMemberInfo.jdField_a_of_type_Int >= j) {
              ((SpannableStringBuilder)localObject).append(new baig(paramString1.subSequence(j, localAtTroopMemberInfo.b), paramInt2, paramInt1, paramMessageRecord));
            }
            for (;;)
            {
          ...
          if (j < paramString1.length()) {
            ((SpannableStringBuilder)localObject).append(new baig(paramString1.subSequence(j, paramString1.length()), paramInt2, paramInt1, paramMessageRecord));
          }
          return localObject;
        }
      }
    }
    return new baig(paramString1, paramInt2, paramInt1, paramMessageRecord);
  }
  
  public static String a(bdnf parambdnf)
  {
    int j = 0;
    char[] arrayOfChar = new char[7];
    arrayOfChar[0] = '<';
    arrayOfChar[1] = '%';
    arrayOfChar[2] = ((char)(parambdnf.b >>> 24 & 0xFF));
    arrayOfChar[3] = ((char)(parambdnf.b >>> 16 & 0xFF));
    arrayOfChar[4] = ((char)(parambdnf.b >>> 8 & 0xFF));
    arrayOfChar[5] = ((char)(parambdnf.b & 0xFF));
    arrayOfChar[6] = '>';
    int i = j;
  ...
  public static List<bejq> a(int paramInt1, String paramString, Paint paramPaint, bejr parambejr, int paramInt2)
  {
    Object localObject = new ArrayList();
    ArrayList localArrayList = new ArrayList();
    ColorClearableEditText.a((List)localObject, parambejr, new bahs(paramString, paramInt2).a());
    int i = (int)Math.ceil(paramPaint.measureText("..."));
    paramString = ((ArrayList)localObject).iterator();
    paramInt2 = 0;
    if (paramString.hasNext())
    {
      parambejr = (bejq)paramString.next();
      switch (parambejr.c)
      {
      }
      for (;;)
      {
        break;
        localObject = azzp.a(paramInt1 - paramInt2, parambejr.jdField_a_of_type_JavaLangString, paramPaint);
        int j;
        if (((String)localObject).equals(parambejr.jdField_a_of_type_JavaLangString))
        {
          j = (int)Math.ceil(paramPaint.measureText(parambejr.jdField_a_of_type_JavaLangString));
          localArrayList.add(parambejr);
          paramInt2 += j;
        }
        else
        {
          parambejr.jdField_a_of_type_JavaLangString = ((String)localObject);
          localArrayList.add(parambejr);
          return localArrayList;
          j = ((bain)parambejr.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
          if (j > paramInt1 - paramInt2 - i)
          {
            localArrayList.add(new bejq(1, parambejr.jdField_a_of_type_Int, parambejr.b, "...", null));
            return localArrayList;
          }
          localArrayList.add(parambejr);
          paramInt2 += j;
  ...
  public static void a(apud paramapud, QQAppInterface paramQQAppInterface, EditText paramEditText)
  {
    if (paramapud.a == null)
    {
    ...
    try
    {
      ...
      ((aube)paramQQAppInterface.getManager(14)).a(String.valueOf(j), new bdnn(j, i, paramEditText));
      return;
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              paramSpannable = (bdof[])paramSpannable.getSpans(0, paramSpannable.length(), bdof.class);
    ...
    if ((paramDraftTextInfo != null) && (!TextUtils.isEmpty(paramDraftTextInfo.mAtInfoStr)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if (paramDraftTextInfo != null)
      {
        ...
        while (paramDraftTextInfo.hasNext())
        {
          ...
          {
            SpannableString localSpannableString = bceh.a(paramQQAppInterface, paramBaseActivity, paramString2, Long.toString(localAtTroopMemberInfo.uin), paramString1.substring(localAtTroopMemberInfo.startPos + 1, localAtTroopMemberInfo.startPos + localAtTroopMemberInfo.textLen), false, paramXEditTextEx, true);
            if (localSpannableString != null) {
  ...
  public Shader a(int paramInt1, List<bejq> paramList, float paramFloat1, float paramFloat2, Rect paramRect, Paint paramPaint, int paramInt2, int paramInt3)
  {
    bdns localbdns = a(paramInt1);
    if (localbdns != null) {}
    float f1;
    float f2;
    label90:
    ...
    Object localObject3;
    bejq localbejq;
    switch (localbdns.jdField_a_of_type_Int)
    {
    default: 
      return null;
    case 1: 
      ...
      {
        return new LinearGradient(f1, f2, paramFloat1, paramFloat2, localbdns.jdField_a_of_type_ArrayOfInt, localbdns.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
    ...
    case 2: 
      ...
      {
        localbejq = (bejq)paramList.get(paramInt2);
        switch (localbejq.c)
        {
        default: 
          paramInt2 += 1;
        ...
        case 1: 
          ...
          paramPaint.getTextBounds(localbejq.jdField_a_of_type_JavaLangString, 0, localbejq.jdField_a_of_type_JavaLangString.length(), (Rect)localObject3);
    ...
    {
      paramInt3 = 0;
      if (paramInt3 < localbejq.jdField_a_of_type_JavaLangString.length())
      {
        float f5 = paramPaint.measureText(localbejq.jdField_a_of_type_JavaLangString, paramInt3, paramInt3 + 1);
        if (localbdns.b == 1)
        {
        ...
        {
          paramRect.setShader(new LinearGradient(paramFloat2, f1, f2, f3, localbdns.jdField_a_of_type_ArrayOfInt, localbdns.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP));
      ...
      break label324;
      paramFloat1 += ((bain)localbejq.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
      break label324;
      return new BitmapShader((Bitmap)localObject1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
      return new RadialGradient(paramRect.width() / 2 + paramFloat1, paramRect.height() / 2 + paramFloat2, paramRect.width() / 2, localbdns.jdField_a_of_type_ArrayOfInt, localbdns.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
      ...
      {
        localObject3 = (bejq)paramList.get(paramInt2);
        switch (((bejq)localObject3).c)
        {
        }
        for (;;)
        {
          ...
          break;
          int i = 0;
          while (i < ((bejq)localObject3).jdField_a_of_type_JavaLangString.length())
          {
            paramFloat2 = paramPaint.measureText(((bejq)localObject3).jdField_a_of_type_JavaLangString, i, i + 1);
            ((Paint)localObject2).setColor(localbdns.jdField_a_of_type_ArrayOfInt[(paramInt1 % localbdns.jdField_a_of_type_ArrayOfInt.length)]);
          ...
          continue;
          paramFloat1 += ((bain)((bejq)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        }
      }
      return new BitmapShader(paramRect, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
      if (localbdns.jdField_a_of_type_AndroidGraphicsBitmap == null) {
        break;
      }
      paramList = Bitmap.createBitmap(paramInt2, paramInt3, Bitmap.Config.ARGB_8888);
      localObject1 = new Canvas(paramList);
      paramInt1 = localbdns.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
      localObject2 = new Rect();
      localObject3 = new Rect(0, 0, paramInt1, localbdns.jdField_a_of_type_AndroidGraphicsBitmap.getHeight());
      for (paramFloat1 = 0.0F; paramFloat1 < paramRect.width(); paramFloat1 += paramInt1)
      {
        ...
        ((Canvas)localObject1).drawBitmap(localbdns.jdField_a_of_type_AndroidGraphicsBitmap, (Rect)localObject3, (Rect)localObject2, paramPaint);
      }
  ...
  public bdns a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(paramInt))) {
      return (bdns)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    }
    a(paramInt);
    return null;
  }
