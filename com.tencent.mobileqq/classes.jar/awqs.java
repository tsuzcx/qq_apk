...
public class awqs
{
  ...
  private static HashMap<String, String> a()
  {
    ...
    if (a != null)
    {
      awqu.a("MsgBackup_MsgBackupReporter", "mReportContainer = %s", new Object[] { a });
  ...
  public static void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    bcst.b(null, "dc00898", "", "", paramString, paramString, paramInt1, 0, String.valueOf(paramInt2), "", "", "");
  }
  ...
  public static void c()
  {
    if (a != null)
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a(str, "MsgBackup_MsgBackupReporter", true, 0L, 0L, localHashMap, null);
      b();
    }
  }
}
