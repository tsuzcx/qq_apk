              ...
              if (paramFromServiceMsg.has())
              {
                ...
                if (paramFromServiceMsg.res_id.has())
                {
                  ...
                  for (;;)
                  {
                    ...
                    localaoax.jdField_a_of_type_Long = ((Integer)paramFromServiceMsg.get(i2)).intValue();
                    localaoax.jdField_a_of_type_Int = i1;
                    m += 1;
                    localaoax.b = m;
                    ((List)localObject).add(localaoax);
                    i2 += 1;
                  }
                  localObject = null;
                  break;
  ...
  public void a(List<Integer> paramList, long paramLong, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      if (paramLong >= l)
      {
        ...
        aoaz.a(localSharedPreferences, (List)localObject, Long.valueOf(paramLong), paramInt);
        paramStringBuilder.append(" saveUserSortInfo");
        return;
      }
      paramList = aoaz.a(this.app, paramInt);
