  ...
  implements View.OnClickListener
{
  ...
  public oiz(Context paramContext, ArrayList<ChannelCoverInfo> paramArrayList, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTopicText(localChannelCoverInfo.mChannelCoverName);
      label165:
      if (this.jdField_a_of_type_Int != 56) {
        break label402;
      }
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTextColor(7566195);
      label184:
      ...
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setCompoundDrawables(paramViewGroup, null, null, null);
      label263:
      if (!localChannelCoverInfo.isReport)
      {
        ...
        ojb.a("0X8007BE5", "1", "", "", localChannelCoverInfo, paramInt);
      }
    }
    for (;;)
    {
      ojb.a("0X8007F01", localChannelCoverInfo, ojb.b);
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setOnClickListener(this);
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo = localChannelCoverInfo;
      return paramView;
      localObject = (oja)paramView.getTag();
      break;
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setSubChannelText(localChannelCoverInfo.mChannelCoverName);
      break label165;
      label402:
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTextColor(localChannelCoverInfo.mFontColor);
      break label184;
      label418:
      ((oja)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setCompoundDrawables(null, null, null, null);
      break label263;
      label433:
      if (ors.a(this.jdField_a_of_type_Int)) {
        opn.a(this.jdField_a_of_type_AndroidContentContext, "0X8009A70", this.jdField_a_of_type_Int, localChannelCoverInfo.mChannelCoverId);
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      paramView = ((oja)paramView.getTag()).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo;
    ...
    if (TextUtils.isEmpty(paramView.mChannelJumpUrl))
    {
      ...
      if (this.jdField_a_of_type_Int == 56)
      {
        nxu.b(this.jdField_a_of_type_AndroidContentContext, paramView.mChannelCoverId, paramView.mChannelCoverName, paramView.mChannelType, 4, (Map)localObject);
        if (QLog.isColorLevel()) {
    ...
    {
      if (ors.a(this.jdField_a_of_type_Int)) {
        opn.a(this.jdField_a_of_type_AndroidContentContext, "0X8009A71", this.jdField_a_of_type_Int, paramView.mChannelCoverId);
      }
      ojb.a("0X8007F02", paramView, ojb.b);
      return;
      ...
      break;
      if (smk.b(paramView.mChannelJumpUrl)) {
        smk.a(this.jdField_a_of_type_AndroidContentContext, "", smk.b(paramView.mChannelJumpUrl), null);
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
