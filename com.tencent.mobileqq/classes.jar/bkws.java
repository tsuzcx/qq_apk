...
public class bkws
{
  ...
  public bkws(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bkwx = new bkwx();
    int i = (paramContext.getDisplayMetrics().widthPixels - (int)(a() * 5.2F)) / (((int)5.2F + 1) * 2);
    b(i);
    a((int)(i * 6 / 5.5F));
  }
  
  private String a(List<bbje> paramList)
  {
    Object localObject = "";
    int i = 0;
    if (i < paramList.size())
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Bkwx.a((RelativeLayout)localView.findViewById(2131362137));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          ...
          {
            if (((bbje)((Iterator)localObject5).next()).d != 0) {
              break label885;
            }
            i += 1;
          }
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new bkwu(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new bkwu(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new bkwt(this));
            if (j == 0) {
