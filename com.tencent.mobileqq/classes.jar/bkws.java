  ...
  extends bkwt
{
  ...
  public bkws(TraeAudioManager paramTraeAudioManager)
  {
  ...
  public boolean a(Context paramContext, bkwu parambkwu)
  {
    ...
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_Bkwu == null)) {}
    for (;;)
    {
      return false;
      try
      ...
      catch (Exception parambkwu)
      {
        ...
        catch (Exception parambkwu)
        {
          ...
          catch (NoSuchMethodException parambkwu)
          {
            try
            {
              do
              {
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_Bkwu.a("DEVICE_BLUETOOTHHEADSET", a());
                  if (!a()) {
                    break label337;
                  }
                  this.jdField_a_of_type_Bkwu.a("DEVICE_BLUETOOTHHEADSET", true);
                  ...
                  if (QLog.isColorLevel())
                  {
                    ...
                    parambkwu = parambkwu;
                    if (QLog.isColorLevel()) {
                      QLog.e("TraeAudioManager", 2, "BTLooperThread BluetoothHeadset.ServiceListener class not found:" + parambkwu);
                    }
                  }
                }
                parambkwu = parambkwu;
