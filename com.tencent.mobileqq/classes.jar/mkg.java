...
public class mkg
{
  ...
  private mkh jdField_a_of_type_Mkh;
  private boolean jdField_a_of_type_Boolean = true;
  private int jdField_b_of_type_Int;
  private boolean jdField_b_of_type_Boolean;
  
  public mkg(View paramView, Paint paramPaint, AttributeSet paramAttributeSet)
  {
  ...
  public void a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Mkh != null) {
        this.jdField_a_of_type_Mkh.a(this.jdField_a_of_type_AndroidViewView);
      }
    }
  }
