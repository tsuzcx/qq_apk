...
public abstract class yeb<T extends VideoListFeedItem>
  extends ybu<T>
{
  public static yed a;
  private boolean a;
  ...
  public boolean c;
  public List<zbe> d = new ArrayList();
  
  static
  {
    jdField_a_of_type_Yed = new yed(null);
  }
  
  public yeb(@NonNull T paramT)
  {
    super(paramT);
  ...
  public void a(int paramInt, StoryVideoItem paramStoryVideoItem)
  {
    ...
    for (;;)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        ykq.d("Q.qqstory.home.data.VideoListHomeFeed", "feed id %s, fake video count:%d", new Object[] { ((VideoListFeedItem)this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelFeedItem).feedId, Integer.valueOf(paramInt) });
        zdl.a();
        return;
      }
    }
  ...
  public void a(StoryVideoItem paramStoryVideoItem, boolean paramBoolean)
  {
    ...
    {
      bool2 = a(a().date);
      ykq.b("Q.qqstory.home.data.VideoListHomeFeed", "sort today=%b before %s", Boolean.valueOf(bool2), this.jdField_c_of_type_JavaUtilList);
    ...
    {
      Collections.sort(paramStoryVideoItem, new yee(paramBoolean));
      ykq.b("Q.qqstory.home.data.VideoListHomeFeed", "sort today=%b after %s", Boolean.valueOf(bool2), this.jdField_c_of_type_JavaUtilList);
      return;
    }
  }
  ...
  public boolean a()
  {
    ...
    {
      ykq.d("Q.qqstory.home.data.VideoListHomeFeed", "video item size:%d", new Object[] { Integer.valueOf(this.jdField_c_of_type_JavaUtilList.size()) });
    }
    return false;
  }
  ...
  {
    super.b();
    c(((wjp)wjs.a(5)).a(((VideoListFeedItem)this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelFeedItem).feedId), true);
  }
  ...
  public void c(List<StoryVideoItem> paramList, boolean paramBoolean)
  {
    ...
    {
      Collections.sort(paramList, new yee(paramBoolean));
      return;
    }
  }
