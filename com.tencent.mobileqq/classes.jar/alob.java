  ...
  extends alpd
{
  ...
  private aloo jdField_a_of_type_Aloo;
  ...
  alob(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    biby.a().c();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Bibq = new alok(this);
    biby.a().a(this.jdField_a_of_type_Bibq);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new alol(this);
  ...
  private JSONObject a(WadlResult paramWadlResult, String paramString)
  {
    try
    {
      ...
      localJSONObject1.put("errCode", bdop.b(paramWadlResult.jdField_c_of_type_Int));
  ...
  {
    super.Destruct();
    biby.a().b(this.jdField_a_of_type_Bibq);
    this.jdField_a_of_type_Bibq = null;
    this.jdField_a_of_type_Alon = null;
    this.jdField_a_of_type_Aloo = null;
  ...
  {
    if (!aloz.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.DOWNLOAD"))
    {
    ...
    if (paramString.equals("QueryPackageState"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_Alon = new aloc(this, l);
        if (paramArrayOfVariantWrapper.size() > 0) {
          biby.a().a(paramArrayOfVariantWrapper);
        }
        return true;
      }
      return false;
    ...
    if (paramString.equals("QueryPackageStateVia"))
    {
      ...
      {
        paramString = paramArrayOfVariantWrapper[0].GetString();
        this.jdField_a_of_type_Aloo = new alod(this, a(paramArrayOfVariantWrapper[1].Copy()));
    ...
    if (paramString.equals("DownloadInit"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
      {
        ...
        this.jdField_a_of_type_Alom = new aloe(this);
    ...
    {
      if (this.jdField_a_of_type_Alom == null)
      {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        if (paramArrayOfVariantWrapper.jdField_b_of_type_Int == 12) {
          axqw.a(null, "dc00898", "", "", "0X8009E12", "0X8009E12", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
        }
        while (paramString != null)
        {
          ...
          if (d > bibz.a())
          {
            ...
            if (paramArrayOfVariantWrapper.jdField_b_of_type_Int == 2) {
              axqw.a(null, "dc00898", "", "", "0X8009E11", "0X8009E11", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
            }
          }
          else if ((bool) && (bbev.g(paramString)) && (bbev.b(paramString) != 1))
          {
            str2 = String.format(paramString.getString(2131690229), new Object[] { bbdi.a(d) });
    ...
    if (paramString.equals("PauseDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        biby.a().a(i, paramString);
        paramVariantWrapper.SetBool(true);
        axqw.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "1", "", paramString, "");
        return true;
      }
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    if (paramString.equals("ContinueDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        if ((bool) && (paramArrayOfVariantWrapper != null) && (bbev.g(paramArrayOfVariantWrapper)) && (bbev.b(paramArrayOfVariantWrapper) != 1))
        {
        ...
        biby.a().b(i, paramString);
        this.c = true;
        axqw.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "2", "", paramString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
    ...
    if (paramString.equals("InstallPackage"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        biby.a().b(paramString);
        axqw.a(null, "dc00898", "", "", "0X8009E16", "0X8009E16", 0, 0, "", "", paramString.jdField_a_of_type_JavaLangString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
