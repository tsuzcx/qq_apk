...
public class bgxb
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bgxd parambgxd)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bgxc(parambgxd, paramString));
    if (!bbkk.a(paramQQAppInterface))
    {
      if (parambgxd != null)
      {
        ...
        parambgxd.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
