...
public class augv
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, aueu paramaueu, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramaueu == null) || (paramaueu.b)) {
          break label519;
        }
        paramaueu.b = true;
        if ((paramInt == 1) && (paramaueu.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramaueu, paramInt);
        paramaueu = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramaueu)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramaueu.toString() + ",filePath:" + paramString2);
        paramaueu = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramaueu = (aueu)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramaueu);
      if (QLog.isColorLevel())
      {
        if (paramaueu != null) {
          continue;
