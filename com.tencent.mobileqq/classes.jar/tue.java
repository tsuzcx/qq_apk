...
public class tue
{
  ...
  private static tue jdField_a_of_type_Tue = new tue();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final anqd jdField_a_of_type_Anqd = new tuf(this);
  private CharSequence jdField_a_of_type_JavaLangCharSequence = "";
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private HashMap<String, tty> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<tty> jdField_a_of_type_JavaUtilList = new ArrayList();
  private tug jdField_a_of_type_Tug = new tug(this);
  private boolean jdField_a_of_type_Boolean;
  private long jdField_b_of_type_Long;
  private String jdField_b_of_type_JavaLangString = "";
  private final HashMap<String, Integer> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private List<tty> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  private static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (localObject3 != null) {
      if ((!alcu.a(paramQQAppInterface)) || (Thread.currentThread() != ThreadManager.getRecentThreadLooper().getThread())) {}
    }
    label460:
    label1123:
    for (;;)
    {
      ...
      try
      {
        Object localObject1 = ((anrs)localObject3).a(paramString, true);
        if (localObject1 != null) {
          break label1123;
        }
        localAccountDetail = ((anrs)localObject3).b(paramString);
      ...
      {
        localObject2 = ((anrs)localObject3).c(paramString);
        continue;
      }
      Object localObject2 = ((anrs)localObject3).c(paramString);
      continue;
      ...
      else
      {
        ...
        else if (i != -1)
        {
          ...
          {
            localObject2 = ((anmw)paramQQAppInterface.getManager(51)).b(paramString);
            if ((localObject2 != null) && (((Friends)localObject2).isFriend()))
            {
              ...
              bctj.a(BaseApplicationImpl.getContext()).a(paramString, "ServiceAccountFolderManager_InValid_puin", false, 1L, 0L, (HashMap)localObject2, null);
              return 0;
            }
          }
          ...
          if (localObject2 != null)
          {
            if (((MessageRecord)localObject2).istroop != 1008)
            {
              ...
              bctj.a(BaseApplicationImpl.getContext()).a(paramString, "ServiceAccountFolderManager_InValid_Msg", false, 1L, 0L, (HashMap)localObject3, null);
              return 0;
            }
            if (nve.a((MessageRecord)localObject2)) {
              return 0;
            }
  ...
  public static Drawable a()
  {
    ...
    if (!TextUtils.isEmpty(tyg.jdField_e_of_type_JavaLangString)) {
      localObject = URLDrawable.getDrawable(tyg.jdField_e_of_type_JavaLangString, localDrawable, localDrawable);
    }
    return localObject;
  }
  ...
  {
    if (TextUtils.isEmpty(tyg.jdField_d_of_type_JavaLangString)) {
      return tyg.b();
    }
    return tyg.jdField_d_of_type_JavaLangString;
  }
  ...
  public static tue a()
  {
    if (jdField_a_of_type_Tue == null) {}
    try
    {
      jdField_a_of_type_Tue = new tue();
      return jdField_a_of_type_Tue;
    }
    finally {}
  }
  ...
  private void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localanrs = (anrs)localQQAppInterface.getManager(56);
      } while ((localanrs != null) && (localanrs.c(paramString) == null) && (localanrs.b(paramString) == null));
      if (tzo.a(localQQAppInterface, paramString) != -7) {
        break;
      }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          {
            if (TextUtils.isEmpty(((tty)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangCharSequence)) {
              break label158;
            }
            tty localtty = (tty)this.jdField_a_of_type_JavaUtilList.get(i);
            long l = a(localtty);
            if (QLog.isColorLevel()) {
  ...
  public long a(tty paramtty)
  {
    ...
    paramtty = paramtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    if ((paramtty != null) && ((paramtty instanceof MessageForStructing)))
    {
      MessageForStructing localMessageForStructing = (MessageForStructing)paramtty;
      paramtty = localMessageForStructing.structingMsg;
      if (paramtty != null) {
        break label110;
      }
      paramtty = bcwd.a(localMessageForStructing.msgData);
    }
    label110:
    for (;;)
    {
      if (paramtty != null) {}
      for (long l = paramtty.msgId;; l = 0L)
      {
        if (QLog.isColorLevel()) {
  ...
  public CharSequence a(QQAppInterface paramQQAppInterface)
  {
    if ((TextUtils.isEmpty(this.jdField_a_of_type_JavaLangCharSequence)) && (!this.jdField_a_of_type_Boolean))
    {
      f(paramQQAppInterface);
      this.jdField_a_of_type_Boolean = true;
      return new bdnt(this.jdField_a_of_type_JavaLangCharSequence, 3, 16);
    }
    if (QLog.isColorLevel()) {
  ...
  public CharSequence a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    bgnr.a(paramQQAppInterface.getApplication(), paramQQAppInterface, localMessage, localMessage.istroop, paramMessageRecord, localMessage.nickName, false, paramBoolean);
  ...
  public String a()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        Object localObject2 = (tty)this.jdField_a_of_type_JavaUtilList.get(0);
        if (localObject2 != null)
        {
          localObject2 = ((tty)localObject2).jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
          if (localObject2 != null)
          {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext()) {
          localStringBuilder.append(((tty)localIterator.next()).jdField_a_of_type_JavaLangString).append(",");
        }
        if (i <= 0) {
          break label194;
        }
  ...
  public List<tty> a(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      localObject1 = twi.a().a(paramQQAppInterface);
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localObject4 = twg.a(paramQQAppInterface, paramQQAppInterface.getApplication(), (TroopBarData)localObject4);
          if (localObject4 != null)
          {
            if ((((twg)localObject4).jdField_a_of_type_JavaUtilList != null) && (((twg)localObject4).jdField_a_of_type_JavaUtilList.size() > 0))
            {
              localObject5 = (twh)((twg)localObject4).jdField_a_of_type_JavaUtilList.get(0);
              if ((TextUtils.isEmpty(((twh)localObject5).jdField_b_of_type_JavaLangString)) && (!TextUtils.isEmpty(((twh)localObject5).jdField_c_of_type_JavaLangString))) {
                ((twh)localObject5).jdField_b_of_type_JavaLangString = ((twh)localObject5).jdField_c_of_type_JavaLangString;
              }
            }
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (twg)((Iterator)localObject4).next();
        if ((QLog.isColorLevel()) && (localObject1 != null)) {
          ((StringBuilder)localObject1).append("[").append(((twg)localObject3).jdField_a_of_type_JavaLangString).append(", ").append(((twg)localObject3).jdField_a_of_type_Int).append("]");
        }
        if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(((twg)localObject3).jdField_a_of_type_JavaLangString))
        {
          localObject5 = tty.a(paramQQAppInterface, (twg)localObject3);
          if (((tty)localObject5).jdField_b_of_type_Boolean)
          {
            this.jdField_a_of_type_JavaUtilList.add(localObject5);
            this.jdField_a_of_type_JavaUtilHashMap.put(((twg)localObject3).jdField_a_of_type_JavaLangString, localObject5);
          }
        }
      }
      else
      {
        ...
        for (;;)
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localObject4 = tty.a(paramQQAppInterface, localRecentUser);
              if (((tty)localObject4).jdField_b_of_type_Boolean)
              {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if ((TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) || (!this.jdField_a_of_type_JavaLangString.equals(paramQQAppInterface.getAccount())))
    {
      ...
      if (localSharedPreferences != null)
      {
        ...
        tyg.p = localSharedPreferences.getBoolean("service_folder_redclean_after_enter", false);
        if (QLog.isColorLevel()) {
      ...
      paramQQAppInterface.addObserver(this.jdField_a_of_type_Anqd, true);
      if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          localtty = (tty)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
          localtty.jdField_a_of_type_JavaLangString = paramString;
          localObject2 = (anrs)paramQQAppInterface.getManager(56);
          if (localObject2 != null)
          {
            PublicAccountInfo localPublicAccountInfo = ((anrs)localObject2).c(paramString);
            if (localPublicAccountInfo != null)
            {
              localtty.jdField_c_of_type_JavaLangString = localPublicAccountInfo.name;
              localtty.jdField_b_of_type_Boolean = localPublicAccountInfo.isVisible();
              localtty.jdField_c_of_type_Int = 0;
            }
          }
          else
          {
            localtty.jdField_b_of_type_Int = paramQQAppInterface.a().c(paramString, 1008);
            i = paramQQAppInterface.a().g(paramString, 1008);
            if (localtty.jdField_b_of_type_Int <= 0) {
              break label788;
            }
            if ((localtty.jdField_b_of_type_Int != 1) || (i <= 0)) {
              break label763;
            }
            localtty.jdField_a_of_type_Int = 2;
            localObject2 = paramQQAppInterface.a();
            if (localObject2 == null) {
              break label1003;
            }
            localtty.jdField_b_of_type_JavaLangCharSequence = null;
            localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((QQMessageFacade)localObject2).b(paramString, 1008);
            ...
            if ((localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (((DraftSummaryInfo)localObject2).getTime() <= localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time)) {
              break label797;
            }
            localtty.jdField_e_of_type_Int = 4;
            localtty.jdField_a_of_type_Long = ((DraftSummaryInfo)localObject2).getTime();
            localtty.jdField_b_of_type_JavaLangString = TimeManager.getInstance().getMsgDisplayTime(localtty.jdField_a_of_type_JavaLangString, ((DraftSummaryInfo)localObject2).getTime());
            localtty.jdField_a_of_type_JavaLangCharSequence = ((DraftSummaryInfo)localObject2).getSummary();
            i = 0;
            localtty.jdField_d_of_type_JavaLangString = a(paramQQAppInterface, localtty.jdField_a_of_type_JavaLangString);
            localtty.jdField_a_of_type_Boolean = true;
            if (!twi.a().a(paramQQAppInterface, paramString, 1008)) {
              break label961;
            }
            ...
            if (paramQQAppInterface.a() != null)
            {
              ...
              if (paramQQAppInterface.a().a() != null)
              {
                ...
                if (localObject2 != null)
                {
                  localtty.jdField_b_of_type_Long = ((RecentUser)localObject2).lastmsgtime;
                  j = i;
                  if (i != 0)
                  {
                    j = i;
                    if (localtty.jdField_b_of_type_Long > 0L)
                    {
                      localtty.jdField_a_of_type_Long = localtty.jdField_b_of_type_Long;
                      localtty.jdField_b_of_type_JavaLangString = TimeManager.getInstance().getMsgDisplayTime(paramString, localtty.jdField_a_of_type_Long);
                      localtty.jdField_a_of_type_JavaLangCharSequence = "";
                      j = 0;
                    }
                  }
                }
            ...
            if (QLog.isColorLevel()) {
              QLog.d("ServiceAccountFolderManager", 2, "updateServiceAccountFolderFeed->" + localtty.toString());
            }
            if (tzo.a(paramQQAppInterface, paramString) != -7) {
              break label998;
            }
            i = 1;
            if ((QLog.isColorLevel()) && (i != 0)) {
              QLog.d("ServiceAccountFolderManager", 2, "updateServiceAccountFolderFeed->puin:" + localtty.jdField_a_of_type_JavaLangString + " is Eqq!");
            }
            if ((!localtty.jdField_b_of_type_Boolean) || (j != 0) || (i != 0) || (!c(paramQQAppInterface, paramString)))
            {
              this.jdField_a_of_type_JavaUtilHashMap.remove(paramString);
              this.jdField_a_of_type_JavaUtilList.remove(localtty);
              if (QLog.isColorLevel()) {
                QLog.d("ServiceAccountFolderManager", 2, "updateServiceAccountFolderFeed->remove feed puin:" + localtty.jdField_a_of_type_JavaLangString + ", title:" + localtty.jdField_c_of_type_JavaLangString);
              }
            }
            h(paramQQAppInterface);
        ...
        {
          localtty = new tty();
          this.jdField_a_of_type_JavaUtilList.add(localtty);
          this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localtty);
          continue;
        }
        Object localObject2 = ((anrs)localObject2).b(paramString);
        if (localObject2 == null) {
          continue;
        }
        localtty.jdField_c_of_type_JavaLangString = ((AccountDetail)localObject2).name;
        if (1 == ((AccountDetail)localObject2).showFlag)
        {
          bool = true;
          localtty.jdField_b_of_type_Boolean = bool;
          localtty.jdField_c_of_type_Int = 0;
        }
      }
      boolean bool = false;
      continue;
      label763:
      localtty.jdField_a_of_type_Int = 1;
      label788:
      label797:
      label961:
      if (i > 0)
      {
        localtty.jdField_b_of_type_Int -= 1;
        continue;
        localtty.jdField_a_of_type_Int = 0;
        continue;
        localtty.jdField_e_of_type_Int = 0;
        localtty.jdField_a_of_type_Long = localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;
        localtty.jdField_b_of_type_JavaLangString = TimeManager.getInstance().getMsgDisplayTime(paramString, localtty.jdField_a_of_type_Long);
        localtty.jdField_a_of_type_JavaLangCharSequence = a(paramQQAppInterface, localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, false);
        i = 0;
        continue;
        label854:
        if ((localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time > 0L))
        {
          localtty.jdField_e_of_type_Int = 0;
          localtty.jdField_a_of_type_Long = localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;
          localtty.jdField_b_of_type_JavaLangString = TimeManager.getInstance().getMsgDisplayTime(paramString, localtty.jdField_a_of_type_Long);
        ...
        {
          localtty.jdField_e_of_type_Int = 0;
          localtty.jdField_a_of_type_Long = 0L;
          localtty.jdField_b_of_type_JavaLangString = null;
          localtty.jdField_a_of_type_JavaLangCharSequence = null;
          i = 1;
          continue;
          if ((localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ("1".equals(localtty.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("inter_num"))))
          {
            localtty.jdField_a_of_type_Boolean = false;
            continue;
            label998:
  ...
  public void a(QQAppInterface paramQQAppInterface, tty paramtty, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          tty localtty = (tty)this.jdField_a_of_type_JavaUtilHashMap.get(str);
          if (localtty != null)
          {
            this.jdField_a_of_type_JavaUtilList.remove(localtty);
        ...
        if (paramtty.jdField_a_of_type_Boolean)
        {
          paramtty = (RecentUser)paramQQAppInterface.a().a().findRecentUser(paramtty.jdField_a_of_type_JavaLangString, 1008);
          if (paramtty != null) {
            aldk.a(paramQQAppInterface, paramtty, -1);
          }
          if (paramBoolean)
          {
            h(paramQQAppInterface);
      ...
      twi.a().a(str, paramQQAppInterface);
      aldk.b(paramQQAppInterface, str, tzo.b(paramQQAppInterface, str));
  ...
  public int b()
  {
    if (this.e > this.jdField_c_of_type_Long)
    {
      ...
      if ((tyg.a()) && (this.jdField_d_of_type_Long >= this.e)) {
        if (QLog.isColorLevel()) {
  ...
  public void b(QQAppInterface paramQQAppInterface, tty paramtty, boolean paramBoolean)
  {
    if (paramtty == null) {}
    do
    {
      return;
      this.jdField_a_of_type_Int -= paramtty.jdField_b_of_type_Int;
      if (this.jdField_a_of_type_Int < 0) {
        this.jdField_a_of_type_Int = 0;
      }
      paramtty.jdField_b_of_type_Int = 0;
      paramtty = paramtty.jdField_a_of_type_JavaLangString;
      aldk.b(paramQQAppInterface, paramtty, 1008);
      paramQQAppInterface.a().c(paramtty, 1008);
      paramQQAppInterface.a().a(paramtty, 1008, true);
      a(paramQQAppInterface, paramtty);
      if (paramBoolean) {
        i(paramQQAppInterface);
      }
    } while (!QLog.isColorLevel());
    QLog.d("ServiceAccountFolderManager", 2, "clearServiceAccountFolderFeedUnreadNum->uin:" + paramtty + ", needRefresh:" + paramBoolean);
  }
    ...
    do
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          localtty.jdField_b_of_type_Int = 0;
          localArrayList.add(localtty.jdField_a_of_type_JavaLangString);
        }
      }
      this.jdField_a_of_type_Int = 0;
  ...
  public void h(QQAppInterface paramQQAppInterface)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        aldk.a(this.jdField_a_of_type_JavaUtilList);
        Collections.sort(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Tug);
        int i = 0;
        l3 = 0L;
        String str1 = "";
        int k = 0;
        ...
        if (localIterator.hasNext())
        {
          localObject5 = (tty)localIterator.next();
          if (((tty)localObject5).jdField_a_of_type_Int == 2)
          {
            bool = true;
            l2 = l3;
            if (((tty)localObject5).jdField_b_of_type_Int > 0)
            {
              l2 = l3;
              if (((tty)localObject5).jdField_a_of_type_Long >= l3) {
                l2 = ((tty)localObject5).jdField_a_of_type_Long;
              }
            }
            l3 = l4;
            if (((tty)localObject5).jdField_b_of_type_Long > l4) {
              l3 = ((tty)localObject5).jdField_b_of_type_Long;
            }
            if ((((tty)localObject5).jdField_b_of_type_Int <= 0) || (k != 0) || (TextUtils.isEmpty(((tty)localObject5).jdField_d_of_type_JavaLangString))) {
              break label822;
            }
            str1 = ((tty)localObject5).jdField_d_of_type_JavaLangString;
            k = 1;
            if ((j != 0) || (TextUtils.isEmpty(((tty)localObject5).jdField_a_of_type_JavaLangCharSequence))) {
              break label795;
            }
            l1 = ((tty)localObject5).jdField_a_of_type_Long;
            localObject4 = ((tty)localObject5).jdField_b_of_type_JavaLangString;
            localObject3 = ((tty)localObject5).jdField_c_of_type_JavaLangString;
            str2 = ((tty)localObject5).jdField_a_of_type_JavaLangString;
            localObject2 = ((tty)localObject5).jdField_a_of_type_JavaLangCharSequence;
            localObject1 = ((tty)localObject5).jdField_e_of_type_JavaLangString;
            j = 1;
            break label828;
          }
          if (((tty)localObject5).jdField_a_of_type_Int != 1) {
            break label825;
          }
          i += ((tty)localObject5).jdField_b_of_type_Int;
          continue;
        }
        ...
        {
          this.jdField_a_of_type_JavaLangCharSequence = new bdnt((CharSequence)localObject3, 3, 16).a((String)localObject2 + "：", true, new int[0]);
          if (this.jdField_a_of_type_JavaUtilList.size() <= 0) {
            break label787;
          }
          if (((tty)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_e_of_type_Int != 4) {
            break label863;
          }
          bool = true;
        ...
        if (!TextUtils.isEmpty(str2)) {
          this.jdField_a_of_type_JavaLangCharSequence = new bdnt((CharSequence)localObject3, 3, 16).a(str2 + "：", true, new int[0]);
        }
      }
      ...
      if (this.jdField_a_of_type_JavaLangCharSequence == null)
      {
        ...
        if (this.jdField_a_of_type_JavaUtilList.size() > 0)
        {
          this.jdField_a_of_type_Long = ((tty)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Long;
          this.jdField_b_of_type_JavaLangString = ((tty)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_b_of_type_JavaLangString;
          this.jdField_a_of_type_JavaLangCharSequence = ((tty)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaLangCharSequence;
          this.jdField_d_of_type_JavaLangString = ((tty)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_e_of_type_JavaLangString;
          if (this.jdField_a_of_type_JavaLangCharSequence == null)
          {
            this.jdField_a_of_type_JavaLangCharSequence = "";
            continue;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    RecentUser localRecentUser = (RecentUser)localaong.findRecentUser(anhk.aB, 7230);
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() == 0))
      {
      ...
      if (localRecentUser == null)
      {
        localRecentUser = new RecentUser(anhk.aB, 7230);
