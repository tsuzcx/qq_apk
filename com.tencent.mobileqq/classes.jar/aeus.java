...
public class aeus
  implements azjq
{
  public aeus(ProfileLabelEditorActivity paramProfileLabelEditorActivity) {}
  ...
  public void a(ProfileLabelInfo paramProfileLabelInfo, ToggleButton paramToggleButton, Boolean paramBoolean)
  {
    if (paramBoolean.booleanValue())
    {
      ...
      bcst.b(this.a.app, "CliOper", "", "", "card_mall", "0X80066C7", 0, 0, "1", "", "", "");
      this.a.jdField_a_of_type_JavaUtilList.add(paramProfileLabelInfo);
    }
    for (;;)
    {
      this.a.jdField_a_of_type_Azjr.c(paramProfileLabelInfo, paramToggleButton);
      this.a.a(this.a.jdField_a_of_type_JavaUtilList.size());
      if (this.a.jdField_a_of_type_Aeuw == null) {
        break;
      }
      this.a.jdField_a_of_type_Aeuw.notifyDataSetChanged();
      return;
