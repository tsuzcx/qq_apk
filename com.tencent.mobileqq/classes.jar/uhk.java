  ...
  implements uhc
{
  ...
  private bgve jdField_a_of_type_Bgve;
  ...
  public pbq a;
  private pxw jdField_a_of_type_Pxw;
  private ugz jdField_a_of_type_Ugz;
  private uhr jdField_a_of_type_Uhr;
  public zon a;
  private long jdField_b_of_type_Long = -1L;
  private String jdField_b_of_type_JavaLangString;
  private List<ude> jdField_b_of_type_JavaUtilList;
  private String c;
  
  public uhk(pxw parampxw, zon paramzon)
  {
    this.jdField_a_of_type_Pxw = parampxw;
    this.jdField_a_of_type_Bgve = parampxw.mRuntime;
    this.jdField_a_of_type_Zon = paramzon;
    this.jdField_a_of_type_AndroidAppActivity = a();
    this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = this.jdField_a_of_type_Bgve.a();
    parampxw = this.jdField_a_of_type_Bgve.a(this.jdField_a_of_type_Bgve.a());
    if ((parampxw != null) && ((parampxw instanceof bgzu))) {
      this.jdField_a_of_type_Bgzu = ((bgzu)parampxw);
    }
    parampxw = this.jdField_a_of_type_Bgve.a(this.jdField_a_of_type_Bgve.a());
    if ((parampxw != null) && ((parampxw instanceof bgzi))) {
      this.jdField_a_of_type_Bgzi = ((bgzi)parampxw);
    }
  }
  ...
  private List<Integer>[] a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList1.add(Integer.valueOf(((ude)((Iterator)localObject).next()).a));
    }
    ArrayList localArrayList2 = new ArrayList();
    localObject = this.jdField_b_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList2.add(Integer.valueOf(((ude)((Iterator)localObject).next()).a));
    }
    ...
    for (;;)
    {
      ...
      label152:
      localObject = this.jdField_a_of_type_Uhr.c;
      break;
      label163:
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_Long != -1L) {
      this.jdField_b_of_type_JavaUtilList.add(2, new ude("fav_move_group", 39, false));
    }
  }
  ...
  private void e()
  {
    String str1 = this.jdField_a_of_type_Uhr.a;
    String str2 = this.jdField_a_of_type_Uhr.jdField_b_of_type_JavaLangString;
    String str3 = this.jdField_a_of_type_Uhr.d;
    String str4 = this.jdField_a_of_type_Bgve.a().uin;
    String str5 = this.jdField_a_of_type_Uhr.f;
    bkov.a(0, str1, this.jdField_a_of_type_Uhr.c, str5, str2, str3, null, null, false, -1L).a("lCategory", 8L).c(str4).a(this.jdField_a_of_type_Bgve.a(), str4);
  }
  
  private void f()
  {
    Object localObject1 = Pattern.compile("(http|https)://.*.mp.qq.com.*").matcher(this.jdField_a_of_type_Uhr.c);
    int i = 0;
    ...
    try
    {
      localObject1 = URLEncoder.encode(this.jdField_a_of_type_Uhr.c, "UTF-8");
      str2 = this.jdField_a_of_type_Bgve.a().uin;
      if (i != 0)
      {
        ...
        str1 = this.jdField_a_of_type_Bgve.a().publicUin;
  ...
  Activity a()
  {
    for (Activity localActivity = this.jdField_a_of_type_Bgve.a(); (localActivity != null) && ((localActivity instanceof BasePluginActivity)); localActivity = ((BasePluginActivity)localActivity).getOutActivity()) {}
  ...
  {
    this.jdField_a_of_type_Bgve.a().getSettings().setTextZoom(bgww.a[paramInt]);
    this.jdField_a_of_type_Zon.a(paramInt);
  }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Ugz == null) {
      this.jdField_a_of_type_Ugz = new ugz(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bgve.a(), new uhp(this));
    }
    this.jdField_a_of_type_Ugz.a().setActionSheetTitle("biu出去让更多好友看到");
    this.jdField_a_of_type_Ugz.a().setCancelListener(new uhl(this));
    for (;;)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList = ugz.b();
          if (localJSONArray2 == null)
          {
            this.jdField_b_of_type_JavaUtilList = ugz.c();
            b();
            this.jdField_a_of_type_Uhr = new uhr(null);
            this.jdField_a_of_type_Uhr.c = paramString.optString("share_url");
            this.jdField_a_of_type_Uhr.jdField_b_of_type_JavaLangString = paramString.optString("desc");
            this.jdField_a_of_type_Uhr.a = paramString.optString("title");
            this.jdField_a_of_type_Uhr.d = paramString.optString("image_url");
            this.jdField_a_of_type_Uhr.e = paramString.optString("puin");
            this.jdField_a_of_type_Uhr.f = paramString.optString("nick_name");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Uhr.f)) {
              this.jdField_a_of_type_Uhr.f = paramString.optString("sourceName");
            }
            this.jdField_b_of_type_JavaLangString = paramString.optString("callback");
            int i = paramString.optInt("report_from");
            this.jdField_a_of_type_Ugz.a(a(), i);
          }
        }
        else
        {
          this.jdField_a_of_type_JavaUtilList = ugz.a(localJSONArray1, null);
          continue;
        }
        this.jdField_b_of_type_JavaUtilList = ugz.a(localJSONArray2, null);
      }
      catch (JSONException paramString)
      {
        paramString.printStackTrace();
  ...
  void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        paramString2 = this.jdField_a_of_type_Bgve.a();
  ...
  void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    paramString1.putLong("share_begin_time", bgww.jdField_b_of_type_Long);
    if (this.jdField_a_of_type_Bgzu != null)
    {
      paramString1.putString("struct_url", this.jdField_a_of_type_Bgzu.getCurrentUrl());
      paramString1.putBoolean("from_web", true);
    }
    if (this.jdField_a_of_type_Bgzi != null) {
      i = this.jdField_a_of_type_Bgzi.switchRequestCode(this.jdField_a_of_type_Pxw, (byte)2, true);
    }
    QZoneShareManager.jumpToQzoneShare(this.jdField_a_of_type_Bgve.a(), this.jdField_a_of_type_AndroidAppActivity, paramString1, null, i);
  }
  ...
  public void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131695880, new Object[] { paramString5 }));
      ...
      if (paramJSONObject.has("serviceID"))
      {
        ...
        if ((paramInt == 116) || (paramInt == 123)) {
          localIntent.putExtra("compatible_text", apse.a);
        }
      }
      ...
      paramJSONObject = this.jdField_a_of_type_Bgve.a();
      if (paramJSONObject != null)
      {
        c();
        localIntent.putExtra("struct_share_key_source_name", Long.toString(l));
        aadf.a(paramJSONObject, this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.getAccount(), l, 3000L, new uhm(this, localIntent));
      }
      return;
    ...
    for (;;)
    {
      ...
      {
        paramString2 = this.jdField_a_of_type_Bgve.a().getEntityManagerFactory(this.jdField_a_of_type_Bgve.a().getAccount()).createEntityManager();
      ...
      for (paramString2 = paramString5.name;; paramString2 = null)
      {
        ...
        for (;;)
        {
          if (paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131698803)))
          {
            boolean bool = paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131698803));
            if (bool)
            {
          ...
          for (;;)
          {
            localIntent.putExtra("stuctmsg_bytes", bchh.a(localIntent.getExtras()).getBytes());
            this.jdField_a_of_type_Pxw.startActivityForResult(localIntent, (byte)1);
            return;
            if (paramJSONObject.has("sourceName")) {
            ...
            {
              localIntent.putExtra("app_name", this.jdField_a_of_type_AndroidAppActivity.getString(2131695896));
            }
          }
          paramString2 = paramString3;
        }
