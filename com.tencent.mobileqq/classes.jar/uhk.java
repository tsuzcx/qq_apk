...
public class uhk
  extends alko
{
  public static final String a = ume.a("StorySvc.video_config_get");
  public static final String b = ume.a("StorySvc.video_config_set");
  public static final String c = ume.a("StorySvc.video_get_user_mask_list");
  public static final String d = ume.a("StorySvc.video_set_user_mask");
  public static final String e = ume.a("StorySvc.video_get_user_mask_states");
  public static final String f = ume.a("StorySvc.video_show_video_list");
  public static final String g = ume.a("StorySvc.get_official_recommend");
  public static final String h = ume.a("StorySvc.pgc_subscribe_operation");
  public static final String i = ume.a("StorySvc.pgc_person_page");
  public static final String j = ume.a("StorySvc.pgc_search_feedlist_get");
  public static final String k = ume.a("StorySvc.pgc_client_report");
  public static final String l = ume.a("StorySvc.video_aio_sync_publish");
  public static final String m = ume.a("StorySvc.get_video_reader_config");
  public static final String n = ume.a("StorySvc.msgtab_node_feedback");
  
  public uhk(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    wsv.b("QQStoryHandler", "handleGetForbidList");
    boolean bool2;
    int i1;
    Object localObject;
    if (paramObject != null)
      ...
      try
      {
        ...
        if (((qqstory_service.RspGetForbiddenList)localObject).result.error_code.get() == 0)
        {
          if (((qqstory_service.RspGetForbiddenList)localObject).is_end.get() != 0)
          {
            ...
            localQQStoryUserInfo.setNick(bdbt.m(this.app, localQQStoryUserInfo.uin));
            if (!bool2) {
              break label290;
            }
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      localuhl = (uhl)this.app.getManager(181);
    ...
    try
    {
      ...
      {
        paramFromServiceMsg = localuhl.a(str);
        ...
        if (paramToServiceMsg.size() > 0)
        {
          ...
          if (paramFromServiceMsg == null)
          {
            ...
            paramToServiceMsg.setNick(bdbt.m(this.app, str));
            localuhl.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, paramToServiceMsg);
            paramToServiceMsg.isAllowed = i2;
            paramToServiceMsg.isInterested = i1;
            if (paramToServiceMsg.getStatus() == 1000)
            {
              localuhl.jdField_a_of_type_Awbw.a(paramToServiceMsg);
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
        ...
        try
        {
          if ((paramObject.error_code.get() == 0) && (localRspGetInfoCard.user.has()))
          {
            ...
            else
            {
              ...
              uhl.c("QQStoryHandler handleGetPGCUserInfoCard user=" + null);
            }
            if (i2 != 0)
            {
              wta.b("story_check", "pgc_check", 0, 1, new String[] { i });
      ...
      break label35;
      wta.b("story_check", "pgc_check", 0, 0, new String[] { i });
      continue;
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((qqstory_pgc.RspGetSearchFeedList)localObject1).result_type.has())
          {
            ...
            i2 = 1;
            uhl.c("QQStoryHandler handleGetPGCSearchFeedList user=" + localObject2);
            continue;
            i4 = 0;
            break;
            l1 = System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("extra_start_time");
          ...
          wta.b("story_check", "pgc_check", 0, 1, new String[] { j });
      ...
      return;
      wta.b("story_check", "pgc_check", 0, 0, new String[] { j });
    }
  ...
  private void n(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   80: istore 4
    //   82: aload_3
    //   83: invokestatic 358	uhk:a	(Ljava/lang/Object;)Z
    //   86: ifeq +334 -> 420
    ...
    //   178: iconst_1
    //   179: aload 13
    //   181: invokevirtual 121	uhk:notifyUI	(IZLjava/lang/Object;)V
    //   184: iconst_1
    //   185: istore 6
    //   187: iload 6
    //   189: istore 5
    ...
    //   253: iconst_0
    //   254: aload 13
    //   256: invokevirtual 121	uhk:notifyUI	(IZLjava/lang/Object;)V
    //   259: iload 7
    //   261: ifne +15 -> 276
    //   264: aload_0
    //   265: getstatic 58	uhk:h	Ljava/lang/String;
    //   268: lload 9
    //   270: iload 4
    //   272: aload_1
    //   273: invokevirtual 429	uhk:a	(Ljava/lang/String;JILjava/lang/String;)V
    //   276: return
    //   277: aload_1
  ...
  public byte a(FromServiceMsg paramFromServiceMsg, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (4 <= i4)
        {
          localObject = String.valueOf(bdlr.a(paramFromServiceMsg, 0));
      ...
      catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
      {
        ...
        if (7 <= i4) {
          i2 = bdlr.a(paramFromServiceMsg, 5);
        }
        i1 = 7;
        i3 = 0;
      }
      if (i3 < i2)
      {
        ...
        int i5 = bdlr.a(paramFromServiceMsg, i1);
        int i6 = i1 + 2;
        i1 = bdlr.a(paramFromServiceMsg, i6);
        i6 += 2;
        byte b2 = b1;
        ...
        label373:
        for (b1 = 0;; b1 = (byte)bdlr.a(paramFromServiceMsg, i6))
        {
          b2 = b1;
          if (QLog.isColorLevel())
          {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      bdlr.a((byte[])localObject, 0, l1);
      localObject[4] = 0;
      bdlr.a((byte[])localObject, 5, (short)1);
      bdlr.a((byte[])localObject, 7, 42060);
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      bdlr.a((byte[])localObject, 0, l1);
      localObject[4] = 0;
      bdlr.a((byte[])localObject, 5, (short)2);
      bdlr.a((byte[])localObject, 7, 42060);
      bdlr.a((byte[])localObject, 9, (short)2);
      bdlr.a((byte[])localObject, 11, s);
      bdlr.a((byte[])localObject, 13, 40319);
      bdlr.a((byte[])localObject, 15, (short)2);
      bdlr.a((byte[])localObject, 17, (short)1);
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      ...
      localObject[4] = 0;
      bdlr.a((byte[])localObject, 5, (short)1);
      bdlr.a((byte[])localObject, 7, paramInt2);
      bdlr.a((byte[])localObject, 9, (short)2);
      bdlr.a((byte[])localObject, 11, s);
      localOIDBSSOPkg.bytes_bodybuffer.set(ByteStringMicro.copyFrom((byte[])localObject));
      localObject = createToServiceMsg("OidbSvc.0x4ff_9");
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      localObject[4] = 0;
      bdlr.a((byte[])localObject, 5, (short)1);
      bdlr.a((byte[])localObject, 7, paramInt);
      localObject = makeOIDBPkg("OidbSvc.0x480_9", 1152, 9, (byte[])localObject);
      ((ToServiceMsg)localObject).extraData.putBoolean(paramString, true);
      a((ToServiceMsg)localObject);
      return;
  ...
  public void a(StoryPushMsg paramStoryPushMsg)
  {
    ...
    vgv.a().a(this.app, 2, paramStoryPushMsg);
  }
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject, String paramString)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
    {
      ...
      wta.b("handleSetTlvRsp", paramString, 0, i1, new String[] { "" });
    }
  }
  ...
  public void a(String paramString1, long paramLong, int paramInt, String paramString2)
  {
    ...
    wta.b("story_net", paramString1, 0, paramInt, new String[] { paramString2, String.valueOf(paramLong), wta.a(null) });
  }
  ...
  {
    boolean bool = true;
    wsv.a("QQStoryHandler", "getForbidList, cookie:%s, count:%s, isNotAllowed:%s, tag:%s", paramArrayOfByte, Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean), paramString);
  ...
  public void b(FromServiceMsg paramFromServiceMsg)
  {
    ...
    ((urk)urr.a(10)).b("sp_key_user_enable_album_scan", Integer.valueOf(i1));
    if (QLog.isColorLevel()) {
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramToServiceMsg)
      {
          ...
          else
          {
            ...
            if ("pub_allow_stranger".equals(localObject3))
            {
              ...
              for (;;)
              {
                ...
                wsv.a("QQStoryHandler", "get default permission from server. type is %d.", Integer.valueOf(i3));
                i3 = i1;
                i1 = i2;
                i2 = i3;
                break;
            ...
            if ("mainpage_auto_reqdata_interval".equals(localObject3))
            {
              ...
              wsv.a("Q.qqstory.home.position", "set disable autorefresh time:%d", Long.valueOf(l1));
        ...
        {
          ((urk)urr.a(10)).b(System.currentTimeMillis());
          ...
          while (paramObject.hasNext())
          {
            ...
            wsv.b("Q.qqstory.protocol", "find specs in response " + ((qqstory_struct.PicSpecs)localObject2).pic_bid.get().toStringUtf8() + ", specs " + ((qqstory_struct.PicSpecs)localObject2).pic_spec.get());
            ...
            {
              wsv.d("QQStoryHandler", "Invalid json format in " + (String)localObject1 + ", " + localObject2);
            }
          }
          urk.j(paramFromServiceMsg.toString());
          wsv.b("Q.qqstory.protocol", "get thumbnail config formatted in json " + paramFromServiceMsg.toString());
        }
        while (paramToServiceMsg.video_source_tag_list.has())
        {
          ...
          for (;;)
          {
            if (paramFromServiceMsg.hasNext())
            {
              ...
              {
                wsv.d("QQStoryHandler", "Invalid json format, tagType: " + i1 + ", jumpUrl: " + paramObject + ", wording: " + (String)localObject1);
              }
              continue;
              wsv.b("Q.qqstory.protocol", "no thumbnail pic_specs_list found, check for day limitation");
              break;
            }
          }
          paramFromServiceMsg = (urk)urr.a(10);
          ...
          xok.a();
          wsv.a("QQStoryHandler", "video_source_tag_list format json : %s", paramToServiceMsg.toString());
        }
        i1 = i3;
      }
    }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      paramFromServiceMsg = (uhl)this.app.getManager(181);
    ...
    for (;;)
    {
      try
      {
        ...
        if (((qqstory_service.RspForbidStory)localObject).result.error_code.get() == 0)
        {
          ...
          paramToServiceMsg.setNick(bdbt.m(this.app, (String)localObject));
          ...
          if (bool2)
          {
            ...
            paramFromServiceMsg.jdField_a_of_type_Awbw.a(paramToServiceMsg);
            continue;
          }
        }
        else
  ...
  public void c(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      {
        label440:
        wsv.b("Q.qqstory.protocol", "decode json fail", paramArrayOfByte);
  ...
  public void d()
  {
    ...
    long l2 = ((urk)localObject).c();
    long l1 = ((urk)localObject).d();
    long l3 = TimeUnit.DAYS.toMillis(1L);
    wsv.b("Q.qqstory.protocol", "lastGetConfigTime " + l2 + ", " + System.currentTimeMillis());
  ...
  public void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   45: istore 4
    //   47: aload_3
    //   48: invokestatic 358	uhk:a	(Ljava/lang/Object;)Z
    //   51: ifeq +267 -> 318
    ...
    //   131: aload_1
    //   132: aastore
    //   133: invokevirtual 121	uhk:notifyUI	(IZLjava/lang/Object;)V
    //   136: iconst_1
    //   137: istore 6
    //   139: iload 6
    //   141: istore 5
    ...
    //   189: iconst_0
    //   190: aconst_null
    //   191: invokevirtual 121	uhk:notifyUI	(IZLjava/lang/Object;)V
    //   194: iload 7
    //   196: ifne +15 -> 211
    //   199: aload_0
    //   200: getstatic 70	uhk:k	Ljava/lang/String;
    //   203: lload 9
    //   205: iload 4
    //   207: aload_1
    //   208: invokevirtual 429	uhk:a	(Ljava/lang/String;JILjava/lang/String;)V
    //   211: return
    //   212: iconst_0
    //   213: istore 7
    //   215: goto -204 -> 11
  ...
  public void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = "local data";; paramToServiceMsg = paramFromServiceMsg.getBusinessFailMsg())
    {
      ...
      try
      {
        ...
        paramFromServiceMsg = paramToServiceMsg;
        i2 = i1;
        notifyUI(1017, true, new uhi(this.app, (qqstory_struct.VideoReaderConf)localRspVideoReaderConf.reader_conf.get()));
        paramFromServiceMsg = paramToServiceMsg;
        i2 = i1;
        if (QLog.isColorLevel())
        {
