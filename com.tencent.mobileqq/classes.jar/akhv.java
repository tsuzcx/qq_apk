...
public class akhv
{
  public static void a(akhp paramakhp, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((!paramFromServiceMsg.isSuccess()) || (paramObject == null))
    {
      ...
      paramakhp.notifyUI(121, false, new Object[] { null, null });
      return;
    }
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(".troop.troopManagerTroopHandler", 2, new Object[] { "handleTroopBulkSendMessageRespond, ", vyp.a(localRspSend1V1Msg) });
      }
      paramakhp.notifyUI(121, true, new Object[] { localRspSend1V1Msg, localReqSend1V1Msg });
      return;
    }
  ...
  public static void a(@NonNull akhp paramakhp, @NonNull homework.ReqSend1V1Msg paramReqSend1V1Msg)
  {
    if (QLog.isColorLevel()) {
      QLog.i(".troop.troopManagerTroopHandler", 2, "sendTroopBulkSendMessageRequest");
    }
    ToServiceMsg localToServiceMsg = paramakhp.createToServiceMsg("HwSvc.send_msg");
    localToServiceMsg.putWupBuffer(paramReqSend1V1Msg.toByteArray());
    paramakhp.a(localToServiceMsg);
  }
}
