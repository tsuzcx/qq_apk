...
public class akhv
  extends azip
{
  private akhv(ContactListView paramContactListView) {}
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      this.a.i();
      this.a.g();
      if (((i == 0) || (i == 7)) && ((this.a.jdField_a_of_type_Int != 2) || (!(this.a.jdField_a_of_type_Aupt instanceof ForwardShareCardOption))) && (this.a.b == 0)) {
        this.a.a(2131718057, 3000L);
      }
    }
    do
    {
