...
public class awrn
{
  ...
  private static volatile awrn jdField_a_of_type_Awrn;
  public static awru a;
  ...
  awrq jdField_a_of_type_Awrq = new awrq();
  ...
  private LinkedList<awrp> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private Stack<String> jdField_a_of_type_JavaUtilStack = new Stack();
  boolean jdField_a_of_type_Boolean = false;
  private awrs[] jdField_a_of_type_ArrayOfAwrs = { new awrs("com.tencent.mtt", "qqBrowser"), new awrs("com.tencent.android.qqdownloader", "qqMarket"), new awrs("com.tencent.qqgame", "qqGame"), new awrs("com.tencent.qqmusic", "qqMusic"), new awrs("com.tencent.news", "qqNews"), new awrs("com.qq.reader", "qqReader"), new awrs("com.tencent.qqlive", "qqVideo"), new awrs("com.tencent.wblog", "qqMicroblog"), new awrs("com.tencent.qqphonebook", "qqPhonebook") };
  private int jdField_b_of_type_Int;
  private StringBuilder jdField_b_of_type_JavaLangStringBuilder = new StringBuilder("Thread info:\n");
  private String jdField_d_of_type_JavaLangString;
  
  protected awrn(Context paramContext)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private awrn(Context paramContext, long paramLong)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  ...
  public static awrn a(Context paramContext)
  {
    return a(paramContext, 3000L);
  }
  
  public static awrn a(Context paramContext, long paramLong)
  {
    if (jdField_a_of_type_Awrn == null) {}
    for (;;)
    {
      try
      {
        ...
        {
          if (ajop.a()) {
            jdField_a_of_type_Awrn = new awrn(BaseApplicationImpl.getApplication(), paramLong);
          }
        }
        else if (jdField_a_of_type_Awrn == null) {}
      }
      finally {}
      try
      {
        if ((ajop.a()) && ((jdField_a_of_type_Awrn instanceof awrr))) {
          jdField_a_of_type_Awrn = new awrn(BaseApplicationImpl.getApplication(), paramLong);
        }
        return jdField_a_of_type_Awrn;
      }
      finally {}
      jdField_a_of_type_Awrn = new awrr(BaseApplicationImpl.getApplication());
    }
  }
  ...
  private static Map<String, String> a()
  {
    ...
    localHashMap.put("param_MODEL", babp.d());
    localHashMap.put("param_manu", babp.k());
    localHashMap.put("param_OS", babp.e());
    localHashMap.put("param_Resolution", MsfSdkUtils.getResolutionString(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_IMEI", babp.a());
    localHashMap.put("param_IMSI", babp.b());
    localHashMap.put("param_NetworkType", "" + badq.b(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_ProductVersion", "" + AppSetting.a());
    localHashMap.put("param_CPU", babp.g());
    localHashMap.put("param_totalmemory", MsfSdkUtils.getTotalMemory());
    localHashMap.put("param_availmemory", String.valueOf(babp.e() / 1024L) + "kB");
    long[] arrayOfLong = babp.a();
    ...
    localHashMap.put("param_Camera", "" + babp.c());
    return localHashMap;
  }
  ...
  {
    Object localObject1 = balj.a("android.app.ActivityThread", "currentActivityThread", new Object[0], new Class[0]);
    paramContext = paramContext.getPackageName();
    paramContext = (Map)balj.a("android.app.LoadedApk", ((WeakReference)((Map)balj.a("android.app.ActivityThread", localObject1, "mPackages")).get(paramContext)).get(), "mReceivers");
  ...
  void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Awrq.jdField_a_of_type_Boolean = ((JSONObject)localObject).getBoolean("control_switch");
      this.jdField_a_of_type_Awrq.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("control_level");
      this.jdField_a_of_type_Awrq.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("control_window");
      this.jdField_a_of_type_Awrq.c = ((JSONObject)localObject).getInt("control_freq");
      ...
      ((StringBuilder)localObject).append(",switch=").append(this.jdField_a_of_type_Awrq.jdField_a_of_type_Boolean);
      ((StringBuilder)localObject).append(",level=").append(this.jdField_a_of_type_Awrq.jdField_a_of_type_Int);
      ((StringBuilder)localObject).append(",window=").append(this.jdField_a_of_type_Awrq.jdField_b_of_type_Int);
      ((StringBuilder)localObject).append(",Freq=").append(this.jdField_a_of_type_Awrq.c);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      paramString1 = new awrp(System.currentTimeMillis(), paramString1, paramString2);
      ...
      for (this.jdField_b_of_type_Int = (paramString1.jdField_a_of_type_Int + i); (this.jdField_b_of_type_Int > 15360L) && (this.jdField_a_of_type_JavaUtilLinkedList.size() > 1); this.jdField_b_of_type_Int -= paramString1.jdField_a_of_type_Int) {
        paramString1 = (awrp)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      }
    }
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean1, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap, String paramString3, boolean paramBoolean2)
  {
    ...
    zqj.a(paramString2, paramHashMap);
  ...
  public void a(StringBuilder paramStringBuilder)
  {
    ...
    //   13: invokestatic 761	android/os/Process:myPid	()I
    ...
    //   50: aconst_null
    //   51: astore 5
    //   53: invokestatic 644	java/lang/System:currentTimeMillis	()J
    //   56: lstore_3
    //   57: aload 8
    //   59: astore 7
    //   61: aload 9
    //   63: astore 6
    //   65: new 707	java/io/File
    //   68: dup
    //   69: aload 11
    //   71: invokespecial 710	java/io/File:<init>	(Ljava/lang/String;)V
    //   74: invokevirtual 1039	java/io/File:list	()[Ljava/lang/String;
    //   77: astore 10
    //   79: aload 8
    //   81: astore 7
    //   83: aload 9
    ...
    //   90: dup
    //   91: invokespecial 943	java/util/HashMap:<init>	()V
    //   94: astore 8
    //   96: iconst_0
    //   97: istore_2
    //   98: aload 5
    ...
    //   159: invokespecial 710	java/io/File:<init>	(Ljava/lang/String;)V
    //   162: astore 9
    //   164: aload 5
    //   166: astore 7
    //   168: aload 5
    //   170: astore 6
    //   172: invokestatic 644	java/lang/System:currentTimeMillis	()J
    //   175: lload_3
    //   176: lsub
    //   177: ldc2_w 1044
    //   180: lcmp
    ...
    //   226: aastore
    //   227: invokestatic 539	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   230: aload 5
    //   232: astore 7
    //   234: aload 5
    //   236: astore 6
    //   238: aload 8
    //   240: invokevirtual 1050	java/util/HashMap:entrySet	()Ljava/util/Set;
    ...
    //   283: checkcast 1052	java/util/Map$Entry
    //   286: astore 9
    //   288: aload 5
    //   290: astore 7
    //   292: aload 5
    ...
    //   351: ldc_w 1066
    //   354: aload_1
    //   355: invokestatic 544	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   358: aload 7
    //   360: ifnull +8 -> 368
    //   363: aload 7
    //   365: invokevirtual 1071	java/io/BufferedReader:close	()V
    //   368: return
    //   369: aload 5
    //   371: astore 7
    //   373: aload 5
    //   375: astore 6
    //   377: aload 9
    //   379: invokevirtual 713	java/io/File:exists	()Z
    //   382: ifeq +364 -> 746
    //   385: aload 5
    //   387: astore 7
    //   389: aload 5
    //   391: astore 6
    //   393: new 1068	java/io/BufferedReader
    //   396: dup
    //   397: new 1073	java/io/FileReader
    //   400: dup
    //   401: aload 9
    //   403: invokespecial 1076	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   406: bipush 64
    //   408: invokespecial 1079	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   411: astore 5
    //   413: aload 5
    //   415: invokevirtual 1082	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   418: astore 6
    //   420: aload 6
    //   422: ifnull +327 -> 749
    //   425: aload 6
    //   427: ldc_w 1084
    //   430: invokevirtual 481	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   433: ifeq -20 -> 413
    //   436: aload 6
    //   438: ldc_w 461
    //   441: invokevirtual 509	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   444: iconst_1
    //   445: aaload
    //   446: invokevirtual 1087	java/lang/String:trim	()Ljava/lang/String;
    //   449: astore 6
    //   451: aload 8
    //   453: aload 6
    //   455: invokevirtual 952	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   458: ifeq +49 -> 507
    //   461: aload 8
    //   463: aload 6
    //   465: aload 8
    //   467: aload 6
    //   469: invokevirtual 953	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   472: checkcast 511	java/lang/Integer
    //   475: invokevirtual 517	java/lang/Integer:intValue	()I
    //   478: iconst_1
    //   479: iadd
    //   480: invokestatic 529	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   483: invokevirtual 648	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   486: pop
    //   487: aload 5
    //   489: ifnull +47 -> 536
    //   492: aload 5
    //   494: invokevirtual 1071	java/io/BufferedReader:close	()V
    //   497: aconst_null
    //   498: astore 5
    //   500: iload_2
    //   501: iconst_1
    ...
    //   509: aload 6
    //   511: iconst_1
    //   512: invokestatic 529	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   515: invokevirtual 648	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   518: pop
    //   519: goto -32 -> 487
    //   522: astore 6
    //   524: ldc_w 383
    ...
    //   528: ldc_w 1066
    //   531: aload 6
    //   533: invokestatic 544	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   536: goto -36 -> 500
    //   539: aload 5
    //   541: astore 7
    //   543: aload 5
    ...
    //   565: aload 5
    //   567: astore 6
    //   569: invokestatic 1094	com/tencent/mobileqq/app/ThreadLog:needRecordJob	()Z
    //   572: ifeq +36 -> 608
    //   575: aload 5
    //   577: astore 7
    //   579: aload 5
    ...
    //   598: astore 6
    //   600: aload_1
    //   601: invokestatic 1097	com/tencent/mobileqq/app/ThreadManager:reportCurrentState	()Ljava/lang/String;
    ...
    //   612: aload 5
    //   614: astore 6
    //   616: invokestatic 524	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   619: ifeq +52 -> 671
    //   622: aload 5
    //   624: astore 7
    //   626: aload 5
    ...
    //   644: dup
    //   645: iconst_1
    //   646: invokestatic 644	java/lang/System:currentTimeMillis	()J
    //   649: lload_3
    //   650: lsub
    //   651: invokestatic 1104	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   654: aastore
    //   655: dup
    //   656: iconst_2
    //   657: ldc_w 1106
    ...
    //   667: aastore
    //   668: invokestatic 539	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   671: aload 5
    //   673: ifnull -305 -> 368
    //   676: aload 5
    //   678: invokevirtual 1071	java/io/BufferedReader:close	()V
    //   681: return
    //   682: astore_1
    //   683: ldc_w 383
    //   686: iconst_2
    //   687: ldc_w 1066
    //   690: aload_1
    //   691: invokestatic 544	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   694: return
    //   695: astore_1
    //   696: ldc_w 383
    //   699: iconst_2
    //   700: ldc_w 1066
    //   703: aload_1
    //   704: invokestatic 544	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   707: return
    //   708: astore_1
    //   709: aload 6
    //   711: ifnull +8 -> 719
    //   714: aload 6
    //   716: invokevirtual 1071	java/io/BufferedReader:close	()V
    //   719: aload_1
    //   720: athrow
    //   721: astore 5
    //   723: ldc_w 383
    ...
    //   727: ldc_w 1066
    //   730: aload 5
    //   732: invokestatic 544	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   735: goto -16 -> 719
    //   738: astore_1
    //   739: aload 5
    //   741: astore 6
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    Object localObject = new NewIntent(paramAppRuntime.getApplication(), awdl.class);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramAppRuntime.getApplication(), awdl.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      paramString2 = new NewIntent(paramAppRuntime.getApplication(), awdl.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), awdl.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString, Map<String, Integer> paramMap)
  {
    ...
    paramMap = new NewIntent(paramAppRuntime.getApplication(), awdl.class);
  ...
  void b()
  {
    if (!this.jdField_a_of_type_Awrq.jdField_a_of_type_Boolean) {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Awrq.jdField_a_of_type_Int == 2) && ((TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).contains("QQBroadcastReceiver"))))
      {
    ...
    if ((l1 <= 0L) || (l2 <= l1) || (i < 0) || (l2 - l1 > this.jdField_a_of_type_Awrq.jdField_b_of_type_Int * 1000))
    {
      i = 1;
      l1 = l2;
    }
    for (;;)
    {
      if (i > this.jdField_a_of_type_Awrq.c) {
  ...
  void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      localSharedPreferences.edit().putLong("starttime", l1).putInt("crashcount", i).putBoolean("allowpreload", bool1).putInt("controlwindow", this.jdField_a_of_type_Awrq.jdField_b_of_type_Int).commit();
      return;
      i += 1;
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    CrashReport.initCrashReport(jdField_a_of_type_AndroidContentContext, new awro(this), null, bool, (CrashStrategyBean)localObject, 30000L);
    try
    {
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchInstallStatus", String.valueOf(yss.jdField_a_of_type_Int));
      if (!TextUtils.isEmpty(yss.jdField_a_of_type_JavaLangString)) {
        CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchNameInstalled", yss.jdField_a_of_type_JavaLangString);
      }
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Revision", AppSetting.g());
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Version.buildNum", "8.2.6.4370");
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "topActivity", ajox.a());
