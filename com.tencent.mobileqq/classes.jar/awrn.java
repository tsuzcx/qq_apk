...
public class awrn
{
  ...
  public CharSequence a(aowp paramaowp)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    Object localObject = paramaowp.a().jdField_a_of_type_JavaUtilArrayList;
    localSpannableStringBuilder.append(paramaowp.a().jdField_a_of_type_JavaLangString);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((aowr)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        ...
        paramaowp = ((aowr)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString;
        localObject = new ForegroundColorSpan(Color.parseColor("#4D94FF"));
        localSpannableStringBuilder.append(paramaowp);
        localSpannableStringBuilder.setSpan(localObject, j, paramaowp.length() + j, 33);
      }
    }
  ...
  {
    long l = aoks.a().a(529, paramQQAppInterface.getCurrentAccountUin());
  ...
  {
    boolean bool = false;
    if (aoks.a().a(529, paramQQAppInterface.getCurrentAccountUin()) > paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).getLong("recommend_topic_version", -1L)) {
      bool = true;
    }
    return bool;
  }
