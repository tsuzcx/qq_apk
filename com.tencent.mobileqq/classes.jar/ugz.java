  ...
  implements Handler.Callback, ShareActionSheet.OnItemClickListener
{
  ...
  private final bjtg jdField_a_of_type_Bjtg;
  @NotNull
  private ShareActionSheet jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet;
  private slb jdField_a_of_type_Slb;
  private ueb jdField_a_of_type_Ueb;
  @Nullable
  private uha jdField_a_of_type_Uha;
  private uhc jdField_a_of_type_Uhc;
  private final uij jdField_a_of_type_Uij;
  private int b;
  
  static
  {
    jdField_a_of_type_Uhb = new uhb(null);
  }
  
  public ugz(@NotNull Activity paramActivity, @NotNull AppInterface paramAppInterface, @Nullable uha paramuha)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Uha = paramuha;
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Bjtg = ((bjtg)new uhg(this));
    ...
    this.jdField_a_of_type_Uij = new uij(paramAppInterface);
    this.jdField_a_of_type_Bjng = new bjng((Handler.Callback)this);
  }
  ...
  {
    return jdField_a_of_type_Uhb.a();
  }
  
  @JvmStatic
  @NotNull
  public static final List<ude> a(@NotNull JSONArray paramJSONArray, @Nullable JSONObject paramJSONObject)
  {
    return jdField_a_of_type_Uhb.a(paramJSONArray, paramJSONObject);
  }
  ...
  {
    return jdField_a_of_type_Uhb.b();
  }
  ...
  {
    return jdField_a_of_type_Uhb.c();
  }
  ...
  @Nullable
  public final ude a(@NotNull List<? extends ude> paramList1, @NotNull List<? extends ude> paramList2, int paramInt)
  {
    ...
    {
      ude localude = (ude)((Iterator)localObject).next();
      if (localude.jdField_a_of_type_Int == paramInt) {
        return localude;
      }
    }
    ...
    {
      localObject = (ude)paramList2.next();
      if (((ude)localObject).jdField_a_of_type_Int == paramInt) {
        return localObject;
      }
    }
    if ((paramInt == 72) || (paramInt == 73))
    {
      ...
      {
        paramList2 = (ude)paramList1.next();
  ...
  public final void a(@NotNull String paramString)
  {
    ...
    if (this.jdField_a_of_type_Ueb == null) {
      this.jdField_a_of_type_Ueb = new ueb(this.jdField_a_of_type_AndroidAppActivity, (uec)new uhf());
    }
    ueb localueb = this.jdField_a_of_type_Ueb;
    if (localueb != null) {
      localueb.a(paramString);
    }
  }
  
  public final void a(@NotNull uhc paramuhc)
  {
    Intrinsics.checkParameterIsNotNull(paramuhc, "listener");
    a(paramuhc, false);
  }
  
  public final void a(@NotNull uhc paramuhc, boolean paramBoolean)
  {
    Intrinsics.checkParameterIsNotNull(paramuhc, "listener");
    this.jdField_a_of_type_Uhc = paramuhc;
    if (this.jdField_a_of_type_Int == -1)
    {
      paramuhc = bkwm.a("readinjoy_font_size_index_sp" + pay.a(), Integer.valueOf(2));
      Intrinsics.checkExpressionValueIsNotNull(paramuhc, "ReadInJoyHelper.getReadI…JoyUtils.getAccount(), 2)");
      this.jdField_a_of_type_Int = ((Number)paramuhc).intValue();
    }
    paramuhc = new sld(this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater()).a(this.jdField_a_of_type_Bjtg).a(this.jdField_a_of_type_Int).a(paramBoolean).a();
    ...
    this.jdField_a_of_type_Slb = paramuhc.a(localWindow.getDecorView());
  }
  
  public final boolean a()
  {
    slb localslb = this.jdField_a_of_type_Slb;
    if ((localslb != null) && (localslb.a()))
    {
      localslb.b();
      return true;
    }
  ...
  public final void b()
  {
    Object localObject = this.jdField_a_of_type_Uij;
    if (localObject != null) {
      ((uij)localObject).a();
    }
    localObject = this.jdField_a_of_type_Slb;
    if (localObject != null) {
      ((slb)localObject).a();
    }
  ...
  public final void b(@NotNull String paramString)
  {
    ...
    paramString.putExtra("big_brother_source_key", pay.f(0));
    try
    {
      this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
      return;
  ...
  public final void c()
  {
    ...
    {
      Bitmap localBitmap2 = sxa.a(this.jdField_a_of_type_AndroidAppActivity.getWindow(), localBitmap1);
      if (localBitmap2 != null)
      {
        QQToast localQQToast = QQToast.a((Context)BaseApplicationImpl.getContext(), 0, 2131694798, 0);
        BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
        Intrinsics.checkExpressionValueIsNotNull(localBaseApplication, "BaseApplicationImpl.getContext()");
        localQQToast.b(localBaseApplication.getResources().getDimensionPixelSize(2131299076));
  ...
  public final void d(@NotNull String paramString)
  {
    ...
    if (localObject != null)
    {
      paramString = Long.valueOf(((uij)localObject).a(paramString));
      localObject = uhd.a;
      if (paramString != null) {
        break label46;
      }
  ...
  public void onItemClick(@NotNull ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem, @NotNull ShareActionSheet paramShareActionSheet)
  {
    ...
    paramShareActionSheet = this.jdField_a_of_type_Uha;
