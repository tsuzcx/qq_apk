  ...
  implements GLGestureListener
{
  ...
  public avss(ViewStub paramViewStub)
  {
  ...
  public avss(CameraFocusView paramCameraFocusView)
  {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      a();
      if (((localGLSurfaceView instanceof CameraCaptureView)) && (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView != null))
      {
      ...
      if ((!(localGLSurfaceView instanceof AECameraGLSurfaceView)) || (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView == null) || (((AECameraGLSurfaceView)localGLSurfaceView).b() == 1)) {
        break;
      }
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView.a(paramMotionEvent);
    ...
    a();
    if (((localGLSurfaceView instanceof CameraCaptureView)) && (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView != null) && (((CameraCaptureView)localGLSurfaceView).a() != 1))
    {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView.a(paramMotionEvent);
      a((CameraCaptureView)localGLSurfaceView, paramMotionEvent.getX(), paramMotionEvent.getY());
      if (QLog.isColorLevel()) {
