...
public final class asst
{
  @JvmStatic
  @NotNull
  public final asss a(@NotNull QQAppInterface paramQQAppInterface)
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    paramQQAppInterface = paramQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
    ...
    paramQQAppInterface = ((aslo)paramQQAppInterface).a();
