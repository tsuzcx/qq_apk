  ...
  implements assv
{
  ...
  public asst(Intent paramIntent, String paramString, astn paramastn)
  {
  ...
  private String a(faceproto.Request paramRequest, String paramString)
  {
    ...
    //   3: dup
    //   4: getstatic 52	asst:j	Ljava/lang/String;
    //   7: new 24	java/lang/StringBuilder
    //   10: dup
    //   11: invokespecial 27	java/lang/StringBuilder:<init>	()V
    //   14: invokestatic 253	java/lang/System:currentTimeMillis	()J
    //   17: invokevirtual 256	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   20: ldc 120
    ...
    //   28: invokespecial 258	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   31: astore 5
    //   33: new 247	java/io/File
    //   36: dup
    //   37: getstatic 52	asst:j	Ljava/lang/String;
    //   40: invokespecial 260	java/io/File:<init>	(Ljava/lang/String;)V
    //   43: astore_3
    //   44: aload_3
    //   45: invokevirtual 264	java/io/File:exists	()Z
    //   48: ifne +129 -> 177
    //   51: aload_3
    //   52: invokevirtual 267	java/io/File:mkdirs	()Z
    //   55: pop
    //   56: new 269	java/io/BufferedOutputStream
    //   59: dup
    //   60: new 271	java/io/FileOutputStream
    //   63: dup
    //   64: aload 5
    //   66: invokespecial 274	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   69: invokespecial 277	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   72: astore 4
    //   74: aload 4
    //   76: astore_3
    //   77: aload 4
    //   79: bipush 40
    //   81: invokevirtual 280	java/io/BufferedOutputStream:write	(I)V
    //   84: aload 4
    //   86: astore_3
    //   87: aload_1
    //   88: invokevirtual 283	face/qqlogin/faceproto$Request:toByteArray	()[B
    //   91: astore_1
    //   92: aload 4
    //   94: astore_3
    //   95: aload 4
    //   97: aload_1
    //   98: arraylength
    //   99: invokestatic 288	bdal:a	(I)[B
    //   102: invokevirtual 291	java/io/BufferedOutputStream:write	([B)V
    //   105: aload 4
    //   107: astore_3
    //   108: aload 4
    //   110: aload_2
    //   111: ldc_w 293
    //   114: invokevirtual 296	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   117: arraylength
    //   118: invokestatic 288	bdal:a	(I)[B
    //   121: invokevirtual 291	java/io/BufferedOutputStream:write	([B)V
    //   124: aload 4
    //   126: astore_3
    //   127: aload 4
    //   129: aload_1
    //   130: invokevirtual 291	java/io/BufferedOutputStream:write	([B)V
    //   133: aload 4
    //   135: astore_3
    //   136: aload 4
    //   138: aload_2
    //   139: ldc_w 293
    //   142: invokevirtual 296	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   145: invokevirtual 291	java/io/BufferedOutputStream:write	([B)V
    //   148: aload 4
    //   150: astore_3
    //   151: aload 4
    //   153: bipush 41
    //   155: invokevirtual 280	java/io/BufferedOutputStream:write	(I)V
    //   158: aload 4
    //   160: astore_3
    //   161: aload 4
    //   163: invokevirtual 299	java/io/BufferedOutputStream:flush	()V
    //   166: aload 4
    //   168: invokestatic 302	bdal:a	(Ljava/io/Closeable;)V
    //   171: aload 5
    //   173: invokevirtual 305	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   176: areturn
    //   177: aload_3
    //   178: invokevirtual 308	java/io/File:delete	()Z
    //   181: pop
    //   182: aload_3
    //   183: invokevirtual 267	java/io/File:mkdirs	()Z
    //   186: pop
    //   187: goto -131 -> 56
    //   190: astore_1
    //   191: aconst_null
    ...
    //   206: invokestatic 315	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   209: aload 4
    //   211: invokestatic 302	bdal:a	(Ljava/io/Closeable;)V
    //   214: aconst_null
    //   215: areturn
    //   216: astore_1
    //   217: aconst_null
    ...
    //   232: invokestatic 315	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   235: aload 4
    //   237: invokestatic 302	bdal:a	(Ljava/io/Closeable;)V
    //   240: aconst_null
    //   241: areturn
    //   242: astore_1
    //   243: aconst_null
    //   244: astore_3
    //   245: aload_3
    //   246: invokestatic 302	bdal:a	(Ljava/io/Closeable;)V
    //   249: aload_1
    //   250: athrow
    //   251: astore_1
    //   252: goto -7 -> 245
  ...
  public void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Astn.a(2, a(211, alpo.a(2131706413), false));
      return;
    }
    this.jdField_a_of_type_Long = System.currentTimeMillis();
    byte[] arrayOfByte = MD5.getFileMd5((String)localObject);
    long l = bdcs.a((String)localObject) / 1024L;
    Bundle localBundle = new Bundle();
    ...
    QIPCClientHelper.getInstance().callServer("IdentificationIpcServer_Model", "action_upload", localBundle, new assu(this, l));
    return;
    label237:
    this.jdField_a_of_type_Astn.a(2, null);
  }
}
