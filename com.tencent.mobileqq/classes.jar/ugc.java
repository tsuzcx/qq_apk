  ...
  implements View.OnClickListener
{
  ...
  private List<uer> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public ugc(Activity paramActivity, View paramView, int paramInt1, int paramInt2, ugi paramugi)
  {
    super(paramView);
    ...
    this.jdField_a_of_type_Ugi = paramugi;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_Apgg = new apgg(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130845869);
    ...
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364057));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364058));
    this.g = ((TextView)paramView.findViewById(2131364059));
    ...
    this.jdField_a_of_type_AndroidOsHandler = new ugg(this, Looper.getMainLooper());
    paramActivity = (uef)urr.a(30);
  ...
  private int a()
  {
    ...
    if (this.jdField_a_of_type_Ueq != null) {
      i = this.jdField_a_of_type_Ueq.e;
    }
    return i;
  }
  
  private int a(List<uer> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      i = j;
      if (new File(((uer)paramList.get(j)).jdField_a_of_type_JavaLangString).exists()) {
        break;
      }
      j += 1;
    }
  ...
  private Drawable a(String paramString)
  {
    ...
    //   64: ldc_w 298
    //   67: aload_3
    //   68: invokestatic 303	wsv:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   71: aload_2
    //   72: ifnull +49 -> 121
    //   75: aload_2
  ...
  private URLDrawable a(String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean, ugc paramugc)
  {
    QQLiveDrawable.QQLiveDrawableParams localQQLiveDrawableParams = new QQLiveDrawable.QQLiveDrawableParams();
    paramugc = new ugj(paramugc);
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = this.jdField_a_of_type_Apgg;
    if (!paramBoolean) {
    ...
    {
      localQQLiveDrawableParams.mListener = paramugc;
      localQQLiveDrawableParams.mDownloadListener = paramugc;
      paramString2 = URLDrawable.URLDrawableOptions.obtain();
      paramString2.mExtraInfo = localQQLiveDrawableParams;
      paramString2.mFailedDrawable = this.jdField_a_of_type_Apgg;
      paramString2.mLoadingDrawable = this.jdField_a_of_type_Apgg;
  ...
  {
    if (this.jdField_a_of_type_Ueq != null) {
      this.jdField_a_of_type_Ueq.e = paramInt;
    }
  }
  ...
  {
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg :%s", new Object[] { this.jdField_a_of_type_Ueq });
    this.jdField_c_of_type_Int = 3;
    if (paramList.size() == 0)
    {
      wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , no pic list");
      return;
    }
    ...
    {
      wsv.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , %s", paramList);
      return;
    }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Ueq.a() == 0) {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetLinearLayout.getVisibility() == 0) && (this.jdField_b_of_type_AndroidWidgetLinearLayout.getAnimation() == null))
    {
      ...
      localAlphaAnimation.setAnimationListener(new ugd(this));
    ...
    if (i < 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Ueq.jdField_b_of_type_JavaLangString);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Ueq.a(((List)localObject).size()))) {
        break label364;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(alpo.a(2131700539), new Object[] { this.jdField_a_of_type_Ueq.jdField_b_of_type_JavaLangString, Integer.valueOf(((List)localObject).size()) }));
    }
    for (;;)
    {
      this.f.setText(String.valueOf(this.jdField_a_of_type_Ueq.b()));
      this.e.setText(this.jdField_a_of_type_Ueq.a());
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView.setLocalDrawable(((uer)((List)localObject).get(i)).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      break;
      label364:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Ueq.a(((List)localObject).size()));
    }
  }
  ...
  private void e()
  {
    ...
    a(localHashSet);
    vhj.a(this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView, null, this.jdField_b_of_type_JavaLangString, false, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700545));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131700547));
  }
  ...
  private void f()
  {
    ...
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845871);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845869);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700554));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131700537));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131700555));
    this.g.setText(alpo.a(2131700532));
  }
  ...
  private void g()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845874);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845869);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700548));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131700552));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131700558));
    this.g.setText(alpo.a(2131700530));
  }
  ...
  private void h()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845870);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845869);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700556));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131700557));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131700553));
    this.g.setText(alpo.a(2131700533));
  }
  ...
  private void i()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845872);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845869);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700543));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131700538));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131700549));
    this.g.setText(alpo.a(2131700551));
  }
  
  private void j()
  {
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop :%s", new Object[] { this.jdField_a_of_type_Ueq });
    if ((this.jdField_a_of_type_Ueq == null) || (this.jdField_a_of_type_Ueq.a()))
    {
      wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,album not exist");
      this.jdField_c_of_type_Int = 0;
      return;
    }
    ...
    {
      wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,get pick count not enough ,size = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
      this.jdField_c_of_type_Int = 0;
      return;
    }
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop success ,get pick count = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
  }
  
  private void k()
  {
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayLoop");
    this.jdField_c_of_type_Int = 0;
    ...
    if (this.jdField_a_of_type_Ueq != null)
    {
      localObject = this.jdField_a_of_type_Ueq.a();
      if (((List)localObject).size() <= 0) {
        break label111;
      }
    }
    label111:
    for (Object localObject = ((uer)((List)localObject).get(0)).jdField_a_of_type_JavaLangString;; localObject = "")
    {
  ...
  private void l()
  {
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayMp4 :%s", new Object[] { this.jdField_a_of_type_Ueq });
    ...
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_Apgg;
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_Apgg;
  ...
  private void m()
  {
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4");
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_ComTencentImageURLDrawable != null)
    {
      if ((this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable() instanceof QQLiveDrawable))
      {
        ...
        wsv.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4 suc");
      }
  ...
  private void o()
  {
    wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayCenterImg");
    this.jdField_c_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Ueq != null) {
      a(this.jdField_a_of_type_Ueq);
    }
  }
  
  public void a(@NonNull ueq paramueq)
  {
    if ((this.jdField_a_of_type_Ueq != null) && (!this.jdField_a_of_type_Ueq.equals(paramueq)) && (this.jdField_c_of_type_Int != 0)) {
      c();
    }
    this.jdField_a_of_type_Ueq = paramueq;
    Object localObject = this.jdField_a_of_type_Ueq.a();
    paramueq = new ArrayList();
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      uer localuer = (uer)((Iterator)localObject).next();
      if (localuer.a()) {
        paramueq.add(localuer);
      }
    }
    this.jdField_a_of_type_JavaUtilList = paramueq;
    if (this.jdField_c_of_type_Int == 0)
    {
      if (!this.jdField_a_of_type_Ueq.a()) {
        break label185;
      }
      if (this.jdField_a_of_type_Ueq.jdField_d_of_type_Int == 1) {
        e();
      }
    }
    else
    ...
    if (this.jdField_a_of_type_Ueq.jdField_d_of_type_Int == 3)
    {
      f();
      return;
    }
    if (this.jdField_a_of_type_Ueq.jdField_d_of_type_Int == 2)
    {
      g();
      return;
    }
    if (this.jdField_a_of_type_Ueq.jdField_d_of_type_Int == 5)
    {
      i();
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Ueq == null) {
      wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , startPlay error!");
    }
    do
    {
      do
    ...
    } while (this.jdField_a_of_type_Ueq.jdField_d_of_type_Int != 2);
    a(ueb.a().a(ueb.jdField_a_of_type_Int));
    return;
    j();
  }
  ...
  {
    if (this.jdField_a_of_type_Ueq == null) {
      wsv.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , stopPlay error!");
    }
    while (this.jdField_c_of_type_Int == 0) {
      return;
    }
    wsv.a("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stop play :%s", this.jdField_a_of_type_Ueq);
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_Ueq.a()) {
      if (this.jdField_a_of_type_Ueq.jdField_d_of_type_Int == 1) {
        m();
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i < 3)
      {
        ...
        paramView = new uge(this);
        paramView = bdcd.a(this.jdField_a_of_type_AndroidAppActivity, 230, 2131558943, alpo.a(2131700534), null, alpo.a(2131700541), alpo.a(2131700544), paramView, paramView);
      ...
      for (;;)
      {
        wta.a("video_shoot_slides", "delete_smartalbum", 0, 0, new String[] { String.valueOf(this.jdField_a_of_type_Ueq.d()), "1" });
        return;
        if (this.jdField_a_of_type_Ugi != null) {
          this.jdField_a_of_type_Ugi.b(this.jdField_a_of_type_Ueq);
        }
      }
    } while (xod.b());
    blwf.a(this.jdField_a_of_type_AndroidViewView, 300L, new ugf(this), new float[] { 1.0F, 0.95F, 1.0F });
  }
}
