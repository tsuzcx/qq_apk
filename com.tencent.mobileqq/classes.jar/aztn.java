  ...
  extends azqk
{
  ...
  private void a(Context paramContext, Resources paramResources, RelativeLayout paramRelativeLayout, View paramView, LinearLayout paramLinearLayout, TextView paramTextView1, TextView paramTextView2)
  {
    ...
    paramResources.setId(2131376808);
    paramView = new ImageView(paramContext);
    paramView.setImageResource(2130849791);
    ...
    paramTextView2.setId(2131376809);
    ...
    paramResources.addRule(3, 2131376808);
    ...
    paramResources.setId(2131376810);
    paramResources.setImageResource(2130849793);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(14);
    paramView.addRule(3, 2131376809);
    paramRelativeLayout.addView(paramResources, paramView);
    paramResources = new RelativeLayout(paramContext);
    paramView = new ImageView(paramContext);
    paramView.setId(2131376812);
    paramView.setImageResource(2130849794);
    ...
    paramContext.setImageResource(2130849790);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(15);
    paramView.addRule(0, 2131376812);
    ...
    paramContext.addRule(1, 2131376812);
    ...
    paramContext.addRule(3, 2131376810);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localRelativeLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, aekt.a(290.0F, localResources)));
      ...
      if ((!"type".equals(localObject5)) || (!(paramView instanceof azvl))) {
        break label264;
      }
      j = ((azvl)paramView).k;
      i = j;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          if (("head".equals(localObject5)) && ((paramView instanceof azsf)) && (localObject2 == null))
          {
            ((azsf)paramView).k = i;
            ...
            continue;
            label531:
            paramView = new azur(paramContext.getString(2131720228)).a(paramContext, null, null);
            paramBundle = new LinearLayout.LayoutParams(-1, -2);
            j = aekt.a(15.0F, localResources);
            paramView.setLayoutParams(paramBundle);
            paramView.setPadding(j, j, j, j);
            paramBundle = (TextView)paramView.findViewById(2131377081);
            ...
            paramBundle.setImageResource(2130849784);
            ...
            ((RelativeLayout.LayoutParams)localObject4).rightMargin = aekt.a(7.0F, localResources);
            paramView.addView(paramBundle, (ViewGroup.LayoutParams)localObject4);
            paramContext = new ImageView(paramContext);
            paramContext.setImageResource(2130849785);
            paramBundle = new RelativeLayout.LayoutParams(-2, -2);
            paramBundle.addRule(1, localObject1.getId());
            paramBundle.addRule(15);
            paramBundle.leftMargin = aekt.a(7.0F, localResources);
            paramView.addView(paramContext, paramBundle);
            paramContext = new RelativeLayout.LayoutParams(-1, -2);
            paramContext.topMargin = aekt.a(5.0F, localResources);
            paramContext.addRule(3, 2131376811);
            paramView.setLayoutParams(paramContext);
            paramView.setId(2131376809);
            localRelativeLayout.addView(paramView);
            paramContext = new RelativeLayout.LayoutParams(-2, -2);
            paramContext.addRule(14);
            paramContext.addRule(3, 2131376809);
            paramContext.topMargin = aekt.a(10.0F, localResources);
            if (localObject2 != null)
            {
              localObject2.setId(2131376808);
