...
public class bhum
  extends bhsh
{
  private bhul jdField_a_of_type_Bhul = new bhul();
  private String jdField_a_of_type_JavaLangString = "";
  private bhul jdField_b_of_type_Bhul = new bhul();
  ...
  private String a()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      Object localObject = bhcq.jdField_a_of_type_JavaLangString;
  ...
  private void a(String... paramVarArgs)
  {
    if (this.jdField_a_of_type_Bhul != null) {
      this.jdField_a_of_type_Bhul.b();
    }
  }
  
  private void b(String... paramVarArgs)
  {
    if (this.jdField_b_of_type_Bhul != null) {
      this.jdField_b_of_type_Bhul.b();
    }
  }
  ...
  private void c(String... paramVarArgs)
  {
    try
    {
      paramVarArgs = bdik.d(new JSONObject(paramVarArgs[0]).optString("url"));
      paramVarArgs = a() + paramVarArgs + ".mp3";
      QLog.d("QzoneSoundPlugin", 2, "playLocalSound : " + paramVarArgs);
      if (new File(paramVarArgs).exists())
      {
        this.jdField_b_of_type_Bhul.a(paramVarArgs);
        this.jdField_b_of_type_Bhul.a();
      }
      return;
    }
  ...
  private void d(String... paramVarArgs)
  {
    try
    {
      ...
      if (new File(paramVarArgs).exists())
      {
        this.jdField_a_of_type_Bhul.a(paramVarArgs);
        this.jdField_a_of_type_Bhul.a();
      }
      return;
    }
    catch (Exception paramVarArgs) {}
  ...
  private void e(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        localObject2 = bdik.d(((JSONObject)localObject2).optString("url"));
        ...
        {
          DownloaderFactory.getInstance(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a()).getCommonDownloader().download((String)localObject1, this.jdField_b_of_type_JavaLangString, new bhun(this, paramVarArgs));
          return;
        }
        if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    {
      this.jdField_b_of_type_Bhul.a();
      this.jdField_b_of_type_Bhul = null;
    }
  }
