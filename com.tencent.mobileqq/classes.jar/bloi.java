...
public class bloi
{
  ...
  private bloy jdField_a_of_type_Bloy = new blok(this);
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bloj(this);
  private String jdField_a_of_type_JavaLangString = "#FDFDFD";
  private ArrayList<blox> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<blox> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bloi(Activity paramActivity)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      blpu.e("ReaderTabConfigDataHelper", " url=" + (String)localObject);
      return localObject;
    }
  }
  ...
  private void a(ArrayList<blox> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      this.jdField_c_of_type_ArrayOfJavaLangString[i] = localblox.jdField_c_of_type_JavaLangString;
      int k = localblox.jdField_a_of_type_Int;
  ...
  private boolean a(ArrayList<blox> paramArrayList1, ArrayList<blox> paramArrayList2)
  {
    ...
    if (paramArrayList1.size() == paramArrayList2.size())
    {
      ...
      while (i < j)
      {
        if (!((blox)paramArrayList1.get(i)).equals(paramArrayList2.get(i))) {
          return false;
        }
        i += 1;
      }
  ...
  private boolean a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject1 = new blox(((JSONObject)localObject1).optInt("tabID", -1), ((JSONObject)localObject1).optString("tabName"), ((JSONObject)localObject1).optString("n_tabIcon"), ((JSONObject)localObject1).optString("h_tabIcon"), localArrayList, k);
      if (k != 0) {
        break label397;
      }
    ...
    {
      blps.d(paramJSONObject, paramBoolean);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      return;
      blpu.d("ReaderTabConfigDataHelper", "tab url from local");
      a(4);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      blox localblox = new blox();
      localblox.jdField_a_of_type_Int = 100;
      localblox.jdField_a_of_type_JavaLangString = "书城";
      localblox.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_ELPT79nUxC.png";
      localblox.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_AXwBTwpLm8.png";
      ...
      localblox.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localblox);
      localblox = new blox();
      localblox.jdField_a_of_type_Int = 101;
      localblox.jdField_a_of_type_JavaLangString = "分类";
      localblox.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_u3wddLskp6.png";
      localblox.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_xYKQeprMCg.png";
      localArrayList = new ArrayList(1);
      localArrayList.add(a("https://cdn.vip.qq.com/club/client/read/6/rel/category_index.html?configfrom=local&_bid=2036"));
      localblox.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localblox);
      localblox = new blox();
      localblox.jdField_a_of_type_Int = 102;
      localblox.jdField_a_of_type_JavaLangString = "书架";
      localblox.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_G6VUELHdgC.png";
      localblox.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_f9xtLKYkBV.png";
      localArrayList = new ArrayList(2);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(localblox);
      localblox = new blox();
      localblox.jdField_a_of_type_Int = 104;
      localblox.jdField_a_of_type_JavaLangString = "我的";
      localblox.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190604150617_XAeQPgB9Z8.png";
      localblox.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_wdBlMCyKuS.png";
      localArrayList = new ArrayList(1);
  ...
  private void f()
  {
    ...
    {
      blpu.a("ReaderTabConfigDataHelper", "getTabConfigDataFromDB," + localJSONException.getMessage());
    }
  }
  ...
  public String d()
  {
    ...
    return "&height=" + (bggq.b(this.jdField_a_of_type_AndroidContentContext, i) + 50);
  }
}
