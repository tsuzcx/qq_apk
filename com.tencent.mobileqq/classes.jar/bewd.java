...
public class bewd
  ...
  implements View.OnClickListener, bipu, EmoticonCallback
{
  protected int a;
  protected long a;
  protected Handler a;
  ...
  public bewd(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a()
  {
    ...
    if (!android.text.TextUtils.isEmpty(str)) {
      bgip.c.put(this.jdField_a_of_type_JavaLangString, str);
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    paramActivity = LayoutInflater.from(paramActivity).inflate(2131559959, null);
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    //   14: putfield 189	bewd:c	Ljava/lang/String;
    ...
    //   57: putfield 198	bewd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: aload_0
    //   61: aload_0
    //   62: getfield 198	bewd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   65: ldc 200
    //   67: invokevirtual 203	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   70: putfield 72	bewd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 198	bewd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   78: ldc 205
    //   80: invokevirtual 209	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   83: putfield 211	bewd:jdField_a_of_type_Int	I
    //   86: aload_0
    //   87: aload_0
    //   88: getfield 198	bewd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   91: ldc 213
    //   93: invokevirtual 209	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   96: putfield 215	bewd:jdField_b_of_type_Int	I
    //   99: aload_0
    //   100: aload_0
    //   101: getfield 198	bewd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   104: ldc 217
    //   106: invokevirtual 203	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   109: putfield 219	bewd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   112: aload_0
    //   113: new 221	java/util/ArrayList
    //   116: dup
    //   117: invokespecial 222	java/util/ArrayList:<init>	()V
    //   120: putfield 224	bewd:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   123: aload_0
    //   124: getfield 198	bewd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   127: ldc 226
    ...
    //   135: astore_1
    //   136: aload_0
    //   137: getfield 224	bewd:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   140: aload_1
    ...
    //   152: dup
    //   153: aload_0
    //   154: invokespecial 244	bewe:<init>	(Lbewd;)V
    //   157: putfield 246	bewd:jdField_a_of_type_Bewe	Lbewe;
    ...
    //   169: astore_1
    //   170: aload_0
    //   171: getfield 40	bewd:jdField_a_of_type_ComTencentMobileqqAppBaseActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   174: aload_0
    //   175: getfield 246	bewd:jdField_a_of_type_Bewe	Lbewe;
    //   178: aload_1
    ...
    //   184: astore_1
    //   185: aload_0
    //   186: invokevirtual 260	bewd:dismiss	()V
    //   189: return
    //   190: astore_1
    //   191: aload_0
    //   192: invokevirtual 260	bewd:dismiss	()V
    //   195: return
    //   196: astore_1
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetInputMethodRelativeLayout = ((InputMethodRelativeLayout)paramView.findViewById(2131376947));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366054));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131368909));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131377349));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131369836));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton.setSelected(true);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    paramView.findViewById(2131379357).setOnClickListener(this);
  ...
  protected void a(String paramString)
  {
    try
    {
      avzm.a("qbrowserCommentOnSend", new JSONObject(TroopBarPublishUtils.a(paramString, null, null)), this.jdField_a_of_type_JavaUtilArrayList, null);
      return;
    }
  ...
  {
    Object localObject;
    if ((!android.text.TextUtils.isEmpty(paramString1)) && ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof biex)))
    {
      localObject = ((biex)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).a();
      if (localObject != null)
      {
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        avzm.a("qbrowserCommentOnCreate", null, this.jdField_a_of_type_JavaUtilArrayList, null);
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695979));
        return;
      }
  ...
  protected boolean a()
  {
    String str = (String)bgip.c.get(this.jdField_a_of_type_JavaLangString);
    bgip.c.clear();
    if (!android.text.TextUtils.isEmpty(str))
    {
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bewe != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.unregisterReceiver(this.jdField_a_of_type_Bewe);
      this.jdField_a_of_type_Bewe = null;
    }
    if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel != null) {
    ...
    avzm.a("qbrowserCommentOnClose", null, this.jdField_a_of_type_JavaUtilArrayList, null);
    super.dismiss();
  }
  ...
  public void send()
  {
    ...
    for (int i = str.length();; i = 0)
    {
      if (i == 0)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131695997, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (i < this.jdField_b_of_type_Int)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695995, new Object[] { Integer.valueOf(this.jdField_b_of_type_Int) }), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (i > this.jdField_a_of_type_Int)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695996, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) }), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (!HttpUtil.isConnect(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity))
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131694226, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      a(str);
      return;
