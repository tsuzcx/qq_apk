  ...
  implements akpq
{
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, aukn paramaukn)
  {
    a().b(paramDataLineMsgRecord);
    paramaukn = a().a(paramDataLineMsgRecord.groupId);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.c(localMessage);
    ...
    label290:
    while ((paramaukn != null) && (paramaukn.getComeCount() != 1)) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(localMessage.frienduin, localMessage.istroop, 1);
  }
  ...
  public int a(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    if (Thread.currentThread() == ((Looper)localObject).getThread())
    {
      ...
      if (i > 0)
      {
        paramDataLineMsgSet = akpy.a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int);
        ...
        if (l > 0L)
        {
          ...
          if (paramDataLineMsgSet != null)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a.put(akpy.a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int), localObject);
          }
        }
  ...
  public long a(DataLineMsgRecord paramDataLineMsgRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      return l1;
      a();
      localObject1 = new gn(false, false);
      ...
      if (Thread.currentThread() == ((Looper)localObject2).getThread())
      {
        ...
        try
        {
          if (paramDataLineMsgRecord.time == 0L) {
            paramDataLineMsgRecord.time = awzw.a();
          }
          ...
          RecentUser localRecentUser = ((aktg)localObject2).a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int);
          localRecentUser.setType(this.jdField_a_of_type_Int);
          localRecentUser.lastmsgtime = paramDataLineMsgRecord.time;
          ((aktg)localObject2).a(localRecentUser);
          a(paramDataLineMsgRecord, (aukn)localObject1);
    ...
    new Handler((Looper)localObject2).post(new DatalineMessageManager.1(this, paramDataLineMsgRecord, (gn)localObject1));
    ((gn)localObject1).a(-1L);
    return 0L;
  }
  ...
  protected void a()
  {
    ((ajuo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a(false);
  }
  
  public void a(int paramInt, akta paramakta)
  {
    a().a(paramInt, paramakta);
  }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      RecentUser localRecentUser = localaktg.a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int);
      localRecentUser.setType(this.jdField_a_of_type_Int);
      localRecentUser.lastmsgtime = awzw.a();
  ...
  public void e()
  {
    if (!LiteActivity.class.getName().equals(ajuf.a(BaseApplication.getContext()))) {}
    do
    {
      return;
      if (QLog.isColorLevel()) {
