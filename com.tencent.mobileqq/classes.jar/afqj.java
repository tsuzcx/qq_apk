  ...
  implements afrc, View.OnClickListener
{
  ...
  private afqs jdField_a_of_type_Afqs;
  private ClipData jdField_a_of_type_AndroidContentClipData;
  private Context jdField_a_of_type_AndroidContentContext;
  private Html.ImageGetter jdField_a_of_type_AndroidTextHtml$ImageGetter = new afqk(this);
  private Html.TagHandler jdField_a_of_type_AndroidTextHtml$TagHandler = new afqm(this);
  public View a;
  ...
  private bjve jdField_a_of_type_Bjve = new afql(this);
  ...
  public afqj(BaseChatPie paramBaseChatPie)
  {
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299195);
    ...
    localLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299192);
    this.jdField_b_of_type_AndroidWidgetImageButton.setLayoutParams(localLayoutParams);
  }
  ...
  private boolean d()
  {
    bdgh localbdgh = (bdgh)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getHelper(74);
    return (localbdgh != null) && (localbdgh.a()) && (aqeg.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app));
  }
  ...
  private void e()
  {
    ...
    bcef.b(localQQAppInterface, "dc00898", "", "", "0X800AD27", "0X800AD27", b(), 0, "", "", "", "");
    c(true);
    ...
    amat.a(localQQAppInterface, "full_screen_input", true);
    ...
    ((aqwg)localQQAppInterface.getManager(214)).c(false);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131364012);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getText(2131719695));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167075));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130849929);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.rightMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299194);
    localLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299193);
    localLayoutParams.gravity = 85;
    this.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams(localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    if (AppSetting.c) {
      this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(amtj.a(2131689494));
    }
  ...
  private void h()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.setOnDragListener(new afqq(this));
    }
  }
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.b(this.jdField_a_of_type_Bjve);
    }
    avse.a(null);
    avse.a(null);
  }
  ...
  Drawable a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = ThumbnailUtils.extractThumbnail(atvy.a(paramString, localOptions, 1, 4), j, i, 2);
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new afqr(this);
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131367340);
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)paramViewGroup.findViewById(2131367337));
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)paramViewGroup.findViewById(2131368068));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramViewGroup.findViewById(2131367353));
    this.jdField_a_of_type_ComTencentWidgetPatchedButton = ((PatchedButton)paramViewGroup.findViewById(2131367338));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetPatchedButton.setOnClickListener(this);
    if (AppSetting.c)
    {
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(amtj.a(2131704088));
      this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(amtj.a(2131704085));
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.setFilters(new InputFilter[] { new afqn(this) });
    paramViewGroup = new afqo(this);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.a(this.jdField_a_of_type_Bjve);
    jdField_b_of_type_Boolean = true;
    ...
    paramViewGroup = avse.a(paramViewGroup[0], ImageSpan.class);
    avse.a(this);
    avse.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.setOnWindowFocusChangedListener(new afqp(this));
  }
  ...
  public void a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_Afqs = new afqs(paramCharSequence, paramInt1, paramInt2, paramInt3);
      if (QLog.isColorLevel()) {
        QLog.d("FullScreenInputHelper", 2, "[mix] handleBeforeTextChange mTextChangeInfo: " + this.jdField_a_of_type_Afqs);
      }
    }
  }
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    jdField_b_of_type_Boolean = true;
    avsf.a("0X800AE19", paramList.size());
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getInputEnable()) {
        amat.a(localQQAppInterface, "full_screen_input", false);
      }
    }
    ...
    ((aqwg)localQQAppInterface.getManager(214)).c(true);
  ...
  public boolean a(Editable paramEditable)
  {
    ...
    for (;;)
    {
      b(bool);
      if (jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Afqs.a(paramEditable);
      }
      try
      {
        this.jdField_a_of_type_Afqs.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input);
        if (this.c) {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.getLineCount() > 3) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.enableFullScreenInput()) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getInputEnable()) && (!bbyp.b())) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      bcef.b((QQAppInterface)localObject, "dc00898", "", "", "0X8009F36", "0X8009F36", b(), 0, "", "", "", "");
      a(false);
      continue;
      bcef.b((QQAppInterface)localObject, "dc00898", "", "", "0X8009F27", "0X8009F27", b(), 0, "", "", "", "");
      e();
      continue;
      bcef.b((QQAppInterface)localObject, "dc00898", "", "", "0X800AD28", "0X800AD28", b(), 0, "", "", "", "");
      if (a() > 0) {}
      for (int i = a();; i = 21)
      {
        avsf.a("0X800AE1A", i);
      ...
      localObject = (bdgh)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getHelper(74);
      if (localObject != null) {
        ((bdgh)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.getText().toString(), 2);
      }
    }
  }
}
