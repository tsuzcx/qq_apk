  ...
  implements View.OnClickListener, View.OnHoverListener
{
  ...
  private acds jdField_a_of_type_Acds;
  private aced jdField_a_of_type_Aced;
  private acej jdField_a_of_type_Acej;
  private acek jdField_a_of_type_Acek;
  private acel jdField_a_of_type_Acel;
  ...
  public acep(acey paramacey, View paramView, aced paramaced)
  {
    acho.a("GdtMvElementsController", "GdtMvElementsController: ");
    ...
    this.jdField_a_of_type_Acds = new acds();
  }
  ...
  private ImageView a(int paramInt)
  {
    ...
    if (2 == paramInt) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838553));
    }
    do
    {
      ...
      if (1 == paramInt)
      {
        localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838547));
        return localImageView;
      }
    } while (3 != paramInt);
    localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838548));
    return localImageView;
  }
  ...
  private URLDrawable a(String paramString)
  {
    ...
    int i = aciv.a(140, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    paramString.setTag(bgxc.b(i, i, aciv.a(21, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext))));
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Aced.a();
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          j = aciv.e(this.jdField_a_of_type_AndroidContentContext);
          localLayoutParams.height = aciv.a(paramInt, i, j);
          this.jdField_b_of_type_AndroidViewView.setBackground(aciv.a(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165683), 8, 80));
          this.jdField_b_of_type_AndroidViewView.setVisibility(0);
          this.jdField_b_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
          acho.b("GdtMvElementsController", "initDesMaskPositions " + paramInt + "|" + paramBoolean);
          return;
        }
        int j = aciv.f(this.jdField_a_of_type_AndroidContentContext);
        continue;
      ...
      {
        this.jdField_b_of_type_AndroidViewView.setVisibility(8);
        acho.d("GdtMvElementsController", "initDesMaskPositions error! ", localThrowable);
        return;
      }
      return;
      label184:
  ...
  private void a(String paramString)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView != null)
    {
      ...
      {
        acho.a("GdtMvElementsController", "updateScoreAndStar " + paramString);
        ...
        acho.a("GdtMvElementsController", "updateScoreAndStar " + this.jdField_b_of_type_AndroidWidgetTextView.getWidth() + " mw " + f);
  ...
  private String b()
  {
    ...
    if (localObject != null)
    {
      ...
      if (!((qq_ad_get.QQAdGetRsp.AdInfo)localObject).display_info.button_info.get().isEmpty())
      {
        ...
        acho.b("GdtMvElementsController", "getContentStrByStyle pushName " + str2);
        ...
        {
          str1 = str2;
          if (ois.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject))
          {
  ...
  private void i()
  {
    ...
    localLayoutParams.width = aciv.a(140, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.height = localLayoutParams.width;
    localLayoutParams.topMargin = aciv.a(1054, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(30, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = aciv.a(1063, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(196, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = aciv.a(1111, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(196, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetLinearLayout.getLayoutParams();
    localLayoutParams.topMargin = aciv.a(1160, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(196, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    ...
    localLayoutParams.height = aciv.a(80, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = aciv.a(1224, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(30, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    ...
    localLayoutParams.height = aciv.a(129, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = aciv.a(1199, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(5, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
    acho.a("GdtMvElementsController", "inti585Vpositions() urlBtnLp2.topMargin = " + localLayoutParams.topMargin + ", urlBtnLp2.height = " + localLayoutParams.height);
    ((RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams()).height = aciv.a(315, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
  }
  ...
  private void j()
  {
    ...
    localLayoutParams.width = aciv.a(140, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.height = localLayoutParams.width;
    localLayoutParams.topMargin = aciv.a(580, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(30, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = aciv.a(589, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(196, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = aciv.a(637, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(196, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetLinearLayout.getLayoutParams();
    localLayoutParams.topMargin = aciv.a(685, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(196, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.getLayoutParams();
    localLayoutParams.height = aciv.a(80, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = aciv.a(611, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(1034, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = aciv.a(30, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetButton.getLayoutParams();
    localLayoutParams.height = aciv.a(129, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = aciv.a(586, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(1009, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = aciv.a(5, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    ((RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams()).height = aciv.a(200, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void k()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      ((RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams()).topMargin = aciv.a(742, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    }
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setHeight(aciv.a(80, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext)));
    localLayoutParams.topMargin = aciv.a(1224, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(30, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetButton.getLayoutParams();
    this.jdField_a_of_type_AndroidWidgetButton.setHeight(aciv.a(129, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext)));
    localLayoutParams.topMargin = aciv.a(1199, 1334, aciv.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = aciv.a(5, 750, aciv.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetImageView != null) {
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845460);
      }
    }
  }
  ...
  private void n()
  {
    ...
    {
      acho.b("GdtMvElementsController", "doHandleClick");
  ...
  {
    Object localObject = this.jdField_a_of_type_Aced.a();
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131362220);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362098));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362100));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362119));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362121));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362038));
    this.e = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362041));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362110));
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight = ((GdtMvButtonHighLight)this.jdField_a_of_type_AndroidViewView.findViewById(2131362128));
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView = ((GdtMvAppBtnView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362133));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView = ((GdtMvAppBtnView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362132));
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null)
    {
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setOnClickListener(this);
      this.jdField_a_of_type_Acds.a(this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight);
    }
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
    {
      ...
      this.jdField_a_of_type_Acds.a(this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    }
    if (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
    {
      ...
      this.jdField_a_of_type_Acds.a(this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    }
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131362129));
    if (this.jdField_a_of_type_AndroidWidgetButton != null) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(4);
    }
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131362112));
    ...
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367604);
    if (this.jdField_c_of_type_AndroidViewView != null)
    {
      this.jdField_a_of_type_Acds.a(this.jdField_c_of_type_AndroidViewView);
      this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidViewView.setOnHoverListener(this);
    }
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367605);
    if (this.jdField_d_of_type_AndroidViewView != null)
    {
      this.jdField_a_of_type_Acds.a(this.jdField_d_of_type_AndroidViewView);
      this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    }
    if ((((GdtMotiveVideoPageData)localObject).vSize != 585) && (((GdtMotiveVideoPageData)localObject).screenOrientation == 1)) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363693));
    }
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131362096));
    h();
    l();
    localObject = b();
    if (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null) {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvDownloadBtnManager = new GdtMvDownloadBtnManager(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Aced.a(), (String)localObject, this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvDownloadBtnManager.f();
    this.jdField_a_of_type_Acds.a(new aceq(this));
  }
  
  public void a(int paramInt)
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Aced.a();
    acho.b("GdtMvElementsController", "adjustViewsPosition " + paramInt + " style " + localGdtMotiveVideoPageData.style);
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null) {
    ...
    if (localGdtMotiveVideoPageData.screenOrientation == 1)
    {
      if (localGdtMotiveVideoPageData.vSize == 585)
      {
        if (this.jdField_a_of_type_Acel == null)
        {
          this.jdField_a_of_type_Acel = new acel(this.jdField_a_of_type_AndroidContentContext);
          this.jdField_a_of_type_Acel.a(this.jdField_b_of_type_AndroidViewView, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_c_of_type_AndroidViewView);
        }
        this.jdField_a_of_type_Acel.a(paramInt);
      }
      while (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
        return;
      }
      if (this.jdField_a_of_type_Acek == null)
      {
        this.jdField_a_of_type_Acek = new acek(this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Acek.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_c_of_type_AndroidViewView);
      }
      this.jdField_a_of_type_Acek.a(paramInt);
      return;
    }
    if (this.jdField_a_of_type_Acej == null)
    {
      this.jdField_a_of_type_Acej = new acej(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Acej.a(this.jdField_b_of_type_AndroidViewView, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_c_of_type_AndroidViewView);
    }
    this.jdField_a_of_type_Acej.a(paramInt);
  }
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Aced.a();
    qq_ad_get.QQAdGetRsp.AdInfo localAdInfo = this.jdField_a_of_type_Aced.a();
    long l = this.jdField_a_of_type_Acey.a();
    String str2 = "";
    this.jdField_a_of_type_Acey.a().b(2);
    String str1;
    switch (paramInt)
    {
    default: 
    ...
    for (;;)
    {
      ...
      return;
      acho.a("GdtMvElementsController", "[click ad btn] " + localAdInfo);
      Activity localActivity = this.jdField_a_of_type_Acey.a().a();
      str1 = str2;
      if (localAdInfo != null)
      {
        ...
        if (localActivity != null)
        {
          ...
          paramString = this.jdField_a_of_type_Acds.a(str1, l, this.jdField_a_of_type_Acey.a(), this.jdField_a_of_type_Acey.b(), paramString);
          ...
          for (;;)
          {
            ...
            GdtHandler.a(a(localAdInfo, localGdtMotiveVideoPageData, localActivity, paramBoolean));
            break;
            paramBoolean = a();
          }
          acho.a("GdtMvElementsController", "[click ad download btn] ");
          str1 = str2;
          if (localAdInfo != null)
          {
            str1 = localAdInfo.report_info.click_url.get();
            ...
            if ((localAdInfo.exp_info.reward_video_download_type.get() == 1) && (localAdInfo.product_type.get() == 12) && (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvDownloadBtnManager != null))
            {
              ...
              if (ois.a(this.jdField_a_of_type_AndroidContentContext, paramString)) {
                n();
              } else {
  ...
  public boolean a()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          localObject = this.jdField_a_of_type_Aced.a();
          if (localObject == null)
          {
  ...
  public void b()
  {
    Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130840307);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setBackgroundDrawable(localDrawable);
    int i = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167226);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setTextColor(i);
  }
  
  public void c()
  {
    acho.b("GdtMvElementsController", "enableMvBtnUrlStyleDefault");
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null)
    {
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setBackgroundDrawable(this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130840296));
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167363));
    }
  }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Acel != null)
    {
      this.jdField_a_of_type_Acel.b();
      this.jdField_a_of_type_Acel = null;
    }
    if (this.jdField_a_of_type_Acek != null)
    {
      this.jdField_a_of_type_Acek.b();
      this.jdField_a_of_type_Acek = null;
    }
    if (this.jdField_a_of_type_Acej != null)
    {
      this.jdField_a_of_type_Acej.b();
      this.jdField_a_of_type_Acej = null;
    }
    ...
    if (this.jdField_a_of_type_Acds != null) {
      this.jdField_a_of_type_Acds.a();
    }
  }
  ...
  public void g()
  {
    acho.a("GdtMvElementsController", "onResume: ");
    d();
    f();
  }
  ...
  public boolean onHover(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      acho.d("GdtMvElementsController", "onHover " + paramMotionEvent.getAction());
