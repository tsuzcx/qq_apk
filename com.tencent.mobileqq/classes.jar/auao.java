...
public class auao
  extends aszq
  implements atji, auas
{
  final int jdField_a_of_type_Int = 1000;
  long jdField_a_of_type_Long = 0L;
  aszq jdField_a_of_type_Aszq = null;
  auap jdField_a_of_type_Auap = null;
  public auaq a;
  public auar a;
  ...
  public auao(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = null;
    this.jdField_a_of_type_Auar = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Auaq = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = paramFileManagerEntity;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    this.jdField_a_of_type_Auar = new auar(paramQQAppInterface.getCurrentAccountUin(), "actDiscussFileUp");
  }
  ...
  private boolean a(long paramLong, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramString1 == null) || (paramString1.length() == 0))
    {
      ...
      if (paramLong == 0L)
      {
        this.jdField_a_of_type_Auar.jdField_a_of_type_Long = 9048L;
        this.jdField_a_of_type_Auar.c = "onSendDiscFile Host null";
        this.jdField_a_of_type_Auar.c();
        a(false);
        bool = false;
      }
    }
    while ((paramString2 != null) && (paramString2.length() != 0) && (paramString3 != null) && (paramString3.length() != 0)) {
      ...
      {
        return bool;
        this.jdField_a_of_type_Auar.jdField_a_of_type_Long = ((int)paramLong);
      }
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    if (paramLong == 0L) {}
    for (this.jdField_a_of_type_Auar.jdField_a_of_type_Long = 9005L;; this.jdField_a_of_type_Auar.jdField_a_of_type_Long = ((int)paramLong))
    {
      this.jdField_a_of_type_Auar.c = "onSendDiscFile param error";
      this.jdField_a_of_type_Auar.c();
      a(false);
      return false;
    }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 - this.jdField_a_of_type_Long >= 1000L)
    {
      ...
      {
        String str = this.jdField_a_of_type_Auar.a();
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Auar.jdField_d_of_type_Long = System.currentTimeMillis();
    if (!paramBoolean)
    {
      ...
      for (this.jdField_a_of_type_Auar.jdField_a_of_type_Long = 9043L;; this.jdField_a_of_type_Auar.jdField_a_of_type_Long = 9045L)
      {
        this.jdField_a_of_type_Auar.c = "server retError";
        if (paramString6 != null) {
          this.jdField_a_of_type_Auar.c = paramString6;
        }
        this.jdField_a_of_type_Auar.c();
        a(false);
        return;
    ...
    paramBoolean = false;
    int i;
    if ((atgz.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (paramBundle != null))
    {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
      this.jdField_a_of_type_Auap = new auap();
      this.jdField_a_of_type_Auap.a(paramString3, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSHA, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this);
      this.jdField_a_of_type_Auaq = new auaq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Auar, paramString4, paramInt, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_Auap, paramBoolean, paramString2, paramString5);
  ...
  {
    this.jdField_a_of_type_Auar.jdField_a_of_type_Long = paramLong.longValue();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Auar.jdField_a_of_type_Long = 9004L;
    this.jdField_a_of_type_Auar.g = System.currentTimeMillis();
    this.jdField_a_of_type_Auar.c();
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Auar.jdField_a_of_type_Long = 9037L;
    this.jdField_a_of_type_Auar.g = System.currentTimeMillis();
    this.jdField_a_of_type_Auar.c();
  ...
  public void f()
  {
    this.jdField_a_of_type_Auar.jdField_a_of_type_Int = 3000;
    this.jdField_a_of_type_Auar.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName;
    this.jdField_a_of_type_Auar.j = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize;
    this.jdField_a_of_type_Auar.h = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    if (QLog.isColorLevel()) {
      QLog.i("DiscFileOperator<FileAssistant>", 1, "start sendFile:" + bbyp.a());
    }
    atvy.a().execute(new DiscFileOperator.2(this));
  }
}
