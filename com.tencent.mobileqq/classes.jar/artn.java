...
public class artn
{
  ...
  private static void a(BaseActivity paramBaseActivity, arts paramarts)
  {
    ThreadManagerV2.postImmediately(new MultiAIOStarter.2(paramBaseActivity, paramarts), null, false);
  }
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (!((artr)BaseApplicationImpl.getApplication().getRuntime().getManager(325)).a())
    {
      if (QLog.isColorLevel()) {
    ...
    if (artg.a(paramInt))
    {
      ...
      arts localarts = arts.a(localQQAppInterface);
      Bitmap localBitmap = a(paramContext);
      int i = a(paramContext);
      a = true;
      localarts.a(localBitmap);
      localarts.a(i);
      a((BaseActivity)paramContext, localarts);
      localarts.a((QQAppInterface)localQQAppInterface, (FragmentActivity)paramContext, paramString3, paramInt, paramString1, paramString2);
      localarts.a(new arto(paramContext));
      localIntent.putExtra("OPEN_MULTI_AIO_CONTEXT", localarts.a());
      if ("open_from_aio".equals(paramString3)) {
        localIntent.putExtra("OPEN_MULTI_AIO_LIST_VIEW_SPECIFY_BOTTOM", a(paramContext));
      }
      abju.a(paramContext, localIntent, PublicTransFragmentActivity.class, MultiAIOFragment.class);
      return true;
    }
    return false;
  }
  ...
  private static int[] a(Context paramContext)
  {
    ...
    if ((paramContext instanceof BaseActivity))
    {
      paramContext = (ListView)((BaseActivity)paramContext).findViewById(2131303604);
      if (paramContext != null)
      {
