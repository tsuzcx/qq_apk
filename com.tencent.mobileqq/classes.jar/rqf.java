...
public class rqf
{
  private static String jdField_a_of_type_JavaLangString = bbvj.a(Environment.getExternalStorageDirectory().getAbsolutePath() + "/tencent/MobileQQ/pddata/" + "proteus/");
  ...
  public rqf(String paramString1, String paramString2)
  {
  ...
  private File a(String paramString1, String paramString2)
  {
    ...
    //   36: aload_0
    //   37: invokespecial 68	rqf:a	()Ljava/lang/String;
    ...
    //   65: invokestatic 81	rqi:a	(Ljava/io/File;)Z
    //   68: pop
    //   69: aload 6
    ...
    //   125: aload_1
    //   126: aload_3
    //   127: invokestatic 115	rqi:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   130: pop2
    //   131: aload_1
    //   132: invokestatic 118	rqi:a	(Ljava/io/Closeable;)V
    //   135: aload_3
    //   136: invokestatic 118	rqi:a	(Ljava/io/Closeable;)V
    //   139: aload 6
    //   141: areturn
    //   142: astore 6
    //   144: aconst_null
    ...
    //   181: aload_1
    //   182: invokestatic 118	rqi:a	(Ljava/io/Closeable;)V
    //   185: aload_3
    //   186: invokestatic 118	rqi:a	(Ljava/io/Closeable;)V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aconst_null
    ...
    //   196: astore_3
    //   197: aload 5
    //   199: invokestatic 118	rqi:a	(Ljava/io/Closeable;)V
    //   202: aload_3
    //   203: invokestatic 118	rqi:a	(Ljava/io/Closeable;)V
    //   206: aload_1
    //   207: athrow
    //   208: astore_1
    //   209: aconst_null
  ...
  private String a()
  {
    return jdField_a_of_type_JavaLangString + onh.a() + "/" + this.c + "/" + "styles";
  }
  
  private boolean a()
  {
    if (this.d == null) {}
    while (!this.d.equals(onh.a())) {
      return true;
    }
    return false;
  }
  ...
  public rqg a(boolean paramBoolean)
  {
    Object localObject3;
    Object localObject1;
    if ((paramBoolean) && (this.jdField_a_of_type_Boolean) && (!a()))
    {
      localObject3 = rqg.a(this.jdField_b_of_type_JavaLangString, false);
    ...
    else
    {
      ...
      ((rqg)localObject1).a(rpx.a());
      ((rqg)localObject1).b(this.jdField_b_of_type_JavaLangString);
      ((rqg)localObject1).a(3);
      l = System.currentTimeMillis();
      for (;;)
      {
        try
        {
          localObject3 = new rqc(a());
          localObject4 = ((rqa)localObject3).a();
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          rqg localrqg = null;
          return localrqg;
          Object localObject5 = rqj.a((InputStream)localObject5);
          a(localrqg, new JSONObject((String)localObject5), false);
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("RealTimeTemplateFactory", 2, "加载样式 file: " + (String)localObject4 + "  realTimeStyle: " + (String)localObject5);
          continue;
        }
        ...
        if (localIterator.hasNext())
        {
          ...
          try
          {
            QLog.d("RealTimeTemplateFactory", 2, "加载样式 file: " + (String)localObject4);
            localObject5 = ((rqa)localObject3).a((String)localObject4);
  ...
  public void a(rqg paramrqg, JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramrqg.a(str1, str2, (String)localJSONObject.keys().next());
      localProteusParser.createViewTemplate(paramrqg, localJSONObject, null);
