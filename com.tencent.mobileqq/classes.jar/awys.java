  ...
  implements awyp
{
  ...
  public awys(Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_Awyq.jdField_a_of_type_Int = 0;
    int j = paramInt2;
    int i = paramInt1;
    paramInt1 = j;
    while (paramInt2 > 0)
    ...
    return this.jdField_a_of_type_Awyq;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_JavaIoPipedInputStream = new bdjp(this.jdField_a_of_type_JavaIoPipedOutputStream, 1920);
      return;
    }
  ...
  protected void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    {
      paramInt1 = a(this.c, this.jdField_a_of_type_Awyq.jdField_a_of_type_Int);
      paramArrayOfByte = this.jdField_a_of_type_Awyq;
