...
public class bfir
{
  ...
  {
    bflp.c("AppClient", "getFeedsChannelId >>> qzoneAppid = " + paramInt1 + "| " + paramInt2 + " | " + paramInt3);
    if (paramInt1 == 352) {}
    switch (paramInt2)
    {
    case 4: 
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    if ((!TextUtils.isEmpty(paramActivity)) && (paramActivity.contains("&")))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          HashMap localHashMap = bfiu.a((String)localObject2);
          str1 = (String)localHashMap.get("appid");
          if (TextUtils.isEmpty(str1))
          {
            str1 = (String)localHashMap.get(bfoh.b);
            localObject4 = (String)localHashMap.get(bfoh.jdField_c_of_type_JavaLangString);
            if (!TextUtils.isEmpty((CharSequence)localObject4)) {
              break label416;
            }
            localObject4 = (String)localHashMap.get("ta");
            localObject5 = (String)localHashMap.get(bfoh.d);
            if (!TextUtils.isEmpty((CharSequence)localObject5)) {
              break label419;
            }
            localObject5 = (String)localHashMap.get("tk");
            str2 = (String)localHashMap.get(bfoh.e);
            localObject7 = (String)localHashMap.get("via");
            localObject3 = (String)localHashMap.get("packName");
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              break label422;
            }
            localObject3 = (String)localHashMap.get(bfoh.f);
            paramActivity = (String)localHashMap.get(bfoh.B);
            bflp.d("AppClient", " feedChannel:" + paramActivity + "   schemaUrl:" + (String)localObject2);
            if ((!TextUtils.isEmpty(paramActivity)) && (!paramActivity.startsWith("0;"))) {
              break label425;
            }
            paramActivity = "";
            bflp.d("AppClient", " finalFeedChannel:" + paramActivity);
            if ((TextUtils.isEmpty((CharSequence)localObject3)) || (!bfms.a((String)localObject3))) {
              break;
            }
        ...
        bfms.a(bfbm.a().a(), str1, (String)localObject3, paramActivity);
        return;
      ...
      ((Bundle)localObject6).putString(bfoh.b, localMalformedURLException);
      ((Bundle)localObject6).putString(bfoh.jdField_c_of_type_JavaLangString, (String)localObject4);
      ((Bundle)localObject6).putString(bfoh.d, (String)localObject5);
      ((Bundle)localObject6).putString(bfoh.e, str2);
      ((Bundle)localObject6).putString(bfoh.f, (String)localObject3);
      ((Bundle)localObject6).putString(bfoh.i, (String)localObject7);
      ((Bundle)localObject6).putString(bfoh.B, paramActivity);
      ...
      paramActivity = bfmy.a(i, j, m);
      bfnj.a().a(String.valueOf(bfbm.a().a()), localMalformedURLException, paramActivity, "200", false);
      localObject6 = paramActivity;
    }
    for (paramActivity = (Activity)localObject7;; paramActivity = (Activity)localObject7)
    {
      if ((TextUtils.isEmpty((CharSequence)localObject5)) || (TextUtils.isEmpty((CharSequence)localObject4)) || ("0".equals(localObject5)) || (localObject3 == null) || (!bfox.a().c()) || (!bool)) {
        break label749;
      }
    ...
    label749:
    Object localObject3 = bfiu.g() + File.separator + "qapp_center_detail.htm";
    Object localObject4 = new File((String)localObject3);
    if (!((File)localObject4).exists())
    {
      bflp.d("AppClient", "file" + (String)localObject3 + " not exist copyassets.");
    ...
    if (((File)localObject4).exists())
    {
      ...
      label945:
      if (bfiu.a(paramBundle.getString("schemaUrl")).get("auto_download") == null) {
        break label1235;
      }
      i = 1;
      label965:
    ...
    for (;;)
    {
      ...
      bflp.b("Jie", "APP_URL:" + (String)localObject3 + " |  PARAMS >>> " + ((Bundle)localObject7).getString("APP_PARAMS"));
      ...
      return;
      localObject3 = bfiu.m() + File.separator + "qapp_center_detail.htm";
      break;
      label1206:
  ...
  {
    String str1 = bfiu.g() + File.separator + "qapp_center_detail.htm";
    bfiu.a();
    Object localObject = new File(str1);
    if (!((File)localObject).exists())
    {
      bflp.d("AppClient", "file" + str1 + " not exist copyassets.");
      bflm.a("Page/system", bfiu.h());
    }
  ...
  protected static void a(Activity paramActivity, String paramString1, String paramString2, Bundle paramBundle, String paramString3, String paramString4)
  {
    ...
    {
      paramString4 = bfiu.g() + File.separator + paramString4;
      localObject = new File(paramString4);
      if (!((File)localObject).exists())
      {
        bflp.d("AppClient", "file" + paramString4 + " not exist copyassets.");
        bflm.a("Page/system", bfiu.h());
      }
      if (((File)localObject).exists()) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str4))
      {
        ...
        localBundle.putBoolean("FROM_FEED", true);
        localBundle.putString(bfoh.i, str1);
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString2))
        {
          ...
          if (paramString2.size() > 0)
          {
            ...
            bflp.b("AppClient", "titles = " + paramString2);
          }
        }
        else
        {
          bflp.b("TAG", "APP_URL:" + paramString4 + " |  PARAMS >>> " + localBundle.getString("APP_PARAMS"));
          localIntent.putExtras(localBundle);
          localIntent.putExtra("adapter_action", "action_app_detail");
          localIntent.addFlags(603979776);
        }
      ...
      catch (Exception paramString2)
      {
        try
        {
          for (;;)
          {
            ...
            paramString1 = bfok.a().a(paramString1);
            if ((!bfox.a().c()) || (paramString1 == null) || (paramString1.jdField_c_of_type_Int != 1)) {
              break label1133;
            }
            bflp.d("AppClient", ">>>appid=" + paramString1.jdField_c_of_type_JavaLangString + " myAppid=" + paramString1.j);
            localBundle.putString(bfoh.b, paramString1.jdField_c_of_type_JavaLangString);
            localBundle.putString(bfoh.jdField_c_of_type_JavaLangString, paramString1.j);
            localBundle.putString(bfoh.d, paramString1.k);
            localBundle.putString(bfoh.i, str1);
            localBundle.putString(bfoh.f, paramString1.e);
            localBundle.putInt(bfoh.e, paramString1.b);
            bfox.a().a(paramActivity, localBundle, ((String)localObject).equals("2457"), true);
            return;
            i = 0;
            paramString4 = bfiu.m() + File.separator + "qapp_center_detail.htm";
            break;
            break;
          ...
          bflp.c("AppClient", "get push title error>>>", paramString2);
        }
        catch (Exception paramString2)
        {
          for (;;)
  ...
  {
    bflp.b("AppClient", "shcemaUrlAnd:" + paramString1);
    if ((paramString1 == null) || (paramString1.length() == 0)) {}
    for (;;)
    {
      return;
      Object localObject2 = bfiu.a(paramString1);
      ...
      if (TextUtils.isEmpty(str2))
      {
        ...
        String str5 = (String)((HashMap)localObject2).get(bfoh.jdField_c_of_type_JavaLangString);
        if (!TextUtils.isEmpty(str5)) {
          break label870;
        }
        str5 = (String)((HashMap)localObject2).get("ta");
        String str6 = (String)((HashMap)localObject2).get(bfoh.d);
        ...
        bflp.b("AppClient", "appid=" + str8 + " ,sendtime=" + str10 + " ,packname=" + str9 + " ,packetversion=" + str13 + " ,msgtype=" + str11 + " ,type=" + str14 + " ,downUrl=" + (String)localObject1 + " ,nativePage=" + str1 + " ,htmlPage=" + str2 + " ,subPageType=" + str3 + " ,pageTitles=" + str4 + " ,minvercode=" + str16 + " ,backUrl=" + (String)localObject2);
        i = bfms.a(str9);
        int j = bfms.b(bfok.a().a(str8));
        ...
        ((Bundle)localObject1).putString(bfoh.b, str8);
        ((Bundle)localObject1).putString(bfoh.jdField_c_of_type_JavaLangString, str5);
        ((Bundle)localObject1).putString(bfoh.d, str6);
        if (!TextUtils.isEmpty(str9)) {
          ((Bundle)localObject1).putString(bfoh.f, str9);
        }
        ((Bundle)localObject1).putString(bfoh.e, str13);
      }
      try
      {
        bfbm.a().a(Integer.parseInt(paramString2));
        label800:
        bfbm.a().a(paramString3);
        ...
        try
        {
          ...
          bfms.a(paramActivity, str8, str9, paramString1);
          return;
          break label236;
          label864:
          break label270;
          ...
          if (str1.equals("tmast"))
          {
            ...
            i = bfms.a("com.tencent.android.qqdownloader");
  ...
  protected static void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localBundle.putString("v", bfbm.a().e());
    new bfmk("http://appic.qq.com/cgi-bin/appstage/mapp_setrequest.cgi", "GET", null).execute(new Bundle[] { localBundle });
  }
  ...
  public static void b(Activity paramActivity, Bundle paramBundle)
  {
    ...
    bfmy.a("200", "ANDROIDQQ.SHARESOURCE", str2);
  ...
  protected static void b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      bfmy.a("200", str, paramString3);
      if ("2460".equals(paramString1)) {}
      label67:
      try
      {
        paramString2 = bfmy.a(Integer.parseInt(paramString2));
        paramString1 = paramString4;
        if (TextUtils.isEmpty(paramString4)) {
          paramString1 = paramString2;
        }
        bfmy.a("200", paramString1, paramString3);
        return;
      }
      catch (NumberFormatException paramString1) {}
    }
