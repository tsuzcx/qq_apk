...
public class bfir
{
  ...
  private CopyOnWriteArrayList<bfit> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public bfir()
  {
    bfjt.a("MobileQQprotect.QSecCb", new bfis(this));
    a();
  }
  ...
  private String a()
  {
    return bfha.a() + File.separator + "QSecCb.dat";
  }
  
  private void a()
  {
    byte[] arrayOfByte = new bfjp().a(a(), null, 1);
    if (arrayOfByte != null) {
      a(arrayOfByte);
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        ((bfit)paramString.next()).a(localLinkedList);
        continue;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	bfir:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   42: iload_3
  ...
  private byte[] a()
  {
    ...
    //   16: astore 4
    //   18: aload_0
    //   19: getfield 18	bfir:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  private void b()
  {
    byte[] arrayOfByte = a();
    if (arrayOfByte != null) {
      new bfjp().a(a(), arrayOfByte, null, 1);
    }
  }
  ...
  public void a(bfit parambfit)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambfit);
  }
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      bfjt.a("MobileQQprotect.QSecCb", localQSecCbQuery.toByteArray());
      return;
    }
