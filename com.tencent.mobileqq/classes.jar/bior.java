...
public class bior
{
  public static WebViewFragment a(binz parambinz, WebViewTabBarData paramWebViewTabBarData, Intent paramIntent)
  {
    ...
    if (i == 3)
    {
      ...
      if (parambinz != null) {
        return parambinz.a(paramIntent);
      }
    ...
    if (i == 4)
    {
      ...
      if ((i == 1) && (TextUtils.isDigitsOnly(paramWebViewTabBarData.tag)))
      {
        ...
        bmqw.d("WebViewFragmentBuilder", "tab_id =" + paramWebViewTabBarData.tag);
