  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("WATER_MARK_GET_PROFILE_PHOTO".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        ((Bundle)localObject2).putByteArray("PROFILE_PHOTO", a(a(baxt.a((AppInterface)localObject1, paramString, (byte)3))));
    ...
    else if ("WATER_MARK_GET_QQCARD_FRIENDINFO".equals(paramString))
    {
      ...
      if (localObject2 != null)
      {
        ...
        paramBundle = ((ajxn)localObject2).c(paramString);
        localObject2 = new Bundle();
        ((Bundle)localObject2).putString("QQ_NUMBER", paramString);
        ((Bundle)localObject2).putInt("QQ_LEVEL", paramBundle.iQQLevel);
        ((Bundle)localObject2).putInt("QQ_VIP_LEVEL", paramBundle.iSuperVipLevel);
    ...
    for (paramString = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; paramString = null)
    {
      ...
      localObject2 = new anxq();
      ((anxq)localObject2).d = paramBundle.getString("ARG_GIF_PATH");
      ((anxq)localObject2).e = ((anxq)localObject2).d;
      ((anxq)localObject2).a = paramBundle.getString("forward_summary_extra", "");
      ((anxq)localObject2).a(paramString, BaseApplicationImpl.getContext(), null, ((SessionWrap)localObject1).a());
      return null;
      return null;
    }
  }
