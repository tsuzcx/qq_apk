...
public class ajfr
{
  ...
  private ajfq jdField_a_of_type_Ajfq = new ajfu(this);
  private ajfy jdField_a_of_type_Ajfy;
  private anyu jdField_a_of_type_Anyu = new ajfv(this);
  ...
  public ajfr(Face2FaceAddContactFragment paramFace2FaceAddContactFragment)
  {
    this.jdField_a_of_type_Ajfy = paramFace2FaceAddContactFragment;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramFace2FaceAddContactFragment.getActivity().app;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajfq);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Anyu);
    this.jdField_a_of_type_Ajfp = ((ajfp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(169));
  }
  ...
  private void a(FragmentActivity paramFragmentActivity, boolean paramBoolean, String paramString1, String paramString2)
  {
    if (Build.VERSION.SDK_INT >= 23) {
      if (paramFragmentActivity.checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0) {
        paramFragmentActivity.requestPermissions(new ajfs(this, paramBoolean, paramString1, paramString2), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
      }
    }
    while (!paramBoolean)
    {
  ...
  private void a(SosoInterface.SosoLbsInfo paramSosoLbsInfo, String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_Ajfp.a(this.jdField_a_of_type_JavaLangString, paramString1, localGPS, paramSosoLbsInfo);
  }
  ...
  private void a(boolean paramBoolean1, String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, int paramInt3, int paramInt4, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (TextUtils.equals(this.jdField_a_of_type_JavaLangString, paramString1)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
      if (paramInt2 == 2) {
        if (this.jdField_a_of_type_Ajfy != null) {
          this.jdField_a_of_type_Ajfy.f();
        }
      }
    }
    while (this.jdField_a_of_type_Ajfy == null)
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              this.jdField_a_of_type_Ajfy.b(paramString3);
              return;
              switch (paramInt1)
              {
              default: 
              ...
              case 0: 
                ...
                if (this.jdField_a_of_type_Ajfy != null)
                {
                  this.jdField_a_of_type_Ajfy.a(this.b);
                  this.jdField_a_of_type_Ajfy.b(this.jdField_a_of_type_Int);
                }
                c();
                return;
              }
            } while (this.jdField_a_of_type_Ajfy == null);
            this.jdField_a_of_type_Ajfy.g();
            return;
          } while (this.jdField_a_of_type_Ajfy == null);
          this.jdField_a_of_type_Ajfy.c();
          return;
        } while (this.jdField_a_of_type_Ajfy == null);
        this.jdField_a_of_type_Ajfy.d();
        return;
      } while (this.jdField_a_of_type_Ajfy == null);
      this.jdField_a_of_type_Ajfy.e();
      return;
    }
    this.jdField_a_of_type_Ajfy.e();
  }
    ...
    do
    {
      do
      {
        ...
        if ((paramList != null) && (paramList.size() > 0)) {
          this.jdField_a_of_type_Ajfy.a(paramList);
        }
        this.jdField_a_of_type_Ajfy.b(this.jdField_a_of_type_Int);
        return;
      } while (this.jdField_a_of_type_Ajfy == null);
  ...
  public void a()
  {
    ...
    d();
    this.jdField_a_of_type_Ajfy = null;
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ajfq);
  ...
  public void a(List<String> paramList)
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_Ajfp.a(this.jdField_a_of_type_JavaLangString, paramList);
    }
  }
  ...
  public void b()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_Ajfp.a(this.jdField_a_of_type_JavaLangString);
