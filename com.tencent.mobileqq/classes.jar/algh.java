...
public class algh
{
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaLangString = (albw.a() + "ar_cloud_img/");
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, algi paramalgi)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[ScanStarFace]pretreatFaceRecogInfo,  FaceScanModelsLoader.hasFaceModelInit =  " + alco.b);
    }
    if (!alco.b)
    {
    ...
    algk localalgk = new algk();
    localalgk.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    ...
    if (alhe.a != null)
    {
      if (alhe.a.hasMessages(4))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[DEBUG_SCAN_yt_face] pretreatFaceRecogInfo, remove pending task");
        }
        alhe.a.removeMessages(4);
      }
      paramArrayOfByte = Message.obtain(alhe.a, new ARCloudPretreatmentManager.1(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
      paramArrayOfByte.what = 4;
      if (alhe.a != null) {
        alhe.a.sendMessage(paramArrayOfByte);
      }
    }
    for (;;)
    {
      ...
      {
        localalgk.jdField_a_of_type_ArrayOfComTencentYTFaceModelFaceStatus = paramARRecognition;
        axqw.b(null, "dc00898", "", "", "0X800834C", "0X800834C", 0, 0, "", "", "", "");
      }
      paramalgi.a(localalgk);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte, ARRecognition paramARRecognition, algi paramalgi)
  {
    paramArrayOfByte = new algu();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramalgi.a(paramArrayOfByte);
  }
  
  public void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList, algi paramalgi, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramArrayOfByte.hasNext())
    {
      ...
      if (l3 == 1L) {
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramalgi);
      }
      for (;;)
      {
        break;
        if (l3 == 2L)
        {
          b(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramalgi);
        }
        else if (l3 == 4L)
        {
          l1 = System.currentTimeMillis();
          a(this.jdField_a_of_type_ArrayOfByte, j, i, paramArrayList, paramalgi);
          l1 = System.currentTimeMillis() - l1;
        }
        else if (l3 == 64L)
        {
          d(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramalgi);
        }
        else if (l3 == 128L)
        {
          c(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramalgi);
        }
        else if (l3 == 2048L)
        {
          e(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramalgi);
        }
      }
    }
    paramArrayList = new YuvImage(this.jdField_a_of_type_ArrayOfByte, paramInt3, j, i, null);
    paramArrayOfByte = a();
    paramArrayOfByte = new algj(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte);
    ...
    alhb localalhb = alhb.a();
    localalhb.c = l1;
    localalhb.b = l2;
    l1 = paramArrayOfByte.jdField_a_of_type_ArrayOfByte.length / 8192;
    paramalgi.a(jdField_a_of_type_Int, paramArrayList, l1);
  }
  ...
  public void b(byte[] paramArrayOfByte, ARRecognition paramARRecognition, algi paramalgi)
  {
    paramArrayOfByte = new algl();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramalgi.a(paramArrayOfByte);
  }
  
  public void c(byte[] paramArrayOfByte, ARRecognition paramARRecognition, algi paramalgi)
  {
    paramArrayOfByte = new algl();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramalgi.b(paramArrayOfByte);
  }
  
  public void d(byte[] paramArrayOfByte, ARRecognition paramARRecognition, algi paramalgi)
  {
    paramArrayOfByte = new algm();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramalgi.a(paramArrayOfByte);
  }
  
  public void e(byte[] paramArrayOfByte, ARRecognition paramARRecognition, algi paramalgi)
  {
    paramArrayOfByte = new algn();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramalgi.a(paramArrayOfByte);
  }
}
