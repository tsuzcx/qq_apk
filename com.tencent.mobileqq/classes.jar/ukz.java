  ...
  extends uku<ulm>
{
  ...
  private uju a()
  {
    return new uju(new uny(), null, new ula(this), 1001);
  }
  ...
  private void a(Context paramContext, stRedDotMenu paramstRedDotMenu, String paramString, int paramInt1, int paramInt2)
  {
    if ((paramstRedDotMenu != null) && (paramstRedDotMenu.schema != null))
    {
      ...
      {
        uee.a(paramContext, paramstRedDotMenu.H5Url);
        return;
      }
      upe.d("WSHomeFragmentPresenter", "jumOtherPlatform other type：" + paramstRedDotMenu.type);
      a(paramContext, paramString, "", "", paramInt1);
      return;
    }
    upe.d("WSHomeFragmentPresenter", "jumOtherPlatform messageMenu is null");
    a(paramContext, paramString, "", "", paramInt1);
  }
  
  private void a(Context paramContext, String paramString)
  {
    uee.a(paramContext, paramString, new ulb(this));
  }
  
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ups.a(paramContext, paramString1, paramString2, paramString3, a(), new ulc(this, paramContext, paramInt));
  }
  ...
  public void a(Context paramContext, stPublisherRsp paramstPublisherRsp)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130841680);
    new udf().a(localURLImageView, paramContext, paramstPublisherRsp.guide.imageUrl, true);
  }
  ...
  public void d()
  {
    uju localuju = new uju(new unq(), null, new uld(this), 4008);
    ujn.a().a(localuju);
  }
}
