  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  public bfev(@NonNull Context paramContext)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131370598));
    this.b = ((TextView)paramContext.findViewById(2131370599));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131370600));
  ...
  {
    this.jdField_a_of_type_Bfex = parambfex;
  }
    ...
    if (paramArrayOfString != null)
    {
      ...
      if (i < paramArrayOfString.length)
      {
        ...
        for (Object localObject = new MiniNumberPicker(getContext());; localObject = new NumberPicker(getContext()))
        {
          ...
          ((NumberPicker)localObject).setOnValueChangedListener(new bfew(this, i));
  ...
  public void onCancel(DialogInterface paramDialogInterface)
  {
    if (this.jdField_a_of_type_Bfex != null) {
      this.jdField_a_of_type_Bfex.onValCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bfex != null) {
      this.jdField_a_of_type_Bfex.onValConfirm(this.jdField_a_of_type_ArrayOfInt);
    }
    a();
  }
}
