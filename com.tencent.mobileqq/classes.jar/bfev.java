...
public class bfev
{
  protected static ConcurrentHashMap<String, bfev> a;
  protected volatile long a;
  protected ServiceConnection a;
  private bfeo jdField_a_of_type_Bfeo;
  public volatile bfer a;
  protected Object a;
  ...
  public bfev(String paramString1, String paramString2)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
    this.jdField_a_of_type_Long = -1L;
    this.jdField_a_of_type_AndroidContentServiceConnection = new bfew(this);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.b = paramString2;
  }
  
  public static bfev a(String paramString)
  {
    try
    {
      if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString) == null) {
        jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, new bfev(null, paramString));
      }
      paramString = (bfev)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      return paramString;
    }
    finally {}
  }
  ...
  public void a(SendMsg paramSendMsg)
  {
    ...
    this.jdField_a_of_type_Bfer.a(paramSendMsg);
  }
  ...
  public void a(SendMsg paramSendMsg, RecvMsg paramRecvMsg)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Bfeo.a(paramRecvMsg);
        return;
      }
    }
  ...
  protected boolean a()
  {
    return this.jdField_a_of_type_Bfer != null;
  }
  ...
  public void b(SendMsg paramSendMsg)
  {
    ...
    {
      if (this.jdField_a_of_type_Bfer == null)
      {
        c(paramSendMsg);
        return;
      }
  ...
  void c()
  {
    try
    {
      ...
      localbfdi.d = ajjy.a(2131647602);
      localbfdi.jdField_a_of_type_JavaLangString = this.b;
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {}
      for (localbfdi.e = "com.tencent.plugin.qappcenter.remote.RemoteService";; localbfdi.e = this.jdField_a_of_type_JavaLangString)
      {
        localbfdi.jdField_a_of_type_AndroidContentIntent = localIntent;
        localbfdi.jdField_a_of_type_AndroidContentServiceConnection = this.jdField_a_of_type_AndroidContentServiceConnection;
