...
public class yhd
{
  ...
  public yhd(qqstory_710_message.StoryMessage paramStoryMessage)
  {
    ...
    for (;;)
    {
      if (paramStoryMessage.video_info.has())
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) {
          this.jdField_a_of_type_Wqw = wqw.a(this.jdField_g_of_type_JavaLangString);
        }
        if (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString)) {
          this.jdField_a_of_type_Wqv = wqv.a(this.jdField_h_of_type_JavaLangString);
        }
      }
      ...
      if (paramStoryMessage.share_info.has())
      {
        ...
        for (bool1 = bool9;; bool1 = false)
        {
          ...
          this.jdField_e_of_type_JavaLangString = wjz.a(2131698511, new Object[] { this.k });
          break label1020;
          this.jdField_a_of_type_Int = 7;
          this.l = ((qqstory_710_message.ShareGroupInfo)localObject).share_new_name.get().toStringUtf8();
          this.jdField_e_of_type_JavaLangString = wjz.a(2131698512, new Object[] { this.l });
          break label1020;
          this.jdField_a_of_type_Int = 8;
          break label1020;
          this.jdField_a_of_type_Int = 9;
          this.jdField_e_of_type_JavaLangString = wjz.a(2131698517, new Object[] { this.k });
          break label1020;
          this.jdField_a_of_type_Int = 11;
          this.jdField_e_of_type_JavaLangString = anni.a(2131705346);
          break label1020;
        }
      }
  ...
  {
    if (this.t == null) {
      this.t = ykw.a(this.jdField_a_of_type_Long);
    }
    return this.t;
  }
