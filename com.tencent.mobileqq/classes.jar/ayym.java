  ...
  extends zhu
{
  ...
  private static ConcurrentHashMap<String, beal> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static void a(beal parambeal, String paramString)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, parambeal);
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    else
    {
      ...
      if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(beal.a(paramToServiceMsg)))
      {
        paramToServiceMsg = ((beal)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(beal.a(paramToServiceMsg))).a(paramToServiceMsg, paramFromServiceMsg, localUniPacket);
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    } while (!jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(beal.a(paramToServiceMsg)));
    Object localObject = (beal)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(beal.a(paramToServiceMsg));
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((beal)localObject).a(paramToServiceMsg, paramUniPacket, i);
    return true;
  }
