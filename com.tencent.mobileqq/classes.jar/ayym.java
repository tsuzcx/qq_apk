...
public class ayym
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, aywl paramaywl, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramaywl == null) || (paramaywl.b)) {
          break label519;
        }
        paramaywl.b = true;
        if ((paramInt == 1) && (paramaywl.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramaywl, paramInt);
        paramaywl = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramaywl)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramaywl.toString() + ",filePath:" + paramString2);
        paramaywl = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramaywl = (aywl)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramaywl);
      if (QLog.isColorLevel())
      {
        if (paramaywl != null) {
          continue;
