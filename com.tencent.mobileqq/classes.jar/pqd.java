import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJMsgReport.addMessageNumToR5.1;
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJMsgReport.addMessageReportToR5.1;
...
public final class pqd
{
  ...
  {
    return a(paramString, (Function1)new RIJMsgReport.addMessageReportToR5.1((pqd)this));
  }
  ...
  public final void a()
  {
    ...
    if (localObject != null) {
      jdField_a_of_type_Int = ((KandianMergeManager)localObject).f();
    }
  }
  ...
  {
    return a(paramString, (Function1)new RIJMsgReport.addMessageNumToR5.1((pqd)this));
  }
