  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  private ausb jdField_a_of_type_Ausb;
  private bhhv jdField_a_of_type_Bhhv;
  bhhx jdField_a_of_type_Bhhx = new aurt(this);
  ...
  public aurs(@NonNull Context paramContext)
  {
  ...
  {
    Object localObject = new aurz(this);
    ...
    if ((paramContext instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(getContext(), 2131559158, null));
  ...
  public aurs a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new ausa(this, paramOnClickListener));
    return this;
  }
  ...
  public void a()
  {
    ...
    if ((localObject != null) && ((localObject instanceof Integer)) && (((Integer)localObject).intValue() == 2130840192))
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840191);
      this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130840191));
      b();
  ...
  public void a(ausb paramausb)
  {
    this.jdField_a_of_type_Ausb = paramausb;
  }
  ...
  public aurs b(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
    ...
    this.rBtn.setOnClickListener(new auru(this, paramOnClickListener));
    return this;
  }
  ...
  public void b(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aury(this, paramInt));
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130840192));
        this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setMinimumHeight(bhhv.a(0));
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout = ((MaxHeightRelativelayout)findViewById(2131376803));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380385));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131368909));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131366054));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131368921));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new aurv(this));
    Object localObject = (Context)this.jdField_a_of_type_JavaLangRefSoftReference.get();
    if (localObject == null) {
      return;
    }
    abty.a((Context)localObject, this.jdField_a_of_type_AndroidWidgetEditText);
    this.jdField_a_of_type_Bhhv = new bhhv(((ViewGroup)getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Bhhx);
    this.b = this.jdField_a_of_type_Bhhv.a();
    this.b = bhhv.a(this.b);
    setOnDismissListener(this);
    a((Context)localObject);
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new aurw(this));
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131377132);
    if ((localObject instanceof ScrollView)) {
      this.jdField_a_of_type_AndroidWidgetScrollView = ((ScrollView)localObject);
    }
    this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new aurx(this));
  }
}
