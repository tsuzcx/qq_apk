...
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new avpc(this);
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            xho.a(localActivity, new VidListPlayInfo(paramJsBridgeListener, paramString3, paramString2, paramString1), 105, null);
            break;
          }
