  ...
  implements IMediaPlayer
{
  ...
  private bftv jdField_a_of_type_Bftv = new bftm(this);
  ...
  private void e()
  {
    wsv.b("DefaultMediaPlayer", "onVideoPlayEnded");
  ...
  private void f()
  {
    wsv.b("DefaultMediaPlayer", "onVideoPlayRepeated");
  ...
  {
    boolean bool2 = true;
    bftn.a(hashCode(), "[Player] handle play cmd from qg");
    wsv.a("DefaultMediaPlayer", "handleStartPlay , src = %s", this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder = new MediaDecoder(this.jdField_a_of_type_JavaLangString, this.jdField_d_of_type_Int, this.jdField_a_of_type_Bftv, false, hashCode());
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.jdField_d_of_type_Boolean = false;
      this.g = 0;
      bftn.a(hashCode(), "[Player] handle play cmd from qg finish");
      return;
      bool1 = false;
      break;
    }
  ...
  private void h()
  {
    wsv.a("DefaultMediaPlayer", "handleResumePlay , src = %s", this.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    ...
    if (this.g == 1)
    {
      ...
      bftn.a(hashCode(), "[Player] render first frame to qg");
    }
  }
  
  public void a()
  {
    wsv.b("DefaultMediaPlayer", "onResume");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.d();
    }
  }
  ...
  public void b()
  {
    wsv.b("DefaultMediaPlayer", "onPause");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
  ...
  public void c()
  {
    wsv.b("DefaultMediaPlayer", "onStop");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.b();
    }
  }
  ...
  {
    wsv.b("DefaultMediaPlayer", "qg -> create");
  ...
  public void destroy()
  {
    wsv.b("DefaultMediaPlayer", "qg -> destroy");
    c();
    if (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer != null) {
  ...
  {
    return (int)uku.a(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void pause()
  {
    wsv.b("DefaultMediaPlayer", "qg -> pause");
    b();
  }
  
  public void play(int paramInt1, int paramInt2, int paramInt3)
  {
    wsv.a("DefaultMediaPlayer", "qg -> play , texture id = %d , width = %d , height = %d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3));
    bftn.a(hashCode(), "[Player] receive play cmd from qg");
  ...
  public void setSrc(String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      wsv.a("DefaultMediaPlayer", "qg -> set Src , src = %s , isSrcChanged :%s", str, Boolean.valueOf(this.jdField_c_of_type_Boolean));
      return;
    }
  }
  ...
  {
    wsv.b("DefaultMediaPlayer", "qg -> setVolume , not support yet");
  }
  
  public void stop()
  {
    wsv.b("DefaultMediaPlayer", "qg -> stop");
    c();
  }
}
