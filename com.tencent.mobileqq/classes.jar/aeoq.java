...
public class aeoq
  extends amgy
{
  private List<aeon> jdField_a_of_type_JavaUtilList;
  
  public aeoq(List<aeon> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559666, paramViewGroup, false);
      paramView = new aeot();
      ...
      if (localObject != null)
      {
        localObject = (aeon)localObject;
        if (localObject != null)
        {
          paramView.jdField_a_of_type_JavaLangString = ((aeon)localObject).a.getUin();
          paramView.jdField_a_of_type_Aeon = ((aeon)localObject);
          paramView.c.setImageBitmap(super.a(paramView.jdField_a_of_type_JavaLangString, 1, (byte)0));
          paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((aeon)localObject).a.name);
          if (((aeon)localObject).a.certifiedGrade <= 0L) {
            break label284;
          }
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (aeot)paramView.getTag();
      localView = paramView;
