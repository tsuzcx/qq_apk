  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  aouf jdField_a_of_type_Aouf;
  aouk jdField_a_of_type_Aouk = new aouk();
  private hj jdField_a_of_type_Hj = new hj();
  ...
  private aoum[] jdField_a_of_type_ArrayOfAoum = new aoum[300];
  ...
  public aoul(aoua paramaoua)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Aoua = paramaoua;
    this.jdField_a_of_type_Aouf = paramaoua.a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Aouk.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844879, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Aoua.a().getResources(), 2130844880, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Aouf.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Aouf.c = 0L;
    this.jdField_a_of_type_Aouf.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Aouk != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Aouk.a(paramSize.getHeight(), paramSize.getWidth(), apew.jdField_a_of_type_Int, apew.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localaoum2 = this.jdField_a_of_type_ArrayOfAoum[i4];
      if ((localaoum2 != null) && (!localaoum2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localaoum2.jdField_b_of_type_Float * 0.35F - Math.abs(localaoum2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localaoum2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localaoum2 != null)
        {
          localaoum1 = localaoum2;
          i3 = i2;
          if (!localaoum2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localaoum2.jdField_b_of_type_Float;
      localaoum2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localaoum2.jdField_b_of_type_Float + f2 + f4);
      if (localaoum2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localaoum2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localaoum2 == null)
      {
        localaoum1 = new aoum(this);
        this.jdField_a_of_type_ArrayOfAoum[i4] = localaoum1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localaoum1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localaoum1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localaoum1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localaoum1 == null) || (localaoum1.jdField_a_of_type_Boolean) || (localaoum1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAoum[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAoum[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localaoum1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        a(this.jdField_a_of_type_ArrayOfFloat, this.jdField_a_of_type_Hj.a(), this.jdField_a_of_type_Hj.d(), this.jdField_a_of_type_Hj.b(), paramGL10, this.jdField_a_of_type_Hj.b(), this.jdField_a_of_type_Hj.c());
        a(0, this.jdField_a_of_type_Hj.a());
        d();
        e();
        f();
      ...
      if (this.jdField_a_of_type_Aouf.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Aouf.c > this.jdField_a_of_type_Aouf.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Aouf;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Aouk != null) && (this.u == 2)) {
        this.jdField_a_of_type_Aouk.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
