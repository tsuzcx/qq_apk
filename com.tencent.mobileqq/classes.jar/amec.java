...
public class amec
  implements alqx, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Handler.Callback, View.OnClickListener, TouchWebView.OnScrollChangedListener
{
  public float a;
  int jdField_a_of_type_Int = 1;
  private alqv jdField_a_of_type_Alqv;
  private ameg jdField_a_of_type_Ameg;
  private ameh jdField_a_of_type_Ameh;
  private amel jdField_a_of_type_Amel;
  ...
  public amec(RelativeLayout paramRelativeLayout, amel paramamel)
  {
    this.jdField_a_of_type_Amel = paramamel;
    ...
    paramamel = new RelativeLayout.LayoutParams(100, 100);
    this.jdField_a_of_type_Alqv = new amed(this);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_a_of_type_Alqv);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramamel);
    this.jdField_e_of_type_Float = (FontSettingManager.getFontLevel() / 16.0F);
    if (this.jdField_e_of_type_Float != 0.0F) {
      this.jdField_d_of_type_Float = (DeviceInfoUtil.getDesity() / this.jdField_e_of_type_Float);
    }
    if (this.jdField_d_of_type_Float == 0.0F) {
      this.jdField_d_of_type_Float = DeviceInfoUtil.getDesity();
    }
    ...
    this.jdField_a_of_type_Ameh = new ameh();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(paramRelativeLayout);
    paramamel = new ImageView(paramRelativeLayout);
    paramamel.setImageResource(2130839445);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13, -1);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(paramamel, localLayoutParams);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130838647);
  ...
  private String b(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!amge.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), amtj.a(2131699725), 0).a();
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if ((paramApolloWebAvatarParam.tapRectWidth > 0) && (paramApolloWebAvatarParam.tapRectHeight > 0))
        {
          ...
          this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(23, 500L);
          ...
          ((RelativeLayout.LayoutParams)???).topMargin = ((int)(paramApolloWebAvatarParam.y * this.jdField_d_of_type_Float - (float)DeviceInfoUtil.getPortraitHeight() * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate));
          ((RelativeLayout.LayoutParams)???).rightMargin = ((int)((float)DeviceInfoUtil.getPortraitWidth() - this.jdField_d_of_type_Float * paramApolloWebAvatarParam.x - ((RelativeLayout.LayoutParams)???).width - ApolloUtil.a(68.0F, this.jdField_d_of_type_Float) * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F));
          ...
          this.jdField_a_of_type_Bjng.sendMessage(paramApolloWebAvatarParam);
  ...
  private void e()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) {
          if (this.jdField_i_of_type_Int == 0) {
            try
            {
              ...
              if (FileUtils.fileExists(str))
              {
                ...
                if ((this.jdField_a_of_type_AndroidMediaAudioManager != null) && (this.jdField_a_of_type_AndroidMediaAudioManager.getRingerMode() == 1))
                {
                  ...
                  try
                  {
                    bftt.a(BaseApplicationImpl.getContext(), true);
            ...
            for (;;)
            {
              if (!new File(amdp.b(this.jdField_i_of_type_Int)).exists()) {
                break label395;
              }
              this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(24, (int)(this.jdField_f_of_type_Float * 1000.0F));
              return;
              k = 0;
              break;
              m = 0;
      ...
      if ((!TextUtils.isEmpty(amgf.a().jdField_a_of_type_JavaLangString)) && ("interactive".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)))
      {
        this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(24, 0L);
        return;
      }
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if ((!amdp.a(this.jdField_c_of_type_Int)) || (m != 0) || (k != 0) || (n == 0)) {
        break;
      }
      try
      {
        bftt.a(BaseApplicationImpl.getContext(), true);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(amip.jdField_d_of_type_JavaLangString + this.jdField_c_of_type_Int + "/" + "music.amr");
  ...
  private void f()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bjng != null) {
        this.jdField_a_of_type_Bjng.removeMessages(24);
      }
      return;
    }
  ...
  public String a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null))
    {
      ...
      String[] arrayOfString = amge.a(10, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
      if ((arrayOfString.length > 0) && (!TextUtils.isEmpty(arrayOfString[0])) && (arrayOfString[0].length() - "action".length() > 0)) {}
      amgf.a().jdField_a_of_type_JavaLangString = arrayOfString[0].substring(0, arrayOfString[0].length() - "action".length());
    ...
    this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(22, 100L);
    return a(amtj.a(2131699713));
  }
  ...
  public String a(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!amge.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), amtj.a(2131699712), 0).a();
      return a("dresses is not download!");
    }
    if ((!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) && (!this.jdField_e_of_type_JavaLangString.equals(paramApolloWebAvatarParam.tab)))
    {
      ...
      this.jdField_a_of_type_Bjng.postDelayed(new ApolloViewController.2(this, paramInt, paramBoolean, paramApolloWebAvatarParam), 100L);
    }
    for (;;)
    {
      return b("initAvatar成功");
  ...
  public String a(ameg paramameg)
  {
    if (this.j)
    {
      QLog.e("ApolloViewController", 1, "previewAction 小人已隐藏");
      return a(amtj.a(2131699718));
    }
    if (paramameg == null) {
      return a("actionData is null");
    }
    if (paramameg.jdField_a_of_type_Int > 1) {}
    for (this.jdField_a_of_type_Ameg = paramameg; (paramameg.jdField_c_of_type_Int == 1) && (!TextUtils.isEmpty(paramameg.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramameg.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)); this.jdField_a_of_type_Ameg = null) {
      return a(amtj.a(2131699723));
    }
    if ((TextUtils.isEmpty(paramameg.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
      paramameg.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId;
    }
    if (TextUtils.isEmpty(paramameg.jdField_b_of_type_JavaLangString)) {
      return a("未传apolloId");
    }
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramameg.jdField_b_of_type_JavaLangString)) {
      return a(amtj.a(2131699721));
    }
    Object localObject1 = (ApolloWebAvatarParam)this.jdField_a_of_type_JavaUtilHashMap.get(paramameg.jdField_b_of_type_JavaLangString);
    if (localObject1 == null) {
      return a(amtj.a(2131699707));
    }
    int m = 0;
    int k = m;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
    {
      k = m;
      if (paramameg.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)) {
        k = 1;
      }
    }
    if ((k != 0) && (!amge.a(((ApolloWebAvatarParam)localObject1).uin, ((ApolloWebAvatarParam)localObject1).roleId, ((ApolloWebAvatarParam)localObject1).dressIds, null)))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), amtj.a(2131699708), 0).a();
      return a(amtj.a(2131699719));
    }
    if (!ApolloUtil.a(paramameg.jdField_b_of_type_Int, paramameg.jdField_c_of_type_Int))
    {
      if (k != 0) {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), amtj.a(2131699726), 0).a();
      }
      return a(amtj.a(2131699709));
    }
    ...
    {
      if (k != 0) {
        QQToast.a(BaseApplicationImpl.getContext(), amtj.a(2131699724), 0).a();
      }
      return a(amtj.a(2131699714));
    }
    if (k != 0) {
      f();
    }
    this.jdField_i_of_type_Int = paramameg.m;
    this.jdField_f_of_type_Float = paramameg.jdField_a_of_type_Float;
    boolean bool;
    label556:
    label616:
    float f1;
    ...
    if (paramameg.l == 0)
    {
      ...
      this.jdField_h_of_type_Boolean = paramameg.jdField_a_of_type_Boolean;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (paramameg.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId))) {
        this.jdField_c_of_type_Int = paramameg.jdField_b_of_type_Int;
      }
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
      this.jdField_a_of_type_Bjng.removeMessages(16);
      this.jdField_f_of_type_Int = paramameg.jdField_i_of_type_Int;
      this.jdField_d_of_type_JavaLangString = paramameg.jdField_a_of_type_JavaLangString;
      this.jdField_g_of_type_Int = paramameg.k;
      if (paramameg.j != 1) {
        break label1141;
      }
      bool = true;
      this.jdField_f_of_type_Boolean = bool;
      if ((!paramameg.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Ameh != null)) {
        this.jdField_a_of_type_Ameh.a();
      }
      if ((!TextUtils.isEmpty(paramameg.jdField_a_of_type_JavaLangString)) && (!paramameg.jdField_a_of_type_Boolean)) {
        break label1147;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView.setVisibility(8);
      }
      if (paramameg.jdField_d_of_type_Int != 0) {
        break label1518;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.setVisibility(0);
      ...
      if (this.jdField_a_of_type_Int != paramameg.jdField_c_of_type_Int)
      {
        ...
        if (paramameg.jdField_c_of_type_Int != 1) {
          break label1218;
        }
        if (ApolloUtil.d(this.jdField_f_of_type_Int))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, amdp.a(this.jdField_f_of_type_Int), null);
      ...
      if (!paramameg.jdField_a_of_type_Boolean) {
        break label1277;
      }
      this.jdField_a_of_type_Ameh.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramameg.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, paramameg.jdField_c_of_type_Int);
      this.jdField_a_of_type_Ameh.a(paramameg.jdField_b_of_type_Float);
      this.jdField_a_of_type_Int = paramameg.jdField_c_of_type_Int;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      if (TextUtils.isEmpty(paramameg.jdField_a_of_type_JavaLangString)) {
        break label1496;
      }
      if (paramameg.k != 1) {
        break label1453;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null)
      {
        ...
        n = (int)((float)DeviceInfoUtil.getPortraitHeight() * ((ApolloWebAvatarParam)localObject1).rate * 1.14F);
        ...
        label1086:
        if (!paramameg.jdField_a_of_type_Boolean) {
          alrv.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), n, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", paramameg.jdField_a_of_type_JavaLangString, true);
        }
      }
    }
    for (;;)
    {
      ...
      localObject2 = amge.a(13, paramameg.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, true);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, ((ApolloWebAvatarParam)localObject1).apolloId, paramameg.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      if (paramameg.jdField_c_of_type_Int != 1) {
        break label890;
      }
      localObject2 = amge.a(13, paramameg.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, false);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, paramameg.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      break label890;
      label1384:
      ...
      break label1086;
      label1453:
      amgf.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(8);
    ...
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView == null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(new amee(this, (DisplayMetrics)localObject1, paramameg));
      if (this.jdField_b_of_type_Alqv == null) {
        this.jdField_b_of_type_Alqv = new amef(this);
      }
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_b_of_type_Alqv);
      label1745:
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.stopLoopDelayed(50L);
      this.jdField_a_of_type_Bjng.removeMessages(15);
      localObject2 = this.jdField_b_of_type_AndroidWidgetTextView;
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        break label1995;
      }
      localObject1 = amtj.a(2131699727);
      label1800:
      ...
      label1836:
      if ((paramameg.jdField_h_of_type_Int != 1) && (paramameg.jdField_e_of_type_Int > 0)) {
        break label2016;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(paramameg.jdField_b_of_type_Int));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(Integer.valueOf(paramameg.jdField_b_of_type_Int));
      break;
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Bjng.obtainMessage(19, paramameg.jdField_c_of_type_Int, paramameg.jdField_b_of_type_Int);
      if (paramameg.jdField_a_of_type_Boolean) {
        ((Message)localObject1).obj = Float.valueOf(paramameg.jdField_b_of_type_Float);
      }
      this.jdField_a_of_type_Bjng.sendMessageDelayed((Message)localObject1, 100L);
      break label1745;
      label1995:
      ...
      if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getString(2131690041));
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ApolloUtil.a(this.jdField_b_of_type_AndroidWidgetImageView, paramameg.jdField_e_of_type_Int);
      if (!bool) {
  ...
  public String a(ArrayList<ApolloWebAvatarParam> paramArrayList)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (!amge.a(localApolloWebAvatarParam.uin, localApolloWebAvatarParam.roleId, localApolloWebAvatarParam.dressIds, null))
      {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), amtj.a(2131699710), 0).a();
        return a("dresses is not download!");
      }
    }
  ...
  public String a(int[] paramArrayOfInt)
  {
    if (this.j)
    {
      ...
      return a(amtj.a(2131699720));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam == null) {
      return a(amtj.a(2131699711));
    }
    if (!amge.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.uin, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, paramArrayOfInt, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), amtj.a(2131699728), 0).a();
      return a(amtj.a(2131699717));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getColor(2131166923));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(4);
      Object localObject1 = new RelativeLayout.LayoutParams(-2, (int)((float)DeviceInfoUtil.getPortraitHeight() * 0.6F));
      ((RelativeLayout.LayoutParams)localObject1).addRule(13, -1);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      Object localObject2 = LayoutInflater.from(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext()).inflate(2131558690, null);
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject2).findViewById(2131364104));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((View)localObject2).findViewById(2131362806));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362734));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362733));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131362731));
      ...
      ((ImageView)localObject1).setId(2131362762);
      ...
      ((ImageView)localObject1).setBackgroundResource(2130838480);
  ...
  {
    this.jdField_a_of_type_Bjng.removeMessages(23);
    this.jdField_b_of_type_Int = paramInt;
    if (this.jdField_g_of_type_Boolean)
    {
      this.jdField_a_of_type_Bjng.removeMessages(16);
      this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(16, 3000L);
    }
    label218:
    label250:
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
      {
        if ("mall".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)) {
          ...
          {
            this.jdField_a_of_type_JavaLangString = amtj.a(2131699730);
            if (this.jdField_h_of_type_Int == 1) {
              this.jdField_a_of_type_JavaLangString = amdp.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId);
            }
        ...
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_JavaLangString = amtj.a(2131699715);
            break;
          }
  ...
  public void a(alqx paramalqx)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramalqx);
  }
  
  public void a(Activity paramActivity, AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    c(false);
    this.jdField_a_of_type_Bjng.postDelayed(new ApolloViewController.3(this, paramActivity, paramAppInterface, paramString1, paramString2), 500L);
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_Bjng.obtainMessage(18).sendToTarget();
      return;
      label79:
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    case 27: 
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_AndroidMediaAudioManager != null) && (this.jdField_a_of_type_AndroidMediaAudioManager.getRingerMode() == 1))
              {
                ...
                n = 1;
                if ((!new File(amdp.b(this.jdField_i_of_type_Int)).exists()) || (m != 0) || (k != 0) || (n == 0)) {}
              }
              try
              {
                bftt.a(BaseApplicationImpl.getContext(), true);
                this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(amdp.b(this.jdField_i_of_type_Int));
                this.jdField_a_of_type_AndroidMediaMediaPlayer.prepare();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.start();
                if (!TextUtils.isEmpty(amgf.a().jdField_a_of_type_JavaLangString))
                {
                  ??? = amgf.a().jdField_a_of_type_JavaLangString;
                  if (???.startsWith("def"))
                  {
                    ??? = amip.jdField_c_of_type_JavaLangString + "/" + ???;
                    amgf.a().jdField_a_of_type_JavaLangString = "";
                    ??? = ApolloUtil.a(???, "amr");
                    if (??? == null) {}
                  }
              ...
              catch (Throwable ???)
              {
                try
                {
                  ...
                  ??? = amip.jdField_a_of_type_JavaLangString + "/" + ???;
                }
                catch (IOException ???)
                {
                  for (;;)
          ...
          ??? = amge.a(4, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_Int != 0))
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, amdp.a, null);
          }
        }
        for (;;)
        {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            ...
            if ((???.arg1 > 0) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_f_of_type_Boolean) && (this.jdField_g_of_type_Int == 0))
            {
              ...
              this.jdField_b_of_type_Boolean = false;
              if (this.jdField_a_of_type_Amel != null) {
                this.jdField_a_of_type_Amel.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
              }
              a(false);
              ...
              this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(21, 100L);
              return false;
              if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
              {
              ...
              for (;;)
              {
                synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                {
                  for (;;)
                  {
                    ...
                    {
                      ???.a(1, localApolloWebAvatarParam.apolloId, amdp.a, null);
                      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                      {
      ...
      if (!TextUtils.isEmpty((CharSequence)???))
      {
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(???))
            {
              ...
              if (localApolloWebAvatarParam != null)
              {
                ...
                if (??? != null)
                {
                  ...
                  ((alpf)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtil.a(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                  if (localApolloWebAvatarParam.roleId != 0) {
                    break label1995;
                  }
                  ((alpf)???).a(1, localApolloWebAvatarParam.apolloId, amdp.a, null);
                }
              }
            }
            ...
            ((alpf)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.dressIds, null);
          }
        }
    ...
    case 19: 
      ...
      {
        f2 = 77.0F;
        f4 = (float)(Math.max(DeviceInfoUtil.getDispalyHeight(), DeviceInfoUtil.getDispalyWidth()) / 7L) / 368.0F;
        ??? = ???.obj;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      {
        f1 = 330.0F * f4 / DeviceInfoUtil.density / 2.0F;
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, amdp.a(this.jdField_f_of_type_Int), null);
        ??? = amge.a(13, n, this.jdField_f_of_type_Int, false);
        if (k != 0)
        {
          this.jdField_a_of_type_Ameh.a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, m);
          this.jdField_a_of_type_Ameh.a(f3);
        }
      }
      for (;;)
      {
        ...
        ??? = amge.a(13, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
        ...
        for (;;)
        {
          if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
          {
            if (this.jdField_g_of_type_Int == 1)
            {
              ...
              k = (int)((float)(DeviceInfoUtil.getPortraitHeight() / 7L) * 1.14F);
              ...
              if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != ???)
              {
                ...
                ???.bottomMargin = (AIOUtils.dp2px(f2, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources()) + (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight() - this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight()) / 2);
              ...
              alrv.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getWidth(), k, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", this.jdField_d_of_type_JavaLangString, true);
              return true;
              f2 = 42.0F;
              break;
            ...
            amgf.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, "Bubble");
        return true;
        if ((this.jdField_a_of_type_Ameg == null) || (this.jdField_a_of_type_Ameg.jdField_a_of_type_Int <= 0)) {
          break;
        }
        ??? = this.jdField_a_of_type_Ameg;
        ???.jdField_a_of_type_Int -= 1;
        a(this.jdField_a_of_type_Ameg);
        return false;
        label2851:
        return true;
        f1 = 0.0F;
  ...
  {
    if (paramView.getId() == 2131362762)
    {
      this.jdField_a_of_type_Bjng.sendEmptyMessage(15);
      f();
    }
    for (;;)
    {
      ...
      {
        f();
        if ((this.jdField_a_of_type_Amel != null) && ((paramView.getTag() instanceof Integer))) {
          this.jdField_a_of_type_Amel.a(((Integer)paramView.getTag()).intValue());
        }
        this.jdField_a_of_type_Bjng.sendEmptyMessage(15);
      }
    }
  ...
  public void onNotifyLongTouch(String paramString)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((alqx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyLongTouch(paramString);
    }
  }
  ...
  public void onNotifyStatusChanged(int paramInt, String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((alqx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyStatusChanged(paramInt, paramString);
    }
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bjng.sendEmptyMessage(18);
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((alqx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onSurfaceReady(paramInt1, paramInt2);
    }
  }
}
