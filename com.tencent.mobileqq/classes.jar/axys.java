...
public class axys
  implements Handler.Callback, awei
{
  private static axys jdField_a_of_type_Axys;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  public int a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  public ConcurrentHashMap<String, avjt> a;
  ...
  public static axys a()
  {
    if (jdField_a_of_type_Axys == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Axys == null) {
        jdField_a_of_type_Axys = new axys();
      }
      return jdField_a_of_type_Axys;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView)
  {
    ...
    if ((!TextUtils.isEmpty(paramFriends.songName)) && (System.currentTimeMillis() < paramFriends.songEndTime))
    {
      ...
      {
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131697873), new Object[] { paramFriends.songName, paramFriends.singerName });
        if (!(paramTextView instanceof OnlineStatusLyricView)) {
          break label152;
        }
        ((axyt)bmqh.a().getBusinessHandler(174)).a(paramFriends);
        ((OnlineStatusLyricView)paramTextView).setFriendSession(paramFriends, paramQQAppInterface);
      }
      for (;;)
      {
        bcef.b(null, "dc00898", "", "", "0X800AC92", "0X800AC92", paramFriends.songSourceType, 0, "", "0", "0", "");
        return paramQQAppInterface;
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131697874), new Object[] { paramFriends.songName });
        break;
        label152:
        paramQQAppInterface = apph.a(paramTextView.getPaint(), paramQQAppInterface, ViewUtils.dip2px(200.0F));
      }
    }
    return paramQQAppInterface.getString(2131697875);
  }
  ...
  public void a(Activity paramActivity, String paramString)
  {
    ...
    bcef.b(null, "dc00898", "", "", "0X800ABB2", "0X800ABB2", 0, 0, "", "0", "0", "");
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      ((axyt)a().getBusinessHandler(174)).a(null);
      return false;
    case 2: 
      localaxyt = (axyt)a().getBusinessHandler(174);
      ...
      {
        localaxyt.a((MusicInfo)localObject, j, bool, QQMusicPlayService.a());
    ...
    axyt localaxyt = (axyt)a().getBusinessHandler(174);
    Object localObject = QQPlayerService.b();
    if (paramMessage.arg1 == 1) {}
    for (boolean bool = true;; bool = false)
    {
      localaxyt.a((SongInfo)localObject, i, bool, QQPlayerService.d());
