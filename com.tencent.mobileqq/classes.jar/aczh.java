...
public class aczh
  extends aczw
  implements alii, Handler.Callback
{
  private int jdField_a_of_type_Int;
  alig jdField_a_of_type_Alig;
  public Context a;
  ...
  private void a(LinkedHashMap<String, List<Object>> paramLinkedHashMap)
  {
    ...
    while (paramLinkedHashMap.hasNext()) {
      Collections.sort((List)paramLinkedHashMap.next(), new aczi(this));
    }
  }
    ...
    if (paramJSONObject != null)
    {
      ...
      if (bcvs.a(paramJSONObject))
      {
        ...
        while (paramJSONObject.hasNext())
        {
          ...
          String str = atbg.a(localTencentDocData.aioTime);
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Alig.notifyDataSetChanged();
      return;
  ...
  private void i()
  {
    ...
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aczj(this);
  }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aczk(this);
  }
  ...
  public void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_Alig = new alig(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this);
    this.jdField_a_of_type_Alig.a(this);
    this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560766, null);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370060));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131371852));
    this.jdField_a_of_type_ComTencentWidgetXListView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Alig);
    paramIntent = this.jdField_a_of_type_AndroidViewView.findViewById(2131366660);
    paramQQAppInterface = paramIntent.findViewById(2131373873);
  ...
  public void a(TencentDocData paramTencentDocData)
  {
    ...
    for (;;)
    {
      ...
      continue;
      bcvs.a(paramTencentDocData.docUrl, this.jdField_a_of_type_AndroidContentContext);
      aszr.a("0X8009A9F");
    }
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (b()) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.a(paramFileManagerEntity))
      {
        ...
        {
          aszk.a(aszt.d(paramFileManagerEntity.fileName) + amtj.a(2131700748));
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.b(paramFileManagerEntity);
        }
        this.jdField_a_of_type_Alig.notifyDataSetChanged();
      }
    ...
    aszr.a("0X8004AE4");
    localObject = new asub(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramFileManagerEntity, 10001);
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Asbj = new aczn(this);
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Alig.a(true);
    this.jdField_a_of_type_Alig.notifyDataSetChanged();
  }
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_Alig.a(false);
    this.jdField_a_of_type_Alig.notifyDataSetChanged();
  }
