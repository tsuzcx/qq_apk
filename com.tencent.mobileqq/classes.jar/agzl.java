  ...
  implements agzt
{
  ...
  public agzl(QQAppInterface paramQQAppInterface, ahap paramahap, Activity paramActivity, SessionInfo paramSessionInfo, aeqo paramaeqo)
  {
  ...
  {
    paramVarArgs = azaf.a(-1016);
    long l = ayzl.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691892), l, -1017, 3000, l);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = aozd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((aozd)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Aeqo.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
            ...
            if (!bdin.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            paramInt = mww.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          if (!this.jdField_a_of_type_Ahap.a(this, new Object[0])) {
            break label1201;
          }
          ((aozd)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2);
        ...
        for (;;)
        {
          try
          {
            azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
