...
public class bcpw
  extends amab
{
  public bcpw(TroopRecommendFriendFragment paramTroopRecommendFriendFragment) {}
  ...
  protected void a(boolean paramBoolean1, String paramString1, ArrayList<bcpp> paramArrayList, byte[] paramArrayOfByte, boolean paramBoolean2, String paramString2)
  {
    ...
    do
    {
      ...
      paramString1 = TroopRecommendFriendFragment.a(this.a).findViewById(2131372312);
      if (paramString1 != null) {
        paramString1.setVisibility(8);
      }
      paramString1 = (TextView)TroopRecommendFriendFragment.a(this.a).findViewById(2131379049);
