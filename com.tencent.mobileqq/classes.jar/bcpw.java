...
public class bcpw
  implements begw
{
  public bcpw(QidianProfileCardActivity paramQidianProfileCardActivity, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        if (this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Bcpn.d(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Atwx.a.jdField_a_of_type_JavaLangString)) {
