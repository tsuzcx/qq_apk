...
{
  private final bmtd jdField_a_of_type_Bmtd;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bmtc(bmtd parambmtd, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bmtd = parambmtd;
  ...
  private void b(bmsi parambmsi)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Bmtd.a(parambmsi.a(), true, false, false, str2);
                return;
              }
            } while (parambmsi.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Bmtd.a(parambmsi.a(), false, false, true, "");
              return;
            }
          } while (parambmsi.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Bmtd.a(parambmsi.a(), false, true, false, "");
            return;
          }
        } while (parambmsi.d());
        localObject = IOUtils.ensureFilePath(str4, parambmsi.a().b);
      } while (parambmsi.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Bmtd.a(parambmsi.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (parambmsi.d());
    this.jdField_a_of_type_Bmtd.a(parambmsi.a(), false, false, false, (String)localObject);
  }
  
  public void a(bmsi parambmsi)
  {
    if (parambmsi == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, parambmsi));
  }
