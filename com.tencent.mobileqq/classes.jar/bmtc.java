...
public class bmtc
  extends bmtb
  implements bmst, QGRenderer.QGEventListener
{
  private volatile int jdField_a_of_type_Int = 1;
  private aotv jdField_a_of_type_Aotv;
  private bjer jdField_a_of_type_Bjer = new bmtd(this);
  ...
  public bmtc(Context paramContext, ViewGroup paramViewGroup)
  {
    super(paramContext, paramViewGroup);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null) {
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369651));
    }
    b();
  }
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_b_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Bmtg == null) || (!bjes.b.get()))
    {
      QZLog.i("VipARQGThreeController", 1, "checkInValid mVipQGViewConfig = " + this.jdField_a_of_type_Bmtg + " so status = " + bjes.b.get());
      return true;
    }
    return false;
  }
  ...
  public void a(bmtg parambmtg)
  {
    this.jdField_a_of_type_Bmtg = parambmtg;
    if ((this.jdField_a_of_type_Bmtg != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bmtg.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.i("VipARQGThreeController", 2, " setVipQGViewConfig config = " + parambmtg.toString());
      }
      localObject = new aqul();
      ((aqul)localObject).b = parambmtg.jdField_a_of_type_JavaLangString;
      ((aqul)localObject).c = parambmtg.c;
      bmto.a().a((aqul)localObject, this);
      return;
    }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Bmtg != null) {
      this.jdField_a_of_type_Bmtg.b = paramString;
    }
    QZLog.i("VipARQGThreeController", 1, "qg resources load success path = " + paramString + " soStatus = " + bjes.b.get());
  }
  ...
  {
    QZLog.i("VipARQGThreeController", 1, "qg resources load fail error = " + paramString + " soStatus = " + bjes.b.get());
    if (this.jdField_a_of_type_Bmtg != null) {
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.getModuleEngine().unRegisterJsModule(this.jdField_a_of_type_Bmte);
      this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.b();
    }
    if (this.jdField_a_of_type_Aotv != null) {
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            return;
          } while ((this.jdField_a_of_type_Bmtg == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Bmtg.b)) || (this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView == null));
      ...
      } while (!this.jdField_a_of_type_Bmtg.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Int = 4;
      return;
    } while ((this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView == null) || (!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Aotv == null) || (paramGL10 == null));
    int i = this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.getCanvasTexture("offScreen");
    if (i != 0)
    {
      GLES20.glEnable(3042);
      GLES20.glBlendFunc(1, 771);
      this.jdField_a_of_type_Aotv.a(i, null, null);
      if (this.c)
      {
        bmti.a("ar_qg_show", "1");
        this.c = false;
  ...
  {
    if (this.jdField_a_of_type_Aotv != null) {
      this.jdField_a_of_type_Aotv.a(paramInt1, paramInt2);
    }
  }
  
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    this.jdField_a_of_type_Aotv = new aotv();
