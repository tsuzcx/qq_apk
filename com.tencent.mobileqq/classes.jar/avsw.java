...
public class avsw
  implements avsy, ark.ApplicationCallback
{
  private ArrayList<WeakReference<avth>> a = new ArrayList();
  
  private avth a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (i < this.a.size())
      {
        localavth = (avth)((WeakReference)this.a.get(i)).get();
        if ((localavth == null) || (!(localavth instanceof avtf))) {
          break label150;
        }
      }
      for (avtb localavtb = ((avtf)localavth).a();; localavtb = null)
      {
        if ((localavtb != null) && (localavtb.getContainer() == localContainer)) {
          break label154;
        }
        i += 1;
        break;
  ...
  public boolean CheckUrlLegalityCallback(ark.Application paramApplication, String paramString)
  {
    ...
    if (localArkAppUrlChecker != null)
    {
      ...
      if (j == 0)
      {
        ...
        QLog.e("ArkNodeContainer", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.EngineCallback seach appName=", paramApplication, ",url=", mpw.b(paramString, new String[0]), ", isValid set=true" });
        i = 2;
        bool = true;
        label97:
        alht.a(paramApplication, paramString, j, i, "");
      }
    }
    for (;;)
    {
      QLog.e("ArkNodeContainer", 1, new Object[] { "ArkSafe.EngineCallback search appName=", paramApplication, ",url=", mpw.b(paramString, new String[0]), ", isValid=", Boolean.valueOf(bool) });
      return bool;
      bool = false;
      break;
      label165:
  ...
  public void OutputScriptError(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        alep.a(null, paramString1, "ScriptError", 0, 0, 0L, 0L, 0L, paramString2, "");
        return;
      }
    }
  }
  ...
  {
    alan.a(paramModuleRegister, paramApplication);
    String str = paramApplication.GetSpecific("appName");
    avsx localavsx = new avsx(paramApplication, alan.a(str));
    localavsx.a(this);
    paramApplication = alan.a();
    ...
    {
      if (paramApplication != null) {
        localavsx.a((List)alck.a.get(localavsx.GetTypeName()));
      }
      paramModuleRegister.RegCallbackWrapper(localavsx);
      return;
    }
  }
  ...
  {
    avth localavth = a(paramLong);
    if ((localavth != null) && ((localavth instanceof avtf))) {
      ((avtf)localavth).a(paramString);
    }
  }
  ...
  public void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    avth localavth = a(paramLong);
    if ((localavth != null) && ((localavth instanceof avtf))) {
      ((avtf)localavth).a(paramString1, paramString2);
    }
  }
  ...
  public void a(avtf paramavtf)
  {
    ...
    while (localIterator.hasNext()) {
      if (((WeakReference)localIterator.next()).get() == paramavtf) {
        return;
      }
    }
    this.a.add(new WeakReference(paramavtf));
  }
  
  public void b(avtf paramavtf)
  {
    if (paramavtf == null) {}
    ...
    } while (localWeakReference.get() != paramavtf);
