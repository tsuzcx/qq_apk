...
public class adnb
  extends MqqHandler
{
  public adnb(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (AssociatedAccountManageActivity.a(this.a) == null) {
        AssociatedAccountManageActivity.a(this.a, new biau(this.a, this.a.getTitleBarHeight()));
      }
