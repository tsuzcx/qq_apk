...
public class aodr
{
  public static void a(QQAppInterface paramQQAppInterface, GetFriendListResp paramGetFriendListResp)
  {
    ...
    VasFaceManager localVasFaceManager = ((bgzk)paramQQAppInterface.getManager(235)).a;
    ...
    if ((paramGetFriendListResp.stSelfInfo != null) && (i == 0))
    {
      ...
      if (bool1)
      {
        ...
        paramGetFriendListResp = localanmw.e(paramQQAppInterface.getCurrentAccountUin());
        ...
        aysz.a(paramGetFriendListResp, localFriendInfo.vecMusicInfo, "GetFriendList(self)");
        aypu.a(paramGetFriendListResp, localFriendInfo.vecExtOnlineBusinessInfo, "GetFriendList(self)");
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      paramGetFriendListResp.qqVipInfo = FriendListHandler.a(localFriendInfo.oVipInfo, EVIPSPEC.E_SP_QQVIP.value(), paramGetFriendListResp.qqVipInfo);
      paramGetFriendListResp.superQqInfo = FriendListHandler.a(localFriendInfo.oVipInfo, EVIPSPEC.E_SP_SUPERQQ.value(), paramGetFriendListResp.superQqInfo);
      paramGetFriendListResp.superVipInfo = FriendListHandler.a(localFriendInfo.oVipInfo, EVIPSPEC.E_SP_SUPERVIP.value(), paramGetFriendListResp.superVipInfo);
      paramGetFriendListResp.bigClubInfo = FriendListHandler.a(localFriendInfo.oVipInfo, EVIPSPEC.E_SP_BIGCLUB.value(), paramGetFriendListResp.bigClubInfo);
      ...
      for (bool1 = bool2;; bool1 = false)
      {
        ...
        localanmw.a(paramGetFriendListResp);
  ...
  public static void a(QQAppInterface paramQQAppInterface, GetFriendListResp paramGetFriendListResp, long paramLong)
  {
    ...
    if (paramGetFriendListResp.vecGroupInfo != null)
    {
      ...
      if ((j > 0) && (QLog.isColorLevel()))
      {
        ...
        QLog.d("Q.contacttab.friend.FriendListUpdateUtil", 2, "handleGetFriendList " + bgjw.a(paramGetFriendListResp.groupname) + ", " + paramGetFriendListResp.friend_count + ", " + paramGetFriendListResp.sqqOnLine_count + ", " + paramGetFriendListResp.seqid);
      }
