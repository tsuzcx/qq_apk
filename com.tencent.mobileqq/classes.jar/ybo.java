...
public class ybo
{
    ...
    try
    {
      if (jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser == null)
      {
        ...
        if (VSNetworkHelper.a() != null) {
          VSNetworkHelper.a().a(new SubscribePersonalDetailRequest(BaseApplicationImpl.getApplication().getRuntime().getAccount(), localStCommonExt), new ybp());
        }
      }
  ...
  public static void a(CertifiedAccountRead.StGetMainPageRsp paramStGetMainPageRsp)
  {
    ...
    } while (!ybu.a(localStUser.attr.get()));
