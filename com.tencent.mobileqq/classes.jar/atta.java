...
public abstract class atta
{
  ...
  public static final String b = awqo.jdField_a_of_type_JavaLangString + "file/";
  protected QQAppInterface a;
  
  static
  {
    jdField_a_of_type_JavaLangString = awqo.jdField_a_of_type_JavaLangString + "fileThumb/";
  }
  
  public atta(QQAppInterface paramQQAppInterface)
  {
  ...
  protected MsgBackupResEntity a(MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    ...
    awqu.a(paramMessageRecord, localMsgBackupResEntity);
    localMsgBackupResEntity.extraDataStr = a(atvo.a((ChatMessage)paramMessageRecord), paramInt);
    ...
    if (bgmg.b(paramString)) {
      localMsgBackupResEntity.fileSize = bgmg.a(paramString);
    }
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if ((!TextUtils.isEmpty(paramMsgBackupResEntity)) && (!TextUtils.isEmpty(str)) && (paramMsgBackupResEntity.equals(str)))
      {
        if (QLog.isDebugVersion()) {
          QLog.i("FileMsgBackupHandler<QFile>", 1, "isResourceRelateToMsg: multi msg match res. fileId[" + str + "] " + atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
        }
        return true;
      }
      return false;
