  ...
  extends MSFServlet
{
  ...
  {
    new bkpi().a(paramFileStoragePushFSSvcList);
  }
  ...
  public static void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList, QQAppInterface paramQQAppInterface)
  {
    ...
    aptw.a(paramFileStoragePushFSSvcList, paramQQAppInterface);
    ...
    azck.a(paramQQAppInterface).a(true, false);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
          ...
          if ("qqwifi.notifyAvail".equals(str))
          {
            ...
            if (paramIntent != null)
            {
              ...
              for (int i = 1032;; i = 1033)
              {
                ...
                bcef.b(localQQAppInterface, "CliOper", "", "", "QQWIFI", "show_buleNotify", 0, 0, "", "", "", "");
                return;
              }
            }
          }
    ...
    try
    {
      ...
      label1557:
      ((FriendListHandler)localQQAppInterface.getBusinessHandler(1)).handleCheckUpdate(paramIntent);
      return;
    }
