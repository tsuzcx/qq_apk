...
public class aymo
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (bhhr.X(paramQQAppInterface.getApplication(), paramQQAppInterface.getCurrentAccountUin()) != 1) {}
    for (int i = 1;; i = 0)
    {
  ...
  {
    return ((anxs)paramQQAppInterface.getManager(QQManagerFactory.LIKE_RANKING_LIST_MANAGER)).c();
  }
}
