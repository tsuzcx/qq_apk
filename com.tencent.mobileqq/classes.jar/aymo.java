...
public class aymo
  extends aniz
{
  public aymo(AccountOnlineStateActivity paramAccountOnlineStateActivity) {}
  ...
  protected void onSetAutoReplyList(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      aypi localaypi = AccountOnlineStateActivity.a(this.a).a();
      AppRuntime.Status localStatus = ayox.a().a(localaypi);
      if ((localStatus != null) && (!AccountOnlineStateActivity.a(this.a, localaypi, localStatus)))
      {
        AccountOnlineStateActivity.a(this.a, true);
        AccountOnlineStateActivity.a(this.a).a(localStatus, localaypi.a);
      }
    }
    for (;;)
    {
