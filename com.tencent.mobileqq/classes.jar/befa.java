...
public class befa
{
  ...
  public static befb a(String paramString)
  {
    int i = 1;
    befb localbefb = new befb();
    if (TextUtils.isEmpty(paramString)) {
      return localbefb;
    }
    for (;;)
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localbefb.jdField_a_of_type_JavaLangString = paramString;
            localbefb.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localbefb.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localbefb.jdField_a_of_type_JavaLangString = str2;
          localbefb.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static bfbb a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return bfbb.a(localQQAppInterface, paramLong);
  }
