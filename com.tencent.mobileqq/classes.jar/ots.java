  ...
  extends ViewBase
{
  ...
  public ots(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131560039, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369184));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369272));
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369191));
  }
  ...
  private void a(View paramView)
  {
    ...
    if ((localObject1 != null) && (((Activity)localObject1).getWindow() != null))
    {
      ...
      this.d = afur.a(40.0F, ((Activity)localObject1).getResources());
    }
    if ((this.jdField_a_of_type_Pxk != null) && (this.jdField_a_of_type_Pxk.a() != null) && (this.jdField_a_of_type_Pxk.a().a() != null))
    {
      ...
      this.jdField_c_of_type_Int = this.jdField_a_of_type_Pxk.a().a().getTop();
