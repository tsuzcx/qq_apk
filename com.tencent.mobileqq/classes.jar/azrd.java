...
public class azrd
  extends akoq
{
  public Comparator b = new azre(this);
  
  public azrd(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private long a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1, ArrayList<MessageRecord> paramArrayList2, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        try
        {
          paramArrayList = a(paramArrayList, (ArrayList)localObject, localaxav, true, localazml);
          if (paramArrayList != null) {
  ...
  private void a(long paramLong1, long paramLong2, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if ((i != 2) || (paramMessageRecord == null)) {
        ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).c(Long.parseLong(paramString));
      }
      return;
      label145:
      ...
      for (int j = 1;; j = 0)
      {
        ...
        if (((ArrayList)localObject2).size() > 0)
        {
          ...
          if (i >= 0)
          {
            ...
            if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((myb.a((MessageRecord)localObject3)) && (myb.b((MessageRecord)localObject3))))
            {
              if (myb.a((MessageRecord)localObject3))
              {
                ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                localObject4 = myb.a((MessageRecord)localObject3);
                myb.a().a(((MessageRecord)localObject3).frienduin, ((MessageRecord)localObject3).vipBubbleID, ((myc)localObject4).jdField_b_of_type_Int, ((myc)localObject4).jdField_b_of_type_JavaLangString, ((myc)localObject4).jdField_c_of_type_Int, ((myc)localObject4).a, ((myc)localObject4).jdField_c_of_type_JavaLangString);
              }
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (paramPbGetGroupMsgResp != null) && (paramPbGetGroupMsgResp.size() > 0))
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
              awzy.a.a = new ConcurrentHashMap();
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
            awzy.a.a.put(localObject1, paramPbGetGroupMsgResp);
          }
          if (paramToServiceMsg.size() > 0)
          {
            ...
            paramArrayList = (akom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1);
            ...
            while (i < k)
            {
              ...
              if ((paramPbGetGroupMsgResp instanceof MessageForMarketFace)) {
                aske.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramPbGetGroupMsgResp);
              }
            ...
            i = akpx.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        ...
        for (;;)
        {
          if ((j != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject1) == 1))
          {
            ...
            if (paramArrayList != null)
            {
              ...
              ((akom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1)).b((String)localObject1, 1, l2);
            }
          }
          if (l1 >= 0L)
          {
          ...
          bool2 = akas.b(paramToServiceMsg);
          ...
          if (paramToServiceMsg.size() > 0) {
            akpq.a((MessageRecord)paramToServiceMsg.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          return;
          bool1 = false;
          break;
  ...
  private void a(ToServiceMsg paramToServiceMsg, msg_svc.PbGetGroupMsgResp paramPbGetGroupMsgResp, ArrayList<msg_comm.Msg> paramArrayList, String paramString)
  {
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.TroopMessageProcessor", 2, "<---refreshTroopHead_PB : fromUin:" + l4 + ",toUin:" + l3 + ",msgTime:" + l5 + ",msgSeq:" + l1 + ",msgUid:" + l2 + ",userActive:" + i + ",fromInstid:" + j + ",groupCode:" + l6 + ",groupType:" + k + ",groupSeq:" + l7 + ",Hascard:" + ((msg_comm.GroupInfo)localObject2).group_card.has() + ",cardName:" + bbbr.a((String)localObject3) + ",hasAppShare:" + paramArrayList.appshare_info.has() + ",hasMsgBody:" + paramArrayList.msg_body.has());
          }
          localObject2 = new ArrayList();
          localObject3 = new axav();
          ((axav)localObject3).e = paramPbGetGroupMsgResp.group_code.get();
          ((axav)localObject3).jdField_c_of_type_Int = 1;
          ((axav)localObject3).d = k;
          if (paramArrayList.content_head.has())
          {
            msg_comm.ContentHead localContentHead = (msg_comm.ContentHead)paramArrayList.content_head.get();
            i = localContentHead.div_seq.get();
          ...
          try
          {
            paramArrayList = a(paramArrayList, (ArrayList)localObject2, (axav)localObject3, true, localazml);
            if (paramArrayList != null)
            {
    ...
    ((asks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList, localazml);
    ...
    ((bbrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramString);
  }
  ...
  private void a(String paramString, MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    if (paramMessageRecord1.msgtype == -2011)
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)localObject1).tipParam != null) && (((MessageForUniteGrayTip)localObject1).tipParam.jdField_b_of_type_Int == 3276802))
      {
        ...
        QLog.i("Q.msg.TroopMessageProcessor" + ayed.i, 1, "updateGroupMsgSeqAndTime. docs gray msg. shmsgseq = " + paramMessageRecord1.shmsgseq + ", grayMsgType = " + -5020 + ", grayUniSeq = " + ((MessageRecord)localObject1).uniseq);
      }
    }
    label342:
    label361:
    while (paramMessageRecord1.msgtype != -2000)
    {
      ...
      localObject1 = akpx.a(paramMessageRecord2, paramMessageRecord1);
      ...
      adgc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord2.uniseq);
    ...
    for (;;)
    {
      ...
      break;
      break;
      if ((axvx.a(paramMessageRecord2)) || (paramMessageRecord2.msgtype == -2048))
      {
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        label473:
        paramPbPushMsg = (asks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
        if (!MessageHandler.b)
        {
          if (paramBoolean) {
            break label608;
        ...
        paramFromServiceMsg = new azml();
        try
        {
          a(paramMsg, (ArrayList)localObject1, localaxav, true, paramFromServiceMsg);
          ...
          if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0))
          {
            ...
            if (i < j)
            {
              ...
              if ((localObject3 instanceof MessageForMarketFace)) {
                aske.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)localObject3);
              }
              if (QLog.isColorLevel())
              {
              ...
              if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((myb.a((MessageRecord)localObject3)) && (myb.b((MessageRecord)localObject3))))
              {
                if (myb.a((MessageRecord)localObject3))
                {
                  ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                  localObject4 = myb.a((MessageRecord)localObject3);
                  myb.a().a(String.valueOf(localaxav.e), ((MessageRecord)localObject3).vipBubbleID, ((myc)localObject4).jdField_b_of_type_Int, ((myc)localObject4).jdField_b_of_type_JavaLangString, ((myc)localObject4).jdField_c_of_type_Int, ((myc)localObject4).a, ((myc)localObject4).jdField_c_of_type_JavaLangString);
                }
              ...
              for (;;)
              {
                ...
                if ((localObject3 instanceof MessageForTroopFile)) {
                  ((aygx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(272)).a((ChatMessage)localObject3);
                }
              }
            }
          }
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramMsg);
          bool1 = akas.a(paramMsg);
          bool2 = akas.b(paramMsg);
          i = akpx.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
        {
          ...
          ((bamk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203)).c(paramFromServiceMsg);
        }
        if (n == 127) {
          break;
        }
        ...
        ((bbrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((List)localObject2);
        l1 = System.currentTimeMillis() - l1;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.TroopMessageProcessor", 2, "decodecMsg cost:" + l1);
        }
        akpq.a("actGroupDecodeCost", l1);
        if (((ArrayList)localObject2).size() <= 0) {
          break;
        }
        akpq.a((MessageRecord)((ArrayList)localObject2).get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      }
      label1694:
      i = 0;
  ...
  public void a(GroupMsgReadedNotify paramGroupMsgReadedNotify)
  {
    ...
    paramGroupMsgReadedNotify = (bajo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
