...
public class bjvs
{
  protected static bjvs a;
  
  private long a(SQLiteDatabase paramSQLiteDatabase, String paramString, bjvp parambjvp)
  {
    try
    {
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("actiontype", parambjvp.c);
      localContentValues.put("appid", parambjvp.a);
      localContentValues.put("qua", parambjvp.e);
      localContentValues.put("uin", parambjvp.d);
      localContentValues.put("via", parambjvp.b);
      localContentValues.put("network", parambjvp.a());
      localContentValues.put("timestamp", parambjvp.g);
      localContentValues.put("expand1", parambjvp.h);
      localContentValues.put("expand2", parambjvp.i);
      localContentValues.put("expand3", parambjvp.j);
      localContentValues.put("expand4", parambjvp.k);
      localContentValues.put("expand5", parambjvp.l);
      long l1 = -1L;
      try
      {
      ...
      catch (SQLException paramSQLiteDatabase)
      {
        for (;;)
        {
          ...
          bjtx.e("BusinessReport", paramSQLiteDatabase.getLocalizedMessage());
        }
      }
      return l1;
    }
  ...
  public int a(String paramString)
  {
    try
    {
      ...
      bjtx.b("Jie", "new_table>>count=" + i);
      i += b("table_old_data", paramString);
      bjtx.b("Jie", "all_table>>>count=" + i);
      return i;
    }
    finally
    {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString1)
      {
        ...
        localObject2 = localObject1;
        bjtx.e("BusinessReport", paramString1.getLocalizedMessage());
      }
      finally
      {
  ...
  /* Error */
  public int a(String paramString, ArrayList<bjvp> paramArrayList)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   10: aload_0
    //   11: invokevirtual 143	bjvs:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore 5
    //   16: aload 5
    //   18: ifnonnull +7 -> 25
    //   21: aload_0
    ...
    //   56: checkcast 21	bjvp
    //   59: invokespecial 189	bjvs:a	(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lbjvp;)J
    //   62: pop2
    //   63: iload_3
    //   64: iconst_1
    //   65: iadd
    ...
    //   97: ldc 200
    //   99: aload_1
    //   100: invokestatic 203	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: aload 5
    ...
    //   0	144	2	paramArrayList	ArrayList<bjvp>
    //   4	91	3	i	int
    //   1	92	4	j	int
  ...
  public int a(ArrayList<bjvp> paramArrayList)
  {
    try
    {
  ...
  /* Error */
  public long a(String paramString, bjvp parambjvp)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   5: lstore 5
    //   7: aload_0
    //   8: invokevirtual 143	bjvs:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   11: astore 7
    //   13: lload 5
    //   15: lstore_3
    //   16: aload 7
    ...
    //   24: aload_1
    //   25: aload_2
    //   26: invokespecial 189	bjvs:a	(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lbjvp;)J
    //   29: lstore_3
    //   30: aload 7
    ...
    //   42: ldc 212
    //   44: aload_1
    //   45: invokestatic 203	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   48: aload 7
  ...
  protected SQLiteDatabase a()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = bjvu.a(bjjo.a().a()).getWritableDatabase();
  ...
  public ArrayList<bjvp> a(String paramString)
  {
    try
    {
  ...
  /* Error */
  public ArrayList<bjvp> a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   43: astore 7
    //   45: aload_0
    //   46: invokevirtual 143	bjvs:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   49: astore 5
    //   51: aload 10
    //   53: astore 4
    //   55: aload 9
    ...
    //   104: new 21	bjvp
    //   107: dup
    //   108: invokespecial 247	bjvp:<init>	()V
    //   111: astore 6
    //   113: aload_1
    //   114: astore 4
    //   116: aload_1
    ...
    //   134: putfield 25	bjvp:c	Ljava/lang/String;
    //   137: aload_1
    //   138: astore 4
    //   140: aload_1
    //   141: astore_2
    ...
    //   158: putfield 33	bjvp:a	Ljava/lang/String;
    //   161: aload_1
    //   162: astore 4
    //   164: aload_1
    //   165: astore_2
    ...
    //   182: putfield 38	bjvp:e	Ljava/lang/String;
    //   185: aload_1
    //   186: astore 4
    //   188: aload_1
    //   189: astore_2
    ...
    //   206: putfield 43	bjvp:d	Ljava/lang/String;
    //   209: aload_1
    //   210: astore 4
    //   212: aload_1
    //   213: astore_2
    ...
    //   230: putfield 48	bjvp:b	Ljava/lang/String;
    //   233: aload_1
    //   234: astore 4
    //   236: aload_1
    //   237: astore_2
    ...
    //   254: putfield 257	bjvp:f	Ljava/lang/String;
    //   257: aload_1
    //   258: astore 4
    //   260: aload_1
    //   261: astore_2
    ...
    //   278: putfield 58	bjvp:g	Ljava/lang/String;
    //   281: aload_1
    //   282: astore 4
    //   284: aload_1
    //   285: astore_2
    ...
    //   302: putfield 63	bjvp:h	Ljava/lang/String;
    //   305: aload_1
    //   306: astore 4
    //   308: aload_1
    //   309: astore_2
    ...
    //   326: putfield 68	bjvp:i	Ljava/lang/String;
    //   329: aload_1
    //   330: astore 4
    //   332: aload_1
    //   333: astore_2
    ...
    //   350: putfield 73	bjvp:j	Ljava/lang/String;
    //   353: aload_1
    //   354: astore 4
    //   356: aload_1
    //   357: astore_2
    ...
    //   374: putfield 78	bjvp:k	Ljava/lang/String;
    //   377: aload_1
    //   378: astore 4
    //   380: aload_1
    //   381: astore_2
    ...
    //   398: putfield 83	bjvp:l	Ljava/lang/String;
    //   401: aload_1
    //   402: astore 4
    //   404: aload_1
    //   405: astore_2
    ...
    //   443: invokestatic 105	bjtx:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   446: aload 4
    //   448: ifnull +10 -> 458
    //   451: aload 4
  ...
  public int b(String paramString1, String paramString2)
  {
    ...
    //   36: astore 8
    //   38: aload_0
    //   39: invokevirtual 143	bjvs:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   42: astore 7
    //   44: aload 11
    //   46: astore_2
    //   47: aload 10
    ...
    //   145: invokestatic 105	bjtx:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   148: aload 5
    //   150: ifnull +10 -> 160
    //   153: aload 5
  ...
  public ArrayList<bjvp> b(String paramString)
  {
    try
    {
