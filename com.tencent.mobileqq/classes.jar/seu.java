...
public final class seu
{
  ...
  private final void b()
  {
    ...
    set.b(str);
    set.a(System.currentTimeMillis());
    set.b(set.b() + 1);
    tto.a(set.b(), (ucm)new sew());
  }
  ...
  public final List<String> a(@NotNull JSONObject paramJSONObject, @NotNull String paramString)
  {
    ...
    if (paramJSONObject != null) {
      try
      {
        paramJSONObject = new Gson().fromJson(paramJSONObject.toString(), new sev().getType());
  ...
  public final void a()
  {
    ...
    {
      ((seu)this).b(true);
      String str = ((seu)this).a();
      ((seu)this).a(((seu)this).a(str));
    }
    if (((seu)this).a() == Aladdin.getConfig(309).getIntegerFromString("config_version", -1)) {}
    for (int i = 1; i != 0; i = 0) {
      return;
    }
    set.b(0);
  ...
  public final void a(@NotNull TPPlayerMsg.TPMediaCodecInfo paramTPMediaCodecInfo, @NotNull rqa paramrqa)
  {
    ...
    if (paramTPMediaCodecInfo.mediaType == TPPlayerMsg.TPMediaCodecInfo.TP_DEC_MEDIA_TYPE_VIDEO)
    {
      ...
      paramrqa.n = paramTPMediaCodecInfo;
    }
    label119:
    while (paramTPMediaCodecInfo.infoType != TPPlayerMsg.TPMediaCodecInfo.TP_INFO_MEDIA_CODEC_EXCEPTION) {
      try
      {
        ...
        paramrqa.j = paramTPMediaCodecInfo.optBoolean("reuseEnable");
        paramrqa.k = paramTPMediaCodecInfo.optBoolean("isReuse");
        paramrqa.u = paramTPMediaCodecInfo.optInt("totalCodec");
        return;
      }
    ...
    try
    {
      ...
      paramrqa.o = ((seu)this).a(paramrqa.o, str, ";");
      paramrqa.p = ((seu)this).a(paramrqa.p, paramTPMediaCodecInfo.msg, ";");
      return;
    }
    catch (Throwable paramrqa)
    {
      LogUtils.e("CodecReuseHelper", "onCodecReuseInfo error for jsonObject:" + paramTPMediaCodecInfo.msg);
    }
  }
  
  public final void a(@NotNull Object paramObject, @NotNull rqa paramrqa)
  {
    ...
    if ((paramObject instanceof TPPlayerMsg.TPMediaCodecInfo))
    {
      ...
      ((seu)this).a(paramObject, paramrqa);
    }
  }
  ...
  public final boolean a(@NotNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((seu)this).a(paramString.optInt("version", -1));
        List localList;
        if (i == 0)
        {
          localList = ((seu)this).a(paramString, "black_brand_list");
          paramString = ((seu)this).a(paramString, "black_model_list");
        ...
        {
          localList = ((seu)this).a(paramString, "white_brand_list");
          paramString = ((seu)this).a(paramString, "white_model_list");
          if (!localList.contains(Build.BRAND))
          {
