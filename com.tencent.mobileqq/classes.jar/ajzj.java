...
public class ajzj
  implements alzd, Handler.Callback, Manager
{
  public static final String a;
  public static boolean a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  ajjh jdField_a_of_type_Ajjh = new ajzk(this);
  private ajuc jdField_a_of_type_Ajuc = new ajzl(this);
  private beez jdField_a_of_type_Beez = new beez(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<ajzn> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<ajzi> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131639904);
  }
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = baig.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "breaking_ice_config");
    }
    i2 = i3;
    m = n;
    k = i1;
  ...
  private void f()
  {
    ...
    Object localObject1 = bace.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bace.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bace.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bace.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void g()
  {
    ...
    bace.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((ajjj)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  public void a(ajzi paramajzi)
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramajzi);
  }
  
  public void a(ajzn paramajzn)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajzn);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, alzc paramalzc)
  {
    if ((paramalzc != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        f();
      }
      paramQQAppInterface = a(true, paramalzc.jdField_a_of_type_JavaLangString);
      ...
      if ((bool1 != this.jdField_c_of_type_Boolean) || (bool2 != this.jdField_d_of_type_Boolean))
      {
        ...
        if (a(this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean, paramQQAppInterface))
        {
          ...
          if (this.jdField_a_of_type_Beez.hasMessages(1)) {
            this.jdField_a_of_type_Beez.removeMessages(1);
          }
          this.jdField_a_of_type_Beez.sendEmptyMessage(1);
        }
      }
      if (QLog.isColorLevel())
      {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aemn.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (ajzn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((ajzn)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Beez.hasMessages(1)) {
          this.jdField_a_of_type_Beez.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, befj.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localaemc.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          ...
          ((List)localObject).add(localaemc);
          i += 1;
        }
  ...
  public void b()
  {
    ...
    bace.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(ajzn paramajzn)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == paramajzn)) {
  ...
  public void c()
  {
    ...
    bace.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    bace.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean d(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        ajzn localajzn = (ajzn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localajzn != null) {
          localajzn.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Beez.hasMessages(1)) {
        this.jdField_a_of_type_Beez.removeMessages(1);
  ...
  public boolean e(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void h(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((anoe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).c()) {
            break;
          }
      ...
      localajzn = (ajzn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localajzn == null);
    localajzn.a(paramString, false);
  }
  ...
  {
    if (!aemi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
