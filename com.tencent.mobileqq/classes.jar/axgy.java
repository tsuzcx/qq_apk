  ...
  extends auzh
{
  protected void a(boolean paramBoolean, long paramLong, ArrayList<Long> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((paramLong == axgu.a(this.a)) && (axgu.d(this.a) != null)) {
        if (paramArrayList != null) {
          synchronized (axgu.a(this.a))
          {
            axgu.a(this.a).put(Long.valueOf(paramLong), (ArrayList)paramArrayList.clone());
          }
        }
      }
      synchronized (axgu.d(this.a))
      {
        localObject2 = (WeakReference)axgu.d(this.a).get(Long.valueOf(paramLong));
        if (localObject2 != null)
        {
          ??? = (axgx)((WeakReference)localObject2).get();
          if (??? != null)
          {
            if (paramBoolean) {
              break;
            }
            axgu.a(this.a, paramLong, (axgx)???);
          }
        }
        return;
        label200:
    ...
    ((axgx)???).a(paramLong, paramArrayList);
  }
  ...
  protected void a(boolean paramBoolean, HashMap<Long, IntimateInfo> paramHashMap, Object arg3)
  {
    ...
    for (paramHashMap = paramHashMap.size() + paramHashMap.toString();; paramHashMap = "null")
    {
      ...
      synchronized (axgu.e(this.a))
      {
        ...
        axgu.e(this.a).remove(localObject2);
      }
    }
    label387:
    label393:
    ...
    {
      label297:
      if ((l2 == axgu.a(this.a)) && (axgu.f(this.a) != null)) {}
      synchronized (axgu.f(this.a))
      {
        ??? = (WeakReference)axgu.f(this.a).get(Long.valueOf(l2));
        if (??? != null)
        {
          ??? = (axgv)((WeakReference)???).get();
          if (??? != null) {
            axgu.a(this.a, l2, paramHashMap, ???);
          }
        }
        return;
      }
