  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject3 = paramView.findViewById(2131378101);
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = ((View)localObject3).getTag(2131378101);
      if ((localObject1 instanceof StructMsgForImageShare))
      {
        ...
        try
        {
          ...
          {
            bdll.b((QQAppInterface)localObject1, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForImageShare.msgId), "");
          ...
          {
            bdll.b(null, "dc00898", "", "", "0X800A428", "0X800A428", 0, 0, "", ForwardUtils.b(localStructMsgForImageShare.uinType), Long.toString(localStructMsgForImageShare.mSourceAppid), "");
            if (QLog.isColorLevel()) {
              QLog.d("StructMsg", 2, "大图点击=0X800A428, appid=" + localStructMsgForImageShare.mSourceAppid + ", fileType=4");
            }
          }
          bdll.b(null, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForImageShare.mMsgServiceID + "", "", "", "");
          ...
          if ((!bhnt.b(localStructMsgForImageShare.mIsSend)) && (((bdqr)localObject4).a != null))
          {
            localObject1 = ahng.a(localContext, ((bdqr)localObject4).a);
        ...
        catch (AccountNotMatchException localAccountNotMatchException)
        {
          ...
          else
          {
            ...
            localIntent.putExtra("image_share_by_server", ((bdqr)localObject4).a());
            localIntent.putExtra("urlAtServer", ((bdqr)localObject4).ad);
            localIntent.putExtra("KEY_FILE_ID", ((bdqr)localObject4).c);
            localIntent.putExtra("picMD5", ((bdqr)localObject4).ae);
            localIntent.putExtra("url", ((bdqr)localObject4).ac);
            ...
            localIntent.putExtra("IS_FROMOTHER_TERMINAL_KEY", bhnt.c(localStructMsgForImageShare.mIsSend));
    ...
    localIntent.putExtra("fileSize", ((bdqr)localObject4).d);
    localIntent.putExtra("KEY_TIME", ((bdqr)localObject4).e);
    ...
    localIntent.putExtra("KEY_THUMBNAL_BOUND", abke.a((View)localObject3));
    Object localObject4 = ((bdqr)localObject4).a;
    if (localObject4 != null)
    {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        if ((!bhnt.b(((MessageForPic)localObject4).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject4).path)) || (!new File(((MessageForPic)localObject4).path).exists())) {
          continue;
        }
        ...
        if ((!bhnt.b(((MessageForPic)localObject4).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject4).path)) || (!TextUtils.isEmpty(((MessageForPic)localObject4).md5)) || (!new File(((MessageForPic)localObject4).path).exists())) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_JavaLangString = ((MessageForPic)localObject4).path;
        localAIOImageData.jdField_b_of_type_Int = 4;
        continue;
        if (!avlv.a(localStructMsgForImageShare)) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_Int = 5;
        avlv.a(localAIOImageData, localStructMsgForImageShare);
        continue;
      ...
      localAIOImageData = aicv.a((MessageForPic)localObject4);
      ...
      if ((localStructMsgForImageShare.mMsgActionData != null) && (localStructMsgForImageShare.mMsgActionData.startsWith("comic_plugin.apk")))
      {
        ...
        localAIOImageData.a = localStructMsgForImageShare.getBytes();
        localObject4 = aics.a(localStructMsgForImageShare);
        localAIOImageData.d = aics.a((String[])localObject4);
        if ((localObject4 != null) && (localObject4.length >= 8))
        {
          if (localObject4[7].equals("link"))
          {
            localObject3 = localObject4[4];
            bmbt.a(null, (String)localObject2, localContext, "3009", "2", "40054", localObject4[0], new String[] { localObject4[2], localObject4[4], localObject3 });
          }
        }
        else
        {
          ...
          bdll.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X80055C7", "0X80055C7", 0, j, "" + localStructMsgForImageShare.msgId, "" + localStructMsgForImageShare.templateIDForPortal, "", localStructMsgForImageShare.mMsgUrl);
          localObject2 = new StringBuilder().append("MSGID=").append(Long.toString(localStructMsgForImageShare.msgId)).append(";TEPLATEID=").append(localStructMsgForImageShare.templateIDForPortal).append(";ARTICALID=").append("").append(";REFERRER=").append(bdol.a(localStructMsgForImageShare.mMsgUrl));
          bdll.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X8005D49", "0X8005D49", 0, j, ((StringBuilder)localObject2).toString(), "", "", "");
          break;
