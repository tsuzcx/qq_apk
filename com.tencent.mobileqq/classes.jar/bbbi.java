  ...
  extends WtloginObserver
{
  ...
  public void onRegGetSMSVerifyLoginAccount(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    if (QLog.isColorLevel()) {
      QLog.d(bbbh.jdField_a_of_type_JavaLangString, 2, "OnRegGetSMSVerifyLoginAccount ret=" + paramInt + " uin=" + paramLong);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte3 = "";
        bdll.a(localQQAppInterface, "new_reg", "setting_page_no", "result", "", 1, "", str, "", paramArrayOfByte3, "", "", "", "", "");
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        if (paramInt != 0) {
          break label469;
        }
        bbbh.a(this.a, Long.valueOf(paramLong).toString());
        bbbh.a(this.a, paramArrayOfByte2);
        if (!TextUtils.isEmpty(bbbh.a(this.a))) {
          break;
        }
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131715879, 1);
        return;
      }
    ...
    if ((bbbh.a(this.a) == null) || (bbbh.a(this.a).length == 0))
    {
      this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131715879, 1);
      return;
    }
    if (QLog.isDevelopLevel()) {
      QLog.d(bbbh.jdField_a_of_type_JavaLangString, 4, String.format(Locale.getDefault(), "OnRegGetSMSVerifyLoginAccount ret: %s, uin: %s, sign: %s", new Object[] { Integer.valueOf(paramInt), Long.valueOf(paramLong), MD5.toMD5(bbbh.a(this.a)) }));
    }
    ...
    paramArrayOfByte1.putExtra("uin", bbbh.a(this.a));
    paramArrayOfByte1.putExtra("key_register_sign", bbbh.a(this.a));
    paramArrayOfByte1.putExtra("key_register_from_send_sms", bbbh.a(this.a));
