...
{
  public alum(ColorNoteSmallScreenService paramColorNoteSmallScreenService) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_Alub.a(paramContext);
      this.a.jdField_a_of_type_ComTencentMobileqqColornoteSmallscreenColorNoteSmallScreenRelativeLayout.a(paramContext);
      break label556;
      paramContext = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a();
      if ((alsb.a()) || (((paramContext.size() != 1) || (!alsr.b((ColorNote)paramContext.get(0)))) && (paramContext.size() != 0))) {
        break label556;
      }
      this.a.f();
      break label556;
