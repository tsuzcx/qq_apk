...
public class alum
{
  private static alum jdField_a_of_type_Alum;
  private aluo jdField_a_of_type_Aluo = new aluo(this, null);
  private aluq jdField_a_of_type_Aluq;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(new alun(this));
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private alum(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Aluo);
    }
  }
  
  public static alum a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Alum == null) {
      jdField_a_of_type_Alum = new alum(paramAppInterface);
    }
    return jdField_a_of_type_Alum;
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Alum != null)
    {
      jdField_a_of_type_Alum.b();
      jdField_a_of_type_Alum = null;
    }
  }
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aluq != null)
    {
      ...
      this.jdField_a_of_type_Aluq.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Aluo);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new alup(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Aluq != null) {
          this.jdField_a_of_type_Aluq.a(paramInt, bool2);
        }
        return;
      }
  ...
  {
    this.jdField_a_of_type_Aluq = paramaluq;
  }
}
