  ...
  implements bmrk
{
  ...
  {
    JSONObject localJSONObject = this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.a.jdField_a_of_type_Bmru.c, this.a.jdField_a_of_type_Int, this.a.b, "uploading", "", 0);
    try
    {
      if (this.a.b == 2)
      {
      ...
      for (float f1 = 1.0F;; f1 = paramInt / 100.0F)
      {
        ...
        this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.callJs(this.a.jdField_a_of_type_Bmru.jdField_a_of_type_JavaLangString, new String[] { localJSONObject.toString() });
  ...
  public void a(String paramString)
  {
    ...
    for (int i = 11;; i = 0)
    {
      ...
      localObject = this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.a.jdField_a_of_type_Bmru.c, this.a.jdField_a_of_type_Int, this.a.b, (String)localObject, paramString, i);
        ...
        for (;;)
        {
          try
          {
            ...
            if (2 == this.a.b)
            {
              ...
              if (this.a.b != 2) {
                this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.callJs(this.a.jdField_a_of_type_Bmru.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject).toString() });
              }
  ...
  public void b(int paramInt)
  {
    ...
    this.a.jdField_a_of_type_Boolean = false;
    JSONObject localJSONObject = this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.a.jdField_a_of_type_Bmru.c, this.a.jdField_a_of_type_Int, this.a.b, "uploaded", "", 0);
    try
    {
