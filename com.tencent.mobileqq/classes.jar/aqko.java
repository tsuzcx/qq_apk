  ...
  extends ServerConfigObserver
{
  ...
  public void onGetPluginConfig(boolean paramBoolean, int paramInt, GetResourceRespV2 paramGetResourceRespV2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localObject1 = aqkn.a(this.a).a().createEntityManager();
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (localGetResourceRespInfoV2.iPluginType == 32)
          {
            ...
            if (aqkv.a((EntityManager)localObject1, aqkn.a(this.a), localGetResourceRespInfoV2).cDefaultState != 0) {
              break label515;
            }
            paramInt = 1;
            i = 1;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        while (paramGetResourceRespV2.hasNext())
        {
          ...
          {
            aqkv.a((EntityManager)localObject1, aqkn.a(this.a), (GetResourceRespInfoV2)localObject2);
            i = 1;
          }
        }
        ...
        if (i != 0)
        {
          paramGetResourceRespV2 = new ArrayList(aqkn.a(this.a)).iterator();
          while (paramGetResourceRespV2.hasNext())
          {
        ...
        label415:
        if (k >= aqkn.a(this.a).size()) {
          break;
        }
        try
        {
          ResourcePluginListener.a((ResourcePluginListener)aqkn.a(this.a).get(k), (byte)1, 2);
          label454:
          k += 1;
          break label415;
          while (paramInt < aqkn.a(this.a).size()) {
            try
            {
              ResourcePluginListener.a((ResourcePluginListener)aqkn.a(this.a).get(paramInt), (byte)-1, 2);
              label500:
              paramInt += 1;
            }
