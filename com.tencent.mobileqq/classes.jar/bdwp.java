  ...
  extends bdwi
{
  ...
  {
    a.download(paramQQAppInterface, "specialRing." + paramInt, parambdts, paramBoolean);
  }
  ...
  {
    paramContext = a.getDir(paramContext, "specialRing." + paramInt);
    paramContext = bdhb.a(new File(paramContext + File.separator + paramInt + ".json"));
