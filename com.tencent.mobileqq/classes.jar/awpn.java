...
public class awpn
  extends RecyclerView.Adapter<awpv>
{
  private int jdField_a_of_type_Int;
  private UniBusiSimpleItemDetail jdField_a_of_type_QCUniBusiSimpleItemDetail;
  private Context jdField_a_of_type_AndroidContentContext;
  private Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable;
  private awpm jdField_a_of_type_Awpm;
  public awpu a;
  private URLDrawable.URLDrawableListener jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener = new awpt(this);
  ...
  public awpn(Context paramContext, ArrayList<UniBusiSimpleItemDetail> paramArrayList)
  {
    this.jdField_a_of_type_Awpu = new awpp(this);
  ...
  {
    String str3 = alpo.a(2131705055);
    String str2 = alpo.a(2131720773);
    String str1 = str2;
    if (!TextUtils.isEmpty(paramString2))
    {
      str1 = str2;
      if (paramString2.contains("svip")) {
        str1 = alpo.a(2131720771);
      }
    }
    bdcd.a(paramContext, 230, str3, paramString3, alpo.a(2131705056), str1, new awpq(this, paramContext, paramString1, paramString2, paramString4), new awpr(this)).show();
  }
  ...
  public Drawable a(Context paramContext, Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    return new LayerDrawable(new Drawable[] { paramDrawable, paramContext.getResources().getDrawable(2130849637) });
  }
  ...
  public Drawable a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    return new LayerDrawable(new Drawable[] { paramString, paramContext.getResources().getDrawable(2130849637) });
  }
  
  public awpv a(ViewGroup paramViewGroup, int paramInt)
  {
    paramViewGroup = new awpv(this, View.inflate(paramViewGroup.getContext(), 2131561211, null));
    if (paramInt == 1)
    {
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_QCUniBusiSimpleItemDetail != null) && (this.jdField_a_of_type_Boolean))
    {
      ...
      a(this.jdField_a_of_type_Int, this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, this.jdField_a_of_type_QCUniBusiSimpleItemDetail.feeType, this.jdField_a_of_type_Awpu);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, awpu paramawpu)
  {
    if ((a(paramInt3)) && (paramawpu != null))
    {
      paramawpu.a(true, null);
      return;
    }
    new bdwc("QC.UniBusinessUserInfoServer.UniBusinessUserInfoObj", "QcUniBusinessUserInfo.UniBusiGetOneItemWithCheck", "stReq", "stRsp").a("UniBusiGetOneItemWithCheck", new UniBusiGetOneItemWithCheckReq(bdwc.a(), paramInt1, paramInt2), new UniBusiGetOneItemWithCheckRsp(), new awps(this, paramawpu), false);
  }
  
  public void a(TextView paramTextView, int paramInt)
  {
    paramTextView.setCompoundDrawablePadding(bdkf.b(4.0F));
    paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, a(paramInt), 0);
  }
  
  public void a(awpm paramawpm)
  {
    this.jdField_a_of_type_Awpm = paramawpm;
  }
  
  public void a(awpv paramawpv, int paramInt)
  {
    ...
    paramawpv.jdField_a_of_type_AndroidWidgetTextView.setText(localUniBusiSimpleItemDetail.name);
    boolean bool;
    if (this.b == localUniBusiSimpleItemDetail.itemId)
    {
      ...
      paramawpv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setBackgroundDrawable(a(paramawpv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.getContext(), localUniBusiSimpleItemDetail.itemBgColor, bool));
      paramInt = (azgq.e(paramawpv.itemView.getContext()) - azgq.a(96.0F)) / 3;
      Object localObject = paramawpv.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
      ((ViewGroup.LayoutParams)localObject).width = paramInt;
      ((ViewGroup.LayoutParams)localObject).height = ((int)(paramInt * 0.57F));
      paramawpv.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      paramawpv.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a(String.valueOf(localUniBusiSimpleItemDetail.itemId), localUniBusiSimpleItemDetail.image));
    }
    for (;;)
    {
      a(paramawpv.jdField_a_of_type_AndroidWidgetTextView, localUniBusiSimpleItemDetail.feeType);
      paramawpv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setOnClickListener(new awpo(this, localUniBusiSimpleItemDetail));
      return;
      bool = false;
      break;
      label290:
      ...
      break label72;
      label295:
      paramawpv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setBackgroundDrawable(a(paramawpv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.getContext(), a(String.valueOf(localUniBusiSimpleItemDetail.itemId), localUniBusiSimpleItemDetail.image), bool));
    }
  }
    ...
    for (;;)
    {
      ...
      else
      {
        if (this.jdField_a_of_type_QCUniBusiSimpleItemDetail != null)
        {
          ...
          a(this.jdField_a_of_type_Int, this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, -1, this.jdField_a_of_type_Awpu);
        }
        this.d = 0;
        return;
        this.jdField_a_of_type_JavaUtilArrayList = paramArrayList;
  ...
  {
    notifyDataSetChanged();
    if (this.jdField_a_of_type_Awpm != null)
    {
      ...
      this.jdField_a_of_type_Awpm.b(this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, i);
    }
    label60:
    ...
    this.jdField_a_of_type_Awpm.a(this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, i);
  }
