  ...
  implements awoe
{
  ...
  public awpn(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public awpn(QQAppInterface paramQQAppInterface, int paramInt1, byte[] paramArrayOfByte, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_Int = paramInt1;
  ...
  public static List<awpn> a(QQAppInterface paramQQAppInterface, List<DynamicDiscovery.Result> paramList, int paramInt)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            bbjn.a(paramQQAppInterface.getCurrentAccountUin(), arrayOfString);
            ...
            continue;
            localObject = new awml(paramQQAppInterface, k, ((DynamicDiscovery.Result)localObject).toByteArray(), paramInt, false);
            continue;
      ...
      boolean bool = a(arrayOfInt, awil.a(paramQQAppInterface, paramInt, false));
      awil.a(paramQQAppInterface, paramInt, bool, false);
      if (bool) {
        awil.a(paramQQAppInterface, paramInt, arrayOfInt, false);
      }
    }
  ...
  public static List<awpn> b(QQAppInterface paramQQAppInterface, List<UnifySearchDiscovery.Result> paramList, int paramInt)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            bbjn.b(paramQQAppInterface.getCurrentAccountUin(), arrayOfString);
            ...
            continue;
            localObject = new awml(paramQQAppInterface, k, ((UnifySearchDiscovery.Result)localObject).toByteArray(), paramInt, true);
            continue;
      ...
      boolean bool = a(arrayOfInt, awil.a(paramQQAppInterface, paramInt, true));
      awil.a(paramQQAppInterface, paramInt, bool, true);
      if (bool) {
        awil.a(paramQQAppInterface, paramInt, arrayOfInt, true);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("SearchEntryDataModel", 2, "convertPbDataToModel, modelList = " + localArrayList.size());
  ...
  public void a()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_ArrayOfByte = bbdj.a(BaseApplication.getContext().getFileStreamPath("search_discovery_sp_prefixpref_search_model_data" + localQQAppInterface.getCurrentAccountUin() + "_" + this.jdField_a_of_type_Int + "_" + this.b));
        a(this.jdField_a_of_type_ArrayOfByte);
        return;
      }
      this.jdField_a_of_type_ArrayOfByte = bbdj.a(BaseApplication.getContext().getFileStreamPath("search_discovery_sp_prefix_unifypref_search_model_data" + localQQAppInterface.getCurrentAccountUin() + "_" + this.jdField_a_of_type_Int + "_" + this.b));
      a(this.jdField_a_of_type_ArrayOfByte);
    }
  }
