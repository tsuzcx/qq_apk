...
public class bdfb
{
  ...
  public static bdfb a(Bundle paramBundle)
  {
    bdfb localbdfb = new bdfb();
    localbdfb.jdField_a_of_type_JavaLangString = paramBundle.getString("uin");
    localbdfb.jdField_a_of_type_Boolean = paramBundle.getBoolean("enableInvite");
    return localbdfb;
  }
  
  public static void a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    boolean bool = bdex.a(paramString1, paramQQAppInterface, paramString2);
