...
@TargetApi(18)
public class mjd
  implements Handler.Callback, View.OnClickListener, moh, mok, moq
{
  ...
  public mjd(AVActivity paramAVActivity, RelativeLayout paramRelativeLayout1, VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, RelativeLayout paramRelativeLayout2, VideoControlUI paramVideoControlUI)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI == null)
      {
        ...
        this.jdField_a_of_type_Long = (this.jdField_a_of_type_Moi.h * 60 * 1000L);
  ...
  private int a(int paramInt)
  {
    ...
    do
    {
      ...
      j = paramInt;
    } while (!this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI.i());
    return 0;
  }
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong >= 0L)
      {
        ...
        mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695169);
        mol.a("0X8008AB0");
      }
      else if (paramLong < 0L)
      {
        a(3, true);
        mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695144);
  ...
  public static void a(VideoController paramVideoController)
  {
    ...
    paramVideoController.a(8, "SUPPORT_TRUE");
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + moi.a().h);
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + moi.a().h);
  }
  
  private void a(VideoAppInterface paramVideoAppInterface)
  {
    LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131559797, this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380947));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376400));
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376399));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378698));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376385));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376382);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376381);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376380);
    ...
    this.jdField_a_of_type_Int = agej.a(51.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    this.jdField_b_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131695157);
    this.jdField_c_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131695153);
    this.jdField_a_of_type_ComTencentAvUiFunchatRecordQavRecordButtonView = ((QavRecordButtonView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376372));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376388));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376387));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    if (AudioHelper.a(0) == 1)
    {
  ...
  private void b(long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoController.a().B = false;
    mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695145);
    this.jdField_a_of_type_ComTencentAvVideoController.F();
    n();
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
  ...
  private void h(int paramInt)
  {
    ...
    do
    {
      ...
      for (paramInt = 2131695159;; paramInt = 2131695158)
      {
  ...
  private void r()
  {
    ...
    agej.a(7.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    agej.a(64.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    b(2131297825);
    b(2131297822);
    b(2131297822);
    b(2131297824);
    ...
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener == null) {
      this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new mje(this);
    }
    if (this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener == null) {
      this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new mjf(this);
    }
  ...
  private void u()
  {
    ...
    {
      localAVActivity.jdField_a_of_type_Mct.c(2);
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().B)
    {
      ...
      bdll.b(null, "CliOper", "", "", "0X800863B", "0X800863B", 0, 0, String.valueOf(l), "", "", "");
      bdmc.a(BaseApplicationImpl.getContext()).a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "av_record_click_end", true, l, 0L, null, "", false);
      return;
    }
    ...
    if (!f())
    {
      if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
        mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695139);
      }
      j = 0;
    ...
    for (;;)
    {
      if (j != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentAvVideoController.a().I = b();
        b();
        Object localObject;
        if ((j()) && (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)))
        {
          localObject = (lgx)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
          if (((FaceItem)((lgx)localObject).a() != null) && (((lgx)localObject).a()) && (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
            mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695149);
          }
        }
        mol.a("0X800863A");
        ...
        for (;;)
        {
          ...
          if (!this.jdField_a_of_type_ComTencentAvVideoController.a().A)
          {
            ...
            for (j = 2131695147;; j = 2131695146)
            {
              if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) {
                break label1192;
              }
              mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, j);
              j = 0;
              break;
              mol.a("0X8008AB5");
            }
          ...
          {
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695152);
            }
            j = 0;
          ...
          if ((this.jdField_a_of_type_ComTencentAvVideoController.a().C) && (this.jdField_a_of_type_ComTencentAvVideoController.a().u < 735))
          {
            QLog.d("QavVideoRecordUICtrl", 1, "start record, friend's old version not support record in same time");
            mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695150);
            j = 0;
            break;
          }
          if (!e())
          {
            ...
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695148);
            }
            j = 0;
            break;
          }
          ...
          {
            localObject = (lgx)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
            FaceItem localFaceItem = (FaceItem)((lgx)localObject).a();
            if (localFaceItem != null)
            {
              boolean bool1 = ((lgx)localObject).a();
              ...
              label801:
              for (j = 2131695172;; j = 2131695171)
              {
                mbb.a((VideoAppInterface)localObject, 1022, j);
                j = 0;
          ...
          {
            localObject = (lix)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            if (localObject != null)
            {
              ...
              if (localObject != null)
              {
                ...
                for (j = 1;; j = 0)
                {
                  ...
                  mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695173);
                  j = 0;
          ...
          label931:
          if ((localAVActivity.jdField_a_of_type_Mng != null) && (localAVActivity.jdField_a_of_type_Mng.a()))
          {
            j = 0;
            mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695170);
            break;
          }
          if (mny.a() < 31457280L)
          {
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mbb.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695164);
            }
            j = 0;
          ...
          if ((mqr.a()) && (mqr.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface).c()))
          {
          ...
          {
            localObject = (lhx)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
            if ((localObject != null) && (((lhx)localObject).a() != null))
            {
  ...
  private void v()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI.i())
    {
  ...
  private void w()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b() + b(2131297784));
      return;
    }
    this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b(2131297784));
  }
  ...
  int a()
  {
    ...
    {
      if (bool) {
        j = LiuHaiUtils.b((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      }
    }
    else {
      return j;
  ...
  public long a()
  {
    try
    {
      ...
      for (l = this.jdField_g_of_type_Long;; l = mny.a(this.jdField_a_of_type_JavaIoFile))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      mny.a(paramString, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
  ...
  public void a(String paramString1, String paramString2)
  {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        do
        {
          ...
          if ("SUPPORT_TRUE".equals(paramString2))
          {
            ...
            this.jdField_a_of_type_ComTencentAvVideoController.a().u = Math.max(this.jdField_a_of_type_ComTencentAvVideoController.a().u, 730);
            n();
            return;
          }
        } while (!paramString2.startsWith("SUPPORT_TRUE_7.3.5"));
        this.jdField_a_of_type_ComTencentAvVideoController.a().A = true;
        this.jdField_a_of_type_ComTencentAvVideoController.a().u = Math.max(this.jdField_a_of_type_ComTencentAvVideoController.a().u, 735);
        j = mom.a(paramString2, this.jdField_a_of_type_Moi.h);
    ...
    case 1: 
      ...
      for (;;)
      {
        ...
        {
          paramString1 = (lhx)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
    ...
    case 8: 
      ...
      {
        a(4, false);
        mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695143);
      }
      for (;;)
      {
        m();
        return;
        a(9, false);
        mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695142);
      }
    case 4: 
      a(3);
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    Object localObject;
    int j;
    if ((this.jdField_c_of_type_AndroidWidgetRelativeLayout.getVisibility() == 0) && (!b()) && (!LiuHaiUtils.b()))
    {
    ...
    for (;;)
    {
      localObject = (RedPacketGameView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131373571);
      if (localObject != null) {
  ...
  {
    if ((jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Moo != null) && (paramInt1 == 100)) {
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        j = mjk.b(paramInt1);
        this.jdField_d_of_type_JavaLangString = mny.a();
        ...
        paramInt2 = this.jdField_a_of_type_Moi.f;
        if (paramInt1 > paramInt2)
        {
          ...
          if (j % 2 == 1)
          {
            ...
            bbmc localbbmc = new bbmc(this.jdField_d_of_type_JavaLangString, paramInt1, paramInt2, 5120000, 1, false, 0);
  ...
  public void b()
  {
    ...
    QLog.i("QavVideoRecordUICtrl", 1, "startRecord, after registerAudioDataCallback, ret2=" + j + ", ret4=" + k + ", set2=" + m + ", set4=" + n);
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().F)
    {
      ...
      QLog.d("QavVideoRecordUICtrl", 1, "startRecord, registerAudioDataCallback, mix = true, ret3=" + j + ", set3=" + k);
  ...
  public void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      QLog.i("QavVideoRecordUICtrl", 1, "endRecord, after unregisterAudioDataCallbackAll, ret2=" + j + ", ret4=" + k);
      if (this.jdField_a_of_type_ComTencentAvVideoController.a().F)
      {
        ...
        QLog.i("QavVideoRecordUICtrl", 1, "endRecord, registerAudioDataCallback, mix = true, ret3=" + j + ", set3=" + k);
      }
      mol.a(this.jdField_a_of_type_Moi.r, this.jdField_a_of_type_Moi.s, paramInt, b());
      return;
      if (paramInt == 2)
      {
        b(b());
  ...
  public void b(int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout$LayoutParams.setMargins(b(2131297825), 0, 0, 0);
  ...
  public void d()
  {
    if ((this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI == null) || (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI.h())) {}
    do
    {
      return;
    ...
    {
      j = 1;
      if ((j == 0) || (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI == null) || (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI.i())) {
        break label296;
      }
      if (d() != 3) {
        break label238;
      ...
      this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.leftMargin = agej.a(15.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
      if (this.jdField_d_of_type_AndroidWidgetRelativeLayout != null) {
        this.jdField_d_of_type_AndroidWidgetRelativeLayout.setLayoutParams(this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams);
      }
  ...
  public void f(int paramInt)
  {
    ...
    case 180: 
      ...
      localLayoutParams.setMargins(agej.a(10.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, 0);
      localLayoutParams.addRule(2, 0);
      localLayoutParams.addRule(1, 2131376372);
      localLayoutParams.addRule(6, 2131376372);
    ...
    localLayoutParams.setMargins(agej.a(-12.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, agej.a(32.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    localLayoutParams.addRule(2, 2131376372);
  ...
  public void g(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        bool = this.jdField_a_of_type_ComTencentAvVideoController.a().B;
        if (QLog.isColorLevel()) {
    ...
    default: 
      return;
    case 0: 
      FaceItem localFaceItem = (FaceItem)((lgx)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      for (;;)
      {
        mol.a("0X8008AC8");
        return;
        mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695155);
      }
      mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695154);
      mol.a("0X8008AC9");
      return;
  ...
  public boolean g()
  {
    if ((k()) || (!f()) || (!i()) || (!this.jdField_a_of_type_ComTencentAvVideoController.a().A)) {}
  ...
  public boolean h()
  {
    ...
    {
      return false;
      bool1 = this.jdField_a_of_type_ComTencentAvVideoController.a().B;
      bool6 = this.jdField_a_of_type_ComTencentAvVideoController.a().C;
      bool7 = this.jdField_a_of_type_ComTencentAvVideoController.a().x;
    } while (!g());
    if (bool1) {
      return true;
    }
    ...
    {
      localObject = (lgx)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
      FaceItem localFaceItem = (FaceItem)((lgx)localObject).a();
      if (localFaceItem != null)
      {
        bool4 = ((lgx)localObject).a();
    ...
    for (boolean bool5 = true;; bool5 = false)
    {
      ...
      {
        localObject = (lix)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
        if (localObject != null)
        {
          localObject = (ZimuItem)((lix)localObject).a();
          if (localObject != null) {
      ...
      for (;;)
      {
        ...
        if ((bool7) || (bool1) || ((bool5) && (bool4) && ((bool3) || (bool2))) || ((bool6) && (this.jdField_a_of_type_ComTencentAvVideoController.a().u < 735))) {
          break;
        }
        return true;
        bool1 = false;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (l > this.jdField_a_of_type_Long)
      {
        ...
        bdll.b(null, "CliOper", "", "", "0X800863C", "0X800863C", 0, 0, String.valueOf(l), "", "", "");
        bdmc.a(BaseApplicationImpl.getContext()).a("", "av_record_timeout", true, l, 0L, null, "", false);
        return true;
      }
      ...
      if (!((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).i)
      {
        ...
        continue;
        if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
          mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695156);
        }
      }
    }
  }
  ...
  public boolean i()
  {
    ...
    {
      if (this.jdField_a_of_type_Moi.r <= this.jdField_a_of_type_Moi.jdField_d_of_type_Int) {
        break label111;
      }
    ...
    for (;;)
    {
      ...
      return true;
      label111:
      if ((this.jdField_a_of_type_Moi.r == this.jdField_a_of_type_Moi.jdField_d_of_type_Int) && (this.jdField_a_of_type_Moi.s >= this.jdField_a_of_type_Moi.jdField_e_of_type_Int)) {
        this.jdField_b_of_type_Int = 2;
      } else if (this.jdField_a_of_type_Moi.r > this.jdField_a_of_type_Moi.jdField_b_of_type_Int) {
        this.jdField_b_of_type_Int = 1;
      } else if ((this.jdField_a_of_type_Moi.r == this.jdField_a_of_type_Moi.jdField_b_of_type_Int) && (this.jdField_a_of_type_Moi.s >= this.jdField_a_of_type_Moi.jdField_c_of_type_Int)) {
        this.jdField_b_of_type_Int = 1;
      } else {
  ...
  public void l()
  {
    ...
    b(true);
    if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
      mbb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695175);
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a().C = false;
    n();
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
    long l = (System.currentTimeMillis() - this.jdField_c_of_type_Long) / 1000L;
    bdll.b(null, "CliOper", "", "", "0X800863E", "0X800863E", 0, 0, "", String.valueOf(l), "", "");
    bdmc.a(BaseApplicationImpl.getContext()).a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "av_record_cancel", true, l, 0L, null, "", false);
    c(1);
  }
  ...
  public void n()
  {
    ...
    if (h())
    {
      ...
      for (;;)
      {
        ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvUiVideoControlUI.i(l, 65535);
        return;
