...
public final class mjd
{
  ...
  private mei[] jdField_a_of_type_ArrayOfMei = new mei[16];
  ...
  public mjd(VideoController paramVideoController)
  {
    this.jdField_a_of_type_ComTencentAvVideoController = paramVideoController;
    int i = 0;
    while (i < 16)
    {
      this.jdField_a_of_type_ArrayOfMei[i] = new mei();
      i += 1;
    }
  }
  ...
  {
    int i = 1;
    this.jdField_a_of_type_ArrayOfMei[this.jdField_a_of_type_Int].jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_ArrayOfMei[this.jdField_a_of_type_Int].jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_ArrayOfMei[this.jdField_a_of_type_Int].jdField_c_of_type_Int = paramInt3;
  ...
  public boolean a(miw parammiw)
  {
    int j = 1;
    this.jdField_a_of_type_JavaLangString = "";
    if (this.jdField_a_of_type_ComTencentAvVideoController.a.a(3))
    {
      parammiw = ((lhw)this.jdField_a_of_type_ComTencentAvVideoController.a.a(3)).a();
      if (parammiw != null) {
        this.jdField_a_of_type_JavaLangString = parammiw.getDesc();
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      for (i = j;; i = 0)
      {
        ...
        return lpq.c(VideoController.a().a());
      }
    }
  }
