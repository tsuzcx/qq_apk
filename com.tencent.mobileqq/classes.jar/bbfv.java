  ...
  implements Handler.Callback
{
  ...
  public bbfv(QQAppInterface paramQQAppInterface)
  {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      while (((bbfv)localObject).jdField_b_of_type_Boolean)
      {
        paramQQAppInterface = ((auqh)paramQQAppInterface.getManager(36)).a().iterator();
        do
        {
          bool1 = bool2;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Befq.hasMessages(0)) {
      this.jdField_a_of_type_Befq.removeMessages(0);
    }
    this.jdField_b_of_type_Int += 1;
    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(0, 2000L);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_b_of_type_Boolean != paramBoolean)
    {
      ...
      ajqy.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime());
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008824", "0X8008824", 0, this.jdField_b_of_type_Int, 0, "", "", "", "");
    this.jdField_b_of_type_Int = 0;
    return false;
  }
}
