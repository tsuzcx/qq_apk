...
public class pie
{
  ...
  pif jdField_a_of_type_Pif;
  
  public pie(pif parampif)
  {
    this.jdField_a_of_type_Pif = parampif;
  }
  ...
  public void a(String paramString, Object paramObject, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    while (this.jdField_a_of_type_Pif == null) {
      return;
    }
    this.jdField_a_of_type_Pif.a(paramString, paramObject);
  }
  
  public void b()
  {
    if ((this.jdField_a_of_type_Pif != null) && (!this.jdField_a_of_type_JavaUtilHashMap.isEmpty()))
    {
      ...
      while (localIterator1.hasNext())
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          this.jdField_a_of_type_Pif.a((String)localEntry.getKey(), localObject);
        }
      }
    }
  }
