  ...
  implements Comparator<RecentBaseData>
{
  ...
  public amer(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(RecentBaseData paramRecentBaseData1, RecentBaseData paramRecentBaseData2)
  {
    if (((paramRecentBaseData1 instanceof RecentUserBaseData)) && ((paramRecentBaseData2 instanceof RecentUserBaseData)))
    {
      ...
      boolean bool1;
      if ((paramRecentBaseData1.mUser.getType() == 1) && (!aupu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData1.mUser)))
      {
        bool1 = localTroopManager.b(paramRecentBaseData1.a());
        if ((paramRecentBaseData2.mUser.getType() != 1) || (aupu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData2.mUser))) {
          break label138;
        }
      }
      label138:
      ...
      if ((!bool1) && (!bool2)) {
        if ((paramRecentBaseData1.mUnreadNum > 0) && (paramRecentBaseData1.mUser.getType() == 0) && (akaj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramRecentBaseData1.mUser.uin)) && (!a(paramRecentBaseData1.mUser.uin, 0)))
        {
          i = 1;
          if (i == 0) {
            break label594;
    ...
    for (int i = 4096;; i = 0)
    {
      if ((paramRecentBaseData2.mUnreadNum > 0) && (paramRecentBaseData2.mUser.getType() == 0) && (akaj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramRecentBaseData2.mUser.uin)) && (!a(paramRecentBaseData2.mUser.uin, 0)))
      {
        j = 1;
        if (j == 0) {
          break label588;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (localRecentUser.getType() == 3000)
        {
          ...
          DiscussionInfo localDiscussionInfo = ((almv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(localRecentUser.uin);
        ...
        if (localRecentUser.lFlag == 16L)
        {
          ...
          nlx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser);
          break;
        }
        if ((localRecentUser.getType() == 10005) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
          astt.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser);
        }
        break;
        if ((this.jdField_a_of_type_JavaLangStringBuilder != null) && (QLog.isDevelopLevel()))
        {
