  ...
  extends VasWebviewJsPlugin
{
  ...
  private void a()
  {
    this.jdField_a_of_type_Alxj = new ahht(this);
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if ((localObject != null) && (!((ArrayList)localObject).isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((!paramString1.equals("openVideoPlayer")) || ((!bbkk.a(paramString2)) && (paramString2.contains("jump play")))) {
  ...
  {
    return (paramBitmap != null) && (paramBitmap != this.jdField_a_of_type_Alxf.a);
  }
  ...
  private void b()
  {
    ...
    try
    {
      QIPCClientHelper.getInstance().callServer("SpringHbIPCModule", "GetEmergencyInfo", null, new ahhu(this));
      return;
    }
  ...
  private boolean b(String paramString)
  {
    ...
    ahif.a((String)localObject, i, j, paramString);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_Ahhw, localIntentFilter);
  }
  ...
  private void d()
  {
    try
    {
      if ((this.jdField_a_of_type_Ahhw != null) && (this.jdField_b_of_type_Boolean))
      {
        this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Ahhw);
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject).optInt("cache_only", 1) == 1)
        {
          ...
          localObject = this.jdField_a_of_type_Alxf.a(paramString, bool1);
    ...
    if ((paramLong == 8589934595L) || (paramLong == 8589934612L))
    {
      ...
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (!TextUtils.isEmpty(str1)) && (str1.startsWith(this.jdField_a_of_type_JavaLangString)) && (!TextUtils.equals(this.jdField_b_of_type_JavaLangString, str1)))
      {
        ...
        if (bbfj.d(this.jdField_a_of_type_AndroidContentContext))
        {
          ...
          ahif.a(ahhz.e, 1, 1, (Map)localObject, true);
          break label544;
        }
      }
    }
