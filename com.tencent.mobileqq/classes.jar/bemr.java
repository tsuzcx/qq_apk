...
public class bemr
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new bemw(this);
  ...
  public bemr()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561554, null));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368066));
    int i = 0;
  ...
  void b()
  {
    ...
    this.d.setBackgroundResource(2130845102);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new bems(this));
  ...
  void e()
  {
    ...
    localObject2 = new bemu(this, localAnimatorSet);
