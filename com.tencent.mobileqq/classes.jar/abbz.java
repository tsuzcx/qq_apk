  ...
  implements Runnable
{
  ...
  public abbz(ArkLocalAppMgr paramArkLocalAppMgr, int paramInt, String paramString1, String paramString2, abcr paramabcr, String paramString3) {}
  ...
  public void run()
  {
    ...
    {
      ArkLocalAppMgr.a((String)localObject3, String.format("%s.%s", new Object[] { this.jdField_a_of_type_Abcr.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abcr.b }), this.jdField_a_of_type_Abcr.jdField_a_of_type_Int, localArrayList);
      if (!localArrayList.isEmpty()) {
        break label448;
      }
      ArkAppCenter.b("ArkApp.ArkLocalAppMgr", String.format("findAppViewMatchAction, not match, context=%s, action=%s, app-name=%s", new Object[] { this.jdField_a_of_type_Abcr.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abcr.b, this.c }));
      i = -1;
      ??? = "Action NOT Matched";
    }
    label448:
    for (;;)
    {
      if (localArrayList.isEmpty())
      {
        ...
        synchronized (this.jdField_a_of_type_Abcr)
        {
          this.jdField_a_of_type_Abcr.c.addAll(localArrayList);
          this.jdField_a_of_type_Abcr.jdField_a_of_type_JavaUtilSet.remove(this.c);
          if (this.jdField_a_of_type_Abcr.jdField_a_of_type_JavaUtilSet.isEmpty())
          {
            this.jdField_a_of_type_Abcr.jdField_a_of_type_Boolean = true;
          ...
          ArkAppCenter.b("ArkApp.ArkLocalAppMgr", String.format("getAppByAction finished, action=%s.%s, app-count=%d, unfinished-count=%d", new Object[] { this.jdField_a_of_type_Abcr.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abcr.b, Integer.valueOf(this.jdField_a_of_type_Abcr.c.size()), Integer.valueOf(this.jdField_a_of_type_Abcr.jdField_a_of_type_JavaUtilSet.size()) }));
          return;
        }
      }
    }
