...
public class unh
  implements Runnable
{
  public unh(PressToSpeakPanel paramPressToSpeakPanel, MotionEvent paramMotionEvent) {}
  ...
  public void run()
  {
    ...
    {
      QQToast.a(BaseApplication.getContext(), 2131433771, 0).b(i);
      return;
    }
    if (AudioHelper.b(1))
    {
    ...
    PressToSpeakPanel.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelPressToSpeakPanel).setBackgroundResource(2130845481);
