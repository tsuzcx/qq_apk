  ...
  implements Manager
{
  ...
  public axny(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    axql.a("Q.nearby", "updateNearbyPeopleCard", new Object[] { paramString, paramCharmEvent, paramNearbyCharmNotify });
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt == 1) {
      bdla.b(null, "dc00899", "grp_lbs", "", "app_down", "exp_msg", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      bhdj.a(paramActivity, 230).setMessage(paramString1).setNegativeButton(anvx.a(2131706585), new axoa()).setPositiveButton(anvx.a(2131706588), new axnz(paramString2, paramInt, paramActivity)).show();
      return true;
      if (paramInt == 2) {
        bdla.b(null, "dc00899", "grp_lbs", "", "app_down", "exp_pic", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt != this.jdField_b_of_type_Int)
    {
      ...
      axqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_age", Integer.valueOf(this.jdField_b_of_type_Int));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 31	axny:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   6: ifnull +19 -> 25
    //   9: aload_0
    //   10: getfield 31	axny:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   13: invokevirtual 312	java/util/concurrent/ConcurrentHashMap:isEmpty	()Z
    //   16: istore_2
    //   17: iload_2
    //   18: ifne +7 -> 25
    //   21: aload_1
    ...
    //   27: return
    //   28: aload_0
    //   29: getfield 31	axny:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   32: aload_1
    //   33: invokevirtual 315	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   36: ifeq -11 -> 25
    //   39: aload_0
    //   40: getfield 31	axny:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   43: aload_1
    //   44: invokevirtual 318	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   47: pop
    //   48: goto -23 -> 25
    //   51: astore_1
    //   52: aload_0
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    if (localEntityManager != null)
    {
      ...
      localObject1 = ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localObject1 != null)
      {
        i = paramSelfInfo.uint32_vote_num.get();
        if ((!paramSelfInfo.uint32_vote_num.has()) || (i <= 0)) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (j != 0)
      {
        axqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), ((Card)localObject1).lVoteCount, ((Card)localObject1).iVoteIncrement);
        localEntityManager.update((Entity)localObject1);
      }
      localEntityManager.close();
      b(paramSelfInfo.uint32_gender.get());
      a(paramSelfInfo.uint32_age.get());
      axqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_third_line_info", paramSelfInfo.str_third_line_info.get());
      axqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_third_line_icon", paramSelfInfo.str_third_line_icon.get());
      return;
      label483:
  ...
  public boolean a()
  {
    return ((Boolean)axqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "self_god_flag", Boolean.valueOf(false))).booleanValue();
  }
  ...
  public boolean a(NearbyPeopleCard paramNearbyPeopleCard, String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt, boolean paramBoolean3)
  {
    ...
    label241:
    return (!TextUtils.isEmpty(paramNearbyPeopleCard.uin)) && (((axpb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEARBY_LIKE_LIMIT_MANAGER)).a(paramNearbyPeopleCard.uin));
  }
    ...
    for (;;)
    {
      if (i != this.jdField_a_of_type_Int)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ((avlj)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, paramInt, NetConnInfoCenter.getServerTime());
          }
        }
        axqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_gender", Integer.valueOf(this.jdField_a_of_type_Int));
      }
      return;
