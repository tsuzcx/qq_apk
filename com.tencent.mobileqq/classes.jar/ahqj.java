...
{
  private static int[] jdField_a_of_type_ArrayOfInt = { 2131374148, 2131374148 };
  private int jdField_a_of_type_Int = 18;
  private ahqi jdField_a_of_type_Ahqi;
  private Context jdField_a_of_type_AndroidContentContext;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahqm(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new ahqn(this);
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ahqk(this);
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Integer, ahqi> jdField_a_of_type_JavaUtilHashMap;
  private Animation.AnimationListener jdField_b_of_type_AndroidViewAnimationAnimation$AnimationListener = new ahql(this);
  private Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  private RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  
  public ahqj(BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout)
  {
  ...
  private void a(ahqi paramahqi)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Ahqi = paramahqi;
      Object localObject1 = paramahqi.a();
      if (localObject1 != null)
      {
        ...
        if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setMinimumHeight(bgtn.b(45.0F));
          ...
          ((RelativeLayout.LayoutParams)localObject2).topMargin = bgtn.a(this.jdField_a_of_type_Int);
        ...
        if (paramahqi.a() > 0L)
        {
          ...
          ((Message)localObject1).arg1 = paramahqi.jdField_a_of_type_Int;
          this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed((Message)localObject1, paramahqi.a());
        }
      }
    } while (!QLog.isColorLevel());
    QLog.d("NavigateBarManager", 2, String.format("show navigate bar: %s", new Object[] { paramahqi }));
  }
  
  private void c()
  {
    if (QLog.isColorLevel()) {
      QLog.d("NavigateBarManager", 2, String.format("hide navigate bar: %s", new Object[] { this.jdField_a_of_type_Ahqi }));
    }
    ...
    if (this.jdField_a_of_type_Ahqi != null)
    {
      b(this.jdField_a_of_type_Ahqi.jdField_a_of_type_Int);
      this.jdField_a_of_type_Ahqi = null;
    }
  }
  ...
  public void a()
  {
    ...
    {
      ahqi localahqi = (ahqi)((Map.Entry)localIterator.next()).getValue();
      Object localObject2;
      if (localObject1 == null) {
        localObject2 = localahqi;
      }
      for (;;)
      {
        localObject1 = localObject2;
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if (localObject != null)
      {
        boolean bool = ((ahqi)localObject).a();
        if (bool) {
          this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(((ahqi)localObject).jdField_a_of_type_Int), localObject);
        }
        if (QLog.isColorLevel()) {
          QLog.d("NavigateBarManager", 2, String.format("addTask, barId: %s, needShow: %s", new Object[] { Integer.valueOf(((ahqi)localObject).jdField_a_of_type_Int), Boolean.valueOf(bool) }));
        }
      }
      return;
      localObject = new ahqh(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramInt, 4);
      continue;
      localObject = new ahqq(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramInt, 4);
      continue;
      localObject = new ahqp(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramInt, 4);
      continue;
      localObject = new ahqo(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramInt, 4);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Ahqi != null) && (this.jdField_a_of_type_Ahqi.jdField_a_of_type_Int == paramInt)) {
      c();
    }
    for (;;)
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Ahqi != null) && (i == this.jdField_a_of_type_Ahqi.jdField_a_of_type_Int)) {
        c();
      } else {
