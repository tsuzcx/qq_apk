...
public class axdj
{
  private static axdj a = new axdj();
  ...
  public void a(QQAppInterface paramQQAppInterface, List<BusinessInfoCheckUpdate.NumRedInfo> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      ((baia)paramQQAppInterface.getManager(65)).a(localArrayList, "nearby_num_red_dot", new axdk(this, paramQQAppInterface));
    }
  }
  ...
  public void b(QQAppInterface paramQQAppInterface, List<NumRedMsg.NumMsgBusi> paramList)
  {
    ...
    njg localnjg = (njg)paramQQAppInterface.getManager(70);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      try
      {
        ...
        localObject3 = (baif)paramQQAppInterface.getManager(36);
        if ((!str.equals("7719.771901")) && (!str.equals("7719.771903")) && (!str.equals("7719.771904"))) {
          break label1120;
        }
        i = ((baif)localObject3).a(str, 0);
        i = ((baif)localObject3).a(str, 1) + i;
      }
      ...
      catch (Exception localException4)
      {
        try
        {
          axzx.a().a(paramQQAppInterface, (oidb_0x791.RedDotInfo)localObject1);
        }
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = localnjg.a(localInteger.intValue());
      ...
      {
        break;
        if ((localObject2 != null) && (niy.h(((oidb_0x791.RedDotInfo)localObject2).uint32_appid.get())))
        {
          i = 1;
        }
        else
        {
          localnjg.a((oidb_0x791.RedDotInfo)localHashMap2.get(localInteger));
          i = 1;
        }
      }
    }
    ...
    do
    {
      ...
      try
      {
        localnjg.a(localHashMap1);
        new bcsy(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("nearby_push_red_tmp").a(new String[] { paramList.uint32_appid.get() + "" }).a();
        if (paramList.uint32_appid.get() == 59)
        {
          new bcsy(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("like_exp_red").a();
          return;
        }
      }
      catch (Exception localException1)
      {
        ...
        if (paramList.uint32_appid.get() == 60)
        {
          ...
          {
            new bcsy(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("assist_exp_red").a();
            return;
          }
          new bcsy(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("c2c_exp_red").a();
          return;
        }
      }
    } while (paramList.uint32_appid.get() != 61);
    new bcsy(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("paried_exp_red").a();
  }
}
