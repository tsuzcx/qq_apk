  ...
  implements View.OnClickListener
{
  ...
  public bkpz(@NonNull bkqb parambkqb)
  {
    super(parambkqb);
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bkqb.jdField_d_of_type_Int = paramString.jdField_a_of_type_Int;
      this.jdField_a_of_type_Bkqb.jdField_e_of_type_Int = paramString.b;
      this.jdField_a_of_type_Bkqb.jdField_d_of_type_JavaLangString = paramString.jdField_a_of_type_JavaLangString;
      int i = this.jdField_a_of_type_Bkqb.jdField_d_of_type_Int;
      if (i > 0) {
        return true;
      }
    }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setTextEffect(this.jdField_a_of_type_Bkqb.jdField_e_of_type_JavaLangString);
    String str = bhdx.a(this.jdField_a_of_type_Bkqb.jdField_d_of_type_Int, null, null, null);
    if (TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_Bkqb.jdField_d_of_type_Int = -1;
    }
    for (;;)
    {
  ...
  public void a()
  {
    ...
    if (!this.jdField_a_of_type_Bkqb.j) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    if ((this.jdField_a_of_type_Bkqb.g) || (this.jdField_a_of_type_Bkqb.i))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new bkqa(this));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if ((paramIntent != null) && (paramIntent.getExtras() != null))
      {
        ...
        if (paramIntent.containsKey("permission_code")) {
          this.jdField_a_of_type_Bkqb.jdField_c_of_type_Int = paramIntent.getInt("permission_code");
        }
        if (paramIntent.containsKey("uin_list"))
        {
          if (this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList == null) {
            this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          }
          this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList.clear();
          localObject = paramIntent.getStringArrayList("uin_list");
          if (localObject != null) {
            this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList.addAll((Collection)localObject);
          }
        }
        if (a(this.jdField_a_of_type_Bkqb.jdField_c_of_type_Int))
        {
          this.jdField_a_of_type_Bkqb.b = paramIntent.getString("key_setting_raw_json");
          this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaLangString = paramIntent.getString("key_selected_tag");
        }
        d();
      }
    }
    do
    {
      ...
      if (this.jdField_a_of_type_Bkqb.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_Bkqb.jdField_a_of_type_AndroidViewView.setVisibility(8);
      }
    ...
    if (localBundle.containsKey("contentIntentKey"))
    {
      ...
      this.jdField_a_of_type_Bkqb.jdField_c_of_type_JavaLangString = paramIntent;
    }
    ...
    this.jdField_a_of_type_Bkqb.jdField_d_of_type_Int = localBundle.getInt("extra_key_font_id", -1);
    this.jdField_a_of_type_Bkqb.jdField_e_of_type_Int = localBundle.getInt("extra_key_font_format_type");
    this.jdField_a_of_type_Bkqb.jdField_d_of_type_JavaLangString = localBundle.getString("extra_key_font_url");
    this.jdField_a_of_type_Bkqb.jdField_f_of_type_Int = localBundle.getInt("extra_key_super_font_id", -1);
    this.jdField_a_of_type_Bkqb.jdField_e_of_type_JavaLangString = localBundle.getString("extra_key_super_font_info");
    j();
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    case 0: 
      ...
      paramInt = i;
      if (this.jdField_a_of_type_Bkqb.h) {
        paramInt = 0;
      }
  ...
  public void d()
  {
    this.jdField_a_of_type_JavaLangString = bhup.a(this.jdField_a_of_type_Bkqb.jdField_c_of_type_Int);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i == 2131366450)
      {
        ...
        ((bkqb)this.jdField_a_of_type_Bjxn).d(3004);
        localBundle = new Bundle();
        localBundle.putInt("permission_code", this.jdField_a_of_type_Bkqb.jdField_c_of_type_Int);
        if ((this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localBundle.putStringArrayList("uin_list", this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList);
          localObject1 = new ArrayList(this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList.size());
          localObject2 = this.jdField_a_of_type_Bkqb.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        if ((a(this.jdField_a_of_type_Bkqb.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bkqb.b))) {
          localBundle.putString("key_setting_raw_json", this.jdField_a_of_type_Bkqb.b);
        }
        bgyp.a((BaseActivity)this.jdField_a_of_type_Bjyv, paramView, 1, localBundle, "");
        return;
      }
    } while (i != 2131366407);
    ((bkqb)this.jdField_a_of_type_Bjxn).d(3001);
    paramView = bgyw.a();
    ...
    if (this.jdField_a_of_type_Bkqb.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Bkqb.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
    Object localObject1 = new Bundle();
    ((Bundle)localObject1).putBoolean("key_at_click_hide_keyboard", true);
    Object localObject2 = (BaseActivity)this.jdField_a_of_type_Bjyv;
    String str = this.jdField_a_of_type_Bkqb.jdField_c_of_type_JavaLangString;
    if (this.jdField_a_of_type_Bkqb.g) {}
    for (int i = 0;; i = 1)
    {
      bgyp.a((Activity)localObject2, paramView, 1009, "", str, "", "", 0, i, 1, 0, 0, 0, "", 10000, localBundle, this.jdField_a_of_type_Bkqb.g, this.jdField_a_of_type_Bkqb.jdField_f_of_type_Boolean, this.jdField_a_of_type_Bkqb.jdField_d_of_type_Int, this.jdField_a_of_type_Bkqb.jdField_f_of_type_Int, true, (Bundle)localObject1);
      return;
    }
  }
}
