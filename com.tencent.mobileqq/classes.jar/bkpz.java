  ...
  implements bkpy
{
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    case 1: 
      ...
      atdm.a().b(paramBundle, (Bundle)localObject2);
      return true;
    case 2: 
      ...
      ((QQAppInterface)localObject1).getFileManagerDataCenter().a(new asku(paramBundle));
    ...
    case 4: 
      ...
      paramBundle.putString("configInfo", asld.a(((QQAppInterface)localObject1).getApp().getBaseContext(), str));
      return true;
    }
