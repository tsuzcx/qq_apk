...
{
  public ayhh(TroopBarReplyActivity paramTroopBarReplyActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      bbmy.a(localTroopBarReplyActivity, 1, paramBundle, 0).b(this.a.getTitleBarHeight());
      if (this.a.k) {
        azho.a("reply_page", "fail", this.a.o, "4", "", "");
      }
      return;
      ...
      if (!TextUtils.isEmpty(azho.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetXEditTextExWithListener))) {
      ...
      if (this.a.k) {
        azho.a("reply_page", "suc", this.a.o, "", ((StringBuffer)localObject).toString(), "");
      }
      paramBundle = this.a.getString(2131630857, new Object[] { Integer.valueOf(9992) });
    }
  }
