...
public class avdr
{
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, aved paramaved)
  {
    ...
    if (!TextUtils.isEmpty(paramString5))
    {
      ...
      if (a.getStatus() == 1)
      {
        wxe.c("ShortVideoShareUtil", "URLDrawable's status is SUCCESSED.");
        b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, a(a), paramaved);
        return;
      }
      if (a.getStatus() == 2)
      {
        b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, null, paramaved);
        a.downloadImediatly();
        return;
      }
      wxe.c("ShortVideoShareUtil", "start load URLDrawable.");
      a.setURLDrawableListener(new avdw(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, paramaved));
      a.downloadImediatly();
      return;
    }
    b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, null, paramaved);
  ...
  {
    paramString1 = new azup(StructMsgForGeneralShare.class).c(131).a(paramString2).a("web", paramString4, null, null, null).a();
    paramString4 = azvc.a(2);
    ...
    aryv.a(paramBaseActivity, paramString2, 123);
  }
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, int paramInt, String paramString6)
  {
    ...
    paramString4 = new azup(StructMsgForGeneralShare.class).c(131).a(paramString2).a("web", paramString4, null, null, null).a();
    azut localazut = azvc.a(2);
    localazut.a(paramString5, paramString2, paramString3, 0);
    paramString4.addItem(localazut);
    ...
    aryv.a(paramBaseActivity, paramString1, ForwardRecentTranslucentActivity.class, 123, 100500, "biz_src_hdsp_nearby");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, URLDrawable paramURLDrawable, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    ((ShareActionSheet)localObject).setItemClickListenerV2(new avds(paramBaseActivity, paramString2, paramString4, paramString5, paramString3, paramString6, paramString7, paramQQAppInterface));
    ((ShareActionSheet)localObject).setCancelListener(new avdv(paramOnDismissListener));
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    bjev.a(paramString1, paramBaseActivity, paramString5, null, 124);
    new aveg().h("video").i("playpage_fw_suc").a().a(paramString1);
  }
  
  static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, aved paramaved)
  {
    ...
    if (!TextUtils.isEmpty(paramString5))
    {
      ...
      if (a.getStatus() == 1)
      {
        ...
        if (paramString1 == null) {
          paramBaseActivity = bdal.b(BaseApplicationImpl.getApplication().getResources(), 2130844914);
        }
        WXShareHelper.a().a(new avdy(str, paramaved));
        WXShareHelper.a().a(str, paramString2, paramBaseActivity, paramString3, paramString4);
        new aveg().h("video").i("playpage_fw_suc").a().a(paramString5);
      }
    }
    else
    {
    ...
    if (a.getStatus() == 2)
    {
      ...
      WXShareHelper.a().a(new avdz(str, paramaved));
      WXShareHelper.a().a(str, paramString2, paramBaseActivity, paramString3, paramString4);
      a.downloadImediatly();
      new aveg().h("video").i("playpage_fw_suc").a().a(paramString5);
      return;
    ...
    wxe.c("ShortVideoShareUtil", "start load URLDrawable.");
    a.setURLDrawableListener(new avea(str, paramaved, paramString2, paramString3, paramString4, paramString5));
    a.startDownload();
  }
  
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap, aved paramaved)
  {
    String str = String.valueOf(System.currentTimeMillis());
    if (paramBitmap == null) {}
    for (paramString1 = bdal.b(BaseApplicationImpl.getApplication().getResources(), 2130844914);; paramString1 = paramBitmap)
    {
      WXShareHelper.a().a(new avdx(str, paramaved));
      WXShareHelper.a().b(str, paramString2, paramString1, paramString3, paramString4);
      new aveg().h("video").i("playpage_fw_suc").a().a(paramQQAppInterface);
      return;
    }
  }
}
