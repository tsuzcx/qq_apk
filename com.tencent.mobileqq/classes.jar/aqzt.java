...
public class aqzt
  extends aqzw
  implements araq, URLDrawable.DownloadListener
{
  public int a;
  ...
  public aqzt(HotPicPageView paramHotPicPageView, View paramView, arba paramarba)
  {
    super(paramHotPicPageView, paramView, paramarba);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379108));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379118));
    ...
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379048));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131379111));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364213);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131378942));
  }
  ...
  public void a()
  {
    ...
    if (localHotVideoMongoliaRelativeLayout != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Aqzt == this) {
        this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Aqzt = null;
      }
  ...
  public void b()
  {
    ...
    localValueAnimator.addUpdateListener(new aqzv(this));
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.itemView.setContentDescription(ajya.a(2131705613));
      continue;
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      a();
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(ajya.a(2131705610));
      this.jdField_a_of_type_Boolean = false;
      continue;
      this.jdField_a_of_type_Boolean = false;
      if (paramInt == 1) {
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(ajya.a(2131705616));
      continue;
      if ((this.jdField_d_of_type_AndroidWidgetImageView.getVisibility() == 0) && ((this.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Int == 2)))
      {
        ...
        ((AlphaAnimation)localObject).setAnimationListener(new aqzu(this));
      ...
      for (;;)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.setVisibility(8);
        this.itemView.setContentDescription(ajya.a(2131705612));
        break;
        this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      ...
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(ajya.a(2131705614));
      b();
      continue;
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(ajya.a(2131705615));
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Arba != null) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == -11))) {
      this.jdField_a_of_type_Arba.c(this, getPosition());
    }
  ...
  public void onFileDownloadFailed(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Araz.a();
  }
  ...
  public void onFileDownloadSucceed(long paramLong)
  {
    ...
    if ((localHotVideoData != null) && (localHotVideoData.picIndex == paramLong))
    {
      ...
      if (localHotVideoData.CheckIsNeedBlurBackground())
      {
        ...
        if ((Build.VERSION.SDK_INT >= 17) && (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.a()) && (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Arah != null)) {
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Arah.a(this, localHotVideoData);
        }
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Araz.a();
