...
public class aumo
{
  ...
  /* Error */
  private void a(File paramFile1, File paramFile2, aumn paramaumn)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    ...
    //   25: iconst_1
    //   26: ldc 150
    //   28: invokestatic 54	aumo:a	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 29	aumo:jdField_a_of_type_Boolean	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, aumn paramaumn)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_b_of_type_Long += auog.a(str1);
        }
    ...
    if (str2.contains("/.tmp/")) {
      localObject = b(str1) + aunj.a(str2);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ThreadManager.post(new FMSettings.4(this, str2, (File)localObject, j, paramaumn), 8, null, false);
          i += 1;
        }
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = c(str1) + aunj.a(str2);
      } else {
        localObject = a(str1) + aunj.a(str2);
      }
    }
  }
  ...
  private aumu b()
  {
    return (aumu)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
  }
  ...
  private aumu c()
  {
    ...
    return (aumu)this.jdField_a_of_type_JavaUtilMap.get("externalSdCard");
  }
  ...
  private void c()
  {
    ...
    ThreadManager.post(new FMSettings.1(this, b(localaumu.jdField_b_of_type_JavaLangString + localaumu.c)), 8, null, false);
  }
  ...
  private aumu d()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (aumu)this.jdField_a_of_type_JavaUtilMap.get(localObject2);
      ((aumu)localObject2).a();
      if (((aumu)localObject2).jdField_a_of_type_Boolean)
      {
        a(2, "getDefaultStorage[" + ((aumu)localObject2).jdField_b_of_type_JavaLangString + "] + ext[" + ((aumu)localObject2).c + "]");
        return localObject2;
      }
    }
    a(2, "getDefaultStorage nothing is default refresh!");
    Object localObject2 = (aumu)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new aumu(this, null);
      ((aumu)localObject1).jdField_a_of_type_Boolean = true;
      ((aumu)localObject1).jdField_a_of_type_JavaLangString = "SD卡";
      ((aumu)localObject1).jdField_b_of_type_JavaLangString = Environment.getExternalStorageDirectory().getPath();
      ((aumu)localObject1).c = "";
    }
    ((aumu)localObject1).a(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public aumu a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (aumu)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      if (localaumu != localObject) {
        return localObject;
      }
    }
  ...
  public String a()
  {
    ...
    return a(localaumu.jdField_b_of_type_JavaLangString + localaumu.c);
  }
  ...
  public void a()
  {
    ...
    Map localMap = aunj.a(localBaseApplication);
    a(1, "qurey strorages[" + localMap.size() + "]");
    String str1 = localBaseApplication.getSharedPreferences("FMSETTING_59", 4).getString("DefaultRootPath", antf.aZ);
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localaumu = new aumu(this, null);
          localaumu.jdField_a_of_type_Boolean = false;
          if (!str2.equalsIgnoreCase("sdCard")) {
            break label402;
          }
          localaumu.jdField_a_of_type_JavaLangString = "SD卡";
          localaumu.jdField_b_of_type_JavaLangString = ((String)localObject);
          localaumu.c = "";
          a(1, "rootPath[" + localaumu.jdField_b_of_type_JavaLangString + "],bDefault[" + localaumu.jdField_a_of_type_Boolean + "]");
          localObject = new StatFs((String)localObject);
          localaumu.jdField_a_of_type_Long = (((StatFs)localObject).getAvailableBlocks() * ((StatFs)localObject).getBlockSize());
          a(4, "defaultRootPath[" + str1 + "].equalsIgnoreCase(si.rootPath[" + localaumu.jdField_b_of_type_JavaLangString + "])");
          if ((localMap.size() == 1) || (str1.equalsIgnoreCase(localaumu.jdField_b_of_type_JavaLangString)))
          {
            a(4, "defaultRootPath.equalsIgnoreCase(si.rootPath) = true");
            localaumu.jdField_a_of_type_Boolean = true;
            localaumu.a(localBaseApplication);
          }
          localaumu.a();
          this.jdField_a_of_type_JavaUtilMap.put(str2, localaumu);
        }
        catch (Exception localException)
        {
          localException.printStackTrace();
        ...
        {
          localaumu.jdField_a_of_type_JavaLangString = "外置SD卡";
          localBaseApplication.getExternalFilesDir(null);
          String str3 = BaseApplicationImpl.sApplication.getPackageName();
          localaumu.jdField_b_of_type_JavaLangString = ((String)localObject);
          localaumu.c = ("/Android/data/" + str3 + "/");
        }
      }
    }
  }
  
  public void a(long paramLong, List<String> arg3, Activity paramActivity, aumn paramaumn)
  {
    ...
    for (;;)
    {
      ...
      a(1, "showChoosePath, callback[" + paramaumn + "]");
      ??? = b();
      aumu localaumu = c();
      if (((aumu)???).jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_JavaLangString = anzj.a(2131703558);
      }
      ...
      {
        label216:
        paramActivity.runOnUiThread(new FMSettings.5(this, paramActivity, ???, paramaumn));
        return;
        if ((localaumu == null) || (!localaumu.jdField_a_of_type_Boolean)) {
          break label216;
        }
        this.jdField_a_of_type_JavaLangString = anzj.a(2131703554);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        ...
        {
          ((aumu)this.jdField_a_of_type_JavaUtilMap.get("sdCard")).a(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public long b()
  {
    ...
    localObject = ((aumu)localObject).jdField_b_of_type_JavaLangString;
    try
    {
      localObject = new StatFs((String)localObject);
      long l = ((StatFs)localObject).getAvailableBlocks();
  ...
  public void b()
  {
    ...
    {
      a(1, "FMSettings free");
      Field localField = this.jdField_a_of_type_Bhpc.getClass().getSuperclass().getDeclaredField("mShowing");
      localField.setAccessible(true);
      localField.set(this.jdField_a_of_type_Bhpc, Boolean.valueOf(true));
