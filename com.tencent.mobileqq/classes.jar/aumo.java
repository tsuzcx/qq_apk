...
class aumo
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aumq(this);
  private aurg jdField_a_of_type_Aurg = new aump(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<aurf> jdField_a_of_type_JavaUtilList = new ArrayList();
  private List<aurf> b = new ArrayList();
  ...
  private void a(Intent paramIntent)
  {
    ...
    localausa.a(paramIntent.getStringExtra("closeRoomFrom"), localNewTogetherRoomMessageData);
  }
  
  private void a(Intent paramIntent, List<aurf> paramList)
  {
    int i;
    String str;
  ...
  void a(Bundle paramBundle, aurf paramaurf)
  {
    Intent localIntent = a();
    localIntent.putExtra("command_type", 4);
    localIntent.putExtra("closeRoomBundle", paramBundle);
    b(localIntent);
    this.jdField_a_of_type_JavaUtilList.add(paramaurf);
  }
  
  void a(aurf paramaurf)
  {
    this.b.add(paramaurf);
  }
