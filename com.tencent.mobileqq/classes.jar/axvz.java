  ...
  implements View.OnClickListener
{
  ...
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new axwl(this);
  EditText jdField_a_of_type_AndroidWidgetEditText;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  private aqiw jdField_a_of_type_Aqiw = new axwd(this);
  private axwr jdField_a_of_type_Axwr;
  private bdzm jdField_a_of_type_Bdzm = new axwk(this);
  ...
  private aqiw jdField_b_of_type_Aqiw = new axwm(this);
  ...
  public axvz(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Axwr = new axwr(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
    this.jdField_h_of_type_Int = zlx.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2.0F);
    this.jdField_a_of_type_Bdzm.addFilter(new Class[] { bdwp.class });
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a().a(this.jdField_a_of_type_Bdzm);
  }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    localRelativeLayout.setBackgroundResource(2130845048);
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Axwr);
    }
  ...
  private String a()
  {
    ...
    {
      if (!bgjw.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname)) {
  ...
  {
    if (paramBoolean) {}
    for (int j = 2131166980;; j = 2131166986)
    {
  ...
  private void a(URLImageView paramURLImageView, PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (paramDrawable == null)
    {
      ...
      ((GradientDrawable)localObject).setCornerRadius(bggq.a(this.jdField_a_of_type_AndroidContentContext, 15.0F));
    ...
    try
    {
      ...
      if ((paramPicInfo.jdField_c_of_type_JavaLangString != null) && (paramPicInfo.jdField_c_of_type_JavaLangString.length() > 0))
      {
        ...
        paramPicInfo.setDecodeHandler(bgey.a);
    ...
    {
      paramPicInfo = URLDrawable.getDrawable(bdwn.a(paramDrawable), localURLDrawableOptions);
      paramPicInfo.setDecodeHandler(bgey.a);
      paramURLImageView.setImageDrawable(paramPicInfo);
      return;
    }
  ...
  {
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    localRelativeLayout.setBackgroundResource(2130841343);
    Object localObject = new RelativeLayout.LayoutParams(zlx.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 35.0F), zlx.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 16.0F));
    int j = zlx.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 5.0F);
    ...
    ((TextView)localObject).setText(anni.a(2131706079));
  ...
  private boolean e()
  {
    ...
    if (!bgsp.a(str))
    {
      if (bgsp.d(str).length() == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anni.a(2131706114));
        return false;
      }
    }
    else
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anni.a(2131706038));
      return false;
    }
    return true;
  }
  ...
  private void k()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131706136));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131706104));
    ...
    this.jdField_b_of_type_AndroidViewView.findViewById(2131368947).setVisibility(8);
    TextView localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368949);
    localTextView.setVisibility(0);
    localTextView.setText(2131690582);
    localTextView.setOnClickListener(new axwe(this));
    localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368979);
    localTextView.setVisibility(0);
    localTextView.setText(2131692257);
    localTextView.setEnabled(true);
    localTextView.setOnClickListener(new axwf(this));
    this.jdField_b_of_type_AndroidViewView.findViewById(2131376599).setOnClickListener(this);
  }
  ...
  private void l()
  {
    if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      localObject = new StringBuilder(anni.a(2131706130));
  ...
  Intent a(String paramString)
  {
    ...
    paramString = anhk.ba + this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin() + "/" + "nearby_people_photo/";
    ...
    localIntent.putExtra("PhotoConst.QZONE_COVER_CROP_LEFT_TITLE", anni.a(2131706132));
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a().b(this.jdField_a_of_type_Bdzm);
  }
  ...
  public void a(int paramInt)
  {
    ...
    String str = anhk.ba + this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin() + "/" + "nearby_people_photo/";
    ...
    bgkc.anim(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, false, true);
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481F", "0X800481F", 1, 0, "", "", "", "");
  }
  ...
  void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    j = paramInt2 + 1;
    int m = paramInt3 + 1;
    localObject1 = bgjw.a(paramInt2 + 1, paramInt3 + 1);
                    ...
                    if (paramIntent != null)
                    {
                      ...
                      if ((paramInt2 == -1) && (this.jdField_d_of_type_AndroidWidgetEditText != null))
                      {
                        ...
                        if (paramInt2 == -1)
                        {
                          ...
                          try
                          {
                            paramIntent = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Anjh.a((String[])localObject2);
                            if (paramIntent != null)
                            {
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378873));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378808));
    paramView.findViewById(2131368994).setVisibility(4);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380685));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372831));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372397));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378006));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131371720));
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131367404));
    this.jdField_c_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131362285));
    this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131363088));
    this.jdField_f_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131381363));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_b_of_type_AndroidViewView.findViewById(2131365833));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView.mScrollFlag = 1;
    k();
    bfqu.b("profile_edit", "exp", "", "", "", "");
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    {
      j = ((Integer)axdz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "exp_edit", 0, 0, axei.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
      ...
      this.jdField_a_of_type_JavaLangString = anni.a(2131706124);
      label318:
      if (!this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) {
        break label857;
      }
      this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131693931));
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetEditText.setText(bght.b(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender));
      ...
      int n = (0xFF00 & k) >> 8;
      int i1 = k & 0xFF;
      paramNearbyPeopleCard = bgjw.a(n, i1);
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131381364).setOnClickListener(this);
      this.jdField_f_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131367407).setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131362287).setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131363104).setOnClickListener(this);
      this.jdField_b_of_type_ComTencentImageURLImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new axwq(this));
      this.jdField_f_of_type_AndroidWidgetEditText.addTextChangedListener(new axwb(this));
      this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new axwc(this));
      return;
      ...
      paramNearbyPeopleCard = aoch.a(paramNearbyPeopleCard, 1, paramNearbyPeopleCard.getCurrentAccountUin());
      ...
      this.jdField_a_of_type_JavaLangString = anni.a(2131706075);
      break label318;
      label857:
      if (this.jdField_a_of_type_JavaUtilArrayList.size() > NearbyPeopleProfileActivity.jdField_b_of_type_Int) {
        this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131693932, new Object[] { this.jdField_a_of_type_JavaLangString }));
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      if (paramInt != 0)
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8006784", "0X8006784", 0, 0, "", "", "", "");
      }
    }
    else
    {
  ...
  public void c()
  {
    ...
    anjh localanjh = (anjh)this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getManager(59);
    int j = localanjh.a();
    Object localObject1;
    if (j != 0)
    {
      j = localanjh.a(j, true);
      if (QLog.isColorLevel()) {
        QLog.d("Q.nearby_people_card.", 2, "startLocationSelectActivity | update result = " + j);
      }
      if (j == 2)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2131693948, 0).b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getTitleBarHeight());
        return;
      }
      if (j == 0)
      {
        ...
        localanjh.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Anjl);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131690908));
    ...
    localIntent.putExtra("param_location_param", localanjh.b((String[])localObject1));
  ...
  public void d()
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Anjh.a(arrayOfString);
  ...
  void e()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004823", "0X8004823", 0, 0, "", "", "", "");
    bfqu.b("profile_edit", "suc_edit", a(), "", "", "");
  ...
  void f()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(anni.a(2131706116));
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(this.jdField_a_of_type_JavaUtilArrayList);
    if (c())
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 10, 0, "", "", "", "");
    ...
    for (int j = 1;; j = 3)
    {
      ...
      {
        localObject = "1";
        bcst.b(null, "dc00899", "grp_lbs", "", "data_card", "upload_video", 0, 0, "", (String)localObject, "", String.valueOf(j));
        j = ((Integer)axdz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "suc_edit", 0, 0, axei.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          if (!Arrays.equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.xuanYan, (byte[])this.jdField_f_of_type_AndroidWidgetEditText.getTag()))
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 2, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 1, 0, "", "", "", "");
          }
          ...
          if (b1 != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 4, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.birthday)
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 5, 0, "", "", "", "");
          }
        }
        localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Axeq;
        if (localObject == null) {
          break label679;
        }
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a(new NearbyProfileEditTribePanel.17(this, (axeq)localObject, localBundle, localArrayList));
      }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject2;
    int k;
    if ((paramView.getId() == 2131367407) || (paramView == this.jdField_b_of_type_AndroidWidgetEditText))
    {
      localObject1 = bkho.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = (DispatchActionMoveScrollView)((bkho)localObject1).findViewById(2131361980);
      ...
      localObject2 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131561215, null);
      ((IphonePickerView)localObject2).a(this.jdField_b_of_type_Aqiw);
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new axwa(this, (IphonePickerView)localObject2, (bkho)localObject1));
        ((bkho)localObject1).a(new axwn(this));
        ((bkho)localObject1).a((View)localObject2, null);
        ((bkho)localObject1).show();
        a(paramView, ((bkho)localObject1).a());
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        if ((paramView.getId() == 2131369373) || (paramView == this.jdField_d_of_type_AndroidWidgetEditText))
        {
          g();
        }
        else if (paramView == this.jdField_b_of_type_AndroidWidgetLinearLayout)
        {
          ...
          localObject1 = bkgj.a(bkgj.a(bkgj.a(bkgj.a("https://qun.qq.com/qqweb/m/nearby/pages/school_edit.html", "_bid", "2473"), "_wv", "1031"), "schoolName", (String)localObject1), "isValid", String.valueOf(this.i));
        ...
        else if ((paramView.getId() == 2131368015) || (paramView == this.jdField_e_of_type_AndroidWidgetEditText))
        {
          c();
        }
        else
        {
          if ((paramView.getId() != 2131381364) && (paramView != this.jdField_f_of_type_AndroidWidgetEditText)) {
            break;
          }
          h();
        }
      }
      if ((paramView.getId() != 2131362287) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText)) {
        break;
      }
      localObject1 = bkho.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = Calendar.getInstance();
      this.jdField_b_of_type_Int = ((Calendar)localObject2).get(1);
      localObject3 = (DispatchActionMoveScrollView)((bkho)localObject1).findViewById(2131361980);
      ...
      localObject3 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131561215, null);
      ((IphonePickerView)localObject3).a(this.jdField_a_of_type_Aqiw);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new axwo(this, (IphonePickerView)localObject3, (bkho)localObject1));
      ...
      ((bkho)localObject1).a(new axwp(this));
      ((bkho)localObject1).a((View)localObject3, null);
      ((bkho)localObject1).show();
      a(paramView, ((bkho)localObject1).a());
    ...
    {
      if (axek.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app)) {
        break label882;
      }
      ...
      {
        axek.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, null, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.d, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.e, true);
        j = 1;
      }
    }
    for (;;)
    {
      axek.a("clk_video_entry", new String[] { "" + j, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin, "1" });
      break;
      axek.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, 2);
      j = 2;
      continue;
      if (((paramView.getId() != 2131363104) && (paramView != this.jdField_b_of_type_ComTencentImageURLImageView)) || (this.jdField_a_of_type_JavaUtilArrayList == null)) {
        break;
      }
