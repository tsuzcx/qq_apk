...
public class nau
  extends myh
{
  private static nau jdField_a_of_type_Nau;
  ...
  {
    paramString = apws.a().a(paramString);
  ...
  {
    List localList = apws.a().a(paramInt);
  ...
  private String a(mzq parammzq, String paramString)
  {
    if (("over".equals(paramString)) || (parammzq == null) || (parammzq.b() != 3))
    {
    ...
    parammzq = ((nap)parammzq).a(i);
    if (parammzq == null)
    {
      QLog.d("AvGameMusicPlayer", 1, "isVideoEffectValid() res is null ");
      return null;
    }
    parammzq = naz.a(parammzq.b(), ".mp3");
    if (!FileUtils.fileExists(parammzq))
    {
      QLog.d("AvGameMusicPlayer", 1, String.format("isVideoEffectValid() effectFile is not exist [effectFile] %s ", new Object[] { parammzq }));
      return null;
    }
    return parammzq;
  }
  ...
  public static nau a()
  {
    if (jdField_a_of_type_Nau == null) {}
    try
    {
      if (jdField_a_of_type_Nau == null) {
        jdField_a_of_type_Nau = new nau();
      }
      return jdField_a_of_type_Nau;
    }
    finally {}
  }
  ...
  private boolean a(int paramInt1, String paramString, int paramInt2, float paramFloat)
  {
    ...
    try
    {
      ...
      {
        bool1 = bool3;
        bool3 = mxh.a().a(paramInt1);
        bool1 = bool3;
        mxh.a().a(paramString, 1, paramFloat, paramInt2);
        bool2 = bool3;
        bool1 = bool3;
  ...
  {
    ngu.b().a(this);
    this.jdField_a_of_type_JavaLangString = nav.b();
  ...
  public void a(String paramString, boolean paramBoolean, float paramFloat)
  {
    ...
    {
      bcef.b(null, "dc00898", "", "", paramString, str, mzl.a().a().d(), 0, "", "", "", "");
      return;
      i = 1;
      break label86;
      break;
  ...
  public void a(mzq parammzq, String paramString)
  {
    String str = a(parammzq, paramString);
    parammzq = str;
    if (TextUtils.isEmpty(str)) {
      parammzq = this.jdField_a_of_type_JavaLangString + paramString + ".mp3";
    }
    b(parammzq, false, 0.5F);
  }
