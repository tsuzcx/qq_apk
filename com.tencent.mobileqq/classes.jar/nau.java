  ...
  implements Manager, rcu
{
  ...
  public nau(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    for (;;)
    {
      ...
      {
        String str1;
        if ((this.jdField_a_of_type_Rcw == null) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          str1 = (String)this.jdField_a_of_type_JavaUtilArrayList.remove(0);
        }
        try
        {
          Object localObject2 = new URL(str1);
          if (rcv.a().a((URL)localObject2))
          {
            b();
            if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_Rcw = new rcw();
          this.jdField_a_of_type_Rcw.jdField_a_of_type_JavaNetURL = ((URL)localObject2);
          this.jdField_a_of_type_Rcw.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
          this.jdField_a_of_type_Rcw.b = this.b;
          localObject2 = rcv.a().a(this.jdField_a_of_type_Rcw);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdPreloadManager", 2, "onFail url:" + paramrcw.jdField_a_of_type_JavaNetURL.toString());
    }
    if (paramrcw.equals(this.jdField_a_of_type_Rcw))
    {
      this.jdField_a_of_type_Rcw = null;
      b();
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdPreloadManager", 2, "onSuccess url:" + paramrcw.jdField_a_of_type_JavaNetURL.toString());
    }
    if (paramrcw.equals(this.jdField_a_of_type_Rcw))
    {
      this.jdField_a_of_type_Rcw = null;
