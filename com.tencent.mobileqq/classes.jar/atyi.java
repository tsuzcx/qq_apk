  ...
  extends Dialog
{
  ...
  public atyi(Context paramContext, ArrayList<atyk> paramArrayList)
  {
    super(paramContext, 2131755791);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new atyj(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = baxn.a(paramContext, 34.0F);
    this.jdField_a_of_type_Int = baxn.a(paramContext, 34.0F);
    a(paramArrayList);
  }
  ...
  protected void a(ArrayList<atyk> paramArrayList)
  {
    ...
    localRoundCornerLinearLayout.setBackgroundResource(2130844708);
    int i = baxn.a(this.jdField_a_of_type_AndroidContentContext, 6.0F);
    localRoundCornerLinearLayout.setPadding(0, i, 0, i);
    localRoundCornerLinearLayout.setRadius(baxn.a(this.jdField_a_of_type_AndroidContentContext, 8.0F));
    LayoutInflater localLayoutInflater = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext);
    paramArrayList = paramArrayList.iterator();
    if (paramArrayList.hasNext())
    {
      atyk localatyk = (atyk)paramArrayList.next();
      ...
      TextView localTextView2 = (TextView)localViewGroup.findViewById(2131376633);
      localTextView1.setText(localatyk.jdField_b_of_type_JavaLangString);
      if (TextUtils.isEmpty(localatyk.c))
      {
        localTextView2.setVisibility(8);
        label167:
        if (TextUtils.isEmpty(localatyk.a)) {
          break label227;
        }
        a(localImageView, localatyk.a);
      }
      for (;;)
      {
        localViewGroup.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        localViewGroup.setTag(localatyk);
        localRoundCornerLinearLayout.addView(localViewGroup);
        break;
        localTextView2.setText(localatyk.c);
        break label167;
        label227:
        if (localatyk.jdField_b_of_type_Int > 0) {
          localImageView.setImageResource(localatyk.jdField_b_of_type_Int);
        }
      }
    }
