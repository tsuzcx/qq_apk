  ...
  extends AbstractDbCacheManager
{
  ...
  protected bcfz a;
  protected String b;
  protected final ArrayList<WeakReference<bcfy>> b;
  protected String c;
  
  protected bcfx(Context paramContext, Class<? extends bcft> paramClass, long paramLong, String paramString)
  {
  ...
  public bcft a(int paramInt)
  {
    try
    {
      bcft localbcft = a(this.jdField_a_of_type_AndroidDatabaseCursor, paramInt);
      return localbcft;
    }
    finally {}
  }
  
  protected List<bcfy> a()
  {
    ...
    for (;;)
    {
      ...
      localObject2 = (bcfy)localObject1.get();
    }
    for (;;)
    {
      return localObject2;
  ...
  public void a(bcft parambcft, int paramInt)
  {
    try
    {
      a(paramInt, new bcft[] { parambcft });
      return;
    }
    finally {}
  }
  
  void a(bcfz parambcfz)
  {
    this.jdField_a_of_type_Bcfz = parambcfz;
  }
  
  public void a(bcft[] paramArrayOfbcft, int paramInt)
  {
    try
    {
      a(paramInt, paramArrayOfbcft);
      return;
    }
    finally {}
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      {
        bcfy localbcfy = (bcfy)((Iterator)localObject).next();
        if (localbcfy != null) {
          localbcfy.a(this);
        }
      }
  ...
  public void b(bcft parambcft, String paramString)
  {
    try
    {
      a(parambcft, paramString);
      return;
    }
    finally {}
  }
