  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  public bcce a;
  public bccj a;
  private bcfo jdField_a_of_type_Bcfo;
  public final bcga a;
  public bcsr a;
  ...
  public bcfx()
  {
    ...
    this.jdField_a_of_type_Bcga = new bcga();
  ...
  {
    return (TouchWebView)this.jdField_a_of_type_Bceh.a();
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Bceh.a() != null)
    {
      WebView localWebView = this.jdField_a_of_type_Bceh.a();
      localWebView.setId(2131379402);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      return;
    case 2: 
      nau.a("Web_updateTitleBarUI");
      if (this.jdField_a_of_type_Bcga.q) {
        this.jdField_a_of_type_Bccj.g();
      }
      nau.b("Web_updateTitleBarUI");
      return;
    case 3: 
      ...
      this.jdField_a_of_type_Bccj.e();
      return;
    case 4: 
      if ((this.jdField_a_of_type_Bcce.jdField_a_of_type_AndroidViewView != null) && (8 == this.jdField_a_of_type_Bcce.c.getVisibility())) {
        this.jdField_a_of_type_Bcce.a();
      }
      if (paramBundle.containsKey("Configuration")) {}
      for (paramBundle = (Configuration)paramBundle.getParcelable("Configuration"); (paramBundle != null) && (this.jdField_a_of_type_Bcce.c != null) && (paramBundle.orientation == 2) && (this.jdField_a_of_type_Bcce.c.getVisibility() == 0); paramBundle = null)
      {
        this.jdField_a_of_type_Bcce.c.setVisibility(8);
        return;
      }
    case 6: 
      if ((!this.jdField_a_of_type_Bcfo.j) && (this.jdField_a_of_type_Bcsr != null) && (this.jdField_a_of_type_Bcsr.b() != 0)) {
    ...
    for (paramBundle = paramBundle.getString("url");; paramBundle = null)
    {
      ...
      if ((localObject1 != null) && (((Uri)localObject1).isHierarchical()) && ("simple".equals(((Uri)localObject1).getQueryParameter("style"))))
      {
        ...
        this.jdField_a_of_type_Bcga.w = true;
      }
      a(this.jdField_a_of_type_Bceh.a());
      return;
      if (this.jdField_a_of_type_Bcsr != null) {
        this.jdField_a_of_type_Bcsr.a((byte)2);
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      if ((this.jdField_a_of_type_Bcga.B) || (this.jdField_b_of_type_AndroidWidgetTextView == null)) {
        break;
      }
      if ((this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_a_of_type_Int == -1)) {
        this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2131167130);
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      if (this.jdField_a_of_type_Bceh.a() == null) {
        break;
      }
      localObject1 = (TouchWebView)this.jdField_a_of_type_Bceh.a();
      ...
      for (;;)
      {
        ...
        ((TouchWebView)localObject1).setOnOverScrollHandler(new bcfy(this, (TouchWebView)localObject1, paramBundle));
        ((TouchWebView)localObject1).setOnScrollChangedListener(new bcfz(this));
        b(this.jdField_a_of_type_Bceh.a());
        return;
        label562:
  ...
  public void a(Intent paramIntent)
  {
    int i;
    boolean bool;
    if (((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x20000) != 0L) || (paramIntent.getBooleanExtra("isFullScreen", false)))
    {
      i = 1;
      if (i != 0) {
        this.jdField_a_of_type_Bcga.jdField_a_of_type_Boolean = true;
      }
      bcga localbcga = this.jdField_a_of_type_Bcga;
      if (((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x1000000) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitle", false))) {
        break label666;
      }
      bool = true;
      label76:
      localbcga.jdField_b_of_type_Boolean = bool;
      localbcga = this.jdField_a_of_type_Bcga;
      if (((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitleAndClickable", false))) {
        break label671;
      }
      bool = true;
      label115:
      localbcga.m = bool;
      localbcga = this.jdField_a_of_type_Bcga;
      if (((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x2) == 0L) && (!paramIntent.getBooleanExtra("hide_more_button", false))) {
        break label676;
      }
      bool = true;
      label156:
      localbcga.e = bool;
      localbcga = this.jdField_a_of_type_Bcga;
      if (((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("hide_operation_bar", false)) && (!"noBottomBar".equals(paramIntent.getStringExtra("webStyle")))) {
        break label681;
      }
      bool = true;
      label211:
      localbcga.f = bool;
      localbcga = this.jdField_a_of_type_Bcga;
      if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 0x100) == 0L) {
        break label686;
      }
      bool = true;
      label241:
      ...
      {
        this.jdField_a_of_type_Bcga.e = true;
        this.jdField_a_of_type_Bcga.f = true;
      }
      i = paramIntent.getIntExtra("reqType", -1);
      if ((!this.jdField_a_of_type_Bcga.f) && (i == 6)) {
        this.jdField_a_of_type_Bcga.f = true;
      }
      this.jdField_a_of_type_Bcga.g = paramIntent.getBooleanExtra("fromOneCLickCLose", false);
      if ((!this.jdField_a_of_type_Bcga.e) && ((i == 3) || (i == 1) || (!paramIntent.getBooleanExtra("ba_is_login", true)) || (i == 7))) {
        this.jdField_a_of_type_Bcga.e = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x20000) > 0L) {
        this.jdField_a_of_type_Bcga.jdField_a_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x20000000) != 0L) {
        this.jdField_a_of_type_Bcga.q = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x800) > 0L)
      {
        this.jdField_a_of_type_Bcga.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Bcga.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
      }
      if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 0x4) > 0L)
      {
        this.jdField_a_of_type_Bcga.jdField_d_of_type_Boolean = false;
        this.jdField_a_of_type_Bcga.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
      }
      if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 0x2) > 0L) {
        this.jdField_a_of_type_Bcga.h = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 0x200) > 0L) {
        this.jdField_a_of_type_Bcga.B = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 0x400) > 0L)
      {
        localbcga = this.jdField_a_of_type_Bcga;
        this.jdField_a_of_type_Bcga.z = true;
        localbcga.C = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Long & 0x2000) > 0L) {
        this.jdField_a_of_type_Bcga.p = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_d_of_type_Long & 1L) > 0L) {
        this.jdField_a_of_type_Bcga.jdField_b_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Bcga.jdField_d_of_type_Long & 0x8) > 0L) {
        this.jdField_a_of_type_Bcga.m = true;
      }
    ...
    label686:
    label691:
    while ((this.jdField_a_of_type_Bcga.jdField_a_of_type_Long & 0x80000000) <= 0L)
    {
      return;
      i = 0;
      break;
    ...
    this.jdField_a_of_type_Bcga.D = mvs.a().j(paramIntent.getStringExtra("url"));
  }
  
  public void a(Intent paramIntent, String paramString)
  {
    this.jdField_a_of_type_Bccj.a(paramIntent, paramString);
  ...
  {
    this.jdField_a_of_type_Bccj.a(paramView, paramInt1, paramInt2, paramInt3);
  }
  ...
  public void a(View paramView, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      return;
      int i;
      if ((this.jdField_a_of_type_Bcga.z) && (!"1000".equals(ThemeUtil.getCurrentThemeId()))) {
        i = 1;
      }
  ...
  {
    this.jdField_a_of_type_Bccj.a(paramTouchWebView);
  }
  ...
  public void a(WebBrowserViewContainer paramWebBrowserViewContainer, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramWebBrowserViewContainer.findViewById(2131366880));
    ...
    {
      paramWebBrowserViewContainer.b(this.jdField_a_of_type_Bcga.F);
      this.jdField_a_of_type_Bcce.a(paramWebBrowserViewContainer, this.jdField_a_of_type_AndroidViewView$OnClickListener);
      this.jdField_a_of_type_Bcce.a(this.jdField_a_of_type_AndroidAppActivity);
    }
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Bcfo.s = (l1 - l2);
    this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar = ((WebViewProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372005));
    ...
    paramIntent = this.jdField_a_of_type_Bcsr;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      nau.a("Web_qqbrowser_initView_WebViewWrapper");
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379412));
      nau.b("Web_qqbrowser_initView_WebViewWrapper");
      l2 = System.currentTimeMillis();
      this.jdField_a_of_type_Bcfo.m = (l2 - l1);
      if (!this.jdField_a_of_type_Bcga.B)
      {
        this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363421);
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363422));
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131376901));
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(4);
        if ((this.jdField_a_of_type_Bcga.jdField_b_of_type_Boolean) && ((this.jdField_a_of_type_AndroidAppActivity instanceof BaseActivity))) {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131375056));
      }
      if ((this.jdField_a_of_type_Bcga.A) && (this.jdField_b_of_type_AndroidViewView != null)) {
        this.jdField_b_of_type_AndroidViewView.setPadding(0, (int)bbdv.a(BaseApplicationImpl.getContext(), 30.0F), 0, 0);
      }
      j();
  ...
  {
    if (this.jdField_a_of_type_Bcga.g)
    {
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Bcga.jdField_a_of_type_Long = Long.parseLong(str1, 10);
    ...
    catch (NumberFormatException localNumberFormatException7)
    {
      try
      {
        this.jdField_a_of_type_Bcga.jdField_c_of_type_Long = Long.parseLong(str1, 10);
        str1 = paramString.getQueryParameter("_fu");
        this.jdField_a_of_type_Bcga.jdField_c_of_type_Boolean = false;
        if (str1 == null) {}
      }
      catch (NumberFormatException localNumberFormatException7)
      {
        try
        {
          if (Long.parseLong(str1) == 2019L) {
            this.jdField_a_of_type_Bcga.jdField_c_of_type_Boolean = true;
          }
        ...
        catch (NumberFormatException localNumberFormatException7)
        {
          try
          {
            this.jdField_a_of_type_Bcga.jdField_b_of_type_Long = Long.parseLong(str1, 10);
          ...
          catch (NumberFormatException localNumberFormatException7)
          {
            ...
            {
              String str2;
              this.jdField_a_of_type_Bcga.jdField_d_of_type_Long = Long.parseLong(str2, 10);
              str1 = paramString.getQueryParameter("channel");
              if (!TextUtils.isEmpty(str1)) {
                this.jdField_a_of_type_Bcga.jdField_a_of_type_JavaLangString = URLDecoder.decode(str1);
              }
            ...
            catch (NumberFormatException localNumberFormatException7)
            {
              try
              {
                this.jdField_a_of_type_Bcga.jdField_a_of_type_Int = Integer.parseInt(str1.trim());
              ...
              catch (NumberFormatException localNumberFormatException7)
              {
                ...
                catch (NumberFormatException localNumberFormatException7)
                {
                  try
                  {
                    for (;;)
                    {
                      this.jdField_a_of_type_Bcga.jdField_b_of_type_Int = Integer.parseInt(str1.trim());
                  ...
                  catch (NumberFormatException localNumberFormatException8)
                  {
                    ...
                    this.jdField_a_of_type_Bcga.F = false;
                  }
                }
              }
            }
  ...
  {
    this.jdField_a_of_type_Bccj.a(paramJSONObject, paramBoolean);
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bcga.n == paramBoolean) {}
    Object localObject;
    for (;;)
    {
      return;
      this.jdField_a_of_type_Bcga.n = paramBoolean;
      localObject = null;
      ...
      {
        ((View)localObject).setBackgroundColor(BaseApplicationImpl.getContext().getResources().getColor(2131166910));
        if (!paramBoolean) {
          break label98;
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          localObject = this.jdField_a_of_type_Bccj.jdField_a_of_type_AndroidViewViewGroup;
        }
      }
    }
    label98:
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Bceh.a() == null);
  ...
  public void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Bccj.a((TouchWebView)this.jdField_a_of_type_Bceh.a(), paramBoolean1, paramInt1, paramInt2, paramInt3, paramBoolean2, paramString1, paramString2, paramString3);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bcga.jdField_a_of_type_OrgJsonJSONObject == null) {
        this.jdField_a_of_type_Bcga.jdField_a_of_type_OrgJsonJSONObject = this.jdField_a_of_type_Bccj.a(paramString);
      }
    } while ((this.jdField_a_of_type_Bcga.jdField_a_of_type_OrgJsonJSONObject == null) || (this.jdField_a_of_type_Bcga.jdField_a_of_type_OrgJsonJSONObject.length() == 0));
    if (this.jdField_a_of_type_Bcga.jdField_a_of_type_OrgJsonJSONObject.optInt("trans", -1) == 0) {
      this.jdField_a_of_type_Bcga.u = true;
    }
    if (!this.jdField_a_of_type_Bcga.u) {
      this.jdField_a_of_type_Bcga.u = this.jdField_a_of_type_Bccj.a();
    }
    return true;
  }
  ...
  {
    super.b();
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Bceh.a();
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment = this.jdField_a_of_type_Bceh.a();
    this.jdField_a_of_type_Bcfo = ((bcfo)this.jdField_a_of_type_Bceh.a().a(-2));
  }
  ...
  public void b(Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("1".equals(localUri.getQueryParameter("_qStyle")))
      {
        ...
        this.jdField_a_of_type_Bcga.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = paramIntent;
        return;
      }
      WebViewTitleStyle localWebViewTitleStyle = a((String)localObject);
      if (localWebViewTitleStyle != null)
      {
        this.jdField_a_of_type_Bcga.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = localWebViewTitleStyle;
        return;
      }
      Object localObject = b((String)localObject);
      if (localObject != null)
      {
        this.jdField_a_of_type_Bcga.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = ((WebViewTitleStyle)localObject);
        return;
      }
      ...
      paramIntent = (WebViewTitleStyle)bcbw.a().a.get(paramIntent);
  ...
  {
    if (this.jdField_a_of_type_Bcga.jdField_a_of_type_Boolean) {}
    do
    {
      do
      {
        return;
      } while ((this.jdField_a_of_type_AndroidViewViewGroup != null) || (!this.jdField_a_of_type_Bcga.g));
      paramIntent = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363377);
    } while (paramIntent == null);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramIntent.inflate());
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131362984));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageView.setEnabled(false);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131366632));
  ...
  public void b(WebView paramWebView)
  {
    if (this.jdField_a_of_type_Bcga.g)
    {
      if (!this.jdField_a_of_type_Bcga.k) {
        break label26;
      }
      a(paramWebView);
    }
  ...
  {
    if ((!this.jdField_a_of_type_Bcga.g) || (this.jdField_a_of_type_Bcga.jdField_a_of_type_Boolean)) {}
    ...
    do
    {
      ...
      localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bceh.a();
    ...
    axqy.a(null, "dc00898", "", "", "0X8009B1E", "0X8009B1E", 0, 0, "", "", "", "");
    return;
    this.e = false;
    f();
    this.jdField_a_of_type_AndroidViewViewGroup.clearAnimation();
  ...
  public void c()
  {
    this.jdField_a_of_type_Bccj = bcbg.a(this);
    this.jdField_a_of_type_Bcce = bccd.a(this);
  }
  
  public void c(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bcce.a(paramBoolean);
  }
  
  public void d()
  {
    if ((this.jdField_a_of_type_Bceh.a() != null) && (!this.jdField_a_of_type_Bcga.jdField_a_of_type_Boolean)) {
      a((TouchWebView)this.jdField_a_of_type_Bceh.a());
    }
  }
  
  public void d(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bccj.jdField_a_of_type_Bcga.l = paramBoolean;
    if (paramBoolean)
    {
      this.jdField_a_of_type_Bccj.a("");
      return;
    }
    this.jdField_a_of_type_Bccj.c();
  }
  
  public void e()
  {
    ViewStub localViewStub = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363337);
    if (localViewStub == null) {
      return;
    }
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)localViewStub.inflate());
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131378013));
  ...
  public void f()
  {
    ...
    if ((this.jdField_a_of_type_Bceh.a() != null) && (this.jdField_a_of_type_AndroidViewViewGroup != null))
    {
    ...
    if (this.e)
    {
      ...
      f = this.jdField_a_of_type_Bcga.jdField_c_of_type_Int;
    }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Bcce.g != null) {
      this.jdField_a_of_type_Bcce.g.setVisibility(0);
    }
    if ((this.jdField_a_of_type_Bcce.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_Bcce.jdField_a_of_type_AndroidViewView.getVisibility() == 8) || (this.jdField_a_of_type_Bcce.jdField_a_of_type_AndroidViewView.getVisibility() == 4))) {
      this.jdField_a_of_type_Bcce.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
  }
  ...
  public void j()
  {
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_Bcga.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Bcga.jdField_a_of_type_JavaLangBoolean.booleanValue()))
    {
      i = 1;
      if (i != 0) {
        break label74;
      }
      if ((!this.jdField_a_of_type_Bcga.e) || (this.jdField_a_of_type_Bcga.h)) {
        break label69;
      }
      bool = true;
    }
    for (;;)
    {
      ...
      continue;
      label74:
      bool = this.jdField_a_of_type_Bcga.jdField_a_of_type_JavaLangBoolean.booleanValue();
    }
    label88:
    if (this.jdField_a_of_type_Bcga.jdField_d_of_type_Boolean)
    {
  ...
  public void onClick(View paramView)
  {
    ...
    TouchWebView localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bceh.a();
    ...
    do
    {
      ...
      b(localTouchWebView);
      axqy.a(null, "dc00898", "", "", "0X8009B21", "0X8009B21", 0, 0, "", "", "", "");
      return;
    ...
    b(localTouchWebView);
    axqy.a(null, "dc00898", "", "", "0X8009B20", "0X8009B20", 0, 0, "", "", "", "");
  }
}
