  ...
  extends MSFServlet
{
  ...
  {
    Object localObject = new NewIntent(paramQQAppInterface.getApp(), ayan.class);
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          paramLong = axrn.a(BaseApplication.getContext());
          ...
          if (paramMessageForPtt.istroop == 0)
          {
            ...
            ((HashMap)localObject).put("appversion", "8.3.0");
        ...
        catch (Exception paramQQAppInterface)
        {
          try
          {
            ...
            for (;;)
            {
              paramQQAppInterface = axrn.a(BaseApplication.getContext());
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      notifyObserver(paramIntent, k, bool2, paramFromServiceMsg, ayaj.class);
      return;
      break;
    }
  }
