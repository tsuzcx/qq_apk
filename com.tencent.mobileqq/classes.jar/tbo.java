...
{
  tbo(tbm paramtbm, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    tbm.a(this.jdField_a_of_type_Tbm).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.e(tbm.a(), 2, paramBundle.getMessage());
        continue;
      ...
      QLog.e(tbm.a(), 2, "build struct msg fail");
      return;
