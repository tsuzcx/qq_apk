...
public class abiw
  extends BaseAdapter
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new abix(this);
  List<ProfileLabelInfo> jdField_a_of_type_JavaUtilList;
  
  public abiw(List<ProfileLabelInfo> paramList)
  {
    Object localObject;
  ...
  private void a(ProfileLabelInfo paramProfileLabelInfo)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auaj.a().keySet().iterator();
    ...
    {
      break;
      if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auaj.a(localObject)))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auaj.c(localObject, this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auaj.a(localObject));
        return;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.getLayoutInflater().inflate(2131496888, null);
      ...
      paramViewGroup = new abiv();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131311027));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (abiv)paramView.getTag();
    }
  }
}
