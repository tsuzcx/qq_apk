...
public class blml
{
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_Blmb == null) && (!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaLangRefWeakReference != null))
    {
  ...
  private boolean a(blmn paramblmn)
  {
    return this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(paramblmn);
  }
  
  private boolean b()
  {
    if ((this.jdField_a_of_type_Blmb != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null))
    {
      AppRuntime localAppRuntime = (AppRuntime)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localAppRuntime != null)
      {
        QQIndividualityPluginProxyService.a(localAppRuntime, this.jdField_a_of_type_AndroidContentServiceConnection);
        this.jdField_a_of_type_Blmb = null;
  ...
  public void a(blmn paramblmn)
  {
    if ((this.jdField_a_of_type_Blmb != null) && (paramblmn != null))
    {
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        new Handler(localLooper).post(new QQIndividualityRemoteProxy.1(this, paramblmn));
      }
    }
    else
    {
    ...
    try
    {
      this.jdField_a_of_type_Blmb.a(paramblmn.jdField_a_of_type_Int, paramblmn.jdField_a_of_type_AndroidOsBundle);
      return;
    }
    catch (RemoteException paramblmn) {}
  }
  ...
  public boolean a(String paramString, int paramInt, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_JavaUtilHashSet.contains(paramString))
    {
      paramString = new blmn(this, paramInt, paramBundle);
      if (this.jdField_a_of_type_Blmb != null) {
        a(paramString);
      }
      for (;;)
      {
