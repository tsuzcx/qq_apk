  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<ajdu> jdField_a_of_type_JavaLangRefWeakReference;
  
  public ajdv(ajdu paramajdu, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajdu);
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	ajdv:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	ajdu:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    ajdu localajdu = (ajdu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localajdu != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localajdu.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
