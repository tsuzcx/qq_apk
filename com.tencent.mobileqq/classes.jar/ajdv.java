  ...
  extends BaseAdapter
{
  ...
  private ajdv(ClassificationSearchFragment paramClassificationSearchFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561007, paramViewGroup, false);
        ...
        localObject1 = new ajeq();
        ((ajeq)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367925));
        ((ajeq)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371826));
        ((ajeq)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380384));
        ((ajeq)localObject1).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365411));
        ((ajeq)localObject1).d = ((TextView)paramView.findViewById(2131370334));
        ((ajeq)localObject1).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$record = ((AccountSearchPb.record)getItem(paramInt));
        ((ajeq)localObject1).jdField_b_of_type_Int = ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
        paramView.setTag(2131370600, Integer.valueOf(paramInt));
        paramView.setTag(localObject1);
        localView = paramView;
        if ((((ajeq)localObject1).jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView))
        {
          ((ThemeImageView)((ajeq)localObject1).jdField_a_of_type_AndroidWidgetImageView).setSupportMaskView(false);
          localView = paramView;
        }
      }
      ...
      if (AppSetting.c)
      {
        ...
        if (paramView == null)
        {
          localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561521, null);
          paramView = new ajep();
          ...
          paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378875));
          paramView.d = ((TextView)localView.findViewById(2131363056));
          paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363671));
        ...
        paramView = (ajep)localView.getTag();
        ...
        int i = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.getResources().getDimensionPixelSize(2131297401);
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              localView.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, agej.a(110.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
              localObject2 = (ImageView)localView.findViewById(2131381271);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)localView.findViewById(2131365160);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            localView.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, agej.a(90.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
          }
        }
        localView = paramView;
        if (paramView == null)
        {
          localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131559485, null);
          localView.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
          paramView = new ajdu();
          localView.setTag(paramView);
        ...
        localObject1 = (ajdu)localView.getTag();
        if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Int == 3)
        {
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
          {
            ...
            ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131700834));
            paramView = localView;
          }
          else
          {
            ...
            if (bhnv.d(BaseApplicationImpl.getContext()))
            {
              ...
              ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
              ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131700843));
        ...
        {
          ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
          ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131700851));
          paramView = localView;
        }
        else
        {
          ...
          {
            ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            ((ajdu)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131700847));
            paramView = localView;
          }
        }
      }
