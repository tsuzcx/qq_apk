...
public class axuy
{
  ...
  public static int a()
  {
    ...
    for (int i = j;; i = 0)
    {
      j = i;
      if (i <= 0) {
        j = bfyz.H(BaseApplicationImpl.sApplication.getApplicationContext());
      }
      return j;
    }
  }
  ...
  private Drawable a(axvj paramaxvj, @Nullable Friends paramFriends, int paramInt1, int paramInt2)
  {
    ...
    if (paramaxvj != null)
    {
      ...
      paramaxvj = paramaxvj.jdField_a_of_type_MqqAppAppRuntime$Status;
      if (paramInt2 != 1) {
        break label49;
      }
      paramInt1 = 0;
      localObject1 = axvd.a(paramaxvj, paramInt1);
    }
    label49:
    label55:
    do
    ...
    label104:
    paramaxvj = URLDrawable.getDrawable(paramaxvj.b, URLDrawable.URLDrawableOptions.obtain());
    paramaxvj.setBounds(0, 0, i, i);
    return paramaxvj;
    label127:
    if (paramaxvj.jdField_a_of_type_Long == 1030L)
    {
      localObject1 = (apzf)apub.a().a(652);
      if ((localObject1 == null) || (paramFriends == null)) {
        break label326;
      }
      localObject1 = ((apzf)localObject1).a(paramFriends.weatherTypeId);
      if (QLog.isColorLevel()) {
    ...
    label326:
    for (paramFriends = ((axyf)localObject1).d;; paramFriends = "")
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramaxvj = URLDrawable.getDrawable(paramFriends, (URLDrawable.URLDrawableOptions)localObject1);
        paramaxvj.setBounds(0, 0, i, i);
        return paramaxvj;
      }
      paramaxvj = URLDrawable.getDrawable(paramaxvj.b, (URLDrawable.URLDrawableOptions)localObject1);
      paramaxvj.setBounds(0, 0, i, i);
      return paramaxvj;
      paramaxvj = URLDrawable.getDrawable(paramaxvj.b, URLDrawable.URLDrawableOptions.obtain());
      paramaxvj.setBounds(0, 0, i, i);
  ...
  public static int b()
  {
    int i = bfyz.I(BaseApplicationImpl.sApplication.getApplicationContext());
    int j = i;
  ...
  public static int c()
  {
    ...
    //   25: if_icmplt +96 -> 121
    //   28: aload_3
    //   29: invokevirtual 234	android/os/BatteryManager:isCharging	()Z
    //   32: istore_2
    //   33: aload_3
    //   34: bipush 6
    ...
    //   75: iconst_1
    //   76: iload_2
    //   77: invokestatic 241	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   80: aastore
    //   81: dup
    //   82: iconst_2
    //   83: ldc 243
  ...
  public Drawable a(long paramLong, AppRuntime.Status paramStatus, int paramInt, Friends paramFriends)
  {
    ...
    {
      axvj localaxvj = a(AppRuntime.Status.online, paramLong);
      if (localaxvj != null) {
        return a(localaxvj, paramFriends, paramInt, 3);
      }
    }
    return axvd.a(paramStatus, a(paramInt));
  }
  
  public Drawable a(axvj paramaxvj, Friends paramFriends)
  {
    return a(paramaxvj, paramFriends, 0, 1);
  }
  ...
  public axvj a(AppRuntime.Status paramStatus, long paramLong, boolean paramBoolean)
  {
    if (paramStatus == null)
    {
    ...
    label119:
    for (paramStatus = ((apzf)localObject).b(paramStatus, paramLong);; paramStatus = ((apzf)localObject).a(paramStatus, paramLong))
    {
      localObject = paramStatus;
      if (paramStatus == null) {
        localObject = new axvj(AppRuntime.Status.online);
      }
      return localObject;
      localObject = paramStatus;
      break;
    ...
    label130:
    Object localObject = (apzh)apub.a().a(578);
    if ((localObject != null) && (paramStatus == AppRuntime.Status.online)) {
      return ((apzh)localObject).a(paramStatus, paramLong);
    }
    if (localObject != null) {
      return ((apzh)localObject).a(paramStatus, 0L);
    }
    return new axvj(AppRuntime.Status.online);
  }
  ...
  public String a(long paramLong, AppRuntime.Status paramStatus)
  {
    if (paramStatus == AppRuntime.Status.online)
    {
      ...
      axvj localaxvj = a(AppRuntime.Status.online, paramLong);
      if ((localaxvj != null) && (!TextUtils.isEmpty(localaxvj.jdField_a_of_type_JavaLangString))) {
        return localaxvj.jdField_a_of_type_JavaLangString;
      }
    }
    return axvd.a(paramStatus);
  }
  
  public String a(QQAppInterface paramQQAppInterface, axvj paramaxvj, AppRuntime.Status paramStatus, Friends paramFriends, TextView paramTextView, int paramInt)
  {
    if (paramStatus == AppRuntime.Status.online)
    {
      if (paramaxvj.jdField_a_of_type_Long > 0L) {}
      for (boolean bool = true;; bool = false) {
        return a(paramQQAppInterface, paramFriends, paramTextView, 4, paramaxvj, Boolean.valueOf(bool));
      }
    }
    return b(paramQQAppInterface, paramaxvj, paramStatus, paramFriends, paramTextView, paramInt);
  }
  
  public String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView, int paramInt, axvj paramaxvj, Boolean paramBoolean)
  {
    AppRuntime.Status localStatus = a().a(paramaxvj);
    if (!Boolean.valueOf(a(paramaxvj, paramFriends, paramBoolean.booleanValue())).booleanValue())
    {
      if (paramInt == 1) {}
      for (paramQQAppInterface = ContactUtils.getStatusName(paramFriends);; paramQQAppInterface = axvv.b(paramFriends))
      {
        paramFriends = paramQQAppInterface;
        if (TextUtils.isEmpty(paramQQAppInterface)) {
          paramFriends = BaseApplicationImpl.getContext().getResources().getString(2131718588);
        }
        return paramFriends;
      }
    }
    return a().b(paramQQAppInterface, paramaxvj, localStatus, paramFriends, paramTextView, paramInt);
  }
  
  public ArrayList<axvj> a()
  {
    apzh localapzh = (apzh)apub.a().a(578);
    if (localapzh != null) {
      return localapzh.a();
    }
    return null;
  ...
  public AppRuntime.Status a(axvj paramaxvj)
  {
    if (paramaxvj != null) {
      return paramaxvj.jdField_a_of_type_MqqAppAppRuntime$Status;
    }
    return null;
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        ...
        {
          paramBoolean = axvv.b(paramQQAppInterface);
          break label139;
        }
        if (paramFriends.uExtOnlineStatus == 1040L)
        {
          paramBoolean = axvv.b(paramFriends);
          break label139;
        }
  ...
  public void a(Friends paramFriends, TextView paramTextView, boolean paramBoolean, axvj paramaxvj)
  {
    Drawable[] arrayOfDrawable = paramTextView.getCompoundDrawables();
    if (paramBoolean)
    {
    ...
    if ((ContactUtils.getFriendStatus(paramFriends.detalStatusFlag, paramFriends.iTermType) == 4) && (paramFriends.uExtOnlineStatus > 0L) && (paramaxvj != null)) {}
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        break label124;
      }
      paramFriends = a().a(paramaxvj, paramFriends);
      if (paramFriends == null) {
        break;
      }
      paramTextView.setCompoundDrawablePadding(AIOUtils.dp2px(4.0F, BaseApplicationImpl.getContext().getResources()));
  ...
  public boolean a(axvj paramaxvj)
  {
    return (paramaxvj != null) && (paramaxvj.jdField_a_of_type_Long == 1000L);
  }
  
  boolean a(axvj paramaxvj, Friends paramFriends)
  {
    return (paramaxvj.jdField_a_of_type_Long == 1030L) && (!axvv.a(paramFriends));
  }
  
  public boolean a(axvj paramaxvj, Friends paramFriends, boolean paramBoolean)
  {
    boolean bool = paramBoolean;
    if (paramBoolean)
    {
      bool = paramBoolean;
      if (axvj.a(paramaxvj.jdField_a_of_type_Long)) {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      {
        paramBoolean = bool;
        if (!axvv.a(paramFriends)) {
          paramBoolean = false;
        }
      }
      bool = paramBoolean;
      if (paramaxvj.jdField_a_of_type_Long == 1040L)
      {
        bool = paramBoolean;
        if (!axvv.b(paramFriends)) {
          bool = false;
        }
      }
      paramBoolean = bool;
      if (paramaxvj.jdField_a_of_type_Long == 40001L)
      {
        paramBoolean = bool;
        if (!axvv.b(paramaxvj)) {
          paramBoolean = false;
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, View paramView)
  {
    ...
    {
      paramView = ((amsw)paramQQAppInterface.getManager(51)).e(paramSessionInfo.curFriendUin);
      boolean bool;
      ...
      do
      {
        do
        {
          ...
          paramQQAppInterface = (apzf)apub.a().a(652);
        ...
        axyg.a.a(paramActivity, paramQQAppInterface, 4014);
        axvz.a("0X800AF4C", 2);
        return true;
      } while (paramQQAppInterface.jdField_a_of_type_Long != 1040L);
      label207:
      axyg.a.a(paramActivity, paramView.constellationJumpUrl, 4014);
      axvz.a("0X800AF4C", 1);
      return true;
    }
    return false;
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    while (localFriends != null)
    {
      ...
      {
        if (paramQQAppInterface.jdField_a_of_type_Long == 1030L) {
          return axvv.a(localFriends);
        }
        if (paramQQAppInterface.jdField_a_of_type_Long == 1040L) {
          return axvv.b(localFriends);
        }
      }
    }
    return false;
  ...
  public String b(QQAppInterface paramQQAppInterface, axvj paramaxvj, AppRuntime.Status paramStatus, Friends paramFriends, TextView paramTextView, int paramInt)
  {
    if ((paramStatus == AppRuntime.Status.online) && (paramaxvj != null))
    {
      if ((paramaxvj.jdField_a_of_type_Long == 1000L) && (paramFriends != null)) {
      ...
      do
      {
        ...
        if ((paramaxvj.jdField_a_of_type_Long == 1028L) && (paramFriends != null)) {
          return axys.a(paramQQAppInterface, paramFriends, paramTextView);
        }
        if ((paramaxvj.jdField_a_of_type_Long == 1030L) && (paramFriends != null)) {
          return axvv.a(paramQQAppInterface, paramTextView, paramFriends, paramInt);
        }
        if ((paramaxvj.jdField_a_of_type_Long != 1040L) || (paramFriends == null)) {
          break;
        }
        paramQQAppInterface = axyi.b(paramFriends);
        if (QLog.isColorLevel()) {
          QLog.d("OnLineStatusHelper", 2, new Object[] { "getAIOStatusName: invoked. ", " suitableTrend: ", paramQQAppInterface });
        }
      } while (axvv.b(paramFriends));
      return "";
      if (paramaxvj.jdField_a_of_type_Long > 40001L)
      {
        if (!TextUtils.isEmpty(paramaxvj.jdField_a_of_type_JavaLangString))
        {
          long l = paramFriends.autoStatusUpdateSecond;
          paramStatus = axvv.a(NetConnInfoCenter.getServerTime(), l);
          QLog.d("OnLineStatusHelper", 1, new Object[] { "getAIOStatusName: invoked. [status-time] ", " passTimeStr: ", paramStatus, " autoStatusUpdateSecond: ", Long.valueOf(l), " extOnlineStatus.title: ", paramaxvj.jdField_a_of_type_JavaLangString, " friend.uin: ", paramFriends.uin, " during second: ", Long.valueOf(NetConnInfoCenter.getServerTime() - l) });
          if ((TextUtils.isEmpty(paramStatus)) || (paramQQAppInterface.getCurrentAccountUin().equals(paramFriends.uin))) {
            return paramaxvj.jdField_a_of_type_JavaLangString;
          }
          return paramaxvj.jdField_a_of_type_JavaLangString + String.format("(%s)", new Object[] { paramStatus });
        }
        return "";
      }
      if (paramaxvj.jdField_a_of_type_Long == 40001L)
