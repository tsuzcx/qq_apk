...
public class qrd
  extends nkq
{
  public qrd(RIJRedPacketManager paramRIJRedPacketManager, int paramInt, qrh paramqrh) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      for (;;)
      {
        ...
        int n;
        label634:
        this.jdField_a_of_type_Qrh.a(false);
        label663:
        label669:
    ...
    if (((cmd0xe23.GetConsumeInfoItem)paramBundle.rpt_consume_info_item.get()).need_record.has())
    {
      ...
      if (((cmd0xe23.GetConsumeInfoItem)paramBundle.rpt_consume_info_item.get()).next_request_time.has())
      {
        ...
        else
        {
          ...
          {
            break label812;
            paramArrayOfByte = this.jdField_a_of_type_Qrh;
            if ((paramInt == 0) || (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRedpacketRIJRedPacketManager.b())) {
              break label663;
            }
            bool1 = true;
