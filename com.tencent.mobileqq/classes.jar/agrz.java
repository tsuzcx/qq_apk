  ...
  extends agrt
{
  ...
  public agrz(BaseChatPie paramBaseChatPie)
  {
  ...
  private void m()
  {
    ...
    agws localagws = (agws)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(55);
    if (localagws != null) {
      localagws.e();
    }
    aiad.e();
  ...
  protected View a()
  {
    this.jdField_a_of_type_ComTencentMobileqqTroopTroopappsTroopAppShortcutContainer = new agsa(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), 1);
  ...
  public void i()
  {
    ...
    try
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a != null) && (bgqr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a.a))))
      {
        bgkq localbgkq = (bgkq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(171);
        ...
        if ((localObject != null) && (localbgkq != null))
        {
          localbgkq.a(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a.a), (int)((TroopInfo)localObject).dwGroupClassExt);
          return;
        }
      }
    }
