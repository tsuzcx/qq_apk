  ...
  implements biwy
{
  ...
  public bizi(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    bize.a("WadlJsBridge", "##@!JsCheckUpdateCallback onException >>> " + paramString);
  ...
  {
    bize.c("WadlJsBridge", "##@checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
