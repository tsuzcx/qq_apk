...
{
  anob(annx paramannx, RelativeLayout.LayoutParams paramLayoutParams, View paramView1, View paramView2) {}
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    do
    {
      ...
      int i = (int)(-this.jdField_a_of_type_Annx.a * (1.0F - f));
    ...
    } while (!this.jdField_a_of_type_Annx.e);
    this.b.setAlpha(f);
  }
}
