...
{
  public static int a;
  private amsu jdField_a_of_type_Amsu = new aicn(this);
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new aicm(this);
  ...
  public aicl(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_ComTencentMobileqqAppCardObserver);
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Amsu);
  }
  
  public static aicl a(QQAppInterface paramQQAppInterface)
  {
    return (aicl)paramQQAppInterface.getManager(332);
  }
  ...
  private void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((!paramBoolean) && (a(paramBundle.getInt("friend_setting"))))
    {
      ...
      a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), str, i, j, paramBundle);
    }
  }
  ...
  public aick a()
  {
    return (aick)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(158);
  }
  ...
  public void a()
  {
    ...
    if (jdField_a_of_type_Int > 0) {
      bcef.b(null, "dc00898", "", "", "0X800A3A3", "0X800A3A3", 0, jdField_a_of_type_Int, 0, "", "", "", "");
    }
