  ...
  implements Handler.Callback
{
  ...
  private boolean W;
  private anmu jdField_a_of_type_Anmu = new aics(this);
  private anqd jdField_a_of_type_Anqd = new aicr(this);
  asgf jdField_a_of_type_Asgf = new aict(this);
  private volatile ExtendFriendUserInfo jdField_a_of_type_ComTencentMobileqqDataExtendFriendUserInfo;
  private MessageRecord jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
  private Comparator<MessageRecord> jdField_a_of_type_JavaUtilComparator = new aicm(this);
  private Observer jdField_a_of_type_JavaUtilObserver = new aicq(this);
  private long e;
  private long f;
  private String g;
  private String h = "0";
  ...
  public aicl(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private boolean F()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1044) {
      ...
      {
        localaskk = (askk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(292);
        if (localaskk == null) {
          break label66;
        }
      }
    ...
    label66:
    for (bool = localaskk.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).booleanValue();; bool = false)
    {
      return bool;
  ...
  private void bA()
  {
    if (!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 1, this.jdField_a_of_type_AndroidContentContext.getString(2131697995), 0).a();
    }
  }
  ...
  private void br()
  {
    ...
    {
      this.h = asli.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
      ThreadManager.getSubThreadHandler().post(new LimitChatPie.6(this, str));
      this.t = asli.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  private void bu()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = (asfs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127);
          if (localObject != null) {
            ((asfs)localObject).a(localArrayList);
          }
        }
        return;
  ...
  private void bx()
  {
    ...
    {
      localbgpa = bglp.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230).setMessage(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131697599)).setPositiveButton(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131694081), new aicp(this)).setNegativeButton(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131690582), new aico(this));
      localbgpa.setCancelable(false);
    }
    try
    {
      localbgpa.show();
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800ADC8", "0X800ADC8", 0, 0, "", "", "", "");
      return;
    }
    catch (Exception localException)
    {
  ...
  private void by()
  {
    this.V = ((anjo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4)).b();
    ((askk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(292)).a(this.V);
  }
  ...
  public void H()
  {
    ...
    ((aiyr)this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.app.getManager(34)).deleteObserver(this.jdField_a_of_type_JavaUtilObserver);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null) {
      if (this.U)
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A695", "0X800A695", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A692", "0X800A692", 0, 0, String.valueOf(l1 - l2), "", this.h, "");
      return;
      String str = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
      break;
      label195:
      if ((this.u > 0) || (this.v > 0)) {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A694", "0X800A694", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    super.K();
    ((asfs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
  }
  ...
  public void a(Object paramObject)
  {
    ...
    default: 
      return;
    case 4: 
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AA", "0X80096AA", this.w, 0, "", "", "", "");
      return;
    case 2: 
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096A9", "0X80096A9", this.w, 0, "", "", "", "");
      return;
    case 5: 
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AB", "0X80096AB", this.w, 0, "", "", "", "");
      return;
    case 24: 
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AC", "0X80096AC", this.w, 0, "", "", "", "");
      return;
    }
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AD", "0X80096AD", this.w, 0, "", "", "", "");
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bs();
    ((aiyr)this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.app.getManager(34)).addObserver(this.jdField_a_of_type_JavaUtilObserver);
  ...
  {
    super.b(paramIntent);
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(new aicu(this));
  }
  ...
  public void bo()
  {
    ...
    for (;;)
    {
      if (j != 0)
      {
        String str = ((asfu)localObject).c();
        localObject = ((asfu)localObject).d();
        if (!TextUtils.isEmpty(str))
        {
          asli.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, k);
          this.t = k;
  ...
  public void bp()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A693", "0X800A693", 0, 0, "", "", "", "");
  }
  ...
  public void j()
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar = new VideoStatusTipsBar(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Aimj, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_MqqOsMqqHandler);
    this.jdField_a_of_type_Aimj.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar);
  }
  ...
  public void r()
  {
    if (Boolean.valueOf(F()).booleanValue())
    {
      ...
      this.d.setOnClickListener(new aicn(this));
      return;
    }
