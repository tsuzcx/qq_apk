  ...
  extends aibn
{
  ...
  ahzr jdField_a_of_type_Ahzr;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aicp(this);
  ...
  public aicl(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aicm(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131367807)).setOnClickListener(new aicn(this));
    Button localButton = (Button)findViewById(2131363520);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new aico(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Ahzr = new ahzr(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bhoe, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ahzr);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new aicq(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new aicr(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new aics(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new aict(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Ahzr.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Ahzr.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  
  public void a(List<TroopLinkElement> paramList)
  {
    this.jdField_a_of_type_Ahzr.a(paramList);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131706489));
        ...
        {
          this.jdField_a_of_type_Ahzr.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
      ...
      this.jdField_a_of_type_Ahzr.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Ahzr.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131706490));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131372313).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Ahzr.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Ahzr.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ahzr);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
