...
public class ayqt
{
  private static final String a = ayqt.class.getSimpleName();
  
  public static boolean a(Activity paramActivity, String paramString)
  {
    if (QLog.isColorLevel()) {
      bjko.b(a, "enter now live room. mqqapi= " + paramString);
    }
    try
    {
    ...
    {
      if (QLog.isColorLevel()) {
        bjko.b(a, "enter now live room error: " + paramActivity.getMessage());
      }
    }
    return false;
  }
  ...
  public static boolean a(Activity paramActivity, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        bmar.a(paramActivity, 2131694266, 1);
        return false;
      }
