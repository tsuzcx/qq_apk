...
public class xti
  extends Handler
{
  public xti(EditLocalVideoActivity paramEditLocalVideoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1100: 
      do
      {
        ...
        new AlertDialog.Builder(this.a).setMessage("初始化裁剪组件失败").setNegativeButton(2131428346, new xtj(this)).setCancelable(false).create().show();
        return;
    ...
    case 9999: 
      ...
      try
      {
        new AlertDialog.Builder(this.a).setMessage("加载视频超时").setNegativeButton(2131428346, new xtk(this)).setCancelable(false).create().show();
        return;
      }
