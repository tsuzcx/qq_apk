...
public class arfr
{
  ...
  public arey a;
  protected arfo a;
  private arfu jdField_a_of_type_Arfu = new arfs(this);
  ...
  public arfr(LyricView paramLyricView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewScroll.setScrollListener(this.jdField_a_of_type_Arfu);
  }
  
  private void d()
  {
    this.jdField_a_of_type_Arey = this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal.a();
    arey localarey = this.jdField_a_of_type_Arey;
    if ((localarey == null) || (localarey.a()) || (this.jdField_a_of_type_Boolean))
    {
  ...
  public void a()
  {
    ...
    arfd.a().post(new LyricViewController.4(this));
  ...
  public void a(int paramInt)
  {
    ...
    arfd.a().post(new LyricViewController.5(this, paramInt));
  }
  ...
  public void a(arey paramarey1, arey paramarey2, arey paramarey3)
  {
    Log.v("ModuleController", "setLyric begin");
    arfd.a().post(new LyricViewController.3(this, paramarey3, paramarey1, paramarey2));
  }
  ...
  protected void b(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Arey != null) || (this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal != null))
    {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Arey.a.size()))
    {
      if (this.jdField_a_of_type_Arey.a.get(paramInt) == null)
      {
        Log.w("ModuleController", "onScrollStop -> current sentence is null");
        return;
      }
      long l2 = ((arfa)this.jdField_a_of_type_Arey.a.get(paramInt)).jdField_a_of_type_Long;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Arfo.a(l1);
  ...
  protected void c(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Arey.a.size()))
    {
      ...
      for (;;)
      {
        ...
        l1 = l2 / 10L;
        this.jdField_a_of_type_Arfo.b((l1 + 1L) * 10L);
        return;
        label178:
        l1 = l2;
        if (this.jdField_b_of_type_Int >= 0)
