  ...
  extends baww
{
  ...
  public baxa()
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new baxb(this);
  }
  
  public long a()
  {
    if ((this.jdField_a_of_type_Bayd != null) && (this.jdField_a_of_type_Bayd.a != null)) {
      return this.jdField_a_of_type_Bayd.a.getCurPlayingPos();
    }
    return 0L;
  }
  ...
  public Intent a(AIOFileVideoData paramAIOFileVideoData, Activity paramActivity)
  {
    ...
    if ((paramAIOFileVideoData != null) && (RichMediaBrowserManager.getInstance().getProvider() != null) && (RichMediaBrowserManager.getInstance().getProvider().isPingBinder()))
    {
      ...
      if (localIntent != null)
      {
        ...
        for (;;)
        {
          baxo.a(paramActivity, localIntent, bool);
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramInt2 == 269484034)
      {
        ...
        if ((paramString != null) && ((paramString.baseData instanceof AIOBrowserBaseData)) && (((AIOBrowserBaseData)paramString.baseData).jdField_a_of_type_Long == paramLong)) {
          if (paramBoolean)
          {
            ...
            QQToast.a(this.jdField_a_of_type_Bayd.mContext, 2, this.jdField_a_of_type_Bayd.mContext.getString(2131717408), 0).a();
          }
        }
      }
      for (;;)
      {
        ...
        label283:
        if (paramInt3 == 2) {
          QQToast.a(this.jdField_a_of_type_Bayd.mContext, 1, this.jdField_a_of_type_Bayd.mContext.getString(2131717423), 0).a();
        }
      }
      paramBoolean = false;
    }
  ...
  {
    this.jdField_a_of_type_Bayd.a(paramLong, paramInt1, paramInt2, paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3, paramBundle);
  }
  ...
  public void a(AIOFileVideoData paramAIOFileVideoData)
  {
    ...
    localIProvider.onFileVideoStatusChange(paramAIOFileVideoData.jdField_a_of_type_Long, 11, null);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bawx != null) && (this.jdField_a_of_type_Bawx.a != null) && (this.jdField_a_of_type_Bawx.a() != null))
    {
      ...
      if (localAIOFileVideoData != null) {
        bool = bgmg.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString);
      }
      if (bool)
      {
        if (!bqcd.b()) {
        ...
        this.jdField_a_of_type_Bawx.a().a((int)afur.a(bqcd.jdField_a_of_type_Int, this.jdField_a_of_type_Bayd.mContext.getResources()) + 46);
      }
    }
    for (;;)
    {
  ...
  public boolean b()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AIOFileVideoPresenterXOXO", 2, "isImmersionOpen, ImmersiveConfProcessor.isVideoEnable() = " + aqgz.b());
    }
    return aqgz.b();
  }
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof bayd)) {
      this.jdField_a_of_type_Bayd = ((bayd)paramBrowserBaseView);
    }
  }
}
