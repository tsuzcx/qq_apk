  ...
  extends lja
{
  ...
  public ljc(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public boolean a(int paramInt, String paramString)
  {
    if (!this.jdField_a_of_type_Boolean) {
      bdst.a().postDelayed(new SupportFace.1(this), 1100L);
    }
    lcg.c("SupportFace", "onReceiveSupportMessage type:" + paramInt + "|" + paramString);
    if (paramString != null)
    {
    ...
    do
    {
      ...
      {
        this.f = 1;
        lcg.c("SupportFace", "onReceiveSupportMessage  support reason 1:");
        return false;
      }
      return true;
      if (paramString.equals("SUPPORT_FALSE"))
      {
        ...
        for (;;)
        {
          ...
          {
            this.f = 0;
            lcg.c("SupportFace", "onReceiveSupportMessage not support reason 1:");
          }
        }
      }
      ...
      if (paramString.equals("SUPPORT_CREATIVECOP_TRUE"))
      {
        ...
        {
          this.f = 1;
          lcg.c("SupportFace", "onReceiveSupportMessage  support reason 2:");
        }
        return true;
      }
    ...
    {
      this.f = 0;
      lcg.c("SupportFace", "onReceiveSupportMessage  not support reason 2:");
    }
    return true;
  }
  ...
  {
    boolean bool2 = ljd.b();
    if (axeh.a(BaseApplicationImpl.getContext()) == 1) {}
    boolean bool3;
    boolean bool4;
    boolean bool5;
    boolean bool6;
  ...
  public void c()
  {
    ...
    this.e = -1;
    this.f = -1;
    lcg.c("SupportFace", "SupportFace restore:");
  }
}
