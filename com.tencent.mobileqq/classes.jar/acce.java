  ...
  extends ClickableSpan
{
  ...
  public acce(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString, int paramInt4, MessageForNearbyMarketGrayTips paramMessageForNearbyMarketGrayTips)
  {
  ...
  public void c(String paramString)
  {
    ...
    ThreadManager.post(new acci(this, localQQAppInterface), 2, null, false);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        {
          ThreadManager.post(new accf(this), 5, null, true);
          return;
        }
        c(paramView);
        return;
      ...
      for (String str = "2";; str = "1")
      {
        ...
        ThreadManager.post(new accg(this, localQQAppInterface), 5, null, true);
        return;
        paramView = "1";
        break;
      }
      ...
      if (TextUtils.isEmpty(paramView))
      {
        ThreadManager.post(new acch(this), 5, null, true);
        return;
      }
      c(paramView);
    } while (!QLog.isColorLevel());
