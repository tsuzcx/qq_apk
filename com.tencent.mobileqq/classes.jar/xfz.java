...
public class xfz
  implements ajmb, ajzp, IMemoryManager, IAppStateChangeListener
{
  private static xfz jdField_a_of_type_Xfz;
  ...
  private Vector<xga> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  public static xfz a()
  {
    if (jdField_a_of_type_Xfz == null) {}
    try
    {
      if (jdField_a_of_type_Xfz == null) {
        jdField_a_of_type_Xfz = new xfz();
      }
      return jdField_a_of_type_Xfz;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          awrn.a(BaseApplicationImpl.getApplication()).a((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  {
    a(2);
    xfx.a(BaseApplicationImpl.class.getClassLoader());
  }
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          if (!ajlz.a().a.jdField_a_of_type_Boolean) {
            break label531;
          }
          str1 = "1";
          localHashMap.put("ClearEnable", str1);
          localHashMap.put("DpcConfigId", ajlz.a().a.jdField_a_of_type_JavaLangString);
          ...
          label396:
          awrn.a(BaseApplicationImpl.getApplication()).a(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    xfv localxfv = ajlz.a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localxfv.jdField_a_of_type_Boolean + "configId" + localxfv.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramxfw.jdField_b_of_type_Int * localxfv.jdField_b_of_type_Int * 1000)) && (localxfv.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramxfw);
      return;
    }
    catch (Exception paramxfw)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramxfw);
    }
  }
  ...
  public void a(xga paramxga)
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramxga);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", ajox.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        awrn.a(BaseApplicationImpl.getApplication()).a(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", ajox.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", awri.a().a());
      ((SharedPreferences.Editor)localObject).putInt("hackArtResult", HackVm.jdField_d_of_type_Int);
      ((SharedPreferences.Editor)localObject).putString("clear_config_id", ajlz.a().a.jdField_a_of_type_JavaLangString);
      ((SharedPreferences.Editor)localObject).putBoolean("clear_config_enable", ajlz.a().a.jdField_a_of_type_Boolean);
  ...
  public void b(int paramInt, xfw paramxfw)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((xga)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramxfw.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramxfw.a > 0.0F) && (paramxfw.a < 1.0F))
          {
            l4 = MemoryManager.a() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramxfw.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramxfw.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramxfw.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramxfw = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramxfw.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramxfw.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramxfw = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramxfw.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramxfw.next();
              ...
              break label1465;
              label842:
              paramxfw = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramxfw.length < 2) {
                break label1522;
              }
              if ((paramxfw[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramxfw[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramxfw[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramxfw[1].toString());
              i1 = i2;
              break label1522;
            }
          }
  ...
  public void b(xga paramxga)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramxga);
      return;
    }
  }
  ...
  public final void d()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
