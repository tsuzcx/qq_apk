  ...
  implements DialogInterface.OnCancelListener
{
  ...
  private void a()
  {
    ...
    if (k < m)
    {
      ...
      if ((k == 0) && (m == 1))
      {
        ...
        {
        default: 
          j = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165735);
        }
      }
      for (;;)
      {
        ...
        break label63;
        j = -16777216;
        ((Button)localObject1).setTextSize(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297223));
        ((Button)localObject1).setClickable(false);
        ((Button)localObject1).setVisibility(8);
        a(((Button)localObject1).getText().toString());
        continue;
        j = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165738);
        continue;
        bfgl.a(getContext(), 8.0F);
        j = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165735);
        localObject2 = new SpannableString(((Button)localObject1).getText());
        Object localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840859);
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      ((Button)localObject2).setText(2131694209);
  ...
  public TextView a(String paramString)
  {
    try
    {
      ...
      localLayoutParams.height = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297191));
      localLayoutParams.gravity = 17;
      localButton.setLayoutParams(localLayoutParams);
      localButton.setTextSize(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297223));
      localButton.setText(paramString);
      localButton.setTextColor(-16777216);
      localButton.setBackgroundResource(2130840711);
      localButton.setClickable(false);
      return localButton;
    }
    catch (Exception paramString)
    {
      betc.d("ActionSheetDialog", "e:" + paramString.toString());
    }
    return null;
  }
