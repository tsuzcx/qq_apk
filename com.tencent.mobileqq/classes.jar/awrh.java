...
public class awrh
{
  ...
  private awrk a(String paramString1, String paramString2)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString1.has("num")) {
          localawrk.jdField_a_of_type_Int = paramString1.getInt("num");
        }
        if (paramString1.has("process_frame"))
        {
          ...
          if (((JSONObject)localObject).has("repeat")) {
            localawrk.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("repeat");
          }
          if (((JSONObject)localObject).has("frame_delay")) {
            localawrk.c = ((JSONObject)localObject).getInt("frame_delay");
          }
          localObject = ((JSONObject)localObject).getJSONArray("seq_array");
          if ((localObject != null) && (((JSONArray)localObject).length() > 0))
          {
            localawrk.jdField_a_of_type_ArrayOfJavaLangString = new String[((JSONArray)localObject).length()];
            i = 0;
            while (i < ((JSONArray)localObject).length())
            {
              localawrk.jdField_a_of_type_ArrayOfJavaLangString[i] = (EmoticonUtils.pngFramePath.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
              i += 1;
            }
          }
        }
        Object localObject = paramString1.getJSONArray("result_frame");
        paramString1 = localawrk;
        if (localObject == null) {
          continue;
        }
        paramString1 = localawrk;
        ...
        localawrk.jdField_b_of_type_ArrayOfJavaLangString = new String[((JSONArray)localObject).length()];
        int i = j;
        for (;;)
        {
          paramString1 = localawrk;
          ...
          localawrk.jdField_b_of_type_ArrayOfJavaLangString[i] = (EmoticonUtils.pngFramePath.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
          i += 1;
        }
        return localawrk;
      }
