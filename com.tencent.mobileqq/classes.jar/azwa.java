...
public class azwa
  extends azwd
{
  public azwa(QQAppInterface paramQQAppInterface)
  {
  ...
  public Long a(MessageForPtt paramMessageForPtt)
  {
    ...
    new azwb(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPtt, Long.valueOf(l)).a();
