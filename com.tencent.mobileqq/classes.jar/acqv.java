  ...
  implements acqj
{
  ...
  public static GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      acqy.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      Object localObject1;
      if (localGdtAd.getImageData() == null)
      {
        ...
        if (paramAdInfo != null) {
          localObject1 = acqx.a(paramAdInfo);
        }
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (acpp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(acpp paramacpp, String paramString, String... paramVarArgs)
  {
    ...
    {
      acqy.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    String str2 = "";
    for (;;)
    {
      try
      {
        acqy.a("GdtOpenMvPageHandler", "args = " + paramVarArgs[0]);
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          k = i;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(acqx.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramVarArgs)));
        }
        ...
        try
        {
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramacpp.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramacpp == null) {
            break label377;
          }
