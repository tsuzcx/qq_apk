...
{
  augt(Intent paramIntent, int paramInt, Activity paramActivity, QQAppInterface paramQQAppInterface) {}
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Int == 2) {
          aukj.a(this.jdField_a_of_type_AndroidAppActivity, "shareToQQ", l, 0, aukj.a);
        }
        while (this.jdField_a_of_type_Int == 1)
        {
          ForwardUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X800A740", new String[0]);
          return;
          aukj.a(l, i, this.jdField_a_of_type_AndroidAppActivity, null);
        }
      ...
      while (this.jdField_a_of_type_Int == 1)
      {
        ...
        if (this.jdField_a_of_type_Int == 3) {
          ...
          aukj.a(l, i, this.jdField_a_of_type_AndroidAppActivity);
        }
      }
      if (this.jdField_a_of_type_Int == 0)
      {
