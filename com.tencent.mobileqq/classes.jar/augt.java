...
public class augt
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, aues paramaues, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramaues == null) || (paramaues.b)) {
          break label519;
        }
        paramaues.b = true;
        if ((paramInt == 1) && (paramaues.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramaues, paramInt);
        paramaues = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramaues)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramaues.toString() + ",filePath:" + paramString2);
        paramaues = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramaues = (aues)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramaues);
      if (QLog.isColorLevel())
      {
        if (paramaues != null) {
          continue;
