...
{
  aeic(Context paramContext, int paramInt, URLDrawable paramURLDrawable, QQAppInterface paramQQAppInterface, StructMsgForImageShare paramStructMsgForImageShare, PicMessageExtraData paramPicMessageExtraData) {}
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    paramVarArgs = aehy.a(this.jdField_a_of_type_AndroidContentContext, paramVarArgs);
    if (paramVarArgs != null)
    {
      aehy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, paramVarArgs);
      return Integer.valueOf(2);
    }
    paramVarArgs = this.jdField_a_of_type_ComTencentImageURLDrawable.getURL().toString();
    if (!ayog.b(paramVarArgs))
    {
    ...
    File localFile = ayog.a(paramVarArgs);
    if (localFile != null) {}
    for (paramVarArgs = SecUtil.getFileMd5(localFile.getAbsolutePath());; paramVarArgs = null)
    {
      ...
      {
        paramVarArgs = ajsf.bh + akvu.a(str2) + paramVarArgs + str1 + ".jpg";
        try
        {
          bbdj.a(localFile, new File(paramVarArgs));
          return Integer.valueOf(aehy.a(this.jdField_a_of_type_AndroidContentContext, paramVarArgs, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, this.jdField_a_of_type_ComTencentMobileqqDataPicMessageExtraData));
        }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      bcpw.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131695181, 0).b(this.jdField_a_of_type_Int);
      askd.c("2004", 1);
    }
    while (paramInteger.intValue() != 2) {
      return;
    }
    bcpw.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, 2131689687, 0).b(this.jdField_a_of_type_Int);
    askd.c("2003", 1);
  }
}
