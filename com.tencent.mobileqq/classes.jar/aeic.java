...
{
  public aeic(ImageFeedsUploader paramImageFeedsUploader) {}
  ...
  public void a(PicFeedUploadInfo paramPicFeedUploadInfo, VideoFeedsUploader.UploadResult paramUploadResult)
  {
    ...
    ThreadManager.getUIHandler().post(new aeie(this, paramPicFeedUploadInfo, paramUploadResult));
  }
  
  public void b(PicFeedUploadInfo paramPicFeedUploadInfo)
  {
    ThreadManager.getUIHandler().post(new aeid(this));
  }
}
