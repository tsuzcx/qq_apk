...
{
  private awpq(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
  
  private void a(awpp paramawpp, PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    if (this.a.jdField_b_of_type_Boolean)
    {
      if (paramawpp.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramawpp.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramawpp.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramawpp.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramawpp.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramawpp.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramawpp.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramawpp.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      paramawpp.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramawpp.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramawpp.jdField_b_of_type_AndroidViewView.setTag(2131362117, Integer.valueOf(4));
      paramawpp.jdField_b_of_type_AndroidViewView.setTag(2131365065, paramawpp);
      paramawpp = paramawpp.jdField_b_of_type_AndroidWidgetImageView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label384;
      }
    }
    ...
    {
      paramawpp.setImageResource(i);
      return;
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        if (paramawpp.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramawpp.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        if (paramawpp.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramawpp.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        ...
        if (paramawpp.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
          paramawpp.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
        paramawpp.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
        paramawpp.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        paramawpp.jdField_b_of_type_AndroidViewView.setTag(2131362117, Integer.valueOf(1));
        break;
      }
      if (paramawpp.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramawpp.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramawpp.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramawpp.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramawpp.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramawpp.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramawpp.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramawpp.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      paramawpp.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramawpp.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramawpp.jdField_b_of_type_AndroidViewView.setTag(2131362117, Integer.valueOf(3));
      break;
    }
  }
  ...
  private void b(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    ...
    bdfa.anim(this.a, false, true);
  }
  
  public void a(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    bjea localbjea = bjea.a();
    localbjea.a = this.a.app.getCurrentAccountUin();
    localbjea.b = this.a.app.getCurrentNickname();
    Bundle localBundle = new Bundle();
    localBundle.putString("key_title", this.a.getString(2131718431));
    ...
    bjdt.a(this.a, localbjea, localBundle, 1);
  }
  
  void a(PersonalityLabelInfo paramPersonalityLabelInfo, awpp paramawpp)
  {
    String str = paramawpp.jdField_b_of_type_AndroidWidgetTextView.getText().toString();
    if (paramPersonalityLabelInfo.praiseCount > 0L)
    {
      ...
      if (!TextUtils.equals(paramPersonalityLabelInfo, str)) {
        paramawpp.jdField_b_of_type_AndroidWidgetTextView.setText(paramPersonalityLabelInfo);
      }
      paramPersonalityLabelInfo = paramawpp.jdField_b_of_type_AndroidWidgetTextView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label375;
      }
    }
    ...
    for (float f = 0.5F;; f = 1.0F)
    {
      ...
      return;
      paramPersonalityLabelInfo = this.a.getResources().getString(2131699662);
      break;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2131561139, paramViewGroup, false);
      paramViewGroup = new awpp(null);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131367411);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369125));
      ...
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365065));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380390));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView = ((GlowCountRecyclerView)paramView.findViewById(2131375543));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380392));
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131377925);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131364736);
      ...
      localObject1 = new awpo(this.a, null);
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (awpp)paramView.getTag();
    }
    paramViewGroup.jdField_a_of_type_Long = ((PersonalityLabelInfo)localObject1).id;
    Object localObject2 = (Integer)paramViewGroup.jdField_a_of_type_AndroidViewView.getTag(2131369125);
    if ((localObject2 == null) || (((Integer)localObject2).intValue() != ((PersonalityLabelInfo)localObject1).bgColor))
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131369125, Integer.valueOf(((PersonalityLabelInfo)localObject1).bgColor));
    }
    ...
    paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(2131380392, paramViewGroup);
    label463:
    boolean bool2;
    boolean bool1;
    if (!PersonalityLabelGalleryActivity.a(this.a))
    {
      if (((PersonalityLabelInfo)localObject1).praiseFlag > 0) {
        paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845282);
      }
    }
    else
    {
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setAdapter(new awpv(this.a, ((PersonalityLabelInfo)localObject1).id));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setOnScrollListener(new awpr(this, (PersonalityLabelInfo)localObject1));
      label722:
    ...
    for (paramInt = i;; paramInt = -2)
    {
      ...
      return paramView;
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845270);
      break label463;
      label860:
      bool1 = false;
      break label552;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject1 != null) && ((localObject1 instanceof Integer)))
    {
      ...
      if (localObject1 != null)
      {
        paramView = bhuf.a(paramView.getContext());
        paramView.c("从手机相册选择");
        paramView.c("从空间相册选择");
        paramView.d("取消");
        paramView.a(new awps(this, (PersonalityLabelInfo)localObject1, paramView));
        paramView.show();
        azqs.b(this.a.app, "dc00898", "", "", "0X8007FD2", "0X8007FD2", 0, 0, "", "", "", "");
      }
    }
    label192:
    do
    ...
    if (i == 3)
    {
      ...
      {
        ((awpy)this.a.app.a(112)).a(PersonalityLabelGalleryActivity.a(this.a), localPersonalityLabelInfo.id);
    ...
    for (;;)
    {
      ...
      if (localObject2 != null) {}
      for (localObject1 = ((PersonalityLabelZan)localObject2).nick;; localObject1 = bdgc.a(this.a.app, this.a.app.getCurrentAccountUin()))
      {
        localPersonalityLabelZan.nick = ((String)localObject1);
        localPersonalityLabelInfo.zanUins.add(0, localPersonalityLabelZan);
        a(localPersonalityLabelInfo, (awpp)paramView.getTag(2131380392));
        ((ImageView)paramView.findViewById(2131380390)).setImageResource(2130845282);
        ...
        azqs.b(this.a.app, "dc00898", "", "", "0X8007FD0", "0X8007FD0", 0, 0, "", "", "", "");
        return;
      }
      ...
      if (i == 4)
      {
        ...
        {
          bdgm.a(this.a, (String)localObject1, 2131690648, 2131692822, new awpt(this, paramView, (PersonalityLabelInfo)localObject2), new awpu(this)).show();
          return;
        }
      }
      if (i != 5) {
