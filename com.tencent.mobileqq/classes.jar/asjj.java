...
public class asjj
{
  private static volatile asjj jdField_a_of_type_Asjj;
  ...
  public static asjj a()
  {
    if (jdField_a_of_type_Asjj == null) {}
    try
    {
      if (jdField_a_of_type_Asjj == null) {
        jdField_a_of_type_Asjj = new asjj();
      }
      return jdField_a_of_type_Asjj;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        bool1 = bhhb.a(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir + File.separator + "liteavsdk.jar", BaseApplicationImpl.getApplication().getApplicationContext(), getClass().getClassLoader(), "com.tencent.rtmp.ui.TXCloudVideoView", null, false);
        if (bool1)
        {
      ...
      catch (Exception localException)
      {
        ...
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir)))
        {
          ...
          bhom.a("com.tencent.rtmp.TXLiveBase", "setLibraryPath", false, bhom.a(new Class[] { String.class }), new Object[] { this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir });
        }
        return bool1;
      }
      boolean bool3 = false;
