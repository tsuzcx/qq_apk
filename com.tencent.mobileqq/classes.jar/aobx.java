...
public class aobx
{
  private Handler jdField_a_of_type_AndroidOsHandler = new aoby(this);
  private aobz jdField_a_of_type_Aobz;
  private aoca jdField_a_of_type_Aoca = new aoca();
  ...
  public aobx()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aoca.a((aoco)localObject);
      return;
  ...
  {
    this.jdField_a_of_type_Aobz = paramaobz;
  }
  ...
  {
    return aoct.a().a(paramInt, paramString);
  }
  
  public void b(int paramInt1, String paramString, int paramInt2)
  {
    boolean bool = aoca.b(paramInt1, paramString, paramInt2);
  ...
  {
    Bundle localBundle = aoca.a(paramInt, paramString, paramBoolean);
    if (localBundle == null) {
      return;
    }
  ...
  public void b(ColorNote paramColorNote)
  {
    ...
    if (paramColorNote.mMainTitle != null) {
      bool2 = aoca.a((String)localObject, "mMainTitle", paramColorNote.mMainTitle);
    }
    boolean bool1 = bool2;
    if (paramColorNote.mSubTitle != null) {
      bool1 = bool2 & aoca.a((String)localObject, "mSubTitle", paramColorNote.mSubTitle);
    }
    bool2 = bool1;
    if (paramColorNote.mPicUrl != null) {
      bool2 = bool1 & aoca.a((String)localObject, "mPicUrl", paramColorNote.mPicUrl);
    }
