  ...
  implements ahqb, EmotionPanelListView.PullAndFastScrollListener
{
  ...
  public avla(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, RichTextPanel paramRichTextPanel)
  {
  ...
  protected void a(int paramInt)
  {
    ...
    localValueAnimator.addUpdateListener(new avlc(this, paramInt));
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localValueAnimator.addUpdateListener(new avlb(this));
    localValueAnimator.start();
  }
