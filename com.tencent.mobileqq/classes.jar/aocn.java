...
public class aocn
  implements aokj
{
  public aocn(ArConfigService paramArConfigService) {}
    ...
    if (ArConfigService.c(this.a) != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((aofj)ArConfigService.c(this.a).getBroadcastItem(i)).a(paramInt1, paramInt2);
            i += 1;
          }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ((aofj)ArConfigService.c(this.a).getBroadcastItem(i)).a(paramInt);
        }
        catch (RemoteException localRemoteException)
        {
          localRemoteException.printStackTrace();
        }
        ((aofj)ArConfigService.c(this.a).getBroadcastItem(i)).b(paramInt, 0);
      }
      catch (Exception localException)
      {
        if (QLog.isColorLevel()) {
