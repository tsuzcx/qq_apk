  ...
  extends BusinessHandler
{
  ...
  aocn(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new aoco(this, Looper.getMainLooper());
  }
            ...
            if (paramFromServiceMsg.getServiceCmd().equals("RegPrxySvc.PushParam"))
            {
              if (paramObject != null)
              {
                ...
                if (paramObject.clientType == 9)
                {
                  ...
                  if (!((zng)this.app.getManager(QQManagerFactory.LOGIN_DEVICES_MANAGER)).a(localSvcRespParam)) {
                    break label535;
                  }
                }
                for (i = 1;; i = 0)
