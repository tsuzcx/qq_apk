...
class adfc
  extends niv
{
  adfc(adfb paramadfb, adfn paramadfn, JSONObject paramJSONObject, adea paramadea) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(adfb.a, 2, "onResult appid=" + adfb.a(this.jdField_a_of_type_Adfb).a + ", openid=" + this.jdField_a_of_type_Adfn.a + ", openkey=" + this.jdField_a_of_type_Adfn.b + ", code=" + paramInt + ", req param=" + this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      adhh.a(this.jdField_a_of_type_Adea, paramInt, "getRankingList result error, try again");
      return;
    }
    ...
    if (paramArrayOfByte != null)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.e(adfb.a, 2, localJSONException.getMessage(), localJSONException);
          }
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(adfb.a, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
        }
      }
      QLog.i(adfb.a, 2, "result is, " + paramBundle.toString());
