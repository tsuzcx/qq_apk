  ...
  extends BaseAdapter
{
  ...
  public axjk(Context paramContext, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560860, paramViewGroup, false);
    }
    TextView localTextView = (TextView)localView.findViewById(2131366356);
    ImageView localImageView3 = (ImageView)localView.findViewById(2131368195);
    ImageView localImageView1 = (ImageView)localView.findViewById(2131367808);
    ImageView localImageView2 = (ImageView)localView.findViewById(2131364860);
    URLImageView localURLImageView = (URLImageView)localView.findViewById(2131362153);
    CaptureCommonLoadingView localCaptureCommonLoadingView = (CaptureCommonLoadingView)localView.findViewById(2131366359);
    ...
    for (;;)
    {
      ...
      {
        localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845461));
        if (bool)
        {
          localImageView3.setVisibility(0);
          label297:
          localImageView2.setVisibility(8);
          localTextView.setText(alpo.a(2131704982));
          localImageView1.setContentDescription(alpo.a(2131704985));
          localTextView.setContentDescription(alpo.a(2131704986));
        }
      }
      label590:
      do
      {
        ...
        if (bool)
        {
          ...
          paramView.mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845457);
          paramView.mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845457);
          ...
          localImageView2.setVisibility(8);
          if (!bdje.a(localFilterCategoryItem.j)) {
            break label590;
          }
        ...
        for (;;)
        {
          azmj.b(null, "dc00898", "", "", "0X800859E", "0X800859E", 2, 0, "", "", localFilterCategoryItem.jdField_a_of_type_JavaLangString, "");
          return localView;
          localImageView3.setVisibility(8);
        ...
        bool = axkd.a().a(3, localFilterCategoryItem.jdField_b_of_type_Int, localFilterCategoryItem.jdField_a_of_type_JavaLangString);
        if (!bool) {
          break label704;
        }
