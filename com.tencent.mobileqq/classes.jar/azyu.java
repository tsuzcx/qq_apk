  ...
  implements Manager
{
  ...
  private void c()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Awbw.a(SubAccountMessage.class, SubAccountMessage.class.getSimpleName(), false, "subUin=?", new String[] { str }, null, null, "time desc", null);
            ...
            if ((paramString1.equals(localSubAccountMessage.subUin)) && (paramString2.equals(localSubAccountMessage.senderuin)))
            {
              ...
              if (localIterator.hasNext())
              {
                ...
                if (localSubAccountMessage != null) {
                  this.jdField_a_of_type_Awbw.b(localSubAccountMessage);
                }
                if (QLog.isColorLevel()) {
  ...
  SubAccountMessage a(String paramString)
  {
    ...
    localSubAccountMessage.sendername = alpo.a(2131720438);
  ...
  public List<SubAccountMessage> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (aljq.aD.equals(((SubAccountMessage)localObject2).senderuin))
            {
              localObject1 = localObject2;
              break label304;
            }
      ...
      for (localObject1 = null;; localObject1 = "containsKey=" + this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
      {
        ...
        label239:
        if ((localaonj == null) || (localaonj.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_Boolean)) {
          break;
        }
        localArrayList.add(0, a(paramString));
        break;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Awbw.a(SubAccountMessage.class.getSimpleName());
  }
  
  public void a(azyv paramazyv)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      if ((paramazyv != null) && (paramazyv.jdField_b_of_type_JavaLangString != null) && (paramazyv.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (paramazyv = "data == null";; paramazyv = "data.mMainAccount=" + paramazyv.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramazyv.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, paramazyv);
      return;
      localObject1 = "data.mMainAccount=" + paramazyv.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramazyv.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = paramazyv.a();
    Object localObject1 = paramazyv.c();
    ArrayList localArrayList3 = paramazyv.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!paramazyv.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = paramazyv.jdField_b_of_type_JavaLangString;
          ((SubAccountInfo)localObject2).serverErrorType = paramazyv.jdField_b_of_type_Int;
          ((SubAccountInfo)localObject2).serverErrorMsg = paramazyv.jdField_a_of_type_JavaLangString;
      ...
      {
        paramazyv = localArrayList3.iterator();
        while (paramazyv.hasNext()) {
          a((String)paramazyv.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      paramazyv = localArrayList1.iterator();
      while (paramazyv.hasNext()) {
        a((SubAccountInfo)paramazyv.next());
      }
      break;
      label629:
      localObject1 = null;
          ...
          if (paramString2 != null)
          {
            ...
            if (bool)
            {
              ...
              if (localSubAccountMessage.istroop == 1)
              {
                ...
                azyl.a(paramQQAppInterface, paramString1, 6);
                paramQQAppInterface.a().d(paramString1, 7000, -i);
                paramQQAppInterface.a().a(new String[] { aljq.x, paramString1 });
                paramQQAppInterface.D();
                paramString2 = new azyv();
        ...
        if (localObject != null)
        {
          ...
          if (i4 != 0)
          {
            ...
            if ((((SubAccountMessage)localObject).mEmoRecentMsg == null) && (((SubAccountMessage)localObject).msg != null)) {
              ((SubAccountMessage)localObject).mEmoRecentMsg = new baig(((SubAccountMessage)localObject).msg, 3, 16);
            }
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramSubAccountMessage.subUin))
        {
          ...
          if ((localObject == null) || (((ArrayList)localObject).size() == 0))
          {
            ...
            break label453;
            if (bool) {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramSubAccountMessage.subUin, 7000, paramSubAccountMessage.unreadNum);
            }
            if (QLog.isColorLevel()) {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            if ((aljq.aD.equals(paramSubAccountMessage.senderuin)) && (paramSubAccountMessage.time > localSubAccountMessage.time))
            {
              bool = true;
              continue;
            }
            if ((!aljq.aD.equals(paramSubAccountMessage.senderuin)) || (paramSubAccountMessage.unreadNum != 0)) {
              continue;
            }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((aljq.aD.equals(paramSubAccountMessage.senderuin)) && (paramSubAccountMessage.time == 0L) && (paramSubAccountMessage.unreadNum == 0))
          {
        ...
        if (!aljq.aD.equals(paramSubAccountMessage.senderuin)) {
          continue;
        }
      }
      finally
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      boolean bool = this.jdField_a_of_type_Awbw.a((String)localObject1, (ContentValues)localObject2, "subUin=?", new String[] { paramString });
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void c(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString, 7000);
      j = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramString, 7000);
      if ((i > 0) || (j > 0)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    while (paramString.hasNext())
    {
      ...
      {
        localazyq = azyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSubAccountInfo.subuin);
        j = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localSubAccountInfo.subuin, 7000);
        k = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(localSubAccountInfo.subuin, 7000);
        if ((localazyq.jdField_a_of_type_Boolean) || (j == localazyq.jdField_a_of_type_Int)) {
          break label429;
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(localSubAccountInfo.subuin, 7000, localazyq.jdField_a_of_type_Int - j);
      }
    }
    label338:
    abol localabol;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("SUB_ACCOUNT", 2, "updateAnotherSubAccountUnreadMsg" + " info.subuin=" + localSubAccountInfo.subuin + " anotherC2cUnread=" + j + " anotherTroopUnread=" + k + " item.showRedDot=" + localazyq.jdField_a_of_type_Boolean + " item.unReadCount=" + localazyq.jdField_a_of_type_Int);
        break label198;
        break;
        if ((localazyq.jdField_a_of_type_Boolean) && (localazyq.jdField_a_of_type_Int != k))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 != null) && (((ArrayList)localObject2).size() != 0))
            {
              ...
              if (((Iterator)localObject2).hasNext())
              {
                ...
                localSubAccountMessage.mTimeString = bdjj.a(localSubAccountMessage.time * 1000L, true, paramString);
                if (i == 0) {
                  break label332;
                }
                i = 0;
  ...
  public void h(String paramString)
  {
    ...
    boolean bool = this.jdField_a_of_type_Awbw.a(str, localContentValues, null, null);
    if (QLog.isColorLevel()) {
