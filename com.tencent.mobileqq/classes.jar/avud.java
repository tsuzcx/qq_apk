  ...
  implements View.OnClickListener, bdbc
{
  ...
  public avud(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561099, null);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131372512));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378003));
    ...
    this.jdField_a_of_type_Bdbb = new bdbb(this.jdField_a_of_type_AndroidContentContext, ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
    this.jdField_a_of_type_Bdbb.a(this);
    this.jdField_a_of_type_Ayec = ((ayec)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(15));
    ...
    {
      paramContext = paramContext.getString("key_nearbyrecommender_title", this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694729));
  ...
  public static void a(VipBaseInfo paramVipBaseInfo, ImageView paramImageView, SingleLineTextView paramSingleLineTextView)
  {
    ...
    paramSingleLineTextView.setTextColor(paramSingleLineTextView.getResources().getColorStateList(2131166964));
    ...
    if ((paramVipBaseInfo != null) && (paramVipBaseInfo.mOpenInfo != null))
    {
      ...
      paramSingleLineTextView.setTextColor(paramSingleLineTextView.getResources().getColorStateList(2131167037));
    }
    label84:
    do
    {
  ...
  {
    bevq localbevq = new bevq(this.jdField_a_of_type_AndroidContentContext.getResources(), this.jdField_a_of_type_Ayec.a(paramInt, 200), false, false);
    if (this.c == 0) {
      this.c = ((int)(paramSingleLineTextView.a() * 1.1F + 0.5F));
    }
    localbevq.setBounds(0, 0, this.c, this.c);
    paramSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(localbevq, null);
  }
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559371, null);
  ...
  public void a(RespEncounterInfo paramRespEncounterInfo, ImageView paramImageView)
  {
    ...
    try
    {
      if (paramRespEncounterInfo.tiny_id > 0L)
      {
        ...
        paramRespEncounterInfo = this.jdField_a_of_type_Bdbb.a(32, str, 202);
        if (paramRespEncounterInfo == null)
        {
          if (!this.jdField_a_of_type_Bdbb.a()) {
            this.jdField_a_of_type_Bdbb.a(str, 202, true, false);
          }
          if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bdhj.a());
          }
    ...
    if (paramRespEncounterInfo.lEctID > 0L)
    {
      ...
      paramRespEncounterInfo = this.jdField_a_of_type_Bdbb.a(32, str, 200);
      if (paramRespEncounterInfo == null)
      {
        this.jdField_a_of_type_Bdbb.a(str, 200, true, false);
        if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bdhj.a());
        }
        paramImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
  ...
  {
    ImageView localImageView1 = (ImageView)paramView.findViewById(2131367819);
    SingleLineTextView localSingleLineTextView1 = (SingleLineTextView)paramView.findViewById(2131377607);
    Object localObject4 = (ImageView)paramView.findViewById(2131362912);
    ImageView localImageView5 = (ImageView)paramView.findViewById(2131368189);
    Object localObject1 = (TextView)paramView.findViewById(2131377674);
    ImageView localImageView2 = (ImageView)paramView.findViewById(2131380031);
    SingleLineTextView localSingleLineTextView2 = (SingleLineTextView)paramView.findViewById(2131365045);
    Object localObject2 = (SingleLineTextView)paramView.findViewById(2131377876);
    Object localObject3 = paramView.findViewById(2131368896);
    TextView localTextView = (TextView)paramView.findViewById(2131371107);
    ImageView localImageView3 = (ImageView)paramView.findViewById(2131371796);
    ImageView localImageView4 = (ImageView)paramView.findViewById(2131364123);
    LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131376308);
    View localView = paramView.findViewById(2131368980);
    paramView = (SingleLineTextView)paramView.findViewById(2131368329);
    this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166964);
    label222:
    int i;
    if (!TextUtils.isEmpty(paramRespEncounterInfo.strNick))
    {
      ...
      localImageView5.setBackgroundResource(2130845486);
      localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845112);
      ((TextView)localObject1).setBackgroundDrawable(bcpx.a(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
      ((TextView)localObject1).setText(alud.a(2131702093));
      label311:
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramRespEncounterInfo.constellation == 0)
        {
          ...
          {
          default: 
            localImageView4.setImageResource(2130845029);
            if (AppSetting.c) {
              localImageView4.setContentDescription(alud.a(2131702095));
            }
            label713:
            if (paramRespEncounterInfo.watch_color == 0)
            {
      ...
      for (;;)
      {
        ...
        localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845112);
        ((TextView)localObject1).setBackgroundDrawable(bcpx.a(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
        ((TextView)localObject1).setText(alud.a(2131702096));
        break label311;
        label860:
        ...
        break label548;
        ((StringBuilder)localObject1).append(" ").append(bddf.a(paramRespEncounterInfo.constellation));
        break label581;
        label980:
        ((StringBuilder)localObject1).append(" ").append(bdda.e[paramRespEncounterInfo.profession_id]);
        break label597;
        label1003:
        paramView.setVisibility(8);
        break label636;
        localImageView4.setImageResource(2130845031);
        break label696;
        localImageView4.setImageResource(2130845032);
        break label696;
        localImageView4.setImageResource(2130845033);
        break label696;
  ...
  public void a(List<RespEncounterInfo> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      if ((localView != null) && (localRespEncounterInfo != null)) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView, new LinearLayout.LayoutParams(-1, bdaq.a(this.jdField_a_of_type_AndroidContentContext, 84.0F)));
      }
      i += 1;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = (alto)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(51);
    if (paramView != null) {}
    for (boolean bool = paramView.b(Long.toString(((RespEncounterInfo)localObject).lEctID));; bool = false)
    {
      ...
      if (bool)
      {
        ...
        paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131694698);
        if (!"0".equals(String.valueOf(((RespEncounterInfo)localObject).cSex))) {
          break label282;
        }
      }
      label282:
      for (paramView = String.format(paramView, new Object[] { alud.a(2131702094) });; paramView = String.format(paramView, new Object[] { alud.a(2131702092) }))
      {
        avue.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, Long.toString(((RespEncounterInfo)localObject).lEctID), Long.toString(((RespEncounterInfo)localObject).lEctID), paramView, 1001, true, true);
        ...
        localObject = avue.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
        azqs.b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, "CliOper", "", "", "0X80055FC", "0X80055FC", 0, 0, localObject[0], paramView, "", "");
        return;
