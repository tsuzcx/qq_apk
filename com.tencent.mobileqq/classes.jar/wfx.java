...
{
  wfx(SearchContactsFragment paramSearchContactsFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    wfy localwfy;
    int i;
    if ((paramView != null) && ((paramView instanceof wfy)))
    {
      localwfy = (wfy)paramView;
      if ((localwfy.b != 80000003) || (SearchContactsFragment.c(this.a) == null)) {
        break label287;
      }
      this.a.a(SearchContactsFragment.c(this.a), SearchContactsFragment.a(this.a), SearchContactsFragment.b(this.a));
      Integer localInteger = (Integer)SearchContactsFragment.a(this.a).get(Integer.valueOf(localwfy.b));
      Object localObject = null;
      paramView = (View)localObject;
      if (localwfy.a != null)
      {
        paramView = (View)localObject;
        if (localwfy.a.uin != null) {
          paramView = String.valueOf(localwfy.a.uin.get());
        }
      }
      int j = localwfy.b;
    ...
    label354:
    label359:
    while (localwfy.b != 80000003) {
      for (;;)
      {
        return;
        if (localwfy.b == 80000004)
        {
          QzoneSearchResultView.a(this.a.getActivity(), localwfy.jdField_c_of_type_JavaLangString);
          break;
        }
        paramView = this.a;
        i = localwfy.b;
        if (localwfy.jdField_c_of_type_Int == 2) {}
