...
public class sbc
{
  ...
  private static sbc jdField_a_of_type_Sbc = new sbc();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final akav jdField_a_of_type_Akav = new sbd(this);
  private CharSequence jdField_a_of_type_JavaLangCharSequence = "";
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private HashMap<String, saw> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<saw> jdField_a_of_type_JavaUtilList = new ArrayList();
  private sbe jdField_a_of_type_Sbe = new sbe(this);
  private boolean jdField_a_of_type_Boolean;
  private long jdField_b_of_type_Long;
  private String jdField_b_of_type_JavaLangString = "";
  private final HashMap<String, Integer> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private List<saw> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  private static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (localObject3 != null) {
      if ((!ahop.a(paramQQAppInterface)) || (Thread.currentThread() != ThreadManager.getRecentThreadLooper().getThread())) {}
    }
    label460:
    label1123:
    for (;;)
    {
      ...
      try
      {
        Object localObject1 = ((akdi)localObject3).a(paramString, true);
        if (localObject1 != null) {
          break label1123;
        }
        localAccountDetail = ((akdi)localObject3).b(paramString);
      ...
      {
        localObject2 = ((akdi)localObject3).c(paramString);
        continue;
      }
      Object localObject2 = ((akdi)localObject3).c(paramString);
      continue;
      ...
      else
      {
        ...
        else if (i != -1)
        {
          ...
          {
            localObject2 = ((ajxn)paramQQAppInterface.getManager(51)).b(paramString);
            if ((localObject2 != null) && (((Friends)localObject2).isFriend()))
            {
              ...
              axrl.a(BaseApplicationImpl.getContext()).a(paramString, "ServiceAccountFolderManager_InValid_puin", false, 1L, 0L, (HashMap)localObject2, null);
              return 0;
            }
          }
          ...
          if (localObject2 != null)
          {
            if (((MessageRecord)localObject2).istroop != 1008)
            {
              ...
              axrl.a(BaseApplicationImpl.getContext()).a(paramString, "ServiceAccountFolderManager_InValid_Msg", false, 1L, 0L, (HashMap)localObject3, null);
              return 0;
            }
  ...
  public static Drawable a()
  {
    ...
    if (!TextUtils.isEmpty(sfh.jdField_e_of_type_JavaLangString)) {
      localObject = URLDrawable.getDrawable(sfh.jdField_e_of_type_JavaLangString, localDrawable, localDrawable);
    }
    return localObject;
  }
  ...
  {
    if (TextUtils.isEmpty(sfh.jdField_d_of_type_JavaLangString)) {
      return sfh.b();
    }
    return sfh.jdField_d_of_type_JavaLangString;
  }
  ...
  public static sbc a()
  {
    if (jdField_a_of_type_Sbc == null) {}
    try
    {
      jdField_a_of_type_Sbc = new sbc();
      return jdField_a_of_type_Sbc;
    }
    finally {}
  }
  ...
  private void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localakdi = (akdi)localQQAppInterface.getManager(56);
      } while ((localakdi != null) && (localakdi.c(paramString) == null) && (localakdi.b(paramString) == null));
      if (sgj.a(localQQAppInterface, paramString) != -7) {
        break;
      }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          {
            if (TextUtils.isEmpty(((saw)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangCharSequence)) {
              break label158;
            }
            saw localsaw = (saw)this.jdField_a_of_type_JavaUtilList.get(i);
            long l = a(localsaw);
            if (QLog.isColorLevel()) {
  ...
  public long a(saw paramsaw)
  {
    ...
    paramsaw = paramsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    if ((paramsaw != null) && ((paramsaw instanceof MessageForStructing)))
    {
      MessageForStructing localMessageForStructing = (MessageForStructing)paramsaw;
      paramsaw = localMessageForStructing.structingMsg;
      if (paramsaw != null) {
        break label110;
      }
      paramsaw = axuy.a(localMessageForStructing.msgData);
    }
    label110:
    for (;;)
    {
      if (paramsaw != null) {}
      for (long l = paramsaw.msgId;; l = 0L)
      {
        if (QLog.isColorLevel()) {
  ...
  public CharSequence a(QQAppInterface paramQQAppInterface)
  {
    if ((TextUtils.isEmpty(this.jdField_a_of_type_JavaLangCharSequence)) && (!this.jdField_a_of_type_Boolean))
    {
      f(paramQQAppInterface);
      this.jdField_a_of_type_Boolean = true;
      return new ayki(this.jdField_a_of_type_JavaLangCharSequence, 3, 16);
    }
    if (QLog.isColorLevel()) {
  ...
  public CharSequence a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    bbet.a(paramQQAppInterface.getApplication(), paramQQAppInterface, localMessage, localMessage.istroop, paramMessageRecord, localMessage.nickName, false, paramBoolean);
  ...
  public String a()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        Object localObject2 = (saw)this.jdField_a_of_type_JavaUtilList.get(0);
        if (localObject2 != null)
        {
          localObject2 = ((saw)localObject2).jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
          if (localObject2 != null)
          {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext()) {
          localStringBuilder.append(((saw)localIterator.next()).jdField_a_of_type_JavaLangString).append(",");
        }
        if (i <= 0) {
          break label194;
        }
  ...
  public List<saw> a(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      localObject1 = sdf.a().a(paramQQAppInterface);
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localObject4 = sdd.a(paramQQAppInterface, paramQQAppInterface.getApplication(), (TroopBarData)localObject4);
          if (localObject4 != null)
          {
            if ((((sdd)localObject4).jdField_a_of_type_JavaUtilList != null) && (((sdd)localObject4).jdField_a_of_type_JavaUtilList.size() > 0))
            {
              localObject5 = (sde)((sdd)localObject4).jdField_a_of_type_JavaUtilList.get(0);
              if ((TextUtils.isEmpty(((sde)localObject5).jdField_b_of_type_JavaLangString)) && (!TextUtils.isEmpty(((sde)localObject5).jdField_c_of_type_JavaLangString))) {
                ((sde)localObject5).jdField_b_of_type_JavaLangString = ((sde)localObject5).jdField_c_of_type_JavaLangString;
              }
            }
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (sdd)((Iterator)localObject4).next();
        if ((QLog.isColorLevel()) && (localObject1 != null)) {
          ((StringBuilder)localObject1).append("[").append(((sdd)localObject3).jdField_a_of_type_JavaLangString).append(", ").append(((sdd)localObject3).jdField_a_of_type_Int).append("]");
        }
        if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(((sdd)localObject3).jdField_a_of_type_JavaLangString))
        {
          localObject5 = saw.a(paramQQAppInterface, (sdd)localObject3);
          if (((saw)localObject5).jdField_b_of_type_Boolean)
          {
            this.jdField_a_of_type_JavaUtilList.add(localObject5);
            this.jdField_a_of_type_JavaUtilHashMap.put(((sdd)localObject3).jdField_a_of_type_JavaLangString, localObject5);
          }
        }
      }
      else
      {
        ...
        for (;;)
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localObject4 = saw.a(paramQQAppInterface, localRecentUser);
              if (((saw)localObject4).jdField_b_of_type_Boolean)
              {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if ((TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) || (!this.jdField_a_of_type_JavaLangString.equals(paramQQAppInterface.getAccount())))
    {
      ...
      if (localSharedPreferences != null)
      {
        ...
        sfh.p = localSharedPreferences.getBoolean("service_folder_redclean_after_enter", false);
        if (QLog.isColorLevel()) {
      ...
      paramQQAppInterface.addObserver(this.jdField_a_of_type_Akav, true);
      if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          localsaw = (saw)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
          localsaw.jdField_a_of_type_JavaLangString = paramString;
          localObject2 = (akdi)paramQQAppInterface.getManager(56);
          if (localObject2 != null)
          {
            PublicAccountInfo localPublicAccountInfo = ((akdi)localObject2).c(paramString);
            if (localPublicAccountInfo != null)
            {
              localsaw.jdField_c_of_type_JavaLangString = localPublicAccountInfo.name;
              localsaw.jdField_b_of_type_Boolean = localPublicAccountInfo.isVisible();
              localsaw.jdField_c_of_type_Int = 0;
            }
          }
          else
          {
            localsaw.jdField_b_of_type_Int = paramQQAppInterface.a().b(paramString, 1008);
            i = paramQQAppInterface.a().f(paramString, 1008);
            if (localsaw.jdField_b_of_type_Int <= 0) {
              break label771;
            }
            if ((localsaw.jdField_b_of_type_Int != 1) || (i <= 0)) {
              break label746;
            }
            localsaw.jdField_a_of_type_Int = 2;
            localObject2 = paramQQAppInterface.a();
            if (localObject2 == null) {
              break label990;
            }
            localsaw.jdField_b_of_type_JavaLangCharSequence = null;
            localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((QQMessageFacade)localObject2).b(paramString, 1008);
            ...
            if ((localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (((DraftSummaryInfo)localObject2).getTime() <= localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time)) {
              break label780;
            }
            localsaw.jdField_e_of_type_Int = 4;
            localsaw.jdField_a_of_type_Long = ((DraftSummaryInfo)localObject2).getTime();
            localsaw.jdField_b_of_type_JavaLangString = ahpl.a().a(localsaw.jdField_a_of_type_JavaLangString, ((DraftSummaryInfo)localObject2).getTime());
            localsaw.jdField_a_of_type_JavaLangCharSequence = ((DraftSummaryInfo)localObject2).getSummary();
            i = 0;
            localsaw.jdField_d_of_type_JavaLangString = a(paramQQAppInterface, localsaw.jdField_a_of_type_JavaLangString);
            localsaw.jdField_a_of_type_Boolean = true;
            if (!sdf.a().a(paramQQAppInterface, paramString, 1008)) {
              break label944;
            }
            ...
            localsaw.jdField_b_of_type_Long = ((RecentUser)localObject2).lastmsgtime;
            if ((i == 0) || (localsaw.jdField_b_of_type_Long <= 0L)) {
              break label987;
            }
            localsaw.jdField_a_of_type_Long = localsaw.jdField_b_of_type_Long;
            localsaw.jdField_b_of_type_JavaLangString = ahpl.a().a(paramString, localsaw.jdField_a_of_type_Long);
            localsaw.jdField_a_of_type_JavaLangCharSequence = "";
            i = 0;
            if (QLog.isColorLevel()) {
              QLog.d("ServiceAccountFolderManager", 2, "updateServiceAccountFolderFeed->" + localsaw.toString());
            }
            if (sgj.a(paramQQAppInterface, paramString) != -7) {
              break label981;
            }
            j = 1;
            if ((QLog.isColorLevel()) && (j != 0)) {
              QLog.d("ServiceAccountFolderManager", 2, "updateServiceAccountFolderFeed->puin:" + localsaw.jdField_a_of_type_JavaLangString + " is Eqq!");
            }
            if ((!localsaw.jdField_b_of_type_Boolean) || (i != 0) || (j != 0) || (!c(paramQQAppInterface, paramString)))
            {
              this.jdField_a_of_type_JavaUtilHashMap.remove(paramString);
              this.jdField_a_of_type_JavaUtilList.remove(localsaw);
              if (QLog.isColorLevel()) {
                QLog.d("ServiceAccountFolderManager", 2, "updateServiceAccountFolderFeed->remove feed puin:" + localsaw.jdField_a_of_type_JavaLangString + ", title:" + localsaw.jdField_c_of_type_JavaLangString);
              }
            }
            h(paramQQAppInterface);
        ...
        {
          localsaw = new saw();
          this.jdField_a_of_type_JavaUtilList.add(localsaw);
          this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localsaw);
          continue;
        }
        Object localObject2 = ((akdi)localObject2).b(paramString);
        if (localObject2 == null) {
          continue;
        }
        localsaw.jdField_c_of_type_JavaLangString = ((AccountDetail)localObject2).name;
        if (1 == ((AccountDetail)localObject2).showFlag)
        {
          bool = true;
          localsaw.jdField_b_of_type_Boolean = bool;
          localsaw.jdField_c_of_type_Int = 0;
        }
      }
      boolean bool = false;
      continue;
      label746:
      localsaw.jdField_a_of_type_Int = 1;
      label771:
      label780:
      label944:
      if (i > 0)
      {
        localsaw.jdField_b_of_type_Int -= 1;
        continue;
        localsaw.jdField_a_of_type_Int = 0;
        continue;
        localsaw.jdField_e_of_type_Int = 0;
        localsaw.jdField_a_of_type_Long = localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;
        localsaw.jdField_b_of_type_JavaLangString = ahpl.a().a(paramString, localsaw.jdField_a_of_type_Long);
        localsaw.jdField_a_of_type_JavaLangCharSequence = a(paramQQAppInterface, localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, false);
        i = 0;
        continue;
        label837:
        if ((localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time > 0L))
        {
          localsaw.jdField_e_of_type_Int = 0;
          localsaw.jdField_a_of_type_Long = localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;
          localsaw.jdField_b_of_type_JavaLangString = ahpl.a().a(paramString, localsaw.jdField_a_of_type_Long);
        ...
        {
          localsaw.jdField_e_of_type_Int = 0;
          localsaw.jdField_a_of_type_Long = 0L;
          localsaw.jdField_b_of_type_JavaLangString = null;
          localsaw.jdField_a_of_type_JavaLangCharSequence = null;
          i = 1;
          continue;
          if ((localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ("1".equals(localsaw.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("inter_num"))))
          {
            localsaw.jdField_a_of_type_Boolean = false;
            continue;
            label981:
  ...
  public void a(QQAppInterface paramQQAppInterface, saw paramsaw, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          saw localsaw = (saw)this.jdField_a_of_type_JavaUtilHashMap.get(str);
          if (localsaw != null)
          {
            this.jdField_a_of_type_JavaUtilList.remove(localsaw);
        ...
        if (paramsaw.jdField_a_of_type_Boolean)
        {
          paramsaw = paramQQAppInterface.a().a().b(paramsaw.jdField_a_of_type_JavaLangString, 1008);
          if (paramsaw != null) {
            ahpf.a(paramQQAppInterface, paramsaw, -1);
          }
          if (paramBoolean)
          {
            h(paramQQAppInterface);
      ...
      sdf.a().a(str, paramQQAppInterface);
      ahpf.b(paramQQAppInterface, str, sgj.b(paramQQAppInterface, str));
  ...
  public int b()
  {
    if (this.e > this.jdField_c_of_type_Long)
    {
      ...
      if ((sfh.a()) && (this.jdField_d_of_type_Long >= this.e)) {
        if (QLog.isColorLevel()) {
  ...
  public void b(QQAppInterface paramQQAppInterface, saw paramsaw, boolean paramBoolean)
  {
    if (paramsaw == null) {}
    do
    {
      return;
      this.jdField_a_of_type_Int -= paramsaw.jdField_b_of_type_Int;
      if (this.jdField_a_of_type_Int < 0) {
        this.jdField_a_of_type_Int = 0;
      }
      paramsaw.jdField_b_of_type_Int = 0;
      paramsaw = paramsaw.jdField_a_of_type_JavaLangString;
      ahpf.b(paramQQAppInterface, paramsaw, 1008);
      paramQQAppInterface.a().c(paramsaw, 1008);
      paramQQAppInterface.a().a(paramsaw, 1008, true);
      a(paramQQAppInterface, paramsaw);
      if (paramBoolean) {
        i(paramQQAppInterface);
      }
    } while (!QLog.isColorLevel());
    QLog.d("ServiceAccountFolderManager", 2, "clearServiceAccountFolderFeedUnreadNum->uin:" + paramsaw + ", needRefresh:" + paramBoolean);
  }
    ...
    do
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          localsaw.jdField_b_of_type_Int = 0;
          localArrayList.add(localsaw.jdField_a_of_type_JavaLangString);
        }
      }
      this.jdField_a_of_type_Int = 0;
  ...
  public void h(QQAppInterface paramQQAppInterface)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ahpf.a(this.jdField_a_of_type_JavaUtilList);
        Collections.sort(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Sbe);
        int i = 0;
        l3 = 0L;
        String str1 = "";
        int k = 0;
        ...
        if (localIterator.hasNext())
        {
          localObject5 = (saw)localIterator.next();
          if (((saw)localObject5).jdField_a_of_type_Int == 2)
          {
            bool = true;
            l2 = l3;
            if (((saw)localObject5).jdField_b_of_type_Int > 0)
            {
              l2 = l3;
              if (((saw)localObject5).jdField_a_of_type_Long >= l3) {
                l2 = ((saw)localObject5).jdField_a_of_type_Long;
              }
            }
            l3 = l4;
            if (((saw)localObject5).jdField_b_of_type_Long > l4) {
              l3 = ((saw)localObject5).jdField_b_of_type_Long;
            }
            if ((((saw)localObject5).jdField_b_of_type_Int <= 0) || (k != 0) || (TextUtils.isEmpty(((saw)localObject5).jdField_d_of_type_JavaLangString))) {
              break label822;
            }
            str1 = ((saw)localObject5).jdField_d_of_type_JavaLangString;
            k = 1;
            if ((j != 0) || (TextUtils.isEmpty(((saw)localObject5).jdField_a_of_type_JavaLangCharSequence))) {
              break label795;
            }
            l1 = ((saw)localObject5).jdField_a_of_type_Long;
            localObject4 = ((saw)localObject5).jdField_b_of_type_JavaLangString;
            localObject3 = ((saw)localObject5).jdField_c_of_type_JavaLangString;
            str2 = ((saw)localObject5).jdField_a_of_type_JavaLangString;
            localObject2 = ((saw)localObject5).jdField_a_of_type_JavaLangCharSequence;
            localObject1 = ((saw)localObject5).jdField_e_of_type_JavaLangString;
            j = 1;
            break label828;
          }
          if (((saw)localObject5).jdField_a_of_type_Int != 1) {
            break label825;
          }
          i += ((saw)localObject5).jdField_b_of_type_Int;
          continue;
        }
        ...
        {
          this.jdField_a_of_type_JavaLangCharSequence = new ayki((CharSequence)localObject3, 3, 16).a((String)localObject2 + "：", true, new int[0]);
          if (this.jdField_a_of_type_JavaUtilList.size() <= 0) {
            break label787;
          }
          if (((saw)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_e_of_type_Int != 4) {
            break label863;
          }
          bool = true;
        ...
        if (!TextUtils.isEmpty(str2)) {
          this.jdField_a_of_type_JavaLangCharSequence = new ayki((CharSequence)localObject3, 3, 16).a(str2 + "：", true, new int[0]);
        }
      }
      ...
      if (this.jdField_a_of_type_JavaLangCharSequence == null)
      {
        ...
        if (this.jdField_a_of_type_JavaUtilList.size() > 0)
        {
          this.jdField_a_of_type_Long = ((saw)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Long;
          this.jdField_b_of_type_JavaLangString = ((saw)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_b_of_type_JavaLangString;
          this.jdField_a_of_type_JavaLangCharSequence = ((saw)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaLangCharSequence;
          this.jdField_d_of_type_JavaLangString = ((saw)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_e_of_type_JavaLangString;
          if (this.jdField_a_of_type_JavaLangCharSequence == null)
          {
            this.jdField_a_of_type_JavaLangCharSequence = "";
            continue;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    RecentUser localRecentUser = localaktg.b(ajsf.aB, 7230);
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() == 0))
      {
      ...
      if (localRecentUser == null)
      {
        localRecentUser = new RecentUser(ajsf.aB, 7230);
