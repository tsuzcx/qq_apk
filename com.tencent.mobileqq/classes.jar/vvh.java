...
public final class vvh
  implements Runnable
{
  public vvh(LinearLayout paramLinearLayout, XEditTextEx paramXEditTextEx, PanelIconLinearLayout paramPanelIconLinearLayout, PatchedButton paramPatchedButton) {}
  ...
  public void run()
  {
    ...
    ThreadManager.getUIHandler().post(new vvi(this, localDrawable1, localDrawable2, localDrawable3, localStateListDrawable));
  }
}
