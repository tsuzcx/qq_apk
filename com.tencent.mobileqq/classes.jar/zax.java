  ...
  extends zaq
{
  ...
  zam jdField_a_of_type_Zam;
  zaw jdField_a_of_type_Zaw = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (localDoodleItem != null) {
      localzav = new zav(localDoodleItem, paramVideoMaterial.getDataPath());
    }
    return localzav;
  }
  ...
  {
    return new zau(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    if (localBitmap != null)
    {
      ...
      localBitmap.recycle();
      return zkh.a((Bitmap)localObject, this.jdField_c_of_type_Int, this.jdField_d_of_type_Int, true);
    }
    return null;
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Zaw.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Zaw.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && ((this.jdField_a_of_type_Zam instanceof zao)))
    {
      ((zao)this.jdField_a_of_type_Zam).h();
      a(true);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, zaw paramzaw)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(paramzaw.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    paramzaw.jdField_a_of_type_Boolean = true;
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, zaw paramzaw)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = paramzaw.jdField_d_of_type_Boolean;
    localArrayList.addAll(paramzaw.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramzaw.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof zav))
    {
      localObject = (zav)localObject;
      ((zav)localObject).a(localArrayList);
      ((zav)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((zav)localObject).a(paramzaw.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((zav)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        paramzaw.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!paramzaw.jdField_d_of_type_Boolean) || (!paramzaw.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = paramzaw.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof zat))
      {
        localObject = (zat)localObject;
        ((zat)localObject).a();
        ((zat)localObject).a(localArrayList, bool, paramzaw);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((zat)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((zat)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          paramzaw.b();
        }
      }
      else if ((localObject instanceof zau))
      {
        localObject = (zau)localObject;
        ((zau)localObject).a(localArrayList);
        zay.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((zau)localObject).a();
        zay.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((zau)localObject).a(paramzaw.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          zay.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          paramzaw.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Zam != null) {
        this.jdField_a_of_type_Zam.a(paramVideoMaterial);
      }
      return;
    }
    yqp.b("PersonalityOperator", "material is null!");
  }
  ...
  public void a(zaw paramzaw)
  {
    if ((paramzaw.jdField_d_of_type_Boolean) && (paramzaw.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!paramzaw.jdField_a_of_type_Boolean) && (paramzaw.jdField_b_of_type_Boolean))
      {
        if (paramzaw.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramzaw);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (paramzaw.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramzaw);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Zaw == null) || (!this.jdField_a_of_type_Zaw.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    QQToast.a(QQStoryContext.a().getApp(), anni.a(2131706738), 0).a();
    return true;
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        ...
        {
          this.jdField_a_of_type_Zaw = new zaw(102, this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId());
          this.jdField_f_of_type_Int += 1;
          this.jdField_a_of_type_Zaw.jdField_c_of_type_Boolean = true;
          if (this.jdField_a_of_type_Zam != null) {
            this.jdField_a_of_type_Zam.a(this.jdField_a_of_type_Zaw);
          }
          a(f1, f2, false);
          this.jdField_e_of_type_Int = 0;
        }
      }
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Zaw != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (localBitmap == null)
      {
        ...
        yqp.e("PersonalityOperator", "saveTextureToBitmap failed, bitmapFromTexture is null");
        return;
      }
      localBitmap = zkh.a(localBitmap, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Zam != null)
      {
        this.jdField_a_of_type_Zam.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_Zam != null) && ((this.jdField_a_of_type_Zam instanceof zao))) {
      ((zao)this.jdField_a_of_type_Zam).f();
    }
    Object localObject4;
    Object localObject5;
    Bitmap localBitmap1;
    ...
    try
    {
      ...
      if (localBitmap2 != null)
      {
        localObject3 = localObject4;
        localObject2 = localObject5;
        localBitmap1 = zkh.a(localBitmap2, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      }
      localObject3 = localBitmap1;
      localObject2 = localBitmap1;
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Zam != null) {
        this.jdField_a_of_type_Zam.a(localBitmap1);
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Zam != null) {
          this.jdField_a_of_type_Zam.a((Bitmap)localObject3);
        }
      }
    }
    finally
    {
      ...
      this.jdField_a_of_type_Zam.a((Bitmap)localObject2);
    }
