...
public class mry
{
  private static volatile mry jdField_a_of_type_Mry;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mrz(this);
  Context jdField_a_of_type_AndroidContentContext = null;
  VideoController jdField_a_of_type_ComTencentAvVideoController = null;
  VideoAppInterface jdField_a_of_type_ComTencentAvAppVideoAppInterface = null;
  String jdField_a_of_type_JavaLangString = null;
  List<String> jdField_a_of_type_JavaUtilList = new ArrayList();
  msa jdField_a_of_type_Msa = null;
  
  private mry(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public static mry a(VideoAppInterface paramVideoAppInterface)
  {
    if (jdField_a_of_type_Mry == null) {}
    try
    {
      if (jdField_a_of_type_Mry == null) {
        jdField_a_of_type_Mry = new mry(paramVideoAppInterface);
      }
      return jdField_a_of_type_Mry;
    }
    finally {}
  }
  ...
  public void a(VideoAppInterface paramVideoAppInterface, String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 89	ldc:a	()Lldc;
    //   5: aload_0
    //   6: getfield 34	mry:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: invokevirtual 93	ldc:b	(Ljava/lang/String;)Llgf;
    //   12: astore_3
    //   13: aload_3
    //   14: ifnonnull +6 -> 20
    //   17: aload_0
    ...
    //   19: return
    //   20: aload_0
    //   21: getfield 32	mry:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   24: aload_2
    ...
    //   69: ifeq -52 -> 17
    //   72: aload_0
    //   73: getfield 32	mry:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: aload_2
  ...
  public void a(msa parammsa)
  {
    this.jdField_a_of_type_Msa = parammsa;
  }
}
