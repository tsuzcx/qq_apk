...
public abstract class avlx<M extends avok, V extends avwu>
  extends avkk<M, V>
{
  FTSEntitySearchDetailActivity jdField_a_of_type_ComTencentMobileqqSearchFtsentityFTSEntitySearchDetailActivity;
  private String jdField_a_of_type_JavaLangString;
  private List<avmb> jdField_a_of_type_JavaUtilList;
  private int jdField_b_of_type_Int;
  private List<FTSEntity> jdField_b_of_type_JavaUtilList;
  private int c;
  private int d;
  
  public avlx(ListView paramListView, azwg paramazwg, List<FTSEntity> paramList, String paramString, FTSEntitySearchDetailActivity paramFTSEntitySearchDetailActivity)
  {
  ...
  public void a()
  {
    ArrayList localArrayList = bakq.a(this.jdField_a_of_type_JavaLangString);
