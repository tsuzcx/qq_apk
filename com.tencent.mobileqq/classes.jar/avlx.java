...
public class avlx
{
  ...
  public avlx(String paramString)
  {
    this(paramString, 1);
  }
  
  public avlx(String paramString, int paramInt)
  {
    this.c = paramString;
    a(paramInt);
  }
  ...
  private byte[] a(String paramString)
  {
    ...
    //   28: invokestatic 101	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   31: new 103	java/io/File
    //   34: dup
    //   35: aload_1
    //   36: invokespecial 105	java/io/File:<init>	(Ljava/lang/String;)V
    //   39: astore 8
    //   41: aload 8
    //   43: astore 5
    //   45: aload 8
    //   47: invokevirtual 108	java/io/File:exists	()Z
    //   50: ifne +47 -> 97
    //   53: new 103	java/io/File
    //   56: dup
    //   57: aload_1
    //   58: ldc 85
    //   60: ldc 87
    //   62: invokevirtual 114	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   65: invokespecial 105	java/io/File:<init>	(Ljava/lang/String;)V
    //   68: astore 5
    //   70: aload 5
    ...
    //   82: iconst_0
    //   83: ifeq +11 -> 94
    //   86: new 116	java/lang/NullPointerException
    //   89: dup
    //   90: invokespecial 117	java/lang/NullPointerException:<init>	()V
    //   93: athrow
    //   94: aload 6
    //   96: areturn
    //   97: new 119	java/io/FileInputStream
    //   100: dup
    //   101: aload 5
    //   103: invokespecial 122	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   106: astore 5
    //   108: aload 5
    //   110: invokevirtual 127	java/io/InputStream:available	()I
    //   113: istore_3
    //   114: iload_3
    //   115: newarray byte
    //   117: astore_1
    //   118: aload 5
    //   120: aload_1
    //   121: invokevirtual 131	java/io/InputStream:read	([B)I
    //   124: istore_2
    //   125: iload_2
    //   126: iload_3
    ...
    //   140: iload_2
    //   141: invokevirtual 134	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   144: ldc 136
    //   146: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   149: iload_3
    //   150: invokevirtual 134	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   153: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   156: invokestatic 101	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   159: ldc 31
    //   161: iconst_1
    ...
    //   174: iload_2
    //   175: invokevirtual 134	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   178: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   181: invokestatic 101	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   184: aload 5
    //   186: ifnull +8 -> 194
    //   189: aload 5
    //   191: invokevirtual 141	java/io/InputStream:close	()V
    //   194: aload_1
    //   195: areturn
    //   196: astore_1
    //   197: aconst_null
    ...
    //   200: ifnull -106 -> 94
    //   203: aload_1
    //   204: invokevirtual 141	java/io/InputStream:close	()V
    //   207: aconst_null
    //   208: areturn
    //   209: astore_1
    //   210: aconst_null
    ...
    //   224: ifnull -130 -> 94
    //   227: aload 5
    //   229: invokevirtual 141	java/io/InputStream:close	()V
    //   232: aload_1
    //   233: areturn
    //   234: astore 5
    //   236: aload_1
  ...
  public avlr a(String paramString1, String paramString2)
  {
    avlr localavlr = new avlr();
    localavlr.b = a(this.c + a + File.separator + paramString1);
    localavlr.a = a(this.c + a + File.separator + paramString2);
    return localavlr;
  }
  ...
  public String c(String paramString)
  {
    ...
    //   3: aconst_null
    //   4: astore 4
    //   6: new 103	java/io/File
    //   9: dup
    //   10: aload_1
    //   11: invokespecial 105	java/io/File:<init>	(Ljava/lang/String;)V
    //   14: astore 5
    //   16: aload 5
    //   18: astore_3
    //   19: aload 5
    ...
    //   24: ifne +45 -> 69
    //   27: new 103	java/io/File
    //   30: dup
    //   31: aload_1
    //   32: ldc 85
    //   34: ldc 87
    //   36: invokevirtual 114	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   39: invokespecial 105	java/io/File:<init>	(Ljava/lang/String;)V
    //   42: astore_3
    //   43: aload_3
    ...
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    //   59: new 116	java/lang/NullPointerException
    //   62: dup
    //   63: invokespecial 117	java/lang/NullPointerException:<init>	()V
    //   66: athrow
    //   67: aload_1
    //   68: areturn
    //   69: new 119	java/io/FileInputStream
    //   72: dup
    //   73: aload_3
    //   74: invokespecial 122	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   77: astore 4
    //   79: aload 4
    //   81: astore_1
    //   82: aload 4
    //   84: invokevirtual 127	java/io/InputStream:available	()I
    //   87: newarray byte
    //   89: astore_3
    //   90: aload 4
    //   92: astore_1
    //   93: aload 4
    //   95: aload_3
    //   96: invokevirtual 131	java/io/InputStream:read	([B)I
    //   99: pop
    //   100: aload 4
    //   102: astore_1
    //   103: new 110	java/lang/String
    //   106: dup
    //   107: aload_3
    //   108: ldc 162
    //   110: invokespecial 165	java/lang/String:<init>	([BLjava/lang/String;)V
    //   113: astore_3
    //   114: aload 4
    //   116: astore_1
    //   117: aload_3
    //   118: ldc 167
    //   120: ldc 169
    //   122: invokevirtual 173	java/lang/String:replaceFirst	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   125: astore 5
    //   127: aload 5
    //   129: astore_3
    //   130: aload_3
    ...
    //   134: ifnull -67 -> 67
    //   137: aload 4
    //   139: invokevirtual 141	java/io/InputStream:close	()V
    //   142: aload_3
    //   143: areturn
    //   144: astore_1
    //   145: aload_3
    ...
    //   182: aload 5
    //   184: invokevirtual 178	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   200: ifnull -133 -> 67
    //   203: aload 4
    //   205: invokevirtual 141	java/io/InputStream:close	()V
    //   208: aload_3
    //   209: areturn
    //   210: astore_1
    //   211: aload_3
    ...
    //   217: ifnull +7 -> 224
    //   220: aload_1
    //   221: invokevirtual 141	java/io/InputStream:close	()V
    //   224: aload_3
    //   225: athrow
    //   226: astore_1
    //   227: aconst_null
