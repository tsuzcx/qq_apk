...
public class aslq
{
  public static HashMap<String, askv> a;
  public askd a;
  private biht a;
  ...
  public aslq(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Biht = new aslr(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = ((QQAppInterface)paramAppInterface);
    this.jdField_a_of_type_Askd = ((askd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43));
  }
  ...
  {
    File localFile = new File(asos.r.replace("[epId]", paramString1));
    boolean bool = true;
    if (localFile.exists()) {
  ...
  private void a(EmoticonPackage paramEmoticonPackage, ArrayList<Emoticon> paramArrayList, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    localaskd.b(localArrayList, localHashMap, paramEmoticonPackage, paramBundle);
    int i = localaskd.a(paramEmoticonPackage, paramArrayList, localArrayList, localHashMap, paramBundle, 6);
    if (i != 0)
    {
      QLog.e("VasEmojiManager", 1, "downloadOthers error : " + i);
      return;
    }
    paramArrayList = new bihu(localArrayList, localHashMap, "vipEmoticonKey_" + paramEmoticonPackage.epId);
    paramArrayList.n = true;
    if (localArrayList.size() == 0)
    {
      paramArrayList.a(paramBundle);
      paramArrayList.a(3);
      this.jdField_a_of_type_Biht.onDone(paramArrayList);
    }
    for (;;)
    {
      localaskd.b(paramEmoticonPackage, paramBoolean);
      return;
      localaskd.a().a(paramArrayList, this.jdField_a_of_type_Biht, paramBundle);
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    VasQuickUpdateEngine.safeDeleteFile(new File(asos.n.replace("[epId]", paramString)));
  }
      ...
      for (;;)
      {
        if (i >= 0)
        {
          ...
          try
          {
            ...
            askv localaskv = new askv();
            localaskv.jdField_a_of_type_JavaLangString = localJSONObject.getString("leftText");
            localaskv.b = localJSONObject.getString("linkText");
            localaskv.c = localJSONObject.getString("type");
            localHashMap.put(str, localaskv);
            i -= 1;
          }
  ...
  private boolean a(String paramString, Bundle paramBundle, EmoticonPackage paramEmoticonPackage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = bhmi.a((File)localObject);
        paramString = asks.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramEmoticonPackage, askd.c, paramString, localArrayList, localaslf);
        if (paramString != null)
        {
      ...
      catch (OutOfMemoryError paramString)
      {
        ...
        if ((!localaslf.jdField_a_of_type_Boolean) && (paramEmoticonPackage.jobType != 4))
        {
          ...
          paramString.a(paramEmoticonPackage.epId, localArrayList, localaslf);
          int j = i + 1;
          ...
          if (QLog.isColorLevel()) {
            QLog.d("VasEmojiManager", 2, "addEmoticonsTask| fetchEncryptKeys count=" + j + " encryptKeysSuccess=" + localaslf.jdField_a_of_type_Boolean);
          }
          if (!localaslf.jdField_a_of_type_Boolean)
          {
            QLog.e("VasEmojiManager", 1, "addEmoticonsTask| fetchEncryptKeys fail epId=" + paramEmoticonPackage.epId + " encryptGetKeySeq=" + localaslf.jdField_a_of_type_JavaLangString + " encryptKeysResultCode" + localaslf.jdField_a_of_type_Int);
            bool = false;
            break;
          }
        }
  ...
  {
    paramString = a(paramString);
    return asos.u.replace("[epId]", paramString);
  }
  
  public askd a()
  {
    return this.jdField_a_of_type_Askd;
  }
  ...
  public void a(EmoticonPackage paramEmoticonPackage, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localBundle.putBoolean("isUpdate", asos.a(paramEmoticonPackage));
    ...
    a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramEmoticonPackage.epId, new aslp(paramEmoticonPackage.epId, null));
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (localObject1 == null)
    {
      ...
      EmoticonPackage localEmoticonPackage = ((axfj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str);
      localObject1 = localEmoticonPackage;
      if (localEmoticonPackage == null)
      {
        localObject1 = new EmoticonPackage();
        ((EmoticonPackage)localObject1).name = anzj.a(2131714818);
      ...
      ((Bundle)localObject2).putBoolean("isUpdate", asos.a((EmoticonPackage)localObject1));
    ...
    for (;;)
    {
      ...
      if ((paramInt != 0) || (!a(b(paramString), (Bundle)localObject1, (EmoticonPackage)localObject2))) {
        askd.jdField_a_of_type_Askc.a((EmoticonPackage)localObject2, paramInt, 8, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  {
    paramString = a(paramString);
    aslp localaslp = (aslp)a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localaslp != null) {
      localaslp.a((float)paramLong1 * 100.0F / (float)paramLong2);
    }
    ...
    if (paramString != null)
    {
      ...
      askd.jdField_a_of_type_Askc.b(paramString, (int)paramLong1, (int)paramLong2);
    }
  }
}
