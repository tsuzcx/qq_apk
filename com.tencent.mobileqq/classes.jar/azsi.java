  ...
  implements atqq
{
  ...
  public azsi(TroopPicEffectsEditActivity paramTroopPicEffectsEditActivity)
  {
  ...
  public void b(atqr paramatqr)
  {
    ...
    localTroopPicEffectsEditActivity.startActivity(aciy.a(localIntent, new int[] { 1 }));
    localTroopPicEffectsEditActivity.finish();
    localTroopPicEffectsEditActivity.a(localTroopPicEffectsEditActivity.a, (im_msg_body.CustomFace)paramatqr.a, new azsj(this, localTroopPicEffectsEditActivity));
  }
}
