...
public class apnb
{
  ...
  public static apnn a(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static List<ColorNote> a(int paramInt)
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        if (aplm.a(localColorNote, (ColorNote)localIterator2.next())) {
  ...
  public static void a(ColorNote paramColorNote)
  {
    ...
    paramColorNote = aplm.c(paramColorNote);
    paramColorNote.setType(2);
    apko localapko = new apko();
    localapko.a(paramColorNote.getServiceType(), paramColorNote.getSubType(), 2);
    localapko.a(new apnc(localapko, paramColorNote));
  ...
  private static void a(List<ColorNote> paramList)
  {
    if ((paramList != null) && (paramList.size() >= 20))
    {
      ...
      while (i < paramList.size())
      {
        ...
        localapko.a(localColorNote.getServiceType(), localColorNote.getSubType(), 2);
        i += 1;
      }
    }
  }
