...
public class apnb
{
  ...
  private ajuc jdField_a_of_type_Ajuc = new apnc(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private GridLayoutManager jdField_a_of_type_AndroidSupportV7WidgetGridLayoutManager;
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new apne(this);
  private RecyclerView jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private apnf jdField_a_of_type_Apnf;
  private azwg jdField_a_of_type_Azwg;
  private azwh jdField_a_of_type_Azwh = new apnd(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private String jdField_a_of_type_JavaLangString = "";
  
  public apnb(Context paramContext)
  {
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131639064));
      int j = (int)(16.0D / this.jdField_a_of_type_Float);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(2, j);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101348));
    }
    if (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView == null)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, float paramFloat)
  {
    ...
    this.jdField_a_of_type_Apnf = new apnf(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Azwg, this.jdField_a_of_type_Float);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Apnf);
    ...
    b();
    if (paramInt == 1) {
      ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(this.jdField_a_of_type_JavaLangString);
    }
    while (paramInt != 3000) {
      return;
    }
