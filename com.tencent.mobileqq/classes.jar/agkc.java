...
public class agkc
{
  ...
  private static agkc jdField_a_of_type_Agkc;
  public static final String a;
  public static long b;
  public static final String b;
  public Handler a;
  public HandlerThread a;
  HashMap<String, agkd> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public MqqHandler a;
  agke[] jdField_a_of_type_ArrayOfAgke = null;
  ...
  private agkc()
  {
    ...
    this.jdField_a_of_type_ArrayOfAgke = new agke[6];
    agke[] arrayOfagke = this.jdField_a_of_type_ArrayOfAgke;
    int k = arrayOfagke.length;
    i = j;
    while (i < k)
    {
      agke localagke = arrayOfagke[i];
      localagke = new agke(this);
      localagke.jdField_a_of_type_Int = 1;
      localagke.jdField_a_of_type_Long = -1L;
      i += 1;
    }
  ...
  {
    if (jdField_a_of_type_Agkc == null) {}
    try
    {
      if (jdField_a_of_type_Agkc == null) {
        jdField_a_of_type_Agkc = new agkc();
      }
      return jdField_a_of_type_Agkc;
    }
    finally {}
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject1 = new agkd(this);
      ((agkd)localObject1).jdField_a_of_type_ArrayOfAgkf = new agkf[6];
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    Object localObject2 = (agkd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    ...
    Object localObject1 = ((agkd)localObject2).jdField_a_of_type_ArrayOfAgkf;
    paramInt2 = ((agkd)localObject2).jdField_a_of_type_Int;
    if (paramInt1 - 1 == -1) {
      paramInt1 = 0;
    }
    while ((paramInt1 >= 0) && (paramInt1 < 6))
    {
      ...
      {
        localObject1[paramInt1] = new agkf(this);
      ...
      if (paramInt3 != -1)
      {
        ...
        ((agkd)localObject2).jdField_a_of_type_Int = paramInt1;
      ...
      else
      {
        ...
        {
          if (paramInt2 != -1) {
            bcef.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
          }
          localObject1[paramInt1].jdField_a_of_type_Long = l1;
          if (QLog.isColorLevel()) {
    ...
    {
      bcef.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
      ((agkd)localObject2).jdField_a_of_type_Int = -1;
    }
    return 0;
  }
  ...
  public void a(View paramView)
  {
    ...
    Object localObject;
    if (agaj.class.isInstance(paramView))
    {
      localObject = (agaj)paramView;
      if (QLog.isColorLevel()) {
        QLog.d("GivingHeart", 2, new Object[] { "==>to be remove obj:", Integer.valueOf(((agaj)localObject).jdField_b_of_type_Int) });
      }
      if ((((agaj)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForPoke))
      {
        paramView = (MessageForPoke)((agaj)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if (agkg.a(paramView.interactType)) {
          break label82;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        } while (!((agaj)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a());
        localObject = ((agaj)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a();
        paramView.mUnlimitedState.jdField_a_of_type_Int = ((agts)localObject).jdField_a_of_type_Int;
        paramView.mUnlimitedState.jdField_b_of_type_Int = ((agts)localObject).jdField_b_of_type_Int;
        paramView.mUnlimitedState.jdField_a_of_type_Long = ((agts)localObject).jdField_a_of_type_Long;
        paramView.mFrameState.c = ((agts)localObject).jdField_b_of_type_Boolean;
        paramView.mFrameState.jdField_a_of_type_Boolean = ((agts)localObject).jdField_a_of_type_Boolean;
        return;
        localObject = ((agaj)localObject).jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getBackground();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new bjng(Looper.getMainLooper(), paramFitSystemWindowsRelativeLayout);
  }
}
