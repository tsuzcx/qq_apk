...
public class bewm
{
  private static bewm jdField_a_of_type_Bewm;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentLinkedQueue<bewn> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bewm a()
  {
    try
    {
      if (jdField_a_of_type_Bewm == null) {
        jdField_a_of_type_Bewm = new bewm();
      }
      bewm localbewm = jdField_a_of_type_Bewm;
      return localbewm;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = bhnp.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bhli.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.3.3"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.3.3", Integer.valueOf(a("8.3.3")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bewn)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bewn)localObject1).a();
      localObject3 = ((bewn)localObject1).a();
      str3 = ((bewn)localObject1).b();
      j = ((bewn)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = bhma.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bewn(paramInt1, paramString1, paramInt2, paramString2));
  }
