...
{
  public bjat(AuthorityActivity paramAuthorityActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 0: 
      ...
      if (i != 0) {
        QLog.d("AuthorityActivity", 1, "rec | cmd: G_A_L_D | uin : *" + bjhh.a(this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
      }
      for (;;)
      {
        try
        {
          bjgx.a().a(this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString, "", AuthorityActivity.jdField_e_of_type_JavaLangString, "1", "6", "" + i, false, true);
          if (TextUtils.isEmpty(((SdkAuthorize.GetAuthApiListResponse)localObject1).msg.get()))
          {
            ...
            if (i == 110405)
            {
              bjhh.a(this.a, paramMessage, new bjau(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131696223), new Object[] { ((SdkAuthorize.GetAuthApiListResponse)localObject1).msg.get(), Integer.valueOf(i) });
            continue;
          }
          if (i != 110509) {
            break label566;
          ...
          if (AuthorityActivity.a(this.a) < 0)
          {
            ...
            bjpm.a().a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_MqqObserverSSOAccountObserver, AuthorityActivity.jdField_e_of_type_JavaLangString, 3);
          ...
          else
          {
            ...
            QQToast.a(this.a, 1, anvx.a(2131707307), 0).a();
        ...
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131694457);
        ...
        if (i == 110537)
        {
          ...
          QQToast.a(this.a, 1, anvx.a(2131707309), 0).a();
          this.a.c(this.a.jdField_a_of_type_JavaLangString);
          return true;
        }
        if (i == 100044) {
          bjhg.a(this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString, AuthorityActivity.jdField_e_of_type_JavaLangString, this.a.jdField_a_of_type_AndroidOsBundle.getString("packagename"), this.a.jdField_a_of_type_AndroidOsBundle.getString("packagesign"));
        }
        ...
        bjhh.a(this.a, paramMessage, new bjav(this, (SdkAuthorize.GetAuthApiListResponse)localObject1, (JSONObject)localObject2));
      }
      ...
      this.a.b("wtl_loggednunauthorized", this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
      ...
      for (;;)
      {
        ...
        if (!this.a.jdField_e_of_type_Boolean) {
          this.a.b("wtl_loggednauthorized", this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
        }
        this.a.j();
      }
    case 1: 
      ...
      if (i != 0)
      {
        QLog.d("AuthorityActivity", 1, "rec | cmd: A_D | uin : *" + bjhh.a(this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
        try
        {
          localObject2 = ((SdkAuthorize.AuthorizeResponse)localObject1).msg.get();
          if (TextUtils.isEmpty((CharSequence)localObject2)) {}
          for (paramMessage = String.format(this.a.getResources().getString(2131694450), new Object[] { Integer.valueOf(i) }); i == 110405; paramMessage = String.format(this.a.getResources().getString(2131696223), new Object[] { localObject2, Integer.valueOf(i) }))
          {
            bjhh.a(this.a, paramMessage, new bjaw(this));
            label1368:
            this.a.b(i, paramMessage);
            return true;
          }
      ...
      for (;;)
      {
        ...
        this.a.b("wtl_lognback", this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
        break;
        label2071:
        if (i == 1105030)
        {
          this.a.d(i, (String)localObject2);
          paramMessage = bjqk.a(AuthorityActivity.jdField_e_of_type_JavaLangString, this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
        ...
        if (i == 100044)
        {
          ...
          bjhh.a(this.a, paramMessage, new bjax(this, (SdkAuthorize.AuthorizeResponse)localObject1, (JSONObject)localObject2));
          break label1368;
        }
        if (i != 110537) {
          break label1368;
      ...
      {
        ForwardUtils.reportAuthorityTotal(((SdkAuthorize.AuthorizeResponse)localObject1).ret.get(), this.a.jdField_a_of_type_Bjpl);
        bjfi.a().a(this.a.jdField_a_of_type_AndroidOsBundle, true);
    ...
    {
      bjhg.a(this.a.jdField_a_of_type_JavaLangString, paramMessage);
      break label1923;
      ...
      StatisticCollector.getInstance(this.a).collectPerformance(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
      this.a.b("wtl_lognauthorizenback", this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
      break;
      if (this.a.jdField_f_of_type_Boolean)
      {
        ((HashMap)localObject1).put("appid", AuthorityActivity.jdField_e_of_type_JavaLangString);
        ...
        ((HashMap)localObject1).put("p2", "auth");
        StatisticCollector.getInstance(this.a).collectPerformance(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
        this.a.b("wtl_loggednunauthorizedback", this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
        break;
      }
      ((HashMap)localObject1).put("appid", AuthorityActivity.jdField_e_of_type_JavaLangString);
      ((HashMap)localObject1).put("p1", "logged");
      ((HashMap)localObject1).put("p2", "uauth");
      StatisticCollector.getInstance(this.a).collectPerformance(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
      this.a.b("wtl_loggednauthorizedback", this.a.jdField_a_of_type_Bjpl.jdField_a_of_type_JavaLangString);
      break;
