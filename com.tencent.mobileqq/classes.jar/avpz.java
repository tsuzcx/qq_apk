    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          localObject2 = "";
          axqy.a(localQQAppInterface, "new_reg", "reg_page", "next_clk", "", 1, "", (String)localObject1, "", (String)localObject2, "", "", "", "", "");
          if (paramBoolean) {
            continue;
          }
          ...
          if (TextUtils.isEmpty(paramArrayOfByte)) {
            localObject1 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131717143);
          }
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        if (!TextUtils.isEmpty(paramArrayOfByte))
        {
          ...
          if ((i > 0) && (j > 0) && (i + 1 < j)) {
            avpy.a(this.a, paramArrayOfByte.substring(i + 1, j));
          }
        }
        switch (paramInt)
        {
        ...
        default: 
          ...
          localObject1 = paramArrayOfByte;
          if (TextUtils.isEmpty(paramArrayOfByte)) {
            localObject1 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getResources().getString(2131717143);
          }
          this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a((String)localObject1, 0);
          return;
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(paramString))
        {
          ...
          j = 0;
          axqy.a(paramArrayOfByte2, "dc00898", "", "", "0X8009844", "0X8009844", i, j, "", "", "", "");
          QQAppInterface localQQAppInterface = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
          if (!paramBoolean) {
            break label356;
          }
          ...
          str2 = "";
          axqy.a(localQQAppInterface, "new_reg", "reg_page", "next_msg", "", 1, "", paramArrayOfByte2, paramString, str2, "", "", "", "", "");
          if (paramBoolean) {
            break label377;
          }
          paramArrayOfByte1 = str1;
          if (TextUtils.isEmpty(str1)) {
            paramArrayOfByte1 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131717143);
          }
      ...
      catch (Exception paramArrayOfByte2)
      {
        ...
        default: 
          label377:
          this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717143, 0);
          return;
        }
      }
      avpy.a(this.a, 0, 0L);
      ...
      if (paramArrayOfByte1 != null)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramArrayOfByte1.putExtra("selfSet_leftViewText", ajya.a(2131711230));
          paramArrayOfByte1.putExtra("url", str1);
          this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.startActivity(paramArrayOfByte1);
          axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C5D", "0X8009C5D", 0, 0, "", "", this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_a_of_type_JavaLangString, "");
          return;
          str1 = null;
        }
      }
