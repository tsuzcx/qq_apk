...
public class avpz
  extends QIPCModule
{
  private static volatile avpz jdField_a_of_type_Avpz;
  ...
  private avpz(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Avpz == null) {}
    try
    {
      if (jdField_a_of_type_Avpz == null) {
        jdField_a_of_type_Avpz = new avpz("IdentificationIpcServer_Model");
      }
      return jdField_a_of_type_Avpz;
    }
    finally {}
  }
  ...
  {
    return new avqc(this, paramFile, paramEIPCResult, paramQQAppInterface, paramInt2, paramInt3, paramInt1);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    bdla.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80097EB", "0X80097EB", 0, 0, i + "", "" + k, j + "", "");
    ...
    for (localObject1 = new Transaction(((QQAppInterface)localObject2).getCurrentAccountUin(), 61, (String)localObject1, 0, arrayOfByte, a(localFile, localEIPCResult, (QQAppInterface)localObject2, j, i, k), null, false);; localObject1 = new Transaction(str1, 61, (String)localObject1, 0, Base64.decode(str2, 11), arrayOfByte, a(localFile, localEIPCResult, (QQAppInterface)localObject2, j, i, k)))
    {
      ...
      if (avpm.c.contains(this.jdField_a_of_type_JavaLangString))
      {
  ...
  private void a(Bundle paramBundle, int paramInt)
  {
    ...
    if ((avpm.c.contains(str3)) && (TextUtils.isEmpty(str4)))
    {
    ...
    avzo.a(paramBundle, str3, str4, i, AppSetting.a(), str2, str1, l, new avqb(this, localFaceDetectForThirdPartyManager, paramInt, paramBundle));
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    avpm.a().a(paramQQAppInterface, BaseApplicationImpl.getContext(), i, str, paramBundle, new avqa(this, paramInt));
  }
  
  private void b(QQAppInterface paramQQAppInterface)
  {
    bnku localbnku = bnku.a();
    avqe localavqe = new avqe(this);
    if (paramQQAppInterface.isLogin())
    {
      localbnku.a(bnkt.b, localavqe, false);
      return;
    }
    localbnku.a(bnkt.b, localavqe);
  }
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    paramString2 = new avqd(this, paramString2, paramString3, paramString1, paramInt);
      ...
      if (((List)localObject2).size() > 0)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (((ShortVideoResourceManager.SVConfigItem)localObject1).name.startsWith("new_qq_android_native_short_new_other_"))
          {
            ...
            QLog.d("qqidentification_server", 1, new Object[] { "no res,start download, localpath is", localObject2, " version is : ", Integer.valueOf(i), " app so bits is : ", Integer.valueOf(avpw.b()) });
