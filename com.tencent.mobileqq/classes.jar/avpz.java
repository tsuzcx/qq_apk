...
public class avpz
{
  ...
  private static final Comparator<avqc> jdField_a_of_type_JavaUtilComparator = new avqa();
  private static final Comparator<MostUsedSearch> b = new avqb();
  ...
  public static ArrayList<avqc> a(ArrayList<avqc> paramArrayList)
  {
    ...
    {
      avqc localavqc = (avqc)paramArrayList.next();
      int i = localavqc.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identifyType * 100 + localavqc.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.businessType;
      HashMap localHashMap;
      if (((HashMap)localObject).containsKey(Integer.valueOf(i)))
      {
        localHashMap = (HashMap)((HashMap)localObject).get(Integer.valueOf(i));
        if (localHashMap.containsKey(localavqc.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify)) {
          QLog.d("MostUsedCahce", 2, "more high level exsit " + localavqc.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify);
        } else {
          localHashMap.put(localavqc.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify, localavqc);
        }
      }
      else
      {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if ((localObject != null) && (((HashMap)localObject).values() != null) && (((HashMap)localObject).values().size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            localArrayList.add((avqc)((Iterator)localObject).next());
          }
        }
      }
    }
  ...
  public ArrayList<avqc> a(QQAppInterface paramQQAppInterface, String paramString)
  {
      ...
      try
      {
        ...
        if (k != 0)
        {
          ...
          if (j < localMostUsedSearch.items.size())
          {
            ...
            {
              avqc localavqc = new avqc(this);
              localavqc.jdField_a_of_type_Boolean = false;
              localavqc.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem = new MostUsedSearchItem(localMostUsedSearchItem);
              localavqc.jdField_a_of_type_Int = k;
              paramQQAppInterface.add(localavqc);
            }
            else
            {
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	avpz:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 75 1 0
    //   9: aload_0
    //   10: getfield 39	avpz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   13: ifnull +10 -> 23
    //   16: aload_0
    //   17: getfield 39	avpz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   20: invokevirtual 232	java/util/ArrayList:clear	()V
    //   23: aload_0
    //   24: getfield 44	avpz:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   27: invokeinterface 100 1 0
    //   32: getstatic 22	avpz:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   35: astore_1
    //   36: aload_1
    //   37: monitorenter
    //   38: aload_0
    //   39: iconst_0
    //   40: putfield 271	avpz:jdField_a_of_type_Boolean	Z
    //   43: aload_1
    //   44: monitorexit
    //   45: ldc 102
    //   47: iconst_2
    ...
    //   55: astore_1
    //   56: aload_0
    //   57: getfield 44	avpz:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
