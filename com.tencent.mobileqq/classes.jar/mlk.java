  ...
  extends BaseAdapter
{
  ...
  public void a(mln[] paramArrayOfmln)
  {
    this.jdField_a_of_type_ArrayOfMln = paramArrayOfmln;
  }
  ...
  public int getCount()
  {
    ...
    return this.jdField_a_of_type_ArrayOfMln.length;
  }
  ...
  public Object getItem(int paramInt)
  {
    ...
    return this.jdField_a_of_type_ArrayOfMln[paramInt];
  }
  ...
  {
    boolean bool = true;
    lcg.a(jdField_a_of_type_JavaLangString, "getView|position=" + paramInt + ", view=" + paramView);
    if (paramView == null) {
      paramView = new VoiceChangeItemView1(this.jdField_a_of_type_AndroidContentContext);
    }
    for (;;)
    {
      paramViewGroup = (mln)getItem(paramInt);
      ...
      for (;;)
      {
        localVoiceChangeItemView1.a(paramInt, paramViewGroup, bool, this.jdField_a_of_type_Int, this.jdField_a_of_type_Mlp);
        if (this.c == paramViewGroup.jdField_a_of_type_Int)
        {
          if (paramInt != 0) {
