  ...
  extends BaseAdapter
{
  ...
  public aiqf(Context paramContext, QQAppInterface paramQQAppInterface, List<Long> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (aiqg)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562423, null);
      paramView = new aiqg(this);
      ...
      paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131375164));
