...
public class ozn
{
  static ozn jdField_a_of_type_Ozn;
  ...
  public static ozn a()
  {
    try
    {
      if (jdField_a_of_type_Ozn == null) {
        jdField_a_of_type_Ozn = new ozn();
      }
      return jdField_a_of_type_Ozn;
    }
    finally {}
  }
  ...
  public Fragment a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    if (paramTabChannelCoverInfo.mChannelCoverId == pfg.a()) {
    ...
    for (;;)
    {
      ...
      {
      default: 
        if (smk.a(paramTabChannelCoverInfo.mChannelJumpUrl))
        {
      ...
      case 41450: 
        ...
        if (paramTabChannelCoverInfo.bid > 0L)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((ovb)localObject2).b("cgi"))) {}
