...
{
  ozn(ozk paramozk, AdvertisementInfo paramAdvertisementInfo) {}
        ...
        if (paramInt == 0)
        {
          ...
          if (paramInt == 0)
          {
            ...
            if ((paramBundle != null) && (paramBundle.length() > 0))
            {
              ...
              this.jdField_a_of_type_Ozk.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
            }
          }
        }
        return;
