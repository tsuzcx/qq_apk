  ...
  extends ReportDialog
{
  ...
  private BaseAdapter adapter = new bgpb(this);
  ...
  ListView list;
  private bgpl mBrandColorManager = new bgpl(null);
  ...
  @TargetApi(14)
  public bgpa(Context paramContext)
  {
    super(paramContext);
  ...
  @TargetApi(14)
  public bgpa(Context paramContext, int paramInt)
  {
  ...
  @TargetApi(14)
  protected bgpa(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
  ...
  {
    bgpc localbgpc = new bgpc(paramActivity);
    showPermissionSettingDialog(paramActivity, paramString1, paramString2, localbgpc, localbgpc, null);
  }
  ...
  public static void showPermissionSettingDialog(Activity paramActivity, String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    {
      paramActivity = anni.a(2131708974);
    }
    ...
    {
      paramActivity = anni.a(2131708966);
    }
    localbgpa.setMessage(paramActivity);
    localbgpa.setNegativeButton(anni.a(2131708973), paramOnClickListener1);
    localbgpa.setPositiveButton(anni.a(2131708958), paramOnClickListener2);
    localbgpa.setOnCancelListener(paramOnCancelListener);
    localbgpa.show();
  }
  
  public bgpa addCenterView(View paramView, LinearLayout.LayoutParams paramLayoutParams)
  {
  ...
  public bgpa addView(View paramView)
  {
    this.text.setVisibility(8);
  ...
  public bgpa addView(View paramView, LinearLayout.LayoutParams paramLayoutParams)
  {
    this.text.setVisibility(8);
    this.countText.setVisibility(8);
    this.bodyLayout.addView(paramView, paramLayoutParams);
  ...
  public void adjustMessageBottomMargin(float paramFloat)
  {
    if (this.bodyLayout != null)
    {
      ...
      localLayoutParams.bottomMargin = bclx.a(paramFloat);
  ...
  public void adjustMessageTopBottomMargin(float paramFloat1, float paramFloat2)
  {
    ...
    {
      RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.bodyLayout.getLayoutParams();
      localLayoutParams.bottomMargin = bclx.a(paramFloat2);
      localLayoutParams.topMargin = bclx.a(paramFloat1);
      this.bodyLayout.setLayoutParams(localLayoutParams);
    }
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 272	adbo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 272	adbo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 272	adbo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  {
    return (TextView)findViewById(2131365477);
  }
  ...
  public bgpa setCheckBox(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    return setCheckBox(paramString, true, paramOnClickListener);
  }
  
  public bgpa setCheckBox(String paramString, boolean paramBoolean, DialogInterface.OnClickListener paramOnClickListener)
  {
    findViewById(2131369566).setVisibility(0);
    this.checkTxt.setText(paramString);
    if (this.checkBox != null)
    {
      this.checkBox.setChecked(paramBoolean);
      this.checkBox.setOnCheckedChangeListener(new bgpe(this, paramOnClickListener));
    }
    setSeperatorState();
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.title = ((TextView)findViewById(2131365479));
    this.text = ((TextView)findViewById(2131365475));
    this.dialogEdit = ((EditText)findViewById(2131365460));
    this.countText = ((TextView)findViewById(2131365453));
    this.dummyFirstPreviewImage = ((TextView)findViewById(2131365740));
    this.previewImage = ((TextView)findViewById(2131372836));
    this.operateImage = ((ImageView)findViewById(2131371983));
    this.framePreviewImage = ((ImageView)findViewById(2131367087));
    this.framePreview = findViewById(2131367086);
    this.mVideoIcon = ((ImageView)findViewById(2131380685));
    this.mVideoSize = ((TextView)findViewById(2131370311));
    this.mVideoTime = ((TextView)findViewById(2131370312));
    this.lBtn = ((TextView)findViewById(2131365464));
    this.rBtn = ((TextView)findViewById(2131365470));
    this.editPicTag = ((TextView)findViewById(2131365461));
    this.progressBar = ((ProgressBar)findViewById(2131365505));
    this.lBtn.setVisibility(8);
    this.rBtn.setVisibility(8);
    this.bodyLayout = ((LinearLayout)findViewById(2131363543));
    this.checkBox = ((CheckBox)findViewById(2131379070));
    this.mSwitch = ((FormSwitchItem)findViewById(2131379072));
    this.checkTxt = ((TextView)findViewById(2131380055));
    this.list = ((ListView)findViewById(2131369914));
    this.rootView = ((ViewGroup)findViewById(2131365471));
    if ((this.list != null) && (Build.VERSION.SDK_INT >= 9)) {
      this.list.setOverScrollMode(2);
    }
    this.mBrandColorManager.a(findViewById(2131365438));
  }
  ...
  public bgpa setFirstDummyPreviewImage(Drawable paramDrawable)
  {
  ...
  public bgpa setImageOnClickListener(View.OnClickListener paramOnClickListener)
  {
  ...
  public bgpa setItems(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
  ...
  public bgpa setItems(String[] paramArrayOfString, DialogInterface.OnClickListener paramOnClickListener)
  {
  ...
  public bgpa setMessage(int paramInt)
  {
  ...
  public bgpa setMessage(CharSequence paramCharSequence)
  {
  ...
  public bgpa setMessageCount(String paramString)
  {
    if (paramString != null)
    {
  ...
  public bgpa setMessageMaxLine(int paramInt)
  {
    if (this.text != null)
    {
  ...
  public bgpa setMessageWithEmo(String paramString, float paramFloat)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      this.text.setText(new bdnt(paramString, 3));
  ...
  public bgpa setMessageWithUrl(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  public bgpa setMessageWithoutAutoLink(CharSequence paramCharSequence)
  {
    if (!TextUtils.isEmpty(paramCharSequence))
    {
      this.text.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  public bgpa setMsgMaxLineWithEnd(String paramString, int paramInt)
  {
    if (this.text != null)
    {
      this.text.setMaxLines(paramInt);
      this.text.getViewTreeObserver().addOnGlobalLayoutListener(new bgpd(this, paramInt, paramString));
    }
    return this;
  }
  ...
  public bgpa setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bgpj(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  
  public bgpa setNegativeButton(String paramString, int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.lBtn.setVisibility(8);
  ...
  public bgpa setNegativeButton(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.lBtn.setVisibility(8);
    ...
    this.lBtn.setVisibility(0);
    this.lBtn.setOnClickListener(new bgpg(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bgpa setOperateImage(Drawable paramDrawable)
  {
  ...
  public bgpa setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bgpk(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  
  public bgpa setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
    ...
    this.rBtn.setVisibility(0);
    this.rBtn.setOnClickListener(new bgpi(this, paramOnClickListener, paramBoolean));
    setSeperatorState();
    return this;
  }
  
  public bgpa setPositiveButton(String paramString, int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
  ...
  public bgpa setPositiveButton(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
    ...
    this.rBtn.setVisibility(0);
    this.rBtn.setOnClickListener(new bgph(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bgpa setPreviewFixDimension(int paramInt1, int paramInt2)
  {
    ...
    localMarginLayoutParams.topMargin = afur.a(12.0F, this.framePreview.getResources());
    this.framePreviewImage.getLayoutParams().width = paramInt1;
    this.framePreviewImage.getLayoutParams().height = paramInt2;
    return this;
  }
  
  public bgpa setPreviewImage(Drawable paramDrawable)
  {
    return setPreviewImage(paramDrawable, false, 0);
  }
  
  public bgpa setPreviewImage(Drawable paramDrawable, boolean paramBoolean, int paramInt)
  {
  ...
  public bgpa setPreviewImage(Drawable paramDrawable, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (paramInt == 2)
      {
        this.framePreview.setBackgroundResource(2130840132);
        return this;
      }
      this.framePreview.setBackgroundResource(2130840133);
      return this;
    }
  ...
  public bgpa setPreviewImageScaleType(boolean paramBoolean)
  {
  ...
  public bgpa setSwitch(String paramString, boolean paramBoolean, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (this.mSwitch != null)
    {
      ...
      if (paramOnClickListener != null) {
        this.mSwitch.setOnCheckedChangeListener(new bgpf(this, paramOnClickListener));
      }
    }
    return this;
  }
  ...
  public bgpa setText(String paramString, int paramInt)
  {
  ...
  public bgpa setTitle(String paramString)
  {
    if (paramString != null)
    {
  ...
  public bgpa setTitleWithEmo(CharSequence paramCharSequence)
  {
  ...
  public bgpa setVideoFormat(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
  ...
  public bgpa setView(View paramView)
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
    this.bodyLayout.addView(paramView, localLayoutParams);
    return this;
