...
public class bdbn
  extends akil
{
  public bdbn(JoinTroopPreVerificationFragment paramJoinTroopPreVerificationFragment) {}
  ...
  protected void e(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      ...
      banb.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramString2, 2);
      this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.finish();
      return;
    }
    this.a.a(ajya.a(2131705887));
    this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.finish();
  }
}
