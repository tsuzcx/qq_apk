...
public class akrm
{
  ...
  private akrp jdField_a_of_type_Akrp;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentHashMap<String, akro> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  public akrm(akrp paramakrp)
  {
    this.jdField_a_of_type_Akrp = paramakrp;
  }
  ...
  private String a()
  {
    return azac.a(ayoi.jdField_a_of_type_JavaLangString);
  }
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      akro localakro = new akro();
      if (m > k) {}
      for (paramString = paramString.substring(k, m);; paramString = "")
      {
        localakro.jdField_a_of_type_JavaLangString = paramString;
        localakro.jdField_a_of_type_Long = localFile.length();
        localakro.jdField_a_of_type_Int = paramInt;
        localakro.jdField_b_of_type_Int = 0;
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) {
          break;
        }
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localFile.getName(), localakro);
        break label85;
      }
    }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Akrp != null) && (a()))
    {
      this.jdField_a_of_type_Akrp.a();
      if (QLog.isColorLevel()) {
  ...
  public String a(akro paramakro)
  {
    if (paramakro == null) {
      return "";
    }
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append(a(paramakro.jdField_a_of_type_Int));
    localStringBuffer.append(paramakro.jdField_a_of_type_JavaLangString);
    return localStringBuffer.toString();
  }
  
  public ConcurrentHashMap<String, akro> a()
  {
  ...
  public void a(String paramString, akro paramakro)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramakro != null) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, paramakro);
    }
  }
  ...
  {
    h();
    this.jdField_a_of_type_Akrp = null;
  }
}
