...
public class aeut
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bhwb
{
  public static final int[] a;
  public static long b;
  public int a;
  public long a;
  private aeuv jdField_a_of_type_Aeuv;
  public Activity a;
  ...
  public aeut(Activity paramActivity, WebView paramWebView)
  {
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        xxb.a(2, 2131691362);
        if ((this.h) && (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p))) {
      ...
      for (;;)
      {
        ...
        if (paramInt == 11)
        {
          ...
          try
          {
            ...
            if (i != 0)
            {
              ...
              localObject1 = bfhi.b(paramString + 200 + (String)localObject3 + "jubao@article@123");
        ...
        else
        {
          if (paramInt == 2)
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Zbj.g = bool1;
          ...
          if (paramInt == 4)
          {
            ...
            try
            {
              ...
              azmj.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, ndq.b(str2, new String[0]), null, null, null);
          ...
          else if (paramInt != 5)
          {
            if (paramInt == 3)
            {
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
                this.jdField_a_of_type_Zbj.a((String)localObject4, 2, false);
              }
              for (;;)
              {
            ...
            if (paramInt == 6)
            {
              if (this.jdField_a_of_type_Zbj.a((String)localObject4)) {
                this.jdField_a_of_type_Zbj.a((String)localObject4, 9, false);
              }
              if ((str3 != null) && (!"".equals(str3))) {
            ...
            else if ((paramInt == 9) || (paramInt == 10))
            {
              ...
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
                  this.jdField_a_of_type_Zbj.a((String)localObject4, 3, true);
                }
                for (;;)
                {
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
                this.jdField_a_of_type_Zbj.a((String)localObject4, 4, true);
              }
              for (;;)
              {
            ...
            {
              this.jdField_a_of_type_Zbj.a((String)localObject4, 5, true);
            }
            else if (paramInt == 15)
            {
              if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) {
              ...
              a().a(j, new aeuu(this));
              azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 16)
            {
              ...
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
              azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 17)
            {
              paramString = "";
              ...
              paramBundle.putExtra("hide_more_button", true);
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
              azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 7)
            {
              b();
            ...
            else if ((paramInt == 19) || (paramInt == 20))
            {
              ...
              for (i = 6;; i = 7)
              {
                ...
                this.jdField_a_of_type_Zbj.a((String)localObject4, i, false);
                break;
              }
              this.jdField_a_of_type_Zbj.a((String)localObject4, i, true);
            }
            else
            {
              if (paramInt == 12)
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
                  this.jdField_a_of_type_Zbj.a((String)localObject4, 8, false);
                }
                for (;;)
                {
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Aeuv = new aeuv();
      ...
      try
      {
        this.jdField_a_of_type_Aeuv.jdField_a_of_type_Long = Long.parseLong(str, 10);
      ...
      catch (NumberFormatException localNumberFormatException2)
      {
        try
        {
          this.jdField_a_of_type_Aeuv.jdField_b_of_type_Long = Long.parseLong(str, 10);
        ...
        catch (NumberFormatException localNumberFormatException2)
        {
          try
          {
            for (;;)
            {
              this.jdField_a_of_type_Aeuv.c = Long.parseLong(str, 10);
              ...
              try
              {
                this.jdField_a_of_type_Aeuv.d = Long.parseLong(paramString, 10);
                return;
              }
  ...
  public void a(zbj paramzbj)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Aeuv.jdField_a_of_type_Long;
      a();
      c();
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131720040));
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    for (Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qq")) && ((this.jdField_a_of_type_Long & 0x8) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696871);
      ...
      if (((this.jdField_a_of_type_Long & 0x8000000) != 0L) && (bjxj.a()) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:kandian")) && (localObject1 != null))
      {
        ...
        {
          localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696885);
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696891);
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:timeline")) && ((this.jdField_a_of_type_Long & 0x8000) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130838914;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696888);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130838919;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696867);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842284;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696868);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842280;
      ...
      if ((!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bfua.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList);
      }
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696882);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130843955;
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          case 2: 
            ...
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131695765);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842278;
      ...
      if ((this.jdField_f_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          case 3: 
            localObject3 = new ShareActionSheetBuilder.ActionSheetItem();
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131696872);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842287;
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).iconNeedBg = true;
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2131559086, null);
    ...
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new bhwf(alpo.a(2131702791), TypedValue.applyDimension(1, 15.0F, alnq.a)));
    localArrayList.add(new bhwf(alpo.a(2131702795), TypedValue.applyDimension(1, 16.0F, alnq.a)));
    localArrayList.add(new bhwf("", TypedValue.applyDimension(1, 17.0F, alnq.a)));
    localArrayList.add(new bhwf("", TypedValue.applyDimension(1, 17.0F, alnq.a)));
    localArrayList.add(new bhwf(alpo.a(2131702794), TypedValue.applyDimension(1, 18.0F, alnq.a)));
    ...
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131691163));
