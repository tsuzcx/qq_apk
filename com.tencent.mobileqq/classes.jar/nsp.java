...
public class nsp
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, byte[] paramArrayOfByte, boolean paramBoolean2)
  {
      ...
      try
      {
        ...
        if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.has())
        {
          ...
          if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.ret_code.get() == 0)
          {
            ...
            localArrayList = nso.a(paramQQAppInterface).a(l1);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          i = nso.a(paramQQAppInterface).a(paramArrayOfByte, paramBoolean1, l1, l2, l3, localArrayList, paramBoolean2);
          break;
        }
        i = 5;
        break;
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, aoeg paramaoeg)
  {
    if (QLog.isColorLevel()) {
    ...
    ((account_detail_dynamic_list.AccountDetailDynamicListRequest)localObject).versionInfo.set("8.4.5,3,4745");
    ...
    if (paramLong2 == 0L)
    {
      ...
      localObject = ((aody)localObject).a(String.valueOf(paramLong1));
      if (localObject == null) {
        break label350;
      }
      ...
      paramInt = 1;
      i = ocd.a(paramQQAppInterface, String.valueOf(paramLong1), (AccountDetail)localObject);
    }
    for (;;)
    {
      ...
      {
        ocd.a(null, str1, "0X80077FF", "0X80077FF", 0, 0, "1", str2, (String)localObject, String.valueOf(i), false);
        localNewIntent.setObserver(new nsq(paramQQAppInterface, bool, paramaoeg));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, aoeg paramaoeg)
  {
    nso.a(paramQQAppInterface).a(paramQQAppInterface, paramLong, paramaoeg);
    a(paramQQAppInterface, paramLong, 0L, 25, paramaoeg);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, long paramLong, aoeg paramaoeg)
  {
    nse localnse = nso.a(paramQQAppInterface).a(paramLong);
    if ((localnse != null) && (localnse.b > 0L))
    {
      if (a != localnse.b) {
        a(paramQQAppInterface, paramLong, localnse.b, 25, paramaoeg);
      }
      return;
    }
    a(paramQQAppInterface, paramLong, paramaoeg);
  }
}
