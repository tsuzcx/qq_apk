...
public class nsp
{
  ...
  private nsu jdField_a_of_type_Nsu;
  private nth jdField_a_of_type_Nth;
  
  public nsp(nth paramnth, View paramView)
  {
    ...
    this.jdField_a_of_type_Nsu = new nsu(this, null);
    this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Nsu);
    this.jdField_a_of_type_AndroidWidgetGridView.setOnItemClickListener(this.jdField_a_of_type_Nsu);
    if ((ooq.a()) && (jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      paramnth = this.jdField_a_of_type_AndroidViewView.getLayoutParams();
      paramnth.height = 0;
      this.jdField_a_of_type_AndroidViewView.setLayoutParams(paramnth);
  ...
  private void a(TabChannelCoverInfo paramTabChannelCoverInfo, View paramView)
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_Nth;
      if (nth.b)
      {
        ...
        ((TranslateAnimation)localObject).setAnimationListener(new nst(this));
  ...
  public void a()
  {
    ...
    localValueAnimator.addUpdateListener(new nsq(this));
  ...
  public void a(List<TabChannelCoverInfo> paramList)
  {
    ...
    ((List)localObject).add(new nsw(null));
    this.jdField_a_of_type_JavaUtilList.addAll((Collection)localObject);
    this.jdField_a_of_type_Nsu.notifyDataSetChanged();
  }
  ...
  public void b()
  {
    ...
    ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { 0, this.jdField_a_of_type_Int });
    localValueAnimator.setDuration(200L);
    localValueAnimator.addUpdateListener(new nsr(this));
    localValueAnimator.addListener(new nss(this));
    localValueAnimator.start();
  }
