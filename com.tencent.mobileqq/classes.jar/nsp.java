...
public class nsp
  extends ohe
{
  public nsp(ReadInJoyDeliverBiuActivity paramReadInJoyDeliverBiuActivity) {}
  ...
  public void a(int paramInt1, long paramLong, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    if (paramInt1 == 0)
    {
      bbmy.a(this.a, 2, this.a.getString(2131652577), 0).b(this.a.getTitleBarHeight());
    ...
    for (;;)
    {
      ...
      return;
      bbmy.a(this.a, 1, paramString3, 0).b(this.a.getTitleBarHeight());
    }
  }
  ...
  public void a(long paramLong, int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      paramString = this.a.getString(2131652577);
      if (ReadInJoyDeliverBiuActivity.g(this.a)) {
        paramString = this.a.getString(2131652570);
      }
      ReadInJoyDeliverBiuActivity.d(this.a, false);
      bbmy.a(this.a, 2, paramString, 0).b(this.a.getTitleBarHeight());
    ...
    for (;;)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actMultiBiuResult", bool, paramLong, 0L, paramString, "");
