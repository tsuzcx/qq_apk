...
public class wea
  extends vqr
{
  public static final String a = vpl.a("StorySvc.new_get_date_share_list");
  public static final String b = vpl.a("StorySvc.get_share_video_info_list");
  public int c;
  public String c;
  public int d;
  public String d;
  ...
  public vqm a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wfy(this.jdField_c_of_type_JavaLangString, localRspGetCollectionVideoList);
    }
  ...
  protected byte[] a()
  {
    ...
    for (;;)
    {
      yos.a(this.jdField_c_of_type_JavaLangString);
