...
public class bgie
  extends QIPCModule
{
  private static bgie jdField_a_of_type_Bgie;
  bgif jdField_a_of_type_Bgif;
  
  public bgie(String paramString)
  {
    super(paramString);
  }
  
  public static bgie a()
  {
    if (jdField_a_of_type_Bgie == null) {}
    try
    {
      if (jdField_a_of_type_Bgie == null) {
        jdField_a_of_type_Bgie = new bgie("QQComicIPCModule");
      }
      return jdField_a_of_type_Bgie;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("isLebaItemOpen".equals(paramString))
    {
      ...
      paramString = ((avps)((QQAppInterface)localObject).getManager(36)).a().iterator();
      do
      {
      ...
      for (;;)
      {
        ...
        else
        {
          if ("getComicConfig".equals(paramString))
          {
            ...
            {
              if (this.jdField_a_of_type_Bgif == null) {
                this.jdField_a_of_type_Bgif = new bgif(this, paramInt);
              }
              paramString.addCallBacker(this.jdField_a_of_type_Bgif);
            }
          ...
          if ("getPlayerSo".equals(paramString)) {
            bghz.a((QQAppInterface)localObject);
          }
        }
      }
    }
