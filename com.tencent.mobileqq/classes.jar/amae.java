...
public class amae
{
  ...
  {
    amae localamae = a();
    BackgroundProbeManager.1 local1 = new BackgroundProbeManager.1(localamae);
    BackgroundProbeManager.2 local2 = new BackgroundProbeManager.2(localamae);
    boolean bool = localamae.a();
    if (QLog.isColorLevel()) {
      QLog.i("BackgroundProbeManager", 2, "onRunningBackground: invoked.  probeEnabled: " + bool);
    }
    if (bool) {
      azjv.a(local1, 180000L);
    }
    azjv.a(local2, 181000L);
  }
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((c) && (b()) && (!jdField_b_of_type_Boolean) && (i != 0) && (paramIntent.getComponent() == null))
      {
        ...
        axps.a(localBackgroundException, "intent: " + paramIntent.toString());
  ...
  private void b()
  {
    ...
    {
      axps.a(new BackgroundException("startProbeService failed"));
    }
  }
