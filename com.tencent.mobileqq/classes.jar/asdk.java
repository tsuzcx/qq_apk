...
public class asdk
  extends asdn
{
  public asdk(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(XmlData paramXmlData)
  {
    ...
    try
    {
      ...
      if (((SharedPreferences)localObject1).getBoolean("qq.android.ar.native.so_v8.3.6", true))
      {
        ...
        localObject1 = new File(apjk.a() + File.separator).listFiles();
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          localObject = "0";
          bdll.b(localQQAppInterface, "dc01440", "", "", "0X8007A3D", "0X8007A3D", 0, 0, "", String.valueOf(i), (String)localObject, "qq.android.ar.native.so_v8.3.6");
          ...
          bdmc.a(BaseApplicationImpl.getContext()).a(this.a.getCurrentAccountUin(), "armap_so_update_rate", true, 0L, 0L, (HashMap)localObject, "", false);
        }
      }
      catch (Exception localException)
      {
