...
public class ajmr
{
  ...
  protected static String a(String paramString)
  {
    ...
    return paramString.replace("[client]", "androidQQ").replace("[version]", "8.3.0.4480").replace("[platformId]", "2").replace("[device]", Build.DEVICE).replace("[system]", Build.VERSION.RELEASE).replace("[systemInt]", Integer.toString(Build.VERSION.SDK_INT));
  }
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      ajms.ah = a(paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ApolloConfigUtils", 2, "sApolloStoreUrl = " + ajms.ah);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          bbkb.k((Context)localObject2, Integer.parseInt(paramString));
          ...
          bbkb.l((Context)localObject2, Integer.parseInt((String)localObject3));
        }
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < paramString.length())
        {
          ...
          if (!a("8.3.0", ((JSONObject)localObject3).optString("minVersion"), ((JSONObject)localObject3).optString("maxVersion"))) {
            break label1447;
          }
        ...
        if (((JSONObject)localObject1).has("freqConfig"))
        {
          ...
          if (paramString != null)
          {
            ...
            if (nqu.jdField_a_of_type_Int < i) {
              nqu.jdField_a_of_type_Int = i;
            }
          }
        }
        ...
        if (((JSONObject)localObject1).has("gameConfig"))
        {
          ...
          if ((paramString != null) && (paramString.has("aio")))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject1)) {
              ajms.aD = (String)localObject1;
            }
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              ajms.aE = ((String)localObject2).trim();
            }
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              ajms.aF = ((String)localObject3).trim();
            }
          }
        }
        if (airx.a.get()) {
        ...
        paramString = (airx)paramQQAppInterface.getManager(153);
        airx.a.set(true);
        paramString.h();
        return;
        label1447:
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                ajms.ai = a(paramString2);
                              } while (!QLog.isColorLevel());
                              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloStoreInteractUrl=", ajms.ai });
                              return;
                            ...
                            ajms.aj = a(paramString2);
                          } while (!QLog.isColorLevel());
                          QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewStoreUrl=", ajms.aj });
                          return;
                          if (!"game_center".equals(paramString1)) {
                            break;
                          }
                        } while (TextUtils.isEmpty(paramString2));
                        ajms.ak = a(paramString2);
                      } while (!QLog.isColorLevel());
                      QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCenterUrl=", ajms.ak });
                      return;
                      if (!"new_interact".equals(paramString1)) {
                        break;
                      }
                    } while (TextUtils.isEmpty(paramString2));
                    ajms.al = a(paramString2);
                  } while (!QLog.isColorLevel());
                  QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewInteractUrl=", ajms.al });
                  return;
                  if (!"game_city".equals(paramString1)) {
                    break;
                  }
                } while (TextUtils.isEmpty(paramString2));
                ajms.am = a(paramString2);
              } while (!QLog.isColorLevel());
              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCityUrl=", ajms.am });
              return;
              if ("apollo_drawer_game_box_lottie".equals(paramString1))
              {
                ajms.ar = paramString2;
                return;
              }
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (i < paramJSONObject.length())
          {
            ...
            if (!a("8.3.0", localJSONObject.optString("minVersion"), localJSONObject.optString("maxVersion"))) {
              continue;
            }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            if (a("8.3.0", str1, str2))
            {
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
                ajms.at = (String)localObject2;
                ajms.au = localJSONObject.optString("id");
                ajms.av = ajms.jdField_a_of_type_JavaLangString + "/script/" + ajms.au + "/";
                if (paramBoolean)
                {
              ...
              if (QLog.isColorLevel())
              {
                QLog.d("ApolloConfigUtils", 2, new Object[] { "parseBaseScriptConfig: localversion target.url=" + (String)localObject2, ",scriptId:", ajms.au, ",isUpdate:", Boolean.valueOf(paramBoolean) });
                localObject3 = localObject1;
              }
            }
            else
            {
              ...
              if (a("8.3.0", str1) < 0)
              {
                ...
                if (a((String)localObject1, str1) < 0)
                {
                  if (!TextUtils.isEmpty((CharSequence)localObject2))
                  {
                    ajms.aw = (String)localObject2;
                    ajms.ax = localJSONObject.optString("id");
                    ajms.ay = ajms.jdField_a_of_type_JavaLangString + "/script/" + ajms.ax + "/";
                  }
                  if (QLog.isColorLevel()) {
                    QLog.d("ApolloConfigUtils", 2, "parseBaseScriptConfig: newestMinVersion=" + str1 + " target.url=" + (String)localObject2 + ", id=" + ajms.ax);
                  }
                  localObject3 = str1;
                }
              }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localApolloPreDownloadData.resId = bfko.b(localApolloPreDownloadData.url);
          ...
          if ((!TextUtils.isEmpty(localApolloPreDownloadData.minVer)) && (!TextUtils.isEmpty(localApolloPreDownloadData.maxVer)) && (!a("8.3.0", localApolloPreDownloadData.minVer, localApolloPreDownloadData.maxVer))) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aizi.a(jdField_a_of_type_OrgJsonJSONArray);
        ...
        if (localJSONObject2 != null)
        {
          aixr.a("aio.enter.bg", localJSONObject2.optString("entranceBkgUrl"));
          ...
          else
          {
            ...
            aixr.a("aio.enter", paramQQAppInterface);
            aixr.a("aio.enter.name", localJSONObject2.optString("entranceName"));
          }
        }
        else
        {
