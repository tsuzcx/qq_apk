  ...
  extends AsyncTask<Void, Void, Bitmap>
{
  ...
  private ajom(PhotoCropActivity paramPhotoCropActivity) {}
  ...
  protected Bitmap a(Void... paramVarArgs)
  {
    try
    {
      ...
      for (paramVarArgs = Bitmap.Config.ARGB_8888;; paramVarArgs = Bitmap.Config.RGB_565)
      {
        ...
        bfvo.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString, localOptions);
        localOptions.inSampleSize = ajpz.a(localOptions, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g);
        localOptions.inJustDecodeBounds = false;
        paramVarArgs = bfvo.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString, localOptions);
        return new ExifBitmapCreator(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString).creatBitmap(paramVarArgs);
      }
      return null;
    }
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    if (this.jdField_a_of_type_Int == 1) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, amtj.a(2131707174), 0).a();
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 2) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, amtj.a(2131707175), 0).a();
      } else {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, amtj.a(2131707173), 0).a();
      }
    }
  }
}
