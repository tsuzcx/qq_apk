  ...
  extends ajfb
{
  ...
  private ajmm jdField_a_of_type_Ajmm = new ajon(this);
  private ajre jdField_a_of_type_Ajre = new ajoo(this);
  private Timer jdField_a_of_type_JavaUtilTimer;
  private boolean jdField_a_of_type_Boolean;
  
  public ajom(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.app.addObserver(this.jdField_a_of_type_Ajmm);
    this.app.addObserver(this.jdField_a_of_type_Ajre);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramString = awbg.a(this.app, 13, paramString, localawbn, paramLong2, awbk.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (ajrc)this.app.a(10);
    if ((((ajrc)localObject1).a() != 0) && (((ajrc)localObject1).e() == 1))
    {
