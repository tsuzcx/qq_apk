...
public class ajom
{
  ...
  public static CopyOnWriteArrayList<WeakReference<ajon>> a;
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (ajon)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((ajon)localObject2).a(paramInt);
          }
        }
      }
    }
  ...
  public static void a(ajon paramajon)
  {
    if (paramajon == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((localWeakReference != null) && (paramajon == localWeakReference.get()))
            {
              QLog.i("ApolloSoLoader", 1, "already add, cb:" + paramajon);
              break;
            }
          }
        }
      ...
      jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramajon));
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    if ((jdField_d_of_type_Boolean) && (airx.a(BaseApplicationImpl.getContext()))) {}
    ...
    for (;;)
    {
      ...
      synchronized (bfnq.a)
      {
        ...
        if (i < j)
        {
          ...
          ajlo.a(10, 300, new Object[] { "load [" + ((File)localObject1).getAbsolutePath() + "]" });
        }
      }
      return;
      label223:
  ...
  /* Error */
  public static void b(ajon paramajon)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: aload_0
    //   4: ifnull +14 -> 18
    //   7: getstatic 68	ajom:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   20: monitorexit
    //   21: return
    //   22: getstatic 68	ajom:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   57: if_acmpne -28 -> 29
    //   60: getstatic 68	ajom:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: aload_3
  ...
  public static boolean b()
  {
    ...
    try
    {
      ...
      {
        str3 = arrayOfString[i];
        bool = bbdx.d(str2 + "/" + str3);
        if (!bool) {
          return false;
        }
        i += 1;
      }
      bbdx.a(bfnq.a(1), false);
      return true;
    }
  ...
  private static boolean b(int paramInt)
  {
    try
    {
      synchronized (bfnq.a)
      {
        File localFile1 = new File(bfnq.a(paramInt));
        String str1 = bfnq.a();
        if (localFile1.exists())
        {
          ...
          while (i < j)
          {
            ...
            if (jdField_e_of_type_Boolean) {
              ajlo.a(10, 100, new Object[] { localStringBuilder.toString() });
            }
            if (!bool) {
              return false;
            }
          ...
          bbdx.a(localFile1.getAbsolutePath());
  ...
  private static void c(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (l < 120000L)
      {
        ...
        if (jdField_e_of_type_Boolean) {
          ajlo.a(10, 200, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
        }
      }
    }
    do
    {
      do
      {
        return;
        if (jdField_e_of_type_Boolean) {
          ajlo.a(10, 200, new Object[] { "startDownload:", Long.valueOf(l) });
        }
    ...
    ajlo.a(10, 201, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
    return;
    jdField_a_of_type_Long = System.currentTimeMillis();
    if (jdField_e_of_type_Boolean) {
      ajlo.a(10, 201, new Object[] { "startDownload:", Long.valueOf(l) });
    }
    anpi.a();
  }
  ...
  private static void f()
  {
    try
    {
      File localFile = new File(ajsd.aW + "pddata/prd/early", anpi.a);
      if (!localFile.exists())
      {
        c(1);
        return;
      ...
      {
        bfnq.a(localFile.getAbsolutePath(), 1);
  ...
  private static boolean j()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bool1 = localSharedPreferences.getBoolean("is_handle_reinstall_" + anpi.a, false);
        if ((f) || ((bool1) && (str.equals(anpi.a)))) {
          break label295;
        }
        if (str.equals(anpi.a)) {
          break;
        }
        QLog.i("ApolloSoLoader", 1, "oldRes:" + str + ",newRes:" + anpi.a);
        if (k())
        {
          bool1 = false;
          if (bool1)
          {
            localSharedPreferences.edit().putBoolean("is_handle_reinstall_" + anpi.a, true).commit();
            f = true;
          }
          bool1 = bool2;
          if (!jdField_e_of_type_Boolean) {
          ...
          ajlo.a(10, 100, new Object[] { "reinstall delete old so, oldRes:", str, ",newRes:", anpi.a });
          return true;
        }
      }
      catch (Throwable localThrowable)
      {
        QLog.e("ApolloSoLoader", 1, localThrowable, new Object[0]);
        if (jdField_e_of_type_Boolean) {
          ajlo.a(10, 100, new Object[] { "reinstall th:", localThrowable });
        }
        b();
        return false;
      }
    ...
    for (;;)
    {
      try
      {
        if (ApolloGameUtil.a())
        {
          ...
          ajlo.a(10, 300, 1002, new Object[] { "arch=x86" });
          break;
        }
        if (!UpdateArkSo.a(BaseApplicationImpl.getContext(), UpdateArkSo.a()))
        {
          ...
          ajlo.a(10, 300, 1003, new Object[] { "png-armeabi-v7a load failed" });
          jdField_a_of_type_Boolean = true;
          break label498;
        }
        ...
        localObject = (anpc)((AppInterface)localObject).getManager(77);
        if (localObject == null) {
          break label491;
        }
        localObject = (anpi)((anpc)localObject).a(anpi.a);
        if (localObject == null) {
          break label491;
        }
        localObject = ((anpi)localObject).a();
        if (localObject == null) {
          break label491;
        }
        i = ((XmlData)localObject).Version;
        QLog.i("ApolloSoLoader", 1, "[so info], str:" + anpi.a + ",ver:" + i + ", IS_CPU_64_BIT=" + AppSetting.jdField_b_of_type_Boolean);
        if (jdField_e_of_type_Boolean) {
          ajlo.a(10, 300, new Object[] { "[so info], str:" + anpi.a + ",ver:" + i });
        }
        if (a(jdField_c_of_type_ArrayOfJavaLangString))
        {
          ...
          if (localObject != null) {
            ((SharedPreferences)localObject).edit().putString("res_name", anpi.a).commit();
          }
          ...
          ajlo.a(10, 300, 0, new Object[] { "loadAllSo success" });
          break label500;
        }
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (jdField_e_of_type_Boolean)
        {
          ajlo.a(10, 300, 1004, new Object[] { "[loadAllSo], Something unexpected happened.", localThrowable });
          jdField_a_of_type_Boolean = true;
        }
        return false;
      }
  ...
  private static boolean m()
  {
    ...
    boolean bool = new ajnl(-1, 3, "", "").a();
    QLog.i("ApolloSoLoader", 1, "[isSavaSoExists], check result:" + bool);
    if (jdField_e_of_type_Boolean) {
      ajlo.a(10, 100, new Object[] { "[isSavaSoExists], check result:" + bool });
    }
    return bool;
  }
  ...
  private static boolean n()
  {
    ...
    if ((BaseApplicationImpl.sProcessId == 2) || (BaseApplicationImpl.sProcessId == 8))
    {
      if (a(jdField_b_of_type_ArrayOfJavaLangString))
      {
        ...
        if (new File(bfnq.a() + "checkList_jsc").exists())
        {
          bool = new ajnl(-1, 4, "", "").a();
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        for (;;)
        {
          try
          {
            synchronized (bfnq.a)
            {
              ...
              str3 = arrayOfString[i];
              bool = bbdx.d(str1 + "/" + str3, (String)localObject2 + str3);
              if (bool) {
                continue;
              }
              return false;
        ...
        {
          str3 = arrayOfString[i];
          bool = bbdx.d(str2 + "/" + str3, (String)localObject2 + str3);
          if (!bool) {
            return false;
          }
          i += 1;
  ...
  private static boolean o()
  {
    ...
    try
    {
      if (TextUtils.isEmpty(airx.f)) {
        airx.f = bbdx.b(new File(a("brick.js"), "brick.js"));
      }
      if (TextUtils.isEmpty(airx.g)) {
        airx.g = bbdx.b(new File(a("ticker.js"), "ticker.js"));
      }
      if (TextUtils.isEmpty(airx.h)) {
        airx.h = bbdx.b(new File(a("scene.js"), "scene.js"));
      }
      if (TextUtils.isEmpty(airx.i)) {
        airx.i = bbdx.b(new File(a("game.js"), "game.js"));
      }
      return true;
    }
    catch (Throwable localThrowable)
    {
      ...
      if (jdField_e_of_type_Boolean) {
        ajlo.a(10, 100, new Object[] { "[initScriptLib], th:", localThrowable });
      }
      return false;
    }
    finally
