...
public class aybo
{
  ...
  public static ArrayList<aybm> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)axdz.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)axdz.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            aybm localaybm2 = new aybm();
            localaybm2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localaybm2.jdField_a_of_type_Int != 1) && (localaybm2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localaybm2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localaybm2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localaybm2.c = ((JSONObject)localObject2).optString("subTitle");
            localaybm2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localaybm2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            aybm localaybm1 = new aybm();
            localaybm1.jdField_a_of_type_Int = 1;
            localaybm1.jdField_b_of_type_Int = 2130841328;
            localaybm1.jdField_b_of_type_JavaLangString = anni.a(2131706159);
            localArrayList.add(localaybm1);
            localaybm1 = new aybm();
            localaybm1.jdField_a_of_type_Int = 2;
            localaybm1.jdField_b_of_type_Int = 2130841327;
            localaybm1.jdField_b_of_type_JavaLangString = anni.a(2131706160);
            localArrayList.add(localaybm1);
          }
  ...
  public static void a(Context paramContext, aybm paramaybm, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramaybm.jdField_a_of_type_Int);
    }
    switch (paramaybm.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramaybm.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    axbl localaxbl = axbl.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localaxbl != null)
    {
      if (axbl.a(paramContext))
      {
        a(paramContext, localaxbl.d);
        return;
      }
      localaxbl.f = a(paramString1, paramString2);
      paramContext = new aybf(paramContext);
      paramContext.a(localaxbl);
      paramContext.show();
      return;
    }
  ...
  {
    new bcsy(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(paramContext, 2131717588, 0).a();
        if (QLog.isColorLevel()) {
      ...
      {
        String str = bhgg.a(anhk.ba + "photo/" + System.currentTimeMillis() + ".jpg");
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new aybp(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                QQToast.a(paramContext, 2131690580, 0).a();
                return;
              }
            }
          }
  ...
  {
    biau localbiau = new biau(paramContext, paramContext.getResources().getDimensionPixelSize(2131298998));
    localbiau.c(2131693478);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbiau, paramString2, paramContext, paramString1), 5, null, true);
  }
