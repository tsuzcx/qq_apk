  ...
  implements Comparator<ChatMessage>
{
  ...
  public int a;
  private bhod<Integer> jdField_a_of_type_Bhod;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aljq.aX + "fight/pic_expire.png";
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bdcs.a(paramQQAppInterface.getApp(), 2130841175, jdField_a_of_type_JavaLangString);
      paramQQAppInterface = bdcs.c(jdField_a_of_type_JavaLangString);
      paramQQAppInterface = bame.d("chatthumb:" + paramQQAppInterface);
      bdcs.d(jdField_a_of_type_JavaLangString, paramQQAppInterface);
    }
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    //   42: aload_0
    //   43: getfield 159	aukx:jdField_a_of_type_Bhod	Lbhod;
    //   46: ifnull +40 -> 86
    //   49: aload_0
    //   50: getfield 159	aukx:jdField_a_of_type_Bhod	Lbhod;
    //   53: lload_1
    //   54: iconst_0
    //   55: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   58: invokevirtual 170	bhod:a	(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    //   71: ifeq +18 -> 89
    //   74: aload_0
    //   75: getfield 159	aukx:jdField_a_of_type_Bhod	Lbhod;
    //   78: lload_1
    //   79: iload_3
    //   80: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   83: invokevirtual 177	bhod:a	(JLjava/lang/Object;)V
    //   86: aload_0
    //   87: monitorexit
    //   88: return
    //   89: aload_0
    //   90: getfield 159	aukx:jdField_a_of_type_Bhod	Lbhod;
    //   93: lload_1
    //   94: invokevirtual 180	bhod:b	(J)V
    //   97: goto -11 -> 86
    //   100: astore 4
    //   102: aload_0
    //   103: monitorexit
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, int paramInt2, @Nullable Bundle paramBundle)
  {
    ...
    localbaub.jdField_b_of_type_JavaLangString = paramQQAppInterface.getAccount();
    localbaub.c = paramString;
    localbaub.jdField_a_of_type_Int = paramInt1;
    localbaub.jdField_b_of_type_Int = 2;
    localbaub.jdField_a_of_type_Long = ((MessageRecord)paramArrayList.get(0)).uniseq;
    ...
    {
      localbaub.n = k;
      localbaub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((MessageRecord)paramArrayList.get(0));
      localMessageForPtt.mInputContent = "";
      localbaub.jdField_a_of_type_Awfy = new aulc(paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramInt2, this, null);
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, alsi paramalsi, ArrayList<MessageRecord> paramArrayList, boolean paramBoolean, int paramInt2)
  {
    ...
    paramalsi = paramQQAppInterface.a().a().a(paramArrayList, paramHashMap, paramBoolean);
    if (paramalsi == null)
    {
    ...
    do
    {
      ...
      if (paramInt2 == 0) {
        paramHashMap = new aulb(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
      }
      for (;;)
      {
        if (a(paramQQAppInterface, paramalsi, paramQQAppInterface.getCurrentAccountUin(), paramString, paramString, paramInt1, paramMessageRecord.uniseq, 1035, paramHashMap))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (paramInt2 == 2)
          {
            paramHashMap = new aula(paramQQAppInterface, paramMessageRecord, paramString, paramInt1, paramArrayList, paramHashMap);
          }
          else if (paramInt2 == 5)
          {
            paramHashMap = new axhc(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
          }
          else
          {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<awew> paramArrayList1, int paramInt2)
  {
    awfc localawfc = awes.a(8, 7);
    localawfc.a(paramArrayList1);
    localawfc.a(new auky(this, paramInt2, paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramHashMap));
    awes.a(localawfc, paramQQAppInterface);
  }
  
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<ayyz> paramArrayList1, ayzo paramayzo, int paramInt2)
  {
    ...
    localayzo.a(new aukz(this, paramArrayList, paramMessageRecord, paramQQAppInterface, paramString, paramInt1, paramHashMap, paramInt2));
    ayyu.a(localayzo, paramQQAppInterface);
  }
  ...
  private boolean a(long paramLong)
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool1;
        if (((Integer)this.jdField_a_of_type_Bhod.a(paramLong, Integer.valueOf(0))).intValue() == 0)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public MessageForStructing a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, AbsStructMsg paramAbsStructMsg)
  {
    ...
    paramQQAppInterface = ayvw.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, 0L, paramAbsStructMsg);
  ...
  public List<ChatMessage> a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramString != null) {
      abot.a(paramString, paramInt, (List)localObject, paramQQAppInterface);
    }
    ...
    while (paramString.hasNext())
    {
      ...
      if ((localObject instanceof MessageForStructing))
      {
        ...
        if (localMessageForStructing.structingMsg == null) {
          localMessageForStructing.structingMsg = azqu.a(((MessageRecord)localObject).msgData);
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      k = bdiv.a(paramQQAppInterface.c(), "multimsg_config");
      if (k > 0) {
    ...
    catch (NumberFormatException paramQQAppInterface)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramQQAppInterface))
        {
          ...
          if (DeviceProfileManager.a(paramQQAppInterface, (Object[])localObject, new almr()) >= localObject.length)
          {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    ((axso)paramQQAppInterface.getManager(326)).a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramArrayList);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, String paramString2, AbsStructMsg paramAbsStructMsg, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      break;
      if (k != 0) {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800662C", "0X800662C", 0, 1, 0, "", "", "", "");
      }
      ArrayList localArrayList = new ArrayList();
      ...
      if (paramInt2 == 2)
      {
        ...
        k = aytq.jdField_a_of_type_Int;
        aytq.jdField_a_of_type_Int = k + 1;
        localObject1 = ayvw.a(paramQQAppInterface, (String)localObject1, paramString1, (String)localObject1, 1040, k, paramAbsStructMsg);
        ((MessageRecord)localObject1).msg = acex.a(localArrayList, (Map)localObject2);
      }
      for (;;)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject3 = bdir.a(paramQQAppInterface, paramString1, paramInt1, paramAbsStructMsg);
        }
        if (localObject3 == null) {
          break;
        }
        ((MessageRecord)localObject3).isReMultiMsg = true;
        aeyf.a().a(((MessageRecord)localObject3).uniseq, 0L, paramInt3);
        if (paramBoolean) {
        ...
        if ((paramInt2 == 0) || (paramInt2 == 2))
        {
          ...
          ((auld)localObject1).jdField_a_of_type_Int = 0;
          ((auld)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = ((SessionInfo)localObject4);
          ((auld)localObject1).jdField_a_of_type_JavaUtilList = localArrayList;
          ((auld)localObject1).jdField_a_of_type_JavaUtilMap = ((Map)localObject2);
          ((auld)localObject1).jdField_b_of_type_Int = paramInt2;
          ((auld)localObject1).jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = paramAbsStructMsg;
          ((auld)localObject1).jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = ((MessageForStructing)localObject3);
          paramQQAppInterface.a().e((auld)localObject1);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  public void a(QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean)
  {
    ...
    for (int k = 0;; k = 1)
    {
      ...
      azmz.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "multiMsgReceive", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
    azmz.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "multiMsgReceive", paramBoolean, 0L, 0L, localHashMap, "");
  }
  ...
  public void a(MessageForStructing paramMessageForStructing, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.h != 0) && (awez.a(paramQQAppInterface, paramMessageForStructing.istroop, paramMessageForStructing.frienduin) == 1));
  ...
  public void a(HashMap<String, String> paramHashMap, long paramLong, QQAppInterface paramQQAppInterface)
  {
    ...
    //   111: goto -81 -> 30
    //   114: aload 4
    //   116: invokevirtual 554	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   119: invokevirtual 560	awbx:createEntityManager	()Lawbw;
    //   122: astore 4
    //   124: aload 4
    //   126: invokevirtual 961	awbw:a	()Lawby;
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 965	awby:a	()V
    //   134: aload 5
    ...
    //   163: invokevirtual 968	awbw:b	(Lawbv;)V
    //   166: goto -25 -> 141
    //   169: astore 5
    //   171: aload 5
    //   173: invokevirtual 971	java/lang/Exception:printStackTrace	()V
    //   176: aload_1
    //   177: invokevirtual 972	awby:b	()V
    //   180: aload 4
    //   182: invokevirtual 973	awbw:a	()V
    //   185: return
    //   186: aload_1
    //   187: invokevirtual 975	awby:c	()V
    //   190: aload_1
    //   191: invokevirtual 972	awby:b	()V
    //   194: goto -14 -> 180
    //   197: astore 4
    //   199: aload_1
    //   200: invokevirtual 972	awby:b	()V
    //   203: aload 4
    //   205: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  {
    azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8006628", "0X8006628", 0, 1, 0, "", "", "", "");
    return a(paramQQAppInterface, paramLong).size() > 0;
  }
  
  public boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, long paramLong, int paramInt2, aweh paramaweh)
  {
    ...
    localbaub.jdField_b_of_type_Int = 131078;
    localbaub.jdField_l_of_type_JavaLangString = paramString1;
    localbaub.jdField_b_of_type_JavaLangString = paramString2;
    localbaub.c = paramString3;
    localbaub.d = paramString4;
    localbaub.jdField_a_of_type_Int = paramInt1;
    localbaub.jdField_a_of_type_Long = paramLong;
    localbaub.jdField_e_of_type_Int = paramInt2;
  ...
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      Collections.sort(paramList, jdField_a_of_type_Aukx);
    }
  }
  ...
  public boolean b(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
    {
      ...
      if (localIterator1.hasNext())
      {
        ...
        for (;;)
        {
          if ((paramQQAppInterface != null) && (!baul.a(null, paramQQAppInterface, 65537)))
          {
            if (QLog.isColorLevel()) {
        ...
        for (paramQQAppInterface = (MessageForPic)paramQQAppInterface;; paramQQAppInterface = (QQAppInterface)localObject)
        {
          ...
          for (;;)
          {
            ...
            if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof StructMsgForImageShare)))
            {
              ...
              if ((localObject != null) && (((azsp)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic == null))
              {
                if (((azsp)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare == null) {
                  ((azsp)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare = ((StructMsgForImageShare)paramQQAppInterface);
                }
                ((azsp)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic = ((azsp)localObject).a();
                paramQQAppInterface = ((azsp)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
                break label99;
              }
            }
  ...
  public int c()
  {
    ...
    {
      break;
      m = aule.a(localChatMessage);
      break label64;
      aule.b("checkMap.size = %d,count= %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilHashMap.size()), Integer.valueOf(k) });
      return k;
    }
  }
}
