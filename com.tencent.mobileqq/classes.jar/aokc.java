...
public class aokc
{
  ...
  public static aokc a(aogf[] paramArrayOfaogf)
  {
    aokc localaokc = new aokc();
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          String str1 = paramArrayOfaogf[i].jdField_a_of_type_JavaLangString;
          if (str1 == null) {
            break label671;
          }
          ...
          if (((JSONObject)localObject).has("aio_mini_app_on"))
          {
            ...
            bool = true;
            localaokc.jdField_a_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("mini_app_local_search"))
          {
            ...
            bool = true;
            localaokc.jdField_b_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("mini_app_refresh_time")) {
            localaokc.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("mini_app_refresh_time", 60);
          }
          if (((JSONObject)localObject).has("popBarShowMiniAppStore"))
          {
            ...
            bool = true;
            localaokc.jdField_c_of_type_Boolean = bool;
          }
          ...
          if (((JSONObject)localObject).has("mini_app_entry_auto_show"))
          {
            ...
            bool = true;
            localaokc.jdField_d_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("contact_mini_app_on"))
          {
            ...
            bool = true;
            localaokc.jdField_f_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("more_mini_app_on"))
          {
            ...
            bool = true;
            localaokc.jdField_e_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("group_mini_app_on"))
          {
            ...
            bool = true;
            localaokc.jdField_g_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("avatar_mini_app_on"))
          {
            ...
            if (((JSONObject)localObject).has("avatar_mini_app_url")) {
              localaokc.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).optString("avatar_mini_app_url");
            }
          }
          if (((JSONObject)localObject).has("back_to_home_scene_list"))
          {
            if (localaokc.jdField_a_of_type_JavaUtilArrayList == null) {
              localaokc.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
            }
            localaokc.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (j < k)
            {
              ...
              localaokc.jdField_a_of_type_JavaUtilArrayList.add(Integer.valueOf(str2));
              break label678;
            }
          }
          if (1 == ((JSONObject)localObject).optInt("enable_c2c_plus_panel", 0))
          {
            localaokc.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("url", "");
            localaokc.jdField_c_of_type_JavaLangString = ((JSONObject)localObject).optString("icon", "");
            localaokc.jdField_d_of_type_JavaLangString = ((JSONObject)localObject).optString("icon_night", "");
            localaokc.jdField_e_of_type_JavaLangString = ((JSONObject)localObject).optString("simple_icon", "");
            localaokc.jdField_f_of_type_JavaLangString = ((JSONObject)localObject).optString("simple_icon_night", "");
            localaokc.jdField_g_of_type_JavaLangString = ((JSONObject)localObject).optString("name", BaseApplicationImpl.sApplication.getString(2131698794));
            localObject = BaseApplicationImpl.getApplication().getRuntime();
            if ((localObject instanceof QQAppInterface))
            {
              localObject = (QQAppInterface)localObject;
              agcq.a((QQAppInterface)localObject).a((QQAppInterface)localObject, localaokc);
            }
          }
