  ...
  extends BusinessHandler
{
  ...
  public aokc(NearbyAppInterface paramNearbyAppInterface)
  {
  ...
  private void a(List<MultiHeadUrl.RspUsrHeadInfo> paramList, List<FaceInfo> paramList1, ArrayList<FaceInfo> paramArrayList, List<FaceInfo> paramList2, int paramInt1, int paramInt2, aoke paramaoke)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 32) && (((MultiHeadUrl.RspHeadInfo)localObject2).faceType.get() != 0))
      {
        ...
        if (paramArrayList != null)
        {
          label183:
          i = 0;
          localObject1 = paramaoke.a("stranger_" + String.valueOf(localFaceInfo.b) + "_" + localFaceInfo.jdField_a_of_type_JavaLangString);
          if (paramaoke.a(localFaceInfo)) {
            break label459;
          }
          i = 1;
          label247:
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramObject)
      {
        ...
        paramToServiceMsg = (aoke)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(axoc.k);
    ...
    for (;;)
    {
      ...
      if (!bool3)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          aoks.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getApp().getApplicationContext(), true);
          return bool1;
          label212:
          bool1 = false;
        }
