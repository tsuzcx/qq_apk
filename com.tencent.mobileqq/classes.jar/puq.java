...
public class puq
  extends pqq
{
  public puq(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  public pqq a()
  {
    ...
    return a(this.jdField_a_of_type_Ram, this.jdField_a_of_type_Baxy).r().l().g().n().q().j().h();
  }
  ...
  public pqq d()
  {
    ...
    if (this.jdField_a_of_type_Pqp != null)
    {
      ...
      if ((this.jdField_a_of_type_Pqp instanceof ComponentContentBigImageVideo))
      {
        ...
        localLinearLayout3.setOnClickListener(new pur(this));
      }
    ...
    localLinearLayout2.setOnClickListener(new pus(this));
