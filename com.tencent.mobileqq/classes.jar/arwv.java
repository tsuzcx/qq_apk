  ...
  implements bejq
{
  ...
  public arwv(MultiCardRootLayout paramMultiCardRootLayout) {}
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        arww localarww = (arww)MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout).get();
        if (localarww != null) {
          MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout, localarww.a(paramMotionEvent));
        }
      }
