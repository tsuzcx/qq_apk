  ...
  implements amqb
{
  ...
  private void a(amld paramamld, int paramInt, long paramLong)
  {
    ApolloCmdChannel localApolloCmdChannel = ampj.a();
    if (localApolloCmdChannel != null) {
      localApolloCmdChannel.playMusicInner(paramamld, paramInt, paramLong);
    }
  }
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!ampj.d()) || (paramamld == null)))
    {
    ...
    for (Object localObject = null;; localObject = null)
    {
      try
      {
        if ((paramamld instanceof ApolloSurfaceView)) {
          localObject = ((ApolloSurfaceView)paramamld).getRender();
        }
        for (;;)
        {
          if (localObject == null) {
          ...
          return -1;
          if ((paramamld instanceof ApolloTextureView)) {
            localObject = ((ApolloTextureView)paramamld).getRender();
          }
        }
      ...
      catch (Throwable paramamld)
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramamld, new Object[0]);
        return -1;
      }
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new amqa(this, paramFloat, paramInt2, paramString, paramamld, paramLong));
        ...
        if (paramString != null) {
          if (-1.0F == paramFloat)
          {
            ...
            if (paramInt1 != 0) {
              a(paramamld, paramInt1, paramLong);
            }
          }
        }
        for (;;)
      ...
      paramamld = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!ampj.d())))
    {
      QLog.w("cmgame_process.CmGameSoudPoolPlayer", 1, "[playMusic], DO NOT play. switch:" + this.jdField_a_of_type_Int);
    ...
    if (paramJSONObject != null) {
      ...
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramamqr, new Object[0]);
      }
    } else {
      return null;
    }
    ...
    {
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new ampz(this, f, i, str2, paramamqr, localJSONObject));
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        if ((i == 0) || (paramamqr == null)) {
          break;
        }
        try
        {
          localJSONObject.put("id", i);
          paramamqr.a(localJSONObject);
        }
        catch (Throwable paramamqr)
        {
          QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramamqr, new Object[0]);
      ...
      break;
      paramamqr = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, bool);
