  ...
  implements ProtoReqManager.IProtoRespBack
{
  ...
  public void onProtoResp(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = (amsw)anmf.b(this.a).getManager(51);
        paramProtoReq = anmf.c(this.a).getAccount();
      ...
      else if (paramProtoResp.size() > 0)
      {
        ...
        l3 = bcsy.a().a(anmf.d(this.a));
        localObject2 = anmf.e(this.a).getMessageFacade().getAIOList(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, l3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            anmf.f(this.a).getMessageFacade().removeMsgByUniseq(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, ((ChatMessage)localObject3).uniseq, false);
          ...
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            if ((localMessageForSystemMsg.structMsg.msg.sub_type.get() == 13) && (((amsw)localObject1).b(str)))
            {
              anmf.g(this.a).getMessageFacade().removeMsgByUniseq(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
          }
        }
        bcsy.a().a(anmf.h(this.a), l2);
        if (paramProtoResp.size() < 20) {
          bcsy.a().a(true, anmf.i(this.a));
        }
        l2 = localRspNextSystemMsg.following_friend_seq.get();
        l1 = l2;
        if (l2 <= 0L) {
          l1 = anmf.j(this.a).getMsgCache().e("following_friend_seq_47");
        }
        if (QLog.isColorLevel()) {
          QLog.e("Q.systemmsg.", 2, "<---sendGetNextFriendSystemMsg : decode pb following_friend_seq" + l1);
        }
        anmf.k(this.a).getMsgCache().e("following_friend_seq_47", l1);
        localObject1 = anmf.m(this.a).getMessageFacade();
        paramProtoReq = String.valueOf(paramProtoReq);
        if ((!amwh.a(paramProtoResp)) || (!anmf.l(this.a).isBackgroundStop)) {
          break label865;
        }
      }
    }
