  ...
  implements Manager
{
  ...
  public bglf(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.a().createEntityManager();
    this.jdField_a_of_type_Bgku = new bglg(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private void b(long paramLong, ArrayList<ImportantMsgItem.MsgInfo> paramArrayList)
  {
    ...
    a(paramLong, new bgli(this, paramArrayList));
  }
  ...
  public void a(long paramLong, bglj parambglj)
  {
    if (parambglj == null) {
      return;
    }
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong)))
    {
      parambglj.a(paramLong, (ImportantMsgItem)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong)));
      return;
    }
    ThreadManager.post(new ImportantMsgManager.6(this, paramLong, parambglj), 5, null, false);
  }
  
  public void a(long paramLong, ArrayList<Long> paramArrayList, int paramInt)
  {
    ((bglf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(375)).a(paramLong, new bglh(this, paramArrayList, paramInt));
  }
  ...
  public void a(long paramLong, List<oidb_0xea3.BackMsg> paramList, List<Long> paramList1)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        bglk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localBackMsg, localArrayList2);
        if (!localArrayList2.isEmpty()) {
          localArrayList1.add(localArrayList2.get(0));
        }
      }
    }
    a(paramLong, bglk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong, localArrayList1, true), paramList1);
  }
