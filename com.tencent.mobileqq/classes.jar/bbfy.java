  ...
  extends BaseAdapter
{
  ...
  public bbfy(Context paramContext, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561055, paramViewGroup, false);
    }
    TextView localTextView = (TextView)localView.findViewById(2131366800);
    ImageView localImageView3 = (ImageView)localView.findViewById(2131368790);
    ImageView localImageView1 = (ImageView)localView.findViewById(2131368381);
    ImageView localImageView2 = (ImageView)localView.findViewById(2131365253);
    URLImageView localURLImageView = (URLImageView)localView.findViewById(2131362237);
    CaptureCommonLoadingView localCaptureCommonLoadingView = (CaptureCommonLoadingView)localView.findViewById(2131366805);
    ...
    for (;;)
    {
      ...
      if (localFilterCategoryItem.a())
      {
        ...
        if (bool)
        {
          ...
          localTextView.setText(anvx.a(2131704078));
          localImageView1.setContentDescription(anvx.a(2131704081));
          localTextView.setContentDescription(anvx.a(2131704082));
        }
      }
      for (;;)
      {
        ...
        if (bool)
        {
          ...
          paramView.mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845930);
          paramView.mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845930);
        ...
        for (;;)
        {
          bdla.b(null, "dc00898", "", "", "0X800859E", "0X800859E", 2, 0, "", "", localFilterCategoryItem.jdField_a_of_type_JavaLangString, "");
          break;
          localImageView3.setVisibility(8);
        ...
        label678:
        bool = bbgq.a().a(3, localFilterCategoryItem.jdField_b_of_type_Int, localFilterCategoryItem.jdField_a_of_type_JavaLangString);
        if (bool)
        {
