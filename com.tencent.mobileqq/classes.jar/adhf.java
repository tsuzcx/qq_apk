...
public class adhf
  implements bkzq
{
  public adhf(AddRequestActivity paramAddRequestActivity, bkzi parambkzi) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
      long l1 = bdzx.a().b();
      this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a = bdzx.a().a(Long.valueOf(l1));
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a != null)
      {
        ...
        if ((paramView != null) && (1 < paramView.size()))
        {
          ...
          AddRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131718527, 1000L, false);
        }
      }
    }
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "Verification_msg", "Vfc_shield_clk", 0, 0, "", "", "", "");
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "0X800AA45", "0X800AA45", 0, 0, "", "", "", "");
      break;
      ...
      continue;
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131694255, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.getTitleBarHeight());
    }
  }
}
