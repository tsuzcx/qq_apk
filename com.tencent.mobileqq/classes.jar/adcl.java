...
public class adcl
{
  ...
  private adbw jdField_a_of_type_Adbw;
  private adbx jdField_a_of_type_Adbx;
  private ayvv jdField_a_of_type_Ayvv;
  private ayvz jdField_a_of_type_Ayvz;
  ...
  private adby[] jdField_a_of_type_ArrayOfAdby;
  private String b;
  private String c;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    axrl.a(BaseApplication.getContext()).a(null, "pttSliceToText", true, 0L, 0L, localHashMap, "");
  }
  ...
  private void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    //   48: astore_1
    //   49: iload_3
    //   50: invokestatic 148	bbis:a	(B)I
    //   53: istore 5
    //   55: new 150	com/tencent/mobileqq/utils/SilkCodecWrapper
    //   58: dup
    //   59: aload_0
    //   60: getfield 66	adcl:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   80: astore 10
    //   82: iload 5
    //   84: invokestatic 162	bbis:a	(I)I
    //   87: istore 4
    //   89: aload_2
    //   90: astore 8
    //   92: aload_1
    ...
    //   191: astore 10
    //   193: aload_0
    //   194: getfield 173	adcl:jdField_a_of_type_Boolean	Z
    //   197: ifeq +91 -> 288
    //   200: aload_2
    //   201: astore 7
    //   203: aload_1
    ...
    //   342: astore 10
    //   344: aload_0
    //   345: getfield 173	adcl:jdField_a_of_type_Boolean	Z
    //   348: ifeq -60 -> 288
    //   351: aload_2
    //   352: astore 8
    //   354: aload_1
    ...
    //   359: astore 10
    //   361: aload 15
    //   363: invokestatic 189	bbis:a	([B)I
    //   366: istore 5
    //   368: iload 5
    //   370: ifgt +127 -> 497
    //   373: aload_2
    ...
    //   515: astore 10
    //   517: aload_0
    //   518: getfield 173	adcl:jdField_a_of_type_Boolean	Z
    //   521: ifeq -233 -> 288
    //   524: aload_2
    //   525: astore 8
    //   527: aload_1
    ...
    //   688: astore 10
    //   690: aload_0
    //   691: getfield 173	adcl:jdField_a_of_type_Boolean	Z
    //   694: ifeq -406 -> 288
    //   697: aload_2
    //   698: astore 8
    //   700: aload_1
  ...
  public byte a(String paramString)
  {
    ...
    //   14: astore_1
    //   15: aload 4
    //   17: invokestatic 239	bbis:a	(Ljava/io/InputStream;)B
    //   20: istore_2
    //   21: iload_2
    //   22: istore_3
    //   23: aload 4
  ...
  public String a(adby paramadby, int paramInt)
  {
    this.jdField_a_of_type_ArrayOfAdby[paramInt] = paramadby;
    paramadby = new StringBuffer();
    paramInt = 0;
    for (;;)
    {
      adby localadby;
      if (paramInt < this.jdField_a_of_type_ArrayOfAdby.length)
      {
        localadby = this.jdField_a_of_type_ArrayOfAdby[paramInt];
        if (localadby != null) {
          break label42;
        }
      }
      ...
      do
      {
        return paramadby.toString();
        paramadby.append(localadby.jdField_a_of_type_JavaLangString);
      } while (!localadby.jdField_a_of_type_Boolean);
      paramInt += 1;
    }
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Ayvv.d(this.c, ((Long)this.jdField_a_of_type_JavaUtilList.get(i)).longValue());
      i += 1;
    }
  ...
  public void a(adby paramadby, int paramInt)
  {
    if ((this.jdField_a_of_type_ArrayOfAdby == null) || (paramInt >= this.jdField_a_of_type_ArrayOfAdby.length) || ((this.jdField_a_of_type_ArrayOfAdby[paramInt] != null) && (this.jdField_a_of_type_ArrayOfAdby[paramInt].jdField_a_of_type_Boolean)))
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Adbx.a(a(paramadby, paramInt));
  }
  
  public void a(String paramString)
  {
    bdse.a(new VoiceTextEdtiController.2(this, paramString));
  }
  
  public void a(String paramString1, QQAppInterface paramQQAppInterface, adbx paramadbx, int paramInt, String paramString2)
  {
    this.b = paramString1;
    ...
    this.jdField_a_of_type_Ayvz = new adcm(this);
    this.jdField_a_of_type_Ayvz.addFilter(new Class[] { aytm.class });
  }
  ...
  {
    bdse.a(new VoiceTextEdtiController.3(this, paramString));
  }
