...
public class adcl
{
  ...
  private adcm jdField_a_of_type_Adcm;
  ...
  {
    SpannableString localSpannableString = new SpannableString(ajya.a(2131716859) + this.jdField_a_of_type_JavaLangString);
  ...
  public void a(QQAppInterface paramQQAppInterface, ColorStateList paramColorStateList, adcm paramadcm)
  {
    this.jdField_a_of_type_AndroidContentResColorStateList = paramColorStateList;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilTimer = new Timer();
    this.jdField_a_of_type_Adcm = paramadcm;
  }
