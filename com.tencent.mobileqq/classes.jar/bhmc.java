...
class bhmc
  implements aaob
{
  bhmc(bhmb parambhmb, String paramString, boolean paramBoolean) {}
  
  public void callback(Bundle paramBundle)
  {
    if (this.jdField_a_of_type_Bhmb.isDestroy) {}
    do
    {
      return;
      if (TextUtils.equals(this.jdField_a_of_type_Bhmb.b, this.jdField_a_of_type_JavaLangString)) {
        break;
      }
    ...
    if (i == 0)
    {
      ...
      localObject = this.jdField_a_of_type_Bhmb;
      int i1 = ((bhmb)localObject).jdField_a_of_type_Boolean;
      if (k == 15)
      {
        i = 1;
        label116:
        ((bhmb)localObject).jdField_a_of_type_Boolean = (i & i1);
        if (j != 0) {
          break label252;
        }
    ...
    for (paramBundle = this.jdField_a_of_type_JavaLangString;; paramBundle = null)
    {
      ...
      this.jdField_a_of_type_Bhmb.a(l);
      for (;;)
      {
        if (TextUtils.isEmpty(paramBundle)) {
          break label360;
        }
        localObject = this.jdField_a_of_type_Bhmb.mRuntime.a();
        if (localObject == null) {
          break;
        }
        QLog.i("WebSecurityPluginV2", 1, "now jump url=" + nmj.b(paramBundle, new String[0]));
        this.jdField_a_of_type_Bhmb.jdField_a_of_type_JavaLangString = paramBundle;
