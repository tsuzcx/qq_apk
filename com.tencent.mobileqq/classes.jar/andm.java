  ...
  extends ajfb
{
  ...
  public andm(QQAppInterface paramQQAppInterface)
  {
  ...
  public static MqqComicHeadPb.ComicReqHead a(AppInterface paramAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (String str = "";; str = "8.2.6")
    {
      localPBStringField.set(str);
      localComicReqHead.net.set(mpl.a());
      ...
      paramAppInterface = bezp.a(paramAppInterface.getApp());
  ...
  public static byte[] a(MqqComicHeadPb.ComicReqHead paramComicReqHead, MessageMicro paramMessageMicro)
  {
    ...
    try
    {
      ...
      bakz.a(arrayOfByte, 0, i);
      bakz.a(arrayOfByte, 4, paramComicReqHead, paramComicReqHead.length);
      bakz.a(arrayOfByte, i, j);
      bakz.a(arrayOfByte, i + 4, paramMessageMicro, paramMessageMicro.length);
      return arrayOfByte;
    }
  ...
  public void a(ToServiceMsg paramToServiceMsg, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      bakz.a(arrayOfByte, 0, paramToServiceMsg, j + 8, arrayOfByte.length);
      ...
      if ((localSetMyComicFavorEmotIconsReqBody != null) && (localSetMyComicFavorEmotIconsReqBody.reqs != null))
      {
        ...
        ((andn)this.app.getManager(141)).b(paramToServiceMsg);
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (paramArrayOfByte != null) {
        ...
        {
          localObject = (andn)this.app.getManager(141);
          if (localObject != null)
          {
            paramInt = 0;
            while (paramInt < paramArrayOfByte.rsps.size())
            {
              ...
              ((andn)localObject).a(localVipComicFavorEmoStructMsgInfo);
              paramInt += 1;
            }
          }
        }
  ...
  public void c(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.maintab.has())) {
      bezd.a(paramArrayOfByte.maintab.get());
    }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
          ...
          if ("ComicProtoConvSvr.tunnel".equals(localObject))
          {
            if (!paramFromServiceMsg.isSuccess())
            {
              if ("GetMyComicFavorEmotIcons".equals(str))
              {
                ...
                bcad.a().a("GetMyComicFavorEmotIcons", l2, l3, l1, paramFromServiceMsg.getBusinessFailCode(), Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[会员中心].查询我的漫图发送失败", false);
                return;
              }
              if ("SetMyComicFavorEmotIcons".equals(str))
              {
                ...
                bcad.a().a("SetMyComicFavorEmotIcons", l2, l3, l1, paramFromServiceMsg.getBusinessFailCode(), Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[会员中心].设置我的漫图发送失败", false);
                return;
              }
              if ("DelMyComicFavorEmotIcons".equals(str))
              {
                ...
                bcad.a().a("DelMyComicFavorEmotIcons", l2, l3, l1, paramFromServiceMsg.getBusinessFailCode(), Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[会员中心].删除我的漫图发送失败", false);
                return;
              }
              if ((!"GetComicGlobalConfig".equals(str)) || (!a())) {
                break;
              }
              bcad.a().a("GetComicGlobalConfig", l2, l3, l1, paramFromServiceMsg.getBusinessFailCode(), Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[QQ动漫].查询动漫全局配置失败", false);
              return;
            }
            localObject = (byte[])paramObject;
            int i = a((byte[])localObject, 0);
            paramObject = new byte[i - 4];
            bakz.a(paramObject, 0, (byte[])localObject, 4, paramObject.length);
            ...
            try
            {
              ...
              if ((paramFromServiceMsg != null) && (paramFromServiceMsg.retCode.has()))
              {
                ...
                if (j == 0)
                {
                  ...
                  bakz.a(paramFromServiceMsg, 0, (byte[])localObject, i + 4, paramFromServiceMsg.length);
                  if (!"GetMyComicFavorEmotIcons".equals(str)) {
                    break label579;
                  }
                  ...
                  bcad.a().a("GetMyComicFavorEmotIcons", l2, l3, l1, j, Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[会员中心].查询我的漫图成功", false);
                }
              }
            }
            catch (Exception paramFromServiceMsg)
            {
              ...
              if ("SetMyComicFavorEmotIcons".equals(str))
              {
                ...
                if (a()) {
                  bcad.a().a("SetMyComicFavorEmotIcons", l2, l3, l1, j, Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[会员中心].设置我的漫图信息成功", false);
                }
              }
              else if ("DelMyComicFavorEmotIcons".equals(str))
              {
                ...
                bcad.a().a("DelMyComicFavorEmotIcons", l2, l3, l1, j, Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[会员中心].删除我的漫图信息成功", false);
              }
            }
          }
        }
    ...
    bcad.a().a("GetComicGlobalConfig", l2, l3, l1, j, Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, "[QQ动漫].查询动漫全局配置，code = " + j, false);
  }
}
