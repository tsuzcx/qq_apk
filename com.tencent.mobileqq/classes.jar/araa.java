  ...
  implements arag
{
  ...
  protected araa(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bbsc parambbsc)
  {
  ...
  private arab a()
  {
    arab localarab = new arab(this);
    if ((this.jdField_a_of_type_Bbru != null) && ((this.jdField_a_of_type_Bbru instanceof araf)))
    {
      araf localaraf = (araf)this.jdField_a_of_type_Bbru;
      localarab.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo = localaraf.a();
      localarab.jdField_a_of_type_Int = localaraf.a();
    }
    return localarab;
  }
  
  public static bbsa a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bbsc parambbsc)
  {
    if (paramLong == 0L)
    {
      bbrc.a("ExcitingTransfer.ExtfGroupDownloadWorker", bbrc.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      bbrc.a("ExcitingTransfer.ExtfGroupDownloadWorker", bbrc.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null)
    {
      bbrc.a("ExcitingTransfer.ExtfGroupDownloadWorker", bbrc.jdField_a_of_type_Int, "getWoker. item.id=null");
      return null;
    }
    return new araa(paramLong, paramItem, paramBundle, parambbsc);
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt1 == 0)
    {
      bool = true;
      localObject = a();
      localaqzz = new aqzz(bbra.a());
      String str = arni.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
      localaqzz.a(paramInt1, paramInt2, str, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
      ...
      localaqzz.c(this.g);
      label100:
      if ((localObject == null) || (((arab)localObject).jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo == null)) {
        break label161;
      }
      localaqzz.a(((arab)localObject).jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo);
    }
    for (;;)
    {
      localaqzz.a(this.jdField_a_of_type_Long);
      localaqzz.a(bool);
      return;
      bool = false;
      break;
      ...
      if (this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long > 0L) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_uStartSize = this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long;
      }
      if (this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long > 0L) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_uDownloadedSize = this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long;
      }
      if (paramInt3 != 0) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_nSrvReturnCode = paramInt3;
      }
      localaqzz.a((ExcitingTransferDownloadCompletedInfo)localObject);
    }
  }
  ...
  private int b(int paramInt)
  {
    ...
    if (bdag.a()) {}
    for (long l1 = bdag.a() * 1024L;; l1 = bdag.b() * 1024L)
    {
  ...
  private void l()
  {
    ...
    aqzz localaqzz = new aqzz(bbra.a());
    Object localObject = arni.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
    localaqzz.a(1, i, (String)localObject, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
    if ((this.f > 0L) && (this.g >= this.f))
    {
      localaqzz.b(this.f);
      localaqzz.c(this.g);
  ...
  protected bbru a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    if (arni.b(paramString1)) {
      this.jdField_a_of_type_Boolean = true;
    }
    arae localarae = new arae();
    localarae.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal);
    localarae.b(paramString2);
    localarae.c(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.cookieValue);
    int i = 80;
    localarae.a(paramBoolean);
    localarae.d(paramString3);
    if (paramBoolean) {
      i = 443;
    }
    ...
    for (;;)
    {
      localarae.a(paramString2);
      paramQQAppInterface = araf.a(paramQQAppInterface, paramLong, this.jdField_b_of_type_Long, paramString1, localarae);
      if (paramQQAppInterface == null) {
        break;
      }
      ((araf)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (int i = paramExcitingTransferOneSlotComplete.m_SrvRetCode;; i = 0)
    {
      ...
      this.jdField_a_of_type_Bbqo.d = 0;
      if (paramExcitingTransferOneSlotComplete != null)
      {
        arac localarac = new arac(bbra.a());
        localarac.a(this.jdField_a_of_type_Long);
        String str = arni.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
        i = b(paramInt);
        if (i == 3) {
          paramInt = 5;
        ...
        for (;;)
        {
          localarac.a(paramInt, i, str, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
          localarac.a(paramExcitingTransferOneSlotComplete);
          localarac.a();
          return;
          paramInt = j;
          if (i != 506) {
  ...
  public void a(String paramString)
  {
    if (b())
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal >= this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long) {
        this.d = (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal - this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long);
      }
      if (!bdcs.a(paramString))
      {
        bbrc.a("ExcitingTransfer.ExtfGroupDownloadWorker", bbrc.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  onDownloadSuccess but file is not exsited." + paramString);
        a(7, 706);
        a(true, bclj.b, bclj.o, 307);
      }
      do
      {
        return;
        long l = arni.a(paramString);
        ...
        {
          bbrc.a("ExcitingTransfer.ExtfGroupDownloadWorker", bbrc.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  file size check fail. filesize:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal + " transSize:" + l);
          a(7, 704);
          a(true, bclj.b, bclj.q, 305);
          new File(paramString).delete();
          this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressValue = 0L;
          return;
        }
        bbrc.c("ExcitingTransfer.ExtfGroupDownloadWorker", bbrc.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onDownlaodSuc  mFilePath:" + paramString);
  ...
  protected void b()
  {
    ...
    if (b())
    {
      if ((this.jdField_a_of_type_Bbqo.jdField_c_of_type_Int == 8) || (this.jdField_a_of_type_Bbqo.jdField_c_of_type_Int == 11) || (this.jdField_a_of_type_Bbqo.jdField_c_of_type_Int == 12)) {
        l();
      }
    }
    else {
    ...
    int j;
    int i;
    if ((localarab != null) && (localarab.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null))
    {
      j = b(localarab.jdField_a_of_type_Int);
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        a(m, j, n);
        return;
        j = this.jdField_a_of_type_Bbqo.d;
        i = j;
        if (j == 0) {
          i = this.jdField_a_of_type_Bbqo.jdField_c_of_type_Int;
        }
        if (this.jdField_c_of_type_Long == 0L)
        {
          k = c(this.jdField_a_of_type_Bbqo.jdField_c_of_type_Int, this.jdField_a_of_type_Bbqo.d);
          if (!this.jdField_c_of_type_Boolean) {
            break label220;
          }
          n = this.jdField_a_of_type_Bbqo.d;
          i = 2;
          j = 7;
          k = 0;
          break;
  ...
  protected void c()
  {
    ...
    if (b())
    {
      ...
      if ((localarab != null) && (localarab.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null))
      {
        this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long = localarab.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uStartSize;
        this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long = localarab.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uDownloadedSize;
        this.jdField_a_of_type_Bbqo.jdField_c_of_type_Long = localarab.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uTotalTimes;
        if ((this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long <= 0L) || (this.jdField_a_of_type_Bbqo.jdField_c_of_type_Long <= 0L)) {
          break label139;
        }
        f = (float)this.jdField_a_of_type_Bbqo.jdField_c_of_type_Long / 1000.0F;
      }
    }
    label139:
    for (this.jdField_a_of_type_Bbqo.jdField_e_of_type_Long = (((float)this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long / f));; this.jdField_a_of_type_Bbqo.jdField_e_of_type_Long = 0L)
    {
      super.c();
      if (b()) {
        a(0, 0, 0);
