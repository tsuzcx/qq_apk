...
public class altr
  implements Runnable
{
  public altr(QQComicJsPlugin paramQQComicJsPlugin, long paramLong, String paramString1, JSONObject paramJSONObject, String paramString2) {}
  ...
  public void run()
  {
    ...
    if (QQComicPluginBridge.a) {
      ThreadManager.getUIHandler().post(new alts(this));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
