...
public class altr
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = bdhb.a(new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), bdrh.f.a));
      Object localObject2 = "";
      String str = "";
      j = 1;
      i = j;
  ...
  public static void a(boolean paramBoolean, Context paramContext, List<CustomEmotionData> paramList, AppInterface paramAppInterface, IPicDownloadListener paramIPicDownloadListener)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localbeaj = ((beag)paramAppInterface.getManager(47)).a(1);
      } while (localbeaj == null);
      apon localapon = (apon)paramAppInterface.getManager(149);
      appr localappr = (appr)paramAppInterface.getManager(141);
      ...
      for (;;)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            if (localbeaj.a(localCustomEmotionData.url) != null)
            {
            ...
            boolean bool1 = false;
            File localFile;
            if ((localappr != null) && (localappr.a(localCustomEmotionData))) {
              if ((!TextUtils.isEmpty(localCustomEmotionData.emoPath)) && (localCustomEmotionData.emoPath.startsWith(alof.bi)))
              {
            ...
            for (;;)
            {
              ...
              {
                paramList = localappr.a(localCustomEmotionData.md5);
                break label234;
              }
              if (!TextUtils.isEmpty(localCustomEmotionData.resid))
              {
                paramList = paramList + amqy.a(localCustomEmotionData.resid);
                break label234;
              }
              ...
              localbeaj.a(localbeae, new alts(paramList, localFile, localCustomEmotionData, bool1, paramBoolean, localapon, paramIPicDownloadListener, localArrayList1, localArrayList2, paramContext, localAtomicInteger2, localAtomicInteger1), null);
            }
            continue;
          }
          if (paramIPicDownloadListener != null) {
