...
public class ahln
{
  public static MessageForReplyText.SourceMsgInfo a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, int paramInt, long paramLong, String paramString)
  {
    ...
    paramQQAppInterface.mAtInfoStr = paramChatMessage.getExtInfoFromExtStr(bbkv.i);
    Object localObject = nmy.a(paramChatMessage);
    if (!TextUtils.isEmpty(((nmz)localObject).b)) {
      paramQQAppInterface.mAnonymousNickName = ((nmz)localObject).b;
    }
    for (;;)
    {
      ...
      {
        localObject = bfat.a(paramChatMessage);
        if (localObject != null) {
          paramQQAppInterface.mAnonymousNickName = ((bfau)localObject).c;
        }
      }
    }
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo)
  {
    ...
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
    {
      ...
      while (i < paramQQAppInterface.size())
      {
        ...
        if ((!abwz.a(paramSessionInfo)) && (!(paramSessionInfo instanceof MessageForSafeGrayTips))) {
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
    {
      ...
      while (paramInt < paramQQAppInterface.size())
      {
        ...
        if ((!abwz.b(paramString)) && (!(paramString instanceof MessageForSafeGrayTips))) {
          return paramString;
        }
        paramInt += 1;
      }
