...
public class zfn
{
  ...
  public static zfo a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      if (StringUtil.isEmpty(paramObject))
      {
        ...
        label105:
        localzfo = new zfo();
        localzfo.jdField_a_of_type_JavaLangString = str1;
        localzfo.jdField_b_of_type_JavaLangString = str3;
        localzfo.jdField_c_of_type_JavaLangString = str2;
        localzfo.jdField_a_of_type_Int = i;
        localzfo.e = str4;
        localzfo.f = paramObject;
        localzfo.g = ((String)localObject);
        localzfo.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localzfo.jdField_d_of_type_JavaLangString = "DOV";
          return localzfo;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localzfo.jdField_d_of_type_JavaLangString = anvx.a(2131716265);
              return localzfo;
              break label105;
            }
          }
  ...
  public static zgk a(Context paramContext, Object paramObject)
  {
    zfo localzfo = a(paramObject);
    if (localzfo == null) {
      return null;
    }
    String str1 = localzfo.jdField_a_of_type_JavaLangString;
    String str2 = localzfo.jdField_b_of_type_JavaLangString;
    String str3 = localzfo.f;
    int j = localzfo.jdField_a_of_type_Int;
    String str4 = localzfo.e;
    int k = localzfo.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bhfn.a(paramContext, "com.tencent.qim"))
        {
          bdla.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bhfn.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          bdla.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          xab.a(paramContext);
        }
      }
      label174:
      ...
      {
        bdla.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        bdla.b(null, "dc00899", "grp_story", "", "weishi_share", localzfo.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        bdla.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        bdla.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      bdla.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localzfo.jdField_c_of_type_JavaLangString;
      bdla.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new zgk(paramContext, 2131756044, paramObject);
  ...
  {
    if (!zei.b(paramContext))
    {
      QQToast.a(paramContext, anvx.a(2131716267), 0).a();
      return;
    }
    bpqr.a().a();
    ...
    {
      ykq.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    bdla.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    return bkyz.a(paramContext, "com.tencent.weishi");
  }
}
