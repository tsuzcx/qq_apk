...
public class acgu
  extends ajvp
{
  public acgu(ActivateFriendGrid paramActivateFriendGrid) {}
  ...
  public void b()
  {
    ...
    if (i < ActivateFriendGrid.a(this.a).size())
    {
      ...
      ((ActivateFriendGridItem)ActivateFriendGrid.b(this.a).get(i)).setBirthday(this.a.getResources().getString(2131624045));
    }
    for (;;)
    {
      i += 1;
      ...
      {
        ((ActivateFriendGridItem)ActivateFriendGrid.b(this.a).get(i)).setChecked(false);
        ((ActivateFriendGridItem)ActivateFriendGrid.b(this.a).get(i)).setBirthday(this.a.getResources().getString(2131624048));
      }
    }
  }
}
