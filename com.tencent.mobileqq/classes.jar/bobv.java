  ...
  implements Handler.Callback
{
  ...
  private bobw jdField_a_of_type_Bobw;
  private int b;
  private int c;
  
  public bobv(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bobw != null) {
        this.jdField_a_of_type_Bobw.a(this.jdField_a_of_type_Bobw, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
