  ...
  extends DynamicTextItem
{
  ...
  static
  {
    jdField_a_of_type_Float = awmc.a(22.0F);
    jdField_b_of_type_Float = awmc.a(3.0F);
    Resources localResources = BaseApplicationImpl.getContext().getResources();
    jdField_b_of_type_Int = aciy.a(27.0F, localResources);
    jdField_d_of_type_Int = aciy.a(6.0F, localResources);
    int i = biqy.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - uyh.a - i * 2;
  }
  
  public bhnf(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
