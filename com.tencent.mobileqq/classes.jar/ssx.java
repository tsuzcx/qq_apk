  ...
  implements ssw, sti
{
  ...
  public ssx(int paramInt)
  {
    this(paramInt, null, false);
  }
  
  public ssx(int paramInt, String paramString, boolean paramBoolean)
  {
    super(BaseApplicationImpl.getContext(), paramString, paramBoolean);
    this.jdField_a_of_type_Ssz = new ssz(paramInt, this);
    a(this.jdField_a_of_type_Ssz);
    a(this);
  }
  ...
  private void b(String paramString, long paramLong, int paramInt)
  {
    ...
    swx.a().a(paramString, new ssy(this, paramString, paramLong, paramInt));
  }
  ...
  public void a(String paramString)
  {
    this.d = paramString;
    if (h()) {
      six.a(new ReadInjoyPlayer.2(this));
    }
  }
  
  public void a(rqa paramrqa)
  {
    paramrqa.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    paramrqa.j = b();
    paramrqa.k = c();
  }
  ...
  {
    six.a(new ReadInjoyPlayer.4(this));
  }
