  ...
  extends mod
{
  ...
  private mof jdField_a_of_type_Mof;
  ...
  public moe(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat, mof parammof)
  {
    ...
    this.jdField_a_of_type_Mof = parammof;
    e();
  }
  ...
  private Bitmap c()
  {
    ...
    //   1: istore 5
    //   3: aload_0
    //   4: getfield 103	moe:jdField_a_of_type_Lhh	Llhh;
    //   7: getfield 108	lhh:a	Ljava/lang/CharSequence;
    ...
    //   22: aload_0
    //   23: aload_0
    //   24: getfield 88	moe:jdField_a_of_type_Mof	Lmof;
    //   27: getfield 118	mof:b	I
    //   30: iload 6
    //   32: imul
    //   33: iload 6
    //   35: iconst_1
    //   36: isub
    //   37: aload_0
    //   38: getfield 42	moe:j	I
    //   41: imul
    //   42: iadd
    //   43: aload_0
    //   44: getfield 88	moe:jdField_a_of_type_Mof	Lmof;
    //   47: getfield 118	mof:b	I
    ...
    //   56: putfield 132	moe:jdField_b_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   59: aload_0
    //   60: getfield 38	moe:jdField_b_of_type_AndroidGraphicsCanvas	Landroid/graphics/Canvas;
    //   63: aload_0
    //   64: getfield 132	moe:jdField_b_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   67: invokevirtual 136	android/graphics/Canvas:setBitmap	(Landroid/graphics/Bitmap;)V
    //   70: aload_0
    //   71: getfield 88	moe:jdField_a_of_type_Mof	Lmof;
    //   74: getfield 118	mof:b	I
    //   77: iconst_2
    //   78: idiv
    //   79: i2f
    //   80: fstore_2
    //   81: aload_0
    //   82: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    ...
    //   124: aload_0
    //   125: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   128: iconst_0
    //   129: invokevirtual 153	android/graphics/Paint:setAntiAlias	(Z)V
    //   132: aload_0
    //   133: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    ...
    //   142: aload_0
    //   143: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   146: iconst_m1
    //   147: invokevirtual 167	android/graphics/Paint:setColor	(I)V
    //   150: aload_0
    //   151: getfield 38	moe:jdField_b_of_type_AndroidGraphicsCanvas	Landroid/graphics/Canvas;
    //   154: fload_1
    //   155: fload_2
    //   156: fload_2
    //   157: aload_0
    //   158: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   161: invokevirtual 171	android/graphics/Canvas:drawCircle	(FFFLandroid/graphics/Paint;)V
    //   164: aload_0
    //   165: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   168: iconst_1
    //   169: invokevirtual 153	android/graphics/Paint:setAntiAlias	(Z)V
    //   172: aload_0
    //   173: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    ...
    //   182: aload_0
    //   183: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   186: ldc 175
    //   188: invokevirtual 167	android/graphics/Paint:setColor	(I)V
    //   191: aload_0
    //   192: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   195: aload_0
    //   196: getfield 44	moe:k	I
    //   199: i2f
    //   200: invokevirtual 179	android/graphics/Paint:setStrokeWidth	(F)V
    //   203: aload_0
    //   204: getfield 38	moe:jdField_b_of_type_AndroidGraphicsCanvas	Landroid/graphics/Canvas;
    //   207: fload_1
    //   208: fload_2
    //   209: fload_2
    //   210: fload 4
    //   212: fsub
    //   213: aload_0
    //   214: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   217: invokevirtual 171	android/graphics/Canvas:drawCircle	(FFFLandroid/graphics/Paint;)V
    //   220: aload_0
    //   221: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   224: fconst_0
    //   225: invokevirtual 179	android/graphics/Paint:setStrokeWidth	(F)V
    //   228: aload_0
    //   229: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    ...
    //   238: aload_0
    //   239: getfield 38	moe:jdField_b_of_type_AndroidGraphicsCanvas	Landroid/graphics/Canvas;
    //   242: aload 9
    //   244: iload 5
    //   246: iload 5
    //   248: iconst_1
    ...
    //   253: fsub
    //   254: aload_0
    //   255: getfield 74	moe:jdField_a_of_type_AndroidGraphicsPaint	Landroid/graphics/Paint;
    //   258: invokevirtual 183	android/graphics/Canvas:drawText	(Ljava/lang/String;IIFFLandroid/graphics/Paint;)V
    //   261: aload_0
    //   262: getfield 88	moe:jdField_a_of_type_Mof	Lmof;
    //   265: getfield 118	mof:b	I
    //   268: istore 7
    //   270: aload_0
    //   271: getfield 42	moe:j	I
    //   274: istore 8
    //   276: fload_1
    //   277: iload 7
    //   279: iload 8
    ...
    //   299: ifeq +16 -> 315
    //   302: aload_0
    //   303: getfield 192	moe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   306: iconst_2
    //   307: aload 9
    ...
    //   315: aload_0
    //   316: getfield 132	moe:jdField_b_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   319: areturn
    //   320: astore 9
    //   322: invokestatic 189	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   325: ifeq -10 -> 315
    //   328: aload_0
    //   329: getfield 192	moe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   332: iconst_2
    //   333: aload 9
  ...
  {
    this.d = this.jdField_a_of_type_Mof.jdField_a_of_type_Int;
  ...
  protected int a(Paint paramPaint, String paramString)
  {
    ...
    for (int m = this.jdField_a_of_type_Lhh.a.length();; m = 0)
    {
      int n = this.jdField_a_of_type_Mof.jdField_a_of_type_Int;
      int i1 = this.i;
      int i2 = this.jdField_a_of_type_Mof.b;
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    paramCanvas.save();
    paramCanvas.clipRect(this.jdField_a_of_type_Mof.jdField_a_of_type_Int / 2, 0, paramInt1, paramInt2);
    float f2 = this.jdField_a_of_type_Mof.jdField_a_of_type_Int + this.i;
    float f1 = f2;
    if (d())
    {
    ...
    paramCanvas.drawBitmap(this.jdField_b_of_type_AndroidGraphicsBitmap, f1, (this.jdField_a_of_type_Mof.jdField_a_of_type_Int - this.jdField_a_of_type_Mof.b) / 2, this.jdField_a_of_type_AndroidGraphicsPaint);
    paramCanvas.restore();
    Bitmap localBitmap = this.jdField_a_of_type_Mof.jdField_a_of_type_ArrayOfAndroidGraphicsBitmap[((int)((l - this.jdField_a_of_type_Long) / 200L % this.jdField_a_of_type_Mof.jdField_a_of_type_ArrayOfAndroidGraphicsBitmap.length))];
  ...
  public int e()
  {
    return this.jdField_a_of_type_Mof.c;
  }
