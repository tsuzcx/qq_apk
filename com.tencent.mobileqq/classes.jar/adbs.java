...
{
  public adbs(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (paramView.getTag(-1) == null)
      {
        ...
        bcef.b(null, "dc00898", "", (String)localObject4, "0X800AFC4", "0X800AFC4", 0, 0, String.valueOf(l3), String.valueOf(l2), (String)localObject2, "");
        if (l2 == 0L)
        {
          ...
          adxr.a(this.a.getApplicationContext(), (Intent)localObject2, PublicFragmentActivity.class, TroopAppShortcutFragment.class);
          bcef.b(null, "dc00898", "", this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "0X800AFC6", "0X800AFC6", 0, 0, String.valueOf(l1), "", "", "");
          localObject2 = (bfaa)this.a.app.getManager(109);
          if (localObject2 != null) {
            ((bfaa)localObject2).a(true, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
          }
        }
      ...
      if ((l2 == 1101236949L) && (aqgr.c().mIsEnable) && (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mIsFreezed == 1) && (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isOwnerOrAdim()))
      {
        boolean bool = ancy.c(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.groupFreezeReason);
        if (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.bOwner)
        {
          ...
          if (bool)
          {
            ...
            localObject4 = amtj.a(2131700887);
            adbt localadbt = new adbt(this, bool);
            if (!bool) {
              break label657;
            }
            ...
            i = 1;
            label606:
            VipUtils.a((Context)localObject2, (String)localObject3, str, (String)localObject4, localadbt, (String)localObject1, i, bool);
          }
        }
        for (;;)
        {
      ...
      if (MiniAppLauncher.isMiniAppUrl(str))
      {
        ...
        if (i != 0)
        {
          ...
          ((TextView)paramView.findViewById(2131362850)).setVisibility(8);
          bfdg.a(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, (int)l2);
        }
        bftc.a("Grp_app_new", "grpData_admin", "app_clk", 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, bftc.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData), String.valueOf(l2) });
        localObject1 = "";
        if (l2 != 0L) {
          break label1266;
        }
      ...
      for (;;)
      {
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          bftc.a("Grp_app_new", "grpData_admin", (String)localObject1, 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, bftc.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData) });
        }
        if (l2 != 101889454L) {
          break;
        }
        ...
        if (l2 == 1105981808L)
        {
          localObject1 = yns.a(this.a.getIntent(), (String)localObject2, null);
