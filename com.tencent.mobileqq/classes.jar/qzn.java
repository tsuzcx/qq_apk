  ...
  implements qzs
{
  ...
  private final ArrayList<qzp> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private final LinkedHashMap<String, String> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  private final qzy jdField_a_of_type_Qzy = new qzy((qzr)new qzw());
  
  static
  {
    jdField_a_of_type_Qzo = new qzo(null);
  }
  
  public qzn()
  {
    this.jdField_a_of_type_Qzy.a((qzs)this);
  }
  
  private final String a()
  {
    String str = Aladdin.getConfig(296).getString("watch_word_public_topic_text", pay.g(2131717603));
  ...
  {
    String str = Aladdin.getConfig(296).getString("watch_word_private_topic_text", pay.g(2131717601));
  ...
  {
    String str = Aladdin.getConfig(296).getString("watch_word_public_video_text", pay.g(2131717604));
  ...
  {
    String str = Aladdin.getConfig(296).getString("watch_word_private_video_text", pay.g(2131717602));
  ...
  public final void a(@NotNull qzp paramqzp)
  {
    Intrinsics.checkParameterIsNotNull(paramqzp, "observer");
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramqzp)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramqzp);
    }
  }
}
