...
final class ajxp
  extends bbwt
{
  ajxp(String paramString, File paramFile, CustomEmotionData paramCustomEmotionData, boolean paramBoolean1, boolean paramBoolean2, answ paramansw, IPicDownloadListener paramIPicDownloadListener, List paramList1, List paramList2, Context paramContext, AtomicInteger paramAtomicInteger1, AtomicInteger paramAtomicInteger2) {}
  
  public void onDone(bbwu parambbwu)
  {
    super.onDone(parambbwu);
    ajxo.a.remove(this.jdField_a_of_type_JavaLangString);
    if ((3 == parambbwu.a()) && (this.jdField_a_of_type_JavaIoFile.exists()))
    {
      ...
      {
        parambbwu = MD5.getFileMd5(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.emoPath);
        this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5 = HexUtil.bytes2HexStr(parambbwu);
      }
    ...
    for (;;)
    {
      ...
      bbrx.a("emotionType", "emotionActionFav", "3", "", "", bbfj.b(this.jdField_a_of_type_AndroidContentContext) + "", parambbwu.a + "", "", "", "");
    }
  }
}
