...
public class kts
{
  ...
  public kts(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ktt = new ktt(this);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().bindService(localIntent, this.jdField_a_of_type_Ktt, 1);
      return;
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        krx.e(jdField_a_of_type_JavaLangString, "bindService " + localThrowable.getMessage());
      }
    }
  }
  ...
  {
    QLog.d(jdField_a_of_type_JavaLangString, 1, String.format("setAVServiceForegroud start=%s mAvService=%s", new Object[] { Boolean.valueOf(paramBoolean), this.jdField_a_of_type_Lly }));
    if (this.jdField_a_of_type_Lly != null) {}
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Lly.a(paramBoolean, paramNotification);
  ...
  public void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unbindService(this.jdField_a_of_type_Ktt);
      return;
    }
    catch (Exception localException)
    {
      krx.e(jdField_a_of_type_JavaLangString, "unbindService msg = " + localException.getMessage());
    }
  }
}
