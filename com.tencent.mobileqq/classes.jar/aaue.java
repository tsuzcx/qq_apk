...
public class aaue
  extends Handler
{
  public aaue(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick))
      {
        ...
        localObject1 = new ayjw(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick, 16).a();
        paramMessage.setRightText((CharSequence)localObject1);
        bbos.a(this.a.app, paramMessage.a(), (Spannable)localObject1);
        return;
      }
      paramMessage.setRightText(this.a.getString(2131697827));
      bbos.a(this.a.app, paramMessage.a(), new SpannableString(""));
      return;
    ...
    if (this.a.jdField_c_of_type_AndroidWidgetTextView != null) {
      this.a.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131701755) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + ajya.a(2131701761));
    }
    this.a.b(true);
    this.a.e();
    this.a.a(this.a.e);
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() > 0))
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject2).hasNext())
          {
            ...
            continue;
            if ((this.a.jdField_a_of_type_Bata == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_Bata.a))) {
              break label1404;
            }
            if (ajya.a(2131701748).equals(this.a.jdField_a_of_type_Bata.a))
            {
              i = 0;
              break;
            }
            paramMessage = this.a.jdField_a_of_type_Bata.a;
            i = 1;
            break;
          }
        }
      ...
      {
        localObject2 = (FormSimpleItem)localView2.findViewById(2131368396);
        localSwitch = ((FormSwitchItem)localView1).a();
        localObject3 = (TextView)localView2.findViewById(2131368154);
        ((TextView)localObject3).setBackgroundResource(2130839171);
        localObject1 = "";
        paramMessage = "";
        Boolean localBoolean = (Boolean)this.a.jdField_a_of_type_Bbjl.c.get(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        ...
        localView1.setBackgroundResource(2130839176);
      ...
      for (;;)
      {
        ((FormSimpleItem)localObject2).setRightText(new aykk((CharSequence)localObject1, 3));
        ((TextView)localObject3).setText(paramMessage);
        ((TextView)localObject3).setTextColor(this.a.getResources().getColor(2131166928));
        asfd.a().c(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        return;
        label1045:
        localView1.setBackgroundResource(2130839179);
        localView1.getBackground().setAlpha(255);
        if (!localSwitch.isChecked())
        {
          localSwitch.setTag(Boolean.TRUE);
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131697900);
          paramMessage = this.a.getString(2131697902);
          break;
        case 3: 
          localObject1 = this.a.getString(2131693207);
          paramMessage = this.a.getString(2131697898);
          break;
        case 4: 
          localObject1 = this.a.getString(2131697904);
          paramMessage = this.a.getString(2131697906);
          break;
          label1204:
          localView2.setVisibility(0);
          localView1.setBackgroundResource(2130839179);
      ...
      {
        localObject1 = (TextView)paramMessage.findViewById(2131377350);
        ...
        paramMessage = (ProgressBar)paramMessage.findViewById(2131371952);
        if (paramMessage != null) {
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130849297))
      {
