...
public class bamn
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      do
      {
        ...
        localStringBuilder.append(akpy.b());
        localStringBuilder.append(" and isValid=1 ");
        paramString = bbep.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), paramQQAppInterface, localStringBuilder.toString());
  ...
  {
    return a(paramResources, paramInt, paramResources.getDrawable(2130848637));
  }
  ...
  public static Pair<String, ArrayList<MessageForText.AtTroopMemberInfo>> a(Editable paramEditable)
  {
    ...
    paramEditable = bafh.a(paramEditable, localArrayList);
  ...
  public static EntryModel a(TroopInfo paramTroopInfo, String paramString)
  {
    ...
    localEntryModel.reportData.put("via", "2010_3");
    localEntryModel.reportData.put("groupid", paramString);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          {
            localTroopInfoData.mRichFingerMemo = nam.c(localTroopInfoData.mRichFingerMemo);
            localTroopInfoData.mRichFingerMemo = nam.b(localTroopInfoData.mRichFingerMemo);
          }
          localTroopInfoData.cGroupOption = ((short)paramBundle.getByte("troop_info_opt"));
          localTroopInfoData.mStrJoinQuestion = bbbc.b(paramContext, localTroopInfoData.troopUin);
          localTroopInfoData.nTroopGrade = paramBundle.getInt("TROOP_INFO_TROOP_GRADE");
          localTroopInfoData.mStrJoinAnswer = bbbc.c(paramContext, localTroopInfoData.troopUin);
  ...
  public static String a(Context paramContext, long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      localObject = paramContext.getResources().getString(2131696427) + ((SimpleDateFormat)localObject).format(Long.valueOf(1000L * paramLong));
    }
    return localObject;
  }
  ...
  public static String a(View paramView, oidb_0xaf4.TabInfo paramTabInfo)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 705	tencent/im/oidb/cmd0xaf4/oidb_0xaf4$TabInfo:url	Lcom/tencent/mobileqq/pb/PBStringField;
    //   4: invokevirtual 709	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   7: invokestatic 715	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   10: astore 4
    //   12: iconst_0
    //   13: istore_2
    //   14: aload 4
    ...
    //   19: aload 4
    //   21: ldc_w 717
    //   24: invokevirtual 720	android/net/Uri:getQueryParameter	(Ljava/lang/String;)Ljava/lang/String;
    //   27: astore_1
    //   28: aload 4
    //   30: ldc_w 695
    //   33: invokevirtual 720	android/net/Uri:getQueryParameter	(Ljava/lang/String;)Ljava/lang/String;
    //   36: astore 4
    //   38: aload_1
    //   39: ifnull +21 -> 60
    //   42: aload_1
    //   43: invokestatic 723	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   46: istore_3
    //   47: iload_3
    //   48: istore_2
    //   49: aload_0
    //   50: ldc_w 724
    //   53: iload_2
    //   54: invokestatic 727	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   57: invokevirtual 733	android/view/View:setTag	(ILjava/lang/Object;)V
    //   60: aload 4
    //   62: ifnull +105 -> 167
    //   65: aload_0
    //   66: ldc_w 734
    //   69: aload 4
    //   71: invokevirtual 733	android/view/View:setTag	(ILjava/lang/Object;)V
    //   74: new 584	org/json/JSONObject
    //   77: dup
    //   78: aload 4
    //   80: invokespecial 735	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   83: astore_0
    //   84: aload_0
    //   85: ldc_w 737
    //   88: invokevirtual 740	org/json/JSONObject:has	(Ljava/lang/String;)Z
    //   91: ifeq +76 -> 167
    //   94: aload_0
    //   95: ldc_w 737
    //   98: invokevirtual 743	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   101: astore_0
    //   102: aload_0
    //   103: areturn
    //   104: astore_1
  ...
  public static String a(String paramString, long paramLong, int paramInt, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      str = "0";
      paramQQAppInterface = paramString.replace("$GCODE$", paramTroopInfoData.troopUin).replace("$CLIENTVER$", "android8.2.8").replace("$UIN$", paramQQAppInterface.getCurrentAccountUin()).replace("$LANG$", "zh_CN").replace("$GROUPAPPID$", Long.toString(paramLong)).replace("$ROLE$", str);
      if (!paramBoolean) {
        break label169;
      }
    }
  ...
  public static void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localObject = (akhq)localQQAppInterface.a(20);
      ((akhq)localObject).notifyUI(2, false, null);
      ((ajsz)localQQAppInterface.a(22)).notifyUI(43, true, new Object[] { str, paramString, null });
      if (i != 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopUtils", 2, "TroopUtils handleModifyName :" + localTroopInfo.troopname);
        }
        ((akhq)localObject).b(str, String.valueOf(paramLong2), paramString);
      }
      return;
    }
  }
  ...
  {
    bcqc localbcqc = new bcqc(paramActivity);
    int i = paramActivity.getResources().getDimensionPixelSize(2131298865);
    switch (paramInt)
    {
    case 6: 
    case 7: 
    ...
    case 10: 
    default: 
      localbcqc.a(2131693686, i, 0, 1);
      return;
    case 2: 
      localbcqc.a(ajyc.a(2131715813), i, 0, 1);
      return;
    case 3: 
      localbcqc.a(ajyc.a(2131715802), i, 0, 1);
      return;
    case 4: 
      localbcqc.a(ajyc.a(2131715808), i, 0, 1);
      return;
    case 5: 
      localbcqc.a(ajyc.a(2131715803), i, 0, 1);
      return;
    }
    localbcqc.a(2131720494, i, 0, 1);
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(paramActivity, bbpp.a(paramActivity, "background", ""), 33554432L, localIntent, true, paramInt);
    axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8004E0E", "0X8004E0E", 0, 0, "", "", "", "");
  }
  ...
  {
    new bcqc(paramContext).a(paramInt2, paramInt1, 0, paramInt3);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty(paramRecommendTroopItem.recommendReason))
        {
          ...
          ArrayList localArrayList = myd.a(paramRecommendTroopItem);
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    paramContext = bbcl.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramString, false);
    Intent localIntent = actn.a(new Intent((Context)localObject, SplashActivity.class), null);
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("uintype", 1);
  ...
  public static void a(View paramView, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, boolean paramBoolean, String paramString1, String paramString2, auvu paramauvu)
  {
    ...
    while (TextUtils.isEmpty(paramCharSequence2))
    {
      ...
      if (paramBoolean) {
        auvt.a(paramView, paramString1, paramString2, paramauvu);
      }
    }
  ...
  public static void a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      new batu(paramBaseActivity, paramTroopInfoData, new bamo(paramTroopInfoData)).a(paramTroopInfoData);
      axqw.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_share", 0, 0, paramTroopInfoData.troopUin, "", "", "");
    } while (!paramTroopInfoData.isMember);
    bbbb.a("Grp_set_new", "grpData_admin", "clk_share", 0, 0, new String[] { paramTroopInfoData.troopUin, bbbb.a(paramTroopInfoData) });
  }
  ...
  {
    if (bbcp.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString) != 0) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
        bbcp.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString, 0);
      }
      Intent localIntent = new Intent();
      ...
      axqw.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp", "Clk_grpinfo_files", 0, 0, paramString, "0", "", "");
      if (QLog.isDevelopLevel()) {
        QLog.d("Clk_grpinfo_files", 4, "troopUin :" + paramString);
      }
      mzx.a(paramQQAppInterface, 67);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString2 = (bail)paramQQAppInterface.getManager(109);
    ...
    for (int i = 32;; i = 0)
    {
      ...
      for (paramString2 = paramString2.url.replace("$GCODE$", paramString1);; paramString2 = null)
      {
        ...
        axqw.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, paramString1, "", "", "");
        return;
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      ...
      localbgyf.b = paramQQAppInterface.getCurrentNickname();
      akhq localakhq = (akhq)paramQQAppInterface.a(20);
      if (!TextUtils.isEmpty(paramString1)) {
        localakhq.e(paramString1, true);
      }
      if (bbcp.a(paramQQAppInterface.getCurrentAccountUin(), "troop_photo_message", paramString1) <= 0) {
        break label123;
      }
      bgxy.d(paramActivity, localbgyf, paramString1, 7);
    }
    for (;;)
    {
      axqw.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_album", 0, 0, paramString1, "", "", "");
      mzx.a(paramQQAppInterface, 66);
      return;
      bool = false;
      break;
      label123:
      bgxy.a(paramActivity, localbgyf, paramString1, paramString2, bool, 7);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, baho parambaho)
  {
    ...
    if (str1.length() < 10)
    {
      ...
      a(paramQQAppInterface, paramContext, str3, parambaho, 0, null);
    ...
    for (;;)
    {
      ...
      new bahp(localStringBuilder.toString(), "GET", parambaho, 1, null).a(paramQQAppInterface);
      return;
      ((StringBuilder)localObject1).append("0");
      ((StringBuilder)localObject1).append(str1);
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Bundle paramBundle)
  {
    ...
    localIntent.putExtras(paramBundle);
    paramContext.startActivity(localIntent);
    axqw.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, str, "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    if (localTroopManager != null)
    {
      ...
      if (paramString != null)
      {
        ...
        {
          paramQQAppInterface = new batu((BaseActivity)paramContext, localTroopInfoData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, baho parambaho, int paramInt, Bundle paramBundle)
  {
    Bundle localBundle = new Bundle();
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    new bahp(localStringBuilder.toString(), "GET", parambaho, paramInt, paramBundle).a(paramQQAppInterface);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, TroopInfoData paramTroopInfoData, long paramLong)
  {
    paramQQAppInterface = (askq)paramQQAppInterface.getManager(37);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<ChatMessage> paramList)
  {
        ...
        if (i < paramList.size())
        {
          ...
          if ((!(localChatMessage instanceof MessageForGrayTips)) && ((!(localChatMessage instanceof MessageForUniteGrayTip)) || (localChatMessage.time == l)))
          {
            ...
            if ((localChatMessage instanceof MessageForSplitLineTips))
            {
              ...
              if (!ajyc.a(2131715805).equalsIgnoreCase(((MessageForSplitLineTips)localObject2).msgContent)) {
                break;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (MessageForSplitLineTips)axaq.a(-4012);
        ((MessageForSplitLineTips)localObject2).init(paramQQAppInterface.getCurrentAccountUin(), paramString, paramQQAppInterface.getCurrentAccountUin(), ajyc.a(2131715810), l, -4012, 1, l);
        ...
        ((MessageForSplitLineTips)localObject2).msgContent = ajyc.a(2131715811);
  ...
  public static void a(TroopInfoData paramTroopInfoData, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      axqw.b(null, "P_CliOper", "Grp_nearby", "", "recom", "Clk_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 18)
    {
      axqw.b(null, "P_CliOper", "Grp_join", "", "join_page", "Clk_join", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 24)
    {
      axqw.b(null, "P_CliOper", "Grp_nearby", "", "search", "Clk_joingrp", 0, 0, "", "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 17)
    {
      axqw.b(null, "CliOper", "", "", "Grp_recommend", "viewinfor_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    int i = -1;
    int j;
    ...
    for (;;)
    {
      ...
      axqw.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", "" + i, paramInt2 + "");
      axqw.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp1", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", paramInt3 + "", "");
      return;
      i = 0;
      break;
      i = 1;
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      ...
      bbaj.a(BaseApplicationImpl.getApplication(), paramString, paramString);
    } while (!QLog.isColorLevel());
  ...
  public static void a(List<String> paramList)
  {
    ...
    {
      balw localbalw = (balw)((QQAppInterface)localObject).getManager(203);
      localObject = null;
  ...
  public static void a(AppRuntime paramAppRuntime, TroopInfo paramTroopInfo, Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setTitle(ajyc.a(2131715806)).setMessage(ajyc.a(2131715804)).setPositiveButton(ajyc.a(2131715812), paramOnClickListener);
    paramActivity.show();
    bbbb.a("Grp_manage_new", "gainUin_msgBox", "exp", 0, 0, new String[] { String.valueOf(paramTroopInfo.troopuin), "", bbbb.a(paramTroopInfo, paramAppRuntime) });
  }
  ...
  public static void a(oidb_0xaf4.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    if (((MiniAppInfo)localObject).reportData == null) {
      ((MiniAppInfo)localObject).reportData = new HashMap();
    }
    ...
    ((MiniAppConfig)localObject).launchParam.reportData.put("groupid", paramString2);
    ((MiniAppConfig)localObject).launchParam.reportData.put("category_tag", paramAppInfo.trace.get());
  ...
  public static void a(boolean paramBoolean, TextView paramTextView)
  {
    if (paramBoolean)
    {
      ...
      paramTextView.setCompoundDrawablePadding(actn.a(10.0F, BaseApplicationImpl.getApplication().getResources()));
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130841001, 0);
      return;
    }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if (!TextUtils.equals("4440", paramContext)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.i("TroopUtils", 2, String.format("isUpdateBeforeSomeVersion pre: %s, cur: %s", new Object[] { "4440", paramContext }));
      return false;
  ...
  {
    if ((paramTabInfo != null) && (paramTabInfo.appid.get() == 1106837471L) && ((paramView.getTag(2131376877) instanceof Integer))) {
      return ((Integer)paramView.getTag(2131376877)).intValue() == 1;
    }
    return false;
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    return (akhq.jdField_a_of_type_Boolean) && (localTroopManager.b());
  }
  ...
  public static void b(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      bbbb.a("Grp_set_new", "grpData_admin", "clk_report", 0, 0, new String[] { paramTroopInfoData.troopUin, bbbb.a(paramTroopInfoData) });
      paramTroopInfoData = xkq.a(str1, 1);
      xkq.a(paramBaseActivity, str1, null, null, str1, paramQQAppInterface.getAccount(), i, null, paramTroopInfoData);
      return;
      if (paramTroopInfoData.isMember) {
        i = 22000;
      } else {
    ...
    {
      bbbb.a("Grp_set_new", "grpData_visitor", "clk_report", 0, 0, new String[] { str2, paramTroopInfoData });
  ...
  {
    String str = bbaj.a(BaseApplicationImpl.getApplication(), paramString);
    if (QLog.isColorLevel()) {
