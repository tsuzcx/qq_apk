...
public class bamn
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alkn.jdField_a_of_type_JavaLangString + "/capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    f = alkn.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lbc.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lbc.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  
  public static final bamn a()
  {
    return bamo.a();
  }
  
  private static bamu a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lbc.c("CaptureVideoFilterManager", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localbamu = new bamu(i, str1, str2);
        try
        {
          lbc.c("CaptureVideoFilterManager", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localbamu;
        }
      ...
      try
      {
        ...
        lbc.c("CaptureVideoFilterManager", "parseConfig failed. info = " + localJSONObject);
        return localbamu;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lbc.c("CaptureVideoFilterManager", "parseConfig|parse failed.context = " + paramString);
        return localbamu;
      }
    }
  }
  ...
  public static void a(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lbc.c("CaptureVideoFilterManager", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new bdvs();
          ((bdvs)localObject).jdField_a_of_type_Bdvw = new bamr();
          ...
          ((bdvs)localObject).jdField_c_of_type_JavaLangString = (f + "skin_color.zip");
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if ((paramString2 != null) && (!paramString2.equals("")))
      {
        ...
        lbc.c("CaptureVideoFilterManager", "compareContent newList.size=0");
        bgmg.a(jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        long l2 = System.currentTimeMillis();
        lbc.c("CaptureVideoFilterManager", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lbc.c("CaptureVideoFilterManager", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                if ((localFilterDesc.resMD5 != null) && (!localFilterDesc.resMD5.equals(paramString2.resMD5))) {
                  bgmg.a(paramString2.getResFold(jdField_b_of_type_JavaLangString));
                }
                lbc.c("CaptureVideoFilterManager", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
                if ((localFilterDesc.iconMD5 != null) && (!localFilterDesc.iconMD5.equals(paramString2.iconMD5))) {
                  bgmg.d(paramString2.getIconFile(jdField_b_of_type_JavaLangString));
                }
              }
            }
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lbc.c("CaptureVideoFilterManager", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = lkw.e();
    if (paramInt2 < paramInt1)
    {
      lbc.c("CaptureVideoFilterManager", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = lkw.d();
    if (l < paramLong1)
    {
      lbc.c("CaptureVideoFilterManager", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = bgln.d();
    if (paramLong1 < paramLong2)
    {
      lbc.c("CaptureVideoFilterManager", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lbc.c("CaptureVideoFilterManager", "getVideoEffectBeautyConfig:" + f + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bgmg.b(localFile);
      }
      b(paramContext, 0);
  ...
  {
    lbc.c("CaptureVideoFilterManager", "setVideoEffectBeautyConfigVersion:" + paramInt);
  ...
  private static boolean b(Context paramContext)
  {
    ...
    lbc.c("CaptureVideoFilterManager", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lbc.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig error ");
      return;
    }
    ...
    bgmg.a(jdField_a_of_type_JavaLangString, "filter_config.xml", paramString);
    a(paramContext, paramInt);
    c();
    a(paramString);
    lbc.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig sendBroadcast");
    paramContext.sendBroadcast(new Intent("action_brocassreceiver_for_filter"));
  }
  
  public void a(bamp parambamp)
  {
    this.jdField_a_of_type_Bamp = parambamp;
  }
  
  public void a(bamt parambamt)
  {
    ...
    do
    {
      ...
      parambamt = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambamt.hasNext())
      {
        Object localObject1 = (FilterCategory)parambamt.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((bdvs)localObject3).jdField_a_of_type_Bdvw = new bams(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((bdvs)localObject2).jdField_a_of_type_Bdvw = new bamq(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Bamt == null));
    this.jdField_a_of_type_Bamt.a(false);
  }
  ...
  public void b(Context paramContext)
  {
    if (new File(f + "beauty_config.json").exists())
    {
      ...
      {
        lbc.c("CaptureVideoFilterManager", "!JasonFile.exists()");
        a(paramContext);
      }
      return;
    }
    lbc.c("CaptureVideoFilterManager", "BEAUTY_CONFIG  is not exsit");
  }
