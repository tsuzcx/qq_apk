  ...
  implements BaseConstants.NetType
{
  ...
  protected static bamo[] a;
  
  static
  {
    jdField_a_of_type_ArrayOfBamo = new bamo[4];
    jdField_a_of_type_ArrayOfBamo[1] = new bamo();
    jdField_a_of_type_ArrayOfBamo[2] = new bamo();
    jdField_a_of_type_ArrayOfBamo[3] = new bamo();
  }
  
  public static bamo a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    a(paramQQAppInterface, false);
    return jdField_a_of_type_ArrayOfBamo[paramInt];
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, int paramInt, bamo parambamo)
  {
    ...
    try
    {
      a(((String)localObject).substring(((String)localObject).indexOf(':') + 1), parambamo);
      return paramQQAppInterface;
    }
    catch (Exception parambamo) {}
    return paramQQAppInterface;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, bamo parambamo, int paramInt)
  {
    ...
    ((StringBuilder)localObject).append(parambamo.jdField_a_of_type_Int);
    int i = 0;
    while (i <= 5)
    {
      ((StringBuilder)localObject).append('#').append(i).append('_').append(parambamo.jdField_a_of_type_ArrayOfInt[i]);
      i += 1;
    }
    paramQQAppInterface = paramQQAppInterface.getCurrentAccountUin();
    parambamo = BaseApplicationImpl.sApplication.getSharedPreferences("RecordParams_" + paramQQAppInterface, 0);
    localObject = ((StringBuilder)localObject).toString();
    parambamo.edit().putString("PTTPreDownloadParams_" + paramInt, (String)localObject).commit();
    if (QLog.isDevelopLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length >= 2))
        {
          ...
          if ((j >= 1) && (j < jdField_a_of_type_ArrayOfBamo.length))
          {
            bamo localbamo = jdField_a_of_type_ArrayOfBamo[j];
            a(arrayOfString[1], localbamo);
          }
        }
      }
  ...
  protected static void a(String paramString, bamo parambamo)
  {
    ...
    {
      return;
      parambamo.jdField_a_of_type_Int = Integer.parseInt(paramString[0]);
      int i = 1;
      for (;;)
      {
        ...
        parambamo.jdField_a_of_type_ArrayOfInt[j] = k;
        i += 1;
      }
    }
  }
