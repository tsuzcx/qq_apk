  ...
  extends WebViewPlugin
{
  ...
  private void a(String paramString)
  {
    ...
    axqy.b(null, a(paramString, "tag", "P_CliOper"), a(paramString, "main_action", "Pb_account_lifeservice"), a(paramString, "to_uin", ""), str1, str2, a(paramString, "from_type", 0), a(paramString, "result", 0), a(paramString, "r2", ""), a(paramString, "r3", ""), a(paramString, "r4", ""), a(paramString, "r5", ""));
  }
  ...
  protected void a(Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {
        Toast.makeText(this.mRuntime.a().getApplicationContext(), ajya.a(2131708814), 0).show();
      }
      return;
    }
    if (paramBoolean1)
      ...
      for (;;)
      {
        ...
        else if (TextUtils.equals("socialize_feeds_update", paramString3))
        {
          try
          {
            ...
            a(anqu.a("ipc_kandian_socialfeeds_update", "", -1, this.a), false, false);
          }
          catch (Exception paramJsBridgeListener)
          {
        ...
        else if ("toggleFolderList".equals(paramString3))
        {
          try
          {
            ...
            paramJsBridgeListener = ((EcshopWebActivity)paramJsBridgeListener).b();
