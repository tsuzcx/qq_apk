...
public class nov
{
  ...
  private static nov jdField_a_of_type_Nov;
  private Context jdField_a_of_type_AndroidContentContext;
  Handler jdField_a_of_type_AndroidOsHandler = new now(this, Looper.getMainLooper());
  ...
  private void e()
  {
    ...
    if (i <= m)
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131377943);
