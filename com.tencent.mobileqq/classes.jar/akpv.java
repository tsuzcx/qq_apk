  ...
  extends aksv
{
  ...
  public akpv(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  private int a(String paramString, int paramInt)
  {
    synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
    {
      ...
      if (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().containsKey(a(paramString, paramInt))) {
  ...
  private QQMessageFacade.Message a(String paramString, aukn paramaukn, int paramInt1, int paramInt2)
  {
    if (a(paramString, true)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramaukn);
    }
    int i;
    String str;
    if ((paramString.startsWith("mr_discusssion")) || (paramString.startsWith("mr_troop")))
    {
      ...
      str = "select * from (select count() as unReadNum from %s mr where mr.isread=0),(select count() as hasReply from %s mr where mr.issend=0),%s m where m.isValid=1 and m.msgtype " + akpy.a() + " and m.longMsgId='%d' and m.issend='%d' order by %s limit 1";
      if (!bool) {
        break label177;
      }
      if (i == 0) {
      ...
      paramaukn = "longMsgIndex asc , shmsgseq desc , _id desc";
    }
    for (;;)
    {
      paramString = String.format(str, new Object[] { paramString, paramString, paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramaukn });
      ...
      break;
      label171:
      paramaukn = "longMsgIndex asc , time desc , _id desc";
      continue;
      label177:
      paramaukn = "_id desc";
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!akpy.a(paramMessageRecord1, paramMessageRecord2)) {
            break;
          }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      if (localHashSet.contains(akpy.a((MessageRecord)paramList.get(i)))) {
      ...
      for (;;)
      {
        i -= 1;
        break;
        localHashSet.add(akpy.a((MessageRecord)paramList.get(i)));
      }
    }
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if ((localList != null) && (localList.size() == 0))
    {
      ...
      akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().remove(a(paramString, paramInt));
      b(paramString, paramInt, b(paramString, paramInt, new axrr()));
    }
  }
  ...
  {
    Object localObject2;
    synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt1))
    {
  ...
  private void b(String paramString, int paramInt, List<MessageRecord> paramList)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 266	akrz:jdField_a_of_type_Boolean	Z
    //   5: ifeq +26 -> 31
    //   8: aload_0
    //   9: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   12: invokevirtual 36	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    //   15: invokestatic 41	akpu:a	(Ljava/lang/String;)Lakpu;
    //   18: invokevirtual 269	akpu:a	()Lcom/tencent/mobileqq/app/msgcache/MsgLruCache;
    //   21: aload_1
    //   22: iload_2
    //   23: aload_3
    ...
    //   30: return
    //   31: aload_0
    //   32: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   35: invokevirtual 36	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    //   38: invokestatic 41	akpu:a	(Ljava/lang/String;)Lakpu;
    //   41: invokevirtual 211	akpu:a	()Ljava/util/concurrent/ConcurrentHashMap;
    //   44: invokevirtual 276	java/util/concurrent/ConcurrentHashMap:size	()I
    //   47: istore 4
    //   49: getstatic 279	akpy:a	[Ljava/lang/String;
    //   52: arraylength
    //   53: istore 5
    //   55: getstatic 281	akpy:b	[Ljava/lang/String;
    //   58: arraylength
    //   59: istore 6
    //   61: iload 4
    //   63: iload 5
    ...
    //   121: aload_0
    //   122: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   125: invokevirtual 36	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    //   128: invokestatic 41	akpu:a	(Ljava/lang/String;)Lakpu;
    //   131: invokevirtual 211	akpu:a	()Ljava/util/concurrent/ConcurrentHashMap;
    //   134: aload_0
    //   135: aload_1
    //   136: iload_2
    //   137: invokevirtual 63	akpv:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   140: aload_3
  ...
  private void b(List<MessageRecord> paramList, akte paramakte)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (localMessageRecord.versionCode > 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(localMessageRecord.frienduin, localMessageRecord.istroop, MessageRecord.getTableName(localMessageRecord.frienduin, localMessageRecord.istroop), localMessageRecord, 0, paramakte);
      }
    }
  ...
  private List<MessageRecord> f(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      localObject1 = akpy.a(paramString, (List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext()) {
        akpy.a(paramString, (MessageRecord)((Iterator)localObject1).next(), true);
      }
      label346:
  ...
  private void g()
  {
    agvz localagvz = (agvz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125);
    localagvz.e = null;
    localagvz.f = null;
  }
  ...
  {
    Object localObject2 = akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt);
    List localList = null;
    for (;;)
    {
      Object localObject1;
  ...
  public int a(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(ajsf.Y, paramInt))
      {
        Object localObject2 = d(ajsf.Y, 4001);
        if (localObject2 != null)
        {
          ...
          if (j >= 0)
          {
            ...
            a(String.valueOf(ajsf.Y), 4001, MessageRecord.getTableName(String.valueOf(ajsf.Y), 4001), "msgtype=?", new String[] { String.valueOf(paramInt) }, null);
          }
        }
        else
        {
          if ((localObject2 != null) && (((List)localObject2).size() == 0) && (aydb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) <= 0))
          {
            localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
            RecentUser localRecentUser = ((aktg)localObject2).a(ajsf.W, 9000);
            if (localRecentUser != null) {
              ((aktg)localObject2).b(localRecentUser);
            }
          }
          return i;
        }
  ...
  public int a(int paramInt, QQMessageFacade.Message paramMessage)
  {
    ...
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(str, 4001))
      {
  ...
  public int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
      paramString = a();
      str1 = "( msgtype " + akpy.b() + " and isValid=1 ) and ( time < ? or (time = ? and longMsgIndex <= ? and _id <= ?))";
  ...
  protected int a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localaulz = (aulz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        break label93;
      }
      ThreadManager.post(new MsgProxy.1(this, localaulz, paramString, paramInt), 10, null, false);
    }
    label93:
    while (localaulz == null) {
      return i;
    }
    localaulz.a(MessageRecord.getTableName(paramString, paramInt), null, null);
    return i;
  }
  ...
  public Cursor a(String paramString, int paramInt)
  {
    ...
    if (paramString.equals(String.valueOf(ajsf.G)))
    {
      ArrayList localArrayList = new ArrayList();
      int i = 0;
      ...
      return new akpw(this, localArrayList);
    }
    return new akpw(this, (List)((ArrayList)localList).clone());
  }
  ...
  /* Error */
  public com.tencent.mobileqq.app.fms.FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt1, String paramString2, int paramInt2, akmw paramakmw)
  {
    // Byte code:
    //   0: aload_1
    ...
    //   13: iload_2
    //   14: iconst_1
    //   15: invokevirtual 209	akpv:a	(Ljava/lang/String;IZ)Z
    //   18: ifeq +10 -> 28
    //   21: aload_0
    //   22: getfield 81	akpv:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    ...
    //   31: lstore 6
    //   33: getstatic 681	aknb:jdField_a_of_type_Long	J
    //   36: lstore 8
    //   38: aload_1
    //   39: iload_2
    ...
    //   43: astore 10
    //   45: aload_0
    //   46: invokevirtual 134	akpv:a	()Laukv;
    //   49: iconst_0
    //   50: aload 10
    //   52: aconst_null
    //   53: ldc_w 683
    ...
    //   108: invokevirtual 557	aukv:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   111: astore 10
    //   113: aload_0
    //   114: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   117: aload_0
    //   118: getfield 655	akpv:jdField_a_of_type_Aukv	Laukv;
    //   121: aload 10
    //   123: aload_1
    //   124: iload_2
    //   125: aload_3
    //   126: aload 5
    //   128: invokestatic 690	akmy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Laukn;Landroid/database/Cursor;Ljava/lang/String;ILjava/lang/String;Lakmw;)Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult$SearchResultItem;
    //   131: astore_3
    //   132: aload_3
    //   133: astore_1
    //   134: aload 10
  ...
  public QQMessageFacade.Message a(String paramString, aukn paramaukn)
  {
    return a(paramString, paramaukn, 0);
  }
  
  protected QQMessageFacade.Message a(String paramString, aukn paramaukn, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b)
      {
        ...
        ((StringBuilder)localObject1).append(akpy.a());
            ...
            if (localObject2 != null)
            {
              ...
              if (((QQMessageFacade.Message)localObject2).isLongMsg())
              {
                ...
                if (((QQMessageFacade.Message)localObject2).longMsgIndex > 0) {
                  localObject1 = a(paramString, paramaukn, ((QQMessageFacade.Message)localObject2).longMsgId, ((QQMessageFacade.Message)localObject2).issend);
                }
              }
            }
          }
        ...
        if (localObject1 == null)
        {
          ...
          if (paramString.hasNext())
          {
            ...
            i = 0;
            paramaukn = a(paramaukn, (MessageRecord)localObject2, bool1);
            paramInt = i + paramInt;
            continue;
          }
        }
        ...
        if (localObject1 == null)
        {
          ...
          MessageRecord.copyMessageRecordBaseField(paramString, paramaukn);
  ...
  protected ChatHistorySearchData a(Cursor paramCursor, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      if (str1 != null)
      {
        localObject = bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo, str1.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), str1);
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    //   46: astore_3
    //   47: aload_0
    //   48: invokevirtual 134	akpv:a	()Laukv;
    //   51: iconst_0
    //   52: aload_3
    //   53: aconst_null
    //   54: ldc_w 809
    ...
    //   72: ldc_w 685
    //   75: aconst_null
    //   76: invokevirtual 557	aukv:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   79: astore 5
    //   81: aload_0
    //   82: aload 5
    //   84: aload_1
    //   85: aload_2
    //   86: invokevirtual 811	akpv:a	(Landroid/database/Cursor;Lcom/tencent/mobileqq/activity/aio/SessionInfo;Ljava/lang/String;)Lcom/tencent/mobileqq/data/ChatHistorySearchData;
    //   89: astore_1
    //   90: aload_1
    //   91: astore_3
    //   92: aload 5
        ...
        if (i >= 0)
        {
          ...
          else
          {
            ...
            if (localObject2 == null)
            {
              ...
              akpr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt1);
  ...
  public MessageRecord a(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt1))
      {
        paramString = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(a(paramString, paramInt1));
        if (paramString != null)
        {
  ...
  public MessageRecord a(String paramString1, int paramInt, long paramLong, String paramString2, Object paramObject)
  {
    ...
    try
    {
      ...
      if (((Field)localObject).isAnnotationPresent(aulx.class)) {
        return localMessageRecord;
      }
      localObject = new ContentValues();
  ...
  public MessageRecord a(String paramString1, int paramInt1, long paramLong1, String paramString2, String paramString3, long paramLong2, int paramInt2)
  {
    ...
    if (localMessageRecord != null)
    {
      paramString3 = aywi.b(localMessageRecord.msg, paramString2, paramString3, paramLong2, paramInt2);
  ...
  protected String a(Cursor paramCursor, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    if (bbet.a(paramCursor.getInt(paramCursor.getColumnIndex("issend")))) {
  ...
  protected List<MessageRecord> a(String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        aktd localaktd = (aktd)((Iterator)localObject2).next();
        if ((localaktd.jdField_a_of_type_Aukm instanceof MessageRecord))
        {
          MessageRecord localMessageRecord = (MessageRecord)localaktd.jdField_a_of_type_Aukm;
          if ((TextUtils.equals(paramString, localaktd.jdField_b_of_type_JavaLangString)) && (localaktd.jdField_b_of_type_Int == 0)) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      Object localObject = akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt1);
      if (i == 0) {}
      try
      {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt1))
    {
      localObject1 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().get(a(paramString, paramInt1));
      int k = 0;
      int i = 0;
      int j = k;
      if (localObject1 != null)
    ...
    for (;;)
    {
      if (paramInt2 >= 0)
      {
        localObject4 = akpy.a((MessageRecord)localList.get(paramInt2));
      ...
      else
      {
        ...
        akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().put(a(paramString, paramInt1), localObject2);
        for (;;)
        {
          return (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().get(a(paramString, paramInt1));
          ((List)localObject1).addAll(localList);
          break;
          label698:
          akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().remove(a(paramString, paramInt1));
          if (QLog.isColorLevel()) {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByMsgUniseqFromDB, peerUin[" + apue.e(paramString) + "] type[" + paramInt + "] uniseq[" + paramLong + "]");
    }
    if (paramLong == 0L)
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localObject = ((aukv)localObject).a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
  ...
  protected List<MessageRecord> a(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt1))
    {
      if (a(paramInt1))
      {
        ...
        akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().put(a(paramString, paramInt1), localObject1);
        return localObject1;
      }
  ...
  protected List<MessageRecord> a(String paramString1, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, String paramString2)
  {
    ...
    paramString2 = bbep.a(MessageRecord.getOldTableName(paramString1, paramInt1), MessageRecord.getTableName(paramString1, paramInt1), paramLong1, paramInt2, paramLong2, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(), paramString2);
    if (paramString2 != null)
    {
      if (a(paramString1, paramInt1, true)) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(a());
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    for (int i = amns.a(paramInt1, paramInt2) << 3;; i = 0)
    {
      ...
      if (i == 0)
      {
        ...
        localObject1 = ((aukv)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, (QQAppInterface)localObject3);
        if (QLog.isColorLevel())
        {
      ...
      for (paramInt1 = 0;; paramInt1 = ((List)localObject1).size())
      {
        ...
        localObject1 = ((StringBuilder)localObject1).toString();
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        localObject1 = ((aukv)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2), String.valueOf(i) }, (QQAppInterface)localObject3);
        break;
      }
    }
  }
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, axrr paramaxrr)
  {
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        List localList2 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(str);
        List localList1 = localList2;
        if (localList2 == null)
        {
          long l = System.nanoTime();
          localList1 = b(paramString, paramInt, paramaxrr);
          b(paramString, paramInt, localList1);
          if (!bbjv.a()) {
            break label294;
          }
          paramaxrr = (awzy)awzw.b.get(str);
          if (paramaxrr == null)
          {
            paramaxrr = new awzy();
            paramaxrr.jdField_a_of_type_JavaLangString = paramString;
            paramaxrr.jdField_a_of_type_Boolean = false;
            if (localList1.isEmpty()) {
              break label297;
            }
            bool = true;
            paramaxrr.b = bool;
            paramaxrr.jdField_a_of_type_Long = ((System.nanoTime() - l) / 1000000L);
            awzw.b.put(str, paramaxrr);
            break label294;
          }
        }
        else
        {
          if (QLog.isColorLevel())
          {
            paramaxrr = new StringBuilder();
            paramaxrr.append("getMsgList2 uin ").append(paramString).append(" , type = ").append(paramInt).append(" itemList size=").append(localList1.size());
            ...
            QLog.d("Q.msg.MsgProxy", 2, paramaxrr.toString());
            jdField_b_of_type_Int += 1;
          }
          return localList1;
        }
  ...
  public List<MessageRecord> a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        if (Looper.myLooper() == Looper.getMainLooper())
        {
          ...
          localObject2 = a(paramString, paramInt, (axrr)localObject1);
          if ((((axrr)localObject1).jdField_b_of_type_Int != 0) && (axrl.a()) && (axrl.a(1)))
          {
            localObject4 = new HashMap();
            ((HashMap)localObject4).put("param_IsMainThread", String.valueOf(((axrr)localObject1).jdField_a_of_type_Int));
            ((HashMap)localObject4).put("param_OptType", ((axrr)localObject1).jdField_a_of_type_JavaLangString);
            ((HashMap)localObject4).put("param_OptTotalCost", String.valueOf(((axrr)localObject1).jdField_a_of_type_Long));
            ((HashMap)localObject4).put("param_OptCount", String.valueOf(((axrr)localObject1).jdField_b_of_type_Int));
            ((HashMap)localObject4).put("param_OptMsgCount", String.valueOf(((axrr)localObject1).c));
            ((HashMap)localObject4).put("param_OptOneCost", String.valueOf(((axrr)localObject1).jdField_b_of_type_Long));
            ((HashMap)localObject4).put("param_OptScene", ((axrr)localObject1).jdField_b_of_type_JavaLangString);
            ((HashMap)localObject4).put("param_WalSwitch", String.valueOf(akfv.jdField_a_of_type_Boolean));
            axrl.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, ((axrr)localObject1).c, 0L, (HashMap)localObject4, null, false);
          }
          if ((localObject2 == null) || (((List)localObject2).isEmpty())) {
            break label1102;
          }
    ...
    if ((paramInt == 0) || (paramInt == 1000) || (paramInt == 1004) || (paramInt == 1044))
    {
      if (((List)localObject2).size() > 15)
      {
        ...
        if (akpy.a(paramString, paramInt, (List)localObject1)) {
          break label1202;
        }
        if (!akpy.c((List)localObject1)) {
          break label1208;
        }
        break label1202;
      ...
      for (;;)
      {
        ...
        label859:
        return (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().get(a(paramString, paramInt));
    ...
    for (;;)
    {
      if (i >= 0)
      {
        localObject5 = akpy.a((MessageRecord)((List)localObject2).get(i));
  ...
  public void a(int paramInt, String paramString)
  {
    try
    {
      ...
      akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().remove(paramString);
      g();
      if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, akte paramakte)
  {
    if (paramInt2 > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString1, paramInt1, MessageRecord.getTableName(paramString1, paramInt1), paramContentValues, paramString2, paramArrayOfString, 1, paramakte);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString1, paramInt1, MessageRecord.getOldTableName(paramString1, paramInt1), paramContentValues, paramString2, paramArrayOfString, 1, paramakte);
  }
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    for (String str1 = "shmsgseq";; str1 = "time")
    {
      ...
      a(paramString, paramInt, str3, localContentValues, String.format("isread=? and %s<=? and " + akpy.d(), new Object[] { str1 }), new String[] { "0", str2 }, null);
      return;
    }
  ...
  public void a(String paramString, int paramInt, long paramLong, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        if (!akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().containsKey(str)) {
          break label415;
        }
        localList = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(str);
        int k = 0;
        i = 0;
        int j = k;
        Object localObject2;
      ...
      paramList = akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a();
      if ((akrz.jdField_a_of_type_Boolean) && (paramList.getCacheType(str) == akrz.d)) {
        paramList.changeCacheType(str, akrz.c);
      }
      label407:
  ...
  protected void a(String paramString, int paramInt, aukm paramaukm, akte paramakte)
  {
    if (((paramaukm instanceof MessageRecord)) && (((MessageRecord)paramaukm).versionCode > 0)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString, paramInt, MessageRecord.getTableName(paramString, paramInt), paramaukm, 0, paramakte);
    }
  }
  ...
  public void a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
    {
      List localList = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(a(paramString, paramInt));
      if (localList != null)
      {
        akpy.a(localList, paramMessageRecord, true);
        if (localList.size() > 40)
        {
          localList.remove(0);
          paramMessageRecord = a(paramString, paramInt);
          MsgLruCache localMsgLruCache = akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a();
          if ((akrz.jdField_a_of_type_Boolean) && (localMsgLruCache.getCacheType(paramMessageRecord) == akrz.d)) {
            localMsgLruCache.changeCacheType(paramMessageRecord, akrz.c);
          }
        }
        b(paramString, paramInt, localList);
      }
  ...
  protected void a(String paramString, int paramInt1, MessageRecord paramMessageRecord, int paramInt2)
  {
    ...
    if (((paramInt1 == 1001) || (paramInt1 == 10002)) && (paramMessageRecord.msgtype != -1003) && (paramMessageRecord.msgtype != -1031) && (paramMessageRecord.msgtype != -1032) && (paramMessageRecord.msgtype != 201)) {
      ...
      {
        str = MessageRecord.getTableName(String.valueOf(ajsf.H), 1001);
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        str = MessageRecord.getOldTableName(String.valueOf(ajsf.H), 1001);
        break;
        if (paramInt1 == 1009)
        {
          a(paramString, paramInt1, MessageRecord.getTableName(ajsf.w, 1009), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else if (paramInt1 == 1010)
        {
          a(paramString, paramInt1, MessageRecord.getTableName(ajsf.ab, 1010), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else
        {
          if ((paramInt1 != 0) || (!TextUtils.equals(paramString, ajsf.M))) {
            break label316;
          }
          a(paramString, paramInt1, MessageRecord.getTableName(ajsf.M, 0), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
      }
      if ((paramInt1 == 1032) && (TextUtils.equals(paramString, ajsf.aM)))
      {
    ...
    paramInt2 = amns.a(paramInt1, paramInt2) << 3;
    a(paramString, paramInt1, MessageRecord.getTableName(ajsf.aM, 1032), localContentValues, "senderuin=? and isread=? and (extLong & 4194296)=? ", new String[] { paramString, "0", Integer.toString(paramInt2) }, null);
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, akte paramakte)
  {
    if (paramMessageRecord.versionCode > 0) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramString, paramInt, MessageRecord.getTableName(paramString, paramInt), paramMessageRecord, 0, paramakte);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
  }
  
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, akte paramakte, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((akpy.n(paramMessageRecord.msgtype)) && (!akpy.a(paramMessageRecord.frienduin, paramMessageRecord.istroop))) {}
    while (!paramBoolean2) {
      return;
    }
    if (paramBoolean1)
    {
      a(paramString, paramInt, paramMessageRecord, paramakte);
      return;
    }
    a(paramString, paramInt, paramMessageRecord, paramakte);
  }
    ...
    for (;;)
    {
      ...
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        if ((localObject3 != null) && (((List)localObject3).size() > 40) && (!akpy.a(paramString)))
        {
          ...
          if ((akrz.jdField_a_of_type_Boolean) && (((MsgLruCache)localObject3).getCacheType(localObject1) == akrz.d)) {
  ...
  protected void a(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2)
  {
    for (;;)
    {
      List localList;
      ArrayList localArrayList;
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString1, paramInt1))
      {
  ...
  public void a(String paramString, int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        localObject1 = new ArrayList();
        localList = akpy.a((List)localObject1, paramList);
        Iterator localIterator = localList.iterator();
        if (localIterator.hasNext())
        {
      ...
      if (agvz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) {
        akok.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localList, localList, true, false);
      }
  ...
  public void a(List<MessageRecord> paramList, akte paramakte)
  {
    b(akpy.a(paramList), paramakte);
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        Iterator localIterator = akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().keySet().iterator();
        Object localObject1 = null;
        if (!localIterator.hasNext()) {
          break label430;
        }
        String str = (String)localIterator.next();
        if (((str != null) && (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().keySet().contains(str))) || ((str != null) && (akpy.b(str)))) {
          continue;
        }
        if (str != null)
        {
          List localList = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(str);
          localObject5 = str;
          ...
          if (localObject5 != null)
          {
            ...
            akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().remove(localObject5);
            if (QLog.isColorLevel())
            {
  ...
  protected boolean a(String paramString1, int paramInt, String paramString2, List<MessageRecord> paramList)
  {
    ...
    if ((!akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().containsKey(paramString2)) && (localawan.a(paramString1)))
    {
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().put(a(paramString1, paramInt), paramString2);
        return true;
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          aktd localaktd = (aktd)localVector.get(i);
          if ((akpy.a(localaktd.jdField_a_of_type_JavaLangString, paramString, localaktd.jdField_a_of_type_Int, paramInt)) && ((localaktd.jdField_b_of_type_Int == 1) || (localaktd.jdField_b_of_type_Int == 2) || ((paramBoolean) && (localaktd.jdField_b_of_type_Int == 0))))
          {
            if (QLog.isColorLevel()) {
  ...
  protected boolean a(String paramString, boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (TextUtils.isEmpty(localaktd.jdField_b_of_type_JavaLangString)) {
          return true;
        }
        if ((paramString.equals(localaktd.jdField_b_of_type_JavaLangString)) && ((localaktd.jdField_b_of_type_Int == 1) || (localaktd.jdField_b_of_type_Int == 2) || ((paramBoolean) && (localaktd.jdField_b_of_type_Int == 0))))
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            MessageRecord localMessageRecord = (MessageRecord)localaktd.jdField_a_of_type_Aukm;
            if ((akpy.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt)) && (localaktd.jdField_b_of_type_Int == 0) && (localMessageRecord.time > paramLong) && (!localMessageRecord.isread) && (!localMessageRecord.isSend())) {
              i += 1;
            }
          }
        }
  ...
  public MessageRecord b(String paramString, int paramInt)
  {
    ...
    if (a(str1, false)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(this.jdField_a_of_type_Aukv);
    }
    String str2 = akpy.b();
    if (a(paramInt)) {}
  ...
  public MessageRecord b(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (a(paramInt))
    {
      localStringBuilder = new StringBuilder().append("select * from ").append(MessageRecord.getTableName(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(akpy.a()).append(" ");
      if (paramString2 != null) {}
    ...
    StringBuilder localStringBuilder = new StringBuilder().append("select * from ").append(MessageRecord.getTableName(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(akpy.a()).append(" ");
    if (paramString2 != null) {}
    for (paramString1 = "and " + paramString2;; paramString1 = "")
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt1))
      {
        ...
        localObject1 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(localObject1);
        int j = k;
        if (localObject1 != null)
        {
          j = k;
  ...
  protected List<MessageRecord> b(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      localObject = a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramString2 = ((aukv)localObject).a(paramString2, new String[] { String.valueOf(paramLong), String.valueOf(l) }, localQQAppInterface);
      if (paramString2 == null) {
        break label298;
      }
      if (QLog.isColorLevel()) {
  ...
  List<MessageRecord> b(String paramString, int paramInt, axrr paramaxrr)
  {
    Object localObject1;
    long l1;
    String str;
    ...
    for (;;)
    {
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        localObject1 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(a(paramString, paramInt));
        if (localObject1 != null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (TextUtils.equals(paramaxrr.jdField_b_of_type_JavaLangString, "launch"))
        {
          l2 = (System.nanoTime() - l2) / 1000L;
          paramaxrr.jdField_a_of_type_Long += l2;
          paramaxrr.jdField_b_of_type_Int += 1;
          paramaxrr.c += 1;
          paramaxrr.jdField_b_of_type_Long = (paramaxrr.jdField_a_of_type_Long / paramaxrr.jdField_b_of_type_Int);
          if ((axrl.c) && (QLog.isColorLevel()) && (a(paramString, paramInt))) {
          ...
          paramaxrr = (MessageRecord)((List)localObject1).get(i);
          ((List)localObject1).set(i, ((List)localObject1).get(paramInt));
          ((List)localObject1).set(paramInt, paramaxrr);
          i += 1;
          paramInt -= 1;
          continue;
        }
        if (TextUtils.equals(paramaxrr.jdField_b_of_type_JavaLangString, "AIO"))
        {
          l2 = (System.nanoTime() - l2) / 1000L;
          paramaxrr.jdField_a_of_type_Long = l2;
          paramaxrr.jdField_b_of_type_Int = 1;
      ...
      paramInt = 1;
      if ((paramInt != 0) && (axrl.a()) && (axrl.a(2)))
      {
        paramaxrr.jdField_a_of_type_Int = 1;
        paramaxrr.jdField_a_of_type_JavaLangString = "select";
        paramaxrr.jdField_b_of_type_JavaLangString = "mainThread";
        paramaxrr.jdField_a_of_type_Long = l2;
        paramaxrr.jdField_b_of_type_Int = 1;
        paramaxrr.c = 1;
        paramaxrr.jdField_b_of_type_Long = (paramaxrr.jdField_a_of_type_Long / paramaxrr.jdField_b_of_type_Int);
        HashMap localHashMap = new HashMap();
        localHashMap.put("param_IsMainThread", String.valueOf(paramaxrr.jdField_a_of_type_Int));
        localHashMap.put("param_OptType", paramaxrr.jdField_a_of_type_JavaLangString);
        localHashMap.put("param_OptTotalCost", String.valueOf(paramaxrr.jdField_a_of_type_Long));
        localHashMap.put("param_OptCount", String.valueOf(paramaxrr.jdField_b_of_type_Int));
        localHashMap.put("param_OptMsgCount", String.valueOf(paramaxrr.c));
        localHashMap.put("param_OptOneCost", String.valueOf(paramaxrr.jdField_b_of_type_Long));
        localHashMap.put("param_OptScene", paramaxrr.jdField_b_of_type_JavaLangString);
        localHashMap.put("param_WalSwitch", String.valueOf(akfv.jdField_a_of_type_Boolean));
        axrl.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, paramaxrr.c, 0L, localHashMap, null, false);
      }
    }
    for (;;)
    {
      localObject1 = akpy.a(paramaxrr, localList).iterator();
      for (;;)
      {
        if (((Iterator)localObject1).hasNext())
        {
          akpy.a(paramaxrr, (MessageRecord)((Iterator)localObject1).next(), true);
          continue;
          paramaxrr = new ArrayList();
          break;
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MsgProxy", 2, new Object[] { "init from db, uin=", paramString, ", isSaveToDatabase=", Boolean.valueOf(bool), ", cost=", Long.valueOf(System.currentTimeMillis() - l1), " sqlStr = ", str, " size =", Integer.valueOf(paramaxrr.size()) });
      }
      return paramaxrr;
      label930:
      paramInt = 0;
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, List<Long> paramList)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("queryMessagesByMsgUniseqFromDB, peerUin[").append(apue.e(paramString)).append("] type[").append(paramInt).append("] uniseqList[");
      if (paramList == null)
      {
        i = 0;
  ...
  protected void b(String paramString, int paramInt, long paramLong)
  {
    ...
    synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject2).next();
        if ((!localMessageRecord.isread) && (a(paramInt, paramLong, localMessageRecord)) && ((!akpy.a(paramInt)) || (!akpy.m(localMessageRecord.msgtype)))) {
          localMessageRecord.isread = true;
        }
      }
    }
    ...
    {
      localObject2 = (MessageRecord)paramString.next();
      if ((!((MessageRecord)localObject2).isread) && (a(paramInt, paramLong, (MessageRecord)localObject2)) && ((!akpy.a(paramInt)) || (!akpy.m(((MessageRecord)localObject2).msgtype)))) {
        ((MessageRecord)localObject2).isread = true;
      }
    }
  }
  ...
  public List<MessageRecord> c(String paramString, int paramInt)
  {
    ...
    synchronized (((akpu)???).a(paramString, paramInt))
    {
  ...
  protected List<MessageRecord> c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          MessageRecord localMessageRecord = (MessageRecord)localaktd.jdField_a_of_type_Aukm;
          if ((akpy.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt1)) && (localaktd.jdField_b_of_type_Int == 0) && ((paramInt2 <= 0) || (localMessageRecord.getConfessTopicId() == paramInt2))) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
  ...
  public List<MessageRecord> c(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Object localObject1 = "select * from " + paramString + " where (shmsgseq < ? and msgtype " + akpy.b() + " and isValid=1) order by shmsgseq desc limit ";
    ...
    for (;;)
    {
      ...
      if (paramString.size() < paramInt2)
      {
        ...
        if (localaulz != null)
        {
          localObject1 = localaulz.a().a((String)localObject1 + (paramInt2 - paramString.size()), (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (QLog.isColorLevel())
          {
  ...
  public List<MessageRecord> c(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = ((aukv)localObject).a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = new ArrayList();
    }
  ...
  public void c()
  {
    try
    {
      akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().clear();
      g();
      if (QLog.isColorLevel()) {
        QLog.d("msgFold", 2, "delAIOMsg ");
      }
  ...
  public MessageRecord d(String paramString, int paramInt, long paramLong)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if ((localMessageRecord.shmsgseq == paramLong) && (!akpy.a(localMessageRecord))) {
          return localMessageRecord;
        }
      }
    }
  ...
  protected List<MessageRecord> d(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        localObject2 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a().get(str);
        localObject1 = localObject2;
        if (localObject2 == null)
        {
          long l = System.nanoTime();
          localObject2 = b(paramString, paramInt, new axrr());
          b(paramString, paramInt, (List)localObject2);
          if (!bbjv.a()) {
            break label310;
          }
          localObject1 = (awzy)awzw.b.get(str);
          if (localObject1 == null)
          {
            localObject1 = new awzy();
            ((awzy)localObject1).jdField_a_of_type_JavaLangString = paramString;
            ((awzy)localObject1).jdField_a_of_type_Boolean = false;
            if (((List)localObject2).isEmpty()) {
              break label317;
            }
            bool = true;
            ((awzy)localObject1).b = bool;
            ((awzy)localObject1).jdField_a_of_type_Long = ((System.nanoTime() - l) / 1000000L);
            awzw.b.put(str, localObject1);
            break label310;
          }
        }
        else
  ...
  public List<MessageRecord> d(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    paramString = "select * from " + (String)localObject2 + " where (shmsgseq >= ? and msgtype " + akpy.b() + " and isValid=1) order by shmsgseq asc limit " + (paramInt2 + 1);
    ...
    for (;;)
    {
      ...
      if (localaulz != null)
      {
        localObject2 = "select * from " + (String)localObject2 + " where (shmsgseq > ? and msgtype " + akpy.b() + " and isValid=1) order by shmsgseq asc limit " + paramInt2;
        localObject1 = localaulz.a().a((String)localObject2, (String[])localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel())
        {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt1, int paramInt2)
  {
    ...
    aukv localaukv = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaukv.a((String)localObject, new String[] { String.valueOf(-2006), String.valueOf(paramInt2) }, localQQAppInterface);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByTimeFromDB, peerUin[" + apue.e(paramString) + "] type[" + paramInt + "] time[" + paramLong1 + "] uid[" + paramLong2 + "]");
    }
    ...
    aukv localaukv = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaukv.a((String)localObject, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByTimeFromDB, peerUin[").append(apue.e(paramString)).append("] type[").append(paramInt).append("] time[").append(paramLong1).append("] uid[").append(paramLong2).append("], list.size():");
      if (localObject != null) {
        break label286;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 81	akpv:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   4: invokevirtual 328	com/tencent/mobileqq/app/proxy/ProxyManager:d	()V
    //   7: aload_0
    //   8: getfield 81	akpv:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   11: invokevirtual 1846	com/tencent/mobileqq/app/proxy/ProxyManager:e	()V
    //   14: aload_0
    //   15: invokevirtual 134	akpv:a	()Laukv;
    //   18: invokevirtual 1849	aukv:a	()Laukp;
    //   21: astore 11
    //   23: aload_0
    //   24: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: return
    //   45: aload_0
    //   46: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   49: sipush 201
    //   52: invokevirtual 403	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   55: checkcast 573	aulz
    //   58: astore 14
    //   60: iconst_0
    //   61: istore_1
    //   62: iload_1
    ...
    //   302: astore 8
    //   304: iload_2
    //   305: invokestatic 528	akpv:a	(I)Z
    //   308: ifne +20 -> 328
    //   311: lload 6
    //   313: lstore 4
    //   315: iload_3
    ...
    //   330: astore 8
    //   332: aload_0
    //   333: getfield 30	akpv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   336: invokevirtual 1423	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzw;
    //   339: aload 10
    //   341: iload_2
    //   342: lload 4
    //   344: invokevirtual 1882	awzw:a	(Ljava/lang/String;IJ)V
    //   347: aload 9
    //   349: ifnull +10 -> 359
    //   352: aload 9
    ...
    //   361: ifnull +8 -> 369
    //   364: aload 11
    //   366: invokevirtual 1885	aukp:a	()V
    //   369: aload 12
    //   371: aload 15
    //   373: aconst_null
    //   374: aconst_null
    ...
    //   381: ifnull +8 -> 389
    //   384: aload 11
    //   386: invokevirtual 1888	aukp:c	()V
    //   389: aload 11
    //   391: ifnull +8 -> 399
    //   394: aload 11
    //   396: invokevirtual 1890	aukp:b	()V
    //   399: aload 14
    //   401: ifnull +13 -> 414
    //   404: aload 14
    //   406: aload 15
    //   408: aconst_null
    //   409: aconst_null
    //   410: invokevirtual 602	aulz:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   413: pop
    //   414: iload_1
    //   415: iconst_1
    //   416: iadd
    ...
    //   496: ifnull -97 -> 399
    //   499: aload 11
    //   501: invokevirtual 1890	aukp:b	()V
    //   504: goto -105 -> 399
    //   507: astore 8
    //   509: aload 11
    //   511: ifnull +8 -> 519
    //   514: aload 11
    //   516: invokevirtual 1890	aukp:b	()V
    //   519: aload 8
    //   521: athrow
    //   522: astore 9
    //   524: goto -69 -> 455
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + apue.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    aukv localaukv = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localaukv.a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + apue.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    ...
    aukv localaukv = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaukv.a((String)localObject, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByShmsgseqFromDB, peerUin[").append(apue.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
      if (localObject != null) {
        break label260;
      }
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB4Troop, peerUin[" + apue.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    if ((paramLong == 0L) && (QLog.isColorLevel())) {
    ...
    paramString = "select * from " + MessageRecord.getTableName(paramString, paramInt) + " where shmsgseq=? and msgtype " + akpy.c();
    aukv localaukv = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localaukv.a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if ((paramString != null) && (paramString.size() > 0)) {
      return (MessageRecord)paramString.get(0);
    }
    return null;
  ...
  public MessageRecord i(String paramString, int paramInt, long paramLong)
  {
    ...
    Object localObject2 = (aulz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject2 != null)
    {
      if (QLog.isColorLevel()) {
      ...
      localObject2 = ((aulz)localObject2).a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject1 = ((aukv)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
      if (QLog.isColorLevel())
      {
        paramString = new StringBuilder().append("queryMsgItemHistoryByShmsgseq, slow db return peerUin[").append(apue.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
        if (localObject1 != null) {
          break label210;
        }
      }
