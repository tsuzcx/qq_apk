...
public class bkun
{
  ...
  private List<bkuo> jdField_a_of_type_JavaUtilList;
  ...
  private Pair<Integer, List<bkuo>> a(String paramString, int paramInt)
  {
    Object localObject = null;
    byte[] arrayOfByte = new bkvi().a(paramString, null, 1);
  ...
  /* Error */
  private Pair<Integer, List<bkuo>> a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 155	bkun:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	bkun:a	(Lorg/w3c/dom/Node;)Lbkuo;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private bkuo a(Node paramNode)
  {
    ...
    do
    {
      for (;;)
      {
          ...
          else
          {
            ...
            if (str != null)
            {
              ...
              if (localObject != null) {
                ...
                {
                  localbkuo.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("type"))
                {
                  localbkuo.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("flags"))
                {
                  localbkuo.c = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("path"))
                {
                  localbkuo.jdField_b_of_type_JavaLangString = ((String)localObject);
                  i = k + 1;
                }
                else
                {
                  ...
                  {
                    localbkuo.jdField_a_of_type_JavaLangString = ((String)localObject);
                    i = k + 1;
                  }
                }
              }
        ...
        localbkuo.jdField_a_of_type_AndroidOsBundle = a(paramNode);
        return localbkuo;
        j += 1;
        k = i;
      }
  ...
  private String a()
  {
    return bkst.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List<bkuo> paramList)
  {
    paramList = a(paramInt, paramList);
    if (paramList == null) {
      return false;
    }
    return new bkvi().a(paramString, paramList, null, 1);
  }
  
  /* Error */
  private byte[] a(int paramInt, List<bkuo> paramList)
  {
    // Byte code:
    ...
    //   132: ldc 182
    //   134: aload 6
    //   136: getfield 183	bkuo:jdField_a_of_type_Int	I
    ...
    //   154: ldc 185
    //   156: aload 6
    //   158: getfield 188	bkuo:jdField_b_of_type_Int	I
    ...
    //   198: ldc 200
    //   200: aload 6
    //   202: getfield 202	bkuo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: ldc 195
    //   219: aload 6
    //   221: getfield 198	bkuo:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private bkuo b(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      bkuo localbkuo = (bkuo)localIterator.next();
      if (localbkuo.jdField_a_of_type_Int == paramInt) {
        return localbkuo;
      }
    }
    return null;
  ...
  {
    bkuo localbkuo = b(paramInt);
    if (localbkuo == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilList.remove(localbkuo);
    } while (!paramBoolean);
  ...
  public boolean a(bkuo parambkuo, boolean paramBoolean)
  {
    if (a(parambkuo.jdField_a_of_type_Int)) {
      return false;
    }
    this.jdField_a_of_type_JavaUtilList.add(parambkuo);
    if (paramBoolean) {
      return a();
    }
    return true;
