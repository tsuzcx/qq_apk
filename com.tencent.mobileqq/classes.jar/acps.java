  ...
  extends PublicBaseFragment
{
  ...
  public static void a(Activity paramActivity, JSONObject paramJSONObject, Class<? extends acps> paramClass)
  {
    if ((paramActivity == null) || (paramJSONObject == null))
    {
      acqy.b("GdtBaseBannerFragment", "start error");
      return;
    }
    acqy.b("GdtBaseBannerFragment", "start");
    ...
    aevv.a(paramActivity, paramJSONObject, PublicFragmentActivityForTool.class, paramClass);
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBundle = (qq_ad_get.QQAdGet)qq_ad_get.QQAdGet.class.cast(acqx.a(new qq_ad_get.QQAdGet(), paramBundle));
      ...
      catch (JSONException paramLayoutInflater)
      {
        for (;;)
        {
          acqy.d("GdtBaseBannerFragment", "createParams error", paramLayoutInflater);
        }
      }
      paramLayoutInflater = new Button(getActivity());
      paramLayoutInflater.setText("load");
      paramLayoutInflater.setOnClickListener(new acpt(this));
      paramViewGroup = new Button(getActivity());
      paramViewGroup.setText("show");
      paramViewGroup.setOnClickListener(new acpu(this));
