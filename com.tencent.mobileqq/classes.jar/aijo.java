...
public class aijo
  implements Runnable
{
  public aijo(StructMsgItemPAAudio paramStructMsgItemPAAudio, View paramView, StructMsgItemPAAudio.ViewHolder paramViewHolder) {}
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqStructmsgViewStructMsgItemPAAudio$ViewHolder.c.setBackgroundResource(2130839777);
      return;
    }
