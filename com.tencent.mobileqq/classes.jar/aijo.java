  ...
  implements baux
{
  ...
  public Bitmap getBitmap(java.net.URL paramURL)
  {
    ...
    //   29: aload_1
    //   30: invokestatic 87	bdda:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   33: astore_1
    //   34: aload 8
    ...
    //   167: invokestatic 103	baul:a	(Ljava/lang/String;)I
    //   170: istore_2
    //   171: aload_1
    //   172: astore 6
    //   174: iload_2
    //   175: ifeq +68 -> 243
    //   178: new 105	android/graphics/Matrix
    //   181: dup
    //   182: invokespecial 106	android/graphics/Matrix:<init>	()V
    //   185: astore 6
    //   187: aload 6
    //   189: iload_2
    //   190: i2f
    ...
    //   203: idiv
    //   204: i2f
    //   205: invokevirtual 110	android/graphics/Matrix:setRotate	(FFF)V
    //   208: aload_1
    //   209: iconst_0
    //   210: iconst_0
    //   211: aload_1
    ...
    //   219: aload 6
    //   221: iconst_1
    //   222: invokestatic 113	android/graphics/Bitmap:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   225: astore 7
    //   227: aload_1
    //   228: astore 6
    //   230: aload 7
    ...
    //   260: idiv
    //   261: iload_2
    //   262: invokespecial 115	aijo:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   265: astore 7
    //   267: aload_1
    //   268: astore 6
    //   270: aload 7
    ...
    //   293: iload 4
    //   295: idiv
    //   296: invokespecial 115	aijo:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   299: astore 7
    //   301: aload_1
    //   302: astore 6
    //   304: aload 7
    ...
    //   437: iload 4
    //   439: idiv
    //   440: invokespecial 115	aijo:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   443: astore 7
    //   445: aload_1
    //   446: astore 6
    //   448: aload 7
    ...
    //   472: idiv
    //   473: iload_3
    //   474: invokespecial 115	aijo:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   477: astore 6
    //   479: aload 6
    //   481: ifnull +88 -> 569
    //   484: aload_1
    ...
    //   491: goto -329 -> 162
    //   494: astore 6
    //   496: invokestatic 121	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   499: ifeq +13 -> 512
    //   502: ldc 123
    //   504: iconst_2
    //   505: ldc 125
    //   507: aload 6
    //   509: invokestatic 129	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   512: aload_1
    //   513: astore 6
    //   515: aload_1
    ...
    //   523: aconst_null
    //   524: astore_1
    //   525: invokestatic 121	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   528: ifeq +13 -> 541
    //   531: ldc 123
    //   533: iconst_2
    //   534: ldc 131
    //   536: aload 6
    //   538: invokestatic 129	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   541: aload_1
    //   542: ifnull -23 -> 519
    //   545: aload_1
    //   546: areturn
