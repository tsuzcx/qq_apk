...
public final class bhqd
{
  private static int jdField_a_of_type_Int;
  private static final bhqj jdField_a_of_type_Bhqj = new bhqj(84298576L);
  private static final bhqj b = new bhqj(50613072L);
  private static final bhqj c = new bhqj(101010256L);
  ...
  public static String a(File paramFile)
  {
    ...
    //   56: ldc 188
    //   58: invokestatic 191	bhqd:a	(Ljava/lang/String;I)[B
    //   61: astore_1
    //   62: aload_1
    ...
    //   80: astore_2
    //   81: aload_1
    //   82: invokestatic 201	bhqd:a	(Ljava/io/RandomAccessFile;)[B
    //   85: astore_3
    //   86: aload_3
    //   87: ifnonnull +45 -> 132
    //   90: aload_1
    ...
    //   139: dup
    //   140: aconst_null
    //   141: invokespecial 215	bhqf:<init>	(Lbhqe;)V
    //   144: astore 4
    //   146: aload_1
    //   147: astore_0
    //   148: aload_1
    ...
    //   150: aload 4
    //   152: aload_3
    //   153: invokevirtual 218	bhqf:a	([B)V
    //   156: aload_1
    //   157: astore_0
    //   158: aload_1
    //   159: astore_2
    //   160: aload 4
    //   162: getfield 221	bhqf:a	Ljava/util/Properties;
    //   165: ldc 223
  ...
  private static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        arrayOfByte = new byte[jdField_a_of_type_Bhqj.a().length];
        ((ByteBuffer)localObject).get(arrayOfByte);
        localObject = paramArrayOfByte;
      } while (jdField_a_of_type_Bhqj.equals(new bhqj(arrayOfByte)));
      localObject = paramArrayOfByte;
    } while (b.equals(new bhqj(arrayOfByte)));
    Object localObject = new ByteArrayOutputStream();
    ((ByteArrayOutputStream)localObject).write(b.a());
    ((ByteArrayOutputStream)localObject).write(new bhqk(paramArrayOfByte.length).a());
  ...
  private static void b(File paramFile, String paramString)
  {
    ...
    finally
    {
      try
      {
        ...
        localbhqf = new bhqf(null);
        localbhqf.a(paramFile);
        localbhqf.a.setProperty("apkSecurityCode", paramString);
        paramFile = localbhqf.a();
        localRandomAccessFile.seek(jdField_a_of_type_Int);
        localRandomAccessFile.write(new bhqk(paramFile.length).a());
  ...
  private static void c(File paramFile, String paramString)
  {
    try
    {
      ...
      bhqf localbhqf = new bhqf(null);
      localbhqf.a(arrayOfByte);
      localbhqf.a.setProperty("apkSecurityCode", paramString);
      paramString = localbhqf.a();
