...
public class axti
{
  ...
  private static final String jdField_a_of_type_JavaLangString = axti.class.getName() + "Q.nearby.video_chat.gift";
  public static long[] a;
  ...
  public axti(AppInterface paramAppInterface, Context paramContext, SessionInfo paramSessionInfo, TroopGiftPanel paramTroopGiftPanel, ViewGroup paramViewGroup, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private void b()
  {
    ...
    aail localaail = aail.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
    if (localaail != null)
    {
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData(localaail, true);
      return;
    }
  ...
  public void a(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    bggl localbggl = (bggl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.AIO_ANIMATION_MANAGER);
    bgko localbgko = (bgko)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.TROOP_GIFT_MANAGER);
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin;
    if (paramBoolean) {}
    for (int i = 4;; i = 3)
    {
      localbgko.a("OidbSvc.0x7f8", 2040, paramInt2, str, 2, i, 0, new axtj(this, localbgko, l, localbggl, paramInt1));
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel != null)
    {
      ...
      if (paramBoolean1)
      {
        ...
        localObject = aail.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
        if (localObject == null) {
          break label172;
        }
        this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData((aail)localObject, true);
    ...
    {
      if (paramInt == 0) {
        SosoInterface.startLocation(new axtl(3, true, true, 60000L, true, false, "NearbyTroopsView"));
      }
      return;
      label172:
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.d();
