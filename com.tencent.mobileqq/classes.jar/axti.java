  ...
  extends alko
{
  ...
  public long a;
  private axoh jdField_a_of_type_Axoh = new axoh(paramAppInterface, this.jdField_a_of_type_Axth);
  private axth jdField_a_of_type_Axth = new axth();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public axti(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Axth.b())
        {
          this.jdField_a_of_type_Axth.a(2);
          paramArrayOfByte1 = (axoi)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Axoh.a(paramArrayOfByte2);
          this.jdField_a_of_type_Axoh.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Axth.a(0);
  ...
  {
    Object localObject = lit.a(paramArrayOfByte);
    paramArrayOfByte = ((liu)localObject).a;
    localObject = ((liu)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
  ...
  {
    if (!this.jdField_a_of_type_Axth.h())
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
        if (!this.jdField_a_of_type_Axth.a()) {
          break;
        }
        if (this.jdField_a_of_type_Axth.d())
        {
          QLog.d("PeakAudioTransHandler", 2, "closeWholeConnection close tcp");
          this.jdField_a_of_type_Axoh.a(paramLong);
          return;
        }
        if (this.jdField_a_of_type_Axth.f())
        {
          a(String.valueOf(paramLong), "TransInfo.ExitSession", null, 0, 0, false);
          return;
        }
        if (this.jdField_a_of_type_Axth.e())
        {
          this.jdField_a_of_type_Axth.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Axth.g());
      this.jdField_a_of_type_Axth.c(4);
      return;
    } while (this.jdField_a_of_type_Axth.c());
    this.jdField_a_of_type_Axth.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Axth.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = lit.a(paramString1.toByteArray(), paramString2.toByteArray());
        if (this.jdField_a_of_type_Axoh == null) {
          break;
        }
        if (this.jdField_a_of_type_Axoh.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Axoh.a(paramString1);
  }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Axth.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Axth.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Axth.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Axoh.a())
            {
              ...
              this.jdField_a_of_type_Axth.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(lit.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Axth.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Axth.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
