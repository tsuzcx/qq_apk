...
public class php
  ...
  implements View.OnClickListener, bljm, bljn, syb, syc
{
  public int a;
  private int[] a;
  private int c = -1;
  ...
  public php(ReadInJoyChannelPanelFragment paramReadInJoyChannelPanelFragment, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  private void a(int paramInt, TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      ...
      try
      {
        ReadInJoyChannelPanelFragment.a("0X800949C", new paa().b().a(paramTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramTabChannelCoverInfo)).a());
    ...
    for (paramTabChannelCoverInfo.channelConfigType = ((qvr)ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment).get(1)).a;; paramTabChannelCoverInfo.channelConfigType = paramTabChannelCoverInfo.sectionId)
    {
      localReadInJoyStaticGridView.a(localReadInJoyStaticGridView.a().getCount() - 1, 0, paramTabChannelCoverInfo);
      paramTabChannelCoverInfo = new phq(this, localReadInJoyStaticGridView);
      localReadInJoyStaticGridView.setTag(2131376146, paramTabChannelCoverInfo);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new qwz();
        ((qvp)localObject).a = ((TabChannelCoverInfo)localList.get(i));
        ((qvp)localObject).l = i;
        ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (qvp)localObject, this.d);
        i += 1;
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949B", new paa().b().a(localTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(localTabChannelCoverInfo)).a());
      this.c = -1;
      return;
    }
    catch (JSONException localJSONException)
  ...
  public boolean a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949A", new paa().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).a());
      return true;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, 2131560222), null);
      localphr = new phr(this);
      localphr.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369982));
      localphr.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView = ((AutoFitTextView)paramView.findViewById(2131364368));
      localphr.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376418));
      localphr.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376423));
      localphr.b = ((ImageView)paramView.findViewById(2131365370));
      localphr.b.setOnClickListener(this);
      localphr.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setOnGetMaxWidthCallback(localphr);
      localphr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView = ((KanDianUrlRoundCornerImageView)paramView.findViewById(2131369247));
      if (localphr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView != null) {
        localphr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView.setCorner(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment));
      }
      paramView.setTag(localphr);
    }
    for (;;)
    {
      paramView.setAlpha(1.0F);
      localphr.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setText(((TabChannelCoverInfo)localObject).mChannelCoverName);
      localphr.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setTextColor(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (TabChannelCoverInfo)localObject));
      ImageView localImageView = localphr.b;
      int i;
      if (ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment))
      {
        ...
        localphr.b.setTag(localObject);
        localphr.b.setTag(2131376196, Integer.valueOf(paramInt));
        if ((paramInt < this.jdField_a_of_type_Int) && (ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)))
        {
          ...
          localphr.b.setVisibility(8);
        }
        if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
          break label413;
        }
        localphr.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        localphr.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        if ((localphr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView == null) || (!paz.a())) {}
      }
      try
      {
        localObject = new URL(((TabChannelCoverInfo)localObject).mChannelCoverIcon);
        ozc.a(localphr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView, (URL)localObject, paramView.getContext());
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localphr = (phr)paramView.getTag();
        continue;
        i = 8;
        break label239;
        label413:
        localImageView = localphr.jdField_a_of_type_AndroidWidgetImageView;
        ...
        for (i = 0;; i = 8)
        {
          ...
          localphr.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (TabChannelCoverInfo)localObject, localphr.jdField_a_of_type_AndroidWidgetTextView);
          break;
        }
        label493:
        localphr.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      int i = ((Integer)paramView.getTag(2131376196)).intValue();
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
      try
      {
        ReadInJoyChannelPanelFragment.a("0X8009499", new paa().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).n(ReadInJoyChannelPanelFragment.a(paramAdapterView)).c((int)paramAdapterView.sectionId).b("style", 1).a());
        ...
        if (bnrf.A())
        {
          pfa.a().a(paramAdapterView.mChannelCoverId, 3, false, true);
          ozs.b().post(new ReadInJoyChannelPanelFragment.DynamicGridViewAdapter.1(this, paramAdapterView));
          return;
        }
      }
      catch (JSONException paramView)
      {
        for (;;)
        {
          ...
          continue;
          pfa.a().b(paramAdapterView.mChannelCoverId, 3);
        }
      }
    }
