...
public class php
  implements Runnable
{
  public php(Share paramShare, String paramString, int paramInt, boolean paramBoolean) {}
  
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.e("shareWebPage", 2, "QConnect rich START. title=" + this.jdField_a_of_type_ComTencentBizWebviewpluginShare.jdField_d_of_type_JavaLangString + ", desc=" + this.jdField_a_of_type_ComTencentBizWebviewpluginShare.g + ", thumb=" + this.jdField_a_of_type_ComTencentBizWebviewpluginShare.h + ", shareURL=" + this.jdField_a_of_type_JavaLangString);
    }
    int i = 0;
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.h)) {
      i = 1;
    }
    int j = i;
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.g)) {
      j = i | 0x2;
    }
      ...
      catch (Exception localException1)
      {
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            {
              i = k;
              this.jdField_a_of_type_ComTencentBizWebviewpluginShare.g = ((String)localObject2);
              m = k;
            }
          }
          n = m;
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            {
              m = n;
              this.jdField_a_of_type_ComTencentBizWebviewpluginShare.h = ((String)localObject1);
              m = n;
              this.jdField_a_of_type_ComTencentBizWebviewpluginShare.e = false;
              m = n;
          ...
          if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.h)) || (localObject1 == null)) {
            continue;
          }
          ThreadManager.getUIHandler().post(new phq(this, (SwiftBrowserComponentsProvider.SwiftBrowserComponentProviderSupporter)localObject1));
          return;
        }
