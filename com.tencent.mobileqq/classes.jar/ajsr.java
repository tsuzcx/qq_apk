  ...
  extends ajqv
{
  ...
  ajsr(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Ajqu.f)
    {
      ...
      PhotoUtils.sendPhoto(this.mActivity, localIntent, this.mPhotoCommonData.selectedPhotoList, 0, this.jdField_a_of_type_Ajqu.jdField_a_of_type_Boolean);
      return;
    }
    if (!this.jdField_a_of_type_Ajqu.g)
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        AlbumUtil.putRecordLastPosData(localIntent, this.mPhotoCommonData.albumId, str, this.jdField_a_of_type_Ajqu.isRecodeLastAlbumPath);
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_a_of_type_Ajqu.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new ajss(this, paramView, (ArrayList)localObject2), (LocalMediaInfo)localObject1);
        return;
      }
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ((ajrc)this.mOtherCommonData).a(this.jdField_b_of_type_Boolean, this.mPhotoCommonData);
    if (((ajrc)this.mOtherCommonData).a())
    {
      ylg.a().c(21);
      ylg.a().b(13);
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    PhotoUtils.onSendResult(this.mActivity, paramInt1, paramInt2, paramIntent, this.jdField_a_of_type_Ajqu.h, this.mPhotoCommonData.myUin);
  }
