  ...
  implements bgek
{
  ...
  public bgei(JSONObject paramJSONObject)
  {
  ...
  public static JSONObject a(bgei parambgei)
  {
    JSONObject localJSONObject = new JSONObject().put("type", "recite").put("troop_uin", parambgei.jdField_f_of_type_JavaLangString).put("subtype", 1).put("title", parambgei.jdField_b_of_type_JavaLangString).put("desc", parambgei.c).put("kid", parambgei.jdField_a_of_type_JavaLangString).put("error_count", parambgei.jdField_d_of_type_Int).put("remind_count", parambgei.jdField_e_of_type_Int).put("waste_time", parambgei.jdField_a_of_type_Long).put("grade", parambgei.jdField_f_of_type_Int).put("lyric", parambgei.jdField_g_of_type_JavaLangString);
    if (!TextUtils.isEmpty(parambgei.jdField_e_of_type_JavaLangString)) {
      localJSONObject.put("file_url", parambgei.jdField_e_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(parambgei.jdField_d_of_type_JavaLangString)) {
      localJSONObject.put("file_path", parambgei.jdField_d_of_type_JavaLangString);
    }
    if (parambgei.jdField_a_of_type_JavaUtilList != null) {
      localJSONObject.put("pid_list", new JSONArray(parambgei.jdField_a_of_type_JavaUtilList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(anzj.a(2131704587)).append(paramString2);
    if ((paramList != null) && (!paramList.isEmpty())) {
      localStringBuilder.append(bgdm.a(paramList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(anzj.a(2131704589)).append(paramString2);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (this.jdField_a_of_type_Bnsq != null)
    {
      ...
      this.jdField_a_of_type_Bnsq = null;
    }
