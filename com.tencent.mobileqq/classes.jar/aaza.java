...
public class aaza
  extends RecyclerView.Adapter<aazd>
  implements Handler.Callback
{
  ...
  public aazd a(ViewGroup paramViewGroup, int paramInt)
  {
    return new aazd(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131563051, null));
  }
  ...
  public void a(aayz paramaayz)
  {
    this.jdField_a_of_type_Aayz = paramaayz;
  }
  
  public void a(aazd paramaazd, int paramInt)
  {
    if (a() == 0) {}
    int i;
    label31:
    ...
    do
    {
      EventCollector.getInstance().onRecyclerBindViewHolder(paramaazd, paramInt, getItemId(paramInt));
      return;
      if (paramInt >= a()) {
        break;
      }
    ...
    for (;;)
    {
      zlx.a(aazd.a(paramaazd), localVsMusicItemInfo.mAlbumUrl, zlx.a(paramaazd.itemView.getContext(), 60.0F), zlx.a(paramaazd.itemView.getContext(), 60.0F), zlx.a(paramaazd.itemView.getContext(), 30.0F), paramaazd.itemView.getContext().getResources().getDrawable(2130838844), null);
      paramaazd.itemView.setOnClickListener(new aazb(this, paramInt, localVsMusicItemInfo));
      break;
      i = a(paramInt);
      break label31;
      paramaazd.b(false);
  ...
  {
    VSNetworkHelper.a().a(new BatchGetMusicInfoRequest(paramArrayList), new aazc(this, paramBoolean));
  }
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Aayp = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
