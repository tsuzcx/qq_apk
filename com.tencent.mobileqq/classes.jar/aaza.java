  ...
  extends BaseAdapter
{
  ...
  {
    this.jdField_a_of_type_Ajxl = ((ajxl)paramDiscussionInfoCardActivity.app.getManager(51));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localaazb = new aazb();
      localaazb.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367679));
      localaazb.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370647));
      paramViewGroup.setTag(localaazb);
      ...
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.getString(2131693672);
      ...
      if ((!this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.a.isDiscussHrMeeting()) || (!bbgi.a(this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.a.mSelfRight))) {
        break label219;
      }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        Object localObject = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.app, DiscussionInfoCardActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity), str);
        ...
        else
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            {
              Friends localFriends = this.jdField_a_of_type_Ajxl.e(str);
              paramView = (View)localObject;
              if (localFriends != null)
              {
                paramView = (View)localObject;
                if (localFriends.isFriend()) {
                  paramView = bbcz.a(this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.app, str);
                }
              }
            }
          }
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.a(localaazb, null, true);
          localImageView.setTag(str);
          localImageView.setTag(2131376869, localObject);
        }
      }
    }
  }
