...
public class qkp
{
  ...
  private pal jdField_a_of_type_Pal;
  ...
  public qkp(qlp paramqlp, List<VideoInfo> paramList, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, Handler paramHandler)
  {
    ...
    onh.a().getManager(163);
    this.jdField_a_of_type_Pal = new qkq(this);
  }
  ...
  private VideoInfo a(AdvertisementInfo paramAdvertisementInfo, boolean paramBoolean)
  {
    ...
    localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo = nmc.a(paramAdvertisementInfo);
    ...
    try
    {
      ...
      {
        localObject = onh.a(paramAdvertisementInfo.mJsonVideoList, paramAdvertisementInfo);
  ...
  private void a(AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      nkz localnkz = new nkz();
      localnkz.jdField_a_of_type_Int = paramAdvertisementInfo.mAdMaterialId;
      localnkz.jdField_b_of_type_Int = 1;
      localnkz.jdField_c_of_type_Int = paramAdvertisementInfo.mAdKdPos;
      localnkz.jdField_a_of_type_Long = paramAdvertisementInfo.mAdPosID;
      osg.a().a().a(paramInt2, this.jdField_a_of_type_Pal);
      ThreadManager.executeOnSubThread(new VideoAdExposureManager.1(this, paramInt3, paramInt2, localnkz));
      return;
  ...
  private void b(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Qlp.notifyItemChanged(paramInt);
  }
  
  private void b(AdvertisementInfo paramAdvertisementInfo)
  {
    paramAdvertisementInfo = a(paramAdvertisementInfo, false);
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecyclerView != null) && (this.jdField_a_of_type_Qlp != null) && ((this.e < this.jdField_a_of_type_JavaUtilList.size()) || (this.e <= 0)))
    {
      ...
      if ((localVideoInfo != null) && (!localVideoInfo.jdField_c_of_type_Boolean) && (this.e > k))
      {
        ...
        this.jdField_a_of_type_Qlp.notifyItemInserted(this.e);
        this.e = 0;
      }
      if ((localVideoInfo != null) && (localVideoInfo.jdField_c_of_type_Boolean) && (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null) && (this.jdField_a_of_type_Qlp.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)))
      {
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramAdvertisementInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == this.jdField_b_of_type_Int)
        {
          k = this.f;
          this.f = 0;
          AdvertisementInfo localAdvertisementInfo1 = osg.a().a(paramInt, k);
  ...
  public void a()
  {
    ozk localozk = osg.a().a();
    if (localozk != null)
    {
      localozk.a(this.jdField_a_of_type_Int);
      localozk.a(this.jdField_b_of_type_Int);
    }
  }
  ...
  public void a(int paramInt, qql paramqql, ArrayList<VideoInfo> paramArrayList)
  {
    if ((paramqql == null) || (paramqql.a == null) || (!this.jdField_c_of_type_Boolean)) {}
    for (;;)
    {
      return;
      if (!paramqql.a.jdField_c_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoAdExposureManager", 2, "checkAndInsert , mPlayVmCount=" + this.j);
        }
        b(paramInt, paramqql, paramArrayList);
      }
      while (QLog.isColorLevel())
      {
  ...
  public void a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    a(nmc.a(paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo), paramInt, this.jdField_b_of_type_Int, 6);
  }
  ...
  public void a(qmf paramqmf)
  {
    try
    {
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        if ((paramqmf != null) && (paramqmf.a != null) && (paramqmf.a.a != null) && (paramqmf.a.a.jdField_c_of_type_Boolean) && (paramqmf.a.a.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null))
        {
          d(paramqmf.jdField_b_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAndRecord reset notCountFlag , mPlayingVideoHolder.position=" + paramqmf.jdField_b_of_type_Int);
          }
        }
      }
      return;
  ...
  public void a(boolean paramBoolean, int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if ((!oaq.f(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) || (!this.jdField_d_of_type_Boolean)) {
        break label740;
      }
    }
    label735:
  ...
  public void b(int paramInt, qql paramqql, ArrayList<VideoInfo> paramArrayList)
  {
    boolean bool;
    label25:
    int m;
      ...
      do
      {
        do
        {
          try
          {
            ...
            if (paramqql != null)
            {
              bool = paramqql.jdField_c_of_type_Boolean;
              if (!bool) {
                break label25;
              }
            }
      ...
      else
      {
        for (;;)
        {
          ...
          if (k == -1) {
            ...
            {
              paramqql = (VideoInfo)this.jdField_b_of_type_JavaUtilArrayList.get(0);
              this.jdField_b_of_type_JavaUtilArrayList.remove(0);
            }
          }
          for (;;)
          {
            if ((paramqql != null) || (n == -1) || (n >= paramArrayList.size())) {
              break label587;
            }
            ...
            paramqql = (VideoInfo)paramArrayList.get(k);
          ...
          paramArrayList.add(m, paramqql);
          if (this.jdField_a_of_type_Qlp != null) {
            this.jdField_a_of_type_Qlp.b(paramqql);
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          paramqql = (VideoInfo)paramArrayList.get(m);
          if ((paramqql == null) || (!paramqql.jdField_c_of_type_Boolean) || (paramqql.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (this.jdField_a_of_type_Qlp == null) || (!this.jdField_a_of_type_Qlp.a(paramqql.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h))) {
            break;
          }
          VideoInfo localVideoInfo = (VideoInfo)this.jdField_b_of_type_AndroidUtilSparseArray.get(m);
          paramqql = localVideoInfo;
