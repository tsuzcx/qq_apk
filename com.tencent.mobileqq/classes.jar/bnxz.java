  ...
  extends QzoneExternalRequest
{
  ...
  public bnxz(long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.androidId = String.valueOf(bhlo.f());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.imsi = String.valueOf(b());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.mode = String.valueOf(bhlo.i());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.manufacture = String.valueOf(bhlo.h());
    ...
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.uniqueId = String.valueOf(bjve.c());
  ...
  public static String a()
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = blhc.a("b94d1a");
      label27:
      return jdField_a_of_type_JavaLangString;
    }
