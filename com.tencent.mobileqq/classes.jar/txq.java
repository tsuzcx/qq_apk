  ...
  extends uux
{
  ...
  private SparseArray<txt> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  public txq(boolean paramBoolean, List<urb> paramList1, List<urb> paramList2, JSONObject paramJSONObject, WeakReference<Activity> paramWeakReference, String paramString, BridgeModule paramBridgeModule)
  {
  ...
  {
    this.jdField_a_of_type_AndroidUtilSparseArray.put(1, new txu(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(5, new txz(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(4, new tye(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(6, new txw(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(11, new txy(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(21, new tyb(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(26, new tyc(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(35, new txr(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(37, new txx(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(31, new tyd(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(39, new tya(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(134, new txs(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(133, new tyf(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(-111, new txv(this, (Activity)paramWeakReference.get(), this, paramJSONObject));
  }
  ...
  private boolean b(int paramInt, @NotNull ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    for (;;)
    {
      localObject1 = ((uuw)localObject1).a((List)localObject2, localList, i);
      if ((localObject1 != null) && (((urb)localObject1).jdField_a_of_type_Boolean))
      {
  ...
  public boolean a(int paramInt, @NotNull ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    txt localtxt = (txt)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localtxt != null) {
      localtxt.a(str1, str2, str3, paramActionSheetItem, paramInt);
    }
    for (;;)
    {
      a();
      ...
      ((txt)this.jdField_a_of_type_AndroidUtilSparseArray.get(-111)).a(str1, str2, str3, paramActionSheetItem, paramInt);
    }
  }
