  ...
  extends BaseAdapter
{
  ...
  private ahcm(ClassificationSearchFragment paramClassificationSearchFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (paramView == null)
          {
            paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131560754, paramViewGroup, false);
            ...
            paramViewGroup = new ahdo();
            paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367536));
            paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371141));
            paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379214));
            paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365125));
            paramViewGroup.d = ((TextView)paramView.findViewById(2131369777));
            ...
            paramView.setTag(2131370036, Integer.valueOf(paramInt));
          ...
          paramView = (ahdo)((View)localObject1).getTag();
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561238, null);
          paramView = new ahdn();
          ...
          paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131377821));
        ...
        paramView = (ahdn)paramViewGroup.getTag();
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, aekt.a(110.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
              localObject2 = (ImageView)paramViewGroup.findViewById(2131380076);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131364879);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, aekt.a(90.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
          }
        }
        paramViewGroup = paramView;
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131559365, null);
          paramViewGroup.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
          paramView = new ahcl();
          paramViewGroup.setTag(paramView);
        ...
        localObject1 = (ahcl)paramViewGroup.getTag();
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
        {
          ...
          ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
          ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131702295));
          return paramViewGroup;
        }
        paramView = paramViewGroup;
      } while (!bdee.d(BaseApplicationImpl.getContext()));
      ...
      ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131702304));
      ...
      {
        ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131702312));
        return paramViewGroup;
      }
      paramView = paramViewGroup;
    ...
    ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    ((ahcl)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131702308));
    return paramViewGroup;
  }
