  ...
  extends WebViewPlugin
{
  ...
  public void a()
  {
    ...
    a(anah.a("ipc_kandian_socialfeeds_update", "", 0, this.jdField_a_of_type_AndroidOsBundle), false, false);
  }
  ...
  protected void a(Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {
        Toast.makeText(this.mRuntime.a().getApplicationContext(), ajjy.a(2131647028), 0).show();
      }
      return;
    }
    if (paramBoolean1)
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("showShareReadInJoyMenu".equals(paramString3))
    {
      if (this.jdField_a_of_type_Rus == null) {
        this.jdField_a_of_type_Rus = new rus(this, this.jdField_a_of_type_Wis);
      }
      if (paramVarArgs == null) {
        return false;
      }
      this.jdField_a_of_type_Rus.a(paramVarArgs[0]);
    }
    for (;;)
    {
      return true;
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            if (TextUtils.equals("socialize_feeds_update", paramString3))
            {
              ...
              paramJsBridgeListener = paramString1;
              a(anah.a("ipc_kandian_socialfeeds_update", paramString1, 0, this.jdField_a_of_type_AndroidOsBundle), false, false);
            }
            else
            {
              paramJsBridgeListener = paramString1;
      ...
      if ("readSkinAndSound".equals(paramString3))
      {
        ...
        try
        {
          ...
          paramJsBridgeListener = paramString1;
          this.jdField_a_of_type_Wis.i(new orh(this, paramString1));
        }
      ...
      try
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_Wis.a(paramJsBridgeListener, l1, paramString2, paramString3, l2, l3, new ori(this, paramString1));
      ...
      if ("cancelLoadSkin".equals(paramString3))
      {
        ...
        try
        {
          ...
          paramJsBridgeListener = paramString2;
          this.jdField_a_of_type_Wis.e(paramString3, paramString1, new orj(this, paramString2));
          paramJsBridgeListener = paramString2;
      ...
      try
      {
        ...
        this.jdField_a_of_type_Wis.a(paramString3, l1, paramJsBridgeListener, paramString1, l2, l3, i, new ork(this, paramString2));
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    while (((paramByte != 1) && (paramByte != 2)) || (this.jdField_a_of_type_Rus == null)) {
      return;
    }
    this.jdField_a_of_type_Rus.a(paramIntent, paramByte, paramInt);
  }
