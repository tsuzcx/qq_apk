...
public class awni
{
  ...
  private MsgBackupUserData a(submsgtype0x11a.UserData paramUserData)
  {
    ...
    if (paramUserData.bytes_ip.has()) {
      localawoq.a(paramUserData.bytes_ip.get().toStringUtf8());
    }
    if (paramUserData.rpt_fixed32_port.has()) {
      localawoq.a(paramUserData.rpt_fixed32_port.get());
    }
    if (paramUserData.bytes_bssid.has()) {
      localawoq.c(paramUserData.bytes_bssid.get().toStringUtf8());
    }
    if (paramUserData.bytes_ssid.has()) {
      localawoq.b(paramUserData.bytes_ssid.get().toStringUtf8());
    }
    if (paramUserData.enum_platform.has()) {
      localawoq.a(paramUserData.enum_platform.get());
    }
    return localawoq.a();
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject1 = new bbzm();
    localObject2 = ((SubMsgType0x7.MsgBody)localObject2).toByteArray();
    ((bbzm)localObject1).jdField_a_of_type_Int = 7;
    ((bbzm)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject2);
    long l1 = atvo.b();
    long l2 = atvo.a();
    localObject1 = bbzf.a(paramString, 13, paramString.c(), (bbzm)localObject1, l2, bbzj.b(l1));
    ...
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.enum_result.has())
      {
        ...
        if (paramMsgBody.bytes_token.has()) {
          localawoc.a(paramMsgBody.bytes_token.get().toStringUtf8());
        }
        if (paramMsgBody.bytes_encrypt_key.has()) {
          localawoc.b(paramMsgBody.bytes_encrypt_key.get().toStringUtf8());
        }
        if (paramMsgBody.msg_user_data.has()) {
          localawoc.a(a((submsgtype0x11a.UserData)paramMsgBody.msg_user_data.get()));
        }
        if (paramMsgBody.enum_biz_type.has()) {
          localawoc.a(paramMsgBody.enum_biz_type.get());
        }
        paramMsgBody = localawoc.a();
        if (QLog.isColorLevel()) {
          QLog.d("MsgBackup.MsgBackupPushHandler", 2, "processOnLinePush receive processOnLinePush0x11a response = " + paramMsgBody);
        }
        awnr.a().a(paramMsgBody);
      }
    }
    label180:
    do
  ...
  public void a(submsgtype0x11b.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      awok localawok = new awok();
      if (paramMsgBody.bytes_qr_sig.has()) {
        localawok.a(paramMsgBody.bytes_qr_sig.get().toStringUtf8());
      }
      if (paramMsgBody.enum_biz_type.has()) {
        localawok.a(paramMsgBody.enum_biz_type.get());
      }
      paramMsgBody = localawok.a();
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (paramGenericSubCmd.length() == 1)
      {
        ...
        if ("exit".equals(paramGenericSubCmd.optString("cmd")))
        {
          ...
          if (TextUtils.equals(paramGenericSubCmd, awng.a().a())) {
            awql.a().b(true);
          }
        }
      }
