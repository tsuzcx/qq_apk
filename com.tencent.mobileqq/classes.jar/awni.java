...
public class awni
{
  ...
  {
    return paramQQAppInterface.getMessageFacade().getAllMessages(paramString, paramInt, new int[] { -2076 }, 5);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord instanceof MessageForLocationShare))
    {
      ...
      paramQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.uniseq, localMessageForLocationShare.convertToMsgData());
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    awnj.a(paramQQAppInterface, 0, paramString, false);
    a(paramQQAppInterface, 0, paramString, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bffl parambffl)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (parambffl != null) {}
      for (paramQQAppInterface = parambffl.a;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)bcsa.a(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131718965);
  ...
  {
    return paramQQAppInterface.getMessageFacade().getMessagesFromDB(paramString, paramInt, 9223372036854775807L, 3, 9223372036854775807L, new int[] { -2076 }, 2147483647);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    awnj.a(paramQQAppInterface, 1, paramString, false);
