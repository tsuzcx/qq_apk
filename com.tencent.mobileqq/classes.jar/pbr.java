...
{
  protected long a;
  private akdn jdField_a_of_type_Akdn = new pbs(this);
  private List<sda> jdField_a_of_type_JavaUtilList;
  private volatile boolean jdField_a_of_type_Boolean;
  private Handler b = new pbt(this, ThreadManager.getSubThreadLooper());
  
  public pbr(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  public int a()
  {
    ...
    Iterator localIterator = sdc.a().b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).iterator();
    for (;;)
    {
      j = i;
  ...
  public void a(String paramString)
  {
    int j;
    sda localsda;
    if (!sdc.a().a(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface))
    {
      sdc.a().b(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      ...
      do
      {
        ...
        localsda = (sda)localIterator.next();
      } while ((localsda.a == null) || (!localsda.a.equals(paramString)));
    }
    for (int i = localsda.b;; i = 0)
    {
      f();
      axqy.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064CD", "0X80064CD", 0, 0, "" + i, "" + j, "", "");
      return;
    }
  }
  ...
  public void a(String paramString, Context paramContext)
  {
    ...
    do
    {
      ...
      localsda = (sda)paramContext.next();
    } while ((localsda.a == null) || (!localsda.a.equals(paramString)));
    for (int i = localsda.b;; i = 0)
    {
      axqy.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064CF", "0X80064CF", 0, 0, "" + i, "", "", "");
      return;
    }
  }
  ...
  {
    sdc.a().c(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    int j = sdc.a().a();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    sda localsda;
    do
    ...
    {
      f();
      axqy.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064CE", "0X80064CE", 0, 0, "" + i, "" + j, "", "");
      return;
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    sdc.a().a(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    f();
    ...
    do
    {
      ...
      localsda = (sda)((Iterator)localObject).next();
    } while ((localsda.a == null) || (!localsda.a.equals(paramString)));
    for (int i = localsda.b;; i = 0)
    {
      axqy.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064D0", "0X80064D0", 0, 0, "" + i, "", "", "");
      return;
    }
  }
