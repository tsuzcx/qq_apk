...
public class begk
  extends Handler
{
  public begk(AbsPublishActivity paramAbsPublishActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              this.a.requestPermissions(new begl(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
              return;
            }
            ...
            if (this.a.q != null)
            {
              ...
              bfqu.a(this.a.o, this.a.p, "Clk_record", this.a.q, this.a.jdField_b_of_type_JavaLangString, "", "");
            }
            aevv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramMessage, PublicTransFragmentActivity.class, AudioRecordFragment.class, 1003);
            return;
          } while (!this.a.a(4));
          return;
          ...
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130843520);
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(this.a.getString(2131695545));
          this.a.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
          bkft.b(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
    ...
    if (this.a.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      paramMessage = this.a.jdField_a_of_type_Beji;
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() < 9) {
        bool = true;
      }
    ...
    this.a.jdField_a_of_type_Beji.a(false, true);
    this.a.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo = null;
    this.a.a(0);
