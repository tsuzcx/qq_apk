  ...
  extends avoo
{
  ...
  public avnl()
  {
    this.jdField_c_of_type_Int = 2131101334;
  ...
  public avnl(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131101334;
    this.jdField_f_of_type_Int = -1;
    this.jdField_a_of_type_ArrayOfInt = new int[3];
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bcpn.a((QQAppInterface)localObject3, this.jdField_i_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bcpn.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bcpn.b(this.jdField_i_of_type_Int)) && (!bcpn.c(this.jdField_i_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131630742);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = avvt.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = avwf.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new avvu(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = avwf.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((avvu)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = avwf.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((avvu)localObject).a(this.jdField_c_of_type_JavaLangString, true);
    if (((avvu)localObject).jdField_a_of_type_Int > 0) {}
    for (;;)
    {
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131633811);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131633813);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131633811);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131633812);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof aviu))
      {
        localObject3 = (aviu)localObject2;
        if (((aviu)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((aviu)localObject3).a();
        if (!(localObject1 instanceof avit)) {
          break label2491;
        }
      }
      break;
    ...
    label2485:
    label2491:
    for (Object localObject1 = (avit)localObject1;; localObject1 = null)
    {
      label204:
      Object localObject4;
      switch (((aviu)localObject3).a())
      {
      default: 
        if (d() == 268435456)
        {
          avwf.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_g_of_type_Int + 1) });
          if (((paramView.getContext() instanceof UniteSearchActivity)) && (avjb.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
          {
            localObject1 = (avjc)avjb.jdField_b_of_type_JavaUtilHashMap.get(this);
            localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ...
      do
      {
        try
        {
          for (;;)
          {
            ...
            return;
            avwf.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_g_of_type_Int, paramView);
            if (this.jdField_l_of_type_Int == 1)
            {
              awqx.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
              awqx.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
              break;
            }
            awqx.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
            awqx.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
            break;
            avwf.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_g_of_type_Int, paramView);
            break;
            avwf.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_n_of_type_JavaLangString, e(), e());
            avwf.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_g_of_type_Int, paramView);
            if ((this.jdField_n_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_n_of_type_JavaLangString)))
            {
              avsv.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            ...
            {
              avsv.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            avsv.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
            QQAppInterface localQQAppInterface;
            JSONObject localJSONObject;
            if ((avjb.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
            {
              localObject4 = (avjc)avjb.jdField_b_of_type_JavaUtilHashMap.get(this);
            ...
            try
            {
              ...
              localJSONObject.put("obj_lct", ((avjc)localObject4).jdField_a_of_type_Int);
              localJSONObject.put("get_src", "web");
              avsv.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((avjc)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(avsv.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + avjb.jdField_a_of_type_Long));
              if (avwf.a(this.jdField_a_of_type_Long)) {
                if (avjb.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
                {
                  localObject4 = (avjc)avjb.jdField_a_of_type_JavaUtilHashMap.get(this);
                  if (((avjc)localObject4).jdField_b_of_type_Boolean)
                  {
                    i1 = 2;
                    avwf.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((avjc)localObject4).jdField_b_of_type_JavaLangString + "", ((avjc)localObject4).jdField_a_of_type_Int + "" });
                  }
                }
                else
                {
                  if ((localObject1 == null) || (!((avit)localObject1).b())) {
                    break label204;
                  }
                  ((avit)localObject1).a(true);
                  avwf.a("all_result", "clk_first_result", new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
                }
              }
            }
            catch (JSONException localJSONException2)
            {
              ...
              if (avjb.jdField_b_of_type_Boolean) {}
              for (i1 = 2;; i1 = 1)
              {
                avwf.a("all_result", "clk_content", i1, 0, new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "", avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
                if ((localObject1 == null) || (!((avit)localObject1).b())) {
                  break;
                }
                ((avit)localObject1).a(true);
                avwf.a("all_result", "clk_first_result", new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
                break;
              }
            }
          }
          ...
          {
            ((avit)localObject1).a(true);
            avwf.a("all_result", "clk_tab_first_result", new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
          }
          avwf.a("all_result", "clk_tab_result", new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "", avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
          break label204;
          if ((localObject1 != null) && (((avit)localObject1).b()))
          {
            ((avit)localObject1).a(true);
            avwf.a("sub_result", "clk_sub_first_result", new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
          }
          avwf.a("sub_result", "clk_result", new String[] { ((aviu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), avwf.a("dynamic_tab_search.1", ((aviu)localObject3).a()) });
        }
        catch (JSONException localJSONException1)
        {
          for (;;)
          ...
          {
            paramView = bade.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
            if (paramView != null)
            {
              paramView.c();
              return;
        ...
        {
          avwf.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
          return;
        }
        if (this.jdField_a_of_type_Long == 1001L)
        {
          ...
          if (azgu.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
          {
            azgu.a(paramView.getContext(), null, this.jdField_b_of_type_JavaLangString);
            return;
          }
        }
      ...
      for (i2 = 113;; i2 = 104)
      {
        ...
        azlj.a(paramView.getContext(), (Bundle)localObject1, 2);
        return;
      }
    }
  }
  ...
  {
    Object localObject = new avvu(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_g_of_type_JavaLangString = avwf.a(this.jdField_g_of_type_JavaLangString);
    SpannableString localSpannableString = ((avvu)localObject).a(this.jdField_g_of_type_JavaLangString);
    localObject = localSpannableString;
    if (localSpannableString == null) {
      localObject = "";
    }
  ...
  {
    boolean bool = false;
    avvu localavvu = new avvu(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = avwf.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localavvu.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localavvu.jdField_a_of_type_Int > 0) {
      bool = true;
    }
    this.h = bool;
    if (localSpannableString == null) {
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new avvu(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
