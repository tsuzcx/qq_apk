...
public class avnl
{
  ...
  public static String a(long paramLong)
  {
    ...
    if (l2 < 600000L) {
      return alpo.a(2131707602);
    }
    if (l2 < 3600000L) {
      return l2 / 60L / 1000L + 1L + alpo.a(2131707595);
    }
    if ((l2 < 21600000L) && (k == i)) {
      return l2 / 60L / 60L / 1000L + alpo.a(2131707589);
    }
    if ((l2 < 86400000L) && (k == i))
    {
    ...
    {
      localSimpleDateFormat.applyPattern("HH:mm");
      return alpo.a(2131707600) + localSimpleDateFormat.format(localCalendar.getTime());
    }
    if (m == j)
    {
