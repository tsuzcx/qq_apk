  ...
  extends MSFServlet
{
  ...
  protected void a(boolean paramBoolean, newest_feeds_rsp paramnewest_feeds_rsp)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = localajxl.a(String.valueOf(localObject3));
    ...
    if ((paramnewest_feeds_rsp != null) && (!paramnewest_feeds_rsp.isEmpty()))
    {
      ...
      while (paramnewest_feeds_rsp.hasNext())
      {
        ...
        localObject2 = localajxl.a(String.valueOf(((feed_info)localObject1).opuin));
        if (localObject2 != null)
        {
          l = ((feed_info)localObject1).time;
          str = avnm.a(((feed_info)localObject1).strcontent, localQQAppInterface);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      paramIntent = avnk.a(paramFromServiceMsg.getWupBuffer());
      if (paramIntent != null)
      {
        b(true, paramIntent);
        return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    byte[] arrayOfByte = new avnk(avnm.a(paramIntent)).encode();
