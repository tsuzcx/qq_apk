...
public class yju
  extends yka<HotRecommendFeedItem>
{
  public yju(@NonNull HotRecommendFeedItem paramHotRecommendFeedItem)
  {
    ...
    if (!this.c.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localStoryVideoItem.mOwnerUid)) {
          localwpy.b(localStoryVideoItem.mOwnerUid);
        }
      }
    }
  }
