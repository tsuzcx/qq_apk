...
{
  private ahkf jdField_a_of_type_Ahkf;
  protected View a;
  ...
  public static ahmv a(BaseActivity paramBaseActivity, ahkf paramahkf)
  {
    Object localObject = ahmt.a().a(a());
    if (localObject != null)
    {
      localObject = ((ahmr)localObject).a();
      if (localObject != null) {
        ((ahmv)localObject).a(paramBaseActivity, paramahkf);
      }
      return localObject;
    }
    return null;
  ...
  private void b(ahmr paramahmr)
  {
    this.jdField_b_of_type_Boolean = paramahmr.a();
    if (this.jdField_b_of_type_Boolean)
    {
      this.jdField_c_of_type_Boolean = this.jdField_a_of_type_Ahkf.a();
  ...
  public View a()
  {
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131372758);
  ...
  protected String a(String paramString)
  {
    ...
    for (String str = bbcl.h(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getCurrentAccountUin());; str = "") {
  ...
  public void a()
  {
    ahmr localahmr = ahmt.a().a(a());
    if (localahmr != null) {
      bhkd.a().b(localahmr.jdField_b_of_type_JavaLangString, null);
    }
  }
  ...
  protected void a(ahmr paramahmr)
  {
    ...
    String str = paramahmr.jdField_a_of_type_JavaLangString;
    ...
    bhkd.a().c(paramahmr.jdField_b_of_type_JavaLangString, null);
  }
  
  public void a(BaseActivity paramBaseActivity, ahkf paramahkf)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Ahkf = paramahkf;
  }
  ...
  public boolean a()
  {
    ...
    localObject = ahmt.a().a((String)localObject);
    if ((localObject == null) || (((ahmr)localObject).jdField_a_of_type_AndroidUtilSparseArray == null) || (((ahmr)localObject).jdField_a_of_type_AndroidUtilSparseArray.size() == 0))
    {
  ...
  public void b()
  {
    ahmr localahmr = ahmt.a().a(a());
    if (localahmr != null) {
      bhkd.a().a(localahmr.jdField_b_of_type_JavaLangString, null);
    }
  }
  ...
  public void c()
  {
    ...
    ahmr localahmr = ahmt.a().a(a());
    if ((localahmr != null) && (localahmr.jdField_a_of_type_AndroidUtilSparseArray != null))
    {
      ahms localahms = (ahms)localahmr.jdField_a_of_type_AndroidUtilSparseArray.get(1);
      if (localahms == null)
      {
      ...
      if ((!TextUtils.isEmpty(localahms.c)) && ((localahmr.jdField_a_of_type_Int == 1) || (localahmr.jdField_a_of_type_Int == 0)))
      {
        ...
        if (localahmr.jdField_a_of_type_Int == 1) {}
        for (boolean bool = true;; bool = false)
        {
          ((URLDrawable.URLDrawableOptions)localObject).mPlayGifImage = bool;
          localObject = URLDrawable.getFileDrawable(localahms.c, (URLDrawable.URLDrawableOptions)localObject);
          if (localObject != null) {
            break;
          }
          QLog.i("QbossADBannerManager", 1, "initQbossADBanner urlDrawable == null  file path = " + localahms.c);
          e();
          return;
        }
        ...
        ((URLDrawable)localObject).setURLDrawableListener(new ahmw(this, localahmr, localahms));
        ThreadManager.executeOnFileThread(new QbossADBannerManager.2(this, (URLDrawable)localObject));
        return;
      }
      QLog.i("QbossADBannerManager", 1, "initQbossADBanner resType is wrong: " + localahmr.jdField_a_of_type_Int + " file path = " + localahms.c);
      e();
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      axqw.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X8009EE2", "0X8009EE2", 11, 0, "", "", "", "");
      return;
      b();
      e();
      ahmt.a().a(a());
      continue;
      ahmr localahmr = ahmt.a().a(a());
      if ((localahmr == null) || (TextUtils.isEmpty(localahmr.jdField_a_of_type_JavaLangString)))
      {
      ...
      a();
      if (QLog.isColorLevel()) {
        QLog.i("QbossADBannerManager", 2, "qboss banner jump url = " + localahmr.jdField_a_of_type_JavaLangString);
      }
      if (localahmr.jdField_b_of_type_Int == 1)
      {
        Object localObject = localahmr.jdField_a_of_type_JavaLangString;
        ...
        for (paramView = paramView + "&qboss_trace=" + localahmr.jdField_b_of_type_JavaLangString;; paramView = paramView + "?qboss_trace=" + localahmr.jdField_b_of_type_JavaLangString)
        {
          paramView = paramView + bhdv.a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), localahmr.jdField_b_of_type_JavaLangString, "&");
          if (QLog.isDevelopLevel()) {
          ...
          try
          {
            ...
            {
              localObject = (ahfz)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(342);
              if (((ahfz)localObject).a(paramView))
              {
                ((ahfz)localObject).a((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getWindow().getDecorView(), false);
                return;
              }
            }
          }
      ...
      if (localahmr.jdField_b_of_type_Int == 2)
      {
        paramView = bbej.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localahmr.jdField_a_of_type_JavaLangString);
        if (paramView != null)
        {
          this.jdField_a_of_type_Boolean = true;
          paramView.c();
        ...
        {
          bhkd.a().a(2741, localahmr.c, 100, "qboss banner jump scheme action = null , url =  " + localahmr.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
