  ...
  implements Handler.Callback
{
  ...
  public birh(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(a().getLooper(), this);
    this.b = paramString;
    this.jdField_a_of_type_Biqh = biqh.a(this.jdField_a_of_type_AndroidContentContext);
    a();
  }
  ...
  {
    birf.a(paramPluginInfo, a(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void a(String paramString)
  {
    birf.a(paramString, a(this.jdField_a_of_type_AndroidContentContext));
  }
      ...
      if (paramPluginInfo.mInstalledPath != null)
      {
        ...
        if (localFile != null)
        {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              if (!birf.a(paramPluginInfo, localFile)) {
                break label137;
              }
              bool1 = true;
  ...
  private static boolean a(File paramFile, QZipFile paramQZipFile, ZipEntry paramZipEntry)
  {
    ...
    //   116: invokestatic 200	bjvj:a	(Ljava/io/OutputStream;)Lbjvj;
    //   119: astore_0
    //   120: aload_0
    //   121: astore 5
    //   123: aload_0
  ...
  private void c(PluginInfo paramPluginInfo, birk parambirk)
  {
    int i = 1;
    String str = paramPluginInfo.mID;
    QLog.d("plugin_tag", 1, "doSetupPlugin." + str);
    if (birf.a(paramPluginInfo, this.jdField_a_of_type_AndroidContentContext))
    {
  ...
  private boolean c(String paramString)
  {
    ...
    {
      return false;
      paramString = new File(this.b).list(new biri(this, paramString));
  ...
  private boolean d(String paramString)
  {
    ...
    if ((localPluginInfo != null) && (birf.a(localPluginInfo, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    boolean bool = birf.a(localFile1);
    File[] arrayOfFile = birf.a(localFile1);
    int i;
    File localFile2;
    Object localObject;
    if (arrayOfFile != null)
  ...
  public void a(PluginInfo paramPluginInfo, birk parambirk)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambirk);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(66816, paramPluginInfo).sendToTarget();
  }
  
  public void a(String paramString, File paramFile, birk parambirk)
  {
    int i = 1;
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramFile);
    if ((PluginUtils.isOsNeedReleaseDex()) && (biqy.a(paramString) > 1)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramFile))
        {
          ...
          boolean bool = Dex2Oat.a(localArrayList, localFile, true, paramFile, new birj(this));
          ...
          azql.a(paramString, i, l2);
          l2 = System.currentTimeMillis();
          if (parambirk != null) {
            parambirk.a(paramString, "pluginOatCost", l2 - l1);
          }
          if (QLog.isColorLevel()) {
  ...
  public boolean a(PluginInfo paramPluginInfo, birk parambirk)
  {
    if (paramPluginInfo == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = a((PluginInfo)localObject);; bool = false)
    {
      ...
      if (!birf.a(paramPluginInfo, (File)localObject))
      {
        if (QLog.isColorLevel()) {
      ...
      bdhb.a((File)localObject, localFile);
      if (!birf.a(paramPluginInfo, localFile))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, birk parambirk)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      if (parambirk != null) {
        parambirk.e(paramString);
      }
      return false;
    }
    if (!this.jdField_a_of_type_Biqh.a(paramString))
    {
      if (QLog.isColorLevel()) {
    ...
    boolean bool = false;
    Object localObject3 = this.jdField_a_of_type_Biqh.a(paramString);
    if (localObject3 == null)
    {
      QLog.d("plugin_tag", 1, "plugin not builtin");
      if (parambirk != null) {
        parambirk.b(false, paramString);
      }
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (parambirk != null) {
        parambirk.b(true, paramString);
      }
      return true;
    }
    if (parambirk != null) {
      parambirk.f(paramString);
    }
    ...
    if (localObject3 != null)
    {
      ...
      try
      {
        ...
        if ((0 == 0) && (bool))
        {
          long l2 = System.currentTimeMillis();
          if (parambirk != null) {
            parambirk.a(paramString, "pluginApkCost", l2 - l1);
          }
          i = 0;
          try
          {
            ...
            l2 = System.currentTimeMillis();
            if (parambirk != null) {
              parambirk.a(paramString, "pluginLibCost", l2 - l1);
            }
            if (localObject3 != null)
            {
      ...
      if (birn.a()) {
        a(paramString, (File)localObject1, parambirk);
      }
  ...
  public void b(PluginInfo paramPluginInfo, birk parambirk)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambirk);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(67072, paramPluginInfo).sendToTarget();
  }
  
  public boolean b(PluginInfo paramPluginInfo, birk parambirk)
  {
    String str = paramPluginInfo.mID;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        a(str, new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), str), parambirk);
        paramPluginInfo.mState = 4;
        paramPluginInfo.mFingerPrint = a();
        a(paramPluginInfo);
        if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 66816: 
      ...
      c((PluginInfo)paramMessage.first, (birk)paramMessage.second);
      return true;
    }
    paramMessage = (Pair)paramMessage.obj;
    b((PluginInfo)paramMessage.first, (birk)paramMessage.second);
    return true;
  }
}
