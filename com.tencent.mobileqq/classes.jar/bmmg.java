  ...
  implements View.OnTouchListener
{
  ...
  public bmmg(bmmf parambmmf)
  {
    this.jdField_a_of_type_Bmmf = parambmmf;
  }
  
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_Bmmf == null) {}
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            this.jdField_a_of_type_Bmmf.a(paramMotionEvent);
            return true;
          }
          this.jdField_b_of_type_AndroidViewMotionEvent = MotionEvent.obtain(paramMotionEvent);
          this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bmmf.a(this.jdField_a_of_type_AndroidViewMotionEvent, this.jdField_b_of_type_AndroidViewMotionEvent);
    ...
    if (!this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Bmmf.onClick(paramView);
    }
