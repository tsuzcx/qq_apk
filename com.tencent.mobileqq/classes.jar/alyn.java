  ...
  extends AsyncTask<RespondQueryQQBindingStat, Void, List<PhoneContact>>
{
  ...
  private alyn(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  protected List<PhoneContact> a(RespondQueryQQBindingStat... paramVarArgs)
  {
    ...
    Collections.sort(paramVarArgs, new alyo(this));
    ArrayList localArrayList = new ArrayList();
    alto localalto = (alto)PhoneContactManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqAppPhoneContactManagerImp).getManager(51);
    ...
    do
    {
      do
      {
        ...
        {
          Collections.sort(localArrayList, new alyp(this));
    ...
    for (;;)
    {
      ...
      break;
      paramVarArgs = localalto.e(localPhoneContact.uin);
      break label201;
      label260:
      localPhoneContact.uin = "0";
      if (localalto.d(localPhoneContact.nationCode + localPhoneContact.mobileCode))
      {
