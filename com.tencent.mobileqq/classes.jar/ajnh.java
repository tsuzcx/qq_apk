...
public class ajnh
{
  ...
  public ajnh(QQAppInterface paramQQAppInterface, ajnk paramajnk)
  {
    ...
    this.jdField_a_of_type_Ajnk = paramajnk;
    this.jdField_a_of_type_Anvi = new ajni(this);
  ...
  private long a()
  {
    long l = this.jdField_a_of_type_Anyb.a(2);
    if (QLog.isColorLevel()) {
  ...
  private void a(ArrayList<MayKnowRecommend> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Anyb.a((List)???, l2, l1, true);
  ...
  private void a(List<MayKnowRecommend> paramList)
  {
    ...
    for (String str = "NULL";; str = paramList.toString())
    {
      ...
      this.jdField_a_of_type_Ajnk.a(paramList);
      return;
    }
  }
  ...
  private boolean a()
  {
    ...
    return this.jdField_a_of_type_Anyb.b(2);
  }
  ...
  private boolean a(Bundle paramBundle)
  {
    ...
    return this.jdField_a_of_type_Anyb.a(2, paramBundle);
  }
  ...
  private boolean a(MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    {
      if (!this.jdField_a_of_type_Anvk.b(paramMayKnowRecommend.uin))
      {
        boolean bool = this.jdField_a_of_type_Anvk.a(paramMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int i = 1;; i = 0)
        {
  ...
  private ArrayList<MayKnowRecommend> c()
  {
    ...
    Collections.sort(localArrayList, new ajnj(this));
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Ajnk.a())
    {
      if (a())
      {
        int i;
