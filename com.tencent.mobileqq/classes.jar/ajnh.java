...
public class ajnh
{
  ...
  public static Map<String, amtj> a;
  ...
  {
    azmj.b(null, "dc00898", "", "", "0X80072C1", "0X80072C1", 0, 0, "", "", "", "");
  }
  ...
  public static void a(int paramInt)
  {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "acQQFilterDownload", true, 0L, 0L, localHashMap, null);
  }
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    azmz.a(BaseApplicationImpl.getApplication()).a(null, "actSetPreviewSizeWay", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(int paramInt, long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    for (String str = "back";; str = "front")
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "cameraStartTimeCost", true, 0L, 0L, localHashMap, null);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      paramString3 = ((amtj)localEntry.getValue()).a();
    ...
    for (;;)
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "dynamic_adjustment_on_destroy", true, paramString1.jdField_a_of_type_ArrayOfLong[((int)(paramString1.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
      a(localHashMap, "DynamicAdjustment", "dynamic_adjustment_on_destroy");
      return;
    }
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, amtk paramamtk)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("camera_type", paramString1);
    ...
    localHashMap.put("is_dynamic", VideoEnvironment.a.d + "");
    if ((paramamtk == null) || (paramamtk.jdField_a_of_type_ArrayOfLong == null) || (paramamtk.jdField_a_of_type_ArrayOfLong.length == 0)) {
      return;
    }
    localHashMap.put("cost_time", paramamtk.jdField_a_of_type_ArrayOfLong[((int)(paramamtk.jdField_a_of_type_ArrayOfLong.length * 0.5F))] + "");
    azmz.a(BaseApplication.getContext()).a(null, "dynamic_adjustment_on_triggering", true, paramamtk.jdField_a_of_type_ArrayOfLong[((int)(paramamtk.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
  ...
  private static void a(String paramString1, String paramString2, HashMap<String, String> paramHashMap)
  {
    ...
    for (paramString1 = new HashMap();; paramString1 = paramHashMap)
    {
      ...
      paramString1.put("DEVICE_TYPE_NAME", anwu.a().a());
      a(paramString1, "open_custom_camera", paramString2);
      azmz.a(BaseApplicationImpl.getApplication()).a(null, paramString2, true, 0L, 0L, paramString1, null);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (String str = "0"; (!bdje.a(paramString1)) || (!anwv.a()); str = "1")
    {
      azmj.b(null, "dc00898", "", "", "0X80072C3", "0X80072C3", 0, 0, str, paramString1, "", "");
      if (paramBoolean) {
        azmj.b(null, "dc00898", "", "", "0X80083B0", "0X80083B0", 0, 0, str, paramString1, "", "");
      }
      if (!bdje.a(paramString2)) {
        azmj.b(null, "dc00898", "", "", "0X80083B6", "0X80083B6", 0, 0, paramString1, "", paramString2, "");
      }
      return;
    }
    azmj.b(null, "dc00898", "", "", "0X80072C2", "0X80072C2", 0, 0, str, "", "", "");
  }
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2, long paramLong)
  {
    ...
    for (paramString1 = "beauty";; paramString1 = "nBeauty")
    {
      ...
      paramString2 = (amtj)jdField_a_of_type_JavaUtilMap.get(localObject);
      paramString1 = paramString2;
      if (paramString2 == null)
      {
        paramString1 = new amtj(2147483647);
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "photo_shot_from_shortvideo", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "actSetPhotoClipSize", paramBoolean, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean2, int paramInt5, boolean paramBoolean3)
  {
    ...
    else
    {
      ...
      localazmz = azmz.a(BaseApplication.getContext());
      if (paramBoolean1) {
        break label319;
      }
    }
    ...
    {
      localazmz.a(null, "actShootPhotoClip", bool, 0L, 0L, localHashMap, "");
      if (QLog.isColorLevel()) {
  ...
  public static void b(int paramInt)
  {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "acQQfilterView", true, 0L, 0L, localHashMap, null);
  }
  ...
  public static void l()
  {
    ...
    while (localIterator.hasNext()) {
      ((amtj)((Map.Entry)localIterator.next()).getValue()).a();
    }
    jdField_a_of_type_JavaLangString = "";
  }
}
