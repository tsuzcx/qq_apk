...
{
  private uve(GivingHeartItemBuilder paramGivingHeartItemBuilder) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          ((CustomFrameAnimationDrawable)localObject1).a(new uvf(this, localHolder, localMessageForPoke));
          ...
          paramView = ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.a.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131363473)).a();
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      localHolder.c.setVisibility(8);
      localHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
      localHolder.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new uvg(this, localHolder, localMessageForPoke));
