  ...
  implements View.OnClickListener
{
  ...
  public thb(tha paramtha, View paramView, BaseData paramBaseData)
  {
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131560224, (ViewGroup)this.jdField_a_of_type_AndroidViewView, false);
  }
  
  private void a(String paramString, tge paramtge, ArticleInfo paramArticleInfo)
  {
    long l1 = paramArticleInfo.mArticleID;
    long l2 = paramtge.jdField_a_of_type_Long;
    olh.a(null, "CliOper", "", pkh.a(), paramString, paramString, 0, 0, String.valueOf(l1), String.valueOf(l2), paramArticleInfo.innerUniqueID, "", false);
  }
    ...
    for (;;)
    {
      ...
      for (d += 1.0D; d >= 11.0D; d += 0.5D)
      {
        ...
        if (i < paramString.length() - 1) {
          str = paramString.substring(0, i + 1) + pjj.jdField_a_of_type_JavaLangString;
        }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalLabelLayout.getChildCount())
    {
      ...
      if (i < j)
      {
        ...
        tge localtge = (tge)paramBaseData1.jdField_a_of_type_JavaUtilList.get(i);
        localView.setTag(localtge);
        ((TextView)localView.findViewById(2131376154)).setText(a(localtge.jdField_a_of_type_JavaLangString));
        if ((!paramBoolean) && (!paramBaseData1.jdField_a_of_type_Boolean))
        {
          a("0X800919F", localtge, paramBaseData2.b);
  ...
  {
    tge localtge = (tge)paramView.getTag();
    if (localtge != null)
    {
      pkh.a(paramView.getContext(), localtge.b);
      a("0X80091A0", localtge, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b);
    }
