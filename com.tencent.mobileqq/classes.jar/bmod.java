  ...
  extends alfw
{
  ...
  public bmod(tAdvDesc paramtAdvDesc)
  {
    super(paramtAdvDesc);
  }
  
  public bmod(TianShuAccess.AdItem paramAdItem)
  {
    super(paramAdItem);
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = new bmof(this, null);
      ((alfx)localObject).a = this.h;
      ((alfx)localObject).b = this.i;
      if (!TextUtils.isEmpty(this.h)) {
        ((alfx)localObject).c = (QzoneZipCacheHelper.getBasePath("qboss_banner", String.valueOf(this.h.hashCode())) + ".zip");
      }
  ...
  public void a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    try
    {
      ...
      paramSharedPreferences = new bmof(this, null);
