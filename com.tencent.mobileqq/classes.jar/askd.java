...
public class askd
  ...
  implements Handler.Callback, bkja
{
  ...
  public askd(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559127, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Asku = new asku(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  public void a(String paramString1, String paramString2, String paramString3, JSONObject paramJSONObject, String paramString4)
  {
    ...
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559133, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aepi.a(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ((ImageView)((View)localObject).findViewById(2131368172)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131379060);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(asnl.a(-16733441, 1593879295));
      ...
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364249);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131378704);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131378850);
      localTextView3.setTextColor(asnl.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new askg(this, paramString1));
      localTextView2.setOnClickListener(new askh(this, paramString4));
      localTextView1.setOnClickListener(new aski(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new askj(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      aahi.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      aahi.a(akwd.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(alud.a(2131710713));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = aepi.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131710697));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131710699));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = aepi.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131710700));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846712);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846712);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(aepi.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, aepi.a(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131710690));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = aepi.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(alud.a(2131710715));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131710707));
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Bkik != null) {
      bkis.b(this.jdField_a_of_type_Bkik);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(alud.a(2131710708));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof asku)) {
        ((asku)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    label27:
      ...
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof askm)) && (!(paramViewHolder instanceof askk))) {
              break;
            }
          ...
          if ((localFeedsItemData.type == 1) || (localFeedsItemData.type == 2) || (localFeedsItemData.type == 3))
          {
            ...
            aahi.a(akwd.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
            return;
          }
        } while (localFeedsItemData.type != 4);
        ((askk)paramViewHolder).a(this, localFeedsItemData, paramInt);
        paramViewHolder = new HashMap();
        aahi.a(paramViewHolder, localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
        ...
        aahi.a(akwd.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
        return;
      } while (!(paramViewHolder instanceof aslv));
      localFeedsItemData = a(paramInt);
    } while (localFeedsItemData == null);
    ((aslv)paramViewHolder).a(localFeedsItemData);
    paramViewHolder = new HashMap();
    aahi.a(paramViewHolder, localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Asku;
      }
      return new aske(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new askf(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(aepi.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aepi.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject3).setId(2131377938);
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      Object localObject4 = new RelativeLayout.LayoutParams(-1, aepi.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(aepi.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setMaxWidth(aepi.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(aepi.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aepi.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams2.addRule(3, 2131377938);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131371323);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.leftMargin = aepi.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131367051);
      ((TextView)localObject4).setBackgroundColor(1270796256);
      ((TextView)localObject4).setPadding(aepi.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, aepi.a(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((CornerImageView)localObject2).setId(2131368053);
      localLayoutParams = new LinearLayout.LayoutParams(0, aepi.a(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, aepi.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131365355);
      ((ImageView)localObject1).setPadding(aepi.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = aepi.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new askk(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return asma.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new askm(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559126, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof askm))
    {
      paramViewHolder = (askm)paramViewHolder;
      if ((paramViewHolder.a != null) && (asmr.a().a() == paramViewHolder.a))
      {
        paramViewHolder.a.i();
        paramViewHolder.a.l();
      }
