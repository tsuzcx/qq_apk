  ...
  implements begy
{
  ...
  private bfav jdField_a_of_type_Bfav = new bfav(this, 5).a(this.jdField_e_of_type_Bfaz);
  private bfaz jdField_a_of_type_Bfaz = new bfaz(this, Integer.valueOf(1));
  ...
  private bfav jdField_b_of_type_Bfav = new bfav(this, 7).a(this.jdField_f_of_type_Bfaz);
  private bfaz jdField_b_of_type_Bfaz = new bfaz(this, Integer.valueOf(2));
  private String jdField_b_of_type_JavaLangString = "appLaunch";
  private bfav jdField_c_of_type_Bfav = new bfav(this, 9).a(this.jdField_g_of_type_Bfaz);
  private bfaz jdField_c_of_type_Bfaz = new bfaz(this, Integer.valueOf(4));
  private bfav jdField_d_of_type_Bfav = new bfav(this, 11).a(this.jdField_h_of_type_Bfaz);
  private bfaz jdField_d_of_type_Bfaz = new bfaz(this, Integer.valueOf(3));
  private bfav jdField_e_of_type_Bfav = new bfav(this, 13).a(this.jdField_i_of_type_Bfaz);
  private bfaz jdField_e_of_type_Bfaz = new bfaz(this, Integer.valueOf(6));
  private bfav jdField_f_of_type_Bfav = new bfav(this, 15).a(this.j);
  private bfaz jdField_f_of_type_Bfaz = new bfaz(this, Integer.valueOf(8));
  private bfav jdField_g_of_type_Bfav = new bfav(this, 17).a(this.k);
  private bfaz jdField_g_of_type_Bfaz = new bfaz(this, Integer.valueOf(10));
  private bfav jdField_h_of_type_Bfav = new bfav(this, 19).a(this.l);
  private bfaz jdField_h_of_type_Bfaz = new bfaz(this, Integer.valueOf(12));
  private bfav jdField_i_of_type_Bfav = new bfav(this, 21).a(this.m);
  private bfaz jdField_i_of_type_Bfaz = new bfaz(this, Integer.valueOf(14));
  private bfaz j = new bfaz(this, Integer.valueOf(16));
  private bfaz k = new bfaz(this, Integer.valueOf(18));
  private bfaz l = new bfaz(this, Integer.valueOf(20));
  private bfaz m = new bfaz(this, Integer.valueOf(22));
  
  public bfbf(begz parambegz, AppBrandPageContainer paramAppBrandPageContainer)
  {
  ...
  private com.tencent.smtt.export.external.interfaces.WebResourceResponse a(com.tencent.smtt.sdk.WebView paramWebView, String paramString)
  {
    ...
    //   18: ifeq +236 -> 254
    //   21: invokestatic 147	bejy:c	()Ljava/lang/String;
    //   24: astore_1
    //   25: aload_1
    //   26: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   29: ifne +532 -> 561
    //   32: aload_0
    //   33: getfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   36: ifnull +11 -> 47
    //   39: aload_0
    //   40: getfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   43: arraylength
    //   44: ifne +13 -> 57
    //   47: aload_0
    //   48: aload_1
    ...
    //   54: putfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   57: new 163	java/io/ByteArrayInputStream
    //   60: dup
    //   61: aload_0
    //   62: getfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   65: iconst_0
    //   66: aload_0
    //   67: getfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   70: arraylength
    ...
    //   112: astore_2
    //   113: aload_0
    //   114: getfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   117: ifnull +47 -> 164
    //   120: aload 5
    //   122: astore_2
    //   123: aload_0
    //   124: getfield 155	bfbf:jdField_a_of_type_ArrayOfByte	[B
    //   127: arraylength
    //   128: istore_3
    //   129: aload 5
    //   131: astore_2
    ...
    //   143: invokestatic 195	besl:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   146: aload_1
    //   147: astore_2
    //   148: aload 5
    //   150: ifnull +10 -> 160
    ...
    //   199: ldc 204
    //   201: aload 6
    //   203: invokestatic 207	besl:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   206: aload_1
    //   207: astore_2
    //   208: aload 5
    //   210: ifnull -50 -> 160
    ...
    //   265: astore_1
    //   266: aload_0
    //   267: getfield 209	bfbf:jdField_a_of_type_Bejy	Lbejy;
    //   270: ifnull -108 -> 162
    //   273: aload_2
    //   274: invokestatic 213	bekr:a	(Ljava/lang/String;)Z
    //   277: ifne +10 -> 287
    //   280: aload_2
    //   281: invokestatic 215	bekr:b	(Ljava/lang/String;)Z
    //   284: ifeq +59 -> 343
    //   287: aload_2
    //   288: ldc 131
    ...
    //   296: astore 5
    //   298: aload_2
    //   299: invokestatic 215	bekr:b	(Ljava/lang/String;)Z
    //   302: istore 4
    //   304: iload 4
    //   306: ifeq +31 -> 337
    //   309: ldc 225
    ...
    //   317: ldc 157
    //   319: aload_0
    //   320: getfield 209	bfbf:jdField_a_of_type_Bejy	Lbejy;
    //   323: aload 5
    //   325: invokevirtual 228	bejy:g	(Ljava/lang/String;)Ljava/lang/String;
    //   328: iload 4
    //   330: invokestatic 231	bekr:a	(Ljava/lang/String;Z)Ljava/io/InputStream;
    ...
    //   392: ldc 157
    //   394: aload_0
    //   395: getfield 209	bfbf:jdField_a_of_type_Bejy	Lbejy;
    //   398: aload 5
    //   400: invokevirtual 228	bejy:g	(Ljava/lang/String;)Ljava/lang/String;
    //   403: invokestatic 242	bekr:a	(Ljava/lang/String;)Ljava/io/ByteArrayInputStream;
    ...
    //   425: ifeq -263 -> 162
    //   428: aload_2
    //   429: invokestatic 213	bekr:a	(Ljava/lang/String;)Z
    //   432: ifne +10 -> 442
    //   435: aload_2
    //   436: invokestatic 215	bekr:b	(Ljava/lang/String;)Z
    //   439: ifeq +46 -> 485
    //   442: aload_2
    //   443: invokestatic 215	bekr:b	(Ljava/lang/String;)Z
    //   446: istore 4
    //   448: iload 4
    //   450: ifeq +29 -> 479
    //   453: ldc 225
    ...
    //   460: aload_1
    //   461: ldc 157
    //   463: invokestatic 251	beiu:a	()Lbeiu;
    //   466: aload_2
    //   467: invokevirtual 253	beiu:a	(Ljava/lang/String;)Ljava/lang/String;
    //   470: iload 4
    //   472: invokestatic 231	bekr:a	(Ljava/lang/String;Z)Ljava/io/InputStream;
    ...
    //   522: aload_1
    //   523: ldc 157
    //   525: invokestatic 251	beiu:a	()Lbeiu;
    //   528: aload_2
    //   529: invokevirtual 253	beiu:a	(Ljava/lang/String;)Ljava/lang/String;
    //   532: invokestatic 242	bekr:a	(Ljava/lang/String;)Ljava/io/ByteArrayInputStream;
  ...
  private void e()
  {
    this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview = new PageWebview(this.jdField_a_of_type_Begz, this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageAppBrandPageContainer);
    this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview.addJavascriptInterface(this, "WeixinJSCore");
    this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview.setWebViewClient(new bfbg(this));
    this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview.setWebChromeClient(new bfbh(this));
  }
  ...
  public String a(bejy parambejy)
  {
    ...
    try
    {
      ...
      parambejy = String.format("if (typeof __qqConfig === 'undefined') var __qqConfig = {};var __tempConfig=%1$s; Object.assign(__qqConfig, __tempConfig); __qqConfig.accountInfo=JSON.parse('%2$s'); __qqConfig.QUA='V1_AND_SQ_8.1.3_0_RDM_B';", new Object[] { parambejy.jdField_b_of_type_JavaLangString, localJSONObject.toString() });
  ...
  public String a(boolean paramBoolean)
  {
    ...
    {
      besl.d("BrandPageWebview", "getJsDefaultConfig failed: " + localException);
    }
    return "";
  }
  ...
  protected void a()
  {
    ...
    a(new bfba(this).a(this.jdField_c_of_type_Bfaz).b(this.jdField_a_of_type_Bfav).a(Integer.valueOf(5)));
    a(new bfba(this).a(this.jdField_e_of_type_Bfaz).b(this.jdField_b_of_type_Bfav).a(Integer.valueOf(6)));
    a(new bfba(this).a(this.jdField_f_of_type_Bfaz).b(this.jdField_c_of_type_Bfav).a(Integer.valueOf(7)));
    a(new bfba(this).a(this.jdField_g_of_type_Bfaz).b(this.jdField_d_of_type_Bfav).a(Integer.valueOf(8)));
    a(new bfba(this).a(this.jdField_h_of_type_Bfaz).b(this.jdField_e_of_type_Bfav).a(Integer.valueOf(9)));
    a(new bfba(this).a(this.jdField_i_of_type_Bfaz).b(this.jdField_f_of_type_Bfav).a(Integer.valueOf(10)));
    a(new bfba(this).a(this.j).b(this.jdField_g_of_type_Bfav).a(Integer.valueOf(11)));
    a(new bfba(this).a(this.k).b(this.jdField_h_of_type_Bfav).a(Integer.valueOf(12)));
    a(new bfba(this).a(this.l).b(this.jdField_i_of_type_Bfav).a(Integer.valueOf(13)));
    a(this.jdField_a_of_type_Bfaz);
  }
  ...
  public void a(bejy parambejy)
  {
    ...
    String str = a(parambejy);
    this.jdField_d_of_type_Bfav.a(str);
    b(Integer.valueOf(8));
    this.jdField_c_of_type_Bfav.a("");
    b(Integer.valueOf(9));
    parambejy = parambejy.d();
    this.jdField_f_of_type_Bfav.a(parambejy);
    b(Integer.valueOf(10));
  }
  
  public void a(bfaz parambfaz)
  {
    if ((parambfaz == this.m) && (this.jdField_a_of_type_Bfbn != null)) {
      this.jdField_a_of_type_Bfbn.b(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview.b());
    }
    bfaz localbfaz = a();
    if (localbfaz == this.jdField_b_of_type_Bfav) {
      beyr.a(this.jdField_a_of_type_Begz.a(), 18, "0");
    }
    for (;;)
    {
      super.a(parambfaz);
      return;
      if (this.jdField_g_of_type_Bfaz == localbfaz) {
        beyr.a(this.jdField_a_of_type_Begz.a(), 19, "0");
      }
    }
  }
  
  public void a(bfbn parambfbn)
  {
    this.jdField_a_of_type_Bfbn = parambfbn;
    if (this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview != null) {
      this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview.setPageEventListener(parambfbn);
    }
  }
  ...
  public void a(String paramString1, ValueCallback paramValueCallback, String paramString2)
  {
    ...
    {
      if (this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview != null) {
        this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePagePageWebview.evaluateJavascript(paramString1, bfdw.a(paramValueCallback));
      }
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    paramString2 = this.jdField_a_of_type_Bejy.a().jdField_b_of_type_JavaLangString;
    this.jdField_g_of_type_Bfav.a(paramString2);
    b(Integer.valueOf(11));
    paramString2 = this.jdField_a_of_type_Bejy.f(paramString1);
    this.jdField_h_of_type_Bfav.a(paramString2);
    b(Integer.valueOf(12));
    paramString1 = this.jdField_a_of_type_Bejy.b(paramString1);
    this.jdField_i_of_type_Bfav.a(paramString1);
    b(Integer.valueOf(13));
    if (this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageAppBrandPageContainer.a() != null) {
      beki.a(new BrandPageWebview.7(this), 1000L);
    }
  }
  ...
  {
    String str = a(true);
    this.jdField_a_of_type_Bfav.a(str);
    b(Integer.valueOf(5));
    MiniAppEnv.g().getBaselibLoader().loadBaselib(this.jdField_a_of_type_Begz.a(), new bfbj(this));
  }
}
