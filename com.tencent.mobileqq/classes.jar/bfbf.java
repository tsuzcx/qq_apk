  ...
  implements bfaz
{
  ...
  private bfbg jdField_a_of_type_Bfbg;
  
  public bfbf(bfba parambfba)
  {
    bfax localbfax = parambfba.a;
    if (localbfax != null) {
      localbfax.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bfba = parambfba;
  }
  
  public void a(bfbg parambfbg)
  {
    this.jdField_a_of_type_Bfbg = parambfbg;
  }
  
  public void a(Object paramObject1, Object paramObject2)
  {
    if (this.jdField_a_of_type_Bfbg == null) {}
    label7:
    do
    {
      do
      {
        do
        {
          ...
          paramObject1 = this.jdField_a_of_type_Bfba.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bfbg.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bfba.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bfax)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bfay)localObject4).encode(localObject1);
        }
        ((bfax)localObject2).send(paramString);
        return;
      }
      try
      {
