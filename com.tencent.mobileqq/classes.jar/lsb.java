  ...
  extends lsc
{
  ...
  public void a(lqt paramlqt, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramlqt.a(3);
        paramlqt.a(this.jdField_a_of_type_Float);
      }
  ...
  public void e()
  {
    ...
    {
      j = mrs.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (int j = 1;; j = 0)
    {
      if (j != 0)
      {
        ...
        this.jdField_a_of_type_JavaLangString = (mrs.a(this.jdField_a_of_type_JavaLangString, 0, i) + "...");
        i = (int)Math.ceil(this.jdField_a_of_type_AndroidTextTextPaint.measureText(this.jdField_a_of_type_JavaLangString));
      }
