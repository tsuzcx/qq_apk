...
public class aqbo
{
  ...
  public WeakReference<aqcj> a;
  public HashSet<String> a;
  
  public aqbo(BaseActivity paramBaseActivity, aqcj paramaqcj)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_JavaUtilHashSet = badd.a(paramBaseActivity);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaqcj);
  }
  ...
  public ArrayList<String> a(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && ((paramBundle instanceof ArrayList)))
    {
      ...
      aqbr localaqbr = new aqbr(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, null);
      int i = 0;
      while (i < paramBundle.size())
      {
        String str = localaqbr.a((Uri)paramBundle.get(i), false);
  ...
  public void a(String paramString)
  {
    ...
    aqcg localaqcg = (aqcg)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
    ...
    paramString = (aqcj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
      localaqcg.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, "android.intent.action.SEND", paramString);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localaqcg = (aqcg)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
      ...
      if ((!TextUtils.isEmpty(paramString1)) && (new File(paramString1).exists()))
      {
        ...
        localVideoInfo.sha1.set(aqbq.a(paramString1));
        localVideoInfo.play_duration.set((int)l);
        localCheckShareExtensionReq.videos.add(localVideoInfo);
      }
      paramString1 = (aqcj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramString1 == null);
    localaqcg.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString2, paramString1);
  }
  ...
  public void a(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            String str = bach.a(apck.d((String)localObject2));
            if (QLog.isColorLevel()) {
              QLog.d("CheckForward.Security", 2, "sendCheckImgShareReq md5= " + str);
            }
            localImgInfo.md5.set(str);
            localImgInfo.sha1.set(aqbq.a((String)localObject2));
            localObject2 = aqbq.a((String)localObject2);
            ...
            localObject1 = aqbq.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (File)localObject1);
      ...
      paramArrayList = (aqcj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramArrayList == null);
    localaqcg.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString, paramArrayList);
  }
  ...
  public boolean a(Uri paramUri, int paramInt, String paramString)
  {
    if (this.jdField_a_of_type_Aqbr == null) {
      this.jdField_a_of_type_Aqbr = new aqbr(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, new aqbp(this, paramInt, paramString));
    }
    String str = this.jdField_a_of_type_Aqbr.a(paramUri);
    if (QLog.isColorLevel()) {
      QLog.d("CheckForward.Security", 2, "prepareFileInfoAndReq : uri= " + paramUri + ", path= " + str);
    }
    if (TextUtils.isEmpty(str)) {}
    do
    {
      ...
      {
        return false;
        if ((this.jdField_a_of_type_Aqbr.b) || (this.jdField_a_of_type_Aqbr.a)) {
          return true;
        }
        paramUri = new File(str);
        l = paramUri.length();
      } while ((!this.jdField_a_of_type_Aqbr.b) && (!this.jdField_a_of_type_Aqbr.a) && (l == 0L));
      if ((!apin.b(str)) && (paramUri.canRead())) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("CheckForward.Security", 2, "prepareFileInfoAndReq : can not Read");
    return false;
    if (paramInt == 2)
    {
