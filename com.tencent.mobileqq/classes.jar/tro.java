  ...
  public tro(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.s = paramString.optInt("normal_mask");
        ...
        this.t = paramString.optInt("is_video_new");
        ...
        if ((localObject != null) && (((JSONArray)localObject).length() > 0))
        {
          ...
          {
            trk localtrk = new trk(((JSONArray)localObject).getJSONObject(i1));
            this.jdField_a_of_type_JavaUtilList.add(localtrk);
            if (!QLog.isColorLevel()) {
              break label618;
            }
            QLog.d("AdvertisementExtInfo", 2, "adPKImageData = " + localtrk.toString());
            break label618;
          }
        }
