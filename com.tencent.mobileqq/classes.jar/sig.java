...
{
  public sig(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435303, 1500);
    this.a.finish();
  }
    ...
    do
    {
      for (;;)
      {
        ...
        if ((1 == paramInt1) && ((this.a.isResume()) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.cGroupOption == 1)))
        {
          ...
          {
          default: 
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131434482, 1500);
          }
          for (;;)
          {
            this.a.b = null;
            return;
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131434481, 1500);
            this.a.finish();
            ...
            if (localObject != null)
            {
              ...
              continue;
              this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131434447, 1500);
            }
          }
        }
        if (this.a.isResume())
