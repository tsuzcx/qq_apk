...
public class avdg
{
  private static volatile avdg jdField_a_of_type_Avdg;
  ...
  {
    if (jdField_a_of_type_Avdg == null) {}
    try
    {
      if (jdField_a_of_type_Avdg == null) {
        jdField_a_of_type_Avdg = new avdg();
      }
      return jdField_a_of_type_Avdg;
    }
    finally {}
  }
  ...
  private void a(long paramLong1, long paramLong2, submsgtype0x122.MsgBody paramMsgBody)
  {
    ...
    try
    {
      paramMsgBody = aqvc.a(new String(paramMsgBody, "utf-8"));
      if (paramMsgBody != null)
      {
        localObject7 = paramMsgBody.a();
        if (((aquu)localObject7).a() != 6) {
          QLog.e("PushDialogHandler", 1, new Object[] { "error note type:", Integer.valueOf(((aquu)localObject7).a()) });
        }
      }
      else
      {
    ...
    catch (UnsupportedEncodingException paramMsgBody)
    {
      do
      {
        ...
        localObject2 = "";
        localObject4 = "";
        localObject7 = ((aquu)localObject7).a();
    ...
    for (;;)
    {
      ...
      {
        localObject8 = (aquu)localIterator1.next();
        localObject9 = ((aquu)localObject8).a();
        localObject7 = ((aquu)localObject8).a();
        if (((aquu)localObject8).a() == 7)
        {
        ...
        else if (((aquu)localObject8).a() == 8)
        {
          ...
          {
            localObject7 = (aquu)((Iterator)localObject9).next();
            localObject10 = ((aquu)localObject7).a();
            if ((((aquu)localObject7).a() == 2) && (localObject10 != null))
            {
    ...
    for (;;)
    {
      ...
      break;
      if ((((aquu)localObject8).a() == 9) && (localObject7 != null))
      {
        ...
        {
          localObject7 = (aquu)localIterator2.next();
          String str2;
          Object localObject11;
          if (((aquu)localObject7).a() == 10)
          {
            localObject7 = ((aquu)localObject7).a();
          ...
          for (;;)
          {
            ...
            abtq.a((Intent)localObject7, PublicTransFragmentActivity.class, RiskHintDlgFragment.class);
            return;
          }
        }
        localObject7 = localObject2;
  ...
  public void a(submsgtype0x122.MsgBody paramMsgBody, MsgInfo paramMsgInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    avde.a().b(this.jdField_a_of_type_Aukp, paramMsgBody);
  }
