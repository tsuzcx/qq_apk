...
@TargetApi(11)
public class aouy
  implements SurfaceTexture.OnFrameAvailableListener, aoty, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnDefinitionInfoListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener
{
  ...
  private aova jdField_a_of_type_Aova;
  private apdt jdField_a_of_type_Apdt;
  private apdu jdField_a_of_type_Apdu = new aouz(this);
  ...
  private apdt jdField_b_of_type_Apdt;
  ...
  public aouy(aoua paramaoua, aova paramaova)
  {
    this.jdField_a_of_type_Aoua = paramaoua;
    this.jdField_a_of_type_Aova = paramaova;
    this.jdField_e_of_type_Int = paramaova.jdField_e_of_type_Int;
    this.jdField_d_of_type_Int = paramaova.jdField_d_of_type_Int;
    this.jdField_a_of_type_Apdw = paramaova.jdField_a_of_type_Apdw;
    this.jdField_a_of_type_JavaLangString = paramaova.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Long = paramaova.jdField_b_of_type_Long;
    boolean bool = aovg.a();
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "Construction mSoftwarePlayConfig:false  isRubbishDevice:" + bool + "  isSoftPlay:" + this.jdField_a_of_type_Aova.jdField_a_of_type_Boolean);
    }
  }
  ...
  {
    if (paramBoolean) {
      if (this.jdField_b_of_type_Apdt == null)
      {
        this.jdField_b_of_type_Apdt = apdv.a(this.jdField_a_of_type_Apdw, 3);
        this.jdField_b_of_type_Apdt.a(aovg.jdField_b_of_type_ArrayOfFloat, aovg.jdField_a_of_type_ArrayOfShort);
        this.jdField_b_of_type_Apdt.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Apdu);
        this.jdField_b_of_type_Apdt.a(this.jdField_a_of_type_Aova.jdField_c_of_type_Int, this.jdField_a_of_type_Aova.jdField_a_of_type_Float, this.jdField_a_of_type_Aova.jdField_b_of_type_Float, this.jdField_a_of_type_Aova.jdField_c_of_type_Float);
      }
    }
    ...
    this.jdField_a_of_type_Apdt.a(this.jdField_a_of_type_Aova.jdField_c_of_type_Int, this.jdField_a_of_type_Aova.jdField_a_of_type_Float, this.jdField_a_of_type_Aova.jdField_b_of_type_Float, this.jdField_a_of_type_Aova.jdField_c_of_type_Float);
  }
  
  public void a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4)
  {
    if ((!this.jdField_e_of_type_Boolean) || (paramArrayOfFloat2 == null) || (this.jdField_a_of_type_Aova == null)) {
      return;
    }
    ...
    label54:
    int m;
    if (this.jdField_a_of_type_Aova.jdField_b_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_Apdt != null)
      {
        ...
        paramArrayOfFloat3 = this.jdField_a_of_type_Apdw;
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Apdt != null)
      {
        paramArrayOfFloat2 = this.jdField_b_of_type_Apdt;
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2) {
      if (this.jdField_a_of_type_Aova.jdField_a_of_type_Aoxu != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Aova.jdField_a_of_type_Aoxu.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Aova.jdField_a_of_type_Aoxu.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Aova.jdField_a_of_type_Aoxu.jdField_c_of_type_Float, this.jdField_a_of_type_Aova.jdField_a_of_type_Aoxu.d, this.jdField_a_of_type_Aova.jdField_a_of_type_Aoxu.e);
      }
    }
    for (;;)
    {
    ...
    if (this.jdField_a_of_type_Aova.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Aova != null) {
      return this.jdField_a_of_type_Aova.jdField_a_of_type_Int;
    }
    return 4;
  }
  ...
  {
    if (this.jdField_a_of_type_Aova != null) {
      return this.jdField_a_of_type_Aova.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Aova.jdField_a_of_type_JavaLangString;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "start, arResourceInfo=" + this.jdField_a_of_type_Aova);
    }
    ...
    this.j = true;
    String str = apex.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
  ...
  public void f()
  {
    ...
    try
    {
      ...
      if (this.jdField_b_of_type_Apdt != null)
      {
        this.jdField_b_of_type_Apdt.b();
        this.jdField_b_of_type_Apdt = null;
      }
      HashMap localHashMap = new HashMap();
      localHashMap.put("decode_type", String.valueOf(this.jdField_f_of_type_Int));
      bctj.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_decode_type", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Aoua != null) {
          this.jdField_a_of_type_Aoua.a(this.jdField_a_of_type_Aova.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void onCompletion(ISuperPlayer paramISuperPlayer)
  {
    ...
    if (this.jdField_a_of_type_Aoua != null) {
      this.jdField_a_of_type_Aoua.b(2, this.jdField_e_of_type_Int - this.jdField_c_of_type_Int);
    }
    ...
    } while (this.jdField_a_of_type_Aoua == null);
    this.jdField_a_of_type_Aoua.a(paramISuperPlayer);
  }
  ...
  public void onVideoPrepared(ISuperPlayer paramISuperPlayer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Aoua != null)
        {
          this.jdField_a_of_type_Aoua.b(0, this.jdField_e_of_type_Int);
          return;
        }
      }
