...
public class apgw
  implements Handler.Callback, apha, aphj
{
  ...
  private volatile apgv jdField_a_of_type_Apgv;
  private volatile apgz jdField_a_of_type_Apgz;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131699681);
    jdField_b_of_type_JavaLangString = anzj.a(2131699682);
    jdField_c_of_type_JavaLangString = anzj.a(2131699677);
    jdField_d_of_type_JavaLangString = anzj.a(2131699678);
    jdField_e_of_type_JavaLangString = anzj.a(2131699680);
    jdField_f_of_type_JavaLangString = anzj.a(2131699684);
    jdField_g_of_type_JavaLangString = anzj.a(2131699679);
    jdField_h_of_type_JavaLangString = anzj.a(2131699683);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Apgv.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      ...
      {
        this.jdField_a_of_type_Apgz.a(0);
        this.jdField_a_of_type_Apgz.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Apgv.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Apgv.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          apgs.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Apgv != null) && (this.jdField_a_of_type_Apgv.a())) {
        this.jdField_a_of_type_Apgv.a(false, true);
      }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Apgv != null)) {
        this.jdField_a_of_type_Apgv.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Apgv == null) || (this.jdField_a_of_type_Apgz == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Apgz.a() != 0) {
            break label145;
          }
          if (!apgs.a(104857600L))
          {
            apgs.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Apgv.a(true, null)) {
            break;
          }
          apgs.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Apgz.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Apgv.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof apgz))
      {
        this.jdField_a_of_type_Apgz = ((apgz)paramObject);
        this.jdField_a_of_type_Apgz.a(this);
        return;
      }
    } while (!(paramObject instanceof apgv));
    this.jdField_a_of_type_Apgv = ((apgv)paramObject);
    this.jdField_a_of_type_Apgv.a(this);
  }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Apgv != null) && (this.jdField_a_of_type_Apgv.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Apgv != null) && (this.jdField_a_of_type_Apgv.b()) && (!this.jdField_a_of_type_Apgv.a());
  }
  ...
  public void d()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) || (!this.jdField_f_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Apgv == null) {
      return;
    }
    this.jdField_a_of_type_Apgv.a(System.currentTimeMillis());
  }
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      for (int i1 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE");; i1 = 0)
      {
        ...
        for (int i2 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE");; i2 = 0)
        {
          ...
          ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new apgx(this), 1, new String[] { "android.permission.RECORD_AUDIO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return true;
          ...
          this.jdField_a_of_type_Apgv.a(false, null);
          return true;
          if (this.jdField_a_of_type_Apgv == null) {
            break;
          }
