...
public class adbb
  implements Runnable
{
  public adbb(ForwardQFavBatchOption paramForwardQFavBatchOption, Bundle paramBundle, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, Intent paramIntent) {}
  ...
  public void run()
  {
    ...
    case 6: 
    case 8: 
      this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon", BaseApplicationImpl.getContext().getString(2131431614));
      this.jdField_a_of_type_AndroidOsBundle.putString("app_name", BaseApplicationImpl.getContext().getString(2131431600));
    ...
    case 2: 
      ...
      ThreadManager.post(new adbc(this, (String)localObject1), 8, null, false);
