  ...
  extends AbstractImageAdapter
{
  ...
  protected void a(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        paramURLDrawable = beqz.a(str);
        if ((paramURLDrawable != null) && (paramURLDrawable.exists())) {
          paramView.setTag(2131296389, Integer.valueOf(bhmq.d(paramURLDrawable.getAbsolutePath())));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    abkm localabkm = (abkm)getItem(paramInt);
    if (localabkm != null)
    {
      localObject = a(localabkm.a(), paramViewGroup);
      if (localObject != null) {
        break label198;
      }
      localObject = (URLDrawable)localabkm.b();
    }
    label198:
    for (;;)
    {
      ...
      if ((localObject != null) && (((URLDrawable)localObject).getStatus() != 1) && (((URLDrawable)localObject).getStatus() != 4) && (((URLDrawable)localObject).getStatus() != 2))
      {
        ...
        paramView.setURLDrawableDownListener(new abko(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
      }
