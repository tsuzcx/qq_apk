...
{
  public aoeg(SearchEmoticonFragment paramSearchEmoticonFragment) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 1)
    {
      ...
      if (SearchEmoticonFragment.a(this.a).d == 1)
      {
        ...
        axqy.b(null, "dc00898", "", "", "0X8009EAF", "0X8009EAF", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (SearchEmoticonFragment.a(this.a).d == 2)
      {
        ...
        axqy.b(null, "dc00898", "", "", "0X8009EB1", "0X8009EB1", 0, 0, "", "", "", "");
        continue;
        if (paramMotionEvent.getAction() == 0)
        {
          this.a.b.setBackgroundColor(Color.parseColor("#DEDEDE"));
          axqy.b(null, "dc00898", "", "", "0X8009EAE", "0X8009EAE", 0, 0, "", "", "", "");
        }
      }
    }
  }
