  ...
  implements bcbk
{
  ...
  public anrb(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private boolean a(bccg parambccg, String paramString)
  {
    if (parambccg == null) {}
    while (parambccg.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.4.1");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)bgln.d() / 1048576);
      ...
      Object localObject4 = bgsh.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (bccg)this.a.getManager(12);
    ...
    if (paramRespItem != null)
    {
      ...
      if (i == 2) {
        try
        {
          ...
          {
            i = (int)bgva.a((byte[])localObject1, 0);
            paramRespItem = new byte[i - 4];
            bgva.a(paramRespItem, 0, (byte[])localObject1, 4, i - 4);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          bgsh.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
