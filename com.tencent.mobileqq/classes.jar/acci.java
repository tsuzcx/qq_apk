...
{
  public acci(AuthDevVerifyCodeActivity paramAuthDevVerifyCodeActivity) {}
  ...
  private void a(int paramInt1, String paramString, int paramInt2, ErrMsg paramErrMsg, DevlockInfo paramDevlockInfo)
  {
    ...
    paramString = this.a.getString(2131717515);
  ...
  public void onVerifyClose(int paramInt1, String paramString, int paramInt2, ErrMsg paramErrMsg)
  {
    ...
    this.a.setResult(-1);
    this.a.finish();
    apwu.a().a((AppRuntime)AuthDevVerifyCodeActivity.a(this.a).get(), this.a, paramString, true);
  }
}
