...
public class biks
  extends bikp
{
  public biks(VipFunCallPreviewActivity paramVipFunCallPreviewActivity) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (TextUtils.isEmpty(paramObject)) {
        localObject3 = anzj.a(2131715526);
      }
      paramObject = localObject3;
      if (!TextUtils.isEmpty((CharSequence)localObject2)) {
        break label607;
      }
      localObject1 = anzj.a(2131715504);
      localObject2 = null;
      paramInt = 11;
      paramObject = localObject3;
    }
    for (;;)
    {
        ...
        if ((i == 22001) || (i == 6002))
        {
          ...
          if (!TextUtils.isEmpty(str))
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject1)) {
              localObject3 = anzj.a(2131715524);
            }
          }
          ...
          if (i == 9003)
          {
            ...
            if (TextUtils.isEmpty(paramObject)) {
              localObject1 = anzj.a(2131715507);
            }
            paramObject = localObject1;
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label607;
            }
            localObject3 = anzj.a(2131715519);
            localObject2 = null;
            paramInt = 12;
            paramObject = localObject1;
          ...
          if ((i == 1005011) || (i == 5002))
          {
            ...
            localObject1 = paramObject;
            if (TextUtils.isEmpty(paramObject)) {
              localObject1 = anzj.a(2131715513);
            }
            paramObject = localObject1;
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label607;
            }
            localObject3 = anzj.a(2131715517);
            localObject2 = null;
            paramInt = 2;
            paramObject = localObject1;
            localObject1 = localObject3;
          ...
          if ((i == 1005012) || (i == 4002))
          {
            ...
            localObject1 = paramObject;
            if (TextUtils.isEmpty(paramObject)) {
              localObject1 = anzj.a(2131715522);
            }
            paramObject = localObject1;
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label607;
            }
            localObject3 = anzj.a(2131715514);
            localObject2 = null;
            paramInt = 1;
            paramObject = localObject1;
            localObject1 = localObject3;
          ...
          if (i == 461001)
          {
            localObject1 = anzj.a(2131715529);
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label601;
            }
          }
      ...
      label601:
      for (paramObject = anzj.a(2131715523);; paramObject = localObject2)
      {
        localObject3 = anzj.a(2131715512);
        str = bhyk.a("funCallMine");
        paramInt = 6;
        ...
        if (i == 3002)
        {
          paramObject = anzj.a(2131715503);
          break label222;
        }
        if (i == 8002)
        {
          paramObject = anzj.a(2131715530);
          break label222;
        }
        break label222;
      }
