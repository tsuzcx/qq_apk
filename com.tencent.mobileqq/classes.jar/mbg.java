...
public class mbg
  extends QIPCModule
{
  public mbg(VideoFeedsIPCServer paramVideoFeedsIPCServer, String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("CMD_SHORTVIDEO_REQUEST_MANUAL_DOWNLOAD".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        VideoFeedsIPCServer.a(this.a, new mbh(this, paramString));
        ...
        do
        {
          for (;;)
          {
            ...
            else
            {
              ...
              {
                VideoFeedsHelper.a((QQAppInterface)localObject, paramBundle.getString("VALUE_PUB_ACCOUNT_UIN"));
              }
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    if ("CMD_CAMERA_CAPTURE_SO_DOWNLOAD".equals(paramString))
                    {
                      ...
                      VideoFeedsIPCServer.a(this.a).a(new mbi(this));
                    ...
                    else
                    {
                      ...
                      {
                        VideoFeedsIPCServer.a(this.a, new mbj(this, (QQAppInterface)localObject));
