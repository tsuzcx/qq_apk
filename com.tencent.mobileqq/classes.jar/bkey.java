...
public class bkey
{
  ...
  private static bkey jdField_a_of_type_Bkey;
  ...
  public static bkey a()
  {
    if (jdField_a_of_type_Bkey == null) {}
    try
    {
      if (jdField_a_of_type_Bkey == null) {
        jdField_a_of_type_Bkey = new bkey();
      }
      return jdField_a_of_type_Bkey;
    }
    finally {}
  }
  ...
  public void a(bkfd parambkfd)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambkfd.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bkez(this, parambkfd));
  }
  ...
  public void b(bkfd parambkfd)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambkfd.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bkfa(this, parambkfd));
  }
}
