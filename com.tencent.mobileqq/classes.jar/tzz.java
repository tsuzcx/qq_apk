  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public boolean onDoubleTap(MotionEvent paramMotionEvent)
  {
    ...
    localObject = (ugn)((StoryPlayerGroupHolder)localObject).b(ugn.class);
    if ((localObject != null) && (((ugn)localObject).d()))
    {
      try
      {
        localObject = (AnimationDrawable)this.a.a().getResources().getDrawable(2130846023);
      ...
      {
        axps.a(paramMotionEvent);
        return false;
      }
      veg.c(this.a.jdField_a_of_type_JavaLangString, "onDoubleTap handle");
    }
    for (;;)
    {
      return super.onDoubleTap(paramMotionEvent);
      veg.c(this.a.jdField_a_of_type_JavaLangString, "onDoubleTap not handle");
    }
  }
  ...
  public boolean onSingleTapConfirmed(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      veg.c(this.a.jdField_a_of_type_JavaLangString, "onSingleTapConfirmed");
      return true;
      paramMotionEvent.a(true, true);
      vel.a("play_video", "clk_video", 0, 0, new String[] { "", "2", "", "" });
      continue;
      paramMotionEvent.a(false, true);
      vel.a("play_video", "clk_video", 0, 0, new String[] { "", "1", "", "" });
    }
  }
}
