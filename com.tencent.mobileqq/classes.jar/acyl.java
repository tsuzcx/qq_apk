...
public class acyl
  ...
  implements acxx
{
  private List<acyk> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new acyj());
      this.jdField_a_of_type_JavaUtilList.add(new acyo());
      this.jdField_a_of_type_JavaUtilList.add(new acyn());
      return;
    }
  ...
  public String b()
  {
    return a().getOldStrategy("0.002;0.000025;1;3600;5|5,30,60;5,0;5,1|5,30,60;5,1|2,200,300,20|2,30,40,20|30;3,10;10,120|3,15;10,300|3,15,10,300|1800|1800||0;0;8;8;5;5;1;0|");
  }
