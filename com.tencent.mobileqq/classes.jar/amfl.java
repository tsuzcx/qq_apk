...
public class amfl
{
  ...
  static int[] b = { 0, 1000, 1004, 1020, 1006, 1001, 1003, 1021, 1022, 10008 };
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((aloz)paramQQAppInterface.getManager(51)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), alpo.a(2131706071), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new aslp(paramString, paramQQAppInterface.c(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      azmj.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (ayvy.a(paramMessageRecord.msgtype)) || (abot.j(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (amfi)paramQQAppInterface.getManager(285);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (amfi)paramQQAppInterface.getManager(285);
      localFriends = localaloz.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (agug.a(paramQQAppInterface).b()) {
      if (((amfi)localObject).a(true))
      {
        if (!((amfi)localObject).c(paramString)) {
          break label227;
        }
        ((amfi)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localaloz.a(paramString, true);
      ...
      return;
      label227:
      ((amfi)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt))) && (!bdal.b(paramString)) && (!bcgx.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        amfi localamfi = (amfi)paramQQAppInterface.getManager(285);
        if (!localamfi.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else if (localamfi.e(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localamfi.a();
            Object localObject2 = localaloz.a(paramString, true);
  ...
  {
    ((amfi)paramQQAppInterface.getManager(285)).h(paramString);
  }
  
  public static boolean d(int paramInt)
  {
    return athk.b(paramInt);
  }
  
  private static void e(QQAppInterface paramQQAppInterface, String paramString)
  {
    ((amfi)paramQQAppInterface.getManager(285)).i(paramString);
  }
}
