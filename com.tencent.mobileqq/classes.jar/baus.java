...
public class baus
{
  ...
  public final Queue<baux> a;
  
  public baus(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", mzk.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bbbd.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public bauy a(Context paramContext)
  {
    bauy localbauy = new bauy(this);
    localbauy.jdField_a_of_type_JavaLangString = (bbct.h() + " " + bbct.d());
    localbauy.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbauy.c = "8.2.8.4440";
    bbcu localbbcu = bbct.a(paramContext);
    localbauy.d = localbbcu.jdField_a_of_type_JavaLangString;
    localbauy.e = localbbcu.c;
    localbauy.jdField_a_of_type_Int = bbct.b();
    localbauy.jdField_a_of_type_Long = bbct.a();
    localbauy.jdField_b_of_type_Long = bbct.d();
    localbauy.f = bbct.g();
    localbauy.jdField_a_of_type_Boolean = a(paramContext);
    localbauy.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbauy.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbauy.jdField_b_of_type_Boolean = bool;
      return localbauy;
    }
  }
  ...
  public String a()
  {
    baur localbaur = bauq.a("getprop net.dns1");
    if (localbaur.jdField_a_of_type_Boolean)
    {
      if (!localbaur.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbaur.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbaur.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 524	bavc:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bauv(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bavc.a(localArrayList, paramContext);
            bavc.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new baut(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 702
    //   14: ldc_w 383
    //   17: invokestatic 705	bcgc:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   79: invokestatic 729	nax:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 733	nax:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 524	bavc:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bavc.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new baux(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bauu(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bavd(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      baux localbaux = (baux)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbaux != null) && (localbaux.jdField_b_of_type_Long == paramLong))
      {
        localbaux = (baux)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbaux != null)
        {
          b(paramContext, localbaux.jdField_a_of_type_JavaLangString, localbaux.jdField_a_of_type_Int, localbaux.jdField_a_of_type_Long, localbaux.jdField_b_of_type_Long, localbaux.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbaux.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bavc.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bauw(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
