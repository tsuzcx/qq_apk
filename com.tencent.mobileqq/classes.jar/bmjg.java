...
public class bmjg
{
  ...
  public bmjg(AppRuntime paramAppRuntime, String paramString1, String paramString2)
  {
    this.c = paramString1;
  ...
  private void d()
  {
    String str1 = atrr.a(auea.a(new String(this.c))).toLowerCase();
    int i = NetworkUtil.getNetworkType(BaseApplicationImpl.getContext());
    File localFile = new File(this.c);
    JSONObject localJSONObject = bmjd.a(this.jdField_a_of_type_MqqAppAppRuntime, localFile.getName(), this.d, str1);
    Object localObject;
    if ((localJSONObject != null) && (localJSONObject.optInt("retcode") == 0))
    {
      ...
      if (localObject == null)
      {
        ...
        bgmd.a("grp_hw", "upload_video", "-1", "", i + "", "");
        if (this.jdField_a_of_type_Bmjf != null) {
          this.jdField_a_of_type_Bmjf.b(2);
        }
      }
    }
    do
      ...
      do
      {
        do
        {
            ...
            do
            {
              for (;;)
              {
                ...
                if (TextUtils.isEmpty(str2))
                {
                  ...
                  bgmd.a("grp_hw", "upload_video", "-2", "", i + "", "");
                  if (this.jdField_a_of_type_Bmjf != null) {
                    this.jdField_a_of_type_Bmjf.b(2);
                  }
                }
                  ...
                  if (!TextUtils.isEmpty((CharSequence)localObject)) {
                    try
                    {
                      ...
                      if ((l != 0L) && (localFile.length() > l))
                      {
                        ...
                        bgmd.a("grp_hw", "upload_video", "-3", "", i + "", "");
                        if (this.jdField_a_of_type_Bmjf == null) {
                          continue;
                        }
                        this.jdField_a_of_type_Bmjf.b(3);
                      }
                    }
              ...
              j = bmjd.a(localJSONObject, this.c, str1);
              if (j != 0) {
                break;
              }
              if (QLog.isColorLevel()) {
              ...
              bgmd.a("grp_hw", "upload_video", "0", "1", i + "", "");
            } while (this.jdField_a_of_type_Bmjf == null);
            this.jdField_a_of_type_Bmjf.a(str2);
            return;
            if (QLog.isColorLevel()) {
              QLog.w("TroopHomeworkHelper", 2, "doPutCOSData failed, putResult =" + j);
            }
            bgmd.a("grp_hw", "upload_video", "-4", "", i + "", "");
          } while (this.jdField_a_of_type_Bmjf == null);
          this.jdField_a_of_type_Bmjf.b(5);
          return;
          ...
          default: 
            ...
            bgmd.a("grp_hw", "upload_video", "-6", "", i + "", "");
          }
        } while (this.jdField_a_of_type_Bmjf == null);
        this.jdField_a_of_type_Bmjf.b(2);
        return;
  ...
  private void e()
  {
    ...
    int i = NetworkUtil.getNetworkType(BaseApplicationImpl.getContext());
    File localFile = new File(this.c);
    Object localObject = bmjd.c(this.c);
    localObject = bmjd.b(this.jdField_a_of_type_MqqAppAppRuntime, localFile.getName(), this.d, (String)localObject);
  ...
  private void f()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 277	bmjg:jdField_a_of_type_Okhttp3OkHttpClient	Lokhttp3/OkHttpClient;
    //   4: ifnonnull +47 -> 51
    //   7: aload_0
    ...
    //   48: putfield 277	bmjg:jdField_a_of_type_Okhttp3OkHttpClient	Lokhttp3/OkHttpClient;
    ...
    //   58: aload_0
    //   59: aload_0
    //   60: getfield 265	bmjg:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   63: ldc_w 310
    //   66: invokevirtual 59	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   69: putfield 312	bmjg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   72: aload_0
    //   73: aload_0
    //   74: getfield 265	bmjg:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   77: ldc 164
    //   79: invokevirtual 59	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   82: putfield 259	bmjg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   85: aload_0
    //   86: getfield 265	bmjg:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   89: ldc_w 314
    //   92: invokevirtual 318	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   95: astore 14
    //   97: aload_0
    //   98: iconst_3
    //   99: putfield 320	bmjg:jdField_a_of_type_Int	I
    //   102: new 322	java/io/RandomAccessFile
    //   105: dup
    //   106: aload_0
    //   107: getfield 27	bmjg:c	Ljava/lang/String;
    //   110: ldc_w 324
    ...
    //   131: astore 12
    //   133: aload_0
    //   134: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   137: lstore 5
    //   139: aload 13
    //   141: astore 12
    //   143: aload_0
    //   144: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   147: lload 9
    //   149: lcmp
    //   150: ifge +705 -> 855
    //   153: aload 13
    //   155: astore 12
    //   157: aload_0
    //   158: getfield 23	bmjg:jdField_a_of_type_Boolean	Z
    //   161: istore 11
    //   163: iload 11
    //   165: ifeq +22 -> 187
    //   168: aload 13
    ...
    //   191: lload 9
    //   193: aload_0
    //   194: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   197: lsub
    //   198: ldc2_w 335
    //   201: lcmp
    //   202: ifle +121 -> 323
    ...
    //   209: aload_0
    //   210: aload_0
    //   211: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   214: ldc2_w 337
    //   217: ladd
    //   218: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   221: aload 13
    //   223: astore 12
    //   225: aload_0
    //   226: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   229: lload 5
    //   231: lsub
    //   232: lstore 7
    //   234: aload 13
    ...
    //   327: aload_0
    //   328: lload 9
    //   330: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   333: goto -112 -> 221
    //   336: astore 14
    //   338: aload 13
    //   340: astore 12
    ...
    //   378: aload_0
    //   379: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   382: ifnull +14 -> 396
    //   385: aload_0
    //   386: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   389: bipush 6
    ...
    //   424: ldc 137
    //   426: invokestatic 155	bgmd:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   429: aload_0
    //   430: lconst_0
    //   431: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   434: aload 12
    //   436: ifnull -258 -> 178
    //   439: aload 12
    ...
    //   515: aload_0
    //   516: getfield 259	bmjg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   539: ldc_w 385
    //   542: aload_0
    //   543: getfield 312	bmjg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   573: l2i
    //   574: aload 14
    //   576: invokespecial 399	bmjg:a	(ILorg/json/JSONArray;)Ljava/lang/String;
    ...
    //   594: astore 12
    //   596: aload_0
    //   597: getfield 277	bmjg:jdField_a_of_type_Okhttp3OkHttpClient	Lokhttp3/OkHttpClient;
    //   600: aload 15
    ...
    //   626: astore 12
    //   628: aload_0
    //   629: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   632: ifnull +97 -> 729
    //   635: aload 13
    //   637: astore 12
    //   639: aload_0
    //   640: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   643: iload_2
    //   644: i2l
    //   645: lload 5
    //   647: ladd
    ...
    //   663: astore 12
    //   665: aload_0
    //   666: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   669: lload 9
    //   671: lcmp
    //   672: iflt +57 -> 729
    //   675: aload 13
    ...
    //   707: ldc 137
    //   709: invokestatic 155	bgmd:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   712: aload 13
    //   714: astore 12
    //   716: aload_0
    //   717: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   720: aload_0
    //   721: getfield 259	bmjg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   724: invokeinterface 216 2 0
    //   729: aload 13
    //   731: astore 12
    //   733: aload_0
    //   734: iconst_3
    //   735: putfield 320	bmjg:jdField_a_of_type_Int	I
    //   738: aload 13
    //   740: astore 12
    //   742: aload_0
    //   743: getfield 33	bmjg:jdField_a_of_type_Long	J
    //   746: lstore 7
    //   748: lload 7
    //   750: lstore 5
    //   752: goto +606 -> 1358
    ...
    //   757: astore 12
    //   759: aload_0
    //   760: getfield 320	bmjg:jdField_a_of_type_Int	I
    //   763: iconst_1
    //   764: isub
    //   765: istore_1
    //   766: aload 13
    ...
    //   770: aload_0
    //   771: iload_1
    //   772: putfield 320	bmjg:jdField_a_of_type_Int	I
    //   775: iload_1
    //   776: ifgt +98 -> 874
    //   779: aload 13
    //   781: astore 12
    ...
    //   811: ldc 137
    //   813: invokestatic 155	bgmd:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   816: aload 13
    //   818: astore 12
    //   820: aload_0
    //   821: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   824: ifnull +534 -> 1358
    //   827: aload 13
    //   829: astore 12
    //   831: aload_0
    //   832: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   835: aload 15
    ...
    //   849: aload_0
    //   850: lload 5
    //   852: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   855: aload 13
    //   857: ifnull -679 -> 178
    //   860: aload 13
    ...
    //   878: aload_0
    //   879: lload 5
    //   881: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   884: goto -745 -> 139
    //   887: astore 15
    //   889: aload 13
    //   891: astore 12
    ...
    //   927: astore 12
    //   929: aload_0
    //   930: getfield 320	bmjg:jdField_a_of_type_Int	I
    //   933: iconst_1
    //   934: isub
    //   935: istore_1
    //   936: aload 13
    ...
    //   940: aload_0
    //   941: iload_1
    //   942: putfield 320	bmjg:jdField_a_of_type_Int	I
    //   945: iload_1
    //   946: ifgt +208 -> 1154
    //   949: aload 13
    //   951: astore 12
    ...
    //   981: ldc 137
    //   983: invokestatic 155	bgmd:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   986: aload 13
    //   988: astore 12
    //   990: aload_0
    //   991: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   994: ifnull +364 -> 1358
    //   997: aload 13
    //   999: astore 12
    //   1001: aload_0
    //   1002: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   1005: bipush 6
    ...
    //   1016: aload_0
    //   1017: lload 5
    //   1019: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   1022: goto -167 -> 855
    //   1025: astore 14
    //   1027: aload 13
    //   1029: astore 12
    ...
    //   1065: astore 12
    //   1067: aload_0
    //   1068: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   1071: ifnull +18 -> 1089
    //   1074: aload 13
    //   1076: astore 12
    //   1078: aload_0
    //   1079: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   1082: bipush 6
    ...
    //   1121: ldc 137
    //   1123: invokestatic 155	bgmd:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1126: aload 13
    //   1128: astore 12
    //   1130: aload_0
    //   1131: lconst_0
    //   1132: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   1135: aload 13
    //   1137: ifnull -959 -> 178
    //   1140: aload 13
    ...
    //   1158: aload_0
    //   1159: lload 5
    //   1161: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   1164: goto -1025 -> 139
    //   1167: astore 14
    //   1169: aload 13
    //   1171: astore 12
    ...
    //   1207: astore 12
    //   1209: aload_0
    //   1210: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   1213: ifnull +18 -> 1231
    //   1216: aload 13
    //   1218: astore 12
    //   1220: aload_0
    //   1221: getfield 157	bmjg:jdField_a_of_type_Bmjf	Lbmjf;
    //   1224: bipush 6
    ...
    //   1263: ldc 137
    //   1265: invokestatic 155	bgmd:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1268: aload 13
    //   1270: astore 12
    //   1272: aload_0
    //   1273: lconst_0
    //   1274: putfield 33	bmjg:jdField_a_of_type_Long	J
    //   1277: aload 13
  ...
  public void a()
  {
    ...
    File localFile = new File(this.c);
    if (((!localFile.exists()) || (localFile.length() == 0L)) && (this.jdField_a_of_type_Bmjf != null))
    {
      this.jdField_a_of_type_Bmjf.b(-1);
      int i = NetworkUtil.getNetworkType(BaseApplicationImpl.getContext());
      bgmd.a("grp_hw", "upload_video", "-13", "", i + "", "");
      return;
    }
  ...
  public void a(bmjf parambmjf)
  {
    this.jdField_a_of_type_Bmjf = parambmjf;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bmjf.a(this.jdField_a_of_type_JavaLangString);
    return;
    f();
    return;
    label167:
