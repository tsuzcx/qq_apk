  ...
  extends sqn<sqv>
{
  ...
  protected List<spy> a(List<spz> paramList)
  {
    ...
    {
      localObject2 = (spz)paramList.next();
      Object localObject3 = ((spz)localObject2).jdField_a_of_type_ComTencentBizQqstoryModelItemAddressItem;
      ...
      {
        ved.a("Q.qqstory.recommendAlbum.logic.AbstractSplitStrategy", "handleSplit pic poi is null picPath=%s", ((spz)localObject2).jdField_a_of_type_JavaLangString);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      {
        localObject2 = new spy(a().a, (List)localObject2);
        ((spy)localObject2).a(this.a);
