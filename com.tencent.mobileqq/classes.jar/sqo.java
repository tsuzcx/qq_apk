...
public class sqo
{
  ...
  public sqo(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setId(2131364588);
  ...
  private void a(VVideoView paramVVideoView, View paramView, int paramInt)
  {
    ...
    b(paramVVideoView, paramView);
    int i = rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0];
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    rdm.a(this.jdField_a_of_type_AndroidViewView, 0, 300);
    rdm.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 300);
    rdm.a(paramView, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt, new int[] { 0, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) }, new int[] { i, j }, 300L, true);
    ...
    j = rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    int k = this.c[1];
    int[] arrayOfInt2 = this.c;
    rdm.a(paramVVideoView, new int[] { 0, paramInt + i }, arrayOfInt1, new int[] { 0, j - k }, arrayOfInt2, 300L, true);
    paramView.addOnLayoutChangeListener(new sqp(this));
  }
  ...
  private void a(VVideoView paramVVideoView, View paramView, boolean paramBoolean)
  {
    ...
    rdm.a(this.jdField_a_of_type_AndroidViewView, 8, 300);
    rdm.a(this.jdField_a_of_type_AndroidViewViewGroup, 8, 300);
    ...
    if (paramBoolean)
    {
      ...
      localObject[0] = 0;
      localObject[1] = rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    }
    for (;;)
    {
      rdm.a(this.jdField_a_of_type_AndroidViewViewGroup, new int[] { 0, rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - this.jdField_a_of_type_AndroidViewViewGroup.getHeight() }, arrayOfInt, (int[])localObject, arrayOfInt, 300L, true);
      ...
      localObject = rdm.a(paramView, new int[] { 0, i }, new int[] { j, k }, (int[])localObject, arrayOfInt, 300L, false);
      ((Animator)localObject).addListener(new sqq(this, paramVVideoView, paramView));
  ...
  private void c()
  {
    ...
    {
      int i;
      if (azkz.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext()))
      {
        i = azkz.d(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    ...
    b();
    this.c = new int[] { rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0], this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height };
  }
  ...
  public void a(View paramView, float paramFloat)
  {
    ...
    {
      int i = (int)(paramView.getHeight() / paramView.getWidth() * rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0]);
      this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = ((int)(rdm.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - i - paramFloat - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)));
  ...
  public void a(VVideoView paramVVideoView, View paramView, ArticleInfo paramArticleInfo, AnchorData paramAnchorData, int paramInt)
  {
    ...
    } while (this.jdField_a_of_type_Sqs == null);
    this.jdField_a_of_type_Sqs.a(true);
  }
  
  public void a(sqs paramsqs)
  {
    this.jdField_a_of_type_Sqs = paramsqs;
  }
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Sqs != null) {
        this.jdField_a_of_type_Sqs.a(false);
      }
    }
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new sqr(this), this.jdField_a_of_type_AndroidViewViewGroup);
