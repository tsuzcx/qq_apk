...
public class abqc
{
  ...
  public static ArrayList<abqc> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    try
    {
      paramString = new JSONArray(abqg.a(paramString));
      int i = 0;
      while (i < paramString.length())
      {
        abpt.b("KingKongSubPatch", "Parsing sub patch " + i);
        abqc localabqc = new abqc();
        if (localabqc.a(paramString.getJSONObject(i)))
        {
          localabqc.a();
          localArrayList.add(localabqc);
          i += 1;
        }
        else
        {
          abpt.a("KingKongSubPatch", "Parse sub patch failed, give up");
          return null;
        }
      }
    ...
    {
      abpt.a("KingKongSubPatch", "Parse SubPatch List exception : " + paramString);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    while (i < this.c.size())
    {
      abpt.b("KingKongSubPatch", "--> HookPoints : " + this.c.get(i));
      i += 1;
    }
    i = 0;
    int j;
    for (;;)
    {
      ...
      abpt.b("KingKongSubPatch", "--> Parameters : " + ((Integer)this.jdField_a_of_type_JavaUtilArrayList.get(i)).toString());
      i += 1;
    }
    while (j < this.b.size())
    {
      abpt.b("KingKongSubPatch", "--> FingerPrint : " + (String)this.b.get(j) + ", " + this.d.get(j));
      j += 1;
    }
  }
  ...
  public boolean a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        abpt.a("KingKongSubPatch", "Fingerprint value count mismatch " + n + ", " + k);
        return false;
      }
      catch (JSONException paramJSONObject)
      {
        ...
        int k;
        int j;
        abpt.a("KingKongSubPatch", "Parse SubPatch error : " + paramJSONObject);
        return false;
      }
