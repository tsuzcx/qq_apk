...
class adbc
  extends ntf
{
  adbc(adbb paramadbb, adbn paramadbn, JSONObject paramJSONObject, adaa paramadaa) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(adbb.a, 2, "onResult appid=" + adbb.a(this.jdField_a_of_type_Adbb).a + ", openid=" + this.jdField_a_of_type_Adbn.a + ", openkey=" + this.jdField_a_of_type_Adbn.b + ", code=" + paramInt + ", req param=" + this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      addh.a(this.jdField_a_of_type_Adaa, paramInt, "getRankingList result error, try again");
      return;
    }
    ...
    if (paramArrayOfByte != null)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.e(adbb.a, 2, localJSONException.getMessage(), localJSONException);
          }
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(adbb.a, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
        }
      }
      QLog.i(adbb.a, 2, "result is, " + paramBundle.toString());
