...
public class xgo
  implements Runnable
{
  public xgo(QWalletSkinHandler paramQWalletSkinHandler, WalletSkinRsp paramWalletSkinRsp, QWalletSkinHandler.SkinListener paramSkinListener) {}
  ...
  public void run()
  {
    ...
    QWalletSkinHandler.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletQWalletSkinHandler, null);
    QWalletSkinHandler.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletQWalletSkinHandler).a(this.jdField_a_of_type_WalletWalletSkinRsp.zipUrl, this.jdField_a_of_type_WalletWalletSkinRsp.zipMd5, new xgp(this, str1), true);
  }
}
