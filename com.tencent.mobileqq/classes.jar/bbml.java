...
public class bbml
{
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidViewView.getWidth() > 0) && (this.jdField_b_of_type_AndroidViewView.getHeight() > 0))
    {
      ...
      if (this.jdField_a_of_type_Bbmn != null) {
        this.jdField_a_of_type_Bbmn.a((Bundle)localObject3);
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bbmn != null) {
        this.jdField_a_of_type_Bbmn.b((Bundle)localObject3);
      }
  ...
  public bbml a(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    return this;
  }
  
  public bbml a(bbmn parambbmn)
  {
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Bbmm != null) {
      bool = this.jdField_a_of_type_Bbmm.a();
    }
    for (;;)
    {
