...
class pny
  extends nkn
{
  pny(pnx parampnx, poa parampoa) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d(pnx.a, 2, "getAtlasFavoriteStatus onResult, errorCode=" + paramInt);
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        if (this.jdField_a_of_type_Poa != null) {
          this.jdField_a_of_type_Poa.a(false, null, false, null);
        }
        QLog.e(pnx.a, 1, "getAtlasFavoriteStatus onResult(), exception=" + paramArrayOfByte.toString());
      }
      boolean bool = false;
      continue;
      label242:
      if (this.jdField_a_of_type_Poa != null) {
        this.jdField_a_of_type_Poa.a(true, paramBundle, bool, localArrayList);
      }
    }
  }
}
