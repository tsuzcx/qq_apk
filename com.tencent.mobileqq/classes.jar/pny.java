  ...
  implements PolymericContainer
{
  ...
  private EventCallback jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerPolymericEventCallback = new pof(this);
  ...
  protected pau a;
  private poh jdField_a_of_type_Poh;
  private poi jdField_a_of_type_Poi;
  private boolean jdField_a_of_type_Boolean = true;
  private List<BaseArticleInfo> jdField_b_of_type_JavaUtilList;
  protected Map<Integer, String> b;
  
  public pny(VafContext paramVafContext)
  {
  ...
  {
    QLog.d(this.jdField_a_of_type_JavaLangString, 1, "addExportItem curPosition: " + paramInt + "  model :" + this.jdField_a_of_type_Pau);
    ...
    if ((this.jdField_a_of_type_Pau != null) && (this.jdField_a_of_type_Pau.a() != null) && (localTemplateBean != null)) {}
    try
    {
      if ((this.jdField_a_of_type_Pau.a().mGroupSubArticleList != null) && (this.jdField_a_of_type_Pau.a().mGroupSubArticleList.size() > paramInt) && (onh.s(this.jdField_a_of_type_Pau.a())) && (this.jdField_a_of_type_Pau.a().mNewPolymericInfo.jdField_a_of_type_Boolean)) {
        a((BaseArticleInfo)this.jdField_a_of_type_Pau.a().mGroupSubArticleList.get(paramInt), paramInt);
      }
      for (;;)
      {
        ...
        {
          return;
          localObject2 = (List)c.get(Long.valueOf(this.jdField_a_of_type_Pau.a().mArticleID));
          localObject1 = localObject2;
          if (localObject2 == null)
          {
            localObject1 = new ArrayList();
            c.put(Long.valueOf(this.jdField_a_of_type_Pau.a().mArticleID), localObject1);
          }
        } while (paramInt < ((List)localObject1).size());
        Object localObject2 = this.jdField_a_of_type_Pau.a().clone();
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Pau.a().getContext();
    ...
    for (int i = 1;; i = 0)
    {
      localObject = new pbf((Context)localObject, localArticleInfo, j, k, i, paramInt, false, a(), null, this.jdField_a_of_type_Pau.a());
      this.jdField_a_of_type_Pau.a().a(paramBaseArticleInfo, (pau)localObject, System.currentTimeMillis(), paramInt);
      return;
    }
  }
  ...
  public void a(pau parampau)
  {
    ...
    } while (this.jdField_a_of_type_Pau.a() == null);
    a(this.jdField_a_of_type_Pau.a().mGroupSubArticleList);
  }
  
  public void a(poh parampoh)
  {
    this.jdField_a_of_type_Poh = parampoh;
  }
  
  public void a(poi parampoi)
  {
    this.jdField_a_of_type_Poi = parampoi;
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    paramInt = a(paramInt);
    Object localObject;
    if ((paramViewHolder instanceof poj))
    {
    ...
    do
    {
      do
      {
        ...
        ViewFactory.findClickableViewListener(((Container)paramViewHolder.itemView).getVirtualView(), new pnz(this, paramInt, (TemplateBean)localObject));
        return;
      } while (!(paramViewHolder instanceof pog));
      paramViewHolder = (pog)paramViewHolder;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (localObject == null)
    {
      ...
      sez.a("error", "", paramViewGroup);
      a(new RecycleViewAdapterHelper.2(this));
      return new pog(this, a());
    }
    ...
    return new poj(this, (Container)localObject, null);
  }
