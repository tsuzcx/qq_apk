  ...
  extends pnq
{
  ...
  private pmn jdField_a_of_type_Pmn = new poc(this);
  private rdc jdField_a_of_type_Rdc = new pob(this);
  private boolean jdField_a_of_type_Boolean;
  
  public pny(@NotNull pnr parampnr, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    super(parampnr, "RIJSkinOperationPopupStep");
  ...
  private void a(GuideData paramGuideData, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      localFrameLayout = (FrameLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131365002);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySkinGuideView = new ReadInJoySkinGuideView(0, this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface, paramGuideData.id, paramString, paramInt, new pnz(this, localFrameLayout, paramInt, localQQAppInterface), new poa(this, localQQAppInterface, paramGuideData, localFrameLayout));
    } while (a() != 0);
  ...
  private void a(oidb_0x5bd.RefreshInfo paramRefreshInfo, int paramInt)
  {
    ...
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    rcx localrcx = (rcx)localQQAppInterface.getManager(270);
    RefreshData localRefreshData;
    if (paramRefreshInfo.has())
    {
      paramRefreshInfo = new RefreshData(paramRefreshInfo);
      localRefreshData = localrcx.a(this.jdField_a_of_type_AndroidAppActivity, paramInt);
      ...
      if (localRefreshData != null)
      {
        bgsg.f(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), null, paramInt);
        bgmg.b(rdv.a());
        localrcx.a(0, "", -1L, paramInt);
      }
    }
    for (;;)
    {
      if (paramRefreshInfo != null)
      {
        ...
        bgsg.f(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), paramRefreshInfo.toJson().toString(), paramInt);
      }
      return;
      ...
      if (((localRefreshData == null) || (!paramRefreshInfo.id.equals(localRefreshData.id)) || (paramRefreshInfo.seq > localRefreshData.seq)) && (i <= paramRefreshInfo.endTime))
      {
        localrcx.a(0, "", -1L, paramInt);
        bgmg.b(rdv.a());
        localrcx.a(paramRefreshInfo, paramInt);
        if (QLog.isColorLevel()) {
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    rcu localrcu = (rcu)localQQAppInterface.getManager(paramInt);
    if (localrcu.a(paramString, paramBaseResData))
    {
      String str = localrcu.b(paramString, paramBaseResData.id);
      if (localrcu.b(paramString, paramBaseResData))
      {
        if (261 == paramInt)
        {
          if (bgsg.g(this.jdField_a_of_type_AndroidAppActivity, paramBaseResData.id) != paramBaseResData.seq)
          {
            bgmg.a(str);
            localrcu.c(paramString, paramBaseResData);
            return false;
          }
          bgsg.t(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), paramBaseResData.id);
          bgsg.C(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin());
        }
  ...
  private boolean a(int paramInt, oidb_0x5bd.SkinInfo paramSkinInfo, oidb_0x5bd.GuideInfo paramGuideInfo)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    boolean bool2 = false;
    RefreshData localRefreshData = ((rcx)localQQAppInterface.getManager(270)).a(this.jdField_a_of_type_AndroidAppActivity, paramInt);
    int i = (int)(System.currentTimeMillis() / 1000L);
    Object localObject;
    boolean bool1;
    if (paramSkinInfo.has())
    {
      ...
      paramGuideInfo = (rdd)localQQAppInterface.getManager(261);
      ...
      bgsg.s(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), null);
      if ((localRefreshData != null) && (i <= localRefreshData.endTime))
      {
        localRefreshData.isShown = true;
        bgsg.f(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), localRefreshData.toJson().toString(), paramInt);
      }
    }
    label258:
    label310:
    ...
    bgsg.s(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), paramSkinInfo.toJson().toString());
  ...
  private boolean a(oidb_0x5bd.GuideInfo paramGuideInfo, int paramInt)
  {
    ...
    rcw localrcw = (rcw)((QQAppInterface)localObject).getManager(271);
    int i;
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySkinGuideView != null)
    {
      ...
      ((FrameLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131365002)).removeView(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySkinGuideView);
  ...
  public void a()
  {
    super.a();
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    localQQAppInterface.addObserver(this.jdField_a_of_type_Rdc);
    localQQAppInterface.addObserver(this.jdField_a_of_type_Pmn);
  }
  ...
  public void b()
  {
    super.b();
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    localQQAppInterface.removeObserver(this.jdField_a_of_type_Rdc);
    localQQAppInterface.removeObserver(this.jdField_a_of_type_Pmn);
  }
