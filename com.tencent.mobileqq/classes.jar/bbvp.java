...
public class bbvp
{
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_h_of_type_JavaLangString = this.jdField_a_of_type_Bbvs.jdField_c_of_type_JavaLangString;
      this.jdField_n_of_type_Int = this.jdField_a_of_type_Bbvs.jdField_a_of_type_Int;
      ...
      this.jdField_i_of_type_JavaLangString = this.jdField_a_of_type_Bbvs.jdField_a_of_type_JavaLangString;
      label100:
      if (!this.jdField_a_of_type_Bbvs.jdField_a_of_type_Boolean) {
        break label824;
      }
      i1 = 1;
      label112:
      this.o = i1;
      if (!this.jdField_a_of_type_Bbvs.jdField_c_of_type_Boolean) {
        break label829;
      }
    }
    label782:
    ...
    {
      this.q = i1;
      this.jdField_m_of_type_Long = this.jdField_a_of_type_Bbvs.jdField_d_of_type_Long;
      ...
      localHashMap.put("param_busiType", bbvr.a(this.jdField_n_of_type_Int));
      ...
      axrl.a(BaseApplication.getContext()).a(null, "actVideoSDKPlay", this.jdField_b_of_type_Boolean, 0L, 0L, localHashMap, "");
      return;
      i1 = 1;
      break;
      if ((this.jdField_a_of_type_Bbvs.jdField_a_of_type_ArrayOfJavaLangString == null) || (this.jdField_a_of_type_Bbvs.jdField_a_of_type_ArrayOfJavaLangString.length <= 0)) {
        break label100;
      }
      this.jdField_i_of_type_JavaLangString = this.jdField_a_of_type_Bbvs.jdField_a_of_type_ArrayOfJavaLangString[0];
      break label100;
      i1 = 0;
      break label112;
    }
