  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public ahdk(QQAppInterface paramQQAppInterface, Context paramContext, ArrayList<String> paramArrayList, int paramInt)
  {
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    //   184: putfield 22	ahdk:jdField_a_of_type_Long	J
    ...
    //   190: astore 8
    //   192: aload_0
    //   193: getfield 33	ahdk:jdField_b_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   208: checkcast 144	ahcr
    //   211: invokevirtual 147	ahcr:a	()Lcom/tencent/mobileqq/data/MessageForShortVideo;
    //   214: astore 7
    //   216: aload 7
    //   218: ifnonnull +8 -> 226
    //   221: iconst_5
    ...
    //   239: aload_0
    //   240: getfield 35	ahdk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   267: aload_0
    //   268: getfield 35	ahdk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   283: aload_0
    //   284: getfield 33	ahdk:jdField_b_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   313: invokestatic 176	bdhb:b	(Ljava/lang/String;)Z
    //   316: ifeq +274 -> 590
    ...
    //   344: aload 7
    //   346: aload_0
    //   347: getfield 188	ahdk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   370: aload 8
    //   372: aload_1
    //   373: invokestatic 205	bdhb:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   376: pop
    ...
    //   434: iconst_0
    //   435: iconst_3
    //   436: invokestatic 222	azdd:a	(II)Lazdx;
    //   439: astore_1
    //   440: aload 7
    //   442: aload_1
    //   443: invokestatic 225	azdd:a	(Ljava/lang/Object;Lazdx;)Lazen;
    //   446: astore 5
    //   448: aload 5
    //   450: iconst_0
    //   451: putfield 230	azen:a	Z
    //   454: aload 5
    //   456: iconst_1
    //   457: putfield 232	azen:d	Z
    //   460: aload 5
    //   462: getfield 235	azen:r	Ljava/lang/String;
    //   465: ifnull +32 -> 497
    //   468: aload 5
    //   470: getfield 235	azen:r	Ljava/lang/String;
    //   473: invokevirtual 238	java/lang/String:length	()I
    //   476: bipush 39
    //   478: if_icmpne +19 -> 497
    //   481: aload 5
    //   483: aload 5
    //   485: getfield 235	azen:r	Ljava/lang/String;
    //   488: iconst_0
    //   489: bipush 28
    //   491: invokevirtual 242	java/lang/String:substring	(II)Ljava/lang/String;
    //   494: putfield 235	azen:r	Ljava/lang/String;
    //   497: aload_1
    //   498: aload 5
    //   500: invokevirtual 247	azdx:a	(Lazen;)V
    //   503: aload_1
    //   504: aload 6
    //   506: invokestatic 250	azdd:a	(Lazdx;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   509: aload_0
    //   510: invokestatic 131	java/lang/System:currentTimeMillis	()J
    //   513: putfield 24	ahdk:jdField_b_of_type_Long	J
    ...
    //   562: aload_0
    //   563: getfield 24	ahdk:jdField_b_of_type_Long	J
    //   566: aload_0
    //   567: getfield 22	ahdk:jdField_a_of_type_Long	J
    //   570: lsub
    //   571: l2d
    //   572: ldc2_w 263
    //   575: ddiv
    ...
    //   589: areturn
    //   590: aload 8
    //   592: invokestatic 176	bdhb:b	(Ljava/lang/String;)Z
    //   595: ifne +24 -> 619
    ...
    //   871: aload_0
    //   872: aload_1
    //   873: putfield 188	ahdk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   876: aload 7
    //   878: lload_2
    //   879: l2i
    ...
    //   888: invokestatic 176	bdhb:b	(Ljava/lang/String;)Z
    //   891: ifeq -558 -> 333
    //   894: aload 7
    ...
    //   924: invokestatic 205	bdhb:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   927: ifne +8 -> 935
    //   930: iconst_3
  ...
  protected void a(Integer paramInteger)
  {
    ...
    ahct.a("bless_event_ptv_result", localProperties);
    ...
    for (;;)
    {
      ...
      return;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131720152, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131720147, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131720117, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131720144, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131720148);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131720145, true);
    }
  }
