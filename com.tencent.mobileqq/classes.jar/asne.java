  ...
  extends alpd
{
  ...
  public asne(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private asmt a(GameUserInfo paramGameUserInfo)
  {
    if (paramGameUserInfo == null) {
      return null;
    }
    asmu localasmu = (asmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
    if (GameUserInfo.isUsrInfoUpdate(localasmu.a(paramGameUserInfo.mRoleId), paramGameUserInfo))
    {
      QLog.i(b, 1, "[notifyGameUsrInfoChanged], roleId:" + paramGameUserInfo.mRoleId);
      return asmt.a(localasmu.a(paramGameUserInfo.mAppId), paramGameUserInfo);
    }
    return null;
  }
      ...
      try
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (paramIntent != null)
          {
            ...
            ((asmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358)).c(paramFromServiceMsg);
          }
        }
      }
  ...
  private void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent = (asmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.app.getApp(), asng.class);
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    try
    {
      ...
      ((WebSSOAgent.UniSsoServerReqComm)localObject1).mqqver.set("8.3.5");
    ...
    paramArrayList = new NewIntent(this.app.getApp(), asng.class);
