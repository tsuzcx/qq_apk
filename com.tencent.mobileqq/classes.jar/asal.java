...
public class asal
{
  ...
  private static LruCache<String, asam> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = RmVFSUtils.getVFSPath(asaa.jdField_a_of_type_JavaLangString + "combo" + File.separator);
    ...
    jdField_b_of_type_JavaLangString = asaa.jdField_a_of_type_JavaLangString;
  ...
  public static asam a()
  {
    return a(jdField_a_of_type_JavaLangString + "dui.png", 2);
  }
  
  public static asam a(int paramInt)
  {
    return a(jdField_a_of_type_JavaLangString + jdField_a_of_type_ArrayOfJavaLangString[paramInt], 2);
  }
  
  public static asam a(String paramString, int paramInt)
  {
    int i = 0;
    Object localObject1 = (asam)jdField_a_of_type_AndroidUtilLruCache.get(paramString);
    ...
    for (;;)
    {
      asam localasam = new asam();
      localasam.jdField_a_of_type_Int = i;
      localasam.b = paramInt;
      localasam.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject2);
      jdField_a_of_type_AndroidUtilLruCache.put(paramString, localasam);
      return localasam;
      i = AIOUtils.dp2px(k / jdField_a_of_type_Float, localasam);
      paramInt = AIOUtils.dp2px(j / jdField_a_of_type_Float, localasam);
      continue;
      paramInt = AIOUtils.dp2px(32.0F, localasam);
      i = (int)(paramInt / j * k);
      continue;
      paramInt = AIOUtils.dp2px(24.0F, localasam);
      i = (int)(paramInt / j * k);
    }
  }
