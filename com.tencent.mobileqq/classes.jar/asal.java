  ...
  extends aryv
{
  ...
  public asal(Intent paramIntent)
  {
    super(paramIntent);
  ...
  protected View a()
  {
    ...
    localFrameLayout.setMinimumHeight(bdoo.a(85.0F));
    int j = bdoo.a(15.0F);
    ...
    localImageView.setMaxWidth(bdoo.a(120.0F));
    localImageView.setMaxHeight(bdoo.a(120.0F));
  ...
  protected void e()
  {
    ...
    for (Object localObject = AIOEmotionFragment.a; localObject == null; localObject = afvg.a) {
      return;
    }
    localObject = ((apxv)localObject).a("fromAIO", false);
    ((URLDrawable)localObject).setBounds(bdhj.a((Drawable)localObject, 36, 100, this.jdField_a_of_type_Float));
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    ((URLDrawable)localObject).setURLDrawableListener(new asam(this));
  }
