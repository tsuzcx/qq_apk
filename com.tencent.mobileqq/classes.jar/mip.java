  ...
  extends min
{
  ...
  private volatile ConcurrentHashMap<Long, mld> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  static
  {
    int[] arrayOfInt = { 2, 2, 1 };
    jdField_a_of_type_Array2dOfInt = new int[][] { { 1 }, { 1, 1 }, { 1, 2 }, { 2, 2 }, arrayOfInt, { 2, 2, 2 }, { 2, 2, 3 }, { 2, 3, 3 }, { 3, 3, 3 }, { 3, 3, 2, 2 }, { 3, 3, 3, 2 }, { 3, 3, 3, 3 }, { 3, 3, 3, 4 }, { 3, 3, 4, 4 }, { 3, 4, 4, 4 }, { 4, 4, 4, 4 } };
  ...
  protected mip(Context paramContext, VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a(ley paramley, mdt[] paramArrayOfmdt, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    paramInt3 = Math.min(paramley.c.size(), paramArrayOfmdt.length);
    label35:
    float f1;
    float f2;
    if (paramInt3 > jdField_a_of_type_Int)
    {
      ...
      if ((paramInt3 >= 2) && (mue.a(1))) {
        ThreadManager.getUIHandler().post(new ScreenLayoutMultipleGrid.1(this));
      }
      paramley = a(paramInt3, paramInt1, paramInt2);
      f1 = mue.a(this.jdField_a_of_type_AndroidContentContext, 12.0F);
      f2 = mue.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      paramInt2 = 0;
      label98:
      if (paramInt2 < paramInt3)
      {
        Object localObject = (Rect)paramley.get(paramInt2);
        if (localObject == null) {
          break label356;
        }
        paramArrayOfmdt[paramInt2].b(((Rect)localObject).left, ((Rect)localObject).top, ((Rect)localObject).right, ((Rect)localObject).bottom);
        paramArrayOfmdt[paramInt2].a(0, 0, 0, 0);
        long l1 = AudioHelper.a(paramArrayOfmdt[paramInt2].b());
        long l2 = paramArrayOfmdt[paramInt2].h();
        if ((TextUtils.isEmpty(paramArrayOfmdt[paramInt2].a())) && (l1 != 0L)) {
          paramArrayOfmdt[paramInt2].b(String.valueOf(l1));
        }
        if (l1 != 0L)
        {
          localObject = (mld)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l1));
          if (localObject != null)
          {
            if (!((mld)localObject).e()) {
              break label320;
            }
            paramInt1 = 1;
            label254:
    ...
    {
      label277:
      paramArrayOfmdt[paramInt2].h(paramInt1);
      if (paramInt3 == 1)
      {
        paramArrayOfmdt[paramInt2].g(false);
        paramArrayOfmdt[paramInt2].a(f2);
      }
      for (;;)
      {
        paramInt2 += 1;
        ...
        if (paramInt3 >= 2)
        {
          paramArrayOfmdt[paramInt2].g(true);
          paramArrayOfmdt[paramInt2].a(f1);
        }
      }
      label356:
      if (!QLog.isDevelopLevel()) {
