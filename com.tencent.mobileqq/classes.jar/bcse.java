  ...
  implements bcsi
{
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = bhki.a((msg_comm.PluginInfo)localObject1);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject1 = BaseApplication.getContext().getString(2131718006);
        ...
        for (;;)
        {
          ...
          for (localObject3 = str1;; localObject3 = null)
          {
            if (localObject3 != null)
            {
              ...
              localObject2 = beyo.a((String)localObject3, j, 1, false, (String)localObject3);
              if (QLog.isColorLevel()) {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                else if (((im_msg_body.Elem)localObject3).custom_face.has())
                {
                  ...
                  localObject6 = bhml.a((byte[])localObject6);
                  localObject4 = bhml.a((byte[])localObject4);
                  localObject5 = bhml.a((byte[])localObject5);
                  if (QLog.isColorLevel()) {
                  ...
                  localObject1 = beyo.a((String)localObject1, 0L, 1, false, (String)localObject1);
                  paramBoolean = true;
                  continue;
                  ...
                  for (;;)
                  {
                    ...
                    do
                    {
                      ...
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)bcry.a(-1000);
                    ...
                    paramMessageHandler.d(String.valueOf(bhki.b(l1)));
                    paramMsg = bhka.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                      QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared: content:" + (String)localObject1 + ",opType:" + paramMsg.b);
                    }
                    localObject2 = bhka.a((String)localObject1, (String)localObject2, l1, paramMsg.a);
                    if (QLog.isColorLevel()) {
                      QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject1 + ",encodeMsg:" + (String)localObject2);
                    }
                    localObject1 = bcry.a(paramMsg.b);
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bcre parambcre)
  {
    ...
    a(paramMessageHandler, paramList, paramMsg, 0L, 0L, parambcre.d);
  }
}
