  ...
  extends beot
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afbm(this);
  protected View a;
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new afbn(this);
  View jdField_b_of_type_AndroidViewView;
  protected List<RecommendTroopItem> b;
  public boolean b;
  private final int jdField_c_of_type_Int = 1;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new afbo(this);
  ...
  public afbk(QQAppInterface paramQQAppInterface, Context paramContext, afaw paramafaw, aexv paramaexv)
  {
    ...
    this.jdField_a_of_type_Afaw = paramafaw;
  ...
  private void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    do
    {
      ...
      azzx.a("Grp_contacts_news", "notice", "recom_exp_grp", 0, 0, new String[] { str1, paramRecommendTroopItem });
  ...
  {
    Object localObject;
    if ((paramView == null) || (!(paramView.getTag() instanceof afbb)))
    {
      ...
      localObject = (Button)paramView.findViewById(2131312046);
  ...
  public void a(ajqt paramajqt)
  {
    ArrayList localArrayList;
    int i;
    Object localObject;
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramajqt != null))
    {
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    localURLDrawableOptions.mRequestWidth = aciy.a(238.0F, (Resources)localObject);
    localURLDrawableOptions.mRequestHeight = aciy.a(161.0F, (Resources)localObject);
    ...
    ((ImageView)paramLinearLayout.findViewById(2131301847)).setImageDrawable((Drawable)localObject);
  }
  ...
  public void b()
  {
    ...
    azzx.a("Grp_contacts_news", "notice", "verify_clk", 3, 0, new String[0]);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface))) {
        paramViewGroup = azwp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, localRecommendTroopItem.uin);
      }
    }
    for (;;)
    {
      ...
      {
        localView = aese.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this.jdField_c_of_type_AndroidViewView$OnClickListener);
      }
      aese.a((aesh)localView.getTag(), localRecommendTroopItem, paramViewGroup);
      a(localRecommendTroopItem);
      return localView;
      if (this.jdField_a_of_type_Azgs != null)
      {
        paramViewGroup = this.jdField_a_of_type_Azgs.a(localRecommendTroopItem.uin, true);
        if (paramViewGroup != null)
        {
          ...
          if (i == 2)
          {
            localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131496965, null);
            paramViewGroup = (TextView)localView.findViewById(2131310009);
            if (this.jdField_g_of_type_Boolean) {
              paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131633824);
            }
            for (;;)
            {
              paramViewGroup.setText(paramView);
              localView.setOnClickListener(new afbl(this));
              paramViewGroup = localView;
              if (this.jdField_c_of_type_Boolean) {
                break;
              }
              azzx.a("Grp_contacts_news", "notice", "verify_exp", 2, 0, new String[0]);
              this.jdField_c_of_type_Boolean = true;
              return localView;
              if (this.jdField_a_of_type_Int > c() - 2) {
                paramView = ajjy.a(2131641847) + this.jdField_a_of_type_Int + ajjy.a(2131641849);
              } else {
                paramView = ajjy.a(2131641846);
              }
            }
          }
          if (i == 4)
          {
            ...
            this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131494818, null);
            this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131305036));
            this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131305022);
            if (paramInt != 0)
            {
          ...
          if (i == 5)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131496966, null);
            ((TextView)paramView.findViewById(2131301859)).setText(ajjy.a(2131641845));
            ((LinearLayout)paramView.findViewById(2131305264)).setVisibility(8);
            return paramView;
          }
          if (i == 6)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131496966, null);
            ((TextView)paramView.findViewById(2131301859)).setText(ajjy.a(2131641844));
            ((LinearLayout)paramView.findViewById(2131305264)).setVisibility(8);
            return paramView;
          }
          if (i == 3)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131496966, null);
            ((TextView)paramView.findViewById(2131301859)).setText(ajjy.a(2131641848));
            paramViewGroup = (LinearLayout)paramView.findViewById(2131305264);
