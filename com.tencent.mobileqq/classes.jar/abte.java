  ...
  implements Cursor
{
  ...
  protected abte(abtg paramabtg, List<MessageRecord> paramList)
  {
    this.jdField_a_of_type_Abtg = paramabtg;
  ...
  private Object a(int paramInt)
  {
    ...
    case 14: 
      return bdgc.a(this.jdField_a_of_type_Abtg.a(), localMessageRecord.senderuin, localMessageRecord.frienduin, 1, 0);
    case 15: 
      if (localMessageRecord.istroop == 3000) {
        return bdgc.d(this.jdField_a_of_type_Abtg.a(), localMessageRecord.senderuin);
      }
      if (localMessageRecord.istroop == 1) {
        return ((TroopManager)this.jdField_a_of_type_Abtg.a().getManager(52)).a(localMessageRecord.senderuin);
      }
      return bdgc.a(this.jdField_a_of_type_Abtg.a(), localMessageRecord.senderuin);
    case 16: 
      return Integer.valueOf(((alto)this.jdField_a_of_type_Abtg.a().getManager(51)).b(localMessageRecord.frienduin));
    case 17: 
