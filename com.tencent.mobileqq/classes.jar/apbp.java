...
public class apbp
{
  ...
  public apbp(int paramInt, String... paramVarArgs)
  {
    try
    {
      this.e = true;
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new apbt(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new apbu(this));
  ...
  public apbp(String paramString1, String paramString2)
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new apbq(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new apbr(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new apbs(this));
