  ...
  extends alar
{
  ...
  akzp(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    bgsw.a().c();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Bgso = new akzy(this);
    bgsw.a().a(this.jdField_a_of_type_Bgso);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new akzz(this);
  ...
  private String a(int paramInt)
  {
    ...
    case 2: 
    default: 
      str = localBaseActivity.getString(2131624672);
      return str;
    case 1: 
      return localBaseActivity.getString(2131624670);
    }
    return localBaseActivity.getString(2131624671);
  }
  ...
  private JSONObject a(WadlResult paramWadlResult, String paramString)
  {
    try
    {
      ...
      localJSONObject1.put("errCode", bcko.b(paramWadlResult.jdField_c_of_type_Int));
  ...
  {
    super.Destruct();
    bgsw.a().b(this.jdField_a_of_type_Bgso);
    this.jdField_a_of_type_Bgso = null;
    this.jdField_a_of_type_Alab = null;
  ...
  {
    if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.DOWNLOAD"))
    {
      QLog.i("ark.download.module", 1, "ArkAppDownloadModule.invokeFunc permission denied");
      paramString = BaseActivity.sTopActivity;
      if (paramString != null) {
        b(paramString.getString(2131624677));
      }
      return false;
    }
    ...
    if (paramString.equals("QueryPackageState"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_Alab = new akzq(this, l);
        if (paramArrayOfVariantWrapper.size() > 0) {
          bgsw.a().a(paramArrayOfVariantWrapper);
        }
        return true;
      }
      return false;
    ...
    if (paramString.equals("QueryPackageStateVia"))
    {
      ...
      {
        paramString = paramArrayOfVariantWrapper[0].GetString();
        this.jdField_a_of_type_Alac = new akzr(this, a(paramArrayOfVariantWrapper[1].Copy()));
    ...
    if (paramString.equals("DownloadInit"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
      {
        ...
        this.jdField_a_of_type_Alaa = new akzs(this);
    ...
    if (paramString.equals("StartDownload"))
    {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        if (paramArrayOfVariantWrapper.jdField_b_of_type_Int == 12) {
          awqx.a(null, "dc00898", "", "", "0X8009E12", "0X8009E12", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
        }
        while (paramString != null)
        {
          ...
          if (d > bgsx.a())
          {
            ...
            if (paramArrayOfVariantWrapper.jdField_b_of_type_Int == 2) {
              awqx.a(null, "dc00898", "", "", "0X8009E11", "0X8009E11", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
            }
          }
          else if ((bool) && (badq.g(paramString)) && (badq.b(paramString) != 1))
          {
            str2 = String.format(paramString.getString(2131624675), new Object[] { bacd.a(d) });
            str3 = paramString.getString(2131624674);
    ...
    if (paramString.equals("PauseDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        bgsw.a().a(i, paramString);
        paramVariantWrapper.SetBool(true);
        awqx.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "1", "", paramString, "");
        return true;
      }
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    if (paramString.equals("ContinueDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        if ((bool) && (paramArrayOfVariantWrapper != null) && (badq.g(paramArrayOfVariantWrapper)) && (badq.b(paramArrayOfVariantWrapper) != 1))
        {
          str2 = paramArrayOfVariantWrapper.getString(2131624668);
          str3 = paramArrayOfVariantWrapper.getString(2131624674);
        ...
        bgsw.a().b(i, paramString);
        this.c = true;
        awqx.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "2", "", paramString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
    ...
    if (paramString.equals("InstallPackage"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        bgsw.a().b(paramString);
        awqx.a(null, "dc00898", "", "", "0X8009E16", "0X8009E16", 0, 0, "", "", paramString.jdField_a_of_type_JavaLangString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
