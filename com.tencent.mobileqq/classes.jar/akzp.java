...
public class akzp
  extends alpd
{
  public akzp(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<akyx> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        akyx localakyx = (akyx)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localakyx.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localakyx.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localakyx.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), akzq.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("qq_version", "8.3.5.4555");
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), akzq.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), akzq.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), akzq.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = akwd.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      localUniSsoServerReqComm.mqqver.set("8.3.5.4555");
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), akzq.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    Object localObject1 = akwd.a(i);
    if (localObject1 == null) {}
    do
    {
      return;
      localObject1 = ((akyg)localObject1).a();
    ...
    try
    {
      ...
      {
        ((akzg)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((akzg)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new akzf();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((akzf)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((akzf)localObject2).jdField_b_of_type_Boolean = bool;
      ((akzf)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((akzf)localObject2).jdField_b_of_type_Int = i;
      ((akzf)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((akzf)localObject2).c = paramArrayOfByte.md5.get();
      ((akzf)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((akzf)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((akzf)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((akzf)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((akzf)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((akzf)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((akzf)localObject2).jdField_d_of_type_Int = 1;
      ((akzg)localObject1).a((akzf)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localakyp == null) || (localakyp.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new akup(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localakyp.a().updateUserInfo((akup)localObject1);
            if (j == akxp.jdField_a_of_type_Int) {
              localakyp.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == akxp.jdField_b_of_type_Int) {
              localakyp.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localakyp.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localakyp.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == akxp.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localakyp.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == akxp.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localakyp.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localakyp.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localakyp.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == akxp.c)
        {
          localakyp.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localakyp.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localakyp.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = akwd.a(localJSONObject1.optInt("gameId"));
    ...
    localakyp.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
