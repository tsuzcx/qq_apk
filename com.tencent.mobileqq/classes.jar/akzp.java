  ...
  implements akzn
{
  ...
  private akzo jdField_a_of_type_Akzo;
  ...
  private final String jdField_a_of_type_JavaLangString = ajya.a(2131700763);
  ...
  public akzp(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqArARRecordARVideoRecordButtonView = ((ARVideoRecordButtonView)paramView.findViewById(2131369653));
    this.c = paramView.findViewById(2131363900);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362721);
    this.jdField_a_of_type_Boolean = akzg.a();
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    }
    this.c.setOnClickListener(null);
    this.c.setOnTouchListener(new akzq(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362723));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362722));
  ...
  public void a(akzo paramakzo)
  {
    this.jdField_a_of_type_Akzo = paramakzo;
  }
