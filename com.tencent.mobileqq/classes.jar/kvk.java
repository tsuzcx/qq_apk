...
public class kvk
  extends Handler
{
  public kvk(PublicAccountAdvertisementActivity paramPublicAccountAdvertisementActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            default: 
              ...
              return;
            case -24: 
              this.a.b(this.a.getString(2131438989));
              return;
            }
            this.a.a(2131438986);
            return;
            this.a.b(this.a.getString(2131438990));
            return;
          } while (PublicAccountAdvertisementActivity.a(this.a) == null);
        ...
        paramMessage.add(2131365603, PublicAccountAdvertisementActivity.a(this.a));
        paramMessage.commit();
      } while (!ThemeUtil.isInNightMode(this.a.getAppRuntime()));
      paramMessage = this.a.findViewById(2131366981);
