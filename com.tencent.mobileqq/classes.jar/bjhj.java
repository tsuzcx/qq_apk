  ...
  extends GPUBaseFilter
{
  ...
  private bjha jdField_a_of_type_Bjha;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Bjha != null) || (this.b != null);
  }
  
  public void destroy()
  {
    if (this.jdField_a_of_type_Bjha != null) {
      this.jdField_a_of_type_Bjha.destroy();
    }
    if (this.b != null) {
      this.b.destroy();
    }
  ...
  public void drawTexture(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    if (!a())
    {
      urk.e("Q.qqstory.publish.edit GpuImagePartsFilterGroup", "must set filters before draw texture");
      return;
    }
    if (this.jdField_a_of_type_Bjha != null) {
      this.jdField_a_of_type_Bjha.drawTexture(paramInt, paramArrayOfFloat1, paramArrayOfFloat2);
    }
  ...
  public void init()
  {
    if ((this.jdField_a_of_type_Bjha != null) && (!this.jdField_a_of_type_Bjha.isInitialized())) {
      this.jdField_a_of_type_Bjha.init();
    }
  ...
  {
    if (this.jdField_a_of_type_Bjha != null) {
      this.jdField_a_of_type_Bjha.onOutputSizeChanged(paramInt1, paramInt2);
    }
    if (this.b != null) {
