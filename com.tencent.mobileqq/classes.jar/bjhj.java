...
public class bjhj
{
  ...
  public static int a()
  {
    Object localObject = DeviceInfoUtil.getQQVersionWithCode(MobileQQ.sMobileQQ);
    try
    {
  ...
  public static String b(int paramInt)
  {
    ...
    try
    {
      return bjms.a("641d5d");
    }
    catch (Exception localException) {}
    if (paramInt == 2) {
      return bjms.c("641d5d");
    }
    if (paramInt == 3)
    {
      String str = bjms.b("641d5d");
      return str;
    }
    return null;
  }
