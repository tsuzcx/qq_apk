...
{
  public aebo(TroopMemberListActivity paramTroopMemberListActivity) {}
            ...
            do
            {
              ...
              do
              {
                do
                {
                  ...
                  {
                    if (this.a.jdField_a_of_type_Aecg.jdField_b_of_type_JavaUtilList.contains(str)) {
                      this.a.jdField_a_of_type_Aecg.jdField_b_of_type_JavaUtilList.remove(str);
                    }
                    for (;;)
                    {
                      TroopMemberListActivity.a(this.a);
                      this.a.jdField_a_of_type_Aecg.notifyDataSetChanged();
                      return;
                      if (i != 0) {
                        this.a.jdField_a_of_type_Aecg.jdField_b_of_type_JavaUtilList.add(str);
                      }
                    }
                  }
                  if (!bool1) {
