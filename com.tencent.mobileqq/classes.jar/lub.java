  ...
  implements lgt
{
  ...
  public lpf a()
  {
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {}
      localObject2 = new lpf((short)5, (short)localObject2.length, (byte[])localObject2);
      return localObject2;
      label412:
      i -= 1;
    }
  ...
  public void a(String paramString, lpf paramlpf)
  {
    boolean bool;
    if ((!QLog.isColorLevel()) || (paramlpf != null))
    {
      try
      {
        if (paramlpf.a() == null) {
      ...
      try
      {
        localFrameSyncInfo.mergeFrom(paramlpf.a());
        paramlpf = ltz.a(this.a, localFrameSyncInfo);
        paramString = paramlpf;
        bool = true;
      }
      catch (Exception paramlpf)
      {
        bool = false;
        break label78;
      }
