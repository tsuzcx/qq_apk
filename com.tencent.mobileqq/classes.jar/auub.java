  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject4 = (bizg)bizh.a().a("comminfo");
        if (localObject4 == null) {
          break label593;
        }
        paramString2 = ((bizg)localObject4).a(paramString1);
        if (QLog.isColorLevel()) {
          QLog.d("GameCenterInterruptPlugin", 1, "handleSchemaRequest url=" + paramString1 + " apkInfo=" + paramString2);
        }
        if ((paramString2 == null) || (bgnw.a(BaseApplication.getContext(), paramString2.c)))
        {
          localObject3 = bizs.a();
          paramString2 = null;
        }
      ...
      ((bizs)localObject3).g = paramString1;
      ((bizs)localObject3).h = paramString2;
      bmxq.a().a("205925", "20", (bizs)localObject3, "dc05076");
      return false;
      ...
      if (this.mRuntime != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          localPair = aceh.a((Intent)localObject3);
          ...
          if (TextUtils.isEmpty((CharSequence)localObject3))
          {
            ...
            auuc.a(paramString1, paramString2.a, false, 0);
            if (localObject4 != null)
            {
              paramString1 = ((bizg)localObject4).c;
              ...
              aceh.a(null, "558", "205758", paramString2.a, "55801", "4", "430", new String[] { String.valueOf(localPair.first), (String)localPair.second, paramString2.d, paramString2.e, localObject3 });
              return true;
            }
