...
public class apje
  extends aphp
{
  public apje(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  protected void a(bafb parambafb)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwwardMapOption", 2, "updateImageView:setDefaultDialogPreviewImage");
    }
    a(apjy.a(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130839328), this.jdField_a_of_type_Float), false, 0);
  }
