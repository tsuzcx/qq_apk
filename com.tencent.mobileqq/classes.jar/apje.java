...
{
  apje(apiz paramapiz, apjf paramapjf) {}
  ...
  public void onCallBackAction(Integer paramInteger, Object paramObject1, Object paramObject2)
  {
    ...
    if (paramInteger.intValue() == 5012)
    {
      ...
      if (this.jdField_a_of_type_Apjf != null) {
        this.jdField_a_of_type_Apjf.b(true);
      }
    }
    label129:
    do
    ...
    } while (this.jdField_a_of_type_Apjf == null);
    this.jdField_a_of_type_Apjf.b(false);
  }
}
