...
{
  txs(AppInterface paramAppInterface, List paramList, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3, String paramString6, String paramString7, String paramString8) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, android.os.Bundle paramBundle)
  {
    ...
    //   124: lstore 5
    //   126: aload_0
    //   127: getfield 22	txs:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   130: bipush 101
    //   132: invokevirtual 127	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   135: checkcast 129	txq
    //   138: invokevirtual 131	txq:a	()V
    ...
    //   324: athrow
    //   325: aload_0
    //   326: getfield 22	txs:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   329: bipush 101
    //   331: invokevirtual 127	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   334: checkcast 129	txq
    //   337: astore_3
    ...
    //   345: astore 9
    //   347: aload_0
    //   348: getfield 24	txs:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   363: aload 9
    //   365: aload_0
    //   366: getfield 24	txs:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   369: iconst_0
    ...
    //   398: aload 9
    //   400: aload_0
    //   401: getfield 24	txs:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   404: iload_1
    ...
    //   428: dup
    //   429: aload_0
    //   430: getfield 26	txs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   433: aload_0
    //   434: getfield 28	txs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   437: aload_0
    //   438: getfield 30	txs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   441: aload_0
    //   442: getfield 32	txs:d	Ljava/lang/String;
    //   445: aload_0
    //   446: getfield 34	txs:e	Ljava/lang/String;
    //   449: aload_0
    //   450: getfield 36	txs:jdField_a_of_type_Int	I
    //   453: aload_0
    //   454: getfield 38	txs:jdField_b_of_type_Int	I
    //   457: aload_0
    //   458: getfield 40	txs:jdField_c_of_type_Int	I
    //   461: aload_0
    //   462: getfield 42	txs:f	Ljava/lang/String;
    //   465: aload_0
    //   466: getfield 44	txs:g	Ljava/lang/String;
    //   469: aload_0
    //   470: getfield 46	txs:h	Ljava/lang/String;
    //   473: aload 9
    ...
    //   481: invokevirtual 159	txq:a	(Lcom/tencent/biz/pubaccount/util/PAReportInfo;)V
    //   484: return
    //   485: astore_3
    //   486: goto -198 -> 288
    //   489: astore_3
