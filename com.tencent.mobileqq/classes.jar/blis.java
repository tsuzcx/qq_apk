...
public class blis
{
  ...
  private bliv jdField_a_of_type_Bliv;
  private bliw jdField_a_of_type_Bliw;
  private blix jdField_a_of_type_Blix;
  private bliy jdField_a_of_type_Bliy;
  ...
  public blis(int paramInt, float paramFloat)
  {
    a();
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    label148:
    label184:
    while ((!this.jdField_e_of_type_Boolean) || (!this.f) || (this.jdField_a_of_type_Blix == null))
    {
      return;
      this.jdField_c_of_type_Int = i;
      this.f = true;
      if (this.jdField_a_of_type_Blix != null)
      {
        TraceCompat.beginSection("onPagerChanged");
        this.jdField_a_of_type_Blix.a(localViewHolder);
    ...
    this.jdField_a_of_type_Blix.b(paramView);
    TraceCompat.endSection();
  }
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bliy = new bliy(this, null);
    this.jdField_a_of_type_Bliv = new bliv(this, null);
    this.jdField_a_of_type_Bliw = new bliw(this, null);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnTouchListener(this.jdField_a_of_type_Bliy);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnScrollListener(this.jdField_a_of_type_Bliy);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnFlingListener(this.jdField_a_of_type_Bliy);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bliv);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bliw);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getAdapter().registerAdapterDataObserver(new blit(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.removeOnScrollListener(this.jdField_a_of_type_Bliy);
  ...
  {
    return new bliu(this, this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getContext(), paramLinearLayoutManager);
  }
  ...
  public void a(blix paramblix)
  {
    this.jdField_a_of_type_Blix = paramblix;
  }
