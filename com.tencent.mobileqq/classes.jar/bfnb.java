...
public class bfnb
{
  ...
  {
    bflp.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bflp.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bflp.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      paramString1 = bfms.a(paramContext);
      ...
      bflp.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bfmk(str2, str3, new bfnc(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bflp.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bfbm.a().g());
    localBundle.putString("keystr", bfbm.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bfmw.e());
    localBundle.putString("keytype", "256");
    if (bfms.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bflp.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bfmk parambfmk, Bundle paramBundle)
  {
