...
public class qhl
{
  ...
  private static volatile qhl jdField_a_of_type_Qhl;
  public static int b;
  ...
  public static qhl a()
  {
    if (jdField_a_of_type_Qhl == null) {}
    try
    {
      if (jdField_a_of_type_Qhl == null) {
        jdField_a_of_type_Qhl = new qhl();
      }
      return jdField_a_of_type_Qhl;
    }
    finally {}
  }
  ...
  private void a(AbsListView paramAbsListView, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (qhm)this.jdField_a_of_type_JavaUtilList.get(((Integer)this.jdField_b_of_type_JavaUtilHashMap.get(str)).intValue());
      l3 = ((qhm)localObject1).jdField_b_of_type_Long;
      if (i1 <= 0) {
        break label521;
      }
    }
    ...
    {
      ((qhm)localObject1).jdField_b_of_type_Long = (l2 + l3);
      localObject2 = a(localView);
      if ((localObject2 != null) && (localObject2[1] - localObject2[0] >= localView.getHeight() * jdField_a_of_type_Double)) {
        ((qhm)localObject1).jdField_c_of_type_Long += l1;
      }
      ((qhm)localObject1).jdField_c_of_type_Boolean = this.jdField_a_of_type_JavaUtilHashMap.containsKey(str);
      if (!paramBoolean) {
        break;
      }
      ((qhm)localObject1).jdField_b_of_type_Boolean = true;
      break;
      localObject1 = new qhm(this);
      ((qhm)localObject1).jdField_a_of_type_JavaLangString = str;
      ((qhm)localObject1).jdField_a_of_type_Int = ors.a((BaseArticleInfo)localObject2);
      int m;
      label305:
      boolean bool;
      ...
      {
        m = 0;
        ((qhm)localObject1).jdField_b_of_type_Int = m;
        if (this.jdField_g_of_type_Long != -1L) {
          break label504;
        }
        bool = true;
        label326:
        ((qhm)localObject1).jdField_a_of_type_Boolean = bool;
        ((qhm)localObject1).jdField_c_of_type_Int = localView.getHeight();
        ((qhm)localObject1).jdField_b_of_type_JavaLangString = ((BaseArticleInfo)localObject2).mRecommentdReason;
        m = this.j;
        this.j = (m + 1);
        ((qhm)localObject1).jdField_d_of_type_Int = m;
        localObject2 = osc.a().a();
      ...
      label504:
      label510:
      for (((qhm)localObject1).jdField_c_of_type_JavaLangString = (localObject2[0] + "_" + localObject2[1] + "_" + localObject2[2] + "_" + localObject2[3]);; ((qhm)localObject1).jdField_c_of_type_JavaLangString = "NULL")
      {
  ...
  public long a()
  {
    if (this.jdField_a_of_type_Qhp.jdField_a_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_a_of_type_Qhp.jdField_a_of_type_Long - this.jdField_a_of_type_Long;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_d_of_type_Long != 0L) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      qhm localqhm = (qhm)this.jdField_a_of_type_JavaUtilList.get(k);
      localqhm.jdField_a_of_type_Long = (l + localqhm.jdField_a_of_type_Long);
  ...
  public long b()
  {
    if (this.jdField_a_of_type_Qhp.jdField_b_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_c_of_type_Long - this.jdField_a_of_type_Qhp.jdField_b_of_type_Long;
  }
  ...
  public void c()
  {
    ...
    new phg(null, null, null, puz.a(), null).a(this, BaseApplication.getContext());
    e();
    this.jdField_a_of_type_MqqUtilWeakReference = null;
    jdField_a_of_type_Qhl = null;
  }
