...
{
  public int a;
  private afjj jdField_a_of_type_Afjj;
  protected afmk a;
  private Context jdField_a_of_type_AndroidContentContext;
  private LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afna(this);
  protected View a;
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new afnb(this);
  View jdField_b_of_type_AndroidViewView;
  protected List<RecommendTroopItem> b;
  public boolean b;
  private final int jdField_c_of_type_Int = 1;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new afnc(this);
  ...
  public afmy(QQAppInterface paramQQAppInterface, Context paramContext, afmk paramafmk, afjj paramafjj)
  {
    ...
    this.jdField_a_of_type_Afjj = paramafjj;
  }
  ...
  private void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    do
    {
      ...
      bbbp.a("Grp_contacts_news", "notice", "recom_exp_grp", 0, 0, new String[] { str1, paramRecommendTroopItem });
  ...
  {
    Object localObject;
    if ((paramView == null) || (!(paramView.getTag() instanceof afmp)))
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559705, paramViewGroup, false);
      paramViewGroup = new afmp();
      paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131372553));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131372543));
      paramViewGroup.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131372550));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131372557));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372548));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372554));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372556));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131372549));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131372552));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131377874));
      localObject = (Button)paramView.findViewById(2131377873);
      paramView.setTag(paramViewGroup);
      paramViewGroup.jdField_b_of_type_Int = paramInt;
      if (paramInt >= this.jdField_a_of_type_Int) {
        break label234;
      }
      afjt.a(paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout, true);
      label201:
    ...
    {
      return paramView;
      paramViewGroup = (afmp)paramView.getTag();
      break;
      label234:
      afjt.a(paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout, false);
      break label201;
      label245:
      ...
      {
        this.jdField_a_of_type_Afjj.a(paramViewGroup, paramInt);
        return paramView;
      }
    }
  }
  ...
  public void a(akfc paramakfc)
  {
    ...
    int i;
    Object localObject;
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramakfc != null))
    {
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    localURLDrawableOptions.mRequestWidth = actj.a(238.0F, (Resources)localObject);
    localURLDrawableOptions.mRequestHeight = actj.a(161.0F, (Resources)localObject);
  ...
  public void b()
  {
    ...
    bbbp.a("Grp_contacts_news", "notice", "verify_clk", 3, 0, new String[0]);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface))) {
        paramViewGroup = bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, localRecommendTroopItem.uin);
      }
    }
    for (;;)
    {
      ...
      {
        localView = afcy.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this.jdField_c_of_type_AndroidViewView$OnClickListener);
      }
      afcy.a((afdb)localView.getTag(), localRecommendTroopItem, paramViewGroup);
      a(localRecommendTroopItem);
      return localView;
      if (this.jdField_a_of_type_Baij != null)
      {
        paramViewGroup = this.jdField_a_of_type_Baij.a(localRecommendTroopItem.uin, true);
        if (paramViewGroup != null)
        {
          ...
          if (i == 2)
          {
            localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562564, null);
            paramViewGroup = (TextView)localView.findViewById(2131375775);
            if (this.jdField_g_of_type_Boolean) {
              paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131699622);
            }
            for (;;)
            {
              paramViewGroup.setText(paramView);
              localView.setOnClickListener(new afmz(this));
              paramViewGroup = localView;
              if (this.jdField_c_of_type_Boolean) {
                break;
              }
              bbbp.a("Grp_contacts_news", "notice", "verify_exp", 2, 0, new String[0]);
              this.jdField_c_of_type_Boolean = true;
              return localView;
              if (this.jdField_a_of_type_Int > c() - 2) {
                paramView = ajya.a(2131707643) + this.jdField_a_of_type_Int + ajya.a(2131707645);
              } else {
                paramView = ajya.a(2131707642);
              }
            }
          }
          if (i == 4)
          ...
          if (i == 5)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562565, null);
            ((TextView)paramView.findViewById(2131367471)).setText(ajya.a(2131707641));
          ...
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562565, null);
            ((TextView)paramView.findViewById(2131367471)).setText(ajya.a(2131707640));
            ((LinearLayout)paramView.findViewById(2131370938)).setVisibility(8);
            return paramView;
          }
          if (i == 3)
          {
            ...
            paramViewGroup.setText(ajya.a(2131707644));
