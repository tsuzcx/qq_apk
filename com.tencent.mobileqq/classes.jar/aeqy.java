...
public class aeqy
{
  ...
  public static aeqy a(SharedPreferences paramSharedPreferences, int paramInt)
  {
    ...
    aeqy localaeqy = new aeqy();
    localaeqy.jdField_a_of_type_Long = paramSharedPreferences.getLong(str1, 0L);
    if (DateUtils.isToday(localaeqy.jdField_a_of_type_Long)) {
      try
      {
        ...
        {
          localaeqy.a(paramSharedPreferences.getString(paramInt), paramSharedPreferences.getInt(paramInt + 1));
          paramInt += 2;
          continue;
          localaeqy.jdField_a_of_type_Long = System.currentTimeMillis();
        }
      }
  ...
  public static void a(SharedPreferences paramSharedPreferences, aeqy paramaeqy, int paramInt)
  {
    paramaeqy.a();
    Object localObject = new JSONArray();
    Iterator localIterator = paramaeqy.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
    ...
    if (paramInt == 2)
    {
      ...
      paramSharedPreferences.putLong("web_uin_list_time_millis", paramaeqy.jdField_a_of_type_Long);
    }
    for (;;)
    {
      ...
      paramSharedPreferences.putLong("bless_uin_list_time_millis", paramaeqy.jdField_a_of_type_Long);
    }
  }
