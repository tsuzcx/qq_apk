  ...
  extends aerh
{
  ...
  public aeqy(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    localObject = bdcs.a(paramString);
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Bdpn = ((bdpn)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Afvg = null;
      this.c = aekt.a(Long.valueOf(this.jdField_a_of_type_JavaLangString).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
      if ((localObject != null) && ((localObject instanceof afvg))) {
        this.jdField_a_of_type_Afvg = ((afvg)localObject);
      }
      while (this.jdField_a_of_type_Afvg == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Afvg.a != null)
      {
        localObject = this.jdField_a_of_type_Afvg.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Bdpn.a * k);
      j += (int)(this.jdField_a_of_type_Bdpn.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Bdpn.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Bdpn.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        this.jdField_a_of_type_Aeqz = null;
        ...
        localObject = aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof aeqz)))
        {
          this.jdField_a_of_type_Aeqz = ((aeqz)localObject);
          label484:
          ...
          j = this.jdField_a_of_type_Aeqz.a.getRight() - this.jdField_a_of_type_Aeqz.a.getLeft();
          i = this.jdField_a_of_type_Aeqz.a.getBottom() - this.jdField_a_of_type_Aeqz.a.getTop();
        }
      }
      for (;;)
      {
