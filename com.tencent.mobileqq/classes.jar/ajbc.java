  ...
  implements aivr
{
  ...
  public airo a;
  public bega a;
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new ajbg(this);
  ...
  public ajbc(int paramInt)
  {
    this.jdField_a_of_type_Bega = new ajbf(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new ajbi(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
    ...
    if ((ajlc.a(BaseApplicationImpl.getContext()).a() != null) && (ajlc.a(BaseApplicationImpl.getContext()).a().getRoom() != null) && (localArrayList1.size() > 0)) {
      ajlc.a(BaseApplicationImpl.getContext()).a().getRoom().requestViewList((String[])localArrayList1.toArray(new String[localArrayList1.size()]), (AVView[])localArrayList2.toArray(new AVView[localArrayList2.size()]), localArrayList1.size(), paramArrayOfString);
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((ajae.b(this.jdField_a_of_type_Long) != null) && (ajae.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)ajae.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new ajbh(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = ajlc.a(BaseApplicationImpl.getContext()).a();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        ajku.a().b(paramBoolean);
        break label60;
      } while ((ajlc.a(BaseApplicationImpl.getContext()).a() == null) || (ajlc.a(BaseApplicationImpl.getContext()).a().getRoom() == null));
      label130:
      label140:
      ajlc.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new ajbj(this));
    }
  }
  ...
  public void d()
  {
    ...
    {
      ajku.a().a("" + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_Airo != null) {
        this.jdField_a_of_type_Airo.b();
      }
      b(false);
  ...
  public void grant()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ajae.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      try
      {
        ...
        ajae.a().callbackFromRequest(this.jdField_a_of_type_Long, i, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
