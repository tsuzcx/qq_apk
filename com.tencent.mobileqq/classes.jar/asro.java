...
public class asro
  extends xgz
{
  public asro(NearbyProfilePicBrowserActivity paramNearbyProfilePicBrowserActivity) {}
  
  public xgg a(Activity paramActivity, xgm paramxgm)
  {
    return new asrq(paramActivity, paramxgm);
  }
  
  public xgi a(Activity paramActivity, xgm paramxgm)
  {
    return new asru((PicBrowserActivity)paramActivity, paramxgm);
  }
