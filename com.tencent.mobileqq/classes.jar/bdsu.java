  ...
  implements View.OnClickListener
{
  ...
  public bdsu(bdss parambdss, Context paramContext, String paramString1, String paramString2)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null) && ((this.jdField_a_of_type_JavaLangRefWeakReference.get() instanceof FragmentActivity)) && (!MultiForwardActivity.class.isInstance(this.jdField_a_of_type_JavaLangRefWeakReference.get())))
    {
      ...
      if (localObject1 != null)
      {
        ...
        aean.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_JavaLangString + " +1");
        localObject2 = "";
    ...
    ocd.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "0X8007239", "0X8007239", 0, 0, (String)localObject1, "", "", "");
    ocd.a("0X8007239", "", (String)localObject1, "", "", "");
