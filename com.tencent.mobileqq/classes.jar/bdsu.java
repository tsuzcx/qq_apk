...
public class bdsu
{
  static final int jdField_a_of_type_Int = bdhg.a("MiniApp", "mini_app_report_max_time_cost", 120000);
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidUtilSparseArray.put(1041, "steploadgameend");
    jdField_a_of_type_AndroidUtilSparseArray.put(1042, "steponfirstframeappear");
    ...
    b.put(2, new bdsv("launch_result", 1));
    b.put(5, new bdsv("basejs_download_result", 4));
    b.put(617, new bdsv("basejs_download_result", 4));
    b.put(7, new bdsv("basejs_unzip_result", 6));
    b.put(618, new bdsv("basejs_unzip_result", 6));
    b.put(620, new bdsv("app_download_result", 619));
    b.put(614, new bdsv("sub_download_result", 613));
    b.put(622, new bdsv("app_unzip_result", 621));
    b.put(627, new bdsv("preload_result", 626));
    b.put(1022, new bdsv("game_first_launch_result", 1));
    b.put(1023, new bdsv("game_twice_launch_result", 1));
    b.put(201, new bdsv("runtime_create_task", 200));
    b.put(203, new bdsv("runtime_init_task", 202));
    b.put(205, new bdsv("base_lib_load_async_task", 204));
    b.put(207, new bdsv("apkg_load_async_task", 206));
    b.put(209, new bdsv("service_init_task", 208));
    b.put(211, new bdsv("preload_flag_task", 210));
    b.put(213, new bdsv("flutter_view_create", 212));
    b.put(214, new bdsv("flutter_view_channel_init", 212));
    b.put(216, new bdsv("flutter_launch_app", 215));
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public static bdsw a(String paramString)
  {
    bdsw localbdsw2 = (bdsw)jdField_a_of_type_JavaUtilHashMap.get(paramString);
    bdsw localbdsw1 = localbdsw2;
    if (localbdsw2 == null)
    {
      localbdsw1 = new bdsw();
      localbdsw1.jdField_a_of_type_JavaLangString = paramString;
      jdField_a_of_type_JavaUtilHashMap.put(paramString, localbdsw1);
    }
    return localbdsw1;
  }
  ...
  {
    bdsw localbdsw = a(paramString);
    paramString = new JSONArray();
    try
    {
      JSONObject localJSONObject;
      if (localbdsw.jdField_b_of_type_JavaUtilMap.size() > 0)
      {
        localJSONObject = new JSONObject();
        localJSONObject.put("navigationStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(1)));
        localJSONObject.put("serviceStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(100)));
        localJSONObject.put("serviceEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(101)));
        localJSONObject.put("viewStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(102)));
        localJSONObject.put("viewEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(103)));
        localJSONObject.put("fetchPkgStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(619)));
        localJSONObject.put("fetchPkgEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(620)));
        localJSONObject.put("fetchSdkStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(4)));
        localJSONObject.put("fetchSdkEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(5)));
        localJSONObject.put("loadSdkServiceStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(14)));
        localJSONObject.put("loadSdkServiceEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(15)));
        localJSONObject.put("loadSdkViewStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(18)));
        localJSONObject.put("loadSdkViewEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(19)));
        localJSONObject.put("loadAppServiceStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(104)));
        localJSONObject.put("loadAppServiceEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(105)));
        localJSONObject.put("loadAppViewStart", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(106)));
        localJSONObject.put("loadAppViewEnd", localbdsw.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(107)));
        paramString.put(localJSONObject);
      }
      if (localbdsw.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        localJSONObject = new JSONObject();
        localJSONObject.put("navigationStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(1)));
        localJSONObject.put("serviceStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(100)));
        localJSONObject.put("serviceEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(101)));
        localJSONObject.put("viewStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(102)));
        localJSONObject.put("viewEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(103)));
        localJSONObject.put("fetchPkgStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(619)));
        localJSONObject.put("fetchPkgEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(620)));
        localJSONObject.put("fetchSdkStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(4)));
        localJSONObject.put("fetchSdkEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(5)));
        localJSONObject.put("loadSdkServiceStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(14)));
        localJSONObject.put("loadSdkServiceEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(15)));
        localJSONObject.put("loadSdkViewStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(18)));
        localJSONObject.put("loadSdkViewEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(19)));
        localJSONObject.put("loadAppServiceStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(104)));
        localJSONObject.put("loadAppServiceEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(105)));
        localJSONObject.put("loadAppViewStart", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(106)));
        localJSONObject.put("loadAppViewEnd", localbdsw.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(107)));
        paramString.put(localJSONObject);
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        bdnw.d("MiniReportManager", "create performance result failed", localException);
      }
    }
    bdnw.d("MiniReportManager", "wesley: getformance: " + paramString.toString());
    return paramString;
  }
  ...
  public static void a(MiniAppInfo paramMiniAppInfo, int paramInt1, String paramString1, String paramString2, String paramString3, int paramInt2, String paramString4, long paramLong, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    if (paramMiniAppInfo != null) {}
    for (String str = paramMiniAppInfo.appId;; str = "0000000000")
    {
      bdsw localbdsw1 = a(str);
      long l1;
      if (paramInt1 == 1)
      {
        bdse.a(str);
        if ((paramMiniAppInfo != null) && (paramMiniAppInfo.launchParam != null) && (paramMiniAppInfo.launchParam.b != 0L))
        {
          ...
          bdnw.a("MiniReportManager", "reportEventType: fix onlaunch timestamp to " + paramMiniAppInfo.launchParam.b);
          localbdsw1.jdField_a_of_type_Boolean = false;
          if (!localbdsw1.jdField_b_of_type_Boolean)
          {
            bdsw localbdsw2 = a("0000000000");
            if ((localbdsw2 != null) && (localbdsw2.jdField_a_of_type_JavaUtilMap.size() > 0))
            {
              Iterator localIterator = localbdsw2.jdField_a_of_type_JavaUtilMap.entrySet().iterator();
              while (localIterator.hasNext())
              {
                Map.Entry localEntry = (Map.Entry)localIterator.next();
                localbdsw1.jdField_a_of_type_JavaUtilMap.put(localEntry.getKey(), localEntry.getValue());
                bdnw.a("MiniReportManager", "transfer eventtime" + localEntry.getKey() + "[" + (String)jdField_a_of_type_AndroidUtilSparseArray.get(((Integer)localEntry.getKey()).intValue()) + " ] + appid:" + str);
              }
              localbdsw2.jdField_a_of_type_JavaUtilMap.clear();
            }
          }
        }
      }
      for (;;)
      {
        if ((paramInt1 == 611) && (!localbdsw1.jdField_a_of_type_Boolean)) {
          paramInt1 = 2;
        }
        for (;;)
        {
          if (paramInt1 == 2) {
            if (localbdsw1.jdField_a_of_type_Boolean) {
              bdnw.a("MiniReportManager", "has report apponloaded. ignore apponloaed ");
            }
          }
          label648:
          for (;;)
          {
            return;
            if (localbdsw1.jdField_b_of_type_JavaUtilMap.size() == 0) {
              localbdsw1.jdField_b_of_type_JavaUtilMap.putAll(localbdsw1.jdField_a_of_type_JavaUtilMap);
            }
            break;
            localbdsw1.jdField_a_of_type_Boolean = true;
            localbdsw1.jdField_b_of_type_Boolean = true;
            if (jdField_a_of_type_JavaUtilArrayList.contains(Integer.valueOf(paramInt1))) {
              localbdsw1.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt1), Long.valueOf(l1));
            }
            bdsi.a(paramMiniAppInfo, paramInt1, paramString1, paramString2, paramString3, paramInt2, paramString4, paramLong, paramString5, l1, paramString6, paramString7, paramString8, paramString9);
            paramString2 = (bdsv)b.get(paramInt1);
            if (paramString2 != null)
            {
              paramString3 = (Long)localbdsw1.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramString2.jdField_a_of_type_Int));
              ...
              if (paramLong > 0L)
              {
                ...
                paramString3 = (String)localbdsw1.c.get(Integer.valueOf(paramInt1));
                if (l2 < 0L) {
                  break label620;
                }
                paramLong = l2;
                ...
                bdsi.a(paramMiniAppInfo, paramString2, paramString3, paramInt2, paramLong, l1, paramString6, paramString7, paramString8, paramString9);
              }
            }
            for (;;)
            {
              ...
              bdsi.a(paramMiniAppInfo, 630, paramString1, "0", null, 0, "0", 0L, null, l1, "", "", "", "");
              return;
              label614:
              paramLong = 0L;
              break;
              label620:
              bdnw.d("MiniReportManager", "costTime < 0 " + l2);
            }
          }
        }
        l1 = l2;
  ...
  public static void a(String paramString1, MiniAppInfo paramMiniAppInfo, String paramString2)
  {
    ...
    {
      bdnw.a("MiniReportManager", "checkShouldReportJSError: report js error " + paramString1);
  ...
  public static void b(MiniAppInfo paramMiniAppInfo, int paramInt, String paramString)
  {
    ...
    bdnw.a("MiniReportManager", "addCostTimeEventAttachInfo:  mileStoneEventKey:" + paramInt + "   attachInfo:" + paramString);
  }
}
