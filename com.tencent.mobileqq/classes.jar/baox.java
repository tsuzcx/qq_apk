...
{
  public baox(StatusJsHandler paramStatusJsHandler) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          ((PublicAccountHandler)localBaseActivity.app.getBusinessHandler(11)).a(this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail);
          ocw.a().a(localBaseActivity.getApplicationContext(), localBaseActivity.app, this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin, null, true);
