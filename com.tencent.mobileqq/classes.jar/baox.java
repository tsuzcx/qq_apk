...
public class baox
{
  ...
  private baox(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Int = localbaou.b(paramString, paramInt1);
      ...
      if (!bhka.b(paramMessage.msgtype))
      {
        bool = bhka.c(paramMessage.msgtype);
        if (!bool) {
          break label235;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_JavaLangString = anzj.a(2131708451);
      }
      catch (Exception paramMessage) {}
