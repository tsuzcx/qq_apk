  ...
  extends baop
{
  ...
  protected void d()
  {
    ...
    if (localObject != null) {
      this.jdField_b_of_type_Baoo.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b((MessageRecord)localObject, null);
    }
    localObject = new Bundle();
    ((Bundle)localObject).putString("report_type", "102");
    ((Bundle)localObject).putString("act_type", "14");
    ((Bundle)localObject).putString("intext_2", "" + baoo.a(this.jdField_b_of_type_Baoo));
    ((Bundle)localObject).putString("stringext_1", "" + baoo.e(this.jdField_b_of_type_Baoo));
    ((Bundle)localObject).putString("intext_3", "0");
    bfdq.a().a((Bundle)localObject, "", this.jdField_b_of_type_Baoo.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
