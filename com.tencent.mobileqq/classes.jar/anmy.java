  ...
  implements Handler.Callback
{
  ...
  public anmy(Context paramContext, AppInterface paramAppInterface, int paramInt)
  {
    ...
    this.jdField_a_of_type_Anna = new anna();
  }
  
  public anmy(Context paramContext, AppInterface paramAppInterface, int paramInt1, int paramInt2)
  {
  ...
  public static String a(int paramInt)
  {
    if (paramInt / 10000 >= 1.0D)
    {
      ...
      for (DecimalFormat localDecimalFormat = new DecimalFormat("#.#");; localDecimalFormat = new DecimalFormat("#")) {
        return localDecimalFormat.format(paramInt / 10000.0F) + ajyc.a(2131707591);
      }
    }
  ...
  {
    if (!this.jdField_a_of_type_Anna.a()) {
      return;
    }
    RelativeLayout.LayoutParams localLayoutParams;
    if (this.jdField_c_of_type_Int == 1) {
      if (this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      }
    }
    for (;;)
    {
      ...
      if (!paramBoolean1)
      {
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.setVisibility(8);
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        ...
        {
          localObject = a(k);
          if (!(this.jdField_a_of_type_Anna.b instanceof TextView)) {
            break label683;
          }
          ((TextView)this.jdField_a_of_type_Anna.b).setText((CharSequence)localObject);
          label137:
          if (localLayoutParams == null) {
            break label712;
          }
          ...
          this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(localLayoutParams);
          return;
          localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_Anna.b.getLayoutParams();
        }
      }
      else
      {
        localObject = (ViewGroup.MarginLayoutParams)this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.getLayoutParams();
        if (paramBoolean2) {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.setBackgroundResource(m);
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.setLayoutParams((ViewGroup.LayoutParams)localObject);
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.setVisibility(paramInt);
        break label94;
        if (this.jdField_c_of_type_Int == 1)
        {
        ...
        if (this.jdField_c_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.setVisibility(paramInt);
          if (this.i != 2) {
            break label638;
          }
          this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.setText("+" + a(this.e));
        }
        for (;;)
        {
          ...
          if (this.jdField_c_of_type_Int == 2)
          {
            ...
            ((ViewGroup.MarginLayoutParams)localObject).leftMargin = bawz.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), 4.0F);
            j = 2130849298;
            break label418;
          }
          ...
          break label418;
          label638:
          this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.setText("+" + this.e);
        }
        localObject = String.valueOf(k);
        break label109;
        label683:
        if (!(this.jdField_a_of_type_Anna.b instanceof SingleLineTextView)) {
          break label137;
        }
        ((SingleLineTextView)this.jdField_a_of_type_Anna.b).setText((CharSequence)localObject);
        break label137;
        label712:
        break;
        label714:
        this.jdField_a_of_type_Anna.b.setLayoutParams(localLayoutParams);
        return;
        label727:
        m = 2130849289;
      }
  ...
  public void a()
  {
    anmg.a("voteAnim", new Object[] { "reset" });
    this.jdField_a_of_type_MqqOsMqqHandler.removeCallbacksAndMessages(null);
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
    if ((this.jdField_a_of_type_Anna.a()) && (!this.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.clearAnimation();
      this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.clearAnimation();
    }
    a(false, false, 8);
  }
  ...
  public void a(int paramInt1, int paramInt2, View paramView1, TextView paramTextView, View paramView2, RelativeLayout paramRelativeLayout, HeartLayout paramHeartLayout)
  {
    ...
    for (;;)
    {
      anmg.a("voteAnim", new Object[] { "updateVoteNum", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
      if (j <= 0)
      {
        if (this.jdField_a_of_type_Int != 0) {
          a();
        }
        anmg.a("voteAnim", new Object[] { "updateVoteNum", Integer.valueOf(this.jdField_d_of_type_Int), Integer.valueOf(this.e), Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(k), Integer.valueOf(j) });
      ...
      {
        this.e = j;
        this.jdField_a_of_type_Anna.b = paramView2;
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout = paramRelativeLayout;
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView = paramTextView;
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView = paramView1;
        this.jdField_a_of_type_Anna.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout = paramHeartLayout;
        aqyo.a(this.jdField_a_of_type_Anna.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout);
        ...
        case 0: 
          ...
          if ((this.jdField_d_of_type_Int != k) || (this.e != j))
          {
            ...
            try
            {
              ...
              if ((this.jdField_a_of_type_Int != 1) || (!this.jdField_a_of_type_Anna.a(paramView1, paramTextView, paramView2, paramRelativeLayout, paramHeartLayout))) {
                break label535;
              }
              this.f = paramInt1;
              this.g = paramInt2;
              if ((this.jdField_d_of_type_Boolean) && (!bfni.e()))
              {
                a();
                return;
              }
      ...
      if (paramTextView.a(paramView2, new anmz(this, paramInt1))) {
      ...
      for (;;)
      {
        ...
        this.jdField_b_of_type_Int = 0;
        return;
        this.jdField_a_of_type_MqqOsMqqHandler.sendMessageDelayed(paramView1, auws.jdField_b_of_type_Int);
      }
  ...
  protected void b()
  {
    anmg.a("voteAnim", new Object[] { "finishAnim" });
  ...
  public void c()
  {
    anmg.a("voteAnim", new Object[] { "endAnim", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Int) });
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 0: 
      if ((this.jdField_a_of_type_Int == 1) && (this.jdField_b_of_type_Int == 0) && (this.jdField_a_of_type_Anna.a()))
      {
        ...
        if (this.jdField_d_of_type_Boolean)
        {
          ...
          for (;;)
          {
            anmg.a("voteAnim", new Object[] { "MSG_ANIM_1", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Int), this.jdField_a_of_type_Anna });
            return false;
            this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(3, j, 0).sendToTarget();
            continue;
            a();
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidViewAnimationAnimation == null)
      {
        ...
        label383:
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.clearAnimation();
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationAnimation);
      ...
      {
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.clearAnimation();
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.startAnimation(this.jdField_b_of_type_AndroidViewAnimationAnimation);
      ...
      a();
      break;
      a(this.f, this.g, this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView, this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_Anna.b, this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_Anna.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout);
      return false;
      ...
      if (j > 0)
      {
        ...
        if (this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
        {
          this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout.getLocationInWindow(arrayOfInt);
          paramMessage = this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131371885);
          if (paramMessage != null) {
            f1 = (paramMessage.getWidth() + this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingLeft()) * 0.5F;
          }
          f2 = arrayOfInt[0];
          if (this.jdField_a_of_type_Aqyo == null) {
            this.jdField_a_of_type_Aqyo = new aqyo(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), 2130845045);
          }
          paramMessage = null;
          localObject2 = null;
          ...
          if ((localTPraiseInfo.iIsPayed <= 0) || (((auwu)localObject2).c == null)) {
            break label1077;
          }
          paramMessage = ((auwu)localObject2).c;
          localObject1 = localObject2;
        }
        for (;;)
        {
          ...
          if (paramMessage == null) {
            localObject2 = this.jdField_a_of_type_Aqyo.b();
          }
          this.jdField_a_of_type_Anna.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.a((auwu)localObject1, (Bitmap)localObject2, f2 + f1, arrayOfInt[1]);
          int m = j - 1;
          if (m <= 0) {
            break label1160;
          }
          ...
          return false;
          this.jdField_a_of_type_Anna.b.getLocationInWindow(arrayOfInt);
          if ((this.jdField_a_of_type_Anna.b instanceof SingleLineTextView))
          {
            f1 = ((SingleLineTextView)this.jdField_a_of_type_Anna.b).a() * 0.5F;
            break;
          }
          if (!(this.jdField_a_of_type_Anna.b instanceof TextView)) {
            break;
          }
          f1 = ((TextView)this.jdField_a_of_type_Anna.b).getCompoundPaddingLeft() * 0.5F;
          break;
          label1067:
          l = localTPraiseInfo.uCustomId;
          break label788;
          label1077:
          paramMessage = ((auwu)localObject2).b;
          localObject1 = localObject2;
          continue;
          label1090:
          localObject1 = paramMessage;
          if (localTPraiseInfo != null)
          {
            ...
            if (localTPraiseInfo.iIsPayed > 0) {
              try
              {
                localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp().getResources(), 2130842078);
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      anmg.a("voteAnim", new Object[] { "end", Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
      this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(2);
  ...
  {
    if ((paramAnimation == null) || (!this.jdField_a_of_type_Anna.a())) {}
    do
    {
      return;
      if (paramAnimation == this.jdField_a_of_type_AndroidViewAnimationAnimation)
      {
        anmg.a("voteAnim", new Object[] { "start", "anim1_1" });
        this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidViewView.setVisibility(0);
        return;
      }
    } while (paramAnimation != this.jdField_b_of_type_AndroidViewAnimationAnimation);
    anmg.a("voteAnim", new Object[] { "start", "anim1_2" });
    this.jdField_a_of_type_Anna.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
  }
}
