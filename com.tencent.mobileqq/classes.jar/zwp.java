...
public class zwp
{
  ...
  private static final zwp jdField_a_of_type_Zwp = new zwp();
  ...
  private final ConcurrentHashMap<String, ConcurrentHashMap<Integer, WeakReference<zwr>>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private zwp()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new zwq(this, "SUBSCRIBE_IPC_MODULE"));
      }
      return;
      i = 0;
    }
  ...
  private void a(String paramString, zwr paramzwr)
  {
    ...
    localConcurrentHashMap1.put(Integer.valueOf(paramzwr.hashCode()), new WeakReference(paramzwr));
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localConcurrentHashMap1);
    QLog.d("SimpleEventBus", 2, "registerReceiver event Name:" + paramString + ",key：[" + paramzwr.getClass().getSimpleName() + ":" + paramzwr.hashCode() + "], subscribers size:" + localConcurrentHashMap1.size());
  }
  ...
  private void b(String paramString, zwr paramzwr)
  {
    ...
    localConcurrentHashMap.remove(Integer.valueOf(paramzwr.hashCode()));
    if (localConcurrentHashMap.size() == 0) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
    }
    QLog.d("SimpleEventBus", 2, "unRegisterReceiver event Name:" + paramString + ",key：[" + paramzwr.getClass().getSimpleName() + ":" + paramzwr.hashCode() + "], subscribers size:" + localConcurrentHashMap.size());
  }
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localWeakReference != null) && (localWeakReference.get() != null)) {
          ((zwr)localWeakReference.get()).onReceiveEvent(paramSimpleBaseEvent);
        }
      }
    }
  }
  ...
  public void a(zwr paramzwr)
  {
    ...
    {
      return;
      Iterator localIterator = paramzwr.getEventClass().iterator();
      while (localIterator.hasNext()) {
        a(((Class)localIterator.next()).getName(), paramzwr);
      }
    }
  }
  
  public void b(zwr paramzwr)
  {
    if ((paramzwr == null) || (paramzwr.getEventClass() == null)) {}
    for (;;)
    {
      return;
      Iterator localIterator = paramzwr.getEventClass().iterator();
      while (localIterator.hasNext()) {
        b(((Class)localIterator.next()).getName(), paramzwr);
      }
    }
  }
}
