...
class bkmz
  implements acaq
{
  bkmz(bkmy parambkmy, Activity paramActivity) {}
  ...
  public void a(GdtAd paramGdtAd, acap paramacap)
  {
    ...
    label58:
    for (paramGdtAd = paramacap.a();; paramGdtAd = "")
    {
  ...
  public void c(GdtAd paramGdtAd)
  {
    ...
    if ((paramGdtAd != null) && (paramGdtAd.getAd() != null) && (AdUtils.isHitReport50ViewAndOneSecond(paramGdtAd.getAd()))) {
      AdExposureChecker.onClick(this.jdField_a_of_type_AndroidAppActivity, paramGdtAd.getAd(), new WeakReference(this.jdField_a_of_type_Bkmy.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Bkmy.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener != null) {
        this.jdField_a_of_type_Bkmy.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener.onADClicked();
      }
      return;
  ...
  public void d(GdtAd paramGdtAd)
  {
    ...
    if (this.jdField_a_of_type_Bkmy.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener != null) {
      this.jdField_a_of_type_Bkmy.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener.onADClosed();
    }
  }
}
