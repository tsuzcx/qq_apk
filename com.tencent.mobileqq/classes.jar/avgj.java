  ...
  implements azwh
{
  ...
  public avgj(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(avgm paramavgm, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Ahbe != null) {
        paramDrawable = this.jdField_a_of_type_Ahbe.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)ahbe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.a()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = paramavgm.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramavgm.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.b());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      paramavgm.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(avgm paramavgm, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((paramavgm == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(paramavgm, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof avgm))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((avgm)paramViewHolder, localRecentBaseData, null);
    }
  }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new avgl(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131496758, paramViewGroup, false));
    }
    return new avgm(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495463, paramViewGroup, false), this.jdField_a_of_type_Avgk);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof avgm))
        {
          break label436;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (avgm)paramBitmap;
