...
public class alad
  extends aliy
{
  public alad(RecentMemberInnerFrame paramRecentMemberInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (alae)paramView.getTag();
      localView = paramView;
    ...
    for (;;)
    {
      ...
      return localView;
      paramView = new alae(this.a, null);
      localView = this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getLayoutInflater().inflate(2131562780, paramViewGroup, false);
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.isResultListContainFriend(localRecentUser.uin))
    {
      ...
      if (AppSetting.c)
      {
        ...
        localView.setContentDescription((String)localObject + amtj.a(2131712313));
      }
    }
    for (;;)
    {
      ...
      break label271;
      label369:
      localView.setContentDescription((String)localObject + amtj.a(2131712310));
    }
  }
}
