...
public class alad
{
  ...
  private akgd jdField_a_of_type_Akgd;
  private alaf jdField_a_of_type_Alaf;
  private alah jdField_a_of_type_Alah;
  private alai jdField_a_of_type_Alai;
  ...
  public alad(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new alag(this);
    this.jdField_a_of_type_Akgd = new alae(this, 3, true, true, 0L, true, true, "ArkAppEventObserverManager");
  }
  ...
  public void a(alak paramalak, long paramLong)
  {
    if ((paramalak instanceof alaj))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppEventObserverManager", 2, "attachEvent MotionCallback");
      }
      if ((this.jdField_a_of_type_Long != 0L) && (this.jdField_a_of_type_Alaj != null)) {
        this.jdField_a_of_type_Alaj.a(this.jdField_a_of_type_Long);
      }
      this.jdField_a_of_type_Alaj = ((alaj)paramalak);
      this.jdField_a_of_type_Long = paramLong;
      if (this.jdField_a_of_type_AndroidHardwareSensor == null)
      {
        paramalak = (SensorManager)BaseApplicationImpl.getApplication().getSystemService("sensor");
        this.jdField_a_of_type_AndroidHardwareSensor = paramalak.getDefaultSensor(1);
        if (this.jdField_a_of_type_AndroidHardwareSensor == null) {
          break label113;
        }
        paramalak.registerListener(this.jdField_a_of_type_AndroidHardwareSensorEventListener, this.jdField_a_of_type_AndroidHardwareSensor, 1);
      }
    }
    label113:
    do
    {
      do
      {
        do
        {
          ...
          this.jdField_a_of_type_Alaj.a(false, 0.0F, 0.0F, 0.0F);
          return;
          if (!(paramalak instanceof alal)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("ArkAppEventObserverManager", 2, "attachEvent OrientationCallback");
          }
          if ((this.jdField_b_of_type_Long != 0L) && (this.jdField_a_of_type_Alal != null)) {
            this.jdField_a_of_type_Alal.a(this.jdField_b_of_type_Long);
          }
          this.jdField_a_of_type_Alal = ((alal)paramalak);
          this.jdField_b_of_type_Long = paramLong;
        } while (this.jdField_b_of_type_AndroidHardwareSensor != null);
        paramalak = (SensorManager)BaseApplicationImpl.getApplication().getSystemService("sensor");
        this.jdField_b_of_type_AndroidHardwareSensor = paramalak.getDefaultSensor(3);
        paramalak.registerListener(this.jdField_a_of_type_AndroidHardwareSensorEventListener, this.jdField_b_of_type_AndroidHardwareSensor, 1);
        return;
        if ((paramalak instanceof alam))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ArkAppEventObserverManager", 2, "attachEvent PositionCallback callback=" + paramalak + ", cbId=" + paramLong + ", mPositionCallback=" + this.jdField_a_of_type_Alam + ", mPositionCallbackId=" + this.jdField_c_of_type_Long);
          }
          if ((this.jdField_c_of_type_Long != 0L) && (this.jdField_a_of_type_Alam != null)) {
            this.jdField_a_of_type_Alam.a(this.jdField_c_of_type_Long);
          }
          this.jdField_a_of_type_Alam = ((alam)paramalak);
          this.jdField_c_of_type_Long = paramLong;
          SosoInterface.a(this.jdField_a_of_type_Akgd);
          return;
        }
        if (!(paramalak instanceof alah)) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ArkAppEventObserverManager", 2, "attachEvent ConnectionCallback");
        }
        if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_Alah != null)) {
          this.jdField_a_of_type_Alah.a(this.jdField_d_of_type_Long);
        }
        this.jdField_a_of_type_Alah = ((alah)paramalak);
        this.jdField_d_of_type_Long = paramLong;
      } while (this.jdField_a_of_type_Alaf != null);
      this.jdField_a_of_type_Alaf = new alaf(this);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_Alaf);
      return;
    } while (!(paramalak instanceof alai));
    if (QLog.isColorLevel()) {
      QLog.d("ArkAppEventObserverManager", 2, "attachEvent GetCurrentPositionCallback");
    }
    if ((this.jdField_e_of_type_Long != 0L) && (this.jdField_a_of_type_Alai != null)) {
      this.jdField_a_of_type_Alai.a(this.jdField_e_of_type_Long);
    }
    this.jdField_a_of_type_Alai = ((alai)paramalak);
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      if ("Position".equals(paramString))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("ArkAppEventObserverManager", 2, "detachEvent PositionCallback mPositionCallback=" + this.jdField_a_of_type_Alam + ", mPositionCallbackId=" + this.jdField_c_of_type_Long);
        }
        if ((this.jdField_c_of_type_Long != 0L) && (this.jdField_a_of_type_Alam != null)) {
          this.jdField_a_of_type_Alam.a(this.jdField_c_of_type_Long);
        }
        this.jdField_a_of_type_Alam = null;
    ...
    {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Alaf);
      this.jdField_a_of_type_Alaf = null;
    }
    if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_Alah != null)) {
      this.jdField_a_of_type_Alah.a(this.jdField_d_of_type_Long);
    }
    this.jdField_a_of_type_Alah = null;
