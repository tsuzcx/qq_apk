...
public class aofz
{
  ...
  private HashMap<String, aogw> jdField_a_of_type_JavaUtilHashMap;
  ...
  private aogt a(String paramString1, int paramInt, String paramString2, MessageRecord paramMessageRecord)
  {
    ...
    paramString2 = new aogt(this, paramString2, paramString1, paramInt, paramMessageRecord);
    paramString1 = paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFilePath");
    if (a(paramString1)) {
      if (paramInt == 0) {
        paramString1 = new aogh(this, paramMessageRecord);
      }
    }
    for (;;)
    {
      ...
      if (paramInt == 3000)
      {
        paramString1 = new aogq(this, paramMessageRecord);
      }
      else if (paramInt == 1)
      {
        paramString1 = new aoha(this, paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName"), paramString1, null);
      }
      else
      {
        do
        {
          do
          {
            ...
            if (paramInt == 0)
            {
              paramString1 = new aogb(this, paramMessageRecord);
              break;
            }
            if (paramInt == 3000)
            {
              paramString1 = new aogd(this, paramMessageRecord);
              break;
            }
          } while (paramInt != 1);
          paramString1 = new aogf(this, paramMessageRecord);
          break;
          if (paramInt == 0)
          {
            paramString1 = new aogk(this, paramMessageRecord);
            break;
          }
          if (paramInt == 3000)
          {
            paramString1 = new aogm(this, paramMessageRecord);
            break;
          }
        } while (paramInt != 1);
        paramString1 = new aogo(this, paramMessageRecord);
      }
    }
    if (paramInt == 0) {
      paramInt = 3;
    ...
    for (;;)
    {
      paramString1 = new aogy(this, paramMessageRecord, paramInt, null);
      break label76;
      if (paramInt == 3000)
      {
        paramInt = 106;
  ...
  private static void b(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, aogv paramaogv)
  {
    if (paramaogv == null)
    {
    ...
    wln.a(paramQQAppInterface, paramLong1, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, new aoga(paramString, paramaogv, paramLong2));
  }
  ...
  public void a(aood paramaood, HashMap<String, ArrayList<MessageRecord>> paramHashMap)
  {
    if ((paramHashMap == null) || (paramHashMap.size() <= 0)) {
      QLog.i("FileMultiMsgManager<FileAssistant>", 1, "addMultiFileUploadRequest: file message record list is null");
    }
    this.jdField_a_of_type_AndroidOsHandler.post(new QFileMsgForwardManager.1(this, paramaood));
  }
  
  public void a(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    if (apdq.a(paramMessageRecord1)) {
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        continue;
        paramMessageRecord1 = (MessageForTroopFile)apck.a((ChatMessage)paramMessageRecord1);
        paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1).a);
        continue;
      }
      Object localObject;
      ...
      else if ((paramMessageRecord1 instanceof MessageForTroopFile))
      {
        ...
        localObject = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1);
        if (localObject != null)
        {
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_750_", ((ayqd)localObject).c);
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_384_", ((ayqd)localObject).d);
          if (((paramMessageRecord1.width == 0) || (paramMessageRecord1.height == 0)) && (((ayqd)localObject).e > 0) && (((ayqd)localObject).f > 0))
          {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgWidth", String.valueOf(paramMessageRecord1.width));
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgHeight", String.valueOf(paramMessageRecord1.height));
          }
          paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", ((ayqd)localObject).a);
          if ((((ayqd)localObject).b == 2) || (((ayqd)localObject).b == 3)) {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardStatusPaused", "1");
          }
        }
      }
