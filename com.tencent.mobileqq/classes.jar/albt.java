  ...
  extends alcd
{
  ...
  private void a(View paramView, RecentBaseData paramRecentBaseData, Context paramContext, albu paramalbu)
  {
    int j = 1;
    int k = 0;
    ...
    if (i > 0) {
      if (m == 0)
      {
        paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(-1, paramView);
        j = 0;
        i = 0;
      }
    }
    for (;;)
    {
      bkjh.a(paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, i, k, j, 99, null);
      return;
      if (m == 2)
      {
        paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(-1, paramView);
      ...
      else if (m == 3)
      {
        ...
        paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(1, paramView);
        paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTextColor(paramContext.getResources().getColor(2131167110));
        j = 2130850396;
        m = 3;
        k = i;
        i = m;
      ...
      {
        j = 2130850392;
        paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(0, paramView);
        paramalbu.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTextColor(paramContext.getResources().getColor(2131167111));
        k = i;
        i = 3;
        continue;
        j = 0;
  ...
  private void a(RecentBaseData paramRecentBaseData, albu paramalbu)
  {
    CharSequence localCharSequence1 = paramRecentBaseData.mMsgExtroInfo;
    CharSequence localCharSequence2 = paramalbu.d.getText();
    int i = paramalbu.d.getCurrentTextColor();
    Object localObject = localCharSequence1;
    if (localCharSequence1 == null) {
      localObject = "";
    }
    if (!localObject.equals(localCharSequence2)) {
      paramalbu.d.setText((CharSequence)localObject);
    }
    if ((i != paramRecentBaseData.mExtraInfoColor) && (paramRecentBaseData.mExtraInfoColor != 0)) {
      paramalbu.d.setTextColor(paramRecentBaseData.mExtraInfoColor);
    }
  }
  
  private void b(RecentBaseData paramRecentBaseData, albu paramalbu)
  {
    CharSequence localCharSequence1 = paramRecentBaseData.mLastMsg;
    CharSequence localCharSequence2 = paramalbu.e.getText();
    ...
    try
    {
      paramalbu.e.setText(paramRecentBaseData);
      return;
    }
  ...
  private void c(RecentBaseData paramRecentBaseData, albu paramalbu)
  {
    String str = paramRecentBaseData.mShowTime;
    CharSequence localCharSequence = paramalbu.jdField_a_of_type_AndroidWidgetTextView.getText();
    paramRecentBaseData = str;
    if (str == null) {
      paramRecentBaseData = "";
    }
    if (!paramRecentBaseData.equals(localCharSequence)) {
      paramalbu.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData);
    }
  }
  
  private void d(RecentBaseData paramRecentBaseData, albu paramalbu)
  {
    if ((paramRecentBaseData.mMenuFlag & 0xF0) == 32)
    {
      paramalbu.g.setBackgroundResource(2130839395);
      return;
    }
    paramalbu.g.setBackgroundResource(2130839394);
  }
  ...
  public View a(int paramInt, Object paramObject, alby paramalby, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, View.OnLongClickListener paramOnLongClickListener, aled paramaled)
  {
    ...
    {
      paramaled = new albu();
      localObject = a(paramContext, 2131562779, paramaled);
      paramaled.jdField_a_of_type_ComTencentWidgetThemeImageView = ((ThemeImageView)((View)localObject).findViewById(2131368138));
      paramaled.jdField_a_of_type_ComTencentWidgetThemeImageView.setSupportMaskView(true);
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup != null) && ((paramObject instanceof RecentBaseData)))
      {
        ...
        if ((paramObject instanceof RecentItemEcShop))
        {
          ...
          if (AppSetting.c) {
            paramViewGroup.jdField_a_of_type_ComTencentWidgetThemeImageView.setContentDescription(String.format(anni.a(2131711924), new Object[] { ((RecentItemEcShop)paramObject).getTitleName() }));
          }
        }
      }
      for (;;)
  ...
  public void a(albu paramalbu, RecentBaseData paramRecentBaseData)
  {
    switch (paramRecentBaseData.mStatus)
    {
    default: 
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(null);
      return;
    case 1: 
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842080);
      return;
    case 2: 
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      if (paramRecentBaseData.mIsGroupVideo)
      {
        paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842090);
        return;
      }
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842080);
      return;
    case 3: 
      ...
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842091);
      return;
    case 5: 
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842091);
    ...
    paramalbu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    paramalbu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839532);
  }
  ...
  protected void a(View paramView, TextView paramTextView, Context paramContext)
  {
    try
    {
      LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131378447);
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((localObject instanceof albu)) {}
    for (albu localalbu = (albu)localObject;; localalbu = null)
    {
      if (localalbu == null)
      {
        if (!QLog.isColorLevel()) {
      ...
      localalbu.jdField_a_of_type_ComTencentWidgetThemeImageView.setImageDrawable(paramDrawable);
      localObject = paramRecentBaseData.mTitleName;
      CharSequence localCharSequence = localalbu.jdField_b_of_type_AndroidWidgetTextView.getText();
      paramDrawable = (Drawable)localObject;
      if (localObject == null) {
        paramDrawable = "";
      }
      if (!paramDrawable.equals(localCharSequence)) {
        localalbu.jdField_b_of_type_AndroidWidgetTextView.setText(paramDrawable);
      }
      int i = paramRecentBaseData.mAuthenIconId;
      if (i > 0)
      {
        localalbu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        localalbu.jdField_b_of_type_AndroidWidgetImageView.setImageResource(i);
        label175:
        localObject = paramRecentBaseData.mExtraInfo;
        localCharSequence = localalbu.c.getText();
        paramDrawable = (Drawable)localObject;
        if (localObject == null) {
          paramDrawable = "";
        }
        ...
        localalbu.c.setVisibility(8);
      }
      for (;;)
      {
        a(a((View)localalbu.jdField_b_of_type_AndroidWidgetTextView.getParent()), localalbu.jdField_b_of_type_AndroidWidgetTextView, new View[] { localalbu.jdField_b_of_type_AndroidWidgetImageView, localalbu.c });
        a(paramRecentBaseData, localalbu);
        b(paramRecentBaseData, localalbu);
        c(paramRecentBaseData, localalbu);
        a(localalbu, paramRecentBaseData);
        a(paramView, paramRecentBaseData, paramContext, localalbu);
        if (localalbu.jdField_a_of_type_AndroidWidgetTextView.getVisibility() != 0) {
          localalbu.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        if (AppSetting.c) {
          paramView.setContentDescription(paramRecentBaseData.mContentDesc);
        }
        d(paramRecentBaseData, localalbu);
        long l = paramRecentBaseData.getFaceExtraFlag();
        if (!(localalbu.jdField_a_of_type_ComTencentWidgetThemeImageView instanceof bkli)) {
          break;
        }
        ((bkli)localalbu.jdField_a_of_type_ComTencentWidgetThemeImageView).a(l);
        return;
        localalbu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
        break label175;
        label389:
        if (!paramDrawable.equals(localCharSequence)) {
          localalbu.c.setText(paramDrawable);
        }
        localalbu.c.setVisibility(0);
      }
    }
  }
}
