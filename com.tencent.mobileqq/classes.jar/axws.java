  ...
  extends axup
{
  ...
  public axws()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axwt(this);
    this.jdField_a_of_type_JavaLangString = "picture";
    this.jdField_a_of_type_Int = 16;
  }
  
  public axws(String paramString)
  {
    this();
    this.S = paramString;
  }
  
  public axws(String paramString1, String paramString2)
  {
    this();
    this.S = paramString1;
    this.T = paramString2;
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    try
    {
      ...
      for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
      {
        ...
        paramDrawable = bbef.a((Bitmap)localObject, i, i, i);
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Drawable localDrawable1 = npy.a().a((Resources)localObject3, 2130849353);
        ...
        else
        {
          try
          {
            ...
            ((PAHighLightImageView)localObject1).setImageDrawable(bayh.a(((BaseActivity)paramContext).app, 4, paramBundle.optString("groupcode")));
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          ...
          ((PAHighLightImageView)localObject2).setId(2131367947);
          ((PAHighLightImageView)localObject2).setContentDescription(((Resources)localObject3).getString(2131691237));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ((PAHighLightImageView)localObject1).setImageDrawable(bbef.a());
          return localObject2;
        }
        ...
        paramContext.setTag(bavw.b(j, j, j));
        paramContext.setDecodeHandler(bavw.i);
      ...
      if ("StructMsgItemCover createView ,exception  = " + paramContext != null)
      {
          ...
          if ((localObject3 instanceof BaseActivity))
          {
            ...
            if (paramView.indexOf("internal_phone") > -1)
            {
              ...
              else
              {
                ...
                if (!bbcz.a(paramContext)) {
                  break label997;
                }
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298830);
                ((PAHighLightImageView)localObject1).setTextSize(i);
                ((PAHighLightImageView)localObject1).e = paramContext;
                paramContext = ((Context)localObject3).getResources().getDrawable(2130841580);
              }
            }
            for (;;)
            {
              ...
              break;
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298832);
              break label944;
              if (bbcz.a(paramContext))
              {
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298826);
                break label944;
              }
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298828);
              break label944;
              if (paramBundle.startsWith("+"))
              {
                paramContext = bayh.b(localQQAppInterface, paramBundle, (byte)3);
              }
              else
              {
                paramContext = bayh.a(11, 3);
                continue;
                paramContext = bayh.a(localQQAppInterface, 1, paramBundle, 3, paramContext, paramContext);
              }
            }
          }
        }
        ...
        {
          ((PAHighLightImageView)localObject1).setImageResource(2130843257);
          return localObject2;
        }
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              if (this.p == m)
              {
                j = actj.a(70.0F, (Resources)localObject3);
                i = j;
              }
            }
            catch (MalformedURLException paramContext) {}
          ...
          j = actj.a(140.0F, (Resources)localObject3);
          i = j;
          continue;
          paramBundle = null;
          if (paramView.startsWith("http://p.qlogo.cn/gh/"))
          {
            ...
            if ((paramView instanceof BaseActivity))
            {
              ...
              paramBundle = bayh.a(4, 3);
              ((PAHighLightImageView)localObject1).setImageDrawable(bayh.a(paramView, 4, paramContext, 3, paramBundle, paramBundle));
              return localObject2;
            }
            ((PAHighLightImageView)localObject1).setImageDrawable(bbef.a());
            return localObject2;
      ...
      for (;;)
      {
        ...
        {
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_CROP);
          i = actj.a(70.0F, (Resources)localObject3);
          if (!bool1) {
            break label1943;
          }
          ((PAHighLightImageView)localObject1).setBackgroundColor(Color.parseColor("#dddfe2"));
        ...
        for (;;)
        {
          ...
          paramContext.restartDownload();
          break label2045;
          if ((paramView.startsWith(xbi.b)) || (paramView.startsWith(xbi.c)) || (paramView.startsWith(xbi.d)))
          {
            ((PAHighLightImageView)localObject1).setBackgroundDrawable(null);
            i = paramView.lastIndexOf("&uin=");
            paramContext = paramView.substring("&uin=".length() + i);
          ...
          if ((paramView.startsWith("http://imgplat.store.qq.com/bqq_qfpic/520520")) || (paramView.contains(wux.jdField_a_of_type_JavaLangString)))
          {
            paramBoolean = true;
          ...
          if (this.p == n)
          {
            ...
            i = actj.a(140.0F, (Resources)localObject3);
            break label1367;
          }
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER);
          break label1367;
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (localObject2 = null;; localObject2 = ((ChatFragment)localObject2).a())
    {
      ...
      catch (Exception localException)
      {
        ...
        axqy.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D93", "0X8005D93", paramInt2, 1, paramInt1, str, String.valueOf(paramView.msgId), "1", "");
        return;
      }
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    do
    {
      ...
      {
        return true;
        str = paramaxwg.a("cover");
        if (str == null) {
          break;
        }
        this.S = str;
      } while (this.jdField_a_of_type_Int <= 3);
      this.c = paramaxwg.a("action");
    ...
    for (;;)
    {
      ...
      this.T = paramaxwg.a("needRoundView");
      return true;
      str = "";
      break label18;
