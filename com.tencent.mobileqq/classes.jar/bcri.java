...
public class bcri
  implements Handler.Callback, bcrh
{
  int jdField_a_of_type_Int = 0;
  Handler jdField_a_of_type_AndroidOsHandler = null;
  bcrj jdField_a_of_type_Bcrj = null;
  WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  boolean jdField_a_of_type_Boolean;
  int jdField_b_of_type_Int = 10;
  boolean jdField_b_of_type_Boolean = false;
  
  public bcri(bcrj parambcrj, Context paramContext)
  {
    this.jdField_a_of_type_Bcrj = parambcrj;
  ...
  void a(int paramInt)
  {
    ...
    if (paramInt != this.jdField_a_of_type_Int)
    {
      ...
      if (this.jdField_a_of_type_Bcrj != null) {
    ...
    {
      this.jdField_a_of_type_Bcrj.a(localView, i, paramInt);
      return;
    }
  }
