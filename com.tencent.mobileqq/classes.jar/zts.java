  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    {
      ztp.a(this.a).sendEmptyMessage(1003);
      new aafq().a();
      this.a.b = 2;
    }
    long l;
    do
    {
        ...
        do
        {
          do
          {
            do
            {
              ...
              ztp.a(this.a, "DeviceList @@ cache receivechange for ui list:" + paramContext);
            ...
            if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_login"))
            {
              ...
              ztp.a(this.a, "SmartDeviceProxyMgr::receive qq login broadcast!!!resultCode = " + i);
              SettingCloneUtil.writeValue(this.a.app.getApp(), this.a.app.getCurrentAccountUin(), null, "account_login_success_time", String.valueOf(ayzl.a()));
              if (i == 0)
              {
            ...
            if ((paramIntent.getAction().equalsIgnoreCase("mqq.intent.action.LOGOUT")) || (paramIntent.getAction().equalsIgnoreCase("mqq.intent.action.ACCOUNT_CHANGED")))
            {
              if (this.a.a())
              {
                ztp.a(this.a, "SmartDeviceProxyMgr::receive qq logout broadcast!!!");
                this.a.d();
              }
              aafq.c();
              return;
            ...
            if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_clickOnDeviceList"))
            {
              ...
              aagb.a(null, "Usr_Click_MyDevice", 0, 0, 0);
              return;
            }
      ...
      ztp.a(this.a, 1);
      SettingCloneUtil.writeValueForInt(BaseApplication.getContext(), this.a.app.getCurrentAccountUin(), null, "qqsetting_deviceplugin_bind_flag", ztp.a(this.a));
