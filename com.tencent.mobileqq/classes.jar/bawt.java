  ...
  extends bawi
{
  ...
  public bawt(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, List<FTSMessage> paramList, String paramString3, CharSequence paramCharSequence)
  {
    ...
    {
      i = ((amrb)paramQQAppInterface.getManager(53)).a(this.jdField_d_of_type_JavaLangString);
      if (i <= 0) {
        this.f = "";
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    if ((paramView.getContext() instanceof UniteSearchActivity)) {
      ...
      {
        localObject1 = (batc)batb.b.get(this);
    ...
    try
    {
      ...
      localJSONObject.put("obj_lct", ((batc)localObject1).jdField_a_of_type_Int);
      localJSONObject.put("get_src", "native");
      bbda.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((batc)localObject1).jdField_a_of_type_Long + "").obj2(((batc)localObject1).jdField_b_of_type_JavaLangString).ver1(((batc)localObject1).jdField_a_of_type_JavaLangString).ver2(bbda.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(localJSONObject.toString()).session_id(((QQAppInterface)localObject2).getCurrentAccountUin() + batb.jdField_a_of_type_Long));
      bbda.a(null, this.v, 0, "0X8009D4D", 0, 0, null, null);
      if (this.jdField_a_of_type_JavaLangCharSequence != null) {
        this.jdField_a_of_type_JavaLangCharSequence = bgbo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int, this.jdField_e_of_type_JavaLangString);
      }
      localObject1 = (Integer)paramView.getTag(2131380832);
      localObject2 = (Integer)paramView.getTag(2131380830);
      if (((paramView.getContext() instanceof UniteSearchActivity)) && (((Integer)localObject1).intValue() >= 0) && (((Integer)localObject2).intValue() >= 0))
      {
        bbgk.a("all_result", "clk_talk", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + localObject2, "" + (((Integer)localObject1).intValue() + 1) });
        if (this.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label699;
        }
        bgbp.f = 1;
        bgbp.jdField_d_of_type_Int = this.jdField_a_of_type_Int;
        bgbp.g = this.jdField_e_of_type_Int;
        bgbp.h = this.jdField_b_of_type_Int;
        bgbp.i = this.jdField_c_of_type_Int;
        bgbp.j = this.jdField_d_of_type_Int;
        bgbo.a(paramView);
        if (this.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label725;
        }
        ...
        if (((FTSMessage)localObject1).msgExts != null)
        {
          ...
          akms.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject1).msgExts).shmsgseq;
        }
        anap.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
        akms.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int, (String)this.jdField_a_of_type_JavaLangCharSequence, false);
        bbgk.a(this.jdField_a_of_type_JavaLangString, 40, paramView, false);
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        ...
        {
          bbgk.a("talk", "clk_talk", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + localObject2, "" + (((Integer)localObject1).intValue() + 1) });
          continue;
          label699:
          bgbp.f = 2;
          continue;
          label706:
          akms.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject1).msgExts).time;
          continue;
          label725:
  ...
  public CharSequence c()
  {
    ...
    if (this.jdField_d_of_type_JavaLangCharSequence == null)
    {
      ...
      if (i == 1) {
        this.jdField_d_of_type_JavaLangCharSequence = bbgk.a(((FTSEntity)this.jdField_a_of_type_JavaUtilList.get(0)).mContent, ((FTSEntity)this.jdField_a_of_type_JavaUtilList.get(0)).mProximityStart, this.jdField_a_of_type_JavaUtilArrayList);
      }
    }
    else
    {
    ...
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder(i + amtj.a(2131704080) + "\"");
    if ((this.jdField_c_of_type_JavaLangString != null) && ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))) {
      localSpannableStringBuilder.append(bbgk.a(this.jdField_c_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString));
    }
    for (;;)
    {
