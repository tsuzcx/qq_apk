...
{
  public aiom(TroopAioKeywordTipManager paramTroopAioKeywordTipManager, MessageRecord paramMessageRecord, TroopAioKeywordTipManager.Callback paramCallback) {}
    ...
    if (paramBoolean)
    {
      if ((paramList != null) && (paramList.size() > 0))
      {
        ...
        synchronized (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipManager.b)
        {
          ...
          ThreadManager.post(new aion(this, paramList), 2, null, true);
          return;
        }
      }
