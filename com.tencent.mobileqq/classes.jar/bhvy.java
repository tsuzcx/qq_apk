  ...
  extends SQLiteOpenHelper
{
  ...
  public bhvy(Context paramContext)
  {
    super(paramContext, "agent_report.db", null, 2);
  }
  
  public static bhvy a()
  {
    try
    {
      if (jdField_a_of_type_Bhvy == null) {
        jdField_a_of_type_Bhvy = new bhvy(bhpc.a().a());
      }
      bhvy localbhvy = jdField_a_of_type_Bhvy;
      return localbhvy;
    }
    finally {}
  }
  ...
  public int a(String paramString)
  {
    ...
    //   16: ireturn
    //   17: aload_0
    //   18: invokevirtual 47	bhvy:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   21: astore 5
    //   23: aload 5
    //   25: ifnonnull +8 -> 33
    //   28: iconst_0
    ...
    //   33: aload 5
    //   35: ldc 49
    //   37: getstatic 15	bhvy:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   40: ldc 51
    //   42: iconst_1
  ...
  public java.util.List<java.lang.Integer> a()
  {
    ...
    //   9: astore 4
    //   11: aload_0
    //   12: invokevirtual 77	bhvy:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   15: astore 5
    //   17: aload 5
    //   19: ifnonnull +10 -> 29
    //   22: aload 4
  ...
  public java.util.List<java.io.Serializable> a(String paramString)
  {
    ...
    //   24: areturn
    //   25: aload_0
    //   26: invokevirtual 47	bhvy:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore 5
    //   31: aload 5
    //   33: ifnonnull +6 -> 39
    //   36: goto -16 -> 20
  ...
  public void a(String paramString)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: invokevirtual 77	bhvy:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   18: astore_3
    //   19: aload_3
    //   20: ifnull -9 -> 11
    //   23: aload_3
  ...
  public void a(String paramString, java.util.List<java.io.Serializable> paramList)
  {
    ...
    //   36: aload_0
    //   37: aload_1
    //   38: invokevirtual 164	bhvy:a	(Ljava/lang/String;)V
    //   41: aload_0
    //   42: invokevirtual 77	bhvy:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   45: astore 8
    //   47: aload 8
    //   49: ifnull -22 -> 27
    //   52: aload 8
