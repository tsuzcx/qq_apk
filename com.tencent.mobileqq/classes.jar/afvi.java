  ...
  extends afgm
{
  ...
  afvi(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Afli;
      this.jdField_a_of_type_Afli = null;
  ...
  public boolean b(String paramString)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    if (!((ankf)localObject).a(str, paramString, this.jdField_a_of_type_Int, i, new afvj(this, localWeakReference)))
    {
