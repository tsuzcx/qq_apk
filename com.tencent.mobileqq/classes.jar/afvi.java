  ...
  extends ArkViewModel
{
  ...
  protected static ArrayList<WeakReference<afvi>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<afvi> c;
  boolean c;
  private String d;
  protected WeakReference<afvl> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new afvj();
  }
  
  public afvi() {}
  
  public afvi(boolean paramBoolean) {}
  ...
  public static WeakReference<afvi> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      afvi localafvi = (afvi)localWeakReference.get();
      if ((localafvi != null) && (localafvi.getContainer() == paramContainer)) {
  ...
  {
    this.jdField_d_of_type_JavaLangRefWeakReference = new WeakReference(paramafvl);
  }
  ...
  {
    afvl localafvl = (afvl)this.jdField_d_of_type_JavaLangRefWeakReference.get();
    if (localafvl != null) {
      localafvl.openCardView(this, paramString1, paramString2);
    }
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new afvk(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      aovl.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693345);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693346);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
