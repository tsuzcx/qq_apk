  ...
  implements nfr
{
  ...
  private CopyOnWriteArrayList<WeakReference<nhg>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  private lpm jdField_a_of_type_Lpm;
  private mwf jdField_a_of_type_Mwf = new mwf();
  protected nfq a;
  private nhf jdField_a_of_type_Nhf;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = 1;; paramInt1 = 0)
    {
      ...
      if (this.jdField_a_of_type_Lpm == null)
      {
        ...
        this.jdField_a_of_type_Lpm.a(this.jdField_a_of_type_JavaLangInteger.intValue(), this.jdField_b_of_type_JavaLangInteger.intValue());
      }
      return;
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender.drawTexture(36197, this.jdField_a_of_type_Nfq.a(), this.jdField_a_of_type_ArrayOfFloat, this.jdField_b_of_type_ArrayOfFloat);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nhg)localWeakReference.get()).a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangInteger.intValue(), this.jdField_b_of_type_JavaLangInteger.intValue(), paramLong);
      }
    }
    if (this.jdField_b_of_type_Boolean) {
      this.jdField_a_of_type_Mwf.a(this.jdField_a_of_type_JavaLangInteger.intValue(), this.jdField_b_of_type_JavaLangInteger.intValue(), 15);
    }
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread == null)
    {
      ...
      this.jdField_a_of_type_Nhf = new nhf(this, this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread.getLooper());
      this.jdField_a_of_type_Nhf.sendEmptyMessage(152);
    }
  }
  ...
  private void j()
  {
    ...
    Matrix.setIdentityM(this.jdField_b_of_type_ArrayOfFloat, 0);
    this.jdField_a_of_type_Nfq.a(this, this.jdField_a_of_type_Nhf);
  }
  ...
  public long a()
  {
    if (this.jdField_a_of_type_Nfq != null) {
      return this.jdField_a_of_type_Nfq.a();
    }
    return 0L;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Nfq != null) {
      this.jdField_a_of_type_Nfq.a();
    }
    if (this.jdField_a_of_type_Nhf != null) {
      this.jdField_a_of_type_Nhf.sendEmptyMessage(258);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Nfq == null) || (this.jdField_a_of_type_Nfq.a() == null) || (this.jdField_a_of_type_Nfq.a() == -1)) {}
    do
    {
      return;
      this.jdField_a_of_type_Nfq.a().updateTexImage();
      this.jdField_a_of_type_Nfq.a().getTransformMatrix(this.jdField_a_of_type_ArrayOfFloat);
    } while (!this.c);
  ...
  public void a(TPAudioFrameBuffer paramTPAudioFrameBuffer)
  {
    ...
    if (Build.VERSION.SDK_INT >= 16)
    {
      ...
      {
        mxh.a();
        mxh.a(arrayOfByte, this.jdField_a_of_type_JavaLangFloat.floatValue());
      }
      mxh.a().a(arrayOfByte, arrayOfByte.length);
    }
    label273:
    ...
    {
      mxh.a();
      mxh.a(paramTPAudioFrameBuffer.data[0], this.jdField_a_of_type_JavaLangFloat.floatValue());
    }
    mxh.a().a(paramTPAudioFrameBuffer.data[0], paramTPAudioFrameBuffer.data[0].length);
  }
  ...
  public void a(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nhg)localWeakReference.get()).a(paramString);
      }
    }
  }
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    this.jdField_a_of_type_Nhh.a(this.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_Nfq != null) {
      this.jdField_a_of_type_Nfq.a(this.jdField_a_of_type_JavaLangString, paramLong);
    }
    if (Build.VERSION.SDK_INT >= 16) {
      mxh.a().a(3);
    }
  ...
  public void a(List<nhd> paramList)
  {
    QLog.d("AVGameMediaPlayerCtrl", 1, "setPreLoadVideoResourceInfos infoList:=" + Arrays.toString(paramList.toArray()));
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      nhd localnhd = (nhd)paramList.next();
      this.jdField_a_of_type_Nhh.a(localnhd.jdField_a_of_type_JavaLangString, localnhd.jdField_a_of_type_Long, 3000L);
    }
  }
  
  public void a(nhg paramnhg)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (paramnhg == localWeakReference.get())) {
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramnhg));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Nfq != null) {
      this.jdField_a_of_type_Nfq.a(true);
    }
  }
  ...
  public boolean a()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        bool1 = bool2;
        if (this.jdField_a_of_type_Nfq.a()) {
          bool1 = true;
        }
      }
    }
    do
    {
      return bool1;
      bool1 = bool2;
    } while (this.jdField_a_of_type_Nfq == null);
    return this.jdField_a_of_type_Nfq.a();
  }
  ...
  public void b(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nhg)localWeakReference.get()).b(paramString);
      }
    }
  }
  ...
  public void b(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Nhh.a(this.jdField_a_of_type_JavaLangString);
      if (this.jdField_a_of_type_Nfq != null) {
        this.jdField_a_of_type_Nfq.b(this.jdField_a_of_type_JavaLangString, paramLong);
      }
    }
  }
  
  public void b(nhg paramnhg)
  {
  ...
  {
    bcef.b(null, "dc00898", "", "", "0X800B1F3", "0X800B1F3", 0, 0, "", "", "", "");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nhg)localWeakReference.get()).c(paramString);
      }
    }
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Nhh = new nhh();
    this.jdField_a_of_type_Nfq = new nfq();
    i();
  }
  ...
  public void d(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nhg)localWeakReference.get()).d(paramString);
      }
    }
  }
  ...
  public void g()
  {
    ...
    {
      if (this.jdField_a_of_type_Nhf != null) {
        this.jdField_a_of_type_Nhf.sendEmptyMessage(153);
      }
  ...
  public void h()
  {
    ...
    bija.d("AVGameMediaPlayerCtrl", "init scaleFacors:=" + this.jdField_a_of_type_JavaLangFloat);
  }
}
