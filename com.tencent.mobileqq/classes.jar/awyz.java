  ...
  extends awul
{
  ...
  public awyz()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new awza(this);
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new awzb(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBundle = paramBundle.getDrawable(2130841217);
        if (TextUtils.isEmpty(this.S))
        {
          ...
          paramView.setContentDescription(paramBundle.getString(2131629081));
          paramView.setDisplayRuleDef(bbhq.a);
          paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
          paramView.setContentDescription(paramBundle.getText(2131653917));
        }
      }
