  ...
  extends xom
{
  ...
  private static ConcurrentHashMap<String, bbxb> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public static void a(bbxb parambbxb)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambbxb.a(), parambbxb);
  }
  
  public static void b(bbxb parambbxb)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(parambbxb.a());
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    else
    {
      ...
      {
        paramToServiceMsg = ((bbxb)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramToServiceMsg.getServiceCmd())).a(paramToServiceMsg, paramFromServiceMsg, localUniPacket);
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    Object localObject = (bbxb)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramToServiceMsg.getServiceCmd());
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((bbxb)localObject).a(paramToServiceMsg, paramUniPacket, i);
    return true;
  }
