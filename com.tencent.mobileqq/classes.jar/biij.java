...
public class biij
{
  ...
  public static void a(String paramString, MessageMicro paramMessageMicro, Class paramClass, anui paramanui)
  {
    ((VasExtensionHandler)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(71)).a(paramString, paramMessageMicro, paramClass, paramanui);
  }
  
  public static void a(String paramString1, String paramString2, anui paramanui)
  {
    ((VasExtensionHandler)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(71)).a(paramString1, paramString2, paramanui);
  }
  
  public static void a(String paramString, byte[] paramArrayOfByte, anui paramanui)
  {
    ((VasExtensionHandler)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(71)).a(paramString, paramArrayOfByte, paramanui);
  }
