...
public class biij
{
  ...
  private static biij jdField_a_of_type_Biij;
  static WeakReference<BrowserAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private static final ArrayList<biim> jdField_a_of_type_JavaUtilArrayList = new ArrayList(5);
  final MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new biik(this);
  boolean jdField_a_of_type_Boolean = false;
  
  public static biij a()
  {
    if (jdField_a_of_type_Biij == null) {}
    try
    {
      if (jdField_a_of_type_Biij == null) {
        jdField_a_of_type_Biij = new biij();
      }
      return jdField_a_of_type_Biij;
    }
    finally {}
  }
  ...
  static void a()
  {
    try
    {
      nwo.a("downloadX5KernelIfNeeded");
      ...
      if (localBrowserAppInterface != null)
      {
        ...
        if (TbsDownloader.needDownload(BaseApplication.getContext(), false, false, new biil()))
        {
      ...
      for (;;)
      {
        nwo.b("downloadX5KernelIfNeeded");
        return;
        label91:
  ...
  public void a(biim parambiim)
  {
    if (Looper.myLooper() == Looper.getMainLooper())
    {
      ...
      } while (((biim)localIterator.next()).jdField_a_of_type_Int != parambiim.jdField_a_of_type_Int);
    }
    do
    {
      return;
      jdField_a_of_type_JavaUtilArrayList.add(parambiim);
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      biim localbiim = (biim)localIterator.next();
      if (localbiim.jdField_a_of_type_Int == paramInt)
      {
        jdField_a_of_type_JavaUtilArrayList.remove(localbiim);
        return true;
      }
    }
    return false;
