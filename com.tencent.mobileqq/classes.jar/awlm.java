...
public class awlm
  extends bhap
{
  public awlm(GameRoomInviteActivity paramGameRoomInviteActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new awln(this));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.a.setText(amtj.a(2131704221));
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.c();
    ...
    this.a.jdField_a_of_type_Bhar.a();
  ...
  public void a(submsgtype0xdd.MsgBody paramMsgBody)
  {
    ...
    case 1: 
      do
      {
        ...
        {
          ((awmf)localObject).jdField_a_of_type_Boolean = bool;
