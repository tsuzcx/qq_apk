  ...
  extends Drawable
{
  ...
  public bhit(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof bhit))) {}
    Object localObject;
    do
    {
    ...
    return new bhit((Bitmap)localObject);
  }
  
  public static bhit a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new bhit(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (bhiu.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public bhit a(float paramFloat)
  {
  ...
  public bhit a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public bhit a(ColorStateList paramColorStateList)
  {
  ...
  public bhit a(Shader.TileMode paramTileMode)
  {
  ...
  public bhit a(ImageView.ScaleType paramScaleType)
  {
  ...
  public bhit a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public bhit b(Shader.TileMode paramTileMode)
  {
