...
public class bhit
  extends bhim
{
  private bhim jdField_a_of_type_Bhim;
  private ConcurrentHashMap<String, MusicItemInfo> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentHashMap<String, batm> b;
  
  public bhit(ConcurrentHashMap<String, MusicItemInfo> paramConcurrentHashMap, ConcurrentHashMap<String, batm> paramConcurrentHashMap1, bhim parambhim)
  {
  ...
  {
    this.jdField_a_of_type_Bhim.a(paramInt);
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Bhim.a(paramString);
    bhpu.a(localMusicItemInfo).c();
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_Bhim.a(paramString, i);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bhim.a(paramString, paramBoolean);
      return;
      label60:
      localMusicItemInfo.mProgress = 1;
    }
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    for (bool = paramBoolean;; bool = paramBoolean)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      this.b.remove(paramString);
      this.jdField_a_of_type_Bhim.a(paramString, bool, paramInt);
      return;
      label214:
      localMusicItemInfo.mProgress = -1;
      bhpu.a(localMusicItemInfo).c();
