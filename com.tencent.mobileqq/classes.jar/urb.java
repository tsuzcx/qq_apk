...
public class urb
{
  ...
  public static <I> I a(Class<I> paramClass)
  {
    ...
    {
      ClassLoader localClassLoader = urb.class.getClassLoader();
      urc localurc = new urc();
      return Proxy.newProxyInstance(localClassLoader, new Class[] { paramClass }, localurc);
    }
  ...
  public static <T> T a(Class<T> paramClass, Object[] paramArrayOfObject)
  {
    ...
    for (int j = 0;; j = arrayOfClass1.length)
    {
      ...
      catch (InstantiationException paramArrayOfObject)
      {
        int k;
        Class[] arrayOfClass2;
        throw new IllegalStateException(paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + alud.a(2131708071), paramArrayOfObject);
      }
      catch (IllegalAccessException paramArrayOfObject)
      {
        throw new IllegalStateException(paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + alud.a(2131708072), paramArrayOfObject);
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        throw new IllegalStateException(alud.a(2131708070) + paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + alud.a(2131708073), localNoSuchMethodException);
        if (arrayOfClass2[i].isPrimitive()) {
          if (arrayOfClass1[i] == null)
          {
            i = 0;
      ...
      break label107;
      label300:
      wxe.e("NullableObjectFactoryImplement", "虽然不是直接匹配, 但是还是找到了" + paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + ")的构造函数");
      break;
      i = 1;
      break label131;
      label492:
