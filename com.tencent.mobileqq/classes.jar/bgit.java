...
public abstract class bgit
  implements bgfh, bgfl
{
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, bgfl parambgfl, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambgfl, paramBoolean);
  }
  
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, bgfl parambgfl, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      QLog.e("BaseUpdateCallback", 1, "x86 not support");
      if (parambgfl != null) {
        parambgfl.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambgfl == null);
    parambgfl.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambgfl != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambgfl));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambgfl);
        ...
        parambgfl.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambgfl);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, bgfl parambgfl, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambgfl, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bgfl)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bgfl)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((bgfl)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((bgfl)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bgfl)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((bgfl)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, bgfl parambgfl)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambgfl, false);
    weakListeners.a(paramString, parambgfl, true);
  }
}
