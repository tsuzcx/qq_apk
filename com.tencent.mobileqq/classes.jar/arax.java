...
{
  public static ConcurrentHashMap<String, arax> a;
  ...
  private arax(Context paramContext, String paramString1, String paramString2)
  {
  ...
  public static <T extends arae<Y>, Y> T a(Y paramY, Class<T> paramClass)
  {
    arae localarae = (arae)aran.a(paramClass);
    try
    {
      localarae.a(paramY);
      return localarae;
    ...
    {
      araq.a().a(paramClass, paramY);
      throw new QStorageInstantiateException("readJsonOrXml exception too much", paramY);
    }
  }
  
  public static arax a(String paramString)
  {
    if (!a(paramString)) {
      QLog.d("QStorage", 1, "buildQStorage notRegister " + paramString);
    }
    Object localObject = (arax)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject == null) {
      synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        arax localarax = (arax)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        localObject = localarax;
        if (localarax == null)
        {
          localObject = new arax(BaseApplicationImpl.getContext(), paramString, MobileQQ.sMobileQQ.waitAppRuntime(null).getAccount());
  ...
  public <T extends Serializable> T a(String paramString, Class<T> paramClass, int paramInt)
  {
    ...
    return (Serializable)a(localFile, "", paramClass, paramInt, new araz(this, localFile, paramString));
  }
  
  public <JavaBean, Param> JavaBean a(File paramFile, Param paramParam, Class<JavaBean> paramClass, int paramInt, arad<JavaBean, Param> paramarad)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramInt == 1) || (str1 == null) || (!arak.a().a(this.jdField_a_of_type_JavaLangString, this.b, str1)) || (paramFile.exists())) {
          break;
        }
    ...
    try
    {
      paramParam = paramarad.a(paramFile, paramParam);
    ...
    catch (Exception paramParam)
    {
      for (;;)
      {
        araq.a().a(paramarad, paramFile, paramParam);
        ...
        if (str2 != null)
        {
          arak.a().a(this.jdField_a_of_type_JavaLangString, this.b, str2);
          paramParam = paramFile;
        }
      }
    }
  ...
  /* Error */
  public <DATA> void a(File paramFile, DATA paramDATA, arad<String, DATA> paramarad)
  {
    // Byte code:
    //   0: aload_3
    //   1: aload_1
    ...
    //   28: astore_2
    //   29: invokestatic 190	arak:a	()Larak;
    //   32: aload_0
    //   33: getfield 32	arax:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   36: aload_0
    //   37: getfield 36	arax:b	Ljava/lang/String;
    //   40: aload_2
    //   41: invokevirtual 224	arak:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   44: invokestatic 190	arak:a	()Larak;
    //   47: aload_0
    //   48: getfield 32	arax:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   51: aload_0
    //   52: getfield 36	arax:b	Ljava/lang/String;
    //   55: aload_2
    //   56: invokevirtual 220	arak:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   59: return
    //   60: astore_2
    //   61: ldc 113
    //   63: iconst_1
    ...
    //   90: invokestatic 95	araq:a	()Laraq;
    //   93: aload_3
    //   94: aload_1
    //   95: aload_2
    //   96: invokevirtual 214	araq:a	(Larad;Ljava/io/File;Ljava/lang/Exception;)V
    //   99: return
    //   100: astore_1
    //   101: return
    ...
    //   0	102	3	paramarad	arad<String, DATA>
    //   17	3	4	bool	boolean
    // Exception table:
    //   from	to	target	type
  ...
  {
    a(a(paramString, ".serial"), paramT, new aray(this, paramString, paramT));
  }
}
