  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private int jdField_b_of_type_Int = 2131755843;
  ...
  public mlh(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewWindowManager = ((WindowManager)paramContext.getSystemService("window"));
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131559831, null);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(this);
  }
  
  public TextView a()
  {
    return (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371803);
  }
  ...
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366345)).setImageBitmap(paramBitmap);
  }
  
  public void a(Bitmap paramBitmap, String paramString)
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366345)).setImageBitmap(paramBitmap);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371803)).setText(paramString);
  }
  
  public void a(String paramString)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370922));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370922);
    Button localButton1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361816);
    Button localButton2 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376497);
    ...
    if (paramBoolean3) {
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131695097));
      }
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(localTextView.getResources().getString(2131695098));
      continue;
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131695096));
      } else {
        localTextView.setText(localTextView.getResources().getString(2131695099));
      }
    }
  }
  ...
  void b()
  {
    ...
    for (;;)
    {
      ...
      {
        lbd.h("VideoInviteFloatBar", "startHandler error : " + localException2);
      }
  ...
  {
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378949));
  ...
  public void c()
  {
    Object localObject = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361816);
    Button localButton = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376497);
    ((Button)localObject).setVisibility(4);
    localButton.setVisibility(4);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370922);
    this.jdField_a_of_type_AndroidViewView.invalidate();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131361816: 
      ...
      for (;;)
      {
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361816)).setClickable(false);
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376497)).setClickable(false);
