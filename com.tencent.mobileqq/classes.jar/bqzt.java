  ...
  implements zqq
{
  ...
  bqzt(bqzq parambqzq, PublishVideoEntry paramPublishVideoEntry, String paramString1, String paramString2)
  {
  ...
  public void onFinish(boolean paramBoolean)
  {
    ...
    ((HashMap)localObject).put("generate_video_cost", this.jdField_a_of_type_Bqzq.a + "");
    ((HashMap)localObject).put("watermark_cost", d + "");
    bdmc.a(BaseApplication.getContext()).a(null, "qq_ptv_save_time", true, 0L, 0L, (HashMap)localObject, null);
    bhmi.d(this.jdField_a_of_type_JavaLangString);
    SaveVideoActivity.a(false);
    int i;
    Intent localIntent;
    if (bqzq.a(this.jdField_a_of_type_Bqzq).get() != null)
    {
      localObject = (Activity)bqzq.a(this.jdField_a_of_type_Bqzq).get();
      if (bqzq.b(this.jdField_a_of_type_Bqzq).get() != null) {
        SaveVideoActivity.a((AppInterface)bqzq.b(this.jdField_a_of_type_Bqzq).get(), this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
      }
      if (!paramBoolean) {
        break label340;
      }
      i = bqzq.b(this.jdField_a_of_type_Bqzq, -1);
      if (!born.e(((Activity)localObject).getIntent())) {
        break label353;
      }
    ...
    bqzq.a(this.jdField_a_of_type_Bqzq, bqzq.a(this.jdField_a_of_type_Bqzq));
  }
  ...
  public void onSuccess(String paramString)
  {
    ...
    zom.a(BaseApplication.getContext(), new File(this.b));
    bhmi.d(new File(this.jdField_a_of_type_JavaLangString).getParent());
  }
}
