  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public avkp(HiBoomPanelView paramHiBoomPanelView)
  {
  ...
  {
    avkq localavkq;
    if ((paramViewHolder instanceof avkq))
    {
      localavkq = (avkq)paramViewHolder;
      localavkq.jdField_a_of_type_Int = paramInt;
      if (localavkq.jdField_a_of_type_Boolean) {
        break label41;
      }
    }
    for (;;)
    {
      ...
      label41:
      int i = a(paramInt);
      ViewGroup.LayoutParams localLayoutParams = localavkq.itemView.getLayoutParams();
      localLayoutParams.height = HiBoomPanelView.jdField_a_of_type_Int;
      localLayoutParams.width = HiBoomPanelView.b;
      localavkq.itemView.setPadding(0, 0, HiBoomPanelView.c, HiBoomPanelView.c);
      localLayoutParams = localavkq.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomTextView.getLayoutParams();
      ...
      this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.a(localavkq, i);
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    try
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext()).inflate(2131563057, paramViewGroup, false);
      localObject = paramViewGroup;
      if (paramViewGroup == null) {
        localObject = new View(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext());
      }
      return new avkq(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView, (View)localObject, bool);
    }
