...
public class bixy
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, biya parambiya)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bixz(parambiya, paramString));
    if (!bdje.a(paramQQAppInterface))
    {
      if (parambiya != null)
      {
        ...
        parambiya.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
