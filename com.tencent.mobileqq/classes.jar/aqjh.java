  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public aqjh(Context paramContext, mxu parammxu)
  {
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    bfqn.a(paramContext, String.valueOf(bbtm.a().a()), localQZoneShareData, null, 1003);
    awqx.b(null, "dc00898", "", this.jdField_a_of_type_Mxu.a.a, "0X80092A4", "0X80092A4", 0, 0, this.jdField_a_of_type_Mxu.a.c, "", "", this.jdField_a_of_type_Mxu.a.jdField_b_of_type_JavaLangString);
  }
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    if (a(paramContext, paramInt))
    {
      ...
      if (jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1) {
        a(paramContext, paramString1, paramString2, asmd.a(jdField_a_of_type_ComTencentImageURLDrawable), paramString3, paramInt);
      }
    }
    else
    {
    ...
    jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new aqji(this, paramContext, paramString1, paramString2, paramString3, paramInt));
    jdField_a_of_type_ComTencentImageURLDrawable.downloadImediatly();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, Bitmap paramBitmap, String paramString4, int paramInt)
  {
    if (paramInt == 1001)
    {
      ...
      awqx.b(null, "dc00898", "", this.jdField_a_of_type_Mxu.a.a, "0X80092A3", "0X80092A3", 0, 0, this.jdField_a_of_type_Mxu.a.c, "", "", this.jdField_a_of_type_Mxu.a.jdField_b_of_type_JavaLangString);
    }
    while (paramInt != 1002) {
      return;
    }
    WXShareHelper.a().a(paramString1, paramString2, paramBitmap, paramString3, paramString4);
    awqx.b(null, "dc00898", "", this.jdField_a_of_type_Mxu.a.a, "0X80092A5", "0X80092A5", 0, 0, this.jdField_a_of_type_Mxu.a.c, "", "", this.jdField_a_of_type_Mxu.a.jdField_b_of_type_JavaLangString);
  }
  
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    paramString4 = new awui(StructMsgForGeneralShare.class).c(127).b(12345).e(paramString4).a(ajjy.a(2131639953) + paramString3).a();
    Object localObject = this.jdField_a_of_type_Mxu.a.v;
    String str = this.jdField_a_of_type_Mxu.a.w;
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      paramString4.mSourceName = this.jdField_a_of_type_Mxu.a.v;
      if (!TextUtils.isEmpty(str)) {
        paramString4.mSourceIcon = this.jdField_a_of_type_Mxu.a.w;
      }
    }
    paramString4.mContentLayout = 2;
    localObject = awuv.a(2);
    ((awum)localObject).a(paramString1, paramString2, paramString3);
    paramString4.addItem((awul)localObject);
    ...
    aphp.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramString1, 1000);
    awqx.b(null, "dc00898", "", this.jdField_a_of_type_Mxu.a.a, "0X80092A2", "0X80092A2", 0, 0, this.jdField_a_of_type_Mxu.a.c, "", "", this.jdField_a_of_type_Mxu.a.jdField_b_of_type_JavaLangString);
  }
  ...
  private boolean a(Context paramContext, int paramInt)
  {
    ...
    {
      bbmy.a(paramContext, 2131628757, 0).a();
      return false;
    }
    if (!WXShareHelper.a().b())
    {
      bbmy.a(paramContext, 2131655009, 0).a();
      return false;
    }
    ...
    {
      bbmy.a(this.jdField_a_of_type_AndroidContentContext, 1, 2131628948, 1).a();
      return false;
    }
    return true;
  }
  ...
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      if (!bool) {
        bbmy.a(paramContext, 2131652209, 0).a();
      }
      return bool;
  ...
  public bahx a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, String paramString)
  {
    bahx localbahx = new bahx();
    localbahx.a = this.jdField_a_of_type_AndroidContentContext.getString(paramInt1);
    localbahx.jdField_b_of_type_Int = paramInt2;
    localbahx.jdField_b_of_type_Boolean = paramBoolean;
  ...
  public List<bahx>[] a()
  {
    ...
    localArrayList.add(a(2131630983, 2130838732, true, 2, ""));
    localArrayList.add(a(2131630996, 2130838733, true, 3, ""));
    localArrayList.add(a(2131631003, 2130838736, true, 9, ""));
    localArrayList.add(a(2131630986, 2130838730, true, 10, ""));
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      if ("onshare_ItemClick mAdItem " + this.jdField_a_of_type_Mxu == null)
      {
    ...
    else
    {
      ...
      if ((localObject2 != null) && (this.jdField_a_of_type_Mxu != null)) {
        break label73;
      }
    }
    label73:
    ...
    {
      return;
      paramAdapterView = this.jdField_a_of_type_Mxu.toString();
      break;
      str2 = this.jdField_a_of_type_Mxu.a.x;
      paramView = this.jdField_a_of_type_Mxu.a.t;
      localObject1 = this.jdField_a_of_type_Mxu.a.s;
      String str1 = this.jdField_a_of_type_Mxu.a.u;
      paramAdapterView = paramView;
      if (TextUtils.isEmpty(paramView)) {
        paramAdapterView = this.jdField_a_of_type_Mxu.e;
      }
      paramView = (View)localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        paramView = this.jdField_a_of_type_Mxu.d;
      }
      localObject1 = str1;
      if (TextUtils.isEmpty(str1)) {
        localObject1 = this.jdField_a_of_type_Mxu.f;
      }
    } while (!a(this.jdField_a_of_type_AndroidContentContext, paramView, paramAdapterView, str2));
    switch (((baia)localObject2).a.c)
    {
    }
    for (;;)
    {
