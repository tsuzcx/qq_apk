...
public class alzl
{
  public static void a(alzf paramalzf, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((!paramFromServiceMsg.isSuccess()) || (paramObject == null))
    {
      ...
      paramalzf.notifyUI(121, false, new Object[] { null, null });
      return;
    }
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(".troop.troopManagerTroopHandler", 2, new Object[] { "handleTroopBulkSendMessageRespond, ", xnh.a(localRspSend1V1Msg) });
      }
      paramalzf.notifyUI(121, true, new Object[] { localRspSend1V1Msg, localReqSend1V1Msg });
      return;
    }
  ...
  public static void a(@NonNull alzf paramalzf, @NonNull homework.ReqSend1V1Msg paramReqSend1V1Msg)
  {
    if (QLog.isColorLevel()) {
      QLog.i(".troop.troopManagerTroopHandler", 2, "sendTroopBulkSendMessageRequest");
    }
    ToServiceMsg localToServiceMsg = paramalzf.createToServiceMsg("HwSvc.send_msg");
    localToServiceMsg.putWupBuffer(paramReqSend1V1Msg.toByteArray());
    paramalzf.a(localToServiceMsg);
  }
}
