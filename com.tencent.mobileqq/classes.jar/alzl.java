...
public class alzl
{
  ...
  private static int a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    //   8: new 20	axlo
    //   11: dup
    //   12: invokespecial 24	axlo:<init>	()V
    //   15: astore 9
    //   17: aload 9
    //   19: iload_3
    //   20: putfield 28	axlo:c	I
    //   23: aload 9
    //   25: iload_3
    //   26: putfield 31	axlo:d	I
    //   29: aload 9
    //   31: ldc 33
    //   33: putfield 36	axlo:a	Ljava/lang/String;
    //   36: aload 9
    //   38: iload 4
    //   40: putfield 39	axlo:e	I
    //   43: aload_1
    //   44: aload_2
    //   45: aload 9
    //   47: invokestatic 42	alzl:a	(Ljava/lang/String;Ljava/lang/String;Laxlo;)[Ljava/lang/String;
    //   50: astore_1
    //   51: aload_1
    //   52: ifnonnull +8 -> 60
    //   55: ldc 44
    //   57: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   60: aload_0
    ...
    //   99: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    ...
    //   187: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   190: aload_1
    //   191: arraylength
    //   192: istore 4
    //   194: iconst_0
    ...
    //   292: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   295: aload 10
    ...
    //   390: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   393: aload 12
    //   395: astore 11
    //   397: aload_1
    //   398: astore 10
    ...
    //   445: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   448: goto -55 -> 393
    //   451: astore 13
    //   453: sipush -1001
    //   456: istore 4
    ...
    //   506: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   509: aload_0
    //   510: ifnull +7 -> 517
    //   513: aload_0
    ...
    //   578: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   581: iload_3
    //   582: ifeq +46 -> 628
    ...
    //   625: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   628: iload_3
    //   629: ireturn
    //   630: aload 12
    //   632: astore 11
    ...
    //   653: astore 9
    //   655: ldc 184
    //   657: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   660: aload_0
    //   661: ifnull +7 -> 668
    //   664: aload_0
    ...
    //   764: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   767: aload_0
    //   768: ifnull +7 -> 775
    //   771: aload_0
    ...
    //   871: invokestatic 47	alzl:a	(Ljava/lang/String;)V
    //   874: aload_0
    //   875: ifnull +7 -> 882
    //   878: aload_0
  ...
  public static int a(String paramString1, String paramString2, int paramInt1, Context paramContext, int paramInt2)
  {
    ...
    {
      axlo localaxlo = ShortVideoTrimmer.a(paramString1);
      localaxlo.c = paramInt1;
      localaxlo.d = paramInt1;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localaywa.i = paramString;
    localaywa.jdField_a_of_type_Long = System.currentTimeMillis();
    localaywa.b = paramInt1;
    paramString = new lld();
    paramString.a(paramInt2);
    paramString.a(paramInt3);
    localaywa.jdField_a_of_type_ArrayOfByte = paramString.a();
    paramQQAppInterface.a().a(localaywa);
  }
  ...
  private static String[] a(String paramString1, String paramString2, axlo paramaxlo)
  {
    ...
    String str2 = paramaxlo.c + "x" + String.valueOf(paramaxlo.d);
    a("[@] generateCommand threads=" + str1 + "  resolution=" + str2);
    return new String[] { "-d", "-y", "-threads", str1, "-copyts", "-copytb", "0", "-i", paramString1, "-metadata:s", "rotate=" + paramaxlo.a, "-acodec", "aac", "-vcodec", "libx264", "-preset", "ultrafast", "-tune", "fastdecode", "-profile:v", "High", "-level", "1.3", "-minrate", "300k", "-maxrate", "600k", "-bufsize", "800k", "-qmin", "1", "-qmax", String.valueOf(paramaxlo.e), "-qdiff", "3", "-bf", "3", "-coder", "1", "-refs", "1", "-s", str2, "-movflags", "faststart", paramString2 };
  }
