  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), axzz.class);
  ...
  private void a(oidb_0xca6.RspBody paramRspBody, Intent paramIntent, int paramInt)
  {
    ...
    if ((getAppRuntime() instanceof QQAppInterface))
    {
      ...
      localFriends = localamsw.d(localQQAppInterface.getCurrentUin());
    ...
    for (i = 0;; i = 1)
    {
      ...
      localamsw.a(localFriends);
      ((axvk)localQQAppInterface.getManager(369)).b(paramInt, paramIntent);
      return;
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   7: istore_3
    //   8: aload_2
    //   9: invokevirtual 319	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   12: ifeq +282 -> 294
    ...
    //   22: astore 5
    //   24: aload_2
    //   25: invokevirtual 322	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   28: invokestatic 325	java/nio/ByteBuffer:wrap	([B)Ljava/nio/ByteBuffer;
    //   31: astore_2
    //   32: aload_2
    //   33: invokevirtual 328	java/nio/ByteBuffer:getInt	()I
    //   36: iconst_4
    //   37: isub
    //   38: newarray byte
    //   40: astore 6
    //   42: aload_2
    //   43: aload 6
    //   45: invokevirtual 330	java/nio/ByteBuffer:get	([B)Ljava/nio/ByteBuffer;
    //   48: pop
    //   49: aload 5
    //   51: aload 6
    //   53: invokevirtual 334	tencent/im/oidb/oidb_sso$OIDBSSOPkg:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   56: pop
    //   57: aload 5
    //   59: astore 6
    //   61: aload 6
    //   63: getfield 103	tencent/im/oidb/oidb_sso$OIDBSSOPkg:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   66: invokevirtual 336	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   69: istore 4
    ...
    //   79: iconst_2
    //   80: iconst_2
    //   81: anewarray 338	java/lang/Object
    //   84: dup
    //   85: iconst_0
    //   86: ldc_w 340
    //   89: aastore
    ...
    //   91: iconst_1
    //   92: iload 4
    //   94: invokestatic 345	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   97: aastore
    //   98: invokestatic 348	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   101: iload 4
    //   103: ifne +179 -> 282
    //   106: aload 6
    //   108: getfield 107	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   111: invokevirtual 351	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   114: ifeq +168 -> 282
    //   117: aload 6
    //   119: getfield 107	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   122: invokevirtual 354	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   125: ifnull +157 -> 282
    //   128: aload 6
    //   130: getfield 107	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   133: invokevirtual 354	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   136: invokevirtual 355	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   139: astore_2
    //   140: new 154	tencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody
    //   143: dup
    //   144: invokespecial 356	tencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody:<init>	()V
    //   147: astore 5
    //   149: aload 5
    //   151: aload_2
    //   152: invokevirtual 357	tencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   155: pop
    //   156: aload 5
    //   158: getfield 360	tencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody:ret	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   161: invokevirtual 361	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   164: ifeq +118 -> 282
    //   167: aload 5
    //   169: getfield 360	tencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody:ret	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   172: invokevirtual 336	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   175: ifne +107 -> 282
    //   178: aload 5
    ...
    //   183: invokevirtual 362	tencent/im/oidb/cmd0xca6/WeatherReportStore$WeatherInfo:has	()Z
    //   186: ifeq +96 -> 282
    //   189: aload 5
    ...
    //   194: invokevirtual 363	tencent/im/oidb/cmd0xca6/WeatherReportStore$TipsList:has	()Z
    //   197: ifeq +85 -> 282
    //   200: aload_0
    //   201: aload 5
    //   203: aload_1
    //   204: iload_3
    //   205: invokespecial 365	axzz:a	(Ltencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody;Landroid/content/Intent;I)V
    //   208: new 367	android/os/Bundle
    //   211: dup
    //   212: invokespecial 368	android/os/Bundle:<init>	()V
    //   215: astore_2
    //   216: aload_2
    //   217: ldc 35
    //   219: iload_3
    //   220: invokevirtual 371	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   223: aload_0
    //   224: aload_1
    //   225: iconst_1
    //   226: iconst_1
    //   227: aload_2
    //   228: ldc_w 373
    //   231: invokevirtual 377	axzz:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   234: return
    //   235: astore 5
    //   237: aconst_null
    //   238: astore_2
    ...
    //   251: ldc_w 379
    //   254: aload 5
    //   256: invokestatic 382	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   259: aload_2
    //   260: astore 6
    //   262: goto -201 -> 61
    //   265: astore_2
    ...
    //   275: ldc_w 384
    //   278: aload_2
    //   279: invokestatic 382	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   282: aload_0
    //   283: aload_1
    //   284: iconst_1
    //   285: iconst_0
    //   286: aconst_null
    //   287: ldc_w 373
    //   290: invokevirtual 377	axzz:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   293: return
    //   294: invokestatic 53	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   297: ifeq -15 -> 282
    //   300: ldc 55
    //   302: iconst_2
    //   303: new 266	java/lang/StringBuilder
    //   306: dup
    //   307: invokespecial 385	java/lang/StringBuilder:<init>	()V
    //   310: ldc_w 387
    //   313: invokevirtual 274	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   316: aload_2
    //   317: invokevirtual 390	com/tencent/qphone/base/remote/FromServiceMsg:getResultCode	()I
    //   320: invokevirtual 393	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   323: invokevirtual 292	java/lang/StringBuilder:toString	()Ljava/lang/String;
