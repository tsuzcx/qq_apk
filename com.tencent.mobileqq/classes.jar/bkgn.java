  ...
  extends LinearLayout
{
  ...
  public bkgn(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bkfw parambkfw)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = bkht.a(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = bkht.a(getContext(), 7.0F);
      }
  ...
  public void a(bkfs parambkfs, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject = parambkfs.a(paramInt2);
      localImageView.setTag(2131376880, localObject);
      localImageView.setTag(2131376871, Integer.valueOf(paramInt2));
      if (parambkfs.a(paramInt2) != 1) {
        break label252;
      }
      if (!(getContext() instanceof EditPicActivity)) {
        break label158;
      }
      localObject = parambkfs.b(paramInt2);
      localImageView.setTag(2131376880, localObject);
      bkbg.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      localObject = bbql.a(BaseApplicationImpl.sApplication.getRuntime(), (String)localObject, "-Dynamic-", null, new int[] { 13 }, "-Dynamic-", null);
      if (localObject != null)
      {
