public class bkgn
{
  ...
  public static void a(android.content.Context paramContext, java.lang.String paramString1, java.lang.String paramString2)
  {
    ...
    //   361: ifnull -346 -> 15
    //   364: aload_0
    //   365: invokevirtual 113	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   368: return
    //   369: astore_0
    //   370: aload_0
    //   371: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   374: return
    //   375: aload 8
    //   377: ifnull -362 -> 15
    //   380: aload 8
    //   382: invokevirtual 113	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   385: return
    //   386: astore_0
    //   387: aload_0
    //   388: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   391: return
    //   392: astore_0
    //   393: aload 7
    //   395: astore 8
    ...
    //   399: ifnull +8 -> 407
    //   402: aload 8
    //   404: invokevirtual 113	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   407: aload_0
    //   408: athrow
    //   409: astore_1
    //   410: aload_1
    //   411: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   414: goto -7 -> 407
    //   417: astore_1
    //   418: goto -285 -> 133
    //   421: astore_0
    ...
    //   425	26	6	localIOException	java.io.IOException
    ...
    //   4	429	7	localObject3	Object
    //   27	376	8	localObject4	Object
    ...
    //   129	133	417	java/io/IOException
    //   299	304	421	java/io/IOException
    //   261	265	425	java/io/IOException
    //   272	276	430	java/io/IOException
    //   341	346	437	java/io/IOException
    //   350	354	441	java/io/IOException
    //   86	92	445	finally
    //   129	133	445	finally
    //   137	145	445	finally
    //   261	265	445	finally
