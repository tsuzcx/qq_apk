  ...
  extends bbkn
{
  ...
  public bbky(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, List<FTSMessage> paramList, String paramString3, CharSequence paramCharSequence)
  {
    ...
    {
      i = ((ankw)paramQQAppInterface.getManager(53)).a(this.jdField_d_of_type_JavaLangString);
      if (i <= 0) {
        this.f = "";
      }
    }
  ...
  public CharSequence a()
  {
    if (this.jdField_a_of_type_JavaLangCharSequence == null) {
      this.jdField_a_of_type_JavaLangCharSequence = bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int);
    }
  ...
  public void a(View paramView)
  {
    ...
    if ((paramView.getContext() instanceof UniteSearchActivity)) {
      ...
      {
        localObject1 = (bbhe)bbhd.b.get(this);
    ...
    try
    {
      ...
      localJSONObject.put("obj_lct", ((bbhe)localObject1).jdField_a_of_type_Int);
      localJSONObject.put("get_src", "native");
      bbrf.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((bbhe)localObject1).jdField_a_of_type_Long + "").obj2(((bbhe)localObject1).jdField_b_of_type_JavaLangString).ver1(((bbhe)localObject1).jdField_a_of_type_JavaLangString).ver2(bbrf.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(localJSONObject.toString()).session_id(((QQAppInterface)localObject2).getCurrentAccountUin() + bbhd.jdField_a_of_type_Long));
      bbrf.a(null, this.t, 0, "0X8009D4D", 0, 0, null, null);
      if (this.jdField_a_of_type_JavaLangCharSequence != null) {
        this.jdField_a_of_type_JavaLangCharSequence = bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int, this.jdField_e_of_type_JavaLangString);
      }
      localObject1 = (Integer)paramView.getTag(2131380930);
      localObject2 = (Integer)paramView.getTag(2131380928);
      if (((paramView.getContext() instanceof UniteSearchActivity)) && (((Integer)localObject1).intValue() >= 0) && (((Integer)localObject2).intValue() >= 0))
      {
        bbup.a("all_result", "clk_talk", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + localObject2, "" + (((Integer)localObject1).intValue() + 1) });
        if (this.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label699;
        }
        bgur.f = 1;
        bgur.jdField_d_of_type_Int = this.jdField_a_of_type_Int;
        bgur.g = this.jdField_e_of_type_Int;
        bgur.h = this.jdField_b_of_type_Int;
        bgur.i = this.jdField_c_of_type_Int;
        bgur.j = this.jdField_d_of_type_Int;
        bguq.a(paramView);
        if (this.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label725;
        }
        ...
        if (((FTSMessage)localObject1).msgExts != null)
        {
          ...
          aldk.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject1).msgExts).shmsgseq;
        }
        anuq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
        aldk.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int, (String)this.jdField_a_of_type_JavaLangCharSequence, false);
        bbup.a(this.jdField_a_of_type_JavaLangString, 40, paramView, false);
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        ...
        {
          bbup.a("talk", "clk_talk", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + localObject2, "" + (((Integer)localObject1).intValue() + 1) });
          continue;
          label699:
          bgur.f = 2;
          continue;
          label706:
          aldk.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject1).msgExts).time;
          continue;
          label725:
  ...
  public CharSequence c()
  {
    ...
    if (this.jdField_d_of_type_JavaLangCharSequence == null)
    {
      ...
      if (i == 1) {
        this.jdField_d_of_type_JavaLangCharSequence = bbup.a(((FTSEntity)this.jdField_a_of_type_JavaUtilList.get(0)).mContent, ((FTSEntity)this.jdField_a_of_type_JavaUtilList.get(0)).mProximityStart, this.jdField_a_of_type_JavaUtilArrayList);
      }
    }
    else
    {
    ...
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder(i + anni.a(2131703744) + "\"");
    if ((this.jdField_c_of_type_JavaLangString != null) && ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))) {
      localSpannableStringBuilder.append(bbup.a(this.jdField_c_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString));
    }
    for (;;)
    {
