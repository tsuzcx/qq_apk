...
public class arlm
{
  ...
  public static bdnt a(appoint_define.RichText paramRichText)
  {
    return a(paramRichText, 16);
  }
  
  public static bdnt a(appoint_define.RichText paramRichText, int paramInt)
  {
    return a(auoo.a(paramRichText), paramInt);
  }
  
  public static bdnt a(String paramString, int paramInt)
  {
    return new bdnt(paramString, 5, paramInt);
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((JSONObject)localObject5).has("audio_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + anni.a(2131705724);
            }
          ...
          if (((JSONObject)localObject5).has("video_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + anni.a(2131705725);
            }
          }
          else
          {
            ...
            if (((JSONObject)localObject5).has("pic_list"))
            {
              ...
              {
                localObject4 = localObject3;
                localObject1 = (String)localObject3 + anni.a(2131705723);
              }
            }
            else
            {
      ...
      if (i < ((JSONArray)localObject5).length())
      {
        ...
        {
          localObject4 = localObject3;
          localObject1 = (String)localObject3 + anni.a(2131705721);
          break label450;
        }
        localObject4 = localObject3;
        localObject1 = localObject3;
        ...
        localObject4 = localObject3;
        localObject1 = (String)localObject3 + anni.a(2131705722);
        break label450;
  ...
  {
    return (paramInt == -2053) && (!paramString.equals(String.valueOf(1822701914L + anhk.g))) && (!paramString.equals("1822701914"));
  }
  ...
  public static boolean a(QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramMessage.msgtype == -2011) {
      localMessageRecord = paramQQAppInterface.a(1001).a(anhk.I, 1001, paramMessage.uniseq);
    }
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        str1 = paramString;
        str2 = paramString;
        if (paramString.indexOf('\024' + bdnh.a[i]) == -1) {
          break label268;
        }
        str1 = paramString;
        str2 = paramString.replace('\024' + bdnh.a[i], "\024" + (char)i);
      }
      ...
      if (i < bdnh.a.length)
      {
        str2 = paramString;
        str1 = paramString;
        if (paramString.indexOf(bdnh.a[i]) != -1)
        {
          str1 = paramString;
          str2 = paramString.replace(bdnh.a[i], "\024" + (char)i);
        }
        i += 1;
        paramString = str2;
      }
