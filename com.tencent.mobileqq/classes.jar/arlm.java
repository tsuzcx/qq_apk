  ...
  extends arjj<arll>
{
  ...
  @NonNull
  public arll a(aqxa[] paramArrayOfaqxa)
  {
    int j = -1;
    ...
    if (i < m)
    {
      ...
      int k = localaqxa.jdField_a_of_type_Int;
      if (k < j) {
        ykq.e("QVipStickerProcessor", "received old task id " + k + ", latest task id: " + j);
      }
      for (;;)
      {
        i += 1;
        ...
        try
        {
          JSONObject localJSONObject = new JSONObject(new String(localaqxa.jdField_a_of_type_JavaLangString.getBytes("utf-8")));
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          ...
          ykq.e("QVipStickerProcessor", "item.content=" + localaqxa.jdField_a_of_type_JavaLangString + " e=" + localUnsupportedEncodingException);
        }
        catch (JSONException localJSONException)
        {
          localJSONException.printStackTrace();
          ykq.e("QVipStickerProcessor", "item.content=" + localaqxa.jdField_a_of_type_JavaLangString + " e=" + localJSONException);
        }
      }
    }
    return new arll();
