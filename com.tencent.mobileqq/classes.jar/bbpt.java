  ...
  extends VasQuickUpdateManager.CallBacker
{
  ...
  public void callback(long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, VasQuickUpdateManager paramVasQuickUpdateManager)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if ("iRedPacket_v3.char300.json".equals(paramString1))
        {
          ...
          axqy.b((QQAppInterface)localObject1, "CliOper", "", "", "0X800612D", "0X800612D", 0, 0, (String)???, paramVasQuickUpdateManager, "1", "");
        }
        else if ("iRedPacket_v3.font.zip".equals(paramString1))
        {
          this.a.jdField_a_of_type_Bbpx.e = i;
          if (bool)
          {
            paramVasQuickUpdateManager = new File(ajzd.a(null, null, 21, 0, 0));
            this.a.a(true, false, paramString1, paramVasQuickUpdateManager);
          }
          localObject1 = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
          ??? = ajzd.c;
          ...
          paramVasQuickUpdateManager = "1";
          axqy.b((QQAppInterface)localObject1, "CliOper", "", "", "0X800612C", "0X800612C", 0, 0, (String)???, paramVasQuickUpdateManager, "1", "");
        }
        else
        {
          ...
          if (bool)
          {
            paramVasQuickUpdateManager = new File(ajzd.a(null, null, 25, 0, 0));
            this.a.a(true, false, paramString1, paramVasQuickUpdateManager);
          }
        }
      }
    ...
    label453:
    Object localObject1 = ajzd.a(paramString1);
    label560:
    if (bool)
    {
      paramVasQuickUpdateManager = this.a.a((String)localObject1);
      if ((paramVasQuickUpdateManager != null) && (this.a.jdField_a_of_type_Ajzd != null))
      {
        ??? = ajzd.a((String)localObject1, null, paramVasQuickUpdateManager.jdField_a_of_type_Bbpv.f, paramVasQuickUpdateManager.jdField_a_of_type_Bbpv.d, 0);
        ??? = (String)??? + "_dir2";
    ...
    for (;;)
    {
      ...
      synchronized (this.a.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (i < ((List)localObject3).size())
        {
          ...
          this.a.jdField_a_of_type_Ajzd.a(str, paramVasQuickUpdateManager.jdField_a_of_type_Bbpv.f);
          this.a.jdField_a_of_type_Ajzd.a(str + "_tp", paramVasQuickUpdateManager.b.f);
          this.a.jdField_a_of_type_Ajzd.a(str + "_send", paramVasQuickUpdateManager.c.f);
        }
      }
      ...
      Object localObject3 = ajzd.c;
      if (bool) {}
      for (paramVasQuickUpdateManager = "1";; paramVasQuickUpdateManager = "0")
      {
        axqy.b((QQAppInterface)???, "CliOper", "", "", "0X800612E", "0X800612E", 0, 0, (String)localObject3, paramVasQuickUpdateManager, "1", (String)localObject1);
        break;
      }
      label1059:
