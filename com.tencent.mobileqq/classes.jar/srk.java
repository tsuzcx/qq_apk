  ...
  implements View.OnClickListener
{
  ...
  private List<spz> jdField_a_of_type_JavaUtilList = new ArrayList();
  private spy jdField_a_of_type_Spy;
  private srq jdField_a_of_type_Srq;
  public int b;
  public View b;
  public ImageView b;
  ...
  public srk(Activity paramActivity, View paramView, int paramInt1, int paramInt2, srq paramsrq)
  {
    super(paramView);
    ...
    this.jdField_a_of_type_Anoz = new anoz(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130845490);
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362426));
    this.jdField_b_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362439));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131362501));
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewRoundCornerLayout = ((RoundCornerLayout)paramView.findViewById(2131362429));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362503));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362498));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362441));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362482));
    this.e = ((TextView)paramView.findViewById(2131362502));
    this.f = ((TextView)paramView.findViewById(2131362484));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362435));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362431);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362440));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362476));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131363996));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363997));
    this.g = ((TextView)paramView.findViewById(2131363998));
    ...
    this.jdField_a_of_type_AndroidOsHandler = new sro(this, Looper.getMainLooper());
    paramActivity = (spn)tcz.a(30);
  ...
  private int a()
  {
    ...
    if (this.jdField_a_of_type_Spy != null) {
      i = this.jdField_a_of_type_Spy.e;
    }
    return i;
  }
  
  private int a(List<spz> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      i = j;
      if (new File(((spz)paramList.get(j)).jdField_a_of_type_JavaLangString).exists()) {
        break;
      }
      j += 1;
    }
  ...
  private Drawable a(String paramString)
  {
    ...
    //   64: ldc_w 298
    //   67: aload_3
    //   68: invokestatic 303	ved:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   71: aload_2
    //   72: ifnull +49 -> 121
    //   75: aload_2
  ...
  private URLDrawable a(String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean, srk paramsrk)
  {
    QQLiveDrawable.QQLiveDrawableParams localQQLiveDrawableParams = new QQLiveDrawable.QQLiveDrawableParams();
    paramsrk = new srr(paramsrk);
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = this.jdField_a_of_type_Anoz;
    if (!paramBoolean) {
    ...
    {
      localQQLiveDrawableParams.mListener = paramsrk;
      localQQLiveDrawableParams.mDownloadListener = paramsrk;
      paramString2 = URLDrawable.URLDrawableOptions.obtain();
      paramString2.mExtraInfo = localQQLiveDrawableParams;
      paramString2.mFailedDrawable = this.jdField_a_of_type_Anoz;
      paramString2.mLoadingDrawable = this.jdField_a_of_type_Anoz;
  ...
  {
    if (this.jdField_a_of_type_Spy != null) {
      this.jdField_a_of_type_Spy.e = paramInt;
    }
  }
  ...
  {
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg :%s", new Object[] { this.jdField_a_of_type_Spy });
    this.jdField_c_of_type_Int = 3;
    if (paramList.size() == 0)
    {
      ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , no pic list");
      return;
    }
    ...
    {
      ved.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , %s", paramList);
      return;
    }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Spy.a() == 0) {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetLinearLayout.getVisibility() == 0) && (this.jdField_b_of_type_AndroidWidgetLinearLayout.getAnimation() == null))
    {
      ...
      localAlphaAnimation.setAnimationListener(new srl(this));
    ...
    if (i < 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Spy.jdField_b_of_type_JavaLangString);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Spy.a(((List)localObject).size()))) {
        break label364;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(ajya.a(2131700170), new Object[] { this.jdField_a_of_type_Spy.jdField_b_of_type_JavaLangString, Integer.valueOf(((List)localObject).size()) }));
    }
    for (;;)
    {
      this.f.setText(String.valueOf(this.jdField_a_of_type_Spy.b()));
      this.e.setText(this.jdField_a_of_type_Spy.a());
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView.setLocalDrawable(((spz)((List)localObject).get(i)).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      break;
      label364:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Spy.a(((List)localObject).size()));
    }
  }
  ...
  private void e()
  {
    ...
    a(localHashSet);
    tsr.a(this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView, null, this.jdField_b_of_type_JavaLangString, false, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131700176));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131700178));
  }
  ...
  private void f()
  {
    ...
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845492);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845490);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131700185));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700168));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131700186));
    this.g.setText(ajya.a(2131700163));
  }
  ...
  private void g()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845495);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845490);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131700179));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700183));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131700189));
    this.g.setText(ajya.a(2131700161));
  }
  ...
  private void h()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845491);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845490);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131700187));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700188));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131700184));
    this.g.setText(ajya.a(2131700164));
  }
  ...
  private void i()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845493);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845490);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131700174));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700169));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131700180));
    this.g.setText(ajya.a(2131700182));
  }
  
  private void j()
  {
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop :%s", new Object[] { this.jdField_a_of_type_Spy });
    if ((this.jdField_a_of_type_Spy == null) || (this.jdField_a_of_type_Spy.a()))
    {
      ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,album not exist");
      this.jdField_c_of_type_Int = 0;
      return;
    }
    ...
    {
      ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,get pick count not enough ,size = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
      this.jdField_c_of_type_Int = 0;
      return;
    }
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop success ,get pick count = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
  }
  
  private void k()
  {
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayLoop");
    this.jdField_c_of_type_Int = 0;
    ...
    if (this.jdField_a_of_type_Spy != null)
    {
      localObject = this.jdField_a_of_type_Spy.a();
      if (((List)localObject).size() <= 0) {
        break label111;
      }
    }
    label111:
    for (Object localObject = ((spz)((List)localObject).get(0)).jdField_a_of_type_JavaLangString;; localObject = "")
    {
  ...
  private void l()
  {
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayMp4 :%s", new Object[] { this.jdField_a_of_type_Spy });
    ...
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_Anoz;
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_Anoz;
  ...
  private void m()
  {
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4");
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_ComTencentImageURLDrawable != null)
    {
      if ((this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable() instanceof QQLiveDrawable))
      {
        ...
        ved.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4 suc");
      }
  ...
  private void o()
  {
    ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayCenterImg");
    this.jdField_c_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Spy != null) {
      a(this.jdField_a_of_type_Spy);
    }
  }
  
  public void a(@NonNull spy paramspy)
  {
    if ((this.jdField_a_of_type_Spy != null) && (!this.jdField_a_of_type_Spy.equals(paramspy)) && (this.jdField_c_of_type_Int != 0)) {
      c();
    }
    this.jdField_a_of_type_Spy = paramspy;
    Object localObject = this.jdField_a_of_type_Spy.a();
    paramspy = new ArrayList();
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      spz localspz = (spz)((Iterator)localObject).next();
      if (localspz.a()) {
        paramspy.add(localspz);
      }
    }
    this.jdField_a_of_type_JavaUtilList = paramspy;
    if (this.jdField_c_of_type_Int == 0)
    {
      if (!this.jdField_a_of_type_Spy.a()) {
        break label185;
      }
      if (this.jdField_a_of_type_Spy.jdField_d_of_type_Int == 1) {
        e();
      }
    }
    else
    ...
    if (this.jdField_a_of_type_Spy.jdField_d_of_type_Int == 3)
    {
      f();
      return;
    }
    if (this.jdField_a_of_type_Spy.jdField_d_of_type_Int == 2)
    {
      g();
      return;
    }
    if (this.jdField_a_of_type_Spy.jdField_d_of_type_Int == 5)
    {
      i();
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Spy == null) {
      ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , startPlay error!");
    }
    do
    {
      do
    ...
    } while (this.jdField_a_of_type_Spy.jdField_d_of_type_Int != 2);
    a(spj.a().a(spj.jdField_a_of_type_Int));
    return;
    j();
  }
  ...
  {
    if (this.jdField_a_of_type_Spy == null) {
      ved.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , stopPlay error!");
    }
    while (this.jdField_c_of_type_Int == 0) {
      return;
    }
    ved.a("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stop play :%s", this.jdField_a_of_type_Spy);
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_Spy.a()) {
      if (this.jdField_a_of_type_Spy.jdField_d_of_type_Int == 1) {
        m();
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i < 3)
      {
        ...
        paramView = new srm(this);
        paramView = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, 2131558906, ajya.a(2131700165), null, ajya.a(2131700172), ajya.a(2131700175), paramView, paramView);
      ...
      for (;;)
      {
        vei.a("video_shoot_slides", "delete_smartalbum", 0, 0, new String[] { String.valueOf(this.jdField_a_of_type_Spy.d()), "1" });
        return;
        if (this.jdField_a_of_type_Srq != null) {
          this.jdField_a_of_type_Srq.b(this.jdField_a_of_type_Spy);
        }
      }
    } while (vzl.b());
    bjkv.a(this.jdField_a_of_type_AndroidViewView, 300L, new srn(this), new float[] { 1.0F, 0.95F, 1.0F });
  }
}
