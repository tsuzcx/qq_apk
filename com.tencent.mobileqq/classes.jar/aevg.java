  ...
  extends aeun
{
  ...
  public aevg(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (aeqi)aepi.a((View)localObject1);
          if ((((aeqi)localObject2).jdField_a_of_type_Int != 0) && (((aeqi)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.jdField_g_of_type_Int > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((aeqi)aepi.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  int a(int paramInt, aeqi paramaeqi)
  {
    int k;
    int m;
    int n;
    if (paramaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramaeqi.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramaeqi.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.i - BaseChatItemLayout.n;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramaeqi.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.i + BaseChatItemLayout.n;
      m = paramaeqi.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.j;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localaeqi = (aeqi)aepi.a(localBaseChatItemLayout);
          if (localaeqi != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localaeqi.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localaeqi.jdField_a_of_type_AndroidViewView.getLeft() + localaeqi.jdField_a_of_type_AndroidViewView.getRight()) / 2, localaeqi);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localaeqi != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localaeqi) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = aepi.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          aeqi localaeqi = (aeqi)aepi.a(aepi.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localaeqi != null)
          {
            k = localaeqi.jdField_a_of_type_AndroidViewView.getTop();
            k = localaeqi.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = aepi.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = aepi.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localaeqi = (aeqi)aepi.a(aepi.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localaeqi != null)
              {
                k = localaeqi.jdField_a_of_type_AndroidViewView.getTop();
                k = localaeqi.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localaeqi = (aeqi)aepi.a(aepi.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localaeqi != null)
              {
                k = localaeqi.jdField_a_of_type_AndroidViewView.getTop();
                k = localaeqi.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
