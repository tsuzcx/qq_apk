...
{
  private static pca jdField_a_of_type_Pca;
  private BackgroundColorSpan jdField_a_of_type_AndroidTextStyleBackgroundColorSpan;
  
  public static pca a()
  {
    if (jdField_a_of_type_Pca == null) {
      jdField_a_of_type_Pca = new pca();
    }
    return jdField_a_of_type_Pca;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 2) || (i == 3))
    {
      ...
      if ((paramTextView.getTag(2131376220) != null) && ((paramTextView.getTag(2131376220) instanceof Boolean)) && (((Boolean)paramTextView.getTag(2131376220)).booleanValue()))
      {
        ...
        {
          return true;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130849372));
          continue;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130849377));
        }
      }
    }
    return false;
