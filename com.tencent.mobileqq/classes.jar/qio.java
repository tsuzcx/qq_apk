...
public final class qio
{
  ...
  private final pfh jdField_a_of_type_Pfh;
  private final qim jdField_a_of_type_Qim;
  ...
  static
  {
    jdField_a_of_type_Qiq = new qiq(null);
  }
  
  public qio(@NotNull ViewGroup paramViewGroup, @NotNull qim paramqim)
  {
    this.jdField_b_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_Qim = paramqim;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this.jdField_b_of_type_AndroidViewViewGroup.getContext()).inflate(2131562798, this.jdField_b_of_type_AndroidViewViewGroup, false);
    paramViewGroup = this.jdField_b_of_type_AndroidViewView;
    if (paramViewGroup != null)
    {
      paramViewGroup = paramViewGroup.findViewById(2131373229);
      this.jdField_a_of_type_AndroidViewView = paramViewGroup;
      paramViewGroup = this.jdField_a_of_type_AndroidViewView;
      if (paramViewGroup == null) {
        break label310;
      }
      paramViewGroup = (ImageView)paramViewGroup.findViewById(2131373223);
      label104:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373233);
      label128:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373227);
      label152:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131365336);
      label176:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373231);
      label200:
      ...
      paramViewGroup = (ImageView)paramViewGroup.findViewById(2131364599);
      label224:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373228);
      label248:
    ...
    label340:
    label345:
    for (paramViewGroup = (ViewGroup)paramViewGroup.findViewById(2131373226);; paramViewGroup = null)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
      this.jdField_a_of_type_Pfh = ((pfh)new qip(this));
      b();
      c();
      a();
      return;
  ...
  private final void a()
  {
    ...
    if (localView != null) {
      localView.addOnAttachStateChangeListener((View.OnAttachStateChangeListener)new qir(this));
    }
  }
  ...
  private final void a(boolean paramBoolean, Function0<Unit> paramFunction0)
  {
    ...
    if (paramBoolean)
    {
      localTranslateAnimation = new TranslateAnimation(0.0F, 0.0F, bhgr.a(this.jdField_b_of_type_AndroidViewViewGroup.getContext(), 152.0F), 0.0F);
    ...
    for (AlphaAnimation localAlphaAnimation = new AlphaAnimation(0.0F, 1.0F);; localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener((Animation.AnimationListener)new qix(paramFunction0));
      ...
      return;
      localTranslateAnimation = new TranslateAnimation(0.0F, 0.0F, 0.0F, bhgr.a(this.jdField_b_of_type_AndroidViewViewGroup.getContext(), 152.0F));
      break;
    }
  }
  ...
  private final void b()
  {
    ...
    {
      if (((CharSequence)this.jdField_a_of_type_Qim.a()).length() == 0)
      {
        i = 1;
        if (i == 0) {
          break label599;
    ...
    else
    {
      ...
      if (localObject1 != null) {
        ((RelativeLayout.LayoutParams)localObject1).bottomMargin = this.jdField_a_of_type_Qim.b();
      }
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)qig.a.a().a());
      }
      if (this.jdField_a_of_type_Qim.a() != 1) {
        break label615;
      }
      localObject1 = this.d;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)qig.a.a().b());
      }
      ...
      localObject1 = this.e;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)qig.a.a().c());
      }
      ...
      label266:
      if (!this.jdField_a_of_type_Qim.a()) {
        break label763;
      }
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setCompoundDrawablesWithIntrinsicBounds(2130849441, 0, 0, 0);
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = ((Resources)localObject1).getDrawable(2130849437);
        label352:
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = ((Resources)localObject1).getDrawable(2130849443);
        label433:
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          localObject1 = localObject3;
          if (localObject4 != null) {
            localObject1 = ((Resources)localObject4).getDrawable(2130849439);
          }
        }
        ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
      }
      ...
      if (localObject1 != null)
      {
        localObject1 = ((View)localObject1).findViewById(2131371836);
        if (localObject1 != null) {
          if (!this.jdField_a_of_type_Qim.b()) {
            break label1060;
          }
        }
      }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      break;
      label599:
      localObject1 = this.jdField_a_of_type_Qim.a();
      break label79;
      label610:
      localObject1 = null;
      break label106;
      label615:
      if (this.jdField_a_of_type_Qim.a() != 2) {
        break label266;
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetImageView;
      if (localObject1 != null) {
      ...
      localObject1 = this.d;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)qig.a.a().d());
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)qig.a.a().e());
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetTextView;
      if (localObject1 == null) {
        break label266;
      }
      ((TextView)localObject1).setText((CharSequence)qig.a.a().f());
      break label266;
      label748:
      localObject1 = null;
      break label352;
      ...
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setCompoundDrawablesWithIntrinsicBounds(2130849442, 0, 0, 0);
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject1 != null)
          {
            localObject1 = ((Resources)localObject1).getDrawable(2130849438);
            label839:
            ((ImageView)localObject2).setImageDrawable((Drawable)localObject1);
          }
        }
      ...
      else
      {
        ...
        if (localObject2 != null)
        {
          ...
          localObject1 = ((Resources)localObject1).getDrawable(2130849433);
          ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        }
        localObject2 = this.jdField_b_of_type_AndroidWidgetTextView;
        if (localObject2 != null)
      ...
      for (localObject1 = ((Resources)localObject1).getDrawable(2130849433);; localObject1 = null)
      {
        ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        localObject2 = this.jdField_a_of_type_AndroidWidgetTextView;
        if (localObject2 != null)
        {
          ...
          if (localObject3 != null)
          {
            ...
            localObject1 = localObject4;
            if (localObject3 != null) {
              localObject1 = ((Resources)localObject3).getDrawable(2130849434);
            }
          }
          ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        }
  ...
  private final void c()
  {
    ...
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new qis(this));
    }
    localObject = this.jdField_b_of_type_AndroidWidgetTextView;
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new qit(this));
    }
    localObject = this.jdField_b_of_type_AndroidWidgetImageView;
    if (localObject != null) {
      ((ImageView)localObject).setOnClickListener((View.OnClickListener)new qiu(this));
    }
    localObject = this.e;
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new qiv(this));
    }
    localObject = this.c;
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new qiw(this));
    }
  }
  ...
  public final void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed((Runnable)new RIJPushNotifyDialog.show.1(this), qig.a.a().a());
  }
