...
class aare
  extends Handler
{
  aare(aarc paramaarc, Looper paramLooper)
  {
    super(paramLooper);
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                if ((localObject2 == null) || (!(localObject2 instanceof bika))) {
                  break;
                }
                ...
                localObject1 = (urx)aarc.jdField_a_of_type_JavaUtilHashMap.get(aarc.a(this.a));
                ...
                this.a.jdField_a_of_type_AndroidWidgetTextView.setText(((urx)localObject1).e + paramMessage.arg2 + "%");
                return;
                try
                {
                  ...
                  ((JSONObject)localObject2).put("data", nwo.a((String)localObject1));
          ...
          } while ((paramMessage.arg1 != 5) || (aarc.jdField_a_of_type_JavaUtilHashMap == null) || (TextUtils.isEmpty(aarc.a(this.a))));
          localObject2 = (urx)aarc.jdField_a_of_type_JavaUtilHashMap.get(aarc.a(this.a));
        } while (localObject2 == null);
        if (paramMessage.arg2 != 0) {
          break;
        }
        ((urx)localObject2).a(3);
      } while (localException2 == null);
      paramMessage = localException2.getResources().getDrawable(2130839441);
      ...
      if (this.a.jdField_a_of_type_AndroidWidgetTextView != null) {
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(((urx)localObject2).d);
      }
      if (this.a.jdField_a_of_type_AndroidWidgetProgressBar != null) {
