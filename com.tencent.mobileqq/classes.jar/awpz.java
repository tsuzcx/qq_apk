...
public abstract class awpz
{
  ...
  public awpz(long paramLong, String paramString, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_b_of_type_ComTencentUploadUinterfaceIUploadTaskCallback = new awqa(this);
    this.jdField_a_of_type_Long = paramLong;
    this.g = paramString;
    this.h = awpx.a(paramString);
