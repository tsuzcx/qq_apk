...
public class awpz
  implements Manager
{
  private awpu jdField_a_of_type_Awpu = new awpu("Cahce_");
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public awpz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  public ArrayList<awpx> a(String paramString)
  {
    if (this.jdField_a_of_type_Awpu != null)
    {
      paramString = this.jdField_a_of_type_Awpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Awpu != null)
    {
      this.jdField_a_of_type_Awpu.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  {
    b();
    this.jdField_a_of_type_Awpu = null;
