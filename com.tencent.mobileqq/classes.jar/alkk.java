  ...
  extends alko
{
  ...
  public alkk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      try
      {
        paramToServiceMsg = bcgq.a(l, paramFromServiceMsg.opt_msg_record.get().toByteArray(), paramFromServiceMsg.uint32_cur_cnt.get());
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (alws)this.app.getManager(22);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
    ...
    if (bdee.a(this.app.getApplication().getApplicationContext()) == 1)
    {
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (j == 1)
      {
        ...
        if (i == 1224)
        {
          bdiv.j(this.app.getApplication().getApplicationContext(), this.app.getCurrentAccountUin(), (String)localObject2);
  ...
  {
    bbmw localbbmw = new bbmw();
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      notifyUI(28, false, localbbmw);
      return;
    }
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null)) {
      notifyUI(41, false, new Object[] { Integer.valueOf(2131696607) });
    }
    for (;;)
    {
      return;
    ...
    if (localObject != null) {
      ((alzf)localObject).j(paramObject.troopuin);
    }
    localObject = (bbml)this.app.getManager(32);
    if (localObject != null) {
      ((bbml)localObject).a(this.app, paramObject.troopuin);
    }
    ...
    paramObject = (almv)this.app.getManager(53);
    ...
    notifyUI(41, true, new Object[] { Integer.valueOf(2131696614), paramToServiceMsg, paramFromServiceMsg, Boolean.valueOf(true) });
    return;
    label534:
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        if (i == 1328) {
          paramToServiceMsg[2] = alpo.a(2131701525);
        }
  ...
  public void a(String paramString1, int paramInt, @Nullable String paramString2)
  {
    ...
    if (bdiv.a(this.app.getApplication(), this.app.getCurrentAccountUin()).contains(str))
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      QQToast.a(BaseApplication.getContext(), 2131696588, 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131298914));
      return false;
    }
      ...
      do
      {
        ...
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        if (i == 2)
                        {
                          ((bcjl)this.app.getManager(48)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
                          return;
                        }
                        if (i == 3)
                        {
                  ...
                  paramToServiceMsg = (byte[])paramObject;
                  paramToServiceMsg = bckr.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
                ...
                {
                  bckr.a(this.app, i, l1, l2, s, paramToServiceMsg, l3, paramFromServiceMsg, j);
                  return;
                }
                if ("OidbSvc.0x852_48".equals(localObject))
                {
                  bckr.a(this.app, i, l1, l2, s, paramToServiceMsg, (short)k, bool);
                  return;
                }
              } while (!"OidbSvc.0x8ca_2".equals(localObject));
              ((alzf)this.app.a(20)).a(this.app, "" + l1, paramToServiceMsg, i);
              return;
            ...
            j = paramToServiceMsg.extraData.getInt("time");
            paramToServiceMsg = (byte[])paramObject;
            bckr.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
            return;
          ...
          paramToServiceMsg = (byte[])paramObject;
          paramToServiceMsg = bckr.a(this.app, l1, l2, paramToServiceMsg, j, i, bool);
