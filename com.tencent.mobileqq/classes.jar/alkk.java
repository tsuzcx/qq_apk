...
public class alkk
{
  ...
  public alkk(AbsListView paramAbsListView) {}
  ...
  private void d()
  {
    ...
    while (i < n)
    {
      ...
      while (k < i1 - m)
      {
        AbsListView.access$4300(this.jdField_a_of_type_ComTencentWidgetAbsListView, (View)localArrayList.remove(j), false);
        k += 1;
        j -= 1;
      }
      i += 1;
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (i != -2) {
          AbsListView.access$4000(this.jdField_a_of_type_ComTencentWidgetAbsListView, paramView, false);
        }
      }
      else
      {
        ...
        if (this.b == 1)
        {
          AbsListView.access$4100(this.jdField_a_of_type_ComTencentWidgetAbsListView, paramView);
  ...
  public void b()
  {
    ...
    if (this.b == 1)
    {
      ...
      while (i < j)
      {
        AbsListView.access$3800(this.jdField_a_of_type_ComTencentWidgetAbsListView, (View)localArrayList.remove(j - 1 - i), false);
        i += 1;
      }
    }
    int k = this.b;
    ...
    while (i < k)
    {
      ...
      while (j < m)
      {
        AbsListView.access$3900(this.jdField_a_of_type_ComTencentWidgetAbsListView, (View)localArrayList.remove(m - 1 - j), false);
        j += 1;
      }
      i += 1;
    }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetAbsListView$RecyclerListener != null)
    {
      ...
      if (localView != null)
      {
        ...
        if (m != -2)
        {
          AbsListView.access$4200(this.jdField_a_of_type_ComTencentWidgetAbsListView, localView, false);
          localObject2 = localObject1;
        }
      }
    }
    for (;;)
    {
      ...
      AbsListView.access$4100(this.jdField_a_of_type_ComTencentWidgetAbsListView, localView);
      ((AbsListView.LayoutParams)localObject2).b = (this.jdField_a_of_type_Int + k);
      ((ArrayList)localObject1).add(localView);
      localObject2 = localObject1;
      if (i != 0)
      {
        this.jdField_a_of_type_ComTencentWidgetAbsListView$RecyclerListener.b(localView);
        localObject2 = localObject1;
      }
    }
    label200:
