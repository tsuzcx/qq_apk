...
public class asoh
  implements AdapterView.OnItemClickListener, asut
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajsf.aW + "TempMail" + File.separator;
    j = ajyc.a(2131700115);
    jdField_b_of_type_JavaLangString = "0X8007F0A ";
  }
  
  public asoh(QQAppInterface paramQQAppInterface, Context paramContext, Activity paramActivity, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  {
    URL localURL = aywk.a(paramMessageForPic, 131075);
    if (ayog.a(localURL.toString()) != null) {
      return ayog.d(localURL.toString());
    }
    localURL = aywk.a(paramMessageForPic, 1);
    if (ayog.a(localURL.toString()) != null) {
      return ayog.d(localURL.toString());
    }
    paramMessageForPic = aywk.a(paramMessageForPic, 65537);
    if (ayog.a(paramMessageForPic.toString()) != null) {
      return ayog.d(paramMessageForPic.toString());
    }
    return null;
  }
  ...
  public static String a(MessageForPic paramMessageForPic, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramMessageForPic = "";
    if (str2.indexOf(".") == -1) {
      paramMessageForPic = bbdj.b(str1);
    }
    paramMessageForPic = ajyc.a(2131700119) + paramList1.size() + "." + paramMessageForPic;
    paramList1 = paramMessageForPic + ajyc.a(2131700114);
      ...
      if (paramMessageForStructing == null)
      {
        ...
        if (((StructMsgForGeneralShare)localObject2).mStructMsgItemLists != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject3 = (axxg)localObject3;
              localObject1 = paramMessageForStructing;
              if (((axxg)localObject3).a != null)
              {
                localObject3 = ((axxg)localObject3).a.iterator();
                for (;;)
                {
                  localObject1 = paramMessageForStructing;
                  ...
                  if ((localObject1 instanceof axzh)) {
                    paramMessageForStructing = ((axzh)localObject1).Y;
                  }
                }
              }
            }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramArrayList = Intent.createChooser((Intent)paramMap.remove(0), ajyc.a(2131700113));
    ...
    this.jdField_a_of_type_AndroidContentContext.startActivity(Intent.createChooser(localIntent, ajyc.a(2131700111)));
  }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, Intent paramIntent)
  {
    ...
    //   19: ifne +725 -> 744
    //   22: aload_0
    //   23: getfield 103	asoh:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   26: ldc_w 415
    ...
    //   37: iconst_0
    //   38: aload_0
    //   39: getfield 101	asoh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload 6
    //   44: getfield 421	com/tencent/mobileqq/data/ChatMessage:selfuin	Ljava/lang/String;
    //   47: invokestatic 426	bbcl:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   50: aastore
    //   51: dup
    //   52: iconst_1
    //   53: aload_0
    //   54: getfield 101	asoh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   57: aload 6
    //   59: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   62: invokestatic 426	bbcl:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   65: aastore
    ...
    //   80: pop
    //   81: getstatic 56	asoh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: invokestatic 438	bbdj:a	(Ljava/lang/String;Z)V
    //   88: new 47	java/io/File
    //   91: dup
    //   92: getstatic 56	asoh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   165: getstatic 56	asoh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: getstatic 64	asoh:j	Ljava/lang/String;
    ...
    //   180: invokestatic 448	bbdj:a	(Ljava/lang/String;)Ljava/io/File;
    //   183: pop
    ...
    //   199: getstatic 56	asoh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   202: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   205: getstatic 64	asoh:j	Ljava/lang/String;
    ...
    //   442: astore 7
    //   444: aload 5
    //   446: invokestatic 521	ayla:a	(Ljava/lang/String;)Z
    //   449: ifeq +1189 -> 1638
    //   452: aload 5
    //   454: invokestatic 522	ayla:d	(Ljava/lang/String;)Ljava/lang/String;
    //   457: astore 7
    //   459: goto +1179 -> 1638
    //   462: aload 6
    //   464: astore 7
    ...
    //   753: aload_0
    //   754: getfield 103	asoh:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   757: ldc_w 547
    ...
    //   768: iconst_0
    //   769: aload_0
    //   770: getfield 101	asoh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   773: aload 6
    //   775: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   778: invokestatic 549	bbcl:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   781: aastore
    ...
    //   801: aload_0
    //   802: getfield 103	asoh:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   805: ldc_w 547
    ...
    //   816: iconst_0
    //   817: aload_0
    //   818: getfield 101	asoh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   821: aload_0
    //   822: getfield 101	asoh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   833: invokestatic 558	bbcl:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   836: aastore
    ...
    //   868: aload 12
    //   870: aload 13
    //   872: invokestatic 563	asoh:a	(Lcom/tencent/mobileqq/data/MessageForPic;Ljava/util/List;Ljava/util/List;)Ljava/lang/String;
    //   875: astore 5
    //   877: goto -415 -> 462
    //   880: aload 16
    //   882: instanceof 565
    ...
    //   951: ldc_w 574
    //   954: invokestatic 62	ajyc:a	(I)Ljava/lang/String;
    ...
    //   993: ldc_w 577
    //   996: invokestatic 62	ajyc:a	(I)Ljava/lang/String;
    ...
    //   1111: ldc_w 595
    //   1114: invokestatic 62	ajyc:a	(I)Ljava/lang/String;
    //   1117: astore 5
    //   1119: goto -657 -> 462
    //   1122: ldc_w 597
    //   1125: aload 7
    ...
    //   1136: ifeq +14 -> 1150
    //   1139: ldc_w 603
    //   1142: invokestatic 62	ajyc:a	(I)Ljava/lang/String;
    //   1145: astore 5
    //   1147: goto -41 -> 1106
    //   1150: aload 7
    ...
    //   1163: aload_0
    //   1164: aload 7
    //   1166: invokevirtual 608	asoh:a	(Lcom/tencent/mobileqq/data/MessageForStructing;)Ljava/lang/String;
    //   1169: astore 5
    //   1171: goto -65 -> 1106
    //   1174: aload 7
    ...
    //   1277: aload_1
    //   1278: aload_0
    //   1279: getstatic 64	asoh:j	Ljava/lang/String;
    //   1282: invokevirtual 630	asoh:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1336: getstatic 56	asoh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1367: invokestatic 637	bbdj:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1370: ifeq -63 -> 1307
    //   1373: aload_1
    //   1374: aload_0
    //   1375: aload 13
    ...
    //   1394: invokevirtual 630	asoh:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1512: getstatic 56	asoh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1543: invokestatic 637	bbdj:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1546: ifeq -63 -> 1483
    //   1549: aload_1
    //   1550: aload_0
    //   1551: aload 11
    ...
    //   1570: invokevirtual 630	asoh:a	(Ljava/lang/String;)Landroid/net/Uri;
  ...
  public boolean a()
  {
    Iterator localIterator = asty.a().a.entrySet().iterator();
    boolean bool2 = false;
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        ...
        bool2 |= ajwd.a((MessageRecord)localObject);
        if (akqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        do
        {
          ...
          localObject = bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject);
        } while (localObject == null);
        bool1 = bool2;
        if (((azqt)localObject).jdField_b_of_type_Int == 8) {
          break;
        }
        bool1 = bool2;
        if (((azqt)localObject).jdField_b_of_type_Int == 9) {
          break;
        }
        bool1 = bool2;
        if (((azqt)localObject).jdField_b_of_type_Int == 6) {
          break;
        }
        bool1 = bool2;
        if (((azqt)localObject).jdField_b_of_type_Int == 7) {
          break;
        }
        if (((azqt)localObject).jdField_b_of_type_Int == 11)
        {
          bool1 = bool2;
          if (apvb.a(((azqt)localObject).jdField_a_of_type_JavaLangString)) {
            break;
          }
        }
      } while (((azqt)localObject).jdField_b_of_type_Int != 10);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  {
    if (((paramChatMessage instanceof MessageForPic)) && (ajwd.a(paramChatMessage))) {
      return false;
    }
    ...
    else if (((paramChatMessage instanceof MessageForPic)) && (aezn.a((MessageForPic)paramChatMessage)))
    {
      return false;
    }
    return akqb.a(paramChatMessage);
  }
  ...
  public List<bbje>[] a(Context paramContext)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      ((bbje)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131696701);
      ((bbje)localObject).jdField_b_of_type_Int = 2130839046;
      ((bbje)localObject).c = 25;
      ((bbje)localObject).jdField_b_of_type_JavaLangString = "";
      localArrayList.add(localObject);
      if (this.jdField_a_of_type_Boolean)
      {
        localObject = new bbje();
        ((bbje)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131692910);
        ((bbje)localObject).jdField_b_of_type_Int = 2130839641;
        ((bbje)localObject).c = 50;
        ((bbje)localObject).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject);
      }
      ...
      {
        localbbje = new bbje();
        localbbje.jdField_a_of_type_JavaLangString = paramContext.getString(2131696703);
        localbbje.jdField_b_of_type_Int = 2130839079;
      ...
      {
        localbbje = new bbje();
        localbbje.jdField_a_of_type_JavaLangString = paramContext.getString(2131696718);
        localbbje.jdField_b_of_type_Int = 2130839209;
        localbbje.jdField_b_of_type_Boolean = true;
        localbbje.c = 27;
        localbbje.jdField_b_of_type_JavaLangString = "";
        ((ArrayList)localObject).add(localbbje);
      ...
      localbbje.jdField_a_of_type_JavaLangString = paramContext.getString(2131696699);
      ...
      ((ArrayList)localObject).add(localbbje);
      localbbje = new bbje();
      localbbje.jdField_a_of_type_JavaLangString = paramContext.getString(2131696694);
      localbbje.jdField_b_of_type_Int = 2130839609;
      localbbje.jdField_b_of_type_Boolean = true;
      localbbje.c = 47;
      localbbje.jdField_b_of_type_JavaLangString = "";
      ((ArrayList)localObject).add(localbbje);
  ...
  public void b()
  {
    Iterator localIterator = asty.a().a().iterator();
    ...
    do
    {
      ...
      k = adtg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    } while ((!(localChatMessage instanceof MessageForPic)) || (k != 1) || (bbet.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localChatMessage, false)));
    for (boolean bool = true;; bool = false)
    {
      if ((this.jdField_a_of_type_Bbjc == null) || (this.jdField_a_of_type_Boolean != bool))
      {
        ...
        int m = this.jdField_a_of_type_Bbjc.b();
        this.jdField_a_of_type_Bbjc.c(Math.max(k, m));
  ...
  public void b(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    if (k < paramArrayList.size())
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = ajyc.a(2131700112);
        }
        else if ((localChatMessage instanceof MessageForShortVideo))
        {
          localObject1 = ajyc.a(2131700116);
        }
        else
        {
    ...
    for (;;)
    {
      ...
      localObject1 = ajyc.a(2131700118);
      break;
      ...
      else
      {
        ...
        if (((MessageForStructing)localObject1).structingMsg.mMsgUrl != null)
        {
          ...
          if (((localChatMessage instanceof MessageForArkFlashChat)) && (localChatMessage.msg != null))
          {
            ...
            bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694465, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
            return;
          }
          localObject1 = null;
          break;
  ...
  public boolean b()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        localObject = (ChatMessage)((Map.Entry)localObject).getKey();
        bool2 |= ajwd.a((MessageRecord)localObject);
        if (akqb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        ...
        localObject = (MessageForTroopFile)localObject;
      } while (bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject) == null);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  public boolean b(ChatMessage paramChatMessage)
  {
    ...
    if (((paramChatMessage instanceof MessageForPic)) && (aezn.a((MessageForPic)paramChatMessage))) {
      return false;
    }
    return akqb.a(paramChatMessage);
  }
  ...
  public boolean c()
  {
    ...
    Object localObject1 = asty.a().a();
    if (((List)localObject1).size() == 0)
    {
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698465, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ...
    if (localArrayList1.size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        bakj.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2);
      }
    }
    ...
    if (localArrayList2.size() > 0)
    {
      ...
      localObject2 = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if (localObject2 == null)
      {
        aptv.a(2131692666);
        return false;
      ...
      apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1, BaseActivity.sTopActivity);
    }
    while ((localArrayList1.size() == 0) && (localArrayList2.size() == 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2, BaseActivity.sTopActivity);
      }
    }
    return true;
  }
  ...
  public boolean e()
  {
    ...
    {
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694459, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((adiq)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 3);
    return true;
  }
  ...
  public boolean g()
  {
    ...
    if (localList.isEmpty())
    {
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694464, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((adiq)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 4);
    return true;
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 9: 
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", e, e, 0, 0, "", "", "", "");
        paramInt = -1;
        ...
        while (paramInt != -1)
        {
          bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_AndroidContentContext.getString(paramInt), 0).a();
          return;
        ...
        if (this.jdField_a_of_type_Bcwh != null) {
          this.jdField_a_of_type_Bcwh = new asoi(this);
        }
        WXShareHelper.a().a(this.jdField_a_of_type_Bcwh);
        ((adiq)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acut, true);
        return;
      case 25: 
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", f, f, 0, 0, "", "", "", "");
        if (!d())
        {
          bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694457)).setPositiveButton(17039370, new asom(this)).setNegativeButton(17039360, new asol(this)).show();
          return;
        }
        break;
      }
    } while ((asty.a().a().isEmpty()) || (!e()));
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
    return;
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", i, i, 0, 0, "", "", "", "");
    paramView = asty.a().a();
    ...
    if (paramView.hasNext())
    {
      ...
      k = adtg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1);
      if (((localObject1 instanceof MessageForPic)) && (k == 1))
      {
        if (bbet.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localObject1, false)) {
          break label1246;
        }
    ...
    for (;;)
    {
      ...
      {
        bcpw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131718828), 0).a();
        return;
      }
      ...
      aqno.a(this.jdField_a_of_type_AndroidAppActivity, paramView, (String)localObject1, (String)localObject2, k, paramAdapterView, 102);
      return;
      if (!b())
      {
        bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694468)).setPositiveButton(17039370, new asoo(this)).setNegativeButton(17039360, new ason(this)).show();
        return;
      }
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067F7", "0X80067F7", 0, 0, "", "", "", "");
      if (!c()) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", g, g, 0, 0, "", "", "", "");
      if (!a())
      {
        bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694466)).setPositiveButton(17039370, new asoq(this)).setNegativeButton(17039360, new asop(this)).show();
        return;
      }
      if (!bict.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), this.jdField_a_of_type_MqqOsMqqHandler)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", h, h, 0, 0, "", "", "", "");
      if (!f())
      {
        bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694463)).setPositiveButton(17039370, new asos(this)).setNegativeButton(17039360, new asor(this)).show();
        return;
      }
      if ((asty.a().a().isEmpty()) || (!g())) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      paramAdapterView = new asul(this.jdField_a_of_type_AndroidAppActivity);
      paramView = (asuu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(324);
      if ((paramView == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acut == null)) {
        break;
      }
      localObject1 = new ArrayList();
      localObject2 = asty.a().a.entrySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
      ...
      localObject1 = asup.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (List)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acut.a, this);
      if ((localObject1 == null) || (((List)localObject1).isEmpty()))
      {
        bcpw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131718827), 0).a();
        return;
      }
      ...
      paramView.a(new asoj(this, paramAdapterView, paramView, (List)localObject1));
