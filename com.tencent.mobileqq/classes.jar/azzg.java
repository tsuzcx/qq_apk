  ...
  implements azzf
{
  ...
  public static azzf a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.richmedia.ICallBack");
    if ((localIInterface != null) && ((localIInterface instanceof azzf))) {
      return (azzf)localIInterface;
    }
    return new azzh(paramIBinder);
  }
