  ...
  extends ajtb
{
  ...
  public akwp(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<MessageRecord> a()
  {
    ...
    long l2 = this.app.a().a((String)localObject1, 1038);
    long l1 = l2;
    if (l2 > System.currentTimeMillis()) {
      l1 = -1L;
    }
    Object localObject2 = this.app.a().a(1038).a((String)localObject1, 1038, l1);
      ...
      if (paramFromServiceMsg.item.has())
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (((oidb_cmd0xc76.Item)localObject4).id.has()) {
            localakwy.a(((oidb_cmd0xc76.Item)localObject4).id.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).icon.has()) {
            localakwy.b(((oidb_cmd0xc76.Item)localObject4).icon.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).type.has()) {
            localakwy.a(((oidb_cmd0xc76.Item)localObject4).type.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).name.has()) {
            localakwy.a(((oidb_cmd0xc76.Item)localObject4).name.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).value.has()) {
            localakwy.b(((oidb_cmd0xc76.Item)localObject4).value.get());
          }
          ((List)localObject1).add(localakwy.a());
        }
      }
      ((akwz)localObject2).jdField_a_of_type_JavaUtilList = ((List)localObject1);
      if (paramFromServiceMsg.desc.has()) {
        ((akwz)localObject2).jdField_a_of_type_JavaLangString = paramFromServiceMsg.desc.get();
      }
    ...
    if (paramRspBody.apps.has())
    {
      ...
      if (paramRspBody.item.has())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          localObject4 = new akwy();
          if (((oidb_cmd0xc76.Item)localObject3).id.has()) {
            ((akwy)localObject4).a(((oidb_cmd0xc76.Item)localObject3).id.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).icon.has()) {
            ((akwy)localObject4).b(((oidb_cmd0xc76.Item)localObject3).icon.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).type.has()) {
            ((akwy)localObject4).a(((oidb_cmd0xc76.Item)localObject3).type.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).name.has()) {
            ((akwy)localObject4).a(((oidb_cmd0xc76.Item)localObject3).name.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).value.has()) {
            ((akwy)localObject4).b(((oidb_cmd0xc76.Item)localObject3).value.get());
          }
          paramFromServiceMsg.add(((akwy)localObject4).a());
        }
      }
      ((akwz)localObject1).jdField_a_of_type_JavaUtilList = paramFromServiceMsg;
      if (paramRspBody.desc.has()) {
        ((akwz)localObject1).jdField_a_of_type_JavaLangString = paramRspBody.desc.get();
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    // Byte code:
    //   0: aload_2
    //   1: invokevirtual 283	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   4: ifeq +504 -> 508
    //   7: new 243	tencent/im/oidb/oidb_sso$OIDBSSOPkg
    //   10: dup
    //   11: invokespecial 244	tencent/im/oidb/oidb_sso$OIDBSSOPkg:<init>	()V
    //   14: astore_1
    //   15: aload_1
    //   16: aload_3
    //   17: checkcast 285	[B
    //   20: checkcast 285	[B
    //   23: invokevirtual 289	tencent/im/oidb/oidb_sso$OIDBSSOPkg:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   26: checkcast 243	tencent/im/oidb/oidb_sso$OIDBSSOPkg
    //   29: astore_2
    //   30: aload_2
    //   31: astore_1
    //   32: iconst_m1
    ...
    //   45: istore 4
    //   47: aload_1
    //   48: getfield 250	tencent/im/oidb/oidb_sso$OIDBSSOPkg:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   51: invokevirtual 292	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   54: ifeq +54 -> 108
    //   57: aload_1
    //   58: getfield 250	tencent/im/oidb/oidb_sso$OIDBSSOPkg:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   61: invokevirtual 294	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   64: istore 5
    //   66: iload 5
    //   68: istore 4
    //   70: invokestatic 299	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   73: ifeq +35 -> 108
    //   76: ldc_w 301
    //   79: iconst_2
    //   80: new 303	java/lang/StringBuilder
    //   83: dup
    //   84: invokespecial 304	java/lang/StringBuilder:<init>	()V
    //   87: ldc_w 430
    //   90: invokevirtual 310	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   93: iload 5
    //   95: invokevirtual 313	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   98: invokevirtual 316	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   101: invokestatic 320	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   104: iload 5
    //   106: istore 4
    //   108: iload 4
    //   110: ifne +390 -> 500
    //   113: aload_1
    //   114: getfield 257	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   117: invokevirtual 364	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   120: ifeq +380 -> 500
    //   123: aload_1
    //   124: getfield 257	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   127: invokevirtual 339	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   130: ifnull +370 -> 500
    //   133: new 432	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody
    //   136: dup
    //   137: invokespecial 433	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:<init>	()V
    //   140: astore_2
    //   141: aload_1
    //   142: getfield 257	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   145: invokevirtual 339	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   148: invokevirtual 340	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   151: astore_1
    //   152: aload_2
    //   153: aload_1
    //   154: invokevirtual 434	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   157: pop
    //   158: aload_2
    //   159: getfield 437	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:wording	Lcom/tencent/mobileqq/pb/PBStringField;
    //   162: invokevirtual 402	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   165: ifeq +367 -> 532
    //   168: aload_2
    //   169: getfield 437	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:wording	Lcom/tencent/mobileqq/pb/PBStringField;
    //   172: invokevirtual 404	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   175: astore_1
    //   176: aload_2
    //   177: getfield 440	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:next_req_duration	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   180: invokevirtual 292	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   183: ifeq +343 -> 526
    //   186: aload_2
    //   187: getfield 440	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:next_req_duration	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   190: invokevirtual 294	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   193: istore 4
    //   195: aload_0
    //   196: getfield 444	akwp:mApp	Lcom/tencent/common/app/AppInterface;
    //   199: sipush 315
    //   202: invokevirtual 450	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   205: checkcast 452	ahjx
    //   208: aload_1
    //   209: iload 4
    //   211: invokevirtual 455	ahjx:a	(Ljava/lang/String;I)V
    //   214: aload_2
    //   215: getfield 459	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:get_uin_info_rsp	Ltencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp;
    //   218: invokevirtual 462	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp:has	()Z
    //   221: ifeq +300 -> 521
    //   224: aload_2
    //   225: getfield 459	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$RspBody:get_uin_info_rsp	Ltencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp;
    //   228: invokevirtual 463	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   231: checkcast 461	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp
    //   234: astore_1
    //   235: aload_1
    //   236: ifnull +280 -> 516
    //   239: aload_1
    //   240: getfield 466	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp:uin_infos	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   243: invokevirtual 387	com/tencent/mobileqq/pb/PBRepeatMessageField:has	()Z
    //   246: ifeq +270 -> 516
    //   249: aload_1
    //   250: getfield 466	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$GetUinInfoRsp:uin_infos	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   253: invokevirtual 389	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   256: astore_1
    //   257: new 101	java/util/ArrayList
    //   260: dup
    //   261: invokespecial 102	java/util/ArrayList:<init>	()V
    //   264: astore_2
    //   265: aload_1
    //   266: ifnull +227 -> 493
    //   269: aload_1
    ...
    //   275: astore_1
    //   276: aload_1
    //   277: invokeinterface 114 1 0
    //   282: ifeq +211 -> 493
    //   285: aload_1
    //   286: invokeinterface 118 1 0
    //   291: checkcast 468	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo
    //   294: astore_3
    //   295: new 470	com/tencent/mobileqq/applets/data/AppletsAccountInfo
    //   298: dup
    //   299: invokespecial 471	com/tencent/mobileqq/applets/data/AppletsAccountInfo:<init>	()V
    //   302: astore 6
    //   304: aload_3
    //   305: getfield 474	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   308: invokevirtual 393	com/tencent/mobileqq/pb/PBUInt64Field:has	()Z
    //   311: ifeq +18 -> 329
    //   314: aload 6
    //   316: aload_3
    //   317: getfield 474	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   320: invokevirtual 395	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   323: invokestatic 479	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   326: putfield 481	com/tencent/mobileqq/applets/data/AppletsAccountInfo:uin	Ljava/lang/String;
    //   329: aload_3
    //   330: getfield 484	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:face_url	Lcom/tencent/mobileqq/pb/PBStringField;
    //   333: invokevirtual 402	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   336: ifeq +15 -> 351
    //   339: aload 6
    //   341: aload_3
    //   342: getfield 484	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:face_url	Lcom/tencent/mobileqq/pb/PBStringField;
    //   345: invokevirtual 404	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   348: putfield 487	com/tencent/mobileqq/applets/data/AppletsAccountInfo:faceUrl	Ljava/lang/String;
    //   351: aload_3
    //   352: getfield 490	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:face_url_simple	Lcom/tencent/mobileqq/pb/PBStringField;
    //   355: invokevirtual 402	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   358: ifeq +15 -> 373
    //   361: aload 6
    //   363: aload_3
    //   364: getfield 490	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:face_url_simple	Lcom/tencent/mobileqq/pb/PBStringField;
    //   367: invokevirtual 404	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   370: putfield 493	com/tencent/mobileqq/applets/data/AppletsAccountInfo:faceUrlSimple	Ljava/lang/String;
    //   373: aload_3
    //   374: getfield 496	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:nick	Lcom/tencent/mobileqq/pb/PBStringField;
    //   377: invokevirtual 402	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   380: ifeq +15 -> 395
    //   383: aload 6
    //   385: aload_3
    //   386: getfield 496	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:nick	Lcom/tencent/mobileqq/pb/PBStringField;
    //   389: invokevirtual 404	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   392: putfield 498	com/tencent/mobileqq/applets/data/AppletsAccountInfo:nick	Ljava/lang/String;
    //   395: aload_3
    //   396: getfield 502	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:appinfo	Ltencent/im/oidb/qqconnect$Appinfo;
    //   399: invokevirtual 505	tencent/im/oidb/qqconnect$Appinfo:has	()Z
    //   402: ifeq +23 -> 425
    //   405: aload 6
    //   407: aload 6
    //   409: aload_3
    //   410: getfield 502	tencent/im/oidb/cmd0xc7a/oidb_cmd0xc7a$UinInfo:appinfo	Ltencent/im/oidb/qqconnect$Appinfo;
    //   413: invokevirtual 506	tencent/im/oidb/qqconnect$Appinfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   416: checkcast 504	tencent/im/oidb/qqconnect$Appinfo
    //   419: invokevirtual 510	com/tencent/mobileqq/applets/data/AppletsAccountInfo:convertToAppletInfo	(Ltencent/im/oidb/qqconnect$Appinfo;)Lcom/tencent/mobileqq/applets/data/AppletInfo;
    //   422: putfield 514	com/tencent/mobileqq/applets/data/AppletsAccountInfo:appInfo	Lcom/tencent/mobileqq/applets/data/AppletInfo;
    //   425: aload_2
    //   426: aload 6
    //   428: invokeinterface 128 2 0
    //   433: pop
    //   434: goto -158 -> 276
    //   437: astore_2
    //   438: ldc_w 301
    //   441: iconst_4
    //   442: aload_2
    //   443: invokevirtual 358	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:getMessage	()Ljava/lang/String;
    //   446: aload_2
    //   447: invokestatic 362	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   450: goto -418 -> 32
    //   453: astore_2
    //   454: ldc_w 301
    //   457: iconst_4
    //   458: aload_2
    //   459: invokevirtual 363	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   462: aload_2
    //   463: invokestatic 362	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   466: goto -434 -> 32
    //   469: astore_1
    //   470: invokestatic 299	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   473: ifeq +13 -> 486
    //   476: ldc_w 301
    //   479: iconst_2
    //   480: ldc_w 516
    //   483: invokestatic 519	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   486: aload_1
    //   487: invokevirtual 522	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   490: goto -332 -> 158
    //   493: aload_0
    //   494: iconst_1
    //   495: iconst_1
    //   496: aload_2
    //   497: invokevirtual 355	akwp:notifyUI	(IZLjava/lang/Object;)V
    //   500: aload_0
    //   501: iconst_1
    //   502: iconst_0
    //   503: aconst_null
    //   504: invokevirtual 355	akwp:notifyUI	(IZLjava/lang/Object;)V
    //   507: return
    //   508: aload_0
    //   509: iconst_1
    //   510: iconst_0
    //   511: aconst_null
    //   512: invokevirtual 355	akwp:notifyUI	(IZLjava/lang/Object;)V
    //   515: return
    //   516: aconst_null
    //   517: astore_1
    //   518: goto -261 -> 257
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          this.app.a().a((String)???, 1038, localMessageRecord.uniseq, "isread", Boolean.valueOf(true));
          i -= 1;
        }
      }
      if (i != 0) {
        this.app.a().c((String)???, 1038, i);
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    akwy localakwy = new akwy();
    localakwy.a(paramString2);
    localakwy.a(paramString1);
    localakwy.b(paramInt);
    localArrayList.add(localakwy.a());
