...
public class aopt
  extends aopk
{
  private static aopu jdField_a_of_type_Aopu;
  public static final ArrayList<WeakReference<aopt>> a;
  private static String e = "";
  protected SongInfo a;
  private WeakReference<aopt> jdField_a_of_type_JavaLangRefWeakReference;
  protected long b = 0L;
  protected String d;
  ...
  public aopt(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_Aopu = new aopu(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Aopu);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Aopu);
      QQPlayerService.a(null);
      return true;
    }
