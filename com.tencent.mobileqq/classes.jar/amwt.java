...
{
  public amwt(FavoriteSearchFragment paramFavoriteSearchFragment, ListView paramListView, FaceDecoder paramFaceDecoder)
  {
  ...
  {
    return new SearchResultView(paramViewGroup, 2130971562);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        ...
        ((TextView)localObject).setTextColor(paramViewGroup.getResources().getColor(2131494249));
      ...
      do
      {
        ...
        break;
        paramViewGroup.setText(2131431726);
  ...
  public void onClick(View paramView)
  {
    ...
    Animatable localAnimatable = (Animatable)BaseApplicationImpl.sApplication.getResources().getDrawable(2130838602);
