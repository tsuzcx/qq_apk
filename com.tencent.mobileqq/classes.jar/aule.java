...
public class aule
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    bdec.a(paramQQAppInterface.getApp(), paramQQAppInterface, localMessage, localMessage.istroop, paramMessageRecord, null, false, false);
    try
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    while (((MessageForLongTextMsg.class.isInstance(paramChatMessage)) && ((paramChatMessage.getExtInfoFromExtStr("long_text_recv_state").equals("2")) || (paramChatMessage.getExtInfoFromExtStr("long_text_recv_state").equals("3")))) || (!MessageForArkApp.isAllowedArkForward(false, paramChatMessage)) || (MessageForTroopConfess.class.isInstance(paramChatMessage)) || (MessageForLightVideo.class.isInstance(paramChatMessage)) || ((paramChatMessage instanceof MessageForFuDai)) || (alnp.a(paramChatMessage)) || (((paramChatMessage instanceof MessageForPic)) && (agwq.a((MessageForPic)paramChatMessage)))) {
      return false;
    }
    boolean bool;
        ...
        else
        {
          ...
          else
          {
            ...
            if (paramChatMessage.isMultiMsg) {
              bool = true;
            } else if (arni.a(paramQQAppInterface, (MessageForFile)paramChatMessage).getCloudType() == 0) {
              bool = false;
            } else {
              bool = true;
            }
