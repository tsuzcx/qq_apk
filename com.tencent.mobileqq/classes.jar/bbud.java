...
{
  public bbud(AuthorityActivity paramAuthorityActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    apmt.a("KEY_GET_APP_INFO_REQUEST", this.a.jdField_a_of_type_Bciz, paramBoolean);
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.a.i) {
          localObject = bcjy.b(arrayOfByte, this.a.jdField_a_of_type_Bciz);
        }
        if (localObject == null) {
          break;
        }
