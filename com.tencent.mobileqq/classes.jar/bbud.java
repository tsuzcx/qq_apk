...
public class bbud
{
  ...
  static
  {
    jdField_d_of_type_JavaLangString = alud.a(2131715699);
  }
    ...
    while (this.jdField_a_of_type_JavaLangString.indexOf('[') > 0)
    {
      ...
      if ((i < this.jdField_a_of_type_JavaLangString.length() - 1) && (this.jdField_a_of_type_JavaLangString.charAt(i + 1) == '('))
      {
        ...
        if (m > 0)
        {
          ...
          bbue localbbue = new bbue();
          localbbue.jdField_a_of_type_Int = k;
          localbbue.jdField_b_of_type_Int = (i + 1);
          localbbue.jdField_a_of_type_JavaLangString = str;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbbue);
        }
      }
    }
  }
