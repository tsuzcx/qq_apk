...
public class olx
{
  private static Map<String, olx> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private olx(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidContentContext = pkh.a().getApplication();
    a();
  }
  ...
  public static olx a()
  {
    ...
    {
      if (jdField_a_of_type_JavaUtilMap.get(str) == null) {
        jdField_a_of_type_JavaUtilMap.put(str, new olx(str));
      }
      return (olx)jdField_a_of_type_JavaUtilMap.get(str);
    }
    finally {}
  }
    ...
    for (;;)
    {
      if (paramInt < i - 1)
      {
        ...
        try
        {
          ...
          localHashMap.put(Integer.valueOf(paramInt), localVideoInfo.a.mAdvertisementSoftInfo.K);
        }
