...
public class aajy
  extends MqqHandler
{
  public aajy(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (arip)this.a.app.getManager(16);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = babh.e(this.a.app, ChatSettingActivity.c(this.a));
              ...
              bool1 = false;
              break label308;
              paramMessage = (ajjj)this.a.app.getManager(51);
              if (paramMessage != null)
              {
