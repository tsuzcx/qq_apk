...
{
  public agny(PhotoListActivity paramPhotoListActivity) {}
  ...
  protected List<LocalMediaInfo> a(Object... paramVarArgs)
  {
    ...
    if (((PhotoListActivity.c(this.a)) && (this.a.jdField_b_of_type_JavaLangString.equals("$RecentAlbumId"))) || ((this.a.l) && (this.a.k)))
    {
      ...
      paramVarArgs = bbbj.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.jdField_a_of_type_JavaLangString, i, this.a.jdField_a_of_type_Aglx, j, k, true, paramVarArgs, this.a.k, this.a.jdField_e_of_type_Long);
    }
    for (;;)
    {
      ...
      if (PhotoListActivity.a(this.a))
      {
        if ((!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString)) && (this.a.jdField_b_of_type_JavaLangString.equals("$CustomAlbumId")))
        {
          ...
          paramVarArgs.addAll(vuc.a().b());
        }
        else
        {
          paramVarArgs = bbbj.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.jdField_a_of_type_JavaLangString, i, this.a.jdField_a_of_type_Aglx, 0, 0, true, null, false, this.a.jdField_e_of_type_Long, 1);
        }
      }
      else {
        paramVarArgs = bbbj.b(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.jdField_a_of_type_JavaLangString, i, this.a.jdField_a_of_type_Aglx, this.a.jdField_e_of_type_Long);
      }
    }
    ...
    if (bbbj.jdField_a_of_type_JavaUtilHashMap.containsKey(this.a.jdField_b_of_type_JavaLangString)) {}
    for (int k = ((Integer)bbbj.jdField_a_of_type_JavaUtilHashMap.get(this.a.jdField_b_of_type_JavaLangString)).intValue();; k = 0)
    {
      Object localObject2;
      ...
      {
        break label1194;
        agpm.a(paramVarArgs, null, PhotoListActivity.a(this.a));
        ...
        if (m < paramVarArgs.size())
        {
          ...
          for (;;)
          {
            ...
            i = j;
            break;
            int i1 = bbbj.a((LocalMediaInfo)localObject2);
            ...
            else if ((this.a.jdField_v_of_type_Boolean) && (l1 - l2 <= 60000L) && (k == paramVarArgs.size()) && (((LocalMediaInfo)localObject2).path.equals(bbbj.jdField_a_of_type_JavaLangString)))
            {
  ...
  protected void a(List<LocalMediaInfo> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      this.a.jdField_a_of_type_Agnv.a((List)localObject);
      this.a.jdField_a_of_type_Agnv.notifyDataSetChanged();
      this.a.g();
      bcpw.a(this.a, ajyc.a(2131708103), 1000).a();
      return;
    }
    ...
    this.a.jdField_a_of_type_Agnv.a(paramList);
    label289:
    int i;
    if (paramList.isEmpty())
    {
      bcpw.a(this.a, ajyc.a(2131708106), 1000).a();
      if (this.a.jdField_i_of_type_Boolean)
      {
        ...
        localObject = (LinkedHashMap)bbbj.jdField_b_of_type_JavaUtilHashMap.get(this.a.jdField_b_of_type_JavaLangString);
        if (localObject == null) {
          break label877;
        }
    ...
    for (int j = ((Integer)((LinkedHashMap)localObject).get(localObject.keySet().toArray()[(j - 1)])).intValue();; j = i)
    {
      ...
      for (;;)
      {
        j = this.a.jdField_a_of_type_Agnv.getCount();
        if (j == 0)
        {
          j = m;
          if (!PhotoListActivity.a(this.a)) {
        ...
        for (;;)
        {
          ...
          vuc.a().b(this.a.jdField_c_of_type_JavaUtilArrayList, PhotoListActivity.jdField_a_of_type_JavaUtilHashMap);
          return;
          if ((!this.a.L) || (paramList.size() != 1)) {
            break label289;
          }
          bcpw.a(this.a, ajyc.a(2131708084), 1000).a();
