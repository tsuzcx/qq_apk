...
public class agny
  implements bfpv
{
  public agny(PhotoPreviewActivity paramPhotoPreviewActivity) {}
  ...
  public void a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    LocalMediaInfo localLocalMediaInfo = this.a.b(this.a.jdField_a_of_type_Agox.a(paramInt));
    if (this.a.E)
    {
      if ((localLocalMediaInfo == null) || (this.a.a(localLocalMediaInfo.path) != 1)) {
        break label444;
      }
      if (this.a.jdField_a_of_type_Agqs != null)
      {
        agra localagra = new agra();
        localagra.jdField_a_of_type_Boolean = false;
        localagra.jdField_a_of_type_JavaLangString = localLocalMediaInfo.path;
        this.a.jdField_a_of_type_Agqs.a(paramAdapterView, localagra);
      }
      if (paramView != null)
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (PhotoPreviewActivity.c(this.a))
        {
          ...
          this.a.jdField_a_of_type_Agqs.a(null, null);
        }
      }
      catch (Exception paramView)
      {
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            QLog.d("PhotoPreviewActivity", 2, bfnu.a(paramView));
            continue;
            ...
            else
            {
              ...
              continue;
              label590:
              this.a.d.setText(this.a.getResources().getString(2131695337));
            }
          }
        }
      }
