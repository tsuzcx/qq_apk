...
class aiai
  implements Runnable
{
  aiai(aiah paramaiah, AppRuntime paramAppRuntime) {}
  ...
  public void run()
  {
    ...
    String str;
    if ("202".equals(this.jdField_a_of_type_Aiah.a.c))
    {
      ...
      if (!"1103".equals(this.jdField_a_of_type_Aiah.a.a)) {
        break label417;
      }
    ...
    for (;;)
    {
      if (!"200".equals(this.jdField_a_of_type_Aiah.a.c))
      {
        int i = ThemeUtil.getErrorThemeId(this.jdField_a_of_type_MqqAppAppRuntime.getApplication(), this.jdField_a_of_type_Aiah.a.a);
        if (i > 0)
        {
          QLog.d("ThemeSwitchManager", 1, "onPostExecute errTime > 0 errTime:" + i + ", change to themeId=" + this.jdField_a_of_type_Aiah.a.a + ", mVersion=" + this.jdField_a_of_type_Aiah.a.b + ", mFrom:" + this.jdField_a_of_type_Aiah.a.c);
          if (i / 100000 == Integer.parseInt("3")) {
            ThemeUtil.setErrorThemeId(this.jdField_a_of_type_MqqAppAppRuntime.getApplication(), this.jdField_a_of_type_Aiah.a.a, true);
          }
          ((ThemeHandler)((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime).a(14)).a(this.jdField_a_of_type_Aiah.a.a, this.jdField_a_of_type_Aiah.a.b);
        }
      }
      if (!"1000".equals(this.jdField_a_of_type_Aiah.a.a)) {
        ThemeUtil.delOldThemeResDir(this.jdField_a_of_type_Aiah.a.a, this.jdField_a_of_type_Aiah.a.b, ThemeUtil.getThemeResourcePath(this.jdField_a_of_type_MqqAppAppRuntime.getApplication(), this.jdField_a_of_type_Aiah.a.a, this.jdField_a_of_type_Aiah.a.b), false);
      }
      return;
      label417:
