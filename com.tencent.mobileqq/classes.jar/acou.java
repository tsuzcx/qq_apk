  ...
  extends acpd
{
  ...
  private acov jdField_a_of_type_Acov;
  private adnv jdField_a_of_type_Adnv;
  protected Rect a;
  public View a;
  public baoj a;
  public String a;
  ...
  public acou(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    localObject = bace.a(paramString);
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Baoj = ((baoj)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Adnv = null;
      this.c = aciy.a(Long.valueOf(this.jdField_a_of_type_JavaLangString).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = aciy.a(aciy.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
      if ((localObject != null) && ((localObject instanceof adnv))) {
        this.jdField_a_of_type_Adnv = ((adnv)localObject);
      }
      while (this.jdField_a_of_type_Adnv == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Adnv.a != null)
      {
        localObject = this.jdField_a_of_type_Adnv.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Baoj.a * k);
      j += (int)(this.jdField_a_of_type_Baoj.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Baoj.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Baoj.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        this.jdField_a_of_type_Acov = null;
        ...
        localObject = aciy.a(aciy.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof acov)))
        {
          this.jdField_a_of_type_Acov = ((acov)localObject);
          label484:
          if (this.jdField_a_of_type_Acov == null) {
            break label587;
          }
          if (this.jdField_b_of_type_AndroidViewView == null) {
            break label642;
          }
          j = this.jdField_a_of_type_Acov.a.getRight() - this.jdField_a_of_type_Acov.a.getLeft();
          i = this.jdField_a_of_type_Acov.a.getBottom() - this.jdField_a_of_type_Acov.a.getTop();
        }
      }
      for (;;)
      {
