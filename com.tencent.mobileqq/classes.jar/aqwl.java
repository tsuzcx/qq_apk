  ...
  implements BusinessObserver
{
  ...
  private final SparseArray<WeakReference<aqwn>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        localObject2 = (aqwn)((WeakReference)localObject1).get();
        ...
        ((aqwn)localObject1).a(paramBoolean, i, j, paramBundle, (String)localObject2);
        return;
      }
  ...
  int a(aqwn paramaqwn)
  {
    synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
    {
      ...
      localSparseArray2.append(i, new WeakReference(paramaqwn));
