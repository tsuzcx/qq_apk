...
public class pds
{
  private static final Map<Integer, pye> a = new HashMap();
  ...
  {
    blqm.a("ProteusSupportUtilDynamic.getView");
    ...
    {
      localContainer.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841693));
  ...
  private static TemplateBean a(int paramInt, BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    //   96: aload_2
    //   97: iconst_1
    //   98: invokestatic 150	suz:a	(Ljava/lang/String;Z)Lsuz;
    //   101: astore_1
    //   102: aload_1
    //   103: ifnull +12 -> 115
    //   106: aload_1
    //   107: aload 4
    //   109: invokevirtual 154	suz:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   112: astore_1
    //   113: aload_1
    //   114: areturn
    //   115: aconst_null
  ...
  private static TemplateBean a(VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        paramVafContext = paramVafContext.getTemplateBean(localptl.a(paramString1).a());
  ...
  private static void a(int paramInt, pye parampye)
  {
    ...
    a.put(Integer.valueOf(paramInt), parampye);
  }
  ...
  {
    blqm.a("ProteusSupportUtilDynamic.bindData");
    ...
    paramProteusItemView.setTag(2131376204, paramString);
    blqm.a("ProteusSupportUtilDynamic.bindDataImpl");
    if (paramString != null) {
      oyj.a(paramProteusItemView, localTemplateBean, paramString);
    }
    blqm.a();
    oyj.a(paramProteusItemView, paramVafContext, paramString);
    blqm.a();
  }
