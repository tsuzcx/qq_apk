...
public class beqx
  extends besk
{
  public beqx(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    try
    {
      ...
      paramDownloadParams.inPreferredConfig = beyq.a;
      ...
      if (bool) {
        try
        {
          ...
          if (paramDownloadParams != null) {
            return new bezd(paramFile.getAbsolutePath()).a(paramDownloadParams);
          }
          paramFile.delete();
