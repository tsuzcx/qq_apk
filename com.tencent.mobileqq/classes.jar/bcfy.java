  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  private bcgb jdField_a_of_type_Bcgb;
  ...
  public bcfy(QQAppInterface paramQQAppInterface, Context paramContext, MessageForShortVideo paramMessageForShortVideo, bcgb parambcgb)
  {
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = bcft.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    bcfw localbcfw = bcft.a(paramString1);
    bcfx.a(localbcfw);
    boolean bool = bcft.a(localbcfw, (bcfv)localObject1);
    this.jdField_b_of_type_Boolean = bool;
    if (QLog.isColorLevel()) {
      QLog.d("VideoCompressProcessor", 1, "CompressTask, isNeedCompress = " + bool);
    }
    if (this.jdField_a_of_type_Bcgb != null) {
      bkgk.a(new VideoCompressProcessor.CompressTask.1(this, bool));
    }
    if (!bool) {
      return -1;
    }
    localObject1 = bcft.a(localbcfw, (bcfv)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.sendRawVideo);
    int i = bcic.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
    Object localObject2;
    label290:
    label380:
    long l1;
    ...
    if ((Build.VERSION.SDK_INT >= 18) && ((i & 0x1) > 0) && ((i & 0x2) > 0))
    {
      ...
      localObject2 = new bcgc(this.jdField_a_of_type_JavaLangRefWeakReference, paramString1, paramString2, (bcfu)localObject1, new bcfz(this));
      this.jdField_a_of_type_Bcms = new bcms();
      if ((!this.jdField_a_of_type_Bcms.a(new File(paramString1), (bcmt)localObject2, true)) || (((bcgc)localObject2).a != null)) {
        break label567;
      }
      if (QLog.isColorLevel()) {
      ...
      localObject2 = new bcga(this);
      i = ShortVideoTrimmer.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), paramString1, paramString2, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (bcme)localObject2, (bcfu)localObject1, localbcfw);
      if (i != 0) {
        break label626;
      }
    ...
    {
      bcfx.a(bool, l3, localbcfw, (bcfu)localObject1, l2);
      if (QLog.isColorLevel()) {
      ...
      label586:
      if (this.jdField_a_of_type_Bcgb != null) {
        this.jdField_a_of_type_Bcgb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1.0F);
      }
      if (QLog.isColorLevel()) {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "initVideoTrimError", true, 0L, 0L, null, "", false);
      break label380;
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)) || (!bgmg.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((TextUtils.isEmpty(this.c)) || (!bgmg.b(this.c)))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_b_of_type_JavaLangString = bgmj.a(MD5.toMD5Byte(new FileInputStream(paramVarArgs), this.jdField_a_of_type_Long));
      ...
      catch (Exception paramVarArgs)
      {
        ...
        if (this.jdField_a_of_type_Long < 104345600L)
        {
          ...
          bgmg.a(new File(this.c), new File(ShortVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, "mp4")));
        }
      }
    }
  ...
  public void a(bcgb parambcgb)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Bcgb == null);
        this.jdField_a_of_type_Bcgb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1);
        return;
        if (!isCancelled()) {
          break;
        }
      } while (this.jdField_a_of_type_Bcgb == null);
      this.jdField_a_of_type_Bcgb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 3);
      return;
    } while (this.jdField_a_of_type_Bcgb == null);
    this.jdField_a_of_type_Bcgb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, this.jdField_b_of_type_Boolean);
  }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (this.jdField_a_of_type_Bcgb != null)
    {
      bcgb localbcgb = this.jdField_a_of_type_Bcgb;
      MessageForShortVideo localMessageForShortVideo = this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      if (paramInteger.intValue() == 1) {
        i = 1;
      }
      localbcgb.a(localMessageForShortVideo, i);
    }
    while (paramInteger.intValue() == 1)
    {
      ahhm.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressProcessor", 2, "onPostExecute, mListener is null ," + b());
      }
    }
    ahhm.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
  }
  
  public boolean a()
  {
    if (this.jdField_a_of_type_Bcms != null) {}
    for (boolean bool = this.jdField_a_of_type_Bcms.b();; bool = false) {
      try
      {
        if (this.jdField_a_of_type_JavaLangProcess != null) {
          this.jdField_a_of_type_JavaLangProcess.destroy();
  ...
  protected void onCancelled()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
    {
      ...
      if (!TextUtils.isEmpty(localMessageForShortVideo.md5)) {
        bgmg.d(ShortVideoUtils.a(localMessageForShortVideo, "mp4"));
      }
      ...
      bauy.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localMessageForShortVideo.frienduin, localMessageForShortVideo.uniseq);
    ...
    for (Object localObject = ShortVideoUtils.d(this.jdField_a_of_type_JavaLangString, "mp4");; localObject = ShortVideoUtils.c(this.jdField_a_of_type_JavaLangString, "mp4"))
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        bgmg.d((String)localObject);
      }
      bcfx.a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.uniseq);
      if (QLog.isColorLevel()) {
