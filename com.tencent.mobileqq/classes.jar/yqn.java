  ...
  extends yqp
{
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    {
      paramString1 = anvx.a(2131707646) + paramInt1 + anvx.a(2131707639) + paramInt2 + anvx.a(2131707638);
      this.t = paramString1;
      return paramString1;
    }
  ...
  public String a(String paramString)
  {
    ...
    //   3: ldc 48
    //   5: aload_0
    //   6: getfield 50	yqn:m	Ljava/lang/String;
    //   9: invokevirtual 56	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   12: ifeq +178 -> 190
    //   15: aload_0
    ...
    //   37: putfield 84	yqn:r	Ljava/lang/String;
    //   40: aload_0
    //   41: getfield 84	yqn:r	Ljava/lang/String;
    //   44: invokestatic 90	com/tencent/mobileqq/utils/FileUtils:fileExists	(Ljava/lang/String;)Z
    //   47: ifne +60 -> 107
    //   50: aload_0
    //   51: getfield 93	yqn:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   70: dup
    //   71: aload_0
    //   72: getfield 84	yqn:r	Ljava/lang/String;
    //   75: invokestatic 112	com/tencent/mobileqq/utils/FileUtils:createFile	(Ljava/lang/String;)Ljava/io/File;
    //   78: invokespecial 115	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   81: astore_2
    //   82: aload_2
    //   83: astore_1
    //   84: aload_3
    //   85: getstatic 121	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   88: bipush 100
    //   90: aload_2
    //   91: invokevirtual 127	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   94: pop
    //   95: aload_3
    //   96: invokevirtual 130	android/graphics/Bitmap:recycle	()V
    //   99: aload_2
    //   100: ifnull +7 -> 107
    //   103: aload_2
    //   104: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   107: aload_0
    //   108: getfield 84	yqn:r	Ljava/lang/String;
    //   111: areturn
    //   112: astore_1
    //   113: aload_1
    //   114: invokevirtual 136	java/lang/OutOfMemoryError:printStackTrace	()V
    //   117: aconst_null
    //   118: astore_3
    //   119: goto -56 -> 63
    //   122: astore_1
    //   123: aload_1
    //   124: invokevirtual 137	java/io/IOException:printStackTrace	()V
    //   127: goto -20 -> 107
    //   130: astore 4
    //   132: aconst_null
    //   133: astore_2
    ...
    //   135: astore_1
    //   136: aload 4
    //   138: invokevirtual 138	java/lang/Exception:printStackTrace	()V
    //   141: aload_3
    //   142: invokevirtual 130	android/graphics/Bitmap:recycle	()V
    //   145: aload_2
    //   146: ifnull -39 -> 107
    //   149: aload_2
    ...
    //   156: astore_1
    //   157: aload_1
    //   158: invokevirtual 137	java/io/IOException:printStackTrace	()V
    //   161: goto -54 -> 107
    //   164: astore_1
    //   165: aload 4
    //   167: astore_2
    //   168: aload_3
    //   169: invokevirtual 130	android/graphics/Bitmap:recycle	()V
    //   172: aload_2
    //   173: ifnull +7 -> 180
    //   176: aload_2
    //   177: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   180: aload_1
    //   181: athrow
    //   182: astore_2
    //   183: aload_2
    //   184: invokevirtual 137	java/io/IOException:printStackTrace	()V
    //   187: goto -7 -> 180
    //   190: aload_0
    //   191: getfield 141	yqn:h	Ljava/lang/String;
    //   194: invokestatic 147	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   197: ifne +25 -> 222
    //   200: aload_0
    //   201: getfield 141	yqn:h	Ljava/lang/String;
    //   204: aload_0
    //   205: getfield 84	yqn:r	Ljava/lang/String;
    //   208: invokevirtual 56	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   211: ifne +11 -> 222
    //   214: aload_0
    //   215: aload_0
    //   216: getfield 141	yqn:h	Ljava/lang/String;
    //   219: invokevirtual 150	yqn:a	(Ljava/lang/String;)V
    //   222: aload_0
    //   223: aload_1
    //   224: putfield 152	yqn:s	Ljava/lang/String;
    //   227: aload_0
    //   228: getfield 152	yqn:s	Ljava/lang/String;
    //   231: areturn
    //   232: astore 4
    //   234: aload_1
    //   235: astore_2
