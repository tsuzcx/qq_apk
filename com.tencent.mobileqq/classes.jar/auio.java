...
class auio
  implements bmsx
{
  auio(auie paramauie, String paramString, int paramInt, Object paramObject) {}
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt)
  {
    ...
    if ((paramBoolean) && (paramString1 != null) && (!TextUtils.isEmpty(paramString2)) && (new File(paramString2).exists()))
    {
      ...
      auie.a(this.jdField_a_of_type_Auie).getFileManagerNotifyCenter().a(true, 39, new Object[] { this.jdField_a_of_type_JavaLangString, Integer.valueOf(this.jdField_a_of_type_Int), paramString2, this.jdField_a_of_type_JavaLangObject });
    }
    label128:
