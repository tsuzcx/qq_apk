  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public agjt(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Agjs = new agjs(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Agjs);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Agjs.a(paramString);
    if (this.jdField_a_of_type_Agjs.getCount() == 0) {
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 203	zzp:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 203	zzp:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 203	zzp:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
