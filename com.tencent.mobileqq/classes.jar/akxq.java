...
public class akxq
{
  ...
  public akxq(int paramInt, String... paramVarArgs)
  {
    try
    {
      this.e = true;
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new akxu(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new akxv(this));
  ...
  public akxq(String paramString1, String paramString2)
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new akxr(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new akxs(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new akxt(this));
