...
public class avsx
  extends alar
{
  private WeakReference<avsy> a;
  
  public avsx(ark.Application paramApplication, long paramLong)
  {
  ...
  public void a(avsy paramavsy)
  {
    this.a = new WeakReference(paramavsy);
  }
  ...
  protected boolean a(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      else if (k == 7)
      {
        ...
        continue;
        awqx.b(localQQAppInterface, "CliOper", "", str, paramVariantWrapper, (String)localObject1, i, j, String.valueOf(l1), String.valueOf(l2), (String)localObject3, (String)localObject2);
        return true;
      }
      else
      {
