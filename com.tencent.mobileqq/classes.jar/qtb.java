  ...
  extends qqt
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = qtb.class.getSimpleName();
  }
  
  public qtb(Context paramContext, aobu paramaobu, snh paramsnh)
  {
    super(paramContext, paramaobu, paramsnh);
  }
  
  private void a(LinearLayout paramLinearLayout, pxk parampxk)
  {
    if (parampxk.e() == 56)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPolymericView.setDividerWidth(afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPolymericView.setPadding(bggq.a(this.jdField_a_of_type_AndroidContentContext, 6.0F), 0, bggq.a(this.jdField_a_of_type_AndroidContentContext, 6.0F), bggq.a(this.jdField_a_of_type_AndroidContentContext, 15.0F));
    }
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPolymericView.setDividerWidth(afur.a(1.5F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPolymericView.setPadding(bggq.a(this.jdField_a_of_type_AndroidContentContext, 6.0F), bggq.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), bggq.a(this.jdField_a_of_type_AndroidContentContext, 12.0F), bggq.a(this.jdField_a_of_type_AndroidContentContext, 8.0F));
    }
  }
  ...
  public qqt a()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_JavaLangObject instanceof pxk)) && (((pxk)this.jdField_a_of_type_JavaLangObject).e() == 56))
    {
      if (((pxk)this.jdField_a_of_type_JavaLangObject).b() == 53) {
        return b(this.jdField_a_of_type_Snh, this.jdField_a_of_type_Aobu).u().n();
      }
      return b(this.jdField_a_of_type_Snh, this.jdField_a_of_type_Aobu).u().n().l().m();
    }
    return b(this.jdField_a_of_type_Snh, this.jdField_a_of_type_Aobu).u().n().l();
  }
  ...
  public qqt d()
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_JavaLangObject instanceof pxk)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPolymericView != null))
    {
      ...
      a(localLinearLayout, (pxk)this.jdField_a_of_type_JavaLangObject);
    }
    for (;;)
    {
      ...
      ((LinearLayout.LayoutParams)localObject).leftMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 12.0F);
      ((LinearLayout.LayoutParams)localObject).bottomMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 20.0F);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPolymericView.setDividerWidth(afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
  ...
  public qqt p()
  {
    super.p();
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentHeaderPolymeric != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentHeaderPolymeric.a(this.jdField_a_of_type_Qrb);
    }
    return this;
  }
}
