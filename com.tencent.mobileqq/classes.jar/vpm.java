  ...
  implements View.OnClickListener
{
  ...
  public vpm(Context paramContext, vrn paramvrn)
  {
    super(paramContext);
    if (paramvrn != null) {
  ...
  private void a(String paramString, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    paramString = a().getDrawable(2130840269);
  ...
  protected void e()
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131367583));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131367567));
    this.jdField_b_of_type_AndroidViewView = a(2131367573);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131367575));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      vmp.b("GdtWSVerticalItemBottomController", "跳转到广告落地页");
      ...
      if (this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback == null) {
        this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback = new vpn(this);
      }
