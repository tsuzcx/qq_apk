...
{
  static final ArrayList<bkmd> c = new ArrayList();
  private final ListAdapter jdField_a_of_type_AndroidWidgetListAdapter;
  ArrayList<bkmd> jdField_a_of_type_JavaUtilArrayList;
  boolean jdField_a_of_type_Boolean;
  ArrayList<bkmd> jdField_b_of_type_JavaUtilArrayList;
  private final boolean jdField_b_of_type_Boolean;
  
  public bkky(ArrayList<bkmd> paramArrayList1, ArrayList<bkmd> paramArrayList2, ListAdapter paramListAdapter)
  {
  ...
  private boolean a(ArrayList<bkmd> paramArrayList)
  {
    if (paramArrayList != null)
    {
      paramArrayList = paramArrayList.iterator();
      while (paramArrayList.hasNext()) {
        if (!((bkmd)paramArrayList.next()).jdField_a_of_type_Boolean) {
          return false;
        }
      }
    }
  ...
  public boolean a(View paramView)
  {
    ...
    {
      if (((bkmd)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public boolean b(View paramView)
  {
    ...
    {
      if (((bkmd)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public Object getItem(int paramInt)
  {
    int i = a();
    if (paramInt < i) {
      return ((bkmd)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_JavaLangObject;
    }
    int j = paramInt - i;
    paramInt = 0;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    return ((bkmd)this.jdField_b_of_type_JavaUtilArrayList.get(j - paramInt)).jdField_a_of_type_JavaLangObject;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    View localView;
    if (paramInt < k) {
      localView = ((bkmd)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      ...
      try
      {
        localView = ((bkmd)this.jdField_b_of_type_JavaUtilArrayList.get(m - i)).jdField_a_of_type_AndroidViewView;
      }
  ...
  public boolean isEnabled(int paramInt)
  {
    int k = a();
    if (paramInt < k) {
      return ((bkmd)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Boolean;
    }
    int m = paramInt - k;
    int i;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    boolean bool = ((bkmd)this.jdField_b_of_type_JavaUtilArrayList.get(m - i)).jdField_a_of_type_Boolean;
    return bool;
  }
