...
public class acys
{
  private static volatile acys jdField_a_of_type_Acys;
  public static final String a;
  public static final String b = jdField_a_of_type_JavaLangString + "eggs.xml";
  private ArrayList<acyu> jdField_a_of_type_JavaUtilArrayList;
  ...
  {
    if (jdField_a_of_type_Acys == null) {}
    try
    {
      if (jdField_a_of_type_Acys == null) {
        jdField_a_of_type_Acys = new acys();
      }
      return jdField_a_of_type_Acys;
    }
    finally {}
  }
  
  private ArrayList<acyu> a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          localObject2 = new acyu();
          ((acyu)localObject2).jdField_a_of_type_Int = Integer.valueOf((String)localObject3).intValue();
    ...
    for (;;)
    {
      ...
      localObject2 = new acyw();
      if (str1 != null) {
        ((acyw)localObject2).jdField_b_of_type_Int = acyw.a(str1);
      }
      ((acyw)localObject2).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
      ...
      localObject4.jdField_a_of_type_Acyv = new acyv();
      ...
      localObject4.jdField_a_of_type_Acyv.jdField_a_of_type_Int = Integer.parseInt((String)localObject2);
      localObject4.jdField_a_of_type_Acyv.jdField_b_of_type_Int = Integer.parseInt((String)localObject3);
      localObject4.jdField_a_of_type_Acyv.c = Integer.parseInt(str1);
      localObject4.jdField_a_of_type_Acyv.e = Integer.parseInt(str3);
      localObject4.jdField_a_of_type_Acyv.d = Integer.parseInt(str2);
      localObject2 = localObject4;
      localObject3 = localObject1;
      break;
      localObject2 = localObject4;
  ...
  private boolean a(String paramString)
  {
    ...
    //   163: aload_0
    //   164: aload_2
    //   165: invokespecial 277	acys:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   168: astore_2
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    ...
    //   181: aload_0
    //   182: aload_2
    //   183: putfield 281	acys:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   186: iconst_1
    //   187: ireturn
    //   188: astore_2
    //   189: aload_3
