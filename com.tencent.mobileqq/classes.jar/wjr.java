  ...
  extends wjp
{
  ...
  public wjr(PublishVideoEntry paramPublishVideoEntry)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Wrb = a().getLinkInfo();
  ...
  public wjr(StoryVideoItem paramStoryVideoItem)
  {
    ...
    this.jdField_a_of_type_Wrb = wrb.a(paramStoryVideoItem.mLinkInfoJson);
    this.n = paramStoryVideoItem.originalAuthorUnionId;
    this.o = paramStoryVideoItem.originalAuthorName;
  }
  
  public wjr(String paramString)
  {
    this.p = paramString;
    zkb.a(paramString);
  }
  ...
  private int a()
  {
    ...
    if ((arrayOfByte != null) && (arrayOfByte.length > 0))
    {
      ...
      try
      {
        ...
        int i1 = new wfd(localAppInterface, localVideoReaderConf).jdField_a_of_type_Int;
        return i1;
      }
  ...
  private zhq a()
  {
    ...
    if ((localObject != null) && (localObject.length > 0))
    {
      ...
      try
      {
        ...
        localObject = new zhq(localTagInfoBase);
        return localObject;
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
  ...
  public StoryVideoItem a()
  {
    ...
    if (TextUtils.isEmpty(localStoryVideoItem.mPublishDate)) {
      localStoryVideoItem.mPublishDate = yij.a().format(new Date(this.jdField_d_of_type_Long));
    }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      if (this.jdField_a_of_type_Wrb != null) {
        localStoryVideoItem.mLinkInfoJson = this.jdField_a_of_type_Wrb.a(false);
      }
      localStoryVideoItem.mGameInfoJson = a().getStringExtra("game", null);
      localStoryVideoItem.mGameInfo = wqz.a(localStoryVideoItem.mGameInfoJson);
  ...
  public GeneralFeedItem a()
  {
    ...
    String str2 = localyij.a(QQStoryContext.a().b(), str3);
    yqp.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "find true feedId:%s", str2);
    String str1 = str2;
    if (TextUtils.isEmpty(str2))
    {
      str1 = VideoListFeedItem.makeFakeFeedId(QQStoryContext.a().b(), str3);
      yqp.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "make fake feedId:%s", str1);
    }
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = ((GeneralFeedItem)localyij.a(str1));
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem == null)
    {
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = GeneralFeedItem.createFakeFeedItem(str3);
      localyij.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
      yqp.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "save fake item %s", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem.feedId);
    }
    return this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem;
  }
  ...
  public wrd a()
  {
    ...
    if ((this.jdField_a_of_type_Wrd == null) && (a().spreadGroupBytes != null) && (a().spreadGroupBytes.length > 0)) {
      localVideoSpreadGroupList = new qqstory_struct.VideoSpreadGroupList();
    }
    try
    {
      localVideoSpreadGroupList.mergeFrom(a().spreadGroupBytes);
      this.jdField_a_of_type_Wrd = new wrd(localVideoSpreadGroupList);
    ...
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      for (;;)
      {
        yqp.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "decode spread group fail", localInvalidProtocolBufferMicroException);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    ((yij)wpm.a(11)).a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
  }
