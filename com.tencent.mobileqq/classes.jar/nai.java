...
class nai
  implements Runnable
{
  nai(nah paramnah, boolean paramBoolean, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
          ...
          if (localGetPublicAccountDetailInfoResponse.ret_info.has())
          {
            ...
            if (((mobileqq_mp.RetInfo)localGetPublicAccountDetailInfoResponse.ret_info.get()).ret_code.has())
            {
              ...
              if (((mobileqq_mp.RetInfo)localGetPublicAccountDetailInfoResponse.ret_info.get()).ret_code.get() == 0)
              {
                ...
                j = i1;
                localObject4 = this.jdField_a_of_type_Nah.a.getEntityManagerFactory(this.jdField_a_of_type_Nah.a.getAccount()).createEntityManager();
                k = i;
                if (localObject4 != null)
                {
                  ...
                  {
                    j = i1;
                    localObject4 = (PublicAccountDataManager)this.jdField_a_of_type_Nah.a.getManager(55);
                    if (localObject4 != null)
                    {
                      j = i1;
      ...
      try
      {
        if (PublicAccountUtil.a != null)
        {
          ...
          if (localGetPublicAccountDetailInfoResponse.uin.has())
          {
            ...
            {
              j = i;
              ServiceAccountFolderManager.a().a(this.jdField_a_of_type_Nah.a, (AccountDetail)localObject3);
              k = i;
            }
          }
          j = k;
      ...
      j = n;
      localObject4 = this.jdField_a_of_type_Nah.a.getHandler(Conversation.class);
      i = m;
      if (localObject4 != null)
      {
        j = n;
