...
public class bbgl
  implements DialogInterface.OnDismissListener, bbix
{
  ...
  {
    SubtitleLayout localSubtitleLayout = (SubtitleLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131378239);
    if (localSubtitleLayout != null)
    {
      alzm.a().c = alyh.a(paramInt);
      if (paramInt == 0)
      {
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    bdll.b(null, "dc00898", "", "", "0X800859F", "0X800859F", 1, 0, "", "", paramPtvTemplateInfo.id, "");
    if (paramPtvTemplateInfo.popup)
    {
      ...
      {
        bdll.b(null, "dc00898", "", "", "0X80085A0", "0X80085A0", 1, 0, str, "", "", "");
        if (!bool) {
          break;
        }
  ...
  void a(String paramString1, String paramString2)
  {
    ...
    catch (Exception paramString1)
    {
      ...
      new bjcf(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp()).a(anzj.a(2131702886), 100, 0, 1);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_Alwq == null))
    {
      alwq localalwq = new alwq(this.jdField_a_of_type_AndroidViewView.getContext());
      this.jdField_a_of_type_Alwq = localalwq;
      localalwq.a(paramString1, paramString2, paramString3, paramString7);
      localalwq.a(new bbgm(this, paramInt, paramBoolean, paramString4, paramString5, paramString6));
      localalwq.a();
      this.jdField_a_of_type_Alwq.setOnDismissListener(this);
      this.jdField_a_of_type_Alwq.show();
      paramString1 = this.jdField_a_of_type_Alwq.getWindow().getAttributes();
      paramString1.width = -1;
      paramString1.height = -1;
      this.jdField_a_of_type_Alwq.getWindow().setAttributes(paramString1);
    }
  }
  ...
  public void b(FilterCategoryItem paramFilterCategoryItem)
  {
    ...
    bdll.b(null, "dc00898", "", "", "0X800859F", "0X800859F", 2, 0, "", "", paramFilterCategoryItem.a, "");
    if (paramFilterCategoryItem.b)
    {
      ...
      for (String str = "1";; str = "0")
      {
        bdll.b(null, "dc00898", "", "", "0X80085A0", "0X80085A0", 2, 0, str, "", "", "");
        if (!bool) {
          break;
        }
