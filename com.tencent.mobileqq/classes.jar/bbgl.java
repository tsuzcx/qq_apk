  ...
  extends bbhp
{
  ...
  adlj jdField_a_of_type_Adlj;
  private adlm jdField_a_of_type_Adlm = new bbgm(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bbgn(this);
  ...
  public bbgl(Context paramContext, int paramInt)
  {
  ...
  private adlj a(bbgo parambbgo, Bundle paramBundle)
  {
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambbgo.jdField_a_of_type_JavaLangString);
    }
    i = paramBundle.getInt("req_type");
    if (ArkFullScreenAppActivity.a(paramBundle))
    {
      this.jdField_a_of_type_Adlj.a(parambbgo.jdField_a_of_type_JavaLangString, parambbgo.b, parambbgo.c, parambbgo.d, parambbgo.jdField_a_of_type_Float, parambbgo.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      if ((this.jdField_e_of_type_Int == 0) || (this.jdField_f_of_type_Int == 0)) {
        break label289;
      }
      this.jdField_a_of_type_Adlj.setFixSize(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      alpc.a = false;
      return this.jdField_a_of_type_Adlj;
      String str1 = "news";
      if (i == 2) {
        str1 = "music";
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_Adlj.a("com.tencent.structmsg", str1, "0.0.0.1", paramBundle, alsz.a(), parambbgo.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
        break;
        if (i == 4) {
          str1 = "video";
        }
      ...
      label289:
      this.jdField_a_of_type_Adlj.setFixSize(this.jdField_d_of_type_Int, this.g);
      this.jdField_a_of_type_Adlj.setMaxSize(this.jdField_d_of_type_Int, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Adlj.setMinSize(this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    }
  }
  ...
  private String a(Bundle paramBundle, String paramString)
  {
    ...
    try
    {
      ...
      {
        str1 = str3;
        if (str3.contains(ajya.a(2131710203))) {
          str1 = str3.replace(ajya.a(2131710207), "");
        }
      }
    ...
    for (;;)
    {
      ...
      bbdx.d(str6, paramString + File.separator + str1);
  ...
  {
    bbgo localbbgo = new bbgo(paramBundle);
    localbbgo.jdField_a_of_type_Float = alsz.a();
    paramBundle = a(localbbgo, paramBundle);
    paramBundle.a(this.jdField_a_of_type_Adlm);
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ((LinearLayout)findViewById(2131368198)).setVisibility(8);
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Adlj.doOnEvent(paramInt);
  }
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    try
    {
      ...
      b(7);
      setContentView(2131558916);
      View localView = LayoutInflater.from(paramContext).inflate(2131558727, null);
      localView.setPadding(0, 0, 0, 0);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)localView.findViewById(2131362768));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout = ((ArkAppLoadLayout)localView.findViewById(2131369476));
      Object localObject1 = localView.findViewById(2131362789);
      ((RelativeLayout.LayoutParams)((View)localObject1).getLayoutParams()).addRule(14);
      ((View)localObject1).setPadding(0, 0, 0, 0);
      ((LinearLayout)localView.findViewById(2131362774)).setVisibility(8);
      ...
      if ((ArkFullScreenAppActivity.a(paramBundle)) && ("card".equals(((ArkAppMessage.Config)localObject1).type))) {
        this.g = alsz.jdField_a_of_type_Int;
      }
      boolean bool2 = MessageForArkApp.isSetSizeByConfig((ArkAppMessage.Config)localObject1);
      if (bool2)
      {
        localObject2 = MessageForArkApp.limitToSizeRange(alsz.a(), ((ArkAppMessage.Config)localObject1).width.intValue(), ((ArkAppMessage.Config)localObject1).height.intValue());
        if (localObject2 != null)
        {
          ...
          if ((((ArkAppMessage.Config)localObject1).autoSize != null) && (((ArkAppMessage.Config)localObject1).autoSize.intValue() == 1)) {
            this.jdField_e_of_type_Int = alsz.jdField_a_of_type_Int;
          }
      ...
      if (this.bodyLayout != null)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).topMargin = ((int)paramContext.getResources().getDimension(2131296768));
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = ((int)paramContext.getResources().getDimension(2131296739));
        ((RelativeLayout.LayoutParams)localObject1).rightMargin = ((int)paramContext.getResources().getDimension(2131296740));
        ((RelativeLayout.LayoutParams)localObject1).bottomMargin = ((int)paramContext.getResources().getDimension(2131296764));
      }
      if (!bool1)
      {
        localObject2 = findViewById(2131363442);
        if (localObject2 != null) {
        ...
        localObject2 = findViewById(2131365109);
        if (localObject2 != null) {
          ((View)localObject2).setVisibility(8);
        }
        localObject2 = findViewById(2131365127);
        if (localObject2 != null) {
          ((View)localObject2).setVisibility(8);
        }
        ...
        i = paramContext.getResources().getDimensionPixelSize(2131296763);
        ...
        {
          alui.a(paramContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView);
  ...
  public void a(String paramString)
  {
    ...
    ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378544)).setText(paramString);
  }
