  ...
  extends Dialog
{
  ...
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new begu(this);
  ...
  protected begr(Context paramContext)
  {
    this(paramContext, false, false);
  }
  
  protected begr(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true);
  }
  
  @TargetApi(14)
  protected begr(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    super(paramContext, 2131689684);
    this.jdField_d_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new begv(this);
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131492895, null));
    super.setContentView(this.jdField_a_of_type_AndroidViewViewGroup);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131296375));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131296381));
  ...
  public static begr a(Context paramContext)
  {
    paramContext = new begr(paramContext, false, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131689474);
    }
    return paramContext;
  }
  
  public static begr a(Context paramContext, boolean paramBoolean)
  {
    paramContext = new begr(paramContext, false, true, paramBoolean);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131689474);
    }
    return paramContext;
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131625548) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131625550) + paramTextView.getText());
  }
  
  public static begr b(Context paramContext)
  {
    paramContext = new begr(paramContext, false, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131689474);
    }
    return paramContext;
  ...
  public static begr c(Context paramContext)
  {
    paramContext = new begr(paramContext, true, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131689474);
    }
    return paramContext;
  ...
  public static begr d(Context paramContext)
  {
    paramContext = new begr(paramContext, true, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131689474);
    }
    return paramContext;
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837555));
      ((View)localObject1).setOnClickListener(new begs(this));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131296391));
      ...
      {
        localObject2 = (TextView)((View)localObject1).findViewById(2131296388);
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          ...
          if (((Integer)((Pair)localObject1).second).intValue() == 65537)
          {
            ...
            localObject2 = (TextView)localView.findViewById(2131296378);
            localObject3 = (TextView)localView.findViewById(2131310894);
            ...
            if ((m >= 0) && (m < ((CharSequence)((Pair)localObject1).first).length()))
            {
              ...
              localView.findViewById(2131298203).setContentDescription(((TextView)localObject2).getText());
              label408:
              azve.b(localView.findViewById(2131298203), LinearLayout.class.getName());
              label424:
              if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
              {
                localObject3 = (begq)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
                if ((localObject3 != null) && (((begq)localObject3).jdField_b_of_type_Int != 0)) {
                  ((TextView)localObject2).setId(((begq)localObject3).jdField_b_of_type_Int);
                }
              }
              localObject3 = (ImageView)localView.findViewById(2131296389);
              localObject4 = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = azvv.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
              ...
              label565:
              localObject3 = (ImageView)localView.findViewById(2131296390);
              localObject4 = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
              ...
              {
                ((RelativeLayout.LayoutParams)localObject4).width = azvv.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).height = azvv.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).addRule(15);
              }
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = azvv.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
              ((ImageView)localObject3).setLayoutParams((ViewGroup.LayoutParams)localObject4);
              ...
              label846:
              localView.setOnClickListener(this.jdField_c_of_type_AndroidViewView$OnClickListener);
              ...
              if (this.jdField_a_of_type_Boolean)
              {
                ...
                localView.findViewById(2131296379).setVisibility(0);
          ...
          for (;;)
          {
            ...
            break label408;
            localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131492897, null);
            localObject2 = (TextView)localView.findViewById(2131296378);
            ((TextView)localObject2).setText((CharSequence)((Pair)localObject1).first);
            azve.b((View)localObject2, Button.class.getName());
            break label424;
            label1002:
  ...
  protected int a(int paramInt)
  {
    ...
    {
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099664);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099664);
    case 1: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099664);
    ...
    case 4: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099664);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099668);
    case 5: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099664);
    case 6: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131099664);
    ...
    return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100068);
  }
  ...
  public Drawable a(int paramInt)
  {
    ...
    case 2: 
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130837554);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130837551);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130837554);
    }
    return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130837558);
  }
  ...
  public begq a(int paramInt)
  {
    return a(a(paramInt));
  }
  
  public begq a(CharSequence paramCharSequence)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      return null;
    }
    return (begq)this.jdField_a_of_type_JavaUtilHashMap.get(paramCharSequence);
  }
  ...
  public void a(int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    if ((paramInt1 >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131296378);
  ...
  public void a(begq parambegq, int paramInt)
  {
    if (parambegq == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(parambegq.a, parambegq);
    a(parambegq.a, paramInt);
  }
  
  public void a(begw parambegw)
  {
  ...
  public void a(begy parambegy)
  {
    this.jdField_a_of_type_Begy = parambegy;
  }
  ...
  public void a(beha parambeha)
  {
    this.jdField_a_of_type_Beha = parambeha;
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      ((VerticalCenterImageSpan)localObject).setPadding(aciy.a(10.0F, this.jdField_a_of_type_AndroidContentResResources), 0);
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131296379).setVisibility(8);
          a((TextView)localView.findViewById(2131296378), false);
        }
        i += 1;
      }
    }
  ...
  public void d(int paramInt)
  {
    if ((paramInt >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (this.jdField_a_of_type_AndroidUtilSparseArray != null)
      {
        ...
        {
          localView.findViewById(2131296379).setVisibility(0);
          a((TextView)localView.findViewById(2131296378), true);
        }
      }
    }
  }
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Begz != null) {
      this.jdField_a_of_type_Begz.an_();
    }
    if (this.g)
    {
      this.g = false;
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 693	android/app/Dialog:dismiss	()V
    //   4: aload_0
    //   5: invokestatic 698	zqa:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 698	zqa:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 698	zqa:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
