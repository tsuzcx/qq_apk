  ...
  extends zsa
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    ...
    {
      befc.a("TroopFileDownloadWorker", befc.jdField_a_of_type_Int, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqFetchResult isSuccess:false  errCode:" + paramInt);
      this.a.c(bfdy.A);
      return;
    }
    int i = paramDownloadFileRspBody.int32_ret_code.get();
    befc.c("TroopFileDownloadWorker", befc.jdField_a_of_type_Int, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqFetchResult isSuccess:true  errCode:" + paramInt + " retCode:" + i);
    if (i < 0)
    {
      if ((i != -103) && (i != -302) && (i != -301)) {
        break label779;
      }
      befc.a("TroopFileDownloadWorker", befc.jdField_a_of_type_Int, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqFetchResult  file is not exsit. retCode:" + i);
      this.a.jdField_a_of_type_Boolean = true;
      this.a.b(4);
      this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ErrorCode = 0;
      beel.a(this.a.jdField_a_of_type_Long, this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 12);
      if (this.a.jdField_a_of_type_Begs != null) {
        this.a.jdField_a_of_type_Begs.a(this.a.a(), false, i, this.a);
      }
    }
