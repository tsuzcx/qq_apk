  ...
  extends WebViewPlugin
{
  ...
  public asvn()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new asvp(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
      ...
      if (TextUtils.equals(paramString3, "openRoom"))
      {
        try
        {
          ...
          if (localObject != null)
          {
            ...
            this.jdField_a_of_type_Ymk.a(paramJsBridgeListener, i, paramString3, paramString1, paramString2, paramVarArgs, (String)localObject);
            asvu.a("group_video", new asvo(this, paramString3));
          }
        }
        catch (Exception paramJsBridgeListener)
        {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ymk.e(null);
      return true;
    }
    catch (Exception paramJsBridgeListener)
    {
  ...
  public void onCreate()
  {
    ...
    IntentFilter localIntentFilter = new IntentFilter(aswm.a("com.tencent.od"));
    localIntentFilter.addAction(aswm.b("com.tencent.od"));
    this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, localIntentFilter);
    this.jdField_a_of_type_Bepp = new bepp(this.mRuntime.a());
  }
