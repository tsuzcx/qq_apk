  ...
  extends IArkDelegateNet
{
  public void download(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, String> paramHashMap, File paramFile, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    for (paramFile = paramFile.getAbsolutePath();; paramFile = "")
    {
      ...
      anmg.a().a("callDownload", (Bundle)localObject, new anmy(this, paramString, paramIArkDelegateNetCallback));
      return;
      str = "";
      break;
      paramHashMap = "";
    ...
    label175:
    Object localObject = ((bdvx)BaseApplicationImpl.getApplication().getRuntime().getManager(47)).a(1);
    paramFile = new bdvv(paramString, new File(paramFile));
    ...
    ((bdwa)localObject).a(paramFile, new anmz(this, paramString, paramIArkDelegateNetCallback), paramHashMap);
  }
  ...
  public void sendAppMsg(String paramString1, String paramString2, int paramInt1, int paramInt2, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      anmg.a().a("callSendAppMsg", (Bundle)localObject, new anmw(this, paramString1, paramString2, paramIArkDelegateNetCallback, paramInt2));
      return;
    }
    ...
    ((ankf)localObject).a(paramString1, paramString2, paramInt1, paramInt2, new anmx(this, paramIArkDelegateNetCallback));
  }
}
