...
public class mpz
{
  ...
  private LruCache<String, mqb> jdField_a_of_type_AndroidUtilLruCache = new mqa(this, 4194304);
  private LinkedList<mqc> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private mqc jdField_a_of_type_Mqc;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public mpz(int paramInt)
  {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        mqb localmqb = (mqb)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmqb != null)
        {
          this.jdField_a_of_type_Mqc = new mqc(localmqb, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (mqb)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Mqc = new mqc(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      if (localmqc != null) {
        localmqc.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmqc = (mqc)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmqc != null)
        {
          int j = i + localmqc.a(this.b, i, paramInt);
          i = j;
          if (!localmqc.a()) {
            break label229;
          }
      ...
      {
        mqd.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new mqb(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmqb != null)
        {
          paramString = new mqc(localmqb, false);
      ...
      if (paramString != null)
      {
        paramString = new mqc(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
