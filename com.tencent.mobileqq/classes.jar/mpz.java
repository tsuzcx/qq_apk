...
public class mpz
{
  ...
  public static void a(VideoAppInterface paramVideoAppInterface, BaseToolbar paramBaseToolbar)
  {
    ...
    for (int j = paramBaseToolbar.jdField_a_of_type_Int;; j = -1)
    {
      ...
      for (;;)
      {
        ...
        bcef.b(null, "dc00898", "", "", "0X8008977", "0X8008977", n, 0, String.valueOf(i), String.valueOf(j), jdField_a_of_type_JavaLangString, "");
        return;
        label243:
        i = 0;
      }
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    bcef.b(null, "dc00898", "", "", paramString1, paramString1, jdField_a_of_type_Int, 0, "", "", jdField_a_of_type_JavaLangString, paramString2);
  }
  
  public static void a(mqb parammqb)
  {
    if (QLog.isDevelopLevel()) {
      QLog.w("RedBagReport", 1, "reportClickEvent, key[" + "0X800897F" + "], fromType[" + jdField_a_of_type_Int + "], mSucAboutGame[" + parammqb.jdField_a_of_type_Boolean + "], mExceptionType[" + parammqb.jdField_f_of_type_Int + "], mRoomId[" + jdField_a_of_type_JavaLangString + "]");
    }
    int i = jdField_a_of_type_Int;
    int j = parammqb.jdField_f_of_type_Int;
    if (parammqb.jdField_a_of_type_Boolean) {}
    for (parammqb = "1";; parammqb = "0")
    {
      bcef.b(null, "dc00898", "", "", "0X800897F", "0X800897F", i, 0, String.valueOf(j), parammqb, jdField_a_of_type_JavaLangString, "");
      return;
    }
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      bcef.b(null, "dc00898", "", "", "0X8008978", "0X8008978", j, i, String.valueOf(paramInt), "", jdField_a_of_type_JavaLangString, String.valueOf(j));
      return;
      i = 0;
    }
  }
  ...
  public static void b(mqb parammqb)
  {
    ...
    {
      if (QLog.isDevelopLevel()) {
        QLog.w("RedBagReport", 1, "reportClickEvent, key[" + str1 + "], fromType[" + jdField_a_of_type_Int + "], getRedbag_ResultCode[" + parammqb.jdField_e_of_type_JavaLangString + "], getRedbag_ResultState[" + parammqb.jdField_f_of_type_JavaLangString + "], mRoomId[" + jdField_a_of_type_JavaLangString + "], hitScore[" + parammqb.jdField_a_of_type_Int + "]");
      }
      bcef.b(null, "dc00898", "", "", str1, str1, jdField_a_of_type_Int, parammqb.jdField_a_of_type_Int, String.valueOf(parammqb.jdField_f_of_type_Int), parammqb.jdField_e_of_type_JavaLangString, jdField_a_of_type_JavaLangString, parammqb.jdField_f_of_type_JavaLangString);
      return;
      str1 = "0X800897E";
      continue;
      str1 = "0X8008983";
  ...
  public static void b(boolean paramBoolean, int paramInt)
  {
    ...
    bcef.b(null, "dc00898", "", "", str, str, jdField_a_of_type_Int, 0, String.valueOf(paramInt), "", jdField_a_of_type_JavaLangString, null);
  }
