...
public class aukn
{
  ...
  aukn(akfv paramakfv, String paramString)
  {
    this.jdField_a_of_type_Akfv = paramakfv;
  ...
  /* Error */
  private List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, aukx paramaukx, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: iload_3
    ...
    //   12: aload 8
    //   14: aload 9
    //   16: invokevirtual 55	aukn:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   19: astore 5
    //   21: aload 5
    //   23: ifnull +122 -> 145
    //   26: new 57	aukg
    //   29: dup
    //   30: aload 5
    //   32: invokespecial 60	aukg:<init>	(Landroid/database/Cursor;)V
    //   35: astore 4
    //   37: aload 4
    //   39: astore 5
    //   41: aload_0
    ...
    //   44: aload 4
    //   46: aload 10
    //   48: invokevirtual 63	aukn:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;Laukx;)Ljava/util/List;
    //   51: astore_1
    //   52: aload 4
    //   54: ifnull +10 -> 64
    //   57: aload 4
    ...
    //   0	154	0	this	aukn
    //   0	154	1	paramClass	Class<? extends aukm>
  ...
  private boolean a(String paramString, aukm paramaukm, boolean paramBoolean)
  {
    ...
    for (boolean bool2 = ((Boolean)jdField_a_of_type_JavaUtilMap.get(str)).booleanValue();; bool2 = false)
    {
      ...
      if (!bool2)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
          this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = this.jdField_a_of_type_Akfv.a();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase != null) {
          break label82;
        }
      ...
      {
        return bool1;
        bool2 = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(auln.a(paramaukm));
        paramaukm = auln.b(paramaukm);
        if (paramaukm != null) {
          this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramaukm);
        }
  ...
  {
    return this.jdField_a_of_type_Akfv.a().a(paramString1, paramString2, paramArrayOfString);
  }
  
  protected ContentValues a(aukm paramaukm)
  {
    List localList = auln.a(paramaukm.getClassForTable());
    ...
    if (i < j)
    {
      ...
      localObject = ((Field)localObject).get(paramaukm);
  ...
  public Cursor a(boolean paramBoolean, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    try
    {
      if (d(paramString1))
      {
        paramString1 = this.jdField_a_of_type_Akfv.b().a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString5, paramString6);
        return paramString1;
      }
    }
  ...
  public aukm a(Class<? extends aukm> paramClass, long paramLong)
  {
    try
    {
      paramClass = a(paramClass, auln.a(paramClass), false, "_id=?", new String[] { String.valueOf(paramLong) }, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (aukm)paramClass.get(0);
      }
    }
  ...
  public aukm a(Class<? extends aukm> paramClass, Cursor paramCursor)
  {
    try
    {
      paramClass = a(paramClass, auln.a(paramClass), paramCursor);
      return paramClass;
    }
  ...
  public aukm a(Class<? extends aukm> paramClass, String paramString)
  {
    Object localObject = auln.a(paramClass);
    ...
    while (i < j)
    {
      ...
      if (localField.isAnnotationPresent(auma.class))
      {
        ...
        try
        {
          paramClass = a(paramClass, auln.a(paramClass), false, (String)localObject, new String[] { paramString }, null, null, null, null, null, 3);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localaukm != null)
          {
            ...
            if (aukm.class.isAssignableFrom(localClass))
            {
              localObject = a(localClass, paramCursor);
              ((aukm)localObject)._status = 1002;
              localField.set(localaukm, localObject);
            }
            localObject = localField.getName();
        ...
        else
        {
          ...
          if (localClass == Double.TYPE)
          {
            ...
            if (paramaukx != null)
            {
              paramaukx.a(new NoColumnError((String)localObject, localClass));
              break label568;
              if ((l != -1L) && (paramString != null)) {}
              for (localaukm._status = 1001;; localaukm._status = 1002)
              {
                localaukm.postRead();
                return localaukm;
              }
  ...
  public aukm a(Class<? extends aukm> paramClass, String paramString, String[] paramArrayOfString)
  {
  ...
  public aukm a(Class<? extends aukm> paramClass, String... paramVarArgs)
  {
    ...
    try
    {
      paramClass = a(paramClass, auln.a(paramClass), false, localStringBuffer.toString(), paramVarArgs, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (aukm)paramClass.get(0);
      }
    }
  ...
  public aukp a()
  {
    if (this.jdField_a_of_type_Aukp == null) {
      this.jdField_a_of_type_Aukp = new aukp(this.jdField_a_of_type_Akfv);
    }
    return this.jdField_a_of_type_Aukp;
  }
  
  public List<? extends aukm> a(Class<? extends aukm> paramClass)
  {
    try
    {
      paramClass = a(paramClass, auln.a(paramClass), false, null, null, null, null, null, null, null, 2);
      return paramClass;
    }
    catch (InstantiationException paramClass)
    {
  ...
  public List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString, Cursor paramCursor)
  {
    return a(paramClass, paramString, paramCursor, null);
  }
  
  public List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString, Cursor paramCursor, aukx paramaukx)
  {
    localObject4 = null;
  ...
  /* Error */
  public List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   4: astore 7
    //   6: aload_0
    //   7: getfield 33	aukn:jdField_a_of_type_Akfv	Lakfv;
    //   10: invokevirtual 235	akfv:b	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   13: aload_2
    //   14: aload_3
    //   15: aload 4
    //   17: aload 5
    ...
    //   34: aconst_null
    //   35: aload_2
    //   36: invokevirtual 473	aukn:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   39: astore_1
    //   40: aload_1
    //   41: astore_3
    //   42: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	119	0	this	aukn
    //   0	119	1	paramClass	Class<? extends aukm>
  ...
  public List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6)
  {
  ...
  public List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, aukx paramaukx)
  {
    return a(paramClass, paramString1, paramBoolean, paramString2, paramArrayOfString, paramString3, paramString4, paramString5, paramString6, paramaukx, 1);
  }
  
  /* Error */
  public List<? extends aukm> a(Class<? extends aukm> paramClass, String paramString, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   30: aconst_null
    //   31: aload_2
    //   32: invokevirtual 473	aukn:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   35: astore_1
    //   36: aload_1
    //   37: astore_3
    //   38: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	157	0	this	aukn
    //   0	157	1	paramClass	Class<? extends aukm>
  ...
  public List<? extends aukm> a(Class<? extends aukm> paramClass, boolean paramBoolean, String paramString1, String[] paramArrayOfString, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    try
    {
      paramString1 = a(paramClass, auln.a(paramClass), paramBoolean, paramString1, paramArrayOfString, paramString2, paramString3, paramString4, paramString5);
      return paramString1;
    }
    catch (Exception paramString1)
    {
  ...
  public void a(aukm paramaukm)
  {
    ...
    catch (Throwable paramaukm)
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persist error", paramaukm);
    }
  }
  ...
  protected void a(aukm paramaukm, boolean paramBoolean)
  {
    ...
    String str;
    if (paramaukm._status == 1000)
    {
      str = paramaukm.getTableName();
      a(str, paramaukm, false);
      paramaukm.prewrite();
    }
    for (;;)
    {
      try
      {
        localContentValues = a(paramaukm);
        if (!paramBoolean) {
          continue;
        }
  ...
  public boolean a(aukm paramaukm)
  {
    ...
    try
    {
      if ((paramaukm._status == 1001) || (paramaukm._status == 1002))
      {
        ContentValues localContentValues = a(paramaukm);
        int i = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramaukm.getTableName(), localContentValues, "_id=?", new String[] { String.valueOf(paramaukm._id) });
        return i > 0;
      }
    }
    catch (Exception localException)
  ...
  public boolean a(aukm paramaukm, String paramString, String[] paramArrayOfString)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
    ...
    paramaukm.prewrite();
    if (paramaukm._status == 1001)
    {
      bool1 = bool2;
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramaukm.getTableName(), paramString, paramArrayOfString) > 0) {
        bool1 = true;
      }
      paramaukm._status = 1003;
    }
    paramaukm.postwrite();
    return bool1;
  }
  
  public boolean a(Class<? extends aukm> paramClass)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
      this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = this.jdField_a_of_type_Akfv.a();
    }
  ...
  public void b(aukm paramaukm)
  {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persistOrReplace error", paramaukm);
    }
  }
  ...
  public boolean b(aukm paramaukm)
  {
    ...
    paramaukm.prewrite();
    if (paramaukm._status == 1001) {
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramaukm.getTableName(), "_id=?", new String[] { String.valueOf(paramaukm._id) }) > 0) {
        paramaukm._status = 1003;
      }
    }
    for (;;)
  ...
  public boolean b(String paramString)
  {
    try
    {
      this.jdField_a_of_type_Akfv.b().a(paramString);
      return true;
    }
    catch (Exception paramString)
    {
  ...
  public boolean d(String paramString)
  {
    ...
    do
    {
      ...
      localSQLiteDatabase = this.jdField_a_of_type_Akfv.b();
