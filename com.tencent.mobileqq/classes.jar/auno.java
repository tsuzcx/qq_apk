  ...
  implements Manager
{
  ...
  private auns jdField_a_of_type_Auns;
  private aunt jdField_a_of_type_Aunt;
  private aunu jdField_a_of_type_Aunu;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<aunr>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<aunp>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<aunq>> d = new HashMap(5);
  ...
  public auno(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Asii = ((asii)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	auno:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	auno:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, aunr paramaunr)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramaunr));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, aunp paramaunp)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramaunp));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, aunq paramaunq)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramaunq));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Asii.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Auns != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Auns);
      this.jdField_a_of_type_Auns = null;
    }
    if (this.jdField_a_of_type_Aunt != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aunt);
      this.jdField_a_of_type_Aunt = null;
    }
    if (this.jdField_a_of_type_Aunu != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aunu);
      this.jdField_a_of_type_Aunu = null;
    }
  ...
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, aunp paramaunp)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaunp != null) && (??? != null))
      {
        if (bdin.d(paramContext)) {
          break;
        }
        a(paramLong, ???, paramaunp);
      }
      return;
    }
    ...
    a(paramLong, ???, paramaunp);
    paramaunp = new WeakReference(paramaunp);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramaunp);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramaunp = new ArrayList(1);
      paramaunp.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramaunp);
      ((asig)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, aunq paramaunq)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaunq != null) && (paramArrayList != null))
      {
        if (bdin.d(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramaunq);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramaunq);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Asii.a(paramString, paramIntimateInfo);
