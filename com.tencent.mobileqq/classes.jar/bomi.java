  ...
  extends DynamicTextItem
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = AIOUtils.dp2px(27.0F, localResources);
    jdField_d_of_type_Int = AIOUtils.dp2px(6.0F, localResources);
    int i = bpdd.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - yri.a - i * 2;
  }
  
  public bomi(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
