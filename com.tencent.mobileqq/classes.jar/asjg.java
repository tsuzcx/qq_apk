  ...
  implements asjf
{
    ...
    if (localObject1 != null)
    {
      ...
      if (localJSONArray != null)
      {
        ...
        for (;;)
        {
          ...
          localQQEmoConfigItem = (QQSysAndEmojiResInfo.QQEmoConfigItem)avyx.a((JSONObject)localObject1, QQSysAndEmojiResInfo.QQEmoConfigItem.class);
          try
          {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    bdla.b(null, "dc00898", "", "", "0X800A7A2", "0X800A7A2", paramInt1, 0, String.valueOf(paramInt2), "", "", "");
  }
  
  public boolean a(int paramInt)
  {
    boolean bool = false;
    String str = asjb.a(2, String.format("/s%d.png", new Object[] { Integer.valueOf(paramInt) }));
  ...
  public Drawable b(int paramInt)
  {
    ...
    //   103: invokevirtual 106	asjg:a	(Ljava/net/URL;Landroid/graphics/drawable/Drawable;ZLjava/lang/String;)Landroid/graphics/drawable/Drawable;
    //   106: areturn
    //   107: astore 5
    //   109: aconst_null
    //   110: astore_3
