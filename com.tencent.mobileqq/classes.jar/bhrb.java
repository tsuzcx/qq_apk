...
public class bhrb
{
  private static bhrb jdField_a_of_type_Bhrb;
  public static final Object a;
  public int a;
  final bhqs jdField_a_of_type_Bhqs = new bhqs(new bhrc(this));
  public boolean a;
  public int b = 0;
  ...
  public static bhrb a()
  {
    if (jdField_a_of_type_Bhrb == null) {}
    try
    {
      if (jdField_a_of_type_Bhrb == null) {
        jdField_a_of_type_Bhrb = new bhrb();
      }
      return jdField_a_of_type_Bhrb;
    }
    finally {}
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      bhrd.b();
      bhqc.X = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "initX5Environment on main thread, cost " + bhqc.X + "ms.");
      return 1;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (Looper.getMainLooper() == Looper.myLooper())
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bhqs.b();
        this.jdField_a_of_type_Bhqs.a(localBundle);
  ...
  public int b(Bundle paramBundle)
  {
    ...
    bhqc.Y = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateWebView:create webview cost " + bhqc.Y + "ms.");
    return 1;
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    bhqc.Z = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "tendocpreload doMainStep_WarnUpWebView:load " + paramBundle + ", cost " + bhqc.Z + "ms.");
    return 1;
  }
  ...
  public int e(Bundle paramBundle)
  {
    ...
    if (WebAccelerateHelper.preloadBrowserView == null)
    {
      ...
      bhqc.aa = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateBrowserView, cost = " + bhqc.aa + "ms.");
      return 1;
    }
    return 0;
  }
