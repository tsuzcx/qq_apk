...
public class aqud
  implements bahf, bakb
{
  private double jdField_a_of_type_Double;
  int jdField_a_of_type_Int = 0;
  private Handler jdField_a_of_type_AndroidOsHandler = new aque(this, Looper.getMainLooper());
  ...
  public aqud(WebRecordApiPlugin paramWebRecordApiPlugin, AppInterface paramAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  private void e(String paramString)
  {
    ...
    {
      return;
      localObject = azzf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "LAST_DELETE_TIME");
    ...
    for (;;)
    {
      if (paramInt1 != 0)
      {
        ...
        if ((new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1) && (localObject != null) && (localObject[1] > 2L))
        {
          ...
          e(ajed.aU + "webrecord/");
          if (this.b == 0) {
            localObject = new QQRecorder.RecorderParam(bahn.jdField_a_of_type_Int, 0, 0);
          }
          for (this.jdField_a_of_type_JavaLangString = a(2, true);; this.jdField_a_of_type_JavaLangString = a(25, true))
          {
            ...
            c(0);
            return;
            localObject = new QQRecorder.RecorderParam(bahn.b, 16000, 1);
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131653221) + "'}" });
        return;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131629029) + "'}" });
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    {
      aucl.b(paramString);
      azzf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_JavaLangString, Double.toString(this.jdField_a_of_type_Double));
      arrayOfByte = bace.a(paramString);
      localObject = null;
  ...
  public void a(JSONArray paramJSONArray, String paramString1, String paramString2)
  {
    ...
    if (i < paramJSONArray.length())
    {
      ...
      String str = azzf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (String)localObject);
      long l;
  ...
  public void b(String paramString)
  {
    ...
    if ((((File)localObject).exists()) && (azzf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString) != null))
    {
      double d = Double.valueOf(azzf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString)).doubleValue();
      long l;
      if (((File)localObject).exists())
      {
        ...
        this.jdField_a_of_type_Baka = new baka(((AudioInfo)localObject).path, new Handler(), ((AudioInfo)localObject).getAudioType());
        this.jdField_a_of_type_Baka.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
