  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  public bhql()
  {
    ...
    this.jdField_a_of_type_Bhqo = new bhqo();
  ...
  private void a(Uri paramUri)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x20000) != 0L) {
        bcst.a(null, "dc00898", "", "", "0X800ADD8", "0X800ADD8", 131072, 0, "", "", str, "");
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x1000000) != 0L) {
        bcst.a(null, "dc00898", "", "", "0X800ADD8", "0X800ADD8", 16777216, 0, "", "", str, "");
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x2) != 0L) {
        bcst.a(null, "dc00898", "", "", "0X800ADD8", "0X800ADD8", 2, 0, "", "", str, "");
      }
      return;
    }
  ...
  private void a(String paramString1, String paramString2, long paramLong)
  {
    try
    {
      ...
      if (!"1".equals(nhe.a().a("wv_ctrl_switch", "")))
      {
      ...
      {
        if ((!nhe.a().a(paramString2, paramString1)) && ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & paramLong) != 0L))
        {
          paramString1 = this.jdField_a_of_type_Bhqo;
  ...
  {
    return (TouchWebView)this.jdField_a_of_type_Bhov.a();
  }
  ...
  public void a()
  {
    ...
    {
      WebView localWebView = this.jdField_a_of_type_Bhov.a();
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      return;
    case 2: 
      nmj.a("Web_updateTitleBarUI");
      if (this.jdField_a_of_type_Bhqo.s) {
        this.jdField_a_of_type_Bhmv.h();
      }
      nmj.b("Web_updateTitleBarUI");
      return;
    case 3: 
      ...
      this.jdField_a_of_type_Bhmv.f();
      return;
    case 4: 
      if ((this.jdField_a_of_type_Bhmq.jdField_a_of_type_AndroidViewView != null) && (8 == this.jdField_a_of_type_Bhmq.jdField_c_of_type_AndroidViewView.getVisibility())) {
        this.jdField_a_of_type_Bhmq.a();
      }
      if (paramBundle.containsKey("Configuration")) {}
      for (paramBundle = (Configuration)paramBundle.getParcelable("Configuration"); (paramBundle != null) && (this.jdField_a_of_type_Bhmq.jdField_c_of_type_AndroidViewView != null) && (paramBundle.orientation == 2) && (this.jdField_a_of_type_Bhmq.jdField_c_of_type_AndroidViewView.getVisibility() == 0); paramBundle = null)
      {
        this.jdField_a_of_type_Bhmq.jdField_c_of_type_AndroidViewView.setVisibility(8);
        return;
      }
    case 6: 
      if ((!this.jdField_a_of_type_Bhqc.j) && (this.jdField_a_of_type_Bidh != null) && (this.jdField_a_of_type_Bidh.b() != 0)) {
    ...
    for (paramBundle = paramBundle.getString("url");; paramBundle = null)
    {
      ...
      {
        this.jdField_a_of_type_Bhmv.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_a_of_type_Bhqo.y = true;
      }
      a(this.jdField_a_of_type_Bhov.a());
      return;
      if (this.jdField_a_of_type_Bidh != null) {
        this.jdField_a_of_type_Bidh.a((byte)2);
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      if ((this.jdField_a_of_type_Bhqo.D) || (this.jdField_b_of_type_AndroidWidgetTextView == null)) {
        break;
      }
      if ((this.jdField_c_of_type_AndroidViewView != null) && (this.jdField_a_of_type_Int == -1)) {
        this.jdField_c_of_type_AndroidViewView.setBackgroundResource(2131167275);
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      if (this.jdField_a_of_type_Bhov.a() == null) {
        break;
      }
      localObject1 = (TouchWebView)this.jdField_a_of_type_Bhov.a();
      ...
      for (;;)
      {
        ...
        ((TouchWebView)localObject1).setOnOverScrollHandler(new bhqm(this, (TouchWebView)localObject1, paramBundle));
        ((TouchWebView)localObject1).setOnScrollChangedListener(new bhqn(this));
        b(this.jdField_a_of_type_Bhov.a());
        return;
        label566:
  ...
  public void a(Intent paramIntent)
  {
    int i;
    boolean bool;
    if (((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x20000) != 0L) || (paramIntent.getBooleanExtra("isFullScreen", false)))
    {
      i = 1;
      if (i != 0) {
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean = true;
      }
      bhqo localbhqo = this.jdField_a_of_type_Bhqo;
      if (((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x1000000) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitle", false))) {
        break label696;
      }
      bool = true;
      label76:
      localbhqo.jdField_b_of_type_Boolean = bool;
      localbhqo = this.jdField_a_of_type_Bhqo;
      if (((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitleAndClickable", false))) {
        break label701;
      }
      bool = true;
      label115:
      localbhqo.m = bool;
      localbhqo = this.jdField_a_of_type_Bhqo;
      if (((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x2) == 0L) && (!paramIntent.getBooleanExtra("hide_more_button", false))) {
        break label706;
      }
      bool = true;
      label156:
      localbhqo.e = bool;
      localbhqo = this.jdField_a_of_type_Bhqo;
      if (((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("hide_operation_bar", false)) && (!"noBottomBar".equals(paramIntent.getStringExtra("webStyle")))) {
        break label711;
      }
      bool = true;
      label211:
      localbhqo.f = bool;
      localbhqo = this.jdField_a_of_type_Bhqo;
      if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 0x100) == 0L) {
        break label716;
      }
      bool = true;
      label241:
      ...
      {
        this.jdField_a_of_type_Bhqo.e = true;
        this.jdField_a_of_type_Bhqo.f = true;
      }
      i = paramIntent.getIntExtra("reqType", -1);
      if ((!this.jdField_a_of_type_Bhqo.f) && (i == 6)) {
        this.jdField_a_of_type_Bhqo.f = true;
      }
      this.jdField_a_of_type_Bhqo.g = paramIntent.getBooleanExtra("fromOneCLickCLose", false);
      this.jdField_a_of_type_Bhqo.q = paramIntent.getBooleanExtra("rightTopCancel", false);
      this.jdField_a_of_type_Bhqo.r = paramIntent.getBooleanExtra("webViewMoveTop", false);
      if ((!this.jdField_a_of_type_Bhqo.e) && ((i == 3) || (i == 1) || (!paramIntent.getBooleanExtra("ba_is_login", true)) || (i == 7))) {
        this.jdField_a_of_type_Bhqo.e = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x20000) > 0L) {
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x20000000) != 0L) {
        this.jdField_a_of_type_Bhqo.s = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x800) > 0L)
      {
        this.jdField_a_of_type_Bhqo.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 0x4) > 0L)
      {
        this.jdField_a_of_type_Bhqo.jdField_d_of_type_Boolean = false;
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 0x2) > 0L) {
        this.jdField_a_of_type_Bhqo.h = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 0x200) > 0L) {
        this.jdField_a_of_type_Bhqo.D = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 0x400) > 0L)
      {
        localbhqo = this.jdField_a_of_type_Bhqo;
        this.jdField_a_of_type_Bhqo.B = true;
        localbhqo.E = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long & 0x2000) > 0L) {
        this.jdField_a_of_type_Bhqo.p = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_d_of_type_Long & 1L) > 0L) {
        this.jdField_a_of_type_Bhqo.jdField_b_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_d_of_type_Long & 0x8) > 0L) {
        this.jdField_a_of_type_Bhqo.m = true;
      }
      if (!paramIntent.getBooleanExtra("from_single_task", false)) {
        break label721;
      }
      this.jdField_a_of_type_Bhqo.G = true;
    }
    label696:
    label701:
    label706:
    ...
    label716:
    label721:
    while ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long & 0x80000000) <= 0L)
    {
      return;
      i = 0;
      break;
    ...
    this.jdField_a_of_type_Bhqo.F = nhe.a().j(paramIntent.getStringExtra("url"));
  }
  
  public void a(Intent paramIntent, String paramString)
  {
    this.jdField_a_of_type_Bhmv.a(paramIntent, paramString);
  ...
  {
    this.jdField_a_of_type_Bhmv.a(paramView, paramInt1, paramInt2, paramInt3);
  }
  ...
  public void a(View paramView, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      return;
      int i;
      if ((this.jdField_a_of_type_Bhqo.B) && (!"1000".equals(ThemeUtil.getCurrentThemeId()))) {
        i = 1;
      }
  ...
  {
    this.jdField_a_of_type_Bhmv.a(paramTouchWebView);
  }
  ...
  {
    long l2 = System.currentTimeMillis();
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramWebBrowserViewContainer.findViewById(2131367271));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(0);
    if ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Bhqo.jdField_c_of_type_Long != 0L))
    {
      paramWebBrowserViewContainer.b(this.jdField_a_of_type_Bhqo.H);
      this.jdField_a_of_type_Bhmq.a(paramWebBrowserViewContainer, this.jdField_a_of_type_AndroidViewView$OnClickListener);
      this.jdField_a_of_type_Bhmq.a(this.jdField_a_of_type_AndroidAppActivity);
    }
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Bhqc.s = (l1 - l2);
    this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar = ((WebViewProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372936));
    ...
    paramIntent = this.jdField_a_of_type_Bidh;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      nmj.a("Web_qqbrowser_initView_WebViewWrapper");
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131381162));
      nmj.b("Web_qqbrowser_initView_WebViewWrapper");
      l2 = System.currentTimeMillis();
      this.jdField_a_of_type_Bhqc.m = (l2 - l1);
      if (!this.jdField_a_of_type_Bhqo.D)
      {
        this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363656);
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363657));
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131378312));
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(4);
        if ((this.jdField_a_of_type_Bhqo.jdField_b_of_type_Boolean) && ((this.jdField_a_of_type_AndroidAppActivity instanceof BaseActivity))) {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131376313));
      }
      if ((this.jdField_a_of_type_Bhqo.C) && (this.jdField_c_of_type_AndroidViewView != null)) {
        this.jdField_c_of_type_AndroidViewView.setPadding(0, (int)bgme.a(BaseApplicationImpl.getContext(), 30.0F), 0, 0);
      }
      l();
      ...
      if (this.jdField_a_of_type_Bhmv != null) {
        this.jdField_a_of_type_Bhmv.b();
      }
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bhqo.g)
    {
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Bhqo.jdField_a_of_type_Long = Long.parseLong(str, 10);
    ...
    catch (NumberFormatException localNumberFormatException6)
    {
      try
      {
        this.jdField_a_of_type_Bhqo.jdField_c_of_type_Long = Long.parseLong(paramString, 10);
        paramString = localUri.getQueryParameter("_fu");
        this.jdField_a_of_type_Bhqo.jdField_c_of_type_Boolean = false;
        if (paramString == null) {}
      }
      catch (NumberFormatException localNumberFormatException6)
      {
        try
        {
          if (Long.parseLong(paramString) == 2019L) {
            this.jdField_a_of_type_Bhqo.jdField_c_of_type_Boolean = true;
          }
        ...
        catch (NumberFormatException localNumberFormatException6)
        {
          try
          {
            this.jdField_a_of_type_Bhqo.jdField_b_of_type_Long = Long.parseLong(paramString, 10);
          ...
          catch (NumberFormatException localNumberFormatException6)
          {
            try
            {
              this.jdField_a_of_type_Bhqo.jdField_d_of_type_Long = Long.parseLong(str, 10);
              paramString = localUri.getQueryParameter("channel");
              if (!TextUtils.isEmpty(paramString)) {
                this.jdField_a_of_type_Bhqo.jdField_a_of_type_JavaLangString = URLDecoder.decode(paramString);
              }
            ...
            catch (NumberFormatException localNumberFormatException6)
            {
              try
              {
                this.jdField_a_of_type_Bhqo.jdField_a_of_type_Int = Integer.parseInt(paramString.trim());
              ...
              catch (NumberFormatException localNumberFormatException6)
              {
                ...
                catch (NumberFormatException localNumberFormatException6)
                {
                  try
                  {
                    for (;;)
                    {
                      this.jdField_a_of_type_Bhqo.jdField_b_of_type_Int = Integer.parseInt(paramString.trim());
                  ...
                  catch (NumberFormatException localNumberFormatException7)
                  {
                    for (;;)
                    {
                      ...
                      continue;
                      this.jdField_a_of_type_Bhqo.H = false;
                    }
                  }
                }
              }
  ...
  {
    this.jdField_a_of_type_Bhmv.a(paramJSONObject, paramBoolean);
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bhqo.n == paramBoolean) {}
    Object localObject;
    for (;;)
    {
      return;
      this.jdField_a_of_type_Bhqo.n = paramBoolean;
      localObject = null;
      ...
      {
        ((View)localObject).setBackgroundColor(BaseApplicationImpl.getContext().getResources().getColor(2131167042));
        if (!paramBoolean) {
          break label98;
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          localObject = this.jdField_a_of_type_Bhmv.jdField_a_of_type_AndroidViewViewGroup;
        }
      }
    }
    label98:
  ...
  public void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Bhmv.a((TouchWebView)this.jdField_a_of_type_Bhov.a(), paramBoolean1, paramInt1, paramInt2, paramInt3, paramBoolean2, paramString1, paramString2, paramString3);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bhqo.jdField_a_of_type_OrgJsonJSONObject == null) {
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_OrgJsonJSONObject = this.jdField_a_of_type_Bhmv.a(paramString);
      }
    } while ((this.jdField_a_of_type_Bhqo.jdField_a_of_type_OrgJsonJSONObject == null) || (this.jdField_a_of_type_Bhqo.jdField_a_of_type_OrgJsonJSONObject.length() == 0));
    if (this.jdField_a_of_type_Bhqo.jdField_a_of_type_OrgJsonJSONObject.optInt("trans", -1) == 0) {
      this.jdField_a_of_type_Bhqo.w = true;
    }
    if (!this.jdField_a_of_type_Bhqo.w) {
      this.jdField_a_of_type_Bhqo.w = this.jdField_a_of_type_Bhmv.a();
    }
    return true;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bhqc = ((bhqc)this.jdField_a_of_type_Bhov.a().a(-2));
  }
  ...
  public void b(Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("1".equals(localUri.getQueryParameter("_qStyle")))
      {
        ...
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = paramIntent;
        return;
      }
      WebViewTitleStyle localWebViewTitleStyle = a((String)localObject);
      if (localWebViewTitleStyle != null)
      {
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = localWebViewTitleStyle;
        return;
      }
      Object localObject = b((String)localObject);
      if (localObject != null)
      {
        this.jdField_a_of_type_Bhqo.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = ((WebViewTitleStyle)localObject);
        return;
      }
      ...
      paramIntent = (WebViewTitleStyle)bhmi.a().a.get(paramIntent);
  ...
  {
    if (this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean) {}
    do
    {
      do
      {
        return;
      } while ((this.jdField_a_of_type_AndroidViewViewGroup != null) || (!this.jdField_a_of_type_Bhqo.g));
      paramIntent = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363610);
    } while (paramIntent == null);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramIntent.inflate());
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363205));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageView.setEnabled(false);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131367027));
  ...
  public void b(WebView paramWebView)
  {
    if (this.jdField_a_of_type_Bhqo.g)
    {
      if (!this.jdField_a_of_type_Bhqo.k) {
        break label26;
      }
      a(paramWebView);
    }
  ...
  {
    if ((!this.jdField_a_of_type_Bhqo.g) || (this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean)) {}
    ...
    do
    {
      ...
      localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bhov.a();
    ...
    bcst.a(null, "dc00898", "", "", "0X8009B1E", "0X8009B1E", 0, 0, "", "", "", "");
    return;
    this.e = false;
    h();
    this.jdField_a_of_type_AndroidViewViewGroup.clearAnimation();
  ...
  public void c()
  {
    this.jdField_a_of_type_Bhmv = bhls.a(this);
    this.jdField_a_of_type_Bhmq = bhmp.a(this);
  }
  
  public void c(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bhmq.a(paramBoolean);
  }
  
  public void d()
  {
    if ((this.jdField_a_of_type_Bhov.a() != null) && (!this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean)) {
      a((TouchWebView)this.jdField_a_of_type_Bhov.a());
    }
  }
  
  public void d(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bhmv.jdField_a_of_type_Bhqo.l = paramBoolean;
    if (paramBoolean)
    {
      this.jdField_a_of_type_Bhmv.a("");
      return;
    }
    this.jdField_a_of_type_Bhmv.d();
  }
  
  public void e()
  {
    if ((this.jdField_a_of_type_Bhqo.r) && (!this.jdField_a_of_type_Bhqo.w)) {
      this.jdField_a_of_type_Bhqo.w = this.jdField_a_of_type_Bhmv.a();
    }
  }
  ...
  public void f()
  {
    ViewStub localViewStub = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363568);
    if (localViewStub == null) {
      return;
    }
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)localViewStub.inflate());
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379464));
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Bhqo.q)
    {
      localViewStub = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131366759);
      if (localViewStub != null) {}
    }
    else
    {
  ...
  public void h()
  {
    ...
    if ((this.jdField_a_of_type_Bhov.a() != null) && (this.jdField_a_of_type_AndroidViewViewGroup != null))
    {
    ...
    if (this.e)
    {
      ...
      f = this.jdField_a_of_type_Bhqo.jdField_c_of_type_Int;
    }
  ...
  public void i()
  {
    if (this.jdField_a_of_type_Bhmq.g != null) {
      this.jdField_a_of_type_Bhmq.g.setVisibility(0);
    }
    if ((this.jdField_a_of_type_Bhmq.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_Bhmq.jdField_a_of_type_AndroidViewView.getVisibility() == 8) || (this.jdField_a_of_type_Bhmq.jdField_a_of_type_AndroidViewView.getVisibility() == 4))) {
      this.jdField_a_of_type_Bhmq.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
  }
  ...
  public void l()
  {
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_Bhqo.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Bhqo.jdField_a_of_type_JavaLangBoolean.booleanValue()))
    {
      i = 1;
      if (i != 0) {
        break label74;
      }
      if ((!this.jdField_a_of_type_Bhqo.e) || (this.jdField_a_of_type_Bhqo.h)) {
        break label69;
      }
      bool = true;
    }
    for (;;)
    {
      ...
      continue;
      label74:
      bool = this.jdField_a_of_type_Bhqo.jdField_a_of_type_JavaLangBoolean.booleanValue();
    }
    label88:
    if (this.jdField_a_of_type_Bhqo.jdField_d_of_type_Boolean)
    {
  ...
  public void onClick(View paramView)
  {
    ...
    TouchWebView localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bhov.a();
    ...
    for (;;)
    {
      ...
      if ((localTouchWebView != null) && (localTouchWebView.canGoBack()))
      {
        ...
        b(localTouchWebView);
        bcst.a(null, "dc00898", "", "", "0X8009B21", "0X8009B21", 0, 0, "", "", "", "");
        continue;
        if ((localTouchWebView != null) && (localTouchWebView.canGoForward()))
        {
          ...
          b(localTouchWebView);
          bcst.a(null, "dc00898", "", "", "0X8009B20", "0X8009B20", 0, 0, "", "", "", "");
        }
      }
    }
  }
