  ...
  implements asor
{
  ...
  protected asod(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, behi parambehi)
  {
    super(paramLong, paramItem, paramBundle, parambehi);
  }
  
  public static behl a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, behi parambehi)
  {
    if (paramLong == 0L)
    {
      befc.a("ExcitingTransfer.TroopFileUploadWorker", befc.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      befc.a("ExcitingTransfer.TroopFileUploadWorker", befc.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null) {
      befc.a("ExcitingTransfer.TroopFileUploadWorker", befc.jdField_a_of_type_Int, "getWoker. item.id=null");
    }
    return new asod(paramLong, paramItem, paramBundle, parambehi);
  }
  ...
  private ExcitingTransferUploadResultRp a()
  {
    ...
    if (this.jdField_a_of_type_Begw != null)
    {
      ...
      if ((this.jdField_a_of_type_Begw instanceof asoo)) {
        localObject1 = ((asoo)this.jdField_a_of_type_Begw).a();
      }
    }
    return localObject1;
  }
  ...
  private void c(int paramInt)
  {
    ...
    asoc localasoc = new asoc(befa.a());
    localasoc.c(paramInt);
    int i = f();
    if (localObject != null) {
      if (((ExcitingTransferUploadResultRp)localObject).m_nResult == 0L)
      {
        localasoc.a((ExcitingTransferUploadResultRp)localObject);
        paramInt = ataw.b(((ExcitingTransferUploadResultRp)localObject).m_strServerIp);
        localasoc.c(this.jdField_a_of_type_Long);
        localObject = aszt.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
        localasoc.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
        localasoc.c(this.jdField_a_of_type_Been.jdField_a_of_type_Boolean);
        long l = System.currentTimeMillis() - this.jdField_a_of_type_Been.jdField_d_of_type_Long;
        if (l <= 0L) {
          break label380;
        }
        localasoc.b(l);
        label152:
        l = this.jdField_a_of_type_Been.g;
        if (l <= 0L) {
          break label389;
        }
        localasoc.a(l);
    ...
    {
      localasoc.a(i);
      localasoc.b(paramInt);
      localasoc.d(this.jdField_b_of_type_Boolean);
      localasoc.a(bool);
      return;
      bool = false;
      break;
      ...
      if (paramInt == 0)
      {
        ...
        if (this.jdField_a_of_type_Been.jdField_a_of_type_Long > 0L) {
          ((ExcitingTransferUploadResultRp)localObject).m_u64StartSize = this.jdField_a_of_type_Been.jdField_a_of_type_Long;
        }
        if (this.jdField_a_of_type_Been.jdField_b_of_type_Long > 0L) {
          ((ExcitingTransferUploadResultRp)localObject).m_u64TransferSize = this.jdField_a_of_type_Been.jdField_b_of_type_Long;
        }
  ...
  private int f()
  {
    if ((this.jdField_a_of_type_Begw != null) && ((this.jdField_a_of_type_Begw instanceof asoo))) {
      return ((asoo)this.jdField_a_of_type_Begw).g();
    }
    return 0;
  }
  ...
  private void s()
  {
    ...
    localasoc.c(33);
    localasoc.c(this.jdField_a_of_type_Long);
    Object localObject = aszt.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
    localasoc.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
    localasoc.c(false);
    long l = System.currentTimeMillis() - this.jdField_a_of_type_Been.jdField_d_of_type_Long;
    label119:
  ...
  protected begw a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    paramString = new asoq(localArrayList1, localArrayList2, paramBoolean2, paramString, null);
    paramQQAppInterface = asoo.a(paramQQAppInterface, paramLong, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, localasop, paramString);
    if (paramQQAppInterface != null)
    {
      ((asoo)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    if (paramInt != 0)
    {
      this.jdField_a_of_type_Been.e = 0;
      ...
      localasoe = new asoe(befa.a());
      localasoe.c(this.jdField_a_of_type_Long);
      String str = aszt.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
      localasoe.c(paramInt);
      localasoe.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, str, this.jdField_c_of_type_Long);
      localasoe.a(paramExcitingTransferUploaderRp);
      localasoe.a(f());
      localasoe.b(ataw.b(paramExcitingTransferUploaderRp.m_strServerIp));
      localasoe.c(this.jdField_b_of_type_Boolean);
      if (paramInt != 0) {
        break label206;
      }
    }
  ...
  protected void c()
  {
    ...
    for (;;)
    {
      c(j);
      return;
      j = this.jdField_a_of_type_Been.jdField_d_of_type_Int;
      int i = j;
      if (j == 0) {
