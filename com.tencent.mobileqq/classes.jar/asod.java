  ...
  extends alxo
{
  ...
  public asod(Context paramContext)
  {
  ...
  public void b(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = asnx.a(localContext);
    if ((localObject != null) && (((bepp)localObject).isShowing())) {
      ((bepp)localObject).dismiss();
    }
    label124:
    int j;
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          asnx.a(localContext, (byte[])localObject, j);
          asnx.b.set(false);
          return;
          i = -1;
          break;
    ...
    {
    default: 
      QQToast.a(localContext, 1, alpo.a(2131705853), 0).a();
      asnx.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", asnx.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      arum.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((asnx)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a((BaseChatPie)localObject, paramObject, j, asnx.a(j));
  ...
  public void c(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            asnx.a(localContext, paramObject, j);
            asnx.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((asnx)paramObject.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a(paramObject, (String)localObject, j, asnx.a(j));
                paramObject.aE();
          ...
          ((alxl)((QQAppInterface)paramObject).a(13)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        QQToast.a(localContext, 1, alpo.a(2131705850), 0).a();
        asnx.b.set(false);
        return;
