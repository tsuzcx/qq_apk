...
{
  private FilenameFilter jdField_a_of_type_JavaIoFilenameFilter = new bfle(this);
  ...
  {
    boolean bool2 = false;
    File localFile1 = new File(ajed.aT, "/Tencent/ReaderZone/");
    ...
    for (;;)
    {
      ...
      int k = bace.a(localFile2.getAbsolutePath(), ((File)localObject).getAbsolutePath());
  ...
  {
    String[] arrayOfString = new File(ajed.aT, "/Tencent/ReaderZone/").list(this.jdField_a_of_type_JavaIoFilenameFilter);
  ...
  {
    return new File(new File(ajed.aT, "/Tencent/ReaderZone/"), paramString);
  }
  ...
  public String[] reportHistoryFileInfo()
  {
    ...
    File localFile = new File(ajed.aT, "/Tencent/ReaderZone/");
    ...
    if ((arrayOfString2 != null) && (arrayOfString2.length > 0))
    {
      ...
      while (i < j)
      {
        ...
        l2 += bace.b(new File(localFile, str).getAbsolutePath());
        l1 += bace.c(new File(localFile, str).getAbsolutePath());
        i += 1;
      }
