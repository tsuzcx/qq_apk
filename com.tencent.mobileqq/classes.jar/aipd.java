  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, int paramInt, FromServiceMsg paramFromServiceMsg)
  {
    ...
    notifyObserver(paramIntent, 0, false, localBundle, aior.class);
  }
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            paramFromServiceMsg = aioi.a((QQAppInterface)paramIntent);
            if (i == 1)
            {
              bool = true;
              paramFromServiceMsg.c(bool);
              long l = System.currentTimeMillis();
              aioi.a((QQAppInterface)paramIntent).a(l);
              return;
            }
          }
    ...
    if (localObject != null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            localObject = (ZhituResponse)bgzr.b(new JSONObject(str), ZhituResponse.class);
            Bundle localBundle = new Bundle();
            ...
            notifyObserver(paramIntent, 0, true, localBundle, aior.class);
            return;
          }
        }
