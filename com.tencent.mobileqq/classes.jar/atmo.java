  ...
  implements akfl
{
  ...
  private List<atoq> jdField_a_of_type_JavaUtilList;
  private Drawable b;
  
  public atmo(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560903, null);
      paramView = new atmq(this, null);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131368246));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378737));
      paramView.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)localView.findViewById(2131372935));
      localView.setTag(paramView);
    }
    Object localObject1;
    for (;;)
    {
      localObject1 = (atoq)getItem(paramInt);
      ...
      return localView;
      localObject1 = (atmq)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject1;
    }
    URL localURL = ((atoq)localObject1).a();
    int i = ((atoq)localObject1).a();
    if (localURL != null)
    {
      ...
      if (((atoq)localObject1).a())
      {
        paramView.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        label246:
        a(localView, (URLDrawable)localObject2, ((atoq)localObject1).b());
        if ((i != 1) || (!AsyncImageView.a(localURL)) || (!atwl.a(((atoq)localObject1).b()))) {
          break label321;
        }
