...
public class airb
  extends ajtd
{
  public airb(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void a(List<Long> paramList, ajtg paramajtg)
  {
    ...
    localAddonReqComm.mqqver.set("8.2.8");
    ...
    paramajtg = super.createToServiceMsg("ReadDiyAddonInfo.1", paramajtg);
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd0x01.has()) && (paramFromServiceMsg.rspcmd0x01.userdiyinfo.has()))
          {
            ...
            aiqz.a().a(this.app, true, paramFromServiceMsg);
