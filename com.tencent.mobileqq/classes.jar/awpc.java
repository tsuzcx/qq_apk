...
{
  public awpc(LoginWelcomeManager paramLoginWelcomeManager) {}
  ...
  public void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aoep localaoep = (aoep)LoginWelcomeManager.a(this.a).getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
        paramObject = localaoep.a((Card)paramObject);
        localaoep.a(str, paramObject, 1, null, (String)localObject, localaoep.a(paramObject, l1, l2), null);
