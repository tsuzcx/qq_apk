  ...
  extends awor
{
  ...
  private List<awpn> a(JSONArray paramJSONArray)
  {
    ...
    if (paramJSONArray != null)
    {
      ...
      while (i < paramJSONArray.length())
      {
        ...
        localObject = new awpn(((JSONObject)localObject).optString("word"), ((JSONObject)localObject).optString("url"));
        if (((awpn)localObject).a()) {
