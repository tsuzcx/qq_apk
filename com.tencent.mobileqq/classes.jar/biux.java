...
public class biux
{
  ...
  public biux(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new biuy(this, Looper.getMainLooper());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new biuz(this);
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    return bacm.a(paramBitmap, i, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  }
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      localvox = (vox)this.jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
      if (localvox != null)
      {
        urk.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, hit cache:" + paramString);
        return localvox;
      }
    }
    urk.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, not in cache:" + paramString);
    vox localvox = new vox(paramInt1, paramInt2);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache.put(paramString, localvox);
  ...
  public void a()
  {
    ...
    {
      urk.e("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory:" + localException.toString());
    }
  }
  
  public void a(biva parambiva)
  {
    this.jdField_a_of_type_Biva = parambiva;
  }
  
  protected void a(String paramString)
  {
    urk.b("Q.qqstory.record.StoryFaceDrawableFactory", "sendQQHeadRequest uin:%s.", paramString);
