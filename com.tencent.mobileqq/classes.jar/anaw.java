  ...
  extends BusinessHandler
{
  ...
  anaw(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718427);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718428);
    this.c = paramQQAppInterface.getApplication().getString(2131718425);
    this.d = paramQQAppInterface.getApplication().getString(2131718429);
    this.f = paramQQAppInterface.getApplication().getString(2131718423);
    this.g = paramQQAppInterface.getApplication().getString(2131718421);
    this.h = paramQQAppInterface.getApplication().getString(2131718424);
    this.e = paramQQAppInterface.getApplication().getString(2131718426);
    this.i = paramQQAppInterface.getApplication().getString(2131718422);
  }
  ...
  private String a(boolean paramBoolean, long paramLong, int paramInt, String paramString)
  {
    ...
    if (paramInt != 1006) {
      if (paramBoolean)
      {
        ...
        if (ChatActivityUtils.a.contains(paramLong + ""))
        {
          str = this.jdField_b_of_type_JavaLangString;
          ChatActivityUtils.a.remove(paramLong + "");
        }
        if (paramInt != 1024) {
          break label298;
        }
        localbily = (bily)this.app.getManager(165);
        if ((localbily != null) && ((localbily.a(paramString)) || (localbily.f(paramString)))) {
          break label298;
        }
        str = this.d;
      }
    ...
    for (;;)
    {
      if ((paramInt == 1037) || (paramInt == 1044) || (paramInt == 1045)) {
        str = this.e;
      }
      for (;;)
      {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((avnk)this.app.getManager(16)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        if (k == 1006) {
          localObject = ContactUtils.getPhoneNumByUin(this.app, String.valueOf(l1));
        }
        String str2 = a(paramBoolean, l1, k, (String)localObject);
        ...
        {
          localMessageRecord = bbli.a(-2012);
          localMessageRecord.init(str1, (String)localObject, str1, str2, l2, 0, k, 0L);
          localMessageRecord.msgtype = -2012;
          localMessageRecord.isread = true;
          localObject = this.app.getMessageFacade().getMsgList((String)localObject, k);
          if ((localObject == null) || (((List)localObject).size() <= 0) || (!abwz.a((MessageRecord)((List)localObject).get(((List)localObject).size() - 1), localMessageRecord, false))) {
            break label297;
          }
          if (QLog.isColorLevel()) {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      break;
      this.app.getMessageFacade().addMessage(localArrayList, String.valueOf(str1), false);
      return;
    }
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (avnk)this.app.getManager(16);
    int j = 0;
  ...
  private void d()
  {
    ...
    ((avnk)this.app.getManager(16)).a(localArrayList);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = ContactUtils.getUinByPhoneNum(this.app, paramString);
    ...
    catch (Exception paramArrayOfByte)
    {
      do
      {
        ...
        if (paramArrayOfByte.msg_s2c_blocklist_notify.has())
        {
          ...
          localObject1 = this.app.getMsgHandler();
