  ...
  implements amkw
{
  ...
  public amgs a;
  public bjsi a;
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new amqj(this);
  ...
  public amqf(int paramInt)
  {
    this.jdField_a_of_type_Bjsi = new amqi(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new amql(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
    ...
    if ((anai.a(BaseApplicationImpl.getContext()).a() != null) && (anai.a(BaseApplicationImpl.getContext()).a().getRoom() != null) && (localArrayList1.size() > 0)) {
      anai.a(BaseApplicationImpl.getContext()).a().getRoom().requestViewList((String[])localArrayList1.toArray(new String[localArrayList1.size()]), (AVView[])localArrayList2.toArray(new AVView[localArrayList2.size()]), localArrayList1.size(), paramArrayOfString);
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((ampj.b(this.jdField_a_of_type_Long) != null) && (ampj.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)ampj.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new amqk(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = anai.a(BaseApplicationImpl.getContext()).a();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        anaa.a().b(paramBoolean);
        break label60;
      } while ((anai.a(BaseApplicationImpl.getContext()).a() == null) || (anai.a(BaseApplicationImpl.getContext()).a().getRoom() == null));
      label130:
      label140:
      anai.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new amqm(this));
    }
  }
  ...
  public void d()
  {
    ...
    {
      anaa.a().a("" + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_Amgs != null) {
        this.jdField_a_of_type_Amgs.b();
      }
      b(false);
  ...
  public void grant()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ampj.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      try
      {
        ...
        ampj.a().callbackFromRequest(this.jdField_a_of_type_Long, i, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
