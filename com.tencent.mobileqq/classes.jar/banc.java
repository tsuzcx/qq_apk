...
public class banc
{
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131563065, paramViewGroup, false);
  }
  ...
  public static TextView a(@NonNull Context paramContext)
  {
    ...
    paramContext.setShadowLayer(0.0F, ScreenUtil.dip2px(0.5F), ScreenUtil.dip2px(1.5F), 2131167355);
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131563063, paramViewGroup, false);
  }
  ...
  public static TextView b(@NonNull Context paramContext)
  {
    ...
    localTextView.setTextColor(paramContext.getResources().getColor(2131167345));
    localTextView.setTextSize(1, 14.0F);
    localTextView.setShadowLayer(0.0F, ScreenUtil.dip2px(0.5F), ScreenUtil.dip2px(1.5F), 2131167355);
    return localTextView;
  }
  
  public static View c(@NonNull Context paramContext, ViewGroup paramViewGroup)
  {
    return LayoutInflater.from(paramContext).inflate(2131563061, paramViewGroup, false);
  }
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131563062, paramViewGroup, false);
  }
