...
public class banc
{
  ...
  public final String a()
  {
    if (a())
    {
      ...
      if (bane.a(this.jdField_a_of_type_Int)) {
  ...
  {
    this.jdField_a_of_type_Int = bane.b(paramCustomOnlineStatusMsg);
    this.jdField_a_of_type_JavaLangString = bane.a(paramCustomOnlineStatusMsg);
    this.b = bane.a(paramCustomOnlineStatusMsg);
    b();
  }
  ...
  {
    int j = this.c;
    amif localamif = (amif)alzw.a().a(479);
    if ((localamif == null) || (localamif.a)) {}
    for (int i = 1;; i = 0)
    {
      this.c = i;
      if (j != this.c) {
