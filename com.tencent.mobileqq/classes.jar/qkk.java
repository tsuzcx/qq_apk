  ...
  implements ahma
{
  ...
  public qkk(@NonNull PendingIntent paramPendingIntent, @NonNull QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, PendingIntent paramPendingIntent, String paramString1, String paramString2)
  {
    ...
    paramIntent = new qkk(paramPendingIntent, paramQQAppInterface, str1, paramIntent.getStringExtra("banner_readinjoy_article_id"), str2, str3, paramIntent.getBooleanExtra("banner_readinjoy_is_weishi_mode", false));
    paramQQAppInterface = ahkf.a(paramQQAppInterface, i, paramString1, paramString2, paramIntent);
    paramIntent.a();
  ...
  private void a(String paramString)
  {
    ...
    {
      localqze = new qze(this.d, this.jdField_a_of_type_JavaLangString, this.c, this.b);
      localqze.h(this.b);
    ...
    {
      noo.a(localQQAppInterface, str2, paramString, paramString, 0, 0, str1, "", "", localqze.a().a(), false);
      return;
    }
  }
