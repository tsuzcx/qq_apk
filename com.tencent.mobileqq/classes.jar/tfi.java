...
{
  public tfi(PermisionPrivacyActivity paramPermisionPrivacyActivity) {}
    ...
    do
    {
      do
      {
        ...
        if (paramCompoundButton == this.a.jdField_a_of_type_AndroidWidgetCompoundButton)
        {
          ...
          {
            QQToast.a(this.a.getApplicationContext(), 2131434811, 1).a();
          ...
          if (paramBoolean)
          {
            ...
            this.a.a(this.a.getApplication().getResources().getString(2131436225));
            if (!paramBoolean) {
              break label417;
            }
          }
      ...
      for (byte b = 0;; b = 1)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(0, 2131434453, 1000);
        return;
