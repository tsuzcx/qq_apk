  ...
  implements bqtc
{
  ...
  public bqti(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      label26:
      int k = brfv.jdField_a_of_type_Int;
      if (j <= k) {
        break label226;
      }
      i = (int)(i * k / j);
    ...
    for (;;)
    {
      ...
      {
        localObject = bhmq.a(paramContext, bhmq.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = zoc.a(zoc.a(paramContext, i, j, true), paramBitmap);
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, int paramInt, bqtj parambqtj)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambqtj);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Brgc != null) {
      this.jdField_a_of_type_Brgc.a();
    }
  }
}
