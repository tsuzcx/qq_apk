...
{
  public tcl(PhoneUnityBindInfoActivity paramPhoneUnityBindInfoActivity) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (int i = 1;; i = 3)
    {
      ...
      if (paramInt != 0)
      {
        ...
        DialogUtil.a(this.a, 230, this.a.getString(2131436839), this.a.getString(2131436840), null, this.a.getString(2131436611), new tcq(this), null).show();
      }
      return;
    }
    localObject = paramString;
    if (TextUtils.isEmpty(paramString)) {
      localObject = this.a.getString(2131436834);
    }
  ...
  public void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      return;
      PhoneUnityBindInfoActivity.a(this.a, 2131435586);
    }
  }
  ...
  public void b(boolean paramBoolean, Bundle paramBundle)
  {
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            {
              this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a((Context)localObject, 230, "绑定冲突", "该手机号码已绑定一个无密码的QQ号，需给原QQ号设置密码后才能解绑并绑定新QQ号。", null, "我知道了", new tcm(this), null);
              this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnCancelListener(new tcn(this));
            }
          ...
          {
            this.a.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a((Context)localObject, 230, "无法绑定", "当前要改绑QQ号未设置密码，无法绑定新的手机号码。请设置密码后重试。", null, "我知道了", new tco(this), null);
            this.a.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnCancelListener(new tcp(this));
          }
    ...
    paramBundle.append("&version=7.6.0.3525");
    ...
    return;
    label536:
    QQToast.a(this.a, this.a.getString(2131436828), 0).b(this.a.getTitleBarHeight());
    this.a.finish();
    return;
    label572:
    PhoneUnityBindInfoActivity.a(this.a);
