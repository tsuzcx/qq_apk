  ...
  extends aihn
{
  ...
  public aiib(QQAppInterface paramQQAppInterface, CameraEmotionData paramCameraEmotionData)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData = paramCameraEmotionData;
    paramQQAppInterface = (asen)paramQQAppInterface.getManager(QQManagerFactory.CAMERA_EMOTION_DB_MANAGER);
  ...
  {
    ((aseg)paramQQAppInterface.getManager(QQManagerFactory.CAMERA_EMOTION_MANAGER)).c(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    if (((paramContext instanceof BaseActivity)) && (axnp.a(paramSessionInfo.curType, paramSessionInfo.curFriendUin)))
    {
      ...
      QQToast.a(paramQQAppInterface.getApp(), anvx.a(2131713773), 0).b(paramContext.getTitleBarHeight());
      return;
    }
    this.jdField_a_of_type_Boolean = true;
    admh.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_JavaLangString, true, this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData.strContext, null);
    ((aseg)paramQQAppInterface.getManager(QQManagerFactory.CAMERA_EMOTION_MANAGER)).b(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData);
  }
