  ...
  extends pyw
{
  protected int a;
  protected Handler a;
  protected SparseArray<pyt[]> a;
  protected String a;
  protected ArrayList<pzs> b = new ArrayList();
  
  public pzf(AppInterface paramAppInterface)
  {
    ...
    a(3, new pyt[] { new pyt(), new pzg(this) });
    a(2, new pyt[] { new pyt(), new pzk(this) });
    a(4, new pyt[] { new pzl(this), new pzm(this, paramAppInterface) });
    a(5, new pyt[] { new pzn(this), new pzo(this, paramAppInterface) });
    a(6, new pyt[] { new pzp(this), new pzq(this, paramAppInterface) });
    a(7, new pyt[] { new pzr(this), new pzh(this, paramAppInterface) });
    a(8, new pyt[] { new pzi(this), new pzj(this) });
  }
  ...
  private void b(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    pyu.a(this.jdField_a_of_type_JavaLangString);
    paramInt = 0;
    while (paramInt < this.b.size())
    {
      ((pzs)this.b.get(paramInt)).a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, paramBoolean);
      paramInt += 1;
    }
  }
  ...
  public SkinData a(Context paramContext)
  {
    ...
    paramContext = bbkb.p(paramContext, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  ...
  {
    if ((!pyu.a(paramString1)) && (!TextUtils.isEmpty(paramString1)))
    {
    ...
    for (;;)
    {
      boolean bool = bbkb.u(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getBaseContext(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      ...
      paramString3 = (pyz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(270);
      ...
      if ("".equals(paramString1))
      {
        if (localObject != null)
        {
          ...
          bbkb.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getBaseContext(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), ((RefreshData)localObject).toJson().toString(), 0);
        ...
        bbkb.l(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getBaseContext(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramBoolean);
      ...
      {
        bbkb.r(paramString3, (String)localObject, paramString2);
  ...
  public pyt a(int paramInt)
  {
    pyt[] arrayOfpyt = (pyt[])this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if ((arrayOfpyt != null) && (this.jdField_a_of_type_Int < arrayOfpyt.length)) {
      return arrayOfpyt[this.jdField_a_of_type_Int];
    }
    return null;
  }
  ...
  public void a(int paramInt, pyt... paramVarArgs)
  {
  ...
  {
    bbkb.g(paramContext, paramString, paramBaseResData.seq);
  }
  
  public void a(pzs parampzs)
  {
    synchronized (this.b)
    {
      if (!this.b.contains(parampzs)) {
        this.b.add(parampzs);
      }
      return;
    }
  ...
  {
    axqy.b(null, "dc00899", "BizTechReport", "", "skin_download", "skin_guide", 0, 0, paramArrayOfString[0], paramArrayOfString[1], paramArrayOfString[2], String.valueOf(bbfj.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication())));
  }
  ...
  public boolean a(String paramString)
  {
    ...
    if (paramString != null)
    {
      this.jdField_a_of_type_Bbwz.a(false, paramString);
      return true;
    }
    return false;
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2, long paramLong3, bbwt parambbwt)
  {
  ...
  public String b(String paramString1, String paramString2)
  {
    if ("skin".equals(paramString1)) {
      return pyu.a(paramString2);
    }
    if ("guide".equals(paramString1)) {
      return pyu.b(paramString2);
    }
    return pyu.b(paramString2);
  }
  ...
  {
    bbkb.s(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramBaseResData.id);
    bbkb.C(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  }
  
  public void b(pzs parampzs)
  {
    synchronized (this.b)
    {
      this.b.remove(parampzs);
      return;
    }
  }
  ...
  public boolean b(String paramString, BaseResData paramBaseResData)
  {
    ...
    long l1 = bbkb.h(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()) / 86400000L;
    long l2 = System.currentTimeMillis() / 86400000L;
    return (aybs.a(new File(paramString))) && (pyu.a(paramBaseResData.id)) && (!bbkb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramBaseResData.id)) && (l2 > l1);
  }
