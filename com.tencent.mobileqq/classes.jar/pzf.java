...
public class pzf
{
  ...
  private static ArrayList<pzi> jdField_a_of_type_JavaUtilArrayList;
  private static AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private static JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private static pzj jdField_a_of_type_Pzj;
  ...
  private static ArrayList<pzi> a()
  {
    ...
    try
    {
      ...
      {
        pzi localpzi = new pzi();
        Object localObject = (JSONObject)localJSONArray.get(i);
        localpzi.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("vid");
        localpzi.jdField_a_of_type_Long = ((JSONObject)localObject).getLong("bitrate");
        localpzi.jdField_b_of_type_Long = ((JSONObject)localObject).getLong("timeout_ms");
        localpzi.jdField_a_of_type_Float = Float.valueOf(((JSONObject)localObject).getString("hevc_level")).floatValue();
        localpzi.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("max_hashdiff");
        localpzi.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("tag");
        ...
        while (j < ((JSONArray)localObject).length())
        {
          ...
          localpzq.jdField_a_of_type_Int = localJSONObject.getInt("index");
          localpzq.jdField_a_of_type_Long = localJSONObject.getLong("serverHash");
          localpzi.jdField_a_of_type_JavaUtilArrayList.add(localpzq);
          j += 1;
        }
        localArrayList.add(localpzi);
        i += 1;
      }
  ...
  {
    String str1 = (String)bgmq.a("kandian_video_extract_frame", "");
    if (QLog.isColorLevel()) {
    ...
    String str2 = (String)bgmq.a("kandian_video_extract_frame_local_result", "");
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!localException1.equals(str2))
        {
          ...
          bgmq.a("kandian_video_extract_frame_local_result", jdField_b_of_type_OrgJsonJSONObject.toString());
        }
  ...
  public static void b()
  {
    ...
    if ((jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)) && (jdField_a_of_type_Pzj != null))
    {
      jdField_a_of_type_Pzj.b();
      jdField_a_of_type_Pzj = null;
    }
  }
  
  private static void b(Context paramContext, pzi parampzi, int paramInt, String paramString, HashMap<Integer, pzq> paramHashMap)
  {
    ...
    try
    {
      ...
      localJSONObject.put("subversion", "8.2.6");
      if (jdField_a_of_type_OrgJsonJSONObject == null) {
        break label632;
      }
      localObject = jdField_a_of_type_OrgJsonJSONObject.optString("version");
      localJSONObject.put("server_version", localObject);
      localJSONObject.put("video_tag", parampzi.jdField_b_of_type_JavaLangString);
      localJSONObject.put("video_vid", parampzi.jdField_a_of_type_JavaLangString);
      localJSONObject.put("video_bitrate", parampzi.jdField_a_of_type_Long);
      localJSONObject.put("video_width", parampzi.jdField_b_of_type_Int);
      localJSONObject.put("video_height", parampzi.c);
      ...
      if (bool1)
      {
        ...
        {
          localObject = (pzq)paramString.next();
          if (((pzq)localObject).jdField_b_of_type_Int > parampzi.jdField_a_of_type_Int) {
            bool1 = false;
          }
          i += ((pzq)localObject).jdField_b_of_type_Int;
          k = j;
          if (j > ((pzq)localObject).jdField_b_of_type_Int) {
            k = ((pzq)localObject).jdField_b_of_type_Int;
          }
          if (paramInt >= ((pzq)localObject).jdField_b_of_type_Int) {
            break label645;
          }
          paramInt = ((pzq)localObject).jdField_b_of_type_Int;
          break label625;
        }
      ...
      parampzi = new JSONArray();
      paramString = paramHashMap.values().iterator();
      while (paramString.hasNext())
      {
        paramHashMap = (pzq)paramString.next();
        ...
        parampzi.put(localObject);
        continue;
        localHashMap.put("param_content", localJSONObject.toString());
      }
    }
    catch (Exception parampzi) {}
    for (;;)
    {
      localHashMap.put("param_device", pza.a(false));
      if (QLog.isColorLevel()) {
        QLog.d("VideoExtractFrame", 2, "灯塔数据上报 reportMap = " + localHashMap.toString());
      }
      parampzi = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      if (parampzi != null) {
        awrn.a(paramContext).a(parampzi.c(), "actKandianVideoExtractFrame", true, -1L, 0L, localHashMap, null);
      }
      return;
      localJSONObject.put("detail_list", parampzi);
    }
    label645:
    for (;;)
    {
  ...
  private static void b(pzi parampzi, String paramString, HashMap<Integer, pzq> paramHashMap, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoExtractFrame", 2, "innerDoExtractFrame start() videoInfo.tag = " + parampzi.jdField_b_of_type_JavaLangString);
    }
    jdField_a_of_type_Long = System.currentTimeMillis();
    jdField_a_of_type_Pzj = new pzj(BaseApplication.getContext(), paramString, paramHashMap, paramLong);
    jdField_a_of_type_Pzj.a(new pzh(parampzi));
    jdField_a_of_type_Pzj.a();
  }
  ...
  private static void c()
  {
    try
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (((pzi)((Iterator)localObject).next()).jdField_a_of_type_Float > f) {
      ...
      localObject = (pzi)jdField_a_of_type_JavaUtilArrayList.get(i);
      HashMap localHashMap = new HashMap();
      Iterator localIterator = ((pzi)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext())
      {
        pzq localpzq = (pzq)localIterator.next();
        localHashMap.put(Integer.valueOf(localpzq.jdField_a_of_type_Int), localpzq);
      }
      ocm.a().a(((pzi)localObject).jdField_a_of_type_JavaLangString, "PubAccountArticleCenter.GetUrlByVid", new pzg((pzi)localObject, localHashMap));
      return;
    }
    catch (Exception localException) {}
  }
