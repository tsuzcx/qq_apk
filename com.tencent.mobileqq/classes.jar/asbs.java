...
public class asbs
  extends asbv
{
  public asbs(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(XmlData paramXmlData)
  {
    ...
    try
    {
      ...
      if (((SharedPreferences)localObject1).getBoolean("qq.android.ar.native.so_v8.3.6", true))
      {
        ...
        localObject1 = new File(apfz.a() + File.separator).listFiles();
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          localObject = "0";
          bdla.b(localQQAppInterface, "dc01440", "", "", "0X8007A3D", "0X8007A3D", 0, 0, "", String.valueOf(i), (String)localObject, "qq.android.ar.native.so_v8.3.6");
