...
public class aowt
{
  ...
  private HashMap<String, aoxq> jdField_a_of_type_JavaUtilHashMap;
  ...
  private aoxn a(String paramString1, int paramInt, String paramString2, MessageRecord paramMessageRecord)
  {
    ...
    paramString2 = new aoxn(this, paramString2, paramString1, paramInt, paramMessageRecord);
    paramString1 = paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFilePath");
    if (a(paramString1)) {
      if (paramInt == 0) {
        paramString1 = new aoxb(this, paramMessageRecord);
      }
    }
    for (;;)
    {
      ...
      if (paramInt == 3000)
      {
        paramString1 = new aoxk(this, paramMessageRecord);
      }
      else if (paramInt == 1)
      {
        paramString1 = new aoxu(this, paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName"), paramString1, null);
      }
      else
      {
        do
        {
          do
          {
            ...
            if (paramInt == 0)
            {
              paramString1 = new aowv(this, paramMessageRecord);
              break;
            }
            if (paramInt == 3000)
            {
              paramString1 = new aowx(this, paramMessageRecord);
              break;
            }
          } while (paramInt != 1);
          paramString1 = new aowz(this, paramMessageRecord);
          break;
          if (paramInt == 0)
          {
            paramString1 = new aoxe(this, paramMessageRecord);
            break;
          }
          if (paramInt == 3000)
          {
            paramString1 = new aoxg(this, paramMessageRecord);
            break;
          }
        } while (paramInt != 1);
        paramString1 = new aoxi(this, paramMessageRecord);
      }
    }
    if (paramInt == 0) {
      paramInt = 3;
    ...
    for (;;)
    {
      paramString1 = new aoxs(this, paramMessageRecord, paramInt, null);
      break label76;
      if (paramInt == 3000)
      {
        paramInt = 106;
  ...
  private static boolean a(String paramString)
  {
    ...
    do
    {
      return bool2;
      bool1 = bool2;
      if (apue.a(paramString) <= 10485760L) {
        bool1 = true;
      }
      bool2 = bool1;
  ...
  {
    if (paramBoolean) {
      return BaseActivity.sTopActivity.app.getApplication().getResources().getString(2131692537);
    }
    if (paramLong > 10485760L) {
      return BaseActivity.sTopActivity.app.getApplication().getResources().getString(2131692539);
    }
    return BaseActivity.sTopActivity.app.getApplication().getResources().getString(2131692576);
  }
  
  private static void b(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, aoxp paramaoxp)
  {
    if (paramaoxp == null)
    {
    ...
    xap.a(paramQQAppInterface, paramLong1, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, new aowu(paramString, paramaoxp, paramLong2));
  }
  ...
  private void b(MessageRecord paramMessageRecord, Bundle paramBundle)
  {
    ...
    paramMessageRecord.saveExtInfoToExtStr("_m_ForwardLasSuccess", String.valueOf(awzw.a()));
  }
  ...
  public void a(apey paramapey, HashMap<String, ArrayList<MessageRecord>> paramHashMap)
  {
    if ((paramHashMap == null) || (paramHashMap.size() <= 0)) {
      QLog.i("FileMultiMsgManager<FileAssistant>", 1, "addMultiFileUploadRequest: file message record list is null");
    }
    this.jdField_a_of_type_AndroidOsHandler.post(new QFileMsgForwardManager.1(this, paramapey));
  }
  
  public void a(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    if (apvk.a(paramMessageRecord1)) {
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        continue;
        paramMessageRecord1 = (MessageForTroopFile)apue.a((ChatMessage)paramMessageRecord1);
        paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1).a);
        continue;
      }
      Object localObject;
      ...
      else if ((paramMessageRecord1 instanceof MessageForTroopFile))
      {
        ...
        localObject = bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1);
        if (localObject != null)
        {
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_750_", ((azqt)localObject).c);
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_384_", ((azqt)localObject).d);
          if (((paramMessageRecord1.width == 0) || (paramMessageRecord1.height == 0)) && (((azqt)localObject).e > 0) && (((azqt)localObject).f > 0))
          {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgWidth", String.valueOf(paramMessageRecord1.width));
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgHeight", String.valueOf(paramMessageRecord1.height));
          }
          paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", ((azqt)localObject).a);
          if ((((azqt)localObject).b == 2) || (((azqt)localObject).b == 3)) {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardStatusPaused", "1");
          }
        }
      }
