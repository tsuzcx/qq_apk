...
public class blbs
{
  public static int a(String paramString, blbt paramblbt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          paramblbt.a[0] = Integer.parseInt(str1);
          paramblbt.a[1] = Integer.parseInt(str2);
          paramblbt.a[3] = Integer.parseInt(str3);
          i = 0;
        }
        ...
        try
        {
          paramblbt.a[2] = Integer.parseInt(paramString);
          paramblbt.a[4] = 0;
          return i;
        }
