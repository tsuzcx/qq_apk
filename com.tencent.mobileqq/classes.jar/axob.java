...
public class axob
{
  ...
  {
    boolean bool2 = false;
    paramAppInterface = (String)axqc.a(paramAppInterface.getAccount(), "key_tabs_array", "");
    for (;;)
    {
      try
      {
  ...
  {
    bool2 = false;
    paramAppInterface = (String)axqc.a(paramAppInterface.getCurrentAccountUin(), "key_banner_enter_items", "");
    for (;;)
    {
      try
      {
  ...
  public DatingConfig a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 199	axob:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 199	axob:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    ...
    //   30: ldc 203
    //   32: aload_3
    //   33: invokestatic 209	com/tencent/mobileqq/utils/FileUtils:readObjectList	(Ljava/lang/String;[Ljava/lang/Class;)[Ljava/lang/Object;
    //   36: astore 4
    //   38: aload_2
    //   39: astore_1
    //   40: aload 4
    ...
    //   57: iconst_0
    //   58: aaload
    //   59: checkcast 211	com/tencent/mobileqq/data/DatingConfig
    //   62: astore_1
    //   63: aload_0
    //   64: aload_1
    //   65: putfield 199	axob:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   68: goto -54 -> 14
    //   71: astore_1
    //   72: aload_0
    //   73: monitorexit
  ...
  public void a()
  {
    ...
    //   14: aload_0
    //   15: aconst_null
    //   16: putfield 199	axob:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   19: goto -8 -> 11
    //   22: astore_1
    //   23: aload_0
    //   24: monitorexit
