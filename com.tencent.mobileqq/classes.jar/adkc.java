...
public class adkc
{
  ...
  public void a(adke paramadke)
  {
    this.jdField_a_of_type_Adke = paramadke;
  }
  ...
  public void a(IntimateInfo.MemoryDayInfo paramMemoryDayInfo)
  {
    ...
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379494);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369247);
    RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131369878);
    Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362993);
    ...
    Object localObject1 = this.jdField_a_of_type_Adka.jdField_a_of_type_JavaLangString;
    if (localURLThemeImageView != null)
    {
      if (localURLThemeImageView.a != null) {
        localURLThemeImageView.a.a(bfwa.c);
      }
    ...
    if ((localRelativeLayout != null) && (ThemeUtil.isNowThemeIsNight(null, false, null))) {
      localObject1 = this.jdField_a_of_type_Adka.b;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if ((localTextView2 != null) && (paramMemoryDayInfo.wording != null))
        {
          ...
          int i = actn.a(95.0F, this.jdField_a_of_type_Adka.jdField_a_of_type_AndroidContentContext.getResources());
          i = adka.a(this.jdField_a_of_type_Adka, (String)localObject1, 14.0F, i + 80);
          if (i > 200) {
        ...
        try
        {
          ...
          localTextView1.setOnClickListener(new adkd(this));
          return;
