  ...
  extends aiir
{
  ...
  aikb jdField_a_of_type_Aikb;
  SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  String jdField_a_of_type_JavaLangString;
  
  public aike(aikb paramaikb, SessionInfo paramSessionInfo, String paramString)
  {
  ...
  public Intent a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    localIntent.putExtra("PicContants.NEED_COMPRESS", false);
    localIntent.putExtra("quick_send_original_md5", this.jdField_a_of_type_Aikb.b);
    localIntent.putExtra("quick_send_original_size", this.jdField_a_of_type_Aikb.jdField_a_of_type_Long);
    localIntent.putExtra("quick_send_thumb_md5", this.jdField_a_of_type_Aikb.b);
    localIntent.putExtra("quick_send_is_ad_emo", true);
    localIntent.putExtra("quick_send_ad_emo_jump_url", this.jdField_a_of_type_Aikb.c);
    localIntent.putExtra("quick_send_ad_emo_desc_str", this.jdField_a_of_type_Aikb.d);
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Aikb != null) {
      return this.jdField_a_of_type_Aikb.jdField_a_of_type_JavaLangString;
    }
    return null;
  }
  ...
  public URL a()
  {
    try
    {
      if ((this.jdField_a_of_type_Aikb != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aikb.b)))
      {
        URL localURL1 = new URL("sticker_recommended_pic", "fromAIO", this.jdField_a_of_type_Aikb.b);
        if (localURL1 != null) {
          return ???;
        }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    new aikc().a(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, a(), paramInt, this.jdField_a_of_type_Aikb.b, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      new aikc().b(paramQQAppInterface, paramSessionInfo, a(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Aikb.b, this.jdField_a_of_type_JavaLangString);
      paramSessionInfo = a(paramSessionInfo, aijp.d(e()));
  ...
  {
    if (this.jdField_a_of_type_Aikb != null) {
      return this.jdField_a_of_type_Aikb.b;
    }
    return null;
  }
