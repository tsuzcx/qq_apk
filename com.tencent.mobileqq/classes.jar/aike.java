  ...
  implements aikq
{
  ...
  public aike(QQAppInterface paramQQAppInterface, ailr paramailr, Activity paramActivity, SessionInfo paramSessionInfo, afqz paramafqz)
  {
  ...
  {
    paramVarArgs = bcsa.a(-1016);
    long l = bcrg.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691730), l, -1017, 3000, l);
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = arpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((arpb)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Afqz.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
            ...
            if (!NetworkUtil.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            l1 = Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin).longValue();
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          ...
          ((arpb)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 2);
        ...
        for (;;)
        {
          try
          {
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
