  ...
  implements aiyc
{
  ...
  {
    aiyd localaiyd = this.jdField_a_of_type_Aixp.a();
    if (localaiyd != null) {
      localaiyd.b(paramList);
    }
  }
  
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Aixp.a();
    if (localObject != null)
    {
      localObject = ((aiyd)localObject).a();
      if (localObject != null) {
  ...
  {
    this.jdField_a_of_type_Aixp = paramaixp;
    paramaixp = this.jdField_a_of_type_Aixp.a();
    if (paramaixp != null) {
      paramaixp.a(this);
    }
  ...
  {
    aiyb localaiyb = this.jdField_a_of_type_Aixp.a();
    if (localaiyb != null)
    {
      localaiyb.a(paramList);
      localaiyb.b(paramList);
    }
  }
