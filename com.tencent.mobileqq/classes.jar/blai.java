...
public class blai
{
  ...
  public blai a()
  {
    blai localblai = new blai();
    localblai.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    return localblai;
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    blae.d = a("land_page", paramJSONObject.optString("land_page_id", blae.d));
    blae.b = a("obj_ownerid", paramJSONObject.optString("obj_ownerid", blae.b));
    blae.g = a("algo_id", paramJSONObject.optString("algo_id", "0"));
  }
  ...
  public void b(JSONObject paramJSONObject)
  {
    ...
    blae.a = a("mod", paramJSONObject.optString("mod_18", blae.a));
    blae.e = a("obj_pos", paramJSONObject.optString("obj_pos_14", blae.e));
    blae.f = a("detailpage_from", paramJSONObject.optString("detailpage_from_45", blae.f));
  }
