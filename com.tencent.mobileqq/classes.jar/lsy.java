  ...
  implements ltf
{
  ...
  {
    if (this.a.jdField_a_of_type_Lgf == null) {}
    label517:
    label1010:
    do
    {
            ...
            if ((paramltl.a == -100) || (paramltl.a == 3))
            {
              if (RandomController.a(this.a) == 1)
              {
                if ((paramInt == 0) && ((paramltl instanceof ltn)))
                {
                  ...
                  this.a.jdField_a_of_type_Lgf.a.a = paramltl.a;
                  if (this.a.jdField_a_of_type_Lgf.j())
                  {
              ...
              else if (RandomController.a(this.a) == 2)
              {
                ...
                if ((paramInt == 0) && ((paramltl instanceof ltp)))
                {
                  ...
                  for (localObject1 = ((ltp)localObject2).e;; localObject1 = String.valueOf(((ltp)localObject2).jdField_a_of_type_Long))
                  {
                    ...
                    {
                      ldw localldw = RandomController.a(this.a).a((String)localObject1);
                      if (localldw != null)
                      {
                        localldw.c = ((ltp)localObject2).c;
                        RandomController.a(this.a).a((String)localObject1, ((ltp)localObject2).b, ((ltp)localObject2).c);
                        if (QLog.isColorLevel()) {
                          QLog.d("RandomController", 2, "RSP_MULTI_PULL uin:" + localldw.jdField_a_of_type_Long + ", headUrl:" + localldw.c);
                        }
                      }
                    }
                ...
                if (paramInt == 100)
                {
                  ...
                  while (((Iterator)localObject2).hasNext()) {
                    ((StringBuilder)localObject1).append(((ldw)((Iterator)localObject2).next()).jdField_a_of_type_Long).append("|");
                  }
                ...
                if ((paramltl instanceof ltp))
                {
                  ...
                  if ((!TextUtils.isEmpty(paramltl.d)) && (TextUtils.isEmpty(this.a.jdField_a_of_type_Lgf.a.e)))
                  {
                    this.a.jdField_a_of_type_Lgf.a.e = (RandomController.a(this.a).getApp().getString(2131696046) + " “" + paramltl.d + "” ");
                    RandomController.a(this.a, paramltl.d);
                    if (QLog.isColorLevel()) {
                      QLog.d("RandomController", 2, "RSP_MULTI_PULL talkTips : " + this.a.jdField_a_of_type_Lgf.a.e);
                    }
                  }
                }
              }
      ...
      this.a.jdField_a_of_type_JavaLangString = bbdm.a(paramltl.jdField_a_of_type_OrgJsonJSONObject.optString("wording").trim());
      if (TextUtils.isEmpty(this.a.jdField_a_of_type_JavaLangString)) {
        this.a.jdField_a_of_type_JavaLangString = RandomController.a(this.a).getApp().getApplicationContext().getString(2131696039);
      }
      if (QLog.isColorLevel()) {
