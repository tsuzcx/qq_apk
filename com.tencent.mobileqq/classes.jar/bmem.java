  ...
  extends RemoteCommand
{
  ...
  private void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramFileManagerEntity.putExtra("forward_text", anvx.a(2131709170) + auea.d(localFileManagerEntity.fileName) + anvx.a(2131709182) + FileUtil.filesizeToString(localFileManagerEntity.fileSize) + "。");
    paramFileManagerEntity.putExtra("k_favorites", auea.c(localFileManagerEntity));
    ...
    {
      audn.a(paramActivity, 2131692476, 2131692481, new bmen(this, paramActivity, paramFileManagerEntity));
      return;
    }
    aupt.a(paramActivity, paramFileManagerEntity, 103);
  }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      if (i > 0)
      {
        ...
        {
          a(localQQAppInterface, localActivity, auea.a(new FileInfo(paramString)));
          return;
        }
        bmgm.a("QRRemoteCommond", "No Activity to use to forward file");
        return;
      }
    }
    catch (FileNotFoundException paramString)
    {
      bmgm.a("QRRemoteCommond", "file not found", paramString);
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    Object localObject1 = (aoan)a().getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
    ...
    for (paramBundle = paramBundle.getString("uin"); localObject1 != null; paramBundle = null)
    {
      for (;;)
      {
        if (((aoan)localObject1).b(paramBundle) != null) {
        ...
        ((Bundle)localObject2).putInt("qq_vip_level", bmeo.a(a(), null));
        return localObject2;
        ((Bundle)localObject2).putShort("qq_vip_info", bmeo.a(a(), null));
        return localObject2;
        if (a() == null) {
          break;
        }
        paramBundle = paramBundle.getString("publicaccount_uin");
        ((Bundle)localObject2).putBoolean("publicaccount_is_follow", uuc.a(a(), paramBundle));
        return localObject2;
        if (a() == null) {
          break;
        }
        localObject1 = paramBundle.getString("publicaccount_uin");
        Object localObject3 = (aoan)a().getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
        paramBundle = paramOnInvokeFinishLinstener;
        if (localObject3 != null) {
          paramBundle = ((aoan)localObject3).b((String)localObject1);
        }
        if (paramBundle != null)
        {
        ...
        if (paramOnInvokeFinishLinstener != null)
        {
          paramOnInvokeFinishLinstener = (bbbq)paramOnInvokeFinishLinstener.getManager(QQManagerFactory.MGR_RED_TOUCH);
          if (paramOnInvokeFinishLinstener != null)
          {
            paramBundle = paramOnInvokeFinishLinstener.a(paramBundle.getString("path"));
            if (paramBundle != null) {
              ((Bundle)localObject2).putParcelable("redTouchInfo", bbbt.a(paramBundle));
            }
          }
        }
        for (;;)
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          paramBundle.add(bbbt.a((BusinessInfoCheckUpdate.AppInfo)localObject2));
        }
      }
