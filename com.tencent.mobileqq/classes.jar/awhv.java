...
public class awhv
{
  ...
  public static awhv a()
  {
    try
    {
      if (jdField_a_of_type_Awhv == null) {
        jdField_a_of_type_Awhv = new awhv();
      }
      awhv localawhv = jdField_a_of_type_Awhv;
      return localawhv;
    }
    finally {}
  }
  ...
  private void a(EntityManager arg1)
  {
    ...
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 129	awhw:<init>	(Lawhv;)V
    ...
    //   76: aload_0
    //   77: getfield 38	awhv:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   80: astore_1
    //   81: aload_1
    //   82: monitorenter
    //   83: aload_0
    //   84: aload_2
    //   85: putfield 165	awhv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: aload_0
    //   89: getfield 165	awhv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   92: ifnonnull +16 -> 108
    //   95: aload_0
    ...
    //   105: putfield 165	awhv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 47	awhv:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   114: astore_1
    //   115: aload_1
    //   116: monitorenter
    //   117: aload_0
    //   118: getfield 47	awhv:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   121: invokeinterface 173 1 0
    //   126: aload_0
    //   127: getfield 165	awhv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   154: astore_3
    //   155: aload_0
    //   156: getfield 47	awhv:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   159: aload_3
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = (RecentUser)localaong.findRecentUserByUin(anhk.C, 5000);
        ((RecentUser)localObject).uin = anhk.C;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = (RecentUser)localaong.findRecentUser(anhk.C, 5000);
        if (paramQQAppInterface != null) {
          localaong.delRecentUser(paramQQAppInterface);
        }
      }
    }
  }
  ...
  {
    aong localaong = paramQQAppInterface.a().a();
    paramString = (RecentUser)localaong.findRecentUser(paramString, 1);
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilSet != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (!aglw.a(str, 1, paramQQAppInterface))) {
              i += 1;
            }
          }
          else
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (aglw.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) {
              continue;
            }
  ...
  {
    ThreadManager.post(new TroopAssistantManager.2(this, paramQQAppInterface, paramniv), 8, null, true);
  }
  ...
  public void a(EntityManager paramEntityManager, QQAppInterface paramQQAppInterface)
  {
    try
    {
      a(paramQQAppInterface);
      aong localaong = paramQQAppInterface.a().a();
      Object localObject2 = localaong.getRecentList(false);
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          for (((TroopAssistantData)localObject3).lastmsgtime = localMessage.time;; ((TroopAssistantData)localObject3).lastmsgtime = ((RecentUser)localObject2).lastmsgtime)
          {
            ...
            localaong.delRecentUser((BaseRecentUser)localObject2);
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    EntityManager localEntityManager = paramQQAppInterface.a().createEntityManager();
    aong localaong = paramQQAppInterface.a().a();
    RecentUser localRecentUser = (RecentUser)localaong.findRecentUser(paramString, 1);
    QQMessageFacade.Message localMessage;
    ...
    for (paramString.lastmsgtime = localMessage.time;; paramString.lastmsgtime = localRecentUser.lastmsgtime)
    {
      ...
      if ((!(localRecentUser.msg instanceof alep)) && (!(localRecentUser.msg instanceof alff)) && (!(localRecentUser.msg instanceof ales)) && (!(localRecentUser.msg instanceof alex)) && (!(localRecentUser.msg instanceof aleo)) && (!(localRecentUser.msg instanceof bmsc)) && (!(localRecentUser.msg instanceof alfc)) && (!(localRecentUser.msg instanceof alew)) && (!(localRecentUser.msg instanceof alez))) {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilSet = bgsh.a((SharedPreferences)localObject2, "troop_assis_new_unread_list", null);
      if (this.jdField_a_of_type_JavaUtilSet == null)
      {
        this.jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  public void c(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        localObject = localEntityManager;
        RecentUser localRecentUser = (RecentUser)localaong.findRecentUserByUin(String.valueOf(localTroopAssistantData.troopUin), 1);
        localObject = localEntityManager;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    ??? = ((aong)localObject1).getRecentList(false);
    Object localObject5;
    if ((??? != null) && (((List)???).size() > 0))
    {
      ??? = ((List)???).iterator();
    ...
    if (((ArrayList)localObject3).size() > 0)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (((TroopAssistantData)localObject5).lastmsgtime = ((QQMessageFacade.Message)localObject6).time;; ((TroopAssistantData)localObject5).lastmsgtime = ((RecentUser)???).lastmsgtime)
        {
          ...
          ((aong)localObject1).delRecentUser((BaseRecentUser)???);
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ??? = (RecentUser)((aong)localObject1).findRecentUserByUin(((TroopAssistantData)localObject3).troopUin, 1);
        ...
        {
          ((aong)localObject1).saveRecentUser((BaseRecentUser)???);
  ...
  public void k(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      if (awhx.a().a(paramQQAppInterface) == true)
      {
        localEntityManager = paramQQAppInterface.a().createEntityManager();
        awhx.a().a(localEntityManager, paramQQAppInterface);
        localEntityManager.close();
      }
      return;
    }
