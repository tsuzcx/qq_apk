  ...
  extends BaseAdapter
{
  ...
  public bgdl(List<ParagraphInfo> paramList, Set<Integer> paramSet)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560646, paramViewGroup, false);
    }
    Object localObject1 = (CheckBox)localView.findViewById(2131364507);
    paramView = (TextView)localView.findViewById(2131379761);
    ...
    ((SpannableString)localObject2).setSpan(new bgvl(paramViewGroup.getContext(), paramViewGroup.getContext().getResources().getColor(2131167069), 17, 4, 3, 12, Color.parseColor("#777777"), (String)localObject1), 0, ((String)localObject1).length(), 33);
