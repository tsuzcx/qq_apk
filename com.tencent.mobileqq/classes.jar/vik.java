...
{
  public vik(VideoActionSheet paramVideoActionSheet, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, String paramString, Context paramContext, boolean paramBoolean, int paramInt1, int paramInt2) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        DialogUtil.b(this.jdField_a_of_type_AndroidContentContext, 230, null, paramView, 2131429042, 2131428668, new vil(this), null).show();
        return;
