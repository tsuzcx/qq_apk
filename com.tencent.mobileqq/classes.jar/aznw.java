...
{
  public aznw(SQLiteOpenHelper paramSQLiteOpenHelper, String paramString)
  {
    ...
    catch (Exception paramNoColumnErrorHandler)
    {
      try
      {
        if (paramClass.getName().equals(MessageRecord.class.getName()))
        {
          ...
          MessageRecord localMessageRecord = bcry.a(i, paramClass, j, paramNoColumnErrorHandler, k);
