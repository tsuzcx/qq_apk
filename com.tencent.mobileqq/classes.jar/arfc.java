...
public class arfc
{
  ...
  public static arfc a(araj[] paramArrayOfaraj)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          String str1 = paramArrayOfaraj[i].jdField_a_of_type_JavaLangString;
          if (str1 == null) {
            break label671;
          }
          ...
          if (((JSONObject)localObject).has("aio_mini_app_on"))
          {
            ...
            bool = true;
            localarfc.jdField_a_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("mini_app_local_search"))
          {
            ...
            bool = true;
            localarfc.jdField_b_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("mini_app_refresh_time")) {
            localarfc.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("mini_app_refresh_time", 60);
          }
          if (((JSONObject)localObject).has("popBarShowMiniAppStore"))
          {
            ...
            bool = true;
            localarfc.jdField_c_of_type_Boolean = bool;
          }
          ...
          if (((JSONObject)localObject).has("mini_app_entry_auto_show"))
          {
            ...
            bool = true;
            localarfc.jdField_d_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("contact_mini_app_on"))
          {
            ...
            bool = true;
            localarfc.jdField_f_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("more_mini_app_on"))
          {
            ...
            bool = true;
            localarfc.jdField_e_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("group_mini_app_on"))
          {
            ...
            bool = true;
            localarfc.jdField_g_of_type_Boolean = bool;
          }
          if (((JSONObject)localObject).has("avatar_mini_app_on"))
          {
            ...
            if (((JSONObject)localObject).has("avatar_mini_app_url")) {
              localarfc.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).optString("avatar_mini_app_url");
            }
          }
          if (((JSONObject)localObject).has("back_to_home_scene_list"))
          {
            if (localarfc.jdField_a_of_type_JavaUtilArrayList == null) {
              localarfc.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
            }
            localarfc.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (j < k)
            {
              ...
              localarfc.jdField_a_of_type_JavaUtilArrayList.add(Integer.valueOf(str2));
              break label678;
            }
          }
          if (1 == ((JSONObject)localObject).optInt("enable_c2c_plus_panel", 0))
          {
            localarfc.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("url", "");
            localarfc.jdField_c_of_type_JavaLangString = ((JSONObject)localObject).optString("icon", "");
            localarfc.jdField_d_of_type_JavaLangString = ((JSONObject)localObject).optString("icon_night", "");
            localarfc.jdField_e_of_type_JavaLangString = ((JSONObject)localObject).optString("simple_icon", "");
            localarfc.jdField_f_of_type_JavaLangString = ((JSONObject)localObject).optString("simple_icon_night", "");
            localarfc.jdField_g_of_type_JavaLangString = ((JSONObject)localObject).optString("name", BaseApplicationImpl.sApplication.getString(2131697771));
            localObject = BaseApplicationImpl.getApplication().getRuntime();
            if ((localObject instanceof QQAppInterface))
            {
              localObject = (QQAppInterface)localObject;
              aiay.a((QQAppInterface)localObject).a((QQAppInterface)localObject, localarfc);
            }
          }
