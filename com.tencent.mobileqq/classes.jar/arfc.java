...
public class arfc
{
  ...
  public final ArrayList<arex> a;
  public final int b;
  public arfb b;
  public final int c;
  private final int d;
  
  public arfc(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, ArrayList<arex> paramArrayList)
  {
  ...
  public arfc(String paramString, int paramInt1, int paramInt2, ArrayList<arex> paramArrayList)
  {
    this.jdField_a_of_type_Arfb = new arfb();
    this.jdField_b_of_type_Arfb = new arfb();
    this.jdField_a_of_type_Int = paramInt1;
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      return ((arex)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2, Bitmap paramBitmap1, Bitmap paramBitmap2, int paramInt3)
  {
    ...
    if ((this.jdField_a_of_type_Arfb != null) && (this.jdField_a_of_type_Arfb.a != null) && (!this.jdField_a_of_type_Arfb.a.isRecycled()))
    {
      paramBitmap1 = new Rect(paramInt1 - this.jdField_a_of_type_Arfb.c - this.jdField_a_of_type_Arfb.a.getWidth(), (int)(paramInt2 - paramPaint1.getTextSize()), paramInt1 - this.jdField_a_of_type_Arfb.c, (int)(this.jdField_a_of_type_Arfb.a.getHeight() + paramInt2 - paramPaint1.getTextSize()));
      paramCanvas.drawBitmap(this.jdField_a_of_type_Arfb.a, null, paramBitmap1, null);
    }
  ...
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2, Paint paramPaint3, int paramInt3, float paramFloat1, float paramFloat2, int[] paramArrayOfInt, float[] paramArrayOfFloat)
  {
    ...
    if (paramInt3 > 0)
    {
      paramArrayOfInt = (arex)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3 - 1);
    ...
    paramPaint2 = (arex)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3);
    ...
    for (paramPaint2 = this.jdField_a_of_type_JavaLangString.substring(paramPaint2.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString.length());; paramPaint2 = this.jdField_a_of_type_JavaLangString.substring(paramPaint2.jdField_a_of_type_Int, paramPaint2.jdField_b_of_type_Int))
    {
      ...
      if (paramInt3 < this.jdField_a_of_type_JavaUtilArrayList.size() - 1)
      {
        paramPaint2 = (arex)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3 + 1);
  ...
  public long b()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      arex localarex = (arex)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_JavaUtilArrayList.size() - 1);
      long l = localarex.jdField_a_of_type_Long;
      return localarex.jdField_b_of_type_Long + l;
    }
    return 0L;
  }
}
