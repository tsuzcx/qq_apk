...
public class mye
{
  ...
  private final myg jdField_a_of_type_Myg = new myg(Looper.getMainLooper());
  private final List<BusinessObserver> jdField_b_of_type_JavaUtilList = new ArrayList(4);
  private final myg jdField_b_of_type_Myg = new myg(ThreadManager.getSubThreadHandler());
  ...
  private void a(int paramInt, boolean paramBoolean1, Object paramObject, boolean paramBoolean2, boolean paramBoolean3, BusinessObserver paramBusinessObserver, myg parammyg)
  {
    paramObject = new ObserverCenter.1(this, paramBusinessObserver, paramInt, parammyg, paramBoolean1, paramObject);
    if (paramBoolean2)
    {
      parammyg.a(paramObject, paramBoolean3);
      return;
    }
    parammyg.b(paramObject, paramBoolean3);
  }
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((paramClass != null) && (paramClass.isAssignableFrom(localBusinessObserver.getClass()))) {
            a(paramInt, paramBoolean1, paramObject, paramBoolean2, paramBoolean3, localBusinessObserver, this.jdField_a_of_type_Myg);
          }
        }
      }
      finally {}
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        while (localIterator.hasNext())
        {
          localBusinessObserver = (BusinessObserver)localIterator.next();
          if ((paramClass != null) && (paramClass.isAssignableFrom(localBusinessObserver.getClass()))) {
            a(paramInt, paramBoolean1, paramObject, paramBoolean2, paramBoolean3, localBusinessObserver, this.jdField_b_of_type_Myg);
          }
        }
      }
      finally {}
  ...
  public void b(BusinessObserver paramBusinessObserver)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: getfield 28	mye:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   9: astore_2
    //   10: aload_2
    //   11: monitorenter
    //   12: aload_0
    //   13: getfield 28	mye:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   16: aload_1
    ...
    //   24: monitorexit
    //   25: aload_0
    //   26: getfield 26	mye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   29: astore_2
    //   30: aload_2
    //   31: monitorenter
    //   32: aload_0
    //   33: getfield 26	mye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   36: aload_1
