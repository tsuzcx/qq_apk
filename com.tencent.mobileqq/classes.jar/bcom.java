...
public class bcom
{
  ...
  {
    Object localObject = new File(mol.a("1018") + "1018");
    if (!((File)localObject).isDirectory()) {}
    do
    {
      return null;
      localObject = ((File)localObject).listFiles(new bcon());
    } while ((localObject == null) || (localObject.length == 0));
    return localObject[0];
  }
  
  public static void a(String paramString, boolean paramBoolean, bcol parambcol)
  {
    if (jdField_a_of_type_Bcok == null) {
      jdField_a_of_type_Bcok = bcok.a();
    }
    jdField_a_of_type_Bcok.a(paramString, paramBoolean, parambcol);
  }
  ...
  {
    paramString = new File(paramString).listFiles(new bcoo());
    boolean bool2;
  ...
  private static boolean c(String paramString)
  {
    ...
    //   15: aload_0
    //   16: invokestatic 93	mol:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   46: astore 4
    //   48: invokestatic 42	bcom:a	()Ljava/io/File;
    //   51: astore_0
    //   52: aload_0
    //   53: ifnonnull +9 -> 62
    //   56: aload 4
    //   58: invokestatic 211	bcom:b	(Ljava/lang/String;)Z
    //   61: ireturn
    ...
    //   135: ifne +113 -> 248
    //   138: aload 4
    //   140: invokestatic 211	bcom:b	(Ljava/lang/String;)Z
    //   143: istore_1
    //   144: iload_1
    //   145: ireturn
    //   146: astore_0
