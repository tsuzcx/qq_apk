...
public class arpy
{
  ...
  private SparseArray<arpz> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private String jdField_a_of_type_JavaLangString = "";
  private List<arqa> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Map<String, String> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int;
  private String jdField_b_of_type_JavaLangString = "";
  private Map<String, arpz> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  public static arpy a(araj[] paramArrayOfaraj)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        localarpz.jdField_b_of_type_ArrayOfJavaLangString = a(str2);
        paramArrayOfaraj.jdField_b_of_type_JavaUtilMap.put(str1, localarpz);
        continue;
        return paramArrayOfaraj;
      }
    }
    ...
    do
    {
      ...
      paramArrayOfaraj.jdField_a_of_type_JavaLangString = ((StringBuilder)localObject3).toString();
      paramArrayOfaraj.jdField_b_of_type_JavaLangString = ((StringBuilder)localObject5).toString();
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject5 = (arpz)paramArrayOfaraj.jdField_b_of_type_JavaUtilMap.get(localObject3);
        str1 = ((JSONObject)localObject4).optString("key");
        ((arpz)localObject5).jdField_a_of_type_ArrayOfJavaLangString = a(str1);
        if (paramArrayOfaraj.jdField_c_of_type_Int == 1) {
          ((arpz)localObject5).jdField_a_of_type_JavaLangString = ((JSONObject)localObject4).optString("Tips1");
        }
        for (((arpz)localObject5).jdField_b_of_type_JavaLangString = ((JSONObject)localObject4).optString("Link1");; ((arpz)localObject5).jdField_b_of_type_JavaLangString = ((JSONObject)localObject4).optString("Link0"))
        {
          ...
          paramArrayOfaraj.jdField_c_of_type_JavaUtilMap.put("key_str_key_tips" + (String)localObject3, ((arpz)localObject5).jdField_a_of_type_JavaLangString);
          paramArrayOfaraj.jdField_c_of_type_JavaUtilMap.put("key_str_key_link" + (String)localObject3, ((arpz)localObject5).jdField_b_of_type_JavaLangString);
          break;
          ((arpz)localObject5).jdField_a_of_type_JavaLangString = ((JSONObject)localObject4).optString("Tips0");
        }
      }
      localJSONObject1 = localException.optJSONObject("Text");
    } while (localJSONObject1 == null);
    paramArrayOfaraj.jdField_c_of_type_JavaLangString = localJSONObject1.toString();
  ...
  private static void a(JSONObject paramJSONObject, arpy paramarpy)
  {
    ...
    if (i < localJSONArray.length())
    {
      ...
      arpz localarpz = new arpz();
      paramarpy.jdField_d_of_type_Int = paramJSONObject.optInt("containKeyword");
      if (paramarpy.jdField_d_of_type_Int == 1) {
        localarpz.jdField_a_of_type_JavaLangString = paramJSONObject.optString("Tips1");
      }
      for (localarpz.jdField_b_of_type_JavaLangString = paramJSONObject.optString("Link1");; localarpz.jdField_b_of_type_JavaLangString = paramJSONObject.optString("Link0"))
      {
        int j = k;
        if (k == -1) {
          j = i;
        }
        paramarpy.jdField_a_of_type_AndroidUtilSparseArray.put(j, localarpz);
        i += 1;
        break;
        localarpz.jdField_a_of_type_JavaLangString = paramJSONObject.optString("Tips0");
      }
    }
  }
        ...
        while (i < ((JSONArray)localObject).length())
        {
          ...
          if (paramJSONObject.optJSONArray("infos") != null)
          {
            ...
            while (j < paramJSONObject.length())
            {
              ...
              arqa localarqa = new arqa();
              localarqa.jdField_a_of_type_JavaLangString = localJSONObject.optString("template_name");
              localarqa.jdField_a_of_type_Int = localJSONObject.optInt("template_id", -1);
              if (localarqa.jdField_a_of_type_Int == -1) {
                QLog.d("TencentDocDataLineTipsConfigBean", 2, "template has no id");
              }
              localarqa.jdField_b_of_type_Int = k;
              this.jdField_a_of_type_JavaUtilList.add(localarqa);
              j += 1;
            }
          }
          i += 1;
