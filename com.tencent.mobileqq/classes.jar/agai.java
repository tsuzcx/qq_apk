...
public class agai
  implements bfug
{
  public agai(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  
  public void a(bfuf parambfuf)
  {
    if (parambfuf.a == this.a.m) {
      return;
    }
    this.a.m = parambfuf.a;
    ChatHistoryTroopMemberFragment.a(this.a, parambfuf.a);
    ...
    for (;;)
    {
      ...
      if (this.a.m == 1)
      {
        ((akhq)this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).v(this.a.jdField_c_of_type_JavaLangString);
        new axra(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("mber_list").d("exp_onlineList").a(0).a(new String[] { this.a.jdField_c_of_type_JavaLangString }).a();
        new axra(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("mber_list").d("clk_onlinefirst").a(new String[] { this.a.jdField_c_of_type_JavaLangString }).a();
        break;
      }
      if (this.a.m == 2) {}
      for (parambfuf = "Clk_lastactivetime";; parambfuf = "Clk_jointime")
      {
        this.a.a(parambfuf, "1", this.a.o);
        break;
      }
      label433:
