...
public class wkg
{
  ...
  public wkg(List<String> paramList)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Wkl = new wkh(this);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Wkk = null;
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    xvv.d("BatchGetVideoInfo", "runPuller vid list size = %d", new Object[] { Integer.valueOf(((List)localObject).size()) });
    paramList = waz.a((List)localObject);
    paramList.a("BatchGetVideoInfo");
    paramList.a(new wki(this, paramList));
    paramList.b();
  }
  
  public void a(wkk paramwkk)
  {
  ...
  public void b()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          if ((this.jdField_a_of_type_Wkl != null) && (this.jdField_a_of_type_Wkl.a(localStoryVideoItem)))
          {
            if (QLog.isColorLevel()) {
    ...
    } while (this.jdField_a_of_type_Wkk == null);
    this.jdField_a_of_type_Wkk.a(localArrayList2);
    return;
    a(localArrayList1);
  }
  ...
  public void c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      StoryVideoItem localStoryVideoItem = localvuu.a((String)localObject2);
      if (localStoryVideoItem == null)
      {
        if (QLog.isColorLevel()) {
      ...
      {
        localObject2 = ((vvj)vux.a(2)).b(localStoryVideoItem.mOwnerUid);
    ...
    do
    {
      ...
      if (!localArrayList3.isEmpty()) {
        localvuu.a(localArrayList3);
      }
      if (!localArrayList2.isEmpty()) {
        break;
      }
    } while (this.jdField_a_of_type_Wkk == null);
    this.jdField_a_of_type_Wkk.a((ArrayList)localObject1);
    return;
    localObject1 = waz.a(localArrayList2);
    ((waz)localObject1).a("BatchGetVideoInfo");
    ((waz)localObject1).a(new wkj(this, (waz)localObject1));
    ((waz)localObject1).b();
  }
  ...
  public void d()
  {
    ...
    while (localIterator.hasNext())
    {
      StoryVideoItem localStoryVideoItem = localvuu.a((String)localIterator.next());
      if (localStoryVideoItem == null)
      {
        xvv.d("BatchGetVideoInfo", "user -> video empty ,strange");
      }
      else
      {
        ...
        {
          localQQUserUIItem = ((vvj)vux.a(2)).b(localStoryVideoItem.mOwnerUid);
    ...
    if (!localArrayList2.isEmpty()) {
      localvuu.a(localArrayList2);
    }
    if (this.jdField_a_of_type_Wkk != null) {
      this.jdField_a_of_type_Wkk.a(localArrayList1);
    }
  }
}
