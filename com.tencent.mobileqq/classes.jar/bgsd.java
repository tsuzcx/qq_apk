...
public class bgsd
{
  ...
  public void a()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.mActivity.runOnUiThread(new TroopInteractGiftAnimationController.5(this));
  ...
  public void a(TroopChatPie paramTroopChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.mAIORootView.findViewById(2131364488));
  }
  ...
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie != null) {
      ((bgko)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.app.getManager(QQManagerFactory.TROOP_GIFT_MANAGER)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.animationPackageId, new bgsr(this, paramMessageForDeliverGiftTips));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie != null) {
      ((bgko)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.app.getManager(QQManagerFactory.TROOP_GIFT_MANAGER)).a(paramString1, paramString2, paramInt1, paramInt2, new bgsq(this, paramInt2, paramString2, paramMessageForDeliverGiftTips, paramBoolean));
    }
    this.jdField_a_of_type_Int = 0;
  }
  
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, String paramString, boolean paramBoolean, bdyy parambdyy)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie == null) {
      return;
    }
    ...
    if (this.jdField_a_of_type_AndroidMediaSoundPool != null) {
      this.b = this.jdField_a_of_type_AndroidMediaSoundPool.load(bglb.a(paramString) + "sound.wav", 1);
    }
    ThreadManager.post(new TroopInteractGiftAnimationController.1(this, paramString, paramMessageForDeliverGiftTips, paramBoolean, parambdyy, (bgko)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.app.getManager(QQManagerFactory.TROOP_GIFT_MANAGER)), 8, null, true);
  }
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_AndroidMediaSoundPool != null)
    {
      AudioManager localAudioManager = (AudioManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.mContext.getSystemService("audio");
