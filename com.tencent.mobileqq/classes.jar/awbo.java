...
public class awbo
{
  ...
  public static MessageRecord a(awbv paramawbv)
  {
    if (paramawbv != null) {}
    try
    {
    ...
    catch (Exception paramawbv)
    {
      if (QLog.isColorLevel()) {
        QLog.e("Cursor2EntityConvert", 2, "postRead exception = " + paramawbv.getMessage());
      }
      return null;
    }
      ...
      for (l = paramCursor.getLong(paramCursor.getColumnIndex("_id"));; l = -1L)
      {
        try
        {
          if (paramClass.getName().equals(MessageRecord.class.getName()))
          {
            ...
            paramClass = ayvw.a(i, arrayOfByte, j, str, k);
            ...
            if (!this.jdField_a_of_type_Boolean)
            {
              ...
              a(awcw.b(paramClass), paramCursor);
            }
