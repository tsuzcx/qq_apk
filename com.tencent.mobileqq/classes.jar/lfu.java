  ...
  extends BroadcastReceiver
{
  ...
  private lfu(VideoAppInterface paramVideoAppInterface)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                ...
                if ("com.tencent.qav.notify.refuse".equals(paramContext))
                {
                  ...
                  paramIntent = lcx.a().b(paramContext);
                  if (QLog.isColorLevel()) {
                  ...
                  for (;;)
                  {
                    axqy.b(null, "dc00898", "", "", "0X800A2C7", "0X800A2C7", 0, 0, "", "", "", "");
                    return;
      ...
      if (TextUtils.equals(paramContext, "avChatRoom"))
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ((lko)localObject).a(i, paramIntent);
          }
        }
      }
