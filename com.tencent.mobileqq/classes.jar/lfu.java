...
public class lfu
  extends lft
{
  public lfu(AppInterface paramAppInterface)
  {
  ...
  protected int a()
  {
    ...
    {
      localObject = (lip)((VideoAppInterface)localObject).a(0);
      if (localObject != null) {
        return ((lip)localObject).b();
      }
    }
    return 4;
  }
  ...
  protected void a(long paramLong1, boolean paramBoolean, List<NetAddr> paramList, long paramLong2)
  {
    ...
    label159:
    for (Object localObject = "null";; localObject = localley.d)
    {
      QLog.w("AudioTransClientInterfaceHandlerExtend.runhw", 1, (String)localObject + "]");
      if ((localVideoController != null) && (localley != null)) {
        localVideoController.a(lcr.a(localley.d), paramBoolean, paramList, paramLong2);
      }
      return;
  ...
  {
    lbc.c("AudioTransClientInterfaceHandlerExtend.runhw", "notifyEvent :" + paramInteger + "|" + paramObject);
  ...
  {
    a(Integer.valueOf(6008), new lga(paramString1, paramString2, paramString3, paramInt));
  }
