...
public class beos
{
  ...
  public beos(QQAppInterface paramQQAppInterface)
  {
  ...
  public ArrayList<Entity> a(String paramString)
  {
    ...
    Object localObject2 = (aonn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(2);
    Object localObject1 = ((aonn)localObject2).a(paramString);
    ...
    if (j < ((List)localObject1).size())
    {
      ...
      {
        localObject6 = (RecentUser)((aong)localObject4).findRecentUserByUin(((TroopIndex)localObject5).mTroopUin, 1);
    ...
    for (;;)
    {
      ...
      localObject7 = ((aonn)localObject2).b((String)localObject7);
      ...
      if ((((anmw)localObject1).b(((TroopIndex)localObject8).mMemberUin)) && (!((String)localObject6).equals(((TroopIndex)localObject8).mMemberUin)) && (!paramString.equals(((TroopIndex)localObject8).mMemberUin)))
      {
        if (((HashMap)localObject5).containsKey(((TroopIndex)localObject8).mMemberUin)) {
          break label676;
        }
        beov localbeov = new beov(this, f3);
        localbeov.b = f1;
        localbeov.jdField_a_of_type_Int = 1;
        RecentUser localRecentUser = (RecentUser)((aong)localObject4).findRecentUserByUin(((TroopIndex)localObject8).mMemberUin, 0);
        if (localRecentUser != null) {
          localbeov.jdField_a_of_type_Long = localRecentUser.lastmsgtime;
        }
        ((HashMap)localObject5).put(((TroopIndex)localObject8).mMemberUin, localbeov);
      }
      for (;;)
      {
        j += 1;
        break;
        label676:
        localObject8 = (beov)((HashMap)localObject5).get(((TroopIndex)localObject8).mMemberUin);
        ((beov)localObject8).jdField_a_of_type_Int += 1;
        ((beov)localObject8).b += f1;
      }
      if (QLog.isColorLevel()) {
      ...
      Collections.sort(paramString, new beot(this));
      i = paramString.size();
      if ((i > 1) && (((beov)((Map.Entry)paramString.get(i - 1)).getValue()).a() == ((beov)((Map.Entry)paramString.get(0)).getValue()).a())) {}
      for (i = 1;; i = 0)
      {
        if (i != 0)
        {
          ...
          Collections.sort(paramString, new beou(this));
        }
        localObject2 = new ArrayList();
        i = 0;
        if (i < paramString.size())
        {
          localObject3 = (beov)((Map.Entry)paramString.get(i)).getValue();
          localObject4 = ((anmw)localObject1).b((String)((Map.Entry)paramString.get(i)).getKey());
          if (localObject4 != null)
          {
            ((ArrayList)localObject2).add(localObject4);
            if ((i < 20) && (QLog.isColorLevel())) {
              QLog.i("RelationFriendsSearchHelper", 2, "top20:uin" + bgsp.e(((Friends)localObject4).uin) + ",scores:" + ((beov)localObject3).a() + ",frequency:" + ((beov)localObject3).jdField_a_of_type_Int + ",activefactor:" + ((beov)localObject3).b + ",c2clastmsgtime:" + ((beov)localObject3).jdField_a_of_type_Long);
            }
          }
          for (;;)
          {
