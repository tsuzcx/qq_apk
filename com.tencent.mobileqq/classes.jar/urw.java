...
{
  public urw(ArkAppView paramArkAppView) {}
  ...
  public void onFocusChanged(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = this.a.getResources().getDrawable(2130838188);
      Object localObject1 = this.a.getResources().getDrawable(2130838187);
  ...
  public void onSelectChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = this.a.getResources().getDrawable(2130838188).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = this.a.getResources().getDrawable(2130838187).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      int i = this.a.getResources().getDrawable(2130838187).getIntrinsicHeight();
      ArkViewImplement.ArkViewInterface localArkViewInterface = (ArkViewImplement.ArkViewInterface)paramView;
      ArkAppView.a(this.a, BubbleContextMenu.a(paramView, paramInt1, paramInt2, paramInt3 + i, localQQCustomMenu, new urx(this, paramInt4, localArkViewInterface)));
      return;
      if (paramInt4 == 1)
      {
