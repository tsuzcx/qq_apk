...
public final class UInt64Rules
  extends ExtendableMessageNano<UInt64Rules>
{
  public long a;
  public long b;
  public long c;
  ...
  public UInt64Rules a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
    ...
    if (arrayOfLong != null)
    {
      ...
      if (arrayOfLong.length > 0)
      {
        ...
        for (;;)
        {
          ...
          k += CodedOutputByteBufferNano.computeUInt64SizeNoTag(arrayOfLong[i]);
          i += 1;
        }
  ...
  public void writeTo(CodedOutputByteBufferNano paramCodedOutputByteBufferNano)
  {
    ...
    if ((arrayOfLong != null) && (arrayOfLong.length > 0))
    {
      ...
      for (;;)
      {
        ...
        paramCodedOutputByteBufferNano.writeUInt64(6, arrayOfLong[i]);
        i += 1;
      }
    }
    arrayOfLong = this.g;
    if ((arrayOfLong != null) && (arrayOfLong.length > 0))
    {
      ...
      for (;;)
      {
        ...
        paramCodedOutputByteBufferNano.writeUInt64(7, arrayOfLong[i]);
        i += 1;
      }
    }
 ...
 * Qualified Name:     io.envoyproxy.pgv.validate.nano.UInt64Rules
