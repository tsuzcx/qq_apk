  ...
  implements EventChannel.EventSink
{
  ...
  {
    if ((this.hasEnded.getAndSet(true)) || (EventChannel.IncomingStreamRequestHandler.access$300(this.this$1).get() != this)) {
      return;
    }
  ...
  {
    if ((this.hasEnded.get()) || (EventChannel.IncomingStreamRequestHandler.access$300(this.this$1).get() != this)) {
      return;
    }
