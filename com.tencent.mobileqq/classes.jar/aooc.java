  ...
  extends aood
{
  ...
  public aooc(QQAppInterface paramQQAppInterface, arya paramarya, HashMap<String, ArrayList<MessageRecord>> paramHashMap, arxn paramarxn)
  {
    ...
    if (this.b == null)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (i < ((ArrayList)localObject).size())
        {
          ...
          if ((localMessageRecord2 == null) || (!apck.a(localMessageRecord2))) {
            break label165;
          }
  ...
  public void a(String paramString, List<MessageRecord> paramList, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      paramList = ajjy.a(2131641227) + paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName");
