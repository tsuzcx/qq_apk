...
public class ymx
{
  public static String a(DeviceInfo paramDeviceInfo)
  {
    ...
    {
      localObject = ((yak)((QQAppInterface)localObject).a(51)).a(paramDeviceInfo.productId);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, DeviceInfo paramDeviceInfo, String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = bfng.a(paramString);
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            bhvv.a().a((Activity)paramContext, paramQQAppInterface, paramQQAppInterface.getAccount(), paramDeviceInfo, "com.tencent.device.activities.DeviceSquareActivity", 0, null, SmartDevicePluginProxyActivity.class);
            ymw.a(null, "Usr_NewDevice_Aio", 2, 0, 0);
            return;
          }
        }
        catch (Exception paramQQAppInterface)
        {
          bdht.c("SmartDeviceUtil", "jumpLightApp, Exception >>>", paramQQAppInterface);
          return;
        }
      ...
      ((yak)paramQQAppInterface.a(51)).a(paramString);
    ...
    paramBundle = (yak)paramQQAppInterface.a(51);
  ...
  public static void a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString)
  {
    if (AppSetting.b)
    {
      bdht.e("SmartDeviceUtil", "AppSetting.IS_CPU_64_BIT, disable device model");
      return;
    }
    ...
    try
    {
      ...
      paramJSONObject = (StructMsgForGeneralShare)axuy.a((Bundle)localObject);
      localObject = (MessageForStructing)axaq.a(-2011);
  ...
  public static void a(String paramString1, Bundle paramBundle, int paramInt, String paramString2, AppRuntime paramAppRuntime, BusinessObserver paramBusinessObserver)
  {
    ...
    paramBundle.putString("version", "8.2.8");
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), xqn.class);
