  ...
  implements ymz
{
  ...
  public ymx(AppInterface paramAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(@NonNull ArrayList<yna> paramArrayList, @NonNull Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      paramArrayList.add(new yna(paramContext.getResources().getDrawable(2130846699), 1, 0));
    }
      ...
      if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
      {
        ...
        if (bool)
        {
          ...
          if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
          {
            ...
            do
            {
              localObject4 = localyna1;
              localObject5 = localObject2;
              localObject6 = localObject3;
              localObject7 = localyna2;
            ...
            {
              localObject4 = new yna(paramContext.getResources().getDrawable(2130844952), 2, i);
    ...
    for (;;)
    {
      ...
      {
        localyna1 = new yna(paramContext.getResources().getDrawable(2130844953), 2, i);
      ...
      {
        localObject4 = new yna(paramContext.getResources().getDrawable(2130844954), 2, i);
        localObject3 = localObject1;
        localObject1 = localObject2;
      ...
      {
        localObject4 = new yna(paramContext.getResources().getDrawable(2130844951), 2, i);
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
      }
      ...
      {
        localyna2 = new yna(paramContext.getResources().getDrawable(2130844950), 2, i);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
        ...
        paramArrayList.add(new yna(paramContext.getResources().getDrawable(2130846691), 0, -1));
        int k = 0;
