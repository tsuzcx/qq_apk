  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    aceh.a((Map)localObject, localLabelInfo.msgId);
    ...
    if (auud.a(localLabelInfo.redInfo))
    {
      ...
      aceh.a(ampj.a(), "769", "205614", localLabelInfo.appId, "76903", "1", "160", (Map)localObject);
      auud.a(localLabelInfo.redInfo.redPointId);
      ((aurh)paramView.getTag()).a.setVisibility(8);
      if (!localLabelInfo.isFriend) {
        break label301;
      }
      new LinearLayout.LayoutParams(-1, -2).gravity = 80;
      new auuw(this.a.itemView.getContext(), this.a.jdField_a_of_type_Auqu.a().gameAppId, localLabelInfo.friendType).show();
      aceh.a(ampj.a(), "769", "205355", this.a.jdField_a_of_type_Auqu.a().gameAppId, "76902", "1", "160", new String[] { "", "", "20" });
    }
    for (;;)
    {
