...
public class aurm
{
  private static aurm jdField_a_of_type_Aurm;
  ...
  private auro jdField_a_of_type_Auro;
  ...
  private aurm()
  {
    try
    {
      ...
      this.jdField_a_of_type_Auro = new auro(this, BaseApplicationImpl.getContext());
  ...
  {
    if (jdField_a_of_type_Aurm == null) {
      jdField_a_of_type_Aurm = new aurm();
    }
    return jdField_a_of_type_Aurm;
  }
  ...
  public int a(auuk paramauuk, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramauuk != null)
    {
      paramauuk.a(new aurn(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130844388;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131560926);
      paramBundle.setImageViewResource(2131371952, 2130844384);
      paramBundle.setTextViewText(2131371963, (CharSequence)localObject2);
      paramBundle.setProgressBar(2131371944, 100, 0, false);
      paramBundle.setViewVisibility(2131371951, 8);
      paramBundle.setViewVisibility(2131371945, 8);
      paramBundle.setTextColor(2131371963, -7829368);
      paramBundle.setTextColor(2131371951, -7829368);
      paramBundle.setTextColor(2131371946, -7829368);
      float f1 = this.jdField_a_of_type_Auro.a();
      if (this.jdField_a_of_type_Auro.a() <= 0.0F)
      {
        QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
        f1 = 14.0F;
      }
      paramBundle.setFloat(2131371951, "setTextSize", f1);
      paramBundle.setFloat(2131371946, "setTextSize", f1);
      float f2 = this.jdField_a_of_type_Auro.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      paramBundle.setFloat(2131371963, "setTextSize", f1);
      ...
      try
      {
        int i = this.jdField_a_of_type_Auro.a().intValue();
        paramBundle.setInt(2131371953, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131719067) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131371952, 2130844384);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131371946, BaseApplication.getContext().getString(2131719068));
        paramNotification.contentView.setViewVisibility(2131371945, 0);
        paramNotification.contentView.setViewVisibility(2131371951, 8);
        paramNotification.contentView.setProgressBar(2131371944, 100, 0, false);
      ...
      for (;;)
      {
        ...
        paramNotification.contentView.setTextViewText(2131371946, "0%");
        break;
        paramNotification.when = a(3);
        break label243;
        paramNotification.contentView.setOnClickPendingIntent(2131371953, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      aure.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131719061) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131719063);
    if (auuf.a(str1) != null)
    {
      localBitmap = auuf.a(str1);
      localObject = BaseApplication.getContext().getString(2131719062);
    }
    if (localBitmap == null)
    {
      int j = aunj.b(str1);
      if (j != 0)
      {
        localNotification.contentView.setImageViewResource(2131371952, j);
        label236:
        localNotification.contentView.setImageViewResource(2131371952, 2130844386);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131371951, 0);
      localNotification.contentView.setViewVisibility(2131371945, 8);
      localNotification.contentView.setTextViewText(2131371951, (CharSequence)localObject);
      ...
      localNotification.contentView.setImageViewResource(2131371952, 2130844386);
      break label236;
      localNotification.contentView.setImageViewBitmap(2131371952, localBitmap);
    }
  }
  ...
  protected void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131371944, 100, i, false);
      paramNotification.contentView.setTextViewText(2131371946, "" + i + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.setPackage(MobileQQ.getContext().getPackageName());
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      aure.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131371952, 2130844387);
    paramNotification.contentView.setViewVisibility(2131371951, 0);
    paramNotification.contentView.setViewVisibility(2131371945, 8);
    paramNotification.contentView.setTextViewText(2131371951, BaseApplication.getContext().getString(2131719066));
    paramNotification.contentView.setProgressBar(2131371944, 100, i, false);
    paramNotification.contentView.setTextViewText(2131371946, "" + i + "%");
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setOnClickPendingIntent(2131371953, paramBundle2);
    }
  }
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131719065);
      paramNotification.contentView.setTextViewText(2131371951, BaseApplication.getContext().getString(2131719065));
      label115:
      paramNotification.contentView.setImageViewResource(2131371952, 2130844385);
      paramNotification.contentView.setViewVisibility(2131371951, 0);
      paramNotification.contentView.setTextViewText(2131371946, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131719064) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131371951, auuk.a(i) + anzj.a(2131714663));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131371953, paramBundle2);
    }
