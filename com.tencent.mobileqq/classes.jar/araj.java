...
public class araj
  implements Handler.Callback, ayeo
{
  ...
  private WeakReference<aran> jdField_a_of_type_JavaLangRefWeakReference;
  
  public araj(QQAppInterface paramQQAppInterface, Context paramContext, CustomEmotionData paramCustomEmotionData, StructMsgForImageShare paramStructMsgForImageShare, int paramInt)
  {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    if (paramInt == 1)
    {
      paramQQAppInterface = new aram(paramQQAppInterface, paramContext);
      if ((paramContext instanceof BaseActivity))
      {
        if (!((BaseActivity)paramContext).isFinishing())
        {
          paramQQAppInterface = bfur.a(paramContext, 0, "温馨提示", paramContext.getString(2131689608), "取消", "立即开通", paramQQAppInterface, paramQQAppInterface);
    ...
    while (paramInt != 2) {
      ...
      {
        return;
        QQToast.a(paramContext, paramContext.getString(2131689609), 0).b(2131299076);
      }
    }
    QQToast.a(paramContext, paramContext.getString(2131689609), 0).b(2131299076);
    avsq.c("2007", 1);
  ...
  protected void a()
  {
    ...
    localReportDialog.setContentView(2131559129);
    ...
    localButton1.setOnClickListener(new arak(this, localReportDialog));
    localButton2.setOnClickListener(new aral(this, localReportDialog));
    if (!((Activity)this.jdField_a_of_type_AndroidContentContext).isFinishing())
    {
      bfyz.w(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), false);
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaran);
  }
  ...
  protected void b()
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      ((arba)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149)).c(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare != null) {
        agzl.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      }
    ...
    do
    {
      do
      {
        ...
        localObject = (aran)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      } while (localObject == null);
      ((aran)localObject).a(0, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5);
      return;
  ...
  protected void b(int paramInt)
  {
    ...
    {
      localaran = (aran)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localaran != null)
      {
        if (400010 != paramInt) {
          break label43;
        }
        localaran.a(2, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5);
      }
    }
    return;
    label43:
    if (400011 == paramInt)
    {
      localaran.a(3, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5);
      return;
    }
    localaran.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131689606, 0).b(2131299076);
  ...
  {
    int i = paramayep.jdField_a_of_type_Int;
    if (i == 0) {
      b();
    }
    do
