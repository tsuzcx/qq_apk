  ...
  extends ajtb
{
  ...
  public long a;
  private avwi jdField_a_of_type_Avwi = new avwi(paramAppInterface, this.jdField_a_of_type_Awbi);
  private awbi jdField_a_of_type_Awbi = new awbi();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public awbj(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Awbi.b())
        {
          this.jdField_a_of_type_Awbi.a(2);
          paramArrayOfByte1 = (avwj)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Avwi.a(paramArrayOfByte2);
          this.jdField_a_of_type_Avwi.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Awbi.a(0);
  ...
  {
    Object localObject = lgq.a(paramArrayOfByte);
    paramArrayOfByte = ((lgr)localObject).a;
    localObject = ((lgr)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Awbi.d())
        {
          ...
          this.jdField_a_of_type_Avwi.a(paramLong);
          return;
        }
        ...
        {
          this.jdField_a_of_type_Awbi.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Awbi.g());
      this.jdField_a_of_type_Awbi.c(4);
      return;
    } while (this.jdField_a_of_type_Awbi.c());
    this.jdField_a_of_type_Awbi.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Awbi.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = lgq.a(paramString1.toByteArray(), paramString2.toByteArray());
        if (this.jdField_a_of_type_Avwi == null) {
          break;
        }
        if (this.jdField_a_of_type_Avwi.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Avwi.a(paramString1);
  }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Awbi.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Awbi.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Awbi.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Avwi.a())
            {
              ...
              this.jdField_a_of_type_Awbi.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(lgq.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Awbi.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Awbi.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramObject = lgq.a(paramFromServiceMsg.getWupBuffer());
