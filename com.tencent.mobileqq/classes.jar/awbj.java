...
public class awbj
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, avwp paramavwp)
  {
    if (paramavwp == null) {}
    do
    {
      ...
      {
        return 0;
        paramQQAppInterface = avwv.a(paramQQAppInterface).a(paramavwp);
  ...
  public static void a()
  {
    ...
    {
      jdField_a_of_type_Int = bgsg.G(localBaseApplicationImpl);
      c = bgsg.d(localBaseApplicationImpl);
      if (QLog.isColorLevel()) {
    ...
    bgsg.a(localBaseApplicationImpl, false, 0);
  }
  ...
  public static void b()
  {
    ...
    boolean bool = avwv.a((QQAppInterface)localAppRuntime).a.a();
  ...
  public static void c()
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Int != 0))
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        bctj.a(BaseApplication.getContext()).a(localQQAppInterface.getCurrentAccountUin(), "actLocationBgReportSampling", true, jdField_a_of_type_Int, 0L, localHashMap, "");
        if (QLog.isColorLevel()) {
  ...
  public static void e()
  {
    ...
    bcst.b(null, "CliOper", "", "", "0X800A976", "0X800A976", 0, 0, String.valueOf(l), "0", "0", "");
  }
