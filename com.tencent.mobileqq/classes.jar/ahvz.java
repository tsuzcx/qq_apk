...
public class ahvz
{
  private static ahvz jdField_a_of_type_Ahvz;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = anhk.cS + "icons/";
  private static final String jdField_c_of_type_JavaLangString = anhk.cS + "zip/";
  private static final String jdField_d_of_type_JavaLangString = anni.a(2131708621);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bhhf(paramString1, new File(jdField_c_of_type_JavaLangString + "android_qim_theme_icons.zip"));
        paramString1.f = "profileCardDownload";
        paramString1.e = "VIP_profilecard";
        return bhhh.a(paramString1, null);
      }
      ...
      bgmg.b(jdField_b_of_type_JavaLangString);
      continue;
      label183:
      bgmg.b(jdField_c_of_type_JavaLangString);
    }
  }
  
  public static ahvz a()
  {
    if (jdField_a_of_type_Ahvz == null) {
      jdField_a_of_type_Ahvz = new ahvz();
    }
    return jdField_a_of_type_Ahvz;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	ahvz:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   42: invokestatic 316	bgmg:c	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_3
    //   46: aload_3
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	ahvz:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bgmg:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	ahvz:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   71: invokestatic 324	nmk:a	(Ljava/io/File;Ljava/lang/String;)V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_1
  ...
  public Drawable a(int paramInt)
  {
    ...
    localObject = bgmo.a(jdField_b_of_type_JavaLangString + "skin_header_bar.png", localOptions);
    if (localObject != null)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localObject != null)
    {
      localObject = ((anmw)localObject).e(paramSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public void a(ArrayList<ahwa> paramArrayList, ArrayList<int[]> paramArrayList1)
  {
  ...
  {
    if ((!paramBoolean) && ((!(paramObject instanceof ahkf)) || ((paramObject instanceof ahkp)))) {}
    do
    {
      return false;
  ...
  public Drawable b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        localBitmap = bgmo.a(jdField_b_of_type_JavaLangString + "skin_aio_qim_header_flag.png", (BitmapFactory.Options)localObject3);
        localObject1 = localObject2;
        if (localBitmap != null)
        {
          ...
          if (localBitmap == null)
          {
            localObject1 = bgmo.a(jdField_b_of_type_JavaLangString + "title_bg_round.9.png", (BitmapFactory.Options)localObject3);
          ...
          if (localObject2 == null)
          {
            localBitmap = bgmo.a(jdField_b_of_type_JavaLangString + "aio_qim_online_icon.png", (BitmapFactory.Options)localObject3);
            localObject1 = localObject2;
            if (localBitmap != null)
            {
              localObject1 = new BitmapDrawable(localBitmap);
              ...
              {
                localObject2 = bgmo.a(jdField_b_of_type_JavaLangString + "qim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bgmo.a(jdField_b_of_type_JavaLangString + "aio_qim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
                    localObject1 = new BitmapDrawable(BaseApplicationImpl.getContext().getResources(), (Bitmap)localObject1);
                    ((Drawable)localObject1).setBounds(0, 0, bclx.a(13.0F), bclx.a(13.0F));
                    continue;
                    label501:
                    localObject1 = null;
                  }
