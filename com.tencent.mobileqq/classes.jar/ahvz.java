  ...
  implements aibg
{
  ...
  private ahwf jdField_a_of_type_Ahwf = new ahwb(this);
  private ahwg jdField_a_of_type_Ahwg;
  private ahwh jdField_a_of_type_Ahwh;
  Context jdField_a_of_type_AndroidContentContext;
  Handler jdField_a_of_type_AndroidOsHandler = new Handler(new ahwa(this));
  private axdj jdField_a_of_type_Axdj = new ahwc(this);
  bfso jdField_a_of_type_Bfso = new ahwd(this);
  ...
  public ahvz(AppInterface paramAppInterface, Context paramContext, ArrayList<PtvTemplateManager.PtvTemplateInfo> paramArrayList, int paramInt, HorizontalListView paramHorizontalListView, FSurfaceViewLayout paramFSurfaceViewLayout)
  {
    ...
    aibd.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this);
  }
  ...
  {
    PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo;
    if ((!bbkk.a(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewFSurfaceViewLayout != null))
    {
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Ahwh != null) {
        this.jdField_a_of_type_Ahwh.c(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.type);
      }
    ...
    aibd.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo);
    ...
    {
      ahtz.a("", "0X80075BA", paramPtvTemplateInfo, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id, "", "");
      if (!this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.hasGesture()) {
        break;
      }
      ahtz.a("", "0X80083AE", paramPtvTemplateInfo, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id, "", "");
      return;
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, this.jdField_a_of_type_Axdj);
  ...
  public void a(String paramString)
  {
    ...
    aibd.a("lbsUpdateFilter", String.format("currentPath=%s,name=%s", new Object[] { "" + this.jdField_a_of_type_JavaLangString, "" + paramString }), null);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Ahwf);
      return paramView;
