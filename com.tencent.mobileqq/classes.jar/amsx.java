  ...
  implements Manager
{
  ...
  public long a;
  private amsv jdField_a_of_type_Amsv;
  private amti jdField_a_of_type_Amti;
  private amtl jdField_a_of_type_Amtl;
  amtq jdField_a_of_type_Amtq;
  private amxf jdField_a_of_type_Amxf = new amxf();
  private amzq jdField_a_of_type_Amzq;
  private amzw jdField_a_of_type_Amzw;
  private anaj jdField_a_of_type_Anaj;
  Handler jdField_a_of_type_AndroidOsHandler = new amta(this, ThreadManager.getSubThreadLooper());
  anje jdField_a_of_type_Anje;
  anpo jdField_a_of_type_Anpo;
  biht jdField_a_of_type_Biht = new amtf(this);
  bnwp jdField_a_of_type_Bnwp = new amte(this);
  private QQLruCache<String, ApolloBaseInfo> jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new amsy(this, 2009, 1024, ApolloBaseInfo.calcSelfMemorySize());
  ...
  Comparator<DrawerPushItem> jdField_a_of_type_JavaUtilComparator = new amtb(this);
  ...
  private List<amth> jdField_b_of_type_JavaUtilList;
  private AtomicBoolean jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private biht jdField_c_of_type_Biht = new amtc(this);
  private Runnable jdField_c_of_type_JavaLangRunnable = new ApolloManager.5(this);
  private List<WeakReference<amtj>> jdField_c_of_type_JavaUtilList = new ArrayList();
  public boolean c;
  public boolean d;
  ...
  public amsx(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject();
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = true;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Biht = new amtg(this);
    ...
    {
      this.jdField_a_of_type_Anpo = new anpo();
      q();
      anav.b();
    ...
    this.jdField_a_of_type_Amtq = new amtq(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
    this.jdField_a_of_type_Amsv = new amsv(paramQQAppInterface);
    o();
  }
  
  public static int a()
  {
    if ((u) && (annu.jdField_e_of_type_Boolean)) {
      return 3;
    }
    return 2;
  }
    ...
    for (;;)
    {
      try
      {
        if (jdField_c_of_type_Int == -1)
        {
          ...
          {
            i1 = bhsi.p(paramAppInterface.getApplication());
            if (i1 != 0) {
              continue;
            }
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((amsx)paramQQAppInterface.getManager(153)).a(paramQQAppInterface.c());
    int i1;
  ...
  {
    if ((paramQQAppInterface == null) || (!c(paramQQAppInterface.getApplication())) || (TextUtils.isEmpty(paramString1)) || (annu.jdField_a_of_type_OrgJsonJSONObject == null)) {
      return -1;
    }
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      {
        paramString2 = (amsx)paramQQAppInterface.getManager(153);
    ...
    if ((annu.jdField_a_of_type_OrgJsonJSONObject != null) && (str != null))
    {
      paramQQAppInterface = annu.jdField_a_of_type_OrgJsonJSONObject.optJSONObject(str);
      if (paramQQAppInterface == null) {}
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return 0;
          paramQQAppInterface = ((amsx)paramQQAppInterface.getManager(153)).a(paramString);
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    localbnwr.b = (str + "_" + l1);
    localbnwr.jdField_a_of_type_Int = 1;
    localbnwr.jdField_e_of_type_JavaLangString = "tianshu.75";
    localbnwr.jdField_f_of_type_JavaLangString = "tianshu.75";
    localbnwr.g = paramString1;
    localbnwr.h = "";
    localbnwr.jdField_a_of_type_Long = l1;
    localbnwr.jdField_d_of_type_Int = paramInt;
    localbnwr.jdField_e_of_type_Int = 1;
    localbnwr.jdField_f_of_type_Int = 1;
    localbnwr.jdField_l_of_type_JavaLangString = paramString2;
    if (!TextUtils.isEmpty(paramString3)) {
      localbnwr.m = paramString3;
    }
    bnwq.a().a(localbnwr);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   52: dup
    //   53: getstatic 791	annv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((amsx)localObject).b(paramString1 + "");
    ...
    for (paramQQAppInterface = paramString1.substring(0, 4);; paramQQAppInterface = paramString1)
    {
      ...
      do
      {
        ...
        localObject = ((amsx)localObject).b(paramQQAppInterface.c());
  ...
  private void a(ApolloActionPackage paramApolloActionPackage, List<ApolloActionData> paramList)
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      paramList = ((annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionPackage.packageId);
  ...
  private void a(TianShuAccess.RspEntry paramRspEntry)
  {
      ...
      do
      {
        for (;;)
        {
          try
          {
            ...
            continue;
            bnwq.a().a((TianShuAccess.AdItem)paramRspEntry.value.lst.get(i1));
          }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      break label366;
      ((annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).i(localArrayList);
      return;
    }
  }
  ...
  public static boolean a()
  {
    ...
    bhmi.a(new File(annv.c, "/def/basic").getAbsolutePath());
    do
    {
      try
      {
        long l2 = System.currentTimeMillis();
        a(BaseApplicationImpl.getApplication().getApplicationContext(), "apollo_def_rsc", annv.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        long l3 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, "copy file to sdcard cost:" + (l3 - l2));
        }
        new File(annv.c, "def").mkdirs();
        int i1 = LzmaUtils.a(BaseApplicationImpl.getApplication().getApplicationContext(), annv.jdField_a_of_type_JavaLangString + "/apollo_def_rsc", annv.c + "/def/");
        bhmi.d(annv.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        if (i1 != 0) {
          continue;
        }
        boolean bool2 = true;
  ...
  {
    String str = annv.s + paramString1 + ".zip";
    localObject1 = annv.s + paramString1 + ".patch";
    localObject2 = annv.s + paramString1 + ".patched";
    ...
    for (;;)
    {
      try
      {
        if (jdField_d_of_type_Int == -1)
        {
          ...
          if (paramAppInterface != null)
          {
            i1 = bhsi.q(paramAppInterface.getApplication());
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return 0;
            localObject = (amsx)paramQQAppInterface.getManager(153);
            paramString = ((amsx)localObject).a(paramString);
      ...
      localObject = ((amsx)localObject).a(paramQQAppInterface.c());
  ...
  private void b(TianShuAccess.RspEntry paramRspEntry)
  {
    ...
    for (;;)
    {
      ...
      bnwq.a().a((TianShuAccess.AdItem)paramRspEntry.value.lst.get(i2));
      i2 += 1;
      break;
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    apcx.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  ...
  public static int c(String paramString)
  {
    ...
    do
    {
      ...
      i2 = annu.b.optInt(paramString);
      i1 = i2;
    } while (i2 != 2);
    return jdField_e_of_type_Int;
    return annu.b.optInt(paramString);
  }
  ...
  private void d(TianShuAccess.RspEntry paramRspEntry)
  {
    ...
    Object localObject2 = (annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    Object localObject3 = ((annx)localObject2).a(i3);
    ...
    for (;;)
    {
      if (i2 < i4)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject4))
        {
          ...
          if (localObject3 != null)
          {
            localObject5 = ((annx)localObject2).a(i5);
            if (localObject5 != null)
            {
              ...
              ((annx)localObject2).a((ApolloActionPackage)localObject5);
              g(i5);
  ...
  public static boolean d()
  {
    ...
    do
    {
      ...
      {
        return false;
        if (!annu.b.has("autoOpenBox")) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, new Object[] { "openBoxByH5 autoOpenBox:", Integer.valueOf(annu.b.optInt("autoOpenBox")) });
        }
      } while (annu.b.optInt("autoOpenBox") != 0);
      return true;
    } while (!QLog.isColorLevel());
  ...
  public static boolean f()
  {
    ...
    try
    {
      String str = annv.av + "cmshow_script_engine.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
        if (new anqa(str + ".sig", str).a(1)) {
          break label181;
        }
    ...
    if (bool1)
    {
      jdField_d_of_type_JavaLangString = bhmi.b(localFile);
      return bool1;
    }
  ...
  public static boolean g()
  {
    ...
    try
    {
      String str = annv.av + "cmshow_script_0.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
    ...
    if (bool1)
    {
      jdField_e_of_type_JavaLangString = bhmi.b(localFile);
      return bool1;
    }
  ...
  private void o()
  {
    this.jdField_a_of_type_Amti = new amti(this);
    IntentFilter localIntentFilter = new IntentFilter();
    localIntentFilter.addAction("com.tencent.mobileqq.action.ACTION_APOLLO_STORE_CRASH_EVENT");
    try
    {
      BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Amti, localIntentFilter, "com.tencent.msg.permission.pushnotify", null);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void r()
  {
    ...
    //   18: aload_0
    //   19: getfield 2061	amsx:y	Z
    //   22: ifne +586 -> 608
    //   25: aload_0
    //   26: getfield 2061	amsx:y	Z
    //   29: ifeq +4 -> 33
    //   32: return
    //   33: aload_0
    //   34: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   37: ifnull +293 -> 330
    //   40: aload_0
    //   41: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   52: lstore_3
    //   53: aload_0
    //   54: getfield 260	amsx:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   57: ldc 150
    ...
    //   152: aload_0
    //   153: getfield 159	amsx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   156: astore 6
    //   158: aload 6
    //   160: monitorenter
    //   161: aload_0
    //   162: getfield 159	amsx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   165: aload 8
    ...
    //   192: aload_0
    //   193: aload 8
    //   195: putfield 425	amsx:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   198: aload_0
    //   199: aload_0
    //   200: getfield 425	amsx:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   203: getfield 2081	com/tencent/mobileqq/data/ApolloBaseInfo:apolloAISwitch	I
    //   206: iconst_0
    //   207: invokevirtual 2083	amsx:a	(II)V
    //   210: goto -125 -> 85
    //   213: astore 5
    ...
    //   236: ifeq -204 -> 32
    //   239: aload_0
    //   240: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   243: ifnull -211 -> 32
    //   246: aload_0
    //   247: getfield 159	amsx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   250: aload_0
    //   251: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   293: aload_0
    //   294: getfield 159	amsx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    ...
    //   345: athrow
    //   346: aload_0
    //   347: getfield 260	amsx:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   350: ldc_w 623
    ...
    //   363: ifnull +124 -> 487
    //   366: aload_0
    //   367: getfield 136	amsx:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   370: astore 5
    //   372: aload 5
    //   374: monitorenter
    //   375: aload_0
    //   376: getfield 139	amsx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   434: aload_0
    //   435: aload 7
    //   437: invokevirtual 757	amsx:a	(Lcom/tencent/mobileqq/DrawerPushItem;)Z
    //   440: ifne +31 -> 471
    //   443: aload_0
    //   444: getfield 139	amsx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   447: aload 7
    ...
    //   468: goto -253 -> 215
    //   471: aload_0
    //   472: getfield 260	amsx:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   475: aload 7
    ...
    //   486: monitorexit
    //   487: aload_0
    //   488: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   491: ifnull +61 -> 552
    //   494: aload_0
    //   495: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   549: putfield 2103	amsx:k	Ljava/lang/String;
    //   552: aload_0
    //   553: getfield 425	amsx:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   556: ifnonnull +32 -> 588
    //   559: aload_0
    //   560: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   563: ifnull +25 -> 588
    //   566: aload_0
    //   567: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   570: bipush 71
    //   572: invokevirtual 845	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lanud;
    //   575: checkcast 847	com/tencent/mobileqq/vas/VasExtensionHandler
    //   578: aload_0
    //   579: getfield 244	amsx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  public amsv a()
  {
    return this.jdField_a_of_type_Amsv;
  }
  ...
  public amtl a()
  {
    ...
    {
      if (this.jdField_a_of_type_Amtl == null) {
        this.jdField_a_of_type_Amtl = new amtl(this, null);
      }
      return this.jdField_a_of_type_Amtl;
    }
    finally {}
  }
  ...
  public amxf a()
  {
    return this.jdField_a_of_type_Amxf;
  }
  ...
  public amzq a()
  {
    try
    {
      if (this.jdField_a_of_type_Amzq == null) {
        this.jdField_a_of_type_Amzq = new amzq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      amzq localamzq = this.jdField_a_of_type_Amzq;
      return localamzq;
    }
    finally {}
  }
  ...
  public amzw a()
  {
    try
    {
      if (this.jdField_a_of_type_Amzw == null) {
        this.jdField_a_of_type_Amzw = new amzw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      amzw localamzw = this.jdField_a_of_type_Amzw;
      return localamzw;
    }
    finally {}
  }
  ...
  public anaj a()
  {
    if (this.jdField_a_of_type_Anaj == null) {
      this.jdField_a_of_type_Anaj = new anaj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Anaj;
  }
  
  public anje a()
  {
    if (this.jdField_a_of_type_Anje == null) {
      this.jdField_a_of_type_Anje = new amsz(this);
    }
    return this.jdField_a_of_type_Anje;
  }
  ...
  public bihz a()
  {
    ...
    return ((bihw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(3);
  }
  ...
  public DrawerPushItem a(String paramString1, String paramString2, JSONObject paramJSONObject, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label496:
      if (paramInt == 1) {
        localDrawerPushItem.ext_url = annv.T;
      } else if (paramInt == 2) {
  ...
  public ApolloActionData a(QQAppInterface paramQQAppInterface, String paramString, int... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      aniv.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), paramVarArgs);
  ...
  public String a()
  {
    if ((!this.f) && (!this.jdField_l_of_type_Boolean)) {
      return anzj.a(2131699380);
    }
    return anzj.a(2131699377);
  }
  ...
  public String a(int paramInt)
  {
    ...
    if (((annx)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() == 0) {
      ((annx)localObject1).a();
    }
    for (;;)
    {
      localObject2 = (String)((annx)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      ...
      return localObject1;
      if (TextUtils.isEmpty((CharSequence)((annx)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {
        ((annx)localObject1).a(paramInt);
      }
    }
  }
  ...
  public String a(int paramInt, String paramString)
  {
    ...
    for (paramInt = 2;; paramInt = 1)
    {
      ...
      for (;;)
      {
        ...
        if (bool)
        {
          ...
          if (i2 == 1)
          {
            ...
            if (a() != null)
            {
              ...
              {
                localObject2 = localObject1;
                if (!TextUtils.isEmpty(annv.ao))
                {
                  localObject2 = annv.ao;
        ...
        {
          paramString = (String)localObject2;
          if (annv.ao.equals(localObject2)) {
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (paramString2.jdField_a_of_type_JavaLangString != null) {
      paramQQAppInterface = blhn.a(paramString1, "facedata", paramString2.jdField_a_of_type_JavaLangString);
    }
    paramString1 = paramQQAppInterface;
    if (paramString2.a() != null) {
      paramString1 = blhn.a(paramQQAppInterface, "dressids", Arrays.toString(paramString2.a()).replaceAll(" ", ""));
    }
    return blhn.a(paramString1, "roleid", String.valueOf(paramString2.jdField_a_of_type_Int));
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    return a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, annv.ao, paramString);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (a() != null)
    {
      localObject = new bihu((List)localObject, localHashMap, "apollo_json_task" + System.currentTimeMillis());
      ((bihu)localObject).p = true;
      ((bihu)localObject).j = false;
      ((bihu)localObject).n = true;
      ((bihu)localObject).s = false;
      ((bihu)localObject).jdField_f_of_type_JavaLangString = "apollo_res";
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (localannx.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      localannx.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), paramString);
    }
  ...
  public void a(amth paramamth)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 2500	amsx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnonnull +17 -> 23
    //   9: aload_0
    ...
    //   20: putfield 2500	amsx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   23: aload_0
    //   24: getfield 2500	amsx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: astore_2
    //   28: aload_2
    //   29: monitorenter
    //   30: aload_0
    //   31: getfield 2500	amsx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   34: aload_1
  ...
  public void a(amtj paramamtj)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, new Object[] { "[setApolloStatusUpdateListener] listener=", paramamtj });
    }
    this.jdField_c_of_type_JavaUtilList.add(new WeakReference(paramamtj));
  }
  ...
  public void a(anpy paramanpy)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Anpo != null) {
        this.jdField_a_of_type_Anpo.a(paramanpy);
      }
      return;
    }
    finally
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 0) && (paramSessionInfo.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bhnv.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {}
    do
    {
      do
      {
  ...
  public void a(ApolloPreDownloadData paramApolloPreDownloadData, String paramString1, String paramString2)
  {
    ...
    paramString2 = (annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
  ...
  {
    if ((paramApolloActionData == null) && (!bhmi.a(ApolloUtil.a(paramApolloActionData, 7)))) {}
    while ((!a(bhmi.a(new File(ApolloUtil.a(paramApolloActionData, 7))), paramApolloActionData)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ((annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionData);
  }
  ...
  public void a(String paramString1, String paramString2, amtn paramamtn)
  {
    ...
    do
    {
      return;
      localbihz = a();
    } while ((localbihz == null) || (localbihz.a(paramString1) != null));
    File localFile = new File(paramString2);
    paramString2 = new bihu(paramString1, localFile);
    if (localFile.exists())
    {
    ...
    localbihz.a(paramString2, new amto(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramamtn), paramString1);
  }
  ...
  public void a(List<ApolloActionData> paramList, String paramString)
  {
    ...
    do
    {
      ...
      paramList = new bihu(localArrayList, localHashMap, paramString);
      paramList.n = true;
    ...
    a().a(paramList, this.jdField_b_of_type_Biht, localBundle);
  }
  ...
  public void a(List<String> paramList, Map<String, File> paramMap, List<ApolloActionData> paramList1, Bundle paramBundle)
  {
    ...
    if (i1 < paramList1.size())
    {
      ...
      localObject = new bihu(str1, new File((String)localObject));
      Bundle localBundle = new Bundle();
      localBundle.putSerializable(str1, localApolloActionData);
      ((bihu)localObject).c = str1;
      ((bihu)localObject).a(localBundle);
      this.jdField_b_of_type_Biht.onDoneFile((bihu)localObject);
    }
    for (;;)
    {
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ((localObject == null) || (((ApolloPreDownloadData)localObject).status == 0) || (localApolloPreDownloadData.version > ((ApolloPreDownloadData)localObject).version))
          {
            ...
            for (localObject = ApolloUtil.e(localApolloPreDownloadData.dirType) + localApolloPreDownloadData.zipDir;; localObject = annv.t + localApolloPreDownloadData.resId + ".zip")
            {
      ...
      paramMap = new bihu(localArrayList, localHashMap, "apollo_preDownload");
      paramMap.n = true;
    ...
    a().a(paramMap, this.jdField_c_of_type_Biht, localBundle);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) || (((paramInt & 0x1) == 1) && (!auog.a(ApolloUtil.jdField_a_of_type_JavaLangString))))
    {
      a(paramInt);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((TextUtils.isEmpty(paramArrayOfByte)) || (annu.a("8.4.5", paramArrayOfByte) >= 0)) {
          break label334;
        }
  ...
  public boolean a(ApolloActionData paramApolloActionData, int paramInt, anpy paramanpy)
  {
    if (paramApolloActionData == null) {}
    for (;;)
    {
      ...
      if ((paramInt & 0x1) == 1)
      {
        ...
        {
          localObject1 = new bihu((String)localObject1, new File((String)localObject2));
          ((bihu)localObject1).jdField_f_of_type_JavaLangString = "apollo_res";
          ((bihu)localObject1).jdField_b_of_type_Int = 1;
          ((bihu)localObject1).n = true;
          ((bihu)localObject1).q = true;
          ((bihu)localObject1).r = true;
          i1 = bihw.a((bihu)localObject1, a());
          if (i1 != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      if ((paramInt & 0x4) == 4)
      {
        ...
        {
          localObject2 = new bihu((String)localObject2, new File((String)localObject1));
          ((bihu)localObject2).jdField_f_of_type_JavaLangString = "apollo_res";
          ((bihu)localObject2).jdField_b_of_type_Int = 1;
          ((bihu)localObject2).n = true;
          ((bihu)localObject2).q = true;
          ((bihu)localObject2).r = true;
          paramInt = bihw.a((bihu)localObject2, a());
          if (paramInt != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        bhmi.a((String)localObject1, ApolloUtil.a(paramApolloActionData, 6), false);
      ...
      catch (Exception localException)
      {
        ...
        paramanpy.b(paramApolloActionData);
      }
    }
    return true;
  }
  ...
  public boolean a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    do
    {
      ...
      paramApolloActionPackage = new bihu(ApolloUtil.b(paramApolloActionPackage), new File(ApolloUtil.a(paramApolloActionPackage)));
      ...
      i1 = bihw.a(paramApolloActionPackage, a());
    } while (i1 != 0);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, "ret:" + i1);
    }
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bhsi.p(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label139;
      }
  ...
  void b(int paramInt1, int paramInt2)
  {
    if ((!ApolloUtil.a(paramInt1, paramInt2)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      aniv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, str);
    }
  }
  
  public void b(anpy paramanpy)
  {
    if ((paramanpy != null) && (this.jdField_a_of_type_Anpo != null)) {
      this.jdField_a_of_type_Anpo.b(paramanpy);
    }
  }
    ...
    if (paramApolloActionData != null)
    {
      ...
      if (((File)localObject).exists()) {
        try
        {
          ...
          {
            boolean bool = auog.c(ApolloUtil.a(paramApolloActionData, 6));
  ...
  public boolean b()
  {
    ...
    try
    {
      localObject1 = bhmi.b(new File(ApolloUtil.jdField_a_of_type_JavaLangString));
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          localObject3 = (annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
          ((annx)localObject3).a(false, localArrayList4);
          ((annx)localObject3).b();
          ((annx)localObject3).a(localArrayList1);
          ((annx)localObject3).b(1);
          ((annx)localObject3).c(localArrayList2);
          ((annx)localObject3).d();
          ((annx)localObject3).d(localArrayList3);
          ...
          this.jdField_a_of_type_Anpo.a(Boolean.valueOf(true));
          m();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          ...
          if (!((SharedPreferences)localObject3).getBoolean("8.4.5" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false)) {
            ((SharedPreferences)localObject3).edit().putBoolean("8.4.5" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true).commit();
          }
          if (localObject1 != null)
          {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((amsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).l();
        }
      }
      catch (Exception localException)
      {
  ...
  public boolean b(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    return auog.a(ApolloUtil.a(paramApolloActionPackage));
  }
  ...
  public void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bhsi.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label137;
      }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt1 & 0x1) != (paramInt2 & 0x1)) || ((paramInt1 & 0x2) != (paramInt2 & 0x2)))
    {
      ...
      if (this.jdField_c_of_type_JavaUtilList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          amtj localamtj = (amtj)((WeakReference)localIterator.next()).get();
          if (localamtj != null) {
            localamtj.a(paramInt1, bool);
          }
        }
      }
    }
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (annu.a("8.4.5", str1, (String)localObject2))
      {
  ...
  public void h()
  {
    ...
    {
      return;
      localapcx = (apcx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(115);
    } while ((localapcx == null) || (!localapcx.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()));
    QLog.w("ApolloManager", 1, "config is done, then request update");
    ArrayList localArrayList = new ArrayList();
    localapcx.b(localArrayList);
    localapcx.a(localArrayList);
    localapcx.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
  }
  
  public boolean h()
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_new_user_bar_showed" + anbd.a().getCurrentAccountUin(), false)) || (this.i)) {
      bool = true;
    }
    return bool;
  }
  ...
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_780_guide_showed" + anbd.a().getCurrentAccountUin(), false)) || (this.m)) {
      bool = true;
    }
    return bool;
  }
  ...
  public boolean k()
  {
    return this.jdField_a_of_type_Amzq != null;
  }
  ...
  public void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      ApolloActionData localApolloActionData = ((annx)localObject).a(1450);
      if (localApolloActionData != null) {
        b(localApolloActionData.actionId, localApolloActionData.personNum);
      }
      localObject = ((annx)localObject).a(1454);
      if (localObject != null) {
  ...
  public void m()
  {
    ...
    {
      Object localObject2 = (annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      localObject1 = ((annx)localObject2).d(400);
      if (((annx)localObject2).d(3000059) == null) {
        break label99;
      }
      if (localObject1 != null) {
        break label96;
  ...
  public void n()
  {
    ...
    localbnwo.jdField_a_of_type_Int = 364;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 365;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 366;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 367;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 393;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 433;
    localbnwo.jdField_b_of_type_Int = 20;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 501;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
    localbnwo = new bnwo();
    localbnwo.jdField_a_of_type_Int = 502;
    localbnwo.jdField_b_of_type_Int = 1;
    localArrayList.add(localbnwo);
  ...
  public void onDestroy()
  {
    ...
    try
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Amti);
      this.jdField_a_of_type_Amti = null;
      if (QLog.isColorLevel()) {
      ...
      aniv.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_Amtq.c();
          this.jdField_a_of_type_Amtq = null;
        }
        ApolloGameStateMachine.d();
        ApolloGameUtil.a();
        this.jdField_a_of_type_Amsv.b();
        amzf.a();
        annr.a();
        if (this.jdField_a_of_type_Anaj != null) {
          this.jdField_a_of_type_Anaj.b();
        }
        if (this.jdField_a_of_type_Amzw != null)
        {
          this.jdField_a_of_type_Amzw.e();
          this.jdField_a_of_type_Amzw = null;
        }
        if (this.jdField_a_of_type_Amzq != null)
        {
          this.jdField_a_of_type_Amzq.c();
          this.jdField_a_of_type_Amzq = null;
        }
        j();
        anav.a().a();
        andk localandk = anav.a().a();
        if (localandk != null) {
          localandk.a();
        }
        anmu.a().a();
