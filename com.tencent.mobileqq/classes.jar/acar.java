  ...
  extends BaseAdapter
{
  ...
  private final List<ahpl> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public acar(Context paramContext, CompoundButton.OnCheckedChangeListener paramOnCheckedChangeListener)
  {
  ...
  private void b(List<ahpl> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (i >= 0)
      {
        ...
        if (((localahpl == null) || (localahpl.jdField_a_of_type_Int == 1) || (localahpl.jdField_a_of_type_Int == 2)) && (localahpl != null)) {
          paramList.remove(localahpl);
        }
        i -= 1;
      }
    }
  ...
  public ahpl a(short paramShort)
  {
    int i = 0;
    while (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      if (((ahpl)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Short == paramShort) {
        return (ahpl)this.jdField_a_of_type_JavaUtilList.get(i);
      }
      i += 1;
    }
    return null;
  ...
  public void a(List<ahpl> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        if (i < paramArrayOfShort.length)
        {
          ...
          int m = ((ahpl)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_a_of_type_Short;
          if (k == m)
          {
            bool = true;
            i += 1;
  ...
  public Object getItem(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < getCount())) {
      return (ahpl)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return null;
  }
  ...
  {
    ahpl localahpl = (ahpl)getItem(paramInt);
    if (localahpl == null) {
      return 0L;
    }
    return localahpl.jdField_a_of_type_Int;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (!(paramView instanceof FormSwitchItem))
    {
      ...
      paramView = (ahpl)getItem(paramInt);
      if (paramView != null)
      {
        ...
        paramViewGroup.setSecendLineText(this.jdField_a_of_type_AndroidContentContext.getString(2131699467));
