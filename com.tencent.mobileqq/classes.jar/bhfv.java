  ...
  implements awhd
{
  ...
  private bjik jdField_a_of_type_Bjik = new bhfx(this);
  public bjin a;
  public GridView a;
  ...
  public bhfv(Context paramContext, GridView paramGridView, bhpp parambhpp, int paramInt, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_Bhga = new bhfw(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
    this.jdField_a_of_type_ComTencentWidgetGridView = paramGridView;
    this.jdField_a_of_type_Boolean = paramBoolean;
    if (paramBoolean) {}
    for (this.jdField_a_of_type_Bjin = ((bjin)bhfm.a(18));; this.jdField_a_of_type_Bjin = ((bjin)bhfm.a(3)))
    {
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bhpp != null)
      {
        ...
        jdField_a_of_type_JavaLangString = "";
        if ((ahhj.jdField_a_of_type_Int == 2) && (jdField_b_of_type_JavaLangString.equals("0")) && (jdField_b_of_type_Int == 0))
        {
          if (QLog.isColorLevel()) {
            QLog.d("QIMPtvTemplateManager", 2, "onDrawBeautyFeature is in back_camera && no template is selected");
          }
          this.jdField_a_of_type_Bhpp.b(0);
          this.jdField_a_of_type_Bhpp.c(-1);
        }
        if (QLog.isColorLevel()) {
          QLog.i("QIMPtvTemplateManager", 2, "setVideoFilter null");
        }
      }
      this.jdField_a_of_type_Bjin.a(113, null);
      if (this.jdField_a_of_type_Bhpp != null) {
        this.jdField_a_of_type_Bhpp.a(null);
      }
      this.jdField_a_of_type_Bjin.a(jdField_b_of_type_JavaLangString);
      return;
      i = this.e;
      if (i >= this.jdField_a_of_type_JavaUtilArrayList.size()) {
        break;
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.usable)
    {
      jdField_b_of_type_Int = paramPtvTemplateInfo.categoryId;
      jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.id;
      String str = bjin.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name;
      if (this.jdField_a_of_type_Bhpp != null)
      {
        if (QLog.isColorLevel()) {
        ...
        {
          this.jdField_a_of_type_Bhpp.a(str);
          str = "";
          this.jdField_a_of_type_Bhpp.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, str);
      ...
      {
        this.jdField_a_of_type_Bjin.a(paramPtvTemplateInfo, 111);
        this.jdField_a_of_type_Bjin.a(113, null);
        this.jdField_a_of_type_Bjin.a(jdField_b_of_type_JavaLangString);
      }
    }
    ...
    {
      if (!this.jdField_a_of_type_Boolean) {
        biyj.a("", "0X80075BA", this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id);
      }
      if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.kind == 3) && (!this.jdField_a_of_type_Boolean)) {
        biyj.a("", "0X80083B9", this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id);
      }
      urp.a((Activity)this.jdField_a_of_type_AndroidContentContext, "face_element", String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.categoryId), this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id);
      return;
      this.jdField_a_of_type_Bhpp.a(null);
      break;
      label578:
      ...
      break label440;
      if ((!this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.downloading) && (!TextUtils.isEmpty(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) && (this.jdField_a_of_type_Bjin != null)) {
        if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.kind == 3) && (badq.b(this.jdField_a_of_type_AndroidContentContext)))
        {
          if (this.jdField_a_of_type_Bafb == null) {
            this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(ajjy.a(2131644036)).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131632581)).setPositiveButton(this.jdField_a_of_type_AndroidContentContext.getString(2131629116), new bhfz(this)).setNegativeButton(this.jdField_a_of_type_AndroidContentContext.getString(2131625035), new bhfy(this));
          }
          try
          {
        ...
        else
        {
          ...
          bhpu.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo).a();
          bizx.a("shortvideo_download_effects", null);
        }
      }
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Bhga, jdField_b_of_type_Int, jdField_b_of_type_JavaLangString, jdField_b_of_type_Boolean);
      return paramView;
