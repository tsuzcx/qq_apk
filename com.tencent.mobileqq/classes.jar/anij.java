  ...
  extends KSAppChannel
{
  ...
  public boolean requestAppCmd(byte[] paramArrayOfByte, int paramInt, AVAppChannel.CsCmdCallback paramCsCmdCallback)
  {
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentTMGSdkAVContext$StartParam instanceof anhv))
      {
        bkjq.a().a(paramArrayOfByte, "", this.jdField_a_of_type_ComTencentTMGSdkAVContext$StartParam.identifier, this.jdField_a_of_type_ComTencentTMGSdkAVContext$StartParam.sdkAppId, ((anhv)this.jdField_a_of_type_ComTencentTMGSdkAVContext$StartParam).jdField_a_of_type_Int, ((anhv)this.jdField_a_of_type_ComTencentTMGSdkAVContext$StartParam).jdField_a_of_type_Long, new anik(this, paramArrayOfByte, paramCsCmdCallback));
        return true;
      }
      return false;
    }
