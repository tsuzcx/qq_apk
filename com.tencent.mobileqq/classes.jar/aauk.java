...
public class aauk
  extends ImageSpan
{
  public aauk(ChatSettingForTroop paramChatSettingForTroop, Drawable paramDrawable, int paramInt)
  {
  ...
  {
    paramCanvas.save();
    paramCanvas.translate(axlk.a(9.0F), 0.0F);
  ...
  {
    return getDrawable().getBounds().right + axlk.a(9.0F);
  }
}
