    ...
    for (;;)
    {
      try
      {
        ...
        if ("share".equals(paramJsBridgeListener.optString("type")))
        {
          ...
          bjgx.a().a(paramJsBridgeListener, "", this.mRuntime.a().getAccount(), false);
        }
        paramJsBridgeListener = this.mRuntime.a(this.mRuntime.a());
        if ((paramJsBridgeListener == null) || (!(paramJsBridgeListener instanceof bikd))) {
          break label747;
        }
        paramString1 = (bikd)paramJsBridgeListener;
        if (QLog.isColorLevel()) {
          QLog.d("ShareApiPlugin", 2, "Share JS deal cost=" + (System.currentTimeMillis() - paramString1.getLoadShareJsTime()));
        }
        if (!(paramJsBridgeListener instanceof biki)) {
          break label747;
        }
        paramJsBridgeListener = (biki)paramJsBridgeListener;
        ...
        if (paramString1.isNotNeedLoadShareJs(paramString2.a()))
        {
          if (QLog.isColorLevel()) {
        ...
        else if ((TextUtils.isEmpty(this.c)) || (TextUtils.isEmpty(this.b)) || (TextUtils.isEmpty(this.d)) || (TextUtils.isEmpty(this.a)) || (this.c.startsWith("http://")) || (this.c.startsWith("https://")))
        {
          ...
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), awco.class);
          ...
          paramString1.setObserver(new aasy(this, paramJsBridgeListener));
