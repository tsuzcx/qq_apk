  ...
  extends unf
{
  ...
  public vdr(qqstory_service.RspWatchVideoBatch paramRspWatchVideoBatch)
  {
    ...
    for (;;)
    {
      ...
      while (paramRspWatchVideoBatch.hasNext())
      {
        ...
        localuri.a = localVideoItem.vid.get().toStringUtf8();
        this.jdField_a_of_type_JavaUtilList.add(localuri);
      }
    }
  }
