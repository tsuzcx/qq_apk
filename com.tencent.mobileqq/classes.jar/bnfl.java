...
{
  public bnfl(bnff parambnff) {}
  
  protected List<LocalMediaInfo> a(Object... paramVarArgs)
  {
    PhotoCommonBaseData localPhotoCommonBaseData = this.a.jdField_a_of_type_Bnfu.a;
    ...
    bgnl.a();
    paramVarArgs = this.a.jdField_a_of_type_Bnfu.a();
    ...
    for (;;)
    {
      ...
      for (int j = ((Integer)QAlbumUtil.sLastAlbumPhotoCountMap.get(localPhotoCommonBaseData.albumId)).intValue();; j = 0)
      {
        ...
        {
          break;
          this.a.jdField_a_of_type_Bnfu.a(paramVarArgs);
          ...
          if (this.a.jdField_a_of_type_Bnfu.a())
          {
  ...
  {
    this.a.jdField_a_of_type_Bnfu.a(paramList);
  }
