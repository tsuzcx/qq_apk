...
public class bnfl
  extends RecyclerView.Adapter<bnfo>
{
  ...
  public bnfl(Context paramContext, int paramInt)
  {
  ...
  private boolean a()
  {
    bnaz localbnaz = AEFilterManagerHolder.getAEFilterManager();
    if (localbnaz == null) {
      return true;
    }
    return localbnaz.a;
  ...
  public bnfo a(ViewGroup paramViewGroup, int paramInt)
  {
    return new bnfo(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131558483, paramViewGroup, false));
  }
  ...
  public void a(bnfo parambnfo, int paramInt)
  {
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = bpjt.a().c(this.jdField_a_of_type_Int);
    ...
    for (boolean bool1 = TextUtils.equals(((QIMFilterCategoryItem)localObject2).a, localQIMFilterCategoryItem.a);; bool1 = false)
    {
      ...
      else
      {
        ...
        bnfo.a(parambnfo).setVisibility(0);
        label117:
      ...
      for (localObject1 = "https://qd.myapp.com/myapp/qqteam/QIM/fliters-QIM/other/none2.png";; localObject1 = ((QIMFilterCategoryItem)localObject1).d)
      {
        ...
        bnfo.b(parambnfo).setImageDrawable((Drawable)localObject1);
        bnfo.a(parambnfo).setText(localQIMFilterCategoryItem.b);
        if (this.jdField_a_of_type_Bnfn != null) {
          parambnfo.itemView.setOnClickListener(new bnfm(this, parambnfo));
        }
        parambnfo.itemView.setTag(localQIMFilterCategoryItem);
        EventCollector.getInstance().onRecyclerBindViewHolder(parambnfo, paramInt, getItemId(paramInt));
        return;
        bool2 = false;
        break;
        bnfo.a(parambnfo).setVisibility(8);
        break label117;
      }
    }
  }
