...
public class bbxz
{
  ...
  public bbxz(Activity paramActivity, JSONObject paramJSONObject, auuy paramauuy)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bbyc = new bbyc();
    }
    catch (IllegalArgumentException paramActivity)
    {
      for (;;)
      {
        ...
        {
          vxp.a("DIYProfileTemplate.ProfileTemplateBase default line color is illegal! " + paramJSONObject.optString("c"), new Object[0]);
          this.jdField_a_of_type_Int = -1;
        }
        paramActivity = paramActivity;
        vxp.a("DIYProfileTemplate.ProfileTemplateBase default main color is illegal! " + paramJSONObject.optString("c"), new Object[0]);
  ...
  private JSONObject a(Map<String, JSONObject> paramMap, String paramString)
  {
    ...
    if (localJSONObject == null) {
      ved.e("DIYProfileTemplate.ProfileTemplateBase", ":json illegal : it don't have " + paramString + " module");
    }
    try
    {
    ...
    {
      vxp.a("DIYProfileTemplate.ProfileTemplateBase:json error : it can not generate default " + paramString + " module", new Object[0]);
    }
    return null;
  }
  ...
  {
    paramView.measure(View.MeasureSpec.makeMeasureSpec(vzl.b(this.jdField_a_of_type_AndroidAppActivity) - vzl.a(this.jdField_a_of_type_AndroidAppActivity, 30.0F), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
  }
  ...
  protected int a(JSONObject paramJSONObject)
  {
    ...
    {
      vxp.a("DIYProfileTemplate.ProfileTemplateBase story line color is illegal module=" + paramJSONObject.optString("type") + " value=" + paramJSONObject.optString("line"), new Object[0]);
    }
    return i;
  }
  ...
  public View a(View paramView)
  {
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 15.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 15.0F);
    ((LinearLayout.LayoutParams)localObject).topMargin = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
    ((LinearLayout.LayoutParams)localObject).bottomMargin = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
  ...
  public View a(JSONObject paramJSONObject, View paramView)
  {
    ...
    a(paramJSONObject, paramView.findViewById(2131367679), (TextView)paramView.findViewById(2131377185), (ImageView)paramView.findViewById(2131367815));
    return paramView;
  }
  ...
  public View a(JSONObject paramJSONObject, View paramView1, View paramView2, View paramView3, View paramView4, View paramView5, View paramView6, View paramView7)
  {
    ...
    if (paramView1 == null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373087).setVisibility(8);
      label87:
      if (paramView4 != null) {
        break label556;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Auuy.b)
      {
  ...
  protected URLDrawable a(JSONObject paramJSONObject, int paramInt1, int paramInt2)
  {
    ...
    return a(paramJSONObject, new bbyb(paramInt1, paramInt2));
  }
  
  public ProfileCardFavorShowView a(Activity paramActivity)
  {
    return new ProfileCardFavorShowView(paramActivity, null, 2131561601);
  }
  ...
  public List<View> a(HashMap<String, View> paramHashMap, String[] paramArrayOfString)
  {
    ...
    {
      vxp.a("DIYProfileTemplate.ProfileTemplateBasethere is no module!", new Object[0]);
    ...
    if (i < ((JSONArray)localObject).length())
    {
      ...
      if (localJSONObject1 == null) {
        ved.e("DIYProfileTemplate.ProfileTemplateBase", "module array[" + i + "] is null");
      }
      for (;;)
      {
        i += 1;
    ...
    for (;;)
    {
      ...
      {
        vxp.a(bool, "makeModuleList error :" + paramArrayOfString[i] + " have a parent!");
        ...
        if (paramArrayOfString[i].equals("map_key_music_box"))
        {
          ...
          if (auxa.a(this.jdField_a_of_type_Auuy))
          {
            localObject = localJSONObject1;
  ...
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561608, null);
    ...
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373087);
    ((View)localObject).setBackgroundResource(2130839171);
  ...
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, auuy paramauuy)
  {
    ProfileCardFavorShowView localProfileCardFavorShowView = a(this.jdField_a_of_type_AndroidAppActivity);
    paramQQAppInterface = new PersonalityLabelBoard(this.jdField_a_of_type_AndroidAppActivity, paramQQAppInterface, paramauuy.a.jdField_a_of_type_JavaLangString, localProfileCardFavorShowView);
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof FriendProfileCardActivity)) {
      paramQQAppInterface.setScrollListener((auti)this.jdField_a_of_type_AndroidAppActivity);
    }
    localProfileCardFavorShowView.setTitle(ajya.a(2131708507));
  ...
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, auuy paramauuy, bcoq parambcoq)
  {
    paramQQAppInterface = new TemplatePhotoWall(this.jdField_a_of_type_AndroidAppActivity, paramQQAppInterface, paramauuy.a.jdField_a_of_type_JavaLangString, parambcoq);
    paramauuy = (ProfileCardDiyPhotoWallView)paramQQAppInterface.findViewById(2131371582).findViewById(2131371582);
    paramauuy.setMargin(vzl.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F));
    paramauuy.setBorderWidth(this.jdField_d_of_type_Int);
    paramauuy = a(this.jdField_a_of_type_AndroidAppActivity);
    paramauuy.setTitle(ajya.a(2131708508));
    paramauuy.setVisibility(8);
    paramauuy.addView(paramQQAppInterface);
    paramHashMap.put("map_key_photo_wall", paramauuy);
  }
  
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, auuy paramauuy, boolean paramBoolean)
  {
  ...
  {
    auxa localauxa = new auxa(true);
    paramCard = localauxa.a(this.jdField_a_of_type_AndroidAppActivity, paramCard.uin);
    localauxa.a(this.jdField_a_of_type_Auuy);
    paramCard.setTag(2131561620, localauxa);
  ...
  protected void a(JSONObject paramJSONObject, View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (paramJSONObject = "null module";; paramJSONObject = paramJSONObject.optString("type"))
    {
      ...
      ved.d("DIYProfileTemplate.ProfileTemplateBase", "setModuleBackground " + paramJSONObject + " ,but it is null.");
      return;
    ...
    if (paramView == null)
    {
      vxp.a("setModuleBackground cant find " + paramJSONObject + " view", new Object[0]);
      return;
    }
    try
    {
      URLDrawable localURLDrawable = a(str, new bbyb(paramInt1, paramInt2));
      paramView.setBackgroundDrawable(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new bbya(paramView));
      return;
    }
    catch (IllegalArgumentException paramView)
    {
      vxp.a("setModuleBackground " + paramJSONObject + " url illegal:" + str + " \ne:" + paramView, new Object[0]);
    }
  }
  ...
  public void a(JSONObject paramJSONObject, ProfileCardFavorShowView paramProfileCardFavorShowView)
  {
    ...
    for (;;)
    {
      a(paramJSONObject, paramProfileCardFavorShowView.findViewById(2131367679), (TextView)paramProfileCardFavorShowView.findViewById(2131377185), (ImageView)paramProfileCardFavorShowView.findViewById(2131367815));
      return;
  ...
  protected void a(JSONObject paramJSONObject, String paramString, View paramView)
  {
    ...
    {
      ved.d("DIYProfileTemplate.ProfileTemplateBase", "setBaseInfoIcon " + paramString + " icon,but it is null.");
      return;
    }
    if (paramView == null)
    {
      ved.e("DIYProfileTemplate.ProfileTemplateBase", "setBaseInfoIcon cant find " + paramString + " view");
      return;
    }
    try
    {
    ...
    {
      vxp.a("setBaseInfoIcon " + paramString + " url illegal:" + paramJSONObject + " \ne:" + paramView, new Object[0]);
    }
  }
  ...
  public View b(JSONObject paramJSONObject, View paramView)
  {
    ...
    localObject2 = (TextView)paramView.findViewById(2131377185);
    ...
    Object localObject3 = (TextView)paramView.findViewById(2131376320);
    ...
    localObject3 = paramView.findViewById(2131376460);
    ...
    ((TextView)paramView.findViewById(2131365669)).setTextColor(this.jdField_c_of_type_Int);
    localObject3 = (TextView)paramView.findViewById(2131376319);
    ((TextView)localObject3).setTextColor(this.jdField_c_of_type_Int);
    ...
    if (paramView.getTag(2131561620) != null) {
      ((auxa)paramView.getTag(2131561620)).a(this.jdField_a_of_type_Auuy);
    }
    return paramView;
  }
  ...
  {
    paramHashMap.put("map_key_qzone", this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561609, null));
  }
  ...
  public View c(JSONObject paramJSONObject, View paramView)
  {
    ...
    do
    {
      ...
      a(paramJSONObject, ((ProfileCardFavorShowView)localObject).findViewById(2131367679), (TextView)((ProfileCardFavorShowView)localObject).findViewById(2131377185), (ImageView)((ProfileCardFavorShowView)localObject).findViewById(2131367815));
  ...
  public View d(JSONObject paramJSONObject, View paramView)
  {
    ...
    try
    {
      ...
      if (localProfileCardFavorShowView.b() > 0)
      {
        ...
        localView.measure(View.MeasureSpec.makeMeasureSpec(vzl.b(this.jdField_a_of_type_AndroidAppActivity) - vzl.a(this.jdField_a_of_type_AndroidAppActivity, 78.0F), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
        a(paramJSONObject, localProfileCardFavorShowView.a(), localView.getMeasuredWidth(), localView.getMeasuredHeight());
        a(paramJSONObject, localProfileCardFavorShowView.findViewById(2131367679), (TextView)localProfileCardFavorShowView.findViewById(2131377185), (ImageView)localProfileCardFavorShowView.findViewById(2131367815));
        return paramView;
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ved.e("DIYProfileTemplate.ProfileTemplateBase", "getTagView error personalityLabelBoard is null");
        continue;
