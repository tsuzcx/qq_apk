...
public class avra
  extends RecyclerView.Adapter<FontBubblePanelView<T>.avrb>
{
  public avra(FontBubblePanelView paramFontBubblePanelView) {}
  
  public FontBubblePanelView<T>.avrb a(ViewGroup paramViewGroup, int paramInt)
  {
    paramViewGroup = LayoutInflater.from(this.a.getContext()).inflate(2131563094, paramViewGroup, false);
    return new avrb(this.a, paramViewGroup);
  }
  
  public void a(FontBubblePanelView<T>.avrb paramFontBubblePanelView, int paramInt)
  {
