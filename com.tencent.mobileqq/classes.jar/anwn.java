...
public class anwn
  extends alpd
{
  public anwn(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void a(List<String> paramList, alpg paramalpg)
  {
    ...
    do
    {
      ...
      localBubble_Req_Comm.mqqver.set("8.3.5");
    ...
    paramalpg = super.createToServiceMsg("bubble.1", paramalpg);
    paramalpg.putWupBuffer(paramList.toByteArray());
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd_0x01.has()) && (paramFromServiceMsg.rspcmd_0x01.user_text_info.has()))
          {
            ...
            anwm.a().a(this.app, true, paramFromServiceMsg);
