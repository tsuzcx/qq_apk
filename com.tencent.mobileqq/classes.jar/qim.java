  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private ont jdField_a_of_type_Ont = new qiu(this);
  ...
  public qim(Activity paramActivity)
  {
  ...
  {
    Object localObject = (StructMsgForGeneralShare)awuw.a(paramBundle.getByteArray("STRUCT_MSG_BYTES"));
    if ((!TextUtils.isEmpty(((StructMsgForGeneralShare)localObject).mMsgBrief)) && (((StructMsgForGeneralShare)localObject).mMsgBrief.indexOf(ajjy.a(2131650581)) == -1)) {
      ((StructMsgForGeneralShare)localObject).mMsgBrief = (ajjy.a(2131650576) + ((StructMsgForGeneralShare)localObject).mMsgBrief);
    }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    aphp.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, 21);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localObject[1] = ajjy.a(2131650595);
    localObject[2] = ajjy.a(2131650593);
    localObject[3] = ajjy.a(2131650590);
    localObject[4] = ajjy.a(2131650566);
    localObject[5] = ajjy.a(2131650586);
    localObject[6] = ajjy.a(2131650594);
    localObject[7] = ajjy.a(2131650597);
    localObject[8] = ajjy.a(2131650601);
    ...
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      ...
      bbmy.a(this.jdField_a_of_type_AndroidContentContext, 0, 2131653595, 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766));
    }
    for (;;)
    {
      return;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Rug == null) {
      this.jdField_a_of_type_Rug = new rug(this.jdField_a_of_type_AndroidAppActivity, a(), new qiv(this), new qiw(this));
    }
    this.jdField_a_of_type_Rug.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Rug.a.a(new qin(this));
    this.jdField_a_of_type_Rug.a.a(new qio(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new qit(this));
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, Bundle paramBundle, qhp paramqhp, qix paramqix, int paramInt)
  {
    a(paramBaseArticleInfo, paramBundle, paramqhp, paramqix, paramInt, true);
  }
  
  public void a(BaseArticleInfo paramBaseArticleInfo, Bundle paramBundle, qhp paramqhp, qix paramqix, int paramInt, boolean paramBoolean)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo = paramBaseArticleInfo;
    this.jdField_a_of_type_Qix = paramqix;
    ...
    this.jdField_a_of_type_Mzv = ((mzv)a().a(136));
    this.jdField_a_of_type_Mzv.a();
  }
  
  public void a(qoe paramqoe)
  {
  ...
  public boolean a(int paramInt)
  {
    ...
    Object localObject3 = this.jdField_a_of_type_Mzv.a();
    ...
    if (paramInt == 1)
    {
      ...
      i = 3;
      localObject3 = new qmv(null, localBaseArticleInfo.mSubscribeID, localBaseArticleInfo.mVideoVid, String.valueOf(localBaseArticleInfo.innerUniqueID), this.jdField_a_of_type_Qhp.a(), localBaseArticleInfo.mVideoDuration * 1000).e(localBaseArticleInfo.mAlgorithmID).c(localBaseArticleInfo.mStrategyId).a(this.jdField_b_of_type_Int).a().a();
      if ((paramInt != 14) && (paramInt != 20) && (paramInt != 12))
      {
        ...
        ((pqh)localObject1).d = ((int)this.jdField_a_of_type_Qhp.a());
        ((pqh)localObject1).e = (localBaseArticleInfo.getVideoDuration() * 1000);
        if (l != 0L) {
          break label2147;
        }
        paramInt = 1;
        ((pqh)localObject1).c = paramInt;
        new.a(localBaseArticleInfo, this.jdField_b_of_type_Int, 26, -1L, (pqh)localObject1);
      }
    ...
    for (localObject1 = localBaseArticleInfo.innerUniqueID;; str1 = "0")
    {
      for (;;)
      {
        ...
        for (;;)
        {
          for (;;)
          {
            ndn.a(null, (String)localObject5, "0X800740F", "0X800740F", 0, 0, "1", (String)localObject6, (String)localObject1, (String)localObject3, false);
            return true;
            if (paramInt == 13)
            {
              this.jdField_a_of_type_Rug.d((String)localObject5 + "&sourcefrom=6");
              i = 3;
              break;
            }
            if (paramInt == 14)
            {
              this.jdField_a_of_type_Rug.c((String)localObject5 + "&sourcefrom=6");
              i = 3;
              break;
            }
            if (paramInt == 20)
          ...
          if (paramInt == 7)
          {
            this.jdField_a_of_type_Rug.a((String)localObject5 + "&sourcefrom=6");
            i = 3;
            break;
          }
          if (paramInt == 8)
          {
            ...
            ((Intent)localObject1).putExtra("big_brother_source_key", obz.f(0));
        ...
        if (paramInt == 3)
        {
          ...
          for (localObject2 = null;; localObject2 = localBaseArticleInfo.getVideoCoverURL().getFile())
          {
            ...
            bfqn.a(a(), this.jdField_a_of_type_AndroidAppActivity, (Bundle)localObject4, null);
            i = 1;
            break;
          }
        }
        ...
        if (paramInt == 12)
        {
          ...
          {
            bbmy.a(this.jdField_a_of_type_AndroidContentContext, 0, ajjy.a(2131650575), 0).a();
            return true;
          }
          qcn.a(a(), this.jdField_a_of_type_AndroidAppActivity);
          int j = 6;
          localObject5 = (String)localObject5 + "&sourcefrom=6";
          localObject2 = qcn.a(localBaseArticleInfo);
          localObject4 = qcn.a(localBaseArticleInfo);
          ...
          {
            ((onp)localObject7).a(localActivity, (String)localObject2, 2, str2, str3, str4, (String)localObject4, (String)localObject5, (Bundle)localObject6);
        ...
        if ((paramInt == 4) || (paramInt == 5))
        {
          ...
          if (paramInt == 4)
          {
            ...
            if (localBaseArticleInfo.mVideoPlayCount > 0) {
              ((StringBuilder)localObject6).append(qcn.b(localBaseArticleInfo.mVideoPlayCount)).append(" ");
            }
          ...
          {
            nex.a((BaseActivity)localObject4, (String)localObject5, (String)localObject6, (String)localObject2, (Bitmap)localObject7, bool, localBaseArticleInfo.innerUniqueID, null);
            break;
        ...
        if (paramInt == 15)
        {
          ...
          try
          {
            ...
            if ((localBaseArticleInfo.mDislikeInfos != null) && (localBaseArticleInfo.mDislikeInfos.size() > 0))
            {
              ...
              localObject4 = new qip(this);
              this.jdField_a_of_type_Begr.a((begz)localObject4);
              localObject4 = new ReadInJoyDisLikeDialogView(this.jdField_a_of_type_AndroidContentContext);
              ((ReadInJoyDisLikeDialogView)localObject4).setOnUninterestConfirmListener(new qiq(this, localBaseArticleInfo, (JSONObject)localObject2));
              ((ReadInJoyDisLikeDialogView)localObject4).setUninterestData(localBaseArticleInfo.mDislikeInfos);
              this.jdField_a_of_type_Begr.a((View)localObject4, null);
              try
              {
                if (!this.jdField_a_of_type_Begr.isShowing())
                {
                  if ((befo.g()) && (!ShortVideoUtils.c()))
                  {
                    ...
                    this.jdField_a_of_type_Begr.setOnShowListener(new qis(this));
                  }
                  this.jdField_a_of_type_Begr.show();
                  ndn.b(null, null, "0X800913B", "0X800913B", 0, 0, null, null, null, new qmv(new.a(null, null, null, null, (JSONObject)localObject2)).h(localBaseArticleInfo.innerUniqueID).a().a(), false);
                }
              }
              catch (Exception localException)
              {
      ...
      if (paramInt == 24)
      {
        if (localBaseArticleInfo.busiType == 6)
        {
          ...
          str1 = obb.g + baaw.encodeToString(localBaseArticleInfo.getSubscribeUin().getBytes(), 2);
        ...
        {
          str1 = obb.k + baaw.encodeToString(localBaseArticleInfo.getSubscribeUin().getBytes(), 2);
          obz.a(this.jdField_a_of_type_AndroidContentContext, str1);
        }
      }
      i = 3;
