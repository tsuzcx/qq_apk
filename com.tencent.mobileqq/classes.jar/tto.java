  ...
  implements View.OnClickListener
{
  ...
  teq jdField_a_of_type_Teq;
  boolean jdField_a_of_type_Boolean;
  
  public tto(@NonNull Context paramContext, String paramString, int paramInt, teq paramteq, boolean paramBoolean)
  {
    super(paramContext, 16973841);
    super.requestWindowFeature(1);
    super.setContentView(LayoutInflater.from(paramContext).inflate(2131561436, null));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopManager = ((TroopManager)tsr.a().getManager(52));
    this.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  void a()
  {
    ((ElasticImageView)findViewById(2131364274)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)findViewById(2131379182));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView = ((LeftTabBarView)findViewById(2131376793));
    ...
    int i;
    if ((this.jdField_a_of_type_Teq != null) && (this.jdField_a_of_type_Boolean))
    {
      if ((this.jdField_a_of_type_Teq.a != null) && (!this.jdField_a_of_type_Teq.a.isEmpty()))
      {
        ArrayList localArrayList2 = new ArrayList(this.jdField_a_of_type_Teq.a.size());
        Iterator localIterator = this.jdField_a_of_type_Teq.a.iterator();
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView.setOnTabChangeListener(new ttp(this));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setAdapter(new ttr(this, localArrayList1));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new ttq(this));
    ...
    for (;;)
    {
      vei.a("pub_control", "exp_list", 0, 0, new String[] { String.valueOf(i), "", "", this.jdField_a_of_type_JavaLangString });
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoMyVideoVisiblePersonPageView = new MyVideoVisiblePersonPageView(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      break;
      label438:
