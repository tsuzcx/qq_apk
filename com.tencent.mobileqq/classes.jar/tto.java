...
import com.tencent.biz.pubaccount.readinjoy.viola.ViolaAccessHelper.1;
import com.tencent.biz.pubaccount.readinjoy.viola.ViolaAccessHelper.4;
import com.tencent.biz.pubaccount.readinjoy.viola.ViolaAccessHelper.7;
...
public class tto
{
  ...
  private static final String jdField_b_of_type_JavaLangString = "QQ/8.4.10 Android/0.17 Android/" + Build.VERSION.RELEASE;
  ...
  private static Intent a(Context paramContext, String paramString1, Bundle paramBundle, boolean paramBoolean, String paramString2)
  {
    ...
    if (a(paramBundle))
    {
      ...
      localIntent.putExtra(tvg.jdField_a_of_type_JavaLangString, paramString1);
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          Object localObject2 = biio.a(paramString);
          if ((localObject2 != null) && (!TextUtils.isEmpty(((biip)localObject2).jdField_b_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ViolaAccessHelper", 2, "load offline想 data cache on loadRes");
            }
            return ((biip)localObject2).jdField_b_of_type_JavaLangString;
          }
          try
          {
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              localObject2 = nvf.a((String)localObject1);
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
  ...
  public static void a()
  {
    ...
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_JavaLangString = pkh.a();
    }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      ...
      if (paramInt == 2)
      {
        ...
        ssn.a(paramContext, (Intent)localObject, str);
        return;
      }
      break;
    case 2: 
    ...
    for (;;)
    {
      try
      {
        ((JSONObject)localObject).put("autoPlayDisable", bmhv.i());
        i = j;
      }
      catch (JSONException localJSONException)
      {
  ...
  @Deprecated
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, ttx paramttx)
  {
    if (!a(paramContext)) {
      if (paramttx != null) {
        paramttx.a();
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if ((paramString2.contains("v_present=2")) || (paramString2.contains("v_present=1")) || (paramString2.contains("v_push_animated_disable=1")))
    {
      ...
      if ((paramBundle != null) && (paramBundle.containsKey("requestCode")) && ((paramContext instanceof Activity))) {
        aeow.a((Activity)paramContext, paramString1, PublicTransFragmentActivity.class, ViolaFragment.class, paramBundle.getInt("requestCode", -1));
      }
      for (;;)
      {
        ...
        return;
        aeow.a(paramContext, paramString1, PublicTransFragmentActivity.class, ViolaFragment.class);
      }
    }
    if ((paramBundle != null) && (paramBundle.containsKey("requestCode")) && ((paramContext instanceof Activity)))
    {
  ...
  public static void a(Context paramContext, String paramString, ttx paramttx) {}
  ...
  /* Error */
  public static void a(com.tencent.common.app.AppInterface paramAppInterface, String paramString, tut paramtut, ttv paramttv)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 699	com/tencent/viola/core/ViolaSDKEngine:isInitialized	()Z
    //   6: ifne +98 -> 104
    //   9: new 825	com/tencent/viola/core/InitConfig$Builder
    //   12: dup
    //   13: invokespecial 826	com/tencent/viola/core/InitConfig$Builder:<init>	()V
    //   16: iconst_1
    //   17: invokevirtual 830	com/tencent/viola/core/InitConfig$Builder:setBusinessId	(I)Lcom/tencent/viola/core/InitConfig$Builder;
    //   20: aload_1
    //   21: invokevirtual 834	com/tencent/viola/core/InitConfig$Builder:setFramework	(Ljava/lang/String;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   24: new 836	tum
    //   27: dup
    //   28: invokespecial 837	tum:<init>	()V
    //   31: invokevirtual 841	com/tencent/viola/core/InitConfig$Builder:setHttpAdapter	(Lcom/tencent/viola/adapter/IHttpAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   34: new 843	tuv
    //   37: dup
    //   38: invokespecial 844	tuv:<init>	()V
    //   41: invokevirtual 848	com/tencent/viola/core/InitConfig$Builder:setComponentAdapter	(Lcom/tencent/viola/adapter/VComponentAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   44: aload_2
    //   45: invokevirtual 852	com/tencent/viola/core/InitConfig$Builder:setReportDelegate	(Lcom/tencent/viola/commons/IReportDelegate;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   48: new 854	tus
    //   51: dup
    //   52: invokespecial 855	tus:<init>	()V
    //   55: invokevirtual 859	com/tencent/viola/core/InitConfig$Builder:setLogAdapter	(Lcom/tencent/viola/adapter/ILogAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   58: astore 5
    //   60: aload_0
    //   61: ifnull +37 -> 98
    //   64: aload_0
    //   65: invokevirtual 865	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   68: astore 4
    //   70: aload 4
    //   72: aload 5
    //   74: invokevirtual 869	com/tencent/viola/core/InitConfig$Builder:build	()Lcom/tencent/viola/core/InitConfig;
    //   77: new 871	tts
    //   80: dup
    //   81: aload_0
    //   82: aload_3
    //   83: aload_2
    //   84: aload_1
    //   85: invokespecial 874	tts:<init>	(Lcom/tencent/common/app/AppInterface;Lttv;Ltut;Ljava/lang/String;)V
    //   88: invokestatic 875	tzr:a	()Ljava/lang/String;
    //   91: invokestatic 879	com/tencent/viola/core/ViolaSDKEngine:initialize	(Landroid/app/Application;Lcom/tencent/viola/core/InitConfig;Lcom/tencent/viola/core/ViolaSDKEngine$InitCallback;Ljava/lang/String;)V
    //   94: ldc 2
    //   96: monitorexit
    //   97: return
    //   98: aconst_null
    ...
    //   107: ldc_w 883
    //   110: iconst_0
    //   111: invokestatic 887	com/tencent/viola/core/ViolaSDKEngine:registerModule	(Ljava/lang/String;Ljava/lang/Class;Z)Z
    //   114: pop
    //   115: aload_3
    //   116: ifnull -22 -> 94
    //   119: new 889	android/os/Handler
    //   122: dup
    //   123: invokestatic 895	android/os/Looper:getMainLooper	()Landroid/os/Looper;
    //   126: invokespecial 898	android/os/Handler:<init>	(Landroid/os/Looper;)V
    //   129: new 900	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$6
    //   132: dup
    //   133: aload_3
    //   134: invokespecial 903	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$6:<init>	(Lttv;)V
    //   137: invokevirtual 906	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   140: pop
    //   141: goto -47 -> 94
    //   144: astore_0
    //   145: invokestatic 541	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   148: ifeq -54 -> 94
    //   151: ldc_w 431
    //   154: iconst_2
    //   155: new 16	java/lang/StringBuilder
    //   158: dup
    //   159: invokespecial 19	java/lang/StringBuilder:<init>	()V
    //   162: ldc_w 908
    //   165: invokevirtual 25	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: aload_0
    //   169: invokevirtual 434	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   172: invokevirtual 25	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   175: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   178: invokestatic 671	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   181: goto -87 -> 94
    //   184: astore_0
    //   185: ldc 2
    //   187: monitorexit
    ...
    //   0	190	2	paramtut	tut
    //   0	190	3	paramttv	ttv
  ...
  {
    bmhv.a("KEY_SP_CHANNEL_FOLLOW_URL", paramString);
  }
  ...
  private static void a(String paramString, JSONObject paramJSONObject, Context paramContext)
  {
    ...
    try
    {
      bool = plw.a(paramString.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(paramString.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(paramString.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(paramString.getString("VIDEO_TIME")).intValue());
      if (bool)
      {
        paramJSONObject = new Intent();
        paramJSONObject.putExtras(paramString);
        ssn.a(paramContext, paramJSONObject);
        return;
      }
    }
    catch (Exception localException)
  ...
  @Deprecated
  public static void a(String paramString, ttv paramttv)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)pkh.a();
    if ((localQQAppInterface == null) && (paramttv != null))
    {
      paramttv.a();
      return;
    }
    a(localQQAppInterface, paramString, null, paramttv);
  }
  
  public static void a(String paramString, ttw paramttw)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)pkh.a();
    ...
    ThreadManager.post(new ViolaAccessHelper.4(paramString, localQQAppInterface, paramttw, System.currentTimeMillis()), 8, null, true);
  }
  
  public static void a(String paramString, ucm paramucm)
  {
    ThreadManager.post(new ViolaAccessHelper.7(paramString, paramucm), 8, null, false);
  }
  ...
  private static boolean a(Context paramContext)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            a(paramContext, anvx.a(2131715827));
          } while (!QLog.isColorLevel());
          ...
          a(paramContext, anvx.a(2131715829));
        } while (!QLog.isColorLevel());
        QLog.d("ViolaAccessHelper", 2, "isViolaPermit checkSO is false");
        return false;
        str = tzr.b("https://kd.qpic.cn/viola/lib/viola.js?v_bid=3547");
        if (!TextUtils.isEmpty(str)) {
          break;
        }
      ...
      a(paramContext, anvx.a(2131715828));
      if (QLog.isColorLevel()) {
  ...
  {
    a("https://sqimg.qq.com/qq_product_operations/kan/viola_config/viola_config.json?v_bid=3192", new ttu());
  }
  ...
  private static void b(Context paramContext, JSONObject paramJSONObject)
  {
    ...
    try
    {
      bool = plw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
      if (bool)
      {
        paramJSONObject = new Intent();
  ...
  {
    if ((System.currentTimeMillis() - jdField_a_of_type_Long >= 18000000L) || ((!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) && (!jdField_a_of_type_JavaLangString.equals(pkh.a()))))
    {
      if (QLog.isColorLevel()) {
