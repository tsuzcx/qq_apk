  ...
  extends MSFServlet
{
  ...
  private void a(Intent paramIntent, int paramInt, byte[] paramArrayOfByte1, byte[] arg4)
  {
    ...
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (asfl.b()) {
          asfl.a("NearbyAlumniServlet", new Object[] { "respGetNearbyAlumni", Integer.valueOf(i), paramArrayOfByte1 });
        }
        if ((paramArrayOfByte1 instanceof xbe)) {
          paramArrayOfByte1 = (xbe)paramArrayOfByte1;
        }
      }
      try
      {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() != 0))
      {
        ...
        if ((localObject3 != null) && (((List)localObject3).size() != 0))
        {
          ...
          if (localObject3 != null) {
            ((asfp)localObject3).a(paramFromServiceMsg, (byte[])localObject1, (String[])localObject2);
          }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString1, Object paramObject, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      paramObject = new NewIntent(paramAppInterface.getApplication(), ascw.class);
  ...
  protected asfp a()
  {
    ...
    if ((localAppRuntime instanceof NearbyAppInterface)) {
      return (asfp)localAppRuntime.getManager(217);
    }
  ...
  protected void a(Intent paramIntent, Packet paramPacket, boolean paramBoolean)
  {
    ...
    if (asfl.b()) {
      asfl.a("NearbyAlumniServlet", new Object[] { "reqBigData", Integer.valueOf(i), Long.valueOf(l) });
    }
    ...
    do
    {
      do
      {
        ...
        while (localObject1 == null) {
          if (paramBoolean)
          {
            a(null, -1, null, null);
            return;
            localObject1 = ((asfp)localObject3).a();
          }
          else
          {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (localObject3 == null)
            {
              ...
              a(null, -1, null, null);
              return;
              localObject2 = ((asfp)localObject3).b();
              continue;
              if (paramBoolean)
              {
                a(null, -1, null, null);
        ...
        paramPacket = new axro();
        paramPacket.jdField_a_of_type_ArrayOfByte = ((byte[])localObject3);
        paramPacket.jdField_a_of_type_Axrt = new ascx(this, paramIntent, (byte[])localObject1);
      ...
      ((axrr)localObject1).a(paramPacket);
    } while (!asfl.b());
    asfl.a("NearbyAlumniServlet", new Object[] { "getBigData", localObject1, paramIntent });
  }
