...
public final class aclu
{
  ...
  private ArkAppMgr.IGetAppPathByNameCallback jdField_a_of_type_ComTencentArkOpenArkAppMgr$IGetAppPathByNameCallback = new aclv(this);
  private WeakReference<aclw> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  
  public aclu(WeakReference<aclw> paramWeakReference, aclt paramaclt, long paramLong)
  {
  ...
  private String a()
  {
    String str = null;
    if (a()) {
      str = ArkAppMgr.getInstance().getAppPathByNameFromLocal(this.jdField_a_of_type_Aclt.a, "", null, false);
    }
    acqy.b("GdtArkPreDownloadTask", String.format("getPath %s", new Object[] { str }));
    return str;
  }
  ...
  private boolean a()
  {
    return (this.jdField_a_of_type_Aclt != null) && (this.jdField_a_of_type_Aclt.a());
  }
  ...
  private static boolean a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      do
      {
        acqy.d("GdtArkPreDownloadTask", String.format("checkStatus result:false oldStatus:%d newStatus:%d", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
        return false;
      } while (paramInt1 != 2);
      if (paramInt2 == 3) {
        break;
  ...
  private void b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 23	aclu:jdField_a_of_type_Int	I
    //   4: istore_2
    //   5: iload_2
    //   6: iload_1
    //   7: if_icmpeq +30 -> 37
    ...
    //   17: iload_2
    //   18: iload_1
    //   19: invokestatic 143	aclu:a	(II)Z
    //   22: ifeq +54 -> 76
    //   25: aload_0
    //   26: iload_1
    //   27: putfield 23	aclu:jdField_a_of_type_Int	I
    //   30: aload_0
    //   31: iload_1
    //   32: invokespecial 145	aclu:a	(I)V
    //   35: aload_0
    //   36: monitorexit
    //   37: ldc 66
    //   39: ldc 147
    ...
    //   60: iconst_2
    //   61: aload_0
    //   62: getfield 23	aclu:jdField_a_of_type_Int	I
    ...
    //   72: invokestatic 80	acqy:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   75: return
    //   76: aload_0
    //   77: iconst_1
    //   78: ldc 148
    //   80: lconst_0
    //   81: invokespecial 121	aclu:a	(IIJ)V
    //   84: goto -49 -> 35
    //   87: astore_3
    //   88: aload_0
    //   89: monitorexit
