  ...
  extends BaseAdapter
{
  ...
  private axod jdField_a_of_type_Axod;
  private List<ShareActionSheetBuilder.ActionSheetItem> jdField_a_of_type_JavaUtilList;
  
  public axoc(Context paramContext, List<ShareActionSheetBuilder.ActionSheetItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Axod == null) {
      this.jdField_a_of_type_Axod = new axod(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(axoa.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.label, 6));
    paramInt = -8947849;
    ...
    if (paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable)
    {
      ...
      localObject = this.jdField_a_of_type_Axod.a((Drawable)localObject, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label421;
      }
      Drawable localDrawable = axod.a(this.jdField_a_of_type_Axod, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Axod.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label294;
      label421:
      localObject = axod.b(this.jdField_a_of_type_Axod, (Drawable)localObject);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    }
    label444:
