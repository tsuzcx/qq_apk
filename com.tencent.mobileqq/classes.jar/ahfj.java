...
{
  public ahfj(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private View a(Context paramContext, View paramView, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt, boolean paramBoolean, View.OnClickListener paramOnClickListener)
  {
    ...
    for (;;)
    {
      ...
      localTextView.setId(2131364407);
      if (!TextUtils.isEmpty(paramString2))
      {
        Drawable localDrawable = localResources.getDrawable(2130850449);
        localDrawable.setBounds(0, 0, afur.a(12.0F, localResources), afur.a(12.0F, localResources));
        paramString1 = localResources.getDrawable(2130850450);
        paramString1.setBounds(0, 0, afur.a(12.0F, localResources), afur.a(12.0F, localResources));
        try
        {
        ...
        paramContext.setBounds(0, 0, afur.a(12.0F, localResources), afur.a(12.0F, localResources));
  ...
  public View a(QQAppInterface paramQQAppInterface, BaseChatItemLayout paramBaseChatItemLayout, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener)
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)paramBaseChatItemLayout.findViewById(2131377927);
    audn localaudn = ((FlashChatManager)paramQQAppInterface.getManager(217)).a;
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(localaudn.b)) && (bool) && ("1".equals(str))) {
        break;
      }
    } while (localRelativeLayout == null);
    paramBaseChatItemLayout.removeView(localRelativeLayout);
    return paramBaseChatItemLayout;
    bcst.b(paramQQAppInterface, "dc00898", "", "", "0X8008279", "0X8008279", i, 0, "", "", "", "");
    a(paramBaseChatItemLayout, paramMessageRecord, paramOnClickListener, paramSessionInfo, localRelativeLayout, localaudn.b, localaudn.d, -1, true);
    return paramBaseChatItemLayout;
  }
  ...
  protected void a(BaseChatItemLayout paramBaseChatItemLayout, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener, Context paramContext, RelativeLayout paramRelativeLayout, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    if (paramRelativeLayout == null)
    {
      ...
      paramRelativeLayout.setId(2131377927);
    }
    for (int i = 1;; i = 0)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject1).topMargin = afur.a(-2.0F, (Resources)localObject2);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = afur.a(0.0F, (Resources)localObject2);
      ...
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (afur.a(18.0F, (Resources)localObject2) + j);
        ((RelativeLayout.LayoutParams)localObject1).addRule(1, 0);
        ((RelativeLayout.LayoutParams)localObject1).addRule(7, 2131364388);
      ...
      for (;;)
      {
        ...
        return;
        j = ((RelativeLayout.LayoutParams)localObject1).leftMargin;
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (afur.a(9.0F, (Resources)localObject2) + j);
        ((RelativeLayout.LayoutParams)localObject1).addRule(7, 2131364379);
        break;
        label248:
