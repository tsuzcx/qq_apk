  ...
  implements bahf
{
  ...
  public ahfj(MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  public static void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if (paramMessageRecord != null)
    {
      ...
      ahiy.a(paramQQAppInterface, paramMessageRecord);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    if (bool)
    {
      ((bagr)paramQQAppInterface.getManager(223)).a(new ahfj(paramMessageForQQWalletMsg), false);
      return true;
    }
    return false;
  }
  ...
  public static boolean a(Object paramObject, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((i == 7) || (i == 8) || (i == 11) || (i == 12))
    {
      ...
      if ((!ahdd.a().a()) && (!paramQQAppInterface.c().equals(paramObject.senderuin)))
      {
  ...
  public void a(BaseChatPie paramBaseChatPie, aycb paramaycb)
  {
    ahiy.a(ahiy.a(), "212", "only.animation.show");
    String str = ahfh.a() + this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.body.feedId + ".zip";
    ...
    paramaycb = new ahfk(this, paramaycb);
    this.jdField_a_of_type_JavaLangRunnable = new SpecifyRedPacketAnimMsg.2(this, paramaycb);
    ThreadManager.getUIHandler().postDelayed(this.jdField_a_of_type_JavaLangRunnable, 10000L);
    PreloadManager.a().c(str, new ahfl(this, localWeakReference, paramaycb, paramBaseChatPie));
  }
