...
public class txl
{
  public static void a(Context paramContext, LinearLayout paramLinearLayout, int paramInt1, QQUserUIItem paramQQUserUIItem, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    int i = vms.a(paramContext, paramInt1);
    if ((paramInt2 != 1) || (!paramBoolean))
    {
      localObject1 = ((LayoutInflater)localObject1).inflate(2131495767, null);
      localObject2 = (CircleImageView)((View)localObject1).findViewById(2131302197);
      ...
      ((CircleImageView)localObject2).setBorderWidth(vms.a(paramContext, 1.0F));
      vms.a((ImageView)localObject2, paramQQUserUIItem.headUrl, i, i, new ulb(null, null));
      paramQQUserUIItem = new LinearLayout.LayoutParams(i, i);
      if (paramInt2 != -1) {
        paramQQUserUIItem.setMargins(-aciy.a(8.0F, paramContext.getResources()), 0, 0, 0);
      }
      paramLinearLayout.addView((View)localObject1, paramQQUserUIItem);
      return;
    }
    Object localObject2 = ((LayoutInflater)localObject1).inflate(2131495768, null);
    Object localObject3 = (TextView)((View)localObject2).findViewById(2131311812);
    if (paramInt3 > 99) {}
    for (localObject1 = "99+";; localObject1 = paramInt3 + "")
    {
      ((TextView)localObject3).setText((CharSequence)localObject1);
      ((TextView)localObject3).setVisibility(0);
      localObject1 = ((View)localObject2).findViewById(2131302198);
      localObject3 = ((View)localObject1).getLayoutParams();
      paramInt1 = vms.a(paramContext, paramInt1 - 2);
  ...
  public static boolean a(ShareGroupFeedItem paramShareGroupFeedItem)
  {
    if (paramShareGroupFeedItem != null)
    {
      ...
      {
        urk.b("ShareGroupUtil", "屏蔽掉圈子类型 %s", paramShareGroupFeedItem);
        return true;
      }
    }
    return false;
