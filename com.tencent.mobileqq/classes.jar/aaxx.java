  ...
  implements View.OnClickListener
{
  ...
  public aaxx(Conversation paramConversation)
  {
  ...
  private void e()
  {
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849543);
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a(2131364758));
  ...
  public void a(View paramView)
  {
    ...
    for (boolean bool = akwg.a(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a());; bool = true)
    {
      if (!bool)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().requestPermissions(new aaxy(this, paramView), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
      }
      b(paramView);
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((amte.a().jdField_a_of_type_Int == 1) && (Build.VERSION.SDK_INT >= 21))
    {
      this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch.setVisibility(0);
      Object localObject = (avpq)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a.getManager(36);
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((avpq)localObject).a(6, "120000");
      ...
      if (bool1)
      {
        ...
        ((avpq)localObject).b(localAppInfo, null);
        if (!paramBoolean) {
          axqw.b(null, "dc00898", "", "", "0X800A2D4", "0X800A2D4", 0, 0, "3", "", "", "");
        }
        label154:
        if (!paramBoolean) {
          break label215;
      ...
      {
        axqw.b(null, "dc00898", "", "", "0X800A2D4", "0X800A2D4", 0, 0, (String)localObject, "", "", "");
        return;
        if ((bool1) || (!bool2)) {
          break label154;
        }
  ...
  public void b()
  {
    boolean bool = aojo.d(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a);
  ...
  public void b(View paramView)
  {
    ...
    {
      localObject2 = (avpq)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a.getManager(36);
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((avpq)localObject2).a(6, "120000");
      localObject1 = bjzb.a(localAppInfo.buffer.get(), "mqqapi://videostory/takevideo?src_type=internal&version=1&from=mainCamera&uin=&appid=406&widgetid=&shareto=1");
      ((avpq)localObject2).a(localAppInfo, null);
    }
    ...
    {
      axqw.b(null, "dc00898", "", "", "0X800A2D5", "0X800A2D5", 0, 0, paramView, "", "", "");
      return;
      label208:
      localObject2 = "?";
      break;
  ...
  {
    e();
    if ((this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch != null) && (amte.a().jdField_a_of_type_Int == 1) && (Build.VERSION.SDK_INT >= 21))
    {
      this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch.b();
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    }
