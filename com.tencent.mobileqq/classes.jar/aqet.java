...
public class aqet
{
  protected static final ark.ApplicationCallback a = new aqfe();
  
  public static void a()
  {
    String str3 = aqcc.a().a();
    String str1 = "";
    ...
    ArkDelegateManager.getInstance().init(str2, (String)localObject, "8.4.5", BaseApplicationImpl.getContext());
    ...
    ArkDelegateManager.getInstance().setSetupDelegate(new aqey());
    ArkDelegateManager.getInstance().setNetDelegate(new aqez());
    ArkDelegateManager.getInstance().setInputCallback(new aqff(null));
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    try
    {
      if (!ArkAppCenter.a)
      {
        ((ArkEnvironmentManager)localObject1).setThreadCreator(new aqeu());
        ((ArkEnvironmentManager)localObject1).setLogCallback(new aqev());
        ((ArkEnvironmentManager)localObject1).setLibraryLoader(new aqew());
        ((ArkEnvironmentManager)localObject1).setDebugFlag(false);
        ((ArkEnvironmentManager)localObject1).setProfilingLogFlag(true);
        ((ArkEnvironmentManager)localObject1).setDataReport(new aqex());
        ArkAppCenter.a = true;
      }
