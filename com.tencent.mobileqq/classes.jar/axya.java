  ...
  extends axuo
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      if (!((axun)((Iterator)localObject1).next() instanceof axwk)) {
        break label944;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        paramView = (axun)this.jdField_a_of_type_JavaUtilArrayList.get(j);
      ...
      for (;;)
      {
        ...
        if ("button".equals(localObject2))
        {
          ...
          if (i == 0)
          {
            ...
            if (m < n)
            {
              localObject2 = (axun)this.jdField_a_of_type_JavaUtilArrayList.get(m);
              ((axun)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
              str = ((axun)localObject2).jdField_a_of_type_JavaLangString;
            ...
            ((axun)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject2 = ((axun)localObject2).a(paramContext, null, paramBundle);
            j = 0;
            if (m == 0)
            {
              j = 2131376559;
            ...
            for (;;)
            {
              ...
              if ("button".equals(str))
              {
                ...
                for (;;)
                {
                  ...
                  return paramView;
                  j = actn.a(5.0F, localResources);
                  break;
                  label888:
                  k = actn.a(5.0F, localResources);
                  m = i;
                  n = j;
                  j = k;
                  k = n;
