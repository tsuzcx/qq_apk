...
public class uib
  extends mml
{
  public uib(StoryMessageListActivity paramStoryMessageListActivity)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null)) {
      try
      {
        ...
        if ((localRspStoryMessageList.errinfo.error_code.has()) && (localRspStoryMessageList.errinfo.error_code.get() == 0))
        {
          ...
          {
            uhy localuhy = new uhy((qqstory_710_message.StoryMessage)localIterator.next());
            if (localuhy.d) {
              paramArrayOfByte.add(localuhy);
            }
          }
        }
