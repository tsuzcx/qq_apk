...
public class aebk
  implements bfux
{
  public aebk(StructingMsgItemBuilder paramStructingMsgItemBuilder, ChatMessage paramChatMessage, Activity paramActivity, AbsStructMsg paramAbsStructMsg) {}
  ...
  public void a(bfuw parambfuw)
  {
    ...
    localSubscribeRequest.index.set(parambfuw.a);
    long l1 = 0L;
    try
    {
    ...
    localNewIntent.setObserver(new aebl(this, str));
