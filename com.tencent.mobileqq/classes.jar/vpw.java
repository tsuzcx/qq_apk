...
public class vpw
{
  ...
  public vpw(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new vpx(this, paramSwipeUpAndDragListener));
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new vpy(this, paramSwipeUpAndDragListener);
    this.jdField_a_of_type_JavaLangRunnable = new vpz(this, paramSwipeUpAndDragListener);
    this.jdField_b_of_type_JavaLangRunnable = new vqa(this, paramSwipeUpAndDragListener);
  }
