...
public class sgg
{
  private static sgg jdField_a_of_type_Sgg = new sgg();
  ...
  public static sgg a()
  {
    return jdField_a_of_type_Sgg;
  }
  
  private void b()
  {
    sgh localsgh = this.jdField_a_of_type_Sgh;
    if ((localsgh == null) || (localsgh.a())) {
      return;
    }
    localsgh.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    localsgh.jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
    if (QLog.isColorLevel()) {
      QLog.d("VideoBehaviorsReporter", 2, "doReportVideoBehaviorsSeq(): " + localsgh.toString());
    }
    pqe.f(BaseApplication.getContext(), pkh.a(), true, localsgh.a());
    this.jdField_a_of_type_Sgh.a();
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Sgh = null;
  }
  ...
  public void a(szd paramszd, List<?> paramList)
  {
    if (!this.jdField_c_of_type_Boolean) {}
    do
    {
