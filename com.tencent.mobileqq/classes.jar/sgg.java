...
public class sgg
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return k;
          localObject = (akdh)paramQQAppInterface.getManager(56);
          k = j;
        } while (localObject == null);
        Object localObject = ((akdh)localObject).b(paramString);
        if (localObject != null)
        {
        ...
        paramQQAppInterface = (ajvr)paramQQAppInterface.getManager(69);
        k = i;
  ...
  public static int a(String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      } else if ((localRecentUserBaseData.mUser.getType() == 1008) && (saz.b((QQAppInterface)onh.a(), localRecentUserBaseData.mUser.uin))) {
        ((Iterator)localObject2).remove();
      }
    }
    int i = 0;
  ...
  public static String a(ArticleInfo paramArticleInfo, pbg parampbg)
  {
    ...
    for (;;)
    {
      return axau.b(paramArticleInfo);
      label145:
      localObject1 = localObject2;
      ...
      parampbg = ReadInJoyUserInfoModule.a(Long.valueOf(paramArticleInfo.msgBoxBriefPreFix).longValue(), parampbg);
      if (parampbg == null)
      {
        localObject1 = ReadInJoyUserInfoModule.a() + ": ";
        break;
      }
      localObject1 = parampbg.nick + ": ";
      break;
        ...
        for (;;)
        {
          ...
          if (paramBaseArticleInfo.mTopicRecommendFeedsInfo != null)
          {
            ...
            if (paramBaseArticleInfo.mTopicRecommendFeedsInfo.a != null)
            {
              ...
              {
                localObject = ((qds)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c;
                str1 = ((qds)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_JavaLangString;
              }
            }
          }
  ...
  public static String a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localObject1 = bbkb.p(BaseApplicationImpl.getApplication(), str);
      if (localObject1 == null) {
        break label123;
      }
    }
    for (;;)
    {
      try
      {
        ...
        {
          paramString = mzb.a(paramString, "_kdSkinID=" + localSkinData.id);
          if (bbkb.u(BaseApplicationImpl.getApplication(), str)) {
            localObject1 = mzb.a(paramString, "_kdSkinVoice=1");
          }
        }
        else
        {
      ...
      return mzb.a(paramString, "_kdSkinVoice=0");
      label123:
      Object localObject2 = null;
    }
  }
  ...
  public static NewIntent a(QQAppInterface paramQQAppInterface, Context paramContext, MqqHandler paramMqqHandler, String paramString)
  {
    ...
    //   36: ifnull +7 -> 43
    //   39: aload_2
    //   40: putstatic 399	sgg:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   43: ldc 2
    //   45: monitorexit
    ...
    //   130: dup
    //   131: aload_0
    //   132: invokespecial 458	sgh:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, ProfileParams paramProfileParams)
  {
    ...
    for (;;)
    {
      ...
      localObject = new sgi(paramActivity, paramQQAppInterface, paramProfileParams);
      localObject = bgzl.a(paramQQAppInterface, paramProfileParams.a(), (ajte)localObject);
      if (localObject != null)
      {
  ...
  {
    boolean bool = ((Boolean)bbkb.a(paramContext, paramQQAppInterface.getCurrentAccountUin(), "config_tim_team_is_web", Boolean.valueOf(false))).booleanValue();
    String str = (String)bbkb.a(paramContext, paramQQAppInterface.getCurrentAccountUin(), "config_tim_team_url", "https://m.q.qq.com/a/p/1109953074?s=pages%2Fnotification%2Findex%3FenterType%3DqqMiniHelper");
    if ((!bool) && (MiniAppLauncher.isMiniAppUrl(str))) {
      MiniAppLauncher.startMiniApp(paramContext, str, 1043, null);
    }
    for (;;)
    {
      paramQQAppInterface.a().a(ajsd.aU, 1008, true, true);
      return;
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    naz.a(paramContext, paramIntent, paramString, false, -1, true, -1);
  }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    } while (!myv.a(paramActivity, paramString));
    a(paramIntent, paramActivity, paramString, paramInt2, paramInt3);
    return;
    naz.a(paramActivity, paramIntent, paramString, false, 5, true, paramInt2);
  }
  ...
  private static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      String str = omj.k + bbco.encodeToString(paramString.getBytes(), 0);
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        break;
      case -6: 
        if (!myv.a(paramContext, paramString)) {
          break;
        }
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, akdn paramakdn)
  {
    a(paramAppInterface, paramContext, paramString, paramakdn, true, 0);
  }
  
  @Deprecated
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, akdn paramakdn, int paramInt)
  {
    ...
    localQQAppInterface.addObserver(new akwr(new sgr(paramakdn, paramString, paramAppInterface, paramContext), localQQAppInterface));
    akww.a(localQQAppInterface, true, paramString, 0);
    if ((paramAppInterface instanceof QQAppInterface)) {
      paramAppInterface = (QQAppInterface)paramAppInterface;
    }
    for (;;)
    {
      nol.a(paramAppInterface, paramString, 0);
      return;
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, akdn paramakdn, boolean paramBoolean)
  {
    a(paramAppInterface, paramContext, paramString, paramakdn, paramBoolean, 0);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, akdn paramakdn, boolean paramBoolean, int paramInt)
  {
    a(paramAppInterface, paramContext, paramString, paramakdn, paramBoolean, paramInt, false);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, akdn paramakdn, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    if ((paramAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        paramakdn = new akwr(new sgn(paramakdn, paramString, paramAppInterface, paramContext, paramInt, paramBoolean1));
        paramContext = new PublicAccountIntent(paramContext.getApplicationContext(), akwt.class);
        paramContext.a(paramakdn);
        ...
        return;
        localObject = (akdh)paramAppInterface.getManager(56);
        if (localObject != null)
        {
          localObject = ((akdh)localObject).a(paramString);
      ...
      {
        localObject = new NewIntent(paramContext.getApplicationContext(), nor.class);
        ...
        try
        {
          ...
          ((NewIntent)localObject).setObserver(new sgo(paramakdn, paramString, paramBoolean1, paramContext, paramAppInterface, paramInt));
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    new pbu(paramQQAppInterface, null, null, por.a(), null).a(localArrayList);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser, int paramInt, RecentBaseData paramRecentBaseData)
  {
    ...
    wis.a(paramActivity, 9004, paramRecentUser);
    if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    localbfpc.a(paramContext.getResources().getString(2131696396));
    localbfpc.a(2131691507, 3);
    if (paramString.equals("2010741172")) {
      localbfpc.b(2131695534);
    }
    localbfpc.c(2131690596);
    localbfpc.a(new sgm(paramQQAppInterface, paramString, paramInt, paramLong, paramBoolean, paramContext, localbfpc));
    localbfpc.show();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean, akdn paramakdn)
  {
    a(paramQQAppInterface, paramContext, paramString, paramBoolean, paramakdn, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean1, akdn paramakdn, boolean paramBoolean2)
  {
    if ((paramQQAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    {
      localObject2 = ((akdh)localObject3).a(paramString);
      ((akdh)localObject3).b(paramString);
      paramContext = (Context)localObject2;
      localObject1 = localNewIntent;
      if (localObject2 == null)
      {
        localObject3 = (ajvr)paramQQAppInterface.getManager(69);
        paramContext = (Context)localObject2;
        localObject1 = localNewIntent;
        if (localObject3 != null)
        {
          localObject1 = ((ajvr)localObject3).a(paramString);
          paramContext = (Context)localObject2;
        }
      }
    }
    ...
    if ((paramBoolean2) || (paramContext == null) || (a(paramContext.accountFlag) != -4))
    {
      ...
      if ((!paramBoolean2) && (paramContext != null) && (a(paramContext.accountFlag) == -4))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApp().getApplicationContext(), nor.class);
    ...
    else
    {
      for (;;)
      {
        try
        {
          ...
          paramContext = new sgp(paramakdn, paramString, paramBoolean1, localBaseApplication, localObject1, paramQQAppInterface);
    ...
    for (;;)
    {
      paramContext = new akwr(new sgq(localObject1, paramQQAppInterface, paramString, paramakdn, paramBoolean1, localBaseApplication), paramQQAppInterface);
      ...
      akww.a(paramQQAppInterface, false, paramString, 0);
      return;
      localObject1 = paramContext;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    akwu.a(paramQQAppInterface, paramChatMessage.senderuin, 0, 6, paramChatMessage.msgId, str);
  }
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (jdField_a_of_type_Int == 0)
        {
          ...
          if ((bool) && (paramBoolean))
          {
            ...
            if (??? != null)
            {
              localObject2 = ((aktf)???).b(ajsd.ay, 1008);
              if (localObject2 != null)
              {
                ((aktf)???).b((RecentUser)localObject2);
            ...
            ??? = (akdh)paramQQAppInterface.getManager(56);
            if (??? != null)
            {
              ((akdh)???).c(ajsd.ay);
  ...
  public static int b(String paramString)
  {
    ...
    if (((RecentUserBaseData)localObject2).mUser.getType() == 1008)
    {
      ...
      if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, paramString))
      {
        if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, ajsd.C)) {
          break label215;
        }
        k = i;
      }
  ...
  private static MessageForStructing b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localMessageForStructing.frienduin = ajsd.az;
  ...
  private static MessageForStructing b(MessageForStructing paramMessageForStructing, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    MessageForStructing localMessageForStructing = (MessageForStructing)axas.a(paramMessageForStructing.msgtype);
  ...
  public static String b()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = onh.f();
        localObject2 = bbdh.d(BaseApplication.getContext());
        if (localObject1 == null) {
          continue;
        }
      }
      ...
      {
        return bbco.encodeToString((byte[])localObject2, 2);
      }
      label225:
      if (localObject2 == null) {}
    }
  ...
  public static String b(QQAppInterface paramQQAppInterface, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBaseArticleInfo.mFeedType == 4) || (paramBaseArticleInfo.mFeedType == 5))
      {
        ...
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qci.a, null);
          if (paramBaseArticleInfo != null) {}
      ...
      {
        if (ram.f((ArticleInfo)paramBaseArticleInfo))
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qci.a, null);
          if (paramBaseArticleInfo != null) {}
          for (paramBaseArticleInfo = paramBaseArticleInfo.nick;; paramBaseArticleInfo = ReadInJoyUserInfoModule.a())
        ...
        {
          paramQQAppInterface = new StringBuilder(ajya.a(2131708768));
          ...
          {
            paramQQAppInterface.append(i + 1).append(".").append(((qbd)paramBaseArticleInfo.hotWordInfo.a.get(i)).jdField_a_of_type_JavaLangString).append("  ");
            i += 1;
          }
          continue;
        }
  ...
  private static void b(AppInterface paramAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramContext, nor.class);
    ...
    try
    {
      ...
      localNewIntent.setObserver(new sgs(paramContext, paramAppInterface, paramInt, paramString));
  ...
  {
    if (jdField_a_of_type_Bbgu != null)
    {
      jdField_a_of_type_Bbgu.dismiss();
      jdField_a_of_type_Bbgu = null;
    }
    paramQQAppInterface = new sgj(paramActivity, paramProfileParams, paramQQAppInterface);
    paramProfileParams = new sgk(paramActivity, paramProfileParams);
    jdField_a_of_type_Bbgu = bbdj.a(paramActivity, 230);
    jdField_a_of_type_Bbgu.setMessage(2131695562);
    jdField_a_of_type_Bbgu.setTitle(2131692234);
    jdField_a_of_type_Bbgu.setNegativeButton(2131690596, paramQQAppInterface);
    jdField_a_of_type_Bbgu.setPositiveButton(2131719431, paramQQAppInterface);
    jdField_a_of_type_Bbgu.setOnCancelListener(paramProfileParams);
  ...
  public static void c(String paramString)
  {
    ...
    nol.a(null, "CliOper", "", "", "0X8009A7C", "0X8009A7C", 0, 0, paramString, "", "", "", false);
  }
