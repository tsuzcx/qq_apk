  ...
  extends bnnn
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bnny(this);
  ...
  private void a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      if (paramInt1 > 0)
      {
        str = String.format(localActivity.getString(2131716812), new Object[] { Integer.valueOf(paramInt1) }) + "，";
        str = str + paramString + anzj.a(2131711165);
      }
      paramString = str + String.format(localActivity.getString(2131716805), new Object[] { Integer.valueOf(paramInt2) });
      bhlq.a(localActivity, 232).setMessage(paramString).setNegativeButton(2131716810, new bnoe(this)).show();
      return;
    }
    bjuh.a().a(localActivity.getString(2131716813) + paramString + anzj.a(2131711164));
  }
  
  private void a(String paramString)
  {
    bngf.a().a().d(paramString);
  }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localIntent.putExtra("source_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getString(2131716614));
  ...
  private void c(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        i = bhlk.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getAccount(), "troop_photo_message", String.valueOf(i));
        if (QLog.isDevelopLevel()) {
  ...
  private void f(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bmtd.b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 1, l, "", paramVarArgs, (String)localObject, 7001, 43);
      return;
    }
    catch (Exception paramVarArgs)
    {
  ...
  private void h(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject2 = bmtk.a();
        ((bmtk)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ...
        bmtd.c(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), (bmtk)localObject2, (Bundle)localObject4, 6);
  ...
  private void i(String... paramVarArgs)
  {
    ...
    bngf.a().a(new bnnz(this, paramVarArgs));
    if (!a())
    {
      bjuh.a().a(anzj.a(2131711163));
      return;
    }
    if (!NetworkState.isNetSupport())
    {
      bjuh.a().a(anzj.a(2131711160));
      return;
    }
    if (!NetworkState.isWifiConn())
    {
      Activity localActivity = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
      bhlq.a(localActivity, 230).setTitle(localActivity.getString(2131716809)).setMessage(localActivity.getString(2131716811)).setPositiveButton(localActivity.getString(2131716808), new bnod(this, paramVarArgs)).setNegativeButton(localActivity.getString(2131716807), new bnoc(this)).show();
      return;
    }
    a(paramVarArgs[0]);
  }
  ...
  private void j(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bmtd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 4, j, "", paramVarArgs, (String)localObject, 7001, 43);
        return;
      }
      catch (Exception paramVarArgs) {}
  ...
  private void l(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localbmtk.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getCurrentAccountUin();
        paramVarArgs.putBoolean("key_need_change_to_jpg", true);
        bmtd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), localbmtk, paramVarArgs, bmtd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 6));
        return;
      }
      catch (Exception paramVarArgs) {}
    } while (!QLog.isColorLevel());
