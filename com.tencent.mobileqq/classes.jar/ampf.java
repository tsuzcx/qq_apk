...
public class ampf
  extends BaseAdapter
  implements View.OnClickListener, aoog, blmf
{
  private int jdField_a_of_type_Int;
  ampn jdField_a_of_type_Ampn;
  Activity jdField_a_of_type_AndroidAppActivity;
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new ampg(this);
  anyu jdField_a_of_type_Anyu = new ampm(this);
  anyw jdField_a_of_type_Anyw;
  aobl jdField_a_of_type_Aobl;
  protected aoof a;
  private blmh jdField_a_of_type_Blmh = new ampk(this);
  ...
  View.OnTouchListener jdField_b_of_type_AndroidViewView$OnTouchListener = new amph(this);
  private Runnable jdField_b_of_type_JavaLangRunnable = new MayKnowAdapter.7(this);
  private int c;
  private int d;
  
  public ampf(Activity paramActivity, QQAppInterface paramQQAppInterface, HorizontalListView paramHorizontalListView, ampn paramampn, int paramInt1, int paramInt2)
  {
    ...
    this.c = agej.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    g();
    this.d = aobl.jdField_a_of_type_Int;
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnScrollStateChangedListener(this.jdField_a_of_type_Blmh);
      if (QLog.isColorLevel()) {
        QLog.d("MayKnowAdapter", 2, "MayKnowAdapter ,mFriendObserver = " + this.jdField_a_of_type_Anyu);
      }
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.postDelayed(this.jdField_b_of_type_JavaLangRunnable, 1000L);
      return;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800674D", "0X800674D", 0, 0, "", "", "", "");
      continue;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800673E", "0X800673E", 0, 0, "", "", "", "");
      continue;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800673F", "0X800673F", 0, 0, "", "", "", "");
      continue;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006773", "0X8006773", 0, 0, "", "", "", "");
    }
  }
  ...
  private View a()
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildCount())
    {
      ...
      if ((localView != null) && ((localView.getTag() instanceof ampl)))
      {
        ampl localampl = (ampl)localView.getTag();
        if ((localampl == null) || (localampl.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend == null) || (localampl.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.friendStatus == 0)) {}
      }
    }
    for (;;)
    {
  ...
  private View a(String paramString)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildCount())
    {
      ...
      {
        ampl localampl = (ampl)localView.getTag();
        if ((localampl == null) || (localampl.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend == null) || (!TextUtils.equals(localampl.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.uin, paramString))) {}
      }
    }
    for (;;)
    {
  ...
  {
    a(paramView, new ampi(this, paramView));
  }
  
  private void a(View paramView, Animation.AnimationListener paramAnimationListener)
  {
    ampj localampj = new ampj(this, paramView, paramView.getMeasuredWidth());
    if (paramAnimationListener != null) {
      localampj.setAnimationListener(paramAnimationListener);
    }
    localampj.setDuration(240L);
    paramView.startAnimation(localampj);
  }
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Aobl != null) {
      this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Aobl.c();
    }
  ...
  public void a()
  {
    ...
    int i;
    if ((getCount() > 0) && (this.jdField_a_of_type_ComTencentWidgetHorizontalListView.isShown()) && (this.jdField_a_of_type_Aobl != null)) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aobl.a(a(i), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      i += 1;
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Aobl != null) {
      this.jdField_a_of_type_Aobl.b(a(paramInt), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
    }
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aobl.b(a(i), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      i += 1;
    }
  }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        ((QQAppInterface)localAppRuntime).removeObserver(this.jdField_a_of_type_Anyu);
      }
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    ampl localampl = null;
    if (paramView != null) {
      localampl = (ampl)paramView.getTag();
    }
    if ((paramView == null) || (localampl == null) || (localampl.jdField_a_of_type_Boolean) || (!TextUtils.equals(localampl.jdField_b_of_type_JavaLangString, ThemeUtil.curThemeId)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558470, paramViewGroup, false);
      localampl = new ampl();
      localampl.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367925));
      localampl.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371826));
      localampl.jdField_a_of_type_AndroidWidgetTextView.getPaint();
      localampl.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367286));
      localampl.c = ((TextView)paramView.findViewById(2131361944));
      localampl.d = ((TextView)paramView.findViewById(2131362142));
      localampl.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364584);
      localampl.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      localampl.jdField_a_of_type_AndroidViewView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      localampl.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      localampl.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(this.jdField_b_of_type_AndroidViewView$OnTouchListener);
      if ((localampl.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)localampl.jdField_a_of_type_AndroidWidgetImageView).setSupportMaskView(false);
      }
      localampl.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
      localampl.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      paramView.setTag(localampl);
      if (this.jdField_a_of_type_Int != 25)
      {
        localampl.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166990));
        localampl.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167084));
      }
      localampl.jdField_b_of_type_JavaLangString = ThemeUtil.curThemeId;
    }
    for (;;)
    {
      MayKnowRecommend localMayKnowRecommend = a(paramInt);
      if (this.jdField_a_of_type_Aobl != null) {
        this.jdField_a_of_type_Aobl.a(localMayKnowRecommend, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      }
      StringBuilder localStringBuilder = new StringBuilder();
      localampl.jdField_a_of_type_JavaLangString = localMayKnowRecommend.uin;
      localampl.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend = localMayKnowRecommend;
      localampl.jdField_a_of_type_AndroidViewView.setTag(localMayKnowRecommend);
      localampl.jdField_a_of_type_AndroidWidgetImageView.setTag(localampl);
      localampl.jdField_a_of_type_AndroidWidgetTextView.setTag(localampl);
      localampl.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(a(1, localampl.jdField_a_of_type_JavaLangString));
      if (this.jdField_a_of_type_Aobl != null) {}
      for (boolean bool = this.jdField_a_of_type_Aobl.a();; bool = false)
      {
        String str = localMayKnowRecommend.getDisplayName(bool);
        localampl.jdField_a_of_type_AndroidWidgetTextView.setText(str);
        if ((AppSetting.c) && (!TextUtils.isEmpty(str))) {
          localStringBuilder.append(str);
        }
        if (!TextUtils.isEmpty(localMayKnowRecommend.recommendReason))
        {
          localampl.jdField_b_of_type_AndroidWidgetTextView.setText(localMayKnowRecommend.recommendReason);
          if (AppSetting.c) {
          ...
          localampl.c.setVisibility(0);
          localampl.c.setTag(localMayKnowRecommend);
          localampl.d.setVisibility(8);
          localampl.c.setOnClickListener(this);
          if (AppSetting.c)
          {
            localampl.c.setContentDescription(anzj.a(2131689551));
        ...
        for (;;)
        {
          ...
          return paramView;
          localampl.jdField_b_of_type_AndroidWidgetTextView.setText("");
          break;
          label701:
          if (localMayKnowRecommend.friendStatus == 1)
          {
            localampl.c.setVisibility(8);
            localampl.d.setVisibility(0);
            localampl.d.setText(2131717458);
            if (!AppSetting.c) {
              break label636;
            }
            localampl.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717458));
            localStringBuilder.append(",等待验证");
            break label636;
          }
          localampl.c.setVisibility(8);
          localampl.d.setVisibility(0);
          localampl.d.setText(2131689982);
          if (!AppSetting.c) {
            break label636;
          }
          localampl.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689982));
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if ((this.jdField_a_of_type_Anyw != null) && (!this.jdField_a_of_type_Anyw.b(((MayKnowRecommend)localObject1).uin)) && (!this.jdField_a_of_type_Anyw.d(((MayKnowRecommend)localObject1).uin)))
          {
            bool = false;
            if (this.jdField_a_of_type_Aobl != null) {
            ...
            localObject2 = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidAppActivity, 1, ((MayKnowRecommend)localObject1).uin, null, 3045, this.jdField_a_of_type_Int, (String)localObject2, null, null, this.jdField_a_of_type_AndroidAppActivity.getString(2131689551), null);
            ((Intent)localObject2).putExtra("key_param_age_area", bhhz.a(this.jdField_a_of_type_AndroidAppActivity, ((MayKnowRecommend)localObject1).gender, ((MayKnowRecommend)localObject1).age, ((MayKnowRecommend)localObject1).country, ((MayKnowRecommend)localObject1).province, ((MayKnowRecommend)localObject1).city));
          ...
          {
            if (this.jdField_a_of_type_Aobl != null) {
              this.jdField_a_of_type_Aobl.a((MayKnowRecommend)localObject1, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 3);
            }
            ...
            break;
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006750", "0X8006750", 0, 0, "", "", "", "");
            continue;
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006744", "0X8006744", 0, 0, "", "", "", "");
            continue;
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006745", "0X8006745", 0, 0, "", "", "", "");
            continue;
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006771", "0X8006771", 0, 0, "", "", "", "");
            continue;
            if ((this.jdField_a_of_type_Anyw != null) && (this.jdField_a_of_type_Anyw.b(((MayKnowRecommend)localObject1).uin)))
            {
        ...
        while ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
        {
          ...
          break;
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800674F", "0X800674F", 0, 0, "", "", "", "");
          continue;
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006742", "0X8006742", 0, 0, "", "", "", "");
          continue;
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006743", "0X8006743", 0, 0, "", "", "", "");
          continue;
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006772", "0X8006772", 0, 0, "", "", "", "");
        }
        localObject1 = (ampl)paramView.getTag();
      } while (localObject1 == null);
      localObject1 = ((ampl)localObject1).jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend;
    } while (localObject1 == null);
    int i = 84;
    ...
    default: 
      ...
      {
        j = i;
        if (this.jdField_a_of_type_Anyw.b(((MayKnowRecommend)localObject1).uin)) {
          j = 1;
        }
      }
      ...
      if (this.jdField_a_of_type_Aobl != null) {
        this.jdField_a_of_type_Aobl.a((MayKnowRecommend)localObject1, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 2);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        switch (this.jdField_b_of_type_Int)
        {
    ...
    while ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      i = 107;
      break label872;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800674E", "0X800674E", 0, 0, "", "", "", "");
      continue;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006740", "0X8006740", 0, 0, "", "", "", "");
      continue;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006741", "0X8006741", 0, 0, "", "", "", "");
      continue;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800678A", "0X800678A", 0, 0, "", "", "", "");
    }
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    if (paramInt1 <= 0)
    {
      ...
      while (paramInt1 < paramInt2)
      {
        ...
        if ((paramString != null) && ((paramString instanceof ampl)))
        {
          paramString = (ampl)paramString;
