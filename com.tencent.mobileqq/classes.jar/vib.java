  ...
  extends vhx
{
  ...
  private void a(DecodeConfig paramDecodeConfig, auzf paramauzf, int paramInt)
  {
    ...
    paramInt = Math.min(paramauzf.jdField_a_of_type_Int, paramauzf.b);
    int i = Math.max(paramauzf.jdField_a_of_type_Int, paramauzf.b);
    paramauzf.jdField_a_of_type_Int = paramInt;
    paramauzf.b = i;
    paramDecodeConfig.width = paramauzf.jdField_a_of_type_Int;
    paramDecodeConfig.height = paramauzf.b;
  }
  
  private boolean a(vhu paramvhu)
  {
    if (paramvhu.jdField_b_of_type_Boolean) {}
    while (!paramvhu.c) {
      return false;
    }
    return true;
  ...
  public void a(vhu paramvhu)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoToVideo", 2, "[runLocalVideo2Video]run begin, taskid:" + paramvhu.jdField_b_of_type_Long + " run:" + paramvhu.d);
    }
    if (a(paramvhu))
    {
      urp.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramvhu.jdField_a_of_type_JavaLangString, null, null, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvhu);
      return;
    }
    ...
    localObject1 = null;
    Object localObject2 = new File(paramvhu.jdField_a_of_type_JavaLangString);
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "before,getPCMFromFile[Have audio File]:  " + paramvhu.jdField_b_of_type_Long + " audioPath: " + (String)localObject1 + " audioFileSize=" + apdh.a((String)localObject1));
      }
      localObject2 = new vlj();
      l1 = System.currentTimeMillis();
      ((vlj)localObject2).a(paramvhu.jdField_a_of_type_JavaLangString, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getMetaDataFromFile:  " + paramvhu.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " mSampleRate: " + paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      localLocalMediaInfo.path = paramvhu.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo.mDuration = paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long;
      l1 = System.currentTimeMillis();
      bool = ((vlj)localObject2).a(localLocalMediaInfo, 0, (int)paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long, (String)localObject1, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getPCMFromFile:  " + paramvhu.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean);
      }
      if (paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean)
      {
        if ((!bool) || (!vlm.e((String)localObject1)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run,getPCMFromFile: failed " + paramvhu.jdField_b_of_type_Long + " path=" + (String)localObject1 + " success=" + bool);
          }
          vlm.g((String)localObject1);
          urp.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramvhu.jdField_a_of_type_JavaLangString, null, null, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvhu);
        }
      }
      else
      {
        vlm.g((String)localObject1);
        vlj.a((String)localObject1, (int)paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long);
        if (!vlm.e((String)localObject1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run[video convert],createSilentPCMFile: failed " + paramvhu.jdField_b_of_type_Long + " path=" + (String)localObject1);
          }
          urp.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramvhu.jdField_a_of_type_JavaLangString, null, null, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvhu);
          return;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "After,getPCMFromFile: hasAudioTrack= " + paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " path=" + (String)localObject1 + " success=" + bool + " audioFileSize=" + apdh.a((String)localObject1));
      }
    }
    paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    if (a(paramvhu))
    {
      urp.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramvhu.jdField_a_of_type_JavaLangString, null, null, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvhu);
    ...
    boolean bool = a(paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvhu);
    ...
    if ((bool) && (apdh.a(this.jdField_a_of_type_JavaLangString)))
    {
      l3 = apdh.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, taskid:" + paramvhu.jdField_b_of_type_Long + " run:" + paramvhu.d + " cost:" + (l2 - l1) + " ms successVideo:" + bool);
      }
      if (!paramvhu.d) {
        break;
      }
      a(this.jdField_a_of_type_Int, paramvhu.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, null, paramvhu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvhu);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, [failed]file not exist:" + paramvhu.jdField_b_of_type_Long + " file:" + this.jdField_a_of_type_JavaLangString);
      }
  ...
  /* Error */
  public boolean a(SlideItemInfo arg1, vhu paramvhu)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +10 -> 11
    ...
    //   33: new 291	bjgv
    //   36: dup
    //   37: invokespecial 292	bjgv:<init>	()V
    //   40: putfield 294	vib:jdField_a_of_type_Bjgv	Lbjgv;
    ...
    //   165: invokevirtual 325	vib:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 5
    //   170: new 22	auzf
    //   173: dup
    //   174: aload 13
    ...
    //   194: invokespecial 333	auzf:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 14
    //   199: aload 14
    //   201: sipush 720
    //   204: putfield 31	auzf:jdField_a_of_type_Int	I
    //   207: aload 14
    //   209: sipush 1280
    //   212: putfield 34	auzf:b	I
    //   215: aload_1
    ...
    //   292: sipush 720
    //   295: sipush 1280
    //   298: invokestatic 339	vnb:a	(IIII)Z
    //   301: ifeq +9 -> 310
    //   304: aload 14
    //   306: iconst_1
    //   307: putfield 340	auzf:c	Z
    ...
    //   340: aload 14
    //   342: iload 5
    //   344: invokespecial 345	vib:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lauzf;I)V
    //   347: aload 15
    //   349: iconst_1
    ...
    //   372: invokevirtual 64	vib:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   488: aload_0
    //   489: getfield 294	vib:jdField_a_of_type_Bjgv	Lbjgv;
    //   492: aload 15
    //   494: aload 14
    //   496: new 370	vic
    //   499: dup
    //   500: aload_0
    //   501: aload_2
    //   502: invokespecial 373	vic:<init>	(Lvib;Lvhu;)V
    //   505: aconst_null
    //   506: invokevirtual 376	bjgv:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lauzf;Lauzr;Lbjgw;)V
    //   509: aload_0
    //   510: getfield 17	vib:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   513: astore_1
    //   514: aload_1
    //   515: monitorenter
    ...
    //   538: aload_2
    //   539: getfield 57	vhu:jdField_b_of_type_Boolean	Z
    ...
    //   564: aload_2
    //   565: getfield 383	vhu:jdField_a_of_type_Boolean	Z
    ...
    //   577: aload_2
    //   578: getfield 57	vhu:jdField_b_of_type_Boolean	Z
    //   581: ifne +84 -> 665
    //   584: aload_2
    //   585: getfield 60	vhu:c	Z
    //   588: ifne +77 -> 665
    //   591: aload_2
    //   592: getfield 383	vhu:jdField_a_of_type_Boolean	Z
    //   595: istore 6
    //   597: iload 6
    //   599: ifne +66 -> 665
    //   602: aload_0
    //   603: getfield 17	vib:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   667: aload_0
    //   668: aload_2
    //   669: invokespecial 391	vib:a	(Lvhu;)Z
    //   672: istore 7
    //   674: iload 7
    //   676: istore 6
  ...
  public void b(vhu paramvhu)
  {
    ...
    {
      paramvhu.jdField_b_of_type_Boolean = true;
