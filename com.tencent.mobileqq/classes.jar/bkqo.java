  ...
  extends PopupWindow
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bkqr();
  ...
  public bkqo(Context paramContext, int paramInt1, int paramInt2)
  {
    this(paramContext, paramInt1, -2, paramInt2);
  }
  
  public bkqo(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public static bkqp a(Context paramContext)
  {
    return new bkqp(paramContext, null);
  }
  ...
  private void d(View paramView, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        i = bggq.a(paramView.getContext(), 300.0F);
        int j = bggq.a(paramView.getContext(), 120.0F);
        this.jdField_a_of_type_AndroidWidgetFrameLayout.measure(i, j);
        this.jdField_b_of_type_Int = bggq.a(paramView.getContext(), this.jdField_b_of_type_Int);
        ...
        if ((this.e == 51) || (this.e == 52))
        {
          ...
          if (this.e == 51)
          {
            ...
            if (this.c == 83)
            {
              ...
              e(paramView, j, i);
              yqp.b("CalloutPopupWindow.VASH", "show tips xoff=%d, yAnchorOff=%d, yoff=%d", Integer.valueOf(j), Integer.valueOf(i), Integer.valueOf(paramInt2));
  ...
  public void c(View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        int n = bggq.a(paramView.getContext(), 300.0F);
        int i1 = bggq.a(paramView.getContext(), 120.0F);
