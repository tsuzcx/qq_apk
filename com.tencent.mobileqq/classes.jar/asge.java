  ...
  implements View.OnTouchListener
{
  ...
  public asge(Context paramContext)
  {
    this.jdField_a_of_type_Bbfq = new asgi(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new asgj(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131639294));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, vct.a(this.jdField_a_of_type_AndroidContentContext, 15.0F));
  ...
  private void b()
  {
    ...
    {
      j = j - this.jdField_a_of_type_AndroidWidgetTextView.getWidth() - vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 <= i * 0.8F) {
        break label251;
      }
      i = i - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() - vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
    }
    for (;;)
    {
      ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { localLayoutParams.x, j });
      localValueAnimator.addUpdateListener(new asgg(this, localLayoutParams, localValueAnimator));
      ...
      localValueAnimator.addUpdateListener(new asgh(this, localLayoutParams, localValueAnimator));
      localValueAnimator.setDuration(200L);
      localValueAnimator.setTarget(this.jdField_a_of_type_AndroidWidgetTextView);
      localValueAnimator.start();
      return;
      j = vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      break;
      label251:
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 > i * 0.6F) {
        ...
        i = vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      }
    }
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Bbfq);
      return;
    }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    Object localObject;
    if (!this.jdField_b_of_type_Boolean) {
      if (!lor.c(this.jdField_a_of_type_AndroidContentContext))
      {
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ((WindowManager.LayoutParams)localObject).x = (j - vct.a(this.jdField_a_of_type_AndroidContentContext, 62.0F) - vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ((WindowManager.LayoutParams)localObject).y = ((int)((k - vct.a(this.jdField_a_of_type_AndroidContentContext, 67.0F)) * 0.25F));
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130841661);
        try
        {
          ...
          if (paramInt1 == 0)
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131639345));
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new asgf(this, paramInt1, paramLong, paramString2, paramString1, paramInt2));
            ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).addObserver(this.jdField_a_of_type_Bbfq);
            return;
            i = 2010;
          }
        }
        catch (Exception localException1)
        {
          for (;;)
          {
            ...
            continue;
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131639336));
          }
        }
      }
    }
  ...
  protected void a(HotChatInfo paramHotChatInfo, int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      ((atmp)localObject2).a(paramHotChatInfo);
      ((atmp)localObject2).a();
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        if ((this.jdField_a_of_type_Boolean) || (Math.abs(paramMotionEvent.getX() - this.jdField_a_of_type_Int) > vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F)) || (Math.abs(paramMotionEvent.getY() - this.jdField_b_of_type_Int) > vct.a(this.jdField_a_of_type_AndroidContentContext, 10.0F)))
        {
          ...
          paramView.y = (k - this.jdField_b_of_type_Int - vct.a(this.jdField_a_of_type_AndroidContentContext, 25.0F));
