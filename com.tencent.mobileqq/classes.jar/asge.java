...
public class asge
{
  public static final String g = ajya.a(2131713952);
  ...
  public asge(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    AbsShareMsg localAbsShareMsg = new axum(StructMsgForGeneralShare.class).c(114).a(this.jdField_b_of_type_JavaLangString).e(this.jdField_a_of_type_JavaLangString).a();
    localAbsShareMsg.mSourceName = this.e;
    localAbsShareMsg.mSourceAction = "web";
    localAbsShareMsg.mSourceUrl = this.f;
    Object localObject = axuz.a(2);
    ((axuq)localObject).a(this.d, this.jdField_b_of_type_JavaLangString, this.c);
  ...
  private void b()
  {
    ...
    bgzl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localBundle, null);
  }
  ...
  {
    if (!a()) {
      bcql.a(this.jdField_a_of_type_AndroidContentContext, ajya.a(2131713953), 0).a();
    }
    do
    {
      for (;;)
      {
        ...
        {
          asgf localasgf = new asgf(this);
          paramOnDismissListener = new asgg(this, paramOnDismissListener);
          ...
          this.jdField_a_of_type_Bbjq.a(localasgf);
