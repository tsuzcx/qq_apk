...
public class ajsv
{
  private static ajsv jdField_a_of_type_Ajsv;
  public static final String a;
  public static final String b;
  private static boolean jdField_b_of_type_Boolean;
  public static final String c;
  private static final String d = ajrx.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  private static final String e = d + "SKINCOLOR" + File.separator;
  private int jdField_a_of_type_Int;
  private ajsz jdField_a_of_type_Ajsz;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajrx.jdField_a_of_type_JavaLangString + "/qsvf" + File.separator;
  ...
  public static ajsv a()
  {
    if (jdField_a_of_type_Ajsv == null) {
      jdField_a_of_type_Ajsv = new ajsv();
    }
    return jdField_a_of_type_Ajsv;
  }
  
  private static ajta a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localajta = new ajta(i, str1, str2);
        try
        {
    ...
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          ((baub)localObject).jdField_a_of_type_Baug = new ajsx();
          ...
          ((baub)localObject).jdField_c_of_type_JavaLangString = (d + "skin_color.zip");
  ...
  public void a()
  {
    this.jdField_a_of_type_Ajsz = null;
    if (this.jdField_c_of_type_Int != -1) {
      this.jdField_c_of_type_Int = -1;
    }
    if (this.jdField_a_of_type_ArrayOfInt[0] != -1) {
  ...
  public void a(Context paramContext, ajsz arg2)
  {
  ...
  void a(List<FilterDesc> paramList)
  {
        ...
        if (localFilterDesc.predownload == 1)
        {
          ...
          if (!TextUtils.isEmpty(localFilterDesc.iconurl))
          {
            ...
            if (!((File)localObject2).exists())
            {
              ...
              ((baub)localObject2).jdField_a_of_type_Baug = new ajsy(this);
              ((baub)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
              ((baub)localObject2).jdField_a_of_type_Int = 0;
              ((baub)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
          ...
          if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            if (!((File)localObject2).exists())
            {
              ...
              ((baub)localObject1).jdField_a_of_type_Baug = new ajsw(this);
              ((baub)localObject1).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
              ((baub)localObject1).jdField_a_of_type_Int = 0;
              ((baub)localObject1).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
              ((baub)localObject1).a(localFilterDesc);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Ajsz == null));
    this.jdField_a_of_type_Ajsz.a(false);
  }
