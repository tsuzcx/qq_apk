...
public class ajle
  extends anvi
{
  private ajle(FriendFragment paramFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, anvx.a(2131704343), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, anvx.a(2131704344), 0).a();
          return;
        }
      }
