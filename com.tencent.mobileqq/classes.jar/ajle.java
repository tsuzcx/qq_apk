...
{
  public ajle(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (!this.b.jdField_a_of_type_Alhs.a) {
        break;
      }
    ...
    URLDrawable.resume();
    this.b.jdField_a_of_type_Alhs.notifyDataSetChanged();
    return;
    label127:
    URLDrawable.pause();
    this.b.jdField_a_of_type_Alhs.a = true;
  }
}
