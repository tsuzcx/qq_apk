  ...
  implements RadioGroup.OnCheckedChangeListener
{
  ...
  {
    if ((this.a.jdField_a_of_type_Bisg != null) && (!TextUtils.isEmpty(this.a.jdField_a_of_type_Bisg.a))) {
      this.a.jdField_a_of_type_Bisg.a(paramInt);
    }
    for (;;)
    {
      EventCollector.getInstance().onCheckedChanged(paramRadioGroup, paramInt);
      return;
      TouchWebView localTouchWebView = this.a.jdField_a_of_type_Birg.a();
