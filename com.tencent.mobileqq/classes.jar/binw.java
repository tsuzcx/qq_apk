...
{
  public binw(QuickLoginAuthorityActivity paramQuickLoginAuthorityActivity) {}
  
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    QLog.e("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onFailed--action = " + paramInt1 + ", ret = " + paramInt2 + ", ssoAccount = *" + bipr.a(paramString));
    this.a.f();
    if (paramInt2 == -1000)
    {
      QuickLoginAuthorityActivity.a(this.a).a(this.a, this.a.getResources().getString(2131694142));
      return;
    }
    paramBundle = (ErrMsg)paramBundle.getParcelable("lastError");
    if (paramBundle == null) {}
    for (paramBundle = this.a.getString(2131694139);; paramBundle = paramBundle.getMessage())
    {
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onGetA1WithA1--ret = " + paramInt1 + ", ssoAccount = *" + bipr.a(paramString));
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onGetTicketNoPasswd--ssoAccount = *" + bipr.a(paramString));
    this.a.b = null;
    ...
    aqsu localaqsu = (aqsu)aqlk.a().a(546);
    paramBundle = "";
    if (paramInt == 32) {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localaqsu.jdField_a_of_type_Int == 1)
          {
            paramBundle = (String)localaqsu.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
            if ((this.a.a(paramString, paramBundle)) && (paramArrayOfByte != null))
            {
              ...
              if ((localaqsu.b != 1) || (paramInt != 0)) {
                break label754;
              }
              this.a.f();
              QQToast.a(BaseApplicationImpl.getContext(), anni.a(2131710006), 1).a();
              ...
              bctj.a(BaseApplicationImpl.getContext()).a("", "kQuickLoginForBrowser", true, 0L, 0L, paramArrayOfByte, "");
              return;
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onUserCancel--action = " + paramInt + ", ssoAccount = *" + bipr.a(paramString));
    this.a.f();
  }
}
