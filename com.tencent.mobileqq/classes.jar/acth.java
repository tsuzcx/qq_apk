...
{
  public acth(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onChanged()
  {
    ...
    if ((6000 == k) && (TextUtils.equals(aljq.z, str)) && (ForwardRecentActivity.a(this.a) != null))
    {
    ...
    if (i < j)
    {
      ...
      if ((localObject2 instanceof akej)) {
        break label227;
      }
    }
    label227:
    do
    {
      ...
      break label197;
      break;
      localObject2 = (akej)localObject2;
    } while ((((akej)localObject2).a == null) || (!TextUtils.equals(((akej)localObject2).a.uin, str)) || (k != ((akej)localObject2).a.getType()));
