...
public class auok
{
  public static Map<String, auok> a;
  public int a;
  public int b;
  public int c;
  public int d;
  ...
  private static void a(String paramString1, String paramString2)
  {
    try
    {
      ...
      auok localauok = new auok();
      localauok.jdField_a_of_type_Int = paramString2.optInt("startupId");
      localauok.b = paramString2.optInt("downloadSucId");
      localauok.c = paramString2.optInt("downloadFailId");
      localauok.d = paramString2.optInt("loadSucId");
      localauok.e = paramString2.optInt("loadFailId");
      localauok.f = paramString2.optInt("startSucId");
      localauok.g = paramString2.optInt("firstUserId");
      localauok.h = paramString2.optInt("exitId");
      jdField_a_of_type_JavaUtilMap.put(paramString1, localauok);
      if (QLog.isColorLevel()) {
        QLog.d("MonitorConfig", 2, paramString1 + localauok);
      }
      return;
    }
  ...
  public static void b(Context paramContext, String paramString)
  {
    if (jdField_a_of_type_JavaUtilMap.get(paramString) != null)
    {
      auoj.b(String.valueOf(((auok)jdField_a_of_type_JavaUtilMap.get(paramString)).jdField_a_of_type_Int));
      return;
    }
    if (QLog.isColorLevel()) {
