...
public class akxo
  extends akxp
{
  public akxo(int paramInt, akxr paramakxr, akxn paramakxn)
  {
    super(paramInt, paramakxr, paramakxn);
  }
  
  public akxo(int paramInt, String paramString, akxr paramakxr, akxn paramakxn)
  {
    super(paramInt, paramString, paramakxr, paramakxn);
  }
  ...
  private aknh b()
  {
    ...
    try
    {
      ...
      {
        localJSONObject.put("is3DBetaTester", akwt.a(localQQAppInterface));
  ...
  private aknh d(String paramString)
  {
    try
    {
      QLog.d("CmShow_SpriteActionScript", 1, new Object[] { "handleJsError mSpriteFrom:", Integer.valueOf(this.jdField_a_of_type_Akxr.e) });
      paramString = new JSONObject(paramString).optString("data");
      alda.a(akwt.b(this.jdField_a_of_type_Akxr.e), 1000, 50, new Object[] { paramString });
      return null;
    }
    catch (Exception paramString)
    {
  ...
  private aknh f(String paramString)
  {
    try
    {
      ...
      if ((i == akwt.b(1)) || (i == akwt.b(2))) {
        alda.a(i, null, new int[] { alcz.a(i, false, this.jdField_a_of_type_Akxr.jdField_b_of_type_Int, -1, true) });
      }
      alda.b(i);
      if ((i == akwt.b(1)) || (i == akwt.b(2)))
      {
        alda.a(akwt.b(this.jdField_a_of_type_Akxr.e), false);
        return null;
      }
    }
    catch (Throwable paramString)
  ...
  private aknh j(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_Akxr.e != 0) {
        return null;
      }
  ...
  private aknh m(String paramString)
  {
    try
    {
      ...
      paramString = this.jdField_a_of_type_Akxn;
      if (paramString != null) {
        return null;
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("pet".equals(paramString.getString("config_name")))
        {
          ...
          if (localObject != null)
          {
            localObject = (akji)((QQAppInterface)localObject).getManager(153);
            if (((akji)localObject).j == null) {
              break label124;
            }
            paramString = new JSONArray(((akji)localObject).j);
  ...
  private aknh p(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Akxr.a();
    if (paramString != null)
    {
      paramString.a();
      return null;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject = akwt.a(ApolloUtil.a());
          if (localObject != null)
          {
  ...
  private aknh q(String paramString)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Akxr == null) || (this.jdField_a_of_type_Akxr.a() == null))
      {
      ...
      if (this.jdField_a_of_type_Akxr.a().a() == null)
      {
    ...
    ApolloUtil.a(this.jdField_a_of_type_Akxr.a().a(), (String)localObject);
    return null;
    label122:
    ...
    if (i > 0)
    {
      ApolloGameUtil.a(this.jdField_a_of_type_Akxr.a(), i, 333002, "message", 1);
      return null;
    }
  ...
  public aknh a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localaknh.jdField_b_of_type_Boolean = true;
        JSONObject localJSONObject = new JSONObject();
        if ((1 == localQQAppInterface.c()) && (((this.jdField_a_of_type_Akxr.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Akxr.jdField_a_of_type_Int != 3000)) || (((1 == localQQAppInterface.a()) || (this.jdField_a_of_type_Akxr.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Akxr.jdField_a_of_type_Int == -2)) && (!localQQAppInterface.k()) && (!localQQAppInterface.l()) && (localQQAppInterface.m()) && (!MediaPlayerManager.a(localQQAppInterface).a()) && ((localQQAppInterface.a() == null) || (!localQQAppInterface.a().k())) && (!localQQAppInterface.c()))))
        {
  ...
  {
    akml localakml = a();
    if ((localakml == null) || (localakml.getLuaState() != paramLong)) {}
    do
    {
      do
      {
      ...
      if ("cs.script_update_boundinglist.local".equals(paramString1)) {
        return a(paramString2, localakml.getRenderImpl().a());
      }
  ...
  public aknh a(String paramString)
  {
    ...
    try
    {
      ...
      akxx localakxx = this.jdField_a_of_type_Akxn.a();
      if (localakxx != null)
      {
        int i = 0;
        if (i < localJSONArray1.length())
        {
          ...
          if (j == 1) {
            localJSONObject2.put("petPath", localakxx.a(new JSONArray(paramString.optString("actionList"))));
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localObject = localakxx.a((String)localObject);
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      ApolloUtil.a().callbackFromRequest(this.jdField_a_of_type_Akxr.a().getLuaState(), 0, "sc.script_notify_user_operation.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Akxr.jdField_b_of_type_Boolean) {
          break label890;
        }
        ...
        if (localObject != null)
        {
          ...
          localJSONObject.put("freeMemory", ((alge)localObject).d);
          localJSONObject.put("totalMemory", ((alge)localObject).jdField_c_of_type_Long);
          localJSONObject.put("maxMemory", ((alge)localObject).jdField_b_of_type_Long);
        }
        localJSONObject.put("aioType", ApolloGameUtil.a(ApolloUtil.a(), paramInt4, this.jdField_a_of_type_Akxr.jdField_a_of_type_JavaLangString));
        ...
        localJSONObject.put("uin", this.jdField_a_of_type_Akxr.jdField_b_of_type_JavaLangString);
        ...
        {
          paramString.put(albu.a(1, Integer.valueOf(localObject[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
        ...
        localJSONObject.put("traceFeatureId", this.jdField_a_of_type_Akxr.a());
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        ApolloCmdChannel.getChannel(paramString1).callbackFromRequest(this.jdField_a_of_type_Akxr.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
      paramString1 = ApolloUtil.a();
      if (paramString1 != null)
      {
        ApolloCmdChannel.getChannelFromOtherProcess(paramString1).callbackFromRequest(this.jdField_a_of_type_Akxr.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Akxr != null) && (this.jdField_a_of_type_Akxr.a() != null)) {
      a(this.jdField_a_of_type_Akxr.a().getWidth(), this.jdField_a_of_type_Akxr.a().getInitHeight(), this.jdField_a_of_type_Akxr.a().getHeight(), this.jdField_a_of_type_Akxr.jdField_a_of_type_Int, this.jdField_a_of_type_Akxr.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Akxr.e);
    }
  }
  ...
  public aknh c(String paramString)
  {
    try
    {
      int i = this.jdField_a_of_type_Akxr.e;
      if (i != 0) {}
      return null;
    }
    catch (Throwable paramString)
