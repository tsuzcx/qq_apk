  ...
  implements DownloadParams.DecodeHandler
{
  ...
  WeakReference<awyo> jdField_a_of_type_JavaLangRefWeakReference;
  
  public awyn(String paramString, awyo paramawyo, Object paramObject)
  {
    if (paramawyo != null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramawyo);
    }
  ...
  public Bitmap run(DownloadParams paramDownloadParams, Bitmap paramBitmap)
  {
    ...
    for (paramDownloadParams = null;; paramDownloadParams = (awyo)this.jdField_a_of_type_JavaLangRefWeakReference.get())
    {
      if (paramDownloadParams != null)
      {
        int[] arrayOfInt = awyq.a(Bitmap.createBitmap(paramBitmap, 0, paramBitmap.getHeight() / 2, paramBitmap.getWidth(), paramBitmap.getHeight() / 2));
