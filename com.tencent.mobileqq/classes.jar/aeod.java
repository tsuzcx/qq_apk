...
{
  public aeod(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131366151)
    {
      ...
      bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D91", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
    }
    label400:
    label1583:
    for (;;)
    {
      ...
      if (i == 2131369073)
      {
        if (this.a.i)
        {
          if (this.a.jdField_a_of_type_Auxu != null)
          {
            this.a.jdField_a_of_type_Auxu.a(false);
          ...
          this.a.finish();
          bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D8F", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
          if (this.a.getIntent().getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
            bdll.b(this.a.app, "dc00898", "", "", "0X8009F7A", "0X8009F7A", 0, 0, "2", "", "", "");
          }
        }
        for (;;)
        {
          ...
          if (ForwardRecentActivity.a(this.a))
          {
            ...
            bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D98", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
          }
          else
          {
            ForwardRecentActivity.d(this.a);
            bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D93", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
          }
        }
      }
      if (i == 2131369044)
      {
        if (ForwardRecentActivity.a(this.a))
        {
          ...
          bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D94", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
        }
      }
      else
      {
        ...
        localObject2 = this.a.jdField_a_of_type_Auxu.a();
        ...
        label475:
        ((Intent)localObject1).putExtras(this.a.jdField_a_of_type_Auxu.a());
      ...
      for (;;)
      {
        ...
        case 2131367061: 
          ...
          bdll.b(this.a.app, "CliOper", "", "", "0X800665F", "0X800665F", 0, 0, "", "", "", "");
          ...
          bdll.b(this.a.app, "CliOper", "", "", "Two_call", "Tc_msg_cate", 0, 0, "0", "", "", "");
          bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D95", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
          ...
          bdll.b(this.a.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerselectpage.select", 0, 0, "", "", "", "");
          break;
          if (this.a.jdField_a_of_type_Auxu != null)
          {
            this.a.jdField_a_of_type_Auxu.a(false);
      ...
      ajnj.a(this.a, this.a.app, (Runnable)localObject1, (Runnable)localObject2);
      localObject2 = this.a.app;
      if (this.a.e) {}
      for (localObject1 = "2";; localObject1 = "1")
      {
        bdll.b((QQAppInterface)localObject2, "dc00899", "Share", "", "select_friend", "clk_addressbook", 0, 0, (String)localObject1, "", "", "");
        break;
      }
      label1086:
      if ((this.a.b == 1) && (this.a.jdField_c_of_type_Int == 2))
      {
        bdll.b(this.a.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.payerselectpage.select", 0, 0, "", "", "", "");
        continue;
        this.a.a("0X8007826");
        i = 1;
        if (!this.a.jdField_a_of_type_Auxu.a(auxr.b)) {
          i = 2;
        }
        ...
        ((Intent)localObject1).putExtra("param_done_button_wording", this.a.getString(2131717847));
        ((Intent)localObject1).putExtra("param_done_button_highlight_wording", this.a.getString(2131717848));
        ...
        bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D92", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
        continue;
        ForwardRecentActivity.a(this.a, (Intent)localObject1);
        if (this.a.i)
        {
          ...
          if (!this.a.jdField_a_of_type_Auxu.a(auxr.d))
          {
          ...
          for (localObject1 = "2";; localObject1 = "1")
          {
            bdll.b((QQAppInterface)localObject2, "dc00899", "Share", "", "select_friend", "clk_group", 0, 0, (String)localObject1, "", "", "");
            new bdlq(this.a.app).a("dc00899").b("Grp_listNew").c("send_to").d("clk_grpList").a();
            break;
            if (this.a.jdField_a_of_type_Auxu.a(auxr.c)) {
              break label1418;
            }
            ((Intent)localObject1).putExtra("onlyOneSegement", true);
        ...
        afez.a(this.a, (Intent)localObject1, PublicTransFragmentActivity.class, ForwardTroopListFragment.class, 20000);
        bdll.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D96", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
      }
    }
  }
}
