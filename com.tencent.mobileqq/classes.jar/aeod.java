...
public class aeod
  extends MqqHandler
{
  public aeod(LoginInfoActivity paramLoginInfoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      paramMessage = this.a.getString(2131715865);
      ...
      for (;;)
      {
        ...
        return;
        paramMessage = paramMessage + this.a.getString(2131717681);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        paramMessage = paramMessage + this.a.getString(2131717682);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        paramMessage = paramMessage + this.a.getString(2131717683);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        LoginInfoActivity.a(this.a).setText(paramMessage);
      }
