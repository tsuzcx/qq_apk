...
public class bcro
{
  ...
  private Object d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return new bcrr(bdoc.a(paramFromServiceMsg.iMsgId, 0), paramToServiceMsg.shResetSeq, paramFromServiceMsg.shFlowLayer, paramFromServiceMsg, paramToServiceMsg.result);
  }
  ...
  private Object o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramToServiceMsg != null)
    {
      awuz.a("Video", "Receive message packet: seq = " + paramFromServiceMsg.getRequestSsoSeq() + " size = " + paramToServiceMsg.vMsgInfos.size());
      return paramToServiceMsg;
    }
    return null;
  }
  ...
  private Object q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    long l1 = bhvd.a(localRespOffFilePack.vBody, 1);
    int i = bhvd.a(localRespOffFilePack.vBody, 5);
    paramFromServiceMsg = new byte[i];
    bhvd.a(paramFromServiceMsg, 0, localRespOffFilePack.vBody, 7, i);
    paramFromServiceMsg = bhvd.a(paramFromServiceMsg, 0, i);
    i += 7;
    if (QLog.isColorLevel()) {
    ...
    default: 
      return null;
    case 1: 
      l2 = bhvd.b(localRespOffFilePack.vBody, i);
      i += 8;
      l3 = bhvd.b(localRespOffFilePack.vBody, i);
      i += 8;
      l4 = bhvd.a(localRespOffFilePack.vBody, i);
      i += 4;
      l5 = bhvd.a(localRespOffFilePack.vBody, i);
      i += 4;
      short s = bhvd.a(localRespOffFilePack.vBody, i);
      j = i + 2;
      i = bhvd.a(localRespOffFilePack.vBody, j);
      j += 2;
      paramToServiceMsg = new byte[i];
      bhvd.a(paramToServiceMsg, 0, localRespOffFilePack.vBody, j, paramToServiceMsg.length);
      j += paramToServiceMsg.length;
      i = bhvd.a(localRespOffFilePack.vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      bhvd.a(arrayOfByte, 0, localRespOffFilePack.vBody, j, arrayOfByte.length);
      i = j + arrayOfByte.length;
      byte b3 = localRespOffFilePack.vBody[i];
      i += 1;
      long l6 = bhvd.a(localRespOffFilePack.vBody, i);
      if (QLog.isColorLevel()) {
    ...
    case 3: 
      ...
      i += 1;
      bhvd.a(localRespOffFilePack.vBody, i);
      i += 2;
      bhvd.a(localRespOffFilePack.vBody, i);
      i += 2;
      bhvd.a(localRespOffFilePack.vBody, i);
      ...
      j = localRespOffFilePack.vBody[i];
      i += 1;
      l2 = bhvd.a(localRespOffFilePack.vBody, i);
      j = i + 4;
      i = bhvd.a(localRespOffFilePack.vBody, j);
      j += 2;
      bhvd.a(new byte[i], 0, localRespOffFilePack.vBody, j, i);
      j += i;
      i = bhvd.a(localRespOffFilePack.vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      bhvd.a(arrayOfByte, 0, localRespOffFilePack.vBody, j, i);
      j += i;
      ...
      bhvd.a((byte[])localObject, 0, localRespOffFilePack.vBody, j, i);
      localObject = bhvd.a((byte[])localObject, 0, i);
      i = j + i;
      j = localRespOffFilePack.vBody[i];
      i += 1;
      l3 = bhvd.a(localRespOffFilePack.vBody, i);
      i += 4;
      l4 = bhvd.a(localRespOffFilePack.vBody, i);
      i += 4;
      bhvd.a(localRespOffFilePack.vBody, i);
    ...
    int j = bhvd.a(localRespOffFilePack.vBody, i);
    paramToServiceMsg = new byte[j];
    bhvd.a(paramToServiceMsg, 0, localRespOffFilePack.vBody, i + 2, j);
