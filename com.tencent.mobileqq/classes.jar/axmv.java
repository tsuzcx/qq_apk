...
public class axmv
{
  ...
  static
  {
    ...
    for (;;)
    {
      if (i < axmq.jdField_b_of_type_ArrayOfJavaLangString.length)
      {
        if (TextUtils.equals("2920", axmq.jdField_b_of_type_ArrayOfJavaLangString[i])) {
      ...
      {
        g = 0;
        e = actj.a(22.0F, BaseApplicationImpl.getApplication().getApplicationContext().getResources());
        f = actj.a(40.0F, BaseApplicationImpl.getApplication().getApplicationContext().getResources());
        return;
      }
      i += 1;
    }
  ...
  {
    int i = 0;
    while (i < axmq.jdField_b_of_type_ArrayOfJavaLangString.length)
    {
      if (TextUtils.equals(paramString, axmq.jdField_b_of_type_ArrayOfJavaLangString[i])) {
        return i;
      }
      i += 1;
    }
  ...
  private static final void a(String paramString)
  {
    ...
    {
      localObject = (axmr)((QQAppInterface)localObject).a(154);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((axmr)localObject).a(bool, i);
      ((axmr)localObject).notifyUI(4, true, new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), paramString });
  ...
  {
    if ((paramInt < 0) || (paramInt >= axmq.jdField_b_of_type_ArrayOfJavaLangString.length))
    {
      if (QLog.isColorLevel()) {
  ...
  public static final int c()
  {
    ...
    for (;;)
    {
      ...
      return i;
      i = axmq.jdField_b_of_type_ArrayOfInt[i];
    }
  }
  ...
  public static int d()
  {
    ...
    for (;;)
    {
      ...
      return i;
      label155:
      i = axmq.jdField_b_of_type_ArrayOfInt[k];
    }
  }
