...
public class yem
  implements Runnable
{
  public yem(NewFriendMoreSysMsgAdapter paramNewFriendMoreSysMsgAdapter, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAdapterNewFriendMoreSysMsgAdapter.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new yen(this, localArrayList));
  }
}
