...
{
  public wxk(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    switch (this.a.jdField_a_of_type_Wxw.getItemViewType(paramInt))
    {
    default: 
    case 0: 
    case 1: 
        ...
        do
        {
          do
          {
            do
            {
              ...
              paramAdapterView = this.a.jdField_a_of_type_Wxw.a(paramInt);
              if ((!this.a.P) || ((paramAdapterView.mediaWidth >= 320) && (paramAdapterView.mediaHeight >= 320))) {
                break;
              }
              paramAdapterView = DialogUtil.a(this.a, 230, null, "图片过小，请重新上传（最小需要320x320）", "好的", null, null, new wxl(this));
              try
              {
            ...
            if ((this.a.G) && (paramAdapterView.mediaWidth > 0) && (paramAdapterView.mediaHeight > 0))
            {
              ...
              {
                QQToast.a(this.a, this.a.getResources().getString(2131434803), 0).b(this.a.getResources().getDimensionPixelSize(2131558448));
                return;
              }
              if ((this.a.o > 0) && (paramAdapterView.fileSize > this.a.o))
              {
                QQToast.a(this.a, this.a.getResources().getString(2131434804, new Object[] { Integer.valueOf(this.a.o / 1048576) }), 0).b(this.a.getResources().getDimensionPixelSize(2131558448));
                return;
              }
            }
            ...
            {
              this.a.c();
              MediaScanner.a(BaseApplicationImpl.getContext()).a(new wxm(this, paramInt), paramAdapterView);
              return;
            }
            if (this.a.O)
            {
              this.a.c();
              MediaScanner.a(BaseApplicationImpl.getContext()).a(new wxn(this, paramInt), paramAdapterView);
              return;
            }
            ...
            paramView = this.a.jdField_a_of_type_Wxw.a(paramInt);
            ...
            if (!Utils.a())
            {
              QQToast.a(this.a, this.a.getResources().getString(2131434770), 0).a();
              return;
            }
            paramView = this.a.jdField_a_of_type_Wxw.a(paramInt);
      ...
      for (;;)
      {
        ...
        this.a.c();
        MediaScanner.a(BaseApplicationImpl.getContext()).a(new wxo(this, paramAdapterView, (ArrayList)localObject), paramView);
        return;
        label2124:
        this.a.f = false;
      ...
      {
        this.a.c();
        MediaScanner.a(BaseApplicationImpl.getContext()).a(new wxp(this, paramInt), paramView);
        return;
      }
      if ((PhotoListActivity.j(this.a)) || (this.a.L))
      {
        this.a.c();
        MediaScanner.a(BaseApplicationImpl.getContext()).a(new wxq(this, paramAdapterView, (ArrayList)localObject), paramView);
        return;
      }
      ...
      if (((PhotoListActivity.d(this.a)) || (PhotoListActivity.e(this.a)) || (PhotoListActivity.k(this.a)) || (PhotoListActivity.f(this.a))) && (this.a.I))
      {
        ...
        PhotoListActivity.m = this.a.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.getFirstVisiblePosition();
        localObject = this.a.jdField_a_of_type_Wxw.a(paramInt);
