...
public class aybg
{
  ...
  public static Drawable a(Context paramContext)
  {
    ...
    return paramContext.getResources().getDrawable(2130845682);
  }
  ...
  public static void a(Context paramContext, SingleLineTextView paramSingleLineTextView, String paramString)
  {
    ...
    do
    {
      ...
      if ((!(localAppRuntime instanceof QQAppInterface)) || (!bcgx.b((QQAppInterface)localAppRuntime, paramString))) {
        break;
      }
  ...
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    return ((localAppRuntime instanceof QQAppInterface)) && (bcgx.b((QQAppInterface)localAppRuntime, paramString));
  }
}
