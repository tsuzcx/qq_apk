...
public class albo
{
  private static albo jdField_a_of_type_Albo;
  private static boolean jdField_a_of_type_Boolean;
  private albd jdField_a_of_type_Albd = new albd(this);
  private final LRULinkedHashMap<String, albq> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(128);
  ...
  private albm a(CustomWebView paramCustomWebView)
  {
  ...
  public static albo a()
  {
    try
    {
      if (jdField_a_of_type_Albo == null) {
        jdField_a_of_type_Albo = new albo();
      }
      albo localalbo = jdField_a_of_type_Albo;
      return localalbo;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Albo != null;
  }
  ...
  private String b(String paramString)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Albd.a(paramString);
      localObject = str;
  ...
  public WebResourceResponse a(String paramString1, String paramString2)
  {
    ...
    if ((paramString1.contains("http://cmshow.qq.com/get_thunder_data?cmd=")) || (paramString1.contains("https://cmshow.qq.com/get_thunder_data?cmd=")))
    {
      ...
      if (!this.jdField_a_of_type_Albd.a(paramString2, paramString1))
      {
        if (QLog.isColorLevel()) {
      ...
      paramString2 = albd.a(paramString2, paramString1);
      localObject = (albq)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString2);
      if (localObject != null) {
        if (albq.a((albq)localObject))
        {
          if (((albq)localObject).a(paramString1))
          {
            if (QLog.isColorLevel()) {
              QLog.d("apollo_client_ApolloWebDataHandler", 2, "getApolloCmdResource, webSSOTask.isValid true, webSSOTask=" + localObject);
            }
            if (albq.a((albq)localObject) != null)
            {
              albq.a((albq)localObject).c = System.currentTimeMillis();
              albq.a((albq)localObject).d = System.currentTimeMillis();
            }
            paramString1 = new WebResourceResponse("text/plain", "utf-8", alao.a(albq.a((albq)localObject).toString()));
      ...
      for (;;)
      {
        return new WebResourceResponse("text/plain", "utf-8", new albs(null, null, null));
        if (QLog.isColorLevel()) {
  ...
  {
    if (this.jdField_a_of_type_Albd != null) {
      return this.jdField_a_of_type_Albd.a(paramString);
    }
    return null;
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, AppInterface paramAppInterface, albr paramalbr)
  {
    if ((TextUtils.isEmpty(paramString1)) || (this.jdField_a_of_type_Albd == null)) {}
    for (;;)
    {
      return;
      ...
      {
        this.jdField_a_of_type_Albd.a(paramAppInterface);
        Object localObject1 = this.jdField_a_of_type_Albd.a(paramString1);
        ...
        else
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            String str = albd.a(paramString1, (String)localObject2);
            albq localalbq = (albq)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str);
            if ((localalbq != null) && (localalbq.a((String)localObject2)))
            {
              if (QLog.isColorLevel()) {
                QLog.d("apollo_client_ApolloWebDataHandler", 2, "preloadSSOCmd, apolloClientId:" + paramString1 + " mPreloadSSOCmds.has WebSSOTask:" + localalbq);
              }
            }
            else
            {
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.remove(str);
              localalbq = new albq(paramalbr, str, (String)localObject2);
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(str, localalbq);
              localObject2 = this.jdField_a_of_type_Albd.a(paramString2, paramString1, (String)localObject2, paramAppInterface);
              if (QLog.isColorLevel()) {
              ...
              if (localObject2 != null) {
                localalbq.a(paramContext, paramString2, (JSONObject)localObject2, paramAppInterface);
              }
            }
          }
        }
  ...
  public boolean a(String paramString)
  {
    ...
    } while (this.jdField_a_of_type_Albd == null);
    return this.jdField_a_of_type_Albd.a(paramString);
  }
  ...
  public boolean a(String paramString1, String paramString2, AppInterface paramAppInterface, WebViewPlugin paramWebViewPlugin)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        albm localalbm = a(paramWebViewPlugin.mRuntime.a());
        if (localalbm == null)
        {
          if (!QLog.isColorLevel()) {
            break label737;
        ...
        if (!this.jdField_a_of_type_Albd.a(str3, str2))
        {
          if (!QLog.isColorLevel()) {
            break label739;
          }
        ...
        str3 = albd.a(str3, str2);
        paramString2 = (albq)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str3);
        if (paramString2 != null)
        {
          if (albq.a(paramString2))
          {
            if (paramString2.a(str2))
            {
              ...
              if (albq.a(paramString2) != null)
              {
                albq.a(paramString2).c = System.currentTimeMillis();
                albq.a(paramString2).d = System.currentTimeMillis();
              }
              paramWebViewPlugin.callJs(str1, new String[] { albq.a(paramString2).toString() });
            ...
            if (localalbm != null)
            {
              paramString2 = localalbm.a();
              paramString2.c = System.currentTimeMillis();
              paramString2 = new albq(paramString2, str3, str2);
              paramString2.a(new albp(this, str1, paramWebViewPlugin));
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    alao.a(alao.d(alao.e(str)), paramString2);
    if (QLog.isColorLevel()) {
