...
public class lsj
  extends kur
{
  public lsj(DoubleVideoMeetingCtrlUI paramDoubleVideoMeetingCtrlUI) {}
      ...
      case 90: 
        if (paramLong3 == 3L) {
          if (this.a.jdField_a_of_type_ComTencentAvUiQavPanel != null)
          {
            ...
            this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131306809, 0);
          }
        }
        break;
      case 96: 
        for (;;)
        {
          if ((!localkvq.j) || (this.a.jdField_c_of_type_Boolean))
          {
            this.a.jdField_c_of_type_Boolean = false;
            this.a.i(paramLong1);
            paramInt1 = localkvq.a(this.a.jdField_b_of_type_Long, 1);
            boolean bool = false;
            if (paramInt1 != -1) {
              bool = ((leb)localkvq.c.get(paramInt1)).a;
            }
          ...
          return;
          if ((paramLong3 != 1L) || (localkvq.an)) {
            break;
          }
          this.a.e("OnGaOprationResult->REQUEST_VIDEO_SUC");
          this.a.a(paramLong1, localkvq.c);
          return;
          this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131306809, 8);
        }
      }
  ...
  protected void c(long paramLong, int paramInt)
  {
    ...
    if ((paramInt != -1) && (((leb)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(paramInt)).a))
    {
