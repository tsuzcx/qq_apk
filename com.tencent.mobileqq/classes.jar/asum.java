  ...
  extends asti
{
  ...
  {
    return atwl.a(paramWeiYunFileInfo.jdField_a_of_type_Long);
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        localObject2 = new asun(this);
        localObject1 = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560842, paramViewGroup, false);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376115));
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.b);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(this.jdField_a_of_type_AndroidViewView$OnLongClickListener);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject2);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView = ((CircleFileStateView)paramView.findViewById(2131361941));
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131366568));
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131366555));
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.b);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject2);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366566));
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetTextView.setGravity(48);
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
        localObject1 = paramView;
        ((asun)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366553));
        localObject1 = paramView;
        ((asun)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369522));
        localObject1 = paramView;
        ((asun)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncClipSize(afur.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        localObject1 = paramView;
      ...
      try
      {
        i = atvo.a(localWeiYunFileInfo.c);
        atvo.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localWeiYunFileInfo.h, i);
        ...
        if ((atvo.a(localWeiYunFileInfo.c) == 0) && (bgmg.b(localWeiYunFileInfo.h))) {
        ...
        localObject1 = atxd.b(localWeiYunFileInfo.b) + a((String)localObject2, (String)localObject1);
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(athc.a(localWeiYunFileInfo));
      ...
      return paramView;
      localObject1 = paramView;
      paramViewGroup = (asun)paramView.getTag();
      continue;
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView.setVisibility(0);
