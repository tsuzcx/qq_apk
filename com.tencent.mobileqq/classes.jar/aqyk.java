  ...
  extends Animation
{
  ...
  @TargetApi(11)
  public aqyk(Path paramPath, float paramFloat, View paramView1, View paramView2, aqyj paramaqyj)
  {
  ...
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      aqyj localaqyj = this.jdField_a_of_type_Aqyj;
      ((View)localObject).setRotation(f * paramFloat * aqyj.jdField_b_of_type_Float);
    }
    if (this.jdField_a_of_type_Aqyj.jdField_b_of_type_Boolean)
    {
      f = this.jdField_a_of_type_AndroidViewAnimationInterpolator.getInterpolation(paramFloat);
      this.jdField_a_of_type_AndroidViewView.setScaleX(this.jdField_a_of_type_Aqyj.c * f);
      this.jdField_a_of_type_AndroidViewView.setScaleY(f * this.jdField_a_of_type_Aqyj.c);
    }
