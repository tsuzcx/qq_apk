...
public class rgv
{
  ...
  public static rgv a(feeds_info.AccountProfile paramAccountProfile)
  {
    Object localObject;
    ...
    do
    {
      return localObject;
      localrgv = new rgv();
      localrgv.jdField_a_of_type_Long = paramAccountProfile.uint64_uin.get();
      localrgv.jdField_a_of_type_Int = paramAccountProfile.uint32_account_type.get();
      if (paramAccountProfile.bytes_desc.has()) {
        localrgv.c = paramAccountProfile.bytes_desc.get().toStringUtf8();
      }
      if (paramAccountProfile.bytes_profile_photo_url.has()) {
        localrgv.b = paramAccountProfile.bytes_profile_photo_url.get().toStringUtf8();
      }
      if (paramAccountProfile.bytes_nick.has()) {
        localrgv.jdField_a_of_type_JavaLangString = paramAccountProfile.bytes_nick.get().toStringUtf8();
      }
      localObject = localrgv;
    } while (!paramAccountProfile.bytes_home_page_url.has());
    localrgv.d = paramAccountProfile.bytes_home_page_url.get().toStringUtf8();
    return localrgv;
  }
