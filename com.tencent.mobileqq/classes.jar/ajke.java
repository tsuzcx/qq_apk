  ...
  implements BusinessObserver
{
  ...
  private ajkf jdField_a_of_type_Ajkf;
  private final String jdField_a_of_type_JavaLangString;
  private final List<ajkd> jdField_a_of_type_JavaUtilList;
  private JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private boolean jdField_a_of_type_Boolean;
  private final String jdField_b_of_type_JavaLangString;
  private boolean jdField_b_of_type_Boolean;
  
  public ajke(ajkf paramajkf, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_b_of_type_JavaLangString = paramString1;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Ajkf = paramajkf;
  }
  ...
  public JSONObject a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (i == 1001)
    {
      ...
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", ajya.a(2131700587));
    }
    for (;;)
    {
      localJSONObject.put("ssoRet", 202);
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", ajya.a(2131700584));
      label473:
      do
      {
        localJSONObject.put("ssoRet", 255);
        localJSONObject.put("businessRet", 0);
        localJSONObject.put("msg", ajya.a(2131700588));
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      while (localIterator.hasNext()) {
        ((ajkd)localIterator.next()).a(this, this.jdField_a_of_type_Ajkf);
      }
  ...
  public void a(ajkd paramajkd)
  {
    if (paramajkd != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramajkd);
    }
  }
  ...
  public void a(Context paramContext, String paramString, JSONObject paramJSONObject, AppInterface paramAppInterface)
  {
    ...
    if ((paramJSONObject.optInt("needCookie") == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("apollo_client_ApolloWebDataHandler", 2, "Get cookie:" + nau.c((String)localObject, new String[0]) + " from " + nau.b(paramString, new String[0]));
      }
    }
    ...
    if (this.jdField_a_of_type_Ajkf != null)
    {
      paramContext = this.jdField_a_of_type_Ajkf;
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    try
    {
      ...
      a();
      if (this.jdField_a_of_type_Ajkf != null) {
        this.jdField_a_of_type_Ajkf.b = System.currentTimeMillis();
      }
      return;
    }
    catch (Exception paramBundle)
