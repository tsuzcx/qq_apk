...
public class sgc
{
  private static sgc jdField_a_of_type_Sgc;
  ...
  private Map<seu, Boolean> jdField_a_of_type_JavaUtilMap = new WeakHashMap();
  ...
  public static sgc a()
  {
    if (jdField_a_of_type_Sgc == null) {}
    try
    {
      if (jdField_a_of_type_Sgc == null) {
        jdField_a_of_type_Sgc = new sgc();
      }
      return jdField_a_of_type_Sgc;
    }
    finally {}
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Sgf == null) {
      this.jdField_a_of_type_Sgf = new sgf(this, null);
    }
    ...
    this.l = true;
    BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(this.jdField_a_of_type_Sgf, paramActivity);
    if (this.jdField_a_of_type_Sgd == null) {
      this.jdField_a_of_type_Sgd = new sgd(this);
    }
    ThreadManager.excute(new VideoVolumeControl.2(this), 16, null, true);
    if (this.jdField_a_of_type_Sge == null) {
      this.jdField_a_of_type_Sge = new sge(this);
    }
  ...
  public void a(seu paramseu)
  {
    ...
    {
      paramseu.b(b());
      if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramseu)) {
        this.jdField_a_of_type_JavaUtilMap.put(paramseu, Boolean.valueOf(true));
      }
      paramseu.a(this.jdField_a_of_type_Sge);
      this.jdField_d_of_type_Int = 1;
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "addVideoManager :" + paramseu + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 149	sgc:k	Z
    //   7: aload_0
    //   8: getfield 75	sgc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +82 -> 93
    //   14: aload_0
    //   15: getfield 89	sgc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +75 -> 93
    ...
    //   63: aload_0
    //   64: getfield 75	sgc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   67: aload_0
    //   68: getfield 89	sgc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   71: invokevirtual 336	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   74: aload_0
    //   75: getfield 149	sgc:k	Z
    //   78: ifeq +18 -> 96
    //   81: aload_0
    //   82: getfield 75	sgc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 89	sgc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   95: return
    //   96: aload_0
    //   97: getfield 75	sgc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   100: aload_0
    //   101: getfield 89	sgc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   104: ldc2_w 175
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) || (paramInt == 0))
    {
      ...
      Object localObject;
      for (boolean bool1 = false; paramString.hasNext(); bool1 = ((seu)localObject).b() | bool1)
      {
        localObject = (seu)paramString.next();
        if (localObject == null) {
          break label450;
        }
        ((seu)localObject).b(paramBoolean);
      }
    ...
    for (;;)
    {
      try
      {
        if (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130843011));
          ((ImageView)paramString.get()).setContentDescription(anni.a(2131715124));
        }
      }
      ...
      return;
      label399:
      ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130843012));
      ((ImageView)paramString.get()).setContentDescription(anni.a(2131715125));
      break label459;
      label444:
      paramInt = n;
      break label241;
  ...
  public void b(Activity paramActivity)
  {
    if (this.jdField_b_of_type_JavaLangString.equals(paramActivity.toString()))
    {
      ...
      if (!"".equals(this.jdField_b_of_type_JavaLangString))
      {
        BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(this.jdField_a_of_type_Sgf);
        ThreadManager.excute(new VideoVolumeControl.4(this), 16, null, true);
      }
      this.jdField_a_of_type_Sge = null;
      this.jdField_a_of_type_Sgf = null;
  ...
  public void b(seu paramseu)
  {
    if (paramseu != null) {
      this.jdField_a_of_type_JavaUtilMap.remove(paramseu);
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "removeVideoManager :" + paramseu + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
