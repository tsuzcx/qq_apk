  ...
  extends BaseJsPlugin
{
  ...
  {
    MiniAppController.getInstance().setActivityResultListener(new bkkx(this, paramRequestEvent));
    ...
    paramRequestEvent.fail(anvx.a(2131704835));
  }
  ...
  public void getMultiMemList(RequestEvent paramRequestEvent)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramRequestEvent)
      {
        ...
        return;
        paramRequestEvent.fail(anvx.a(2131704836));
        return;
        if (localJSONObject != null) {
          continue;
        }
      ...
      {
        paramRequestEvent.fail(anvx.a(2131704837));
        return;
