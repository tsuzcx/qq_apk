...
public class pqa
{
  ...
  public static String a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      return paramString;
      localPair = a(pjj.a, paramInt2, paramInt1);
  ...
  public static URL a(BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.length() > 0))
    {
      ...
      if (paramBaseArticleInfo != null) {
        try
        {
          paramBaseArticleInfo = usq.a(paramBaseArticleInfo.optString("picture"), 3);
  ...
  public static URL a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label57:
    for (localObject = pjr.e();; localObject = pjr.a())
    {
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.d("RIJPreParseData", 2, "preParseProteusItemData", paramArticleInfo);
      }
    }
  }
  ...
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.a != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.a.size() > 0))
    {
      paramBaseArticleInfo = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.a.iterator();
      while (paramBaseArticleInfo.hasNext())
      {
        rrr localrrr = (rrr)paramBaseArticleInfo.next();
        if (localrrr != null)
        {
          localrrr.b = a(localrrr.b);
          localrrr.c = a(localrrr.c);
        }
      }
    }
  }
        ...
        if ((localJSONArray != null) && (localJSONArray.length() > 0))
        {
          ...
          if (i == 2)
          {
            ...
            if (i < localJSONArray.length())
            {
              ...
              arrayOfURL[i] = usq.a(paramBaseArticleInfo, 3);
              break label220;
            }
          }
          else
  ...
  public static void b(BaseArticleInfo paramBaseArticleInfo)
  {
    for (;;)
    {
      try
      {
        ...
        if ((ppe.h(paramBaseArticleInfo)) && (!ppe.l(paramBaseArticleInfo)))
        {
          paramBaseArticleInfo.mSinglePicture = a(((rsj)paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rsh.a.get(0)).d, true, true);
          ...
          if (paramBaseArticleInfo.mVideoCoverUrl != null) {
            paramBaseArticleInfo.mVideoCoverUrl = usq.a(paramBaseArticleInfo.mVideoCoverUrl.toString(), 3);
          }
          if (QLog.isColorLevel()) {
        ...
        if (((paramBaseArticleInfo instanceof ArticleInfo)) && ((ppe.a((ArticleInfo)paramBaseArticleInfo)) || (ppe.f((ArticleInfo)paramBaseArticleInfo))))
        {
          paramBaseArticleInfo.mSinglePicture = a(paramBaseArticleInfo.mFirstPagePicUrl, ppe.g((ArticleInfo)paramBaseArticleInfo), true);
      ...
      paramBaseArticleInfo.mSinglePicture = b(paramBaseArticleInfo.mFirstPagePicUrl, ppe.g((ArticleInfo)paramBaseArticleInfo), true);
    }
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      break;
      label587:
      if (((paramBaseArticleInfo instanceof ArticleInfo)) && (!ppe.q((ArticleInfo)paramBaseArticleInfo))) {
        paramBaseArticleInfo.busiType = ((rrs)paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.get(0)).f;
      }
      return;
    }
  }
  ...
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrl != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrl.a != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrl.a.size() > 0))
    {
      paramBaseArticleInfo = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrl.a.iterator();
      while (paramBaseArticleInfo.hasNext())
      {
        rrm localrrm = (rrm)paramBaseArticleInfo.next();
        if (localrrm != null)
        {
          localrrm.b = a(localrrm.b);
          localrrm.c = a(localrrm.c);
        }
      }
    }
  }
