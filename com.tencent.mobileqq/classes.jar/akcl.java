  ...
  extends akac
{
  ...
  public akcl(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private String a()
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajed.M, 0);
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      {
        axcy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool1);
        localajnf = (ajnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
        j = localajnf.c();
        axcy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.M, 0);
        localajnf.b();
        a(4014, true, null);
        return;
      }
    ...
    if ((j != m) && (m == 0)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.M, 0, true, true);
    }
    localajnf.a(new atcp(paramToServiceMsg, l1));
    return;
    label884:
    j = k;
    if (m == 0)
    ...
    axcy.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    label1328:
    label1334:
    label1340:
    label1876:
    if (j == 0)
    {
      ...
      if (paramRspSystemMsgNew.size() > 0)
      {
        ...
        l3 = axcy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.M, 0, l3);
        localObject2 = paramFromServiceMsg.iterator();
        if (j < 20) {
          while (((Iterator)localObject2).hasNext())
          {
            localObject1 = (ChatMessage)((Iterator)localObject2).next();
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajed.M, 0, ((ChatMessage)localObject1).uniseq, false);
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajed.M, 0, ((ChatMessage)localObject3).uniseq, false);
            ((Iterator)localObject2).remove();
          }
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            if ((j == 13) && (((ajjj)localObject1).b(str)))
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajed.M, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
        ...
        {
          axcy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l2);
          ...
          if ((!ajml.a(paramRspSystemMsgNew)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {
            break label1925;
          }
          bool2 = true;
          ...
          localajnf.a(new atcp(paramObject, l1));
        }
      }
    }
    for (;;)
    {
      ...
      axcy.a().a(true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label1925:
      bool2 = false;
      break label1842;
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    RecentUser localRecentUser = localakeu.a(ajed.D, 4000);
    localRecentUser.msgType = 25;
    localRecentUser.displayName = ajnf.jdField_a_of_type_JavaLangString;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      if (m == 3)
      {
        afcz.a(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew, paramFromServiceMsg, i1, str1);
        return;
      }
      afcz.a(paramRspSystemMsgNew, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    } while (n == 0);
    this.d = 0;
    ...
    axcz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i1);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajed.V, 9000, i1 - j);
    paramObject = new ArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.N, 0, true, false);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.R, 0, true, false);
    axcz.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    paramToServiceMsg = (arom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
    if (paramToServiceMsg != null) {
      paramToServiceMsg.a(false);
    }
    Collections.sort(paramFromServiceMsg, new akcm(this));
    j = 0;
    if (j < n)
    {
      localObject1 = awbi.a(-2018);
      ((MessageRecord)localObject1).msgtype = -2018;
      ((MessageRecord)localObject1).selfuin = str1;
      ((MessageRecord)localObject1).frienduin = ajed.N;
      ...
      if ((m == 1) && (!bool1)) {
        if ((k == 2) && (i3 == 2))
        {
          ...
          if (((TroopManager)localObject3).b(str2) == null)
          {
            ...
            ((ajtg)localObject4).a(paramToServiceMsg.troopuin, false, "", true, true, true, false);
            ((ajtg)localObject4).a(1, ajex.a(paramToServiceMsg.troopuin), 0L, 2, 0, 0, true);
            ((ajtg)localObject4).notifyUI(127, true, new Object[] { str2 });
          }
          if (localMessageForSystemMsg.structMsg.msg.msg_invite_extinfo.has())
          {
            ...
            if ((k == 2) || (k == 4))
            {
              ...
              aqay.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForSystemMsg, paramToServiceMsg, str2);
              if (QLog.isColorLevel()) {
            ...
            bool1 = false;
            label1729:
            paramToServiceMsg = (ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
            if (paramToServiceMsg != null) {
        ...
        else
        {
          ...
          else
          {
            ...
            if ((k == 2) && (i3 == 2))
            {
              ...
              {
                if ((k == 2) || (k == 4)) {
                  aqay.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForSystemMsg, paramToServiceMsg, String.valueOf(l1));
                }
                bool2 = bool3;
                if (k == 4) {
                  bool2 = false;
            ...
            else if ((k == 13) || (k == 6))
            {
              ...
              if ((paramToServiceMsg != null) && (!paramToServiceMsg.a(((structmsg.StructMsg)localObject2).msg.group_code.get(), ((structmsg.StructMsg)localObject2).msg_time.get())))
              {
                ...
                if (localObject4 != null) {
                  ((ajtg)localObject4).a(str2, (String)localObject3, true);
                }
                paramToServiceMsg.a(((structmsg.StructMsg)localObject2).msg.group_code.get(), ((structmsg.StructMsg)localObject2).msg_time.get());
              }
            }
    ...
    if (paramObject.size() > 0)
    {
      ...
      if ((!ajml.a(paramObject)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {
        break label3830;
      }
    }
    label3830:
    for (bool1 = true;; bool1 = false)
    {
      ...
      if (!TextUtils.isEmpty(paramRspSystemMsgNew.grp_msg_display.get())) {
        axcz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew.grp_msg_display.get());
      }
      if ((paramRspSystemMsgNew.msg_ribbon_group.has()) && (paramRspSystemMsgNew.msg_ribbon_group.get() != null))
      {
        ...
        paramToServiceMsg = awbi.a(-2018);
        paramToServiceMsg.selfuin = str1;
        paramToServiceMsg.frienduin = ajed.R;
      ...
      paramToServiceMsg = (ajqs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
      paramRspSystemMsgNew = ((MessageForSystemMsg)paramObject.get(0)).getSystemMsg();
      axcz.a().a(paramRspSystemMsgNew);
      l1 = paramRspSystemMsgNew.msg_time.get();
      paramToServiceMsg.a(ajed.V, 9000, ajjy.a(2131625516), l1, l1);
  ...
  public void a()
  {
    ...
    a(true, true, false, 0L, new akcq(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, String paramString)
  {
    ...
    paramSystemMsgActionInfo = new axtb();
    ...
    paramSystemMsgActionInfo.jdField_a_of_type_Axta = new akco(this);
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, structmsg.StructMsg paramStructMsg, boolean paramBoolean)
  {
    ...
    localaxtb.a();
    localaxtb.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgAction.Friend";
    localaxtb.jdField_a_of_type_ArrayOfByte = ((structmsg.ReqSystemMsgAction)localObject).toByteArray();
    ...
    localaxtb.jdField_a_of_type_JavaLangObject = localObject;
    localaxtb.jdField_a_of_type_Axta = new akcp(this, paramInt6, paramInt3, paramSystemMsgActionInfo, paramStructMsg, paramLong2);
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    {
      aqay.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte, paramLong1, paramLong2, paramMsgHead);
      b(2001, true, null);
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, short paramShort, int paramInt1, msg_comm.Msg paramMsg, int paramInt2)
  {
    ...
    while (paramShort != 190)
    {
      ...
      localObject = SystemMsg.decode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bach.a((byte[])localObject), String.valueOf(str), paramInt1);
      if (localObject != null) {}
      for (localObject = ((SystemMsg)localObject).strGameName;; localObject = "")
      {
        ...
        aeyw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong1, paramLong2, paramShort, paramMsg, paramInt2);
        return;
      }
    }
    ((ajjj)localObject).a(str, false);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_suspicious_seq");; l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_seq"))
    {
      ...
      axtb localaxtb = new axtb();
      localaxtb.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Group";
      localaxtb.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
      localaxtb.jdField_a_of_type_Axta = new akcs(this, l2, l3, l1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localaxtb);
      return;
    }
  }
  ...
  public void b()
  {
    ...
    axtb localaxtb = new axtb();
    localaxtb.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Friend";
    localaxtb.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
    localaxtb.jdField_a_of_type_Axta = new akcr(this, l1, l2, l3);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localaxtb);
  }
  ...
  public void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject = new axtb();
      ((axtb)localObject).a();
      ((axtb)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Group";
      ((axtb)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
      ((axtb)localObject).jdField_a_of_type_JavaLangObject = new Integer(paramInt);
      ((axtb)localObject).jdField_a_of_type_Axta = new akcn(this);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((axtb)localObject);
      return;
  ...
  public void d()
  {
    ...
    a(true, true, false, 0L, new akct(this, l, localReqSystemMsgRead));
  }
  ...
  public void e()
  {
    ...
    a(true, true, false, 0L, new akcu(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void g()
  {
    ...
    localObject = new axtb();
    ((axtb)localObject).a();
    ((axtb)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Friend";
    ((axtb)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
    ((axtb)localObject).jdField_a_of_type_Axta = new akcv(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((axtb)localObject);
  }
