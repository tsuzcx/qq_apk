...
{
  public mnv(VideoLayerUI paramVideoLayerUI, View paramView)
  {
    super(paramView);
  }
  ...
  private Rect a(int paramInt)
  {
    ...
    if ((this.a.jdField_a_of_type_ArrayOfMgp != null) && (this.a.jdField_a_of_type_ArrayOfMgp[paramInt].a() == 0)) {
      localRect.set(this.a.jdField_a_of_type_ArrayOfMgp[paramInt].b());
    }
    return localRect;
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ArrayOfMgp != null) && (paramInt >= 0) && (paramInt < this.a.jdField_a_of_type_ArrayOfMgp.length))
    {
      int i = -1;
      ...
      for (;;)
      {
        ...
        str2 = this.a.jdField_a_of_type_ArrayOfMgp[paramInt].b();
        if (str2 == null) {
          break label214;
        }
        if (!str2.equals(str1)) {
  ...
  {
    if (this.a.jdField_a_of_type_ArrayOfMgp != null)
    {
      int i = this.a.jdField_a_of_type_ArrayOfMgp.length - 1;
      while (i >= 0)
      {
        if ((this.a.jdField_a_of_type_ArrayOfMgp[i].a() == 0) && (this.a.jdField_a_of_type_ArrayOfMgp[i].b().contains((int)paramFloat1, (int)paramFloat2))) {
          return i;
        }
        i -= 1;
      }
  ...
  public void getVisibleVirtualViews(List<Integer> paramList)
  {
    if (this.a.jdField_a_of_type_ArrayOfMgp != null)
    {
      int j = this.a.jdField_a_of_type_ArrayOfMgp.length;
      int i = 0;
      while (i < j)
      {
