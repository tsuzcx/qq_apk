...
import com.tencent.biz.pubaccount.readinjoy.viola.modules.BridgeModuleHelper.1;
import com.tencent.biz.pubaccount.readinjoy.viola.modules.BridgeModuleHelper.11;
import com.tencent.biz.pubaccount.readinjoy.viola.modules.BridgeModuleHelper.14;
import com.tencent.biz.pubaccount.readinjoy.viola.modules.BridgeModuleHelper.19;
import com.tencent.biz.pubaccount.readinjoy.viola.modules.BridgeModuleHelper.20;
import com.tencent.biz.pubaccount.readinjoy.viola.modules.BridgeModuleHelper.9;
...
public class tjg
{
  ...
  {
    tgc.a(String.valueOf(paramJSONObject.optInt("bid", 3256)), new tji(paramBridgeModule, paramString));
  }
  ...
  public static void B(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      nny.a(localArrayList, pay.a(), new tjj(paramBridgeModule, paramString), true, false);
      return;
    }
  ...
  public static void C(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject = nny.a(paramJSONObject.optString("bid"));
  ...
  public static void E(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          localReadInJoyUserInfoModule = pay.a();
    ...
    localReadInJoyUserInfoModule.a(localArrayList, new tjp(localArrayList, paramString, paramBridgeModule));
  }
  ...
  private static HashMap<String, Object> a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null)
    {
      ...
      if (TextUtils.isEmpty(paramJSONObject.optString("bgclr"))) {
        localHashMap.put(thu.d, paramJSONObject.optString("bgclr"));
      }
      if (TextUtils.isEmpty(paramJSONObject.optString("txtclr"))) {
        localHashMap.put(thu.c, paramJSONObject.optString("txtclr"));
      }
      if (!TextUtils.isEmpty(paramJSONObject.optString("titleclr"))) {
        localHashMap.put(thu.e, paramJSONObject.optString("titleclr"));
      }
      if (!TextUtils.isEmpty(paramJSONObject.optString("alpha"))) {
        localHashMap.put(thu.f, paramJSONObject.optString("alpha"));
      }
      if (!TextUtils.isEmpty(paramJSONObject.optString("statusBarColor"))) {
        localHashMap.put(thu.g, paramJSONObject.optString("statusBarColor"));
      }
      return localHashMap;
    }
    return null;
  ...
  {
    JSONObject localJSONObject = new JSONObject();
    Object localObject3 = (QQAppInterface)pay.a();
    String str;
  ...
  {
    if (((QQAppInterface)pay.a() != null) && (paramActivity != null))
    {
  ...
  {
    pay.a(paramContext, paramString, paramBundle);
  }
  ...
  private static void a(ArticleInfo paramArticleInfo, JSONObject paramJSONObject, Intent paramIntent, long paramLong1, long paramLong2, int paramInt1, String paramString, int paramInt2, BridgeModule paramBridgeModule)
  {
    ...
    Object localObject = "";
    if (i == 1) {
      localObject = new String(bfuc.decode(paramJSONObject.optString("newComment"), 2));
    }
    if (i == 1)
    {
      paramJSONObject = (JSONObject)localObject;
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList != null)
      {
        paramJSONObject = (JSONObject)localObject;
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList.size() > 0) {
      ...
      if (localObject != null) {
        ((pks)((QQAppInterface)localObject).getManager(163)).a().a(pay.a(), paramLong1, paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep, 0L, paramJSONObject, paramLong2, -1L, paramInt1, paramString, paramInt2, paramArticleInfo);
      }
  ...
  {
    paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj = new rfj();
    a(paramJSONObject, paramArticleInfo);
    paramArticleInfo.mTitle = new String(bfuc.decode(paramString1, 0));
    paramArticleInfo.mSummary = "";
    if ((paramInt1 == 3) || (paramInt1 == 2))
    {
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      paramString1 = new rfk();
      ...
      if ((paramJSONObject != null) && (paramJSONObject.length() > 0))
      {
        ...
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_JavaUtilArrayList.add(paramString1);
      }
    }
    for (;;)
    {
      if (paramInt2 == 22)
      {
        ...
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Rem = paramJSONObject;
      }
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Int = paramInt1;
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_JavaLangString = paramArticleInfo.mTitle;
      return;
      if ((paramInt1 == 4) || (paramInt1 == 5))
      {
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.b = new ArrayList();
        paramString1 = new rfl();
        ...
        if (paramJSONObject != null)
        {
          ...
          paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.b.add(paramString1);
        }
      }
      else if (paramInt1 == 1)
      {
  ...
  private static void a(BridgeModule paramBridgeModule, String paramString, File paramFile)
  {
    ...
    paramFile = new bgoe(paramString, paramFile);
    paramFile.d = 60L;
    ((bgog)pay.a().getManager(47)).a(1).a(paramFile, new tjv(paramBridgeModule, paramString), localBundle);
  }
  ...
  public static void a(BridgeModule paramBridgeModule, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, String paramString3, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("network", ozb.a(paramBridgeModule.getViolaInstance().getActivity()));
      ...
      catch (Exception paramString1)
      {
        ...
        odq.a(null, "", "0X8009546", "0X8009546", 0, 0, "", paramString5, "", paramBridgeModule.a().a(), false);
      }
      paramBridgeModule = new sie(paramBridgeModule);
      if (paramInt4 != 4) {
        continue;
      }
      odq.a(null, "", "0X8009546", "0X8009546", 0, 0, "", paramString4, paramString3, paramBridgeModule.a().a(), false);
      return;
      if (paramInt4 == 11) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramString1))
      {
        if (!TextUtils.isEmpty(paramString2)) {
          paramBridgeModule.invokeErrorCallJS(paramString2, amtj.a(2131700341));
        }
      }
      else
      {
        if ((paramString1.contains("weishi")) || (paramString1.contains("weishi://feed"))) {
          if (yqu.a(localBaseActivity)) {
            uit.a(localBaseActivity, "video_type_videopublic");
          }
        }
        while (!TextUtils.isEmpty(paramString2))
        {
          ...
          return;
          QQToast.a(localBaseActivity, -1, amtj.a(2131700347), 0).b(localBaseActivity.getResources().getDimensionPixelSize(2131299076));
          uit.b(localBaseActivity, "video_type_videopublic");
          continue;
          if (!twr.a(localBaseActivity, paramString1))
          {
            ...
            localIntent.putExtra("big_brother_ref_source_key", pay.f(0));
  ...
  public static void a(BridgeModule paramBridgeModule, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      bool = bfwv.a(localBaseActivity, paramString1);
      continue;
      label122:
      i = 0;
    }
  ...
  {
    BaseActivity localBaseActivity = BaseActivity.sTopActivity;
    paramBridgeModule = new tjk(paramBridgeModule, paramString);
    if (localBaseActivity == null)
    {
      paramBridgeModule.onAdFailedToLoad(null, new abkz(5));
      return;
    }
    ...
    twt.a().a(localBaseActivity, paramString, l1, l2, i, j, paramBridgeModule);
  }
  ...
  public static void a(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        String str2 = new String(bfuc.decode(paramJSONObject.optString("title", ""), 0));
        ...
        if (Boolean.valueOf(bool3).booleanValue())
        {
          ...
          localBundle.putString("scroll_image_r5", pay.a(i, -1, Integer.toString(n), m, "", "", null));
          localBundle.putString("read_article_r5", pay.a(i, -1, Integer.toString(n), m, "", null));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (paramFragment = ((ViolaFragment)paramFragment).getTtileChangelistener();; paramFragment = null)
        {
          ...
          if (str.equals("right"))
          {
            paramFragment.a(paramJSONObject, new tjm(paramBridgeModule, paramString));
            return;
          }
          if (!str.equals("left")) {
            break;
          }
          paramFragment.b(paramJSONObject, new tjn(paramBridgeModule, paramString));
          return;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramJSONObject)
      {
        try
        {
          ...
          j = k;
          localObject = str1;
          twt.a().a(localBaseActivity, i, (String)localObject, j, paramString, paramJSONObject);
          return;
        }
        catch (Exception paramJSONObject)
        {
  ...
  public static void a(JSONObject paramJSONObject)
  {
    BaseActivity localBaseActivity = BaseActivity.sTopActivity;
    if (localBaseActivity != null) {
      tgc.a(localBaseActivity, paramJSONObject);
    }
  }
  ...
  private static void a(JSONObject paramJSONObject, ArticleInfo paramArticleInfo)
  {
    ...
    if (paramJSONObject != null)
    {
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Rep = new rep();
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList = new ArrayList();
      int i = 0;
      for (;;)
      {
        if (i < paramJSONObject.length())
        {
          ...
          localBiuCommentInfo.jdField_b_of_type_JavaLangString = new String(bfuc.decode(((JSONObject)localObject).optString("comment"), 0));
          ...
          localBiuCommentInfo.c = ((JSONObject)localObject).optInt("op_type");
          String str1 = ((JSONObject)localObject).optString("jumpName");
          String str2 = ((JSONObject)localObject).optString("jumpUrl");
          if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2))) {
            localBiuCommentInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$JumpInfo = new SocializeFeedsInfo.JumpInfo(0L, new String(bfuc.decode(str1, 0)), str2);
          }
          try
          {
            ...
            paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
            i += 1;
          }
  ...
  private static void a(JSONObject paramJSONObject, ArticleInfo paramArticleInfo, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep = new rep();
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaLangLong = Long.valueOf(paramLong1);
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_b_of_type_JavaLangLong = Long.valueOf(paramLong2);
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList = new ArrayList();
    } while (paramJSONObject == null);
    int i = 0;
    while (i < paramJSONObject.length())
    {
      ...
      try
      {
        ...
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
        i += 1;
      }
      catch (Exception localException)
      {
  ...
  public static void a(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramJSONObject = new String(bfuc.decode((String)localObject, 0));
  ...
  public static void a(JSONObject paramJSONObject, String paramString, Activity paramActivity)
  {
    ...
    for (int i = DisplayUtil.dip2px(localBaseActivity, j / 2);; i = 640)
    {
      int m;
      if (paramJSONObject.has("height")) {
        m = paramJSONObject.optInt("height");
      }
      for (int k = DisplayUtil.dip2px(localBaseActivity, m / 2);; k = 640)
      {
  ...
  public static void a(JSONObject paramJSONObject, String paramString, BridgeModule paramBridgeModule)
  {
    ...
    try
    {
      localObject1 = new String(bfuc.decode((String)localObject8, 0));
    }
    ...
    try
    {
      localObject2 = new String(bfuc.decode((String)localObject3, 0));
    }
    ...
    try
    {
      ...
      str2 = new String(bfuc.decode(paramJSONObject.optString("accountDesc"), 0));
      ...
      if ((localJSONObject == null) || (!pgb.a(m, l3))) {
        break label1065;
      }
  ...
  {
    JSONObject localJSONObject = new JSONObject();
    String str1 = DeviceInfoUtil.getAndroidID();
  ...
  private static void b(BridgeModule paramBridgeModule, SosoInterface.SosoLbsInfo paramSosoLbsInfo, String paramString)
  {
  ...
  private static void b(BridgeModule paramBridgeModule, File paramFile)
  {
    ...
    atky.a(paramBridgeModule, (Intent)localObject, 18);
  }
  ...
  private static void b(BridgeModule paramBridgeModule, String paramString1, String paramString2)
  {
    ...
    paramString1 = LbsManagerService.getCachedLbsInfo(paramString1);
  ...
  public static void b(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        ((StringBuilder)localObject).append("&uin=" + pay.a());
        paramString = aqyy.a("VIP_xingying", ((StringBuilder)localObject).toString());
        if (QLog.isColorLevel()) {
  ...
  public static void b(JSONObject paramJSONObject)
  {
    ...
    {
      odq.a(null, null, str, str, 0, 0, paramJSONObject, (String)localObject1, (String)localObject2, (String)localObject3, false);
      return;
      label114:
      paramJSONObject = "";
      break;
  ...
  public static void c(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    nmb.a(pay.a(), new tjo(paramBridgeModule, paramString), localReqBody.toByteArray(), "OidbSvc.0xe36", 3638, 1, new Bundle(), 5000L);
  }
  
  private static void c(BridgeModule paramBridgeModule, String paramString1, String paramString2)
  {
    LbsManagerService.startLocation(new tjl(paramString1, paramBridgeModule, paramString2));
  }
  ...
  public static void c(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      pkm.a().a(str, Integer.valueOf(paramJSONObject).intValue());
      paramBridgeModule.invokeCallJS(paramString, null);
      return;
    }
    catch (Exception paramBridgeModule)
  ...
  public static void c(JSONObject paramJSONObject, String paramString)
  {
    ...
    tgc.a(BaseActivity.sTopActivity, "", paramString, localBundle);
  }
  ...
  public static void g(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    ((ViolaFragment)localObject).setTitleContainerClick(new tju(paramBridgeModule, paramString));
  }
  ...
  public static void g(JSONObject paramJSONObject)
  {
    try
    {
      abrl.a("BridgeModuleHelper", paramJSONObject.toString());
      abrs.a(paramJSONObject.optInt("operationType"), paramJSONObject.optInt("businessType"), (qq_ad_get.QQAdGetRsp.AdInfo)abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramJSONObject.getJSONObject("adInfo")));
      return;
    }
    catch (Exception paramJSONObject)
    {
      abrl.d("BridgeModuleHelper", "handleJsCallRequest", paramJSONObject);
    }
  }
  ...
  public static void h(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    {
      QQToast.a(pay.a().getApplication(), 1, amtj.a(2131700346), 0).a();
      return;
    }
  ...
  {
    Object localObject = (AppInterface)pay.a();
    ...
    try
    {
      ...
      if (pay.g() >= 2)
      {
        QQToast.a(paramBridgeModule, 0, paramBridgeModule.getString(2131717351), 0).b(paramBridgeModule.getResources().getDimensionPixelSize(2131299076));
        return;
      }
    }
    catch (Exception paramJSONObject)
    {
      ...
      oph.a(paramBridgeModule, (Bundle)localObject, (byte)116);
      pay.a("2", "2");
    }
  }
  ...
  public static void i(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      localObject2 = new String(bfuc.decode(paramJSONObject, 0));
    ...
    catch (Exception localException2)
    {
      for (;;)
      {
        QLog.e("BridgeModuleHelper", 1, "showCommentEditor | defaultTxt decode error! | defaultTxt: " + paramJSONObject);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("BridgeModuleHelper", 2, "showCommentEditor | defaultTxt after decode: " + paramJSONObject);
    }
    localObject2 = new Intent();
    ((Intent)localObject2).putExtra("comment_type", false);
    ((Intent)localObject2).putExtra("arg_comment_enable_anonymous", bool1);
    ((Intent)localObject2).putExtra("arg_comment_placeholder", (String)localObject1);
    ((Intent)localObject2).putExtra("arg_comment_default_txt", paramJSONObject);
    ((Intent)localObject2).putExtra("arg_comment_max_length", i);
    ((Intent)localObject2).putExtra("arg_comment_comment_type", j);
    ((Intent)localObject2).putExtra("arg_comment_source_type", k);
    ((Intent)localObject2).putExtra("arg_callback", paramString);
    ((Intent)localObject2).putExtra("arg_comment_open_at", m);
    ((Intent)localObject2).putExtra("comment_can_biu", bool2);
    ((Intent)localObject2).putExtra("public_fragment_window_feature", 1);
    if (localJSONArray != null) {
      ((Intent)localObject2).putExtra("arg_comment_default_comment_at", localJSONArray.toString());
    }
    PublicTransFragmentActivity.b(paramBridgeModule, (Intent)localObject2, ReadInJoyCommentComponentFragment.class, 117);
  }
  ...
  public static void i(JSONObject paramJSONObject)
  {
    ...
    for (float f1 = FlexConvertUtils.converPxByViewportToRealPx(paramJSONObject.opt("width"), 750);; f1 = 100.0F)
    {
      ...
      paramJSONObject = URLDrawable.getDrawable(str, thj.a(bool, (int)f1, (int)f2));
  ...
  public static void j(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    localObject = DeviceInfoUtil.getQQVersionWithCode((Context)localObject);
  ...
  public static void j(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (str3.isEmpty())
    {
      ...
      paramString.b(n);
      paramJSONObject.putExtra("comment_create_data", paramString);
      adxr.a(paramBridgeModule, paramJSONObject, PublicTransFragmentActivity.class, ReadInJoyCommentComponentFragment.class, 126);
      return;
    }
  }
  ...
  public static void k(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("result", bgoa.a());
      paramBridgeModule.invokeCallJS(paramString, localJSONObject);
      return;
    }
    catch (Exception paramBridgeModule)
  ...
  public static void k(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    qoj.a.a().a(i, bool1, bool2, str, j, paramJSONObject, new tjq(paramBridgeModule, paramString));
  }
  ...
  public static void m(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      for (;;)
      {
        QQToast.a((Context)localObject, i, str, 0).b(((Context)localObject).getResources().getDimensionPixelSize(2131299076));
  ...
  public static void n(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      if (!TextUtils.isEmpty(str1))
      {
        ...
        paramJSONObject.putString("big_brother_ref_source_key", pay.f(0));
      }
    }
    for (;;)
    {
  ...
  public static void p(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    {
      return;
      Object localObject = uit.b(paramString);
      if (localObject != null)
      {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("big_brother_source_key", pay.f(0));
  ...
  public static void p(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    QQCustomDialog localQQCustomDialog = new QQCustomDialog(localBaseActivity, 2131755826);
    ...
    localQQCustomDialog.getMessageTextView().setMaxHeight(DisplayUtil.dip2px(localBaseActivity, 200.0F));
    ...
    if (paramJSONObject.optBoolean("needOkBtn", true)) {
      localQQCustomDialog.setPositiveButton(paramJSONObject.optString("okBtnText", amtj.a(2131700340)), new tjr(paramJSONObject, paramBridgeModule, paramString));
    }
    if (paramJSONObject.optBoolean("needCancelBtn", true)) {
      localQQCustomDialog.setNegativeButton(paramJSONObject.optString("cancelBtnText", amtj.a(2131700336)), new tjs(paramJSONObject, paramBridgeModule, paramString));
    }
  ...
  public static void q(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    tgc.a(localBaseActivity, paramJSONObject, new tjt(paramBridgeModule, paramString));
  }
  ...
  public static void s(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramBridgeModule.invokeErrorCallJS(paramString, amtj.a(2131700349));
  }
  ...
  public static void t(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      paramBridgeModule.invokeCallJS(paramString, localJSONObject);
      QQToast.a(pay.a().getApplication(), 1, amtj.a(2131700350), 0).a();
      return;
    }
    catch (Exception paramBridgeModule)
    {
  ...
  public static void v(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      paramJSONObject = paramJSONObject.optString("apkUrl");
      localObject = bhyo.a().b(paramJSONObject);
      j = -1;
      i = 0;
      if (localObject != null)
      {
  ...
  public static void w(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    do
    {
      ...
      for (localObject = "未知";; localObject = DeviceInfoUtil.getNetInfo(localBaseActivity).networkType)
      {
        ...
        paramBridgeModule.invokeCallJS(paramString, null);
        return;
        localObject = DeviceInfoUtil.getNetInfo(localBaseActivity).operatorName;
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  public static void x(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      else
      {
        ...
        if (localObject2 != null)
        {
          beqn.a((Activity)localObject2, j, paramJSONObject, null, null, false, bool, (String)localObject1, 100, null, null, null, null, "", true);
          paramBridgeModule.invokeCallJS(paramString, null);
          return;
        }
      }
  ...
  public static void y(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      CheckPermission.requestSDCardPermission((AppActivity)localActivity, new tjh(paramBridgeModule, paramJSONObject, paramString));
      return;
    }
    z(paramBridgeModule, paramJSONObject, paramString);
  }
  ...
  public static void z(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append("&device=" + Build.DEVICE);
      ((StringBuilder)localObject).append("&uin=" + pay.a());
      paramJSONObject = aqyy.a("VIP_xingying", ((StringBuilder)localObject).toString());
      if (QLog.isColorLevel()) {
