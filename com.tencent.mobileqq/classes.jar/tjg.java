  ...
  extends LinearLayout
{
  ...
  public tjg(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
  {
    ...
    {
      localDrawable = this.jdField_a_of_type_Tjf.a();
      if (this.jdField_a_of_type_Tjf == null) {
        break label176;
      }
      localCharSequence1 = this.jdField_a_of_type_Tjf.a();
      if (this.jdField_a_of_type_Tjf == null) {
        break label182;
      }
      localCharSequence2 = this.jdField_a_of_type_Tjf.b();
      label48:
  ...
  public void a(@Nullable tjf paramtjf)
  {
    if (paramtjf != this.jdField_a_of_type_Tjf)
    {
  ...
  public boolean performClick()
  {
    ...
    if (this.jdField_a_of_type_Tjf != null)
    {
      ...
      tjf localtjf = TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat);
      if (TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) == this.jdField_a_of_type_Tjf) {
        i = 1;
      }
      this.jdField_a_of_type_Tjf.a();
      if ((TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) != null) && (i == 0)) {
        TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat).a(this.jdField_a_of_type_Tjf, localtjf, 1);
      }
      return true;
    }
    return bool;
