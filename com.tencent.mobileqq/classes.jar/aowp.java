  ...
  implements ayth
{
  ...
  public aowp(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(ayti paramayti, aytj paramaytj)
  {
    long l2 = 0L;
    ...
    long l1;
    boolean bool1;
    if ((paramaytj.a.getResultCode() == 1002) || (paramaytj.a.getResultCode() == 1013))
    {
      i = -100001;
      QLog.i("ProtocolManager", 1, "onForwardOfflineResponse: resp is timeout[" + paramaytj.a.getResultCode() + "]");
      l1 = 0L;
      paramaytj = null;
      bool1 = false;
    }
    ...
    {
      bool1 = bool2;
      ((aown)((aowr)paramayti.jdField_a_of_type_JavaLangObject).a()).a(bool1, i, (String)localObject1, paramaytj, l1, l2);
      return;
      if (paramaytj.a.getResultCode() != 1000)
      {
        i = -100002;
        QLog.i("ProtocolManager", 1, "onForwardOfflineResponse: resp is failed[" + paramaytj.a.getResultCode() + "]");
        l1 = 0L;
        paramaytj = null;
        bool1 = false;
      }
      else
      {
        ...
        try
        {
          ((cmd0x346.RspBody)localObject3).mergeFrom(paramaytj);
        ...
        catch (InvalidProtocolBufferMicroException paramaytj)
        {
          paramaytj.printStackTrace();
          l1 = 0L;
          paramaytj = null;
          bool1 = false;
        }
    ...
    for (i = ((cmd0x346.ApplyForwardFileRsp)localObject3).int32_ret_code.get();; i = 0)
    {
      ...
      for (paramaytj = ((cmd0x346.ApplyForwardFileRsp)localObject3).str_ret_msg.get();; paramaytj = null)
      {
        ...
        for (l1 = ((cmd0x346.ApplyForwardFileRsp)localObject3).uint64_total_space.get();; l1 = 0L)
        {
          ...
          localObject1 = paramaytj;
          paramaytj = localObject2;
          break;
          break label96;
        }
      }
  ...
  private void a(String paramString, byte[] paramArrayOfByte, aowr paramaowr, int paramInt1, int paramInt2, int paramInt3)
  {
    ayti localayti = new ayti();
    localayti.jdField_a_of_type_JavaLangString = paramString;
    localayti.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    localayti.jdField_a_of_type_JavaLangObject = paramaowr;
    localayti.jdField_a_of_type_Int = paramInt1;
    localayti.b = paramInt2;
    localayti.c = paramInt3;
  ...
  private void b(ayti paramayti, aytj paramaytj)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    int i = -100003;
    ...
    {
      i = -100001;
      QLog.i("ProtocolManager", 1, "onForwardOfflineToOther: resp is timeout[" + paramaytj.a.getResultCode() + "]");
      paramaytj = null;
      bool1 = false;
    }
    label90:
    ...
    while (i != 0)
    {
      ...
      ((aown)((aowr)paramayti.jdField_a_of_type_JavaLangObject).a()).a(bool1, i, (String)localObject1, paramaytj, 0L, 0L);
      return;
      if (paramaytj.a.getResultCode() != 1000)
      {
        i = -100002;
        QLog.i("ProtocolManager", 1, "onForwardOfflineToOther: resp is failed[" + paramaytj.a.getResultCode() + "]");
        paramaytj = null;
        bool1 = false;
      }
      else
    ...
    for (i = ((cmd0x346.ApplyCopyToRsp)localObject3).int32_ret_code.get();; i = 0)
    {
      ...
      for (paramaytj = ((cmd0x346.ApplyCopyToRsp)localObject3).str_ret_msg.get();; paramaytj = null)
      {
        localObject1 = localObject2;
  ...
  private void c(ayti paramayti, aytj paramaytj)
  {
    boolean bool = false;
    String str = "";
    Object localObject2 = null;
    ...
    if ((paramaytj.a.getResultCode() == 1002) || (paramaytj.a.getResultCode() == 1013))
    {
      QLog.i("ProtocolManager", 1, "internalForwardDiscFile: resp is timeout[" + paramaytj.a.getResultCode() + "]");
      localObject1 = null;
      paramaytj = "";
    }
    for (int i = -100001;; i = -100002)
    {
      ((aown)((aowr)paramayti.jdField_a_of_type_JavaLangObject).a()).a(bool, i, paramaytj, (String)localObject1, 0L, 0L);
      return;
      if (paramaytj.a.getResultCode() == 1000) {
        break;
      }
      QLog.i("ProtocolManager", 1, "internalForwardDiscFile: resp is failed[" + paramaytj.a.getResultCode() + "]");
      localObject1 = null;
      paramaytj = "";
    }
    paramaytj = paramaytj.a.getWupBuffer();
    ...
    for (;;)
    {
      try
      {
        ((cmd0x345.RspBody)localObject3).mergeFrom(paramaytj);
      ...
      label434:
      for (paramaytj = ((cmd0x345.RspBody.SubCmd0x6RspBody)localObject1).str_ret_msg.get();; paramaytj = "")
      {
  ...
  private void d(ayti paramayti, aytj paramaytj)
  {
    boolean bool = false;
    ...
    if ((paramaytj.a.getResultCode() == 1002) || (paramaytj.a.getResultCode() == 1013))
    {
      QLog.i("ProtocolManager", 1, "=_= ^! [CS Replay]handleUploadResponse: resp is timeout[" + paramaytj.a.getResultCode() + "]");
      i = -100001;
      paramaytj = localObject;
    }
    for (;;)
    {
      ((aowo)((aowr)paramayti.jdField_a_of_type_JavaLangObject).a()).a(bool, i, paramaytj);
      return;
      if (paramaytj.a.getResultCode() != 1000)
      {
        QLog.i("ProtocolManager", 1, "=_= ^! [CS Replay]handleUploadResponse: resp is failed[" + paramaytj.a.getResultCode() + "]");
        i = -100002;
        paramaytj = localObject;
      }
      else
      {
        ...
        try
        {
          localRspBody.mergeFrom(paramaytj);
        ...
        continue;
        label224:
        paramaytj = (cmd0x346.ApplyUploadRspV3)localRspBody.msg_apply_upload_rsp_v3.get();
        bool = true;
      }
    }
  }
  
  private void e(ayti paramayti, aytj paramaytj)
  {
    boolean bool = false;
    int i = -1;
    String str = "";
    ...
    {
      i = -100001;
      QLog.i("ProtocolManager", 1, "handleUploadSuccResponse: resp is timeout[" + paramaytj.a.getResultCode() + "]");
      paramaytj = str;
    }
    cmd0x346.RspBody localRspBody;
    for (;;)
    {
      if (paramayti.jdField_a_of_type_JavaLangObject != null) {
        ((aowm)((aowr)paramayti.jdField_a_of_type_JavaLangObject).a()).a(bool, i, paramaytj);
      }
      return;
      if (paramaytj.a.getResultCode() != 1000)
      {
        i = -100002;
        QLog.i("ProtocolManager", 1, "handleUploadSuccResponse: resp is failed[" + paramaytj.a.getResultCode() + "]");
        paramaytj = str;
      }
      else
      {
    ...
    paramaytj = (cmd0x346.UploadSuccRsp)localRspBody.msg_upload_succ_rsp.get();
    if (paramaytj.int32_ret_code.has()) {
      i = paramaytj.int32_ret_code.get();
    }
    if (paramaytj.str_ret_msg.has()) {}
    for (paramaytj = paramaytj.str_ret_msg.get();; paramaytj = "")
    {
      bool = true;
      break;
    }
  ...
  {
    if ("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_APPLY_FORWARD_FILE-700".equals(paramayti.jdField_a_of_type_JavaLangString)) {
      a(paramayti, paramaytj);
    }
    for (;;)
    {
      if ("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_UPLOAD_SUCC-800".equals(paramayti.jdField_a_of_type_JavaLangString)) {
        e(paramayti, paramaytj);
      }
      return;
      if ("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_APPLY_COPY_TO-60100".equals(paramayti.jdField_a_of_type_JavaLangString))
      {
        b(paramayti, paramaytj);
      }
      else if ("GTalkFileAppSvr.CMD_DISCUSS_FILE".equals(paramayti.jdField_a_of_type_JavaLangString))
      {
        aowr localaowr = (aowr)paramayti.jdField_a_of_type_JavaLangObject;
        int i = localaowr.a();
        if (i == 6) {
          c(paramayti, paramaytj);
        } else if (i == 7) {
          c(paramayti, paramaytj);
        } else {
          QLog.w("ProtocolManager", 1, "unspourt:" + localaowr.a());
        }
      }
      else if ("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_APPLY_UPLOAD_V3-1700".equals(paramayti.jdField_a_of_type_JavaLangString))
      {
        d(paramayti, paramaytj);
      }
    }
  }
  
  public void a(String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, aown paramaown)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      localObject = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramInt1);
      if (localObject != null) {
    ...
    paramString2 = new aowr(this, paramaown);
  ...
  public void a(String paramString1, int paramInt1, String paramString2, int paramInt2, aowq paramaowq, int paramInt3, int paramInt4, aown paramaown)
  {
    ...
    localSubCmd0x6ReqBody.uint64_file_size.set(paramaowq.jdField_a_of_type_Long);
    localSubCmd0x6ReqBody.bytes_uuid.set(ByteStringMicro.copyFrom(paramaowq.b.getBytes()));
    if (!TextUtils.isEmpty(paramaowq.c)) {
      localSubCmd0x6ReqBody.bytes_file_md5.set(ByteStringMicro.copyFrom(paramaowq.c.getBytes()));
    }
    ...
    localSubCmd0x6ReqBody.str_file_name.set(paramaowq.jdField_a_of_type_JavaLangString);
    localSubCmd0x6ReqBody.str_src_file_path.set(paramaowq.b);
    ...
    if ((paramInt1 != 1) && (paramInt1 != 0))
    {
      ...
      paramString1 = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramInt1);
  ...
  public void a(String paramString1, String paramString2, aowq paramaowq, int paramInt1, int paramInt2, int paramInt3, aown paramaown)
  {
    ...
    localApplyCopyToReq.uint64_file_size.set(paramaowq.jdField_a_of_type_Long);
    localApplyCopyToReq.str_file_name.set(paramaowq.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString1, String paramString2, aowq paramaowq, aown paramaown)
  {
    ...
    localSubCmd0x5ReqBody.bytes_src_file_path.set(ByteStringMicro.copyFrom(paramaowq.b.getBytes()));
    localSubCmd0x5ReqBody.uint32_dst_uin.set(Integer.parseInt(paramString1));
    localSubCmd0x5ReqBody.uint64_file_size.set(paramaowq.jdField_a_of_type_Long);
    localSubCmd0x5ReqBody.uint32_from_uin.set(Integer.parseInt(paramString2));
    localSubCmd0x5ReqBody.str_file_name.set(paramaowq.jdField_a_of_type_JavaLangString);
    if ((paramaowq.c != null) && (paramaowq.c.length() > 0)) {
      localSubCmd0x5ReqBody.bytes_md5.set(ByteStringMicro.copyFrom(paramaowq.c.getBytes()));
    }
    paramString1 = new cmd0x345.ReqBody();
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, aowo paramaowo)
  {
    ...
    paramString1 = new aowr(this, paramaowo);
    a("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_APPLY_UPLOAD_V3-1700", localReqBody.toByteArray(), paramString1, paramInt1, paramInt2, 1);
  }
  
  public void a(String paramString, byte[] paramArrayOfByte, int paramInt1, int paramInt2, aowm paramaowm)
  {
    ...
    paramString = null;
    if (paramaowm != null) {
      paramString = new aowr(this, paramaowm);
    }
