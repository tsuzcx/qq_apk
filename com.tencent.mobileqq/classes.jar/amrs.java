...
@TargetApi(11)
public class amrs
  implements amqs, anca, SurfaceTexture.OnFrameAvailableListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnInfoListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  ...
  private anau jdField_a_of_type_Anau = new amrt(this);
  private anaw jdField_a_of_type_Anaw;
  ...
  private anat jdField_b_of_type_Anat;
  ...
  public amrs(amqu paramamqu, amru paramamru)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Amqu = paramamqu;
    this.jdField_a_of_type_Amru = paramamru;
    this.jdField_e_of_type_Int = paramamru.jdField_e_of_type_Int;
    this.jdField_d_of_type_Int = paramamru.jdField_d_of_type_Int;
    this.jdField_a_of_type_Anaw = paramamru.jdField_a_of_type_Anaw;
    this.jdField_a_of_type_JavaLangString = paramamru.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Long = paramamru.jdField_b_of_type_Long;
    boolean bool2 = amsa.a();
    if ((bool2) || (this.jdField_a_of_type_Amru.jdField_a_of_type_Boolean)) {
      bool1 = true;
    }
    this.k = bool1;
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "Construction mSoftwarePlayConfig:" + this.k + "  isRubbishDevice:" + bool2 + "  isSoftPlay:" + this.jdField_a_of_type_Amru.jdField_a_of_type_Boolean);
    }
  }
  ...
  {
    if (paramBoolean) {
      if (this.jdField_b_of_type_Anat == null)
      {
        this.jdField_b_of_type_Anat = anav.a(this.jdField_a_of_type_Anaw, 3);
        this.jdField_b_of_type_Anat.a(amsa.jdField_b_of_type_ArrayOfFloat, amsa.jdField_a_of_type_ArrayOfShort);
        this.jdField_b_of_type_Anat.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Anau);
        this.jdField_b_of_type_Anat.a(this.jdField_a_of_type_Amru.jdField_c_of_type_Int, this.jdField_a_of_type_Amru.jdField_a_of_type_Float, this.jdField_a_of_type_Amru.jdField_b_of_type_Float, this.jdField_a_of_type_Amru.jdField_c_of_type_Float);
      }
    }
    while (this.jdField_a_of_type_Anat != null) {
      return;
    }
    this.jdField_a_of_type_Anat = anav.a(this.jdField_a_of_type_Anaw, 1);
    this.jdField_a_of_type_Anat.a(amsa.jdField_a_of_type_ArrayOfFloat, amsa.jdField_a_of_type_ArrayOfShort);
    this.jdField_a_of_type_Anat.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Anau);
    this.jdField_a_of_type_Anat.a(this.jdField_a_of_type_Amru.jdField_c_of_type_Int, this.jdField_a_of_type_Amru.jdField_a_of_type_Float, this.jdField_a_of_type_Amru.jdField_b_of_type_Float, this.jdField_a_of_type_Amru.jdField_c_of_type_Float);
  }
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Amqu.a(paramArrayOfByte1);
    } while (!this.l);
    this.l = false;
  }
  ...
  {
    if ((!this.jdField_d_of_type_Boolean) || (paramArrayOfFloat2 == null) || (this.jdField_a_of_type_Amru == null)) {
      return;
    }
    ...
    label54:
    int m;
    if (this.jdField_a_of_type_Amru.jdField_b_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_Anat != null)
      {
        paramArrayOfFloat2 = this.jdField_a_of_type_Anat;
        m = this.jdField_a_of_type_Int;
        paramArrayOfFloat3 = this.jdField_a_of_type_Anaw;
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Anat != null)
      {
        paramArrayOfFloat2 = this.jdField_b_of_type_Anat;
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2) {
      if (this.jdField_a_of_type_Amru.jdField_a_of_type_Amuo != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Amru.jdField_a_of_type_Amuo.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Amru.jdField_a_of_type_Amuo.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Amru.jdField_a_of_type_Amuo.jdField_c_of_type_Float, this.jdField_a_of_type_Amru.jdField_a_of_type_Amuo.d, this.jdField_a_of_type_Amru.jdField_a_of_type_Amuo.e);
      }
    }
    for (;;)
    {
    ...
    if (this.jdField_a_of_type_Amru.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Amru != null) {
      return this.jdField_a_of_type_Amru.jdField_a_of_type_Int;
    }
    return 4;
  }
  ...
  {
    if (this.jdField_a_of_type_Amru != null) {
      return this.jdField_a_of_type_Amru.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Amru.jdField_a_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Anbz = new anbz(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture);
    this.jdField_a_of_type_Anbz.a(this);
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Anbz);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "start, arResourceInfo=" + this.jdField_a_of_type_Amru);
    }
    ...
    String str2 = anby.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (String str1 = "true";; str1 = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bfhi.d(this.jdField_a_of_type_JavaLangString));
  ...
  public void f()
  {
    ...
    try
    {
      ...
      if (this.jdField_b_of_type_Anat != null)
      {
        this.jdField_b_of_type_Anat.b();
        this.jdField_b_of_type_Anat = null;
      }
      HashMap localHashMap = new HashMap();
      localHashMap.put("decode_type", String.valueOf(this.jdField_f_of_type_Int));
      azmz.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_decode_type", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Amqu != null) {
          this.jdField_a_of_type_Amqu.a(this.jdField_a_of_type_Amru.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Amqu != null) {
      this.jdField_a_of_type_Amqu.b(2, this.jdField_e_of_type_Int - this.jdField_c_of_type_Int);
    }
    ...
    } while (this.jdField_a_of_type_Amqu == null);
    this.jdField_a_of_type_Amqu.a(paramTVK_IMediaPlayer);
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    this.jdField_a_of_type_Amqu.a(this.jdField_a_of_type_JavaLangRunnable);
    if (!this.j)
    {
      this.j = true;
  ...
  public void onVideoPrepared(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Amqu != null)
        {
          this.jdField_a_of_type_Amqu.b(0, this.jdField_e_of_type_Int);
          return;
        }
      }
