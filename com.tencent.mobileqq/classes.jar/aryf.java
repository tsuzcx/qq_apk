...
public class aryf
{
  ...
  private static NativeMonitorConfig a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramSharedPreferences)) {
      try
      {
        ...
        return (NativeMonitorConfig)awfy.a(paramSharedPreferences, NativeMonitorConfig.class);
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int i = bhsi.aF(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int k = bhsi.aG(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (k != m)
    {
      bhsi.Y(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), m);
      i = 0;
    }
    String str;
    if (j != i)
    {
      str = arry.b(paramConfig, i, paramInt);
    ...
    for (;;)
    {
      try
      {
        ...
        paramConfig = (NativeMonitorConfig)awfy.a(paramConfig, NativeMonitorConfig.class);
        if (paramConfig == null)
        {
          a(new NativeMonitorConfig());
          bhsi.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
          bhsi.s(paramQQAppInterface.getApp(), 0);
      ...
      catch (JSONException paramConfig)
      {
        ...
        a(paramConfig);
        bhsi.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, str);
        bhsi.s(paramQQAppInterface.getApp(), paramConfig.soHook);
        continue;
      }
      a(new NativeMonitorConfig());
      bhsi.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (localNativeMonitorConfig != null)
      {
        ...
        aoil.a(jdField_a_of_type_ComTencentMobileqqDataNativemonitorNativeMonitorConfig.getTmChance());
      }
  ...
  public static void b()
  {
    ...
    //   59: new 432	aryg
    //   62: dup
    //   63: invokespecial 433	aryg:<init>	()V
    //   66: invokevirtual 436	com/tencent/mobileqq/nativememorymonitor/library/NativeMemoryMonitor:setupSoLoadHook	(Landroid/content/Context;Lcom/tencent/mobileqq/nativememorymonitor/library/ExternalProvider;)V
    //   69: goto -42 -> 27
    //   72: astore_1
    //   73: ldc 2
    //   75: monitorexit
