...
class adtx
  implements bcjc
{
  adtx(adtw paramadtw, boolean paramBoolean) {}
  ...
  public void a(View paramView)
  {
    ...
    if ((paramView instanceof AnimationTextView))
    {
      ...
      f1 = ((AnimationTextView)localObject).touchL - adtw.a();
      f2 = ((AnimationTextView)localObject).touchT;
      f3 = adtw.b();
      if (this.jdField_a_of_type_Boolean) {
        f1 = ((AnimationTextView)localObject).touchL - adtw.c();
      }
    ...
    for (int i = k;; i = -1)
    {
      ...
      {
        anzm.a((aykp[])localObject, f1, f2 - f3, bool2, i, j, this.jdField_a_of_type_Adtw.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Adtw.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Activity)this.jdField_a_of_type_Adtw.jdField_a_of_type_AndroidContentContext, bool1);
        return;
        label314:
        bool2 = false;
        break;
