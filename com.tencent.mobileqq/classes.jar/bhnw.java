...
public class bhnw
{
  public static WebViewFragment a(bhne parambhne, WebViewTabBarData paramWebViewTabBarData, Intent paramIntent)
  {
    ...
    if (i == 3)
    {
      ...
      if (parambhne != null) {
        return parambhne.a(paramIntent);
      }
    ...
    if (i == 4)
    {
      ...
      if ((i == 1) && (TextUtils.isDigitsOnly(paramWebViewTabBarData.tag)))
      {
        ...
        blpu.d("WebViewFragmentBuilder", "tab_id =" + paramWebViewTabBarData.tag);
