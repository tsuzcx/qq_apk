  ...
  extends BaseAdapter
{
  ...
  public xwo(List<QQStoryUserInfo> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentBizQqstorySettingsQQStoryShieldListActivity).inflate(2131561806, null);
      paramView = new xwp(this);
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView.setMaxWidth(this.jdField_a_of_type_ComTencentBizQqstorySettingsQQStoryShieldListActivity.a.widthPixels - afur.a(175.0F, this.jdField_a_of_type_ComTencentBizQqstorySettingsQQStoryShieldListActivity.getResources()));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131365325));
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (xwp)paramView.getTag();
      localView = paramView;
      ...
      break label186;
      label349:
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(bgmo.a());
    }
  }
}
