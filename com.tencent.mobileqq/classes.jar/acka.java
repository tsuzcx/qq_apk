  ...
  implements azwh
{
  ...
  public acka(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Adie = new adie(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    {
      this.b = l;
      this.jdField_a_of_type_Ahpb = new ahpb(this, paramQQAppInterface);
      this.jdField_a_of_type_Ahpd = new ahpd(paramBaseChatPie);
      this.jdField_a_of_type_Ackb = new ackb(this);
      return;
    }
  }
  ...
  protected static void a(MessageForStructing paramMessageForStructing, acju paramacju, View paramView, boolean paramBoolean)
  {
    int i = 2130848707;
    int j = 2130848514;
    int k = 2130838139;
    ...
    for (i = k;; i = 2130838123)
    {
      ...
      if (!paramMessageForStructing.structingMsg.hasFlag(4))
      {
        ...
        if (paramBoolean) {}
        for (i = j;; i = 2130848515) {
          break;
        }
      }
      if (paramBoolean) {}
      for (i = 2130838139;; i = 2130838123)
      {
        paramView.setBackgroundResource(i);
        return;
      }
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (anam.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(anam.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  public void a(View paramView)
  {
    if ((this.jdField_a_of_type_ComTencentWidgetListView instanceof ChatXListView)) {
      ((ChatXListView)this.jdField_a_of_type_ComTencentWidgetListView).a.a(paramView);
    }
  }
  
  public void a(View paramView, ChatMessage paramChatMessage, int paramInt)
  {
    this.jdField_a_of_type_Adie.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131298565);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((awbk.a(localChatMessage1.msgtype)) || (akbm.i(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!awbk.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!akbm.i(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    if (i < paramList.size())
    {
      ...
      if ((bool2) && ((i == 0) || ((localChatMessage.time < this.b) && (localChatMessage.time - l1 > 300L)) || ((localChatMessage.time >= this.b) && (localChatMessage.time - l1 > 300L) && ((localObject == null) || (localChatMessage.time - localObject.time > 60L))) || ((this.jdField_a_of_type_AndroidSupportV4UtilArraySet.contains(Long.valueOf(localChatMessage.uniseq))) && (l1 / 60L != localChatMessage.time / 60L))))
      {
        bool1 = true;
        label172:
    ...
    for (;;)
    {
      ...
      paramCharSequence = (ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))) {
        ((amxv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(214)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramInt);
      }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Ahpd.c();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Ackb.a != null)
    {
      ahpo localahpo = this.jdField_a_of_type_Ackb.a.a();
      if ((localahpo == null) || (!localahpo.c())) {
        break label41;
      }
      localahpo.d();
    }
    label41:
    while (!this.jdField_a_of_type_Ackb.a.a()) {
      return;
    }
    this.jdField_a_of_type_Ackb.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return this.jdField_a_of_type_Adie.a(localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    baio.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage1.getClass().getName());
    ackk localackk = this.jdField_a_of_type_Adie.a(localChatMessage1, this);
    if (paramInt != 0)
    {
    ...
    paramView = localackk.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage1, paramView, paramViewGroup, this.jdField_a_of_type_Ackb);
    if (paramView != null)
    {
      paramView.setTag(2131298565, localChatMessage1);
      if (((localackk instanceof acjb)) && ((paramView instanceof aftx))) {
        paramViewGroup = (aftx)paramView;
      }
    }
    baio.a("AIO_ChatAdapter_getView" + " | " + localChatMessage1.getClass().getName(), null);
    return paramView;
  }
