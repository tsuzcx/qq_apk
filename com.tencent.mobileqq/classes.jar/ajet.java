  ...
  implements aivr
{
  ...
  public ajet(int paramInt, ajfb paramajfb)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.b = ("cmshow_script_" + paramInt + ".js");
    this.jdField_a_of_type_Ajfb = paramajfb;
    if ((paramajfb != null) && (paramajfb.a() != null)) {
      this.jdField_a_of_type_Ajfg = ((ajfg)paramajfb.a().getManager(249));
    }
  ...
  {
    String str = ajkk.b(paramString, paramQQAppInterface);
    ...
    ajfc.a(paramQQAppInterface, str, new ajew(this, paramBoolean, paramQQAppInterface, paramString, paramInt1, paramArrayOfInt, paramInt2));
  }
  ...
  public aivb a()
  {
    ...
    return this.jdField_a_of_type_Ajfb.a();
  }
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Ajfb == null)) {
    ...
    {
      return;
      localaivb = this.jdField_a_of_type_Ajfb.a();
    } while (localaivb == null);
    localaivb.runRenderTask(new SpriteAioScript.1(this, paramString, localaivb, paramInt, paramBoolean));
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          localObject = ajkk.a(paramString, a(), false);
        } while ((localObject == null) || (localObject.length != 2));
        i = ((Integer)localObject[0]).intValue();
        localObject = (int[])localObject[1];
      } while ((localObject == null) || (localObject.length == 0));
      if (2 != ((airz)localQQAppInterface.getManager(153)).b(paramString)) {
        break;
      }
    } while (!paramBoolean);
    a(localQQAppInterface, paramString, i, (int[])localObject, 0);
    return;
    ajfc.a(localQQAppInterface, paramString, i, (int[])localObject, new ajeu(this, paramBoolean));
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int[] paramArrayOfInt, int paramInt2)
  {
    ...
    Object localObject = ajkk.a(paramString, i, a(), false);
    i = ((Integer)localObject[0]).intValue();
    ...
    ajfc.b(paramQQAppInterface, paramString, i, (int[])localObject, new ajev(this, paramBoolean, paramInt1, paramArrayOfInt));
  }
  ...
  public boolean b()
  {
    try
    {
      ...
      if (!localFile.exists())
      {
        ...
        if (TextUtils.isEmpty(ajmu.au)) {
          ajlq.a(this.jdField_a_of_type_Ajfb.a(), 300, 202, new Object[] { "Fail to read script file:", str });
        } else {
          ajlq.a(this.jdField_a_of_type_Ajfb.a(), 300, 200, new Object[] { "Fail to read script file:", str });
        }
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      ajlq.a(this.jdField_a_of_type_Ajfb.a(), 300, 150, new Object[] { "loadScript:", localOutOfMemoryError });
      return false;
      if (!a(localOutOfMemoryError))
      {
        ajlq.a(this.jdField_a_of_type_Ajfb.a(), 300, 201, new Object[] { "Fail to verify script file:", localOutOfMemoryError });
        return false;
      }
    ...
    catch (Throwable localThrowable)
    {
      ...
      ajlq.a(this.jdField_a_of_type_Ajfb.a(), 300, 30, new Object[] { "loadScript:", localThrowable });
      return false;
    }
    return false;
  }
