  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public vqs(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Vqt = new vqt();
    this.jdField_a_of_type_Vqt.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Vqt.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Vqt.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Vqt = null;
  ...
  {
    this.jdField_a_of_type_Vqt.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Vqt.a("before updateTexImage");
