  ...
  extends BaseAdapter
{
  ...
  public khy(Context paramContext, @NonNull TraeHelper.SoundOutputRes paramSoundOutputRes)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramViewGroup != null) {
      if (paramView == null)
      {
        paramView = new khz(this.jdField_a_of_type_AndroidContentContext, paramViewGroup.jdField_a_of_type_Int, paramViewGroup.b);
        paramViewGroup = (khz)paramView;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return paramView;
      ((khz)paramView).a(paramViewGroup.b);
      paramView.setContentDescription(paramViewGroup.b);
      ((khz)paramView).a(paramViewGroup.jdField_a_of_type_Int);
      break;
    }
  }
}
