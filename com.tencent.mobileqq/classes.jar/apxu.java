...
public class apxu
{
  public static View a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    case 5: 
    case 7: 
      return LayoutInflater.from(paramContext).inflate(2131493513, paramViewGroup, false);
    }
  ...
  public static View a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    localImageView.setId(2131297502);
    localImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    return localImageView;
  }
  
  public static apxp a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    default: 
      return null;
    case 5: 
      return new apxw(paramContext, localView, paramViewGroup);
    case 7: 
      return new apxv(paramContext, localView, paramViewGroup);
    }
    return new apxq(paramContext, localView, paramViewGroup);
  }
}
