...
public class beig
{
  ...
  public beig(beih parambeih, ClassLoader paramClassLoader)
  {
    this.jdField_a_of_type_JavaLangClassLoader = paramClassLoader;
    this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesHostInterface = new WerewolvesHostInterface(parambeih);
    a(parambeih.a.a);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaLangClass = behp.a(this.jdField_a_of_type_JavaLangClassLoader, "com.tencent.mobileqq.werewolves.PluginRuntime");
    this.jdField_b_of_type_JavaLangClass = behp.a(this.jdField_a_of_type_JavaLangClassLoader, "com.tencent.mobileqq.werewolves.PluginInterface");
    try
    {
      if (this.jdField_a_of_type_JavaLangObject == null) {
        this.jdField_a_of_type_JavaLangObject = behp.a(this.jdField_a_of_type_JavaLangClass, "getRuntime", null).invoke(null, null);
      }
      behp.a(this.jdField_a_of_type_JavaLangClass, "initFromHost", new Class[] { Object.class, Context.class }).invoke(this.jdField_a_of_type_JavaLangObject, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesHostInterface, paramContext });
      this.jdField_b_of_type_JavaLangObject = behp.a(this.jdField_a_of_type_JavaLangClass, "getPlulginInterface", null).invoke(this.jdField_a_of_type_JavaLangObject, null);
    }
    ...
    {
      this.jdField_a_of_type_JavaLangReflectMethod = behp.a(this.jdField_b_of_type_JavaLangClass, "onReceive", new Class[] { Integer.TYPE, String.class, [B.class });
      this.c = behp.a(this.jdField_b_of_type_JavaLangClass, "attachGameUI", new Class[] { ViewGroup.class, Context.class });
      this.d = behp.a(this.jdField_b_of_type_JavaLangClass, "onDestroy", new Class[0]);
      this.f = behp.a(this.jdField_b_of_type_JavaLangClass, "isReady", new Class[0]);
      this.g = behp.a(this.jdField_b_of_type_JavaLangClass, "isPlaying", new Class[0]);
      this.h = behp.a(this.jdField_b_of_type_JavaLangClass, "isDead", new Class[0]);
      this.i = behp.a(this.jdField_b_of_type_JavaLangClass, "canSpeak", new Class[0]);
      this.j = behp.a(this.jdField_b_of_type_JavaLangClass, "onFaceDownloaded", new Class[] { String.class, Bitmap.class });
      this.o = behp.a(this.jdField_b_of_type_JavaLangClass, "getQuickWords", new Class[0]);
      this.m = behp.a(this.jdField_b_of_type_JavaLangClass, "stopGame", new Class[0]);
      this.k = behp.a(this.jdField_b_of_type_JavaLangClass, "startGame", new Class[] { Integer.TYPE });
      this.l = behp.a(this.jdField_b_of_type_JavaLangClass, "startGameWithType", new Class[] { Integer.TYPE });
      this.n = behp.a(this.jdField_b_of_type_JavaLangClass, "getRoomNick", new Class[] { String.class });
      this.p = behp.a(this.jdField_b_of_type_JavaLangClass, "onUserSpeakingStateChanged", new Class[] { String.class, Boolean.TYPE });
      this.q = behp.a(this.jdField_b_of_type_JavaLangClass, "getAIOColors", new Class[0]);
      this.r = behp.a(this.jdField_b_of_type_JavaLangClass, "getAIODrawables", new Class[] { Context.class });
      this.e = behp.a(this.jdField_b_of_type_JavaLangClass, "dettachGameUI", new Class[0]);
      this.s = behp.a(this.jdField_b_of_type_JavaLangClass, "onUserLeftAIO", new Class[0]);
      this.t = behp.a(this.jdField_b_of_type_JavaLangClass, "onUserEnterAIO", new Class[0]);
      this.u = behp.a(this.jdField_b_of_type_JavaLangClass, "onSpeakBtnPressed", new Class[] { Boolean.TYPE });
      this.v = behp.a(this.jdField_b_of_type_JavaLangClass, "startGameForGold", new Class[0]);
      this.x = behp.a(this.jdField_b_of_type_JavaLangClass, "getCurZoneId", new Class[0]);
      this.w = behp.a(this.jdField_b_of_type_JavaLangClass, "getCurRoomNumber", new Class[0]);
      this.jdField_b_of_type_JavaLangReflectMethod = behp.a(this.jdField_b_of_type_JavaLangClass, "notify", new Class[] { Integer.TYPE, Object.class });
      this.y = behp.a(this.jdField_b_of_type_JavaLangClass, "onPhoneStateChange", new Class[] { Integer.TYPE });
      this.jdField_a_of_type_Boolean = true;
    }
  }
  
  public void a(ViewGroup paramViewGroup, yxx paramyxx)
  {
    try
    {
      this.c.invoke(this.jdField_b_of_type_JavaLangObject, new Object[] { paramViewGroup, paramyxx });
      return;
    }
