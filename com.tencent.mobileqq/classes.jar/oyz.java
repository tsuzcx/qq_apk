...
{
  oyz(ViewBase paramViewBase, pcf parampcf, pdp parampdp) {}
  ...
  public final void onClick(ViewBase paramViewBase)
  {
    ...
    paramViewBase = (pha)paramViewBase;
    ...
    if (paramViewBase != null)
    {
      localObject = (Activity)this.jdField_a_of_type_Pcf.a;
      ...
      paramViewBase.a((Activity)localObject, localViewBase.getNativeView(), this.jdField_a_of_type_Pdp, (blak)new oza(this));
    }
  }
}
