  ...
  implements View.OnClickListener
{
  ...
  public mlp(SimpleViewCreator paramSimpleViewCreator, View paramView, BaseData paramBaseData)
  {
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2130969599, (ViewGroup)this.jdField_a_of_type_AndroidViewView, false);
  }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalLabelLayout.getChildCount())
    {
      ...
      if (i < j)
      {
        ...
        ((TextView)localView.findViewById(2131367054)).setText(a(localTopicInfo.jdField_a_of_type_JavaLangString));
