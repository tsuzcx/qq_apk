...
public class aclq
{
  ...
  {
    aclx localaclx = acly.a(BaseApplicationImpl.sApplication, "Native");
    if (localaclx != null) {
      UpdateManager.a(localaclx.e());
    }
  }
  ...
  public static boolean a(aclx paramaclx)
  {
    int j = 701;
    String str1 = paramaclx.c();
    ...
    if (700 == i)
    {
      localObject = new File(PatchCommonUtil.getPatchPath(paramaclx.b()));
      if ((((File)localObject).exists()) && (((File)localObject).length() == paramaclx.b())) {
        i = 700;
      }
    }
    for (;;)
  ...
  private static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((localaclx != null) && (localaclx.a(BaseApplicationImpl.sApplication, null)))
    {
      String str = localaclx.b();
      File localFile = new File(PatchCommonUtil.getPatchPath(str));
      int i;
      if ((!localFile.exists()) || (localFile.length() != localaclx.b()))
      {
        i = j;
        if (localFile.exists())
        {
      ...
      {
        if (i != 0) {
          ((aclo)paramQQAppInterface.getManager(QQManagerFactory.PATCH_DOWNLOAD_MANAGER)).a(0, "dex", localaclx);
        }
        return;
