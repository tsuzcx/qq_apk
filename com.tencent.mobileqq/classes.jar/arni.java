...
public class arni
{
  ...
  public static int a(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (String str = "qq.android.minidecode.so_v8.1.5";; str = "qq.android.minidetect.so_v8.0.7")
    {
      str = str;
  ...
  {
    arnj.a(paramBitmap, c() + paramString + ".png", Bitmap.CompressFormat.PNG, 100, false);
  }
  ...
  {
    paramString2 = ajed.cQ + paramString2 + paramString1;
