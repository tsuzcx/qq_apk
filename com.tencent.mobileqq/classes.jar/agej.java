...
public class agej
  ...
  implements bhrq
{
  private agfq jdField_a_of_type_Agfq;
  ...
  public agej(Activity paramActivity, zec paramzec, agft paramagft, String paramString)
  {
    super(paramActivity, paramzec, paramagft, paramString);
  }
  ...
  private void a(Context paramContext, String paramString)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        this.g = ((TextView)this.jdField_a_of_type_AndroidAppProgressDialog.findViewById(2131371874));
      }
      return;
    }
  ...
  {
    String str;
    if ((this.jdField_a_of_type_Ages.b.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) {
      str = "0X8009AB2";
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(str)) {
        azmj.b(null, "dc00898", "", "", str, str, this.k, 0, "", "", "", "");
      }
      if (this.jdField_a_of_type_Zep.a() == null)
      {
        this.jdField_a_of_type_AndroidAppActivity.finish();
        return;
        if ((this.jdField_a_of_type_Ages.b.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) {
          str = "0X8009AB3";
        }
      }
      else
  ...
  public void G()
  {
    ...
    this.jdField_a_of_type_Agei.e = false;
    u();
  }
  ...
  public void a(float paramFloat)
  {
    ...
    if (paramFloat < 0.8F)
    {
      this.jdField_a_of_type_Agei.e = true;
      u();
    }
  }
  ...
  protected void a(agfq paramagfq, Activity paramActivity, int paramInt)
  {
    ...
    if ((this.k == 1) || (this.k == 2) || (this.k == 3) || (this.k == 5) || (this.k == 6))
    {
      ...
      localAIOImageData = (AIOImageData)paramagfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (;;)
      {
        localBundle.putString("forward_urldrawable_big_url", paramagfq.a(i));
        if (localFile == null) {
          break;
        }
        try
        {
          ...
          arum.a(paramActivity, paramagfq, 19005);
          return;
        }
      ...
      return;
      super.a(paramagfq, paramActivity, paramInt);
      return;
    }
  }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    if ((Build.VERSION.SDK_INT >= 21) && (!ajab.d()))
    {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131562802, null);
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131379960));
    this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131379961));
    this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
    this.c = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131379958));
    this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379962));
    this.jdField_a_of_type_JavaUtilSet = new HashSet();
    paramViewGroup = new agek(this);
    ...
    this.jdField_a_of_type_ComTencentWidgetDragView = ((DragView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365487));
    ...
    this.jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(this.jdField_a_of_type_Ages.b.b());
  }
  ...
  protected void a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    ...
    do
    {
      ...
      if (((azsp)localObject2).a == null) {
        ((azsp)localObject2).a = paramStructMsgForImageShare;
      }
      localObject1 = ((azsp)localObject2).a();
      ...
      ((azsp)localObject2).S = ((MessageForPic)localObject1).path;
      if (!TextUtils.isEmpty(((azsp)localObject2).S)) {
        break label173;
      }
    ...
    for (;;)
    {
      ((azsp)localObject2).S = ((String)localObject1);
      break label66;
      localObject1 = baul.a((awfj)localObject1, 65537);
      if (localObject1 != null)
      {
        localObject1 = bame.a(((URL)localObject1).toString());
        if ((localObject1 != null) && (((File)localObject1).exists()))
        {
          ...
          arum.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject2, 0);
          ...
          for (;;)
          {
            biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", localObject1[0], new String[] { "1", "", paramStructMsgForImageShare });
            return;
            label370:
            if (!QLog.isColorLevel()) {
              break;
  ...
  protected void a(StructMsgForImageShare paramStructMsgForImageShare, String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject.put("leftViewText", alpo.a(2131700426));
      ...
      if ((paramStructMsgForImageShare != null) && (paramStructMsgForImageShare.length >= 8))
      {
        if (paramStructMsgForImageShare[7].equals("link"))
        {
          ...
          biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40057", localObject1, new String[] { "", "", paramStructMsgForImageShare });
        }
        label251:
        ...
        biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", localObject1, new String[] { "4", "", paramStructMsgForImageShare });
        return;
      }
    }
    catch (Exception localException)
  ...
  boolean a(agfq paramagfq)
  {
    ...
    if ((this.jdField_a_of_type_Agfq != null) && (this.jdField_a_of_type_Agfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long == paramagfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long) && (this.jdField_a_of_type_Agfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int == paramagfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int)) {}
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Agfq = paramagfq;
      int j;
      Object localObject1;
      ...
      if ((this.jdField_b_of_type_AndroidWidgetImageButton.getVisibility() != 4) || (this.jdField_a_of_type_AndroidViewView.getVisibility() != 4))
      {
        ...
        if (AIOImageData.class.isInstance(paramagfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          localObject1 = (AIOImageData)paramagfq.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
          if (((AIOImageData)localObject1).b != 1) {
            break label574;
          }
          localStructMsgForImageShare2 = (StructMsgForImageShare)azqu.a((byte[])((AIOImageData)localObject1).a);
          ...
          if (arrayOfString2 != null)
          {
            ...
            if (arrayOfString2.length >= 8)
            {
              ...
              localObject2 = arrayOfString2[3] + alpo.a(2131700432) + arrayOfString2[5] + alpo.a(2131700447);
      ...
      for (;;)
      {
        if (!this.jdField_a_of_type_JavaUtilSet.contains(Integer.valueOf(paramagfq.hashCode())))
        {
          biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "3008", "1", "30004", arrayOfString2[0], new String[] { arrayOfString2[2], arrayOfString2[4], a(localStructMsgForImageShare2.mMsgActionData) });
          this.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(paramagfq.hashCode()));
        }
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
          if (this.f != null) {
            this.f.setText(alpo.a(2131700407));
          }
        ...
        for (;;)
        {
          ...
          {
            localStructMsgForImageShare1 = (StructMsgForImageShare)azqu.a((byte[])((AIOImageData)localObject1).a);
            ...
            if ((arrayOfString1 != null) && (arrayOfString1.length > 2))
            {
              ...
              paramagfq = (agfq)localObject1;
              if (localObject1 != null)
              {
                paramagfq = (agfq)localObject1;
                if (((String)localObject1).length() > 17) {
                  paramagfq = ((String)localObject1).substring(0, 16) + "...";
                }
              }
              this.jdField_a_of_type_AndroidWidgetButton.setText(paramagfq);
              this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
              if (i != 0)
              {
                paramagfq = "";
              ...
              nrt.a(null, "", "0X8007153", "0X8007153", 0, 0, (String)localObject1, paramagfq, "", "");
              nrt.a("0X8007153", "", (String)localObject1, paramagfq, "", "");
            }
            for (;;)
            {
              this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
              if (this.f != null)
              {
                this.f.setText(alpo.a(2131700411));
                if ((arrayOfString1 != null) && (arrayOfString1.length > 3))
                {
                  paramagfq = arrayOfString1[3];
                  if ((paramagfq != null) && (paramagfq.equals("1"))) {
                    this.f.setText(alpo.a(2131700445));
                  }
                }
              }
              this.jdField_a_of_type_AndroidViewView.invalidate();
      ...
      if ((localObject instanceof AIOShortVideoData))
      {
        ...
        if (localAIOShortVideoData.k == 2)
        {
          ...
          for (;;)
          {
            ...
            this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(new agel(this, localAIOShortVideoData));
            return true;
            if (1 == localAIOShortVideoData.g)
            {
              localObject = alpo.a(2131700405);
            }
            else
            {
  ...
  {
    if ((parambhpy == null) || (paramAIOImageData == null)) {}
    do
    {
      return false;
      if (paramAIOImageData.b == 1)
      {
        ...
        parambhpy.b(2131693481);
        parambhpy.b(2131693480);
        return true;
      }
    } while (paramAIOImageData.b != 2);
    parambhpy.b(2131693483);
    parambhpy.b(2131693485);
    parambhpy.b(2131693477);
    Object localObject = b(((StructMsgForImageShare)azqu.a((byte[])paramAIOImageData.a)).mMsgActionData);
    ...
    nrt.a(null, "", "0X8007154", "0X8007154", 0, 0, paramAIOImageData, parambhpy, "", "");
    return true;
  }
  ...
  boolean a(String paramString, AIOImageData paramAIOImageData, File paramFile)
  {
    ...
    {
      return false;
      if (!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693485))) {
        break;
      }
    } while ((paramAIOImageData.b != 1) && (paramAIOImageData.b != 2));
    paramString = (StructMsgForImageShare)azqu.a((byte[])paramAIOImageData.a);
    a(paramString);
    ...
    nrt.a(null, "", "0X8007131", "0X8007131", 0, 0, paramAIOImageData, paramString, "", "");
    return true;
    Object localObject;
    boolean bool;
    label284:
    String str1;
    if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693483))) {
      if (paramAIOImageData.b == 1)
      {
        StructMsgForImageShare localStructMsgForImageShare = (StructMsgForImageShare)azqu.a((byte[])paramAIOImageData.a);
        ...
        if ((localObject != null) && (localObject.length >= 8) && ((localObject[7].equals("link")) || (localObject[7].equals("scrawl_link"))))
        {
          ...
          if (bool)
          {
            ...
            String str2 = localObject[3] + alpo.a(2131700415) + localObject[5] + alpo.a(2131700427);
            ...
            new biqt(6).a("nLinkType", 0).b("sTitle", localObject[1]).b("sUrl", paramString).a("bAppShare", false).a("lAppId", 0L).b("sPublisher", localStructMsgForImageShare.mSourceName).b("sBrief", str2).b("sPath", paramFile.getAbsolutePath()).b("sResUrl", localStructMsgForImageShare.mSourceUrl).a("lCategory", 1L).a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_JavaLangString);
            birh.a(null, 6, 2);
            if (localObject.length < 8) {
              break label1262;
            }
    ...
    for (;;)
    {
      biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", localObject[0], new String[] { "2", "", paramString });
      return bool;
      bool = false;
      break label284;
      label724:
      if ((localObject[7].equals("scrawl_link")) && (localObject.length >= 9))
      {
        ...
        if ((paramFile != null) && (paramFile.length > 2))
        {
          ...
          if (paramAIOImageData != null)
          {
            ...
            localObject = agem.a(paramAIOImageData.a());
          ...
          biqt.a(str1).c(this.jdField_b_of_type_JavaLangString).a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_JavaLangString);
          birh.a(null, 6, 2);
          paramString = "";
          paramAIOImageData = Uri.parse(paramFile[1]);
          try
          ...
          nrt.a(null, "", "0X8007132", "0X8007132", 0, 0, paramAIOImageData, paramString, "", "");
        }
        for (bool = true;; bool = false)
        {
          return bool;
          if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693481)))
          {
            if (paramAIOImageData.b != 1) {
              break;
            }
            b((StructMsgForImageShare)azqu.a((byte[])paramAIOImageData.a), "6");
            return true;
          }
          if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693480)))
          {
            if (paramAIOImageData.b != 1) {
              break;
            }
            a((StructMsgForImageShare)azqu.a((byte[])paramAIOImageData.a), "6");
            return true;
          }
          if ((!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693477))) || (paramAIOImageData.b != 2)) {
            break;
          }
          paramString = (StructMsgForImageShare)azqu.a((byte[])paramAIOImageData.a);
          b(paramString);
          ...
          nrt.a(null, "", "0X8007130", "0X8007130", 0, 0, paramAIOImageData, paramString, "", "");
          return true;
        }
      }
      label1262:
  ...
  protected void b(StructMsgForImageShare paramStructMsgForImageShare, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject.put("leftViewText", alpo.a(2131700425));
        ...
        if (arrayOfString.length >= 8)
        {
          ...
          {
            biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40055", arrayOfString[0], new String[] { "", "", paramStructMsgForImageShare });
            return;
          ...
          biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", arrayOfString[0], new String[] { "3", "", paramStructMsgForImageShare });
          return;
        }
      }
      catch (Exception localException)
  ...
  protected void c(StructMsgForImageShare paramStructMsgForImageShare, String paramString)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        biiv.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40056", arrayOfString[0], new String[] { "", paramStructMsgForImageShare, paramString });
      }
    }
  ...
  boolean g()
  {
    Object localObject = this.jdField_a_of_type_Ages.b();
    if ((localObject != null) && (AIOImageData.class.isInstance(((agfq)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)))
    {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Ages.a() != null)
        {
          localObject = this.jdField_a_of_type_Ages.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
  ...
  public void o()
  {
    ...
    {
      this.jdField_a_of_type_Zep.a().e();
      return;
    }
    super.o();
  }
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Zep.a() != null) {
      this.jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(this.jdField_a_of_type_Ages.b.jdField_a_of_type_AndroidGraphicsRect);
    }
    while ((this.jdField_a_of_type_Ages.b.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData))
    {
