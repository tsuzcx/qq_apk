...
public final class agej
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new agek();
  ...
  public static int a(bdqc parambdqc, String paramString)
  {
    parambdqc = parambdqc.a(paramString);
    ...
    do
    {
      ...
      try
      {
        int i1 = Integer.parseInt(parambdqc);
        return i1;
      }
  ...
  protected static void a()
  {
    boolean bool = true;
    Object localObject;
    if (agbh.jdField_a_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (agbh.jdField_a_of_type_Boolean)
        {
          agbh.jdField_a_of_type_Int = i1;
          if (agbh.jdField_a_of_type_Int == -1) {
            agbh.jdField_a_of_type_Int = 0;
          }
          return;
          label111:
          bool = false;
  ...
  public static final void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, aggs paramaggs, ChatMessage paramChatMessage)
  {
    
    if (agbh.jdField_a_of_type_Int <= 0) {
      return;
    }
    a(paramQQAppInterface, a(paramBaseChatPie, paramaggs, paramChatMessage));
  }
  
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    if (paramBoolean) {
      ((WebProcessManager)paramQQAppInterface.getManager(13)).a(1, new agel());
    }
  }
  ...
  protected static boolean a(BaseChatPie paramBaseChatPie, aggs paramaggs, ChatMessage paramChatMessage)
  {
    boolean bool2 = false;
    boolean bool1;
    int i2;
    if (paramChatMessage == null)
    {
      ...
      if (paramaggs != null)
      {
        ...
        if (paramaggs.size() > 0)
        {
          ...
          i1 = agbh.jdField_a_of_type_Int;
          if (i2 <= i1) {
            break label121;
          }
          i2 = i1;
          label61:
          if (!(paramBaseChatPie instanceof ainh)) {
            break label162;
          }
        }
      }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      if (i2 > -1)
      {
        paramBaseChatPie = (ChatMessage)paramaggs.get(i2);
        if (i1 == 0) {
          break label124;
        }
        if (!agbh.a(paramBaseChatPie)) {
          break label140;
        }
        bool1 = true;
      }
      ...
      do
      {
        ...
        break;
        break label61;
        if ((!paramBaseChatPie.isread) && (agbh.a(paramBaseChatPie))) {
          return true;
        }
        i2 -= 1;
        break label76;
        bool1 = bool2;
      } while (!agbh.a(paramChatMessage));
      return true;
    }
  }
  ...
  private static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    try
    {
      ...
      if (i1 == -1)
      {
        QQToast.a(paramBaseActivity, paramBaseActivity.getString(2131718193), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      if (paramIntent.hasExtra("account"))
      {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "1", "", "", "");
        if (!((anyw)paramQQAppInterface.getManager(51)).b(str))
        {
      ...
      if ((paramIntent.getBooleanExtra("shortcut", false)) && (!((anyw)paramQQAppInterface.getManager(51)).b(str)))
      {
        QQToast.a(paramBaseActivity.getApplicationContext(), paramBaseActivity.getString(2131718194), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      return true;
    }
  ...
  {
    bhsq.a(null, "AIO_doOnCreate_BeforeEnterCost");
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return true;
          } while (bfmf.a(paramBaseActivity, paramQQAppInterface, paramIntent));
          if (paramBoolean)
          {
        ...
        return true;
        if (!aarg.a().a(paramIntent, paramBaseActivity, paramQQAppInterface)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    label221:
    bhsq.a("AIO_doOnCreate_BeforeEnterCost", null);
    return false;
  }
