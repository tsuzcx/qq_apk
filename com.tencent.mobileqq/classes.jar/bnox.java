  ...
  extends bnot
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bnox.class.getSimpleName();
  }
  
  public bnox(PeakAppInterface paramPeakAppInterface)
  {
  ...
  public static String a(android.content.Context paramContext, Bitmap paramBitmap)
  {
    ...
    //   3: dup
    //   4: getstatic 34	bndl:b	Ljava/lang/String;
    ...
    //   159: dup
    //   160: aload 9
    //   162: invokestatic 92	bgmg:a	(Ljava/lang/String;)Ljava/io/File;
    ...
    //   215: iload_3
    //   216: iload_2
    //   217: invokestatic 122	bgmo:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V
    //   220: iconst_0
    //   221: istore 5
    //   223: iload_3
    //   224: istore 4
    ...
    //   294: invokestatic 122	bgmo:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V
    //   297: iload_2
    //   298: iconst_1
    //   299: iadd
    //   300: istore_2
    //   301: goto -70 -> 231
    //   304: astore 6
    //   306: getstatic 16	bnox:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   332: invokestatic 144	bnzb:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   335: goto -136 -> 199
    //   338: astore 8
    //   340: aconst_null
    //   341: astore 6
    //   343: aload 6
    //   345: astore 7
    //   347: getstatic 16	bnox:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   373: invokestatic 144	bnzb:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   376: aload 6
    //   378: ifnull +8 -> 386
    //   381: aload 6
    ...
    //   397: goto -187 -> 210
    //   400: astore 6
    //   402: getstatic 16	bnox:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   428: invokestatic 144	bnzb:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   431: goto -45 -> 386
    //   434: astore 7
    //   436: aload 8
    //   438: astore 6
    ...
    //   444: aload 6
    //   446: astore 7
    //   448: getstatic 16	bnox:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   474: invokestatic 144	bnzb:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   477: aload 6
    //   479: ifnull +8 -> 487
    //   482: aload 6
    ...
    //   498: goto -288 -> 210
    //   501: astore 6
    //   503: getstatic 16	bnox:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   529: invokestatic 144	bnzb:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   532: goto -45 -> 487
    //   535: astore_0
    //   536: aload 7
    //   538: ifnull +8 -> 546
    ...
    //   558: athrow
    //   559: astore 6
    //   561: getstatic 16	bnox:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   587: invokestatic 144	bnzb:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   590: goto -44 -> 546
    //   593: aload_1
  ...
  private void b(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      localbnyh.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetFontData", paramObject.Code);
      return;
    }
  }
    ...
    for (int i = paramObject.ValidStatus;; i = -2)
    {
      ...
      if ((paramFromServiceMsg != null) && (paramObject != null))
      {
        ...
        if (this.jdField_a_of_type_JavaUtilMap.containsKey("CameraModuleSvc.GetImgValidStatus"))
        {
          ...
          localbnyh.a(j, String.valueOf(l2 - l1), "CameraModuleSvc.GetImgValidStatus", paramObject.Code);
        }
      }
      else
      {
  ...
  private void d(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      localbnyh.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetOnlineUserNum", paramObject.Code);
      return;
    }
  }
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      if ((localObject != null) && (((GetBulkImageClassifyRsp)localObject).MiltiRsps != null))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramObject.add(new bodd(localSmartFilterRspItem.PituLabel, localSmartFilterRspItem.DisplayLabels));
        }
        bocc.a().a(paramObject);
      }
      paramObject = bnyh.a();
      ...
      try
      {
        ...
        if ((paramFromServiceMsg != null) && (localGetRecommandTextByEmotionRsp != null))
        {
          ...
          if (this.jdField_a_of_type_JavaUtilMap.containsKey("CameraModuleSvc.GetRecommandTextByEmotion"))
          {
            ...
            localbnyh.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetRecommandTextByEmotion", localGetRecommandTextByEmotionRsp.Code);
          }
        }
        else
        {
          notifyUI(1, bool, new bnrb(localArrayList, str, paramObject));
          return;
        }
      }
  ...
  private void g(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      {
        localbnyh.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetTextValidStatus", paramObject.Code);
  ...
  public void b(String paramString)
  {
    ...
    bnxl.a(paramString, new bnoy(this, localToServiceMsg));
  }
