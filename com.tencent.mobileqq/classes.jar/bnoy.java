  ...
  extends WebViewPlugin
{
  ...
  private void a(String... paramVarArgs)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((localActivity != null) && ((localActivity instanceof bnoz)) && (((bnoz)localActivity).a())) {
            return;
          }
          ...
          if ((localActivity == null) || ((!(localActivity instanceof bnoz)) && (!(localActivity instanceof BasePluginActivity)))) {
            break label343;
          }
  ...
  private void c(String... paramVarArgs)
  {
    try
    {
      ...
      paramVarArgs.putExtra("key_left_tab_title", this.mRuntime.a().getString(2131716312));
      paramVarArgs.putExtra("key_right_tab_title", this.mRuntime.a().getString(2131716393));
