...
public class ajwc
{
  ...
  public ajwc(ajvw paramajvw, float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.jdField_a_of_type_Ajvw = paramajvw;
    Object localObject = this.jdField_a_of_type_Ajvw.getContext();
    this.jdField_a_of_type_Float = (bdoo.a() * 0.0375F);
    this.jdField_b_of_type_Float = paramFloat2;
    this.jdField_c_of_type_Float = (this.jdField_a_of_type_Float * 0.5F);
    this.d = paramInt3;
    paramajvw = a(((Context)localObject).getResources(), 2130848664, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    localObject = a(((Context)localObject).getResources(), 2130848666, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    ...
    if (paramajvw != null) {
      localCanvas.drawBitmap(paramajvw, (this.jdField_a_of_type_Float - paramajvw.getWidth()) / 2.0F, (this.jdField_b_of_type_Float - paramajvw.getHeight()) / 2.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
  ...
  public void a()
  {
    this.jdField_a_of_type_Ajwd = null;
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Ajwd == null) {
        break;
      }
      this.jdField_a_of_type_Ajwd.a(this.e, this.f);
      return;
      label148:
      if (this.f - f1 < this.g)
      {
