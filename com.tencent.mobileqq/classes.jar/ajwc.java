...
{
  public ajwc(TroopFileManager paramTroopFileManager) {}
  ...
  {
    ThreadManager.post(new ajwd(this, paramBundle, paramInt2, paramByteStringMicro, paramBoolean1, paramList, paramBoolean2, paramInt3, paramInt1), 8, null, true);
  }
}
