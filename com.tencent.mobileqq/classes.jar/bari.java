  ...
  extends barg
{
  ...
  public bari(bard parambard, int paramInt)
  {
    super(parambard, paramInt);
    this.jdField_b_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new barj(this);
  }
  
  public void a()
  {
    String str1 = this.jdField_a_of_type_Bard.jdField_b_of_type_JavaLangString;
    String str2 = this.jdField_a_of_type_Bard.jdField_a_of_type_JavaLangString;
  ...
  protected boolean b(String paramString)
  {
    ...
    {
      arrayOfByte = alet.a(paramString);
    ...
    do
    {
      ...
      localPttShortVideoFileInfo.uint32_file_time.set((int)this.jdField_a_of_type_Bard.jdField_a_of_type_Long);
