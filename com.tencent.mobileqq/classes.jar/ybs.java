...
public class ybs
  extends ybz
{
  private final ayvz jdField_a_of_type_Ayvz = new ybt(this, Looper.getMainLooper());
  private final ArrayList<ybu> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Set<Long> jdField_a_of_type_JavaUtilSet = new HashSet(10);
  private ConcurrentHashMap<String, ybx> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  ybo jdField_a_of_type_Ybo = new ybo();
  ybr jdField_a_of_type_Ybr = new ybr();
  ...
  private void a(long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    {
      paramString = new ybx(this, paramString, paramLong2, paramInt, "", 0L);
  ...
  {
    ybx localybx = (ybx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    if (localybx == null) {
      return;
    }
    Object localObject1;
    ...
    {
      this.jdField_a_of_type_Ybr.a(paramSession, localybx.jdField_a_of_type_JavaLangString, localybx.jdField_a_of_type_Long, localybx.jdField_a_of_type_Int, paramBoolean);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
        localObject2 = ((yak)((QQAppInterface)localObject1).a(51)).a(Long.parseLong(localybx.jdField_a_of_type_JavaLangString));
    ...
    for (int i = ((DeviceInfo)localObject2).productId;; i = 0)
    {
      ...
      {
        int j;
        if (paramSession.actionInfo.strServiceName.compareTo(yeu.f) == 0) {
          if (paramBoolean)
          {
            j = 0;
            ymw.a((AppRuntime)localObject1, l, "Net_SendMsg_Audio", 0, j, i);
            localObject1 = ((QQAppInterface)localObject1).getHandler(Conversation.class);
            if (localObject1 != null) {
              ((MqqHandler)localObject1).sendEmptyMessage(1009);
            }
            localObject1 = this.jdField_a_of_type_Ayvz.obtainMessage();
            localObject2 = new ybw(this);
            if (!paramBoolean) {
              break label364;
            }
          }
        ...
        for (i = 1003;; i = 1005)
        {
          ((ybw)localObject2).jdField_a_of_type_Int = i;
          ((ybw)localObject2).jdField_a_of_type_Long = localybx.jdField_a_of_type_Long;
          ((Message)localObject1).obj = localObject2;
          this.jdField_a_of_type_Ayvz.sendMessageDelayed((Message)localObject1, 0L);
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
          return;
          if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(yeu.f)) {
            break;
          }
          this.jdField_a_of_type_Ybo.a(paramSession, localybx.jdField_a_of_type_JavaLangString, localybx.jdField_a_of_type_Long, localybx.jdField_a_of_type_Int, paramBoolean);
          break;
          j = 1;
          break label157;
          if (paramSession.actionInfo.strServiceName.compareTo(yeu.e) != 0) {
            break label170;
          }
          if (paramBoolean) {}
          for (j = 0;; j = 1)
          {
            ymw.a((AppRuntime)localObject1, l, "Net_SendMsg_Video", 0, j, i);
            break;
          }
        }
      }
  ...
  private void c(Session paramSession)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)axaq.a(-4503);
  ...
  public String a(DataPoint paramDataPoint)
  {
    for (;;)
    {
      try
      {
        ...
        long l1 = ((JSONObject)localObject1).optLong("msg_time", awzw.a());
        ...
        if (TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject2 instanceof QQAppInterface))
          {
            ...
            MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)axaq.a(-4501);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (ybx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(i));
    } while (paramBundle == null);
    this.jdField_a_of_type_Ybo.a((Session)localObject, paramBundle.jdField_a_of_type_JavaLangString, paramBundle.jdField_a_of_type_Long, paramBundle.jdField_a_of_type_Int, f);
    Object localObject = this.jdField_a_of_type_Ayvz.obtainMessage();
    ybw localybw = new ybw(this);
    localybw.jdField_a_of_type_Int = 1002;
    localybw.jdField_a_of_type_Float = f;
    localybw.jdField_a_of_type_Long = paramBundle.jdField_a_of_type_Long;
    ((Message)localObject).obj = localybw;
    this.jdField_a_of_type_Ayvz.sendMessageDelayed((Message)localObject, 0L);
  }
  
  void a(Message paramMessage)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DeviceAVFileMsgObserver", 2, "handleMessage" + ((ybw)paramMessage.obj).jdField_a_of_type_Long + " status " + paramMessage.what + "retCode " + paramMessage.arg1);
    }
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      Object localObject = (ybu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((ybu)localObject).a();
      localObject = ((ybu)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((ybv)localObject).a(localView, (ybw)paramMessage.obj);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, ybv paramybv)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      ybu localybu = (ybu)localIterator.next();
      if (localybu.a() == paramView)
      {
        localybu.b = new WeakReference(paramybv);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new ybu(this, paramView, paramybv));
  }
  ...
  public void a(MessageForDevPtt paramMessageForDevPtt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          paramMessageForDevPtt = new ybx(this, paramMessageForDevPtt.frienduin, paramMessageForDevPtt.uniseq, paramMessageForDevPtt.istroop, "", 0L);
  ...
  public void a(Session paramSession)
  {
    ...
    if ((!paramSession.bSend) && (paramSession.actionInfo.strServiceName.equalsIgnoreCase(yeu.e))) {
      c(paramSession);
    }
  }
  ...
  public void a(Session paramSession, float paramFloat)
  {
    ...
    if (localybx != null)
    {
      ...
      this.jdField_a_of_type_Ybr.a(paramSession, localybx.jdField_a_of_type_JavaLangString, localybx.jdField_a_of_type_Long, localybx.jdField_a_of_type_Int, paramFloat);
      localMessage = this.jdField_a_of_type_Ayvz.obtainMessage();
      localybw = new ybw(this);
    ...
    label165:
    label205:
    for (localybw.jdField_a_of_type_Int = 1002;; localybw.jdField_a_of_type_Int = 2002)
    {
      localybw.jdField_a_of_type_Float = paramFloat;
      localybw.jdField_a_of_type_Long = localybx.jdField_a_of_type_Long;
      localMessage.obj = localybw;
      this.jdField_a_of_type_Ayvz.sendMessageDelayed(localMessage, 0L);
      return;
      if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(yeu.f)) {
        break;
      }
      this.jdField_a_of_type_Ybo.a(paramSession, localybx.jdField_a_of_type_JavaLangString, localybx.jdField_a_of_type_Long, localybx.jdField_a_of_type_Int, paramFloat);
      break;
    }
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localybx = (ybx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    } while (localybx == null);
    label135:
    Object localObject1;
    Object localObject2;
    ...
    for (int i = 2003;; i = 2005)
    {
      ...
      this.jdField_a_of_type_Ayvz.sendMessageDelayed((Message)localObject1, 0L);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(localybx.jdField_a_of_type_Long));
      if (!paramBoolean) {
        break label439;
      }
      this.b.remove(Long.valueOf(localybx.jdField_a_of_type_Long));
      return;
      if ((paramSession.actionInfo.strServiceName.equalsIgnoreCase(yeu.f)) || (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(yeu.g))) {
        break label135;
      }
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if (!(localObject1 instanceof QQAppInterface)) {
      ...
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = ((QQAppInterface)localObject1).a().a(localybx.jdField_a_of_type_JavaLangString, localybx.jdField_a_of_type_Int, localybx.jdField_a_of_type_Long);
      if (localObject2 == null) {
        break;
      }
      ...
      if (paramBoolean) {}
      for (localMessageForDevPtt.fileSize = apue.a(paramSession.strFilePathSrc);; localMessageForDevPtt.fileSize = -1L)
      {
        localMessageForDevPtt.msg = localMessageForDevPtt.getSummary();
        localMessageForDevPtt.serial();
    ...
    label439:
    this.b.put(Long.valueOf(localybx.jdField_a_of_type_Long), Long.valueOf(awzw.a()));
  }
  
  public void a(MessageRecord paramMessageRecord, float paramFloat)
  {
    Message localMessage = this.jdField_a_of_type_Ayvz.obtainMessage();
    ybw localybw = new ybw(this);
    localybw.jdField_a_of_type_Int = 1002;
    localybw.jdField_a_of_type_Long = paramMessageRecord.uniseq;
    localybw.jdField_a_of_type_Float = paramFloat;
    localMessage.obj = localybw;
    this.jdField_a_of_type_Ayvz.sendMessageDelayed(localMessage, 0L);
  }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    {
      i = 1003;
      localybw.jdField_a_of_type_Int = i;
      localybw.jdField_a_of_type_Long = paramMessageRecord.uniseq;
      if (!paramBoolean.booleanValue()) {
        break label89;
      }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = (yak)((QQAppInterface)localObject1).a(51);
      if ((!paramString1.equalsIgnoreCase(yeu.f)) || (localObject2 == null) || (!((yak)localObject2).b(paramLong1))) {
        break label192;
      }
      localObject1 = new Session();
      ((Session)localObject1).uSessionID = ((yak)localObject2).a(paramLong1, paramString2, paramInt2);
      ((Session)localObject1).strFilePathSrc = paramString2;
      ((Session)localObject1).uFileSizeSrc = apue.a(paramString2);
      ...
      paramString2 = new ybx(this, String.valueOf(paramLong1), paramLong2, paramInt1, paramString2, ((Session)localObject1).uFileSizeSrc);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject2, paramString2);
      label154:
      if (!bbev.d(BaseApplication.getContext()))
      {
        if (!paramString1.equalsIgnoreCase(yeu.e)) {
          break label238;
        }
        this.jdField_a_of_type_Ybr.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
      }
    }
    label192:
    label221:
    label238:
    while (!paramString1.equalsIgnoreCase(yeu.f))
    {
      return;
  ...
  public boolean a(long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((ybx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).jdField_a_of_type_Long == paramLong) {
        return true;
      }
    }
    return false;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localybx = (ybx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramBundle.uSessionID));
    } while (localybx == null);
    paramBundle.strFilePathSrc = localybx.jdField_b_of_type_JavaLangString;
    paramBundle.uFileSizeSrc = localybx.jdField_b_of_type_Long;
    Object localObject1 = this.jdField_a_of_type_Ybo;
    Object localObject2 = localybx.jdField_a_of_type_JavaLangString;
    long l = localybx.jdField_a_of_type_Long;
    int j = localybx.jdField_a_of_type_Int;
    if (i == 0)
    {
      ((ybo)localObject1).a(paramBundle, (String)localObject2, l, j, bool);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
  ...
  public void b(Session paramSession)
  {
    ...
    ybw localybw = new ybw(this);
    if (paramSession.bSend) {}
    for (localybw.jdField_a_of_type_Int = 1001;; localybw.jdField_a_of_type_Int = 2001)
    {
      localybw.jdField_a_of_type_Long = localybx.jdField_a_of_type_Long;
      localMessage.obj = localybw;
      this.jdField_a_of_type_Ayvz.sendMessageDelayed(localMessage, 0L);
