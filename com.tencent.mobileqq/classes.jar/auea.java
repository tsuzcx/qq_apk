  ...
  implements Manager
{
  ...
  private String jdField_b_of_type_JavaLangString = anni.a(2131712220);
  private boolean jdField_b_of_type_Boolean;
  private String jdField_c_of_type_JavaLangString = anni.a(2131712221);
  private boolean jdField_c_of_type_Boolean;
  
  public auea(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_b_of_type_Boolean = bgsg.B(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
  }
  
  public static auea a(QQAppInterface paramQQAppInterface)
  {
    return (auea)paramQQAppInterface.getManager(286);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (auzk)paramQQAppInterface.getManager(219);
  ...
  {
    int j = bgsg.aK(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    if (QLog.isColorLevel()) {
      QLog.d("RichTextChatManager", 2, "last Memoried Tab:" + j);
    }
    int i;
    if (j == -1) {
      if (!bgsg.A(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin()))
      {
        i = paramArrayList.indexOf(Integer.valueOf(a(paramQQAppInterface)));
        bgsg.r(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), true);
        if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Integer paramInteger, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bgsg.aI(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = bgsg.aJ(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int n = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (m != n) {
      bgsg.Z(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), n);
    }
    for (;;)
    {
      if (k != i)
      {
        paramInteger = arcj.b(paramConfig, i, paramInteger.intValue());
        if (QLog.isColorLevel()) {
        ...
        bgsg.f(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), k, paramInteger);
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    bgsg.s(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), paramBoolean);
  }
