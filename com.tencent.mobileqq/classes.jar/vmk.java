...
public class vmk
{
  public static int a(int paramInt)
  {
    ...
    if (localObject == null)
    {
      urk.c("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId() error, app is null", new Throwable());
      return 0;
    }
    localObject = ((mmy)((QQAppInterface)localObject).getManager(70)).a(paramInt);
    if (localObject == null)
    {
      urk.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is null", Integer.valueOf(paramInt));
      return 0;
    }
    urk.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is %s", Integer.valueOf(paramInt), vlw.a((MessageMicro)localObject));
  ...
  {
    return ((stg)paramQQAppInterface.getManager(252)).a;
  }
