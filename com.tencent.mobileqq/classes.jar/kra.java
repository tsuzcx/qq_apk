...
public class kra
{
  private static kqw jdField_a_of_type_Kqw;
  private static kqx jdField_a_of_type_Kqx;
  
  /* Error */
  public static kqw a(Context paramContext)
  {
    // Byte code:
    //   0: getstatic 17	kra:jdField_a_of_type_Kqw	Lkqw;
    //   3: ifnonnull +81 -> 84
    //   6: aload_0
    //   7: ldc 19
    ...
    //   56: ldc 2
    //   58: monitorenter
    //   59: getstatic 17	kra:jdField_a_of_type_Kqw	Lkqw;
    //   62: astore_2
    //   63: aload_2
    //   64: ifnonnull +17 -> 81
    //   67: new 62	kqw
    ...
    //   73: iload_1
    //   74: i2l
    //   75: invokespecial 65	kqw:<init>	(Landroid/content/Context;IJ)V
    //   78: putstatic 17	kra:jdField_a_of_type_Kqw	Lkqw;
    //   81: ldc 2
    //   83: monitorexit
    //   84: getstatic 17	kra:jdField_a_of_type_Kqw	Lkqw;
    //   87: areturn
    //   88: astore_0
  ...
  public static kqx a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Kqx == null) {
        jdField_a_of_type_Kqx = new kqx(65536);
      }
      return jdField_a_of_type_Kqx;
    }
    finally {}
  }
  
  public static kqw b(Context paramContext)
  {
    if (jdField_a_of_type_Kqw == null) {
      ThreadManager.post(new TranslateCache.1(paramContext), 5, null, true);
    }
    return jdField_a_of_type_Kqw;
  }
}
