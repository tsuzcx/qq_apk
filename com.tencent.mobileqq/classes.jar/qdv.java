...
public final class qdv
{
  ...
  @Nullable
  public static final <P extends MessageMicro<P>, R> R a(@NotNull MessageMicro<P> paramMessageMicro, @Nullable R paramR, @NotNull qdt<P, R> paramqdt)
  {
    Intrinsics.checkParameterIsNotNull(paramMessageMicro, "$this$toPBParseValue");
    Intrinsics.checkParameterIsNotNull(paramqdt, "pbParser");
    if (paramMessageMicro.has())
    {
      paramMessageMicro = paramMessageMicro.get();
      Intrinsics.checkExpressionValueIsNotNull(paramMessageMicro, "get()");
      paramR = paramqdt.a(paramMessageMicro);
    }
    return paramR;
  }
