  ...
  protected Boolean a(Void... paramVarArgs)
  {
    for (;;)
    {
      try
      {
        ...
        anoh.a((QQAppInterface)localObject);
        if ((!anoh.jdField_a_of_type_Boolean) || (anoh.jdField_c_of_type_Boolean) || (anoh.jdField_a_of_type_AndroidContentIntent == null)) {
          return Boolean.valueOf(false);
        }
        if ((anoh.b != 0) && (Build.VERSION.SDK_INT > anoh.b)) {
          return Boolean.valueOf(false);
        }
        ...
        if (QQToast.a() == 0)
        {
          ...
          if (i != 0)
          {
            if (!anoh.a((QQAppInterface)localObject)) {
              return Boolean.valueOf(false);
            }
            localObject = PreferenceManager.getDefaultSharedPreferences(((QQAppInterface)localObject).getApp());
            long l3 = System.currentTimeMillis();
            if (anoh.a() == -1L) {
              anoh.a(((SharedPreferences)localObject).getLong("push_open_notify_lasttime", l3));
            }
            long l1 = 0L;
            i = 0;
            ...
            if (n == 1)
            {
              l1 = anoh.jdField_c_of_type_Int * anoh.jdField_a_of_type_Long;
              i = anoh.d;
              j = i;
              m = i1;
              l2 = l1;
              ...
              if (i1 >= i)
              {
                ...
                if (n == 1)
                {
                  l2 = anoh.jdField_c_of_type_Int * anoh.jdField_a_of_type_Long;
                  j = anoh.d;
                  k = n;
                  m = i1;
                }
              ...
              else
              {
                if (QLog.isColorLevel()) {
                  QLog.d("PushOpenNotify", 2, new Object[] { "PopOpenMsgNotifation, stage:", Integer.valueOf(k), " stagecount:", Integer.valueOf(m), " count:", Integer.valueOf(i2), " countMax:", Integer.valueOf(j), " pushInteral:", Long.valueOf(l2), " timeDiff:", Long.valueOf(l3 - anoh.a()) });
                }
                if ((l3 - anoh.a() <= l2) && (i2 != 0)) {
                  break label754;
                }
                anoh.a(l3);
            ...
            else
            {
              if (n == 2)
              {
                l1 = anoh.e * anoh.jdField_a_of_type_Long;
                i = anoh.f;
                continue;
              }
              if (n != 3) {
              ...
              l1 = anoh.g * anoh.jdField_a_of_type_Long;
              i = 2147483647;
              continue;
            }
            if (n == 2)
            {
              l2 = anoh.e * anoh.jdField_a_of_type_Long;
              j = anoh.f;
              m = i1;
              k = n;
              continue;
            ...
            l1 = anoh.g;
            l2 = anoh.jdField_a_of_type_Long;
            l2 = l1 * l2;
            j = 2147483647;
            m = i1;
            k = n;
