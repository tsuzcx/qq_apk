  ...
  implements arrn
{
  ...
  {
    int i = this.a.jdField_a_of_type_Arso.e;
    String str3 = this.a.jdField_a_of_type_Arso.b;
    this.a.b(i, str3);
    ...
    if ((i == 2) && (!TextUtils.isEmpty(str3))) {
      axqw.b(null, "dc00899", "c2c_AIO", "", "music_tab", "close_tab", 0, 0, str3, "", "", "");
    }
    ...
    for (;;)
    {
      axqw.b(null, "dc00899", "Grp_AIO", "", "music_tab", "close_tab", 0, 0, str3, "", str1, "");
      return;
      label180:
      str1 = str2;
