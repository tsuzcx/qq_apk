  ...
  implements arsp
{
  ...
  Application.ActivityLifecycleCallbacks jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new arsy(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new arsz(this);
  protected arrh a;
  ...
  public arss(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilSet = new ArraySet();
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Arsq = new arsq();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_Int = -1;
    this.jdField_d_of_type_Int = 0;
    this.jdField_e_of_type_Int = 0;
    this.jdField_a_of_type_Arrh = new arsx(this);
    this.jdField_h_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Arrh);
    j();
    this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean = true;
    paramQQAppInterface = BaseApplicationImpl.getContext();
    this.jdField_f_of_type_Int = bbll.a();
    this.jdField_g_of_type_Int = bbll.b();
    int j = actj.a(12.0F, paramQQAppInterface.getResources());
    this.jdField_d_of_type_Int = j;
    this.jdField_b_of_type_Int = j;
    j = actj.a(12.0F, paramQQAppInterface.getResources());
    this.jdField_e_of_type_Int = j;
    this.jdField_c_of_type_Int = j;
    this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = -1000;
    this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = -1000;
  ...
  private void a(String paramString)
  {
    ...
    if (!bbbr.a(paramString, this.jdField_b_of_type_JavaLangString))
    {
    ...
    arsr localarsr = a();
    if ((localarsr != null) && (!bbbr.a(localarsr.a(), paramString)))
    {
      localarsr.setSongId(paramString);
      localarsr.setLyric(null, 1);
    }
  }
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      return false;
      localarsr = a();
    } while ((localarsr == null) || (!paramString1.equals(localarsr.a())) || (localarsr.a() == 2));
    paramString1 = paramString2;
    if (!TextUtils.isEmpty(paramString2)) {
      paramString1 = paramString2.replace("&apos;", "'").replace("&quot;", "\"").replace("&nbsp;", " ").replace("&lt;", "<").replace("&gt;", ">").replace("&amp;", "&");
    }
    asbc localasbc = asbk.a(paramString1, true);
    paramString2 = localasbc;
    if (localasbc == null) {
      paramString2 = asbk.a(paramString1, false);
    }
    boolean bool;
    int j;
    if (QLog.isColorLevel())
    ...
    {
      localarsr.c();
      localarsr.setLyric(paramString2, j);
      return true;
      bool = false;
      break;
      label224:
  ...
  private void b(String paramString, int paramInt)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, String.format("updateLyricState [%s, %s]", new Object[] { artd.a(paramInt), paramString }));
    }
    arsr localarsr = a();
    if (localarsr == null) {
      return;
  ...
  {
    boolean bool2 = false;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Arsq.a(paramInt, paramString))) {
      return true;
    }
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Arsq.jdField_b_of_type_Boolean = this.jdField_a_of_type_JavaUtilSet.contains(paramInt + "_" + paramString);
        if (this.jdField_a_of_type_Arsq.b(paramInt, paramString))
        {
          bool1 = false;
          if (bool1 != this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean)
          {
            this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean = bool1;
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout == null)
          {
            ...
            aylx.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout == null)
          {
          ...
          if (this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean) {
            break;
          }
          if (!this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean) {
            break label478;
          }
          this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2);
          if (this.jdField_a_of_type_Arsq.jdField_b_of_type_Int == -1000) {
            this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = (this.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2 - actj.a(110.0F, BaseApplicationImpl.getContext().getResources()));
          }
          this.jdField_a_of_type_Arsq.jdField_e_of_type_Boolean = true;
          if (QLog.isColorLevel()) {
            QLog.d("LyricsController", 2, "showLyricsInner mFloatParams: " + this.jdField_a_of_type_Arsq);
          }
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq);
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq);
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Arsq));
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Arsq));
          boolean bool3 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq);
          bool1 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq);
          this.jdField_a_of_type_Arsq.jdField_d_of_type_Boolean = false;
          if (bool1)
          {
            bool1 = bool2;
            if (bool3) {}
    ...
    if (this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = (this.jdField_d_of_type_Int + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2);; this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = (this.jdField_f_of_type_Int - this.jdField_b_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2))
    {
      if (this.jdField_a_of_type_Arsq.jdField_b_of_type_Int == -1000) {
        this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = (actj.a(70.0F, BaseApplicationImpl.getContext().getResources()) + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2);
      }
      this.jdField_a_of_type_Arsq.jdField_e_of_type_Boolean = false;
      break;
    }
  }
  ...
  private void c(String paramString, int paramInt)
  {
    arsr localarsr = a();
    if (localarsr == null) {}
    while (!bbbr.a(localarsr.a(), paramString)) {
      return;
    }
    localarsr.a(paramInt);
  }
  ...
  private void n()
  {
    ...
    this.jdField_a_of_type_Arsq.jdField_h_of_type_Boolean = false;
    boolean bool1;
    if (this.jdField_b_of_type_Boolean) {
      if ((this.jdField_a_of_type_Arsq.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_Arsq.jdField_g_of_type_Boolean))
      {
        j = this.jdField_a_of_type_Arsq.jdField_a_of_type_Int;
        k = this.jdField_a_of_type_Arsq.jdField_b_of_type_Int;
        bool1 = this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean;
        if (!this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean) {
          break label460;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean = bool1;
        this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = j;
        this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = k;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq);
        if ((this.jdField_a_of_type_Arsq.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_Arsq.jdField_g_of_type_Boolean)) {
          h();
        ...
        break label238;
        label460:
        if (this.jdField_a_of_type_Arsq.jdField_d_of_type_Boolean)
        {
          if (bool1) {}
  ...
  private void o()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilSet)
    {
      if (!this.jdField_a_of_type_JavaUtilSet.isEmpty())
      {
        ...
        localEditor.putInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_Arsq.jdField_a_of_type_Int);
        localEditor.putInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_Arsq.jdField_b_of_type_Int);
        localEditor.putBoolean("listen_together_float_align_right", this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean);
        localEditor.apply();
        return;
      }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onPositionChangeEnd mFloatParams:" + this.jdField_a_of_type_Arsq + " mScreenWidth:" + this.jdField_f_of_type_Int + " mScreenHeight:" + this.jdField_g_of_type_Int);
    }
    n();
    o();
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      j = this.jdField_a_of_type_Arsq.jdField_a_of_type_Int;
      m = this.jdField_a_of_type_Arsq.jdField_b_of_type_Int;
      k = j - paramInt1;
      j = this.jdField_f_of_type_Int;
      if (!this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean) {
        break label231;
      }
      if ((!this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean) || (this.jdField_a_of_type_Arsq.jdField_b_of_type_Boolean)) {
        break label198;
      }
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Arsq.jdField_e_of_type_Boolean = false;
        this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = paramInt2;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Arsq));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Arsq));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq);
        return;
        label198:
        if (this.jdField_a_of_type_Arsq.jdField_b_of_type_Boolean) {
          break label331;
        }
        paramInt1 = 0 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_Arsq.a(paramInt, paramString);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onExitAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_Arsq);
    }
    int k;
    int m;
    int j;
    if (this.jdField_a_of_type_Arsq.b(paramInt, paramString))
    {
      this.jdField_a_of_type_Arsq.b(0, null);
      if (!this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean = true;
        this.jdField_a_of_type_Arsq.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Arsq.jdField_h_of_type_Boolean = false;
    ...
    for (paramInt = -this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d();; paramInt = this.jdField_f_of_type_Int)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b();
      this.jdField_a_of_type_Arsq.jdField_h_of_type_Boolean = true;
      this.jdField_a_of_type_Arsq.jdField_g_of_type_Int = k;
      this.jdField_a_of_type_Arsq.jdField_h_of_type_Int = m;
      this.jdField_a_of_type_Arsq.jdField_a_of_type_AndroidGraphicsPaint$Align = Paint.Align.CENTER;
      ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
      paramInt = 300;
      if (paramBoolean) {
        paramInt = 500;
      ...
      aylx.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Arsq.jdField_e_of_type_Int);
      return;
      label360:
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Arsq.jdField_f_of_type_Boolean = paramBoolean;
    } while (!this.jdField_b_of_type_Boolean);
    n();
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Arsq.a()) && (BaseActivity.sTopActivity != null))
    {
      localObject = bfpc.a(BaseActivity.sTopActivity);
      boolean bool = arrn.a();
      if (bool) {
        ((bfpc)localObject).b(2131693853);
      }
      ((bfpc)localObject).b(2131693823);
      ((bfpc)localObject).c(2131690596);
      ((bfpc)localObject).a(new arta(this));
      ((bfpc)localObject).setOnCancelListener(new artb(this));
      ((bfpc)localObject).a(new arst(this, (bfpc)localObject, bool));
    ...
    abtq.a(BaseApplicationImpl.getContext(), (Intent)localObject, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout != null))
    {
      ...
      if ((this.jdField_a_of_type_Arsq.jdField_e_of_type_Boolean) && (!this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean)) {
        if (!this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean) {
          break label172;
        }
      }
    ...
    label172:
    for (this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2);; this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2))
    {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Arsq));
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "hideLyrics,  type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_Arsq);
    }
    if (!this.jdField_a_of_type_Arsq.a(paramInt, paramString)) {
      return;
    }
    ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
    ...
    m();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Arsq.a(0, null);
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_JavaLangString = null;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_h_of_type_Int = 0;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Arsq.jdField_g_of_type_Boolean != paramBoolean)
    {
      this.jdField_a_of_type_Arsq.jdField_g_of_type_Boolean = paramBoolean;
      if (this.jdField_b_of_type_Boolean) {
        n();
      }
    }
  ...
  {
    int k = 1;
    if ((!this.jdField_b_of_type_Boolean) || (TextUtils.isEmpty(this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString)) || ((this.jdField_a_of_type_Arsq.jdField_e_of_type_Int != 2) && (this.jdField_a_of_type_Arsq.jdField_e_of_type_Int != 1)) || (this.jdField_a_of_type_Arsq.a())) {
      return;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    Object localObject = this.jdField_a_of_type_Arsq.jdField_e_of_type_Int + "_" + this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString;
    if (((BaseActivity.sTopActivity instanceof SplashActivity)) && (SplashActivity.jdField_a_of_type_Int == 1))
    {
      ...
      j = 1;
      label166:
      localObject = actj.a((Intent)localObject, new int[] { j });
      label178:
      ((Intent)localObject).putExtra("uin", this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString);
      if (this.jdField_a_of_type_Arsq.jdField_e_of_type_Int != 2) {
        break label328;
      }
    ...
    for (int j = k;; j = 2)
    {
      axqy.b((QQAppInterface)localObject, "dc00898", "", "", "qq_vip", "0X800A5C0", j, 0, "", "", VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), "");
      return;
      j = 0;
      break;
      j = 2;
      break label166;
      localObject = actj.a(new Intent(localBaseApplication, ChatActivity.class), new int[] { 2 });
      ((Intent)localObject).putExtra("leftViewText", "");
      break label178;
      ((Intent)localObject).putExtra("uintype", 1);
      ((Intent)localObject).putExtra("troop_uin", this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString);
      break label213;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onEnterAIO, type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_Arsq + " mIsForeground:" + this.jdField_a_of_type_Boolean);
    }
    this.jdField_a_of_type_Arsq.b(paramInt, paramString);
    if (this.jdField_a_of_type_Arsq.a(paramInt, paramString)) {}
    for (boolean bool = false;; bool = true)
    {
      if (bool != this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_Arsq.jdField_c_of_type_Boolean = bool;
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      int j = this.jdField_a_of_type_Arsq.jdField_e_of_type_Int;
      String str = this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString;
      this.jdField_a_of_type_Arrp = new arsu(this);
      ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(j, str, this.jdField_a_of_type_Arrp);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onDestroyAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_Arsq);
    }
  ...
  public void e()
  {
    b(this.jdField_a_of_type_Arsq.jdField_e_of_type_Int, this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString);
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout != null) {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout != null) {
  ...
  public void f()
  {
    ...
    if (!bool)
    {
      ...
      if (!this.jdField_d_of_type_Boolean)
      {
        ...
        abtq.a(BaseApplicationImpl.getContext(), localIntent, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_Arsq.jdField_g_of_type_Boolean = false;
    n();
    int j = this.jdField_a_of_type_Arsq.jdField_e_of_type_Int;
    String str3 = this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString;
    b(j, str3, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ((arqv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(156)).notifyUI(14, true, new Object[] { Integer.valueOf(j), str3 });
      ...
      axqy.b(null, "dc00899", "c2c_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", "", "");
    }
    label156:
    ...
    for (;;)
    {
      axqy.b(null, "dc00899", "Grp_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", str1, "");
      return;
      label249:
      str1 = str2;
  ...
  public void h()
  {
    ...
    int j = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq);
    int k = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Arsq);
    int m = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Arsq);
    int n = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Arsq);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new arsv(this, i1, j, i2, k, i3, m, i4, n));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new arsw(this, j, k, m, n));
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_Arsq.jdField_a_of_type_Int);
    this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_Arsq.jdField_b_of_type_Int);
    this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean = ((SharedPreferences)localObject2).getBoolean("listen_together_float_align_right", this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean);
