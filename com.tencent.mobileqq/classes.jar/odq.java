...
public class odq
{
  public static int a(QQAppInterface paramQQAppInterface, String paramString, AccountDetail paramAccountDetail)
  {
    ...
    {
      return i;
      i = ugf.a(((AccountDetail)localObject).accountFlag);
      break;
      i = 3;
      continue;
      i = 4;
      if (ugf.a(((AccountDetail)localObject).accountFlag2) == -8L)
      {
        i = 8;
        continue;
        i = 5;
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("feeds_type", "" + pay.a(paramArticleInfo));
      ...
      ((JSONObject)localObject2).put("mark_type", "" + pay.a(paramArticleInfo));
    ...
    if ((pgb.g(paramArticleInfo)) || (pgb.i(paramArticleInfo)) || (pgb.j(paramArticleInfo)) || (pgb.k(paramArticleInfo)))
    {
      ...
      a(null, pay.d(paramArticleInfo), str2, str2, 0, 0, String.valueOf(paramArticleInfo.mFeedId), (String)localObject2, "" + paramArticleInfo.mStrategyId, (String)localObject1, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((i != 2) && (ugf.a(paramQQAppInterface, paramString) != -7)) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    bcef.b(paramQQAppInterface, "dc01160", "Pb_account_lifeservice", paramString1, paramString2.toUpperCase(), paramString3.toUpperCase(), paramInt1, paramInt2, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    bcef.b(paramQQAppInterface, paramString1, paramString2, paramString3, paramString4, paramString5, paramInt1, paramInt2, paramString6, paramString7, paramString8, paramString9);
    bcef.b(paramQQAppInterface, "dc01160", "Pb_account_lifeservice", paramString3, paramString4.toUpperCase(), paramString5.toUpperCase(), paramInt1, paramInt2, paramString6, paramString7, paramString8, paramString9);
  }
  ...
  public static String b(String paramString)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("version_standard", "8.4.8");
      ((JSONObject)localObject).put("version_detail", AppSetting.a(BaseApplicationImpl.getContext()));
      ((JSONObject)localObject).put("os_standard", "1");
      ((JSONObject)localObject).put("user_mode", pay.n());
      if (ugu.a.a()) {}
      for (int i = 1;; i = 0)
      {
