  ...
  implements aqyx
{
  ...
  public aqzs(HotPicPageView paramHotPicPageView, aqzq paramaqzq)
  {
  ...
  {
    return new aqzw(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558553, paramViewGroup, false), null);
  }
  ...
  public void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    {
      aqze.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramInt);
      this.jdField_a_of_type_Boolean = true;
    }
    if (this.jdField_a_of_type_Int == 1)
    {
      paramViewHolder.itemView.findViewById(2131367646).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131367647).setVisibility(4);
      return;
    }
    if (HotPicPageView.b())
    {
      paramViewHolder.itemView.findViewById(2131367647).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131367646).setVisibility(8);
      return;
    }
