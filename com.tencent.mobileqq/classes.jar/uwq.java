...
public class uwq
{
  ...
  public static DownloadInfo a(String paramString)
  {
    ...
    try
    {
      ...
      for (int i = TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE;; i = TMAssistantDownloadConst.SHOW_NOTIFICATION_FALSE)
      {
        ...
        localDownloadInfo.m = pqx.a(40677);
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      localIntent.putExtra("big_brother_source_key", pqx.a(40677));
      localIntent.putExtra("big_brother_ref_source_key", pqx.a(0));
      localIntent.setData(Uri.parse(c(paramString)));
    } while (!six.a(paramContext, localIntent));
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    if (a != null)
    {
      ...
      paramContext.setMessage(anvx.a(2131715582));
      paramContext.setNegativeButton(anvx.a(2131715570), new uws()).setPositiveButton(anvx.a(2131715526), new uwr());
      paramContext.show();
      return;
    }
