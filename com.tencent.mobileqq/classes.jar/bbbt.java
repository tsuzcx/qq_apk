...
public class bbbt
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          QQToast.a(BaseApplication.getContext(), 0, anzj.a(2131699978), 0).a();
        ...
        for (;;)
        {
          ...
          QQToast.a(BaseApplication.getContext(), 0, anzj.a(2131699981), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = bhlq.a(paramActivity, String.format(Locale.getDefault(), anzj.a(2131699985), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694098, new bbbu());
          if ((paramActivity != null) && (!paramActivity.isFinishing())) {
            paramList.show();
          }
          bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "frd_select", "notAdd_exp", 0, 0, paramString, String.valueOf(j), "", "");
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    bgyq.a(paramQQAppInterface, true, localTroopInfo);
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), anzj.a(2131699979), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label745;
      }
      paramString3 = String.format(Locale.getDefault(), anzj.a(2131699982), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + anzj.a(2131699986);
        localObject1 = anzj.a(2131699983);
        i = paramString3.indexOf((String)localObject1);
        j = ((String)localObject1).length();
        localObject1 = new avpd(paramString1, paramString1, paramString3, 1, -5020, 135178, l2);
        ((avpd)localObject1).jdField_c_of_type_JavaLangString = paramString3;
        ...
        ((avpd)localObject1).a(i, i + j, paramString3);
        ...
        label348:
        ((avpd)localObject1).d = paramString3;
        localObject3 = new MessageForUniteGrayTip();
        ((MessageForUniteGrayTip)localObject3).initGrayTipMsg(paramQQAppInterface, (avpd)localObject1);
      ...
      {
        bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", (String)localObject2, 0, 0, paramString1, (String)localObject1, "", paramString3);
        if (!QLog.isDevelopLevel()) {
          break;
        }
        ...
        break label108;
        label618:
        paramString3 = String.format(Locale.getDefault(), anzj.a(2131699984), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), anzj.a(2131699980), new Object[] { paramString2 });
        paramInt2 = 0;
        break label187;
        paramString3 = paramString3 + anzj.a(2131699977);
        break label217;
        paramString3 = "";
        break label348;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    anyw localanyw = (anyw)paramFriendListHandler.app.getManager(51);
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      if (localAddFrdInfo.uint32_send_req_flag.get() == 1)
      {
        ...
        localanyw.a(Long.toString(localAddFrdInfo.uint64_uin.get()), false);
        bool1 = bool2;
        break label90;
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (anyw)paramFriendListHandler.app.getManager(51);
      ...
      if (i > 0)
      {
        ...
        if (i >= 0)
        {
          ...
          ((anyw)localObject).a(Long.toString(l1), true);
          i -= 1;
        }
        else
        {
