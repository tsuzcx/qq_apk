...
public class aapk
{
  ...
  public aapk(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3)
  {
    this.b = paramString1;
  ...
  public View a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (ClassNotFoundException localClassNotFoundException)
      {
        ...
        try
        {
          paramString = (View)localObject.getConstructor(new Class[] { Context.class }).newInstance(new Object[] { this.jdField_a_of_type_Aapf });
          return paramString;
        }
  ...
  public void a(nux paramnux, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!nuz.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext(), str, new aapl(this, l, localContext, paramBoolean, paramnux))) && (QLog.isColorLevel())) {
