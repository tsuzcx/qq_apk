...
{
  private static aupk jdField_a_of_type_Aupk;
  ...
  {
    if (jdField_a_of_type_Aupk == null) {}
    try
    {
      if (jdField_a_of_type_Aupk == null) {
        jdField_a_of_type_Aupk = new aupk();
      }
      return jdField_a_of_type_Aupk;
    }
    finally {}
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      {
        aupl.a(bool, true, this.jdField_a_of_type_JavaUtilMap, this.jdField_a_of_type_JavaLangString);
        if (bool) {
          break;
        }
    ...
    aupl.a(true, false, this.jdField_a_of_type_JavaUtilMap, this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_JavaUtilMap = null;
    this.jdField_a_of_type_JavaLangString = "";
    return false;
  }
