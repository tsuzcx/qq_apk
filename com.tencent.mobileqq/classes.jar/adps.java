...
public class adps
  implements adpn
{
  private static adps jdField_a_of_type_Adps;
  adpm jdField_a_of_type_Adpm;
  ...
  private adps()
  {
    ...
    for (this.jdField_a_of_type_Adpm = new adpo();; this.jdField_a_of_type_Adpm = new adpq())
    {
      this.jdField_a_of_type_Adpm.a(this);
      return;
      if (QLog.isColorLevel()) {
  ...
  {
    if (jdField_a_of_type_Adps == null) {}
    try
    {
      if (jdField_a_of_type_Adps == null) {
        jdField_a_of_type_Adps = new adps();
      }
      return jdField_a_of_type_Adps;
    }
    finally {}
  }
  ...
  private Map<String, APIQuotaItem> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    try
    {
      ...
      if (i != 0) {
        this.jdField_a_of_type_Adpm.a(paramString1, paramInt, paramString2);
      }
      return localObject;
    }
    finally {}
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Adpm.a(paramString1, paramInt, paramString2, paramString3);
  }
