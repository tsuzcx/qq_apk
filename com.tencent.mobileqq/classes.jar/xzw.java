...
public abstract class xzw
  extends ydp<CertifiedAccountMeta.StFeed>
  implements yel, ykj
{
  private Handler a;
  ...
  private void a(SubscribeFeedsEvent paramSubscribeFeedsEvent)
  {
        ...
        do
        {
          do
          {
            ...
            case 1: 
              if (xxf.a() != null)
              {
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.icon.set(xxf.a().icon.get());
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.nick.set(xxf.a().nick.get());
              }
    ...
    if (xxf.a() != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        {
          localStFeed.poster.icon.set(xxf.a().icon.get());
          localStFeed.poster.nick.set(xxf.a().nick.get());
        }
      }
    }
