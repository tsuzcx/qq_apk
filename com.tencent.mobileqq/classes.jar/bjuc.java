  ...
  extends bjts
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bjud(this);
  ...
  private void a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      if (paramInt1 > 0)
      {
        str = String.format(localActivity.getString(2131718528), new Object[] { Integer.valueOf(paramInt1) }) + "，";
        str = str + paramString + alpo.a(2131712665);
      }
      paramString = str + String.format(localActivity.getString(2131718521), new Object[] { Integer.valueOf(paramInt2) });
      bdcd.a(localActivity, 232).setMessage(paramString).setNegativeButton(2131718526, new bjuj(this)).show();
      return;
    }
    bfhq.a().a(localActivity.getString(2131718529) + paramString + alpo.a(2131712664));
  }
  
  private void a(String paramString)
  {
    bjmn.a().a().d(paramString);
  }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localIntent.putExtra("source_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getString(2131718329));
  ...
  private void c(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        i = bdbx.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getAccount(), "troop_photo_message", String.valueOf(i));
        if (QLog.isDevelopLevel()) {
  ...
  private void f(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bizm.b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 1, l, "", paramVarArgs, (String)localObject, 7001, 43);
      return;
    }
    catch (Exception paramVarArgs)
    {
  ...
  private void h(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        bizm.c(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), (bizt)localObject2, (Bundle)localObject4, 6);
  ...
  private void i(String... paramVarArgs)
  {
    ...
    bjmn.a().a(new bjue(this, paramVarArgs));
    if (!a())
    {
      bfhq.a().a(alpo.a(2131712663));
      return;
    }
    if (!NetworkState.isNetSupport())
    {
      bfhq.a().a(alpo.a(2131712660));
      return;
    }
    if (!NetworkState.isWifiConn())
    {
      Activity localActivity = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
      bdcd.a(localActivity, 230).setTitle(localActivity.getString(2131718525)).setMessage(localActivity.getString(2131718527)).setPositiveButton(localActivity.getString(2131718524), new bjui(this, paramVarArgs)).setNegativeButton(localActivity.getString(2131718523), new bjuh(this)).show();
      return;
    }
    a(paramVarArgs[0]);
  }
  ...
  private void j(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 4, j, "", paramVarArgs, (String)localObject, 7001, 43);
        return;
      }
      catch (Exception paramVarArgs) {}
  ...
  private void l(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localbizt.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getCurrentAccountUin();
        paramVarArgs.putBoolean("key_need_change_to_jpg", true);
        bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), localbizt, paramVarArgs, bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 6));
        return;
      }
      catch (Exception paramVarArgs) {}
    } while (!QLog.isColorLevel());
