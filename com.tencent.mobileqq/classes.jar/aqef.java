...
public class aqef
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aqek(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560927, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367507));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367511));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560946, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367507));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367508));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560945, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367507));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367508));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560936, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367507));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367512));
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    do
    {
      ...
      if (j > 0)
      {
        ...
        localObject = bcxb.a(localQQAppInterface, 1, (String)localObject, 4, localDrawable, localDrawable);
        ((bcxb)localObject).mutate();
        localDrawable = localImageView.getDrawable();
        if ((localDrawable != null) && (localDrawable != localObject) && ((localDrawable instanceof bcxb))) {
      ...
      for (;;)
      {
        ...
        localObject = null;
        break label225;
        localImageView.setImageDrawable(bdda.a(true));
        localImageView.setVisibility(0);
        continue;
    ...
    if (localQQAppInterface != null)
    {
      localObject = bdda.a(true);
      bcxb.a(localQQAppInterface, 1, paramArrayList, 4, (Drawable)localObject, (Drawable)localObject);
    }
  ...
  void b()
  {
    ...
    for (int i = aekt.a(2.0F, ((Context)localObject2).getResources());; i = aekt.a(1.0F, ((Context)localObject2).getResources()))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(i, i, i, i);
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130844662);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131367507);
      ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131367507);
      ...
      try
      {
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new aqeg(this));
  ...
  void c()
  {
    ...
    int j = i - ((Context)localObject1).getResources().getDimensionPixelSize(2131298019);
    if (this.jdField_a_of_type_Int == 2)
    {
      j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298027);
      i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298025);
    }
    for (;;)
    {
      ...
      localObject3 = new aqei(this, (AnimatorSet)localObject1);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() > 1)
      {
        ...
        for (;;)
        {
          if (j < this.jdField_a_of_type_JavaUtilList.size() - 1)
          {
            ...
            j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298030);
            i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298028);
            break;
          }
        }
