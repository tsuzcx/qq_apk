  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      if (((File)localObject1).exists())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(aasr.jdField_a_of_type_JavaLangString, 2, "queryImage, ret=" + ((Pair)localObject1).first + ",cost=" + l1 + ",url=" + (String)((Pair)localObject1).second);
        }
        ...
        bjgx.a().a((Bundle)localObject2, "", str2, false);
        m = 1;
        ...
        paramString.putString("intext_3", "" + bjhd.b(this.a.a.jdField_a_of_type_Int));
        paramString.putString("intext_2", "" + j);
        paramString.putString("stringext_1", this.a.a.jdField_a_of_type_JavaLangString);
        bjgx.a().a(paramString, "", this.a.a.this$0.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
        if (QLog.isColorLevel()) {
          QLog.e("shareWebPage", 2, "WebView screenshot END. thumb=" + this.a.a.this$0.i);
        }
        aasr.a(this.a.a.this$0, this.a.a.jdField_a_of_type_JavaLangString, this.a.a.jdField_a_of_type_Int, this.a.a.jdField_a_of_type_Boolean);
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramString.putString("stringext_1", this.a.a.jdField_a_of_type_JavaLangString);
          bjgx.a().a(paramString, "", str2, false);
          ...
          for (;;)
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d(aasr.jdField_a_of_type_JavaLangString, 2, paramString.getMessage());
              i = j;
              k = m;
              continue;
              i = 1;
