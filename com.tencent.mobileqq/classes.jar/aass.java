...
public class aass
  extends beyf
{
  public aass(TroopMemberApiService paramTroopMemberApiService) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1003: 
      do
      {
        ...
        {
          return;
          if (localbete.jdField_b_of_type_Int != 64) {
            break;
          }
          this.a.jdField_a_of_type_Int = bevi.jdField_a_of_type_Int;
        ...
        paramMessage = (axxj)((QQAppInterface)TroopMemberApiService.k(this.a)).a(60);
        ...
        return;
        if (localbete.jdField_b_of_type_Int == 39)
        {
          this.a.jdField_b_of_type_JavaLangString = ((bevi)localbete.a).jdField_b_of_type_JavaLangString;
          if (QLog.isColorLevel()) {
          ...
          axxd.a((QQAppInterface)TroopMemberApiService.l(this.a), this.a.jdField_a_of_type_JavaLangString);
          return;
        }
