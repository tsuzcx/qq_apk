...
public class bkue
{
  ...
  private bkug jdField_a_of_type_Bkug;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ahwa.jdField_d_of_type_JavaLangString + "pddata/prd/dov_capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    e = ahwa.jdField_d_of_type_JavaLangString + "qav" + File.separator + "beauty" + File.separator;
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bkug != null) {
        this.jdField_a_of_type_Bkug.a();
      }
      return true;
      label334:
      i += 1;
  ...
  public void a()
  {
    this.jdField_a_of_type_Bkug = null;
  }
  ...
  {
    this.jdField_a_of_type_Bkug = parambkug;
  }
  ...
  public void a(bkuj parambkuj)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Bkuj = parambkuj;
      ...
      parambkuj = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambkuj.hasNext())
      {
        Object localObject1 = (FilterCategory)parambkuj.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((ayrv)localObject3).jdField_a_of_type_Aysa = new bkui(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((ayrv)localObject2).jdField_a_of_type_Aysa = new bkuh(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Bkuj == null));
    this.jdField_a_of_type_Bkuj.a(false);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bkuj = null;
  }
}
