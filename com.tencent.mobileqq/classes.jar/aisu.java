  ...
  extends aira
{
  ...
  aisu(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aiqz.f)
    {
      ...
      PhotoUtils.a(this.mActivity, localIntent, this.mPhotoCommonData.selectedPhotoList, 0, this.jdField_a_of_type_Aiqz.jdField_a_of_type_Boolean);
      return;
    }
    if (!this.jdField_a_of_type_Aiqz.g)
    {
      localIntent.putExtra("PhotoConst.ALLOW_LOCK", false);
      localIntent.setClass(this.mActivity, NewPhotoPreviewActivity.class);
      localIntent.putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_Aiqz.jdField_b_of_type_JavaUtilHashMap);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        bdfa.a(localIntent, this.mPhotoCommonData.albumId, str, this.jdField_a_of_type_Aiqz.isRecodeLastAlbumPath);
  ...
  public void caseVideo(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!this.jdField_a_of_type_Aiqz.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new aisv(this, paramAdapterView, (ArrayList)localObject1), paramView);
        return;
      }
