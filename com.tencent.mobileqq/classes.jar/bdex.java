...
public class bdex
{
  ...
  public static bdey a(byte[] paramArrayOfByte)
  {
    bdey localbdey = new bdey();
    ...
    for (;;)
    {
      try
      {
        ...
        localbdey.jdField_a_of_type_Int = paramArrayOfByte.get();
        ...
        if (paramArrayOfByte.hasRemaining())
        {
          ...
          localbdey.c = i;
          localbdey.jdField_a_of_type_JavaLangString = new String(arrayOfByte);
          if (QLog.isColorLevel()) {
            QLog.d("ActionMsgUtil", 2, "decodeAppShareCookie succes appShareCookie.buissnessType =" + localbdey.jdField_a_of_type_Int + "appShareCookie.action" + localbdey.b + "appShareCookie.actionType" + localbdey.c + "appShareCookie.actionValue" + localbdey.jdField_a_of_type_JavaLangString);
          }
        }
      }
