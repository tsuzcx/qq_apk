...
public class bdex
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (k - 10 < c())
    {
      ...
      {
        paramString = (bckx)paramQQAppInterface.getManager(203);
        localObject2 = (bfua)paramQQAppInterface.getManager(165);
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((paramString.b(((TroopMemberInfo)localObject1).memberuin)) || (((bfua)localObject2).f(((TroopMemberInfo)localObject1).memberuin))) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    return ((almv)paramQQAppInterface.getManager(53)).a(paramString);
  }
  ...
  public static Bundle a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (bcjl)paramQQAppInterface.getManager(48);
    boolean bool3 = ((bcjl)localObject).a(paramString, paramQQAppInterface.getCurrentAccountUin());
    boolean bool4 = ((bcjl)localObject).a(paramString);
    boolean bool5 = ((bcjl)localObject).b(paramString);
    paramQQAppInterface = ((bcjl)localObject).a(paramString);
    int j = 0;
    boolean bool2 = false;
    int i;
    boolean bool1;
  ...
  public static bdfa a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = bdfa.a(lex.b(276).a);
      }
      return a;
    }
    finally {}
  ...
  {
    paramString = bdfa.a(paramString);
    try
    {
      a = paramString;
      return;
  ...
  public static void a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.addObserver(new bdey(l, paramString1, paramQQAppInterface, str));
        localalzf.b(l, 480, 0);
        paramString2 = ((TroopManager)paramQQAppInterface.getManager(52)).c(paramString2);
        if (paramString2.maxInviteMemNum == 0)
        {
          paramQQAppInterface.addObserver(new bdez(str, paramQQAppInterface, paramString1));
          localalzf.j(str);
        }
  ...
  {
    paramQQAppInterface = (bcjl)paramQQAppInterface.getManager(48);
    ...
    {
      AudioHelper.a(alpo.a(2131709300));
      return true;
    }
    return bool1;
  }
  ...
  public static boolean a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    if (localTroopInfo != null)
    {
      ...
      bool1 = true;
      str = alpo.a(2131709297);
      label91:
      if ((!bool1) || (!localTroopInfo.isAdmin())) {
        break label735;
      }
      str = str + alpo.a(2131709302);
    }
    label158:
    label210:
    label597:
    ...
    for (boolean bool5 = false;; bool5 = bool1)
    {
      ...
      for (;;)
      {
        ...
        {
          bool1 = false;
          paramQQAppInterface = ((bcjl)paramQQAppInterface.getManager(48)).a(paramString2);
