...
public class bghn
  extends QIPCModule
{
  private static bghn jdField_a_of_type_Bghn;
  bgho jdField_a_of_type_Bgho;
  
  public bghn(String paramString)
  {
    super(paramString);
  }
  
  public static bghn a()
  {
    if (jdField_a_of_type_Bghn == null) {}
    try
    {
      if (jdField_a_of_type_Bghn == null) {
        jdField_a_of_type_Bghn = new bghn("QQComicIPCModule");
      }
      return jdField_a_of_type_Bghn;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("isLebaItemOpen".equals(paramString))
    {
      ...
      paramString = ((avpq)((QQAppInterface)localObject).getManager(36)).a().iterator();
      do
      {
      ...
      for (;;)
      {
        ...
        else
        {
          if ("getComicConfig".equals(paramString))
          {
            ...
            if ((paramInt > 0) && (paramString != null))
            {
              if (this.jdField_a_of_type_Bgho == null) {
                this.jdField_a_of_type_Bgho = new bgho(this, paramInt);
              }
              paramString.addCallBacker(this.jdField_a_of_type_Bgho);
            }
          ...
          if ("getPlayerSo".equals(paramString)) {
            bghi.a((QQAppInterface)localObject);
          }
        }
      }
    }
