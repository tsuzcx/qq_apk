...
public class asfc
  extends amrv
{
  public asfc(AppletsSettingFragment paramAppletsSettingFragment) {}
  ...
  protected void onGetAppletsSettingSwitch(boolean paramBoolean, List<amse> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((paramList != null) && (paramBoolean) && (paramList.size() > 0))
      {
        ...
        {
          Object localObject1 = (amse)paramList.next();
          Object localObject2;
          if ((((amse)localObject1).jdField_a_of_type_JavaUtilList != null) && (((amse)localObject1).jdField_a_of_type_JavaUtilList.size() > 0) && (((amse)localObject1).jdField_a_of_type_JavaUtilList.get(0) != null) && (((AppletItem)((amse)localObject1).jdField_a_of_type_JavaUtilList.get(0)).a() == 1L))
          {
            AppletsSettingFragment.a(this.a, (AppletItem)((amse)localObject1).jdField_a_of_type_JavaUtilList.get(0));
            ...
            {
              ((ajfv)localObject2).a(paramBoolean);
              if (TextUtils.isEmpty(((amse)localObject1).jdField_a_of_type_JavaLangString)) {
                break;
              }
              AppletsSettingFragment.b(this.a).setText(((amse)localObject1).jdField_a_of_type_JavaLangString);
              this.a.a.a(((amse)localObject1).jdField_a_of_type_JavaLangString);
              break;
              paramBoolean = false;
              break label247;
            }
          ...
          if (!TextUtils.isEmpty(((amse)localObject1).jdField_a_of_type_JavaLangString))
          {
            AppletsSettingFragment.c(this.a).setText(((amse)localObject1).jdField_a_of_type_JavaLangString);
            this.a.a.b(((amse)localObject1).jdField_a_of_type_JavaLangString);
          }
          if ((((amse)localObject1).jdField_a_of_type_JavaUtilList != null) && (((amse)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
          {
            AppletsSettingFragment.a(this.a).clear();
            localObject1 = ((amse)localObject1).jdField_a_of_type_JavaUtilList.iterator();
