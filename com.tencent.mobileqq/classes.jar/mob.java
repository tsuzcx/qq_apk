...
public class mob
{
  ...
  private LruCache<String, mod> jdField_a_of_type_AndroidUtilLruCache = new moc(this, 4194304);
  private LinkedList<moe> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private moe jdField_a_of_type_Moe;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public mob(int paramInt)
  {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        mod localmod = (mod)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmod != null)
        {
          this.jdField_a_of_type_Moe = new moe(localmod, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (mod)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Moe = new moe(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      moe localmoe = this.jdField_a_of_type_Moe;
      if (localmoe != null) {
        localmoe.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmoe = (moe)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmoe != null)
        {
          int j = i + localmoe.a(this.b, i, paramInt);
          i = j;
          if (!localmoe.a()) {
            break label229;
          }
      ...
      {
        mof.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new mod(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmod != null)
        {
          paramString = new moe(localmod, false);
      ...
      if (paramString != null)
      {
        paramString = new moe(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
