  ...
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener
{
  ...
  public bbqw(Activity paramActivity, bbpt parambbpt)
  {
    super(paramActivity, parambbpt);
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_c_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Bbpt = parambbpt;
  }
  ...
  private VideoPlayParam a(akss paramakss)
  {
    ...
    if (!paramakss.jdField_a_of_type_Boolean)
    {
      ...
      localVideoPlayParam.mSavePath = paramakss.jdField_a_of_type_AndroidOsBundle.getString("savepath");
      localVideoPlayParam.mFileID = paramakss.jdField_a_of_type_AndroidOsBundle.getString("fileid");
      localVideoPlayParam.mUrls = paramakss.jdField_a_of_type_ArrayOfJavaLangString;
      localVideoPlayParam.mCookies = paramakss.jdField_a_of_type_JavaUtilArrayList;
      localVideoPlayParam.mVideoFormat = 104;
      b(1);
    }
    for (;;)
    {
      localVideoPlayParam.mIsMute = paramakss.jdField_e_of_type_Boolean;
  ...
  private void a(int paramInt1, int paramInt2, VideoPlayParam paramVideoPlayParam)
  {
    ...
    if (paramInt1 == 2)
    {
      akss localakss = new bbpk().a(localAIOFileVideoData, localAIOFileVideoData.i);
      if ((localakss != null) && (localakss.jdField_a_of_type_ArrayOfJavaLangString != null) && (!bhsr.a(localakss.jdField_b_of_type_JavaLangString)))
      {
        String[] arrayOfString = localakss.jdField_a_of_type_ArrayOfJavaLangString;
        ...
        while (i < j)
        {
          ...
          if (!bhsr.a(str2)) {
            InnerDns.getInstance().reportBadIp(localakss.jdField_b_of_type_JavaLangString, InnerDns.getHostFromUrl(str2), 1005);
          }
          i += 1;
        }
        bbqj.a().a();
    ...
    for (;;)
    {
      ...
      if ((!bapj.a(paramInt2, paramVideoPlayParam)) || (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView == null) || (localAIOFileVideoData == null) || (localAIOFileVideoData.jdField_g_of_type_Int >= 2)) {
        break;
      }
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    Object localObject = this.jdField_a_of_type_Bbpt.getItem(paramInt);
    bbpk localbbpk;
    if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 103))
    {
      ...
      localbbpk = new bbpk();
      if ((!localbbpk.a((AIOFileVideoData)localObject)) && (!((AIOFileVideoData)localObject).jdField_d_of_type_Boolean))
      {
        localbbpk.a((AIOFileVideoData)localObject, (bbpa)RichMediaBrowserManager.getInstance().getProvider());
        this.jdField_a_of_type_Bbpt.a((AIOFileVideoData)localObject);
        this.jdField_a_of_type_Bbpt.a(((AIOFileVideoData)localObject).jdField_a_of_type_Long, ((AIOFileVideoData)localObject).jdField_a_of_type_Int, 4);
        updateUI();
      }
    }
    else
    ...
    a(localbbpk.a((AIOFileVideoData)localObject, ((AIOFileVideoData)localObject).i));
  ...
  private void a(Bitmap paramBitmap)
  {
    ...
    //   87: putfield 42	bbqw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   112: aload_0
    //   113: getfield 42	bbqw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   125: aload_1
    //   126: aload_0
    //   127: getfield 42	bbqw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   130: invokestatic 477	auog:a	(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    //   133: pop
    ...
    //   155: iconst_3
    //   156: aload 7
    //   158: invokestatic 486	zxx:a	(Landroid/graphics/Bitmap;ZILandroid/util/SparseArray;)I
    //   161: istore_2
    //   162: iload_2
    //   163: invokestatic 489	zxx:a	(I)Z
    //   166: ifeq +98 -> 264
    ...
    //   258: aload_1
    //   259: iconst_0
    //   260: invokestatic 526	bhrt:a	(ILjava/util/ArrayList;Ljava/lang/String;I)Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;
    //   263: pop
    //   264: iload_2
    //   265: invokestatic 528	zxx:b	(I)Z
    //   268: ifeq +74 -> 342
    ...
    //   336: aload_1
    //   337: iconst_0
    //   338: invokestatic 526	bhrt:a	(ILjava/util/ArrayList;Ljava/lang/String;I)Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;
    //   341: pop
    //   342: aload 6
    ...
    //   418: aload_0
    //   419: aload 6
    //   421: invokespecial 547	com/tencent/mobileqq/richmediabrowser/view/AIOFileVideoView$6:<init>	(Lbbqw;Ljava/util/ArrayList;)V
  ...
  {
    paramVideoPlayParam.mCallback = new bbqy(this, paramVideoPlayParam);
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bbpt.getSelectedItem();
      if ((localRichMediaBrowserInfo == null) || (!(localRichMediaBrowserInfo.baseData instanceof AIOFileVideoData))) {
        break label74;
      }
      if (!bhmi.b(((AIOFileVideoData)localRichMediaBrowserInfo.baseData).jdField_c_of_type_JavaLangString)) {
        return false;
      }
  ...
  private void b(int paramInt)
  {
    AIOFileVideoData localAIOFileVideoData = a();
    if (localAIOFileVideoData != null) {
      this.jdField_a_of_type_Bbpt.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, paramInt);
    }
  }
  ...
  private void b(AIOFileVideoData paramAIOFileVideoData)
  {
    ...
    if (new bbpk().a(paramAIOFileVideoData))
    {
      aunj.a(this.mContext, paramAIOFileVideoData.jdField_c_of_type_JavaLangString);
      return;
    }
  ...
  private void k()
  {
    ...
    j();
    if (this.jdField_a_of_type_Bbpt.a(this.jdField_a_of_type_Bbpt.getCurrentPosition())) {
      this.jdField_a_of_type_Bbpt.a(true);
    }
  }
  
  private void l()
  {
    AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Bbpt.a();
    if ((localAIOFileVideoData == null) || (!bhmi.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString))) {}
    for (;;)
    {
      return;
      ...
      this.jdField_a_of_type_Bjgf.a(localAIOFileVideoData.jdField_c_of_type_JavaLangString, localAIOFileVideoData.jdField_a_of_type_Long, l);
      if (bhmi.b(localAIOFileVideoData.jdField_b_of_type_JavaLangString)) {
        this.jdField_a_of_type_Bjgf.a(localAIOFileVideoData.jdField_b_of_type_JavaLangString, localAIOFileVideoData.jdField_c_of_type_Int, localAIOFileVideoData.jdField_d_of_type_Int);
      }
      if (localAIOFileVideoData.jdField_c_of_type_Int > localAIOFileVideoData.jdField_d_of_type_Int) {}
      for (boolean bool = true; this.jdField_a_of_type_Bjgf.a(bool, localAIOFileVideoData.jdField_b_of_type_Int); bool = false)
      {
        this.jdField_a_of_type_Bbpt.back();
        return;
      }
    }
  }
  ...
  public void a()
  {
    if (this.mBrowserItemView != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((RelativeLayout)localObject).findViewById(2131371891));
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131377245));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131372146));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131373046));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379238));
      ...
      this.e = ((ImageButton)this.mBrowserItemView.findViewById(2131374353));
      this.e.setContentDescription(anzj.a(2131698947));
      this.e.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((RelativeLayout)localObject).findViewById(2131380467));
      this.jdField_b_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131380469));
      this.jdField_b_of_type_AndroidWidgetSeekBar.setMax(10000);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131380468));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131364585));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.mBrowserItemView.findViewById(2131364011));
      ...
      this.jdField_d_of_type_AndroidWidgetImageButton = ((ImageButton)this.mBrowserItemView.findViewById(2131374360));
      this.jdField_d_of_type_AndroidWidgetImageButton.setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView = this.mBrowserItemView.findViewById(2131380983);
      this.mBrowserItemView.findViewById(2131372960).setOnClickListener(this);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.mBrowserItemView.findViewById(2131372962));
      if (LiuHaiUtils.b())
      {
  ...
  public void a(int paramInt1, String paramString1, String[] paramArrayOfString, String paramString2, MessageForShortVideo paramMessageForShortVideo, int paramInt2, Bundle paramBundle)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bbpt.getItem(paramInt1);
    ...
    for (;;)
    {
      ...
      if (localRichMediaBrowserInfo.baseData.getType() == 103)
      {
        ...
        paramMessageForShortVideo = new bbpk();
        ...
        if ("I:E".equals(paramString1)) {
          try
          {
            ...
            this.jdField_a_of_type_Bbpt.a(paramString2.jdField_a_of_type_Long, paramString2.jdField_a_of_type_Int, 8);
            if (paramString2.jdField_f_of_type_Long == -134L)
            {
              paramString1 = this.mContext.getString(2131718233);
              bool = true;
              if (bool)
              {
                paramString1 = bhlq.a(this.mContext, 230, "", paramString1, null, anzj.a(2131698984), new bbqx(this), null);
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bbpt.a(paramString2.jdField_a_of_type_Long, paramString2.jdField_a_of_type_Int, 0);
      ...
      this.jdField_a_of_type_Bbpt.a(paramString2.jdField_a_of_type_Long, paramString2.jdField_a_of_type_Int, 5);
      a(paramString1);
      return;
  ...
  {
    this.jdField_a_of_type_Bbpt.a(paramLong, paramInt, 2);
  }
  ...
  {
    this.jdField_a_of_type_Bbpt.a(paramLong, paramInt1, paramInt2, paramString1);
    a(this.jdField_a_of_type_Bbpt.getSelectedIndex(), paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3, paramBundle);
  }
  
  public void a(AIOFileVideoData paramAIOFileVideoData)
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bbqz(this, paramAIOFileVideoData));
  }
  ...
  public void a(AIOFileVideoData paramAIOFileVideoData, int paramInt)
  {
    ...
    bhrt.a(2, this.jdField_b_of_type_JavaUtilArrayList);
    bhrt.a(27, this.jdField_b_of_type_JavaUtilArrayList);
    bhrt.a(39, this.jdField_c_of_type_JavaUtilArrayList);
    bhrt.a(6, this.jdField_c_of_type_JavaUtilArrayList);
    if ((bbox.a().g()) && (!TextUtils.isEmpty(bbox.a().c()))) {
      bhrt.a(54, this.jdField_c_of_type_JavaUtilArrayList);
    }
    ...
    for (;;)
    {
      ...
      paramAIOFileVideoData = this.jdField_a_of_type_Bbpt.a(paramAIOFileVideoData, this.mContext);
  ...
  public boolean b()
  {
    ...
    {
      AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Bbpt.a();
      if ((localAIOFileVideoData != null) && (!bbox.a().c()) && (auog.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString))) {
        return true;
      }
    }
    return false;
  ...
  public void bindView(int paramInt)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bbpt.getItem(paramInt);
    if ((localRichMediaBrowserInfo == null) || (localRichMediaBrowserInfo.baseData == null)) {
      return;
    }
    Object localObject;
    ...
    if (localRichMediaBrowserInfo.baseData.getType() == 103)
    {
      localObject = this.jdField_a_of_type_Bbpt.a();
      ...
      localbbpk = new bbpk();
      localObject = (Drawable)this.jdField_a_of_type_Bbpt.mActiveDrawable.get(Integer.valueOf(paramInt));
      if (!localbbpk.b(localAIOFileVideoData)) {
        break label346;
      }
    }
    for (;;)
    {
      ...
      this.mBrowserItemView.setId(2131374321);
      ...
      this.jdField_a_of_type_ComTencentRichmediabrowserViewGalleryUrlImageView.setContentDescription(this.mContext.getString(2131691436));
      if (localbbpk.b(localAIOFileVideoData)) {
      ...
      localObject = new bbra(this);
      ((bbra)localObject).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      ...
      this.jdField_a_of_type_Bbpt.onLoadFinish(paramInt, true);
    }
    label373:
    if (!TextUtils.isEmpty(localAIOFileVideoData.jdField_b_of_type_JavaLangString))
    {
      ...
      this.jdField_a_of_type_Bbpt.mActiveDrawable.put(Integer.valueOf(paramInt), (URLDrawable)localObject);
    }
    label499:
    for (;;)
    {
  ...
  public void buildParams(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Int = (bdhj.a(this.mContext) / 2);
  }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (this.jdField_a_of_type_Bbpt.a() == null) {
        break label93;
      }
    }
    label93:
    for (boolean bool = this.jdField_a_of_type_Bbpt.a().b();; bool = false)
    {
      ...
      b(false);
      this.jdField_a_of_type_Bbpt.b(false);
      return;
    }
    if ((this.jdField_a_of_type_Bbpt.a() != null) && (this.jdField_a_of_type_Bbpt.a().b()))
    {
      this.jdField_a_of_type_Bbpt.a().jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Bbpt.d();
      this.jdField_a_of_type_Bbpt.e();
      i(false);
      return;
    }
    showContentView(false);
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bbra)))
    {
      this.mBrowserItemView = ((RelativeLayout)paramView);
      this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = ((bbra)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
    }
    for (;;)
    {
  ...
  public void i()
  {
    a(this.jdField_a_of_type_Bbpt.getCurrentPosition(), true);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Bbpt.i();
        g();
        break;
        QLog.i("AIOFileVideoView<FileAssistant>XOXO", 1, "video pause, try PLAY!");
        new bbpk().a(localAIOFileVideoData, this.mContext, this);
      }
      if (this.jdField_a_of_type_Bbpt.b())
      {
        if (this.jdField_a_of_type_Bbpt.a().jdField_a_of_type_Boolean)
        {
          this.jdField_a_of_type_Bbpt.a().f();
          this.jdField_a_of_type_Bbpt.a().jdField_a_of_type_Boolean = false;
          e();
          this.jdField_a_of_type_Bbpt.a().a();
        }
        else
        {
          this.jdField_a_of_type_Bbpt.a().f();
          this.jdField_a_of_type_Bbpt.a().b();
          this.jdField_a_of_type_Bbpt.a().jdField_a_of_type_Boolean = true;
          e(true);
        }
      }
      else
      {
        this.jdField_a_of_type_Bbpt.back();
        continue;
        localAIOFileVideoData = this.jdField_a_of_type_Bbpt.a();
        bbpk localbbpk = new bbpk();
        ...
        if (localbbpk.a(localAIOFileVideoData)) {
          this.jdField_a_of_type_Bbpt.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 5);
        }
        for (;;)
        {
          a(this.jdField_a_of_type_Bbpt.getCurrentPosition(), false);
          h();
          updateUI();
          break;
          this.jdField_a_of_type_Bbpt.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 1);
        }
        localAIOFileVideoData = this.jdField_a_of_type_Bbpt.a();
        if (localAIOFileVideoData != null)
        {
          localAIOFileVideoData.jdField_e_of_type_Boolean = true;
          this.jdField_a_of_type_Bbpt.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 0);
          this.jdField_a_of_type_Bbpt.b(localAIOFileVideoData);
          this.jdField_a_of_type_Bbpt.back();
          continue;
          l();
          this.jdField_a_of_type_Bbpt.k();
          continue;
          d();
          continue;
          c();
          ...
          {
            long l = this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.getCurPlayingPos();
            MiniChatActivity.a(this.mContext, bbox.a().a(), bbox.a().a(), false, 26, localAIOFileVideoData.jdField_d_of_type_Long, l);
          }
          this.jdField_a_of_type_Bbpt.l();
          continue;
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView != null)
    {
      ...
      this.jdField_a_of_type_Bbpt.c(a());
    }
    this.jdField_a_of_type_Bbpt.getSelectedItem();
  }
  
  public void onDestroyView(int paramInt, View paramView)
  {
    if (this.jdField_a_of_type_Bbpt.mActiveDrawable != null) {
      this.jdField_a_of_type_Bbpt.mActiveDrawable.remove(Integer.valueOf(paramInt));
    }
  }
  ...
  public void onItemSelected(int paramInt)
  {
    ...
    bbpk localbbpk = new bbpk();
    if ((localAIOFileVideoData.h) && (localbbpk.a(localAIOFileVideoData)))
    {
      a(paramInt, true);
      return;
    }
    ...
    if (RichMediaBrowserManager.getInstance().getProvider() != null)
    {
      ...
      {
        this.jdField_a_of_type_Bbpt.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 1);
        localbbpk.a(localAIOFileVideoData, (bbpa)RichMediaBrowserManager.getInstance().getProvider());
      }
      if ((!bhmi.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString)) && (this.jdField_a_of_type_Bbpt.a(this.jdField_a_of_type_Bbpt.getCurrentPosition()))) {
        this.jdField_a_of_type_Bbpt.a(false);
      }
      updateUI();
    ...
    if ((this.jdField_a_of_type_Bbpt.b(paramInt)) && (localRichMediaBrowserInfo.isEnterImage)) {
      a(localbbpk.a(localAIOFileVideoData, localAIOFileVideoData.i));
    }
    if ((!bhmi.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString)) && (this.jdField_a_of_type_Bbpt.a(this.jdField_a_of_type_Bbpt.getCurrentPosition()))) {
      this.jdField_a_of_type_Bbpt.a(false);
    }
  ...
  public void onResume()
  {
    ...
    if ((this.jdField_a_of_type_Bbpt.b(this.jdField_a_of_type_Bbpt.getCurrentPosition())) && (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView != null))
    {
      AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Bbpt.a();
  ...
  public void onScrollEnd()
  {
    ...
    label79:
    for (boolean bool = bhmi.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString);; bool = false)
    {
  ...
  public void onStopTrackingTouch(SeekBar paramSeekBar)
  {
    ...
    if ((this.jdField_a_of_type_Bbpt.a() != null) && (this.jdField_a_of_type_Bbpt.a(this.jdField_a_of_type_Bbpt.getCurrentPosition())) && (paramSeekBar != null))
    {
      BrowserLogHelper.getInstance().getGalleryLog().d("AIOFileVideoView<FileAssistant>XOXO", 4, "seek danmaku");
      this.jdField_a_of_type_Bbpt.a().a(paramSeekBar.getProgress());
      AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Bbpt.a();
      if (localAIOFileVideoData != null) {
        this.jdField_a_of_type_Bbpt.a().a(bbov.a(localAIOFileVideoData.jdField_d_of_type_Long, paramSeekBar.getProgress(), this.jdField_a_of_type_Bbpt.a(), this.jdField_a_of_type_Bbpt.a));
      }
    }
  ...
  public void updateUI()
  {
    int i = 8;
    super.updateUI();
    Object localObject1 = this.jdField_a_of_type_Bbpt.a();
    if (localObject1 != null)
    {
      c(b());
      d(a(this.jdField_a_of_type_Bbpt.getSelectedItem()));
    ...
    case 5: 
      ...
      {
        return;
        this.jdField_a_of_type_Bbpt.onLoadFinish(this.jdField_a_of_type_Bbpt.getSelectedIndex(), true);
        g(false);
        localObject2 = this.mContext.getString(2131692462) + "(" + auog.a(((AIOFileVideoData)localObject1).jdField_g_of_type_Long) + "/" + auog.a(((AIOFileVideoData)localObject1).jdField_c_of_type_Long) + ")";
        ...
        this.jdField_d_of_type_AndroidWidgetTextView.setText(anzj.a(2131698953) + (String)localObject1 + "%");
        ...
        a(false);
        return;
        localObject1 = this.mContext.getString(2131692462) + "(0/" + auog.a(((AIOFileVideoData)localObject1).jdField_c_of_type_Long) + ")";
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Bbpt.getItem(paramInt);
    if ((localObject1 == null) || (((RichMediaBrowserInfo)localObject1).baseData == null) || (paramView == null)) {
      return;
    }
    BaseVideoView localBaseVideoView;
    if ((paramView.getTag() instanceof bbra))
    {
      localBaseVideoView = ((bbra)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      if (((RichMediaBrowserInfo)localObject1).baseData.getType() == 103)
      {
        ...
        localObject2 = localbbpk.a((AIOFileVideoData)localObject2);
        ...
        this.jdField_a_of_type_Bbpt.onLoadFinish(paramInt, true);
        this.jdField_a_of_type_Bbpt.a().c();
      }
    }
    for (;;)
    {
      ...
      break;
      label196:
      localBaseVideoView.setCoverDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130838072));
      this.jdField_a_of_type_Bbpt.onLoadFinish(paramInt, true);
    }
  }
}
