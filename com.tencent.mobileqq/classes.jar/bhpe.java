  ...
  extends BusinessHandler
{
  ...
  public bhpe(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, ArrayList<String> paramArrayList, ArrayList<Float> paramArrayList1, String paramString2)
  {
    try
    {
      paramString2 = "uip:" + acwz.k() + ", " + paramString2;
    ...
    paramArrayList.qqversion.set("8.4.10.4875");
    ...
    ((bhpe)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VAS_MONITOR_HANDLER)).sendPbReq(paramArrayList1);
    if (QLog.isColorLevel()) {
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (bhpe)paramAppRuntime.getBusinessHandler(BusinessHandlerFactory.VAS_MONITOR_HANDLER);
      if (!((bhpe)localObject).b.get()) {
        ((bhpe)localObject).a(paramAppRuntime, false);
      }
      if (((bhpe)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (((bhpe)localObject).jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramString1))
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      ThreadManager.post(new VasMonitorHandler.1(paramAppRuntime, paramString1, a(new String[] { "109", "8.4.10", paramString2, localObject, paramString4, paramString5 }), a(new Float[] { Float.valueOf(1.0F), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) }), paramString3), 5, null, false);
