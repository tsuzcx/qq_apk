  ...
  implements aivg
{
  ...
  public aiuy(QQAppInterface paramQQAppInterface, aiwh paramaiwh, Activity paramActivity, SessionInfo paramSessionInfo, aggs paramaggs)
  {
  ...
  {
    paramVarArgs = bcry.a(-1016);
    long l = bcrg.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691601), l, -1017, 3000, l);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = arrs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((arrs)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Aggs.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
            ...
            if (!bhnv.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            paramInt = mvd.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          if (!this.jdField_a_of_type_Aiwh.a(this, new Object[0])) {
            break label1201;
          }
          ((arrs)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2);
        ...
        for (;;)
        {
          try
          {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
