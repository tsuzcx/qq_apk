  ...
  extends pbe
{
  ...
  public ojr(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  private ntz a(boolean paramBoolean, List<oidb_cmd0xc46.MedalInfo> paramList, String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      if (paramList.hasNext())
      {
        ...
        if (localMedalInfo.is_jump.has()) {
          localntz.jdField_b_of_type_Int = localMedalInfo.is_jump.get();
        }
        if (localMedalInfo.jump_url.has()) {
          localntz.jdField_c_of_type_JavaLangString = localMedalInfo.jump_url.get().toStringUtf8();
        }
        if (localMedalInfo.medal_type.has()) {
          localntz.jdField_a_of_type_Int = localMedalInfo.medal_type.get();
        }
        if (localMedalInfo.medal_id.has()) {
          localntz.jdField_a_of_type_Long = localMedalInfo.medal_id.get();
        }
        if (localMedalInfo.medal_name.has()) {
          localntz.jdField_a_of_type_JavaLangString = localMedalInfo.medal_name.get().toStringUtf8();
        }
        if (localMedalInfo.medal_url.has()) {
          localntz.jdField_b_of_type_JavaLangString = localMedalInfo.medal_url.get().toStringUtf8();
        }
        if (localMedalInfo.pic_width.has()) {
          localntz.jdField_c_of_type_Int = localMedalInfo.pic_width.get();
        }
        if (localMedalInfo.pic_height.has()) {
          localntz.jdField_d_of_type_Int = localMedalInfo.pic_height.get();
        }
        localntz.jdField_e_of_type_JavaLangString = "3";
        if (paramBoolean) {}
        for (localntz.f = "7";; localntz.f = "6")
        {
          localntz.h = paramString;
    ...
    if (!localArrayList.isEmpty()) {
      paramList = (ntz)localArrayList.get(0);
    }
    return paramList;
  }
  ...
  private void a(oidb_cmd0xc46.Comment paramComment, BaseCommentData paramBaseCommentData)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBaseCommentData.flowGuidePtsData = new String(bbco.decode(paramComment.jump_schema.get(), 0), "utf-8");
        ...
        if ((paramComment.is_multi_media.has()) && (paramComment.is_multi_media.get() == 1))
        {
          ...
          for (List localList = paramComment.rpt_media_data_list.get(); (localList != null) && (localList.size() > 0); localList = null)
          {
            ...
            while (i < j)
            {
              ...
              oie localoie = new oie();
              localoie.jdField_a_of_type_JavaLangString = localMediaData.text.get().toString();
              localoie.jdField_e_of_type_Int = localMediaData.media_type.get();
              localoie.jdField_a_of_type_Int = localMediaData.pic_width.get();
              localoie.jdField_b_of_type_Int = localMediaData.pic_length.get();
              localoie.jdField_b_of_type_JavaLangString = localMediaData.pic_url.get();
              localoie.jdField_e_of_type_JavaLangString = localMediaData.thumbnail_url.get();
              localoie.jdField_d_of_type_JavaLangString = localMediaData.video_url.get();
              localoie.jdField_d_of_type_Int = localMediaData.video_duration.get();
              localoie.jdField_c_of_type_JavaLangString = localMediaData.sound_url.get();
              localoie.jdField_c_of_type_Int = localMediaData.sound_duration.get();
              paramBaseCommentData.mediaDataList.add(localoie);
              i += 1;
            }
          }
        }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pot.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject);
    QLog.d("ReadInJoyCommentPBModule", 1, "handleCommonCommentList | retCode " + j);
    paramFromServiceMsg = new ojs();
    paramObject = new ojs();
    ojt localojt = new ojt();
    boolean bool;
    if (j == 0) {
    ...
    for (;;)
    {
      ...
      if (((oidb_cmd0xc46.RspBody)localObject).extra_info.has())
      {
        ...
        if (((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject).extra_info.get()).hidden_comment_count.has()) {
          localojt.b = ((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject).extra_info.get()).hidden_comment_count.get();
        }
        if (((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject).extra_info.get()).show_mask.has()) {
          localojt.jdField_a_of_type_Int = ((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject).extra_info.get()).show_mask.get();
        }
        if (!((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject).extra_info.get()).jump_kva_schema.has()) {}
      }
      try
      {
        localojt.jdField_a_of_type_JavaLangString = new String(bbco.decode(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject).extra_info.get()).jump_kva_schema.get().toString(), 0), "utf-8");
        ...
        if (((oidb_cmd0xc46.RspBody)localObject).article_info.has())
        {
          ...
          if (localArticleInfo.comment_count.has()) {
            localojt.jdField_a_of_type_Long = localArticleInfo.comment_count.get();
          }
        ...
        else
        {
          ...
          this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.2(this, j, paramFromServiceMsg, paramObject, localojt));
          return;
          label954:
          bool = false;
          continue;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      if (localRspBody.next.has())
      {
        ...
        bool = true;
        localojs.jdField_a_of_type_Boolean = bool;
      ...
      if (localRspBody.page_cookie.has()) {
        localojs.jdField_a_of_type_JavaLangString = localRspBody.page_cookie.get().toStringUtf8();
      }
      if (localRspBody.comment_list.has()) {
        localojs.jdField_a_of_type_JavaUtilList = a(localRspBody.comment_list.get());
      }
      if (localRspBody.article_info.has())
      {
        ...
        if (paramFromServiceMsg.comment_count.has()) {
          localojt.jdField_a_of_type_Long = paramFromServiceMsg.comment_count.get();
        }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.4(this, i, localojs, localojt, paramFromServiceMsg));
      return;
      label473:
      bool = false;
      break;
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.6(this, i, localojs, localojt, paramFromServiceMsg));
      return;
      label473:
      bool = false;
      break;
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (localRspBody.hot_comment_list.has()) {
        localojs.jdField_a_of_type_JavaUtilList = a(localRspBody.hot_comment_list.get());
      }
      if (localRspBody.article_info.has())
      {
        paramFromServiceMsg = (oidb_cmd0xc46.ArticleInfo)localRspBody.article_info.get();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.8(this, i, localojs, localojt, paramFromServiceMsg));
      return;
      label473:
      bool = false;
      break;
  ...
  {
    int i = pot.a(paramFromServiceMsg, paramObject, new oidb_cmd0xc46.RspBody());
    ...
    paramObject = axrn.a(onh.a().getApplication());
    if (i == 0) {}
  ...
  public void a()
  {
    this.jdField_a_of_type_Ohb = null;
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = pot.a("OidbSvc.0xc46", 3142, 6, localReqBody.toByteArray());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = pot.a("OidbSvc.0xc46", 3142, 5, localReqBody.toByteArray());
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      paramString1 = pot.a("OidbSvc.0xdc8", 3528, 1, localReqBody.toByteArray());
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = pot.a("OidbSvc.0xc46", 3142, 4, localReqBody.toByteArray());
  ...
  public void b(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = pot.a("OidbSvc.0xc46", 3142, 2, localReqBody.toByteArray());
  ...
  public void c(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = pot.a("OidbSvc.0xc46", 3142, 3, localReqBody.toByteArray());
