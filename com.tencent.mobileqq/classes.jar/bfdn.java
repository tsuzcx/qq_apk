  ...
  extends bfdf
{
  ...
  static
  {
    Logger.init(new bfer());
  }
  
  public bfdn(behq parambehq)
  {
    super(parambehq);
    this.jdField_a_of_type_ComTencentTissueV8rtEngineEngine.setLibLoader(new bfdv());
    this.jdField_a_of_type_ComTencentTissueV8rtEngineEngine.initEngine(parambehq.a());
    this.jdField_a_of_type_AndroidContentContext = parambehq.a();
  ...
  {
    ServiceEventHandlerProvider.getInstance().setServiceEventHandler(this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime, new bfdr(this, parambfdu));
  }
    ...
    for (Object localObject = ((File)localObject).getAbsolutePath() + ".cc";; localObject = null)
    {
      ...
      for (int i = 1;; i = 0)
      {
        if (this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime != null)
        {
          ...
          this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime.getDefaultContext().evaluateJsAsyncWithCodeCache(paramString1, new bfdo(this), paramString2, (String)localObject);
        }
        return;
      ...
      if (i != 0)
      {
        this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime.getDefaultContext().evaluateJsAsyncWithCodeCache(paramString1, new bfdp(this, paramValueCallback), paramString2, (String)localObject);
        return;
      }
      this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime.getDefaultContext().evaluateJsAsyncWithReturn(paramString1, new bfdq(this, paramValueCallback));
      return;
      label324:
      paramString2 = null;
    }
  ...
  {
    a(a(true));
    MiniAppEnv.g().getBaselibLoader().loadBaselib(MiniAppEnv.g().getContext(), new bfds(this));
  }
}
