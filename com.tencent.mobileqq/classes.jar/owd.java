  ...
  implements owa
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localosn.a(str1).c(paramBaseArticleInfo, str2).i(paramBaseArticleInfo).q(paramBaseArticleInfo);
        return localosn.a();
      }
      ...
      try
      {
        localosn.a("ReadInjoy_QA_NoImage_cell");
      }
      catch (JSONException paramBaseArticleInfo)
      {
        paramBaseArticleInfo.printStackTrace();
  ...
  public void a(int paramInt1, Container paramContainer, opw paramopw, int paramInt2)
  {
    ...
    if ((localObject == null) || (paramopw == null) || (paramopw.a() == null)) {}
    ...
    boolean bool = ogy.a().a(paramopw.a().mArticleID);
