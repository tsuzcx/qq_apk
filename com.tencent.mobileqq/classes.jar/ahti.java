...
{
  ahti(Context paramContext, int paramInt, URLDrawable paramURLDrawable, QQAppInterface paramQQAppInterface, StructMsgForImageShare paramStructMsgForImageShare, PicMessageExtraData paramPicMessageExtraData) {}
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    paramVarArgs = ahth.a(this.jdField_a_of_type_AndroidContentContext, paramVarArgs);
    if (paramVarArgs != null)
    {
      ahth.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, paramVarArgs);
    ...
    File localFile = bdsh.a(paramVarArgs);
    if (localFile != null) {}
    for (paramVarArgs = SecUtil.getFileMd5(localFile.getAbsolutePath());; paramVarArgs = null)
    {
      ...
      for (String str1 = str1;; str1 = "")
      {
        ...
        try
        {
          bgmg.a(localFile, new File(paramVarArgs));
          return Integer.valueOf(ahth.a(this.jdField_a_of_type_AndroidContentContext, paramVarArgs, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, this.jdField_a_of_type_ComTencentMobileqqDataPicMessageExtraData));
        }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131694322, 0).b(this.jdField_a_of_type_Int);
      awmr.c("2004", 1);
    }
    while (paramInteger.intValue() != 2) {
      return;
    }
    QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, 2131689606, 0).b(this.jdField_a_of_type_Int);
    awmr.c("2003", 1);
  }
}
