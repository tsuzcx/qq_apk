...
public class azxx
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(azya.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(azxy.class)) {
        paramClass = ((azxy)localField.getAnnotation(azxy.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(azxz.class)) {
        return null;
      }
      localClass1 = ((azxz)localField.getAnnotation(azxz.class)).a();
