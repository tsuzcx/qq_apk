...
public class aqos
{
  private static aqos jdField_a_of_type_Aqos;
  private static final byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private static final byte[] jdField_b_of_type_ArrayOfByte = new byte[0];
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aqot(this);
  private Point jdField_a_of_type_AndroidGraphicsPoint = new Point();
  private Set<String> jdField_a_of_type_JavaUtilSet = new HashSet();
  private WeakReference<aqnu> jdField_a_of_type_MqqUtilWeakReference;
  private boolean jdField_a_of_type_Boolean = true;
  private WeakReference<aqrn> jdField_b_of_type_MqqUtilWeakReference;
  private boolean jdField_b_of_type_Boolean = true;
  
  public static aqos a()
  {
    if (jdField_a_of_type_Aqos == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aqos == null)
      {
        jdField_a_of_type_Aqos = new aqos();
        if (QLog.isColorLevel()) {
          QLog.d("ColorNoteQIPCModule", 2, "create ColorNoteQIPCModule");
        }
      }
      return jdField_a_of_type_Aqos;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[updateColorNoteSet] " + aqoq.a());
    }
    if (paramInt2 == 2) {
      return;
    }
  ...
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaqnu);
  }
  
  public void a(aqrn paramaqrn)
  {
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(paramaqrn);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[setSyncState] " + aqoq.a());
    }
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[setCanAddColorNote] " + aqoq.a());
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[getCanAddColorNote] " + aqoq.a());
    }
