  ...
  implements Manager
{
  ...
  public asik(QQAppInterface paramQQAppInterface)
  {
  ...
  public static asik a(QQAppInterface paramQQAppInterface)
  {
    return (asik)paramQQAppInterface.getManager(349);
  }
  ...
  {
    return ajsf.M.equals(paramString);
  }
  ...
  private Bitmap b(String paramString)
  {
    ...
    String str = ayog.d(paramString);
    Object localObject = new File(str);
    long l1 = SystemClock.uptimeMillis();
    localObject = new bbwg(paramString, (File)localObject);
    ((bbwg)localObject).n = true;
    ((bbwg)localObject).b = 2;
    ((bbwg)localObject).a = str;
    ((bbwg)localObject).b(512);
    int i = bbwi.a((bbwg)localObject, null, null);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.i("NewMsgNotificationManager", 2, "download cost " + (l2 - l1) + " result " + i + " key " + ((bbwg)localObject).a + " iconUrl: " + paramString);
    }
  ...
  {
    Intent localIntent = bbem.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new asil(this, paramNotifyPushSettingActivity, paramFormSwitchItem);
  ...
  {
    asin localasin = new asin(this);
    asio localasio = new asio(this, paramBaseActivity);
    bbcv.a(paramBaseActivity, 230, null, paramBaseActivity.getString(2131693698), paramBaseActivity.getString(2131690596), paramBaseActivity.getString(2131693697), localasio, localasin).show();
  }
  ...
  public void a(BaseActivity paramBaseActivity, TextView paramTextView)
  {
    ...
    String str = ((Resources)localObject).getString(2131695291);
    localObject = new SpannableString(str + "允许QQ通知" + ((Resources)localObject).getString(2131695292));
    ((SpannableString)localObject).setSpan(new asim(this, paramBaseActivity), str.length(), (str + "允许QQ通知").length(), 17);
