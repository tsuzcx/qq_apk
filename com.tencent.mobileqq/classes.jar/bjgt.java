...
public class bjgt
  implements bedj, beds
{
  private static bjgt jdField_a_of_type_Bjgt;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  public bedk a;
  private bjwz jdField_a_of_type_Bjwz;
  ...
  public void a(int paramInt)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        QQToast.a(BaseApplicationImpl.getContext(), alud.a(2131713672), 1);
      }
    }
    while (this.jdField_a_of_type_Bedk == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Bedk.f = paramInt;
    bedn.b(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Bedk, this.jdField_a_of_type_JavaLangString, this);
  }
  ...
  public void a(Intent paramIntent, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Bedk = new bedk(this.jdField_b_of_type_JavaLangString, i, j, k, 0);
      switch (paramInt)
      {
      default: 
        return;
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bjwz.a(this.c, localStringBuilder.toString());
      return;
    }
  ...
  public void a(String paramString, int paramInt, bjwz parambjwz)
  {
  ...
  public void a(String paramString, bjwz parambjwz)
  {
    QZLog.d("RecordAndChangeVoiceService", 2, "getMoodVoiceRecordTime");
    if (this.jdField_a_of_type_Bedk == null) {
      return;
    }
  ...
  public void b(String paramString, int paramInt, bjwz parambjwz)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = mwk.a(BaseApplicationImpl.getContext());
      ...
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        QQToast.a(BaseApplicationImpl.getContext(), alud.a(2131713673), 1);
      }
      return;
    }
    ...
    bedn.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Bedk, this.jdField_a_of_type_JavaLangString, this);
    bedn.a(this.jdField_b_of_type_JavaLangString, this);
  }
  ...
  public void e()
  {
    ...
    this.c = null;
    this.jdField_a_of_type_Bedk = null;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Long = -1L;
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Bjwz = null;
  }
}
