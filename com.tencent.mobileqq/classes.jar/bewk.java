class bewk
{
  private static bewk jdField_a_of_type_Bewk;
  private static bewk jdField_b_of_type_Bewk;
  ...
  public static bewk a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Bewk == null) {
        jdField_a_of_type_Bewk = new bewk(0);
      }
      return jdField_a_of_type_Bewk;
    }
    if (jdField_b_of_type_Bewk == null) {
      jdField_b_of_type_Bewk = new bewk(1);
    }
    return jdField_b_of_type_Bewk;
  }
