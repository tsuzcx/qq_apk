...
public class aron
  implements awwb
{
  public aron(UiApiPlugin paramUiApiPlugin, String paramString) {}
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        byte[] arrayOfByte = bbdx.a(paramString);
        if (arrayOfByte == null) {
          break;
        }
        ...
        if (aupa.a(paramString))
        {
          ...
          localStringBuilder.append(bbco.encodeToString(arrayOfByte, 0));
