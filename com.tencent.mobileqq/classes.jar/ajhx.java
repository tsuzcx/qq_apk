...
public class ajhx
  extends ajgl<CustomEmotionData>
{
  public ajhx(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new anco((String)localObject1);
          if ((!((anco)localObject2).a()) || (TextUtils.isEmpty(((anco)localObject2).c)) || (TextUtils.isEmpty(((anco)localObject2).d)))
          {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localanco1 = new anco((String)localObject2);
          if ((!localanco1.a()) || (TextUtils.isEmpty(localanco1.c)) || (TextUtils.isEmpty(localanco1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localanco1);
          }
        }
      }
      ...
      {
        localanco1 = (anco)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          anco localanco2 = (anco)((List)localObject1).get(j);
          if ((localanco1.c.equals(localanco2.c)) && (localanco2.c.equals("0")) && (localanco2.d.equals(localanco1.d)))
          {
            paramList1.remove(localanco2.a);
            ((StringBuilder)localObject2).append(localanco2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.2.6");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131626473));
      return;
    }
    if (!badq.a())
    {
      notifyUI(3, false, this.app.getApp().getString(2131628303));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.2.6");
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        awrn.a(BaseApplication.getContext()).a(null, "favEmoModifyOcrsSuc", false, 0L, 0L, (HashMap)localObject, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((ancg)this.app.getManager(149)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131626479));
              if (QLog.isColorLevel()) {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        awrn.a(BaseApplication.getContext()).a(null, "favEmoGetOcrSuc", false, 0L, 0L, (HashMap)localObject1, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          paramFromServiceMsg = new FavEmotionOcr.RspBody();
          paramFromServiceMsg.mergeFrom(paramObject.bytes_bodybuffer.get().toByteArray());
          ...
          paramObject = (ancg)this.app.getManager(149);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((ancg)this.app.getManager(149)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.2.6");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        anco localanco = new anco((String)paramList.next());
        if (!TextUtils.isEmpty(localanco.d)) {
          localArrayList.add(localanco.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((andn)this.app.getManager(141)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (anch)this.mApp.getManager(72);
