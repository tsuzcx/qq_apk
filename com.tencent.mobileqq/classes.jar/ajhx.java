...
public class ajhx
  extends amoe
{
  public ajhx(PublicView paramPublicView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      ((View)localObject1).setId(2131374207);
      paramView = new ajhz();
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject2 = (ajhz)paramView.getTag();
    ...
    for (;;)
    {
      ...
      {
        localObject2 = this.a.getResources().getDrawable(2130841751);
        int i = (int)bhmg.a(this.a.a, 15.0F);
