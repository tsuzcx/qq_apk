...
public class bhdf
  implements bhdn
{
  public bhdf(QZoneMsgFragment paramQZoneMsgFragment) {}
    ...
    case 5: 
      ...
      do
      {
        ...
        if ((paramMQMsg != null) && (paramMQMsg.msgInteractData != null)) {
          ((bhdh)this.a.a.getManager(293)).a(paramMQMsg.msgInteractData.likeCell, paramMQMsg.pushTime);
        }
        ...
        if ((paramMQMsg != null) && (paramMQMsg.msgInteractData != null))
        {
          ...
          bgyp.b(this.a.getActivity(), bgyw.a(), paramView);
        }
        for (;;)
        {
        ...
        for (;;)
        {
          ...
          if (paramMQMsg.msgInteractData.shareToQzone != null)
          {
            ...
            bgzl.a(this.a.getActivity(), BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramView, null, 0);
          }
        }
        paramMQMsg = bbex.a(this.a.a, this.a.getActivity(), "mqqzone://arouse/activefeed");
