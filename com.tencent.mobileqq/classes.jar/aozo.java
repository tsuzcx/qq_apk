  ...
  implements biel
{
  ...
  {
    if (this.a.jdField_a_of_type_Apec == null) {}
    do
    {
      do
      {
        ...
        {
          if (parambidw.jdField_b_of_type_Int == 1810002)
          {
            if (QLog.isColorLevel()) {
          ...
          for (;;)
          {
            ...
            this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.a.jdField_b_of_type_Long, this.a.c, this.a.e, this.a.jdField_a_of_type_Int, 36, null, parambidw.jdField_b_of_type_Int, parambidw.jdField_a_of_type_JavaLangString);
            return;
            paramString = new String[3];
            paramString[0] = "param_XGFileFlow";
            paramString[1] = "param_XGFlow";
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.setFilePath(parambidw.jdField_b_of_type_JavaLangString);
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName = apue.a(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath());
      ...
      for (;;)
      {
        ...
        apuc.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString);
        return;
        paramString = new String[3];
        paramString[0] = "param_XGFileFlow";
        paramString[1] = "param_XGFlow";
      ...
      this.a.jdField_a_of_type_Long = parambidw.jdField_b_of_type_Long;
