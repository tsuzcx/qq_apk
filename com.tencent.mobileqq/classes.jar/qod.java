...
public class qod
{
  ...
  public static String a(ArticleInfo paramArticleInfo, HashMap<String, String> paramHashMap)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 16	pay:d	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Ljava/lang/String;
    //   10: astore_2
    //   11: aload_0
    //   12: getfield 22	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mAlgorithmID	J
    //   15: aload_0
    //   16: invokestatic 25	pay:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)I
    //   19: aload_0
    ...
    //   33: aload_0
    //   34: invokestatic 41	pay:f	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Ljava/lang/String;
    //   37: iconst_0
    //   38: invokestatic 44	pay:d	()I
    //   41: aload_0
    //   42: invokestatic 47	pay:a	(JIIZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;IILcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;)Lorg/json/JSONObject;
    //   45: astore_3
    //   46: aload_3
    //   47: invokevirtual 53	org/json/JSONObject:toString	()Ljava/lang/String;
    //   50: astore_2
    //   51: new 49	org/json/JSONObject
    //   54: dup
    //   55: aload_0
    //   56: getfield 56	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:proteusItemsData	Ljava/lang/String;
    //   59: invokespecial 60	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   62: astore_0
    //   63: aload_0
    //   64: ldc 62
    //   66: invokevirtual 66	org/json/JSONObject:optJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   69: ifnull +145 -> 214
    //   72: aload_0
    //   73: ldc 62
    //   75: invokevirtual 69	org/json/JSONObject:getJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   78: astore_0
    //   79: aload_0
    //   80: invokevirtual 73	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   83: astore 4
    //   85: aload 4
    ...
    //   102: checkcast 85	java/lang/String
    //   105: astore 5
    //   107: aload_0
    //   108: aload 5
    //   110: invokevirtual 89	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   113: astore 6
    //   115: aload 5
    //   117: invokestatic 95	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   120: ifne -35 -> 85
    //   123: aload 6
    //   125: invokestatic 95	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   128: ifne -43 -> 85
    //   131: aload_3
    //   132: aload 5
    //   134: aload 6
    //   136: invokevirtual 99	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   139: pop
    //   140: goto -55 -> 85
    //   143: astore_0
    //   144: ldc 101
    ...
    //   159: aload_0
    //   160: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   163: invokevirtual 116	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   166: invokestatic 122	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   169: aload_2
    //   170: aload_1
    //   171: invokestatic 125	qod:a	(Ljava/lang/String;Ljava/util/HashMap;)Ljava/lang/String;
    //   174: areturn
    //   175: aload_3
    //   176: invokevirtual 53	org/json/JSONObject:toString	()Ljava/lang/String;
    //   179: astore_0
    //   180: aload_0
    //   181: astore_2
    //   182: goto -13 -> 169
    ...
    //   186: ldc 101
    //   188: iconst_1
    //   189: new 103	java/lang/StringBuilder
    //   192: dup
    //   193: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   196: ldc 108
    //   198: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   201: aload_0
    //   202: invokevirtual 115	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   205: invokevirtual 116	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   208: invokestatic 122	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   211: goto -42 -> 169
    //   214: aload_2
    //   215: astore_0
    //   216: goto -36 -> 180
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if (!qnp.a.a().contains(localObject3))
          {
            try
            {
  ...
  public static void a(sie paramsie, BaseArticleInfo paramBaseArticleInfo)
  {
    if ((!(paramBaseArticleInfo instanceof ArticleInfo)) || (paramsie == null)) {}
    for (;;)
    {
      return;
      if ((paramBaseArticleInfo.proteusItemsData == null) || (!qmh.a(paramBaseArticleInfo))) {
        continue;
      }
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2))) {
            paramsie.a(str1, str2);
          }
        }
        return;
      }
      catch (JSONException paramsie)
      {
        QLog.e("PTSRijReport", 1, "[addPtsCardReportToR5], e = " + paramsie);
      }
    }
  }
}
