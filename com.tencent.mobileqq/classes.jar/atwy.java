...
public class atwy
{
  ...
  private Map<Integer, atwz> e = new ConcurrentHashMap();
  ...
  public atwy(AppInterface paramAppInterface)
  {
  ...
  {
    return ajed.cl + "defaultCard" + File.separator + paramString + ".json";
  }
  ...
  {
    return azyk.c(paramContext) + paramLong + ".zip";
  }
  ...
  public atwz a(int paramInt, boolean paramBoolean)
  {
    try
    {
      atwz localatwz = (atwz)this.e.get(Integer.valueOf(paramInt));
      if (localatwz == null)
      {
        localatwz = new atwz(this, paramInt);
        this.e.put(Integer.valueOf(paramInt), localatwz);
      }
      for (;;)
      {
        Object localObject2;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        try
        {
          bace.a(paramQQAppInterface.getAbsolutePath(), paramString1, false);
          ...
          if (paramString2.exists())
          {
            ...
            bace.a(paramString2.getAbsolutePath(), str, false);
