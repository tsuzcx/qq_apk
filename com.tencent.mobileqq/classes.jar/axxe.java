...
public class axxe
{
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, axxq paramaxxq)
  {
    ...
    if (!TextUtils.isEmpty(paramString5))
    {
      ...
      if (a.getStatus() == 1)
      {
        ykq.c("ShortVideoShareUtil", "URLDrawable's status is SUCCESSED.");
        b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, a(a), paramaxxq);
        return;
      }
      if (a.getStatus() == 2)
      {
        b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, null, paramaxxq);
        a.downloadImediatly();
        return;
      }
      ykq.c("ShortVideoShareUtil", "start load URLDrawable.");
      a.setURLDrawableListener(new axxj(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, paramaxxq));
      a.downloadImediatly();
      return;
    }
    b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, null, paramaxxq);
  ...
  {
    paramString1 = new bdnr(StructMsgForGeneralShare.class).c(131).a(paramString2).a("web", paramString4, null, null, null).a();
    paramString4 = bdoe.a(2);
    ...
    aupt.a(paramBaseActivity, paramString2, 123);
  }
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, int paramInt, String paramString6)
  {
    ...
    paramString4 = new bdnr(StructMsgForGeneralShare.class).c(131).a(paramString2).a("web", paramString4, null, null, null).a();
    bdnv localbdnv = bdoe.a(2);
    localbdnv.a(paramString5, paramString2, paramString3, 0);
    paramString4.addItem(localbdnv);
    ...
    aupt.a(paramBaseActivity, paramString1, ForwardRecentTranslucentActivity.class, 123, 100500, "biz_src_hdsp_nearby");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, URLDrawable paramURLDrawable, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    ((ShareActionSheet)localObject).setItemClickListenerV2(new axxf(paramBaseActivity, paramString2, paramString4, paramString5, paramString3, paramString6, paramString7, paramQQAppInterface));
    ((ShareActionSheet)localObject).setCancelListener(new axxi(paramOnDismissListener));
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    new axxu().h("video").i("playpage_fw_suc").a().a(paramString1);
  }
  
  static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, axxq paramaxxq)
  {
    ...
    if (!TextUtils.isEmpty(paramString5))
    {
      ...
      if (a.getStatus() == 1)
      {
        ...
        if (paramString1 == null) {
          paramBaseActivity = bgyo.b(BaseApplicationImpl.getApplication().getResources(), 2130845279);
        }
        WXShareHelper.a().a(new axxl(str, paramaxxq));
        WXShareHelper.a().a(str, paramString2, paramBaseActivity, paramString3, paramString4);
        new axxu().h("video").i("playpage_fw_suc").a().a(paramString5);
      }
    }
    else
    {
    ...
    if (a.getStatus() == 2)
    {
      ...
      WXShareHelper.a().a(new axxm(str, paramaxxq));
      WXShareHelper.a().a(str, paramString2, paramBaseActivity, paramString3, paramString4);
      a.downloadImediatly();
      new axxu().h("video").i("playpage_fw_suc").a().a(paramString5);
      return;
    ...
    ykq.c("ShortVideoShareUtil", "start load URLDrawable.");
    a.setURLDrawableListener(new axxn(str, paramaxxq, paramString2, paramString3, paramString4, paramString5));
    a.startDownload();
  }
  
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap, axxq paramaxxq)
  {
    String str = String.valueOf(System.currentTimeMillis());
    if (paramBitmap == null) {}
    for (paramString1 = bgyo.b(BaseApplicationImpl.getApplication().getResources(), 2130845279);; paramString1 = paramBitmap)
    {
      WXShareHelper.a().a(new axxk(str, paramaxxq));
      WXShareHelper.a().b(str, paramString2, paramString1, paramString3, paramString4);
      new axxu().h("video").i("playpage_fw_suc").a().a(paramQQAppInterface);
      return;
    }
  }
}
