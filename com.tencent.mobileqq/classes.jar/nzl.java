  ...
  implements qte
{
  ...
  private HashMap<String, qjf> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private qtd jdField_a_of_type_Qtd;
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.e)
        {
          ...
          if (paramInt1 == nmf.jdField_a_of_type_Int)
          {
            if (paramInt2 != 0) {
  ...
  {
    nmf.a(new nyg().a(this.jdField_a_of_type_AndroidAppActivity).a(paramInt1).b(nmf.al).e(a(paramInt1, paramInt2, paramInt3, paramBoolean)).a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
  }
    ...
    if (!TextUtils.isEmpty(str1.trim()))
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.l))
      {
        ...
        if (str1.contains(str2))
        {
          ...
          localSpannableStringBuilder.setSpan(new AbsoluteSizeSpan(actn.a(13.0F, this.jdField_a_of_type_AndroidAppActivity.getResources())), i, j, 33);
          localSpannableStringBuilder.setSpan(new nzm(actn.a(4.0F, this.jdField_a_of_type_AndroidAppActivity.getResources())), j, j + 1, 33);
        }
      }
      ...
      for (;;)
      {
        localSpannableStringBuilder.setSpan(new AbsoluteSizeSpan(actn.a(f1, this.jdField_a_of_type_AndroidAppActivity.getResources())), i, j, 33);
  ...
  private void h()
  {
    if (bbfd.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Qjf.jdField_d_of_type_JavaLangString))
    {
      this.jdField_a_of_type_Qms.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_a_of_type_Qms.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718492));
    }
    while (this.jdField_a_of_type_Qjf.jdField_a_of_type_Int != 5) {
      return;
    }
    this.jdField_a_of_type_Qms.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    this.jdField_a_of_type_Qms.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718485));
  }
  
  private void i()
  {
    b(nmf.jdField_b_of_type_Int, -1);
  }
  ...
  private void k()
  {
    ...
    {
      sht.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, null, 3, true);
      this.d = true;
    }
    do
    {
    ...
    } while (sht.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.g, this.jdField_a_of_type_AndroidAppActivity));
    ...
    for (;;)
    {
      oal.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.jdField_f_of_type_JavaLangString, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.h, "");
      this.d = false;
      return;
  ...
  {
    if (this.e) {}
    for (ReadInjoyHeaderAdDownloadView localReadInjoyHeaderAdDownloadView = this.jdField_a_of_type_Qms.b;; localReadInjoyHeaderAdDownloadView = this.jdField_a_of_type_Qms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView)
    {
      localReadInjoyHeaderAdDownloadView.a(this.jdField_a_of_type_Qjf.jdField_b_of_type_Int);
      return;
    }
  }
  ...
  {
    a(this.jdField_a_of_type_Qms, paramInt1, paramInt2);
  }
  ...
  public void a(VideoInfo paramVideoInfo, qms paramqms)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.jdField_c_of_type_Int == 0) {
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdProductType == 12)
      {
        ...
        localqjf2 = (qjf)this.jdField_a_of_type_JavaUtilHashMap.get(str);
        localqjf1 = localqjf2;
        if (localqjf2 == null)
        {
          localqjf1 = qjf.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
          this.jdField_a_of_type_JavaUtilHashMap.put(str, localqjf1);
        }
        if (localqjf1 != null)
        {
          this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.n = localqjf1.jdField_d_of_type_JavaLangString;
          if ((nlw.a(BaseApplicationImpl.getApplication(), localqjf1)) || (bbfd.a(BaseApplicationImpl.getContext(), localqjf1.jdField_d_of_type_JavaLangString))) {
            localqjf1.jdField_a_of_type_Int = 5;
          }
          ...
          h();
          paramqms.b.a(a(localqjf1.jdField_a_of_type_Int), localqjf1.jdField_b_of_type_Int);
        }
      }
    }
    label237:
    while (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.jdField_e_of_type_Int != 1) {
      for (;;)
      {
        paramqms.t.setTag(2131379208, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo);
        ...
        return;
        paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.a(a(localqjf1.jdField_a_of_type_Int), localqjf1.jdField_b_of_type_Int);
      }
    }
    String str = paramVideoInfo.jdField_a_of_type_JavaLangString;
    qjf localqjf2 = (qjf)this.jdField_a_of_type_JavaUtilHashMap.get(str);
    qjf localqjf1 = localqjf2;
    if (localqjf2 == null)
    {
      localqjf1 = qjf.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo);
      this.jdField_a_of_type_JavaUtilHashMap.put(str, localqjf1);
    }
    if ((nlw.a(BaseApplicationImpl.getApplication(), localqjf1)) || (bbfd.a(BaseApplicationImpl.getContext(), localqjf1.jdField_d_of_type_JavaLangString))) {
      localqjf1.jdField_a_of_type_Int = 5;
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, VideoFeedsRecyclerView paramVideoFeedsRecyclerView)
  {
    ...
    this.jdField_a_of_type_Nmm = new nmm(paramActivity, true, paramVideoFeedsRecyclerView);
  ...
  public void a(qms paramqms)
  {
    ...
    if (!this.e)
    {
      localLayoutParams1 = (LinearLayout.LayoutParams)paramqms.w.getLayoutParams();
      if (TextUtils.isEmpty(paramqms.Q.getText().toString().trim()))
      {
        paramqms.Q.setVisibility(8);
        localLayoutParams1.gravity = 16;
        paramqms.w.setLayoutParams(localLayoutParams1);
        if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdProductType == 12) || (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.jdField_e_of_type_Int == 1)) {
          break label209;
        }
        paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.setVisibility(8);
    ...
    {
      return;
      LinearLayout.LayoutParams localLayoutParams2 = (LinearLayout.LayoutParams)paramqms.Q.getLayoutParams();
      localLayoutParams2.topMargin = actn.a(1.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      paramqms.Q.setLayoutParams(localLayoutParams2);
      paramqms.Q.setVisibility(0);
      localLayoutParams1.gravity = 16;
      break;
      label209:
      paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.setVisibility(0);
      paramqms.w.setVisibility(8);
      break label111;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdProductType != 12) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementSoftInfo.jdField_e_of_type_Int != 1))
      {
        paramqms.b.setVisibility(8);
        paramqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      }
      ...
      {
        paramqms.S.setText(e());
        return;
        paramqms.b.setVisibility(0);
        paramqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      }
    }
  }
  
  public void a(qms paramqms, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Qjf == null) {
      return;
    }
    this.jdField_a_of_type_Qjf.jdField_b_of_type_Int = paramInt2;
    if (paramInt1 != 8) {
      this.jdField_a_of_type_Qjf.jdField_a_of_type_Int = paramInt1;
    }
    this.jdField_c_of_type_Boolean = false;
    switch (paramInt1)
    {
    ...
    case 1: 
      ...
      {
        paramqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        paramqms.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718492));
        paramqms.b.a(2, 100);
      }
    case 3: 
    case 5: 
      for (;;)
      {
        ...
        paramqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        return;
        if (this.e)
        {
          paramqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
          paramqms.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718485));
          paramqms.b.a(2, 100);
          this.jdField_c_of_type_Boolean = true;
          if (this.jdField_b_of_type_Boolean)
          {
        ...
        for (;;)
        {
          a(paramInt1);
          return;
          paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.a(2, 100);
          break;
          paramqms.x.setVisibility(0);
        }
        paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.a(2, 100);
      }
      paramqms.x.setVisibility(0);
    ...
    case 4: 
      ...
      {
        paramqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramqms.b.a(4, paramInt2);
        return;
      }
      paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.a(4, paramInt2);
      return;
    case 6: 
      label270:
      label294:
      ...
      for (;;)
      {
        bcpw.a(this.jdField_a_of_type_AndroidAppActivity, ajyc.a(2131716238), 0).a();
        return;
        paramqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.a(0, 0);
      }
    }
    c();
  }
  ...
  {
    this.jdField_a_of_type_Qtd = paramqtd;
  }
  ...
  {
    if ((paramqms.t != null) && (paramqms.t.getVisibility() == 0))
    {
  ...
  protected int b()
  {
    ...
    return this.jdField_a_of_type_Qjf.jdField_b_of_type_Int;
  }
  ...
  protected void b()
  {
    if ((d()) && (this.jdField_a_of_type_Qjf != null))
    {
      if ((this.jdField_a_of_type_Qjf.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_Qjf.jdField_d_of_type_JavaLangString))) {
        oau.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Qjf.jdField_d_of_type_JavaLangString);
      }
    }
    else {
      return;
  ...
  protected int c()
  {
    ...
    return this.jdField_a_of_type_Qjf.jdField_a_of_type_Int;
  }
  ...
  public void c()
  {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Qjf.jdField_a_of_type_Int == 4)
        {
          a(this.jdField_a_of_type_Qms, 4, b());
          return;
        }
        if (this.jdField_a_of_type_Qjf.jdField_a_of_type_Int == 5)
        {
          String str = this.jdField_a_of_type_Qjf.jdField_d_of_type_JavaLangString;
          if (bbfd.a(BaseApplicationImpl.getContext(), str))
          {
            this.jdField_a_of_type_Qjf.jdField_a_of_type_Int = 1;
            a(this.jdField_a_of_type_Qms, 1, b());
            return;
          }
          a(this.jdField_a_of_type_Qms, 5, b());
          return;
        }
      } while (this.jdField_a_of_type_Qjf.jdField_a_of_type_Int != 3);
      a(this.jdField_a_of_type_Qms, 3, b());
    } while ((this.jdField_a_of_type_Qjf == null) || (this.jdField_a_of_type_Nmm == null));
    this.jdField_a_of_type_Nmm.a(this.jdField_a_of_type_Qjf);
    return;
  ...
  protected void d()
  {
    if ((this.jdField_a_of_type_Nmm != null) && (this.jdField_a_of_type_Qjf != null)) {
      this.jdField_a_of_type_Nmm.b(this.jdField_a_of_type_Qjf);
    }
  }
  ...
  protected void e()
  {
    ...
    if ((this.jdField_a_of_type_Qms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView != null) || ((this.jdField_a_of_type_Qms.b != null) && (this.jdField_a_of_type_Qjf != null))) {
      l();
    }
  }
  ...
  protected void f()
  {
    if ((this.jdField_a_of_type_Qjf != null) && (this.jdField_a_of_type_Nmm != null)) {
      this.jdField_a_of_type_Nmm.e(this.jdField_a_of_type_Qjf);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Qjf != null) && (this.jdField_a_of_type_Nmm != null)) {
      this.jdField_a_of_type_Nmm.a(this.jdField_a_of_type_Qjf, true);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    int m = nmf.jdField_a_of_type_Int;
    ...
    case 2131378967: 
      ...
      {
        return;
        if (this.jdField_a_of_type_Qtd != null) {
          this.jdField_a_of_type_Qtd.a();
        }
        this.f = true;
        b(paramView.getId());
        a(m, 3, -1, false);
        ...
        if ((a() != 1) || (paramView.getId() != 2131361958) || (localqms == null)) {
          break;
        }
        localqms.b.callOnClick();
      } while (localqms.b.a() == 2);
      localqms.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      return;
      if (paramView.getId() == 2131361958) {}
      for (i = 1;; i = 0)
      {
        a(m, i, -1, e());
        k();
    ...
    for (;;)
    {
      a(m, 1, i, this.d);
      return;
      j = localqms.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyHeaderAdDownloadView.a();
      break;
      label356:
      if (nlx.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Qjf))
      {
        paramView = bdgv.a().c(this.jdField_a_of_type_Qjf.jdField_d_of_type_JavaLangString);
        bdgv.a().a(paramView);
        this.jdField_a_of_type_Qjf.jdField_a_of_type_Int = 5;
        i = 3;
      }
      else if (nlw.a(this.jdField_a_of_type_Qjf, this.jdField_a_of_type_Qjf.jdField_a_of_type_Int))
      {
        f();
        this.jdField_a_of_type_Qjf.jdField_a_of_type_Int = 5;
        i = 3;
      }
      else if (bbev.h(BaseApplicationImpl.getContext()))
      {
        e();
      }
      else
