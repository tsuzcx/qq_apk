...
{
  private static final String jdField_a_of_type_JavaLangString = bqtb.class.getSimpleName();
  ...
  private bqtd jdField_a_of_type_Bqtd;
  ...
  public bqtb(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bqtd = new bqtd();
    this.jdField_a_of_type_Bqtd.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bqtd.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bqtd.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bqtd = null;
  ...
  {
    this.jdField_a_of_type_Bqtd.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bqtd.a("before updateTexImage");
