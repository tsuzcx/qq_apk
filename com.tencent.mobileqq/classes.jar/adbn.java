  ...
  implements biih
{
  ...
  public adbn(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = adbm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new biib(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bihy)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (biig)((biib)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((biig)localObject1).a(this);
          ((biig)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
