  ...
  implements awxj
{
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Awxx.jdField_a_of_type_ArrayOfJavaLangString == null)
    {
      this.jdField_a_of_type_Boolean = true;
      return this.jdField_a_of_type_Awxx.jdField_a_of_type_JavaLangString;
    }
    int i = this.jdField_a_of_type_Int + 1;
    if (i >= this.jdField_a_of_type_Awxx.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      awxx localawxx = this.jdField_a_of_type_Awxx;
      localawxx.jdField_a_of_type_Int -= 1;
      if (this.jdField_a_of_type_Awxx.jdField_a_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Boolean = true;
        return this.jdField_a_of_type_Awxx.jdField_a_of_type_JavaLangString;
      }
      ...
      return this.jdField_a_of_type_Awxx.jdField_a_of_type_ArrayOfJavaLangString[(i + 1)];
    }
    return this.jdField_a_of_type_Awxx.jdField_a_of_type_ArrayOfJavaLangString[i];
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Awxx == null) {
  ...
  public void a(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Awxx.jdField_a_of_type_Awxk != null) {
      this.jdField_a_of_type_Awxx.jdField_a_of_type_Awxk.a((Bitmap)paramMessage.obj);
    }
    this.jdField_a_of_type_Int += 1;
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 5, null, true);
  }
  
  public void a(awxx paramawxx)
  {
    this.jdField_a_of_type_Awxx = paramawxx;
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Awxx != null) {
      this.jdField_a_of_type_Awxx.jdField_a_of_type_JavaLangString = paramString;
    }
  }
