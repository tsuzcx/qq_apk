  ...
  implements afex, afht
{
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new aqur(this));
  private boolean jdField_a_of_type_Boolean;
  
  public aquq(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public static boolean a()
  {
    ...
    return (localamcz != null) && (localamcz.f());
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new aqus(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)paramView.findViewById(2131303423));
