  ...
  extends DynamicDrawableSpan
{
  ...
  private bafh(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint)
  {
    super(0);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = a(String.format("%s%s", new Object[] { "@", new ayju(paramString2, 32).a() }));
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(paramPaint);
  }
  
  private bafh(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint, String paramString3)
  {
    this(paramContext, paramString1, paramString2, paramInt, paramPaint);
    this.d = a(String.format("%s%s", new Object[] { "@", new ayju(paramString3, 32).a() }));
  }
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, EditText paramEditText)
  {
    ...
    try
    {
      paramQQAppInterface = new bafh(paramContext, paramString2, paramString3, i - j - k, paramEditText.getPaint(), paramString4);
    ...
    catch (OutOfMemoryError paramQQAppInterface)
    {
      ...
      paramString1 = new SpannableString(new ayju(paramContext + " ", 16).a());
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, EditText paramEditText, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bafh[] arrayOfbafh = (bafh[])paramEditText.getEditableText().getSpans(0, paramEditText.getEditableText().toString().length(), bafh.class);
    int i = paramEditText.getWidth();
    int j = paramEditText.getPaddingLeft();
    int k = paramEditText.getPaddingRight();
    try
  ...
  private static bafh a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, int paramInt, Paint paramPaint, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        ...
        {
          paramString1 = bbcl.e(paramQQAppInterface, paramString1, paramString2);
      ...
      while (!TextUtils.isEmpty(paramQQAppInterface))
      {
        if (QLog.isColorLevel()) {
          QLog.d("_At_Me_DISC", 2, " memUin:" + paramString2 + " troopMemName:" + bbbd.a(paramQQAppInterface) + " isTroop:" + paramBoolean2);
        }
        return new bafh(paramContext, paramString2, paramQQAppInterface, paramInt, paramPaint);
        paramQQAppInterface = paramString3;
        continue;
        if (!paramString2.equalsIgnoreCase("0"))
        {
          paramString1 = bbcl.c(paramQQAppInterface, paramString2, true);
          paramQQAppInterface = paramString1;
  ...
  public static String a(Spannable paramSpannable, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    bafh[] arrayOfbafh = (bafh[])paramSpannable.getSpans(0, m - 1, bafh.class);
    if (arrayOfbafh.length == 0) {
      return localStringBuffer.toString();
    }
    if (arrayOfbafh.length > 1) {
      Arrays.sort(arrayOfbafh, new bafi(paramSpannable));
    }
    int j = 0;
    int i = 0;
    int n;
    ...
    for (;;)
    {
      if (i >= arrayOfbafh.length) {
        break label345;
      }
      bafh localbafh = arrayOfbafh[i];
      n = paramSpannable.getSpanStart(localbafh) + j;
      i1 = paramSpannable.getSpanEnd(localbafh) + j;
      String str = localbafh.jdField_b_of_type_JavaLangString;
      if (!TextUtils.isEmpty(localbafh.d)) {
        str = localbafh.d;
      }
      try
      {
        ...
        localAtTroopMemberInfo.uin = Long.valueOf(localbafh.jdField_a_of_type_JavaLangString).longValue();
        if ((localbafh.jdField_a_of_type_JavaLangString != null) && (localbafh.jdField_a_of_type_JavaLangString.equalsIgnoreCase("0"))) {
      ...
      catch (JSONException paramQQAppInterface)
      {
        try
        {
          ...
          if (i1 == 0)
          {
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
            str = "@" + bbcl.c(paramQQAppInterface, paramString2, str);
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
  ...
  private List<bcka> a(Paint paramPaint)
  {
    int i = (int)Math.ceil(paramPaint.measureText(" "));
    List localList = bboe.a(this.jdField_b_of_type_Int - i * 2, this.jdField_b_of_type_JavaLangString, paramPaint, this.jdField_a_of_type_Bckb, 16);
    localList.add(new bcka(1, 0, 0, "  ", null));
    this.jdField_a_of_type_Int = bboe.a(localList, paramPaint, new Rect());
    return localList;
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    {
      localObject3 = (bcka)((Iterator)localObject2).next();
      switch (((bcka)localObject3).c)
      {
      default: 
        break;
      case 1: 
        localCanvas.drawText(((bcka)localObject3).jdField_a_of_type_JavaLangString, f1, f2, paramPaint);
        f1 += paramPaint.measureText(((bcka)localObject3).jdField_a_of_type_JavaLangString);
        break;
      case 2: 
        localObject3 = (aykp)((bcka)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle;
        j = ((aykp)localObject3).a().getBounds().height();
        ((aykp)localObject3).draw(localCanvas, "", 0, 0, f1, (i - j) / 2, (i + j) / 2, (j + i) / 2, paramPaint);
        f1 += ((aykp)localObject3).a().getBounds().width();
      }
    }
    localCanvas.save();
    localCanvas.restore();
