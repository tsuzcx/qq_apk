  ...
  implements View.OnClickListener
{
  ...
  protected amsw a;
  protected Context a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aljh(this);
  protected bfqw a;
  ...
  public aljg(Context paramContext, ExpandableListView paramExpandableListView, QQAppInterface paramQQAppInterface, List<Entity> paramList, aljj paramaljj, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Aljj = paramaljj;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
    this.jdField_a_of_type_Bfqw = new bfqw(paramContext);
    this.jdField_a_of_type_Bfqw.a((int)(this.jdField_a_of_type_Float * 100.0F), (int)(this.jdField_a_of_type_Float * 100.0F));
    a(paramList, false);
  ...
  private ArrayList<Entity> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!bftf.a(localRecentUser.uin)) && (localRecentUser.getType() == 0) && (!bftf.c(localRecentUser.uin)) && (this.jdField_a_of_type_Amsw != null) && (this.jdField_a_of_type_Amsw.b(localRecentUser.uin))) {
        localArrayList.add(this.jdField_a_of_type_Amsw.e(localRecentUser.uin));
      }
    }
    ...
    if ((((PhoneContactManagerImp)localObject1).d()) || (i == 8))
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (!((ArrayList)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131694378);
  ...
  {
    alji localalji = (alji)paramView.getTag();
    if (localalji == null)
    {
      localalji = new alji();
      localalji.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367758));
      localalji.b = ((TextView)paramView.findViewById(2131365010));
      paramView.findViewById(2131369232).setVisibility(0);
      paramView.setTag(localalji);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localalji.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      localalji.b.setText(String.valueOf(localGroups.group_friend_count));
      ((CheckBox)paramView.findViewById(2131369232)).setChecked(this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(paramInt));
      return;
    }
  }
  ...
  public void a(List<Entity> paramList, boolean paramBoolean)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break label94;
        Object localObject = ((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(String.valueOf(localGroups.group_id));
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      for (paramViewGroup.jdField_c_of_type_Int = 11;; paramViewGroup.jdField_c_of_type_Int = 1)
      {
        ...
        paramBoolean = this.jdField_a_of_type_Aljj.a(paramView, paramInt1);
        boolean bool = bezm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
        ...
        paramViewGroup = (aljk)localForwardRecentItemView.getTag();
        break;
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558955, paramViewGroup, false);
      paramViewGroup = new alji();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367758));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131365010));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (alji)paramView.getTag();
    }
  }
  ...
  {
    alji localalji = (alji)paramView.getTag();
    if (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(localalji.jdField_a_of_type_Int)) {
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.b(localalji.jdField_a_of_type_Int);
    }
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.a(localalji.jdField_a_of_type_Int);
    }
  }
}
