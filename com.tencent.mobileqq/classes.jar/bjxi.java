  ...
  implements MessageQueue.IdleHandler
{
  ...
  public boolean queueIdle()
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Bjyv.getActivity().getIntent().getExtras();
    ...
    for (localObject = "null";; localObject = str6)
    {
      ...
      localObject = new bkjr(str4);
      ((bkjr)localObject).b = str1;
      ((bkjr)localObject).c = str2;
      ((bkjr)localObject).d = str3;
      this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.setLinkerObject((bkjr)localObject);
      this.a.jdField_a_of_type_Bjxn.a(Message.obtain(null, 15, 1, 0));
      return false;
      localObject = str4;
      break label168;
      localObject = str1;
