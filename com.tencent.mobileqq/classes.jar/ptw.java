...
public class ptw
  extends pto<DynamicChannelDataModel>
{
  ...
  protected TemplateBean a(DynamicChannelDataModel paramDynamicChannelDataModel)
  {
    ...
    if ((paramDynamicChannelDataModel.mTemplateBean != null) && (!((tmh)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getTemplateFactory()).a(paramDynamicChannelDataModel.mTemplateBean))) {
    ...
    {
      localJSONObject = ptq.a(paramDynamicChannelDataModel.proteusData);
      localTemplateBean = ptq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, localJSONObject, ReadInJoyDynamicChannelBaseFragment.a(paramDynamicChannelDataModel.channelID));
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, DynamicChannelDataModel paramDynamicChannelDataModel, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        if (!localTemplateBean.equals(localObject))
        {
          ...
          if (paramDynamicChannelDataModel != null)
          {
            paramDynamicChannelDataModel.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841743));
    ...
    if (localTemplateBean != null) {
      piv.a((Container)localObject, paramDynamicChannelDataModel, localTemplateBean);
    }
    piv.a((Container)localObject, paramVafContext, localTemplateBean);
    blfz.a();
  }
