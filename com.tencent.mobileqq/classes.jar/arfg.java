...
public class arfg
  implements arkf, Manager
{
  private static UpgradeablePluginManager jdField_a_of_type_ComTencentHydevteamPluginframeworkPluginmanagerUpgradeablePluginManager = new UpgradeablePluginManager(argh.a(BaseApplicationImpl.getContext()), "group_video", arfp.a());
  private int jdField_a_of_type_Int;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private final areu jdField_a_of_type_Areu = new areu();
  private bcqf jdField_a_of_type_Bcqf;
  private volatile QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private INetEventHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = new arfl(this);
  private volatile boolean jdField_a_of_type_Boolean;
  
  public arfg(QQAppInterface paramQQAppInterface)
  {
    ...
    arjj.a().a(paramQQAppInterface);
    this.jdField_a_of_type_Areu.a(paramQQAppInterface);
  }
  ...
  private arfn a(String paramString1, String paramString2, String paramString3)
  {
    arfn localarfn = new arfn(null);
    if ((!TextUtils.isEmpty(paramString2)) && (!paramString2.equals("0")))
    {
      localarfn.jdField_a_of_type_Int = 0;
      localarfn.jdField_a_of_type_JavaLangString = paramString2;
      return localarfn;
    }
    if ((!TextUtils.isEmpty(paramString1)) && (!paramString1.equals("0")))
    {
      localarfn.jdField_a_of_type_Int = 2;
      localarfn.jdField_a_of_type_JavaLangString = paramString1;
      return localarfn;
    }
    if ((!TextUtils.isEmpty(paramString3)) && (!paramString3.equals("0")))
    {
      localarfn.jdField_a_of_type_Int = 1;
      localarfn.jdField_a_of_type_JavaLangString = paramString3;
      return localarfn;
    }
    localarfn.jdField_a_of_type_JavaLangString = "0";
    localarfn.jdField_a_of_type_Int = 0;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Bcqf != null)
    {
      ...
      Context localContext2 = this.jdField_a_of_type_Bcqf.getContext();
  ...
  {
    Object localObject = (arik)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(306);
  ...
  private void a(Bundle paramBundle, arkh paramarkh)
  {
    this.jdField_a_of_type_Areu.a(paramBundle, paramarkh);
  }
  
  private void a(arfo paramarfo, arkh paramarkh)
  {
    this.jdField_a_of_type_Areu.a(paramarkh);
    QLog.i("GroupVideoManager", 2, "receive watchTogetherParam: " + paramarfo.toString());
    paramarkh = new JsonObject();
    paramarkh.addProperty("isTogetherWatch", Boolean.valueOf(true));
    paramarkh.addProperty("fromGroupId", Long.valueOf(Long.parseLong(paramarfo.g)));
    paramarkh.addProperty("fromGroupOwnerUin", Long.valueOf(Long.parseLong(paramarfo.h)));
    paramarkh.addProperty("fromGroupName", bbcz.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramarfo.g, false));
    paramarkh.addProperty("sKey", a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    arfn localarfn = a(paramarfo.jdField_b_of_type_JavaLangString, paramarfo.d, paramarfo.c);
    a(paramarfo.jdField_a_of_type_AndroidContentContext, paramarfo.jdField_a_of_type_JavaLangString, localarfn.jdField_a_of_type_JavaLangString, paramarfo.e, paramarfo.f, localarfn.jdField_a_of_type_Int, paramarkh.toString());
  }
  
  public static void a(String paramString, arfm paramarfm)
  {
    ThreadManager.executeOnFileThread(new GroupVideoManager.7(paramString, paramarfm));
  }
  ...
  private void b(Bundle paramBundle, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      localExecutorService.submit(new GroupVideoManager.3(this, localExecutorService.submit(new arfi(this)), paramLong, paramBundle));
      return;
  ...
  public arki a()
  {
    return this.jdField_a_of_type_Areu.a();
  }
  
  public void a(Context paramContext)
  {
    arfp.a(paramContext, "com.tencent.od").a();
  }
  ...
  public void a(Context paramContext, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    for (;;)
    {
      ...
      break;
      label69:
      localObject = (arik)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(306);
      localObject = new Intent(paramContext, ODLoadingActivity.class);
      ((Intent)localObject).putExtra("bizType", "GVideo");
      ((Intent)localObject).putExtra("plugin_id", "Od");
      ((Intent)localObject).putExtra("appid", "1104763709");
  ...
  public void a(Context paramContext, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, arfr paramarfr)
  {
    arfp.a(paramContext, "com.tencent.od").a("group_video", "openGroupvideo", paramString1, paramString2, paramInt, paramString3, paramString4, paramString5, paramString6, paramString7, paramarfr);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) {}
    while (!bbfj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      return;
    }
  ...
  public void a(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, arkh paramarkh)
  {
    paramBundle = new arfo(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  ...
  public void a(String paramString)
  {
    ...
    mrf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, new arfh(this, paramString));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localObject2 = ((aktf)localObject1).a(false);
    ...
    ((akhp)localObject2).a((List)localObject1, new arfk(this));
    return;
    if (QLog.isColorLevel()) {
  ...
  public void b(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, arkh paramarkh)
  {
    a(paramBundle, paramarkh);
  }
