  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<aljh> jdField_a_of_type_JavaLangRefWeakReference;
  
  public alji(aljh paramaljh, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaljh);
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	alji:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	aljh:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    aljh localaljh = (aljh)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localaljh != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localaljh.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
