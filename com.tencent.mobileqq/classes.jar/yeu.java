  ...
  extends ajtd
{
  ...
  akgf jdField_a_of_type_Akgf = new yex(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new yew(this);
  public HashMap<String, List<ybz>> a;
  private List<Long> jdField_a_of_type_JavaUtilList = new ArrayList();
  public ConcurrentHashMap<Long, MessageRecord> a;
  public ybs a;
  private ybz jdField_a_of_type_Ybz = new yev(this);
  public yeo a;
  ...
  public yeu(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Ybz);
    this.jdField_a_of_type_Yes = new yes(paramQQAppInterface);
    this.jdField_a_of_type_Yeo = new yeo(paramQQAppInterface);
    this.jdField_a_of_type_Ybs = new ybs();
    this.jdField_a_of_type_Yet = new yet(paramQQAppInterface);
    a(f, this.jdField_a_of_type_Ybs);
    a(e, this.jdField_a_of_type_Ybs);
    a(g, this.jdField_a_of_type_Ybs);
    a(g, this.jdField_a_of_type_Yeo);
    a(g, this.jdField_a_of_type_Yet);
    a(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Yes);
    a(c, this.jdField_a_of_type_Yes);
    a(d, this.jdField_a_of_type_Yes);
    a(h, this.jdField_a_of_type_Yes);
    a("8000-NASDevMusicFile", this.jdField_a_of_type_Yes);
    a("8001-NASDevVideoFile", this.jdField_a_of_type_Yes);
    a("8002-NASDevDocumentFile", this.jdField_a_of_type_Yes);
    a("8003-NASDevCommonFile", this.jdField_a_of_type_Yes);
    a("", this.jdField_a_of_type_Yes);
    a("", this.jdField_a_of_type_Ybs);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Akgf);
    paramQQAppInterface = (akge)paramQQAppInterface.a(34);
  ...
  private void a()
  {
    DeviceInfo[] arrayOfDeviceInfo = ((yak)this.app.a(51)).a();
  ...
  {
    MessageForDeviceText localMessageForDeviceText = (MessageForDeviceText)axaq.a(-4508);
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong)
  {
    ...
    String str = aaoc.f + "http://maps.google.com/maps?q=" + paramString2 + "," + paramString3 + "&iwloc=A&hl=zh-CN (" + paramString5 + ")";
    if (!paramContext.getResources().getString(2131696394).equals(paramString4)) {}
    for (paramContext = paramContext.getResources().getString(2131691295) + " " + paramString4;; paramContext = paramContext.getResources().getString(2131691295))
    {
      ...
      paramContext = new axuk(StructMsgForGeneralShare.class).c(32).a(paramContext).d(str).a("plugin", paramString2, paramString2, paramString2, paramString2).a();
      ...
      paramContext = axaq.a(this.app, this.app.getCurrentAccountUin(), paramString1, this.app.getCurrentAccountUin(), 9501, 100L, paramContext);
  ...
  public ybs a()
  {
    return this.jdField_a_of_type_Ybs;
  }
  
  public yeo a()
  {
    return this.jdField_a_of_type_Yeo;
  }
  
  public yes a()
  {
    return this.jdField_a_of_type_Yes;
  }
  
  public yet a()
  {
    return this.jdField_a_of_type_Yet;
  }
  ...
  public void a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      long l = ((JSONObject)localObject).optLong("msg_time", awzw.a());
  ...
  {
    ArrayList localArrayList = bbbd.a(paramString, 560, 20, null, new ArrayList());
    int i = 0;
    if (i < localArrayList.size())
    {
      ...
      paramString = "";
      if (str1 != null) {
        paramString = axas.a(str1, true, null);
      }
      int j = (int)awzw.a();
      ...
      localMessageForDeviceText.shmsgseq = axas.a(i, paramSessionInfo.jdField_a_of_type_Int);
      ...
      for (;;)
      {
        if (localMessageForDeviceText.extraflag != 32768)
        {
          ...
          ((yak)paramQQAppInterface.a(51)).a(localMessageForDeviceText.msg, Long.parseLong(localMessageForDeviceText.frienduin), l, localMessageForDeviceText.msgseq);
        }
        i += 1;
        break;
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    default: 
      paramInt = i;
      localMessageForGrayTips = (MessageForGrayTips)axaq.a(paramInt);
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      i = -5001;
      localMessageForNewGrayTips = (MessageForNewGrayTips)axaq.a(i);
  ...
  public boolean a(String paramString, ybz paramybz)
  {
    ...
    if (!((List)localObject).contains(paramybz)) {
      ((List)localObject).add(paramybz);
    }
    return true;
  }
  
  public boolean b(String paramString, ybz paramybz)
  {
    paramString = (List)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {
      paramString.remove(paramybz);
    }
    return true;
  }
  ...
  {
    super.onDestroy();
    b(f, this.jdField_a_of_type_Ybs);
    b(e, this.jdField_a_of_type_Ybs);
    b(g, this.jdField_a_of_type_Ybs);
    b(g, this.jdField_a_of_type_Yeo);
    b(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Yes);
    b(c, this.jdField_a_of_type_Yes);
    b(d, this.jdField_a_of_type_Yes);
    b(h, this.jdField_a_of_type_Yes);
    b("8000-NASDevMusicFile", this.jdField_a_of_type_Yes);
    b("8001-NASDevVideoFile", this.jdField_a_of_type_Yes);
    b("8002-NASDevDocumentFile", this.jdField_a_of_type_Yes);
    b("8003-NASDevCommonFile", this.jdField_a_of_type_Yes);
    b("", this.jdField_a_of_type_Yes);
    b("", this.jdField_a_of_type_Ybs);
    this.app.removeObserver(this.jdField_a_of_type_Ybz);
    this.app.getApp().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.app.removeObserver(this.jdField_a_of_type_Akgf);
    this.jdField_a_of_type_Yes = null;
    this.jdField_a_of_type_Yeo = null;
    this.jdField_a_of_type_Ybs = null;
    this.jdField_a_of_type_Yet = null;
  }
