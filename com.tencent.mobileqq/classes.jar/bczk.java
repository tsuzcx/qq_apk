...
public final class bczk
{
  ...
  public static <T> void a(WebView paramWebView, bczp<T> parambczp)
  {
    ...
    if (paramWebView == null)
    {
      ...
      parambczp.a(new NullPointerException("mWebView is null"));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      parambczp.a(new NullPointerException("context is null"));
      return;
    }
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    localObject1 = new avva((Context)localObject1);
    ((avva)localObject1).a(alpo.a(2131699721));
    ((avva)localObject1).a(true);
    ((avva)localObject1).a(new bczl(localAtomicBoolean, (avva)localObject1));
    ((avva)localObject1).show();
    ...
    Object localObject2 = new bczm((avva)localObject1);
    ...
    ((avva)localObject1).setOnDismissListener(new bczn((AnimatorSet)localObject2));
    a(paramWebView, new bczo(localAtomicBoolean, (avva)localObject1, parambczp, paramWebView, (AnimatorSet)localObject2));
  }
  
  public static void a(WebView paramWebView, bczq parambczq)
  {
    if ((paramWebView == null) || (parambczq == null)) {}
    int i;
    int j;
    Bitmap localBitmap;
    do
            ...
            try
            {
              ...
              try
              {
                if (jdField_a_of_type_JavaLangReflectMethod != null) {
                  jdField_a_of_type_JavaLangReflectMethod.invoke(paramWebView.getX5WebViewExtension(), new Object[] { localBitmap, Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Integer.valueOf(1), Integer.valueOf(1), new ScreenShotUtil.1(parambczq, localBitmap) });
                }
                i = 1;
              }
  ...
  public static <T> boolean a(WebView paramWebView, bczp<T> parambczp)
  {
    ...
    for (;;)
    {
      ...
      if ((i <= 0) || (k <= 0) || (j <= 0))
      {
        ...
        parambczp.a(new IllegalStateException("measuredWidth <= 0 || contentWidth <= 0 || contentHeight <= 0"));
        return false;
      }
      float f = i / k;
      j = (int)(j * f);
      if (j > 20000)
      {
        ...
        parambczp.a(new IllegalStateException(alpo.a(2131719527)));
        return false;
      }
      try
      {
        ...
        if (localBitmap != null)
        {
          Canvas localCanvas = new Canvas(localBitmap);
          localCanvas.scale(f, f);
          ThreadManagerV2.executeOnNetWorkThread(new ScreenShotUtil.2(paramWebView, localCanvas, parambczp, localBitmap));
          return true;
        }
      }
