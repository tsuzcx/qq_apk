...
public class ngx
  extends nfo
{
  public ngx(Context paramContext, ArrayList<nms> paramArrayList, ney paramney, String paramString1, String paramString2)
  {
  ...
  public static View a(Context paramContext, View paramView, ViewGroup paramViewGroup, nmr paramnmr, int paramInt, ney paramney, String paramString1, String paramString2)
  {
    ...
    if (paramnmr.size() % 2 != 0)
    {
      paramnmr.remove(paramnmr.size() - 1);
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup == null) || (!(paramViewGroup instanceof ngx)) || (!((ngx)paramViewGroup).a(paramnmr))) {
        break label162;
      }
      paramContext = paramView;
      if (!QLog.isDevelopLevel()) {
    ...
    paramContext = new ngx(paramContext, paramnmr, paramney, paramString1, paramString2);
  ...
  private void a(LinearLayout paramLinearLayout)
  {
    ...
    int m = actj.a(2.0F, (Resources)localObject1);
    int n = (((Resources)localObject1).getDisplayMetrics().widthPixels - m) / 2;
    int i1 = actj.a(125.0F, (Resources)localObject1);
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      for (;;)
      {
        localObject2 = (nms)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ...
        ((URLImageView)localObject1).setBackgroundDrawable(URLDrawable.getDrawable(((nms)localObject2).e, null, null, true));
        ...
        ((RelativeLayout.LayoutParams)localObject3).setMargins(actj.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, actj.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
        ((TextView)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject3);
        ((TextView)localObject1).setGravity(17);
        ((TextView)localObject1).setText(((nms)localObject2).a);
