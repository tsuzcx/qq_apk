...
public class abzc
  implements bhqd
{
  public abzc(AddRequestActivity paramAddRequestActivity, bhpy parambhpy) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
      long l1 = baaz.a().b();
      this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a = baaz.a().a(Long.valueOf(l1));
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a != null)
      {
        ...
        if ((paramView != null) && (1 < paramView.size()))
        {
          ...
          AddRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131719773, 1000L, false);
        }
      }
    }
    for (;;)
    {
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "Verification_msg", "Vfc_shield_clk", 0, 0, "", "", "", "");
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "0X800AA45", "0X800AA45", 0, 0, "", "", "", "");
      break;
