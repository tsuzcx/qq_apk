...
public class atoi
  implements Handler.Callback, View.OnClickListener, bcrj
{
  public static Boolean a;
  public static WeakReference<atoi> a;
  ...
  public atoi(String paramString, View paramView, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.e = paramInt;
    paramString = (BounceScrollView)paramView.findViewById(2131363400);
    if (paramString != null) {
      paramString.setScrollListener(new bcri(this, paramString.getContext()));
    }
    int i = atsc.jdField_a_of_type_ArrayOfInt.length;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ArrayOfAndroidViewView = new View[i];
    paramInt = 0;
    while (paramInt < i)
    {
      this.jdField_a_of_type_ArrayOfAndroidViewView[paramInt] = paramView.findViewById(atsc.jdField_a_of_type_ArrayOfInt[paramInt]);
      paramInt += 1;
    }
  ...
  {
    if (atbr.a()) {
      atbr.a("InterestGuide", "MSG_CHECK_INTEREST", new Object[] { Integer.valueOf(paramMessage.what), Integer.valueOf(this.d), Integer.valueOf(this.e), Integer.valueOf(this.jdField_a_of_type_AndroidViewView.getMeasuredHeight()) });
    }
    ...
    if ((paramMessage.what == 0) && (this.d == 0) && (this.e != 1) && (this.jdField_a_of_type_AndroidViewView.getMeasuredHeight() > 0))
    {
      ...
      k = 0;
      localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131375445);
      if (localObject != null)
      {
      ...
      if (m < paramMessage.length)
      {
        ...
        if ((localObject != null) && (((View)localObject).getVisibility() == 0))
        {
          ...
          if (atbr.a())
          {
            atbr.a("InterestGuide", "checkShowGuide_bottom", new Object[] { Integer.valueOf(m), Integer.valueOf(this.jdField_a_of_type_ArrayOfInt[0]), Integer.valueOf(this.jdField_a_of_type_ArrayOfInt[1]), Integer.valueOf(((View)localObject).getMeasuredHeight()) });
            n = j;
          }
        }
        for (;;)
        {
          ...
          if (atbr.a())
          {
            atbr.a("InterestGuide", "checkShowGuide_bottom", new Object[] { Integer.valueOf(m), localObject });
            n = i;
          }
        }
      }
      ...
      if (atbr.a()) {
        atbr.a("InterestGuide", "checkShowGuide", new Object[] { Integer.valueOf(this.b), Integer.valueOf(this.c), Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(k), Integer.valueOf(i) });
      }
      localObject = null;
      i = 0;
      ...
      if (paramMessage != null)
      {
        ...
        if (m > 0)
        {
          ...
          paramMessage = LayoutInflater.from(localContext).inflate(2131560857, null);
          ((Button)paramMessage.findViewById(2131363429)).setOnClickListener(this);
        }
      }
    }
    for (;;)
    {
      ...
      if (atbr.a()) {
        atbr.a("InterestGuide", "checkShowGuide", new Object[] { Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m) });
      }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetPopupWindow.dismiss();
      paramView = (BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363400);
      if (paramView != null) {
