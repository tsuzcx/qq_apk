...
public final class bmys
{
  ...
  private final bmyu jdField_a_of_type_Bmyu;
  
  public bmys(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Bmyu = new bmyu(paramView);
  }
  ...
  public static void a(View paramView, long paramLong, View.OnClickListener paramOnClickListener)
  {
    ...
    paramView = new bmyt(paramView, paramOnClickListener);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.removeUpdateListener(this.jdField_a_of_type_Bmyu);
    }
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(this.jdField_a_of_type_Bmyu);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    int k = (i + j) / 2;
    m = (m + (n - i1 - i2)) / 2;
    paramCanvas.scale(this.jdField_a_of_type_Bmyu.a, this.jdField_a_of_type_Bmyu.a, k, m);
    if (QLog.isColorLevel()) {
      QLog.d("PressScaleAnimDelegate ", 2, "draw, left=" + i + ",right=" + j + ",centerX=" + k + ",centerY=" + m + ",scale=" + this.jdField_a_of_type_Bmyu.a);
    }
  }
  
  public boolean a()
  {
    return this.jdField_a_of_type_Bmyu.a != 1.0F;
  }
}
