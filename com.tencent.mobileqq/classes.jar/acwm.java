...
public class acwm
{
  ...
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new acwn(this);
  ...
  private List<bbje>[] jdField_a_of_type_ArrayOfJavaUtilList;
  private Bitmap b;
  private Bitmap c;
  private Bitmap d;
  
  public acwm(FragmentActivity paramFragmentActivity, QQAppInterface paramQQAppInterface, IntimateInfo paramIntimateInfo, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    if ((this.c == null) || (this.c.isRecycled())) {
      this.c = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130845494);
    }
    if ((this.d == null) || (this.d.isRecycled())) {
      this.d = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130845494);
    }
    jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693659) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693660) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693661);
  }
  ...
  private void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Bcwh = new acwo(this);
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    localbgyf.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount();
    bgxy.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localbgyf, paramBitmap, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693663), "", 20001);
  }
  
  private void c()
  {
    this.jdField_a_of_type_Bbjl = new bbjl(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ArrayOfJavaUtilList = a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_Bbjl.a(this.jdField_a_of_type_ArrayOfJavaUtilList);
    this.jdField_a_of_type_Bbjl.a(this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener);
  }
  ...
  private void c(Bitmap paramBitmap)
  {
    try
    {
      ...
      aqbc.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (Intent)localObject, 21);
      return;
    }
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    ...
    localCanvas.restore();
    localCanvas.drawBitmap(a(BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840156), 194, 40), 512.0F, 1185.0F, null);
    return paramBitmap;
  }
  ...
  public Bitmap a(IntimateInfo paramIntimateInfo)
  {
    ...
    {
    default: 
      localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693651);
      ...
      a(localCanvas, localTextPaint, 8.0F + (f + 146.0F), 410.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693601, new Object[] { "" }));
      ...
      localStringBuilder.append(((Resources)localObject).getString(2131693646));
      ...
      {
        localStringBuilder.append(((Resources)localObject).getString(2131693622));
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.commonTroopInfoList.size());
        localStringBuilder.append(((Resources)localObject).getString(2131693610));
        localStringBuilder.append("\r\n");
        label493:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (k < j)
        {
          ...
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840155);
          break;
          ...
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840153);
          break;
          ...
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840154);
          break;
          j = 3;
          break label493;
        }
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    //   19: aload_0
    //   20: getfield 35	acwm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   43: dup
    //   44: getstatic 676	ajsf:aW	Ljava/lang/String;
    //   47: ldc_w 678
    ...
    //   62: ifnonnull +11 -> 73
    //   65: aload_0
    //   66: getfield 33	acwm:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bbjl == null) {
      c();
    }
    ...
    this.jdField_a_of_type_Bbjl.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    this.jdField_a_of_type_Bbjl.a();
  }
  ...
  public void a(int paramInt, Bitmap paramBitmap)
  {
    if ((paramInt == 3) || (paramInt == 4))
    {
      ...
      bcpw.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693656), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    for (;;)
    {
      d();
      ...
      if (!WXShareHelper.a().b()) {
        bcpw.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693664), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      }
    }
  }
  ...
  public List<bbje>[] a(Context paramContext)
  {
    ...
    localArrayList.add(localbbje);
    localbbje = new bbje();
    localbbje.jdField_a_of_type_JavaLangString = paramContext.getString(2131693666);
