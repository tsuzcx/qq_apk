  ...
  implements Handler.Callback
{
  ...
  public bcln a;
  private bclo jdField_a_of_type_Bclo = new bclo(null);
  bclr jdField_a_of_type_Bclr;
  ...
  public bclm()
  {
    this.jdField_a_of_type_Bcln = new bcln();
    f();
  ...
  private bcmf a()
  {
    bcmf localbcmf = this.jdField_a_of_type_Bcln.a.b();
    if (localbcmf != null) {
      return localbcmf;
    }
    localbcmf = this.jdField_a_of_type_Bcln.a.a();
    if (localbcmf != null)
    {
      this.jdField_a_of_type_Bclr.a(localbcmf.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localbcmf;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Bclo.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Bclo.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bclo.jdField_b_of_type_Int = 0;
    alpn.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Bclo.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (bcln.a(this.jdField_a_of_type_Bcln))
    {
      Object localObject2 = bcln.a(this.jdField_a_of_type_Bcln);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Bclr != null) {
      this.jdField_a_of_type_Bclr.c();
    }
    this.jdField_a_of_type_Bclr = null;
    c();
  ...
  public void a(int paramInt1, int paramInt2, almb paramalmb)
  {
    this.jdField_c_of_type_Int = paramInt1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_a_of_type_Int = paramalmb.jdField_c_of_type_Int;
    this.jdField_b_of_type_Int = paramalmb.jdField_d_of_type_Int;
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Bclr = new bclr();
        this.jdField_a_of_type_Bclr.a(false, false);
        d();
      }
      bcke.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (almb)paramMessage.obj);
      this.h = true;
      if (this.i) {
        a(a());
      }
    ...
    do
    {
      do
      {
        ...
        f();
        this.jdField_a_of_type_Bcln.a();
        this.jdField_a_of_type_Bcln.a = null;
        this.jdField_a_of_type_Bclo.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Bclo.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Bclo.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (j != 0)
    {
      alpn.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
      return true;
    }
    if (this.jdField_a_of_type_Bclr != null) {
      bcke.a(PtvFilterUtils.a() / 1000L);
    }
    boolean bool1;
    if (paramMessage.obj != null)
    {
      ...
      for (;;)
      {
        ...
        alpn.a("handleMessage:[copyDataToByteBuffer] steptime=" + l1 + " us");
        bcke.d(l1);
        ...
        if (this.jdField_a_of_type_Bcln.a != null) {
          break;
        }
        alpn.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
        if (paramMessage.arg1 == 1) {
          localObject = ((bcjf)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
        }
      }
      ...
      if (localbcmf != null)
      {
        this.jdField_a_of_type_Bclr.a(localbcmf.jdField_a_of_type_Int);
        alpn.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] bindTextureId=" + localbcmf.jdField_a_of_type_Int);
        alpn.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] Begin drawFrame mWidth=" + this.jdField_a_of_type_Int + " mHeight=" + this.jdField_b_of_type_Int);
        e();
        alpn.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] End drawFrame");
        if (!jdField_a_of_type_Boolean) {}
        AVIOStruct localAVIOStruct;
        for (bool1 = true;; bool1 = false)
        {
          PtvFilterUtils.a(bool1);
          alpn.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] glSyncCommand OK: sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
          if (paramMessage.arg1 != 1) {
            break label1126;
          }
          localAVIOStruct = ((bcjf)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
        ...
        {
          this.jdField_a_of_type_Bclo.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        bool1 = true;
        label739:
        localbcmf.a(j, localObject, bool1);
        localbcmf.e();
        bool1 = this.jdField_a_of_type_Bcln.a.a();
        alpn.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Bclo.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Bclo.jdField_a_of_type_Boolean) {
            a((AVIOStruct)localObject);
          }
          localbcmf.a();
        }
        alpn.a("handleMessage:writeVideoFrame frameBufferTime=" + l2 + "  sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
      }
      l1 = (PtvFilterUtils.a() - l1) / 1000L;
      bcke.c(l1);
    ...
    for (;;)
    {
      ...
      break label739;
      label1143:
      alpn.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
    }
  }
}
