...
{
  sjq(sjo paramsjo, long paramLong, NewIntent paramNewIntent, sjs paramsjs, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      if (this.jdField_a_of_type_Sjs != null) {
        this.jdField_a_of_type_Sjs.a(this.jdField_a_of_type_JavaLangString, "error");
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Sjs != null)
        {
          ...
          this.jdField_a_of_type_Sjs.a(this.jdField_a_of_type_JavaLangString, paramBundle);
        }
      } while (!QLog.isColorLevel());
