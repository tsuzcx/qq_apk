...
public class sjq
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = sjq.class.getSimpleName();
  }
  
  public sjq(Activity paramActivity, QQAppInterface paramQQAppInterface, sks paramsks, VideoFeedsPlayManager paramVideoFeedsPlayManager, shl paramshl, boolean paramBoolean)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Sks = paramsks;
  ...
  private void c()
  {
    ...
    case 0: 
      ...
      Object localObject = Boolean.valueOf(bmhv.t(pkh.a()));
      ...
      if (((Boolean)localObject).booleanValue()) {
        tto.a(this.jdField_a_of_type_AndroidAppActivity, anvx.a(2131715612), "https://kandian.qq.com/viola/bundle_weishiLeadTo.js?v_bid=3256", null, new sjr(this, localBundle));
      }
      for (;;)
      {
        if (!((Boolean)localObject).booleanValue()) {
        ...
        try
        {
          ...
          localObject = this.jdField_a_of_type_Swr.jdField_a_of_type_Skq.a;
          olh.a(null, null, "0X800933E", "0X800933E", 0, 0, String.valueOf(i), "", "", omx.a(null, null, ((VideoInfo)localObject).jdField_a_of_type_JavaLangString, ((VideoInfo)localObject).g, null), false);
          return;
        }
        ...
        pqx.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_a_of_type_JavaLangString, localBundle);
      }
    }
    d();
    e();
    this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidViewView.setVisibility(0);
  }
  
  private void d()
  {
    if ((this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidViewView == null) && ((this.jdField_a_of_type_Swr.itemView instanceof ViewGroup)))
    {
      View localView = View.inflate(this.jdField_a_of_type_AndroidAppActivity, 2131560378, (ViewGroup)this.jdField_a_of_type_Swr.itemView);
      this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidViewView = localView.findViewById(2131367957);
      this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidViewView = localView.findViewById(2131367941);
      this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367949));
      this.jdField_a_of_type_Swr.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367958));
      this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367961));
      this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367947));
      this.jdField_a_of_type_Swr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCircleCountdownView = ((CircleCountdownView)localView.findViewById(2131367959));
    }
  }
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd == null) || (this.jdField_a_of_type_Swr == null)) {
      bool = false;
    }
    int i;
    do
    {
      ...
      {
        return bool;
        i = this.jdField_a_of_type_Swr.jdField_c_of_type_Int;
        switch (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_b_of_type_Int)
        {
        default: 
          return false;
  ...
  private void e()
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_Swr != null) && (this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidWidgetTextView != null))
    {
      ...
      {
        if (bhfn.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_b_of_type_JavaLangString)) {
          break label297;
        }
        this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.d);
        localObject = localResources.getDrawable(2130843149);
      }
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidWidgetTextView.setCompoundDrawables((Drawable)localObject, null, null, null);
      this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new sjs(this));
      this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new sjt(this));
      this.jdField_a_of_type_Swr.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_b_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidViewView.setOnClickListener(null);
      localObject = new JSONObject();
      try
      {
        ((JSONObject)localObject).put("uin", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        label244:
        olh.a(null, null, "0X8009BF0", "0X8009BF0", 0, 0, "", "", "", omx.a(null, null, this.jdField_a_of_type_Swr.jdField_a_of_type_Skq.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Swr.jdField_a_of_type_Skq.a.g, (JSONObject)localObject), false);
        return;
        label297:
        this.jdField_a_of_type_Swr.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.e);
        localObject = localResources.getDrawable(2130843152);
      }
      catch (Exception localException)
      {
        break label244;
  ...
  private boolean e()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_b_of_type_JavaLangString = bmhv.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      localObject = bmhv.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      boolean bool = bmhv.x(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void a()
  {
    ...
    {
      localsks = this.jdField_a_of_type_Sks;
      if (this.jdField_a_of_type_Swr == null) {
        break label55;
      }
    }
    label55:
    for (skq localskq = this.jdField_a_of_type_Swr.jdField_a_of_type_Skq;; localskq = null)
    {
      localsks.b(localskq);
      this.g = false;
      this.f = false;
  ...
  public boolean a(swr paramswr, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Swr != null) {}
    for (int i = this.jdField_a_of_type_Swr.jdField_c_of_type_Int;; i = 0)
    {
      if ((paramswr.jdField_c_of_type_Int > i) && (paramBoolean)) {
        b();
      }
      if ((this.jdField_a_of_type_Swr != null) && (this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidViewView != null)) {
        this.jdField_a_of_type_Swr.jdField_b_of_type_AndroidViewView.setVisibility(8);
      }
      ...
      this.jdField_d_of_type_Int = paramswr.jdField_c_of_type_Int;
      this.jdField_c_of_type_Boolean = false;
      this.jdField_d_of_type_Boolean = false;
      this.e = false;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd != null) && (QLog.isColorLevel())) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "setPlayingVideoInfo() itemHolder.position=" + paramswr.jdField_c_of_type_Int);
      }
      return a(0) | false;
    }
  }
    ...
    if ((this.jdField_b_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString))) {
      try
      {
        ...
        for (String str = "weishi";; str = "default")
        {
          ...
          bmhv.E(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localJSONObject1.toString());
          if (!QLog.isColorLevel()) {
            break;
          }
