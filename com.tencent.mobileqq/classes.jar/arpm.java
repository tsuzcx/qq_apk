  ...
  extends MSFServlet
{
  ...
  static
  {
    Object localObject = { 2131427353, -128 };
    int[] arrayOfInt1 = { 2131427354, -150 };
    int[] arrayOfInt2 = { 2131427349, -151 };
    int[] arrayOfInt3 = { 2131427350, -220 };
    int[] arrayOfInt4 = { 2131427348, 152 };
    int[] arrayOfInt5 = { -1, 350 };
    int[] arrayOfInt6 = { -1, 366 };
    jdField_a_of_type_Array2dOfInt = new int[][] { { 2131427352, -127 }, localObject, arrayOfInt1, arrayOfInt2, { 2131427351, -208 }, arrayOfInt3, arrayOfInt4, { 2131427361, 317 }, { 2131427363, 318 }, { -1, 219 }, arrayOfInt5, { -1, 356 }, arrayOfInt6 };
    ...
    if (i < j)
    {
      ...
      int m = arrayOfInt1[1];
      if (k != -1) {
        jdField_a_of_type_AndroidUtilSparseIntArray.put(weg.a(k), m);
      }
      for (;;)
      {
        i += 1;
    ...
    wej.a(jdField_a_of_type_AndroidUtilSparseIntArray);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Intent paramIntent, Packet paramPacket)
  {
    ...
    boolean bool = bhhr.b(paramQQAppInterface.getApp(), "Q.qqstory.config.QQStoryConfigServlet");
    ArrayList localArrayList2 = new ArrayList(k);
    int i = 0;
    if (i < k)
    {
      int m = jdField_a_of_type_AndroidUtilSparseIntArray.keyAt(i);
      String str = wjl.a(jdField_a_of_type_AndroidUtilSparseIntArray.valueAt(i));
      ConfigurationService.ConfigSeq localConfigSeq = new ConfigurationService.ConfigSeq();
      localConfigSeq.type.set(m);
      int j = 0;
      if (bool) {
        bhhr.b(paramQQAppInterface.getApp(), str, paramIntent);
      }
      for (;;)
      {
        ...
        i += 1;
        break;
        j = bhhr.a(paramQQAppInterface.getApp(), str, paramIntent);
      }
    }
    if (bool) {
      bhhr.g(paramQQAppInterface.getApp(), "Q.qqstory.config.QQStoryConfigServlet");
    }
    if (QLog.isColorLevel())
    {
    ...
    paramQQAppInterface = SosoInterface.getSosoInfo();
    ykq.b("Q.qqstory.config.QQStoryConfigServlet", "addAllConfigs");
    if (paramQQAppInterface == null) {
      ykq.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo is null.");
    }
    for (;;)
    {
      ...
      {
        ykq.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo.location is null.");
      }
      else if (TextUtils.isEmpty(paramQQAppInterface.mLocation.cityCode))
      {
        ykq.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo.location.cityCode is null");
      }
      else
      {
        ykq.a("Q.qqstory.config.QQStoryConfigServlet", "adcode:%s", paramQQAppInterface.mLocation.cityCode);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), arpm.class);
  ...
  private void a(ConfigurationService.RespGetConfig paramRespGetConfig, QQAppInterface paramQQAppInterface, Intent paramIntent, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        if (localConfig.type.has())
        {
          ...
          ykq.a("Q.qqstory.config.QQStoryConfigServlet", "receiveAllConfigs|receive type: %d, localConfigId: %d, length: %d", Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(j));
          String str1 = paramIntent.getStringExtra("key_uin");
          String str2 = wjl.a(m);
          int n = bhhr.a(paramQQAppInterface.getApp(), str2, str1);
          String str3 = arph.a(localConfig, n, m);
          if (localConfig.content_list.size() > 0) {
            ykq.a("Q.qqstory.config.QQStoryConfigServlet", "%d --> %s", Integer.valueOf(m), (String)localConfig.content_list.get(0));
          }
          ykq.a("Q.qqstory.config.QQStoryConfigServlet", "%d ---> %s", Integer.valueOf(m), str3);
          paramBoolean = localwjl.a(m, paramIntent, localConfig);
          if (paramBoolean) {
            bhhr.a(paramQQAppInterface.getApp(), str2, str1, localConfig.version.get());
          }
          ykq.b("Q.qqstory.config.QQStoryConfigServlet", "receiveAllConfigs|receive type: %d, localConfigId: %d, length: %d, localVersion:%d, newVersion: %d, handled: %b", new Object[] { Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(j), Integer.valueOf(n), Integer.valueOf(localConfig.version.get()), Boolean.valueOf(paramBoolean) });
        }
      }
    }
    ...
    while (paramRespGetConfig.hasNext())
    {
      ...
      default: 
        break;
      case 243: 
        ((vzu)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QQSTORY_HANDLER)).notifyUI(1021, true, null);
      }
    }
  }
  ...
  public void onReceive(Intent paramIntent, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 444	arpm:getAppRuntime	()Lmqq/app/AppRuntime;
    //   4: checkcast 68	com/tencent/mobileqq/app/QQAppInterface
    //   7: astore 6
    //   9: aload_2
    //   10: invokevirtual 449	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   13: istore 5
    //   15: getstatic 30	arpm:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   18: invokevirtual 63	android/util/SparseIntArray:size	()I
    //   21: ifne +10 -> 31
    //   24: aload_0
    //   25: aload_1
    //   26: iconst_0
    //   27: invokestatic 452	wej:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   30: return
    //   31: invokestatic 127	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   34: ifeq +73 -> 107
    //   37: getstatic 30	arpm:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   40: invokevirtual 63	android/util/SparseIntArray:size	()I
    //   43: istore 4
    //   45: iconst_0
    //   46: istore_3
    //   47: iload_3
    //   48: getstatic 30	arpm:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    ...
    //   73: getstatic 30	arpm:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   76: iload_3
    ...
    //   97: invokestatic 290	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   100: iload_3
    //   101: iconst_1
    //   102: iadd
    //   103: istore_3
    //   104: goto -57 -> 47
    //   107: aload_2
    //   108: invokevirtual 457	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   111: astore 7
    //   113: aload 7
    //   115: ifnull +10 -> 125
    //   118: aload 7
    ...
    //   141: aload_1
    //   142: iconst_0
    //   143: invokestatic 452	wej:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   146: return
    //   147: aload_2
    //   148: aload 7
    //   150: invokestatic 461	arpm:a	([B)[B
    //   153: invokevirtual 464	com/tencent/qphone/base/remote/FromServiceMsg:putWupBuffer	([B)V
    //   156: new 275	com/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig
    //   159: dup
    //   160: invokespecial 465	com/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig:<init>	()V
    //   163: astore 7
    //   165: aload 7
    //   167: aload_2
    //   168: invokevirtual 457	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   171: invokevirtual 469	com/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   174: pop
    //   175: aload_0
    //   176: aload 7
    //   178: aload 6
    //   180: aload_1
    //   181: iload 5
    //   183: invokespecial 471	arpm:a	(Lcom/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig;Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Intent;Z)V
    //   186: aload_0
    //   187: aload_1
    //   188: iconst_1
    //   189: invokestatic 452	wej:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   192: return
    //   193: astore_2
    ...
    //   216: aload_2
    //   217: invokevirtual 474	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:toString	()Ljava/lang/String;
    ...
    //   229: aload_2
    //   230: invokevirtual 477	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   233: aload_0
    //   234: aload_1
    //   235: iconst_0
    //   236: invokestatic 452	wej:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   239: return
    //   240: astore_2
    //   241: goto -55 -> 186
