...
public class arpm
{
  ...
  public static int a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    do
    {
      ...
      bool = bgmg.a(paramString, paramArrayOfByte, false);
      if (QLog.isColorLevel()) {
  ...
  public static int a(byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      bool = bgmg.a(paramString2, paramArrayOfByte, false);
      if (QLog.isColorLevel()) {
  ...
  public static String a(int paramInt, String paramString)
  {
    ...
    localStringBuilder.append(arze.n.replace("[epId]", paramString));
    switch (paramInt)
    {
    }
    for (;;)
  ...
  public static String a(Context paramContext, QQMessageFacade.Message paramMessage)
  {
    ...
    return paramContext.getString(2131691739);
  }
  ...
  public static String a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    return bgva.a(paramArrayOfByte).toLowerCase();
  }
  ...
  {
    boolean bool = bgnt.d(BaseApplicationImpl.getContext());
    if (!bool) {
      QQToast.a(BaseApplicationImpl.getContext(), 2131691985, 0).a();
    }
    return bool;
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    //   8: aload_0
    //   9: ldc_w 392
    //   12: invokespecial 395	arpk:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   15: astore 4
    //   17: aload 4
    //   19: astore_0
    //   20: bipush 10
    ...
    //   29: aload 4
    //   31: aload 5
    //   33: invokevirtual 396	arpk:read	([B)I
    //   36: pop
    //   37: iload_3
    //   38: istore_2
    //   39: aload 5
    ...
    //   78: ifnull +10 -> 88
    //   81: aload 4
    //   83: invokevirtual 397	arpk:close	()V
    //   86: iload_2
    //   87: istore_3
    //   88: iload_3
    //   89: ireturn
    ...
    //   157: ifnull -69 -> 88
    //   160: aload 4
    //   162: invokevirtual 397	arpk:close	()V
    //   165: iconst_0
    //   166: ireturn
    //   167: astore_0
    //   168: aload_0
    ...
    //   198: ifnull +7 -> 205
    //   201: aload_0
    //   202: invokevirtual 397	arpk:close	()V
    //   205: aload 4
    //   207: athrow
    //   208: astore_0
    //   209: aload_0
