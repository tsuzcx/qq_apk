...
final class atvq
  implements atwp
{
  atvq(QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public long a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, String paramString5, long paramLong1, int paramInt3, long paramLong2, int paramInt4)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = atwl.a(atwl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()), atvo.a(paramString5));
      bgmg.d(paramString5, localDataLineMsgRecord.thumbPath);
    }
    ...
    for (localDataLineMsgRecord.nOpType = 29;; localDataLineMsgRecord.nOpType = 31)
    {
      ...
      paramString1 = (anjx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
      ...
      paramString1.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)anjx.b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
