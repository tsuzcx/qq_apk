...
public class aoir
  extends alpd
{
  public aoir(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            aoiy.a(this.app, str, aoiq.e, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            aoiy.a(this.app, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  private void b(QQAppInterface paramQQAppInterface, aoiq paramaoiq)
  {
    int i = 0;
    long l1 = ayzl.a();
    ...
    aoiq.a(paramQQAppInterface, "redpoint_box_show", l1);
    aoiy.a(paramQQAppInterface, false, true);
    paramQQAppInterface.a().a().d(alof.aN, 1032);
    amnz localamnz = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localamnz.b(alof.aN, 1032);
    if (localRecentUser == null)
    {
      paramQQAppInterface = new RecentUser(alof.aN, 1032);
  ...
  private void c(QQAppInterface paramQQAppInterface, aoiq paramaoiq)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, "onNeedShowLebaRedPoint");
    }
    aoiq.a(paramQQAppInterface, "redpoint_leba_show", ayzl.a());
  }
  ...
  public void a(aojg paramaojg)
  {
    ...
    if (this.app.a().a().b(alof.aN, 1032) != null)
    {
    ...
    notifyUI(2, true, paramaojg);
  }
  
  public void a(QQAppInterface paramQQAppInterface, aoiq paramaoiq)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, String.format("onGetNewConfig boxEntry:%d contactEntry:%d", new Object[] { Integer.valueOf(paramaoiq.h), Integer.valueOf(paramaoiq.i) }));
    }
    if (paramaoiq.h == 2) {
      b(paramQQAppInterface, paramaoiq);
    }
    if (paramaoiq.i == 2) {
      c(paramQQAppInterface, paramaoiq);
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo, int paramInt3)
  {
    ...
    if (paramInt3 == -1)
    {
      ...
      azqs.b(this.app, "dc00898", "", "", (String)localObject, (String)localObject, 0, 0, "", "", "", "");
  ...
  public void b(aojg paramaojg)
  {
    ...
    if ((paramaojg != null) && (paramaojg.a()))
    {
      localamnz = this.app.a().a();
      localRecentUser2 = localamnz.b(alof.aN, 1032);
      i = 0;
      if (localRecentUser2 != null) {
        break label123;
      }
      localRecentUser1 = new RecentUser();
      localRecentUser1.uin = alof.aN;
      localRecentUser1.setType(1032);
      localRecentUser1.lastmsgtime = paramaojg.a;
      i = 1;
    }
    for (;;)
    {
      if (i != 0)
      {
        ...
        paramaojg = this.mApp.getHandler(Conversation.class);
        if (paramaojg != null) {
          paramaojg.sendEmptyMessage(1009);
        }
      }
      ...
      if (localRecentUser2.lastmsgtime < paramaojg.a)
      {
        localRecentUser2.lastmsgtime = paramaojg.a;
        i = 1;
        localRecentUser1 = localRecentUser2;
      }
    }
