  ...
  implements Runnable
{
  ...
  public aoir(BaseActivity paramBaseActivity, Intent paramIntent)
  {
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("src_edited", false);
    ...
    if (FileUtils.b(str))
    {
      ...
      if (((URLDrawable)localObject).getStatus() == 1) {
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new aois(this));
      }
    }
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new aoit(this));
      return;
      if (QLog.isColorLevel()) {
        QLog.e("SendVideoActivity", 2, "#SendTask# run(): thumb not exist, path=" + str);
      }
    } while (this.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new aoiu(this));
  }
}
