...
public class liy
{
  ...
  static
  {
    ...
    jdField_a_of_type_Ljc = new ljc();
  }
  
  public liy(Context paramContext)
  {
    ...
    this.jdField_c_of_type_Boolean = msm.f(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_d_of_type_Boolean = msm.c();
    this.h = Build.VERSION.SDK_INT;
    this.jdField_a_of_type_JavaLangString = Build.MODEL;
    this.jdField_b_of_type_JavaLangString = Build.MANUFACTURER;
    jdField_a_of_type_Ljc.jdField_b_of_type_Int = -1;
    jdField_a_of_type_Ljc.jdField_c_of_type_Int = -1;
  ...
  {
    if (paramBoolean) {
      return 360 - lkq.a(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
    }
    return 360 - lkq.b(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
  }
  ...
  protected ljc a(int paramInt, Camera paramCamera)
  {
    paramCamera = new ljc();
    try
    {
  ...
  {
    int i1 = jdField_a_of_type_Ljc.jdField_c_of_type_Int;
    jdField_a_of_type_Ljc.jdField_c_of_type_Int = ((this.k + paramInt) % 360);
    if (i1 != jdField_a_of_type_Ljc.jdField_c_of_type_Int) {
      QLog.w("AndroidCamera", 1, "setMobileRotation, rotation[" + i1 + "->" + jdField_a_of_type_Ljc.jdField_c_of_type_Int + "], mCompenSateSendAngle[" + this.k + "]");
    }
  }
  
  public void a(int paramInt, liz paramliz)
  {
    int i1 = 0;
    if (this.n != paramInt)
    {
    ...
    if (this.n == 0) {
      if ((this.jdField_a_of_type_Lja != null) && (i1 == 0)) {}
    }
    for (this.jdField_a_of_type_Lja = new ljl(this, paramliz);; this.jdField_a_of_type_Lja = new ljm(this, paramliz))
    {
      do
      {
        if (QLog.isColorLevel()) {
        ...
        return;
      } while ((this.n != 1) || ((this.jdField_a_of_type_Lja != null) && (i1 == 0)));
      if (this.jdField_a_of_type_Lja != null) {
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      return;
      synchronized (jdField_a_of_type_Ljc)
      {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      lba.f("AndroidCamera", "mFrontCameraAngle: " + this.l + ", mBackCameraAngle: " + this.m);
      return;
      this.m = (paramInt % 360);
    }
  }
  ...
  {
    ljc localljc = a(paramInt, paramCamera);
    this.k = d();
    this.j = e();
    int i2 = f();
    int i3 = g();
    int i4;
    int i5;
    if (localljc.jdField_a_of_type_Int == 1)
    {
      i1 = (360 - (localljc.jdField_b_of_type_Int + localljc.jdField_c_of_type_Int) % 360) % 360;
    ...
    {
      QLog.w("AndroidCamera", 1, "setCameraDisplayOrientation, cameraId[" + paramInt + "], orientation[" + jdField_a_of_type_Ljc.jdField_b_of_type_Int + "->" + localljc.jdField_b_of_type_Int + "], rotation[" + jdField_a_of_type_Ljc.jdField_c_of_type_Int + "->" + localljc.jdField_c_of_type_Int + "], mCompenSateSendAngle[" + this.k + "], mCompenSateRecvAngle[" + this.j + "], mSupportLandscape[" + this.jdField_e_of_type_Boolean + "], previewAngleForFrontCamera[" + i4 + "], previewAngleForBackCamera[" + i5 + "], cameraImageOrientation[" + i2 + "], mobileRotation[" + i3 + "], result[" + i1 + "], cameraMode[" + this.n + "], seq[" + paramLong + "]");
      a(paramCamera, i1);
      jdField_a_of_type_Ljc.jdField_a_of_type_Int = localljc.jdField_a_of_type_Int;
      jdField_a_of_type_Ljc.jdField_b_of_type_Int = localljc.jdField_b_of_type_Int;
      return true;
      i1 = (localljc.jdField_b_of_type_Int - localljc.jdField_c_of_type_Int + 360) % 360;
      break;
    }
  }
  ...
  public boolean a(long paramLong, SurfaceTexture paramSurfaceTexture)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (jdField_a_of_type_Boolean)
        {
          ...
          ljo.a(BaseApplicationImpl.getContext(), "openCamera");
          return bool1;
        }
      ...
      if (a(paramLong))
      {
        ...
        if (b(paramLong))
        {
          ...
          try
          {
            label414:
            if (this.jdField_a_of_type_Lja != null) {
              this.jdField_a_of_type_Lja.a(paramLong, paramSurfaceTexture);
            }
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_AndroidHardwareCamera != null)
      {
        ...
        break label596;
        label578:
        ljo.b(BaseApplicationImpl.getContext(), "openCamera");
        break label154;
        bool1 = false;
        break label321;
      }
      ...
      try
      {
        ...
        if (this.g >= 1) {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              ljo.a(BaseApplicationImpl.getContext(), "reopenCamera");
              return bool1;
            }
          }
          else
          {
            QLog.w("AndroidCamera", 1, "reopenCamera, size[" + jdField_a_of_type_Int + ", " + jdField_b_of_type_Int + "], mCurCamera[" + this.f + "], isCameraOpened[" + jdField_a_of_type_Boolean + "], sizeFromParameter[" + paramInt1 + ", " + paramInt2 + "], seq[" + paramLong + "]");
            if (paramInt1 != -1)
            {
              i1 = paramInt1;
              paramInt1 = paramInt2;
        ...
        case 1: 
          ...
          break label382;
          ljo.b(BaseApplicationImpl.getContext(), "reopenCamera");
          continue;
          bool1 = false;
        }
      }
  ...
  protected int b()
  {
    ...
    {
      if (AudioHelper.f()) {
        QLog.w("AndroidCamera", 1, "getNumberOfCamera, hardcode[" + bgbt.a().a() + "]");
      }
      i1 = bgbt.a().a();
    }
    do
  ...
  {
    if (paramBoolean) {
      return lkq.a(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
    }
    return lkq.b(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
  }
  ...
  protected Camera b(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: putfield 340	liy:i	I
    //   11: aload_0
    //   12: getfield 54	liy:g	I
    //   15: ifne +11 -> 26
    //   18: aload_0
    //   19: aload_0
    //   20: invokevirtual 342	liy:b	()I
    //   23: putfield 54	liy:g	I
    //   26: aload_0
    //   27: getfield 54	liy:g	I
    //   30: ifle +240 -> 270
    //   33: new 344	android/hardware/Camera$CameraInfo
    //   36: dup
    //   37: invokespecial 345	android/hardware/Camera$CameraInfo:<init>	()V
    //   40: astore 8
    //   42: iconst_0
    //   43: istore_3
    //   44: iload_3
    //   45: aload_0
    //   46: getfield 54	liy:g	I
    //   49: if_icmpge +319 -> 368
    //   52: iload_3
    //   53: aload 8
    //   55: invokestatic 351	android/hardware/Camera:getCameraInfo	(ILandroid/hardware/Camera$CameraInfo;)V
    //   58: aload 8
    //   60: getfield 354	android/hardware/Camera$CameraInfo:facing	I
    //   63: istore 4
    //   65: invokestatic 159	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   68: ifeq +54 -> 122
    //   71: ldc 120
    //   73: iconst_1
    //   74: new 122	java/lang/StringBuilder
    //   77: dup
    //   78: invokespecial 123	java/lang/StringBuilder:<init>	()V
    //   81: ldc_w 674
    //   84: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   87: iload_3
    //   88: invokevirtual 194	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   91: ldc_w 676
    //   94: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   97: iload 4
    //   99: invokevirtual 194	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   102: ldc 196
    //   104: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   107: lload_1
    //   108: invokevirtual 199	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   111: ldc 138
    ...
    //   119: invokestatic 146	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   122: iload 4
    //   124: iconst_1
    //   125: if_icmpne +249 -> 374
    //   128: iload_3
    //   129: invokestatic 680	android/hardware/Camera:open	(I)Landroid/hardware/Camera;
    //   132: astore 5
    //   134: aload_0
    //   135: iload_3
    //   136: putfield 340	liy:i	I
    //   139: aload 5
    //   141: astore 6
    //   143: invokestatic 159	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   146: ifeq +74 -> 220
    //   149: ldc 120
    //   151: iconst_1
    ...
    //   165: aload 5
    //   167: invokevirtual 177	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   170: ldc_w 684
    //   173: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   176: aload_0
    //   177: getfield 340	liy:i	I
    //   180: invokevirtual 194	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   183: ldc_w 686
    //   186: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   189: aload_0
    //   190: getfield 54	liy:g	I
    //   193: invokevirtual 194	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   196: ldc 196
    //   198: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   201: lload_1
    //   202: invokevirtual 199	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   205: ldc 138
    ...
    //   213: invokestatic 146	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   216: aload 5
    //   218: astore 6
    //   220: aload 6
    //   222: astore 5
    ...
    //   244: ldc_w 688
    //   247: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   250: lload_1
    //   251: invokevirtual 199	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   254: ldc 138
    ...
    //   262: aload 5
    //   264: invokestatic 359	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   267: goto +107 -> 374
    //   270: invokestatic 159	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   273: ifeq -49 -> 224
    //   276: ldc 120
    //   278: iconst_1
    //   279: new 122	java/lang/StringBuilder
    //   282: dup
    //   283: invokespecial 123	java/lang/StringBuilder:<init>	()V
    //   286: ldc_w 690
    //   289: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   292: aload_0
    //   293: getfield 54	liy:g	I
    //   296: invokevirtual 194	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   299: ldc 196
    //   301: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   304: lload_1
    //   305: invokevirtual 199	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   308: ldc 138
    //   310: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   313: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   316: invokestatic 146	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   319: aconst_null
    //   320: areturn
    //   321: astore 6
    //   323: aload 7
    ...
    //   343: lload_1
    //   344: invokevirtual 199	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   347: ldc 138
    //   349: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   352: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   355: aload 6
    //   357: invokestatic 359	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   360: aload 5
    //   362: areturn
    //   363: astore 6
    //   365: goto -38 -> 327
      ...
      try
      {
        if (this.g >= 1)
        {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              ljo.a(BaseApplicationImpl.getContext(), "switchCamera");
              return bool1;
            }
          }
          else
          {
            QLog.w("AndroidCamera", 1, "switchCamera, mCurCamera[" + this.f + "], seq[" + paramLong + "]");
            c(paramLong);
            int i1 = this.f;
            boolean bool2;
            switch (i1)
          ...
          ljo.b(BaseApplicationImpl.getContext(), "switchCamera");
          continue;
        }
        bool1 = false;
      }
  ...
  public boolean c(long paramLong)
  {
    try
    {
      ...
      ljo.b(BaseApplicationImpl.getContext(), "closeCamera");
      return true;
    }
    finally {}
  }
  ...
  public int f()
  {
    if (jdField_a_of_type_Ljc.jdField_b_of_type_Int == -1)
    {
      if (this.f == 1) {
        return 270;
      }
    ...
    return jdField_a_of_type_Ljc.jdField_b_of_type_Int;
  }
  
  public int g()
  {
    if (jdField_a_of_type_Ljc.jdField_c_of_type_Int == -1) {
      return 0;
    }
    return jdField_a_of_type_Ljc.jdField_c_of_type_Int;
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder().append("isCameraOpened[").append(jdField_a_of_type_Boolean).append("], mCameraId[").append(this.i).append("], NUM[").append(this.g).append("], CUR[").append(this.f).append("], camera[");
    if (this.jdField_a_of_type_AndroidHardwareCamera != null) {}
