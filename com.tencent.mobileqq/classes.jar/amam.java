...
public class amam
{
  private static aukp a;
  public static final String a;
  private static String b;
  
  static
  {
    jdField_a_of_type_JavaLangString = bbvj.a(ajsd.aW + ".Rock/");
  }
  
  public static aukp a()
  {
    if (jdField_a_of_type_Aukp == null) {
      jdField_a_of_type_Aukp = new amat().createEntityManager();
    }
    return jdField_a_of_type_Aukp;
  }
  ...
  public static ArrayList<RockDownloadInfo> a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    for (;;)
    {
      ...
      paramRockDownloaderTask = (auko)((Iterator)localObject).next();
  ...
  public static void a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), amas.class);
    ...
    localNewIntent.setObserver(new aman(paramRockDownloaderTask));
  ...
  private static void b(RockDownloaderTask paramRockDownloaderTask, DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (bool2))
      {
        ...
        localObject = (DownloadInfo)bdhk.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("RockDownloader", 2, new Object[] { "removedDownload=", localObject });
        }
        bdhi.a().a(paramDownloadInfo.jdField_b_of_type_JavaLangString);
  ...
  private static void b(@NonNull RockDownloaderTask paramRockDownloaderTask, String paramString)
  {
    ...
    if (localObject != null)
    {
      localStringBuilder.append(((RockDownloadInfo)localObject).getBusinessName()).append("&").append(((RockDownloadInfo)localObject).getBusinessScene()).append("&").append(((RockDownloadInfo)localObject).getPackageName()).append("&").append(bfnn.a("0"));
      ...
      localHashMap.put("IMEI", bfnn.a("0"));
    ...
    try
    {
      ...
      {
        axqy.b((QQAppInterface)paramRockDownloaderTask.getRuntime(), "dc00898", "", ((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        axrn.a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).getApp()).a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
        ...
        axqy.b(null, "dc00898", "", paramRockDownloaderTask.getRuntime().getAccount(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        axrn.a(paramRockDownloaderTask.getRuntime().getApplication()).a(paramRockDownloaderTask.getRuntime().getAccount(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
    }
    catch (Throwable paramRockDownloaderTask)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          axqy.b(null, "dc00898", "", "", paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
          axrn.a(BaseApplicationImpl.context).a("", "RockDownloader", true, 0L, 0L, localHashMap, "");
        }
      }
  ...
  private static void d(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    {
      localamao = new amao(paramRockDownloaderTask, bool);
      Iterator localIterator = bdhk.a().a().values().iterator();
      ...
      bdhk.a().b(localDownloadInfo1);
      if (bool)
      {
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), ajya.a(2131713499), 10011);
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      }
      return;
    }
  ...
  {
    Object localObject = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), amas.class);
