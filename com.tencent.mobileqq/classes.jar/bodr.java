  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  private static final String l = bodr.class.getSimpleName();
  private boolean A;
  private boolean B;
  private boolean C;
  private boolean D;
  ...
  public bodr(bqai parambqai, bqah parambqah)
  {
    super(parambqai, parambqah);
    this.jdField_e_of_type_Int = -1;
    this.jdField_d_of_type_Int = 10001;
    this.jdField_a_of_type_Bqaa = new bqaa(this.jdField_d_of_type_Int, 122, 3);
  ...
  private void a(int paramInt, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      bmtd.a((String)localObject1, localArrayList, paramInt, (ArrayList)localObject2, i, this.jdField_f_of_type_Int, this.n, bool1, bool2, i, this.jdField_o_of_type_JavaLangString);
      a().finish();
      do
      {
        return;
  ...
  private void a(String paramString)
  {
    ...
    localBundle.putString("extra_publish_text", anzj.a(2131708714));
    ...
    this.jdField_a_of_type_Bqai.a().startActivityForResult(localIntent, 1014);
  }
  ...
  private void a(String paramString1, int paramInt1, String paramString2, String paramString3, String paramString4, int paramInt2, aluh paramaluh, String paramString5, int paramInt3, ArrayList<String> paramArrayList, boolean paramBoolean1, int paramInt4, int paramInt5, String paramString6, int paramInt6, String paramString7, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5)
  {
    ...
    localalus.jdField_a_of_type_AndroidAppActivity = a();
    ...
    for (localalus.jdField_i_of_type_Int = 0;; localalus.jdField_i_of_type_Int = this.jdField_c_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult.videoFrameCount)
    {
      localalus.jdField_j_of_type_Int = paramInt2;
      ...
      localalus.jdField_a_of_type_Boolean = this.C;
      localalus.jdField_j_of_type_JavaLangString = this.t;
      ...
      localalus.jdField_i_of_type_JavaLangString = paramString7;
      ...
      localalus.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo;
      localalus.jdField_h_of_type_Boolean = paramBoolean5;
      localalus.jdField_k_of_type_Int = this.jdField_b_of_type_AndroidOsBundle.getInt("entry_source", 0);
  ...
  private void ac()
  {
    ...
    bbnj.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult.videoMp4FilePath, str);
  ...
  private void ad()
  {
    if ((this.jdField_c_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult != null) && (this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null)) {
      a(this.jdField_c_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult.audioDataFilePath, 0, this.jdField_c_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult.videoMp4FilePath, this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.thumbnailPath, null, (int)this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration, this.jdField_a_of_type_Aluh, null, -1, null, false, this.jdField_e_of_type_Int, this.jdField_f_of_type_Int, this.n, this.jdField_g_of_type_Int, this.jdField_o_of_type_JavaLangString, false, false, false, false);
    }
  }
  ...
  private void b(int paramInt, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt = localPublishParam.jdField_f_of_type_Int;; paramInt = 0)
      {
        ...
        a(localPublishParam.jdField_k_of_type_JavaLangString, paramInt, localPublishParam.jdField_j_of_type_JavaLangString, localPublishParam.jdField_c_of_type_JavaLangString, localPublishParam.jdField_b_of_type_JavaLangString, k, this.jdField_a_of_type_Aluh, (String)localObject1, i, (ArrayList)localObject2, false, j, this.jdField_f_of_type_Int, this.n, this.jdField_g_of_type_Int, this.jdField_o_of_type_JavaLangString, bool1, bool2, false, bool3);
        this.F = true;
        return;
      }
    }
  ...
  private void b(bbhq parambbhq)
  {
    try
    {
      ...
      if ((parambbhq == null) || (TextUtils.isEmpty(parambbhq.jdField_a_of_type_JavaLangString)))
      {
        bjuh.a().a(anzj.a(2131708713));
        a().finish();
        return;
      }
    }
    catch (Exception parambbhq)
    {
      QLog.d(l, 2, "handlePic exception", parambbhq);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i(l, 2, "finishShotPhoto " + parambbhq.jdField_a_of_type_JavaLangString);
    }
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (a() != null)
      {
        if (i == 3)
        {
          ...
          bnjp.b(parambbhq.jdField_a_of_type_JavaLangString, d1, d2);
        }
        Intent localIntent;
        label334:
        String str;
        if (bool2)
        {
          localIntent = QzoneEditPictureActivity.a(a(), parambbhq.jdField_a_of_type_JavaLangString, bool1, i, i(), 0);
          ...
          alug.a(this.jdField_b_of_type_AndroidOsBundle.getInt("edit_video_type", -1), "", "0X8007818", null);
          parambbhq = SplashActivity.class.getName();
        ...
        for (;;)
        {
          ...
          if (bool2) {
            localIntent.putExtra("extra_publish_text", this.jdField_a_of_type_Bqai.a().getString(2131694706));
          }
          localIntent.putExtra("PhotoConst.PHOTO_SELECT_ACTIVITY_CLASS_NAME", parambbhq);
          localIntent.putExtra("key_activity_code", this.jdField_b_of_type_AndroidOsBundle.getString("key_activity_code"));
          this.jdField_a_of_type_Bqai.a().startActivityForResult(localIntent, 1012);
          alug.a("", "0X80075C1", "", "", "", "");
          return;
          localIntent = QzoneEditPictureActivity.a(a(), parambbhq.jdField_a_of_type_JavaLangString);
          break;
          label634:
          i = 1;
          break label334;
  ...
  private void b(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult)
  {
    ...
    if (a() != null)
    {
      ...
      this.jdField_a_of_type_Bqai.a().startActivityForResult(localIntent, 1016);
    }
  }
  ...
  private void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_AndroidAppProgressDialog = new ReportProgressDialog(a(), 2131755824);
  ...
  private void c(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aluh = new VideoComponentCallback();
      this.jdField_a_of_type_Aluh.c_(this.u);
  ...
  private void c(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        j = 1;
        if ((!TextUtils.isEmpty(this.t)) || ("ref_h5_record_video".equals(this.u)) || (k == 3) || (k == 5) || (j == 0) || (bnlj.a()) || (this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo != null)) {
          break label616;
        }
        i |= 0x10000;
        ...
        if (j == 0)
        {
          ...
          this.jdField_a_of_type_Bqai.a().startActivityForResult(paramLocalMediaInfo, 1011);
          this.jdField_a_of_type_Bqai.a().overridePendingTransition(0, 0);
          if (!QLog.isColorLevel()) {
            break label619;
          }
  ...
  private void d(Bundle paramBundle)
  {
    ...
    if ((bool2) && (bool1))
    {
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout.setRecordTipsWording(this.jdField_a_of_type_Bqai.a().getResources().getString(2131698404));
      i = 1;
    }
    for (;;)
    {
      ...
      for (j = k;; j = QzoneConfig.getInstance().getConfig("MiniVideo", "QzoneVideoMaxTime", 7))
      {
        ...
        if ((bool2) && (!bool1))
        {
          this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout.setRecordTipsWording(this.jdField_a_of_type_Bqai.a().getString(2131698412));
          i = 3;
          break;
        }
        if ((bool2) || (!bool1)) {
        ...
        i = 2;
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout.setRecordTipsWording(this.jdField_a_of_type_Bqai.a().getString(2131698403));
        break;
  ...
  public View a()
  {
    if ((this.jdField_a_of_type_Bqai != null) && (this.jdField_a_of_type_Bqai.a() != null) && (this.jdField_a_of_type_Bqai.a().getIntent() != null))
    {
      localObject = this.jdField_a_of_type_Bqai.a().getIntent();
  ...
  protected bbhn a()
  {
    ...
    for (int i = QzoneConfig.getInstance().getConfig("PhotoAlbum", "UseQQCameraCompression", 2);; i = 1)
    {
      ...
      for (;;)
      {
        alxc localalxc = bbgs.a().a(this.jdField_h_of_type_Int);
        bbhn localbbhn = new bbhn();
        localbbhn.a(localalxc.a());
        localbbhn.b(localalxc.b());
        localbbhn.a(bbgs.a().a(this.jdField_h_of_type_Int));
        i *= bbgs.a().a(this.jdField_h_of_type_Int) * 1000;
        localbbhn.j(i);
        bdbt.r = i;
        localbbhn.k(1);
        localbbhn.i(this.jdField_h_of_type_Int);
        return localbbhn;
        if (this.D) {
          this.jdField_h_of_type_Int = 1;
        } else {
          this.jdField_h_of_type_Int = bbgb.b();
        }
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      while (this.jdField_a_of_type_Aluh != null)
      {
        this.jdField_a_of_type_Aluh.a(a(), paramInt1, paramInt2, paramIntent);
        return;
  ...
  public void a(Activity paramActivity)
  {
    if (this.jdField_a_of_type_Aluh != null) {
      this.jdField_a_of_type_Aluh.a(paramActivity);
    }
  }
  ...
  public boolean a()
  {
    ...
    {
      yup.a("video_shoot_new", "time_waitshoot", yup.b(10001), i, new String[] { "", "1", "", "" });
      return bool;
    }
  }
  ...
  public void b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      yup.a("video_shoot_new", "time_openshoot", yup.b(10001), i, new String[] { str, localObject1, "", String.valueOf(k) });
      return;
      str = "0";
      break;
      bool1 = false;
  ...
  public void j()
  {
    ...
    for (int i = (int)(System.currentTimeMillis() - this.jdField_b_of_type_Long);; i = 0)
    {
      yup.a("video_shoot_new", "time_waitshoot", yup.b(10001), i, new String[] { "", "0", "", "" });
      return;
    }
  }
  ...
  {
    if (paramView.getId() == 2131370343) {
      a(this.jdField_a_of_type_Bqai.a());
    }
    for (;;)
    {
