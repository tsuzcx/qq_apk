...
public class mnk
{
  ...
  private LruCache<String, mnm> jdField_a_of_type_AndroidUtilLruCache = new mnl(this, 4194304);
  private LinkedList<mnn> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private mnn jdField_a_of_type_Mnn;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public mnk(int paramInt)
  {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        mnm localmnm = (mnm)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmnm != null)
        {
          this.jdField_a_of_type_Mnn = new mnn(localmnm, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (mnm)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Mnn = new mnn(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      mnn localmnn = this.jdField_a_of_type_Mnn;
      if (localmnn != null) {
        localmnn.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmnn = (mnn)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmnn != null)
        {
          int j = i + localmnn.a(this.b, i, paramInt);
          i = j;
          if (!localmnn.a()) {
            break label229;
          }
      ...
      {
        mno.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new mnm(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmnm != null)
        {
          paramString = new mnn(localmnm, false);
      ...
      if (paramString != null)
      {
        paramString = new mnn(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
