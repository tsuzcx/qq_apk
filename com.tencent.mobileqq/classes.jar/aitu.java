  ...
  extends Handler
{
  ...
  public aitu(SubmitHomeWorkFragment paramSubmitHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        ...
        if (SubmitHomeWorkFragment.a(paramSubmitHomeWorkFragment).isEmpty())
        {
          ...
          SubmitHomeWorkFragment.b(paramSubmitHomeWorkFragment).setHint(paramSubmitHomeWorkFragment.getActivity().getString(2131430632));
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (!NetworkUtil.d(localSubmitHomeWorkFragment.getActivity()))
    {
      ...
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), 2131430281, 0).a();
      SubmitHomeWorkFragment.b(localSubmitHomeWorkFragment, false);
      SubmitHomeWorkFragment.d(localSubmitHomeWorkFragment);
      return;
    }
