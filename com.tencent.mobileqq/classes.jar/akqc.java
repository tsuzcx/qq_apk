  ...
  extends akoo
{
  ...
  public akqc(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, axag paramaxag)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("wk", 2, "onReceive, MessageConstants.CMD_TRANSSERVICE_REQOFFFILEPACK: " + paramaxag.jdField_b_of_type_Byte);
      }
      if (paramaxag.jdField_b_of_type_Byte == 6)
      {
        e(paramToServiceMsg, paramFromServiceMsg, paramaxag);
        return;
      }
      if (paramaxag.jdField_b_of_type_Byte == 3)
      {
        d(paramToServiceMsg, paramFromServiceMsg, paramaxag);
        return;
      }
      if (paramaxag.jdField_b_of_type_Byte == 2)
      {
        c(paramToServiceMsg, paramFromServiceMsg, paramaxag);
        return;
      }
    } while (paramaxag.jdField_b_of_type_Byte != 1);
    b(paramToServiceMsg, paramFromServiceMsg, paramaxag);
  }
  ...
  private void a(msg_svc.PbSendMsgReq paramPbSendMsgReq, FMTransC2CMsgInfo paramFMTransC2CMsgInfo)
  {
    ...
    {
      return;
      paramFMTransC2CMsgInfo = aqvs.a(paramFMTransC2CMsgInfo.entity.getFilePath(), paramFMTransC2CMsgInfo.entity.imgWidth, paramFMTransC2CMsgInfo.entity.imgHeight, paramFMTransC2CMsgInfo.entity.strQRUrl);
  ...
  private void a(msg_svc.PbSendMsgReq paramPbSendMsgReq, FMTransC2CMsgInfo paramFMTransC2CMsgInfo, axav paramaxav)
  {
    long l1 = 0L;
    ...
    for (;;)
    {
      if ((paramaxav != null) && (paramaxav.jdField_a_of_type_ArrayOfByte != null)) {
        break label786;
      }
      if (!QLog.isColorLevel()) {
        break;
    ...
    paramPbSendMsgReq.msg_body.rich_text.trans_211_tmp_msg.bytes_msg_body.set(ByteStringMicro.copyFrom(paramaxav.jdField_a_of_type_ArrayOfByte));
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, axag paramaxag)
  {
    ...
    localakaw.b = paramFromServiceMsg.getResultCode();
    localakaw.c = i;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5004, true, new Object[] { paramaxag, localakaw });
  }
            ...
            if (QLog.isColorLevel())
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  {
                    akoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramObject.errmsg.get(), 1001, false, false);
                  ...
                  {
                    axqw.b((QQAppInterface)localObject1, "dc00899", "grp_lbs", "", "c2c_tmp", "no_send", 0, 0, paramObject, "" + i, "", "");
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, axag paramaxag)
  {
    ...
    localakaw.b = paramFromServiceMsg.getResultCode();
    localakaw.c = i;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5005, true, new Object[] { paramaxag, localakaw });
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, axag paramaxag)
  {
    ...
    {
      return;
      long l1 = paramaxag.jdField_c_of_type_Long;
      long l2 = paramaxag.d;
      long l3 = paramaxag.e;
      long l4 = paramaxag.jdField_b_of_type_Long;
      paramFromServiceMsg = paramaxag.jdField_b_of_type_JavaLangString;
      String str1 = paramaxag.jdField_c_of_type_JavaLangString;
      String str2 = paramToServiceMsg.extraData.getString("friendUin");
      boolean bool = paramToServiceMsg.extraData.getBoolean("isRead");
      Object localObject = "http://" + bbmj.b(l1) + "/?ver=" + "2" + "&rkey=" + paramFromServiceMsg;
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "<<---handleGetOffLineFileResp serverPath: " + (String)localObject + " strFileName: " + str1 + " time: " + paramaxag.d + " seq: " + paramaxag.jdField_a_of_type_Short);
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "friendUin:" + str2 + "  struct.senderUin: " + paramaxag.jdField_b_of_type_Long + " struct.time: " + paramaxag.d + " struct.seq: " + paramaxag.jdField_a_of_type_Short);
      }
      int i;
      if (axas.a(str1, paramaxag.jdField_a_of_type_Byte))
      {
        paramFromServiceMsg = aywi.a((String)localObject, l3, 1, false, (String)localObject);
        i = -2000;
      }
      while (paramFromServiceMsg != null)
      {
        localObject = axaq.a(i);
        ...
        ((MessageRecord)localObject).msgseq = paramaxag.jdField_a_of_type_Short;
        ((MessageRecord)localObject).shmsgseq = paramaxag.jdField_a_of_type_Short;
        ...
        return;
        if (axas.b(str1, paramaxag.jdField_a_of_type_Byte))
        {
          if (!str1.contains("_")) {}
          for (paramFromServiceMsg = str1.substring(0, str1.length() - 4);; paramFromServiceMsg = str1.substring(str1.lastIndexOf("_") + 1, str1.length() - 4))
          {
            ...
            if (!axue.e(paramFromServiceMsg)) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "is Duplicate key：" + paramFromServiceMsg);
            }
            axue.d(paramFromServiceMsg);
            return;
          }
          axue.c(paramFromServiceMsg);
          paramFromServiceMsg = aywi.a((String)localObject, l3, 2, false);
          i = -2002;
        }
        else
        {
          ...
          paramFromServiceMsg = aywi.a(aypf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str1, 0, null), l3, 0, false, (String)localObject);
          i = -2005;
        }
      }
    }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, axag paramaxag)
  {
    if (paramaxag == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, paramFromServiceMsg);
    ...
    localakaw.b = paramFromServiceMsg.getResultCode();
    localakaw.c = i;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5003, true, new Object[] { paramaxag.jdField_a_of_type_ArrayOfByte, localakaw });
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 7001: 
      ...
      {
        a((ToServiceMsg)paramVarArgs[0], (FromServiceMsg)paramVarArgs[1], (axag)paramVarArgs[2]);
        return;
      }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5003, false, new Object[] { paramFromServiceMsg, localakaw });
        return;
      }
      if (paramToServiceMsg.extraData.getInt("offfile_type") == 2)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5005, false, new Object[] { paramFromServiceMsg, localakaw });
        return;
      }
    } while (paramToServiceMsg.extraData.getInt("offfile_type") != 3);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5004, false, new Object[] { paramFromServiceMsg, localakaw });
  }
  ...
  public boolean a(String paramString, int paramInt, byte[] paramArrayOfByte, FMTransC2CMsgInfo paramFMTransC2CMsgInfo)
  {
    ...
    a(true, true, true, l, new akqd(this, paramString, paramFMTransC2CMsgInfo, paramInt, paramArrayOfByte));
    return true;
  }
  ...
  public boolean a(String paramString, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    awyl.a = i + 1;
    long l = i;
    a(true, true, true, l, new akqe(this, paramString, paramLong, Math.abs(new Random().nextInt()), l, paramInt, paramArrayOfByte));
    return true;
  }
