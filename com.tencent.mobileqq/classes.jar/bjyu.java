  ...
  implements bjur, IEventReceiver
{
  ...
  {
    a(bjur.class, this);
    if ((this.jdField_a_of_type_Bjxn.a.a instanceof EditLocalPhotoSource)) {
    ...
    for (;;)
    {
      ...
      {
        localObject = ((bjcb)bjav.a(5)).a;
        if (localObject != null)
        {
          localObject = ((bkrg)localObject).a();
          a(Integer.parseInt(((TransitionCategoryItem)localObject).a));
          bkrf.a().a((TransitionCategoryItem)localObject);
          localObject = (bjtw)a(bjtw.class);
          if ((localObject != null) && (!(this.jdField_a_of_type_Bjxn instanceof bkpw))) {
            ((bjtw)localObject).b();
          }
        }
        if (AudioHelper.f()) {
      ...
      vei.a("video_edit_transition", "exp_transition", a(this.jdField_a_of_type_Bjxn.a.a("extra_transiton_src_from", -1)), 0, new String[0]);
      return;
      if ((this.jdField_a_of_type_Bjxn.a.a instanceof EditLocalVideoSource))
      {
        this.jdField_a_of_type_Int = 3;
      }
      else if ((this.jdField_a_of_type_Bjxn.a.a instanceof EditTakeVideoSource))
      {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoVideotransferTransferData.setPositions(((EditTakeVideoSource)this.jdField_a_of_type_Bjxn.a.a).a.mTransferPosList);
        if (this.jdField_a_of_type_Bjxn.a.a("extra_transiton_src_from", -1) == 1) {
          this.jdField_a_of_type_Int = 0;
        } else {
          a(((EditTakeVideoSource)this.jdField_a_of_type_Bjxn.a.a).a.mDuration);
        }
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (c())
    {
      ...
      if (localObject != null) {
        ((bjxx)localObject).a(this.jdField_a_of_type_ComTencentMobileqqShortvideoVideotransferTransferData);
      }
    }
  }
  ...
  public void a(int paramInt, @NonNull bkld parambkld)
  {
    ...
    parambkld.a.putExtra("transfer_effect_data", str);
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Int == 1) {
      bcql.a(a(), 2131720391, 0).a();
    }
    while (this.jdField_a_of_type_Int != 2) {
      return;
    }
    bcql.a(a(), 2131720390, 0).a();
  }
