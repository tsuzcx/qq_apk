...
public class akjb
  extends akhu
{
  protected akjb(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("PhotoListActivity", 2, "PhotoListLogicDataline isConfirmed=" + paramBoolean + " allowUploadInXGTime=" + bcec.b);
        }
        if ((!bgnt.b(BaseApplicationImpl.getContext())) || (paramBoolean) || (i == 0)) {
          break;
        }
        paramArrayList = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131717742);
        paramIntent = new PhotoListLogicDataline.1(this, paramIntent, i2, (String)localObject1, (String)localObject2);
        if (bigl.a(this.mActivity, 4, new akjc(this, paramIntent))) {
          bglp.a(this.mActivity, 232, null, paramArrayList, new akjd(this, paramIntent), new akje(this)).show();
        }
        if (QLog.isColorLevel()) {
      ...
      bcst.b(null, "CliOper", "", "", "0X8009AB0", "0X8009AB0", i2, 0, (String)localObject1, (String)localObject2, "", "");
      return;
    }
  }
}
