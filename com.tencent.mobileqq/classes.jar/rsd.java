  ...
  implements RecyclerView.OnItemTouchListener
{
  ...
  private rsd(VideoFeedsRecommendFragment paramVideoFeedsRecommendFragment) {}
  ...
  public void onScrolled(RecyclerView paramRecyclerView, int paramInt1, int paramInt2)
  {
    ...
    if (paramRecyclerView != null)
    {
      ...
      if ((paramRecyclerView instanceof roj)) {
        ((roj)paramRecyclerView).a(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), true);
      }
      if ((localViewHolder1 instanceof roj)) {
        ((roj)localViewHolder1).a(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), false);
      }
      if ((localViewHolder2 instanceof roj)) {
        ((roj)localViewHolder2).a(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), false);
      }
    }
  }
