...
public class bmxw
{
  ...
  public static final int[] g = { 108, 2130844425, 2130844425, 2131373891 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 106, 2130849570, 2130849570, 2131373886 };
    jdField_b_of_type_ArrayOfInt = new int[] { 101, 2130849571, 2130849571, 2131373887 };
    jdField_c_of_type_ArrayOfInt = new int[] { 102, 2130849573, 2130849573, 2131373890 };
    jdField_d_of_type_ArrayOfInt = new int[] { 103, 2130849574, 2130849574, 2131373889 };
    jdField_e_of_type_ArrayOfInt = new int[] { 104, 2130849572, 2130849572, 2131373888 };
    jdField_f_of_type_ArrayOfInt = new int[] { 105, 2130849569, 2130849569, 2131373885 };
  }
  
  public bmxw(int paramInt)
  {
  ...
  public ProviderView a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        ((ProviderView)localObject1).setId(2131364206);
        continue;
        localObject1 = localObject2;
        if (this.jdField_c_of_type_Boolean)
        {
          localObject1 = new QIMFilterProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131364208);
          continue;
          localObject1 = new StaticStickerProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131364217);
          continue;
          ...
          if (this.jdField_f_of_type_Boolean)
          {
            ...
            ((ProviderView)localObject1).setId(2131364216);
            continue;
            localObject1 = localObject2;
