...
class bmxw
  implements bmyw<WeiyunPB.DiskFileBatchDownloadMsgRsp>
{
  bmxw(bmxv parambmxv, bmyy parambmyy, bmzq parambmzq, DownloadType paramDownloadType) {}
  
  public void a(int paramInt, String paramString, WeiyunPB.DiskFileBatchDownloadMsgRsp paramDiskFileBatchDownloadMsgRsp)
  {
    this.jdField_a_of_type_Bmzq.a(this.jdField_a_of_type_Bmyy, false, paramInt, paramString);
  }
  ...
  public void a(WeiyunPB.DiskFileBatchDownloadMsgRsp paramDiskFileBatchDownloadMsgRsp)
  {
    ...
    if ((paramDiskFileBatchDownloadMsgRsp != null) && (paramDiskFileBatchDownloadMsgRsp.file_list != null))
    {
      ...
      } while ((paramDiskFileBatchDownloadMsgRsp == null) || (!TextUtils.equals(paramDiskFileBatchDownloadMsgRsp.file_id.get(), this.jdField_a_of_type_Bmyy.jdField_a_of_type_JavaLangString)));
    }
    for (;;)
    {
      if (paramDiskFileBatchDownloadMsgRsp == null)
      {
        this.jdField_a_of_type_Bmzq.a(this.jdField_a_of_type_Bmyy, false, 1828004, anni.a(2131713747));
        return;
      }
      ...
      {
        this.jdField_a_of_type_Bmyy.a(paramDiskFileBatchDownloadMsgRsp.server_name.get(), paramDiskFileBatchDownloadMsgRsp.server_port.get(), (String)localObject, paramDiskFileBatchDownloadMsgRsp.download_url.get(), paramDiskFileBatchDownloadMsgRsp.video_url.get(), "0");
        if (this.jdField_a_of_type_CooperationWeiyunSdkDownloadDownloadType == DownloadType.FILE_ORDINARY) {
          this.jdField_a_of_type_Bmyy.jdField_a_of_type_Bmza.c = bmzb.a(this.jdField_a_of_type_Bmyy.jdField_a_of_type_Bmza.c);
        }
        this.jdField_a_of_type_Bmzq.a(this.jdField_a_of_type_Bmyy, true, 0, null);
        return;
      }
