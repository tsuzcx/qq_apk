...
public class auzm
{
  ...
  public auzm()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new auzn(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), this);
  }
  ...
  private void b(String paramString)
  {
    ...
    if (awje.o == 16)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaFormat.setInteger("bitrate", awje.n);
      ...
      if (!paramString.exists()) {
        bace.c(paramString.getAbsolutePath());
      }
  ...
  void a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Auzo != null) {
        this.jdField_a_of_type_Auzo.h();
      }
      return;
    }
