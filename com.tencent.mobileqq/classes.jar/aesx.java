...
public class aesx
{
  public static void a(bcvr parambcvr, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (parambcvr != null)
    {
      ...
      localObject2 = parambcvr.a(6);
      if (parambcvr == null) {
        break label697;
      }
      localQZoneCountInfo1 = parambcvr.a(61);
      if (parambcvr == null) {
        break label703;
      }
      localQZoneCountInfo2 = parambcvr.a(3);
      label149:
      k = i1;
      i = j;
      parambcvr = (bcvr)localObject1;
          ...
          if (((QZoneCountInfo)localObject2).friendList.size() > 0)
          {
            ...
            if (((QZoneCountUserInfo)((QZoneCountInfo)localObject2).friendList.get(0)).uin > 0L)
            {
              ...
              if (((QZoneCountInfo)localObject2).uCount > 0L)
              {
                ...
                {
                  parambcvr = ((QZoneCountInfo)localObject2).strShowMsg;
                  k = 1;
                  i = 1;
                }
              }
      ...
      parambcvr = localQZoneCountInfo2.strShowMsg;
      n = 1;
      m = 1;
      k = i;
      i = n;
    ...
    for (;;)
    {
        ...
        if (i3 <= 0) {
          if (i2 <= 0) {
            if (paramBoolean1)
            {
              ...
              parambcvr = "1";
              label665:
              LpReportInfo_pf00064.report(637, 13, i, parambcvr, "0", null);
            }
          }
        }
      }
      ...
      do
      {
        ...
        {
          LpReportInfo_pf00064.report(637, 11, i, parambcvr, (String)localObject1, null);
          return;
          i = 2;
          break;
          parambcvr = "2";
        ...
        if (i2 <= 0)
        {
          ...
          for (parambcvr = "1";; parambcvr = "2")
          {
            LpReportInfo_pf00064.report(637, 12, i, parambcvr, "0", null);
            return;
            i = 2;
            break;
          }
        ...
        for (localObject1 = "2";; localObject1 = "1")
        {
          LpReportInfo_pf00064.report(637, 14, i, parambcvr, (String)localObject1, null);
          return;
          i = 2;
          break;
          parambcvr = "2";
        ...
        if (m != 0)
        {
          ...
          {
            LpReportInfo_pf00064.report(637, 15, i, (String)localObject1, null, parambcvr);
            return;
            i = 2;
            break;
          }
        ...
        if (k != 0)
        {
          ...
          for (localObject1 = "1";; localObject1 = "2")
          {
            LpReportInfo_pf00064.report(637, 17, i, (String)localObject1, null, parambcvr);
            return;
            i = 2;
            break;
          }
      ...
      for (localObject1 = "1";; localObject1 = "2")
      {
        LpReportInfo_pf00064.report(637, 16, i, (String)localObject1, null, parambcvr);
        return;
        i = 2;
        break;
      }
