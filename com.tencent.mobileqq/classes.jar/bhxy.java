...
public class bhxy
  extends bhxx
  implements bhxp, QGRenderer.QGEventListener
{
  private volatile int jdField_a_of_type_Int = 1;
  private alaa jdField_a_of_type_Alaa;
  private bdsm jdField_a_of_type_Bdsm = new bhxz(this);
  private bhya jdField_a_of_type_Bhya;
  private bhyc jdField_a_of_type_Bhyc;
  ...
  public bhxy(Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_b_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Bhyc == null) || (!bdsn.b.get()))
    {
      QZLog.i("VipARQGThreeController", 1, "checkInValid mVipQGViewConfig = " + this.jdField_a_of_type_Bhyc + " so status = " + bdsn.b.get());
      return true;
    }
    return false;
  }
  ...
  public void a(bhyc parambhyc)
  {
    ...
    if ((this.jdField_a_of_type_Bhyc != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bhyc.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.i("VipARQGThreeController", 2, " setVipQGViewConfig config = " + parambhyc.toString());
      }
      localObject = new amwr();
      ((amwr)localObject).b = parambhyc.jdField_a_of_type_JavaLangString;
      ((amwr)localObject).c = parambhyc.c;
      bhyk.a().a((amwr)localObject, this);
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Bhyc != null) {
      this.jdField_a_of_type_Bhyc.b = paramString;
    }
    QZLog.i("VipARQGThreeController", 1, "qg resources load success path = " + paramString + " soStatus = " + bdsn.b.get());
  }
  ...
  {
    QZLog.i("VipARQGThreeController", 1, "qg resources load fail error = " + paramString + " soStatus = " + bdsn.b.get());
    if (this.jdField_a_of_type_Bhyc != null) {
      this.jdField_a_of_type_Bhyc.b = "";
    }
  }
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.getModuleEngine().unRegisterJsModule(this.jdField_a_of_type_Bhya);
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            return;
          } while ((this.jdField_a_of_type_Bhyc == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Bhyc.b)) || (this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView == null));
      ...
      } while (!this.jdField_a_of_type_Bhyc.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Int = 4;
      return;
    } while ((this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView == null) || (!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Alaa == null) || (paramGL10 == null));
    int i = this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.getCanvasTexture("offScreen");
    if (i != 0)
    {
      GLES20.glEnable(3042);
      GLES20.glBlendFunc(1, 771);
      this.jdField_a_of_type_Alaa.a(i, null, null);
      if (this.c)
      {
        bhye.a("ar_qg_show", "1");
        this.c = false;
  ...
  {
    if (this.jdField_a_of_type_Alaa != null) {
      this.jdField_a_of_type_Alaa.a(paramInt1, paramInt2);
    }
  }
  
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    this.jdField_a_of_type_Alaa = new alaa();
