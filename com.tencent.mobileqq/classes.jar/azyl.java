  ...
  implements Manager
{
  ...
  private ArrayList<bdfq> jdField_a_of_type_JavaUtilArrayList;
  ...
  private ArrayList<azyp> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public azyl(QQAppInterface paramQQAppInterface)
  {
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    azyl localazyl = (azyl)paramQQAppInterface.getManager(62);
    if (localazyl != null) {}
    for (int i = localazyl.a(paramQQAppInterface.c() + "_all_third_last_msg_time");; i = 0)
    {
      if (QLog.isColorLevel()) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, abol paramabol)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramabol == null))
    {
      i = 0;
      return i;
    }
    ...
    if (localazyu != null)
    {
      Iterator localIterator = localazyu.b().iterator();
      i = 0;
      j = i;
      ...
      if ((localObject == null) || (TextUtils.isEmpty(((SubAccountInfo)localObject).subuin)) || (localazyu.a(((SubAccountInfo)localObject).subuin) != 1)) {
        break label238;
      }
    }
    label179:
    label191:
    label238:
    for (int j = paramabol.a(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      j = localazyl.a(paramQQAppInterface.c() + "_" + paramString + "_msgNum");
      i = j;
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    paramQQAppInterface = (azyl)paramQQAppInterface.getManager(62);
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        i = ((Integer)((azyp)localObject).jdField_a_of_type_JavaLangObject).intValue();
        return i;
      }
      ...
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new azyp(paramString, Integer.valueOf(i)));
        }
        return i;
      }
      return 0;
  ...
  private azyp a(String paramString)
  {
    if (this.jdField_c_of_type_JavaUtilArrayList != null) {
      try
      {
        ...
        while (i < j)
        {
          ...
          for (azyp localazyp = (azyp)this.jdField_c_of_type_JavaUtilArrayList.get(i); localazyp != null; localazyp = null)
          {
            boolean bool = TextUtils.equals(localazyp.jdField_a_of_type_JavaLangString, paramString);
            if (!bool) {
              break;
            }
            return localazyp;
  ...
  public static azyq a(QQAppInterface paramQQAppInterface, String paramString)
  {
    azyq localazyq = new azyq();
    ...
    if (i > 0)
    {
      localazyq.jdField_a_of_type_Int = i;
      return localazyq;
    }
    ...
    {
      localazyq.jdField_a_of_type_Int = i;
      localazyq.jdField_a_of_type_Boolean = true;
    }
    return localazyq;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      paramQQAppInterface = bdbt.b(paramQQAppInterface, paramString2, true);
      ...
      continue;
      paramString1 = localBaseApplication.getString(2131719163);
      continue;
      paramString1 = localBaseApplication.getString(2131689703);
    }
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        paramString = (String)((azyp)localObject).jdField_a_of_type_JavaLangObject;
        return paramString;
      }
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("qq_subaccount_associated_cache", 0);
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new azyp(paramString, localObject));
        }
        return localObject;
      }
      return "";
  ...
  public static ArrayList<String> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localazyl != null)
    {
      ...
      localazyl.jdField_b_of_type_JavaUtilConcurrentLocksLock.lock();
    }
    for (;;)
    {
      try
      {
        azyp localazyp = localazyl.a(paramString);
        if (localazyp != null)
        {
          localArrayList.addAll((ArrayList)localazyp.jdField_a_of_type_JavaLangObject);
          localazyl.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (QLog.isColorLevel()) {
        ...
        {
          localazyl.jdField_c_of_type_JavaUtilArrayList.add(new azyp(paramString, localArrayList));
          continue;
        }
        i += 1;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject2 = (azyu)paramQQAppInterface.getManager(61);
      } while (localObject2 == null);
      long l1 = bdbx.a().a(paramQQAppInterface.getApp());
      long l2 = aowf.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (l1 < l2)
      {
        if (l1 == 0L)
        {
          ...
          bool = bdbx.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
          localObject1 = ((azyu)localObject2).a("sub.uin.default");
          if ((localObject1 != null) && (((SubAccountInfo)localObject1).subuin != null))
          {
            ((azyu)localObject2).h(((SubAccountInfo)localObject1).subuin);
            i = ((azyu)localObject2).c(((SubAccountInfo)localObject1).subuin) - paramQQAppInterface.a().a(((SubAccountInfo)localObject1).subuin, 7000);
            if (i != 0)
            {
              paramQQAppInterface.a().d(((SubAccountInfo)localObject1).subuin, 7000, i);
              paramQQAppInterface.a().a(new String[] { aljq.x, ((SubAccountInfo)localObject1).subuin });
            }
            if (bool)
            {
              if (QLog.isColorLevel()) {
          ...
          bdbx.a().a(paramQQAppInterface.getApp());
        }
      }
      else
      {
        if (!bdbx.a().b(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "initAllData() showedBefore:false, isFirstTime to user SubAccount.");
          }
          bdbx.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), true);
          a(paramQQAppInterface, 7);
        }
        localObject1 = paramQQAppInterface.a().a();
        localObject3 = ((amjk)localObject1).b(aljq.x, 7000);
        if (((azyu)localObject2).a() <= 0) {
          break label788;
        }
        if (QLog.isColorLevel()) {
          QLog.d("SUB_ACCOUNT", 2, "initAllData() getBindedNumber > 0, go to initAllData");
        }
        localObject4 = ((azyu)localObject2).b();
      ...
      for (;;)
      {
        ...
        if ((localObject3 != null) && (l1 == 0L))
        {
          ...
          if (localObject2 != null) {
            j = ((azyu)localObject2).c(localSubAccountInfo.subuin);
          }
          int n = j - m;
          if (QLog.isColorLevel()) {
          ...
          if (n != 0)
          {
            ...
            paramQQAppInterface.a().a(new String[] { aljq.x, localSubAccountInfo.subuin });
          }
        }
        bool = false;
        ...
        if (bool) {
          paramQQAppInterface.getSubAccountKey(paramQQAppInterface.getAccount(), localSubAccountInfo.subuin, new azym(paramQQAppInterface));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "initAllData() delete subaccount recentuser, add default subaccount box");
      }
      Object localObject2 = ((azyu)localObject2).b();
      int j = ((ArrayList)localObject2).size();
      int i = 0;
      if (i < j)
      {
        localObject3 = (SubAccountInfo)((ArrayList)localObject2).get(i);
        if ((localObject3 == null) || (aljq.x.equals(((SubAccountInfo)localObject3).subuin))) {}
        for (;;)
        {
          i += 1;
          break;
          localObject3 = ((amjk)localObject1).b(((SubAccountInfo)localObject3).subuin, 7000);
          if (localObject3 != null) {
            ((amjk)localObject1).b((RecentUser)localObject3);
          }
        }
      }
      localObject2 = ((amjk)localObject1).b(aljq.x, 7000);
      ...
      {
        a(paramQQAppInterface, (amjk)localObject1, aljq.x, 7);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte paramByte, ArrayList<String> paramArrayList)
  {
    ...
    for (paramArrayList = (String)localIterator.next();; paramArrayList = null)
    {
      try
      {
        ...
        Object localObject2 = (azyu)paramQQAppInterface.getManager(61);
        if (localObject2 == null) {
          continue;
        }
        paramArrayList = ((azyu)localObject2).a(paramArrayList);
        if (paramArrayList == null)
        {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          long l1 = 0L;
          continue;
          paramArrayList = bdcv.a(paramArrayList);
          continue;
          label377:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      for (;;)
      {
        ...
        if ((localRecentUser != null) && (localRecentUser.getType() == 7000) && (!aljq.x.equals(localRecentUser.uin)))
        {
          if (QLog.isColorLevel()) {
    ...
    a(paramQQAppInterface, localamjk, aljq.x, i);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, amjk paramamjk, String paramString, int paramInt)
  {
    int i = 1;
    if (QLog.isColorLevel()) {
    ...
    if ((paramString == null) || (paramString.length() == 0) || (paramInt == 0)) {
      if (QLog.isColorLevel())
      {
        paramamjk = new StringBuilder().append("updateRecentUser() return,");
        if (paramString != null) {
          break label103;
        }
    ...
    do
    {
      ...
      {
        localRecentUser = paramamjk.b(paramString, 7000);
        if (localRecentUser != null) {
          paramamjk.b(localRecentUser);
        }
      }
      localRecentUser = paramamjk.b(aljq.x, 7000);
      if (localRecentUser != null) {
        break label657;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, RecentItemSubAccount paramRecentItemSubAccount, MsgSummary paramMsgSummary)
  {
    ...
    {
      return;
      localazyu = (azyu)paramQQAppInterface.getManager(61);
      if (localazyu != null) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    ArrayList localArrayList = localazyu.b();
    Object localObject1 = new ArrayList();
    ...
    {
      paramMsgSummary.strContent = paramContext.getString(2131720422);
      if (QLog.isColorLevel()) {
    ...
    int k = a(paramQQAppInterface, localabol);
    int m = b(paramQQAppInterface, localabol);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localSubAccountInfo == null) || (TextUtils.isEmpty(localSubAccountInfo.subuin)) || (localazyu.a(localSubAccountInfo.subuin) != 1)) {
          continue;
        }
        localObject8 = localazyu.a(localSubAccountInfo.subuin);
        ...
        if (localObject8 != null)
        {
          ...
          if (((List)localObject8).size() > 0)
          {
            ...
            localObject6 = null;
            if (!aljq.aD.equals(((SubAccountMessage)localObject7).senderuin)) {
              break label1381;
            }
        ...
        if (((azyq)localObject1).jdField_a_of_type_Boolean)
        {
          i = ((azyq)localObject1).jdField_a_of_type_Int + i;
          break label1362;
        }
        j = ((azyq)localObject1).jdField_a_of_type_Int + j;
        break label1362;
        if ((localObject1 != null) && (localObject3 != null))
        {
          paramMsgSummary.strContent = paramContext.getString(2131720361);
          ...
          localObject4 = (aonj)aogj.a().a(607);
          if ((j <= 0) && ((j != 0) || (i != 0))) {
            continue;
          }
          ...
          if (((((SubAccountMessage)localObject3).mEmoRecentMsg == null) || (((SubAccountMessage)localObject3).mEmoRecentMsg.length() == 0)) && (((SubAccountMessage)localObject3).msg != null)) {
            ((SubAccountMessage)localObject3).mEmoRecentMsg = new baig(((SubAccountMessage)localObject3).msg, 3, 16);
          }
          ...
          paramRecentItemSubAccount.mMsgExtroInfo = ("[" + paramContext.getString(2131717857) + "]");
      ...
      catch (Throwable localThrowable)
      {
        ...
        if ((k > 0) && (localabol != null))
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            i = localabol.a(((SubAccountInfo)localObject3).subuin, 7000);
            if (i > 0)
            {
            ...
            paramMsgSummary.strContent = ((CharSequence)localObject6);
            continue;
            if ((i <= 0) || (localObject4 == null) || (((aonj)localObject4).jdField_a_of_type_Boolean)) {
              break;
            }
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
    ...
    localObject1 = paramBaseActivity.getString(2131720428);
    Object localObject2 = paramBaseActivity.getString(2131720389, new Object[] { Integer.valueOf(2) });
    localObject1 = bdcd.a(paramBaseActivity, 230).setTitle((String)localObject1).setMessage((CharSequence)localObject2);
    ((bdfq)localObject1).setOwnerActivity(paramBaseActivity);
    ((bdfq)localObject1).setPositiveButton(paramBaseActivity.getString(2131720409), new azyo(paramQQAppInterface, paramBaseActivity));
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      paramString = (azyu)paramQQAppInterface.getManager(61);
      if (paramString == null) {
        break label183;
      }
    }
      ...
      if (paramString != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if (!"sub.uin.all".equals(localObject))
          {
            ...
            if (paramQQAppInterface != null)
            {
              localObject = (azyu)paramQQAppInterface.getManager(61);
              if (localObject != null)
              {
                ((azyu)localObject).a(paramString);
                ((azyu)localObject).d(paramString);
                if (bdbt.c(paramQQAppInterface, paramString, false) != null) {
                  break;
                }
              }
            }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((!aljq.x.equals(paramString)) && ((paramString == null) || (paramString.length() < 5))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      return;
      amjk localamjk = paramQQAppInterface.a().a();
      if ((localamjk.b(aljq.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      a(paramQQAppInterface, localamjk, paramString, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localazyl = (azyl)paramQQAppInterface.getManager(62);
    } while (localazyl == null);
    ...
    for (;;)
    {
      try
      {
        paramString2 = localazyl.a(paramString1);
        ...
        if (paramString2 != null) {
          ...
          localazyl.jdField_c_of_type_JavaUtilArrayList.add(new azyp(paramString1, localArrayList));
        }
      }
      finally
      {
    ...
    localazyl.a(paramString1 + "_sysTime", Integer.valueOf(paramInt1));
    localazyl.jdField_b_of_type_Long = paramInt2;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      do
      {
        ...
        paramString1 = (azyl)paramQQAppInterface.getManager(62);
      } while (paramString1 == null);
      paramQQAppInterface = paramQQAppInterface.c() + "_" + paramString2;
      paramString2 = bdlr.a(paramArrayOfByte);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (aljq.x.equals(paramString)) {
      if (paramBoolean) {
        a(paramQQAppInterface, paramQQAppInterface.a().a(), aljq.x, 7);
      }
    }
    for (;;)
    {
      ...
      paramQQAppInterface.sendEmptyMessage(1009);
      return;
      ((azyu)paramQQAppInterface.getManager(61)).a(paramString, paramBoolean);
      amjk localamjk = paramQQAppInterface.a().a();
      if (paramBoolean) {
        a(paramQQAppInterface, localamjk, paramString, 4);
      } else {
        a(paramQQAppInterface, localamjk, paramString, 5);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((((amjk)localObject).b(aljq.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      ...
      while (paramArrayList.hasNext())
      {
        ...
        a(paramQQAppInterface, (amjk)localObject, str, paramInt);
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    localazyl.a(paramQQAppInterface.c() + "_display_third_qq_checked", String.valueOf(paramBoolean));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localazyu != null) && (paramQQAppInterface != null))
      {
        Iterator localIterator = localazyu.a().iterator();
        while (localIterator.hasNext())
        {
          String str = (String)localIterator.next();
          if (!TextUtils.isEmpty(str))
          {
            int i = localazyu.c(str);
            localazyu.b(str);
            if ((paramBoolean) || (i > 0))
            {
              if (QLog.isColorLevel()) {
              ...
              amgw localamgw = paramQQAppInterface.a();
              if (localamgw != null) {
                localamgw.a(str, paramString);
              }
            }
          }
        }
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          ...
          localazyu = (azyu)paramQQAppInterface.getManager(61);
          paramQQAppInterface = (MessageHandler)paramQQAppInterface.a(0);
        } while ((localazyu == null) || (paramQQAppInterface == null));
        i = localazyu.c(paramString2);
        localazyu.b(paramString2);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    azyl localazyl = (azyl)paramQQAppInterface.getManager(62);
    if (localazyl != null) {
      return localazyl.a(paramQQAppInterface.c() + "_all_third_last_msg_time", Integer.valueOf(paramInt));
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, SimpleAccount paramSimpleAccount)
  {
    ...
    paramSimpleAccount = localazyl.a(paramQQAppInterface + "_last_cookie");
    if (!TextUtils.isEmpty(paramSimpleAccount)) {
      localazyl.a(paramQQAppInterface + "_cookie", paramSimpleAccount);
    }
    localazyl.a(paramQQAppInterface + "_msgNum", Integer.valueOf(0));
    localazyl.a(paramQQAppInterface + "_msgFlag", Integer.valueOf(0));
    localazyl.a(paramQQAppInterface + "_redBagTime", Integer.valueOf(0));
    if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      localObject = ((azyu)localObject).a();
      label45:
      paramQQAppInterface = (azyl)paramQQAppInterface.getManager(62);
      bool1 = bool2;
      if (paramQQAppInterface != null) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    label381:
    for (Object localObject = ((azyu)localObject).a(paramString);; localObject = null)
    {
      azyr localazyr = (azyr)paramQQAppInterface.getManager(28);
      if (localazyr != null)
      {
        paramBoolean = localazyr.a();
        if (!paramBoolean)
        {
          localObject = new azyv();
          ((azyv)localObject).jdField_a_of_type_JavaLangString = "";
          ((azyv)localObject).b = paramQQAppInterface.getAccount();
          ((azyv)localObject).c = paramString;
          ((azyv)localObject).jdField_a_of_type_Int = 1009;
      ...
      if ((paramString == null) || (paramString.length() == 0) || (localObject == null) || (((String)localObject).length() == 0) || (((String)localObject).trim().equals("")))
      {
        ...
        ((azyv)localObject).b = paramQQAppInterface.getAccount();
        ((azyv)localObject).c = paramString;
        ((azyv)localObject).jdField_a_of_type_Int = 1010;
        paramQQAppInterface.a().notifyUI(8003, false, localObject);
        return false;
      }
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (localazyl != null)
    {
      if (!localazyl.jdField_b_of_type_Boolean) {
        return false;
      }
      if (BaseActivity.mAppForground)
      {
        bool = localazyl.d(paramQQAppInterface, paramBoolean);
        paramBoolean = bool;
        if (bool) {
          localazyl.b(paramQQAppInterface);
        }
      }
      for (paramBoolean = bool;; paramBoolean = bool)
      {
        if ((!paramBoolean) && (localazyl.jdField_c_of_type_JavaLangRunnable != null)) {
          ThreadManager.getSubThreadHandler().removeCallbacks(localazyl.jdField_c_of_type_JavaLangRunnable);
        }
        return paramBoolean;
        localazyl.jdField_a_of_type_Boolean = true;
      }
    }
    return false;
  }
  ...
  private boolean a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject == null)
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(new azyp(paramString, paramObject));
          bool1 = true;
          this.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          bool2 = bool1;
          if (!bool1) {
        ...
        if (((paramObject instanceof Integer)) && ((((azyp)localObject).jdField_a_of_type_JavaLangObject instanceof Integer)))
        {
          if ((Integer)((azyp)localObject).jdField_a_of_type_JavaLangObject == (Integer)paramObject) {
            break label346;
          }
          bool2 = true;
          bool1 = bool2;
          ...
          ((azyp)localObject).jdField_a_of_type_JavaLangObject = paramObject;
          bool1 = bool2;
          continue;
        }
      ...
      if ((((azyp)localObject).jdField_a_of_type_JavaLangObject instanceof String))
      {
        bool1 = TextUtils.equals((String)((azyp)localObject).jdField_a_of_type_JavaLangObject, (String)paramObject);
        if (!bool1)
        {
          bool2 = true;
          continue;
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localazyl != null)
    {
      paramQQAppInterface = localazyl.a(paramQQAppInterface.c() + "_" + paramString + "_cookie");
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        return bdlr.a(paramQQAppInterface);
      }
    }
    return null;
  }
  
  public static int b(QQAppInterface paramQQAppInterface, abol paramabol)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramabol == null))
    {
    ...
    label192:
    label240:
    for (int j = paramabol.b(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
      StringBuilder localStringBuilder;
      if (QLog.isColorLevel())
      {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      paramString = (azyl)paramQQAppInterface.getManager(62);
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject1 = (azyl)paramQQAppInterface.getManager(62);
        if (localObject1 == null) {
          break label110;
        }
        l1 = System.currentTimeMillis();
        l2 = (l1 - ((azyl)localObject1).jdField_c_of_type_Long) / 1000L;
        if (l2 >= ((azyl)localObject1).jdField_b_of_type_Long) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("SUB_ACCOUNT", 2, "getSubAccountSpecialCareListFromService skip adviseGap=" + ((azyl)localObject1).jdField_b_of_type_Long + "  realGap=" + l2);
      return;
      ((azyl)localObject1).jdField_c_of_type_Long = l1;
      localObject1 = (azyu)paramQQAppInterface.getManager(61);
    } while (localObject1 == null);
    Object localObject2 = new ArrayList();
    if (paramBoolean) {
      ((List)localObject2).addAll(((azyu)localObject1).b());
    }
    for (;;)
    {
      ...
      break;
      ((List)localObject2).add(((azyu)localObject1).a(paramString));
    }
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = (azyu)paramQQAppInterface.getManager(61);
      if (localObject1 != null)
      {
        Object localObject2 = new ArrayList();
        ((List)localObject2).addAll(((azyu)localObject1).b());
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString = localamjk.b(paramString, 7000);
        if (paramString != null)
        {
      ...
      } while (((azyu)paramQQAppInterface.getManager(61)).a() != 0);
      a(paramQQAppInterface, localamjk, aljq.x, 7);
    } while (!QLog.isColorLevel());
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1 = (azyu)paramQQAppInterface.getManager(61);
    azyl localazyl = (azyl)paramQQAppInterface.getManager(62);
    if ((localObject1 == null) || (localazyl == null)) {
      return false;
    }
    localObject1 = ((azyu)localObject1).a();
    Object localObject2 = new ArrayList();
    Object localObject3 = paramQQAppInterface.getApplication().getAllAccounts();
    if ((localObject3 != null) && (((List)localObject3).size() > 0)) {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localObject3 != null) && (!TextUtils.isEmpty(((SimpleAccount)localObject3).getUin())) && (!((SimpleAccount)localObject3).getUin().equals(paramQQAppInterface)) && (!((List)localObject1).contains(((SimpleAccount)localObject3).getUin())))
      {
        ...
        String str = localazyl.a((String)localObject3 + "_last_cookie");
        if (!TextUtils.isEmpty(str)) {
          localazyl.a((String)localObject3 + "_cookie", str);
        }
        localazyl.a((String)localObject3 + "_msgNum", Integer.valueOf(0));
        localazyl.a((String)localObject3 + "_msgFlag", Integer.valueOf(0));
        localazyl.a((String)localObject3 + "_redBagTime", Integer.valueOf(0));
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("SUB_ACCOUNT", 2, "cleanAllThirdQQUnreadMsgNum()");
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    azyl localazyl = (azyl)paramQQAppInterface.getManager(62);
    return (localazyl == null) || (!TextUtils.equals(localazyl.a(paramQQAppInterface.c() + "_display_third_qq_checked"), String.valueOf(false)));
  }
  ...
  private boolean d(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject3 = (azyu)paramQQAppInterface.getManager(61);
  ...
  public ArrayList<Pair<String, Integer>> a(String paramString)
  {
    ...
    //   45: areturn
    //   46: aload_0
    //   47: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   50: invokeinterface 264 1 0
    //   55: aload_0
    //   56: getfield 1065	azyl:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   59: ifnull +29 -> 88
    //   62: ldc_w 950
    //   65: aload_1
    ...
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 1065	azyl:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   77: invokevirtual 463	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   80: pop
    //   81: aload_0
    //   82: getfield 1065	azyl:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 79	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   92: invokeinterface 279 1 0
    //   97: aload_3
    //   98: areturn
    //   99: aload_0
    //   100: getfield 1065	azyl:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   110: iflt -22 -> 88
    //   113: aload_0
    //   114: getfield 1065	azyl:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   117: iload_2
    ...
    //   126: aload_1
    //   127: aload 4
    //   129: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    ...
    //   144: pop
    //   145: aload_0
    //   146: getfield 1065	azyl:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   149: iload_2
    //   150: invokevirtual 1072	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   153: pop
    //   154: iload_2
    //   155: iconst_1
    //   156: isub
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(SubAccountBaseActivity paramSubAccountBaseActivity)
  {
    ...
    while (i >= 0)
    {
      localObject = (bdfq)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if ((localObject == null) || (((bdfq)localObject).getOwnerActivity() != paramSubAccountBaseActivity) || (((bdfq)localObject).isShowing())) {}
      try
      {
        ((bdfq)localObject).dismiss();
        label116:
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, Pair<String, Integer> paramPair, android.content.DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    //   144: aload_3
    //   145: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    ...
    //   160: aload_3
    //   161: getfield 596	com/tencent/util/Pair:second	Ljava/lang/Object;
    ...
    //   172: goto -142 -> 30
    //   175: aload_2
    //   176: invokevirtual 897	java/lang/Object:getClass	()Ljava/lang/Class;
    //   179: invokevirtual 902	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   182: astore 8
    //   184: goto -130 -> 54
    //   187: ldc_w 1255
    //   190: astore 8
    ...
    //   200: goto -97 -> 103
    //   203: aload_3
    //   204: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   207: checkcast 379	java/lang/String
    //   210: astore 8
    //   212: aload_3
    //   213: getfield 596	com/tencent/util/Pair:second	Ljava/lang/Object;
    //   216: checkcast 221	java/lang/Integer
    //   219: invokevirtual 276	java/lang/Integer:intValue	()I
    //   222: istore 6
    //   224: aload_0
    //   225: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   228: invokeinterface 264 1 0
    //   233: aload_0
    //   234: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   237: ifnull +141 -> 378
    //   240: aload_0
    //   241: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   253: iflt +125 -> 378
    //   256: aload_0
    //   257: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   260: iload 5
    //   262: invokevirtual 304	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   265: checkcast 917	bdfq
    //   268: astore 10
    //   270: aload 10
    //   272: ifnull +298 -> 570
    //   275: aload 10
    //   277: invokevirtual 1258	bdfq:getTag	()Ljava/lang/Object;
    //   280: instanceof 346
    //   283: ifeq +287 -> 570
    //   286: aload 10
    //   288: invokevirtual 1258	bdfq:getTag	()Ljava/lang/Object;
    //   291: checkcast 346	com/tencent/util/Pair
    //   294: astore 9
    //   296: aload 8
    //   298: aload 9
    //   300: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   303: invokevirtual 400	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   306: ifeq +264 -> 570
    //   309: aload 10
    //   311: invokevirtual 1239	bdfq:isShowing	()Z
    //   314: istore 7
    //   316: iload 7
    //   318: ifeq +8 -> 326
    //   321: aload 10
    //   323: invokevirtual 1242	bdfq:dismiss	()V
    //   326: aload_0
    //   327: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   330: iload 5
    //   332: invokevirtual 1072	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   335: pop
    ...
    //   358: aload 9
    //   360: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    ...
    //   378: aload_2
    //   379: ldc_w 903
    //   382: invokevirtual 906	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   385: astore 10
    //   387: aload_1
    //   388: aload 8
    //   390: iconst_0
    //   391: invokestatic 960	bdbt:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Z)Ljava/lang/String;
    //   394: astore 9
    //   396: aload 9
    //   398: ifnull +181 -> 579
    //   401: aload 9
    ...
    //   430: aload_1
    //   431: aastore
    //   432: invokevirtual 910	com/tencent/mobileqq/app/BaseActivity:getString	(I[Ljava/lang/Object;)Ljava/lang/String;
    //   435: astore_1
    //   436: aload_2
    //   437: sipush 230
    //   440: invokestatic 915	bdcd:a	(Landroid/content/Context;I)Lbdfq;
    //   443: aload 10
    //   445: invokevirtual 921	bdfq:setTitle	(Ljava/lang/String;)Lbdfq;
    //   448: aload_1
    //   449: invokevirtual 925	bdfq:setMessage	(Ljava/lang/CharSequence;)Lbdfq;
    //   452: astore_1
    //   453: aload_1
    //   454: aload_3
    //   455: invokevirtual 1264	bdfq:setTag	(Ljava/lang/Object;)V
    //   458: aload_1
    //   459: aload_2
    //   460: invokevirtual 929	bdfq:setOwnerActivity	(Landroid/app/Activity;)V
    //   463: aload_1
    //   464: aload_2
    //   465: ldc_w 930
    //   468: invokevirtual 906	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   471: aload 4
    //   473: invokevirtual 938	bdfq:setPositiveButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lbdfq;
    //   476: pop
    //   477: aload_1
    //   478: new 1266	azyn
    //   481: dup
    ...
    //   483: aload 8
    //   485: iload 6
    //   487: invokespecial 1269	azyn:<init>	(Lazyl;Ljava/lang/String;I)V
    //   490: invokevirtual 1273	bdfq:setOnCancelListener	(Landroid/content/DialogInterface$OnCancelListener;)V
    //   493: aload_1
    //   494: invokevirtual 945	bdfq:show	()V
    //   497: aload_0
    //   498: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   501: ifnonnull +14 -> 515
    //   504: aload_0
    //   505: new 57	java/util/ArrayList
    //   508: dup
    //   509: invokespecial 58	java/util/ArrayList:<init>	()V
    //   512: putfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   515: aload_0
    //   516: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   519: aload_1
    //   520: invokevirtual 297	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   523: pop
    //   524: aload_0
    //   525: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   544: aload_1
    //   545: aastore
    //   546: invokevirtual 910	com/tencent/mobileqq/app/BaseActivity:getString	(I[Ljava/lang/Object;)Ljava/lang/String;
    //   549: astore_1
    //   550: goto -114 -> 436
    //   553: astore_1
    //   554: aload_0
    //   555: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   54: return
    //   55: aload_0
    //   56: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   59: invokeinterface 264 1 0
    //   64: aload_0
    //   65: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: ifnull +253 -> 321
    //   71: aload_0
    //   72: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   84: iflt +237 -> 321
    //   87: aload_0
    //   88: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: iload 5
    //   93: invokevirtual 304	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   96: checkcast 917	bdfq
    //   99: astore 7
    //   101: aload 7
    //   103: ifnull +162 -> 265
    //   106: aload 7
    //   108: invokevirtual 1258	bdfq:getTag	()Ljava/lang/Object;
    //   111: astore 8
    //   113: aload 8
    //   115: ifnull +193 -> 308
    //   118: aload 8
    ...
    //   137: aload_1
    //   138: aload 8
    //   140: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   143: invokevirtual 400	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   146: ifeq +190 -> 336
    //   149: iload_2
    //   150: aload 8
    //   152: getfield 596	com/tencent/util/Pair:second	Ljava/lang/Object;
    ...
    //   169: ifeq +173 -> 342
    //   172: aload 7
    //   174: invokevirtual 1239	bdfq:isShowing	()Z
    //   177: istore 6
    //   179: iload 6
    //   181: ifeq +8 -> 189
    //   184: aload 7
    //   186: invokevirtual 1242	bdfq:dismiss	()V
    //   189: aload_0
    //   190: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   193: iload 5
    //   195: invokevirtual 1072	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   198: pop
    ...
    //   221: aload 8
    //   223: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    ...
    //   238: aload 8
    //   240: getfield 596	com/tencent/util/Pair:second	Ljava/lang/Object;
    ...
    //   262: goto +80 -> 342
    //   265: aload_0
    //   266: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   269: iload 5
    //   271: invokevirtual 1072	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   274: pop
    //   275: goto +67 -> 342
    //   278: astore_1
    //   279: aload_0
    //   280: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   283: invokeinterface 279 1 0
    //   288: aload_1
    //   289: athrow
    //   290: aload_1
    //   291: aload 8
    //   293: getfield 1068	com/tencent/util/Pair:first	Ljava/lang/Object;
    ...
    //   305: goto -138 -> 167
    //   308: aload_0
    //   309: getfield 1232	azyl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   312: iload 5
    //   314: invokevirtual 1072	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   317: pop
    //   318: goto +24 -> 342
    //   321: aload_0
    //   322: getfield 43	azyl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void onDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          bdfq localbdfq = (bdfq)localIterator.next();
          try
          {
