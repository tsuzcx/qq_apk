  ...
  extends azut
{
    ...
    if (((localObject1 == null) || (!((String)localObject1).equals("1"))) || (paramLinearLayout.getChildCount() == this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject2 instanceof StructMsgItemTitle))
        {
          ...
          ((azus)localObject2).a(paramContext, (View)localObject3, paramBundle);
          i = ((View)localObject3).getPaddingTop();
          j = ((View)localObject3).getPaddingBottom();
          if (paramBoolean)
          {
            if ((!(localObject2 instanceof azwv)) && (!(localObject2 instanceof azwx))) {
              break label431;
            }
        ...
        for (;;)
        {
          ...
          localObject3 = (azzm)localObject2;
          ((azzm)localObject3).a();
          if ((localObject3 != null) && ((((azzm)localObject3).c() == null) || (((azzm)localObject3).c().equals("")))) {
            ((azzm)localObject3).c(String.valueOf(28));
          }
          localObject4 = ((azzm)localObject3).f();
          if ((localObject4 != null) && (((String)localObject4).equals("1")))
          {
            ((azzm)localObject3).c(String.valueOf(24));
            if ((!paramBoolean) || (!TextUtils.isEmpty(((azzm)localObject3).d()))) {
              break label157;
            }
            ((azzm)localObject3).b("#8e8e8e");
            break label157;
          }
          if (!paramBoolean) {
            break label157;
          }
          if (TextUtils.isEmpty(((azzm)localObject3).c())) {
            ((azzm)localObject3).c(String.valueOf(32));
          }
          if (!TextUtils.isEmpty(((azzm)localObject3).d())) {
            break label157;
          }
          ((azzm)localObject3).b("#000000");
          break label157;
          label431:
          if ((localObject2 instanceof azvv))
          {
          ...
          break label222;
          label467:
          if (((localObject2 instanceof azzm)) && (paramBoolean)) {
            ((TextView)localObject3).setLineSpacing(aepi.a(2.0F, paramResources), 1.0F);
          }
        }
      }
    }
    else
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ("title".equals(localObject3))
        {
          ...
          localObject3 = ((azus)localObject1).a(paramContext, null, paramBundle);
          localObject4 = new LinearLayout.LayoutParams(-2, -2);
          ((LinearLayout.LayoutParams)localObject4).topMargin = aepi.a(2.5F, paramResources);
          ((LinearLayout.LayoutParams)localObject4).bottomMargin = aepi.a(1.5F, paramResources);
          if ((a(1)) && (i == 0)) {
            ((LinearLayout.LayoutParams)localObject4).topMargin = aepi.a(20.0F, paramResources);
          }
          if (paramBoolean)
          {
        ...
        for (;;)
        {
          ...
          {
            localObject1 = ((azus)localObject1).a(paramContext, null, paramBundle);
            localObject3 = new LinearLayout.LayoutParams(-1, 1);
            if (i > 0) {
              ((LinearLayout.LayoutParams)localObject3).topMargin = aepi.a(7.5F, paramResources);
            }
            if (paramBoolean)
            {
          ...
          else
          {
            if ("summary".equals(localObject3))
            {
              ...
              {
                localObject3 = (azzm)localObject1;
                ((azzm)localObject3).a();
                if ((localObject3 != null) && ((((azzm)localObject3).c() == null) || (((azzm)localObject3).c().equals("")))) {
                  ((azzm)localObject3).c(String.valueOf(28));
                }
                localObject4 = ((azzm)localObject1).f();
                if ((localObject4 == null) || (!((String)localObject4).equals("1"))) {
                  break label1100;
                }
                ((azzm)localObject3).c(String.valueOf(24));
              ...
              for (;;)
              {
                localObject1 = ((azus)localObject1).a(paramContext, null, paramBundle);
                if (paramBoolean) {
                  ((TextView)localObject1).setLineSpacing(aepi.a(2.0F, paramResources), 1.0F);
                }
                localObject3 = new LinearLayout.LayoutParams(-2, -2);
                ((LinearLayout.LayoutParams)localObject3).topMargin = aepi.a(4.5F, paramResources);
                ((LinearLayout.LayoutParams)localObject3).bottomMargin = aepi.a(5.5F, paramResources);
                if ((a(2)) && (i == this.jdField_a_of_type_JavaUtilArrayList.size() - 1)) {
                  ((LinearLayout.LayoutParams)localObject3).bottomMargin = aepi.a(13.0F, paramResources);
                }
                if (paramBoolean) {
            ...
            else
            {
              ...
              {
                localObject4 = ((azus)localObject1).a(paramContext, null, paramBundle);
                localObject1 = ((View)localObject4).findViewById(2131368094);
                ...
                for (;;)
                {
                  ((LinearLayout.LayoutParams)localObject1).bottomMargin = aepi.a(7.5F, paramResources);
                  ...
                  {
                    localObject1 = new LinearLayout.LayoutParams(-1, aepi.a(105.0F, paramResources));
                    break label1395;
                  }
                  localObject1 = new LinearLayout.LayoutParams(-1, aepi.a(175.0F, paramResources));
                  break label1395;
                  label1602:
                  ((LinearLayout.LayoutParams)localObject1).topMargin = aepi.a(7.5F, paramResources);
                }
              }
              if ("more".equals(localObject3))
              {
                localObject1 = ((azus)localObject1).a(paramContext, null, paramBundle);
                localObject3 = new LinearLayout.LayoutParams(-1, aepi.a(36.0F, paramResources));
                if (paramBoolean) {
                  ((View)localObject1).setPadding(k, ((View)localObject1).getPaddingTop(), m, ((View)localObject1).getPaddingBottom());
                }
                paramLinearLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject3);
              ...
              {
                localObject1 = ((azus)localObject1).a(paramContext, null, paramBundle);
                ((AnyScaleTypeImageView)localObject1).setImageResource(2130841362);
                localObject3 = new LinearLayout.LayoutParams(-1, (int)(BaseChatItemLayout.jdField_a_of_type_Int / 1.8D));
                if (paramBoolean)
                {
                  ((View)localObject1).setPadding(k, ((View)localObject1).getPaddingTop(), m, ((View)localObject1).getPaddingBottom());
                  ((LinearLayout.LayoutParams)localObject3).topMargin = aepi.a(7.5F, paramResources);
                  ((LinearLayout.LayoutParams)localObject3).bottomMargin = aepi.a(7.5F, paramResources);
                }
                paramLinearLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject3);
              }
  ...
  private void a(Context paramContext, Resources paramResources, LinearLayout paramLinearLayout, int paramInt, View paramView, boolean paramBoolean)
  {
    ...
    if (((Iterator)localObject3).hasNext())
    {
      ...
      int j = i;
      if ((localObject4 instanceof azuu))
      {
        localObject4 = (azuu)localObject4;
        if (paramBoolean)
        {
          if (!(localObject4 instanceof azzm)) {
            break label216;
          }
          if (TextUtils.isEmpty(((azuu)localObject4).c())) {
            ((azuu)localObject4).c(String.valueOf(32));
          }
          if (TextUtils.isEmpty(((azuu)localObject4).d())) {
            ((azuu)localObject4).b("#000000");
          }
        }
      }
      for (;;)
      {
        localObject4 = ((azuu)localObject4).a(paramResources);
        j = i;
        if (localObject4 != null)
        {
          ((azuv)localObject4).e = (i + 1);
          ((azuv)localObject4).f = (((azuv)localObject4).e + ((azuv)localObject4).jdField_a_of_type_JavaLangString.length());
          j = i + ((azuv)localObject4).jdField_a_of_type_JavaLangString.length();
          ((StringBuffer)localObject1).append(((azuv)localObject4).jdField_a_of_type_JavaLangString);
          ((ArrayList)localObject2).add(localObject4);
        }
        i = j;
        break;
        label216:
        if (((localObject4 instanceof StructMsgItemTitle)) && (TextUtils.isEmpty(((azuu)localObject4).c()))) {
          ((azuu)localObject4).c(String.valueOf(36));
        }
      }
    }
    ...
    {
      localObject3 = (azuv)((Iterator)localObject2).next();
      ((SpannableStringBuilder)localObject1).setSpan(new TextAppearanceSpan(null, ((azuv)localObject3).b, (int)TypedValue.applyDimension(2, ((azuv)localObject3).c, paramResources.getDisplayMetrics()), ColorStateList.valueOf(((azuv)localObject3).jdField_a_of_type_Int), null), ((azuv)localObject3).e, ((azuv)localObject3).f, 33);
    }
    ...
    if (paramBoolean)
    {
      paramContext.setLineSpacing(aepi.a(2.0F, paramResources), 1.0F);
      paramView.topMargin = aepi.a(4.5F, paramResources);
      paramView.bottomMargin = aepi.a(5.5F, paramResources);
    }
    for (;;)
    {
      ...
      if (a(2)) {
        paramView.bottomMargin = aepi.a(10.0F, paramResources);
      }
      if (a(1)) {
        paramView.topMargin = aepi.a(10.0F, paramResources);
      }
    }
  }
