...
public class aoua
  extends aouc
{
  public aoua(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      localObject = new bluy(this.jdField_a_of_type_AndroidContentContext, (String)localObject, str2, str3, bool, null, str4, i);
      ((bluy)localObject).f = str1;
      blvm.a((bluy)localObject);
      return;
