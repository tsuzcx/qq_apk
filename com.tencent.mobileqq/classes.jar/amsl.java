  ...
  extends amsf
{
  ...
  public amsl(QQAppInterface paramQQAppInterface, DrawerPushItem paramDrawerPushItem)
  {
  ...
  public int a(anct paramanct, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    int i;
    boolean bool;
    if (this.jdField_b_of_type_Int > anka.jdField_b_of_type_Int)
    {
      i = 3;
      bool = ApolloUtil.d(5, this.jdField_b_of_type_Int);
      ...
      paramInt = 6;
      anck.a(paramanct, 6, paramAppInterface);
    }
    for (;;)
    {
      ...
      break;
      label172:
      super.a(paramanct, i, paramInt, paramAppInterface, paramContext);
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.is_reddot == 0) || (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.fromTianshu))
      {
        ...
        if (!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
          anck.a(paramanct, jdField_a_of_type_JavaLangString, this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.bubble_res_id);
        }
        this.jdField_a_of_type_Long = System.currentTimeMillis();
        paramanct = (amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER);
        ...
        if (!paramanct.jdField_d_of_type_Boolean) {
          break label243;
        }
      }
      for (paramInt = 0;; paramInt = 1)
      {
        ...
        paramanct = (bbbq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH);
        paramanct.b(paramanct.a(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotPath), "");
        return;
        bool = false;
        break;
      }
    } while (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuAdId == 0);
    anme.a(101, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuAdId), this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuTraceInfo);
  }
  ...
  {
    super.a(paramQQAppInterface, paramanct);
    ...
    paramanct = this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem;
    paramanct.show_sum += 1;
    paramQQAppInterface = (amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER);
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotGameId > 0)
      {
        ...
        paramContext = jdField_d_of_type_JavaLangString;
        if (!localamme.jdField_d_of_type_Boolean) {
          break label268;
        }
      }
      for (int i = 0;; i = 1)
      {
        ...
        ((bbbq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH)).b(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotPath);
        return;
        localamme.a(paramQQAppInterface, paramContext, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.scheme, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.ext_url, "drawer");
        break label89;
      }
    } while (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuAdId == 0);
    label268:
    label273:
    anme.a(102, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuAdId), this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuTraceInfo);
  }
