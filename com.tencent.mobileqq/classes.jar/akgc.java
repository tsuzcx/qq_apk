  ...
  extends BaseAdapter
{
  ...
  public akgc(Context paramContext, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Akgd == null) {
      this.jdField_a_of_type_Akgd = new akgd(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    if (paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_b_of_type_Boolean)
    {
      ...
      localObject = this.jdField_a_of_type_Akgd.a((Drawable)localObject, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_b_of_type_Boolean) {
        break label421;
      }
      Drawable localDrawable = akgd.a(this.jdField_a_of_type_Akgd, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Akgd.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label294;
      label421:
      localObject = akgd.b(this.jdField_a_of_type_Akgd, (Drawable)localObject);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    }
    label444:
