...
public class aclx
{
  ...
  private acls jdField_a_of_type_Acls;
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private String b;
  private String c;
  
  public aclx(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
  }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          acls localacls = acls.a(this.jdField_a_of_type_JavaLangString, paramJSONObject.getJSONObject(i));
          if (localacls != null) {
            this.jdField_a_of_type_Acls = localacls;
          }
        }
        else
        {
  ...
  public acls a()
  {
    return this.jdField_a_of_type_Acls;
  }
  ...
  public boolean a(Context paramContext, String paramString)
  {
    ...
    if (!"b8c39faf".equals(this.c))
    {
      QLog.d("PatchLogTag", 1, "PatchConfig isValidConfig revision not match expect: b8c39faf");
      return false;
    }
    if ((TextUtils.isEmpty(this.b)) || (!this.b.equals(arqj.a(paramContext) + "." + arqj.a(paramContext))))
    {
      QLog.d("PatchLogTag", 1, "PatchConfig isValidConfig app version not match expect: " + arqj.a(paramContext) + "." + arqj.a(paramContext));
      return false;
    }
    if ((this.jdField_a_of_type_Acls == null) || (!this.jdField_a_of_type_Acls.a(paramString)))
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Acls != null) {
      return this.jdField_a_of_type_Acls.jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  {
    if (this.jdField_a_of_type_Acls != null) {
      return this.jdField_a_of_type_Acls.jdField_a_of_type_JavaLangString;
    }
    return null;
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Acls != null) && (this.jdField_a_of_type_Acls.a());
  }
  
  public int c()
  {
    if ((!b()) && (PatchCommonUtil.isArtGeN()) && (this.jdField_a_of_type_Acls != null)) {
      return ((aclt)this.jdField_a_of_type_Acls).a();
    }
    return b();
  }
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Acls != null) && (this.jdField_a_of_type_Acls.b());
  }
  
  public String d()
  {
    if (this.jdField_a_of_type_Acls != null) {
      return this.jdField_a_of_type_Acls.b;
    }
    return null;
  }
  ...
  public String e()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Acls != null)
      {
        String str = this.jdField_a_of_type_Acls.a();
