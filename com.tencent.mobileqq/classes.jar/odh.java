  ...
  implements AladdinConfigHandler
{
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals("channel_list_dynamic_order_switch", str1)) {
        bgmq.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(TextUtils.equals(str2, "1")));
      }
    }
    return true;
  }
  ...
  {
    bgmq.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(false));
  }
}
