  ...
  extends anii
{
  ...
  public odh(AppInterface paramAppInterface)
  {
      ...
      for (;;)
      {
        ...
        if ((localException1 instanceof MessageForStructing))
        {
          ...
          if ((localObject instanceof StructMsgForGeneralShare))
          {
            ...
            {
              localObject = (bcvs)((StructMsgForGeneralShare)localObject).mStructMsgItemLists.get(0);
              if (localObject != null) {
                l1 = 0L;
              }
            }
        ...
        try
        {
          long l2 = Long.parseLong(((bcvs)localObject).s);
          l1 = l2;
        }
  ...
  private Set<Long> a()
  {
    ...
    {
      return localHashSet;
      str = akms.a(this.app.getCurrentAccountUin(), "risk_ids", "");
      if (QLog.isColorLevel()) {
        QLog.i("Ecshop_EcshopAdHandler", 2, "---getRiskAids---" + str);
      }
    } while (bgsp.a(str));
    return (Set)new Gson().fromJson(str, new odi(this).getType());
  }
  
  /* Error */
  public static odk a(odk paramodk, MessageRecord paramMessageRecord)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +5 -> 6
    ...
    //   81: putfield 226	odk:jdField_a_of_type_Long	J
    //   84: aload_0
    //   85: aload_3
    //   86: putfield 229	odk:k	Ljava/lang/String;
    //   89: aload_0
    //   90: aload 6
    //   92: putfield 231	odk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   95: aload_0
    //   96: aload 5
    //   98: putfield 234	odk:l	Ljava/lang/String;
    //   101: aload_0
    //   102: aload_2
    //   103: putfield 236	odk:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   106: aload_0
    //   107: iconst_0
    //   108: putfield 239	odk:jdField_g_of_type_Int	I
    //   111: aload_0
    //   112: areturn
    //   113: astore_3
  ...
  private void a(long paramLong)
  {
    ...
    akms.a(this.app.getCurrentAccountUin(), "risk_ids", (String)localObject);
  }
  ...
  public static void a(AppInterface paramAppInterface, ChatMessage paramChatMessage, View paramView)
  {
    ...
    try
    {
      paramChatMessage = oda.a(paramChatMessage);
      if (paramChatMessage != null)
      {
        paramView.setTag(2131380927, new GdtAd(paramChatMessage));
        paramView.setTag(2131380926, new odj(paramAppInterface));
      }
      return;
    }
  ...
  private void a(ArrayList<odx> paramArrayList)
  {
    ...
    do
    {
      ...
      } while ((localObject == null) || (((ChatFragment)localObject).a == null) || (((ChatFragment)localObject).a.c == null) || (((ChatFragment)localObject).a.c.findViewById(2131364345) == null));
      localObject = (CustomTabView)((ChatFragment)localObject).a.c.findViewById(2131364345).findViewWithTag("echopCustomTabView");
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    localodk.jdField_a_of_type_Int = paramInt;
    a(localodk, paramMessageRecord);
    a(localodk, null);
  }
  ...
  public void a(List<Long> paramList, List<Integer> paramList1, boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    try
    {
      String str1 = afsx.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd");
      if (QLog.isColorLevel()) {
        QLog.i("Ecshop_EcshopAdHandler", 2, "currentTs:" + str1);
      }
      String str2 = akms.a(this.app.getCurrentAccountUin(), "risk_ad_del_time", str1);
      if (QLog.isColorLevel()) {
      ...
      if (!str1.equals(str2))
      {
        ...
        akms.a(this.app.getCurrentAccountUin(), "risk_ids");
      }
  ...
  public void a(odk paramodk, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.i("Ecshop_EcshopAdHandler", 2, "do ad report info:" + paramodk.toString());
    }
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      localQQAdReport.type.set(paramodk.jdField_a_of_type_Int);
      localObject2 = localQQAdReport.view_id;
      if (paramodk.jdField_a_of_type_JavaLangString != null) {
        break label627;
      }
      localObject1 = "";
      label84:
      ...
      if (paramodk.jdField_b_of_type_JavaLangString != null) {
        break label635;
      }
      localObject1 = "";
      label107:
      ...
      if (paramodk.jdField_c_of_type_JavaLangString != null) {
        break label643;
      }
      localObject1 = "";
      label146:
      ...
      if (paramodk.jdField_d_of_type_JavaLangString != null) {
        break label651;
      }
      localObject1 = "";
      label169:
      ...
      if (paramodk.jdField_e_of_type_JavaLangString != null) {
        break label659;
      }
      localObject1 = "";
      label192:
      ...
      if (paramodk.jdField_f_of_type_JavaLangString != null) {
        break label667;
      }
      localObject1 = "";
      label215:
      ...
      if (paramodk.jdField_g_of_type_JavaLangString != null) {
        break label675;
      }
      localObject1 = "";
      label238:
      ((PBStringField)localObject2).set((String)localObject1);
      localQQAdReport.feeds_index.set(paramodk.jdField_b_of_type_Int);
      localQQAdReport.is_impression.set(paramodk.jdField_a_of_type_Boolean);
      localQQAdReport.is_installed.set(paramodk.jdField_b_of_type_Boolean);
      ...
      label375:
      ((PBStringField)localObject2).set((String)localObject1);
      localObject2 = bgln.c(BaseApplicationImpl.getApplication().getApplicationContext());
      ...
      localQQAdReport.stay_time.set(paramodk.jdField_c_of_type_Int);
      localQQAdReport.net_type.set(nlw.a());
      localQQAdReport.client_id.set(paramodk.jdField_d_of_type_Int);
      localQQAdReport.action_id.set(paramodk.jdField_e_of_type_Int);
      localQQAdReport.msg_floor.set(paramodk.jdField_f_of_type_Int);
      localQQAdReport.puin.set(paramodk.jdField_a_of_type_Long);
      localQQAdReport.ad_puin.set(paramodk.jdField_b_of_type_Long);
      localQQAdReport.version.set("8.4.1");
    ...
    label714:
    label722:
    for (Object localObject1 = "";; localObject1 = paramodk.l)
    {
      ((PBStringField)localObject2).set((String)localObject1);
      localQQAdReport.get_back.set(false);
      localQQAdReport.source.set(paramodk.jdField_g_of_type_Int);
      paramodk = new ToServiceMsg("mobileqq.service", this.app.c(), paramString);
      paramodk.putWupBuffer(localQQAdReport.toByteArray());
      super.sendPbReq(paramodk);
      return;
      anjf.a(paramString, new int[] { 139 });
      break;
      label627:
      localObject1 = paramodk.jdField_a_of_type_JavaLangString;
      break label84;
      label635:
      localObject1 = paramodk.jdField_b_of_type_JavaLangString;
      break label107;
      localObject1 = paramodk.jdField_c_of_type_JavaLangString;
      break label146;
      localObject1 = paramodk.jdField_d_of_type_JavaLangString;
      break label169;
      localObject1 = paramodk.jdField_e_of_type_JavaLangString;
      break label192;
      localObject1 = paramodk.jdField_f_of_type_JavaLangString;
      break label215;
      localObject1 = paramodk.jdField_g_of_type_JavaLangString;
      break label238;
      localObject1 = paramodk.h;
      break label297;
      localObject1 = biuf.c();
      break label329;
      localObject1 = paramodk.i;
      break label352;
      localObject1 = paramodk.j;
      break label375;
      localObject1 = paramodk.k;
      break label527;
    }
  }
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if ((localChatFragment != null) && (localChatFragment.a != null))
          {
            ...
            if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
            {
              ...
              if (this.app != null) {
                akms.a(this.app.getCurrentAccountUin(), "risk_ad_del_time", afsx.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd"));
              }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.i("Ecshop_EcshopAdHandler", 2, "rsp:" + bghp.a(paramToServiceMsg));
          return;
        }
      }
