  ...
  extends xop
{
  ...
  private long a(String paramString)
  {
    ...
    {
      long l = bbwv.a((QQAppInterface)localAppRuntime, "name_plate_config_version", 0L);
  ...
  private boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str3 = paramToServiceMsg.extraData.getString(akjo.a);
    Object localObject = paramToServiceMsg.extraData.getString(akjo.c);
    long l1 = paramToServiceMsg.extraData.getLong(akjo.l);
    boolean bool3 = bbqs.a();
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    String str4 = bbwc.a(0, BaseApplicationImpl.getContext());
    localObject = bbwc.a(1, BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localPrivExtV2Req.pullPayRuleCfgTime = bbwv.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "last_pull_pay_rule", 0L);
        ...
        paramToServiceMsg.extraData.putBoolean(akjo.h, bool1);
        paramToServiceMsg.extraData.putBoolean(akjo.i, bool2);
        ...
        try
        {
          localPrivExtV2Req.sImsi1 = bfmw.b("a4bd32");
        }
    ...
    {
      if (bool1) {
        paramToServiceMsg.extraData.putString(akjo.j, localPrivExtV2Req.sImsi1);
      }
      if (bool2) {
        paramToServiceMsg.extraData.putString(akjo.k, localPrivExtV2Req.sImsi2);
      }
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      ...
      if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd()))
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(akjo.a);
        ...
        localGuanjiaReportReq.sPhoneNum = paramToServiceMsg.extraData.getString(akjo.d);
        localGuanjiaReportReq.bKingCard = paramToServiceMsg.extraData.getBoolean(akjo.e);
        localGuanjiaReportReq.iCardType = paramToServiceMsg.extraData.getInt(akjo.f);
        localGuanjiaReportReq.iCardStatus = paramToServiceMsg.extraData.getInt(akjo.g);
      ...
      ((GetCustomOnlineStatusReq)localObject).lUin = paramToServiceMsg.extraData.getLong(akjo.m);
      ((GetCustomOnlineStatusReq)localObject).sIMei = paramToServiceMsg.extraData.getString(akjo.n);
