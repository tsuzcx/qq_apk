  ...
  extends bkhx
{
  ...
  public bkie(Context paramContext, String paramString)
  {
  ...
  private bkid a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bkhl parambkhl, int paramInt7)
  {
    paramTypeface = new bkid(paramInt1, paramInt2, paramTypeface, paramInt3, paramInt4, paramInt5, paramInt6);
    paramTypeface.a(paramCharSequence, parambkhl, paramInt7);
  ...
  protected void a(Canvas paramCanvas, ArrayList<Integer> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(actj.a(2.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      int i = actj.a(55.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Bkid = a(this.jdField_b_of_type_JavaLangString, actj.a(48.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1, 0, 0, 0, 600, localTypeface1, this.jdField_a_of_type_Bkhl, 0);
          this.jdField_a_of_type_Int = this.jdField_a_of_type_Bkhl.a("", 300L, 500L, 0, this.jdField_a_of_type_Bkid.e, new LinearInterpolator());
          this.jdField_b_of_type_Bkid = a(this.c, actj.a(11.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1, 0, actj.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 500, 800, (Typeface)localObject, this.jdField_a_of_type_Bkhl, this.jdField_a_of_type_Bkid.e - 10);
          return;
  ...
  {
    return actj.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  
  public int getIntrinsicWidth()
  {
    return this.jdField_a_of_type_Bkid.e;
  }
}
