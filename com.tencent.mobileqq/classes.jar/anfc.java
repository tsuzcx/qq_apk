...
public abstract class anfc
{
  ...
  public anfc(int paramInt)
  {
    this.jdField_c_of_type_JavaLangString = anfg.jdField_a_of_type_JavaLangString;
    ...
    this.jdField_j_of_type_JavaLangString = anfg.jdField_b_of_type_JavaLangString;
    this.jdField_k_of_type_JavaLangString = anfg.jdField_c_of_type_JavaLangString;
    this.jdField_l_of_type_JavaLangString = anfg.jdField_d_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = "precision mediump float;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nuniform mat4 uMVPMatrix;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}";
    this.o = paramInt;
  }
  
  private final int a(anff paramanff, boolean paramBoolean)
  {
    int i1 = 0;
    a(paramanff);
    if (this.jdField_a_of_type_Anfd != null) {
      this.jdField_a_of_type_Anfd.a();
    }
    if (this.n == 1) {
      this.jdField_a_of_type_Aney.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      GLES20.glBindTexture(3553, 0);
      GLES20.glBindFramebuffer(36160, 0);
      anfg.a("keyingHandleAfter");
      if (paramBoolean) {
        i1 = this.jdField_a_of_type_Anez.a();
      }
      return i1;
      this.jdField_a_of_type_Anfi.a();
    }
  }
  
  private final void a(anff paramanff, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Anez.a(paramInt1, paramInt2);
    ...
    for (;;)
    {
      ...
      if (this.m != -1) {
        GLES20.glUniform4f(this.m, paramanff.jdField_a_of_type_Float, paramanff.jdField_b_of_type_Float, paramanff.jdField_c_of_type_Float, 1.0F);
      }
      anfg.a("keyingHandleBefore");
      return;
      this.jdField_a_of_type_Anfi.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
  }
  
  public final int a(int[] paramArrayOfInt, anff paramanff, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    return a(paramArrayOfInt, paramanff, paramArrayOfFloat1, paramArrayOfFloat2, false, 0, 0);
  }
  
  public final int a(int[] paramArrayOfInt, anff paramanff, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    if (paramArrayOfInt == null) {
      throw new IllegalArgumentException("textureIds can not be null!");
    }
    a(paramanff, paramArrayOfFloat1, paramArrayOfFloat2, paramBoolean, paramInt1, paramInt2);
    switch (this.o)
    {
    }
    for (;;)
    {
      anfg.a("keyingTexture");
      return a(paramanff, paramBoolean);
  ...
  protected String a()
  {
    this.jdField_c_of_type_JavaLangString = anfg.a(this.o);
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Anez == null);
    this.jdField_a_of_type_Anez.a();
    this.jdField_a_of_type_Anez = null;
  }
}
