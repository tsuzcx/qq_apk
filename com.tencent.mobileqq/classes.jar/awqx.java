...
public class awqx
{
  private static String a()
  {
    ...
    str2 = String.format("%.2f", new Object[] { Double.valueOf(babp.a()) });
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(i).append(";").append(l).append(";").append(arrayOfLong[0]).append(";").append(arrayOfLong[1]).append(";").append(str1.replaceAll(";", "")).append(";").append(str2).append(";").append(bjlo.a).append(";").append(bjlo.b).append(";");
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    if (localQQAppInterface == null)
    {
      ...
      if (!"CliOper".equals(paramString1)) {
        bgmy.a().a(paramString4, paramQQAppInterface);
      }
    }
    do
    {
      return;
      paramQQAppInterface = a(paramString1, paramString2, localQQAppInterface.getCurrentAccountUin(), paramString3, paramString4, paramString5, paramInt1, paramInt3, paramInt2, paramString6, paramString7, paramString8, paramString9);
  ...
  {
    paramPluginRuntime.setClickEventReportor(new awqy());
  }
