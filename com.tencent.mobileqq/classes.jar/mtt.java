...
public class mtt
{
  ...
  public mtt(Context paramContext, VideoController paramVideoController, Button paramButton)
  {
    ...
    b(paramButton);
    this.jdField_a_of_type_Mub = new mub(this);
    c();
  ...
  private Drawable a(Resources paramResources, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        paramResources = mre.a(paramResources, 2130841542, false);
      }
      else
      {
        paramResources = mts.a(paramResources, 2130841498, 2131165869);
        continue;
        if (paramBoolean)
        {
          paramResources = mre.a(paramResources, 2130841541, false);
        }
        else
        {
          paramResources = mts.a(paramResources, 2130841497, 2131165869);
          continue;
          if (paramBoolean)
          {
            paramResources = mre.a(paramResources, 2130841496);
          }
          else
          {
            paramResources = mts.a(paramResources, 2130841761, 2131165906);
            continue;
            if (paramBoolean)
            {
              paramResources = mre.a(paramResources, 2130841500);
            }
            else
            {
              paramResources = mts.a(paramResources, 2130841768, 2131165906);
              continue;
              if (paramBoolean)
              {
                paramResources = mre.a(paramResources, 2130841499);
              }
              else
              {
                paramResources = mts.a(paramResources, 2130841763, 2131165906);
                continue;
                if (paramBoolean) {
                  paramResources = mre.a(paramResources, 2130841541, false);
                } else {
                  paramResources = mts.a(paramResources, 2130841766, 2131165906);
                }
              }
            }
          }
  ...
  public static mtt a()
  {
    try
    {
      mtt localmtt = jdField_a_of_type_Mtt;
      return localmtt;
    }
    finally
    {
  ...
  public static mtt a(Context paramContext, VideoController paramVideoController)
  {
    if (jdField_a_of_type_Mtt == null) {}
    try
    {
      if (jdField_a_of_type_Mtt == null) {
        jdField_a_of_type_Mtt = new mtt(paramContext, paramVideoController, null);
      }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    for (this.jdField_e_of_type_Boolean = Arrays.asList(paramArrayOfString).contains("DEVICE_BLUETOOTHHEADSET");; this.jdField_e_of_type_Boolean = false)
    {
      if ((this.jdField_e_of_type_Boolean != bool) && (this.jdField_e_of_type_Boolean))
      {
        ...
        axqw.b(null, "CliOper", "", "", "0X8008D1D", "0X8008D1D", 0, 0, "", "", "", "");
      }
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131695295), true);
      ...
      bool2 = bool1;
    } while (msi.d(paramVideoAppInterface.getApp()));
    return true;
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              if (paramVideoAppInterface.getCurrentAccountUin() != null)
              {
                ...
                bool1 = bool2;
                if (str != null) {
                  bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131695294) + str, true);
                }
              }
              bool2 = bool1;
            } while (bbbr.a() == 0);
          ...
          bool2 = bool1;
        } while (msi.a(paramVideoAppInterface.getApp()));
        bool2 = bool1;
      } while (msi.c(paramVideoAppInterface.getApp()));
      bool2 = bool1;
    } while (msi.d(paramVideoAppInterface.getApp()));
    return true;
  }
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession = new TraeAudioSession((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), this.jdField_a_of_type_Mub);
    }
  ...
  public void a(int paramInt)
  {
    ...
    {
      long l = AudioHelper.b();
      QLog.w("TraeSessionHelper", 1, "pressHandFreeBtn, isSpeakerOn[" + ((lgf)localObject2).N + "], seq[" + l + "]", (Throwable)localObject1);
      Object localObject3 = ((lgf)localObject2).a;
      ...
      if (localObject3 != null) {
        if ((this.jdField_e_of_type_Boolean) && (msq.a()))
        {
          if (this.jdField_b_of_type_MqqUtilWeakReference == null) {
            break label717;
          }
      ...
      for (;;)
      {
        ...
        localObject3 = new mtz((String[])localObject3);
        if (!TextUtils.isEmpty(((lgf)localObject2).r)) {
          ((mtz)localObject3).a(((lgf)localObject2).r);
        }
        localObject2 = (bfol)bfoy.a((Context)localObject1, null);
        ((bfol)localObject2).a(2131695922);
        ListView localListView = new ListView((Context)localObject1);
        if (this.jdField_a_of_type_Mtx == null) {
          this.jdField_a_of_type_Mtx = new mtx((Context)localObject1, (mtz)localObject3);
        }
        for (;;)
        {
          localListView.setAdapter(this.jdField_a_of_type_Mtx);
          ...
          localListView.setOnItemClickListener(new mtu(this, localButton, l, (bfol)localObject2));
          ((bfol)localObject2).a(localListView);
          ((bfol)localObject2).c(2131690596);
          ((bfol)localObject2).a(new mtv(this));
          ((bfol)localObject2).setOnShowListener(new mtw(this));
          ((bfol)localObject2).show();
          return;
          this.jdField_a_of_type_Mtx.a((Context)localObject1, (mtz)localObject3);
        }
        int k;
        if (((lgf)localObject2).N)
        {
          int i = 0;
          do
          {
  ...
  public void a(long paramLong, lgf paramlgf)
  {
    if (paramlgf == null) {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "switchButton_handFree, isSpeakerOn[" + paramlgf.N + "], seq[" + paramLong + "]");
    }
    this.jdField_a_of_type_Lgf = paramlgf;
  ...
  public boolean a(long paramLong, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    if ((b(paramVideoAppInterface)) && (a(paramVideoAppInterface.getApp().getApplicationContext())))
    {
      ...
      for (;;)
      {
        ...
        bbbr.a(paramInt1, paramInt2, paramOnCompletionListener);
      }
    }
    return false;
  }
