...
class kir
  implements Runnable
{
  kir(kiq paramkiq, mobileqq_mp.WebviewWhiteListResponse paramWebviewWhiteListResponse) {}
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMpMobileqq_mp$WebviewWhiteListResponse.version != null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          this.jdField_a_of_type_Kiq.a.a.a(localObject1, this.jdField_a_of_type_ComTencentMobileqqMpMobileqq_mp$WebviewWhiteListResponse.version.get(), "lastVersion");
          return;
        }
