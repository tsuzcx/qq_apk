  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_JavaLangString = localJSONObject.optString(this.b, anvx.a(2131713608));
        if (paramString == null) {
          break;
        }
        i = 0;
        ...
        localarmr = new armr();
        localarmr.jdField_a_of_type_Int = localJSONObject.optInt(this.d);
        localarmr.jdField_a_of_type_JavaLangString = localJSONObject.optString(this.e);
        if (!TextUtils.isEmpty(localarmr.jdField_a_of_type_JavaLangString)) {
          break label193;
        }
      ...
      if (j != 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(localarmr);
      }
      i += 1;
      continue;
      label193:
