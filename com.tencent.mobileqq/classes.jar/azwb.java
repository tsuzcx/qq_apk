  ...
  extends azus
{
  ...
  public azwb()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new azwd(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      if ((paramView == null) || (!(paramView instanceof azwe))) {}
    }
    for (paramView = (azwe)paramView;; paramView = null)
    {
      paramBundle = paramView;
      if (paramView == null)
      {
        paramBundle = new azwe();
        localLinearLayout = new LinearLayout(paramContext);
        localLinearLayout.setOrientation(1);
        localLinearLayout.setGravity(17);
        paramView = new LinearLayout.LayoutParams(-2, -2);
        paramView.gravity = 1;
        paramView.setMargins(0, aepi.a(10.0F, localResources), 0, aepi.a(20.0F, localResources));
        localLinearLayout.setLayoutParams(paramView);
        paramView = new NowVideoLayout(paramContext);
        Object localObject = new LinearLayout.LayoutParams(-2, -2);
        paramView.setId(2131377137);
        ...
        localObject = new LinearLayout.LayoutParams(aepi.a(156.0F, localResources), -2);
        ((LinearLayout.LayoutParams)localObject).setMargins(0, 0, 0, 0);
        paramView.setPadding(aepi.a(7.0F, localResources), aepi.a(8.0F, localResources), aepi.a(7.0F, localResources), aepi.a(8.0F, localResources));
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject);
        paramView.setBackgroundResource(2130843275);
        localLinearLayout.addView(paramView);
        localObject = new TextView(paramContext);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
        ((TextView)localObject).setBackgroundColor(localResources.getColor(2131167140));
        ((TextView)localObject).setPadding(0, 0, 0, 0);
        ((TextView)localObject).setTextColor(-16777216);
        ((TextView)localObject).setEllipsize(TextUtils.TruncateAt.END);
        ((TextView)localObject).setTextSize(0, aepi.a(12.0F, localResources));
        ((TextView)localObject).setSingleLine();
        localLayoutParams.setMargins(0, 0, 0, 0);
        paramBundle.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
        ((TextView)localObject).setId(2131379040);
        paramView.addView((View)localObject, localLayoutParams);
        paramContext = new TextView(paramContext);
        localObject = new LinearLayout.LayoutParams(-1, -2);
        paramContext.setBackgroundColor(localResources.getColor(2131167140));
        paramContext.setPadding(0, aepi.a(3.0F, localResources), 0, 0);
        paramContext.setTextColor(-16777216);
        paramContext.setEllipsize(TextUtils.TruncateAt.END);
        paramContext.setTextSize(0, aepi.a(12.0F, localResources));
        paramContext.setSingleLine();
        ((LinearLayout.LayoutParams)localObject).setMargins(0, 0, 0, 0);
        paramBundle.b = paramContext;
        paramContext.setId(2131379043);
      ...
      paramBundle.jdField_a_of_type_ComTencentBizNowNowVideoLayout.setOnLongClickListener(new azwc(this));
  ...
  public boolean a(azwj paramazwj)
  {
    ...
    //   7: aload_1
    //   8: ldc 226
    //   10: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   13: putfield 185	azwb:T	Ljava/lang/String;
    //   16: aload_0
    //   17: aload_1
    //   18: ldc 232
    //   20: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   23: putfield 187	azwb:U	Ljava/lang/String;
    //   26: aload_0
    //   27: aload_1
    //   28: ldc 234
    //   30: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   33: putfield 189	azwb:V	Ljava/lang/String;
    //   36: aload_0
    //   37: aload_1
    //   38: ldc 248
    //   40: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   43: putfield 199	azwb:W	Ljava/lang/String;
    //   46: aload_0
    //   47: aload_1
    //   48: ldc 253
    //   50: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   53: putfield 201	azwb:S	Ljava/lang/String;
    //   56: aload_0
    //   57: aload_1
    //   58: ldc 255
    //   60: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   63: putfield 203	azwb:X	Ljava/lang/String;
    //   66: aload_1
    //   67: ldc 236
    //   69: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   72: astore_3
    //   73: aload_3
    //   74: ifnonnull +68 -> 142
    //   77: iconst_0
    ...
    //   79: aload_0
    //   80: iload_2
    //   81: putfield 195	azwb:k	I
    //   84: aload_1
    //   85: ldc 244
    //   87: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   90: astore_3
    //   91: aload_3
    //   92: ifnonnull +82 -> 174
    //   95: iconst_0
    ...
    //   97: aload_0
    //   98: iload_2
    //   99: putfield 197	azwb:l	I
    //   102: aload_1
    //   103: ldc 246
    //   105: invokevirtual 266	azwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore_1
    //   109: aload_1
