...
public class akvm
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          bcql.a(BaseApplication.getContext(), 0, ajya.a(2131701066), 0).a();
        ...
        for (;;)
        {
          ...
          bcql.a(BaseApplication.getContext(), 0, ajya.a(2131701069), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = bbdj.a(paramActivity, String.format(Locale.getDefault(), ajya.a(2131701073), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694794, new akvn());
          if ((paramActivity != null) && (!paramActivity.isFinishing())) {
            paramList.show();
          }
          axqy.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "frd_select", "notAdd_exp", 0, 0, paramString, String.valueOf(j), "", "");
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    barb.a(paramQQAppInterface, true, localTroopInfo);
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), ajya.a(2131701067), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label745;
      }
      paramString3 = String.format(Locale.getDefault(), ajya.a(2131701070), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + ajya.a(2131701074);
        localObject1 = ajya.a(2131701071);
        i = paramString3.indexOf((String)localObject1);
        j = ((String)localObject1).length();
        localObject1 = new aqvb(paramString1, paramString1, paramString3, 1, -5020, 135178, l2);
        ((aqvb)localObject1).jdField_c_of_type_JavaLangString = paramString3;
        ...
        ((aqvb)localObject1).a(i, i + j, paramString3);
        ...
        label348:
        ((aqvb)localObject1).d = paramString3;
        localObject3 = new MessageForUniteGrayTip();
        ((MessageForUniteGrayTip)localObject3).initGrayTipMsg(paramQQAppInterface, (aqvb)localObject1);
      ...
      {
        axqy.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", (String)localObject2, 0, 0, paramString1, (String)localObject1, "", paramString3);
        if (!QLog.isDevelopLevel()) {
          break;
        }
        ...
        break label108;
        label618:
        paramString3 = String.format(Locale.getDefault(), ajya.a(2131701072), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), ajya.a(2131701068), new Object[] { paramString2 });
        paramInt2 = 0;
        break label187;
        paramString3 = paramString3 + ajya.a(2131701065);
        break label217;
        paramString3 = "";
        break label348;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    ajxl localajxl = (ajxl)paramFriendListHandler.app.getManager(51);
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      if (localAddFrdInfo.uint32_send_req_flag.get() == 1)
      {
        ...
        localajxl.a(Long.toString(localAddFrdInfo.uint64_uin.get()), false);
        bool1 = bool2;
        break label90;
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (ajxl)paramFriendListHandler.app.getManager(51);
      ...
      if (i > 0)
      {
        ...
        if (i >= 0)
        {
          ...
          ((ajxl)localObject).a(Long.toString(l1), true);
          i -= 1;
        }
        else
        {
