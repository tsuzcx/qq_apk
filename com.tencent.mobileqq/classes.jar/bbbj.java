  ...
  extends bbbi
{
  ...
  private RedAppInfo a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    for (paramString = awui.a(paramQQAppInterface, paramString);; paramString = ((bbbq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH)).a(paramString)) {
      return bbbt.a(paramString);
    }
  }
