  ...
  extends bbbg
{
  ...
  public String a;
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new bbbk(this);
  public boolean a;
  ...
  public bbbj(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  private void a(Intent paramIntent, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Adxp != null)
      {
        this.jdField_a_of_type_Adxp.d();
        this.jdField_a_of_type_Adxp = null;
      }
      this.jdField_a_of_type_Adxp = new adxp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity, this.jdField_a_of_type_AndroidContentIntent);
      this.jdField_a_of_type_Adxp.a();
      this.jdField_a_of_type_Adxp.e();
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Boolean) {
        localAccountManager.getQuickRegisterAccount(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_JavaLangString, AppSetting.a(), "8.4.5", this.jdField_a_of_type_MqqObserverAccountObserver);
      }
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.b(2131715830);
        return;
        azoz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
        localAccountManager.sendRegisterBySetPass(paramString2, paramString1, this.jdField_a_of_type_JavaLangString, this.f, this.jdField_e_of_type_Boolean, "8.4.5", this.jdField_a_of_type_MqqObserverAccountObserver);
      }
      return;
    }
