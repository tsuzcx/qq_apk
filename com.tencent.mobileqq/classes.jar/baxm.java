  ...
  extends bayp
{
  ...
  public baxm(QQAppInterface paramQQAppInterface, int paramInt, RecentUser paramRecentUser, long paramLong)
  {
  ...
  private void a()
  {
    ...
    case 2: 
      this.l = this.c;
      this.m = bbgk.a(new String[] { this.e, this.f });
      return;
    case 3: 
      this.l = this.d;
      this.m = bbgk.a(new String[] { this.e, this.f });
      return;
    case 1: 
      this.l = bbgk.a(new String[] { this.c, this.d });
    ...
    this.l = bbgk.a(new String[] { this.c, this.d, this.e });
    this.m = this.f;
  }
  ...
  private void b()
  {
    ...
    {
    default: 
      localObject1 = amtj.a(2131701687);
      if (!bbgk.a(this.jdField_b_of_type_Int)) {
        break;
      }
    }
    for (this.jdField_a_of_type_JavaLangString = (amtj.a(2131701709) + (String)localObject1);; this.jdField_a_of_type_JavaLangString = ((String)localObject1))
    {
      ...
      localObject1 = amtj.a(2131701671);
      break;
      localObject1 = ((amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.troopUin);
      if (localObject1 != null)
      {
      ...
      Object localObject2 = amtj.a(2131701694);
      ...
      localObject2 = ((avsy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).c(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin);
      if (localObject2 != null) {
        this.g = ((PhoneContact)localObject2).name;
      }
      for (;;)
      {
        localObject1 = amtj.a(2131701712);
        break;
        if (localObject1 != null) {
          this.g = ContactUtils.getBuddyName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, true);
        }
      }
      localObject1 = amtj.a(2131701706);
      break;
      localObject1 = amtj.a(2131701677);
      break;
      localObject1 = "QQ电影票临时会话";
      break;
      localObject1 = amtj.a(2131693946);
      break;
    }
  }
  ...
  protected long a(String paramString)
  {
    ...
    long l1 = bbgk.b(paramString, this.c, basn.g);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 2;
    }
    l1 = bbgk.b(paramString, this.d, basn.k);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 3;
    }
    l1 = bbgk.b(paramString, this.e, basn.l);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 1;
    }
    l1 = bbgk.b(paramString, this.g, basn.m);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 4;
    }
    l1 = bbgk.a(paramString, this.f, basn.o, false);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
  ...
  public void a(View paramView)
  {
    ...
    if (bbgk.a(this.jdField_b_of_type_Int))
    {
      ...
      String str2;
      String str3;
      if (!batb.a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin)) {
        switch (this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType())
        {
        default: 
          bbgk.a(this.jdField_b_of_type_JavaLangString, 20, 1, paramView);
      ...
      {
        bbgk.a(localQQAppInterface, str2, str3, str1, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType());
        ...
        return;
        akms.a = true;
        akms.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.troopUin, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType(), this.l, false);
        break;
        akms.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType(), this.l, false);
        break;
        bezm.a(paramView.getContext(), null, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin);
        break;
      }
      label418:
