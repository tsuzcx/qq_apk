  ...
  implements ArkLocalAppMgr.IGetLocalAppPath
{
  ...
  public aaxs(RecommendCommonMessage paramRecommendCommonMessage, ArkRecommendController.AttachAppHolder paramAttachAppHolder, WeakReference paramWeakReference, int paramInt)
  {
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (int j = 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqArkArkRecommendController$AttachAppHolder.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_ComTencentMobileqqArkArkRecommendController$AttachAppHolder.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130838201));
        ...
        ArkAppCenter.a(paramString1, new aaxu(this.jdField_a_of_type_ComTencentMobileqqArkArkRecommendController$AttachAppHolder));
        break;
        paramString1 = null;
        break label88;
        i = 100;
