...
public class aati
{
  ...
  public aati(aatf paramaatf, CustomWebView paramCustomWebView)
  {
  ...
  {
    paramString = bijv.g(paramString);
    bijv.a("catchHtml");
    WebSoService.WebSoState.WebSo3 localWebSo3 = aatf.a(this.jdField_a_of_type_Aatf).a();
    if (localWebSo3 != null)
    {
      WebSoService.a(paramString, localWebSo3.jdField_a_of_type_JavaLangString, localWebSo3.b, Uri.parse(localWebSo3.d));
      return;
    }
    bijv.a("return webSo3 == null");
  }
