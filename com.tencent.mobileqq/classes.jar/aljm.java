...
{
  public aljm(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("tencent.av.v2q.StartVideoChat".equals(paramContext))
    {
      ...
      paramContext = BaseActivity2.$(this.a.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover, 2131366766);
    ...
    if ("tencent.video.q2v.startUploadPTV".equals(paramContext))
    {
      ...
      case 1: 
        ...
        {
          str = "";
          if (this.a.jdField_a_of_type_Alko != null) {
            str = this.a.jdField_a_of_type_Alko.a();
          }
    ...
    for (;;)
    {
      ...
      {
        alio.a("", paramContext, str, "", NewFlowCameraActivity.a(this.a), "");
        if (QLog.isColorLevel()) {
      ...
      if (i == 2)
      {
        ...
        if (bool)
        {
          ...
          bcst.b(null, "dc00898", "", "", "0X8007BB6", "0X8007BB6", 0, 0, "", "", "", "");
