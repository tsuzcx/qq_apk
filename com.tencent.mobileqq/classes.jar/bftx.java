  ...
  implements Manager
{
  ...
  protected int a;
  protected Handler a;
  protected ArrayMap<Long, ArrayList<bftw>> a;
  private anmu jdField_a_of_type_Anmu;
  protected AppInterface a;
  protected String a;
  public WeakReference<bfug> a;
  protected ArrayList<String> a;
  protected HashMap<Long, MessageForUniteGrayTip> a;
  protected List<bfuh> a;
  public boolean a;
  protected ArrayMap<Long, ArrayList<bftw>> b;
  public String b;
  ...
  public bftx(AppInterface paramAppInterface)
  {
    ...
    this.jdField_c_of_type_JavaUtilList.add(anni.a(2131714434));
    this.jdField_d_of_type_JavaUtilList.add(anni.a(2131714420));
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilArrayList = bfpx.a(paramQQAppInterface);
        if (this.jdField_a_of_type_JavaUtilArrayList == null) {
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = bgny.d.matcher(paramMessageRecord.msg);
  ...
  private void a(MessageRecord paramMessageRecord, String paramString1, String paramString2, String paramString3)
  {
    ...
    b(Long.parseLong(paramMessageRecord.frienduin), Long.parseLong(paramString1), paramString3, new bfuc(this, paramString3));
  }
  ...
  private void a(String paramString)
  {
    ...
    bgsg.c(localQQAppInterface.getApplication(), localQQAppInterface.c(), paramString, false);
  }
  ...
  {
    bcst.b(null, "dc00899", "Grp_robot", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static boolean a(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      String str2 = anni.a(2131714422);
      SpannableString localSpannableString = new SpannableString(str2);
      localSpannableString.setSpan(new bftz(str1, paramMessageRecord), 0, str2.length(), 33);
  ...
  public static String b(MessageRecord paramMessageRecord)
  {
    if (b(paramMessageRecord))
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramMessageRecord))) {
        return paramMessageRecord + anni.a(2131714430);
      }
    }
    return null;
  }
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Anmu != null) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))) {
      return;
    }
    this.jdField_a_of_type_Anmu = new bfua(this);
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Anmu != null) && (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null))
    {
  ...
  private void d()
  {
    Object localObject1 = bgsg.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      try
      {
        ...
        localObject2 = bgsg.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      }
    ...
    try
    {
      ...
      if (localObject2 != null) {
        a(((aqzb)localObject2).a(), ((aqzb)localObject2).a());
      }
      return;
    }
  ...
  public bftv a(long paramLong)
  {
    bftv localbftv = new bftv();
    localbftv.jdField_a_of_type_JavaUtilArrayList = a(paramLong);
    localbftv.b = b(paramLong);
    localbftv.jdField_a_of_type_Int = a(paramLong);
    return localbftv;
  }
  ...
  public ArrayList<bftw> a(long paramLong)
  {
    ...
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
      {
        if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong)))
        {
          ...
          while (localIterator.hasNext())
          {
            bftw localbftw = (bftw)localIterator.next();
            if (localbftw.a()) {
              localArrayList.add(localbftw);
            }
          }
        }
      }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, bfuf parambfuf)
  {
    ...
    nir.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfud(this, parambfuf), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, String paramString, bfuf parambfuf)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    ...
    localReqBody.robot_uin.set(paramLong2);
    nir.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfue(this, parambfuf), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(long paramLong, int paramInt, bfuf parambfuf)
  {
    a(4, 0L, paramLong, paramInt, parambfuf);
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (localMessageForUniteGrayTip != null)
    {
      ...
      auxd.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, localMessageForUniteGrayTip);
    }
  }
      ...
      for (;;)
      {
        synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
        {
          if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong1)))
          {
            ...
            bftw localbftw = (bftw)((Iterator)localObject1).next();
            if (localbftw.a() != paramLong2) {
              continue;
            }
            ...
            if (!localbftw.a())
            {
              localObject1 = localObject4;
              if (paramInt == 1) {
                localObject1 = localbftw;
              }
            }
            localbftw.a(paramInt);
            if (localObject1 != null)
            {
              localArrayList.remove(localObject1);
              localArrayList.add(0, localObject1);
              if (QLog.isColorLevel()) {
                QLog.d("TroopRobotManager", 2, "onSetTroopRobot move position " + ((bftw)localObject1).a());
              }
            }
          }
          return;
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, bfuf parambfuf)
  {
    a(1, paramLong1, paramLong2, paramInt, parambfuf);
  }
  
  public void a(long paramLong1, long paramLong2, String paramString, bfuf parambfuf)
  {
    a(3, paramLong1, paramLong2, paramString, parambfuf);
  }
  
  public void a(long paramLong, String paramString, bfuf parambfuf)
  {
    a(Long.valueOf("1").longValue(), paramLong, paramString, parambfuf);
  }
  
  public void a(long paramLong, ArrayList<bftw> paramArrayList)
  {
  ...
  public void a(long paramLong, ArrayList<bftw> arg3, int paramInt)
  {
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
  ...
  {
    String str = bglf.h(paramQQAppInterface, paramChatMessage.frienduin, paramChatMessage.senderuin);
    paramEditText = bfmd.a(paramQQAppInterface, paramContext, paramSessionInfo.jdField_a_of_type_JavaLangString, paramChatMessage.senderuin, str, false, paramEditText, true, true);
    paramContext = new ArrayList();
    paramEditText = bfmd.a(paramEditText, paramContext);
    ...
    try
    {
      ...
      new bcsy(paramQQAppInterface).a("dc00899").b("Grp_robot").c("sub_page").d("next_msg_clk").a(new String[] { paramChatMessage.frienduin, paramSessionInfo }).a();
      return;
    }
  ...
  public void a(bfug parambfug)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambfug);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localArrayList = bfpx.b(paramQQAppInterface);
      if (localArrayList == null)
      {
        ...
        if ((paramArrayList == null) || (paramArrayList.size() == 0))
        {
          ...
          bfpx.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
          bfpx.a(paramQQAppInterface, false);
    ...
    for (;;)
    {
      ...
      {
        bfpx.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
        bfpx.b(paramQQAppInterface, localArrayList);
        if (paramArrayList.size() <= 0) {
          break label392;
        }
        bfpx.a(paramQQAppInterface, true);
        bfpx.c(paramQQAppInterface, true);
        break label392;
        break;
        i -= 1;
        break label182;
    ...
    try
    {
      ...
      if (paramRobot.uin_range.has())
      {
        ...
        while ((i < paramRobot.uin_range.size()) && (i < 5))
        {
          ...
          bfuh localbfuh = new bfuh();
          localbfuh.a = localUinRange.start_uin.get();
          localbfuh.b = localUinRange.end_uin.get();
          this.jdField_a_of_type_JavaUtilList.add(localbfuh);
          i += 1;
        }
      }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      b(Long.parseLong(paramString1), Long.parseLong(paramString2), paramString3, new bfub(this, paramString3));
      a();
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (localJSONArray != null) {
      bgsg.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localJSONArray.toString());
    }
    paramJSONObject = paramJSONObject.optJSONObject("robot_voice_tail");
    if (paramJSONObject != null) {
      bgsg.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramJSONObject.toString());
    }
    d();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        bfuh localbfuh = (bfuh)this.jdField_a_of_type_JavaUtilList.get(i);
        if ((localbfuh != null) && (paramLong >= localbfuh.a) && (paramLong <= localbfuh.b)) {
          bool1 = true;
        }
      }
      else
  ...
  public boolean a(Context paramContext, String paramString, long paramLong)
  {
    if (a(paramLong))
    {
      bfpx.a(paramContext, paramString, String.valueOf(paramLong));
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool2 = false;
    if (!bfpx.d(paramQQAppInterface, paramString2))
    {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord.atInfoList != null) && (paramMessageRecord.atInfoList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        if (a(((MessageForText.AtTroopMemberInfo)localObject).uin))
        {
          ...
          str1 = bglf.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramMessageRecord.frienduin, "" + ((MessageForText.AtTroopMemberInfo)localObject).uin);
          ...
          for (;;)
          {
            ...
            if (str2.equals(((String)this.jdField_c_of_type_JavaUtilList.get(j)).replace("$ROBOTNICK$", str1)))
            {
              ...
              bcst.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "conti_dialog_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_c_of_type_JavaUtilList.get(i), "");
              return true;
            }
            j += 1;
          }
    ...
    while (i < this.jdField_b_of_type_JavaUtilList.size())
    {
      ...
      for (localObject = "";; localObject = ((String)localObject).toUpperCase().replaceAll(" ", ""))
      {
        ...
        bcst.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "keyword_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_b_of_type_JavaUtilList.get(i), "");
        return true;
      }
      i += 1;
    }
  ...
  {
    boolean bool2 = false;
    paramString2 = bglf.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramString3, "" + paramString2);
  ...
  public byte[] a()
  {
    return bgmg.a(BaseApplication.getContext().getFileStreamPath("troop_robot_config"));
  }
  
  public byte[] a(String paramString1, String paramString2)
  {
    return bgmg.a(BaseApplication.getContext().getFileStreamPath("troop_robot_panel_data_" + paramString1 + "_" + paramString2));
  }
  
  public ArrayList<bftw> b(long paramLong)
  {
    ArrayList localArrayList = new ArrayList(0);
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
  ...
  public void b(int paramInt, long paramLong1, long paramLong2, String paramString, bfuf parambfuf)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    localReqBody.cmd.set(paramInt, true);
    localReqBody.group_id.set(paramLong1, true);
    localReqBody.keyword.set(paramString, true);
    localReqBody.robot_uin.set(paramLong2);
    nir.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfty(this, parambfuf), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void b(long paramLong1, long paramLong2, String paramString, bfuf parambfuf)
  {
    b(2, paramLong1, paramLong2, paramString, parambfuf);
  }
  
  public void b(long paramLong, String paramString, bfuf parambfuf)
  {
    b(2, Long.valueOf("1").longValue(), paramLong, paramString, parambfuf);
  }
