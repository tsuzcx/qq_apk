  ...
  implements axmg
{
  ...
  bhxh(String paramString, int paramInt1, int paramInt2)
  {
  ...
  public axmh a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localaxmh.jdField_a_of_type_Float = (m / k);
        localaxmh.jdField_a_of_type_Int = ((int)(this.jdField_a_of_type_Int * localaxmh.jdField_a_of_type_Float * localaxmh.jdField_a_of_type_Float + 0.5F));
        if (localaxmh.jdField_a_of_type_Int <= i * 1024) {
          break label382;
        }
        localaxmh.jdField_a_of_type_Int = (i * 1024);
        paramInt2 = paramInt1;
        if (this.jdField_b_of_type_Int <= paramInt1) {
          paramInt2 = this.jdField_b_of_type_Int;
        }
        localaxmh.jdField_b_of_type_Int = paramInt2;
        localaxmh.jdField_b_of_type_Boolean = a();
        if (QLog.isColorLevel()) {
          QLog.d("TroopHomeworkHelper", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localaxmh.jdField_b_of_type_Boolean);
        }
        return localaxmh;
      }
      ...
      continue;
      label382:
      if (localaxmh.jdField_a_of_type_Int < j * 1024)
      {
        localaxmh.jdField_a_of_type_Int = (j * 1024);
        continue;
        paramInt2 = 0;
        paramInt1 = 0;
        j = 0;
