  ...
  extends bfih
{
  ...
  public bfij(bfie parambfie, int paramInt)
  {
    super(parambfie, paramInt);
    this.jdField_b_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new bfik(this);
  }
  
  public void a()
  {
    String str1 = this.jdField_a_of_type_Bfie.jdField_b_of_type_JavaLangString;
    String str2 = this.jdField_a_of_type_Bfie.jdField_a_of_type_JavaLangString;
  ...
  protected boolean b(String paramString)
  {
    ...
    do
    {
      ...
      localPttShortVideoFileInfo.uint32_file_time.set((int)this.jdField_a_of_type_Bfie.jdField_a_of_type_Long);
  ...
  public void c()
  {
    ...
    for (;;)
    {
      bfif.a().a(bool, this.jdField_a_of_type_Int, localBundle);
      return;
