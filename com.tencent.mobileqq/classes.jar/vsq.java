  ...
  implements DownCallBack
{
  ...
  public vsq(MultiForwardChatPie paramMultiForwardChatPie)
  {
    ...
    for (;;)
    {
      ...
      if ((paramDownResult.jdField_a_of_type_Int == 0) && (paramDownResult.jdField_a_of_type_ArrayOfByte != null))
      {
        ...
        if ((localObject2 != null) && (((ArrayList)localObject2).size() == 1))
        {
          ...
          localMultiForwardChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vsr(this, localMultiForwardChatPie, (CharSequence)localObject1));
        }
      }
      for (;;)
      {
        ...
        localMultiForwardChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vss(this, localMultiForwardChatPie));
      }
    }
  }
}
