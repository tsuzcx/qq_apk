...
public class six
{
  ...
  {
    if (bmhv.b(paramAppRuntime, "VIDEO_FEEDS_SOFT_AD_LOCAL_CONFIG_DATE")) {
  ...
  {
    if (((paramView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) && (paramView.getTag(2131362716) == null))
    {
      ...
      localValueAnimator.addUpdateListener(new sjd(i, localMarginLayoutParams, j, paramView));
      localValueAnimator.addListener(new sje(paramView));
      paramView.setTag(2131362716, localValueAnimator);
  ...
  public static ObjectAnimator a(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localObjectAnimator1.addListener(new sji(paramView));
      localObjectAnimator1.start();
    }
    for (;;)
    {
      ...
      paramView.setTag(2131376126, localObjectAnimator1);
      ...
      if ((paramInt1 == 8) || (paramInt1 == 4))
      {
        ...
        localObjectAnimator1.start();
        paramView.setLayerType(2, null);
        localObjectAnimator1.addListener(new sjj(paramView));
        localObjectAnimator1.start();
      }
    }
  }
  ...
  public static JumpMode a(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (i == 1)
    {
      if (qxl.a(paramBaseArticleInfo.bytes_jump_url)) {
        return pkh.a(paramActivity, qxl.b(paramBaseArticleInfo.bytes_jump_url));
      }
    }
    else if (i == 2)
    {
      if ((qxl.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bhfn.a(paramActivity, qxl.b(paramBaseArticleInfo.bytes_jump_bundle))))
      {
        a(paramActivity, qxl.b(paramBaseArticleInfo.bytes_jump_schema));
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      localVideoInfo.jdField_q_of_type_Int = paramBundle.getInt("VIDEO_STRATEGY_ID", 0);
      ...
      localVideoInfo.jdField_q_of_type_Boolean = paramBundle.getBoolean("VIDEO_ACCOUNT_IS_FOLLOWED");
      localVideoInfo.jdField_r_of_type_Boolean = paramBundle.getBoolean("VIDEO_IS_DIANZAN");
      localVideoInfo.t = paramBundle.getInt("VIDEO_DIAN_ZAN_COUNT");
  ...
  public static Long a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      if (ppe.g(paramBaseArticleInfo)) {
        return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.jdField_a_of_type_Long);
      }
      return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Long);
    }
  ...
  public static String a(int paramInt)
  {
    ...
    return f(paramInt) + anvx.a(2131715520);
  }
  ...
  public static String a(VideoInfo paramVideoInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1) {}
    for (String str = pjj.jdField_g_of_type_JavaLangString;; str = pjj.k)
    {
      if (paramBoolean2) {
      ...
      return str + bhcu.encodeToString(String.valueOf(paramVideoInfo.j).getBytes(), 2) + "&rowkey=" + paramVideoInfo.jdField_g_of_type_JavaLangString + "&last_scene_type=3";
    }
  }
  ...
  public static JSONObject a(String paramString, List<spc> paramList, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramList != null)
      {
        ...
        {
          spc localspc = (spc)paramList.next();
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      ...
      if (paramBaseArticleInfo.mSocialFeedInfo != null)
      {
        ...
        i = j;
        localObject1 = localObject2;
        if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw != null)
        {
          bool1 = bool2;
          l1 = l2;
          i = j;
          ...
          if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq != null)
          {
            ...
            i = j;
            localObject1 = localObject2;
            if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b != null)
            {
              bool1 = bool2;
              l1 = l2;
              i = j;
              localObject1 = localObject2;
              if (!paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.isEmpty())
              {
                bool1 = true;
                l1 = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.a.longValue();
                i = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b.intValue();
                localObject1 = ((rrs)paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.get(0)).jdField_b_of_type_JavaLangString;
              }
            }
          }
        }
  ...
  public static void a(Context paramContext, Bundle paramBundle, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBoolean = plw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1));
        for (;;)
        {
          if (!paramBoolean) {
            break label247;
          ...
          ssn.a(paramContext, paramBundle);
          ...
          if (paramBundle != null) {
            paramBoolean = plw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), paramBundle.jdField_b_of_type_Int, paramBundle.jdField_c_of_type_Int, paramBundle.jdField_d_of_type_Int);
          } else {
            paramBoolean = plw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue(), localBundle);
          }
        }
      }
  ...
  {
    a(paramContext, paramTextView, anvx.a(2131715566), anvx.a(2131715571), bhyk.a("kandian"), null);
  }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1.setSpan(new siy(paramString3, paramContext, paramOnClickListener), i, j, 33);
  ...
  public static void a(Context paramContext, UrlJumpInfo paramUrlJumpInfo)
  {
    if ((paramUrlJumpInfo != null) && (paramContext != null))
    {
      ...
      if (!TextUtils.isEmpty(paramUrlJumpInfo.jdField_a_of_type_JavaLangString)) {
        pkh.a(paramContext, paramUrlJumpInfo.jdField_a_of_type_JavaLangString);
      }
    }
    for (;;)
    {
      ...
      {
        if (!osg.a(paramUrlJumpInfo.jdField_b_of_type_JavaLangString))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
        ...
        if (bhfn.a(paramContext, paramUrlJumpInfo.jdField_b_of_type_JavaLangString)) {
  ...
  public static void a(View paramView)
  {
    ...
    paramView = paramView.getTag(2131376126);
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new sjk(paramView));
        paramView.clearAnimation();
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new sjl(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 0)
      {
        ...
        paramView.setLayerType(2, null);
        localObjectAnimator2.addListener(new sjg(paramView));
    ...
    localObjectAnimator1.setRepeatCount(0);
    paramView.setLayerType(2, null);
    localObjectAnimator1.addListener(new sjh(paramView));
    localObjectAnimator1.start();
  }
  ...
  public static void a(TextView paramTextView, spn paramspn, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    bmhv.i(pkh.a());
    if (paramTextView != null) {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int != 0)
    {
      if (paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null)
      {
        ...
        if (paramVideoInfo.jdField_b_of_type_Boolean)
        {
          ...
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b = new ArrayList();
          ...
          localrrs.jdField_a_of_type_Long = paramVideoInfo.jdField_d_of_type_Int;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.add(localrrs);
        }
  ...
  public static void a(VideoInfo paramVideoInfo, TextView paramTextView)
  {
    ...
    while (i >= 0)
    {
      ...
      {
        tnp localtnp = new tnp(-12541697);
        localtnp.a(new sjf(paramTextView, localRichTitleInfo, paramVideoInfo));
        ...
        localSpannableStringBuilder.setSpan(localtnp, 0, localSpannableStringBuilder.length(), 33);
        paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean, String paramString)
  {
    ...
    ((oma)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.COLUMN_SUBSCRIBE_HANDLER)).a(paramInt, paramBoolean, paramString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    sjb localsjb = new sjb(paramString1, paramBoolean1);
    if (paramBoolean1) {}
    for (int i = 2;; i = 1)
    {
      localqia.a(paramQQAppInterface, paramString1, true, paramString2, localsjb, i, paramBoolean2);
      return;
    }
  }
  ...
  {
    VideoReport.setElementParams(paramObject, new pti().a(paramVideoInfo).c(paramString1).d(paramString2).a());
  }
  ...
  public static void a(String paramString1, String paramString2, TextView paramTextView)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      try
      {
        pic.a(paramTextView, paramString1);
  ...
  {
    bmhv.w(paramAppRuntime, paramInt);
  }
  
  public static void a(AppRuntime paramAppRuntime, Activity paramActivity)
  {
    if (qec.a(paramActivity, true)) {
      bhdj.a(paramActivity, 230, paramActivity.getString(2131717946), paramActivity.getString(2131717945), 2131690697, 2131717944, new sjc(), null).setMessageCount(null).show();
    }
  }
  
  public static void a(spk paramspk, View paramView)
  {
    if (!plw.a()) {}
    do
    {
    ...
    if (!TextUtils.isEmpty(str)) {
      paramspk.jdField_b_of_type_JavaLangString = str;
    }
    paramspk.j = paramView.getNativeView().getWidth();
    paramspk.k = paramView.getNativeView().getHeight();
  }
  ...
  public static boolean a(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (i == 1)
    {
      if (qxl.a(paramBaseArticleInfo.bytes_jump_url))
      {
        pkh.a(paramActivity, qxl.b(paramBaseArticleInfo.bytes_jump_url));
        return true;
      }
    }
    else if ((i == 2) && (qxl.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bhfn.a(paramActivity, qxl.b(paramBaseArticleInfo.bytes_jump_bundle))))
    {
      a(paramActivity, qxl.b(paramBaseArticleInfo.bytes_jump_schema));
      return true;
    }
  ...
  {
    String str = piv.a(paramBaseArticleInfo);
    if (!TextUtils.isEmpty(str))
    {
      if (rnz.a(str))
      {
        pqx.a(paramContext, paramBaseArticleInfo, str);
        return true;
      }
      a(paramContext, str);
      return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    try
    {
      boolean bool = qfq.a(paramLong, null);
      return bool;
    }
  ...
  public static String b(int paramInt)
  {
    ...
    return f(paramInt) + anvx.a(2131715565);
  }
  ...
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1 = new SpannableString(paramString1);
    paramString1.setSpan(new siz(paramTextView), i, j, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(paramString1);
    paramTextView.setOnClickListener(new sja(paramString3, paramContext, paramOnClickListener));
  }
  ...
  {
    if (paramLong <= 0L) {
      return anvx.a(2131715584);
    }
    return b(paramLong) + anvx.a(2131715580);
  }
  ...
  public static String e(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt >= 10004999)
      {
        ...
        return jdField_d_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + anvx.a(2131715532);
      }
      if (paramInt >= 10000)
      {
        ...
        return jdField_c_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + anvx.a(2131715512);
      }
    } while (paramInt <= 0);
    return paramInt + "";
  }
  ...
  private static String f(int paramInt)
  {
    ...
    if (paramInt >= 100000000) {
      str = jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 100000000.0D) + anvx.a(2131715559);
    }
    do
    {
      return str;
      if (paramInt >= 10000) {
        return jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + anvx.a(2131715557);
      }
    } while (paramInt < 0);
    return paramInt + "";
  }
