...
{
  six(sis paramsis, String paramString1, String paramString2, StoryVideoItem paramStoryVideoItem)
  {
    super(paramString1);
  }
  ...
  {
    paramJobContext = new spl(new ErrorMessage(), this.jdField_a_of_type_JavaLangString, true);
    ...
    sgi.a().dispatch(paramJobContext);
    return null;
  }
}
