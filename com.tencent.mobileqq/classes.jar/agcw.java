...
public class agcw
{
  static volatile agcw jdField_a_of_type_Agcw;
  private int jdField_a_of_type_Int;
  private final String jdField_a_of_type_JavaLangString = "DoodleResHelper";
  private Map<Integer, agcx> jdField_a_of_type_JavaUtilMap;
  
  public static agcw a()
  {
    if (jdField_a_of_type_Agcw == null) {}
    try
    {
      if (jdField_a_of_type_Agcw == null) {
        jdField_a_of_type_Agcw = new agcw();
      }
      return jdField_a_of_type_Agcw;
    }
    finally {}
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_1
    //   5: iload_2
    //   6: invokevirtual 52	agcw:a	(II)Ljava/lang/String;
    //   9: astore 8
    //   11: aload 8
    ...
    //   33: aload 8
    //   35: iconst_0
    //   36: invokespecial 66	agcw:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   107: aload 8
    //   109: iconst_0
    //   110: invokespecial 66	agcw:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   113: aload 4
  ...
  public Drawable a(int paramInt1, int paramInt2)
  {
    ...
    //   14: iload_1
    //   15: iload_2
    //   16: invokevirtual 115	agcw:b	(II)Ljava/lang/String;
    //   19: astore 6
    //   21: aload 6
    ...
    //   35: aload 6
    //   37: iconst_1
    //   38: invokespecial 66	agcw:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   105: aload 6
    //   107: iconst_1
    //   108: invokespecial 66	agcw:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   111: aload 4
  ...
  public Drawable a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject3).mFailedDrawable = ((Context)localObject2).getResources().getDrawable(2130838024);
      ((URLDrawable.URLDrawableOptions)localObject3).mLoadingDrawable = ((Context)localObject2).getResources().getDrawable(2130838024);
  ...
  public void a(int paramInt1, int paramInt2, View paramView, bbye parambbye)
  {
    if (Looper.getMainLooper() != Looper.myLooper()) {
      new Handler(Looper.getMainLooper()).post(new DoodleResHelper.1(this, paramInt1, paramInt2, paramView, parambbye));
    }
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ScribbleResMgr.a().a(localQQAppInterface, 3, paramInt2, paramView, parambbye);
        return;
      }
    } while ((paramInt1 != 1) && (paramInt1 != 2));
    ScribbleResMgr.a().a(localQQAppInterface, 4, paramInt2, paramView, parambbye);
  }
  ...
  public void a(Bitmap paramBitmap)
  {
    ...
    {
      agcx localagcx = (agcx)((Iterator)localObject).next();
      if ((localagcx.jdField_a_of_type_JavaLangRefWeakReference != null) && (localagcx.jdField_a_of_type_JavaLangRefWeakReference.get() == paramBitmap))
      {
        localagcx.jdField_a_of_type_Boolean = true;
        QLog.d("DoodleResHelper", 2, "releaseBitmap succ:" + this.jdField_a_of_type_JavaUtilMap.size());
        return;
      }
    }
    localObject = new agcx(this);
    ((agcx)localObject).b = paramBitmap.getHeight();
    ((agcx)localObject).jdField_a_of_type_Int = paramBitmap.getWidth();
    ((agcx)localObject).jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBitmap);
    ((agcx)localObject).jdField_a_of_type_Boolean = true;
  ...
  public Bitmap b(int paramInt1, int paramInt2)
  {
    ...
    //   39: aload 6
    //   41: iconst_0
    //   42: invokespecial 66	agcw:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   89: aload 6
    //   91: iconst_0
    //   92: invokespecial 66	agcw:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   95: aload 4
  ...
  public void b(int paramInt1, int paramInt2, View paramView, bbye parambbye)
  {
    if (Looper.getMainLooper() != Looper.myLooper()) {
      new Handler(Looper.getMainLooper()).post(new DoodleResHelper.2(this, paramInt1, paramInt2, paramView, parambbye));
    }
    QQAppInterface localQQAppInterface;
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ScribbleResMgr.a().a(localQQAppInterface, 1, paramInt2, paramView, parambbye);
        return;
      }
    } while ((paramInt1 != 1) && (paramInt1 != 2));
    ScribbleResMgr.a().a(localQQAppInterface, 2, paramInt2, paramView, parambbye);
  }
  ...
  public Bitmap c(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject5 = (agcx)((Map.Entry)((Iterator)localObject4).next()).getValue();
        if ((localObject5 == null) || (((agcx)localObject5).jdField_a_of_type_JavaLangRefWeakReference == null) || (((agcx)localObject5).jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          ((Iterator)localObject4).remove();
          QLog.d("DoodleResHelper", 2, "getBitmap remove a invalid item");
          continue;
        }
        if (!((agcx)localObject5).jdField_a_of_type_Boolean) {
          continue;
        }
      }
      finally {}
      if ((((agcx)localObject5).b == paramInt2) && (((agcx)localObject5).jdField_a_of_type_Int == paramInt1))
      {
        if (((agcx)localObject5).jdField_a_of_type_JavaLangRefWeakReference != null) {}
        label233:
        Object localObject3;
        for (Object localObject2 = (Bitmap)((agcx)localObject5).jdField_a_of_type_JavaLangRefWeakReference.get(); localObject2 != null; localObject3 = null)
        {
          QLog.d("DoodleResHelper", 2, "getBitmap find idle :" + this.jdField_a_of_type_JavaUtilMap.size());
          ((agcx)localObject5).jdField_a_of_type_Boolean = false;
          return localObject2;
          QLog.d("DoodleResHelper", 2, "getBitmap add new item");
          localObject2 = new agcx(this);
          ((agcx)localObject2).b = paramInt2;
          ((agcx)localObject2).jdField_a_of_type_Int = paramInt1;
          try
          {
            localObject4 = Bitmap.createBitmap(paramInt1, paramInt2, Bitmap.Config.ARGB_8888);
            ((agcx)localObject2).jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject4);
            ((agcx)localObject2).jdField_a_of_type_Boolean = false;
