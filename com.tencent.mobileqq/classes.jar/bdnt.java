  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  public int a;
  private bbhl jdField_a_of_type_Bbhl;
  ...
  static
  {
    jdField_c_of_type_JavaLangString = anni.a(2131709911);
    jdField_b_of_type_ArrayOfJavaLangObject = new Object[0];
    jdField_a_of_type_AndroidTextSpannable$Factory = new bdnu();
    try
    {
  ...
  public bdnt(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public bdnt(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  }
  
  public bdnt(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3) {}
  
  protected bdnt(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (paramInt4 = 1;; paramInt4 = 0)
    {
      ...
      if (paramInt4 != 0)
      {
        localObject2 = (bdoa[])getSpans(paramInt1, paramInt2, bdoa.class);
        if (localObject2 != null)
        {
          ...
          if (paramInt4 < paramInt5)
          {
            ...
            if (((bdoa)localObject3).jdField_c_of_type_Int == 1) {
              ((bdoa)localObject3).jdField_a_of_type_Int &= 0x7FFFFFFF;
            }
            for (;;)
            {
              paramInt4 += 1;
              break;
              if (((bdoa)localObject3).jdField_c_of_type_Int == 2) {
                ((bdoc)localObject3).jdField_b_of_type_Boolean = false;
              }
            }
          }
        }
      ...
      {
        ((bctj)localObject3).a(null, "qq_url_length_report", bool, 0L, 0L, (HashMap)localObject2, null);
        if (this.e.length() < 1000) {
          a();
        }
      ...
      bctj.a(BaseApplication.getContext()).a(null, "qqTextData", false, 0L, 0L, (HashMap)localObject2, null);
      return;
    }
  }
  
  public bdnt(CharSequence paramCharSequence, int paramInt1, int paramInt2, MessageRecord paramMessageRecord)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  ...
  private int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, StringBuilder paramStringBuilder)
  {
    ...
    if (k < paramInt2)
    {
      ...
      if ((paramInt3 & 0x4) == 4)
      {
        ...
        a(new bdoa(i, paramInt4, 1), k, k + 2, 33);
        i = k + 1;
        k = j + 1;
        paramInt1 += 1;
        j = i;
    ...
    for (;;)
    {
      ...
      if ((m >= 255) && (k + 4 < i5))
      {
        ...
        {
          bool2 = true;
          a(new bdoc(arrayOfChar, paramInt4, bool1, bool2), k, k + 5, 33);
          i = 2;
          if (i >= 5) {
            break label504;
          }
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    localbkho.a(String.format(paramContext.getString(2131694053), new Object[] { paramString }));
    localbkho.a(2131691150, 1);
    localbkho.a(2131689610, 1);
    localbkho.c(2131690582);
    localbkho.a(new bdnz(bkgh.a(new bdny(paramContext, paramString, localbkho)).a(1000L)));
    localbkho.show();
  }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 0)
    {
      localbkho.a(String.format(paramContext.getString(2131694052), new Object[] { paramString1 }));
      localbkho.a(2131691437, 1);
      localbkho.a(2131691140, 1);
      localbkho.a(2131689604, 1);
      localbkho.a(2131689569, 1);
      localbkho.a(2131693155, 1);
    }
    for (;;)
    {
      localbkho.c(2131690582);
      localbkho.a(new bdnv(paramInt, paramString1, paramContext, paramString2, localbkho));
      localbkho.show();
      return;
      if (paramInt == 1)
      {
        localbkho.a(String.format(paramContext.getString(2131694053), new Object[] { paramString1 }));
        localbkho.a(2131691437, 1);
        localbkho.a(2131691140, 1);
        localbkho.a(2131689604, 1);
      }
      ...
      {
        localbkho.a(String.format(paramContext.getString(2131693455), new Object[] { paramString1 }));
        localbkho.a(2131717754, 1);
        localbkho.a(2131691140, 1);
      }
      else if (paramInt == 3)
      {
  ...
  private static void c(String paramString1, String paramString2)
  {
    try
    {
      bcst.b((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(jdField_a_of_type_JavaLangString), "dc00898", "", "", paramString1, paramString2, 0, 0, "", "", "", "");
      return;
    }
  ...
  private static void d(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      {
        bcst.b(localQQAppInterface1, "P_CliOper", "Grp_join", "", "send", "Clk_url", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString2, "");
        return;
      }
    }
    catch (ClassCastException localClassCastException)
    {
      ...
      bcst.b(localQQAppInterface2, "P_CliOper", "Grp_join", "", "send", "Clk_item", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString1, "");
      return;
    }
    catch (AccountNotMatchException paramString1) {}
  }
  ...
  public bdnt a(String paramString, boolean paramBoolean, int... paramVarArgs)
  {
    bdnt localbdnt = new bdnt("", 0);
    localbdnt.jdField_d_of_type_Int = this.jdField_d_of_type_Int;
    localbdnt.jdField_c_of_type_Int = this.jdField_c_of_type_Int;
    localbdnt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    localbdnt.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    localbdnt.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localbdnt.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localbdnt.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localbdnt.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
    int i = 0;
    int j = 0;
    ...
    if (paramBoolean)
    {
      ...
      int k = 0;
      while (k < localbdnt.jdField_a_of_type_ArrayOfJavaLangObject.length)
      {
      ...
      if (i != 0) {
        localbdnt.a(0, paramString.length(), i, j, localStringBuilder);
      }
      localbdnt.jdField_d_of_type_JavaLangString = (paramString + this.jdField_d_of_type_JavaLangString);
      localbdnt.e = localStringBuilder.toString();
    ...
    {
      if (i != 0) {
        localbdnt.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
      }
      return localbdnt;
      localStringBuilder = new StringBuilder().append(paramString).append(this.e);
      if (i != 0) {
        localbdnt.a(this.e.length(), this.e.length() + paramString.length(), i, j, localStringBuilder);
      }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (j < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject instanceof bdoa))
      {
        ...
        localObject = (bdoa)localObject;
        switch (((bdoa)localObject).jdField_c_of_type_Int)
        {
        default: 
          i = k;
        }
      ...
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          continue;
          localObject = arvq.a(((bdoa)localObject).jdField_a_of_type_Int & 0x7FFFFFFF);
          localStringBuffer.replace(n + k, i1 + k, (String)localObject);
          i = k + (((String)localObject).length() - (i1 - n));
        }
      }
  ...
  protected void a()
  {
    Object localObject = bdoh.a(this.e);
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      localObject = ((List)localObject).iterator();
      while (((Iterator)localObject).hasNext())
      {
        bdni localbdni = (bdni)((Iterator)localObject).next();
        a(new bdob(this, localbdni.jdField_a_of_type_JavaLangString), localbdni.jdField_a_of_type_Int, localbdni.jdField_b_of_type_Int, 33);
      }
    }
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (paramInt == 2)
    {
      ...
      localObject3 = (anmw)((QQAppInterface)localObject1).getManager(51);
      if (paramInt != 0) {
        break label402;
      }
      if (bgnt.a()) {
      ...
      localbkho.a(String.format(paramContext.getString(2131694053), new Object[] { paramString }));
      localbkho.a(2131691140, 1);
      localbkho.a(2131691986, 1);
      localbkho.a(2131691437, 1);
      localbkho.a(2131689604, 1);
      bcst.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", bbhl.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      bcst.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800B0C0", "0X800B0C0", bbhl.a(paramMessageRecord.istroop), 0, "", "", "", "");
    }
    for (;;)
    {
      localbkho.c(2131690582);
      localbkho.a(new bdnw(this, paramContext, paramString, (QQAppInterface)localObject1, i, paramMessageRecord, paramInt, localbkho));
      localbkho.a(new bdnx(this, (QQAppInterface)localObject1, i));
      localbkho.show();
      return;
      i = 4;
      break;
      label363:
      if (this.jdField_a_of_type_Bbhl == null) {
        this.jdField_a_of_type_Bbhl = new bbhl(this.f);
      }
      this.jdField_a_of_type_Bbhl.a((QQAppInterface)localObject1, paramContext, paramString, (ChatMessage)paramMessageRecord);
      return;
      label402:
      if (paramInt == 1)
      {
        if (!bgnt.a())
        {
          ...
          localbkho.a(2131691437, 1);
          localbkho.a(2131689604, 1);
          if ((!paramMessageRecord.isSend()) && (((anmw)localObject3).b(paramMessageRecord.senderuin)))
          {
            localObject3 = (anip)((QQAppInterface)localObject1).a(2);
            if (localObject3 != null) {
              ((anip)localObject3).a(jdField_a_of_type_JavaLangString, paramMessageRecord.senderuin, 1, 0L, (byte)1, 0L, 0L, null, "", 0L, 10004, null, (byte)0);
            }
            localbkho.a(2131689613, 1);
          }
          bcst.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", bbhl.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
          bcst.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800B0C0", "0X800B0C0", bbhl.a(paramMessageRecord.istroop), 0, "", "", "", "");
        }
      ...
      {
        localbkho.a(String.format(paramContext.getString(2131693455), new Object[] { paramString }));
        localbkho.a(2131691140, 1);
        localbkho.a(2131691986, 1);
        localbkho.a(2131717754, 1);
        bcst.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A924", "0X800A924", bbhl.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      }
      else if (paramInt == 3)
      {
        localbkho.a(String.format(paramContext.getString(2131694053), new Object[] { paramString }));
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    try
    {
      ...
      if ((localObject1 instanceof QQAppInterface)) {
        agjc.a((QQAppInterface)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 5, paramString);
      }
      localObject2 = null;
      ...
      if (bdjg.a((String)localObject1))
      {
        ...
        if (bgnt.d(BaseApplication.getContext()))
        {
          ...
          bcst.b(null, "CliOper", "", "", "0X80061B1", "0X80061B1", 0, 0, "", "", "", "");
          return;
        }
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        continue;
        QQToast.a((Context)localObject2, ((Context)localObject2).getResources().getString(2131691985), 0).b(((Context)localObject2).getResources().getDimensionPixelSize(2131298998));
        continue;
        awri.a(paramView.getContext(), localThrowable, true, true, true, false, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.f);
      }
    }
    for (;;)
    {
      try
      {
        ...
        if (paramView.istroop == 1)
        {
          ...
          bcst.b(null, "CliOper", "", str1, "0X80061B1", "0X80061B1", i, 0, "", "", paramView, paramString);
  ...
  {
    bdnt localbdnt = (bdnt)super.clone();
    localbdnt.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localbdnt.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localbdnt.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localbdnt.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
  ...
  {
    if ((paramObject instanceof bdnt)) {
      return this.jdField_d_of_type_JavaLangString.equals(((bdnt)paramObject).jdField_d_of_type_JavaLangString);
    }
    return false;
  }
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    label73:
    return new bdnt(this.e, paramInt1, paramInt2, this.jdField_a_of_type_Int, this.jdField_d_of_type_Int, this.jdField_c_of_type_Int);
  }
