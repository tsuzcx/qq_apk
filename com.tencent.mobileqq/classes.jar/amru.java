  ...
  implements amry
{
  ...
  amrx jdField_a_of_type_Amrx = amrx.a();
  String jdField_a_of_type_JavaLangString;
  List<amrw> jdField_a_of_type_JavaUtilList;
  Paint b = new Paint();
  int c;
  int d;
  
  public amru(Resources paramResources)
  {
  ...
  public List<amrw> a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        List localList1 = this.jdField_a_of_type_Amrx.a(this);
        ...
        if (i < localList1.size())
        {
          ...
          this.jdField_a_of_type_JavaUtilList.add(new amrv(this, i, localDiyPendantSticker.angle, localDiyPendantSticker.text, localDiyPendantSticker.fontId, localDiyPendantSticker.fontType, j));
          i += 1;
          continue;
        }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((amrw)((Iterator)localObject).next()).a(paramCanvas, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
    }
  }
