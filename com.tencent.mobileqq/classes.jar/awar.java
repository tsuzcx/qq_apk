...
public class awar
  implements Handler.Callback, aumt
{
  private static awar jdField_a_of_type_Awar;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  public int a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  public ConcurrentHashMap<String, atsc> a;
  ...
  {
    if (jdField_a_of_type_Awar == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Awar == null) {
        jdField_a_of_type_Awar = new awar();
      }
      return jdField_a_of_type_Awar;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView)
  {
    ...
    if ((!TextUtils.isEmpty(paramFriends.songName)) && (System.currentTimeMillis() < paramFriends.songEndTime))
    {
      ...
      {
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131698745), new Object[] { paramFriends.songName, paramFriends.singerName });
        if (!(paramTextView instanceof OnlineStatusLyricView)) {
          break label152;
        }
        ((awas)bllv.a().getBusinessHandler(174)).a(paramFriends);
        ((OnlineStatusLyricView)paramTextView).setFriendSession(paramFriends, paramQQAppInterface);
      }
      for (;;)
      {
        azmj.b(null, "dc00898", "", "", "0X800AC92", "0X800AC92", paramFriends.songSourceType, 0, "", "0", "0", "");
        return paramQQAppInterface;
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131698746), new Object[] { paramFriends.songName });
        break;
        label152:
        paramQQAppInterface = aocc.a(paramTextView.getPaint(), paramQQAppInterface, bdkf.a(200.0F));
      }
    }
    return paramQQAppInterface.getString(2131698747);
  }
  ...
  public void a(Activity paramActivity, String paramString)
  {
    ...
    azmj.b(null, "dc00898", "", "", "0X800ABB2", "0X800ABB2", 0, 0, "", "0", "0", "");
  }
  ...
  public boolean a(Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    {
      paramSessionInfo = ((aloz)a().getManager(51)).e(paramSessionInfo.a);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      {
        localawas.a((MusicInfo)localObject, j, bool, QQMusicPlayService.a());
    ...
    awas localawas = (awas)a().a(174);
    Object localObject = QQPlayerService.b();
    if (paramMessage.arg1 == 1) {}
    for (boolean bool = true;; bool = false)
    {
      localawas.a((SongInfo)localObject, i, bool, QQPlayerService.d());
