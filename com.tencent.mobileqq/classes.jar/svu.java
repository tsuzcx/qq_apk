...
public class svu
{
  ...
  private static int a(JSONObject paramJSONObject, swx paramswx)
  {
    int j = -1;
    int i = j;
    ...
    try
    {
      paramswx.jdField_a_of_type_Int = Integer.parseInt(paramJSONObject.getString("moduleType"));
      paramswx.jdField_a_of_type_OrgJsonJSONObject = paramJSONObject;
      i = paramswx.jdField_a_of_type_Int;
      return i;
    }
  ...
  public static ProteusItemData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    for (;;)
    {
      swx localswx = (swx)paramFastWebArticleInfo.jdField_a_of_type_AndroidUtilSparseArray.get(999);
      if (localswx != null) {
        a(localJSONObject, localswx.jdField_a_of_type_OrgJsonJSONObject);
      }
  ...
  public static ProteusItemData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, SparseArray<Float> paramSparseArray)
  {
    ...
    //   17: aload_1
    //   18: aload_3
    //   19: invokestatic 200	svu:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;Lorg/json/JSONObject;)V
    //   22: aload_3
    //   23: aload_0
    //   24: aload_1
    //   25: invokestatic 186	svu:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   28: astore_0
    //   29: aload_0
    //   30: iconst_1
    ...
    //   34: aload_0
    //   35: aload_2
    //   36: invokestatic 207	svu:a	(Landroid/util/SparseArray;)F
  ...
  public static ProteusItemData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, int paramInt3, SparseArray<Float> paramSparseArray)
  {
    ...
    //   19: aload 7
    //   21: aload 8
    //   23: invokestatic 217	swl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   26: astore_2
    //   27: aload 11
    //   29: aload_2
    //   30: aload_3
    ...
    //   39: aload 8
    //   41: iload 9
    //   43: invokestatic 220	swl:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    //   46: aload 11
    //   48: aload_0
    //   49: aload_1
    //   50: invokestatic 186	svu:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   53: astore_0
    //   54: aload_0
    //   55: iconst_1
    ...
    //   59: aload_0
    //   60: aload 10
    //   62: invokestatic 207	svu:a	(Landroid/util/SparseArray;)F
  ...
  static ProteusItemData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, String paramString1, String paramString2, String paramString3, SparseArray<Float> paramSparseArray)
  {
    ...
    //   16: aconst_null
    //   17: iconst_1
    //   18: invokestatic 236	uet:a	(Ljava/lang/String;ILjava/lang/Object;Z)Ljava/net/URL;
    //   21: invokevirtual 239	java/net/URL:toString	()Ljava/lang/String;
    //   24: invokestatic 244	svs:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   27: istore 6
    //   29: aload 7
    //   31: aload_0
    //   32: aload_1
    //   33: invokestatic 186	svu:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   36: astore_0
    //   37: aload_0
    //   38: iconst_1
    ...
    //   42: aload_0
    //   43: aload 5
    //   45: invokestatic 207	svu:a	(Landroid/util/SparseArray;)F
  ...
  public static ProteusItemData a(String paramString, CharSequence paramCharSequence, int paramInt1, int paramInt2, SparseArray<Float> paramSparseArray)
  {
    ...
    //   82: aconst_null
    //   83: aconst_null
    //   84: invokestatic 186	svu:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   87: astore_0
    //   88: aload_0
    //   89: aload 4
    //   91: invokestatic 207	svu:a	(Landroid/util/SparseArray;)F
  ...
  public static ProteusItemData a(String paramString1, String paramString2, SparseArray<Float> paramSparseArray)
  {
    ...
    try
    {
      ...
      localJSONObject.put("attribute_text_size", svv.a());
  ...
  private static String a(long paramLong)
  {
    String str = "";
    if (paramLong > 0L) {
      str = amtj.a(2131715897) + bkwm.a(paramLong, 99990000L, "9999万+", "");
    }
    return str;
  }
  ...
  private static void a(ProteusItemData paramProteusItemData, JSONObject paramJSONObject, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo)
  {
    try
    {
      ...
      paramProteusItemData.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusBeanTemplateBean = ProteusParser.getTemplateBean(syz.a("native_article", true), paramJSONObject);
      return;
    }
  ...
  public static void a(String paramString, SparseArray<swx> paramSparseArray)
  {
    if ((paramString != null) && (paramSparseArray != null)) {
      try
      {
        swx localswx = new swx();
        ...
        while (i < localJSONArray.length())
        {
          ...
          {
            int j = a((JSONObject)localObject, localswx);
            if (-1 != j) {
              paramSparseArray.append(j, localswx);
            }
          }
          i += 1;
        }
  ...
  public static void a(List<BaseData> paramList, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = localObject3;
        localJSONObject.put("interaction_like_count", svr.a(paramFastWebArticleInfo.jdField_a_of_type_Int));
        localObject2 = localObject3;
        localJSONObject.put("like_normalstate_image", localObject1);
        localObject2 = localObject3;
        Iterator localIterator = paramList.iterator();
        localObject1 = localswx;
        localObject2 = localObject3;
        ...
        localswx = (swx)paramFastWebArticleInfo.jdField_a_of_type_AndroidUtilSparseArray.get(2);
        localObject2 = localObject1;
        if (localswx != null)
        {
          localObject2 = localObject1;
      ...
      swt.a(paramList, paramArticleInfo, paramItemShowDispatcher);
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramFastWebArticleInfo.b())
        {
          ...
          {
            paramJSONObject.put("comment_count", bkwm.a(paramFastWebArticleInfo.b, 99990000L, "9999万+", svt.a));
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          if (paramBoolean)
          {
            paramArticleInfo = amtj.a(2131715899);
        ...
        paramArticleInfo = amtj.a(2131715900);
        continue;
        str = "0";
      }
      catch (Exception paramJSONObject)
  ...
  private static void b(JSONObject paramJSONObject, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    try
    {
      ...
      {
        paramJSONObject.put("style_ID", "ReadInjoy_article_operate_cell");
        paramJSONObject.put("biu_text", ooy.a());
        if (!paramFastWebArticleInfo.jdField_a_of_type_Boolean) {
          break label292;
        }
        str = "NativeArticleLikeEnable";
        ...
        if (paramFastWebArticleInfo.jdField_a_of_type_Int > 0)
        {
          paramJSONObject.put("like_count", svr.a(paramFastWebArticleInfo.jdField_a_of_type_Int));
          paramJSONObject.put("like_count_txt_color", "#262626");
        }
        paramJSONObject.put("like_normalstate_image", str);
        if (paramFastWebArticleInfo.c > 0L)
        {
          paramJSONObject.put("biu_count", bkwm.a(paramFastWebArticleInfo.c, 99990000L, "9999万+", "Biu"));
