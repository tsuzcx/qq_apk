  ...
  extends BaseAdapter
{
  ...
  public agpg(QzonePhotoPreviewActivity paramQzonePhotoPreviewActivity, Context paramContext)
  {
    a();
  }
  ...
  private void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoQzonePhotoPreviewActivity.a.setRecyclerListener(new agph(this));
  }
  
  private void a(agpi paramagpi, int paramInt)
  {
    agpf localagpf = (agpf)getItem(paramInt);
    if (localagpf == null)
    {
      QZLog.e("VerticalPictureAdapter", "photoInfo == null");
      return;
    }
    AbsListView.LayoutParams localLayoutParams2 = (AbsListView.LayoutParams)paramagpi.a.getLayoutParams();
    AbsListView.LayoutParams localLayoutParams1 = localLayoutParams2;
    if (localLayoutParams2 == null) {
      localLayoutParams1 = new AbsListView.LayoutParams(-1, -2);
    }
    QZLog.d("VerticalPictureAdapter", 1, new Object[] { "photoInfo.heightWeightProportion:", Float.valueOf(localagpf.jdField_a_of_type_Float) });
    if (localagpf.jdField_a_of_type_Float != 0.0F)
    {
      float f = bbll.a();
      localLayoutParams1.height = ((int)(localagpf.jdField_a_of_type_Float * f));
    }
    paramagpi.a.setLayoutParams(localLayoutParams1);
    paramagpi.a.setImageDrawable(null);
  }
  
  private void b(agpi paramagpi, int paramInt)
  {
    Object localObject = (agpf)getItem(paramInt);
    if ((localObject == null) || (TextUtils.isEmpty(((agpf)localObject).jdField_a_of_type_JavaLangString))) {
      QZLog.e("VerticalPictureAdapter", "loadImageData: bigUrl is empty");
    }
    for (;;)
    {
      return;
      File localFile = new File(((agpf)localObject).jdField_a_of_type_JavaLangString);
      if (localFile.exists())
      {
        localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
        localURLDrawableOptions.mRequestWidth = bbll.a();
        float f = bbll.a();
        localURLDrawableOptions.mRequestHeight = ((int)(((agpf)localObject).jdField_a_of_type_Float * f));
        ...
        try
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null)
            {
              paramagpi.a.setImageDrawable((Drawable)localObject);
              return;
            }
          }
        }
    ...
    localURLDrawableOptions.mRequestWidth = bbll.a();
    localURLDrawableOptions.mRequestHeight = ((int)(bbll.a() * localURLDrawable.jdField_a_of_type_Float));
    localURLDrawableOptions.mLoadingDrawable = aywm.a;
    ...
    paramagpi.a.setImageDrawable(localURLDrawable);
  }
  ...
  {
    agpi localagpi = new agpi(this, null);
    if (paramView == null)
    {
      localagpi.a = new AbstractImageAdapter.URLImageView2(paramViewGroup.getContext());
      localagpi.a.setTag(localagpi);
    }
    for (paramView = localagpi;; paramView = (agpi)paramView.getTag())
    {
