  ...
  implements View.OnTouchListener
{
  ...
  public sdg(CaptureOperateTouchLayout paramCaptureOperateTouchLayout, sdf paramsdf)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (CaptureOperateTouchLayout.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout))
      {
        ...
        localValueAnimator.addUpdateListener(new sdh(this, paramView));
        localValueAnimator.start();
        this.jdField_a_of_type_Sdf.a(true);
      }
      for (;;)
      {
        ...
        break;
        this.jdField_a_of_type_Sdf.a(false);
      }
