  ...
  extends MessageMicro<ExceptionHandle>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "task_id", "errcode", "msg", "version" }, new Object[] { localInteger, localInteger, "", localInteger }, ExceptionHandle.class);
  }
}
