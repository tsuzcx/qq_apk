  ...
  extends MessageMicro<LuckCard>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42 }, new String[] { "luck_card_type", "show_icon_tab", "icon_url", "des_type", "des" }, new Object[] { localInteger, Boolean.valueOf(false), "", localInteger, "" }, LuckCard.class);
  }
}
