...
public class apzv
{
  ...
  private apzv(Activity paramActivity, ArkAppView paramArkAppView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new apzw(this));
    }
  ...
  {
    new apzv(paramActivity, paramArkAppView);
  }
}
