  ...
  implements View.OnClickListener
{
  ...
  public alhr(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  public void a(algh paramalgh)
  {
    this.jdField_a_of_type_Algh = paramalgh;
  }
  ...
  public void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetButton.setText(alpo.a(2131700835));
    }
  ...
  public void b(View paramView)
  {
    ...
    {
      return;
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131375178));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368979));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368977));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131368978));
  }
      ...
      for (;;)
      {
        ...
        if (n < this.jdField_a_of_type_Int)
        {
          ...
          if (i1 < this.jdField_a_of_type_JavaUtilList.size())
          {
            ...
            if (((alhk)this.jdField_a_of_type_JavaUtilList.get(i1)).jdField_b_of_type_Int == 1)
            {
              localObject1 = new RedTouch(this.jdField_b_of_type_AndroidContentContext, localalhm.jdField_a_of_type_AndroidWidgetImageView).a(5).a();
              ((RedTouch)localObject1).a(((axho)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a("103100.103200"));
              localalhm.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838481);
              localalhm.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch = ((RedTouch)localObject1);
              ...
              if (TextUtils.isEmpty(localalhm.jdField_a_of_type_Alhk.jdField_b_of_type_JavaLangString)) {
                break label1322;
              }
              ...
              localalhm.jdField_c_of_type_AndroidWidgetTextView.setText(localalhm.jdField_a_of_type_Alhk.jdField_b_of_type_JavaLangString);
              if (i1 == 0) {
                break label1105;
              }
              f = 3.0F;
              label407:
              i4 = aekt.a(f, this.jdField_b_of_type_AndroidContentContext.getResources());
              ...
              f = 2.0F;
              label489:
              ((RelativeLayout.LayoutParams)localObject1).topMargin = aekt.a(f, this.jdField_b_of_type_AndroidContentContext.getResources());
              ...
              f = 3.0F;
              label608:
              ((RelativeLayout)localObject1).setPadding(0, 0, 0, aekt.a(f, this.jdField_b_of_type_AndroidContentContext.getResources()));
              ...
              ((ImageView)localObject2).postDelayed(new ApolloMainViewBinder.1(this, (ImageView)localObject2, localRelativeLayout, (RelativeLayout)localObject1, localalhm), 200L);
              this.f = -1;
              label1029:
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Algh == null);
        this.jdField_a_of_type_Algh.d();
        if (this.jdField_a_of_type_Boolean)
        {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)paramView.getParent()).findViewById(2131377880));
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_a_of_type_Algh.a();
      return;
    } while (this.jdField_a_of_type_Algh == null);
    this.jdField_a_of_type_Algh.c();
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
