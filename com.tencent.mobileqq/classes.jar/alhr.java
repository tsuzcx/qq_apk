...
public class alhr
{
  ...
  private final afwa jdField_a_of_type_Afwa = new alhs(this);
  private final ally jdField_a_of_type_Ally = new alht(this);
  ...
  private alhr(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, ImageButton paramImageButton, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
  ...
  public static alhr a(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo, ImageButton paramImageButton)
  {
    return new alhr(paramActivity, paramFixedSizeVideoView, paramImageButton, paramQzoneVerticalVideoTopicInfo);
  }
  ...
  private zdw a()
  {
    ...
    {
      zdw localzdw = new zdw();
      localzdw.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.c();
      localzdw.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.d();
      localzdw.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.b();
      localzdw.jdField_b_of_type_Int = 3;
      return localzdw;
    }
    return null;
  }
  ...
  private boolean c()
  {
    return (this.jdField_a_of_type_Zdw != null) && (a() - this.jdField_a_of_type_Zdw.f > 0L);
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Afwa);
    ...
    if (this.jdField_a_of_type_Zdw != null)
    {
      ...
      str = this.jdField_a_of_type_Zdw.g;
      if (this.jdField_a_of_type_Int == 0) {
        break label108;
      }
    }
    label108:
    for (int i = this.jdField_a_of_type_Int;; i = this.jdField_a_of_type_Zdw.jdField_d_of_type_Int)
    {
    ...
    label119:
    QZLog.e("EditLocalVideoMusicMixe", 2, new Object[] { "startAudioPlayback: music not downloaded " + this.jdField_a_of_type_Zdw.jdField_d_of_type_JavaLangString });
  }
  
  public void a()
  {
    P2VEditMusicDialog localP2VEditMusicDialog = new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ally, (int)a(), true);
  ...
  {
    if (this.jdField_a_of_type_Zdw != null) {
      new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ally, (int)paramLong, true);
    }
  }
  ...
  public void a(alhv paramalhv)
  {
    QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new EditLocalVideoMusicMixRunnable(this.jdField_a_of_type_Long, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Zdw, new alhu(this, paramalhv)));
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Zdw != null) && ((this.jdField_a_of_type_Zdw.jdField_b_of_type_Int == 0) || (this.jdField_a_of_type_Zdw.jdField_b_of_type_Int == 3) || (this.jdField_a_of_type_Zdw.jdField_b_of_type_Int == 2)) && (!this.jdField_a_of_type_Boolean);
  }
