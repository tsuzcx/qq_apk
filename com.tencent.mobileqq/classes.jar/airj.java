...
public class airj
  ...
  implements PhotoPreviewLogic.IimageAdapterCallback, PhotoPreviewLogic.IonCheckedChangedCallback, xng
{
  public airg a;
  airs a;
  
  public airj(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
    super(paramNewPhotoPreviewActivity);
    this.jdField_a_of_type_Airs = null;
    this.mImageAdapterCallback = this;
    this.mOnCheckedChangedCallback = this;
    this.mPhotoPreviewData = new airg();
    this.jdField_a_of_type_Airg = ((airg)this.mPhotoPreviewData);
  }
  ...
  private void d()
  {
    ...
    if (this.mPhotoCommonData.a()) {
      ((NewPhotoPreviewActivity)this.mActivity).mEnableLiuHai = bnle.a(((NewPhotoPreviewActivity)this.mActivity).top_blackLH, ((NewPhotoPreviewActivity)this.mActivity).bottom_blackLH, 0);
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Airs != null) {
      this.jdField_a_of_type_Airs.av_();
    }
    String str = "";
    if (((NewPhotoPreviewActivity)this.mActivity).getCurrentSelectedPostion() != -1)
    {
      str = (String)this.jdField_a_of_type_Airg.paths.get(((NewPhotoPreviewActivity)this.mActivity).getCurrentSelectedPostion());
    ...
    updateButton();
    a((String)this.jdField_a_of_type_Airg.paths.get(((NewPhotoPreviewActivity)this.mActivity).getCurrentSelectedPostion()));
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 >= 0) && (paramInt1 < this.mPhotoCommonData.selectedPhotoList.size()) && (paramInt2 >= 0) && (paramInt2 < this.mPhotoCommonData.selectedPhotoList.size()))
    {
      ...
      if (this.jdField_a_of_type_Airg.jdField_a_of_type_Xne != null)
      {
        String str = this.jdField_a_of_type_Airg.jdField_a_of_type_Xne.a();
        if (!TextUtils.isEmpty(str)) {
          ((NewPhotoPreviewActivity)this.mActivity).setCheckedNumber(str);
        }
      }
      xna.a().b(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap);
    }
  }
  ...
  void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      paramInt1 = this.jdField_a_of_type_Airg.paths.indexOf(str1);
    } while (paramInt1 < 0);
    if (this.jdField_a_of_type_Airg.editPathMap.containsValue(str1)) {}
    for (paramIntent = aioz.a(this.jdField_a_of_type_Airg.editPathMap, str1);; paramIntent = str1)
    {
      this.jdField_a_of_type_Airg.editPathMap.put(paramIntent, str2);
      this.jdField_a_of_type_Airg.paths.add(paramInt1, str2);
      this.jdField_a_of_type_Airg.paths.remove(paramInt1 + 1);
      ...
      ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_Aiqw.notifyDataSetChanged();
      ...
      paramIntent.a(str2, this.jdField_a_of_type_Airg.jdField_f_of_type_Int);
      return;
    }
  }
  ...
  public void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)localObject1) == 1)
    {
      ...
      {
        QQToast.a(this.mActivity, ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131720111), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
    ...
    do
    {
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            if (paramBoolean)
            {
              PhotoUtils.a(this.mActivity, paramIntent, paramArrayList, this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap, this.mPhotoCommonData.currentQualityType, true);
            ...
            for (;;)
            {
              ...
              return;
              PhotoUtils.a(this.mActivity, paramIntent, paramArrayList, this.mPhotoCommonData.currentQualityType, this.jdField_a_of_type_Airg.jdField_a_of_type_Boolean);
            }
            i = 0;
          }
        }
      ...
      str = ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131719750);
      ...
      if (bezm.a(this.mActivity, 4, new airp(this, paramIntent))) {
        bdgm.a(this.mActivity, 232, null, str, new airq(this, paramIntent), new airr(this)).show();
      }
  ...
  protected void a(TextView paramTextView)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((!NetworkUtils.isNetworkUrl(str)) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType(str) == 1)) {
        paramTextView.setText(((Resources)localObject1).getString(2131695277));
      }
    }
    int i = bdfa.a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap, false, this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap, this.mPhotoCommonData.selectedMediaInfoHashMap);
    localObject2 = PhotoUtils.a(this.mActivity, i);
    if ((this.mPhotoCommonData.selectedPhotoList.size() == 0) || (((String)localObject2).equals("0"))) {}
    for (localObject1 = ((Resources)localObject1).getString(2131695277);; localObject1 = ((Resources)localObject1).getString(2131695277) + "(共" + (String)localObject2 + ")")
    {
  ...
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    if (this.jdField_a_of_type_Airs != null) {
      this.jdField_a_of_type_Airs.a_(paramSlideItemInfo);
    }
    int i = 0;
    label24:
    if (i < this.jdField_a_of_type_Airg.paths.size()) {
      if (!((String)this.jdField_a_of_type_Airg.paths.get(i)).equals(paramSlideItemInfo.jdField_b_of_type_JavaLangString)) {}
    }
    for (;;)
    {
      if (i >= 0)
      {
        ...
        if (j >= 0)
        {
          this.mPhotoCommonData.selectedPhotoList.remove(this.jdField_a_of_type_Airg.paths.get(i));
          this.mPhotoCommonData.selectedIndex.remove(j);
          if (this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap != null) {
            this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Airg.paths.get(i));
          }
          if (this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap != null) {
            this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Airg.paths.get(i));
          }
        }
        updateButton();
        a((String)this.jdField_a_of_type_Airg.paths.get(i));
        return;
        i += 1;
        break label24;
      }
      ...
      a(paramSlideItemInfo.jdField_b_of_type_JavaLangString);
      return;
      i = -1;
    }
  }
  ...
  void a(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Airg.jdField_a_of_type_Xne == null) {
        this.jdField_a_of_type_Airg.jdField_a_of_type_Xne = new xne(this.mActivity, this);
      }
      xna.a().a(this.jdField_a_of_type_Airg.jdField_a_of_type_Xne);
      xna.a().b(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap);
      xna.a().a(this.mActivity);
      this.jdField_a_of_type_Airg.jdField_a_of_type_Xne.a(this.mPhotoCommonData.selectedPhotoList.indexOf(paramString));
      if (((NewPhotoPreviewActivity)this.mActivity).mEnableLiuHai)
      {
        paramString = (RelativeLayout)((NewPhotoPreviewActivity)this.mActivity).findViewById(2131377919);
        ...
        ((RelativeLayout.LayoutParams)localObject).topMargin = bdoo.a(8.0F);
  ...
  public void b()
  {
    ...
    default: 
      return;
    case 0: 
      ((NewPhotoPreviewActivity)this.mActivity).qualityTv.setText(((NewPhotoPreviewActivity)this.mActivity).getString(2131695277));
  ...
  {
    int j = 0;
    if ((this.mPhotoCommonData.a()) && (!this.jdField_a_of_type_Airg.jdField_e_of_type_Boolean))
    {
      this.jdField_a_of_type_Airg.paths.clear();
      this.jdField_a_of_type_Airg.paths.addAll(this.mPhotoCommonData.selectedPhotoList);
      ...
      ((NewPhotoPreviewActivity)this.mActivity).adapter.notifyDataSetChanged();
      this.jdField_a_of_type_Airg.jdField_e_of_type_Boolean = true;
    }
    int i = this.jdField_a_of_type_Airg.paths.indexOf(paramString);
    if (i < 0) {
      i = j;
    }
    for (;;)
  ...
  protected boolean b()
  {
    ...
    if ((this.mPhotoCommonData.a()) && (i != -1) && (new File((String)this.jdField_a_of_type_Airg.paths.get(i)).length() > bazm.a()))
    {
      QQToast.a(this.mActivity, ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131695273), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
      ((NewPhotoPreviewActivity)this.mActivity).selectedBox.setChecked(false);
      return true;
    }
    return false;
  ...
  protected void c()
  {
    if ((this.jdField_a_of_type_Airg.jdField_c_of_type_Boolean) && ((!TextUtils.isEmpty(this.jdField_a_of_type_Airg.jdField_b_of_type_JavaLangString)) || (!TextUtils.isEmpty(this.jdField_a_of_type_Airg.jdField_c_of_type_JavaLangString)))) {
    ...
    {
      aips.a(((ArrayList)localObject3).size(), this.jdField_a_of_type_Airg.totalPicCount);
      aips.a(localIntent, ((ArrayList)localObject3).size(), this.mPhotoCommonData.currentQualityType);
    }
    ...
    {
      if ((this.mPhotoCommonData.selectedPhotoList.size() == 0) && (((ArrayList)localObject3).size() == 1) && (bdhb.a((String)((ArrayList)localObject3).get(0)) > bazm.a()))
      {
        QQToast.a(this.mActivity, ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131695273), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
      ...
      do
      {
        ...
        if ((localIntent != null) && (localIntent.getBooleanExtra("custom_photopreview_sendbtn_report", false)))
        {
          ...
          if ((str != null) && (localObject1 != null)) {
            azqs.b(null, "CliOper", "", "", str, str, 0, 0, (String)localObject1, "", "", "");
          }
        }
      } while ((!needShowMultiPhoto()) || (this.jdField_a_of_type_Airg.jdField_e_of_type_Int <= 0));
    ...
    for (;;)
    {
      ...
      localObject3 = this.jdField_a_of_type_Airg.editPathMap.values().iterator();
      for (;;)
      {
        if (((Iterator)localObject3).hasNext())
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty(str)) && (((String)localObject2).equals(str)))
          {
            i += 1;
            continue;
            if ((localObject1 == null) || (this.mPhotoCommonData.selectedPhotoList.size() <= 0) || (this.jdField_a_of_type_Airg.i) || (this.jdField_a_of_type_Airg.k) || (this.jdField_a_of_type_Airg.l) || (localIntent.getBooleanExtra("PhotoConst.SEND_NO_PRESEND", false))) {
              break;
            }
            ((PresendPicMgr)localObject1).a(localIntent);
            break;
            if (this.jdField_a_of_type_Airg.jdField_a_of_type_Int == 3000)
            {
              azqs.b(null, "dc00898", "", "", "0X80069A7", "0X80069A7", 0, 0, "", "", "", "");
              azqs.b(null, "dc00898", "", "", "0X800699B", "0X800699B", 0, 0, "", "", "", "");
              break label355;
            }
            if (this.jdField_a_of_type_Airg.jdField_a_of_type_Int != 1) {
              break label355;
            }
    ...
    {
      azqs.b(null, "dc00898", "", "", "0X800A070", "0X800A070", 0, 0, j + "", i + "", "", "");
      return;
    }
  }
  ...
  public void doOnDestroy()
  {
    ...
    if ((this.jdField_a_of_type_Airg.cameraType == 103) && (this.jdField_a_of_type_Airg.paths != null)) {}
    try
    {
      Object localObject = (String)this.jdField_a_of_type_Airg.paths.get(0);
  ...
  {
    this.jdField_a_of_type_Airg.i = paramBoolean;
    if (paramBoolean)
    {
      this.jdField_a_of_type_Airg.k = true;
      ...
      if (!paramBoolean)
      {
        ...
        if ((this.mPhotoCommonData.selectedPhotoList.isEmpty()) && (((NewPhotoPreviewActivity)this.mActivity).gallery.getFirstVisiblePosition() < this.jdField_a_of_type_Airg.paths.size()))
        {
          ((NewPhotoPreviewActivity)this.mActivity).selectLayout.performClick();
          updateButton();
        }
        if ((this.jdField_a_of_type_Airg.j) && (((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_ComTencentWidgetBubblePopupWindow == null))
        {
          this.jdField_a_of_type_Airg.j = false;
          ...
          int i = aepi.a(10.0F, ((NewPhotoPreviewActivity)this.mActivity).getResources());
        ...
        azqs.b(null, "dc00898", "", "", "0X8006997", "0X8006997", 0, 0, "", "", "", "");
      }
    }
    label353:
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Airg.jdField_a_of_type_Int == 3000)
        {
          azqs.b(null, "dc00898", "", "", "0X8006998", "0X8006998", 0, 0, "", "", "", "");
          return;
        }
      } while (this.jdField_a_of_type_Airg.jdField_a_of_type_Int != 1);
      azqs.b(null, "dc00898", "", "", "0X8006999", "0X8006999", 0, 0, "", "", "", "");
      return;
  ...
  {
    if ((this.jdField_a_of_type_Airg.canUseURL) && (bdfa.isNetUrl(paramString)))
    {
  ...
  {
    this.jdField_a_of_type_Airg.canUseURL = paramIntent.getBooleanExtra("PhotoConst.USE_URL_PATH", false);
    super.initData(paramIntent);
    ajrw.a("preview create");
    this.jdField_a_of_type_Airg.j = BaseApplicationImpl.getApplication().getSharedPreferences(BaseApplicationImpl.getApplication().getRuntime().getAccount(), 4).getBoolean("showFlashPic", true);
    this.jdField_a_of_type_Airg.cameraType = paramIntent.getIntExtra("camera_type", 1);
    this.jdField_a_of_type_Airg.h = paramIntent.getBooleanExtra("showFlashPic", false);
    this.jdField_a_of_type_Airg.jdField_b_of_type_Int = paramIntent.getIntExtra("PhotoConst.SEND_BUSINESS_TYPE", -1);
    this.jdField_a_of_type_Airg.jdField_c_of_type_Int = paramIntent.getIntExtra("camera_front_back", 0);
    this.jdField_a_of_type_Airg.jdField_d_of_type_Int = paramIntent.getIntExtra("camera_filter_id", -1);
    this.jdField_a_of_type_Airg.jdField_g_of_type_Int = paramIntent.getIntExtra("camera_capture_method", -1);
    this.jdField_a_of_type_Airg.jdField_d_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_FROM_EDIT", false);
    this.jdField_a_of_type_Airg.l = paramIntent.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false);
    this.jdField_a_of_type_Airg.jdField_a_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM"));
    this.jdField_a_of_type_Airg.jdField_c_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_INFOS"));
    this.jdField_a_of_type_Airg.editPathMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.editPathMap"));
    if (this.jdField_a_of_type_Airg.editPathMap == null) {
      this.jdField_a_of_type_Airg.editPathMap = new HashMap();
    }
    this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap = new HashMap(1);
    if (this.jdField_a_of_type_Airg.jdField_c_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap.putAll(this.jdField_a_of_type_Airg.jdField_c_of_type_JavaUtilHashMap);
    }
    this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap = new HashMap(1);
    if (this.jdField_a_of_type_Airg.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap.putAll(this.jdField_a_of_type_Airg.jdField_a_of_type_JavaUtilHashMap);
    }
    if (QLog.isColorLevel()) {
      QLog.d("aioSendPhotos", 2, "mCanUseURL:" + this.jdField_a_of_type_Airg.canUseURL + " mSelectedSendParams size:" + this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap.size());
    }
    this.mPhotoCommonData.videoSizeLimit = paramIntent.getLongExtra("PhotoConst.PHOTOLIST_KEY_VIDEO_SIZE", 1048576000L);
    this.jdField_a_of_type_Airg.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.HANDLE_DEST_RESULT", false);
    this.jdField_a_of_type_Airg.jdField_b_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.SHOULD_SEND_RAW_PHOTO", false);
    if (!this.jdField_a_of_type_Airg.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_Airg.jdField_c_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", false);
    }
    if ("FROM_QZONE_PHOTO_LIST".equals(this.jdField_a_of_type_Airg.from)) {
      this.jdField_a_of_type_Airg.jdField_c_of_type_Boolean = false;
    }
    if (this.jdField_a_of_type_Airg.jdField_c_of_type_Boolean)
    {
      this.jdField_a_of_type_Airg.jdField_e_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PasterConstants.pasters_data"));
      this.jdField_a_of_type_Airg.jdField_b_of_type_JavaLangString = paramIntent.getStringExtra("PasterConstants.paster_id");
      this.jdField_a_of_type_Airg.jdField_c_of_type_JavaLangString = paramIntent.getStringExtra("PasterConstants.paster_cate_id");
    }
    this.jdField_a_of_type_Airg.jdField_a_of_type_Int = paramIntent.getIntExtra("uintype", -1);
    this.jdField_a_of_type_Airg.jdField_f_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_CALL_IN_PLUGIN", false);
    this.jdField_a_of_type_Airg.jdField_g_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_SINGLE_DERECTBACK_MODE", false);
    this.mPhotoCommonData.currentQualityType = paramIntent.getIntExtra("PhotoConst.CURRENT_QUALITY_TYPE", 0);
    this.jdField_a_of_type_Airg.m = paramIntent.getBooleanExtra("PhotoConst.SEND_FLAG", false);
    if (this.jdField_a_of_type_Airg.m)
    {
    ...
    this.jdField_a_of_type_Airg.jdField_e_of_type_Int = paramIntent.getIntExtra("key_pic_to_edit_from", 0);
  }
  ...
  public void initUI()
  {
    ...
    ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)((NewPhotoPreviewActivity)this.mActivity).findViewById(2131366602));
    ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_AndroidViewView = ((NewPhotoPreviewActivity)this.mActivity).findViewById(2131366600);
    ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_Aiqw = new aiqw((NewPhotoPreviewActivity)this.mActivity);
    ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_Aiqw.a(this.mPhotoCommonData.selectedPhotoList);
    ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_Aiqw);
    ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnItemClickListener(((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_Aiqw);
    ...
    float f;
    int i;
    if (this.jdField_a_of_type_Airg.showBar)
    {
    ...
    {
      if ((this.jdField_a_of_type_Airg.h) && (this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap.size() == 0))
      {
        ...
        ((NewPhotoPreviewActivity)this.mActivity).flashTv.setOnClickListener(new airk(this));
      ...
      ((NewPhotoPreviewActivity)this.mActivity).magicStickBtn.setOnClickListener(new airl(this));
      ((NewPhotoPreviewActivity)this.mActivity).sendBtn.setOnClickListener(new airm(this));
      updateButton();
      if ((this.jdField_a_of_type_Airg.jdField_g_of_type_Boolean) || (this.jdField_a_of_type_Airg.isSingleMode))
      {
      ...
      ((NewPhotoPreviewActivity)this.mActivity).gallery.setOnItemClickListener(new airo(this));
      if (this.mPhotoCommonData.a()) {
        ((NewPhotoPreviewActivity)this.mActivity).backToPhotoListBtn.setText("");
      }
      if (this.jdField_a_of_type_Airg.jdField_a_of_type_Int == 1001)
      {
        ((NewPhotoPreviewActivity)this.mActivity).qualityCheckBox.setVisibility(8);
        ((NewPhotoPreviewActivity)this.mActivity).qualityTv.setVisibility(8);
      }
    ...
    for (;;)
    {
      ...
      aepi.a(((NewPhotoPreviewActivity)this.mActivity).magicStickBtn, (int)(10.0F * f + 0.5F), (int)(10.0F * f + 0.5F), (int)(10.0F * f + 0.5F), (int)(f * 10.0F + 0.5F));
      return;
    }
  }
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt1 == 24747)
    {
      xna.a().a(paramIntent, this.mPhotoCommonData.selectedMediaInfoHashMap);
      return;
    }
    if (paramInt1 == 18001)
    {
    ...
    PhotoUtils.a(this.mActivity, paramInt1, paramInt2, paramIntent, this.jdField_a_of_type_Airg.jdField_f_of_type_Boolean, this.mPhotoCommonData.myUin);
  }
  
  public void onBackPressed(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Airg.jdField_d_of_type_Boolean) {
      xna.a().a(xna.a().c());
    }
    Intent localIntent1 = ((NewPhotoPreviewActivity)this.mActivity).getIntent();
    localIntent1.putExtra("PhotoConst.SEND_BUSINESS_TYPE", this.jdField_a_of_type_Airg.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      localIntent1.putExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM", this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap);
      localIntent1.putExtra("PhotoConst.PHOTO_INFOS", this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap);
      ...
      if (localIntent1.getBooleanExtra("keep_selected_status_after_finish", false))
      {
        ...
        localIntent1.putExtra("PhotoConst.CURRENT_QUALITY_TYPE", this.mPhotoCommonData.currentQualityType);
        localIntent1.putExtra("PhotoConst.editPathMap", this.jdField_a_of_type_Airg.editPathMap);
      ...
      if (paramBoolean) {
        try
        {
          ...
          localIntent2.putExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM", this.jdField_a_of_type_Airg.jdField_b_of_type_JavaUtilHashMap);
    ...
    bdfa.anim(this.mActivity, true, false);
  }
  ...
  public void onGalleryItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    try
    {
      ((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(((NewPhotoPreviewActivity)this.mActivity).getMediaInfo((String)this.jdField_a_of_type_Airg.paths.get(paramInt)).thumbRect);
      if (this.mPhotoCommonData.a())
      {
        if (paramAdapterView != null) {
          ((NewPhotoPreviewActivity)this.mActivity).setCheckedNumber(paramAdapterView);
        }
        a((String)this.jdField_a_of_type_Airg.paths.get(paramInt));
      }
      return;
    }
    catch (Exception paramView)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("PhotoPreviewActivity", 2, bhsw.a(paramView));
        }
      }
    }
  }
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    int i = ((NewPhotoPreviewActivity)this.mActivity).getCurrentSelectedPostion();
    if (i != -1) {
      this.jdField_a_of_type_Airg.jdField_a_of_type_JavaLangString = ((String)this.jdField_a_of_type_Airg.paths.get(i));
    }
    if (this.jdField_a_of_type_Airg.jdField_a_of_type_JavaLangString != null)
    {
      ...
      if (this.jdField_a_of_type_Airg.jdField_c_of_type_Boolean)
      {
        ...
        if (paramIntent == null) {
          paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Airg.jdField_a_of_type_JavaLangString, true, true, true, true, true, paramInt2, 99, 4, paramBundle);
        }
        ...
        if ((needShowMultiPhoto()) && (this.jdField_a_of_type_Airg.jdField_e_of_type_Int > 0))
        {
          paramInt2 = this.jdField_a_of_type_Airg.jdField_e_of_type_Int;
    ...
    for (paramInt1 = this.mPhotoCommonData.selectedPhotoList.size();; paramInt1 = 0)
    {
      ...
      return;
      paramView.putExtra("PhotoConst.SEND_BUSINESS_TYPE", this.jdField_a_of_type_Airg.jdField_b_of_type_Int);
      break;
  ...
  public void onQualityBtnClick(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (!paramBoolean)
      {
        ...
        if (bdfa.a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.jdField_a_of_type_Int, this.mPhotoCommonData.allMediaInfoHashMap, true, this.mPhotoCommonData.selectedMediaInfoHashMap) <= 0) {
          break label175;
        }
        QQToast.a(this.mActivity, ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131695273), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
        ...
        do
        {
          do
          {
            do
            {
              ...
              } while (j >= this.jdField_a_of_type_Airg.paths.size());
              long l = new File((String)this.jdField_a_of_type_Airg.paths.get(j)).length();
              if (((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)this.jdField_a_of_type_Airg.paths.get(j)) == 1) {}
              for (int i = 1; (i == 0) && (l > bazm.a()); i = 0)
              {
                QQToast.a(this.mActivity, ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131695273), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
                this.mPhotoCommonData.currentQualityType = 0;
                ((NewPhotoPreviewActivity)this.mActivity).qualityTv.setText(((NewPhotoPreviewActivity)this.mActivity).getString(2131695277));
              ...
              this.mPhotoCommonData.selectedPhotoList.add(this.jdField_a_of_type_Airg.paths.get(j));
              ...
              if ((paramCompoundButton != null) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)this.jdField_a_of_type_Airg.paths.get(j)) != 1)) {
                paramCompoundButton.a((String)this.jdField_a_of_type_Airg.paths.get(j), this.jdField_a_of_type_Airg.jdField_f_of_type_Int);
              }
          ...
          return;
          if (bdfa.a(this.mPhotoCommonData.selectedPhotoList, 104345600L, this.mPhotoCommonData.allMediaInfoHashMap, true, this.mPhotoCommonData.selectedMediaInfoHashMap) > 0)
          {
            QQToast.a(this.mActivity, ((NewPhotoPreviewActivity)this.mActivity).getResources().getString(2131720133), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
            bdfa.c();
          }
  ...
  public void onSelectClick(View paramView)
  {
    ...
    if (this.mPhotoCommonData.selectedIndex.contains(Integer.valueOf(i)))
    {
      ...
      if (j >= 0)
      {
        ...
        if (i != -1)
        {
          ...
          if (paramView != null) {
            paramView.b((String)this.jdField_a_of_type_Airg.paths.get(i), 1014);
          }
        }
      }
      updateButton();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        localObject = (String)this.jdField_a_of_type_Airg.paths.get(i);
      ...
      if ((this.mPhotoCommonData.a()) && (!bnfr.a(this.mActivity, localLocalMediaInfo)))
      {
        ((NewPhotoPreviewActivity)this.mActivity).selectedBox.setChecked(false);
        return;
      }
      if ((((NewPhotoPreviewActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (awkr.a((String)localObject)) && (bdhb.a((String)localObject) > 3145728L))
      {
        QQToast.a(this.mActivity, "图片文件过大", 0).b(this.jdField_a_of_type_Airg.titleBarHeight);
        ((NewPhotoPreviewActivity)this.mActivity).selectedBox.setChecked(false);
        return;
      }
      if ((paramView != null) && (!this.jdField_a_of_type_Airg.i) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)this.jdField_a_of_type_Airg.paths.get(i)) != 1)) {
        paramView.a((String)this.jdField_a_of_type_Airg.paths.get(i), this.jdField_a_of_type_Airg.jdField_f_of_type_Int);
      }
      paramView = (String)this.jdField_a_of_type_Airg.paths.get(i);
      ...
      if (this.jdField_a_of_type_Airg.jdField_c_of_type_JavaUtilHashMap != null)
      {
        ...
        if ((this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap != null) && (localObject != null)) {
          this.jdField_a_of_type_Airg.jdField_d_of_type_JavaUtilHashMap.put(paramView, localObject);
        }
      }
      this.mPhotoCommonData.selectedIndex.add(Integer.valueOf(i));
      if (this.mPhotoCommonData.a())
  ...
  public void updateButton()
  {
    ...
    if (this.jdField_a_of_type_Airg.jdField_b_of_type_Boolean)
    {
      localObject = ((Resources)localObject).getString(2131695307);
      if (this.jdField_a_of_type_Airg.customSendBtnText == null) {
        break label771;
      }
      localObject = this.jdField_a_of_type_Airg.customSendBtnText;
    }
    label771:
    for (;;)
    {
      ...
      if ((this.mPhotoCommonData.selectedPhotoList != null) && (this.mPhotoCommonData.selectedPhotoList.size() > 0))
      {
        ...
        if (((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)this.jdField_a_of_type_Airg.paths.get(((NewPhotoPreviewActivity)this.mActivity).getCurrentSelectedPostion())) == 1) {
          break label686;
        }
        j = 1;
        label206:
        boolean bool2 = bdfa.isNetUrl((String)this.jdField_a_of_type_Airg.paths.get(((NewPhotoPreviewActivity)this.mActivity).getCurrentSelectedPostion()));
        if (((i != 0) && (!bool1)) || (j == 0) || (bool2)) {
          break label691;
        }
        ((NewPhotoPreviewActivity)this.mActivity).magicStickBtn.setEnabled(true);
        label265:
        if (((NewPhotoPreviewActivity)this.mActivity).jdField_a_of_type_Aiqw != null)
        {
          if (!needShowMultiPhoto()) {
            break label725;
          }
      ...
      for (;;)
      {
        ...
        if (this.mPhotoCommonData.a())
        {
          localObject = ((Resources)localObject).getString(2131699911);
          break;
        }
