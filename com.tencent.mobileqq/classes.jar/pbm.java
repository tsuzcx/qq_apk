...
public class pbm
{
  private static final Map<String, pbm> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static pbm a(String paramString)
  {
    if (paramString == null) {
      return null;
    }
    return (pbm)jdField_a_of_type_JavaUtilMap.get(paramString);
  }
  
  private static pbm a(String paramString, boolean paramBoolean)
  {
    pbm localpbm2 = a(paramString);
  ...
  public static void a(String paramString, pbm parampbm)
  {
    if ((paramString == null) || (parampbm == null)) {
      return;
    }
    jdField_a_of_type_JavaUtilMap.put(paramString, parampbm);
  }
  ...
  public void b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 99	pbm:jdField_a_of_type_Boolean	Z
    //   6: ifeq +37 -> 43
    //   9: aload_0
    //   10: iconst_0
    //   11: putfield 99	pbm:jdField_a_of_type_Boolean	Z
    //   14: invokestatic 104	android/os/SystemClock:elapsedRealtime	()J
    //   17: aload_0
    //   18: getfield 34	pbm:b	J
    //   21: lsub
    //   22: lstore_1
    //   23: lload_1
    //   24: lconst_0
    ...
    //   26: iflt +20 -> 46
    //   29: aload_0
    //   30: getfield 32	pbm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   33: lload_1
