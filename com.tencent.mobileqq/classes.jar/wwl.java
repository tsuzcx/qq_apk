public class wwl
{
  ...
  public void a(wwl paramwwl)
  {
    if (paramwwl == null) {
      return;
    }
    this.jdField_a_of_type_Long = paramwwl.jdField_a_of_type_Long;
    this.jdField_b_of_type_Long = paramwwl.jdField_b_of_type_Long;
    this.jdField_a_of_type_JavaLangString = paramwwl.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramwwl.jdField_b_of_type_JavaLangString;
    this.c = paramwwl.c;
    this.d = paramwwl.d;
    this.jdField_a_of_type_Boolean = paramwwl.jdField_a_of_type_Boolean;
    this.jdField_b_of_type_Boolean = paramwwl.jdField_b_of_type_Boolean;
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      yuk.a("Q.qqstory.config.takevideo", "isVariable=%b content=%s", Boolean.valueOf(bool1), toString());
      return bool1;
      bool1 = false;
      break;
    }
