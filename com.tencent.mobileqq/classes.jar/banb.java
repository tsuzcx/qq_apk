...
public class banb
  extends bamw
{
  bica jdField_a_of_type_Bica = new bica();
  public RandomAccessFile a;
  ArrayList<basp> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public byte[] a;
  ...
  public banb(bamu parambamu, baub parambaub)
  {
    ...
    c(parambaub.jdField_c_of_type_JavaLangString + parambaub.jdField_a_of_type_Long);
    this.jdField_c_of_type_Boolean = parambaub.jdField_e_of_type_Boolean;
  }
  ...
  protected baps a(byte[] paramArrayOfByte)
  {
    ...
    localbaps.jdField_a_of_type_JavaLangString = a(paramArrayOfByte);
    ...
    localbaps.jdField_k_of_type_Boolean = true;
    localbaps.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + this.jdField_s_of_type_Long + "-");
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, paramInt, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, paramInt, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, paramInt, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, paramInt, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  {
    this.jdField_a_of_type_Barz.j = paramString4;
    this.jdField_a_of_type_Barz.k = paramString5;
    this.jdField_a_of_type_Barz.l = paramString6;
    this.jdField_a_of_type_Barz.jdField_c_of_type_JavaLangString = String.valueOf(paramInt);
    this.jdField_a_of_type_Barz.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_Barz.jdField_b_of_type_JavaLangString = paramString3;
  ...
  public boolean h()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 131	banb:jdField_a_of_type_Baub	Lbaub;
    //   4: getfield 330	baub:i	Ljava/lang/String;
    //   7: astore 4
    ...
    //   22: aload_3
    //   23: aload_0
    //   24: getfield 337	banb:jdField_a_of_type_Baoj	Lbaoj;
    //   27: getfield 340	baoj:jdField_a_of_type_Long	J
    //   30: invokestatic 346	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   33: putfield 347	banb:jdField_a_of_type_ArrayOfByte	[B
    //   36: aload_3
    //   37: astore_2
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 347	banb:jdField_a_of_type_ArrayOfByte	[B
    //   43: invokestatic 352	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   46: putfield 354	banb:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   49: aload_3
    //   50: astore_2
    //   51: aload_0
    //   52: aload_0
    //   53: getfield 354	banb:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   56: putfield 355	banb:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   59: aload_3
    //   60: astore_2
    //   61: aload_0
    //   62: getfield 337	banb:jdField_a_of_type_Baoj	Lbaoj;
    //   65: aload_0
    //   66: getfield 354	banb:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   69: putfield 357	baoj:f	Ljava/lang/String;
    //   72: aload_3
    //   73: astore_2
    //   74: aload_0
    ...
    //   82: aload_0
    //   83: getfield 354	banb:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   95: aload_0
    //   96: getfield 360	banb:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   105: putfield 354	banb:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   108: aload_3
    //   109: ifnull +7 -> 116
    //   112: aload_3
    ...
    //   147: astore_2
    //   148: aload 4
    //   150: invokestatic 372	bhli:a	(Ljava/io/File;)Ljava/lang/String;
    //   153: astore 4
    //   155: aload 4
    //   157: ifnull +17 -> 174
    //   160: aload_3
    ...
    //   168: putfield 347	banb:jdField_a_of_type_ArrayOfByte	[B
    //   171: goto -135 -> 36
    //   174: ldc_w 295
    //   177: astore 4
    //   179: goto -19 -> 160
    ...
    //   196: aload_0
    //   197: aconst_null
    //   198: putfield 347	banb:jdField_a_of_type_ArrayOfByte	[B
    //   201: aload_3
    //   202: astore_2
    //   203: aload_0
    //   204: aload 4
    //   206: invokevirtual 234	banb:a	(Ljava/io/IOException;)V
    //   209: iconst_0
    //   210: istore_1
    //   211: aload_3
    //   212: ifnull -94 -> 118
  ...
  protected void o()
  {
    try
    {
      ...
      {
        i = SessionInfo.getInstance(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString).getHttpconn_sig_session().length;
        this.jdField_c_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString).getHttpconn_sig_session(), 0, this.jdField_c_of_type_ArrayOfByte, 0, i);
      }
      if (SessionInfo.getInstance(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString).getSessionKey() != null)
      {
        i = SessionInfo.getInstance(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString).getSessionKey().length;
        this.jdField_b_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString).getSessionKey(), 0, this.jdField_b_of_type_ArrayOfByte, 0, i);
      }
      return;
    }
    finally {}
