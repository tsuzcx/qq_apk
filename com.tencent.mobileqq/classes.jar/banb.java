...
public class banb
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      do
      {
        ...
        localStringBuilder.append(akpx.b());
  ...
  {
    return a(paramResources, paramInt, paramResources.getDrawable(2130848643));
  }
  ...
  public static Pair<String, ArrayList<MessageForText.AtTroopMemberInfo>> a(Editable paramEditable)
  {
    ...
    paramEditable = bafv.a(paramEditable, localArrayList);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          {
            localTroopInfoData.mRichFingerMemo = naj.c(localTroopInfoData.mRichFingerMemo);
            localTroopInfoData.mRichFingerMemo = naj.b(localTroopInfoData.mRichFingerMemo);
          }
          localTroopInfoData.cGroupOption = ((short)paramBundle.getByte("troop_info_opt"));
          localTroopInfoData.mStrJoinQuestion = bbbq.b(paramContext, localTroopInfoData.troopUin);
          localTroopInfoData.nTroopGrade = paramBundle.getInt("TROOP_INFO_TROOP_GRADE");
          localTroopInfoData.mStrJoinAnswer = bbbq.c(paramContext, localTroopInfoData.troopUin);
  ...
  public static String a(Context paramContext, long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      localObject = paramContext.getResources().getString(2131696428) + ((SimpleDateFormat)localObject).format(Long.valueOf(1000L * paramLong));
    }
    return localObject;
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      str = "0";
      paramQQAppInterface = paramString.replace("$GCODE$", paramTroopInfoData.troopUin).replace("$CLIENTVER$", "android8.3.0").replace("$UIN$", paramQQAppInterface.getCurrentAccountUin()).replace("$LANG$", "zh_CN").replace("$GROUPAPPID$", Long.toString(paramLong)).replace("$ROLE$", str);
      if (!paramBoolean) {
        break label169;
      }
    }
  ...
  public static void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localObject = (akhp)localQQAppInterface.a(20);
      ((akhp)localObject).notifyUI(2, false, null);
      ((ajsx)localQQAppInterface.a(22)).notifyUI(43, true, new Object[] { str, paramString, null });
      if (i != 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopUtils", 2, "TroopUtils handleModifyName :" + localTroopInfo.troopname);
        }
        ((akhp)localObject).b(str, String.valueOf(paramLong2), paramString);
      }
      return;
    }
  }
  ...
  {
    bcqr localbcqr = new bcqr(paramActivity);
    ...
    case 10: 
    default: 
      localbcqr.a(2131693687, i, 0, 1);
      return;
    case 2: 
      localbcqr.a(ajya.a(2131715824), i, 0, 1);
      return;
    case 3: 
      localbcqr.a(ajya.a(2131715813), i, 0, 1);
      return;
    case 4: 
      localbcqr.a(ajya.a(2131715819), i, 0, 1);
      return;
    case 5: 
      localbcqr.a(ajya.a(2131715814), i, 0, 1);
      return;
    }
    localbcqr.a(2131720505, i, 0, 1);
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(paramActivity, bbqd.a(paramActivity, "background", ""), 33554432L, localIntent, true, paramInt);
    axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8004E0E", "0X8004E0E", 0, 0, "", "", "", "");
  }
  ...
  {
    new bcqr(paramContext).a(paramInt2, paramInt1, 0, paramInt3);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty(paramRecommendTroopItem.recommendReason))
        {
          ...
          ArrayList localArrayList = mya.a(paramRecommendTroopItem);
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    paramContext = bbcz.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramString, false);
    Intent localIntent = actj.a(new Intent((Context)localObject, SplashActivity.class), null);
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("uintype", 1);
  ...
  public static void a(View paramView, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, boolean paramBoolean, String paramString1, String paramString2, auvw paramauvw)
  {
    ...
    while (TextUtils.isEmpty(paramCharSequence2))
    {
      ...
      if (paramBoolean) {
        auvv.a(paramView, paramString1, paramString2, paramauvw);
      }
    }
  ...
  public static void a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      new baui(paramBaseActivity, paramTroopInfoData, new banc(paramTroopInfoData)).a(paramTroopInfoData);
      axqy.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_share", 0, 0, paramTroopInfoData.troopUin, "", "", "");
    } while (!paramTroopInfoData.isMember);
    bbbp.a("Grp_set_new", "grpData_admin", "clk_share", 0, 0, new String[] { paramTroopInfoData.troopUin, bbbp.a(paramTroopInfoData) });
  }
  ...
  {
    if (bbdd.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString) != 0) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
        bbdd.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString, 0);
      }
      Intent localIntent = new Intent();
      ...
      axqy.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp", "Clk_grpinfo_files", 0, 0, paramString, "0", "", "");
      if (QLog.isDevelopLevel()) {
        QLog.d("Clk_grpinfo_files", 4, "troopUin :" + paramString);
      }
      mzu.a(paramQQAppInterface, 67);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString2 = (baiz)paramQQAppInterface.getManager(109);
    ...
    for (int i = 32;; i = 0)
    {
      ...
      for (paramString2 = paramString2.url.replace("$GCODE$", paramString1);; paramString2 = null)
      {
        ...
        axqy.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, paramString1, "", "", "");
        return;
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      ...
      localbgyw.b = paramQQAppInterface.getCurrentNickname();
      akhp localakhp = (akhp)paramQQAppInterface.a(20);
      if (!TextUtils.isEmpty(paramString1)) {
        localakhp.e(paramString1, true);
      }
      if (bbdd.a(paramQQAppInterface.getCurrentAccountUin(), "troop_photo_message", paramString1) <= 0) {
        break label123;
      }
      bgyp.d(paramActivity, localbgyw, paramString1, 7);
    }
    for (;;)
    {
      axqy.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_album", 0, 0, paramString1, "", "", "");
      mzu.a(paramQQAppInterface, 66);
      return;
      bool = false;
      break;
      label123:
      bgyp.a(paramActivity, localbgyw, paramString1, paramString2, bool, 7);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, baic parambaic)
  {
    ...
    if (str1.length() < 10)
    {
      ...
      a(paramQQAppInterface, paramContext, str3, parambaic, 0, null);
    ...
    for (;;)
    {
      ...
      new baid(localStringBuilder.toString(), "GET", parambaic, 1, null).a(paramQQAppInterface);
      return;
      ((StringBuilder)localObject1).append("0");
      ((StringBuilder)localObject1).append(str1);
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Bundle paramBundle)
  {
    ...
    localIntent.putExtras(paramBundle);
    paramContext.startActivity(localIntent);
    axqy.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, str, "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    if (localTroopManager != null)
    {
      ...
      if (paramString != null)
      {
        ...
        {
          paramQQAppInterface = new baui((BaseActivity)paramContext, localTroopInfoData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, baic parambaic, int paramInt, Bundle paramBundle)
  {
    Bundle localBundle = new Bundle();
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    new baid(localStringBuilder.toString(), "GET", parambaic, paramInt, paramBundle).a(paramQQAppInterface);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, TroopInfoData paramTroopInfoData, long paramLong)
  {
    paramQQAppInterface = (asks)paramQQAppInterface.getManager(37);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<ChatMessage> paramList)
  {
        ...
        if (i < paramList.size())
        {
          ...
          if ((!(localChatMessage instanceof MessageForGrayTips)) && ((!(localChatMessage instanceof MessageForUniteGrayTip)) || (localChatMessage.time == l)))
          {
            ...
            if ((localChatMessage instanceof MessageForSplitLineTips))
            {
              ...
              if (!ajya.a(2131715816).equalsIgnoreCase(((MessageForSplitLineTips)localObject2).msgContent)) {
                break;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (MessageForSplitLineTips)axas.a(-4012);
        ((MessageForSplitLineTips)localObject2).init(paramQQAppInterface.getCurrentAccountUin(), paramString, paramQQAppInterface.getCurrentAccountUin(), ajya.a(2131715821), l, -4012, 1, l);
        ...
        ((MessageForSplitLineTips)localObject2).msgContent = ajya.a(2131715822);
  ...
  public static void a(TroopInfoData paramTroopInfoData, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      axqy.b(null, "P_CliOper", "Grp_nearby", "", "recom", "Clk_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 18)
    {
      axqy.b(null, "P_CliOper", "Grp_join", "", "join_page", "Clk_join", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 24)
    {
      axqy.b(null, "P_CliOper", "Grp_nearby", "", "search", "Clk_joingrp", 0, 0, "", "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 17)
    {
      axqy.b(null, "CliOper", "", "", "Grp_recommend", "viewinfor_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    int i = -1;
    int j;
    ...
    for (;;)
    {
      ...
      axqy.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", "" + i, paramInt2 + "");
      axqy.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp1", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", paramInt3 + "", "");
      return;
      i = 0;
      break;
      i = 1;
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      ...
      bbax.a(BaseApplicationImpl.getApplication(), paramString, paramString);
    } while (!QLog.isColorLevel());
  ...
  public static void a(List<String> paramList)
  {
    ...
    {
      bamk localbamk = (bamk)((QQAppInterface)localObject).getManager(203);
      localObject = null;
  ...
  public static void a(AppRuntime paramAppRuntime, TroopInfo paramTroopInfo, Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setTitle(ajya.a(2131715817)).setMessage(ajya.a(2131715815)).setPositiveButton(ajya.a(2131715823), paramOnClickListener);
    paramActivity.show();
    bbbp.a("Grp_manage_new", "gainUin_msgBox", "exp", 0, 0, new String[] { String.valueOf(paramTroopInfo.troopuin), "", bbbp.a(paramTroopInfo, paramAppRuntime) });
  }
  ...
  public static void a(boolean paramBoolean, TextView paramTextView)
  {
    if (paramBoolean)
    {
      ...
      paramTextView.setCompoundDrawablePadding(actj.a(10.0F, BaseApplicationImpl.getApplication().getResources()));
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130840998, 0);
      return;
    }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if (!TextUtils.equals("4480", paramContext)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.i("TroopUtils", 2, String.format("isUpdateBeforeSomeVersion pre: %s, cur: %s", new Object[] { "4480", paramContext }));
      return false;
  ...
  {
    if ((paramTabInfo != null) && (paramTabInfo.appid.get() == 1106837471L) && ((paramView.getTag(2131376879) instanceof Integer))) {
      return ((Integer)paramView.getTag(2131376879)).intValue() == 1;
    }
    return false;
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    return (akhp.jdField_a_of_type_Boolean) && (localTroopManager.b());
  }
  ...
  public static void b(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      bbbp.a("Grp_set_new", "grpData_admin", "clk_report", 0, 0, new String[] { paramTroopInfoData.troopUin, bbbp.a(paramTroopInfoData) });
      paramTroopInfoData = xkn.a(str1, 1);
      xkn.a(paramBaseActivity, str1, null, null, str1, paramQQAppInterface.getAccount(), i, null, paramTroopInfoData);
      return;
      if (paramTroopInfoData.isMember) {
        i = 22000;
      } else {
    ...
    {
      bbbp.a("Grp_set_new", "grpData_visitor", "clk_report", 0, 0, new String[] { str2, paramTroopInfoData });
  ...
  {
    String str = bbax.a(BaseApplicationImpl.getApplication(), paramString);
    if (QLog.isColorLevel()) {
