...
public class mdk
  extends lef
{
  public mdk(DoubleVideoMeetingCtrlUI paramDoubleVideoMeetingCtrlUI) {}
      ...
      case 90: 
        if (paramLong3 == 3L) {
          if (this.a.jdField_a_of_type_ComTencentAvUiQavPanel != null)
          {
            ...
            this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131373642, 0);
          }
        }
        break;
      case 96: 
        for (;;)
        {
          if ((!locallff.j) || (this.a.c))
          {
            this.a.c = false;
            this.a.i(paramLong1);
            paramInt1 = locallff.a(this.a.jdField_b_of_type_Long, 1);
            boolean bool = false;
            if (paramInt1 != -1) {
              bool = ((lob)locallff.c.get(paramInt1)).a;
            }
          ...
          return;
          if ((paramLong3 != 1L) || (locallff.ap)) {
            break;
          }
          this.a.e("onGaOperationResult->REQUEST_VIDEO_SUC");
          this.a.a(paramLong1, locallff.c);
          return;
          this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131373642, 8);
        }
      }
  ...
  protected void a(long paramLong1, long paramLong2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramLong2 == this.a.jdField_a_of_type_Long)
    {
      this.a.jdField_a_of_type_ComTencentAvVideoController.a().af = 1;
  ...
  protected void d(long paramLong1, long paramLong2)
  {
    ...
    lff locallff = this.a.jdField_a_of_type_ComTencentAvVideoController.a();
    if ((paramLong2 == this.a.jdField_a_of_type_Long) && (locallff.g == paramLong2)) {
      this.a.a(paramLong1, locallff, 3);
    }
  }
}
