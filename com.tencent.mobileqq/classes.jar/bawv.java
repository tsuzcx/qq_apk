  ...
  implements Manager
{
  ...
  public static HashMap<String, bawz> a;
  public static String[] a;
  batl jdField_a_of_type_Batl = new baww(this);
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = ajed.aU + "voiceChange/";
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { null, null, null };
  }
  
  public bawv(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	bawv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	bawz
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	bawz:jdField_a_of_type_Baxa	Lbaxa;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	baxb:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	bawz:jdField_a_of_type_Baxa	Lbaxa;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	bawv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 117	bawz:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 120	bawz:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
  ...
  public static void a(Context paramContext, baws parambaws, String paramString, bawr parambawr)
  {
    if ((bawz)jdField_a_of_type_JavaUtilHashMap.get(parambaws.jdField_a_of_type_JavaLangString) == null) {
      b(paramContext, parambaws, paramString, parambawr);
    }
    ((bawz)jdField_a_of_type_JavaUtilHashMap.get(parambaws.jdField_a_of_type_JavaLangString)).jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.c();
  }
  
  public static void a(Context paramContext, baws parambaws, String paramString, bawr parambawr, bawx parambawx)
  {
    bawz localbawz = (bawz)jdField_a_of_type_JavaUtilHashMap.get(parambaws.jdField_a_of_type_JavaLangString);
    if (localbawz != null) {
      localbawz.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.jdField_a_of_type_Boolean = false;
    }
    localbawz = new bawz();
    localbawz.jdField_a_of_type_Baws = parambaws;
    localbawz.jdField_a_of_type_Bawx = parambawx;
    localbawz.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread = new QQVoiceChangerThread(paramContext, parambaws, parambawx, paramString, parambawr);
    jdField_a_of_type_JavaUtilHashMap.put(parambaws.jdField_a_of_type_JavaLangString, localbawz);
    localbawz.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.start();
  }
  
  public static void a(baws parambaws)
  {
    bawz localbawz = (bawz)jdField_a_of_type_JavaUtilHashMap.get(parambaws.jdField_a_of_type_JavaLangString);
    if (localbawz != null)
    {
      localbawz.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.d();
      jdField_a_of_type_JavaUtilHashMap.remove(parambaws.jdField_a_of_type_JavaLangString);
    }
  }
  
  public static boolean a(String paramString, baxa parambaxa)
  {
    for (;;)
    {
      try
      {
        ...
        bawz localbawz = (bawz)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if (localbawz == null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (localbawz.jdField_a_of_type_Boolean)
        {
          baxb.a(paramString, localbawz.jdField_a_of_type_Baws.jdField_a_of_type_JavaLangString, localbawz.jdField_a_of_type_Baws.f);
          jdField_a_of_type_JavaUtilHashMap.remove(paramString);
          parambaxa.a(paramString, localbawz.jdField_a_of_type_Baws.e, localbawz.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VoiceChangeManager", 2, "queryStateByPath onCompressFinished filePath=" + paramString + " time=" + localbawz.jdField_a_of_type_Int + " voiceType=" + localbawz.jdField_a_of_type_Baws.e);
          }
        }
        else
        {
          localbawz.jdField_a_of_type_Baxa = parambaxa;
        }
      }
      finally {}
      boolean bool = true;
  ...
  public static void b(Context paramContext, baws parambaws, String paramString, bawr parambawr)
  {
    a(paramContext, parambaws, paramString, parambawr, bawx.a());
  }
  
  public static void b(baws parambaws)
  {
    bawz localbawz = (bawz)jdField_a_of_type_JavaUtilHashMap.get(parambaws.jdField_a_of_type_JavaLangString);
    if (localbawz != null)
    {
  ...
  public boolean a(ArrayList<bawt> paramArrayList, JSONObject paramJSONObject)
  {
    boolean bool = bavz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "VoiceChangeManager", false);
    if (!bool)
    {
      ...
      if (i < arrayOfInt.length)
      {
        if (arrayOfInt[i] == j)
        {
          ...
          if (i < 0)
          {
            ...
            break label1363;
            this.jdField_a_of_type_Batl.onDone(null);
            return true;
          }
        }
        else
        ...
        paramJSONObject = (bawt)paramArrayList.get(i);
        label687:
        if (paramJSONObject == null)
        {
          if (!QLog.isColorLevel()) {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (banq.a(((JSONObject)localObject2).getString("QQVersion"), "8.2.6"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          paramJSONObject.jdField_a_of_type_Bawu.jdField_a_of_type_JavaLangString = ((String)localObject3);
          break label1363;
          localObject3 = balu.jdField_a_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = balu.jdField_a_of_type_JavaLangString + (String)localObject1;
