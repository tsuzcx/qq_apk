  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public beqg mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  bepx mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new beqd(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<beqk> mRecoverAnimations = new ArrayList();
  ...
  public beqc(beqg parambeqg)
  {
    this.mCallback = parambeqg;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new beqf(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      beqk localbeqk = (beqk)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localbeqk.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new bepx(this.mRecyclerView.getContext(), new beqj(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return beqg.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return beqg.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  public void attachToRecyclerView(@Nullable RecyclerView paramRecyclerView)
  {
    ...
    this.mSwipeEscapeVelocity = paramRecyclerView.getDimension(2131166049);
    this.mMaxSwipeVelocity = paramRecyclerView.getDimension(2131166048);
    setupCallbacks();
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      beqk localbeqk = (beqk)this.mRecoverAnimations.get(i);
      if (localbeqk.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localbeqk.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localbeqk.jdField_c_of_type_Boolean) {
          localbeqk.b();
        }
        this.mRecoverAnimations.remove(i);
        return localbeqk.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  beqk findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      beqk localbeqk = (beqk)this.mRecoverAnimations.get(i);
      paramMotionEvent = localbeqk;
      if (localbeqk.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (beqk)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((beqk)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(beqk parambeqk, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, parambeqk, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new beqe(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((beqk)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
