...
public class alyl
{
  private alyn jdField_a_of_type_Alyn = new alyn();
  ...
  public void a(Matrix4 paramMatrix4, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramMatrix4.hasNext())
      {
        ...
        this.jdField_a_of_type_Alyn.a(localVector3.x, -localVector3.y, -localVector3.z, 0.0F);
        this.jdField_a_of_type_Alyn.a(this.jdField_b_of_type_ComTencentMobileqqArmapSensorRotationMatrix4);
        localVector3.x = (this.jdField_a_of_type_Alyn.a * 500.0F + 500.0F);
        localVector3.y = (this.jdField_a_of_type_Alyn.b * 500.0F + 500.0F + 0.0F);
        localVector3.z = (this.jdField_a_of_type_Alyn.c * 500.0F);
      }
      continue;
      paramMatrix4 = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramMatrix4.hasNext())
  ...
  public void a(Matrix4 paramMatrix4, int paramInt, float[] paramArrayOfFloat)
  {
    ...
    float f6 = alym.a(this.d, this.f);
    float f7 = alym.a(this.d, this.e);
    float f4 = alym.a(this.c, this.f);
    float f2 = alym.a(this.c, this.d);
    float f1 = alym.a(this.f, this.d);
    float f3 = alym.a(f1, alym.a(f4, f2, f1)) * 57.29578F - 90.0F;
    f1 = f3;
    if (f6 > f7) {
      f1 = -f3;
    }
    ...
    for (f3 = 0.0F;; f3 = f1)
    {
      ...
      for (;;)
      {
        ...
        if (paramInt % 72 == 0)
        {
          ...
          f2 = alym.a(this.d, (Vector3)this.jdField_a_of_type_JavaUtilArrayList.get(m));
          f4 = alym.a(this.d, (Vector3)this.jdField_a_of_type_JavaUtilArrayList.get(n));
          if (f2 >= f4) {
            break label949;
          }
          label374:
        ...
        for (;;)
        {
          ...
          {
            f4 = n % 72;
            f5 = alym.a((Vector3)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), paramMatrix4);
            double d1 = f4 * 5.0F;
            double d2 = 5.0F;
            double d3 = Math.cos(alym.b(f2, alym.a(f1, f2, f5)));
            f1 = alym.a(d1 + d2 * (f1 * d3 / f5) - 180.0D);
            f2 = f1;
            if (Float.isNaN(f1)) {
              f2 = 0.0F;
            }
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                f1 = alym.a(this.g, this.h);
                f6 = alym.a(this.g, this.i);
                f4 = alym.a(this.g, this.j);
                f5 = alym.a(this.g, this.k);
                f2 = alym.a(this.c, this.g);
                f7 = alym.a(this.c, this.h);
                float f8 = alym.a(this.g, this.h);
                f2 = -alym.a(f8, alym.a(f2, f7, f8)) * 57.29578F;
                if (f1 < f6)
                {
                  f1 = f2;
                  if (f4 < f5) {
