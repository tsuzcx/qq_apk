...
public class bhsr
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, aozs paramaozs, int paramInt1, int paramInt2)
  {
    try
    {
      if (paramaozs.a.strPkgName.equals("com.android.ReadInJoy")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MainFragment paramMainFragment, alsn paramalsn, int paramInt)
  {
    try
    {
      if ((((paramalsn instanceof ReadinjoyTabFrame)) || (paramInt == MainFragment.h)) && ((ReadinjoyTabFrame)paramMainFragment.a(ReadinjoyTabFrame.class) != null) && (paramInt == MainFragment.h) && (paramMainFragment.getActivity().getIntent().getIntExtra("launch_from", 5) == 6)) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    try
    {
      if ((paramMessageRecord.istroop == 7220) || ((paramMessageRecord.istroop == 1008) && (alof.az.equals(paramMessageRecord.frienduin))))
      {
      ...
      {
        asmw.a(paramQQAppInterface, paramMessageRecord.frienduin, 10006, 1);
        return;
      }
    }
    catch (Throwable paramQQAppInterface)
    ...
    if (paramRecentUser != null) {
      try
      {
        ...
        while (paramRecentUser.getType() == 7220)
        {
          ...
          return;
          label145:
          if (alof.aS.equals(paramRecentBaseData.a())) {
  ...
  {
    azqs.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
}
