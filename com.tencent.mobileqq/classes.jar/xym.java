  ...
  implements Runnable
{
  ...
  public xym(NewFlowCameraActivity paramNewFlowCameraActivity, @NonNull Bitmap paramBitmap1, @NonNull Bitmap paramBitmap2)
  {
  ...
  private void a()
  {
    ...
    localValueAnimator.addUpdateListener(new xyn(this, k, i, m, j, n, i1));
    localValueAnimator.addListener(new xyo(this));
