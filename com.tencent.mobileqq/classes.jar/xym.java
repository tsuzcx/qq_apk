...
{
  public xym(TroopAddFrdsInnerFrame paramTroopAddFrdsInnerFrame) {}
  ...
  public void onAddBatchTroopFrd(boolean paramBoolean, String paramString, ArrayList paramArrayList)
  {
    ...
    do
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.runOnUiThread(new xyn(this, paramArrayList));
