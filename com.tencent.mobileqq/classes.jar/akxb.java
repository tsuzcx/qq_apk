  ...
  implements akrq
{
  ...
  public aknm a;
  public bgkw a;
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new akxf(this);
  ...
  public akxb(int paramInt)
  {
    this.jdField_a_of_type_Bgkw = new akxe(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new akxh(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
    ...
    if ((alhb.a(BaseApplicationImpl.getContext()).a() != null) && (alhb.a(BaseApplicationImpl.getContext()).a().getRoom() != null) && (localArrayList1.size() > 0)) {
      alhb.a(BaseApplicationImpl.getContext()).a().getRoom().requestViewList((String[])localArrayList1.toArray(new String[localArrayList1.size()]), (AVView[])localArrayList2.toArray(new AVView[localArrayList2.size()]), localArrayList1.size(), paramArrayOfString);
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((akwd.b(this.jdField_a_of_type_Long) != null) && (akwd.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)akwd.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new akxg(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = alhb.a(BaseApplicationImpl.getContext()).a();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        algt.a().b(paramBoolean);
        break label60;
      } while ((alhb.a(BaseApplicationImpl.getContext()).a() == null) || (alhb.a(BaseApplicationImpl.getContext()).a().getRoom() == null));
      label130:
      label140:
      alhb.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new akxi(this));
    }
  }
  ...
  public void d()
  {
    ...
    {
      algt.a().a("" + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_Aknm != null) {
        this.jdField_a_of_type_Aknm.b();
      }
      b(false);
  ...
  public void grant()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        akwd.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      try
      {
        ...
        akwd.a().callbackFromRequest(this.jdField_a_of_type_Long, i, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
