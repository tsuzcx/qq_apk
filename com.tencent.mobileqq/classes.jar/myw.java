...
public abstract class myw
{
  ...
  public myw(Context paramContext, String paramString)
  {
  ...
  public boolean a(AppInterface paramAppInterface, String paramString)
  {
    try
    {
      ...
      paramAppInterface = ((bbww)((QQAppInterface)paramAppInterface).getManager(47)).a(1);
      paramString = ajsd.aW + a() + ".tmp";
      localObject = new bbwu((String)localObject, new File(paramString));
      ((bbwu)localObject).b = 3;
      Bundle localBundle = new Bundle();
      localBundle.putString("file_path", paramString);
      paramAppInterface.a((bbwu)localObject, new myx(this), localBundle);
      return true;
    }
