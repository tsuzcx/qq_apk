...
public class aglt
{
  private aglv jdField_a_of_type_Aglv;
  private View jdField_a_of_type_AndroidViewView;
  private IntimateInfo.MemoryDayInfo jdField_a_of_type_ComTencentMobileqqDataIntimateInfo$MemoryDayInfo;
  
  public aglt(aglr paramaglr, Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131559331, null);
  }
  ...
  {
    this.jdField_a_of_type_Aglv = paramaglv;
  }
  ...
  public void a(IntimateInfo.MemoryDayInfo paramMemoryDayInfo)
  {
    ...
    URLThemeImageView localURLThemeImageView = (URLThemeImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368381);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131381514);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370158);
    RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131370858);
    Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363333);
    ...
    Object localObject1 = this.jdField_a_of_type_Aglr.jdField_a_of_type_JavaLangString;
    if (localURLThemeImageView != null)
    {
      if (localURLThemeImageView.a != null) {
        localURLThemeImageView.a.a(blfw.c);
      }
    ...
    if ((localRelativeLayout != null) && (ThemeUtil.isNowThemeIsNight(null, false, null))) {
      localObject1 = this.jdField_a_of_type_Aglr.b;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if ((localTextView2 != null) && (paramMemoryDayInfo.wording != null))
        {
          ...
          int i = AIOUtils.dp2px(95.0F, this.jdField_a_of_type_Aglr.jdField_a_of_type_AndroidContentContext.getResources());
          i = aglr.a(this.jdField_a_of_type_Aglr, (String)localObject1, 14.0F, i + 80);
          if (i > 200) {
        ...
        try
        {
          ...
          localTextView1.setOnClickListener(new aglu(this));
          return;
