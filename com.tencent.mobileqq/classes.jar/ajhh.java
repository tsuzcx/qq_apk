  ...
  implements Manager
{
  ...
  public ajhh(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    localObject2 = (ArrayList)this.jdField_a_of_type_Atmp.a(DiscussionInfo.class, false, null, null, null, null, null, null);
    ...
    for (int i = ((ArrayList)localObject2).size();; i = 0)
    {
      ...
      while (i < ((ArrayList)localObject2).size())
      {
        ...
        if (babh.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localDiscussionInfo))
        {
          Map localMap = a(localDiscussionInfo.uin);
          if (babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localDiscussionInfo.uin, localDiscussionInfo, localMap, false)) {
    ...
    do
    {
      ...
      if (localObject2 == null)
      {
        ...
        if (!paramBoolean)
        {
          ...
          if (!this.jdField_a_of_type_Boolean)
          {
            localObject2 = (DiscussionInfo)this.jdField_a_of_type_Atmp.a(DiscussionInfo.class, paramString);
            if (QLog.isColorLevel())
            {
  ...
  public Map<String, DiscussionMemberInfo> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      break label82;
      localObject2 = this.jdField_a_of_type_Atmp.a(DiscussionMemberInfo.class, false, "discussionUin=? ", new String[] { paramString }, null, null, "memberUin", null);
      if (localObject2 == null)
      {
        if (!QLog.isColorLevel()) {
          break;
  ...
  public Map<String, ArrayList<DiscussionMemberInfo>> a(String[] paramArrayOfString)
  {
    ...
    paramArrayOfString = this.jdField_a_of_type_Atmp.a(DiscussionMemberInfo.class, false, ((StringBuilder)localObject).toString(), arrayOfString, "memberUin", null, "memberUin", null);
  ...
  public void a(DiscussionMemberInfo paramDiscussionMemberInfo)
  {
    if (paramDiscussionMemberInfo != null)
    {
      ...
      if ((localDiscussionInfo != null) && (babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDiscussionMemberInfo.discussionUin, localDiscussionInfo, localMap, false))) {
  ...
  public void a(String paramString, DiscussionInfo paramDiscussionInfo, long paramLong1, Map<String, DiscussionMemberInfo> paramMap, long paramLong2)
  {
    ...
    //   60: aload_0
    //   61: getfield 40	ajhh:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   64: aload_1
    //   65: aload 5
    ...
    //   141: astore 10
    //   143: aload_0
    //   144: getfield 77	ajhh:jdField_a_of_type_Atmp	Latmp;
    //   147: invokevirtual 157	atmp:a	()Latmr;
    //   150: astore 9
    //   152: aload 9
    //   154: invokevirtual 161	atmr:a	()V
    //   157: aload 5
    ...
    //   286: aload_0
    //   287: aload 12
    //   289: invokevirtual 166	ajhh:a	(Latmo;)Z
    //   292: pop
    //   293: goto -122 -> 171
    //   296: astore_1
    ...
    //   313: aload 9
    //   315: invokevirtual 171	atmr:b	()V
    //   318: return
    //   319: aload_0
    //   320: getfield 63	ajhh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   323: invokevirtual 474	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   326: ifnull +77 -> 403
    //   329: aload_0
    //   330: getfield 63	ajhh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   403: aload_0
    //   404: getfield 63	ajhh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   407: aload_1
    //   408: aload_2
    //   409: aload 5
    //   411: iconst_0
    //   412: invokestatic 148	babh:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lcom/tencent/mobileqq/data/DiscussionInfo;Ljava/util/Map;Z)Z
    //   415: pop
    //   416: aload_2
    //   417: lload_3
    ...
    //   421: aload_0
    //   422: aload_2
    //   423: invokevirtual 491	ajhh:a	(Lcom/tencent/mobileqq/data/DiscussionInfo;)V
    //   426: aload 9
    //   428: invokevirtual 169	atmr:c	()V
    //   431: aload 9
    //   433: invokevirtual 171	atmr:b	()V
    //   436: return
    //   437: astore_1
    //   438: aload 9
    //   440: invokevirtual 171	atmr:b	()V
    //   443: aload_1
    //   444: athrow
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (localObject1 = localObject2;; localObject1 = null)
    {
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = (DiscussionMemberInfo)this.jdField_a_of_type_Atmp.a(DiscussionMemberInfo.class, new String[] { paramString1, paramString2 });
      }
      if (localObject2 != null)
      {
  ...
  public void a(String paramString, Set<String> paramSet)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localMap != null)
        {
          ...
          while (paramSet.hasNext())
          {
            ...
            {
              this.jdField_a_of_type_Atmp.b(localDiscussionMemberInfo);
              if (QLog.isColorLevel()) {
      ...
      catch (Exception paramSet)
      {
        ...
        if (babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramSet, localMap, false)) {
          this.jdField_a_of_type_Atmp.a(paramSet);
        }
        localatmr.c();
        return;
      }
  ...
  {
    beoj.a("queryDiscs_" + paramList.size());
    if (QLog.isColorLevel()) {
    ...
    if (paramList.size() > 0)
    {
      ...
      paramList = this.jdField_a_of_type_Atmp.a(DiscussionInfo.class, true, ((StringBuilder)localObject).toString(), (String[])paramList.toArray(new String[paramList.size()]), null, null, null, null);
      if (paramList != null)
      {
  ...
  {
    boolean bool = false;
    if ((ArrayList)this.jdField_a_of_type_Atmp.a(DiscussionMemberInfo.class, false, "discussionUin=? and memberUin=?", new String[] { paramString1, paramString2 }, null, null, "memberUin", null) != null) {
      bool = true;
    }
    return bool;
  }
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          if (paramArrayList.hasNext())
          {
            ...
            this.jdField_a_of_type_Atmp.b(localDiscussionInfo);
            if (!QLog.isColorLevel()) {
              continue;
            }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    paramString = this.jdField_a_of_type_Atmp.a(DiscussionMemberInfo.class, false, "discussionUin=?", new String[] { paramString }, null, null, "memberUin", String.valueOf(5));
    if (paramString != null)
    {
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    //   49: return
    //   50: aload_0
    //   51: getfield 77	ajhh:jdField_a_of_type_Atmp	Latmp;
    //   54: invokevirtual 157	atmp:a	()Latmr;
    //   57: astore_3
    //   58: aload_3
    //   59: invokevirtual 161	atmr:a	()V
    //   62: aload_0
    //   63: getfield 77	ajhh:jdField_a_of_type_Atmp	Latmp;
    //   66: ldc_w 312
    //   69: iconst_0
    //   70: ldc_w 614
    //   73: iconst_1
    ...
    //   83: ldc_w 368
    //   86: aconst_null
    //   87: invokevirtual 101	atmp:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    //   140: aload_0
    //   141: aload 5
    //   143: invokevirtual 319	ajhh:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/DiscussionInfo;
    //   146: astore 6
    //   148: aload_0
    //   149: aload 5
    //   151: invokevirtual 145	ajhh:a	(Ljava/lang/String;)Ljava/util/Map;
    //   154: astore 7
    //   156: aload 7
    //   158: ifnull +45 -> 203
    //   161: aload 7
    ...
    //   193: aload_0
    //   194: getfield 77	ajhh:jdField_a_of_type_Atmp	Latmp;
    //   197: aload 8
    //   199: invokevirtual 529	atmp:a	(Latmo;)Z
    //   202: pop
    //   203: aload 6
    //   205: ifnull -90 -> 115
    //   208: aload 6
    ...
    //   222: aload_0
    //   223: getfield 63	ajhh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   226: aload 5
    //   228: aload 6
    //   230: aload 7
    //   232: iconst_0
    //   233: invokestatic 148	babh:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lcom/tencent/mobileqq/data/DiscussionInfo;Ljava/util/Map;Z)Z
    //   236: ifeq -121 -> 115
    //   239: aload_0
    //   240: aload 6
    //   242: invokevirtual 166	ajhh:a	(Latmo;)Z
    //   245: pop
    //   246: goto -131 -> 115
    //   249: astore_1
    ...
    //   266: aload_3
    //   267: invokevirtual 171	atmr:b	()V
    //   270: return
    //   271: aload_3
    //   272: invokevirtual 169	atmr:c	()V
    //   275: aload_3
    //   276: invokevirtual 171	atmr:b	()V
    //   279: return
    //   280: astore_1
    //   281: aload_3
    //   282: invokevirtual 171	atmr:b	()V
    //   285: aload_1
    //   286: athrow
    // Local variable table:
    //   start	length	slot	name	signature
