...
{
  public ygd(AVCameraCaptureModel paramAVCameraCaptureModel) {}
  ...
  public void surfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    if (GraphicRendererMgr.getInstance() != null)
    {
      ...
      AVManager.a(AVCameraCaptureModel.a(this.a)).a().getVideoCtrl().setLocalVideoPreviewCallback(new yge(this));
      AVManager.a(AVCameraCaptureModel.a(this.a)).a().getVideoCtrl().setRemoteVideoPreviewCallback(new ygg(this));
    }
    for (;;)
    {
  ...
  public void surfaceDestroyed(SurfaceHolder paramSurfaceHolder)
  {
    ...
    paramSurfaceHolder.enableCamera(0, false, new ygi(this));
