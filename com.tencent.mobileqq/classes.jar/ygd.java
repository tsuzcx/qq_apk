...
public class ygd
{
  public static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    if (paramCommentEntry.commentType == 1) {
      return c(paramCommentLikeFeedItem, paramCommentEntry, paramygf);
    }
    if (paramCommentEntry.commentType == 2) {
      return d(paramCommentLikeFeedItem, paramCommentEntry, paramygf);
    }
    if (paramCommentEntry.commentType == 5) {
      return c(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramygf);
    }
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramygf, true);
    }
    return a(paramCommentLikeFeedItem, paramCommentEntry, paramygf);
  }
  
  private static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf, boolean paramBoolean)
  {
    paramContext = ((wtt)wth.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str5))
    {
      ...
      if (!behh.a(paramCommentEntry.content)) {
        break label511;
      }
    }
    label84:
    ...
    label125:
    label511:
    for (paramCommentLikeFeedItem = bcsa.b(paramCommentEntry.content);; paramCommentLikeFeedItem = null)
    {
      String str1;
      String str2;
      if (paramBoolean)
      {
        paramContext = anzj.a(2131713097);
        if (i == 0) {
          break label403;
        }
        str1 = "V";
      ...
      for (paramCommentLikeFeedItem = new begz(str2 + paramContext + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + paramContext + ": " + str6))
      {
        for (;;)
        {
          i = 0;
          if (paramBoolean)
          {
            ...
            a(paramCommentLikeFeedItem, 0, k, paramygf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
            j = str4.length() + k;
            i = j;
            if (k != j)
            {
          ...
          catch (Exception paramContext)
          {
            ...
            a(paramCommentLikeFeedItem, paramCommentLikeFeedItem.length() - "I".length(), paramCommentLikeFeedItem.length(), 2130846464, 15, 15, 3);
            return paramCommentLikeFeedItem;
          }
        }
        paramContext = anzj.a(2131713100);
        break label84;
        str1 = "";
        break label93;
        str2 = "";
  ...
  private static SpannableStringBuilder a(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    String str1 = null;
    if (behh.a(paramCommentEntry.content)) {
      str1 = bcsa.b(paramCommentEntry.content);
    }
    String str3 = anzj.a(2131713098);
    if (str1 != null) {}
    for (paramCommentEntry = new begz(str3 + ": " + str1, 3, 16);; paramCommentEntry = new SpannableStringBuilder(str3 + ": " + str2))
    {
  ...
  private static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    Object localObject1 = (wtt)wth.a(2);
    Object localObject3 = ((wtt)localObject1).c(paramCommentEntry.authorUnionId);
    ...
    {
      localObject2 = ((wtt)localObject1).c(paramCommentEntry.replierUnionId);
    ...
    for (paramCommentLikeFeedItem = (CommentLikeFeedItem)localObject2;; paramCommentLikeFeedItem = null)
    {
      ...
      if (!TextUtils.isEmpty(str4))
      {
        ...
        if (behh.a(paramCommentEntry.content)) {
          paramCommentLikeFeedItem = bcsa.b(paramCommentEntry.content);
        }
        str6 = anzj.a(2131713103);
        if (i == 0) {
          break label415;
        }
        localObject2 = "V";
      ...
      label422:
      label429:
      for (paramCommentLikeFeedItem = new begz(str2 + (String)localObject2 + str3 + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + ": " + str7))
      {
        j = str2.length();
        ...
        a(paramCommentLikeFeedItem, 0, i, paramygf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
        j = str3.length() + i;
        paramygf = paramCommentLikeFeedItem;
        if (i != j)
        {
          b(paramCommentLikeFeedItem, i, j, -4473925);
          paramygf = paramCommentLikeFeedItem;
        ...
        {
          paramygf.append(" ");
          paramCommentLikeFeedItem = anzj.a(2131713102);
          i = paramygf.length();
          j = paramCommentLikeFeedItem.length();
          paramygf.append(paramCommentLikeFeedItem);
          b(paramygf, i, j + i, -48606);
          i = paramygf.length();
          j = "[icon]  ".length();
          paramygf.append("[icon]  ");
          a(paramygf, i, j + i, 2130848657);
        }
        return paramygf;
        i = 0;
        break;
      ...
      label475:
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new begz(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + str7))
      {
        j = str2.length();
        a(paramCommentLikeFeedItem, 0, j);
        if (wnv.a()) {
        ...
        a(paramCommentLikeFeedItem, i - str1.length(), j, paramygf, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  public static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, List<LikeEntry> paramList, ygf paramygf)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    String str1 = paramCommentLikeFeedItem.feedId + "_" + paramList.hashCode();
    Object localObject = wrc.a().a(str1);
    ...
    for (paramCommentLikeFeedItem = paramCommentLikeFeedItem.qq;; paramCommentLikeFeedItem = null)
    {
      ...
      for (;;)
      {
        if (j < paramList.size())
        {
          ...
          localObject = ((wtt)wth.a(2)).c(localLikeEntry.unionId);
          ...
          for (localObject = "";; localObject = ", ")
          {
            ...
            a(localSpannableStringBuilder, m, n, paramygf, localLikeEntry.unionId);
            break;
            k = 0;
            break label220;
            localObject = "";
      ...
      if (i != 0) {
        wrc.a().a(str1, localSpannableStringBuilder);
      }
  ...
  private static String a(CommentLikeFeedItem paramCommentLikeFeedItem, QQUserUIItem paramQQUserUIItem)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        return ((wtp)wth.a(23)).a(paramQQUserUIItem, paramCommentLikeFeedItem, false, false);
        i = 0;
        break;
      }
      return xiz.a(paramQQUserUIItem);
      label93:
      paramCommentLikeFeedItem = null;
      continue;
      paramCommentLikeFeedItem = null;
  ...
  {
    paramString1 = ((wtt)wth.a(2)).c(paramString1);
    if (paramBoolean) {
      return ((wtp)wth.a(23)).a(paramString1, paramString3, false, false);
    }
    return xiz.a(paramString1);
  }
  ...
  {
    paramInt4 = zps.a(BaseApplicationImpl.getContext(), paramInt4);
    paramInt5 = zps.a(BaseApplicationImpl.getContext(), paramInt5);
    ...
    for (;;)
    {
      ...
      if (paramInt6 == 0) {
        ...
        localObject = new zsx((Drawable)localObject);
      } else {
        localObject = new zuc((Drawable)localObject);
      }
    }
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, ygf paramygf, String paramString)
  {
    a(paramSpannableStringBuilder, paramInt1, paramInt2, paramygf, paramString, 0);
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, ygf paramygf, String paramString, int paramInt3)
  {
    paramSpannableStringBuilder.setSpan(new yge(paramygf, paramString, paramInt3), paramInt1, paramInt2, 33);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString, int paramInt1, int paramInt2)
  {
    ...
    int i = zps.a(BaseApplicationImpl.getContext(), 13.0F);
    paramString.setBounds(0, 0, i, i);
    paramSpannableStringBuilder.setSpan(new zuc(paramString), paramInt1, paramInt2, 33);
  }
  
  public static SpannableStringBuilder b(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    if (paramCommentEntry.commentType == 1) {
    ...
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramygf, false);
    }
    return b(paramCommentLikeFeedItem, paramCommentEntry, paramygf);
  }
  
  private static SpannableStringBuilder b(@NonNull CommentEntry paramCommentEntry)
  {
    String str = anzj.a(2131713099);
    ...
    default: 
      return paramCommentEntry;
    case 1: 
      a(paramCommentEntry, j, k, 2130844603, 37, 16);
      return paramCommentEntry;
    case 2: 
      a(paramCommentEntry, j, k, 2130844605, 37, 16);
      return paramCommentEntry;
    case 3: 
      a(paramCommentEntry, j, k, 2130844604, 37, 16);
      return paramCommentEntry;
    case 4: 
      a(paramCommentEntry, j, k, 2130844602, 37, 16);
      return paramCommentEntry;
    }
    a(paramCommentEntry, j, k, 2130844601, 37, 16);
    return paramCommentEntry;
  }
  
  private static SpannableStringBuilder b(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    String str1 = null;
    Object localObject1 = (wtt)wth.a(2);
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          if (paramCommentLikeFeedItem != null)
          {
            paramCommentEntry = new begz(paramCommentLikeFeedItem, 3, 16);
            return paramCommentEntry;
            i = 0;
            break;
            label153:
      ...
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new begz(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + str4))
      {
        int j = str3.length();
        i = ((String)localObject1).length() + j;
        a(paramCommentLikeFeedItem, j, i);
        ...
        a(paramCommentLikeFeedItem, i - ((String)localObject1).length(), j, paramygf, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  private static SpannableStringBuilder c(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    paramContext = ((wtt)wth.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      paramContext = anzj.a(2131713092);
      label100:
      if (i == 0) {
        break label370;
      }
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, i, paramygf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = i + str2.length();
      if (i != j) {
      ...
      j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130846464, 15, 15, 3);
      }
      return localSpannableStringBuilder;
      i = 0;
      break;
      paramContext = " @" + paramContext + anzj.a(2131713092);
      break label100;
    }
  }
  ...
  private static SpannableStringBuilder c(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    for (paramCommentEntry = anzj.a(2131713096);; paramCommentEntry = "@" + paramCommentEntry + anzj.a(2131713094))
    {
      ...
      int j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130846464, 15, 15);
      }
      return localSpannableStringBuilder;
    }
  }
  
  private static SpannableStringBuilder c(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    Object localObject = ((wtt)wth.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      localObject = null;
      if (behh.a(paramCommentEntry.content)) {
        localObject = bcsa.b(paramCommentEntry.content);
      }
      str4 = anzj.a(2131713095);
      if (i == 0) {
        break label272;
      }
    ...
    label272:
    label278:
    for (localObject = new begz(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + (String)localObject, 3, 16);; localObject = new SpannableStringBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + str5))
    {
      int j = str1.length();
      ...
      a((SpannableStringBuilder)localObject, 0, i, paramygf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = str2.length() + i;
      if (i != j) {
  ...
  private static SpannableStringBuilder d(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, ygf paramygf)
  {
    Object localObject = ((wtt)wth.a(2)).c(paramCommentEntry.authorUnionId);
    String str1 = a(paramCommentLikeFeedItem, (QQUserUIItem)localObject);
    String str2 = a(paramCommentEntry.authorRole, (QQUserUIItem)localObject);
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, j, paramygf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      k = str2.length() + j;
      if (j != k) {
    ...
    a(localSpannableStringBuilder, j, k, 2130844603, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844605, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844604, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844602, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844601, 37, 16, 3);
    return localSpannableStringBuilder;
  }
}
