...
public class bhca
{
  ...
  public static bhcb a(byte[] paramArrayOfByte)
  {
    bhcb localbhcb = new bhcb();
    ...
    for (;;)
    {
      try
      {
        ...
        localbhcb.jdField_a_of_type_Int = paramArrayOfByte.get();
        ...
        if (paramArrayOfByte.hasRemaining())
        {
          ...
          localbhcb.c = i;
          localbhcb.jdField_a_of_type_JavaLangString = new String(arrayOfByte);
          if (QLog.isColorLevel()) {
            QLog.d("ActionMsgUtil", 2, "decodeAppShareCookie succes appShareCookie.buissnessType =" + localbhcb.jdField_a_of_type_Int + "appShareCookie.action" + localbhcb.b + "appShareCookie.actionType" + localbhcb.c + "appShareCookie.actionValue" + localbhcb.jdField_a_of_type_JavaLangString);
          }
        }
      }
