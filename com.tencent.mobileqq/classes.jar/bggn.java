  ...
  implements Closeable
{
  ...
  public bggn(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, bggo parambggo)
  {
    byte[] arrayOfByte = this.jdField_b_of_type_ArrayOfByte;
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = parambggo.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((parambggo.jdField_a_of_type_ArrayOfByte == null) || (parambggo.jdField_a_of_type_ArrayOfByte.length < m)) {
        parambggo.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = parambggo.jdField_a_of_type_ArrayOfByte;
      parambggo.jdField_a_of_type_Int = m;
    ...
    catch (Throwable parambggo)
    {
      QLog.e("BlobCache", 2, "getBlob failed.", parambggo);
      return false;
    }
    finally
    {
  ...
  public boolean a(bggo parambggo)
  {
    if ((a(parambggo.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, parambggo))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(parambggo.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, parambggo))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + parambggo.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      a(parambggo.jdField_a_of_type_Long, parambggo.jdField_a_of_type_ArrayOfByte, parambggo.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
