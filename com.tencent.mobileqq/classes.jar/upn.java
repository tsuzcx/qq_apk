...
public class upn
{
  ...
  private void a(Context paramContext, int paramInt1, String paramString, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        int i = a();
        uya.d("WSGridCardPresenter", "open weishi scheme = " + paramString + ", weishi_jump_url = " + paramstSimpleMetaFeed.weishi_jump_url);
        uyc.a(paramContext.getApplicationContext(), "biz_src_jc_gzh_weishi", paramString, 1, i, paramInt2);
        if (i == 2) {
          uvi.a(paramstSimpleMetaFeed, paramInt1, 1000);
        }
        uvi.a(1, 114, paramInt1, paramstSimpleMetaFeed, null);
        return;
      }
      catch (Exception paramContext)
      {
        paramContext.printStackTrace();
        uya.d("WSGridCardPresenter", "open weishi error scheme = " + paramString);
        return;
      }
  ...
  private void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    unq.a((Activity)paramContext, localWSDownloadParams, false);
  }
  ...
  private void b(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    for (;;)
    {
      uvi.a(paramstSimpleMetaFeed, paramInt, 1001);
      return;
      if (umu.a().a()) {
        c(paramContext, paramInt, paramstSimpleMetaFeed);
      } else {
        uya.a("WSGridCardPresenter", "B test do not download when 4g is not open is server");
      }
    }
  }
  ...
  private void c(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    if (i < 10000)
    {
      ...
      paramContext = ((ukg)localObject).a();
      label98:
      if (localObject == null) {
        break label159;
      }
    ...
    label154:
    label159:
    for (Object localObject = ((ukg)localObject).a();; localObject = null)
    {
      unq.a(localActivity, localWSDownloadParams, paramContext, (RockDownloadListenerWrapper)localObject);
      uvi.a(1, 115, paramInt, paramstSimpleMetaFeed, unq.a(localWSDownloadParams.mScene, localWSDownloadParams.mLinkStrategyType, localWSDownloadParams.mEventId));
      return;
      i = 100;
      break;
      paramContext = null;
  ...
  private void d(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    if (paramstSimpleMetaFeed.video != null)
    {
      ...
      {
        pay.d(paramContext, localstH5OpInfo.h5Url);
        uvr.a(140, localstH5OpInfo.type, paramInt, paramstSimpleMetaFeed.h5_op_info.id);
        uvi.a(140, 9, null);
  ...
  public void a(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      uvi.a(str2, str3, str1, paramstSimpleMetaFeed.feed_desc, paramInt, 112, 1, 0);
      uvr.a(true);
      if ((paramContext instanceof BaseActivity))
      {
        paramContext = bfwg.a(((BaseActivity)paramContext).app, paramContext, paramstSimpleMetaFeed.video_url + "&click_index=" + (paramInt + 1));
        if (paramContext != null) {
          paramContext.a();
        }
        auqd.jdField_a_of_type_JavaLangString = paramstSimpleMetaFeed.id;
        auqd.b = paramstSimpleMetaFeed.feed_desc;
        auqd.jdField_a_of_type_Int = paramInt;
      }
      return;
    }
  }
  ...
  public void a(Context paramContext, int paramInt, ArrayList<stSimpleMetaFeed> paramArrayList, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      uvr.a(141, paramstSimpleMetaFeed.id);
      return;
    }
    uvr.a(112, Integer.valueOf(2));
  }
  ...
  public void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      uvr.a(112, paramstSimpleMetaFeed.h5_op_info.type, paramInt, paramstSimpleMetaFeed.h5_op_info.id);
    ...
    {
      uvi.a(i, (Map)localObject2, str1, j, str2, str3, str4, paramInt, "", (String)localObject1, paramstSimpleMetaFeed.h5_op_info.id);
      ...
      uyo.a(paramContext, (String)localObject1, str1, "", paramstSimpleMetaFeed.h5_op_info.type, new upo(this, paramContext, paramInt, paramstSimpleMetaFeed));
      return;
    }
  }
    ...
    while (i != 0)
    {
      ...
      else
      {
        ...
        if ((localstWaterFallItemStrategy != null) && (localstWaterFallItemStrategy.isCallWeishi))
        {
          ...
          bool2 = umu.a().a(1);
          uya.d("WSGridCardPresenter", "openCallWeishi = " + bool1 + ", isOpenVideoPage = " + bool2 + ", callCount = " + i + ", openCallWSCount = " + localukg.jdField_a_of_type_Int);
          uvr.a(112, Integer.valueOf(114));
          WSPublicAccReport.getInstance().feedsItemReport("gzh_click", uyo.a(1), paramstSimpleMetaFeed, uvi.a(paramstSimpleMetaFeed, paramInt), 1000003);
          if ((!bool1) || (localukg.jdField_a_of_type_Int >= i)) {
            break;
          }
          localukg.jdField_a_of_type_Int += 1;
          if (i >= 10000) {
            break label310;
          }
          i = 104;
        ...
        for (i = 143;; i = 142)
        {
          uvi.a(paramstSimpleMetaFeed, paramInt, i);
          return true;
          bool1 = false;
          break;
          bool2 = false;
        ...
        label325:
        uya.d("WSGridCardPresenter", "openDownloadWeishi = " + bool2 + ", downloadCount = " + j + ", openDownloadWSCount = " + ukg.b);
        uvr.a(112, Integer.valueOf(115));
        WSPublicAccReport.getInstance().feedsItemReport("gzh_click", uyo.a(1), paramstSimpleMetaFeed, uvi.a(paramstSimpleMetaFeed, paramInt), 1000002);
        if ((bool2) && (ukg.b < j))
        {
          a(paramContext, paramInt, paramArrayList, paramstSimpleMetaFeed);
