...
class axsy
{
  ...
  private axtc jdField_a_of_type_Axtc;
  public String a;
  private Map<String, Integer> jdField_a_of_type_JavaUtilMap = new HashMap();
  private long jdField_b_of_type_Long;
  private axtc jdField_b_of_type_Axtc;
  public String b;
  public String c;
  
  public axsy(axsw paramaxsw)
  {
    this.jdField_a_of_type_Axtc = new axtc(axsw.a(paramaxsw), axsw.a(paramaxsw));
    this.jdField_b_of_type_Axtc = new axtc(axsw.b(paramaxsw), axsw.b(paramaxsw));
  }
  ...
  public Pair<Boolean, List<axtd>> a(PowerManager.WakeLock paramWakeLock, String paramString, long paramLong)
  {
    boolean bool = false;
    ...
    this.jdField_a_of_type_Axtc.a(paramString);
    return new Pair(Boolean.valueOf(bool), this.jdField_b_of_type_Axtc.a(paramString));
  }
