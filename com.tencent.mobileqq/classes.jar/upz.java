...
public class upz
{
  public static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    if (paramCommentEntry.commentType == 1) {
      return c(paramCommentLikeFeedItem, paramCommentEntry, paramuqb);
    }
    if (paramCommentEntry.commentType == 2) {
      return d(paramCommentLikeFeedItem, paramCommentEntry, paramuqb);
    }
    if (paramCommentEntry.commentType == 5) {
      return c(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramuqb);
    }
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramuqb, true);
    }
    return a(paramCommentLikeFeedItem, paramCommentEntry, paramuqb);
  }
  
  private static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb, boolean paramBoolean)
  {
    paramContext = ((tdo)tdc.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str5))
    {
      ...
      if (!ayla.a(paramCommentEntry.content)) {
        break label511;
      }
    }
    label84:
    ...
    label125:
    label511:
    for (paramCommentLikeFeedItem = axas.b(paramCommentEntry.content);; paramCommentLikeFeedItem = null)
    {
      String str1;
      String str2;
      if (paramBoolean)
      {
        paramContext = ajyc.a(2131714241);
        if (i == 0) {
          break label403;
        }
        str1 = "V";
      ...
      for (paramCommentLikeFeedItem = new ayks(str2 + paramContext + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + paramContext + ": " + str6))
      {
        for (;;)
        {
          i = 0;
          if (paramBoolean)
          {
            ...
            a(paramCommentLikeFeedItem, 0, k, paramuqb, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
            j = str4.length() + k;
            i = j;
            if (k != j)
            {
          ...
          catch (Exception paramContext)
          {
            ...
            a(paramCommentLikeFeedItem, paramCommentLikeFeedItem.length() - "I".length(), paramCommentLikeFeedItem.length(), 2130845550, 15, 15, 3);
            return paramCommentLikeFeedItem;
          }
        }
        paramContext = ajyc.a(2131714244);
        break label84;
        str1 = "";
        break label93;
        str2 = "";
  ...
  private static SpannableStringBuilder a(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    String str1 = null;
    if (ayla.a(paramCommentEntry.content)) {
      str1 = axas.b(paramCommentEntry.content);
    }
    String str3 = ajyc.a(2131714242);
    if (str1 != null) {}
    for (paramCommentEntry = new ayks(str3 + ": " + str1, 3, 16);; paramCommentEntry = new SpannableStringBuilder(str3 + ": " + str2))
    {
  ...
  private static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    Object localObject1 = (tdo)tdc.a(2);
    Object localObject3 = ((tdo)localObject1).c(paramCommentEntry.authorUnionId);
    ...
    {
      localObject2 = ((tdo)localObject1).c(paramCommentEntry.replierUnionId);
    ...
    for (paramCommentLikeFeedItem = (CommentLikeFeedItem)localObject2;; paramCommentLikeFeedItem = null)
    {
      ...
      if (!TextUtils.isEmpty(str4))
      {
        ...
        if (ayla.a(paramCommentEntry.content)) {
          paramCommentLikeFeedItem = axas.b(paramCommentEntry.content);
        }
        str6 = ajyc.a(2131714247);
        if (i == 0) {
          break label415;
        }
        localObject2 = "V";
      ...
      label422:
      label429:
      for (paramCommentLikeFeedItem = new ayks(str2 + (String)localObject2 + str3 + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + ": " + str7))
      {
        j = str2.length();
        ...
        a(paramCommentLikeFeedItem, 0, i, paramuqb, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
        j = str3.length() + i;
        paramuqb = paramCommentLikeFeedItem;
        if (i != j)
        {
          b(paramCommentLikeFeedItem, i, j, -4473925);
          paramuqb = paramCommentLikeFeedItem;
        ...
        {
          paramuqb.append(" ");
          paramCommentLikeFeedItem = ajyc.a(2131714246);
          i = paramuqb.length();
          j = paramCommentLikeFeedItem.length();
          paramuqb.append(paramCommentLikeFeedItem);
          b(paramuqb, i, j + i, -48606);
          i = paramuqb.length();
          j = "[icon]  ".length();
          paramuqb.append("[icon]  ");
          a(paramuqb, i, j + i, 2130847701);
        }
        return paramuqb;
        i = 0;
        break;
      ...
      label475:
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new ayks(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + str7))
      {
        j = str2.length();
        a(paramCommentLikeFeedItem, 0, j);
        if (sxq.a()) {
        ...
        a(paramCommentLikeFeedItem, i - str1.length(), j, paramuqb, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  public static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, List<LikeEntry> paramList, uqb paramuqb)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    String str1 = paramCommentLikeFeedItem.feedId + "_" + paramList.hashCode();
    Object localObject = tax.a().a(str1);
    ...
    for (paramCommentLikeFeedItem = paramCommentLikeFeedItem.qq;; paramCommentLikeFeedItem = null)
    {
      ...
      for (;;)
      {
        if (j < paramList.size())
        {
          ...
          localObject = ((tdo)tdc.a(2)).c(localLikeEntry.unionId);
          ...
          for (localObject = "";; localObject = ", ")
          {
            ...
            a(localSpannableStringBuilder, m, n, paramuqb, localLikeEntry.unionId);
            break;
            k = 0;
            break label220;
            localObject = "";
      ...
      if (i != 0) {
        tax.a().a(str1, localSpannableStringBuilder);
      }
  ...
  private static String a(CommentLikeFeedItem paramCommentLikeFeedItem, QQUserUIItem paramQQUserUIItem)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        return ((tdk)tdc.a(23)).a(paramQQUserUIItem, paramCommentLikeFeedItem, false, false);
        i = 0;
        break;
      }
      return tsu.a(paramQQUserUIItem);
      label93:
      paramCommentLikeFeedItem = null;
      continue;
      paramCommentLikeFeedItem = null;
  ...
  {
    paramString1 = ((tdo)tdc.a(2)).c(paramString1);
    if (paramBoolean) {
      return ((tdk)tdc.a(23)).a(paramString1, paramString3, false, false);
    }
    return tsu.a(paramString1);
  }
  ...
  {
    paramInt4 = vzo.a(BaseApplicationImpl.getContext(), paramInt4);
    paramInt5 = vzo.a(BaseApplicationImpl.getContext(), paramInt5);
    ...
    for (;;)
    {
      ...
      if (paramInt6 == 0) {
        ...
        localObject = new wct((Drawable)localObject);
      } else {
        localObject = new wdy((Drawable)localObject);
      }
    }
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, uqb paramuqb, String paramString)
  {
    a(paramSpannableStringBuilder, paramInt1, paramInt2, paramuqb, paramString, 0);
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, uqb paramuqb, String paramString, int paramInt3)
  {
    paramSpannableStringBuilder.setSpan(new uqa(paramuqb, paramString, paramInt3), paramInt1, paramInt2, 33);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString, int paramInt1, int paramInt2)
  {
    ...
    int i = vzo.a(BaseApplicationImpl.getContext(), 13.0F);
    paramString.setBounds(0, 0, i, i);
    paramSpannableStringBuilder.setSpan(new wdy(paramString), paramInt1, paramInt2, 33);
  }
  
  public static SpannableStringBuilder b(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    if (paramCommentEntry.commentType == 1) {
    ...
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramuqb, false);
    }
    return b(paramCommentLikeFeedItem, paramCommentEntry, paramuqb);
  }
  
  private static SpannableStringBuilder b(@NonNull CommentEntry paramCommentEntry)
  {
    String str = ajyc.a(2131714243);
    ...
    a(paramCommentEntry, j, k, 2130843776, 37, 16);
    return paramCommentEntry;
  }
  
  private static SpannableStringBuilder b(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    String str1 = null;
    Object localObject1 = (tdo)tdc.a(2);
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          if (paramCommentLikeFeedItem != null)
          {
            paramCommentEntry = new ayks(paramCommentLikeFeedItem, 3, 16);
            return paramCommentEntry;
            i = 0;
            break;
            label153:
      ...
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new ayks(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + str4))
      {
        int j = str3.length();
        i = ((String)localObject1).length() + j;
        a(paramCommentLikeFeedItem, j, i);
        ...
        a(paramCommentLikeFeedItem, i - ((String)localObject1).length(), j, paramuqb, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  private static SpannableStringBuilder c(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    paramContext = ((tdo)tdc.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      paramContext = ajyc.a(2131714236);
      label100:
      if (i == 0) {
        break label370;
      }
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, i, paramuqb, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = i + str2.length();
      if (i != j) {
      ...
      j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130845550, 15, 15, 3);
      }
      return localSpannableStringBuilder;
      i = 0;
      break;
      paramContext = " @" + paramContext + ajyc.a(2131714236);
      break label100;
    }
  }
  ...
  private static SpannableStringBuilder c(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    for (paramCommentEntry = ajyc.a(2131714240);; paramCommentEntry = "@" + paramCommentEntry + ajyc.a(2131714238))
    {
      ...
      int j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130845550, 15, 15);
      }
      return localSpannableStringBuilder;
    }
  }
  
  private static SpannableStringBuilder c(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    Object localObject = ((tdo)tdc.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      localObject = null;
      if (ayla.a(paramCommentEntry.content)) {
        localObject = axas.b(paramCommentEntry.content);
      }
      str4 = ajyc.a(2131714239);
      if (i == 0) {
        break label272;
      }
    ...
    label272:
    label278:
    for (localObject = new ayks(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + (String)localObject, 3, 16);; localObject = new SpannableStringBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + str5))
    {
      int j = str1.length();
      ...
      a((SpannableStringBuilder)localObject, 0, i, paramuqb, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = str2.length() + i;
      if (i != j) {
  ...
  private static SpannableStringBuilder d(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, uqb paramuqb)
  {
    Object localObject = ((tdo)tdc.a(2)).c(paramCommentEntry.authorUnionId);
    String str1 = a(paramCommentLikeFeedItem, (QQUserUIItem)localObject);
    String str2 = a(paramCommentEntry.authorRole, (QQUserUIItem)localObject);
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, j, paramuqb, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      k = str2.length() + j;
      if (j != k) {
    ...
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843776, 37, 16, 3);
    return localSpannableStringBuilder;
  }
}
