  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public ahvp(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  protected Integer a(Void... arg1)
  {
    ...
    {
      localObject1 = bbqf.a(0, this.jdField_b_of_type_Int);
      bbrp localbbrp = bbqf.a(this.jdField_a_of_type_AndroidContentIntent, (bbqx)localObject1);
      if (localbbrp == null) {
        return Integer.valueOf(5);
      }
      localbbrp.d = true;
      localbbrp.a = false;
      if ((localbbrp.r != null) && (localbbrp.r.length() == 39)) {
        localbbrp.r = localbbrp.r.substring(0, 28);
      }
      ((bbqx)localObject1).a(localbbrp);
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((MessageForShortVideo)new bbpo(???.app).a(localbbrp));
      ...
      ((ahux)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(138)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo);
