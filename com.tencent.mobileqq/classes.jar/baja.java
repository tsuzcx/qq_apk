...
public class baja
{
  ...
  private volatile balq jdField_a_of_type_Balq;
  ...
  private baja(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    if (paramInt5 == -1)
    {
      ...
      bakl.a("AudioNewRecorder", "AudioNewRecorder, inited bufferSizeInBytes:" + this.b);
      ...
      if (Build.VERSION.SDK_INT >= 16)
      {
        ...
        {
          bakl.a("AudioNewRecorder", "echo canceler not null, release it");
        ...
        bakl.a("AudioNewRecorder", "create echo canceler, set enable true, session id:" + jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      break label184;
      label225:
      bakl.a("AudioNewRecorder", "echo canceler not available");
    }
  }
  
  public baja(QQRecorder.RecorderParam paramRecorderParam)
  {
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      if (paramInt1 <= 0)
      {
        if (this.jdField_a_of_type_Balq != null) {
          this.jdField_a_of_type_Balq.a("readsize invalid...");
        }
        Thread.sleep(10L);
      }
      else
      {
        if (this.jdField_a_of_type_Balq != null) {
          this.jdField_a_of_type_Balq.a(arrayOfByte, this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get());
        }
        l2 += 1L;
        l1 += paramInt1;
    ...
    bakl.a("AudioNewRecorder", "record finished, slice index:" + l2 + ", total size:" + l1);
  }
  
  public void a()
  {
    bakl.a("AudioNewRecorder", "stop recorder...");
    try
    {
      if (this.jdField_a_of_type_AndroidMediaAudiofxAcousticEchoCanceler != null) {
    ...
    {
      bakl.a("AudioNewRecorder", localIllegalStateException.getMessage());
    }
  }
  ...
  public void a(int paramInt, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    {
      if (this.jdField_a_of_type_Balq != null) {
        this.jdField_a_of_type_Balq.a("AudioRecorder init state failure");
      }
      return;
    }
  ...
  public void a(balq parambalq)
  {
    this.jdField_a_of_type_Balq = parambalq;
  }
  ...
  public boolean a(balr parambalr)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 80	baja:jdField_a_of_type_AndroidMediaAudioRecord	Landroid/media/AudioRecord;
    ...
    //   31: aload_0
    //   32: aload_1
    //   33: invokespecial 214	com/tencent/mobileqq/qassistant/audio/AudioNewRecorder$1:<init>	(Lbaja;Lbalr;)V
    //   36: bipush 16
    //   38: aconst_null
    //   39: iconst_0
  ...
  public void b()
  {
    bakl.a("AudioNewRecorder", "release recorder...");
    try
    {
      if (this.jdField_a_of_type_AndroidMediaAudioRecord != null) {
        this.jdField_a_of_type_AndroidMediaAudioRecord.stop();
    ...
    {
      bakl.a("AudioNewRecorder", "release err:" + localException.getMessage());
    }
  }
}
