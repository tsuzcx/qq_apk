...
public class baja
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          QQToast.a(BaseApplication.getContext(), 0, anni.a(2131699871), 0).a();
        ...
        for (;;)
        {
          ...
          QQToast.a(BaseApplication.getContext(), 0, anni.a(2131699874), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = bglp.a(paramActivity, String.format(Locale.getDefault(), anni.a(2131699878), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694081, new bajb());
          if ((paramActivity != null) && (!paramActivity.isFinishing())) {
            paramList.show();
          }
          bcst.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "frd_select", "notAdd_exp", 0, 0, paramString, String.valueOf(j), "", "");
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    bfyp.a(paramQQAppInterface, true, localTroopInfo);
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), anni.a(2131699872), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label745;
      }
      paramString3 = String.format(Locale.getDefault(), anni.a(2131699875), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + anni.a(2131699879);
        localObject1 = anni.a(2131699876);
        i = paramString3.indexOf((String)localObject1);
        j = ((String)localObject1).length();
        localObject1 = new auxc(paramString1, paramString1, paramString3, 1, -5020, 135178, l2);
        ((auxc)localObject1).jdField_c_of_type_JavaLangString = paramString3;
        ...
        ((auxc)localObject1).a(i, i + j, paramString3);
        ...
        label348:
        ((auxc)localObject1).d = paramString3;
      ...
      {
        bcst.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", (String)localObject2, 0, 0, paramString1, (String)localObject1, "", paramString3);
        if (!QLog.isDevelopLevel()) {
          break;
        }
        ...
        break label108;
        label618:
        paramString3 = String.format(Locale.getDefault(), anni.a(2131699877), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), anni.a(2131699873), new Object[] { paramString2 });
        paramInt2 = 0;
        break label187;
        paramString3 = paramString3 + anni.a(2131699870);
        break label217;
        paramString3 = "";
        break label348;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    anmw localanmw = (anmw)paramFriendListHandler.app.getManager(51);
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      if (localAddFrdInfo.uint32_send_req_flag.get() == 1)
      {
        ...
        localanmw.a(Long.toString(localAddFrdInfo.uint64_uin.get()), false);
        bool1 = bool2;
        break label90;
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (anmw)paramFriendListHandler.app.getManager(51);
      ...
      if (i > 0)
      {
        ...
        if (i >= 0)
        {
          ...
          ((anmw)localObject).a(Long.toString(l1), true);
          i -= 1;
        }
        else
        {
