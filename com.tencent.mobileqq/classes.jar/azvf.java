...
public class azvf
{
  public static azvg a;
  public static final String a;
  public static HashMap<String, azvg> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anhk.ba + "qbosssplahAD/";
    b = anhk.ba + "qbdownres";
  ...
  public static HashMap<String, azvg> a(Context paramContext, String paramString)
  {
    try
    {
      ...
      while (paramContext.hasNext())
      {
        ...
        azvh localazvh = new azvh();
        localazvh.g(paramString).a(str1).b(str2).c(str3).c(i).d(str4).e(k).f(str6).e(str5).d(j).b(bool1).a(bool2).b(m).h(str7).i(str8).a(n);
        QLog.i("QSplash@QbossSplashUtil", 1, "buildADEntryFromSP  adid =" + str1);
        jdField_a_of_type_JavaUtilHashMap.put(str1, localazvh.a());
      }
  ...
  public static boolean a(long paramLong)
  {
    ...
    //   9: lload_0
    //   10: invokestatic 473	azvf:a	(Landroid/content/Context;J)Ljava/util/List;
    //   13: astore 7
    //   15: iload 4
    //   17: istore_3
    //   18: aload 7
    ...
    //   90: invokestatic 480	azvf:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/HashMap;
    //   93: astore 9
    //   95: aconst_null
    //   96: astore 6
    //   98: aload 7
    ...
    //   167: aload 8
    //   169: invokevirtual 492	azvg:toString	()Ljava/lang/String;
    ...
    //   181: aload 8
    //   183: invokevirtual 494	azvg:a	()Z
    //   186: ifeq +95 -> 281
    //   189: aload 6
    ...
    //   203: astore 7
    //   205: aload 8
    //   207: getfield 497	azvg:d	I
    //   210: aload 6
    //   212: getfield 497	azvg:d	I
    //   215: if_icmpgt +59 -> 274
    //   218: goto +63 -> 281
    //   221: aload 6
    //   223: putstatic 499	azvf:jdField_a_of_type_Azvg	Lazvg;
    //   226: iconst_1
    //   227: istore_3
    //   228: iload_3
    //   229: ireturn
