  ...
  implements BusinessInfoCheckUpdateItem
{
  ...
  protected aocj(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Int = 600000;
    this.jdField_a_of_type_ComTencentMobileqqAppSosoLbsManagerService$OnLocationChangeListener = new aock(this, "vas_red_point", false);
  }
  ...
  public static List<aocl> a(AppRuntime paramAppRuntime)
  {
    ...
    while (i < paramAppRuntime.size())
    {
      ...
      localaocl.jdField_a_of_type_Long = ((LebaPluginInfo)paramAppRuntime.get(i)).uiResId;
      localaocl.jdField_a_of_type_Int = ((int)((LebaPluginInfo)paramAppRuntime.get(i)).uiResId);
      localArrayList.add(localaocl);
      i += 1;
    }
  ...
  {
    Object localObject = (bcvc)paramQQAppInterface.getManager(QQManagerFactory.GAMECENTER_MANAGER);
    if (localObject != null) {
      ((bcvc)localObject).a();
    }
    localObject = new NewIntent(paramQQAppInterface.getApplication(), bcvf.class);
    ((NewIntent)localObject).setAction("gc_refresh_ui");
    ((NewIntent)localObject).putExtra("gc_notify_type", 6);
    paramQQAppInterface.startServlet((NewIntent)localObject);
    ((aocj)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.REDPOINT_HANDER)).notifyUI(3, true, null);
  }
  ...
  private void a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody, bbbq parambbbq)
  {
    List localList = paramTimeRspBody.rptSetting.get();
    parambbbq = parambbbq.a();
    ArrayList localArrayList = new ArrayList();
    int i;
    BusinessInfoCheckUpdate.AppSetting localAppSetting;
    if ((localList != null) && (parambbbq != null))
    {
      i = 0;
      if (i < localList.size())
      {
        ...
        if (((BusinessInfoCheckUpdate.AppSetting)parambbbq.get(j)).appid.get() == localAppSetting.appid.get()) {
          parambbbq.set(j, localAppSetting);
        }
      }
    }
    label176:
    for (int j = 1;; j = 0)
    {
      ...
      j += 1;
      break label61;
      parambbbq.addAll(localArrayList);
      for (;;)
      {
        paramTimeRspBody.rptSetting.set(parambbbq);
        return;
        if (parambbbq == null) {
          parambbbq = localList;
        }
  ...
  private void a(Object paramObject)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localObject = (bbbq)this.app.getManager(QQManagerFactory.MGR_RED_TOUCH);
        try
        {
          if (!a(paramObject, (bbbq)localObject)) {
            break;
          }
          a(paramObject, (bbbq)localObject);
          a(paramObject);
          ((bbbq)localObject).a(paramObject);
          c(paramObject);
          ((bbbq)localObject).jdField_a_of_type_Int = 0;
          ((bbbq)localObject).jdField_b_of_type_Int = 0;
          ((bbbq)localObject).a(paramObject);
          a(this.app);
          return;
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        ...
        while (i < j)
        {
          long l = ((aocl)((List)localObject1).get(i)).jdField_a_of_type_Long;
          localObject2 = "100600." + (100000000L + l) + "";
          if (((((aocl)((List)localObject1).get(i)).jdField_a_of_type_Long + "").equals(paramAppInfo.path.get())) || (((String)localObject2).equals(paramAppInfo.path.get()))) {
            return true;
          }
  ...
  private boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody, bbbq parambbbq)
  {
    if (paramTimeRspBody.rptMsgAppInfo.has())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localAppInfo1 != null)
        {
          ...
          {
            BusinessInfoCheckUpdate.AppInfo localAppInfo2 = parambbbq.a(localAppInfo1.path.get());
    ...
    if (paramTimeRspBody.rptMsgNumRedInfo.has())
    {
      ...
      while (paramTimeRspBody.hasNext())
      {
        parambbbq = ((BusinessInfoCheckUpdate.NumRedInfo)paramTimeRspBody.next()).num_red_path.get();
        if (parambbbq != null)
        {
          int i = 0;
          while (i < parambbbq.size())
          {
            ((BusinessInfoCheckUpdate.NumRedPath)parambbbq.get(i)).uint32_push_num_red_ts.set((int)(System.currentTimeMillis() / 1000L));
            i += 1;
          }
        }
      }
  ...
  private void b(int paramInt1, SosoInterface.SosoLbsInfo paramSosoLbsInfo, int paramInt2)
  {
    ...
    localTimeReqBody.sClientVer.set("8.4.10.4875");
    ...
    for (paramSosoLbsInfo = null;; paramSosoLbsInfo = localbbbq.a())
    {
    ...
    if (localbbbq != null)
    {
      paramSosoLbsInfo = localbbbq.b(3).iterator();
      while (paramSosoLbsInfo.hasNext()) {
    ...
    else
    {
      ...
      paramSosoLbsInfo = (TroopManager)this.mApp.getManager(QQManagerFactory.TROOP_MANAGER);
      ...
      label521:
      if ((!((gb)this.app.getManager(QQManagerFactory.CHAT_FONT_MANAGER)).jdField_a_of_type_Boolean) && (localTimeReqBody.rptMsgAppInfo.has())) {
        paramInt1 = i;
      }
    }
    for (;;)
    {
      ...
      else
      {
        ...
        return;
        a(localbbbq, localArrayList1, localArrayList2, localArrayList3);
        break;
        label669:
  ...
  {
    Object localObject1 = (bhnl)this.app.getManager(QQManagerFactory.INDIVIDUATION_ABTEST_MANAGER);
    if ((!((bhnl)localObject1).jdField_b_of_type_Boolean) && (!((bhnl)localObject1).jdField_a_of_type_Boolean)) {
      ((bhnl)localObject1).a(this.app.getCurrentAccountUin());
    }
    int j;
    int i;
    if (paramTimeRspBody.rptMsgAppInfo.has())
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        {
          if ((((bhnl)localObject1).jdField_a_of_type_Int == 0) || (TextUtils.isEmpty(((bhnl)localObject1).jdField_a_of_type_JavaLangString)) || (((bhnl)localObject1).jdField_b_of_type_Int != 0)) {
            break label269;
          }
    ...
    axpk.a().a(this.app, (List)localObject1);
    label346:
    if (QLog.isColorLevel()) {
    ...
    if (paramTimeRspBody.rptSetting.get() != null)
    {
      ...
      ajzy.a().a(paramTimeRspBody.rptSetting.get());
    }
    if (QLog.isColorLevel()) {
      QLog.i("RedPointLog.RedpointHandler", 2, "update NearbyNumAppinfo");
    }
    ayob.a(this.app, true);
  }
  ...
  protected void a(bbbq parambbbq, List<String> paramList1, List<String> paramList2, List<BusinessInfoCheckUpdate.AppInfo> paramList)
  {
    parambbbq = parambbbq.a();
    int j;
    String str;
    ...
    Object localObject;
    if ((parambbbq != null) && (parambbbq.rptMsgAppInfo.has()))
    {
      j = 0;
      ...
      i = 0;
      if (i >= parambbbq.rptMsgAppInfo.size()) {
        break label381;
      }
      localAppInfo = (BusinessInfoCheckUpdate.AppInfo)parambbbq.rptMsgAppInfo.get(i);
  ...
  protected void a(BusinessInfoCheckUpdate.TimeReqBody paramTimeReqBody, List<aocl> paramList, List<BusinessInfoCheckUpdate.AppSetting> paramList1, List<String> paramList2)
  {
    BusinessInfoCheckUpdate.AppSetting localAppSetting;
    int j;
    String str;
    if (paramList != null)
    {
      ...
      if (paramList1 == null)
      {
        ...
        str = ((aocl)paramList.get(j)).jdField_a_of_type_Long + "";
        m = ((aocl)paramList.get(j)).jdField_a_of_type_Int;
        k = 0;
        label81:
        if (k >= i) {
          break label139;
    ...
    for (;;)
    {
      ...
      {
        long l = 100000000L + ((aocl)paramList.get(j)).jdField_a_of_type_Long;
        str = "100600." + l + "";
        a(l);
      }
      for (;;)
      {
        ...
        j += 1;
        break;
        a(((aocl)paramList.get(j)).jdField_a_of_type_Long);
      }
      return;
    }
  }
