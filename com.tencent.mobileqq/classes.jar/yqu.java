...
public class yqu
{
  ...
  public static yqv a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      if (StringUtil.isEmpty(paramObject))
      {
        ...
        label105:
        localyqv = new yqv();
        localyqv.jdField_a_of_type_JavaLangString = str1;
        localyqv.jdField_b_of_type_JavaLangString = str3;
        localyqv.jdField_c_of_type_JavaLangString = str2;
        localyqv.jdField_a_of_type_Int = i;
        localyqv.e = str4;
        localyqv.f = paramObject;
        localyqv.g = ((String)localObject);
        localyqv.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localyqv.jdField_d_of_type_JavaLangString = "DOV";
          return localyqv;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localyqv.jdField_d_of_type_JavaLangString = amtj.a(2131715917);
              return localyqv;
              break label105;
            }
          }
  ...
  public static yrr a(Context paramContext, Object paramObject)
  {
    yqv localyqv = a(paramObject);
    if (localyqv == null) {
      return null;
    }
    String str1 = localyqv.jdField_a_of_type_JavaLangString;
    String str2 = localyqv.jdField_b_of_type_JavaLangString;
    String str3 = localyqv.f;
    int j = localyqv.jdField_a_of_type_Int;
    String str4 = localyqv.e;
    int k = localyqv.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bfwv.a(paramContext, "com.tencent.qim"))
        {
          bcef.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bfwv.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          bcef.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          wlg.a(paramContext);
        }
      }
      label174:
      ...
      {
        bcef.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        bcef.b(null, "dc00899", "grp_story", "", "weishi_share", localyqv.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        bcef.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        bcef.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      bcef.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localyqv.jdField_c_of_type_JavaLangString;
      bcef.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new yrr(paramContext, 2131756037, paramObject);
  ...
  {
    if (!ypp.b(paramContext))
    {
      QQToast.a(paramContext, amtj.a(2131715919), 0).a();
      return;
    }
    boaz.a().a();
    ...
    {
      xvv.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    bcef.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    return bjnn.a(paramContext, "com.tencent.weishi");
  }
}
