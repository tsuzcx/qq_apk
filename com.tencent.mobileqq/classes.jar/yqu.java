...
public class yqu
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = wjz.a(2131698490);
  ...
  public static int a(@Nullable String paramString, VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      localwrs = wsl.a(QQStoryContext.a()).a(paramString);
    }
    if (localwrs != null)
    {
      if (localwrs.a == 12) {
  ...
  @Deprecated
  public static int a(wqq paramwqq)
  {
    if (paramwqq == null) {
      return 4;
    }
    switch (paramwqq.getRelationType())
    {
    default: 
      return 4;
    case 0: 
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForStructing paramMessageForStructing, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        paramContext = bgng.a(paramQQAppInterface, paramContext, localAbsStructMsg.mMsg_A_ActionData);
    ...
    try
    {
      ...
      a("share_uin_obj", paramString, bfup.b(paramMessageForStructing.istroop), i, new String[] { paramContext });
      return;
    }
  ...
  {
    if ((paramInt1 == 10002) || (paramInt1 == 10000) || (paramInt1 == 10001) || (!paramBoolean) || (paramInt1 == bnqb.p.a()) || (paramInt1 == bnqb.e.a()))
    {
      ...
      if (jdField_a_of_type_JavaUtilList.contains(paramString))
      {
        ...
        bctj.a(BaseApplication.getContext()).a(null, paramString, true, 0L, 0L, localHashMap, null);
      }
    }
  }
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    {
      if (yqp.a()) {
        yqp.b("StoryReportor", "[op_type]%s;[op_name]%s;[op_in]%d;[op_result]%d;[d1]%s;[d2]%s;[d3]%s;[d4]%s", new Object[] { paramString1, paramString2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs) });
      }
      label80:
      bcst.b(null, "dc00899", jdField_a_of_type_JavaLangString, "", paramString1, paramString2, paramInt1, paramInt2, a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs));
      return;
    }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    {
      if (yqp.a()) {
        yqp.b("StoryReportor", "[department]%s;[op_type]%s;[op_name]%s;[op_in]%d;[op_result]%d;[d1]%s;[d2]%s;[d3]%s;[d4]%s", new Object[] { paramString1, paramString2, paramString3, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs) });
      }
      label86:
  ...
  public static void a(String paramString, boolean paramBoolean, long paramLong, String... paramVarArgs)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, paramString, paramBoolean, paramLong, 0L, localHashMap, null);
  }
  ...
  public static void b(String paramString1, String paramString2, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    {
      if (yqp.a()) {
        yqp.b("StoryReportor", "Dev[op_type]%s;[op_name]%s;[op_in]%d;[op_result]%d;[d1]%s;[d2]%s;[d3]%s;[d4]%s", new Object[] { paramString1, paramString2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs) });
      }
      label80:
      bcst.b(null, "dc00899", "grp_story_engineer", "", paramString1, paramString2, paramInt1, paramInt2, a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs));
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void c(String paramString1, String paramString2, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    try
    {
      ...
      label80:
      bcst.b(null, "dc00899", "PGC_story", "", paramString1, paramString2, paramInt1, paramInt2, a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs));
      return;
    }
    catch (Exception localException)
    {
