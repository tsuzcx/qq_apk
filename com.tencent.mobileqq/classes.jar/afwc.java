...
public class afwc
{
  ...
  protected String a;
  private final ArrayList<afwg> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private final ArrayList<afwg> b = new ArrayList();
  private final ArrayList<afwf> c = new ArrayList();
  
  public afwc(String paramString, long paramLong)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new afwd(this, 3, true, true, paramLong, true, true, "ArkAppLocationManager");
  }
  ...
  public void a(afwf paramafwf, boolean paramBoolean)
  {
    if (paramafwf == null) {
      return;
    }
  ...
  public void a(afwg paramafwg)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramafwg);
      c();
      return;
    }
  }
  ...
  protected void c()
  {
    ...
    if (!a())
    {
      localBaseActivity.requestPermissions(new afwe(this, localBaseActivity), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
      return;
    }
    grant();
  }
