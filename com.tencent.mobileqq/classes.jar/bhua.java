  ...
  implements View.OnClickListener
{
  ...
  public bhua(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ArrayOfInt = new int[] { 2131379248, 2131379249, 2131379250, 2131379251 };
    this.jdField_b_of_type_ArrayOfInt = new int[] { 2131379253, 2131379254, 2131379255, 2131379256, 2131379257, 2131379258, 2131379259, 2131379260 };
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131700040));
  ...
  public void a()
  {
    this.d = ((int)bdcb.i());
    this.e = ((int)bdcb.j());
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidAppActivity.getSystemService("layout_inflater")).inflate(2131559918, null);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379252));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131379244));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379246);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379247));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379245));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379264));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379263));
    ...
    setOnDismissListener(new bhub(this));
    setTouchable(true);
    setFocusable(true);
  ...
  protected void a(IBinder paramIBinder)
  {
    ...
    this.jdField_c_of_type_AndroidViewView.setOnKeyListener(new bhuc(this));
  ...
  public void a(View paramView, bhue parambhue)
  {
    this.jdField_a_of_type_Bhue = parambhue;
    a(paramView.getWindowToken());
    parambhue = new int[2];
    paramView.getLocationOnScreen(parambhue);
    int j;
    int i;
    int n;
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("KandianPopupWindow", 2, "x = " + parambhue[0] + ", y = " + parambhue[1]);
      }
      if (QLog.isColorLevel()) {
      ...
      n = this.jdField_b_of_type_Int - parambhue[0] - paramView.getWidth() / 2 + i;
      if (QLog.isColorLevel()) {
      ...
      if (j - (k + m) > this.jdField_c_of_type_Int) {
        if (n > this.jdField_b_of_type_Int * 0.1D)
        {
          ...
          j = parambhue[1] + paramView.getHeight() / 2 + aekt.a(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        j = parambhue[1] + paramView.getHeight() / 2 - aekt.a(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - this.jdField_c_of_type_Int;
        showAtLocation(paramView, 0, i, j);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      showAtLocation(paramView, 0, parambhue[0] + paramView.getWidth() / 2 - aekt.a(10.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298619), parambhue[1] + paramView.getHeight() / 2 - this.jdField_c_of_type_Int / 2);
    }
  }
  
  public void a(bhud parambhud)
  {
    this.jdField_a_of_type_Bhud = parambhud;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130842641);
    }
    if (this.jdField_c_of_type_AndroidWidgetImageView != null)
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130842650);
      if (RelativeLayout.LayoutParams.class.isInstance(this.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams()))
      {
        ...
        localLayoutParams.addRule(3, 2131379245);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Bhue != null) {
          this.jdField_a_of_type_Bhue.a(paramView, this.jdField_a_of_type_Int, this.jdField_b_of_type_JavaUtilArrayList, null);
        }
        dismiss();
        return;
        if (this.jdField_a_of_type_Bhud != null) {
          this.jdField_a_of_type_Bhud.a();
        }
        dismiss();
        return;
        i += 1;
      ...
      label267:
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131700041), new Object[] { Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
      }
