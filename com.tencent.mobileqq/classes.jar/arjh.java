  ...
  implements IShadow
{
  ...
  private void a(String paramString)
  {
    try
    {
      arjj.a().a().b("enter_shadow_err").c(paramString).b();
  ...
  public arej a(Context paramContext, String paramString1, String paramString2)
  {
    return ares.a(paramContext, paramString1, paramString2);
  }
  ...
  {
    akhk.b(192).execute(new NowShadowImpl.1(this, paramContext, paramString1, paramString2, paramLong, paramBundle, paramEnterCallback));
  }
