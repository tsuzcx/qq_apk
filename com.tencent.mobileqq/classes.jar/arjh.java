  ...
  implements Handler.Callback
{
  ...
  private arjj jdField_a_of_type_Arjj;
  ...
  arjh(QQAppInterface paramQQAppInterface, Context paramContext, arjj paramarjj)
  {
    super(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Arjj = paramarjj;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == f) {
      if (this.i == c)
      {
        ...
        j = Math.min(j, 99);
        paramMessage = String.format(anni.a(2131701670), new Object[] { Integer.valueOf(j) });
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
        this.jdField_a_of_type_Bkfv.sendEmptyMessageDelayed(f, 500L);
      }
    }
      ...
      do
      {
        ...
        if (this.i == d)
        {
          ...
          if (!this.jdField_b_of_type_JavaIoFile.renameTo(this.jdField_a_of_type_JavaIoFile))
          {
            ...
            boolean bool = bgmg.a(this.jdField_b_of_type_JavaIoFile, this.jdField_a_of_type_JavaIoFile);
            bgmg.d(this.jdField_b_of_type_JavaIoFile.getPath());
            if (!bool)
            {
              QLog.d(jdField_a_of_type_JavaLangString, 1, "db fix succ but copy fail final");
              paramMessage = new HashMap();
              bctj.a(BaseApplication.getContext()).a(null, DBFixManager.m, true, -1L, 0L, paramMessage, null, false);
            }
          }
          this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131701671));
          this.jdField_a_of_type_Bkfv.sendEmptyMessageDelayed(g, 100L);
          return false;
        }
      } while (this.i != e);
      dismiss();
      this.jdField_a_of_type_Arjj.a(this.i);
      return false;
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131559336);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131365260));
    ...
    for (int j = 1;; j = 2)
    {
      ...
      super.setOnKeyListener(new arji(this));
      return;
    }
  }
  ...
  {
    super.onStart();
    this.jdField_a_of_type_Bkfv.sendEmptyMessage(f);
  }
}
