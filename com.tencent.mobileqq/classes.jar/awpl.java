...
public class awpl
{
  ...
  private awox jdField_a_of_type_Awox;
  awpj jdField_a_of_type_Awpj = new awpm(this);
  public Conversation a;
  boolean jdField_a_of_type_Boolean = true;
  private ViewGroup b;
  
  public awpl(Conversation paramConversation, ViewGroup paramViewGroup)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_Awox == null)
      {
        this.jdField_a_of_type_Awox = new awox("Login.Guide");
        this.jdField_a_of_type_Awox.observerOnUiThread = true;
      }
      if (!bool1) {
        LbsManagerService.startLocation(this.jdField_a_of_type_Awox);
      }
      return;
    }
  }
  
  private void a(awpg paramawpg)
  {
    ...
    {
      return;
      if (!TextUtils.isEmpty(paramawpg.jdField_a_of_type_JavaLangString)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("LoginWelcomeManager", 2, "Bad url: " + paramawpg.jdField_a_of_type_JavaLangString);
    return;
    if (QLog.isColorLevel()) {
    ...
    localIntent.putExtra("url", paramawpg.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("flag_show_loading_dialog", false);
    localIntent.putExtra("hide_left_button", true);
    localIntent.setData(Uri.parse(paramawpg.jdField_a_of_type_JavaLangString));
    ...
    LoginWelcomeManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a, paramawpg.jdField_a_of_type_Int);
  }
  ...
  private void a(URLDrawable paramURLDrawable)
  {
    ...
    {
      return;
      if ((this.b != null) && (this.b.findViewById(2131365108) == null) && (paramURLDrawable != null) && (paramURLDrawable.getStatus() == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a != null)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.b.getContext()).inflate(2131559005, null));
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364721);
      ((ImageView)localObject1).setContentDescription(anvx.a(2131705836));
      ((ImageView)localObject1).setOnClickListener(new awpn(this));
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a();
      Object localObject2 = (Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131366812);
      ((Button)localObject2).setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().getString(2131698370));
      ((Button)localObject2).setOnClickListener(new awpo(this, (Activity)localObject1));
      localObject2 = (TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365785);
      ((TextView)localObject2).setContentDescription(((Activity)localObject1).getString(2131698369));
      ((TextView)localObject2).setOnClickListener(new awpp(this, (Activity)localObject1));
      localObject1 = (ThemeImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365158);
      ((ThemeImageView)localObject1).setMaskShape(blfw.b);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a != null) {
      ((LoginWelcomeManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(QQManagerFactory.LOGIN_WELCOME_MANAGER)).a(this.jdField_a_of_type_Awpj);
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Awox != null)
    {
      LbsManagerService.removeListener(this.jdField_a_of_type_Awox);
      this.jdField_a_of_type_Awox = null;
    }
  }
