  ...
  implements Manager
{
  ...
  bbwt jdField_a_of_type_Bbwt = new bbzm(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public bbzh(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bbdx.a(lcj.f(), new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = paramActivity.getLayoutInflater().inflate(2131562601, null);
      localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
      localLayoutParams.addRule(13);
    } while (paramActivity.isFinishing());
    paramRelativeLayout.addView(localView, 0, localLayoutParams);
    return (VipFullScreenVideoView)localView.findViewById(2131378903);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString = lcj.f() + paramInt1 + File.separator;
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt, Bundle paramBundle, VipFunCallAndRing.TSourceInfo paramTSourceInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        localObject1 = new File(lcj.f() + paramInt + File.separator);
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    } while (bbdx.a(paramString2));
    String str = b(paramAppRuntime, paramInt2, 8, null);
    paramString2 = new Bundle();
    paramString1 = new bbwu(str, paramString1);
    ((bbww)paramAppRuntime.getManager(47)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(bbzg.jdField_a_of_type_JavaLangString).exists();
  }
  
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, bbzn parambbzn, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new bbzi());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new bbzj(parambbzn));
        paramVideoView.setOnCompletionListener(new bbzk(paramVideoView));
        paramVideoView.setOnErrorListener(new bbzl(paramInt2, parambbzn, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
        paramContext = baxi.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bbrx.a("externalStorageType", paramString, i + "_t", l2 + "", bool + "", l2 + "", bool + "_p", "", "", "");
        return bool;
      }
      catch (Exception paramContext)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      if (bool)
      {
        ...
        localObject = new bbwu(str1, (File)localObject);
        ((bbwu)localObject).a(3);
        ((bbwu)localObject).jdField_a_of_type_Int = 0;
        ((bbwu)localObject).a(localBundle);
        this.jdField_a_of_type_Bbwt.onDone((bbwu)localObject);
        return;
        label519:
        bool = false;
        break label298;
      ...
      if (i == 0)
      {
        label530:
        localObject = new bbwu(str1, (File)localObject);
        ((bbwu)localObject).jdField_a_of_type_Byte = 1;
        ((bbwu)localObject).jdField_e_of_type_Long = 5242880L;
        ((bbwu)localObject).jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      ...
      {
        ((bbwu)localObject).l = paramBoolean;
        if (7 != paramInt2) {
          ((bbwu)localObject).b = true;
        }
        this.jdField_a_of_type_Bbww.a(1).a((bbwu)localObject, this.jdField_a_of_type_Bbwt, localBundle);
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, bbxa parambbxa)
  {
    ...
    if (paramInt2 != 0)
    {
      bbpb localbbpb = (bbpb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(45);
      localbbpb.jdField_a_of_type_Bbxa = parambbxa;
      localbbpb.a(paramInt2, 3, paramBoolean, paramInt3, "comering");
    }
    if (i == 6) {
  ...
  {
    this.jdField_a_of_type_Bbxa = null;
  }
}
