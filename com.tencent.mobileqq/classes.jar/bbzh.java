...
public class bbzh
{
  ...
  {
    String str = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getCurrentAccountUin();
    return PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).getString("pref_net_search_function_title" + str, anvx.a(2131713084));
  }
  ...
  public static void a(Context paramContext, com.tencent.mobileqq.config.struct.splashproto.ConfigurationService.Config paramConfig, String paramString)
  {
    ...
    //   75: invokestatic 161	ayym:a	([B)[B
    //   78: astore_1
    //   79: aload_1
    //   80: ifnull +516 -> 596
    ...
    //   186: ldc 208
    //   188: ldc 209
    //   190: invokestatic 89	anvx:a	(I)Ljava/lang/String;
    ...
    //   550: pop
    //   551: aconst_null
    //   552: putstatic 244	bcmz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   555: return
    //   556: astore_1
    ...
    //   660: iconst_m1
    //   661: aload_2
    //   662: invokestatic 259	bbzh:a	(Landroid/content/Context;ILjava/lang/String;)V
    //   665: return
    //   666: ldc 13
    //   668: astore 8
    //   670: goto -649 -> 21
  ...
  public static String b()
  {
    ...
    String str1 = anvx.a(2131718354);
    if (TextUtils.isEmpty(bcmz.jdField_a_of_type_JavaLangString))
    {
      if (!bcmz.a(((QQAppInterface)localObject).getCurrentAccountUin())) {
        break label184;
      }
      ...
      if (!TextUtils.isEmpty(str1)) {
        bcmz.jdField_a_of_type_JavaLangString = str1;
      }
    }
    label184:
    for (;;)
    {
      ...
      return str1;
      str1 = anvx.a(2131718354);
      continue;
      if (QLog.isColorLevel()) {
        QLog.d("Q.uniteSearch.SearchEntryConfigManager", 2, "getFtsSearchBarWording() cache wording is not null. " + bcmz.jdField_a_of_type_JavaLangString);
      }
      str1 = bcmz.jdField_a_of_type_JavaLangString;
    }
  }
}
