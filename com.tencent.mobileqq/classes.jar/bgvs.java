...
public class bgvs
{
  ...
  private static bgvs jdField_a_of_type_Bgvs;
  public static final String a;
  private static byte[] jdField_a_of_type_ArrayOfByte;
  public static final String b;
  private List<bgvw> jdField_a_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_a_of_type_Boolean;
  private List<String> jdField_b_of_type_JavaUtilList = Arrays.asList(new String[] { "QView.js", "QLogic.js", "QVConsole.js", "QRemoteDebug.js", "QWebview.js" });
  private boolean jdField_b_of_type_Boolean;
  private List<String> c = Arrays.asList(new String[] { "QGame.js", "QGameOpenDataContext.js", "QGameWorkerContext.js" });
  ...
  {
    if (jdField_a_of_type_Bgvs == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Bgvs == null) {
        jdField_a_of_type_Bgvs = new bgvs();
      }
      return jdField_a_of_type_Bgvs;
    }
  }
  
  public static BaseLibInfo a()
  {
    Object localObject = bgpx.a("qqtriton", "MiniGameBaseLib", "{\"key1\":\"https://d3g.qq.com/sngapp/app/update/20190708174635_6988/lib-1.4.7.zip\",\"key2\":\"\",\"key3\":\"1.4.7\",\"key4\": {\"file_length\": 6336933},\"key5\":2}");
  ...
  private void a(int paramInt)
  {
    try
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bgvw)((Iterator)localObject1).next()).a(paramInt);
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((File)localObject1).exists())
        {
          ...
          {
            localObject1 = new JSONObject(bgpc.b((File)localObject1));
            bool1 = bool2;
  ...
  public void a(bgvw parambgvw)
  {
    try
    {
      a(null, false, parambgvw);
      return;
    }
    finally
    {
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, bgvw parambgvw)
  {
    ...
    ((DownloaderProxy)ProxyManager.get(DownloaderProxy.class)).download(paramString1, null, str, 60, new bgvv(this, parambgvw, paramString1, paramString2, paramString4, str, paramString3));
  }
  
  /* Error */
  public void a(String paramString, boolean paramBoolean, bgvw parambgvw)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 76	bgvs:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: aload_3
    //   7: invokeinterface 380 2 0
    //   12: pop
    //   13: ldc 253
    //   15: new 19	java/lang/StringBuilder
    //   18: dup
    //   19: invokespecial 22	java/lang/StringBuilder:<init>	()V
    //   22: ldc_w 382
    //   25: invokevirtual 54	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   28: aload_0
    //   29: getfield 231	bgvs:jdField_a_of_type_Boolean	Z
    //   32: invokevirtual 385	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   35: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   38: invokestatic 142	com/tencent/qqmini/sdk/log/QMLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: aload_0
    //   42: getfield 231	bgvs:jdField_a_of_type_Boolean	Z
    //   45: istore 4
    //   47: iload 4
    //   49: ifeq +6 -> 55
    //   52: aload_0
    ...
    //   55: aload_0
    //   56: iconst_1
    //   57: putfield 231	bgvs:jdField_a_of_type_Boolean	Z
    //   60: invokestatic 390	com/tencent/qqmini/sdk/core/manager/ThreadManager:a	()Landroid/os/Handler;
    //   63: new 392	com/tencent/qqmini/sdk/manager/BaseLibManager$2
    //   66: dup
    //   67: aload_0
    //   68: iload_2
    //   69: aload_1
    //   70: aload_3
    //   71: invokespecial 395	com/tencent/qqmini/sdk/manager/BaseLibManager$2:<init>	(Lbgvs;ZLjava/lang/String;Lbgvw;)V
    //   74: invokevirtual 401	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   77: pop
    //   78: goto -26 -> 52
    //   81: astore_1
    //   82: aload_0
  ...
  public boolean a()
  {
    ...
    int j = bgpx.a("qqminiapp", "mini_app_inner_baselib_retry_count", jdField_a_of_type_Int);
    QMLog.i("miniapp-process_BaseLibManager", "[MiniEng]installInnerBaseLib, version:1.14.0.00225, totalCount:" + j);
    int i = 0;
    while (i < j)
    {
      boolean bool = AssetsUtil.copyFileOrDir(AppLoaderFactory.g().getMiniAppEnv().getContext(), "mini", str, a());
      if ((bool) && (a().c(str)))
      {
  ...
  {
    return a(paramFile, (String[])this.jdField_b_of_type_JavaUtilList.toArray(new String[this.jdField_b_of_type_JavaUtilList.size()]));
  }
  ...
  public void b(bgvw parambgvw)
  {
    try
    {
      ThreadManager.a().post(new BaseLibManager.1(this, parambgvw));
      return;
    }
    finally
    {
  ...
  {
    return a(paramFile, (String[])this.c.toArray(new String[this.c.size()]));
  }
