...
public class aiwy
{
  ...
  public static ResourceInfo a(String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    String str = aivy.a(paramString, paramInt2);
  ...
  public static List<aiwz> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (str.startsWith("url_last_use_time")) {
          localArrayList.add(new aiwz(str.substring("url_last_use_time".length(), str.length()), ((Long)localEntry.getValue()).longValue(), paramInt));
        }
      }
    }
  ...
  public static void a(int paramInt, PreloadConfig paramPreloadConfig)
  {
    ...
    return;
    Object localObject = aivy.a(paramInt);
    long l2 = System.currentTimeMillis();
    long l3 = bdcs.b((String)localObject);
    ...
    if (l3 > 209715200L)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        aiwz localaiwz = (aiwz)((Iterator)localObject).next();
        if ((localaiwz != null) && (!TextUtils.isEmpty(localaiwz.jdField_a_of_type_JavaLangString)) && (l1 - localaiwz.jdField_a_of_type_Long > 2592000000L) && (!paramPreloadConfig.isUrlInConfig(localaiwz.jdField_a_of_type_JavaLangString)))
        {
          ResourceInfo localResourceInfo = a(localaiwz.jdField_a_of_type_JavaLangString, false, 0, localaiwz.jdField_a_of_type_Int);
          if (localResourceInfo != null)
          {
            b(localaiwz.jdField_a_of_type_JavaLangString, localaiwz.jdField_a_of_type_Int);
            ajaf.a(localResourceInfo.filePath);
            ajaf.a(localResourceInfo.folderPath);
            aiwx.a(localaiwz.jdField_a_of_type_JavaLangString, 8, localaiwz.jdField_a_of_type_Int);
          }
        }
      }
    }
