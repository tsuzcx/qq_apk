  ...
  implements arik
{
  ...
  {
    blrw localblrw = paramQzoneCommonIntent.getRequest();
    Object localObject2 = localblrw.uniKey();
    int i = localblrw.a();
    ...
    if (!paramFromServiceMsg.isSuccess())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("QzoneCommonIntent", 2, String.format("cmd :%s, success:%b,code:%d, msg:%s", new Object[] { localblrw.getCmdString(), Boolean.valueOf(QzoneCommonIntent.succeeded(arrayOfInt[0])), Integer.valueOf(arrayOfInt[0]), arrayOfString[0] }));
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (arrayOfInt[0] != 1000006) {
        QzoneCommonIntent.access$000(localblrw, arrayOfInt[0], arrayOfString[0]);
      }
      return;
      paramFromServiceMsg = bmjb.a(paramFromServiceMsg.getWupBuffer(), (String)localObject2, arrayOfInt, arrayOfString);
      break;
    }
  }
}
