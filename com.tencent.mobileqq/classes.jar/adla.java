  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject = (adlc)actj.a(paramView);
    paramView = (airx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    localObject = (MessageForApollo)((adlc)localObject).a;
    if (localObject == null)
    {
      QLog.e("ApolloItemBuilder", 1, "errInfo->mr is null.");
      return;
    }
    ApolloActionData localApolloActionData = ((ajmu)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).b(((MessageForApollo)localObject).mApolloMessage.id);
