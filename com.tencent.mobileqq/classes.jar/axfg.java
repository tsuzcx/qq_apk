...
public class axfg
{
  ...
  public static String a(long paramLong)
  {
    ...
    if (l2 < 600000L) {
      return amtj.a(2131706342);
    }
    if (l2 < 3600000L) {
      return l2 / 60L / 1000L + 1L + amtj.a(2131706335);
    }
    if ((l2 < 21600000L) && (k == i)) {
      return l2 / 60L / 60L / 1000L + amtj.a(2131706329);
    }
    if ((l2 < 86400000L) && (k == i))
    {
    ...
    {
      localSimpleDateFormat.applyPattern("HH:mm");
      return amtj.a(2131706340) + localSimpleDateFormat.format(localCalendar.getTime());
    }
    if (m == j)
    {
