...
public class qpl
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = qpl.class.getSimpleName();
  }
  
  public qpl(Activity paramActivity, QQAppInterface paramQQAppInterface, qqq paramqqq, VideoFeedsPlayManager paramVideoFeedsPlayManager, qls paramqls, boolean paramBoolean)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Qqq = paramqqq;
  ...
  private void c()
  {
    ...
    case 0: 
      ...
      Object localObject = Boolean.valueOf(bhvh.q(onk.a()));
      ...
      if (((Boolean)localObject).booleanValue()) {
        rwa.a(this.jdField_a_of_type_AndroidAppActivity, ajyc.a(2131716249), "https://kandian.qq.com/viola/bundle_weishiLeadTo.js?v_bid=3256", null, new qpm(this, localBundle));
      }
      for (;;)
      {
        if (!((Boolean)localObject).booleanValue()) {
        ...
        try
        {
          ...
          localObject = this.jdField_a_of_type_Qmr.jdField_a_of_type_Qqo.a;
          noo.a(null, null, "0X800933E", "0X800933E", 0, 0, String.valueOf(i), "", "", npx.a(null, null, ((VideoInfo)localObject).jdField_a_of_type_JavaLangString, ((VideoInfo)localObject).g, null), false);
          return;
        }
        ...
        onk.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_a_of_type_JavaLangString, localBundle);
      }
    }
    d();
    e();
    this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidViewView.setVisibility(0);
  }
  
  private void d()
  {
    if ((this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidViewView == null) && ((this.jdField_a_of_type_Qmr.itemView instanceof ViewGroup)))
    {
      View localView = View.inflate(this.jdField_a_of_type_AndroidAppActivity, 2131560065, (ViewGroup)this.jdField_a_of_type_Qmr.itemView);
      this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidViewView = localView.findViewById(2131367272);
      this.jdField_a_of_type_Qmr.jdField_d_of_type_AndroidViewView = localView.findViewById(2131367255);
      this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367264));
      this.jdField_a_of_type_Qmr.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367273));
      this.jdField_a_of_type_Qmr.e = ((TextView)localView.findViewById(2131367276));
      this.jdField_a_of_type_Qmr.f = ((TextView)localView.findViewById(2131367262));
      this.jdField_a_of_type_Qmr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCircleCountdownView = ((CircleCountdownView)localView.findViewById(2131367274));
    }
  }
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd == null) || (this.jdField_a_of_type_Qmr == null)) {
      bool = false;
    }
    int i;
    do
    {
      ...
      {
        return bool;
        i = this.jdField_a_of_type_Qmr.jdField_c_of_type_Int;
        switch (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_b_of_type_Int)
        {
        default: 
          return false;
  ...
  private void e()
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_Qmr != null) && (this.jdField_a_of_type_Qmr.f != null))
    {
      ...
      {
        if (bbfd.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_b_of_type_JavaLangString)) {
          break label297;
        }
        this.jdField_a_of_type_Qmr.f.setText(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.d);
        localObject = localResources.getDrawable(2130842509);
      }
    }
    for (;;)
    {
      int i = actn.a(12.0F, localResources);
      ((Drawable)localObject).setBounds(0, 0, i, i);
      this.jdField_a_of_type_Qmr.f.setCompoundDrawables((Drawable)localObject, null, null, null);
      this.jdField_a_of_type_Qmr.f.setOnClickListener(new qpn(this));
      this.jdField_a_of_type_Qmr.e.setOnClickListener(new qpo(this));
      this.jdField_a_of_type_Qmr.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.jdField_b_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidViewView.setOnClickListener(null);
      localObject = new JSONObject();
      try
      {
        ((JSONObject)localObject).put("uin", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        label244:
        noo.a(null, null, "0X8009BF0", "0X8009BF0", 0, 0, "", "", "", npx.a(null, null, this.jdField_a_of_type_Qmr.jdField_a_of_type_Qqo.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Qmr.jdField_a_of_type_Qqo.a.g, (JSONObject)localObject), false);
        return;
        label297:
        this.jdField_a_of_type_Qmr.f.setText(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd.e);
        localObject = localResources.getDrawable(2130842512);
      }
      catch (Exception localException)
      {
        break label244;
  ...
  private boolean e()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_b_of_type_JavaLangString = bhvh.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      localObject = bhvh.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      boolean bool = bhvh.u(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void a()
  {
    ...
    {
      localqqq = this.jdField_a_of_type_Qqq;
      if (this.jdField_a_of_type_Qmr == null) {
        break label55;
      }
    }
    label55:
    for (qqo localqqo = this.jdField_a_of_type_Qmr.jdField_a_of_type_Qqo;; localqqo = null)
    {
      localqqq.c(localqqo);
      this.g = false;
      this.f = false;
  ...
  public boolean a(qmr paramqmr, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Qmr != null) {}
    for (int i = this.jdField_a_of_type_Qmr.jdField_c_of_type_Int;; i = 0)
    {
      if ((paramqmr.jdField_c_of_type_Int > i) && (paramBoolean)) {
        b();
      }
      if ((this.jdField_a_of_type_Qmr != null) && (this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidViewView != null)) {
        this.jdField_a_of_type_Qmr.jdField_c_of_type_AndroidViewView.setVisibility(8);
      }
      ...
      this.jdField_d_of_type_Int = paramqmr.jdField_c_of_type_Int;
      this.jdField_c_of_type_Boolean = false;
      this.jdField_d_of_type_Boolean = false;
      this.e = false;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$InterruptedWeishiAd != null) && (QLog.isColorLevel())) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "setPlayingVideoInfo() itemHolder.position=" + paramqmr.jdField_c_of_type_Int);
      }
      return a(0) | false;
    }
  }
    ...
    if ((this.jdField_b_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString))) {
      try
      {
        ...
        for (String str = "weishi";; str = "default")
        {
          ...
          bhvh.F(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localJSONObject1.toString());
          if (!QLog.isColorLevel()) {
            break;
          }
