...
public class yvc
{
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, yuy paramyuy, String paramString, Bundle paramBundle)
  {
    if ((paramyuy == null) || (paramyuy.a() == 0))
    {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, paramActivity, paramyuy.a().a() + "", paramBundle.getBoolean("issupportwpa", false));
      return 1;
      str3 = "";
      str4 = "";
      ...
      a(paramQQAppInterface, paramActivity, paramyuy.a().a() + "", str2, str1, paramBundle.getString("authKey"), str5);
      return 2;
      a(paramQQAppInterface, paramActivity, paramyuy.a().a() + "", paramBundle);
      return 3;
      a(paramActivity, paramyuy);
      return paramyuy.c;
      a(paramQQAppInterface, paramActivity, ucx.a(paramyuy.a().a()), paramBundle);
      return 10;
    }
  }
  ...
  private static void a(Context paramContext, yuy paramyuy)
  {
    npt.a(paramContext, null, String.valueOf(paramyuy.a().a()), false, 1, true, -1);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
    ...
    paramQQAppInterface.putExtra("title", paramActivity.getString(2131717818));
  ...
  private static final void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, Bundle paramBundle)
  {
    ...
    ugf.a(localIntent, paramQQAppInterface, paramActivity, paramString, -1);
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (!TextUtils.isEmpty(bfvp.l)) {
      localBundle.putString("appid", bfvp.l);
    }
    if (!TextUtils.isEmpty(bfvp.m)) {
      localBundle.putString("openid", a(bfvp.m));
    }
    bfvp.l = null;
    bfvp.m = null;
    ...
    for (;;)
    {
      ...
      paramQQAppInterface = bfwg.a(paramQQAppInterface, paramActivity, Uri.parse("mqqapi://card/show_pslcard?" + HttpUtil.encodeUrl(localBundle)).toString());
