  ...
  extends pxz
{
  ...
  public pxy(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  private List<ReadInJoyDraftboxItem> a()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localReadInJoyDraftboxItem.firstPicData = ((ReadInJoyDraftboxItem.PicData)bgnx.a(localReadInJoyDraftboxItem.firstPic, ReadInJoyDraftboxItem.PicData.CREATOR));
      }
    }
    return localList;
  }
    ...
    do
    {
      ...
      if (paramLong == -1L)
      {
        ...
        if (TextUtils.isEmpty(localReadInJoyDraftboxItem.title))
        {
          ...
          localReadInJoyDraftboxItem.title = anni.a(2131711519);
        }
        localReadInJoyDraftboxItem.content = bgnx.a(paramReadInJoyDraftboxContent);
        ...
        if ((paramReadInJoyDraftboxContent != null) && (paramReadInJoyDraftboxContent.size() > 0)) {
          localReadInJoyDraftboxItem.firstPic = bgnx.a((ReadInJoyDraftboxItem.PicData)paramReadInJoyDraftboxContent.get(0));
        }
  ...
  public SpannableStringBuilder a(List<SocializeFeedsInfo.BiuCommentInfo> paramList, Context paramContext, EditText paramEditText, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
      {
        ...
        localArrayList.add(new tfu(j, j + ((String)localObject).length(), new BiuNicknameSpan(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.toString(), localBiuCommentInfo.b.longValue(), (CharSequence)localObject, paramContext, paramEditText.getPaint(), paramInt)));
        j = localStringBuilder.length();
        i += 1;
        break;
        ...
        if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localArrayList.add(new tfu(j, str2.length() + j, new tfs(str3, 13421772)));
          continue;
        }
        ...
        if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localArrayList.add(new tfu(j, str2.length() + j, new TopicSpan((TopicInfo)localObject)));
          continue;
        }
        localObject = localBiuCommentInfo.jdField_a_of_type_JavaLangString;
        continue;
      ...
      str2 = bbzj.b(localBiuCommentInfo.jdField_a_of_type_JavaLangString);
      continue;
      if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null) {}
      for (String str1 = "";; str1 = bbzj.b(localBiuCommentInfo.jdField_a_of_type_JavaLangString))
      {
        localStringBuilder.append(str1);
        break;
      }
      paramList = new SpannableStringBuilder(new bdnt(localStringBuilder, 3, 20));
      paramContext = localArrayList.iterator();
      while (paramContext.hasNext())
      {
        paramEditText = (tfu)paramContext.next();
  ...
  public ReadInJoyDraftboxItem.ReadInJoyDraftboxContent a(long paramLong)
  {
    ...
    if (localReadInJoyDraftboxItem != null)
    {
      ...
      if (localReadInJoyDraftboxItem.content != null)
      {
        ...
        {
          localReadInJoyDraftboxContent2 = (ReadInJoyDraftboxItem.ReadInJoyDraftboxContent)bgnx.a(localReadInJoyDraftboxItem.content, ReadInJoyDraftboxItem.ReadInJoyDraftboxContent.CREATOR);
          localReadInJoyDraftboxContent1 = localReadInJoyDraftboxContent2;
          if (QLog.isColorLevel())
          {
