...
{
  public biul(WerewolvesHostInterface paramWerewolvesHostInterface, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    try
    {
      ((axup)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)).d.put(this.jdField_a_of_type_JavaLangString, Integer.valueOf(1));
      if (!paramBoolean) {
        break label348;
      }
    ...
    catch (Exception paramBundle)
    {
      ...
      label477:
      label483:
      for (paramInt = 2131693931;; paramInt = 2131693939)
      {
