...
{
  private FilenameFilter jdField_a_of_type_JavaIoFilenameFilter = new bium(this);
  ...
  {
    boolean bool2 = false;
    File localFile1 = new File(aljq.aW, "/Tencent/ReaderZone/");
    ...
    for (;;)
    {
      ...
      int k = bdcs.a(localFile2.getAbsolutePath(), ((File)localObject).getAbsolutePath());
  ...
  {
    String[] arrayOfString = new File(aljq.aW, "/Tencent/ReaderZone/").list(this.jdField_a_of_type_JavaIoFilenameFilter);
  ...
  {
    return new File(new File(aljq.aW, "/Tencent/ReaderZone/"), paramString);
  }
  ...
  public String[] reportHistoryFileInfo()
  {
    ...
    File localFile = new File(aljq.aW, "/Tencent/ReaderZone/");
    ...
    if ((arrayOfString2 != null) && (arrayOfString2.length > 0))
    {
      ...
      while (i < j)
      {
        ...
        l2 += bdcs.b(new File(localFile, str).getAbsolutePath());
        l1 += bdcs.c(new File(localFile, str).getAbsolutePath());
        i += 1;
      }
