...
public class aqsc
  extends bbqu
{
  public aqsc(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  protected void onGetGameCenterPubAccountFeeds(boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramBoolean) && (paramObject != null))
    {
      ...
      {
        aqss.a = localJSONObject.optInt("video_count");
        aqss.b = localJSONObject.optInt("video_time") * 1000;
        aqss.c = localJSONObject.optInt("layer_duration") * 1000;
      ...
      if (paramBoolean) {
        ...
        {
          yod.a(ajae.a(), "769", "205353", str1, "76901", "1", "160", new String[] { localObject1, "", "20" });
    ...
    for (;;)
    {
      ...
      if (paramObject.size() == 0) {
        if (localObject2 == null)
        {
          ...
          label495:
          QQGamePubAccountFragment.a(this.a).a(false, false);
          QQGamePubAccountFragment.c(this.a).put(Long.valueOf(l), aqst.b);
          yod.a(ajae.a(), "769", "205353", str1, "76901", "1", "160", new String[] { localObject1, "", "20" });
        }
      }
      for (;;)
      {
        ...
        this.a.a(false);
        break label495;
        QQGamePubAccountFragment.c(this.a).put(Long.valueOf(l), aqst.a);
        QQGamePubAccountFragment.a(this.a).a(false, false);
      }
      if (paramObject != null)
      {
        ...
        yod.a(ajae.a(), "769", "205353", (String)localObject1, "76901", "1", "160", new String[] { paramObject, "", "20" });
      ...
      if (this.a.getActivity() != null) {
        bcpw.a(this.a.getActivity(), ajyc.a(2131710300), 0).a();
      }
    }
  }
}
