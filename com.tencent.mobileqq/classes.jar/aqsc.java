...
public class aqsc
{
  ...
  public aqsc(QQAppInterface paramQQAppInterface)
  {
  ...
  private TransFileInfo a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord != null)
    {
      ...
      if (localawbw != null) {
        localObject1 = (TransFileInfo)localawbw.a(TransFileInfo.class, new String[] { String.valueOf(paramMessageRecord.time), String.valueOf(paramMessageRecord.msgseq), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramMessageRecord.frienduin });
      }
    }
  ...
  public int a(String paramString1, int paramInt1, String paramString2, long paramLong, int paramInt2, String paramString3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramString1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(l, aljq.v, 0);
        ...
        paramString1.fileName = arni.a(paramString2);
        if (0L == paramLong)
        {
          paramString1.fileSize = arni.a(paramString2);
          paramString1.setFilePath(paramString2);
          paramString1.nOpType = paramInt2;
          paramString1.peerNick = null;
          paramString1.peerType = 0;
          paramString1.peerUin = aljq.v;
          paramString1.srvTime = (ayvc.a() * 1000L);
  ...
  public long a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    awbw localawbw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "strUin[" + arni.e(paramString) + "], peeryType[" + String.valueOf(paramInt) + "], uniseq[" + String.valueOf(paramLong2) + "]");
    }
    MessageRecord localMessageRecord = null;
    if (paramLong2 > 0L) {
      localMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramString, paramInt, paramLong2);
    }
    if ((localMessageRecord != null) && (localawbw != null))
    {
      paramString = (TransFileInfo)localawbw.a(TransFileInfo.class, new String[] { String.valueOf(localMessageRecord.time), String.valueOf(localMessageRecord.msgseq), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString });
      if (paramString == null) {}
    }
  ...
  public long a(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, long paramLong1, boolean paramBoolean2, int paramInt1, String paramString4, long paramLong2, long paramLong3, String paramString5, int paramInt2, long paramLong4, long paramLong5, long paramLong6, long paramLong7, int paramInt3)
  {
    ...
    {
      paramString5 = bauj.a(paramString3, paramLong1, 0, paramBoolean2);
    }
    ...
    if (paramBoolean1)
    {
      ...
      localMessageRecord.shmsgseq = ayvy.a(paramLong2, paramInt1);
      paramLong1 = paramLong5;
      if (paramLong5 == 0L) {
        paramLong1 = ayvy.a(ayvy.a());
      }
      localMessageRecord.msgUid = paramLong1;
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(((MessageForFile)localMessageRecord).fileName)) {
        ((MessageForFile)localMessageRecord).fileName = arni.a(paramString3);
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  public aqsu a()
  {
    ...
    for (;;)
    {
      aqsu localaqsu = this.jdField_a_of_type_Aqsu;
      this.jdField_a_of_type_Aqsu = null;
      return localaqsu;
      QLog.d("FileManagerDataCenter<FileAssistant>", 1, "getTmpController " + this.jdField_a_of_type_Aqsu.getClass().getName());
    }
  }
  ...
  public FileManagerEntity a(long paramLong)
  {
    ...
    aqxp localaqxp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if (localaqxp == null)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityBySessionId get FileManagerProxy null! nSessionId[" + paramLong + "]");
      return null;
    }
    FileManagerEntity localFileManagerEntity = localaqxp.a(paramLong);
    if (localFileManagerEntity != null)
    {
      localaqxp.a(localFileManagerEntity);
  ...
  public FileManagerEntity a(long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    if (localFileManagerEntity != null)
    {
      QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityBySessionid for queryall, FileManagerEntity exist, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(localFileManagerEntity.uniseq) + "], strUin[" + arni.e(localFileManagerEntity.peerUin) + "], peerType[" + String.valueOf(localFileManagerEntity.peerType) + "]");
      return localFileManagerEntity;
    }
    ...
    QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityBySessionid, new a FileManagerEntity, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(paramLong2) + "], strUin[" + arni.e(paramString) + "], peerType[" + String.valueOf(paramInt) + "]");
    return localFileManagerEntity;
  }
  ...
  public FileManagerEntity a(long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramLong <= 0L)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityByuniseq uniseq[" + paramLong + "] is error, strUin[" + arni.e(paramString) + "], peerType[" + paramInt + "]");
      return null;
    }
    aqxp localaqxp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if (localaqxp == null)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityByuniseq get FileManagerProxy null! strUin[" + arni.e(paramString) + "], uniseq[" + paramLong + "], peerType[" + paramInt + "]");
      return null;
    }
    FileManagerEntity localFileManagerEntity = localaqxp.a(paramLong, paramString, paramInt);
    if (localFileManagerEntity != null)
    {
      arna.a(localFileManagerEntity);
      return localFileManagerEntity;
    }
    return localaqxp.b(paramLong, paramString, paramInt);
  }
  ...
  public FileManagerEntity a(String paramString, long paramLong)
  {
    ...
    FileManagerEntity localFileManagerEntity1 = ((aqxp)localObject).a(paramString, paramLong);
    if (localFileManagerEntity1 != null) {
    ...
    awbw localawbw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    localObject = localawbw.a(FileManagerEntity.class, (String)localObject, null);
  ...
  {
    QLog.d("FileManagerDataCenter<FileAssistant>", 1, "regTmpController" + paramaqsu.getClass().getName());
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 15	aqsc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 251	com/tencent/mobileqq/app/QQAppInterface:a	()Laqxp;
    //   9: astore_2
    //   10: aload_2
    //   11: ifnonnull +69 -> 80
    //   14: ldc 71
    ...
    //   60: invokestatic 286	arni:e	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   102: aload_1
    //   103: invokestatic 650	arni:a	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)Ljava/lang/String;
    ...
    //   115: aload_2
    //   116: aload_1
    //   117: invokevirtual 652	aqxp:b	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   120: aload_0
    //   121: getfield 15	aqsc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   124: invokevirtual 614	com/tencent/mobileqq/app/QQAppInterface:a	()Laqse;
    //   127: iconst_1
    //   128: iconst_3
    //   129: aconst_null
    //   130: invokevirtual 619	aqse:a	(ZILjava/lang/Object;)V
    //   133: goto -56 -> 77
    //   136: astore_1
    //   137: aload_0
    //   138: monitorexit
  ...
  public void a(boolean paramBoolean, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    ...
    if (paramBoolean)
    {
      localFileManagerEntity.lastTime = (ayvc.a() * 1000L + 604800000L);
      localFileManagerEntity.isReaded = false;
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(localFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.nSessionId, "actFileOf2Of", 0L, "", "", localFileManagerEntity.peerUin, localFileManagerEntity.Uuid, paramInt, paramString1, 0L, 0L, 0L, "", "", 0, paramString1, null);
  }
  ...
  public boolean a(long paramLong, int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "strUin[" + arni.e(((FileManagerEntity)localObject2).peerUin) + "], peeryType[" + String.valueOf(((FileManagerEntity)localObject2).peerType) + "], uniseq[" + String.valueOf(((FileManagerEntity)localObject2).uniseq) + "]");
    }
    ...
    if ((localObject2 != null) && (localObject2 != null) && (localObject1 != null))
    {
      ...
      ((awbw)localObject2).a((awbv)localObject1);
      return true;
    }
    return false;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "SetRead: strUin[" + arni.e(paramString) + "], peeryType[" + paramInt + "], uniseq[" + paramLong + "]");
    }
  ...
  public FileManagerEntity b(long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramLong > 0L)
    {
      FileManagerEntity localFileManagerEntity = ((aqxp)localObject).a(paramLong, paramString, paramInt);
      if (localFileManagerEntity != null)
      {
        QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByuniseq for memory, FileManagerEntity exist, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(localFileManagerEntity.uniseq) + "], strUin[" + arni.e(localFileManagerEntity.peerUin) + "], peerType[" + String.valueOf(localFileManagerEntity.peerType) + "]");
        return localFileManagerEntity;
      }
      localObject = ((aqxp)localObject).b(paramLong, paramString, paramInt);
      if (localObject != null)
      {
        QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByuniseq for db, FileManagerEntity exist, sessionId[" + String.valueOf(((FileManagerEntity)localObject).nSessionId) + "], uniseq[" + String.valueOf(((FileManagerEntity)localObject).uniseq) + "], strUin[" + arni.e(((FileManagerEntity)localObject).peerUin) + "], peerType[" + String.valueOf(((FileManagerEntity)localObject).peerType) + "]");
        return localObject;
      }
    }
    localObject = new FileManagerEntity();
    ((FileManagerEntity)localObject).nSessionId = arni.a().longValue();
    ...
    QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByuniseq, new a FileManagerEntity, sessionId[" + String.valueOf(((FileManagerEntity)localObject).nSessionId) + "], uniseq[" + String.valueOf(paramLong) + "], strUin[" + arni.e(paramString) + "], peerType[" + String.valueOf(paramInt) + "]");
    return localObject;
  }
  ...
  public void b(FileManagerEntity paramFileManagerEntity)
  {
    for (;;)
    {
      ...
      try
      {
        localaqxp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localaqxp == null)
        {
          QLog.e("FileManagerDataCenter<FileAssistant>", 1, "insertToFMListAddOrReplaceDB get FileManagerProxy null! nSessionId[" + paramFileManagerEntity.nSessionId + "], uniseq[" + paramFileManagerEntity.uniseq + "], peerUin[" + arni.e(paramFileManagerEntity.peerUin) + "]");
          return;
        }
        ...
        {
          localaqxp.b(paramFileManagerEntity);
          continue;
        }
        localaqxp.c(paramFileManagerEntity);
      }
      finally {}
      localaqxp.e(paramFileManagerEntity);
    }
  }
