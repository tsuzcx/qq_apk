...
public class yir
{
  ...
  public static final yir b;
  public static final yir c;
  int a;
  public String a;
  public int b;
  public String b;
  ...
  static
  {
    jdField_a_of_type_Yir = new yir(0, amtj.a(2131710049));
    jdField_b_of_type_Yir = new yir(1, amtj.a(2131710046));
    jdField_c_of_type_Yir = new yir(2, "QQ音乐曲库");
  }
  ...
  public yir(int paramInt, String paramString)
  {
    this.jdField_c_of_type_JavaLangString = null;
    this.jdField_e_of_type_JavaLangString = null;
    this.jdField_f_of_type_JavaLangString = null;
  ...
  public yir(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    this.jdField_c_of_type_JavaLangString = null;
    this.jdField_e_of_type_JavaLangString = null;
    this.jdField_f_of_type_JavaLangString = null;
  ...
  public yir(qqstory_struct.MusicConfigInfo paramMusicConfigInfo)
  {
    this.jdField_c_of_type_JavaLangString = null;
    this.jdField_e_of_type_JavaLangString = null;
    this.jdField_f_of_type_JavaLangString = null;
  ...
  /* Error */
  public static final ArrayList<yir> a(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: ldc 135
    ...
    //   52: invokespecial 154	yir:<init>	(Ljava/lang/String;)V
  ...
  public static final void a(Context paramContext, ArrayList<yir> paramArrayList)
  {
    ...
    if (paramArrayList != null)
    {
      ...
      while (i < j)
      {
        ((JSONArray)localObject).put(((yir)paramArrayList.get(i)).a());
        i += 1;
      }
  ...
  {
    this.jdField_a_of_type_JavaLangString = paramyir.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramyir.jdField_b_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = paramyir.jdField_c_of_type_JavaLangString;
    this.jdField_d_of_type_JavaLangString = paramyir.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_JavaLangString = paramyir.jdField_e_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = paramyir.jdField_f_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramyir.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = paramyir.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramyir.jdField_c_of_type_Int;
    this.g = paramyir.g;
    this.jdField_d_of_type_Int = paramyir.jdField_d_of_type_Int;
    this.jdField_e_of_type_Int = paramyir.jdField_e_of_type_Int;
    this.jdField_f_of_type_Int = paramyir.jdField_f_of_type_Int;
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    yir localyir = (yir)paramObject;
    if ((localyir.jdField_b_of_type_Int == 0) && (this.jdField_b_of_type_Int == 0)) {
      return true;
    }
    if ((localyir.jdField_b_of_type_Int == 1) && (this.jdField_b_of_type_Int == 1)) {
      return true;
    }
    if ((localyir.jdField_b_of_type_Int == this.jdField_b_of_type_Int) && (localyir.jdField_b_of_type_JavaLangString != null) && (localyir.jdField_b_of_type_JavaLangString.equals(this.jdField_b_of_type_JavaLangString)) && (localyir.jdField_d_of_type_JavaLangString != null) && (localyir.jdField_d_of_type_JavaLangString.equals(this.jdField_d_of_type_JavaLangString))) {
      return true;
    }
