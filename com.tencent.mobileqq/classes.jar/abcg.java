  ...
  extends WebViewPlugin
{
  ...
  private static long a(bhod parambhod)
  {
    if (parambhod == null) {
      return 0L;
    }
    try
    {
      long l = parambhod.a().getIntent().getLongExtra("preAct_time", 0L);
      return l;
    }
    catch (Exception parambhod)
    {
      QLog.w("QzoneWebViewOfflinePlugin", 2, "can not get click time", parambhod);
    }
    return 0L;
  }
  ...
  private Object a(String paramString)
  {
    ...
    for (AppInterface localAppInterface = this.mRuntime.a();; localAppInterface = null)
    {
      ...
      return bmmo.a(localAppInterface, localCustomWebView, paramString, (String)localObject);
      localObject = null;
      break;
      localObject = null;
      break label27;
  ...
  private void a(bhru parambhru, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambhru == null) {
      return;
    }
    QLog.i("QzoneWebViewOfflinePlugin", 1, "state is " + parambhru);
    for (;;)
    {
      ...
      try
      {
        ...
        switch (parambhru.jdField_a_of_type_Int)
        {
        case 1: 
          if (!TextUtils.isEmpty(parambhru.jdField_b_of_type_JavaLangString)) {
            localJSONObject.put("url", parambhru.jdField_b_of_type_JavaLangString);
          }
          localJSONObject.put("code", parambhru.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(parambhru.f)) {
            localJSONObject.put("msg", parambhru.f);
          }
          localJSONObject.put("dataIsBase64", parambhru.jdField_a_of_type_Boolean);
          if (TextUtils.isEmpty(parambhru.d)) {
            break label396;
          }
          if (!parambhru.jdField_a_of_type_Boolean) {
            break label387;
          }
          str = bgku.encodeToString(parambhru.d.getBytes(), 0);
          localJSONObject.put("data", str);
          if (parambhru.jdField_b_of_type_Int > 0) {
            localJSONObject.put("httpStatusCode", parambhru.jdField_b_of_type_Int);
          }
          if (!TextUtils.isEmpty(parambhru.jdField_c_of_type_JavaLangString)) {
            localJSONObject.put("header", new JSONObject(parambhru.jdField_c_of_type_JavaLangString));
          }
          if (parambhru.jdField_a_of_type_JavaLangObject != null) {
            localJSONObject.put("userinfo", parambhru.jdField_a_of_type_JavaLangObject);
          }
          callJs(paramString, new String[] { localJSONObject.toString() });
          long l1 = System.currentTimeMillis();
          long l2 = parambhru.jdField_a_of_type_Long;
          QLog.i("QzoneWebViewOfflinePlugin", 1, "wnscgi@ status=" + parambhru.jdField_a_of_type_Int + ",total cost " + (l1 - l2) + " ms");
          return;
        }
      }
      catch (Exception parambhru)
      {
        parambhru.printStackTrace();
        return;
      }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new abci(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private static void b(String paramString, long paramLong, bhod parambhod)
  {
    int i;
    long l;
    try
    ...
    label205:
    String str1;
    if ((!TextUtils.isEmpty(paramString)) && (parambhod != null) && ((8589934594L == paramLong) || (8589934593L == paramLong)) && (paramString.equals(QzoneConfig.getInstance().getConfig("H5Url", "GameBar", "https://h5.qzone.qq.com/h5plus/homeV2/index/alpha?_proxy=1&_wv=3&via=qqnavigation.2017"))))
    {
      l = a(parambhod);
      if (l <= 0L)
      {
      ...
      if (QzoneOfflineCacheHelper.getSmallGameLastCacheTime(parambhod.a().getLongAccountUin()) <= 0L) {
        break label367;
      }
      i = 1;
    ...
    for (;;)
    {
      ...
      bcsi.a(localBaseApplication).reportTimeKVEvent(str1, localProperties, (int)l);
      if (8589934594L == paramLong) {}
      for (paramString = anni.a(2131711393);; paramString = anni.a(2131711394))
      {
        QLog.i("QzoneWebViewOfflinePlugin", 2, paramString + l + "ms,mta key=" + str1);
        if (8589934594L != paramLong) {
          break;
        }
        QzoneOfflineCacheHelper.updataSmallGameLastCacheFinishTime(parambhod.a().getLongAccountUin(), System.currentTimeMillis());
        return;
      }
      while (i == 0)
      {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      localbhrt.f = ((JSONObject)localObject2).optString("callback");
      localbhrt.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("url");
    ...
    catch (Exception localException)
    {
      ...
      paramVarArgs = new bhru();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbhrt.jdField_a_of_type_JavaLangString;
      paramVarArgs.jdField_a_of_type_Int = 3;
      paramVarArgs.jdField_c_of_type_Int = 101;
      paramVarArgs.f = localException.getMessage();
      paramVarArgs.e = localbhrt.f;
      a(paramVarArgs, localbhrt.f);
      return;
    }
    if (!a(a(), localbhrt.jdField_a_of_type_JavaLangString))
    {
      localObject1 = a(a());
      localObject2 = a(localbhrt.jdField_a_of_type_JavaLangString);
      throw new Exception("not support for cross-domain request!!! current host=" + (String)localObject1 + ",req host=" + (String)localObject2);
    }
    localbhrt.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("method");
    if ((!"GET".equalsIgnoreCase(localbhrt.jdField_b_of_type_JavaLangString)) && (!"POST".equalsIgnoreCase(localbhrt.jdField_b_of_type_JavaLangString))) {
    ...
    for (localbhrt.d = a((JSONObject)localObject1);; localbhrt.d = localObject1.toString())
    {
    ...
    {
      localbhrt.jdField_c_of_type_JavaLangString = ((String)localObject1);
      localbhrt.jdField_a_of_type_Boolean = ((JSONObject)localObject2).optBoolean("dataNeedBase64", false);
      localbhrt.jdField_a_of_type_Int = ((int)(((JSONObject)localObject2).optDouble("timeout", 0.0D) * 1000.0D));
      localbhrt.jdField_a_of_type_JavaLangObject = ((JSONObject)localObject2).opt("userinfo");
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new abcj(this, Looper.getMainLooper());
      }
      if (bhrs.a().a(localbhrt, this.jdField_b_of_type_AndroidOsHandler)) {
        break;
      }
      paramVarArgs = new bhru();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbhrt.jdField_a_of_type_JavaLangString;
  ...
  protected void a(bhru parambhru)
  {
    a(parambhru, parambhru.e);
  }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if (paramLong == 8L)
    {
      if (this.mRuntime != null)
      {
        bmmo.a = new WeakReference(this.mRuntime.a());
        bmmo.b = new WeakReference(this.mRuntime.a());
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(bhsg.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new abch(this, Looper.getMainLooper());
        }
