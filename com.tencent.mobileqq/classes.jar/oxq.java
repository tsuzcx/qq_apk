...
public class oxq
  implements Runnable
{
  public oxq(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  public void run()
  {
    ...
    //   10: astore 8
    //   12: aload_0
    //   13: getfield 12	oxq:a	Lcom/tencent/biz/qrcode/activity/QRDisplayActivity;
    ...
    //   37: dup
    //   38: getstatic 45	com/tencent/mobileqq/app/AppConstants:aQ	Ljava/lang/String;
    ...
    //   75: getstatic 45	com/tencent/mobileqq/app/AppConstants:aQ	Ljava/lang/String;
    ...
    //   135: getstatic 45	com/tencent/mobileqq/app/AppConstants:aQ	Ljava/lang/String;
    ...
    //   256: astore 4
    //   258: aload_0
    //   259: getfield 12	oxq:a	Lcom/tencent/biz/qrcode/activity/QRDisplayActivity;
    //   262: getfield 121	com/tencent/biz/qrcode/activity/QRDisplayActivity:jdField_c_of_type_Int	I
    //   265: iconst_2
    //   266: if_icmpne +60 -> 326
    //   269: aload_0
    //   270: getfield 12	oxq:a	Lcom/tencent/biz/qrcode/activity/QRDisplayActivity;
    //   273: getfield 123	com/tencent/biz/qrcode/activity/QRDisplayActivity:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   276: astore 6
    //   278: aload_0
    //   279: getfield 12	oxq:a	Lcom/tencent/biz/qrcode/activity/QRDisplayActivity;
    //   282: getfield 125	com/tencent/biz/qrcode/activity/QRDisplayActivity:a	I
    //   285: istore_1
    //   286: iload_2
    //   287: ifeq +343 -> 630
    //   290: ldc 127
    ...
    //   301: iconst_0
    //   302: iconst_3
    //   303: anewarray 135	java/lang/String
    //   306: dup
    //   307: iconst_0
    //   308: aload 6
    //   310: aastore
    ...
    //   312: iconst_1
    //   313: iload_1
    //   314: invokestatic 139	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   317: aastore
    //   318: dup
    //   319: iconst_2
    //   320: aload 5
    //   322: aastore
    //   323: invokestatic 144	com/tencent/mobileqq/util/TroopReportor:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   326: aload_0
    //   327: getfield 12	oxq:a	Lcom/tencent/biz/qrcode/activity/QRDisplayActivity;
    //   330: new 146	oxr
    //   333: dup
    //   334: aload_0
    //   335: iload_2
    //   336: aload 4
    //   338: invokespecial 149	oxr:<init>	(Loxq;ZLjava/lang/String;)V
    //   341: invokevirtual 153	com/tencent/biz/qrcode/activity/QRDisplayActivity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   344: return
    //   345: astore 4
    //   347: iload_3
    //   348: istore_2
    //   349: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   352: ifeq -116 -> 236
    //   355: ldc 160
    //   357: iconst_2
    //   358: aload 4
    //   360: invokevirtual 163	java/io/IOException:getMessage	()Ljava/lang/String;
    //   363: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   366: iload_3
    //   367: istore_2
    //   368: goto -132 -> 236
    //   371: astore 4
    ...
    //   381: aload 5
    //   383: astore 4
    //   385: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   388: ifeq +18 -> 406
    //   391: aload 5
    //   393: astore 4
    //   395: ldc 160
    //   397: iconst_2
    //   398: aload 8
    //   400: invokevirtual 168	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    //   403: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   406: aload 5
    //   408: ifnull +249 -> 657
    //   411: aload 5
    ...
    //   418: goto -182 -> 236
    //   421: astore 4
    //   423: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   426: ifeq +14 -> 440
    //   429: ldc 160
    //   431: iconst_2
    //   432: aload 4
    //   434: invokevirtual 163	java/io/IOException:getMessage	()Ljava/lang/String;
    //   437: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   440: iconst_0
    //   441: istore_2
    //   442: goto -206 -> 236
    //   445: astore 8
    ...
    //   451: aload 5
    //   453: astore 4
    //   455: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   458: ifeq +18 -> 476
    //   461: aload 5
    //   463: astore 4
    //   465: ldc 160
    //   467: iconst_2
    //   468: aload 8
    //   470: invokevirtual 169	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   473: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   476: aload 5
    //   478: ifnull +179 -> 657
    //   481: aload 5
    ...
    //   488: goto -252 -> 236
    //   491: astore 4
    //   493: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   496: ifeq +14 -> 510
    //   499: ldc 160
    //   501: iconst_2
    //   502: aload 4
    //   504: invokevirtual 163	java/io/IOException:getMessage	()Ljava/lang/String;
    //   507: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   510: iconst_0
    //   511: istore_2
    //   512: goto -276 -> 236
    //   515: astore 8
    ...
    //   521: aload 5
    //   523: astore 4
    //   525: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   528: ifeq +18 -> 546
    //   531: aload 5
    //   533: astore 4
    //   535: ldc 160
    //   537: iconst_2
    //   538: aload 8
    //   540: invokevirtual 170	java/lang/IllegalStateException:getMessage	()Ljava/lang/String;
    //   543: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   546: aload 5
    //   548: ifnull +109 -> 657
    //   551: aload 5
    ...
    //   558: goto -322 -> 236
    //   561: astore 4
    //   563: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   566: ifeq +14 -> 580
    //   569: ldc 160
    //   571: iconst_2
    //   572: aload 4
    //   574: invokevirtual 163	java/io/IOException:getMessage	()Ljava/lang/String;
    //   577: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   580: iconst_0
    //   581: istore_2
    //   582: goto -346 -> 236
    //   585: astore 6
    ...
    //   607: athrow
    //   608: astore 5
    //   610: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   613: ifeq -8 -> 605
    //   616: ldc 160
    //   618: iconst_2
    //   619: aload 5
    //   621: invokevirtual 163	java/io/IOException:getMessage	()Ljava/lang/String;
