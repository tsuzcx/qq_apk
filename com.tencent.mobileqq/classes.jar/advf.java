  ...
  extends actq
{
  ...
  {
    paramLinearLayout = (advg)paramactr;
    paramactr = paramView;
    if (paramView == null)
    {
      paramactr = LayoutInflater.from(this.a).inflate(2131558782, null);
      paramLinearLayout.b = ((TextView)paramactr.findViewById(2131367153));
    }
    ...
    if ((paramMessageRecord instanceof MessageForMyEnterTroop))
    {
      ...
      paramMessageRecord = this.a.getString(2131697477);
