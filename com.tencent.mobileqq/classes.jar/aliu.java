  ...
  extends AbsMenuFlag
{
  public boolean handleBusiness(IMCoreAppRuntime paramIMCoreAppRuntime, RecentBaseData paramRecentBaseData)
  {
    ...
    int i;
    if ((((RecentUserBaseData)paramRecentBaseData).mUser.getType() == 1) && (!axnp.a(paramIMCoreAppRuntime, (RecentUser)((RecentUserBaseData)paramRecentBaseData).mUser)))
    {
    ...
    for (;;)
    {
      ...
      i = 16;
      break label94;
      if (!((almg)paramIMCoreAppRuntime.getManager(QQManagerFactory.TEMP_MSG_BOX)).a(paramRecentBaseData.getRecentUserUin(), paramRecentBaseData.getRecentUserType()))
      {
