  ...
  extends tgr
{
  ...
  public tho(thn paramthn, View paramView, BaseData paramBaseData)
  {
  ...
  {
    ViewFactory.findClickableViewListener(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), new thp(this, paramContext));
  }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    thn.a(this.jdField_a_of_type_Thn, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer);
    if ((paramBaseData2 instanceof RecommendAdData)) {
      thn.a(this.jdField_a_of_type_Thn, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer, (RecommendAdData)paramBaseData2);
    }
    try
    {
      ...
      a(thn.a(this.jdField_a_of_type_Thn), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData.c);
      return;
    }
    catch (Exception paramBaseData1)
    {
      for (;;)
      {
        ukq.a("WebFastProteusViewAdCreator", paramBaseData1.getMessage());
      }
    }
  }
}
