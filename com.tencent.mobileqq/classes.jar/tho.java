...
public class tho
{
  ...
  private tht jdField_a_of_type_Tht;
  private int jdField_b_of_type_Int;
  private String jdField_b_of_type_JavaLangString;
  private String c;
  
  public tho(ViolaFragment paramViolaFragment)
  {
  ...
  private tpa a(JSONObject paramJSONObject)
  {
    return new tpa(this.jdField_a_of_type_JavaLangString, paramJSONObject, a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_JavaLangString);
  }
  ...
  private void b(ViewGroup paramViewGroup)
  {
    ...
    if (localHashMap.containsKey(thu.n)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setBorderRadius(((Integer)localHashMap.get(thu.n)).intValue());
    }
    if (localHashMap.containsKey(thu.o)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setContentMarginTop(((Integer)localHashMap.get(thu.o)).intValue());
    }
    if (localHashMap.containsKey(thu.u)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setTitleBarHeight(((Integer)localHashMap.get(thu.u)).intValue());
    }
    if (localHashMap.containsKey(thu.p)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsShowGrayBar(((Boolean)localHashMap.get(thu.p)).booleanValue());
    }
    if (localHashMap.containsKey(thu.r)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsNeedShowBackView(((Boolean)localHashMap.get(thu.r)).booleanValue());
    }
    if (localHashMap.containsKey(thu.q)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsNeedPopAnim(((Boolean)localHashMap.get(thu.q)).booleanValue());
    }
    if (localHashMap.containsKey(thu.s)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsAutoSuctionTop(((Boolean)localHashMap.get(thu.s)).booleanValue());
    }
    if (localHashMap.containsKey(thu.y)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setContainerColor(Color.parseColor((String)localHashMap.get(thu.y)));
    }
    if (localHashMap.containsKey(thu.j)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsStatusImmersive(((Boolean)localHashMap.get(thu.j)).booleanValue());
    }
    if (localHashMap.containsKey(thu.B)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsNeedChangeTitleAlpha(((Boolean)localHashMap.get(thu.B)).booleanValue());
    }
    if (localHashMap.containsKey(thu.C)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setIsNeedGrayBarFloat(((Boolean)localHashMap.get(thu.C)).booleanValue());
    }
    paramViewGroup = (FrameLayout)paramViewGroup.findViewById(2131380866);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.setViolaGestureListener(new ths(this, paramViewGroup));
  ...
  public void a(@NonNull ViewGroup paramViewGroup, @NonNull JSONObject paramJSONObject, boolean paramBoolean, tpb paramtpb)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramViewGroup.findViewById(2131380865));
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViewViolaBaseView.setListener(paramtpb);
  ...
  public void a(ViewGroup paramViewGroup, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.getActivity().overridePendingTransition(2130772222, 2130772225);
    return;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaCommonSuspensionGestureLayout.a(0, 4);
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    for (Object localObject = (ViolaBaseView)this.jdField_a_of_type_JavaUtilArrayList.get(i);; localObject = null)
    {
      if (localObject != null)
      {
        ...
        {
          ((ViolaBaseView)localObject).a(tmd.a(paramJSONObject).toString());
      ...
      paramJSONObject.setListener(new thr(this));
      localObject = str + "&firstCreated=1";
      paramJSONObject.setPageStartTime(System.currentTimeMillis());
      paramJSONObject.a((String)localObject, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment, new tpa((String)localObject, new JSONObject(), a((String)localObject), 0, null));
  ...
  public void a(tht paramtht)
  {
    this.jdField_a_of_type_Tht = paramtht;
  }
  
  public void a(tpb paramtpb)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViewViolaBaseView.a(paramtpb);
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewPagerAdapter = new thp(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetViewPagerCompat.addOnPageChangeListener(new thq(this));
  }
