...
public class shx
  extends Handler
{
  public shx(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      for (paramMessage = this.a.getString(2131430600);; paramMessage = new QQText(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopCard, 3))
      {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (FormSimpleItem)localView.findViewById(2131371575);
        localSwitch = ((FormSwitchItem)localObject4).a();
        localObject3 = (TextView)localView.findViewById(2131371576);
        ((TextView)localObject3).setBackgroundResource(2130838631);
        localObject1 = "";
        paramMessage = "";
        ...
        ((View)localObject4).setBackgroundResource(2130838636);
      ...
      for (;;)
      {
        ...
        return;
        label1174:
        ((View)localObject4).setBackgroundResource(2130838639);
        ((View)localObject4).getBackground().setAlpha(255);
        if (!localSwitch.isChecked())
        {
          localSwitch.setTag(Boolean.TRUE);
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131430251);
          paramMessage = this.a.getString(2131430259);
          break;
        case 3: 
          localObject1 = this.a.getString(2131435720);
          paramMessage = this.a.getString(2131430260);
          break;
        case 4: 
          localObject1 = this.a.getString(2131430250);
          paramMessage = this.a.getString(2131430258);
          break;
          label1336:
          localView.setVisibility(0);
          ((View)localObject4).setBackgroundResource(2130838639);
      ...
      {
        localObject1 = (TextView)paramMessage.findViewById(2131363397);
        if (localObject1 != null)
        {
        ...
        paramMessage = (ProgressBar)paramMessage.findViewById(2131364818);
        if (paramMessage != null) {
          paramMessage.setVisibility(8);
        }
      }
      QQToast.a(this.a, 2, this.a.getString(2131434501), 0).a();
      return;
      i = paramMessage.arg1;
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130846133))
      {
