...
public class shx
{
  ...
  public static final Map<Long, Map<Long, sic>> b;
  ...
  public static String a()
  {
    ...
    try
    {
      localJSONObject.put("version", npx.jdField_a_of_type_JavaLangString);
      localJSONObject.put("os", "1");
      localJSONObject.put("channel_id", olm.b());
  ...
  {
    if ((oox.a((int)paramLong)) || (bhvh.a(paramLong))) {
      return "0X8009CCB";
    }
    if (a(paramLong)) {
      return "0X8009356";
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, String paramString1, int paramInt3, int paramInt4, String paramString2)
  {
    ...
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("network", olg.a(paramContext));
      localJSONObject.put("version", npx.jdField_a_of_type_JavaLangString);
      localJSONObject.put("os", "1");
  ...
  public static String a(Context paramContext, long paramLong1, long paramLong2, int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3, String paramString3)
  {
    try
    {
      ...
      for (;;)
      {
        if (oox.c(paramInt2))
        {
          paramLong1 = ((Long)bhvh.a("readinjoy_daily_article_first_exposure_" + paramLong1, Long.valueOf(0L))).longValue();
          if (paramLong1 != 0L) {
            localJSONObject.put("daily_article_first_timestamp", paramLong1 + "");
          }
        }
        npx.a(localJSONObject);
        return localJSONObject.toString();
  ...
  public static Map<Long, sic> a(int paramInt)
  {
  ...
  public static Map<Long, sic> a(long paramLong)
  {
  ...
  public static onr a(TemplateBean paramTemplateBean, String paramString)
  {
    ...
    if (paramTemplateBean != null)
    {
      ...
      if ((paramTemplateBean != null) && (paramTemplateBean.entrySet() != null))
      {
        ...
        while ((paramTemplateBean != null) && (paramTemplateBean.hasNext()))
        {
          ...
          localonr.b((String)paramString.getKey(), paramString.getValue().toString());
        }
      }
    }
    return localonr;
  ...
  public static void a()
  {
    ...
    localAttributeList.att_value.set(onk.d + "");
    localArrayList.add(localAttributeList);
    sgj.a(10, localArrayList);
    if (QLog.isColorLevel()) {
      QLog.d("ReadinjoyReportUtils", 2, "reportKandianDelete  , foldStatus :  " + onk.d);
    }
  }
  ...
  {
    if ((paramInt == 1008) && (ajsf.aR.equals(paramString1)))
    {
      if (!bbbd.a(paramString2, paramResources.getString(ahny.a[3]))) {
        break label57;
      }
      noo.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
    }
    label57:
    while (!bbbd.a(paramString2, paramResources.getString(ahny.a[2]))) {
      return;
    }
    noo.a(null, null, "0X8009885", "0X8009885", 0, 0, "", "", "", a(), false);
  }
  
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if ((paramInt == 1008) && (ajsf.aR.equals(paramString)))
    {
      if (paramBoolean) {
        noo.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    ota.a().jdField_a_of_type_Oto.a(paramBoolean1);
    long l;
    if (paramBoolean1)
    {
      ota.n();
      ...
      if (paramInt1 == 0)
      {
        ...
        if (onk.d != 1)
        {
          ...
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(onk.a.b);
          localArrayList.add(localObject);
          localObject = new oidb_cmd0x80a.AttributeList();
          ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
          ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("AlgorithmID");
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(onk.a.jdField_a_of_type_JavaLangString);
          localArrayList.add(localObject);
          paramLong = NetConnInfoCenter.getServerTime();
          l = onk.a.jdField_a_of_type_Long;
          localObject = new oidb_cmd0x80a.AttributeList();
      ...
      label483:
      for (paramLong = System.currentTimeMillis() - ota.a().d();; paramLong = System.currentTimeMillis() - ota.jdField_a_of_type_Long)
      {
        ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(paramLong + "");
        localArrayList.add(localObject);
        paramInt2 = 4;
        sgj.a(paramInt2, localArrayList);
        if (QLog.isColorLevel()) {
    ...
    ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(String.valueOf(ota.a(paramLong)));
    localArrayList.add(localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
    ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
    ...
    localArrayList.add(localObject);
    if (onk.a.jdField_a_of_type_Int != 1)
    {
      localObject = new oidb_cmd0x80a.AttributeList();
      ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(5);
      ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("StrategyID");
    ...
    if (((oto)localObject).jdField_a_of_type_Long > 0L)
    {
      paramLong = ((oto)localObject).jdField_a_of_type_Long - ((oto)localObject).d;
      label971:
    ...
    label1206:
    for (paramLong = ((oto)localObject).e - ((oto)localObject).c;; paramLong = 0L)
    {
      localAttributeList.att_value.set(paramLong + "");
      localArrayList.add(localAttributeList);
      localAttributeList = new oidb_cmd0x80a.AttributeList();
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    Object localObject2 = "";
    Object localObject1;
    if ((rap.a(paramArticleInfo)) || (rap.i(paramArticleInfo)) || (rap.j(paramArticleInfo)) || (rap.k(paramArticleInfo)))
    {
    ...
    for (;;)
    {
      ...
      int i = onk.b(paramArticleInfo);
      localObject2 = new JSONObject();
      try
      {
        onk.a((JSONObject)localObject2, paramArticleInfo);
        ((JSONObject)localObject2).put("touin", localObject1);
        ((JSONObject)localObject2).put("entry_mode", String.valueOf(i));
        noo.a(null, "", "0X8009846", "0X8009846", 0, 0, String.valueOf(l1), String.valueOf(l2), String.valueOf(l3), ((JSONObject)localObject2).toString(), false);
        return;
  ...
  {
    if (((Long)bhvh.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(0L))).longValue() == 0L) {
      bhvh.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(System.currentTimeMillis() / 1000L));
    }
    synchronized (jdField_b_of_type_JavaUtilMap)
    {
      Map localMap2 = a(paramBaseArticleInfo.mChannelID);
      sic localsic = (sic)localMap2.get(Long.valueOf(paramBaseArticleInfo.mArticleID));
      if (localsic != null)
      {
        long l = paramLong;
        if (localsic.jdField_a_of_type_Long > paramLong) {
          l = localsic.jdField_a_of_type_Long;
        }
        localsic.jdField_a_of_type_Long = l;
        return;
      }
      localsic = new sic(onk.d());
      localsic.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo = paramBaseArticleInfo;
      localsic.jdField_a_of_type_Long = paramLong;
      localMap2.put(Long.valueOf(paramBaseArticleInfo.mArticleID), localsic);
    }
  }
  ...
  public static void a(TemplateBean paramTemplateBean, String paramString1, String paramString2)
  {
    ...
    {
      return;
      localonr = a(paramTemplateBean, paramString1);
      paramTemplateBean = a(paramTemplateBean, paramString1, paramString2);
    } while (paramTemplateBean == null);
    noo.a(null, "CliOper", "", "", paramTemplateBean, paramTemplateBean, 0, 0, "", "", "", localonr.a(), false);
  }
  
  public static void a(RecentItemChatMsgData paramRecentItemChatMsgData)
  {
    if (!jdField_a_of_type_Boolean) {}
    while ((paramRecentItemChatMsgData == null) || (paramRecentItemChatMsgData.mUser == null) || (!ajsf.aQ.equals(paramRecentItemChatMsgData.mUser.uin))) {
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localonr.l(i);
        localonr.b("message_reddot_style", onk.k());
        if (paramBoolean)
        {
          localObject = "0X8009A85";
          noo.a(null, paramQQAppInterface, (String)localObject, (String)localObject, 0, 0, "", "", "", localonr.a(), false);
          return;
        }
      }
  ...
  public static void a(String paramString)
  {
    ...
    {
      noo.a(null, null, "0X800978D", "0X800978D", 0, 0, "", "", "", a(), false);
      ota.l();
    }
    while (!ajsf.aR.equals(paramString)) {
      return;
    }
    noo.a(null, null, "0X8009886", "0X8009886", 0, 0, "", "", "", a(), false);
    ota.m();
  }
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      Collections.sort(paramList, new sia());
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    Collections.sort(paramList, new shz());
  ...
  public static void a(Map<Long, sic> paramMap)
  {
    Iterator localIterator = paramMap.values().iterator();
    while (localIterator.hasNext())
    {
      sic localsic = (sic)localIterator.next();
      ArticleInfo localArticleInfo = (ArticleInfo)localsic.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo;
      if ((!onk.s(localArticleInfo)) || (!localArticleInfo.mNewPolymericInfo.jdField_a_of_type_Boolean))
      {
        String str1 = onk.c(localArticleInfo);
        paramMap = localArticleInfo.innerUniqueID;
        Object localObject = paramMap;
        if (onk.j(localArticleInfo))
        {
        ...
        String str2 = onk.e(localArticleInfo);
        if (((rap.a(localArticleInfo)) || (rap.i(localArticleInfo)) || (rap.j(localArticleInfo)) || (rap.k(localArticleInfo))) && (!rap.o(localArticleInfo))) {
        ...
        for (;;)
        {
          for (;;)
          {
            localObject = onk.a(localArticleInfo.mAlgorithmID, onk.a(localArticleInfo), (int)localArticleInfo.mChannelID, NetworkState.isWifiConn(), str1, (String)localObject, str2, 0, localsic.jdField_a_of_type_Int, localArticleInfo);
            str1 = a(localArticleInfo.mChannelID);
            try
            {
              ((JSONObject)localObject).put("exposure_time", "" + (float)localsic.jdField_a_of_type_Long / 1000.0F);
              if (oox.c((int)localArticleInfo.mChannelID)) {
                ((JSONObject)localObject).put("cmd", bhvh.g());
              }
              noo.a(null, "CliOper", "", paramMap, str1, str1, 0, 0, Long.toString(localArticleInfo.mFeedId), localArticleInfo.mArticleID + "", localArticleInfo.mStrategyId + "", ((JSONObject)localObject).toString(), false);
            }
          ...
          break;
          if ((onk.i(localArticleInfo)) && (localArticleInfo.mPolymericInfo.jdField_a_of_type_Int == 6)) {
            paramMap = localArticleInfo.mPolymericInfo.b + "";
          } else if (onk.l(localArticleInfo)) {
            paramMap = "";
          } else {
