...
public class ajzv
{
  ...
  {
    if (paramInt == 2052) {
      return ajyc.a(2131693718);
    }
    if (paramInt == 1033) {
      return ajyc.a(2131693717);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = akwi.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      akwi.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = akwi.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      akwi.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    akwi.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    akwi.a(paramContext, "key_local_cache", String.valueOf(paramInt));
