...
public class ajzv
  implements Runnable
{
  public ajzv(SwiftBrowserCookieMonster paramSwiftBrowserCookieMonster, AppRuntime paramAppRuntime, Intent paramIntent) {}
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserCookieMonster.b)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserCookieMonster.a > 0L)
        {
          ...
          new Handler(Looper.getMainLooper()).post(new ajzw(this));
          return;
