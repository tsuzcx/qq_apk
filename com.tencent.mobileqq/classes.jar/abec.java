  ...
  extends WebViewPlugin
{
  ...
  private SparseArray<WeakReference<abee>> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  abee a(int paramInt)
  {
    ...
    Object localObject = new abee(this, null);
    ((abee)localObject).jdField_a_of_type_Int = paramInt;
    localObject = new WeakReference(localObject);
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localObject);
    return (abee)((WeakReference)localObject).get();
  }
  ...
  boolean a(int paramInt)
  {
    ...
    localObject = (abee)((WeakReference)localObject).get();
    if (localObject == null) {
      return false;
    }
    try
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSparseArray != null) && (this.jdField_a_of_type_AndroidUtilSparseArray.size() > 0))
    {
      ...
      {
        abee localabee = (abee)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
        if (localabee != null) {
          a(localabee.jdField_a_of_type_Int);
        }
        i += 1;
      }
    }
