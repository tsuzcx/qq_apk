...
public class awhn
{
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    if (paramInt == 0) {
      localDrawable = TroopUtils.getTroopLevelBgDrawable(paramResources, paramResources.getColor(2131166243));
    }
    while (paramInt != 1) {
      return localDrawable;
    }
    return TroopUtils.getTroopLevelBgDrawable(paramResources, paramResources.getColor(2131166241));
  }
  ...
  public static String a(int paramInt)
  {
    ...
    default: 
      return amtp.c;
    case 2: 
      return amtj.a(2131704730);
    case 4: 
      return amtj.a(2131704728);
    case 5: 
      return amtj.a(2131704729);
    }
    return amtj.a(2131704731);
  }
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (!bool)
    {
      ...
      if ((localObject1 != null) && (((amsw)localObject1).b(paramString2))) {
        i = 1;
      }
    }
    for (;;)
  ...
  public static void a(bbku parambbku, long paramLong, String paramString, int paramInt)
  {
    boolean bool;
    switch (paramInt)
    {
    ...
    {
      if (bool) {
        parambbku.a(0, paramString, paramLong, 1);
      }
      if (QLog.isColorLevel()) {
        awkj.a("PttShow", new Object[] { "addLocalMaxMsgSeq", String.format("needUpdateLocal:%b    from:%d     msgSeq:%d", new Object[] { Boolean.valueOf(bool), Integer.valueOf(paramInt), Long.valueOf(paramLong) }) });
      }
      return;
      long l = parambbku.a(0, paramString);
      if (1L + l == paramLong)
      {
        bool = true;
      }
      else
      {
        ...
        awkj.a("PttShow", new Object[] { "addLocalMaxMsgSeq", String.format("not continuous seq local:%d    msgseq:%d    from:%d", new Object[] { Long.valueOf(l), Long.valueOf(paramLong), Integer.valueOf(paramInt) }) });
        bool = false;
        continue;
        bool = true;
      }
  ...
  public static void a(HotChatInfo paramHotChatInfo, QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt)
  {
    ...
    localIntent.putExtra("url", bjnd.a(bjnd.a(bjnd.a(bjnd.a(bjnd.a("https://nearby.qq.com/hot_chat/member_list.html?_wv=3&_bid=2581", "_wv", "3"), "_bid", "2581"), "gc", paramHotChatInfo.troopUin), "rid", paramHotChatInfo.uuid), "from", String.valueOf(0)));
    ...
    if (paramInt == 0) {
      amxb.a(paramQQAppInterface, "0X800638B");
    }
    while (paramInt != 1) {
      return;
    }
    amxb.a(paramQQAppInterface, "0X800638C");
  }
