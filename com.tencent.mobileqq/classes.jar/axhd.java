  ...
  implements Manager
{
  ...
  public long a;
  private axgv jdField_a_of_type_Axgv;
  private axhb jdField_a_of_type_Axhb;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<MessageRecord> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public axhd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Axhb = new axhb(paramQQAppInterface);
  }
  
  private void a(DataLineMsgRecord paramDataLineMsgRecord, String paramString1, String paramString2, String paramString3, amlk paramamlk)
  {
    if (!this.jdField_a_of_type_Axhb.a())
    {
    ...
    this.jdField_a_of_type_Axhb.a(paramDataLineMsgRecord);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new DataLineMessageSpreadManager.2(this, paramDataLineMsgRecord, paramString1, paramamlk, paramString2, paramString3), 1000L);
  }
  
  private boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    int i = this.jdField_a_of_type_Axhb.a();
    int j = amll.a().a();
    if (j == 0) {
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Axhb.a(paramamli);
  }
  ...
  public void a(DataLineMsgRecord paramDataLineMsgRecord, Context paramContext)
  {
    ...
    catch (Exception paramDataLineMsgRecord)
    {
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80098F8", "0X80098F8", 0, 0, "", "", "", "");
      ...
      axea.a(paramDataLineMsgRecord, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 6, i);
    }
  }
  ...
  public void a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      QLog.e("DataLineMessageSpreadManager", 1, apck.a());
      return;
    }
    if (QLog.isColorLevel()) {
