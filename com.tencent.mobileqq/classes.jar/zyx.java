...
public class zyx
{
  ...
  public static arie a(QQAppInterface paramQQAppInterface, aric paramaric, int paramInt)
  {
    if ((paramaric == null) || (paramaric.a == null) || (paramaric.a.size() <= 0)) {
      return null;
    }
    int k = 0;
    for (int j = (int)(Math.random() * paramaric.a.size()); (paramInt != -1) && (j == paramInt) && (k < 50); j = (int)(Math.random() * paramaric.a.size())) {
      k += 1;
    }
    return (arie)paramaric.a.get(j);
  }
  ...
  public static String a(Context paramContext, String paramString, Bitmap paramBitmap)
  {
    ...
    //   9: dup
    //   10: ldc_w 470
    //   13: invokestatic 475	bigv:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    QQToast.a(localBaseApplication, paramInt1, paramInt2, 1).b(localBaseApplication.getResources().getDimensionPixelSize(2131299011));
  }
  ...
  private static void a(Context paramContext, String paramString, int paramInt1, int paramInt2, Canvas paramCanvas, int paramInt3)
  {
    ...
    try
    {
      ...
      paramCanvas.drawBitmap(BitmapFactory.decodeResource(paramContext.getResources(), 2130846953), null, localRect, localPaint);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, zvp paramzvp)
  {
    paramString1 = zvn.a(paramInt1, paramString1);
    ...
    paramString2 = new zyy(paramzvp);
    paramContext = new NewIntent(paramContext, zvq.class);
  ...
  public static final Bitmap[] a(Context paramContext, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3, ArrayList<Rect> paramArrayList, int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3, boolean paramBoolean1, String paramString4, boolean paramBoolean2)
  {
    ...
    int n = Math.min(750, bdep.e(paramContext));
    int i1 = Math.min(1344, bdep.c(paramContext));
    if (QLog.isColorLevel()) {
