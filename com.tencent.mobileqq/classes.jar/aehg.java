...
public class aehg
  implements Runnable
{
  public aehg(SmallVideoSendFragment paramSmallVideoSendFragment) {}
  ...
  public void run()
  {
    ...
    new VideoCompositeHelper().a(localPublishVideoEntry, SmallVideoSendFragment.a(this.a).j + ".tmp.mp4", new aehh(this, localPublishVideoEntry));
  }
}
