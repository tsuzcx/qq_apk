...
{
  public aehg(SoundAndVibrateActivity paramSoundAndVibrateActivity) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      SoundAndVibrateActivity.b(this.a).setBackgroundResource(2130839491);
      int j = 0;
      ...
      if (i != 0)
      {
        SoundAndVibrateActivity.c(this.a).setBackgroundResource(2130839475);
        SoundAndVibrateActivity.c(this.a).setVisibility(0);
      }
      if (k == 2131230720)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(this.a.getResources().getDrawable(2130850620));
        ...
        if (AppSetting.c)
        {
          SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131718548) + this.a.getString(2131690748));
          SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131718549) + this.a.getString(2131719368));
          SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131718550) + this.a.getString(2131719368));
          SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131718551) + this.a.getString(2131719368));
        }
    ...
    for (int i = 1;; i = 0)
    {
      bcef.b((QQAppInterface)localObject, "CliOper", "", "", "Setting_tab", "Clk_notice_sound", 0, i, "", "", "", "");
      EventCollector.getInstance().onCheckedChanged(paramCompoundButton, paramBoolean);
      return;
      if (k == 2131230721)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(null);
        SoundAndVibrateActivity.c(this.a).setRightIcon(this.a.getResources().getDrawable(2130850620));
        SoundAndVibrateActivity.d(this.a).setRightIcon(null);
        SoundAndVibrateActivity.e(this.a).setRightIcon(null);
        ...
        SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131718548) + this.a.getString(2131719368));
        SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131718549) + this.a.getString(2131690748));
        SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131718550) + this.a.getString(2131719368));
        SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131718551) + this.a.getString(2131719368));
        break;
      }
      if (k == SoundAndVibrateActivity.jdField_a_of_type_Int)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(null);
        SoundAndVibrateActivity.c(this.a).setRightIcon(null);
        SoundAndVibrateActivity.d(this.a).setRightIcon(this.a.getResources().getDrawable(2130850620));
        SoundAndVibrateActivity.e(this.a).setRightIcon(null);
        ...
        SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131718548) + this.a.getString(2131719368));
        SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131718549) + this.a.getString(2131719368));
        SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131718550) + this.a.getString(2131690748));
        SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131718551) + this.a.getString(2131719368));
        break;
      }
      ...
      SoundAndVibrateActivity.c(this.a).setRightIcon(null);
      SoundAndVibrateActivity.d(this.a).setRightIcon(null);
      SoundAndVibrateActivity.e(this.a).setRightIcon(this.a.getResources().getDrawable(2130850620));
      ...
      SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131718549) + this.a.getString(2131719368));
      SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131718550) + this.a.getString(2131719368));
      SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131718551) + this.a.getString(2131690748));
      break;
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(true);
      break label466;
      SoundAndVibrateActivity.b(this.a).setBackgroundResource(2130839475);
