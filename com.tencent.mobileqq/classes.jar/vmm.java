...
public class vmm
  implements Runnable
{
  public vmm(PhotoListPanel paramPhotoListPanel) {}
  ...
  public void run()
  {
    ...
    if ((localObject1 != null) && (((Set)localObject1).size() > 0))
    {
      ...
      for (;;)
      {
        ...
        ((ArrayList)localObject2).add(AppConstants.aI + (String)localObject1);
      }
    }
    localObject1 = null;
    ...
    if ((localObject2 == null) || (((List)localObject2).size() == 0))
    {
      ...
      PhotoListPanel.g = 0;
      this.a.jdField_a_of_type_AndroidOsHandler.post(new vmn(this));
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_AndroidOsHandler.post(new vmo(this, (List)localObject2));
