  ...
  extends aukd
{
  ...
  public aukk(Intent paramIntent, aukp paramaukp)
  {
  ...
  public int a(android.content.Context paramContext, String paramString)
  {
    ...
    //   345: aload_2
    //   346: astore 7
    //   348: invokestatic 135	aukt:a	()Laukt;
    //   351: aload 9
    ...
    //   361: invokevirtual 138	aukt:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   364: pop
    //   365: aload 6
    //   367: astore 8
    //   369: aload_2
    //   370: astore 7
    //   372: aload_0
    //   373: getfield 29	aukk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    //   376: ifnull +564 -> 940
    //   379: aload 6
    //   381: astore 8
    //   383: aload_2
    //   384: astore 7
    //   386: aload_0
    //   387: getfield 29	aukk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   400: aload_2
    //   401: astore 7
    //   403: invokestatic 135	aukt:a	()Laukt;
    //   406: iconst_5
    //   407: invokevirtual 145	aukt:a	(I)Lorg/json/JSONObject;
    //   410: astore 10
    //   412: aload 10
    ...
    //   536: astore 7
    //   538: aload_0
    //   539: getfield 29	aukk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   617: ldc 165
    //   619: aload_0
    //   620: getfield 29	aukk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   665: aload_2
    //   666: astore 7
    //   668: getstatic 190	dov/com/qq/im/ae/download/AEResInfo:AE_RES_BASE_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   671: invokestatic 196	dov/com/qq/im/ae/download/AEResUtil:getUnzippedPackageDir	(Ldov/com/qq/im/ae/download/AEResInfo;)Ljava/lang/String;
    //   674: astore 9
    //   676: aload 9
    //   678: astore_1
    //   679: aload 6
    ...
    //   684: astore 7
    //   686: aload 9
    //   688: getstatic 199	java/io/File:separator	Ljava/lang/String;
    //   691: invokevirtual 205	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   694: ifeq +24 -> 718
    //   697: aload 6
    //   699: astore 8
    //   701: aload_2
    ...
    //   706: iconst_0
    //   707: aload 9
    //   709: invokevirtual 209	java/lang/String:length	()I
    //   712: iconst_1
    //   713: isub
    //   714: invokevirtual 213	java/lang/String:substring	(II)Ljava/lang/String;
    //   717: astore_1
    //   718: aload 6
    //   720: astore 8
    //   722: aload_2
    ...
    //   778: iconst_1
    //   779: iconst_4
    //   780: anewarray 221	java/lang/Object
    //   783: dup
    //   784: iconst_0
    //   785: ldc 223
    //   787: aastore
    ...
    //   818: aload_1
    //   819: aastore
    //   820: invokestatic 229	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   823: aload 6
    //   825: astore 8
    //   827: aload_2
    //   828: astore 7
    ...
    //   836: ldc 215
    //   838: ldc 231
    //   840: invokevirtual 235	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   852: astore 7
    //   854: aload_1
    //   855: invokevirtual 238	java/io/File:getParentFile	()Ljava/io/File;
    //   858: astore 9
    //   860: aload 9
    //   862: ifnull +113 -> 975
    //   865: aload 6
    ...
    //   870: astore 7
    //   872: aload 9
    //   874: invokevirtual 242	java/io/File:exists	()Z
    //   877: ifne +98 -> 975
    //   880: aload 6
    //   882: astore 8
    //   884: aload_2
    //   885: astore 7
    //   887: aload 9
    //   889: invokevirtual 245	java/io/File:mkdirs	()Z
    //   892: istore 5
    //   894: iload 5
    //   896: ifne +18 -> 914
    //   899: aload 6
    ...
    //   919: astore 7
    //   921: aload_1
    //   922: invokevirtual 242	java/io/File:exists	()Z
    //   925: ifeq +15 -> 940
    //   928: aload 6
    //   930: astore 8
    //   932: aload_2
    //   933: astore 7
    //   935: aload_1
    //   936: invokevirtual 248	java/io/File:delete	()Z
    //   939: pop
    //   940: aload 6
    //   942: astore 8
    //   944: aload_2
    ...
    //   949: iconst_1
    //   950: ldc 250
    //   952: invokestatic 252	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   955: aload_2
    //   956: ifnull +7 -> 963
    //   959: aload_2
    ...
    //   1168: aload_1
    //   1169: invokevirtual 255	org/json/JSONException:getMessage	()Ljava/lang/String;
  ...
  public void a(boolean paramBoolean, Activity paramActivity)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = bbuc.a().jdField_a_of_type_AndroidHardwareCamera;
      k = bbuc.a().jdField_a_of_type_Int;
      i = -1;
    }
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      localYtSDKPlatformContex.reflectListener = new aukl(this);
      ...
      JSONObject localJSONObject = aukt.a().a(5);
      ...
      return;
      QLog.d("qq_Identification.Model", 1, new Object[] { "YtSDKKitFramework init result : ", Integer.valueOf(YtSDKKitFramework.getInstance().init(localYtSDKPlatformContex, localJSONObject, (YtSDKKitFramework.YtSDKKitFrameworkWorkMode)localObject, localArrayList, new aukm(this))) });
    }
