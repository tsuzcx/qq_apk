  ...
  implements bbzr
{
  private void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      paramMessageHandler = BaseApplicationImpl.getApplication().getString(2131690183);
      paramMsg = new bbzc().a((List)localObject);
    ...
    label303:
    bbzf.a(paramMessageHandler, paramList, paramMsg, true, paramBoolean1, null);
  }
  
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbyn parambbyn)
  {
    a(paramMessageHandler, paramList, paramMsg, parambbyn.e, parambbyn.b, parambbyn.a, parambbyn.d);
  }
}
