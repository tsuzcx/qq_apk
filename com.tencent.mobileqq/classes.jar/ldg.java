...
public class ldg
{
  ...
  public ldg(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().bindService(localIntent, this.jdField_a_of_type_Ldh, 1);
      return;
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        lbj.e(jdField_a_of_type_JavaLangString, "bindService " + localThrowable.getMessage());
      }
    }
  }
  ...
  {
    QLog.d(jdField_a_of_type_JavaLangString, 1, String.format("setAVServiceForegroud start=%s mAvService=%s", new Object[] { Boolean.valueOf(paramBoolean), this.jdField_a_of_type_Lwu }));
    if (this.jdField_a_of_type_Lwu != null) {}
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Lwu.a(paramBoolean, paramNotification);
  ...
  public void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unbindService(this.jdField_a_of_type_Ldh);
      return;
    }
    catch (Exception localException)
    {
      lbj.e(jdField_a_of_type_JavaLangString, "disconnect msg = " + localException.getMessage());
    }
  }
}
