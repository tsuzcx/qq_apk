...
{
  public ldg(ReadInJoyFeedsActivity paramReadInJoyFeedsActivity, KandianMergeManager paramKandianMergeManager) {}
    ...
    case 8: 
      do
      {
        ...
        for (;;)
        {
          ...
          QQToast.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyActivityReadInJoyFeedsActivity, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyActivityReadInJoyFeedsActivity.getResources().getString(2131428455), 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131558448));
        ...
        return;
        ThreadManager.postImmediately(new ldh(this), null, true);
