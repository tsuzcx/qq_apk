...
{
  bgqv(int paramInt, bgqx parambgqx, VideoView paramVideoView, boolean paramBoolean) {}
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Bgqx != null) {
      this.jdField_a_of_type_Bgqx.a(paramInt1, paramInt2, this.jdField_a_of_type_Int);
    }
    paramMediaPlayer = bgqr.a(null, this.jdField_a_of_type_Int, 7, null);
    ...
    do
    {
      for (;;)
      {
        ...
        {
          paramMediaPlayer = bfpx.a(paramMediaPlayer);
