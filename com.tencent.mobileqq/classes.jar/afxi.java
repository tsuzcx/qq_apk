...
public class afxi
  extends BaseAdapter
{
  private agbf jdField_a_of_type_Agbf;
  ...
  public afxi(Context paramContext, ArrayList<Object> paramArrayList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ChatHistoryC2CLinkFragment paramChatHistoryC2CLinkFragment, agbf paramagbf)
  {
    ...
    this.jdField_a_of_type_Agbf = paramagbf;
    this.jdField_a_of_type_JavaTextSimpleDateFormat = new SimpleDateFormat("M月d日");
    this.jdField_a_of_type_Ajxn = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app.getManager(51));
  }
  ...
  private void a(afxl paramafxl, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          a(afxl.a(paramafxl), (String)localObject);
          i = 1;
          if (i == 0) {
            afxl.a(paramafxl).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849345));
          }
          str1 = a(agbg.a(paramMessageRecord));
          if (!(paramMessageRecord instanceof MessageForArkApp)) {
            break label300;
          }
          str2 = ((MessageForArkApp)paramMessageRecord).getTitle();
          localTextView = afxl.a(paramafxl);
          localObject = str2;
          ...
          afxl.b(paramafxl).setText((CharSequence)localObject);
          afxl.c(paramafxl).setText(bbcl.m(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, paramMessageRecord.senderuin));
          afxl.a(paramafxl).setOnClickListener(new afxj(this, str1, paramafxl, paramMessageRecord));
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.c) {
            break label312;
          }
          afxl.a(paramafxl).setVisibility(0);
          bool = this.jdField_a_of_type_Agbf.a(paramMessageRecord);
          afxl.a(paramafxl).setChecked(bool);
          paramMessageRecord = (LinearLayout.LayoutParams)afxl.a(paramafxl).getLayoutParams();
          paramMessageRecord.setMargins(paramMessageRecord.leftMargin, paramMessageRecord.topMargin, vzo.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), paramMessageRecord.bottomMargin);
          afxl.a(paramafxl).setLayoutParams(paramMessageRecord);
          return;
        }
      ...
      continue;
      label300:
      afxl.a(paramafxl).setText(str1);
      continue;
      label312:
      afxl.a(paramafxl).setVisibility(8);
      paramMessageRecord = (LinearLayout.LayoutParams)afxl.a(paramafxl).getLayoutParams();
      paramMessageRecord.setMargins(paramMessageRecord.leftMargin, paramMessageRecord.topMargin, vzo.a(this.jdField_a_of_type_AndroidContentContext, 50.0F), paramMessageRecord.bottomMargin);
      afxl.a(paramafxl).setLayoutParams(paramMessageRecord);
      return;
      label374:
      int i = 0;
  ...
  public static void a(ImageView paramImageView, String paramString)
  {
    ...
    Drawable localDrawable = localBaseApplication.getResources().getDrawable(2130849345);
  ...
  public void a(URLImageView paramURLImageView, AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (paramAbsShareMsg = Uri.fromFile(new File((String)localObject1)).toString();; paramAbsShareMsg = (AbsShareMsg)localObject1)
    {
      ...
      paramAbsShareMsg.setTag(bavi.b(((ViewGroup.LayoutParams)localObject1).width, ((ViewGroup.LayoutParams)localObject1).height, vzo.a(this.jdField_a_of_type_AndroidContentContext, 6.0F)));
      paramAbsShareMsg.setDecodeHandler(bavi.i);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof afxk)))
      {
        paramViewGroup = (afxk)paramView.getTag();
        ...
        if ((((MessageForStructing)localObject1).structingMsg != null) && ((((MessageForStructing)localObject1).structingMsg instanceof AbsShareMsg)))
        {
          ...
          localObject2 = bbcl.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, ((MessageForStructing)localObject1).senderuin);
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Agbf.a(localObject1));
    ...
    do
    {
      ...
      paramViewGroup.c = ((TextView)paramView.findViewById(2131364918));
      ...
      {
        if ((paramView != null) && ((paramView.getTag() instanceof afxl)))
        {
          localObject1 = (afxl)paramView.getTag();
          paramViewGroup = paramView;
        ...
        for (;;)
        {
          ...
          paramView = new afxl(this, paramViewGroup);
