  ...
  extends ReportDialog
{
  ...
  public aboh(@NonNull Context paramContext)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_Abpi = new abpi(new aboi(this), this.jdField_a_of_type_Abop, true);
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      ((ViewGroup)localObject1).setOnSystemUiVisibilityChangeListener(new aboj(this, (ViewGroup)localObject1));
    }
    Object localObject2 = this.jdField_a_of_type_Abpi.a(LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity), (ViewGroup)localObject1);
    setContentView((View)localObject2);
    setOnDismissListener(new abok(this));
    ((ViewGroup)localObject1).getViewTreeObserver().addOnGlobalLayoutListener(new abol(this, (ViewGroup)localObject1, (View)localObject2));
    this.jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new abom(this);
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    abrl.a("GdtMotiveVideoDialog", "onWindowFocusChanged() called with: hasFocus = [" + paramBoolean + "]");
