...
public class bbcn
{
  private static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (paramQQAppInterface != null)
    {
      i = j;
      if (localabta != null) {
        i = localabta.a(paramQQAppInterface.frienduin, paramQQAppInterface.istroop);
      }
    }
    return i;
  }
  ...
  {
    Object localObject = paramQQAppInterface.a(1001).a(alof.aj, 1001);
    if (localObject == null)
    {
  ...
  {
    Object localObject1 = paramQQAppInterface.a(1001).a(alof.aj, 1001);
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == ((ArrayList)localObject2).size())
      {
        ...
        paramQQAppInterface.a().a(alof.H, 1001, alof.aj, paramQQAppInterface.getCurrentAccountUin());
        return;
      }
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramQQAppInterface.a().a(alof.aj, 1001, (String)localObject2, paramQQAppInterface.getCurrentAccountUin());
      }
    }
  }
  ...
  {
    int i = 0;
    Object localObject = paramQQAppInterface.a(1001).a(alof.H, 1001);
    if (localObject == null)
    {
    ...
    try
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if (alof.aj.equals(localMessageRecord.senderuin))
        {
          a(paramQQAppInterface, localJSONObject2);
          break label402;
        }
        if ((!alof.al.equals(localMessageRecord.senderuin)) && (!alof.am.equals(localMessageRecord.senderuin)) && (!alof.an.equals(localMessageRecord.senderuin)) && (!alof.ao.equals(localMessageRecord.senderuin)) && (!alof.ap.equals(localMessageRecord.senderuin)))
        {
          localArrayList.add(localMessageRecord);
  ...
  public static final void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      default: 
        return;
      case 1: 
        a(paramQQAppInterface, paramString, alof.H);
        return;
      }
      a(paramQQAppInterface, paramString, alof.aj);
      return;
    }
