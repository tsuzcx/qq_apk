  ...
  implements zbs
{
  ...
  public zbq(AppInterface paramAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(@NonNull ArrayList<zbt> paramArrayList, @NonNull Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      paramArrayList.add(new zbt(paramContext.getResources().getDrawable(2130846795), 1, 0));
    }
      ...
      if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
      {
        ...
        if (bool)
        {
          ...
          if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
          {
            ...
            do
            {
              localObject4 = localzbt1;
              localObject5 = localObject2;
              localObject6 = localObject3;
              localObject7 = localzbt2;
            ...
            {
              localObject4 = new zbt(paramContext.getResources().getDrawable(2130845026), 2, i);
    ...
    for (;;)
    {
      ...
      {
        localzbt1 = new zbt(paramContext.getResources().getDrawable(2130845027), 2, i);
      ...
      {
        localObject4 = new zbt(paramContext.getResources().getDrawable(2130845028), 2, i);
        localObject3 = localObject1;
        localObject1 = localObject2;
      ...
      {
        localObject4 = new zbt(paramContext.getResources().getDrawable(2130845025), 2, i);
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
      }
      ...
      {
        localzbt2 = new zbt(paramContext.getResources().getDrawable(2130845024), 2, i);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
        ...
        paramArrayList.add(new zbt(paramContext.getResources().getDrawable(2130846787), 0, -1));
        int k = 0;
