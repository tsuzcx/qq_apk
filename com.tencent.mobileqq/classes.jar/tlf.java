...
{
  public tlf(RecentLoginDevActivity paramRecentLoginDevActivity) {}
  ...
  protected void onDelHistoryDevResult(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131436491), 0).b(this.a.getTitleBarHeight());
      return;
    }
  ...
  protected void onGetHistoryDevResult(boolean paramBoolean, SvcRspGetDevLoginInfo paramSvcRspGetDevLoginInfo)
  {
    ...
    for (;;)
    {
      QQToast.a(this.a.getActivity(), 1, this.a.getString(2131436567), 0).b(this.a.getTitleBarHeight());
      return;
      label288:
