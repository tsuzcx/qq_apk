...
public class bcff
{
  ...
  {
    bcds.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bcds.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bcds.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      ...
      bcds.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bcen(str2, str3, new bcfg(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bcds.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bbtm.a().g());
    localBundle.putString("keystr", bbtm.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bcez.e());
    localBundle.putString("keytype", "256");
    if (bcev.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bcds.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bcen parambcen, Bundle paramBundle)
  {
