...
class ros
  implements URLDrawable.URLDrawableListener, row
{
  private static rou jdField_a_of_type_Rou = new rou(null);
  ...
  ros(ReadInJoyCapsuleView paramReadInJoyCapsuleView)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = rom.a();
    localURLDrawableOptions.mFailedDrawable = rom.a();
  ...
  private void c()
  {
    ...
    int i = rom.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo.mChannelCoverId, false);
    if (i != 0) {
  ...
  private void d()
  {
    ...
    a(true);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setColorFilter(rom.a());
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setTextColor(-1);
    int i = rom.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo.mChannelCoverId, true);
    if (i != 0) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setDrawableLeft(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.getContext().getResources().getDrawable(i));
    }
  }
  ...
  void a(ChannelCoverInfo paramChannelCoverInfo, View.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setOnClickListener(new rot(this, paramOnClickListener));
    if ((TextUtils.isEmpty(paramChannelCoverInfo.externalExposureBackgroundUrl)) || (bhvh.c(paramChannelCoverInfo.mChannelCoverId)))
    {
      c();
      return;
    }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    jdField_a_of_type_Rou.a(this, paramURLDrawable);
  }
}
