...
public abstract class yka<T extends VideoListFeedItem>
  extends yht<T>
{
  public static ykc a;
  private boolean a;
  ...
  public boolean c;
  public List<zhq> d = new ArrayList();
  
  static
  {
    jdField_a_of_type_Ykc = new ykc(null);
  }
  
  public yka(@NonNull T paramT)
  {
    super(paramT);
  ...
  public void a(int paramInt, StoryVideoItem paramStoryVideoItem)
  {
    ...
    for (;;)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        yqp.d("Q.qqstory.home.data.VideoListHomeFeed", "feed id %s, fake video count:%d", new Object[] { ((VideoListFeedItem)this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelFeedItem).feedId, Integer.valueOf(paramInt) });
        zkb.a();
        return;
      }
    }
  ...
  public void a(StoryVideoItem paramStoryVideoItem, boolean paramBoolean)
  {
    ...
    {
      bool2 = a(a().date);
      yqp.b("Q.qqstory.home.data.VideoListHomeFeed", "sort today=%b before %s", Boolean.valueOf(bool2), this.jdField_c_of_type_JavaUtilList);
    ...
    {
      Collections.sort(paramStoryVideoItem, new ykd(paramBoolean));
      yqp.b("Q.qqstory.home.data.VideoListHomeFeed", "sort today=%b after %s", Boolean.valueOf(bool2), this.jdField_c_of_type_JavaUtilList);
      return;
    }
  }
  ...
  public boolean a()
  {
    ...
    {
      yqp.d("Q.qqstory.home.data.VideoListHomeFeed", "video item size:%d", new Object[] { Integer.valueOf(this.jdField_c_of_type_JavaUtilList.size()) });
    }
    return false;
  }
  ...
  {
    super.b();
    c(((wpj)wpm.a(5)).a(((VideoListFeedItem)this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelFeedItem).feedId), true);
  }
  ...
  public void c(List<StoryVideoItem> paramList, boolean paramBoolean)
  {
    ...
    {
      Collections.sort(paramList, new ykd(paramBoolean));
      return;
    }
  }
