  ...
  implements allu
{
  ...
  public rmf(@NonNull PendingIntent paramPendingIntent, @NonNull QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, PendingIntent paramPendingIntent, String paramString1, String paramString2)
  {
    ...
    paramIntent = new rmf(paramPendingIntent, paramQQAppInterface, str1, paramIntent.getStringExtra("banner_readinjoy_article_id"), str2, str3, paramIntent.getBooleanExtra("banner_readinjoy_is_weishi_mode", false));
    paramQQAppInterface = aljw.a(paramQQAppInterface, i, paramString1, paramString2, paramIntent);
    paramIntent.a();
  ...
  private void a(String paramString)
  {
    ...
    {
      localsbg = new sbg(this.d, this.jdField_a_of_type_JavaLangString, this.c, this.b);
      localsbg.i(this.b);
    ...
    {
      ocd.a(localQQAppInterface, str2, paramString, paramString, 0, 0, str1, "", "", localsbg.a().a(), false);
      return;
    }
  }
