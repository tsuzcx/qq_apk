...
public class qee
{
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    try
    {
      localSharedPreferences = bhvy.a(onh.a(), true, true);
  ...
  private static void a(String paramString, ArrayList<Intent> paramArrayList)
  {
    ...
    //   218: ldc_w 280
    //   221: aload_0
    //   222: invokestatic 355	qee:b	(Lorg/json/JSONObject;)Ljava/util/ArrayList;
    //   225: invokevirtual 358	android/os/Bundle:putParcelableArrayList	(Ljava/lang/String;Ljava/util/ArrayList;)V
    //   228: aload 7
    //   230: ldc 89
    //   232: aload_0
    //   233: invokestatic 360	qee:a	(Lorg/json/JSONObject;)Ljava/util/ArrayList;
  ...
  public static void b(Bundle paramBundle)
  {
    ...
    c(paramBundle);
    paramBundle = bhvy.a(onh.a(), true, true);
