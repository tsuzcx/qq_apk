...
class basy
  extends balg
{
  basy(basl parambasl, int paramInt, String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean) {}
  ...
  public void a(int paramInt, oidb_0x962.RspBody paramRspBody)
  {
    ...
    if ((this.jdField_a_of_type_Basl.a != null) && (this.jdField_a_of_type_Boolean)) {
      this.jdField_a_of_type_Basl.a.a.getEntityManagerFactory().createEntityManager().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
    }
  }
}
