  ...
  extends BaseJsPlugin
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bklm(this);
  ...
  private void a(Activity paramActivity, int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      bhdj.a(paramActivity, 232).setMessage(paramString).setNegativeButton(2131717407, new bkls(this)).show();
      return;
    }
  ...
  private void e(JSONObject paramJSONObject)
  {
    ...
    RemoteHandleManager.getInstance().addWebEventListener(new bkln(this, paramJSONObject));
    if (!a())
    {
    ...
    if (!NetworkState.isWifiConn())
    {
      ...
      bhdj.a((Context)localObject, 230).setTitle(((Context)localObject).getString(2131717406)).setMessage(((Context)localObject).getString(2131717408)).setPositiveButton(((Context)localObject).getString(2131717405), new bklr(this, paramJSONObject)).setNegativeButton(((Context)localObject).getString(2131717404), new bklq(this)).show();
      return;
    }
