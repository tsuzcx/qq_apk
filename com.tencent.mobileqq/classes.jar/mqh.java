...
public class mqh
{
      ...
      do
      {
        ...
        if (j == -2)
        {
          ...
          if ((!this.jdField_c_of_type_Boolean) && ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean)))
          {
            ...
            if (this.jdField_a_of_type_Mqm.a != null) {
              this.jdField_a_of_type_Mqm.a.j();
            }
          }
  ...
  protected void a(mpy parammpy, boolean paramBoolean)
  {
    if (AudioHelper.e()) {
      QLog.w("QavRecordEncoder", 1, "handleAudioFrame, frame[" + parammpy + "], endOfStream[" + paramBoolean + "], mNoAudio[" + this.jdField_d_of_type_Boolean + "]");
    }
    if (this.jdField_d_of_type_Boolean) {
      return;
    }
    this.jdField_a_of_type_JavaNioByteBuffer.clear();
    this.jdField_a_of_type_JavaNioByteBuffer.put(parammpy.a);
    this.jdField_a_of_type_JavaNioByteBuffer.position(parammpy.a.length);
    ...
    if (j >= 0)
    {
      ...
      this.jdField_b_of_type_AndroidMediaMediaCodec.queueInputBuffer(j, 0, parammpy.a.length, parammpy.jdField_b_of_type_Long, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QavRecordEncoder", 2, "encode, write to codec, size=" + parammpy.a.length);
      }
      label280:
      parammpy = this.jdField_b_of_type_AndroidMediaMediaCodec.getOutputBuffers();
      i = 0;
    }
    for (;;)
    {
  ...
  public void a(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    paramArrayOfByte = new mpy(paramArrayOfByte, l);
  ...
  public void b()
  {
    ...
    long l = this.jdField_a_of_type_Long;
    this.jdField_a_of_type_Long = (1L + l);
    mpy localmpy = new mpy(new byte[0], l);
    localmpy.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
    a(localmpy, true);
    a(true);
    c();
    if (this.jdField_a_of_type_JavaNioByteBuffer != null)
