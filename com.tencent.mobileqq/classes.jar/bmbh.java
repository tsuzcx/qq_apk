  ...
  implements bmbg
{
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    case 1: 
      ...
      auht.a().b(paramBundle, (Bundle)localObject2);
      return true;
    case 2: 
      ...
      ((QQAppInterface)localObject1).getFileManagerDataCenter().a(new atpa(paramBundle));
    ...
    case 4: 
      ...
      paramBundle.putString("configInfo", atpj.a(((QQAppInterface)localObject1).getApp().getBaseContext(), str));
      return true;
    }
