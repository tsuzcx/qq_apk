  ...
  extends bkbo
{
  ...
  {
    return new bkbu(this, paramIntent);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    while (i == 1000)
    {
      paramFromServiceMsg = (sweet_pair_byebye_rsp)bjqk.a(paramFromServiceMsg.getWupBuffer(), "sweet_pair_byebye");
      if (paramFromServiceMsg != null)
      {
        paramFromServiceMsg = paramFromServiceMsg.rsp_comm;
        if (paramFromServiceMsg.retcode == 0) {
          ((asdx)localObject).a(true, paramFromServiceMsg.retcode, paramFromServiceMsg.errmsg, paramIntent);
        }
      }
      else
      {
      ...
      ((asdx)localObject).a(false, paramFromServiceMsg.retcode, paramFromServiceMsg.errmsg, paramIntent);
      return;
    }
    ((asdx)localObject).a(false, -1, null, null);
  }
}
