...
public class awva
{
  private static volatile awva a;
  public static final String a;
  
  static
  {
    jdField_a_of_type_JavaLangString = aljq.aX + "qbdownres";
  }
  ...
  public static awva a()
  {
    if (jdField_a_of_type_Awva == null) {}
    try
    {
      if (jdField_a_of_type_Awva == null) {
        jdField_a_of_type_Awva = new awva();
      }
      return jdField_a_of_type_Awva;
    }
    finally {}
  }
  ...
  public static boolean a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if ((QzoneConfig.getInstance().getConfig("Schema", "jump_installapp_scheme_enable", 0) == 0) && (arof.b((String)localObject)))
      {
  ...
  private boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (awvh.a(paramString2))
    {
      a(paramQQAppInterface.getAccount(), paramString1);
      arof.c(str);
      return false;
    }
    bjmf.a().c(paramString4, null);
    return false;
  }
  ...
  private static void b(String paramString1, SoftReference<QQAppInterface> paramSoftReference, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      if (paramSoftReference != null)
      {
        paramSoftReference = (bavr)paramSoftReference.getManager(193);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (localbavr.a())
      {
        ...
        localbavr.a(10088, "vas", paramString2, 0, paramString2, paramString3, 1, 2, true, new awvb(this, paramQQAppInterface, "qboss_pre_download_res", paramString1, paramString3, paramString2, paramString4));
        return;
      }
