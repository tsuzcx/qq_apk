...
public class xnv
{
  public static int a(int paramInt)
  {
    ...
    if (localObject == null)
    {
      wsv.c("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId() error, app is null", new Throwable());
      return 0;
    }
    localObject = ((nan)((QQAppInterface)localObject).getManager(70)).a(paramInt);
    if (localObject == null)
    {
      wsv.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is null", Integer.valueOf(paramInt));
      return 0;
    }
    wsv.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is %s", Integer.valueOf(paramInt), xnh.a((MessageMicro)localObject));
  ...
  {
    return ((uur)paramQQAppInterface.getManager(252)).a;
  }
