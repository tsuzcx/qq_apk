  ...
  extends xnr
{
  ...
  private void a(DecodeConfig paramDecodeConfig, axvi paramaxvi, int paramInt)
  {
    if (paramInt != 0)
    {
      paramaxvi.h = paramInt;
      paramaxvi.g = 0;
    }
    paramInt = Math.min(paramaxvi.jdField_a_of_type_Int, paramaxvi.b);
    int i = Math.max(paramaxvi.jdField_a_of_type_Int, paramaxvi.b);
    paramaxvi.jdField_a_of_type_Int = paramInt;
    paramaxvi.b = i;
    paramDecodeConfig.width = paramaxvi.jdField_a_of_type_Int;
    paramDecodeConfig.height = paramaxvi.b;
  }
  
  private boolean a(xno paramxno)
  {
    if (paramxno.jdField_b_of_type_Boolean) {}
    while (!paramxno.c) {
      return false;
    }
    return true;
  ...
  public void a(xno paramxno)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoToVideo", 2, "[runLocalVideo2Video]run begin, taskid:" + paramxno.jdField_b_of_type_Long + " run:" + paramxno.d);
    }
    if (a(paramxno))
    {
      wxj.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramxno.jdField_a_of_type_JavaLangString, null, null, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramxno);
      return;
    }
    ...
    localObject1 = null;
    Object localObject2 = new File(paramxno.jdField_a_of_type_JavaLangString);
    ...
    if (xrg.e((String)localObject1))
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "before,getPCMFromFile[Have audio File]:  " + paramxno.jdField_b_of_type_Long + " audioPath: " + (String)localObject1 + " audioFileSize=" + arso.a((String)localObject1));
      }
      localObject2 = new xrd();
      l1 = System.currentTimeMillis();
      ((xrd)localObject2).a(paramxno.jdField_a_of_type_JavaLangString, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getMetaDataFromFile:  " + paramxno.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " mSampleRate: " + paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      localLocalMediaInfo.path = paramxno.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo.mDuration = paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long;
      l1 = System.currentTimeMillis();
      bool = ((xrd)localObject2).a(localLocalMediaInfo, 0, (int)paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long, (String)localObject1, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getPCMFromFile:  " + paramxno.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean);
      }
      if (paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean)
      {
        if ((!bool) || (!xrg.e((String)localObject1)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run,getPCMFromFile: failed " + paramxno.jdField_b_of_type_Long + " path=" + (String)localObject1 + " success=" + bool);
          }
          xrg.g((String)localObject1);
          wxj.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramxno.jdField_a_of_type_JavaLangString, null, null, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramxno);
        }
      }
      else
      {
        xrg.g((String)localObject1);
        xrd.a((String)localObject1, (int)paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long);
        if (!xrg.e((String)localObject1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run[video convert],createSilentPCMFile: failed " + paramxno.jdField_b_of_type_Long + " path=" + (String)localObject1);
          }
          wxj.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramxno.jdField_a_of_type_JavaLangString, null, null, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramxno);
          return;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "After,getPCMFromFile: hasAudioTrack= " + paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " path=" + (String)localObject1 + " success=" + bool + " audioFileSize=" + arso.a((String)localObject1));
      }
    }
    paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    if (a(paramxno))
    {
      wxj.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramxno.jdField_a_of_type_JavaLangString, null, null, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramxno);
    ...
    boolean bool = a(paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramxno);
    ...
    wxj.a("actVideo2VideoTime", new String[] { l3 - l4 + "" });
    if ((bool) && (arso.a(this.jdField_a_of_type_JavaLangString)))
    {
      l3 = arso.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, file exist, size:" + l3 + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 0;
      wxj.a("actVideo2VideoResult", new String[] { "0" });
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, taskid:" + paramxno.jdField_b_of_type_Long + " run:" + paramxno.d + " cost:" + (l2 - l1) + " ms successVideo:" + bool);
      }
      if (!paramxno.d) {
        break;
      }
      a(this.jdField_a_of_type_Int, paramxno.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, null, paramxno.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramxno);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, [failed]file not exist:" + paramxno.jdField_b_of_type_Long + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 7;
      wxj.a("actVideo2VideoResult", new String[] { "7" });
      xrg.g(this.jdField_a_of_type_JavaLangString);
    }
  }
  
  /* Error */
  public boolean a(SlideItemInfo arg1, xno paramxno)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +10 -> 11
    ...
    //   33: new 291	bnnt
    //   36: dup
    //   37: invokespecial 292	bnnt:<init>	()V
    //   40: putfield 294	xnv:jdField_a_of_type_Bnnt	Lbnnt;
    ...
    //   165: invokevirtual 325	xnv:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 5
    //   170: new 22	axvi
    //   173: dup
    //   174: aload 13
    ...
    //   194: invokespecial 333	axvi:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 14
    //   199: aload 14
    //   201: sipush 720
    //   204: putfield 31	axvi:jdField_a_of_type_Int	I
    //   207: aload 14
    //   209: sipush 1280
    //   212: putfield 34	axvi:b	I
    //   215: aload_1
    ...
    //   292: sipush 720
    //   295: sipush 1280
    //   298: invokestatic 339	xsv:a	(IIII)Z
    //   301: ifeq +9 -> 310
    //   304: aload 14
    //   306: iconst_1
    //   307: putfield 340	axvi:c	Z
    ...
    //   340: aload 14
    //   342: iload 5
    //   344: invokespecial 345	xnv:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Laxvi;I)V
    //   347: aload 15
    //   349: iconst_1
    ...
    //   372: invokevirtual 64	xnv:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   488: aload_0
    //   489: getfield 294	xnv:jdField_a_of_type_Bnnt	Lbnnt;
    //   492: aload 15
    //   494: aload 14
    //   496: new 370	xnw
    //   499: dup
    //   500: aload_0
    //   501: aload_2
    //   502: invokespecial 373	xnw:<init>	(Lxnv;Lxno;)V
    //   505: aconst_null
    //   506: invokevirtual 376	bnnt:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Laxvi;Laxvu;Lbnnu;)V
    //   509: aload_0
    //   510: getfield 17	xnv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   513: astore_1
    //   514: aload_1
    //   515: monitorenter
    ...
    //   538: aload_2
    //   539: getfield 57	xno:jdField_b_of_type_Boolean	Z
    ...
    //   564: aload_2
    //   565: getfield 383	xno:jdField_a_of_type_Boolean	Z
    ...
    //   577: aload_2
    //   578: getfield 57	xno:jdField_b_of_type_Boolean	Z
    //   581: ifne +84 -> 665
    //   584: aload_2
    //   585: getfield 60	xno:c	Z
    //   588: ifne +77 -> 665
    //   591: aload_2
    //   592: getfield 383	xno:jdField_a_of_type_Boolean	Z
    //   595: istore 6
    //   597: iload 6
    //   599: ifne +66 -> 665
    //   602: aload_0
    //   603: getfield 17	xnv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   667: aload_0
    //   668: aload_2
    //   669: invokespecial 391	xnv:a	(Lxno;)Z
    //   672: istore 7
    //   674: iload 7
    //   676: istore 6
  ...
  public void b(xno paramxno)
  {
    ...
    {
      paramxno.jdField_b_of_type_Boolean = true;
