...
public class bfvt
{
  ...
  private List<bfvr> jdField_a_of_type_JavaUtilList = new ArrayList();
  private int b;
  private int c;
  private int d;
  private int e;
  ...
  public bfvt(FollowImageTextView paramFollowImageTextView)
  {
  ...
  private void a()
  {
    ...
    if (j < i1) {
      ...
      {
        localbfvr = new bfvr(null);
        localbfvr.jdField_a_of_type_Int = i;
        localbfvr.b = (j - 1);
        localbfvr.c = k;
        localbfvr.jdField_a_of_type_JavaLangCharSequence = this.jdField_a_of_type_JavaLangCharSequence.subSequence(i, j);
        this.jdField_a_of_type_JavaUtilList.add(localbfvr);
        i = j + 1;
        k = 0;
      }
    }
    for (;;)
    {
      ...
      if (j == i1 - 1)
      {
        ...
        localbfvr.b = (j - 1);
        localbfvr.c = m;
        localbfvr.jdField_a_of_type_JavaLangCharSequence = this.jdField_a_of_type_JavaLangCharSequence.subSequence(i, i1);
        this.jdField_a_of_type_JavaUtilList.add(localbfvr);
      }
      else
      {
  ...
  {
    bfvq localbfvq = FollowImageTextView.a(this.jdField_a_of_type_ComTencentMobileqqTroopWidgetFollowImageTextView);
    this.jdField_a_of_type_JavaLangCharSequence = localbfvq.getText();
    this.jdField_a_of_type_AndroidTextTextPaint = localbfvq.getPaint();
    this.jdField_a_of_type_Int = localbfvq.getMeasuredWidth();
    this.b = localbfvq.getLineHeight();
    this.d = localbfvq.getPaddingLeft();
    this.e = localbfvq.getPaddingTop();
    this.f = localbfvq.getPaddingRight();
    this.g = localbfvq.getPaddingBottom();
    this.c = paramInt;
    a();
  }
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (k < j)
        {
          CharSequence localCharSequence = ((bfvr)this.jdField_a_of_type_JavaUtilList.get(k)).jdField_a_of_type_JavaLangCharSequence;
      ...
      {
        paramCanvas = (bfvr)this.jdField_a_of_type_JavaUtilList.get(j);
