  ...
  extends QIPCModule
{
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("CMD_SHORTVIDEO_REQUEST_MANUAL_DOWNLOAD".equals(paramString))
    {
      ...
      paramBundle = acvz.a((QQAppInterface)localObject);
      if (paramBundle != null)
      {
        if (qpc.a(this.a) == null) {
          qpc.a(this.a, new View(BaseApplicationImpl.getContext()));
        }
        qpc.a(this.a, new qpe(this, paramString));
        paramBundle.a(qpc.a(this.a), qpc.a(this.a));
      }
      paramString.busiType = 0;
      paramString = axdq.a((QQAppInterface)localObject, paramString, 1);
      if (paramString != null) {
        axdq.a(paramString, (QQAppInterface)localObject);
      }
    }
    do
    {
          ...
          do
          {
            for (;;)
            {
              ...
              else if ("CMD_SHORTVIDEO_REQUEST_CLEAR".equals(paramString))
              {
                if (qpc.a(this.a) != null)
                {
                  if (acvz.a((QQAppInterface)localObject) != null) {
                    acvz.a((QQAppInterface)localObject).a(qpc.a(this.a), null);
                  }
                  qpc.a(this.a, null);
                }
                qpc.a(this.a, null);
              ...
              {
                qoi.a((QQAppInterface)localObject, paramBundle);
              }
              ...
              else
              {
                if ("CMD_PUB_ACCOUNT_CHECK_IS_FOLLOWED".equals(paramString)) {
                  try
                  {
                    bool = qoi.a((QQAppInterface)localObject, paramBundle.getLong("VALUE_PUB_ACCOUNT_UIN"));
                ...
                {
                  qoi.a((QQAppInterface)localObject, paramBundle.getString("VALUE_PUB_ACCOUNT_UIN"), false);
                }
                else
                {
                  if ("CMD_VOLUMECONTROL_INSTANCE_SHOULDMUTEINVIDEOFEEDS_GET".equals(paramString))
                  {
                    ...
                    paramBundle.putBoolean("VOLUMECONTROL_INSTANCE_SHOULDMUTEINVIDEOFEEDS", qvk.a().a(false));
                    if (QLog.isColorLevel()) {
                      QLog.d("Q.pubaccount.video.feeds.VideoFeedsIPCServer", 2, paramString + " shouldMuteInVideoFeed = " + qvk.a().a(false));
                    }
                  ...
                  if ("CMD_VOLUMECONTROL_INSTANCE_SHOULDMUTEINVIDEOFEEDS_SET".equals(paramString))
                  {
                    ...
                    qvk.a().b(((Boolean)localObject).booleanValue());
                  }
                  else
                  {
                    ...
                    {
                      paramBundle = new Bundle();
                      paramBundle.putBoolean("VALUE_VIDEO_NEED_ALERT", qkr.a().d());
                      if (QLog.isColorLevel()) {
                        QLog.d("Q.pubaccount.video.feeds.VideoFeedsIPCServer", 2, paramString + " VALUE_VIDEO_NEED_ALERT = " + qkr.a().d());
                      }
                      return EIPCResult.createSuccessResult(paramBundle);
                    }
                    ...
                    if ("CMD_COMFIRM_VIDEO_PLAY_NEED_ALERT_IN_XG".equals(paramString))
                    {
                      ...
                      qkr.a().b = ((Boolean)localObject).booleanValue();
                      if (QLog.isColorLevel()) {
                    ...
                    else
                    {
                      ...
                      {
                        paramString = new Bundle();
                        paramString.putBoolean("VALUE_CAMERA_CAPTURE_IS_SO_READY", Boolean.valueOf(oed.a((QQAppInterface)localObject, BaseApplicationImpl.getContext())).booleanValue());
                      ...
                      {
                        if (qpc.a(this.a) == null) {
                          qpc.a(this.a, new oee((QQAppInterface)localObject, BaseApplicationImpl.getContext()));
                        }
                        qpc.a(this.a).a(new qpf(this));
                        qpc.a(this.a).a();
                      }
                      else
                      {
                        ...
                        {
                          qpc.a(this.a, new qpg(this, (QQAppInterface)localObject));
                          ((QQAppInterface)localObject).addObserver(qpc.a(this.a));
                          paramString = new Bundle();
                          paramString.putString("VALUE_USER_NICK_NAME", bbcz.b((QQAppInterface)localObject, paramBundle.getString("VALUE_USER_UIN_TO_GET_NICK_NAME"), true));
                          return EIPCResult.createSuccessResult(paramString);
                        }
                        if ("CMD_GET_NICK_NAME_BY_UIN_CANCLE".equals(paramString))
                        {
                          ((QQAppInterface)localObject).removeObserver(qpc.a(this.a));
                        }
                        else
                        {
                          ...
                          qtd.a(((QQAppInterface)localObject).getApplication().getApplicationContext());
                        }
                      }
                    }
                  }
            ...
            {
              paramBundle = new Bundle();
              paramBundle.putString("VALUE_CLICK_COMMENT_ACTICLEINFO", qkb.a().b());
              if (QLog.isColorLevel()) {
                QLog.d("Q.pubaccount.video.feeds.VideoFeedsIPCServer", 2, paramString + " VALUE_CLICK_COMMENT_ACTICLEINFO = " + qkb.a().b());
              }
              return EIPCResult.createSuccessResult(paramBundle);
            }
    ...
    {
      rvx.a(paramString, "", (String)localObject, null, new qph(this, paramBundle));
    ...
    for (paramString = (ContextWrapper)SplashActivity.a.get();; paramString = BaseApplicationImpl.getContext())
    {
      rvx.a(paramString, "", (String)localObject, null);
      break;
    }
  }
}
