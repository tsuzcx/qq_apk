...
import com.tencent.mobileqq.activity.recent.BannerManager.30.1;
...
{
  alkw(aljw paramaljw, String paramString, Long paramLong, int paramInt) {}
  
  public void onClick(View paramView)
  {
    if (!aljw.a(this.jdField_a_of_type_Aljw)) {}
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      aljw.a(this.jdField_a_of_type_Aljw, false);
      new Handler().postDelayed(new BannerManager.30.1(this), 1000L);
      Object localObject1 = (QQAppInterface)aljw.a(this.jdField_a_of_type_Aljw).getAppRuntime();
      ...
      ((StringBuilder)localObject2).append("&version=8.4.5.4745");
      ...
      VasWebviewUtil.openQQBrowserActivity(aljw.a(this.jdField_a_of_type_Aljw), (String)localObject2, 32768L, localIntent, false, -1);
      ...
      try
      {
        ...
        bdll.a(aljw.a(this.jdField_a_of_type_Aljw).app, "dc00898", "", "", "0X8009EE3", "0X8009EE3", 9, 0, "", "", "", "");
      }
