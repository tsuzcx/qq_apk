...
{
  public bofg(VideoTrackContainerView paramVideoTrackContainerView, bodv parambodv, int paramInt1, int paramInt2) {}
  
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    int i = ((Integer)paramValueAnimator.getAnimatedValue()).intValue();
    ((VideoTrackTimeLineView)this.jdField_a_of_type_Bodv).d(i);
