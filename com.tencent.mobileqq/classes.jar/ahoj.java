...
public class ahoj
  implements Runnable
{
  public ahoj(EffectsCameraCaptureFragment paramEffectsCameraCaptureFragment, RecentDanceConfigMgr.DItemInfo paramDItemInfo) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845629);
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(new ahok(this));
    if (EffectsCameraCaptureFragment.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment) == null) {
      EffectsCameraCaptureFragment.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment, new ahol(this));
    }
    ...
    CaptureReportUtil.j();
    ThreadManager.getUIHandler().postDelayed(new ahom(this), 2000L);
  }
}
