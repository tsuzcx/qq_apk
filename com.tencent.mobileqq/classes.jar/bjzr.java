  ...
  extends bjzt
{
  ...
  public bjzr(DoodleView paramDoodleView)
  {
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 20	vxy:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          ...
          {
            bjzx localbjzx = (bjzx)localIterator.next();
            DynamicStickerData localDynamicStickerData = new DynamicStickerData();
            localDynamicStickerData.centerP = localbjzx.jdField_b_of_type_AndroidGraphicsPointF;
            localDynamicStickerData.scale = localbjzx.q;
            localDynamicStickerData.rotate = localbjzx.r;
            localDynamicStickerData.translateX = (localbjzx.s + paramInt1);
            localDynamicStickerData.translateY = (localbjzx.t + paramInt2);
            localDynamicStickerData.height = localbjzx.v;
            localDynamicStickerData.width = localbjzx.u;
            localDynamicStickerData.path = localbjzx.jdField_f_of_type_JavaLangString;
            localDynamicStickerData.type = localbjzx.h;
            localDynamicStickerData.data = localbjzx.jdField_g_of_type_JavaLangString;
            localDynamicStickerData.layerWidth = j;
            localDynamicStickerData.layerHeight = i;
            localDynamicStickerData.mapMotionTrack = localbjzx.jdField_a_of_type_JavaUtilMap;
            localDynamicStickerData.setSegmentList(localbjzx.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.getSegmentList());
        ...
        if (((ArrayList)localObject).size() > 0)
        {
          ...
          return bkhu.a((ArrayList)localObject);
        }
      }
      return null;
      j = m;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      if ((localPasterParcelData.jdField_d_of_type_Int == 3) && (!TextUtils.isEmpty(localPasterParcelData.jdField_e_of_type_JavaLangString)))
      {
        ...
        j = 1;
        localbkhg = bkfn.a(BaseApplicationImpl.getContext(), localPasterParcelData.jdField_e_of_type_JavaLangString);
        if (j == 0) {
          break label443;
        }
        paramJSONArray = localbkhg;
      }
    }
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        localbjzx = new bjzx(this, paramJSONArray, new bkab(localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.x, localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.y, localPasterParcelData.jdField_a_of_type_Float, localPasterParcelData.jdField_b_of_type_Float, localPasterParcelData.jdField_c_of_type_Float, localPasterParcelData.jdField_d_of_type_Float, (int)localPasterParcelData.jdField_e_of_type_Float, (int)localPasterParcelData.f), localPasterParcelData.jdField_a_of_type_JavaLangString, localPasterParcelData.jdField_b_of_type_JavaLangString, localPasterParcelData.jdField_c_of_type_JavaLangString, localPasterParcelData.jdField_d_of_type_Int);
        localbjzx.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.set(localPasterParcelData.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper);
        localbjzx.jdField_g_of_type_JavaLangString = localPasterParcelData.jdField_e_of_type_JavaLangString;
        localbjzx.jdField_g_of_type_Int = localPasterParcelData.jdField_e_of_type_Int;
        localbjzx.jdField_e_of_type_Int = 0;
        localbjzx.jdField_f_of_type_Int = 1;
        localbjzx.jdField_b_of_type_Boolean = bkfn.a(localbkhg.a());
        localbjzx.c = bkfn.b(localbkhg.a());
        if (localbjzx.jdField_b_of_type_Boolean)
        {
          this.jdField_b_of_type_JavaUtilList.add(localbjzx);
          if (!TextUtils.isEmpty(localPasterParcelData.jdField_d_of_type_JavaLangString))
          {
            localbjzx.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", localPasterParcelData.jdField_d_of_type_JavaLangString, 0, "", 0, "");
            localbjzx.jdField_a_of_type_Long = System.currentTimeMillis();
          }
        }
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())) {
          break label471;
        ...
        this.jdField_a_of_type_JavaUtilList.add(localbjzx);
      }
      for (;;)
      {
        i += 1;
        ...
        paramJSONArray = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localbkhg.a());
        break label90;
        label471:
        localbjzx.h = 0;
        paramJSONArray = (bjzt)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(bjzt.jdField_a_of_type_JavaLangString);
        if (paramJSONArray != null) {
          paramJSONArray.jdField_a_of_type_JavaUtilList.add(localbjzx);
        }
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        {
          Object localObject = (bjzx)localIterator.next();
          if ((((bjzx)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((((bjzx)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof URLDrawable)))
          {
            localObject = (URLDrawable)((bjzx)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            if (localObject != null)
            {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        Drawable localDrawable = ((bjzx)localIterator.next()).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        if ((localDrawable instanceof bkhr)) {
          ((bkhr)localDrawable).a();
        }
      }
    }
    super.b();
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      bjzx localbjzx = (bjzx)localIterator.next();
      Object localObject2 = a(a(localbjzx.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localbjzx.u, (int)localbjzx.v);
      }
      Object localObject1 = localObject2;
      if (localbjzx.h == 3)
      {
        localObject1 = localObject2;
        if (localbjzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localObject1 = localObject2;
          if (!(localbjzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bkhg)) {}
        }
      }
      for (;;)
      {
        try
        {
          localObject1 = (bkhg)localbjzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((bkhg)localObject1).a());
        }
        catch (Exception localException2)
        {
          try
          {
            ...
            paramCanvas.save();
            paramCanvas.concat(this.jdField_a_of_type_Bkhv.a(localbjzx));
            paramCanvas.save();
            paramCanvas.translate(-localbjzx.u / 2.0F, -localbjzx.v / 2.0F);
