...
public class lsv
  implements mnt
{
  private static volatile lsv jdField_a_of_type_Lsv;
  public int a;
  ...
  private lsw jdField_a_of_type_Lsw;
  private lsx jdField_a_of_type_Lsx = new lsx(this);
  ...
  public static lsv a()
  {
    if (jdField_a_of_type_Lsv == null) {}
    try
    {
      if (jdField_a_of_type_Lsv == null) {
        jdField_a_of_type_Lsv = new lsv();
      }
      return jdField_a_of_type_Lsv;
    }
    finally {}
  }
  ...
  {
    return lzn.a(lzg.a().a()) == 1;
  }
  
  private boolean d()
  {
    VoiceRecognizer.shareInstance().setListener(this.jdField_a_of_type_Lsx);
    ...
    DownloadInfo localDownloadInfo = lzg.a().a();
    if (localDownloadInfo == null)
    {
      QLog.i("AVVoiceRecog", 1, "initRecognizer. init failed. downloadInfo == null.");
      return false;
    }
    String str1 = lzn.b() + localDownloadInfo.filename_so_wxvoiceembedqqegg;
    String str2 = lzn.a() + localDownloadInfo.filename_model_wxvoiceembed;
    if (!lzg.a().a())
    {
      lzg.a().b();
  ...
  public void a(VideoAppInterface paramVideoAppInterface, lsw paramlsw)
  {
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    this.jdField_a_of_type_Lsw = paramlsw;
  }
  ...
  public boolean c()
  {
    ...
    if (!b())
    {
      ...
      String str = lzn.b() + ((DownloadInfo)localObject).filename_so_wxvoiceembedqqegg;
      localObject = lzn.a() + ((DownloadInfo)localObject).filename_model_wxvoiceembed;
      if (!lzg.a().a())
      {
        lzg.a().b();
