...
public class bboj
  implements afsn
{
  private bbol jdField_a_of_type_Bbol;
  private Long jdField_a_of_type_JavaLangLong;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentHashMap<Long, bbok> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentLinkedQueue<Long> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  
  public bboj(String paramString)
  {
  ...
  private FileMsg a()
  {
    if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty())
    {
      ...
      {
        bbok localbbok = (bbok)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(this.jdField_a_of_type_JavaLangLong);
        if (localbbok != null) {
          return localbbok.a();
        }
      }
  ...
  private void a(FileMsg paramFileMsg)
  {
    ...
    {
      Object localObject = (bbok)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramFileMsg.uniseq));
      if (localObject == null) {
        break label150;
      }
      View localView = ((bbok)localObject).a();
      localObject = ((bbok)localObject).a();
      if ((localView != null) && (localObject != null))
      {
        ...
        ((afsn)localObject).a(localView, paramFileMsg, paramFileMsg.status, paramFileMsg.errorCode);
      }
    }
    else
    {
  ...
  private void a(FileMsg paramFileMsg, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (bbok)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramFileMsg.uniseq));
      } while (localObject == null);
      ((bbok)localObject).a(paramFileMsg);
  ...
  private boolean a(long paramLong, int paramInt)
  {
    ...
    if (bbnz.b(paramInt))
    {
      ...
      if (this.jdField_a_of_type_Bbol != null) {
        this.jdField_a_of_type_Bbol.a(paramLong, paramInt);
      }
      boolean bool2 = true;
      bool1 = bool2;
      if (QLog.isColorLevel())
  ...
  private void c(long paramLong)
  {
    ...
    {
      localObject = (bbok)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
      if (localObject != null)
      {
        localView = ((bbok)localObject).a();
        localafsn = ((bbok)localObject).a();
        localObject = ((bbok)localObject).a();
        if ((localView != null) && (localafsn != null) && (localObject != null))
        {
          if (QLog.isColorLevel())
          {
          ...
          ThreadManager.getUIHandler().post(new OrderMediaMsgStatusCallback.1(this, localafsn, localView, (FileMsg)localObject));
        }
      }
    }
    while (!QLog.isColorLevel())
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bbol = null;
  }
  ...
  {
    this.jdField_a_of_type_Bbol = parambbol;
  }
  
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, View paramView, afsn paramafsn)
  {
    ...
    Object localObject = afsl.a(paramQQAppInterface);
    if (localObject != null) {
    ...
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(paramLong), new bbok(this, paramView, paramafsn));
      if (QLog.isColorLevel()) {
      ...
      if (paramQQAppInterface == null)
      {
        ...
        this.jdField_a_of_type_Bbol.a(paramLong);
        i = -1;
    ...
    label520:
    for (paramQQAppInterface = "";; paramQQAppInterface = paramafsn.toString())
    {
      ...
      if ((paramQQAppInterface instanceof BaseTransProcessor))
      {
        ...
        if (!a(paramLong, i))
        {
          ...
          if ((paramLong != 0L) && (this.jdField_a_of_type_JavaLangLong != null) && (paramLong != this.jdField_a_of_type_JavaLangLong.longValue()))
          {
            if (paramafsn != null)
            {
              paramafsn.a(paramView, paramQQAppInterface.getFileMsg(), i, paramQQAppInterface.errCode);
              localObject = (bbok)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
              if (localObject != null) {
                ((bbok)localObject).a(paramQQAppInterface.getFileMsg());
              }
            }
            if (QLog.isColorLevel())
            {
        ...
        break;
        paramQQAppInterface = (bbok)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
        paramQQAppInterface.a = new WeakReference(paramView);
        paramQQAppInterface.b = new WeakReference(paramafsn);
      }
      label505:
      i = -1;
      break;
