  ...
  extends Drawable
{
  ...
  public bqqu(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_Bqqi = new bqqi();
  ...
  public Bitmap a()
  {
    return a(this.jdField_a_of_type_Bqqi.a());
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofObject(this.jdField_a_of_type_Bqqi, new Object[] { this.jdField_a_of_type_Bqqi.b(), this.jdField_a_of_type_Bqqi.a() });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setInterpolator(new DecelerateInterpolator());
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bqqv(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bqqw(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setDuration(this.jdField_a_of_type_Bqqi.a());
