...
public class bpcv
  extends bpen
  implements bozw, bplg, bplh, IEventReceiver
{
  ...
  private ViewTreeObserver.OnGlobalLayoutListener jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bpdc(this);
  bpde jdField_a_of_type_Bpde;
  bpdf jdField_a_of_type_Bpdf;
  bpdg jdField_a_of_type_Bpdg;
  private bpfb jdField_a_of_type_Bpfb = new bpcw(this);
  public bpjl a;
  bqfy jdField_a_of_type_Bqfy = new bpcy(this);
  ...
  public bpcv(@NonNull bpep parambpep, long paramLong)
  {
    super(parambpep);
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_JavaLangRunnable = new EditVideoDoodle.7(this);
    this.jdField_a_of_type_Bpjl = new bpdd(this);
  ...
  private void j()
  {
    ...
    if ((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d()) && (this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Bpep.a() != null) && (!this.jdField_a_of_type_Bpep.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      ...
      f = j / i;
      if (!this.jdField_a_of_type_Bpep.a().getTakePicToVideo()) {
  ...
  public JobSegment<bpsf, bpsf> a(int paramInt)
  {
    if (((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))) {
      return (JobSegment)wjz.a(bpsq.class, new Object[] { this, (bozx)a(bozx.class), Integer.valueOf(paramInt) });
    }
    return (JobSegment)wjz.a(bpsg.class, new Object[] { this, (bozx)a(bozx.class), Integer.valueOf(paramInt) });
  }
  ...
  public void a()
  {
    ...
    PtvTemplateManager.a(localAppInterface).a(localAppInterface, this.jdField_a_of_type_Bqfy, false);
  ...
  {
    this.jdField_a_of_type_Bpep.a(false, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
  }
  
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    a().a(anni.a(2131702562), true, 0L, new bpcx(this));
    this.jdField_a_of_type_Bpep.a(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle != null))
    {
      Bundle localBundle = this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bphm.jdField_a_of_type_JavaLangString);
      if (localBundle != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(localBundle);
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bpic.jdField_a_of_type_JavaLangString));
      }
    }
  }
  ...
  public void a(int paramInt, @NonNull bpsf parambpsf)
  {
    ...
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoDoodleDescription = a().a(paramInt);
    this.jdField_a_of_type_Bpep.a().setWordId(a().b());
    this.jdField_a_of_type_Bpep.a().setStickerId(a().c());
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("all_doodle_text", a().a());
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicMask = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(paramInt);
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicSize = 16;
    if (a().b(paramInt).size() > 0)
    {
      localObject1 = (boom)bojv.a(4);
      parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription = ((boom)localObject1).a();
    }
    label280:
    label337:
    int i;
    ...
    if (this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d())
    {
      ...
      {
        parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalVideoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
        parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalVideoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      }
    }
    else
    {
      if (a().b(paramInt))
      {
        ...
        localObject1 = "2";
        ((bpep)localObject2).a("change_graffiti", 0, 0, new String[] { localObject1 });
        yqv.a("0X80076C0");
      }
      if (a().a(paramInt))
      {
        ...
        localObject1 = "2";
        ((bpep)localObject2).a("change_color", 0, 0, new String[] { localObject1 });
        yqv.a("0X80076C4");
      }
      ...
      if ((localObject2 != null) && (localObject2.length == 2))
      {
        ...
        localObject3 = this.jdField_a_of_type_Bpep;
        j = this.jdField_a_of_type_Bpep.b();
        if (!this.jdField_a_of_type_Bpep.a()) {
          break label980;
        }
        localObject1 = "2";
        label455:
        ((bpep)localObject3).b("pub_graffiti", j, 0, new String[] { "1", "", localObject1 });
        yqv.a("0X80076E0", yqv.b);
        yqv.b("0X80075EA", yqv.jdField_a_of_type_Int);
        parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        parambpsf.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasGraffiti = true;
        label527:
        if (localObject2[1] <= 0) {
          break label1019;
        }
        ...
        localObject1 = "2";
        label564:
        ((bpep)localObject3).b("pub_mosaics", j, 0, new String[] { "1", "", localObject1 });
        yqv.a("0X80076E1");
        yqv.b("0X80075EB");
        parambpsf.jdField_b_of_type_Boolean = true;
        if (localObject2[0] == 0) {
          parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        }
      }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalPhotoSource))
      {
        parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
        parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
        break;
      }
      ...
      parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalGifSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
      parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalGifSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      break;
      label959:
      localObject1 = "1";
      break label280;
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((StringBuilder)localObject4).append(((bphq)((Iterator)localObject1).next()).e).append(',');
      }
    ...
    if (localObject2[0] > 0)
    {
      localObject5 = this.jdField_a_of_type_Bpep;
      j = this.jdField_a_of_type_Bpep.b();
      ...
      {
        localObject1 = "2";
        ((bpep)localObject5).b("pub_face", j, 0, new String[] { String.valueOf(k), localObject6, localObject1 });
        yqv.a("0X80076E3", yqv.b);
        yqv.b("0X80075ED", yqv.jdField_a_of_type_Int);
        parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
        parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject3).toString();
        label1285:
        if (localObject2[1] <= 0) {
          break label1698;
        }
        this.jdField_a_of_type_Bpep.b("pub_poi", this.jdField_a_of_type_Bpep.b(), 0, new String[] { String.valueOf(localObject2[1]), ((StringBuilder)localObject4).toString() });
        yqv.a("0X80076E4");
        yqv.b("0X80075EE");
        if (localObject2[0] <= 0) {
          break label1669;
        }
        parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = (parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 + "," + ((StringBuilder)localObject4).toString());
        label1392:
        localObject2 = a().a(paramInt);
        ...
        localObject3 = this.jdField_a_of_type_Bpep;
        i = this.jdField_a_of_type_Bpep.b();
        if (!this.jdField_a_of_type_Bpep.a()) {
          break label1724;
        }
        localObject1 = "2";
        label1447:
        ((bpep)localObject3).b("pub_text", i, 0, new String[] { "1", localObject2, localObject1 });
        yqv.a("0X80076E2", yqv.b);
        yqv.b("0X80075EC", yqv.jdField_a_of_type_Int);
        parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("3");
        parambpsf.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasText = true;
      }
    }
    for (;;)
    {
      ...
      label1669:
      parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
      parambpsf.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject4).toString();
      break label1392;
      label1698:
      if ((i == 0) || (!bpsl.a(3))) {
        break label1392;
    ...
    this.jdField_a_of_type_Bpep.b("person_gra", this.jdField_a_of_type_Bpep.b(), 0, new String[] { localObject1 });
    label1782:
    Object localObject2 = bojl.a().getCurrentAccountUin();
    if (bpnc.jdField_b_of_type_Boolean) {}
    for (Object localObject1 = parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription;; localObject1 = "")
    {
      ...
      parambpsf.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasFace = true;
      return;
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (localbpez != null) {
      localbpez.a(paramBitmap, paramBoolean);
    }
  }
  
  public void a(Animation paramAnimation)
  {
    this.jdField_a_of_type_Bpep.a(paramAnimation);
  }
  ...
  public void a(bpnj parambpnj)
  {
    ...
    boolean bool = this.jdField_a_of_type_Bpep.b(6);
    if (this.jdField_a_of_type_Bpep.a())
    {
      parambpnj = "2";
      if (!bool) {
    ...
    {
      yqu.a("video_edit", "add_place", 0, 0, new String[] { parambpnj, "", str, "" });
      return;
      parambpnj = "1";
      break;
    }
  ...
  {
    if (!this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())
    {
      this.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      VideoSourceHelper.nativeSetMosaic(16, this.jdField_a_of_type_ArrayOfByte);
      bpez localbpez = (bpez)a(bpez.class);
      if (localbpez != null) {
        localbpez.a(16, paramArrayOfByte);
      }
    }
  }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    case 6: 
      a(0);
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(this.jdField_a_of_type_Bpep.a());
      switch (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.c())
      {
      }
      for (;;)
  ...
  public Bitmap b()
  {
    return this.jdField_a_of_type_Bpep.a();
  }
  ...
  public void b(int paramInt, Object paramObject)
  {
    ...
    case 0: 
    case 7: 
      if ((this.jdField_a_of_type_Bpep.a(13)) || (this.jdField_a_of_type_Bpep.a(14)) || (this.jdField_a_of_type_Bpep.a(15)) || (this.jdField_a_of_type_Bpep.a(16)))
      {
      ...
      {
        this.jdField_a_of_type_Bpep.a(36);
        return;
      }
      this.jdField_a_of_type_Bpep.a(0);
      return;
    case 2: 
      this.jdField_a_of_type_Bpep.a(7, paramObject);
      return;
    case 3: 
      this.jdField_a_of_type_Bpep.a(5, paramObject);
      return;
    case 4: 
      this.jdField_a_of_type_Bpep.a(9);
      return;
    case 5: 
      this.jdField_a_of_type_Bpep.a(8, paramObject);
      return;
    }
    this.jdField_a_of_type_Bpep.a(8);
  }
  
  public void b(Animation paramAnimation)
  {
    this.jdField_a_of_type_Bpep.b(paramAnimation);
  }
  ...
  public void b(String paramString)
  {
    ...
    {
      localbpep.a("exp_editpoi", 0, 0, new String[] { str });
      yqv.a("0X80076CF");
      yqv.b("0X80075E4");
      paramString = new bpdi(this.jdField_a_of_type_Bpfb, paramString);
      this.jdField_a_of_type_Bpep.a(3, paramString);
      return;
    }
  }
  ...
  public void d()
  {
    ...
    label740:
    for (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewViewStub.inflate());; this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)a(2131365633)))
    {
      if (this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f == bnqb.c.a()) {
      ...
      if (!bpep.a(this.jdField_a_of_type_Long, 1)) {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setMosaicStandardSize(this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setEditVideoParams(this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
      ...
      {
        if (this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bphm.jdField_a_of_type_JavaLangString) != null) {
          this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bphm.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Bpep.a());
        }
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bphm.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          if (this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bpic.jdField_a_of_type_JavaLangString) != null) {
            this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bpic.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Bpep.a());
          }
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle(bpic.jdField_a_of_type_JavaLangString));
        }
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          localObject1 = this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidOsBundle.getBundle("VoteLayer");
          if (localObject1 != null)
          {
            localObject1 = (InteractPasterParcelData)((Bundle)localObject1).getParcelable("vote_paster");
            localObject2 = (bpab)this.jdField_a_of_type_Bpep.a(bpab.class);
            if (localObject2 != null) {
              ((bpab)localObject2).a((InteractPasterParcelData)localObject1);
            }
          }
        }
      }
      bosj.a().a(this.jdField_a_of_type_Bpep.h(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      if (localObject1 != null)
      {
        ...
        ((DoodleEditView)localObject1).a(bpep.a(this.jdField_a_of_type_Long, 134217728));
      }
      if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer == null)
      {
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = this.jdField_a_of_type_Bpep.jdField_a_of_type_Bpaz.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer;
        if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null) {
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setLiuHaiParentView(this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        if ((localObject1 != null) && (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null))
        {
          int i = 0;
          if ((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)) {
            i = ((EditLocalVideoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_Int;
          }
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setVideoSegmentPickerListener(new bpcz(this, i));
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setStickerListener(((DoodleEditView)localObject1).a());
          ((DoodleEditView)localObject1).setDoodleEditViewListener(new bpda(this));
        }
        a(2131365808).setOnTouchListener(new bpdb(this));
      }
      localObject1 = wfo.a();
      Object localObject2 = new bpdf(this);
      this.jdField_a_of_type_Bpdf = ((bpdf)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = wfo.a();
      localObject2 = new bpde(this);
      this.jdField_a_of_type_Bpde = ((bpde)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = wfo.a();
      localObject2 = new bpdg(this);
      this.jdField_a_of_type_Bpdg = ((bpdg)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      return;
    }
  }
  ...
  {
    this.c = true;
    if (this.jdField_a_of_type_Bpdf != null) {
      wfo.a().unRegisterSubscriber(this.jdField_a_of_type_Bpdf);
    }
    if (this.jdField_a_of_type_Bpde != null) {
      wfo.a().unRegisterSubscriber(this.jdField_a_of_type_Bpde);
    }
    if (this.jdField_a_of_type_Bpdg != null) {
      wfo.a().unRegisterSubscriber(this.jdField_a_of_type_Bpdg);
    }
    ...
    bosj.a().a(this.jdField_a_of_type_Bpep.h());
  }
  
  public boolean l_()
  {
    if (System.currentTimeMillis() < this.jdField_d_of_type_Long) {}
    while ((!bpep.a(this.jdField_a_of_type_Long, 1)) || (!TextUtils.isEmpty(a().a(this.jdField_a_of_type_Bpep.a())))) {
      return false;
    }
    if (this.jdField_a_of_type_Bpep.jdField_a_of_type_Int == 28) {
      this.jdField_a_of_type_Bpep.a(0);
    }
    return true;
  }
  ...
  public void q()
  {
    this.jdField_a_of_type_Bpep.g();
  }
  
  public void r()
  {
    this.jdField_a_of_type_Bpfx.a().postDelayed(new EditVideoDoodle.9(this), 200L);
  }
  ...
  public void t()
  {
    this.jdField_a_of_type_Bpep.a(true, 0.0F, 0.0F, 0.0F, 0.0F);
  }
}
