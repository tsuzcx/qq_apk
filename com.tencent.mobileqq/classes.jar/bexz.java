...
public class bexz
{
  ...
  public static HashMap<String, beya> a;
  ...
  static
  {
    ...
    jdField_a_of_type_Boolean = bepk.a().a();
  ...
  {
    return belj.a("MiniGame", "MiniShowTimeout", 45000L);
  }
  
  private static beya a(String paramString1, String paramString2, String paramString3, MiniAppInfo paramMiniAppInfo)
  {
    if ((paramMiniAppInfo == null) || (TextUtils.isEmpty(paramMiniAppInfo.appId)))
    {
      besl.a("MiniAppReportManager2", "new report (appId is null)");
      paramString1 = null;
      return paramString1;
    }
    ...
    beya localbeya = (beya)jdField_a_of_type_JavaUtilHashMap.get(paramMiniAppInfo.appId);
    paramString3 = localbeya;
    if (localbeya == null)
    {
      paramString3 = new beya();
    ...
    for (;;)
    {
      ...
      paramString3.jdField_c_of_type_Boolean = besm.a(paramMiniAppInfo);
      ...
      besl.a("MiniAppReportManager2", "launchState: launchId = [" + paramString3.jdField_b_of_type_JavaLangString + "], launchResult = [" + paramString3.jdField_d_of_type_Int + "], clickTime = [" + paramString3.jdField_a_of_type_Long + "], launchTime = [" + paramString3.jdField_c_of_type_Long + "], showTime = [" + paramString3.e + "], hideTime = [" + paramString3.f + "]");
      return paramString3;
      label516:
      paramString3.jdField_b_of_type_JavaLangString = String.valueOf(l);
    }
  ...
  {
    besl.a("MiniAppReportManager2", "onEnterBackground");
    try
    {
      beyo.a().a().post(new MiniAppReportManager2.3());
      return;
    }
    catch (Throwable localThrowable)
    {
      besl.d("MiniAppReportManager2", "onEnterBackground exception", localThrowable);
    }
  }
  ...
  public static void a(int paramInt, String paramString, MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (localbeya != null)
    {
      if (!localbeya.jdField_d_of_type_Boolean) {
        break label96;
      }
      paramString = "" + "flutter";
    }
    ...
    {
      str = paramString;
      if (localbeya.jdField_c_of_type_Boolean) {
        str = paramString + "_hasPkg";
      }
      beyr.a(paramMiniAppInfo, paramInt, str, "0");
      return;
      label96:
      if (beya.jdField_b_of_type_Boolean) {
  ...
  public static void a(String paramString1, String paramString2, String paramString3, MiniAppInfo paramMiniAppInfo)
  {
      ...
      do
      {
        for (;;)
        {
          try
          {
            ...
            beyo.a().a().post(new MiniAppReportManager2.1(paramMiniAppInfo, paramString1, paramString3, paramString2));
            if ((paramMiniAppInfo == null) || (TextUtils.isEmpty(paramMiniAppInfo.appId))) {
              break label410;
            }
            ...
            if (paramMiniAppInfo.isReportTypeMiniGame())
            {
              paramString2 = "1";
              str2 = beyb.a(str1);
              String str3 = beyb.c(str1);
              if (!paramMiniAppInfo.isReportTypeMiniGame()) {
                break label195;
              }
              localObject = beyb.e(str1);
              beyr.a(paramMiniAppInfo, 2, paramString3, null, null, i, paramString2, 0L, null, str2, str3, (String)localObject, beyb.d(str1));
              if (!"2unload".equals(paramString1)) {
                break label418;
              }
              beyb.b(paramMiniAppInfo.appId);
              return;
            }
          }
          catch (Throwable paramString1)
          {
            besl.d("MiniAppReportManager2", "", paramString1);
            return;
          }
          paramString2 = "0";
          continue;
          localObject = beyb.b(str1);
        }
        if (("2launch".equals(paramString1)) && ("first_frame".equals(paramString2)))
        {
          ...
          paramString2 = "1";
          localObject = beyb.a(str1);
          str2 = beyb.c(str1);
          if (paramMiniAppInfo.isReportTypeMiniGame()) {}
          for (str1 = beyb.e(str1);; str1 = beyb.b(str1))
          {
            beyr.a(paramMiniAppInfo, 2, paramString3, null, null, 0, paramString2, 0L, null, (String)localObject, str2, str1, "cold_start");
            break;
          }
        }
    ...
    for (paramString2 = "1";; paramString2 = "0")
    {
      ...
      for (str1 = beyb.e(str1);; str1 = beyb.b(str1))
      {
        beyr.a(paramMiniAppInfo, 2, paramString3, null, null, 0, paramString2, 0L, null, (String)localObject, str2, str1, "hot_start");
        break;
      }
      label410:
      str1 = "";
  ...
  private static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (besl.b()) {
      besl.a("MiniAppReportManager2", "reportPageViewInMainProcess  new report called with: [launchId = " + paramString3 + "], [subActionType = " + paramString2 + "], [appType = " + str1 + "], [reserves = " + paramString5 + "], [reserves2 = " + paramString6 + "], [reserves3 = " + paramString7 + "], [path =" + paramString4 + "]");
    }
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(beyn.b());
    String str2 = bekj.a(paramString4);
    if ((paramMiniAppInfo != null) && (paramMiniAppInfo.launchParam != null))
    {
      ...
      localArrayList.addAll(beyn.a(paramMiniAppInfo, str2, paramString4, paramString1, paramString2, paramString5, paramString6, paramString7, null, null, str1, paramString3));
      ...
      if ((a(paramString2, paramMiniAppInfo)) && (paramMiniAppInfo != null) && (paramMiniAppInfo.launchParam != null) && (paramMiniAppInfo.launchParam.jdField_a_of_type_JavaUtilMap != null) && (paramMiniAppInfo.launchParam.jdField_a_of_type_JavaUtilMap.size() > 0)) {
        localArrayList.addAll(beyn.a(paramMiniAppInfo.launchParam.jdField_a_of_type_JavaUtilMap));
      }
      if (!bfgt.a()) {
        break label367;
      }
    ...
    for (int i = 2;; i = 12)
    {
      ...
      beyo.a().b(paramString1);
      if ((belj.a("MiniApp", "mini_app_report_first_frame_flush", 1) == 1) && ("2show".equals(paramString2)) && (("first_frame".equals(paramString5)) || ("click_resume".equals(paramString5)))) {
        beyo.a().a(true);
      }
      return;
      paramString4 = null;
  ...
  private static void b(beya parambeya)
  {
    parambeya.jdField_d_of_type_Int = 2;
    long l = parambeya.f - parambeya.jdField_a_of_type_Long;
    if (l <= 0L) {
      l = parambeya.jdField_a_of_type_Long - System.currentTimeMillis();
    }
    for (;;)
    {
      String str2 = a(l);
      MiniAppInfo localMiniAppInfo;
      if (parambeya.jdField_a_of_type_Boolean)
      {
        localMiniAppInfo = new MiniAppInfo();
        localMiniAppInfo.appId = parambeya.jdField_a_of_type_JavaLangString;
      }
      try
      {
        localMiniAppInfo.verType = parambeya.jdField_c_of_type_Int;
        localMiniAppInfo.setEngineType(parambeya.jdField_a_of_type_Int);
        localMiniAppInfo.setReportType(parambeya.jdField_b_of_type_Int);
        label88:
        if (parambeya.jdField_b_of_type_Long == 0L) {}
        for (String str1 = "2load_fail";; str1 = "2show_fail")
        {
          a("page_view", str1, parambeya.jdField_b_of_type_JavaLangString, null, str2, String.valueOf(l), parambeya.b(), localMiniAppInfo);
          parambeya.jdField_a_of_type_Boolean = false;
          parambeya.jdField_d_of_type_Int = 2;
          d();
          return;
        }
  ...
  {
    beya localbeya = a(paramString1, paramString2, paramString3, paramMiniAppInfo);
    if (localbeya == null) {
      besl.a("MiniAppReportManager2", "new report (launchState is not exist): [subActionType = " + paramString1 + "], [reserves = " + paramString2 + "], [path = " + paramString3 + "]");
    }
    long l1;
    long l4;
    long l5;
    ...
    do
    {
      do
      {
        return;
        if (besl.b()) {
          besl.a("MiniAppReportManager2", "reportPageViewInMainProcess called with: launchId = [" + localbeya.jdField_b_of_type_JavaLangString + "], subActionType = [" + paramString1 + "], reserves = [" + paramString2 + "], path = [" + paramString3 + "]");
        }
        l1 = localbeya.jdField_c_of_type_Long - localbeya.jdField_a_of_type_Long;
        long l2 = localbeya.f;
        long l3 = localbeya.e;
        l4 = localbeya.jdField_b_of_type_Long;
        l5 = localbeya.jdField_a_of_type_Long;
        l6 = localbeya.g;
        l7 = localbeya.jdField_a_of_type_Long;
        if (("2back_key".equals(paramString1)) && (localbeya.jdField_a_of_type_Boolean))
        {
          a("page_view", "2show_fail", localbeya.jdField_b_of_type_JavaLangString, null, "back_cancel", String.valueOf(l1), localbeya.b(), paramMiniAppInfo);
          localbeya.jdField_a_of_type_Boolean = false;
        }
        if (("2close".equals(paramString1)) && (localbeya.jdField_a_of_type_Boolean))
        {
          a("page_view", "2show_fail", localbeya.jdField_b_of_type_JavaLangString, null, "close_cancel", String.valueOf(l1), localbeya.b(), paramMiniAppInfo);
          localbeya.jdField_a_of_type_Boolean = false;
        }
        if ("2hide".equals(paramString1))
        {
          if (localbeya.jdField_a_of_type_Boolean)
          {
            a("page_view", "2show_fail", localbeya.jdField_b_of_type_JavaLangString, null, "home_cancel", String.valueOf(l1), localbeya.b(), paramMiniAppInfo);
            localbeya.jdField_a_of_type_Boolean = false;
          }
          a("page_view", paramString1, localbeya.jdField_b_of_type_JavaLangString, paramString3, paramString2, String.valueOf(l2 - l3), null, paramMiniAppInfo);
          return;
        }
        if (!"2launch_fail".equals(paramString1)) {
          break;
        }
      } while (!localbeya.jdField_a_of_type_Boolean);
      a("page_view", "2show_fail", localbeya.jdField_b_of_type_JavaLangString, null, paramString2, String.valueOf(l1), localbeya.b(), paramMiniAppInfo);
      localbeya.jdField_a_of_type_Boolean = false;
      return;
      ...
      if (localbeya.jdField_a_of_type_Boolean)
      {
        a("page_view", "2show", localbeya.jdField_b_of_type_JavaLangString, paramString3, paramString2, String.valueOf(l1), localbeya.b(), paramMiniAppInfo);
        localbeya.jdField_a_of_type_Boolean = false;
      }
    } while (!"first_frame".equals(paramString2));
    a("page_view", "2show", localbeya.jdField_b_of_type_JavaLangString, paramString3, "first_frame_extend", String.valueOf(l1), localbeya.b(), paramMiniAppInfo);
    return;
    if ("2load".equals(paramString1))
    {
      a("page_view", paramString1, localbeya.jdField_b_of_type_JavaLangString, paramString3, paramString2, String.valueOf(l4 - l5), localbeya.b(), paramMiniAppInfo);
      return;
    }
    if ("2load_end".equals(paramString1))
    {
      a("page_view", paramString1, localbeya.jdField_b_of_type_JavaLangString, paramString3, paramString2, String.valueOf(l6 - l7), localbeya.b(), paramMiniAppInfo);
      return;
    }
    a("page_view", paramString1, localbeya.jdField_b_of_type_JavaLangString, paramString3, paramString2, null, localbeya.b(), paramMiniAppInfo);
  }
    ...
    if (localObject != null)
    {
      ...
      while (i < j)
      {
        ...
        if (!TextUtils.isEmpty(localCharSequence))
        {
          ...
          if (str != null)
          {
            beya localbeya = new beya();
            localbeya.a(str);
            if (!TextUtils.isEmpty(localbeya.jdField_a_of_type_JavaLangString)) {
              jdField_a_of_type_JavaUtilHashMap.put(localCharSequence, localbeya);
            }
          }
        }
        i += 1;
  ...
  private static void d()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((beya)localObject).jdField_d_of_type_Int == 0)
      {
        ...
        localEditor.putString(str, ((beya)localObject).a());
      }
    }
