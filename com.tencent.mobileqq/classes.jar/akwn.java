...
public class akwn
  implements akxo
{
  public static List<akwn> a;
  private int jdField_a_of_type_Int;
  private akwu jdField_a_of_type_Akwu;
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new akwt(this);
  ...
  public akwn(int paramInt1, int paramInt2, String arg3)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    akyg localakyg = akwd.a(paramInt2);
    if (localakyg != null) {
      localakyg.b(0);
    }
    if ("effect".equals(???)) {
      if (localakyg != null) {
        this.jdField_a_of_type_Akwu = new akwu(paramInt2);
      }
    }
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        a(1);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new akwo(this));
      }
    }
  }
  
  private void a(akxn paramakxn, JSONObject paramJSONObject)
  {
    if (paramakxn != null) {
  ...
  public JSONObject a(int paramInt, JSONObject paramJSONObject, akxn paramakxn)
  {
    int i;
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new akwp(this, paramJSONObject, paramakxn));
  ...
  public JSONObject a(akxn paramakxn, JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        if (paramJSONObject.optInt("N_R_OBJ") == this.jdField_a_of_type_Int)
        {
          ...
          if ("cs.audio_play.local".equals(str)) {
            return b(paramJSONObject, paramakxn);
          }
          ...
          if ("cs.audio_load.local".equals(str)) {
            return c(paramJSONObject, paramakxn);
          }
          ...
          if ("cs.audio_seek.local".equals(str)) {
            return a(paramJSONObject.optInt("seek"), paramJSONObject, paramakxn);
          }
          if ("cs.audio_src.local".equals(str)) {
            return a(paramJSONObject.optString("src"), paramJSONObject, paramakxn);
          }
          ...
          if ("cs.audio_destroy.local".equals(str)) {
            return b(paramakxn, paramJSONObject);
          }
          if ("cs.audio_onend.local".equals(str)) {
            return e(paramJSONObject, paramakxn);
          }
          ...
          {
            paramakxn = a(paramJSONObject, paramakxn);
            return paramakxn;
          }
        }
      }
      ...
      {
        QLog.e("CmGameAudioPlayer", 1, "audio failed", paramakxn);
      }
    }
    return null;
  }
  
  public JSONObject a(String paramString, JSONObject paramJSONObject, akxn paramakxn)
  {
      ...
      try
      {
        ...
        if (localakyg != null)
        {
          ...
          for (;;)
          {
            ...
            a(2);
            return paramJSONObject;
            paramString = akuf.a(paramString, localakyg.a(), str1, false);
          }
        }
  ...
  public JSONObject a(JSONObject paramJSONObject, akxn paramakxn)
  {
    try
    {
      if (paramJSONObject.has("src")) {
        a(paramJSONObject.optString("src"), paramJSONObject, paramakxn);
      }
      ...
      if (paramJSONObject.has("currentTime")) {
        d(paramJSONObject, paramakxn);
      }
      return paramJSONObject;
    }
    catch (Throwable paramakxn)
    {
      QLog.e("CmGameAudioPlayer", 1, paramakxn, new Object[0]);
    }
    return paramJSONObject;
  }
  ...
  public JSONObject a(boolean paramBoolean, float paramFloat1, float paramFloat2, JSONObject paramJSONObject)
  {
    ...
    Object localObject = this.jdField_a_of_type_Akwu;
    if ((paramBoolean) || ((Float.compare(paramFloat1, 0.0F) == 0) && (Float.compare(paramFloat2, 0.0F) == 0))) {}
    for (int i = 0;; i = 1)
    {
      ((akwu)localObject).a(i, BaseActivity.sTopActivity.getAppInterface());
      return paramJSONObject;
    }
  }
  ...
  public JSONObject b(akxn arg1, JSONObject paramJSONObject)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
  ...
  public JSONObject b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      if (paramJSONObject.optBoolean("auto", true)) {
        ...
        this.jdField_a_of_type_Akwu.a(i, null);
      }
    }
  }
  
  public JSONObject b(JSONObject paramJSONObject, akxn paramakxn)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      i = a();
    ...
    while (this.jdField_a_of_type_Akwu == null) {
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new akwq(this));
        }
    ...
    a(true);
    return this.jdField_a_of_type_Akwu.a(paramakxn, paramJSONObject);
  }
  ...
  public JSONObject c(JSONObject paramJSONObject, akxn paramakxn)
  {
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && ((a() == 2) || (a() == 6)))
    {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new akwr(this, paramJSONObject, paramakxn));
  ...
  public JSONObject d(JSONObject paramJSONObject, akxn paramakxn)
  {
    int i;
  ...
  public JSONObject e(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Akwu != null)
    {
      this.jdField_a_of_type_Akwu.c(paramJSONObject.optInt("id"), null);
      this.jdField_a_of_type_Akwu.a(paramJSONObject);
    }
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
  ...
  public JSONObject e(JSONObject paramJSONObject, akxn paramakxn)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new akws(this, paramakxn, paramJSONObject));
    }
    return null;
  }
  ...
  public JSONObject f(JSONObject paramJSONObject)
  {
    ...
    this.jdField_a_of_type_Akwu.b(paramJSONObject.optInt("id"), null);
    return paramJSONObject;
  }
}
