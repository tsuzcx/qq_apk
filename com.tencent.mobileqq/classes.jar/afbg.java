...
public class afbg
  implements blbt
{
  public afbg(TroopAssisSettingActivity paramTroopAssisSettingActivity) {}
  
  public boolean a(ExpandableListView paramExpandableListView, View paramView, int paramInt1, int paramInt2, long paramLong)
  {
    if (((amkj)paramExpandableListView.a()).getChildType(paramInt1, paramInt2) == 1) {
      return true;
    }
    bdls.b(this.a.getActivity(), this.a.app.getCurrentAccountUin());
