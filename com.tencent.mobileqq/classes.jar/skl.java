  ...
  extends skj
{
  ...
  public skl(PublishVideoEntry paramPublishVideoEntry)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Srv = a().getLinkInfo();
  ...
  public skl(StoryVideoItem paramStoryVideoItem)
  {
    ...
    this.jdField_a_of_type_Srv = srv.a(paramStoryVideoItem.mLinkInfoJson);
    this.n = paramStoryVideoItem.originalAuthorUnionId;
    this.o = paramStoryVideoItem.originalAuthorName;
  }
  
  public skl(String paramString)
  {
    this.p = paramString;
    vkw.a(paramString);
  }
  ...
  private int a()
  {
    ...
    if ((arrayOfByte != null) && (arrayOfByte.length > 0))
    {
      ...
      try
      {
        ...
        int i1 = new sfx(localAppInterface, localVideoReaderConf).jdField_a_of_type_Int;
        return i1;
      }
  ...
  private vil a()
  {
    ...
    if ((localObject != null) && (localObject.length > 0))
    {
      ...
      try
      {
        ...
        localObject = new vil(localTagInfoBase);
        return localObject;
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
  ...
  public StoryVideoItem a()
  {
    ...
    if (TextUtils.isEmpty(localStoryVideoItem.mPublishDate)) {
      localStoryVideoItem.mPublishDate = uje.a().format(new Date(this.jdField_d_of_type_Long));
    }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      if (this.jdField_a_of_type_Srv != null) {
        localStoryVideoItem.mLinkInfoJson = this.jdField_a_of_type_Srv.a(false);
      }
      localStoryVideoItem.mGameInfoJson = a().getStringExtra("game", null);
      localStoryVideoItem.mGameInfo = srt.a(localStoryVideoItem.mGameInfoJson);
  ...
  public GeneralFeedItem a()
  {
    ...
    String str2 = localuje.a(QQStoryContext.a().b(), str3);
    urk.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "find true feedId:%s", str2);
    String str1 = str2;
    if (TextUtils.isEmpty(str2))
    {
      str1 = VideoListFeedItem.makeFakeFeedId(QQStoryContext.a().b(), str3);
      urk.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "make fake feedId:%s", str1);
    }
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = ((GeneralFeedItem)localuje.a(str1));
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem == null)
    {
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = GeneralFeedItem.createFakeFeedItem(str3);
      localuje.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
      urk.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "save fake item %s", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem.feedId);
    }
    return this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem;
  }
  ...
  public srx a()
  {
    ...
    if ((this.jdField_a_of_type_Srx == null) && (a().spreadGroupBytes != null) && (a().spreadGroupBytes.length > 0)) {
      localVideoSpreadGroupList = new qqstory_struct.VideoSpreadGroupList();
    }
    try
    {
      localVideoSpreadGroupList.mergeFrom(a().spreadGroupBytes);
      this.jdField_a_of_type_Srx = new srx(localVideoSpreadGroupList);
      return this.jdField_a_of_type_Srx;
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      for (;;)
      {
        urk.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "decode spread group fail", localInvalidProtocolBufferMicroException);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    ((uje)sqg.a(11)).a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
  }
