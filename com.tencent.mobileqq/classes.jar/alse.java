...
public class alse
{
  ...
  public void a(alut paramalut, boolean paramBoolean, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidAnimationAnimatorSet != null)
    {
      Animator localAnimator = vsi.a(this.jdField_a_of_type_AndroidViewView, (int)this.jdField_a_of_type_Float + paramInt, (int)this.b, this.jdField_a_of_type_AndroidViewView.getHeight() / 2, 1.0F);
      localAnimator.addListener(new alsf(this, paramalut, paramBoolean));
