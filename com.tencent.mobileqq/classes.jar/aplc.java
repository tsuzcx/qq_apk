  ...
  implements aplg
{
  ...
  public String a(String paramString)
  {
    ...
    if (paramString == null) {
      localObject1 = localQQAppInterface.c();
    }
    Object localObject2 = ((anmw)localQQAppInterface.getManager(51)).b((String)localObject1);
    ...
    if (((Card)localObject2).shGender == 0) {
      paramString = BaseActivity.sTopActivity.getString(2131693461);
    }
    for (;;)
    {
      ...
      localObject2 = "";
      localObject1 = localQQAppInterface.c((String)localObject1);
      if ((localObject1 != null) && (!TextUtils.isEmpty(((Setting)localObject1).url))) {
        localObject1 = MsfSdkUtils.insertMtype("QQHeadIcon", ((FriendListHandler)localQQAppInterface.a(1)).a().a(((Setting)localObject1).url, ((Setting)localObject1).bFaceFlags, ((Setting)localObject1).bUsrType, 0));
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
        ...
        paramString = BaseActivity.sTopActivity.getString(2131692055);
        break;
