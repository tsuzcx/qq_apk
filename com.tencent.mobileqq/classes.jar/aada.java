  ...
  extends WebViewPlugin
{
  ...
  private aqyp jdField_a_of_type_Aqyp = new aadb(this);
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if (localalpl.a(paramString)) {
      localalpl.a(paramString, null, -1001, paramInt);
    }
  ...
  private void a(String paramString, long paramLong, int paramInt)
  {
    ...
    alpl localalpl = alpl.a();
    if (localalpl.a(paramString)) {
      localalpl.a(paramString, null, -1002, paramInt);
    }
    while (!QLog.isColorLevel()) {
      return;
    }
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    alpl localalpl = alpl.a();
    if (localalpl.a(paramString)) {
      localalpl.a(paramString, null, 1000, paramInt);
    }
    while (!QLog.isColorLevel()) {
      return;
    }
      ...
      try
      {
        ...
        if (localJSONObject.has("timeout"))
        {
          ...
          if (TextUtils.isEmpty(str1))
          {
            ...
            paramString1.put("msg", amtj.a(2131713374));
          ...
          if (l2 > 0L)
          {
            ...
            if (l3 > l2)
            {
              ...
              paramString1.put("businessRet", 0);
              paramString1.put("msg", amtj.a(2131713382));
              super.callJs(paramString2, new String[] { paramString1.toString() });
              if (!QLog.isColorLevel()) {
                break;
              }
          ...
          if (this.d.containsKey(str1))
          {
                ...
                if (i == 1)
                {
                  ...
                  if (localObject != null)
                  {
                    ...
                    if (!TextUtils.isEmpty((CharSequence)localObject))
                    {
                      ...
                      if (QLog.isColorLevel()) {
                        QLog.d("SSOWebviewPlugin", 2, "Get cookie:" + npn.c(str2, new String[0]) + " from " + npn.b((String)localObject, new String[0]));
                      }
                    }
                  }
                }
              }
              if ((this.mRuntime.a() == null) || (!amfy.a().a(this.mRuntime.a().getUrl(), paramString1, this.mRuntime.a(), this))) {
                continue;
              }
              if (!QLog.isColorLevel()) {
                break;
            ...
            paramString1.put("businessRet", 0);
            paramString1.put("msg", amtj.a(2131713371));
            super.callJs(paramString2, new String[] { paramString1.toString() });
            if (!QLog.isColorLevel()) {
              break;
            }
          ...
          localObject = new NewIntent(this.mRuntime.a().getApplicationContext(), auwo.class);
          ...
          ((NewIntent)localObject).setObserver(new aadc(this, System.currentTimeMillis(), str1));
          if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        paramString2 = new NewIntent(this.mRuntime.a().getApplicationContext(), nma.class);
        ...
        paramString2.setObserver(new aadd(this, str1, str3));
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      auwo.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString1.optInt("follow") == 1)
        {
          ...
          paramJsBridgeListener = aqyt.a("ipc_cmd_certified_account_web_plugin_follow", null, this.jdField_a_of_type_Aqyp.key, paramString2);
