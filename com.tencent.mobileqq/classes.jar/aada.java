...
public class aada
{
  ...
  protected aabm a;
  final aabp jdField_a_of_type_Aabp;
  final aacw jdField_a_of_type_Aacw;
  protected List<bczs> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "DoraemonOpenAPI." + aada.class.getSimpleName();
  }
  
  public aada(aabp paramaabp, aacw paramaacw)
  {
    this.jdField_a_of_type_Aabp = paramaabp;
    this.jdField_a_of_type_Aacw = paramaacw;
  ...
  private String a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    localLinkedHashMap.put("app_id", this.jdField_a_of_type_Aabp.jdField_a_of_type_JavaLangString);
    ...
    asiu localasiu = this.jdField_a_of_type_Aabp.a();
    if (localasiu == null)
    {
      paramAppRuntime = "";
    ...
    label265:
    for (paramAppRuntime = "";; paramAppRuntime = localasiu.i)
    {
      ...
      paramAppRuntime = localasiu.jdField_b_of_type_JavaLangString;
      break;
    }
  ...
  private void a()
  {
    ...
    long l = Long.parseLong(this.jdField_a_of_type_Aabp.jdField_a_of_type_JavaLangString);
    ...
    {
      localObject2 = (bczs)((Iterator)localObject1).next();
      if (((bczs)localObject2).jdField_a_of_type_Int > 0) {
        localAuthorizeRequest.openapi.add(Integer.valueOf(((bczs)localObject2).jdField_b_of_type_Int));
      }
    }
    ...
    localAuthorizeRequest.sdkp.set(aaet.a(this.jdField_a_of_type_Aabp.jdField_a_of_type_Int));
    localAuthorizeRequest.sdkv.set("1.5.9");
    localAuthorizeRequest.response_type.set("token");
    if ((this.jdField_a_of_type_Aabp instanceof aabw))
    {
      localObject1 = ((aabw)this.jdField_a_of_type_Aabp).a();
    ...
    if ((this.jdField_a_of_type_Aabp instanceof aadp))
    {
      aadp localaadp = (aadp)this.jdField_a_of_type_Aabp;
      if (localaadp.b)
      {
        localObject3 = a((AppRuntime)localObject1, (String)localObject3, localaadp.e, localaadp.d);
        localAuthorizeRequest.passData.set((String)localObject3);
      }
    }
    localObject3 = new NewIntent(BaseApplicationImpl.getApplication(), bdfa.class);
    ...
    ((NewIntent)localObject3).setObserver(new aadf(this, (String)localObject2));
  ...
  private void a(String paramString)
  {
    ...
    if (localasiu == null)
    {
      ...
      localObject = BaseApplicationImpl.getApplication().getString(2131694924);
    }
    label144:
    for (;;)
    {
      if (TextUtils.isEmpty(paramString))
      {
        a();
        return;
        localObject = localasiu.jdField_b_of_type_JavaLangString;
        break;
      }
      aabp localaabp = this.jdField_a_of_type_Aabp;
      if (localasiu == null) {}
      for (;;)
      {
        localaabp.a((String)localObject, str, BaseApplicationImpl.getApplication().getString(2131694923, new Object[] { localObject }), paramString, BaseApplicationImpl.getApplication().getString(2131720885), new aadc(this), BaseApplicationImpl.getApplication().getString(2131720888), new aadd(this), new aade(this));
        return;
        str = localasiu.c;
      }
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    try
    {
      long l2 = Long.parseLong(this.jdField_a_of_type_Aabp.jdField_a_of_type_JavaLangString);
      l1 = l2;
    }
    ...
    if (((this.jdField_a_of_type_Aabp instanceof aadp)) && (((aadp)this.jdField_a_of_type_Aabp).b))
    {
      localObject1 = "all" + ",server_side";
      localGetAuthApiListRequest.scope.set((String)localObject1);
      localGetAuthApiListRequest.sdkp.set(aaet.a(this.jdField_a_of_type_Aabp.jdField_a_of_type_Int));
      ...
      localObject1 = new NewIntent(BaseApplicationImpl.getApplication(), bdfa.class);
      ...
      ((NewIntent)localObject1).setObserver(new aadb(this, str3, paramBoolean));
  ...
  private boolean a(SdkAuthorize.GetAuthApiListResponse paramGetAuthApiListResponse)
  {
    ...
    while (paramGetAuthApiListResponse.hasNext())
    {
      ...
      {
        bczs localbczs = new bczs();
        localbczs.jdField_b_of_type_JavaLangString = localAuthItem.api_list.get();
        localbczs.jdField_a_of_type_Int = localAuthItem.default_flag.get();
        localbczs.jdField_b_of_type_Int = localAuthItem.id.get();
        if (localAuthItem.is_new.get() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          localbczs.jdField_a_of_type_Boolean = bool;
          localbczs.jdField_a_of_type_JavaLangString = localAuthItem.title.get();
          this.jdField_a_of_type_JavaUtilList.add(localbczs);
          break;
        }
      }
    }
  ...
  private void b(String paramString)
  {
    ...
    Object localObject = this.jdField_a_of_type_Aabp.a();
    if ((localObject != null) && ((this.jdField_a_of_type_Aabp instanceof aadp)) && ((localObject instanceof bcce)))
    {
  ...
  public void a(JSONObject paramJSONObject, aabm paramaabm, boolean paramBoolean)
  {
