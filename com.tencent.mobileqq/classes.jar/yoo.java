...
public class yoo
{
  ...
  private boolean jdField_a_of_type_Boolean = yoa.b("gamecenter_shot_switch");
  private boolean b;
  
  static
  {
    jdField_a_of_type_JavaLangString = bbvj.a("Tencent/MobileQQ/gamecenter" + File.separator);
    jdField_b_of_type_JavaLangString = bbvj.a(jdField_a_of_type_JavaLangString + "gamecenter_screenshot");
  }
  ...
  private void a(Context paramContext, String paramString, yoq paramyoq)
  {
    if (apvd.a(jdField_b_of_type_JavaLangString + paramString)) {
      ThreadManagerV2.executeOnFileThread(new ScreenshotManager.1(this, paramString, paramyoq));
    }
  }
  ...
  public void a(WebView paramWebView, String paramString, yoq paramyoq)
  {
    if (!a(paramyoq)) {
      return;
    }
    ...
    ThreadManagerV2.executeOnSubThread(new ScreenshotManager.2(this, paramString, paramyoq));
  }
  
  public void a(WebView paramWebView, yoq paramyoq)
  {
    if (!a(paramyoq)) {
      return;
    }
    ...
    {
      paramyoq.a(0, "removeShotMask no visible");
      return;
    }
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
      paramyoq.a(0, "removeShotMask succ");
      return;
    }
    catch (Throwable paramWebView)
    {
      paramyoq.a(-400, "removeShotMask fail");
    }
  }
  
  public void a(String paramString, yoq paramyoq)
  {
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("switch", yoa.b("gamecenter_shot_switch"));
      localJSONObject.put("fileExist", apvd.a(jdField_a_of_type_JavaLangString + paramString));
      paramyoq.a(0, localJSONObject.toString());
      return;
    }
    catch (Exception paramString)
    {
      paramyoq.a(-700, "queryShotInfo error");
    }
  }
  
  public void a(yoq paramyoq)
  {
    if (apvd.c(jdField_a_of_type_JavaLangString))
    {
      paramyoq.a(0, "delShotFile succ");
      return;
    }
    paramyoq.a(-500, "delShotFile fail");
  }
  ...
  public boolean a(Bitmap paramBitmap, String paramString)
  {
    if (paramBitmap != null) {
      try
      {
        ...
        vyf.a(jdField_a_of_type_JavaLangString);
  ...
  public boolean a(yoq paramyoq)
  {
    if (!yoa.b("gamecenter_shot_switch"))
    {
      if (paramyoq != null) {
        paramyoq.a(-1, "shot switch is false");
      }
      return false;
    }
    return true;
  ...
  public void b(WebView paramWebView, String paramString, yoq paramyoq)
  {
    if (!a(paramyoq)) {
      return;
    }
    ...
    {
      paramyoq.a(-300, "preloadMask not init");
      a(paramWebView.getContext(), paramString, paramyoq);
    ...
    catch (Throwable paramWebView)
    {
      ...
      paramyoq.a(-301, "add view error");
    }
  }
  
  public void b(yoq paramyoq)
  {
    QLog.i("ScreenshotManager", 1, "closeShot");
    if (yoa.a("gamecenter_shot_switch", false))
    {
      this.jdField_a_of_type_Boolean = false;
      paramyoq.a(0, "closeShot succ");
      return;
    }
    paramyoq.a(-600, "closeShot fail");
  }
  
  public void c(yoq paramyoq)
  {
    QLog.i("ScreenshotManager", 1, "open");
    if (yoa.a("gamecenter_shot_switch", true))
    {
      this.jdField_a_of_type_Boolean = true;
      paramyoq.a(0, "openShot succ");
      return;
    }
    paramyoq.a(-600, "openShot fail");
  }
}
