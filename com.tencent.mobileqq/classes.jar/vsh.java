...
public class vsh
  extends MqqHandler
{
  public vsh(AIOGalleryScene paramAIOGalleryScene) {}
        ...
        do
        {
          do
          {
            do
            {
              ...
              {
                return;
                QQToast.a(AIOGalleryScene.d(this.a), 2131437381, 0).a();
                return;
                String str = AIOGalleryScene.e(this.a).getString(2131437382);
            ...
            paramMessage = DialogUtil.b(AIOGalleryScene.h(this.a), 232, AIOGalleryScene.i(this.a).getResources().getString(2131437409), AIOGalleryScene.j(this.a).getResources().getString(2131437410), 2131437411, 2131434603, new vsi(this, paramMessage), new vsj(this));
            try
            {
              paramMessage.show();
              return;
