...
public class bcmw
{
  ...
  private bcna jdField_a_of_type_Bcna;
  ...
  public static bcmw a(MessageForPtt paramMessageForPtt, QQAppInterface paramQQAppInterface, int paramInt)
  {
    if ((paramMessageForPtt == null) || (paramQQAppInterface == null)) {
      return null;
    }
    bcmw localbcmw = new bcmw();
    localbcmw.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt = paramMessageForPtt;
    localbcmw.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(paramQQAppInterface);
    localbcmw.jdField_b_of_type_Int = paramInt;
    return localbcmw;
  }
  ...
  private Long c()
  {
    ...
    if (this.jdField_a_of_type_Bcnb != null) {
      this.jdField_a_of_type_Bcnb.a();
    }
    if (this.jdField_a_of_type_Bcna != null) {
      this.jdField_a_of_type_Bcna.a();
    }
  ...
  public boolean a(SttResultPush.MsgBody paramMsgBody)
  {
    ...
    {
      if (this.jdField_a_of_type_Bcnb == null) {
        this.jdField_a_of_type_Bcnb = new bcnb(a().getSttResult());
      }
      j = this.jdField_a_of_type_Bcnb.a(paramMsgBody);
      i = 1;
      label105:
    ...
    for (int k = 4;; k = 2)
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Bcna == null) {
            this.jdField_a_of_type_Bcna = new bcna(a().getSttResult());
          }
          j = this.jdField_a_of_type_Bcna.a(paramMsgBody);
          i = 2;
          break label105;
        }
        if (!QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        if ((this.jdField_b_of_type_MqqUtilWeakReference != null) && (!this.jdField_b_of_type_MqqUtilWeakReference.isEnqueued()))
        {
          ...
          bcmv.a((QQAppInterface)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt, Long.valueOf(l), this.jdField_b_of_type_Int, 1);
          if (QLog.isColorLevel()) {
