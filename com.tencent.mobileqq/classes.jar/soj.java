...
public class soj
  extends ual
{
  public soj(FastWebActivity paramFastWebActivity) {}
  ...
  public boolean a(int paramInt, ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    if (paramInt == 1)
    {
      ...
      {
        str = "0X8008994";
        ssi.a(localFastWebActivity, str, 9, this.a.a);
        ssy.a(this.a, this.a.getAppInterface(), this.a.a, -1, 3, false);
      }
    }
    for (;;)
    {
      ...
      if (paramInt == 5)
      {
        ...
        ssy.a(this.a, this.a.getAppInterface(), this.a.a, 6, -1, false);
      }
      else if (paramInt == 4)
      {
        FastWebActivity.a(this.a).b(this.a.a.mArticleContentUrl);
        ssy.a(this.a, this.a.getAppInterface(), this.a.a, 7, -1, false);
      }
      else if (paramInt == 13)
      {
        this.a.a(17, -1, false);
        ssy.a(this.a, this.a.getAppInterface(), this.a.a, 0, -1, false);
      }
      else
      {
        if (paramInt == 6)
        {
          ...
          {
            ssi.a(localFastWebActivity, str, 8, this.a.a);
            ssy.a(this.a, this.a.getAppInterface(), this.a.a, -1, 4, false);
            break;
          }
        }
        if (paramInt == 11)
        {
          ...
          for (str = "0X8008994";; str = "0X800898D")
          {
            ssi.a(localFastWebActivity, str, 10, this.a.a);
            ssy.a(this.a, this.a.getAppInterface(), this.a.a, -1, 5, false);
            break;
          }
        }
        if (paramInt == 21)
        {
          ...
          for (str = "0X8008994";; str = "0X800898D")
          {
            ssi.a(localFastWebActivity, str, 7, this.a.a);
            ssy.a(this.a, this.a.getAppInterface(), this.a.a, -1, 0, false);
            break;
          }
        }
        if (paramInt == 7)
        {
          ...
          ssy.a(this.a, this.a.getAppInterface(), this.a.a, -1, 1, false, false, oyq.a(null, "function_type", Integer.valueOf(7)));
        }
        else if (paramInt == 26)
        {
          FastWebActivity.a(this.a).d(this.a.a.mArticleContentUrl);
          ssy.a(this.a, this.a.getAppInterface(), this.a.a, -1, 2, false);
        }
        else if (paramInt == 68)
        {
          beaj.a(1, 2);
          beaj.a(this.a.a.mArticleContentUrl, this.a.a.mTitle);
        }
        else if (paramInt == 70)
        {
          if (FastWebActivity.a(this.a) != null) {
        ...
        {
          pfa.a().a().a(this.a.a.mArticleContentUrl, this.a.a.innerUniqueID + "", this.a.a.mSubscribeID, paramInt, FastWebActivity.a(this.a));
        }
      }
    }
  }
