...
public class apjx
{
  ...
  private static ArrayList<apjy> a;
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    for (;;)
    {
      ...
      {
        apjy localapjy = (apjy)localObject[i];
        jdField_a_of_type_AndroidOsHandler.post(new FaceScanDownloadManager.1(localapjy, paramInt1, paramInt2));
        i += 1;
      }
    }
  }
  ...
  public static void a(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      {
        apjy localapjy = (apjy)localObject[i];
        jdField_a_of_type_AndroidOsHandler.post(new FaceScanDownloadManager.2(localapjy, paramInt, paramBoolean));
        i += 1;
      }
    }
  }
  
  public static void a(apjy paramapjy)
  {
    if (paramapjy != null) {}
    try
    {
      if (!jdField_a_of_type_JavaUtilArrayList.contains(paramapjy))
      {
        if (QLog.isColorLevel()) {
          QLog.i("FaceScanDownloadManager", 2, "addDownloadCallback");
        }
        jdField_a_of_type_JavaUtilArrayList.add(paramapjy);
      }
      return;
    }
    finally {}
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        asdp localasdp = (asdp)paramQQAppInterface.a("qq.android.ar.face.so_v8.4.1_32");
        if ((localasdp != null) && (localasdp.g()) && (!apka.a()))
        {
          localasdp.g();
          if (QLog.isColorLevel()) {
        ...
        paramQQAppInterface = (asdo)paramQQAppInterface.a("qq.android.ar.face.models_v8.2.0");
      } while ((paramQQAppInterface == null) || (!paramQQAppInterface.g()) || (apjz.a()));
  ...
  private static boolean a(asdn paramasdn)
  {
    ...
    QLog.d("FaceScanDownloadManager", 2, "strPkgName is empty:" + TextUtils.isEmpty(paramasdn.strPkgName) + " strResURL_big is empty:" + TextUtils.isEmpty(paramasdn.strResURL_big) + " loadState :" + paramasdn.loadState);
    return false;
    return true;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((!bool2) && (paramQQAppInterface != null) && (paramQQAppInterface.g()) && (apjz.a())) {
      bool2 = true;
    }
    for (;;)
    {
