  ...
  extends WebViewPlugin
{
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString2 != null)
    {
      ...
      catch (Exception paramVarArgs)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            {
              paramJsBridgeListener = paramString3.getDrawable(2130844835);
            }
      ...
      {
        paramJsBridgeListener = paramString3.getDrawable(2130844836);
        if (j <= 3) {
          break label278;
        }
        k = 3;
        ...
        j = 0;
        paramString2.mSwiftTitleUI.setTitleIcon(k, paramJsBridgeListener, j);
        return true;
      }
    }
    label278:
