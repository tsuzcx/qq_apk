...
public class sdi
{
  ...
  public static int a(ListView paramListView, sdg paramsdg)
  {
    if (paramsdg != null)
    {
      paramsdg = paramListView.getChildAt(paramsdg.a + paramListView.getHeaderViewsCount() - paramListView.getFirstVisiblePosition());
      if (paramsdg != null) {
        return paramsdg.getBottom() - AIOUtils.dp2px(175.0F, paramListView.getResources());
      }
    }
    return 0;
  }
  ...
  public static String a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (paramInt2 == 103) {
        return amtj.a(2131715342) + paramInt1 + "-" + paramInt2;
      }
      if (paramInt2 == 108) {
        return amtj.a(2131717583) + ": " + paramInt1 + "-" + paramInt2;
      }
      return amtj.a(2131715356) + paramInt1 + "-" + paramInt2;
    }
    if (paramInt1 == 122)
    {
      if (paramInt2 == 204) {
        return amtj.a(2131715352) + paramInt1 + "-" + paramInt2;
      }
      if (paramInt2 == 202) {
        return amtj.a(2131715345) + paramInt1 + "-" + paramInt2;
      }
      return amtj.a(2131715332) + paramInt1 + "-" + paramInt2;
    }
    if (paramInt1 == 101)
    {
      if (paramInt2 == 80) {
        return amtj.a(2131715344) + paramInt1 + "-" + paramInt2;
      }
      return amtj.a(2131715334) + paramInt1 + "-" + paramInt2;
    }
    return amtj.a(2131715340) + paramInt1 + "-" + paramInt2;
  }
}
