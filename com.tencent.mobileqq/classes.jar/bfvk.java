  ...
  extends bfvd
{
  ...
  public bfvk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, PubAccountNavigationMenu paramPubAccountNavigationMenu, long paramLong2)
  {
    ...
    try
    {
      ...
      for (int i = 0;; i = paramPubAccountNavigationMenu.version)
      {
        ...
        ((subcmd0x519.CRMMsgHead)localObject1).uint32_ver_no.set(bfvu.a("8.3.3"));
  ...
  private void a(awbw paramawbw)
  {
    if (paramawbw != null)
    {
      paramawbw = paramawbw.a(PubAccountNavigationMenu.class);
      if (paramawbw != null)
      {
        paramawbw = paramawbw.iterator();
        while (paramawbw.hasNext())
        {
          PubAccountNavigationMenu localPubAccountNavigationMenu = (PubAccountNavigationMenu)paramawbw.next();
          if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong)
  {
    if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      if (localObject != null)
      {
        localObject = (PubAccountNavigationMenu)((awbw)localObject).a(PubAccountNavigationMenu.class, new String[] { String.valueOf(paramLong) });
        if (localObject != null) {
