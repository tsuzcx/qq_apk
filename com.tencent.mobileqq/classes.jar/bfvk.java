...
public class bfvk
{
  ...
  public bfvk(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.b = paramInt1;
    this.c = paramInt2;
    this.d = paramInt3;
  ...
  public void a(Canvas paramCanvas, Paint paramPaint, bfvf parambfvf)
  {
    ...
    paramPaint.setColor(parambfvf.b);
    paramPaint.setStrokeWidth(parambfvf.e);
    paramCanvas.drawLine(this.b, this.d, this.c, this.d, paramPaint);
    parambfvf = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (parambfvf.hasNext())
    {
      Point localPoint = (Point)parambfvf.next();
