...
public class yog
  extends ynu
  implements ImageViewVideoPlayer.IMPFrameListener, ImageViewVideoPlayer.IMPlayerEndListener, yoi, ypr
{
  public float a;
  public long a;
  protected Handler a;
  ...
  public yog(@NonNull ynw paramynw)
  {
    super(paramynw);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    ykq.c("Q.qqstory.record.EditVideoPlayer", "updateVideoDrawablePlayerUI width" + paramInt1 + "heightRatio=" + f + "dst_height" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.d + "dst_width=" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.jdField_c_of_type_Int);
  ...
  private void b(boolean paramBoolean)
  {
    ...
    ykq.d("Q.qqstory.record.EditVideoPlayer", "pausePreview but the player has not started : " + this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.mPlayerState);
  }
  ...
  private void k()
  {
    ...
    ykq.d("Q.qqstory.record.EditVideoPlayer", "restartPreview but the player is not stopping : " + this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.mPlayerState);
  }
  ...
  public void S_()
  {
    ...
    switch (this.jdField_a_of_type_Ynw.b)
    {
    case 0: 
    case 2: 
    case 5: 
  ...
  public long a(int paramInt)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        localObject = (ypq)((List)localObject).get(paramInt);
        return ((ypq)localObject).d - ((ypq)localObject).jdField_c_of_type_Long;
      }
    }
    return -1L;
  }
  ...
  public Bitmap a(int paramInt)
  {
    ...
    if (Looper.myLooper() == this.jdField_a_of_type_AndroidOsHandler.getLooper())
    {
      ...
      if ((localObject != null) && (paramInt < ((List)localObject).size())) {}
      for (localObject = (ypq)((List)localObject).get(paramInt); localObject == null; localObject = null) {
        return null;
      }
      return a((ypq)localObject);
    }
  ...
  public Bitmap a(@NonNull ypq paramypq)
  {
    Bitmap localBitmap = null;
    Object localObject = (yld)a(yld.class);
    int j;
    int i;
    if (localObject != null)
    {
      j = ((yld)localObject).a(paramypq.jdField_c_of_type_Int);
      i = ((yld)localObject).a(this.jdField_a_of_type_Ynw.a());
      ykq.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap for %d, playModeNeeded = %d, currentPlayMode = %d", Integer.valueOf(paramypq.jdField_c_of_type_Int), Integer.valueOf(j), Integer.valueOf(i));
    }
    for (;;)
    {
      ...
      {
        k = ((ylc)localObject).a();
        arrayOfByte = ((ylc)localObject).a(paramypq.jdField_c_of_type_Int);
      }
      for (localObject = ((ylc)localObject).a(this.jdField_a_of_type_Ynw.a());; localObject = null)
      {
        ...
        try
        {
          ...
          ykq.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap, playMode=%d, info=%s", Integer.valueOf(j), paramypq);
          if (j == 1)
          {
            localBitmap = ((MultiBlockVideoPlayer)this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(paramypq.b - 1L, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getWidth(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getHeight());
            return localBitmap;
          }
          paramypq = ((MultiBlockVideoPlayer)this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(paramypq.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getWidth(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getHeight());
          return paramypq;
        }
        finally
        {
  ...
  public List<? extends yqa> a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer instanceof MultiBlockVideoPlayer))
    {
      ...
      if (localList != null)
      {
        ...
        if (i > 1) {}
        for (ypq localypq = (ypq)localList.get(i - 1); (localypq != null) && (localypq.b - localypq.jdField_a_of_type_Long < 11L); localypq = null) {
  ...
  public void a()
  {
    ...
    ykq.d("Q.qqstory.record.EditVideoPlayer", "recordMultiVideoFragment = %s, supportMultiVideoFragment = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
    Object localObject;
    label272:
    label290:
    String str2;
    ...
    if ((bool1) && (bool2))
    {
      ...
      if (!(this.jdField_a_of_type_Ynw.a.mEditSource instanceof EditRecordVideoSource)) {
        break label459;
      }
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource = ((EditRecordVideoSource)this.jdField_a_of_type_Ynw.a.mEditSource);
      this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer = ((ImageViewVideoPlayer)a(2131366983));
      ...
      localObject = null;
      str1 = null;
      Bundle localBundle = this.jdField_a_of_type_Ynw.a.mExtra;
      if (localBundle == null) {
        break label569;
      }
    ...
    for (;;)
    {
      if (bool1)
      {
        ...
        ykq.d("Q.qqstory.record.EditVideoPlayer", "onCreate init player, securityChecked=%s, afFilePath=%s, vfFilePath=%s", new Object[] { Boolean.valueOf(bool1), localObject, str1 });
      }
      for (;;)
      {
        a(yoi.class, this);
        ...
        break label272;
        label492:
        ykw.jdField_a_of_type_Long = this.jdField_a_of_type_Ypg.getActivity().getIntent().getLongExtra("stop_record_time", 0L);
        ykw.b = System.currentTimeMillis();
        break label290;
  ...
  public void a(int paramInt, @NonNull yya paramyya)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (ypq)((Iterator)localObject2).next();
        if (localObject1 == null)
        {
          ykq.e("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish error. RecordVideoBlockInfo is null.");
        }
        else if (((ypq)localObject1).jdField_c_of_type_Int == paramInt)
        {
          paramyya.a.hasFragments = true;
          localObject2 = new JSONObject();
        }
      }
      try
      {
        ((JSONObject)localObject2).put("vfFrameIndexStart", ((ypq)localObject1).jdField_a_of_type_Long);
        ((JSONObject)localObject2).put("vfFrameIndexEnd", ((ypq)localObject1).b);
        ((JSONObject)localObject2).put("afTimeStart", ((ypq)localObject1).jdField_c_of_type_Long);
        ((JSONObject)localObject2).put("afTimeEnd", ((ypq)localObject1).d);
        paramyya.a.fragments = ((JSONObject)localObject2).toString();
        ykq.b("Q.qqstory.record.EditVideoPlayer", "fragments = %s.", paramyya.a.fragments);
        ykq.b("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish : %s", paramyya.a.fragments);
        if (paramyya.a.hasFragments) {
          continue;
        }
  ...
  {
    ykq.a("Q.qqstory.record.EditVideoPlayer", "updateVideoFrameBitmap info=%s", paramypq);
    Object localObject = a(paramypq);
    if (localObject != null)
    {
      Bitmap localBitmap = zdr.a((Bitmap)localObject, this.jdField_a_of_type_Float, false);
      a((Bitmap)localObject);
      if (localBitmap != null)
      {
        localObject = new ArrayList(this.jdField_a_of_type_JavaUtilList);
        ypq localypq = (ypq)((List)localObject).get(paramypq.jdField_c_of_type_Int);
        ((List)localObject).set(paramypq.jdField_c_of_type_Int, localypq.a(localBitmap));
  ...
  public void onCurrentFrame(int paramInt)
  {
    ...
    long l2;
    long l1;
    if ((paramInt == 1) && (this.jdField_a_of_type_Long == 0L) && (!this.jdField_a_of_type_Ynw.a()))
    {
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      localObject = QQStoryContext.a().a();
      ykw.a(this.jdField_a_of_type_Long, (String)localObject);
      ykq.b("Q.qqstory.record.EditVideoPlayer", "onCurrentFrame:" + paramInt + ", mPreivewContentTime:" + this.jdField_a_of_type_Long);
      if (0L != 0L) {
        break label229;
      }
      localObject = this.jdField_a_of_type_Ynw.a.mExtra;
      if (localObject == null) {
        break label229;
      }
    ...
    for (;;)
    {
      ...
      if (l2 == 0L)
      {
        localObject = this.jdField_a_of_type_Ypg.getActivity();
        l4 = l1;
        l3 = l2;
        if (localObject != null)
        {
      ...
      if (l3 != 0L) {
        ykv.b("video_edit", "startEditVideoTime", this.jdField_a_of_type_Ynw.b(), 0, new String[] { String.valueOf(l4 - l3) });
      }
      return;
      label229:
      l1 = 0L;
  ...
  public void onDrawLastFrameEnd()
  {
    ...
    if (localBitmap1 != null)
    {
      ...
      if (this.jdField_b_of_type_Boolean) {
        Stream.of(localBitmap1).map(new ThreadOffFunction("Q.qqstory.record.EditVideoPlayer", 2)).map(new yqj(0.2F, false)).map(new yqk(10)).map(new UIThreadOffFunction(this)).subscribe(new yoh(this));
      }
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
  }
