...
{
  public arcq(MapWidget paramMapWidget, int paramInt, arcv paramarcv) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    ...
    if (MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget) != null) {
      MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget).a(false, this.jdField_a_of_type_Arcv);
    }
  }
    ...
    for (;;)
    {
      if (paramObject != null)
      {
        ...
        if (beog.a())
        {
          ...
          label124:
          this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline = this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addPolyline(new PolylineOptions().addAll(paramObject).color(paramInt).width(azvv.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.getContext(), 5.0F)));
          if (this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline != null)
          {
      ...
      {
        ((arcu)localObject1).a(bool, this.jdField_a_of_type_Arcv);
        return;
        ...
        this.jdField_a_of_type_Arcv.a = paramObject.duration;
        this.jdField_a_of_type_Arcv.b = paramObject.distance;
        ...
        this.jdField_a_of_type_Arcv.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_Arcv.b = ((TransitResultObject.Route)localObject1).distance;
