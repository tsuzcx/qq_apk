...
public abstract class arcq
{
  public byte a;
  private final int jdField_a_of_type_Int = aqkv.a();
  public long a;
  ...
  public arcq(short paramShort, byte paramByte)
  {
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if ((localarcw.d == null) || (!localarcw.d.contains(paramString))) {}
      }
      for (;;)
      {
        if (i == -1) {
