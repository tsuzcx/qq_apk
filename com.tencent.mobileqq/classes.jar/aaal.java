  ...
  implements aaaj
{
  ...
  public aaal(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, aaak paramaaak)
  {
    ...
    if ((localObject3 != null) && (i != 102))
    {
      ...
      paramResultObject = new QCloudFileUploadRunnable(new URL((String)localObject1), (String)localObject2, localJSONObject, paramaaak, paramResultObject.dbId, this.jdField_a_of_type_MqqOsMqqHandler);
    ...
    else
    {
      ...
      paramResultObject = new JsonUploadRunnable(new URL((String)localObject1), localJSONObject, paramaaak, paramResultObject.dbId, this.jdField_a_of_type_MqqOsMqqHandler);
      this.jdField_a_of_type_MqqOsMqqHandler.post(paramResultObject);
    }
    return true;
  }
