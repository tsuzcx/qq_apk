...
public class aehj
  extends ntf
{
  public aehj(LoginInfoActivity paramLoginInfoActivity) {}
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        if ((LoginInfoActivity.a(this.a) != null) && (!LoginInfoActivity.a(this.a).isEmpty()))
        {
          if (TextUtils.isEmpty(LoginInfoActivity.a(this.a)))
          {
            ...
            paramBundle = this.a.getString(2131716570);
          ...
          bool = false;
          if (paramInt == 0) {
            paramArrayOfByte = this.a.getString(2131716572);
          }
      ...
      catch (Throwable paramArrayOfByte)
      {
        ...
        if (TextUtils.isEmpty(LoginInfoActivity.b(this.a))) {
          LoginInfoActivity.a(this.a, this.a.getString(2131716573));
        }
