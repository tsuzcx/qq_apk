  ...
  implements ShareProxy
{
  ...
  {
    a(paramInt, paramString1, paramString2, ImageUtil.drawableToBitmap(paramActivity.getResources().getDrawable(2130848403)), paramString3);
  }
  ...
  private void a(String paramString, URLDrawable.URLDrawableListener paramURLDrawableListener)
  {
    ...
    if (paramURLDrawableListener != null)
    {
      ...
      yqp.b("ShareProxyImpl", "URLDrawable's status is SUCCESSED.");
    ...
    for (;;)
    {
      ...
      return;
      label44:
      yqp.b("ShareProxyImpl", "start load URLDrawable.");
    }
  }
  ...
  public void a(InnerShareData paramInnerShareData)
  {
    ...
    bjyp localbjyp = new bjyp(this, paramInnerShareData);
    Object localObject;
    ...
    if (paramInnerShareData.entryModel != null)
    {
      ...
      int j = 0;
      i = j;
      if (!bgsp.a(((MiniArkShareModel)localObject).getTemplateId()))
      {
        i = j;
        if (!bgsp.a(((MiniArkShareModel)localObject).getTemplateData())) {
          i = 2;
        }
      }
  ...
  public void b(InnerShareData paramInnerShareData)
  {
    ...
    String str;
    Intent localIntent;
    if (bgsp.a(paramInnerShareData.summary))
    {
