  ...
  extends RemoteCommand
{
  ...
  public bjyo(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        azmj.b(this.a, "P_CliOper", "BizTechReport", "", "troop_member_card_plugin", "plugin_cmd_exp", 0, 0, paramBundle.getClass().getName(), null, null, null);
        return null;
      }
      ...
      bdbx.a().a(this.a, paramBundle, this.a.getCurrentAccountUin(), this.a.getApp());
      paramBundle = localBundle;
      continue;
      ...
      localObject1 = (aloz)this.a.getManager(51);
      localObject2 = ((aloz)localObject1).b(paramBundle);
      if ((localObject2 == null) || (!((Friends)localObject2).isFriend())) {
        break label1375;
      }
      paramBundle = ((aloz)localObject1).a(paramBundle);
    ...
    for (long l1 = ayvc.a();; l1 = 0L)
    {
      ...
      if (bdal.b(paramBundle)) {
        azmj.b(this.a, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
      }
      ...
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((alzf)this.a.a(20)).l(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((alzf)this.a.a(20)).k(paramBundle);
      paramBundle = localBundle;
      break;
      localObject1 = paramBundle.getString("uin");
      paramBundle = "";
      localObject1 = auoa.a(this.a, (String)localObject1, false);
      if (localObject1 != null)
      {
        if (((aupa)localObject1).a == 1L) {
          paramBundle = this.a.getApp().getString(2131693710);
        }
        for (;;)
        {
          i = ((aupa)localObject1).c;
          localBundle.putString("bind_name", paramBundle);
          localBundle.putInt("bind_icon", i);
          paramBundle = localBundle;
          break;
          if (((aupa)localObject1).a == 2L) {
            paramBundle = this.a.getApp().getString(2131693708);
          } else if (((aupa)localObject1).a == 3L) {
            paramBundle = this.a.getApp().getString(2131693709);
          }
        }
      }
      label1375:
