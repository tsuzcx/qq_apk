  ...
  extends bcod
{
  ...
  public bdae(DeviceFriendListOpenFrame paramDeviceFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_Bddv.a();
    bdht.c(DeviceFriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->start constructHashStruct()");
    ...
    bdht.c(DeviceFriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562408, paramViewGroup, false);
      paramViewGroup = new bdaf();
      paramViewGroup.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375396));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131378220));
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_Bddv.a(localFriend.jdField_a_of_type_JavaLangString)) {
        break label386;
      }
      ...
      if ((localFriend.d == null) || ("".equals(localFriend.d))) {
        localFriend.d = bdec.a(this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), localFriend.jdField_a_of_type_JavaLangString);
      }
      ...
      bddz.a().a(localFriend.d, this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame);
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (bdaf)paramView.getTag();
      break;
      label386:
