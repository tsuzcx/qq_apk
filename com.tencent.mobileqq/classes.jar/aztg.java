  ...
  public static void a(AppRuntime paramAppRuntime)
  {
    ...
    for (;;)
    {
      ...
      if (i < paramAppRuntime.length())
      {
        ...
        localObject1 = new azth();
        ((azth)localObject1).jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
        ((azth)localObject1).b = ((JSONObject)localObject2).optString("subtitle");
        ((azth)localObject1).c = ((JSONObject)localObject2).optString("bannerLink");
        ((azth)localObject1).d = ((JSONObject)localObject2).optString("reportName");
        ((azth)localObject1).jdField_a_of_type_JavaUtilVector = new Vector();
      ...
      for (;;)
      {
        if (j < ((JSONArray)localObject2).length())
        {
          ...
          ((azth)localObject1).jdField_a_of_type_JavaUtilVector.add(str);
          break label442;
