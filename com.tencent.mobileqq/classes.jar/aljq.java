...
public abstract interface aljq
{
  ...
  static
  {
    ...
    bi = bduw.a(aW + "/Tencent/QQ_Favorite/");
    bj = bduw.a(aW + "/Tencent/QQ_CameraEmo/");
    bk = aW + "/DCIM/Camera/";
    bl = bduw.a(aW + "/Tencent/QQ_Collection/");
    bm = bduw.a(aW + "/Tencent/QQfile_recv/");
    bn = bm + ".thumbnails/";
    bo = bm + ".tmp/";
    bp = bm + ".trooptmp/";
    bq = aW + "/Tencent/QQ_Secretfile/";
    br = bduw.a(aW + "/Tencent/QQ_Video/");
    bs = aW + "/Tencent/QQfile_share/";
    bt = aW + "/Tencent/QQHomework_recv/";
    bu = aW + "/Tencent/QQHomework_attach/";
    bv = aX + "Troop_reward/";
    bw = bduw.a(aX + "ar_cloud_img/");
    bx = bduw.a(aX + "ar_cloud_marker_feature/");
    by = bduw.a(aX + "ar_cloud_marker_config/");
    bz = bduw.a(aX + "ar_cloud_marker_model/");
    bA = bduw.a(aX + "ARRelationShip/");
    bB = bduw.a(aX + "ar_cloud_transfer/");
    bC = bduw.a(aX + "qqmusic/");
    bD = aX + "pe";
    bE = aX + "poke";
    bF = aX + "newpoke";
    ...
    for (String str = aX;; str = "/sdcard/Android/data/com.tencent.mobileqq/files/Tencent/MobileQQ/")
    {
      ...
      bN = bH + "_dhd/";
      bO = bH + "_SSOhd/";
      bP = bduw.a(bG + ".starHead/");
      bQ = bduw.a(bG + ".pendant/");
      bR = aX + ".secmsgPic/";
      bS = bduw.a(aX + ".emotionsm/");
      bT = aX + ".emoQFace/";
      bU = bduw.a(aX + ".diy/");
      bV = bduw.a(aX + ".indivAnim/");
      bW = bduw.a(new StringBuilder().append(aX).append("pddata/vas/").toString()) + "individual_sign/";
      bX = bW + "stickers/";
      ...
      cb = aX + "device/";
      cc = aX + "location/";
      cd = bduw.a(aX + "system_background/");
      ...
      ck = cd + "resource/";
      cl = aX + "turnbrand/";
      cm = bduw.a(aX + "Scribble/");
      cn = bduw.a(aX + ".profilecard" + "/");
      co = aX + "card/";
      cp = aX + "card/starfans/";
      ...
      cG = cF + "animation/";
      cH = bduw.a(cy + "preload/");
      cI = bduw.a(cy + "preimg/");
      cJ = aW + "/DCIM/Video/";
      cK = aW + alpo.a(2131700982);
      cL = aW + alpo.a(2131700983);
      cM = aW + "/Camera/Video/";
