...
public class lec
{
  ...
  private led jdField_a_of_type_Led;
  ...
  public void a()
  {
    ...
    {
      return;
      localDexClassLoader = mrc.a();
      if (this.jdField_a_of_type_JavaUtilMap == null) {
        this.jdField_a_of_type_JavaUtilMap = new HashMap();
      }
      if (this.jdField_a_of_type_Led == null)
      {
        ...
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().registerReceiver(this.jdField_a_of_type_Led, (IntentFilter)localObject);
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_JavaLangObject = mrc.a(localDexClassLoader, "com.tencent.av.camera2.CameraManagerWrapper");
    ...
    mrc.a(localDexClassLoader, localObject, "registerAvailabilityCb", new Class[] { Context.class, String.class, Handler.class }, new Object[] { localContext, str, null });
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unregisterReceiver(this.jdField_a_of_type_Led);
        this.jdField_a_of_type_Led = null;
        if (QLog.isColorLevel()) {
        ...
        mrc.a(mrc.a(), this.jdField_a_of_type_JavaLangObject, "unRegisterAvailabilityCb", null, null);
        return;
      }
