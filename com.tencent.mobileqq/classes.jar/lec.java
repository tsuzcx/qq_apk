...
public class lec
{
  ...
  public lec(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = mnp.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          str1 = locallgf.jdField_d_of_type_JavaLangString;
          str2 = locallgf.e;
          i = locallgf.E;
          j = locallgf.jdField_d_of_type_Int;
          bool1 = locallgf.L;
          bool2 = locallgf.N;
          bool3 = locallgf.g;
  ...
  public void a()
  {
    ...
    {
      led.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((lgf)localObject).jdField_i_of_type_Int, ((lgf)localObject).jdField_d_of_type_JavaLangString, ((lgf)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      led.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = ldc.a(j, (String)localObject1, new int[0]);
        localObject3 = ldc.a().a((String)localObject3, false);
        ((lgf)localObject3).jdField_i_of_type_Int = 0;
        ((lgf)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((lgf)localObject3).e = ((String)localObject2);
        ((lgf)localObject3).E = j;
        ((lgf)localObject3).ag = true;
        ((lgf)localObject3).jdField_i_of_type_Long = l2;
        ((lgf)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((lgf)localObject3).Q = true;
        ((lgf)localObject3).L = bool1;
        ((lgf)localObject3).g = bool3;
        ...
        if (lzj.f())
        {
          lzj.a(l3, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((mtt)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          led.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      lzj.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label588:
