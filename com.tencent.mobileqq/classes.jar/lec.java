...
public class lec
{
  ...
  public lec(VideoAppInterface paramVideoAppInterface)
  {
    ...
    this.jdField_a_of_type_Led = new led(paramVideoAppInterface);
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().registerReceiver(this.jdField_a_of_type_Led, localIntentFilter) != null) {
