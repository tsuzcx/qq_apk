...
public class arqx
{
  ...
  /* Error */
  private void a(File paramFile1, File paramFile2, arqw paramarqw)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    ...
    //   25: iconst_1
    //   26: ldc 150
    //   28: invokestatic 54	arqx:a	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 29	arqx:jdField_a_of_type_Boolean	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, arqw paramarqw)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_b_of_type_Long += arso.a(str1);
        }
    ...
    if (str2.contains("/.tmp/")) {
      localObject = b(str1) + arrr.a(str2);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ThreadManager.post(new FMSettings.4(this, str2, (File)localObject, j, paramarqw), 8, null, false);
          i += 1;
        }
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = c(str1) + arrr.a(str2);
      } else {
        localObject = a(str1) + arrr.a(str2);
      }
    }
  }
  ...
  private arrd b()
  {
    return (arrd)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
  }
  ...
  private arrd c()
  {
    ...
    return (arrd)this.jdField_a_of_type_JavaUtilMap.get("externalSdCard");
  }
  ...
  private void c()
  {
    ...
    ThreadManager.post(new FMSettings.1(this, b(localarrd.jdField_b_of_type_JavaLangString + localarrd.c)), 8, null, false);
  }
  ...
  private arrd d()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (arrd)this.jdField_a_of_type_JavaUtilMap.get(localObject2);
      ((arrd)localObject2).a();
      if (((arrd)localObject2).jdField_a_of_type_Boolean)
      {
        a(2, "getDefaultStorage[" + ((arrd)localObject2).jdField_b_of_type_JavaLangString + "] + ext[" + ((arrd)localObject2).c + "]");
        return localObject2;
      }
    }
    a(2, "getDefaultStorage nothing is default refresh!");
    Object localObject2 = (arrd)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new arrd(this, null);
      ((arrd)localObject1).jdField_a_of_type_Boolean = true;
      ((arrd)localObject1).jdField_a_of_type_JavaLangString = "SD卡";
      ((arrd)localObject1).jdField_b_of_type_JavaLangString = Environment.getExternalStorageDirectory().getPath();
      ((arrd)localObject1).c = "";
    }
    ((arrd)localObject1).a(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public arrd a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (arrd)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      if (localarrd != localObject) {
        return localObject;
      }
    }
  ...
  public String a()
  {
    ...
    return a(localarrd.jdField_b_of_type_JavaLangString + localarrd.c);
  }
  ...
  public void a()
  {
    ...
    Map localMap = arrr.a(localBaseApplication);
    a(1, "qurey strorages[" + localMap.size() + "]");
    String str1 = localBaseApplication.getSharedPreferences("FMSETTING_59", 4).getString("DefaultRootPath", alof.aW);
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localarrd = new arrd(this, null);
          localarrd.jdField_a_of_type_Boolean = false;
          if (!str2.equalsIgnoreCase("sdCard")) {
            break label402;
          }
          localarrd.jdField_a_of_type_JavaLangString = "SD卡";
          localarrd.jdField_b_of_type_JavaLangString = ((String)localObject);
          localarrd.c = "";
          a(1, "rootPath[" + localarrd.jdField_b_of_type_JavaLangString + "],bDefault[" + localarrd.jdField_a_of_type_Boolean + "]");
          localObject = new StatFs((String)localObject);
          localarrd.jdField_a_of_type_Long = (((StatFs)localObject).getAvailableBlocks() * ((StatFs)localObject).getBlockSize());
          a(4, "defaultRootPath[" + str1 + "].equalsIgnoreCase(si.rootPath[" + localarrd.jdField_b_of_type_JavaLangString + "])");
          if ((localMap.size() == 1) || (str1.equalsIgnoreCase(localarrd.jdField_b_of_type_JavaLangString)))
          {
            a(4, "defaultRootPath.equalsIgnoreCase(si.rootPath) = true");
            localarrd.jdField_a_of_type_Boolean = true;
            localarrd.a(localBaseApplication);
          }
          localarrd.a();
          this.jdField_a_of_type_JavaUtilMap.put(str2, localarrd);
        }
        catch (Exception localException)
        {
          localException.printStackTrace();
        ...
        {
          localarrd.jdField_a_of_type_JavaLangString = "外置SD卡";
          localBaseApplication.getExternalFilesDir(null);
          String str3 = BaseApplicationImpl.sApplication.getPackageName();
          localarrd.jdField_b_of_type_JavaLangString = ((String)localObject);
          localarrd.c = ("/Android/data/" + str3 + "/");
        }
      }
    }
  }
  
  public void a(long paramLong, List<String> arg3, Activity paramActivity, arqw paramarqw)
  {
    ...
    for (;;)
    {
      ...
      a(1, "showChoosePath, callback[" + paramarqw + "]");
      ??? = b();
      arrd localarrd = c();
      if (((arrd)???).jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_JavaLangString = alud.a(2131705055);
      }
      ...
      {
        label216:
        paramActivity.runOnUiThread(new FMSettings.5(this, paramActivity, ???, paramarqw));
        return;
        if ((localarrd == null) || (!localarrd.jdField_a_of_type_Boolean)) {
          break label216;
        }
        this.jdField_a_of_type_JavaLangString = alud.a(2131705051);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        ...
        {
          ((arrd)this.jdField_a_of_type_JavaUtilMap.get("sdCard")).a(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public long b()
  {
    ...
    localObject = ((arrd)localObject).jdField_b_of_type_JavaLangString;
    try
    {
      localObject = new StatFs((String)localObject);
      long l = ((StatFs)localObject).getAvailableBlocks();
  ...
  public void b()
  {
    ...
    {
      a(1, "FMSettings free");
      Field localField = this.jdField_a_of_type_Bdjz.getClass().getSuperclass().getDeclaredField("mShowing");
      localField.setAccessible(true);
      localField.set(this.jdField_a_of_type_Bdjz, Boolean.valueOf(true));
