...
public class qyk
{
  ...
  private static void b(ArticleInfo paramArticleInfo, JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          if (((pvp)localObject).a().a(paramArticleInfo.mArticleID)) {}
  ...
  public static void c(ArticleInfo paramArticleInfo)
  {
    ...
    if (localObject != null)
    {
      localObject = (pvp)((QQAppInterface)localObject).getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER);
      if (localObject != null) {
        ((pvp)localObject).a().a(paramArticleInfo.mArticleID, System.currentTimeMillis());
      }
    }
  ...
  private static void c(ArticleInfo paramArticleInfo, JSONObject paramJSONObject)
  {
    ...
    String str3 = raj.a().a("default_feeds", str1);
    ...
    if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty(paramJSONObject.toString())) && (!TextUtils.isEmpty(str3)))
    {
      ...
      paramArticleInfo.ptsItemDataBytes = raf.a(paramArticleInfo.ptsItemData);
    ...
    for (;;)
    {
      ...
      paramJSONObject = (pvp)paramJSONObject.getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER);
      if (paramJSONObject == null) {
        break;
      }
