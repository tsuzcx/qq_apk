...
{
  scz(scx paramscx, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    scx.a(this.jdField_a_of_type_Scx).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.d(scx.b(this.jdField_a_of_type_Scx), 2, paramBundle.getMessage());
        continue;
      ...
      if (QLog.isColorLevel()) {
        QLog.d(scx.b(this.jdField_a_of_type_Scx), 2, "build struct msg fail");
      }
      return;
