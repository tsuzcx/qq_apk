  ...
  extends SQLiteOpenHelper
{
  ...
  private int a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   20: astore 6
    //   22: aload_0
    //   23: invokevirtual 35	c/t/m/g/ba:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   26: astore 10
    //   28: iload_1
    //   29: ifeq +41 -> 70
    //   32: iload_2
  ...
  public static ba a(String paramString)
  {
    synchronized (b)
    {
      ...
      {
        m.b();
        localObject1 = new StringBuilder("HalleyAction_");
        ((StringBuilder)localObject1).append(m.c());
        ((StringBuilder)localObject1).append("_");
        ((StringBuilder)localObject1).append(m.i());
        ((StringBuilder)localObject1).append("_");
  ...
  public final void a(java.util.List<java.lang.Long> paramList)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokeinterface 124 1 0
    //   6: ifgt +4 -> 10
    //   9: return
    //   10: aload_0
    //   11: invokevirtual 35	c/t/m/g/ba:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore 4
    //   16: new 126	android/content/ContentValues
    //   19: dup
    //   20: invokespecial 127	android/content/ContentValues:<init>	()V
    //   23: astore 5
    //   25: aload 5
    //   27: ldc 129
    //   29: ldc 53
    ...
    //   75: checkcast 149	java/lang/Long
    //   78: invokevirtual 153	java/lang/Long:longValue	()J
    //   81: invokestatic 157	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   84: aastore
    //   85: invokevirtual 161	android/database/sqlite/SQLiteDatabase:update	(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    //   88: pop
    //   89: goto -47 -> 42
    //   92: aload_1
    ...
    //   126: checkcast 149	java/lang/Long
    //   129: invokevirtual 153	java/lang/Long:longValue	()J
    //   132: invokestatic 157	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   135: aastore
    //   136: invokevirtual 165	android/database/sqlite/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   139: pop
    //   140: goto -41 -> 99
    //   143: aload_0
    //   144: iconst_0
    //   145: iconst_1
    //   146: invokespecial 167	c/t/m/g/ba:a	(ZZ)I
    //   149: ifle +32 -> 181
    //   152: aload_0
    //   153: iconst_1
    //   154: iconst_0
    //   155: invokespecial 167	c/t/m/g/ba:a	(ZZ)I
    //   158: istore_2
    //   159: iload_2
    //   160: ifgt +21 -> 181
    //   163: aload 4
    //   165: ldc 169
    //   167: invokevirtual 172	android/database/sqlite/SQLiteDatabase:execSQL	(Ljava/lang/String;)V
    //   170: aload 4
    //   172: ldc 174
    //   174: invokevirtual 172	android/database/sqlite/SQLiteDatabase:execSQL	(Ljava/lang/String;)V
    //   177: return
    //   178: astore_1
    //   179: aload_1
    //   180: athrow
  ...
  /* Error */
  public final java.util.List<ba.a> b(int paramInt)
  {
    // Byte code:
    ...
    //   13: astore 7
    //   15: aload_0
    //   16: invokevirtual 35	c/t/m/g/ba:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   19: ldc 37
    //   21: aconst_null
    //   22: ldc 49
    //   24: iconst_1
    ...
    //   61: iload_1
    //   62: invokestatic 202	java/lang/Math:min	(II)I
    //   65: istore_2
    //   66: aload 8
    //   68: astore 7
    //   70: aload 8
    ...
    //   168: astore 6
    //   170: aload 9
    //   172: new 219	c/t/m/g/ba$a
    //   175: dup
    //   176: lload_3
    //   177: aload 10
    //   179: iconst_0
    //   180: invokespecial 222	c/t/m/g/ba$a:<init>	(JLjava/lang/String;B)V
    //   183: invokeinterface 225 2 0
    //   188: pop
    //   189: iload_1
    //   190: iconst_1
    //   191: iadd
