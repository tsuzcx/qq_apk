  ...
  extends PhoneStateListener
{
  ...
  private void c()
  {
    eq localeq = eq.a(this.b, this.c, this.f);
    try
    {
      if ((this.e != null) && (localeq != null))
      {
        ec.b localb = new ec.b(this.b);
        localb.a = localeq;
        this.e.post(localb);
      }
      return;
  ...
  final boolean a(CellLocation paramCellLocation)
  {
    ...
    {
      if (fg.a(paramCellLocation) < 0) {
        return false;
      }
      if (fg.a(this.c, paramCellLocation)) {
        return false;
      }
      paramCellLocation = eq.a(this.b, paramCellLocation, null);
      if (paramCellLocation == null) {}
      for (boolean bool = true; bool; bool = fg.a(paramCellLocation)) {
        return true;
      }
    }
    return false;
  ...
  public final void onSignalStrengthsChanged(SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int i = this.b.b.a;
        if ((localSignalStrength == null) || (fg.a(i, localSignalStrength, paramSignalStrength)))
        {
