...
public final class en
{
  ...
  public static CellLocation a(da paramda)
  {
    boolean bool2 = false;
    ...
    if (localTelephonyManager != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          if (a) {
            f.a.b("Cells", "location permission denied!");
          }
      ...
      {
        f.a.a("Cells", "cannot get cell location", paramda);
        a = true;
      }
    }
  }
  ...
  public static void a(@NonNull TelephonyManager paramTelephonyManager, @NonNull int[] paramArrayOfInt)
  {
    ...
    if ((paramTelephonyManager != null) && (paramTelephonyManager.length() >= 5)) {
      ...
      {
        f.a.b("Cells", paramTelephonyManager.toString());
      }
    }
  ...
  {
    if (f.a.a(paramCellLocation1, paramCellLocation2)) {}
    do
    {
      do
      {
  ...
  public static boolean a(ea paramea)
  {
    ...
    return a(paramea.a, paramea.b, paramea.c, paramea.d, paramea.e);
  }
  ...
  public static List<NeighboringCellInfo> b(da paramda)
  {
    paramda = paramda.c();
    if (paramda != null) {
      try
      {
        paramda = paramda.getNeighboringCellInfo();
        return paramda;
      }
      catch (Exception paramda)
      {
        f.a.a("Cells", "cannot get NeighboringCellInfo", paramda);
      }
    }
