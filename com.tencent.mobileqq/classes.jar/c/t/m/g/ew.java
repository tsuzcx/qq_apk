...
public final class ew
{
  ...
  public ew(ey paramey, eu parameu, ev paramev)
  {
    this.b = paramey;
    this.c = parameu;
    this.d = paramev;
      ...
      try
      {
        ...
        if (this.c == null)
        {
          ...
          if (localObject1 == null)
          {
            ...
            localObject2 = "{}";
            eb localeb = paramea.b;
            localObject3 = new HashMap();
            ((HashMap)localObject3).put("imei", localeb.a());
            ((HashMap)localObject3).put("imsi", localeb.b());
            if (localeb.p == null) {
              localeb.p = new Pair((String)dy.b("LocationSDK", "location_device_id_type", ""), (String)dy.b("LocationSDK", "location_device_id", ""));
            }
            ((HashMap)localObject3).put("idfa", localeb.p.second);
            ((HashMap)localObject3).put("phonenum", co.e(localeb.d));
            ((HashMap)localObject3).put("qq", co.e(localeb.f));
            ((HashMap)localObject3).put("mac", localeb.c().toLowerCase(Locale.ENGLISH));
            localObject5 = new JSONObject((Map)localObject3).toString();
            String str2 = localeb.f();
            fm.a();
            int k = fm.a(paramea.a);
            String str1 = fq.c(paramea);
            localObject3 = localeb.j;
            ...
            paramea = (String)localObject3 + "_" + localeb.h;
            int j = 203;
            i = j;
            if (paramBoolean2)
            {
              localObject3 = localeb.a();
              i = j;
              if (localObject3 != null) {
                i = Math.abs(((String)localObject3).hashCode()) % 1000 + 1001;
              }
            }
            localObject3 = "{\"version\":\"" + localeb.d() + "\",\"address\":" + paramInt1;
        ...
        localObject1 = Collections.unmodifiableList(((ey)localObject1).b);
        break label1118;
        ...
        localObject1 = ((StringBuilder)localObject2).toString();
        continue;
        localObject3 = ((ev)localObject2).a;
        ...
        ((StringBuilder)localObject5).append("\"" + d3 + "," + d4 + "," + d5 + "," + d6 + "," + ((ev)localObject2).b + "\"");
        ((StringBuilder)localObject5).append("}");
