...
public final class cm
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new cm();
    ((cm)localObject).a();
    ((cm)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((cm)localObject).c, 8);
    ...
    ((cm)localObject).a(a, i);
    ((cm)localObject).a(paramString, 8);
    a(((cm)localObject).e, ((cm)localObject).b, 16);
    paramString = ((cm)localObject).e;
  ...
  private boolean a(InputStream paramInputStream, long paramLong)
  {
    ...
    try
    {
      ...
      while (j < m)
      {
        paramInputStream[(i + j)] = arrayOfByte1[j];
        j += 1;
      }
      return true;
    }
