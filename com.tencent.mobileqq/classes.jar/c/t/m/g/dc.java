  ...
  implements Observer
{
  ...
  volatile ConcurrentHashMap<String, List<Object>> d = null;
  ...
  public static dc a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 43	c/t/m/g/dc:f	Lc/t/m/g/dc;
    //   6: ifnonnull +19 -> 25
    //   9: ldc 2
    //   11: monitorenter
    //   12: new 2	c/t/m/g/dc
    //   15: dup
    //   16: invokespecial 105	c/t/m/g/dc:<init>	()V
    //   19: putstatic 43	c/t/m/g/dc:f	Lc/t/m/g/dc;
    //   22: ldc 2
    //   24: monitorexit
    //   25: getstatic 43	c/t/m/g/dc:f	Lc/t/m/g/dc;
    //   28: astore_0
    //   29: ldc 2
    //   31: monitorexit
    //   32: aload_0
  ...
  private void c()
  {
    ...
    {
      cy.a("CC_Set", localThrowable.getMessage(), localThrowable);
    }
  }
  
  private static void d()
  {
    SharedPreferences localSharedPreferences = dd.a().b();
    if (localSharedPreferences == null) {}
    String str;
    do
    {
      return;
      str = localSharedPreferences.getString("app_version", "");
    } while ((c.length() <= 0) || (c.equals(str)));
    cy.a("CC_Set", "clear sp > pre:" + str + ",now:" + c);
  ...
  private void f(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        cy.b("CC_Set", paramString.toString());
      }
    }
  }
  ...
  protected final void b()
  {
    if (dd.a().b() == null)
    {
      cy.a("CC_Set", "---> read xml: failed,not init finish!");
      return;
    }
    ...
    this.i = true;
    cy.a("CC_Set", "---> read xml:" + this.h.toString());
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      f(paramObservable);
      cy.a("CC_Set", paramObject + (String)this.h.get(paramObservable));
