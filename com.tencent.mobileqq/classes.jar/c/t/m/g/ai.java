  ...
  extends SSLSocketFactory
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      {
        paramSocket = (SSLSocket)((SSLCertificateSocketFactory)SSLCertificateSocketFactory.getInsecure(10000, new SSLSessionCache(l.a()))).createSocket(paramSocket, this.c, paramInt, paramBoolean);
      ...
      paramString = (SSLCertificateSocketFactory)SSLCertificateSocketFactory.getInsecure(10000, new SSLSessionCache(l.a()));
  ...
  {
    if ((TextUtils.isEmpty(this.c)) || (!(paramObject instanceof ai))) {}
    do
    {
      return false;
      paramObject = ((ai)paramObject).c;
