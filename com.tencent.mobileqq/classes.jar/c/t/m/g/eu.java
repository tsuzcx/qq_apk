  ...
  extends ex
{
  ...
  @SuppressLint({"NewApi"})
  private static eu a(ea paramea, CellInfo paramCellInfo)
  {
    int n = -88;
    ...
    do
    {
      for (;;)
      {
        try
        {
          ...
          paramea.a = eu.a.c;
          paramea.a((TelephonyManager)localObject, eu.a.c);
  ...
  public static eu a(ea paramea, CellLocation paramCellLocation, SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramea.a = eu.a.c;
        paramea.a(localTelephonyManager, eu.a.c);
      ...
      paramea.a = eu.a.b;
      paramea.a(localTelephonyManager, eu.a.b);
  ...
  @SuppressLint({"NewApi"})
  public static eu a(ea paramea, List<CellInfo> paramList)
  {
    if ((paramList == null) || (paramea == null) || (paramList.size() == 0)) {
      return new eu();
    }
    ArrayList localArrayList = new ArrayList();
    Object localObject = new eu();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((CellInfo)localObject).isRegistered())
      {
        ...
        if (((eu)localObject).d())
        {
          paramList.k.add(((eu)localObject).c());
          if (n != 0)
          {
            ((eu)localObject).j = true;
            n = 0;
            paramList = (List<CellInfo>)localObject;
          }
          else
  ...
  private void a(TelephonyManager paramTelephonyManager, eu.a parama)
  {
    int i2 = 0;
    int n = 0;
