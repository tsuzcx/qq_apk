...
public class apda
{
  ...
  public static EntityManager a()
  {
    if (jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager == null) {
      jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = new apdh().createEntityManager();
    }
  ...
  public static void a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), apdg.class);
    ...
    localNewIntent.setObserver(new apdb(paramRockDownloaderTask));
  ...
  private static boolean a(Context paramContext, VFSFile paramVFSFile)
  {
    ...
    //   143: invokestatic 356	apda:a	(Landroid/content/Context;Ljava/lang/String;)Lcom/tencent/mobileqq/data/RockDownloadInfo;
    //   146: astore_0
    //   147: aload_0
    //   148: ifnull +50 -> 198
    //   151: aload 5
  ...
  private static void b(RockDownloaderTask paramRockDownloaderTask, DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (bool2))
      {
        ...
        localObject = (DownloadInfo)bhyo.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
  ...
  private static void b(@NonNull RockDownloaderTask paramRockDownloaderTask, String paramString)
  {
    ...
    if (localObject != null)
    {
      localStringBuilder.append(((RockDownloadInfo)localObject).getBusinessName()).append("&").append(((RockDownloadInfo)localObject).getBusinessScene()).append("&").append(((RockDownloadInfo)localObject).getPackageName()).append("&").append(bjms.a("0"));
      ...
      localHashMap.put("IMEI", bjms.a("0"));
    ...
    try
    {
      ...
      {
        bcef.b((QQAppInterface)paramRockDownloaderTask.getRuntime(), "dc00898", "", ((QQAppInterface)paramRockDownloaderTask.getRuntime()).getCurrentUin(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
      ...
      for (;;)
      {
        ...
        bcef.b(null, "dc00898", "", paramRockDownloaderTask.getRuntime().getAccount(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
    ...
    catch (Throwable paramRockDownloaderTask)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          bcef.b(null, "dc00898", "", "", paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
  ...
  private static void b(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2, boolean paramBoolean, RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), amtj.a(2131712606), 10010);
    }
    for (;;)
    {
      paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      paramString = (DownloadInfo)bhyo.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
  ...
  private static void d(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    {
      localapdc = new apdc(paramRockDownloaderTask, bool);
      Iterator localIterator = bhyo.a().a().values().iterator();
      ...
      bhyo.a().b(localDownloadInfo1);
      if (bool)
      {
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), amtj.a(2131712603), 10011);
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      }
      return;
    }
  ...
  {
    Object localObject = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), apdg.class);
