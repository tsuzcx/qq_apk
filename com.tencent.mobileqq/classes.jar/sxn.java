  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (((LebaViewItem)localObject2).a.uiResId == 3050L) {
    ...
    else if (System.currentTimeMillis() - LocalMultiProcConfig.getLong(BaseApplicationImpl.getContext().getString(2131434208) + this.a.a.getAccount(), 0L) > 86400000L)
    {
      localObject1 = new HashMap();
      if (!LocalMultiProcConfig.getBool(BaseApplicationImpl.getContext().getString(2131434207) + this.a.a.getAccount(), true)) {
        break label624;
      }
    ...
    for (;;)
    {
      ...
      LocalMultiProcConfig.putLong(BaseApplicationImpl.getContext().getString(2131434208) + this.a.a.getAccount(), System.currentTimeMillis());
      return;
