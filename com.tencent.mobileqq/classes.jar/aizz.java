...
public class aizz
  implements ajif
{
  public aizz(CmGameServerQIPCModule.5 param5) {}
  ...
  public void a(boolean paramBoolean, String paramString, List<ajid> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString = ajgn.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloScriptSpriteTaskParam, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkIPCSpriteContext, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkCmShowRenderView$PlayActionConfig);
