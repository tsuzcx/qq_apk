...
public class bcvk
{
  ...
  private List<bcvi> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bcvk(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_Int = azto.a(paramQQAppInterface, paramInt1, bdwu.a().a());
    azte.a(paramString);
  }
  ...
  {
    azte.a(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, paramInt);
  }
