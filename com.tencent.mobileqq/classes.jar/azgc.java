  ...
  implements View.OnClickListener
{
  ...
  public azgc(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130846926);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131696534);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131718308);
  ...
  {
    int i = (int)bbdv.a(paramContext, 60.0F);
    int j = (int)bbdv.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559719, null);
      localazgd = new azgd();
      localazgd.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131378718));
      localazgd.b = ((ImageView)localView.findViewById(2131367975));
      localazgd.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131375526));
      localView.setTag(localazgd);
      ...
      localazgd.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localazgd.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841989);
      localazgd.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localazgd.b.setVisibility(8);
    }
    label245:
    String str;
    label260:
    do
    {
      ...
      return localView;
      localazgd = (azgd)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label306:
      i = Math.min(100, i);
      localazgd.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localazgd.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localazgd.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localazgd.b.setVisibility(0);
      localazgd.b.setTag(Integer.valueOf(paramInt));
      localazgd.b.setOnClickListener(this);
      localazgd.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label288;
      label469:
