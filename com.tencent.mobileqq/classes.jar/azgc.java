...
public class azgc
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, Card paramCard)
  {
    for (;;)
    {
      try
      {
        ...
        localObject = ((anmw)localObject).b(paramString2);
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, Intent paramIntent, int paramInt)
  {
    ...
    Object localObject = ((anmw)paramQQAppInterface.getManager(51)).e(str2);
    ...
    {
      paramQQAppInterface.a = abao.a(str1, 1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    if (((bftx)paramQQAppInterface.getManager(203)).b(paramString2))
    {
      bfpx.a(paramContext, paramString1, paramString2);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    Object localObject2 = ((anmw)paramQQAppInterface.getManager(51)).a(paramString2);
    ...
    {
      paramQQAppInterface.a = abao.a(paramString1, 1);
  ...
  public static boolean a(TroopInfo paramTroopInfo, TroopMemberCard paramTroopMemberCard, TextView paramTextView)
  {
    ...
    if (!TextUtils.isEmpty(paramTroopMemberCard.mUniqueTitle))
    {
      ...
      paramTroopMemberCard = beui.a().a(bool2, bool3);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label49;
        label195:
        if ((bool5) && (!bfpj.a(paramTroopMemberCard.titleId))) {
          break;
        }
        beuj localbeuj = beui.a().a(paramTroopMemberCard.titleId, bool1, bool2, bool3);
        if (localbeuj != null)
        {
          str = localbeuj.jdField_a_of_type_JavaLangString;
          j = localbeuj.b;
          if (localbeuj.jdField_a_of_type_Int == 302) {
            str = paramTroopMemberCard.mUniqueTitle;
          }
          i = j;
          if (localbeuj.jdField_a_of_type_Int != 315) {
            break label92;
          }
