  ...
  implements View.OnClickListener
{
  ...
  {
    if (paramView != null) {
      paramContext = (bdtm)paramView.getTag();
    }
    for (;;)
    {
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.ad = bcsa.a(paramObjectInput.readUTF(), false);
    this.ae = bcsa.a(paramObjectInput.readUTF(), false);
    this.b = bcsa.a(paramObjectInput.readUTF(), false);
  }
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    this.ad = parambdqc.a("leftImage");
    this.ae = parambdqc.a("rightImage");
    this.ac = bcsa.a(parambdqc.a("text"), false);
    return true;
  }
