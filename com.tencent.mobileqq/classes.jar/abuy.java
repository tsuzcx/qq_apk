  ...
  implements bfbg
{
  ...
  public abuy(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = abux.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bfba(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bfax)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bfbf)((bfba)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bfbf)localObject1).a(this);
          ((bfbf)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
