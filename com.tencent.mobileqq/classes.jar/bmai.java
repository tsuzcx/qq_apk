  ...
  implements Closeable
{
  ...
  public bmai(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, bmaj parambmaj)
  {
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = parambmaj.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((parambmaj.jdField_a_of_type_ArrayOfByte == null) || (parambmaj.jdField_a_of_type_ArrayOfByte.length < m)) {
        parambmaj.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = parambmaj.jdField_a_of_type_ArrayOfByte;
      parambmaj.jdField_a_of_type_Int = m;
    ...
    catch (Throwable parambmaj)
    {
      QLog.e("BlobCache", 2, "getBlob failed.", parambmaj);
      return false;
    }
    finally
    {
  ...
  public boolean a(bmaj parambmaj)
  {
    if ((a(parambmaj.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, parambmaj))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(parambmaj.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, parambmaj))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + parambmaj.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      b(parambmaj.jdField_a_of_type_Long, parambmaj.jdField_a_of_type_ArrayOfByte, parambmaj.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
