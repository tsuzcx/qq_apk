...
public class nnj
{
  ...
  {
    File localFile = new File(antf.ba + "photo/");
    if ((!localFile.exists()) && (!localFile.mkdirs()))
    {
      a();
      QQToast.a(paramActivity, 1, paramActivity.getString(2131690589), 0).a();
      return;
    }
    ...
    a(paramActivity, localIntent, 2131690576);
  }
  ...
  {
    Object localObject = new File(antf.ba + "photo/");
    ...
    a(paramActivity, (Intent)localObject, 2131690576);
  }
  
  private void c(Activity paramActivity)
  {
    a(paramActivity, new Intent("android.provider.MediaStore.RECORD_SOUND"), 2131690591);
  }
  ...
  public void a(Activity paramActivity, int paramInt, ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (paramInt != 0)
      {
        paramString2 = blir.a(paramActivity);
        paramString2.a(new nnk(this));
        paramString2.setOnCancelListener(new nnl(this));
        if (paramValueCallback.equals("camera"))
        {
          paramString2.a(paramActivity.getString(2131718535), 0);
          paramString2.a(paramActivity.getString(2131692185), 0);
          paramString2.a(new nnm(this, paramActivity, paramString1, paramString2));
        }
        for (;;)
        {
          paramString2.show();
          ...
          {
            paramString2.a(paramActivity.getString(2131717899), 0);
            paramString2.a(paramActivity.getString(2131692185), 0);
            paramString2.a(new nnn(this, paramActivity, paramString1, paramString2));
          }
          else if (paramValueCallback.equals("microphone"))
          {
            paramString2.a(paramActivity.getString(2131717400), 0);
            paramString2.a(paramActivity.getString(2131692185), 0);
            paramString2.a(new nno(this, paramActivity, paramString1, paramString2));
          }
        }
      }
      a(paramActivity, paramString1);
