  ...
  implements Handler.Callback
{
  ...
  public whv(Context paramContext, xnv paramxnv)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Xnv = paramxnv;
    this.jdField_a_of_type_Aljj = aljj.a();
    this.jdField_a_of_type_Aljj.a(paramContext, hashCode(), "QrImageScan");
  }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Aljj != null) {
        this.jdField_a_of_type_Aljj.a(hashCode(), "QrImageScan");
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int i = whm.a((Uri)paramMessage.obj, this.jdField_a_of_type_AndroidContentContext, j, (SparseArray)localObject);; i = 0)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((!whm.a(k)) || (paramMessage == null)) {
            break label350;
          }
          i = 1;
          if ((!whm.b(k)) || (paramMessage == null)) {
            break label355;
          }
          j = 1;
          if ((i == 0) && (j == 0)) {
      ...
      this.jdField_a_of_type_Xnv.a(String.valueOf(paramMessage.obj), i, j);
      return true;
      i = paramMessage.arg1;
      if (this.jdField_a_of_type_Xnv == null) {
        break;
      }
      this.jdField_a_of_type_Xnv.a(i);
      return true;
    }
  }
}
