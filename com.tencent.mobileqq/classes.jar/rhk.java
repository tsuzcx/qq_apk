...
class rhk
  implements bhqd
{
  rhk(rhf paramrhf, bhpy parambhpy, String paramString1, MessageForShortVideo paramMessageForShortVideo, String paramString2, boolean paramBoolean, String paramString3, String paramString4, String paramString5) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    do
    {
      ...
      if (paramView.equals(this.b))
      {
        ...
        {
          paramView = bizt.a();
          bizm.c(rhf.a(this.jdField_a_of_type_Rhf), paramView, this.c, 10001);
        ...
        for (;;)
        {
          ...
          return;
          QQToast.a(rhf.a(this.jdField_a_of_type_Rhf), 0, 2131720085, 0).b(rhf.a(this.jdField_a_of_type_Rhf).getResources().getDimensionPixelSize(2131298914));
        }
      }
