  ...
  extends VasWebviewJsPlugin
{
  ...
  public boolean handleJsRequest(com.tencent.mobileqq.webview.swift.JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    //   112: aload_1
    //   113: aload_0
    //   114: getfield 93	biiy:mOnRemoteResp	Laphy;
    //   117: getfield 99	aphy:key	I
    //   120: aconst_null
    //   121: invokestatic 104	apic:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   124: iconst_0
    //   125: iconst_1
    ...
    //   189: astore_3
    //   190: aload_0
    //   191: getfield 18	biiy:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   194: invokestatic 125	bdee:g	(Landroid/content/Context;)Z
    //   197: ifne +39 -> 236
    //   200: aload_3
    //   201: ldc 127
    //   203: bipush 254
    ...
    //   358: aload_1
    //   359: aload_0
    //   360: getfield 93	biiy:mOnRemoteResp	Laphy;
    //   363: getfield 99	aphy:key	I
    //   366: aload_3
    //   367: invokestatic 104	apic:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   370: iconst_0
    //   371: iconst_1
    ...
    //   422: aastore
    //   423: invokevirtual 182	biiy:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   426: goto -297 -> 129
    //   429: astore_2
    ...
    //   462: aload_1
    //   463: aload_0
    //   464: getfield 93	biiy:mOnRemoteResp	Laphy;
    //   467: getfield 99	aphy:key	I
    //   470: aconst_null
    //   471: invokestatic 104	apic:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   474: iconst_0
    //   475: iconst_1
