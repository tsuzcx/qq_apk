  ...
  extends LinearLayout
{
  ...
  public bpbv(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
    ...
    paramInt1 = bpdd.b(getContext(), 6.0F);
  ...
  private void a()
  {
    setOrientation(0);
    setGravity(17);
    int j = bpdd.b(getContext(), 12.0F);
    int k = (int)((this.c - j * 2) * this.jdField_a_of_type_Float);
    int i = 0;
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131559143, null);
  ...
  public void a(bpbc parambpbc, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131370522);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131370507);
      localObject3 = (TextView)((View)localObject1).findViewById(2131370523);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131370521);
      str = parambpbc.b(paramInt2);
      localObject1 = parambpbc.a(paramInt2);
      if (localObject1 != null) {
        break label146;
      }
      ykq.e("LocationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambpbc.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
    ...
    Object localObject2 = new bpbw((String)localObject1, localURLImageView, localProgressBar);
    ...
    if (((URLDrawable)localObject1).getStatus() == 1) {
      ((bpbw)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
    }
    if (paramBoolean) {}
    for (;;)
    {
