...
public class bgld
{
  ...
  public static bgld a()
  {
    if (jdField_a_of_type_Bgld == null) {}
    try
    {
      if (jdField_a_of_type_Bgld == null) {
        jdField_a_of_type_Bgld = new bgld();
      }
      return jdField_a_of_type_Bgld;
    }
    finally {}
  }
  ...
  {
    paramString = bgle.a().a(paramString);
  ...
  public String a(String paramString, bgle parambgle)
  {
    String str1 = paramString;
    if (parambgle.c != null) {
      str1 = paramString.replace("<$FROM>", parambgle.c);
    }
    paramString = str1;
    if (parambgle.a != null) {
      paramString = str1.replace("<$GC>", parambgle.a);
    }
    str1 = paramString;
    if (parambgle.e != null) {
      str1 = paramString.replace("<$NICK>", parambgle.e);
    }
    paramString = str1;
    if (parambgle.d != null) {
      paramString = str1.replace("<$TYPE>", parambgle.d);
    }
    str1 = paramString;
    if (parambgle.b != null) {
      str1 = paramString.replace("<$UIN>", parambgle.b);
    }
    paramString = str1;
    if (parambgle.f != null) {
      paramString = str1.replace("<$CATEID>", parambgle.f);
    }
    str1 = paramString;
    if (parambgle.g != null) {
      str1 = paramString.replace("<$SUBID>", parambgle.g);
    }
    paramString = str1;
    if (parambgle.j != null) {
      paramString = str1.replace("<$GRAY>", parambgle.j);
    }
    str1 = paramString;
    if (parambgle.h != null) {}
    try
    {
      str1 = paramString.replace("<$TITLE>", URLEncoder.encode(parambgle.h, "UTF-8").replaceAll("\\+", "%20"));
      paramString = str1;
      if (parambgle.i == null) {}
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = str1.replace("<$CONTENT>", URLEncoder.encode(parambgle.i, "UTF-8").replaceAll("\\+", "%20"));
          return paramString;
        }
  ...
  {
    paramString1 = bgle.a().b(paramString2).a(paramString1);
  ...
  {
    paramString3 = bgle.a().a(paramString1).b(paramString2).e(paramString3).d("3").c("aio");
  ...
  {
    Object localObject = bgle.a().a(paramString);
    if (paramBoolean) {}
    for (paramString = "1";; paramString = "0")
    {
      paramString = ((bgle)localObject).f(paramString);
  ...
  public String b(String paramString, bgle parambgle)
  {
