...
public class batq
{
  ...
  public batq()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new batr(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), this);
  }
  ...
  private void b(String paramString)
  {
    ...
    if (bcjb.o == 16)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaFormat.setInteger("bitrate", bcjb.n);
      ...
      if (!paramString.exists()) {
        bgmg.c(paramString.getAbsolutePath());
      }
