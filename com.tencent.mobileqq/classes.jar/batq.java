...
{
  private static final String c = aljq.cr + "longMsgList.ini";
  private static final String d = aljq.cr + "longMsgList.tmp";
  ...
  private void b()
  {
    ...
    //   7: aload_2
    //   8: astore_1
    //   9: getstatic 36	batq:c	Ljava/lang/String;
    //   12: invokestatic 88	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   15: astore 5
    //   17: aload_2
    //   18: astore_1
    //   19: aload 5
    ...
    //   97: putfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   100: aload_0
    //   101: aload_2
    //   102: invokevirtual 130	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   105: putfield 134	batq:b	Ljava/lang/String;
    //   108: aload_0
    //   109: getfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   112: ifnull +14 -> 126
    //   115: aload_0
    //   116: aload_0
    //   117: getfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   120: invokespecial 136	batq:a	(Ljava/lang/String;)Z
    //   123: ifne +8 -> 131
    //   126: aload_0
    //   127: aconst_null
    //   128: putfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   131: aload_0
    //   132: getfield 134	batq:b	Ljava/lang/String;
    //   135: ifnull +14 -> 149
    //   138: aload_0
    //   139: aload_0
    //   140: getfield 134	batq:b	Ljava/lang/String;
    //   143: invokespecial 136	batq:a	(Ljava/lang/String;)Z
    //   146: ifne +8 -> 154
    //   149: aload_0
    //   150: aconst_null
    //   151: putfield 134	batq:b	Ljava/lang/String;
    //   154: aload_2
    //   155: ifnull -96 -> 59
    //   158: aload_2
  ...
  private void c()
  {
    ...
    //   9: aload_2
    //   10: astore_1
    //   11: getstatic 36	batq:c	Ljava/lang/String;
    //   14: invokestatic 88	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   17: astore 5
    //   19: aload_2
    //   20: astore_1
    //   21: aload 5
    ...
    //   38: astore_1
    //   39: aload_0
    //   40: getfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   43: ifnonnull +52 -> 95
    //   46: aload_2
    //   47: astore_1
    //   48: aload_0
    //   49: getfield 134	batq:b	Ljava/lang/String;
    //   52: astore 6
    //   54: aload 6
    //   56: ifnonnull +39 -> 95
    //   59: iconst_0
    ...
    //   95: aload_2
    //   96: astore_1
    //   97: getstatic 40	batq:d	Ljava/lang/String;
    //   100: invokestatic 88	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   103: astore 6
    //   105: aload_2
    //   106: astore_1
    //   107: aload 6
    ...
    //   156: astore_2
    //   157: aload_0
    //   158: getfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   161: ifnull +77 -> 238
    //   164: aload_0
    //   165: getfield 132	batq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: astore_1
    //   169: aload_2
    //   170: aload_1
    ...
    //   180: aload_0
    //   181: getfield 134	batq:b	Ljava/lang/String;
    //   184: ifnull +60 -> 244
    //   187: aload_0
    //   188: getfield 134	batq:b	Ljava/lang/String;
    //   191: astore_1
    //   192: aload_2
    //   193: aload_1
  ...
  public void a(basp parambasp)
  {
    ...
    do
    {
      ...
      localStringBuilder.append("http://").append(parambasp.jdField_a_of_type_JavaLangString);
      if (parambasp.jdField_a_of_type_Int != 80) {
        localStringBuilder.append(":").append(parambasp.jdField_a_of_type_Int);
      }
      localStringBuilder.append("/");
      parambasp = localStringBuilder.toString();
      int i = j;
      if (this.jdField_a_of_type_JavaLangString != null)
      {
        i = j;
        if (this.jdField_a_of_type_JavaLangString.equals(parambasp))
        {
  ...
  public void b(basp parambasp)
  {
    if ((parambasp != null) && (this.jdField_a_of_type_Int != 0))
    {
      StringBuilder localStringBuilder = new StringBuilder(200);
      localStringBuilder.append("http://").append(parambasp.jdField_a_of_type_JavaLangString);
      if (parambasp.jdField_a_of_type_Int != 80) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 2) {
        this.jdField_a_of_type_JavaLangString = parambasp;
      }
    }
  }
