  ...
  extends bokw
{
  ...
  public boms(int paramInt)
  {
    super(null);
    this.jdField_a_of_type_Bomw = new bomt(this);
    this.d = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = ((QIMMusicConfigManager)bojv.a(2)).b(paramInt);
  }
  ...
  public int a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool = bgmg.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath());
        if (bool) {
          continue;
        }
      }
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    MusicProviderView localMusicProviderView2 = (MusicProviderView)paramActivity.findViewById(2131364154);
    MusicProviderView localMusicProviderView1 = localMusicProviderView2;
    if (localMusicProviderView2 == null)
    {
      ((QIMProviderContainerView)paramActivity.findViewById(2131372978)).a(104);
      localMusicProviderView1 = (MusicProviderView)paramActivity.findViewById(2131364154);
      localMusicProviderView1.g();
    }
    paramActivity = ((bone)bojv.a().c(8)).a();
  ...
  public int b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (!bgmg.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()))
          {
            if (QLog.isColorLevel()) {
            ...
            QimMusicDownloader.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.mUrl, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath(), this.jdField_a_of_type_Bomw);
            a();
            i = 2;
            continue;
          }
