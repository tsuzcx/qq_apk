...
public class benn
{
  ...
  private static benq jdField_a_of_type_Benq = new benq(Looper.getMainLooper(), null);
  ...
  private static BlockingQueue<WeakReference<benn>> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new LinkedBlockingQueue();
  ...
  public benn(Context paramContext)
  {
  ...
  public static int a(Context paramContext)
  {
    ...
    try
    {
      ...
      while (betc.a())
      {
        betc.a("PushOpenNotify", "isNotificationEnabled,  isEnabled, " + bool);
        break;
    ...
    {
      if (betc.a()) {
        betc.a("PushOpenNotify", " isNotificationEnabled, get except, " + paramContext.getMessage());
      }
      i = 2;
      return i;
    }
  ...
  public static benn a(Context paramContext, int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    paramContext = new benn(paramContext);
  ...
  public static benn a(Context paramContext, CharSequence paramCharSequence, int paramInt)
  {
  ...
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((jdField_a_of_type_Int == -1) || (paramBoolean))
      {
        ...
        betc.a("QQToast", "canUseCustomToast = " + jdField_a_of_type_Int);
        if ((i == 0) && (jdField_a_of_type_Int == 1)) {
          betc.a("QQToast", "Temp Report mark: now Notification from disable to Enabled ");
        }
      }
  ...
  {
    benp localbenp = new benp(this.jdField_a_of_type_AndroidContentContext);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      localbenp.setGravity(55, 0, 0);
    }
    for (;;)
    {
      localbenp.setView(localView);
      localbenp.setDuration(this.jdField_c_of_type_Int);
      if (a()) {
        localView.setOnTouchListener(new beno(this, localbenp, paramOnTouchListener));
      }
      return localbenp;
      ...
      if (paramInt1 == 6316128) {
        localbenp.setGravity(55, 0, a());
      } else {
        localbenp.setGravity(55, 0, b());
      }
    }
  }
  ...
  public void a()
  {
    ...
    jdField_a_of_type_Benq.sendEmptyMessage(2);
  }
