...
public class arbd
  implements bivd
{
  public arbd(LocationPickFragment paramLocationPickFragment, View paramView1, View paramView2, View paramView3, ImageView paramImageView, View paramView4) {}
  ...
  public void displayPanelFinish()
  {
    ...
    awqx.b(null, "CliOper", "", "", "0X800A95F", "0X800A95F", LocationPickFragment.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiLocationPickFragment).b(), 0, "", "0", "0", "");
    this.b.setVisibility(8);
    this.c.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqLocationUiLocationPickFragment.getString(2131628358));
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (LocationPickFragment.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiLocationPickFragment).b())) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848379);
    }
  }
  ...
  public void hidePanelFinish()
  {
    ...
    this.c.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqLocationUiLocationPickFragment.getString(2131628356));
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (!LocationPickFragment.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiLocationPickFragment).b())) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848378);
    }
  }
}
