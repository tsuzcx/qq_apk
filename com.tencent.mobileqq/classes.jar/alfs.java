...
public class alfs
{
  private WeakReference<algd> jdField_a_of_type_JavaLangRefWeakReference;
  private final ConcurrentHashMap<String, alfy> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  alfs(algd paramalgd)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramalgd);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    if (!a())
    {
      paramalgd = (AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web");
      if (paramalgd != null)
      {
  ...
  public static void a(alfs paramalfs, AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    boolean bool2 = true;
    ...
    do
    {
      do
      {
        ...
        Object localObject = new File(alfd.a());
        ...
        localObject = new beae("https://cmshow.gtimg.cn/qqshow/admindata/comdata/vipApollo_thunder_config/xydata.json", (File)localObject);
        ...
        ((beae)localObject).a(new alfu(localSharedPreferences, paramInt, paramalfs));
        paramalfs = (beag)paramAppInterface.getManager(47);
        paramBoolean = bool2;
        if (paramalfs != null)
        {
          paramalfs = paramalfs.a(3);
          paramBoolean = bool2;
          if (paramalfs != null)
          {
            paramalfs.a((beae)localObject, ((beae)localObject).a(), null);
            paramBoolean = false;
          }
        }
        if (paramBoolean) {
          ThreadManager.executeOnNetWorkThread(new ApolloSSOConfig.3((beae)localObject));
        }
  ...
  private boolean a()
  {
    ...
    Object localObject1 = new File(alfd.a());
    Object localObject2;
    int i;
    Object localObject4;
    int i1;
    ...
    if (((File)localObject1).exists())
    {
      try
      {
        localObject2 = alfd.a((File)localObject1);
        ...
        ((alfy)localObject2).jdField_a_of_type_Int = n;
        ((alfy)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ...
        if (k < i2)
        {
          ...
          localObject8 = new alfx(null);
          ((alfx)localObject8).jdField_a_of_type_JavaLangString = str1;
          ((alfx)localObject8).jdField_a_of_type_Int = i3;
          ((alfx)localObject8).b = str2;
      ...
      localObject7 = new alfw();
      ((alfw)localObject7).jdField_a_of_type_JavaLangString = ((String)localObject5);
      ((alfw)localObject7).jdField_a_of_type_Int = n;
      ((alfw)localObject7).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject6);
      ((alfy)localObject2).jdField_a_of_type_JavaUtilList.add(localObject7);
      break label1055;
      label543:
      ...
      localObject4 = new alfv();
      ((alfv)localObject4).jdField_a_of_type_JavaLangString = str1;
      ((alfv)localObject4).b = str2;
    ...
    for (;;)
    {
      if (k < i1)
      {
        ...
        if (localObject8 != null)
        {
          ...
          if (!TextUtils.isEmpty(str1))
          {
            ...
            localObject8 = new alfx(null);
            ((alfx)localObject8).jdField_a_of_type_JavaLangString = str1;
            ((alfx)localObject8).jdField_a_of_type_Int = i2;
            ((alfx)localObject8).b = str2;
      ...
      {
        ((alfv)localObject4).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject7);
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((alfv)localObject4).jdField_a_of_type_JavaUtilHashMap.put(localObject7, ((JSONObject)localObject5).optString((String)localObject7));
          }
        }
        ((alfy)localObject2).b.add(localObject4);
        break label1069;
        label935:
        if (QLog.isColorLevel())
        {
  ...
  public String a(String paramString)
  {
    ...
    {
      paramString = (alfy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (paramString != null) {
  ...
  public Set<String> a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = (alfy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (localObject != null)
      {
        paramString = new HashSet();
        localObject = ((alfy)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          alfw localalfw = (alfw)((Iterator)localObject).next();
          if ((localalfw != null) && (!TextUtils.isEmpty(localalfw.jdField_a_of_type_JavaLangString))) {
            paramString.add(localalfw.jdField_a_of_type_JavaLangString);
          }
        }
        return paramString;
      }
  ...
  public JSONObject a(String paramString1, String paramString2, String paramString3, AppInterface paramAppInterface)
  {
    ...
    paramString2 = (alfy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
    if (paramString2 != null)
    {
      paramString2 = paramString2.jdField_a_of_type_JavaUtilList.iterator();
      while (paramString2.hasNext())
      {
        alfw localalfw = (alfw)paramString2.next();
        if ((localalfw != null) && (paramString3.equals(localalfw.jdField_a_of_type_JavaLangString))) {
          return localalfw.a(paramString1, paramAppInterface);
        }
      }
    }
    return null;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = new NewIntent(paramAppInterface.getApp(), atkg.class);
    ...
    ((NewIntent)localObject1).setObserver(new alft(this, paramAppInterface));
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = (alfy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
      if (paramString1 != null)
      {
        paramString1 = paramString1.jdField_a_of_type_JavaUtilList.iterator();
        while (paramString1.hasNext())
        {
          alfw localalfw = (alfw)paramString1.next();
          if ((localalfw != null) && (paramString2.equals(localalfw.jdField_a_of_type_JavaLangString))) {
            return true;
          }
        }
      }
