...
public class uyc
{
  ...
  {
    paramString2 = uyo.b(paramString2);
    uya.d("WeishiScehmeUtil", "openWeishi: scheme = " + paramString2);
    jdField_a_of_type_Boolean = true;
    yqu.a(paramContext, paramString1, paramString2);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      uya.d("WeishiScehmeUtil", "openWeishi context = " + paramContext + "scheme = " + paramString2);
      return;
    }
    ...
    uya.c("WeishiScehmeUtil", "openWeishi final scheme = " + paramString2);
