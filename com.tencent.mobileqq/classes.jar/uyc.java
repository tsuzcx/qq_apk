  ...
  extends uyn
{
  ...
  private vcv jdField_a_of_type_Vcv;
  ...
  public uyc(DoodleView paramDoodleView)
  {
  ...
  private void b()
  {
    ...
    if (bjeh.b()) {
      this.jdField_c_of_type_Int = bjeh.jdField_a_of_type_Int;
    }
    this.d = localDisplayMetrics.heightPixels;
    if (bjeh.b()) {
      this.d = (localDisplayMetrics.heightPixels - bjeh.e);
    }
    ...
    this.jdField_a_of_type_Vcv.b(0.5F);
  }
