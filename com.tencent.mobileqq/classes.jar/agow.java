...
class agow
  implements Runnable
{
  agow(agov paramagov, String paramString) {}
  
  public void run()
  {
    if (this.jdField_a_of_type_Agov.a.a.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
      return;
    }
    this.jdField_a_of_type_Agov.a.a.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelShareHelper$OnUseResListener.a(false);
    ...
    ForwardBaseOption.a(this.jdField_a_of_type_Agov.a.a.jdField_a_of_type_AndroidAppActivity, localIntent, 21);
  }
}
