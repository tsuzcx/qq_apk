  ...
  implements Manager
{
  ...
  public String a;
  ArrayList<anqi> jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
  ...
  public anqg(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bhhe = new anqh(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aopx = ((aopx)paramQQAppInterface.a(59));
    this.jdField_a_of_type_Anyy = ((anyy)paramQQAppInterface.a().getCache(2));
  ...
  private List<MessageRecord> a(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1 = bgnn.a(paramString2, paramString1, localSQLiteDatabase, paramString3, null);
    ...
    return ((ayvj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createMessageRecordEntityManager()).a(paramString1.toString(), null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void a(List<MessageRecord> paramList1, Pair<Long, Long> paramPair, List<MessageRecord> paramList2, String paramString, long paramLong)
  {
    if (((MessageRecord)paramList1.get(paramList1.size() - 1)).time <= ((Long)paramPair.second).longValue())
    {
      ...
      {
        paramPair = this.jdField_a_of_type_Anyy;
      ...
      for (paramList1 = this.jdField_a_of_type_JavaLangString;; paramList1 = paramString)
      {
        ...
        paramList1 = this.jdField_a_of_type_Anyy;
        if (this.jdField_a_of_type_JavaLangString != null) {
          paramString = this.jdField_a_of_type_JavaLangString;
        }
        paramList1.b(paramString, paramLong - 5L, 0);
        bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "judgeClearRoamDateIndex: " + paramLong });
        if (this.jdField_a_of_type_JavaLangString != null) {
          b(paramLong);
        }
        return;
    ...
    for (;;)
    {
      ...
      {
        paramList2 = this.jdField_a_of_type_Anyy;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label619;
        }
      ...
      if (this.jdField_a_of_type_JavaLangString != null)
      {
        ...
        paramList1 = "null";
        label478:
        bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { paramList1 });
  ...
  private boolean a(Calendar paramCalendar)
  {
    ...
    paramCalendar = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, i, j + 1);
  ...
  private boolean a(JSONObject paramJSONObject)
  {
    ...
    {
      bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg Field[lastNumber]: " + paramJSONObject + ", matchLastNumber: " + bool1 });
      return bool1;
    }
  }
  ...
  private void b(int paramInt, Calendar paramCalendar, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramCalendar != null)
        {
          localRoamMessagePreloadInfo = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, paramCalendar, 0);
          localObject = null;
          break;
        }
        if ((paramInt == 3) && (this.jdField_a_of_type_JavaUtilCalendar != null))
        {
          localRoamMessagePreloadInfo = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, 2);
          localObject = null;
          break;
        }
        ...
        localRoamMessagePreloadInfo = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, 1);
        localObject = null;
        break;
  ...
  private void b(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      ...
      {
        localCalendar = this.jdField_a_of_type_Anyy.b(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaUtilCalendar, null);
        ...
        do
        {
          do
          {
            do
            {
              ...
              localCalendar = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaUtilCalendar, null);
  ...
  private boolean b(Calendar paramCalendar)
  {
    ...
    if ((l > ((Long)localPair.first).longValue()) && (l <= ((Long)localPair.second).longValue()))
    {
      ...
      if (paramCalendar != null)
      {
        ...
        this.jdField_a_of_type_Anyy.a(paramCalendar);
      }
      return true;
    }
    return false;
  ...
  private boolean b(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg Field[userType]: " + paramJSONObject });
      return bool;
      bool = false;
    }
  }
  ...
  public int a(String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localStringBuilder.append(acwh.b());
      localStringBuilder.append(" and isValid=1 ");
    }
    for (paramString = bgnn.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), localSQLiteDatabase, "", localStringBuilder.toString(), ""); paramString == null; paramString = bgnn.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), localSQLiteDatabase, localStringBuilder.toString()))
    {
      return 0;
  ...
  public int a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    paramString = a(MessageRecord.getTableName(paramString, 0), null, "( msgtype " + acwh.b() + " and isValid=1 and " + str + " ) " + "ORDER BY time asc , longMsgIndex asc", paramLong1, paramLong2);
    if (paramString == null) {
      return 0;
    }
  ...
  {
    List localList = this.jdField_a_of_type_Anyy.a();
    int m;
    int n;
    int i1;
    int i;
    if (!localList.isEmpty())
    {
      ...
      paramCalendar = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, m, n);
      i = 0;
      if (i >= localList.size()) {
        break label383;
      }
    ...
    for (;;)
    {
      if (i < localList.size())
      {
        ...
        str = this.jdField_a_of_type_Anyy.a(str)[1];
        ...
        for (;;)
        {
          ...
          if ((paramCalendar.getSerState(j - 1) == 2) && (bgnt.d(BaseApplication.getContext())))
          {
            paramCalendar = new Bundle();
  ...
  public anyy a()
  {
    return this.jdField_a_of_type_Anyy;
  }
  
  public RoamMessagePreloadInfo a(int paramInt)
  {
    return this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, paramInt);
  }
  ...
  public List<MessageRecord> a()
  {
    ...
    for (;;)
    {
      ...
      localObject2 = "( msgtype " + acwh.b() + " and isValid=1 ) " + "ORDER BY time asc , longMsgIndex asc";
      ...
      try
      {
        ...
        if (localaywe != null)
        {
          localObject2 = localaywe.a((String)localObject1, (String)localObject2);
  ...
  {
    Object localObject = (aywe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject == null) {
    ...
    {
      return paramString3;
      this.jdField_a_of_type_Long = ((aywe)localObject).a(paramString1);
      if (this.jdField_a_of_type_Long <= paramLong2) {
        break label169;
      }
      paramString2 = "slowTable";
      paramString1 = ((aywe)localObject).a(paramString1, paramString3);
      if (paramString1 != null) {
        break;
      }
      i = 0;
    ...
    for (int k = 0;; k = paramString1.size())
    {
      ...
      localObject = ((aywe)localObject).a(paramString1, paramString3);
      label236:
      String str;
      if (localObject == null)
      {
  ...
  public void a(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    {
      ((anqi)this.jdField_a_of_type_JavaUtilArrayList.get(i)).b(paramInt1, paramInt2, paramObject);
      i += 1;
    }
  }
  ...
  public void a(anqi paramanqi)
  {
    ...
    while (localIterator.hasNext()) {
      ((anqi)localIterator.next()).a(paramanqi);
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(paramanqi);
  }
  
  void a(bhhf parambhhf)
  {
    if ((parambhhf.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit().putLong("cloudSearchCfgLastModify", parambhhf.i).commit();
      if (200 == parambhhf.f) {
    ...
    if (QLog.isColorLevel())
    {
      File localFile = new File(anqf.b);
      long l = 0L;
      if (localFile.exists()) {
        l = localFile.lastModified();
      }
      QLog.d("Q.roammsg.MessageRoamManager", 2, "onDone status=" + parambhhf.a() + ",errCode=" + parambhhf.jdField_a_of_type_Int + ",httpCode=" + parambhhf.f + ",local lastModify=" + l + ",server lastModify=" + parambhhf.i);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      ...
      this.jdField_a_of_type_Anyy.a(paramString);
  ...
  public void a(Calendar paramCalendar, RoamMessagePreloadInfo paramRoamMessagePreloadInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      RoamDate localRoamDate = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, i, j);
      ...
      case 1: 
      case 2: 
        bool = bgnt.d(BaseApplication.getContext());
        if ((n != 2) || (!bool)) {
          break label486;
        }
        a(26, null);
        ...
        this.jdField_a_of_type_Aopx.a(this.jdField_a_of_type_JavaLangString, paramCalendar, paramBoolean1, 8, false, paramBoolean2);
      ...
      case 3: 
        ...
        while ((bgnt.d(BaseApplication.getContext())) && (paramRoamMessagePreloadInfo != null))
        {
          this.jdField_a_of_type_JavaUtilHashMap.clear();
          this.jdField_a_of_type_JavaUtilHashMap.put(this.jdField_a_of_type_JavaUtilCalendar, paramRoamMessagePreloadInfo);
  ...
  public void a(List<MessageRecord> paramList, String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Long = localaywe.a(paramString);
    ...
    if ((i >= j) || (((MessageRecord)paramList.get(i)).time > this.jdField_a_of_type_Long))
    {
      ...
      localaywe.a(paramString, paramList.subList(0, i));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        ...
        {
          a(26, null);
          this.jdField_a_of_type_Aopx.a(this.jdField_a_of_type_JavaLangString, 0, 1, i, j + 1, k);
          return;
          paramBoolean = false;
          break;
          label100:
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aopx.b(paramInt));
    r();
    return (this.jdField_a_of_type_Aopx.a == null) || (this.jdField_a_of_type_Aopx.a.size() == 0);
  }
  ...
  public BitSet b(Calendar paramCalendar1, Calendar paramCalendar2)
  {
    ...
    if (!localList.isEmpty())
    {
      ...
      if ((localCalendar.before(paramCalendar2)) || (localCalendar.equals(paramCalendar2)))
      {
        ...
        localCalendar.get(5);
        paramCalendar1 = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, n, i1);
        int j = 0;
        int m = 0;
        while (j < localList.size())
        {
          ...
          if (((String)((Map.Entry)localList.get(j)).getKey()).equals(paramCalendar1))
          {
            ...
            {
              if (this.jdField_a_of_type_Anyy.a(localRoamDate, k - 1))
              {
                localBitSet.set(i, true);
                if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aopx.a(paramInt));
  }
  ...
  public void b(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()) && (b(((MessageRecord)((List)localObject).get(((List)localObject).size() - 1)).time, (Calendar)localCalendar.clone())))
    {
      ...
      this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, localCalendar.getTimeInMillis() / 1000L, 2);
    }
  }
  
  public void b(anqi paramanqi)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(paramanqi);
  }
  ...
  void b(bhhf parambhhf)
  {
    ...
    if ((parambhhf.a() == 3) && (parambhhf.jdField_a_of_type_Int == 0))
    {
      ...
      localObject = new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getFilesDir(), parambhhf.jdField_a_of_type_JavaLangString);
      if (((File)localObject).exists())
      {
        parambhhf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("vip_message_roam_banner_file", 0);
        localEditor = parambhhf.edit();
      }
    }
    for (;;)
    {
      ...
      try
      {
        localObject = new JSONArray(bgmg.a((File)localObject));
        i = 0;
        ...
        if (bool)
        {
          parambhhf.edit().putLong("blue_banner_last_update_timestamp", NetConnInfoCenter.getServerTimeMillis()).commit();
          return;
        }
        if (!QLog.isColorLevel()) {
          break label482;
      ...
      catch (JSONException parambhhf)
      {
        ...
        QLog.e("Q.roammsg.MessageRoamManager", 2, "JSONException,blue banner parse json error : " + parambhhf.toString());
        return;
      }
      ...
      QLog.e("Q.roammsg.MessageRoamManager", 2, "Exception,blue banner parse json error : " + parambhhf.toString());
      return;
      if (QLog.isColorLevel())
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("Q.roammsg.MessageRoamManager", 2, "blue banner download failed, task.status = " + parambhhf.a() + " , task.errCode = " + parambhhf.jdField_a_of_type_Int);
          return;
          label477:
          bool = false;
          continue;
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    long l = paramMessageRecord.time;
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_Anyy.a(str);
    }
    ...
    if (this.jdField_a_of_type_JavaLangString != null)
    {
      ...
      localObject = "null";
      label150:
      bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { localObject });
      ...
      if ((paramMessageRecord instanceof MessageForLongMsg))
      {
        ...
        bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "judgeClearRoamDateIndex: delList.size() = " + ((List)localObject).size() });
      }
      ...
      {
        localObject = this.jdField_a_of_type_Anyy;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label416;
        }
        paramMessageRecord = this.jdField_a_of_type_JavaLangString;
        label285:
        ((anyy)localObject).a(paramMessageRecord, l - 5L, 1);
        paramMessageRecord = this.jdField_a_of_type_Anyy;
        if (this.jdField_a_of_type_JavaLangString != null) {
          str = this.jdField_a_of_type_JavaLangString;
        }
        paramMessageRecord.b(str, l - 5L, 0);
        bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "judgeClearRoamDateIndex: " + l });
        if (this.jdField_a_of_type_JavaLangString != null) {
          b(l);
        }
      }
  ...
  public void b(Calendar paramCalendar, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramCalendar = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, i, j);
    ...
    this.jdField_a_of_type_Aopx.a(this.jdField_a_of_type_JavaLangString, paramCalendar, false, 0, true, paramBoolean);
  }
  ...
  public void b(boolean paramBoolean)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((anqi)localIterator.next()).a(paramBoolean, null);
    }
  }
      ...
      if ((localCalendar.before(paramCalendar2)) || (localCalendar.equals(paramCalendar2)))
      {
        ...
        while (j < localList.size())
        {
          ...
          if (((String)((Map.Entry)localList.get(j)).getKey()).equals(paramCalendar1))
          {
            ...
            if (k <= RoamDate.getDays(n, i1))
            {
              if ((i == 0) && (!this.jdField_a_of_type_Anyy.a(localRoamDate, k - 1)))
              {
                c();
                a(18, null);
                if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    Object localObject = this.jdField_a_of_type_Anyy.a();
    if (localObject != null)
    {
      if (QLog.isColorLevel())
      {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      str2 = "( msgtype " + acwh.b() + " and isValid=1 and" + str2 + " ) " + "ORDER BY time asc , longMsgIndex asc";
    ...
    for (;;)
    {
      ...
      case 2: 
        ...
        if ((n == 2) && (bool))
        {
          ...
          paramCalendar.setTime(new Date(i - 1900, j - 1, k));
          QLog.d("Q.roammsg.MessageRoamManager", 1, "handleRoamDateQuery getRoamHistoryForSomeDay year = " + i + " month = " + j + " day = " + k + " call stack = " + Log.getStackTraceString(new Throwable()));
          this.jdField_a_of_type_Aopx.a(this.jdField_a_of_type_JavaLangString, paramCalendar, false, 8, false);
          return;
        }
        break;
      case 3: 
        ...
        while (paramCalendar.hasNext()) {
          ((anqi)paramCalendar.next()).a(true, null);
        }
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      paramCalendar = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramCalendar.hasNext()) {
        ((anqi)paramCalendar.next()).a(false, null);
      }
    }
  }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    {
      localObject = ((bhhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(1);
      if ((localObject != null) && (((bhhk)localObject).a("https://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json") == null))
      {
        bhhf localbhhf = new bhhf("https://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json", new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getFilesDir(), "https://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json"));
        localbhhf.p = false;
        ((bhhk)localObject).a(localbhhf, this.jdField_a_of_type_Bhhe, null);
      }
    }
  }
  ...
  public void m()
  {
    ...
    for (;;)
    {
      ...
      for (int k = 0; localIterator.hasNext(); k = m)
      {
        ...
        RoamDate localRoamDate = this.jdField_a_of_type_Anyy.a(this.jdField_a_of_type_JavaLangString, m, n);
        localObject = localRoamDate;
        if (localRoamDate == null) {
          localObject = new RoamDate(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Anyy.a(m, n));
        }
        if (2 != ((RoamDate)localObject).getSerState(i1 - 1))
        {
          ((RoamDate)localObject).setLocState(i1 - 1, 3);
          this.jdField_a_of_type_Anyy.a((RoamDate)localObject);
        }
        i = i1;
        j = n;
      }
  ...
  public void o()
  {
    bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg start...." });
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject).length())
          {
            ...
            {
              bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "curr ver: 8.4.1, config qqVer:" + str });
            }
            else
            {
              str = localJSONObject.getString("canSearchInCloud");
              if (!"1".equals(str)) {
                bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg Field[canSearchInCloud]: " + str });
              }
            }
          }
        }
        ...
        bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg done .... canCloudSearch: " + this.jdField_c_of_type_Boolean });
        return;
    ...
    for (;;)
    {
      if (j < k)
      {
        if (arrayOfString[j].equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
        {
          ...
          bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "match Field[whitlist]:" + str });
        }
      }
      else
      {
        ...
        if (!bool1)
        {
          bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg  matchUserType: " + bool1 });
        }
        else
        {
          ...
          if ((bool1) && (bool2))
          {
            this.jdField_c_of_type_Boolean = true;
            break label265;
            bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg json text is empty" });
            break label265;
            bgjw.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg file not exist" });
            break label265;
          }
        }
        i += 1;
