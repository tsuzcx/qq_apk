...
{
  public ajiy(TroopEntranceBar paramTroopEntranceBar, long paramLong) {}
      ...
      try
      {
        ...
        if ((paramInt == 0) && (((oidb_0x487.RspBody)localObject).uint32_follow_state.has()))
        {
          ...
          if (i == 1)
          {
            ...
            new HttpWebCgiAsyncTask2("https://buluo.qq.com/cgi-bin/bar/extra/clean_temp_follow_state", "", new ajiz(this, paramBundle, i), 1000, null).a(localHashMap);
          }
