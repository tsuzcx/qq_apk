...
{
  private static paj jdField_a_of_type_Paj;
  private BackgroundColorSpan jdField_a_of_type_AndroidTextStyleBackgroundColorSpan;
  
  public static paj a()
  {
    if (jdField_a_of_type_Paj == null) {
      jdField_a_of_type_Paj = new paj();
    }
    return jdField_a_of_type_Paj;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 2) || (i == 3))
    {
      ...
      if ((paramTextView.getTag(2131376067) != null) && ((paramTextView.getTag(2131376067) instanceof Boolean)) && (((Boolean)paramTextView.getTag(2131376067)).booleanValue()))
      {
        ...
        {
          return true;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130849350));
          continue;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130849354));
        }
      }
    }
    return false;
