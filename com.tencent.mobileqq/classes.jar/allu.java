...
public class allu
{
  public static Comparator<awbv> a = new allv();
  ...
  public static ArrayList<awbv> a(ArrayList<awbv> paramArrayList, awbv paramawbv)
  {
    ...
    {
      paramArrayList.add(paramawbv);
      return paramArrayList;
    }
    Groups localGroups1 = (Groups)paramawbv;
    int j = 0;
    ...
    paramArrayList.add(i + 1, paramawbv);
    return paramArrayList;
  }
