  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    aahi.a(localHashMap, paramAdapterView.msgId);
    localHashMap.put(Integer.valueOf(6), paramAdapterView.reportId);
    localHashMap.put(Integer.valueOf(2), paramAdapterView.msgId);
    if (asnl.a(paramAdapterView.redInfo))
    {
      localHashMap.put(Integer.valueOf(3), "1");
      localHashMap.put(Integer.valueOf(4), "20");
      aahi.a(akwd.a(), "769", "205614", paramAdapterView.appId, "76903", "1", "160", localHashMap);
      asnl.a(paramAdapterView.redInfo.redPointId);
      ((askq)paramView.getTag()).a.setVisibility(8);
      if (!paramAdapterView.isFriend) {
        break label281;
      }
      new LinearLayout.LayoutParams(-1, -2).gravity = 80;
      new asnz(this.a.itemView.getContext(), this.a.jdField_a_of_type_Askd.a().gameAppId, paramAdapterView.friendType).show();
      aahi.a(akwd.a(), "769", "205355", this.a.jdField_a_of_type_Askd.a().gameAppId, "76902", "1", "160", new String[] { "", "", "20" });
    }
    label281:
