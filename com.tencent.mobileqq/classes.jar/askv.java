  ...
  extends askm
{
  ...
  public askv(EmoticonInfo paramEmoticonInfo)
  {
  ...
  public int a(List<askm> paramList)
  {
    ...
    if (i < paramList.size())
    {
      Object localObject1 = (askm)paramList.get(i);
      Object localObject2;
      if ((localObject1 instanceof askv))
      {
        localObject1 = ((askv)localObject1).a;
  ...
  {
    boolean bool = true;
    if ((paramaskm instanceof askv))
    {
      paramaskm = ((askv)paramaskm).a;
      Object localObject;
      if (((paramaskm instanceof FavoriteEmoticonInfo)) && ((this.a instanceof FavoriteEmoticonInfo)))
      {
        paramaskm = ((FavoriteEmoticonInfo)paramaskm).resID;
        localObject = ((FavoriteEmoticonInfo)this.a).resID;
        return (paramaskm != null) && (paramaskm.equals(localObject));
      }
      if (((paramaskm instanceof PicEmoticonInfo)) && ((this.a instanceof PicEmoticonInfo)))
      {
        paramaskm = ((PicEmoticonInfo)paramaskm).emoticon;
        localObject = ((PicEmoticonInfo)this.a).emoticon;
        if ((paramaskm != null) && (localObject != null) && (paramaskm.eId != null) && (paramaskm.eId.equals(((Emoticon)localObject).eId)) && (paramaskm.epId != null) && (paramaskm.epId.equals(((Emoticon)localObject).epId))) {}
        for (;;)
        {
          return bool;
          bool = false;
  ...
  public askm b(Bundle paramBundle)
  {
    if (paramBundle.containsKey("cur_emotion_id"))
    {
      ...
      if ((paramBundle instanceof QQAppInterface))
      {
        ...
        {
          paramBundle = (asda)paramBundle.getManager(i);
          ...
          return new askv(paramBundle.a(localCustomEmotionBase));
        }
      }
    }
    return null;
