  ...
  implements askr
{
  ...
  public askv(VideoData paramVideoData, QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    try
    {
      int i = Integer.parseInt("8.2.6".replace(".", ""));
      return i;
    }
  ...
  public void a(int paramInt, askt paramaskt)
  {
    ...
    mmj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new askw(this, paramaskt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public void a(Comments.Comment paramComment, asks paramasks)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    if (a(localReqBody))
    {
      ...
      mmj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new asky(this, paramasks, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
    paramasks.a(paramComment, -1);
  }
  
  public void a(Comments.Comment paramComment, asku paramasku)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      mmj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new askx(this, paramasku, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
