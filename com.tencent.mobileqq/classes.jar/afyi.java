  ...
  extends BaseAdapter
{
  ...
  public ArrayList<bicb> a;
  public boolean a;
  public int b;
  
  public afyi(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      while (i < this.jdField_a_of_type_Int)
      {
        ...
        ((LinearLayout)localObject2).addView(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560972, null), (ViewGroup.LayoutParams)localObject3);
        i += 1;
    ...
    for (;;)
    {
      ...
      for (localObject1 = (bicb)this.jdField_a_of_type_JavaUtilArrayList.get(k);; localObject1 = null)
      {
        ((ChangeVoiceView)localObject3).a((bicb)localObject1);
