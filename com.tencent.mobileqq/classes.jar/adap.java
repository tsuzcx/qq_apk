...
public class adap
{
  private static adap jdField_a_of_type_Adap = new adap();
  public long a;
  public final Object a;
  public Map<String, adaj> a;
  public JSONObject a;
  ...
  static
  {
    Bosses.initWithBoss(BaseApplicationImpl.getApplication(), new vzz(BaseApplicationImpl.getApplication()));
  }
  ...
  private boolean a(String paramString)
  {
    ...
    if ((adaj)this.jdField_a_of_type_JavaUtilMap.get(paramString) != null) {
      return true;
    }
  ...
  public adaj a(String paramString)
  {
    ...
    {
      return localObject;
      localadaj = (adaj)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      localObject = localadaj;
    } while (localadaj != null);
      ...
      if (localJSONObject2 != null)
      {
        ...
        if (localJSONArray != null)
        {
          ...
          for (i = 1;; i = 0)
          {
            ...
            paramString = new adaj((String)localObject, localJSONObject2.optString("name"));
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 43	adap:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   70: aload_0
    //   71: aload 4
    //   73: invokespecial 222	adap:b	(Ljava/lang/String;)Z
    //   76: istore_2
    //   77: iload_2
    //   78: istore_1
    //   79: iload_2
    ...
    //   113: ldc 200
    //   115: invokestatic 235	adap:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   118: astore_3
    //   119: aload_3
    ...
    //   126: aload_0
    //   127: aload_3
    //   128: invokespecial 222	adap:b	(Ljava/lang/String;)Z
    //   131: istore_1
    //   132: iload_1
    //   133: ifne +11 -> 144
    //   136: ldc 177
    ...
    //   144: aload_0
    //   145: iconst_1
    //   146: putfield 43	adap:jdField_a_of_type_Boolean	Z
    //   149: goto -138 -> 11
    //   152: astore_3
    //   153: aload_0
    //   154: monitorexit
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, adaz paramadaz)
  {
    awxt localawxt = awxy.a().a(paramString2, paramInt, 1, false, null, 1);
    paramString1 = localawxt;
    if (localawxt == null) {
      paramString1 = new awxt(paramString2, paramInt);
    }
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new adaw(null)).map(new VerifyUrlJobSegment(paramString3)).map(new adax(null)).map(new adau(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new adat(this, paramadaz));
  }
  
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, adaz paramadaz)
  {
    paramString1 = awxy.a().a(paramString2, paramInt, 1, false, null, 1);
    if (paramString1 != null)
    {
      ThreadManager.getUIHandler().post(new DefaultDoraemonAppInfoHelper.2(this, paramadaz, paramString1));
      return;
    }
    paramString1 = new awxt(paramString2, paramInt);
    ...
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new adaw(null)).map(new adax(null)).map(new adar(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new adaq(this, paramadaz));
  }
