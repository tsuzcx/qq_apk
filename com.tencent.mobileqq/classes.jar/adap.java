...
public class adap
  extends FMObserver
{
  public adap(QfileBaseRecentFileTabView paramQfileBaseRecentFileTabView) {}
  ...
  protected void a(long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    QfileBaseRecentFileTabView.d(this.a, new adas(this));
  }
  ...
  {
    QfileBaseRecentFileTabView.e(this.a, new adat(this));
    FileManagerUtil.a(paramLong, paramInteger.intValue(), paramString);
  }
  
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    QfileBaseRecentFileTabView.b(this.a, new adaq(this));
  }
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      QfileBaseRecentFileTabView.c(this.a, new adar(this, paramLong2));
      return;
  ...
  {
    super.b();
    QfileBaseRecentFileTabView.f(this.a, new adau(this));
  }
}
