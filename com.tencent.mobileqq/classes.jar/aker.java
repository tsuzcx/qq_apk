...
{
  private akes jdField_a_of_type_Akes;
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_Akhh == null) || (!this.jdField_a_of_type_Akhh.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IDownloadMgr == null)) {
      return super.a();
    }
    return this.f;
  }
  ...
  public void a()
  {
    ...
    if (QLog.isDevelopLevel()) {
      QLog.i("PauseDebug", 1, "FileVideoMediaPlayHelper releaseMediaPlayer:" + this.jdField_a_of_type_Akhh.jdField_a_of_type_Long);
    }
    super.a();
  }
  
  public void a(akes paramakes)
  {
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, long paramLong, String paramString3, Context paramContext)
  {
    ...
    if ((this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IDownloadMgr.setCookie(20160714, (String)this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaUtilArrayList.get(0));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IDownloadMgr.setCallBackListener(20160714, this);
    this.jdField_c_of_type_Int = this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IDownloadMgr.startPlayWithSavePath(20160714, paramArrayOfString[0], atvo.a(this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaLangString), 0L, 0, this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaLangString, 0);
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOutputMute(this.jdField_a_of_type_Akhh.e);
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (this.jdField_c_of_type_Long == 0L) {
              this.jdField_c_of_type_Long = a(this.jdField_a_of_type_Akhh.jdField_b_of_type_Long);
            }
            ...
            {
              if (QLog.isDevelopLevel()) {
                QLog.d("FileVideoMediaPlayHelper.filevideoPeek", 4, "[" + this.jdField_a_of_type_Akhh.jdField_a_of_type_Long + "],playid +[" + j + "] callBackType[ " + i + " ]download success! igon");
              }
              if (this.jdField_a_of_type_Akhd == null) {
                continue;
              }
              this.jdField_a_of_type_Akhd.b(this.jdField_a_of_type_Akhh.jdField_a_of_type_Long);
            }
          }
        ...
        default: 
          return;
        case 2: 
          l2 = atvo.a(this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaLangString);
          if (QLog.isDevelopLevel()) {
            QLog.d("FileVideoMediaPlayHelper.filevideoPeek", 4, "[" + this.jdField_a_of_type_Akhh.jdField_a_of_type_Long + "],playid +[" + j + "] callBackType[" + i + "]， tempLen:" + l2);
          }
          if ((l1 - l2 > this.jdField_c_of_type_Long) && (!this.jdField_c_of_type_Boolean))
          {
            if (QLog.isDevelopLevel()) {
              QLog.d("FileVideoMediaPlayHelper.filevideoPeek", 4, "[" + this.jdField_a_of_type_Akhh.jdField_a_of_type_Long + "],playid +[" + j + "] need download block currentBlockId:" + this.jdField_d_of_type_Int);
            }
          ...
          f1 = (float)l2 / (float)this.jdField_a_of_type_Akhh.jdField_b_of_type_Long;
          paramString = this.jdField_a_of_type_AndroidContentContext.getString(2131692456) + "(" + atwl.a(l2) + "/" + atwl.a(this.jdField_a_of_type_Akhh.jdField_b_of_type_Long) + ")";
        }
      ...
      this.jdField_a_of_type_Akhd.a(this.jdField_a_of_type_Akhh.jdField_a_of_type_Long, f1, paramString);
      return;
    } while (atvo.a(this.jdField_a_of_type_Akhh.jdField_a_of_type_JavaLangString) != this.jdField_a_of_type_Akhh.jdField_b_of_type_Long);
