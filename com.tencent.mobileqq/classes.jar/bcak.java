  ...
  implements bbzr
{
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  if (paramMessageHandler.app.a().a((athq)localObject)) {
                    break;
                  }
                } while (!QLog.isColorLevel());
                QLog.d("OnlineFileDecoder", 2, "<---decodeC2CMsgPkg_OnlineFile 0x81 request is error.");
                return;
                if (((athq)localObject).b) {
                  break;
                }
              } while (!QLog.isColorLevel());
              QLog.w("OnlineFileDecoder", 2, "<---decodeC2CMsgPkg_OnlineFile 0x81. requset is no mulitend olfile.");
              return;
              paramMessageHandler.app.a().b(i, String.valueOf(paramLong1), paramMsg, l, s, paramBoolean1, 0, null, (athq)localObject, paramLong2, paramInt);
              return;
            } while (!QLog.isColorLevel());
  ...
  {
    a(paramMessageHandler, paramMsg, parambbyn.e, parambbyn.jdField_a_of_type_Boolean, parambbyn.b, parambbyn.d, parambbyn.jdField_a_of_type_Int);
  }
}
