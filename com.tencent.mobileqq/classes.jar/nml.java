...
public class nml
  extends zbr
{
  public nml(ReadInJoyNativeAdAppContentView paramReadInJoyNativeAdAppContentView, Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  {
    paramWebView = this.a.findViewById(2131362653);
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    } while (!mvs.a().a(paramWebView.getUrl(), (String)localObject).booleanValue());
