  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public void onGlobalLayout()
  {
    ...
    if (this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout != null)
    {
      ...
      int j = arrayOfInt[1];
      int k = j - AIOUtils.dp2px(62.0F, BaseApplicationImpl.getContext().getResources());
      if (k < bnhv.b(this.a)) {
        bnhv.b(this.a, k);
      }
      if (QLog.isColorLevel()) {
        QLog.d("EditTextDialog", 2, "max height" + k + "preViewTextMaxHeight" + bnhv.b(this.a) + "y" + j);
      }
    }
