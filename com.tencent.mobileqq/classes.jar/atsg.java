  ...
  extends atxj
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new atsh(this);
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private String jdField_a_of_type_JavaLangString;
  private TextView jdField_b_of_type_AndroidWidgetTextView;
  private boolean jdField_b_of_type_Boolean;
  
  public atsg(QQAppInterface paramQQAppInterface, Context paramContext, QFileSendBottomView paramQFileSendBottomView)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((777 == i) || (888 == i))
        {
          ...
          blhj.a(this.jdField_a_of_type_AndroidContentContext, 16, (Bundle)localObject1);
          i = -1;
        }
        else
        {
  ...
  public void a()
  {
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131697550);
