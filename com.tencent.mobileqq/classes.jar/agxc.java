  ...
  implements agvc
{
  ...
  public agxc(BaseChatPie paramBaseChatPie)
  {
  ...
  private boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    {
      boolean bool4 = bhjx.b(localSessionInfo.jdField_a_of_type_JavaLangString);
      boolean bool5 = bgpy.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo.jdField_a_of_type_JavaLangString);
      bool2 = bool1;
      if (!bool4)
      {
        bool2 = bool1;
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838376);
      if (QLog.isColorLevel()) {
        QLog.d("UnreadBackBottomHelper", 2, "resume button to unread mode");
      }
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anzj.a(2131689957) + this.jdField_a_of_type_Int + anzj.a(2131689958));
      }
    }
  }
  ...
  {
    if ((paramInt == 2) && (a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie))) {
      a(true);
    }
  }
      ...
      if (Math.abs(paramInt) >= 20) {
        ...
        else if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_Int == 0) && (!this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            if (AppSetting.jdField_c_of_type_Boolean) {
              this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anzj.a(2131689957));
            }
            if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) {
              break;
            }
