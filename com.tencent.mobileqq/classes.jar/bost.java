...
public class bost
{
  ...
  private bosu jdField_a_of_type_Bosu;
  ...
  public Frame a(Frame paramFrame, int paramInt1, int paramInt2, List<List<PointF>> paramList, List<float[]> paramList1)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Bosu != null))
      {
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(770, 771);
        float f1 = -1.0F + this.jdField_a_of_type_Bosu.jdField_a_of_type_Float * 2.0F;
        float f2 = -1.0F + this.jdField_a_of_type_Bosu.b * 2.0F;
        float f3 = this.jdField_a_of_type_Bosu.c * 2.0F + f1;
        float f4 = this.jdField_a_of_type_Bosu.d * 2.0F + f2;
        this.jdField_a_of_type_ComTencentFilterBaseFilter.setPositions(new float[] { f1, f2, f1, f4, f3, f4, f3, f2 });
        this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Bosu.jdField_a_of_type_Int, paramFrame.width, paramFrame.height, -1, 0.0D, paramFrame);
  ...
  {
    this.jdField_a_of_type_Bosu = new bosu(this);
    bota localbota = new bota((int)(320.0F * paramFloat3), (int)(320.0F * paramFloat4));
    localbota.a(paramString1);
    localbota.a(paramInt1);
    localbota.b(paramString2);
    localbota.c(paramString3);
    localbota.a(paramInt2);
    localbota.d(paramString4);
    localbota.a();
    paramString1 = localbota.a();
    this.jdField_a_of_type_Bosu.jdField_a_of_type_Int = RendererUtils.createTexture(paramString1);
    localbota.b();
    this.jdField_a_of_type_Bosu.jdField_a_of_type_Float = paramFloat1;
    this.jdField_a_of_type_Bosu.b = paramFloat2;
    this.jdField_a_of_type_Bosu.c = paramFloat3;
    this.jdField_a_of_type_Bosu.d = paramFloat4;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bosu != null)
    {
      int[] arrayOfInt = new int[1];
      arrayOfInt[0] = this.jdField_a_of_type_Bosu.jdField_a_of_type_Int;
