  ...
  extends aywb
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      localayqo = (ayqo)paramMessage.obj;
    ...
    case 1003: 
      do
      {
        ...
        {
          return;
          if (localayqo.jdField_b_of_type_Int != 64) {
            break;
          }
          this.a.jdField_a_of_type_Int = aysv.jdField_a_of_type_Int;
        ...
        paramMessage = (atbz)((QQAppInterface)TroopMemberApiService.k(this.a)).a(60);
        ...
        return;
        if (localayqo.jdField_b_of_type_Int == 39)
        {
          this.a.jdField_b_of_type_JavaLangString = ((aysv)localayqo.a).jdField_b_of_type_JavaLangString;
          if (QLog.isColorLevel()) {
          ...
          atbt.a((QQAppInterface)TroopMemberApiService.l(this.a), this.a.jdField_a_of_type_JavaLangString);
          return;
        }
