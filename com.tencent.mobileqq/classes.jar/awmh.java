...
class awmh
  extends ayys
{
  awmh(awmg paramawmg, MessageForMixedMsg paramMessageForMixedMsg, QQAppInterface paramQQAppInterface, String paramString, int paramInt) {}
  ...
  private boolean a(MessageForPic paramMessageForPic, ayxy paramayxy)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = bgmg.c(awmg.a());
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MixedMsgManager", 2, "WTF, picResult.mExtraObj is " + paramayxy.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        i = 0;
        break label227;
        if (QLog.isColorLevel())
  ...
  private boolean a(ArrayList<ayxy> paramArrayList)
  {
    ...
    if (localMessageForMixedMsg.msgElemList != null)
    {
      ...
      if (!a((MessageForPic)localObject, (ayxy)paramArrayList.get(i))) {
        bool1 = false;
      }
      i += 1;
    }
  ...
  public void a(int paramInt, ArrayList<ayxy> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (!bool)
      {
        ...
        awmg.a(this.jdField_a_of_type_Awmg, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail");
        return;
      }
      ...
      awmg.a(this.jdField_a_of_type_Awmg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, bool);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.e("MixedMsgManager", 2, "onForwardMultiMsgPicsUpload failed");
    }
    awmg.a(this.jdField_a_of_type_Awmg, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail : result = " + paramInt);
  }
}
