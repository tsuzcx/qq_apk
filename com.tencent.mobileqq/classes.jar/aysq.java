  ...
  implements Handler.Callback, Manager
{
  ...
  private ConcurrentHashMap<Integer, aysx> b = new ConcurrentHashMap();
  ...
  public aysq(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aysy = new aysp(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      aysz.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = aysz.a(localRedTouchItem.redtouchType);
      k = aysz.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        aysz.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Aysy.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    ...
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Aysx.jdField_a_of_type_Int), this.jdField_a_of_type_Aysx);
    aysx localaysx1 = new aysx();
    localaysx1.jdField_a_of_type_Int = 10018;
    localaysx1.jdField_a_of_type_Aysx = this.jdField_a_of_type_Aysx;
    this.b.put(Integer.valueOf(localaysx1.jdField_a_of_type_Int), localaysx1);
    localaysx1 = new aysx();
    localaysx1.jdField_a_of_type_Int = -3;
    localaysx1.jdField_a_of_type_Aysx = this.jdField_a_of_type_Aysx;
    this.b.put(Integer.valueOf(localaysx1.jdField_a_of_type_Int), localaysx1);
    localaysx1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx1;
    localaysx1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((aysx)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    aysx localaysx2 = new aysx();
    localaysx2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localaysx2.jdField_a_of_type_Int), localaysx2);
    localaysx2.jdField_a_of_type_Aysx = localaysx1;
    localaysx1.jdField_a_of_type_JavaUtilList.add(localaysx2);
    localaysx2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new aysx();
    ((aysx)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((aysx)localObject2).jdField_a_of_type_Int), localObject2);
    ((aysx)localObject2).jdField_a_of_type_Aysx = ((aysx)localObject1);
    ((aysx)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new aysx();
    ((aysx)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((aysx)localObject2).jdField_a_of_type_Int), localObject2);
    ((aysx)localObject2).jdField_a_of_type_Aysx = ((aysx)localObject1);
    ((aysx)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new aysx();
    ((aysx)localObject2).jdField_a_of_type_Int = 100601;
    ((aysx)localObject2).jdField_a_of_type_Aysx = ((aysx)localObject1);
    ((aysx)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10023;
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10024;
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10025;
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10026;
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10027;
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localaysx2 = new aysx();
    localaysx2.jdField_a_of_type_Int = -2;
    localaysx2.jdField_a_of_type_Aysx = this.jdField_a_of_type_Aysx;
    this.b.put(Integer.valueOf(localaysx2.jdField_a_of_type_Int), localaysx2);
    this.jdField_a_of_type_Aysx.jdField_a_of_type_JavaUtilList = Arrays.asList(new aysx[] { localaysx1, localaysx2 });
    localaysx2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localaysx1 = new aysx();
    localaysx1.jdField_a_of_type_Int = 10011;
    localaysx1.jdField_a_of_type_Aysx = ((aysx)localObject1);
    this.b.put(Integer.valueOf(localaysx1.jdField_a_of_type_Int), localaysx1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localaysx1);
    ((aysx)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new aysx();
    ((aysx)localObject2).jdField_a_of_type_Int = 100523;
    ((aysx)localObject2).jdField_a_of_type_Aysx = localaysx1;
    this.b.put(Integer.valueOf(((aysx)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new aysx();
    ((aysx)localObject2).jdField_a_of_type_Int = 100517;
    ((aysx)localObject2).jdField_a_of_type_Aysx = localaysx1;
    this.b.put(Integer.valueOf(((aysx)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localaysx1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localaysx1 = new aysx();
    localaysx1.jdField_a_of_type_Int = -5;
    localaysx1.jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localaysx1);
    localaysx1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localaysx1.jdField_a_of_type_Int), localaysx1);
    localaysx1 = new aysx();
    localaysx1.jdField_a_of_type_Int = -6;
    localaysx1.jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localaysx1);
    localaysx1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localaysx1.jdField_a_of_type_Int), localaysx1);
    localObject1 = new aysx();
    ((aysx)localObject1).jdField_a_of_type_Int = 10014;
    ((aysx)localObject1).jdField_a_of_type_Aysx = localaysx1;
    localaysx1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((aysx)localObject1).jdField_a_of_type_Int), localObject1);
    localaysx1 = new aysx();
    localaysx1.jdField_a_of_type_Int = 10013;
    localaysx1.jdField_a_of_type_Aysx = localaysx2;
    localaysx2.jdField_a_of_type_JavaUtilList.add(localaysx1);
    this.b.put(Integer.valueOf(localaysx1.jdField_a_of_type_Int), localaysx1);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bhmi.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
    ...
    try
    {
      ??? = (ConcurrentHashMap)bhmi.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (??? != null)
      {
        this.c.clear();
        this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        aysx localaysx = (aysx)this.b.get(Integer.valueOf(i));
        if ((localaysx == null) || (localaysx.jdField_a_of_type_Aysx == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localaysx.jdField_a_of_type_Aysx.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localaysx.jdField_a_of_type_Aysx.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localaysx.jdField_a_of_type_Aysx.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((aysx)localaysx.jdField_a_of_type_Aysx.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localaysx.jdField_a_of_type_Aysx.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localaysx.jdField_a_of_type_Aysx.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bhmi.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((ayta)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((ayta)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Aysy.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((ayta)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bhmi.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        aogf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Aysy.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
