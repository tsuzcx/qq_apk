  ...
  extends anyz
{
  ...
  public void onMessageRecordAdded(List<MessageRecord> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if ((!paramList.isSendFromLocal()) && (!(paramList instanceof MessageForUniteGrayTip)) && (paramList.frienduin != null) && (paramList.frienduin.equals(this.a.sessionInfo.curFriendUin)) && (!((anvk)this.a.app.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(this.a.sessionInfo.curFriendUin)))
      {
        aici.d(this.a);
        aici.b(this.a);
        aici.e(this.a);
