...
{
  public kgk(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, String paramString) {}
  ...
  public void a(int paramInt1, GVideoGrayConfig.Record paramRecord, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        if ((this.jdField_a_of_type_AndroidContentContext instanceof Activity))
        {
          GVideoGrayConfig.a(this.jdField_a_of_type_AndroidContentContext, paramRecord.b, paramRecord.c, new kgl(this));
          return;
        }
      ...
      if ((this.jdField_a_of_type_AndroidContentContext instanceof Activity))
      {
        GVideoGrayConfig.a(this.jdField_a_of_type_AndroidContentContext, paramRecord.b, paramRecord.c, new kgm(this));
        return;
      }
    } while (!QLog.isColorLevel());
    QLog.e("GroupVideoManager.GVideoGrayConfig", 2, "context is not Activity");
