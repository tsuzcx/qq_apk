  ...
  extends BitmapDrawable
{
  ...
  public aubr(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static aubr[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      aubr[] arrayOfaubr2 = new aubr[paramInt];
      e = paramBitmap.getWidth() / 2;
      d = paramBitmap.getHeight() / 2;
      int i = 0;
      for (;;)
      {
        arrayOfaubr1 = arrayOfaubr2;
        if (i >= paramInt) {
          break;
        }
        arrayOfaubr2[i] = new aubr(paramResources, paramBitmap);
        i += 1;
      }
    }
    aubr[] arrayOfaubr1 = null;
    return arrayOfaubr1;
  }
