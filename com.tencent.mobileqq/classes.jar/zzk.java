...
public class zzk
{
  ...
  public zzk(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static zzk a(JSONObject paramJSONObject)
  {
    zzk localzzk = new zzk();
    try
    {
      localzzk.a = paramJSONObject.getString("name").trim();
      localzzk.b = paramJSONObject.getString("ver").trim();
      localzzk.c = paramJSONObject.getString("system").trim();
      localzzk.d = paramJSONObject.getString("driver").trim();
      localzzk.e = paramJSONObject.getString("url").trim();
      localzzk.f = paramJSONObject.getString("type").trim();
      localzzk.h = paramJSONObject.getString("enabled").trim();
      localzzk.k = paramJSONObject.optString("previousPatch", "").trim();
      return localzzk;
    }
    catch (Exception paramJSONObject)
    {
      zyz.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      zyz.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
