  ...
  extends RelativeLayout
{
  ...
  public ajpe(ApolloGameInfoFragment paramApolloGameInfoFragment, Context paramContext, String paramString)
  {
    super(paramContext);
    a(paramString);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    setOnClickListener(new ajph(this, paramString, paramInt));
  }
  ...
  public void a(Bitmap paramBitmap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      setOnClickListener(new ajpg(this));
      return;
  ...
  public void a(String paramString)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject).setMargins(actj.a(12.0F, getResources()), actj.a(17.0F, getResources()), 100, actj.a(20.0F, getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848549);
    paramString = new RelativeLayout.LayoutParams(actj.a(9.0F, getResources()), actj.a(18.0F, getResources()));
    paramString.addRule(11);
    paramString.addRule(15);
    paramString.rightMargin = actj.a(27.0F, getResources());
    ...
    paramString.rightMargin = actj.a(11.0F, getResources());
    paramString.addRule(11);
    paramString.rightMargin = actj.a(27.0F, getResources());
    paramString.addRule(15);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(4);
    paramString = new RelativeLayout.LayoutParams(actj.a(25.0F, getResources()), actj.a(25.0F, getResources()));
    paramString.rightMargin = actj.a(11.0F, getResources());
    ...
    setOnClickListener(new ajpf(this));
  }
