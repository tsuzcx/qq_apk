  ...
  extends blqv
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajpg(this);
  protected View a;
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ajph(this);
  View jdField_b_of_type_AndroidViewView;
  protected List<RecommendTroopItem> b;
  public boolean b;
  private final int jdField_c_of_type_Int = 1;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new ajpi(this);
  ...
  public ajpe(QQAppInterface paramQQAppInterface, Context paramContext, ajop paramajop, ajjh paramajjh)
  {
  ...
  private void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    do
    {
      ...
      bhju.a("Grp_contacts_news", "notice", "recom_exp_grp", 0, 0, new String[] { str1, paramRecommendTroopItem });
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    Object localObject;
    int j;
    if ((paramView == null) || (!(paramView.getTag() instanceof ajov)))
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559908, paramViewGroup, false);
      paramViewGroup = new ajov();
      paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131373680));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373670));
      paramViewGroup.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131373677));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373684));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373675));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373681));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373683));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131373676));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131373679));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131379495));
      localObject = (Button)paramView.findViewById(2131379494);
      paramView.setTag(paramViewGroup);
      paramViewGroup.jdField_b_of_type_Int = paramInt;
      localObject = (arbc)aran.a().a(634);
      if (localObject == null) {
        break label376;
      }
      if (((arbc)localObject).jdField_e_of_type_Int != 1) {
        break label292;
      }
      j = 1;
    }
    for (;;)
    {
      ...
      {
        ajjr.a(paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout, true);
        label238:
      ...
      {
        return paramView;
        paramViewGroup = (ajov)paramView.getTag();
        paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setPadding(bhtq.a(5.0F), 0, bhtq.a(5.0F), 0);
        break;
        label292:
        j = 0;
        break label217;
        ajjr.a(paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        break label238;
        label309:
        ...
        {
          this.jdField_a_of_type_Ajjh.a(paramViewGroup, paramInt);
          return paramView;
        }
      }
      label376:
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    localURLDrawableOptions.mRequestWidth = agej.a(238.0F, (Resources)localObject);
    localURLDrawableOptions.mRequestHeight = agej.a(161.0F, (Resources)localObject);
    ...
    ((ImageView)paramLinearLayout.findViewById(2131367975)).setImageDrawable((Drawable)localObject);
  }
  ...
  public void a(aoga paramaoga)
  {
    ...
    int j;
    Object localObject;
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramaoga != null))
    {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (j == 1)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface))) {
        localObject2 = aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, ((RecommendTroopItem)localObject3).uin);
      }
    }
    for (;;)
    {
      ...
      {
        localObject1 = paramView;
        if ((paramView.getTag() instanceof ajnr)) {}
      }
      else
      {
        localObject1 = ajno.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this.jdField_c_of_type_AndroidViewView$OnClickListener);
      }
      ajno.a((ajnr)((View)localObject1).getTag(), (RecommendTroopItem)localObject3, (Drawable)localObject2);
      a((RecommendTroopItem)localObject3);
      paramView = (View)localObject1;
      break;
      if (this.jdField_a_of_type_Bgpw != null)
      {
        localObject1 = this.jdField_a_of_type_Bgpw.a(((RecommendTroopItem)localObject3).uin, true);
        if (localObject1 != null)
        {
          ...
          if (j == 2)
          {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_contacts_news", "", "notice", "verify_exp", 0, 0, "", "", "", "");
            localObject2 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563058, null);
            localObject3 = (TextView)((View)localObject2).findViewById(2131377244);
            localObject1 = null;
            ...
            for (;;)
            {
              ...
              ((View)localObject2).setOnClickListener(new ajpf(this, (View)localObject2));
              if (!this.jdField_c_of_type_Boolean)
              {
                bhju.a("Grp_contacts_news", "notice", "verify_clk", 2, 0, new String[0]);
                this.jdField_c_of_type_Boolean = true;
              }
              localObject1 = localObject2;
              break;
              if (this.jdField_a_of_type_Int > c() - 2) {
                localObject1 = anzj.a(2131706511) + this.jdField_a_of_type_Int + anzj.a(2131706513);
              } else {
                localObject1 = anzj.a(2131706510);
              }
            }
          }
          if (j == 4)
          {
            ...
            this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560665, null);
            this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371701));
            this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131371687);
            if (j != 0)
            {
          ...
          if (j == 5)
          {
            localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563059, null);
            ((TextView)((View)localObject1).findViewById(2131367987)).setText(anzj.a(2131706509));
            ((LinearLayout)((View)localObject1).findViewById(2131371939)).setVisibility(8);
            break;
          }
          if (j == 6)
          {
            localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563059, null);
            ((TextView)((View)localObject1).findViewById(2131367987)).setText(anzj.a(2131706508));
            ((LinearLayout)((View)localObject1).findViewById(2131371939)).setVisibility(8);
            break;
          }
          if (j == 3)
          {
            localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563059, null);
            localObject2 = (TextView)((View)localObject1).findViewById(2131367987);
            ((TextView)localObject2).setText(anzj.a(2131706512));
            ((TextView)localObject2).setVisibility(8);
            localObject2 = (LinearLayout)((View)localObject1).findViewById(2131371939);
