...
public class afou
{
  ...
  private afox jdField_a_of_type_Afox;
  ...
  public afou(RelativeLayout paramRelativeLayout, QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramRelativeLayout.findViewById(2131377916));
    ...
    this.jdField_c_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramRelativeLayout.findViewById(2131375151));
  ...
  {
    Object localObject = (akbn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
    StringBuilder localStringBuilder = new StringBuilder(32);
    int i;
    if (paramInt == 0)
    {
      localObject = ((akbn)localObject).a();
      if ((localObject != null) && (((atza)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))
      {
        if (paramBoolean) {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800707A", "0X800707A", 0, 0, "", "", "", "");
        }
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131694632)).append(" 有更新");
        i = 1;
      }
    }
    for (;;)
    {
      bfqs.a(this.jdField_a_of_type_AndroidWidgetTextView, i, paramInt, 0);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(localStringBuilder.toString());
      return;
      if (akka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a())
      {
        int j = 1;
        i = j;
        if (QLog.isColorLevel())
      ...
      {
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131720070));
        do
        {
          i = 0;
          break;
        ...
        if (paramBoolean) {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800707B", "0X800707B", 0, 0, "", "", "", "");
        }
        i = 3;
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131694632)).append(" ");
        if (paramInt > 99) {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    if (n > m)
    {
      ...
      paramRelativeLayout = new afov(this, f);
    ...
    for (paramRelativeLayout = localPaintDrawable;; paramRelativeLayout = null)
    {
      ...
      this.jdField_a_of_type_Afox = new afox(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, paramRelativeLayout, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Afox);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setLayoutFrozen(true);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.addItemDecoration(new afoy(bbll.b(8.0F)));
  ...
  private void a(List<Object> paramList)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = bbll.b(93.0F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.requestLayout();
    Object localObject1 = paramList.get(0);
    Object localObject2;
    if ((localObject1 instanceof atyv))
    {
      localObject2 = (atyv)localObject1;
      this.jdField_b_of_type_ComTencentWidgetSingleLineTextView.setText(((atyv)localObject2).b());
      localObject1 = ((atyv)localObject2).c();
      if (QLog.isColorLevel()) {
        QLog.d("CTNewFriendEntryController", 2, "showOneNewFriendUI nickname = " + ((atyv)localObject2).b() + "reqContent = " + (String)localObject1);
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_Afox.a(paramList.subList(0, 1));
      return;
      ...
      else if ((localObject1 instanceof atyu))
      {
        localObject1 = (atyu)localObject1;
        this.jdField_b_of_type_ComTencentWidgetSingleLineTextView.setText(((atyu)localObject1).a.name);
        localObject1 = (RelativeLayout.LayoutParams)this.jdField_b_of_type_ComTencentWidgetSingleLineTextView.getLayoutParams();
        ((RelativeLayout.LayoutParams)localObject1).addRule(15);
        ((RelativeLayout.LayoutParams)localObject1).addRule(10, 0);
      }
  ...
  private void a(boolean paramBoolean, List<Object> paramList)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = bbll.b(93.0F);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.requestLayout();
      akbn localakbn = (akbn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
      if (!paramBoolean) {
        break;
      }
    } while (paramList.size() <= 0);
    this.jdField_a_of_type_Afox.a(paramList.get(0));
    return;
    this.jdField_a_of_type_Afox.a(paramList);
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = bbll.b(56.0F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.requestLayout();
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007F18", "0X8007F18", 1, 0, String.valueOf(i), "", "", "");
      return;
      if (this.jdField_b_of_type_Int > 1) {
        i = 2;
      } else {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Afox.a(new ArrayList());
    this.jdField_a_of_type_Afox.a(paramQQAppInterface);
  }
