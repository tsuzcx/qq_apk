...
public class bika
  implements SurfaceTexture.OnFrameAvailableListener, axgl, axhy, axig
{
  private static final axhz jdField_a_of_type_Axhz = CameraCaptureView.jdField_a_of_type_Axhz;
  public int a;
  ...
  private axhx jdField_a_of_type_Axhx = new axhx(this.jdField_b_of_type_AndroidOsHandler, this);
  private bijq jdField_a_of_type_Bijq;
  private bikd jdField_a_of_type_Bikd;
  ...
  private bika()
  {
    ...
    jdField_a_of_type_Axhz.e(true);
    this.jdField_a_of_type_Ahvw = new ahvw();
  }
  
  public static bika a()
  {
    return bike.a;
  }
  
  private void a(axhu paramaxhu)
  {
    this.jdField_c_of_type_Int = paramaxhu.jdField_b_of_type_Int;
    this.jdField_d_of_type_Int = paramaxhu.jdField_a_of_type_Int;
    if (this.jdField_a_of_type_Bikd != null) {
      this.jdField_a_of_type_Bikd.a(this.jdField_c_of_type_Int, this.jdField_d_of_type_Int);
    }
  }
  ...
  private void h()
  {
    biwu.a().a("AECameraManager", "realStartPreview---surfaceWidth=" + this.jdField_a_of_type_Int + ", surfaceHeight=" + this.jdField_b_of_type_Int);
    this.jdField_a_of_type_Bijq.i(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Bijq.j(this.jdField_b_of_type_Int);
    if (this.jdField_a_of_type_Boolean) {
      jdField_a_of_type_Axhz.a(new axhu(this.jdField_b_of_type_Int, this.jdField_a_of_type_Int), new axhu(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int), 0, 30, true);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bikd != null) {
        this.jdField_a_of_type_Bikd.i();
      }
      bjah.b("AECameraManager", "### realStartPreview");
      biwu.a().a("startCameraPreview-end");
      return;
      jdField_a_of_type_Axhz.a(new axhu(this.jdField_a_of_type_Bijq.b(), this.jdField_a_of_type_Bijq.c()), new axhu(this.jdField_a_of_type_Bijq.d(), this.jdField_a_of_type_Bijq.e()), 0, 30, false);
    }
  }
  ...
  public Handler a()
  {
    if (jdField_a_of_type_Axhz == null) {
      return null;
    }
    return jdField_a_of_type_Axhz.a();
  }
  
  public void a()
  {
    biwu.a().a("openCamera-begin");
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Ahvw != null) {
      this.jdField_a_of_type_Ahvw.a(paramInt2, paramInt1, b(), c());
    }
  }
  ...
  public void a(bikd parambikd)
  {
    bjah.b("AECameraManager", "### setCameraManagerListener--- listener=" + parambikd);
  ...
  public void a(File paramFile, int paramInt, boolean paramBoolean, aiai paramaiai)
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new AECameraManager.7(this, paramFile, paramaiai, paramInt, paramBoolean));
  }
  ...
  public void a(Exception paramException)
  {
    ...
    {
      bjah.a("AECameraManager", "onCameraException---" + paramException.getMessage(), paramException);
      return;
    }
    bjah.d("AECameraManager", "onCameraException---");
  }
  
  public void a(Object paramObject, int paramInt, Object... paramVarArgs)
  {
    biwu.a().a("AECameraManager", "【CameraProxy notify】eventId=" + paramInt + ", args=" + Arrays.toString(paramVarArgs));
    switch (paramInt)
    {
    }
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              } while (this.jdField_a_of_type_Bikd == null);
              this.jdField_a_of_type_Bikd.a(true, "");
              bjah.b("AECameraManager", "【Camera Open Success】EVENT_SET_CAMERA_PARAM");
              return;
            } while ((!(paramVarArgs[0] instanceof String)) || (this.jdField_a_of_type_Bikd == null));
            this.jdField_a_of_type_Bikd.a(false, (String)paramVarArgs[0]);
            bjah.d("AECameraManager", "【Camera Open Error】EVENT_SET_CAMERA_PARAM:" + paramVarArgs[0]);
            return;
          } while ((!(paramVarArgs[0] instanceof String)) || (this.jdField_a_of_type_Bikd == null));
          this.jdField_a_of_type_Bikd.a(false, (String)paramVarArgs[0]);
          bjah.d("AECameraManager", "【Camera Open Error】EVENT_CREATE_CAMERA:" + paramVarArgs[0]);
          return;
        } while ((!(paramVarArgs[0] instanceof Integer)) || (this.jdField_a_of_type_Bikd == null));
        this.jdField_a_of_type_Bikd.a(false, "[Camera2]openCamera2 error:" + paramVarArgs[0]);
        bjah.d("AECameraManager", "【Camera2 Open Error】EVENT_CAMERA2_ERROR:" + paramVarArgs[0]);
        return;
        if (!(paramVarArgs[0] instanceof axhu)) {
          break;
        }
        ...
        {
          this.jdField_a_of_type_Bikd.a(true, "");
          bjah.b("AECameraManager", "【Camera2 Open Success】EVENT_CAMERA2_PARAMS");
        }
    ...
    this.jdField_a_of_type_Bikd.a(false, "[Camera2]setCamera2 Params error:" + paramVarArgs[0]);
    bjah.d("AECameraManager", "【Camera2 Open Error】setCamera2 Params error::" + paramVarArgs[0]);
  }
  ...
  public void a(RuntimeException paramRuntimeException)
  {
    ...
    {
      bjah.a("AECameraManager", "onDispatchThreadException---" + paramRuntimeException.getMessage(), paramRuntimeException);
      return;
    }
    bjah.d("AECameraManager", "onDispatchThreadException---");
  }
  ...
  public void a(byte[] paramArrayOfByte, Camera paramCamera)
  {
    if (!this.jdField_i_of_type_Boolean)
    {
      ...
      biwu.a().a("onCameraPreviewFrameData");
    }
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Avth.a(paramArrayOfByte, m, n, this.jdField_a_of_type_Avti);
    }
  }
  ...
  public void b()
  {
    biwu.a().a("startCameraPreview-begin");
  ...
  public boolean d()
  {
    return jdField_a_of_type_Axhz.jdField_b_of_type_Boolean;
  }
  ...
  {
    if (this.jdField_a_of_type_Bikd != null) {
      this.jdField_a_of_type_Bikd.a(paramSurfaceTexture);
    }
  }
}
