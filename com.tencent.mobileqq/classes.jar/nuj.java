...
public class nuj
{
  ...
  private num jdField_a_of_type_Num;
  private boolean jdField_a_of_type_Boolean = true;
  
  public nuj(ViewGroup paramViewGroup, Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Num = new num(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewRainView.setAnimationEndListener(new nuk(this));
