  ...
  extends bnbp<bnaz, bnaz>
{
  ...
  public bnbn(String paramString)
  {
  ...
  protected void a(com.tribe.async.async.JobContext paramJobContext, bnaz parambnaz)
  {
    // Byte code:
    //   0: aload_2
    //   1: getfield 27	bnaz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   4: astore 12
    //   6: aload 12
    ...
    //   25: invokespecial 44	bnbp:notifyError	(Ljava/lang/Error;)V
    //   28: return
    //   29: aload_0
    //   30: getfield 17	bnbn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   33: astore_1
    //   34: aload_1
    //   35: astore 7
    //   37: aload_1
    //   38: ifnonnull +18 -> 56
    //   41: aload_2
    //   42: getfield 47	bnaz:jdField_a_of_type_Int	I
    //   45: aload_2
    //   46: getfield 50	bnaz:b	Ljava/lang/String;
    //   49: ldc 52
    //   51: invokestatic 57	bnbs:a	(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   54: astore 7
    //   56: aload_2
    //   57: getfield 60	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   60: getfield 65	com/tencent/biz/qqstory/database/PublishVideoEntry:doodleRawPath	Ljava/lang/String;
    //   63: astore 10
    //   65: aload_2
    //   66: getfield 60	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   69: getfield 68	com/tencent/biz/qqstory/database/PublishVideoEntry:doodlePath	Ljava/lang/String;
    //   72: astore 9
    //   74: aload_2
    //   75: getfield 60	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   78: ldc 70
    //   80: aconst_null
    ...
    //   84: astore 11
    //   86: aload_2
    //   87: getfield 60	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   90: ldc 76
    //   92: aconst_null
    ...
    //   120: ldc 80
    //   122: aload 7
    //   124: invokestatic 85	wxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    //   145: invokestatic 93	xrg:a	(Ljava/io/File;Ljava/io/File;)Z
    //   148: ifeq +24 -> 172
    //   151: aload_2
    //   152: getfield 60	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   155: aload 7
    ...
    //   166: aload_0
    //   167: aload_2
    //   168: invokespecial 100	bnbp:notifyResult	(Ljava/lang/Object;)V
    //   171: return
    //   172: ldc 78
    //   174: ldc 102
    //   176: iconst_2
    ...
    //   187: aload 7
    //   189: aastore
    //   190: invokestatic 108	wxe:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   193: iconst_0
    //   194: istore_3
    //   195: goto -33 -> 162
    //   198: aconst_null
    ...
    //   250: iconst_m1
    //   251: ldc 126
    //   253: invokestatic 131	alud:a	(I)Ljava/lang/String;
    //   256: invokespecial 40	com/tencent/biz/qqstory/base/ErrorMessage:<init>	(ILjava/lang/String;)V
    //   259: invokespecial 44	bnbp:notifyError	(Ljava/lang/Error;)V
    //   262: return
    //   263: astore_1
    //   264: ldc 78
    //   266: ldc 133
    //   268: aload_1
    //   269: invokestatic 136	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   272: aload 6
    //   274: astore_1
    //   275: goto -34 -> 241
    //   278: astore 6
    ...
    //   287: ldc 138
    //   289: aload 6
    //   291: invokestatic 136	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   294: aload_1
    //   295: ifnull +577 -> 872
    //   298: aload_1
    ...
    //   310: ldc 133
    //   312: aload_1
    //   313: invokestatic 136	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   316: aconst_null
    //   317: astore_1
    //   318: goto -77 -> 241
    //   321: astore 5
    ...
    //   335: ldc 140
    //   337: aload 6
    //   339: invokestatic 136	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   342: aload_1
    //   343: ifnull +529 -> 872
    //   346: aload_1
    ...
    //   358: ldc 133
    //   360: aload_1
    //   361: invokestatic 136	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   364: aconst_null
    //   365: astore_1
    //   366: goto -125 -> 241
    //   369: astore_1
    ...
    //   385: ldc 133
    //   387: aload_2
    //   388: invokestatic 136	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   391: goto -11 -> 380
    //   394: aconst_null
    //   395: astore 6
    //   397: aload 6
    ...
    //   403: ifnull +10 -> 413
    //   406: aload 11
    //   408: invokestatic 145	xqw:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   411: astore 5
    //   413: aload 5
    //   415: astore 6
    //   417: aload 5
    ...
    //   431: aload 10
    //   433: aconst_null
    //   434: invokestatic 148	xqw:a	(Ljava/lang/String;Lxqx;)Landroid/graphics/Bitmap;
    //   437: astore 6
    //   439: aload 6
    //   441: astore 5
    //   443: ldc 78
    ...
    //   453: aload 10
    //   455: aastore
    //   456: invokestatic 108	wxe:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   459: aload 6
    //   461: astore 5
    //   463: aload 5
    ...
    //   485: aload_1
    //   486: aload 6
    //   488: invokestatic 156	xqw:b	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   491: astore 5
    //   493: aload 6
    ...
    //   532: aload_1
    //   533: aload 6
    //   535: invokestatic 156	xqw:b	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   538: astore 5
    //   540: aload 5
    //   542: ifnull +327 -> 869
    //   545: aload_1
    ...
    //   599: aload 5
    //   601: invokestatic 179	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   604: aload 6
    //   606: astore 5
    //   608: goto -195 -> 413
    //   611: astore 5
    ...
    //   637: invokestatic 188	wxe:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   640: goto -135 -> 505
    //   643: astore 6
    //   645: ldc 78
    //   647: ldc 190
    //   649: aload 6
    //   651: invokestatic 179	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   654: aload 5
    //   656: astore 6
    //   658: goto +225 -> 883
    //   661: astore 6
    ...
    //   690: aload 6
    //   692: invokestatic 179	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   695: aload 5
    //   697: astore 6
    //   699: goto -219 -> 480
    //   702: aload_1
    ...
    //   737: aload 5
    //   739: invokestatic 179	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   742: aload_1
    //   743: astore 5
    //   745: goto -185 -> 560
    //   748: getstatic 194	ulg:e	Ljava/lang/String;
    //   751: invokestatic 197	xrg:a	(Ljava/lang/String;)Z
    //   754: pop
    //   755: aload 5
    //   757: aload 7
    //   759: invokestatic 200	xqw:a	(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    //   762: istore 4
    //   764: aload 5
    ...
    //   771: ifeq +42 -> 813
    //   774: aload_2
    //   775: getfield 60	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   778: aload 7
    ...
    //   805: invokestatic 204	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   808: iconst_1
    //   809: istore_3
    //   810: goto -648 -> 162
    //   813: iconst_0
    ...
    //   815: ldc 78
    //   817: ldc 206
    //   819: invokestatic 208	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   822: goto -660 -> 162
    //   825: aload_0
    ...
    //   830: iconst_m1
    //   831: ldc 209
    //   833: invokestatic 131	alud:a	(I)Ljava/lang/String;
    //   836: invokespecial 40	com/tencent/biz/qqstory/base/ErrorMessage:<init>	(ILjava/lang/String;)V
    //   839: invokespecial 44	bnbp:notifyError	(Ljava/lang/Error;)V
    //   842: return
    //   843: astore 6
    //   845: aload 5
    //   847: astore_1
