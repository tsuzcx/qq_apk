...
{
  public tuc(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131430365));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131430366));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131430363), new tud(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131435252), new tue(this, (QQCustomDialog)localObject));
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131435269));
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131434506));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435197, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435200, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
