...
public class aobf
{
  ...
  {
    if (paramInt == 2052) {
      return anzj.a(2131693189);
    }
    if (paramInt == 1033) {
      return anzj.a(2131693188);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = apdt.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      apdt.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = apdt.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      apdt.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    apdt.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    apdt.a(paramContext, "key_local_cache", String.valueOf(paramInt));
