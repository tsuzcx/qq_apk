  ...
  extends SimpleItemAnimator
{
  ...
  private ArrayList<zzt> c = new ArrayList();
  private ArrayList<zzs> d = new ArrayList();
  private ArrayList<ArrayList<RecyclerView.ViewHolder>> e = new ArrayList();
  private ArrayList<ArrayList<zzt>> f = new ArrayList();
  private ArrayList<ArrayList<zzs>> g = new ArrayList();
  ...
  private void a(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    if ((paramViewHolder instanceof zzj)) {
      localViewPropertyAnimatorCompat1 = ((zzj)paramViewHolder).a(paramViewHolder);
    }
    ...
    localViewPropertyAnimatorCompat2.setListener(new zzm(this, paramViewHolder, localViewPropertyAnimatorCompat2)).start();
  }
  ...
  private void a(RecyclerView.ViewHolder paramViewHolder, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    Object localObject1 = new zzt(paramViewHolder, paramInt1, paramInt2, paramInt3, paramInt4, null);
    if ((paramViewHolder instanceof zzj)) {}
    for (localObject1 = ((zzj)paramViewHolder).a((zzt)localObject1, getMoveDuration());; localObject1 = null)
    {
      ...
      ((ViewPropertyAnimatorCompat)localObject2).setListener(new zzo(this, paramViewHolder, m, n, (ViewPropertyAnimatorCompat)localObject2)).start();
      return;
    }
  }
  
  private void a(List<zzs> paramList, RecyclerView.ViewHolder paramViewHolder)
  {
    int m = paramList.size() - 1;
    while (m >= 0)
    {
      zzs localzzs = (zzs)paramList.get(m);
      if ((a(localzzs, paramViewHolder)) && (localzzs.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == null) && (localzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == null)) {
        paramList.remove(localzzs);
      }
      m -= 1;
    }
  }
  
  private void a(zzs paramzzs)
  {
    ...
    {
      localObject2 = null;
      localObject1 = paramzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder;
      if (localObject1 == null) {
        break label284;
      }
      ...
      if (localObject2 != null) {
        if (!(localViewHolder instanceof zzj)) {
          break label289;
        }
      }
    }
    label284:
    label289:
    for (Object localObject1 = ((zzj)localViewHolder).a(paramzzs, getChangeDuration(), true);; localObject1 = null)
    {
      this.k.add(paramzzs.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      Object localObject3 = localObject1;
      if (localObject1 == null)
      {
        localObject3 = ViewCompat.animate((View)localObject2).setDuration(getChangeDuration());
        ((ViewPropertyAnimatorCompat)localObject3).translationX(paramzzs.c - paramzzs.jdField_a_of_type_Int);
        ((ViewPropertyAnimatorCompat)localObject3).scaleY(1.0F);
        ((ViewPropertyAnimatorCompat)localObject3).scaleX(1.0F);
        ((ViewPropertyAnimatorCompat)localObject3).translationY(paramzzs.d - paramzzs.jdField_b_of_type_Int);
        ((ViewPropertyAnimatorCompat)localObject3).alpha(0.0F);
      }
      ((ViewPropertyAnimatorCompat)localObject3).setListener(new zzp(this, paramzzs, (ViewPropertyAnimatorCompat)localObject3)).start();
      if (localView != null)
      {
        localObject1 = localObject4;
        if ((localViewHolder instanceof zzj)) {
          localObject1 = ((zzj)localViewHolder).a(paramzzs, getChangeDuration(), false);
        }
        this.k.add(paramzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
        ...
        ((ViewPropertyAnimatorCompat)localObject2).setListener(new zzq(this, paramzzs, (ViewPropertyAnimatorCompat)localObject2, localView)).start();
      }
      return;
  ...
  private boolean a(zzs paramzzs, RecyclerView.ViewHolder paramViewHolder)
  {
    boolean bool2 = false;
    boolean bool1 = false;
    if (paramzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder) {
      paramzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder = null;
    }
    for (;;)
    {
      ...
      do
      {
        return bool1;
        bool1 = bool2;
      } while (paramzzs.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder != paramViewHolder);
      paramzzs.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder = null;
      bool1 = true;
    }
  }
  ...
  private void b(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    localViewPropertyAnimatorCompat.alpha(1.0F).setDuration(getAddDuration()).translationX(0.0F).translationY(0.0F).setInterpolator(new DecelerateInterpolator()).setListener(new zzn(this, paramViewHolder, localViewPropertyAnimatorCompat)).start();
  }
  
  private void b(zzs paramzzs)
  {
    if (paramzzs.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder != null) {
      a(paramzzs, paramzzs.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
    }
    if (paramzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder != null) {
      a(paramzzs, paramzzs.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
    }
  }
  ...
  {
    c(paramViewHolder);
    Object localObject = paramViewHolder.itemView.getTag(2131376627);
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Zzr.jdField_a_of_type_Int == 2)
        {
          localObject = new int[2];
          paramViewHolder.itemView.getLocationOnScreen((int[])localObject);
          int m = this.jdField_a_of_type_Zzr.jdField_b_of_type_Int;
          m = paramViewHolder.itemView.getWidth() / 2;
          m = this.jdField_a_of_type_Zzr.c;
          m = paramViewHolder.itemView.getHeight() / 2;
          animateMove(paramViewHolder, this.jdField_a_of_type_Zzr.jdField_b_of_type_Int, this.jdField_a_of_type_Zzr.c, 0, 0);
          return true;
        }
      }
      else {
  ...
  public boolean animateChange(RecyclerView.ViewHolder paramViewHolder1, RecyclerView.ViewHolder paramViewHolder2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    zzs localzzs = new zzs(paramViewHolder1, paramViewHolder2, paramInt1, paramInt2, paramInt3, paramInt4, null);
    ...
    if (paramViewHolder2 != null)
    {
      c(paramViewHolder2);
      boolean bool = false;
      if ((paramViewHolder2 instanceof zzj)) {
        bool = ((zzj)paramViewHolder2).a(localzzs);
      }
      if (!bool)
      {
  ...
  public boolean animateMove(RecyclerView.ViewHolder paramViewHolder, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    this.c.add(new zzt(paramViewHolder, paramInt1, paramInt2, paramInt3, paramInt4, null));
    return true;
  }
  ...
  public void endAnimation(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    while (m >= 0)
    {
      if (((zzt)this.c.get(m)).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
    ...
    if (m >= 0)
    {
      ...
      for (;;)
      {
        if (n >= 0)
        {
          if (((zzt)localArrayList.get(n)).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder != paramViewHolder) {
            break label293;
          }
          ViewCompat.setTranslationY(localView, 0.0F);
          ViewCompat.setTranslationX(localView, 0.0F);
  ...
  public void endAnimations()
  {
    ...
    while (m >= 0)
    {
      localObject1 = (zzt)this.c.get(m);
      localObject2 = ((zzt)localObject1).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView;
      ViewCompat.setTranslationY((View)localObject2, 0.0F);
      ViewCompat.setTranslationX((View)localObject2, 0.0F);
      dispatchMoveFinished(((zzt)localObject1).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      this.c.remove(m);
      m -= 1;
    }
    ...
    if (isRunning())
    {
      ...
      while (m >= 0)
      {
        ...
        while (n >= 0)
        {
          localObject2 = (zzt)((ArrayList)localObject1).get(n);
          View localView = ((zzt)localObject2).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView;
          ViewCompat.setTranslationY(localView, 0.0F);
          ViewCompat.setTranslationX(localView, 0.0F);
          dispatchMoveFinished(((zzt)localObject2).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      ...
      while (m >= 0)
      {
        ...
        while (n >= 0)
        {
          b((zzs)((ArrayList)localObject1).get(n));
          if (((ArrayList)localObject1).isEmpty()) {
  ...
  {
    if ((paramViewHolder.itemView instanceof zzk)) {
      ((zzk)paramViewHolder.itemView).b(paramBoolean);
    }
  }
  ...
  {
    if ((paramViewHolder.itemView instanceof zzk)) {
      ((zzk)paramViewHolder.itemView).a(paramBoolean);
    }
  }
  ...
  {
    if ((paramViewHolder.itemView instanceof zzk)) {
      ((zzk)paramViewHolder.itemView).c();
    }
  }
  ...
  {
    if ((paramViewHolder.itemView instanceof zzk)) {
      ((zzk)paramViewHolder.itemView).a();
    }
  }
    ...
    for (;;)
    {
      if ((m != 0) || (n != 0) || (i2 != 0) || (i1 != 0))
      {
        ...
        if (n != 0)
        {
          ...
          ViewCompat.postOnAnimationDelayed(((zzt)((ArrayList)localObject1).get(0)).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView, (Runnable)localObject2, getRemoveDuration());
        }
        if (i1 != 0)
        {
          localObject1 = new ArrayList();
          ...
          ViewCompat.postOnAnimationDelayed(((zzs)((ArrayList)localObject1).get(0)).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView, (Runnable)localObject2, getRemoveDuration());
        }
      }
    }
    for (;;)
