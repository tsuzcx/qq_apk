...
public class amek
  extends aojs
{
  public amek(SelectMemberActivity paramSelectMemberActivity) {}
    ...
    if (paramInt1 == 8)
    {
      if (paramInt2 == 0)
      {
        ...
        if (!this.a.jdField_c_of_type_Boolean)
        {
          ...
          bdll.b(this.a.app, "CliOper", "", "", "Grp", "Send_invite", 0, 0, "", "", "", "");
        }
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2)
  {
    ...
    if ((paramBoolean) && (str.equals(this.a.jdField_c_of_type_JavaLangString)))
    {
      ...
      if ((this.a.i >= this.a.jdField_a_of_type_Long) && (this.a.jdField_a_of_type_Long > 0L))
      {
        ...
        bdll.b(this.a.app, "dc00899", "invite_friend", "", "friend_list", "exp_needagree", 0, 0, str, mvb.a(this.a.app, this.a.app.getCurrentAccountUin(), str) + "", "", "");
      }
    }
  }
