...
public class akmq
{
  ...
  private static ArrayList<akmr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static int a()
  {
    ...
    {
      akmr localakmr = (akmr)jdField_a_of_type_JavaUtilArrayList.get(i);
      k = j;
      if (localakmr != null)
      {
        k = j;
        if (localakmr.jdField_c_of_type_Int == 0) {
          k = j + 1;
        }
      }
      i += 1;
  ...
  private static akmr a()
  {
    ...
    for (;;)
    {
      ...
      if (localakmr != null)
      {
        localObject = localakmr;
        if (localakmr.jdField_c_of_type_Int == 1) {
          break;
        }
      }
      i += 1;
  ...
  public static akmr a(boolean paramBoolean)
  {
    Object localObject;
    if (jdField_a_of_type_JavaUtilArrayList == null)
    {
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        localakmr = (akmr)jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localakmr != null)
        {
          localObject = localakmr;
          if (localakmr.jdField_c_of_type_Int == 0) {
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      {
        akmr localakmr = (akmr)jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localakmr == null) || (localakmr.jdField_c_of_type_Int == 1)) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, akmr paramakmr)
  {
    if ((paramQQAppInterface == null) || (jdField_a_of_type_JavaUtilArrayList == null) || (paramakmr == null) || (paramakmr.jdField_b_of_type_Int < 1) || (paramakmr.jdField_b_of_type_Int > 7) || (TextUtils.isEmpty(paramakmr.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.qwallet.push", 2, "params error, pcPayDatas=" + jdField_a_of_type_JavaUtilArrayList + ",app=" + paramQQAppInterface + ",pcPayData=" + paramakmr);
      }
      return;
    }
    if (paramakmr.jdField_b_of_type_Int == 1) {
    ...
    for (;;)
    {
      ...
      {
        jdField_a_of_type_JavaUtilArrayList.add(paramakmr);
        if (b(paramQQAppInterface))
        {
          ...
          b(paramQQAppInterface, paramakmr);
          return;
        }
      }
      if (jdField_a_of_type_Long != 0L) {
      ...
      c(paramQQAppInterface, paramakmr);
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        ...
        if ((k == 1) && (m == 2))
        {
          bgmg.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()));
          bgmg.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()) + "_");
          i = 1;
          continue;
        }
        if ((k == 2) && (m == 1))
        ...
        if ((k == 2) && (m == 2))
        {
          bgmg.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getPersonalInfoFileName(paramQQAppInterface.getCurrentAccountUin()));
          i = 1;
          continue;
        }
        if ((k != 8) || (m != 1)) {
        ...
        ((akpd)paramQQAppInterface.getManager(245)).b(0);
        break label462;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          akrp.a(0, paramQQAppInterface, null);
          return;
        }
        catch (Exception paramQQAppInterface) {}
      }
  ...
  private static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      boolean bool2 = bgrj.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (!bool2)
      {
        ...
        if (localakmr == null)
        {
          ...
          localakmr = (akmr)jdField_a_of_type_JavaUtilArrayList.get(0);
          if (localakmr == null)
          {
          ...
          i = a(localakmr.jdField_b_of_type_Int);
          if (i == 0)
          {
            jdField_a_of_type_JavaUtilArrayList.remove(0);
            b(paramQQAppInterface);
        ...
        for (;;)
        {
          ...
          {
            localakmr.jdField_c_of_type_Int = 2;
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (bool1)
          {
            ...
            bool2 = bool1;
            if (43200L * 1000L + localakmr.jdField_c_of_type_Long > l) {
              bool2 = false;
            }
          }
          if (bool2) {
  ...
  private static void b(QQAppInterface paramQQAppInterface, akmr paramakmr)
  {
    String str1;
    boolean bool1;
    if (bgrj.a(paramQQAppInterface.getApp()))
    {
      ((PowerManager)paramQQAppInterface.getApp().getSystemService("power")).newWakeLock(268435462, "Q.qwallet.push").acquire(10000L);
      String str2 = String.format(BaseApplication.getContext().getString(2131715999), new Object[] { Integer.valueOf(a()) });
      if (!TextUtils.isEmpty(paramakmr.jdField_b_of_type_JavaLangString))
      {
        str1 = paramakmr.jdField_b_of_type_JavaLangString;
        ...
        localIntent.putExtra("time", bgsu.b(BaseApplication.getContext(), paramakmr.jdField_b_of_type_Long));
    ...
    else
    {
      ...
      bool2 = msf.d(paramQQAppInterface.getApp());
      boolean bool3 = paramQQAppInterface.d();
      boolean bool4 = paramQQAppInterface.w();
      boolean bool5 = bghu.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool2 = false;; bool2 = true)
    {
      ...
      if (bool1)
      {
        ...
        bgkl.a(Uri.fromFile(paramQQAppInterface), false, true);
      }
      return;
      str1 = BaseApplication.getContext().getString(2131715998);
      break;
      bool1 = true;
      break label327;
    }
    label495:
    bgkl.a(2131230759, false);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    //   23: lload 5
    //   25: iload 7
    //   27: invokestatic 267	akmq:a	(JIJI)Z
    //   30: ifeq +19 -> 49
    ...
    //   877: invokespecial 772	ayus:<init>	(IILjava/lang/String;)V
    //   880: astore_0
    ...
    //   884: aload_0
    //   885: invokevirtual 782	com/tencent/mobileqq/openapi/OpenApiManager:onPayMsgRsp	(Layus;)V
    //   888: goto -337 -> 551
    //   891: astore 12
  ...
  private static void c(QQAppInterface paramQQAppInterface, akmr paramakmr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.qwallet.push", 2, "startBackgroundPay");
    }
    if ((paramQQAppInterface == null) || (paramQQAppInterface.getApp() == null) || (paramakmr == null)) {}
    for (;;)
    {
      return;
      String str = String.format(BaseApplication.getContext().getString(2131715999), new Object[] { Integer.valueOf(a()) });
      Object localObject = paramakmr.jdField_b_of_type_JavaLangString;
      paramakmr = (akmr)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramakmr = BaseApplication.getContext().getString(2131715998);
      }
      ...
      try
      {
        paramQQAppInterface = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_SHOW_BADGE").setSmallIcon(2130841392).setWhen(System.currentTimeMillis()).setAutoCancel(true).setContentTitle(str).setContentText(paramakmr).setContentIntent(paramQQAppInterface).build();
        paramakmr = QQNotificationManager.getInstance();
        if (paramakmr != null)
        {
          paramakmr.cancel("Q.qwallet.push", 238);
          paramakmr.notify("Q.qwallet.push", 238, paramQQAppInterface);
          return;
        }
      }
