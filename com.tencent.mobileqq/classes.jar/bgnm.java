...
public class bgnm
{
  ...
  private List<bgnk> jdField_a_of_type_JavaUtilList = new ArrayList();
  private int b;
  private int c;
  private int d;
  private int e;
  ...
  public bgnm(FollowImageTextView paramFollowImageTextView)
  {
  ...
  private void a()
  {
    ...
    if (j < i1) {
      ...
      {
        localbgnk = new bgnk(null);
        localbgnk.jdField_a_of_type_Int = i;
        localbgnk.b = (j - 1);
        localbgnk.c = k;
        localbgnk.jdField_a_of_type_JavaLangCharSequence = this.jdField_a_of_type_JavaLangCharSequence.subSequence(i, j);
        this.jdField_a_of_type_JavaUtilList.add(localbgnk);
        i = j + 1;
        k = 0;
      }
    }
    for (;;)
    {
      ...
      if (j == i1 - 1)
      {
        ...
        localbgnk.b = (j - 1);
        localbgnk.c = m;
        localbgnk.jdField_a_of_type_JavaLangCharSequence = this.jdField_a_of_type_JavaLangCharSequence.subSequence(i, i1);
        this.jdField_a_of_type_JavaUtilList.add(localbgnk);
      }
      else
      {
  ...
  {
    bgnj localbgnj = FollowImageTextView.a(this.jdField_a_of_type_ComTencentMobileqqTroopWidgetFollowImageTextView);
    this.jdField_a_of_type_JavaLangCharSequence = localbgnj.getText();
    this.jdField_a_of_type_AndroidTextTextPaint = localbgnj.getPaint();
    this.jdField_a_of_type_Int = localbgnj.getMeasuredWidth();
    this.b = localbgnj.getLineHeight();
    this.d = localbgnj.getPaddingLeft();
    this.e = localbgnj.getPaddingTop();
    this.f = localbgnj.getPaddingRight();
    this.g = localbgnj.getPaddingBottom();
    this.c = paramInt;
    a();
  }
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (k < j)
        {
          CharSequence localCharSequence = ((bgnk)this.jdField_a_of_type_JavaUtilList.get(k)).jdField_a_of_type_JavaLangCharSequence;
      ...
      {
        paramCanvas = (bgnk)this.jdField_a_of_type_JavaUtilList.get(j);
