  ...
  extends ltj
{
  ...
  private Frame a(List<lto> paramList, Frame paramFrame)
  {
    ArrayList localArrayList1 = new ArrayList();
    int i = 0;
    while (i < paramList.size())
    {
      float[][] arrayOfFloat = ((TTFaceOriginDataModel)((lto)paramList.get(i)).jdField_a_of_type_JavaUtilList.get(0)).facePoint;
  ...
  {
    Object localObject2 = (ltn)paramList.get(0);
    Object localObject1 = ((ltn)paramList.get(0)).jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame;
    ...
    if (((ltn)localObject2).a())
    {
      int i = 0;
      while (i < ((ltn)localObject2).jdField_a_of_type_JavaUtilList.size())
      {
        localArrayList.addAll(((lto)((ltn)localObject2).jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaUtilList);
        i += 1;
      }
    }
    ...
    if ((this.d) && (((ltn)localObject2).a()))
    {
      localObject2 = a(((ltn)localObject2).jdField_a_of_type_JavaUtilList, (Frame)localObject1);
      paramList = (List<ltn>)localObject2;
    ...
    for (paramList = (List<ltn>)localObject2;; paramList = (List<ltn>)localObject1)
    {
