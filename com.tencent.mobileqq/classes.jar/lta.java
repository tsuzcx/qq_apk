  ...
  implements msv
{
  ...
  public void a(String paramString, msw parammsw)
  {
    if (QLog.isColorLevel()) {
      QLog.d("RandomController", 2, "onGetNearbyPeopleProfile uin :" + paramString + ", nickname:" + parammsw.b + ", gender:" + parammsw.a);
    }
    if (paramString.equals(RandomController.a(this.a).getAccount()))
    {
      if (parammsw.a != -1) {
        RandomController.a(this.a).a(parammsw.a);
      }
