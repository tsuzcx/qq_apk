...
public class akkw
  extends akks
{
  public akkw(QQAppInterface paramQQAppInterface, akkr paramakkr)
  {
    super(paramQQAppInterface, paramakkr, RoamDate.class);
  }
  ...
  {
    paramaukm = (RoamDate)paramaukm;
    return paramaukm.uin + "&" + paramaukm.date;
  }
  ...
  public Calendar a(String paramString, Calendar paramCalendar, List<Map.Entry<String, aukm>> paramList)
  {
  ...
  public void a(String paramString)
  {
    ...
    paramString = ((aukn)localObject).a(RoamDate.class, false, "uin=?", new String[] { paramString }, null, null, null, null);
    ((aukn)localObject).a();
    if (paramString != null)
    {
      c();
  ...
  public boolean a(String paramString, Calendar paramCalendar, List<Map.Entry<String, aukm>> paramList)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    int j;
  ...
  public Calendar b(String paramString, Calendar paramCalendar, List<Map.Entry<String, aukm>> paramList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = paramList;
