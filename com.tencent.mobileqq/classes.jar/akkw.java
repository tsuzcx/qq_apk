...
public class akkw
{
  ...
  public akkw(ApolloRenderDriver paramApolloRenderDriver, ApolloRender paramApolloRender)
  {
  ...
  public int a(int paramInt, String paramString, int[] paramArrayOfInt, alcc paramalcc)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, new Object[] { "[onChangeDress] apolloId=", paramString, ", roleType=", Integer.valueOf(paramInt), ", dressId=", paramArrayOfInt, ", callback=", paramalcc });
    }
    int i;
    ...
    paramInt = this.jdField_a_of_type_ComTencentMobileqqApolloApolloRenderDriver.a(paramInt, paramString, paramArrayOfInt, paramalcc);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloRenderDriver.a();
    return paramInt;
  }
