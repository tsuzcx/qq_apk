...
public class akkw
  implements Runnable
{
  public akkw(AioVipKeywordHelper paramAioVipKeywordHelper, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Context paramContext, String paramString, ChatMessage paramChatMessage, boolean paramBoolean) {}
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqVipAioVipKeywordHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo))
      {
        ...
        for (;;)
        {
          ...
          if ((!TextUtils.isEmpty(localContext)) && (((String)localObject1).contains(localContext)))
          {
            ...
            ThreadManager.getUIHandler().postDelayed(new akkx(this, localContext), this.jdField_a_of_type_ComTencentMobileqqVipAioVipKeywordHelper.d);
            return;
          }
          i += 1;
        }
