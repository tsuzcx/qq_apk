...
public class ngr
{
  private static volatile ngr jdField_a_of_type_Ngr;
  ...
  public static ngr a()
  {
    if (jdField_a_of_type_Ngr == null) {}
    try
    {
      if (jdField_a_of_type_Ngr == null) {
        jdField_a_of_type_Ngr = new ngr();
      }
      return jdField_a_of_type_Ngr;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    for (;;)
    {
      try
      {
        Object localObject1 = (nji)apub.a().a(642);
        if (localObject1 != null)
        {
          ...
          {
            bool = ((nji)localObject1).a(Long.valueOf(((AVGameAppInterface)localObject3).getCurrentAccountUin()).longValue());
            if (!bool)
            {
            ...
            localObject1 = lzq.a().a("AVGameVoiceRecogSo");
            localObject3 = lzq.a().a("AVGameVoiceRecogModel");
            ...
            if (!lzq.a().b("AVGameVoiceRecogSo"))
            {
              lzq.a().a("AVGameVoiceRecogSo");
              QLog.e("AVGameVoiceRecog", 1, "init failed. so file no exist.");
              bool = false;
              continue;
            }
            if (!lzq.a().b("AVGameVoiceRecogModel"))
            {
              lzq.a().a("AVGameVoiceRecogModel");
  ...
  public boolean d()
  {
    ...
    //   23: aload_0
    //   24: getfield 13	ngr:jdField_a_of_type_Int	I
    ...
    //   36: aload_0
    //   37: getfield 13	ngr:jdField_a_of_type_Int	I
    //   40: istore_1
    //   41: iload_1
    //   42: iconst_m1
    //   43: if_icmpeq +25 -> 68
    ...
    //   52: aload_0
    //   53: iconst_m1
    //   54: putfield 13	ngr:jdField_a_of_type_Int	I
    //   57: iconst_1
    //   58: istore_2
    //   59: aload_0
    //   60: monitorexit
