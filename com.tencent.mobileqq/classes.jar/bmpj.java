...
{
  private static bmpj jdField_a_of_type_Bmpj;
  ...
  public static bmpj a()
  {
    if (jdField_a_of_type_Bmpj == null) {}
    try
    {
      if (jdField_a_of_type_Bmpj == null) {
        jdField_a_of_type_Bmpj = new bmpj();
      }
      return jdField_a_of_type_Bmpj;
    }
    finally {}
  }
  ...
  public void a(@NonNull Context paramContext, @NonNull ImageView paramImageView, long paramLong)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.getComposition() == null)
    {
      ...
      {
        bmqw.b("LoadingAnimationManager", "loadLottieAnimation  fail :", paramContext);
        return;
      }
    }
    a(paramLong);
