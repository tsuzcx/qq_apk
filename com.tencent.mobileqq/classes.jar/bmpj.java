...
public class bmpj
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130850880);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130850881);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new bmpm(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new bmpn(this);
  private ListView jdField_a_of_type_AndroidWidgetListView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private bmpo jdField_a_of_type_Bmpo;
  private Spring jdField_a_of_type_ComTencentComponentAnimationReboundSpring;
  public ArrayList<bmpp> a;
  ...
  public bmpj(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(int paramInt)
  {
    ...
    ViewUtils.setViewBackground(this.jdField_a_of_type_AndroidWidgetRelativeLayout, jdField_c_of_type_AndroidGraphicsDrawableDrawable);
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new bmpk(this));
    this.jdField_a_of_type_Bmpo = new bmpo(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365907));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Bmpo);
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new bmpl(this));
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      ViewUtils.setScaleX(this.jdField_a_of_type_AndroidWidgetListView, f3);
      ViewUtils.setScaleY(this.jdField_a_of_type_AndroidWidgetListView, f3);
      if (this.jdField_c_of_type_Boolean)
      {
        ViewUtils.setPivotY(this.jdField_a_of_type_AndroidWidgetListView, 0.0F);
        ViewUtils.setPivotX(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      for (;;)
      {
        ...
        f3 = f2;
        break;
        ViewUtils.setPivotY(this.jdField_a_of_type_AndroidWidgetListView, this.d);
        ViewUtils.setPivotX(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      label221:
      break;
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    ViewUtils.setViewBackground(this.jdField_a_of_type_AndroidWidgetListView, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void a(bmpp parambmpp)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (parambmpp != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambmpp);
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = ViewUtils.getScreenWidth() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingRight() * 2;
    ...
    localLayoutParams1.topMargin = (paramInt2 - i - ViewUtils.dpToPx(5.0F));
  ...
  public int b()
  {
    ...
    {
      i = ViewUtils.getScreenHeight() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight();
      if (i > ViewUtils.dpToPx(25.0F)) {}
    }
    int j;
    do
    {
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    ViewUtils.setViewBackground(this.jdField_a_of_type_AndroidWidgetListView, jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_AndroidWidgetListView != null) {
      this.jdField_a_of_type_AndroidWidgetListView.setPadding(this.jdField_a_of_type_AndroidWidgetListView.getPaddingLeft(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingTop() + ViewUtils.dpToPx(9.0F), this.jdField_a_of_type_AndroidWidgetListView.getPaddingRight(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingBottom());
    }
    super.showAtLocation(a(), 17, 0, 0);
    c();
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Bmpo.getCount())
    {
      View localView = this.jdField_a_of_type_Bmpo.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
      j += localView.getMeasuredHeight();
      i += 1;
    }
    this.jdField_b_of_type_Int = (ViewUtils.dpToPx(9.0F) + j);
  }
}
