  ...
  implements View.OnClickListener
{
  ...
  public yul(Context paramContext, ApolloGameViewBinder paramApolloGameViewBinder)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup = new yun(null);
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidViewViewGroup[0] = ((ViewGroup)paramView.findViewById(2131363131));
      paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[0] = ((URLImageView)paramView.findViewById(2131363132));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131363134));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0] = ((ImageView)paramView.findViewById(2131363133));
      ...
      paramViewGroup.b[0] = ((ImageView)paramView.findViewById(2131363135));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidViewViewGroup[1] = ((ViewGroup)paramView.findViewById(2131363136));
      paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[1] = ((URLImageView)paramView.findViewById(2131363137));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131363139));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[1] = ((ImageView)paramView.findViewById(2131363138));
      ...
      paramViewGroup.b[1] = ((ImageView)paramView.findViewById(2131363140));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidViewViewGroup[2] = ((ViewGroup)paramView.findViewById(2131363141));
      paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[2] = ((URLImageView)paramView.findViewById(2131363142));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131363144));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[2] = ((ImageView)paramView.findViewById(2131363143));
      ...
      paramViewGroup.b[2] = ((ImageView)paramView.findViewById(2131363145));
    ...
    for (Object localObject1 = ApolloGameViewBinder.a((ApolloGameViewBinder)localObject1);; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        {
          paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setImageResource(2130838072);
        ...
        for (;;)
        {
          if (i != 0)
          {
            localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845923);
            ...
            ((URLDrawable.URLDrawableOptions)localObject3).mLoadingDrawable = ((Resources)localObject2).getDrawable(2130838115);
            ((URLDrawable.URLDrawableOptions)localObject3).mFailedDrawable = ((Resources)localObject2).getDrawable(2130838115);
          ...
          for (;;)
          {
            if ((i < ApolloGameUtil.a()) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null) && (((ApolloGameViewBinder)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(localApolloGameData.gameId)) && (paramViewGroup.b[j].getVisibility() != 0))
            {
              ...
              if (ApolloGameViewBinder.jdField_a_of_type_Boolean)
              {
                ...
                ((ImageView)localObject2).postDelayed(new yum(this, (ImageView)localObject2), 200L);
              }
            }
            for (;;)
            {
              j += 1;
              break label386;
              paramViewGroup = (yun)paramView.getTag();
              break;
              ...
              {
                i = 1;
                paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setImageResource(2130838046);
                paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setVisibility(0);
                break label589;
              }
              ...
              break label680;
              paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[j].setImageResource(2130838115);
              break label773;
  ...
  public void onClick(View paramView)
  {
    ...
    if (localApolloGameViewBinder != null) {
      if (ApolloGameViewBinder.a(localApolloGameViewBinder) != null) {
        if (paramView.getId() == 2131363131) {
          paramView = paramView.findViewById(2131363135);
        }
      }
    }
    for (;;)
    {
      ...
      {
        break label218;
        if (paramView.getId() == 2131363136)
        {
          paramView = paramView.findViewById(2131363140);
          break;
        }
        if (paramView.getId() != 2131363141) {
          break label400;
        }
        paramView = paramView.findViewById(2131363145);
        break;
