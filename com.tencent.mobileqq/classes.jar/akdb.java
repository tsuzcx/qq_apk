...
public class akdb
{
  ...
  private akde jdField_a_of_type_Akde;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentHashMap<String, akdd> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  public akdb(akde paramakde)
  {
    this.jdField_a_of_type_Akde = paramakde;
  }
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      akdd localakdd = new akdd();
      if (m > k) {}
      for (paramString = paramString.substring(k, m);; paramString = "")
      {
        localakdd.jdField_a_of_type_JavaLangString = paramString;
        localakdd.jdField_a_of_type_Long = localFile.length();
        localakdd.jdField_a_of_type_Int = paramInt;
        localakdd.jdField_b_of_type_Int = 0;
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) {
          break;
        }
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localFile.getName(), localakdd);
        break label85;
      }
    }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Akde != null) && (a()))
    {
      this.jdField_a_of_type_Akde.a();
      if (QLog.isColorLevel()) {
  ...
  public String a(akdd paramakdd)
  {
    if (paramakdd == null) {
      return "";
    }
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append(a(paramakdd.jdField_a_of_type_Int));
    localStringBuffer.append(paramakdd.jdField_a_of_type_JavaLangString);
    return localStringBuffer.toString();
  }
  
  public ConcurrentHashMap<String, akdd> a()
  {
  ...
  public void a(String paramString, akdd paramakdd)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramakdd != null) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, paramakdd);
    }
  }
  ...
  {
    h();
    this.jdField_a_of_type_Akde = null;
  }
}
