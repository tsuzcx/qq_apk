...
public class rqa
{
  ...
  private HashMap<String, String> c()
  {
    ...
    for (String str = "";; str = this.jdField_a_of_type_JavaLangString)
    {
      ...
      localHashMap.put("param_version", "8.4.10.4875");
      localHashMap.put("param_subversion", "8.4.10");
  ...
  public HashMap<String, String> a()
  {
    ...
    if (this.jdField_a_of_type_Int == 2)
    {
      ...
      localHashMap.put("param_device_info", sgv.a());
    }
    ...
    localHashMap.put("param_prepareOptimizeConfigJson", pjc.a());
    localHashMap.put("param_httpbuffertime_for_playpreload", String.valueOf(bmhv.g()));
    localHashMap.put("param_dynamic_buffer_switch", String.valueOf(bmhv.h()));
    localHashMap.put("param_dynamic_buffer_config_json", bmhv.c());
    ...
    localHashMap.put("param_isSuperPlayer", String.valueOf(stw.a.a()));
    ...
    localHashMap.put("param_codecReuseConfigVersion", String.valueOf(set.a.a()));
    localHashMap.put("param_codecReuseDeviceSupport", String.valueOf(set.a.a()));
