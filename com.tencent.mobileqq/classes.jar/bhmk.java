  ...
  implements bhmj
{
  ...
  public bhmk(Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  private void initLayout()
  {
    ...
    View localView = LayoutInflater.from(this.mContext).inflate(2131563070, null);
    this.mInActivity.setContentView(localView);
    this.mViewRoot = localView.findViewById(2131381136);
    ...
    this.titleContainer = ((FrameLayout)this.mViewRoot.findViewById(2131378815));
    this.bottomContainer = ((FrameLayout)this.mViewRoot.findViewById(2131363586));
    this.webviewContainer = ((RelativeLayout)this.mViewRoot.findViewById(2131381155));
    this.mLoadProgress = ((ProgressBar)this.mViewRoot.findViewById(2131376313));
    this.maskView = this.mViewRoot.findViewById(2131381158);
    this.contentContainer = ((LinearLayout)this.mViewRoot.findViewById(2131365009));
    if ((this.mIntent != null) && (!this.mIntent.getBooleanExtra("webview_hide_progress", false)))
    {
      this.mLoadingProgressBar = ((WebViewProgressBar)this.mViewRoot.findViewById(2131372936));
      this.mProgressBarController = new bidh();
  ...
  protected void adjustLayout(boolean paramBoolean, bhmm parambhmm)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean)
    {
      localLayoutParams = (RelativeLayout.LayoutParams)parambhmm.b.getLayoutParams();
      localLayoutParams.topMargin = i;
      parambhmm.b.setLayoutParams(localLayoutParams);
      localLayoutParams = (RelativeLayout.LayoutParams)parambhmm.a.getLayoutParams();
      localLayoutParams.topMargin = 0;
      localLayoutParams.addRule(3, 0);
      parambhmm.a.setLayoutParams(localLayoutParams);
      return;
    }
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)parambhmm.b.getLayoutParams();
    localLayoutParams.topMargin = i;
    parambhmm.b.setLayoutParams(localLayoutParams);
    localLayoutParams = (RelativeLayout.LayoutParams)parambhmm.a.getLayoutParams();
    localLayoutParams.topMargin = (i + bggq.a(this.mContext, 50.0F));
    parambhmm.a.setLayoutParams(localLayoutParams);
  }
  ...
  public void buildLayout()
  {
    ...
    this.mWebview.setId(2131381152);
  ...
  public void buildTitleBar()
  {
    ...
    this.mTitleBar = new bhri(this.mInActivity, this.mWebview, this.titleContainer);
    this.titleContainer.setBackgroundResource(2130850087);
    ...
    this.mTitleBar.a(new bhml(this));
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if ((this.bNeedStatusTrans) && (ImmersiveUtils.isSupporImmersive() == 1))
    {
      ...
      int i = this.mInActivity.getResources().getColor(2131167042);
  ...
  protected void onImmersive(boolean paramBoolean, bhmm parambhmm)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean)
    {
      ...
      parambhmm.b.getBackground().setAlpha(0);
      return;
    }
    if (this.mSystemBarComp != null) {
      this.mSystemBarComp.setgetStatusBarVisible(true, 0);
    }
    parambhmm.b.setBackgroundResource(2130850087);
  ...
  protected final void setTittlebarImmersive(boolean paramBoolean, bhmm parambhmm)
  {
    if (QLog.isColorLevel()) {
      QLog.d("WebViewBaseBuilder", 2, "setTittlebarImmersive");
    }
    adjustLayout(paramBoolean, parambhmm);
    onImmersive(paramBoolean, parambhmm);
  }
}
