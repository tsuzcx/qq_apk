...
public class bhmk
{
  ...
  HashMap<String, bhml> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bhmk(TraeAudioManager paramTraeAudioManager) {}
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    paramString = (bhml)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {}
  ...
  public String a(int paramInt)
  {
    ...
    for (localObject = (bhml)localEntry.getValue();; localObject = null)
    {
      if (localObject != null) {}
      for (localObject = ((bhml)localObject).a();; localObject = "DEVICE_NONE")
      {
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
        return localObject;
        i += 1;
  ...
  public String a(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bhml localbhml = (bhml)((Map.Entry)localObject2).getValue();
      if ((localbhml != null) && (localbhml.a()) && (!localbhml.a().equals(paramString)))
      {
        if (localObject1 == null) {
          localObject2 = localbhml;
        }
        for (;;)
        {
  ...
  boolean a(String paramString, int paramInt)
  {
    ...
    bhml localbhml = new bhml(this);
    if (localbhml.a(paramString, paramInt)) {
    ...
    {
      return false;
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localbhml);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    Object localObject = (bhml)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if ((localObject != null) && (((bhml)localObject).a() != paramBoolean))
    {
      ((bhml)localObject).a(paramBoolean);
      ((bhml)localObject).b(paramBoolean);
      this.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel())
      {
  ...
  public String b()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      ((Map.Entry)localObject2).getValue();
      bhml localbhml = (bhml)((Map.Entry)localObject2).getValue();
      if ((localbhml != null) && (localbhml.a()) && (localbhml.b()))
      {
        if (localObject1 == null) {
          localObject2 = localbhml;
        }
  ...
  ArrayList<String> b()
  {
    ...
    while (localIterator.hasNext())
    {
      bhml localbhml = (bhml)((Map.Entry)localIterator.next()).getValue();
      if ((localbhml != null) && (localbhml.a()) && (localbhml.b())) {
        localArrayList.add(localbhml.a());
      }
    }
    return localArrayList;
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    Object localObject = (bhml)this.jdField_a_of_type_JavaUtilHashMap.get(this.c);
    if ((localObject != null) && (((bhml)localObject).a())) {}
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    bhml localbhml = (bhml)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if ((localbhml != null) && (localbhml.a())) {
      this.c = paramString;
    }
  ...
  String f()
  {
    bhml localbhml = (bhml)this.jdField_a_of_type_JavaUtilHashMap.get(this.b);
    if ((localbhml != null) && (localbhml.a())) {
      return this.b;
    }
    return "DEVICE_NONE";
  ...
  String g()
  {
    bhml localbhml = (bhml)this.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_JavaLangString);
    if ((localbhml != null) && (localbhml.a())) {
