...
public final class abns
{
  ...
  static
  {
    jdField_a_of_type_Abnt = new abnt(null);
  }
  
  public abns(int paramInt1, @NotNull String paramString, int paramInt2)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof abns))
      {
        paramObject = (abns)paramObject;
