      ...
      try
      {
        ...
        if (paramBundle.busi_buf.has())
        {
          ...
          if (paramArrayOfByte.ret.get() == 0)
          {
            ...
            new auzx().h("video").i("playpage_focus").b().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            ThreadManagerV2.excute(new PlayOperationViewModel.20.2(this, (auqc)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)), 16, null, false);
            return;
          }
