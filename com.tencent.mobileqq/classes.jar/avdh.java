  ...
  implements avcy, avef, avek
{
  ...
  public avdh(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Avdv = avdv.a(paramContext, 1);
    this.jdField_a_of_type_Avdv.a(this);
  ...
  private void n()
  {
    TVK_SDKMgr.installPlugin(BaseApplicationImpl.getApplication(), new avdp(this));
  }
  ...
  public void a()
  {
    ...
    this.c = true;
    this.h = false;
    this.jdField_a_of_type_Avdv.a();
    aveh.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.getContext()).b(this);
  ...
  {
    if (paramInt == 1) {
      if (this.jdField_a_of_type_Avdv.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
      {
        this.jdField_a_of_type_Avdv.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setDownloadNetworkChange(2);
        localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
        if ((this.jdField_a_of_type_Avdv.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.isPlaying()) && (!a(localQQAppInterface)))
        {
          b();
          m();
        }
    ...
    while ((paramInt != 4) || (this.jdField_a_of_type_Avdv.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null))
    {
      QQAppInterface localQQAppInterface;
      return;
    }
    this.jdField_a_of_type_Avdv.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setDownloadNetworkChange(1);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_Avdv.a() != 6) {
      return;
    }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    case 0: 
      ...
      for (paramInt = 1;; paramInt = 0)
      {
        ...
        bglp.a(paramView.getContext(), 232, null, anni.a(2131707171), new avdl(this, (QQAppInterface)localObject), new avdm(this, (QQAppInterface)localObject)).show();
        return;
      }
    ...
    case 1: 
      if (!this.f)
      {
        this.jdField_a_of_type_Avdv.a(null);
        label245:
    ...
    {
      this.jdField_a_of_type_Avdv.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avcz.jdField_a_of_type_Long, bool);
      this.f = false;
      break label245;
      if (!this.h) {
        break;
      ...
      paramView.append(avdc.a(this.jdField_a_of_type_Avdv.jdField_a_of_type_Long));
      paramView.append(" / ");
      paramView.append(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avcz.b);
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.a(paramView.toString());
      return;
      bool = this.jdField_a_of_type_Avdv.a();
      if (bool)
      {
        paramView = "0X8007ED7";
        label412:
      ...
      for (bool = true;; bool = false)
      {
        ...
        bcst.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", paramView, paramView, 0, 0, "", "", "", "");
      ...
      if ((!this.h) || ((!this.jdField_a_of_type_Avdv.b()) && (!this.f))) {
        break;
      }
      paramView = new StringBuilder();
      long l = this.jdField_a_of_type_Avdv.a();
      this.jdField_a_of_type_Avdv.a();
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.b(4);
      if (this.jdField_a_of_type_Avdv.c == 4) {
        paramView.append(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avcz.b);
      }
      for (;;)
      {
        ...
        c();
        e();
        QLog.d("PresenceInterfaceImpl", 2, "current position is mVideoPlayControl.getCurrentPosition()" + this.jdField_a_of_type_Avdv.a());
        return;
        paramView.append(avdc.a(l));
      }
      g();
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.b(3);
      d();
      return;
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_ComTencentMobileqqHotpicCircleProgressView.setProgress(this.jdField_a_of_type_Avdv.b());
      f();
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.b(6);
      c();
      e();
      return;
      if ((!this.h) || (!this.jdField_a_of_type_Avdv.b())) {
        break;
      }
      this.jdField_a_of_type_Avdv.a();
  ...
  public void a(int paramInt1, TVK_IMediaPlayer paramTVK_IMediaPlayer, int paramInt2, int paramInt3, int paramInt4, String paramString, Object paramObject)
  {
    ...
    new bibh(this.jdField_a_of_type_AndroidContentContext).a(HotVideoMongoliaRelativeLayout.jdField_a_of_type_JavaLangString, 100, 0, 1);
  ...
  public void a(View paramView)
  {
    ...
    aveh.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.getContext()).a(this);
  }
  ...
  {
    this.jdField_a_of_type_Avdv.a(paramBoolean);
  }
  
  boolean a()
  {
    long l = this.jdField_a_of_type_Avdv.b();
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Avdv.a() == 2) {
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Avdv != null) && (this.jdField_a_of_type_Avdv.b());
  }
  ...
  public void c()
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Avdv == null);
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Avdv.a();
  ...
  public void d(boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      File localFile = new File(avdc.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avcz.d));
  ...
  public void i()
  {
    ...
    Object localObject;
    boolean bool;
    if ((this.jdField_a_of_type_Avdv != null) && (this.jdField_a_of_type_Avdv.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null))
    {
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Avdv.a() == 3) {
  ...
  public void l()
  {
    ...
    bglp.a(this.jdField_a_of_type_AndroidContentContext, 232, null, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697007), new avdn(this), new avdo(this)).show();
  }
  
  void m()
  {
    a(bglp.a(this.jdField_a_of_type_AndroidContentContext, 232, null, this.jdField_a_of_type_AndroidContentContext.getString(2131718093), new avdj(this), new avdk(this)));
  }
}
