  ...
  implements aobv
{
  ...
  private avwu jdField_a_of_type_Avwu = new avyt(this);
  private avwv jdField_a_of_type_Avwv;
  private avyo jdField_a_of_type_Avyo;
  private bkhe jdField_a_of_type_Bkhe = new avyu(this);
  ...
  private HashMap<String, avyz> jdField_a_of_type_JavaUtilHashMap = new HashMap(10);
  ...
  {
    EditText localEditText = (EditText)this.jdField_a_of_type_ComTencentMobileqqLocationUiPoiSlideBottomPanel.findViewById(2131366102);
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new avyx(this, paramActivity, localEditText));
    this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.setListener(new avyy(this, paramActivity));
  ...
  {
    ThreadManager.getUIHandler().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    LocationRoom.Venue localVenue = this.jdField_a_of_type_Avyo.a();
    ...
    int i = this.jdField_a_of_type_Avyo.a();
    if (i >= 0) {
  ...
  {
    Object localObject2 = (avyz)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    long l = System.currentTimeMillis();
    Object localObject1;
    if (localObject2 != null)
    {
      if ((l - ((avyz)localObject2).jdField_a_of_type_Long < 4000L) && (((avyz)localObject2).jdField_a_of_type_AndroidGraphicsBitmap != null)) {
        return ((avyz)localObject2).jdField_a_of_type_AndroidGraphicsBitmap;
      }
      localObject1 = localObject2;
      if (l - ((avyz)localObject2).b < 2000L) {
        return null;
      }
    }
    else
    {
      localObject1 = new avyz(null);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    ((avyz)localObject1).b = l;
    ...
    {
      return localObject2;
      ((avyz)localObject1).jdField_a_of_type_Long = l;
      ((avyz)localObject1).jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject2);
    }
  }
  
  LocationRoom.Venue a()
  {
    return this.jdField_a_of_type_Avyo.a();
  }
  ...
  public void a(Activity paramActivity, avwp paramavwp, CameraPosition paramCameraPosition, MapWidget paramMapWidget, ImageView paramImageView, View paramView1, PoiSlideBottomPanel paramPoiSlideBottomPanel, XListView paramXListView, View paramView2, View paramView3)
  {
    ...
    this.jdField_a_of_type_Avyo = new avyo(paramActivity);
    this.jdField_a_of_type_Avyo.a(new avyv(this));
    paramXListView.setDividerHeight(0);
    paramXListView.setAdapter(this.jdField_a_of_type_Avyo);
    paramXListView.setSelectionAfterHeaderView();
    paramXListView.setOnScrollListener(this.jdField_a_of_type_Bkhe);
    paramXListView.setOnItemClickListener(new avyw(this, paramPoiSlideBottomPanel));
    bqcd.a(paramActivity);
    if (bqcd.jdField_a_of_type_Boolean) {}
    for (int i = bggq.a(paramActivity, 54.0F) + bqcd.jdField_a_of_type_Int;; i = bggq.a(paramActivity, 54.0F) + ImmersiveUtils.getStatusBarHeight(paramActivity))
    {
      this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.a(paramActivity, this.jdField_a_of_type_Avwv.a(this.jdField_a_of_type_Avwp), paramCameraPosition, i, paramPoiSlideBottomPanel);
      a(paramActivity);
  ...
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Avyo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.getMap(), this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelLatLng, paramString);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    avyz localavyz = (avyz)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    long l = System.currentTimeMillis();
    paramBitmap = localavyz;
    if (localavyz == null)
    {
      paramBitmap = new avyz(null);
