...
public class avys
  extends avyu
{
  private alwg jdField_a_of_type_Alwg = new avyt(this);
  ...
  public avys(QQAppInterface paramQQAppInterface)
  {
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2)
  {
    ...
    NotificationCompat.Builder localBuilder = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_HIDE_BADGE").setSmallIcon(2130840948).setAutoCancel(true).setOngoing(true).setWhen(System.currentTimeMillis());
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((i >= 512) && (i <= 522))
    {
      ...
      if (ajed.u.equals(paramIntent.getStringExtra("uin"))) {
        break label827;
      }
    ...
    for (;;)
    {
      ...
      if ((bool2) && ((k == 1001) || (k == 10002)))
      {
        ...
        if ((k == 1037) || (k == 1044)) {
          localObject1 = "CHANNEL_ID_LIMIT_CHAT";
        }
        paramIntent = NotificationFactory.createNotificationCompatBuilder((String)localObject1).setSmallIcon(j).setAutoCancel(true).setWhen(System.currentTimeMillis()).setTicker(paramString1);
        if ((k != 1030) && (k != 1035) && (k != 1041) && (k != 1042) && (bool1)) {
          paramIntent.setOngoing(true);
        }
        if (azyh.a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
        {
      ...
      for (;;)
      {
        ...
        if (k == 1030)
        {
          ...
          paramBitmap = azvq.a(BaseApplication.getContext().getResources(), 2130839762);
        ...
        Bitmap localBitmap = azvq.a(paramBitmap.getResources(), 2130839762);
  ...
  private void c(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (!balh.e)
    {
      paramToServiceMsg = bale.a().a(localIntent, localBitmap, arrayOfString[0], arrayOfString[1], arrayOfString[2], this.c, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      label155:
      if (!SettingCloneUtil.readValue(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), BaseApplication.getContext().getString(2131653032), "qqsetting_notify_showcontent_key", true)) {
        break label1204;
      }
      if (j != 1008) {
        break label394;
    ...
    for (;;)
    {
      ...
      else if (j == 1030)
      {
        ...
        Object localObject2 = new awqs();
        ((awqs)localObject2).e = "0X800923F";
        ((awqs)localObject2).d = "Android系统通知曝光";
        if (QLog.isColorLevel()) {
          QLog.d("CampusNoticeManager", 2, new Object[] { "notification url :", localIntent.getStringExtra("url") });
        }
        awqr.a(localIntent.getStringExtra("url"), (awqs)localObject2);
        awqr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (awqs)localObject2);
        localObject2 = (alrl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(240);
      ...
      else if ((j == 1035) || (j == 1041) || (j == 1042))
      {
        ...
        arim.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localIntent.getStringExtra("push_notice_service_id"), localIntent.getStringExtra("push_notice_content_id"), localIntent.getStringExtra("url"), "0X800923F", "Android系统通知曝光");
        if (QLog.isColorLevel()) {
          QLog.d("PushNoticeManager", 2, new Object[] { "notification url :", localIntent.getStringExtra("url") });
        }
        a(str, j, paramToServiceMsg, (String)localObject1, i);
        if (Build.VERSION.SDK_INT >= 19) {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.r();
        }
        if (QLog.isColorLevel()) {
      ...
      else
      {
        if ((j == 0) && (localIntent.getBooleanExtra("key_reactive_push_tip", false))) {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 2, 0, "", "", "", "");
        }
        if ((befx.a(j)) && (befx.a(str)))
        {
          j = localIntent.getIntExtra("param_notifyid", 0);
          a(275);
  ...
  protected void a()
  {
    ...
    {
      super.a();
      a(new avzh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new awbq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new avzw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new awbj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new awaj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new awbx());
      awbs localawbs = new awbs();
      a(localawbs);
      localawbs.a(this.jdField_a_of_type_Alwg);
      a(new avzq());
      a(new awcc());
      a(new avzv());
      a(new avyy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new avzd());
      a(new avze());
      a(new mny(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new awbu());
      a(new awbv());
      a(new avzc());
      a(new awbt());
      a(new awcg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      super.d();
      return;
    }
    finally
  ...
  {
    arih.a().a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  
  public void a(ToServiceMsg paramToServiceMsg)
  {
    b(paramToServiceMsg, this.jdField_a_of_type_Alwg, alwi.class);
  }
  
  protected void a(ToServiceMsg paramToServiceMsg, alwg paramalwg, Class<? extends MSFServlet> paramClass)
  {
    ...
    super.a(paramToServiceMsg, paramalwg, alwi.class);
  }
  ...
  void a(String paramString1, int paramInt1, Notification paramNotification, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aufl localaufl = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localaufl == null) {
          break label305;
        }
        i = localaufl.a();
      ...
      if (beeq.a(BaseApplicationImpl.getApplication().getApplicationContext())) {
        beeq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i, paramNotification);
      }
      if (!TextUtils.isEmpty(paramString1))
      {
