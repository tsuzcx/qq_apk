...
{
  public aqzz(LocationDialogUtil.11 param11) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    paramDialogInterface = aqzc.a((QQAppInterface)this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface());
    paramDialogInterface.c(new aqyw(this.a.jdField_a_of_type_Int, this.a.jdField_b_of_type_JavaLangString));
