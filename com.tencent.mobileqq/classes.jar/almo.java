  ...
  implements alms
{
  ...
  almr jdField_a_of_type_Almr = almr.a();
  String jdField_a_of_type_JavaLangString;
  List<almq> jdField_a_of_type_JavaUtilList;
  Paint b = new Paint();
  int c;
  int d;
  
  public almo(Resources paramResources)
  {
  ...
  public List<almq> a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        List localList1 = this.jdField_a_of_type_Almr.a(this);
        ...
        if (i < localList1.size())
        {
          ...
          this.jdField_a_of_type_JavaUtilList.add(new almp(this, i, localDiyPendantSticker.angle, localDiyPendantSticker.text, localDiyPendantSticker.fontId, localDiyPendantSticker.fontType, j));
          i += 1;
          continue;
        }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((almq)((Iterator)localObject).next()).a(paramCanvas, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
    }
  }
