  ...
  extends BaseAdapter
{
  ...
  List<bgcs> jdField_a_of_type_JavaUtilList;
  
  public alhv(alhs paramalhs) {}
  ...
  public android.view.View getView(int paramInt, android.view.View paramView, android.view.ViewGroup paramViewGroup)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 22	alhv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   4: astore 5
    //   6: aload 5
    //   8: ifnonnull +29 -> 37
    //   11: aload_2
    ...
    //   26: aload_0
    //   27: iload_1
    //   28: invokevirtual 63	alhv:getItemId	(I)J
    ...
    //   44: dup
    //   45: aload_0
    //   46: invokespecial 72	alhw:<init>	(Lalhv;)V
    //   49: astore 7
    //   51: aload_0
    //   52: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   55: getfield 77	alhs:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   87: putfield 100	alhw:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    //   90: aload_2
    //   91: astore 5
    //   93: aload 7
    //   95: aload_2
    ...
    //   104: putfield 106	alhw:jdField_a_of_type_ComTencentMobileqqVasAvatarVasAvatar	Lcom/tencent/mobileqq/vas/avatar/VasAvatar;
    //   107: aload_2
    //   108: astore 5
    //   110: aload 7
    //   112: aload_2
    ...
    //   121: putfield 112	alhw:jdField_a_of_type_AndroidWidgetImageView	Landroid/widget/ImageView;
    //   124: aload_2
    //   125: astore 5
    //   127: aload 7
    //   129: aload_2
    ...
    //   138: putfield 118	alhw:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   141: aload_2
    //   142: astore 5
    //   144: aload 7
    //   146: aload_2
    ...
    //   155: putfield 122	alhw:b	Landroid/widget/ImageView;
    //   158: aload_2
    //   159: astore 5
    //   161: aload 7
    //   163: getfield 100	alhw:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    ...
    //   179: aload 6
    //   181: aload_0
    //   182: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   185: getfield 129	alhs:g	I
    //   188: putfield 134	android/view/ViewGroup$LayoutParams:width	I
    //   191: aload_2
    //   192: astore 5
    //   194: aload 6
    //   196: aload_0
    //   197: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   200: getfield 129	alhs:g	I
    //   203: putfield 137	android/view/ViewGroup$LayoutParams:height	I
    //   206: aload_2
    //   207: astore 5
    //   209: aload 7
    //   211: getfield 100	alhw:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    //   214: aload 6
    ...
    //   235: aload_0
    //   236: iload_1
    //   237: invokevirtual 147	alhv:getItem	(I)Ljava/lang/Object;
    //   240: checkcast 149	bgcs
    //   243: astore 8
    //   245: aload 8
    //   247: ifnull +345 -> 592
    //   250: aload_2
    //   251: astore 5
    //   253: aload 6
    //   255: getfield 118	alhw:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   258: aload 8
    //   260: getfield 152	bgcs:b	Ljava/lang/String;
    //   263: invokevirtual 156	android/widget/TextView:setText	(Ljava/lang/CharSequence;)V
    //   266: aload_2
    //   267: astore 5
    //   269: aload 8
    //   271: getfield 157	bgcs:jdField_a_of_type_Int	I
    //   274: istore 4
    //   276: aload_2
    //   277: astore 5
    //   279: aload 6
    //   281: getfield 106	alhw:jdField_a_of_type_ComTencentMobileqqVasAvatarVasAvatar	Lcom/tencent/mobileqq/vas/avatar/VasAvatar;
    ...
    //   324: ldc 170
    //   326: iconst_1
    //   327: invokespecial 173	bghu:<init>	(IILjava/lang/String;Z)V
    //   330: astore 9
    //   332: aload_2
    //   333: astore 5
    //   335: aload 9
    //   337: aload 7
    //   339: putfield 176	bghu:a	Landroid/graphics/drawable/Drawable;
    //   342: aload_2
    //   343: astore 5
    //   345: aload 6
    //   347: getfield 106	alhw:jdField_a_of_type_ComTencentMobileqqVasAvatarVasAvatar	Lcom/tencent/mobileqq/vas/avatar/VasAvatar;
    //   350: aconst_null
    //   351: aload 9
    //   353: invokevirtual 180	com/tencent/mobileqq/vas/avatar/VasAvatar:setLoader	(Lcom/tencent/mobileqq/vas/avatar/AvatarLayout;Lbghu;)V
    //   356: aload_2
    //   357: astore 5
    //   359: aload 6
    //   361: getfield 100	alhw:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    //   364: aload 8
    //   366: invokevirtual 181	android/widget/RelativeLayout:setTag	(Ljava/lang/Object;)V
    //   369: aload_2
    //   370: astore 5
    //   372: aload_0
    //   373: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   376: ldc 183
    //   378: iconst_0
    ...
    //   382: putfield 192	alhs:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    //   385: aload_2
    //   386: astore 5
    //   388: aload_0
    //   389: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   392: aload_0
    //   393: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   396: getfield 192	alhs:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    //   399: ldc 194
    //   401: iconst_0
    //   402: invokeinterface 200 3 0
    //   407: putfield 203	alhs:n	I
    //   410: aload_2
    //   411: astore 5
    //   413: aload_0
    //   414: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   417: getfield 203	alhs:n	I
    //   420: aload 8
    //   422: getfield 157	bgcs:jdField_a_of_type_Int	I
    //   425: if_icmpne +126 -> 551
    //   428: aload_2
    //   429: astore 5
    //   431: aload_2
    //   432: aload_0
    //   433: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   436: getfield 77	alhs:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   451: astore 5
    //   453: aload 8
    //   455: getfield 157	bgcs:jdField_a_of_type_Int	I
    //   458: aload_0
    //   459: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   462: getfield 222	alhs:m	I
    //   465: if_icmpne +100 -> 565
    //   468: aload_2
    //   469: astore 5
    //   471: aload 6
    //   473: getfield 112	alhw:jdField_a_of_type_AndroidWidgetImageView	Landroid/widget/ImageView;
    //   476: iconst_0
    ...
    //   509: dup
    //   510: aload_0
    //   511: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   514: getfield 129	alhs:g	I
    //   517: aload_0
    //   518: getfield 13	alhv:jdField_a_of_type_Alhs	Lalhs;
    //   521: getfield 243	alhs:h	I
    ...
    //   566: astore 5
    //   568: aload 6
    //   570: getfield 112	alhw:jdField_a_of_type_AndroidWidgetImageView	Landroid/widget/ImageView;
    //   573: bipush 8
    ...
    //   243	211	8	localbgcs	bgcs
    //   330	22	9	localbghu	bghu
    // Exception table:
    //   from	to	target	type
