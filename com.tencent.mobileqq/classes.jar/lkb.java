  ...
  implements loi
{
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidHardwareCamera$AutoFocusCallback = new lkc(this);
  }
  ...
  private void a(Camera.Parameters paramParameters, boolean paramBoolean)
  {
    ...
    {
      lbd.f("AndroidCamera", "parameters null, do nothing about focus config");
      return;
    }
    List localList = paramParameters.getSupportedFocusModes();
    if (localList == null)
    {
      lbd.f("AndroidCamera", "getSupportedFocusModes empty");
      return;
    }
    lom locallom = lom.a();
    if ((locallom != null) && (locallom.g())) {}
    for (boolean bool = true;; bool = false)
    {
      lbd.f("AndroidCamera", String.format("enableAutoFocus, isUserSelfFocusDev[%s], enable[%s]", new Object[] { Boolean.valueOf(bool), Boolean.valueOf(paramBoolean) }));
      if (!bool) {
        break;
      }
  ...
  protected void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    while (!QLog.isDevelopLevel()) {
      try
      {
        ...
        {
          nbo.a(BaseApplicationImpl.getContext()).a(localParameters.flatten());
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      if (this.jdField_a_of_type_AndroidHardwareCamera == null) {
        lbd.f("AndroidCamera", "camera null, return");
      }
    }
    else {
      return;
  ...
  public boolean c(long paramLong)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 186	lkb:jdField_a_of_type_Boolean	Z
    //   5: istore_3
    //   6: iload_3
    //   7: ifeq +19 -> 26
    //   10: aload_0
    //   11: getfield 119	lkb:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   14: invokevirtual 133	android/hardware/Camera:getParameters	()Landroid/hardware/Camera$Parameters;
    //   17: astore 4
    //   19: aload_0
    //   20: aload 4
    //   22: iconst_0
    //   23: invokespecial 152	lkb:a	(Landroid/hardware/Camera$Parameters;Z)V
    //   26: aload_0
    //   27: lload_1
    //   28: invokespecial 188	ljk:c	(J)Z
    //   31: istore_3
    //   32: aload_0
    //   33: monitorexit
    //   34: iload_3
