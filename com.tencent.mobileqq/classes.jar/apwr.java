...
public class apwr
{
  ...
  public final ConcurrentHashMap<Integer, HashMap<String, apxy>> a;
  public final CopyOnWriteArrayList<apym> a;
  ...
  public Bitmap a(apym paramapym, apxz paramapxz)
  {
    if ((paramapym == null) || (paramapxz == null)) {
      return null;
    }
    paramapym = "BubbleDiyFetcher_" + paramapxz.jdField_a_of_type_Int + "_" + paramapxz.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramapxz = (Bitmap)BaseApplicationImpl.sImageCache.get(paramapym);
    if (paramapxz != null)
    {
      this.c.remove(paramapym);
      return paramapxz;
    }
    this.c.add(paramapym);
    paramapym = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramapym instanceof QQAppInterface)) {
      a((QQAppInterface)paramapym, 500);
    }
    return null;
  }
  
  public String a(apym paramapym, String paramString)
  {
    Object localObject;
    if ((paramapym == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramapym);
    paramapym = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramapym instanceof QQAppInterface)) {
      a((QQAppInterface)paramapym, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localapym != null) && (localapym.getCallback() != null) && (a(localapym.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localapym.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, anil paramanil)
  {
    ...
    ((apws)paramQQAppInterface.a(70)).a((List)localObject, paramanil);
  }
  ...
  public Bitmap b(apym paramapym, apxz paramapxz)
  {
    if ((paramapym == null) || (paramapxz == null) || (TextUtils.isEmpty(paramapym.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramapym.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramapym.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramapxz.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramapxz.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramapym.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramapxz.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramapxz = "BubbleDiyFetcher_" + paramapxz.jdField_a_of_type_Int + "_" + paramapxz.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramapxz);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramapxz);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramapxz);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramapxz);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramapym.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramapym.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = bggl.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (apxy)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = bggl.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
