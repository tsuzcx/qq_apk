  ...
  implements Manager
{
  ...
  public agzf(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong, agzi paramagzi, String paramString, Map<String, String> paramMap)
  {
    if (a())
    {
    ...
    for (long l2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin();; l2 = 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QWalletConfigManager", 2, "realGetConfig:" + paramLong + "|" + paramagzi + "|" + paramString + "|" + paramMap + "|" + localReqWalletConfig);
      }
      agwv.a(localReqWalletConfig, new agzg(this, paramLong, paramagzi, new WeakReference(this)), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      l1 = 0L;
      break;
    }
  ...
  public static void a(String paramString, agzj paramagzj)
  {
    ...
    {
      ((agzf)localAppRuntime.getManager(245)).c(paramString, paramagzj);
      return;
    }
    ahiq.a(paramString, paramagzj);
  }
  ...
  public static void b(String paramString, agzj paramagzj)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((agzf)localAppRuntime.getManager(245)).d(paramString, paramagzj);
      return;
    }
    ahiq.b(paramString, paramagzj);
  }
  
  public int a(String paramString, int paramInt, String... paramVarArgs)
  {
    return agzc.a(a(paramString), paramInt, paramVarArgs);
  }
  ...
  public agzd a(String paramString)
  {
  ...
  {
    return agzc.a(a(paramString1), paramString2, paramVarArgs);
  }
  
  public JSONArray a(String paramString, String... paramVarArgs)
  {
    return agzc.a(a(paramString), paramVarArgs);
  }
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    do
    {
      ...
      agwv.a(paramMap, 1, new agzh(this));
    } while (!QLog.isColorLevel());
  ...
  public void b(int paramInt)
  {
    ...
    try
    {
      String str = ((ahcy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(273)).a();
  ...
  public void c(String paramString, agzj paramagzj)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.addUpdateListener(paramString, paramagzj);
  }
  
  public void d(String paramString, agzj paramagzj)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.removeUpdateListener(paramString, paramagzj);
  }
