...
public class amjj
{
  ...
  public amjj(int paramInt)
  {
    this(paramInt, 0, "", "");
  }
  
  public amjj(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Amjk != null) {
        this.jdField_a_of_type_Amjk.a(paramInt);
      }
  ...
  public static boolean a(int paramInt)
  {
    try
    {
      ...
      CmGameInitParams localCmGameInitParams = ((alxy)localObject).a();
  ...
  private String c()
  {
    ...
    if (this.c == 0) {
      localStringBuilder.append(amip.s).append(this.jdField_b_of_type_Int);
    }
    do
    {
      for (;;)
      {
        ...
        localStringBuilder.append(amip.s).append(this.jdField_b_of_type_Int).append("/").append(this.jdField_b_of_type_JavaLangString);
      }
    } while ((this.c != 3) && (this.c != 4));
    return bjmw.b();
  }
    ...
    for (;;)
    {
      try
      {
        if (!a(this.jdField_b_of_type_Int, this.c))
        {
          ...
          this.jdField_a_of_type_Amjk.a(0);
          return false;
        }
      ...
      if (((this.c == 0) || (this.c == 1)) && (!new amku(c() + "/checkList.sig", localThrowable.getAbsolutePath()).a(0)))
      {
        a("checkList.sig", 3);
        return false;
      }
  ...
  public void a(amjk paramamjk)
  {
    this.jdField_a_of_type_Amjk = paramamjk;
  }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 33	amjj:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 365	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifeq +41 -> 48
    //   10: aload_0
    //   11: getfield 295	amjj:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   14: ifnull +34 -> 48
    //   17: aload_2
    //   18: invokestatic 360	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   21: ifne +27 -> 48
    //   24: aload_1
    //   25: invokestatic 360	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   28: ifne +20 -> 48
    //   31: aload_0
    //   32: getfield 35	amjj:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   35: ifnull +13 -> 48
    //   38: aload_0
    //   39: getfield 35	amjj:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   42: invokevirtual 365	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   45: ifeq +5 -> 50
    //   48: iconst_0
    //   49: ireturn
    //   50: invokestatic 322	java/lang/System:currentTimeMillis	()J
    //   53: pop2
    //   54: aconst_null
    //   55: astore 4
    //   57: aconst_null
    //   58: astore 5
    //   60: new 250	java/io/File
    //   63: dup
    //   64: aload_1
    ...
    //   72: astore_3
    //   73: aload 7
    //   75: invokevirtual 260	java/io/File:exists	()Z
    //   78: ifne +37 -> 115
    //   81: aload 4
    //   83: astore_3
    //   84: aload_0
    //   85: aload_2
    //   86: iconst_1
    //   87: invokespecial 266	amjj:a	(Ljava/lang/String;I)V
    //   90: iconst_0
    //   91: ifeq -43 -> 48
    //   94: new 368	java/lang/NullPointerException
    //   97: dup
    //   98: invokespecial 369	java/lang/NullPointerException:<init>	()V
    //   101: athrow
    //   102: astore_1
    //   103: ldc 66
    //   105: iconst_1
    //   106: ldc_w 371
    //   109: aload_1
    //   110: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: iconst_0
    //   114: ireturn
    //   115: aload 4
    //   117: astore_3
    //   118: aload_0
    //   119: getfield 295	amjj:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   122: aload_2
    //   123: invokevirtual 354	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   126: astore 6
    //   128: aload 4
    //   130: astore_3
    //   131: new 373	java/io/FileInputStream
    //   134: dup
    //   135: aload_1
    //   136: invokespecial 374	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   139: astore 4
    //   141: aload 4
    //   143: aload 7
    //   145: invokevirtual 376	java/io/File:length	()J
    //   148: invokestatic 382	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   151: invokestatic 388	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   154: astore_3
    //   155: aload_3
    //   156: invokestatic 360	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   159: ifne +57 -> 216
    //   162: aload 6
    //   164: invokestatic 360	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   167: ifne +49 -> 216
    //   170: aload_3
    //   171: invokevirtual 391	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   174: aload 6
    //   176: invokevirtual 391	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   179: invokevirtual 395	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   182: ifne +34 -> 216
    //   185: aload_0
    //   186: aload_2
    //   187: iconst_4
    //   188: invokespecial 266	amjj:a	(Ljava/lang/String;I)V
    //   191: aload 4
    //   193: ifnull -145 -> 48
    //   196: aload 4
    //   198: invokevirtual 398	java/io/FileInputStream:close	()V
    //   201: iconst_0
    //   202: ireturn
    //   203: astore_1
    //   204: ldc 66
    ...
    //   207: ldc_w 371
    //   210: aload_1
    //   211: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   214: iconst_0
    //   215: ireturn
    //   216: aload 4
    //   218: ifnull +8 -> 226
    //   221: aload 4
    //   223: invokevirtual 398	java/io/FileInputStream:close	()V
    //   226: iconst_1
    //   227: ireturn
    //   228: astore_1
    //   229: ldc 66
    ...
    //   290: aload_2
    //   291: aastore
    //   292: invokestatic 407	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   295: aload 4
    //   297: ifnull -71 -> 226
    //   300: aload 4
    //   302: invokevirtual 398	java/io/FileInputStream:close	()V
    //   305: goto -79 -> 226
    //   308: astore_1
    //   309: ldc 66
    //   311: iconst_1
    //   312: ldc_w 371
    //   315: aload_1
    //   316: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   319: goto -93 -> 226
    //   322: astore_1
    //   323: aload_3
    //   324: ifnull +7 -> 331
    //   327: aload_3
    //   328: invokevirtual 398	java/io/FileInputStream:close	()V
    //   331: aload_1
    //   332: athrow
    //   333: astore_2
    //   334: ldc 66
    ...
    //   337: ldc_w 371
    //   340: aload_2
    //   341: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   344: goto -13 -> 331
    //   347: astore_1
    //   348: aload 4
    //   350: astore_3
