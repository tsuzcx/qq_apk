...
{
  private static aztk jdField_a_of_type_Aztk;
  private ConcurrentLinkedQueue<aztm> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  public static aztk a()
  {
    if (jdField_a_of_type_Aztk != null) {
      return jdField_a_of_type_Aztk;
    }
    try
    {
      if (jdField_a_of_type_Aztk == null) {
        jdField_a_of_type_Aztk = new aztk();
      }
      aztk localaztk = jdField_a_of_type_Aztk;
      return localaztk;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext, MonitorHttpInfo paramMonitorHttpInfo, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      azri.a(paramContext).a(null, "MonitorApkDownload", true, 0L, 0L, localHashMap, "");
      label231:
      if (!QLog.isColorLevel()) {
        break label348;
      }
    ...
    for (paramContext = "MonitorApkDownload{";; paramContext = "UnMonitorApkDownload{")
    {
      ...
      azri.a(paramContext).a(null, "UnMonitorApkDownload", true, 0L, 0L, localHashMap, "");
      break label231;
      break;
    }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof aztm))
        {
          localObject = (aztm)localObject;
          int k = 0;
          try
          {
            j = a(str, ((aztm)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((aztm)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    aztm localaztm = new aztm(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localaztm);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (aztm)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localaztm.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new aztl(this));
      return;
    }
    a(paramString);
  }
