...
public class bhvo
{
  protected static bhvo a;
  protected static byte[] a;
  public int a;
  protected List<bhvp> a;
  public int b;
  ...
  {
    List localList = ((bhvp)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
    if (localList != null) {
  ...
  public Friend a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bhvp)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  {
    return ((bhvp)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaLangString;
  }
  ...
  public List<Friend> a()
  {
    ...
    {
      Iterator localIterator2 = ((bhvp)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator2.hasNext()) {
  ...
  {
    return ((bhvp)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(List<bhvp> paramList, int paramInt1, int paramInt2)
  {
    label9:
    String str2;
    ...
    else
    {
      ...
      this.c.clear();
      str2 = bhpc.a().a().getResources().getString(2131690838);
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        paramList = (bhvp)localIterator1.next();
