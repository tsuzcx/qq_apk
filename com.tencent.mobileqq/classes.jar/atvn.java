...
public class atvn
  implements atvm, atvv, ISPlayerDownloader.Listener
{
  private int jdField_a_of_type_Int = -1;
  private atvt jdField_a_of_type_Atvt;
  private atvu jdField_a_of_type_Atvu;
  ...
  public atvn(aufc paramaufc)
  {
    this.jdField_a_of_type_JavaLangString = paramaufc.a();
    this.jdField_a_of_type_Aufc = paramaufc;
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Aufc.b();
  ...
  public String a()
  {
    return this.jdField_a_of_type_Aufc.a();
  }
  ...
  public void a(int paramInt, String paramString)
  {
    if (this.jdField_a_of_type_Atvt != null) {
      this.jdField_a_of_type_Atvt.a(paramInt, paramString);
    }
  }
  ...
  public void a(atvu paramatvu)
  {
    this.jdField_a_of_type_Atvu = paramatvu;
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    } while (this.jdField_a_of_type_Atvt == null);
    this.jdField_a_of_type_Atvt.a(this.jdField_a_of_type_ComTencentSuperplayerApiSuperPlayerVideoInfo);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      b();
      this.jdField_a_of_type_Atvt = null;
    }
  }
  ...
  public boolean a()
  {
    ...
    long l = this.jdField_a_of_type_Aufc.a();
    String str = this.jdField_a_of_type_Aufc.b();
    if (l != aunj.a(str)) {
      bhmi.d(str);
    }
    this.jdField_a_of_type_Aufc.a(this);
    return true;
  }
  ...
  public String b()
  {
    ...
    String str = aunj.b(aumo.a().b() + this.jdField_a_of_type_Aufc.c());
    if (!auog.b(this.jdField_b_of_type_JavaLangString))
    {
      QLog.i("FileVideoDownloaderImpl<FileAssistant>XOXO", 1, "[" + this.jdField_a_of_type_Aufc.a() + "],File rename faild mybe renamed");
      return null;
    }
    if (QLog.isColorLevel()) {
      QLog.i("FileVideoDownloaderImpl<FileAssistant>XOXO", 4, "[" + this.jdField_a_of_type_Aufc.a() + "],File download over rename[" + str + "],src[" + this.jdField_b_of_type_JavaLangString + "]");
    }
    if (!bhmi.b(new File(this.jdField_b_of_type_JavaLangString), new File(str)))
    {
      this.jdField_a_of_type_Aufc.a(false);
      return null;
    }
    if (QLog.isColorLevel()) {
      QLog.i("FileVideoDownloaderImpl<FileAssistant>XOXO", 4, "[" + this.jdField_a_of_type_Aufc.a() + "],File download over. rename success!");
    }
    this.jdField_a_of_type_Aufc.a(str);
    atvk.d(this.jdField_a_of_type_Aufc.a());
    atvk.b();
    return str;
  }
  ...
  public void onDownloadError(int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    this.jdField_a_of_type_Aufc.a(false);
    if (this.jdField_a_of_type_Atvu == null) {
      return;
    }
    this.jdField_a_of_type_Atvu.a(paramInt2, paramInt3, paramString);
  }
  ...
  public void onDownloadProgressUpdate(int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2, String paramString)
  {
    if (this.jdField_b_of_type_Boolean) {
      if (QLog.isColorLevel()) {
        QLog.i("FileVideoDownloaderImpl<FileAssistant>XOXO", 1, String.format("%s is downloaded!", new Object[] { this.jdField_a_of_type_Aufc.a() }));
      }
    }
    do
    {
      return;
      this.jdField_a_of_type_Aufc.a(paramLong1);
    } while (this.jdField_a_of_type_Atvu == null);
    ...
    this.jdField_a_of_type_Atvu.a(paramInt2, paramInt3, paramLong1, paramLong2);
  }
