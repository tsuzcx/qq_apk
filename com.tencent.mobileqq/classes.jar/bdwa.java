...
public class bdwa
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = bduf.a(paramQQAppInterface, paramChatMessage.senderuin);
    }
  ...
  public static void a(axaw paramaxaw, msg_comm.Msg paramMsg, MessageRecord paramMessageRecord)
  {
    if ((paramaxaw != null) && (paramaxaw.a == 1024) && (paramMsg.msg_body.rich_text.has()) && (paramMsg.msg_body.rich_text.elems.has()))
    {
      paramaxaw = paramMsg.msg_body.rich_text.elems.get().iterator();
      while (paramaxaw.hasNext())
      {
        paramMsg = (im_msg_body.Elem)paramaxaw.next();
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong)
  {
    ...
    {
      i = paramString4.indexOf(paramQQAppInterface.getApp().getString(2131698247));
      if (i != -1) {}
    }
    else
    {
    ...
    paramString4 = new aqvb(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString4, paramInt, -5023, 1245186, awzy.a());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Crm.CrmCCNotify paramCrmCCNotify, msg_comm.Msg paramMsg, axaw paramaxaw)
  {
    long l = paramMsg.msg_head.from_uin.get();
    if (paramaxaw == null) {}
    for (int i = 0;; i = paramaxaw.a)
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        axqy.b(paramQQAppInterface, "dc00899", "Qidian", paramString1, str2, "1", 1, 0, str1, "0", String.valueOf(paramInt3), paramString2);
        return;
        if (paramInt2 == -2000)
        {
          str1 = "2";
  ...
  {
    long l = awzy.a();
    paramString1 = new aqvb(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString2, paramInt, -5020, 1245187, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList, msg_comm.Msg paramMsg, axaw paramaxaw, Crm.CrmCCNotify paramCrmCCNotify)
  {
    int i = 0;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList, im_msg_body.NotOnlineFile paramNotOnlineFile, msg_comm.Msg paramMsg, axaw paramaxaw)
  {
    ...
    try
    {
      ...
      a(paramQQAppInterface, (Crm.CrmCCNotify)localObject, paramMsg, paramaxaw);
      return;
    }
