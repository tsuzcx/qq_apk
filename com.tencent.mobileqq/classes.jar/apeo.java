  ...
  implements Handler.Callback
{
  ...
  public apeo(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Alox = new apep(this);
  ...
  public String a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      apds.a("StrangerHdHeadUrlFetcher", new Object[] { "uinOrMobileNum is null or empty" });
      return "";
    }
    ...
    {
      ??? = (Setting)this.jdField_a_of_type_Awbw.a(Setting.class, str2);
