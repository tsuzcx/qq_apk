...
public class alxk
{
  ...
  private awcx jdField_a_of_type_Awcx = new awcx();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aljq.aX + "WalFlag";
  }
  
  public alxk(SQLiteOpenHelper paramSQLiteOpenHelper)
  {
  ...
  public com.tencent.mobileqq.app.SQLiteDatabase a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((jdField_a_of_type_Boolean) && (bhou.e()) && (localSQLiteDatabase != null))
        {
      ...
      try
      {
        ...
        else
        {
          if ((this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) || (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a != localSQLiteDatabase))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = new com.tencent.mobileqq.app.SQLiteDatabase(localSQLiteDatabase, this.jdField_a_of_type_Awcx, this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteOpenHelper.getDatabaseName());
            if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
              break label570;
            }
            localObject1 = Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.hashCode());
      ...
      catch (IllegalStateException localIllegalStateException)
      {
        ...
        azmz.a(BaseApplicationImpl.getApplication()).a(null, "actWALException", true, 0L, 0L, (HashMap)localObject2, null);
        continue;
      }
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 172	alxk:jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase	Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   6: ifnull +94 -> 100
    //   9: aload_0
    //   10: getfield 172	alxk:jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase	Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   13: invokevirtual 98	java/lang/Object:hashCode	()I
    //   16: invokestatic 104	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   19: astore_1
    //   20: aload_0
    //   21: getfield 111	alxk:jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase	Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   24: ifnull +82 -> 106
    //   27: aload_0
    //   28: getfield 111	alxk:jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase	Lcom/tencent/mobileqq/app/SQLiteDatabase;
    ...
    //   70: iconst_5
    //   71: aload_0
    //   72: getfield 68	alxk:jdField_a_of_type_AndroidDatabaseSqliteSQLiteOpenHelper	Landroid/database/sqlite/SQLiteOpenHelper;
    //   75: aastore
    //   76: dup
    //   77: bipush 6
    //   79: ldc 49
    ...
    //   90: aload_0
    //   91: getfield 68	alxk:jdField_a_of_type_AndroidDatabaseSqliteSQLiteOpenHelper	Landroid/database/sqlite/SQLiteOpenHelper;
      ...
      try
      {
        ...
        else
        {
          if ((this.jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase == null) || (this.jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase.a != localSQLiteDatabase))
          {
            ...
            this.jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase = new com.tencent.mobileqq.app.SQLiteDatabase(localSQLiteDatabase, this.jdField_a_of_type_Awcx, this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteOpenHelper.getDatabaseName());
            if (this.jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
              break label556;
            }
            localObject1 = Integer.valueOf(this.jdField_b_of_type_ComTencentMobileqqAppSQLiteDatabase.hashCode());
