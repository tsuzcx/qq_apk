...
public final class baoc
{
  ...
  private static final String jdField_b_of_type_JavaLangString = aljq.cr + "fmtSrvAddr.ini";
  private static final String c = aljq.cr + "srvAddr.ini";
  private static final String d = aljq.cr + "ipDownAddr.ini";
  private static final String e = aljq.cr + "ipDownAddr.tmp";
  ...
  private baod jdField_a_of_type_Baod = new baod();
  private baoe jdField_a_of_type_Baoe = new baoe(this);
  private batq jdField_a_of_type_Batq = new batq();
  ...
  private byte[] a(baod parambaod)
  {
    ...
    if (parambaod != null)
    {
      ...
      if ((parambaod.jdField_a_of_type_JavaUtilArrayList == null) || (parambaod.jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
        break label842;
      }
      localObject1 = new byte[parambaod.jdField_a_of_type_JavaUtilArrayList.size()][];
      localObject2 = localObject3;
      if (parambaod.jdField_b_of_type_JavaUtilArrayList != null)
      {
        localObject2 = localObject3;
        if (parambaod.jdField_b_of_type_JavaUtilArrayList.size() > 0) {
          localObject2 = new byte[parambaod.jdField_b_of_type_JavaUtilArrayList.size()][];
        }
      }
    ...
    for (;;)
    {
      try
      {
        if (parambaod.jdField_a_of_type_JavaLangString == null) {
          break label836;
        }
        localDataOutputStream.writeUTF(parambaod.jdField_a_of_type_JavaLangString);
        localObject3 = localByteArrayOutputStream.toByteArray();
        localByteArrayOutputStream.reset();
        k = 0 + (localObject3.length + 3);
        j = 1;
        if (parambaod.jdField_b_of_type_JavaLangString == null) {
          break label830;
        }
        localDataOutputStream.writeUTF(parambaod.jdField_b_of_type_JavaLangString);
        ...
        m = k;
        Object localObject4;
        if (parambaod.jdField_a_of_type_JavaUtilArrayList != null)
        {
          i = j;
          m = k;
          if (parambaod.jdField_a_of_type_JavaUtilArrayList.size() > 0)
          {
            m = 0;
            i = k;
            k = m;
            if (k >= parambaod.jdField_a_of_type_JavaUtilArrayList.size()) {
              break label845;
            }
            localObject4 = (FileStorageServerListInfo)parambaod.jdField_a_of_type_JavaUtilArrayList.get(k);
        ...
        if ((parambaod.jdField_b_of_type_JavaUtilArrayList != null) && (parambaod.jdField_b_of_type_JavaUtilArrayList.size() > 0))
        {
          k = 0;
          j = m;
          if (k >= parambaod.jdField_b_of_type_JavaUtilArrayList.size()) {
            break label853;
          }
          localObject4 = (FileStorageServerListInfo)parambaod.jdField_b_of_type_JavaUtilArrayList.get(k);
          localDataOutputStream.writeInt(((FileStorageServerListInfo)localObject4).iPort);
          localDataOutputStream.writeUTF(((FileStorageServerListInfo)localObject4).sIP);
          ...
          {
            parambaod[2] = 1;
            localObject4 = bdlr.a((short)localObject3.length);
            System.arraycopy(localObject4, 0, parambaod, 3, localObject4.length);
            i = localObject4.length + 3;
            System.arraycopy(localObject3, 0, parambaod, i, localObject3.length);
          ...
          if (arrayOfByte != null)
          {
            parambaod[j] = 2;
            i = j + 1;
            localObject3 = bdlr.a((short)arrayOfByte.length);
            System.arraycopy(localObject3, 0, parambaod, i, localObject3.length);
            i += localObject3.length;
            System.arraycopy(arrayOfByte, 0, parambaod, i, arrayOfByte.length);
          ...
          if (localObject1 != null)
          {
            ...
            if (localObject1.length > 0)
            {
              ...
              if (k < localObject1.length)
              {
                parambaod[i] = 3;
                i += 1;
                localObject3 = bdlr.a((short)localObject1[k].length);
                System.arraycopy(localObject3, 0, parambaod, i, localObject3.length);
                i += localObject3.length;
                System.arraycopy(localObject1[k], 0, parambaod, i, localObject1[k].length);
          ...
          if ((localObject2 != null) && (localObject2.length > 0))
          {
            ...
            if (i < localObject2.length)
            {
              parambaod[j] = 4;
              j += 1;
              localObject1 = bdlr.a((short)localObject2[i].length);
              System.arraycopy(localObject1, 0, parambaod, j, localObject1.length);
              j += localObject1.length;
              System.arraycopy(localObject2[i], 0, parambaod, j, localObject2[i].length);
      ...
      catch (Throwable parambaod)
      {
        parambaod = parambaod;
        parambaod.printStackTrace();
        return null;
      }
      finally
      {
  ...
  {
    // Byte code:
    //   0: getstatic 53	baoc:c	Ljava/lang/String;
    //   3: invokestatic 301	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   6: astore_2
    //   7: aload_2
    ...
    //   12: lcmp
    //   13: ifne +35 -> 48
    //   16: invokestatic 313	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   19: ifeq +13 -> 32
    //   22: ldc_w 315
    //   25: iconst_2
    //   26: ldc_w 317
    //   29: invokestatic 320	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   32: iconst_0
    //   33: ifeq +11 -> 44
    //   36: new 322	java/lang/NullPointerException
    //   39: dup
    //   40: invokespecial 323	java/lang/NullPointerException:<init>	()V
    //   43: athrow
    //   44: aconst_null
    //   45: astore_3
    //   46: aload_3
    //   47: areturn
    //   48: new 325	java/io/FileInputStream
    //   51: dup
    //   52: aload_2
    //   53: invokespecial 328	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   56: astore 4
    //   58: aload 4
    //   60: astore_3
    //   61: sipush 1024
    ...
    //   68: aload 4
    //   70: astore_3
    //   71: new 243	java/io/ByteArrayOutputStream
    //   74: dup
    //   75: invokespecial 244	java/io/ByteArrayOutputStream:<init>	()V
    //   78: astore_2
    //   79: aload 4
    //   81: astore_3
    //   82: aload 4
    //   84: aload 5
    //   86: invokevirtual 332	java/io/FileInputStream:read	([B)I
    //   89: istore_1
    //   90: iload_1
    //   91: iconst_m1
    //   92: if_icmpeq +61 -> 153
    ...
    //   101: iconst_0
    //   102: iload_1
    //   103: invokevirtual 336	java/io/ByteArrayOutputStream:write	([BII)V
    //   106: goto -27 -> 79
    //   109: astore 5
    //   111: aconst_null
    //   112: astore_2
    //   113: aload 4
    //   115: astore_3
    //   116: invokestatic 313	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   119: ifeq +17 -> 136
    //   122: aload 4
    //   124: astore_3
    //   125: ldc_w 315
    ...
    //   129: ldc 81
    //   131: aload 5
    //   133: invokestatic 339	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   136: aload_2
    //   137: astore_3
    //   138: aload 4
    //   140: ifnull -94 -> 46
    //   143: aload 4
    //   145: invokevirtual 340	java/io/FileInputStream:close	()V
    //   148: aload_2
    //   149: areturn
    //   150: astore_3
    //   151: aload_2
    ...
    //   153: aload 4
    //   155: astore_3
    //   156: new 342	com/qq/taf/jce/JceInputStream
    //   159: dup
    //   160: aload_2
    //   161: invokevirtual 255	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   164: invokespecial 345	com/qq/taf/jce/JceInputStream:<init>	([B)V
    //   167: astore 5
    //   169: aload 4
    //   171: astore_3
    //   172: new 347	ConfigPush/FileStoragePushFSSvcList
    //   175: dup
    //   176: invokespecial 348	ConfigPush/FileStoragePushFSSvcList:<init>	()V
    //   179: astore_2
    //   180: aload 4
    //   182: astore_3
    //   183: aload_2
    //   184: aload 5
    //   186: invokevirtual 352	ConfigPush/FileStoragePushFSSvcList:readFrom	(Lcom/qq/taf/jce/JceInputStream;)V
    //   189: aload_2
    //   190: astore_3
    //   191: aload 4
    //   193: ifnull -147 -> 46
    //   196: aload 4
    //   198: invokevirtual 340	java/io/FileInputStream:close	()V
    //   201: aload_2
    //   202: areturn
    //   203: astore_3
    //   204: aload_2
    ...
    //   210: ifnull +7 -> 217
    //   213: aload_3
    //   214: invokevirtual 340	java/io/FileInputStream:close	()V
    //   217: aload_2
    //   218: athrow
    //   219: astore_2
    //   220: goto -176 -> 44
  ...
  private ArrayList<FileStorageServerListInfo> b(int paramInt)
  {
    if (this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList != null)
    {
      ...
      return this.jdField_a_of_type_Baod.a(this.jdField_a_of_type_Awtj.b());
    }
  ...
  private void c(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    //   5: aload_3
    //   6: astore_2
    //   7: getstatic 49	baoc:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   10: invokestatic 301	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   13: astore 5
    //   15: aload_1
    //   16: ifnonnull +79 -> 95
    //   19: aload_3
    //   20: astore_2
    //   21: invokestatic 313	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   24: ifeq +15 -> 39
    //   27: aload_3
    //   28: astore_2
    //   29: ldc_w 315
    ...
    //   45: astore_2
    //   46: aload 5
    //   48: invokevirtual 436	java/io/File:exists	()Z
    //   51: ifeq +31 -> 82
    //   54: aload_3
    //   55: astore_2
    //   56: invokestatic 313	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   59: ifeq +15 -> 74
    //   62: aload_3
    //   63: astore_2
    //   64: ldc_w 315
    //   67: iconst_2
    //   68: ldc_w 438
    //   71: invokestatic 320	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   74: aload_3
    //   75: astore_2
    //   76: aload 5
    //   78: invokevirtual 441	java/io/File:delete	()Z
    //   81: pop
    //   82: iconst_0
    //   83: ifeq +11 -> 94
    //   86: new 322	java/lang/NullPointerException
    //   89: dup
    //   90: invokespecial 323	java/lang/NullPointerException:<init>	()V
    //   93: athrow
    //   94: return
    //   95: aload_3
    //   96: astore_2
    //   97: new 443	com/qq/taf/jce/JceOutputStream
    //   100: dup
    //   101: invokespecial 444	com/qq/taf/jce/JceOutputStream:<init>	()V
    //   104: astore 6
    //   106: aload_3
    //   107: astore_2
    //   108: aload_1
    //   109: aload 6
    //   111: invokevirtual 448	ConfigPush/FileStoragePushFSSvcList:writeTo	(Lcom/qq/taf/jce/JceOutputStream;)V
    //   114: aload_3
    //   115: astore_2
    //   116: aload 6
    //   118: invokevirtual 449	com/qq/taf/jce/JceOutputStream:toByteArray	()[B
    //   121: astore 6
    //   123: aload_3
    //   124: astore_2
    //   125: new 451	java/io/FileOutputStream
    //   128: dup
    //   129: aload 5
    //   131: iconst_0
    //   132: invokespecial 454	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   135: astore_3
    //   136: aload_3
    //   137: aload 6
    //   139: invokevirtual 456	java/io/FileOutputStream:write	([B)V
    //   142: new 303	java/io/File
    //   145: dup
    //   146: getstatic 53	baoc:c	Ljava/lang/String;
    //   149: invokespecial 458	java/io/File:<init>	(Ljava/lang/String;)V
    //   152: astore_2
    //   153: aload_2
    //   154: invokevirtual 436	java/io/File:exists	()Z
    //   157: ifeq +8 -> 165
    //   160: aload_2
    //   161: invokevirtual 441	java/io/File:delete	()Z
    //   164: pop
    //   165: aload 5
    //   167: aload_2
    //   168: invokevirtual 462	java/io/File:renameTo	(Ljava/io/File;)Z
    //   171: pop
    //   172: aload_3
    //   173: ifnull +7 -> 180
    //   176: aload_3
    //   177: invokevirtual 463	java/io/FileOutputStream:close	()V
    //   180: aload_1
    //   181: ifnull -87 -> 94
    //   184: invokestatic 313	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   187: ifeq -93 -> 94
    //   190: ldc_w 315
    //   193: iconst_2
    //   194: ldc_w 465
    //   197: invokestatic 320	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   200: return
    //   201: astore_2
    //   202: aload 4
    //   204: astore_3
    ...
    //   208: aload_3
    //   209: astore_2
    //   210: invokestatic 313	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   213: ifeq +17 -> 230
    //   216: aload_3
    //   217: astore_2
    //   218: ldc_w 315
    ...
    //   222: ldc_w 467
    //   225: aload 4
    //   227: invokestatic 339	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   230: aload_3
    //   231: ifnull -51 -> 180
    //   234: aload_3
    //   235: invokevirtual 463	java/io/FileOutputStream:close	()V
    //   238: goto -58 -> 180
    //   241: astore_2
    //   242: goto -62 -> 180
    //   245: astore_1
    ...
    //   247: ifnull +7 -> 254
    //   250: aload_2
    //   251: invokevirtual 463	java/io/FileOutputStream:close	()V
    //   254: aload_1
    //   255: athrow
    //   256: astore_1
    //   257: return
        ...
        if ((this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList != null) && (this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.domainIpChannel != null) && (this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.domainIpChannel.vDomain_iplists != null))
        {
          ...
          if (i < this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.domainIpChannel.vDomain_iplists.size())
          {
            ...
            if (i < ((ArrayList)localObject2).size())
            {
              ...
              ((FileStorageServerListInfo)localObject3).sIP = bdee.a(((DomainIpInfo)((ArrayList)localObject2).get(i)).uIp);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Baoe.a(this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Baod = a(this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.pttlist);
  }
  ...
  public awtj a()
  {
    return this.jdField_a_of_type_Awtj;
  }
  
  /* Error */
  public baod a(byte[] paramArrayOfByte)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   21: aload_0
    //   22: aload_1
    //   23: invokevirtual 569	baoc:a	([B)Z
    //   26: ifne +15 -> 41
    //   29: new 76	baod
    //   32: dup
    //   33: invokespecial 77	baod:<init>	()V
    //   36: astore 9
    //   38: aload 9
    //   40: areturn
    //   41: aload 10
    ...
    //   106: new 76	baod
    //   109: dup
    //   110: invokespecial 77	baod:<init>	()V
    //   113: astore 15
    //   115: aload_1
    //   116: iconst_1
    //   117: baload
    ...
    //   154: iconst_0
    //   155: iconst_2
    //   156: invokestatic 283	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   159: iload_3
    //   160: iconst_2
    //   161: iadd
    //   162: istore_3
    //   163: aload 9
    //   165: iconst_0
    //   166: invokestatic 574	bdal:a	([BI)S
    //   169: istore 6
    //   171: aload_1
    //   172: iload_3
    //   173: iload 6
    ...
    //   177: iconst_0
    //   178: iload 6
    //   180: invokestatic 283	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   183: iload 5
    //   185: iconst_1
    //   186: if_icmpne +117 -> 303
    //   189: new 576	java/io/ByteArrayInputStream
    //   192: dup
    //   193: aload_1
    //   194: iload_3
    //   195: iload 6
    //   197: invokespecial 578	java/io/ByteArrayInputStream:<init>	([BII)V
    //   200: astore 9
    //   202: new 580	java/io/DataInputStream
    //   205: dup
    //   206: aload 9
    //   208: invokespecial 583	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   211: astore 10
    //   213: aload 15
    //   215: aload 10
    //   217: invokevirtual 586	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   220: putfield 250	baod:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   223: aload 9
    //   225: astore 8
    //   227: aload 10
    //   229: astore 9
    ...
    //   250: astore 11
    //   252: aload 8
    //   254: invokevirtual 587	java/io/ByteArrayInputStream:close	()V
    //   257: aload 9
    //   259: ifnull +24 -> 283
    //   262: aload 9
    //   264: astore 13
    ...
    //   276: astore 11
    //   278: aload 9
    //   280: invokevirtual 588	java/io/DataInputStream:close	()V
    //   283: iload_2
    //   284: iconst_1
    //   285: iadd
    //   286: istore_2
    ...
    //   309: new 576	java/io/ByteArrayInputStream
    //   312: dup
    //   313: aload_1
    //   314: iload_3
    //   315: iload 6
    //   317: invokespecial 578	java/io/ByteArrayInputStream:<init>	([BII)V
    //   320: astore 9
    //   322: new 580	java/io/DataInputStream
    //   325: dup
    //   326: aload 9
    //   328: invokespecial 583	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   331: astore 10
    //   333: aload 15
    //   335: aload 10
    //   337: invokevirtual 586	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   340: putfield 259	baod:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   343: new 576	java/io/ByteArrayInputStream
    //   346: dup
    //   347: aload_1
    //   348: iload_3
    //   349: iload 6
    //   351: invokespecial 578	java/io/ByteArrayInputStream:<init>	([BII)V
    //   354: astore 12
    //   356: new 580	java/io/DataInputStream
    //   359: dup
    //   360: aload 12
    //   362: invokespecial 583	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   365: astore 9
    //   367: aload 9
    //   369: astore 13
    //   371: aload 12
    ...
    //   381: astore 11
    //   383: aload 15
    //   385: getfield 591	baod:jdField_b_of_type_ArrayOfInt	[I
    //   388: iconst_0
    //   389: aload 9
    //   391: invokevirtual 594	java/io/DataInputStream:readInt	()I
    //   394: iastore
    //   395: aload 9
    //   397: astore 13
    //   399: aload 12
    ...
    //   409: astore 11
    //   411: aload 15
    //   413: getfield 591	baod:jdField_b_of_type_ArrayOfInt	[I
    //   416: iconst_1
    //   417: aload 9
    //   419: invokevirtual 594	java/io/DataInputStream:readInt	()I
    //   422: iastore
    //   423: aload 12
    //   425: astore 8
    //   427: goto -196 -> 231
    ...
    //   444: astore 11
    //   446: aload 9
    //   448: invokevirtual 290	java/lang/Throwable:printStackTrace	()V
    //   451: aload_1
    //   452: astore 10
    //   454: aload 8
    //   456: astore 11
    //   458: new 76	baod
    //   461: dup
    //   462: invokespecial 77	baod:<init>	()V
    //   465: astore 12
    //   467: aload 8
    //   469: ifnull +8 -> 477
    //   472: aload 8
    //   474: invokevirtual 587	java/io/ByteArrayInputStream:close	()V
    //   477: aload 12
    //   479: astore 9
    //   481: aload_1
    //   482: ifnull -444 -> 38
    //   485: aload_1
    //   486: invokevirtual 588	java/io/DataInputStream:close	()V
    //   489: aload 12
    //   491: areturn
    //   492: astore_1
    //   493: aload 12
    ...
    //   508: new 576	java/io/ByteArrayInputStream
    //   511: dup
    //   512: aload_1
    //   513: iload_3
    //   514: iload 6
    //   516: invokespecial 578	java/io/ByteArrayInputStream:<init>	([BII)V
    //   519: astore 9
    //   521: new 580	java/io/DataInputStream
    //   524: dup
    //   525: aload 9
    //   527: invokespecial 583	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   530: astore 10
    //   532: aload 10
    //   534: invokevirtual 594	java/io/DataInputStream:readInt	()I
    //   537: istore 7
    //   539: aload 10
    //   541: invokevirtual 586	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   544: astore 8
    //   546: iload 5
    //   548: iconst_3
    //   549: if_icmpne +34 -> 583
    //   552: aload 15
    //   554: getfield 237	baod:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   557: new 262	ConfigPush/FileStorageServerListInfo
    //   560: dup
    //   561: aload 8
    //   563: iload 7
    //   565: invokespecial 597	ConfigPush/FileStorageServerListInfo:<init>	(Ljava/lang/String;I)V
    //   568: invokevirtual 191	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   571: pop
    //   572: aload 9
    //   574: astore 8
    //   576: aload 10
    ...
    //   580: goto -349 -> 231
    //   583: aload 15
    //   585: getfield 241	baod:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   588: new 262	ConfigPush/FileStorageServerListInfo
    //   591: dup
    //   592: aload 8
    //   594: iload 7
    //   596: invokespecial 597	ConfigPush/FileStorageServerListInfo:<init>	(Ljava/lang/String;I)V
    //   599: invokevirtual 191	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   602: pop
    //   603: aload 9
    //   605: astore 8
    //   607: aload 10
    ...
    //   628: ifnull +8 -> 636
    //   631: aload 9
    //   633: invokevirtual 587	java/io/ByteArrayInputStream:close	()V
    //   636: aload 8
    //   638: astore 9
    //   640: aload 12
    //   642: ifnull -604 -> 38
    //   645: aload 12
    //   647: invokevirtual 588	java/io/DataInputStream:close	()V
    //   650: aload 8
    //   652: areturn
    //   653: astore_1
    //   654: aload 8
    ...
    //   668: ifnull +8 -> 676
    //   671: aload 9
    //   673: invokevirtual 587	java/io/ByteArrayInputStream:close	()V
    //   676: aload 8
    //   678: ifnull +8 -> 686
    //   681: aload 8
    //   683: invokevirtual 588	java/io/DataInputStream:close	()V
    //   686: aload_1
    //   687: athrow
    //   688: astore 8
    //   690: goto -4 -> 686
  ...
  public batq a()
  {
    return this.jdField_a_of_type_Batq;
  }
  ...
  public String a()
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Baoe.a();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Baod.a(this.jdField_a_of_type_Awtj.b(), paramString);
        if (QLog.isDevelopLevel()) {
      ...
      this.jdField_a_of_type_Baoe.a(paramInt, paramString);
    }
  }
  ...
  public byte[] a(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 97	baoc:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   6: ifnull +43 -> 49
    //   9: aload_0
    //   10: getfield 97	baoc:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   13: getfield 402	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   16: ifnull +33 -> 49
    //   19: aload_0
    //   20: getfield 97	baoc:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   23: getfield 402	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   26: getfield 874	ConfigPush/BigDataChannel:uSig_Uin	J
    //   29: lload_1
    //   30: lcmp
    //   31: ifne +18 -> 49
    //   34: aload_0
    //   35: getfield 97	baoc:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   38: getfield 402	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   41: getfield 877	ConfigPush/BigDataChannel:sBigdata_sig_session	[B
    //   44: astore_3
    //   45: aload_0
    //   46: monitorexit
    //   47: aload_3
  ...
  public byte[] a(byte[] paramArrayOfByte)
  {
    ...
    String str = this.jdField_a_of_type_Awtj.b();
    boolean bool = this.jdField_a_of_type_Awtj.a();
    if (this.jdField_a_of_type_Baod != null)
    {
      if (!bool) {
        break label58;
      }
      this.jdField_a_of_type_Baod.jdField_a_of_type_JavaUtilArrayList = paramArrayOfByte;
      this.jdField_a_of_type_Baod.jdField_a_of_type_JavaLangString = str;
    }
    for (;;)
    {
      return a(this.jdField_a_of_type_Baod);
      label58:
      this.jdField_a_of_type_Baod.jdField_b_of_type_JavaUtilArrayList = paramArrayOfByte;
      this.jdField_a_of_type_Baod.jdField_b_of_type_JavaLangString = str;
    }
  }
  ...
  public String b(int paramInt)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Baoe.a(paramInt);
      if (localFileStorageServerListInfo != null)
      {
        localObject1 = new StringBuffer(200);
        ((StringBuffer)localObject1).append("http://").append(localFileStorageServerListInfo.sIP);
  ...
  public byte[] b(long paramLong)
  {
    ...
    //   35: getfield 97	baoc:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   38: getfield 402	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   41: getfield 899	ConfigPush/BigDataChannel:sBigdata_key_session	[B
    //   44: astore_3
    //   45: aload_0
    //   46: monitorexit
    //   47: aload_3
