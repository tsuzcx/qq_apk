...
public class lyn
{
  ...
  public lyn(Context paramContext, View paramView)
  {
  ...
  public boolean a()
  {
    ...
    //   5: istore_1
    //   6: aload_0
    //   7: getfield 104	lyn:jdField_a_of_type_Boolean	Z
    //   10: ifne +57 -> 67
    //   13: aload_0
    //   14: iconst_1
    //   15: putfield 104	lyn:jdField_a_of_type_Boolean	Z
    //   18: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   21: ifeq +11 -> 32
    //   24: ldc 112
    //   26: iconst_2
    //   27: ldc 148
    //   29: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   32: aload_0
    //   33: getfield 34	lyn:jdField_a_of_type_AndroidViewWindowManager	Landroid/view/WindowManager;
    //   36: aload_0
    //   37: getfield 61	lyn:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   40: aload_0
    //   41: getfield 20	lyn:jdField_a_of_type_AndroidViewWindowManager$LayoutParams	Landroid/view/WindowManager$LayoutParams;
    //   44: invokeinterface 152 3 0
    //   49: iload_2
    //   50: istore_1
    //   51: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   54: ifeq +13 -> 67
    //   57: ldc 112
    //   59: iconst_2
    //   60: ldc 154
    //   62: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   65: iload_2
    //   66: istore_1
    //   67: aload_0
    //   68: getfield 61	lyn:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   71: invokevirtual 160	android/view/View:getLayoutParams	()Landroid/view/ViewGroup$LayoutParams;
    //   74: checkcast 17	android/view/WindowManager$LayoutParams
    //   77: ifnull +255 -> 332
    //   80: iload_1
    //   81: ifeq +251 -> 332
    //   84: aload_0
    //   85: getfield 22	lyn:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   88: invokestatic 166	lyo:b	(Landroid/content/Context;)Z
    //   91: istore_1
    //   92: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   95: ifeq +56 -> 151
    //   98: ldc 112
    //   100: iconst_2
    //   101: new 126	java/lang/StringBuilder
    //   104: dup
    //   105: invokespecial 127	java/lang/StringBuilder:<init>	()V
    //   108: ldc 168
    //   110: invokevirtual 133	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   113: aload_0
    //   114: getfield 104	lyn:jdField_a_of_type_Boolean	Z
    ...
    //   123: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   126: ldc 112
    //   128: iconst_2
    ...
    //   148: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   151: aload_0
    //   152: monitorexit
    //   153: iload_1
    //   154: ireturn
    //   155: astore_3
    //   156: aload_0
    //   157: getfield 34	lyn:jdField_a_of_type_AndroidViewWindowManager	Landroid/view/WindowManager;
    //   160: aload_0
    //   161: getfield 61	lyn:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   164: aload_0
    //   165: getfield 20	lyn:jdField_a_of_type_AndroidViewWindowManager$LayoutParams	Landroid/view/WindowManager$LayoutParams;
    //   168: invokeinterface 176 3 0
    //   173: iload_2
    //   174: istore_1
    //   175: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   178: ifeq -111 -> 67
    //   181: ldc 112
    //   183: iconst_2
    ...
    //   196: aload_3
    //   197: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   200: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   203: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   206: iload_2
    //   207: istore_1
    //   208: goto -141 -> 67
    //   211: astore_3
    ...
    //   217: aload_0
    //   218: iconst_0
    //   219: putfield 104	lyn:jdField_a_of_type_Boolean	Z
    //   222: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   225: ifeq +110 -> 335
    //   228: ldc 112
    //   230: iconst_2
    //   231: new 126	java/lang/StringBuilder
    //   234: dup
    //   235: invokespecial 127	java/lang/StringBuilder:<init>	()V
    //   238: ldc 178
    //   240: invokevirtual 133	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   243: aload_3
    //   244: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   247: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   250: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   253: goto +82 -> 335
    //   256: astore_3
    //   257: aload_0
    //   258: iconst_0
    //   259: putfield 104	lyn:jdField_a_of_type_Boolean	Z
    //   262: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   265: ifeq +75 -> 340
    //   268: ldc 112
    //   270: iconst_2
    //   271: new 126	java/lang/StringBuilder
    //   274: dup
    //   275: invokespecial 127	java/lang/StringBuilder:<init>	()V
    //   278: ldc 178
    //   280: invokevirtual 133	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   283: aload_3
    //   284: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   287: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   290: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   293: goto +47 -> 340
    //   296: astore_3
    //   297: aload_0
    //   298: iconst_0
    //   299: putfield 104	lyn:jdField_a_of_type_Boolean	Z
    //   302: ldc 112
    //   304: iconst_2
    //   305: new 126	java/lang/StringBuilder
    //   308: dup
    //   309: invokespecial 127	java/lang/StringBuilder:<init>	()V
    //   312: ldc 178
    //   314: invokevirtual 133	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   317: aload_3
    //   318: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   321: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   324: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   327: iconst_0
    //   328: istore_1
    //   329: goto -262 -> 67
    //   332: goto -240 -> 92
