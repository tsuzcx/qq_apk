...
public class blrz
  extends bllx
  implements Handler.Callback, blry
{
  static File jdField_a_of_type_JavaIoFile;
  public static final String[] a;
  public Handler a;
  public blrx a;
  blsa jdField_a_of_type_Blsa;
  ArrayList<blsb> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  LinkedList<blrx> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  public boolean a;
  ArrayList<blsb> b;
  public boolean b;
  ...
  private blrx a(int paramInt1, String paramString, int paramInt2)
  {
    blrx localblrx = new blrx();
    localblrx.jdField_a_of_type_Int = paramInt1;
    localblrx.jdField_a_of_type_JavaLangString = paramString;
    localblrx.b = paramInt2;
    localblrx.a(this);
    return localblrx;
  }
  ...
  private void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        blsa localblsa = blsa.a(paramString);
        ...
        bdcs.a(localFile.getAbsolutePath(), paramString);
        a(localblsa);
        d();
        return;
      }
  ...
  private void e()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("QIMPredownManager", 2, String.format("startPredown level:%d  queue:%d  left:%d", new Object[] { Integer.valueOf(this.jdField_a_of_type_Blsa.jdField_a_of_type_Int), Integer.valueOf(this.jdField_a_of_type_JavaUtilLinkedList.size()), Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
    }
    ...
    blsb localblsb = (blsb)localArrayList.get(j);
    blrx localblrx;
    if (this.jdField_a_of_type_Blsa.jdField_a_of_type_Int >= localblsb.b)
    {
      localblrx = a(localblsb.jdField_a_of_type_Int, localblsb.jdField_a_of_type_JavaLangString, localblsb.c);
      switch (localblrx.a())
      {
      }
    }
    for (;;)
    {
      j += 1;
      break;
      this.jdField_b_of_type_JavaUtilArrayList.remove(localblsb);
      this.jdField_a_of_type_JavaUtilLinkedList.offer(localblrx);
      continue;
      this.jdField_a_of_type_JavaUtilArrayList.remove(localblsb);
      this.jdField_b_of_type_JavaUtilArrayList.remove(localblsb);
      i = 1;
    }
  }
  ...
  public void a(blsa paramblsa)
  {
    ...
    this.jdField_a_of_type_Blsa = paramblsa;
    ...
    {
      paramblsa = paramblsa.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramblsa.hasNext())
      {
        localObject1 = (blsb)paramblsa.next();
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        try
        {
          ...
          localObject2 = paramblsa.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            blsb localblsb = (blsb)((Iterator)localObject2).next();
            if (localblsb.jdField_a_of_type_Int == k)
            {
              this.jdField_a_of_type_JavaUtilArrayList.add(localblsb);
              this.jdField_b_of_type_JavaUtilArrayList.add(localblsb);
            }
          }
        }
  ...
  public void a(boolean paramBoolean, blrx paramblrx)
  {
    Handler localHandler = this.jdField_a_of_type_AndroidOsHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      paramblrx = Message.obtain(localHandler, 2, i, 0, paramblrx);
      this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(paramblrx, 3000L);
      return;
    }
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Blsa != null) {
      return;
    }
    ...
    try
    {
      localObject4 = bdcs.a((File)localObject4);
      localObject1 = localObject2;
      localObject2 = blsa.a((String)localObject4);
      localObject1 = localObject2;
      if (QLog.isColorLevel())
      {
        localObject1 = localObject2;
    ...
    try
    {
      String str = blve.a("predownload11111.cfg");
      localObject4 = localObject1;
      localObject1 = blsa.a(str);
      localObject2 = localObject1;
      localObject4 = localObject1;
      if (QLog.isColorLevel())
      {
  ...
  public void d()
  {
    ...
    {
      blsb localblsb = (blsb)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (i == 0) {
        ((StringBuilder)localObject).append(localblsb.jdField_a_of_type_Int);
      }
      for (;;)
      {
        i += 1;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          localObject1 = (blrx)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.i("QIMPredownManager", 2, "onJobFinish: " + ((blrx)localObject1).jdField_a_of_type_Int + ", " + ((blrx)localObject1).jdField_a_of_type_JavaLangString);
          }
          localObject2 = new QIMPredownHistory();
          ((QIMPredownHistory)localObject2).resId = ((blrx)localObject1).jdField_a_of_type_JavaLangString;
          ...
          ((awbw)localObject3).a((awbv)localObject2);
          ((awbw)localObject3).a();
          if (paramMessage.arg1 == 1)
          {
            ...
            if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
            {
              paramMessage = (blsb)this.jdField_a_of_type_JavaUtilArrayList.get(i);
              if (paramMessage.jdField_a_of_type_Int != ((blrx)localObject1).jdField_a_of_type_Int) {
                break label366;
              }
              if (QLog.isColorLevel()) {
                QLog.i("QIMPredownManager", 2, "onJobFinish: remove " + ((blrx)localObject1).jdField_a_of_type_Int + ", " + ((blrx)localObject1).jdField_a_of_type_JavaLangString);
              }
        ...
        if (a())
        {
          ...
          if (i != 0)
          {
            paramMessage = (blrx)this.jdField_a_of_type_JavaUtilLinkedList.poll();
            if (paramMessage != null)
            {
              ...
              for (;;)
              {
                ...
                i += 1;
                break;
                this.jdField_a_of_type_Blrx = paramMessage;
                paramMessage.a();
                i = 0;
                continue;
                this.jdField_a_of_type_Blrx = paramMessage;
      ...
      localObject3 = this.jdField_a_of_type_Blsa;
    ...
    if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
    {
      ...
      if (j == 0)
      {
        ...
        paramMessage = a().getEntityManagerFactory().createEntityManager();
        paramMessage.a((awbv)localObject2);
        paramMessage.a();
      }
      ...
      i = 1;
      label649:
      localObject2 = new azpr();
      ((azpr)localObject2).d = "0X80090DF";
      ((azpr)localObject2).f = String.valueOf(m);
      ((azpr)localObject2).h = ((String)localObject1);
      ((azpr)localObject2).i = String.valueOf(bdiv.B(BaseApplicationImpl.context));
      if (j == 0) {
        break label877;
      }
      paramMessage = "2";
      label705:
      ((azpr)localObject2).j = paramMessage;
      int k = -1;
      paramMessage = ((blsa)localObject3).jdField_b_of_type_JavaUtilArrayList.iterator();
      do
      {
        j = k;
        ...
        localObject3 = (blsb)paramMessage.next();
      } while ((!TextUtils.equals((CharSequence)localObject1, ((blsb)localObject3).jdField_a_of_type_JavaLangString)) || (m != ((blsb)localObject3).c));
      j = ((blsb)localObject3).b;
      if ((j == -1) && (i == 0)) {
        break label884;
      }
      paramMessage = "1";
      label788:
      ((azpr)localObject2).k = paramMessage;
      paramMessage = new blrx();
    ...
    {
      ((azpr)localObject2).l = paramMessage;
      ((azpr)localObject2).m = String.valueOf(j);
      azmf.a(null, (azpr)localObject2);
      break;
      j = 0;
      break label548;
      label872:
