  ...
  extends BaseAdapter
{
  ...
  protected ArrayList<yxk> a;
  protected yxk a;
  protected boolean a;
  protected ArrayList<yxk> b;
  
  public yxh(Context paramContext, GridView paramGridView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_b_of_type_JavaUtilArrayList.add(yxk.jdField_a_of_type_Yxk);
    if (!paramBoolean1) {
      this.jdField_b_of_type_JavaUtilArrayList.add(yxk.jdField_b_of_type_Yxk);
    }
    if (paramBoolean2) {
      this.jdField_b_of_type_JavaUtilArrayList.add(yxk.c);
    }
  }
  ...
  public int a(yxk paramyxk)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {
      return this.jdField_a_of_type_JavaUtilArrayList.indexOf(paramyxk);
    }
    return -1;
  }
  ...
  public yxk a()
  {
    return this.jdField_a_of_type_Yxk;
  }
  ...
  public void a()
  {
    ...
    {
      i = j;
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(yxk.c))
      {
        this.jdField_a_of_type_JavaUtilArrayList.remove(yxk.c);
        this.jdField_b_of_type_JavaUtilArrayList.remove(yxk.c);
        i = 1;
      }
    }
    if (i != 0) {
  ...
  public void a(ArrayList<yxk> paramArrayList)
  {
  ...
  {
    yxk localyxk = (yxk)getItem(paramInt);
    Object localObject1;
    if (localyxk == null)
    {
      localObject1 = null;
    ...
    if (paramView == null)
    {
      ...
      label116:
      localTextView.setText(localyxk.jdField_b_of_type_JavaLangString);
      if (localyxk.jdField_b_of_type_Int != 0) {
        break label234;
      }
      localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130846667, 0, 0);
      if (localyxk.equals(this.jdField_a_of_type_Yxk)) {
        localTextView.getCompoundDrawables()[1].setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166505), PorterDuff.Mode.MULTIPLY);
      }
      ...
      localTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166505));
    }
    for (;;)
    {
      ...
      {
        localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130846671, 0, 0);
        if (localyxk.equals(this.jdField_a_of_type_Yxk)) {
          localTextView.getCompoundDrawables()[1].setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166505), PorterDuff.Mode.MULTIPLY);
        }
        localTextView.setTag(null);
      ...
      {
        localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130846664, 0, 0);
        if ((this.jdField_a_of_type_Yxk != null) && (this.jdField_a_of_type_Yxk.jdField_b_of_type_Int == 2)) {
          localTextView.getCompoundDrawables()[1].setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166505), PorterDuff.Mode.MULTIPLY);
        }
        localTextView.setTag(null);
        break label187;
      ...
      {
        paramView = null;
        int i = (int)bhdz.a(this.jdField_a_of_type_AndroidContentContext, 36.0F);
        if (localyxk.jdField_a_of_type_Int > 0)
        {
          paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(localyxk.jdField_a_of_type_Int);
        ...
        for (;;)
        {
          ...
          localTextView.getCompoundDrawables()[1].setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166506), PorterDuff.Mode.SRC_ATOP);
          break;
      ...
      label709:
      if (localyxk.equals(this.jdField_a_of_type_Yxk)) {
        localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130846666, 0, 0);
      }
      for (;;)
      {
        localTextView.setTag(localyxk);
        break;
        localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130846665, 0, 0);
      }
      label786:
      if ((localyxk.jdField_b_of_type_Int == 2) && (this.jdField_a_of_type_Yxk != null) && (this.jdField_a_of_type_Yxk.jdField_b_of_type_Int == 2))
      {
        localTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166505));
      }
      else
