  ...
  extends yxs
{
  ...
  private zca jdField_a_of_type_Zca;
  ...
  public yxh(DoodleView paramDoodleView)
  {
  ...
  private void b()
  {
    ...
    if (bqcd.b()) {
      this.jdField_c_of_type_Int = bqcd.jdField_a_of_type_Int;
    }
    this.d = localDisplayMetrics.heightPixels;
    if (bqcd.b()) {
      this.d = (localDisplayMetrics.heightPixels - bqcd.e);
    }
    ...
    this.jdField_a_of_type_Zca.b(0.5F);
  }
