...
public class balt
{
  public static aznt a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("TroopBar", 2, "applyUpload title = " + str2 + ", filePath = " + str1 + ", size = " + bbdj.a(str1));
    }
    if ((TextUtils.isEmpty(str1)) || (!bbdj.a(str1)))
    {
    ...
    paramString1.add(new BasicNameValuePair("size", String.valueOf(bbdj.a(str1))));
    paramString1.add(new BasicNameValuePair("sha", bbdm.a(apue.a(str1)).toLowerCase()));
    paramString1.add(new BasicNameValuePair("md5", bbdm.a(apue.d(str1)).toLowerCase()));
    paramString1.add(new BasicNameValuePair("bkn", "" + bamn.b(paramString2)));
    if (QLog.isColorLevel()) {
    ...
    else
    {
      ...
      for (paramBundle = HttpBaseUtil.a(new GZIPInputStream(paramBundle.getContent()));; paramBundle = EntityUtils.toString(paramBundle))
      {
        ...
        paramBundle = new aznt(paramBundle);
