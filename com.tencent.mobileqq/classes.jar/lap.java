  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      try
      {
        ...
        paramFromServiceMsg = abrk.a((PBField)localObject);
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg != JSONObject.NULL))
        {
          ...
          notifyObserver(paramIntent, 1, true, (Bundle)localObject, laq.class);
          return;
        }
        notifyObserver(paramIntent, 1, false, null, laq.class);
        return;
      }
