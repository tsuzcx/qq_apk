...
public class beze
{
  ...
  {
    String str = beln.a(MiniAppEnv.g().getContext());
    if (str == null) {
      return "unknown";
    }
  ...
  {
    return new ArrayList(Arrays.asList(new COMM.Entry[] { a("source_app", ((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getPlatformId()), a("source_version", ((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getAppVersion()), a("source_uin_platform", bfhk.e()), a("connect_openid", beut.a().c()), a("connect_type", String.valueOf(beut.a().a())) }));
  }
  ...
  {
    COMM.Entry localEntry1 = a("uid", beut.a().a());
    ...
    if (paramString2 != null)
    {
      ...
      localEntry6 = a("qua", bfhk.b());
      localEntry7 = a("sdk_version", bfhk.a());
  ...
  public static void a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      betc.d("MiniProgramReportHelper", "[mini] assignAppLaunchId [appId= " + str1 + "] [launchId=" + str2);
    }
  ...
  {
    return new ArrayList(Arrays.asList(new COMM.Entry[] { a("uin", String.valueOf(beut.a().a())), a("touin", ""), a("timestamp", String.valueOf(System.currentTimeMillis())), a("qqversion", bfhk.b()), a("idfa", ""), a("idfv", ""), a("android_id", Settings.Secure.getString(MiniAppEnv.g().getContext().getContentResolver(), "android_id")) }));
  }
  
  public static List<COMM.Entry> c()
  {
    ArrayList localArrayList = new ArrayList(Arrays.asList(new COMM.Entry[] { a("device_platform", "Android"), a("device_maker", Build.MANUFACTURER), a("device_model", Build.MODEL), a("device_version", Build.VERSION.RELEASE), a("network_type", a()), a("network_gateway_ip", ""), a("network_ssid", beln.b(MiniAppEnv.g().getContext())) }));
    if (0 != 0) {
