...
public class bipr
{
  ...
  public static Bundle a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    localBundle.putString("apn", bist.b(biip.a().a()));
    localBundle.putString("model_name", Build.MODEL);
    localBundle.putString("qq_ver", biip.a().c());
    return localBundle;
  }
  ...
  {
    bisy.b("AuthorityUtil", "getOpenId uin = " + paramString1 + ", appid = " + paramString2);
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return null;
    }
    return biyn.a(paramContext, "uin_openid_store").getString(paramString2 + ":" + paramString1, null);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, biyc parambiyc, appType.LoginSig paramLoginSig, String paramString1, String paramString2)
  {
    Object localObject = paramAppRuntime.getAccount();
    String str = parambiyc.a;
    boolean bool2 = ((OpenSDKAppInterface)paramAppRuntime).a().a(str);
    boolean bool1;
    if ((!bool2) && (TextUtils.equals((CharSequence)localObject, str))) {
      if (a(parambiyc.a, paramAppRuntime, true) != null)
      {
        bool1 = true;
        boolean bool3 = a(parambiyc.a, paramAppRuntime);
    ...
    do
    {
      ...
      localObject = a(parambiyc.a, paramAppRuntime, true);
      if ((!bool2) && (localObject != null) && (a(parambiyc.a, paramAppRuntime)))
      {
      ...
      parambiyc = a(parambiyc.a, paramAppRuntime, false);
      paramAppRuntime = paramString2;
    } while (parambiyc == null);
    QLog.d("AuthorityUtil", 1, "getMsfCommand use opensdk cache");
    paramString1.appid.set(1600001540);
    paramString1.sig.set(ByteStringMicro.copyFrom(parambiyc));
    paramLoginSig.set(paramString1);
    return paramString2;
  }
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, Long paramLong, int paramInt2, int paramInt3, String paramString5)
  {
    try
    {
      biur.a().a(paramInt1, paramString1, paramString2, paramString3, paramString4, paramLong, paramInt2, paramInt3, paramString5);
      return;
    }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    try
    {
      bipi.a().a(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramBoolean);
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    for (;;)
    {
      ...
      bcst.b(null, "dc00898", "", "", "0X800AC2F", "0X800AC2F", 0, 0, "", "", "", "");
  ...
  public static byte[] a(String paramString, AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    label151:
    label158:
    for (paramString = null;; paramString = bgmj.a(paramAppRuntime))
    {
      return paramString;
