  ...
  implements View.OnClickListener
{
  ...
  protected ajxl a;
  protected Context a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ainb(this);
  protected bazl a;
  protected QQAppInterface a;
  protected HashMap<Integer, ArrayList<auko>> a;
  protected List<auko> a;
  ...
  public aina(Context paramContext, ExpandableListView paramExpandableListView, QQAppInterface paramQQAppInterface, List<auko> paramList, aind paramaind, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bazl = new bazl(paramContext);
    this.jdField_a_of_type_Bazl.a((int)(this.jdField_a_of_type_Float * 100.0F), (int)(this.jdField_a_of_type_Float * 100.0F));
    a(paramList, false);
  ...
  private ArrayList<auko> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!bbbr.a(localRecentUser.uin)) && (localRecentUser.getType() == 0) && (!bbbr.c(localRecentUser.uin)) && (this.jdField_a_of_type_Ajxl != null) && (this.jdField_a_of_type_Ajxl.b(localRecentUser.uin))) {
        localArrayList.add(this.jdField_a_of_type_Ajxl.e(localRecentUser.uin));
      }
    }
    ...
    if ((((PhoneContactManagerImp)localObject1).c()) || (i == 8))
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (!((ArrayList)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131695029);
  ...
  public List<auko> a(int paramInt)
  {
  ...
  {
    ainc localainc = (ainc)paramView.getTag();
    if (localainc == null)
    {
      localainc = new ainc();
      localainc.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367211));
      localainc.b = ((TextView)paramView.findViewById(2131364630));
      paramView.findViewById(2131368567).setVisibility(0);
      paramView.setTag(localainc);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localainc.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      localainc.b.setText(String.valueOf(localGroups.group_friend_count));
      ((CheckBox)paramView.findViewById(2131368567)).setChecked(this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(paramInt));
      return;
    }
  }
  
  public void a(List<auko> paramList, boolean paramBoolean)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break label94;
        Object localObject = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(String.valueOf(localGroups.group_id));
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      for (paramViewGroup.jdField_c_of_type_Int = 11;; paramViewGroup.jdField_c_of_type_Int = 1)
      {
        ...
        paramBoolean = this.jdField_a_of_type_Aind.a(paramView, paramInt1);
        boolean bool = bail.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
        ...
        paramViewGroup = (aine)localForwardRecentItemView.getTag();
        break;
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.b = ((TextView)paramView.findViewById(2131364630));
  ...
  {
    paramView = (ainc)paramView.getTag();
