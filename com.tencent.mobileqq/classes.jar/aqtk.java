...
public class aqtk
{
  public static aqsz a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!(paramMessageRecord.get(n) instanceof axuq)) {
          break label269;
        }
        ArrayList localArrayList = ((axuq)paramMessageRecord.get(n)).a;
        k = i;
        i = j;
        i1 = 0;
        j = k;
        ...
        {
          k = i;
          if (!(localArrayList.get(i1) instanceof axws)) {
            continue;
          }
          j = 1;
          k = i;
  ...
  public static aqsz a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity)
  {
