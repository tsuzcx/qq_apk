...
public class vtn
  extends Handler
{
  public vtn(PublicAccountChatPie paramPublicAccountChatPie) {}
    ...
    case 7: 
      do
      {
        do
        {
          ...
          do
          {
            ...
            do
            {
              do
              {
                ...
                this.a.d.dismiss();
                QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2131433407, 0).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
                return;
          ...
          PublicAccountChatPie.a(this.a, DialogUtil.a(this.a.jdField_a_of_type_AndroidContentContext, 230, null, String.format("定位到你当前所在城市在%s，是否切换？", new Object[] { (String)paramMessage.obj }), "否", "是", new vto(this, i), new vtp(this, localSharedPreferences)));
