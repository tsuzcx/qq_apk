  ...
  implements AECameraManager.CameraManagerListener
{
  ...
  {
    bnrh.b(this.a.jdField_a_of_type_JavaLangString, "onCameraPreviewSizeChanged---width=" + paramInt1 + ", height=" + paramInt2);
  ...
  {
    bnrh.b(this.a.jdField_a_of_type_JavaLangString, "onCameraStarted--success=" + paramBoolean + ", errMsg=" + paramString);
    this.a.a(paramBoolean, paramString);
    if (paramBoolean) {
      bnqe.a().a("onCameraStart");
    }
    if (!paramBoolean) {
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_Bnbg.a(i);
      this.a.jdField_a_of_type_Bnbg.b(j);
      this.a.jdField_a_of_type_Bnqc.a(458753, new Object[0]);
      return;
      if (this.a.jdField_a_of_type_Bnrs != null) {
