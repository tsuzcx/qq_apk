...
public class aymh
{
  ...
  private Map<Integer, aymi> e = new ConcurrentHashMap();
  ...
  public aymh(AppInterface paramAppInterface)
  {
  ...
  {
    return bfrj.c(paramContext) + paramLong + ".zip";
  }
  ...
  public aymi a(int paramInt, boolean paramBoolean)
  {
    try
    {
      aymi localaymi = (aymi)this.e.get(Integer.valueOf(paramInt));
      if (localaymi == null)
      {
        localaymi = new aymi(this, paramInt);
        this.e.put(Integer.valueOf(paramInt), localaymi);
      }
      for (;;)
      {
        Object localObject2;
