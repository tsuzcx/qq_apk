...
public class agaa
{
  ...
  private static anxg jdField_a_of_type_Anxg;
  ...
  {
    if (bgkc.a(paramSessionInfo.jdField_a_of_type_Int)) {}
    for (int i = 5;; i = 6)
    {
      if (njo.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
        i = 1;
      }
      return i;
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    if ((paramIntent1 == null) || (!paramIntent1.hasExtra("showFlashPic")))
    {
      ...
      paramIntent2.putExtra("showFlashPic", anlk.a(paramSessionInfo.jdField_a_of_type_Int, (HotChatManager)localObject, paramSessionInfo.jdField_b_of_type_JavaLangString));
    }
    ...
    for (;;)
    {
      ...
      paramIntent2.putExtra("ALBUM_ID", bgkc.a(paramActivity));
      paramIntent2.putExtra("ALBUM_NAME", bgkc.b(paramActivity));
      ...
      paramIntent2.putExtra("is_anonymous", njo.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString));
      ...
      if ((paramIntent1 != null) && (paramIntent1.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false)))
      {
        ...
        paramIntent2.putExtra("PhotoConst.MAXUM_SELECTED_NUM", Math.min(bahv.b(paramQQAppInterface), j));
      }
      paramIntent2.putExtra("session_info", paramSessionInfo);
      ...
      if ((paramActivity instanceof SplashActivity)) {
        localObject = afur.a(paramIntent2, null);
      }
      ...
      if (paramSessionInfo.jdField_a_of_type_Int == 9501)
      {
        ...
        paramIntent2 = (abqn)paramQQAppInterface.a(51);
        long l1;
  ...
  private static agaj a(aktl paramaktl)
  {
    int i;
    String str;
    if (RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramaktl.jdField_a_of_type_Int)) == null)
    {
      i = 1;
      str = String.valueOf(2);
      switch (paramaktl.jdField_a_of_type_Int)
      {
      case 4: 
      case 5: 
      default: 
    ...
    for (;;)
    {
      agaj localagaj = new agaj(null);
      localagaj.jdField_a_of_type_JavaLangString = str;
      localagaj.jdField_a_of_type_Int = i;
      localagaj.jdField_b_of_type_JavaLangString = paramaktl;
      return localagaj;
      i = ((Integer)RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramaktl.jdField_a_of_type_Int))).intValue();
      break;
  ...
  private static agak a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    int i = 1;
    int j = 1;
    Object localObject2 = "";
    Object localObject1 = (aklj)paramQQAppInterface.getManager(125);
    if (localObject1 != null) {}
    for (localObject1 = ((aklj)localObject1).a();; localObject1 = "")
    {
      ...
      for (;;)
      {
        localObject2 = new agak(null);
        ((agak)localObject2).jdField_b_of_type_JavaLangString = paramQQAppInterface;
        ((agak)localObject2).jdField_a_of_type_Int = j;
        ((agak)localObject2).jdField_b_of_type_Int = i;
        ((agak)localObject2).jdField_a_of_type_JavaLangString = paramSessionInfo;
        ((agak)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
        return localObject2;
        if (paramSessionInfo.jdField_a_of_type_Int == 3000)
        {
          j = ((ankw)paramQQAppInterface.getManager(53)).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
        ...
        else
        {
          if (paramSessionInfo.jdField_a_of_type_Int == 1)
          {
            ...
            try
            {
              ...
              localObject3 = (anwd)paramQQAppInterface.a(20);
              if (jdField_a_of_type_Anxg == null) {
                jdField_a_of_type_Anxg = new agac(paramSessionInfo);
              }
              paramQQAppInterface.addObserver(jdField_a_of_type_Anxg);
              ((anwd)localObject3).b(l, 32, 0);
            }
            ...
            {
              bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9C", "0X8005B9C", 0, 0, "", "", "", "");
              i = 6;
          ...
          else
          {
            if ((paramSessionInfo.jdField_a_of_type_Int == 1001) || (paramSessionInfo.jdField_a_of_type_Int == 10002) || (paramSessionInfo.jdField_a_of_type_Int == 10004))
            {
              ...
              label574:
              for (paramSessionInfo = bgku.encodeToString(paramSessionInfo, 2);; paramSessionInfo = "")
              {
                bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9D", "0X8005B9D", 0, 0, "", "", "", "");
                paramQQAppInterface = "entrance.click.c2c";
                i = 7;
                break;
  ...
  private static Intent a(aktl paramaktl)
  {
    ...
    if ((paramaktl != null) && (paramaktl.jdField_a_of_type_Int == 3)) {
      if (paramaktl.jdField_a_of_type_OrgJsonJSONObject == null) {
        break label96;
      }
    }
    label96:
    for (paramaktl = paramaktl.jdField_a_of_type_OrgJsonJSONObject.optString("theme_id", "");; paramaktl = "")
    {
      localIntent.putExtra("theme_type", paramaktl);
  ...
  public static void a(Activity paramActivity, int paramInt)
  {
    ...
    localIntent.putExtra("ALBUM_ID", bgkc.a(paramActivity));
    localIntent.putExtra("ALBUM_NAME", bgkc.b(paramActivity));
  ...
  private static void a(Activity paramActivity, Intent paramIntent, agak paramagak, agaj paramagaj, SessionInfo paramSessionInfo)
  {
    paramIntent.putExtra("vacreport_key_seq", VACDReportUtil.a(null, "qqwallet", "makeHongbao", "click", "groupType=" + paramagak.jdField_b_of_type_Int, 0, null));
    JSONObject localJSONObject = new JSONObject();
    try
    {
      localJSONObject.put("recv_type", paramagak.jdField_b_of_type_Int);
      localJSONObject.put("recv_uin", paramSessionInfo.jdField_a_of_type_JavaLangString);
      localJSONObject.put("channel", paramagaj.jdField_a_of_type_Int);
      localJSONObject.put("bus_type", paramagaj.jdField_a_of_type_JavaLangString);
      if (paramagak.jdField_a_of_type_Int > 0) {
        localJSONObject.put("people_num", paramagak.jdField_a_of_type_Int);
      }
      if (!TextUtils.isEmpty(paramagak.jdField_a_of_type_JavaLangString)) {
        localJSONObject.put("session_token", paramagak.jdField_a_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramagak.jdField_c_of_type_JavaLangString)) {
        localJSONObject.put("placeholder", paramagak.jdField_c_of_type_JavaLangString);
      }
    }
    catch (JSONException paramagak)
    {
      for (;;)
      {
        paramagak.printStackTrace();
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public static void a(Intent paramIntent, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    if (a(paramSessionInfo, paramQQAppInterface.a(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      paramIntent.putExtra("binder_presendService", new BinderWarpper(new ayym(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_b_of_type_JavaLangString, paramQQAppInterface.getAccount(), paramSessionInfo.jdField_e_of_type_Int).asBinder()));
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!bgjw.a())
      {
        QQToast.a(paramActivity, paramActivity.getResources().getString(2131717588), 0).a();
        return;
      }
      paramAppInterface = anhk.bn;
      boolean bool;
      label56:
      Object localObject;
      if (paramInt2 == 1)
      ...
      catch (Exception paramAppInterface)
      {
        for (;;)
        {
          ...
          QQToast.a(paramActivity, 2131690580, 0).a();
        }
      }
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt, SessionInfo paramSessionInfo, agak paramagak, agaj paramagaj)
  {
    if (paramInt == 0)
    {
      ahqr.a(paramQQAppInterface, "0X8005CAF", paramSessionInfo.jdField_a_of_type_Int);
      if (jdField_a_of_type_Int != 0) {
        break label104;
      }
      paramagak.jdField_b_of_type_JavaLangString += ".plus";
    }
    for (;;)
    {
      bcst.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramagak.jdField_b_of_type_JavaLangString, 0, 0, paramagaj.jdField_b_of_type_JavaLangString, "", "", "");
      return;
      if (paramInt != 1) {
        break;
      }
      ahqr.a(paramQQAppInterface, "0X8005FC9", paramSessionInfo.jdField_a_of_type_Int);
      break;
      label104:
      if (jdField_a_of_type_Int == 1) {
        paramagak.jdField_b_of_type_JavaLangString += ".quick";
      }
    }
  }
  ...
  {
    blqo.a(paramQQAppInterface, "tenpay.com", new agad(paramInt1, paramSessionInfo, paramQQAppInterface, paramInt2, paramString, paramActivity));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, aktl paramaktl, List<aktl> paramList, int paramInt)
  {
    if (paramaktl == null) {
      return;
    }
    ...
    if (a(paramQQAppInterface, paramActivity, paramaktl, paramSessionInfo, paramList))
    {
      QLog.i("PlusPanelUtils", 2, "---doSendHbJumpNoEnterSendHbActivity---");
      return;
    }
    agaj localagaj = a(paramaktl);
    a(paramActivity, a(paramaktl), paramList, localagaj, paramSessionInfo);
    a(paramQQAppInterface, paramInt, paramSessionInfo, paramList, localagaj);
  }
  ...
  {
    bcst.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "Music_gene", "Music_gene_AIO", 0, 0, String.valueOf(a(paramSessionInfo.jdField_a_of_type_Int)), "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent, HashMap<LocalMediaInfo, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      paramIntent.putExtra("KEY_IS_ANONYMOUS", njo.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString));
      localIntent.putExtra("enter_from", 1);
      ...
      for (;;)
      {
        ...
        return;
        paramQQAppInterface = akft.a(paramHashMap);
  ...
  {
    new agaf(paramSessionInfo, paramQQAppInterface, paramContext, bgmo.b(paramContext, paramUri)).execute(new Void[0]);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramSessionInfo.jdField_a_of_type_Int == 1025) || (paramSessionInfo.jdField_a_of_type_Int == 0) || (paramSessionInfo.jdField_a_of_type_Int == 1000) || (paramSessionInfo.jdField_a_of_type_Int == 1004)) && (((bjft)paramQQAppInterface.getManager(165)).d(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      arrayOfInt[0] = 5;
      localmuh.b(2131697476);
    }
    for (int i = 1;; i = 0)
    {
      arrayOfInt[i] = 1;
      ...
      localmuh.a(new agab(paramQQAppInterface));
      localmuh.a(new agae(localmuh, arrayOfInt, paramSessionInfo, paramQQAppInterface, paramBaseChatPie, paramContext, paramString));
      localmuh.show();
      bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8004D68", "0X8004D68", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      bcst.b(paramQQAppInterface, "CliOper", "", "", (String)localObject2, (String)localObject2, 0, 0, (String)localObject1, "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    ...
    if (AudioHelper.b(0))
    {
      bglp.a(paramContext, 230, paramContext.getString(2131697656), paramContext.getString(2131697657), new agag(), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bglp.a(paramContext, 230, paramContext.getString(2131697656), paramContext.getString(2131697658), new agah(), null).show();
      return;
    }
    if (paramQQAppInterface.getApp().checkPermission("android.permission.CAMERA", Process.myPid(), Process.myUid()) != 0)
    {
      bglp.a(paramContext, 230, paramContext.getString(2131697656), anni.a(2131707076), new agai(), null).show();
      return;
    }
    if (paramInt2 == 0) {}
    for (int i = 1;; i = 17000)
    {
      ...
      accz.a(paramQQAppInterface, Long.parseLong(paramSessionInfo.jdField_a_of_type_JavaLangString), "Usr_AIO_SendMsg", 2, 0, paramInt1);
      return;
    }
  }
  
  private static void a(List<aktl> paramList)
  {
        ...
        if (paramSessionInfo != null)
        {
          ...
          if (paramSessionInfo.length() > 0)
          {
            ...
            if (paramSessionInfo.length >= 4)
            {
              ...
              i = bgnt.a(BaseApplicationImpl.getContext());
            }
          }
        }
      }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity, aktl paramaktl, SessionInfo paramSessionInfo, agak paramagak)
  {
    switch (paramaktl.jdField_a_of_type_Int)
    {
    default: 
    ...
    case 5: 
      ...
      paramaktl = new Intent(paramActivity, QrcodeHbGuiderActivity.class);
      paramaktl.putExtra("appInfo", "");
      paramaktl.putExtra("vacreport_key_seq", l);
      paramActivity.startActivity(paramaktl);
      bcst.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "plus.hongbao.click", 0, 0, "", "", "", "");
      return true;
    case 4: 
      if (paramaktl.jdField_a_of_type_OrgJsonJSONObject != null)
      {
        localObject = paramaktl.jdField_a_of_type_OrgJsonJSONObject.optString("url", "");
        QLog.i("PlusPanelUtils", 2, (String)localObject);
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          return true;
        }
        paramQQAppInterface = (QQAppInterface)localObject;
        if (paramaktl.jdField_a_of_type_OrgJsonJSONObject.optInt("subtype", 0) == 1) {
          if (((String)localObject).indexOf("?") != -1) {
            break label262;
          }
        }
      }
      for (paramQQAppInterface = (String)localObject + "?recv_uin=" + paramSessionInfo.jdField_a_of_type_JavaLangString + "&recv_type=" + paramagak.jdField_b_of_type_Int;; paramQQAppInterface = (String)localObject + "&recv_uin=" + paramSessionInfo.jdField_a_of_type_JavaLangString + "&recv_type=" + paramagak.jdField_b_of_type_Int)
      {
    ...
    case 12: 
      label262:
      paramaktl = paramaktl.jdField_a_of_type_OrgJsonJSONObject.optString("schema");
      QLog.i("PlusPanelUtils", 2, paramaktl);
      if (TextUtils.isEmpty(paramaktl)) {
        return true;
      }
      a(paramQQAppInterface, paramActivity, paramSessionInfo, paramagak.jdField_b_of_type_Int, paramagak.jdField_a_of_type_Int, paramaktl);
      return true;
    }
    paramaktl = paramaktl.jdField_a_of_type_OrgJsonJSONObject.optString("schema", "");
    QLog.i("PlusPanelUtils", 2, paramaktl);
    ...
    ((Map)localObject).put("recv_group_type", paramagak.jdField_b_of_type_Int + "");
    ...
    paramQQAppInterface = blqo.a(paramaktl, (Map)localObject, true);
    if (QLog.isColorLevel()) {
      QLog.i("PlusPanelUtils", 2, "[go to miniapp] finalSchame: " + paramQQAppInterface);
    }
    akwv.a(paramActivity, paramQQAppInterface);
    return true;
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    bljn.a(paramActivity, paramQQAppInterface.getAccount(), localIntent, -1, false);
    bljv.b(paramQQAppInterface, 3, paramSessionInfo.jdField_a_of_type_Int);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (localObject = paramSessionInfo.jdField_a_of_type_JavaLangString; paramString == null; localObject = ((awmz)localObject).b(str))
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    paramQQAppInterface.putExtra(bgkb.h, 84);
