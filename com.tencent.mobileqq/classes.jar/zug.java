...
public class zug
{
  private static final String jdField_a_of_type_JavaLangString = zug.class.getSimpleName();
  private Handler jdField_a_of_type_AndroidOsHandler;
  private Map<String, ArrayList<CertifiedAccountMeta.StComment>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private Map<String, Integer> b = new HashMap();
  private Map<String, zuq> c = new HashMap();
  ...
  private void a(String paramString, COMM.StCommonExt paramStCommonExt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      zuq localzuq = new zuq();
      localzuq.jdField_a_of_type_NS_COMMCOMM$StCommonExt = paramStCommonExt;
      localzuq.jdField_a_of_type_Boolean = paramBoolean1;
      localzuq.b = paramBoolean2;
      this.c.put(paramString, localzuq);
      QLog.d(jdField_a_of_type_JavaLangString, 1, "getDetailCommentSize: attachInfo:" + paramStCommonExt.attachInfo.get());
      return;
    }
    ((zuq)this.c.get(paramString)).jdField_a_of_type_Boolean = paramBoolean1;
    ((zuq)this.c.get(paramString)).jdField_a_of_type_NS_COMMCOMM$StCommonExt = paramStCommonExt;
  }
  
  private void a(String paramString, boolean paramBoolean)
  {
    if ((this.c != null) && (this.c.get(paramString) != null)) {
      ((zuq)this.c.get(paramString)).b = paramBoolean;
    }
  }
  ...
  private void a(boolean paramBoolean, long paramLong, String paramString, CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, COMM.StCommonExt paramStCommonExt)
  {
    if (paramStGetFeedDetailRsp != null)
    {
      ...
      wad.a().dispatch(new zut(5, new Object[] { str, Integer.valueOf(a(str)) }));
    }
    wad.a().dispatch(a(new Object[] { Integer.valueOf(2), Long.valueOf(paramLong), paramString, paramStGetFeedDetailRsp, Integer.valueOf(hashCode()), paramStCommonExt }));
  }
  ...
  public long a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment)
  {
    ...
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, new zun(this));
  ...
  public long a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, new zul(this, paramStComment, paramStReply));
    return 0L;
  }
  ...
  public COMM.StCommonExt a(String paramString)
  {
    ...
    paramString = (zuq)this.c.get(paramString);
    if (paramString != null)
    {
  ...
  public String a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment)
  {
    ...
    {
      wad.a().dispatch(a(new Object[] { Integer.valueOf(5), Long.valueOf(-1L), anvx.a(2131701672), null }));
      return "";
    }
    paramStFeed = new DoCommentRequest(paramStFeed, paramStComment, 0);
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, new zuk(this, paramStComment));
  ...
  public String a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    {
      wad.a().dispatch(a(new Object[] { Integer.valueOf(5), Long.valueOf(-1L), anvx.a(2131701670), null }));
      return "";
    }
    paramStFeed = new DoReplyReq(paramStFeed, paramStComment, paramStReply, 0);
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, new zum(this, paramStReply, paramStComment));
  ...
  public zut a(Object... paramVarArgs)
  {
    return new zut(6, paramVarArgs);
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment)
  {
    ...
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, new zuj(this, paramStComment));
  }
  ...
  {
    paramStFeed = new DoLikeRequest(paramStFeed);
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, new zuo(this));
  }
  
  public void a(CertifiedAccountMeta.StFeed paramStFeed, COMM.StCommonExt paramStCommonExt)
  {
    zuh localzuh = new zuh(this, paramStCommonExt);
    if (paramStCommonExt == null)
    {
      String str = paramStFeed.id.get();
      if (zpr.a("1002" + str))
      {
        zpr.a("1002" + str, new zui(this, localzuh));
        zpr.a("1002" + str);
        return;
      }
    }
    ...
    VSNetworkHelper.getInstance().sendRequest(paramStFeed, localzuh);
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed, COMM.StCommonExt paramStCommonExt, String paramString)
  {
    ...
    VSNetworkHelper.getInstance().sendRequest(paramStCommonExt, new zup(this, paramStFeed, paramString));
  }
