  ...
  extends mxh
{
  private void a(Intent paramIntent)
  {
    if (paramIntent != null)
    {
      ...
      ((ahfq)((QQAppInterface)getAppRuntime()).getManager(341)).a(false, j, 0, null, null, i);
    }
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      paramFromServiceMsg = bblm.b(paramFromServiceMsg.getWupBuffer());
      switch (i9)
      {
      default: 
        i2 = 0;
    ...
    for (m = 0;; m = 1)
    {
      for (;;)
      {
        ahic.a(paramFromServiceMsg, 1, m, 1007, i, j, true, MD5.toMD5((String)localObject1));
        if (k != 0) {}
        try
        {
          ...
          if (i < 1)
          {
            ...
            localahfq = (ahfq)((QQAppInterface)localObject4).getManager(341);
        ...
        try
        {
          ahic.a(2, 2, 1007, i, k, true, new String[] { j + "" });
          j = 1;
          i1 = k;
          paramFromServiceMsg = (FromServiceMsg)localObject1;
        }
      ...
      {
        m = 0;
        ahic.a(2, 2, 1007, i, k, true, new String[] { "type is not 1007" });
        j = 1;
        i1 = k;
        paramFromServiceMsg = (FromServiceMsg)localObject1;
        break;
      ...
      try
      {
        ...
        paramFromServiceMsg = (FromServiceMsg)localObject1;
        k = i1;
        if (localahfq.a(false, j, i, null, null, i7)) {
          break label1643;
        }
        n = i4;
        ahic.a(2, 4, 1007, i, j, true, new String[0]);
        m = i6;
        paramFromServiceMsg = (FromServiceMsg)localObject1;
        k = i1;
      }
      ...
      if (k == -1)
      {
        ...
        n = i4;
        localObject5 = aurl.a((byte[])localObject4);
        n = i4;
        ...
        if ((localObject4.length == 0) || (k == 0))
        {
          ...
          n = i4;
          localahfq.a(true, j, i, null, null, i7);
          k = 0;
          paramFromServiceMsg = "";
          m = i3;
          break label1706;
      ...
      try
      {
        bool = localahfq.a(true, j, i, paramFromServiceMsg, (List)localObject4, i7);
        if (bool) {
          break label1637;
        }
        k = 0;
      ...
      try
      {
        ...
        ahic.a(2, 3, 1007, i, j, true, new String[0]);
        paramFromServiceMsg = "";
        m = 0;
        k = 1;
      }
      ...
      ahic.a(2, 2, 1007, i, j, true, new String[] { "config in package invalid" });
      paramFromServiceMsg = "";
      m = 0;
      k = 1;
      break label1706;
      if (k != 0)
      {
        ...
        n = i4;
        localahfq.a(i7, j, k, localPageRespInfo.task_id.get(), localPageRespInfo.cookies.get().toByteArray(), (byte[])localObject4);
        return;
        QLog.e("springHb_SpringFestivalRedpacketConfigServlet", 1, "onReceive fail.", paramFromServiceMsg);
        i2 = 0;
        ahic.a(2, 2, 1007, paramIntent.getIntExtra("k_id", 0), paramIntent.getIntExtra("k_version", 0), true, new String[] { QLog.getStackTraceString(paramFromServiceMsg) });
        n = i;
        i = j;
        j = n;
        i1 = k;
      ...
      n = k;
      ahic.a(2, 2, 1007, i, j, true, new String[] { "onReceive CMD_GET_CONFIG some thing wrong" });
      paramFromServiceMsg = (FromServiceMsg)localObject1;
      k = i5;
      break label1643;
      if (i9 != 1) {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      ((ConfigurationService.Screen)localObject3).width.set((int)bbct.g());
      ((ConfigurationService.Screen)localObject3).height.set((int)bbct.h());
      ((ConfigurationService.Screen)localObject3).dpi.set(bbct.d());
      ((ConfigurationService.Screen)localObject3).multi_touch.set(bbct.c());
      ...
      localObject1 = bblm.a(((ConfigurationService.ReqGetConfigByPage)localObject3).toByteArray());
      break;
