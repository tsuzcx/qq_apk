...
public class acdy
  extends ajxl
{
  public acdy(SubAccountBindActivity paramSubAccountBindActivity) {}
    ...
    for (;;)
    {
      ...
      while (j < SubAccountBindActivity.a(this.a).size())
      {
        if ((i > j) && (SubAccountBindActivity.a(this.a).get(j) != null) && (paramString.equals(((SimpleAccount)SubAccountBindActivity.a(this.a).get(j)).getUin())))
        {
          ...
          TextView localTextView2 = (TextView)SubAccountBindActivity.a(this.a).getChildAt(j).findViewById(2131361823);
          localTextView1.setText(bbcl.h(this.a.app, paramString));
