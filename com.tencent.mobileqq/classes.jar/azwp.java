...
{
  public azwp(HomeWorkTroopSelectorFragment paramHomeWorkTroopSelectorFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (HomeWorkTroopSelectorFragment.a(this.a) != null)
    {
      ...
      while (i < j)
      {
        localObject = (azwu)HomeWorkTroopSelectorFragment.a(this.a).getItem(i);
        if ((((Boolean)((azwu)localObject).b).booleanValue()) && (!HomeWorkTroopSelectorFragment.a(this.a).equals(((TroopInfo)((azwu)localObject).a).troopuin)))
        {
          paramView.add(((TroopInfo)((azwu)localObject).a).troopname);
          localArrayList.add(((TroopInfo)((azwu)localObject).a).troopuin);
        }
        i += 1;
      }
    }
