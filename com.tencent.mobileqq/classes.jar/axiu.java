  ...
  implements View.OnClickListener
{
  ...
  public axiu(BaseBubbleBuilder paramBaseBubbleBuilder)
  {
  ...
  {
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A36C", "0X800A36C", paramInt, 0, "", "", "", "");
  }
  
  private boolean a(View paramView, MessageForReplyText paramMessageForReplyText)
  {
    Object localObject1 = afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForReplyText.frienduin, paramMessageForReplyText.istroop, paramMessageForReplyText, paramMessageForReplyText.mSourceMsgInfo);
    ...
    else if (paramMessageForReplyText.isBarrageMsg)
    {
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A885", "0X800A885", 0, 0, "", "", "", "");
    }
    boolean bool1;
    label351:
    int i;
    for (;;)
    {
      ...
      if ((paramView.getId() == 2131364199) || (paramView.getId() == 2131377773)) {
        break label635;
      }
      return false;
      ...
      if ((localObject2 instanceof MessageForShortVideo))
      {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A886", "0X800A886", 0, 0, "", "", "", "");
      }
      else if (arni.a((MessageRecord)localObject2))
      {
        localObject1 = afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2);
        if ((localObject1 instanceof MessageForFile))
        {
          ...
          if (localObject1 != null)
          {
            i = arni.a(((FileManagerEntity)localObject1).fileName);
            if (i == 0) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A885", "0X800A885", 0, 0, "", "", "", "");
            } else if (i == 2) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A886", "0X800A886", 0, 0, "", "", "", "");
        ...
        else if ((localObject1 instanceof MessageForTroopFile))
        {
          ...
          localObject1 = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
          if (localObject1 != null)
          {
            i = arni.a(((bbpe)localObject1).g);
            if (i == 0) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A885", "0X800A885", 0, 0, "", "", "", "");
            } else if (i == 2) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A886", "0X800A886", 0, 0, "", "", "", "");
    ...
    {
      localObject1 = (ImageView)paramView.findViewById(2131377773);
      if (((MessageForShortVideo)localObject2).busiType != 0)
      {
        ...
        ShortVideoRealItemBuilder.a((QQAppInterface)localObject3, localContext, localMessageForShortVideo, (View)localObject2, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, false, true, afus.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
      }
      for (;;)
      {
        a(5);
        return true;
        afvt.a((MessageForShortVideo)localObject2, 0L, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, afus.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
      }
      if ((localObject2 instanceof MessageForText))
      {
        if ((paramView.getId() != 2131364199) && (paramView.getId() != 2131370758)) {
          return false;
        }
        if (paramView.getId() != 2131364199) {
          break label2603;
        }
        paramMessageForReplyText = (ETTextView)paramView.findViewById(2131370758);
      ...
      {
        if ((paramView.getId() != 2131364199) && (paramView.getId() != 2131370758) && (paramView.getId() != 2131377773)) {
          return false;
        }
        if (((localObject2 instanceof MessageForMixedMsg)) && ((paramView.getId() == 2131364199) || (paramView.getId() == 2131370758)))
        {
          if (paramView.getId() != 2131364199) {
            break label2592;
          }
        ...
        for (;;)
        {
          ...
          if (((localObject2 instanceof MessageForPic)) && (!(paramView instanceof URLImageView)))
          {
            ...
            if (afsf.a((MessageForPic)localObject1)) {
              AIOEmotionFragment.a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, zen.a(paramView), afus.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), false);
            }
            for (;;)
            {
              return true;
              afsf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, null, (MessageForPic)localObject2, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, true, afus.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
            }
          }
          paramView = (URLImageView)paramView;
          localObject1 = (MessageForPic)paramView.getTag(2131364185);
            ...
            if (bdcs.a(this.jdField_a_of_type_AndroidContentContext))
            {
              ...
              if (!((URLDrawable)localObject3).isDownloadStarted())
              {
                ...
                if (afsf.a((MessageForPic)localObject1)) {
                  ...
                  afsf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramView, (ChatMessage)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, true, afus.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
                }
              }
            }
          }
      ...
      {
        paramView = afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2);
        ...
        if ((paramView instanceof MessageForFile))
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (i == 0)
            {
              afhq.a(this.jdField_a_of_type_AndroidContentContext, null, (MessageForFile)paramView, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, false, true, true, paramMessageForReplyText);
              a(6);
              return true;
            }
            if (i == 2)
            {
              ...
              if (!aroo.a((FileManagerEntity)localObject1)) {
                return true;
              }
              i = 0;
              ...
              for (;;)
              {
                aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (MessageForFile)paramView, null, i, 10004, (FileManagerEntity)localObject1, false, true);
                break;
            ...
            for (;;)
            {
              paramView = new arhh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (FileManagerEntity)localObject1, 10004);
        ...
        else if ((paramView instanceof MessageForTroopFile))
        {
          ...
          localObject1 = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
          if (localObject1 != null)
          {
            if (((bbpe)localObject1).b == 12)
            {
            ...
            if (i == 2)
            {
              ...
              aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramView, l, (bbpe)localObject1, paramView.senderuin, paramView.lastTime, 3, 3, null, false, true, true);
            }
            for (;;)
            {
              a(6);
              return true;
              if (i == 0) {
                switch (((bbpe)localObject1).b)
                {
                case 4: 
                case 5: 
                default: 
                  afsf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, null, paramView, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, true, afus.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
                  break;
                case 0: 
                case 1: 
                case 2: 
                ...
                aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageForReplyText, l, (bbpe)localObject1, paramView.senderuin, paramView.lastTime, 3, 3, null, false, true);
              }
            }
          }
        }
      ...
      {
        if (!akdo.a((MessageRecord)localObject2)) {
          return false;
        }
        if (afus.c((MessageRecord)localObject2)) {
          return false;
        }
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          if ((paramMessageForReplyText instanceof StructMsgForGeneralShare))
          {
            ...
            localObject2 = new azrg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView, (StructMsgForGeneralShare)localObject1);
            StructMsgForGeneralShare.onClickEvent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (StructMsgForGeneralShare)localObject1, paramView, (azrg)localObject2);
    ...
    for (;;)
    {
      try
      {
        ...
        label1041:
        label1426:
        if ((paramMessageForReplyText != null) && (aoip.a().a(paramMessageForReplyText.appName, paramMessageForReplyText.appView)))
        {
          a(aoip.a(paramMessageForReplyText.appName, paramMessageForReplyText.appView));
          localObject2 = aoip.a().a(new JSONObject(paramMessageForReplyText.toAppXml()));
      ...
      continue;
      label2567:
      anfp.a((String)localObject2, 0, paramMessageForReplyText.appName);
      return true;
      label2580:
      localObject1 = null;
      continue;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        aekt.n = true;
        localObject1 = bdlr.a(((MessageForReplyText)localObject2).action);
        localObject1 = bdds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView.getContext(), (String)localObject1);
        if (localObject1 != null) {
          ((bddb)localObject1).c();
        }
      }
      ...
      case 2131368816: 
        ...
        {
          localObject1 = afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject2).frienduin, ((MessageForReplyText)localObject2).istroop, (MessageRecord)localObject2, ((MessageForReplyText)localObject2).mSourceMsgInfo);
          ...
          if (((paramView instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)paramView).tipParam != null) && ((((MessageForUniteGrayTip)paramView).tipParam.b == 1) || (((MessageForUniteGrayTip)paramView).tipParam.b == 131073)))
          {
            ...
            label598:
            label603:
            for (int j = 2131698122;; j = 2131698213)
            {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && ((localObject1 instanceof agld))) {
            ((agld)localObject1).a(22, localSourceMsgInfo.origUid, localSourceMsgInfo.mSourceMsgTime, null, 1, 1);
          }
          for (;;)
          {
            afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView, "0X800A36A");
            return;
            ...
            else if ((localObject1 instanceof agnz))
            {
              ((BaseChatPie)localObject1).a(22, localSourceMsgInfo.mSourceMsgSeq, (int)(((MessageForReplyText)localObject2).shmsgseq - localSourceMsgInfo.mSourceMsgSeq), (MessageRecord)localObject2, 1, 1);
              if (QLog.isColorLevel()) {
        ...
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131698121, 0).b(((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
        return;
        if (QLog.isColorLevel()) {
