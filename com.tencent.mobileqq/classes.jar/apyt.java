  ...
  extends aptq<apys>
{
  ...
  @NonNull
  public apys a(int paramInt)
  {
    return new apys();
  }
  
  @Nullable
  public apys a(aptx[] paramArrayOfaptx)
  {
    if ((paramArrayOfaptx != null) && (paramArrayOfaptx.length > 0))
    {
      new apys();
      return apys.a(paramArrayOfaptx);
    }
    return null;
  }
  
  public void a(apys paramapys)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MiniAppConfProcessor", 2, "onUpdate " + paramapys.toString());
    }
    paramapys = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramapys instanceof QQAppInterface))
    {
      paramapys = (MiniAppEntryHandler)((QQAppInterface)paramapys).getBusinessHandler(149);
      if (paramapys != null) {
        paramapys.notifyUI(0, true, null);
      }
    }
  }
  
  public Class<apys> clazz()
  {
    return apys.class;
  }
