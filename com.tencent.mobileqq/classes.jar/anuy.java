...
public class anuy
  extends ajmy
{
  public anuy(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(anwn paramanwn)
  {
    ...
    else if ((this.a.jdField_b_of_type_Int == 0) && (paramanwn != null) && (!this.a.jdField_b_of_type_JavaUtilList.contains(paramanwn)))
    {
      this.a.jdField_b_of_type_JavaUtilList.add(paramanwn);
      if (this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() != this.a.jdField_d_of_type_JavaUtilList.size()) {
        break label162;
      }
      Face2FaceAddFriendActivity.a(this.a, paramanwn);
    }
    for (;;)
    {
      paramanwn = this.a;
      ...
      ((Message)localObject).obj = paramanwn;
  ...
  public void a(anwr paramanwr)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.a.jdField_f_of_type_Long == 0L) || (l2 >= 1000L) || (paramanwr.a != 0L)) {
          break label269;
        }
        localObject = Message.obtain();
        ((Message)localObject).what = 16;
        ((Message)localObject).obj = paramanwr;
        l3 = 1000L - l2;
    ...
    } while ((this.a.jdField_b_of_type_Int != 1) || (this.a.jdField_a_of_type_JavaUtilList.contains(paramanwr)));
    label269:
    this.a.jdField_a_of_type_JavaUtilList.add(paramanwr);
    if ((this.a.l) && (this.a.jdField_a_of_type_Anwo != null))
    {
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.a.jdField_a_of_type_JavaUtilList.size()));
      this.a.jdField_a_of_type_Anwo.a(paramanwr);
      return;
    }
    Face2FaceAddFriendActivity.a(this.a, paramanwr);
    this.a.e();
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    if (i == 0)
    {
      Iterator localIterator = this.a.jdField_a_of_type_Anvy.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((paramBusiRespHead != null) && (paramBusiRespHead.a() == 2) && (paramString.equals(paramBusiRespHead.b())))
        {
          ...
          if (!(paramBusiRespHead instanceof anwn)) {
            break label477;
          }
        }
      }
    ...
    label477:
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((anwn)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      this.a.jdField_a_of_type_Anvy.a(paramBusiRespHead);
      ...
      break;
      awqx.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.2.6", "", this.a.app.getCurrentAccountUin());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<anwn> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        babr.a(this.a, 230, this.a.getString(2131654355), ajjy.a(2131638504), 2131625035, 2131626615, new anuz(this), null).show();
      }
    }
    label179:
    label185:
    do
    {
      ...
      for (;;)
      {
        ...
        {
          paramList = (anwq)paramBusiRespHead.next();
    ...
    label421:
    babr.a(this.a, 230, this.a.getString(2131654355), ajjy.a(2131638497), 2131625035, 2131626615, new anva(this), null).show();
  }
}
