...
public abstract class auye
{
  ...
  protected static VideoData a(int paramInt, List<FeedsProtocol.TopicCfg> paramList, FeedsProtocol.PicFeedsInfo paramPicFeedsInfo, ArrayList<VideoData> paramArrayList)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localVideoData.jdField_a_of_type_JavaUtilArrayList.add(new auyi(((FeedsProtocol.PicInfo)localObject).url.get().toStringUtf8(), ((FeedsProtocol.PicInfo)localObject).width.get(), ((FeedsProtocol.PicInfo)localObject).hight.get()));
      }
    }
  ...
  public void a(auyf paramauyf)
  {
    this.jdField_a_of_type_Auyf = paramauyf;
  }
