...
public class abqr
{
  ...
  public static SparseArray<abqs> a;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidUtilSparseArray.put(1, new abqs(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(4, new abqs(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(6, new abqs(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(7, new abqs(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(14, new abqs(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(9, new abqs(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(16, new abqs(0L, 0));
  }
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      if ((jdField_a_of_type_Long - l > 0L) && (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor != null))
      {
        ...
        arrayOfInt = abqk.jdField_a_of_type_ArrayOfInt;
        j = arrayOfInt.length;
        i = 0;
        for (;;)
        {
          if (i < j)
          {
            ...
            jdField_a_of_type_AndroidUtilSparseArray.put(k, new abqs(0L, 0));
            i += 1;
            continue;
    ...
    for (;;)
    {
      ...
      if (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences != null)
      {
        ...
        if (jdField_a_of_type_Int >= abqk.jdField_a_of_type_Int) {
          break;
        }
        arrayOfInt = abqk.jdField_a_of_type_ArrayOfInt;
        j = arrayOfInt.length;
        ...
        while (i < j)
        {
          ...
          jdField_a_of_type_AndroidUtilSparseArray.put(k, new abqs(0L, m));
          i += 1;
        }
      }
    }
  ...
  {
    abqs localabqs = (abqs)jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localabqs == null) {
      return;
    }
    localabqs.jdField_a_of_type_Int += 1;
  }
}
