...
import com.tencent.mobileqq.activity.Conversation.30.1;
import com.tencent.mobileqq.activity.Conversation.30.2;
import com.tencent.mobileqq.activity.Conversation.30.3;
import com.tencent.mobileqq.activity.Conversation.30.4;
import com.tencent.mobileqq.activity.Conversation.30.5;
...
public class adzc
  extends anmu
{
  public adzc(Conversation paramConversation) {}
  ...
  protected void onCancelMayKnowRecommend(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      anpk localanpk = (anpk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      ArrayList localArrayList = localanpk.c();
      if (localanpk.a(paramString)) {
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject1 = null;
      awhv.a().i(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        break label176;
      }
    }
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if (localObject1 != null) {
            ((aong)localObject1).delRecentUser(localRecentUser);
          }
          aldk.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, 1);
    ...
    label186:
    this.a.a(9, anhk.C, 5000);
    this.a.a(9, anhk.aK, 5001);
    if (QLog.isColorLevel()) {
  ...
  {
    if ((paramBoolean) && (bgjw.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()))) {
  ...
  protected void onGetStoreFace(boolean paramBoolean, HashSet<String> paramHashSet)
  {
    ...
    this.a.a(new Conversation.30.3(this, paramHashSet));
  }
  ...
  protected void onHideConversationMayKnowRecommend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      paramObject = (anpk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      paramObject.e();
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
    ...
    QQToast.a(BaseApplication.getContext(), anni.a(2131701393), 0).a();
    paramBoolean = ((anpk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl");
    paramObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramBoolean) {}
    for (;;)
    {
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (((anpk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl")))
    {
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
      this.a.jdField_a_of_type_MqqOsMqqHandler.removeCallbacks(this.a.jdField_a_of_type_JavaLangRunnable);
      this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.a.jdField_a_of_type_JavaLangRunnable, 1600L);
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (localObject == null)
    {
      ...
      awhv.a().a(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    for (;;)
    {
      ...
      try
      {
        RecentUser localRecentUser = (RecentUser)((aong)localObject).findRecentUser(str, 1);
      ...
      break;
      label318:
      awhv.a().c(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    label336:
    this.a.a(9, anhk.C, 5000);
    this.a.a(9, anhk.aK, 5001);
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (!bgjw.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      this.a.a(new Conversation.30.2(this, paramString));
      return;
    }
    this.a.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.a.sendEmptyMessage(3);
  }
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if (!bgjw.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()))
    {
      this.a.a(0L);
      return;
    }
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (paramBoolean2))
    {
      ...
      this.a.a(0L);
      this.a.a(new Conversation.30.1(this));
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.a(new Conversation.30.5(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.a(new Conversation.30.4(this, paramString));
    }
  }
}
