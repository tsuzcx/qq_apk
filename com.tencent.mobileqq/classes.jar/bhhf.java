...
public class bhhf
{
  ...
  public static void a(bhgu parambhgu, String paramString, long paramLong)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("module_id", parambhgu.a);
    localHashMap.put("module_url", parambhgu.d);
    localHashMap.put("module_version", parambhgu.b);
    localHashMap.put("resolveClassState", paramString);
    localHashMap.put("param_FailCode", "v" + parambhgu.b + "_" + paramString);
    boolean bool = "1".equalsIgnoreCase(paramString);
    a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambhgu.a + "_resolveClassRes", bool, paramLong, 0L, localHashMap, "");
  }
  
  public static void a(bhgu parambhgu, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("module_id", parambhgu.a);
      localHashMap.put("module_url", parambhgu.d);
      localHashMap.put("module_version", String.valueOf(parambhgu.b));
      localHashMap.put("downloadState", str);
      localHashMap.put("param_FailCode", "v" + parambhgu.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambhgu.a + "_downloadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public static void b(bhgu parambhgu, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("param_FailCode", "v" + parambhgu.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambhgu.a + "_loadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
}
