  ...
  extends anud
{
  ...
  public bdfv(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(boolean paramBoolean, int paramInt, anui paramanui)
  {
    biib localbiib = new biib("QC.UniBusinessLogicServer.UniBusinessLogicObj", "QCUniBusinessLogic.uniSet", "stReq", "rsp");
    UniSetReq localUniSetReq = new UniSetReq();
    localUniSetReq.stLogin = biib.a();
    localUniSetReq.stUniBusinessItem = new UniBusinessItem();
    localUniSetReq.stUniBusinessItem.appid = 307;
    localUniSetReq.stUniBusinessItem.itemid = Integer.decode(bdgb.a(paramInt)).intValue();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      localbiib.a("uniSet", localUniSetReq, new UniSetRsp(), paramanui, false);
      return;
    }
  }
  ...
  {
    int i = bdgb.a(String.valueOf(paramInt));
    if (i != -1)
    {
      bdgb.a(paramQQAppInterface.getCurrentAccountUin(), paramBoolean, 1);
      bdgb.a(paramQQAppInterface.getCurrentAccountUin(), i, 1);
      return;
    }
    bdgb.a(paramQQAppInterface, paramBoolean, String.valueOf(paramInt));
  }
  ...
  {
    a(paramBoolean1, paramInt, new bdfx(this, paramBoolean1, paramInt, paramBoolean3, paramBoolean2));
    ...
    for (;;)
    {
      ...
      localByteBuffer.putInt(bhjx.a(l2)).put((byte)0).putShort((short)3).putShort((short)-23251).putShort((short)2).putShort(s1).putShort((short)-23238).putShort((short)2).putShort((short)0).putShort((short)-23174).putShort((short)2).putShort(s2);
    ...
    if (!paramBoolean1)
    {
      ...
      if (paramBoolean5) {
        if (localBaseActivity != null)
        {
          ...
          bhzu.a(localBaseActivity, arob.a(), 1);
        }
      }
      label76:
      label82:
      do
      {
        ...
        paramInt = 0;
        break label60;
        ((bdup)this.app.getManager(361)).a(this.b.get(), 1);
        ...
        if ((localBaseActivity != null) && ((localBaseActivity instanceof GeneralSettingActivity))) {
          ((GeneralSettingActivity)localBaseActivity).a(1, bdgb.c(), false, true);
        }
      } while (localBaseActivity == null);
      QQToast.a(localBaseActivity, 1, "付费失败", 0).a();
      return;
    }
    bduy.a(paramBoolean3, this.app);
    bdgb.a(this.app.getCurrentAccountUin(), paramBoolean2, 3);
    bdgb.a(this.app.getCurrentAccountUin(), paramInt, 3);
    a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger, -2147483648, this.b, -2147483648, this.c, -2147483648);
    notifyUI(3, paramBoolean1, new Object[] { Boolean.valueOf(true), Boolean.valueOf(paramBoolean4), Integer.valueOf(5) });
    if (localBaseActivity != null) {
      QQToast.a(localBaseActivity, 2, "装扮成功", 0).a();
    }
    bmzn.a().a(bdgb.a(paramInt), "4", "platform898", "4", "1", 113, 1, System.currentTimeMillis());
    bdll.b(this.app, "dc00898", "", "", "qq_vip", "0X800B15D", Integer.decode(bdgb.a(paramInt)).intValue(), 0, "", "", "", "");
  }
  ...
  public boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool2 = a(paramBoolean, bdgb.a(paramInt));
    if (bool2) {}
    for (boolean bool1 = a(false, "212", paramBoolean, true, bdgb.a(paramInt));; bool1 = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    Object localObject = bdgb.a(paramInt);
    ...
    {
      return bool;
      long l = ((bdfv)this.app.a(154)).a(paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
  ...
  protected boolean a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    ...
    String str = ThemeUtil.getUserCurrentThemeId(this.app);
    Object localObject1 = beis.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramBoolean1) {}
        for (paramString2 = new bdfz(this);; paramString2 = new bdfy(this)) {
  ...
  public void b()
  {
    ...
    for (;;)
    {
      a(bool, this.b.get(), new bdfw(this));
      return;
      bool = false;
    }
  }
