  ...
  implements nmj
{
  ...
  private CopyOnWriteArrayList<WeakReference<nny>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  private lpz jdField_a_of_type_Lpz;
  private nbs jdField_a_of_type_Nbs = new nbs();
  protected nmi a;
  private nnx jdField_a_of_type_Nnx;
  private nnz jdField_a_of_type_Nnz;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = 1;; paramInt1 = 0)
    {
      ...
      if (this.jdField_a_of_type_Lpz == null)
      {
        ...
        this.jdField_a_of_type_Lpz.a(this.jdField_a_of_type_JavaLangInteger.intValue(), this.jdField_b_of_type_JavaLangInteger.intValue());
      }
      return;
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender.drawTexture(36197, this.jdField_a_of_type_Nmi.a(), this.jdField_a_of_type_ArrayOfFloat, this.jdField_b_of_type_ArrayOfFloat);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nny)localWeakReference.get()).a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangInteger.intValue(), this.jdField_b_of_type_JavaLangInteger.intValue(), paramLong);
      }
    }
    if (this.jdField_b_of_type_Boolean) {
      this.jdField_a_of_type_Nbs.a(this.jdField_a_of_type_JavaLangInteger.intValue(), this.jdField_b_of_type_JavaLangInteger.intValue(), 15);
    }
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread == null)
    {
      ...
      this.jdField_a_of_type_Nnx = new nnx(this, this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread.getLooper());
      this.jdField_a_of_type_Nnx.sendEmptyMessage(152);
    }
  }
  ...
  private void j()
  {
    ...
    Matrix.setIdentityM(this.jdField_b_of_type_ArrayOfFloat, 0);
    this.jdField_a_of_type_Nmi.a(this, this.jdField_a_of_type_Nnx);
  }
  ...
  public long a()
  {
    if (this.jdField_a_of_type_Nmi != null) {
      return this.jdField_a_of_type_Nmi.a();
    }
    return 0L;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Nmi != null) {
      this.jdField_a_of_type_Nmi.a();
    }
    if (this.jdField_a_of_type_Nnx != null) {
      this.jdField_a_of_type_Nnx.sendEmptyMessage(258);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Nmi == null) || (this.jdField_a_of_type_Nmi.a() == null) || (this.jdField_a_of_type_Nmi.a() == -1)) {}
    do
    {
      return;
      this.jdField_a_of_type_Nmi.a().updateTexImage();
      this.jdField_a_of_type_Nmi.a().getTransformMatrix(this.jdField_a_of_type_ArrayOfFloat);
    } while (!this.c);
  ...
  public void a(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nny)localWeakReference.get()).a(paramString);
      }
    }
  }
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    this.jdField_a_of_type_Nnz.a(this.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_Nmi != null) {
      this.jdField_a_of_type_Nmi.a(this.jdField_a_of_type_JavaLangString, paramLong);
    }
    if (Build.VERSION.SDK_INT >= 16) {
      lfm.a().a(3);
    }
  ...
  public void a(List<nnv> paramList)
  {
    QLog.d("AVGameMediaPlayerCtrl", 1, "setPreLoadVideoResourceInfos infoList:=" + Arrays.toString(paramList.toArray()));
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      nnv localnnv = (nnv)paramList.next();
      this.jdField_a_of_type_Nnz.a(localnnv.jdField_a_of_type_JavaLangString, localnnv.jdField_a_of_type_Long, 3000L);
    }
  }
  
  public void a(nny paramnny)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (paramnny == localWeakReference.get())) {
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramnny));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Nmi != null) {
      this.jdField_a_of_type_Nmi.a(true);
    }
  }
  ...
  public boolean a()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        bool1 = bool2;
        if (this.jdField_a_of_type_Nmi.a()) {
          bool1 = true;
        }
      }
    }
    do
    {
      return bool1;
      bool1 = bool2;
    } while (this.jdField_a_of_type_Nmi == null);
    return this.jdField_a_of_type_Nmi.a();
  }
  ...
  public void b(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nny)localWeakReference.get()).b(paramString);
      }
    }
  }
  ...
  public void b(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Nnz.a(this.jdField_a_of_type_JavaLangString);
      if (this.jdField_a_of_type_Nmi != null) {
        this.jdField_a_of_type_Nmi.b(this.jdField_a_of_type_JavaLangString, paramLong);
      }
    }
  }
  
  public void b(nny paramnny)
  {
  ...
  {
    bdla.b(null, "dc00898", "", "", "0X800B1F3", "0X800B1F3", 0, 0, "", "", "", "");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nny)localWeakReference.get()).c(paramString);
      }
    }
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Nnz = new nnz();
    this.jdField_a_of_type_Nmi = new nmi();
    i();
  }
  ...
  public void d(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      if ((localWeakReference != null) && (localWeakReference.get() != null)) {
        ((nny)localWeakReference.get()).d(paramString);
      }
    }
  }
  ...
  public void g()
  {
    ...
    {
      if (this.jdField_a_of_type_Nnx != null) {
        this.jdField_a_of_type_Nnx.sendEmptyMessage(153);
      }
  ...
  public void h()
  {
    ...
    bjuc.d("AVGameMediaPlayerCtrl", "init scaleFacors:=" + this.jdField_a_of_type_JavaLangFloat);
  }
}
