...
public class alwl
  implements alxp
{
  public alwl(ConditionSearchFriendActivity paramConditionSearchFriendActivity) {}
  
  public void a()
  {
    if ((this.a.i == 0) && (this.a.f > this.a.g) && (this.a.g != 0)) {
      bbmy.a(this.a, this.a.getResources().getString(2131625442), 0).b(this.a.getTitleBarHeight());
    }
    while ((this.a.jdField_a_of_type_Begr == null) || (!this.a.jdField_a_of_type_Begr.isShowing())) {
      return;
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.i == 0)
    {
      ...
      default: 
        ...
        localObject = this.a.jdField_a_of_type_Ajfw.a(this.a.jdField_b_of_type_Int, this.a.jdField_c_of_type_Int);
    ...
    do
    {
      ...
      if (this.a.i == 3)
      {
        ...
        this.a.d = paramInt1;
        this.a.e.setRightText(ajfw.c[paramInt1]);
        return;
      }
      switch (paramInt1)
      {
      ...
      while (this.a.i == 1)
      {
        this.a.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(this.a.jdField_a_of_type_Ajfw.c(ConditionSearchFriendActivity.a(this.a)));
        return;
    ...
    this.a.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(this.a.jdField_a_of_type_Ajfw.c(ConditionSearchFriendActivity.a(this.a)));
  }
}
