...
class avvo
  extends Handler
{
  private final WeakReference<avvm> a;
  
  avvo(avvm paramavvm, Looper paramLooper)
  {
    super(paramLooper);
    this.a = new WeakReference(paramavvm);
  }
  
  public void handleMessage(Message paramMessage)
  {
    avvm localavvm = (avvm)this.a.get();
    if (localavvm == null) {
    ...
    do
    {
      ...
      avvm.a(localavvm, paramMessage);
      return;
      paramMessage = paramMessage.getData();
      String str = paramMessage.getString("key_id");
      i = paramMessage.getInt("key_play_state", -1);
      if (QLog.isColorLevel()) {
        QLog.i("QQMusicPlay.QQMusicPlayClient", 2, String.format("--->handleMessage[MSG_FROM_SERVICE_PLAY_STATE_CHANGE] %s %s", new Object[] { str, avvg.a(i) }));
      }
      avvm.a(localavvm, str, i);
    } while ((i != 4) || (!avvm.a(localavvm)));
    avvm.a(localavvm);
    return;
    ...
    avvm.a(localavvm, paramMessage, i, j);
  }
}
