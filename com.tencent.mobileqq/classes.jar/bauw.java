...
public class bauw
{
  ...
  public bauw(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(MessageRecord paramMessageRecord)
  {
    if (paramMessageRecord != null)
    {
      ...
      if ((paramMessageRecord instanceof bdsx)) {
        return (int)((bdsx)paramMessageRecord).c();
      }
    }
    return -1;
  }
  ...
  {
    bcfy localbcfy = new bcfy(this.a, this.a.getApplication(), paramMessageForShortVideo, null);
    bcfx.a().a(paramMessageForShortVideo.uniseq, localbcfy);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        ((anuk)this.a.a(13)).a(paramMessageRecord);
  ...
  public void a(MessageRecord paramMessageRecord, anqd paramanqd, bava parambava)
  {
    ...
    if (parambava != null) {
      parambava.a(paramMessageRecord);
    }
    this.a.a().b(paramMessageRecord, paramanqd);
  }
  ...
  public int b(MessageRecord paramMessageRecord)
  {
    ...
    for (int i = ((bdsx)paramMessageRecord).e();; i = -1)
    {
      if (QLog.isColorLevel()) {
