  ...
  extends bara
{
  private byte[] a;
  private byte[] b;
  private int jdField_c_of_type_Int = this.jdField_a_of_type_Bayk.jdField_a_of_type_Int;
  private byte[] jdField_c_of_type_ArrayOfByte;
  private String e;
  private int p;
  
  public bauw(bayf parambayf, bayk parambayk)
  {
    super(parambayf, parambayk);
    this.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_Bayk.l.getBytes();
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   36: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   39: iconst_0
    //   40: ireturn
    ...
    //   105: ldc 55
    //   107: ldc 92
    //   109: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: iconst_0
    //   113: ireturn
    //   114: astore_1
    //   115: aload_1
    ...
    //   162: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   165: aload 6
    //   167: ifnull +8 -> 175
    //   170: aload 6
    ...
    //   194: ldc 55
    //   196: ldc 98
    //   198: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   201: aload 6
    //   203: astore 5
    //   205: aload_1
    ...
    //   358: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   361: iconst_0
    //   362: ireturn
    ...
    //   443: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   446: iconst_0
    //   447: ireturn
    //   448: iload 4
    //   450: ifle +450 -> 900
    ...
    //   533: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   536: iconst_0
    //   537: ireturn
    //   538: iload_3
    //   539: newarray byte
    ...
    //   556: aload_1
    //   557: aload_0
    //   558: getfield 171	bauw:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   578: ldc 55
    //   580: ldc 177
    //   582: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   585: iconst_0
    //   586: ireturn
    ...
    //   624: ldc 55
    //   626: ldc 194
    //   628: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   631: iconst_0
    //   632: ireturn
    //   633: aload 5
    ...
    //   645: ldc 55
    //   647: ldc 202
    //   649: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   652: iconst_0
    //   653: ireturn
    //   654: aload 5
    ...
    //   666: ldc 55
    //   668: ldc 204
    //   670: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   673: iconst_0
    //   674: ireturn
    //   675: aload 5
    ...
    //   687: ldc 55
    //   689: ldc 213
    //   691: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   694: iconst_0
    //   695: ireturn
    //   696: aload_0
    //   697: aload 5
    ...
    //   708: putfield 223	bauw:jdField_c_of_type_ArrayOfByte	[B
    //   711: aload_0
    //   712: getfield 223	bauw:jdField_c_of_type_ArrayOfByte	[B
    //   715: ifnull +11 -> 726
    //   718: aload_0
    //   719: getfield 223	bauw:jdField_c_of_type_ArrayOfByte	[B
    //   722: arraylength
    //   723: ifgt +13 -> 736
    //   726: aload_0
    //   727: ldc 55
    //   729: ldc 225
    //   731: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   734: iconst_0
    //   735: ireturn
    //   736: aload_0
    //   737: ldc 55
    ...
    //   761: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   764: aload_0
    //   765: ldc 55
    ...
    //   787: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   790: aload_0
    //   791: ldc 55
    ...
    //   805: aload_0
    //   806: getfield 223	bauw:jdField_c_of_type_ArrayOfByte	[B
    ...
    //   818: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   821: aload_0
    //   822: ldc 55
    ...
    //   836: aload_0
    //   837: getfield 223	bauw:jdField_c_of_type_ArrayOfByte	[B
    //   840: arraylength
    ...
    //   847: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   850: iconst_1
    //   851: ireturn
    //   852: astore_1
    //   853: aload_1
    ...
    //   882: invokevirtual 73	bauw:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   885: iconst_0
    //   886: ireturn
    //   887: astore_1
    //   888: goto -655 -> 233
  ...
  private void f()
  {
    ...
    bbbd localbbbd = new bbbd();
    localbbbd.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bayk.jdField_b_of_type_JavaLangString;
    localbbbd.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Bayk.jdField_c_of_type_JavaLangString;
    localbbbd.e = this.jdField_a_of_type_Bayk.jdField_d_of_type_JavaLangString;
    localbbbd.jdField_f_of_type_Int = this.jdField_a_of_type_Bayk.jdField_a_of_type_Int;
    localbbbd.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
    localbbbd.jdField_a_of_type_Int = this.jdField_a_of_type_Bayk.h;
    bbax localbbax = new bbax();
    localbbax.jdField_a_of_type_Bbce = this;
    localbbax.jdField_a_of_type_JavaLangString = "multi_msg_dw";
    localbbax.jdField_a_of_type_JavaUtilList.add(localbbbd);
  ...
  private void g()
  {
    ...
    if (this.p == 2)
    {
      ...
      {
        localbaub.jdField_b_of_type_JavaLangString = "sslv6.htdata.qq.com";
        localObject = new bawy();
        ((bawy)localObject).jdField_a_of_type_JavaLangString = localbaub.jdField_b_of_type_JavaLangString;
        ((bawy)localObject).jdField_a_of_type_Int = 443;
    ...
    label431:
    for (str = str + "[" + localbawy.jdField_a_of_type_JavaLangString + "]";; str = str + localbawy.jdField_a_of_type_JavaLangString)
    {
      localObject = str;
      ...
      localbaub.jdField_c_of_type_JavaLangString = this.e;
      ...
      return;
      localbaub.jdField_b_of_type_JavaLangString = "ssl.htdata.qq.com";
      break;
    }
    label457:
  ...
  public void a(bbax parambbax, bbbm parambbbm)
  {
    ...
    for (;;)
    {
      ...
      {
        parambbax = (bbbv)parambbbm.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_b_of_type_ArrayOfByte = parambbax.jdField_b_of_type_ArrayOfByte;
        this.p = parambbax.jdField_a_of_type_Int;
        g();
        i += 1;
      }
    }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      b(true, l);
      azri.a(BaseApplication.getContext()).a(null, b(), true, l, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      b(false, l);
      azri.a(BaseApplication.getContext()).a(null, b(), false, l, 0L, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  void d()
  {
    ...
    if (this.jdField_a_of_type_Bayk.jdField_a_of_type_Awiq != null)
    {
      ...
      localawir.jdField_b_of_type_Int = -1;
      localawir.jdField_a_of_type_Awjh = new awjh();
      localawir.jdField_a_of_type_Awjh.jdField_b_of_type_JavaLangString = "[MultiMsgDownloadProcessor] download failed";
      localawir.jdField_a_of_type_ArrayOfByte = null;
  ...
  void e()
  {
    ...
    if (this.jdField_a_of_type_Bayk.jdField_a_of_type_Awiq != null)
    {
      localObject1 = new awir();
      ((awir)localObject1).jdField_b_of_type_Int = 0;
      ((awir)localObject1).jdField_a_of_type_ArrayOfByte = this.jdField_c_of_type_ArrayOfByte;
      ((awir)localObject1).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bayk.f;
      ((awir)localObject1).jdField_c_of_type_Int = this.jdField_a_of_type_Bayk.jdField_b_of_type_Int;
      ((awir)localObject1).jdField_d_of_type_Int = this.jdField_a_of_type_Bayk.jdField_g_of_type_Int;
      ((awir)localObject1).jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Bayk.jdField_a_of_type_JavaLangString;
      ((awir)localObject1).jdField_a_of_type_Long = this.jdField_a_of_type_Bayk.jdField_a_of_type_Long;
      ((awir)localObject1).e = this.jdField_a_of_type_Bayk.l;
      this.jdField_a_of_type_Bayk.jdField_a_of_type_Awiq.a((awir)localObject1);
    }
    for (;;)
    {
      this.jdField_c_of_type_ArrayOfByte = null;
      ...
      {
        aupg.a().a((HashMap)localObject1, this.jdField_a_of_type_Bayk.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel()) {
  ...
  protected void n()
  {
    ...
    {
      if (!abti.d(this.jdField_c_of_type_Int)) {
        break label56;
      }
      str = "multimsgCd";
    }
  ...
  {
    boolean bool2 = true;
    Object localObject = this.jdField_b_of_type_Barh;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.jdField_a_of_type_Bass.a.jdField_d_of_type_JavaLangString = ((String)parambavf.jdField_a_of_type_JavaUtilHashMap.get("param_rspHeader"));
      if ((parambavf.jdField_a_of_type_Int != 0) || (!a(this.e))) {
        break label159;
      }
      e();
      return;
