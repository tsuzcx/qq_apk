  ...
  extends BaseAdapter
{
  ...
  private ArrayList<bfxc> jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhoneCountryActivity.jdField_a_of_type_JavaUtilArrayList;
  
  private ajmp(CountryActivity paramCountryActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      CountryActivity.a(paramView, (bfxc)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
