...
{
  public ahem(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        this.a.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(this.a.getResources(), 2130840365);
        ...
        this.a.g.setOnClickListener(new ahen(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new aheo(this));
    }
  }
      ...
      while (paramString3.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          for (;;)
          {
            ...
            ((TextView)localObject2).setTag(2131367520, paramList2);
