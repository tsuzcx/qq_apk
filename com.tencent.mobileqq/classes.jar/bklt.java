  ...
  implements View.OnClickListener
{
  ...
  public bklt(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ArrayOfInt = new int[] { 2131380233, 2131380234, 2131380235, 2131380236 };
    this.jdField_b_of_type_ArrayOfInt = new int[] { 2131380238, 2131380239, 2131380240, 2131380241, 2131380242, 2131380243, 2131380244, 2131380245 };
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698478));
  ...
  public void a()
  {
    this.d = ((int)bgln.i());
    this.e = ((int)bgln.j());
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidAppActivity.getSystemService("layout_inflater")).inflate(2131560064, null);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380237));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131380229));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380231);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380232));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380230));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380249));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380248));
    ...
    setOnDismissListener(new bklu(this));
    setTouchable(true);
    setFocusable(true);
  ...
  protected void a(IBinder paramIBinder)
  {
    ...
    this.jdField_c_of_type_AndroidViewView.setOnKeyListener(new bklv(this));
  ...
  public void a(View paramView, bklx parambklx)
  {
    this.jdField_a_of_type_Bklx = parambklx;
    a(paramView.getWindowToken());
    parambklx = new int[2];
    paramView.getLocationOnScreen(parambklx);
    int j;
    int i;
    int n;
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("KandianPopupWindow", 2, "x = " + parambklx[0] + ", y = " + parambklx[1]);
      }
      if (QLog.isColorLevel()) {
      ...
      i = parambklx[1];
      i = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298700);
      n = this.jdField_b_of_type_Int - parambklx[0] - paramView.getWidth() / 2 + i;
      if (QLog.isColorLevel()) {
      ...
      if (j - (k + m) > this.jdField_c_of_type_Int) {
        if (n > this.jdField_b_of_type_Int * 0.1D)
        {
          ...
          j = parambklx[1] + paramView.getHeight() / 2 + afur.a(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    for (;;)
    {
      pha.jdField_a_of_type_Boolean = true;
      return;
      ...
      for (;;)
      {
        ...
        j = parambklx[1] + paramView.getHeight() / 2 - afur.a(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - this.jdField_c_of_type_Int;
        showAtLocation(paramView, 0, i, j);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      showAtLocation(paramView, 0, parambklx[0] + paramView.getWidth() / 2 - afur.a(10.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298701), parambklx[1] + paramView.getHeight() / 2 - this.jdField_c_of_type_Int / 2);
    }
  }
  
  public void a(bklw parambklw)
  {
    this.jdField_a_of_type_Bklw = parambklw;
  }
  ...
  public boolean a(int paramInt, ArrayList<DislikeInfo> paramArrayList)
  {
    ...
    while ((paramArrayList == null) || (paramArrayList.size() == 0))
    {
      ...
      this.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298701));
    ...
    this.jdField_b_of_type_Int = ((int)(this.d - this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298700) * 2.0F));
    setWidth(this.jdField_b_of_type_Int);
  ...
  public void b()
  {
    ...
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130842992);
    }
    if (this.jdField_c_of_type_AndroidWidgetImageView != null)
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130843001);
      if (RelativeLayout.LayoutParams.class.isInstance(this.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams()))
      {
        ...
        localLayoutParams.addRule(3, 2131380230);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        if (this.jdField_a_of_type_Bklx != null) {
          this.jdField_a_of_type_Bklx.a(paramView, this.jdField_a_of_type_Int, this.jdField_b_of_type_JavaUtilArrayList, null);
        }
        dismiss();
        continue;
        if (this.jdField_a_of_type_Bklw != null) {
        ...
        label281:
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131698479), new Object[] { Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
        }
