  ...
  implements URLDrawableDownListener
{
  ...
  public aodu(Context paramContext, Handler paramHandler, aodt paramaodt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidOsHandler = paramHandler;
    this.jdField_a_of_type_Aodt = paramaodt;
  }
  ...
  public int a(aodt paramaodt)
  {
    return paramaodt.a(this.jdField_a_of_type_JavaUtilList);
  }
  
  public aodt a(int paramInt)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (aodt)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return this.jdField_a_of_type_Aodt;
  }
  ...
  public void a(List<aodt> paramList)
  {
  ...
  {
    return a(paramInt).a(this.jdField_a_of_type_Aodt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      {
        paramViewGroup = (aodt)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        ...
        label106:
        if ((!(localDrawable instanceof ascb)) || (((ascb)localDrawable).a() == null)) {
          break label211;
        }
        int i = actj.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        paramViewGroup = a(((ascb)localDrawable).a(), i, i);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = this.jdField_a_of_type_Aodt;
        break;
        label200:
