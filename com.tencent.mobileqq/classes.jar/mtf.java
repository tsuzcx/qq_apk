...
public class mtf
{
  ...
  private mth jdField_a_of_type_Mth;
  private boolean jdField_a_of_type_Boolean;
  private final AtomicBoolean b;
  
  /* Error */
  public mtf(Context paramContext, mtg parammtg)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   12: putfield 32	mtf:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   15: aload_0
    //   16: new 29	java/util/concurrent/atomic/AtomicBoolean
    //   19: dup
    //   20: invokespecial 30	java/util/concurrent/atomic/AtomicBoolean:<init>	()V
    //   23: putfield 34	mtf:b	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   26: aload_0
    //   27: new 36	com/tencent/av/utils/PhoneStatusMonitor$3
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 39	com/tencent/av/utils/PhoneStatusMonitor$3:<init>	(Lmtf;)V
    //   35: putfield 41	mtf:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   56: aload_0
    //   57: aload_1
    //   58: putfield 63	mtf:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   61: aload_0
    //   62: aload_2
    //   63: putfield 65	mtf:jdField_a_of_type_Mtg	Lmtg;
    //   66: aload_0
    //   67: new 67	mti
    //   70: dup
    //   71: aload_0
    //   72: invokespecial 68	mti:<init>	(Lmtf;)V
    //   75: putfield 70	mtf:jdField_a_of_type_AndroidTelephonyPhoneStateListener	Landroid/telephony/PhoneStateListener;
    //   78: aload_0
    //   79: new 72	mth
    //   82: dup
    //   83: aload_0
    //   84: invokespecial 73	mth:<init>	(Lmtf;)V
    //   87: putfield 75	mtf:jdField_a_of_type_Mth	Lmth;
    //   90: new 77	com/tencent/av/utils/PhoneStatusMonitor$1
    //   93: dup
    //   94: aload_0
    //   95: aload_1
    //   96: invokespecial 80	com/tencent/av/utils/PhoneStatusMonitor$1:<init>	(Lmtf;Landroid/content/Context;)V
    //   99: bipush 16
    //   101: aconst_null
    //   102: iconst_0
    ...
    //   184: aload_1
    //   185: aload_0
    //   186: getfield 75	mtf:jdField_a_of_type_Mth	Lmth;
    //   189: aload_2
    ...
    //   245: putfield 142	mtf:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   248: return
    //   249: astore_2
  ...
  private void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Mtg != null) {
        this.jdField_a_of_type_Mtg.a(this.jdField_a_of_type_Boolean);
      }
  ...
  public void a()
  {
    ...
    d();
    mtj.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidTelephonyPhoneStateListener, 0);
    QLog.d("PhoneStatusMonitor", 1, "PhoneStatusMonitor.unregisterReceiver()");
    try
    {
      this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Mth);
      this.jdField_a_of_type_Mtg = null;
