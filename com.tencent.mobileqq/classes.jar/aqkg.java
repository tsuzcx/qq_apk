  ...
  extends BaseAdapter
{
  ...
  private aqkg(CommonTroopListActivity paramCommonTroopListActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131364560);
    TextView localTextView = (TextView)paramViewGroup.findViewById(2131364562);
    localImageView.setImageDrawable(bayh.a(CommonTroopListActivity.a(this.jdField_a_of_type_ComTencentMobileqqFriendsIntimateCommonTroopListActivity), 4, paramView.troopCode));
