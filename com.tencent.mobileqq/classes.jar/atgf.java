  ...
  extends alko
{
  ...
  public atgf(QQAppInterface paramQQAppInterface)
  {
              ...
              if (paramFromServiceMsg.has())
              {
                ...
                if (paramFromServiceMsg.res_id.has())
                {
                  ...
                  for (;;)
                  {
                    ...
                    alrb localalrb = new alrb();
                    localalrb.jdField_a_of_type_Long = ((Integer)paramFromServiceMsg.get(i2)).intValue();
                    localalrb.jdField_a_of_type_Int = i1;
                    m += 1;
                    localalrb.b = m;
                    ((List)localObject).add(localalrb);
                    i2 += 1;
                  }
                  localObject = null;
                  break;
