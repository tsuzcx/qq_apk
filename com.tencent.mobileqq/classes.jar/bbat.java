...
public class bbat
  implements Observer
{
  public bbat(SignTextEditFragment paramSignTextEditFragment) {}
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    default: 
      return;
    case 3: 
      paramObservable = bbce.a().a(this.a.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
      if ((paramObservable != null) && (!TextUtils.isEmpty(paramObservable.a)) && (Integer.parseInt(paramObservable.a) > 0) && (paramObservable.f < 2)) {
        if (BaseApplicationImpl.getApplication().getSharedPreferences("mobileQQ", 4).getBoolean(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "new_signature_version_826", true)) {
          bgtl.a(this.a.getActivity(), this.a.getActivity().app, 0, "signature_chouti");
        }
      }
      for (;;)
      {
        bbce.a().deleteObserver(this.a.jdField_a_of_type_JavaUtilObserver);
        return;
