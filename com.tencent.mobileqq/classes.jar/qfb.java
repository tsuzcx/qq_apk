  ...
  extends qhj
{
  ...
  public qfb(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qxn paramqxn, Handler paramHandler)
  {
  ...
  protected ToServiceMsg a(qxt paramqxt)
  {
    ...
    if (paramqxt.jdField_a_of_type_Boolean) {
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_all_channel_list.set(1);
    }
    if (paramqxt.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_important.set(paramqxt.jdField_b_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_id.set(paramqxt.jdField_c_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_cover.set(paramqxt.jdField_d_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_seq.set(paramqxt.jdField_e_of_type_Int);
      localObject = qxp.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      ((ToServiceMsg)localObject).getAttributes().put(c, Integer.valueOf(paramqxt.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put("debug", Boolean.valueOf(paramqxt.l));
      return localObject;
  ...
  public void a(int paramInt1, int paramInt2, List<Integer> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((oidb_cmd0x908.ReqBody)localObject).uint64_uin.set(Long.valueOf(pkh.a()).longValue());
    ...
    for (;;)
    {
      ...
      localObject = qxp.a("OidbSvc.0x908", 2312, 0, ((oidb_cmd0x908.ReqBody)localObject).toByteArray());
  ...
  public void a(boolean paramBoolean, int paramInt, List<Integer> paramList)
  {
    ...
    localReqBody.uint64_uin.set(Long.valueOf(pkh.a()).longValue());
    if (paramBoolean)
    {
      ...
      a(qxp.a("OidbSvc.0x8f5", 2293, 0, localReqBody.toByteArray()));
      if (QLog.isColorLevel()) {
        if (paramList != null) {
          break label151;
        }
  ...
  public void b(List<Integer> paramList)
  {
    ...
    localObject = qxp.a("OidbSvc.0x69e", 1694, 0, ((oidb_cmd0x69e.ReqBody)localObject).toByteArray());
  ...
  {
    Object localObject = new qxt();
    ((qxt)localObject).jdField_a_of_type_Int = 4;
    ((qxt)localObject).jdField_a_of_type_Boolean = true;
    ((qxt)localObject).jdField_b_of_type_Boolean = true;
    ((qxt)localObject).jdField_c_of_type_Boolean = false;
    ((qxt)localObject).jdField_d_of_type_Boolean = true;
    ((qxt)localObject).j = true;
    ((qxt)localObject).k = true;
    ((qxt)localObject).jdField_e_of_type_Boolean = false;
    ((qxt)localObject).f = false;
    ((qxt)localObject).g = false;
    ((qxt)localObject).h = false;
    ((qxt)localObject).jdField_b_of_type_Int = 1;
    ((qxt)localObject).l = paramBoolean;
    localObject = a((qxt)localObject);
  ...
  protected void c(List<rov> paramList)
  {
    if (paramList == null) {
      return;
    }
    ...
    while (paramList.hasNext())
    {
      Iterator localIterator = ((rov)paramList.next()).a.iterator();
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (i == 1)
      {
        ...
        {
          paramObject = qxm.a(localRspBody.rpt_channel_list.get());
  ...
  public List<ChannelInfo> e()
  {
    ...
    Collections.sort((List)localObject1, new qfc(this));
  ...
  {
    if (qxp.a(paramFromServiceMsg, paramObject, new oidb_cmd0x69e.RspBody()) == 0) {}
  ...
  public List<Integer> g()
  {
    ...
    Collections.sort((List)localObject1, new qfd(this));
    localObject2 = new ArrayList(((ArrayList)localObject1).size());
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext()) {
  ...
  {
    int i = qxp.a(paramFromServiceMsg, paramObject, new oidb_cmd0x8f5.RspBody());
    if (QLog.isColorLevel()) {
  ...
  public void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qxp.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject);
    boolean bool1;
    if (k == 0)
    {
