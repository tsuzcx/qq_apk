...
public class ajcb
  implements Runnable
{
  public ajcb(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity, URLDrawable paramURLDrawable, ActionSheet paramActionSheet) {}
  ...
  public void run()
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (TroopAvatarWallPreviewActivity.a(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopAvatarWallPreviewActivity, new File((String)localObject))))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopAvatarWallPreviewActivity.runOnUiThread(new ajcc(this));
      }
      for (;;)
      {
