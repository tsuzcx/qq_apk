...
{
  tyw(tyo paramtyo, String paramString1, int paramInt, boolean paramBoolean, String paramString2) {}
      ...
      if (localObject != null)
      {
        ...
        for (;;)
        {
            ...
            if (j == 2)
            {
              ...
              if (paramBundle.equals(""))
              {
                ...
                try
                {
                  ...
                  this.jdField_a_of_type_Tyo.c((String)localObject);
                  bdll.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D28", "0X8005D28", 0, -1, "1", "", "", "");
                  break label807;
          ...
          catch (InvalidProtocolBufferMicroException paramBundle)
          {
            ...
            return;
            this.jdField_a_of_type_Tyo.a(this.jdField_a_of_type_Int, paramBundle, (String)localObject, true, this.jdField_a_of_type_JavaLangString);
          }
          ...
          if (paramBundle.equals(""))
          {
            ...
            try
            {
              ...
              this.jdField_a_of_type_Tyo.callJs(this.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject).toString() });
              bdll.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D31", "0X8005D31", 0, -1, "1", "", "", "");
            }
          ...
          {
            localObject = ((JSONObject)localObject).optString("mediaid");
            this.jdField_a_of_type_Tyo.a(this.jdField_a_of_type_Int, paramBundle, (String)localObject, false, this.jdField_a_of_type_JavaLangString);
            continue;
            label494:
            if (QLog.isColorLevel()) {
            ...
            try
            {
              ...
              {
                this.jdField_a_of_type_Tyo.c(this.b);
                bdll.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D28", "0X8005D28", 0, -1, "1", "", "", "");
                return;
              }
            }
