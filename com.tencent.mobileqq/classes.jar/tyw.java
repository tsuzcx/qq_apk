...
public final class tyw
  extends tyg
{
  public static final tyx a = new tyx(null);
  
  public tyw(@NotNull BridgeModule paramBridgeModule)
  {
  ...
  private final void a(JSONObject paramJSONObject, String paramString)
  {
    if (paramJSONObject != null)
    {
      ...
      if ((paramString instanceof QQAppInterface))
      {
        ...
        ((avux)paramString).a(paramJSONObject);
      }
    }
  }
  ...
  public void a()
  {
    a("openRoom", (Function2)new NowLiveBridgeInvokeHandler.register.1((tyw)this));
    a("preload", (Function2)new NowLiveBridgeInvokeHandler.register.2((tyw)this));
  }
}
