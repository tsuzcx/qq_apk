  ...
  implements Manager
{
  ...
  public baet(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bafb = new bafb(paramQQAppInterface);
  }
  ...
  private void a(ChatMessage paramChatMessage, String paramString1, String paramString2, String paramString3, aouh paramaouh)
  {
    if ((!this.jdField_a_of_type_Bafb.a()) && (QLog.isColorLevel()))
    {
    ...
    this.jdField_a_of_type_Bafb.a(paramChatMessage);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new AIOMessageSpreadManager.2(this, paramChatMessage, paramString1, paramaouh, paramString2, paramString3), 1000L);
  }
  ...
  {
    boolean bool2 = false;
    int i = this.jdField_a_of_type_Bafb.a();
    int j = aoui.a().a();
    boolean bool1;
    if (j == 0)
    {
  ...
  {
    this.jdField_a_of_type_Bafb.a(paramaouf);
  }
    ...
    do
    {
      ...
      catch (Exception localException1)
      {
        ...
        if (((String)localObject3).equalsIgnoreCase("keyword")) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009078", "0X8009078", 0, 0, "", "", "", "");
        }
        while ((localException1 instanceof MessageForFile))
        {
          ...
          if (paramChatMessage == null)
          {
            ...
            if (((String)localObject3).equalsIgnoreCase("precent")) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800907B", "0X800907B", 0, 0, "", "", "", "");
            } else if (((String)localObject3).equalsIgnoreCase("text_keyword")) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009072", "0X800907B", 0, 0, "", "", "", "");
            }
          }
          else
          {
            bacb.a(paramChatMessage, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2);
            return;
          }
        }
      }
      if ((localException1 instanceof MessageForTroopFile))
      {
        ...
        localObject2 = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        localObject3 = new TeamWorkFileImportInfo();
        ((TeamWorkFileImportInfo)localObject3).c = ((bbpe)localObject2).jdField_a_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_JavaLangString = ((bbpe)localObject2).g;
        ((TeamWorkFileImportInfo)localObject3).j = arni.a(((bbpe)localObject2).g);
        ...
        ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_JavaLangString = ((bbpe)localObject2).jdField_e_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_Int = ((bbpe)localObject2).h;
        ...
        bacb.a((TeamWorkFileImportInfo)localObject3, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_Int);
        return;
      }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.e("AIOMessageSpreadManager", 1, arni.a());
      return;
    }
    if (QLog.isColorLevel()) {
