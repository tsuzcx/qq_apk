  ...
  extends lwm
{
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    {
      lba.g("QQServiceForAV", "linkToVideoProcessDeath");
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder = paramIBinder;
    }
    try
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder.linkToDeath(new lxj(this), 0);
      return;
    }
    catch (RemoteException paramIBinder)
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder = null;
      lba.h("QQServiceForAV", "linkToVideoProcessDeath exception msg = " + paramIBinder.getMessage());
    }
  }
  
  public int a()
  {
    return ((avsy)((QQAppInterface)this.a.a()).getManager(11)).d();
  }
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    {
      int i = bfxg.a(localQQAppInterface, bool, paramString);
  ...
  {
    paramString = ((amrb)((QQAppInterface)this.a.a()).getManager(53)).a(paramString);
    long l = 0L;
    if (paramString != null) {
  ...
  public Bitmap a(int paramInt, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      if (paramString2 == null)
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Amsu);
      }
      if ((paramString2 == null) && (paramBoolean2))
      {
        ...
        if (paramInt == 1)
        {
          ...
          continue;
          paramString2 = (BitmapDrawable)((amqx)localQQAppInterface.getBusinessHandler(6)).a(paramString1, false);
          if (paramString2 == null) {
            break label578;
          }
      ...
      for (;;)
      {
        ...
        break;
        paramString2 = ((aara)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(51)).a(Long.parseLong(paramString1));
        paramString2 = DeviceHeadMgr.getInstance().getDeviceHeadByPID(paramString2.productId);
        break;
        Object localObject = (avsy)localQQAppInterface.getManager(11);
        if ((localObject != null) && (paramString2 != null)) {}
        for (localObject = ((avsy)localObject).c(paramString2);; localObject = null)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          paramString2 = azij.a(localQQAppInterface, paramString2);
          break;
          if (paramInt == 3000) {
            return bfvo.h();
          }
  ...
  public Bundle a(int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    ...
    case 4: 
      for (;;)
      {
        ...
        bool1 = bfxg.a("GetInviteFlag", paramResultReceiver, paramArrayOfByte);
        bfxg.a("GetInviteFlag", paramResultReceiver, paramArrayOfByte);
        paramBundle.putBoolean("enableInvite", bool1);
        return paramBundle;
        bfxn.a((QQAppInterface)this.a.a(), paramBundle);
      }
    case 5: 
      return bfxn.a((QQAppInterface)this.a.a(), paramBundle);
    case 6: 
      return bfxg.a((QQAppInterface)this.a.a(), paramBundle.getString("uin"));
    }
    paramArrayOfByte = paramBundle.getString("red_touch_app_id");
    paramBundle.putParcelable("red_touch_red_app_info", azvm.a(((azvi)((QQAppInterface)this.a.a()).getManager(36)).a(paramArrayOfByte)));
    return paramBundle;
  }
  ...
  public String a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (paramInt == 26)
        {
          paramString1 = azij.a(localQQAppInterface, paramString2);
        }
        else if (paramInt == 25)
        {
        ...
        else
        {
          ...
          paramString1 = ((aara)localQQAppInterface.getBusinessHandler(51)).a(Long.parseLong(str1));
          if (paramString1 == null) {
            break label461;
          }
          paramString1 = abdn.a(paramString1);
        }
      }
      ...
      for (paramString1 = ContactUtils.getNickName(localQQAppInterface, str1, paramInt);; paramString1 = ContactUtils.getDisplayName(localQQAppInterface, str1, paramString2, i, 0))
      {
        ...
        localObject = (amsw)localQQAppInterface.getManager(51);
        str2 = paramString1;
        if (localObject != null)
        {
  ...
  String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    for (str = paramString2;; str = paramString1)
    {
      ...
      label236:
      label248:
      for (localObject1 = ((avsy)localObject1).c(str);; localObject1 = null)
      {
        if (localObject1 != null)
        {
        ...
        for (;;)
        {
          ...
          {
            paramString1 = (amsw)paramQQAppInterface.getManager(51);
            if (paramString1 == null) {
              break label248;
            }
          }
          for (paramString1 = paramString1.e((String)localObject2);; paramString1 = null)
          {
            ...
            for (paramString1 = ContactUtils.getFriendName(paramString1);; paramString1 = null)
            {
              if ((paramString1 == null) || (paramString1.equals(localObject2)))
              {
                ...
                paramQQAppInterface.addObserver(this.a.jdField_a_of_type_Amsu);
  ...
  public String a(String paramString)
  {
    ...
    avsy localavsy = (avsy)((QQAppInterface)this.a.a()).getManager(11);
    if (localavsy == null)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = (aqxc)QQServiceForAV.d(this.a).getManager(77);
    if (localObject != null)
    {
      localObject = (aqyc)((aqxc)localObject).a("qq.android.qav.video");
      if (localObject != null) {
        ((aqyc)localObject).a(false);
      }
    }
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Andd);
        localanca.a(paramInt1, paramLong);
        return;
      }
      catch (Exception localException)
      {
        do
        {
          localQQAppInterface.removeObserver(this.a.jdField_a_of_type_Andd);
        } while (!QLog.isColorLevel());
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.a.jdField_b_of_type_Long = bbko.a();
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    if (localanca != null) {
      try
      {
        localanca.a(paramLong, Long.parseLong(paramString), paramInt);
        return;
      }
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    awkr localawkr = (awkr)localQQAppInterface.getBusinessHandler(60);
    localQQAppInterface.addObserver(this.a.jdField_a_of_type_Awkv);
    localawkr.a(paramString);
  }
  
  public void a(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte)
  {
    nmb.a((QQAppInterface)this.a.a(), new lxi(this, paramString, paramInt2), paramArrayOfByte, paramString, paramInt1, paramInt2);
  }
  
  public void a(String paramString, long paramLong)
  {
    Object localObject = (beyh)((QQAppInterface)this.a.a()).getManager(223);
    if (localObject != null) {
      ((beyh)localObject).a(paramString);
    }
    if ((paramLong > 0L) && ((QQServiceForAV.h(this.a) instanceof QQAppInterface)))
    {
      ...
      acvv.a((QQAppInterface)localObject, localSessionInfo);
    }
  }
  ...
  {
    ((ltv)QQServiceForAV.b(this.a).getManager(254)).b(paramlvz);
  }
  
  public void a(lwi paramlwi)
  {
    if (paramlwi != null) {
      this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.unregister(paramlwi);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(lwi paramlwi, String paramString)
  {
    if (paramlwi != null)
    {
      this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.register(paramlwi, paramString);
      if (QLog.isColorLevel()) {
        QLog.d("QQServiceForAV", 2, "registerCallback");
      }
      a(paramlwi.asBinder());
      paramlwi = (QQAppInterface)this.a.a();
      paramlwi.mQQServiceRef = null;
      paramlwi.mQQServiceRef = new WeakReference(this.a);
    }
  }
  ...
  public void a(lwo paramlwo)
  {
    ...
    localObject = (ampm)QQServiceForAV.a(this.a).getManager(59);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQServiceForAV", 2, "getAddressConfig for IQQServiceLocationCallback");
      }
      if (((ampm)localObject).a() == 1)
      {
        if (((ampm)localObject).a(((ampm)localObject).a(), true) == 0)
        {
          if (QQServiceForAV.a(this.a) == null) {
            QQServiceForAV.a(this.a, new lxe(this, (ampm)localObject, paramlwo));
          }
          for (;;)
          {
            ((ampm)localObject).c(QQServiceForAV.a(this.a));
            return;
            QQServiceForAV.a(this.a).a(paramlwo);
          }
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, lwo paramlwo)
  {
    int i;
    if (paramBoolean) {
      i = 0;
    ...
    try
    {
      for (;;)
      {
        paramlwo.a(i, "admin_region_config");
        return;
        i = -26;
      }
    }
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("QQServiceForAV", 2, "Call onGetAddressConfig fail", paramlwo);
    }
  }
  ...
  public void a(long[] paramArrayOfLong, String paramString)
  {
    ...
    if (localanca != null) {
      try
      {
        localanca.a(paramArrayOfLong, Long.parseLong(paramString));
        return;
      }
  ...
  public boolean a(long paramLong)
  {
    ...
    if (localanca != null) {
      try
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Andd);
        localanca.a(paramLong, 0L, 2, 0, 0);
        return true;
      }
      catch (Exception localException)
      {
  ...
  {
    return ((amsw)((QQAppInterface)this.a.a()).getManager(51)).b(paramString);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localanca != null) {
      try
      {
        localanca.f(paramString, paramBoolean);
        return true;
      }
  ...
  String b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((localavsy != null) && (paramString2 != null)) {}
    for (paramString2 = localavsy.c(paramString2);; paramString2 = null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramString2 = ((azis)paramQQAppInterface.getManager(140)).a(paramString1);
      paramQQAppInterface = (azip)paramQQAppInterface.getBusinessHandler(79);
      paramQQAppInterface.a(paramString1);
      paramQQAppInterface.a(this.a.jdField_a_of_type_Aziq);
  ...
  {
    ((ltv)QQServiceForAV.c(this.a).getManager(254)).a(paramlvz);
  }
  ...
  public void b(lwo paramlwo)
  {
    ...
    do
    {
      do
      {
        ...
        if (QQServiceForAV.a(this.a) == null) {
          QQServiceForAV.a(this.a, new lxf());
        }
        QQServiceForAV.a(this.a).a(paramlwo);
        if (QQServiceForAV.a(this.a).a() == 1)
        {
          localQQAppInterface.addObserver(QQServiceForAV.a(this.a));
          ((amuu)localQQAppInterface.getBusinessHandler(3)).b();
          return;
        }
      } while (!QLog.isColorLevel());
      ...
      try
      {
        paramlwo.a(false, null);
        return;
      }
      catch (RemoteException paramlwo) {}
    } while (!QLog.isColorLevel());
    QLog.e("QQServiceForAV", 2, "Call getUserCurrentLocation fail", paramlwo);
  }
  
  public void b(boolean paramBoolean)
  {
    SharedPreferences localSharedPreferences = bfyz.a(((QQAppInterface)this.a.a()).getApplication().getApplicationContext());
  ...
  public long[] b(String paramString)
  {
    beyh localbeyh = (beyh)((QQAppInterface)this.a.a()).getManager(223);
    if (localbeyh != null) {
      return localbeyh.a(paramString);
    }
    return null;
  }
  ...
  public String c(String paramString)
  {
    ...
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    paramString = ((avsy)QQServiceForAV.e(this.a).getManager(11)).b(paramString);
    if (paramString == null) {
      return null;
    }
  ...
  public boolean c(String paramString)
  {
    ...
    try
    {
      ...
      bfbz localbfbz = (bfbz)((QQAppInterface)QQServiceForAV.l(this.a)).getManager(48);
      boolean bool1 = localbfbz.a(paramString, localQQAppInterface.getCurrentAccountUin());
      boolean bool2 = localbfbz.a(paramString);
      boolean bool3 = localbfbz.b(paramString);
      paramString = localbfbz.a(paramString);
  ...
  public String d(String paramString)
  {
    ...
    localObject2 = ((amsw)QQServiceForAV.f(this.a).getManager(51)).b(paramString);
    if (localObject2 != null)
    {
  ...
  {
    ((azvi)((QQAppInterface)this.a.a()).getManager(36)).b(paramString);
  }
  ...
  public boolean d()
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    if (QQServiceForAV.a(this.a) == null) {
      QQServiceForAV.a(this.a, new lws(localQQAppInterface));
    }
    boolean bool = bbxj.a(localQQAppInterface, localQQAppInterface.getApplication().getApplicationContext(), QQServiceForAV.a(this.a));
    if (QLog.isColorLevel()) {
  ...
  {
    azvi localazvi = (azvi)((QQAppInterface)this.a.a()).getManager(36);
    localazvi.b(localazvi.a(paramString), "");
  }
  
  public boolean e()
  {
    if (QQServiceForAV.a(this.a) == null) {
      QQServiceForAV.a(this.a, new lxg(this.a));
    }
    blvn.a().a(AEResInfo.AE_RES_ADDITIONAL_PACKAGE, QQServiceForAV.a(this.a), false);
    if (QLog.isDevelopLevel()) {
  ...
  public boolean i()
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    mxn localmxn = null;
    if (localQQAppInterface.isCreateManager(373)) {
      localmxn = (mxn)localQQAppInterface.getManager(373);
    }
    if (localmxn != null) {}
    for (boolean bool = localmxn.a();; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("QQServiceForAV", 2, "isInAVGameRoom, isAvGameRoomExist[" + bool + "], avGameManager[" + localmxn + "]");
      }
      return bool;
    }
  }
