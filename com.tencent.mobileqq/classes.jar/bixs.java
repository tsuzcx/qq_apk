...
final class bixs
  extends biyd
{
  bixs(Context paramContext, String paramString, QQAppInterface paramQQAppInterface, aohb paramaohb) {}
  
  public void a(int paramInt)
  {
    if ((1 == paramInt) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aohb);
    }
  }
  ...
  public void a(SCGet3rdCloudCheck paramSCGet3rdCloudCheck)
  {
    ...
    if (paramSCGet3rdCloudCheck != null)
    {
      if (paramSCGet3rdCloudCheck.delayHour > 24) {
        biyh.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, paramSCGet3rdCloudCheck.delayHour);
      }
      if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        bixr.b(this.jdField_a_of_type_AndroidContentContext, 398677);
      }
    }
  }
}
