  ...
  extends PopupWindow
{
  ...
  public bcof(Context paramContext)
  {
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      localValueAnimator.addUpdateListener(new bcoi(this));
      localValueAnimator.addListener(new bcoj(this));
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setOnKeyListener(new bcog(this));
    ...
    paramIBinder.addUpdateListener(new bcoh(this));
    paramIBinder.start();
  }
