  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  public awnf(QQAppInterface paramQQAppInterface, Context paramContext, HorizontalListView paramHorizontalListView, HeadSetView paramHeadSetView)
  {
  ...
  public void a(awlt paramawlt)
  {
    this.jdField_a_of_type_Awlt = paramawlt;
    this.jdField_a_of_type_Awlt.a(this);
  }
  ...
  public int getCount()
  {
    if (this.jdField_a_of_type_Awlt == null) {
      return 0;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559349, null);
      paramView = new awnh(localView);
    ...
    for (;;)
    {
      localView.setOnClickListener(new awng(this, str));
      Bitmap localBitmap = this.jdField_a_of_type_Awlt.a(paramView.jdField_a_of_type_JavaLangString);
      Object localObject = localBitmap;
      if (localBitmap == null) {
        localObject = bheg.a();
      }
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap((Bitmap)localObject);
      awmp.a(localView, ContactUtils.getNick(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 0) + "正在共享位置");
      EventCollector.getInstance().onListGetView(paramInt, localView, paramViewGroup, getItemId(paramInt));
      return localView;
      localObject = (awnh)paramView.getTag();
      ((awnh)localObject).jdField_a_of_type_JavaLangString = str;
      localView = paramView;
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(localObject instanceof awnh)) {
          break label87;
        }
        localObject = (awnh)localObject;
        if ((paramString == null) || (!paramString.equals(((awnh)localObject).jdField_a_of_type_JavaLangString))) {
          break label87;
        }
        if (paramBitmap != null)
        {
          paramString = this.jdField_a_of_type_Awlt.a(paramString);
          if (paramString != null) {
            ((awnh)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramString);
          }
        }
      }
      return;
