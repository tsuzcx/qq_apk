...
{
  private awnf(PortalManager paramPortalManager) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    case 1011: 
      ...
      localObject = awni.b(paramIntent);
      localObject = bdgc.l(PortalManager.a(this.a), (String)localObject);
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramContext))
      {
        paramIntent = awni.b(paramContext);
        localObject = PortalManager.a(this.a).a(paramIntent, false);
        if (localObject != null)
        {
          paramIntent = awni.a((Bitmap)localObject);
        ...
        localObject = new awne();
        ((awne)localObject).jdField_a_of_type_JavaLangString = paramContext;
        ((awne)localObject).b = k;
        ((awne)localObject).jdField_a_of_type_Int = m;
        this.a.a.put(paramIntent, localObject);
        if ((PortalManager.a(this.a).a(paramIntent, true) != null) || (!QLog.isColorLevel())) {
          break;
        }
        paramIntent = bdgc.j(PortalManager.a(this.a), String.valueOf(paramIntent));
