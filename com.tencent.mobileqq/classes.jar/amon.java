  ...
  implements acxg, View.OnClickListener
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new amoo(this);
  private View jdField_a_of_type_AndroidViewView;
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  private Runnable jdField_a_of_type_JavaLangRunnable = new CopyPromptHelper.4(this);
  
  public amon(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext).inflate(2131493837, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c, false);
    ...
    paramString.leftMargin = aciy.a(14.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources());
    ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131298518)).addView(localView, paramString);
    return localView;
  }
  
  private boolean a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131298608).getVisibility() == 0;
  }
  ...
  private void b()
  {
    ...
    if ((localObject instanceof amor))
    {
      localObject = ((amor)localObject).a();
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        arrayOfmmo[0] = new mmo(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c, new amop(this, arrayOfmmo));
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(new amoq(this, (String)localObject));
      }
    }
  }
