...
public class fo
{
  ...
  private ArrayList<fr> jdField_a_of_type_JavaUtilArrayList = new ArrayList(16);
  public AtomicBoolean a;
  public boolean a;
  private fs[] jdField_a_of_type_ArrayOfFs;
  public int b;
  public ETFont b;
  private ArrayList<CharacterStyle> b;
  public boolean b;
  public int c;
  private ArrayList<ft> jdField_c_of_type_JavaUtilArrayList = new ArrayList(16);
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ArrayOfFs == null) || (this.jdField_a_of_type_ArrayOfFs.length == 0)) {
      return null;
    }
    ...
    {
      Object localObject = ((fr)localIterator.next()).a();
      if (localObject == null) {
        return null;
      }
      ...
      for (;;)
      {
        ...
        fm localfm = (fm)((Iterator)localObject).next();
        if (localfm == null) {
          return null;
        }
        String str = localfm.a();
        if (str != null)
        {
          localfm.a(j);
          j += str.length();
  ...
  {
    paramCharacterStyle = new fr(paramCharacterStyle, paramInt1, paramInt2, paramInt3, paramBoolean);
  ...
  {
    if (this.jdField_a_of_type_ArrayOfFs != null) {
      this.jdField_a_of_type_ArrayOfFs = null;
    }
    ...
    while (i < m)
    {
      localObject1 = (fr)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      k = ((fr)localObject1).a(paramETEngine, paramInt, j, k);
      j = ((fr)localObject1).a();
      i += 1;
    }
    k += 1;
    this.jdField_a_of_type_ArrayOfFs = new fs[k];
    paramInt = 0;
    while (paramInt < k)
    {
      this.jdField_a_of_type_ArrayOfFs[paramInt] = new fs();
      paramInt += 1;
    }
    paramInt = 0;
    Object localObject2;
    while (paramInt < m)
    {
      localObject1 = ((fr)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).a();
      i = 0;
      while (i < ((ArrayList)localObject1).size())
      {
        localObject2 = (fm)((ArrayList)localObject1).get(i);
        j = ((fm)localObject2).e();
        if ((j >= 0) && (j < k)) {
          this.jdField_a_of_type_ArrayOfFs[j].a((fm)localObject2);
        }
        i += 1;
      }
      paramInt += 1;
    ...
    while (paramInt < k)
    {
      localObject1 = this.jdField_a_of_type_ArrayOfFs[paramInt];
      ((fs)localObject1).a(paramETEngine, 0, i, this.jdField_a_of_type_Int);
      localObject2 = ((fs)localObject1).a().iterator();
      j = 0;
      while (((Iterator)localObject2).hasNext())
      {
        fm localfm = (fm)((Iterator)localObject2).next();
        ft[] arrayOfft = localfm.a(paramETEngine, j, i, ((fs)localObject1).a(), paramInt);
        if ((arrayOfft != null) && (arrayOfft.length > 0)) {
          Collections.addAll(this.jdField_c_of_type_JavaUtilArrayList, arrayOfft);
        }
        j += localfm.c();
      }
      i += ((fs)localObject1).a();
  ...
  {
    paramString = new fr(paramString, paramInt1, paramInt2, paramETFont, paramBoolean);
  ...
  {
    paramString = new fr(paramString, paramInt1, paramInt2, paramETFont, paramBoolean1);
    paramString.a(this.g);
  ...
  private int b()
  {
    ...
    int i = this.jdField_a_of_type_ArrayOfFs.length;
    return this.jdField_a_of_type_ArrayOfFs[(i - 1)].b();
  }
  ...
  private void b()
  {
    ...
    fq[] arrayOffq = new fq[arrayOfCharacterStyle.length];
    if ((arrayOffq == null) || (arrayOffq.length == 0))
    {
      a(this.jdField_a_of_type_JavaLangCharSequence.toString(), 0, this.jdField_a_of_type_JavaLangCharSequence.length(), this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      return;
    }
    ...
    {
      arrayOffq[i] = new fq();
      arrayOffq[i].jdField_a_of_type_Int = ((Spanned)localObject).getSpanStart(arrayOfCharacterStyle[i]);
      arrayOffq[i].jdField_b_of_type_Int = ((Spanned)localObject).getSpanEnd(arrayOfCharacterStyle[i]);
      arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle = arrayOfCharacterStyle[i];
      i += 1;
    }
    Arrays.sort(arrayOffq, new fp());
    i = 0;
    int j = 0;
    label176:
    int m;
    ...
    {
      m = arrayOffq[i].jdField_a_of_type_Int;
      k = arrayOffq[i].jdField_b_of_type_Int;
      if (m - j > 0) {
        a(a(this.jdField_a_of_type_JavaLangCharSequence, j, m).toString(), j, m, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      }
      if (k - m > 0)
      {
        if (!(arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof ClickableSpan)) {
          break label379;
        }
    ...
    for (j = m + 1;; j = m)
    {
      ...
      for (;;)
      {
        ...
        break;
        label379:
        if ((arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof bdoa))
        {
          localObject = (bdoa)arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
          this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
          a((CharacterStyle)localObject, this.jdField_b_of_type_JavaUtilArrayList.indexOf(localObject), m, k, false);
        }
        else if ((arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof RelativeSizeSpan))
        {
          localObject = a(this.jdField_a_of_type_JavaLangCharSequence, m, k);
          RelativeSizeSpan localRelativeSizeSpan = (RelativeSizeSpan)arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
        ...
        else if ((arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof bbaw))
        {
          localObject = (bbaw)arrayOffq[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
          this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
          a((CharacterStyle)localObject, this.jdField_b_of_type_JavaUtilArrayList.indexOf(localObject), m, k, false);
        }
      }
  ...
  {
    if (this.jdField_a_of_type_ArrayOfFs != null) {
      return this.jdField_a_of_type_ArrayOfFs.length;
    }
    return 0;
  }
  ...
  int a(int paramInt)
  {
    int j = this.jdField_a_of_type_ArrayOfFs.length;
    int i = 0;
    while (i < j)
    {
      fs localfs = this.jdField_a_of_type_ArrayOfFs[i];
      int k = localfs.d();
      if (paramInt < localfs.a() + k) {
        return i;
      }
      i += 1;
    }
  ...
  int a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 < k)
    {
      ft localft = (ft)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt2);
      if (localft.jdField_a_of_type_Int == j)
      {
        if (paramInt1 > localft.jdField_a_of_type_AndroidGraphicsRect.right) {
          break label87;
        }
        return paramInt2;
      }
  ...
  Rect a(int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_ArrayOfFs.length)) {
      return null;
    }
    fs localfs = this.jdField_a_of_type_ArrayOfFs[paramInt];
    paramInt = localfs.c();
    int i = localfs.d();
    return new Rect(paramInt, i, this.jdField_b_of_type_Int + paramInt, i + localfs.a());
  }
  
  public bdoa a(int paramInt1, int paramInt2)
  {
    int i = 0;
    Rect localRect = new Rect(0, 0, 0, 0);
    fs[] arrayOffs = this.jdField_a_of_type_ArrayOfFs;
    int j = arrayOffs.length;
    if (i < j)
    {
      Object localObject = arrayOffs[i];
      localRect.left = ((fs)localObject).c();
      localRect.top = ((fs)localObject).d();
      localRect.right = (localRect.left + ((fs)localObject).b());
      localRect.bottom = (localRect.top + ((fs)localObject).a());
      if (!localRect.contains(paramInt1, paramInt2)) {}
      do
      {
        i += 1;
        break;
        localObject = ((fs)localObject).a(paramInt1);
      } while (localObject == null);
      return ((fm)localObject).a();
    }
    return null;
  }
  ...
  public ETDecoration a(ETEngine paramETEngine, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        if (((CharacterStyle)this.jdField_b_of_type_JavaUtilArrayList.get(i) instanceof bbaw)) {
          this.d = i;
        }
      }
      else {
  ...
  ft a(int paramInt)
  {
    ...
    return (ft)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  public final void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      return;
      fs[] arrayOffs = this.jdField_a_of_type_ArrayOfFs;
      int k = arrayOffs.length;
      int j = 0;
      int i = paramInt2;
      paramInt2 = j;
      while (paramInt2 < k)
      {
        fs localfs = arrayOffs[paramInt2];
        localfs.a(paramCanvas, paramInt1, i);
        i += localfs.a();
        paramInt2 += 1;
      }
    }
  ...
  public final void a(ETEngine paramETEngine, Bitmap paramBitmap, ETDecoration paramETDecoration, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_b_of_type_Int > 0) && (this.jdField_c_of_type_Int > 0))
      {
        ...
        paramETDecoration = this.jdField_a_of_type_ArrayOfFs;
        ...
        for (;;)
        {
          ...
          ((fs)localObject1).a(paramETEngine, paramBitmap, null, j, k);
          k += ((fs)localObject1).a();
          if (k >= n) {
            break;
          }
    ...
    for (;;)
    {
      ...
      {
        j = 0;
        localObject1 = this.jdField_a_of_type_ArrayOfFs;
  ...
  public boolean a(ETEngine paramETEngine, int paramInt1, CharSequence paramCharSequence, ETFont paramETFont, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    if (paramInt2 < j)
    {
      int i = this.jdField_a_of_type_ArrayOfFs[paramInt2].b();
      k = this.jdField_a_of_type_ArrayOfFs[paramInt2].a();
      if (i <= paramInt1) {
        break label254;
      }
      paramInt1 = i;
  ...
  public ETSegment[] a(ETEngine paramETEngine)
  {
    ...
    if (k < n)
    {
      ...
      {
        localfm = (fm)((Iterator)localObject1).next();
        if (localfm == null) {
          return null;
        }
        ...
        i2 = localfm.d();
        int i3 = localfs.e();
        int i4 = localfm.a(paramETEngine);
        localETSegment.x = m;
    ...
    for (;;)
    {
      ...
      if (i1 > -1)
      {
        ...
        localETSegment.y = (i1 - i2 + j);
        localObject2 = localfm.a();
        if ((localObject2 instanceof bbaw))
        {
          localObject2 = (bbaw)localObject2;
          ((bbaw)localObject2).jdField_a_of_type_Float = m;
          ((bbaw)localObject2).b = localETSegment.y;
        }
      }
      localETSegment.textSize = localfm.a();
      localETSegment.lineNum = localfm.e();
  ...
  {
    if ((this.jdField_a_of_type_ArrayOfFs == null) || (paramInt >= this.jdField_a_of_type_ArrayOfFs.length)) {
      return null;
    }
    ArrayList localArrayList = new ArrayList();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localft.jdField_a_of_type_Int == paramInt) {
        localArrayList.add(localft);
      }
    }
    return (ft[])localArrayList.toArray(new ft[0]);
  }
  ...
  public void b(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (bbaw)this.jdField_b_of_type_JavaUtilArrayList.get(this.d);
      ...
      i = ((bbaw)localObject1).b();
      k = (int)((bbaw)localObject1).b;
      ((bbaw)localObject1).jdField_a_of_type_Boolean = false;
      ((bbaw)localObject1).draw(paramCanvas, null, 0, 0, ((bbaw)localObject1).jdField_a_of_type_Float, (int)((bbaw)localObject1).b, 0, i + k, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
    if (this.jdField_a_of_type_ArrayOfFs == null) {}
    for (;;)
    {
