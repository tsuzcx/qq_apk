  ...
  extends mnw
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new mny(this.jdField_a_of_type_JavaLangString, this);
  ...
  public mnx(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    this.m = ((int)paramContext.getResources().getDimension(2131297650));
  ...
  private void a(Canvas paramCanvas, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.jdField_a_of_type_Mnv.b);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(this.jdField_a_of_type_Mnv.jdField_a_of_type_Float);
    float f = -this.jdField_a_of_type_AndroidGraphicsPaint.getFontMetrics().ascent;
    paramCanvas.drawText((String)this.jdField_a_of_type_Lga.a, paramInt, f, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.jdField_a_of_type_Mnv.jdField_a_of_type_Int);
  ...
  private void d(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(this.jdField_b_of_type_Mnv.b);
    this.jdField_c_of_type_AndroidGraphicsPaint.setStrokeWidth(this.jdField_b_of_type_Mnv.jdField_a_of_type_Float);
    ...
    paramCanvas.drawText((String)this.jdField_a_of_type_Lga.b, paramInt1, f, this.jdField_c_of_type_AndroidGraphicsPaint);
    this.jdField_c_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(this.jdField_b_of_type_Mnv.jdField_a_of_type_Int);
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      lbc.c(this.jdField_a_of_type_JavaLangString, "onDraw film:|" + (l2 - l1));
      return;
      i1 = 0;
      break;
      label76:
  ...
  public void a(lga paramlga)
  {
    ...
    for (paramlga = this.jdField_a_of_type_Lga.b;; paramlga = null)
    {
      paramlga = (String)paramlga;
      this.j = a(this.jdField_c_of_type_AndroidGraphicsPaint, paramlga);
      int i1 = c();
      this.e = ((this.g - i1) / 2);
      if ((this.jdField_a_of_type_Lga != null) && (this.jdField_a_of_type_Lga.a()))
      {
        paramlga = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
        this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(paramlga, 2000L);
      }
      return;
    }
  }
  ...
  public void b(Typeface paramTypeface, int paramInt, mnv parammnv)
  {
    if (paramTypeface != null) {
      this.jdField_c_of_type_AndroidGraphicsPaint.setTypeface(paramTypeface);
    }
    this.jdField_b_of_type_Mnv = parammnv;
    this.jdField_c_of_type_AndroidGraphicsPaint.setTextSize(paramInt);
    if (this.jdField_a_of_type_Lga != null) {}
    for (paramTypeface = this.jdField_a_of_type_Lga.b;; paramTypeface = null)
    {
  ...
  public int d()
  {
    return (int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297648);
  }
  
  Bitmap d()
  {
    if ((this.jdField_a_of_type_Lga == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Lga.b))) {
      return null;
    }
    try
    {
  ...
  int g()
  {
    ...
    label48:
    for (Object localObject = this.jdField_a_of_type_Lga.b;; localObject = null)
    {
