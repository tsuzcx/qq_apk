  ...
  implements yku
{
  ...
  public ylb(Context paramContext, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    super(paramContext);
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (paramInt1 < 0) || (paramInt2 < 0))
    {
      yny.d("GdtBannerViewWithPictureText", "constructor");
      return;
    }
    setOrientation(0);
    setGravity(16);
  ...
  {
    if ((this.jdField_a_of_type_Int <= 0) || (this.b <= 0) || (this.jdField_a_of_type_Ykr == null) || (this.jdField_a_of_type_AndroidWidgetTextView == null) || (paramInt1 <= 0) || (paramInt2 <= 0))
    {
      yny.d("GdtBannerViewWithPictureText", "setSize error");
      return;
    }
    ykz localykz = new ykz(getContext(), paramInt1, paramInt2);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(Double.valueOf(1.0D * (paramInt2 - localykz.b * 2) / this.b * this.jdField_a_of_type_Int + localykz.b * 2).intValue(), paramInt2);
    this.jdField_a_of_type_Ykr.setLayoutParams(localLayoutParams);
    this.jdField_a_of_type_Ykr.setPadding(localykz.b, localykz.b, localykz.b, localykz.b);
