...
public class akje
{
  ...
  public akje(int paramInt, String... paramVarArgs)
  {
    try
    {
      this.e = true;
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new akji(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new akjj(this));
  ...
  public akje(String paramString1, String paramString2)
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new akjf(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new akjg(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new akjh(this));
