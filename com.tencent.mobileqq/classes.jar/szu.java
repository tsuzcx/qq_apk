  ...
  implements syk, syp
{
  ...
  public syj a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    try
    {
      ...
      pfr.a(((Container)localObject).getVirtualView(), localProteusItemData.a.getViewBean());
      paramViewGroup = (ViewGroup)localObject;
    ...
    return new szv(this, (View)localObject, localProteusItemData);
  }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext == null)
        {
          ...
          {
            QLog.d("WebProteusViewCreator", 1, "VIEW_TYPE_COUNT=" + syj.a + ",NAME_VIEWTYPE_MAP size=" + this.jdField_a_of_type_JavaUtilMap.size() + "type=" + i);
            syj.a += this.jdField_a_of_type_JavaUtilMap.size() + 1;
          }
        }
        else
        {
