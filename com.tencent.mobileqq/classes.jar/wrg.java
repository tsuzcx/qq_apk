  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public wrg(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Wrf = new wrf(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Wrf);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Wrf.a(paramString);
    if (this.jdField_a_of_type_Wrf.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Wrf.notifyDataSetChanged();
      return;
