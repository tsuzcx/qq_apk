...
public class aopa
{
  ...
  private aopc jdField_a_of_type_Aopc;
  private aope jdField_a_of_type_Aope;
  private aopf jdField_a_of_type_Aopf;
  private aopg jdField_a_of_type_Aopg;
  private aopi jdField_a_of_type_Aopi;
  private aopj jdField_a_of_type_Aopj;
  ...
  public aopa(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new aopd(this);
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new aopb(this, 3, true, true, 0L, true, true, "ArkAppEventObserverManager");
  }
  ...
  public void a(aoph paramaoph, long paramLong)
  {
    if ((paramaoph instanceof aopg))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppEventObserverManager", 2, "attachEvent MotionCallback");
      }
      if ((this.jdField_a_of_type_Long != 0L) && (this.jdField_a_of_type_Aopg != null)) {
        this.jdField_a_of_type_Aopg.a(this.jdField_a_of_type_Long);
      }
      this.jdField_a_of_type_Aopg = ((aopg)paramaoph);
      this.jdField_a_of_type_Long = paramLong;
      if (this.jdField_a_of_type_AndroidHardwareSensor == null)
      {
        paramaoph = (SensorManager)BaseApplicationImpl.getApplication().getSystemService("sensor");
        this.jdField_a_of_type_AndroidHardwareSensor = paramaoph.getDefaultSensor(1);
        if (this.jdField_a_of_type_AndroidHardwareSensor == null) {
          break label113;
        }
        paramaoph.registerListener(this.jdField_a_of_type_AndroidHardwareSensorEventListener, this.jdField_a_of_type_AndroidHardwareSensor, 1);
      }
    }
    label113:
    do
    {
      do
      {
        do
        {
          ...
          this.jdField_a_of_type_Aopg.a(false, 0.0F, 0.0F, 0.0F);
          return;
          if (!(paramaoph instanceof aopi)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("ArkAppEventObserverManager", 2, "attachEvent OrientationCallback");
          }
          if ((this.jdField_b_of_type_Long != 0L) && (this.jdField_a_of_type_Aopi != null)) {
            this.jdField_a_of_type_Aopi.a(this.jdField_b_of_type_Long);
          }
          this.jdField_a_of_type_Aopi = ((aopi)paramaoph);
          this.jdField_b_of_type_Long = paramLong;
        } while (this.jdField_b_of_type_AndroidHardwareSensor != null);
        paramaoph = (SensorManager)BaseApplicationImpl.getApplication().getSystemService("sensor");
        this.jdField_b_of_type_AndroidHardwareSensor = paramaoph.getDefaultSensor(3);
        paramaoph.registerListener(this.jdField_a_of_type_AndroidHardwareSensorEventListener, this.jdField_b_of_type_AndroidHardwareSensor, 1);
        return;
        if ((paramaoph instanceof aopj))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ArkAppEventObserverManager", 2, "attachEvent PositionCallback callback=" + paramaoph + ", cbId=" + paramLong + ", mPositionCallback=" + this.jdField_a_of_type_Aopj + ", mPositionCallbackId=" + this.jdField_c_of_type_Long);
          }
          if ((this.jdField_c_of_type_Long != 0L) && (this.jdField_a_of_type_Aopj != null)) {
            this.jdField_a_of_type_Aopj.a(this.jdField_c_of_type_Long);
          }
          this.jdField_a_of_type_Aopj = ((aopj)paramaoph);
          this.jdField_c_of_type_Long = paramLong;
          SosoInterface.startLocation(this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener);
          return;
        }
        if (!(paramaoph instanceof aope)) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ArkAppEventObserverManager", 2, "attachEvent ConnectionCallback");
        }
        if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_Aope != null)) {
          this.jdField_a_of_type_Aope.a(this.jdField_d_of_type_Long);
        }
        this.jdField_a_of_type_Aope = ((aope)paramaoph);
        this.jdField_d_of_type_Long = paramLong;
      } while (this.jdField_a_of_type_Aopc != null);
      this.jdField_a_of_type_Aopc = new aopc(this);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_Aopc);
      return;
    } while (!(paramaoph instanceof aopf));
    if (QLog.isColorLevel()) {
      QLog.d("ArkAppEventObserverManager", 2, "attachEvent GetCurrentPositionCallback");
    }
    if ((this.jdField_e_of_type_Long != 0L) && (this.jdField_a_of_type_Aopf != null)) {
      this.jdField_a_of_type_Aopf.a(this.jdField_e_of_type_Long);
    }
    this.jdField_a_of_type_Aopf = ((aopf)paramaoph);
  ...
  public void a(String paramString)
  {
    ...
    if ("Motion".equals(paramString))
    {
      ...
      this.jdField_a_of_type_Aopg = null;
    ...
    do
    {
      ...
      if ("Position".equals(paramString))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("ArkAppEventObserverManager", 2, "detachEvent PositionCallback mPositionCallback=" + this.jdField_a_of_type_Aopj + ", mPositionCallbackId=" + this.jdField_c_of_type_Long);
        }
        if ((this.jdField_c_of_type_Long != 0L) && (this.jdField_a_of_type_Aopj != null)) {
          this.jdField_a_of_type_Aopj.a(this.jdField_c_of_type_Long);
        }
        this.jdField_a_of_type_Aopj = null;
    ...
    if (this.jdField_a_of_type_Aopc != null)
    {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Aopc);
      this.jdField_a_of_type_Aopc = null;
    }
    if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_Aope != null)) {
      this.jdField_a_of_type_Aope.a(this.jdField_d_of_type_Long);
    }
