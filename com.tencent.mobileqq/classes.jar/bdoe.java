...
public class bdoe
{
  private static final SparseArray<Class<? extends bdnv>> jdField_a_of_type_AndroidUtilSparseArray;
  private static HashMap<String, Class<? extends bdnu>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilHashMap.put("pavideo", bdsp.class);
    jdField_a_of_type_JavaUtilHashMap.put("video", bdte.class);
    jdField_a_of_type_JavaUtilHashMap.put("picture", bdpx.class);
    jdField_a_of_type_JavaUtilHashMap.put("title", StructMsgItemTitle.class);
    jdField_a_of_type_JavaUtilHashMap.put("summary", bdsv.class);
    jdField_a_of_type_JavaUtilHashMap.put("timer", bdsz.class);
    jdField_a_of_type_JavaUtilHashMap.put("hr", bdpz.class);
    jdField_a_of_type_JavaUtilHashMap.put("image", bdqa.class);
    jdField_a_of_type_JavaUtilHashMap.put("more", bdsj.class);
    jdField_a_of_type_JavaUtilHashMap.put("progress", bdst.class);
    jdField_a_of_type_JavaUtilHashMap.put("checklist", bdtn.class);
    jdField_a_of_type_JavaUtilHashMap.put("vote", bdtp.class);
    jdField_a_of_type_JavaUtilHashMap.put("price", bdss.class);
    jdField_a_of_type_JavaUtilHashMap.put("button", bdpr.class);
    jdField_a_of_type_JavaUtilHashMap.put("remark", bdsu.class);
    jdField_a_of_type_JavaUtilHashMap.put("paaudio", bdsk.class);
    jdField_a_of_type_JavaUtilHashMap.put("textButton", bdsx.class);
    jdField_a_of_type_JavaUtilHashMap.put("content", bdpw.class);
    jdField_a_of_type_JavaUtilHashMap.put("tips", bdpj.class);
    jdField_a_of_type_JavaUtilHashMap.put("live", bdpd.class);
    jdField_a_of_type_JavaUtilHashMap.put("tr", bdtc.class);
    jdField_a_of_type_JavaUtilHashMap.put("td", bdsw.class);
    jdField_a_of_type_JavaUtilHashMap.put("head", bdpq.class);
    jdField_a_of_type_JavaUtilHashMap.put("type", bdtd.class);
    jdField_a_of_type_JavaUtilHashMap.put("tag", bdph.class);
    jdField_a_of_type_JavaUtilHashMap.put("taglist", bdpi.class);
    jdField_a_of_type_JavaUtilHashMap.put("group", bdox.class);
    jdField_a_of_type_JavaUtilHashMap.put("groupitem", bdoz.class);
    jdField_a_of_type_JavaUtilHashMap.put("voice", bdpk.class);
    jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    jdField_a_of_type_AndroidUtilSparseArray.append(0, bdry.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(1, bdqb.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(2, bdqn.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(3, bdrh.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(4, bdro.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(5, bdrp.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(6, bdrr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(7, bdru.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(8, bdrw.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(9, bdrx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(10, bdqc.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(11, bdqe.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(12, bdqg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(18, bdqk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(19, bdqm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(20, bdqo.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(21, bdqr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(22, bdqs.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(23, bdqt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(24, bdqv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(25, bdqy.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(26, bdqz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(27, bdra.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(28, bdrb.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(29, bdre.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(30, bdri.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(31, bdrk.class);
  }
  
  public static bdnu a(String paramString)
  {
    return a(paramString, 0);
  }
  
  /* Error */
  public static bdnu a(String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 212
    //   2: aload_0
    ...
    //   6: ifne +72 -> 78
    //   9: getstatic 18	bdoe:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_0
    ...
    //   76: aload_3
    //   77: areturn
    //   78: getstatic 143	bdoe:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   81: iload_1
  ...
  /* Error */
  public static bdnv a(int paramInt)
  {
    // Byte code:
    //   0: getstatic 143	bdoe:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   3: iload_0
