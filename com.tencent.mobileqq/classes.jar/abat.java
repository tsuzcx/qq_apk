...
public class abat
  implements bkhw
{
  public abat(NewerGuidePlugin paramNewerGuidePlugin, Activity paramActivity, bkho parambkho) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramView = bghy.a();
      paramInt = bghy.b(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        paramView = bhgg.a(anhk.ba + "photo/");
