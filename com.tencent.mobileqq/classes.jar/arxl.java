  ...
  extends ClickableSpan
{
  ...
  public arxl(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString, int paramInt4, MessageForNearbyMarketGrayTips paramMessageForNearbyMarketGrayTips)
  {
  ...
  public void a(String paramString)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      if (((String)localObject).contains("sign=xxx"))
      {
        ...
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + bhjx.a(localQQAppInterface.a().n(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      }
    ...
    for (;;)
    {
      ...
      if (((String)localObject).equals("https://imgcache.qq.com/club/client/flower/release/html/index.html"))
      {
        ...
        localObject = bhjx.a(localQQAppInterface.a().n(paramString));
        localObject = String.format("https://imgcache.qq.com/club/client/flower/release/html/index.html?strangerUin=%s&sign=%s&sourceType=%d&ADTAG=%s&groupCode=%s&_wv=2147347&_bid=2050", new Object[] { axwz.a(paramString), ((String)localObject).toLowerCase(), Integer.valueOf(1), "aio.plus.s", "" });
        paramString = (String)localObject;
      ...
      {
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + bhjx.a(localQQAppInterface.a().q(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
        break;
      }
      paramString = (String)localObject;
      ...
      paramString = ((String)localObject).replace("sign=xxx", "sign=" + bhjx.a(localQQAppInterface.a().k(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      break;
      label472:
      localObject = paramString;
      if (1010 == this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.istroop) {
  ...
  public void b(String paramString)
  {
    ...
    Object localObject = bhni.a((QQAppInterface)localObject, localContext, paramString);
    if (localObject != null)
    {
      ((bhmr)localObject).a();
      return;
  ...
  public void c(String paramString)
  {
    ...
    return;
    ((axwo)localQQAppInterface.a(66)).a("tag_nearby_chat", paramString, null);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localQQAppInterface != null)
    {
      bdll.b(localQQAppInterface, "CliOper", "", "", "0X800524C", "0X800524C", 0, 0, String.valueOf(this.c), "", "", "");
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.AioType == 0)
      {
        paramView = "0";
        bdll.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "clk_link", 0, 0, paramView, "", "", "");
      }
    }
    else
    {
    ...
    do
    {
      ...
      if (axuf.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips, "isFaceScoreSecondMember"))
      {
        paramView = "2";
        if (!axuf.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips, "isFaceScoreSpecialLike")) {
          break label343;
        }
      }
      for (String str = "2";; str = "1")
      {
        axuf.a("clk_hi", this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin, new String[] { paramView, "", "", str });
