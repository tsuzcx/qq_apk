  ...
  extends ProtocolDownloader.Adapter
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbvj.a(ajsd.aW + "keyword_emotion/");
  }
  
  public aeww()
  {
    if (BaseApplicationImpl.sProcessId == 1) {
      this.jdField_a_of_type_Aukp = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getEntityManagerFactory().createEntityManager();
    }
  ...
  public static String a(aewv paramaewv)
  {
    String str = null;
    if (!TextUtils.isEmpty(paramaewv.e())) {
      str = paramaewv.e();
    }
    while (TextUtils.isEmpty(paramaewv.a())) {
      return str;
    }
    return paramaewv.a();
  }
  ...
  {
    return aexb.a(paramString).exists();
  }
  ...
  public File a(String paramString, File paramFile, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramURLDrawableHandler)
      {
        try
        {
          new ayrp().a((OutputStream)localObject, localDownloadParams, paramURLDrawableHandler);
          ((FileOutputStream)localObject).close();
          paramURLDrawableHandler = new File(str2);
          if (!paramURLDrawableHandler.renameTo(paramFile))
          {
            bbdx.a(paramURLDrawableHandler, paramFile);
          ...
          axrn.a(BaseApplication.getContext()).a(null, "StickerRecImgDownload", true, l, 0L, paramURLDrawableHandler, "");
          return paramFile;
        }
        catch (Exception paramURLDrawableHandler)
        {
    ...
    axrn.a(BaseApplication.getContext()).a(null, "StickerRecImgDownload", false, l, 0L, null, "");
    paramFile.delete();
  ...
  public boolean hasDiskFile(DownloadParams paramDownloadParams)
  {
    try
    {
      paramDownloadParams = a((aewv)paramDownloadParams.mExtraInfo);
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    File localFile1 = aexb.a(paramDownloadParams);
