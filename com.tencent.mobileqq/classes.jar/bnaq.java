...
public class bnaq
{
  ...
  private static final String b = "https://dldir1.qq.com/weiyun/android/qq/" + a + "/weiyunLibrary" + 1004 + ".zip";
  private static final String c = "https://dldir1.qq.com/weiyun/android/qq/" + a + "/librarySize" + 1004 + ".txt";
  ...
  public static void a(Context paramContext, bnat parambnat)
  {
    ...
    {
      if (parambnat != null) {
        parambnat.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = bnav.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    bmzf.a().a(b, str1, "SoHelper", new bnar(str2, str1, parambnat, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = bnap.a(paramContext, "0", "key_local_so_version");
