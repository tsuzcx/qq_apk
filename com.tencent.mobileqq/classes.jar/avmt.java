...
{
  afuo jdField_a_of_type_Afuo = afuo.a();
  ...
  public avmt(Activity paramActivity, String paramString1, String paramString2, MiniMsgUserParam paramMiniMsgUserParam)
  {
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidAppActivity.getApplicationContext(), 2131563068, null);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      String str = bfpi.a("", this.jdField_a_of_type_JavaLangString, 0);
      bdsh.a(str);
      Object localObject2 = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131371076);
      URLImageView localURLImageView = (URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371077);
      Object localObject1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371078);
      ...
      localLayoutParams.leftMargin = bgtn.b(4.0F);
      ...
      if (AppSetting.c) {
        bgfz.b(this.jdField_a_of_type_AndroidViewView, false);
      }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam != null)
    {
      ...
      {
        ajzt localajzt = MiniMsgIPCClient.getInstance().getBusinessInfo(this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam.businessName);
        if (localajzt != null)
        {
          int[] arrayOfInt = ((ajzr)this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam.unreadCallback).a();
          if (arrayOfInt != null)
          {
