...
public class msp
{
  ...
  {
    Object localObject2 = ((askl)paramQQAppInterface.getManager(11)).b(paramString);
    Object localObject1 = null;
    if (localObject2 != null) {
      localObject1 = bbcl.b(((PhoneContact)localObject2).name);
    }
    localObject2 = localObject1;
    if (localObject1 == null) {
      localObject2 = bbcl.b(paramString);
    }
    paramString = new bazn(paramQQAppInterface.getApp(), (String)localObject2);
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    {
      return paramQQAppInterface;
      paramQQAppInterface = (aver)paramQQAppInterface.getManager(38);
  ...
  public static List<AVPhoneUserInfo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    localObject1 = (ajvk)paramQQAppInterface.getManager(53);
    if (localObject1 == null) {
      return null;
    }
    paramString = ((ajvk)localObject1).a(paramString);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        paramQQAppInterface = ((askl)localObject1).b(paramQQAppInterface);
        if (paramQQAppInterface == null) {
          break label266;
        }
      }
  ...
  public static List<Bitmap> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    Map localMap = ((ajvk)localObject).a(paramString);
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      for (;;)
      {
        paramInt1 += 1;
        break;
        PhoneContact localPhoneContact = localaskl.b(str);
        paramString = null;
