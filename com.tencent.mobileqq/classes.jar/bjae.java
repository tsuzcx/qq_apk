...
{
  public bjae(AgentActivity paramAgentActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("action_login_sucess".equals(paramIntent.getAction())) {
      ...
      {
        paramContext = bjhh.a(paramIntent, "login_success_uin");
        ...
        aeow.a(this.a, AgentActivity.a(this.a), PublicFragmentActivityForOpenSDK.class, OpenAuthorityFragment.class, 0);
      }
    }
    for (;;)
    {
