  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private bcal jdField_a_of_type_Bcal;
  ...
  bcam(int paramInt1, int paramInt2)
  {
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e("AlphaVideoView", 2, "playVideo Exception: " + localException.getMessage());
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bcan(this));
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 246	bcam:jdField_d_of_type_Boolean	Z
    //   6: ifne +6 -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    ...
    //   13: monitorexit
    //   14: aload_0
    //   15: getfield 58	bcam:jdField_h_of_type_Int	I
    //   18: invokestatic 249	android/opengl/GLES20:glUseProgram	(I)V
    //   21: aload_0
    //   22: monitorenter
    //   23: aload_0
    //   24: getfield 251	bcam:jdField_b_of_type_Boolean	Z
    //   27: ifeq +50 -> 77
    //   30: aload_0
    //   31: getfield 81	bcam:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   34: ifnull +43 -> 77
    //   37: aload_0
    //   38: getfield 253	bcam:jdField_b_of_type_AndroidGraphicsSurfaceTexture	Landroid/graphics/SurfaceTexture;
    //   41: ifnull +36 -> 77
    //   44: aload_0
    //   45: getfield 81	bcam:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   48: invokevirtual 243	android/media/MediaPlayer:isPlaying	()Z
    //   51: ifeq +26 -> 77
    //   54: aload_0
    //   55: getfield 253	bcam:jdField_b_of_type_AndroidGraphicsSurfaceTexture	Landroid/graphics/SurfaceTexture;
    //   58: invokevirtual 258	android/graphics/SurfaceTexture:updateTexImage	()V
    //   61: aload_0
    //   62: getfield 253	bcam:jdField_b_of_type_AndroidGraphicsSurfaceTexture	Landroid/graphics/SurfaceTexture;
    //   65: aload_0
    //   66: getfield 51	bcam:jdField_j_of_type_ArrayOfFloat	[F
    //   69: invokevirtual 262	android/graphics/SurfaceTexture:getTransformMatrix	([F)V
    //   72: aload_0
    //   73: iconst_0
    //   74: putfield 251	bcam:jdField_b_of_type_Boolean	Z
    //   77: aload_0
    //   78: monitorexit
    //   79: aload_0
    //   80: aload_0
    //   81: getfield 264	bcam:jdField_a_of_type_Int	I
    //   84: aload_0
    //   85: getfield 266	bcam:jdField_b_of_type_Int	I
    //   88: invokespecial 268	bcam:c	(II)V
    //   91: return
    //   92: astore_1
    //   93: aload_0
    //   94: monitorexit
  ...
  void a(bcal parambcal)
  {
    this.jdField_a_of_type_Bcal = parambcal;
  }
  ...
  public void c()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        QLog.e("AlphaVideoView", 2, "release: " + localException.getMessage());
      }
    }
  }
  ...
  public void d()
  {
    ...
    p();
    l();
    this.jdField_a_of_type_Bcal.onDrawBegin();
  }
  ...
  public void g()
  {
    ...
    {
      QLog.e("AlphaVideoView", 2, "onDestroy: " + localException.getMessage());
    }
  }
  ...
  public void i()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        QLog.e("AlphaVideoView", 2, "pauseVideo: " + localException.getMessage());
      }
    }
  }
  ...
  public void j()
  {
    ...
    {
      QLog.e("AlphaVideoView", 2, "resumeVideo: " + localException.getMessage());
    }
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    //   2: aload_0
    //   3: iconst_1
    //   4: putfield 251	bcam:jdField_b_of_type_Boolean	Z
    //   7: aload_0
    //   8: iconst_1
    //   9: putfield 246	bcam:jdField_d_of_type_Boolean	Z
    //   12: aload_0
    //   13: getfield 96	bcam:jdField_a_of_type_Long	J
    //   16: lconst_0
    //   17: lcmp
    //   18: ifne +33 -> 51
    //   21: aload_0
    //   22: invokestatic 433	java/lang/System:currentTimeMillis	()J
    //   25: putfield 96	bcam:jdField_a_of_type_Long	J
    //   28: aload_0
    //   29: getfield 64	bcam:jdField_a_of_type_CooperationLiveroomLiveRoomGiftCallback	Lcooperation/liveroom/LiveRoomGiftCallback;
    //   32: ifnull +16 -> 48
    //   35: aload_0
    //   36: getfield 64	bcam:jdField_a_of_type_CooperationLiveroomLiveRoomGiftCallback	Lcooperation/liveroom/LiveRoomGiftCallback;
    //   39: iconst_4
    //   40: ldc_w 370
    //   43: invokeinterface 376 3 0
    //   48: aload_0
    //   49: monitorexit
    //   50: return
    //   51: aload_0
    //   52: getfield 64	bcam:jdField_a_of_type_CooperationLiveroomLiveRoomGiftCallback	Lcooperation/liveroom/LiveRoomGiftCallback;
    //   55: ifnull -7 -> 48
    //   58: aload_0
    //   59: getfield 64	bcam:jdField_a_of_type_CooperationLiveroomLiveRoomGiftCallback	Lcooperation/liveroom/LiveRoomGiftCallback;
    //   62: iconst_5
    //   63: ldc_w 370
    //   66: invokeinterface 376 3 0
    //   71: goto -23 -> 48
    //   74: astore_1
    //   75: aload_0
    //   76: monitorexit
