...
public class rfe
  extends rfc
{
  public rfe(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp a()
  {
    ...
    return f(this.jdField_a_of_type_Szd, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder).g().q().l().n();
  }
  ...
  public rbp d()
  {
    ...
    if ((this.jdField_a_of_type_Rbo != null) && ((this.jdField_a_of_type_Rbo instanceof ComponentContentBigImageVideo)))
    {
      ...
      localLinearLayout2.setOnClickListener(new rff(this));
