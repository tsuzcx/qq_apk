  ...
  implements MessageQueue.IdleHandler
{
  ...
  public boolean queueIdle()
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Bmkf.getActivity().getIntent().getExtras();
    ...
    for (localObject = "null";; localObject = str6)
    {
      ...
      localObject = new bmvb(str4);
      ((bmvb)localObject).b = str1;
      ((bmvb)localObject).c = str2;
      ((bmvb)localObject).d = str3;
      this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.setLinkerObject((bmvb)localObject);
      this.a.jdField_a_of_type_Bmix.a(Message.obtain(null, 15, 1, 0));
      return false;
      localObject = str4;
      break label168;
      localObject = str1;
