  ...
  extends zdx
{
  ...
  public void a(Activity paramActivity, zdy paramzdy, int paramInt)
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramzdy.a();
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367017);
    localRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setDuration(300L);
    this.b.setDuration(300L);
    this.jdField_a_of_type_Zdy = paramzdy;
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new zer(this));
    this.b.setAnimationListener(new zes(this));
  }
