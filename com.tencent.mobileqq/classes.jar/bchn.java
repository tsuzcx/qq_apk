    ...
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        for (;;)
        {
          ...
          if (k < m)
          {
            ...
            for (;;)
            {
              ...
              l2 = l3;
              break label448;
              paramVarArgs = new bcfy(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgu(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              ...
              break label583;
              paramVarArgs = new bcgq(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgn(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgo(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              ...
              break label583;
              paramVarArgs = new bcgp(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgm(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgk(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              l2 = l1 - 1L;
              continue;
              if (!bcni.b(l2))
              ...
              {
                paramVarArgs = new bcha(str1, str7, -4, str5);
                paramVarArgs.u = localResultItem.seporator_type.get();
                localArrayList3.add(paramVarArgs);
                l2 = l1;
              }
              ...
              {
                paramVarArgs = new bcep(str1, paramVarArgs, (String)localObject, str5, str6, str7, l2, localArrayList2, i);
                l2 = l1;
        ...
        if (l1 > 0L)
        {
          ...
          {
            localArrayList1.add(new bceo(str1, l3, str2, localArrayList3, l1, paramVarArgs, (String)localObject, localArrayList2, bool1, bool2, bool3, str3, str4));
            break;
            bool2 = false;
            break label1159;
          }
