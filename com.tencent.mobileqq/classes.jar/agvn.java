  ...
  implements agvc
{
  ...
  public agvn(BaseChatPie paramBaseChatPie)
  {
  ...
  private axld a()
  {
    ...
    return ((axlc)localBaseActivity.app.getManager(325)).b(i);
  }
  ...
  private void d()
  {
    ...
    if ((localObject != null) && (((axld)localObject).a()))
    {
      ...
      if (localObject != null) {
        ((ChatXListView)localObject).setOnLayoutListener(new agvo(this));
      }
    }
  }
  ...
  private void j()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs;
    Object localObject2;
    if (localObject1 != null)
    {
      localObject1 = ((aggs)localObject1).a();
      i = a();
      if ((localObject1 != null) && (((List)localObject1).size() == i))
      {
        localObject1 = a();
        if ((localObject1 != null) && (((axld)localObject1).a()))
        {
          localObject2 = ((axld)localObject1).a();
          if (localObject2 != null)
          {
            localObject2 = ((axlh)localObject2).a();
            if (localObject2 != null) {
              break label100;
            }
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new MultiWindowAIOHelper.4(this, (axld)localObject1), 350L);
  }
  
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs != null)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs.d();
    }
