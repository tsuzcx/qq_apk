  ...
  extends akln
{
  ...
  public void a(RecentItemRecommendTroopData paramRecentItemRecommendTroopData, aklg paramaklg)
  {
    ...
    for (boolean bool = paramRecentItemRecommendTroopData.mUser.uin.equals("sp_uin_for_title");; bool = true)
    {
      if (bool)
      {
        ...
        if (AppSetting.c)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(amtj.a(2131712322));
        }
        return;
      }
      ...
      if (paramRecentItemRecommendTroopData.mUser != null)
      {
        ...
        if (paramaklg == null)
        {
          paramaklg = null;
          label243:
          this.jdField_a_of_type_ComTencentWidgetThemeImageView.setImageDrawable(paramaklg);
      ...
      label620:
      label632:
      for (paramaklg = (RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo;; paramaklg = null)
      {
        if (paramaklg == null)
        {
          QLog.d("RecentRecommendTroopIte", 1, "bindData, troopItem == null");
          return;
          paramaklg = paramaklg.a(paramRecentItemRecommendTroopData);
          break label243;
        }
        if (paramaklg.activity > 0)
        {
          this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setVisibility(0);
          this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setHotLevel(paramaklg.activity);
          ArrayList localArrayList = nmx.a((RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo);
          ...
          label377:
          if (!paramaklg.isJoined()) {
            break label546;
          }
          this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
          this.jdField_a_of_type_AndroidWidgetButton.setText(2131698716);
          ...
          if (TextUtils.isEmpty(paramaklg.intro)) {
            break label620;
          }
          this.jdField_a_of_type_ComTencentMobileqqWidgetFolderTextView.setText(new QQText(paramaklg.intro, 11, 16));
        }
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetButton.setText(2131698714);
