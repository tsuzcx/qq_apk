...
public class aajo
{
  private static final String jdField_a_of_type_JavaLangString = aajo.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131719406);
      localObject2 = BaseApplicationImpl.getContext().getString(2131719407);
      localObject1 = BaseApplicationImpl.getContext().getString(2131719405);
