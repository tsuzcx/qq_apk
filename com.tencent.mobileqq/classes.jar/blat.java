...
public class blat
{
  ...
  private String jdField_b_of_type_JavaLangString = bkkv.jdField_b_of_type_JavaLangString;
  private int jdField_c_of_type_Int;
  private String jdField_c_of_type_JavaLangString;
  private int d;
  
  public blat(String paramString)
  {
  ...
  public void a(blau paramblau)
  {
    this.jdField_a_of_type_Blau = paramblau;
    QLog.d(jdField_a_of_type_JavaLangString, 4, "start add text to png");
    this.jdField_a_of_type_AndroidOsHandler.post(new PngsTextDrawer.2(this, paramblau));
  }
