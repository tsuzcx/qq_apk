...
public class bded
{
  ...
  protected bded()
  {
    this.jdField_a_of_type_AndroidOsHandler = new bdee(this, Looper.getMainLooper());
  ...
  public static bded a()
  {
    try
    {
      if (jdField_a_of_type_Bded == null) {
        jdField_a_of_type_Bded = new bded();
      }
      bded localbded = jdField_a_of_type_Bded;
      return localbded;
    }
    finally {}
  }
  ...
  public int a(int paramInt)
  {
    ...
    {
      return paramInt;
      i = bdjb.a(bcxm.a().a(), null).a("Common_CGIReportFrequencyFailed");
      paramInt = i;
    } while (i != 0);
    return 100;
  }
  ...
  public Bundle a()
  {
    localObject1 = bdef.a().a("report_cgi");
    ...
    try
    {
      ((Bundle)localObject1).putString("releaseversion", bcxm.a().f());
      ((Bundle)localObject1).putString("device", Build.DEVICE);
      ((Bundle)localObject1).putString("qua", bdji.b);
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        localObject2 = bdja.h() + "&" + (String)((BaseData)localObject2).attrs.get("deviceInfo");
  ...
  public void a(Bundle paramBundle, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bcxm.a().a(Long.valueOf(paramString2).longValue());
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, boolean paramBoolean)
  {
    try
    {
      a(bdem.a(paramString1, paramString2, paramString4, paramString5, paramString3, paramString6, paramString7, "", "", paramString8, paramString9), paramString3, paramString1, paramBoolean);
      return;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    try
    {
      a(bdem.a(paramString1, paramString2, paramString4, paramString5, paramString3, paramString6, paramString5, "", "", "", ""), paramString3, paramString1, paramBoolean);
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    {
      j = bdjb.a(bcxm.a().a(), null).a("Common_CGIReportMaxcount");
      if (j != 0) {}
    }
    for (;;)
    {
      ...
      {
        j = bdjb.a(bcxm.a().a(), null).a("Agent_ReportBatchCount");
        if (j != 0) {
          i = j;
        }
      }
  ...
  public Bundle b()
  {
    for (;;)
    {
      try
      {
        Object localObject1 = bdef.a().a("report_via");
        if (localObject1 != null) {
