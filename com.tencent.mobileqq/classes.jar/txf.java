...
public class txf
{
  private static final String jdField_a_of_type_JavaLangString = txf.class.getName();
  private static txf jdField_a_of_type_Txf;
  ...
  public static txf a()
  {
    if (jdField_a_of_type_Txf == null) {
      jdField_a_of_type_Txf = new txf();
    }
    return jdField_a_of_type_Txf;
  }
