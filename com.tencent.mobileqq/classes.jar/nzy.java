...
public class nzy
{
  ...
  private static nzz jdField_a_of_type_Nzz = new nzz(null);
  private static oaa jdField_a_of_type_Oaa = new oaa(null);
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localObject2 = bcid.a().a("com.tencent.reading");
          boolean bool;
  ...
  {
    String str = b(obz.a(), "sp_key_local_apk_path");
  ...
  private static void b(Context paramContext, String paramString)
  {
    ...
    {
      a(obz.a(), "sp_key_current_app_version_name", paramContext.versionName);
      QLog.d("KBPreDownloadUtils", 2, "[saveVersionInfo] versionName: " + paramContext.versionName);
      paramContext = bcdu.a(paramString);
      if (paramContext == null) {
        break label129;
      }
    }
    ...
    {
      a(obz.a(), "sp_key_local_apk_path", paramString);
      a(obz.a(), "sp_key_current_app_md5", paramContext);
  ...
  private static void b(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    awrn.a(obz.a().getApplication()).a(str, "actKBPreDownload", paramBoolean, paramLong, 0L, localHashMap, null, false);
  }
  
  private static boolean b(Context paramContext)
  {
    paramContext = b(obz.a(), "sp_key_current_app_version_name");
    String str1 = b(obz.a(), "sp_key_latest_app_version_name");
    String str2 = b(obz.a(), "sp_key_current_app_md5");
    String str3 = b(obz.a(), "sp_key_latest_app_md5");
