...
public class zju
{
  ...
  private static void b(String paramString, Bitmap paramBitmap, ImageView paramImageView)
  {
    ...
    if (paramBitmap != null)
    {
      localBitmap = bfvo.a(paramImageView.getContext(), paramBitmap, 0.25F, 20.0F);
      if (localBitmap != null)
      {
    ...
    for (Object localObject = localBitmap;; localObject = localBitmap.copy(localBitmap.getConfig(), true))
    {
      ...
      localObject = yqs.a(paramBitmap.getWidth(), paramBitmap.getHeight(), paramImageView.getWidth(), paramImageView.getHeight());
      paramBitmap = yoy.a(yoy.a(localBitmap, ((Integer)((Pair)localObject).first).intValue(), ((Integer)((Pair)localObject).second).intValue(), true), paramBitmap);
      b(paramBitmap, paramImageView);
      bfuj.a(paramString, paramBitmap);
      return;
    }
  }
}
