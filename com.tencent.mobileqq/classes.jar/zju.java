...
public final class zju
  implements Runnable
{
  public zju(RichStatus paramRichStatus, QQAppInterface paramQQAppInterface, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        SharedPreUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), this.jdField_a_of_type_JavaLangString, 0L);
        return;
    ...
    for (;;)
    {
      ...
      if (!MessageHandlerUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject4, false))
      {
        ...
        SharedPreUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), ((MessageRecord)localObject4).frienduin, l1);
