...
public abstract class aczo
{
  ...
  public aczo(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  public void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (localIterator.hasNext()) {
        ((aota)localIterator.next()).b(paramInt, paramBoolean, paramObject);
      }
    }
  }
  ...
  public void a(aota paramaota)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramaota);
      return;
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((aota)localIterator.next()).a(getClass().getSimpleName(), paramString, paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
      }
    }
  }
  ...
  {
    int i = adak.a(???, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((aota)localIterator.next()).a(getClass().getSimpleName(), paramString, paramBoolean1, i, paramBoolean2, paramBoolean3);
      }
    }
  }
  ...
  protected void a(List<MessageRecord> paramList, ArrayList<MessageRecord> paramArrayList, boolean paramBoolean)
  {
    if (paramList.size() > 0)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (!aoci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramBoolean)) {
  ...
  public void a(msg_svc.PbMsgReadedReportReq paramPbMsgReadedReportReq)
  {
    ...
    a(true, true, false, 0L, new aczp(this, paramPbMsgReadedReportReq));
  }
  
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, long paramLong, aczq paramaczq)
  {
    int i;
    if (paramLong == 0L)
    {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean1)
      {
        paramaczq = paramaczq.a();
        if (paramaczq == null) {
          return;
        }
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "processRequest cmd=" + paramaczq.getServiceCmd() + ",reqSeq=" + paramLong);
        }
        a(paramaczq, paramLong, paramBoolean2, paramBoolean3);
        return;
      }
      ...
      while (i < 9)
      {
        localSendMessageHandler.a(new BaseMessageProcessor.1(this, paramaczq, paramLong, l, paramBoolean2, paramBoolean3));
        i += 1;
      }
      i = 0;
      label168:
  ...
  {
    return aoci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramBoolean);
  }
  ...
  public void b(int paramInt, boolean paramBoolean, Object paramObject)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((aota)localIterator.next()).c(paramInt, paramBoolean, paramObject);
      }
    }
  }
}
