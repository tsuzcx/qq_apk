...
public class ayxg
{
  private static final String a = ayxg.class.getSimpleName();
  
  public static boolean a(Activity paramActivity, String paramString)
  {
    if (QLog.isColorLevel()) {
      bjtx.b(a, "enter now live room. mqqapi= " + paramString);
    }
    try
    {
    ...
    {
      if (QLog.isColorLevel()) {
        bjtx.b(a, "enter now live room error: " + paramActivity.getMessage());
      }
    }
    return false;
  }
  ...
  {
    if ((paramActivity != null) && (!bhnv.g(paramActivity.getApplication()))) {
      bmlc.a(paramActivity, 2131693976, 1);
    }
    for (;;)
    {
      return false;
