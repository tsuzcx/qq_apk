  ...
  implements View.OnClickListener
{
  ...
  {
    if (!TextUtils.isEmpty(this.a.jdField_a_of_type_Bisg.jdField_a_of_type_JavaLangString))
    {
      this.a.jdField_a_of_type_JavaLangString = this.a.jdField_a_of_type_Bisg.jdField_a_of_type_JavaLangString;
      ...
      {
        bigb localbigb = this.a.jdField_a_of_type_Bigb;
        if (this.a.jdField_a_of_type_Bigb.a())
        {
          paramView = "2";
          localbigb.a("use_custom_tag", 0, 0, new String[] { paramView });
        }
      }
      else
      {
