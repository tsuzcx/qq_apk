  ...
  extends bdol
{
  ...
  List<bdol> jdField_a_of_type_JavaUtilList = null;
  ...
  private View a(View paramView)
  {
    ...
    ((ImageView)localObject).setImageResource(2130844447);
    int i = agej.a(9.0F, paramView.getResources());
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(agej.a(8.0F, paramView.getResources()), i);
    localLayoutParams.leftMargin = agej.a(24.0F, paramView.getResources());
    localLayoutParams.rightMargin = agej.a(4.0F, paramView.getResources());
    localLinearLayout.addView((View)localObject, localLayoutParams);
    paramView.setPadding(0, 0, 0, 0);
    localObject = paramView.findViewById(2131380110);
    if (localObject != null) {
  ...
  private void a(Resources paramResources, ImageView paramImageView)
  {
    ...
    {
      paramImageView.setBackgroundResource(2130844446);
      return;
    }
    paramImageView.setBackgroundResource(2130844445);
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (bdol)this.jdField_a_of_type_JavaUtilList.get(i);
      paramView = ((bdol)localObject2).jdField_a_of_type_JavaLangString;
      if (!"summary".equals(paramView)) {
        break label334;
      }
      paramView = new LinearLayout(paramContext);
      paramView.setId(2131378085);
      paramView.setOrientation(0);
      localObject1 = new LinearLayout.LayoutParams(-1, agej.a(42.0F, localResources));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = agej.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).rightMargin = agej.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      localObject3 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378086);
      if (localObject3 != null) {
        break label323;
      }
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      label198:
      localObject1 = ((bdol)localObject2).a(paramContext, null, paramBundle);
      localObject2 = new LinearLayout.LayoutParams(-1, -2);
      ((LinearLayout.LayoutParams)localObject2).weight = 1.0F;
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      localObject1 = new ImageView(paramContext);
      ((ImageView)localObject1).setId(2131378084);
    ...
    do
    {
      for (;;)
      {
        ...
        paramView = ((bdol)localObject2).a(paramContext, null, paramBundle);
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
        localObject2 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378086);
    ...
    label430:
    Object localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378086);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinearLayout(paramContext);
      paramView.setOrientation(1);
      paramView.setId(2131378086);
      if (!this.jdField_a_of_type_Boolean) {
        break label646;
      }
    ...
    for (;;)
    {
      ...
      paramView.setBackgroundColor(localResources.getColor(2131167164));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).rightMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      localObject3 = ((bdol)localObject2).a(paramContext, null, paramBundle);
      ...
      localObject2 = new LinearLayout.LayoutParams(-1, agej.a(48.0F, localResources));
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      this.o += 1;
      break;
  ...
  public void a()
  {
    ...
    {
      return;
      localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378086);
    } while (localLinearLayout == null);
    localLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Boolean = false;
    a(this.jdField_a_of_type_AndroidContentContext.getResources(), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378084));
  }
  
  void a(bdol parambdol)
  {
    this.jdField_a_of_type_JavaUtilList.add(parambdol);
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    if (k < m)
    {
      ...
      for (;;)
      {
        ...
        {
          localbdol.aa = String.valueOf(i);
          localbdol.ab = this.ab;
          j = i + 1;
        }
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    for (;;)
    {
      ...
      this.d = parambdqc.a("actionData");
      this.e = parambdqc.a("a_actionData");
      this.f = parambdqc.a("i_actionData");
      this.jdField_b_of_type_JavaLangString = parambdqc.a("url");
      this.o = 0;
      Object localObject = parambdqc.a("expand");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("true"))) {
        this.jdField_a_of_type_Boolean = true;
      }
      localObject = parambdqc.a("animation");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("false"))) {
        this.jdField_b_of_type_Boolean = false;
      }
      localObject = parambdqc.a("duration");
      if (localObject != null) {}
      try
      {
        this.jdField_c_of_type_Long = Long.parseLong((String)localObject);
        label157:
        if ((parambdqc.jdField_a_of_type_JavaUtilList != null) && (parambdqc.a() > 0))
        {
          Iterator localIterator = parambdqc.jdField_a_of_type_JavaUtilList.iterator();
          localObject = null;
          if (localIterator.hasNext())
          {
            bdqc localbdqc = (bdqc)localIterator.next();
            if (("summary".equals(localbdqc.jdField_b_of_type_JavaLangString)) || ("hr".equals(localbdqc.jdField_b_of_type_JavaLangString))) {
              parambdqc = bdov.a(localbdqc.jdField_b_of_type_JavaLangString);
            }
            do
            {
              localObject = parambdqc;
              if (parambdqc == null) {
                break;
              }
              localObject = parambdqc;
              if (!parambdqc.a(localbdqc)) {
                break;
              }
              a(parambdqc);
              localObject = parambdqc;
              break;
              parambdqc = (bdqc)localObject;
            } while (!"item".equals(localbdqc.jdField_b_of_type_JavaLangString));
            parambdqc = localbdqc.a("layout");
            try
            {
              if (!TextUtils.isEmpty(parambdqc)) {}
              for (int i = Integer.parseInt(parambdqc);; i = 0)
              {
                parambdqc = bdov.a(i);
                this.o += 1;
                break;
  ...
  public void b()
  {
    ...
    {
      return;
      localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378086);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localObject2 = new bdps((ViewGroup)localObject1);
        ((bdps)localObject2).setDuration(this.jdField_c_of_type_Long);
        ((bdps)localObject2).setInterpolator(new DecelerateInterpolator());
      ...
      for (;;)
      {
        ...
        localObject2 = (bkib)((QQAppInterface)localObject3).a(85);
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append(this.d).append("&expand=").append(this.jdField_a_of_type_Boolean);
        ((bkib)localObject2).a(((StringBuilder)localObject3).toString(), 1, false, 0.0D, 0.0D, (String)localObject1, 1, "", "", "");
        return;
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject2 = new bdpr((ViewGroup)localObject1);
      ((bdpr)localObject2).setDuration(this.jdField_c_of_type_Long);
      ((bdpr)localObject2).setInterpolator(new AccelerateInterpolator());
      ((LinearLayout)localObject1).startAnimation((Animation)localObject2);
    }
    for (;;)
    {
