...
public class aivt
  implements aivg, Handler.Callback
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bhlj(ThreadManager.getSubThreadLooper(), this);
  private int b;
  
  public aivt(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aiwh paramaiwh)
  {
  ...
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800524B", "0X800524B", 0, 0, String.valueOf(paramInt), "", "", "");
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (this.b == 0) {}
    for (String str = "0";; str = "1")
    {
      bdll.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "exp_oper", 0, 0, str, "", "", "");
      return this.jdField_a_of_type_Aiwh.a(this, paramVarArgs);
    }
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    for (paramVarArgs = paramVarArgs[0].toString();; paramVarArgs = null)
    {
      ...
      {
        MessageRecord localMessageRecord = bcry.a(-2027);
        long l = bcrg.a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return false;
            if ((this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a()) && (!this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a(bcrg.a() * 1000L))) {
              break;
            }
            return false;
            l1 = bcrg.a() * 1000L;
        ...
        } while (bcsa.a(paramMessage.msgtype));
      ...
      while (!TextUtils.isEmpty(paramMessage))
      {
        ...
        if (localGrayTipsConfig.sceneId == 4)
        {
          ...
          else
          {
            ...
            paramMessage.text = anzj.a(2131706098);
            paramMessage.highlightText = anzj.a(2131706097);
          }
      ...
      if (!bhnt.b(((ChatMessage)localObject).issend)) {
        break label1201;
      }
    ...
    } while (bhnt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (QQMessageFacade.Message)localObject));
    ...
    if (paramMessage != null)
    {
      ...
      if (bcsa.a(((ChatMessage)paramMessage.next()).msgtype)) {
        break label1348;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (paramMessage = this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.c(this.b, this.jdField_a_of_type_Int, l1);; paramMessage = null)
      {
        ...
        if (bcsa.a(((ChatMessage)localObject).msgtype)) {
          break;
        }
