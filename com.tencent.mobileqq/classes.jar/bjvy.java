  ...
  extends bjwu
{
  ...
  private bjwc jdField_a_of_type_Bjwc;
  protected ElasticImageView a;
  private List<bjwd> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bjvy(@NonNull bjww parambjww)
  {
    super(parambjww);
  }
  
  private void a(List<? extends bjzj> paramList)
  {
    int i;
    int j;
    if (paramList == null)
    ...
    for (;;)
    {
      ...
      if (i == 1)
      {
        this.jdField_a_of_type_JavaUtilList.add(new bjwd((bjzj)paramList.get(0), null, null));
        return;
      }
      ...
      for (Object localObject = "0";; localObject = "1")
      {
        ...
        if ((this.jdField_a_of_type_Bjww.a.d()) && ((this.jdField_a_of_type_Bjww.a.a instanceof EditLocalVideoSource)))
        {
          localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bjww.a.a;
        ...
        k = actn.a(12.0F, a());
        m = actn.a(2.0F, a());
        k = (blbz.jdField_a_of_type_Int - j * 2 - k * 5) / 6 - m * 2;
        m = k * 8 / 5;
        localuxy = new uxy(actn.a(3.0F, a()), 0, m * 1.0F / k, null, null);
        j = 0;
        while (j < i)
        {
          localbjzj = (bjzj)paramList.get(j);
          if (localbjzj != null) {
            break label368;
          }
          j += 1;
      ...
      label368:
      localObject = vxy.a(localbjzj.jdField_c_of_type_AndroidGraphicsBitmap, k, m, false);
      if (localObject != null) {}
      for (localObject = localuxy.a((Bitmap)localObject);; localObject = null)
      {
        this.jdField_a_of_type_JavaUtilList.add(new bjwd(localbjzj, (Bitmap)localObject, null));
        break;
      }
    }
  }
  
  private void a(List<? extends bjzj> paramList, boolean paramBoolean)
  {
    int j = 0;
    if (paramList == null)
    {
    ...
    if (this.jdField_a_of_type_Bjwc == null) {
      this.jdField_a_of_type_Bjwc = new bjwc(this);
    }
    int i;
    if (paramBoolean)
    {
      ...
      if (((bjzj)paramList.get(i)).jdField_c_of_type_Int != this.jdField_b_of_type_Int) {}
    }
    for (;;)
    {
      if (i < 0)
      ...
      } while (((bjwd)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_c_of_type_Int != this.jdField_b_of_type_Int);
      veg.b("Q.qqstory.record.EditVideoFragment", "update the %d fragment's thumb.", Integer.valueOf(j));
      this.jdField_a_of_type_Bjwc.a((bjzj)paramList.get(i), (bjwd)this.jdField_a_of_type_JavaUtilList.get(j));
      return;
      i = 0;
      while (i < paramList.size())
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          while (((bjzj)paramList.get(i)).jdField_c_of_type_Int != ((bjwd)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_c_of_type_Int)
          {
            j += 1;
            break;
          }
  ...
  private void b(List<bjwd> paramList)
  {
    int j = 0;
    if (paramList == null) {}
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetElasticImageView = ((ElasticImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368681));
  ...
  private void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramInt == ((bjwd)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_c_of_type_Int)
        {
          ...
          ((bjwd)this.jdField_a_of_type_JavaUtilList.get(i)).a = this.jdField_a_of_type_Bjwc.a(paramInt);
        }
      }
      else {
        return;
  ...
  private void c(List<bjwd> paramList)
  {
    if (paramList == null) {}
    for (int i = 0; (i < 2) || (i > 6); i = paramList.size())
    {
    ...
    int j = actn.a(2.0F, a());
    int n = (blbz.jdField_a_of_type_Int - k * 2 - m * 5) / 6;
  ...
  private void d(List<bjwd> paramList)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      while (i < paramList.size())
      {
        this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i].setOnTouchListener(new bjwb(this, i));
        i += 1;
      }
    }
  }
  
  private void e(List<bjwd> paramList)
  {
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
    ...
    if (i < this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout.length)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setBackgroundDrawable(new BitmapDrawable(((bjwd)paramList.get(i)).b));
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageBitmap(((bjwd)paramList.get(i)).a);
  ...
  protected void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Int == ((bjwd)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_Int) && (!this.jdField_a_of_type_Boolean))
    {
    ...
    this.jdField_a_of_type_Int = ((bjwd)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_Int;
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bjww.a(Message.obtain(null, 6, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int));
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localObject = (bjzj)this.jdField_a_of_type_JavaUtilList.get(paramInt1);
    if (localObject == null)
    {
      veg.e("Q.qqstory.record.EditVideoFragment", "deleteFragment error. VideoFragmentInfo = null.");
      return;
    }
    paramInt2 = ((bjzj)localObject).jdField_c_of_type_Int;
    ...
    this.jdField_a_of_type_Bjww.a(Message.obtain(null, 7, paramInt2, 0));
    bjww localbjww = this.jdField_a_of_type_Bjww;
    if (this.jdField_a_of_type_Bjww.a.d()) {}
    for (localObject = "0";; localObject = "1")
    {
      localbjww.b("clk_del", 0, 0, new String[] { "", localObject });
      return;
    }
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localValueAnimator.addListener(new bjvz(this, paramView));
    localValueAnimator.addUpdateListener(new bjwa(this, paramInt3, paramInt1, paramInt4, paramInt2, paramView));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null)
    {
      ...
      if (paramBoolean1) {
        bjzg.b(this.jdField_b_of_type_AndroidWidgetRelativeLayout, paramBoolean3);
      }
    }
    else
    {
    ...
    bjzg.a(this.jdField_b_of_type_AndroidWidgetRelativeLayout, paramBoolean3);
    return;
    label33:
