  ...
  implements bfmb, bfmw, bfmx
{
  ...
  protected bfnf(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, long paramLong2, List<String> paramList, String paramString2, String paramString3, boolean paramBoolean, String paramString4)
  {
    ...
    this.jdField_a_of_type_Bfma = new bfma(paramQQAppInterface, paramList, paramString2, this.jdField_b_of_type_Long, paramBoolean, this);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Bfma.a();
    paramString1 = bfmd.a(this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_Bfmv = new bfmv(paramQQAppInterface, paramLong1, 1, 0, paramLong2, paramBoolean, paramString4);
    this.jdField_a_of_type_Bfmv.a(this);
  }
  
  public static bfmx a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, long paramLong2, List<String> paramList, String paramString2, String paramString3, boolean paramBoolean, String paramString4)
  {
    String str = "";
    if (paramString1 == null) {
    ...
    {
      bfmf.a("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "getFileDownloader " + str);
      return null;
    ...
    return new bfnf(paramQQAppInterface, paramLong1, paramString1, paramLong2, paramList, paramString2, paramString3, paramBoolean, paramString4);
  }
  ...
  private void i()
  {
    ...
    bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] reDownload mstrUrl:" + this.jdField_a_of_type_JavaLangString);
    g();
    if (this.jdField_a_of_type_Bfmy != null) {
      this.jdField_a_of_type_Bfmy.d();
    }
    this.jdField_d_of_type_Long = auea.a(this.jdField_d_of_type_JavaLangString);
  ...
  public void a(int paramInt, String paramString1, String paramString2, HttpMsg paramHttpMsg)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      bfmf.a("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] onErr errCode:" + paramInt + " errMsg:" + paramString1 + " rspHeader:" + paramString2);
      if (this.jdField_a_of_type_Bfma.a(this.jdField_a_of_type_JavaLangString, paramInt, bool))
      {
  ...
  public void a(boolean paramBoolean, int paramInt, String paramString1, String paramString2)
  {
    ...
    {
      bfmf.a("TroopFileDownloader", i, localObject);
      if (this.jdField_a_of_type_Bfmy != null) {
        this.jdField_a_of_type_Bfmy.a(paramBoolean, this.jdField_d_of_type_Long, paramInt, paramString1, paramString2, new Bundle());
      }
      return;
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] onData getted filesize=" + paramLong);
        ...
        try
        {
          ...
          if (!this.jdField_c_of_type_Boolean)
          {
            ...
            this.jdField_a_of_type_Bfma.a(this.jdField_a_of_type_JavaLangString);
          }
    ...
    } while (((this.e != 0L) && (paramLong - this.e < 1000L)) || (this.jdField_a_of_type_Bfmy == null));
    this.jdField_a_of_type_Bfmy.a(this.jdField_d_of_type_Long, this.jdField_c_of_type_Long);
  }
  ...
  public boolean a()
  {
    ...
    try
    {
      ...
      {
        bfmf.b("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] checkexcpover fileSize=0");
        return false;
      }
    }
    ...
    do
    {
      ...
      if (this.jdField_d_of_type_Long == this.jdField_c_of_type_Long)
      {
        bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] checkexcpover tmpfilesize=filesize");
        h();
        return true;
      }
      l1 = this.jdField_c_of_type_Long;
      l2 = this.jdField_d_of_type_Long;
    } while (audf.a().a() >= l1 - l2);
  ...
  public void b()
  {
    ...
    bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] download url:" + this.jdField_a_of_type_JavaLangString);
  ...
  public void b(String paramString)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] onRetry but stoped");
      return;
    }
    int i = 0;
    ...
    {
      i = 1;
      bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] onRetry urlChanged");
    }
    this.jdField_a_of_type_JavaLangString = paramString;
    if (i != 0)
    {
      paramString = bfmd.a(this.jdField_a_of_type_JavaLangString);
      if (paramString != null)
      {
      ...
      this.jdField_a_of_type_Bfmy.b(this.jdField_a_of_type_JavaLangString);
    }
    i();
  }
  ...
  public void c()
  {
    bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] cancelTask");
    this.jdField_a_of_type_Boolean = true;
    f();
    e();
  }
  ...
  public boolean c()
  {
    ...
    {
      bfmf.a("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] openOutputStream excp");
  ...
  {
    e();
    this.jdField_a_of_type_Bfmv.a(this.jdField_a_of_type_JavaLangString, this.jdField_d_of_type_Long);
  }
  ...
  protected void f()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        bfmf.a("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] closeOutputStream excp");
  ...
  protected void g()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        bfmf.a("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] flushOutputStream excp");
        localIOException.printStackTrace();
      }
    }
  }
  ...
  protected void h()
  {
    ...
    bfmf.c("TroopFileDownloader", bfmf.jdField_a_of_type_Int, "[" + this.jdField_b_of_type_Long + "] onSuc. cost:" + (l - this.jdField_a_of_type_Long));
    if (this.jdField_a_of_type_Bfmy != null) {
      this.jdField_a_of_type_Bfmy.a(this.jdField_d_of_type_JavaLangString);
    }
  }
}
