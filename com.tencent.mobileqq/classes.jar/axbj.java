...
{
  public axbj(MsgBackupPCAuthFragment paramMsgBackupPCAuthFragment) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 1)
    {
      ...
      if (MsgBackupPCAuthFragment.a(this.a) > 0)
      {
        ...
        this.a.b.setText(this.a.getString(2131690582, new Object[] { Integer.valueOf(MsgBackupPCAuthFragment.a(this.a)) }));
        if (AppSetting.c) {
          this.a.b.setContentDescription(this.a.getString(2131690582));
        }
      ...
      for (int i = 0;; i = 2)
      {
        ...
        this.a.b.setText(2131690572);
        if (!AppSetting.c) {
          break;
        }
        this.a.b.setContentDescription(this.a.getString(2131690572));
        return true;
        i = 0;
        break label205;
      }
