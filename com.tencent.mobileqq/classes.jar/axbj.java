...
public class axbj
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new axbk(this);
  protected Handler a;
  public axbg a;
  protected QQAppInterface a;
  Runnable jdField_a_of_type_JavaLangRunnable = new QzonePhotoGuideNotifyService.1(this);
  
  public axbj(QQAppInterface paramQQAppInterface, axbg paramaxbg)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Axbg = paramaxbg;
    if (paramQQAppInterface != null) {}
    try
    {
      paramaxbg = new IntentFilter("com.qzonex.localalbum.new_photo_notification_feedback_action");
      paramQQAppInterface.getApp().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramaxbg);
      return;
    }
