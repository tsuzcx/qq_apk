    ...
    try
    {
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localaxbk.jdField_a_of_type_JavaLangString = str1;
            localaxbk.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localaxbk.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localaxbk.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localaxbk.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localaxbk.jdField_a_of_type_Int = 80;
        }
      }
  ...
  public static InetSocketAddress a()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = a();
          str = ((axbk)localObject1).jdField_a_of_type_JavaLangString;
          i = ((axbk)localObject1).jdField_a_of_type_Int;
        }
      }
    }
  }
