...
class bhnx
{
  ...
  private static String b = bhnv.a(bhnv.v);
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    //   8: iload_3
    //   9: istore_2
    //   10: getstatic 13	bhnx:a	Ljava/lang/String;
    //   13: invokestatic 38	bhnx:a	(Ljava/lang/String;)Ljava/security/PublicKey;
    //   16: astore 11
    //   18: aload 11
    //   20: ifnonnull +33 -> 53
    //   23: sipush 129
    ...
    //   168: istore_2
    //   169: aload_0
    //   170: invokestatic 67	bhnw:a	(Ljava/lang/String;)Ljava/util/Map;
    //   173: astore 10
    //   175: aload 10
    ...
    //   264: ifeq -213 -> 51
    //   267: getstatic 26	bhnx:b	Ljava/lang/String;
    //   270: iconst_2
    ...
    //   485: aload 13
    //   487: aload 11
    //   489: invokestatic 133	bhnx:a	([B[BLjava/security/PublicKey;)Z
    //   492: ifne +13 -> 505
    //   495: sipush 137
    //   498: istore_2
    //   499: aload 9
    ...
    //   682: iconst_1
    //   683: aaload
    //   684: invokestatic 154	bhnw:a	(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)I
    //   687: istore 4
    //   689: iload 4
    //   691: ifeq +211 -> 902
    //   694: iconst_0
  ...
  private static PublicKey a(String paramString)
  {
    ...
    try
    {
      paramString = KeyFactory.getInstance(bhnw.a).generatePublic(paramString);
      return paramString;
    }
  ...
  private static boolean a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, PublicKey paramPublicKey)
  {
    try
    {
      Signature localSignature = Signature.getInstance(bhnw.b);
