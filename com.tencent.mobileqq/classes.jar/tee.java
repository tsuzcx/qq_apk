  ...
  extends syq
{
  ...
  public tee(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((qqstory_service.RspGetFilterList)localObject1).is_end.get() != 0)
        {
          ...
          localtdw.jdField_a_of_type_Long = ((qqstory_struct.FilterListPack)localObject2).filter_id.get();
          localtdw.jdField_a_of_type_JavaLangString = ((qqstory_struct.FilterListPack)localObject2).filter_name.get().toStringUtf8();
          localtdw.jdField_a_of_type_Int = ((qqstory_struct.FilterListPack)localObject2).filter_type.get();
          localtdw.jdField_b_of_type_JavaLangString = ((qqstory_struct.FilterListPack)localObject2).filter_config_file.get().toStringUtf8();
          localtdw.c = ((qqstory_struct.FilterListPack)localObject2).filter_config_md5.get().toStringUtf8();
          try
          {
            localObject2 = localtdw.a();
            paramArrayOfByte.add(localObject2);
            veg.d("VideoFilterManager", "GET Filter : id=%d, name=%s, type=%d, url=%s, md5=%s", new Object[] { Long.valueOf(((FilterItem)localObject2).filterId), ((FilterItem)localObject2).filterName, Integer.valueOf(((FilterItem)localObject2).filterType), ((FilterItem)localObject2).filterConfigUrl, ((FilterItem)localObject2).filterConfigMd5 });
          }
          catch (FilterItem.FilterItemIllegalException localFilterItemIllegalException)
          {
            veg.c("VideoFilterManager", "GET Filter error : ", localFilterItemIllegalException);
          }
          continue;
        }
        bool = false;
      ...
      {
        veg.e("VideoFilterManager", "GetEmojiPackInfoListRequest error : " + paramArrayOfByte);
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_JavaLangString = ajyc.a(2131716261);
