  ...
  implements apts<String>
{
  ...
  public static ofr a()
  {
    ofr localofr = new ofr();
    localofr.jdField_a_of_type_JavaLangString = uex.jdField_d_of_type_JavaLangString;
    localofr.jdField_b_of_type_JavaLangString = uex.jdField_e_of_type_JavaLangString;
    localofr.jdField_b_of_type_Boolean = uex.jdField_a_of_type_Boolean;
    localofr.jdField_c_of_type_Boolean = uex.p;
    localofr.jdField_a_of_type_Boolean = uex.jdField_b_of_type_Boolean;
    localofr.jdField_d_of_type_Boolean = uex.jdField_e_of_type_Boolean;
    localofr.jdField_e_of_type_Boolean = uex.jdField_f_of_type_Boolean;
    localofr.jdField_f_of_type_Boolean = uex.jdField_g_of_type_Boolean;
    localofr.jdField_g_of_type_Boolean = uex.jdField_h_of_type_Boolean;
    localofr.jdField_h_of_type_Boolean = uex.jdField_i_of_type_Boolean;
    localofr.jdField_i_of_type_Boolean = uex.l;
    localofr.j = uex.j;
    localofr.jdField_c_of_type_JavaLangString = uex.jdField_f_of_type_JavaLangString;
    localofr.jdField_a_of_type_Long = uex.jdField_a_of_type_Long;
    localofr.k = uex.m;
    localofr.jdField_a_of_type_Int = uex.jdField_b_of_type_Int;
    localofr.jdField_d_of_type_JavaLangString = uex.jdField_i_of_type_JavaLangString;
    localofr.l = uex.n;
    localofr.m = uex.jdField_c_of_type_Boolean;
    localofr.n = uex.o;
    localofr.jdField_a_of_type_JavaUtilArrayList = uex.jdField_a_of_type_JavaUtilArrayList;
    localofr.jdField_b_of_type_Int = uex.jdField_c_of_type_Int;
    localofr.jdField_c_of_type_Int = uex.jdField_d_of_type_Int;
    localofr.jdField_d_of_type_Int = uex.jdField_e_of_type_Int;
    localofr.o = uex.k;
    Object localObject = uex.jdField_g_of_type_JavaLangString;
    localofr.jdField_e_of_type_JavaLangString = ((String)localObject);
    localofr.jdField_f_of_type_JavaLangString = uex.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localofr, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localofr, (JSONObject)localObject);
        }
      }
      return localofr;
    }
  ...
  private ofr a(ofr paramofr, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramofr.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramofr.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramofr.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramofr.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramofr.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramofr.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramofr.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramofr.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramofr.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramofr.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramofr.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramofr.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramofr.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramofr.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramofr.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramofr.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramofr.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramofr.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramofr.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramofr.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramofr.jdField_e_of_type_JavaLangString;
          this.p = paramofr.p;
          this.jdField_e_of_type_Int = paramofr.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramofr.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramofr.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramofr.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramofr.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramofr.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramofr)
      {
        paramofr.printStackTrace();
      }
    }
    return this;
  }
  
  public static ofr a(aptx[] paramArrayOfaptx)
  {
    Object localObject1 = new ofr();
    ...
    if (paramArrayOfaptx != null)
    {
      ...
      if (paramArrayOfaptx.length > 0)
      {
        ...
        for (;;)
        {
          if (i1 >= paramArrayOfaptx.length) {
            break label94;
          }
          str = paramArrayOfaptx[i1].jdField_a_of_type_JavaLangString;
          try
          {
            localObject2 = ((ofr)localObject1).a((ofr)apul.a(str, ofr.class), str);
  ...
  private static void a(ofr paramofr, JSONObject paramJSONObject)
  {
    paramofr.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(ofr paramofr, JSONObject paramJSONObject)
  {
    paramofr.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramofr.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramofr.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramofr.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramofr.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    uex.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    uex.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    uex.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    uex.p = this.jdField_c_of_type_Boolean;
    uex.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    uex.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    uex.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    uex.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    uex.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    uex.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    uex.l = this.jdField_i_of_type_Boolean;
    uex.j = this.j;
    uex.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    uex.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    uex.m = this.k;
    uex.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    uex.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    uex.n = this.l;
    uex.jdField_c_of_type_Boolean = this.m;
    uex.o = this.n;
    uex.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    uex.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    uex.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    uex.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    uex.k = this.o;
    uex.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    uex.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      uex.b((QQAppInterface)localAppRuntime);
    }
  }
}
