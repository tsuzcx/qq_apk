...
{
  public ofr(EditVideoPartManager paramEditVideoPartManager, GenerateContext paramGenerateContext, long paramLong) {}
  ...
  public void a(GenerateContext paramGenerateContext)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.a() == 9) && ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoPublishGenerateContext.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
      {
        paramGenerateContext = (EditLocalVideoSource)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoPublishGenerateContext.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
        ((Intent)localObject1).putExtra("local_video_time_start", paramGenerateContext.a);
        ((Intent)localObject1).putExtra("local_video_time_end", paramGenerateContext.b);
      }
