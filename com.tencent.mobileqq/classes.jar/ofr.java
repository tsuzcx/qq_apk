...
public class ofr
{
  private static final Map<Integer, owa> a = new HashMap();
  ...
  {
    beoj.a("ProteusSupportUtilDynamic.getView");
    ...
    {
      localContainer.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841186));
  ...
  private static TemplateBean a(int paramInt, BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    //   96: aload_2
    //   97: iconst_1
    //   98: invokestatic 150	rdg:a	(Ljava/lang/String;Z)Lrdg;
    //   101: astore_1
    //   102: aload_1
    //   103: ifnull +12 -> 115
    //   106: aload_1
    //   107: aload 4
    //   109: invokevirtual 154	rdg:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   112: astore_1
    //   113: aload_1
    //   114: areturn
    //   115: aconst_null
  ...
  private static TemplateBean a(VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    rdg localrdg = (rdg)paramVafContext.getTemplateFactory();
    paramVafContext = localrdg;
    if (localrdg == null) {
      paramVafContext = rdg.a(paramString2, true);
    }
    ...
    for (;;)
    {
      try
      {
        paramVafContext = paramVafContext.getTemplateBean(localosn.a(paramString1).a());
  ...
  private static void a(int paramInt, owa paramowa)
  {
    ...
    a.put(Integer.valueOf(paramInt), paramowa);
  }
  ...
  {
    beoj.a("ProteusSupportUtilDynamic.bindData");
    ...
    paramProteusItemView.setTag(2131309081, paramString);
    beoj.a("ProteusSupportUtilDynamic.bindDataImpl");
    if (paramString != null) {
      oag.a(paramProteusItemView, localTemplateBean, paramString);
    }
    beoj.a();
    oag.a(paramProteusItemView, paramVafContext, paramString);
    beoj.a();
  }
