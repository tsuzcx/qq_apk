...
class sux
  implements Runnable
{
  sux(suw paramsuw, oidb_0x791.RedDotInfo paramRedDotInfo, TroopRedTouchManager paramTroopRedTouchManager) {}
  ...
  public void run()
  {
    ...
    int i;
    int j;
    if ((Leba.a(this.jdField_a_of_type_Suw.a) != null) && (Leba.c(this.jdField_a_of_type_Suw.a) != null))
    {
      if (QLog.isDevelopLevel()) {
        QLog.d("XingquBuluo", 4, "updateXingquBuluoRedFlag");
      }
      Leba.a(this.jdField_a_of_type_Suw.a).setVisibility(8);
      Leba.a(this.jdField_a_of_type_Suw.a).setImageDrawable(null);
      boolean bool = SharedPreUtils.k(this.jdField_a_of_type_Suw.a.a(), this.jdField_a_of_type_Suw.a.a.getCurrentAccountUin());
    ...
    for (;;)
    {
      CustomWidgetUtil.a(Leba.c(this.jdField_a_of_type_Suw.a), j, i, 0);
      CustomWidgetUtil.a(this.jdField_a_of_type_Suw.a.a(), Leba.c(this.jdField_a_of_type_Suw.a), j);
      this.jdField_a_of_type_Suw.a.a(1);
      if ((AppSetting.b) && (localObject1 != null))
      {
        if ((j == 3) && (i > 0)) {
          Leba.b(this.jdField_a_of_type_Suw.a).setContentDescription("兴趣部落 " + i + "条更新");
        }
      }
      else
      {
        ...
        if (localRedDotInfo != null)
        {
          ...
          try
          {
            localDrawable = this.jdField_a_of_type_Suw.a.a().getDrawable(2130839128);
            ...
            if (localRedDotInfo.str_face_url.has())
            {
              ...
              if (localRedDotInfo.str_face_url.get() != null)
              {
                ...
                {
                  i = AIOUtils.a(31.0F, this.jdField_a_of_type_Suw.a.a());
            ...
            try
            {
              ...
              if (localObject1 == null)
              {
                ...
                if (localRedDotInfo.uint64_cmd_uin.has()) {
                  localObject3 = FaceDrawable.a(this.jdField_a_of_type_Suw.a.a, String.valueOf(localRedDotInfo.uint64_cmd_uin.get()), (byte)3);
                }
              }
              if (localObject3 != null)
              {
                Leba.a(this.jdField_a_of_type_Suw.a).setImageDrawable((Drawable)localObject3);
                Leba.a(this.jdField_a_of_type_Suw.a).setVisibility(0);
                i = 0;
                j = 1;
            ...
            catch (Exception localException)
            {
              for (;;)
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  localObject2 = localObject3;
                  continue;
                  Leba.a(this.jdField_a_of_type_Suw.a).setImageDrawable(localDrawable);
                }
              }
            }
          }
      ...
      Leba.b(this.jdField_a_of_type_Suw.a).setContentDescription("兴趣部落 有更新");
      return;
      label635:
      j = 0;
      i = 0;
