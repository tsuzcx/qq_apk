...
public class avzk
{
  ...
  private final avzt jdField_a_of_type_Avzt;
  ...
  static
  {
    if (!avzk.class.desiredAssertionStatus()) {}
  ...
  public avzk(DecodeConfig paramDecodeConfig, avzt paramavzt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Avzl = a(this.jdField_a_of_type_AndroidMediaMediaExtractor);
      if (this.jdField_a_of_type_Avzl.jdField_a_of_type_Int >= 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("HWAudioRecoder", 1, "audio track normal");
        }
        this.jdField_a_of_type_Avzt.a(1, this.jdField_a_of_type_Avzl.jdField_a_of_type_AndroidMediaMediaFormat);
        this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(this.jdField_a_of_type_Avzl.jdField_a_of_type_Int);
        if (this.jdField_a_of_type_Avzl.jdField_a_of_type_AndroidMediaMediaFormat.containsKey("max-input-size")) {
          this.jdField_a_of_type_Int = this.jdField_a_of_type_Avzl.jdField_a_of_type_AndroidMediaMediaFormat.getInteger("max-input-size");
        }
        if (this.jdField_a_of_type_Avzl.jdField_b_of_type_Int >= 0)
        {
          this.jdField_a_of_type_Avzt.a(2);
          this.jdField_a_of_type_Avzt.a(2, this.jdField_a_of_type_Avzl.jdField_b_of_type_AndroidMediaMediaFormat);
          this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(this.jdField_a_of_type_Avzl.jdField_b_of_type_Int);
          if (this.jdField_a_of_type_Avzl.jdField_b_of_type_AndroidMediaMediaFormat.containsKey("max-input-size"))
          {
            int i = this.jdField_a_of_type_Avzl.jdField_b_of_type_AndroidMediaMediaFormat.getInteger("max-input-size");
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_a_of_type_Avzt.a(0);
        this.jdField_a_of_type_Avzt.a(1, null);
        if (QLog.isColorLevel()) {
  ...
  public avzl a(MediaExtractor paramMediaExtractor)
  {
    avzl localavzl = new avzl();
    ...
    if (i < j)
    {
      ...
      l1 = l2;
      if (localavzl.jdField_a_of_type_Int >= 0) {
        break label206;
      }
      l1 = l2;
      ...
      if (l2 == 1L)
      {
        localavzl.jdField_a_of_type_Int = i;
        localavzl.jdField_a_of_type_JavaLangString = str;
        localavzl.jdField_a_of_type_AndroidMediaMediaFormat = localMediaFormat;
        label99:
        l1 = l2;
        if (l2 < 2L) {
          break label206;
    ...
    {
      this.b = bool;
      QLog.d("HWAudioRecoder", 1, new Object[] { "getAudioTrack, ", Integer.valueOf(localavzl.jdField_a_of_type_Int), " ", Integer.valueOf(localavzl.jdField_b_of_type_Int) });
      return localavzl;
      if (l2 != 2L) {
        break label99;
      }
      localavzl.jdField_b_of_type_Int = i;
      localavzl.jdField_b_of_type_JavaLangString = str;
      localavzl.jdField_b_of_type_AndroidMediaMediaFormat = localMediaFormat;
      break label99;
      i += 1;
      l2 = l1;
      break;
  ...
  public boolean b()
  {
    ...
    if (j < 0)
    {
      ...
      this.jdField_a_of_type_Avzt.a(1, this.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
      this.jdField_a_of_type_Avzt.a(2, this.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
      this.c = true;
      this.d = true;
      return true;
    }
    if (j == this.jdField_a_of_type_Avzl.jdField_a_of_type_Int) {
      i = 1;
    }
    int k;
    long l;
    while (j == this.jdField_a_of_type_Avzl.jdField_b_of_type_Int)
    {
      this.jdField_a_of_type_JavaNioByteBuffer.clear();
    ...
    if ((k < 0) || ((this.jdField_a_of_type_Long > 0L) && (l > this.jdField_a_of_type_Long)))
    {
      this.jdField_a_of_type_JavaNioByteBuffer.clear();
      this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.set(0, 0, 0L, 4);
      this.jdField_a_of_type_Avzt.a(i, this.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
      if (j == this.jdField_a_of_type_Avzl.jdField_a_of_type_Int)
      {
        this.c = true;
        return true;
