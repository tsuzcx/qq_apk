...
class voh
{
  static String a(InputStream paramInputStream)
  {
    ...
    {
      urk.c("Q.qqstory.ffmpeg.FFmpeg", "error converting input stream to string", paramInputStream);
      return null;
    }
  ...
  static void a(vnp paramvnp)
  {
    if ((paramvnp != null) && (!paramvnp.a()))
    {
      if (paramvnp.jdField_a_of_type_JavaLangProcess != null)
      {
        paramvnp.jdField_a_of_type_JavaLangProcess.destroy();
        paramvnp.jdField_a_of_type_JavaLangProcess = null;
      }
      if (!paramvnp.isCancelled()) {
        paramvnp.cancel(true);
      }
      urk.e("Q.qqstory.ffmpeg.FFmpeg", "kill ffmpeg task", new Object[] { Arrays.toString(paramvnp.jdField_a_of_type_ArrayOfJavaLangString) });
    }
  }
