  ...
  implements rzt
{
  ...
  public rwa(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, sgh paramsgh, VideoFeedsPlayManager paramVideoFeedsPlayManager, ViewGroup paramViewGroup)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rwb(this));
  ...
  private void j()
  {
    try
    {
      this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new rwe(this));
      return;
    }
  ...
  public void a(AnchorData paramAnchorData)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
    {
      ...
      rwv.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 100);
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      if (this.jdField_a_of_type_Rwf != null) {
        this.jdField_a_of_type_Rwf.a(true);
      }
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Rwf = paramrwf;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = (rwv.c(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) - this.jdField_a_of_type_Int);
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(rzv.a());
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(2);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new rwc(this), this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  public void f()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Rwf != null) {
        this.jdField_a_of_type_Rwf.a(false);
      }
    }
  }
  ...
  public void g()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
    {
      ...
      {
        e();
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(new rwd(this));
      }
    }
    else {
      return;
