...
public class rwa
{
  ...
  static
  {
    jdField_b_of_type_JavaLangString = "QQ/8.2.8 Android/0.17 Android/" + Build.VERSION.RELEASE;
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
      {
        ...
        {
          Object localObject2 = bcfx.a(paramString);
          if ((localObject2 != null) && (!TextUtils.isEmpty(((bcfy)localObject2).jdField_b_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ViolaAccessHelper", 2, "load offline想 data cache on loadRes");
            }
            return ((bcfy)localObject2).jdField_b_of_type_JavaLangString;
          }
          try
          {
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              localObject2 = mzk.a((String)localObject1);
  ...
  public static void a()
  {
    ...
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_JavaLangString = onk.a();
    }
    if (QLog.isColorLevel()) {
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      ...
      else
      {
        ...
        {
          localObject3 = paramBundle.getString("margin_top", null);
          localObject2 = localObject1;
          if (!TextUtils.isEmpty((CharSequence)localObject3))
          {
            localObject2 = localObject1;
            if (!"null".equals(localObject3)) {
              localObject2 = (String)localObject1 + "&v_present_top=" + paramBundle.getString("margin_top");
            }
          }
        }
        localObject1 = localObject2;
    ...
    label533:
    label541:
    for (localObject1 = "&v_present_back_bar=1";; localObject1 = "&v_present_back_bar=0")
    {
      localObject1 = (String)localObject1;
      localObject2 = localObject1;
      if (paramBundle.containsKey("floating_window_scene"))
      {
        paramInt = paramBundle.getInt("floating_window_scene", 0);
        localObject2 = localObject1;
        if (paramInt == 4) {
          localObject2 = (String)localObject1 + "&v_present_interrupt_back=1";
        }
        localObject2 = (String)localObject2 + "&presentFrom=" + paramInt;
      }
      a(paramContext, "", (String)localObject2, paramBundle, false);
      return;
  ...
  @Deprecated
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, rwi paramrwi)
  {
    if (!a(paramContext)) {
      if (paramrwi != null) {
        paramrwi.a();
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        label387:
        abtu.a((Activity)paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class);
      }
      label405:
      ...
      abtu.a((Activity)paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class, paramBundle.getInt("requestCode", -1));
      ...
      localIntent.putExtra("public_fragment_window_feature", 1);
      abtu.a(paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class);
      ((Activity)paramContext).overridePendingTransition(2130772010, 0);
      return;
      label536:
    ...
    if ((paramContext instanceof SplashActivity))
    {
      ...
      localIntent.putExtra(rxe.jdField_a_of_type_JavaLangString, paramString1);
      if (paramBundle != null) {
  ...
  public static void a(Context paramContext, String paramString, rwi paramrwi) {}
  ...
  /* Error */
  public static void a(com.tencent.common.app.AppInterface paramAppInterface, String paramString, rww paramrww, rwg paramrwg)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 251	com/tencent/viola/core/ViolaSDKEngine:isInitialized	()Z
    //   6: ifne +91 -> 97
    //   9: new 707	com/tencent/viola/core/InitConfig$Builder
    //   12: dup
    //   13: invokespecial 708	com/tencent/viola/core/InitConfig$Builder:<init>	()V
    //   16: iconst_1
    //   17: invokevirtual 712	com/tencent/viola/core/InitConfig$Builder:setBusinessId	(I)Lcom/tencent/viola/core/InitConfig$Builder;
    //   20: aload_1
    //   21: invokevirtual 716	com/tencent/viola/core/InitConfig$Builder:setFramework	(Ljava/lang/String;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   24: new 718	rwp
    //   27: dup
    //   28: invokespecial 719	rwp:<init>	()V
    //   31: invokevirtual 723	com/tencent/viola/core/InitConfig$Builder:setHttpAdapter	(Lcom/tencent/viola/adapter/IHttpAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   34: new 725	rwy
    //   37: dup
    //   38: invokespecial 726	rwy:<init>	()V
    //   41: invokevirtual 730	com/tencent/viola/core/InitConfig$Builder:setComponentAdapter	(Lcom/tencent/viola/adapter/VComponentAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   44: aload_2
    //   45: invokevirtual 734	com/tencent/viola/core/InitConfig$Builder:setReportDelegate	(Lcom/tencent/viola/commons/IReportDelegate;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   48: new 736	rwv
    //   51: dup
    //   52: invokespecial 737	rwv:<init>	()V
    //   55: invokevirtual 741	com/tencent/viola/core/InitConfig$Builder:setLogAdapter	(Lcom/tencent/viola/adapter/ILogAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   58: astore_2
    //   59: aload_0
    //   60: ifnull +32 -> 92
    //   63: aload_0
    //   64: invokevirtual 747	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   67: astore_1
    //   68: aload_1
    //   69: aload_2
    //   70: invokevirtual 751	com/tencent/viola/core/InitConfig$Builder:build	()Lcom/tencent/viola/core/InitConfig;
    //   73: new 753	rwe
    //   76: dup
    //   77: aload_3
    //   78: aload_0
    //   79: invokespecial 756	rwe:<init>	(Lrwg;Lcom/tencent/common/app/AppInterface;)V
    //   82: invokestatic 757	rys:a	()Ljava/lang/String;
    //   85: invokestatic 761	com/tencent/viola/core/ViolaSDKEngine:initialize	(Landroid/app/Application;Lcom/tencent/viola/core/InitConfig;Lcom/tencent/viola/core/ViolaSDKEngine$InitCallback;Ljava/lang/String;)V
    //   88: ldc 2
    //   90: monitorexit
    //   91: return
    //   92: aconst_null
    ...
    //   100: ldc_w 765
    //   103: iconst_0
    //   104: invokestatic 769	com/tencent/viola/core/ViolaSDKEngine:registerModule	(Ljava/lang/String;Ljava/lang/Class;Z)Z
    //   107: pop
    //   108: aload_3
    //   109: ifnull -21 -> 88
    //   112: aload_0
    //   113: new 771	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5
    //   116: dup
    //   117: aload_3
    //   118: invokespecial 774	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5:<init>	(Lrwg;)V
    //   121: invokevirtual 778	com/tencent/common/app/AppInterface:runOnUiThread	(Ljava/lang/Runnable;)V
    //   124: goto -36 -> 88
    //   127: astore_0
    ...
    //   150: aload_0
    //   151: invokevirtual 424	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   0	172	2	paramrww	rww
    //   0	172	3	paramrwg	rwg
    // Exception table:
    //   from	to	target	type
  ...
  @Deprecated
  public static void a(String paramString, rwg paramrwg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)onk.a();
    if ((localQQAppInterface == null) && (paramrwg != null))
    {
      paramrwg.a();
      return;
    }
    a(localQQAppInterface, paramString, null, paramrwg);
  }
  
  public static void a(String paramString, rwh paramrwh)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)onk.a();
    ...
    ThreadManager.post(new ViolaAccessHelper.3(paramString, localQQAppInterface, paramrwh, System.currentTimeMillis()), 8, null, true);
  }
  
  public static void a(String paramString, sac paramsac)
  {
    ThreadManager.post(new ViolaAccessHelper.6(paramString, paramsac), 8, null, false);
  }
  ...
  private static boolean a(Context paramContext)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            a(paramContext, ajyc.a(2131716464));
          } while (!QLog.isColorLevel());
          ...
          a(paramContext, ajyc.a(2131716466));
        } while (!QLog.isColorLevel());
        QLog.d("ViolaAccessHelper", 2, "isViolaPermit checkSO is false");
        return false;
        str = rys.b("https://kd.qpic.cn/viola/lib/viola.js?v_bid=3547");
        if (!TextUtils.isEmpty(str)) {
          break;
        }
      ...
      a(paramContext, ajyc.a(2131716465));
      if (QLog.isColorLevel()) {
  ...
  {
    a("http://sqimg.qq.com/qq_product_operations/kan/viola_config/viola_config.json?v_bid=3192", new rwf());
  }
