...
public class aiad
{
  ...
  private aiae jdField_a_of_type_Aiae;
  ...
  public aiad(ahzx paramahzx, float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.jdField_a_of_type_Ahzx = paramahzx;
    Object localObject = this.jdField_a_of_type_Ahzx.getContext();
    this.jdField_a_of_type_Float = (bbll.a() * 0.0375F);
    this.jdField_b_of_type_Float = paramFloat2;
    this.jdField_c_of_type_Float = (this.jdField_a_of_type_Float * 0.5F);
    this.d = paramInt3;
    paramahzx = a(((Context)localObject).getResources(), 2130848206, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    localObject = a(((Context)localObject).getResources(), 2130848208, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    ...
    if (paramahzx != null) {
      localCanvas.drawBitmap(paramahzx, (this.jdField_a_of_type_Float - paramahzx.getWidth()) / 2.0F, (this.jdField_b_of_type_Float - paramahzx.getHeight()) / 2.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
  ...
  public void a()
  {
    this.jdField_a_of_type_Aiae = null;
  ...
  public void a(aiae paramaiae)
  {
    this.jdField_a_of_type_Aiae = paramaiae;
  }
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aiae == null) {
        break;
      }
      this.jdField_a_of_type_Aiae.a(this.e, this.f);
      return;
      label148:
      if (this.f - f1 < this.g)
      {
