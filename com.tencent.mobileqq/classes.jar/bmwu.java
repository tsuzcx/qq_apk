  ...
  extends DynamicTextItem
{
  ...
  bmxb jdField_b_of_type_Bmxb;
  private String jdField_b_of_type_JavaLangString = "05/09";
  bmxb jdField_c_of_type_Bmxb;
  ...
  static
  {
    ...
    jdField_b_of_type_Int = AIOUtils.dp2px(18.0F, localResources);
    d = AIOUtils.dp2px(6.0F, localResources);
    int n = bnnl.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - bngn.a - n * 2;
  }
  
  public bmwu(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
    ...
    if (paramTypeface == null)
    {
      ...
      this.k = AIOUtils.dp2px(41.0F, BaseApplicationImpl.getContext().getResources());
      ...
      this.g = AIOUtils.dp2px(34.0F, BaseApplicationImpl.getContext().getResources());
      this.h = AIOUtils.dp2px(45.0F, BaseApplicationImpl.getContext().getResources());
      this.l = AIOUtils.dp2px(4.0F, BaseApplicationImpl.getContext().getResources());
      this.m = AIOUtils.dp2px(3.0F, BaseApplicationImpl.getContext().getResources());
      this.jdField_c_of_type_Bmxb = new bmxb(0);
      this.jdField_c_of_type_Bmxb.a(new bmwm(-1, this.l, this.m));
      ...
      this.j = AIOUtils.dp2px(19.0F, BaseApplicationImpl.getContext().getResources());
      ...
      this.jdField_b_of_type_JavaLangString = bmxl.a();
      localTextPaint.setAntiAlias(true);
      localTextPaint.setTextSkewX(-0.15F);
      localTextPaint.setStyle(Paint.Style.FILL_AND_STROKE);
      this.i = AIOUtils.dp2px(23.0F, BaseApplicationImpl.getContext().getResources());
      localTextPaint.setTextSize(this.i);
      localTextPaint.setColor(-1);
      this.jdField_b_of_type_Bmxb = new bmxb(0);
      this.jdField_b_of_type_Bmxb.a(new bmwm(-16777216, this.l, this.m));
      this.jdField_b_of_type_Bmxb.a(this.jdField_b_of_type_JavaLangString, jdField_c_of_type_Int, this.i, localTextPaint);
      if (paramList != null) {
        break label541;
      }
    }
  ...
  public int a(MotionEvent paramMotionEvent, float paramFloat1, float paramFloat2, @Nullable bngq parambngq, bnnn parambnnn)
  {
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    if (parambngq != null) {
      return parambnnn.a(parambngq, f1, f2);
    }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bmwv(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.f = AIOUtils.dp2px(18.0F, BaseApplicationImpl.getContext().getResources());
    if (paramInt == 0)
    {
      paramString = " " + paramString;
      this.jdField_a_of_type_Bmxb = new bmxb(0);
      this.jdField_a_of_type_Bmxb.a(new bmwm(-16777216, this.l, this.m));
      this.jdField_a_of_type_Bmxb.a(paramString, jdField_c_of_type_Int, this.k, this.jdField_b_of_type_AndroidTextTextPaint);
      this.jdField_a_of_type_Float = Math.max(this.jdField_a_of_type_Bmxb.a(), this.jdField_b_of_type_Bmxb.a());
      this.jdField_a_of_type_Float = Math.max(this.jdField_c_of_type_Bmxb.a(), this.jdField_a_of_type_Float);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Bmxb.b() + this.g + this.jdField_b_of_type_Bmxb.b() + this.h + this.jdField_c_of_type_Bmxb.b());
      return;
    }
  ...
  {
    this.e = 0;
    this.jdField_a_of_type_Bmxb.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_a_of_type_Bmxb.b()));
    this.e += this.g;
    this.jdField_b_of_type_Bmxb.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_b_of_type_Bmxb.b()));
    this.e += this.h;
    this.jdField_c_of_type_Bmxb.a(paramCanvas, 0, this.e);
    if (super.b(1))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.set(this.jdField_c_of_type_Bmxb.a(2, this.jdField_c_of_type_Bmxb.a()));
    ...
    this.e = ((int)(this.e + this.jdField_c_of_type_Bmxb.b()));
    if (super.b(0))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.left = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.top = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.right = this.jdField_a_of_type_Bmxb.a();
      this.jdField_a_of_type_AndroidGraphicsRectF.bottom = this.jdField_a_of_type_Bmxb.b();
