  ...
  extends PagerAdapter
{
  ...
  public axmt(CaptureVideoFilterViewPager paramCaptureVideoFilterViewPager)
  {
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (View)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      ((View)localObject2).setContentDescription(localFilterCategoryItem.b + "," + localFilterCategoryItem.f + alpo.a(2131701818));
