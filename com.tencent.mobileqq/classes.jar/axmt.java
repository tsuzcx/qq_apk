...
public class axmt
{
  ...
  static
  {
    ...
    for (;;)
    {
      if (i < axmo.jdField_b_of_type_ArrayOfJavaLangString.length)
      {
        if (TextUtils.equals("2920", axmo.jdField_b_of_type_ArrayOfJavaLangString[i])) {
      ...
      {
        g = 0;
        e = actn.a(22.0F, BaseApplicationImpl.getApplication().getApplicationContext().getResources());
        f = actn.a(40.0F, BaseApplicationImpl.getApplication().getApplicationContext().getResources());
        return;
      }
      i += 1;
    }
  ...
  {
    int i = 0;
    while (i < axmo.jdField_b_of_type_ArrayOfJavaLangString.length)
    {
      if (TextUtils.equals(paramString, axmo.jdField_b_of_type_ArrayOfJavaLangString[i])) {
        return i;
      }
      i += 1;
    }
  ...
  public static void a(ImmersiveTitleBar2 paramImmersiveTitleBar2, Window paramWindow)
  {
    ...
    for (;;)
    {
      ...
      if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramImmersiveTitleBar2 != null)) {
        paramImmersiveTitleBar2.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131166910));
      }
    }
  }
  ...
  public static void a(SystemBarCompact paramSystemBarCompact, Window paramWindow, Boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramSystemBarCompact != null)) {
        paramSystemBarCompact.setStatusBarColor(2131166910);
      }
    }
  }
  ...
  private static final void a(String paramString)
  {
    ...
    {
      localObject = (axmp)((QQAppInterface)localObject).a(154);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((axmp)localObject).a(bool, i);
      ((axmp)localObject).notifyUI(4, true, new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), paramString });
  ...
  {
    if ((paramInt < 0) || (paramInt >= axmo.jdField_b_of_type_ArrayOfJavaLangString.length))
    {
      if (QLog.isColorLevel()) {
  ...
  public static final int c()
  {
    ...
    for (;;)
    {
      ...
      return i;
      i = axmo.jdField_b_of_type_ArrayOfInt[i];
    }
  }
  ...
  public static int d()
  {
    ...
    for (;;)
    {
      ...
      return i;
      label155:
      i = axmo.jdField_b_of_type_ArrayOfInt[k];
    }
  }
