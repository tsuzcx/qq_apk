...
public class atox
  extends atos
{
  public atox(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    super(paramQQAppInterface, paramContext);
  }
  
  protected bftf a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForTroopFile))
    {
      paramChatMessage = (MessageForTroopFile)paramChatMessage;
      return bgsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
    }
        ...
        do
        {
          ...
          do
          {
            do
            {
              ...
              paramaggl = a(paramChatMessage);
            } while (paramaggl == null);
            int i = bhnv.a((Activity)this.jdField_a_of_type_AndroidContentContext);
            if (paramInt != 0) {
              break;
            }
          ...
          localTroopFileTransferManager.d(paramaggl.jdField_a_of_type_JavaUtilUUID);
          return;
        } while (paramInt != 1);
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A887", "0X800A887", 0, 0, "", "", "", "");
        paramChatMessage = new bfsf(Long.parseLong(paramChatMessage.frienduin), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext);
        if ((paramaggl.b != 10) && (paramaggl.b != 9)) {
          break;
        }
      } while (paramaggl.jdField_a_of_type_JavaUtilUUID == null);
      paramChatMessage.b(paramaggl.jdField_a_of_type_JavaUtilUUID);
      return;
      if (paramaggl.b == 7)
      {
        paramChatMessage.a(paramView.url, paramaggl.g, paramaggl.c, paramaggl.h);
        return;
      }
    } while ((paramaggl.b != 6) || (bhmi.b(paramaggl.jdField_a_of_type_JavaLangString)));
    paramChatMessage.a(paramView.url, paramaggl.g, paramaggl.c, paramaggl.h);
  }
  ...
  protected boolean a(ChatMessage paramChatMessage)
  {
    ...
    int i = aunj.a(paramChatMessage.g);
    if ((i == 0) || (i == 2)) {
      return false;
    }
    ...
    if ((paramChatMessage.b == 10) || (paramChatMessage.b == 9) || (paramChatMessage.b == 7)) {
      return !bhmi.b(paramChatMessage.jdField_a_of_type_JavaLangString);
    }
    return (paramChatMessage.b == 6) && (!bhmi.b(paramChatMessage.jdField_a_of_type_JavaLangString));
  }
