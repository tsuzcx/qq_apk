...
public class ajyk
{
  public static Dialog a(Activity paramActivity, View.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setContentView(2131560796);
    Button localButton1 = (Button)paramActivity.findViewById(2131363439);
    Button localButton2 = (Button)paramActivity.findViewById(2131363450);
    localButton1.setOnClickListener(new ajyl(paramActivity));
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramString.exists())
          {
            ...
            bawu.a(paramString.getAbsolutePath(), localOptions);
            int i = localOptions.outWidth;
            if (i > 150) {
              localOptions.inSampleSize = (i / 150);
            }
            localOptions.inJustDecodeBounds = false;
            paramString = bawu.a(paramString.getAbsolutePath(), localOptions);
            return paramString;
          }
        }
  ...
  public static bbgg a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    int i = paramActivity.getRequestedOrientation();
    paramActivity.setRequestedOrientation(1);
    paramQQAppInterface = bbcv.a(paramActivity, 0, 2131559731, paramActivity.getString(2131693320), null, paramActivity.getString(2131693723), paramActivity.getString(2131693065), new ajym(paramActivity, paramQQAppInterface), new ajyn(paramQQAppInterface));
    paramQQAppInterface.setOnDismissListener(new ajyo(paramActivity, i));
    paramQQAppInterface.getBtnight().setTypeface(Typeface.DEFAULT_BOLD);
    paramQQAppInterface.setMessageCount(paramActivity.getString(2131693319));
    paramQQAppInterface.setPreviewImage(paramActivity.getResources().getDrawable(2130842040), true, 1);
    paramQQAppInterface.show();
    return paramQQAppInterface;
  }
  
  public static bbgg a(HotChatInfo paramHotChatInfo, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramHotChatInfo = bbcv.a(localBaseActivity, 230, localBaseActivity.getString(2131693315), localBaseActivity.getString(2131693314), 2131690596, 2131692201, paramOnClickListener, new ajyp());
    paramOnClickListener = (TextView)paramHotChatInfo.findViewById(2131365147);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 17;
    paramOnClickListener.setLayoutParams(localLayoutParams);
    paramHotChatInfo.setOnDismissListener(new ajyq(localBaseActivity, i));
  ...
  {
    paramString5 = new bbjc(paramBaseActivity);
    paramString5.a(paramBaseActivity.getString(2131719497));
    paramString5.a(a(paramBaseActivity));
    paramString5.a(new ajyr(paramString5, paramInt, paramQQAppInterface, paramBaseActivity, paramString1, paramString6, paramString3, paramString4, paramString7, paramString2, paramString8));
    try
    {
      paramString5.a();
      return;
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (paramBaseActivity == null) {
      paramString1 = bawu.b(BaseApplicationImpl.getApplication().getResources(), 2130844479);
    }
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    ...
    for (int i = 69;; i = 65)
    {
      paramString4 = new axuk(StructMsgForGeneralShare.class).c(i).a(paramString2).a("web", paramString4, paramString5, null, null).a(ajyc.a(2131705551), null).a();
      paramString5 = axux.a(2);
      ...
      aqbc.a(paramBaseActivity, paramString1, 3);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
    ...
    do
    {
      ...
      {
        a(paramQQAppInterface, paramHotChatInfo, paramQQAppInterface.getApp().getString(2131693309), true);
        return;
      }
      a(paramQQAppInterface, paramHotChatInfo, paramQQAppInterface.getApp().getString(2131693317), true);
      aktg localaktg = paramQQAppInterface.a().a();
      RecentUser localRecentUser = localaktg.a(paramHotChatInfo.troopUin, 1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo, String paramString, boolean paramBoolean)
  {
    ...
    akoj.a(paramQQAppInterface, paramHotChatInfo.troopUin, paramString, 1, paramBoolean, false);
  }
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (paramString2.startsWith("邀请加入QQ热聊：")) {
      paramString1 = paramString2 + ajyc.a(2131705552);
    }
    paramString5.putString("troop_wording", paramString1);
    paramString5.putString("bizname", "JoinTroopLink");
    bgyu.a(localQQAppInterface, paramBaseActivity, paramString5, null);
  }
  ...
  static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (paramString2.startsWith("邀请加入QQ热聊：")) {}
    for (paramBaseActivity = paramString2 + ajyc.a(2131705554);; paramBaseActivity = paramString2)
    {
