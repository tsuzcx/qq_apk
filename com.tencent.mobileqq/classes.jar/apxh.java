  ...
  implements apxf
{
  private void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = blhn.a(paramString1);
      localMap = apxc.a(new JSONObject(paramString2));
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      localObject = urb.a((String)localObject);
    ...
    if ((paramString1.equals("jumpApp")) && (!TextUtils.isEmpty(paramString2)) && (paramString2.startsWith("weishi://")) && (zqd.a(BaseActivity.sTopActivity)))
    {
      uqh.a(BaseActivity.sTopActivity, "biz_src_jc_gzh_weishi", paramString2);
      uvu.a(str, 1000003, (stSimpleMetaFeed)localObject);
      return;
    }
    urb.a((stSimpleMetaFeed)localObject, BaseActivity.sTopActivity);
    uvu.a(str, 1000001, (stSimpleMetaFeed)localObject);
  ...
  protected void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = bhni.a(a(), localBaseActivity, String.format("mqqapi://app/action?pkg=com.tencent.mobileqq&cmp=com.tencent.biz.PoiMapActivity&type=sharedmap&lat=%s&lon=%s&title=%s&loc=%s&dpid=null", new Object[] { paramString, str1, str2, str3 }));
      if (paramString != null)
      {
        paramString.a();
        return;
  ...
  public boolean a(String paramString1, String paramString2, JSONObject paramJSONObject, long paramLong, String paramString3)
  {
    ...
    if (paramString1.equals("pubaccount/pendant"))
    {
      if ((BaseActivity.sTopActivity instanceof FragmentActivity))
      {
        ...
        if (paramString1 != null)
        {
          ...
          if ((paramString1 != null) && ((paramString1 instanceof ainh))) {
            ((ainh)paramString1).g(paramString2);
          }
        }
      }
      return true;
    ...
    if ("cmshow/openGame".equals(paramString1))
    {
      paramString1 = a();
      if (paramString1 != null) {
        ((amsx)paramString1.getManager(153)).a().a(paramString2);
      }
      return true;
    }
    ...
    do
    {
      for (;;)
      {
        ...
        catch (JSONException paramString2)
        {
          try
          {
            ...
            if (paramString2 != null) {
              ((aoip)paramString2.a(20)).b(paramLong + "", l);
            }
            bhju.a("Grp_AIO", "Grp_aio_subscription", "Grp_aio_clk", 1, 0, new String[] { String.valueOf(paramLong) });
            oix.a(BaseActivity.sTopActivity, paramString1, 1);
            return false;
          }
          catch (JSONException paramString2)
          {
        ...
        else if ("gift/predownload".equals(paramString1))
        {
          ...
          if (paramString1 != null)
          {
            paramString1 = (bayq)paramString1.getManager(312);
            paramString1.a(paramString2);
            paramString1 = paramString1.a(paramString2);
            if ((paramString1 != null) && (!TextUtils.isEmpty(paramString1.b)) && (bnuw.a().a()))
            {
              bnuq.a().b();
              bnuq.a().a();
              bkfs.a("1018", true, null);
              bnuw.a().a(paramString1, null);
            }
            else
            {
              QLog.i("VipARPreDownload", 1, "predownload vipARConfig not match ARgift or isEnableOpen3D = " + bnuw.a().a());
            }
          }
        }
        else
        {
          ...
          if (paramString1 != null)
          {
            paramJSONObject = (bayq)paramString1.getManager(312);
            ...
            {
              QLog.i("VipARPreDownload", 1, "playAnimation vipARConfig not match ARgift or isEnableOpen3D = " + bnuw.a().a());
