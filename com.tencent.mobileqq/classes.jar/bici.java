  ...
  implements bhyw, bhza
{
  ...
  private static bick<bhza> listeners = new bick();
  private static bick<WeakReference<bhza>> weakListeners = new bick();
  ...
  protected void doOnCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      bhmi.a(paramQQAppInterface, paramString2, false);
      return;
    }
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, bhza parambhza, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambhza, paramBoolean);
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, bhza parambhza, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      ...
      if (parambhza != null) {
        parambhza.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambhza == null);
    parambhza.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambhza != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambhza));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambhza);
        ...
        parambhza.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambhza);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, bhza parambhza, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambhza, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bhza)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bhza)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((bhza)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((bhza)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bhza)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((bhza)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, bhza parambhza)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambhza, false);
    weakListeners.a(paramString, parambhza, true);
  }
}
