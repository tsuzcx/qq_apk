  ...
  implements aaru
{
  ...
  public static GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      aase.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      ...
      if (localGdtAd.getImageData() == null)
      {
        ...
        if (paramAdInfo != null) {
          localObject1 = aasd.a(paramAdInfo);
        }
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (aarb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(aarb paramaarb, String paramString, String... paramVarArgs)
  {
    ...
    j = 0;
    if (paramaarb != null) {}
    for (Object localObject1 = paramaarb.a(); (paramaarb == null) || (localObject1 == null); localObject1 = null)
    {
      aase.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    for (;;)
    {
      ...
      catch (Throwable paramVarArgs)
      {
        try
        {
          ...
          j = k;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(aasd.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(str)));
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramaarb.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramaarb == null) {
            break label321;
          }
