  ...
  extends PopupWindow
{
  ...
  public bjak(Context paramContext)
  {
    super(paramContext, null, 2131755909);
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      localValueAnimator.addUpdateListener(new bjan(this));
      localValueAnimator.addListener(new bjao(this));
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setOnKeyListener(new bjal(this));
    ...
    paramIBinder.addUpdateListener(new bjam(this));
    paramIBinder.start();
  }
