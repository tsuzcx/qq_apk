...
class avhi
  implements avhj
{
  avhi(avhf paramavhf, long paramLong1, SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, long paramLong2, boolean paramBoolean) {}
  
  public void a(String paramString)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)avhf.a(this.jdField_a_of_type_Avhf).get();
    ...
    for (;;)
    {
      ...
      catch (JSONException paramString)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Long < j)
          {
            ...
            if ((i > 0) && (i < 5))
            {
              ...
              bjgx.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2044", "0", false);
              return;
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            bjgx.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2044", "1", false);
            return;
          }
        }
        catch (JSONException localJSONException)
        {
          ...
          bjgx.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2043", "0", false);
          return;
        }
        bjgx.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2043", "1", false);
      }
    }
  }
}
