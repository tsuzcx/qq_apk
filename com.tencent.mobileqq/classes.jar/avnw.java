...
{
  public static final String a = AppConstants.SDCARD_PATH + "hotvideo/preview/";
  ...
  public static Drawable a(Context paramContext, HotVideoData paramHotVideoData)
  {
    ...
    paramHotVideoData = avny.a(paramHotVideoData, 10.0F, paramContext);
  ...
  private void a(File paramFile, HotVideoData paramHotVideoData, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramFile = new bhyo(paramHotVideoData.url.replaceFirst("https", "http"), localFile);
    paramFile.n = true;
    paramFile.b = 2;
    int i = bhyq.a(paramFile, null, null);
    if (i == 0)
    {
      paramFile = aznv.a(localFile.getAbsolutePath());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramURLDrawableHandler = aznv.a(paramFile.getAbsolutePath());
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    {
      paramDownloadParams.GetPreviewURLAsync((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), 0, "0", new avnx(this, paramDownloadParams, localFile, paramURLDrawableHandler));
      return localFile;
    }
