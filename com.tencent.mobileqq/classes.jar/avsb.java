...
public class avsb
{
  private static volatile avsb jdField_a_of_type_Avsb;
  ...
  public static avsb a()
  {
    if (jdField_a_of_type_Avsb == null) {}
    try
    {
      if (jdField_a_of_type_Avsb == null) {
        jdField_a_of_type_Avsb = new avsb();
      }
      return jdField_a_of_type_Avsb;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        bool1 = QzoneModuleLoader.loadModuleDex(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir + File.separator + "liteavsdk.jar", BaseApplicationImpl.getApplication().getApplicationContext(), getClass().getClassLoader(), "com.tencent.rtmp.ui.TXCloudVideoView", null, false);
        if (bool1)
        {
      ...
      catch (Exception localException)
      {
        ...
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir)))
        {
          ...
          JarReflectUtil.callSpecifiedStaticMethod("com.tencent.rtmp.TXLiveBase", "setLibraryPath", false, JarReflectUtil.getParamsClass(new Class[] { String.class }), new Object[] { this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir });
        }
        return bool1;
      }
      boolean bool3 = false;
