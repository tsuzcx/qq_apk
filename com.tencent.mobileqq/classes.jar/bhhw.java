  ...
  implements bhhk, INetInfoHandler
{
  ...
  public bhhw(AppRuntime paramAppRuntime, bhhj parambhhj)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "getTask | " + paramString + " task find =" + localbhhf);
            }
            return localbhhf;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbhhf2.a()) && (l > localbhhf2.c + localbhhf2.d))
          {
            ...
            QLog.d("QueueDownloader", 2, "remove task[" + localbhhf2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbhhf2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new QueueDownloader.1(this, localbhhf1), 2, null, false);
  ...
  public void a(bhhf parambhhf)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("QueueDownloader", 2, "removeTask | task=" + parambhhf);
        }
        parambhhf.i();
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambhhf.b)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "startDownload | task=" + parambhhf.jdField_a_of_type_JavaLangString);
            }
            a();
            return;
          }
