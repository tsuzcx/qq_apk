  ...
  extends bdsh
{
  ...
  protected File a(int paramInt)
  {
    ...
    if ((paramInt >= bdnh.a.length) || (a == null)) {}
    try
    {
      a = BaseApplicationImpl.getApplication().getDir("systemface", 0);
      String str = BaseApplicationImpl.getContext().getResources().getResourceEntryName(bdnh.a[paramInt]);
  ...
  {
    arvk.a().a(paramInt1).b(paramInt2);
  }
  
  protected boolean a(int paramInt)
  {
    return arvq.a(paramInt);
  }
