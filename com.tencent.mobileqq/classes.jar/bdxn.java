...
public class bdxn
{
  ...
  public bdxn(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, bdxp parambdxp)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentWidgetPinnedFooterExpandableListView = paramPinnedFooterExpandableListView;
    this.jdField_a_of_type_Bdxp = parambdxp;
    this.jdField_a_of_type_Bdxj = new bdxj(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    if (localbdzw != null)
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_Bdxp.a();
      if (localArrayList1 != null)
      {
        ...
        localbdzw.a(localArrayList2, new bdxo(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramContext).inflate(2131560428, paramViewGroup, false);
      paramViewGroup = new bdwr();
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131368236));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131371615));
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131364530));
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131379811);
      if (paramOnClickListener != null) {
        paramView.setOnClickListener(paramOnClickListener);
      }
      paramView.findViewById(2131379673).setVisibility(8);
    ...
    {
      paramContext = FaceDrawable.getFaceDrawable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramRelationTroopEntity.troopInfo.troopuin, 3, FaceDrawable.getDefaultDrawable(4, 3), FaceDrawable.getDefaultDrawable(4, 3));
      ...
      return paramView;
      paramViewGroup = (bdwr)paramView.getTag();
  ...
  public void a()
  {
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ResultRecord paramResultRecord)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("RelationFriendsTroopViewHelper", 2, "onSearchResult:,currentRelationUin:" + this.jdField_a_of_type_JavaLangString + ",lastrecordUIN:" + paramResultRecord.uin);
      }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<Entity>> paramSparseArray)
  {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = amtj.a(2131717661);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = amtj.a(2131717660);
  ...
  public View b(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    ...
    for (paramInt1 = 4;; paramInt1 = 113)
    {
      ...
      paramViewGroup.d.setText(paramContext);
      return paramView;
      paramViewGroup = (alan)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      break;
    }
  }
  ...
  public void b()
  {
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}
