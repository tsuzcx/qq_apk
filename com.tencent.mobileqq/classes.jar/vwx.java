...
public class vwx
  extends AsyncTask<vwz, vxb, vxa>
{
  public final vmd a;
  
  public vwx(vmd paramvmd)
  {
    if (paramvmd == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	xvv:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	vwx:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    xvv.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    xvv.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    xvv.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected vxa a(vwz... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new vxa(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new vwy(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        ypi.d(paramVarArgs.b);
        return new vxa(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new vxa(paramVarArgs, i, "error=" + i);
  }
}
