...
public final class ardk
{
  ...
  {
    ardi localardi = (ardi)aran.a().a(627);
    if (localardi != null) {
      return localardi;
    }
    return new ardi();
  ...
  private static final ardi b(String paramString)
  {
    int k = 0;
    if (paramString == null) {
      return null;
    ...
    if (j < i)
    {
      ...
      if (localObject3 != null)
      {
        ...
        localObject2 = new aqkg((String)localObject2, str1, str2, str3, (String)localObject3, false);
        localardi.a().add(localObject2);
      }
    }
    else
    {
