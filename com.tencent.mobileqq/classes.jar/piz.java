  ...
  implements ViewBase.OnClickListener
{
  ...
  public piz(ArticleInfo paramArticleInfo, Context paramContext, int paramInt)
  {
  ...
  private void a()
  {
    ...
    osj.a().a().a(localQQAppInterface.getAccount(), String.valueOf(l), true, new pja(this), 1);
    c();
  }
  ...
  private void b()
  {
    ...
    {
      rap.a(localArticleInfo, str, str, (int)localArticleInfo.mChannelID);
      osj.b(localArticleInfo);
      if (localArticleInfo.mSocialFeedInfo != null)
      {
        long l = localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcl.jdField_a_of_type_Long;
        osj.a().a().a(localAppRuntime.getAccount(), String.valueOf(l), true, new pjb(this, localArticleInfo));
      }
      c();
      return;
    }
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    for (;;)
    {
      oam.a(paramViewBase, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, true);
      return;
      label144:
      b();
    }
