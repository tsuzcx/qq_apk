...
public class bcbx
{
  public static aupa a(bccb parambccb)
  {
    if (parambccb != null)
    {
      aupa localaupa = new aupa();
      localaupa.jdField_c_of_type_JavaLangString = parambccb.b;
      String str = parambccb.jdField_a_of_type_JavaLangString;
      localaupa.jdField_a_of_type_JavaLangString = str;
      localaupa.d = str;
      localaupa.jdField_a_of_type_Long = parambccb.jdField_a_of_type_Int;
      localaupa.jdField_c_of_type_Boolean = true;
      return localaupa;
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    return c(((bcbt)paramQQAppInterface.getManager(346)).a(paramString1, paramString2));
  }
  ...
  public static ArrayList<bhws> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    paramString = ((bcbt)paramQQAppInterface.getManager(346)).a(paramString);
    ...
    {
      bccb localbccb = (bccb)paramString.next();
      bhws localbhws = new bhws();
      localbhws.jdField_a_of_type_JavaLangString = localbccb.b;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, NavBarAIO paramNavBarAIO, ImageView paramImageView1, ImageView paramImageView2, boolean paramBoolean)
  {
    ...
    bcbt localbcbt = (bcbt)paramQQAppInterface.getManager(346);
    if (!localbcbt.b(paramString))
    {
    ...
    localbcbt.b(paramString, paramQQAppInterface.getCurrentAccountUin(), new bcby(paramNavBarAIO, paramImageView1, paramImageView2, paramBoolean, paramQQAppInterface, paramString, paramActivity));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return !((bckx)paramQQAppInterface.getManager(203)).b(paramMessageRecord.senderuin);
  }
  ...
  public static String b(List<bccb> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return "";
    }
    ...
    while (i < paramList.size())
    {
      localStringBuilder.append(((bccb)paramList.get(i)).jdField_a_of_type_Int);
      if (i != paramList.size() - 1) {
        localStringBuilder.append("|");
      }
      i += 1;
  ...
  public static String c(List<bccb> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext()) {
        localStringBuilder.append(((bccb)paramList.next()).jdField_a_of_type_JavaLangString);
      }
    }
    return localStringBuilder.toString();
  }
