  ...
  implements ambe
{
  ...
  private CopyOnWriteArrayList<WeakReference<ambg>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  
  public amar(amau paramamau, ambh paramambh, amav paramamav)
  {
  ...
  private String a()
  {
    ...
    return this.jdField_a_of_type_Amav.a(localSpriteTaskParam);
  }
  ...
  private String a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Amav.a(paramSpriteTaskParam);
      localObject = str;
  ...
  {
    boolean bool2;
    if ((this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Amau.b == null))
    {
      bool2 = false;
      return bool2;
    }
    Object localObject1 = (QQAppInterface)this.jdField_a_of_type_Amau.b.get();
  ...
  private boolean a(int paramInt1, int paramInt2)
  {
    ...
    return ((amaz)this.jdField_a_of_type_Amau.a().getManager(249)).a().a(paramInt1, paramInt2) != null;
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ambg localambg = (ambg)((WeakReference)localIterator.next()).get();
        if (localambg != null) {
          localambg.a(paramInt);
        }
      }
    }
  }
  ...
  public void a(int paramInt, MessageForApollo paramMessageForApollo)
  {
    ...
    if ((paramMessageForApollo == null) || (this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Ambh == null)) {
      break label48;
    }
    label48:
    while (!ambc.b(this.jdField_a_of_type_Amau.a(), paramMessageForApollo.istroop, paramMessageForApollo.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
    localSpriteTaskParam.f = ApolloUtil.a(this.jdField_a_of_type_Amau, paramMessageForApollo);
    localSpriteTaskParam.jdField_c_of_type_Int = ApolloUtil.b(this.jdField_a_of_type_Amau, paramMessageForApollo);
    ...
    for (;;)
    {
      ...
      ambc.a(this.jdField_a_of_type_Amau.a(), localSpriteTaskParam);
      return;
  ...
  public void a(amau paramamau)
  {
    ...
    if ((this.jdField_a_of_type_Amav == null) || (paramamau == null) || (!paramamau.c())) {
      amhk.a(i, 300, 160, new Object[] { "glview is not ready" });
    }
    String str;
    amal localamal;
    do
    {
      ...
      while (TextUtils.isEmpty(str))
      {
        amhk.a(i, 300, 301, new Object[] { "spriteJs is empty" });
        return;
        str = this.jdField_a_of_type_JavaLangString;
        QLog.d("CmShowStatUtil", 1, "spriteJs from cache");
        this.jdField_a_of_type_JavaLangString = null;
      }
      localamal = ambc.a(paramamau.a());
    ...
    ThreadManager.executeOnSubThread(new SpriteBridge.2(this, localamal, paramamau));
  }
  
  public void a(ambg paramambg)
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramambg));
  }
  ...
  {
    if ((paramChatMessage == null) || (this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Ambh == null)) {}
    while (!ambc.b(this.jdField_a_of_type_Amau.a(), paramChatMessage.istroop, paramChatMessage.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
    localSpriteTaskParam.f = paramInt;
    ApolloActionData localApolloActionData = ambc.a(this.jdField_a_of_type_Amau.a(), paramInt);
  ...
  public void a(ChatMessage paramChatMessage, ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    if ((paramChatMessage == null) || (this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Ambh == null) || (paramArrayList1 == null) || (paramArrayList1.size() == 0)) {}
    while (!ambc.b(this.jdField_a_of_type_Amau.a(), paramChatMessage.istroop, paramChatMessage.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
  ...
  public void a(MessageForApollo paramMessageForApollo)
  {
    ...
    try
    {
      ...
      if ((!this.jdField_a_of_type_Amau.h()) && (this.jdField_a_of_type_Amau.g()))
      {
        localObject1 = ambc.a(this.jdField_a_of_type_Amau.a()).a();
        if (localObject1 != null) {
      ...
      if (paramMessageForApollo.mApolloMessage.name != null) {
        ((JSONObject)localObject2).put("name", ambc.a(bfuc.encodeToString(paramMessageForApollo.mApolloMessage.name, 0)));
      }
      if (paramMessageForApollo.mApolloMessage.text != null) {
        ((JSONObject)localObject2).put("atText", ambc.a(bfuc.encodeToString(paramMessageForApollo.mApolloMessage.text, 0)));
      }
      ...
      paramMessageForApollo = ambc.a(this.jdField_a_of_type_Amau.a());
  ...
  {
    if ((paramList == null) || (paramList.size() == 0) || (this.jdField_a_of_type_Amav == null) || (this.jdField_a_of_type_Amau == null) || (!this.jdField_a_of_type_Amau.c())) {}
    do
    {
      return;
      localObject = ((amaz)this.jdField_a_of_type_Amau.a().getManager(249)).a();
    } while (localObject == null);
    Object localObject = ((amay)localObject).a(0);
    if (localObject == null)
    {
    ...
    while (paramList.hasNext())
    {
      ...
      try
      {
        ...
        ((amam)localObject).a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, false);
      }
    ...
    ((amam)localObject).a(paramList.toString());
  }
  ...
  public void b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    {
      return;
      if ((paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList != null) && (paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList.size() > 0) && (!this.jdField_a_of_type_Amau.e()))
      {
      ...
      localObject2 = this.jdField_a_of_type_Amav.a(paramSpriteTaskParam);
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        paramSpriteTaskParam.jdField_b_of_type_Int = 4;
        return;
      }
      localObject1 = (amaz)this.jdField_a_of_type_Amau.a().getManager(249);
      localObject3 = ((amaz)localObject1).a();
    } while (localObject3 == null);
    Object localObject3 = ((amay)localObject3).a(paramSpriteTaskParam.jdField_c_of_type_Int);
    ...
    ((amam)localObject3).a(localStringBuilder.toString());
    ((amam)localObject3).a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, false);
    ((amam)localObject3).a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, false);
    ...
    for (;;)
    {
      amge.a((QQAppInterface)localObject2, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      localObject1 = ((amaz)localObject1).a();
      if ((localObject1 == null) || (ambc.a(this.jdField_a_of_type_Amau.a()))) {
        break;
      }
      ...
      ((amaq)localObject1).a(paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList);
      return;
      bool = false;
    }
    label372:
