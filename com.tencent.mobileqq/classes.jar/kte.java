...
public class kte
  extends kti
{
  public kte(VideoController paramVideoController)
  {
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    for (int i = 4;; i = 1)
    {
      ...
      this.jdField_a_of_type_ComTencentAvVideoController.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(14), Integer.valueOf(this.jdField_a_of_type_ComTencentAvVideoController.a().w), this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_JavaLangString, Long.valueOf(this.jdField_a_of_type_Long) });
      this.jdField_a_of_type_Long = 0L;
      return;
    }
  }
