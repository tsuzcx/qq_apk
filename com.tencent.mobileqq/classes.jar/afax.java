  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<String, bbwu> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private volatile boolean jdField_a_of_type_Boolean;
  private afbs jdField_b_of_type_Afbs;
  ...
  public afax(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new BlessManager.1(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface = ajsd.aW + jdField_a_of_type_JavaLangString;
  ...
  private void a(aktf paramaktf)
  {
    RecentUser localRecentUser = paramaktf.a(ajsd.au, 9003);
    long l = NetConnInfoCenter.getServerTime();
    localRecentUser.uin = ajsd.au;
  ...
  private void a(aktf paramaktf, RecentUser paramRecentUser)
  {
    paramaktf.b(paramRecentUser);
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
      ...
      for (;;)
      {
        if (m < arrayOfString.length) {
          ...
          else
          {
            ...
            {
              localObject = bdik.b(arrayOfString[m]);
              j = 1;
  ...
  private void a(BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    for (;;)
    {
      ...
      {
        localaukr.a();
        localaukp.a(BlessTask.class);
        if (paramBlessTask != null) {
          localaukp.b(paramBlessTask);
        }
        localaukp.a(BlessPtvModule.class);
        if (paramArrayList != null)
        {
          paramBlessTask = paramArrayList.iterator();
          if (paramBlessTask.hasNext())
          {
            localaukp.b((BlessPtvModule)paramBlessTask.next());
            continue;
          }
        }
      }
      catch (Exception paramBlessTask)
      {
        ...
        localaukr.b();
        return;
        localaukp.a(BlessWording.class);
        if (paramArrayList1 != null)
        {
          paramBlessTask = paramArrayList1.iterator();
          if (paramBlessTask.hasNext())
          {
            localaukp.b((BlessWording)paramBlessTask.next());
            continue;
          }
        }
      }
  ...
  private void a(String paramString, BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    this.jdField_a_of_type_Afbs.b();
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    afbs.a((SharedPreferences)localObject1, this.jdField_a_of_type_Afbs, 1);
  ...
  {
    if (bbfj.a(BaseApplicationImpl.getApplication()) == 0) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localbbwu = (bbwu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
      if (localbbwu == null) {
        break label147;
      }
      if ((localbbwu.a() != 2) && (localbbwu.a() != 3)) {
        break;
      }
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString2, localbbwu);
    localbbwz.a(localbbwu, new afay(this, paramString2, paramString1), null);
  }
  ...
  private void a(ArrayList<BlessPtvModule> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bbdx.a(this.jdField_b_of_type_JavaLangString + str1);
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          if ((bfnz.d()) && (!new File((String)localObject1).exists()))
          {
            k();
            if (QLog.isColorLevel()) {
  ...
  private void d(boolean paramBoolean)
  {
    ...
    RecentUser localRecentUser = localaktf.b(ajsd.au, 9003);
    int i;
    label78:
    Object localObject;
  ...
  private void h()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    this.jdField_a_of_type_Afbs = afbs.a((SharedPreferences)localObject1, 1);
    this.jdField_b_of_type_Afbs = afbs.a((SharedPreferences)localObject1, 2);
    Object localObject3 = bbkc.a((SharedPreferences)localObject1, "bless_uin_to_send", null);
    ...
    label198:
    label212:
    for (localObject1 = localObject2;; localObject1 = Integer.valueOf(this.jdField_b_of_type_Afbs.a()))
    {
      ...
      break label112;
      localObject1 = Integer.valueOf(this.jdField_a_of_type_Afbs.a());
      break label133;
    }
  }
  ...
  private void i()
  {
    ...
    Object localObject2 = (ArrayList)((aukp)localObject1).a(BlessTask.class, new BlessTask().getTableName(), false, null, null, null, null, null, null);
    if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask = ((BlessTask)((ArrayList)localObject2).get(0));
    }
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)((aukp)localObject1).a(BlessPtvModule.class, new BlessPtvModule().getTableName(), false, null, null, null, null, null, null));
    this.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)((aukp)localObject1).a(BlessWording.class, new BlessWording().getTableName(), false, null, null, null, null, null, null));
    ((aukp)localObject1).a();
    if (QLog.isColorLevel())
    {
  ...
  private void k()
  {
    if ((bfnz.d()) && (!this.jdField_a_of_type_Boolean)) {
  ...
  public aaod a(int paramInt1, int paramInt2)
  {
    aaod localaaod = new aaod();
    localaaod.jdField_a_of_type_Int = 0;
    if (paramInt1 == 2) {
      localaaod.jdField_b_of_type_Int = 1;
    }
    for (;;)
    {
      localaaod.jdField_b_of_type_Long = paramInt2;
      return localaaod;
      if (paramInt1 == 3) {
        localaaod.jdField_b_of_type_Int = 4;
      } else {
        localaaod.jdField_b_of_type_Int = 0;
      }
    }
  }
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.recentHeadImgUrl != null))
    {
      if ((this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) || (this.jdField_d_of_type_Boolean != bool))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          i = actj.a(50.0F, BaseApplication.getContext().getResources());
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    return paramString1 + bbco.encodeToString(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentNickname().getBytes(), 2);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    acqv.a(paramContext, localIntent, str);
  }
  ...
  public void a(ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        this.jdField_a_of_type_Afbs.a(str);
      }
      afbs.a(localSharedPreferences, this.jdField_a_of_type_Afbs, 1);
    }
    while (paramInt != 2) {
      return;
    }
    ...
    {
      str = (String)paramArrayList.next();
      this.jdField_b_of_type_Afbs.a(str);
    }
    afbs.a(localSharedPreferences, this.jdField_b_of_type_Afbs, 2);
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    bbkc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", paramList.toArray()).commit();
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(ajsd.au, 9003) != null;
  }
  
  public boolean a(String paramString)
  {
    this.jdField_a_of_type_Afbs.a();
    return this.jdField_a_of_type_Afbs.a(paramString);
  }
  ...
  {
    this.jdField_c_of_type_JavaUtilArrayList.clear();
    bbkc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", new String[0]).commit();
  }
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        while ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.unread != -1) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed))
        {
          ...
          {
            localaukr.a();
            localaukp.a(this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask);
            localaukr.c();
          }
  ...
  {
    this.jdField_b_of_type_Afbs.a();
    return this.jdField_b_of_type_Afbs.a(paramString);
  }
  ...
  {
    this.jdField_a_of_type_Afbs.a();
    return c() - this.jdField_a_of_type_Afbs.a();
  }
  ...
  public int f()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_a_of_type_Afbs.b();
    }
    return i;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask == null) {}
    while ((!bfnz.d()) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed) || (!d()) || (!i())) {
      return false;
    }
    return true;
  }
  ...
  {
    this.jdField_b_of_type_Afbs.a();
    return i() - this.jdField_b_of_type_Afbs.a();
  }
  ...
  public int k()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_b_of_type_Afbs.b();
    }
    return i;
  }
  ...
  {
    Object localObject = (bbww)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47);
    if (localObject != null)
    {
      localObject = ((bbww)localObject).a(1);
      if (localObject != null) {
        ((bbwz)localObject).a(true, null);
      }
    }
    ThreadManager.getSubThreadHandler().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
  }
