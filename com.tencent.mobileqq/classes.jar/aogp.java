  ...
  extends acvl
{
  ...
  public aogp(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    int i1 = bbzj.b(paramMessageRecord.msgUid);
    ...
    if ((i2 == 0) || (i2 == 1000) || (i2 == 1004))
    {
      ...
      if (paramMessageRecord.msgtype == -2005)
      {
        ...
        if ((paramMessageRecord != null) && (paramMessageRecord.nOLfileSessionId != 0L))
        {
          ...
          ((msg_svc.PbDelRoamMsgReq.C2CMsg)localObject).msg_random.set(bbzj.b(paramMessageRecord.msgUid));
        }
      }
    }
    for (;;)
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    boolean bool = paramToServiceMsg.extraData.getBoolean(bbyw.h);
    if (QLog.isColorLevel()) {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    boolean bool3 = paramToServiceMsg.extraData.getBoolean(bbyw.h);
  ...
  public static void b(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(localAppInterface.getCurrentAccountUin(), "revokeMsgErrorTag", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public ToServiceMsg a(List<MessageRecord> paramList, int paramInt)
  {
    ...
    if ((paramInt == 1) && (!((MessageRecord)localObject1).isSend()) && (!bfup.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
    {
      QLog.e("revokeMsg", 1, "buildRevokeOrDeleteMultiMsgReq error, msg not send");
      a(((MessageRecord)localObject1).frienduin, ((MessageRecord)localObject1).istroop, f, o);
      return null;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        case 1004: 
          for (;;)
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              int i4 = bbzj.b(localMessageRecord.msgUid);
              ...
              for (localObject2 = localMessageRecord.senderuin;; localObject2 = localMessageRecord.selfuin) {
                try
                {
                  ...
                  if (bbzf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, (msg_svc.RoutingHead)localObject2)) {
        ...
        if (localIterator.hasNext())
        {
          ...
          i3 = bbzj.b(localMessageRecord.msgUid);
          ...
          if (i2 == 1)
          {
            ...
            {
              if (!bfup.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
                break label1366;
              }
          ...
          for (i1 = 1;; i1 = 0)
          {
            ((RevokeMsgInfo)localObject3).f = i1;
            ...
            localObject3 = "delete";
            break label1160;
            if (!bfup.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
              break label1260;
            }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      break;
      if ((!acwh.a(paramMessageRecord)) && (acwh.g(paramMessageRecord.msgtype)))
      {
        ...
        for (;;)
        {
          ...
          int i2 = bbxc.jdField_a_of_type_Int;
          bbxc.jdField_a_of_type_Int = i2 + 1;
          long l1 = i2;
  ...
  public void a(MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, adrq paramadrq)
  {
    paramArrayList = anqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramArrayList, paramadrq);
    ...
    {
      a(false, true, true, 0L, new aogq(this, paramMessageRecord, bool, paramArrayList));
      return;
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (this.jdField_a_of_type_Arva != null) {
        this.jdField_a_of_type_Arva.a(false);
      }
  ...
  {
    if (this.jdField_a_of_type_Arva != null) {
      this.jdField_a_of_type_Arva.a(true);
    }
