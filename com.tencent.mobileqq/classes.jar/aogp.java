  ...
  implements bcuc
{
  ...
  public aogp(AppInterface paramAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    bhvd.a(arrayOfByte2, 0, arrayOfByte1.length + 4);
    bhvd.a(arrayOfByte2, 4, arrayOfByte1, arrayOfByte1.length);
  ...
  public void a(RespItem paramRespItem)
  {
    ...
    if (paramRespItem.eServiceID == 117)
    {
      ...
      arrayOfByte = bhuf.b(paramRespItem.vecUpdate);
      if (arrayOfByte != null) {
    ...
    else
    {
      ...
      catch (InvalidProtocolBufferMicroException paramRespItem)
      {
        ...
        if ((this.a instanceof QQAppInterface)) {
          ((wja)((QQAppInterface)this.a).a(98)).notifyUI(1023, true, Boolean.valueOf(false));
        }
      }
    }
    for (;;)
