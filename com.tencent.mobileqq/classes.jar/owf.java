...
public final class owf
{
  ...
  @NotNull
  private final HashMap<String, owh> a;
  @NotNull
  private final HashMap<String, owh> b = new HashMap();
  @NotNull
  private final HashMap<String, owh> c = new HashMap();
  @NotNull
  private final HashMap<String, owh> d = new HashMap();
  
  static
  {
    jdField_a_of_type_Owg = new owg(null);
  }
  ...
  private final void a(String paramString, owh paramowh)
  {
    paramowh = paramowh.a();
    QLog.i("RIJChannelBannerReport", 1, "[reportDataImp], actionName = " + paramString + ", r5 = " + paramowh);
    oat.a(null, "", paramString, paramString, 0, 0, "", "", "", paramowh, false);
  }
  
  @NotNull
  public final HashMap<String, owh> a()
  {
    return this.jdField_a_of_type_JavaUtilHashMap;
  }
  
  @NotNull
  public final owh a(@NotNull owd paramowd)
  {
    Intrinsics.checkParameterIsNotNull(paramowd, "channelBannerInfo");
    return new owh().a("channel_id", String.valueOf(paramowd.a())).a(paramowd.d());
  }
  ...
  @NotNull
  public final HashMap<String, owh> b()
  {
    return this.b;
  }
  
  @NotNull
  public final HashMap<String, owh> c()
  {
    return this.c;
  }
  
  @NotNull
  public final HashMap<String, owh> d()
  {
    return this.d;
  }
}
