...
public class avpu
{
  ...
  public WeakReference<avqp> a;
  public HashSet<String> a;
  
  public avpu(BaseActivity paramBaseActivity, avqp paramavqp)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_JavaUtilHashSet = bhnh.a(paramBaseActivity);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramavqp);
  }
  ...
  public ArrayList<String> a(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && ((paramBundle instanceof ArrayList)))
    {
      ...
      avpx localavpx = new avpx(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, null);
      int i = 0;
      while (i < paramBundle.size())
      {
        String str = localavpx.a((Uri)paramBundle.get(i), false);
  ...
  public void a(String paramString)
  {
    ...
    avqm localavqm = (avqm)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
    ...
    paramString = (avqp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
      localavqm.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, "android.intent.action.SEND", paramString);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localavqm = (avqm)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
      ...
      if ((!TextUtils.isEmpty(paramString1)) && (new File(paramString1).exists()))
      {
        ...
        localVideoInfo.sha1.set(avpw.a(paramString1));
        localVideoInfo.play_duration.set((int)l);
        localCheckShareExtensionReq.videos.add(localVideoInfo);
      }
      paramString1 = (avqp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramString1 == null);
    localavqm.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString2, paramString1);
  }
  ...
  public void a(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            String str = bhml.a(aunj.e((String)localObject2));
            if (QLog.isColorLevel()) {
              QLog.d("CheckForward.Security", 2, "sendCheckImgShareReq md5= " + str);
            }
            localImgInfo.md5.set(str);
            localImgInfo.sha1.set(avpw.a((String)localObject2));
            localObject2 = avpw.a((String)localObject2);
            ...
            localObject1 = avpw.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (File)localObject1);
      ...
      paramArrayList = (avqp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramArrayList == null);
    localavqm.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString, paramArrayList);
  }
  ...
  public boolean a(Uri paramUri, int paramInt, String paramString)
  {
    if (this.jdField_a_of_type_Avpx == null) {
      this.jdField_a_of_type_Avpx = new avpx(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, new avpv(this, paramInt, paramString));
    }
    String str = this.jdField_a_of_type_Avpx.a(paramUri);
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Avpx.b) || (this.jdField_a_of_type_Avpx.a)) {
        return true;
      }
      paramUri = new File(str);
      l = paramUri.length();
    } while ((!this.jdField_a_of_type_Avpx.b) && (!this.jdField_a_of_type_Avpx.a) && (l == 0L));
