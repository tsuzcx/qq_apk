...
public class anjd
{
  ...
  public static String m = ajed.cs + "[epId]" + File.separator;
  public static String n = ajed.bJ + "[epId]" + File.separator;
  ...
  public static arnz a()
  {
    try
    {
      ...
      if (localAppInterface != null) {
        return (arnz)localAppInterface.getManager(14);
      }
    }
  ...
  public static List<ankb> a(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    paramQQAppInterface.add(new ankb(7, 7, null));
    paramQQAppInterface.add(new ankb(4, 4, null));
    paramQQAppInterface.add(new ankb(11, 4, null));
    return paramQQAppInterface;
  }
  
  public static List<ankb> a(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    List localList2 = Collections.synchronizedList(new ArrayList());
    Object localObject = (arnz)paramQQAppInterface.getManager(14);
    List localList1 = ((arnz)localObject).a(paramInt);
    localList2.add(new ankb(7, 7, null));
    if (paramInt == 0)
    {
      localList2.add(new ankb(4, 4, null));
      paramQQAppInterface = (anbh)paramQQAppInterface.getManager(334);
      if ((paramQQAppInterface != null) && (paramQQAppInterface.c())) {
        localList2.add(new ankb(11, 4, null));
      }
    }
    paramQQAppInterface = ((arnz)localObject).a(false, paramInt, paramBoolean);
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0)) {
      localList2.add(new ankb(8, 3, null));
    }
    if (localList1 != null)
    {
      ...
      if (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.type != 1) && (3 != localEmoticonPackage.jobType) && (1 != localEmoticonPackage.jobType) && (5 != localEmoticonPackage.jobType))
        {
          ...
          {
            paramQQAppInterface = new ankb(10, 7, localEmoticonPackage);
            i1 = paramInt;
        ...
        {
          anja.a(paramQQAppInterface, bool);
          paramInt = i1;
          break;
          ...
          paramQQAppInterface = new ankb(6, 4, localEmoticonPackage);
          break label260;
          ...
          localList2.add(new ankb(9, 4, localEmoticonPackage));
          i1 = 1;
          break label277;
        }
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt)
  {
    ...
    {
      paramQQAppInterface = (anfj)paramQQAppInterface.getManager(43);
  ...
  public static void a(axkk[] paramArrayOfaxkk, float paramFloat1, float paramFloat2, boolean paramBoolean1, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Activity paramActivity, boolean paramBoolean2)
  {
    if ((paramArrayOfaxkk == null) || (paramQQAppInterface == null) || (paramSessionInfo == null) || (paramActivity == null)) {}
    Object localObject1;
    int i2;
    do
    {
      ...
      i2 = paramInt1;
      paramInt1 = i1;
      while (paramInt1 < paramArrayOfaxkk.length)
      {
        Object localObject2 = paramArrayOfaxkk[paramInt1];
        boolean bool = paramBoolean1;
        int i3 = i2;
        i1 = paramInt2;
        if ((localObject2 instanceof axkm))
        {
          localObject2 = (axkm)localObject2;
          float f1 = ((axkm)localObject2).a;
          float f2 = ((axkm)localObject2).b;
          float f3 = ((axkm)localObject2).c;
          float f4 = ((axkm)localObject2).d;
          int i4 = ((axkm)localObject2).e;
          int i5 = ((axkm)localObject2).f;
    ...
    {
      ((arnz)paramQQAppInterface.getManager(14)).b(String.valueOf(i2), 0, new anje(paramSessionInfo, paramQQAppInterface, i2, paramActivity));
      return;
    }
    paramSessionInfo = ((TreeSet)localObject1).iterator();
    for (paramArrayOfaxkk = ""; paramSessionInfo.hasNext(); paramArrayOfaxkk = paramArrayOfaxkk + localObject1 + ",") {
      localObject1 = (Integer)paramSessionInfo.next();
    }
    paramSessionInfo = paramArrayOfaxkk;
    if (!paramArrayOfaxkk.equals("")) {
      paramSessionInfo = paramArrayOfaxkk.substring(0, paramArrayOfaxkk.length() - 1);
    }
    EmojiHomeUiPlugin.openSmallEmojiListPage(paramActivity, paramQQAppInterface.getAccount(), 11, paramSessionInfo);
    awqx.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X8007000", 0, 0, String.valueOf(i2), String.valueOf(paramInt2), "", "");
  }
  
  public static boolean a()
  {
    int i1 = badq.a(BaseApplication.getContext());
  ...
  public static List<ankb> b(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    paramQQAppInterface.add(new ankb(7, 7, null));
    return paramQQAppInterface;
  ...
  {
    return badq.a(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean c()
  {
    ...
    int i1 = badq.a(localBaseApplication);
    boolean bool = SettingCloneUtil.readValue(localBaseApplication, null, localBaseApplication.getString(2131629640), "qqsetting_auto_receive_magic_face_key", true);
