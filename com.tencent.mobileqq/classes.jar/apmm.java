...
public class apmm
{
  private static apmo a;
  
  static
  {
    if ((apml.a("HUAWEI")) && (Build.VERSION.SDK_INT >= 23) && (apgb.a())) {
      a = null;
    }
  }
  
  /* Error */
  public static int a(apmo paramapmo, String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   4: ifnull +14 -> 18
    //   7: aload_1
    //   8: invokestatic 33	bhsr:a	(Ljava/lang/String;)Z
    //   11: istore 4
    //   13: iload 4
    //   15: ifeq +11 -> 26
    //   18: bipush 252
    ...
    //   46: aload_0
    //   47: aload 5
    //   49: invokestatic 46	apjl:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   52: aload_1
    //   53: invokestatic 49	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   56: istore_3
    //   57: iload_3
    //   58: istore_2
  ...
  /* Error */
  public static int a(apmo paramapmo, String paramString1, String paramString2)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   11: ifne +14 -> 25
    //   14: aload_2
    //   15: invokestatic 33	bhsr:a	(Ljava/lang/String;)Z
    //   18: istore 4
    //   20: iload 4
    //   22: ifeq +10 -> 32
    //   25: iconst_m1
    ...
    //   120: aload 5
    //   122: aload_2
    //   123: invokestatic 106	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   126: aload_1
    //   127: aload 5
    //   129: aload 6
    //   131: aload 5
    //   133: aload 6
    //   135: aload 5
    //   137: invokestatic 46	apjl:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   140: invokestatic 108	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   143: invokestatic 113	apjh:a	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   159: aload 6
    //   161: aload 5
    //   163: invokestatic 46	apjl:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   166: invokestatic 108	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   210: pop
    //   211: aload_2
    //   212: invokestatic 133	bhmi:b	(Ljava/io/File;)Ljava/lang/String;
    //   215: aload 7
    //   217: invokestatic 136	apmm:a	(Ljava/lang/String;Ljava/util/List;)Ljava/util/HashMap;
    //   220: astore_0
    //   221: aload_0
    ...
    //   296: aload 6
    //   298: aload 5
    //   300: invokestatic 46	apjl:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   303: invokestatic 108	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   344: invokestatic 106	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   387: ifeq +267 -> 654
    //   390: aload_0
    //   391: invokestatic 181	azul:a	(Ljava/lang/String;)Ljava/lang/String;
    //   394: astore 9
    //   396: aload_2
    ...
    //   491: aload 6
    //   493: aload 5
    //   495: invokestatic 46	apjl:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   498: invokestatic 108	apjl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   501: iconst_0
    //   502: invokestatic 198	bhmi:a	(Ljava/lang/String;Z)V
  ...
  public static boolean a(apmo paramapmo)
  {
    if (paramapmo == null) {
      return false;
    }
    Object localObject = paramapmo.a();
    if ((localObject == null) || (((List)localObject).size() == 0)) {
      return false;
    }
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext()) {
      if (!a(paramapmo, (String)((Iterator)localObject).next())) {
        return false;
      }
    }
    return true;
  ...
  public static boolean a(apmo paramapmo, String paramString)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (paramapmo != null) {}
    for (;;)
    {
      try
      {
        bool1 = bhsr.a(paramString);
        if (bool1)
        {
          bool1 = bool2;
          return bool1;
        }
        String str1 = paramapmo.a();
        String str2 = paramapmo.b();
        paramapmo = apjl.a(str1, str2, apjl.b(str1, str2, str1)) + File.separator + paramString + ".so";
        File localFile = new File(paramapmo);
        if (QLog.isColorLevel()) {
          QLog.d("ArCoreNativeSoManager", 2, "isSoFileExist soFile=" + paramapmo + ", exist=" + localFile.exists());
        }
        if (localFile.exists())
        {
          paramString = apjl.b(str1, str2, paramString);
          str1 = azul.a(paramapmo);
          if (paramString.equalsIgnoreCase(str1))
          {
            bool1 = true;
            continue;
          }
          QLog.i("ArCoreNativeSoManager", 2, "isSoFileExist. check md5 failed. soFilename = " + paramapmo + ", md5FromConfig = " + paramString + ", md5FromCalc = " + str1);
          bool1 = bool2;
          continue;
        }
        QLog.i("ArCoreNativeSoManager", 2, "isSoFileExist. so not exist. soFilename = " + paramapmo);
      }
      finally {}
      bool1 = bool2;
    }
  ...
  public static boolean b(apmo paramapmo)
  {
    if (paramapmo == null) {
      return false;
    }
    String str1 = paramapmo.a();
    String str2 = paramapmo.b();
    paramapmo = paramapmo.a();
    if ((paramapmo == null) || (paramapmo.size() == 0)) {
      return false;
    }
    paramapmo = paramapmo.iterator();
    while (paramapmo.hasNext())
    {
      String str3 = (String)paramapmo.next();
      if (!new File(apjl.a(str1, str2, apjl.b(str1, str2, str1)) + File.separator + str3 + ".so").exists())
      {
