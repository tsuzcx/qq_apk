...
public class addp
  implements addn
{
  private static final String jdField_a_of_type_JavaLangString = "https://sngapm.qq.com/entrance/" + MagnifierSDK.b() + "/uploadFile/";
  private static final String b = "https://sngapm.qq.com/entrance/" + MagnifierSDK.b() + "/uploadJson/";
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  
  public addp(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, addo paramaddo)
  {
    ...
    if (localObject3 != null)
    {
      ...
      paramResultObject = new QCloudFileUploadRunnable(new URL((String)localObject1), (String)localObject2, localJSONObject, paramaddo, paramResultObject.dbId, this.jdField_a_of_type_MqqOsMqqHandler);
    ...
    else
    {
      ...
      paramResultObject = new JsonUploadRunnable(new URL((String)localObject1), localJSONObject, paramaddo, paramResultObject.dbId, this.jdField_a_of_type_MqqOsMqqHandler);
      this.jdField_a_of_type_MqqOsMqqHandler.post(paramResultObject);
    }
    return true;
  }
