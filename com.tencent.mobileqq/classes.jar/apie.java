...
public class apie
{
  ...
  public apie(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString)
  {
  ...
  public static apie a(Bundle paramBundle)
  {
    int j = 0;
    int n = -1;
    String str = "";
    ...
    {
      return new apie(i, j, k, m, n, paramBundle);
      m = -1;
      k = -1;
      i = -1;
    }
