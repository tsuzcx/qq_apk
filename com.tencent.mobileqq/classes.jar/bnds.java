  ...
  implements bndq
{
  ...
  private bndv jdField_a_of_type_Bndv;
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Bndp == null) || (this.jdField_a_of_type_Bndp.a())) {}
    int i;
    do
    {
      return;
  ...
  private void c()
  {
    ...
    label157:
    while (this.jdField_a_of_type_Bndu == null)
    {
      return;
      this.jdField_a_of_type_Bndv.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Bndu.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Bndr.postInvalidate();
  }
  ...
  {
    if (this.jdField_a_of_type_Bndp == null) {
      return;
    }
    c();
    ...
    while (i < k)
    {
      bndt localbndt = this.jdField_a_of_type_Bndp.a(i);
      if (localbndt != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localbndt.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
