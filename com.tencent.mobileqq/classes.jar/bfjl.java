...
public class bfjl
{
  ...
  private List<bfjm> jdField_a_of_type_JavaUtilList;
  ...
  private Pair<Integer, List<bfjm>> a(String paramString, int paramInt)
  {
    Object localObject = null;
    byte[] arrayOfByte = new bfkg().a(paramString, null, 1);
  ...
  /* Error */
  private Pair<Integer, List<bfjm>> a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 155	bfjl:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	bfjl:a	(Lorg/w3c/dom/Node;)Lbfjm;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private bfjm a(Node paramNode)
  {
    ...
    do
    {
      for (;;)
      {
          ...
          else
          {
            ...
            if (str != null)
            {
              ...
              if (localObject != null) {
                ...
                {
                  localbfjm.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("type"))
                {
                  localbfjm.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("flags"))
                {
                  localbfjm.c = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("path"))
                {
                  localbfjm.jdField_b_of_type_JavaLangString = ((String)localObject);
                  i = k + 1;
                }
                else
                {
                  ...
                  {
                    localbfjm.jdField_a_of_type_JavaLangString = ((String)localObject);
                    i = k + 1;
                  }
                }
              }
        ...
        localbfjm.jdField_a_of_type_AndroidOsBundle = a(paramNode);
        return localbfjm;
        j += 1;
        k = i;
      }
  ...
  private String a()
  {
    return bfhr.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List<bfjm> paramList)
  {
    paramList = a(paramInt, paramList);
    if (paramList == null) {
      return false;
    }
    return new bfkg().a(paramString, paramList, null, 1);
  }
  
  /* Error */
  private byte[] a(int paramInt, List<bfjm> paramList)
  {
    // Byte code:
    ...
    //   132: ldc 182
    //   134: aload 6
    //   136: getfield 183	bfjm:jdField_a_of_type_Int	I
    ...
    //   154: ldc 185
    //   156: aload 6
    //   158: getfield 188	bfjm:jdField_b_of_type_Int	I
    ...
    //   198: ldc 200
    //   200: aload 6
    //   202: getfield 202	bfjm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: ldc 195
    //   219: aload 6
    //   221: getfield 198	bfjm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private bfjm b(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      bfjm localbfjm = (bfjm)localIterator.next();
      if (localbfjm.jdField_a_of_type_Int == paramInt) {
        return localbfjm;
      }
    }
    return null;
  ...
  {
    bfjm localbfjm = b(paramInt);
    if (localbfjm == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilList.remove(localbfjm);
    } while (!paramBoolean);
  ...
  public boolean a(bfjm parambfjm, boolean paramBoolean)
  {
    if (a(parambfjm.jdField_a_of_type_Int)) {
      return false;
    }
    this.jdField_a_of_type_JavaUtilList.add(parambfjm);
    if (paramBoolean) {
      return a();
    }
    return true;
