...
public class bbgp
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 101, 2130845929 };
    jdField_b_of_type_ArrayOfInt = new int[] { 102, 2130845932 };
    jdField_c_of_type_ArrayOfInt = new int[] { 103, 2130845928 };
    jdField_d_of_type_ArrayOfInt = new int[] { 104, 2130845935 };
  }
  
  public bbgp(int paramInt)
  {
