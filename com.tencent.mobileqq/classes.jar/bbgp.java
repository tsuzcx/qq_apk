  ...
  extends bbgu
{
  ...
  private adlm jdField_a_of_type_Adlm = new bbgq(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bbgr(this);
  ...
  public bbgp(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  private adlj a(bbgs parambbgs)
  {
    this.jdField_a_of_type_Adlj = new adli();
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambbgs.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Adlj.a(parambbgs.jdField_a_of_type_JavaLangString, parambbgs.b, parambbgs.c, parambbgs.d, parambbgs.jdField_a_of_type_Float, parambbgs.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    if ((this.e != 0) && (this.f != 0)) {
      this.jdField_a_of_type_Adlj.setFixSize(this.e, this.f);
    }
    for (;;)
    {
      alpc.a = false;
      return this.jdField_a_of_type_Adlj;
      this.jdField_a_of_type_Adlj.setFixSize(this.d, this.g);
      this.jdField_a_of_type_Adlj.setMaxSize(this.d, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Adlj.setMinSize(this.b, this.c);
    }
  }
  ...
  {
    paramBundle = a(new bbgs(paramBundle));
