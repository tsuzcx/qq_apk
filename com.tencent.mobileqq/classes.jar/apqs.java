  ...
  implements Manager
{
  ...
  public apqs(QQAppInterface paramQQAppInterface)
  {
  ...
  public IntimateInfo a(String paramString)
  {
    ...
    while ((this.jdField_a_of_type_Atmp == null) || (!this.jdField_a_of_type_Atmp.a())) {
      return null;
    }
    return (IntimateInfo)this.jdField_a_of_type_Atmp.a(IntimateInfo.class, paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          b(str);
        } while (this.jdField_a_of_type_Axxj == null);
        Object localObject = new axro();
        ((axro)localObject).jdField_a_of_type_Axrt = new apqt(this);
        ((axro)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
        ((axro)localObject).jdField_a_of_type_Int = 0;
        ((axro)localObject).c = str;
        ((axro)localObject).e = 0;
        ((axro)localObject).jdField_a_of_type_Axrs = new apqu(this);
        localObject = new axxh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.b, new apqv(this), (axro)localObject);
        this.jdField_a_of_type_Axxj.a(10089, "prd", this.b, 0, this.jdField_a_of_type_JavaLangString, str, 2, 0, false, (axxg)localObject);
        return;
      } while (c());
      bool1 = b(str, a());
      bool2 = c();
  ...
  public void a(IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Atmp != null) && (this.jdField_a_of_type_Atmp.a())) {
        this.jdField_a_of_type_Atmp.a(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = (IntimateInfo)this.jdField_a_of_type_Atmp.a(IntimateInfo.class, paramString);
      if (paramString != null) {
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      return;
      if ((this.jdField_a_of_type_Atmp != null) && (this.jdField_a_of_type_Atmp.a())) {
        this.jdField_a_of_type_Atmp.b(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
