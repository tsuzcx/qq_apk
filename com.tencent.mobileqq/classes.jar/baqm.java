  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  public baqm(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(baqp parambaqp, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Aklg != null) {
        paramDrawable = this.jdField_a_of_type_Aklg.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)aklg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = parambaqp.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      parambaqp.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.getTitleName());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      parambaqp.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(baqp parambaqp, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((parambaqp == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(parambaqp, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof baqp))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((baqp)paramViewHolder, localRecentBaseData, null);
    }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new baqo(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562731, paramViewGroup, false));
    }
    return new baqp(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561402, paramViewGroup, false), this.jdField_a_of_type_Baqn);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof baqp))
        {
          break label437;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (baqp)paramBitmap;
        RecentBaseData localRecentBaseData = a(paramBitmap.getAdapterPosition());
        if (localRecentBaseData == null) {
          break label437;
        }
        int i = localRecentBaseData.getRecentUserType();
        i = ((Integer)aklg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, localRecentBaseData.getRecentUserUin()).first).intValue();
        if (i == -2147483648) {
          break label437;
        }
