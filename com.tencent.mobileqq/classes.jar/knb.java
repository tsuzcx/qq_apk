...
public class knb
  extends BaseAdapter
{
  public knb(TroopCardXingquBuluo paramTroopCardXingquBuluo) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = LayoutInflater.from(this.a.getContext()).inflate(2130969413, paramViewGroup, false);
      ((TroopCardXingquBuluo.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366417));
      ((TroopCardXingquBuluo.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366419));
      ((TroopCardXingquBuluo.ViewHolder)localObject).b = ((TextView)paramView.findViewById(2131366421));
      ((TroopCardXingquBuluo.ViewHolder)localObject).c = ((TextView)paramView.findViewById(2131366422));
