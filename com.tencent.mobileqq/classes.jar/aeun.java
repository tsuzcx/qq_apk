  ...
  extends BaseAdapter
{
  ...
  private aeun(ClassificationSearchFragment paramClassificationSearchFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (paramView == null)
          {
            paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131495005, paramViewGroup, false);
            ...
            paramViewGroup = new aevp();
            paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131301797));
            paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131305157));
            paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312770));
            paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131299473));
            paramViewGroup.d = ((TextView)paramView.findViewById(2131303841));
            ...
            paramView.setTag(2131304100, Integer.valueOf(paramInt));
          ...
          paramView = (aevp)((View)localObject1).getTag();
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131495466, null);
          paramView = new aevo();
          paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131301797));
          paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131305157));
          paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131311478));
          paramView.d = ((TextView)paramViewGroup.findViewById(2131297348));
          paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131297866));
        ...
        paramView = (aevo)paramViewGroup.getTag();
        ...
        int i = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.getResources().getDimensionPixelSize(2131166210);
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, aciy.a(110.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
              localObject2 = (ImageView)paramViewGroup.findViewById(2131313522);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131299236);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, aciy.a(90.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
          }
        }
        paramViewGroup = paramView;
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131493742, null);
          paramViewGroup.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
          paramView = new aeum();
          paramViewGroup.setTag(paramView);
          paramView.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramViewGroup.findViewById(2131309309));
          paramViewGroup.findViewById(2131303806).setVisibility(8);
        ...
        localObject1 = (aeum)paramViewGroup.getTag();
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
        {
          ...
          ((aeum)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
          ((aeum)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131636128));
          return paramViewGroup;
        }
      ...
      ((aeum)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      ((aeum)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131636137));
      ...
      {
        ((aeum)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ((aeum)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131636145));
        return paramViewGroup;
      }
      paramView = paramViewGroup;
    ...
    ((aeum)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    ((aeum)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131636141));
    return paramViewGroup;
  }
