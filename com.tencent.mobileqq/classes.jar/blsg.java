...
public class blsg
{
  public static blrn a;
  public static blrr a;
  public static blse a;
  public static blsn a;
  ...
  public static blrs a(bifw parambifw, blro paramblro)
  {
    if (jdField_a_of_type_Blrr == null) {
      return null;
    }
    return jdField_a_of_type_Blrr.a(parambifw, paramblro);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localblwh.b = "comic_plugin.apk";
    localblwh.d = "comic_plugin";
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (DeviceProfileManager.a(str, arrayOfInteger, new antj()) >= arrayOfInteger.length)
        {
  ...
  {
    if (jdField_a_of_type_Blse == null) {
      jdField_a_of_type_Blse = new blse();
    }
    for (;;)
    {
      jdField_a_of_type_Blse.addObserver(paramObserver);
      return;
      jdField_a_of_type_Blse.deleteObservers();
    }
  }
  
  public static boolean a(Activity paramActivity, Intent paramIntent, String paramString, avlg paramavlg)
  {
    ...
    localblwh.jdField_a_of_type_JavaLangClass = VipComicProxyActivity.a(paramString);
    localblwh.jdField_a_of_type_AndroidContentIntent = paramIntent;
    localblwh.c = 10000;
    localblwh.jdField_a_of_type_Avlg = paramavlg;
  ...
  public static boolean a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      do
      {
        ...
        paramAppRuntime = (blvy)paramAppRuntime.getManager(QQManagerFactory.MGR_PLUGIN);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean, blsj arg2)
  {
    boolean bool = false;
  ...
  {
    if (jdField_a_of_type_Blsn == null) {
      jdField_a_of_type_Blsn = new blsn();
    }
    for (;;)
    {
      jdField_a_of_type_Blsn.addObserver(paramObserver);
      return;
      jdField_a_of_type_Blsn.deleteObservers();
    }
  }
  
  public static void c(Observer paramObserver)
  {
    if ((jdField_a_of_type_Blsn != null) && (paramObserver != null)) {
      jdField_a_of_type_Blsn.deleteObserver(paramObserver);
    }
  }
}
