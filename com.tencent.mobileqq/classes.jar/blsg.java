  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public blsk mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  blsb mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new blsh(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<blso> mRecoverAnimations = new ArrayList();
  ...
  public blsg(blsk paramblsk)
  {
    this.mCallback = paramblsk;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new blsj(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      blso localblso = (blso)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localblso.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new blsb(this.mRecyclerView.getContext(), new blsn(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return blsk.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return blsk.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      blso localblso = (blso)this.mRecoverAnimations.get(i);
      if (localblso.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localblso.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localblso.jdField_c_of_type_Boolean) {
          localblso.b();
        }
        this.mRecoverAnimations.remove(i);
        return localblso.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  blso findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      blso localblso = (blso)this.mRecoverAnimations.get(i);
      paramMotionEvent = localblso;
      if (localblso.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (blso)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((blso)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(blso paramblso, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, paramblso, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new blsi(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((blso)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
