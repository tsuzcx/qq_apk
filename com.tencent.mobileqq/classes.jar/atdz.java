...
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new atea(this);
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            vju.a(localActivity, new VidListPlayInfo(paramJsBridgeListener, paramString3, paramString2, paramString1), 105, null);
            break;
          }
