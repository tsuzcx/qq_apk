  ...
  implements alkr
{
  ...
  public ambi(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          ...
          {
            localObject2 = (NewCommonConchArgs)bjpy.a(new NewCommonConchArgs(), ((Conch)localObject2).params);
            ...
            else
            {
              ...
              bevt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i, (String)localObject2);
              bevt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
          else if (6142 == ((Conch)localObject2).cmdId)
          {
            ...
            else
            {
              ...
              bevt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), (String)localObject2);
              bevt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
        }
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Ambj != null) {
        this.jdField_a_of_type_Ambj.a(paramInt);
      }
      return;
      try
      {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bevt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramObject);
          continue;
          paramObject = (bevv)paramObject;
          a(paramObject.jdField_a_of_type_MConchSCPullConchs);
          if (this.jdField_a_of_type_Ambj != null) {
            this.jdField_a_of_type_Ambj.a(paramObject.jdField_a_of_type_MWIFISCGet3rdCloudCheck);
          }
        }
      }
    }
