...
public class aucy
{
  ...
  public static Pair<StringBuilder, StringBuilder> a(Context paramContext, File paramFile)
  {
    ...
    a = true;
    paramContext = yxi.a(Uri.parse("file://" + paramFile.getAbsolutePath()), paramContext);
    a = false;
    return paramContext;
  }
  ...
  public static msg_ctrl.MsgCtrl a(String paramString)
  {
    ...
    Object localObject2;
    long l2;
    if ((audj.a().f()) && (!TextUtils.isEmpty(paramString)))
    {
  ...
  {
    Object localObject = audj.a();
    if (!((audj)localObject).e()) {}
    String str;
    do
    {
      return false;
      str = ((audj)localObject).a();
      localObject = ((audj)localObject).b();
