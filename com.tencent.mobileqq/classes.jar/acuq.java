  ...
  implements acxj, View.OnClickListener, bfqj
{
  ...
  public acuq(acup paramacup) {}
  
  private void a(acuz paramacuz)
  {
    if ((paramacuz instanceof aebx)) {
      paramacuz = Integer.toString(0);
    }
    for (;;)
    {
      axqy.b(this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004044", "0X8004404", 0, 0, paramacuz, "", "", "");
      return;
      if ((paramacuz instanceof advs)) {
        paramacuz = Integer.toString(1);
      } else {
        paramacuz = Integer.toString(999);
      }
    }
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Aibm != null) {
      this.jdField_a_of_type_Aibm.b();
    }
    Object localObject1;
    if (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage != null)
    {
      localObject1 = this.jdField_a_of_type_Acup.jdField_a_of_type_Adte.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Acup);
    ...
    for (;;)
    {
      ...
      bbcq.jdField_a_of_type_Boolean = false;
      Object localObject2;
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Boolean) {
            if (((aebu)localObject3).jdField_a_of_type_Ambg != null) {
              ((aebu)localObject3).jdField_a_of_type_Ambg.a(this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((aebu)localObject3).jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend(), ((aebu)localObject3).jdField_a_of_type_ComTencentMobileqqDataChatMessage.needVipBubble(), true, ((aebu)localObject3).jdField_a_of_type_AndroidViewView, false);
            }
          }
          for (;;)
          {
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage != null)
    {
      localacuz = this.jdField_a_of_type_Acup.jdField_a_of_type_Adte.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Acup);
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    Object localObject2;
    int i;
    if (this.jdField_a_of_type_Acup.jdField_a_of_type_Boolean)
    {
      bool = false;
      ...
      localObject2 = actj.a(paramView);
      if (!((ChatMessage)localObject2).isMultiMsg) {
        break label1319;
      }
      if (asuh.b((ChatMessage)localObject2)) {
        break label151;
      }
      i = 1;
    }
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return true;
          bool = this.jdField_a_of_type_Acup.jdField_a_of_type_Aibr.a(paramView);
          break;
          i = 0;
          break label113;
          if (this.jdField_a_of_type_Acup.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
            break label187;
          }
        } while (!QLog.isColorLevel());
      ...
      if ((!bool) && (this.jdField_a_of_type_Aibm != null) && (this.jdField_a_of_type_Aibm.a()))
      {
        a(paramView);
        return false;
      }
      ...
      Object localObject1 = this.jdField_a_of_type_Acup.jdField_a_of_type_Adte.a((ChatMessage)localObject2, this.jdField_a_of_type_Acup);
      Object localObject4 = ((acuz)localObject1).a(paramView);
      int j;
      if ((localObject4 != null) && (localObject4.length > 0))
      {
        this.jdField_a_of_type_ComTencentMobileqqDataChatMessage = actj.a(paramView);
        j = localObject4.length;
        i = 0;
        while (i < j)
        {
          ((bbmf)localObject3).a(localObject4[i]);
          i += 1;
        }
        if (((bbmf)localObject3).a() < 1) {
          return false;
        }
      ...
      for (i = 1;; i = 0)
      {
        ...
        for (;;)
        {
          if (this.jdField_a_of_type_Aibm == null)
          {
            this.jdField_a_of_type_Aibm = new aibm(this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
            this.jdField_a_of_type_Aibm.a(this);
            this.jdField_a_of_type_Aibm.a(this);
          }
          this.jdField_a_of_type_Aibm.a = ((int)this.jdField_a_of_type_AndroidGraphicsPointF.y);
          k = (int)this.jdField_a_of_type_AndroidGraphicsPointF.x - bbll.b(14.0F);
          this.jdField_a_of_type_Aibm.b = k;
          if (bool)
          {
            this.jdField_a_of_type_Aibm.a((bbmf)localObject3, ((ChatMessage)localObject2).isMultiMsg);
            this.jdField_a_of_type_Aibm.a(k);
            this.jdField_a_of_type_Aibm.b(j);
            if ((paramView instanceof ArkAppView))
            {
            ...
            if ((localObject1 instanceof BaseBubbleBuilder))
            {
              ...
              if (localObject2 != null)
              {
                ...
                ((acui)localObject2).a(paramView, true);
              }
            }
          }
          for (;;)
          {
            if (bool) {
              this.jdField_a_of_type_Acup.jdField_a_of_type_Aibr.a(paramView, this.jdField_a_of_type_Aibm);
            }
            a((acuz)localObject1);
            bbcq.jdField_a_of_type_Boolean = true;
            return true;
            localObject2 = this.jdField_a_of_type_Aibm.a(paramView, this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
            this.jdField_a_of_type_Aibm.a(paramView, k, ((aibv)localObject2).a, (bbmf)localObject3, true, ((aibv)localObject2).b);
            break;
            label861:
            ...
            ((acui)localObject2).a(paramView, false);
          }
          a(paramView);
          return false;
          j = k - m;
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    Object localObject1 = actj.a(paramView);
    if ((paramView instanceof ArkAppView))
    {
      ((ArkAppView)paramView).onTouch(paramView, paramMotionEvent);
      if ((paramMotionEvent.getAction() == 1) && (this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null))
      {
        if (this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a != 1008) {
          break label238;
        }
        sgg.a(this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1);
      }
    }
    if ((paramMotionEvent.getAction() == 1) && (this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a == 1008) && (localObject1 != null)) {
      akwu.a(118, (ChatMessage)localObject1, actj.a(((ChatMessage)localObject1).uniseq, this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentWidgetListView.getAdapter()));
    }
    ...
    for (;;)
    {
      localObject1 = this.jdField_a_of_type_Acup.jdField_a_of_type_Adte.a((ChatMessage)localObject1, this.jdField_a_of_type_Acup);
      if ((!this.jdField_b_of_type_Boolean) && ((localObject1 instanceof BaseBubbleBuilder)))
      {
        ...
        if (localObject1 != null) {
          ((acui)localObject1).a(paramView, paramMotionEvent);
        }
      }
      return false;
      label238:
      if ((this.jdField_a_of_type_Acup.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a != 1038) || (!(localObject1 instanceof MessageForArkApp))) {
        break;
      }
      ...
      break;
      localObject2 = paramView.findViewById(2131376574);
      if ((localObject2 != null) && ((localObject2 instanceof PAHighLightImageView)) && (!this.jdField_b_of_type_Boolean)) {
        ((PAHighLightImageView)localObject2).a(paramView, paramMotionEvent);
      }
    }
