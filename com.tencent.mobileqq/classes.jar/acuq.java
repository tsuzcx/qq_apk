...
{
  public acuq(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void loadFinish(int paramInt1, boolean paramBoolean, int paramInt2, String paramString)
  {
    ...
    {
      bool1 = true;
      this.a.runOnUiThread(new acus(this, paramInt1, bool1, paramInt2, paramString));
      paramString = this.a;
      if (paramBoolean) {
        break label67;
      }
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        localObject2 = UniformDownloadMgr.a();
        ...
        DialogUtil.a(this.a, 233, this.a.getString(2131434162), "是否下载文件:\n" + paramString1 + "(" + FileUtil.a(paramLong) + ")", new acut(this, paramString2, (UniformDownloadMgr)localObject2, (Bundle)localObject3), new acuu(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!FileUtil.b(((FileManagerEntity)localObject3).getFilePath()));
    ...
    paramString1.c = FileUtil.a(((FileManagerEntity)localObject3).fileName);
  ...
  {
    this.a.runOnUiThread(new acur(this, paramInt1, paramInt2));
  }
