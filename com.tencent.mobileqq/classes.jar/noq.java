  ...
  implements Manager
{
  ...
  public String a;
  HashMap<String, nos> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public noq(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bfpo = new nor(this);
  ...
  public nos a(String paramString, long paramLong)
  {
    nos localnos2 = (nos)this.jdField_a_of_type_JavaUtilHashMap.get(paramString + paramLong);
    nos localnos1 = localnos2;
    if (localnos2 == null)
    {
      localnos1 = new nos(this);
      localnos1.jdField_a_of_type_JavaLangString = paramString;
      localnos1.jdField_a_of_type_Long = paramLong;
      this.jdField_a_of_type_JavaUtilHashMap.put(localnos1.a(), localnos1);
    }
    return localnos1;
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    new bfpn("https://now.qq.com/cgi-bin/now/web/room/get_live_room_url", "GET", this.jdField_a_of_type_Bfpo, 1001, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    paramString2.put("CONTEXT", MobileQQ.getContext());
    new bfpn("https://now.qq.com/cgi-bin/now/web/room/check_live_stat", "GET", this.jdField_a_of_type_Bfpo, 1003, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public boolean b()
  {
    ...
    Iterator localIterator = ((baif)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a().iterator();
