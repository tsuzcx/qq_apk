  ...
  implements Handler.Callback, bmjh, bnki, HWDecodeListener
{
  ...
  public bmkq(@NonNull bmix parambmix)
  {
    super(parambmix);
  ...
  public static Bitmap a(Context paramContext, Bitmap paramBitmap, bnjl parambnjl)
  {
    if ((paramBitmap == null) || (parambnjl == null)) {
      return null;
    }
    Object localObject = xom.a(paramBitmap.getWidth(), paramBitmap.getHeight(), azgq.jdField_a_of_type_Int, azgq.jdField_b_of_type_Int);
    int j = ((Integer)((Pair)localObject).first).intValue();
    int k = ((Integer)((Pair)localObject).second).intValue();
    int i = bnje.jdField_a_of_type_Int;
    if (k > i) {
      j = (int)(j * i / k);
    }
    for (;;)
    {
      ...
      {
        paramContext = bdda.a(paramContext, bdda.c(paramBitmap), 0.4F, 25.0F);
        parambnjl = paramContext;
        ...
        label205:
        for (parambnjl = paramContext;; parambnjl = paramContext.copy(paramContext.getConfig(), true))
        {
          localCanvas.setBitmap(parambnjl);
          localCanvas.drawColor(Color.parseColor("#3F000000"), PorterDuff.Mode.SRC_OVER);
          parambnjl = paramContext;
          paramContext = xmn.a(xmn.a(parambnjl, j, i, true), paramBitmap);
  ...
  private Bitmap a(@NonNull bmks parambmks, boolean paramBoolean)
  {
    long l1 = 0L;
    int i = 180;
    Object localObject2 = bmks.a(parambmks);
    long l2 = this.jdField_a_of_type_Bmix.c() / 1000000L;
    Object localObject1;
    if ((l2 != 0L) && (paramBoolean))
    {
      localObject1 = bnkb.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo, l2);
    ...
    for (;;)
    {
      ...
      label126:
      Object localObject3;
      if (xom.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo))
      {
        i = 0;
        ...
        localObject1 = a(a(), (Bitmap)localObject1, localbnjl);
        localObject3 = bkka.a(bkka.jdField_c_of_type_Int);
        localObject2 = localObject1;
        if (localObject3 != null)
        {
          ...
          {
            if (paramBoolean) {
              l1 = this.jdField_a_of_type_Bmix.c();
            }
            localObject3 = localbnjl.a((Bitmap)localObject1, l1);
            localObject2 = localObject1;
            if (localObject3 != null) {
        ...
        if ((!bmks.a(parambmks)) || (!bnjk.a(bmks.a(parambmks)))) {
          break label635;
        }
        switch (bmks.a(parambmks))
        {
        default: 
          localObject1 = null;
          label251:
          if (localObject1 != null)
          {
            ...
            wsv.a("Q.qqstory.record.HWEditImportVideoPlayer", "updateFragmentThumbBitmapIfNeeded, filterThumbBitmap = %s", localObject3);
            if (localObject3 != null) {
      ...
      for (;;)
      {
        ...
        {
          localObject2 = localObject1;
          if (bmks.b(parambmks) != null)
          {
            bnjp localbnjp = (bnjp)bnjk.a(106);
            localbnjp.a(bmks.b(parambmks));
            localbnjp.init();
            localObject2 = localbnjl.a((Bitmap)localObject1, localbnjp);
            wsv.a("Q.qqstory.record.HWEditImportVideoPlayer", "updateFragmentThumbBitmapIfNeeded, mosaicThumbBitmap = %s", localObject2);
            if (localObject2 != null) {
              localObject1 = localObject2;
            }
            localbnjp.destroy();
        ...
        if ((localObject3 != null) && (localObject3 != bmks.a(parambmks)) && (localObject3 != localObject2)) {
          ((Bitmap)localObject3).recycle();
        }
        localbnjl.a();
        localObject1 = localObject2;
        if (i != 0) {
          localObject1 = xod.a((Bitmap)localObject2, 360 - i);
        }
        localObject2 = localObject1;
        if (this.jdField_e_of_type_Boolean) {
          localObject2 = xod.a((Bitmap)localObject1, 90.0F);
        }
        if ((localObject2 != bmks.a(parambmks)) || (bmks.a(parambmks)) || (bmks.b(parambmks)))
        {
          return localObject2;
          ...
          {
            localObject2 = this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
            localObject1 = a(localbnjl, (Bitmap)localObject1, a(), a().getString(2131699881, new Object[] { localObject2 }));
            break label126;
          }
          localbnjl.a(((Bitmap)localObject1).getWidth(), ((Bitmap)localObject1).getHeight());
          break label126;
        ...
        return parambmks.jdField_c_of_type_AndroidGraphicsBitmap;
        localObject1 = localObject2;
        continue;
        label635:
        localObject3 = null;
  ...
  public static Bitmap a(bnjl parambnjl, Bitmap paramBitmap, Context paramContext, String paramString)
  {
    ...
    for (j = (int)(k * i / j);; j = k)
    {
      ...
      i = axld.a(i);
      parambnjl.a(j, i);
      parambnjl = new bnjz(paramContext, paramString);
      parambnjl.a(k, m, j, i);
      paramContext = new GLImage();
      paramContext.loadTextureSync(paramBitmap);
      paramBitmap = GlUtil.captureFrame(parambnjl.a(paramContext.getTexture()), j, i);
      parambnjl.a();
      return paramBitmap;
      i = j;
    }
  ...
  private void a(@NonNull bmks parambmks)
  {
    wsv.b("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayInfo，index : %d => %d", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(parambmks.jdField_c_of_type_Int));
    if (parambmks.jdField_a_of_type_JavaLangString == null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setPlayRange((int)bmks.a(parambmks), (int)bmks.b(parambmks));
      if (this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter != null) {
        this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter.a(3, alpo.a(2131706050));
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = parambmks.jdField_c_of_type_Int;
      return;
      if (!this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a().equalsIgnoreCase(parambmks.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c();
        this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setFilePath(parambmks.jdField_a_of_type_JavaLangString, parambmks.jdField_b_of_type_JavaLangString, true, this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean);
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Bmix.a() != null) && (!this.jdField_a_of_type_Bmix.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      ...
      i = azgq.jdField_b_of_type_Int;
      if (azgq.a(a())) {
        break label333;
      }
    }
    label333:
    for (int i = azgq.c(a());; i = azgq.jdField_b_of_type_Int)
    {
      k = (int)(j / f1);
  ...
  public int a()
  {
    ...
    {
      bmks localbmks = (bmks)this.jdField_a_of_type_JavaUtilList.get(i);
      if (localbmks != null) {
        return bmks.a(localbmks);
      }
    }
    return 0;
  }
  ...
  public long a(int paramInt)
  {
    ...
    {
      bmks localbmks = (bmks)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      return bmks.b(localbmks) - bmks.a(localbmks);
    }
    wsv.e("Q.qqstory.record.HWEditImportVideoPlayer", "getDurationOfFragment with invalid index = %d", new Object[] { Integer.valueOf(paramInt) });
    return 0L;
  }
  ...
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return a((bmks)this.jdField_a_of_type_JavaUtilList.get(paramInt), true);
    }
    wsv.e("Q.qqstory.record.HWEditImportVideoPlayer", "getDurationOfFragment with invalid index = %d", new Object[] { Integer.valueOf(paramInt) });
    return null;
  }
  ...
  public void a()
  {
    ...
    {
      localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaWidth == 0) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaHeight == 0))
      {
        ...
        bnnt.a(this.jdField_a_of_type_JavaLangString, (bnnu)localObject);
      ...
      wsv.d("Q.qqstory.record.HWEditImportVideoPlayer", "recordMultiVideoFragment = %s, supportMultiVideoFragment = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
      if ((!bool1) || (!bool2)) {
        break label642;
      }
      bool1 = true;
      ...
      if (this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) {
        break label647;
      }
      this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
      label334:
      this.jdField_c_of_type_Boolean = this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_fit_center", false);
      this.jdField_d_of_type_Boolean = this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_need_gaussion_blur", false);
      if (this.jdField_d_of_type_Boolean) {
        if (!xom.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo)) {
          break label758;
        }
    ...
    for (int i = -90;; i = 0)
    {
      ...
      {
        localObject = (VideoStoryDataBean)this.jdField_a_of_type_Bmix.jdField_a_of_type_AndroidOsBundle.getSerializable("KEY_VIDEO_STORY_CAMERA_TYPE");
      ...
      else if (this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("is_video_forward", false))
      {
        if (!xom.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo)) {
          break label753;
        }
      ...
      for (i = j;; i = 0)
      {
        localObject = this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(a().getString(2131699881, new Object[] { localObject }), i);
        ...
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setTrackerCallback(new bmkr(this));
        a(bmjh.class, this);
        ...
        bool1 = false;
        break;
        if (((this.jdField_a_of_type_Bmix.a() != null) && (this.jdField_a_of_type_Bmix.a().isLandTakePicToVideo())) || (!xom.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo))) {
          this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        }
        for (;;)
        {
  ...
  public void a(int paramInt)
  {
    ...
    {
      localbmks = (bmks)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int);
      if (localbmks.jdField_a_of_type_JavaLangString == null)
      {
    ...
    for (;;)
    {
      ...
      return;
      wsv.b("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayMode change to iframe video");
      a(localbmks);
      break;
  ...
  public void a(int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    if ((f1 == 0.0F) || (f1 > 0.95F))
    {
      ...
      a(paramInt1);
      wsv.a("Q.qqstory.record.HWEditImportVideoPlayer", "setSlideMode lefPlayMode=%s rightMode=%s, offset=%s", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Float.valueOf(paramFloat));
    }
    do
    {
      return;
  ...
  public void a(int paramInt, @NonNull bmwn parambmwn)
  {
    ...
    if (i > 1) {
      if (paramInt < i)
      {
        localObject = (bmks)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        parambmwn.a.hasFragments = true;
        parambmwn.a.videoNeedRotate = false;
        parambmwn.a.videoRangeStart = ((int)bmks.a((bmks)localObject));
        parambmwn.a.videoRangeEnd = ((int)bmks.b((bmks)localObject));
        wsv.b("Q.qqstory.record.HWEditImportVideoPlayer", "editVideoPrePublish : %s", localObject);
      }
    }
    for (;;)
    {
      parambmwn.a.putExtra("local_import", Boolean.valueOf(true));
      parambmwn.a.putExtra("video_rotation", Integer.valueOf(this.jdField_d_of_type_Int));
      ...
      parambmwn.a.putExtra("landscape_video", Boolean.valueOf(bool));
      parambmwn.a.putExtra("extra_is_need_gaussion_blur", Boolean.valueOf(this.jdField_d_of_type_Boolean));
      if (this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("is_video_forward", false))
      {
        localObject = this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
        parambmwn.a.putExtra("video_forward_watermark", a().getString(2131699881, new Object[] { localObject }));
        parambmwn.a.putExtra("is_video_forward", Boolean.valueOf(true));
      }
      return;
      wsv.d("Q.qqstory.record.HWEditImportVideoPlayer", "editVideoPrePublish : get invalid fragment index = %d, fragment count = %d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(i) });
      continue;
      if (i == 1)
      {
        localObject = (bmks)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        parambmwn.a.videoNeedRotate = false;
        parambmwn.a.videoRangeStart = this.jdField_b_of_type_Int;
        parambmwn.a.videoRangeEnd = this.jdField_c_of_type_Int;
        parambmwn.a.hwEncodeRecordVideo = true;
      }
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      localbmks = (bmks)this.jdField_a_of_type_JavaUtilList.get(i);
      bmks.a(localbmks, paramBitmap);
      if ((!bmks.b(localbmks)) && (!paramBoolean)) {
        break label73;
      }
    }
    label73:
  ...
  public void a(boolean paramBoolean)
  {
    int i = this.jdField_a_of_type_Bmix.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size()) {
      bmks.b((bmks)this.jdField_a_of_type_JavaUtilList.get(i), paramBoolean);
    }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    if (paramMessage.what == 6)
    {
      ...
      paramMessage = (bmks)this.jdField_a_of_type_JavaUtilList.get(i);
      wsv.b("Q.qqstory.record.HWEditImportVideoPlayer", "MESSAGE_PLAYING_FRAGMENT_CHANGED : fragment = %s", paramMessage);
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setColorFilterType(b(bmks.a(paramMessage)));
      a(bmks.a(paramMessage));
      a(paramMessage);
    ...
    for (;;)
    {
      return false;
      label180:
      wsv.e("Q.qqstory.record.HWEditImportVideoPlayer", "MESSAGE_PLAYING_FRAGMENT_CHANGED : get invalid index=%d, video fragment count = %d", new Object[] { Integer.valueOf(i), Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
    }
  }
  ...
  {
    wsv.a("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayMode mode=%s", Integer.valueOf(paramInt));
    int i = this.jdField_a_of_type_Bmix.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      bmks localbmks = (bmks)this.jdField_a_of_type_JavaUtilList.get(i);
      if (bmks.a(localbmks) != paramInt)
      {
        bmks.a(localbmks, paramInt);
        bmks.c(localbmks, true);
      }
    }
  }
  ...
  public void g()
  {
    ...
    super.g();
    if ((blun.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j > 100) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c > 0L))
    {
      ...
      if (wta.a((int)f1, 0L, 30L)) {
        wta.a("CamEditFreq", true, 0L, new String[] { String.valueOf(this.jdField_a_of_type_Bmix.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int), String.valueOf(f1), wta.b(i), String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j), String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c) });
      }
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if ((localBitmap != null) && (localBitmap != paramMessage.jdField_c_of_type_AndroidGraphicsBitmap))
      {
        ...
        wsv.b("Q.qqstory.record.HWEditImportVideoPlayer", "update fragment bitmap : %s", paramMessage);
