...
public final class bmkq
{
  ...
  public static FileManagerEntity a(Bundle paramBundle, String paramString, int paramInt)
  {
    ...
    return aunj.a(str1, str2, paramBundle, str3, l, bhml.a(arrayOfByte), paramString, paramInt);
  }
  ...
  public static FileManagerEntity a(FavFileInfo paramFavFileInfo, String paramString, int paramInt)
  {
    ...
    return aunj.a(str1, str2, str4, str3, l, paramFavFileInfo.n, paramString, paramInt);
  }
  ...
  public static void a(Context paramContext, FavFileInfo paramFavFileInfo, int paramInt)
  {
    ...
    localBundle.putLong("download_fav_id", paramFavFileInfo.jdField_a_of_type_Long);
    localBundle.putInt("thumb_format", paramInt);
    QfavPluginProxyService.a().a(paramContext.getPackageName(), 3, localBundle);
  }
  ...
  {
    a(paramContext, paramString1, paramBoolean1, paramString2, paramBoolean2, 2131691991);
  }
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = paramContext.getString(2131692033);
        if (!paramBoolean2) {
          continue;
        }
        paramString1 = paramContext.getString(2131692028);
        paramString1 = bhlq.a(paramContext, 230, paramString2, paramString1, 2131690580, 2131692031, new bmkr(), null);
      ...
      localQQToast.b(paramContext.getResources().getDimensionPixelSize(2131299011) - (int)(5.0F * paramContext.getResources().getDisplayMetrics().density));
      return;
      paramString1 = paramContext.getString(2131692032);
      continue;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<FavFileInfo> paramList, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramQQAppInterface.a().a(localFileManagerEntity, paramString, paramInt, 0);
      }
    }
  }
  ...
  public static boolean a(Context paramContext, long paramLong, Boolean paramBoolean, Bundle paramBundle)
  {
    ...
    QfavPluginProxyService.a().a(paramContext.getPackageName());
    Bundle localBundle = paramBundle;
    if (paramBundle == null) {
      localBundle = new Bundle();
    }
    localBundle.putLong("reqTimestamp", paramLong);
    localBundle.putBoolean("localEnd", paramBoolean.booleanValue());
    QfavPluginProxyService.a().a(paramContext.getPackageName(), 2, localBundle);
    return true;
  }
  ...
  public static boolean a(Context paramContext, Bundle paramBundle)
  {
    ...
    localBundle.putBoolean("bool_refresh_list", true);
    QfavPluginProxyService.a().a(paramContext.getPackageName(), 2, localBundle);
    return true;
  }
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    ...
    return (paramChatMessage != null) && ((araw.c.equals(paramChatMessage.ark_app_message.appName)) || ("com.tencent.structmsg".equals(paramChatMessage.ark_app_message.appName)));
  }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bmks((Runnable)localObject2));
