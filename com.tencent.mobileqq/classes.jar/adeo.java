  ...
  private static void a(QQAppInterface paramQQAppInterface, MsgType0x210 paramMsgType0x210)
  {
    ...
    do
    {
      do
      {
        ...
        if (i == 49)
        {
          arry.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), localMsgBody.uint32_version.get());
          return;
        }
        if (i == 46)
        {
          aczk.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), localMsgBody.uint32_version.get(), "C2COnlinePush");
          return;
        }
        if (i == 1003)
        {
        ...
        if (i != localMsgBody.uint32_version.get()) {
          arry.a(paramQQAppInterface, 222, paramQQAppInterface.getCurrentAccountUin());
        }
    ...
    try
    {
      ...
      arry.a(paramQQAppInterface, 283, paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (Throwable paramQQAppInterface)
    {
