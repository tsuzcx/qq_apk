...
public class ayip
{
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bguh.a(paramInt1, paramString, paramInt2);
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a(bgkw.a(this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow, paramView.getContext(), this.jdField_a_of_type_Bguh, this.jdField_a_of_type_AndroidViewView$OnClickListener, true));
