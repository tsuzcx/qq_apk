  ...
  extends BaseBubbleBuilder
{
  ...
  public agbu(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new agbv(this);
  }
    ...
    if (paramInt == 2)
    {
      ...
      if (paramSessionInfo.jdField_a_of_type_Int == 3000) {
        if (paramQQAppInterface.a().b() != l) {
          azmj.b(paramQQAppInterface, "CliOper", "", "", "Multi_call", "Multi_call_disobj_launch", 0, 0, "", "", "", "");
        }
      }
      ...
      if (paramInt == 10)
      {
        ...
        for (;;)
        {
          azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005DC6", "0X8005DC6", 0, 0, "", "", "", "");
          return;
          label242:
          azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005925", "0X8005925", 0, 0, "", "", "", "");
        }
      }
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X80046CB", "0X80046CB", 0, 0, "", "", "", "");
      return;
    }
    boolean bool = bdex.a("qqVideoEx", paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, int paramInt, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (10 == paramInt)
    {
      ...
      {
        paramString1 = bdex.a(paramQQAppInterface, str);
        bool = paramString1.getBoolean("forceDisableInviteBox");
        i = paramString1.getInt("errId", 2131696104);
      }
      if (bool) {
        bdcd.a(paramContext, 230, null, paramContext.getResources().getString(i), 2131695892, 2131721323, new agbw(), null).show();
      }
    }
    ...
    {
      if (i != 0) {
        AudioHelper.a(alpo.a(2131716676));
      }
      ...
      if (j == 1) {
        paramSessionInfo.putBoolean("enableInvite", bdex.a("showGroupQavActionSheet", paramQQAppInterface, str));
      }
    ...
    paramString1 = paramQQAppInterface.a().a(awwo.b(str));
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, MessageForVideo paramMessageForVideo)
  {
    ...
    {
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005642", "0X8005642", 0, 0, "", "", "", "");
      return;
    }
    azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005243", "0X8005243", 0, 0, "", "", "", "");
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForVideo paramMessageForVideo, SessionInfo paramSessionInfo)
  {
    ...
    else
    {
      try
      {
        ...
        boolean bool1 = ((bcjl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramQQAppInterface.getCurrentAccountUin());
        boolean bool2 = ((bcjl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
        boolean bool3 = ((bcjl)localObject).b(paramSessionInfo.jdField_a_of_type_JavaLangString);
        localObject = ((bcjl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
        if ((l == 0L) && (((!bool3) && (bool1)) || ((!bool2) && (localObject != null) && (((bcjs)localObject).a > 0L))))
        {
          QQToast.a(paramQQAppInterface.getApp(), alpo.a(2131716675), 0).b(paramQQAppInterface.getApp().getResources().getDimensionPixelSize(2131298914));
          return;
        }
      }
  ...
  private static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!paramBoolean)
    {
      ...
      default: 
        paramSessionInfo = "0";
        label72:
        azmj.b(paramQQAppInterface, "CliOper", "", "", str1, str2, 0, 0, paramSessionInfo, "", "", "");
        if (paramInt == 2) {
          azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004009", "", 0, 0, "2", "", "", "");
        }
        break;
      }
    }
    for (;;)
    {
      ...
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005643", "0X8005643", 0, 0, "", "", "", "");
      return;
      str1 = "Two_video_call";
      ...
      break label72;
      if (paramInt == 0) {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800400A", "", 0, 0, "2", "", "", "");
      }
    }
    label238:
    azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005244", "0X8005244", 0, 0, "", "", "", "");
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, MessageForVideo paramMessageForVideo, SessionInfo paramSessionInfo)
  {
    ...
    if (paramMessageForVideo.type == 13)
    {
      ...
      azmj.b(paramQQAppInterface, "CliOper", "", "", "Multi_call", "Multi_call_disobj", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      if ((paramMessageForVideo.type == 2) || (paramMessageForVideo.type == 24)) {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004009", "", 0, 0, "1", "", "", "");
      }
      if (paramMessageForVideo.type == 0) {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800400A", "", 0, 0, "1", "", "", "");
      }
      return;
      label123:
      if (i == 1) {
        if (paramMessageForVideo.extInt == 10) {
          azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005924", "0X8005924", 0, 0, "", "", "", "");
        } else {
          azmj.b(null, "dc00899", "Grp_video", "", "notice", "video", 0, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, "" + bclo.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString), "0", "");
        }
      }
    }
  }
  ...
  private void a(MessageForVideo paramMessageForVideo, Context paramContext, View paramView)
  {
    ...
    if (paramMessageForVideo.selfuin.equals(paramMessageForVideo.senderuin))
    {
      if (-2016 == paramMessageForVideo.msgtype) {
        localObject1 = alpo.a(2131716669);
      }
      ...
      if (!paramMessageForVideo.text.contains(paramContext.getResources().getString(2131721320))) {
        break label569;
      }
      localObject2 = paramMessageForVideo.text;
      paramContext = paramContext.getResources().getString(2131721320) + ",";
    ...
    for (;;)
    {
      ...
      label449:
      label765:
      for (localObject1 = paramContext + k + alpo.a(2131716671);; localObject1 = paramContext)
      {
        paramContext = (Context)localObject1;
        if (j > 0) {
          paramContext = (String)localObject1 + j + alpo.a(2131716673);
        }
        localObject1 = paramContext;
        if (i > 0) {
          localObject1 = paramContext + i + alpo.a(2131716672);
        }
        ...
        for (;;)
        {
          paramView.setContentDescription(((String)localObject1).replace(alpo.a(2131716677), alpo.a(2131716668)));
          return;
          localObject1 = bdbt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForVideo.senderuin, 0);
          break;
          i = 2131720899;
          break label135;
          ...
          i = 2131720899;
          break label449;
          if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131721309)))
          {
            paramContext = paramContext.getResources();
            if (paramMessageForVideo.isVideo) {}
            for (i = 2131721326;; i = 2131690320)
            {
              localObject1 = paramContext.getString(i);
              break;
            }
          }
          if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131696419))) {
            localObject1 = paramContext.getResources().getString(2131719733);
          } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131696418))) {
            localObject1 = paramContext.getResources().getString(2131719228);
          } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695849))) {
            localObject1 = paramContext.getResources().getString(2131719733);
          } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695848))) {
            localObject1 = paramContext.getResources().getString(2131719228);
          }
        }
      }
  ...
  public View a(ChatMessage paramChatMessage, aelt paramaelt, View paramView, BaseChatItemLayout paramBaseChatItemLayout, aeov paramaeov)
  {
    ...
    localagbx.a.setTextColor(localResources.getColor(i));
    localagbx.a.setText(paramView.text);
    if ((paramView.istroop == 1) && (this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131696048).equals(paramView.text))) {
      azmj.b(null, "dc00899", "Grp_video", "", "notice", "exp", 0, 0, paramView.frienduin, "" + bclo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView.frienduin), "", "");
    }
    ...
    if (jdField_e_of_type_Boolean) {
      a(paramView, paramBaseChatItemLayout, paramaelt);
    }
    return paramaelt;
  }
  ...
  {
    agbx localagbx = (agbx)paramaelt;
    localagbx.a.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_Int);
    if ((paramansf.jdField_a_of_type_Int == 0) || (!paramansf.a()))
    {
      paramView = paramView.getResources();
      if (localagbx.a.getText().toString().contains(this.jdField_a_of_type_AndroidContentContext.getString(2131721306)))
      {
        paramaelt = paramView.getColorStateList(2131165867);
        localagbx.a.setTextColor(paramaelt);
        return;
      }
      ...
      {
        localagbx.a.setLinkTextColor(paramaelt);
        return;
    ...
    if (paramansf.jdField_b_of_type_Int == 0) {
      localagbx.a.setTextColor(-16777216);
    }
    while (paramansf.c == 0)
    {
      localagbx.a.setLinkTextColor(paramView.getResources().getColorStateList(2131166921));
      return;
      localagbx.a.setTextColor(paramansf.jdField_b_of_type_Int);
    }
    localagbx.a.setLinkTextColor(paramansf.c);
  }
