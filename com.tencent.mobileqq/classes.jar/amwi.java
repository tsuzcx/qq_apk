...
public class amwi
  implements anfh
{
  public amwi(CmGameServerQIPCModule.5 param5) {}
  
  public void a(boolean paramBoolean, String paramString, List<anff> paramList)
  {
    int i = 1;
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqApolloScriptSpriteTaskParam.m = this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkCmShowRenderView$PlayActionConfig.c;
      paramString = ando.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloScriptSpriteTaskParam, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkIPCSpriteContext, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkCmShowRenderView$PlayActionConfig);
