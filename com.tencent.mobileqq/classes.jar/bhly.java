...
class bhly
{
  ...
  void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        if (!bhlw.a().equals(new bhmc(arrayOfByte))) {
          break;
        }
    ...
    } while (!bhlw.b().equals(new bhmc(paramArrayOfByte)));
    if (i - j <= 2)
    {
    ...
    localByteBuffer.get(paramArrayOfByte);
    int k = new bhmd(paramArrayOfByte).a();
    if (i - j - 2 < k)
    {
    ...
    return;
    if (bhlw.b().equals(new bhmc(arrayOfByte)))
    {
      j = bhlw.b().a().length;
      if (paramArrayOfByte.length - i <= 2)
      {
  ...
  byte[] a()
  {
    ...
    {
      localByteArrayOutputStream.write(bhlw.a().a());
      ...
      localByteArrayOutputStream.write(new bhmd(localObject1.length).a());
      localByteArrayOutputStream.write((byte[])localObject1);
    }
    if ((this.jdField_a_of_type_ArrayOfByte != null) && (this.jdField_a_of_type_ArrayOfByte.length > 0))
    {
      localByteArrayOutputStream.write(bhlw.b().a());
      localByteArrayOutputStream.write(new bhmd(this.jdField_a_of_type_ArrayOfByte.length).a());
