  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localActionSheetItem.icon = 2130840157;
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if ("S".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + alpo.a(2131716757) + alpo.a(2131716765);
    }
    if ("A".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + alpo.a(2131716751) + alpo.a(2131716741);
    }
    if ("B".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + alpo.a(2131716753) + alpo.a(2131716761);
    }
    if ("C".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + alpo.a(2131716747) + alpo.a(2131716776);
    }
    return "[QQ高能舞室]" + alpo.a(2131716766);
  }
  ...
  {
    new wza(this.jdField_a_of_type_AndroidAppActivity, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramInt1, this.jdField_a_of_type_MqqUtilWeakReference, paramInt2).execute(new Void[0]);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt2 == 2)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, alpo.a(2131716743), 1).a();
    }
    do
    {
      do
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Axoa = new axoa(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Axoa.a(a(this.jdField_a_of_type_AndroidAppActivity));
    this.jdField_a_of_type_Axoa.a(this);
    this.jdField_a_of_type_Axoa.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131720040));
  ...
  protected void a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      bdcs.a(new File(paramString).getParent());
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Axoa.a().isShowing()) {
      this.jdField_a_of_type_Axoa.a().dismiss();
    }
    paramAdapterView = ((bdip)paramView.getTag()).a;
