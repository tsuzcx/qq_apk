...
public abstract class bmrj
{
  ...
  public bmrj(@NonNull String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      wsv.e("FacePackage", "config json is empty.");
      i = 0;
      if (i == 0)
      {
        wsv.e("FacePackage", "config json is illegal, use default value, type : %s", new Object[] { a() });
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            wsv.e("FacePackage", "config json is illegal : %s", new Object[] { paramString });
            i = 0;
            break;
          }
          this.f = paramString;
        ...
        {
          wsv.e("FacePackage", "parse config json error : " + paramString + ", exception : " + localException.toString());
          i = 0;
        }
      }
      break;
