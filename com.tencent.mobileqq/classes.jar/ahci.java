...
public class ahci
  extends QIPCModule
{
  public static ahci a;
  private Map<Integer, agzj> a;
  ...
  public static ahci a()
  {
    if (jdField_a_of_type_Ahci == null) {}
    try
    {
      if (jdField_a_of_type_Ahci == null) {
        jdField_a_of_type_Ahci = new ahci();
      }
      return jdField_a_of_type_Ahci;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (akjw)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (acso)paramQQAppInterface.getManager(321);
    ...
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.a().b(ajsf.ad, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.D();
      }
      return null;
    case 0: 
      paramQQAppInterface = bbcl.b(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new ahcn(this, paramInt));
      return null;
    case 8: 
    ...
    case 14: 
      ...
      axnj.a().a(paramQQAppInterface, new ahco(this, paramInt));
      return null;
    case 1: 
    ...
    case 16: 
      ...
      {
        paramBundle = (agzj)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    paramBundle = new ahcq(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((ajxn)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = bbcl.b(paramQQAppInterface, str, true);
      }
      for (;;)
      {
        ...
        localObject1 = bbcl.b(paramQQAppInterface, str, true);
        continue;
        paramBundle = bbcl.q(paramQQAppInterface, str);
        localObject1 = paramBundle;
        if (TextUtils.isEmpty(paramBundle)) {
          localObject1 = str;
        }
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (agzf)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new ahcs(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new ahcr(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new ahcj(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new ahck(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
      ...
      else
      {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (ajty)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new ahcm(this, (Bundle)localObject, i, paramString, paramBundle));
              }
