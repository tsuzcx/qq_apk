...
{
  public ahci(BusinessSearchEntryModel paramBusinessSearchEntryModel, View paramView1, BusinessSearchEntryDataModel.SearchEntry paramSearchEntry, View paramView2, String paramString, List paramList) {}
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!NetworkUtil.g(BusinessSearchEntryModel.a(this.jdField_a_of_type_ComTencentMobileqqSearchBusinessSearchEntryModel))) {
          QQToast.a(BusinessSearchEntryModel.a(this.jdField_a_of_type_ComTencentMobileqqSearchBusinessSearchEntryModel), 0, BusinessSearchEntryModel.a(this.jdField_a_of_type_ComTencentMobileqqSearchBusinessSearchEntryModel).getResources().getString(2131438848), 0).a();
        }
      }
    }
  }
