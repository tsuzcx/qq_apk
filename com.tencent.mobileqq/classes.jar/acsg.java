  ...
  implements View.OnClickListener
{
  ...
  public acsg(ReminderListFragment paramReminderListFragment, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375108));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375107));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.c = ((TextView)paramView.findViewById(2131375112));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375109));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369292));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369291));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375110));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131375111));
  ...
  public void a(acst paramacst)
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setTag(paramacst.jdField_a_of_type_WalletAcsMsg);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(paramacst.jdField_a_of_type_WalletAcsMsg.title);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setTag(paramacst.jdField_a_of_type_WalletAcsMsg.jump_url);
    Object localObject1 = paramacst.jdField_a_of_type_WalletAcsMsg.busi_icon;
    ...
    String str = acrp.a(paramacst.jdField_a_of_type_WalletAcsMsg.notice_time * 1000L, "yyyy.MM.dd");
    localObject2 = acrp.a(paramacst.jdField_a_of_type_WalletAcsMsg.notice_time * 1000L, "HH:mm");
    localObject1 = localObject2;
    if (paramacst.jdField_a_of_type_Int == 0) {
      localObject1 = (String)localObject2 + "　　　开启时提醒";
    }
    localObject1 = str + "　　　" + (String)localObject1;
    this.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
    localObject1 = this.c;
    if (!bbkk.a(paramacst.jdField_a_of_type_JavaLangString))
    {
      ((TextView)localObject1).setText(paramacst.jdField_a_of_type_JavaLangString);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (bbkk.a((String)paramView.getTag()));
