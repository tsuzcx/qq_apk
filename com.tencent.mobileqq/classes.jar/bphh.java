...
{
  public bphh(AEEditorVideoEditFragment paramAEEditorVideoEditFragment) {}
  ...
  public void onDeleteButtonClick(String paramString)
  {
    ...
    bpam.a(AEEditorVideoEditFragment.e(), "[onDeleteButtonClick]textEditorData = null");
  }
  ...
  public void onStickerOutsideClick()
  {
    this.a.j();
    this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData = null;
    bpam.a(AEEditorVideoEditFragment.e(), "[onStickerOutsideClick]textEditorData = null");
  }
  ...
  public void onTextEditButtonClick(TextEditorData paramTextEditorData)
  {
    ...
    this.a.jdField_a_of_type_Bpkb.a(this.a.getActivity(), paramTextEditorData, AEEditorVideoEditFragment.a(this.a));
  ...
  public void onUpdateTextStickerDone(String paramString)
  {
    if (this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData != null)
    {
      this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData.setUniqueID(paramString);
      this.a.a(this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData);
      bpam.d(AEEditorVideoEditFragment.e(), "[onUpdateTextStickerDone] uniqueId:" + paramString);
      return;
    }
    bpam.d(AEEditorVideoEditFragment.e(), "[onUpdateTextStickerDone] mCurrentTextEditorData null");
  }
}
