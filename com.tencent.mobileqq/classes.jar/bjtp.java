  ...
  extends SimpleObserver<bkld>
{
  ...
  public void a(bkld parambkld)
  {
    ...
    Activity localActivity = this.a.jdField_a_of_type_Bjyv.getActivity();
    Intent localIntent;
    boolean bool;
    if ((localActivity != null) && (!localActivity.isFinishing()))
    {
      ved.b("EditPicActivity.EditPicPartManager", "picDestPath = " + parambkld.a.b);
      localIntent = this.a.jdField_a_of_type_Bjyv.a(parambkld);
      if (!parambkld.a.c)
      {
        if (parambkld.a.c) {
          break label280;
      ...
      this.a.b();
      ved.b("EditPicActivity.EditPicPartManager", "subBussinessId = " + this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b());
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_Bjyv.a(-1, localIntent, 2130772028, 0);
      return;
      label280:
      bool = false;
      break;
      ...
      continue;
      if (parambkld.a()) {
        bfna.a(parambkld.a.b, true);
      }
    }
    label320:
    if (this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a == 1)
    {
      this.a.jdField_a_of_type_Bjyv.a().sendBroadcast(new Intent("action_fire_create_story"));
      this.a.jdField_a_of_type_Bjyv.a(-1, localIntent, 2130772028, 0, true);
      return;
    }
    ...
    {
      parambkld = localIntent.getStringExtra("PhotoConst.SINGLE_PHOTO_PATH");
      bjto.a(this.a, localIntent);
      AIOLongShotHelper.a(localActivity, parambkld, new bjtq(this));
      return;
    }
    ...
    {
      this.a.jdField_a_of_type_Bjyv.a(-1, localIntent, 2130772028, 0, false);
      axqy.b(null, "dc00898", "", "", "0X800A188", "0X800A188", 0, 0, "", "", "", "");
      return;
    }
    if (this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a == 2)
    {
      ...
      {
        bjto.a(this.a, localIntent);
        axqy.b(null, "dc00898", "", "", "0X800A183", "0X800A183", 0, 0, "", "", "", "");
        return;
      }
    }
  ...
  public void onCancel()
  {
    ...
    this.a.jdField_a_of_type_Bjyv.b();
    bcql.a(this.a.jdField_a_of_type_Bjyv.a(), ajya.a(2131703687), 0).a();
  }
