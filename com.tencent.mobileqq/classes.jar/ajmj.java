  ...
  implements ajmc
{
  ...
  {
    ajmd localajmd = this.jdField_a_of_type_Ajlp.a();
    if (localajmd != null) {
  ...
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Ajlp.a();
    if (localObject != null)
    {
      localObject = ((ajmd)localObject).a();
      if (localObject != null) {
  ...
  public void a(ajlp paramajlp)
  {
    ...
    paramajlp = this.jdField_a_of_type_Ajlp.a();
    if (paramajlp != null) {
      paramajlp.a(this);
    }
  ...
  {
    ajmb localajmb = this.jdField_a_of_type_Ajlp.a();
    if (localajmb != null)
    {
      localajmb.a(paramList);
      localajmb.b(paramList);
    }
  }
