...
public final class ajmj
  implements Runnable
{
  public ajmj(int paramInt, String paramString1, BaseActivity paramBaseActivity, String paramString2, String paramString3, QQProgressDialog paramQQProgressDialog) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        String str2;
        String str3;
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new ajml(this, localException1));
        return;
      }
      try
      {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new ajmk(this, (String)localObject));
      return;
