...
public class afbi
{
  private static afbi jdField_a_of_type_Afbi;
  ...
  private Map<Integer, afbj> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    afbj localafbj = (afbj)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localafbj != null)
    {
      Object localObject = localafbj.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localafbj.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localafbj.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localafbj.jdField_a_of_type_Long + "uniID:" + localafbj.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localafbj.jdField_a_of_type_Long + "uniID:" + localafbj.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static afbi a()
  {
    try
    {
      if (jdField_a_of_type_Afbi == null) {
        jdField_a_of_type_Afbi = new afbi();
      }
      return jdField_a_of_type_Afbi;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        afbj localafbj = (afbj)((Map.Entry)localIterator.next()).getValue();
        if ((localafbj == null) || (localafbj.jdField_a_of_type_Int < paramInt1) || (localafbj.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (afbj)localIterator.next();
        if ((localObject != null) && (((afbj)localObject).jdField_a_of_type_Int >= this.d) && (((afbj)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((afbj)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          afbj localafbj = (afbj)((Iterator)localObject).next();
          if (localafbj.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localafbj.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (afbj)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((afbj)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((afbj)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((afbj)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Afbi != null)
      {
        jdField_a_of_type_Afbi.a();
        jdField_a_of_type_Afbi = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new afbj(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          afbj localafbj = (afbj)((Iterator)localObject).next();
          if ((localafbj.jdField_a_of_type_JavaLangRefWeakReference != null) && (localafbj.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localafbj.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
