  ...
  extends attg
{
  ...
  atsv(atsi paramatsi, MessageRecord paramMessageRecord)
  {
    super(paramatsi);
  ...
  void a(String paramString, int paramInt, atte paramatte)
  {
    ...
    atsi.a(this.jdField_a_of_type_Atsi).a().a().a(paramString, paramInt, this.d, 106, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.c, new atsw(this, paramString, paramatte));
  }
}
