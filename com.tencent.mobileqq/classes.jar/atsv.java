...
public class atsv
{
  ...
  public atsc a;
  protected atss a;
  private atsy jdField_a_of_type_Atsy = new atsw(this);
  ...
  public atsv(LyricView paramLyricView)
  {
    ...
    this.jdField_a_of_type_Atss = new atss();
    ...
    this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewScroll.setScrollListener(this.jdField_a_of_type_Atsy);
  }
  
  private void d()
  {
    this.jdField_a_of_type_Atsc = this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal.a();
    atsc localatsc = this.jdField_a_of_type_Atsc;
    if ((localatsc == null) || (localatsc.a()) || (this.jdField_a_of_type_Boolean))
    {
  ...
  public void a()
  {
    ...
    atsh.a().post(new LyricViewController.4(this));
  ...
  public void a(int paramInt)
  {
    ...
    atsh.a().post(new LyricViewController.5(this, paramInt));
  }
  ...
  public void a(atsc paramatsc1, atsc paramatsc2, atsc paramatsc3)
  {
    Log.v("ModuleController", "setLyric begin");
    atsh.a().post(new LyricViewController.3(this, paramatsc3, paramatsc1, paramatsc2));
  }
  ...
  protected void b(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Atsc != null) || (this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal != null))
    {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Atsc.a.size()))
    {
      if (this.jdField_a_of_type_Atsc.a.get(paramInt) == null)
      {
        Log.w("ModuleController", "onScrollStop -> current sentence is null");
        return;
      }
      long l2 = ((atse)this.jdField_a_of_type_Atsc.a.get(paramInt)).jdField_a_of_type_Long;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Atss.a(l1);
  ...
  protected void c(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Atsc.a.size()))
    {
      ...
      for (;;)
      {
        ...
        l1 = l2 / 10L;
        this.jdField_a_of_type_Atss.b((l1 + 1L) * 10L);
        return;
        label178:
        l1 = l2;
        if (this.jdField_b_of_type_Int >= 0)
