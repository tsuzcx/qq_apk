    ...
    for (paramInt = 300000;; paramInt = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((k > 0) && (k < 10))
        {
          ...
          BidDownloader localBidDownloader = new BidDownloader(str1, paramQQAppInterface, new mzm(paramContext, str2, m, str1), true, k);
          localBidDownloader.d = ((JSONObject)localObject).optInt("id");
          JSONObject localJSONObject = mze.a(str1);
          if ((localJSONObject == null) || (localJSONObject.optInt("version", 0) < localBidDownloader.d))
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              localObject = new mzo(paramQQAppInterface, str1, localBidDownloader);
