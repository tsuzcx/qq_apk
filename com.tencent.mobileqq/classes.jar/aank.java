...
public class aank
{
  ...
  public aank(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean, int paramInt4)
  {
  ...
  @TargetApi(17)
  @RequiresApi(api=17)
  public void a(List<Bitmap> paramList, aane paramaane)
  {
    aanf localaanf = new aanf(0, "success");
    this.jdField_a_of_type_Bbna = new bbna();
    bbmm localbbmm = new bbmm(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int, this.c, 1, false, 0);
    ...
    this.jdField_a_of_type_Bbna.a(localbbmm, new aanl(this, paramList, paramaane, localaanf));
    try
    {
      try
      {
