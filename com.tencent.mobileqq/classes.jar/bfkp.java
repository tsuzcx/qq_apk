...
public class bfkp
  extends anii
{
  private bfkr jdField_a_of_type_Bfkr;
  private ConcurrentHashMap<Long, bflk> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public AtomicLong a;
  
  public bfkp(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong = new AtomicLong(0L);
    this.jdField_a_of_type_Bfkr = ((bfkr)paramQQAppInterface.getManager(355));
  }
    ...
    if (j == 0)
    {
      ...
      if (localRspBody.app.has())
      {
        ...
        while (paramFromServiceMsg.hasNext()) {
          paramToServiceMsg.add(bfkm.a((cmd0xe82.App)paramFromServiceMsg.next()));
        }
      }
      paramToServiceMsg = new bfkq(l1, k, m, n, i1, l2, paramToServiceMsg);
      paramFromServiceMsg = (bfkr)this.app.getManager(355);
      if (i == 1) {}
      for (bool = true;; bool = false)
      {
        ...
        {
          paramFromServiceMsg.append(((bfkm)paramToServiceMsg.a().get(i)).c()).append("|");
          i += 1;
        }
      }
      if (QLog.isColorLevel()) {
  ...
  {
    bfkq localbfkq = this.jdField_a_of_type_Bfkr.a(Long.valueOf(paramLong));
    if (localbfkq == null) {
      if (QLog.isColorLevel()) {
    ...
    {
      return true;
      if ((localbfkq.a().size() <= 0) || (System.currentTimeMillis() <= localbfkq.b())) {
        break;
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ((bfkr)this.app.getManager(355)).a(l, i, bool);
      if (QLog.isColorLevel()) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l))) && (((bflk)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l))).a(paramFromServiceMsg, paramObject))) {
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    ((cmd0xe82.ClientInfo)localObject).version.set("8.4.1");
  ...
  public void a(long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    if (((bfkr)this.app.getManager(355)).a(Long.valueOf(paramLong)) == null) {
      return;
    }
