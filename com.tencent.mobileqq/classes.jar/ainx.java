  ...
  implements aioa
{
  ...
  private void a(aijf paramaijf, int paramInt, long paramLong)
  {
    ApolloCmdChannel localApolloCmdChannel = aing.a();
    if (localApolloCmdChannel != null) {
      localApolloCmdChannel.playMusicInner(paramaijf, paramInt, paramLong);
    }
  }
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!aing.d()) || (paramaijf == null)))
    {
    ...
    for (Object localObject = null;; localObject = null)
    {
      try
      {
        if ((paramaijf instanceof ApolloSurfaceView)) {
          localObject = ((ApolloSurfaceView)paramaijf).getRender();
        }
        for (;;)
        {
          if (localObject == null) {
          ...
          if ((paramaijf instanceof ApolloTextureView)) {
            localObject = ((ApolloTextureView)paramaijf).getRender();
          }
        }
      ...
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramaijf, new Object[0]);
        return -1;
      }
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new ainz(this, paramFloat, paramInt2, paramString, paramaijf, paramLong));
        ...
        if (paramString != null) {
          if (-1.0F == paramFloat)
          {
            ...
            if (paramInt1 != 0) {
              a(paramaijf, paramInt1, paramLong);
            }
          }
        }
        for (;;)
      ...
      paramaijf = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!aing.d())))
    {
      QLog.w("cmgame_process.CmGameSoudPoolPlayer", 1, "[playMusic], DO NOT play. switch:" + this.jdField_a_of_type_Int);
    ...
    if (paramJSONObject != null) {
      ...
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramaioq, new Object[0]);
      }
    } else {
      return null;
    }
    ...
    {
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new ainy(this, f, i, str2, paramaioq, localJSONObject));
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        if ((i == 0) || (paramaioq == null)) {
          break;
        }
        try
        {
          localJSONObject.put("id", i);
          paramaioq.a(localJSONObject);
        }
        catch (Throwable paramaioq)
        {
          QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramaioq, new Object[0]);
      ...
      break;
      paramaioq = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, bool);
