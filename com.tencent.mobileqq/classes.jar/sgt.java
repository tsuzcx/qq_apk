...
{
  public sgt(Conversation paramConversation) {}
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    {
      this.a.a(new sgv(this, paramString));
      return;
    }
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.a(new sgx(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.a(new sgw(this, paramString));
    }
  }
}
