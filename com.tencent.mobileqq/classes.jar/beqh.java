  ...
  extends Animation
{
  ...
  private beqi jdField_a_of_type_Beqi;
  private final boolean jdField_a_of_type_Boolean;
  private final float b;
  private final float c;
  
  public beqh(float paramFloat1, float paramFloat2, boolean paramBoolean, int paramInt)
  {
  ...
  public void a(beqi parambeqi)
  {
    this.jdField_a_of_type_Beqi = parambeqi;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    int i = 1;
    if (this.jdField_a_of_type_Beqi != null) {
      this.jdField_a_of_type_Beqi.a(paramFloat);
    }
    float f1;
    float f2;
