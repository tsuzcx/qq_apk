...
public class blvc
{
  ...
  private blvc(FileChannel paramFileChannel)
  {
    ...
    blva.a(this.jdField_a_of_type_ArrayOfByte[4], 1, 2, "bad elf class: " + this.jdField_a_of_type_ArrayOfByte[4]);
    blva.a(this.jdField_a_of_type_ArrayOfByte[5], 1, 2, "bad elf data encoding: " + this.jdField_a_of_type_ArrayOfByte[5]);
    int i;
    label222:
    ...
    for (ByteOrder localByteOrder = ByteOrder.LITTLE_ENDIAN;; localByteOrder = ByteOrder.BIG_ENDIAN)
    {
      ...
      blva.a(paramFileChannel, localByteBuffer, "failed to read rest part of ehdr.");
      ...
      blva.a(this.jdField_a_of_type_Int, 1, 1, "bad elf version: " + this.jdField_a_of_type_Int);
