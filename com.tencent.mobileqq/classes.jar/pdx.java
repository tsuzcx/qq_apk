...
public class pdx
  implements bltz
{
  public pdx(ReadInJoyDynamicChannelFragment paramReadInJoyDynamicChannelFragment) {}
  ...
  public void a(XRecyclerView paramXRecyclerView, int paramInt)
  {
    ...
    {
      pfa.a().a(ReadInJoyDynamicChannelFragment.j(this.a), ReadInJoyDynamicChannelFragment.k(this.a), 2, 0, paramInt);
      return;
    }
  }
