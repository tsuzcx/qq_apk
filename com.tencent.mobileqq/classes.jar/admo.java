...
public class admo
  implements Runnable
{
  public admo(QQApiPlugin paramQQApiPlugin, String paramString1, String paramString2, String paramString3, ApplicationInfo paramApplicationInfo, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new admp(this));
    if (QLog.isColorLevel()) {
