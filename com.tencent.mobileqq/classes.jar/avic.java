  ...
  implements View.OnClickListener
{
  ...
  public avic(int paramInt, boolean paramBoolean)
  {
    super(paramInt);
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Xel = new avid(this);
    this.jdField_c_of_type_Boolean = paramBoolean;
  }
  
  public static void a(Context paramContext, URLImageView paramURLImageView, String paramString1, String paramString2, avii paramavii)
  {
    ...
    for (;;)
    {
      ...
      if (ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime())) {
        localColorDrawable.setColor(paramContext.getResources().getColor(2131101514));
      }
      ...
      {
        paramURLImageView = new avig(paramURLImageView, paramContext, paramavii);
        ...
        return;
        localColorDrawable.setColor(paramContext.getResources().getColor(2131101513));
      }
    }
    label159:
  ...
  private void a(HotWordSearchEntryDataModel.GIFInfo paramGIFInfo)
  {
    ...
    avif localavif = new avif(this, paramGIFInfo);
    this.jdField_a_of_type_AndroidViewView.post(new HotWordSearchEntryModel.4(this, paramGIFInfo, localavif));
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    {
      localObject = bade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
      if (localObject != null)
      {
        ((bacn)localObject).c();
  ...
  public View a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (paramViewGroup = ((BaseActivity)paramContext).getAppRuntime();; paramViewGroup = null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131495012, null);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131311542));
      this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311580));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311622));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304777));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307332));
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentBizWidgetsHotWordTipsContainer = ((HotWordTipsContainer)this.jdField_a_of_type_AndroidViewView.findViewById(2131311502));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131299709);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131299710);
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302013));
      if (!this.jdField_a_of_type_Boolean) {
        this.jdField_b_of_type_AndroidViewView.setVisibility(8);
      }
      for (;;)
      {
        this.jdField_a_of_type_ComTencentBizWidgetsHotWordTipsContainer.setOnTipsClickListener(this.jdField_a_of_type_Xel);
  ...
  public void a(avoi paramavoi)
  {
    Object localObject = new ColorDrawable();
    URLDrawable.URLDrawableOptions localURLDrawableOptions;
    if (ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime()))
    {
      ((ColorDrawable)localObject).setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101514));
      localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mLoadingDrawable = ((Drawable)localObject);
      localURLDrawableOptions.mFailedDrawable = ((Drawable)localObject);
      localObject = "http://res.imtt.qq.com/res_mtt/KDhotword/xiaohuomiao.png";
      if (!TextUtils.isEmpty(paramavoi.b)) {
        localObject = paramavoi.b;
      }
      if (!ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime())) {
        break label208;
      }
      ...
      if (TextUtils.isEmpty(paramavoi.jdField_a_of_type_JavaLangString)) {
        break label217;
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setText(paramavoi.jdField_a_of_type_JavaLangString);
      label116:
      if (TextUtils.isEmpty(paramavoi.c)) {
        break label233;
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setText(paramavoi.c);
      label137:
      if ((paramavoi.jdField_a_of_type_Int != 1) || (TextUtils.isEmpty(paramavoi.e))) {
        break label245;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new avie(this, paramavoi));
      return;
      ((ColorDrawable)localObject).setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101513));
      break;
      label208:
      localObject = URLDrawable.getDrawable((String)localObject, localURLDrawableOptions);
      break label87;
      label217:
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131639838));
      break label116;
      label233:
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      break label137;
  ...
  {
    Object localObject = (HotWordSearchEntryDataModel)paramavpu;
    ...
    if (((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_Avoi == null) {
    ...
    for (;;)
    {
      ...
      paramavpu = (Boolean)SearchEntryFragment.a.get(Integer.valueOf(1));
      ...
      while (i < j - 1)
      {
        paramavpu.append(((HotWordSearchEntryDataModel.HotSearchItem)((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_JavaUtilList.get(i)).title).append("::");
        i += 1;
      }
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      a(((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_Avoi);
    }
    paramavpu.append(((HotWordSearchEntryDataModel.HotSearchItem)((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_JavaUtilList.get(j - 1)).title);
    label300:
    avwf.a("hot_list", "exp_hot_list", new String[] { paramavpu.toString(), String.valueOf(this.jdField_a_of_type_Int) });
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("experiment_id", avsv.b);
      ...
      {
        i = 21;
        avsv.a(null, localReportModelDC02528.ver2(avsv.a(i)).ver4(paramavpu.toString()).ver7(((JSONObject)localObject).toString()).session_id(localQQAppInterface.getCurrentAccountUin() + this.jdField_a_of_type_Long));
        avsv.a(localQQAppInterface, 0, SearchEntryFragment.a(this.jdField_a_of_type_Int), "0X8009D27", 0, 0, null, null);
        return;
      }
    }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel != null) && (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_Avoi != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_Avoi.e))) {
      a(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_Avoi.e, "");
    }
    for (;;)
    {
      ...
      try
      {
        ...
        avwf.a("hot_list", "clk_qq_index", new String[] { "", String.valueOf(this.jdField_a_of_type_Int) });
        ReportModelDC02528 localReportModelDC02528 = new ReportModelDC02528().module("hot_list").action("clk_qq_index");
        if (this.jdField_a_of_type_Int == 3)
        {
          i = 21;
          avsv.a(null, localReportModelDC02528.ver2(avsv.a(i)).ver7(paramView.toString()).session_id(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + this.jdField_a_of_type_Long));
          avsv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, SearchEntryFragment.a(this.jdField_a_of_type_Int), "0X8009D28", 0, 0, null, null);
          return;
