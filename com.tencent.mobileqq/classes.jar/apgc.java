...
public class apgc
  implements Manager
{
  apfw jdField_a_of_type_Apfw = null;
  apgg jdField_a_of_type_Apgg = null;
  private apgk jdField_a_of_type_Apgk;
  PromotionConfigInfo jdField_a_of_type_ComTencentMobileqqArARPromotionMgrPromotionConfigInfo = null;
  final String jdField_a_of_type_JavaLangString;
  String b;
  
  public apgc(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Apgg = new apgg(l);
  }
  ...
  public PromotionConfigInfo a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqArARPromotionMgrPromotionConfigInfo == null) && (AudioHelper.e())) {
      QLog.w(apgj.jdField_a_of_type_JavaLangString, 1, "getConfigInfo, AR配置还未初始化", new Throwable("打印调用栈"));
    }
  ...
  {
    if (this.jdField_a_of_type_Apgg != null) {
      this.jdField_a_of_type_Apgg.a(paramapgi);
    }
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString)
  {
    if (this.jdField_a_of_type_Apgg != null) {
      if (a())
      {
        ...
        this.jdField_a_of_type_Apgg.a(localPromotionConfigInfo);
        this.jdField_a_of_type_Apgg.a(paramAppInterface, false, paramString, 0);
      }
    }
    do
    {
    ...
    throw new IllegalArgumentException(anzj.a(2131707393));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, PromotionConfigInfo paramPromotionConfigInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramPromotionConfigInfo != null)
      {
        ...
        if (this.jdField_a_of_type_Apgk != null)
        {
          this.jdField_a_of_type_Apgk.clean();
          this.jdField_a_of_type_Apgk = null;
        }
      }
  ...
  boolean a(String paramString, AppInterface paramAppInterface, apge paramapge)
  {
    if ((a()) && (apgb.a != -1)) {
      return false;
    }
    Object localObject2 = this.jdField_a_of_type_Apgk;
    ...
    if (localObject2 == null)
    {
      ...
      localObject1 = new apgk(this.jdField_a_of_type_JavaLangString, this.b, paramAppInterface);
      this.jdField_a_of_type_Apgk = ((apgk)localObject1);
    }
    if (((apgk)localObject1).isNeedRunTask())
    {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "异步加载config[" + paramString + "]");
      localObject2 = new ArrayList();
      ((ArrayList)localObject2).add(localObject1);
      bhss.requestSyncTask(null, (ArrayList)localObject2, new apgd(this, paramAppInterface, paramString, paramapge));
    }
    for (;;)
    {
      return true;
  ...
  {
    if (this.jdField_a_of_type_Apgg != null) {
      this.jdField_a_of_type_Apgg.b(paramapgi);
    }
  }
  ...
  void b(AppInterface paramAppInterface)
  {
    ...
    if (AudioHelper.f()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "requestPreDownload, PromotionConfigInfo[" + localPromotionConfigInfo1 + "], isDevicesSupport[" + apgb.a() + "]");
    }
    if (!apgb.a()) {}
    ...
    } while ((localPromotionConfigInfo2 == null) || (this.jdField_a_of_type_Apgg == null));
    this.jdField_a_of_type_Apgg.a(localPromotionConfigInfo2);
    this.jdField_a_of_type_Apgg.a(paramAppInterface, true, localPromotionConfigInfo1.activityid, 0);
  }
  
  void c(AppInterface paramAppInterface)
  {
    bdcn.b();
    if (this.jdField_a_of_type_Apfw == null) {
      this.jdField_a_of_type_Apfw = new apfw();
    }
    this.jdField_a_of_type_Apfw.a(paramAppInterface);
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Apgg != null)
    {
      this.jdField_a_of_type_Apgg.a();
      this.jdField_a_of_type_Apgg = null;
    }
    if (this.jdField_a_of_type_Apfw != null)
    {
      this.jdField_a_of_type_Apfw.a();
      this.jdField_a_of_type_Apfw = null;
    }
    a(null);
  }
}
