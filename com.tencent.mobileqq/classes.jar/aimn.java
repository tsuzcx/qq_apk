...
public class aimn
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	amyn:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	amyn
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	amyn:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	amyn
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	amyn:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	amyn
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	amyn:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localaifc.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bady.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((aifg)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    Object localObject = (aiyu)paramQQAppInterface.getManager(155);
    ApolloGameData localApolloGameData = ((aiyu)localObject).a(paramInt);
    String str = ajjy.a(2131636319);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localajdd.jdField_b_of_type_Int = i;
        localajdd.jdField_a_of_type_Int = paramInt;
        localajdd.jdField_a_of_type_Long = paramLong;
        localajdd.e = 1;
        localajdd.d = 3;
        a(paramQQAppInterface, paramString, localajdd);
        return;
        localajdd.jdField_b_of_type_JavaLangString = ajjy.a(2131636321);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ajdd paramajdd)
  {
    if ((paramajdd == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramajdd.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramajdd.jdField_a_of_type_Long), ",extendInfo:", paramajdd.jdField_c_of_type_JavaLangString });
    }
    ApolloMessage localApolloMessage = new ApolloMessage();
    if (!TextUtils.isEmpty(paramajdd.jdField_a_of_type_JavaLangString)) {
      localApolloMessage.name = paramajdd.jdField_a_of_type_JavaLangString.getBytes();
    }
    if (0 == 0) {}
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject).put("gameId", paramajdd.jdField_a_of_type_Int);
        ((JSONObject)localObject).put("gameMode", paramajdd.jdField_c_of_type_Int);
        ((JSONObject)localObject).put("roomid", paramajdd.jdField_a_of_type_Long);
        if (paramajdd.jdField_a_of_type_Int == 1)
        {
          ((JSONObject)localObject).put("msgTyep", 2);
          ((JSONObject)localObject).put("gameName", paramajdd.jdField_b_of_type_JavaLangString);
          if (!TextUtils.isEmpty(paramajdd.jdField_c_of_type_JavaLangString)) {
            ((JSONObject)localObject).put("gameExtendJson", paramajdd.jdField_c_of_type_JavaLangString);
          }
          ((JSONObject)localObject).put("gameStatus", paramajdd.e);
          if (localObject != null) {
            localApolloMessage.extStr = ((JSONObject)localObject).toString();
          }
          localObject = ((aifg)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
          localApolloMessage.sender_ts = azzz.a(((ApolloBaseInfo)localObject).apolloServerTS);
          localApolloMessage.sender_status = ((ApolloBaseInfo)localObject).apolloStatus;
          localObject = ((aiyu)paramQQAppInterface.getManager(155)).a(paramajdd.jdField_a_of_type_Int);
          if ((localObject == null) || (1 != ((ApolloGameData)localObject).hasOwnArk)) {
            break label511;
          }
          i = 297;
          localApolloMessage.flag = (i | 0x200);
          paramString = awbi.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramajdd.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramajdd.jdField_a_of_type_Int;
            paramString.mGameMode = paramajdd.jdField_c_of_type_Int;
            paramString.roomId = paramajdd.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramajdd.jdField_b_of_type_Int;
            paramString.gameName = paramajdd.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramajdd.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramajdd.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramajdd.e + "}");
        ...
        {
          ((JSONObject)localObject).put("msgTyep", paramajdd.d);
          continue;
        }
        paramString.msgType = paramajdd.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((aifg)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((aiyu)localObject2).a(paramInt);
    Object localObject1 = ajjy.a(2131636320);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((aiyu)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localajdd.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localajdd.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localajdd.jdField_b_of_type_Int = i;
      localajdd.jdField_a_of_type_Int = paramInt;
      localajdd.jdField_a_of_type_Long = paramLong;
      localajdd.e = 0;
      ...
      if (!TextUtils.isEmpty(localajdd.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localajdd.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localajdd.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localajdd.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localajdd.jdField_a_of_type_Long);
          if (localajdd.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localajdd.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localajdd.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localajdd.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localajdd.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((aifg)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = azzz.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = awbi.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localajdd.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localajdd.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localajdd.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localajdd.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localajdd.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localajdd.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localajdd.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localajdd.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localajdd.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localajdd.jdField_b_of_type_JavaLangString = ajjy.a(2131636322);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localajdd.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localajdd.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof aecb)) {}
      }
    }
    for (Object localObject = (aecb)localObject;; localObject = null) {
      return (localObject != null) && (((aecb)localObject).D());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      aael.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
