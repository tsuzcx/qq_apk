  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localObject = new vrn();
          ((vrn)localObject).jdField_b_of_type_JavaLangString = paramIntent.optString("title");
          ((vrn)localObject).jdField_b_of_type_Int = 2;
          ((vrn)localObject).a = String.valueOf(i);
          ((vrn)localObject).g = paramContext;
          vra.a(this.a).a((vrn)localObject);
        }
        ...
        vra.a(this.a, paramIntent.optBoolean("is_from_story", false));
        vra.a(this.a, paramContext.mSongMid);
      }
    ...
    vra.a(this.a).sendEmptyMessage(1);
  }
}
