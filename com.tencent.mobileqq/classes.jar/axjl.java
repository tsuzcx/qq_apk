  ...
  implements azbr
{
  ...
  private axjo jdField_a_of_type_Axjo = new axjm(this);
  axjt jdField_a_of_type_Axjt;
  private axkp jdField_a_of_type_Axkp;
  private axnu jdField_a_of_type_Axnu;
  private ayyn jdField_a_of_type_Ayyn = new axjn(this);
  ...
  public axjl(AppInterface paramAppInterface, Context paramContext, GridView paramGridView, axnu paramaxnu, axkp paramaxkp, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Axkp = paramaxkp;
    this.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  private void b(int paramInt)
  {
    PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo1 = axjt.a().a();
  ...
  public void a(int paramInt)
  {
    ...
    axjt.a().a(localPtvTemplateInfo);
    if (!localPtvTemplateInfo.id.equals("0"))
    {
      axjt localaxjt = axjt.a();
      localaxjt.a(localPtvTemplateInfo, 111);
      localaxjt.a(3, localPtvTemplateInfo.categoryId, localPtvTemplateInfo.id);
    }
    this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = localPtvTemplateInfo;
    axjt.a().a(114, this.jdField_a_of_type_Axkp);
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) || (this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id.equals("0")))
    {
      ...
      if (this.jdField_a_of_type_Axnu != null) {
        this.jdField_a_of_type_Axnu.a(localPtvTemplateInfo, this.jdField_a_of_type_JavaLangString);
      }
      axjt.a().a(null);
      axjt.a().a(113, null);
      return;
    ...
    {
      this.jdField_a_of_type_JavaLangString = axjt.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.md5);
      if (this.jdField_a_of_type_Axnu != null) {
        this.jdField_a_of_type_Axnu.a(localPtvTemplateInfo, this.jdField_a_of_type_JavaLangString);
      }
      axjt.a().a(113, null);
    ...
    for (;;)
    {
      bdiv.a();
      return;
      if ((!this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.downloading) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) && (this.jdField_a_of_type_Axjt != null))
      {
        this.jdField_a_of_type_Axjt.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, this.jdField_a_of_type_Ayyn);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Axjo);
