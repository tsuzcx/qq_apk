...
{
  public static int a;
  private static volatile arpa jdField_a_of_type_Arpa;
  ...
  private arop jdField_a_of_type_Arop;
  protected aroq a;
  private aros jdField_a_of_type_Aros;
  private arot jdField_a_of_type_Arot;
  public arow a;
  private arox jdField_a_of_type_Arox = new arox(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  private arpo jdField_a_of_type_Arpo;
  private arrt jdField_a_of_type_Arrt = arrt.a();
  ...
  private arow b;
  public ConcurrentHashMap<String, arpw> b;
  public ConcurrentHashMap<String, arpw> c;
  private int d;
  public ConcurrentHashMap<Long, arrz> d;
  private int jdField_e_of_type_Int;
  private String jdField_e_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
  public ConcurrentHashMap<Long, arrz> e;
  private int f;
  public ConcurrentHashMap<Long, arpx> f;
  public ConcurrentHashMap<Long, arpx> g;
  ...
  private arpa()
  {
    ...
    this.jdField_a_of_type_Aroq = new arpb(this);
    this.jdField_b_of_type_Arow = new arpd(this);
  ...
  {
    if (jdField_a_of_type_Arpa == null) {}
    try
    {
      if (jdField_a_of_type_Arpa == null) {
        jdField_a_of_type_Arpa = new arpa();
      }
      return jdField_a_of_type_Arpa;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 6) {
      if (this.jdField_a_of_type_Aros != null) {
        this.jdField_a_of_type_Aros.a();
      }
    }
    while (paramInt != 20) {
      return;
  ...
  private void a(arpk paramarpk)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "processPush0x11aSucc: client ip = " + paramarpk.a().a() + ", udpport = " + localList.get(1) + ", tcpport = " + localList.get(0));
      }
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "pc端已经确认了，客户端收到了0x11a的push了--------> bizType= " + i);
      }
      paramarpk = new Intent();
      if (BaseActivity.sTopActivity != null) {
        break;
      }
      arsc.a("MsgBackup.BackupAndMigrateManager", "activity is null! please check whether is assigned!", new Object[0]);
      return;
      if (i == 2)
      {
        localarrt.c(1);
    ...
    PublicFragmentActivity.a(BaseActivity.sTopActivity, paramarpk, MsgBackupPCConfirmFragment.class, 1000);
  }
  ...
  public arop a()
  {
    if (this.jdField_a_of_type_Arop == null) {
      this.jdField_a_of_type_Arop = arop.a();
    }
    return this.jdField_a_of_type_Arop;
  }
  
  public arpo a()
  {
    return this.jdField_a_of_type_Arpo;
  }
  
  public arrt a()
  {
    if (this.jdField_a_of_type_Arrt == null) {
      this.jdField_a_of_type_Arrt = arrt.a();
    }
    return this.jdField_a_of_type_Arrt;
  }
  ...
  public void a(int paramInt, arpg paramarpg, Object paramObject)
  {
    if (paramarpg.jdField_a_of_type_Int == 0) {}
    while (paramarpg.jdField_a_of_type_Int != 2) {
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Arrt.a(this.jdField_e_of_type_JavaLangString, paramInt, paramString);
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, BaseActivity paramBaseActivity)
  {
    ...
    for (;;)
    {
      localMessage.obj = String.format(str1, new Object[] { str2, arsc.a(paramLong) + "B/s" });
      localMessage.arg1 = paramInt2;
      arop.a().a(paramInt2);
      localMqqHandler.sendMessage(localMessage);
      arrt.a().a(null);
      arrt.a().a(this.jdField_b_of_type_Arow);
      a(paramBaseActivity);
  ...
  {
    this.jdField_a_of_type_Aros = paramaros;
  }
  
  public void a(arot paramarot)
  {
    this.jdField_a_of_type_Arot = paramarot;
  }
  ...
  public void a(arpg paramarpg)
  {
    ...
    paramarpg.jdField_a_of_type_Arou = this;
    this.jdField_a_of_type_Arox.a(paramarpg, 10000);
  }
  
  public void a(arpg paramarpg, Object paramObject)
  {
    if (paramarpg.jdField_a_of_type_Int == 0) {
      if ((paramObject != null) && ((paramObject instanceof arpw)))
      {
        paramarpg = (arpw)paramObject;
        paramObject = new File(arsc.a(paramarpg.jdField_a_of_type_JavaLangString, arsc.b(paramarpg.jdField_a_of_type_Int), paramarpg.jdField_b_of_type_JavaLangString));
    ...
    label72:
    while ((paramarpg.jdField_a_of_type_Int != 2) || (this.jdField_a_of_type_Arow == null))
    {
      return;
      paramarpg.jdField_a_of_type_Long = paramObject.length();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(arsc.a(paramarpg.jdField_a_of_type_JavaLangString, arsc.b(paramarpg.jdField_a_of_type_Int)), paramarpg);
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "onProgress, db prepared! result = 0, sessionInfo.uin = " + paramarpg.jdField_a_of_type_JavaLangString);
      }
      a().e(257);
      return;
    }
    this.jdField_a_of_type_Arow.b(paramarpg.jdField_c_of_type_Int + 1, paramarpg.jdField_b_of_type_Int);
  }
  ...
  public void a(arpr paramarpr)
  {
    ...
    int i = paramarpr.a();
    a().a(i);
    paramarpr = paramarpr.a();
    a().a(paramarpr);
    localIntent.putExtra("0x11bpush_extra", paramarpr);
  ...
  {
    if ((paramObject instanceof arpk))
    {
  ...
  {
    ((aroo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).c(paramString);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      a().a(i);
      this.jdField_a_of_type_Arrt.a(this.jdField_e_of_type_JavaLangString, i, paramBoolean);
      return;
      this.jdField_a_of_type_Arpo = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aroq);
    }
  }
  ...
  public void b(arpg paramarpg)
  {
    ...
    paramarpg.jdField_a_of_type_Arou = this;
    this.jdField_a_of_type_Arox.a(paramarpg, 10001);
  }
  ...
  public void c(arpg paramarpg)
  {
    ...
    paramarpg.jdField_a_of_type_Arou = this;
    this.jdField_a_of_type_Arox.a(paramarpg, -1);
  }
  
  public void d()
  {
    arsc.a("MsgBackup.BackupAndMigrateManager", "onDestory ......", new Object[0]);
    this.jdField_a_of_type_Arrt.b();
    b();
  ...
  public void g()
  {
    ((aroo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).a();
  }
  
  public void h()
  {
    arsc.b("MsgBackup.BackupAndMigrateManager", "sFileMeta = %s", new Object[] { jdField_a_of_type_JavaLangString });
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {}
    ((aroo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).b(jdField_a_of_type_JavaLangString);
  }
  
  public void i()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aroq);
  }
  
  public void j()
  {
    this.jdField_a_of_type_Arrt.a(this.jdField_e_of_type_JavaLangString);
  }
  ...
  public void k()
  {
    ...
    if (this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener == null) {
      this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener = new arpc(this);
    }
