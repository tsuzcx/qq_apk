  ...
  extends MqqHandler
{
  ...
  public anyi(Looper paramLooper, VideoBroadcastReceiver paramVideoBroadcastReceiver)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          case 0: 
            ...
            if (i == 1006)
            {
              ...
              localObject1 = ((awmz)localQQAppInterface.getManager(11)).a();
            ...
            for (;;)
            {
              adrm.b(localQQAppInterface, paramMessage, (SessionInfo)localObject3, (String)localObject2);
              return;
              if (i == 1000)
              {
          ...
          case 1: 
            ...
            localObject1 = (bgpa)paramMessage[0];
      ...
      mqw.e(localQQAppInterface.isBackground_Pause);
      return;
      paramMessage = (bgpa)((Object[])(Object[])paramMessage.obj)[0];
    } while (!paramMessage.isShowing());
    paramMessage.dismiss();
    return;
