  ...
  implements agma, agmn
{
  ...
  public agky(aglu paramaglu, BaseChatPie paramBaseChatPie)
  {
  ...
  public void a(int paramInt)
  {
    ...
    for (paramInt = i;; paramInt = 0)
    {
      ...
      amtx localamtx = amuo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localamtx != null) {
        localamtx.a(this.jdField_a_of_type_Long, this.b, amuo.b(), amuo.a());
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Amje == null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Amje = new amje();
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Amje.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
      return;
    }
  }
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          bgsc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramInt1, (AbsStructMsg)localObject, null);
          ...
          else if (paramInt1 == 14003)
          {
            if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
            {
              ...
              ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(null);
            }
          }
    ...
    for (int i = Integer.parseInt((String)((Map)localObject1).get("textType"));; i = 0)
    {
      ...
      for (int j = Integer.parseInt(paramObject);; j = 0)
      {
        ...
        for (float f = Float.parseFloat(paramObject);; f = 0.0F)
        {
          ...
          {
            paramObject = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
            Object localObject3 = (amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
            ...
            {
            default: 
              String str3 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690018);
              String str4 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690018);
              paramObject = str3;
              localObject1 = str4;
              localObject3 = str2;
              ...
              this.jdField_a_of_type_Bgpa = bglp.a(this.jdField_a_of_type_AndroidAppActivity, 0, paramObject, (CharSequence)localObject1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694420), (String)localObject3, (DialogInterface.OnClickListener)localObject2, new agla(this));
            ...
            case 31006: 
              ...
              if (TextUtils.isEmpty(paramObject)) {
                paramObject = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690010);
              }
              break;
            }
            for (;;)
            {
              ...
              str2 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690009);
              localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690009);
              localObject2 = new agkz(this, (String)localObject1, m);
              ...
              paramObject = str2;
              break label579;
              QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690000), 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298998));
              if (!QLog.isColorLevel()) {
                break;
              }
