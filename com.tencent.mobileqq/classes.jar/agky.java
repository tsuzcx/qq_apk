...
public class agky
  implements bfpt
{
  private agky(AlbumListActivity paramAlbumListActivity) {}
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = this.a.jdField_a_of_type_Agla.a(paramInt);
    if ((paramAdapterView == null) || (paramAdapterView.mMediaFileCount <= 0) || (TextUtils.isEmpty(paramAdapterView.name))) {
      bcql.a(this.a, 2131690020, 0).a();
    }
    Object localObject;
    do
    {
      ...
      bgyp.a(this.a, (bgyw)localObject, paramView, 0);
    ...
    for (paramInt = 0;; paramInt = 1) {
      for (;;)
      {
        for (;;)
        {
          vei.a("pic_choose_slides", "change_album", paramInt, 0, new String[0]);
          return;
