...
public class aqxg
{
  ...
  public aqxg(QQAppInterface paramQQAppInterface, arnw paramarnw, long paramLong)
  {
    ...
    Object localObject1 = (HashMap)paramarnw.a().get("OnlinePreView");
    ...
    paramarnw = (HashMap)paramarnw.a().get("OfflineConfig");
    localObject1 = paramarnw.keySet().iterator();
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject3 = paramarnw.get(localObject2);
  ...
  {
    long l1 = Long.parseLong(arni.c("OfflineConfigFlowSize"));
    try
    {
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    return arni.c(paramString);
  }
  
  public static String a(Context paramContext, String paramString1, String paramString2)
  {
    return a(paramContext, "OnlinePreView", arof.a(paramString1).replace(".", ""), paramString2);
  }
  ...
  {
    long l1 = Long.parseLong(arni.c("OfflineConfigFlowTime"));
    try
    {
  ...
  {
    long l1 = Long.parseLong(arni.c("OfflineConfigFtnThumbMaxSize"));
    try
    {
