...
class ajej
  extends Handler
{
  ajej(ajei paramajei, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (ajei.a())
      {
        ...
        if ((ReportInfo)ajei.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        ajei.a(this.a).add(localObject5);
      }
      ajei.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      ajei.b(this.a).add(localObject1);
      ajei.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (ajei.a())
        {
          ...
          localObject5 = (ReportInfo)ajei.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (ajei.a())
        {
          ...
          localObject4 = (ReportInfo)ajei.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        ajei.a(this.a).add(???);
        ajei.b(this.a, 5);
        localObject4 = ajei.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          ajei.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (ajei.a())
      {
        ...
        if ((ReportInfo)ajei.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      ajei.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      ajei.b(this.a).add(localObject3);
      ajei.a(this.a).add(localObject5);
      ajei.a(this.a, 1);
      return;
      ??? = ".";
