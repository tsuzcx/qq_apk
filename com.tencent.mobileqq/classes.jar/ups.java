...
public class ups
{
  ...
  private List<vvh> f = new ArrayList();
  ...
  public void a(List<CommentEntry> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        ...
        veg.a("Q.qqstory.detail.DetailFeedItem", "comment list's size is %d after clear.", Integer.valueOf(localList.size()));
      }
      ...
      Collections.sort(localList, new upt(this));
      veg.a("Q.qqstory.detail.DetailFeedItem", "comment list's size is %d after add %d comments.", Integer.valueOf(localList.size()), Integer.valueOf(paramList.size()));
      return;
    }
  }
  ...
  public void b(List<vvh> paramList, boolean paramBoolean)
  {
    if (paramBoolean) {
      this.f.clear();
    }
