...
public class ups
{
  ...
  public static int a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      return ((QQAppInterface)localObject).a().a().a(anhk.aP, 1008);
    }
    return 0;
  }
  ...
  private static Bitmap a(URL paramURL, ImageView paramImageView)
  {
    if ((paramURL != null) && (paramImageView.getWidth() > 0))
    {
      ...
      localtdw.jdField_a_of_type_JavaNetURL = paramURL;
      localtdw.jdField_a_of_type_Int = paramImageView.getWidth();
      localtdw.jdField_b_of_type_Int = paramImageView.getHeight();
      paramURL = bglc.a(localtdw.a());
      if (paramURL != null) {
        return paramURL.a();
      }
    }
  ...
  {
    Object localObject = a();
    if (a((pnp)localObject))
    {
      localObject = ((pnp)localObject).a();
      upe.d("WSPushLog", "WSRedDotPushMsg = " + (String)localObject);
  ...
  public static String a(stSimpleMetaFeed paramstSimpleMetaFeed, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      upe.b("WeishiUtils", "使用webp图片资源：" + (String)localObject1);
    ...
    {
      upe.b("WeishiUtils", "使用服务器默认的图片格式资源：" + (String)localObject3);
  ...
  public static pnp a()
  {
    ...
    {
      localObject = (QQAppInterface)localObject;
      if ((((QQAppInterface)localObject).getManager(274) instanceof pnp)) {
        return (pnp)((QQAppInterface)localObject).getManager(274);
      }
    }
    return null;
  }
  ...
  public static void a()
  {
    ...
    if (localpnp != null)
    {
      ...
      localstSimpleMetaFeed.id = localpnp.c();
      localstSimpleMetaFeed.feed_desc = localpnp.d();
      localpnp.a(localstSimpleMetaFeed);
    }
  }
  ...
  public static void a(Context paramContext, KandianUrlImageView paramKandianUrlImageView, URL paramURL, Drawable paramDrawable, String paramString)
  {
    ...
    if (paramDrawable == null) {
      localObject = paramContext.getResources().getDrawable(2130841680);
    }
    if (paramURL == null)
    {
    ...
    paramKandianUrlImageView.setPublicAccountImageDownListener(new upt(paramString, paramKandianUrlImageView));
  }
  
  public static void a(Context paramContext, RoundImageView paramRoundImageView, String paramString)
  {
    upe.b("AvatarImageLog", "WeishiUtils loadAvatarImage url:" + paramString + ", imageView:" + paramRoundImageView);
    URL localURL;
    ...
    paramRoundImageView.setImageDrawable(paramContext);
    paramContext.setURLDrawableListener(new upu(paramString, paramRoundImageView));
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt, upz paramupz)
  {
    if (paramupz == null) {
    ...
    if (zmi.a(paramContext))
    {
      ...
      {
        upe.c("815", "走打开shemeUrl:" + paramString1);
        paramupz.a(paramString1, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString3))
      {
        upe.c("833", "走打开小程序:" + paramString3);
        paramupz.d(paramString3, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString2))
      {
        upe.c("815", "走打开h5Url:" + paramString2);
        paramupz.b(paramString2, paramInt);
        return;
      }
      upe.c("815", "走打开兜底:" + paramString1);
      paramupz.a("weishi://main", paramInt);
      return;
    }
    if (!TextUtils.isEmpty(paramString3))
    {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      upe.c("815", "走跳转h5Url:" + paramString2);
      paramupz.b(paramString2, paramInt);
      return;
    }
    upe.c("815", "走下载，shemeUrl:" + paramString1);
    paramupz.c(paramString1, paramInt);
  }
  ...
  public static void a(Context paramContext, ArrayList<stSimpleMetaFeed> paramArrayList, int paramInt1, String paramString, stGlobalConfig paramstGlobalConfig, WSRedDotPushMsg paramWSRedDotPushMsg, int paramInt2)
  {
    ...
    try
    {
      ...
      if (paramArrayList != null)
      {
        ...
        if (paramArrayList.size() > 0)
        {
          ...
          paramString = ugb.a().a(paramArrayList.traceId);
        }
      }
      ...
      uef.jdField_a_of_type_Boolean = true;
    ...
    catch (NumberFormatException paramString)
    {
      for (;;)
      {
        upe.b("openVerticalVideoLayerPage parseLong posterId : " + paramString);
      }
    }
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new upx(paramView));
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new upy(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, Drawable paramDrawable1, Drawable paramDrawable2, String paramString2)
  {
    ...
    paramImageView.setImageDrawable(paramDrawable1);
    paramDrawable1.setURLDrawableListener(new upv(paramString2, paramImageView, paramString1));
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, String paramString)
  {
    if ((paramKandianUrlImageView != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      paramKandianUrlImageView.setImagePlaceHolder(BaseApplicationImpl.getApplication().getApplicationContext().getResources().getDrawable(2130841778)).setImage(paramString);
    }
  }
  ...
  public static void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, boolean paramBoolean)
  {
    ...
    {
      upe.b("WSRedDotLog", "saveRedDotAppInfo appInfo = " + paramAppInfo.iNewFlag.get());
      upe.b("WSRedDotLog", "saveRedDotAppInfo hasWsRedDot = " + paramBoolean);
  ...
  public static void a(String paramString)
  {
    paramString = a(paramString);
    tdw localtdw = new tdw();
    localtdw.jdField_a_of_type_JavaNetURL = paramString;
    localtdw.jdField_b_of_type_Boolean = true;
    tdv.a().a(localtdw, new upw());
  }
  ...
  public static void a(List<stSimpleMetaFeed> paramList, boolean paramBoolean)
  {
    ...
    upe.b("PreloadCoverImgLog", "preloadImg size = " + paramList.size());
  ...
  private static boolean a(MessageForStructing paramMessageForStructing)
  {
    ...
    {
      return false;
      upe.d("WSPushLog", "isMsgFromWeishiPush structMsg.frienduin: " + paramMessageForStructing.frienduin);
    } while ((!TextUtils.equals(anhk.aP, paramMessageForStructing.frienduin)) || (paramMessageForStructing.issend != 0));
    return true;
  }
  
  public static boolean a(pnp parampnp)
  {
    if (parampnp == null) {
      return false;
    }
  ...
  {
    return paramString + "&idx=" + ugb.a().e();
  }
  ...
  public static void b(String paramString)
  {
    ...
    if ((localClipboardManager != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      upe.d("WeishiUtils", "Clipboard copyScheme: " + paramString + ", clip: " + localClipData);
  ...
  public static boolean b()
  {
    ...
    {
      upe.f("WeishiUtils", "click too fast");
  ...
  {
    ugf localugf = ugf.a();
    if ((localugf == null) || (localugf.a == null)) {
      return false;
    }
    return localugf.a.jdField_a_of_type_Boolean;
  }
  ...
  public static void d(String paramString)
  {
    ...
    {
      umz.b = "";
      umz.jdField_a_of_type_JavaLangString = "";
      LocalMultiProcConfig.putString("weishi_usergrowth", "key_ref_page_id", "");
      return;
    }
    umz.b = umz.jdField_a_of_type_JavaLangString;
    LocalMultiProcConfig.putString("weishi_usergrowth", "key_ref_page_id", umz.b);
    umz.jdField_a_of_type_JavaLangString = paramString;
  }
  ...
  public static String e()
  {
    ...
    {
      upe.d("WeishiUtils", "getWifiBssid : " + localException.toString());
    }
    return "";
  }
  ...
  public static String f()
  {
    ...
    upe.f("WeishiUtils", "[qq_connect_person_id]" + str);
    return str;
  }
}
