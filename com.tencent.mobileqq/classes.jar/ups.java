  ...
  implements PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  public static ups a()
  {
    if (jdField_a_of_type_Ups == null) {}
    try
    {
      if (jdField_a_of_type_Ups == null) {
        jdField_a_of_type_Ups = new ups();
      }
      return jdField_a_of_type_Ups;
    }
    finally {}
  }
  ...
  public void b()
  {
    ...
    uqf.b("QzoneVerticalVideoPluginApk", "initPluginThreshold configBean = " + localObject);
    if ((localObject == null) || (((ugh)localObject).a == null))
    {
      uqf.d("QzoneVerticalVideoPluginApk", "doDownloadWeishi : configBean is null");
      return;
    }
    localObject = ((ugh)localObject).a;
    this.jdField_a_of_type_Long = (((ugk)localObject).jdField_a_of_type_Long * 1000L);
    this.d = ((ugk)localObject).jdField_a_of_type_Boolean;
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    for (;;)
    {
      ...
      if (paramPluginManagerClient != null)
      {
        ...
        try
        {
          this.jdField_a_of_type_ComTencentMobileqqPluginsdkPluginManagerClient.installPlugin("qzone_vertical_video_plugin.apk", new upt(this));
        }
