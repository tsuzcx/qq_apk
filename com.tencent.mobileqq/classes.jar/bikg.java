  ...
  extends bikj
{
  ...
  private static final String jdField_a_of_type_JavaLangString = bikg.class.getSimpleName();
  private static String jdField_b_of_type_JavaLangString;
  private static boolean jdField_b_of_type_Boolean;
  private static int o;
  private static int p;
  private birl jdField_a_of_type_Birl = new birl();
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        ...
        this.jdField_a_of_type_Biki.b(103);
        return;
      }
      ...
      if (this.jdField_a_of_type_Biki != null) {
        this.jdField_a_of_type_Biki.a(localBitmap);
      }
      return;
      label126:
      continue;
  ...
  private void f()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Biss == null) {
        this.jdField_a_of_type_Biss = new biss();
      }
      return;
    }
    finally {}
  ...
  {
    if (this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) {}
    while ((!bkvg.a().b()) || (!e()) || (!this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.canUseLargeImage())) {
      return false;
    }
    return true;
  }
  ...
  private void g()
  {
    ...
    if (this.jdField_a_of_type_Biss != null) {
      this.jdField_a_of_type_Biss.a();
    }
    this.jdField_a_of_type_Birl.a();
  }
  ...
  private void i()
  {
    ...
    int j = 100;
    Object localObject = bjaa.a().a("app_alg_filter_timeout_id", "", 4);
    int i = j;
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.setOnMaterialLoadFinishListener(new bikh(this));
  ...
  public int a(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Biss.a(localFrame).getTextureId();
  }
  ...
  public int[] a(int paramInt1, int paramInt2)
  {
    ...
    if (birl.jdField_a_of_type_Boolean)
    {
      if (!this.jdField_a_of_type_Birl.a())
      {
        this.jdField_a_of_type_Birl.c();
        this.g = this.jdField_a_of_type_Birl.a();
        this.h = this.jdField_a_of_type_Birl.b();
      }
      localObject = this.jdField_b_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Birl.c(), this.e, this.f);
    }
    for (;;)
    {
      int i;
      ...
      if ((bool) && (f()))
      {
        bink.a.jdField_a_of_type_Boolean = true;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Biss != null)
    {
      this.jdField_a_of_type_Biss.b();
      this.jdField_a_of_type_Biss = null;
    }
    this.jdField_a_of_type_Birl.b();
  }
