  ...
  implements Manager
{
  ...
  private acag jdField_a_of_type_Acag;
  ...
  public akrc(QQAppInterface paramQQAppInterface) {}
  ...
  private QWalletPubAdReport.TerminalInfor a(Context paramContext)
  {
    ...
    localTerminalInfor.qq_version.set("8.4.10");
  ...
  private void a(acaf paramacaf)
  {
    ...
    do
    {
      ...
      if (paramacaf.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp == null)
      {
        QLog.i("QWalletGdtAdManager", 2, "reqAds onResponse ret fail,loader.getSession().response null");
        return;
      }
    } while (paramacaf.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get() == 0);
    QLog.i("QWalletGdtAdManager", 2, "reqAds onResponse ret fail,loader.getSession().response.ret.get " + paramacaf.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get());
  }
  
  private void a(Context paramContext, String paramString, int paramInt, acag paramacag)
  {
    acah localacah = new acah();
    localacah.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet = a(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin(), paramString, paramInt);
    new acaf(localacah, new WeakReference(paramacag)).a(new WeakReference(paramContext));
    if (QLog.isColorLevel()) {
  ...
  private void a(BaseActivity paramBaseActivity)
  {
    ...
    bmhg.a(localQQAppInterface, "tenpay.com", new akre(this, paramBaseActivity, localQQAppInterface, NetConnInfoCenter.getServerTimeMillis()));
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    bdla.b(localQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
  ...
  public static void a(im_msg_body.GeneralFlags paramGeneralFlags, MessageForStructing paramMessageForStructing)
  {
    if ((paramGeneralFlags != null) && (paramGeneralFlags.bytes_pb_reserve.has())) {
      try
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          if (((bdnu)((Iterator)localObject).next() instanceof bdrk))
          {
    ...
    Object localObject = bdoe.a(0);
    ((bdnv)localObject).a(new bdpz());
    ((bdnv)localObject).a = paramMessageForStructing.structingMsg;
    paramGeneralFlags.add(localObject);
    localObject = bdoe.a(31);
    ((bdnv)localObject).a = paramMessageForStructing.structingMsg;
    paramGeneralFlags.add(localObject);
  ...
  {
    paramBaseChatPie = new akrd(this, NetConnInfoCenter.getServerTimeMillis(), paramBaseChatPie);
    this.jdField_a_of_type_Acag = paramBaseChatPie;
  ...
  public void a()
  {
    Iterator localIterator = bdrk.b.iterator();
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Acag = null;
    paramContext = bdrk.b.iterator();
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bmhg.a(localQQAppInterface, "tenpay.com", new akrg(this, paramInt, paramContext, localQQAppInterface, l));
        return;
      }
  ...
  public void a(BaseActivity paramBaseActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    {
      localObject = (aktz)paramBaseActivity.app.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER);
      i1 = ((aktz)localObject).a("common", 1, new String[] { "pub_ad_control", "gdt_day_freq" });
      n = ((aktz)localObject).a("common", 4, new String[] { "pub_ad_control", "gdt_week_freq" });
    }
    int i2 = 0;
    int i5 = 0;
    int i4 = 0;
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("QWalletGdtAdManager", 2, "list,time:" + bhid.b(localChatMessage.time * 1000L) + ",isShowQWalletPubAd:" + localChatMessage.isShowQWalletPubAd);
      }
      i -= 1;
      break label22;
      break;
  ...
  public boolean a()
  {
    ...
    if (((aktz)localQQAppInterface.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).a("common", 0, new String[] { "pub_ad_control", "gdt_switch" }) == 0) {}
