...
public class akrc
{
  ...
  private akri jdField_a_of_type_Akri;
  public akrj a;
  akrv jdField_a_of_type_Akrv;
  private aksc jdField_a_of_type_Aksc;
  ...
  public akrc()
  {
    this.jdField_a_of_type_Akgd = new akrg(this, 0, true, true, 3000L, true, false, "QQARScan");
  }
  ...
  private void a(int paramInt, aksc paramaksc)
  {
    QLog.i("AREngine_ARCloudControl", 1, "requestToCheckLBSLocation.");
    this.jdField_a_of_type_Aksc = paramaksc;
    ...
    this.jdField_a_of_type_ComTencentMobileqqArModelArLBSActivity = aksc.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions, paramaksc);
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new akrh(this), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
  ...
  private void a(aksh paramaksh)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Akqi.a(paramaksh, new akrf(this, l1, paramaksh));
      return;
    }
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Akqi != null)
    {
      ...
      this.jdField_a_of_type_Akqi.a(paramString, paramInt1, paramInt2, new akrd(this));
    }
  }
  ...
  private void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList)
  {
    if (this.jdField_a_of_type_Akrv != null)
    {
      ...
      this.jdField_a_of_type_Akrv.a(paramArrayOfByte, paramArrayList, new akre(this, localaksh), this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (akna.a("libARCloud"))
        {
          jdField_l_of_type_Boolean = true;
          try
          {
            if (akna.a("libARCloud") != 0) {
              break label167;
            }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    long l1;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Akrj != null))
    {
      l1 = System.currentTimeMillis();
      bool1 = this.jdField_a_of_type_Akrj.a(paramArrayOfByte);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Akri.c(bool1);
      QLog.i("AREngine_ARCloudControl", 1, "isSameSceneWithBestImg = " + bool1 + " cost time:" + (System.currentTimeMillis() - l1) + "ms");
    }
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Akrj == null)) {
      return;
    }
    ...
    if (this.jdField_a_of_type_Akri != null) {
      this.jdField_a_of_type_Akri.b();
    }
    this.jdField_c_of_type_Long = System.currentTimeMillis();
    boolean bool1 = this.jdField_a_of_type_Akrj.a(paramArrayOfByte, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    ...
    if (this.jdField_a_of_type_Akri != null)
    {
      boolean bool2 = this.jdField_a_of_type_Akri.a();
      l1 = this.jdField_a_of_type_Akri.a();
      if ((bool1) && (!this.jdField_m_of_type_Boolean) && (bool2))
      {
        ...
        i1 = 0;
        bool1 = false;
        this.jdField_a_of_type_Akri.a(bool1);
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Akri != null) {
          this.jdField_a_of_type_Akri.b(true);
        }
        if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Akri != null))
        {
          l1 = this.jdField_a_of_type_Akri.b();
          akpc.a().a(l1, this.jdField_l_of_type_Long, this.jdField_m_of_type_Long, this.jdField_a_of_type_Akrj.jdField_c_of_type_Int);
          akip.a().a(l1, this.jdField_m_of_type_Long);
          this.jdField_f_of_type_Boolean = true;
        }
        a(new ARCloudControl.3(this, paramArrayOfByte));
        return;
        paramArrayOfByte = this.jdField_a_of_type_Akrj.a();
      }
      label675:
      i1 = 0;
      break;
  ...
  public boolean a(akri paramakri, AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, ARCommonConfigInfo paramARCommonConfigInfo)
  {
    long l2 = System.currentTimeMillis();
    jdField_k_of_type_Boolean = a();
    akue.a().b(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
    if (!jdField_k_of_type_Boolean) {
      return false;
    }
    this.jdField_a_of_type_Akrj = new akrj(akrj.jdField_b_of_type_Int);
    this.jdField_a_of_type_Akrv = new akrv();
    this.jdField_a_of_type_Akrj.a(BaseApplicationImpl.getContext().getApplicationContext());
    ...
    this.jdField_a_of_type_Akri = paramakri;
    this.jdField_a_of_type_Akqi = new akqi(paramAppInterface, true);
    this.jdField_a_of_type_Akqi.a();
    ...
    for (long l1 = ARRecognition.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions);; l1 = 0L)
    {
      ...
      akue.a().c(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
      return true;
    }
  }
  ...
  public void denied()
  {
    ...
    this.jdField_a_of_type_Aksc = null;
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Akrj != null)
    {
      this.jdField_a_of_type_Akrj.a();
      this.jdField_a_of_type_Akrj = null;
    }
    if (this.jdField_a_of_type_Akrv != null)
    {
      this.jdField_a_of_type_Akrv.b();
      this.jdField_a_of_type_Akrv = null;
    }
    this.jdField_a_of_type_Akri = null;
