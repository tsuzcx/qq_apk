...
public class bjmm
  extends QIPCModule
{
  private static bjmm a;
  
  private bjmm(String paramString)
  {
    super(paramString);
  }
  
  /* Error */
  public static bjmm a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bjmm:a	Lbjmm;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bjmm:a	Lbjmm;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bjmm
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bjmm:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bjmm:a	Lbjmm;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bjmm:a	Lbjmm;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_start_send".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        localObject1 = axdo.a(3, 0);
        localObject2 = axdo.a(0, paramBundle, (axeg)localObject1);
        ((axdt)localObject2).c = true;
        ((axeg)localObject1).a((axdt)localObject2);
        axdo.a((axeg)localObject1, paramString);
      }
      if (QLog.isColorLevel())
      {
    ...
    if ("action_cancel_send".equals(paramString))
    {
      ...
      if (localObject1 != null)
      {
        ...
        label350:
        if ((!(paramString instanceof ayuu)) || (((ayuu)paramString).q)) {
          break label570;
        }
        ((ayuu)paramString).c();
        bool1 = true;
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        awan.a(paramBundle, (String)localObject2, l2);
        bool2 = bool3;
        if (localObject1 != null) {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        for (;;)
        {
          for (;;)
          {
            ...
            break label350;
            label570:
            if (((paramString instanceof aypj)) && (!((aypj)paramString).b))
            {
              ((aypj)paramString).c();
              bool1 = true;
              paramString = "C2CPic";
            ...
            if ((!(paramString instanceof ayrd)) || (((ayrd)paramString).q)) {
              break label1809;
            }
            ((ayrd)paramString).c();
            bool1 = true;
            ...
            if ("action_re_send".equals(paramString))
            {
              ...
              if ((paramBundle instanceof MessageForShortVideo))
              {
                ...
                if ((bbdj.b(ShortVideoUtils.a(((MessageForShortVideo)localObject1).thumbMD5, "jpg"))) && (!TextUtils.isEmpty(((MessageForShortVideo)localObject1).videoFileName)) && (((MessageForShortVideo)localObject1).isStoryVideo))
                {
                  ((awan)paramString.getManager(326)).a(((MessageForShortVideo)localObject1).frienduin, (MessageRecord)localObject1, ((MessageForShortVideo)localObject1).videoFileName);
                  localObject1 = axdo.a(4, 0);
                  localObject2 = axdo.a(0, paramBundle, (axeg)localObject1);
                  ((axdt)localObject2).c = true;
                  ((axeg)localObject1).a((axdt)localObject2);
                  axdo.a((axeg)localObject1, paramString);
              ...
              for (paramString = paramBundle.toString();; paramString = "")
              {
                ...
                bool1 = bool2;
                if (!bbdj.b(((MessageForPic)localObject1).path)) {
                  break label991;
                }
                bool1 = bool2;
                ...
                localObject2 = new auoc();
                ((auoc)localObject2).a(((MessageForPic)localObject1).path);
                ((auoc)localObject2).d(5);
                ((auoc)localObject2).d(((MessageForPic)localObject1).frienduin);
                if (((MessageForPic)localObject1).fileSizeFlag == 1) {
                  ((auoc)localObject2).c(ayvu.e);
                }
                for (;;)
                {
                  ((auoc)localObject2).e(((MessageForPic)localObject1).senderuin);
                  ((auoc)localObject2).c(((MessageForPic)localObject1).selfuin);
                  ((auoc)localObject2).e(((MessageForPic)localObject1).istroop);
                  ((auoc)localObject2).l(((MessageForPic)localObject1).getConfessTopicId());
                  ((auoc)localObject2).jdField_i_of_type_Int = ((MessageForPic)localObject1).extLong;
                  ((auoc)localObject2).jdField_i_of_type_JavaLangString = ((MessageForPic)localObject1).extStr;
                  ((auoc)localObject2).b(true);
                  localObject3 = new auod();
                  ((auod)localObject3).a = ((MessageForPic)localObject1).msgseq;
                  ((auod)localObject3).b = ((MessageForPic)localObject1).shmsgseq;
                  ((auod)localObject3).c = ((MessageForPic)localObject1).msgUid;
                  ((auoc)localObject2).a((auod)localObject3);
                  ((auoc)localObject2).b(((MessageForPic)localObject1).uniseq);
                  ((awan)paramString.getManager(326)).a(((MessageForPic)localObject1).frienduin, ((MessageForPic)localObject1).uniseq);
                  localObject3 = aunj.a(4, 5);
                  ((aunt)localObject3).a(((auoc)localObject2).a());
                  ((aunt)localObject3).a = ((MessageForPic)localObject1).picExtraData;
                  aunj.a((aunt)localObject3, paramString);
                  bool1 = true;
                  break;
                  ((auoc)localObject2).c(ayvu.d);
                }
              }
            }
        ...
        if ("action_get_name".equals(paramString))
        {
          ...
          try
          {
            paramString = bbcl.b((QQAppInterface)localObject1, paramString);
            localBundle.putBoolean("key_result", true);
            localBundle.putString("uinname", paramString);
            paramString = EIPCResult.createSuccessResult(localBundle);
            return paramString;
