  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public bmzy(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Bmzz = new bmzz();
    this.jdField_a_of_type_Bmzz.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Bmzz.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bmzz.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bmzz = null;
  ...
  {
    this.jdField_a_of_type_Bmzz.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bmzz.a("before updateTexImage");
