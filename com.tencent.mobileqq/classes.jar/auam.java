...
public class auam
{
  ...
  public static auam a()
  {
    try
    {
      if (jdField_a_of_type_Auam == null) {
        jdField_a_of_type_Auam = new auam();
      }
      auam localauam = jdField_a_of_type_Auam;
      return localauam;
    }
    finally {}
  }
  
  private TroopAssistantData a(awgf paramawgf, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      paramawgf = localTroopAssistantData;
  ...
  {
    jdField_a_of_type_Auam = null;
  }
  
  /* Error */
  private void a(awgf arg1)
  {
    // Byte code:
    //   0: aload_1
    //   1: ldc 64
    ...
    //   8: ldc 93
    //   10: aconst_null
    //   11: invokevirtual 98	awgf:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   14: astore_2
    //   15: aload_2
    //   16: ifnull +198 -> 214
    //   19: aload_2
    ...
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 109	auan:<init>	(Lauam;)V
    ...
    //   76: aload_0
    //   77: getfield 38	auam:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   80: astore_1
    //   81: aload_1
    //   82: monitorenter
    //   83: aload_0
    //   84: aload_2
    //   85: putfield 145	auam:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: aload_0
    //   89: getfield 145	auam:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   92: ifnonnull +16 -> 108
    //   95: aload_0
    ...
    //   105: putfield 145	auam:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 47	auam:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   114: astore_1
    //   115: aload_1
    //   116: monitorenter
    //   117: aload_0
    //   118: getfield 47	auam:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   121: invokeinterface 153 1 0
    //   126: aload_0
    //   127: getfield 145	auam:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   154: astore_3
    //   155: aload_0
    //   156: getfield 47	auam:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   159: aload_3
  ...
  private void a(awgf paramawgf, TroopAssistantData paramTroopAssistantData)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        ThreadManager.post(new TroopAssistantManager.4(this, paramTroopAssistantData, paramawgf), 8, null, false);
        return;
        paramawgf = finally;
        throw paramawgf;
        i += 1;
  ...
  private boolean a(awgf paramawgf, String paramString)
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      if (paramString != null)
      {
        ThreadManager.post(new TroopAssistantManager.3(this, paramawgf, paramString), 8, null, false);
        return true;
        paramawgf = finally;
        throw paramawgf;
      }
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = localamnz.a(alof.C, 5000);
        ((RecentUser)localObject).uin = alof.C;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = localamnz.b(alof.C, 5000);
        if (paramQQAppInterface != null) {
          localamnz.b(paramQQAppInterface);
        }
      }
    }
  }
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilSet != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (!afex.a(str, 1, paramQQAppInterface))) {
              i += 1;
            }
          }
          else
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (afex.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) {
              continue;
            }
    ...
    try
    {
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          {
            a(paramawgf, (TroopAssistantData)localObject3);
  ...
  public void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    a(paramMessageRecord, paramMessageRecord.frienduin, paramMessageRecord.time, localawgf, paramQQAppInterface);
    localawgf.a();
  }
  ...
  {
    TroopAssistantData localTroopAssistantData = a(paramawgf, paramQQAppInterface, paramString);
    ...
    for (localTroopAssistantData.lastmsgtime = paramMessageRecord.time;; localTroopAssistantData.lastmsgtime = paramLong)
    {
      ...
      a(paramawgf, localTroopAssistantData);
  ...
  public void a(String paramString, long paramLong, awgf paramawgf, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, 0, paramLong);
      return;
      localTroopAssistantData = a(paramawgf, paramQQAppInterface, paramString);
      break;
      label94:
      a(paramawgf, localTroopAssistantData);
    }
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    awgf localawgf = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    amnz localamnz = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localamnz.b(paramString, 1);
    QQMessageFacade.Message localMessage;
    if (localRecentUser != null)
    {
      paramString = a(localawgf, paramQQAppInterface, paramString);
    ...
    for (paramString.lastmsgtime = localMessage.time;; paramString.lastmsgtime = localRecentUser.lastmsgtime)
    {
      ...
      a(localawgf, paramString);
      e(paramString.troopUin, paramQQAppInterface);
      ajjj.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
      if ((!(localRecentUser.msg instanceof ajlw)) && (!(localRecentUser.msg instanceof ajmn)) && (!(localRecentUser.msg instanceof ajlz)) && (!(localRecentUser.msg instanceof ajmf)) && (!(localRecentUser.msg instanceof ajlv)) && (!(localRecentUser.msg instanceof bkds)) && (!(localRecentUser.msg instanceof ajmk)) && (!(localRecentUser.msg instanceof ajme)) && (!(localRecentUser.msg instanceof ajmh))) {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilSet = bdnf.a((SharedPreferences)localObject2, "troop_assis_new_unread_list", null);
      if (this.jdField_a_of_type_JavaUtilSet == null)
      {
        this.jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  public void c(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        localObject = localawgf;
        RecentUser localRecentUser = localamnz.a(String.valueOf(localTroopAssistantData.troopUin), 1);
        localObject = localawgf;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    if (((ArrayList)localObject3).size() > 0)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        localObject5 = a(localawgf, paramQQAppInterface, ((RecentUser)???).uin);
        ...
        {
          a(localawgf, (TroopAssistantData)localObject5);
          ((amnz)localObject1).b((RecentUser)???);
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ??? = ((amnz)localObject1).a(((TroopAssistantData)localObject3).troopUin, 1);
        ...
        if (a(localawgf, ((TroopAssistantData)localObject3).troopUin))
        {
          ((amnz)localObject1).a((RecentUser)???);
  ...
  public void k(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      if (a(paramQQAppInterface) == true)
      {
        ...
        a().a(localawgf, paramQQAppInterface);
        localawgf.a();
      }
      c(paramQQAppInterface);
      if (auao.a().a(paramQQAppInterface) == true)
      {
        localawgf = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
        auao.a().a(localawgf, paramQQAppInterface);
        localawgf.a();
      }
      return;
    }
