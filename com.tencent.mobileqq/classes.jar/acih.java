      ...
      do
      {
        ...
        if ("android.intent.action.SCREEN_OFF".equals(paramContext))
        {
          if (QLog.isColorLevel()) {
            bkad.c("GameCenterBroadcastReceiver", "mScreenOff = true");
          }
          GameCenterCheck.a();
          return;
        }
        ...
        acig.a = paramIntent.getIntExtra("level", 0) * 100 / paramIntent.getIntExtra("scale", 100);
      } while (!QLog.isColorLevel());
      bkad.c("GameCenterBroadcastReceiver", "battery cap= " + acig.a);
      return;
