...
public class acih
  extends akim
{
  public acih(TroopLowCreditLevelNotifyActivity paramTroopLowCreditLevelNotifyActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong)
  {
    ...
    if (paramLong == 1L)
    {
      localObject = bbcv.a(this.a.jdField_a_of_type_AndroidContentContext, 230).setTitle(this.a.getString(2131720249)).setMessage(ajyc.a(2131715477));
      ((bbgg)localObject).setPositiveButton(2131697799, new acii(this));
      ((bbgg)localObject).setNegativeButton("", null);
      ((bbgg)localObject).setCancelable(false);
      ((bbgg)localObject).show();
      return;
    }
    Object localObject = bbcv.a(this.a.jdField_a_of_type_AndroidContentContext, 230).setTitle(this.a.getString(2131720249)).setMessage(ajyc.a(2131715478));
    ((bbgg)localObject).setPositiveButton(2131697799, new acij(this));
    ((bbgg)localObject).setNegativeButton("", null);
    ((bbgg)localObject).setCancelable(false);
    ((bbgg)localObject).show();
  }
