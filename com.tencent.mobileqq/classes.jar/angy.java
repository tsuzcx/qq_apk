...
public class angy
{
  ...
  public angy(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  protected void c(View paramView)
  {
      ...
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_Angr == null) {
            this.jdField_a_of_type_Angr = new angr(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext);
          }
          if (this.jdField_a_of_type_Bkhe == null) {
            this.jdField_a_of_type_Bkhe = new angz(this);
          }
          this.jdField_a_of_type_Angr.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
          this.jdField_a_of_type_Angr.a(this.c);
          this.jdField_a_of_type_Angr.b(this.f);
          this.jdField_a_of_type_Angr.c(this.e);
          this.jdField_a_of_type_Angr.a(this.jdField_a_of_type_JavaUtilList);
        } while (!(paramView instanceof ApolloPanelListView));
        paramView = (ApolloPanelListView)paramView;
        paramView.setOnScrollListener(this.jdField_a_of_type_Bkhe);
        paramView.setAdapter(this.jdField_a_of_type_Angr);
      } while (this.e == -1);
      int j = this.e / this.f;
      i = j;
      if (this.e % this.f != 0) {
    ...
    } while (i >= this.jdField_a_of_type_Angr.getCount());
