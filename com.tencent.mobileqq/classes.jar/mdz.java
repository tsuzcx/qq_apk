  ...
  extends lsc
{
  ...
  meb jdField_a_of_type_Meb = null;
  ...
  public mdz(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString)
  {
    this(paramContext, paramVideoAppInterface, paramString, 0L);
  }
  
  public mdz(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong)
  {
    this(paramContext, paramVideoAppInterface, paramString, paramLong, true);
  }
  
  public mdz(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong, boolean paramBoolean)
  {
    super(paramContext);
    ...
    this.jdField_r_of_type_Int = actj.a(6.0F, paramContext.getResources());
    this.s = actj.a(10.0F, paramContext.getResources());
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(new mea(this, paramVideoAppInterface));
    }
  ...
  private void a(lqo paramlqo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && (((AVActivity)localObject).a != null) && ((((AVActivity)localObject).a instanceof MultiVideoCtrlLayerUIBase)))
      {
        ...
        try
        {
          ...
          paramInt = bbfj.b(BaseApplicationImpl.getApplication());
          if (paramInt == 1)
          {
            paramInt = 1;
            localStringBuilder.append(paramInt).append(';');
  ...
  Bitmap a(Bitmap paramBitmap)
  {
    ...
    //   55: aload_2
    //   56: bipush 20
    //   58: invokestatic 483	bbki:a	(Landroid/graphics/Bitmap;I)V
    //   61: aload_2
    //   62: aload_1
    ...
    //   81: astore_1
    //   82: aload_0
    //   83: getfield 141	mdz:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   86: iconst_2
    ...
    //   118: astore_1
    //   119: aload_0
    //   120: getfield 141	mdz:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   123: iconst_2
  ...
  public med a(lqo paramlqo)
  {
    ...
    for (;;)
    {
      if (i1 != 0)
      {
        ...
        if (this.jdField_a_of_type_Lrs != null)
        {
          ...
          this.jdField_a_of_type_Med.a(paramlqo[0], i1, i2);
          return this.jdField_a_of_type_Med;
          i1 = 0;
          break;
          label139:
          i1 = 0;
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Med.a(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId(), i5, i6);
          return this.jdField_a_of_type_Med;
          i1 = this.y;
          break;
          label548:
    ...
    if ((this.e) && (this.jdField_c_of_type_Lrr != null))
    {
    ...
    this.jdField_a_of_type_Med.a(-1, 0, 0);
    return this.jdField_a_of_type_Med;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (this.jdField_a_of_type_Maa == null)
    {
      this.jdField_a_of_type_Maa = new maa();
      int i1 = b();
      int i2 = c();
      this.jdField_a_of_type_Maa.a(i1);
      this.jdField_a_of_type_Maa.b(i2);
    }
    this.jdField_a_of_type_Maa.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Maa != null)
      {
        this.jdField_a_of_type_Maa.a(paramInt1);
        this.jdField_a_of_type_Maa.b(paramInt2);
      }
      return;
    }
    catch (Exception localException)
  ...
  protected void d(lqo paramlqo)
  {
    ...
    for (float f1 = f5;; f1 = f6)
    {
      ...
      if ((!this.jdField_n_of_type_Boolean) && (a(i6)))
      {
        ...
        paramlqo.a(2);
        a(paramlqo, i1);
        paramlqo.a(i6 * 90, 0.0F, 0.0F, 1.0F);
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a((int)this.jdField_c_of_type_AndroidGraphicsRectF.width());
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.b((int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        this.jdField_a_of_type_Lrs.a(paramlqo, i7, i8, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        if (QLog.isColorLevel())
        {
          if (this.jdField_a_of_type_Meb == null) {
            this.jdField_a_of_type_Meb = new meb();
          }
          localObject = this.jdField_a_of_type_Meb;
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        break label400;
        if ((this.jdField_a_of_type_Maa != null) && (this.jdField_a_of_type_Maa.f()))
        {
          paramlqo.a((4 - i5) * 90, 0.0F, 0.0F, 1.0F);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Maa.a(paramlqo, i7, i8, i2, i3);
            break;
            i4 = i2;
            i2 = i3;
            i3 = i4;
        ...
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqo, i7, i8, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        break label601;
      }
      label1120:
      f4 = f5;
  ...
  protected void e(lqo paramlqo)
  {
    ...
    if (this.jdField_n_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Maa.a(paramlqo, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
    for (;;)
    {
      paramlqo.c();
      lcg.c(this.jdField_c_of_type_JavaLangString, "renderDoubleScreenOfPC:|" + b() + "|" + h() + "|" + i2 + "|" + i3 + "|" + i4 + "|" + i5 + "|" + this.jdField_b_of_type_AndroidGraphicsRectF.toString() + "|" + this.jdField_c_of_type_AndroidGraphicsRectF.toString());
      return;
      i1 = this.y;
      break;
      label398:
  ...
  protected void g(lqo paramlqo)
  {
    ...
    if (this.jdField_r_of_type_Boolean)
    {
      ...
      if (this.jdField_i_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Lrw.e(super.b() - this.s);
      ...
      if ((this.jdField_a_of_type_Lrw != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        i1 = this.s;
        i2 = i5 - this.jdField_a_of_type_Lrw.j() - this.jdField_r_of_type_Int;
      }
    }
    for (;;)
    {
      ...
      {
        i1 = actj.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        i2 = this.w;
      }
    }
  }
  ...
  {
    if ((paramInt == this.jdField_q_of_type_Int) && (this.jdField_b_of_type_Lrs != null)) {
      return;
    }
    ...
    this.jdField_b_of_type_Lrs = new lrs(muc.a(this.jdField_a_of_type_AndroidContentContext, paramInt));
  ...
  protected void i(lqo paramlqo)
  {
    ...
    int i6;
    int i1;
    if ((this.jdField_r_of_type_Boolean) && (this.jdField_m_of_type_Boolean) && (this.jdField_b_of_type_Lrs != null))
    {
      i3 = super.b();
      i4 = super.c();
      i5 = this.jdField_b_of_type_Lrs.c();
      i6 = this.jdField_b_of_type_Lrs.d();
      if (!this.jdField_g_of_type_Boolean) {
        break label159;
      }
      i1 = i3 - i5 - this.jdField_r_of_type_Int;
    }
    for (int i2 = i4 - this.jdField_a_of_type_Lrw.j() - this.jdField_r_of_type_Int + this.jdField_a_of_type_Lrw.k() - i6 + (i6 - this.jdField_a_of_type_Lrw.k()) / 2;; i2 = this.w + this.jdField_a_of_type_Lrw.k() - i6 + Math.abs((i6 - this.jdField_a_of_type_Lrw.k()) / 2))
    {
      paramlqo.a(3);
      paramlqo.a((i5 - i3) / 2, (i6 - i4) / 2);
      this.jdField_b_of_type_Lrs.a(paramlqo, i1, i2, i5, i6);
      paramlqo.c();
      return;
      label159:
      i1 = actj.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + this.jdField_a_of_type_Lrw.c() + this.s;
    }
  }
  ...
  public void k(boolean paramBoolean)
  {
    if (this.e != paramBoolean)
    {
      ...
      if (this.jdField_c_of_type_Lrr == null) {
        this.jdField_c_of_type_Lrr = new lrv(this.jdField_a_of_type_AndroidContentContext, 2130841789);
      }
      localGLRootView = a();
      if (localGLRootView != null) {
