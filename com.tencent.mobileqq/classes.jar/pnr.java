  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new pns(this);
  ...
  private poa jdField_a_of_type_Poa;
  ...
  public pnr(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_Pob = new pob(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Pob);
    this.jdField_a_of_type_Pob.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Pob.a(new pnt(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new pnu(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Pob.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130848432);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130848433);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Poa != null))
    {
      if (this.jdField_a_of_type_Pob.a() > 1)
      {
        this.jdField_a_of_type_Poa.a();
        this.jdField_a_of_type_Poa.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Poa.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Poa.b();
  }
  ...
  private void d()
  {
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new pny(this));
      return;
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Pob == null) {
      return;
    }
    b();
  }
  ...
  {
    this.jdField_a_of_type_Pob.a(parampax);
    a();
  }
  
  public void a(pnq parampnq)
  {
  ...
  {
    this.jdField_a_of_type_Pob.a(parampol);
  }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Poa == null))
    {
      this.jdField_a_of_type_Poa = new poa();
      this.jdField_a_of_type_Poa.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Poa.a(new pnx(this));
    }
    if (this.jdField_a_of_type_Pon == null)
    {
      this.jdField_a_of_type_Pon = new pon(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Pon);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Pob.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
  ...
  public boolean setAttribute(int paramInt, Object paramObject)
  {
    ...
    case 1052: 
      try
      {
        ...
        this.jdField_a_of_type_Pob.a(localList);
