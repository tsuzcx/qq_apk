...
public class apre
  implements View.OnTouchListener, assc, bhpo
{
  private float jdField_a_of_type_Float;
  private int jdField_a_of_type_Int;
  private apsn jdField_a_of_type_Apsn;
  private assb jdField_a_of_type_Assb = new assb(120, this);
  ...
  public apre(EmotionPanelListView paramEmotionPanelListView, apsn paramapsn, bhpo parambhpo)
  {
    ...
    this.c = bdkf.a(5.0F);
    this.jdField_a_of_type_Assb.b(30);
  }
  ...
  public assb a()
  {
    return this.jdField_a_of_type_Assb;
  }
  
  public void a(AbsListView paramAbsListView)
  {
    if (((paramAbsListView.getAdapter() instanceof apup)) || ((paramAbsListView.getAdapter() instanceof apuf)))
    {
      if (((this.jdField_a_of_type_Apsn instanceof EmoticonMainPanel)) && (((EmoticonMainPanel)this.jdField_a_of_type_Apsn).a().a != null))
      {
        int i = EmoticonPanelController.jdField_b_of_type_Int;
        List localList = ((EmoticonMainPanel)this.jdField_a_of_type_Apsn).a().jdField_b_of_type_JavaUtilList;
        EmotionPanelViewPagerAdapter localEmotionPanelViewPagerAdapter = ((EmoticonMainPanel)this.jdField_a_of_type_Apsn).a().a;
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Apsn != null))
    {
      this.jdField_a_of_type_Apsn.m();
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView)) && (this.jdField_b_of_type_Int == 2) && (this.jdField_a_of_type_Apsn != null)) {
      a(0);
    }
    a(paramAbsListView);
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (i == 0)
    {
      ...
      this.jdField_a_of_type_Assb.a(true);
      if (this.jdField_a_of_type_Apsn != null) {
        this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Apsn.c();
      }
    }
    for (;;)
    {
      ...
      if ((i == 1) && (this.jdField_a_of_type_Boolean)) {
        if ((a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView)) && (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView.getListViewScrollY() < this.jdField_a_of_type_Int) && (this.jdField_a_of_type_Apsn != null))
        {
          this.jdField_a_of_type_Apsn.n();
          if (QLog.isColorLevel()) {
        ...
        else if ((a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView)) && (paramMotionEvent.getY() > this.jdField_a_of_type_Float) && (this.jdField_a_of_type_Apsn != null))
        {
          this.jdField_a_of_type_Apsn.n();
          if (QLog.isColorLevel()) {
