...
public class pmr
{
  public static CharSequence a(ArticleInfo paramArticleInfo)
  {
    ...
    if (paramArticleInfo != null)
    {
      ...
      if (l1 > 0L)
      {
        localObject = onj.a(l1, true);
        str2 = "";
        if ((!pen.b(paramArticleInfo)) || (paramArticleInfo.mSocialFeedInfo == null)) {
          break label105;
        }
    ...
    for (;;)
    {
      return onk.a((String)localObject, 36);
      localObject = ajyc.a(2131701139);
      break;
      label105:
      str1 = str2;
      if (paramArticleInfo.mSocialFeedInfo == null) {
  ...
  {
    paramViewBase = (plp)paramViewBase.findViewBaseByName("id_socialize_recommend_follow");
    if (paramViewBase != null) {
      paramViewBase.a(parampax);
    }
  }
  
  public static void c(ViewBase paramViewBase, pax parampax)
  {
    parampax = parampax.a();
    ...
    if (paramViewBase != null)
    {
      try
      {
        if (pen.a(parampax))
        {
          if ((parampax != null) && (parampax.isPGCShortContent()))
          {
  ...
  public static void d(ViewBase paramViewBase, pax parampax)
  {
    paramViewBase = (NativeText)paramViewBase.findViewBaseByName("id_nickname");
    parampax = parampax.a();
    try
    {
      long l = Long.parseLong(parampax.mSubscribeID);
    ...
    paramViewBase.setText(parampax.nick);
  }
}
