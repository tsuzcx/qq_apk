...
public class pmr
{
  private static final LRULinkedHashMap<String, pmu> jdField_a_of_type_ComTencentUtilLRULinkedHashMap;
  private static final Object jdField_a_of_type_JavaLangObject = new Object();
  private static volatile pmr jdField_a_of_type_Pmr;
  private static volatile boolean jdField_a_of_type_Boolean;
  public static int b;
  private static final LRULinkedHashMap<String, pmu> jdField_b_of_type_ComTencentUtilLRULinkedHashMap;
  public static int c;
  public static int d;
  public static int e;
  public static int f;
  ...
  public pmr()
  {
    ...
    this.jdField_a_of_type_Pmv = new pmv(new pms(this));
  }
  
  public static pmr a()
  {
    if (jdField_a_of_type_Pmr == null) {
      jdField_a_of_type_Pmr = new pmr();
    }
    return jdField_a_of_type_Pmr;
  }
  
  public static pmu a(String paramString)
  {
    ...
    {
      localpmu = (pmu)jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString);
      if (localpmu != null)
      {
        paramString = localpmu;
        if (localpmu.a()) {
          paramString = null;
        }
        return paramString;
    ...
    pmu localpmu = (pmu)jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(paramString);
    if (localpmu != null)
    {
      paramString = localpmu;
      if (localpmu.a()) {}
  ...
  /* Error */
  public static void a(String paramString, pmt parampmt)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 132	pmr:jdField_a_of_type_Boolean	Z
    //   6: ifeq +20 -> 26
    //   9: aload_1
    //   10: ifnull +12 -> 22
    //   13: aload_1
    //   14: getstatic 47	pmr:g	I
    ...
    //   33: aload_1
    //   34: aload_0
    //   35: invokespecial 148	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine$3:<init>	(Lpmt;Ljava/lang/String;)V
  ...
  {
    boolean bool = true;
    File localFile = new File(pmx.a(), "libviola.so");
  ...
  public int g(Bundle paramBundle)
  {
    ...
    if (bhqz.a((String)localObject))
    {
      localObject = bhqz.a((String)localObject);
      if ((localObject != null) && (!TextUtils.isEmpty(((bhra)localObject).jdField_b_of_type_JavaLangString))) {
        this.jdField_e_of_type_JavaLangString = ((bhra)localObject).jdField_b_of_type_JavaLangString;
      }
    }
    while (TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString))
    {
      ...
      localObject = nko.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
      if (localObject != null) {
        try
        {
          int i = ((nks)localObject).a.available();
          if (i != 0)
          {
            byte[] arrayOfByte = new byte[i];
            if (i == ((nks)localObject).a.read(arrayOfByte)) {
  ...
  public int h(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      if (!TextUtils.isEmpty(paramBundle.getString(tmg.jdField_a_of_type_JavaLangString))) {
        str1 = paramBundle.getString(tmg.jdField_a_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramBundle.getString(tmg.jdField_e_of_type_JavaLangString))) {
        str2 = paramBundle.getString(tmg.jdField_e_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramBundle.getString(tmg.jdField_c_of_type_JavaLangString))) {
        str3 = paramBundle.getString(tmg.jdField_c_of_type_JavaLangString);
      }
      str4 = str1;
      str5 = str2;
      str6 = str3;
      if (!TextUtils.isEmpty(paramBundle.getString(tmg.jdField_d_of_type_JavaLangString)))
      {
        this.jdField_f_of_type_JavaLangString = paramBundle.getString(tmg.jdField_d_of_type_JavaLangString);
        str6 = str3;
        str5 = str2;
        str4 = str1;
      }
  ...
  public int i(Bundle paramBundle)
  {
    if (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString))
    {
      ...
      jdField_b_of_type_ComTencentUtilLRULinkedHashMap.put(this.jdField_a_of_type_JavaLangString, new pmu(this.jdField_e_of_type_JavaLangString, "utf-8", 1800000L));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      pha.a(pha.a(), true, 8);
      pha.a(pha.a(), true, 12, System.currentTimeMillis() - this.jdField_a_of_type_Long);
      d();
      a();
      this.jdField_a_of_type_Int = 1;
      return -1;
      label131:
      jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(this.jdField_a_of_type_JavaLangString, new pmu(this.jdField_e_of_type_JavaLangString, "utf-8"));
    }
  }
