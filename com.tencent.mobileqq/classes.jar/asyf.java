  ...
  implements Manager
{
  ...
  private asyi jdField_a_of_type_Asyi;
  ...
  public asyf(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    asye.b("installTVKSdk");
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(a(), "");
    this.jdField_a_of_type_Asyi = new asyi(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Asyi);
    try
    {
      TVK_SDKMgr.setOnLogListener(new asyg(this));
      ...
      {
        TVK_SDKMgr.installPlugin(this.jdField_a_of_type_AndroidContentContext, new asyh(this));
        return;
      }
      b();
      return;
  ...
  private void a(int paramInt)
  {
    ...
    {
      asye.b("startVideoDownload queueType:" + paramInt);
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr == null)
      {
        asye.b("startVideoDownload cache manager not init!");
        c();
        return;
      }
      if (paramInt <= this.jdField_a_of_type_Int)
      {
        asye.b("startVideoDownload queue(" + this.jdField_a_of_type_Int + ") already run!");
        return;
      }
    }
    if (this.jdField_a_of_type_Int != 0)
    {
      asye.b("startVideoDownload break current queue(" + this.jdField_a_of_type_Int + ")!");
    ...
    for (;;)
    {
      ...
      {
        asye.b("startVideoDownload no task to download");
        c();
        return;
      ...
      else
      {
        ...
        if (!TextUtils.isEmpty(str1)) {
          ...
          {
            i = a(str1);
            asye.b("startVideoDownload vid:" + str1 + ", cacheState:" + i);
            if (i != 2) {
        ...
        for (;;)
        {
          try
          {
            ...
            asye.b("startVideoDownload vid:" + str1);
            return;
          }
          catch (IOException localIOException)
          {
            asye.b("startVideoDownload create tmp file failed for vid:" + str1);
            continue;
          }
          i = bdin.a(BaseApplication.getContext());
          asye.b("startVideoDownload vid:" + str1 + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", curNetType:" + i + ", no valid network, skip to next task");
          b(paramInt);
          continue;
          ...
          b(paramInt);
          continue;
          asye.b("startVideoDownload vid:" + str1 + ", expireTime:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mExpireTime + ", task expired, clean cache and skip to next task");
          b(paramInt);
          if (a(str1) != 0)
          {
            ThreadManager.executeOnFileThread(new ImaxAdVideoPreloadManager.7(this, str1));
            continue;
            asye.b("startVideoDownload empty vid, skip to next task");
            b(paramInt);
          }
        }
        switch (paramInt)
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, awgf paramawgf, amnz paramamnz)
  {
    ...
    {
      asyc.a().a(((nlo)localObject1).jdField_a_of_type_JavaLangString);
      asyc.a().a((nlo)localObject1);
    ...
    else
    {
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramawgf.b((awge)localObject2);
        ajlb.b(paramQQAppInterface, ((MessageRecord)localObject2).frienduin, ((MessageRecord)localObject2).istroop);
        localObject3 = paramamnz.a(paramMessageRecord.frienduin, paramMessageRecord.istroop);
        if (localObject3 != null)
        {
          ajjj.a().a(paramMessageRecord.frienduin + "-" + paramMessageRecord.istroop);
          paramamnz.b((RecentUser)localObject3);
        }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new asyj(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new asyk(this, null));
    }
  ...
  {
    asye.b("continueDownload queueType:" + paramInt);
  ...
  {
    asye.b("clearCacheVideo vid:" + paramString);
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  {
    paramString = asyc.a().a(paramString).iterator();
    while (paramString.hasNext())
    {
      nlo localnlo = (nlo)paramString.next();
      b(localnlo);
      localnlo.jdField_a_of_type_Int = 1;
      asye.b(a(), localnlo.jdField_a_of_type_JavaLangString, localnlo.a());
    }
  }
  ...
  private void d()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask != null)
    {
      azqs.a(null, "dc00898", "", "", "0X8008F77", "0X8008F77", 0, 0, "", "", this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid, String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mSource));
      return;
    }
    azqs.a(null, "dc00898", "", "", "0X8008F77", "0X8008F77", 0, 0, "", "", "", "");
  }
  ...
  {
    if (this.jdField_a_of_type_Int == 0) {
      asye.b("onNetworkChange, no queue is working");
    }
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask == null)
      {
        asye.b("onNetworkChange, no valid task");
        return;
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.isNetworkValid())
      {
        asye.b("onNetworkChange, vid:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", valid network, going on");
        return;
      }
      asye.b("onNetworkChange, vid:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", invalid network, skip to next task");
  ...
  {
    asye.b("loadLocalConfigTaskForImax uin:" + paramString);
    Object localObject3 = asye.a(paramString);
    ??? = new ArrayList();
    Object localObject2 = new ArrayList();
    paramString = a();
    asxz.a().b(asye.a(paramString, "delete_uin_list"));
    Object localObject5;
    if (localObject3 != null)
    {
      asye.b("loadLocalConfigTaskForImax sp size:" + ((Map)localObject3).size());
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        {
          asyc.a().a((nlo)localObject5);
          ((List)???).add(localObject5);
          if ((((nlo)localObject5).c()) || (asxz.a().a(paramString, ((nlo)localObject5).jdField_a_of_type_JavaLangString)))
          {
    ...
    {
      localObject5 = ((amnz)localObject4).a(true);
      int i = 0;
      while (i < ((List)localObject5).size())
      {
        RecentUser localRecentUser = (RecentUser)((List)localObject5).get(i);
        nlo localnlo = asyc.a().b(localRecentUser.uin);
        if ((localRecentUser.getType() == 10005) && (localnlo != null))
        {
          ((List)localObject3).add(localnlo);
          if ((localnlo.c()) || (asxz.a().a(paramString, localnlo.jdField_a_of_type_JavaLangString)))
          {
            ajjj.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
            ((amnz)localObject4).b(localRecentUser);
            ajlb.b(paramQQAppInterface, localRecentUser.uin, 10005);
    ...
    while (paramQQAppInterface.hasNext())
    {
      ...
      asyc.a().a((nlo)localObject4);
      asye.b(paramString, ((nlo)localObject4).jdField_a_of_type_JavaLangString, ((nlo)localObject4).a());
    }
    asye.b("loadLocalConfigTaskForImax recentImaxAdList:" + ((List)localObject3).size() + " expiredImaxAdList:" + ((List)localObject2).size() + " imaxAdList:" + ((List)???).size());
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (paramQQAppInterface.size() > 0)
      {
        ...
        asye.b("loadLocalConfigTaskForImax taskSize:" + paramQQAppInterface.size());
        ThreadManager.executeOnNetWorkThread(new ImaxAdVideoPreloadManager.3(this));
        asxz.a().c(paramString);
        return;
      }
      asye.b("loadLocalConfigTaskForImax tasklist null");
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        localPAAdPreloadTask.mMsgId = bflr.d(localPAAdPreloadTask.mVideoVid);
        localPAAdPreloadTask.mSource = 2;
        ...
        asye.b("handlePreloadTaskFromMessage msgid:" + localPAAdPreloadTask.mMsgId + ", vid:" + localPAAdPreloadTask.mVideoVid + ", add to queue");
        return;
      }
      asye.b("handlePreloadTaskFromMessage msgid:" + localPAAdPreloadTask.mMsgId + ", vid:" + localPAAdPreloadTask.mVideoVid + ", exist in queue, ignore");
    }
  }
  ...
  public void a(nlo paramnlo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          asye.b("handlePreloadTaskFromMessage invalid item");
          return;
        }
        asye.b("handlePreloadTaskFromMessage adItem " + paramnlo.jdField_a_of_type_JavaLangString);
        nlq localnlq = paramnlo.jdField_a_of_type_Nlq;
        ...
        if (!TextUtils.isEmpty(localnlp.b))
        {
          ...
          if (paramnlo.jdField_a_of_type_Long > 0L)
          {
            ...
            asye.b("handlePreloadTaskFromMessage msgid:" + paramnlo.jdField_c_of_type_JavaLangString + ", vid:" + localnlp.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label287:
      asye.b("handlePreloadTaskFromMessage msgid:" + paramnlo.jdField_c_of_type_JavaLangString + ", vid:" + localnlp.b + ", exist in queue, ignore");
    }
  }
  
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    asye.b("processMsg0x210Sub0xfd " + paramInt);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        asxz.a().a(paramArrayOfByte);
        asye.a(a(), "delete_uin_list", asxz.a().a());
        asye.a(a(), "delete_st_" + paramArrayOfByte, String.valueOf(NetConnInfoCenter.getServerTimeMillis()));
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          asxz.a().a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramArrayOfByte);
          return;
        }
      }
  ...
  {
    asye.b("processMsg0x210Sub0xf9 " + paramInt);
    if (paramArrayOfByte == null)
    {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte = asye.a(paramArrayOfByte.bytes_zip_AdInfo.get().toByteArray());
        if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0))
        {
          asye.b("output == null " + paramInt);
          return;
        }
      }
      catch (Exception paramArrayOfByte)
      ...
      if (asxz.a().a(a(), paramArrayOfByte.jdField_a_of_type_JavaLangString))
      {
        asye.b("processMsg0x210Sub0xf9 InDeleteFilter mSenderUin " + paramArrayOfByte.jdField_a_of_type_JavaLangString);
        return;
      }
      asyc.a().a(paramArrayOfByte.jdField_a_of_type_JavaLangString);
      asyc.a().a(paramArrayOfByte);
      asye.b("processMsg0x210Sub0xf9 sp :advertisementItem " + paramArrayOfByte.jdField_a_of_type_JavaLangString);
      asye.b(a(), paramArrayOfByte.jdField_a_of_type_JavaLangString, paramArrayOfByte.a());
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Asyi != null)
    {
      this.jdField_a_of_type_Asyi.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Asyi);
      this.jdField_a_of_type_Asyi = null;
    }
