...
public class asyf
{
  ...
  public static asyf a(mutualmark.MutualMark paramMutualMark)
  {
    asyf localasyf = new asyf();
    localasyf.jdField_a_of_type_Long = paramMutualMark.uint64_type.get();
    localasyf.jdField_b_of_type_Long = paramMutualMark.uint64_level.get();
    localasyf.jdField_a_of_type_Float = paramMutualMark.float_count.get();
    localasyf.jdField_c_of_type_Long = paramMutualMark.uint64_day.get();
    localasyf.jdField_d_of_type_Long = paramMutualMark.uint64_time.get();
    localasyf.f = paramMutualMark.uint64_icon_status.get();
    if (localasyf.f != 2L)
    {
      localasyf.g = 0L;
    ...
    {
      localasyf.jdField_a_of_type_Boolean = bool;
      ...
      if (paramMutualMark != null)
      {
        if (paramMutualMark.bytes_static_url.has()) {
          localasyf.jdField_a_of_type_JavaLangString = paramMutualMark.bytes_static_url.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_dynamic_url.has()) {
          localasyf.jdField_b_of_type_JavaLangString = paramMutualMark.bytes_dynamic_url.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_cartoon_url.has()) {
          localasyf.jdField_c_of_type_JavaLangString = paramMutualMark.bytes_cartoon_url.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_cartoon_md5.has()) {
          localasyf.jdField_d_of_type_JavaLangString = paramMutualMark.bytes_cartoon_md5.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_word.has()) {
          localasyf.jdField_e_of_type_JavaLangString = paramMutualMark.bytes_word.get().toStringUtf8();
        }
      }
      return localasyf;
      ...
      localasyf.g = paramMutualMark.uint64_icon_status_end_time.get();
      break;
    }
  }
