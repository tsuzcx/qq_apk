  ...
  implements View.OnClickListener
{
  ...
  public thi(View paramView, BaseData paramBaseData)
  {
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramBaseData1.mUseSharpPImage = bkwb.a(this.jdField_a_of_type_AndroidViewView.getContext());
      paramBaseData1.mMemoryCacheKeySuffix = "fast_web";
      paramBaseData1 = URLDrawable.getDrawable(usq.a(thh.a(paramBaseData2.jdField_a_of_type_JavaLangString, paramBaseData2), 4), paramBaseData1);
      if (i != 0) {
        a(paramBaseData1);
      }
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new thj(this));
      return;
  ...
  {
    this.jdField_a_of_type_Tgw.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData);
    ...
    for (Object localObject = "2";; localObject = "1")
    {
      ...
      tkj.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8008996", ((JSONObject)localObject).toString());
