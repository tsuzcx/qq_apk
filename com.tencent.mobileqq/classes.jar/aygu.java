  ...
  implements aoys
{
  ...
  public void a(int paramInt, String paramString, apad paramapad)
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.ocr.control", 2, "retCode:" + paramInt + ",sessionId:" + paramString + ",recogResult:" + paramapad);
    }
    paramString = aygt.a(this.a, paramString);
    long l = 0L;
    if (paramString != null) {
    ...
    if (paramString != null)
    {
      ...
      {
        if ((paramInt != 0) || (paramapad == null) || (paramapad.a == null)) {
          break label282;
        }
        paramapad = paramapad.a;
        OcrRecogResult localOcrRecogResult = paramapad.a();
        if (aygt.a(this.a) != null) {
          aygt.a(this.a).a(0, localOcrRecogResult, paramString.a.b, l);
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (aygt.a(this.a) != null)
        {
          aygt.a(this.a).a(3, null, paramString.a.b, l);
          i = m;
          j = k;
        }
      }
