  ...
  extends ProtocolDownloader.Adapter
{
  ...
  public static String a(aihq paramaihq)
  {
    String str = null;
    if (!TextUtils.isEmpty(paramaihq.b())) {
      str = paramaihq.b();
    }
    while (TextUtils.isEmpty(paramaihq.a())) {
      return str;
    }
    return paramaihq.a();
  }
  ...
  {
    return aiin.a(paramString).exists();
  }
  ...
  public boolean hasDiskFile(DownloadParams paramDownloadParams)
  {
    try
    {
      paramDownloadParams = a((aiig)paramDownloadParams.mExtraInfo);
  ...
  {
    paramDownloadParams = a((aihq)paramDownloadParams.mExtraInfo);
    QLog.d("StickerRecDrawableDownLoader", 1, "loadImageFile");
    File localFile1 = aiin.a(paramDownloadParams);
