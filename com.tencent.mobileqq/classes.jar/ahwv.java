...
public class ahwv
{
  private static ahwv jdField_a_of_type_Ahwv;
  ...
  private static final String jdField_d_of_type_JavaLangString = anvx.a(2131709309);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bhyo(paramString1, new File(jdField_c_of_type_JavaLangString + "android_qim_theme_icons.zip"));
        paramString1.f = "profileCardDownload";
        paramString1.e = "VIP_profilecard";
        return bhyq.a(paramString1, null);
      }
  ...
  public static ahwv a()
  {
    if (jdField_a_of_type_Ahwv == null) {
      jdField_a_of_type_Ahwv = new ahwv();
    }
    return jdField_a_of_type_Ahwv;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	ahwv:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	ahwv:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 144	com/tencent/mobileqq/utils/FileUtils:deleteFilesInDirectory	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	ahwv:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   71: invokestatic 326	nwp:a	(Ljava/io/File;Ljava/lang/String;)V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_1
  ...
  public Drawable a(int paramInt)
  {
    ...
    localObject = bheg.a(jdField_b_of_type_JavaLangString + "skin_header_bar.png", localOptions);
    if (localObject != null)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localObject != null)
    {
      localObject = ((anvk)localObject).e(paramSessionInfo.curFriendUin);
      if ((localObject != null) && (((Friends)localObject).netTypeIconId == 11))
      {
        paramSessionInfo.isQimUserOnline = true;
        if (paramSessionInfo.isQimUserOnline)
        {
          ...
          bool1 = true;
          label130:
          paramSessionInfo.isQimUserTitleForm = bool1;
          if ((a(paramQQAppInterface) != 1) || (!bool3)) {
            break label210;
          }
          bool1 = true;
          label151:
          paramSessionInfo.isQimUserOnlineIcon = bool1;
    ...
    {
      paramSessionInfo.isQimUserBubbleForm = bool1;
      return;
      if (a()) {
        break;
      }
  ...
  public void a(ArrayList<ahww> paramArrayList, ArrayList<int[]> paramArrayList1)
  {
  ...
  public boolean a(Object paramObject, SessionInfo paramSessionInfo)
  {
    ...
    {
      bool1 = bool2;
      if (paramSessionInfo.isQimUserBubbleForm) {
        bool1 = true;
      }
    }
    return bool1;
  ...
  {
    if ((!paramBoolean) && ((!(paramObject instanceof ahit)) || ((paramObject instanceof ahjd)))) {}
    do
    {
      return false;
  ...
  public Drawable b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        localBitmap = bheg.a(jdField_b_of_type_JavaLangString + "skin_aio_qim_header_flag.png", (BitmapFactory.Options)localObject3);
        localObject1 = localObject2;
        if (localBitmap != null)
        {
          ...
          if (localBitmap == null)
          {
            localObject1 = bheg.a(jdField_b_of_type_JavaLangString + "title_bg_round.9.png", (BitmapFactory.Options)localObject3);
          ...
          if (localObject2 == null)
          {
            localBitmap = bheg.a(jdField_b_of_type_JavaLangString + "aio_qim_online_icon.png", (BitmapFactory.Options)localObject3);
            localObject1 = localObject2;
            if (localBitmap != null)
            {
              localObject1 = new BitmapDrawable(localBitmap);
              ...
              {
                localObject2 = bheg.a(jdField_b_of_type_JavaLangString + "qim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bheg.a(jdField_b_of_type_JavaLangString + "aio_qim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
