public final class ahwv
{
  ...
  public ahwv(int paramInt1, int paramInt2)
  {
    this.a = paramInt1;
    this.b = paramInt2;
  }
  ...
  public static ahwv a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ahwv localahwv = new ahwv(Integer.parseInt(paramString.substring(0, i)), Integer.parseInt(paramString.substring(i + 1)));
        return localahwv;
      }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while (!(paramObject instanceof ahwv));
    paramObject = (ahwv)paramObject;
