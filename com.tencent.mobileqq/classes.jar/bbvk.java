...
public class bbvk
{
  private bbvi jdField_a_of_type_Bbvi = new bbvi();
  private String jdField_a_of_type_JavaLangString;
  private String b;
  
  public static bbvk a()
  {
    return bbvm.a;
  }
  ...
  private List<String> a(QQAppInterface paramQQAppInterface)
  {
    ...
    localArrayList.add(ajsd.aW + paramQQAppInterface + File.separator);
  ...
  private void a(String paramString)
  {
    ...
    {
      paramString = new File(bbvj.a(paramString));
  ...
  {
    boolean bool = false;
    if (BaseApplicationImpl.sApplication.getSharedPreferences("StepUpdate", 4).getInt("vfs_version", 0) < 9) {
      bool = true;
    }
  ...
  private void b()
  {
    BaseApplicationImpl.sApplication.getSharedPreferences("StepUpdate", 4).edit().putInt("vfs_version", 9).apply();
    if (QLog.isColorLevel()) {
      QLog.d("VFSRegisterProxy", 2, "initConfig updateSP is called, version = 9");
    }
  }
  ...
  private void c(Context paramContext)
  {
    ...
    Iterator localIterator = bbvn.a.iterator();
  ...
  private void d()
  {
    for (;;)
    {
      try
      {
        File[] arrayOfFile = new File(ajsd.aW).listFiles();
        if (arrayOfFile == null) {
          return;
        }
  ...
  public final void a()
  {
    Iterator localIterator = bbvn.b.iterator();
    while (localIterator.hasNext()) {
  ...
  public void a(Context paramContext)
  {
    b(paramContext);
    if (QLog.isColorLevel()) {
      QLog.d("VFSRegisterProxy", 2, "initConfig start!");
    }
    VFSTrack.track(null, "track_init_config");
    try
    {
      if (a())
      {
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        this.jdField_a_of_type_Bbvi.reportError(paramContext);
        QLog.e("VFSRegisterProxy", 1, paramContext, new Object[0]);
      }
    }
    VFSTrack.track("track_init_config", null);
    if (QLog.isColorLevel()) {
      QLog.d("VFSRegisterProxy", 2, "initConfig end!");
    }
  }
  ...
  public void b(Context paramContext)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      FileSystemManager.setStatisticsCallback(this.jdField_a_of_type_Bbvi);
    }
  }
}
