  ...
  extends DialogFromBottom
{
  ...
  static
  {
    jdField_a_of_type_Atdc = new atdc(null);
  }
  
  public atdb(@NotNull Context paramContext, @Nullable QQAppInterface paramQQAppInterface, @Nullable String paramString, int paramInt)
  {
    super(paramContext);
  ...
  public final void a(@NotNull Context paramContext, @Nullable QQAppInterface paramQQAppInterface, @Nullable String paramString, int paramInt)
  {
    ...
    {
      Object localObject = LayoutInflater.from(paramContext).inflate(2131561180, null);
      if (localObject == null) {
        throw new TypeCastException("null cannot be cast to non-null type android.widget.LinearLayout");
      }
      localObject = (LinearLayout)localObject;
      ((ImageView)((LinearLayout)localObject).findViewById(2131369419)).setOnClickListener((View.OnClickListener)new atdd(this, paramContext, paramString, paramQQAppInterface, paramInt));
      setOnCancelListener((DialogInterface.OnCancelListener)atdf.a);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((LinearLayout)localObject).findViewById(2131379761));
      ((Button)((LinearLayout)localObject).findViewById(2131363740)).setOnClickListener((View.OnClickListener)new atde(this, paramContext, paramString, paramQQAppInterface, paramInt));
      paramContext = ((LinearLayout)localObject).findViewById(2131364666);
