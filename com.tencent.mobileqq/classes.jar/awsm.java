...
class awsm
  extends Handler
{
  public awsm(Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      if (awsl.a() == null) {
        awsl.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/" + "com.tencent.mobileqq".replace(".", File.separator) + "/battery/");
      }
      awsl.b(awsl.a() + awsl.b() + "_" + awsl.a() + ".log");
      awsl.c(awsl.a() + awsl.b() + "_" + awsl.a() + ".rpt");
      paramMessage = new File(awsl.a());
      Object localObject1 = new File(awsl.c());
      localObject3 = new File(awsl.d());
      try
      {
        ...
        awsl.a(new BufferedWriter(new FileWriter((File)localObject1), 8192));
        ((File)localObject3).createNewFile();
        awsl.b(new BufferedWriter(new FileWriter((File)localObject3), 8192));
        localObject1 = null;
        ...
        awsl.b(new Object[] { "header", localObject3, AppSetting.g(), "pub", localObject1, Build.MANUFACTURER, Build.MODEL, Integer.valueOf(Build.VERSION.SDK_INT), Long.valueOf(awsl.a()), "1.3" });
        return;
      }
    ...
    else
    {
      ...
      {
        if (awsl.a() == null) {
          awsl.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/");
        }
        label824:
        for (;;)
        {
          try
          {
            localObject2 = new File(awsl.a()).listFiles();
            ...
            try
            {
              long l = awsl.a((File)localObject3);
