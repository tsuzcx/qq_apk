...
public class nqu
  extends ajtd
{
  public nqu(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.bindlist.has()))
    {
      ...
      if ((paramArrayOfByte != null) && (!paramArrayOfByte.isEmpty()))
      {
        ...
        {
          nqq.a.put(String.valueOf(paramArrayOfByte.puin.get()), String.valueOf(paramArrayOfByte.binduin.get()));
  ...
  public void a(String paramString)
  {
    ...
    paramString = new NewIntent(this.app.getApp(), nqw.class);
