  ...
  extends trj
{
  ...
  public tps(String paramString1, String paramString2, boolean paramBoolean)
  {
    a(false, true);
  ...
  public void a()
  {
    ...
    localtnq.jdField_c_of_type_Int = 1;
    ...
    localtnq.b = arrayOfString[1];
    localtnq.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    syr.a().a(localtnq, new tpt(this, arrayOfString));
  }
