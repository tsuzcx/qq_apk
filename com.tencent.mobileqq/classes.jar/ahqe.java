...
public class ahqe
  implements ahpr, Handler.Callback
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bfum(ThreadManager.getSubThreadLooper(), this);
  private int b;
  
  public ahqe(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ahqs paramahqs)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade = ((QQMessageFacade)paramQQAppInterface.getManager(20));
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 1010) {
        this.b = 2;
      } else if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 10002) {
        this.b = 3;
      }
    }
  }
  ...
  {
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800524B", "0X800524B", 0, 0, String.valueOf(paramInt), "", "", "");
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (this.b == 0) {}
    for (String str = "0";; str = "1")
    {
      bcef.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "exp_oper", 0, 0, str, "", "", "");
      return this.jdField_a_of_type_Ahqs.a(this, paramVarArgs);
    }
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    for (paramVarArgs = paramVarArgs[0].toString();; paramVarArgs = null)
    {
      ...
      {
        MessageRecord localMessageRecord = bbli.a(-2027);
        long l = bbko.a();
        String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        localMessageRecord.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, str, paramVarArgs, l, -2027, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, l);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return false;
            if ((this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a()) && (!this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a(bbko.a() * 1000L))) {
              break;
            }
            return false;
            l1 = bbko.a() * 1000L;
            long l2 = System.currentTimeMillis();
            paramMessage = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getAIOList(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
        ...
        } while (bblk.a(paramMessage.msgtype));
      ...
      while (!TextUtils.isEmpty(paramMessage))
      {
        ...
        if (localGrayTipsConfig.sceneId == 4)
        {
          ...
          else
          {
            ...
            paramMessage.text = amtj.a(2131706328);
            paramMessage.highlightText = amtj.a(2131706327);
          }
      ...
      paramMessage = this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade.getAIOList(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
      ...
      if (!bfwr.b(((ChatMessage)localObject).issend)) {
        break label1201;
      }
      localObject = this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade.getLastMessage(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
    } while (bfwr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (QQMessageFacade.Message)localObject));
    ...
    if (paramMessage != null)
    {
      ...
      if (bblk.a(((ChatMessage)paramMessage.next()).msgtype)) {
        break label1348;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (paramMessage = this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.c(this.b, this.jdField_a_of_type_Int, l1);; paramMessage = null)
      {
        ...
        if (bblk.a(((ChatMessage)localObject).msgtype)) {
          break;
        }
