...
class akvx
  implements bdui
{
  akvx(akvv paramakvv, List paramList, String paramString1, String paramString2, int paramInt) {}
  ...
  public boolean a(String paramString, ApolloBaseInfo paramApolloBaseInfo)
  {
    ...
    {
      int i = aknx.a(ApolloUtil.a(), this.jdField_a_of_type_JavaLangString, true);
      int j = aknx.a(ApolloUtil.a(), this.b, true);
