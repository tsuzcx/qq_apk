...
public class yae
{
  ...
  private yaf jdField_a_of_type_Yaf;
  
  public yae(Activity paramActivity, yaf paramyaf)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Yaf = paramyaf;
  }
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    wjz.a(paramActivity, i, paramIntent);
  }
  ...
  public static void c(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      yqp.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handleOpenTagAction parm error");
      return;
    }
    xfv.a(paramActivity, str, paramIntent);
  }
  
  public static void d(Activity paramActivity, Intent paramIntent)
  {
    paramIntent = (String)((wpf)wpm.a(10)).b("mainHallConfig", "");
    if (!TextUtils.isEmpty(paramIntent)) {}
    for (;;)
    {
      try
      {
        ...
        yqp.d("Q.qqstory.home.QQStoryHomeJumpHelper", "square config not ready , use default config instead");
        return;
      }
      catch (Exception paramIntent)
      {
        yqp.d("Q.qqstory.home.QQStoryHomeJumpHelper", "analyze config error , error :%s", new Object[] { paramIntent.getMessage() });
      }
      paramIntent = "";
    }
  ...
  private void e(Intent paramIntent)
  {
    ...
    bgmp.c(QQStoryContext.a(), this.jdField_a_of_type_AndroidAppActivity, paramIntent, str);
  }
  ...
  private void h(Intent paramIntent)
  {
    ...
    wjz.a(this.jdField_a_of_type_AndroidAppActivity, 23, str);
  }
  ...
  {
    yqp.b("Q.qqstory.home.QQStoryHomeJumpHelper", "handleAction=" + paramInt);
    switch (paramInt)
    {
    case 3: 
    default: 
    ...
    case 1: 
      ...
      this.jdField_a_of_type_Yaf.a(false, true, 16, null);
      return true;
    case 2: 
      a(paramIntent);
      return true;
  ...
  protected void b(Intent paramIntent)
  {
    ...
    if (((wsm)QQStoryContext.a().getManager(252)).a) {
  ...
  protected void c(Intent paramIntent)
  {
    ...
    if (paramIntent == null)
    {
      yqp.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handle open play list error , no play info !");
      return;
    }
    xho.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, 31, null);
  }
