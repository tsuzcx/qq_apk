...
public class bnyy
{
  private static volatile bnyy jdField_a_of_type_Bnyy;
  ...
  private CopyOnWriteArrayList<WeakReference<bnyx>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  {
    if (jdField_a_of_type_Bnyy == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Bnyy == null) {
        jdField_a_of_type_Bnyy = new bnyy();
      }
      return jdField_a_of_type_Bnyy;
    }
  }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(BaseApplicationImpl.getApplication(), bnyw.class);
  ...
  private void a(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bnyx localbnyx = (bnyx)((WeakReference)localObject).get();
      if (localbnyx != null)
      {
        localObject = localbnyx.getFilterCmds();
        if ((localObject == null) || (((HashSet)localObject).contains(paramString)))
        {
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "notifyListeners cmd=" + paramString + ",ret=" + paramLong + ",listener=" + localbnyx);
          }
          localbnyx.onCmdRsp(paramIntent, paramString, paramLong, paramJSONObject);
        }
      }
      else
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bihq.a() == 1)
        {
          ...
          localJSONObject4 = new JSONObject();
          localJSONObject4.put("status", bhim.a(BaseApplicationImpl.getContext()));
          localJSONObject3.put("screen", localJSONObject4);
          localJSONObject4 = new JSONObject();
          long[] arrayOfLong = bhlo.b();
  ...
  public void a(bnyx parambnyx)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "addListener listener=" + parambnyx);
    }
    if (parambnyx == null) {
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      bnyx localbnyx = (bnyx)((WeakReference)localIterator.next()).get();
      if ((localbnyx != null) && (localbnyx == parambnyx)) {
        return;
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "addListener listener=" + parambnyx + " succ");
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(parambnyx));
  }
  ...
  public void a(WadlParams paramWadlParams, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("clientver", "8.4.5");
  ...
  public void a(String paramString1, String paramString2, bkar parambkar, String paramString3)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "reportDC appRuntime=" + localAppRuntime + ",dcId=" + paramString3 + ",operId=" + paramString1 + ",operType=" + paramString2 + ",reportInfo=" + parambkar);
    }
    if (parambkar == null) {
      return;
    }
    for (;;)
    {
      ...
      try
      {
        localWadlParams = parambkar.jdField_a_of_type_CooperationWadlIpcWadlParams;
        if (TextUtils.isEmpty(jdField_b_of_type_JavaLangString)) {
          jdField_b_of_type_JavaLangString = String.valueOf(bhlo.e());
        }
        ...
        localJSONObject3.put("apk_volume", String.valueOf(parambkar.jdField_a_of_type_Long));
        int j = nnr.a();
        if (j < 0) {
          break label1042;
        }
        ...
        localJSONObject3.put("net_type", antf.c[i]);
        ...
        localJSONObject3.put("ret_id", String.valueOf(parambkar.jdField_a_of_type_Int));
        if (localWadlParams != null)
        {
          ...
          localJSONObject3.put("ext31", parambkar.jdField_b_of_type_JavaLangString);
          localJSONObject3.put("ext32", parambkar.d);
          localJSONObject3.put("ext36", parambkar.a());
          localJSONObject3.put("ext37", bkar.jdField_a_of_type_JavaLangString);
          if (!TextUtils.isEmpty(parambkar.jdField_c_of_type_JavaLangString)) {
            localJSONObject3.put("ext48", parambkar.jdField_c_of_type_JavaLangString);
          }
          localJSONObject3.put("ext49", String.valueOf(parambkar.jdField_b_of_type_Long));
          localJSONObject3.put("ext50", parambkar.i);
          if (localWadlParams != null)
          {
            ...
            paramString1 = "1";
            localJSONObject3.put("ext41", paramString1);
            ...
            paramString1 = "1";
            localJSONObject3.put("ext10", paramString1);
          }
          if (!TextUtils.isEmpty(parambkar.f)) {
            localJSONObject3.put("ext45", parambkar.f);
          }
          if (!TextUtils.isEmpty(parambkar.g)) {
            localJSONObject3.put("ext42", parambkar.g);
          }
          if (!TextUtils.isEmpty(parambkar.h)) {
            localJSONObject3.put("ext43", parambkar.h);
          }
  ...
  public void a(String paramString, JSONObject paramJSONObject, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(BaseApplicationImpl.getApplication(), bnyw.class);
  ...
  public void b(bnyx parambnyx)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "removeListener listener=" + parambnyx);
    }
    if (parambnyx == null) {
      return;
    }
    ...
    do
    {
      ...
      bnyx localbnyx = (bnyx)localWeakReference.get();
      if ((localbnyx == null) || (localbnyx != parambnyx)) {
        break;
      }
      bool = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localWeakReference);
    } while (!QLog.isColorLevel());
    QLog.d(jdField_a_of_type_JavaLangString, 1, "removeListener listener=" + parambnyx + " " + bool);
  }
