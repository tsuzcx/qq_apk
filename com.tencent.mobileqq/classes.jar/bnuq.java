...
public class bnuq
{
  ...
  private static bnuq jdField_a_of_type_Bnuq;
  ...
  public static bnuq a()
  {
    if (jdField_a_of_type_Bnuq == null) {}
    try
    {
      if (jdField_a_of_type_Bnuq == null) {
        jdField_a_of_type_Bnuq = new bnuq();
      }
      return jdField_a_of_type_Bnuq;
    }
    finally {}
  }
  ...
  public void a(bnuv parambnuv)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambnuv.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bnur(this, parambnuv));
  }
  ...
  public void b(bnuv parambnuv)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambnuv.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bnus(this, parambnuv));
  }
}
