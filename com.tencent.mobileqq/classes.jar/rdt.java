  ...
  public HashMap<String, String> a()
  {
    ...
    for (String str = "";; str = this.jdField_a_of_type_JavaLangString)
    {
      ...
      if (this.jdField_a_of_type_Int == 2)
      {
        ...
        localHashMap.put("param_device_info", rug.a());
      }
      ...
      localHashMap.put("param_version", "8.4.8.4810");
      localHashMap.put("param_subversion", "8.4.8");
      ...
      localHashMap.put("param_prepareOptimizeConfigJson", pay.n());
      localHashMap.put("param_httpbuffertime_for_playpreload", String.valueOf(bkwm.g()));
      localHashMap.put("param_dynamic_buffer_switch", String.valueOf(bkwm.h()));
      localHashMap.put("param_dynamic_buffer_config_json", bkwm.c());
      ...
      localHashMap.put("param_isSuperPlayer", String.valueOf(shg.a.a()));
      ...
      localHashMap.put("param_codecReuseConfigVersion", String.valueOf(rse.a.a()));
      localHashMap.put("param_codecReuseDeviceSupport", String.valueOf(rse.a.a()));
