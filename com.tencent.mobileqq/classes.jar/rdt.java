...
public class rdt
  extends rbp
{
  public rdt(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp a()
  {
    ...
    return c(this.jdField_a_of_type_Szd, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder).q().l().n().h().j();
  }
  ...
  public rbp d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null)
    {
      ...
      localRelativeLayout2.setLayoutParams(new LinearLayout.LayoutParams(-1, AIOUtils.dp2px(86.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      ...
      localRelativeLayout2.setOnClickListener(new rdu(this));
