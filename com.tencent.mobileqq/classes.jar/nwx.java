...
public class nwx
{
  ...
  public nwx(int paramInt1, int paramInt2, BaseCommentData paramBaseCommentData, ArticleInfo paramArticleInfo)
  {
  ...
  public nwx(int paramInt, BaseCommentData paramBaseCommentData, ArticleInfo paramArticleInfo)
  {
  ...
  private CharSequence a(SubCommentData paramSubCommentData)
  {
    ...
    if (paramSubCommentData.hasTarget())
    {
      ...
      if (!TextUtils.isEmpty(paramSubCommentData.repliedUserNickname))
      {
        ...
        localSpannableStringBuilder.setSpan(new nxa(this, paramSubCommentData), i, localSpannableStringBuilder.length(), 33);
        localSpannableStringBuilder.append("：");
      }
    }
    String str = awbk.b(paramSubCommentData.commentContent);
  ...
  private String a(int paramInt)
  {
    ...
    default: 
      return "";
    case 1: 
      return ajjy.a(2131636421);
    }
    return ajjy.a(2131636423);
  }
  ...
  private void a(SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    paramSpannableStringBuilder.setSpan(new nxc(this, null), i, paramSpannableStringBuilder.length(), 33);
  }
  ...
  private void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString1, String paramString2, String paramString3, BaseCommentData paramBaseCommentData)
  {
    ...
    paramSpannableStringBuilder.setSpan(new nxb(this, paramBaseCommentData, paramString2, paramString3), i, paramSpannableStringBuilder.length(), 33);
  }
  ...
  public void a()
  {
    ...
    Object localObject2;
    label514:
    for (this.jdField_a_of_type_JavaLangCharSequence = new axkd(awbk.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentContent), 7, this.d);; this.jdField_a_of_type_JavaLangCharSequence = new axkd(a((SubCommentData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData), 7, this.d))
    {
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData instanceof CommentData))
      {
      ...
      while ((i < j) && ((this.c == null) || (this.c.size() <= 2)))
      {
        ...
        if ((localObject1 != null) && (((SubCommentData)localObject1).isAuthorReply()))
        {
          ...
          {
            a((SpannableStringBuilder)localObject2, ((SubCommentData)localObject1).nickName, ((SubCommentData)localObject1).uin, new nuj(this).a().a(), (BaseCommentData)localObject1);
          ...
          if (!TextUtils.isEmpty(((SubCommentData)localObject1).repliedUserNickname))
          {
            ...
            a((SpannableStringBuilder)localObject2, ((SubCommentData)localObject1).repliedUserNickname, ((SubCommentData)localObject1).repliedUserUin, new nuj(this).a().b(((SubCommentData)localObject1).repliedUserUin).a(), (BaseCommentData)localObject1);
          }
          if (!TextUtils.isEmpty(((SubCommentData)localObject1).commentContent))
          {
            ...
            ((SpannableStringBuilder)localObject2).append(new axkd(awbk.b(((SubCommentData)localObject1).commentContent) + str, 7, this.d));
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(((SubCommentData)localObject1).nickName))
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new nwy(this, (SubCommentData)localObject1), 0, ((SpannableStringBuilder)localObject2).length(), 33);
      }
      if ((((SubCommentData)localObject1).hasTarget()) && (!TextUtils.isEmpty(((SubCommentData)localObject1).repliedUserNickname)))
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new nwz(this, (SubCommentData)localObject1), k, ((SpannableStringBuilder)localObject2).length(), 33);
      }
      this.jdField_a_of_type_JavaUtilList.add(localObject2);
      if (!TextUtils.isEmpty(((SubCommentData)localObject1).commentContent))
      {
        localObject2 = a(((SubCommentData)localObject1).getCommentMediaType());
        localObject1 = new axkd(awbk.b(((SubCommentData)localObject1).commentContent) + (String)localObject2, 7, this.d);
