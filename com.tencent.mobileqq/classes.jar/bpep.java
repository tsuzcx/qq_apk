  ...
  implements IEventReceiver
{
  ...
  private SimpleObserver<bpsf> jdField_a_of_type_ComTribeAsyncReactiveSimpleObserver;
  ...
  protected List<bpen> a;
  protected Map<Class<? extends bpeo>, bpeo> a;
  ...
  private void D()
  {
    ...
    {
      yqp.c("Q.qqstory.publish.edit.EditVideoPartManager", "reportPublish()  entranceType=" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c() + " , isEditCamera:" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c());
    ...
    for (int j = 1;; j = 2)
    {
      ...
      try
      {
        localJSONObject1.put("lens_id", boke.jdField_b_of_type_JavaLangString);
      ...
      aaxb.a("mystatus_edit", "post_clk", i, 0, new String[] { String.valueOf(j), "", localJSONObject1.toString(), localJSONObject2.toString() });
      return;
      i = 2;
      break;
    }
  ...
  private void E()
  {
    if ((this.jdField_a_of_type_Bpfx == null) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null)) {
  ...
  private boolean a(bpsf parambpsf)
  {
    if (parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.doodlePath != null) {}
    do
    {
      do
      {
        return true;
      } while (parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.doodleRawPath != null);
      if (parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.atJsonData != null)
      {
        yqp.c("Q.qqstory.publish.edit.EditVideoPartManager", "HAS AT LABELS.");
        return true;
      }
    } while ((parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.backgroundMusicPath != null) || (parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.isMuteRecordVoice) || (parambpsf.jdField_b_of_type_Boolean) || (parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.saveMode != 0));
    return false;
  }
  ...
  private void b(EditVideoParams.EditSource paramEditSource, Observer<bpsf> paramObserver)
  {
    bpsf localbpsf = new bpsf(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
    localbpsf.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_upload_temp_directory");
    if (localbpsf.jdField_b_of_type_JavaLangString == null) {
      localbpsf.jdField_b_of_type_JavaLangString = bpsy.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int);
    }
    ...
    label140:
    for (localbpsf.jdField_a_of_type_Bpsl = new bpsl((String)((EditLocalGifSource)paramEditSource).a.get(0));; localbpsf.jdField_a_of_type_Bpsl = new bpsl(paramEditSource.a()))
    {
      paramEditSource = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramEditSource.hasNext()) {
        ((bpen)paramEditSource.next()).a(0, localbpsf);
      }
    }
    a(localbpsf);
    b(localbpsf);
    yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "PUBLISH start, Folder = %s", new Object[] { localbpsf.jdField_b_of_type_JavaLangString });
    this.jdField_a_of_type_Bpfx.a(anni.a(2131702628), false, 500L);
    Stream.of(localbpsf).map(new bpsi((bozw)a(bozw.class), null, true)).map(new ThreadOffFunction("Q.qqstory.publish.edit.EditVideoPartManager", 2)).map(new bpsw(bpao.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(paramObserver);
  }
  ...
  private void c(int paramInt)
  {
    ...
    if (a())
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_slide_show_video", false)) {
        yqu.a("video_edit", "pub_slides", 0, 0, new String[0]);
      }
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      Bosses.get().postJob(new bpet(this, "Q.qqstory.publish.edit.EditVideoPartManager"));
      break;
      paramInt = 0;
      break label51;
      str1 = "1";
  ...
  private void c(bpsf parambpsf)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = bncu.a(bncu.jdField_c_of_type_Int);
    ...
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("has_game_pk_filter", Boolean.valueOf(true));
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("game_pk_video_path", ((PKFilter)localObject).getPKVideoPath());
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("game_pk_cover_path", ((PKFilter)localObject).getPKCoverPath());
    parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("game_pk_result_path", ((PKFilter)localObject).getPKTitleBmgPath());
    yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "put pk encode config at manager : video=" + ((PKFilter)localObject).getPKVideoPath() + ",pkCover=" + ((PKFilter)localObject).getPKCoverPath() + " pk result=" + ((PKFilter)localObject).getPKTitleBmgPath());
  }
  
  private void c(EditVideoParams.EditSource paramEditSource, Observer<bpsf> paramObserver)
  {
    Object localObject = new bpsf(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
    ((bpsf)localObject).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMaxrate = bcjb.r;
    ((bpsf)localObject).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMinrate = bcjb.s;
    ((bpsf)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_upload_temp_directory");
    if (((bpsf)localObject).jdField_b_of_type_JavaLangString == null) {
      ((bpsf)localObject).jdField_b_of_type_JavaLangString = bpsy.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int);
    }
    ((bpsf)localObject).jdField_a_of_type_Bpsl = new bpsl(paramEditSource.a());
    paramEditSource = this.jdField_a_of_type_JavaUtilList.iterator();
    while (paramEditSource.hasNext()) {
      ((bpen)paramEditSource.next()).a(0, (bpsf)localObject);
    }
    a((bpsf)localObject);
    b((bpsf)localObject);
    yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "PUBLISH start, Folder = %s", new Object[] { ((bpsf)localObject).jdField_b_of_type_JavaLangString });
    this.jdField_a_of_type_Bpfx.a(anni.a(2131702617), false, 500L);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(1);
    this.jdField_b_of_type_JavaUtilList.clear();
    paramEditSource = Stream.of(localObject).map(new ThreadOffFunction("Q.qqstory.publish.edit.EditVideoPartManager", 2)).map(new bpsw(false)).map(new bptb());
    localObject = this.jdField_a_of_type_Bpfx.getActivity();
    ...
    {
      localObject = paramEditSource.map(new bpsm((Activity)localObject, i));
      paramEditSource = (EditVideoParams.EditSource)localObject;
      if (this.jdField_a_of_type_Bpcv != null) {
        paramEditSource = ((Stream)localObject).map(this.jdField_a_of_type_Bpcv.a(0));
      }
      localObject = paramEditSource;
      if (this.jdField_a_of_type_Bpca != null) {
        localObject = paramEditSource.map(this.jdField_a_of_type_Bpca.a(0));
      }
      ((Stream)localObject).map(new bpsx()).map((StreamFunction)wjz.a(bpsd.class, new Object[0])).map(new bpta(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams)).map(new UIThreadOffFunction(this)).subscribe(paramObserver);
      return;
    }
  }
  ...
  public void B()
  {
    if (this.jdField_a_of_type_Bpcv != null)
    {
      DoodleLayout localDoodleLayout = this.jdField_a_of_type_Bpcv.a();
      if (localDoodleLayout != null) {
        localDoodleLayout.a.e();
      }
      if (this.jdField_a_of_type_Bpcv != null) {
        this.jdField_a_of_type_Bpcv.s();
      }
    }
  }
  ...
  public void C()
  {
    if (this.jdField_a_of_type_Bpej != null) {
      this.jdField_a_of_type_Bpej.b(false);
    }
  }
  ...
  public int a()
  {
    ...
    {
      if (this.jdField_a_of_type_Bpdr == null) {
        throw new IllegalStateException("mEditVideoFragment is null");
      }
      return this.jdField_a_of_type_Bpdr.a();
    }
    return 0;
  }
  ...
  public int a(@NonNull Message paramMessage)
  {
    ...
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "broadcast message ignore because of publishing");
      return 0;
    }
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    int i = 0;
    ...
    {
      if (!((bpen)localIterator.next()).b(Message.obtain(paramMessage))) {
        break label94;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      break;
      if (i == 0) {
        yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "broadcastEditVideoMessage, but no one handled", new Object[] { paramMessage });
      }
  ...
  public long a()
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        {
          throw new RuntimeException(anni.a(2131702679));
        }
        break;
      case 1: 
        return l / 2L;
  ...
  public long a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b()) && (a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Long, 262144)))
    {
      ...
      if (localObject != null)
      {
        l2 = ((bpez)localObject).a(paramInt);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        default: 
          ...
          {
            throw new RuntimeException(anni.a(2131702682));
          }
          break;
        case 1: 
          return l1 / 2L;
  ...
  View a()
  {
    if (this.jdField_a_of_type_Bpcg != null) {
      return this.jdField_a_of_type_Bpcg.a();
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bpcg != null) {
      return this.jdField_a_of_type_Bpcg.a(paramLong);
    }
    return null;
  }
  ...
  public bpcg a()
  {
    return this.jdField_a_of_type_Bpcg;
  }
  
  public bpcv a()
  {
    return this.jdField_a_of_type_Bpcv;
  }
  ...
  public bpeo a(Class<? extends bpeo> paramClass)
  {
    ...
    return (bpeo)this.jdField_a_of_type_JavaUtilMap.get(paramClass);
  }
  ...
  {
    if (this.jdField_a_of_type_Bpej != null) {
      return this.jdField_a_of_type_Bpej.a();
    }
    return null;
  }
  ...
  protected SimpleObserver<bpsf> a()
  {
    ...
    return new bpeu(this, SystemClock.uptimeMillis());
  }
  ...
  public zhp a()
  {
    if (this.jdField_a_of_type_Bpfp != null) {
      return this.jdField_a_of_type_Bpfp.a();
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    Intent localIntent = this.jdField_a_of_type_Bpfx.getActivity().getIntent();
    if (!this.jdField_b_of_type_Boolean)
    {
      if ((bnqb.a(localIntent, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())) || (bnqb.c(localIntent)))
      {
        if (this.jdField_a_of_type_Bpfx.getActivity() != null) {
          break label190;
        }
        localObject = "";
      }
      for (;;)
      {
        ...
        return;
        label190:
        if (this.jdField_a_of_type_Bpfx.getActivity().getIntent() == null) {
          localObject = "";
        } else if (this.jdField_a_of_type_Bpfx.getActivity().getIntent().getBundleExtra("state") == null) {
          localObject = "";
        } else {
          localObject = this.jdField_a_of_type_Bpfx.getActivity().getIntent().getBundleExtra("state").getString("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH");
        }
      }
    }
    ...
    if (((localEditSource instanceof EditRecordVideoSource)) || ((localEditSource instanceof EditLocalVideoSource)) || ((localEditSource instanceof EditTakeVideoSource)))
    {
      ...
      if ((localEditSource instanceof EditLocalVideoSource)) {
        yqu.a("video_edit", "pub_local", 0, 1, new String[0]);
      }
    }
    for (;;)
    {
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    ...
    if (localbpez != null)
    {
      if (!(localbpez instanceof HWEditLocalVideoPlayer)) {
        break label43;
      }
      ((HWEditLocalVideoPlayer)localbpez).a(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
    }
    label43:
    while (!(localbpez instanceof bpgi)) {
      return;
    }
    ((bpgi)localbpez).a(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bpen)localIterator.next()).a(paramInt1, paramInt2, paramIntent);
    }
  }
  ...
  public final void a(int paramInt, Object paramObject)
  {
    ...
    if ((this.jdField_a_of_type_Int != paramInt) || (paramInt == 5) || (paramInt == 39))
    {
      if (this.jdField_a_of_type_Boolean) {
        yqp.b("Q.qqstory.publish.edit.EditVideoPartManager", "change state while state changing, " + paramInt + " oldState:" + this.jdField_a_of_type_Int, new Throwable());
      }
      this.jdField_a_of_type_Boolean = true;
      yqp.b("Q.qqstory.publish.edit.EditVideoPartManager", "changeState : %s => %s", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(paramInt));
      int i = this.jdField_a_of_type_Int;
      this.jdField_a_of_type_Int = paramInt;
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext()) {
        ((bpen)localIterator.next()).a(i, this.jdField_a_of_type_Int, paramObject);
      }
    }
  ...
  {
    if (this.jdField_a_of_type_Bpcv != null) {
      this.jdField_a_of_type_Bpcv.a().a(paramInt, paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bpcv != null) {
      this.jdField_a_of_type_Bpcv.a(paramLong);
    }
  }
  ...
  public void a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (a())
      {
        localObject = "2";
        label81:
        b("clk_publish", j, 0, new String[] { localObject, String.valueOf(l), String.valueOf(i), biub.a(paramContext) });
  ...
  void a(Intent paramIntent, int paramInt, PublishParam paramPublishParam, TribeVideoPublishParams paramTribeVideoPublishParams)
  {
    ...
    case 101: 
      ...
      this.jdField_a_of_type_Bpfx.getActivity().startActivityForResult(paramIntent, 10004);
    ...
    case 11: 
      ...
      if (localIterator.hasNext())
      {
        ...
        if (!(localbpen instanceof bozq)) {
          break label399;
        }
        paramInt = ((bozq)localbpen).a();
        paramPublishParam = ((bozq)localbpen).a();
      }
      break;
    }
    label399:
  ...
  public void a(Bundle paramBundle)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bpen)localIterator.next()).a(paramBundle);
    }
  }
  ...
  {
    p();
    if ((parambpfx == null) || (paramEditVideoParams == null)) {
      throw new IllegalArgumentException("both ui ant params should not be null");
    }
    if ((this.jdField_a_of_type_Bpfx != parambpfx) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams != paramEditVideoParams))
    {
    ...
    {
      ((bpen)paramEditVideoParams.next()).a(parambpfx);
      continue;
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "duplicate attachUiAndParams ui=%s, params=%s", new Object[] { parambpfx, paramEditVideoParams });
    }
  }
  
  public void a(bpsf parambpsf)
  {
    Object localObject = parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.readerConfBytes;
    if ((localObject == null) || (localObject.length == 0))
    {
      ...
      parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.readerConfBytes = ((qqstory_struct.VideoReaderConf)localObject).toByteArray();
    }
  }
  
  public void a(EditVideoParams.EditSource paramEditSource, Observer<bpsf> paramObserver)
  {
    ...
    if ((paramEditSource instanceof EditRecordVideoSource))
    {
      ...
      bcjb.y = (int)((EditRecordVideoSource)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_Long;
      bcjb.z = ((EditRecordVideoSource)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_Int;
      bcjb.x = 0;
      bcjb.E = 0;
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter != null) {}
      for (i = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter.a();; i = 0)
      {
        ...
        localObject1 = null;
        if (this.jdField_a_of_type_Bpdr != null) {
          localObject1 = this.jdField_a_of_type_Bpdr.a();
        }
        ...
        while (((Iterator)localObject1).hasNext()) {
          localArrayList.add(Integer.valueOf(((bphc)((Iterator)localObject1).next()).jdField_c_of_type_Int));
        }
      }
    }
    ...
    throw new IllegalArgumentException(anni.a(2131702623) + paramEditSource);
    ...
    if (m < localArrayList.size())
    {
      ...
      c(n);
      localObject1 = new bpsf(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
      ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.multiFragmentGroupId = str3;
      ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.createTime = (m * 1000 + l);
      ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMaxrate = bcjb.r;
      if (bclh.f())
      {
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMaxrate = (bclh.b() * 1000);
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("composite_key_bitrate_mode", Boolean.valueOf(bclh.f()));
      }
      ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMinrate = bcjb.s;
      ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoUploadGroupTempDir = str4;
      ((bpsf)localObject1).jdField_b_of_type_JavaLangString = bpsy.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int);
      ...
      {
        bool2 = true;
        ((bpsf)localObject1).jdField_a_of_type_Bpsn = new bpsn((Activity)localObject2, i, j, str1, f, bool2, k, 0.0D, 0.0D, str2, bool1);
        if ((!(paramEditSource instanceof EditTakeVideoSource)) && (!(paramEditSource instanceof EditLocalVideoSource))) {
          break label1147;
        }
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("is_hw_encode", Boolean.valueOf(true));
      }
      for (;;)
      {
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("thumb_rotation", Integer.valueOf(k));
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("composite_key_capturemode", Integer.valueOf(g()));
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("composite_key_entrance", Integer.valueOf(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c()));
        c((bpsf)localObject1);
        localObject2 = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject2).hasNext()) {
          ((bpen)((Iterator)localObject2).next()).a(n, (bpsf)localObject1);
        }
        bool2 = false;
        break;
        label1147:
        ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("is_hw_encode", Boolean.valueOf(false));
      }
      localObject2 = ((bpsf)localObject1).jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_text_filter_text");
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        if (TextUtils.isEmpty(((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoDoodleDescription)) {
          ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoDoodleDescription = ((String)localObject2);
        }
      }
      else
      {
        ...
        a((bpsf)localObject1);
        b((bpsf)localObject1);
        yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "PUBLISH start, Folder = %s", new Object[] { ((bpsf)localObject1).jdField_b_of_type_JavaLangString });
        this.jdField_a_of_type_Bpfx.a(anni.a(2131702566), false, 500L);
        localObject2 = Stream.of(localObject1).map(new ThreadOffFunction("Q.qqstory.publish.edit.EditVideoPartManager", 2));
        if (((bpsf)localObject1).jdField_a_of_type_Int != 1) {
          break label1684;
        }
        ...
        localObject1 = new bpss(null, (bpez)a(bpez.class), n);
        label1339:
        localObject2 = ((Stream)localObject2).map((StreamFunction)localObject1);
        localObject1 = localObject2;
        if (this.jdField_a_of_type_Bpcv != null)
        {
          localObject1 = ((Stream)localObject2).map(this.jdField_a_of_type_Bpcv.a(n));
          if ((this.jdField_a_of_type_Bpcv.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a()) && (c() == 0L)) {
            break label1813;
          }
          localObject1 = ((Stream)localObject1).map(new bpsh(this.jdField_a_of_type_Bpcv, (bozx)a(bozx.class), n));
        }
      }
    }
    label1684:
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bpca != null) {
        localObject2 = ((Stream)localObject1).map(this.jdField_a_of_type_Bpca.a(n));
      }
      localObject1 = localObject2;
      Object localObject3;
      if (this.jdField_a_of_type_Bpec != null)
      {
        localObject3 = this.jdField_a_of_type_Bpec.a(n);
        localObject1 = localObject2;
      ...
      if (((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))) {}
      for (localObject1 = ((Stream)localObject1).map(new bpst());; localObject1 = ((Stream)localObject1).map(new bpsx()).map((StreamFunction)wjz.a(bpsd.class, new Object[0])))
      {
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a() == 14) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_AndroidOsBundle.putInt("VIDEO_STORY_JUMP_TO_TYPE", bnqb.b(this.jdField_a_of_type_Bpfx.getActivity().getIntent()));
        }
        ((Stream)localObject1).map(new bpta(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams)).map(new UIThreadOffFunction(this)).subscribe(paramObserver);
        m += 1;
        break;
        localObject3 = new StringBuilder();
        PublishVideoEntry localPublishVideoEntry = ((bpsf)localObject1).jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry;
        localPublishVideoEntry.videoDoodleDescription += (String)localObject2;
        break label1211;
        label1659:
        localObject1 = new bpso(null, (bpez)a(bpez.class), n);
        break label1339;
        if (((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
        {
          localObject1 = new bpss(null, (bpez)a(bpez.class), 0);
          break label1339;
        }
        localObject1 = new bpso();
        break label1339;
      }
      paramEditSource = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramEditSource.hasNext()) {
        ((bpen)paramEditSource.next()).aT_();
      }
      break;
    }
  }
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    {
      localObject = new bozq(this, l);
      this.jdField_a_of_type_Bpcg = ((bpcg)localObject);
      localArrayList.add(localObject);
      if ((!bnqb.a(this.jdField_a_of_type_Bpfx.getActivity().getIntent(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())) && (!bnqb.c(this.jdField_a_of_type_Bpfx.getActivity().getIntent())))
      {
        localObject = new bpaz(this);
        this.jdField_a_of_type_Bpaz = ((bpaz)localObject);
        localArrayList.add(localObject);
      }
      localObject = new bozv(this);
      this.jdField_a_of_type_Bozv = ((bozv)localObject);
      localArrayList.add(localObject);
      ...
      if (a(l, 2))
      {
        ...
        localArrayList.add(new aayr(this));
      }
      label257:
      if ((paramEditVideoParams.b()) && (bonv.jdField_a_of_type_Boolean))
      {
        localObject = new bpbh(this);
        this.jdField_a_of_type_Bpbh = ((bpbh)localObject);
        localArrayList.add(localObject);
        if (a(l, 16777216)) {
          this.jdField_a_of_type_Bpbh.jdField_a_of_type_Boolean = true;
        }
      }
      if (a(l, 1024))
      {
        localObject = new bpca(this);
        this.jdField_a_of_type_Bpca = ((bpca)localObject);
        localArrayList.add(localObject);
      }
      if ((a(l, 536870912)) || (a(l, 1)) || (a(l, 8)))
      {
        localObject = new bpcv(this, l);
        ...
        localArrayList.add(localObject);
        if ((a(l, 274877906944L)) && (paramEditVideoParams.jdField_a_of_type_Int == 1) && (((DynamicTextConfigManager)bojv.a(7)).c()))
        {
      ...
      if (a(l, 256))
      {
        ...
        localObject = new bpfm(this, a(l, 2097152));
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter = ((EditVideoFilter)localObject);
        localArrayList.add(localObject);
      }
      if (a(l, 512))
      {
        localObject = new bped(this);
        this.jdField_a_of_type_Bped = ((bped)localObject);
        localArrayList.add(localObject);
      }
      ...
      if (a(l, 8192))
      {
        if (!bnqb.c(this.jdField_a_of_type_Bpfx.getActivity().getIntent())) {
          break label1882;
        }
      ...
      if (a(l, 32768))
      {
        localObject = new bozy(this);
        this.jdField_a_of_type_Bozy = ((bozy)localObject);
        localArrayList.add(localObject);
      }
      if (a(l, 131072))
      {
      ...
      if (a(l, 1048576))
      {
        localObject = new bpfl(this);
        this.jdField_a_of_type_Bpfl = ((bpfl)localObject);
        localArrayList.add(localObject);
      }
      if ((paramEditVideoParams.b()) && (a(l, 262144)))
      {
        localObject = new bpdr(this);
        this.jdField_a_of_type_Bpdr = ((bpdr)localObject);
        localArrayList.add(localObject);
      }
      if (a(l, 8388608))
      {
      ...
      if (a(l, 134217728))
      {
        localObject = new bpel(this);
        this.jdField_a_of_type_Bpel = ((bpel)localObject);
        localArrayList.add(localObject);
      }
      if (a(l, 16))
      {
        localObject = new bpfw(this);
        this.jdField_a_of_type_Bpfw = ((bpfw)localObject);
        localArrayList.add(localObject);
      }
      if (a(l, 33554432))
      {
      ...
      if (a(l, 4294967296L))
      {
        localObject = new bpcq(this, l);
        this.jdField_a_of_type_Bpcq = ((bpcq)localObject);
        localArrayList.add(localObject);
      }
      if ((bnqb.c.a(paramEditVideoParams.f)) && ((paramEditVideoParams.c()) || (paramEditVideoParams.a()) || (paramEditVideoParams.b())))
      {
        localObject = new bptt(this);
        this.jdField_a_of_type_Bptt = ((bptt)localObject);
        localArrayList.add(localObject);
      }
      if (a(paramEditVideoParams.jdField_a_of_type_Long, 8589934592L))
      {
        localObject = new bpdn(this, l);
        this.jdField_a_of_type_Bpdn = ((bpdn)localObject);
        localArrayList.add(localObject);
      }
      ...
      {
        localObject = new bpbu(this);
        this.jdField_a_of_type_Bpbu = ((bpbu)localObject);
        localArrayList.add(localObject);
      }
      if (a(l, 16384))
      {
        ...
        yqp.e("Q.qqstory.publish.edit.EditVideoPartManager", " curType have not set but it use BUSINESS_QQ ID, that is illegal!!");
      }
    }
    for (;;)
    {
      ...
      paramEditVideoParams = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramEditVideoParams.hasNext()) {
        yqp.a("Q.qqstory.publish.edit.EditVideoPartManager", "initEditVideoParts : %s", ((bpen)paramEditVideoParams.next()).getClass().getSimpleName());
      }
      if (paramEditVideoParams.jdField_a_of_type_Int == 12)
      {
        localObject = new ovl(this, l);
        this.jdField_a_of_type_Bpcg = ((bpcg)localObject);
        localArrayList.add(localObject);
        break;
      }
      if (paramEditVideoParams.jdField_a_of_type_Int == 14)
      {
        localObject = new bpfn(this);
        this.jdField_a_of_type_Bpfn = ((bpfn)localObject);
        localArrayList.add(localObject);
        break;
      }
      localObject = new bpcg(this, l);
      this.jdField_a_of_type_Bpcg = ((bpcg)localObject);
      localArrayList.add(localObject);
      break;
      label1690:
      ...
      if (paramEditVideoParams.d())
      {
        ...
        localArrayList.add(new bpgi(this));
        break label188;
      }
      ...
      localObject = new bpex(this);
      this.jdField_a_of_type_Bpex = ((bpex)localObject);
      localArrayList.add(localObject);
      break label188;
      label1823:
      localObject = new bomv(this, false);
      this.jdField_a_of_type_Bomv = ((bomv)localObject);
      localArrayList.add(localObject);
      break label257;
      label1853:
      ...
      break label612;
      label1882:
      if (!bnqb.a(this.jdField_a_of_type_Bpfx.getActivity().getIntent(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()))
      {
        localObject = new bpff(this);
        this.jdField_a_of_type_Bpff = ((bpff)localObject);
        localArrayList.add(localObject);
        break label793;
      }
      localObject = new bpau(this);
      ...
      break label793;
      label1965:
      this.jdField_a_of_type_Bozs = new bozs(this, i, true);
  ...
  public void a(Class<? extends bpeo> paramClass, bpeo parambpeo)
  {
    ...
    if (!paramClass.isInstance(parambpeo)) {
      throw new IllegalArgumentException("the 2nd parameter's type " + parambpeo.getClass().getName() + " is not instance of " + paramClass.getName());
    }
    bpeo localbpeo = (bpeo)this.jdField_a_of_type_JavaUtilMap.get(paramClass);
    if (localbpeo == null) {
      yqp.b("Q.qqstory.publish.edit.EditVideoPartManager", "publishEditExport for %s with %s", paramClass.getSimpleName(), parambpeo);
    }
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilMap.put(paramClass, parambpeo);
      return;
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "publishEditExport for %s replace %s by %s", new Object[] { paramClass.getSimpleName(), localbpeo, parambpeo });
    }
  }
  ...
  public void a(Error paramError)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bpen)localIterator.next()).a(paramError);
    }
    ...
    do
    {
      ...
      QQToast.a(this.jdField_a_of_type_Bpfx.a(), anni.a(2131702548), 0).a();
      paramError = (bpez)a(bpez.class);
  ...
  public void a(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      blsb.e(this.jdField_a_of_type_Bpfx.getActivity(), localblsi, localBundle, -1);
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 1) {
      Bosses.get().postJob(new bper(this, "Q.qqstory.publish.edit.EditVideoPartManager", paramString, paramInt1, paramInt2, paramVarArgs));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bpcv != null) {
      this.jdField_a_of_type_Bpcv.a(paramMap);
    }
  }
  ...
  public void a(boolean paramBoolean, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    if (localbpez != null)
    {
      ...
      ((HWEditLocalVideoPlayer)localbpez).a(paramBoolean, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
    }
    label41:
    while (!(localbpez instanceof bpgi)) {
      return;
    }
    ((bpgi)localbpez).a(paramBoolean, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
  }
  ...
  public long b()
  {
    ...
    else
    {
      ...
      throw new RuntimeException(anni.a(2131702591));
    }
    return l;
  }
  ...
  public void b(Bundle paramBundle)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bpen)localIterator.next()).b(paramBundle);
    }
    ...
    if (l != 0L)
    {
      ...
      if (((ArrayList)localObject).size() > 0) {
        try
        {
          ...
          byte[] arrayOfByte = parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.spreadGroupBytes;
          if (arrayOfByte != null) {}
          try
          {
            localVideoSpreadGroupList.mergeFrom(parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.spreadGroupBytes);
            localVideoSpreadGroupList.group_list.set((List)localObject);
            localVideoSpreadGroupList.visibility_type.set(4);
            localVideoSpreadGroupList.setHasFlag(true);
            parambpsf.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.spreadGroupBytes = localVideoSpreadGroupList.toByteArray();
            return;
          }
  ...
  {
    Bosses.get().postJob(new bpes(this, "Q.qqstory.publish.edit.EditVideoPartManager", paramString, paramInt1, paramInt2, paramVarArgs));
  }
  ...
  public long c()
  {
    if (this.jdField_a_of_type_Bpcq != null) {
      return this.jdField_a_of_type_Bpcq.jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void c(boolean paramBoolean)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bpen)localIterator.next()).h_(paramBoolean);
    }
  }
  ...
  public int d()
  {
    int i = 0;
    if (this.jdField_a_of_type_Bpcv != null) {
      i = this.jdField_a_of_type_Bpcv.a(a());
    }
    int j = i;
  ...
  public long d()
  {
    if ((this.jdField_a_of_type_Bpfx instanceof EditVideoActivity)) {
      return ((EditVideoActivity)this.jdField_a_of_type_Bpfx).jdField_a_of_type_Long;
    }
    if ((this.jdField_a_of_type_Bpfx instanceof EditPicActivity)) {
      return ((EditPicActivity)this.jdField_a_of_type_Bpfx).jdField_a_of_type_Long;
    }
    return -1L;
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Bpcv != null)
    {
      Object localObject = this.jdField_a_of_type_Bpcv.a();
      if (localObject != null) {
        ((DoodleLayout)localObject).j();
      }
      localObject = this.jdField_a_of_type_Bpcv.a().a();
      int i = k;
      if (localObject != null)
      {
        i = k;
        if (((bphy)localObject).a.a())
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqstory.publish.edit.EditVideoPartManager", 2, "preparePublish");
          }
          this.jdField_a_of_type_Bpfx.a(anni.a(2131702515), false, 500L);
          this.jdField_a_of_type_Bpcv.jdField_a_of_type_Int = 2;
          this.jdField_a_of_type_Bpcv.a().o();
          i = 1;
        }
      }
      localObject = this.jdField_a_of_type_Bpcv.a().a();
  ...
  void d(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bomv == null) {
        continue;
      }
      return;
      i = 1;
  ...
  public boolean d()
  {
    if ((this.jdField_a_of_type_Bpej != null) && (this.jdField_a_of_type_Bpej.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpfc });
      return true;
    }
    if ((this.jdField_a_of_type_Bpfy != null) && (this.jdField_a_of_type_Bpfy.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpfc });
      return true;
    }
    if ((this.jdField_a_of_type_Bpfc != null) && (this.jdField_a_of_type_Bpfc.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpfc });
      return true;
    }
    if ((this.jdField_a_of_type_Bpfa != null) && (this.jdField_a_of_type_Bpfa.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpfa });
      return true;
    }
    if ((this.jdField_a_of_type_Bpfp != null) && (this.jdField_a_of_type_Bpfp.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpfp });
      return true;
    }
    if ((this.jdField_a_of_type_Bpga != null) && (this.jdField_a_of_type_Bpga.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpga });
      return true;
    }
    if ((this.jdField_a_of_type_Bpqd != null) && (this.jdField_a_of_type_Bpqd.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpqd });
      return true;
    }
    if ((this.jdField_a_of_type_Bpec != null) && (this.jdField_a_of_type_Bpec.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpec });
      return true;
    }
    if ((this.jdField_a_of_type_Bomv != null) && (this.jdField_a_of_type_Bomv.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bomv });
      return true;
    }
    if ((this.jdField_a_of_type_Bped != null) && (this.jdField_a_of_type_Bped.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bped });
      return true;
    }
    if ((this.jdField_a_of_type_Bpcv != null) && (this.jdField_a_of_type_Bpcv.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpcv });
      return true;
    }
    if ((this.jdField_a_of_type_Bpap != null) && (this.jdField_a_of_type_Bpap.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpap });
      return true;
    }
    ...
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter });
      return true;
    }
    if ((this.jdField_a_of_type_Bozy != null) && (this.jdField_a_of_type_Bozy.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bozy });
      return true;
    }
    if ((this.jdField_a_of_type_Bpcq != null) && (this.jdField_a_of_type_Bpcq.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpcq });
      return true;
    }
    if ((this.jdField_a_of_type_Bpcg != null) && (this.jdField_a_of_type_Bpcg.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpcg });
      return true;
    }
    if ((this.jdField_a_of_type_Bpfn != null) && (this.jdField_a_of_type_Bpfn.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bpfn });
      return true;
    }
    if ((this.jdField_a_of_type_Bptt != null) && (this.jdField_a_of_type_Bptt.a()))
    {
      yqp.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Bptt });
      return true;
    }
    e();
    return true;
  ...
  public int e()
  {
    if (this.jdField_a_of_type_Bpdr != null)
    {
      List localList = this.jdField_a_of_type_Bpdr.a();
      if (localList != null) {
  ...
  public void e()
  {
    ...
    if (a())
    {
      ...
      yqv.a("0X80076B6");
      yqv.b("0X80075C2");
      yqv.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a(), "0X8007823");
      if (this.jdField_a_of_type_Bpcv == null) {
        break label349;
      }
    }
    label312:
    label349:
    for (int j = this.jdField_a_of_type_Bpcv.b();; j = 0)
    {
      int i = j;
      if (this.jdField_a_of_type_Bped != null)
      {
        i = j;
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Bped.a())) {
          i = j + 1;
        }
      }
      j = i;
      if (this.jdField_a_of_type_Bpap != null) {
        j = i + this.jdField_a_of_type_Bpap.jdField_a_of_type_Int;
      }
      i = j;
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter != null)
      {
      ...
      yqp.a("Q.qqstory.publish.edit.EditVideoPartManager", "tryQuitRecordUI, current is preview state, edit count = %d", Integer.valueOf(i));
      if (i < 3)
      {
        c();
        return;
      ...
      if (a())
      {
        ...
        str = anni.a(2131702626);
      }
      for (;;)
      {
        bkho localbkho = bkho.a(this.jdField_a_of_type_Bpfx.a(), false);
        localbkho.a(str);
        localbkho.a(anni.a(2131702670), 3);
        localbkho.d(anni.a(2131702588));
        localbkho.a(new bpeq(this, localbkho));
        localbkho.show();
        return;
        str = "1";
        break;
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.e()) || (this.jdField_d_of_type_Boolean)) {
          str = anni.a(2131702686);
        } else {
          str = anni.a(2131702662);
        }
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bpcg != null) {
      this.jdField_a_of_type_Bpcg.b(paramBoolean);
    }
  }
  
  public boolean e()
  {
    return (this.jdField_a_of_type_Bptt != null) && (this.jdField_a_of_type_Bptt.jdField_a_of_type_Boolean);
  }
  ...
  public void f()
  {
    ...
    {
      return;
      a(this.jdField_a_of_type_Bpfx.a());
      a();
      localObject1 = this.jdField_a_of_type_Bpfx.getActivity();
      ...
      default: 
        ...
        bncn.a(this.jdField_a_of_type_Bpfx.a());
        localObject2 = zgl.a();
      }
    } while (localObject2 == null);
    Object localObject1 = ((zgl)localObject2).a();
    ...
    for (;;)
    {
      ...
      int k = ((zgl)localObject2).a();
      localObject2 = this.jdField_a_of_type_Bpfx.getActivity().getIntent();
      int j;
      ...
      for (;;)
      {
        ...
        for (k = 0;; k = 1)
        {
          yqu.a("video_edit_slides", "clk_pub", k, 0, new String[] { yqu.a(j) + "", ((List)localObject1).size() + "", m - i + "", i + "" });
          return;
  ...
  public void j()
  {
    ...
    this.jdField_a_of_type_AndroidOsBundle = bojm.a((Intent)localObject);
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bpen)localIterator.next()).a();
    }
    if ((bnqb.a((Intent)localObject, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())) || (bnqb.c((Intent)localObject)))
    {
      bqcd.c(this.jdField_a_of_type_Bpfx.getActivity());
    ...
    if (a())
    {
      ...
      jdField_a_of_type_Bqer = new bqer();
    }
    label236:
    do
    {
      ...
      localObject = "1";
      break;
      localObject = this.jdField_a_of_type_Bpfx.getActivity().findViewById(2131374013);
  ...
  public void o()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext()) {
        ((bpen)localIterator.next()).g();
      }
      i();
    }
    if ((jdField_a_of_type_Bqer != null) && (!bcli.c())) {
      jdField_a_of_type_Bqer.a();
    }
    bpye.a().b();
  ...
  {
    if (this.jdField_a_of_type_Bpcv != null) {
      this.jdField_a_of_type_Bpcv.a().k();
    }
    a(19);
    if (zgl.a().b() == 22)
    {
  ...
  {
    int j = 0;
    Object localObject = this.jdField_a_of_type_Bpap;
    ((bpap)localObject).jdField_a_of_type_Int += d();
    ...
    {
      return;
      localObject = this.jdField_a_of_type_Bpcv.a();
      ((DoodleLayout)localObject).i();
      bphy localbphy = ((DoodleLayout)localObject).a();
      i = j;
      if (localbphy != null)
      {
        i = j;
        if (localbphy.a.a())
        {
          this.jdField_a_of_type_Bpfx.a(anni.a(2131702583), false, 500L);
          this.jdField_a_of_type_Bpcv.jdField_a_of_type_Int = 3;
  ...
  {
    this.jdField_a_of_type_Bpfx.b();
    Object localObject3 = this.jdField_a_of_type_Bpcv.a();
    Object localObject1 = ((DoodleLayout)localObject3).a(0);
    Object localObject2 = ((DoodleLayout)localObject3).b(0);
    this.jdField_a_of_type_Bpap.jdField_a_of_type_ArrayOfInt[0] = localObject1[0];
    this.jdField_a_of_type_Bpap.jdField_a_of_type_ArrayOfInt[1] = localObject1[1];
    this.jdField_a_of_type_Bpap.jdField_a_of_type_ArrayOfInt[2] = localObject2[0];
    this.jdField_a_of_type_Bpap.jdField_a_of_type_ArrayOfInt[3] = localObject2[1];
    this.jdField_a_of_type_Bpap.jdField_a_of_type_ArrayOfInt[4] = ((DoodleLayout)localObject3).a().b();
    localObject2 = a();
    ...
    this.jdField_a_of_type_Bpap.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject1);
    a(11);
  }
  ...
  {
    if (this.jdField_a_of_type_Bpcv != null) {
      this.jdField_a_of_type_Bpcv.a().l();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bpcv != null) {
      this.jdField_a_of_type_Bpcv.a().s();
    }
  }
