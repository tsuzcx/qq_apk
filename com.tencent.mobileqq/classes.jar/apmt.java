...
public class apmt
{
  ...
  public apmt()
  {
    this.jdField_a_of_type_Apcq = new apmx(this, 0, true, true, 3000L, true, false, "QQARScan");
  }
  ...
  private void a(int paramInt, apnt paramapnt)
  {
    QLog.i("AREngine_ARCloudControl", 1, "requestToCheckLBSLocation.");
    this.jdField_a_of_type_Apnt = paramapnt;
    ...
    this.jdField_a_of_type_ComTencentMobileqqArModelArLBSActivity = apnt.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions, paramapnt);
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new apmy(this), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
  ...
  private void a(apny paramapny)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Apmf.a(paramapny, new apmw(this, l1, paramapny));
      return;
    }
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Apmf != null)
    {
      ...
      this.jdField_a_of_type_Apmf.a(paramString, paramInt1, paramInt2, new apmu(this));
    }
  }
  ...
  private void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList)
  {
    if (this.jdField_a_of_type_Apnm != null)
    {
      ...
      this.jdField_a_of_type_Apnm.a(paramArrayOfByte, paramArrayList, new apmv(this, localapny), this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    long l1;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Apna != null))
    {
      l1 = System.currentTimeMillis();
      bool1 = this.jdField_a_of_type_Apna.a(paramArrayOfByte);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Apmz.c(bool1);
      QLog.i("AREngine_ARCloudControl", 1, "isSameSceneWithBestImg = " + bool1 + " cost time:" + (System.currentTimeMillis() - l1) + "ms");
    }
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Apna == null)) {
      return;
    }
    ...
    if (this.jdField_a_of_type_Apmz != null) {
      this.jdField_a_of_type_Apmz.b();
    }
    this.jdField_c_of_type_Long = System.currentTimeMillis();
    boolean bool1 = this.jdField_a_of_type_Apna.a(paramArrayOfByte, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    ...
    if (this.jdField_a_of_type_Apmz != null)
    {
      boolean bool2 = this.jdField_a_of_type_Apmz.a();
      l1 = this.jdField_a_of_type_Apmz.a();
      if ((bool1) && (!this.jdField_m_of_type_Boolean) && (bool2))
      {
        ...
        i1 = 0;
        bool1 = false;
        this.jdField_a_of_type_Apmz.a(bool1);
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Apmz != null) {
          this.jdField_a_of_type_Apmz.b(true);
        }
        if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Apmz != null))
        {
          l1 = this.jdField_a_of_type_Apmz.b();
          apkz.a().a(l1, this.jdField_l_of_type_Long, this.jdField_m_of_type_Long, this.jdField_a_of_type_Apna.jdField_c_of_type_Int);
          apem.a().a(l1, this.jdField_m_of_type_Long);
  ...
  public boolean a(apmz paramapmz, AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, ARCommonConfigInfo paramARCommonConfigInfo)
  {
    long l2 = System.currentTimeMillis();
    jdField_k_of_type_Boolean = a();
    appv.a().b(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
    if (!jdField_k_of_type_Boolean) {
      return false;
    }
    this.jdField_a_of_type_Apna = new apna(apna.jdField_b_of_type_Int);
    this.jdField_a_of_type_Apnm = new apnm();
    this.jdField_a_of_type_Apna.a(BaseApplicationImpl.getContext().getApplicationContext());
    ...
    this.jdField_a_of_type_Apmf = new apmf(paramAppInterface, true);
    this.jdField_a_of_type_Apmf.a();
    ...
    for (long l1 = ARRecognition.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions);; l1 = 0L)
    {
      ...
      appv.a().c(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
      return true;
    }
  }
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_Apna.a();
      this.jdField_a_of_type_Apna = null;
    }
    if (this.jdField_a_of_type_Apnm != null)
    {
      this.jdField_a_of_type_Apnm.b();
      this.jdField_a_of_type_Apnm = null;
    }
    this.jdField_a_of_type_Apmz = null;
