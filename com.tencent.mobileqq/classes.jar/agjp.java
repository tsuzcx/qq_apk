  ...
  implements akrb
{
  ...
  private akqn jdField_a_of_type_Akqn;
  protected alsi a;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new agjv(this);
  private Handler jdField_a_of_type_AndroidOsHandler = new bhow(ThreadManager.getSubThreadLooper(), this.jdField_a_of_type_AndroidOsHandler$Callback);
  ...
  public agjp(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new agjq(this);
    this.jdField_a_of_type_Alsi = new agjs(this);
    ((akji)paramQQAppInterface.getManager(153)).a().a(this);
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      if (paramInt2 > 86400)
      {
        paramString = (int)Math.ceil(paramInt2 / 86400.0D) + alpo.a(2131702425);
    ...
    for (;;)
    {
      ...
      if (paramInt2 > 3600)
      {
        paramString = (int)Math.ceil(paramInt2 / 3600.0D) + alpo.a(2131702429);
        break;
      }
      paramString = (int)Math.ceil(paramInt2 / 60.0D) + alpo.a(2131702423);
      break;
      this.ac = true;
      this.jdField_f_of_type_AndroidWidgetTextView.setText(alpo.a(2131720302));
      if (this.jdField_a_of_type_MqqOsMqqHandler != null)
      {
        this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(16777215);
  ...
  private void a(String paramString, agkc paramagkc, int paramInt)
  {
    boolean bool;
    if (paramInt == 4)
    {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "[updateFriendAndShield] friUin:" + paramString + ", " + paramagkc.toString());
      }
      ...
      if ((!TextUtils.isEmpty(paramagkc.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity != null) && (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent() != null))
      {
    ...
    } while (paramagkc.jdField_c_of_type_Int == 4);
    label204:
    this.h = ((RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558826, null));
    this.h.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView = ((CornerImageView)this.h.findViewById(2131368675));
    this.o = ((TextView)this.h.findViewById(2131378839));
    this.jdField_p_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131363495));
    this.jdField_q_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131379033));
    this.jdField_a_of_type_ComTencentMobileqqApolloLightGameDotPollingView = ((DotPollingView)this.h.findViewById(2131365463));
    this.jdField_r_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131363494));
    this.jdField_s_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131378917));
    this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)this.h.findViewById(2131368892));
    this.l = ((TextView)this.h.findViewById(2131378598));
    this.i = ((RelativeLayout)this.h.findViewById(2131375871));
    this.m = ((TextView)this.h.findViewById(2131378647));
    this.n = ((TextView)this.h.findViewById(2131378619));
    if ((paramagkc.jdField_a_of_type_Int <= 0) && (TextUtils.isEmpty(paramagkc.jdField_c_of_type_JavaLangString)) && (paramagkc.jdField_b_of_type_Int <= 0))
    {
      this.n.setVisibility(0);
      label743:
      this.l.setText(paramagkc.jdField_a_of_type_Int + alpo.a(2131702427));
      this.m.setText(paramagkc.jdField_c_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setRadius(aekt.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setImageURL(paramagkc.d);
      if (!TextUtils.isEmpty(paramagkc.jdField_a_of_type_JavaLangString)) {
        break label1253;
      }
      this.o.setText(paramagkc.e);
      label840:
      this.jdField_p_of_type_AndroidWidgetTextView.setBackgroundDrawable(akqq.a(this.jdField_a_of_type_AndroidContentContext, aekt.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), "#000000"));
      this.jdField_p_of_type_AndroidWidgetTextView.setTextColor(akqq.a(Color.parseColor("#ffec00"), Color.parseColor("#80ffec00")));
      this.jdField_r_of_type_AndroidWidgetTextView.setBackgroundDrawable(akqq.a(this.jdField_a_of_type_AndroidContentContext, aekt.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(23.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), "#000000"));
      this.jdField_r_of_type_AndroidWidgetTextView.setTextColor(akqq.a(Color.parseColor("#ffec00"), Color.parseColor("#80ffec00")));
      ...
      if (paramagkc.jdField_c_of_type_Int != 1) {
        break label1267;
      }
      this.jdField_p_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameDotPollingView.setVisibility(0);
      ...
      this.jdField_s_of_type_AndroidWidgetTextView.setVisibility(8);
      label1043:
      paramString = new RelativeLayout.LayoutParams(-1, aekt.a(66.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      paramString.addRule(3, 2131375812);
      if (!this.I) {
        break label1368;
      }
    }
    label1368:
    for (paramString.topMargin -= aekt.a(3.0F, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources());; paramString.topMargin = 0)
    {
      this.m.getViewTreeObserver().addOnPreDrawListener(new agka(this, paramagkc));
      this.jdField_d_of_type_AndroidViewViewGroup.addView(this.h, paramString);
      if (((this.jdField_a_of_type_Aelz.a().size() != 0) && (!(this.jdField_a_of_type_Aelz.a().get(0) instanceof MessageForCmGameTips))) || (this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips == null)) {
        break;
      }
      ...
      return;
      if (paramagkc.jdField_a_of_type_Int > 0) {
        this.l.setVisibility(0);
      }
      if (!TextUtils.isEmpty(paramagkc.jdField_c_of_type_JavaLangString)) {
        this.i.setVisibility(0);
      }
      if ((paramagkc.jdField_b_of_type_Int != 1) && (paramagkc.jdField_b_of_type_Int != 2)) {
        break label743;
      }
      this.jdField_p_of_type_AndroidWidgetImageView.setVisibility(0);
      break label743;
      label1253:
      this.o.setText(paramagkc.jdField_a_of_type_JavaLangString);
      break label840;
      label1267:
      if (paramagkc.jdField_c_of_type_Int == 2)
      {
        this.jdField_p_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_q_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_ComTencentMobileqqApolloLightGameDotPollingView.setVisibility(8);
  ...
  private void a(List<akrc> paramList, int paramInt)
  {
    if (paramList == null) {
      return;
    }
    int j = aekt.a(7.0F, a().getResources());
    if (bdcb.a() <= 2.0F) {
      j = aekt.a(9.0F, a().getResources());
    }
    akrc localakrc = akqu.a(paramInt);
    if (localakrc != null)
    {
      paramList.add(localakrc);
      return;
    }
    switch (paramInt)
    {
    ...
    case 0: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 1;
      localakrc.jdField_a_of_type_JavaLangCharSequence = alpo.a(2131702418);
      paramList.add(localakrc);
      return;
    case 7: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 7;
      localakrc.jdField_a_of_type_JavaLangCharSequence = new baig(baiy.c(193), 3, j);
      paramList.add(localakrc);
      return;
    case 6: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 6;
      localakrc.jdField_a_of_type_JavaLangCharSequence = alpo.a(2131702433);
      paramList.add(localakrc);
      return;
    case 5: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 5;
      localakrc.jdField_a_of_type_JavaLangCharSequence = alpo.a(2131702428);
      paramList.add(localakrc);
      return;
    case 4: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 4;
      localakrc.jdField_a_of_type_JavaLangCharSequence = new baig(baiy.c(209), 3, j);
      paramList.add(localakrc);
      return;
    case 3: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 3;
      localakrc.jdField_a_of_type_JavaLangCharSequence = alpo.a(2131702426);
      paramList.add(localakrc);
      return;
    case 2: 
      localakrc = new akrc();
      localakrc.jdField_a_of_type_Int = 2;
      localakrc.jdField_a_of_type_JavaLangCharSequence = new baig(baiy.c(192), 3, j);
      paramList.add(localakrc);
      return;
    }
    localakrc = new akrc();
    localakrc.jdField_a_of_type_Int = 1;
    localakrc.jdField_a_of_type_JavaLangCharSequence = alpo.a(2131702417);
    paramList.add(localakrc);
  }
  ...
  private void bu()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (new Random().nextBoolean()) && (akrd.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      akqu localakqu = ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a();
      int j = (int)(System.currentTimeMillis() / 1000L);
      this.jdField_r_of_type_Int = j;
      this.jdField_s_of_type_Int = j;
      localakqu.a(this.jdField_a_of_type_Akqn.jdField_a_of_type_Int, this.jdField_r_of_type_Int);
    }
  }
  ...
  private void bv()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar == null)
    {
      ...
      localObject = new RelativeLayout.LayoutParams(-1, aekt.a(48.0F, a().getResources()));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aeqa.a(aekt.a(48.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), false, "cmGame_addFooter", 0);
      this.Z = true;
      return;
  ...
  public void H()
  {
    ...
    localakji.a().a();
    localakji.a().b(this.jdField_a_of_type_Agkb);
    localakji.a().b("page_tag_aio");
    if (this.V)
    {
      localakji.a().d(a());
      this.V = false;
    ...
    if (this.jdField_a_of_type_Akqn != null)
    {
      this.jdField_a_of_type_Akqn.dismiss();
      this.jdField_a_of_type_Akqn = null;
    }
    super.H();
    this.W = false;
    ...
    if (this.jdField_d_of_type_Bdfq != null) {
      this.jdField_d_of_type_Bdfq.dismiss();
    }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    Object localObject = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    String str = alpo.a(2131702430);
    ApolloGameData localApolloGameData = ((aleh)localObject).a(paramInt);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localaliq.jdField_b_of_type_Int = j;
        localaliq.jdField_a_of_type_Long = paramLong;
        localaliq.jdField_a_of_type_Int = paramInt;
        localaliq.d = 3;
        localaliq.e = 0;
        akqq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localaliq);
        return;
        localaliq.jdField_b_of_type_JavaLangString = alpo.a(2131702424);
        j = 0;
      }
    }
  }
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    ...
    U = true;
    akqq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramInt, paramLong);
  }
  
  public void a(akqy paramakqy)
  {
    if (paramakqy == null)
    {
    ...
    if ((paramakqy.jdField_b_of_type_JavaUtilList.size() < 3) || (paramakqy.jdField_b_of_type_JavaUtilList.size() % 3 != 0))
    {
    ...
    if (!this.T)
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips = ((MessageForCmGameTips)ayvw.a(-7004));
      ...
      ayvw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", 1036);
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips.gameInfo = paramakqy;
  ...
  public void a(akrc paramakrc)
  {
    if ((paramakrc != null) && (paramakrc.jdField_a_of_type_JavaLangCharSequence != null) && (!this.ad))
    {
      acex.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramakrc.jdField_a_of_type_JavaLangCharSequence.toString());
      if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar != null) {
      ...
      VipUtils.a(null, "cmshow", "Apollo", "quickMessage", 0, 0, new String[] { String.valueOf(paramakrc.jdField_a_of_type_Int) });
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    if (paramInt == 3)
    {
      paramString1 = new aslp(paramString1, paramString2, alpo.a(2131702421), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, -5040, 2359297, ayvc.a());
      paramString2 = new MessageForUniteGrayTip();
      paramString2.initGrayTipMsg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
      aslq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2);
    }
    String str2;
    ...
    } while ((this.jdField_a_of_type_Agkc != null) && (this.jdField_a_of_type_Agkc.jdField_c_of_type_Int == 4));
    String str1 = alpo.a(2131702434);
    for (;;)
    {
      paramString1 = new aslp(paramString1, paramString2, str1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, -5040, 2359297, l1);
      paramString2 = new MessageForUniteGrayTip();
      paramString2.initGrayTipMsg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
      aslq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2);
      ...
      return;
      if (paramInt == 1) {
        str1 = alpo.a(2131702432) + paramString3 + alpo.a(2131702422);
      } else if (paramInt == 2) {
        str1 = alpo.a(2131702419) + paramString3 + alpo.a(2131702420);
      }
    }
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    this.G = false;
    this.V = true;
    Object localObject = (akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    ((akji)localObject).a().a("page_tag_aio");
    ((akji)localObject).a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "join");
  ...
  public void aZ()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setImageResource(2130839034);
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setGifData(100, null, "https://cmshow.gtimg.cn/client/img/apollo_game_audio_micBig.zip", aljf.a("https://cmshow.gtimg.cn/client/img/apollo_game_audio_micBig.zip"), false);
      this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setOnClickListener(new agjr(this));
      localObject = new RelativeLayout.LayoutParams(aekt.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    if (this.jdField_b_of_type_ComTencentMobileqqApolloViewFrameGifView == null)
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloViewFrameGifView.setImageResource(2130839035);
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloViewFrameGifView.setGifData(100, null, "https://cmshow.gtimg.cn/client/img/apollo_game_audio_micSmall.zip", aljf.a("https://cmshow.gtimg.cn/client/img/apollo_game_audio_micSmall.zip"), false);
      localObject = new LinearLayout.LayoutParams(aekt.a(18.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(18.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
  ...
  public void br()
  {
    ...
    if (localSharedPreferences.getBoolean("apollo_audio_intro", true))
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = aekt.a(200.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = aekt.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      localObject2 = new RelativeLayout.LayoutParams(aekt.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      ((RelativeLayout.LayoutParams)localObject2).addRule(10);
      ((RelativeLayout.LayoutParams)localObject2).setMargins(0, ImmersiveUtils.getStatusBarHeight(BaseApplicationImpl.getApplication()) + aekt.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      this.g.addView(localImageView, (ViewGroup.LayoutParams)localObject2);
      localImageView = new ImageView(a());
      localObject2 = new RelativeLayout.LayoutParams(aekt.a(210.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131362624);
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      ((RelativeLayout.LayoutParams)localObject2).setMargins(0, 0, aekt.a(40.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      this.g.addView(localImageView, (ViewGroup.LayoutParams)localObject2);
      this.ah = true;
      this.g.setOnClickListener(new agjt(this));
  ...
  public void bs()
  {
    ...
    do
    {
      ...
      localSharedPreferences = SharedPreferencesProxyManager.getInstance().getProxy("apollo_sp", 0);
    } while ((!localSharedPreferences.getBoolean("apollo_add_playMate_intro", true)) || (this.jdField_a_of_type_Agkc.jdField_c_of_type_Int != 0));
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mRequestWidth = aekt.a(200.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((URLDrawable.URLDrawableOptions)localObject).mRequestHeight = aekt.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    localImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    RelativeLayout.LayoutParams localLayoutParams1 = new RelativeLayout.LayoutParams(aekt.a(91.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(41.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    localLayoutParams1.addRule(11);
    localLayoutParams1.addRule(10);
    localLayoutParams1.setMargins(0, ImmersiveUtils.getStatusBarHeight(BaseApplicationImpl.getApplication()) + aekt.a(57.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.addView(localImageView, localLayoutParams1);
    localImageView = new ImageView(a());
    localLayoutParams1 = new RelativeLayout.LayoutParams(aekt.a(210.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    localLayoutParams1.addRule(3, 2131362623);
    localLayoutParams1.addRule(11);
    localLayoutParams1.setMargins(0, 0, aekt.a(40.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
    ...
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.addView(localImageView, localLayoutParams1);
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new agju(this));
  ...
  {
    super.d(paramIntent);
    bdjd.a(null, "AIO_updateSession_business");
    if (this.jdField_a_of_type_Agkb == null) {
      this.jdField_a_of_type_Agkb = new agkb(this);
    }
    ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(this.jdField_a_of_type_Agkb);
    bdjd.a("AIO_updateSession_business", null);
    this.W = true;
    bt();
  }
  ...
  public void f(String paramString)
  {
    if (this.h != null)
    {
      ...
      a(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Agkc.jdField_a_of_type_JavaLangString, 2);
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips != null)
      {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar != null)
        {
          ...
          if ("dialog_type_permission".equals(localObject))
          {
            if (this.jdField_d_of_type_Bdfq == null)
            {
              localObject = bdcd.a(a(), 230).setMessage(a().getString(2131696122)).setTitle(a().getString(2131696123)).setNegativeButton(2131690648, new agjx(this));
              if (!mww.a(a())) {
                break label218;
              }
            }
            label218:
            for (int j = 2131696124;; j = 2131696125)
            {
              this.jdField_d_of_type_Bdfq = ((bdfq)localObject).setPositiveButton(j, new agjw(this));
              this.jdField_d_of_type_Bdfq.show();
              break;
            }
          }
          ...
          {
            if (this.c == null) {
              this.c = bdcd.a(a(), 230).setMessage(alpo.a(2131702431)).setPositiveButton(a().getString(2131694951), new agjz(this)).setNegativeButton(a().getString(2131690648), new agjy(this));
            }
            this.c.show();
          }
        }
  ...
  {
    Object localObject = (akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    akqu localakqu = ((akji)localObject).a();
    localakqu.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1);
    localakqu.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    localObject = ((akji)localObject).a();
    if ((akqb.jdField_a_of_type_Boolean) && (!((akqb)localObject).b())) {
      ((akqb)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 319);
    }
    if ((!TextUtils.isEmpty(((akqb)localObject).a())) && (((akqb)localObject).a().equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setImageResource(2130839036);
    }
    localakqu.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 319);
    localakqu.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
