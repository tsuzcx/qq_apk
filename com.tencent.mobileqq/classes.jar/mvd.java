...
public class mvd
{
  ...
  private mve jdField_a_of_type_Mve;
  private boolean jdField_a_of_type_Boolean = true;
  private int jdField_b_of_type_Int;
  private boolean jdField_b_of_type_Boolean;
  
  public mvd(View paramView, Paint paramPaint, AttributeSet paramAttributeSet)
  {
  ...
  public void a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Mve != null) {
        this.jdField_a_of_type_Mve.a(this.jdField_a_of_type_AndroidViewView);
      }
    }
  }
