...
public class mvd
{
  ...
  {
    int i = agej.a(paramFloat, paramContext.getResources());
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return localObject2;
              Object localObject3 = ((anyw)paramQQAppInterface.getManager(51)).b(paramString);
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      if ((k > 0) || (j > 0) || (i > 0))
      {
        paramString = str;
        if (k > 0) {
          paramString = str + k + anzj.a(2131714644);
        }
        str = paramString;
        if (j > 0) {
          str = paramString + j + anzj.a(2131714643);
        }
        paramString = str;
        if (i > 0) {
          paramString = str + i + anzj.a(2131714642);
        }
        return paramString;
        if (arrayOfString.length == 2)
        {
  ...
  public static void a()
  {
    ...
    bhsi.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putBoolean("has_show_svip_dialog", false));
  }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      bhsi.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putInt(str, 0));
      return;
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      paramContext = bhsi.a(paramContext);
  ...
  public static void a(View paramView, String paramString, int paramInt)
  {
    if (jdField_a_of_type_Boolean)
    {
      ...
      if (paramInt == 2) {
        str = paramString.replace(paramView.getResources().getString(2131694762), anzj.a(2131714645));
      }
      if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    {
      bhsi.a(localEditor.putBoolean(str, true));
      return;
