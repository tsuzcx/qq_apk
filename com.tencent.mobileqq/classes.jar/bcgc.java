  ...
  implements Manager
{
  ...
  public List<bcgk> a(String paramString)
  {
    ...
    if ((paramString != null) && (paramString.size() > 0))
    {
      ...
      while (paramString.hasNext())
      {
        ...
        localObject = this.jdField_a_of_type_Bcgl.a(((Integer)localObject).intValue());
        if (localObject != null) {
  ...
  public List<bcgk> a(String paramString1, String paramString2)
  {
    if (!b(paramString1)) {
      return null;
    }
  ...
  public void a(bcgl parambcgl, boolean paramBoolean)
  {
    if (parambcgl == null) {}
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_Bcgl = parambcgl;
        if (QLog.isColorLevel()) {
          QLog.d("TroopHonor.manager", 2, String.format("updateConfig, isInit: %s, config: %s", new Object[] { Boolean.valueOf(paramBoolean), parambcgl }));
        }
        if (!paramBoolean) {
  ...
  public void a(String paramString1, String paramString2, bcgf parambcgf)
  {
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramString1, paramString2, new bcgd(this, paramString1, paramString2, parambcgf));
  }
      ...
      try
      {
        ...
        if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
        {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            a(paramString, str, bcgg.a(paramArrayOfByte));
            if ((!TextUtils.isEmpty(str)) && (str.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
              ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(80, true, new Object[] { paramString, str });
            }
            if (!QLog.isColorLevel()) {
              continue;
            }
  ...
  {
    if ((this.jdField_a_of_type_Bcgl != null) && (this.jdField_a_of_type_Bcgl.jdField_a_of_type_Boolean)) {}
    for (int i = 1;; i = 0)
    {
      TroopManager localTroopManager = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
      if (i == 0)
  ...
  public void b(String paramString1, String paramString2, bcgf parambcgf)
  {
    if ((!b(paramString1)) && (parambcgf != null))
    {
      parambcgf.a(null);
      return;
    }
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramString1, paramString2, new bcge(this, paramString1, paramString2, parambcgf));
  }
