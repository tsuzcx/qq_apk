...
public class bcgc
{
  ...
  {
    if ((bcge.jdField_a_of_type_Boolean) || (bcge.b))
    {
      StringBuilder localStringBuilder = new StringBuilder("_tcvassp_0_=");
      if ((bcge.jdField_a_of_type_Int != -1) && (bcge.jdField_a_of_type_JavaUtilArrayList.size() != 0))
      {
        localStringBuilder.append(bcge.jdField_a_of_type_Int);
        if (bcge.b) {}
        for (Object localObject = "shp";; localObject = "webp")
        {
          ...
          ((Bundle)localObject).putStringArrayList("domains", bcge.jdField_a_of_type_JavaUtilArrayList);
          if (QLog.isColorLevel())
          {
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, arg: " + localStringBuilder.toString());
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, domainList: " + TextUtils.join(", ", bcge.jdField_a_of_type_JavaUtilArrayList));
          }
          return localObject;
        }
      }
  ...
  public static Bundle a(WebViewFragment paramWebViewFragment, Intent paramIntent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        ...
        {
          paramWebViewFragment.a.evaluateJavascript("document.querySelector(\"meta[itemprop='name']\").getAttribute('content')", new bcgd(paramWebViewFragment));
          paramIntent = null;
        }
      }
    }
  ...
  public static String a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (WebpSoLoader.b())
      {
        ...
        if (!TextUtils.isEmpty(str2)) {
          bcge.jdField_a_of_type_Boolean = true;
        }
        bcge.b = paramBoolean;
        ...
        localObject = localStringBuilder.append((String)localObject).append(" ").append(bgxy.a());
    ...
    {
      return paramString1 + " QQ/" + "8.2.8" + "." + "4440" + str1 + str2 + " Pixel/" + j + " StatusBarHeight/" + k + " SimpleUISwitch/" + i + " QQTheme/" + ThemeUtil.getCurrentThemeId();
  ...
  {
    int j = 0;
    if ((bcge.jdField_a_of_type_JavaUtilArrayList.size() != 0) && (bcge.jdField_a_of_type_Int != -1)) {}
    Object localObject1;
    do
    {
      return;
      localObject1 = new File(BaseApplicationImpl.getContext().getFilesDir(), bbnq.e.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          bcge.jdField_a_of_type_JavaUtilArrayList.clear();
          k = localObject2.length;
          i = 0;
          if (i < k)
          {
            arrayOfString = localObject2[i];
            bcge.jdField_a_of_type_JavaUtilArrayList.add(arrayOfString.trim());
            i += 1;
            continue;
          }
        }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramString.equalsIgnoreCase(paramJSONObject.optString("business", ""))))
    {
      ...
      if (bool2)
      {
        ...
        if (paramJSONObject.has("minVersion"))
        {
          ...
          {
            bool1 = bool2;
            if (!bbpp.a(paramString, "8.2.8.4440")) {
              bool1 = false;
            }
          }
        }
      ...
      if (bool1)
      {
        ...
        if (paramJSONObject.has("maxVersion"))
        {
          ...
          {
            bool2 = bool1;
            if (!bbpp.a("8.2.8.4440", paramString)) {
              bool2 = false;
            }
          }
        }
  ...
  public static void b()
  {
    ...
    bcgf.jdField_a_of_type_JavaLangString = localSharedPreferences.getString("http_proxy_address", "");
    bcgf.jdField_a_of_type_Boolean = localSharedPreferences.contains("need_set_proxy");
