...
import com.tencent.mobileqq.webview.swift.component.SwiftBrowserTBSHandler.2;
...
import com.tencent.mobileqq.webview.swift.component.SwiftBrowserTBSHandler.9;
  ...
  implements Handler.Callback
{
  ...
  public bihz(Activity paramActivity)
  {
  ...
  private static Pair<Integer, Integer> a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.isHierarchical())
      {
        ...
        if ((!TextUtils.isEmpty(paramString)) && (nro.a().l(paramString)))
        {
          ...
          if (!paramString.contains("cmshow")) {
            i = m - (int)mvk.a(BaseApplicationImpl.getApplication(), 54.0F);
          }
        }
      }
    }
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a.size() > 1))
    {
      ...
      {
        localObject = (blsk)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(QQManagerFactory.COMIC_RED_TOUCH_MANAGER);
        ArrayList localArrayList = new ArrayList();
        localArrayList.add("1113.100803");
        this.jdField_a_of_type_JavaUtilMap = ((blsk)localObject).a(localArrayList);
      }
      if (this.jdField_a_of_type_JavaUtilMap == null) {
        break label244;
      }
    ...
    for (;;)
    {
      if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a.size() > 4) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.e == 0))
      {
      ...
      {
        i = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.e + 1;
  ...
  public static void a(WebView paramWebView, String paramString1, String paramString2)
  {
    ...
    for (localObject = "";; localObject = bijg.a(paramString2))
    {
  ...
  private void b()
  {
    ...
    {
      String str = a();
      if ((!TextUtils.isEmpty(str)) && (biit.a(str)) && (!str.contains("asyncMode=3")) && (!str.contains("sonic=1"))) {
        ThreadManager.post(new SwiftBrowserTBSHandler.9(this, str), 5, null, true);
      }
    }
  }
  ...
  public Object a(String paramString, Bundle paramBundle)
  {
    ...
    paramString = bjna.a().a(paramBundle);
    if (paramString != null)
    {
      paramString = paramString.d;
      Bundle localBundle = new Bundle();
      localBundle.putString(bjmy.b, paramBundle);
      ...
      localBundle.putString(bjmy.m, "_" + paramBundle);
      bjmu.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localBundle, "biz_src_yyb", null, 0);
      return paramBundle;
    }
    ThreadManager.post(new SwiftBrowserTBSHandler.3(this, paramBundle, str), 8, null, true);
    return paramBundle;
    if ("cancelDownloadTask".equals(paramString))
    {
      paramString = paramBundle.getString("download_id");
      if (!bjmu.a(paramString)) {
        return Boolean.valueOf(false);
      }
      bjmu.a(paramString, "_" + paramString, true);
    ...
    {
      paramString = paramBundle.getString("download_id");
      paramBundle = bjna.a().a(paramString);
      if ((paramBundle == null) || (paramBundle.a() != 4)) {
        return Boolean.valueOf(false);
      }
      paramBundle = new Bundle();
      paramBundle.putString(bjmy.b, paramString);
      paramBundle.putInt(bjmy.k, 5);
      paramBundle.putBoolean(bjmy.r, false);
      paramBundle.putBoolean(bjmy.x, false);
      bjmu.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, paramBundle, "biz_src_yyb", null, 0);
      return Boolean.valueOf(true);
    }
    if ("notifyQBiconShine".equals(paramString))
    {
      paramString = (SwiftBrowserUIStyleHandler)this.mComponentContext.a().a(2);
      if (paramString != null)
      {
        paramString.mUIStyle.mHasRelatedContent = true;
          ...
          if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
          {
            ...
            if (!TextUtils.isEmpty(str))
            {
              ...
              if (!this.jdField_a_of_type_JavaUtilHashSet.contains(str))
              {
                ...
                ThreadManager.getUIHandler().postDelayed(new SwiftBrowserTBSHandler.4(this, paramString), 5000L);
              }
            }
          }
        }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.browserApp != null) && (i != 0)) {
        if ("CN".equals(Locale.getDefault().getCountry())) {
          if (TbsDownloader.needDownload(BaseApplication.getContext(), false, false, new biid(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment)))
          {
            if (QLog.isColorLevel()) {
              QLog.d("TBS_update", 2, "tbs need download");
            }
            QbSdk.setUploadCode(BaseApplication.getContext(), 150);
            this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.browserApp.a(false);
            label161:
            i = 1;
            label163:
      ...
      label441:
      label448:
      for (localObject1 = (bihv)this.mComponentContext.a().a(-2);; localObject1 = null)
      {
        if (((localObject1 == null) || (!((bihv)localObject1).i)) && (!QLog.isColorLevel())) {
          break label451;
        }
        ...
        {
          if ((localObject1 == null) || (!((bihv)localObject1).i)) {
            break;
          }
        ...
        for (;;)
        {
          bdla.b(null, "P_CliOper", "BizTechReport", "", "web", (String)localObject1, 0, 1, j, "", "", "", "");
          return;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getWebView();; localObject = null)
    {
      if (localObject != null)
      {
        localObject = (awcr)((CustomWebView)localObject).getPluginEngine().a("x5");
        if (localObject != null) {
          ((awcr)localObject).a(paramInt, paramString);
        }
      }
      return;
    }
      ...
      for (;;)
      {
        ...
        catch (Throwable paramBundle)
        {
          try
          {
            ...
            QLog.d("SwiftBrowserTBSHandler", 1, "handle stgw time, requestTime: " + localObject4 + "s, responseTime: " + (String)localObject3 + "s, url: " + nwo.b(localObject5, new String[0]));
            return;
          }
          catch (Throwable paramBundle)
          {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bjna.a().a("801097412");
        if ((localObject == null) || (!NetworkUtil.isWifiConnected(BaseApplicationImpl.getApplication()))) {
          break;
        }
        ...
        if (paramBoolean)
        {
          paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689480);
          QQToast.a(BaseApplicationImpl.getApplication(), 2, paramString, 0).b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getTitleBarHeight());
          this.jdField_a_of_type_MqqOsMqqHandler.sendMessage(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(102));
          return;
        }
      }
      finally {}
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689485);
    }
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    this.jdField_a_of_type_JavaLangString = paramString;
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.waitting.setVisibility(8);
      ThreadManager.post(new SwiftBrowserTBSHandler.5(this), 8, null, true);
      paramString = new biia(this);
      localObject = new biib(this);
      if (!NetworkUtil.isWifiConnected(BaseApplicationImpl.getApplication())) {
        break label351;
      }
      this.jdField_a_of_type_MqqOsMqqHandler.sendMessage(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(102));
      if (!paramBoolean) {
    ...
    label335:
    for (paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689480);; paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689485))
    {
      QQToast.a(BaseApplicationImpl.getApplication(), 2, paramString, 0).b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getTitleBarHeight());
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.waitting.setVisibility(8);
      return;
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.waitting.setVisibility(0);
      break;
    }
    label351:
    if (paramBoolean)
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844338);
      this.jdField_a_of_type_AndroidAppDialog = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localDrawable, BaseApplicationImpl.getApplication().getResources().getString(2131689479), " ", BaseApplicationImpl.getApplication().getResources().getString(2131690677), BaseApplicationImpl.getApplication().getResources().getString(2131689478), paramString, (View.OnClickListener)localObject);
    ...
    for (paramString = paramString.getString("icon_url", null);; paramString = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.waitting.setVisibility(8);
      return;
      this.jdField_a_of_type_AndroidAppDialog = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, BaseApplicationImpl.getApplication().getResources().getString(2131689484), 2131690677, 2131689478, paramString, (View.OnClickListener)localObject);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.waitting.setVisibility(8);
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        } while ((this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.isFinishing()) || (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) || (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.isDestroyed));
        ...
        if (paramMessage != null)
        {
          ...
          paramMessage.putString("param_user_agent", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView.getSettings().getUserAgentString());
          paramMessage.putString("param_refer_url", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView.getUrl());
          ...
          if ((localObject1 != null) && (((String)localObject1).length() != 0))
          {
            ...
            auhn.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, (String)localObject1, paramMessage);
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.waitting.setVisibility(8);
        return true;
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131380468);
      ((ImageView)localObject1).setImageDrawable(null);
      ((ImageView)localObject1).setImageDrawable(paramMessage);
      return true;
      paramMessage = (String)paramMessage.obj;
    } while ((this.jdField_a_of_type_AndroidAppDialog == null) || (!this.jdField_a_of_type_AndroidAppDialog.isShowing()) || (paramMessage == null));
    ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131380470)).setText(paramMessage);
    return true;
  }
  ...
  public void onLifeCycleStateChanged(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (awcr)paramBundle.getPluginEngine().a("x5");
    } while (paramBundle == null);
    paramBundle.a();
  }
}
