  ...
  extends yuf
{
  ...
  yub jdField_a_of_type_Yub;
  yul jdField_a_of_type_Yul = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (localDoodleItem != null) {
      localyuk = new yuk(localDoodleItem, paramVideoMaterial.getDataPath());
    }
    return localyuk;
  }
  ...
  {
    return new yuj(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    if (localBitmap != null)
    {
      ...
      localBitmap.recycle();
      return zdr.a((Bitmap)localObject, this.jdField_c_of_type_Int, this.jdField_d_of_type_Int, true);
    }
    return null;
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Yul.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Yul.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && ((this.jdField_a_of_type_Yub instanceof yud)))
    {
      ((yud)this.jdField_a_of_type_Yub).h();
      a(true);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, yul paramyul)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(paramyul.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    paramyul.jdField_a_of_type_Boolean = true;
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, yul paramyul)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = paramyul.jdField_d_of_type_Boolean;
    localArrayList.addAll(paramyul.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramyul.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof yuk))
    {
      localObject = (yuk)localObject;
      ((yuk)localObject).a(localArrayList);
      ((yuk)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((yuk)localObject).a(paramyul.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((yuk)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        paramyul.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!paramyul.jdField_d_of_type_Boolean) || (!paramyul.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = paramyul.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof yui))
      {
        localObject = (yui)localObject;
        ((yui)localObject).a();
        ((yui)localObject).a(localArrayList, bool, paramyul);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((yui)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((yui)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          paramyul.b();
        }
      }
      else if ((localObject instanceof yuj))
      {
        localObject = (yuj)localObject;
        ((yuj)localObject).a(localArrayList);
        yun.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((yuj)localObject).a();
        yun.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((yuj)localObject).a(paramyul.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          yun.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          paramyul.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Yub != null) {
        this.jdField_a_of_type_Yub.a(paramVideoMaterial);
      }
      return;
    }
  ...
  public void a(yul paramyul)
  {
    if ((paramyul.jdField_d_of_type_Boolean) && (paramyul.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!paramyul.jdField_a_of_type_Boolean) && (paramyul.jdField_b_of_type_Boolean))
      {
        if (paramyul.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramyul);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (paramyul.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramyul);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Yul == null) || (!this.jdField_a_of_type_Yul.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    QQToast.a(QQStoryContext.a().getApp(), anvx.a(2131707426), 0).a();
    return true;
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        ...
        {
          this.jdField_a_of_type_Yul = new yul(102, this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId());
          this.jdField_f_of_type_Int += 1;
          this.jdField_a_of_type_Yul.jdField_c_of_type_Boolean = true;
          if (this.jdField_a_of_type_Yub != null) {
            this.jdField_a_of_type_Yub.a(this.jdField_a_of_type_Yul);
          }
          a(f1, f2, false);
          this.jdField_e_of_type_Int = 0;
        }
      }
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Yul != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (localBitmap == null)
      {
        ...
        ykq.e("PersonalityOperator", "saveTextureToBitmap failed, bitmapFromTexture is null");
        return;
      }
      localBitmap = zdr.a(localBitmap, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Yub != null)
      {
        this.jdField_a_of_type_Yub.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_Yub != null) && ((this.jdField_a_of_type_Yub instanceof yud))) {
      ((yud)this.jdField_a_of_type_Yub).f();
    }
    Object localObject4;
    Object localObject5;
    Bitmap localBitmap1;
    ...
    try
    {
      ...
      if (localBitmap2 != null)
      {
        localObject3 = localObject4;
        localObject2 = localObject5;
        localBitmap1 = zdr.a(localBitmap2, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      }
      localObject3 = localBitmap1;
      localObject2 = localBitmap1;
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Yub != null) {
        this.jdField_a_of_type_Yub.a(localBitmap1);
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Yub != null) {
          this.jdField_a_of_type_Yub.a((Bitmap)localObject3);
        }
      }
    }
    finally
    {
      ...
      this.jdField_a_of_type_Yub.a((Bitmap)localObject2);
    }
