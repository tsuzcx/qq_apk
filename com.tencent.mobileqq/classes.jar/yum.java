  ...
  implements alpy
{
  private static int a(int paramInt)
  {
    ...
    yxs.d("GdtInterstitialNotifyReg", String.format("getError arkScriptError:%d not working", new Object[] { Integer.valueOf(paramInt) }));
    return 1;
  }
  ...
  private static int a(String paramString)
  {
    ...
    {
      yxs.d("GdtInterstitialNotifyReg", String.format("getError params:%s", new Object[] { paramString }), localThrowable);
    }
    return -2147483648;
  }
  ...
  private static GdtAd a(String paramString)
  {
    ...
    {
      yxs.b("GdtInterstitialNotifyReg", String.format("getAd params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private static String a(String paramString)
  {
    ...
    {
      yxs.d("GdtInterstitialNotifyReg", String.format("getUrl params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      yxs.b("GdtInterstitialNotifyReg", String.format("receiveHTTPGet %b %s", new Object[] { Boolean.valueOf(bool), paramString }));
      return bool;
  ...
  private boolean b(String paramString)
  {
    ...
    for (;;)
    {
      yxs.b("GdtInterstitialNotifyReg", String.format("receiveClick %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
      ...
      {
        paramString = yul.a().a(paramString);
        if (paramString != null)
        {
  ...
  private boolean c(String paramString)
  {
    ...
    for (;;)
    {
      yxs.b("GdtInterstitialNotifyReg", String.format("receiveClose %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
      paramString = paramString.getTraceId();
      if (TextUtils.isEmpty(paramString))
      {
  ...
  private boolean d(String paramString)
  {
    ...
    for (;;)
    {
      yxs.b("GdtInterstitialNotifyReg", String.format("receiveLoaded %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
      paramString = paramString.getTraceId();
      paramString = yul.a().a(paramString);
      if (paramString != null)
  ...
  private boolean e(String paramString)
  {
    ...
    int i = a(paramString);
    int j = a(i);
    yxs.d("GdtInterstitialNotifyReg", String.format("receiveError error:%d arkScriptError:%d params:%s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), paramString }));
    if ((j != 4) && (j != 207)) {}
    do
    {
      do
  ...
  {
    yxs.b("GdtInterstitialNotifyReg", String.format("notify appName:%s eventName:%s params:%s", new Object[] { paramString1, paramString2, paramString3 }));
    ...
    if (!yul.a().a().a.equals(paramString1)) {}
    do
    {
      return false;
