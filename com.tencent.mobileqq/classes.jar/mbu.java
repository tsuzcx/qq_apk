  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public mbu(EffectCycleViewPager paramEffectCycleViewPager, ViewPager.OnPageChangeListener paramOnPageChangeListener, int paramInt)
  {
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      krx.c("EffectCycleViewPager", "onPageScrollStateChanged 00:1");
    ...
    for (;;)
    {
      ...
      {
        krx.c("EffectCycleViewPager", "onPageScrollStateChanged 11:" + (this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectCycleViewPager.a.getCount() - 2));
