  ...
  implements View.OnClickListener
{
  ...
  {
    String str;
    if (!TextUtils.isEmpty(this.a.jdField_a_of_type_Bqsi.jdField_a_of_type_JavaLangString))
    {
      this.a.jdField_a_of_type_JavaLangString = this.a.jdField_a_of_type_Bqsi.jdField_a_of_type_JavaLangString;
      ...
      {
        bqgk localbqgk = this.a.jdField_a_of_type_Bqgk;
        if (this.a.jdField_a_of_type_Bqgk.a())
        {
          str = "2";
          localbqgk.a("use_custom_tag", 0, 0, new String[] { str });
        }
      }
      else
      {
