...
public class bdsr
{
  private static final bdsr jdField_a_of_type_Bdsr = new bdsr();
  ...
  public static bdsr a()
  {
    return jdField_a_of_type_Bdsr;
  }
  
  private void a(byte[] paramArrayOfByte, List<APP_REPORT_TRANSFER.SingleDcData> paramList)
  {
    if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0)) {
      ((ChannelProxy)ProxyManager.get(ChannelProxy.class)).dataReport(paramArrayOfByte, new bdst(this, paramList));
    }
  }
  ...
  {
    if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0)) {
      ((ChannelProxy)ProxyManager.get(ChannelProxy.class)).report(paramArrayOfByte, paramString1, paramString2, new bdss(this, paramList));
    }
  }
  ...
  private static String b(REPORT.SingleDcData paramSingleDcData)
  {
    ...
    if (paramSingleDcData != null) {
      localStringBuilder.append(bdyt.a(paramSingleDcData));
    }
  ...
  private void d()
  {
    if (!this.d.isEmpty())
    {
      ...
      this.d.clear();
      byte[] arrayOfByte = bdsq.a(localArrayList).toByteArray();
  ...
  private void f()
  {
    ...
    if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
    {
      ...
      localObject2 = bdsq.a(localArrayList);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bdnw.d("MiniProgramReporter", "performReportLaunchDcDataToServer", localException);
      }
      ...
      bdnw.a("MiniProgramReporter", "performReportLaunchDcDataToServer: split into " + i + " count");
      j = 0;
      i = k;
    }
    ...
    for (;;)
    {
      ...
      while (i <= localArrayList.size())
      {
        if ((j < i) && (j >= 0) && (i <= localArrayList.size()))
        {
          ...
          APP_REPORT_TRANSFER.StDataReportReq localStDataReportReq = bdsq.a((List)localObject1);
  ...
  private void g()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bdnw.d("MiniProgramReporter", "performReportToServer", localException);
      }
      if (localObject1.length > 262144) {
        break label108;
      }
      ...
      i = localObject1.length / 262144 + 1;
      k = localArrayList.size() / i;
      bdnw.a("MiniProgramReporter", "performReportToServer: split into " + i + " count");
      j = 0;
      i = k;
    }
    if (localObject1 == null) {}
    for (;;)
    {
      ...
      while (i <= localArrayList.size())
      {
        ...
        {
          localObject1 = localArrayList.subList(j, i);
          REPORT.StDcReportReq localStDcReportReq = bdsq.a((List)localObject1);
  ...
  public void a()
  {
    ...
    try
    {
      j = bdhg.a("MiniApp", "mini_app_report_time_threshold", 10);
      i = j;
      int m = bdhg.a("MiniApp", "mini_app_report_count_threshold", 64);
      i = m;
      k = j;
      j = i;
    }
