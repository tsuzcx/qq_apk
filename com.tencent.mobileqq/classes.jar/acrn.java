  ...
  implements acrf
{
  public int a;
  public long a;
  acrp jdField_a_of_type_Acrp = new acro(this);
  ...
  private int a(String paramString, int paramInt)
  {
    ...
    acrl.a(BaseApplicationImpl.getApplication(), this, paramString);
    j = -1;
    i = j;
    for (;;)
    {
      try
      {
        acqy.a("GdtC2SReporter", "index: " + paramInt + " mOpeType " + this.jdField_a_of_type_Int);
        i = j;
        ...
        i = j;
        acqy.a("GdtC2SReporter", "rspCode:  " + j + " index: " + paramInt + " mOpeType " + this.jdField_a_of_type_Int + " reportUrl =" + paramString);
        i = j;
        ...
        paramInt = 0;
        i = j;
        bcst.a(null, "dc00898", "", "", "0X8009B97", "0X8009B97", k, paramInt, "", "", this.jdField_a_of_type_JavaLangString, paramString);
      }
      catch (Throwable localThrowable)
      {
        acqy.d("GdtC2SReporter", "c2sReport excetpion: " + localThrowable.getMessage());
        j = i;
        continue;
      }
      acrl.a(BaseApplicationImpl.getApplication(), this, paramString, j, System.currentTimeMillis() - l);
      return j;
      paramInt = 1;
    }
  }
  ...
  private void a(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      acrl.a(BaseApplicationImpl.getApplication(), this, str, i);
    }
    bcst.a(null, "dc00898", "", "", "0X8009EBF", "0X8009EBF", this.jdField_a_of_type_Int, i, "", "", this.jdField_a_of_type_JavaLangString, "");
  }
  ...
  public void a(int paramInt1, int paramInt2, qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      acqy.a("GdtC2SReporter", "reportAsync for ADID: " + this.jdField_a_of_type_JavaLangString + ", operationType: " + paramInt1);
      acrl.a(BaseApplicationImpl.getApplication(), new GdtAd(paramAdInfo), paramInt1, paramInt2, true);
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      paramAdInfo = BaseApplicationImpl.getApplication().getRuntime();
      String str = paramAdInfo.getAccount();
      NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), acrq.class);
      ...
      localNewIntent.setObserver(this.jdField_a_of_type_Acrp);
      paramAdInfo.startServlet(localNewIntent);
      bcst.a(null, "dc00898", "", "", "0X8009EBC", "0X8009EBC", this.jdField_a_of_type_Int, 0, "", "", this.jdField_a_of_type_JavaLangString, "");
      return;
    }
  }
}
