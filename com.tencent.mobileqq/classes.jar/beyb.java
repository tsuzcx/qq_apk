...
public class beyb
{
  public static ConcurrentHashMap<String, beyc> a = new ConcurrentHashMap();
  ...
  public static beyc a(String paramString)
  {
    if (a.containsKey(paramString)) {
      return (beyc)a.get(paramString);
    }
    beyc localbeyc = new beyc();
    a.put(paramString, localbeyc);
    return localbeyc;
  }
