  ...
  implements ruk
{
  ...
  private bbac jdField_a_of_type_Bbac;
  bbej jdField_a_of_type_Bbej = null;
  bbev jdField_a_of_type_Bbev = null;
  bbms jdField_a_of_type_Bbms;
  public CustomWebView a;
  public String a;
  private HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<rux> jdField_a_of_type_JavaUtilList;
  public ocu a;
  ...
  private List<rux> jdField_b_of_type_JavaUtilList;
  private String c;
  
  public rus(org paramorg, wis paramwis)
  {
    this.jdField_a_of_type_Org = paramorg;
    this.jdField_a_of_type_Bbac = paramorg.mRuntime;
    this.jdField_a_of_type_Wis = paramwis;
    this.jdField_a_of_type_AndroidAppActivity = a();
    this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = this.jdField_a_of_type_Bbac.a();
    paramorg = this.jdField_a_of_type_Bbac.a(this.jdField_a_of_type_Bbac.a());
    if ((paramorg != null) && ((paramorg instanceof bbev))) {
      this.jdField_a_of_type_Bbev = ((bbev)paramorg);
    }
    paramorg = this.jdField_a_of_type_Bbac.a(this.jdField_a_of_type_Bbac.a());
    if ((paramorg != null) && ((paramorg instanceof bbej))) {
      this.jdField_a_of_type_Bbej = ((bbej)paramorg);
    }
  ...
  private List<rux> a()
  {
    ...
    localArrayList.add(new rux("kandian", 1, false));
    localArrayList.add(new rux("qq_friend", 2, false));
    localArrayList.add(new rux("qzone", 3, false));
    localArrayList.add(new rux("we_chat", 4, false));
    localArrayList.add(new rux("we_chat_circle", 5, false));
    localArrayList.add(new rux("we_bo", 6, false));
    localArrayList.add(new rux("qq_browser", 7, false));
    localArrayList.add(new rux("sys_browser", 8, false));
    return localArrayList;
  }
  
  private List<rux> a(JSONArray paramJSONArray)
  {
    ArrayList localArrayList = new ArrayList();
        ...
        if (i < j)
        {
          ...
          if ((localObject1 instanceof String))
          {
            ...
            if (localObject2 != null) {
              localArrayList.add(new rux((String)localObject1, ((Integer)localObject2).intValue(), false));
            }
          }
          else if ((localObject1 instanceof JSONObject))
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (this.jdField_a_of_type_JavaUtilHashMap.get(localObject2) != null))
            {
              ...
              {
                bool = true;
                localArrayList.add(new rux((String)localObject2, m, bool));
              }
            }
          }
        }
  ...
  private rux a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    rux localrux;
    while (localIterator.hasNext())
    {
      localrux = (rux)localIterator.next();
      if (localrux.a == paramInt) {
        return localrux;
      }
    }
  ...
  private List<Integer>[] a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList1.add(Integer.valueOf(((rux)((Iterator)localObject).next()).a));
    }
    ArrayList localArrayList2 = new ArrayList();
    localObject = this.jdField_b_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList2.add(Integer.valueOf(((rux)((Iterator)localObject).next()).a));
    }
    ...
    for (;;)
    {
      ...
      label152:
      localObject = this.jdField_a_of_type_Rva.c;
      break;
      label163:
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new rux("screen_shot", 9, false));
    localArrayList.add(new rux("set_font", 10, false));
    localArrayList.add(new rux("add_favourite", 12, false));
    localArrayList.add(new rux("export_tencent_docs", 28, false));
    localArrayList.add(new rux("send_pc", 13, false));
    localArrayList.add(new rux("copy_link", 14, false));
    localArrayList.add(new rux("report", 20, false));
    return localArrayList;
  }
  ...
  private void d()
  {
    String str1 = this.jdField_a_of_type_Rva.a;
    String str2 = this.jdField_a_of_type_Rva.jdField_b_of_type_JavaLangString;
    String str3 = this.jdField_a_of_type_Rva.d;
    String str4 = this.jdField_a_of_type_Bbac.a().f;
    String str5 = this.jdField_a_of_type_Rva.f;
    bfhl.a(0, str1, this.jdField_a_of_type_Rva.c, str5, str2, str3, null, null, false, -1L).a("lCategory", 8L).c(str4).b(this.jdField_a_of_type_Bbac.a(), str4, 2, null);
  }
  
  private void e()
  {
    Object localObject1 = Pattern.compile("(http|https)://.*.mp.qq.com.*").matcher(this.jdField_a_of_type_Rva.c);
    int i = 0;
    ...
    try
    {
      localObject1 = URLEncoder.encode(this.jdField_a_of_type_Rva.c, "UTF-8");
      str2 = this.jdField_a_of_type_Bbac.a().f;
      if (i != 0)
      {
        String str3 = String.valueOf(NetConnInfoCenter.getServerTime());
        String str1 = bcdu.b((String)localObject1 + 200 + str3 + "jubao@article@123");
        localObject3 = str1;
        if (str1 != null)
        {
          localObject3 = str1;
        ...
        str1 = this.jdField_a_of_type_Bbac.a().j;
  ...
  Activity a()
  {
    for (Activity localActivity = this.jdField_a_of_type_Bbac.a(); (localActivity != null) && ((localActivity instanceof BasePluginActivity)); localActivity = ((BasePluginActivity)localActivity).getOutActivity()) {}
  ...
  {
    c();
    if (this.jdField_a_of_type_Ocu != null) {
      WxShareHelperFromReadInjoy.a().b(this.jdField_a_of_type_Ocu);
    }
  }
  
  public void a(int paramInt, float paramFloat)
  {
    this.jdField_a_of_type_Bbac.a().getSettings().setTextZoom(bbbt.a[paramInt]);
    this.jdField_a_of_type_Wis.a(paramInt);
  }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Rug == null) {
      this.jdField_a_of_type_Rug = new rug(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bbac.a(), null, new ruy(this));
    }
    this.jdField_a_of_type_Rug.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Rug.a.a(new rut(this));
    for (;;)
    {
      try
      {
        ...
        if (localJSONArray1 == null)
        {
          ...
          if (localJSONArray2 == null)
          {
            ...
            this.jdField_a_of_type_Rva = new rva(null);
            this.jdField_a_of_type_Rva.c = paramString.optString("share_url");
            this.jdField_a_of_type_Rva.jdField_b_of_type_JavaLangString = paramString.optString("desc");
            this.jdField_a_of_type_Rva.a = paramString.optString("title");
            this.jdField_a_of_type_Rva.d = paramString.optString("image_url");
            this.jdField_a_of_type_Rva.e = paramString.optString("puin");
            this.jdField_a_of_type_Rva.f = paramString.optString("nick_name");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Rva.f)) {
              this.jdField_a_of_type_Rva.f = paramString.optString("sourceName");
            }
  ...
  void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        paramString2 = this.jdField_a_of_type_Bbac.a();
  ...
  void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    {
      paramString1.putString("struct_url", this.jdField_a_of_type_Bbev.b());
      paramString1.putBoolean("from_web", true);
    }
    if (this.jdField_a_of_type_Bbej != null) {
      i = this.jdField_a_of_type_Bbej.a(this.jdField_a_of_type_Org, (byte)2, true);
    }
    bfqn.a(this.jdField_a_of_type_Bbac.a(), this.jdField_a_of_type_AndroidAppActivity, paramString1, null, i);
  }
  ...
  public void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131630985, new Object[] { paramString5 }));
      ...
      if (paramJSONObject.has("serviceID"))
      {
        ...
        if ((paramInt == 116) || (paramInt == 123)) {
          localIntent.putExtra("compatible_text", alyc.a);
        }
      }
      ...
      paramJSONObject = this.jdField_a_of_type_Bbac.a();
      if (paramJSONObject != null)
      {
        b();
        localIntent.putExtra("struct_share_key_source_name", Long.toString(l));
        xdt.a(paramJSONObject, this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.getAccount(), l, 3000L, new ruu(this, localIntent));
      }
      return;
    ...
    for (;;)
    {
      ...
      {
        paramString2 = this.jdField_a_of_type_Bbac.a().getEntityManagerFactory(this.jdField_a_of_type_Bbac.a().getAccount()).createEntityManager();
      ...
      for (paramString2 = paramString5.name;; paramString2 = null)
      {
        ...
        for (;;)
        {
          if (paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131633855)))
          {
            boolean bool = paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131633855));
            if (bool)
            {
          ...
          for (;;)
          {
            localIntent.putExtra("stuctmsg_bytes", awuw.a(localIntent.getExtras()).getBytes());
            this.jdField_a_of_type_Org.startActivityForResult(localIntent, (byte)1);
            return;
            if (paramJSONObject.has("sourceName")) {
            ...
            {
              localIntent.putExtra("app_name", this.jdField_a_of_type_AndroidAppActivity.getString(2131631001));
            }
          }
          paramString2 = paramString3;
        }
