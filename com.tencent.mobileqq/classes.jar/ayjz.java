...
public class ayjz
  extends amfg
{
  public ayjz(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131700159));
        this.a.g.setOnClickListener(new aykb(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new aykc(this));
    }
  }
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Ahex == null)
                {
                  ...
                  paramArrayOfByte.setText(alud.a(2131700163));
                  ...
                  paramArrayOfByte.setText(alud.a(2131700161));
                  paramArrayOfByte.setBackgroundResource(2130838593);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131700154));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new ayka(this, paramString2));
