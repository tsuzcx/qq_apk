  ...
  extends aqiz
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new aqjh(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    aqjh localaqjh = (aqjh)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = a(paramInt1, paramInt2 * 4 + i, paramBoolean, localaqjh.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  protected View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (Object localObject = (FileInfo)paramViewGroup;; localObject = null)
    {
      ...
      for (;;)
      {
        try
        {
          paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560640, null);
          paramView = paramViewGroup;
          try
          {
            localaqiy = new aqiy();
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramViewGroup.findViewById(2131367910));
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367927));
            paramView = paramViewGroup;
            localaqiy.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367924));
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localaqiy);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_AndroidWidgetImageView.setTag(localaqiy);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.c);
            paramView = paramViewGroup;
            paramViewGroup.setTag(localaqiy);
            paramView = paramViewGroup;
            ((FileInfo)localObject).a((String)getGroup(paramInt1));
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_JavaLangObject = localObject;
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_Int = paramInt2;
            paramView = paramViewGroup;
            localaqiy.jdField_b_of_type_Int = paramInt1;
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAdjustViewBounds(false);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setDefaultImage(2130847294);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncClipSize(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int);
            paramView = paramViewGroup;
            if (((FileInfo)localObject).c() != null)
            {
              ...
              {
                paramView = paramViewGroup;
                if (arof.b(((FileInfo)localObject).c()))
                {
                  paramView = paramViewGroup;
                  localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncImage(((FileInfo)localObject).c());
                }
              }
            }
            paramView = paramViewGroup;
            ...
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
            paramView = paramViewGroup;
            if (aqxj.a((FileInfo)localObject))
            {
              ...
              paramView = paramViewGroup;
              localaqiy.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840305);
              paramView = paramViewGroup;
              ...
              paramView = paramViewGroup;
              localaqiy.jdField_a_of_type_AndroidWidgetImageView.setContentDescription((CharSequence)localObject);
              paramView = paramViewGroup;
              localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setContentDescription((CharSequence)localObject);
              return paramViewGroup;
              localaqiy = (aqiy)paramView.getTag();
              paramViewGroup = paramView;
              continue;
            }
            paramView = paramViewGroup;
            localObject = str + alpo.a(2131710061);
            paramView = paramViewGroup;
            localaqiy.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
            paramView = paramViewGroup;
            localaqiy.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845222);
            continue;
        ...
        return paramView;
        paramView = paramViewGroup;
        localaqiy.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        paramView = paramViewGroup;
        localaqiy.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
        localObject = str;
      }
    }
  }
