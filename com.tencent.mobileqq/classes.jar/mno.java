...
public class mno
{
  ...
  public static void a(long paramLong)
  {
    ...
    localHashMap.put("device_model", bgln.d());
    localHashMap.put("api", bgln.e());
    localHashMap.put("manufacture", bgln.h());
    bctj localbctj = bctj.a(BaseApplicationImpl.getContext());
    if (!jdField_a_of_type_Boolean) {}
    for (boolean bool = true;; bool = false)
    {
      localbctj.a("", "av_record_convert_pcm_cost", bool, paramLong / 1000L, 0L, localHashMap, "", false);
      return;
    }
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    bctj.a(BaseApplicationImpl.getContext()).a("", "av_record_convert_pcm_success", paramBoolean, 0L, 0L, localHashMap, "", false);
  }
  ...
  public static void d()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localbctj.a("", "av_record_report_end", bool, 0L, 0L, localHashMap, "", false);
      return;
    }
  }
  ...
  public static void e()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localbctj.a("", "av_record_audio_fail", bool, 0L, 0L, localHashMap, "", false);
      return;
    }
  }
  ...
  public static void f()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localbctj.a("", "av_record_convert_pcm_timeout", bool, 0L, 0L, localHashMap, "", false);
      return;
    }
  }
}
