...
import com.tencent.mobileqq.app.MayknowRecommendManager.10;
import com.tencent.mobileqq.app.MayknowRecommendManager.12;
  ...
  implements Manager
{
  ...
  ajxj jdField_a_of_type_Ajxj = new akac(this);
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private asko jdField_a_of_type_Asko = new akad(this);
  ...
  private ArrayList<aflw> jdField_c_of_type_JavaUtilArrayList;
  ...
  public akaa(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_Asko != null)
    {
      ...
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(this.jdField_a_of_type_Asko);
      }
    }
  }
  
  private aflw a(oidb_0xc26.TabInfo paramTabInfo)
  {
    aflw localaflw = new aflw();
    localaflw.jdField_a_of_type_Int = paramTabInfo.uint32_tab_id.get();
    localaflw.jdField_b_of_type_Int = paramTabInfo.uint32_recommend_count.get();
    String str;
    if (paramTabInfo.bytes_table_name.has())
    {
      str = paramTabInfo.bytes_table_name.get().toStringUtf8();
      localaflw.jdField_a_of_type_JavaLangString = str;
      if (!paramTabInfo.bytes_icon_url_select.has()) {
        break label116;
      }
      str = paramTabInfo.bytes_icon_url_select.get().toStringUtf8();
      label77:
      localaflw.jdField_b_of_type_JavaLangString = str;
  ...
  private RecentRecommendTroopItem a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        this.jdField_a_of_type_MqqOsMqqHandler.post(new MayknowRecommendManager.10(this, paramString));
        if (k == 0)
        {
      ...
      ??? = ((aktf)localObject2).b(paramString, 8113);
      paramString = localObject1;
      if (??? == null) {
        break;
      }
      ((aktf)localObject2).b((RecentUser)???);
      return localObject1;
      label249:
      k += 1;
      continue;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_Aukp.b((String)localObject2);
        }
        if (paramArrayList.size() > 0)
        {
          ...
          while (paramArrayList.hasNext())
          {
            ...
            this.jdField_a_of_type_Aukp.a((auko)localObject2);
          }
        }
      }
  ...
  private <T extends MayKnowRecommend> ArrayList<T> b(@NonNull ArrayList<T> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (!localajxl.b(localMayKnowRecommend.uin))
      {
        boolean bool = localajxl.a(localMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int k = 1;; k = 0)
        {
  ...
  private void c(List<oidb_0xc26.TabInfo> paramList)
  {
    ...
    for (??? = "null";; ??? = Integer.valueOf(paramList.size()))
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (((aflw)localObject2).jdField_a_of_type_Int == 23) {
          ((aflw)localObject2).jdField_b_of_type_Int += c().size();
        }
  ...
  private void d(List<aflw> paramList)
  {
    for (;;)
    {
      SharedPreferences localSharedPreferences;
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        paramList = paramList.iterator();
        if (paramList.hasNext()) {
          localJSONArray.put(aflw.a((aflw)paramList.next()));
        }
      }
  ...
  private void e(int paramInt)
  {
    synchronized (this.jdField_f_of_type_JavaLangObject)
    {
      ...
      {
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukp.a(MayKnowRecommend.class, false, "tabID=?", new String[] { paramInt + "" }, null, null, null, null);
        synchronized (this.jdField_f_of_type_JavaLangObject)
        {
  ...
  private void k()
  {
    ...
    {
      localaukr.a();
      this.jdField_a_of_type_Aukp.b("delete from MayKnowRecommend");
      this.jdField_a_of_type_Aukp.b("delete from MayKnowExposure");
      localaukr.c();
      bool1 = true;
    }
  ...
  private void l()
  {
    ...
    ampz localampz = ampy.a();
    StringBuilder localStringBuilder;
    if (localampz != null)
    {
      this.jdField_g_of_type_Int = localampz.jdField_a_of_type_Int;
      this.jdField_a_of_type_JavaLangString = localampz.jdField_a_of_type_JavaLangString;
      if (localampz.jdField_b_of_type_Int == 1)
      {
        bool1 = true;
  ...
  private void m()
  {
    ...
    {
      Object localObject2 = this.jdField_a_of_type_Aukp.a(MayKnowExposure.class, false, null, null, null, null, null, null);
  ...
  private void n()
  {
    Object localObject1 = (ArrayList)this.jdField_a_of_type_Aukp.a(RecentRecommendTroopItem.class);
    Object localObject3;
    int k;
  ...
  private void o()
  {
    ...
    ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukp.a(MayKnowRecommend.class, false, "tabID=? or tabID is null", new String[] { "23" }, null, null, null, null);
    Object localObject3;
    if (QLog.isColorLevel())
    {
    ...
    synchronized (this.jdField_d_of_type_JavaLangObject)
    {
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          {
            localArrayList.add(aflw.a(((JSONArray)localObject4).getJSONObject(k)));
            k += 1;
          }
  ...
  public int a()
  {
    ...
    int k = 0;
    p();
    if (!((afry)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c()) {}
    for (int m = 1;; m = 0) {
      label148:
      for (;;)
      {
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              aflw localaflw = (aflw)localIterator.next();
              if ((localaflw.jdField_a_of_type_Int != 23) && (m == 0)) {
                break label148;
              }
              k = localaflw.jdField_b_of_type_Int + k;
              break label148;
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public ArrayList<aflw> a()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        localaflw = aflw.a((aflw)localIterator.next());
        if (localaflw.jdField_a_of_type_Int == 23)
        {
          localaflw.jdField_a_of_type_Boolean = true;
          localArrayList.add(localaflw);
        }
      }
      localaflw.jdField_a_of_type_Boolean = bool;
    }
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              aflw localaflw = (aflw)((Iterator)localObject3).next();
              if ((localaflw.equals(paramList)) && ((localaflw.jdField_b_of_type_Int != paramList.jdField_b_of_type_Int) || (!localaflw.jdField_a_of_type_JavaLangString.equals(paramList.jdField_a_of_type_JavaLangString)) || (!localaflw.jdField_b_of_type_JavaLangString.equals(paramList.jdField_b_of_type_JavaLangString)) || (!localaflw.c.equals(paramList.c))))
              {
                localaflw.jdField_b_of_type_Int = paramList.jdField_b_of_type_Int;
                localaflw.jdField_a_of_type_JavaLangString = paramList.jdField_a_of_type_JavaLangString;
                localaflw.jdField_b_of_type_JavaLangString = paramList.jdField_b_of_type_JavaLangString;
                localaflw.c = paramList.c;
                d(this.jdField_c_of_type_JavaUtilArrayList);
              }
            }
          }
  ...
  public void a(View paramView, Context paramContext, String paramString)
  {
    ...
    if ((paramString.equals("sp_uin_for_title")) && (k == 2131374956))
    {
      paramView = bfpc.a(paramContext);
      paramView.b(2131691252);
      paramView.c(2131690596);
      paramView.a(new akab(this, paramView));
      paramView.show();
      axqy.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_ellipsis", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return;
      if ((paramView.getTag() != null) && ((paramView.getTag() instanceof ahpa)))
      {
        paramView = (ahpa)paramView.getTag();
        if (paramView.a == null) {
          break;
        }
        ...
        for (paramView = (RecentRecommendTroopItem)paramView.a.mUser.extraInfo; paramView != null; paramView = null)
        {
          ...
          if (k == 2131363569)
          {
            ...
            axqy.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_add", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
            return;
          }
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty(paramView.recommendReason))
              {
                ...
                localObject = mya.a(paramView);
                if (localObject != null) {
                  paramString.labels = ((ArrayList)localObject);
                }
                paramString.strJoinSig = paramView.authSig;
                banb.a(paramContext, banb.a(107, paramString, 10018, false), 2);
                axqy.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_grp", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
                return;
              }
            }
      ...
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaLangObject)
        {
          ...
          if ((paramBoolean) && (localMayKnowRecommend != null)) {
            this.jdField_a_of_type_Aukp.b(localMayKnowRecommend);
          }
          p();
          ...
          synchronized (this.jdField_c_of_type_JavaUtilArrayList)
          {
            ...
            for (;;)
            {
              ...
              localaflw = (aflw)localIterator.next();
              label217:
              label222:
              synchronized (this.jdField_f_of_type_JavaLangObject)
              {
                ...
                {
                  if (localaflw.jdField_b_of_type_Int <= 0) {
                    break;
                  }
                  k = localaflw.jdField_b_of_type_Int - 1;
                  localaflw.jdField_b_of_type_Int = k;
                }
              }
            }
          }
        ...
        break label217;
        label252:
        Object localObject3 = (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(localaflw.jdField_a_of_type_Int));
        if (localObject3 != null)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            localaflw.jdField_b_of_type_Int -= 1;
          }
        }
      }
      label336:
  ...
  public void a(@NonNull ArrayList<MayKnowRecommend> paramArrayList)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_1
    //   5: invokevirtual 309	java/util/ArrayList:isEmpty	()Z
    //   8: ifeq +29 -> 37
    //   11: invokestatic 235	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +22 -> 36
    //   17: ldc 237
    //   19: iconst_2
    //   20: invokestatic 1245	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   23: ldc_w 1247
    //   26: iconst_0
    //   27: anewarray 4	java/lang/Object
    //   30: invokestatic 1251	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   33: invokestatic 252	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   36: return
    //   37: aload_0
    //   38: aload_1
    //   39: invokespecial 327	akaa:b	(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    //   42: astore 4
    //   44: aload 4
    //   46: astore_3
    //   47: aload 4
    //   49: invokeinterface 263 1 0
    //   54: sipush 1000
    //   57: if_icmple +15 -> 72
    //   60: aload 4
    //   62: iconst_0
    //   63: sipush 1000
    //   66: invokeinterface 1255 3 0
    //   71: astore_3
    //   72: getstatic 46	akaa:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   75: astore 4
    //   77: aload 4
    //   79: monitorenter
    //   80: aload_0
    //   81: getfield 135	akaa:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   84: invokevirtual 1198	java/util/ArrayList:clear	()V
    //   87: aload_0
    //   88: getfield 135	akaa:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: aload_3
    //   92: invokevirtual 331	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   95: pop
    //   96: aload 4
    //   98: monitorexit
    //   99: aload_0
    //   100: getfield 124	akaa:jdField_a_of_type_Aukp	Laukp;
    //   103: invokevirtual 336	aukp:a	()Laukr;
    //   106: astore 4
    //   108: aload 4
    //   110: invokevirtual 340	aukr:a	()V
    //   113: aload_0
    //   114: getfield 124	akaa:jdField_a_of_type_Aukp	Laukp;
    //   117: ldc_w 632
    //   120: invokevirtual 347	aukp:b	(Ljava/lang/String;)Z
    //   123: pop
    //   124: aload_3
    //   125: invokeinterface 263 1 0
    //   130: ifle +145 -> 275
    //   133: aload_3
    //   134: invokeinterface 523 1 0
    //   139: astore_3
    //   140: aload_3
    //   141: invokeinterface 356 1 0
    //   146: ifeq +129 -> 275
    //   149: aload_0
    //   150: aload_3
    //   151: invokeinterface 360 1 0
    //   156: checkcast 362	com/tencent/mobileqq/data/MayKnowRecommend
    //   159: invokevirtual 1257	akaa:a	(Lauko;)Z
    //   162: pop
    //   163: goto -23 -> 140
    //   166: astore_3
    ...
    //   176: ldc_w 1259
    //   179: aload_3
    //   180: invokestatic 370	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   183: aload 4
    //   185: invokevirtual 372	aukr:b	()V
    //   188: iconst_0
    //   189: istore_2
    //   190: aload_0
    //   191: getfield 96	akaa:jdField_f_of_type_JavaLangObject	Ljava/lang/Object;
    //   194: astore_3
    //   195: aload_3
    //   196: monitorenter
    //   197: aload_0
    //   198: getfield 83	akaa:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   201: ifnull +10 -> 211
    //   204: aload_0
    //   205: getfield 83	akaa:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   208: invokevirtual 1260	java/util/HashMap:clear	()V
    //   211: aload_3
    //   212: monitorexit
    //   213: invokestatic 235	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   216: ifeq -180 -> 36
    //   219: ldc 237
    //   221: iconst_2
    //   222: invokestatic 1245	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   225: ldc_w 1262
    //   228: iconst_3
    ...
    //   233: iconst_0
    //   234: aload_1
    //   235: invokevirtual 312	java/util/ArrayList:size	()I
    //   238: invokestatic 378	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   241: aastore
    //   242: dup
    //   243: iconst_1
    //   244: aload_0
    //   245: getfield 135	akaa:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   248: invokevirtual 312	java/util/ArrayList:size	()I
    //   251: invokestatic 378	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   254: aastore
    //   255: dup
    //   256: iconst_2
    //   257: iload_2
    //   258: invokestatic 1267	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   261: aastore
    //   262: invokestatic 1251	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   265: invokestatic 252	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   268: return
    //   269: astore_1
    //   270: aload 4
    //   272: monitorexit
    ...
    //   274: athrow
    //   275: aload 4
    //   277: invokevirtual 387	aukr:c	()V
    //   280: aload 4
    //   282: invokevirtual 372	aukr:b	()V
    //   285: iconst_1
    //   286: istore_2
    //   287: goto -97 -> 190
    //   290: astore_1
    //   291: aload 4
    //   293: invokevirtual 372	aukr:b	()V
    //   296: aload_1
    //   297: athrow
    //   298: astore_1
    //   299: aload_3
  ...
  public void a(List<String> paramList, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    //   1: ifnull +12 -> 13
    //   4: aload_1
    //   5: invokeinterface 761 1 0
    //   10: ifeq +4 -> 14
    //   13: return
    //   14: new 126	java/util/ArrayList
    //   17: dup
    //   18: invokespecial 133	java/util/ArrayList:<init>	()V
    //   21: astore 7
    //   23: getstatic 46	akaa:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   26: astore 8
    //   28: aload 8
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 135	akaa:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   35: invokevirtual 351	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   38: astore 9
    //   40: aload 9
    //   42: invokeinterface 356 1 0
    //   47: ifeq +92 -> 139
    //   50: aload 9
    //   52: invokeinterface 360 1 0
    //   57: checkcast 362	com/tencent/mobileqq/data/MayKnowRecommend
    //   60: astore 10
    //   62: aload 10
    //   64: ifnull -24 -> 40
    //   67: aload_1
    //   68: aload 10
    //   70: getfield 551	com/tencent/mobileqq/data/MayKnowRecommend:uin	Ljava/lang/String;
    //   73: invokeinterface 1269 2 0
    //   78: ifeq -38 -> 40
    //   81: iload 6
    //   83: ifeq +39 -> 122
    //   86: aload 10
    //   88: getfield 1295	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   91: lload 4
    //   93: ladd
    //   94: lload_2
    //   95: lcmp
    ...
    //   99: aload 10
    //   101: lload_2
    //   102: putfield 1295	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   105: aload 7
    //   107: aload 10
    //   109: invokevirtual 559	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   112: pop
    //   113: goto -73 -> 40
    //   116: astore_1
    //   117: aload 8
    ...
    //   122: aload 10
    //   124: lload_2
    //   125: putfield 1295	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   128: aload 7
    //   130: aload 10
    //   132: invokevirtual 559	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   135: pop
    //   136: goto -96 -> 40
    //   139: aload 8
    //   141: monitorexit
    //   142: aload 7
    //   144: invokevirtual 309	java/util/ArrayList:isEmpty	()Z
    //   147: ifne -134 -> 13
    //   150: aload_0
    //   151: getfield 124	akaa:jdField_a_of_type_Aukp	Laukp;
    //   154: invokevirtual 336	aukp:a	()Laukr;
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 340	aukr:a	()V
    //   162: aload 7
    //   164: invokevirtual 351	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   167: astore 7
    //   169: aload 7
    //   171: invokeinterface 356 1 0
    //   176: ifeq +46 -> 222
    //   179: aload 7
    //   181: invokeinterface 360 1 0
    //   186: checkcast 362	com/tencent/mobileqq/data/MayKnowRecommend
    //   189: astore 8
    //   191: aload 8
    //   193: ifnull -24 -> 169
    //   196: aload_0
    //   197: aload 8
    //   199: invokevirtual 1257	akaa:a	(Lauko;)Z
    //   202: pop
    //   203: goto -34 -> 169
    //   206: astore 7
    //   208: ldc 237
    //   210: iconst_1
    //   211: ldc_w 1297
    //   214: invokestatic 989	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   217: aload_1
    //   218: invokevirtual 372	aukr:b	()V
    //   221: return
    //   222: aload_1
    //   223: invokevirtual 387	aukr:c	()V
    //   226: aload_1
    //   227: invokevirtual 372	aukr:b	()V
    //   230: return
    //   231: astore 7
    //   233: aload_1
    //   234: invokevirtual 372	aukr:b	()V
    //   237: aload 7
    //   239: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void a(boolean paramBoolean, List<oidb_0xc26.RecommendInfo> arg2)
  {
    ...
    localaukr.a();
    this.jdField_a_of_type_Aukp.b("delete from RecentRecommendTroopItem");
        ...
        for (;;)
        {
          if (localIterator2.hasNext())
          {
            ...
            if (localRgroupInfo.uint64_group_code.has())
            {
              ...
              localRecentRecommendTroopItem.labelList = akfc.b(localRgroupInfo.rpt_group_label.get());
    ...
    for (;;)
    {
      ...
      for (k = localRgroupInfo.int32_uin_privilege.get();; k = -1)
      {
        ...
        this.jdField_a_of_type_Aukp.b(localRecentRecommendTroopItem);
  ...
  protected boolean a(auko paramauko)
  {
    ...
    QLog.d("MayknowRecommendManager", 2, "updateEntity em closed e=" + paramauko.getTableName());
    return false;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      paramString = localaktf.b(paramString, 8112);
      bool1 = bool2;
      if (paramString != null)
      {
  ...
  public boolean a(List<RecentBaseData> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (m < paramList.size())
      {
        ...
        i1 = n;
        if (!ahmv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject2)) {
          i1 = n + 1;
        }
        if (i1 == 3) {
          m += 1;
  ...
  public boolean a(boolean paramBoolean, List<MayKnowRecommend> paramList)
  {
    ...
    for (paramList = new LinkedList(this.jdField_a_of_type_JavaUtilArrayList);; paramList = null)
    {
      ...
      if ((paramList != null) && (!paramList.isEmpty()))
      {
        ...
        {
          ((aukr)???).a();
          this.jdField_a_of_type_Aukp.b("delete from MayKnowRecommend where tabID=23");
          paramList = paramList.iterator();
    ...
    try
    {
      if (this.jdField_c_of_type_JavaUtilArrayList != null)
      {
        ...
        if (!this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
          localObject1 = (aflw)this.jdField_c_of_type_JavaUtilArrayList.get(0);
        }
      }
      if (localObject1 != null)
      {
        localObject1 = a(((aflw)localObject1).jdField_a_of_type_Int);
        if (localObject1 != null) {
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localaflw.jdField_a_of_type_Int != 23)
        {
          a(localaflw.jdField_a_of_type_Int, new ArrayList(0), true);
          a(localaflw.jdField_a_of_type_Int, null);
        }
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          if (((aflw)localIterator.next()).jdField_a_of_type_Int != paramInt) {
            continue;
          }
        ...
        if (bool1)
        {
          ...
          if (!TextUtils.equals(paramString, "sp_mayknow_ml_s_a_vl"))
          {
            ...
            if (!TextUtils.equals(paramString, "sp_mayknow_addpage_s_a_vl"))
            {
              ...
              {
                afry localafry = (afry)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
                bool2 = bool1;
                if (localafry != null)
                {
                  bool2 = bool1;
        ...
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            if (??? != null)
            {
              ...
              this.jdField_a_of_type_Aukp.a((auko)???, "uin=?", new String[] { localObject4 });
            }
          }
          return false;
        }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if ((localObject4 != null) && (!((List)localObject4).isEmpty()) && (bool))
        {
          aktf localaktf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
          localaktf.b(8112);
          ??? = localaktf.b(ajsd.ag, 8111);
          if (??? != null) {
            localaktf.b((RecentUser)???);
          }
          localaktf.b(8113);
          Object localObject2 = localaktf.b("sp_uin_for_title", 8113);
          ??? = localObject2;
          if (localObject2 == null) {
          ...
          ??? = localaktf.b(localRecentRecommendTroopItem.uin, 8113);
          if (??? != null) {
            break label404;
          }
  ...
  public void c(String paramString)
  {
    ...
    a(paramString);
    ((akfc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new akae(this, paramString));
    ...
    if (this.jdField_e_of_type_Int == 0)
    {
      ...
      axqy.b(null, "dc00899", "Grp_recom", "", "link_top", "clk_hide", 0, 0, "", "", "", "");
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject1 = localaktf.b(ajsd.ag, 8111);
      if (localObject1 != null) {
        localaktf.b((RecentUser)localObject1);
      }
      localaktf.b(8112);
      localRecentUser = localaktf.b("sp_uin_for_title", 8112);
      ...
      localaktf.a((RecentUser)localObject1);
      Iterator localIterator = ((ArrayList)localObject2).iterator();
      if (!localIterator.hasNext()) {
        break label462;
      }
      localMayKnowRecommend = (MayKnowRecommend)localIterator.next();
      localRecentUser = localaktf.b(localMayKnowRecommend.uin, 8112);
      if (localRecentUser != null) {
        break label479;
      }
    ...
    for (;;)
    {
      ...
      break;
      localaktf.b(8112);
      localRecentUser = localaktf.b(ajsd.ag, 8111);
      if (QLog.isColorLevel()) {
      ...
      localObject1 = localRecentUser;
      if (localRecentUser == null) {
        localObject1 = new RecentUser(ajsd.ag, 8111);
      }
      localaktf.a((RecentUser)localObject1);
  ...
  public void d(String paramString)
  {
    ...
    ((akfc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new akaf(this, paramString));
    ...
    {
      axqy.b(null, "dc00899", "Grp_recom", "", "msg_tab", "slide_delete", 0, 0, paramString, (String)localObject, "", "");
      return;
  ...
  public void e()
  {
    ...
    aktf localaktf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    localaktf.b(8112);
    RecentUser localRecentUser = localaktf.b(ajsd.ag, 8111);
    if (QLog.isColorLevel()) {
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_Aukp == null)) {}
    for (;;)
    {
      return;
  ...
  public void j()
  {
    ...
    {
      this.jdField_a_of_type_MqqOsMqqHandler.post(new MayknowRecommendManager.12(this));
