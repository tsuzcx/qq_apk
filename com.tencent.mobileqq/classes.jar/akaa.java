  ...
  implements View.OnClickListener, aobv
{
  ...
  private akac jdField_a_of_type_Akac = new akac();
  akah jdField_a_of_type_Akah;
  protected alby a;
  ...
  public akaa(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, akah paramakah)
  {
    ...
    this.jdField_a_of_type_Akah = paramakah;
  }
  
  protected View a()
  {
    return View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559430, null);
  }
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramDrawable == null)
        {
          localDrawable = paramDrawable;
          if (this.jdField_a_of_type_Alby != null) {
            localDrawable = this.jdField_a_of_type_Alby.a(paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin());
          }
        }
      } while (this.jdField_a_of_type_Akac == null);
      try
      {
        this.jdField_a_of_type_Akac.a(paramView, paramRecentBaseData, this.jdField_a_of_type_AndroidContentContext, localDrawable);
        return;
      }
      catch (Throwable paramView) {}
    } while (!alcu.b(this.jdField_a_of_type_AndroidContentContext));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        alcu.a(this.jdField_a_of_type_AndroidContentContext, false, localThrowable);
        if (!alcu.b(this.jdField_a_of_type_AndroidContentContext)) {
          continue;
        }
      ...
      return paramView;
      localObject2 = paramView;
      localObject1 = this.jdField_a_of_type_Akac.a(paramInt, localObject1, this.jdField_a_of_type_Alby, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, null, null);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject instanceof RecentBaseData))
      {
        ...
        if (this.jdField_a_of_type_Akah != null)
        {
          this.jdField_a_of_type_Akah.a((RecentBaseData)localObject);
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        i = ((Integer)alby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, paramString).first).intValue();
        if (i == -2147483648) {
          break label667;
        }
        ...
        {
          l = System.currentTimeMillis();
          paramBitmap = BaseApplication.getContext().getResources().getDrawable(2130840344);
