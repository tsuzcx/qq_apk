  ...
  extends PostHttpRequest
{
  public int a(JceStruct paramJceStruct)
  {
    ...
    catch (Throwable paramJceStruct)
    {
      ...
      ((SdkInfo)localObject).versionName = bfbm.a().c();
      ...
      ((TicketWtLogin)localObject).uin = bfbm.a().a();
      ((TicketWtLogin)localObject).A2 = bfbm.a().b().getBytes();
