  ...
  implements Observer
{
  ...
  bfin(QQAppInterface paramQQAppInterface, Context paramContext, bfhz parambfhz, SessionInfo paramSessionInfo)
  {
  ...
  public bfhr a(int paramInt1, List<Long> paramList, long paramLong1, Object paramObject, long paramLong2, long paramLong3, int paramInt2)
  {
    ...
    if ((paramList != null) && (a(paramList, paramLong2, paramLong3))) {
      return new bfhr(true, this.jdField_a_of_type_AndroidContentContext.getString(2131696906), bepx.a(paramInt1, paramLong1, paramInt2), paramList.senderuin);
    }
    return null;
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_Besj = null;
    awne localawne = (awne)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
    long l = bgnu.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if (l == -1L) {
      return;
    }
    this.jdField_a_of_type_Besf = localawne.a(Long.valueOf(l), true);
  ...
  public void a(int paramInt, Object paramObject, String paramString)
  {
    ...
    if (paramObject != null)
    {
      ...
      if (paramObject != null)
      {
        boolean bool = paramString.equals(this.jdField_a_of_type_AndroidContentContext.getString(2131696918));
    ...
    {
      bcst.b(paramString, "dc00898", "", "", "", "0X800AACB", 0, 1, 0, str, String.valueOf(l), paramObject, "");
      return;
    }
  }
  ...
  public void b(int paramInt, Object paramObject, String paramString)
  {
    ...
    for (paramObject = "2";; paramObject = "1")
    {
      bcst.b(paramString, "dc00898", "", "", "", "0X800AACC", 0, 1, 0, str, String.valueOf(l), paramObject, "");
      return;
    }
  }
  ...
  void c()
  {
    boolean bool3 = this.jdField_a_of_type_Bfhz.d();
    if (QLog.isColorLevel()) {
      QLog.d("TroopAioMsgNavigateNotification", 2, "showTroopNotifyBar troopNotifyData = " + this.jdField_a_of_type_Besj + ",  mFIsShow = " + bool3);
    }
    ...
    if (bool3)
    {
      localObject1 = str2;
      bool1 = bool2;
      if (!this.jdField_a_of_type_Besj.b)
      {
        localObject1 = str2;
        bool1 = bool2;
        if ((this.jdField_a_of_type_JavaLangObject instanceof MessageForArkApp))
        {
          localObject1 = str2;
          bool1 = bool2;
          if (!this.jdField_a_of_type_Besj.d)
          {
    ...
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("TroopAioMsgNavigateNotification", 2, "showTroopNotifyBar mTroopNotifyData confirmRequired:" + this.jdField_a_of_type_Besj.c + " fid:" + this.jdField_a_of_type_Besj.jdField_a_of_type_JavaLangString + " isShowTipWindow:" + this.jdField_a_of_type_Besj.b);
        }
        localObject1 = new JSONObject(((MessageForArkApp)localObject2).ark_app_message.metaList).optJSONObject("mannounce");
        localObject2 = this.jdField_a_of_type_Bfhz.a();
        if ((localObject1 == null) || (localObject2 == null) || (!((JSONObject)localObject1).optString("fid").equals(this.jdField_a_of_type_Besj.jdField_a_of_type_JavaLangString))) {
          continue;
        }
        ...
        if ((localObject1 == null) || (!a((MessageRecord)localObject1, l, this.jdField_a_of_type_Bfhz.a()))) {
          continue;
        }
        if (!this.jdField_a_of_type_Besj.c) {
          continue;
        }
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131696918);
        bool1 = true;
      }
      ...
      this.jdField_a_of_type_Bfhz.a(new bfhr(bool1, (String)localObject1, null, ""));
      this.jdField_a_of_type_Besj = null;
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      return;
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131696906);
    }
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Besf != null) && (this.jdField_a_of_type_Besf.b != null)) {
        try
        {
          this.jdField_a_of_type_Besj = besj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Besf.b);
          c();
          return;
        }
        finally {}
