...
public abstract class ovg<K, D>
  extends RecyclerView.Adapter<biej>
{
  protected int a;
  protected Context a;
  ...
  public ovg(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    ...
    opy.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, a());
