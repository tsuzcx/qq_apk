...
public class bbrb
  extends QIPCModule
{
  private static bbrb a;
  
  private bbrb(String paramString)
  {
    super(paramString);
  }
  
  /* Error */
  public static bbrb a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bbrb:a	Lbbrb;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bbrb:a	Lbbrb;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bbrb
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bbrb:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bbrb:a	Lbbrb;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bbrb:a	Lbbrb;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          ((akjn)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(27)).notifyUI(5, true, paramBundle);
