...
public class afbu
{
  ...
  public static afbu a(SharedPreferences paramSharedPreferences, int paramInt)
  {
    ...
    afbu localafbu = new afbu();
    localafbu.jdField_a_of_type_Long = paramSharedPreferences.getLong(str1, 0L);
    if (DateUtils.isToday(localafbu.jdField_a_of_type_Long)) {
      try
      {
        ...
        {
          localafbu.a(paramSharedPreferences.getString(paramInt), paramSharedPreferences.getInt(paramInt + 1));
          paramInt += 2;
          continue;
          localafbu.jdField_a_of_type_Long = System.currentTimeMillis();
        }
      }
  ...
  public static void a(SharedPreferences paramSharedPreferences, afbu paramafbu, int paramInt)
  {
    paramafbu.a();
    Object localObject = new JSONArray();
    Iterator localIterator = paramafbu.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
    ...
    if (paramInt == 2)
    {
      ...
      paramSharedPreferences.putLong("web_uin_list_time_millis", paramafbu.jdField_a_of_type_Long);
    }
    for (;;)
    {
      ...
      paramSharedPreferences.putLong("bless_uin_list_time_millis", paramafbu.jdField_a_of_type_Long);
    }
  }
