  ...
  implements oyp
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull pcf parampcf, @NotNull pdp parampdp, @NotNull ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener((ViewBase.OnClickListener)new ozp(parampcf, parampdp));
    parampdp = paramViewBase.findViewBaseByName("id_comment_expose_subcomment_one");
    if ((parampdp instanceof pha)) {
      ((pha)parampdp).a(parampcf, (View)paramContainer, 0);
    }
  }
}
