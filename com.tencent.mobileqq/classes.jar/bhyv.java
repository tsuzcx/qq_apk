...
public class bhyv
{
  ...
  @Deprecated
  public bhyv(String paramString1, String paramString2)
  {
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.b = paramString1;
    if (!anrx.a().containsKey(paramString2)) {
      anrx.a(paramString2, new int[] { BusinessHandlerFactory.SVIP_HANDLER });
    }
  }
  
  public bhyv(String paramString1, String paramString2, int paramInt)
  {
  ...
  public bhyv(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    this(paramString1, paramString2);
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.b = paramString1;
    anrx.a(paramString2, a(paramString2, BusinessHandlerFactory.SVIP_HANDLER));
    this.c = paramString3;
    this.d = paramString4;
  }
  ...
  private int[] a(String paramString, int paramInt)
  {
    ...
    {
      localObject = (int[])anrx.a().get(paramString);
  ...
  public void a(String paramString, JceStruct paramJceStruct1, JceStruct paramJceStruct2, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    paramBusinessObserver = ((aocy)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).createToServiceMsg(this.jdField_a_of_type_JavaLangString, paramBusinessObserver, paramBoolean);
    ...
    localQQAppInterface.sendToService(paramBusinessObserver);
  }
}
