...
public class bhyv
{
  ...
  private static bhyv jdField_a_of_type_Bhyv;
  ...
  public static bhyv a()
  {
    if (jdField_a_of_type_Bhyv == null) {}
    try
    {
      if (jdField_a_of_type_Bhyv == null) {
        jdField_a_of_type_Bhyv = new bhyv();
      }
      return jdField_a_of_type_Bhyv;
    }
    finally {}
  }
  ...
  public void a(bhza parambhza)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambhza.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bhyw(this, parambhza));
  }
  ...
  public void b(bhza parambhza)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambhza.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bhyx(this, parambhza));
  }
}
