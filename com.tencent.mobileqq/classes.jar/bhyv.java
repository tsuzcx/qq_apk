  ...
  extends PopupWindow
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bhyy();
  ...
  public bhyv(Context paramContext, int paramInt1, int paramInt2)
  {
    this(paramContext, paramInt1, -2, paramInt2);
  }
  
  public bhyv(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public static bhyw a(Context paramContext)
  {
    return new bhyw(paramContext, null);
  }
  ...
  private void d(View paramView, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        i = bcwh.a(paramView.getContext(), 300.0F);
        int j = bcwh.a(paramView.getContext(), 120.0F);
        this.jdField_a_of_type_AndroidWidgetFrameLayout.measure(i, j);
        this.jdField_b_of_type_Int = bcwh.a(paramView.getContext(), this.jdField_b_of_type_Int);
        ...
        if ((this.e == 51) || (this.e == 52))
        {
          ...
          if (this.e == 51)
          {
            ...
            if (this.c == 83)
            {
              ...
              e(paramView, j, i);
              wsv.b("CalloutPopupWindow.VASH", "show tips xoff=%d, yAnchorOff=%d, yoff=%d", Integer.valueOf(j), Integer.valueOf(i), Integer.valueOf(paramInt2));
  ...
  public void c(View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        int n = bcwh.a(paramView.getContext(), 300.0F);
        int i1 = bcwh.a(paramView.getContext(), 120.0F);
