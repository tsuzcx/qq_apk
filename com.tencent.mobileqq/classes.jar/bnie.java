  ...
  implements bnic
{
  ...
  private bnid jdField_a_of_type_Bnid;
  private bnig jdField_a_of_type_Bnig;
  private bnih jdField_a_of_type_Bnih;
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Bnib == null) || (this.jdField_a_of_type_Bnib.a())) {}
    int i;
    do
    {
      return;
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      b();
      if (this.jdField_a_of_type_Bnid != null) {
        this.jdField_a_of_type_Bnid.invalidate();
      }
    ...
    {
      return;
      this.jdField_a_of_type_Bnih.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Bnig.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Bnid.postInvalidate();
  }
  ...
  {
    if (this.jdField_a_of_type_Bnib == null) {
      return;
    }
    c();
    ...
    while (i < k)
    {
      bnif localbnif = this.jdField_a_of_type_Bnib.a(i);
      if (localbnif != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localbnif.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
