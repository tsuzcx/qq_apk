...
public class azmt
{
  ...
  {
    byte[] arrayOfByte = bbdx.a(BaseApplication.getContext().getFileStreamPath("0x496_aio_keyword"));
  ...
  public static List<azmu> a(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      azmu localazmu = new azmu();
      localazmu.jdField_a_of_type_JavaLangString = localAioKeywordInfo.word.get();
      localazmu.jdField_a_of_type_JavaUtilList = localAioKeywordInfo.rule_id.get();
      localArrayList.add(localazmu);
    }
    return localArrayList;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localFileOutputStream;
        localObject2 = localFileOutputStream;
        bbkb.O(BaseApplicationImpl.getApplication(), paramQQAppInterface.getCurrentAccountUin(), paramAioKeyword.version.get());
      }
  ...
  public static List<azmv> b(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      azmv localazmv = new azmv();
      localazmv.jdField_a_of_type_Int = localAioKeywordRuleInfo.rule_id.get();
      localazmv.b = localAioKeywordRuleInfo.start_time.get();
      localazmv.c = localAioKeywordRuleInfo.end_time.get();
      localazmv.d = localAioKeywordRuleInfo.postion_flag.get();
      localazmv.jdField_a_of_type_JavaUtilList = localAioKeywordRuleInfo.match_group_class.get();
      localazmv.e = localAioKeywordRuleInfo.version.get();
      localArrayList.add(localazmv);
    }
    return localArrayList;
  }
}
