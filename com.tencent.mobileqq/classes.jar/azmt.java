...
{
  azmt(azms paramazms, RelativeLayout.LayoutParams paramLayoutParams, View paramView1, View paramView2) {}
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    do
    {
      ...
      int i = (int)(-azms.a(this.jdField_a_of_type_Azms) * f);
    ...
    } while (!this.jdField_a_of_type_Azms.f);
