...
public class akqs
  extends akov
{
  public akqs(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
        ...
        for (;;)
        {
          try
          {
            ...
            else
            {
              ...
              if (j == 0)
              {
                paramToServiceMsg = (ayax)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
                if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    localayay.jdField_b_of_type_JavaLangString = str2;
    localayay.jdField_c_of_type_JavaLangString = str1;
    if (QLog.isColorLevel()) {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("printPBuffer", 2, bbea.a((byte[])paramObject));
      }
    ...
    else
    {
      ...
      axrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", false, 0L, 0L, paramToServiceMsg, "");
      a(8003, false, localayay);
      return;
    }
    label336:
    label351:
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        default: 
          ...
          {
            localayay.jdField_a_of_type_Int = 1004;
            localayay.jdField_b_of_type_Int = i;
            localayay.jdField_a_of_type_JavaLangString = paramObject.errmsg.get();
            localayay.jdField_c_of_type_Boolean = true;
            ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, str1);
            ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, 6);
            localayay.d = true;
            localayax.a(str1, null, true);
            bool1 = localayax.a(str1, 3);
            localayax.a(str1, i, paramObject.errmsg.get());
            localayax.e(str1);
            if (bool1)
            {
              ...
              if (i != 0)
              {
                ...
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(new String[] { ajsd.x, str1 });
              }
              if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          return;
          localayay.jdField_a_of_type_Int = 1008;
          ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sub.uin.all");
          continue;
          localayay.jdField_a_of_type_Int = 1002;
          ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, str1);
          ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1);
          continue;
          localayay.jdField_a_of_type_Int = 1006;
          continue;
          localayay.jdField_a_of_type_Int = 1000;
        }
        localayax.a(str1, 1);
                ...
                for (localObject1 = paramObject.sync_cookie.get().toByteArray();; localObject1 = null)
                {
                  ...
                  for (int j = paramObject.sync_flag.get();; j = 2)
                  {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        if (localayax != null) {}
                        for (List localList1 = localayax.a(Long.toString(l3));; localList1 = null)
                        {
                          ...
                          for (;;)
                          {
                            ...
                            if (m < localList2.size())
                            {
                              ...
                              do
                              {
                                ...
                                localawzw = new awzw(l1, l6, false, false, false, true);
                              } while ((paramObject == null) || (paramObject.size() <= 0));
                              Collections.sort(paramObject, new akqt(this));
                                ...
                                if (localObject2 != null)
                                {
                                  ...
                                  for (;;)
                                  {
                                    for (;;)
                                    {
                                      ...
                                      paramObject.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131720731);
                                      paramObject.msgtype = 193;
                                      paramFromServiceMsg.add(paramObject);
                                      continue;
                                      if ((axau.c(i)) && (((msg_comm.MsgHead)localObject3).c2c_cmd.has()) && ((i1 == 169) || (i1 == 241) || (i1 == 242) || (i1 == 243) || (i1 == 129) || (i1 == 131) || (i1 == 133)))
                                      {
                                      ...
                                      try
                                      {
                                        paramFromServiceMsg = a((msg_comm.Msg)localObject2, localawzw);
                                        if (paramFromServiceMsg == null) {}
                                      }
                                      catch (Exception paramObject)
                                      {
                                  ...
                                  try
                                  {
                                    ...
                                    if (String.valueOf(ajsd.G).equalsIgnoreCase(((MessageRecord)localObject4).frienduin))
                                    {
                                      paramFromServiceMsg = ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, ((MessageRecord)localObject4).msgtype, ((MessageRecord)localObject4).senderuin);
                                      if (paramFromServiceMsg == null)
                                      {
                                        i = 1;
                              ...
                              for (;;)
                              {
                                try
                                {
                                  if (!bbbu.a(((MessageRecord)localObject4).msgtype)) {
                                    continue;
                                  }
                                  localObject4 = bbbu.a(((MessageRecord)localObject4).msg);
                                  paramFromServiceMsg = paramObject;
                                ...
                                paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131719902);
                                continue;
                                ...
                                else
                                {
                                  ...
                                  else
                                  {
                                    ...
                                    else
                                    {
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131692043);
                                      continue;
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131719782);
                                      continue;
                                      ...
                                      continue;
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(bbcc.a(((MsgBody)localObject4).shareAppID));
                                      ...
                                      continue;
                                      paramFromServiceMsg = paramObject;
                                      if (!bbbu.b(((MessageRecord)localObject4).msgtype))
                                      {
                                        paramFromServiceMsg = paramObject;
                                        if (((MessageRecord)localObject4).msg != null)
                                        {
                                          ...
                                          {
                                            localObject4 = axau.a(((MessageRecord)localObject4).msg);
                                            paramObject = "";
                                            paramFromServiceMsg = paramObject;
                                            if (localObject4 != null)
                                            {
                                            ...
                                            paramFromServiceMsg = "[" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131720374) + "] " + paramFromServiceMsg;
                                          }
                                        }
                                      }
                                    }
                              ...
                              if ((paramFromServiceMsg != null) && (paramFromServiceMsg.from_nick.has()))
                              {
                                ...
                                if (i != 0) {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131719985);
                                }
                                if (QLog.isColorLevel()) {
                                ...
                                if (i != 0)
                                {
                                  ((SubAccountMessage)localObject2).frienduin = String.valueOf(ajsd.G);
                                  label4222:
                                  if (!bool1) {
                                    break label4897;
                                  }
                                ...
                                for (l4 = System.currentTimeMillis() / 1000L;; l4 = l5)
                                {
                                  ...
                                  ((SubAccountMessage)localObject2).mTimeString = bbkp.a(1000L * l5, true, ayaq.jdField_a_of_type_JavaLangString);
                                  ...
                                  if (localayax != null) {
                                    localayax.a((SubAccountMessage)localObject2);
                                  }
                                  if (QLog.isColorLevel())
                                  {
                                  ...
                                  ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, 6);
                                  localayay.d = true;
                                  paramFromServiceMsg = axas.a(((MessageRecord)localObject3).msgtype);
                            ...
                            else
                            {
                              if ((localList1 != null) && (localList1.size() > 0) && (k != 0))
                              {
                                ...
                                if (i < localList1.size())
                                {
                                  ...
                                  for (;;)
                                  {
                                    i += 1;
                                    break;
                                    if (!paramFromServiceMsg.frienduin.equals(String.valueOf(ajsd.G)))
                                    {
                                      m = 0;
                                      ...
                                      if ((k != 0) && (localHashMap.containsKey(paramFromServiceMsg.frienduin))) {
                                        localayax.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l3), paramFromServiceMsg.frienduin, ((Integer)localHashMap.get(paramFromServiceMsg.frienduin)).intValue());
                                      }
                                      if ((k == 0) && (localayax != null))
                                      {
                                        k = localayax.a(String.valueOf(l3), paramFromServiceMsg.frienduin);
                                        if (k != 0)
                                        {
                              ...
                              {
                                if (localayax != null) {
                                  localayax.a(str1, (byte[])localObject1);
                                }
                                ...
                                axrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", true, 0L, 0L, paramFromServiceMsg, "");
                                if (b <= 0) {
                                  break label5377;
                                }
                                if (l3 <= 0L) {
                                ...
                                localayay.jdField_a_of_type_Boolean = false;
                                a(8003, true, localayay);
                                return;
                                label5350:
                              ...
                              localayay.jdField_a_of_type_Int = 0;
                              a(8003, true, localayay);
                              if (!QLog.isColorLevel()) {
                                break;
                              }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    return;
    new akqu(this, paramObject, str, (String)localObject, i, j).execute(new Void[0]);
  }
  ...
  public void a(byte paramByte, int paramInt, String paramString1, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    paramArrayList = (ayax)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
    ...
    for (paramArrayList = paramArrayList.a(paramString1);; paramArrayList = null)
    {
      ...
      catch (Exception paramString1)
      {
        try
        {
          do
          {
            localPbBindUinGetMsgReq.bind_uin_sig.set(ByteStringMicro.copyFrom(bbmx.a(paramString2)));
            if (paramArrayList == null) {
              break;
            }
            if (QLog.isColorLevel()) {
  ...
  public void a(RequestPushNotify paramRequestPushNotify)
  {
    ...
    {
      localObject = awzq.a(((MsgInfo)localObject).vMsg);
    ...
    do
    {
      ...
      try
      {
        ...
        axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localReqBody, paramRequestPushNotify.lBindedUin, true);
        return;
      }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    while (i < paramObject.thirdqq_resp_info.get().size())
    {
      ...
      ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, str, arrayOfByte, k, m, n, i1, i2);
      i += 1;
    }
    ayaq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, j);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (Object localObject = ((ayax)localObject).a(paramString1);; localObject = null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localObject2 != null)
        {
          try
          {
            ...
            localThirdQQReqInfo.third_uin_sig.set(ByteStringMicro.copyFrom(bbmx.a((String)localObject3)));
            localObject3 = ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
  ...
  public boolean a(SubAccountInfo paramSubAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      ((Oidb_0x5d0.ReqBody)localObject1).uint32_start_time.set(ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramSubAccountInfo.subuin));
      try
      {
