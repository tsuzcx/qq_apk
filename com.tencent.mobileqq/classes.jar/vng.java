  ...
  extends xrg
{
  ...
  private vnh jdField_a_of_type_Vnh = new vnh(this);
  private vni jdField_a_of_type_Vni = new vni();
  private vnj jdField_a_of_type_Vnj = new vnj(this);
  private vnm jdField_a_of_type_Vnm;
  public weh a;
  
  public vng(Context paramContext)
  {
    super(paramContext);
  }
  ...
  public int a()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Weh != null)) {
      return this.jdField_a_of_type_Weh.a(b()).size();
    }
    return 0;
  }
  ...
  {
    if ((this.jdField_a_of_type_Weh == null) || (paramInt > this.jdField_a_of_type_Weh.a(b()).size()))
    {
      wsv.e("Q.qqstory.detail.DetailCommentSegment", "bind view failed. position is out of bound.");
      return paramwph.a();
    }
    CommentEntry localCommentEntry = (CommentEntry)this.jdField_a_of_type_Weh.a(b()).get(paramInt);
    ...
    localObject1 = localCommentEntry.commentId + localCommentEntry.feedId + localCommentEntry.status + this.jdField_a_of_type_Vnh.hashCode() + "bubble_style";
    ...
    for (;;)
    {
      localTextView2.setOnTouchListener(this.jdField_a_of_type_Vni);
      localTextView2.setSpannableFactory(baig.a);
      localTextView2.setTextColor(-16777216);
      break;
      localObject2 = weo.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Weh.a, localCommentEntry, this.jdField_a_of_type_Vnh);
      localTextView2.setText((CharSequence)localObject2);
      if (localCommentEntry.isReply())
      {
        localQQUserUIItem = ((usd)urr.a(2)).c(localCommentEntry.replierUnionId);
        if ((localQQUserUIItem == null) || (!localQQUserUIItem.isAvailable())) {
          break label352;
        }
  ...
  {
    if ((this.jdField_a_of_type_Weh == null) || (paramInt >= this.jdField_a_of_type_Weh.a(this.jdField_a_of_type_Vmu.a()).size())) {
      return null;
    }
    return (CommentEntry)this.jdField_a_of_type_Weh.a(this.jdField_a_of_type_Vmu.a()).get(paramInt);
  }
  ...
  public wph a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.a(this.jdField_a_of_type_Vnj);
  ...
  public void a(vmu paramvmu, vnm paramvnm, int paramInt)
  {
