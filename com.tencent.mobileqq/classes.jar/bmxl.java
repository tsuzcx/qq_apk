  ...
  extends bmxt
{
  ...
  public bmxl(Context paramContext, String paramString)
  {
  ...
  protected void a(Canvas paramCanvas, ArrayList<Integer> paramArrayList)
  {
    ...
    bmxz.a(((Integer)paramArrayList.get(this.jdField_c_of_type_Int)).intValue(), this.jdField_a_of_type_AndroidTextTextPaint);
    ...
    else
    {
      ...
      bmxz.a(((Integer)paramArrayList.get(this.e)).intValue(), this.jdField_a_of_type_AndroidTextTextPaint);
      ...
      bmxz.a(((Integer)paramArrayList.get(this.h)).intValue(), this.jdField_a_of_type_AndroidTextTextPaint);
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          this.i = this.jdField_a_of_type_Bmxh.a("X", 0L, 700L, -this.jdField_a_of_type_AndroidGraphicsRect.width(), this.jdField_a_of_type_AndroidGraphicsRect.width(), new LinearInterpolator());
          this.j = this.jdField_a_of_type_Bmxh.a("Y", 0L, 700L, -this.jdField_a_of_type_AndroidGraphicsRect.height(), this.jdField_a_of_type_AndroidGraphicsRect.height(), new LinearInterpolator());
          this.jdField_c_of_type_Int = this.jdField_a_of_type_Bmxh.a("firstFont", 500L, 200L, 0, 255, new LinearInterpolator());
          this.jdField_a_of_type_Float = a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
          this.jdField_d_of_type_Int = this.jdField_a_of_type_Bmxh.a("secondLine", 600L, 400L, 0, (int)(this.jdField_a_of_type_AndroidGraphicsRect.width() - 2.0F * this.jdField_a_of_type_Float), new LinearInterpolator());
          this.e = this.jdField_a_of_type_Bmxh.a("thirdFont", 800L, 500L, 0, 255, new LinearInterpolator());
          this.h = this.jdField_a_of_type_Bmxh.a("fourthFont", 900L, 500L, 0, 255, new LinearInterpolator());
          return;
