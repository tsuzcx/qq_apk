...
public class aeao
  extends apmh
{
  public aeao(TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment paramTeamWorkDocEditBrowserFragment) {}
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a) != null) && (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a).a()))
    {
      ...
      if (this.a.a().getStringExtra("tdsourcetag") != null)
      {
        ...
        str = baic.b(str, (String)localObject);
        ...
        for (;;)
        {
          bajr.a("WebLog_WebViewFragment", "get_url_time", String.valueOf(l) + " - url:" + str);
          return;
    ...
    if ((Math.abs(i) == 115) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      for (;;)
      {
        bajr.a("WebLog_WebViewFragment", "get_url_time", String.valueOf(l) + " - redirectUrl:" + (String)localObject);
        return;
        baic.a(paramBundle, "0X8009ED6");
    ...
    if (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a, null)) {
      bajr.a(null, "0X800A755");
    }
    bajr.a("WebLog_WebViewFragment", "get_url_time", "retCode = " + i + " errorStr = " + str);
  }
}
