  ...
  public static void a(TextView paramTextView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString)
  {
    ...
    for (;;)
    {
      if ((TextUtils.isEmpty(paramString)) && (paramInt1 == 0) && (paramInt2 == 0))
      {
        ...
        paramString = "";
        paramInt1 = 2130849288;
        paramInt2 = 0;
        break;
        if (paramInt3 > 0) {}
        for (paramInt2 = paramInt3;; paramInt2 = 2130849292)
        {
          paramString = "NEW";
          paramInt1 = 0;
          break;
      ...
      Object localObject = paramTextView.getTag(2131378650);
      ...
      for (;;)
      {
        ...
        if (!bbbd.a(paramTextView.getText().toString(), paramString))
        {
        ...
        paramTextView.setTag(2131378650, Integer.valueOf(paramInt1));
        paramTextView.setText(paramString);
