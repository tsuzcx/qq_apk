...
public class akoj
  extends akns
{
  public akoj(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = String.format(amtj.a(2131696887), new Object[] { amtj.a(2131714734) });
  ...
  {
    if ((paramObject instanceof akoj))
    {
      paramObject = (akoj)paramObject;
      paramObject.jdField_a_of_type_Bdyj.a(parambdyi.jdField_a_of_type_Bdyj);
      return paramObject;
    }
    paramObject = new akoj(BaseApplication.getContext());
