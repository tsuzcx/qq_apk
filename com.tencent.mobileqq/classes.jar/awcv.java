  ...
  extends ayen
{
  ...
  awcv(awcu paramawcu, ArrayList paramArrayList, HashMap paramHashMap, MessageRecord paramMessageRecord, awcd paramawcd, awcs paramawcs) {}
  
  private int a(MessageForPic paramMessageForPic, aydt paramaydt)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = FileUtils.calcMd5(awcm.a);
      ...
      for (;;)
      {
        if (i != 0)
        {
          ...
          if (paramaydt.jdField_a_of_type_Int == 0)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.e("PicMultiMsgProcessor", 2, "WTF, picResult.mExtraObj is " + paramaydt.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
            }
            i = 0;
            continue;
          }
      ...
      label591:
      for (int j = paramaydt.jdField_a_of_type_Aydp.jdField_a_of_type_Int;; j = -1)
      {
        i = j;
        if (!QLog.isColorLevel()) {
          break;
  ...
  private boolean a(ArrayList<aydt> paramArrayList)
  {
    ...
    if (n < this.b.size())
    {
      ...
      {
        i = k;
        if (((aydt)paramArrayList.get(j)).b) {
          i = 1;
        }
      }
      if (((localObject1 instanceof MessageForPic)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForPic))))
      {
        ...
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject1, (aydt)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
            b(m);
            if (!this.jdField_a_of_type_Awcu.a(m)) {
              break label288;
            }
            bool2 = true;
            k = i;
        ...
        for (;;)
        {
          ...
          break label152;
          localObject2 = this.jdField_a_of_type_Awcu.a.getMultiMessageProxy().a((MessageRecord)localObject1, awcu.a(), false);
          ...
          bool2 = this.jdField_a_of_type_Awcu.a.getMultiMessageProxy().a(this.jdField_a_of_type_JavaUtilHashMap, (MessageRecord)localObject2);
          if (QLog.isColorLevel()) {
      ...
      if (((localObject1 instanceof MessageForMixedMsg)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg)))) {
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject2, (aydt)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
    ...
    for (;;)
    {
      ...
      break label483;
      label724:
      localObject2 = this.jdField_a_of_type_Awcu.a.getMultiMessageProxy().a((MessageRecord)localObject2, amtj.a(2131707264), false);
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          i1 = a((MessageForPic)localObject3, (aydt)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (i1 != 0)
          {
            b(i1);
            if (this.jdField_a_of_type_Awcu.a(i1))
            {
              bool2 = true;
              k = i;
            }
        ...
        for (;;)
        {
          ...
          break label905;
          localObject3 = this.jdField_a_of_type_Awcu.a.getMultiMessageProxy().a((MessageRecord)localObject3, amtj.a(2131707265), false);
          ...
          if (((localObject1 instanceof MessageForStructing)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg))))
          {
            ...
            for (;;)
            {
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject2 != null) && (((bcjc)localObject2).a != null))
                {
                  localObject2 = ((bcjc)localObject2).a;
                  if (QLog.isColorLevel()) {
                    QLog.d("PicMultiMsgProcessor", 2, "updateMessageForPic for MessageForPic, MsgIndex[" + n + "], resultIndex[" + j + "]");
                  }
                  ...
                  k = a((MessageForPic)localObject2, (aydt)paramArrayList.get(j));
                  bool2 = bool1;
                  if (k != 0)
                  {
                    b(k);
                    bool2 = bool1;
                    if (this.jdField_a_of_type_Awcu.a(k)) {
                      bool2 = true;
                    }
                  }
                  k = j + 1;
                  ...
                  if (k != 0)
                  {
                    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                      bcef.b(this.jdField_a_of_type_Awcu.a, "CliOper", "", "", "0X800662B", "0X800662B", 0, 1, 0, "", "", "", "");
                    }
                    if (QLog.isColorLevel()) {
                      QLog.e("PicMultiMsgProcessor", 2, "requestUploadPics isPicMsgModify");
                    }
                    this.jdField_a_of_type_Awcu.a.getProxyManager().a().a(this.b, null);
                  }
                  if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                    bcef.b(this.jdField_a_of_type_Awcu.a, "CliOper", "", "", "0X800662A", "0X800662A", 0, 1, 0, "", "", "", "");
                  }
                  return bool1;
                }
              }
  ...
  public void a(int paramInt, ArrayList<aydt> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        this.jdField_a_of_type_Awcd.a(1, 1, this.jdField_a_of_type_Awcs);
        return;
    ...
    label317:
    this.jdField_a_of_type_Awcd.a(0, 1, this.jdField_a_of_type_Awcs);
  }
}
