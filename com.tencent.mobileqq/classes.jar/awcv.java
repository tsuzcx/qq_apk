...
public class awcv
{
  public static List<ChatMessage> a(List<ChatMessage> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((!acnh.k(localChatMessage.msgtype)) && (!afqy.a(localChatMessage))) {
  ...
  {
    axio.a().jdField_a_of_type_Int = 7;
    ...
    do
    {
      ...
      if (paramIntent.size() > 0)
      {
        ...
        while (paramQQAppInterface.hasNext())
        {
          ...
          axio.a().jdField_a_of_type_JavaUtilHashMap.put(localObject1, Boolean.valueOf(true));
        }
      }
