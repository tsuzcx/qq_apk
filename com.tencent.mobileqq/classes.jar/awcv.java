...
public class awcv
  implements awcg
{
  public awcv(SignTextEditFragment paramSignTextEditFragment) {}
  ...
  public void a(int paramInt, RichStatus paramRichStatus, Object paramObject)
  {
    ...
    if ((paramRichStatus == null) || (paramRichStatus == RichStatus.getEmptyStatus())) {
      if (paramInt == 100) {
        bcpw.a(BaseApplication.context, 2, ajyc.a(2131714146), 0).a();
      }
    }
    for (int i = 0;; i = 1)
    {
      ...
      if (paramInt == 100)
      {
        ...
        {
          awei.a().addObserver(this.a.jdField_a_of_type_JavaUtilObserver);
          paramObject = awei.a().a(this.a.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
      ...
      {
        return;
        bcpw.a(BaseApplication.context, 1, ajyc.a(2131714138), 0).a();
        break;
        int j = i;
        if (Integer.parseInt(paramObject.jdField_a_of_type_JavaLangString) > 0)
        {
          ...
          if (paramObject.f < 2)
          {
            ...
            {
              bbkv.a(this.a.getActivity(), this.a.getActivity().app, 0, "signature_chouti");
              j = 0;
            }
          }
        }
