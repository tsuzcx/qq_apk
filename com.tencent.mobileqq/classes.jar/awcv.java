  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramAppRuntime.getApplication(), awcv.class);
  ...
  {
    paramIntent = new bfvu((UserCommReport)paramIntent.getSerializableExtra("userCommReport"), (ArrayList)paramIntent.getSerializableExtra("reportInfos"));
