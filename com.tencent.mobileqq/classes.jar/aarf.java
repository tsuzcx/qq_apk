  ...
  implements aarc
{
  ...
  public aarf(aare paramaare)
  {
    this.jdField_a_of_type_Aare = paramaare;
  }
  ...
  private String a(String paramString)
  {
    ...
    for (Activity localActivity = this.jdField_a_of_type_Aare.a();; localActivity = null)
    {
      String str1 = str2;
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localaanu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaanu);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    aanu localaanu = new aanu();
    localaanu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaanu);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    aanu localaanu = new aanu();
    localaanu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaanu);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    aanu localaanu = new aanu();
    localaanu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaanu);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    aanu localaanu = new aanu();
    localaanu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localaanu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaanu);
  }
