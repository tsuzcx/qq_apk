  ...
  extends llo
{
  ...
  private Queue<lll> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaUtilQueue.offer(new lll(this, this.jdField_a_of_type_AndroidGraphicsPathMeasure.getLength()));
  }
  ...
  public void b(Canvas paramCanvas, MySurfaceView paramMySurfaceView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilQueue.size() > 0))
      {
        ...
        locallll = (lll)((LinkedList)this.jdField_a_of_type_JavaUtilQueue).getLast();
        ...
        for (;;)
        {
          ...
          paramMySurfaceView = (lll)localIterator.next();
          localObject2 = paramMySurfaceView;
        ...
        continue;
        f2 = locallll.jdField_a_of_type_Float;
        if (localObject2 == null) {
          break label683;
        }
        if ((localObject1 != null) && (localObject1 != localObject2)) {
          f1 = (((lll)localObject1).jdField_a_of_type_Float * (float)(((lll)localObject2).jdField_a_of_type_Long - l) + ((lll)localObject2).jdField_a_of_type_Float * (float)(l - ((lll)localObject1).jdField_a_of_type_Long)) / (float)(((lll)localObject2).jdField_a_of_type_Long - ((lll)localObject1).jdField_a_of_type_Long);
        }
      }
    }
    for (;;)
    {
      float f3 = 0.01481482F * this.c * (float)(locallll.jdField_a_of_type_Long - l) / 500.0F;
      f4 /= 2.0F;
      ...
      for (;;)
      {
        if (f1 <= locallll.jdField_a_of_type_Float)
        {
          ...
          f1 += f7;
          continue;
          f1 = ((lll)localObject2).jdField_a_of_type_Float;
          break;
        }
      }
