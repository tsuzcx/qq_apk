...
public class llk
{
  private final ArrayList<lll> a = new ArrayList(1);
  ...
  public void a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      try
      {
        ...
        do
        {
          localObject2 = new lll((BufferedReader)localObject1);
          ...
          ((lll)localObject2).a(arrayOfBitmapDrawable);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (i < j)
    {
      ((lll)this.a.get(i)).a(paramCanvas);
      i += 1;
    }
  }
  ...
  public void a(PathMeasure paramPathMeasure)
  {
    ...
    while (i < j)
    {
      ((lll)this.a.get(i)).a(paramPathMeasure);
      i += 1;
    }
  }
}
