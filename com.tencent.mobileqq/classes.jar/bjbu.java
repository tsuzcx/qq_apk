...
public class bjbu
{
  ...
  public bjbu(ReaderTabBarView paramReaderTabBarView, int paramInt1, String paramString, boolean paramBoolean, int paramInt2, RedTouchUI paramRedTouchUI)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          catch (NumberFormatException localNumberFormatException)
          {
            for (;;)
            {
              bjbl.a("ReaderTabBarView", localNumberFormatException.getMessage());
              continue;
              paramBoolean = false;
            }
          }
        ...
        catch (JSONException localJSONException)
        {
          for (;;)
          {
            bjbl.a("ReaderTabBarView", localJSONException.getMessage());
          }
        }
