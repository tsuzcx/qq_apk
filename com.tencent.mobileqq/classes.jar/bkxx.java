  ...
  extends MiniAppProxy
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bkyd(this));
  private MiniAppConfig jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig;
  private DownloadListener jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new bkyc(this);
  ...
  private void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localBundle.putString(bjwo.jdField_b_of_type_JavaLangString, paramString1);
  ...
  {
    paramIMiniAppContext.performAction(new bkye());
  ...
  private void a(IMiniAppContext paramIMiniAppContext, String paramString)
  {
    ...
    MiniAppConfig localMiniAppConfig = bkyr.a(paramIMiniAppContext.getMiniAppInfo());
  ...
  private void a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "sync_mini_app_data", localBundle, new bkyg(this, paramMiniAppInfo));
  }
  ...
  private void b(MiniAppInfo paramMiniAppInfo)
  {
    ...
    MiniAppCmdUtil.getInstance().setUserAppTop(paramMiniAppInfo.appId, paramMiniAppInfo.topType, paramMiniAppInfo.verType, null, new bkyh(this, paramMiniAppInfo));
  }
  ...
  private void c(IMiniAppContext paramIMiniAppContext)
  {
    ...
    ((IActivityResultManager)localObject).addActivityResultListener(new bkyf(this, (IActivityResultManager)localObject, paramIMiniAppContext));
  ...
  private void e(IMiniAppContext paramIMiniAppContext)
  {
    ...
    localObject = "https://tucao.qq.com/qq_miniprogram/tucao?appid=" + localMiniAppInfo.appId + "&openid=" + MainPageFragment.getUin() + "&avatar=" + paramIMiniAppContext + anzj.a(2131700264);
    ...
    paramIMiniAppContext = bkyr.a(localMiniAppInfo);
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      ((Intent)localObject2).putExtra("key_mini_app_config", bkyr.a((MiniAppInfo)localObject1));
      ...
      ((IActivityResultManager)localObject1).addActivityResultListener(new bkyk(this, (IActivityResultManager)localObject1));
      ...
      if ((localObject2 instanceof bkzk))
      {
        localObject2 = ((bkzk)localObject2).a();
        if ((!bool4) && (localObject2 != null))
        {
          i = a((aqre)localObject2);
          continue;
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    bguq.a(paramContext, TroopInfoActivity.a(paramString, 5), 2);
  }
  
  public boolean addShortcut(Context paramContext, MiniAppInfo paramMiniAppInfo, AsyncResult paramAsyncResult)
  {
    blaa.a((Activity)paramContext, paramMiniAppInfo, new bkxz(this, paramAsyncResult));
    return true;
  }
  ...
  public void b(IMiniAppContext paramIMiniAppContext)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "query_mini_app_data", localBundle, new bkyj(this, localMiniAppInfo));
  }
  ...
  public boolean chooseLocation(Context paramContext, AsyncResult paramAsyncResult)
  {
    ...
    localIActivityResultManager.addActivityResultListener(new bkyb(this, paramAsyncResult, localIActivityResultManager));
  ...
  public boolean downloadApp(Context paramContext, MiniAppInfo paramMiniAppInfo, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig = bkyr.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
  ...
  public boolean enterQRCode(Context paramContext, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    if (!alof.a(localBaseActivity))
    {
      paramAsyncResult.onReceiveResult(false, null);
      return true;
    }
    paramContext = new Intent((BaseActivity)paramContext, ScannerActivity.class);
    paramContext.putExtra("leftViewText", localBaseActivity.getString(2131690559));
    paramContext.putExtra("selfSet_leftViewText", localBaseActivity.getString(2131690559));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bkxy(this, paramAsyncResult);
  ...
  public boolean getLocation(Context paramContext, String paramString, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    {
      SosoInterface.a(new bkya(this, 0, true, true, 5000L, false, false, "miniApp", bool, paramBoolean, paramAsyncResult));
      return true;
    }
  }
  ...
  {
    return QzoneConfig.getInstance().getConfig("qqminiapp", "mini_game_pay_by_h5", 0);
  }
  ...
  {
    bhkm.a(paramContext, paramBoolean);
  }
  ...
  public boolean openChoosePhotoActivity(Context paramContext, int paramInt, MiniAppProxy.IChoosePhotoListner paramIChoosePhotoListner)
  {
    ...
    bhkd.anim((Activity)paramContext, false, true);
    return true;
  }
  ...
  public void setDrawableCallback(Drawable paramDrawable, MiniAppProxy.IDrawableLoadedCallBack paramIDrawableLoadedCallBack)
  {
    if ((paramDrawable != null) && ((paramDrawable instanceof URLDrawable))) {
      ((URLDrawable)paramDrawable).setURLDrawableListener(new bkyi(this, paramIDrawableLoadedCallBack));
    }
  }
