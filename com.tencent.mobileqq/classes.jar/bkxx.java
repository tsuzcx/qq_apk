...
public class bkxx
{
  ...
  public bkxx(AppRuntime paramAppRuntime, String paramString1, String paramString2)
  {
    this.c = paramString1;
  ...
  private void d()
  {
    String str1 = asnl.a(aszt.a(new String(this.c))).toLowerCase();
    int i = NetworkUtil.getNetworkType(BaseApplicationImpl.getContext());
    File localFile = new File(this.c);
    JSONObject localJSONObject = bkxu.a(this.jdField_a_of_type_MqqAppAppRuntime, localFile.getName(), this.d, str1);
    Object localObject;
    if ((localJSONObject != null) && (localJSONObject.optInt("retcode") == 0))
    {
      ...
      if (localObject == null)
      {
        ...
        bfdx.a("grp_hw", "upload_video", "-1", "", i + "", "");
        if (this.jdField_a_of_type_Bkxw != null) {
          this.jdField_a_of_type_Bkxw.b(2);
        }
      }
    }
    do
      ...
      do
      {
        do
        {
            ...
            do
            {
              for (;;)
              {
                ...
                if (TextUtils.isEmpty(str2))
                {
                  ...
                  bfdx.a("grp_hw", "upload_video", "-2", "", i + "", "");
                  if (this.jdField_a_of_type_Bkxw != null) {
                    this.jdField_a_of_type_Bkxw.b(2);
                  }
                }
                  ...
                  if (!TextUtils.isEmpty((CharSequence)localObject)) {
                    try
                    {
                      ...
                      if ((l != 0L) && (localFile.length() > l))
                      {
                        ...
                        bfdx.a("grp_hw", "upload_video", "-3", "", i + "", "");
                        if (this.jdField_a_of_type_Bkxw == null) {
                          continue;
                        }
                        this.jdField_a_of_type_Bkxw.b(3);
                      }
                    }
              ...
              j = bkxu.a(localJSONObject, this.c, str1);
              if (j != 0) {
                break;
              }
              if (QLog.isColorLevel()) {
              ...
              bfdx.a("grp_hw", "upload_video", "0", "1", i + "", "");
            } while (this.jdField_a_of_type_Bkxw == null);
            this.jdField_a_of_type_Bkxw.a(str2);
            return;
            if (QLog.isColorLevel()) {
              QLog.w("TroopHomeworkHelper", 2, "doPutCOSData failed, putResult =" + j);
            }
            bfdx.a("grp_hw", "upload_video", "-4", "", i + "", "");
          } while (this.jdField_a_of_type_Bkxw == null);
          this.jdField_a_of_type_Bkxw.b(5);
          return;
          ...
          default: 
            ...
            bfdx.a("grp_hw", "upload_video", "-6", "", i + "", "");
          }
        } while (this.jdField_a_of_type_Bkxw == null);
        this.jdField_a_of_type_Bkxw.b(2);
        return;
  ...
  private void e()
  {
    ...
    int i = NetworkUtil.getNetworkType(BaseApplicationImpl.getContext());
    File localFile = new File(this.c);
    Object localObject = bkxu.c(this.c);
    localObject = bkxu.b(this.jdField_a_of_type_MqqAppAppRuntime, localFile.getName(), this.d, (String)localObject);
  ...
  private void f()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 277	bkxx:jdField_a_of_type_Okhttp3OkHttpClient	Lokhttp3/OkHttpClient;
    //   4: ifnonnull +47 -> 51
    //   7: aload_0
    //   8: new 279	okhttp3/OkHttpClient
    //   11: dup
    //   12: invokespecial 280	okhttp3/OkHttpClient:<init>	()V
    //   15: invokevirtual 284	okhttp3/OkHttpClient:newBuilder	()Lokhttp3/OkHttpClient$Builder;
    //   18: ldc2_w 285
    //   21: getstatic 292	java/util/concurrent/TimeUnit:MILLISECONDS	Ljava/util/concurrent/TimeUnit;
    //   24: invokevirtual 298	okhttp3/OkHttpClient$Builder:connectTimeout	(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
    //   27: ldc2_w 285
    //   30: getstatic 292	java/util/concurrent/TimeUnit:MILLISECONDS	Ljava/util/concurrent/TimeUnit;
    //   33: invokevirtual 301	okhttp3/OkHttpClient$Builder:writeTimeout	(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
    //   36: ldc2_w 285
    //   39: getstatic 292	java/util/concurrent/TimeUnit:MILLISECONDS	Ljava/util/concurrent/TimeUnit;
    //   42: invokevirtual 304	okhttp3/OkHttpClient$Builder:readTimeout	(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
    //   45: invokevirtual 308	okhttp3/OkHttpClient$Builder:build	()Lokhttp3/OkHttpClient;
    //   48: putfield 277	bkxx:jdField_a_of_type_Okhttp3OkHttpClient	Lokhttp3/OkHttpClient;
    //   51: invokestatic 91	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   54: invokestatic 97	com/tencent/mobileqq/utils/NetworkUtil:getNetworkType	(Landroid/content/Context;)I
    //   57: istore_3
    //   58: aload_0
    //   59: aload_0
    //   60: getfield 265	bkxx:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   63: ldc_w 310
    //   66: invokevirtual 59	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   69: putfield 312	bkxx:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   72: aload_0
    //   73: aload_0
    //   74: getfield 265	bkxx:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   77: ldc 164
    //   79: invokevirtual 59	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   82: putfield 259	bkxx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   85: aload_0
    //   86: getfield 265	bkxx:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   89: ldc_w 314
    //   92: invokevirtual 318	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   95: astore 14
    //   97: aload_0
    //   98: iconst_3
    //   99: putfield 320	bkxx:jdField_a_of_type_Int	I
    //   102: new 322	java/io/RandomAccessFile
    //   105: dup
    //   106: aload_0
    //   107: getfield 27	bkxx:c	Ljava/lang/String;
    //   110: ldc_w 324
    //   113: invokespecial 327	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   116: astore 13
    //   118: aload 13
    //   120: astore 12
    //   122: aload 13
    //   124: invokevirtual 328	java/io/RandomAccessFile:length	()J
    //   127: lstore 9
    //   129: aload 13
    //   131: astore 12
    //   133: aload_0
    //   134: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   137: lstore 5
    //   139: aload 13
    //   141: astore 12
    //   143: aload_0
    //   144: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   147: lload 9
    //   149: lcmp
    //   150: ifge +705 -> 855
    //   153: aload 13
    //   155: astore 12
    //   157: aload_0
    //   158: getfield 23	bkxx:jdField_a_of_type_Boolean	Z
    //   161: istore 11
    //   163: iload 11
    //   165: ifeq +22 -> 187
    //   168: aload 13
    //   170: ifnull +8 -> 178
    //   173: aload 13
    //   175: invokevirtual 331	java/io/RandomAccessFile:close	()V
    //   178: return
    //   179: astore 12
    //   181: aload 12
    //   183: invokevirtual 334	java/io/IOException:printStackTrace	()V
    //   186: return
    //   187: aload 13
    //   189: astore 12
    //   191: lload 9
    //   193: aload_0
    //   194: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   197: lsub
    //   198: ldc2_w 335
    //   201: lcmp
    //   202: ifle +121 -> 323
    ...
    //   209: aload_0
    //   210: aload_0
    //   211: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   214: ldc2_w 337
    //   217: ladd
    //   218: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   221: aload 13
    //   223: astore 12
    //   225: aload_0
    //   226: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   229: lload 5
    //   231: lsub
    //   232: lstore 7
    //   234: aload 13
    ...
    //   251: aload 13
    //   253: lload 5
    //   255: invokevirtual 342	java/io/RandomAccessFile:seek	(J)V
    //   258: aload 13
    //   260: astore 12
    //   262: sipush 4096
    //   265: newarray byte
    ...
    //   273: aload 13
    //   275: aload 16
    //   277: invokevirtual 346	java/io/RandomAccessFile:read	([B)I
    //   280: istore 4
    //   282: iload_1
    //   283: istore_2
    //   284: iload 4
    ...
    //   309: iload_1
    //   310: iload 4
    //   312: invokestatic 352	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   315: iload_1
    //   316: iload 4
    //   318: iadd
    //   319: istore_1
    ...
    //   327: aload_0
    //   328: lload 9
    //   330: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   333: goto -112 -> 221
    //   336: astore 14
    //   338: aload 13
    //   340: astore 12
    ...
    //   362: aload 13
    //   364: invokevirtual 355	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    ...
    //   373: aload 13
    //   375: invokestatic 358	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   378: aload_0
    //   379: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   382: ifnull +14 -> 396
    //   385: aload_0
    //   386: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   389: bipush 6
    //   391: invokeinterface 162 2 0
    //   396: ldc 131
    //   398: ldc 133
    //   400: ldc_w 360
    //   403: ldc 137
    ...
    //   408: dup
    //   409: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   412: iload_3
    //   413: invokevirtual 144	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   416: ldc 137
    //   418: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   421: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   424: ldc 137
    //   426: invokestatic 155	bfdx:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   429: aload_0
    //   430: lconst_0
    //   431: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   434: aload 12
    //   436: ifnull -258 -> 178
    //   439: aload 12
    //   441: invokevirtual 331	java/io/RandomAccessFile:close	()V
    //   444: return
    //   445: astore 12
    //   447: aload 12
    //   449: invokevirtual 334	java/io/IOException:printStackTrace	()V
    //   452: return
    //   453: lload 7
    //   455: iload_1
    //   456: i2l
    ...
    //   469: iload_1
    //   470: iload_2
    //   471: invokestatic 352	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   474: lload 7
    //   476: l2i
    //   477: istore_2
    //   478: aload 13
    //   480: astore 12
    //   482: ldc_w 362
    //   485: invokestatic 368	okhttp3/MediaType:parse	(Ljava/lang/String;)Lokhttp3/MediaType;
    //   488: aload 15
    //   490: iconst_0
    //   491: iload_2
    //   492: invokestatic 374	okhttp3/RequestBody:create	(Lokhttp3/MediaType;[BII)Lokhttp3/RequestBody;
    //   495: astore 15
    //   497: aload 13
    //   499: astore 12
    //   501: new 376	okhttp3/Request$Builder
    //   504: dup
    //   505: invokespecial 377	okhttp3/Request$Builder:<init>	()V
    //   508: new 139	java/lang/StringBuilder
    //   511: dup
    //   512: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   515: aload_0
    //   516: getfield 259	bkxx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   528: lload 5
    //   530: invokevirtual 195	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   533: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   536: invokevirtual 383	okhttp3/Request$Builder:url	(Ljava/lang/String;)Lokhttp3/Request$Builder;
    //   539: ldc_w 385
    //   542: aload_0
    //   543: getfield 312	bkxx:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   546: invokevirtual 389	okhttp3/Request$Builder:addHeader	(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Request$Builder;
    //   549: ldc_w 391
    //   552: ldc_w 393
    //   555: invokevirtual 389	okhttp3/Request$Builder:addHeader	(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Request$Builder;
    //   558: ldc_w 395
    //   561: ldc_w 362
    //   564: invokevirtual 389	okhttp3/Request$Builder:addHeader	(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Request$Builder;
    //   567: ldc_w 397
    //   570: aload_0
    //   571: lload 5
    //   573: l2i
    //   574: aload 14
    //   576: invokespecial 399	bkxx:a	(ILorg/json/JSONArray;)Ljava/lang/String;
    //   579: invokevirtual 389	okhttp3/Request$Builder:addHeader	(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Request$Builder;
    //   582: aload 15
    //   584: invokevirtual 402	okhttp3/Request$Builder:post	(Lokhttp3/RequestBody;)Lokhttp3/Request$Builder;
    //   587: invokevirtual 405	okhttp3/Request$Builder:build	()Lokhttp3/Request;
    //   590: astore 15
    //   592: aload 13
    //   594: astore 12
    //   596: aload_0
    //   597: getfield 277	bkxx:jdField_a_of_type_Okhttp3OkHttpClient	Lokhttp3/OkHttpClient;
    //   600: aload 15
    //   602: invokevirtual 409	okhttp3/OkHttpClient:newCall	(Lokhttp3/Request;)Lokhttp3/Call;
    //   605: invokeinterface 415 1 0
    //   610: astore 15
    //   612: aload 13
    //   614: astore 12
    //   616: aload 15
    //   618: invokevirtual 420	okhttp3/Response:isSuccessful	()Z
    //   621: ifeq +134 -> 755
    //   624: aload 13
    //   626: astore 12
    //   628: aload_0
    //   629: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   632: ifnull +97 -> 729
    //   635: aload 13
    //   637: astore 12
    //   639: aload_0
    //   640: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   643: iload_2
    //   644: i2l
    //   645: lload 5
    //   647: ladd
    ...
    //   654: ldiv
    //   655: l2i
    //   656: invokeinterface 424 2 0
    //   661: aload 13
    //   663: astore 12
    //   665: aload_0
    //   666: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   669: lload 9
    //   671: lcmp
    //   672: iflt +57 -> 729
    //   675: aload 13
    ...
    //   683: ldc 178
    //   685: ldc_w 426
    //   688: new 139	java/lang/StringBuilder
    //   691: dup
    //   692: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   695: iload_3
    //   696: invokevirtual 144	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   699: ldc 137
    //   701: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   704: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   707: ldc 137
    //   709: invokestatic 155	bfdx:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   712: aload 13
    //   714: astore 12
    //   716: aload_0
    //   717: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   720: aload_0
    //   721: getfield 259	bkxx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   724: invokeinterface 216 2 0
    //   729: aload 13
    //   731: astore 12
    //   733: aload_0
    //   734: iconst_3
    //   735: putfield 320	bkxx:jdField_a_of_type_Int	I
    //   738: aload 13
    //   740: astore 12
    //   742: aload_0
    //   743: getfield 33	bkxx:jdField_a_of_type_Long	J
    //   746: lstore 7
    //   748: lload 7
    //   750: lstore 5
    //   752: goto +606 -> 1358
    ...
    //   757: astore 12
    //   759: aload_0
    //   760: getfield 320	bkxx:jdField_a_of_type_Int	I
    //   763: iconst_1
    //   764: isub
    //   765: istore_1
    //   766: aload 13
    ...
    //   770: aload_0
    //   771: iload_1
    //   772: putfield 320	bkxx:jdField_a_of_type_Int	I
    //   775: iload_1
    //   776: ifgt +98 -> 874
    //   779: aload 13
    //   781: astore 12
    ...
    //   787: ldc_w 428
    //   790: ldc 137
    //   792: new 139	java/lang/StringBuilder
    //   795: dup
    //   796: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   799: iload_3
    //   800: invokevirtual 144	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   803: ldc 137
    //   805: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   808: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   811: ldc 137
    //   813: invokestatic 155	bfdx:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   816: aload 13
    //   818: astore 12
    //   820: aload_0
    //   821: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   824: ifnull +534 -> 1358
    //   827: aload 13
    //   829: astore 12
    //   831: aload_0
    //   832: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   835: aload 15
    //   837: invokevirtual 431	okhttp3/Response:code	()I
    //   840: invokeinterface 162 2 0
    //   845: aload 13
    //   847: astore 12
    //   849: aload_0
    //   850: lload 5
    //   852: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   855: aload 13
    //   857: ifnull -679 -> 178
    //   860: aload 13
    //   862: invokevirtual 331	java/io/RandomAccessFile:close	()V
    //   865: return
    //   866: astore 12
    //   868: aload 12
    //   870: invokevirtual 334	java/io/IOException:printStackTrace	()V
    //   873: return
    //   874: aload 13
    //   876: astore 12
    //   878: aload_0
    //   879: lload 5
    //   881: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   884: goto -745 -> 139
    //   887: astore 15
    //   889: aload 13
    //   891: astore 12
    //   893: ldc 123
    //   895: iconst_2
    //   896: new 139	java/lang/StringBuilder
    //   899: dup
    //   900: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   903: ldc_w 354
    //   906: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   909: aload 15
    //   911: invokevirtual 432	java/io/IOException:getMessage	()Ljava/lang/String;
    //   914: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   917: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   920: aload 15
    //   922: invokestatic 358	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   925: aload 13
    //   927: astore 12
    //   929: aload_0
    //   930: getfield 320	bkxx:jdField_a_of_type_Int	I
    //   933: iconst_1
    //   934: isub
    //   935: istore_1
    //   936: aload 13
    ...
    //   940: aload_0
    //   941: iload_1
    //   942: putfield 320	bkxx:jdField_a_of_type_Int	I
    //   945: iload_1
    //   946: ifgt +208 -> 1154
    //   949: aload 13
    //   951: astore 12
    ...
    //   957: ldc_w 434
    //   960: ldc 137
    //   962: new 139	java/lang/StringBuilder
    //   965: dup
    //   966: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   969: iload_3
    //   970: invokevirtual 144	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   973: ldc 137
    //   975: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   978: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   981: ldc 137
    //   983: invokestatic 155	bfdx:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   986: aload 13
    //   988: astore 12
    //   990: aload_0
    //   991: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   994: ifnull +364 -> 1358
    //   997: aload 13
    //   999: astore 12
    //   1001: aload_0
    //   1002: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   1005: bipush 6
    //   1007: invokeinterface 162 2 0
    //   1012: aload 13
    //   1014: astore 12
    //   1016: aload_0
    //   1017: lload 5
    //   1019: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   1022: goto -167 -> 855
    //   1025: astore 14
    //   1027: aload 13
    //   1029: astore 12
    //   1031: ldc 123
    //   1033: iconst_2
    //   1034: new 139	java/lang/StringBuilder
    //   1037: dup
    //   1038: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   1041: ldc_w 354
    //   1044: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1047: aload 14
    //   1049: invokevirtual 432	java/io/IOException:getMessage	()Ljava/lang/String;
    //   1052: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1055: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1058: aload 14
    //   1060: invokestatic 358	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   1063: aload 13
    //   1065: astore 12
    //   1067: aload_0
    //   1068: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   1071: ifnull +18 -> 1089
    //   1074: aload 13
    //   1076: astore 12
    //   1078: aload_0
    //   1079: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   1082: bipush 6
    //   1084: invokeinterface 162 2 0
    //   1089: aload 13
    //   1091: astore 12
    //   1093: ldc 131
    //   1095: ldc 133
    //   1097: ldc_w 436
    //   1100: ldc 137
    //   1102: new 139	java/lang/StringBuilder
    //   1105: dup
    //   1106: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   1109: iload_3
    //   1110: invokevirtual 144	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   1113: ldc 137
    //   1115: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1118: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1121: ldc 137
    //   1123: invokestatic 155	bfdx:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1126: aload 13
    //   1128: astore 12
    //   1130: aload_0
    //   1131: lconst_0
    //   1132: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   1135: aload 13
    //   1137: ifnull -959 -> 178
    //   1140: aload 13
    //   1142: invokevirtual 331	java/io/RandomAccessFile:close	()V
    //   1145: return
    //   1146: astore 12
    //   1148: aload 12
    //   1150: invokevirtual 334	java/io/IOException:printStackTrace	()V
    //   1153: return
    //   1154: aload 13
    //   1156: astore 12
    //   1158: aload_0
    //   1159: lload 5
    //   1161: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   1164: goto -1025 -> 139
    //   1167: astore 14
    //   1169: aload 13
    //   1171: astore 12
    //   1173: ldc 123
    //   1175: iconst_2
    //   1176: new 139	java/lang/StringBuilder
    //   1179: dup
    //   1180: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   1183: ldc_w 354
    //   1186: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1189: aload 14
    //   1191: invokevirtual 437	java/security/InvalidParameterException:getMessage	()Ljava/lang/String;
    //   1194: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1197: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1200: aload 14
    //   1202: invokestatic 358	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   1205: aload 13
    //   1207: astore 12
    //   1209: aload_0
    //   1210: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   1213: ifnull +18 -> 1231
    //   1216: aload 13
    //   1218: astore 12
    //   1220: aload_0
    //   1221: getfield 157	bkxx:jdField_a_of_type_Bkxw	Lbkxw;
    //   1224: bipush 6
    //   1226: invokeinterface 162 2 0
    //   1231: aload 13
    //   1233: astore 12
    //   1235: ldc 131
    //   1237: ldc 133
    //   1239: ldc_w 439
    //   1242: ldc 137
    //   1244: new 139	java/lang/StringBuilder
    //   1247: dup
    //   1248: invokespecial 140	java/lang/StringBuilder:<init>	()V
    //   1251: iload_3
    //   1252: invokevirtual 144	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   1255: ldc 137
    //   1257: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1260: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1263: ldc 137
    //   1265: invokestatic 155	bfdx:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1268: aload 13
    //   1270: astore 12
    //   1272: aload_0
    //   1273: lconst_0
    //   1274: putfield 33	bkxx:jdField_a_of_type_Long	J
    //   1277: aload 13
    //   1279: ifnull -1101 -> 178
    //   1282: aload 13
    //   1284: invokevirtual 331	java/io/RandomAccessFile:close	()V
    //   1287: return
    //   1288: astore 12
    //   1290: aload 12
    //   1292: invokevirtual 334	java/io/IOException:printStackTrace	()V
    //   1295: return
    //   1296: astore 13
    //   1298: aconst_null
    //   1299: astore 12
    ...
    //   1303: ifnull +8 -> 1311
    //   1306: aload 12
    //   1308: invokevirtual 331	java/io/RandomAccessFile:close	()V
    //   1311: aload 13
    //   1313: athrow
    //   1314: astore 12
    //   1316: aload 12
    //   1318: invokevirtual 334	java/io/IOException:printStackTrace	()V
    //   1321: goto -10 -> 1311
    //   1324: astore 13
    //   1326: goto -25 -> 1301
    //   1329: astore 13
  ...
  public void a()
  {
    ...
    File localFile = new File(this.c);
    if (((!localFile.exists()) || (localFile.length() == 0L)) && (this.jdField_a_of_type_Bkxw != null))
    {
      this.jdField_a_of_type_Bkxw.b(-1);
      int i = NetworkUtil.getNetworkType(BaseApplicationImpl.getContext());
      bfdx.a("grp_hw", "upload_video", "-13", "", i + "", "");
      return;
    }
  ...
  public void a(bkxw parambkxw)
  {
    this.jdField_a_of_type_Bkxw = parambkxw;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bkxw.a(this.jdField_a_of_type_JavaLangString);
    return;
    f();
    return;
    label167:
