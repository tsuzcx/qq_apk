...
public class res
  extends rbp
{
  public res(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp d()
  {
    ...
    if ((this.jdField_a_of_type_Rbo != null) && ((this.jdField_a_of_type_Rbo instanceof ComponentContentThree))) {
      localLinearLayout.addView((ComponentContentThree)this.jdField_a_of_type_Rbo);
    }
  ...
  public rbp g()
  {
    this.jdField_a_of_type_Rbo = new ComponentContentThree(this.jdField_a_of_type_AndroidContentContext);
    return this;
  }
}
