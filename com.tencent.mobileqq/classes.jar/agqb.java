  ...
  extends Handler
{
  ...
  public agqb(SendPhotoActivity paramSendPhotoActivity1, SendPhotoActivity paramSendPhotoActivity2)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.a(2131695126);
      return;
      if (localSendPhotoActivity.jdField_a_of_type_AndroidOsHandler.hasMessages(2))
      {
        aung.b(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage", "remove delayed Message:MSG_CANCLE_PROGRESS");
        localSendPhotoActivity.jdField_a_of_type_AndroidOsHandler.removeMessages(2);
      }
      Object localObject2;
      Object localObject1;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_AndroidAppProgressDialog != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_AndroidAppProgressDialog.isShowing()))
      {
        bool1 = true;
        this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.b();
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        ((Intent)localObject2).putExtra(bbbw.h, 2);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          aung.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage print CompressInfo", "info:" + localObject3);
      ...
      aung.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "CompressLog", "compress startTime = " + localSendPhotoActivity.b + "ns,finishTime = " + l1 + "ns,duration = " + l2 + "ms,count = " + i + ",isShowing = " + bool1);
      agqd.a(l2, i, bool1);
      localSendPhotoActivity.app.a().a(l1);
      aung.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "TimeCompare", "CompressFinish Time = " + l1 + "ns");
      ...
      aupa.a(BaseApplication.getContext(), paramMessage);
      return;
      if (QLog.isColorLevel()) {
        QLog.e(SendPhotoActivity.jdField_a_of_type_JavaLangString, 2, "idleHandler time out");
      }
    } while (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoTask != null);
    Looper.myQueue().removeIdleHandler(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_AndroidOsMessageQueue$IdleHandler);
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoTask = new SendPhotoTask(localSendPhotoActivity, null, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_AndroidOsHandler);
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_Long != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoTask.jdField_a_of_type_Long = (SystemClock.uptimeMillis() - this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_Long);
    }
    ThreadManager.post(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoTask, 8, null, false);
  }
}
