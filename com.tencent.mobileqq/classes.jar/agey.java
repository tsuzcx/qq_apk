  ...
  implements bfpt
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.i(ager.jdField_a_of_type_JavaLangString, 2, "onItemClick, position = " + paramInt);
    }
    ...
    {
      paramAdapterView = (agep)this.a.jdField_a_of_type_Ageq.getItem(paramInt);
      ...
      if (QLog.isColorLevel()) {
        QLog.i(ager.jdField_a_of_type_JavaLangString, 2, "onItemClick, mRecordCount = " + this.a.jdField_a_of_type_Int);
      }
      this.a.a(true);
      this.a.dismiss();
    }
    ...
    {
      return;
      if (paramAdapterView == this.a.jdField_a_of_type_Agfb)
      {
        paramAdapterView = (agef)this.a.jdField_a_of_type_Agfb.getItem(paramInt);
        this.a.b = false;
    ...
    QLog.i(ager.jdField_a_of_type_JavaLangString, 2, "onItemClick, unknown data type");
  }
}
