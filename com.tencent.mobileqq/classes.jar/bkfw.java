...
public class bkfw
{
  private static final bjsl<bkfw, Void> jdField_a_of_type_Bjsl = new bkfx();
  public WeakReference<bkfy> a;
  ...
  public static bkfw a()
  {
    return (bkfw)jdField_a_of_type_Bjsl.b(null);
  }
  ...
  public qq_ad_get.QQAdGet.DeviceInfo a()
  {
    for (;;)
    {
      try
      {
        ...
        ((aate)localObject).a = "1018ec";
        localObject = aatd.a(BaseApplicationImpl.getApplication(), (aate)localObject);
        if (localObject == null) {
          continue;
        }
        localObject = ((aatf)localObject).jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo;
  ...
  public void a(int paramInt1, long paramLong, int paramInt2, String paramString, int paramInt3)
  {
    ...
    bkfz.a(paramLong, paramString, paramInt1, paramInt2, 1, paramInt3, this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo);
  ...
  public void a(long paramLong, int paramInt1, String paramString, int paramInt2, bkfy parambkfy)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambkfy);
  ...
  public void a(vac_adv_get.VacAdvRsp paramVacAdvRsp)
  {
    ...
    {
      ((bkfy)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a((AlumBasicData)localArrayList.get(0));
