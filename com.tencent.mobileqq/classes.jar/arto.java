  ...
  extends Handler
{
  ...
  public arto(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
      ...
      do
      {
        do
        {
          do
          {
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                paramMessage = (artr)paramMessage.obj;
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.a())) && ((QQMusicPlayService.d() == 2) || (QQMusicPlayService.d() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          artm.a(i, bbfj.b((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        artm.b(QQMusicPlayService.b(), QQMusicPlayService.c());
                      }
            ...
            return;
            if (QQMusicPlayService.d() != 6) {
              break;
            }
          } while (!bbfj.g(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
