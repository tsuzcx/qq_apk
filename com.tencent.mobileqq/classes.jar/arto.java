  ...
  extends amno
{
  ...
  public arto(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
  }
  
  private void a(UniformDownloadBPTransEntity paramUniformDownloadBPTransEntity, amnx paramamnx)
  {
    ...
    if (localUniformDownloadBPTransEntity.getStatus() == 1000) {
      paramamnx.a(localUniformDownloadBPTransEntity);
    }
    for (;;)
    {
      paramamnx.a();
  ...
  private UniformDownloadBPTransEntity b(String paramString)
  {
    ...
    localObject = localawgf.a(UniformDownloadBPTransEntity.class, (String)localObject, null);
    if (localObject == null)
    {
      localawgf.a();
      return null;
  ...
  private void c()
  {
    ...
    awgf localawgf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_JavaUtilList = localawgf.a(UniformDownloadBPTransEntity.class, (String)localObject, null);
    if (this.jdField_a_of_type_JavaUtilList == null) {
