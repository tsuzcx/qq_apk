...
{
  public int a;
  private LinkedHashMap<String, List<ajtt>> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  ...
  public bfjw(List<ajtt> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_c_of_type_JavaUtilList = new ArrayList();
  }
  
  private bfjx a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, String paramString, bfjx parambfjx, boolean paramBoolean)
  {
    if (((bfjk.a(paramQQAppInterface, paramTroopInfo)) || (bfjk.b(paramQQAppInterface, paramTroopInfo))) && (!paramBoolean))
    {
      paramQQAppInterface = bfjv.a();
      if ((TextUtils.isEmpty(paramString)) || (bfjv.a(paramString, paramQQAppInterface))) {
        parambfjx.jdField_a_of_type_JavaUtilList.add(0, paramQQAppInterface);
      }
    }
    return parambfjx;
  }
  
  private bfjx a(String paramString, boolean paramBoolean, TroopInfo paramTroopInfo)
  {
  ...
  private List<ajtt> a(LinkedHashMap<String, List<ajtt>> paramLinkedHashMap)
  {
  ...
  private Object[] a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localajtt.jdField_a_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (bfjk.a(localajtt.jdField_a_of_type_JavaLangString, paramTroopInfo)))) {
          break label664;
        }
        if ((TextUtils.isEmpty(paramString)) || (!bfjk.b(localajtt.jdField_a_of_type_JavaLangString, paramTroopInfo))) {
          break label228;
        }
      }
      finally {}
      ...
      ((List)localLinkedHashMap.get(localObject2)).add(localajtt);
      continue;
      label228:
      localObject1 = localajtt.x;
      if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
        break label688;
      }
      localObject1 = ((String)localObject1).substring(0, 1);
    }
    paramTroopInfo = new bfjo(paramTroopInfo);
  ...
  public bfjx a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, SessionInfo paramSessionInfo, boolean paramBoolean2)
  {
    ...
    for (this.jdField_b_of_type_JavaUtilList = bfjv.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1);; this.jdField_b_of_type_JavaUtilList = new ArrayList(bfjv.a(paramString, bfjv.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1), paramQQAppInterface, localTroopInfo))) {
