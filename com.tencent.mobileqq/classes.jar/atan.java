  ...
  extends atab
{
  ...
  private atbo jdField_a_of_type_Atbo;
  ...
  public atan(atbo paramatbo, BaseFileAssistantActivity paramBaseFileAssistantActivity, Object paramObject, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, View.OnClickListener paramOnClickListener3, View.OnLongClickListener paramOnLongClickListener, View.OnClickListener paramOnClickListener4)
  {
    ...
    this.jdField_a_of_type_Atbo = paramatbo;
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    atap localatap = (atap)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = b(paramInt1, paramInt2 * 4 + i, paramBoolean, localatap.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new atap(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (Object localObject1 = (WeiYunFileInfo)paramViewGroup;; localObject2 = null)
    {
      if (localObject1 == null)
      {
        ...
        if (this.jdField_a_of_type_Atbo.c()) {
          return null;
        }
        ...
        paramView = new ataa();
        paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560819, null);
        paramViewGroup.setClickable(true);
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131381193));
        paramView.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramViewGroup.findViewById(2131376461));
        paramView.c = ((ImageView)paramViewGroup.findViewById(2131370440));
        ...
        paramViewGroup.setOnClickListener(this.jdField_a_of_type_Atbo.a(paramView.jdField_a_of_type_AndroidWidgetTextView));
        paramViewGroup.setTag(paramView);
        if ((this.jdField_b_of_type_JavaUtilLinkedHashMap.size() == 0) && (!this.jdField_a_of_type_Atbo.a()))
        {
          paramViewGroup.setVisibility(8);
          if (!this.jdField_a_of_type_Atbo.b()) {
            break label295;
          }
          paramView.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
          paramView.c.setVisibility(8);
          paramView.jdField_a_of_type_AndroidWidgetTextView.setText(2131692512);
        }
        for (;;)
        {
          return paramViewGroup;
          ...
          paramView.jdField_a_of_type_AndroidWidgetTextView.setText(2131692302);
        }
      }
      if (paramView == null) {
      ...
      for (;;)
      {
        try
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560829, null);
          paramViewGroup = paramView;
          localObject3 = new ataa();
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131368501));
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368518));
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368515));
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.jdField_c_of_type_AndroidViewView$OnClickListener);
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject3);
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_AndroidWidgetImageView.setTag(localObject3);
          paramViewGroup = paramView;
          ((ataa)localObject3).jdField_a_of_type_Boolean = false;
          paramViewGroup = paramView;
        ...
        try
        {
          ...
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setDefaultImage(2130847846);
          ...
          if ((((WeiYunFileInfo)localObject1).h != null) && (((WeiYunFileInfo)localObject1).h.length() > 0) && (FileUtil.fileExistsAndNotEmpty(((WeiYunFileInfo)localObject1).h))) {
          ...
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692304) + ((WeiYunFileInfo)localObject1).c;
          if (!this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.f()) {
            continue;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          if (!atpm.a((WeiYunFileInfo)localObject1)) {
            continue;
          }
          localObject1 = (String)localObject3 + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692305);
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840569);
          paramView.setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getResources().getColor(2131167363));
        ...
        return paramViewGroup;
        paramViewGroup = paramView;
        localObject3 = (ataa)paramView.getTag();
        paramViewGroup = paramView;
        if (!((ataa)localObject3).jdField_a_of_type_Boolean) {
          continue;
        }
        paramViewGroup = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560829, null);
        ...
        paramViewGroup = (ViewGroup)localObject3;
        continue;
        localObject2 = (String)localObject3 + anvx.a(2131709184);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845669);
  ...
  public int getChildrenCount(int paramInt)
  {
    ...
    do
    {
      ...
      break;
      paramInt = j;
    } while (this.jdField_a_of_type_Atbo.c());
    return 1;
  }
