  ...
  extends num
{
  ...
  public nun(SharedPreferences paramSharedPreferences)
  {
  ...
  public static int a(nwz paramnwz, int paramInt1, int paramInt2, String paramString)
  {
    int k = 1;
    int m = 0;
  ...
  public static boolean a(nwz paramnwz, String paramString)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((paramnwz.a() == 0) || (TextUtils.isEmpty(paramString))) {
      bool1 = false;
    }
    int i;
    do
    {
      do
      {
        do
        {
          ...
          bool1 = bool2;
        } while (paramnwz.a(0) == 42);
        if ((i != 3) || (a(paramnwz, 0, i, "*.*") != 0)) {
          break;
        }
        bool1 = bool2;
      ...
      return false;
      if (paramnwz.a(0) == 42) {
        i = b(paramnwz, 1, i, paramString);
      }
      while (i < 0)
      {
        return nro.b(paramnwz.a(), paramString);
        if (paramnwz.a(i - 1) == 42) {
          i = a(paramnwz, 0, i - 1, paramString);
        } else {
          i = a(paramnwz, 0, i, paramString);
        }
      }
      bool1 = bool2;
    } while (i == 0);
  ...
  public static int b(nwz paramnwz, int paramInt1, int paramInt2, String paramString)
  {
    int k = 1;
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    localObject = ((nxa)localObject).a(0);
    if ((localObject == null) || (((nwz)localObject).a() == 0)) {
      return a(false, true);
    }
    nxa localnxa = new nxa();
    nwz localnwz1 = new nwz();
    nwz localnwz2 = new nwz();
    nwz localnwz3 = new nwz();
    int m = ((nwz)localObject).a();
    int i = 0;
    while (i < m)
    {
      ((nwz)localObject).a(i, localnxa);
      localnxa.a(0, localnwz1);
      int n = localnwz1.a();
      int j = 0;
      if (j < n)
      {
        localnwz1.a(j, localnwz3);
        if (!a(localnwz3, paramString1)) {}
        for (;;)
        {
          j += 1;
          break;
          localnxa.a(1, localnwz2);
          int k = 0;
          int i1 = localnwz2.a();
          while (k < i1)
          {
            localnwz2.a(k, localnwz3);
            if (a(localnwz3, paramString2)) {
              return a(true, false);
            }
            k += 1;
          }
  ...
  public String a(android.content.SharedPreferences.Editor paramEditor, String paramString)
  {
    ...
    //   2: aload_0
    //   3: aload_0
    //   4: getfield 56	nun:jdField_a_of_type_ComTencentBizFlatbuffersFlatBuffersParser	Lcom/tencent/biz/flatbuffers/FlatBuffersParser;
    //   7: aload_2
    //   8: ldc 237
    ...
    //   13: iconst_1
    //   14: invokevirtual 243	nun:a	(Ljava/nio/ByteBuffer;Z)Ljava/lang/String;
    //   17: astore 5
    //   19: aload_0
    //   20: getfield 245	nun:jdField_a_of_type_Nxa	Lnxa;
    //   23: ifnonnull +33 -> 56
    //   26: ldc 247
    //   28: iconst_1
    //   29: ldc 249
    ...
    //   34: aload_0
    //   35: invokevirtual 257	nun:a	()Ljava/io/File;
    //   38: invokevirtual 260	java/io/File:delete	()Z
    //   41: pop
    //   42: aload_0
    //   43: getfield 262	nun:jdField_a_of_type_Nuo	Lnuo;
    //   46: aload_1
    //   47: aload_2
    //   48: invokevirtual 266	nuo:a	(Landroid/content/SharedPreferences$Editor;Ljava/lang/String;)Ljava/lang/String;
    //   51: astore_1
    //   52: aload_0
    //   53: monitorexit
    //   54: aload_1
    //   55: areturn
    //   56: aload_0
    //   57: getfield 245	nun:jdField_a_of_type_Nxa	Lnxa;
    //   60: iconst_5
    //   61: ldc2_w 48
    //   64: invokevirtual 269	nxa:a	(IJ)J
    //   67: lstore_3
    //   68: ldc 247
    //   70: iconst_1
    ...
    //   104: pop
    //   105: aload_0
    //   106: getfield 262	nun:jdField_a_of_type_Nuo	Lnuo;
    //   109: invokevirtual 288	nuo:a	()V
    //   112: aload 5
    //   114: astore_1
    //   115: goto -63 -> 52
    //   118: astore_1
  ...
  public String a(ByteBuffer paramByteBuffer, boolean paramBoolean)
  {
    ...
    //   21: astore 5
    //   23: aload_1
    //   24: invokestatic 295	nxa:a	(Ljava/nio/ByteBuffer;)Lnxa;
    //   27: astore 9
    //   29: aload 9
    ...
    //   71: ifeq +10 -> 81
    //   74: aload_0
    //   75: getfield 245	nun:jdField_a_of_type_Nxa	Lnxa;
    ...
    //   112: aload_0
    //   113: invokevirtual 307	nun:b	()Ljava/io/File;
    //   116: astore 6
    //   118: iload_2
    //   119: ifne +860 -> 979
    //   122: aload_0
    //   123: invokevirtual 257	nun:a	()Ljava/io/File;
    ...
    //   173: aload 6
    //   175: iload_2
    //   176: invokespecial 317	com/tencent/biz/authorize/FlatBuffersConfig$2:<init>	(Lnun;Ljava/nio/ByteBuffer;Ljava/io/File;Z)V
    //   179: bipush 8
    //   181: aconst_null
    //   182: iconst_1
    ...
    //   202: new 65	nwz
    //   205: dup
    //   206: invokespecial 204	nwz:<init>	()V
    //   209: astore 10
    //   211: aload 7
    //   213: astore 5
    //   215: aload 9
    //   217: iconst_0
    //   218: aload 10
    //   220: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   262: aload 9
    //   264: iconst_1
    //   265: invokevirtual 234	nxa:a	(I)Ljava/lang/String;
    ...
    //   306: aload 9
    //   308: iconst_2
    //   309: invokevirtual 234	nxa:a	(I)Ljava/lang/String;
    ...
    //   350: aload 9
    //   352: iconst_3
    //   353: invokevirtual 234	nxa:a	(I)Ljava/lang/String;
    ...
    //   396: iconst_4
    //   397: aload 10
    //   399: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   413: aload 9
    //   415: bipush 12
    //   417: invokevirtual 234	nxa:a	(I)Ljava/lang/String;
    ...
    //   460: bipush 6
    //   462: aload 10
    //   464: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   507: bipush 7
    //   509: aload 10
    //   511: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   554: bipush 8
    //   556: aload 10
    //   558: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   601: bipush 9
    //   603: aload 10
    //   605: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   648: bipush 10
    //   650: aload 10
    //   652: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   691: bipush 11
    //   693: aload 10
    //   695: invokevirtual 210	nxa:a	(ILnwz;)Lnwz;
    ...
    //   732: aload_0
    //   733: aload 9
    //   735: putfield 245	nun:jdField_a_of_type_Nxa	Lnxa;
    //   738: aload 9
    //   740: iconst_5
    //   741: ldc2_w 48
    //   744: invokevirtual 269	nxa:a	(IJ)J
    //   747: lstore_3
    //   748: ldc 247
    //   750: iconst_1
    ...
    //   833: astore 5
    //   835: aload 10
    //   837: invokevirtual 165	nwz:a	()I
    //   840: ifle +104 -> 944
    //   843: aload 7
    //   845: astore 5
    //   847: aload 10
    //   849: iconst_0
    //   850: invokevirtual 363	nwz:a	(I)Lnxa;
    //   853: astore 6
    //   855: aload 6
    //   857: ifnull +93 -> 950
    //   860: aload 7
    ...
    //   864: aload 6
    //   866: iconst_0
    //   867: invokevirtual 202	nxa:a	(I)Lnwz;
    //   870: astore 8
    //   872: aload 7
    //   874: astore 6
    //   876: aload 8
    ...
    //   917: aload 8
    //   919: iconst_0
    //   920: invokevirtual 366	nwz:a	(I)Ljava/lang/String;
    ...
    //   957: ifeq +14 -> 971
    //   960: aload_0
    //   961: invokevirtual 257	nun:a	()Ljava/io/File;
    //   964: astore 6
    //   966: iconst_1
    //   967: istore_2
    //   968: goto -810 -> 158
    ...
    //   870	82	8	localnwz1	nwz
    //   27	712	9	localnxa	nxa
    //   209	639	10	localnwz2	nwz
    // Exception table:
    //   from	to	target	type
    //   23	29	193	finally
    //   38	62	193	finally
  ...
  public nxa a()
  {
    ...
    return this.jdField_a_of_type_Nxa;
  }
  ...
  public JSONArray a(String paramString)
  {
    ...
    nwz localnwz = ((nxa)localObject).a(((Integer)jdField_a_of_type_JavaUtilHashMap.get(paramString)).intValue());
    if (localnwz == null) {
      return null;
    }
  ...
  public JSONObject a()
  {
    ...
    {
      return localObject1;
      localObject3 = ((nxa)localObject2).a(12);
      if (localObject3 != null) {
        return new JSONObject((String)localObject3);
      }
      localObject3 = ((nxa)localObject2).a(4);
    } while (localObject3 == null);
    localObject2 = new JSONObject();
    nxa localnxa = new nxa();
    nwz localnwz1 = new nwz();
    nwz localnwz2 = new nwz();
    int k = ((nwz)localObject3).a();
    int i = 0;
    for (;;)
    {
  ...
  public void a()
  {
    ...
    //   12: return
    //   13: aload_0
    //   14: invokevirtual 257	nun:a	()Ljava/io/File;
    //   17: astore 5
    //   19: aload 5
    ...
    //   59: aload_0
    //   60: getfield 51	nun:jdField_a_of_type_Long	J
    ...
    //   82: aload_0
    //   83: getfield 245	nun:jdField_a_of_type_Nxa	Lnxa;
    //   86: ifnull +12 -> 98
    //   89: aload_0
    //   90: getfield 51	nun:jdField_a_of_type_Long	J
    //   93: lload_3
    //   94: lcmp
    //   95: ifeq -85 -> 10
    //   98: aload_0
    //   99: lload_3
    //   100: putfield 51	nun:jdField_a_of_type_Long	J
    //   103: aload 5
    ...
    //   241: iconst_0
    //   242: invokevirtual 243	nun:a	(Ljava/nio/ByteBuffer;Z)Ljava/lang/String;
    //   245: pop
    //   246: ldc 247
    //   248: iconst_1
    //   249: ldc_w 422
  ...
  public boolean a()
  {
    return (FlatBuffersParser.a()) && (this.jdField_a_of_type_Nxa != null);
  }
  ...
  public boolean a(ByteBuffer paramByteBuffer, File paramFile, boolean paramBoolean)
  {
    ...
    //   169: aload 7
    //   171: aload_1
    //   172: invokestatic 454	nun:a	(Ljava/io/OutputStream;Ljava/nio/ByteBuffer;)V
    //   175: ldc 247
    //   177: iconst_1
    //   178: ldc_w 456
    ...
    //   296: putfield 51	nun:jdField_a_of_type_Long	J
    //   299: ldc 247
    //   301: iconst_1
    ...
    //   315: aload_0
    //   316: getfield 51	nun:jdField_a_of_type_Long	J
    ...
    //   328: aload_0
    //   329: getfield 150	nun:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
  ...
  public void b()
  {
    if ((!FlatBuffersParser.a()) || (this.jdField_a_of_type_Nxa != null)) {
      return;
    }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject1 = this.jdField_a_of_type_Nxa;
        ...
        if (localObject3 != null)
        {
          try
          {
            ...
            if (this.jdField_a_of_type_Nxa == null) {
              break label303;
            }
