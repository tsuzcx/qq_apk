...
public class accu
  extends ajuc
{
  public accu(TroopTransferActivity paramTroopTransferActivity) {}
  ...
  {
    if ((!azzz.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) || (!azzz.a(paramString1, this.a.app.getCurrentAccountUin()))) {
      return;
    }
    ...
    if (paramBoolean)
    {
      ...
      paramString1.putExtra("fin_tip_msg", this.a.getString(2131654548));
    ...
    if ((paramInt == 1) || (paramInt == 2) || (paramInt == 6) || (paramInt == 8) || (paramInt == 9) || (paramInt == 10) || (paramInt == 11)) {
      paramString1 = this.a.getString(2131654534);
    }
    for (;;)
    {
      if (this.a.jdField_a_of_type_Bbmv == null) {
      ...
      this.a.jdField_a_of_type_Bbmv.a(2, paramString1, 1500);
      return;
      if ((paramInt == 3) || (paramInt == 4) || (paramInt == 7) || (paramInt == 16) || (paramInt == 19))
      {
        paramString1 = this.a.getString(2131654536);
      }
      else if ((paramInt == 5) || (paramInt == 17) || (paramInt == 18))
      {
        paramString1 = this.a.getString(2131654535);
      }
      else
      {
        if (paramInt == 12)
        {
          ...
          paramString1 = babr.a(this.a, 230);
          paramString1.setTitle(this.a.getString(2131630803));
          paramString1.setMessage(this.a.getString(2131630804));
          paramString1.setNegativeButton(this.a.getString(2131630758), new accv(this, paramString1));
          paramString1.setPositiveButton(this.a.getString(2131653656), new accw(this, paramString1));
          paramString1.show();
          return;
        }
        paramString1 = this.a.getString(2131654535);
