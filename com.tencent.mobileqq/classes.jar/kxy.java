...
public class kxy
  implements Runnable
{
  public kxy(ReadInJoyNativeAdAppVideoView paramReadInJoyNativeAdAppVideoView) {}
  ...
  public void run()
  {
    if ((ReadInJoyNativeAdAppVideoView.a(this.a) != null) && (ReadInJoyNativeAdAppVideoView.a(this.a).isPlaying()))
    {
      ...
      if (!ReadInJoyNativeAdAppVideoView.a(this.a))
      {
        ...
        NativeAdUtils.a(ReadInJoyNativeAdAppVideoView.a(this.a), this.a.getContext(), NativeAdUtils.f, 9, ReadInJoyNativeAdAppVideoView.a(this.a), null, 0, NativeAdUtils.a(ReadInJoyNativeAdAppVideoView.c(this.a), ReadInJoyNativeAdAppVideoView.d(this.a), ReadInJoyNativeAdAppVideoView.e(this.a), ReadInJoyNativeAdAppVideoView.f(this.a), ReadInJoyNativeAdAppVideoView.g(this.a), ReadInJoyNativeAdAppVideoView.h(this.a), (int)(ReadInJoyNativeAdAppVideoView.a(this.a) / 1000L), NativeAdUtils.n));
