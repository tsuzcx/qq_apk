...
{
  private alsi jdField_a_of_type_Alsi = new asng(this);
  private Handler jdField_a_of_type_AndroidOsHandler;
  private asop jdField_a_of_type_Asop;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private long[] jdField_a_of_type_ArrayOfLong;
  private asop b;
  
  public asnd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static asnd a(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    QQToast.a(paramContext, 0, alpo.a(2131705054), 2000).a();
    int j;
    if (this.b != null)
    {
    ...
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      ...
      this.b = null;
      this.jdField_a_of_type_Asop = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      paramBaseChatPie.a(localacfe);
      localacfe.i = paramBaseChatPie.J;
      paramBaseChatPie.J = false;
      this.jdField_a_of_type_ArrayOfLong = acex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.a(), paramBaseChatPie.a(), str, new ArrayList(), localacfe);
  ...
  private void a(BaseChatPie paramBaseChatPie, long paramLong, int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = alpo.a(2131705055);
    }
    ...
    bdcd.a(paramBaseChatPie.a(), 230, (String)localObject1, (CharSequence)localObject2, alpo.a(2131705056), (String)localObject3, new asne(this, paramBaseChatPie, str), new asnf(this)).show();
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Asop != null) {
          this.jdField_a_of_type_Asop.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
      }
      return;
      label59:
  ...
  public void a(BaseChatPie paramBaseChatPie, Bundle paramBundle)
  {
    ...
    if (this.b != null)
    {
      ...
      this.b = new asop(this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
  ...
  public void a(BaseChatPie paramBaseChatPie, boolean paramBoolean, SetFontBubbleRsp paramSetFontBubbleRsp, int paramInt)
  {
    if ((paramBoolean) && (paramSetFontBubbleRsp.stRet != null) && (paramSetFontBubbleRsp.stRet.ret == 0))
    {
      ...
      if ((this.jdField_a_of_type_Asop != null) && (this.jdField_a_of_type_Asop.jdField_a_of_type_Int == paramInt))
      {
        if ((paramSetFontBubbleRsp.stFontRsp.authRet != 0) || (paramSetFontBubbleRsp.stBubbleRsp.authRet != 0)) {
          QLog.e("FontBubbleManager", 1, "onSetFontBubble failed," + " fontAuth:" + paramSetFontBubbleRsp.stFontRsp.authRet + " bubbleAuth:" + paramSetFontBubbleRsp.stBubbleRsp.authRet + this.jdField_a_of_type_Asop.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
        }
        for (;;)
        {
          this.jdField_a_of_type_Asop = null;
          return;
          if (QLog.isColorLevel()) {
            QLog.d("FontBubbleManager", 2, "onSetFontBubble mRestore success: " + this.jdField_a_of_type_Asop.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
          }
        }
      }
    ...
    StringBuilder localStringBuilder = aekt.a().append("onSetFontBubble failed,");
    ...
    if ((this.jdField_a_of_type_Asop != null) && (this.jdField_a_of_type_Asop.jdField_a_of_type_Int == paramInt)) {
      QLog.e("FontBubbleManager", 1, "restore failed: " + this.jdField_a_of_type_Asop.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
    }
    a(paramBaseChatPie.a());
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1000: 
      ...
      this.jdField_a_of_type_Asop = new asop((FontBubble)paramMessage[0]);
      this.b = new asop((FontBubble)paramMessage[1]);
      this.b.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return true;
    }
