...
public class asnd
  implements bata, bbfe<asnh>
{
  private int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  protected amop a;
  private Context jdField_a_of_type_AndroidContentContext;
  private asml jdField_a_of_type_Asml;
  private basv jdField_a_of_type_Basv;
  private bbff<asnh> jdField_a_of_type_Bbff;
  ...
  private List<basn> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean;
  private List<befl> jdField_c_of_type_JavaUtilList;
  private boolean jdField_c_of_type_Boolean;
  private volatile boolean d = true;
  
  public asnd(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, int paramInt, asml paramasml)
  {
    this.jdField_a_of_type_Amop = new asne(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Asml = paramasml;
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong, List<Long> paramList, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      ((amoo)paramQQAppInterface.getBusinessHandler(22)).a("GroupFileAppSvr.GetFileSearch", paramList.toByteArray(), (Bundle)localObject);
  ...
  private void a(boolean paramBoolean, List<befl> paramList)
  {
  ...
  private void b(String paramString)
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_Basv = null;
      label96:
      QLog.i("TroopFileSearchEngine<QFile>", 4, "execSearch. success.");
      this.jdField_a_of_type_Basv = new basv(paramString, paramString, this.jdField_b_of_type_JavaUtilList, this);
  ...
  public List<asnh> a(bbfs parambbfs)
  {
    return null;
  }
  ...
  public void a(bbfs parambbfs, bbff<asnh> parambbff)
  {
