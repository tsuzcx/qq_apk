...
public class asnd
{
  ...
  {
    ((asmu)paramQQAppInterface.getManager(358)).a(paramString);
  }
  ...
  private static void a(msg_comm.Msg paramMsg, QQAppInterface paramQQAppInterface, ayzj paramayzj, String paramString1, String paramString2)
  {
    if (paramMsg.msg_head.has())
    {
      paramMsg = (msg_comm.C2CTmpMsgHead)((msg_comm.MsgHead)paramMsg.msg_head.get()).c2c_tmp_msg_head.get();
      if ((!paramayzj.d) && (paramMsg.sig.has()))
      {
        paramMsg = paramMsg.sig.get().toByteArray();
        paramQQAppInterface.a().d(paramString1, paramString2, paramMsg);
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.tiny_msg.decoder.TinyMsgCodec", 4, "saveTokenSig tempHead.sig.get()----> sig:" + bdhe.a(paramMsg) + ",length:" + paramMsg.length);
        }
      }
    }
  }
  
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface, ayzj paramayzj)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((hummer_commelem.MsgElemInfo_servtype34)localObject1).from_nickname.has())
        {
          ...
          a(paramMsg, paramQQAppInterface, paramayzj, ((MessageRecord)localObject2).frienduin, str4);
          paramayzj.e = Long.parseLong(((MessageRecord)localObject2).frienduin);
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("Q.tiny_msg.decoder.TinyMsgCodecdecodePBMsgGameInterCommElem", 2, "toTinyId = " + l3 + ", fromTinyId = " + l2 + ", ctx.senderUin = " + paramayzj.b + ", ctx.friendUin = " + paramayzj.e + ", mr = " + ((MessageRecord)localObject2).getBaseInfoString());
          continue;
        }
      }
