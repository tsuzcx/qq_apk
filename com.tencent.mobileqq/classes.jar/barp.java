...
public class barp
  implements SurfaceTexture.OnFrameAvailableListener, bary, AEDecoder
{
  ...
  public barp(String paramString)
  {
    this.jdField_a_of_type_Barv = new barv(paramString, 0, false, false);
  }
  ...
  public void setTexture(int paramInt)
  {
    a();
    this.j = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWVideoDecoder.a(this.jdField_a_of_type_Barv, this.k, this, this);
    this.g = 2;
  }
}
