...
public class bffa
{
  private static bffa a;
  private static final HashMap<String, Integer> b = new HashMap();
  protected HashMap<String, bffb> a;
  protected JSONArray a;
  protected JSONObject a;
  
  static
  {
    b.put("10009", Integer.valueOf(2130843757));
    b.put("10010", Integer.valueOf(2130843758));
    b.put("10011", Integer.valueOf(2130843759));
    b.put("24", Integer.valueOf(2130843760));
    b.put("25", Integer.valueOf(2130843761));
    b.put("26", Integer.valueOf(2130843762));
    b.put("27", Integer.valueOf(2130843763));
    b.put("28", Integer.valueOf(2130843764));
    b.put("29", Integer.valueOf(2130843765));
    b.put("30", Integer.valueOf(2130843766));
    b.put("31", Integer.valueOf(2130843767));
    b.put("32", Integer.valueOf(2130843768));
    b.put("20001", Integer.valueOf(2130843676));
    b.put("20002", Integer.valueOf(2130843677));
    b.put("20003", Integer.valueOf(2130846945));
  }
  ...
  public static bffa a()
  {
    if (jdField_a_of_type_Bffa == null) {}
    try
    {
      if (jdField_a_of_type_Bffa == null) {
        jdField_a_of_type_Bffa = new bffa();
      }
      return jdField_a_of_type_Bffa;
    }
    finally {}
  }
  
  public bffb a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (bffb)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if ((paramBoolean) && ((((bffb)localObject2).jdField_a_of_type_JavaUtilArrayList == null) || (((bffb)localObject2).jdField_a_of_type_JavaUtilArrayList.isEmpty()))) {
          break;
        }
        return localObject2;
      }
      Object localObject2 = this.jdField_a_of_type_OrgJsonJSONObject.optJSONArray(paramString);
      bffb localbffb = new bffb();
      localbffb.a(paramString);
      localbffb.d = ((String)localObject1);
      localbffb.jdField_b_of_type_Int = i;
      localbffb.jdField_b_of_type_JavaLangString = ((JSONArray)localObject2).optString(0);
      int j = ((JSONArray)localObject2).length();
      if (j > 1)
      {
        localbffb.jdField_a_of_type_Boolean = true;
        if (paramBoolean)
        {
          localbffb.jdField_a_of_type_JavaUtilArrayList = new ArrayList(j);
          ...
          if (i < j)
          {
            ...
            for (;;)
            {
              i += 1;
              break;
              localObject3 = new bffb((String)localObject3, localJSONArray.optString(0));
              ((bffb)localObject3).d = paramString;
              localbffb.jdField_a_of_type_JavaUtilArrayList.add(localObject3);
              if (i <= 2)
              {
                if (i != 1) {
                  ((StringBuilder)localObject1).append("、");
                }
                ((StringBuilder)localObject1).append(((bffb)localObject3).jdField_b_of_type_JavaLangString);
              }
            }
          }
          localbffb.c = ((StringBuilder)localObject1).toString();
        }
      }
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localbffb);
      return localbffb;
      localObject1 = null;
    }
  }
  
  public ArrayList<bffb> a()
  {
    ...
    while (i < k)
    {
      ...
      bffb localbffb1 = new bffb();
      localbffb1.jdField_b_of_type_Int = 2;
      localbffb1.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("title");
      localArrayList.add(localbffb1);
      localbffb1.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      localObject = ((JSONObject)localObject).optJSONArray("cates");
      int m = ((JSONArray)localObject).length();
      int j = 0;
      if (j < m)
      {
        bffb localbffb2 = a(((JSONArray)localObject).optString(j), true);
        if (localbffb2 == null) {}
        for (;;)
        {
          j += 1;
          break;
          localbffb1.jdField_a_of_type_JavaUtilArrayList.add(localbffb2);
        }
      }
      i += 1;
    }
