  ...
  implements bfez
{
  ...
  public static bfez a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qlink.IQlinkService");
    if ((localIInterface != null) && ((localIInterface instanceof bfez))) {
      return (bfez)localIInterface;
    }
    return new bffb(paramIBinder);
  }
