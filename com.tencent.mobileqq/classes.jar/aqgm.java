...
public class aqgm
{
  private static aqgm jdField_a_of_type_Aqgm;
  public int a;
  public Paint a;
  private LruCache<String, aqgn> jdField_a_of_type_AndroidUtilLruCache;
  private aqgt jdField_a_of_type_Aqgt;
  
  private aqgm()
  {
    this.jdField_a_of_type_Int = bgtn.a(150.0F);
    ...
    {
      if (this.jdField_a_of_type_Aqgt == null) {
        this.jdField_a_of_type_Aqgt = new aqgt();
      }
      b();
    }
  }
  ...
  {
    if (jdField_a_of_type_Aqgm == null) {
      jdField_a_of_type_Aqgm = new aqgm();
    }
    return jdField_a_of_type_Aqgm;
  }
  
  public aqgn a(String paramString)
  {
    return (aqgn)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
  }
  ...
  public List<DanmuItemBean> a(List<oidb_0xdea.Comment> paramList, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject3 = localbbzc.a((List)localObject2, new StringBuilder(), l2, paramList);
        if (TextUtils.isEmpty(((bbzd)localObject3).jdField_a_of_type_JavaLangString)) {
          break;
        }
        if ((TextUtils.isEmpty(((bbzd)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mAnonymousNickName)) && (((bbzd)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo != null) && (!TextUtils.isEmpty(((bbzd)localObject3).jdField_a_of_type_JavaLangString)) && (((bbzd)localObject3).jdField_a_of_type_JavaLangString.length() > ((bbzd)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo.textLen + 1) && (((bbzd)localObject3).jdField_a_of_type_JavaLangString.startsWith(((bbzd)localObject3).b)))
        {
          paramList = ((bbzd)localObject3).jdField_a_of_type_JavaLangString.substring(((bbzd)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo.textLen + 1);
          if (!TextUtils.isEmpty(paramList)) {
            ((bbzd)localObject3).jdField_a_of_type_JavaLangString = paramList;
          }
        }
        ...
        if (TextUtils.isEmpty(paramList))
        {
          localObject1 = bglf.h(localQQAppInterface, String.valueOf(paramLong), String.valueOf(l1));
          ...
          paramList = aqgv.a(this.jdField_a_of_type_AndroidGraphicsPaint, paramList, this.jdField_a_of_type_Int);
          localObject1 = new DanmuItemBean(l1, l2, l3, l4, ((bbzd)localObject3).jdField_a_of_type_JavaLangString, paramList);
      ...
      if (i == 4)
      {
        localObject1 = ((anmw)localQQAppInterface.getManager(51)).b(String.valueOf(l1));
  ...
  public void a(aqgl paramaqgl, aqgr paramaqgr)
  {
    if ((paramaqgl.a == 0L) || (paramaqgl.b == 0L))
    {
      if (QLog.isColorLevel()) {
        QLog.d("DanmuDataHolder", 2, String.format("request, bad parameter, topicUin:%s, groupUin:%s", new Object[] { Long.valueOf(paramaqgl.a), Long.valueOf(paramaqgl.b) }));
      }
      return;
    }
    Object localObject = a().a(paramaqgl.b, paramaqgl.a);
    aqgn localaqgn = a().a((String)localObject);
    localObject = localaqgn;
    if (localaqgn == null)
    {
      localObject = new aqgn(this).a(paramaqgl).d(0).e(0).a(paramaqgr).a();
      QLog.d("DanmuDataHolder", 2, "request start, reqHolder is null, create it");
    }
    this.jdField_a_of_type_Aqgt.a((aqgn)localObject);
  }
  
  public void a(String paramString, aqgn paramaqgn)
  {
    this.jdField_a_of_type_AndroidUtilLruCache.put(paramString, paramaqgn);
  }
  
  public aqgn b(String paramString)
  {
    aqgn localaqgn = new aqgn(this);
    a(paramString, localaqgn);
    return localaqgn;
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsPaint == null) && (localQQAppInterface != null)) {
      this.jdField_a_of_type_AndroidGraphicsPaint = ((TextView)LayoutInflater.from(localQQAppInterface.getApp()).inflate(2131558924, null).findViewById(2131364725)).getPaint();
    }
  }
}
