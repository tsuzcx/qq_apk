...
public class aegl
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, bhee parambhee)
  {
    if (paramContext == null) {}
    while ((paramString == null) || ("".equals(paramString)) || (paramQQAppInterface == null)) {
      return;
    }
    ThreadManager.post(new LebaIconDownloader.1(paramContext, paramString, paramQQAppInterface, parambhee), 5, null, true);
  }
