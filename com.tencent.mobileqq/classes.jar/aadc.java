  ...
  implements AsyncBack, Runnable
{
  ...
  public aadc(UpgradeTIMManager paramUpgradeTIMManager, String paramString1, String paramString2)
  {
  ...
  private void a()
  {
    UpgradeTIMManager.a(this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeTIMManager).postDelayed(new aadd(this), 3000L);
  }
  ...
  private void b()
  {
    ...
    {
      ThreadManager.post(new aade(this), 8, null, false);
