...
{
  aadc(aada paramaada, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Aada.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Aada.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        aada.a(this.jdField_a_of_type_Aada, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        auwo.d = System.currentTimeMillis();
        l1 = auwo.d - auwo.jdField_a_of_type_Long;
        long l3 = auwo.b - auwo.jdField_a_of_type_Long;
        long l4 = auwo.c - auwo.b;
        long l5 = auwo.d - auwo.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Aada.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Aada.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = StatisticCollector.getInstance(this.jdField_a_of_type_Aada.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
      ...
      return;
      label1197:
      this.jdField_a_of_type_Aada.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      aada.a(this.jdField_a_of_type_Aada, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        aada.b(this.jdField_a_of_type_Aada, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", amtj.a(2131713372));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", amtj.a(2131713378));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", amtj.a(2131713377));
        break;
        paramBoolean = false;
        break label1110;
        return;
