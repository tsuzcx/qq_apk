  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  private aneu jdField_a_of_type_Aneu;
  ...
  public WeakReference<anek> a;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  WeakReference<Context> jdField_b_of_type_JavaLangRefWeakReference;
  
  public anev(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    this.jdField_a_of_type_Aneu = new aneu((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), this);
    ...
    if (annu.jdField_a_of_type_Int > 0)
    {
      jdField_a_of_type_Int = annu.jdField_a_of_type_Int * 1000;
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        localObject2 = (amsx)((AppInterface)localObject2).getManager(153);
        localObject1 = localChatFragment;
        if (localObject2 != null)
        {
          localObject2 = ((amsx)localObject2).a();
          localObject1 = localChatFragment;
          if (localObject2 != null) {
  ...
  private void g()
  {
    ...
    if ((localBaseChatPie != null) && (this.jdField_a_of_type_Aneu != null) && (localBaseChatPie.a().a() == this.jdField_a_of_type_Aneu) && (this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()))
    {
      this.jdField_a_of_type_Aneu.a();
      this.jdField_a_of_type_Blhq.removeMessages(20);
      this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(20, 1000L);
    }
  }
  ...
  {
    this.jdField_a_of_type_Aneu = new aneu(paramActivity, this);
  }
  
  public void a(anek paramanek)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramanek);
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((aiwh)localObject).a() == this.jdField_a_of_type_Aneu))
      {
        ((aiwh)localObject).a();
        if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    for (localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = anzj.a(2131701050);
      }
      localMessage.obj = (anzj.a(2131701046) + (String)localObject2);
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Aneu != null)
    {
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        break label251;
      }
      this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Aneu.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      this.jdField_a_of_type_Aneu.c.setVisibility(8);
    }
    label251:
    while (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)
    {
      ...
      if (this.jdField_a_of_type_Aneu != null)
      {
        if ((this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
          ((ViewGroup)this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        ((aiwh)localObject1).a(this.jdField_a_of_type_Aneu, new Object[0]);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    for (Object localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      Object localObject2 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = anzj.a(2131701049);
      }
      localObject1 = anzj.a(2131701051) + (String)localObject2;
      this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      this.jdField_a_of_type_Aneu.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      break;
    }
  }
  ...
  public void e()
  {
    this.jdField_a_of_type_Blhq.removeMessages(25);
  ...
  {
    this.jdField_a_of_type_Blhq.removeMessages(25);
    this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(25, jdField_a_of_type_Int);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      ...
                      paramMessage.ar();
                      return false;
                      if ((this.jdField_a_of_type_Aneu != null) && ((paramMessage.obj instanceof String)))
                      {
                    ...
                    if (paramMessage != null)
                    {
                      ...
                      if ((localObject3 != null) && (this.jdField_a_of_type_Aneu != null))
                      {
                        if ((this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
                          ((ViewGroup)this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout);
                        }
                        if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                        {
                          ...
                          if (TextUtils.isEmpty(paramMessage)) {
                            localObject1 = anzj.a(2131701052);
                          }
                          paramMessage = anzj.a(2131701047) + (String)localObject1;
                          this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
                          this.jdField_a_of_type_Aneu.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessage);
                        }
                        this.jdField_a_of_type_Aneu.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Aneu.c.setVisibility(8);
                        ((aiwh)localObject3).a(this.jdField_a_of_type_Aneu, new Object[0]);
                        if (QLog.isColorLevel()) {
                          QLog.d("cmgame_process.CmGameUIManager", 2, "showGameTips");
                        }
                      }
                    }
                    Object localObject3 = anbd.a();
                    MqqHandler localMqqHandler;
                    Message localMessage;
                    ...
                    for (paramMessage = (Message)localObject2;; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      localObject1 = paramMessage;
                      if (TextUtils.isEmpty(paramMessage)) {
                        localObject1 = anzj.a(2131701043);
                      }
                      localMessage.obj = (anzj.a(2131701045) + (String)localObject1);
                      localMqqHandler.sendMessage(localMessage);
                      ...
                      {
                        paramMessage = (anek)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if (paramMessage != null) {
                          paramMessage.a();
                        }
                      }
                    ...
                    for (paramMessage = "";; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      ...
                      anat.a(this.jdField_b_of_type_Int);
                    ...
                    if (localObject2 != null)
                    {
                      ...
                      if (localObject2 != null)
                      {
                        if ((this.jdField_a_of_type_Aneu == null) || (this.jdField_a_of_type_Aneu != ((aiwh)localObject2).a())) {
                          break label964;
                        }
                        ((aiwh)localObject2).a();
                        if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        localObject2 = (anek)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if ((paramMessage.obj instanceof String)) {
                          localObject1 = (String)paramMessage.obj;
                        }
                        if (localObject2 != null) {
                          ((anek)localObject2).d((String)localObject1);
                        }
                      }
                      paramMessage = anbd.a();
                      ...
                      VipUtils.a(paramMessage, "cmshow", "Apollo", "shutdown_game", 0, 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), Integer.toString(anbd.b()), Integer.toString(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.commFlag & 0x1) });
                      return false;
                      if (QLog.isColorLevel()) {
                    ...
                    if ((paramMessage.obj instanceof String))
                    {
                      ...
                      if (this.jdField_a_of_type_Aneu != null)
                      {
                        this.jdField_a_of_type_Aneu.c.setVisibility(8);
                        this.jdField_a_of_type_Aneu.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetTextView.setText((String)paramMessage.obj);
                      }
                    }
                    paramMessage = anbd.a();
              ...
              this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(24, 500L);
              return false;
              paramMessage = a();
            } while (paramMessage == null);
            paramMessage.ar();
        ...
        if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aneu != null))
        {
          localObject1 = (String)paramMessage.obj;
          localObject2 = new SpannableString((String)localObject1 + anzj.a(2131701048));
          ((SpannableString)localObject2).setSpan(new ForegroundColorSpan(-16776961), 0, ((String)localObject1).length(), 17);
          this.jdField_a_of_type_Aneu.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          g();
        }
      } while (!QLog.isColorLevel());
      ...
      paramMessage = a();
    } while ((paramMessage == null) || (this.jdField_a_of_type_Aneu == null) || (paramMessage.a().a() != this.jdField_a_of_type_Aneu) || (!this.jdField_a_of_type_Aneu.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()));
    label733:
    this.jdField_a_of_type_Aneu.b();
    label964:
    return false;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (Object localObject = "";; localObject = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      localObject = a();
      if (localObject != null) {
        ((BaseChatPie)localObject).ar();
      }
      this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(18, 300L);
