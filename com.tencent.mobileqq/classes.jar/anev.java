  ...
  extends AbsDownloader
{
  ...
  public static URLDrawable a(boolean paramBoolean1, String paramString1, URLDrawable.URLDrawableOptions paramURLDrawableOptions, String paramString2, boolean paramBoolean2)
  {
    ...
    for (String str = "/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/image_cache/boxcard/" + paramString1;; str = paramString1)
    {
      ...
      if (localURLDrawableOptions.mExtraInfo == null) {
        localURLDrawableOptions.mExtraInfo = new anew();
      }
      paramBoolean1 = paramBoolean2;
      if ((localURLDrawableOptions.mExtraInfo instanceof anew))
      {
        paramURLDrawableOptions = (anew)localURLDrawableOptions.mExtraInfo;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return false;
      String str = "/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/image_cache/" + paramString.substring(paramString.lastIndexOf("/") + 1);
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    anew localanew;
    if ((paramFile != null) && (paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof anew)))
    {
      localanew = (anew)paramDownloadParams.mExtraInfo;
      if (localanew.jdField_a_of_type_Int != jdField_a_of_type_Int) {
        break label102;
      }
    }
    for (;;)
    {
      try
      {
        ...
        localBitmap = bheg.a(localBitmap, localBitmap.getWidth(), localBitmap.getHeight());
      ...
      } while (localanew.jdField_a_of_type_Int != b);
      if (paramFile.exists())
      {
        ...
        paramURLDrawableHandler.inSampleSize = bheg.a(paramURLDrawableHandler, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight);
        ...
        try
        {
          ...
          if (paramFile != null) {
            if (localanew.jdField_a_of_type_Boolean)
            {
              i = 2130850010;
              paramDownloadParams = bheg.a(paramFile, i, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight, true);
  ...
  public File downloadImage(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof anew)))
    {
      paramOutputStream = (anew)paramDownloadParams.mExtraInfo;
      ...
      do
      {
        ...
        bhyo localbhyo = new bhyo(paramOutputStream, paramDownloadParams);
        localbhyo.b = 1;
        localbhyo.p = false;
        localbhyo.q = true;
        localbhyo.r = true;
        i = bhyq.a(localbhyo, null);
        if (i != 0) {
          break;
        }
        if (paramURLDrawableHandler != null) {
