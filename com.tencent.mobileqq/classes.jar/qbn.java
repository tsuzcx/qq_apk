...
public class qbn
  extends qbh
{
  public qbn(Context paramContext, bdbb parambdbb, rqj paramrqj)
  {
  ...
  public pxl a()
  {
    ...
    return d(this.jdField_a_of_type_Rqj, this.jdField_a_of_type_Bdbb).q().g().l().j().n();
  }
  ...
  public pxl d()
  {
    ...
    if ((this.jdField_a_of_type_Pxk != null) && ((this.jdField_a_of_type_Pxk instanceof ComponentContentBigImageVideo)))
    {
      ...
      ((ComponentContentBigImageVideo)this.jdField_a_of_type_Pxk).setOnClickListener(new qbo(this));
