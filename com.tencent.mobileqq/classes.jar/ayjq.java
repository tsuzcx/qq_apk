...
public class ayjq
  implements ayjh
{
  private static ayjq jdField_a_of_type_Ayjq;
  private ayji jdField_a_of_type_Ayji;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new ayjr(this, "PrecoverIPCServer_MODEL");
  ...
  private ayjq()
  {
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_Ayji = ((ayji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(179));
      this.jdField_a_of_type_Ayji.a().a(this);
    }
  }
  
  public static ayjq a()
  {
    if (jdField_a_of_type_Ayjq == null) {}
    try
    {
      if (jdField_a_of_type_Ayjq == null) {
        jdField_a_of_type_Ayjq = new ayjq();
      }
      return jdField_a_of_type_Ayjq;
    }
    finally {}
  }
  ...
  private EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Ayji.a((String)localObject2, str);
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    if ((paramObject != null) && ((paramObject instanceof Object[])) && ("PrecoverIPCServer_MODEL".equals(((Object[])(Object[])paramObject)[0])))
    {
      ...
      paramObject.putString("key_action", ayjp.b);
