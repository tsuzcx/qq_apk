  ...
  extends ayjh
{
  ...
  public ayjq(QQAppInterface paramQQAppInterface, int paramInt, MiniAppLocalSearchEntity paramMiniAppLocalSearchEntity, String paramString)
  {
  ...
  {
    return ayrd.b(this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appName, this.jdField_a_of_type_JavaLangString, 10, true);
  }
  ...
  public void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ReportModelDC02528 localReportModelDC02528 = new ReportModelDC02528().module("all_result").action("clk_item").obj1(paramView.jdField_a_of_type_Long + "").obj2(this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appId).ver1(paramView.jdField_a_of_type_JavaLangString).ver2(aynt.a(UniteSearchActivity.d));
        if (c())
        {
          paramView = "1";
          aynt.a(null, localReportModelDC02528.ver3(paramView).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + aydw.jdField_a_of_type_Long));
          ayrd.b(localQQAppInterface, this.jdField_a_of_type_JavaLangString, this.i, e(), e());
          if ((this.i == null) || (TextUtils.isEmpty(this.i))) {
            break label379;
          }
          aynt.a(null, 0, this.b, "0X8009D31", 3, 0, null, null);
          return;
          label314:
      ...
      catch (JSONException localJSONException)
      {
        ...
        {
          aynt.a(null, 0, this.b, "0X8009D33", 0, 0, this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appId, null);
          return;
        }
        aynt.a(null, 0, this.b, "0X8009D45", 0, 0, this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appId, null);
      }
    }
  }
