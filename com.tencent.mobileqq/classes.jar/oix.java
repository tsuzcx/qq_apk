  ...
  extends LinearLayout
{
  ...
  public oix(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2130970714, null);
  ...
  public void a(LocationFacePackage paramLocationFacePackage, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localURLImageView = (URLImageView)((View)localObject3).findViewById(2131364363);
      localTextView = (TextView)((View)localObject3).findViewById(2131364362);
      localObject2 = (ProgressBar)((View)localObject3).findViewById(2131364364);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localObject2 = new oiy((String)localObject1, localURLImageView, (ProgressBar)localObject2);
        ...
        if (((URLDrawable)localObject1).getStatus() == 1) {
          ((oiy)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
        }
