  ...
  extends ajxj
{
  ...
  protected void onSetSpecialCareSwitch_global(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    if (this.a.jdField_a_of_type_Ails != null) {
      this.a.jdField_a_of_type_Ails.notifyDataSetChanged();
    }
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            bcql.a(this.a.getActivity(), 2, ajya.a(2131704875), 0).a();
            return;
          }
          bcql.a(this.a.getActivity(), 2, ajya.a(2131704876), 0).a();
          return;
        }
      }
      ...
      if (FriendFragment.a(this.a))
      {
        if (FriendFragment.b(this.a))
        {
          ...
          if (this.a.jdField_a_of_type_Afqs != null) {
            this.a.jdField_a_of_type_Afqs.a(this.a.b(), paramBoolean1, null);
          }
        }
  ...
  protected void onUpdateSpecialCareList(boolean paramBoolean1, boolean paramBoolean2, List<SpecialCareInfo> paramList)
  {
    ...
    if ((paramBoolean1) && (this.a.jdField_a_of_type_Ails != null)) {
      this.a.jdField_a_of_type_Ails.notifyDataSetChanged();
    }
  }
}
