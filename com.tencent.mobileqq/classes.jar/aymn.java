...
{
  public aymn(AppInterface paramAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((i == 0) && (paramToServiceMsg.str_config_version.has()))
    {
      ...
      {
        paramObject = (aymd)this.app.getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER);
        if (paramObject != null)
        {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = paramToServiceMsg.extraData.getInt("task_id");; i = 0)
    {
      ...
      paramObject = (aymd)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER);
      if (paramObject == null) {
        break;
      }
      if (j == 0)
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("RedtouchHandler", 2, "getRedPointConfigs(), client version : 8.4.10");
    }
    cmd0x6f5.ReqBody localReqBody = new cmd0x6f5.ReqBody();
    localReqBody.uint32_qq_platform.set(1);
    localReqBody.str_qq_version.set("8.4.10");
