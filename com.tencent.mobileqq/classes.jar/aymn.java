...
public class aymn
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, aymn paramaymn, String paramString2)
  {
    if ((paramView == null) || (paramaymn == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramaymn.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramaymn = paramaymn.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramaymn == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramaymn instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramaymn);
                                      return;
                                    }
                                  } while (!(paramaymn instanceof String));
                                  paramString1 = (String)paramaymn;
                            ...
                            if ((paramaymn instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramaymn).getConstantState().newDrawable();
                              paramaymn = new Rect();
                              paramString1.getPadding(paramaymn);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramaymn.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramaymn.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramaymn.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramaymn.bottom;
                              paramaymn = paramView.findViewById(2131374184);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramaymn != null) {
                                  paramaymn.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramaymn != null) {
                                  paramaymn.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramaymn instanceof String));
                      ...
                      } while (!(paramaymn instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramaymn instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramaymn).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramaymn).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramaymn).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramaymn).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramaymn instanceof Drawable));
      ((ImageView)paramView).setImageDrawable((Drawable)paramaymn);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramaymn instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramaymn;
    paramaymn = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = bfrj.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 777	aymn:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 777	aymn:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 779
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 781	aymn:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 781	aymn:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    ...
    //   121: aload_1
    //   122: ldc2_w 552
    //   125: invokestatic 558	bfrj:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    ...
    //   336: putstatic 777	aymn:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 777	aymn:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    ...
    //   383: putstatic 781	aymn:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 781	aymn:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!aynq.a(paramQQAppInterface)) {
            continue;
          }
          str1 = aynt.a(paramQQAppInterface.getApp());
