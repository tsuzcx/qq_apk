...
public class ahst
  extends altm
{
  private ahst(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, alud.a(2131700612), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, alud.a(2131700613), 0).a();
          return;
        }
      }
