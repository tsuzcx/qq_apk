...
public class ohf
{
  private static final akfx jdField_a_of_type_Akfx = new ohg("readinjoy_anti_cheating", false);
  private static boolean jdField_a_of_type_Boolean;
  
  private static int a()
  {
    String str1 = a();
    String str2 = (String)bgmq.a("readinjoy_sp_key_last_request_lbs_date", "");
    QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "getToadyRequestLbsTime, today = ", str1, ", lastRequestLbsDate = ", str2 });
    if (str1.equals(str2)) {
      return ((Integer)bgmq.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(0))).intValue();
    }
    return 0;
  }
  ...
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = akfu.a("readinjoy_anti_cheating");
  ...
  public static void a()
  {
    ...
    bgmq.a("readinjoy_sp_key_app_launch_time", Long.valueOf(l));
  }
  ...
  private static boolean a()
  {
    ...
    if (localObject != null)
    {
      ...
      long l1 = ((Long)bgmq.a("readinjoy_sp_key_app_launch_time", Long.valueOf(System.currentTimeMillis()))).longValue();
  ...
  {
    String str = a();
    Object localObject = (String)bgmq.a("readinjoy_sp_key_last_request_lbs_date", "");
    QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "updateToadyRequestLbsTime, today = ", str, ", lastRequestLbsDate = ", localObject });
    if (str.equals(localObject))
    {
      localObject = (Integer)bgmq.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(0));
      QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "updateToadyRequestLbsTime, todayTime = ", localObject });
      bgmq.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(((Integer)localObject).intValue() + 1));
    }
    for (;;)
    {
      bgmq.a("readinjoy_sp_key_last_request_lbs_date", str);
      return;
      QLog.d("ReadInJoySpEventReportUtil", 1, "updateToadyRequestLbsTime, first time today.");
      bgmq.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(1));
    }
  }
}
