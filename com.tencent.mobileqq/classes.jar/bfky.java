...
public abstract class bfky
{
  bfky(TraeAudioManager paramTraeAudioManager) {}
  ...
  public void a(Context paramContext, Intent paramIntent, bfkz parambfkz)
  {
    if ("android.bluetooth.adapter.action.STATE_CHANGED".equals(paramIntent.getAction()))
    {
      ...
      if (i == 10)
      {
        ...
        parambfkz.a("DEVICE_BLUETOOTHHEADSET", false);
      }
  ...
  public abstract boolean a(Context paramContext, bfkz parambfkz);
