  ...
  extends nuu
{
  ...
  public bfpu(Context paramContext, String paramString)
  {
    super(paramContext, paramString);
  }
  
  /* Error */
  public static bfpv a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   25: invokestatic 39	com/tencent/mobileqq/utils/FileUtils:readFileToString	(Ljava/io/File;)Ljava/lang/String;
    //   28: astore_1
    //   29: aload_1
    //   30: invokestatic 28	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   33: ifne -19 -> 14
    //   36: new 41	org/json/JSONObject
    //   39: dup
    //   40: aload_1
    //   41: invokespecial 44	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   44: astore 4
    ...
    //   71: new 61	bfpv
    //   74: dup
    //   75: invokespecial 62	bfpv:<init>	()V
    //   78: astore_1
    //   79: aload 4
    //   81: ldc 64
    //   83: invokevirtual 68	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   86: astore 5
    //   88: aload 5
    ...
    //   116: putfield 70	bfpv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   119: aload 4
    //   121: ldc 72
    //   123: invokevirtual 76	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   126: astore 4
    //   128: aload_1
    //   129: new 78	java/util/ArrayList
    //   132: dup
    //   133: invokespecial 79	java/util/ArrayList:<init>	()V
    //   136: putfield 82	bfpv:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   139: iconst_0
    //   140: istore_2
    //   141: iload_2
    //   142: aload 4
    //   144: invokevirtual 88	org/json/JSONArray:length	()I
    //   147: if_icmpge +216 -> 363
    //   150: aload 4
    //   152: iload_2
    //   153: invokevirtual 92	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   156: astore 5
    //   158: new 94	bfpw
    //   161: dup
    //   162: invokespecial 95	bfpw:<init>	()V
    //   165: astore 6
    //   167: aload 5
    //   169: ldc 97
    //   171: iconst_0
    //   172: invokevirtual 101	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   175: iconst_1
    ...
    //   181: aload 6
    //   183: iload_3
    //   184: putfield 103	bfpw:jdField_a_of_type_Boolean	Z
    //   187: aload 5
    //   189: ldc 105
    //   191: invokevirtual 68	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   194: astore 7
    //   196: aload 7
    //   198: invokestatic 28	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   201: ifne +27 -> 228
    //   204: aload 6
    //   206: new 46	java/lang/StringBuilder
    //   209: dup
    //   210: invokespecial 49	java/lang/StringBuilder:<init>	()V
    //   213: aload_0
    ...
    //   222: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   225: putfield 106	bfpw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   228: aload 5
    //   230: ldc 108
    //   232: invokevirtual 68	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   235: astore 7
    //   237: aload 7
    //   239: invokestatic 28	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifne +27 -> 269
    //   245: aload 6
    //   247: new 46	java/lang/StringBuilder
    //   250: dup
    //   251: invokespecial 49	java/lang/StringBuilder:<init>	()V
    //   254: aload_0
    //   255: invokevirtual 53	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   258: aload 7
    //   260: invokevirtual 53	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   263: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   266: putfield 110	bfpw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   269: aload 5
    //   271: ldc 112
    //   273: invokevirtual 68	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   276: astore 7
    //   278: aload 7
    //   280: invokestatic 28	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   283: ifne +27 -> 310
    //   286: aload 6
    //   288: new 46	java/lang/StringBuilder
    //   291: dup
    //   292: invokespecial 49	java/lang/StringBuilder:<init>	()V
    //   295: aload_0
    ...
    //   304: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   307: putfield 114	bfpw:c	Ljava/lang/String;
    //   310: aload 5
    //   312: ldc 116
    //   314: iconst_0
    //   315: invokevirtual 101	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   318: iconst_1
    ...
    //   324: aload 6
    //   326: iload_3
    //   327: putfield 118	bfpw:jdField_b_of_type_Boolean	Z
    //   330: aload_1
    //   331: getfield 82	bfpv:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   334: aload 6
    //   336: invokevirtual 122	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   339: pop
    //   340: iload_2
    //   341: iconst_1
    //   342: iadd
