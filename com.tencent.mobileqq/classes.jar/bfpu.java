...
public class bfpu
{
  ...
  public static final String d = alud.a(2131717427);
  ...
  {
    bflp.c(a, "---deleteYYBApkPackage--");
    ThreadManager.getSubThreadHandler().post(new YybHandleUtil.1());
  }
  
  public static boolean a()
  {
    String str = bfbm.a().a().getFilesDir().getAbsolutePath() + File.separator + c;
    return bfms.a(bfbm.a().a(), str);
  }
}
