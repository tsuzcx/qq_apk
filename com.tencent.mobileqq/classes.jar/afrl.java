...
public class afrl
  extends ailz
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afrm(this);
  public LinkedHashMap<String, List<afrk>> a;
  private boolean jdField_a_of_type_Boolean;
  public int[] a;
  public String[] a;
  
  public afrl(PublicAccountFragment paramPublicAccountFragment)
  {
  ...
  public afrl(PublicAccountFragment paramPublicAccountFragment, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
    super(paramContext, paramQQAppInterface, paramXListView, paramBoolean);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ArrayOfInt = new int[0];
    this.jdField_a_of_type_ArrayOfJavaLangString = new String[0];
    this.jdField_a_of_type_AndroidGraphicsBitmap = bbef.a(true);
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if ((ThemeUtil.isNowThemeDefaultCache) || (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
      paramView.setBackgroundResource(2130849142);
    }
    for (;;)
    {
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        afrk localafrk = (afrk)((Iterator)localObject2).next();
        if ((localafrk.jdField_a_of_type_JavaLangString == null) || (localafrk.jdField_a_of_type_JavaLangString.length() == 0))
        {
          localObject1 = "#";
        ...
        for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
        {
          ...
          ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localafrk);
          break;
          localObject1 = localafrk.jdField_a_of_type_JavaLangString.substring(0, 1);
          break label92;
        }
      }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (afrk)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363815));
      ...
      paramViewGroup.f = ((TextView)paramView.findViewById(2131378223));
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131372098);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363799));
    ...
    for (;;)
    {
      ...
      {
        i = -(i + 1) - 1;
        localObject = (afrk)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        paramViewGroup.jdField_a_of_type_Afrk = ((afrk)localObject);
        paramViewGroup.jdField_a_of_type_JavaLangString = String.valueOf(((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.uin);
        paramViewGroup.jdField_a_of_type_AndroidViewView.setVisibility(0);
        paramViewGroup.f.setVisibility(8);
        paramViewGroup.d.setVisibility(0);
        paramViewGroup.d.setText(((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
        if (((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.certifiedGrade > 0L)
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.getResources().getDrawable(2130841310);
          ...
          paramViewGroup.e.setText(((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary);
          ...
          if (((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.extendType != 2) {
            break label858;
          }
        }
      }
      for (boolean bool = naz.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), 1024);; bool = false)
      {
        if (bool)
        {
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-1, ((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-2, ((afrk)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
        ...
        {
          return paramView;
          paramViewGroup = (afrn)paramView.getTag();
          break;
          ...
          break label544;
          paramViewGroup.jdField_a_of_type_Afrk = null;
