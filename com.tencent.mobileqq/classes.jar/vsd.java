  ...
  extends vko
{
  ...
  public vsd(int paramInt1, String paramString, int paramInt2)
  {
    this.b = paramInt2;
  ...
  public vsd(int paramInt1, String paramString, int paramInt2, CommentLikeFeedItem paramCommentLikeFeedItem)
  {
