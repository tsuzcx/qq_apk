...
import com.tencent.biz.pubaccount.readinjoy.comment.ReadInJoyCommentUtils.2;
...
public class pbq
{
  public static Pair<Integer, Integer> a(ArticleInfo paramArticleInfo, CommonCommentData paramCommonCommentData)
  {
    ...
    for (;;)
    {
      ...
      {
        if (((paramArticleInfo.mFeedType == 1) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Int == 5)) || (pqw.a(paramArticleInfo)))
        {
          i = 2;
          continue;
        }
        if ((ReadInJoyDeliverBiuActivity.b(paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq != null))
        {
          if (ReadInJoyDeliverBiuActivity.a(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Int)) {
            i = 9;
          }
        }
  ...
  public static String a(ArticleInfo paramArticleInfo)
  {
    ...
    if (((ppe.g(paramArticleInfo)) || (ppe.i(paramArticleInfo))) && (paramArticleInfo.mSocialFeedInfo != null)) {
      return String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.jdField_a_of_type_Long);
    }
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, String paramString3, boolean paramBoolean2, pbs parampbs, int paramInt2)
  {
    qgx.a().a(paramActivity, 3, new pbr(paramActivity, paramArticleInfo, paramCommentInfo, paramInt1, paramString1, paramString2, paramBoolean1, paramString3, paramBoolean2, parampbs, paramInt2));
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData, int paramInt1, String paramString1, String paramString2, boolean paramBoolean, pbs parampbs, int paramInt2)
  {
    a(paramActivity, paramArticleInfo, paramBaseCommentData, paramInt1, paramString1, paramString2, paramBoolean, parampbs, paramInt2, true);
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, pbs parampbs, int paramInt2, boolean paramBoolean2)
  {
    ...
    if (paramBaseCommentData != null)
    {
      ...
      if ((paramBaseCommentData != null) && (paramBaseCommentData.mediaDataList != null) && (paramBaseCommentData.mediaDataList.size() > 0) && (((pdo)paramBaseCommentData.mediaDataList.get(0)).e != 0)) {
    ...
    for (paramInt2 = 0;; paramInt2 = 1)
    {
      ...
      if (paramInt1 == 2) {
        localIntent.putExtra("comment_is_show_pic", plk.a());
      }
  ...
  public static void a(ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArticleInfo = pvj.a().a((int)paramArticleInfo.mChannelID, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, int paramInt)
  {
    if (paramIntent == null)
    {
      QQToast.a(BaseApplication.getContext(), 1, BaseApplication.getContext().getString(2131717659), 0).a();
    ...
    {
      pdv.a(localArticleInfo, 0).d(paramQQAppInterface);
      pdv.a(localArticleInfo);
      return;
    }
    pvj.a().a(localArticleInfo, paramQQAppInterface);
  }
  ...
  public static void a(String paramString, Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    paramString = uvs.a(paramArticleInfo, pjj.g + bhcu.encodeToString(paramString.getBytes(), 2), uvs.g);
    pkh.a(paramContext, paramString);
    QLog.d("ReadInJoyCommentUtils", 1, "personal url =" + paramString);
  }
  
  public static void a(String paramString, ArticleInfo paramArticleInfo, pqg parampqg)
  {
    olh.a(null, a(paramArticleInfo), paramString, paramString, 0, 0, String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mStrategyId), paramArticleInfo.innerUniqueID, parampqg.a(), false);
  }
    ...
    if (paramContext.hasPrimaryClip())
    {
      ...
      if ((paramContext != null) && (paramContext.getItemCount() > 0))
      {
        ...
        if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.getText())))
        {
          ...
          paramString = new QQText(bcsc.b(paramString), 7, 18).toString();
  ...
  public static boolean a(ArticleInfo paramArticleInfo, String paramString)
  {
    ...
    localSocializeFeedsInfo.jdField_a_of_type_Rqw = new rqw();
    ...
    try
    {
      ...
      {
        localSocializeFeedsInfo.jdField_a_of_type_Rqw.b = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b;
        localSocializeFeedsInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaLangLong = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaLangLong;
      }
      ...
      if (i < paramString.length())
      {
        ...
        {
          localObject = new pbz((String)localObject, l, paramString.getJSONObject(i).optString("biu_info_comment"));
          ((pbz)localObject).jdField_a_of_type_Int = paramString.getJSONObject(i).optInt("biu_optype");
          ((pbz)localObject).jdField_a_of_type_JavaLangCharSequence = paramString.getJSONObject(i).optString("biu_nickname");
    ...
    while (((Iterator)localObject).hasNext()) {
      paramString.append(((pbz)((Iterator)localObject).next()).toString()).append("\n");
    }
    ...
    if ((paramArticleInfo != null) && (localArrayList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        {
          localObject = (pbz)localArrayList.get(i);
          SocializeFeedsInfo.BiuCommentInfo localBiuCommentInfo = new SocializeFeedsInfo.BiuCommentInfo();
          try
          {
            localBiuCommentInfo.mUin = Long.valueOf(((pbz)localObject).jdField_a_of_type_JavaLangString);
            if (((pbz)localObject).b == null)
            {
              paramString = "";
              localBiuCommentInfo.mBiuComment = paramString;
              localBiuCommentInfo.mOpType = ((pbz)localObject).jdField_a_of_type_Int;
              localBiuCommentInfo.mFeedId = Long.valueOf(((pbz)localObject).jdField_a_of_type_Long);
              localSocializeFeedsInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
              i += 1;
            }
          }
          catch (Exception paramString)
          {
            for (;;)
            {
              ...
              continue;
              paramString = ((pbz)localObject).b.toString();
            }
          }
        }
      }
      pvj.a().a(pkh.a(), paramArticleInfo.mFeedId, localSocializeFeedsInfo.jdField_a_of_type_Rqw, 0L, ((pbz)localArrayList.get(0)).b.toString(), paramArticleInfo.mArticleID, paramArticleInfo.mRecommendSeq, j, paramArticleInfo.innerUniqueID, k, paramArticleInfo);
    }
    return true;
  }
  
  public static void b(Activity paramActivity, ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, String paramString3, boolean paramBoolean2, pbs parampbs, int paramInt2)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("public_fragment_window_feature", 1);
    localIntent.putExtra("arg_comment_enable_anonymous", false);
