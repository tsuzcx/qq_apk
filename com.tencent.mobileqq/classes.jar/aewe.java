  ...
  implements Animator.AnimatorListener
{
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_Aexe = new aexe(paramContext);
    this.jdField_a_of_type_Aexe.a(new aewf(this));
  }
  ...
  public void a(aewt paramaewt)
  {
    ...
    this.jdField_a_of_type_JavaLangString = autp.c();
    ...
    if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new aewg(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), localFileInputStream, new aewh(this));
      super.a(paramaewt);
      paramaewt.a(bool);
      return;
    }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Aexe.b();
      this.jdField_a_of_type_Aexe.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Aexe != null) && (this.jdField_a_of_type_Aexe.a())) {
      this.jdField_a_of_type_Aexe.d();
    }
  }
