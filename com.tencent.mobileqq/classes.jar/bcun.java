...
public class bcun
  extends bcug
  implements arzx, bctv, IVideoOuterStatusListener
{
  private IVideoInnerStatusListener a;
  private ImageView b;
  
  bcun(Context paramContext)
  {
    super(paramContext);
  ...
  public void a(Context paramContext)
  {
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373155));
    this.b.setContentDescription(ajya.a(2131704643));
    a(new View[] { this.b });
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(2, new bcuo(this));
    }
  }
