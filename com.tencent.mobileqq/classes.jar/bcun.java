...
public class bcun
{
  ...
  public static HashMap<Integer, HashMap<Integer, bmwi>> a;
  ...
  public static List<Integer> a(Map<Integer, bmwi> paramMap)
  {
  ...
  public static Map<Integer, String> a(long paramLong)
  {
    ...
    Map localMap = bcup.a(LocalMultiProcConfig.getString("EXTEND_INFO" + paramLong, ""));
    if (a(paramLong)) {
  ...
  public static void a(mobile_count_rsp_new parammobile_count_rsp_new)
  {
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.vec_soft_infos != null) && (parammobile_count_rsp_new.vec_soft_infos.size() != 0))
    {
      ...
      LocalMultiProcConfig.putString("qzone_soft_infos", bhkv.encodeToString(localJceOutputStream.toByteArray(), 0));
    }
  }
  ...
  private static void a(mobile_count_rsp_new parammobile_count_rsp_new, bcvp parambcvp)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (parambcvp == null);
        if (parammobile_count_rsp_new.iNextTimeout > 0)
        {
          parambcvp.jdField_a_of_type_Long = (parammobile_count_rsp_new.iNextTimeout * 1000L);
          if (QLog.isColorLevel()) {
            QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getFeedInterval:" + parambcvp.jdField_a_of_type_Long);
          }
        }
      } while (parammobile_count_rsp_new.switchTimeout <= 0);
      parambcvp.jdField_b_of_type_Long = (parammobile_count_rsp_new.switchTimeout * 1000);
    } while (!QLog.isColorLevel());
    QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getActiveAppInterval:" + parambcvp.jdField_b_of_type_Long);
  }
  ...
  public static void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, QQAppInterface paramQQAppInterface, bcvp parambcvp)
  {
    ...
    do
    {
      ...
      {
        return;
        paramFromServiceMsg = bcuk.a(paramIntent, paramQQAppInterface, "getUndealCount");
    ...
    axft localaxft = (axft)paramQQAppInterface.getManager(10);
    if (localaxft != null) {
      localaxft.b(0);
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      long l = System.currentTimeMillis();
      HashMap localHashMap = new HashMap();
      bdmc.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", true, l - bcvp.c, 0L, localHashMap, "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, Long paramLong)
  {
    ...
    do
    {
      ...
      } while ((paramQQAppInterface == null) || (!(paramQQAppInterface instanceof bcvn)));
    ...
    {
      bmwi localbmwi = (bmwi)localHashMap.get(Integer.valueOf(1));
      localbmwi.jdField_a_of_type_Long = paramLong.longValue();
      localHashMap.put(Integer.valueOf(1), localbmwi);
    }
    ((bcvn)paramQQAppInterface).a(localHashMap);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, FromServiceMsg paramFromServiceMsg, bcvp parambcvp)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    if (parambcvp != null) {
      parambcvp.notifyObserver(null, 1000, false, new Bundle(), ayxo.class);
    }
    if (paramQQAppInterface != null)
    {
      ...
      bdmc.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bcvp.d - bcvp.c, 0L, paramFromServiceMsg, "");
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, bcvp parambcvp)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    ...
    if (paramQQAppInterface != null)
    {
      paramArrayOfByte = "|wufbuf: " + bhml.a(paramArrayOfByte);
      parambcvp = new HashMap();
      parambcvp.put("param_FailCode", String.valueOf(9045));
      parambcvp.put("param_errorDesc", paramArrayOfByte);
      bdmc.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bcvp.d - bcvp.c, 0L, parambcvp, "");
    }
  }
  
  public static void a(String paramString) {}
  
  private static void a(String paramString, bcvp parambcvp)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambcvp == null) {
      return;
    ...
    parambcvp.notifyObserver(null, 1003, true, localBundle, ayxo.class);
  }
  ...
  public static void a(String paramString, ArrayList<String> paramArrayList)
  {
    ...
    {
      paramArrayList = bhsr.a(paramArrayList, ",");
    ...
    if (paramArrayList != null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localoperat_data != null)
        {
          ...
          localbnkl.jdField_a_of_type_Int = localoperat_data.cmd;
          if ((localoperat_data.mapExt != null) && (localoperat_data.mapExt.size() > 0)) {
            localbnkl.jdField_a_of_type_JavaUtilMap.putAll(localoperat_data.mapExt);
          }
          localbnkl.jdField_a_of_type_JavaUtilMap.put("key_desc", localoperat_data.desc);
  ...
  private static void a(byte[] paramArrayOfByte, mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface, bcvp parambcvp)
  {
    HashMap localHashMap = new HashMap();
    boolean bool = a(parammobile_count_rsp_new, localHashMap, paramQQAppInterface);
    int i = 0;
    if (bool) {
      i = bngf.a().a().a(paramQQAppInterface.getLongAccountUin());
    }
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof bcvn)))
    {
      ((bcvn)paramArrayOfByte).a(localHashMap);
      if (QLog.isColorLevel()) {
    ...
    label129:
    a(paramQQAppInterface, paramArrayOfByte, parambcvp);
  }
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localbcuo.a())
      {
        ...
        if (localbcuo.jdField_a_of_type_Int <= 0) {
          break label53;
        }
        bool1 = bool2;
      }
  ...
  private static boolean a(long paramLong)
  {
    ...
    try
    {
      localObject = (stNuanNuanComment)b(stNuanNuanComment.class, bhkv.decode((String)localObject, 0));
  ...
  public static boolean a(mobile_count_rsp_new parammobile_count_rsp_new, HashMap<Integer, bmwi> paramHashMap, QQAppInterface paramQQAppInterface)
  {
    if (QLog.isDevelopLevel()) {
    ...
    if (localcount_info != null)
    {
      ...
      {
        localbmwi.jdField_a_of_type_Long = localcount_info.stCount.uCount;
        localbmwi.jdField_a_of_type_Int = localcount_info.stCount.iControl;
        if (QLog.isDevelopLevel())
        {
        ...
        if ((i == 1) && (localbmwi.jdField_a_of_type_Long > 0L) && (paramQQAppInterface != null) && (parammobile_count_rsp_new.isPreLoad == 1) && (!TextUtils.isEmpty(parammobile_count_rsp_new.undealCountTime)) && (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", paramQQAppInterface.getLongAccountUin()).equals(parammobile_count_rsp_new.undealCountTime)))
        {
          bool1 = true;
          label423:
          ...
          if (parammobile_count_rsp_new.mapTransData != null)
          {
            ...
            if (arrayOfByte != null) {
              localObject = (PassiveFeedsPush)bnjr.a(PassiveFeedsPush.class, arrayOfByte);
            }
          }
          if ((localcount_info.vecUinList != null) && (localcount_info.vecUinList.size() > 0))
          {
            ...
            while (j < localcount_info.vecUinList.size())
            {
              ...
              localbmwi.jdField_a_of_type_JavaUtilArrayList.add(localQZoneCountUserInfo);
              j += 1;
            }
            localbmwi.jdField_a_of_type_JavaLangString = ((feed_host_info)localcount_info.vecUinList.get(0)).actiondesc;
            if (QLog.isDevelopLevel()) {
          ...
          localbmwi.jdField_b_of_type_JavaLangString = localcount_info.trace_info;
          localbmwi.c = localcount_info.iSubCountID;
          localbmwi.f = localcount_info.strShowMsg;
          localbmwi.g = localcount_info.strReportValue;
          localbmwi.e = localcount_info.strIconUrl;
          localbmwi.jdField_b_of_type_Long = localcount_info.cTime;
          paramHashMap.put(Integer.valueOf(i), localbmwi);
        }
      }
    }
    for (;;)
  ...
  public static byte[] a(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Map<Integer, count_info> paramMap, String paramString2, Map<Long, Long> paramMap1)
  {
    ...
    return bcuk.a(paramString1, "getUndealCount", paramLong, paramInt1, paramInt2, paramInt4);
  }
  ...
  public static void b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (str != null)
      {
        ...
        bnkc.a();
        paramQQAppInterface = (axft)paramQQAppInterface.getManager(10);
        if ((paramInt & 0x80) == 0) {
          break label84;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((parammobile_count_rsp_new.snnComment != null) && (parammobile_count_rsp_new.snnComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_comment_info", bhkv.encodeToString(localJceOutputStream.toByteArray(), 0), paramLong);
        ...
        if ((parammobile_count_rsp_new.sContentOpComment != null) && (parammobile_count_rsp_new.sContentOpComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_operation_comment_info", bhkv.encodeToString(((JceOutputStream)localObject).toByteArray(), 0), paramLong);
          return;
        }
      }
  ...
  private static void d(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    bmup.a().a(parammobile_count_rsp_new.stYellowInfo.iYellowType, parammobile_count_rsp_new.stYellowInfo.iYellowLevel, parammobile_count_rsp_new.stYellowInfo.isAnnualVip, parammobile_count_rsp_new.stuStarInfo, parammobile_count_rsp_new.stuCombineDiamondInfo);
  }
  ...
  private static void i(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.length > 0))
    {
      ...
      bnjr.a((JceStruct)localObject, parammobile_count_rsp_new);
