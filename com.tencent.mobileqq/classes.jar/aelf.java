...
public class aelf
  extends MqqHandler
{
  public aelf(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
    ...
    do
    {
      do
      {
        ...
        else
        {
          ...
          DiscussionInfoCardActivity.a(this.a).setText(anzj.a(2131702240) + i + anzj.a(2131702241));
          ...
          DiscussionInfoCardActivity.a(this.a, new aelg(this.a));
        ...
        for (;;)
        {
          removeMessages(0);
          return;
          this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetFollowImageTextView.setText(this.a.getString(2131693885));
          if (!AppSetting.c) {
            break;
          }
          this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetFollowImageTextView.setContentDescription(anzj.a(2131702246) + this.a.getString(2131693885) + anzj.a(2131702238));
          break;
