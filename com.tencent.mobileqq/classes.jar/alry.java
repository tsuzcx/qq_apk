...
public class alry
{
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new DataInputStream(new ByteArrayInputStream(bdbi.decode((String)localObject, 0)));
  ...
  public void c()
  {
    try
    {
      ...
      BaseApplicationImpl.getApplication().getSharedPreferences("MemoryManagerMemoryStat", 0).edit().putString("LowMemoryStat", bdbi.encodeToString((byte[])localObject, 0)).commit();
      return;
    }
    catch (Exception localException) {}
  }
