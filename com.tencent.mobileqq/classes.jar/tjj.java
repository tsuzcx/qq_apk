  ...
  extends tjd<WSRedDotPushMsg, WSPushStrategyInfo>
{
  ...
  public tjj(WSRedDotPushMsg paramWSRedDotPushMsg, int paramInt, Intent paramIntent)
  {
  ...
  public boolean a(Context paramContext, WSPushStrategyInfo paramWSPushStrategyInfo)
  {
    ...
    if (!TextUtils.isEmpty(paramWSPushStrategyInfo.mScheme))
    {
      ...
      if (bool3)
      {
        tgx.a().a(new WSWeSeeClientBiz.1(this, paramContext, paramWSPushStrategyInfo), 200L);
        bool2 = true;
      }
    }
    return bool2;
