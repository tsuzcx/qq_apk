  ...
  extends ajtd
{
      ...
      if (paramFromServiceMsg.item.has())
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (((oidb_cmd0xc76.Item)localObject4).id.has()) {
            localakwz.a(((oidb_cmd0xc76.Item)localObject4).id.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).icon.has()) {
            localakwz.b(((oidb_cmd0xc76.Item)localObject4).icon.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).type.has()) {
            localakwz.a(((oidb_cmd0xc76.Item)localObject4).type.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).name.has()) {
            localakwz.a(((oidb_cmd0xc76.Item)localObject4).name.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).value.has()) {
            localakwz.b(((oidb_cmd0xc76.Item)localObject4).value.get());
          }
          ((List)localObject1).add(localakwz.a());
        }
      }
      ((akxa)localObject2).jdField_a_of_type_JavaUtilList = ((List)localObject1);
      if (paramFromServiceMsg.desc.has()) {
        ((akxa)localObject2).jdField_a_of_type_JavaLangString = paramFromServiceMsg.desc.get();
      }
    ...
    if (paramRspBody.apps.has())
    {
      ...
      if (paramRspBody.item.has())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          localObject4 = new akwz();
          if (((oidb_cmd0xc76.Item)localObject3).id.has()) {
            ((akwz)localObject4).a(((oidb_cmd0xc76.Item)localObject3).id.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).icon.has()) {
            ((akwz)localObject4).b(((oidb_cmd0xc76.Item)localObject3).icon.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).type.has()) {
            ((akwz)localObject4).a(((oidb_cmd0xc76.Item)localObject3).type.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).name.has()) {
            ((akwz)localObject4).a(((oidb_cmd0xc76.Item)localObject3).name.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).value.has()) {
            ((akwz)localObject4).b(((oidb_cmd0xc76.Item)localObject3).value.get());
          }
          paramFromServiceMsg.add(((akwz)localObject4).a());
        }
      }
      ((akxa)localObject1).jdField_a_of_type_JavaUtilList = paramFromServiceMsg;
      if (paramRspBody.desc.has()) {
        ((akxa)localObject1).jdField_a_of_type_JavaLangString = paramRspBody.desc.get();
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   193: istore 4
    //   195: aload_0
    //   196: getfield 444	akwq:mApp	Lcom/tencent/common/app/AppInterface;
    //   199: sipush 315
    //   202: invokevirtual 450	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   205: checkcast 452	ahjz
    //   208: aload_1
    //   209: iload 4
    //   211: invokevirtual 455	ahjz:a	(Ljava/lang/String;I)V
    //   214: aload_2
    ...
    //   495: iconst_1
    //   496: aload_2
    //   497: invokevirtual 355	akwq:notifyUI	(IZLjava/lang/Object;)V
    //   500: aload_0
    //   501: iconst_1
    //   502: iconst_0
    //   503: aconst_null
    //   504: invokevirtual 355	akwq:notifyUI	(IZLjava/lang/Object;)V
    //   507: return
    //   508: aload_0
    //   509: iconst_1
    //   510: iconst_0
    //   511: aconst_null
    //   512: invokevirtual 355	akwq:notifyUI	(IZLjava/lang/Object;)V
    //   515: return
    //   516: aconst_null
    //   517: astore_1
    //   518: goto -261 -> 257
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    akwz localakwz = new akwz();
    localakwz.a(paramString2);
    localakwz.a(paramString1);
    localakwz.b(paramInt);
    localArrayList.add(localakwz.a());
