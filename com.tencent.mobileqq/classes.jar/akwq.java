  ...
  implements ajte
{
  ...
  protected void onGetAppletsSettingSwitch(boolean paramBoolean, List<akwz> paramList)
  {
    ...
    for (localObject1 = (ahjx)((QQAppInterface)localObject1).getManager(315);; localObject1 = null)
    {
      ...
      if ((paramList != null) && (paramBoolean) && (paramList.size() > 0))
      {
        ...
        {
          Object localObject2 = (akwz)paramList.next();
          if ((((akwz)localObject2).a != null) && (((akwz)localObject2).a.size() > 0) && (((akwz)localObject2).a.get(0) != null) && (((AppletItem)((akwz)localObject2).a.get(0)).a() == 1L))
          {
            localObject2 = (AppletItem)((akwz)localObject2).a.get(0);
            if (((AppletItem)localObject2).b() == 1) {}
            for (paramBoolean = true;; paramBoolean = false)
            {
              ((ahjx)localObject1).a(paramBoolean);
              onAppletsSettingSwitchChange(((AppletItem)localObject2).b());
              break;
            }
          }
          if ((((akwz)localObject2).a != null) && (((akwz)localObject2).a.size() > 0))
          {
            localObject2 = ((akwz)localObject2).a.iterator();
      ...
      ((ahjx)localObject1).a(localHashSet);
      return;
    }
  }
  ...
  protected void onSetAppletsSettingSwitch(boolean paramBoolean, List<AppletItem> paramList)
  {
    ...
    if ((localObject instanceof QQAppInterface)) {
      localahjx = (ahjx)((QQAppInterface)localObject).getManager(315);
    }
    if (localahjx == null) {}
    for (;;)
    {
      ...
      if ((paramList != null) && (paramBoolean))
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if (localahjx != null) {
            if (i == 0) {
              localahjx.c(String.valueOf(((AppletItem)localObject).a()));
            } else {
              localahjx.d(String.valueOf(((AppletItem)localObject).a()));
            }
          }
        }
      }
