...
public class tjc
  extends tiy
{
  public tjc(ViewGroup paramViewGroup, int paramInt)
  {
  ...
  protected void a(ShareGroupItem paramShareGroupItem)
  {
    ...
    {
      str = ajyc.a(2131713930);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(str);
      localObject = (ukv)tdc.a(24);
      i = this.jdField_a_of_type_AndroidWidgetImageView.getContext().getResources().getDimensionPixelSize(2131298327);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(((ukv)localObject).a());
    }
    label116:
    do
    {
      ...
      break label91;
      localObject = ((ukv)localObject).a(paramShareGroupItem.headerUnionIdList, str);
  ...
  public void a(tfi paramtfi)
  {
    ...
    ShareGroupItem localShareGroupItem = ((umy)tdc.a(7)).a(paramtfi.a);
    a(localShareGroupItem);
    if (localShareGroupItem == null) {
      new tjw(paramtfi.a, String.valueOf(System.currentTimeMillis())).a();
    }
    if (QLog.isColorLevel()) {
      QLog.e("zivonchen", 2, "ShareGroupViewHolder groupItem = " + localShareGroupItem + ", unionId = " + paramtfi.a);
    }
  }
}
