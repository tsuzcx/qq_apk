  ...
  extends LinearLayout
{
  ...
  public tjc(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while ((i != k) || (j != m))
      {
        ...
        ((ValueAnimator)localObject).addUpdateListener(new tjd(this, i, k, j, m));
        ((ValueAnimator)localObject).addListener(new tje(this, paramInt1));
