...
public class aqiv
{
  private static aqiv jdField_a_of_type_Aqiv;
  private ConcurrentLinkedQueue<String> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  
  public static aqiv a()
  {
    try
    {
      if (jdField_a_of_type_Aqiv == null) {
        jdField_a_of_type_Aqiv = new aqiv();
      }
      aqiv localaqiv = jdField_a_of_type_Aqiv;
      return localaqiv;
    }
    finally {}
  }
  
  public static void a(String paramString1, mxu parammxu, String paramString2)
  {
    aqja.b(paramString1, paramString2);
    if (parammxu != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ImaxAdvertisement", 2, "doDeleteItem bingo clearDistInfo  uin:" + paramString2);
      }
      paramString1 = parammxu.a.iterator();
      while (paramString1.hasNext()) {
        aqjb.b(((mxv)paramString1.next()).b);
      }
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (localObject = null;; localObject = ((ProxyManager)localObject).a())
    {
      if (localObject != null)
      {
        RecentUser localRecentUser = ((akeu)localObject).a(paramString, 10005);
        if (localRecentUser != null)
        {
          ...
          ahcq.b(paramQQAppInterface, paramString, 10005);
          paramQQAppInterface.a().c(paramString, 10005);
        }
      }
      localObject = aqiy.a().a(paramString);
      if (Looper.myLooper() != Looper.getMainLooper()) {
        break;
      }
      ThreadManager.executeOnFileThread(new ImaxAdDeleteManager.1(this, (mxu)localObject, paramQQAppInterface, paramString));
      return;
    }
    a(paramQQAppInterface.c(), (mxu)localObject, paramString);
  }
  ...
  {
    if (b(paramString2)) {}
    while (!TextUtils.isEmpty(aqja.a(paramString1, "delete_st_" + paramString2))) {
      return true;
    }
    return false;
  }
  ...
  public void c(String paramString)
  {
    ...
    {
      String str = (String)localIterator.next();
      long l = Long.valueOf(aqja.a(paramString, "delete_st_" + str)).longValue();
      if (NetConnInfoCenter.getServerTimeMillis() - l > 86400000L)
      {
        a(str);
        aqja.a(paramString, "delete_st_" + str);
      }
    }
    aqja.a(paramString, "delete_uin_list", a());
  }
}
