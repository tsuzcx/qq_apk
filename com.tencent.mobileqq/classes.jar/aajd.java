...
public class aajd
{
  private static aajd jdField_a_of_type_Aajd;
  public static final String a;
  private Map<String, String> jdField_a_of_type_JavaUtilMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = aajd.class.getSimpleName();
  }
  
  public static aajd a()
  {
    if (jdField_a_of_type_Aajd == null) {}
    try
    {
      if (jdField_a_of_type_Aajd == null) {
        jdField_a_of_type_Aajd = new aajd();
      }
      return jdField_a_of_type_Aajd;
    }
    finally {}
  }
