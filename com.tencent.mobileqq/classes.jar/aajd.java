...
public class aajd
{
  ...
  public aajd(aaje paramaaje, aajc paramaajc)
  {
    aanp.a("GdtAdBoxPresenter", "GdtAdBoxPresenter() called with: view = [" + paramaaje + "], model = [" + paramaajc + "]");
    this.jdField_a_of_type_Aaje = paramaaje;
  ...
  public void a()
  {
    aanp.a("GdtAdBoxPresenter", "onCreate() called");
    this.jdField_a_of_type_Aaje.b(this.jdField_a_of_type_Aajc);
  }
  ...
  public void a(Activity paramActivity, View paramView, GdtAdBoxData paramGdtAdBoxData)
  {
    ...
    paramActivity = paramView.getTag(2131367066);
    if (paramActivity == null)
    {
      aanp.d("GdtAdBoxPresenter", "onClick() tag == null");
      return;
    }
    paramActivity = (GdtAd)paramActivity;
    aanp.a("GdtAdBoxPresenter", "onClick() open url = [" + paramActivity.info.dest_info.landing_page.get() + "]");
  ...
  public void b()
  {
    aanp.a("GdtAdBoxPresenter", "onResume() called");
  }
