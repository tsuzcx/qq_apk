  ...
  extends sys
{
  ...
  public tmu()
  {
    this.jdField_c_of_type_JavaLangString = sxm.a("StoryGroupSvc.datacard_get_feeds_new");
  ...
  public syn a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new tok(this.a, localRspGroupDateVideoList);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ved.b("Q.qqstory.shareGroup:GetShareGroupDateListRequest", a(), paramArrayOfByte);
    }
    return null;
  }
