  ...
  implements View.OnClickListener
{
  ...
  private rhh(ComponentContentRecommendFollowGroup paramComponentContentRecommendFollowGroup) {}
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131367098: 
      i = 0;
      label50:
      if (i < this.jdField_a_of_type_Rpg.a.size()) {
        if (((RecommendFollowInfo)this.jdField_a_of_type_Rpg.a.get(i)).isFollowed) {
          break;
        }
      }
      break;
    ...
    for (int i = 0;; i = 1)
    {
      ...
      List localList = this.jdField_a_of_type_Rpg.a;
      if (i == 0) {}
      for (;;)
      {
