...
public class avfb
  extends QIPCModule
{
  private static volatile avfb jdField_a_of_type_Avfb;
  ...
  private bdwv jdField_a_of_type_Bdwv;
  ...
  private avfb(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Avfb == null) {}
    try
    {
      if (jdField_a_of_type_Avfb == null) {
        jdField_a_of_type_Avfb = new avfb("IdentificationIpcServer_Model");
      }
      return jdField_a_of_type_Avfb;
    }
    finally {}
  }
  ...
  {
    return new avfe(this, paramFile, paramEIPCResult, paramQQAppInterface, paramInt2, paramInt3, paramInt1);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    bcst.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80097EB", "0X80097EB", 0, 0, i + "", "" + k, j + "", "");
  ...
  private void a(Bundle paramBundle, int paramInt)
  {
    ...
    avod.a(paramBundle, str3, str4, i, AppSetting.a(), str2, str1, l, new avfd(this, localFaceDetectForThirdPartyManager, paramInt, paramBundle));
  }
  
  private void a(QQAppInterface paramQQAppInterface)
  {
    bnpu localbnpu = bnpu.a();
    avfg localavfg = new avfg(this);
    if (paramQQAppInterface.isLogin())
    {
      localbnpu.a(bnpt.b, localavfg, false);
      return;
    }
    localbnpu.a(bnpt.b, localavfg);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    avep.a().a(paramQQAppInterface, BaseApplicationImpl.getContext(), i, str, paramBundle, new avfc(this, paramInt));
  }
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    paramString2 = new avff(this, paramString2, paramString3, paramString1, paramInt);
    if (this.jdField_a_of_type_Bdwv == null)
    {
      paramQQAppInterface = new bgut(paramQQAppInterface, 4);
      paramQQAppInterface.a();
      this.jdField_a_of_type_Bdwv = new bdwv(paramQQAppInterface, false);
    }
    paramQQAppInterface = new bdvs();
    paramQQAppInterface.jdField_a_of_type_Bdvw = paramString2;
    ...
    this.jdField_a_of_type_Bdwv.a(paramQQAppInterface);
  }
      ...
      if (((List)localObject2).size() > 0)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (((ShortVideoResourceManager.SVConfigItem)localObject1).name.startsWith("new_qq_android_native_short_new_other_"))
          {
            ...
            QLog.d("qqidentification_server", 1, new Object[] { "no res,start download, localpath is", localObject2, " version is : ", Integer.valueOf(i), " app so bits is : ", Integer.valueOf(avez.b()) });
