...
public class bcrw
{
  public static final Comparator<? super adbr> a = new bcrx();
  
  public static int a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    return ((adbw)paramQQAppInterface.a().a().a().a(Integer.valueOf(paramInt))).a();
  }
  ...
  public static int a(im_msg_body.RichText paramRichText, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((str.charAt(k) == '\024') && (k + 1 < str.length()))
      {
        ...
        arrayOfInt = asfa.a((char[])localObject2);
      ...
      for (paramString = paramString.getSharedPreferences("Last_Login", j).getString("uin", "");; paramString = null) {
        for (;;)
        {
          try
          {
            ...
            paramString = (axfj)paramString.getManager(14);
            if (paramString == null) {
              break label1113;
            }
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, bfoy parambfoy)
  {
    ...
    paramList = (MessageForMixedMsg)bcry.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((parambfoy != null) && (parambfoy.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = parambfoy.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      bgme.a(parambfoy.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
    if (paramArrayOfByte != null) {
      paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bhml.a(paramArrayOfByte));
    }
    paramList.parse();
    return paramList;
  }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + bcsa.a.length);
        }
        j = i;
        if (asle.c(k))
        {
  ...
  private static List<adbr> a(List<im_msg_body.Elem> paramList, QQMessageFacade paramQQMessageFacade)
  {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, bcsd parambcsd, long paramLong, int paramInt2)
  {
    if (parambcsd == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | parambcsd.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + parambcsd);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(parambcsd.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(parambcsd.jdField_a_of_type_Int);
        paramString = paramString.replace("+", "");
        ((msg_svc.Trans0x211)localObject).to_uin.set(mrs.a(paramString));
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(parambcsd.jdField_a_of_type_ArrayOfByte));
      ...
      parambcsd = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (parambcsd == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(parambcsd));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = bcsa.a(l);
      localbcrg = paramQQAppInterface.a();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramQQAppInterface = localbcrg.a();
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = bdqf.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131693252);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131693253), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = anzj.a(2131705541);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = bhml.a(apdm.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((bdom)localObject2).a;
              if (localObject2 != null)
              {
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)apdm.a(bhml.a((String)localObject4));
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bfoy parambfoy)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, parambfoy, null, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bfoy parambfoy, bcsc parambcsc, bcre parambcre)
  {
    ...
    do
    {
      ...
      a(localList, paramMsg, paramList, (StringBuilder)localObject1, paramMessageHandler.app.a(), paramBoolean2, paramBoolean1, parambfoy, (List)localObject2, parambcsc, parambcre);
    } while (!QLog.isColorLevel());
  ...
  private static void a(List<adbr> paramList1, List<adbr> paramList2)
  {
    paramList2 = paramList2.iterator();
    while (paramList2.hasNext())
    {
      adbr localadbr = (adbr)paramList2.next();
      if (localadbr != null) {
        localadbr.a(paramList1);
      }
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, List<adbr> paramList1, List<adbr> paramList2)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      while (localIterator.hasNext())
      {
        adbr localadbr = (adbr)localIterator.next();
        if ((localadbr != null) && (localadbr.a(localElem))) {
          paramList1.add(localadbr);
        }
      }
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, bfoy parambfoy)
  {
    bcrt localbcrt = new bcrt();
    if (paramList1.isEmpty()) {
      localbcrt.f(paramList, paramList1, paramStringBuilder, paramMsg, parambfoy);
    }
    if (paramList1.isEmpty()) {
      localbcrt.i(paramList, paramList1, paramStringBuilder, paramMsg, parambfoy);
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, QQMessageFacade paramQQMessageFacade, boolean paramBoolean1, boolean paramBoolean2, bfoy parambfoy, List<adbr> paramList2, bcsc parambcsc, bcre parambcre)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localadbr = (adbr)paramQQMessageFacade.next();
      } while (localadbr == null);
      bool = localadbr.a(paramList, paramMsg, paramList1, paramStringBuilder, paramBoolean1, paramBoolean2, parambfoy, parambcsc, parambcre);
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "dispatchDecodePBMsgElements() decoder = [" + localadbr + "], handled = [" + bool + "]");
      }
    } while (!bool);
    a(paramList, paramMsg, paramList1, paramStringBuilder, parambfoy);
    b(paramList2);
    paramQQMessageFacade = paramList2.iterator();
    while (paramQQMessageFacade.hasNext())
    {
      paramList2 = (adbr)paramQQMessageFacade.next();
      if (paramList2 != null)
      {
        bool = paramList2.a(paramList, paramMsg, paramList1, paramStringBuilder, paramBoolean1, paramBoolean2, parambfoy, parambcsc, parambcre);
        if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    int i = b(paramMessageRecord.istroop, paramQQAppInterface);
    return ((adbw)paramQQAppInterface.a().a().a().a(Integer.valueOf(i))).a(paramRoutingHead, paramMessageRecord, paramQQAppInterface);
  }
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(anzj.a(2131705544)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = bdqf.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131693253), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(bhjx.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(bhjx.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(bhjx.a(localApolloMessage.peer_ts));
    ...
    localObject1 = anzj.a(2131705545);
  ...
  private static void b(List<adbr> paramList)
  {
    int i = paramList.size() - 1;
    while (i >= 0)
    {
      if (((adbr)paramList.get(i)).a() > -1000) {
        paramList.remove(i);
      }
      i -= 1;
    }
  ...
  private static void b(List<adbr> paramList1, List<adbr> paramList2)
  {
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = bdqf.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(bcsa.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = bdqf.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = anzj.a(2131705543);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = anzj.a(2131705548);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(anzj.a(2131705540)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
