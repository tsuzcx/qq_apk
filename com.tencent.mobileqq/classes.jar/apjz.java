...
public class apjz
{
  ...
  public static byte a(String arg0)
  {
    // Byte code:
    //   0: iconst_1
    //   1: putstatic 22	apjz:jdField_a_of_type_Boolean	Z
    //   4: new 24	java/io/File
    //   7: dup
    //   8: invokestatic 27	apjz:b	()Ljava/lang/String;
    ...
    //   21: ifeq +40 -> 61
    //   24: aload 4
    //   26: invokestatic 39	auog:a	(Ljava/io/File;)Z
    //   29: istore_3
    //   30: invokestatic 44	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   33: ifeq +28 -> 61
    //   36: ldc 46
    //   38: iconst_2
    ...
    //   51: iload_3
    //   52: invokevirtual 58	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   55: invokevirtual 61	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   58: invokestatic 65	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   61: aload_0
    //   62: invokestatic 67	apjz:a	()Ljava/lang/String;
    //   65: invokestatic 70	apjz:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   68: new 72	java/util/HashMap
    //   71: dup
    //   72: invokespecial 73	java/util/HashMap:<init>	()V
    //   75: astore 6
    //   77: getstatic 79	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   80: ldc 81
    //   82: iconst_0
    //   83: invokevirtual 85	com/tencent/common/app/BaseApplicationImpl:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   86: invokeinterface 91 1 0
    //   91: astore 5
    ...
    //   104: invokestatic 67	apjz:a	()Ljava/lang/String;
    ...
    //   132: astore_0
    //   133: aload 4
    //   135: invokestatic 98	bhmi:b	(Ljava/io/File;)Ljava/lang/String;
    //   138: astore 4
    //   140: aload 4
    //   142: astore_0
    //   143: aload_0
    ...
    //   147: aload_0
    //   148: aload 6
    //   150: invokestatic 101	apjz:a	(Ljava/lang/String;Ljava/util/HashMap;)Z
    //   153: ifeq +267 -> 420
    //   156: getstatic 16	apjz:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   159: astore_0
    //   160: aload_0
    //   161: monitorenter
    //   162: aload 6
    //   164: invokevirtual 105	java/util/HashMap:entrySet	()Ljava/util/Set;
    ...
    //   249: ifeq +166 -> 415
    //   252: aload 8
    //   254: invokestatic 136	azul:a	(Ljava/lang/String;)Ljava/lang/String;
    //   257: astore 8
    //   259: aload 6
    //   261: invokeinterface 139 1 0
    //   266: checkcast 131	java/lang/String
    //   269: aload 8
    //   271: invokevirtual 143	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   274: ifne +85 -> 359
    //   277: aload 7
    //   279: invokevirtual 146	java/io/File:delete	()Z
    //   282: pop
    //   283: iconst_2
    //   284: istore_1
    //   285: aload 5
    //   287: invokeinterface 151 1 0
    //   292: pop
    //   293: aload_0
    //   294: monitorexit
    //   295: iconst_0
    //   296: putstatic 22	apjz:jdField_a_of_type_Boolean	Z
    //   299: iload_1
    //   300: ireturn
    //   301: astore_0
    //   302: iconst_0
    //   303: putstatic 22	apjz:jdField_a_of_type_Boolean	Z
    //   306: invokestatic 44	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   309: ifeq +31 -> 340
    //   312: ldc 46
    //   314: iconst_2
    //   315: new 48	java/lang/StringBuilder
    //   318: dup
    //   319: invokespecial 49	java/lang/StringBuilder:<init>	()V
    //   322: ldc 153
    //   324: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   327: aload_0
    //   328: invokevirtual 156	java/io/IOException:getMessage	()Ljava/lang/String;
    //   331: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   334: invokevirtual 61	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   337: invokestatic 65	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   340: invokestatic 67	apjz:a	()Ljava/lang/String;
    //   343: iconst_0
    //   344: invokestatic 159	bhmi:a	(Ljava/lang/String;Z)V
    //   347: iconst_m1
    //   348: ireturn
    //   349: astore 4
    //   351: aload 4
    //   353: invokevirtual 162	java/io/IOException:printStackTrace	()V
    //   356: goto -213 -> 143
    //   359: aload 5
    //   361: new 48	java/lang/StringBuilder
    //   364: dup
    //   365: invokespecial 49	java/lang/StringBuilder:<init>	()V
    //   368: ldc 164
    //   370: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   373: aload 6
    //   375: invokeinterface 129 1 0
    //   380: checkcast 131	java/lang/String
    ...
    //   389: aload 6
    //   391: invokeinterface 139 1 0
    //   396: checkcast 131	java/lang/String
    //   399: invokeinterface 168 3 0
    //   404: pop
    //   405: goto -231 -> 174
    //   408: astore 4
    //   410: aload_0
    ...
    //   422: iload_2
    //   423: istore_1
    //   424: invokestatic 44	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   427: ifeq -132 -> 295
    //   430: ldc 46
    //   432: iconst_2
    //   433: ldc 170
    //   435: invokestatic 65	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   438: iload_2
    //   439: istore_1
    //   440: goto -145 -> 295
    //   443: invokestatic 44	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   446: ifeq +11 -> 457
    //   449: ldc 46
    //   451: iconst_2
    //   452: ldc 172
    //   454: invokestatic 65	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   457: iconst_0
    //   458: istore_1
    //   459: goto -164 -> 295
    //   462: iconst_0
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    //   112: getstatic 126	java/io/File:separator	Ljava/lang/String;
    ...
    //   155: goto +346 -> 501
    //   158: aload_0
    //   159: getstatic 126	java/io/File:separator	Ljava/lang/String;
    ...
    //   262: ifeq +9 -> 271
    //   265: aload 8
    //   267: invokevirtual 146	java/io/File:delete	()Z
    //   270: pop
    ...
    //   369: aload 8
    //   371: aload 9
    //   373: invokestatic 291	bhmi:b	(Ljava/io/File;Ljava/io/File;)Z
    //   376: ifne +125 -> 501
    //   379: aload 8
    //   381: aload 9
    //   383: invokestatic 293	bhmi:a	(Ljava/io/File;Ljava/io/File;)Z
    //   386: pop
    //   387: goto +114 -> 501
    //   390: astore_0
    //   391: aconst_null
    ...
    //   431: astore_0
    //   432: aload_0
    //   433: invokevirtual 162	java/io/IOException:printStackTrace	()V
    //   436: goto -28 -> 408
    //   439: astore_0
    //   440: aload_0
    //   441: invokevirtual 162	java/io/IOException:printStackTrace	()V
    //   444: goto -24 -> 420
    //   447: astore_0
    //   448: aload_0
    //   449: invokevirtual 162	java/io/IOException:printStackTrace	()V
    //   452: return
    //   453: astore_3
    //   454: aload_3
    //   455: invokevirtual 162	java/io/IOException:printStackTrace	()V
    //   458: goto -122 -> 336
    //   461: astore_1
    //   462: aload_1
    //   463: invokevirtual 162	java/io/IOException:printStackTrace	()V
    //   466: goto -122 -> 344
    //   469: astore_1
    //   470: aload_1
