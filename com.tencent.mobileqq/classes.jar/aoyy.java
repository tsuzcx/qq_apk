...
{
  private List<aoyz> a = new ArrayList();
  ...
  public void a(aoyz paramaoyz)
  {
    ...
    //   3: ifnull +18 -> 21
    //   6: aload_0
    //   7: getfield 18	aoyy:a	Ljava/util/List;
    //   10: aload_1
    ...
    //   23: return
    //   24: aload_0
    //   25: getfield 18	aoyy:a	Ljava/util/List;
    //   28: aload_1
  ...
  public void b(aoyz paramaoyz)
  {
    if ((paramaoyz == null) || (!this.a.contains(paramaoyz))) {
      return;
    }
    this.a.remove(paramaoyz);
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody) == 0)
    {
      ...
      {
        aoyz localaoyz = (aoyz)paramObject.next();
        if (localaoyz != null) {
          localaoyz.a(paramToServiceMsg, paramFromServiceMsg, localRspBody);
        }
      }
    }
  }
