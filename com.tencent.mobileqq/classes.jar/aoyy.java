  ...
  extends aouj
{
  ...
  protected void b(boolean paramBoolean, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, long paramLong, Bundle paramBundle)
  {
    ...
    aoyz localaoyz = aoyx.a(this.a, paramLong, false);
    if (localaoyz == null)
    {
    ...
    if (!paramBoolean)
    {
      this.a.a.a().a(false, 50, new Object[] { localaoyz.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity });
      this.a.a(paramLong);
      this.a.a(paramLong, false, null, 0, null, null, paramString2, false, null, (short)0, null);
      return;
    }
    ...
    paramString5 = "/ftn_video_pic/rkey=" + paramString3 + "&filetype=" + localaoyz.b + "&size=" + this.a.a(localaoyz.jdField_a_of_type_Int) + "&";
    paramBoolean = false;
    short s1 = 0;
