  ...
  implements Handler.Callback
{
  ...
  public aljh(aljj paramaljj, aljk paramaljk)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Aljj = paramaljj;
    this.jdField_a_of_type_Aljk = paramaljk;
  }
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > 0))
        {
          ...
          new alji(this, 0).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
        }
      }
      return;
    }
  ...
  public void a(int paramInt, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Aljj.a(this, paramString1, this.jdField_b_of_type_JavaLangString, paramString2);
      return;
    }
    this.jdField_a_of_type_Int = 2;
  }
  ...
  public void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (paramBitmap != null) && (!paramBitmap.isRecycled()))
    {
      ...
      this.jdField_a_of_type_Bhow.obtainMessage(255, this.jdField_c_of_type_Int, 0).sendToTarget();
    }
    for (;;)
    {
      ...
      return;
      label77:
      paramBitmap = this.jdField_a_of_type_Bhow.obtainMessage(255, this.jdField_c_of_type_Int, 0);
      this.jdField_a_of_type_Bhow.sendMessageDelayed(paramBitmap, this.jdField_b_of_type_Int - l2);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    this.jdField_a_of_type_Aljk.a(paramMessage.arg1, this.jdField_a_of_type_AndroidGraphicsBitmap);
    ...
    if ((this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > this.jdField_c_of_type_Int)) {
      new alji(this, this.jdField_c_of_type_Int).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
    }
    for (;;)
    {
