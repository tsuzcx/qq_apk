  ...
  implements afeq
{
  ...
  public afii(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyObserver = new afik(this);
  }
  ...
  protected void a(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      if (paramObject.a != bdyn.a) {
        break label73;
      }
      refreshHeadMessage(paramObject.c, paramObject.a(), paramObject.d, null);
    }
    label73:
    while ((paramObject.a != bdyn.b) || (this.speakerPhoneLayout == null)) {
      return;
    }
  ...
  {
    if (((bfbz)this.app.getManager(48)).a(this.sessionInfo.curFriendUin, true).a) {}
    do
    {
      return;
    ...
    if (this.sessionInfo.debugFilterMemberMsgCommand)
    {
      ...
      this.dirty = 131077;
      refresh(this.dirty);
      this.mFunBtn.setText(amtj.a(2131700210));
  ...
  public void c()
  {
    ...
    this.mTitleBtnRight.setContentDescription(this.mActivity.getString(2131719183));
    if (QLog.isColorLevel()) {
  ...
  public void doOnCreate_initUI()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new afij(this);
  ...
  public void doOnStop()
  {
    if (!this.hasDestory)
    {
      Object localObject = (bese)this.app.getManager(363);
      if (localObject != null)
      {
        ((bese)localObject).a(this.sessionInfo.curFriendUin, 0);
        if (this.mTroopTips != null)
        {
  ...
  public void doUpdateUnreadBubble(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7)
  {
    ...
    if ((localaftn != null) && (localafsn != null) && (localafsn.b()) && (localaftn.a())) {
  ...
  void e()
  {
    ...
    Object localObject = (bfdz)this.app.getManager(81);
    if (localObject == null) {
      if (QLog.isColorLevel()) {
        QLog.d(this.tag, 2, "troopTipsMsgMgr == null");
      }
    }
    while ((this.sessionInfo.curType != 1) || (!((bfdz)localObject).a(this.sessionInfo.curFriendUin))) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d(this.tag, 2, "troopAIO has unread troopTipMsg");
    }
    localObject = new BaseTroopChatPie.3(this, (bfdz)localObject);
  ...
  public void hideTroopFCView(boolean paramBoolean)
  {
    ...
    while (((this.root.a() != 0) && (!paramBoolean)) || (this.jdField_a_of_type_Bequ == null) || (!this.jdField_a_of_type_Bequ.a())) {
      return;
    }
    this.jdField_a_of_type_Bequ.a();
  }
  ...
  public View onCreatePanel(int paramInt)
  {
    if (paramInt == 3)
    {
      ...
      this.mEmoPanel = ((EmoticonMainPanel)this.mActivity.getLayoutInflater().inflate(2131559130, null));
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    afsn localafsn = (afsn)getHelper(52);
    if ((localafsn != null) && (localafsn.a(paramMotionEvent))) {
      return false;
    }
    return bool;
  }
      ...
      if (this.mTroopTips != null) {
        if (this.mTroopTips.jdField_b_of_type_Boolean)
        {
          ...
          if ((this.sessionInfo.curType == 1) && (this.app.getTroopMask(this.sessionInfo.curFriendUin) == 3)) {
            bcef.b(this.app, "P_CliOper", "Grp_AIO", "", "AIOchat", "Get_more_history", 0, 0, this.sessionInfo.curFriendUin, "", "", "");
          }
        }
      }
    }
  ...
  public void saveTextDraft(SessionInfo paramSessionInfo, avnb paramavnb, Spanned paramSpanned, QQAppInterface paramQQAppInterface, String paramString1, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, String paramString2)
  {
    ...
    if (paramSessionInfo.curType == 1) {
      paramSpanned = bevq.a(this.input.getEditableText(), localArrayList);
    }
    for (;;)
    {
      if (localArrayList.size() > 0) {
        paramString2 = bevq.a(localArrayList);
      }
      for (;;)
      {
        if (this.input != null) {
          super.saveTextDraft(paramSessionInfo, paramavnb, paramSpanned, paramQQAppInterface, paramString1, paramSourceMsgInfo, paramString2);
        }
        return;
      }
    }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    if (paramObject == null) {
      ...
      {
        if ((this.mUserActionState.d == becx.c) && (this.mUserActionState.a != null)) {
    ...
    while (!(paramObject instanceof bdyo)) {
      return;
    }
    a(paramObject);
  }
  ...
  public void updateListUnRead(int paramInt)
  {
    ...
    Object localObject = (aftj)this.helperProvider.a(23);
    if (localObject != null) {
      ((aftj)localObject).a(paramInt, this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout, this.mContent);
    }
    localObject = (afsn)getHelper(52);
    if (localObject != null) {
      ((afsn)localObject).a(this.mContent);
    }
  }
  ...
  public void updateSession_updateTitle(Intent paramIntent)
  {
    ...
    for (;;)
    {
      this.mTitleText.setText(new bczs(this.sessionInfo.curFriendNick, 32).a());
      if (AppSetting.c)
      {
  ...
  public void updateSpeakerPhoneLayout(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if (localObject != null) {
        ((aftj)localObject).a(this.speakerPhoneLayout);
      }
      localObject = (afsn)getHelper(52);
    } while (localObject == null);
    ((afsn)localObject).a(this.mContent, this.speakerPhoneLayout);
  }
}
