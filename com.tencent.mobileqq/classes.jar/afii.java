  ...
  extends ArkViewModel
{
  ...
  protected static ArrayList<WeakReference<afii>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<afii> c;
  boolean c;
  protected WeakReference<afil> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new afij();
  }
  
  public afii() {}
  
  public afii(boolean paramBoolean) {}
  ...
  public static WeakReference<afii> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      afii localafii = (afii)localWeakReference.get();
      if ((localafii != null) && (localafii.getContainer() == paramContainer)) {
  ...
  public void a(afil paramafil)
  {
    this.d = new WeakReference(paramafil);
  }
  ...
  {
    afil localafil = (afil)this.d.get();
    if (localafil != null) {
      localafil.a(this, paramString1, paramString2);
    }
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new afik(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      anoe.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693916);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693921);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
