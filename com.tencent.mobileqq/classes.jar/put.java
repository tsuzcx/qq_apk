...
public class put
  extends pun
{
  public put(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  public pqq a()
  {
    ...
    return d(this.jdField_a_of_type_Ram, this.jdField_a_of_type_Baxy).q().g().l().j().n();
  }
  ...
  public pqq d()
  {
    ...
    if ((this.jdField_a_of_type_Pqp != null) && ((this.jdField_a_of_type_Pqp instanceof ComponentContentBigImageVideo)))
    {
      ...
      ((ComponentContentBigImageVideo)this.jdField_a_of_type_Pqp).setOnClickListener(new puu(this));
