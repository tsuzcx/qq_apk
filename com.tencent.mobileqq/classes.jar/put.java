...
public class put
{
  private static Pattern a = Pattern.compile(baea.c.pattern() + "|" + baea.d.pattern(), 2);
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new res(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    {
      return false;
      if (baea.b.matcher(paramSpannable).find())
      {
        Object localObject = (res[])paramSpannable.getSpans(0, m, res.class);
        int j;
        int n;
        int i;
        ...
        int k = 0;
        localObject = (req[])paramSpannable.getSpans(0, m, req.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new puu(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = obx.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    req[] arrayOfreq = (req[])localEditable.getSpans(0, localEditable.length(), req.class);
    if ((arrayOfreq == null) || (arrayOfreq.length <= 0))
    {
      if (paramBoolean1) {
        break label650;
      }
    ...
    for (;;)
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), awbk.a(b((String)localObject + paramEditText, str))));
      return true;
      int m = arrayOfreq.length;
      Arrays.sort(arrayOfreq, new puu(localEditable));
      paramEditText = awbk.a(b(localEditable.subSequence(0, localEditable.getSpanStart(arrayOfreq[0])).toString(), str));
      ...
      if (i < m)
      {
        ...
        if (i == m - 1)
        {
          ...
          paramEditText = "";
          if (j - n > 0) {
            paramEditText = awbk.a(b(localEditable.subSequence(n, j).toString(), str));
          }
        ...
        for (;;)
        {
          i += 1;
          break;
          j = localEditable.getSpanStart(arrayOfreq[(i + 1)]);
          break label372;
          label481:
          ...
          else if ((localObject instanceof rer))
          {
            paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), paramEditText, 3, new SocializeFeedsInfo.JumpInfo(0L, ajjy.a(2131650227), ((rer)localObject).a())));
          }
        }
      }
      return false;
