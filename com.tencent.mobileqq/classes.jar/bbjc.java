...
public class bbjc
  extends anxw
{
  public bbjc(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        this.a.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(this.a.getResources(), 2130842294);
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.a.jdField_a_of_type_AndroidGraphicsBitmap);
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698585));
        this.a.g.setOnClickListener(new bbje(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new bbjf(this));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<bbmx> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4, int paramInt)
  {
    ...
    {
      localObject2 = (bbmx)((Iterator)localObject1).next();
      if (((bbmx)localObject2).a() == null) {
        break label3419;
      }
      if (!(localObject2 instanceof bblv)) {
        break label3416;
      }
      localObject3 = (bblv)localObject2;
      localObject4 = ((bblv)localObject3).a();
      Iterator localIterator = ((List)localObject4).iterator();
      while (localIterator.hasNext())
      {
        Object localObject5 = (bbmy)localIterator.next();
        if ((localObject5 instanceof bblw))
        {
          localObject5 = (bblw)localObject5;
          if (ActiveEntitySearchActivity.b) {
            ((bblw)localObject5).m = 1;
          }
          paramString2.add(Long.valueOf(((bblw)localObject5).d()));
        }
      }
      if (l1 != -1L) {
        break label3413;
      }
      l1 = ((bblv)localObject3).a;
      l2 = ((bblv)localObject3).a;
      if ((((List)localObject4).size() > 0) && (((bblv)localObject3).a == 1001L))
      {
        bcst.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 1, 0, "", "", "", "");
        label572:
        paramInt = i + ((bbmx)localObject2).a().size();
        l3 = l1;
        l1 = l2;
        l2 = l3;
      }
    ...
    for (;;)
    {
      ...
      i = paramInt;
      break label363;
      if ((((List)localObject4).size() > 0) && (((bblv)localObject3).a == 1002L)) {
        bcst.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 2, 0, "", "", "", "");
      }
      break label572;
      ...
      if (!paramBoolean1)
      {
        ...
        bbup.a("sub_result", "load_result", new String[] { this.a.jdField_b_of_type_JavaLangString, bbup.a(paramString3), "", bbup.a("dynamic_tab_search.1", this.a.jdField_a_of_type_ArrayOfLong) });
      }
      ...
      {
        bool1 = true;
        bbuk.a(paramString2, paramList, bool1, this.a.jdField_a_of_type_ArrayOfLong, this.a.jdField_e_of_type_JavaLangString, this.a.jdField_b_of_type_JavaLangString);
        if (i != 0) {
          break label1347;
        }
        if ((this.a.getActivity() instanceof bbgw)) {}
        switch (((bbgw)this.a.getActivity()).a())
        {
        case 2: 
        default: 
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bool1 = false;
        break;
        bbup.a("sub_result", "no_result", new String[] { this.a.jdField_b_of_type_JavaLangString, bbup.a(this.a.jdField_a_of_type_ArrayOfLong), "", bbup.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        bbup.a("all_result", "exp_tab_empty", new String[] { this.a.jdField_b_of_type_JavaLangString, bbup.a(this.a.jdField_a_of_type_ArrayOfLong), "", bbup.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        if ((this.a.jdField_a_of_type_ArrayOfByte != null) || (!(this.a.getActivity() instanceof bbgw))) {
          break label892;
        }
        paramString2 = (bbgw)this.a.getActivity();
        ...
        default: 
          break;
        case 1: 
          bbup.a("all_result", "exp_tab_page", new String[] { this.a.jdField_b_of_type_JavaLangString, bbup.a(this.a.jdField_b_of_type_JavaUtilList), "", bbup.a("UnifySearch.Unite", paramString2.a()) });
          break;
        case 3: 
          bbup.a("sub_result", "exp_result", new String[] { paramString2.a(), bbup.a(this.a.jdField_b_of_type_JavaUtilList), "", bbup.a("dynamic_tab_search.1", paramString2.a()) });
          break;
          if (QLog.isColorLevel()) {
      ...
      if ((!TextUtils.isEmpty(ActiveEntitySearchFragment.a(this.a))) && (ActiveEntitySearchFragment.a(this.a).size() > 0))
      {
        ...
        j = bggq.a(paramString3, 8.0F);
        k = bggq.a(paramString3, 10.0F);
        int m = bggq.a(paramString3, 2.0F);
        paramList1 = new GradientDrawable();
        paramList1.setCornerRadius(bggq.a(this.a.getActivity(), 15.0F));
        ...
        while (paramString4.hasNext())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            for (;;)
            {
              ...
              ((TextView)localObject3).setTag(2131368086, localObject1);
        ...
        if (this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() == 0)
        {
          ...
          paramString2 = bbhd.a(paramList, paramBoolean1, this.a.jdField_f_of_type_Boolean);
          if ((paramBoolean1) || (l1 != ActiveEntitySearchFragment.a(this.a)) || (paramBoolean3) || (paramString2 == null) || (paramString2.size() <= 0)) {
            break label2428;
          }
          paramArrayOfByte = (bbmw)this.a.jdField_a_of_type_JavaUtilList.get(this.a.jdField_a_of_type_JavaUtilList.size() - 1);
          ...
          if (!((bbmw)paramString2.get(paramInt) instanceof bbmf)) {
            break label2415;
          }
        }
      }
      for (;;)
      {
        if ((paramArrayOfByte instanceof bbmy))
        {
          paramArrayOfByte = (bbmy)paramArrayOfByte;
          j = paramArrayOfByte.a();
          bbus.a(paramArrayOfByte, j + paramInt, j - 1);
        }
        for (;;)
        {
          k = 0;
          for (;;)
          {
            if (k < paramInt)
            {
              paramArrayOfByte = (bbmw)paramString2.get(k);
              if ((paramArrayOfByte instanceof bbmy)) {
                bbus.a((bbmy)paramArrayOfByte, j + paramInt, j + k);
              }
              k += 1;
              continue;
          ...
          this.a.jdField_a_of_type_Bbix.a(this.a.jdField_a_of_type_JavaUtilList);
          ...
          for (;;)
          {
            ...
            {
              this.a.g.setVisibility(0);
              paramString3 = (anpk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Ajcl == null)
                {
                  this.a.jdField_a_of_type_Ajcl = new ajcp(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.getActivity(), this.a.jdField_b_of_type_ComTencentWidgetXListView, null);
                  paramString2 = this.a.jdField_a_of_type_Ajcl.a();
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setGravity(17);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, afur.a(105.0F, this.a.getResources())));
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131167064));
                  paramArrayOfByte.setTextSize(1, 17.0F);
                  paramArrayOfByte.setText(anni.a(2131698589));
                  paramArrayOfByte.setBackgroundResource(2130838759);
                  paramString2.addHeaderView(paramArrayOfByte);
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131167064));
                  paramArrayOfByte.setTextSize(1, 14.0F);
                  paramArrayOfByte.setGravity(16);
                  paramArrayOfByte.setPadding(afur.a(15.0F, this.a.getResources()), 0, 0, 0);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, afur.a(40.0F, this.a.getResources())));
                  paramArrayOfByte.setText(anni.a(2131698587));
                  paramArrayOfByte.setBackgroundResource(2130838759);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                this.a.jdField_a_of_type_Bbix.a(this.a.jdField_a_of_type_JavaUtilList);
                break;
                this.a.jdField_a_of_type_Ajcl.e();
                break label2973;
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698580));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bbjd(this, paramString2));
                    if (TextUtils.isEmpty(paramArrayOfByte)) {
                      break label2984;
                    }
                    this.a.jdField_a_of_type_AndroidWidgetButton.setText(paramArrayOfByte);
                    this.a.jdField_b_of_type_AndroidWidgetTextView.setPadding(0, bggq.a(this.a.jdField_b_of_type_AndroidWidgetTextView.getContext(), 15.0F), 0, 0);
                  }
                }
