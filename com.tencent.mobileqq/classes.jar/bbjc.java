...
public class bbjc
{
  ...
  public static Dialog a(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramActivity.setContentView(2131560845);
    TextView localTextView3 = (TextView)paramActivity.findViewById(2131378476);
    TextView localTextView4 = (TextView)paramActivity.findViewById(2131378453);
    TextView localTextView1 = (TextView)paramActivity.findViewById(2131378447);
    TextView localTextView2 = (TextView)paramActivity.findViewById(2131378443);
    localTextView3.setText(paramString1);
    localTextView4.setText(new SpannableString(paramString2));
    paramString1 = (ImageView)paramActivity.findViewById(2131364062);
    ((ImageButton)paramActivity.findViewById(2131364271)).setOnClickListener(new bbjd(paramActivity));
    if (paramInt >= 0)
    {
  ...
  public static Bitmap a(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 171	bbkd:a	(Landroid/content/Context;)Z
    //   4: ifne +7 -> 11
    //   7: aconst_null
    //   8: astore_1
    //   9: aload_1
    //   10: areturn
    //   11: getstatic 172	bbkd:a	Ljava/lang/String;
    //   14: astore_2
    //   15: aload_0
    ...
    //   79: aload_2
    //   80: arraylength
    //   81: invokestatic 213	baxi:a	([BII)Landroid/graphics/Bitmap;
    //   84: astore_2
    //   85: goto -38 -> 47
    //   88: aload_2
    //   89: astore_1
    ...
    //   125: aload_0
    //   126: astore_1
    //   127: getstatic 12	bbjc:a	Ljava/lang/String;
    //   130: iconst_2
  ...
  public static Bitmap a(String paramString1, String paramString2, String paramString3, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    return QQAppInterface.a(baxi.a(paramString2), 50, 50);
  }
  ...
  public static SparseArray<String> a(Context paramContext, String paramString)
  {
    ...
    //   154: aload_1
    //   155: astore_0
    //   156: getstatic 12	bbjc:a	Ljava/lang/String;
    //   159: iconst_2
  ...
  public static String a(String paramString)
  {
    ...
    localStringBuilder.append(ajsd.bO);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, String paramString, Bitmap paramBitmap)
  {
    ...
    int i = bbdv.a(paramQQAppInterface.getApp());
    ...
    label128:
    for (paramIntent = bbnc.a().a(paramBitmap, i);; paramIntent = Bitmap.createScaledBitmap(paramBitmap, i, i, false))
    {
            ...
            catch (InterruptedException localInterruptedException2)
            {
              try
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  localObject2 = localObject1;
                  continue;
                  localObject1 = bbay.a(paramQQAppInterface.b(localObject2.getStringExtra("uin")));
                  continue;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, MqqHandler paramMqqHandler, int paramInt2, String paramString3, int paramInt3)
  {
    ...
    {
      paramString1 = paramQQAppInterface.getApp().getString(2131692214);
  ...
  {
    return bbkd.a(paramContext, paramArrayOfString);
  }
}
