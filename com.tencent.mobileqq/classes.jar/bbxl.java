...
public class bbxl
{
  ...
  public bbxl(Activity paramActivity, JSONObject paramJSONObject, auuw paramauuw)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bbxo = new bbxo();
    }
    catch (IllegalArgumentException paramActivity)
    {
      for (;;)
      {
        ...
        {
          vxs.a("DIYProfileTemplate.ProfileTemplateBase default line color is illegal! " + paramJSONObject.optString("c"), new Object[0]);
          this.jdField_a_of_type_Int = -1;
        }
        paramActivity = paramActivity;
        vxs.a("DIYProfileTemplate.ProfileTemplateBase default main color is illegal! " + paramJSONObject.optString("c"), new Object[0]);
  ...
  private JSONObject a(Map<String, JSONObject> paramMap, String paramString)
  {
    ...
    if (localJSONObject == null) {
      veg.e("DIYProfileTemplate.ProfileTemplateBase", ":json illegal : it don't have " + paramString + " module");
    }
    try
    {
    ...
    {
      vxs.a("DIYProfileTemplate.ProfileTemplateBase:json error : it can not generate default " + paramString + " module", new Object[0]);
    }
    return null;
  }
  ...
  {
    paramView.measure(View.MeasureSpec.makeMeasureSpec(vzo.b(this.jdField_a_of_type_AndroidAppActivity) - vzo.a(this.jdField_a_of_type_AndroidAppActivity, 30.0F), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
  }
  ...
  protected int a(JSONObject paramJSONObject)
  {
    ...
    {
      vxs.a("DIYProfileTemplate.ProfileTemplateBase story line color is illegal module=" + paramJSONObject.optString("type") + " value=" + paramJSONObject.optString("line"), new Object[0]);
    }
    return i;
  }
  ...
  public View a(View paramView)
  {
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = vzo.a(this.jdField_a_of_type_AndroidAppActivity, 15.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = vzo.a(this.jdField_a_of_type_AndroidAppActivity, 15.0F);
    ((LinearLayout.LayoutParams)localObject).topMargin = vzo.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
    ((LinearLayout.LayoutParams)localObject).bottomMargin = vzo.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
  ...
  {
    QZoneLayoutTemplateBase localQZoneLayoutTemplateBase = (QZoneLayoutTemplateBase)paramView.findViewById(2131368127);
    ...
    a(paramJSONObject, paramView.findViewById(2131367679), (TextView)paramView.findViewById(2131377183), (ImageView)paramView.findViewById(2131367815));
    return paramView;
  }
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131361833);
    Object localObject;
    if (paramView1 == null)
    {
      localObject = localViewGroup.findViewById(2131361836);
      if (localObject != null) {
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373083).setVisibility(8);
      label67:
      if (paramView3 != null) {
        break label537;
      }
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373085).setVisibility(8);
      label87:
      if (paramView4 != null) {
        break label556;
      }
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373081).setVisibility(8);
    }
    for (;;)
    {
      if (localViewGroup.getChildAt(0) != null) {
        a(paramJSONObject, "qq", localViewGroup.getChildAt(0).findViewById(2131367679));
      }
      if (localViewGroup.getChildAt(1) != null) {
        a(paramJSONObject, "p", localViewGroup.getChildAt(1).findViewById(2131367679));
      }
      if (paramView1 != null)
      {
      ...
      if (this.jdField_a_of_type_Auuw.b)
      {
        paramJSONObject = (ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131361835);
        paramView2 = this.jdField_a_of_type_AndroidViewView.findViewById(2131361836);
        if (paramView2 != null) {
        ...
        {
          ((TextView)paramView5.findViewById(2131368342)).setTextColor(this.jdField_c_of_type_Int);
          ((ImageView)paramView5.findViewById(2131367679)).clearColorFilter();
          ((ImageView)paramView5.findViewById(2131367679)).setColorFilter(this.jdField_c_of_type_Int);
          paramJSONObject.addView(paramView5, 0);
        }
        if ((paramView6 != null) && (paramView6.getParent() == null))
        {
          ((TextView)paramView6.findViewById(2131368342)).setTextColor(this.jdField_c_of_type_Int);
          ((ImageView)paramView6.findViewById(2131367679)).clearColorFilter();
          ((ImageView)paramView6.findViewById(2131367679)).setColorFilter(this.jdField_c_of_type_Int);
          paramJSONObject.addView(paramView6, 0);
        }
        if ((paramView7 != null) && (paramView7.getParent() == null))
        {
          ((TextView)paramView7.findViewById(2131368342)).setTextColor(this.jdField_c_of_type_Int);
          ((ImageView)paramView7.findViewById(2131367679)).clearColorFilter();
          ((ImageView)paramView7.findViewById(2131367679)).setColorFilter(this.jdField_c_of_type_Int);
          paramJSONObject.addView(paramView7, paramJSONObject.getChildCount());
        }
      }
      return paramView1;
      localObject = (TextView)localViewGroup.findViewById(2131361837);
      if (localObject == null) {
        break;
      }
      ...
      break;
      label519:
      a(paramJSONObject, "sign", paramView2.findViewById(2131367679));
      break label67;
      label537:
      a(paramJSONObject, "lv", paramView3.findViewById(2131367679));
      break label87;
      label556:
      a(paramJSONObject, "metal", paramView4.findViewById(2131367679));
    }
  }
  ...
  protected URLDrawable a(JSONObject paramJSONObject, int paramInt1, int paramInt2)
  {
    ...
    return a(paramJSONObject, new bbxn(paramInt1, paramInt2));
  }
  ...
  public List<View> a(HashMap<String, View> paramHashMap, String[] paramArrayOfString)
  {
    ...
    {
      vxs.a("DIYProfileTemplate.ProfileTemplateBasethere is no module!", new Object[0]);
    ...
    if (i < ((JSONArray)localObject).length())
    {
      ...
      if (localJSONObject1 == null) {
        veg.e("DIYProfileTemplate.ProfileTemplateBase", "module array[" + i + "] is null");
      }
      for (;;)
      {
        i += 1;
    ...
    for (;;)
    {
      ...
      {
        vxs.a(bool, "makeModuleList error :" + paramArrayOfString[i] + " have a parent!");
        ...
        if (paramArrayOfString[i].equals("map_key_music_box"))
        {
          ...
          if (auwy.a(this.jdField_a_of_type_Auuw))
          {
            localObject = localJSONObject1;
  ...
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561609, null);
    ...
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373083);
    ((View)localObject).setBackgroundResource(2130839171);
    paramHashMap.put("map_key_sig", localObject);
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373085);
    ((View)localObject).setBackgroundResource(2130839171);
    paramHashMap.put("map_key_account_level_info", localObject);
    ((View)localObject).setClickable(false);
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373081);
    ((View)localObject).setBackgroundResource(2130839171);
    paramHashMap.put("map_key_medal_and_diamond", localObject);
  }
  
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, auuw paramauuw)
  {
    ProfileCardFavorShowView localProfileCardFavorShowView = a(this.jdField_a_of_type_AndroidAppActivity);
    paramQQAppInterface = new PersonalityLabelBoard(this.jdField_a_of_type_AndroidAppActivity, paramQQAppInterface, paramauuw.a.jdField_a_of_type_JavaLangString, localProfileCardFavorShowView);
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof FriendProfileCardActivity)) {
      paramQQAppInterface.setScrollListener((autg)this.jdField_a_of_type_AndroidAppActivity);
    }
    localProfileCardFavorShowView.setTitle(ajyc.a(2131708496));
  ...
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, auuw paramauuw, bcob parambcob)
  {
    paramQQAppInterface = new TemplatePhotoWall(this.jdField_a_of_type_AndroidAppActivity, paramQQAppInterface, paramauuw.a.jdField_a_of_type_JavaLangString, parambcob);
    paramauuw = (ProfileCardDiyPhotoWallView)paramQQAppInterface.findViewById(2131371582).findViewById(2131371582);
    paramauuw.setMargin(vzo.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F));
    paramauuw.setBorderWidth(this.jdField_d_of_type_Int);
    paramauuw = a(this.jdField_a_of_type_AndroidAppActivity);
    paramauuw.setTitle(ajyc.a(2131708497));
    paramauuw.setVisibility(8);
    paramauuw.addView(paramQQAppInterface);
    paramHashMap.put("map_key_photo_wall", paramauuw);
  }
  
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, auuw paramauuw, boolean paramBoolean)
  {
    paramQQAppInterface = a(this.jdField_a_of_type_AndroidAppActivity);
    paramQQAppInterface.setTitle(this.jdField_a_of_type_AndroidAppActivity.getString(2131691151));
  ...
  {
    auwy localauwy = new auwy(true);
    paramCard = localauwy.a(this.jdField_a_of_type_AndroidAppActivity, paramCard.uin);
    localauwy.a(this.jdField_a_of_type_Auuw);
    paramCard.setTag(2131561621, localauwy);
  ...
  protected void a(JSONObject paramJSONObject, View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (paramJSONObject = "null module";; paramJSONObject = paramJSONObject.optString("type"))
    {
      ...
      veg.d("DIYProfileTemplate.ProfileTemplateBase", "setModuleBackground " + paramJSONObject + " ,but it is null.");
      return;
    ...
    if (paramView == null)
    {
      vxs.a("setModuleBackground cant find " + paramJSONObject + " view", new Object[0]);
      return;
    }
    try
    {
      URLDrawable localURLDrawable = a(str, new bbxn(paramInt1, paramInt2));
      paramView.setBackgroundDrawable(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new bbxm(paramView));
      return;
    }
    catch (IllegalArgumentException paramView)
    {
      vxs.a("setModuleBackground " + paramJSONObject + " url illegal:" + str + " \ne:" + paramView, new Object[0]);
    }
  }
  ...
  public void a(JSONObject paramJSONObject, ProfileCardFavorShowView paramProfileCardFavorShowView)
  {
    ...
    for (;;)
    {
      a(paramJSONObject, paramProfileCardFavorShowView.findViewById(2131367679), (TextView)paramProfileCardFavorShowView.findViewById(2131377183), (ImageView)paramProfileCardFavorShowView.findViewById(2131367815));
      return;
  ...
  protected void a(JSONObject paramJSONObject, String paramString, View paramView)
  {
    ...
    {
      veg.d("DIYProfileTemplate.ProfileTemplateBase", "setBaseInfoIcon " + paramString + " icon,but it is null.");
      return;
    }
    if (paramView == null)
    {
      veg.e("DIYProfileTemplate.ProfileTemplateBase", "setBaseInfoIcon cant find " + paramString + " view");
      return;
    }
    try
    {
    ...
    {
      vxs.a("setBaseInfoIcon " + paramString + " url illegal:" + paramJSONObject + " \ne:" + paramView, new Object[0]);
    }
  }
  ...
  {
    View localView = paramView.findViewById(2131368109);
    ...
    localObject1 = paramView.findViewById(2131367679);
    ...
    localObject2 = (TextView)paramView.findViewById(2131377183);
    ...
    Object localObject3 = (TextView)paramView.findViewById(2131376318);
    ...
    localObject3 = paramView.findViewById(2131376458);
    ...
    ((TextView)paramView.findViewById(2131365670)).setTextColor(this.jdField_c_of_type_Int);
    localObject3 = (TextView)paramView.findViewById(2131376317);
    ((TextView)localObject3).setTextColor(this.jdField_c_of_type_Int);
    ...
    if (paramView.getTag(2131561621) != null) {
      ((auwy)paramView.getTag(2131561621)).a(this.jdField_a_of_type_Auuw);
    }
    return paramView;
  }
  ...
  {
    paramHashMap.put("map_key_qzone", this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561610, null));
  }
  ...
  public View c(JSONObject paramJSONObject, View paramView)
  {
    ...
    do
    {
      ...
      ProfileCardDiyPhotoWallView localProfileCardDiyPhotoWallView = (ProfileCardDiyPhotoWallView)localPhotoWallView.findViewById(2131371582).findViewById(2131371582);
      ...
      a(paramJSONObject, ((ProfileCardFavorShowView)localObject).findViewById(2131367679), (TextView)((ProfileCardFavorShowView)localObject).findViewById(2131377183), (ImageView)((ProfileCardFavorShowView)localObject).findViewById(2131367815));
      localObject = localPhotoWallView.findViewById(2131371574);
  ...
  public View d(JSONObject paramJSONObject, View paramView)
  {
    ...
    try
    {
      ...
      if (localProfileCardFavorShowView.b() > 0)
      {
        ...
        localView.measure(View.MeasureSpec.makeMeasureSpec(vzo.b(this.jdField_a_of_type_AndroidAppActivity) - vzo.a(this.jdField_a_of_type_AndroidAppActivity, 78.0F), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
        a(paramJSONObject, localProfileCardFavorShowView.a(), localView.getMeasuredWidth(), localView.getMeasuredHeight());
        a(paramJSONObject, localProfileCardFavorShowView.findViewById(2131367679), (TextView)localProfileCardFavorShowView.findViewById(2131377183), (ImageView)localProfileCardFavorShowView.findViewById(2131367815));
        return paramView;
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        veg.e("DIYProfileTemplate.ProfileTemplateBase", "getTagView error personalityLabelBoard is null");
        continue;
