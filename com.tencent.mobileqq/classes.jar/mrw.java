  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent.getAction().equals("tencent.video.q2v.getNearByProfile"))
    {
      ...
      paramIntent = lcx.a().b(this.a.jdField_a_of_type_JavaLangString);
      if (paramIntent != null) {
        break label98;
      }
    }
    ...
    do
    {
      ...
      {
        ldr localldr = this.a.jdField_a_of_type_ComTencentAvVideoController.a(paramContext);
        if (localldr != null)
        {
          this.a.jdField_a_of_type_ComTencentAvVideoController.a(paramContext, localmry.jdField_b_of_type_JavaLangString, false);
          localldr.jdField_b_of_type_Int = localmry.jdField_a_of_type_Int;
        }
