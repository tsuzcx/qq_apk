...
public class mlc
  extends mce
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mld(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  lef jdField_a_of_type_Lef = new mlf(this);
  lfl jdField_a_of_type_Lfl = new mle(this);
  ...
  public mlc(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      bdll.b(null, "dc00899", "Grp_video", "", "invite", (String)localObject, 0, 0, String.valueOf(this.jdField_a_of_type_ComTencentAvVideoController.a().g), this.jdField_d_of_type_Int + "", "", "");
      bool1 = true;
      return bool1;
    }
  }
  ...
  public int a(long paramLong, Intent paramIntent)
  {
    ...
    if (mrl.b(this.jdField_b_of_type_Int))
    {
      ...
      paramIntent = lcb.a(this.jdField_c_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
      if (lcb.a().a(paramIntent))
      {
        this.jdField_a_of_type_Lff = lcb.a().c(paramIntent);
        return 2;
      }
      this.jdField_a_of_type_Lff = lcb.a().a();
      return 2;
    }
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Lff = lcb.a().c(paramIntent);
      this.jdField_a_of_type_Lff.a(paramLong, "onStartCommand.1", 4);
      this.jdField_a_of_type_Lff.e("onStartCommand", true);
    ...
    {
      this.jdField_a_of_type_Lff.a(paramLong, "onStartCommand.2", 1);
    ...
    for (;;)
    {
      ...
      return 2;
      this.jdField_a_of_type_Lff.a(paramLong, "onStartCommand.3", 2);
      paramIntent = this.jdField_a_of_type_Lff;
  ...
  public void a(long paramLong)
  {
    ...
    int i = 1;
    if (!this.jdField_a_of_type_Lff.N) {
      i = 4;
    }
    if (1008 == this.jdField_a_of_type_Lff.j) {
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Mlb != null) {
          this.jdField_a_of_type_Mlb.c(anzj.a(2131715064));
        }
        if (!this.jdField_a_of_type_Lff.S) {
          break;
        }
        ...
        return;
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_a_of_type_Lff.jdField_d_of_type_JavaLangString, j, i);
      }
  ...
  protected boolean a()
  {
    if (this.jdField_a_of_type_Mvi == null) {
      this.jdField_a_of_type_Mvi = new mvi(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext(), 1, "video wifi lock");
    }
    if ((mtd.e(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext())) && (this.jdField_a_of_type_Mvi != null)) {
  ...
  public void b(long paramLong)
  {
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      long l = mrs.a(this.jdField_c_of_type_JavaLangString);
  ...
  public void d(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Mlb != null) {
      this.jdField_a_of_type_Mlb.c(anzj.a(2131715065));
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Lff.g, this.jdField_a_of_type_ArrayOfLong, false);
