  ...
  implements lqr
{
  ...
  public void a(lqq paramlqq)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Miw.a() == 2) {
      return;
    }
    ...
    if (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.q == 0) {
      this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee[0].a(i, j, true);
    }
    for (;;)
    {
      ljo.a(false);
  ...
  public boolean a(lqq paramlqq)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.q == 0) {
      this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee[0].a(i, j, false);
    }
    for (;;)
    {
      return true;
