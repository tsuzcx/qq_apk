...
public class var
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((qq_ad_get.QQAdGetRsp.AdInfo)localObject2).product_type.get() == 12)
        {
          ...
          localstSimpleMetaGdtAdInfo.bottomButton.text = amtj.a(2131715363);
        ...
        {
          localstSimpleMetaGdtAdInfo.bottomButton.text = amtj.a(2131715365);
          continue;
        }
      ...
      ((s_droplist_option)localObject3).optext = amtj.a(2131715368);
      ...
      ((s_droplist_option)localObject4).optext = amtj.a(2131715366);
  ...
  /* Error */
  private static String a(Context paramContext, vaq paramvaq)
  {
    // Byte code:
    //   0: ldc_w 409
    //   3: astore_3
    ...
    //   5: ifnull +260 -> 265
    //   8: aload_1
    //   9: invokevirtual 443	vaq:a	()Ljava/lang/Object;
    //   12: instanceof 65
    //   15: ifeq +250 -> 265
    //   18: aload_1
    //   19: invokevirtual 443	vaq:a	()Ljava/lang/Object;
    //   22: checkcast 65	UserGrowth/stSimpleMetaFeed
    //   25: astore 6
    //   27: aload 6
    //   29: invokestatic 59	var:a	(LUserGrowth/stSimpleMetaFeed;)Ltencent/gdt/qq_ad_get$QQAdGetRsp$AdInfo;
    //   32: astore 5
    //   34: aload 5
    //   36: ifnull +229 -> 265
    //   39: aload 5
    ...
    //   67: aload_3
    //   68: astore_1
    //   69: new 445	org/json/JSONObject
    //   72: dup
    //   73: aload 6
    //   75: getfield 69	UserGrowth/stSimpleMetaFeed:gdt_ad_info	Ljava/lang/String;
    //   78: invokespecial 448	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   81: ldc_w 450
    //   84: invokevirtual 454	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   87: iconst_0
    //   88: invokevirtual 460	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   91: ldc_w 462
    //   94: invokevirtual 454	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   97: iconst_0
    //   98: invokevirtual 460	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   101: ldc_w 463
    //   104: invokevirtual 467	org/json/JSONObject:optJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   107: ldc_w 469
    //   110: invokevirtual 473	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   113: astore_3
    //   114: aload_3
    //   115: astore_1
    //   116: aload_1
    //   117: astore_3
    //   118: aload_1
    //   119: invokestatic 422	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   122: ifne +89 -> 211
    //   125: aload 5
    ...
    //   138: new 475	java/lang/StringBuilder
    //   141: dup
    //   142: invokespecial 476	java/lang/StringBuilder:<init>	()V
    //   145: astore_3
    //   146: aload_0
    //   147: aload 4
    ...
    //   155: invokestatic 429	var:a	(Landroid/content/Context;Ljava/lang/String;)Z
    //   158: ifeq +55 -> 213
    //   161: iconst_2
    //   162: istore_2
    //   163: aload_1
    ...
    //   167: aload_3
    //   168: iload_2
    //   169: invokevirtual 482	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   172: ldc_w 409
    //   175: invokevirtual 485	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   178: invokevirtual 486	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   181: invokevirtual 490	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   184: astore_0
    //   185: aload_0
    //   186: astore_1
    //   187: aload_0
    //   188: ldc_w 492
    //   191: ldc_w 494
    //   194: invokevirtual 490	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   197: astore_0
    //   198: aload_0
    //   199: astore_1
    //   200: aload_0
    //   201: ldc_w 496
    //   204: ldc_w 498
    //   207: invokevirtual 490	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   210: astore_3
    //   211: aload_3
    //   212: areturn
    //   213: iconst_1
    ...
    //   219: ldc_w 478
    //   222: ldc_w 498
    //   225: invokevirtual 490	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   228: astore_0
    //   229: goto -44 -> 185
    //   232: astore_0
    //   233: ldc_w 500
    //   236: new 475	java/lang/StringBuilder
    //   239: dup
    //   240: invokespecial 476	java/lang/StringBuilder:<init>	()V
    //   243: ldc_w 502
    //   246: invokevirtual 485	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   249: aload_0
    //   250: invokevirtual 505	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   253: invokevirtual 486	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   256: invokestatic 511	uya:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   259: aload_1
    //   260: areturn
    //   261: astore_0
    //   262: goto -29 -> 233
  ...
  public static qq_ad_get.QQAdGetRsp.AdInfo a(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    try
    {
      ...
      paramstSimpleMetaFeed = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramstSimpleMetaFeed));
  ...
  public static void a(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    try
    {
      ...
      if (paramstSimpleMetaFeed != null)
      {
        ...
        abkw.a().a(paramstSimpleMetaFeed);
      }
      return;
    }
    catch (Throwable paramstSimpleMetaFeed)
    {
      uya.d("GdtAdUtil", "adPreLoad error" + paramstSimpleMetaFeed);
    }
  }
  ...
  {
    uya.b("GdtAdUtil", 2, "[onItemClick] action=" + paramInt1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramstSimpleMetaFeed.optext = amtj.a(2131715368);
        ...
        locals_droplist_option.optext = amtj.a(2131715366);
        ...
        {
        case 131072: 
          uya.b("GdtAdUtil", "invalid action, " + paramInt1);
          return;
        }
      }
  ...
  public static void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed, GdtAppReceiver paramGdtAppReceiver, urt paramurt)
  {
    if (paramstSimpleMetaFeed == null) {
      return;
    }
    ...
    try
    {
      paramurt = new GdtHandler.Params();
      paramurt.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((Activity)paramContext);
      paramurt.jdField_a_of_type_ComTencentGdtadAditemGdtAd = new GdtAd(paramstSimpleMetaFeed);
      paramurt.jdField_a_of_type_Boolean = true;
      paramurt.jdField_a_of_type_Int = 8;
      paramurt.jdField_b_of_type_Int = 6;
      paramurt.jdField_b_of_type_Boolean = true;
      paramurt.jdField_c_of_type_Int = 7;
      paramurt.jdField_c_of_type_Boolean = false;
      paramurt.d = false;
      paramurt.e = false;
      paramurt.f = true;
      paramurt.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramGdtAppReceiver);
      paramurt.jdField_a_of_type_JavaLangClass = GdtVideoCeilingFragmentForJS.class;
      paramurt.jdField_b_of_type_JavaLangClass = GdtCanvasFragmentForArk.class;
      paramurt.jdField_a_of_type_AndroidOsBundle = new Bundle();
      paramurt.jdField_a_of_type_AndroidOsBundle.putString("big_brother_ref_source_key", "biz_src_gzh_weishi");
      GdtHandler.a(paramurt);
      return;
    }
  ...
  public static void a(Context paramContext, vaq paramvaq)
  {
    if ((paramvaq != null) && ((paramvaq.a() instanceof stSimpleMetaFeed)))
    {
      stSimpleMetaFeed localstSimpleMetaFeed = (stSimpleMetaFeed)paramvaq.a();
      stSimpleMetaGdtAdInfo localstSimpleMetaGdtAdInfo = paramvaq.a();
  ...
  private static void b(Context paramContext, vaq paramvaq)
  {
    paramContext = a(paramContext, paramvaq);
