  ...
  implements Manager
{
  ...
  public static String a(Context paramContext)
  {
    ...
    tmp6_5[0] = 2131689815;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131689820;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131689819;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131689813;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131689812;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131689817;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131689816;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131689811;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131689814;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131689818;
    tmp54_48;
  ...
  public static String a(Context paramContext, SubMsgType0x76.MsgBody paramMsgBody)
  {
    ...
    if (TextUtils.isEmpty(str2))
    {
      ...
      str1 = String.format(paramContext.getString(2131689808), new Object[] { paramMsgBody.msg_geographic_notify.bytes_local_city.get().toStringUtf8() });
    }
    label63:
    do
    {
      ...
      if (paramMsgBody.uint32_msg_type.get() == 2) {
        return paramContext.getString(2131689806);
      }
      str1 = str2;
    } while (paramMsgBody.uint32_msg_type.get() != 3);
    return paramContext.getString(2131689810);
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if ((paramInt == 2) || (paramInt == 3))
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007210", "0X8007211", 0, 0, "", "", "", "");
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean2)
    {
      ((anri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER)).l(paramBoolean1);
      return;
    }
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694720) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean1).commit();
  }
  ...
  {
    if (paramBoolean) {
      ((anri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER)).u();
    }
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694720) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694720) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
  ...
  public void c()
  {
    ...
    aohd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, true, false, true);
  }
