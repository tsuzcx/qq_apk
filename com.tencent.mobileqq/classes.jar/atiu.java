...
public class atiu
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, atgt paramatgt, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramatgt == null) || (paramatgt.b)) {
          break label519;
        }
        paramatgt.b = true;
        if ((paramInt == 1) && (paramatgt.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramatgt, paramInt);
        paramatgt = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramatgt)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramatgt.toString() + ",filePath:" + paramString2);
        paramatgt = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramatgt = (atgt)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramatgt);
      if (QLog.isColorLevel())
      {
        if (paramatgt != null) {
          continue;
