  ...
  extends aphp
{
  ...
  public apic(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_c_of_type_Int = 0;
    this.jdField_d_of_type_Int = 0;
    this.jdField_b_of_type_Boolean = true;
    this.jdField_c_of_type_Int = paramIntent.getIntExtra("choose_friend_businessType", 0);
    this.jdField_d_of_type_Int = paramIntent.getIntExtra("choose_friend_businessSubType", 0);
  }
    ...
    for (paramInt = paramBundle.wMemberNum;; paramInt = 0)
    {
      ...
      for (;;)
      {
        ...
        if (j == 3000)
        {
          ...
          paramBundle = (ajhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
          paramInt = i;
          if (paramBundle != null)
          {
            i = paramBundle.a(str);
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && ((localRecentUser.getType() != 1006) || (a(aphf.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 9501) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 7000)) {
        if ((localRecentUser.getType() == 0) && (!azzz.a(localRecentUser.uin)) && (!azzz.c(localRecentUser.uin)) && (!mqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType())) && (a(jdField_b_of_type_JavaLangInteger)))
        {
          if ((localajjj != null) && (localajjj.b(localRecentUser.uin))) {
        ...
        else if (((localRecentUser.getType() == 1) && (a(jdField_c_of_type_JavaLangInteger))) || ((localRecentUser.getType() == 3000) && (a(jdField_d_of_type_JavaLangInteger)))) {
          localArrayList.add(localRecentUser);
        }
      }
    }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    if (d())
    {
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerselectpage.list", 0, 0, "", "", "", "");
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerconfirmpage.show", 0, 0, "", "", "", "");
    }
    label280:
    label307:
    do
    {
      ...
      {
        return;
        if ((this.jdField_c_of_type_Int == 1) && (this.jdField_d_of_type_Int == 2)) {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.payerselectpage.list", 0, 0, "", "", "", "");
        }
      } while ((this.jdField_a_of_type_Bafb != null) && (this.jdField_a_of_type_Bafb.isShowing()));
      boolean bool;
      String str3;
      String str2;
      String str1;
      ...
      for (;;)
      {
        babr.a(this.jdField_a_of_type_AndroidAppActivity, 230, str3, str1, ajjy.a(2131638955), ajjy.a(2131638953), new apid(this, paramInt, paramBundle), new apie(this)).show();
        return;
        bool = false;
        break;
        str1 = str2;
  ...
  protected void d()
  {
    String str = this.jdField_a_of_type_Bafb.getEditString();
    this.jdField_a_of_type_AndroidOsBundle.putString("emsg", str);
    if ((this.jdField_c_of_type_Int <= 0) || (this.jdField_a_of_type_AndroidOsResultReceiver == null)) {}
    do
    {
      do
      {
        return;
        Object localObject = a(aphf.a.intValue(), this.jdField_a_of_type_AndroidOsBundle);
        ((Bundle)localObject).putString("emsg", str);
        this.jdField_a_of_type_AndroidOsResultReceiver.send(0, (Bundle)localObject);
        if ((this.jdField_d_of_type_Int > 0) && (this.jdField_a_of_type_AndroidAppActivity != null))
        {
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "editsay.button", 0, 0, "", "", "", "");
    } while ((TextUtils.isEmpty(str)) || (str.equals(this.jdField_h_of_type_JavaLangString)));
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerconfirmpage.send", 0, 0, "", "", "", "");
  }
}
