  ...
  implements View.OnClickListener
{
  ...
  public axul(AbsShareMsg paramAbsShareMsg) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject3 = new axun(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, localQQAppInterface, paramView);
    ...
    if ("app".equals(paramView)) {
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData.startsWith("comic_plugin.apk")))
      {
        ...
        localContext.startActivity(paramView);
        localObject1 = aeht.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData);
    ...
    for (;;)
    {
      bghx.a(null, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.uin, localContext, "3009", "2", "40059", localObject1[0], new String[] { localObject1[2], localObject1[4], paramView });
      paramView = "";
      label495:
      bdes.a().a(localQQAppInterface.getAccount(), "", String.valueOf(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid), "1000", "80", "0", false);
      label525:
      nau.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.uin, "sourceclick", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID, paramView);
      axqy.b(localQQAppInterface, "CliOper", "", "", "0X800567C", "0X800567C", 0, 0, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID + "", "", "", "");
      axqy.b(localQQAppInterface, "CliOper", "", "", "0X8004B5C", "0X8004B5C", 1, 0, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID + "", "", "", "");
      axqy.b(localQQAppInterface, "dc00898", "", "", "0X8007C39", "0X8007C39", 0, 0, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID + "", "", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceName, "");
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.adverSign == 1) {
        axqy.b(localQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.uin, "0X800631F", "0X800631F", 0, 0, "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.msgId, "", "", "");
      }
      ...
      if (((localAbsShareMsg instanceof StructMsgForGeneralShare)) && (((StructMsgForGeneralShare)localAbsShareMsg).mIsPAVideoStructMsg))
      {
        ...
        {
          paramView = (axup)((Iterator)localObject3).next();
          if ((paramView instanceof axyg))
          {
            Iterator localIterator = ((axyg)paramView).a.iterator();
            label882:
            axzs localaxzs;
            String str1;
            label991:
            ...
            while (localIterator.hasNext())
            {
              ...
              if ((paramView instanceof axzs))
              {
                localaxzs = (axzs)paramView;
                if (localaxzs.a())
                {
                  paramView = new qzb(null, ((StructMsgForGeneralShare)localObject1).source_puin, localaxzs.U, localaxzs.Z);
                  ...
                  paramView = "1";
                  nol.a(null, "CliOper", "", "", "0X80065FE", "0X80065FE", 0, 0, paramView, Integer.toString(npu.a(localaxzs.r, ((StructMsgForGeneralShare)localObject1).mSourceName)), "", str1, false);
            ...
            for (paramView = localaxzs.Z;; paramView = "0")
            {
              nol.a(localQQAppInterface, str2, "0x8007410", "0x8007410", 0, 0, "1", "", paramView, str1, false);
              break label882;
              break label842;
              ...
              break;
              if (((axun)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData))
              {
                localObject1 = "run";
                if (localAbsShareMsg.mSourceAppid == -1L) {}
                for (paramView = "";; paramView = String.valueOf(localAbsShareMsg.mSourceAppid))
                {
                  axqy.b(null, "dc00898", "", "", "0X800A86D", "0X800A86D", 0, 0, paramView, "", "", "");
                  paramView = (View)localObject1;
                  break;
                }
              }
              if (((axun)localObject3).a(((FragmentActivity)localContext).getActivity(), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid, localAbsShareMsg.mSourceName, localAbsShareMsg.mSourceActionData, localAbsShareMsg.mSource_A_ActionData))
              {
                localObject1 = "setup";
                if (localAbsShareMsg.mSourceAppid == -1L) {}
                for (paramView = "";; paramView = String.valueOf(localAbsShareMsg.mSourceAppid))
                {
                  axqy.b(null, "dc00898", "", "", "0X800A86E", "0X800A86E", 0, 0, paramView, "", "", "");
                  paramView = (View)localObject1;
                  break;
                }
              }
              ((axun)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl);
              paramView = "setup";
              break label495;
              if ("web".equals(paramView))
              {
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 114)
                {
                  ...
                  localObject1 = bbex.a(localQQAppInterface, localContext, paramView);
                  if (localObject1 == null) {
                    break label1565;
                  }
                  ((bbeg)localObject1).c();
                  axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, paramView, "", "", "");
                }
                for (;;)
                {
                  paramView = "setup";
                  ...
                  localObject1 = String.format("%s&gc=%s", new Object[] { localObject1, atbp.a(localAbsShareMsg.uin) });
                  paramView = (View)localObject1;
                  if (!QLog.isColorLevel()) {
                    break label1380;
                  }
              ...
              if ("plugin".equals(paramView))
              {
                ...
                {
                  this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData = amom.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, localAbsShareMsg.uin);
                  boolean bool = amom.a(localQQAppInterface, localAbsShareMsg.uin);
                  ...
                  if ((bool) && (!TextUtils.isEmpty(paramView)) && ((localContext instanceof FragmentActivity)))
                  {
                    ...
                    if (localObject3 != null)
                    {
                      ...
                      {
                        localObject1 = "https://ti.qq.com/honest-say/group.html?_bid=3104&_qStyle=1&_wv=9191&_nav_alpha=0&_nav_txtclr=FFFFFF&_nav_titleclr=FFFFFF&_nav_anim=true&_wwv=128&gc=$GCODE$&src_type=share&from=appstore_aio&adtag=qq_to_qq".replace("$GCODE$", atbp.a(localAbsShareMsg.uin));
                        if (QLog.isColorLevel()) {
                        ...
                        amom.a((TroopChatPie)paramView);
                      }
                    }
                  }
                  if (!bool) {
                    bcql.a(BaseApplicationImpl.getContext(), amom.a, 0).a();
                  }
                  if (QLog.isColorLevel()) {
                ...
                for (;;)
                {
                  ...
                  catch (Exception localException)
                  {
                    for (;;)
                    {
                      ...
                      continue;
                      nol.a(null, "", "0X8007756", "0X8007756", 0, 0, "", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl, "", "", false);
                    }
                  }
                  if (TextUtils.isEmpty(paramView)) {
                    break label2003;
                  }
                  nol.a(null, "", "0X8007756", "0X8007756", 0, 0, paramView, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl, "", "", false);
                  paramView = "plugin";
                  break;
                  ((axun)localObject3).c(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
                }
              }
              label2003:
              ((axun)localObject3).a(paramView, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
              break label525;
      ...
      label2065:
      Object localObject2 = bbex.a(localQQAppInterface, localContext, localAbsShareMsg.mMsg_A_ActionData);
      if (localObject2 == null) {
        break;
      }
      paramView = ((bbeg)localObject2).b("usertype");
      ...
      vei.a("share_uin_obj", "clk_tail", 0, i, new String[] { localObject2 });
      return;
      label2232:
      paramView = "";
    }
