  ...
  extends PopupWindow
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new axum(this);
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private axun jdField_a_of_type_Axun;
  private String jdField_a_of_type_JavaLangString;
  
  public axul(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramContext);
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2131559618, null);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380358));
    this.jdField_a_of_type_AndroidWidgetTextView.getTextSize();
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363884));
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)paramView.findViewById(2131368762).getLayoutParams();
    ...
    for (;;)
    {
      ...
      setBackgroundDrawable(paramContext.getResources().getDrawable(2130850736));
      return;
  ...
  {
    this.jdField_a_of_type_Axun = paramaxun;
  }
