...
public class nvx
{
  public static String a(ArticleInfo paramArticleInfo)
  {
    ...
    if (((qoe.a(paramArticleInfo)) || (qoe.i(paramArticleInfo))) && (paramArticleInfo.mSocialFeedInfo != null)) {
      return String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqo.jdField_a_of_type_Long);
    }
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, String paramString3, boolean paramBoolean2, nvy paramnvy, int paramInt2)
  {
    ...
    abju.a(paramActivity, localIntent, PublicTransFragmentActivity.class, ReadInJoyCommentComponentFragment.class, 117);
    if (paramnvy != null) {
      paramnvy.a();
    }
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData, int paramInt1, String paramString1, String paramString2, boolean paramBoolean, nvy paramnvy, int paramInt2)
  {
    a(paramActivity, paramArticleInfo, paramBaseCommentData, paramInt1, paramString1, paramString2, paramBoolean, paramnvy, paramInt2, true);
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, nvy paramnvy, int paramInt2, boolean paramBoolean2)
  {
    Intent localIntent = new Intent();
    ...
    if (paramBaseCommentData != null)
    {
      ...
      if ((paramBaseCommentData != null) && (paramBaseCommentData.mediaDataList != null) && (paramBaseCommentData.mediaDataList.size() > 0) && (((nww)paramBaseCommentData.mediaDataList.get(0)).e != 0)) {
    ...
    if (paramInt1 == 2) {
      localIntent.putExtra("comment_is_show_pic", odk.a());
    }
  ...
  public static void a(ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArticleInfo = ogy.a().a((int)paramArticleInfo.mChannelID, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, int paramInt)
  {
    if (paramIntent == null)
    {
      bbmy.a(BaseApplication.getContext(), 1, BaseApplication.getContext().getString(2131652550), 0).a();
    ...
    {
      nxd.a(localArticleInfo, 0).b(paramQQAppInterface);
      nxd.a(localArticleInfo);
      return;
    }
    ogy.a().a(localArticleInfo, paramQQAppInterface);
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    {
      return;
      paramString = obb.g + baaw.encodeToString(paramString.getBytes(), 2);
      obz.a(paramContext, paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ReadInJoyCommentUtils", 2, "personal url =" + paramString);
  }
  
  public static void a(String paramString, ArticleInfo paramArticleInfo, ocg paramocg)
  {
    ndn.a(null, a(paramArticleInfo), paramString, paramString, 0, 0, String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mStrategyId), paramArticleInfo.innerUniqueID, paramocg.a(), false);
  }
    ...
    if (paramContext.hasPrimaryClip())
    {
      ...
      if ((localClipData != null) && (localClipData.getItemCount() > 0))
      {
        ...
        if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.getText())))
        {
          ...
          paramString = new axkd(awbk.b(paramString), 7, 18).toString();
  ...
  public static boolean a(ArticleInfo paramArticleInfo, String paramString)
  {
    ...
    localSocializeFeedsInfo.jdField_a_of_type_Pqm = new pqm();
    ...
    try
    {
      ...
      if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqm != null))
      {
        localSocializeFeedsInfo.jdField_a_of_type_Pqm.b = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqm.b;
        localSocializeFeedsInfo.jdField_a_of_type_Pqm.jdField_a_of_type_JavaLangLong = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqm.jdField_a_of_type_JavaLangLong;
      }
      ...
      if (i < paramString.length())
      {
        ...
        {
          localObject = new nwf((String)localObject, l, paramString.getJSONObject(i).optString("biu_info_comment"));
          ((nwf)localObject).jdField_a_of_type_Int = paramString.getJSONObject(i).optInt("biu_optype");
          ((nwf)localObject).jdField_a_of_type_JavaLangCharSequence = paramString.getJSONObject(i).optString("biu_nickname");
    ...
    while (((Iterator)localObject).hasNext()) {
      paramString.append(((nwf)((Iterator)localObject).next()).toString()).append("\n");
    }
    ...
    if ((paramArticleInfo != null) && (localArrayList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        {
          localObject = (nwf)localArrayList.get(i);
          SocializeFeedsInfo.BiuCommentInfo localBiuCommentInfo = new SocializeFeedsInfo.BiuCommentInfo();
          try
          {
            localBiuCommentInfo.jdField_a_of_type_JavaLangLong = Long.valueOf(((nwf)localObject).jdField_a_of_type_JavaLangString);
            if (((nwf)localObject).b == null)
            {
              paramString = "";
              localBiuCommentInfo.jdField_a_of_type_JavaLangString = paramString;
              localBiuCommentInfo.c = ((nwf)localObject).jdField_a_of_type_Int;
              localBiuCommentInfo.b = Long.valueOf(((nwf)localObject).jdField_a_of_type_Long);
              localSocializeFeedsInfo.jdField_a_of_type_Pqm.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
              i += 1;
            }
          }
          catch (Exception paramString)
          {
            for (;;)
            {
              ...
              continue;
              paramString = ((nwf)localObject).b.toString();
            }
          }
        }
      }
      ogy.a().a(obz.a(), paramArticleInfo.mFeedId, localSocializeFeedsInfo.jdField_a_of_type_Pqm, 0L, ((nwf)localArrayList.get(0)).b.toString(), paramArticleInfo.mArticleID, paramArticleInfo.mRecommendSeq, j, paramArticleInfo.innerUniqueID, k, paramArticleInfo);
    }
    return true;
  }
