  ...
  extends Drawable
{
  ...
  public bcre(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof bcre))) {}
    Object localObject;
    do
    {
    ...
    return new bcre((Bitmap)localObject);
  }
  
  public static bcre a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new bcre(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (bcrf.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public bcre a(float paramFloat)
  {
  ...
  public bcre a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public bcre a(ColorStateList paramColorStateList)
  {
  ...
  public bcre a(Shader.TileMode paramTileMode)
  {
  ...
  public bcre a(ImageView.ScaleType paramScaleType)
  {
  ...
  public bcre a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public bcre b(Shader.TileMode paramTileMode)
  {
