...
public class aata
  extends bfss
{
  public aata(TroopGiftPanel paramTroopGiftPanel, int paramInt, aasi paramaasi) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = anni.a(2131714080);
    }
    QQToast.a(this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.jdField_a_of_type_AndroidContentContext, str, 0).b(this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.getResources().getDimensionPixelSize(2131298998)).show();
