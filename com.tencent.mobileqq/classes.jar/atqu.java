  ...
  extends AvatarWallPagerAdapter<PicInfo>
{
  ...
  {
    return this.jdField_a_of_type_Atpk.a(paramInt, paramPicInfo);
  }
  ...
  public View a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetLinearLayout$LayoutParams = new LinearLayout.LayoutParams(vzl.a(this.jdField_a_of_type_Atpk.jdField_a_of_type_AndroidContentContext, 11.0F), vzl.a(this.jdField_a_of_type_Atpk.jdField_a_of_type_AndroidContentContext, 1.0F));
  ...
  {
    return this.jdField_a_of_type_Atpk.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(paramPicInfo1, paramPicInfo2);
  }
}
