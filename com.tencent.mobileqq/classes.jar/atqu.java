  ...
  extends CrashHandler
{
  ...
  private static bdlq jdField_a_of_type_Bdlq;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new atqv(Looper.getMainLooper());
    jdField_a_of_type_Bdlq = new atqw();
  ...
  public static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = atqx.a(paramContext, "/Tencent/MobileQQ/log/") + "/";
      atqx.jdField_a_of_type_JavaLangString = paramContext.getPackageManager().getPackageInfo(paramContext.getPackageName(), 0).versionName;
      atqx.jdField_b_of_type_JavaLangString = Build.MODEL;
      atqx.c = Build.VERSION.RELEASE;
      return;
    }
  ...
  public static void a(com.tencent.mobileqq.utils.httputils.HttpCommunicator paramHttpCommunicator, Context paramContext, ProgressDialog paramProgressDialog, String paramString1, String paramString2)
  {
    ...
    //   20: return
    //   21: aload_2
    //   22: putstatic 147	atqu:jdField_a_of_type_AndroidAppProgressDialog	Landroid/app/ProgressDialog;
    //   25: new 76	java/lang/StringBuilder
    //   28: dup
    //   29: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   32: aload_1
    //   33: ldc 32
    //   35: invokestatic 82	atqx:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   49: putstatic 34	atqu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   52: new 149	java/io/File
    //   55: dup
    //   56: new 76	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   63: getstatic 34	atqu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   91: ldc 160
    //   93: iconst_1
    //   94: invokestatic 163	atqu:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   97: iconst_1
    //   98: putstatic 165	atqu:jdField_a_of_type_Boolean	Z
    //   101: aload 9
    ...
    //   204: pop
    //   205: getstatic 198	atqu:jdField_b_of_type_ArrayOfByte	[B
    //   208: ifnonnull +178 -> 386
    //   211: ldc 200
    //   213: invokevirtual 24	java/lang/String:getBytes	()[B
    //   216: putstatic 198	atqu:jdField_b_of_type_ArrayOfByte	[B
    //   219: goto +167 -> 386
    ...
    //   256: aload_2
    //   257: getstatic 198	atqu:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   275: aload_1
    //   276: getstatic 26	atqu:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   302: new 247	bdlo
    //   305: dup
    //   306: getstatic 58	atqu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   309: aload_2
    //   310: invokevirtual 248	KQQ/HttpUploadReq:toByteArray	()[B
    //   313: getstatic 54	atqu:jdField_a_of_type_Bdlq	Lbdlq;
    //   316: invokespecial 251	bdlo:<init>	(Ljava/lang/String;[BLbdlq;)V
    //   319: astore_1
    //   320: aload_1
    //   321: ldc 253
    //   323: invokevirtual 255	bdlo:b	(Ljava/lang/String;)V
    //   326: aload_0
    //   327: aload_1
    //   328: invokevirtual 260	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lbdlo;)I
    //   331: pop
    //   332: iconst_0
    //   333: putstatic 165	atqu:jdField_a_of_type_Boolean	Z
    //   336: iconst_0
    //   337: ifeq -317 -> 20
  ...
  {
    atqx.a(paramString1, paramString2, paramBoolean);
  }
  
  private boolean a(Throwable paramThrowable)
  {
    boolean bool = true;
    if ((paramThrowable == null) || (1 != BaseApplicationImpl.sProcessId) || (System.currentTimeMillis() - azmz.jdField_b_of_type_Long > 600000L)) {}
    Object localObject2;
    do
    {
      return false;
  ...
  public void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    if (a(paramThrowable))
    {
      zdi.a(alpo.a(2131713795));
      azmz.jdField_b_of_type_Boolean = true;
      azlf.a(new Throwable(paramThrowable), "notExitOnSafeMode");
    ...
    try
    {
      atqx.jdField_a_of_type_JavaLangString = paramThread.getPackageManager().getPackageInfo(paramThread.getPackageName(), 0).versionName;
      atqx.jdField_b_of_type_JavaLangString = Build.MODEL;
      atqx.c = Build.VERSION.RELEASE;
      label295:
      paramThread.crashed();
