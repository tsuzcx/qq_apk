...
public class qpv
{
  ...
  private qpu jdField_a_of_type_Qpu;
  private qpw jdField_a_of_type_Qpw;
  private boolean jdField_a_of_type_Boolean;
  private int[] jdField_a_of_type_ArrayOfInt;
  private URLDrawable[] jdField_a_of_type_ArrayOfComTencentImageURLDrawable;
  
  public qpv(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          jdField_a_of_type_Int = actj.a(28.0F, paramActivity.getResources());
          this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
          this.jdField_a_of_type_JavaUtilRandom = new Random();
          paramActivity = a();
          if (paramActivity != null)
          {
            this.jdField_a_of_type_Qpu = ((qpu)paramActivity.a(138));
            this.jdField_a_of_type_Qpw = new qpw(this);
            paramActivity.addObserver(this.jdField_a_of_type_Qpw);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = bhvy.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_Qpu == null) || (!bhvy.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_Qpu.a(paramInt);
          bhvy.a(System.currentTimeMillis());
      ...
      return;
    } while (this.jdField_a_of_type_Qpu == null);
    this.jdField_a_of_type_Qpu.a(paramInt);
    bhvy.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Qpw);
    }
  }
