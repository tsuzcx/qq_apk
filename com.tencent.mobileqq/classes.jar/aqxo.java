...
{
  public static ConcurrentHashMap<String, aqxo> a;
  ...
  private aqxo(Context paramContext, String paramString1, String paramString2)
  {
  ...
  public static <T extends aqwv<Y>, Y> T a(Y paramY, Class<T> paramClass)
  {
    aqwv localaqwv = (aqwv)aqxe.a(paramClass);
    try
    {
      localaqwv.a(paramY);
      return localaqwv;
  ...
  public static aqxo a(String paramString)
  {
    ...
    Object localObject = (aqxo)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject == null) {
      synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        aqxo localaqxo = (aqxo)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        localObject = localaqxo;
        if (localaqxo == null)
        {
          localObject = new aqxo(BaseApplicationImpl.getContext(), paramString, MobileQQ.sMobileQQ.waitAppRuntime(null).getAccount());
  ...
  public <T extends Serializable> T a(String paramString, Class<T> paramClass, int paramInt)
  {
    ...
    return (Serializable)a(localFile, "", paramClass, paramInt, new aqxq(this, localFile, paramString));
  }
  
  public <JavaBean, Param> JavaBean a(File paramFile, Param paramParam, Class<JavaBean> paramClass, int paramInt, aqwu<JavaBean, Param> paramaqwu)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramInt == 1) || (str1 == null) || (!aqxb.a().a(this.jdField_a_of_type_JavaLangString, this.b, str1)) || (paramFile.exists())) {
          break;
        }
    ...
    try
    {
      paramParam = paramaqwu.a(paramFile, paramParam);
    ...
    catch (Exception paramParam)
    {
      for (;;)
      {
        aqxh.a().a(paramaqwu, paramFile, paramParam);
        ...
        if (str2 != null)
        {
          aqxb.a().a(this.jdField_a_of_type_JavaLangString, this.b, str2);
          paramParam = paramFile;
        }
      }
    }
  ...
  /* Error */
  public <DATA> void a(File paramFile, DATA paramDATA, aqwu<String, DATA> paramaqwu)
  {
    // Byte code:
    //   0: aload_3
    //   1: aload_1
    ...
    //   28: astore_2
    //   29: invokestatic 190	aqxb:a	()Laqxb;
    //   32: aload_0
    //   33: getfield 32	aqxo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   36: aload_0
    //   37: getfield 36	aqxo:b	Ljava/lang/String;
    //   40: aload_2
    //   41: invokevirtual 224	aqxb:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   44: invokestatic 190	aqxb:a	()Laqxb;
    //   47: aload_0
    //   48: getfield 32	aqxo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   51: aload_0
    //   52: getfield 36	aqxo:b	Ljava/lang/String;
    //   55: aload_2
    //   56: invokevirtual 220	aqxb:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   59: return
    //   60: astore_2
    //   61: ldc 113
    //   63: iconst_1
    ...
    //   90: invokestatic 95	aqxh:a	()Laqxh;
    //   93: aload_3
    //   94: aload_1
    //   95: aload_2
    //   96: invokevirtual 214	aqxh:a	(Laqwu;Ljava/io/File;Ljava/lang/Exception;)V
    //   99: return
    //   100: astore_1
    //   101: return
    ...
    //   0	102	3	paramaqwu	aqwu<String, DATA>
    //   17	3	4	bool	boolean
    // Exception table:
    //   from	to	target	type
  ...
  {
    a(a(paramString, ".serial"), paramT, new aqxp(this, paramString, paramT));
  }
}
