...
public class atnz
{
  ...
  atnz(BaseActivity paramBaseActivity, TencentMap paramTencentMap, LatLng paramLatLng, String paramString)
  {
  ...
  void a(atob paramatob)
  {
    this.jdField_a_of_type_Atob = paramatob;
  }
