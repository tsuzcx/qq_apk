...
class AttrsDialog$Adapter$EditTextViewHolder$2$1
  implements OnColorChangedListener
{
  AttrsDialog$Adapter$EditTextViewHolder$2$1(AttrsDialog.Adapter.EditTextViewHolder.2 param2) {}
  ...
  public void onColorChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ((AttrsDialog.Adapter)((RecyclerView)this.this$1.val$itemView.getParent()).getAdapter()).notifyDataSetChanged(((EditTextItem)this.this$1.this$0.item).getElement());
      return;
 ...
 * Qualified Name:     me.ele.uetool.dialog.AttrsDialog.Adapter.EditTextViewHolder.2.1
