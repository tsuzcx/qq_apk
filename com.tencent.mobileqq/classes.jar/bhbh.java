...
public class bhbh
{
  ...
  public static Fragment a(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface, @NonNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramString instanceof bhbl))
        {
          try
          {
            ((bhbl)paramString).attachQQContext(paramActivity, paramQQAppInterface);
            i = 1;
          }
  ...
  @Nullable
  public static bhbg a(@NonNull Activity paramActivity)
  {
    if (!jdField_a_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          paramActivity = (bhbg)((Constructor)localObject1).newInstance(new Object[] { paramActivity });
  ...
  public static String a(Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(str)) {
      paramContext = ajyc.a(2131720020);
    }
    return paramContext;
  }
  ...
  public static boolean a(@Nullable Activity paramActivity, @Nullable QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        bool2 = d(paramActivity, paramQQAppInterface);
        bool1 = bool2;
      } while (!bool2);
      bool1 = bool2;
  ...
  public static boolean b()
  {
    ...
    if (localPluginManagerClient != null) {
      return localPluginManagerClient.isPluginInstalled("qzone_plugin.apk");
    }
    long l = System.nanoTime();
    PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bhbi(l));
    return false;
  }
  ...
  public static boolean b(@Nullable Activity paramActivity, @Nullable QQAppInterface paramQQAppInterface)
  {
    ...
    return d(paramActivity, paramQQAppInterface);
  }
  ...
  public static boolean b(@NonNull Context paramContext, @NonNull QQAppInterface paramQQAppInterface)
  {
    ...
    ((bgkq)paramQQAppInterface.getManager(27)).a("qzone_plugin.apk");
  ...
  private static boolean d(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface)
  {
    boolean bool = true;
