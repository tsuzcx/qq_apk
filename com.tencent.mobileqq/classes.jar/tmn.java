...
public class tmn
{
  ...
  public tmn(Fragment paramFragment)
  {
  ...
  public tmn(ViolaFragment paramViolaFragment)
  {
    this.jdField_d_of_type_Boolean = true;
    this.jdField_g_of_type_Boolean = true;
  ...
  private static HashMap<String, Object> a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.contains("hideNav=1"))
      {
        ...
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_nav_bgclr"))) {
          localHashMap.put(jdField_c_of_type_JavaLangString, tlg.a(paramString, "v_nav_bgclr"));
        }
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_nav_txtclr"))) {
          localHashMap.put(jdField_d_of_type_JavaLangString, tlg.a(paramString, "v_nav_txtclr"));
        }
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_nav_titleclr"))) {
          localHashMap.put(jdField_e_of_type_JavaLangString, tlg.a(paramString, "v_nav_titleclr"));
        }
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_nav_alpha"))) {
          localHashMap.put(jdField_f_of_type_JavaLangString, tlg.a(paramString, "v_nav_alpha"));
        }
        localHashMap.put(jdField_i_of_type_JavaLangString, Boolean.valueOf(paramString.contains("statusBarStyle=1")));
        if (!TextUtils.isEmpty(tlg.a(paramString, "statusBarColor"))) {
          localHashMap.put(jdField_g_of_type_JavaLangString, tlg.a(paramString, "statusBarColor"));
        }
        localHashMap.put(jdField_j_of_type_JavaLangString, Boolean.valueOf(paramString.contains("v_nav_immer=1")));
        localHashMap.put(k, Boolean.valueOf(paramString.contains("v_full_screen=1")));
        ...
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_present_radius"))) {
          localHashMap.put(n, tlg.a(paramString, "v_present_radius"));
        }
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_present_top"))) {
          localHashMap.put(o, tlg.a(paramString, "v_present_top"));
        }
        if (!TextUtils.isEmpty(tlg.a(paramString, "v_present_titleHeight"))) {
          localHashMap.put(u, tlg.a(paramString, "v_present_titleHeight"));
        }
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        if (paramString.contains("v_bg_color")) {
          localHashMap.put(y, "#" + tlg.a(paramString, "v_bg_color"));
        }
  ...
  private void a(HashMap<String, Object> paramHashMap)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.a(paramHashMap);
      return;
      paramHashMap = str;
      if (str.startsWith("0X")) {
        paramHashMap = str.replace("0X", "#");
  ...
  private void b(HashMap<String, Object> paramHashMap, ViewGroup paramViewGroup)
  {
    ...
    if (paramHashMap.containsKey("title_trans_anim")) {
      this.jdField_e_of_type_Boolean = ((Boolean)paramHashMap.get("title_trans_anim")).booleanValue();
    }
    if (paramHashMap.containsKey("error_view_white")) {
      this.jdField_f_of_type_Boolean = ((Boolean)paramHashMap.get("error_view_white")).booleanValue();
    }
    ...
    if (paramHashMap.containsKey(v)) {
      this.jdField_h_of_type_Boolean = ((Boolean)paramHashMap.get(v)).booleanValue();
    }
    if (paramHashMap.containsKey(w)) {
      this.jdField_i_of_type_Boolean = ((Boolean)paramHashMap.get(w)).booleanValue();
    }
    if (paramHashMap.containsKey(x)) {
      this.jdField_j_of_type_Boolean = ((Boolean)paramHashMap.get(x)).booleanValue();
    }
    if (b()) {
    ...
    if (paramHashMap.containsKey(A)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.v();
    }
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramViewGroup.findViewById(2131373602));
  ...
  private void d(HashMap<String, Object> paramHashMap, ViewGroup paramViewGroup)
  {
    if (paramViewGroup != null)
    {
      ...
      this.jdField_a_of_type_Int = afur.a(i1, paramViewGroup.getResources());
  ...
  private void e()
  {
    if (this.jdField_a_of_type_Tmp == null) {
      this.jdField_a_of_type_Tmp = new tmo(this);
    }
  }
  ...
  private boolean e()
  {
    ...
    while ((ReadinjoyTabFrame.d_()) && (this.jdField_h_of_type_Boolean)) {
      return true;
    }
    return false;
  }
  ...
  public void a()
  {
    ...
    while ((this.jdField_a_of_type_Bidh == null) || (this.jdField_a_of_type_Bidh.b() == 0)) {
      return;
    }
  ...
  public void a(ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    if ((!b()) && (!c()))
    {
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramViewGroup.findViewById(2131380967));
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((ViewStub)paramViewGroup.findViewById(2131380968)).inflate();
      if (this.jdField_b_of_type_Int != -1) {
        this.jdField_a_of_type_AndroidViewView.setBackgroundColor(this.jdField_b_of_type_Int);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376012));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376011));
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(paramViewGroup.getResources().getString(2131717128));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(paramOnClickListener);
    if ((this.jdField_b_of_type_Int == -1) || (d())) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramViewGroup.getResources().getDrawable(2130839277));
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramViewGroup.getResources().getColor(2131166869));
      ((LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams()).topMargin = afur.a(10.0F, paramViewGroup.getResources());
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramViewGroup.getResources().getDrawable(2130839480));
    }
  }
  ...
  public void a(HashMap<String, Object> paramHashMap, ViewGroup paramViewGroup)
  {
    ...
    if (paramHashMap != null)
    {
      if (paramHashMap.containsKey(jdField_j_of_type_JavaLangString))
      {
        this.jdField_c_of_type_Boolean = ((Boolean)paramHashMap.get(jdField_j_of_type_JavaLangString)).booleanValue();
        if (this.jdField_c_of_type_Boolean)
        {
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.m();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.d();
      return;
      label274:
      bool = false;
      break;
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.a(anni.a(2131715139), null);
  ...
  public void b()
  {
    ...
    while ((this.jdField_a_of_type_Bidh == null) || (this.jdField_a_of_type_Bidh.b() == 2)) {
      return;
    }
  ...
  public void b(ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar.setId(2131372936);
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, afur.a(3.0F, paramViewGroup.getContext().getResources()));
    ...
    } while ((trd.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.a())) && (aros.i()) && (arot.i()));
    a();
  }
  
  public boolean b()
  {
    return (this.jdField_d_of_type_Boolean) && ((e()) || (this.jdField_i_of_type_Boolean)) && (!this.jdField_j_of_type_Boolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.h("white");
  }
