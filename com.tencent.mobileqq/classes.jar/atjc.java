  ...
  extends atjw
{
  ...
  atjc(atiy paramatiy, MessageRecord paramMessageRecord)
  {
    super(paramatiy);
  ...
  void a(String paramString, int paramInt, atju paramatju)
  {
    ...
    atiy.a(this.jdField_a_of_type_Atiy).getFileManagerEngine().a().a(paramString, paramInt, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 106, new atjd(this, paramString, paramatju));
  }
}
