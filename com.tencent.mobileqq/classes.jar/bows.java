...
@TargetApi(11)
public class bows
  implements View.OnClickListener, View.OnTouchListener, baos, baot, baqq, boxv, boxw, boye, boyo
{
  protected int a;
  protected long a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bowt(this);
  ...
  public bows(boyn paramboyn, boym paramboym)
  {
    this.jdField_b_of_type_Long = 3L;
    this.jdField_a_of_type_Boyf = new boyf(10000, 100, 2);
  ...
  private void v()
  {
    ...
    if (this.jdField_a_of_type_Boyn.a().getIntent().getIntExtra("flow_camera_show_mode_style", 0) == 1) {
      this.jdField_a_of_type_Boolean = true;
    }
    this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boyn.a().getIntent().getBooleanExtra("flow_camera_show_panel", false);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Boyn.a().getIntent().getIntExtra("light_video_entry_type", 0);
  }
  ...
  private void w()
  {
    if (this.jdField_a_of_type_Bgpa == null)
    {
      ...
      this.jdField_a_of_type_Bgpa = bglp.a(localActivity, 230).setMessage(str).setPositiveButton(localActivity.getString(2131693473), new boww(this));
    }
  }
  ...
  private void x()
  {
    ...
    {
      this.jdField_a_of_type_Balo = balo.a();
  ...
  public View a()
  {
    v();
    View localView = b();
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_Boyn.a());
    localRelativeLayout.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
    Object localObject = localView;
    if (localView == null) {
      localObject = this.jdField_a_of_type_Boyn.a().getLayoutInflater().inflate(a(), localRelativeLayout, false);
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewSimpleEffectsCaptureView = ((SimpleEffectsCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364093));
    ...
    this.jdField_a_of_type_Bang = new bang(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewSimpleEffectsCaptureView);
    this.jdField_a_of_type_Bana = a();
    this.jdField_a_of_type_Bane = new bane();
    localObject = (SessionInfo)this.jdField_a_of_type_Boyn.a().getIntent().getParcelableExtra("PhotoConst.SEND_SESSION_INFO");
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImPtvLightWeightCaptureButtonLayout = ((LightWeightCaptureButtonCornerLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364037));
      if (localObject != null) {
      ...
      avsp.b(this.jdField_a_of_type_DovComQqImPtvLightWeightCaptureButtonLayout.d);
    }
    for (;;)
    {
      this.jdField_a_of_type_DovComQqImPtvLightWeightCaptureShadow = ((LightWeightCaptureShadow)this.jdField_a_of_type_AndroidViewView.findViewById(2131364158));
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).topMargin = (bqja.a(73.5F) - bqja.a(8.0F));
      ...
      this.jdField_a_of_type_DovComQqImPtvLightWeightCaptureButtonLayout = ((LightWeightCaptureButtonHorizontalLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364038));
      break;
      label542:
      avsp.a(this.jdField_a_of_type_DovComQqImPtvLightWeightCaptureButtonLayout.d);
      avsp.d(this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Long != -1L)
    {
      ...
      bceg.a("sv_light_cost_time_total", l);
    }
    bpwt.a();
  ...
  public void a(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Boyn.a(), new bowx(this, null));
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    bany.b = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewSimpleEffectsCaptureView.a();
  }
  ...
  public void denied()
  {
    ...
    for (;;)
    {
      ...
      label83:
      if (i != 0) {
        localObject = anni.a(2131704904);
      } else {
        localObject = anni.a(2131704902);
      }
    }
  }
  ...
  public void f()
  {
    ...
    if (!this.d)
    {
      ...
      this.jdField_a_of_type_Boyn.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, localIntentFilter);
      this.d = true;
    }
    x();
  }
  ...
  public void l()
  {
    this.jdField_a_of_type_Boym.a(1);
  }
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_a_of_type_AndroidWidgetImageView) {
      this.jdField_a_of_type_Boym.a(0);
    }
