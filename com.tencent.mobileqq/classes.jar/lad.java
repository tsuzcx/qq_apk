...
class lad
  extends kzi
{
  lad(lab paramlab, List paramList, lan paramlan, Long paramLong) {}
  ...
  public void a(int paramInt, Header[] paramArrayOfHeader, String paramString)
  {
    ...
    try
    {
      localObject = this.jdField_a_of_type_Lab.a.parse(new InputSource(new StringReader(paramString)));
    ...
    catch (IOException localIOException)
    {
      ...
      this.jdField_a_of_type_Lan.a(localIOException, paramString, this.jdField_a_of_type_JavaLangLong);
    }
