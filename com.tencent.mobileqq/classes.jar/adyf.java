  ...
  implements QQRecorder.OnQQRecorderListener, VoicePlayer.VoicePlayerListener
{
  ...
  protected adyi a;
  private Handler jdField_a_of_type_AndroidOsHandler = new adyg(this, Looper.getMainLooper());
  ...
  public adyf(WebRecordApiPlugin paramWebRecordApiPlugin, AppInterface paramAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  private void e(String paramString)
  {
    ...
    ThreadManager.post(new adyh(this, paramString), 8, null, false);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (paramInt1 != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131433438) + "'}" });
        return;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131433437) + "'}" });
  }
    ...
    if (i < paramJSONArray.length())
    {
      ...
      if ((localFile.exists()) && (!TextUtils.isEmpty(str)))
      {
        ...
        if (localFile.exists())
        {
          ...
          this.jdField_a_of_type_Adyi = new adyi(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidOsHandler, paramString1, paramString2, (AudioInfo)localObject);
          ThreadManager.post(this.jdField_a_of_type_Adyi, 5, null, true);
        }
      }
      for (;;)
      {
