  ...
  extends aebx
{
  ...
  public adyf(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_Adyp = new adyp(null);
    this.jdField_a_of_type_Acxj = new adyg(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new adyk(this);
  ...
  private static adyn a(MessageForMixedMsg paramMessageForMixedMsg)
  {
    boolean bool2 = true;
    ...
    if (m < paramMessageForMixedMsg.msgElemList.size())
    {
      ...
      for (localObject4 = localObject1;; localObject4 = localObject1)
      {
        ...
        bool1 = bool2;
        label250:
        return new adyn((MessageForPic)localObject1, (String)localObject3, i, bool1);
        label265:
  ...
  private View a(BaseChatItemLayout paramBaseChatItemLayout, Context paramContext, adyo paramadyo, MessageForReplyText paramMessageForReplyText, acxj paramacxj, boolean paramBoolean)
  {
    paramadyo.e = 0;
    Object localObject2 = this.jdField_a_of_type_Adyp.a(0);
    ...
    if (localObject2 == null)
    {
      ...
      paramadyo.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)localObject3);
      paramadyo.c = ((TextView)((ViewGroup)localObject3).findViewById(2131377274));
      paramadyo.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((ViewGroup)localObject3).findViewById(2131370647));
      paramadyo.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((ViewGroup)localObject3).findViewById(2131366657));
      paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)((ViewGroup)localObject3).findViewById(2131370452));
      paramadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)((ViewGroup)localObject3).findViewById(2131370469));
      ((ViewGroup)localObject3).setId(2131364137);
      localObject2 = new LinearLayout.LayoutParams(-1, -1);
      ((LinearLayout)localObject1).setPadding(0, 0, 0, 0);
      paramadyo.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((ViewGroup)localObject3).findViewById(2131368616));
      paramadyo.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
      paramadyo.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131713419));
      ...
      ((ETTextView)localObject3).setEditableFactory(ayku.a);
      ((ETTextView)localObject3).setSpannableFactory(aykk.a);
      ...
      ((LinearLayout)localObject1).addView(paramadyo.jdField_a_of_type_AndroidViewViewGroup, (ViewGroup.LayoutParams)localObject2);
      ((ETTextView)localObject3).setId(2131364112);
      paramadyo.d = ((TextView)localObject3);
      localObject2 = new LinearLayout.LayoutParams(-1, -1);
      ((LinearLayout.LayoutParams)localObject2).topMargin = actj.a(8.0F, paramContext.getResources());
      ((LinearLayout)localObject1).addView(paramadyo.d, (ViewGroup.LayoutParams)localObject2);
    }
    paramadyo.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131370647));
    paramadyo.c = ((TextView)((View)localObject1).findViewById(2131377274));
    paramadyo.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131366657));
    paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)((View)localObject1).findViewById(2131370452));
    paramadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)((View)localObject1).findViewById(2131370469));
    paramadyo.d = ((ETTextView)((View)localObject1).findViewById(2131364112));
    paramadyo.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)((View)localObject1).findViewById(2131364137));
    paramadyo.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject1).findViewById(2131368616));
    paramadyo.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131713416));
    paramadyo.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
    paramadyo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838092));
    ...
    for (paramContext = Long.toString(paramMessageForReplyText.getSourceMsgInfo().mSourceMsgSenderUin);; paramContext = "")
    {
      ...
      paramadyo.c.setTypeface(paramContext);
      paramadyo.jdField_a_of_type_AndroidWidgetTextView.setTypeface(paramContext);
      paramadyo.jdField_b_of_type_AndroidWidgetTextView.setTypeface(paramContext);
      paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTypeface(paramContext);
      paramadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTypeface(paramContext);
      if (!TextUtils.isEmpty(paramMessageForReplyText.getExtInfoFromExtStr("sens_msg_ctrl_info")))
      {
        paramContext = ((ETTextView)paramadyo.d).getETLayout();
        if (paramContext != null) {
          paramContext.a = (paramMessageForReplyText.uniseq + 1L);
        }
      }
      ((ETTextView)paramadyo.d).setFont(0, paramMessageForReplyText.uniseq);
      i = ((ETTextView)paramadyo.d).mMaxWidth;
      j = BaseChatItemLayout.d;
      paramadyo.d.setMaxWidth(j);
      paramadyo.d.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_Int);
      if (i != j) {
        ((ETTextView)paramadyo.d).mMsgId = 0L;
      }
      paramadyo.d.setText(paramMessageForReplyText.sb);
      if (AppSetting.d) {
        paramadyo.d.setContentDescription(aylc.e(paramMessageForReplyText.sb.toString()));
      }
      super.a(paramadyo.d, paramMessageForReplyText);
      a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramadyo.jdField_a_of_type_AndroidViewViewGroup, paramMessageForReplyText.mSourceMsgInfo, paramMessageForReplyText.frienduin, paramMessageForReplyText.istroop, paramMessageForReplyText, paramBoolean, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      paramadyo.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView = ((BubbleImageView)((View)localObject1).findViewById(2131377248));
      paramadyo.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      paramadyo.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ((View)localObject1).setOnTouchListener(paramacxj);
      ((View)localObject1).setOnLongClickListener(paramacxj);
      paramadyo.jdField_a_of_type_AndroidViewViewGroup.setOnTouchListener(paramacxj);
      paramadyo.jdField_a_of_type_AndroidViewViewGroup.setOnLongClickListener(paramacxj);
      paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setOnTouchListener(this.jdField_a_of_type_Acxj);
      paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setOnLongClickListener(this.jdField_a_of_type_Acxj);
      paramadyo.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setOnTouchListener(this.jdField_a_of_type_Acxj);
      paramadyo.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setOnLongClickListener(this.jdField_a_of_type_Acxj);
      paramadyo.d.setOnTouchListener(paramacxj);
      paramadyo.d.setOnLongClickListener(paramacxj);
      paramadyo.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      if ((paramadyo.d instanceof AnimationTextView)) {
        ((AnimationTextView)paramadyo.d).onDoubleClick = this.jdField_a_of_type_Bcjp;
      }
      if ((paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView instanceof AnimationTextView)) {
        paramadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.onDoubleClick = this.jdField_a_of_type_Bcjp;
      }
      if (paramadyo.jdField_a_of_type_Aibq == null) {
        paramadyo.jdField_a_of_type_Aibq = new aibq();
      }
      if ((localObject1 instanceof aicc))
      {
        paramadyo.jdField_a_of_type_Aibq.a((aicc)localObject1);
        paramadyo.jdField_a_of_type_Aibq.a(paramBaseChatItemLayout, paramBaseChatItemLayout);
      }
      paramadyo.jdField_a_of_type_Aibq.b(paramMessageForReplyText);
      return localObject1;
    }
  }
  ...
  public static final RelativeLayout a(Context paramContext)
  {
    ...
    ((TextView)localObject).setEditableFactory(ayku.a);
    ((TextView)localObject).setSpannableFactory(aykk.a);
    localObject = (TextView)localRelativeLayout.findViewById(2131377274);
    ((TextView)localObject).setTextColor(paramContext.getResources().getColorStateList(2131166872));
    ImmersiveUtils.a((View)localObject, 0.9F);
    ((TextView)localObject).setTextSize(1, 13.0F);
    ((TextView)localObject).setEditableFactory(ayku.a);
    ...
    ((TextView)localObject).setEditableFactory(ayku.a);
    ((TextView)localObject).setSpannableFactory(aykk.a);
    ((ImageView)localRelativeLayout.findViewById(2131368616)).setColorFilter(null);
    localObject = (ETTextView)localRelativeLayout.findViewById(2131370452);
    ...
    ((ETTextView)localObject).setEditableFactory(ayku.a);
    ((ETTextView)localObject).setSpannableFactory(aykk.a);
    ((ETTextView)localObject).setLineSpacing(actj.a(2.0F, paramContext.getResources()), 1.0F);
    localObject = (ETTextView)localRelativeLayout.findViewById(2131370469);
    ((ETTextView)localObject).setTextColor(paramContext.getResources().getColorStateList(2131166872));
    ((ETTextView)localObject).setLinkTextColor(paramContext.getResources().getColorStateList(2131166866));
    ((ETTextView)localObject).setTextSize(1, 13.0F);
    ((ETTextView)localObject).setEditableFactory(ayku.a);
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (apug.a(paramMessageRecord)) {
      paramQQAppInterface = apug.a((ChatMessage)paramMessageRecord);
    }
  ...
  {
    BubbleImageView localBubbleImageView = (BubbleImageView)paramViewGroup.findViewById(2131377248);
    ...
    if ((paramMessageRecord2 instanceof MessageForShortVideo)) {
      localBubbleImageView.setContentDescription(ajya.a(2131713418));
    }
    Object localObject;
    for (;;)
    {
      ...
      localLayoutParams.rightMargin = baxn.a(paramContext, 25.0F);
      ((View)localObject).setLayoutParams(localLayoutParams);
      i = Build.VERSION.SDK_INT;
      if ((i == 19) || (i == 18)) {
        localBubbleImageView.e = true;
      }
      localObject = (ETTextView)paramViewGroup.findViewById(2131370469);
      paramViewGroup = (ETTextView)paramViewGroup.findViewById(2131370452);
      ...
      return;
      localBubbleImageView.setContentDescription(ajya.a(2131713411));
    }
    if ((paramBoolean2) || (a(paramString)) || (paramSourceMsgInfo.mSourceSummaryFlag != 1))
    {
      c(paramContext, paramQQAppInterface, localBubbleImageView, paramMessageRecord1, new adyh(paramViewGroup, (ETTextView)localObject, paramSourceMsgInfo, localBubbleImageView, paramInt, paramString, paramMessageRecord1, paramContext));
      return;
    }
  ...
  public static final void a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean, SessionInfo paramSessionInfo)
  {
    ...
    String str2 = bbkp.a(paramContext, 3, paramSourceMsgInfo.mSourceMsgTime * 1000L).toString();
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131370647);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131377274);
    boolean bool1;
    Object localObject2;
    Object localObject1;
    label147:
    ...
    if ((paramBoolean) || (a(paramSourceMsgInfo.mSourceMsgText)))
    {
      ...
      paramString = str1;
      if (ajwb.a((MessageRecord)localObject2))
      {
        if (str1 == null) {
          break label694;
        }
    ...
    for (;;)
    {
      ...
      if ((paramMessageRecord instanceof MessageForReplyText))
      {
        ...
        localObject3 = (ImageView)paramViewGroup.findViewById(2131368616);
        ...
        if ((paramMessageRecord instanceof MessageForReplyText))
        {
          ...
          if (((MessageForReplyText)paramMessageRecord).isBarrageMsg)
          {
            ...
            paramString = amle.a(paramContext, (int)(l / 1000L));
          }
        }
        label405:
        if (paramString == null) {
        ...
        if (paramSourceMsgInfo.mSourceMsgSenderUin == 50000000L)
        {
          ...
          {
            localObject1 = bajp.a((MessageRecord)localObject1);
            if (localObject1 != null) {
              paramSourceMsgInfo.mAnonymousNickName = ((bajq)localObject1).c;
            }
          }
          localObject1 = "";
          break label147;
        }
        localObject1 = localTextView1.getTag(2131376862);
        ...
        localTextView1.setText(new ayjw((String)localTextView1.getTag(2131376861), 16).a());
        localTextView2.setText(" " + str2);
        localObject1 = "";
        break label147;
        label694:
        paramString = ajya.a(2131713413);
        break label245;
        label705:
      ...
      for (;;)
      {
        ...
        if ((localObject3 instanceof MessageForTroopFile))
        {
          ...
          {
            localObject4 = bakx.a(paramQQAppInterface, (MessageForTroopFile)localObject3);
            str1 = paramString;
            if (localObject4 != null) {
              str1 = ((azqv)localObject4).g;
            }
          }
          paramString = str1;
          if (TextUtils.isEmpty(str1))
          {
            ...
            paramString = str1;
            if (!TextUtils.isEmpty(str1)) {
              paramString = ajya.a(2131706577) + str1;
            }
          }
          if (!TextUtils.isEmpty(paramString))
          {
        ...
        else
        {
          ...
          {
            if ((paramMessageRecord instanceof anij))
            {
              paramString = null;
              paramBoolean = true;
              paramInt = 0;
          ...
          else if (localObject3 != null)
          {
            ...
            label1181:
            paramString = paramSessionInfo;
            if (!apug.a((MessageRecord)localObject2)) {
              break label405;
            }
            ...
            if ((localObject5 instanceof MessageForFile))
            {
              ...
              if ((paramString == null) || (apug.a(paramString.fileName) != 2)) {
                break label1536;
              }
            }
            label1536:
            for (paramString = amle.a(paramContext, (int)(l / 1000L));; paramString = null)
            {
              break;
              paramString = paramSessionInfo;
              ...
              localObject5 = bakx.a(paramQQAppInterface, (MessageForTroopFile)localObject5);
              paramString = paramSessionInfo;
              if (localObject5 == null) {
                break;
              }
              paramString = paramSessionInfo;
              if (apug.a(((azqv)localObject5).g) != 2) {
                break;
              }
              paramString = amle.a(paramContext, (int)(l / 1000L));
              break;
              ...
              break label431;
              label1346:
              paramString = paramContext.getString(2131699360);
              if (!TextUtils.isEmpty(paramSourceMsgInfo.mSourceMsgTroopName))
              {
                ...
                paramString = paramContext.getString(2131699359) + paramString;
              }
              ((TextView)localObject4).setText(paramString);
              ((TextView)localObject4).setVisibility(0);
              paramString = ((FragmentActivity)paramContext).getChatFragment();
              if ((paramString != null) && ((paramString.a() instanceof aeqz))) {}
              for (i = 1;; i = 0)
              {
                if (i != 0) {}
                for (i = 4;; i = 0)
  ...
  protected static void a(Context paramContext, QQAppInterface paramQQAppInterface, ChatThumbView paramChatThumbView, MessageRecord paramMessageRecord, adyq paramadyq)
  {
    ThreadManager.post(new ReplyTextItemBuilder.3(paramMessageRecord, paramQQAppInterface, paramadyq, paramContext, paramChatThumbView), 8, null, true);
  }
  ...
  public static final void a(Context paramContext, QQAppInterface paramQQAppInterface, ChatThumbView paramChatThumbView, MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    if ((paramMessageRecord1 instanceof anij)) {
      localObject = (anij)paramMessageRecord1;
    }
    if ((paramMessageRecord2 instanceof MessageForPic))
    {
      paramQQAppInterface = (MessageForPic)paramMessageRecord2;
      paramContext = advs.a(paramContext, paramQQAppInterface, paramChatThumbView);
      if (paramContext != null)
      {
      ...
      paramChatThumbView.setTag(2131364123, paramQQAppInterface);
    }
    boolean bool;
    label1161:
    for (;;)
    {
      ...
      if ((paramMessageRecord2 instanceof MessageForTroopFile))
      {
        ...
        paramMessageRecord1 = bakx.a(paramQQAppInterface, paramContext);
        if (paramMessageRecord1 == null)
        {
          a(paramChatThumbView, false, 0, 0);
          return;
        }
        int k = apug.a(paramMessageRecord1.g);
        ...
        if (bbdx.b((String)localObject))
        {
          ...
          {
            paramContext = apuy.a(paramContext.width, paramContext.height, (String)localObject);
        ...
        int j = 383;
        i = j;
        if (apuy.b(paramContext.width, paramContext.height))
        {
          i = j;
          if (!apvd.b(paramMessageRecord1.c)) {
            i = 640;
          }
        }
        if (paramMessageRecord1.jdField_b_of_type_Int != 12)
        {
          if (paramMessageRecord1.a != null)
          {
            ...
            paramChatThumbView.setTag(2131364124, new Boolean(true));
          }
        }
        else {
          if (k != 2) {
        ...
        for (bool = true;; bool = false)
        {
          ...
          paramContext = apuy.a(paramContext.width, paramContext.height, "");
          if (QLog.isDebugVersion()) {
      ...
      if ((paramMessageRecord2 instanceof MessageForFile))
      {
        ...
        if (localObject != null)
        {
          i = apug.a(((FileManagerEntity)localObject).fileName);
          if (i == 2) {}
          ...
          if (!bbdx.b(paramContext))
          {
            ...
            if (!bbdx.b(paramContext))
            {
              ...
              paramQQAppInterface = apuy.a(((FileManagerEntity)localObject).imgWidth, ((FileManagerEntity)localObject).imgHeight, "");
              if (QLog.isDebugVersion()) {
          ...
          for (paramMessageRecord1 = paramContext;; paramMessageRecord1 = paramContext)
          {
            ...
            paramContext = apuy.a(((FileManagerEntity)localObject).imgWidth, ((FileManagerEntity)localObject).imgHeight, paramMessageRecord1);
            if (QLog.isDebugVersion()) {
            ...
            break;
            label1113:
            if (apuy.b((FileManagerEntity)localObject))
            {
    ...
    if ((paramMessageRecord2 instanceof MessageForShortVideo))
    {
      ...
      if (!bbdx.b(paramMessageRecord2)) {}
      for (;;)
      {
        try
        {
          paramMessageRecord2 = axdq.a(2, 2);
          localObject = paramContext.getDownloadInfo(paramMessageRecord2.jdField_b_of_type_Int);
          ((axdt)localObject).i = ShortVideoUtils.a(paramContext.thumbMD5, "jpg");
          ((axdt)localObject).a(paramContext.istroop, 1);
          paramMessageRecord2.a((axdt)localObject);
          paramMessageRecord2.a(new adyi(paramContext, paramMessageRecord1, paramQQAppInterface, paramChatThumbView));
          axdq.a(paramMessageRecord2, paramQQAppInterface);
          paramContext = (ImageView)((ViewGroup)paramChatThumbView.getParent()).findViewById(2131367700);
          if (paramContext == null) {
            break;
          }
          paramContext.setImageResource(2130843521);
    ...
    if ((localObject != null) && (((anij)localObject).getSourceMsgInfo() != null) && (((anij)localObject).getSourceMsgInfo().replyPicWidth != 0))
    {
      paramChatThumbView.setImageDrawable(aede.a(2, 200, 200));
      return;
    }
  ...
  {
    paramSourceMsgInfo = new adyj(paramSourceMsgInfo, paramBubbleImageView, paramETTextView2, paramETTextView1, paramInt, paramString, paramMessageRecord);
  ...
  public static void a(ChatThumbView paramChatThumbView)
  {
    ...
    Object localObject = paramChatThumbView.findViewById(2131377245);
    if (localObject != null) {
      ((View)localObject).setVisibility(8);
    }
    localObject = paramChatThumbView.findViewById(2131364811);
    if (localObject != null) {
      ((View)localObject).setVisibility(8);
    }
    localObject = paramChatThumbView.findViewById(2131364967);
    if (localObject != null) {
      ((View)localObject).setVisibility(8);
    }
  ...
  private static void a(ChatThumbView paramChatThumbView, Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo)
  {
    ...
    if ((aywm.b() instanceof SkinnableBitmapDrawable))
    {
      ...
      paramChatThumbView.setImageDrawable(new anox(paramContext.getResources(), localBitmap, paramSourceMsgInfo.replyPicWidth, paramSourceMsgInfo.replyPicHeight, -921103));
      return;
    }
    ...
    paramChatThumbView.setImageDrawable(aywm.b());
  }
  ...
  public static void a(ChatThumbView paramChatThumbView, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = actj.a(120.0F, ((Context)localObject).getResources());
    int i = actj.a(80.0F, ((Context)localObject).getResources());
    if (paramInt1 <= 0) {
      if (paramBoolean) {
        paramInt1 = actj.a(60.0F, ((Context)localObject).getResources());
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          return;
          paramInt1 = actj.a(120.0F, ((Context)localObject).getResources());
          break;
          paramChatThumbView.setVisibility(8);
          ((ViewGroup)localObject).setVisibility(0);
          paramChatThumbView = (AsyncImageView)((ViewGroup)localObject).findViewById(2131377245);
          if (paramChatThumbView != null) {
            paramChatThumbView.setVisibility(8);
          }
          paramChatThumbView = ((ViewGroup)localObject).findViewById(2131364967);
          if (paramChatThumbView != null)
          {
          ...
          paramChatThumbView = ((ViewGroup)localObject).findViewById(2131364811);
          if (paramChatThumbView != null) {
            paramChatThumbView.setVisibility(8);
          }
        ...
        if (paramBoolean)
        {
          paramChatThumbView.setImageResource(2130843521);
          return;
        }
  ...
  public static void a(ChatThumbView paramChatThumbView, boolean paramBoolean, int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        paramString = localViewGroup.findViewById(2131364811);
        if (paramString != null)
        {
      ...
      paramChatThumbView = localViewGroup.findViewById(2131364967);
      if (paramChatThumbView != null) {
        paramChatThumbView.setVisibility(8);
      }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, TextView paramTextView, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    if (apug.a(paramMessageRecord))
    {
      ...
      if ((paramMessageRecord instanceof MessageForFile))
      {
        ...
        i = apug.a(apug.a(paramMessageRecord.fileName), 1);
    ...
    for (;;)
    {
      if (paramQQAppInterface != null)
      {
        ...
        int j = actj.a(4.0F, paramContext.getResources());
        ...
        paramMessageRecord = bakx.a(paramQQAppInterface, (MessageForTroopFile)paramMessageRecord);
        if (paramMessageRecord == null) {
          break label750;
        }
        i = apug.a(apug.a(paramMessageRecord.g), 1);
        if (Build.VERSION.SDK_INT >= 21) {}
        ...
        {
          if ((!aimd.a(paramMessageRecord)) || (c(paramMessageRecord))) {
            break label745;
          }
          label336:
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            paramString = paramContext.getDrawable(2130843482);
            ...
            if (((MessageForStructing)paramMessageRecord).structingMsg != null)
            {
              ...
              paramQQAppInterface = ayfx.f(paramMessageRecord);
              i = actj.a(15.0F, paramContext.getResources());
          ...
          {
            break;
            paramString = paramContext.getResources().getDrawable(2130843482);
            break label336;
            label458:
            paramQQAppInterface = paramString;
            ...
            {
              paramQQAppInterface = paramString;
              if (paramMessageRecord.contains(ayfx.c))
              {
                paramQQAppInterface = URLDrawable.getDrawable(ayfx.d, localURLDrawableOptions);
                paramQQAppInterface.setBounds(0, 0, i, i);
              }
            }
          }
        ...
        for (;;)
        {
          try
          {
            for (;;)
            {
              ...
              if ((paramMessageRecord == null) || (!amrr.a().a(paramMessageRecord.appName, paramMessageRecord.appView))) {
                break label745;
              }
              if (Build.VERSION.SDK_INT < 21) {
                break label691;
              }
              paramQQAppInterface = paramContext.getDrawable(2130843482);
              paramMessageRecord = amrr.a().a(new JSONObject(paramMessageRecord.toAppXml())).get("kArkMsgReplyIcon").toString();
              i = actj.a(15.0F, paramContext.getResources());
          ...
          break;
          paramQQAppInterface = paramContext.getResources().getDrawable(2130843482);
        }
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    for (;;)
    {
      axqy.b(paramQQAppInterface, "dc00898", "", "", paramString, paramString, i, 0, "", "", "", "");
      return;
      ...
      else
      {
        ...
        if ((paramMessageRecord instanceof MessageForArkApp)) {
          try
          {
            ...
            i = j;
            if (paramMessageRecord != null) {
              i = amrr.a(paramMessageRecord.appName, paramMessageRecord.appView);
            }
          }
          catch (Exception paramMessageRecord)
          {
  ...
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (paramString.indexOf(ajya.a(2131713415)) == -1) {
      return false;
    }
    return true;
  }
  ...
  private static void b(int paramInt1, int paramInt2, String paramString, ImageView paramImageView)
  {
    if ((paramInt1 == 0) || (paramInt2 == 0)) {
      paramString = adzf.a(paramString, 55, 95, actj.a(2.0F, paramImageView.getContext().getResources()));
    }
    while ((paramString == null) || (paramString.getCurrent() == null))
    {
      ...
      if (paramInt1 > paramInt2)
      {
        ...
        paramString = adzf.a(paramString, 95, (int)(Float.valueOf(paramInt2).floatValue() / paramInt1), actj.a(2.0F, paramImageView.getContext().getResources()));
      }
      else
      {
        paramInt2 = (int)(Float.valueOf(paramInt2).floatValue() / 95);
        paramString = adzf.a(paramString, (int)(Float.valueOf(paramInt1).floatValue() / paramInt2), 95, actj.a(2.0F, paramImageView.getContext().getResources()));
      }
    }
  ...
  protected static void b(Context paramContext, QQAppInterface paramQQAppInterface, ChatThumbView paramChatThumbView, MessageRecord paramMessageRecord, adyq paramadyq)
  {
    ThreadManager.post(new ReplyTextItemBuilder.4(paramMessageRecord, paramQQAppInterface, paramadyq, paramContext, paramChatThumbView), 8, null, true);
  }
  ...
  private static void b(TextView paramTextView1, TextView paramTextView2, int paramInt, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    paramString = bbos.a(str, paramMessageRecord, ChatTextSizeSettingActivity.b() - 2, 7);
    switch (paramInt)
    {
    default: 
      ...
      if (AppSetting.d) {
        paramTextView1.setContentDescription(aylc.e(str));
      }
    ...
    if (AppSetting.d) {
      paramTextView2.setContentDescription(aylc.e(str));
    }
    paramTextView1.setVisibility(8);
  }
  ...
  private static void b(MessageRecord paramMessageRecord1, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, BubbleImageView paramBubbleImageView, ETTextView paramETTextView1, ETTextView paramETTextView2, int paramInt, String paramString1, MessageRecord paramMessageRecord2, Context paramContext, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    for (;;)
    {
      if (bool1)
      {
        ...
        paramBubbleImageView.setTag(2131364124, null);
        ...
        paramMessageRecord1 = actj.a(paramETTextView1);
        if ((paramMessageRecord1 != null) && ((paramMessageRecord1 instanceof adyo))) {
          ((adyo)paramMessageRecord1).jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView = paramBubbleImageView;
        }
        return;
        bool1 = true;
        i = 0;
        ...
        else if ((paramMessageRecord1 instanceof MessageForMixedMsg))
        {
          ...
          bool1 = ((adyn)localObject1).jdField_a_of_type_Boolean;
          i = ((adyn)localObject1).jdField_a_of_type_Int;
          paramString1 = ((adyn)localObject1).jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
          localObject1 = ((adyn)localObject1).jdField_a_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramSourceMsgInfo instanceof MessageForFile))
        {
          ...
          {
            j = apug.a(((FileManagerEntity)localObject2).fileName);
            if (j != 2)
            {
              paramString2 = localObject3;
              bool1 = bool2;
        ...
        paramSourceMsgInfo = bakx.a(paramQQAppInterface, (MessageForTroopFile)paramSourceMsgInfo);
        paramString2 = localObject3;
        bool1 = bool2;
        i = paramInt;
        localObject1 = paramString1;
        ...
        int j = apug.a(paramSourceMsgInfo.g);
        if (j != 2)
        {
          paramString2 = localObject3;
          bool1 = bool2;
  ...
  protected static void c(Context paramContext, QQAppInterface paramQQAppInterface, ChatThumbView paramChatThumbView, MessageRecord paramMessageRecord, adyq paramadyq)
  {
    ThreadManager.post(new ReplyTextItemBuilder.5(paramMessageRecord, paramQQAppInterface, paramadyq, paramContext, paramChatThumbView), 8, null, true);
  }
  ...
  public acui a(View paramView)
  {
    ...
    {
      paramView = (adyo)((View)paramView.getParent()).getTag();
      if (paramView != null) {
  ...
  public View a(ChatMessage paramChatMessage, acuj paramacuj, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acxj paramacxj)
  {
    ...
    if (paramView != null)
    {
      localadyo = (adyo)paramView.getTag();
      if (localadyo != null) {
        this.jdField_a_of_type_Adyp.a(localadyo.e, paramView);
      }
    }
    adyo localadyo = (adyo)paramacuj;
    int i;
    if (localMessageForReplyText.mSourceMsgInfo == null)
    {
      if (QLog.isColorLevel()) {
      ...
      localadyo.e = -1;
      paramacuj = this.jdField_a_of_type_Adyp.a(-1);
      if (paramacuj != null) {
        break label643;
      }
      paramacuj = new LinearLayout(localContext);
      ...
      paramView.setEditableFactory(ayku.a);
      ...
      localadyo.d = paramView;
      paramView = new LinearLayout.LayoutParams(-2, -2);
      paramView.topMargin = actj.a(5.0F, localContext.getResources());
      paramacuj.addView(localadyo.d, paramView);
    }
    label643:
    for (;;)
    {
      ((ETTextView)localadyo.d).setFont(0, paramChatMessage.uniseq);
      localadyo.d.setTypeface(ia.a(paramChatMessage));
      localadyo.d.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_Int);
      localadyo.d.setText(localMessageForReplyText.sb);
      super.a(localadyo.d, paramChatMessage);
      paramacuj.setOnTouchListener(paramacxj);
      paramacuj.setOnLongClickListener(paramacxj);
      localadyo.d.setOnTouchListener(paramacxj);
      localadyo.d.setOnLongClickListener(paramacxj);
      paramView = paramacuj;
      if ((localadyo.d instanceof AnimationTextView))
      {
        ((AnimationTextView)localadyo.d).onDoubleClick = this.jdField_a_of_type_Bcjp;
        paramView = paramacuj;
      }
      if (paramView != null)
      {
        paramView.setTag(localadyo);
        paramView.setPadding(0, 0, 0, 0);
        if ((AppSetting.d) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0))
        {
          paramacuj = aylc.e(paramChatMessage.msg);
          if (!paramChatMessage.isSend()) {
            break label604;
          }
          paramView.setContentDescription(ajya.a(2131713412) + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d + ajya.a(2131713417) + paramacuj);
        }
      }
      return paramView;
      if (QLog.isColorLevel()) {
      ...
      {
        paramView = a(paramBaseChatItemLayout, localContext, localadyo, localMessageForReplyText, paramacxj, bool);
        break;
      }
      label604:
      paramView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d + ajya.a(2131713414) + paramacuj);
      return paramView;
    }
  }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt != 0)
      {
        ...
        localObject = (avqu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(340);
        ...
        ((avqu)localObject).a(paramChatMessage);
      }
      for (;;)
      {
  ...
  {
    adyo localadyo = (adyo)paramacuj;
    paramacuj = (MessageForReplyText)paramChatMessage;
    if (paramacuj.mSourceMsgInfo == null) {
      return;
    }
    ...
    int i = paramacuj.mSourceMsgInfo.mType;
    if ((paramambg.jdField_a_of_type_Int == 0) || (!paramambg.a()) || (axmv.b()))
    {
      ...
      if (paramChatMessage.isSend())
      {
        ...
        localadyo.d.setTextColor(paramacuj);
        localadyo.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramacuj);
        localadyo.c.setTextColor(paramacuj);
        localadyo.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramacuj);
        localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramacuj);
        localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramacuj);
        ((Drawable)localObject).setColorFilter(new PorterDuffColorFilter(paramacuj.getDefaultColor(), PorterDuff.Mode.SRC_ATOP));
        localadyo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
        if (!paramChatMessage.isSend()) {
          break label295;
        }
      }
      ...
      {
        localadyo.d.setLinkTextColor(paramacuj);
        localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramacuj);
        localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramacuj);
        ImmersiveUtils.a(localadyo.jdField_b_of_type_AndroidWidgetTextView, 0.5F);
        ImmersiveUtils.a(localadyo.jdField_a_of_type_AndroidWidgetTextView, 0.9F);
        ImmersiveUtils.a(localadyo.c, 0.9F);
        ImmersiveUtils.a(localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
        ImmersiveUtils.a(localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
        return;
    ...
    {
      localadyo.d.setTextColor(-16777216);
      localadyo.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-16777216);
      localadyo.c.setTextColor(-16777216);
      localadyo.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-16777216);
      localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(-16777216);
      localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTextColor(-16777216);
      ((Drawable)localObject).setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.SRC_ATOP));
      localadyo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      label408:
      if (paramambg.jdField_c_of_type_Int != 0) {
        break label750;
      }
    ...
    for (;;)
    {
      ...
      ImmersiveUtils.a(localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
      ImmersiveUtils.a(localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
      if ((!paramambg.jdField_b_of_type_Boolean) || (((ChatBackgroundManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(63)).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, localadyo.d.getCurrentTextColor(), 10000.0D * localadyo.jdField_a_of_type_Ambg.jdField_a_of_type_Double) != 1)) {
        break;
      }
      paramacuj = (ETTextView)localadyo.d;
      ...
      localadyo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      return;
      localadyo.d.setTextColor(paramambg.jdField_b_of_type_Int);
      localadyo.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramambg.jdField_b_of_type_Int);
      localadyo.c.setTextColor(paramambg.jdField_b_of_type_Int);
      localadyo.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramambg.jdField_b_of_type_Int);
      localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramambg.jdField_b_of_type_Int);
      localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramambg.jdField_b_of_type_Int);
      ((Drawable)localObject).setColorFilter(new PorterDuffColorFilter(paramambg.jdField_b_of_type_Int, PorterDuff.Mode.SRC_ATOP));
      localadyo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      break label408;
      label750:
      localadyo.d.setLinkTextColor(paramambg.jdField_c_of_type_Int);
      localadyo.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramambg.jdField_c_of_type_Int);
      localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramambg.jdField_c_of_type_Int);
    }
  }
  ...
  public void a(View paramView)
  {
    ...
    {
      return;
      paramView = (MessageForReplyText)actj.a(paramView);
    ...
    bbdj.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new adyl(this, paramView), new adym(this)).show();
  }
  
  public void a(View paramView, ChatMessage paramChatMessage)
  {
    paramView = (adyo)paramView.getTag();
    MessageForReplyText localMessageForReplyText = (MessageForReplyText)paramChatMessage;
    int i = actj.a(1.0F, paramView.jdField_a_of_type_AndroidWidgetTextView.getResources());
    if (localMessageForReplyText.mSourceMsgInfo == null) {
      return;
    }
    int j = localMessageForReplyText.mSourceMsgInfo.mType;
    j = BaseChatItemLayout.d - actj.a(16.0F, paramView.jdField_a_of_type_AndroidWidgetTextView.getResources());
    if (paramChatMessage.isSend())
    {
    ...
    for (;;)
    {
      ...
      f = actj.a(37.0F, paramView.jdField_a_of_type_AndroidWidgetTextView.getResources()) + f;
      paramView.jdField_a_of_type_AndroidWidgetTextView.setMaxWidth(i - (int)f);
      paramChatMessage = (String)paramView.jdField_a_of_type_AndroidWidgetTextView.getTag(2131376861);
      paramChatMessage = aylc.a(paramView.jdField_a_of_type_AndroidWidgetTextView, paramChatMessage, i - (int)f);
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, acuj paramacuj, int paramInt1, int paramInt2)
  {
    ...
    paramChatMessage = bbef.a(paramacuj.a.getBackground());
    if (paramChatMessage == null)
    {
      ...
      if ((paramacuj instanceof adyo)) {
        ((adyo)paramacuj).jdField_a_of_type_AndroidViewViewGroup.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838090));
      }
    }
    label254:
    while (!(paramacuj instanceof adyo))
    {
      return;
    ...
    ((adyo)paramacuj).jdField_a_of_type_AndroidViewViewGroup.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838091));
  }
  ...
  public void b(acuj paramacuj, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(paramChatMessage.sb)) {
          paramacuj = paramChatMessage.sb;
        }
      } while ((paramacuj == null) || (!(paramacuj instanceof aykk)));
      paramChatMessage = (aykk)paramacuj;
      paramacuj = (aykr[])paramChatMessage.getSpans(0, paramacuj.length(), aykr.class);
    } while ((paramacuj.length <= 0) || (paramChatMessage.b().length() != 0));
    ...
    localadyo.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setText(paramChatMessage);
  }
}
