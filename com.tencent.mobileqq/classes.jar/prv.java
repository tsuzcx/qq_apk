...
public class prv
  extends pqt
{
  public prv(Context paramContext, baxk parambaxk, rap paramrap)
  {
  ...
  public pqt d()
  {
    ...
    if ((this.jdField_a_of_type_Pqs != null) && ((this.jdField_a_of_type_Pqs instanceof ComponentContentGallery))) {
      localLinearLayout.addView((ComponentContentGallery)this.jdField_a_of_type_Pqs);
    }
  ...
  public pqt g()
  {
    this.jdField_a_of_type_Pqs = new ComponentContentGallery(this.jdField_a_of_type_AndroidContentContext);
    return this;
  }
  ...
  public pqt o()
  {
    ...
    if ((this.jdField_a_of_type_Pqs != null) && ((this.jdField_a_of_type_Pqs instanceof ComponentContentGallery)))
    {
      ((ComponentContentGallery)this.jdField_a_of_type_Pqs).setAdapter(this.jdField_a_of_type_Rap);
      ((ComponentContentGallery)this.jdField_a_of_type_Pqs).setPosition(this.jdField_a_of_type_Int);
    }
    return this;
  }
}
