...
public class bgph
{
  ...
  private static bgph jdField_a_of_type_Bgph;
  ...
  public static bgph a()
  {
    if (jdField_a_of_type_Bgph == null) {}
    try
    {
      if (jdField_a_of_type_Bgph == null) {
        jdField_a_of_type_Bgph = new bgph();
      }
      return jdField_a_of_type_Bgph;
    }
    finally {}
  }
  ...
  public void a(bgpm parambgpm)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambgpm.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bgpi(this, parambgpm));
  }
  ...
  public void b(bgpm parambgpm)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambgpm.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bgpj(this, parambgpm));
  }
}
