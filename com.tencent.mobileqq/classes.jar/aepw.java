...
public class aepw
{
  public static void a(PlusPanel paramPlusPanel, aeox paramaeox)
  {
  ...
  public static boolean a(TroopAIOAppInfo paramTroopAIOAppInfo, BaseChatPie paramBaseChatPie, aeox paramaeox)
  {
    if ((paramTroopAIOAppInfo != null) && (paramBaseChatPie != null) && (MiniAppLauncher.isMiniAppUrl(paramTroopAIOAppInfo.url)))
    {
      a(paramBaseChatPie.a(), paramTroopAIOAppInfo.url, paramBaseChatPie, paramaeox);
      return true;
    }
    return false;
  }
  
  private static void b(PlusPanel paramPlusPanel, aeox paramaeox)
  {
    if (paramaeox.a >= 0) {}
    do
    {
      ...
      do
      {
        ...
        if (paramPlusPanel.jdField_a_of_type_AndroidUtilSparseArray != null) {
          localObject = (TroopAIOAppInfo)paramPlusPanel.jdField_a_of_type_AndroidUtilSparseArray.get(paramaeox.b);
        }
      } while ((localObject == null) || (((TroopAIOAppInfo)localObject).url == null));
      paramaeox = ((TroopAIOAppInfo)localObject).url.replace("$UIN$", paramPlusPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).replace("$GCODE$", paramPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a).replace("$APPID$", String.valueOf(paramaeox.b));
      int j = 0;
      int i = j;
      try
      {
        if (TextUtils.equals(new URI(paramaeox).getScheme(), "mqqapi"))
        {
          localObject = bdds.a(paramPlusPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), paramaeox);
          i = j;
          if (localObject != null)
          {
            ((bddb)localObject).c();
    ...
    ((Intent)localObject).putExtra("url", paramaeox);
    ((Intent)localObject).putExtra("selfSet_leftViewText", alpo.a(2131716095));
