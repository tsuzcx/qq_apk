  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, j, bool1, localBundle, bnax.class);
      return;
      ...
      if (((MqqLbsPack.RspGetPOIList)localObject).msg_head.has())
      {
        ...
        if (k != 0) {
          bnaz.a("actLbsSendPoiListFailure", k);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          bnaz.a("actLbsSendPoiListFailure");
        }
        ...
        if (((MqqLbsPack.RspOpenLBSRPReport)localObject).msg_head.has())
        {
          ...
          if (paramFromServiceMsg != null)
          {
            ...
            if (((MqqLbsPack.RspGetLBSPID)localObject).msg_head.has())
            {
              ...
              bnaz.a("actLbsSendGetPidFailure");
            }
            for (;;)
            {
              localBundle.putInt("key_receive_result", k);
              ...
              break;
              bnaz.a("actLbsSendGetPidFailure", k);
            }
            ...
            default: 
              break;
            case 1: 
              bnaz.a("actLbsSendPoiListFailure", -10006);
              break;
            case 2: 
              break;
            case 3: 
              bnaz.a("actLbsSendGetPidFailure", -10006);
              break;
            case 4: 
              if (QLog.isColorLevel())
              {
