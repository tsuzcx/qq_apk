  ...
  implements Manager
{
  ...
  private axvs jdField_a_of_type_Axvs = new axvq(this);
  ...
  private ArrayList<WeakReference<axvr>> jdField_a_of_type_JavaUtilArrayList;
  private List<Integer> jdField_a_of_type_JavaUtilList;
  
  public axvp(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.registObserver(this.jdField_a_of_type_Axvs);
  ...
  private Pair<Boolean, List<Integer>> a(List<Integer> paramList)
  {
    ...
    List localList = ((apzf)apub.a().a(652)).a.a(false);
    if (localList.size() <= 0)
    {
      localArrayList.addAll(paramList);
      return new Pair(Boolean.valueOf(false), localArrayList);
    ...
    if (paramList.hasNext())
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (localInteger.intValue() != localaxyc.a) {
          break label208;
        }
  ...
  /* Error */
  private void a(axvr paramaxvr)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 42	axvp:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   71: return
    //   72: aload_0
    //   73: getfield 42	axvp:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  private void b()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (axvr)((WeakReference)localObject2).get();
          ((axvr)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem, a());
          if (QLog.isColorLevel()) {
  ...
  public OnlineStatusFriendsPermissionItem a(long paramLong, boolean paramBoolean, axvr paramaxvr)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iconst_3
    //   37: aload_0
    //   38: getfield 22	axvp:jdField_a_of_type_Int	I
    ...
    //   61: aload_0
    //   62: getfield 52	axvp:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   65: ifnull +14 -> 79
    //   68: aload_0
    //   69: getfield 52	axvp:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   72: astore 4
    //   74: aload_0
    //   75: monitorexit
    //   76: aload 4
    ...
    //   106: aload_0
    //   107: aload 4
    //   109: invokespecial 297	axvp:a	(Laxvr;)V
    //   112: iload_3
    //   113: ifeq +9 -> 122
    //   116: aload_0
    //   117: lload_1
    //   118: iconst_0
    //   119: invokevirtual 300	axvp:a	(JZ)V
    //   122: aconst_null
    //   123: astore 4
    //   125: goto -51 -> 74
    //   128: astore 4
  ...
  {
    axvt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong, paramBoolean, false);
  }
  ...
  public boolean a(OnlineStatusPermissionChecker.OnlineStatusPermissionItem paramOnlineStatusPermissionItem, axvr paramaxvr)
  {
    ...
    do
    {
      ...
      {
        return false;
        paramaxvr = a(40001L, false, paramaxvr);
        if (paramaxvr != null) {
          break;
        }
      ...
      return false;
      if (paramaxvr.allHasPermission != paramOnlineStatusPermissionItem.isAllHasPermission())
      {
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusPermissionManager", 2, new Object[] { " hasPermissionChange entity.allHasPermission=", Boolean.valueOf(paramaxvr.allHasPermission), " item.isAllHasPermission=", paramOnlineStatusPermissionItem.getPermissionUins() });
        }
        return true;
      }
      if (paramaxvr.permissionUins.size() != paramOnlineStatusPermissionItem.getPermissionUins().size())
      {
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusPermissionManager", 2, new Object[] { " hasPermissionChange entity.size=", Integer.valueOf(paramaxvr.permissionUins.size()), " item.size=", Integer.valueOf(paramOnlineStatusPermissionItem.getPermissionUins().size()) });
        }
        return true;
      }
    } while (paramaxvr.permissionUins.containsAll(paramOnlineStatusPermissionItem.getPermissionUins()));
    if (QLog.isColorLevel()) {
  ...
  public boolean a(ArrayList<axvj> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        axvj localaxvj = (axvj)paramArrayList.next();
        Iterator localIterator = localList.iterator();
        ...
        } while (localaxvj.a != localInteger.intValue());
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
