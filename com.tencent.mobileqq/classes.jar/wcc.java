  ...
  implements Runnable
{
  ...
  public wcc(BlessResultActivity paramBlessResultActivity, String paramString1, String paramString2, BlessResultActivity.VideoInfo paramVideoInfo, TroopBarShortVideoUploadUtil.OnUploadVideoListener paramOnUploadVideoListener)
  {
    this.c = paramString1;
    this.d = paramString2;
    ...
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = paramBlessResultActivity.getString(2131429276);
    }
    if (this.b == null) {
      this.b = paramBlessResultActivity.getString(2131438271);
    }
  }
  ...
  public void run()
  {
    ...
    //   19: aload_0
    //   20: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_0
    //   24: invokevirtual 71	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: aload_0
    //   28: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   31: ifnonnull +26 -> 57
    //   34: aload_0
    //   35: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   38: iconst_1
    ...
    //   56: return
    //   57: aload_0
    //   58: getfield 40	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity$VideoInfo	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity$VideoInfo;
    //   61: ifnull +23 -> 84
    //   64: aload_0
    //   65: getfield 36	wcc:c	Ljava/lang/String;
    //   68: invokestatic 115	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   71: ifne +13 -> 84
    //   74: aload_0
    //   75: getfield 38	wcc:d	Ljava/lang/String;
    //   78: invokestatic 115	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   81: ifeq +96 -> 177
    //   84: aload_0
    //   85: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   88: iconst_1
    //   89: invokevirtual 71	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   92: aload_0
    //   93: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   96: ldc2_w 31
    //   99: invokeinterface 120 3 0
    //   104: invokestatic 61	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   107: ifeq -51 -> 56
    //   110: aload_0
    //   111: getfield 40	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity$VideoInfo	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity$VideoInfo;
    ...
    //   152: return
    //   153: aload_0
    //   154: getfield 36	wcc:c	Ljava/lang/String;
    ...
    //   178: istore 10
    //   180: aload_0
    //   181: getfield 40	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity$VideoInfo	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity$VideoInfo;
    ...
    //   192: dup
    //   193: aload_0
    //   194: getfield 40	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity$VideoInfo	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity$VideoInfo;
    ...
    //   219: ldc 146
    //   221: aload_0
    //   222: getfield 44	wcc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   239: ldc 154
    //   241: aload_0
    //   242: getfield 53	wcc:b	Ljava/lang/String;
    ...
    //   259: ldc 158
    //   261: aload_0
    //   262: getfield 40	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity$VideoInfo	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity$VideoInfo;
    ...
    //   277: ifeq +1115 -> 1392
    //   280: aload_0
    //   281: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   284: invokevirtual 74	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   287: ifne +1105 -> 1392
    //   290: aload 13
    //   292: aload_0
    //   293: getfield 36	wcc:c	Ljava/lang/String;
    //   296: aload_0
    //   297: getfield 38	wcc:d	Ljava/lang/String;
    //   300: ldc 172
    //   302: iconst_0
    ...
    //   391: ifeq +170 -> 561
    //   394: aload_0
    //   395: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   398: lload_2
    //   399: l2d
    //   400: ldc2_w 201
    //   403: dmul
    ...
    //   410: aload_0
    //   411: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   414: invokevirtual 74	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   417: ifne +969 -> 1386
    //   420: aload 15
    //   422: aload_0
    //   423: getfield 20	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity;
    //   426: getfield 205	com/tencent/mobileqq/activity/bless/BlessResultActivity:b	Ljava/lang/String;
    //   429: aload_0
    //   430: getfield 36	wcc:c	Ljava/lang/String;
    //   433: aload_0
    //   434: getfield 38	wcc:d	Ljava/lang/String;
    //   437: aload 14
    ...
    //   463: ifeq +17 -> 480
    //   466: aload_0
    //   467: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   470: lload_2
    //   471: invokeinterface 204 3 0
    //   476: iload 11
    //   478: istore 10
    //   480: aload_0
    //   481: getfield 20	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity;
    //   484: aload 14
    ...
    //   492: aload_0
    //   493: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   496: iconst_0
    //   497: iconst_1
    ...
    //   506: ifeq +743 -> 1249
    //   509: aload_0
    //   510: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    ...
    //   674: aload_0
    //   675: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    ...
    //   720: astore 12
    //   722: aload_0
    //   723: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   758: aload_0
    //   759: lload 4
    //   761: putfield 34	wcc:jdField_a_of_type_Long	J
    //   764: lload 4
    //   766: ldc2_w 31
    //   769: lcmp
    //   770: ifeq +233 -> 1003
    ...
    //   775: astore 12
    //   777: aload_0
    //   778: invokevirtual 76	wcc:a	()Z
    //   781: ifne +617 -> 1398
    //   784: aload 13
    //   786: astore 12
    //   788: aload_0
    //   789: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   792: lload 4
    //   794: l2d
    //   795: ldc2_w 201
    //   798: dmul
    ...
    //   856: astore 12
    //   858: aload_0
    //   859: getfield 30	wcc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   872: aload 15
    //   874: aload_0
    //   875: getfield 20	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity;
    //   878: getfield 205	com/tencent/mobileqq/activity/bless/BlessResultActivity:b	Ljava/lang/String;
    //   881: aload_0
    //   882: getfield 36	wcc:c	Ljava/lang/String;
    //   885: aload_0
    //   886: getfield 38	wcc:d	Ljava/lang/String;
    //   889: aload 14
    ...
    //   920: astore 12
    //   922: aload_0
    //   923: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   926: lload_2
    ...
    //   938: astore 12
    //   940: aload_0
    //   941: getfield 20	wcc:jdField_a_of_type_ComTencentMobileqqActivityBlessBlessResultActivity	Lcom/tencent/mobileqq/activity/bless/BlessResultActivity;
    //   944: aload 14
    ...
    //   1246: goto -22 -> 1224
    //   1249: aload_0
    //   1250: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   1253: aload_0
    //   1254: getfield 34	wcc:jdField_a_of_type_Long	J
    ...
    //   1299: return
    //   1300: aload_0
    //   1301: getfield 42	wcc:jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarShortVideoUploadUtil$OnUploadVideoListener	Lcom/tencent/mobileqq/troop/data/TroopBarShortVideoUploadUtil$OnUploadVideoListener;
    //   1304: aload_0
    //   1305: getfield 34	wcc:jdField_a_of_type_Long	J
