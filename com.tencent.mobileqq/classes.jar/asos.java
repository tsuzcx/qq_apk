...
public class asos
{
  ...
  public static String m = antf.cx + "[epId]" + File.separator;
  public static String n = antf.bV + "[epId]" + File.separator;
  ...
  public static axfj a()
  {
    try
    {
      ...
      if (localAppInterface != null) {
        return (axfj)localAppInterface.getManager(14);
      }
    }
  ...
  public static String a(asmu paramasmu)
  {
    if ((paramasmu instanceof assj)) {
      if (((assj)paramasmu).a == 1) {
        paramasmu = asle.a(((assj)paramasmu).b);
      }
    }
    for (;;)
    {
      Object localObject = paramasmu;
      if (paramasmu != null)
      {
        localObject = paramasmu;
        if (paramasmu.length() > 1)
        {
          localObject = paramasmu;
          if (paramasmu.startsWith("/")) {
            localObject = paramasmu.substring(1);
          }
        }
      }
      return localObject;
      if (((assj)paramasmu).a == 2)
      {
        paramasmu = askx.a(((assj)paramasmu).b);
        continue;
        return "";
      }
      else
  ...
  public static List<aspt> a(QQAppInterface paramQQAppInterface)
  {
    ArrayList localArrayList1 = new ArrayList();
    ardw localardw = ardv.a();
    if ((localardw != null) && (!localardw.b.isEmpty()))
    {
      ...
      localArrayList1.addAll(a(paramQQAppInterface, localardw.b, localArrayList2, 0, false));
      return localArrayList1;
    }
    localArrayList1.add(new aspt(7, 7, null));
    localArrayList1.add(new aspt(4, 4, null));
    localArrayList1.add(new aspt(12, 4, null));
    localArrayList1.add(new aspt(11, 4, null));
    return localArrayList1;
  }
  
  public static List<aspt> a(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    List localList2 = Collections.synchronizedList(new ArrayList());
    List localList1 = ((axfj)paramQQAppInterface.getManager(14)).a(paramInt);
    Object localObject = ardv.a();
    label91:
    EmoticonPackage localEmoticonPackage;
    label175:
    int i1;
    if ((localObject != null) && (!((ardw)localObject).b.isEmpty()))
    {
      localList2.addAll(a(paramQQAppInterface, ((ardw)localObject).b, null, paramInt, paramBoolean));
      if (localList1 == null) {
        break label397;
      }
      ...
      paramQQAppInterface = new aspt(10, 7, localEmoticonPackage);
      i1 = paramInt;
    ...
    {
      asop.a(paramQQAppInterface, bool);
      paramInt = i1;
      break label91;
      ...
      paramQQAppInterface = new aspt(6, 4, localEmoticonPackage);
      break label175;
      label340:
      ...
      localList2.add(new aspt(9, 4, localEmoticonPackage));
      i1 = 1;
      break label192;
    }
    label397:
  ...
  public static List<aspt> a(QQAppInterface paramQQAppInterface, List<String> paramList1, List<String> paramList2, int paramInt, boolean paramBoolean)
  {
    ...
    while (paramList1.hasNext())
    {
      ...
      if ((paramList2 == null) || (paramList2.contains(localObject))) {
        ...
        {
          if (paramInt == 0) {
            localArrayList.add(new aspt(4, 4, null));
          }
        }
        else if ("hotpic".equals(localObject))
        {
          if (paramInt == 0) {
            localArrayList.add(new aspt(12, 4, null));
          }
        }
        else if ("camera".equals(localObject))
        {
          localObject = (asfy)paramQQAppInterface.getManager(334);
          if ((localObject != null) && (((asfy)localObject).c())) {
            localArrayList.add(new aspt(11, 4, null));
          }
        }
        else if ("recommend".equals(localObject))
        {
          localObject = ((axfj)paramQQAppInterface.getManager(14)).a(false, paramInt, paramBoolean);
          if ((localObject != null) && (((List)localObject).size() > 0)) {
            localArrayList.add(new aspt(8, 3, null));
          }
        }
      }
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        bdll.b(paramQQAppInterface, "dc00898", "", "", "0X800AEE5", "0X800AEE5", paramInt, 0, "", "", paramString1, paramString2);
        return;
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt)
  {
    ...
    {
      paramQQAppInterface = (askd)paramQQAppInterface.getManager(43);
  ...
  public static void a(begw[] paramArrayOfbegw, float paramFloat1, float paramFloat2, boolean paramBoolean1, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Activity paramActivity, boolean paramBoolean2)
  {
    if ((paramArrayOfbegw == null) || (paramQQAppInterface == null) || (paramSessionInfo == null) || (paramActivity == null)) {}
    Object localObject1;
    int i2;
    do
    {
      ...
      i2 = paramInt1;
      paramInt1 = i1;
      while (paramInt1 < paramArrayOfbegw.length)
      {
        Object localObject2 = paramArrayOfbegw[paramInt1];
        boolean bool = paramBoolean1;
        int i3 = i2;
        i1 = paramInt2;
        if ((localObject2 instanceof begy))
        {
          localObject2 = (begy)localObject2;
          float f1 = ((begy)localObject2).a;
          float f2 = ((begy)localObject2).b;
          float f3 = ((begy)localObject2).c;
          float f4 = ((begy)localObject2).d;
          int i4 = ((begy)localObject2).e;
          int i5 = ((begy)localObject2).f;
    ...
    {
      ((axfj)paramQQAppInterface.getManager(14)).b(String.valueOf(i2), 0, new asot(paramSessionInfo, paramQQAppInterface, i2, paramActivity));
      return;
    }
    paramSessionInfo = ((TreeSet)localObject1).iterator();
    for (paramArrayOfbegw = ""; paramSessionInfo.hasNext(); paramArrayOfbegw = paramArrayOfbegw + localObject1 + ",") {
      localObject1 = (Integer)paramSessionInfo.next();
    }
    paramSessionInfo = paramArrayOfbegw;
    if (!paramArrayOfbegw.equals("")) {
      paramSessionInfo = paramArrayOfbegw.substring(0, paramArrayOfbegw.length() - 1);
    }
    EmojiHomeUiPlugin.openSmallEmojiListPage(paramActivity, paramQQAppInterface.getAccount(), 11, paramSessionInfo);
    bdll.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X8007000", 0, 0, String.valueOf(i2), String.valueOf(paramInt2), "", "");
  }
  
  public static boolean a()
  {
    int i1 = bhnv.a(BaseApplication.getContext());
  ...
  public static boolean a(BaseChatPie paramBaseChatPie, asmu paramasmu)
  {
    if ((paramasmu == null) || (paramBaseChatPie == null)) {}
    while (paramasmu.c != 7) {
      return false;
    }
    return true;
  ...
  public static List<aspt> b(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    paramQQAppInterface.add(new aspt(7, 7, null));
    return paramQQAppInterface;
  }
  
  public static boolean b()
  {
    return bhnv.a(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean c()
  {
    ...
    int i1 = bhnv.a(localBaseApplication);
    boolean bool = SettingCloneUtil.readValue(localBaseApplication, null, localBaseApplication.getString(2131694443), "qqsetting_auto_receive_magic_face_key", true);
