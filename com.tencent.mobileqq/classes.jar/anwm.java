...
public class anwm
{
  public static String a(QQAppInterface paramQQAppInterface, bbwu parambbwu, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambbwu == null)) {}
    EmoticonPackage localEmoticonPackage;
    do
    {
      return null;
      localObject = parambbwu.a();
      localEmoticonPackage = (EmoticonPackage)((Bundle)localObject).getSerializable("emoticonPackage");
    } while (localEmoticonPackage == null);
    int i = ((Bundle)localObject).getInt("jsonType", anvx.c);
    File localFile = (File)parambbwu.jdField_a_of_type_JavaUtilMap.get(parambbwu.jdField_a_of_type_JavaLangString);
    Object localObject = new anwv();
    parambbwu = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambbwu = bbdx.a(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambbwu, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambbwu, localArrayList, (anwv)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList)
  {
    ...
    askf localaskf = (askf)paramQQAppInterface.getManager(14);
    Object localObject1;
    Object localObject2;
    String str1;
    try
    ...
    catch (JSONException paramQQAppInterface)
    {
      for (;;)
      {
        ...
        paramArrayOfByte = localaskf.b(paramEmoticonPackage.epId);
    ...
    localaskf.a(paramEmoticonPackage);
    if (QLog.isColorLevel()) {
    ...
    if (j < m)
    {
      ...
      paramQQAppInterface = localaskf.a(str1, (String)localObject1);
      if (paramQQAppInterface == null)
      {
        if (paramInt == anvx.d) {
          break label1013;
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, anwv paramanwv)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramanwv == null))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayOfByte.has("type")) && (1 == j))
    {
      ...
      if (paramEmoticonPackage.copywritingType != aske.a)
      {
      ...
      paramQQAppInterface = localaskf.b(str1);
      if (paramQQAppInterface != null)
      {
      ...
      if ((paramEmoticonPackage.mobileFeetype == 1) || ((str1 != null) && ("10278".equals(str1))) || (paramEmoticonPackage.jobType == 1))
      {
        ...
        localObject2 = localaskf.a(str1, str2);
