...
public class anwm
{
  ...
  public final ConcurrentHashMap<Integer, HashMap<String, anxt>> a;
  public final CopyOnWriteArrayList<anyh> a;
  ...
  public static anwm a()
  {
    if (jdField_a_of_type_Anwm == null) {}
    try
    {
      if (jdField_a_of_type_Anwm == null) {
        jdField_a_of_type_Anwm = new anwm();
      }
      return jdField_a_of_type_Anwm;
    }
    finally {}
  }
  
  public Bitmap a(anyh paramanyh, anxu paramanxu)
  {
    if ((paramanyh == null) || (paramanxu == null)) {
      return null;
    }
    paramanyh = "BubbleDiyFetcher_" + paramanxu.jdField_a_of_type_Int + "_" + paramanxu.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramanxu = (Bitmap)BaseApplicationImpl.sImageCache.get(paramanyh);
    if (paramanxu != null)
    {
      this.c.remove(paramanyh);
      return paramanxu;
    }
    this.c.add(paramanyh);
    paramanyh = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramanyh instanceof QQAppInterface)) {
      a((QQAppInterface)paramanyh, 500);
    }
    return null;
  }
  
  public String a(anyh paramanyh, String paramString)
  {
    Object localObject;
    if ((paramanyh == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramanyh);
    paramanyh = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramanyh instanceof QQAppInterface)) {
      a((QQAppInterface)paramanyh, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localanyh != null) && (localanyh.getCallback() != null) && (a(localanyh.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localanyh.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, alpg paramalpg)
  {
    ...
    ((anwn)paramQQAppInterface.a(70)).a((List)localObject, paramalpg);
  }
  ...
  public Bitmap b(anyh paramanyh, anxu paramanxu)
  {
    if ((paramanyh == null) || (paramanxu == null) || (TextUtils.isEmpty(paramanyh.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramanyh.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramanyh.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramanxu.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramanxu.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramanyh.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramanxu.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramanxu = "BubbleDiyFetcher_" + paramanxu.jdField_a_of_type_Int + "_" + paramanxu.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramanxu);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramanxu);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramanxu);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramanxu);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramanyh.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramanyh.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        BubbleDiyEntity localBubbleDiyEntity = (BubbleDiyEntity)((awgf)localObject2).a(BubbleDiyEntity.class, (String)((ArrayList)localObject1).get(i));
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = bdal.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (anxt)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = bdal.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
