  ...
  extends ClickableSpan
{
  ...
  amda(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (int j = -1; i < paramArrayOfHotWordItem.length; j = k)
      {
        ...
        if (j != str.length())
        {
          ...
          localSpannableStringBuilder.setSpan(new amda(paramQQAppInterface, paramArrayOfHotWordItem[i].hotWord), str.length(), k, 33);
          if (paramQQAppInterface != null) {
            axqy.b(paramQQAppInterface, "P_CliOper", "aio_search", "", "aio_hotword", "view_hotword", 0, 0, "", "", paramArrayOfHotWordItem[i].hotWord, "");
          }
        }
        i += 1;
      }
  ...
  private void a(Context paramContext)
  {
    ...
    localbfpc.a(2131697536, 5);
    localbfpc.c(2131690596);
    localbfpc.a(new amdb(this, paramContext, localbfpc));
  ...
  public void onClick(View paramView)
  {
    ...
    axqy.b((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), "P_CliOper", "aio_search", "", "aio_hotword", "click_hotword", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, "");
  }
