...
public class uil
{
  ...
  private static WXShareHelper.WXShareListener jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener = new uim();
  private static String jdField_a_of_type_JavaLangString;
  
  public static void a()
  {
    WXShareHelper.getInstance().addObserver(jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener);
  }
  ...
  public static void b()
  {
    ...
    WXShareHelper.getInstance().removeObserver(jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener);
  }
  ...
  public static void b(Activity paramActivity)
  {
    ...
    for (;;)
    {
      if (i != -1)
      {
        QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getString(i), 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299076));
        return;
  ...
  private static void d()
  {
    ...
    if (FileUtils.saveBitmapToFile(jdField_a_of_type_AndroidGraphicsBitmap, str))
    {
      ...
      bfvo.a(BaseApplicationImpl.getContext(), str);
      str = BaseApplicationImpl.getContext().getString(2131694485) + " " + str;
