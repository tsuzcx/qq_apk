...
public class bpxx
  extends QIPCModule
{
  private static bpxx a;
  
  private bpxx(String paramString)
  {
    super(paramString);
  }
  
  /* Error */
  public static bpxx a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bpxx:a	Lbpxx;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bpxx:a	Lbpxx;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bpxx
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bpxx:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bpxx:a	Lbpxx;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bpxx:a	Lbpxx;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_start_send".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        localObject1 = bcwu.a(3, 0);
        localObject2 = bcwu.a(0, paramBundle, (bcxn)localObject1);
        ((bcwz)localObject2).c = true;
        ((bcxn)localObject1).a((bcwz)localObject2);
        bcwu.a((bcxn)localObject1, paramString);
      }
      if (QLog.isColorLevel())
      {
    ...
    if ("action_cancel_send".equals(paramString))
    {
      ...
      if (localObject1 != null)
      {
        ...
        label350:
        if ((!(paramString instanceof bexd)) || (((bexd)paramString).h)) {
          break label570;
        }
        ((bexd)paramString).c();
        bool1 = true;
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        bbnr.a(paramBundle, (String)localObject2, l2);
        bool2 = bool3;
        if (localObject1 != null) {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        for (;;)
        {
          for (;;)
          {
            ...
            break label350;
            label570:
            if (((paramString instanceof besa)) && (!((besa)paramString).b))
            {
              ((besa)paramString).c();
              bool1 = true;
              paramString = "C2CPic";
            ...
            if ((!(paramString instanceof betv)) || (((betv)paramString).b)) {
              break label1832;
            }
            ((betv)paramString).c();
            bool1 = true;
            ...
            if ("action_re_send".equals(paramString))
            {
              ...
              if ((paramBundle instanceof MessageForShortVideo))
              {
                ...
                if ((bhmi.b(ShortVideoUtils.a(((MessageForShortVideo)localObject1).thumbMD5, "jpg"))) && (!TextUtils.isEmpty(((MessageForShortVideo)localObject1).videoFileName)) && (((MessageForShortVideo)localObject1).isStoryVideo))
                {
                  ((bbnr)paramString.getManager(326)).a(((MessageForShortVideo)localObject1).frienduin, (MessageRecord)localObject1, ((MessageForShortVideo)localObject1).videoFileName);
                  localObject1 = bcwu.a(4, 0);
                  localObject2 = bcwu.a(0, paramBundle, (bcxn)localObject1);
                  ((bcwz)localObject2).c = true;
                  ((bcxn)localObject1).a((bcwz)localObject2);
                  bcwu.a((bcxn)localObject1, paramString);
              ...
              for (paramString = paramBundle.toString();; paramString = "")
              {
                ...
                bool1 = bool2;
                if (!bhmi.b(((MessageForPic)localObject1).path)) {
                  break label1014;
                }
                bool1 = bool2;
                ...
                localObject2 = new azqu();
                ((azqu)localObject2).a(((MessageForPic)localObject1).path);
                ((azqu)localObject2).d(5);
                ((azqu)localObject2).d(((MessageForPic)localObject1).frienduin);
                if (((MessageForPic)localObject1).fileSizeFlag == 1) {
                  ((azqu)localObject2).c(beya.e);
                }
                for (;;)
                {
                  ((azqu)localObject2).e(((MessageForPic)localObject1).senderuin);
                  ((azqu)localObject2).c(((MessageForPic)localObject1).selfuin);
                  ((azqu)localObject2).e(((MessageForPic)localObject1).istroop);
                  ((azqu)localObject2).l(((MessageForPic)localObject1).getConfessTopicId());
                  ((azqu)localObject2).jdField_i_of_type_Int = ((MessageForPic)localObject1).extLong;
                  ((azqu)localObject2).jdField_i_of_type_JavaLangString = ((MessageForPic)localObject1).extStr;
                  ((azqu)localObject2).b(true);
                  localObject3 = new azqv();
                  ((azqv)localObject3).a = ((MessageForPic)localObject1).msgseq;
                  ((azqv)localObject3).b = ((MessageForPic)localObject1).shmsgseq;
                  ((azqv)localObject3).c = ((MessageForPic)localObject1).msgUid;
                  ((azqu)localObject2).a((azqv)localObject3);
                  ((azqu)localObject2).b(((MessageForPic)localObject1).uniseq);
                  ((bbnr)paramString.getManager(326)).a(((MessageForPic)localObject1).frienduin, ((MessageForPic)localObject1).uniseq);
                  localObject3 = azqb.a(4, 5);
                  ((azqk)localObject3).a(((azqu)localObject2).a());
                  ((azqk)localObject3).a = ((MessageForPic)localObject1).picExtraData;
                  azqb.a((azqk)localObject3, paramString);
                  bool1 = true;
                  break;
                  ((azqu)localObject2).c(beya.d);
                }
              }
            }
        ...
        if ("action_get_name".equals(paramString))
        {
          ...
          try
          {
            paramString = bhlg.b((QQAppInterface)localObject1, paramString);
            localBundle.putBoolean("key_result", true);
            localBundle.putString("uinname", paramString);
            paramString = EIPCResult.createSuccessResult(localBundle);
            return paramString;
