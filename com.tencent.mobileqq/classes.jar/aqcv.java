  ...
  extends aomz
{
  ...
  ArrayList<aqcx> jdField_a_of_type_JavaUtilArrayList;
  private Comparator<ColorNote> jdField_a_of_type_JavaUtilComparator = new aqcw(this);
  ...
  public aqcv(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  private void a(int paramInt, ColorNote paramColorNote)
  {
    ...
    if (i < j)
    {
      ...
      ((aqcx)localArrayList.get(i)).a(paramColorNote);
    }
    for (;;)
    {
      i += 1;
      ...
      label62:
      if (paramInt == 2) {
        ((aqcx)localArrayList.get(i)).b(paramColorNote);
      }
    }
  }
      ...
      try
      {
        ...
        if (!paramList.isEmpty())
        {
          ...
          if (i >= 0)
          {
            ...
            if ((localColorNote.isOpen()) && (!aqda.d(localColorNote))) {
              break label96;
            }
  ...
  protected void a()
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      aqfv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, false);
    }
    localObject = aqbz.a();
    if ((localObject != null) && (((aqby)localObject).a() != -1))
    {
      jdField_a_of_type_Int = ((aqby)localObject).a();
      if (QLog.isColorLevel()) {
        QLog.e("ColorNoteConfigProcessor", 2, "init MAX_COUNT " + jdField_a_of_type_Int);
      }
    }
    aqfv.a(BaseApplicationImpl.getContext(), 3, true);
  }
  ...
  public void a(aqcx paramaqcx)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramaqcx)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramaqcx);
    }
  }
  ...
  {
    boolean bool = false;
    if ((!a(paramColorNote)) && (aqfv.a())) {
      if (paramColorNote.getServiceType() == 16973824) {
        bcst.b(null, "dc00898", "", "", "0X800A746", "0X800A746", 0, 0, "", "", "", "");
      }
    }
    do
    {
    ...
    QLog.e("ColorNoteProxy", 2, "addColorNote error! isAfterSyncMsg = " + aqfv.a());
    return false;
  }
  ...
  public void b(aqcx paramaqcx)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaqcx);
    }
  }
