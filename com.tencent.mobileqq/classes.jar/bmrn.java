    ...
    if (!jdField_a_of_type_Boolean) {
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          bmqz.a(localBaseApplicationImpl, false);
          bmsd.a(localBaseApplicationImpl);
  ...
  public static void b()
  {
    if (jdField_a_of_type_Boolean) {
      try
      {
        if (jdField_a_of_type_Boolean)
        {
          bmqz.a(false, BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
