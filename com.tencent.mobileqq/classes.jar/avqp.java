  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject2 = paramView.getTag(2131311070);
    Object localObject3 = paramView.getTag(2131311071);
    ...
    if ((localObject2 instanceof String))
    {
      ...
      if ((localContext instanceof UniteSearchActivity))
      {
        ...
        default: 
          i = 0;
          avwf.a("all_result", "clk_relatedsearch_list", new String[] { "" + localObject3, ((UniteSearchActivity)localObject1).a + "", "" + avwc.a((String)localObject3, i) });
          paramView = (avnl)paramView.getTag(2131313373);
    ...
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject1).put("experiment_id", avsv.b);
        QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        ReportModelDC02528 localReportModelDC02528 = new ReportModelDC02528().module("all_result").action("clk_relatedsearch_list").obj1(paramView.d() + "").obj2(paramView.b).ver1(paramView.a()).ver2(avsv.a(paramView.a));
        if (localObject3 == null)
        {
          paramView = "";
          avsv.a(null, localReportModelDC02528.ver4(paramView).ver7(((JSONObject)localObject1).toString()).session_id(localQQAppInterface.getCurrentAccountUin() + avjb.a));
          localObject1 = avwc.e(i);
          ...
          paramView = avwc.a((String)localObject3, 3, paramView);
          if (QLog.isColorLevel()) {
      ...
      catch (JSONException localJSONException)
      {
        ...
        {
          localObject1 = bade.a(((BaseActivity)localContext).app, localContext, paramView);
