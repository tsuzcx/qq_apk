...
public class avqp
{
  private static avqp jdField_a_of_type_Avqp;
  ...
  public static avqp a()
  {
    try
    {
      if (jdField_a_of_type_Avqp == null) {
        jdField_a_of_type_Avqp = new avqp();
      }
      avqp localavqp = jdField_a_of_type_Avqp;
      return localavqp;
    }
    finally {}
  }
  
  public static void a(String paramString1, oeq paramoeq, String paramString2)
  {
    avqu.b(paramString1, paramString2);
    if (paramoeq != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ImaxAdvertisement", 2, "doDeleteItem bingo clearDistInfo  uin:" + paramString2);
      }
      paramString1 = paramoeq.a.iterator();
      while (paramString1.hasNext()) {
        avqv.b(((oer)paramString1.next()).b);
      }
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (localObject = null;; localObject = ((ProxyManager)localObject).a())
    {
      if (localObject != null)
      {
        RecentUser localRecentUser = (RecentUser)((aoxz)localObject).findRecentUserByUin(paramString, 10005);
        if (localRecentUser != null)
        {
          ...
          alik.b(paramQQAppInterface, paramString, 10005);
          paramQQAppInterface.getMessageFacade().setReaded(paramString, 10005);
        }
      }
      localObject = avqs.a().a(paramString);
      if (Looper.myLooper() != Looper.getMainLooper()) {
        break;
      }
      ThreadManager.executeOnFileThread(new ImaxAdDeleteManager.1(this, (oeq)localObject, paramQQAppInterface, paramString));
      return;
    }
    a(paramQQAppInterface.getCurrentUin(), (oeq)localObject, paramString);
  }
  ...
  {
    if (b(paramString2)) {}
    while (!TextUtils.isEmpty(avqu.a(paramString1, "delete_st_" + paramString2))) {
      return true;
    }
    return false;
  }
  ...
  public void c(String paramString)
  {
    ...
    {
      String str = (String)localIterator.next();
      long l = Long.valueOf(avqu.a(paramString, "delete_st_" + str)).longValue();
      if (NetConnInfoCenter.getServerTimeMillis() - l > 86400000L)
      {
        a(str);
        avqu.a(paramString, "delete_st_" + str);
      }
    }
    avqu.a(paramString, "delete_uin_list", a());
  }
}
