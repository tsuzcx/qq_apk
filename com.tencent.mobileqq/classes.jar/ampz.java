  ...
  extends BaseAdapter
{
  ...
  public ampz(Context paramContext, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetSquareImageView = ((SquareImageView)localView.findViewById(2131377771));
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131368686);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (amqa)paramView.getTag();
      localView = paramView;
