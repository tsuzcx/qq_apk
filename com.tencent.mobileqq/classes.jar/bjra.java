...
public class bjra
{
  ...
  private static boolean a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool4 = avte.a();
    boolean bool2 = a();
    if ((!bool3) || (!bool4) || (!bool2))
    {
      ved.b("CaptureUtils", "checkApiVersionDialog false");
      bbdj.a(paramContext, 230).setMessage(ajya.a(2131708738)).setPositiveButton(2131694794, new bjrb()).show();
      bool1 = true;
    }
    return bool1;
  }
  ...
  {
    return (ShortVideoUtils.a(paramAppInterface)) && (axle.a(BaseApplicationImpl.getContext()) == 1);
  }
}
