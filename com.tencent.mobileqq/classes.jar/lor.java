...
public class lor
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    //   191: aload_0
    //   192: iload_1
    //   193: invokestatic 164	lor:b	(Landroid/content/Context;I)I
    //   196: istore_2
    //   197: iload_2
    //   198: istore_1
    //   199: aload 5
  ...
  public static void a(long paramLong, Context paramContext, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (AudioHelper.e()) {
        QLog.w("SmallScreenUtils", 1, "actionOn isFloatWindowOpAllowed, isFloatWindowOpAllowed[" + c(paramContext) + "], isCalling[" + mhj.d(paramContext) + "], isHome[" + a(paramContext) + "], isNeedStartDialog[" + paramBoolean1 + "], seq[" + paramLong + "]");
      }
      if (a(paramContext, paramBoolean1, paramString, paramBoolean2)) {
        awqx.b(null, "CliOper", "", "", "0X80057D8", "0X80057D8", 0, 0, "", "", "", "");
      }
      return;
    }
  ...
  public static void a(Context paramContext, kvq paramkvq)
  {
    int i = paramkvq.jdField_d_of_type_Int;
    int j = paramkvq.C;
    int k = paramkvq.jdField_g_of_type_Int;
    if (QLog.isColorLevel())
    {
    ...
    if (paramkvq.jdField_a_of_type_Kvr.jdField_b_of_type_Int > 0) {
      if (paramkvq.jdField_a_of_type_Kvs.a > 0L) {
        paramkvq = "0X8005A49";
      }
    }
    for (;;)
    {
      if ((paramkvq != null) && (c(paramContext))) {
        awqx.b(null, "CliOper", "", "", paramkvq, paramkvq, 0, 0, "", "", "", "");
      }
      return;
      if (paramkvq.jdField_a_of_type_Kvr.jdField_b_of_type_Int == 5)
      {
        paramkvq = "0X8005A48";
      }
      else
  ...
  public static void a(View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramView != null)
    {
      localObject = paramView.getTag(2131306489);
      if (localObject != null) {
        break label190;
      }
      bool = false;
      ...
      localObject = paramView.getTag(2131306490);
      if (localObject != null) {
        break label203;
      }
      bool = false;
    ...
    for (Object localObject = new AlphaAnimation(0.0F, 1.0F);; localObject = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener(new los(paramView, paramBoolean1));
      paramView.startAnimation(localAnimationSet);
      paramView.setVisibility(0);
      paramView.setTag(2131306490, Boolean.valueOf(paramBoolean1));
      paramView.setTag(2131306489, Boolean.valueOf(paramBoolean2));
      return;
        ...
        if (paramVideoAppInterface.getApp() != null)
        {
          ...
          if (paramVideoAppInterface.a() != null)
          {
            ...
            if (paramVideoAppInterface.a().a() != null)
            {
              ...
              if ((((kvq)localObject).jdField_d_of_type_Int == 3) || (((kvq)localObject).jdField_d_of_type_Int == 4)) {
                str = String.valueOf(((kvq)localObject).jdField_g_of_type_Long);
              }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    {
      krx.e("SmallScreenUtils", paramContext.getMessage());
      return bool2;
    }
    return bool3;
  }
  ...
  public static boolean e(Context paramContext)
  {
    ...
    do
    {
      ...
      bool2 = mft.a(jdField_b_of_type_ArrayOfJavaLangString, paramContext.getClassName());
      bool1 = bool2;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  public static boolean f()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallpb.jdField_b_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
  ...
  public static boolean g()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallpb.jdField_d_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
