...
{
  public awzg(QQAppInterface paramQQAppInterface)
  {
        ...
        try
        {
          ...
          if (paramOIDBSSOPkg.get_decrypt_key_rsp.has())
          {
            ...
            if (((oidb_cmd0xcde.GetDecryptKeyRsp)localObject).dncrypt_key.has())
            {
              ...
              awzs.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localObject);
    ...
    try
    {
      ...
      if (paramOIDBSSOPkg.query_state_rsp.has())
      {
        ...
        if (paramOIDBSSOPkg.state.has())
        {
          ...
          ((axan)localObject).a(i);
          if (i == 2)
          {
            if (paramOIDBSSOPkg.token.has()) {
              ((axan)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.encrypt_key.has()) {
              ((axan)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.user_data.has()) {
              ((axan)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
            }
            if (paramOIDBSSOPkg.biz_type.has()) {
              ((axan)localObject).b(paramOIDBSSOPkg.biz_type.get());
            }
          }
        }
        notifyUI(4, true, ((axan)localObject).a());
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        ...
        try
        {
          ...
          if (paramOIDBSSOPkg.get_encrypt_key_rsp.has())
          {
            ...
            if (paramOIDBSSOPkg.encrypt_key.has())
            {
              ...
              awzs.jdField_a_of_type_JavaLangString = paramOIDBSSOPkg;
              if (QLog.isDevelopLevel()) {
  ...
  private void e(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new axad();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.ConfirmQrRsp)paramOIDBSSOPkg.confirm_qr_rsp.get();
          if (paramOIDBSSOPkg.token.has()) {
            ((axad)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((axad)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((axad)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((axad)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((axad)localObject).a();
          if (QLog.isColorLevel()) {
  ...
  private void f(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new axah();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.GetQrRsp)paramOIDBSSOPkg.get_qr_rsp.get();
          if (paramOIDBSSOPkg.qr_sig.has()) {
            ((axah)localObject).a(paramOIDBSSOPkg.qr_sig.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.token.has()) {
            ((axah)localObject).b(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((axah)localObject).c(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((axah)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((axah)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((axah)localObject).a();
          if (QLog.isColorLevel()) {
            QLog.d("MsgBackup.MsgBackupAuthHandler", 2, "processGetQrRsp getQrResponse= " + paramOIDBSSOPkg);
          }
          axct.a();
  ...
  public MsgBackupUserData a(oidb_cmd0xcdd.UserData paramUserData)
  {
    ...
    if (paramUserData.ip.has()) {
      localaxar.a(paramUserData.ip.get().toStringUtf8());
    }
    if (paramUserData.port.has()) {
      localaxar.a(paramUserData.port.get());
    }
    if (paramUserData.ssid.has()) {
      localaxar.b(paramUserData.ssid.get().toStringUtf8());
    }
    if (paramUserData.bssid.has()) {
      localaxar.c(paramUserData.bssid.get().toStringUtf8());
    }
    return localaxar.a();
  }
