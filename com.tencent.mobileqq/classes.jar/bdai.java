...
public class bdai
{
  ...
  public static void a(Activity paramActivity, String paramString, bdan parambdan)
  {
    ...
    paramActivity = bfur.a(paramActivity, 0, null, paramActivity.getString(2131718200), paramActivity.getString(2131690620), paramActivity.getString(2131690952), new bdal(parambdan), new bdam(parambdan));
    paramActivity.show();
    paramActivity.setCancelable(false);
    a("0X800A5C9");
  }
  
  public static void a(bdbp parambdbp)
  {
    if (b()) {
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    String str = localBaseActivity.getString(2131718203);
    if (!paramBoolean1) {
      str = localBaseActivity.getString(2131718199);
    }
    paramString1 = bfur.a(localBaseActivity, 0, null, str, localBaseActivity.getString(2131690620), localBaseActivity.getString(2131690952), new bdaj(paramBoolean1, paramBoolean2), new bdak(paramString1, paramString2));
    paramString1.show();
  ...
  public static boolean a(Activity paramActivity, String paramString, bdan parambdan)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing())) {}
    while (!b()) {
      return false;
    ...
    if ((paramActivity.getResources().getConfiguration().uiMode & 0x30) == 32)
    {
      ...
      a(paramActivity, paramString, parambdan);
    }
    for (;;)
    {
      return true;
      ...
      break;
      label141:
      ThreadManager.getUIHandler().post(new DarkModeManager.6(paramActivity, paramString, parambdan));
    }
  }
  ...
  private static void b(bdbp parambdbp)
  {
    Object localObject;
    if (bbyp.b()) {
    ...
    for (;;)
    {
      ...
      ThemeSwitcher.a((String)localObject, "202", parambdbp);
      return;
      localObject = bdbo.a(b());
  ...
  private static void b(boolean paramBoolean1, boolean paramBoolean2, bdbp parambdbp)
  {
