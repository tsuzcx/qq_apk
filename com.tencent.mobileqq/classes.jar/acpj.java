  ...
  implements Animator.AnimatorListener
{
  ...
  private acqj jdField_a_of_type_Acqj;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private LottieDrawable jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable;
  private String jdField_a_of_type_JavaLangString = "";
  
  public acpj(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Acqj = new acqj(paramContext);
    this.jdField_a_of_type_Acqj.a(new acpk(this));
  }
  ...
  public void a(acpy paramacpy)
  {
    ...
    this.jdField_a_of_type_JavaLangString = ascd.c();
    ...
    if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new acpl(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), localFileInputStream, new acpm(this));
      super.a(paramacpy);
      paramacpy.a(bool);
      return;
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Acqj != null)
    {
      this.jdField_a_of_type_Acqj.b();
      this.jdField_a_of_type_Acqj.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Acqj != null) && (this.jdField_a_of_type_Acqj.a())) {
      this.jdField_a_of_type_Acqj.d();
    }
  }
