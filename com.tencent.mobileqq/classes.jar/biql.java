  ...
  extends Drawable
{
  ...
  public biql(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_Bipz = new bipz();
  ...
  public Bitmap a()
  {
    return a(this.jdField_a_of_type_Bipz.a());
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofObject(this.jdField_a_of_type_Bipz, new Object[] { this.jdField_a_of_type_Bipz.b(), this.jdField_a_of_type_Bipz.a() });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setInterpolator(new DecelerateInterpolator());
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new biqm(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new biqn(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setDuration(this.jdField_a_of_type_Bipz.a());
