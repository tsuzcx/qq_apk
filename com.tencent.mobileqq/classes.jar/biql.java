...
public class biql
  extends bipp
  implements Handler.Callback, AdapterView.OnItemClickListener, ubp
{
  ...
  ubn jdField_a_of_type_Ubn = null;
  public boolean a;
  int b;
  public String b;
  public boolean b;
  ...
  private void c()
  {
    this.jdField_a_of_type_Stb = new stb(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Stb.a(this);
    ...
    {
      this.jdField_a_of_type_Stb.a((String)localObject);
      return;
    }
  }
  ...
  View a()
  {
    Object localObject = (birg)this.jdField_a_of_type_Bipq.a().a(2);
    if ((((birg)localObject).a.jdField_a_of_type_Boolean) || (((birg)localObject).a.jdField_b_of_type_Boolean)) {}
    for (int i = 2131363678;; i = 2131379050)
    {
  ...
  public String a()
  {
    return this.jdField_a_of_type_Stb.a();
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Stb == null);
      ...
      return;
      if ((this.jdField_a_of_type_Stb != null) && (this.jdField_a_of_type_Stb.a() != null)) {
        this.jdField_a_of_type_Stb.a().onConfigurationChanged();
      }
  ...
  public void a(Uri paramUri, String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Stb != null) {
      paramUri = this.jdField_a_of_type_Stb.c();
    }
    int i;
    for (;;)
    {
      ...
      try
      {
        ...
        bdll.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A69", "0X8006A69", 0, 0, "", paramString, "", "");
        ocd.a("0X8006A69", "", "", paramString, "", "");
        if (QLog.isDevelopLevel()) {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = sta.a(this.jdField_a_of_type_AndroidAppActivity.getWindow(), paramString);
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      if (this.jdField_a_of_type_Stb != null) {
        this.jdField_a_of_type_Stb.a(paramInt);
      }
      if (paramInt != 1) {
        break label487;
      }
  ...
  {
    if (this.jdField_a_of_type_Stb != null) {
      this.jdField_a_of_type_Stb.a(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Stb != null) {
      this.jdField_a_of_type_Stb.a(paramString1, paramString2, paramInt);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Stb.a().show();
  ...
  {
    if (this.jdField_a_of_type_Stb != null) {
      this.jdField_a_of_type_Stb.a(paramJSONArray);
    }
  }
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          if ((this.jdField_a_of_type_AndroidWidgetLinearLayout != null) && ((this.jdField_a_of_type_AndroidWidgetLinearLayout.getTag() instanceof Integer)))
          {
            ...
            if (i != paramInt)
            {
              ...
              localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363678);
              if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d != null)) {
                this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d.findViewById(2131363678);
              }
          ...
          if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559635, null));
            localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363678);
            if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d != null)) {
              this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d.findViewById(2131363678);
            }
            ...
            localLayoutParams.setMargins(0, 0, agej.a(10.0F, BaseApplicationImpl.getContext().getResources()), agej.a(65.0F, BaseApplicationImpl.getContext().getResources()));
            ...
            if (paramInt == 2)
            {
              localObject = (LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377099).getLayoutParams();
              ((LinearLayout.LayoutParams)localObject).width = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297527);
              ((LinearLayout.LayoutParams)localObject).height = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297528);
            }
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377099).setOnClickListener(new biqn(this));
          }
          ...
          ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377099)).setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      ...
      ((AlphaAnimation)localObject).setAnimationListener(new biqo(this));
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Ubn != null;
  }
  ...
  {
    if ((this.jdField_a_of_type_Ubn == null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      this.jdField_a_of_type_Ubn = new ubn(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
      this.jdField_a_of_type_Ubn.a(this);
      localObject = a();
      if (localObject != null)
      {
        ((View)localObject).setDrawingCacheEnabled(true);
        ((View)localObject).getViewTreeObserver().addOnGlobalLayoutListener(new biqm(this, (View)localObject));
      }
      if (QLog.isColorLevel()) {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Stb != null)) {
      this.jdField_a_of_type_Stb.c(paramString.replace("|", "｜"));
    }
    while ((this.jdField_a_of_type_Stb == null) || (!TextUtils.isEmpty(this.jdField_a_of_type_Stb.b())) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
      return;
    }
    this.jdField_a_of_type_Stb.c(BaseApplicationImpl.getContext().getResources().getString(2131694680));
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Stb != null)) {
      this.jdField_a_of_type_Stb.b(paramString);
    }
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Stb != null)) {
      this.jdField_a_of_type_Stb.e(paramString);
    }
  }
  ...
  public void f(String paramString)
  {
    ...
    paramString.putExtra("EditPicType", this.jdField_a_of_type_Stb.b());
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          bdll.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1001", localException, "", "");
          ocd.a("0X8006A1F", "", "1001", localException, "", "");
          if (QLog.isColorLevel())
          {
            QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action friend!");
            continue;
            bdll.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1002", localException, "", "");
            ocd.a("0X8006A1F", "", "1002", localException, "", "");
            if (QLog.isColorLevel())
            {
              QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action qzone!");
              continue;
              bdll.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1003", localException, "", "");
              ocd.a("0X8006A1F", "", "1003", localException, "", "");
              if (QLog.isColorLevel())
              {
                QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat!");
                continue;
                bdll.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1004", localException, "", "");
                ocd.a("0X8006A1F", "", "1004", localException, "", "");
                if (QLog.isColorLevel())
                {
                  QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat circle!");
                  continue;
                  ocd.a(null, "", "0X800787A", "0X800787A", 0, 0, localException, str, "", "");
                  bdll.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1005", localException, "", "");
                  ocd.a("0X8006A1F", "", "1005", localException, "", "");
                  if (QLog.isColorLevel()) {
