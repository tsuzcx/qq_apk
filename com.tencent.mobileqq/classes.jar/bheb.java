...
public class bheb
{
  private static final asbr<bheb, Void> jdField_a_of_type_Asbr = new bhec();
  private static bhci jdField_a_of_type_Bhci;
  private FileFilter jdField_a_of_type_JavaIoFileFilter = new bhee(this);
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentHashMap<Integer, bhdw> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private FileFilter jdField_b_of_type_JavaIoFileFilter = new bhef(this);
  private String jdField_b_of_type_JavaLangString;
  private ConcurrentHashMap<Integer, ArrayList<bhej>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  private String c;
  ...
  public static bheb a()
  {
    return (bheb)jdField_a_of_type_Asbr.b(null);
  }
  ...
  private String a()
  {
    ...
    this.jdField_a_of_type_JavaLangString = bhcg.a();
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        ...
        do
        {
          ...
          localObject2 = (bhej)((Iterator)???).next();
          localbhdy = (bhdy)((bhej)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
        } while (localbhdy == null);
        localbhdy.a(paramInt, b(paramInt, ((bhej)localObject2).b), ((bhej)localObject2).jdField_a_of_type_JavaLangString);
      }
    }
  }
  
  private void a(int paramInt1, String paramString1, int paramInt2, String paramString2, bhdy parambhdy)
  {
    if (parambhdy == null) {
      return;
    }
    ThreadManager.post(new FontManager.3(this, paramInt1, paramInt2, parambhdy, paramString2, paramString1), 8, null, false);
  }
  
  private void a(int paramInt1, String paramString1, int paramInt2, String paramString2, boolean paramBoolean, bhdy parambhdy)
  {
    if (parambhdy == null) {
      return;
    }
    ...
    {
      parambhdy.a(paramInt1, null, paramString2);
      return;
    }
    if (!paramBoolean)
    {
    ...
    a(paramInt1, paramString1, paramInt2, paramString2, parambhdy);
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    //   0: aload_0
    //   1: iload_1
    //   2: invokespecial 133	bheb:a	(I)Ljava/lang/String;
    //   5: astore 5
    //   7: aload_0
    //   8: iload_1
    //   9: invokespecial 269	bheb:b	(I)Ljava/lang/String;
    //   12: astore 6
    ...
    //   32: invokestatic 274	bhoh:b	(Ljava/io/File;Ljava/io/File;)Z
    //   35: istore 4
    //   37: iload 4
    //   39: ifeq +440 -> 479
    ...
    //   96: iload_1
    //   97: iconst_1
    //   98: invokespecial 136	bheb:a	(II)Ljava/lang/String;
    ...
    //   126: iload 4
    //   128: ifeq +18 -> 146
    //   131: invokestatic 78	bheb:b	()Lbhci;
    //   134: aload 8
    //   136: invokevirtual 286	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   139: iconst_1
    //   140: invokevirtual 298	bhci:a	(Ljava/lang/String;Z)V
    //   143: iload 4
    //   145: istore_3
    //   146: iload_3
    //   147: ifeq +209 -> 356
    //   150: new 300	bhdw
    //   153: dup
    //   154: invokespecial 301	bhdw:<init>	()V
    //   157: astore 7
    //   159: aload 7
    //   161: iload_1
    //   162: putfield 303	bhdw:jdField_a_of_type_Int	I
    //   165: aload_0
    //   166: getfield 31	bheb:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   169: aload 7
    //   171: getfield 303	bhdw:jdField_a_of_type_Int	I
    ...
    //   192: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   195: pop
    //   196: new 55	java/io/File
    //   199: dup
    //   200: aload 6
    //   202: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   205: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   208: pop
    //   209: iload_3
    //   210: ireturn
    //   211: astore 7
    ...
    //   252: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   255: pop
    //   256: new 55	java/io/File
    //   259: dup
    //   260: aload 6
    //   262: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   265: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   268: pop
    //   269: iconst_0
    //   270: ireturn
    //   271: astore 5
    ...
    //   290: iload_1
    //   291: iconst_0
    //   292: invokespecial 136	bheb:a	(II)Ljava/lang/String;
    ...
    //   320: iload 4
    //   322: ifeq -176 -> 146
    //   325: invokestatic 78	bheb:b	()Lbhci;
    //   328: aload 8
    //   330: invokevirtual 286	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   333: iconst_1
    //   334: invokevirtual 298	bhci:a	(Ljava/lang/String;Z)V
    //   337: aload_0
    //   338: aload 8
    ...
    //   344: iload_1
    //   345: iconst_1
    //   346: invokespecial 136	bheb:a	(II)Ljava/lang/String;
    //   349: invokespecial 321	bheb:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   352: istore_3
    //   353: goto -207 -> 146
    //   356: ldc 141
    //   358: iconst_1
    ...
    //   411: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   414: pop
    //   415: new 55	java/io/File
    //   418: dup
    //   419: aload 6
    //   421: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   424: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   427: pop
    //   428: iconst_0
    //   429: istore_3
    //   430: goto -221 -> 209
    ...
    //   459: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   462: pop
    //   463: new 55	java/io/File
    //   466: dup
    //   467: aload 6
    //   469: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   472: invokestatic 309	bhoh:a	(Ljava/io/File;)Z
    //   475: pop
    //   476: aload 7
    //   478: athrow
    //   479: ldc 141
  ...
  private boolean a(int paramInt1, String paramString1, int paramInt2, String arg4, bhdy parambhdy)
  {
    ...
    bhej localbhej = new bhej(this, null);
    localbhej.jdField_a_of_type_Int = paramInt1;
    localbhej.b = paramInt2;
    localbhej.jdField_a_of_type_JavaLangString = ???;
    localbhej.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhdy);
    synchronized (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
    {
      parambhdy = (ArrayList)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
      if (parambhdy == null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("FontManager", 4, "add new download task. fontId =" + paramInt1);
        }
        parambhdy = new ArrayList();
        parambhdy.add(localbhej);
        this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt1), parambhdy);
  ...
  private static bhci b()
  {
    if (jdField_a_of_type_Bhci == null) {
      jdField_a_of_type_Bhci = bhcg.d();
    }
    return jdField_a_of_type_Bhci;
  }
  ...
  {
    bhdw localbhdw = new bhdw(paramInt);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), localbhdw);
  }
  ...
  public bheg a(long paramLong)
  {
    ...
    localObject1 = new bheg();
    try
    {
      ((bheg)localObject1).jdField_a_of_type_Int = Integer.valueOf(arrayOfString[0]).intValue();
      ((bheg)localObject1).jdField_a_of_type_JavaLangString = arrayOfString[1];
      return localObject1;
    }
  ...
  public bhei a(long paramLong)
  {
    ...
    localObject1 = new bhei();
    try
    {
      ((bhei)localObject1).jdField_a_of_type_Int = Integer.valueOf(arrayOfString[0]).intValue();
      ((bhei)localObject1).jdField_a_of_type_JavaLangString = arrayOfString[1];
      return localObject1;
    }
    catch (Throwable localThrowable)
    {
  ...
  public String a(int paramInt, String paramString1, String paramString2, bhdz parambhdz)
  {
    ...
    {
      a(paramInt, paramString1, 0, paramString2, false, parambhdz);
      return null;
    }
    b().a(str, true);
    return str;
  ...
  public String a(int paramInt, String paramString1, String paramString2, boolean paramBoolean, bhea parambhea)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!new File(str).exists())
    {
      a(paramInt, paramString1, 1, paramString2, paramBoolean, parambhea);
      return null;
    }
    b().a(str, true);
    return str;
  ...
  public void a(long paramLong, bheg parambheg)
  {
    String str = "";
    ...
    {
      localObject = str;
      if (parambheg.jdField_a_of_type_Int > 0)
      {
        localObject = str;
        if (!TextUtils.isEmpty(parambheg.jdField_a_of_type_JavaLangString))
        {
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append(parambheg.jdField_a_of_type_Int).append(";");
          ((StringBuilder)localObject).append(parambheg.jdField_a_of_type_JavaLangString).append(";");
  ...
  public void a(long paramLong, bheh parambheh)
  {
    String str2 = "";
    String str1 = str2;
    if (parambheh != null)
    {
      str1 = str2;
      if (parambheh.jdField_a_of_type_Int > 0)
      {
        str1 = str2;
        if (!TextUtils.isEmpty(parambheh.jdField_a_of_type_JavaLangString))
        {
          str1 = parambheh.toString();
          a(paramLong, null);
        }
      }
    }
  ...
  public void a(long paramLong, bhei parambhei)
  {
    String str = "";
    Object localObject = str;
    if (parambhei != null)
    {
      localObject = str;
      if (parambhei.jdField_a_of_type_Int > 0)
      {
        localObject = str;
        if (!TextUtils.isEmpty(parambhei.jdField_a_of_type_JavaLangString))
        {
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append(parambhei.jdField_a_of_type_Int).append(";");
          ((StringBuilder)localObject).append(parambhei.jdField_a_of_type_JavaLangString).append(";");
          localObject = ((StringBuilder)localObject).toString();
          a(paramLong, null);
        }
      }
  ...
  public void a(anpf paramanpf)
  {
    paramanpf = new bhed(this);
    QIPCClientHelper.getInstance().callServer("VasFontIPCModule", hy.jdField_a_of_type_JavaLangString, null, paramanpf);
  }
