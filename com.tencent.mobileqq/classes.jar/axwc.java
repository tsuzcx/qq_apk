  ...
  extends axup
{
  ...
  public axwc(String paramString)
  {
    this(paramString, "tag");
  }
  
  public axwc(String paramString1, String paramString2)
  {
    this.a = paramString2;
    this.X = paramString1;
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramContext = (TextView)paramView.findViewById(2131378371);
    }
    for (;;)
    {
        ...
        catch (Exception paramBundle)
        {
          try
          {
            for (;;)
            {
              ...
              paramView.setMinimumHeight(actj.a(14.0F, (Resources)localObject));
              paramView.setLayoutParams(new LinearLayout.LayoutParams(-2, -1));
              paramView.setGravity(16);
              paramView.setPadding(actj.a(5.0F, (Resources)localObject), actj.a(2.0F, (Resources)localObject), actj.a(5.0F, (Resources)localObject), actj.a(2.0F, (Resources)localObject));
              paramBundle = new URLImageView(paramContext);
              paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
              LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(actj.a(9.0F, (Resources)localObject), actj.a(9.0F, (Resources)localObject));
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.W = axau.a(paramObjectInput.readUTF(), false);
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    {
      return true;
      this.U = paramaxwg.a("color");
      this.V = paramaxwg.a("style");
      this.W = paramaxwg.a("size");
      this.X = axau.a(axva.a(paramaxwg), false);
      this.S = paramaxwg.a("bgColor");
      this.T = paramaxwg.a("icon");
      paramaxwg = paramaxwg.a("radius");
      try
      {
        this.l = Integer.valueOf(paramaxwg).intValue();
        return true;
      }
      catch (NumberFormatException paramaxwg) {}
    } while (!QLog.isColorLevel());
    QLog.e("Q..troop.faceScore.StructMsgItemTag", 2, "StructMsgItemTag fromXml radius is not a integer value.", paramaxwg);
    return true;
  }
