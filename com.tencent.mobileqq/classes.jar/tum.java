...
{
  public tum(TroopGagActivity paramTroopGagActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt > 0)
    {
      ...
      {
        paramView = ((LayoutInflater)this.a.getSystemService("layout_inflater")).inflate(2130969449, paramViewGroup, false);
        paramViewGroup = new tun(this, null);
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131366518));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362876));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131366519));
        paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131366520));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (tun)paramView.getTag();
      }
