...
{
  public static final String a = ajed.aU + "hotpic/";
  ...
  {
    paramString = new batm(paramString.replaceFirst("https", "http"), paramFile);
    paramString.e = 20000;
    paramString.n = true;
    paramString.b = 2;
    return bato.a(paramString, null, null);
  }
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if (j == 0)
    {
      str = attn.a(localFile1.getAbsolutePath());
