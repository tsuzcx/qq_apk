  ...
  extends ArkViewModel
{
  ...
  protected static ArrayList<WeakReference<agyw>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<agyw> c;
  boolean c;
  protected WeakReference<agyz> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new agyx();
  }
  
  public agyw() {}
  
  public agyw(boolean paramBoolean) {}
  ...
  public static WeakReference<agyw> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      agyw localagyw = (agyw)localWeakReference.get();
      if ((localagyw != null) && (localagyw.getContainer() == paramContainer)) {
  ...
  public void a(agyz paramagyz)
  {
    this.d = new WeakReference(paramagyz);
  }
  ...
  {
    agyz localagyz = (agyz)this.d.get();
    if (localagyz != null) {
      localagyz.a(this, paramString1, paramString2);
    }
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new agyy(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      aqca.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693256);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693257);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
