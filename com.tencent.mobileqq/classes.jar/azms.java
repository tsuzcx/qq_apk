  ...
  implements Handler.Callback
{
  ...
  public azms(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Blcl = new azmv(this);
    this.jdField_c_of_type_Boolean = true;
    this.jdField_f_of_type_Int = -1;
    this.jdField_e_of_type_Boolean = true;
    this.jdField_f_of_type_Boolean = VersionUtils.isHoneycomb();
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new azna(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new aznb(this, paramView3);
    }
  ...
  private void b(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new azmt(this, paramView2, paramView1, paramView3));
      this.jdField_b_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new azmu(this, paramView3, paramView1);
    }
  ...
  private void o()
  {
    ...
    do
    {
      ...
      if (this.jdField_d_of_type_Int == 3)
      {
        int j = AIOUtils.dp2px(100.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
  ...
  public void a()
  {
    ...
    ((PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(QQManagerFactory.MGR_PORTAL)).d();
  ...
  {
    PortalManager localPortalManager = (PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(QQManagerFactory.MGR_PORTAL);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsCountDownTimer = new azmw(this, arrayOfLong[1], 40L, arrayOfLong);
  ...
  {
    if ((!this.jdField_e_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation == null)) {
      return;
    }
  ...
  public boolean c()
  {
    ...
    localAlphaAnimation.setAnimationListener(new azmx(this));
    int i = (int)this.jdField_a_of_type_AndroidViewViewGroup.getResources().getDimension(2131298214);
    ...
    localTranslateAnimation.setAnimationListener(new azmy(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new azmz(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_e_of_type_Int = 0;
      ((PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(QQManagerFactory.MGR_PORTAL)).a(this.jdField_a_of_type_AndroidAppActivity);
      return false;
      if (!this.jdField_d_of_type_Boolean) {
        break;
      }
      paramMessage = (PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().getAppInterface().getManager(QQManagerFactory.MGR_PORTAL);
      if (paramMessage == null) {
        break;
      }
      paramMessage.b(4);
