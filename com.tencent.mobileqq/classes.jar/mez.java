...
public class mez
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    Bitmap localBitmap = azvq.a(paramString, localOptions);
    if (localBitmap == null) {
  ...
  public static med a(VideoAppInterface paramVideoAppInterface)
  {
    return (med)paramVideoAppInterface.a(7);
  }
  ...
  {
    paramVideoAppInterface = mjg.a(paramVideoAppInterface).edit();
  ...
  public static void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramBundle = new aqax((String)localObject, paramQQAppInterface.getCurrentAccountUin(), paramBundle, i, -5040, 65560, 0L);
  ...
  public static boolean a()
  {
    ...
    if ((!lfi.a(4, 1800000L)) && (!lfi.a(8, 1400000L))) {}
    for (;;)
    {
  ...
  {
    boolean bool = mjg.a(paramVideoAppInterface).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
