...
{
  public adbr(FileManagerEntity paramFileManagerEntity, Activity paramActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      {
        QQToast.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131439138), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131558448));
        return;
        bool1 = false;
        break;
      }
