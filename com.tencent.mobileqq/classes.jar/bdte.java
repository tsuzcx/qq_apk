...
public abstract class bdte
{
  ...
  public bdte(bdtg parambdtg, bdtf parambdtf)
  {
    this.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_Bdtg = parambdtg;
    this.jdField_a_of_type_Bdtf = parambdtf;
  }
  ...
  public long a(long paramLong)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bdtj != null) {
        this.jdField_a_of_type_Bdtj.b(l2 / 1000L);
      }
      ...
      veg.b(a(), "end seekTo timecost=" + (System.currentTimeMillis() - l1) + " seekTargetTimeUs:" + paramLong + " realStartTime:" + l2);
      return l2;
    }
    catch (RuntimeException localRuntimeException)
    {
      for (;;)
      {
        veg.c(a(), "decoder flush error %s", localRuntimeException);
      }
    }
  }
  ...
  protected abstract void a(bdtf parambdtf, MediaCodec paramMediaCodec, MediaFormat paramMediaFormat);
  
  public void a(bdtj parambdtj)
  {
  ...
  {
    boolean bool2 = false;
    bdtb.a(this.jdField_a_of_type_Bdtg.jdField_a_of_type_Long, "[" + a() + "] init now");
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaExtractor.setDataSource(this.jdField_a_of_type_Bdtf.b);
        bdtb.a(this.jdField_a_of_type_Bdtg.jdField_a_of_type_Long, "[" + a() + "] extractor setDataSource");
        i = 0;
        bool1 = bool2;
        if (i < this.jdField_a_of_type_AndroidMediaMediaExtractor.getTrackCount())
        {
          ...
          if (!str.startsWith(this.jdField_a_of_type_Bdtf.a)) {
            break label353;
          }
          this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(i);
          bdtb.a(this.jdField_a_of_type_Bdtg.jdField_a_of_type_Long, "[" + a() + "] find and selectTrack");
        }
      }
      catch (IOException localIOException)
      {
        String str;
        veg.b(a(), "init set data source error :%s", localIOException);
        return false;
      }
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaCodec = MediaCodec.createDecoderByType(str);
        bdtb.a(this.jdField_a_of_type_Bdtg.jdField_a_of_type_Long, "[" + a() + "] create codec");
        a(this.jdField_a_of_type_Bdtf, this.jdField_a_of_type_AndroidMediaMediaCodec, this.jdField_a_of_type_AndroidMediaMediaFormat);
        bdtb.a(this.jdField_a_of_type_Bdtg.jdField_a_of_type_Long, "[" + a() + "] configureCodec");
        bool1 = true;
      }
      catch (Throwable localThrowable)
      {
        veg.b(a(), "init createDecoderByType error :%s", localThrowable);
        bool1 = bool2;
        continue;
      }
      if (!bool1) {
      ...
      veg.b(a(), "create media decoder success!");
      return bool1;
      label353:
      i += 1;
    }
    veg.d(a(), "create media decoder error!");
    return bool1;
  }
  ...
  public void b()
  {
    ...
    {
      veg.c(a(), "onRelease error :%s ", localException);
    }
  }
  
  public boolean b()
  {
    veg.a(a(), "start ! %s", this.jdField_a_of_type_Bdtf);
    try
    {
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        veg.c(a(), "decode start error :%s", localException);
      }
      localThrowable = localThrowable;
      veg.c(a(), "decode start error", localThrowable);
      return false;
    }
  }
