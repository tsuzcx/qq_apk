...
public class bdte
{
  ...
  {
    Object localObject = new File(mzh.a("1018") + "1018");
    if (!((File)localObject).isDirectory()) {}
    do
    {
      return null;
      localObject = ((File)localObject).listFiles(new bdtf());
    } while ((localObject == null) || (localObject.length == 0));
    return localObject[0];
  }
  
  public static void a(String paramString, boolean paramBoolean, bdtd parambdtd)
  {
    if (jdField_a_of_type_Bdtc == null) {
      jdField_a_of_type_Bdtc = bdtc.a();
    }
    jdField_a_of_type_Bdtc.a(paramString, paramBoolean, parambdtd);
  }
  ...
  {
    paramString = new File(paramString).listFiles(new bdtg());
    boolean bool2;
  ...
  private static boolean c(String paramString)
  {
    ...
    //   15: aload_0
    //   16: invokestatic 93	mzh:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   46: astore 4
    //   48: invokestatic 42	bdte:a	()Ljava/io/File;
    //   51: astore_0
    //   52: aload_0
    //   53: ifnonnull +9 -> 62
    //   56: aload 4
    //   58: invokestatic 211	bdte:b	(Ljava/lang/String;)Z
    //   61: ireturn
    ...
    //   135: ifne +113 -> 248
    //   138: aload 4
    //   140: invokestatic 211	bdte:b	(Ljava/lang/String;)Z
    //   143: istore_1
    //   144: iload_1
    //   145: ireturn
    //   146: astore_0
