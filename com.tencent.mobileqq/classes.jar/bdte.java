  ...
  extends bdnu
{
  ...
  String ax;
  public String ay = "";
  private View.OnClickListener b = new bdtf(this);
  public boolean b;
  public long c;
  public boolean c;
  boolean d;
  ...
  public bdte()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdti(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bdtj(this);
    this.jdField_a_of_type_JavaLangString = "video";
    this.jdField_a_of_type_Int = 18;
  }
  
  public bdte(String paramString1, int paramInt1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, String paramString5, String paramString6, String paramString7, int paramInt7, long paramLong)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdti(this);
  ...
  public bdte(String paramString1, String paramString2, boolean paramBoolean)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdti(this);
  ...
  private void a()
  {
    try
    {
      if (!onq.b(this.Y))
      {
        ...
        localooa.jdField_a_of_type_Int = 3;
        localooa.f = 1;
        localooa = onx.a(localooa, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message);
        ((onx)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a(localooa, null);
      }
      return;
    }
  ...
  private void a(Context paramContext)
  {
    ...
    do
    {
      ...
      paramContext = bdny.a(b());
    } while (TextUtils.isEmpty(paramContext));
    bdla.b(null, "CliOper", "", "", "0X8005F58", "0X8005F58", 0, 0, "", "", paramContext, "");
  }
  ...
  private void a(Context paramContext, View paramView)
  {
    if (this.o == 1)
    {
      if ((paramView instanceof AnyScaleTypeImageView)) {
        ((AnyScaleTypeImageView)paramView).setImageResource(2130839464);
      }
      if (this.jdField_a_of_type_Bdtm == null) {
        this.jdField_a_of_type_Bdtm = new bdtm(this);
      }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(b()))
    {
      ...
      if (!TextUtils.isEmpty(paramContext)) {
        bdla.b(null, "CliOper", "", "", "0X8005F57", "0X8005F57", 0, 0, "", "", paramContext, "");
      }
    }
  }
  ...
  {
    boolean bool2 = bdnp.a().a(paramContext, 3, paramInt);
    boolean bool3 = pqt.f();
    if ((bool2) && (bool3)) {}
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (this.ai = localBundle.getString("VIDEO_PUB_ACCOUNT_NAME");; this.ai = String.valueOf(((StructMsgForGeneralShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg).mSourceName))
    {
      ...
      if (paramView.getTag(2131378150) != null)
      {
        paramContext = paramView.getTag(2131378150);
        if ((paramContext instanceof bdtl))
        {
          paramContext = (bdtl)paramContext;
          if (QLog.isColorLevel()) {
    ...
    paramBundle.setId(2131378150);
    paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramBundle.setContentDescription(((Resources)localObject1).getText(2131719004));
    ...
    if (bool1)
    {
      ...
      if (this.r >= this.s)
      {
        ...
        ((ImageView)localObject2).setImageResource(2130843294);
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(5, 2131378150);
        ((RelativeLayout.LayoutParams)localObject4).addRule(7, 2131378150);
        ((RelativeLayout.LayoutParams)localObject4).addRule(8, 2131378150);
        if (!bool1) {
          break label1462;
        }
    ...
    for (;;)
    {
      ...
      ((TextView)localObject4).setId(2131378149);
      ...
      if (bool1)
      {
        ...
        localObject5 = new bdtl();
        ((bdtl)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView = paramBundle;
        ((bdtl)localObject5).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject4);
        ((bdtl)localObject5).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localObject2);
        ((bdtl)localObject5).b = ((TextView)localObject1);
        ((bdtl)localObject5).jdField_a_of_type_AndroidViewView = ((View)localObject3);
        paramView.setTag(2131378150, localObject5);
        paramView.setTag(this);
        ((bdtl)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.a(this, (bdtl)localObject5);
        ...
        ((bdtl)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.d();
      }
      for (;;)
      {
        if (this.q > 0) {
          ((bdtl)localObject5).b.setText(ShortVideoUtils.stringForTime(this.q * 1000));
        }
        if (!TextUtils.isEmpty(this.au)) {
          paramView.setTag(2131378157, this.au);
        }
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null) && (!bhbz.a().a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message, "0X800B375")))
        {
          olh.a(null, null, "0X800B375", "0X800B375", 0, 0, "", "", "", new suu(null, null, this.ae, this.aj).i(this.aj).l(bool2).m(pkh.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg)).a().a(), false);
          bhbz.a().a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message, "0X800B375");
        }
        return paramView;
        paramBundle.i = false;
        ...
        break label818;
        label1519:
        ((bdtl)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.f();
      }
      label1530:
      j = i;
      k = i;
  ...
  protected void a(Context paramContext, StructMsgForGeneralShare paramStructMsgForGeneralShare, long paramLong)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        if ((sqp.a(paramContext)) || ((localQQAppInterface != null) && (localQQAppInterface.isVideoChatting())))
        {
      ...
      for (Object localObject = paramStructMsgForGeneralShare.mCreateTime.substring(0, paramStructMsgForGeneralShare.mCreateTime.indexOf(" "));; localObject = paramStructMsgForGeneralShare.mCreateTime)
      {
        ...
        if (!bool1)
        {
          ...
          {
            swx.a();
            localBundle.putString("VIDEO_THIRD_URL", swx.a(this.af));
          }
        }
        if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null) {
          bdla.b(null, "dc00899", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message.frienduin, "0X8006830", "0X8006830", 0, 0, this.ae, "" + this.v, "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.msgId, "");
        }
        ...
        if (((paramStructMsgForGeneralShare.mSourceName == null) || (!paramStructMsgForGeneralShare.mSourceName.equals(anvx.a(2131716402)))) && (((AladdinConfig)localObject).getIntegerFromString("enable_floating_layer_style", 0) == 1) && (bmic.a(paramContext, this.aj, localBundle))) {
          break;
        }
        bool1 = false;
        try
        {
          boolean bool2 = plw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
          bool1 = bool2;
        }
        ...
        ssn.a(paramContext, paramStructMsgForGeneralShare);
  ...
  public boolean a(bdpl parambdpl)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = parambdpl.a("load");
      this.ae = parambdpl.a("vInfo");
      this.af = parambdpl.a("tInfo");
      String str = parambdpl.a("preTime");
      if (str != null) {}
      try
      {
        this.q = Integer.valueOf(str).intValue();
        label81:
        str = parambdpl.a("preWidth");
        if (str == null) {}
      }
            ...
            try
            {
              ...
              catch (RuntimeException localNumberFormatException9)
              {
                try
                {
                  ...
                  label199:
                  this.aj = parambdpl.a("aID");
                  this.au = parambdpl.a("jumpUrl");
                  this.jdField_d_of_type_Boolean = "1".equals(parambdpl.a("isJump2Web"));
                  localObject = parambdpl.a("preStartPosi");
                  if (!TextUtils.isEmpty((CharSequence)localObject)) {}
                  try
                  {
                    this.p = Integer.valueOf((String)localObject).intValue();
                    this.av = parambdpl.a("apurl");
                    this.aw = parambdpl.a("rl");
                    this.ax = parambdpl.a("disType");
                    localObject = parambdpl.a("feedId");
                    if (TextUtils.isEmpty((CharSequence)localObject)) {}
                  }
                  catch (Exception localNumberFormatException9)
                  {
                    try
                    {
                      ...
                      localObject = parambdpl.a("feedType");
                      if (TextUtils.isEmpty((CharSequence)localObject)) {}
                    }
                    catch (Exception localNumberFormatException9)
                    {
                      try
                      {
                        ...
                        if (this.jdField_a_of_type_Int >= 13)
                        {
                          localObject = parambdpl.a("action_type");
                          if (TextUtils.isEmpty((CharSequence)localObject)) {}
                        }
                      }
                      catch (Exception localNumberFormatException9)
                      {
                        try
                        {
                          ...
                          localObject = parambdpl.a("dest_type");
                          if (TextUtils.isEmpty((CharSequence)localObject)) {}
                        }
                        catch (NumberFormatException localNumberFormatException9)
                        {
                          try
                          {
                            ...
                            localObject = parambdpl.a("product_type");
                            if (TextUtils.isEmpty((CharSequence)localObject)) {}
                          }
                          catch (NumberFormatException localNumberFormatException9)
                          {
                            try
                            {
                              ...
                              this.r = parambdpl.a("advertiser_id");
                              this.s = parambdpl.a("aid");
                              this.t = parambdpl.a("app_download_schema");
                              this.u = parambdpl.a("canvas_json");
                              this.v = parambdpl.a("customized_invoke_url");
                              this.w = parambdpl.a("effect_url");
                              this.x = parambdpl.a("landing_page");
                              this.y = parambdpl.a("landing_page_report_url");
                              this.z = parambdpl.a("noco_id");
                              this.A = parambdpl.a("product_id");
                              this.C = parambdpl.a("subordinate_product_id");
                              this.D = parambdpl.a("traceid");
                              this.E = parambdpl.a("via");
                              this.F = parambdpl.a("video_url");
                              this.G = parambdpl.a("appname");
                              this.H = parambdpl.a("customized_invoke_url");
                              this.I = parambdpl.a("pkg_name");
                              this.J = parambdpl.a("pkgurl");
                              this.B = parambdpl.a("rl");
                              this.q = parambdpl.a("apurl");
                              this.N = parambdpl.a("corporate_image_name");
                              this.O = parambdpl.a("corporate_logo");
                              if (this.jdField_a_of_type_Int >= 14)
                              {
                                localObject = parambdpl.a("mini_program_type");
                                if (TextUtils.isEmpty((CharSequence)localObject)) {}
                              }
                            }
                            catch (NumberFormatException localNumberFormatException9)
                            {
                              try
                              {
                                ...
                                if ((parambdpl.a != null) && (parambdpl.a.a != null))
                                {
                                  localObject = parambdpl.a.a;
                                  if (this.jdField_a_of_type_Int >= 15)
                                  {
                                    str = ((bdpl)localObject).a("tab_id");
                              ...
                              catch (NumberFormatException localNumberFormatException9)
                              {
                                try
                                {
                                  ...
                                  str = ((bdpl)localObject).a("is_hidden");
                                  if (StringUtil.isEmpty(str)) {}
                                }
                                catch (NumberFormatException localNumberFormatException9)
                                {
                                  try
                                  {
                                    ...
                                    if (this.jdField_a_of_type_Int >= 16)
                                    {
                                      this.P = ((bdpl)localObject).a("negative_feedback_url");
                                      this.Q = ((bdpl)localObject).a("sdk_exposure_monitor_url");
                                      this.R = ((bdpl)localObject).a("sdk_click_monitor_url");
                                      str = ((bdpl)localObject).a("media_duration");
                                      if (StringUtil.isEmpty(str)) {}
                                    }
                                  }
                                  catch (NumberFormatException localNumberFormatException9)
                                  {
                                    try
                                    {
                                      ...
                                      str = ((bdpl)localObject).a("video_file_size");
                                      if (StringUtil.isEmpty(str)) {}
                                    }
                                    catch (NumberFormatException localNumberFormatException9)
                                    {
                                      try
                                      {
                                        ...
                                        str = ((bdpl)localObject).a("app_score_num");
                                        if (StringUtil.isEmpty(str)) {}
                                      }
                                      catch (NumberFormatException localNumberFormatException9)
                                      {
                                        try
                                        {
                                          ...
                                          str = ((bdpl)localObject).a("download_num");
                                          if (StringUtil.isEmpty(str)) {}
                                        }
                                        catch (NumberFormatException localNumberFormatException9)
                                        {
                                          try
                                          {
                                            for (;;)
                                            {
                                              for (;;)
                                              {
                                                ...
                                                this.S = ((bdpl)localObject).a("universal_link");
                                                this.T = ((bdpl)localObject).a("sdk_data");
                                                this.U = ((bdpl)localObject).a("tencent_video_id");
                                                this.V = ((bdpl)localObject).a("view_id");
                                                if (this.jdField_a_of_type_Int >= 17) {
                                                  this.W = ((bdpl)localObject).a("qgg_ext");
                                                }
                                                if (this.jdField_a_of_type_Int >= 18)
                                                {
                                                  this.X = ((bdpl)localObject).a("adInfo");
                                                  this.Y = ((bdpl)localObject).a("is_report_click");
                                                }
                                                if (this.jdField_a_of_type_Int < 18) {
                                                  break;
                                                }
                                                this.ay = parambdpl.a("noAutoPlay");
                                                return true;
  ...
  protected View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle.getBoolean("has_cnr"))
    {
      ...
      for (;;)
      {
        paramView.setImageResource(2130845395);
        paramView.setTag(this);
        try
        {
          localObject2 = new bdoa(-16777216, j, j, i);
          if (TextUtils.isEmpty(this.ac))
          {
            ...
            paramView.setContentDescription(((Resources)localObject1).getString(2131694367));
            paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            paramView.setContentDescription(((Resources)localObject1).getText(2131719004));
            localObject1 = paramView;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBundle.getBoolean("has_cnr")) {
          localURLDrawable.setDecodeHandler(new bdtk(this, i, j, j));
        }
