  ...
  implements Manager
{
  ...
  public bhtk(QQAppInterface paramQQAppInterface)
  {
  ...
  private bamb a(String paramString)
  {
    paramString = new bamb(paramString, 16);
  ...
  public static bhtk a(QQAppInterface paramQQAppInterface)
  {
    return (bhtk)paramQQAppInterface.getManager(313);
  }
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (akey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = alud.a(2131708031) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new bamb("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(alud.a(2131708030)));
      paramSpannableStringBuilder.append(new bamb(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((akey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(alud.a(2131708032)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = alud.a(2131708033) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131699985) + paramString;
  }
  
  public void b()
  {
    ((alpk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).j();
  }
  ...
  {
    return akey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
