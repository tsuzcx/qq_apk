  ...
  implements agin
{
  ...
  private axem a()
  {
    ...
    return ((axel)localBaseActivity.app.getManager(QQManagerFactory.AIO_MULTI_WINDOW_MANAGER)).b(i);
  }
  ...
  private void d()
  {
    ...
    if ((localObject != null) && (((axem)localObject).a()))
    {
      localObject = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.listView;
      if (localObject != null) {
        ((ChatXListView)localObject).setOnLayoutListener(new agiz(this));
      }
    }
  }
  ...
  private void j()
  {
    ...
    {
      localObject1 = ((afqz)localObject1).a();
      i = a();
      if ((localObject1 != null) && (((List)localObject1).size() == i))
      {
        localObject1 = a();
        if ((localObject1 != null) && (((axem)localObject1).a()))
        {
          localObject2 = ((axem)localObject1).a();
          if (localObject2 != null)
          {
            localObject2 = ((axeq)localObject2).a();
            if (localObject2 != null) {
              break label100;
            }
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new MultiWindowAIOHelper.4(this, (axem)localObject1), 350L);
  }
