...
public class ainc
  extends amsu
{
  private ainc(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, amtj.a(2131699380), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, amtj.a(2131699381), 0).a();
          return;
        }
      }
