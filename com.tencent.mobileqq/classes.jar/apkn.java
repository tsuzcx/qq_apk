...
public class apkn
{
  ...
  private List<apkt> jdField_a_of_type_JavaUtilList;
  private int b = 0;
  
  public apkn(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString == null) || (this.jdField_a_of_type_JavaLangString.trim().length() == 0) || (this.jdField_a_of_type_JavaLangString.equals(localFileManagerEntity.peerUin)))
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(apkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity));
          break;
        }
      }
    }
  ...
  private boolean a(ForwardFileInfo paramForwardFileInfo)
  {
    ...
    while (paramForwardFileInfo.hasNext())
    {
      ...
      if (localObject != null)
      {
        if (apvd.b(((FileManagerEntity)localObject).getFilePath())) {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.add(apkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject));
          i += 1;
          break;
        }
      }
  ...
  private boolean b()
  {
    ...
    if ((localObject2 != null) && (((Set)localObject2).size() > 0))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (((FileInfo)localObject3).a() == 0) {
          this.jdField_a_of_type_JavaUtilList.add(apkm.a((FileInfo)localObject3));
        }
      }
    }
    if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (apug.a(((WeiYunFileInfo)localObject2).c) == 0) {
          this.jdField_a_of_type_JavaUtilList.add(apkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (WeiYunFileInfo)localObject2));
        }
      }
    }
  ...
  private boolean b(Intent paramIntent)
  {
    ...
    if (paramIntent.hasNext())
    {
      ...
      if ((i == 0) && (((FileInfo)localObject).hashCode() == k))
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(apkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity));
        i = 1;
      }
      for (;;)
      {
        j += 1;
        break;
        this.jdField_a_of_type_JavaUtilList.add(apkm.a((FileInfo)localObject));
      }
    }
    apel.a();
    return true;
  ...
  private boolean c(Intent paramIntent)
  {
    ...
    while (paramIntent.hasNext())
    {
      ...
      do
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(apkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localWeiYunFileInfo));
          break;
        } while (apug.a(localWeiYunFileInfo.c) == 0);
  ...
  public apim a(BaseActivity paramBaseActivity)
  {
    return new apko(this, paramBaseActivity);
  }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = ayek.a(localForwardFileInfo);
    }
    ...
    if (5 != this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.cloudType) {
      apug.c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    }
    boolean bool;
    ...
    {
      this.jdField_a_of_type_Apkt = apkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.b = 3;
      return true;
    }
    return bool;
