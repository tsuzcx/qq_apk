  ...
  extends PopupWindow
{
  ...
  public qko(Context paramContext)
  {
    super(-2, -2);
  ...
  private void a()
  {
    ...
    qkp localqkp = new qkp(this, this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    this.jdField_a_of_type_Qkp = localqkp;
  ...
  private void b()
  {
    ...
    qkp.a(this.jdField_a_of_type_Qkp).setColor(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Qkp, this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    ...
    for (;;)
    {
      ...
      return;
      localLayoutParams.rightMargin = qkp.a(this.jdField_a_of_type_Qkp);
      this.jdField_a_of_type_Qkp.setRotation(90.0F);
      continue;
      localLayoutParams.bottomMargin = qkp.b(this.jdField_a_of_type_Qkp);
      this.jdField_a_of_type_Qkp.setRotation(180.0F);
      continue;
      localLayoutParams.leftMargin = qkp.a(this.jdField_a_of_type_Qkp);
      this.jdField_a_of_type_Qkp.setRotation(270.0F);
      continue;
      localLayoutParams.topMargin = qkp.b(this.jdField_a_of_type_Qkp);
      this.jdField_a_of_type_Qkp.setRotation(0.0F);
    }
  }
  ...
  {
    qkp.c(this.jdField_a_of_type_Qkp, paramInt);
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    qkp.a(this.jdField_a_of_type_Qkp, paramInt1);
    qkp.b(this.jdField_a_of_type_Qkp, paramInt2);
  }
  ...
  public int c()
  {
    return qkp.b(this.jdField_a_of_type_Qkp);
  }
