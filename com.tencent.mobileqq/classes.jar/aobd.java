...
{
  static ArrayList<aobm> jdField_a_of_type_JavaUtilArrayList;
  ...
  public aobd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static aobo a(byte[] paramArrayOfByte)
  {
    aobo localaobo = new aobo();
    ...
    localaobo.jdField_a_of_type_Int = lcx.a(lcx.a(arrayOfByte1, 2));
    System.arraycopy(paramArrayOfByte, 2, arrayOfByte3, 0, 8);
    localaobo.jdField_a_of_type_Long = lcx.b(arrayOfByte3, 8);
    localaobo.jdField_b_of_type_Int = lcx.a(paramArrayOfByte[10]);
    int j = localaobo.jdField_b_of_type_Int + 11;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localaobo.jdField_b_of_type_Long = lcx.a(lcx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localaobo.jdField_c_of_type_Long = lcx.a(lcx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte3, 0, 8);
    localaobo.jdField_d_of_type_Long = lcx.b(arrayOfByte3, 8);
    j += 8;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localaobo.jdField_c_of_type_Int = lcx.a(arrayOfByte2, 4);
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localaobo.jdField_d_of_type_Int = lcx.a(lcx.a(arrayOfByte1, 2));
    j += 2;
    localaobo.jdField_e_of_type_Int = lcx.a(paramArrayOfByte[j]);
    j += 1;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localaobo.jdField_e_of_type_Long = lcx.a(arrayOfByte2, 4);
    j += localaobo.jdField_e_of_type_Int;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localaobo.jdField_f_of_type_Int = lcx.a(lcx.a(arrayOfByte1, 2));
    j = j + 2 + localaobo.jdField_f_of_type_Int * 8;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localaobo.jdField_f_of_type_Long = lcx.a(lcx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localaobo.jdField_g_of_type_Int = lcx.a(lcx.a(arrayOfByte1, 2));
    j += 2;
    if ((localaobo.jdField_g_of_type_Int >= 16) && (localaobo.jdField_g_of_type_Int + j <= i))
    {
      System.arraycopy(paramArrayOfByte, j + 9, arrayOfByte1, 0, 2);
      i = lcx.a(lcx.a(arrayOfByte1, 2)) + 11;
      if (localaobo.jdField_d_of_type_Int != 3) {
        break label414;
      }
    }
    for (;;)
    {
      i = localaobo.jdField_g_of_type_Int;
      return localaobo;
      label414:
      localaobo.h = lcx.a(paramArrayOfByte[(j + i)]);
      i += 1;
      if (i + 4 <= localaobo.jdField_g_of_type_Int)
      {
        System.arraycopy(paramArrayOfByte, j + i, arrayOfByte2, 0, 4);
        localaobo.jdField_g_of_type_Long = lcx.a(lcx.a(arrayOfByte2, 4));
      }
    }
  }
  ...
  private void a(int paramInt, long paramLong)
  {
    ...
    if (paramInt != 0)
    {
      if ((jdField_a_of_type_JavaUtilArrayList != null) && (!jdField_a_of_type_JavaUtilArrayList.isEmpty()))
      {
        ...
        {
          localObject1 = (aobm)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
          if ((localObject1 != null) && (((aobm)localObject1).jdField_a_of_type_Long == paramLong) && (((aobm)localObject1).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)))
          {
            localObject2 = new byte[8];
            arrayOfByte1 = ((im_msg_body.MsgBody)((aobm)localObject1).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
            System.arraycopy(arrayOfByte1, (arrayOfByte1[10] & 0xFF) + 19, localObject2, 0, 8);
            l = lcx.b((byte[])localObject2, 8);
            VideoMsgTools.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, 6, true, Long.toString(paramLong), Long.toString(l), false, null, false, new Object[] { ((aobm)localObject1).jdField_a_of_type_MsfMsgcommMsg_comm$Msg });
          }
          paramInt += 1;
        }
      }
    ...
    do
    {
      do
      {
        do
        {
          ...
          while (paramInt < jdField_a_of_type_JavaUtilArrayList.size())
          {
            localObject2 = (aobm)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
            if ((localObject2 != null) && (((aobm)localObject2).jdField_a_of_type_Long == paramLong) && (((aobm)localObject2).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))) {
              ((ArrayList)localObject1).add(localObject2);
            }
            paramInt += 1;
          }
          Collections.sort((List)localObject1, new aobn());
          paramInt = 0;
          while (paramInt < ((ArrayList)localObject1).size() - 1)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QQGAudioMsgHandler", 2, "onRecvMultiVideoC2SACK_0x31-retCode->list =" + ((aobm)((ArrayList)localObject1).get(paramInt)).jdField_b_of_type_Long);
            }
            localObject2 = (aobm)((ArrayList)localObject1).get(paramInt);
            arrayOfByte1 = new byte[8];
            byte[] arrayOfByte2 = ((im_msg_body.MsgBody)((aobm)localObject2).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
            System.arraycopy(arrayOfByte2, (arrayOfByte2[10] & 0xFF) + 19, arrayOfByte1, 0, 8);
            l = lcx.b(arrayOfByte1, 8);
            VideoMsgTools.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, 6, true, Long.toString(paramLong), Long.toString(l), false, null, false, new Object[] { ((aobm)localObject2).jdField_a_of_type_MsfMsgcommMsg_comm$Msg });
            paramInt += 1;
          }
        } while (((ArrayList)localObject1).size() <= 0);
        localObject1 = ((im_msg_body.MsgBody)((aobm)((ArrayList)localObject1).get(((ArrayList)localObject1).size() - 1)).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
    ...
    while (j < paramInt)
    {
      ...
      if (k < n)
      {
        ...
        for (;;)
        {
          k += 1;
          break;
          l = lcx.a(paramByteBuffer.getInt());
          continue;
          i = paramByteBuffer.getInt();
          continue;
          paramByteBuffer.getInt();
      ...
      msj.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l), new aobe(this, l, i));
      j += 1;
    }
  }
  ...
  private void j(byte[] paramArrayOfByte)
  {
    ...
    if ((j == 1) && (i == 2))
    {
      new bltw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new aobk(this, paramArrayOfByte));
      return;
    }
    new lxx((Context)localObject).a(new aobl(this, paramArrayOfByte));
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long[] paramArrayOfLong, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    catch (Exception localException)
    {
      ...
      paramInt3 = 23;
      lne locallne = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAVNotifyCenter().a(l1);
      if ((locallne == null) || (locallne.jdField_a_of_type_Int <= 0) || (paramInt2 != 0)) {
        break label229;
      }
      this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(5, 1, l1, null, locallne.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      if ((i == 2) && (paramInt1 == 1) && (((bgmk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_VIDEO_MANAGER)).a(paramString) == 1)) {
  ...
  void a(long paramLong, int paramInt, byte paramByte)
  {
    ...
    lbd.g("QQGAudioMsgHandler", String.format("queryRoomMemberNum| discussId=%d, dataType= %d, wReserve=%s", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt), Byte.valueOf(paramByte) }));
  ...
  public void a(byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    do
    {
      ...
      i = lcx.a(lcx.a((byte[])localObject, 2));
      if (i != 141) {
        break label630;
      }
      aobo localaobo = a(paramArrayOfByte);
      i = localaobo.jdField_d_of_type_Int;
      l1 = localaobo.jdField_d_of_type_Long;
      l2 = localaobo.jdField_e_of_type_Long;
      j = localaobo.jdField_c_of_type_Int;
      l3 = localaobo.jdField_f_of_type_Long;
      l4 = localaobo.jdField_g_of_type_Long;
      str = Long.toString(l2);
      localObject = Long.toString(l1);
      if (QLog.isColorLevel()) {
        QLog.d("QQGAudioMsgHandler", 2, "GAudioOfflineMsg relationShip[" + i + "], groupUin[" + str + "], inviteUin[" + l1 + "], subCmd0x8DMsg[" + localaobo + "]");
      }
      if (1 == i)
      {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      jdField_a_of_type_JavaUtilArrayList.add(new aobm(paramMsg, Long.valueOf(paramArrayOfByte).longValue(), l2));
      ...
      return;
      label471:
      paramMsg = (bapk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECENT_CALL_FACADE);
      ...
      ((bgmk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_VIDEO_MANAGER)).a(l2);
  ...
  void b(long paramLong)
  {
    ...
    ((antl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(paramLong);
  ...
  public void b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    long l = lcx.b((byte[])localObject, j);
    if (QLog.isColorLevel()) {
  ...
  {
    lbd.g("QQGAudioMsgHandler", "onRecvAppTipMsgData.");
    if (!a()) {}
    byte[] arrayOfByte1;
    byte[] arrayOfByte2;
    byte[] arrayOfByte3;
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        for (;;)
        {
          ...
          System.arraycopy(paramArrayOfByte, j, arrayOfByte3, 0, 8);
          localObject2[i1] = lcx.b(arrayOfByte3, 8);
          i1 += 1;
          j += 8;
        }
        System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
  ...
  {
    lbd.g("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31.");
    if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter == null) {}
    long l2;
    Object localObject2;
    int j;
    ...
    do
    {
      ...
      int i = lcx.a(arrayOfByte2, 4);
      if (i != 0)
      {
        localObject1 = new byte[2];
        System.arraycopy(paramArrayOfByte, paramArrayOfByte.length - 2, localObject1, 0, 2);
        lbd.g("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31| retCode wR0=" + localObject1[0] + " wR1=" + localObject1[1]);
        if (localObject1[0] == 3)
        {
          b(paramArrayOfByte, i);
          return;
        }
        lbd.h("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31|wrong retCode.");
        return;
      }
      localObject2 = new byte[2];
      System.arraycopy(paramArrayOfByte, paramArrayOfByte.length - 2, localObject2, 0, 2);
      lbd.g("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31| relation type wR0=" + localObject2[0] + " wR1=" + localObject2[1]);
      int k;
      if (localObject2[0] == 1)
      {
        j = 1;
      ...
      for (;;)
      {
        ...
        lbd.h("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31|wrong relation type.");
        break;
        i += 2;
        System.arraycopy(paramArrayOfByte, i, arrayOfByte2, 0, 4);
        i += 4;
        l2 = lcx.b(arrayOfByte2, 4);
        continue;
        i += 6;
        continue;
        System.arraycopy(paramArrayOfByte, i, arrayOfByte1, 0, 2);
  ...
  {
    lbd.g("QQGAudioMsgHandler", "onRecvMultiVideoS2C_0x95.");
    if (!a()) {}
    int i;
    do
    {
  ...
  void f(byte[] paramArrayOfByte)
  {
    ...
    long l1 = lcx.b((byte[])localObject, 8);
    int j = i + 8;
    localObject = new byte[4];
    System.arraycopy(paramArrayOfByte, j, localObject, 0, 4);
    i = lcx.a((byte[])localObject, 4);
    j += 4;
    localObject = new byte[2];
    ...
    if (k == 2)
    {
      ...
      l2 = lcx.a((byte[])localObject, 4);
      if (QLog.isColorLevel()) {
        QLog.d("QQGAudioMsgHandler", 2, "onRecvMuitiInvite discussId is" + l2 + "InviteUin:" + l1);
      }
      ((antl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).b(l2);
      if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter != null) {
        this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(7, 2, l2, new long[] { l1 }, 1L);
      }
      paramArrayOfByte = Long.toString(l2);
      localObject = Long.toString(l1);
      ((bapk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECENT_CALL_FACADE)).a(0, l2, (String)localObject, "");
    ...
    while ((k == 1) && (i == 2))
    {
      new bltw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new aobf(this));
      return;
      if ((k == 1) && (i == 10))
      {
        localObject = new byte[4];
    ...
    new lxx(BaseApplication.getContext()).a(new aobg(this));
  }
  ...
  void g(byte[] paramArrayOfByte)
  {
    ...
    long l1 = lcx.b(arrayOfByte, 8);
    i += 8;
    arrayOfByte = new byte[4];
    System.arraycopy(paramArrayOfByte, i, arrayOfByte, 0, 4);
    int j = lcx.a(arrayOfByte, 4);
    arrayOfByte = new byte[4];
    System.arraycopy(paramArrayOfByte, i + 4, arrayOfByte, 0, 4);
    long l2 = lcx.b(arrayOfByte, 4);
    msj.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), new aobh(this, l2, j, l1));
  }
  ...
  void h(byte[] paramArrayOfByte)
  {
    ...
    ((antl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).b(l);
