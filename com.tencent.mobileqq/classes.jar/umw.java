    ...
    do
    {
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            localObject3 = ((tcm)localObject2).a((String)localObject3);
            paramArrayOfByte = paramBundle;
            ...
            if (paramInt < ((List)localObject4).size())
            {
              ...
              paramArrayOfByte = ((tcw)localObject1).a(localStoryVideoItem.mVid, localStoryVideoItem);
              ((VideoCollectionItem)localObject3).videoVidList.add(paramArrayOfByte.mVid);
              paramArrayOfByte = new uuc(paramArrayOfByte.mVid, paramArrayOfByte);
              ((VideoCollectionItem)localObject3).collectionVideoUIItemList.add(paramArrayOfByte);
              paramInt += 1;
            }
            else
            {
              ((tcm)localObject2).a((VideoCollectionItem)localObject3);
