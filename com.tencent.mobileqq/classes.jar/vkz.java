  ...
  implements VideoConverter.Processor
{
  ...
  vkz(vkv paramvkv, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
  ...
  public VideoConverter.VideoConvertConfig a(int paramInt1, int paramInt2)
  {
    ...
    long l1;
    int m;
    if ((this.jdField_a_of_type_Vkv.b != null) && (this.jdField_a_of_type_Vkv.b.get() != null))
    {
      localObject = SharedPreUtils.q(((QQAppInterface)this.jdField_a_of_type_Vkv.b.get()).getApp(), ((QQAppInterface)this.jdField_a_of_type_Vkv.b.get()).getCurrentAccountUin());
