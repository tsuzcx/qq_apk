  ...
  implements ClipConstant
{
  ...
  private void b(float paramFloat1, float paramFloat2)
  {
    ...
    bmsg.a(this.jdField_d_of_type_AndroidGraphicsRectF, this.jdField_a_of_type_AndroidGraphicsRectF, 10.0F);
  ...
  public void a(float paramFloat1, float paramFloat2)
  {
    ...
    {
      bljn.d("yk", "before setClipWinSize frame::" + this.jdField_a_of_type_AndroidGraphicsRectF);
      bmsg.a(this.jdField_d_of_type_AndroidGraphicsRectF, this.jdField_a_of_type_AndroidGraphicsRectF);
      bljn.d("yk", "setClipWinSize frame::" + this.jdField_a_of_type_AndroidGraphicsRectF);
      this.jdField_c_of_type_AndroidGraphicsRectF.set(this.jdField_a_of_type_AndroidGraphicsRectF);
    }
  }
  ...
  public boolean a()
  {
    ...
    this.jdField_c_of_type_AndroidGraphicsRectF.set(this.jdField_a_of_type_AndroidGraphicsRectF);
    bmsg.a(this.jdField_d_of_type_AndroidGraphicsRectF, this.jdField_c_of_type_AndroidGraphicsRectF, 10.0F);
