  ...
  extends anud
{
  ...
  private aocj jdField_a_of_type_Aocj = new aodn(this);
  private aogl jdField_a_of_type_Aogl = new aodo(this);
  ...
  public aodm(QQAppInterface paramQQAppInterface)
  {
    ...
    this.app.addObserver(this.jdField_a_of_type_Aogl);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramString = bcrw.a(this.app, 13, paramString, localbcsd, paramLong2, bcsa.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (aogj)this.app.a(10);
    if ((((aogj)localObject1).a() != 0) && (((aogj)localObject1).e() == 1))
    {
