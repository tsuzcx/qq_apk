...
public class bdpf
{
  private bdpg jdField_a_of_type_Bdpg = new bdpg();
  private WadlJsBridge jdField_a_of_type_ComTencentOpenWadlWadlJsBridge = new WadlJsBridge(null, null, this.jdField_a_of_type_Bdpg);
  
  public void a()
  {
    this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.doOnDestroy();
    this.jdField_a_of_type_Bdpg = null;
  }
  
  public void a(bdph parambdph)
  {
    this.jdField_a_of_type_Bdpg.a(parambdph);
  }
  ...
  public boolean a(String paramString1, String paramString2, int paramInt, ArrayList<WadlResult> paramArrayList)
  {
    ...
    if ((paramString1.equals(localWadlParams.a)) && (paramString2.equals(localWadlParams.b)) && (paramInt == localWadlParams.f) && (!TextUtils.isEmpty(localWadlResult.b)) && (apvd.a(localWadlResult.b))) {
      bool1 = false;
    }
    for (;;)
    {
