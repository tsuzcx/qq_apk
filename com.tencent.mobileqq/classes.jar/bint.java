...
public class bint
{
  private static volatile bint jdField_a_of_type_Bint;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new binv(this);
  ...
  {
    if (jdField_a_of_type_Bint == null) {}
    try
    {
      if (jdField_a_of_type_Bint == null) {
        jdField_a_of_type_Bint = new bint();
      }
      return jdField_a_of_type_Bint;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new binu(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = anni.a(2131709959))
    {
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty("")) && (!"".equals(localObject1)))
    {
      ...
      localByteBuffer.put(arrayOfByte);
      arrayOfByte = localByteBuffer.array();
      ((ArrayList)localObject2).add(bgmj.a((byte[])localObject3));
      ((ArrayList)localObject2).add(bgmj.a(arrayOfByte));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((ArrayList)localObject2).add(bgmj.a(((ByteBuffer)localObject3).array()));
