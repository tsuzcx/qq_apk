...
public class bcua
{
  ...
  public final Queue<bcuf> a;
  
  public bcua(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bdal.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public bcug a(Context paramContext)
  {
    bcug localbcug = new bcug(this);
    localbcug.jdField_a_of_type_JavaLangString = (bdcb.h() + " " + bdcb.d());
    localbcug.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbcug.c = "8.3.3.4515";
    bdcc localbdcc = bdcb.a(paramContext);
    localbcug.d = localbdcc.jdField_a_of_type_JavaLangString;
    localbcug.e = localbdcc.c;
    localbcug.jdField_a_of_type_Int = bdcb.b();
    localbcug.jdField_a_of_type_Long = bdcb.a();
    localbcug.jdField_b_of_type_Long = bdcb.d();
    localbcug.f = bdcb.g();
    localbcug.jdField_a_of_type_Boolean = a(paramContext);
    localbcug.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbcug.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbcug.jdField_b_of_type_Boolean = bool;
      return localbcug;
    }
  }
  ...
  public String a()
  {
    bctz localbctz = bcty.a("getprop net.dns1");
    if (localbctz.jdField_a_of_type_Boolean)
    {
      if (!localbctz.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbctz.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbctz.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 524	bcuk:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bcud(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bcuk.a(localArrayList, paramContext);
            bcuk.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new bcub(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 702
    //   14: ldc_w 383
    //   17: invokestatic 705	befr:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 524	bcuk:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bcuk.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new bcuf(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bcuc(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bcul(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      bcuf localbcuf = (bcuf)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbcuf != null) && (localbcuf.jdField_b_of_type_Long == paramLong))
      {
        localbcuf = (bcuf)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbcuf != null)
        {
          b(paramContext, localbcuf.jdField_a_of_type_JavaLangString, localbcuf.jdField_a_of_type_Int, localbcuf.jdField_a_of_type_Long, localbcuf.jdField_b_of_type_Long, localbcuf.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbcuf.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bcuk.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bcue(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
