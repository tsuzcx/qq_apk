...
public class avew
{
  ...
  private avew(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Int = localavet.b(paramString, paramInt1);
      ...
      if (!bbbu.b(paramMessage.msgtype))
      {
        bool = bbbu.c(paramMessage.msgtype);
        if (!bool) {
          break label235;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_JavaLangString = ajya.a(2131709582);
      }
      catch (Exception paramMessage) {}
