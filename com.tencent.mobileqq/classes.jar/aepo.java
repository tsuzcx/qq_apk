  ...
  extends BaseAdapter
{
  ...
  private ArrayList<agsn> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  public aepo(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841161);
  }
  ...
  public void a(List<agsn> paramList)
  {
  ...
  {
    int k = a();
    int i = (XPanelContainer.jdField_a_of_type_Int - aekt.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) - aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 2) / 3;
    int j;
    if (i >= 0)
    {
    ...
    for (;;)
    {
      j = (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 4) / 8;
      Object localObject1;
      Object localObject2;
      if (paramView == null)
      {
        paramViewGroup = new StickerBubbleLinearLayout(this.jdField_a_of_type_AndroidContentContext);
        paramViewGroup.setMinimumHeight(aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + i);
        ...
        for (;;)
        {
          ...
          localObject1 = new LinearLayout.LayoutParams(aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
          ...
          int m = aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
          int n = aekt.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      if (paramInt == 0)
      {
        ...
        localObject2 = (agsn)this.jdField_a_of_type_JavaUtilArrayList.get(j);
        if (localObject2 != null) {
          ((ImageView)localObject1).setImageDrawable(a(((agsn)localObject2).jdField_a_of_type_JavaLangString));
        }
        ((View)localObject1).setTag(Integer.valueOf(j));
        if (AppSetting.c) {
          ((View)localObject1).setContentDescription(agso.a(((agsn)localObject2).jdField_a_of_type_Int) + alpo.a(2131708703));
        }
      }
      for (;;)
      {
