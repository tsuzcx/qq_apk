  ...
  extends Drawable
{
  ...
  public bibu(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof bibu))) {}
    Object localObject;
    do
    {
    ...
    return new bibu((Bitmap)localObject);
  }
  
  public static bibu a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new bibu(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (bibv.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public bibu a(float paramFloat)
  {
  ...
  public bibu a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public bibu a(ColorStateList paramColorStateList)
  {
  ...
  public bibu a(Shader.TileMode paramTileMode)
  {
  ...
  public bibu a(ImageView.ScaleType paramScaleType)
  {
  ...
  public bibu a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public bibu b(Shader.TileMode paramTileMode)
  {
