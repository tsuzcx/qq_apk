  ...
  extends LinearLayout
{
  ...
  public bnlz(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bnlr parambnlr)
  {
    super(paramContext);
  ...
  private URLDrawable a(bnli parambnli)
  {
    Object localObject1 = (bmug)bmql.a().c(12);
    Object localObject2 = bmug.a();
    localObject1 = parambnli.b + "_static.png";
    ...
    for (;;)
    {
      ...
      return URLDrawable.getDrawable(parambnli, (URLDrawable.URLDrawableOptions)localObject1);
  ...
  private void a()
  {
    ...
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131561637, null);
      ...
      for (;;)
      {
        ...
        ((ImageView)localView.findViewById(2131368731)).setPadding(k, k, k, k);
        addView(localView);
        i += 1;
        break;
        if (this.b - 1 == i) {
  ...
  private void a(bnli parambnli, URLImageView paramURLImageView, QIMCommonLoadingView paramQIMCommonLoadingView, ProgressBar paramProgressBar, bnmb parambnmb, boolean paramBoolean, bnlr parambnlr)
  {
    Object localObject1 = (bmug)bmql.a().c(12);
    Object localObject2 = bmug.a();
    localObject1 = parambnli.b + "_dynamic.png";
    localObject2 = new File((String)localObject2);
    String str;
    if (((File)localObject2).exists())
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        parambnmb.onLoadSuccessed(paramURLImageView, (URLDrawable)localObject1);
      }
    ...
    for (;;)
    {
      if (!bool1)
      {
        ...
        new java.lang.ref.WeakReference(parambnlr);
        parambnlr = parambnli.c;
        localObject1 = new HttpNetReq();
        ((HttpNetReq)localObject1).mCallback = new bnma(this, (File)localObject2, paramQIMCommonLoadingView, paramURLImageView, str, paramBoolean, parambnmb, paramProgressBar);
        ((HttpNetReq)localObject1).mReqUrl = parambnlr;
        if (QLog.isColorLevel()) {
          QLog.d("InformationFaceAdapter", 2, "apng url:" + parambnlr);
        }
        ...
        ((HttpNetReq)localObject1).setUserData(parambnli);
  ...
  public void a(bnlf parambnlf, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131368733);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131368731);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131368732);
      localQIMCommonLoadingView = (QIMCommonLoadingView)((View)localObject1).findViewById(2131368730);
      if (!(this.jdField_a_of_type_AndroidContentContext instanceof EditPicActivity)) {
        break label153;
      }
      localObject1 = parambnlf.b(paramInt2);
      label111:
      if (localObject1 != null) {
        break label163;
      }
      xvv.e("InformationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambnlf.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      break;
      label153:
      localObject1 = parambnlf.a(paramInt2);
      break label111;
      label163:
      ...
      else
      {
        ...
        localObject2 = new bnmb((String)localObject1, localURLImageView, localProgressBar);
        localURLImageView.setURLDrawableDownListener((URLDrawableDownListener)localObject2);
        if ((this.jdField_a_of_type_AndroidContentContext instanceof EditPicActivity))
        {
          localObject1 = a((bnli)parambnlf.a.get(paramInt2));
          if (localObject1 != null)
          {
            if (((URLDrawable)localObject1).getStatus() != 1) {
              ((URLDrawable)localObject1).restartDownload();
            ...
            if (((URLDrawable)localObject1).getStatus() == 1) {
              ((bnmb)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
            }
            if (paramBoolean) {}
            for (;;)
            {
        ...
        {
          a((bnli)parambnlf.a.get(paramInt2), localURLImageView, localQIMCommonLoadingView, localProgressBar, (bnmb)localObject2, paramBoolean, this.jdField_a_of_type_Bnlr);
        }
      }
    }
  }
