...
{
  public static final bglg a = new bglg();
  ...
  public final Integer a(@NotNull String paramString)
  {
    ...
    if ((!TextUtils.isEmpty((CharSequence)paramString)) && (StringsKt.contains$default((CharSequence)paramString, (CharSequence)"?", false, 2, null)))
    {
      ...
      paramString = bhwr.a(((String[])paramString)[1]);
  ...
  public final void a(@NotNull GetWatchWordShareRsp paramGetWatchWordShareRsp)
  {
    ...
    localObject = new bglk((ViewGroup)localObject, str1, str2, (Function1)new VasWatchWord.showContentDialog.jumpDialog.1(paramGetWatchWordShareRsp, i));
    str1 = paramGetWatchWordShareRsp.itemmsg;
    Intrinsics.checkExpressionValueIsNotNull(str1, "rsp.itemmsg");
    ((bglk)localObject).a(str1);
    ...
    ((bglk)localObject).a(j, paramGetWatchWordShareRsp);
    ((bglk)localObject).a();
    bcef.b(null, "dc00898", "", "", "qq_vip", "0X800AF79", i, 0, "", "", "", "");
  }
  ...
  public final void a(@Nullable Context paramContext, @NotNull String paramString)
  {
    ...
    paramString = bhwr.a(((String[])paramContext)[1]);
    ...
    bcef.b(null, "dc00898", "", "", "qq_vip", "0X800AF78", Integer.parseInt(paramString), 0, paramContext, "", "", "");
    Object localObject = RemoteProxy.getProxy(bgjv.class);
    if (localObject == null) {
      throw new TypeCastException("null cannot be cast to non-null type com.tencent.mobileqq.vas.remote.IWatchWordProtocol");
    }
    ((bgju)localObject).a(paramString, paramContext, null, -1, (EIPCResultCallback)new bglj(paramString, paramContext));
  }
  ...
  public final void c(@NotNull Context paramContext, @NotNull String paramString)
  {
    ...
    bfur.a(paramContext, 230, paramContext.getString(2131719610), (CharSequence)paramString, null, paramContext.getString(2131719609), (DialogInterface.OnClickListener)new bfvf(), null).show();
  }
}
