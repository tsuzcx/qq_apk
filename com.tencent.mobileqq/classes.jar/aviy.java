...
public class aviy
{
  private static HashMap<String, aviy> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aviz(this);
  ...
  private aviy(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = avig.a();
  ...
  public static aviy a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      aviy localaviy = (aviy)jdField_a_of_type_JavaUtilHashMap.get(str);
      paramString1 = localaviy;
      if (localaviy == null)
      {
        paramString1 = new aviy(paramContext.getApplicationContext(), a(paramContext), paramString2);
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (avjb.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          avjb.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", anni.a(2131704428) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", anni.a(2131704442) + k);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", anni.a(2131704424));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(anni.a(2131704430));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  {
    Intent localIntent = new Intent(avip.c(this.jdField_b_of_type_JavaLangString));
    int i;
    if (paramBoolean)
    {
      i = 1;
      ...
      if (!paramBoolean)
      {
        if (!avip.a(this.jdField_b_of_type_JavaLangString)) {
          break label64;
        }
        avjb.a("2714209");
      }
    ...
    label64:
    while (!avip.b(this.jdField_b_of_type_JavaLangString))
    {
      return;
      i = 0;
      break;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_Avja != null) {
      this.jdField_a_of_type_Avja.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", anni.a(2131704444));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", anni.a(2131704432) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", anni.a(2131704439) + (String)localObject3 + " mPluginVersion:" + this.e);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!"huiyin".equals(this.d)) || (bgnt.a(this.jdField_a_of_type_AndroidContentContext)) || (!bool)) {
          break label559;
        }
        return;
      }
      ...
      if (avjc.jdField_a_of_type_JavaUtilMap.get(this.d) != null) {
        avjb.b(String.valueOf(((avjc)avjc.jdField_a_of_type_JavaUtilMap.get(this.d)).g));
      }
      localObject3 = null;
      break;
      label553:
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", anni.a(2131704438));
