  ...
  implements apag
{
  ...
  public afgv(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new afgw(this);
  ...
  {
    int i = arni.a(arof.a(paramMessageForDeviceSingleStruct.strMediaFileName));
    Object localObject2 = arni.a(paramMessageForDeviceSingleStruct);
    ...
    if (i == 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ((localObject3 instanceof MessageForDeviceSingleStruct))
        {
          ...
          if (arni.a(arof.a(((MessageForDeviceSingleStruct)localObject3).strMediaFileName)) == 0) {
            ((ArrayList)localObject1).add(String.valueOf(arni.a((MessageForDeviceSingleStruct)localObject3).nSessionId));
          }
        }
      }
  ...
  protected View a(MessageRecord paramMessageRecord, aekx paramaekx, View paramView, LinearLayout paramLinearLayout, aeov paramaeov)
  {
    ...
    paramLinearLayout = (afgy)paramaekx;
    paramaekx = paramView;
    if (paramView == null)
    {
      paramaekx = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558768, null);
      paramLinearLayout.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramaekx.findViewById(2131376749));
      paramLinearLayout.c = ((TextView)paramaekx.findViewById(2131376748));
      paramLinearLayout.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramaekx.findViewById(2131376739));
      paramLinearLayout.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramaekx.findViewById(2131379671));
      paramLinearLayout.d = ((TextView)paramaekx.findViewById(2131376734));
      paramLinearLayout.e = ((TextView)paramaekx.findViewById(2131376736));
    }
    ...
    for (paramMessageRecord = (MessageForDeviceSingleStruct)paramMessageRecord;; paramMessageRecord = null)
    {
      ...
      if ((paramMessageRecord.strTitle != null) && (!TextUtils.isEmpty(paramMessageRecord.strTitle)))
      {
        ...
        paramLinearLayout.c.setText(bdjj.a(this.jdField_a_of_type_AndroidContentContext, l * 1000L));
        ...
        if (bdcs.b(paramMessageRecord.strCoverPath)) {
          break label550;
        }
        ((ztk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(paramMessageRecord, paramaekx, this);
      }
      for (;;)
      {
        if ((!bdcs.b(paramMessageRecord.strMediaPath)) && (bdee.h(bexd.a().a())))
        {
          paramView = (ztk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49);
          ((zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramMessageRecord.senderuin));
          paramView.a().a(paramMessageRecord);
        }
        paramaekx.setTag(paramLinearLayout);
        ...
        break label342;
        label550:
        if ((!TextUtils.isEmpty(paramMessageRecord.faceRect)) && (!bdcs.b(paramMessageRecord.strMediaPath)))
        {
          paramView = (ztk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49);
          if (((zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramMessageRecord.senderuin)).isAdmin == 1) {
            paramView.a().a(paramMessageRecord);
          }
        }
      }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800465F", "0X800465F", 0, 0, "" + paramInt, "", "", "");
      return;
  ...
  {
    afgy localafgy = (afgy)aekt.a(paramView);
    if (localafgy == null) {
    ...
    do
    {
      do
      {
        return;
        paramView = null;
        if ((localafgy.jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForDeviceSingleStruct)) {
          paramView = (MessageForDeviceSingleStruct)localafgy.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        }
  ...
  protected void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, afgy paramafgy)
  {
    if ((paramMessageForDeviceSingleStruct.nDataType == 1) && (bdcs.b(paramMessageForDeviceSingleStruct.strMediaPath))) {}
    for (;;)
    {
      int k;
      int j;
      ...
      try
      {
        k = ((WindowManager)bexd.a().a().getSystemService("window")).getDefaultDisplay().getWidth() - 156;
        j = (int)(this.jdField_a_of_type_Float * 150.0F);
        i = k;
        if (k <= 0) {
          i = j;
        }
        paramMessageForDeviceSingleStruct = banw.a(paramMessageForDeviceSingleStruct.strMediaPath, i, j, paramMessageForDeviceSingleStruct.strCoverMD5);
        if (paramMessageForDeviceSingleStruct != null)
        {
          ...
          paramafgy.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramMessageForDeviceSingleStruct);
        }
        return;
      }
      catch (Exception paramMessageForDeviceSingleStruct)
      {
        paramafgy.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837964);
        return;
      }
      if (bdcs.b(paramMessageForDeviceSingleStruct.strCoverPath)) {
        try
        {
          k = ((WindowManager)bexd.a().a().getSystemService("window")).getDefaultDisplay().getWidth() - 156;
          j = (int)(this.jdField_a_of_type_Float * 150.0F);
          ...
          paramMessageForDeviceSingleStruct = banw.a(paramMessageForDeviceSingleStruct.strCoverPath, i, j, paramMessageForDeviceSingleStruct.strCoverMD5);
          if (paramMessageForDeviceSingleStruct != null)
          {
            paramMessageForDeviceSingleStruct = URLDrawable.getDrawable(paramMessageForDeviceSingleStruct);
            paramafgy.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramMessageForDeviceSingleStruct);
  ...
  public bdlb[] a(View paramView)
  {
    ...
    if ((i != 0) && (aukx.a().a())) {
      paramView.a(2131370842, this.jdField_a_of_type_AndroidContentContext.getString(2131694625), 2130838685);
    }
    return paramView.a();
  }
}
