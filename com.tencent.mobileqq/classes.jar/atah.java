  ...
  implements Manager
{
  ...
  protected HashMap<Long, atam> a;
  protected HashSet<String> a;
  protected boolean a;
  protected boolean b = true;
  
  public atah(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Atao = new atao();
  ...
  {
    axqw.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "pay_like", paramString1, 0, 0, paramString3, paramString4, paramString5, paramString6);
  ...
  {
    if ((this.jdField_a_of_type_Atao == null) || (this.jdField_a_of_type_Atao.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg == null)) {
      return null;
    }
    return a(this.jdField_a_of_type_Atao.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_first_info.get());
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Atao.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Atao.c = paramInt2;
        this.jdField_a_of_type_Atao.d = paramInt3;
        if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        atam localatam = (atam)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localatam == null)
        {
          if ((paramInt1 > 0) || (paramInt2 > 0))
          {
            localatam = new atam();
            localatam.jdField_a_of_type_Long = paramLong;
            localatam.jdField_a_of_type_Int += paramInt1;
            localatam.b += paramInt2;
            localatam.c += this.jdField_a_of_type_Atao.b * paramInt2;
            this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localatam);
            localObject2 = this.jdField_a_of_type_Atao;
            ((atao)localObject2).f += 1;
            localObject2 = this.jdField_a_of_type_Atao;
            ((atao)localObject2).e -= this.jdField_a_of_type_Atao.b * paramInt2;
          }
          if (QLog.isColorLevel())
          {
      ...
      localObject1.c += this.jdField_a_of_type_Atao.b * paramInt2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localObject1);
      Object localObject2 = this.jdField_a_of_type_Atao;
      ((atao)localObject2).e -= this.jdField_a_of_type_Atao.b * paramInt2;
      continue;
      label377:
      boolean bool = false;
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString1, atap paramatap, String paramString2)
  {
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyLikeLimitManager", 2, "checkCanDoVote, uin=" + paramString1 + ", from=" + paramString2 + ", mLimitInfo=" + this.jdField_a_of_type_Atao);
        }
        ...
        if ((bool1) && (c()))
        {
          ...
          if (i != 0)
          {
            paramActivity = bbcv.a(paramActivity, 0, null, localSpannableString, ajyc.a(2131707202), ajyc.a(2131707198), ajyc.a(2131707197), new atai(this, bool1, paramString1, paramatap, paramQQAppInterface, paramString2, paramActivity), new ataj(this, paramActivity, paramQQAppInterface, paramString2));
        ...
        if (a())
        {
          ...
          paramatap.a(paramString1, false);
  ...
  {
    bbcv.a(paramActivity, 230).setTitle(ajyc.a(2131707203)).setMessage(ajyc.a(2131707199)).setNegativeButton(ajyc.a(2131707201), new atal(this)).setPositiveButton(ajyc.a(2131707200), new atak(this, paramActivity)).show();
  }
  
  public void a(atao paramatao, List<atam> paramList, int paramInt)
  {
    try
    {
      this.jdField_a_of_type_Atao = paramatao;
      if (paramInt == 511) {
        this.jdField_a_of_type_JavaUtilHashMap.clear();
      }
      paramatao = new StringBuilder();
      if ((paramList != null) && (paramList.size() > 0))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          atam localatam = (atam)paramList.next();
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localatam.jdField_a_of_type_Long), localatam);
          if (QLog.isColorLevel()) {
            paramatao.append(localatam).append(" | ");
          }
        }
      }
      if (!QLog.isColorLevel()) {
    ...
    QLog.d("NearbyLikeLimitManager", 2, "updateFromServer, mLimitInfo=" + this.jdField_a_of_type_Atao + ", mLikeItemMap=[" + paramatao + "]");
    label165:
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Atao.e >= this.jdField_a_of_type_Atao.b)
        {
          bool1 = bool2;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Atao.f < this.jdField_a_of_type_Atao.c) {
          break label165;
        }
        bool1 = true;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        bool1 = false;
        break label219;
        if ((this.jdField_a_of_type_Atao.f >= this.jdField_a_of_type_Atao.c) && (localObject.b > 0))
        {
  ...
  public boolean a(String paramString)
  {
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 35	atah:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   61: aload_1
  ...
  public SpannableString b()
  {
    ...
    return a(this.jdField_a_of_type_Atao.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_user_num_limit_info.get());
  }
  ...
  public boolean b(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        atam localatam = (atam)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        boolean bool1;
        if ((this.jdField_a_of_type_Atao == null) || (localatam == null))
        {
          if (QLog.isColorLevel())
          {
        ...
        if (localatam.jdField_a_of_type_Int >= this.jdField_a_of_type_Atao.d)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public SpannableString c()
  {
    ...
    return a(this.jdField_a_of_type_Atao.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_zan_limit_info.get());
  }
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Atao != null) && (this.jdField_a_of_type_Atao.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	atah:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: lload_1
    ...
    //   13: checkcast 335	atam
    //   16: astore 5
    //   18: aload_0
    //   19: getfield 25	atah:jdField_a_of_type_Atao	Latao;
    //   22: astore 6
    //   24: aload 6
    //   26: ifnull +8 -> 34
    //   29: aload 5
    ...
    //   16	27	5	localatam	atam
    //   64	5	5	localObject	Object
    //   22	3	6	localatao	atao
    // Exception table:
    //   from	to	target	type
    //   2	24	64	finally
    //   42	48	64	finally
  ...
  public boolean d()
  {
    if ((this.b) && (this.jdField_a_of_type_Atao != null) && (this.jdField_a_of_type_Atao.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
