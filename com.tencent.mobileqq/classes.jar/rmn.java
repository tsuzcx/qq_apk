...
public class rmn
{
  ...
  private static int a(JSONObject paramJSONObject, rnn paramrnn)
  {
    int j = -1;
    int i = j;
    ...
    try
    {
      paramrnn.jdField_a_of_type_Int = Integer.valueOf(paramJSONObject.getString("moduleType")).intValue();
      paramrnn.jdField_a_of_type_OrgJsonJSONObject = paramJSONObject;
      i = paramrnn.jdField_a_of_type_Int;
      return i;
    }
    ...
    try
    {
      if (paramFastWebArticleInfo.b())
      {
        ...
        for (;;)
        {
          ...
          {
            localJSONObject.put("comment_count", bhvy.a(paramFastWebArticleInfo.b, 99990000L, "9999万+", rmm.a));
            localJSONObject.put("count_txt_color", "#FFFFFF");
            localJSONObject.put("count_bg_color", "#FF4222");
          }
          localObject = (rnn)paramFastWebArticleInfo.jdField_a_of_type_AndroidUtilSparseArray.get(999);
          if (localObject != null) {
            a(localJSONObject, ((rnn)localObject).jdField_a_of_type_OrgJsonJSONObject);
          }
  ...
  public static ProteusItemData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, int paramInt3, SparseArray<Float> paramSparseArray)
  {
    ...
    //   19: aload 7
    //   21: aload 8
    //   23: invokestatic 244	rnb:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   26: astore_2
    //   27: aload 11
    //   29: aload_2
    //   30: aload_3
    ...
    //   39: aload 8
    //   41: iload 9
    //   43: invokestatic 247	rnb:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    //   46: aload 11
    //   48: aload_0
    //   49: aload_1
    //   50: invokestatic 226	rmn:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   53: astore_0
    //   54: aload_0
    //   55: iconst_1
    ...
    //   59: aload_0
    //   60: aload 10
    //   62: invokestatic 254	rmn:a	(Landroid/util/SparseArray;)F
  ...
  public static ProteusItemData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, String paramString1, String paramString2, String paramString3, SparseArray<Float> paramSparseArray)
  {
    ...
    //   12: aload 4
    //   14: aload_2
    //   15: invokestatic 270	rml:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   18: istore 6
    //   20: aload 7
    //   22: aload_0
    //   23: aload_1
    //   24: invokestatic 226	rmn:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   27: astore_0
    //   28: aload_0
    //   29: iconst_1
    ...
    //   33: aload_0
    //   34: aload 5
    //   36: invokestatic 254	rmn:a	(Landroid/util/SparseArray;)F
  ...
  public static ProteusItemData a(String paramString, CharSequence paramCharSequence, int paramInt1, int paramInt2, SparseArray<Float> paramSparseArray)
  {
    ...
    //   85: aconst_null
    //   86: aconst_null
    //   87: invokestatic 226	rmn:a	(Lorg/json/JSONObject;Lcom/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo;Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/util/FastWebArticleInfo;)Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/ProteusItemData;
    //   90: astore_0
    //   91: aload_0
    //   92: aload 4
    //   94: invokestatic 254	rmn:a	(Landroid/util/SparseArray;)F
  ...
  public static ProteusItemData a(String paramString1, String paramString2, SparseArray<Float> paramSparseArray)
  {
    ...
    try
    {
      ...
      localJSONObject.put("attribute_text_size", rmo.a());
  ...
  private static void a(ProteusItemData paramProteusItemData, JSONObject paramJSONObject, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo)
  {
    try
    {
      ...
      paramProteusItemData.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusBeanTemplateBean = ProteusParser.getTemplateBean(rpr.a("native_article", true), paramJSONObject);
      return;
    }
  ...
  public static void a(String paramString, SparseArray<rnn> paramSparseArray)
  {
    if ((paramString != null) && (paramSparseArray != null)) {
      try
      {
        rnn localrnn = new rnn();
        ...
        while (i < localJSONArray.length())
        {
          ...
          {
            int j = a((JSONObject)localObject, localrnn);
            if (-1 != j) {
              paramSparseArray.append(j, localrnn);
            }
          }
          i += 1;
        }
  ...
  public static void a(List<BaseData> paramList, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    try
    {
      ...
      rnj.a(paramList, paramArticleInfo, paramItemShowDispatcher);
      return;
    }
  ...
  public static void b(List<BaseData> paramList, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (localObject1 = "NativeArticleLikeEnable";; str = "NativeArticleLikeDisable")
    {
      ...
      {
        localObject2 = localObject3;
        localJSONObject.put("interaction_like_count", rmk.a(paramFastWebArticleInfo.jdField_a_of_type_Int));
        localObject2 = localObject3;
        ...
        localrnn = (rnn)paramFastWebArticleInfo.jdField_a_of_type_AndroidUtilSparseArray.get(2);
        localObject2 = localObject1;
        if (localrnn != null)
        {
          localObject2 = localObject1;
          a(localJSONObject, localrnn.jdField_a_of_type_OrgJsonJSONObject);
          localObject2 = localObject1;
        }
