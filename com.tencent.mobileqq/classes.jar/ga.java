  ...
  extends Handler
{
  ...
  {
    fx localfx = (fx)paramMessage.obj;
    if (localfx == null) {}
    ...
    do
    {
      do
      {
        ...
        {
          return;
          localETTextView = (ETTextView)localfx.jdField_a_of_type_JavaLangRefWeakReference.get();
      ...
      ETTextView.mCreateDecorationHandler.obtainMessage(2, fx.a(localETTextView)).sendToTarget();
      return;
    } while (!localETTextView.isViewVisible());
    boolean bool;
    int i;
    if ((ETTextView.access$400(localETTextView).a() == localfx.jdField_a_of_type_AndroidGraphicsBitmap) && (localETTextView.mMsgId == localfx.jdField_a_of_type_Long) && (ETTextView.access$600(localETTextView) != null) && (ETTextView.access$600(localETTextView).currentFrameIndex() == localfx.jdField_a_of_type_Int) && (localETTextView.mFont != null) && (localETTextView.mFont.equals(localfx.jdField_a_of_type_Fo.a))) {
      if ((ETTextView.access$700(localETTextView)) && (ETTextView.access$800(localETTextView)) && (ETTextView.enableAnimation) && (!ETTextView.access$900(localETTextView)))
      {
        ...
        int j = (int)(System.currentTimeMillis() - localfx.b);
        if (j <= 0) {
          break label385;
        }
        i -= j;
        label268:
        paramMessage = obtainMessage(0, fx.a(localETTextView));
        if (i > 1) {
          break label308;
        }
