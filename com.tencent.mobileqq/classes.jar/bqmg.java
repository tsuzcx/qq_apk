...
public class bqmg
{
  ...
  private bqli jdField_a_of_type_Bqli = new bqli();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bqli.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bqli.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public bqmd a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Bqli.a(paramFloat1, paramFloat2);
    ...
    return new bqmd(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public bqmd a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Bqli.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bqli.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bqli.a(paramFloat1, paramFloat2);
      bqmd localbqmd = new bqmd(paramFloat1, paramFloat2, c(), a());
      localbqmd.a(bqlh.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbqmd;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bqli.c()) {}
  ...
  {
    this.jdField_a_of_type_Bqli.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bqli.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bqli.a(false);
      this.jdField_a_of_type_Bqli.b(true);
      this.jdField_a_of_type_Bqli.c(false);
      return paramBoolean;
    }
  }
  ...
  public bqmd b(float paramFloat1, float paramFloat2)
  {
    return new bqmd(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Bqli.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Bqli.c(paramBoolean);
  }
  ...
  public bqmd c(float paramFloat1, float paramFloat2)
  {
    bqmd localbqmd = new bqmd(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bqli.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bqli.d())
    {
      ...
      localbqmd.a(bqlh.a(localRectF1, localRectF2));
      return localbqmd;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Bqli.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bqli.a(paramFloat1, paramFloat2));
      localbqmd.a(bqlh.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbqmd;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localbqmd.a(bqlh.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localbqmd;
  }
  ...
  {
    this.jdField_a_of_type_Bqli.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bqli.d(true);
  }
