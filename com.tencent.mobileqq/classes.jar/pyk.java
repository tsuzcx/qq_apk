  ...
  implements agzl
{
  ...
  public pyk(@NonNull PendingIntent paramPendingIntent, @NonNull QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, PendingIntent paramPendingIntent, String paramString1, String paramString2)
  {
    ...
    paramIntent = new pyk(paramPendingIntent, paramQQAppInterface, str1, paramIntent.getStringExtra("banner_readinjoy_article_id"), str2, str3, paramIntent.getBooleanExtra("banner_readinjoy_is_weishi_mode", false));
    paramQQAppInterface = agxq.a(paramQQAppInterface, i, paramString1, paramString2, paramIntent);
    paramIntent.a();
  ...
  private void a(String paramString)
  {
    ...
    {
      localqmv = new qmv(this.d, this.jdField_a_of_type_JavaLangString, this.c, this.b);
      localqmv.h(this.b);
    ...
    {
      ndn.a(localQQAppInterface, str2, paramString, paramString, 0, 0, str1, "", "", localqmv.a().a(), false);
      return;
    }
  }
