  ...
  extends yuf
{
  ...
  {
    int k = 0;
    ykq.b("MosaicOperator", "increaseMask:x=" + paramInt1 + ",y=" + paramInt2 + ",MosaicMaskWidth:" + this.jdField_e_of_type_Int + ",MosaicMaskHeight:" + this.f);
  ...
  {
    int k = 0;
    ykq.b("MosaicOperator", "decreaseMask:x=" + paramInt1 + ",y=" + paramInt2 + ",MosaicMaskWidth:" + this.jdField_e_of_type_Int + ",MosaicMaskHeight:" + this.f);
    int[] arrayOfInt1 = new int[5];
    arrayOfInt1[0] = paramInt1;
    arrayOfInt1[1] = (paramInt1 - 1);
    arrayOfInt1[2] = paramInt1;
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      while (k < this.jdField_a_of_type_Array2dOfByte.length)
      {
        ...
        ykq.b("MosaicOperator", localStringBuilder.toString());
  ...
  public void a(Canvas paramCanvas, yug paramyug, float paramFloat)
  {
    if (paramyug.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (paramyug.jdField_a_of_type_Int == 104)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(45.0F);
        this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsBitmapShader);
        paramCanvas.drawPath(paramyug.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (paramyug.jdField_a_of_type_Int != 105);
    if (this.jdField_a_of_type_AndroidGraphicsCanvas == null)
    {
      ykq.d("MosaicOperator", "do not init yet");
      return;
    }
    ...
    if (this.h == 0) {
      this.h = AIOUtils.dp2px(16.0F, BaseApplicationImpl.getContext().getResources());
    }
    this.jdField_a_of_type_AndroidGraphicsPaint.setXfermode(null);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(this.h);
    this.jdField_a_of_type_AndroidGraphicsPaint.setShader(null);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(paramyug.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
  ...
  public void a(yrf paramyrf, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
    this.jdField_a_of_type_Yrf = paramyrf;
  ...
  public void a(yug paramyug)
  {
    if (paramyug.jdField_a_of_type_Int == 103)
    {
      ...
      ykw.a("0X80076C2");
      List localList = paramyug.jdField_a_of_type_JavaUtilList;
      paramyug = paramyug.b;
      int k = 0;
      while ((k < localList.size()) && (k < paramyug.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)paramyug.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  {
    ykq.a("MosaicOperator", "clearMp4MosaicCanvasAndDraw notify=%s", Boolean.valueOf(paramBoolean));
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Yug = new yug(new Path(), this.g);
      if (this.jdField_a_of_type_Yub != null) {
        this.jdField_a_of_type_Yub.a(this.jdField_a_of_type_Yug);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Yug.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Yug.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Yug.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Yug.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Yug.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Yug.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Yug.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Yug.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Yug.b.get(this.jdField_a_of_type_Yug.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Yug.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Yug.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        ...
        {
          this.jdField_a_of_type_Yug.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, (this.jdField_d_of_type_Float + f1) / 2.0F, (this.jdField_e_of_type_Float + f2) / 2.0F);
          this.jdField_d_of_type_Float = f1;
          this.jdField_e_of_type_Float = f2;
        }
        else if (this.g == 105)
  ...
  public void b()
  {
    ...
    {
      k = UIUtils.getWindowScreenWidth(BaseApplicationImpl.getContext());
      m = UIUtils.getWindowScreenHeight(BaseApplicationImpl.getContext());
    ...
    for (int k = 2;; k = 8) {
      for (;;)
      {
        try
        {
          ...
          ykq.a("MosaicOperator", "init matrix. scale[%f, %f]. translate[%f, %f].", Float.valueOf(f1), Float.valueOf(f1), Float.valueOf(f2), Float.valueOf(f3));
        ...
        {
          ykq.c("MosaicOperator", "initMosaicPicMode.", localOutOfMemoryError);
          return;
        }
        localBitmap = null;
        break;
  ...
  {
    ykq.b("MosaicOperator", "set MosaicSize:" + paramInt);
    this.jdField_b_of_type_Int = paramInt;
  }
  
  public void b(int paramInt1, int paramInt2)
  {
    ykq.b("MosaicOperator", "standardWidth:" + paramInt1 + ",standardHeight:" + paramInt2);
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Yrf != null)
    {
      if (this.g != 105) {
        break label50;
      }
      this.jdField_a_of_type_Yrf.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Yrf.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    {
      ykq.e("MosaicOperator", "mosaicHeightScale <= 0.");
    ...
    ykq.b("MosaicOperator", "create mosaic mask array, width:" + this.jdField_e_of_type_Int + ",height:" + this.f + ",array length:" + this.jdField_e_of_type_Int * this.f);
  ...
  public void d()
  {
    this.jdField_a_of_type_Yug = null;
    if (this.g == 104) {
      return;
    }
    if (this.g == 105)
