  ...
  implements alqd
{
  private void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = bfnx.a(paramString1);
      localMap = alqa.a(new JSONObject(paramString2));
  ...
  protected void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = bbex.a(a(), localBaseActivity, String.format("mqqapi://app/action?pkg=com.tencent.mobileqq&cmp=com.tencent.biz.PoiMapActivity&type=sharedmap&lat=%s&lon=%s&title=%s&loc=%s&dpid=null", new Object[] { paramString, str1, str2, str3 }));
      if (paramString != null)
      {
        paramString.c();
        return;
  ...
  public boolean a(String paramString1, String paramString2, JSONObject paramJSONObject, long paramLong, String paramString3)
  {
    ...
    //   68: ifeq +11 -> 79
    //   71: aload_1
    //   72: checkcast 224	aert
    //   75: aload_2
    //   76: invokevirtual 227	aert:f	(Ljava/lang/String;)V
    //   79: iconst_1
    //   80: ireturn
    //   81: aload_1
    //   82: ldc 229
    ...
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 231	alqf:a	(Ljava/lang/String;)V
    //   95: iconst_1
    //   96: ireturn
    //   97: ldc 233
    //   99: aload_1
    ...
    //   103: ifeq +31 -> 134
    //   106: aload_0
    //   107: invokevirtual 184	alqf:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   110: astore_1
    //   111: aload_1
    //   112: ifnull +20 -> 132
    //   115: aload_1
    ...
    //   122: checkcast 239	airx
    //   125: invokevirtual 242	airx:a	()Lairv;
    //   128: aload_2
    //   129: invokevirtual 245	airv:a	(Ljava/lang/String;)V
    //   132: iconst_1
    //   133: ireturn
    //   134: ldc 247
    //   136: aload_1
    ...
    //   175: astore_1
    //   176: aload_0
    //   177: invokevirtual 184	alqf:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   180: astore_2
    //   181: aload_2
    //   182: ifnull +37 -> 219
    //   185: aload_2
    //   186: bipush 20
    //   188: invokevirtual 263	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   191: checkcast 265	akhp
    ...
    //   214: lload 7
    //   216: invokevirtual 271	akhp:b	(Ljava/lang/String;J)V
    //   219: ldc_w 273
    //   222: ldc_w 275
    //   225: ldc_w 277
    //   228: iconst_1
    ...
    //   241: aastore
    //   242: invokestatic 286	bbbp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   245: getstatic 151	com/tencent/mobileqq/app/BaseActivity:sTopActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   248: aload_1
    //   249: iconst_1
    //   250: invokestatic 291	nuq:a	(Landroid/content/Context;Ljava/lang/String;I)V
    //   253: iconst_0
    //   254: ireturn
    //   255: astore_2
    //   256: aconst_null
    ...
    //   272: ifeq +13 -> 285
    //   275: invokestatic 301	alqq:a	()Lalqq;
    //   278: aload_2
    //   279: invokevirtual 302	alqq:a	(Ljava/lang/String;)V
    //   282: goto -29 -> 253
    //   285: ldc_w 304
    //   288: aload_1
    ...
    //   292: ifeq +43 -> 335
    //   295: aload_2
    //   296: invokestatic 305	bbbp:a	(Ljava/lang/String;)V
    ...
    //   378: aload_0
    //   379: invokevirtual 184	alqf:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   382: astore_1
    //   383: aload_1
    //   384: ifnull -131 -> 253
    //   387: aload_1
    ...
    //   394: checkcast 320	avno
    //   397: astore_1
    //   398: aload_1
    //   399: aload_2
    //   400: invokevirtual 321	avno:a	(Ljava/lang/String;)V
    //   403: aload_1
    //   404: aload_2
    //   405: invokevirtual 324	avno:a	(Ljava/lang/String;)Lamwq;
    //   408: astore_1
    //   409: aload_1
    //   410: ifnull +53 -> 463
    //   413: aload_1
    //   414: getfield 329	amwq:b	Ljava/lang/String;
    //   417: invokestatic 335	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   420: ifne +43 -> 463
    //   423: invokestatic 340	bhzb:a	()Lbhzb;
    //   426: invokevirtual 342	bhzb:a	()Z
    //   429: ifeq +34 -> 463
    //   432: invokestatic 347	bhyv:a	()Lbhyv;
    //   435: invokevirtual 349	bhyv:b	()V
    //   438: invokestatic 347	bhyv:a	()Lbhyv;
    //   441: invokevirtual 351	bhyv:a	()V
    //   444: ldc_w 353
    //   447: iconst_1
    //   448: aconst_null
    //   449: invokestatic 358	bdte:a	(Ljava/lang/String;ZLbdtd;)V
    //   452: invokestatic 340	bhzb:a	()Lbhzb;
    //   455: aload_1
    //   456: aconst_null
    //   457: invokevirtual 361	bhzb:a	(Lamwq;Lbhyg;)V
    //   460: goto -207 -> 253
    //   463: ldc_w 316
    //   466: iconst_1
    ...
    //   480: invokestatic 340	bhzb:a	()Lbhzb;
    //   483: invokevirtual 342	bhzb:a	()Z
    ...
    //   541: aload_0
    //   542: invokevirtual 184	alqf:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   545: astore_1
    //   546: aload_1
    //   547: ifnull -294 -> 253
    //   550: aload_1
    ...
    //   557: checkcast 320	avno
    //   560: astore_3
    //   561: aload_3
    //   562: aload_2
    //   563: invokevirtual 324	avno:a	(Ljava/lang/String;)Lamwq;
    //   566: astore_1
    //   567: aload_1
    //   568: ifnull +103 -> 671
    //   571: aload_1
    //   572: getfield 329	amwq:b	Ljava/lang/String;
    //   575: invokestatic 335	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   578: ifne +93 -> 671
    //   581: invokestatic 340	bhzb:a	()Lbhzb;
    //   584: invokevirtual 342	bhzb:a	()Z
    //   587: ifeq +84 -> 671
    //   590: sipush 600
    //   593: invokestatic 373	bhyv:a	(I)Z
    //   596: ifeq +62 -> 658
    ...
    //   688: invokestatic 340	bhzb:a	()Lbhzb;
    //   691: invokevirtual 342	bhzb:a	()Z
    ...
    //   703: aload_3
    //   704: aload_2
    //   705: invokevirtual 404	avno:b	(Ljava/lang/String;)V
    //   708: goto -455 -> 253
    //   711: aload_1
    //   712: ldc_w 406
    ...
    //   722: aload_1
    //   723: aload_2
    //   724: invokespecial 411	alqf:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   727: iconst_1
    //   728: ireturn
    //   729: astore_2
    //   730: goto -472 -> 258
