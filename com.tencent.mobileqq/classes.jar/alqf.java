  ...
  implements amqg
{
  ...
  public alqf(QQAppInterface paramQQAppInterface)
  {
  ...
  public static amqj a(UpgradeInfo paramUpgradeInfo)
  {
  ...
  private void a(awgf paramawgf, GetResourceRespInfo paramGetResourceRespInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      return;
      localAppShareID = bdff.a(paramGetResourceRespInfo);
    } while (localAppShareID == null);
    if (QLog.isColorLevel()) {
      QLog.d("share_appid", 2, "parser share appid from resp info, result:  " + localAppShareID);
    }
    paramGetResourceRespInfo = (AppShareID)paramawgf.a(AppShareID.class, "strPkgName=?", new String[] { paramGetResourceRespInfo.strPkgName });
    if (paramGetResourceRespInfo == null)
    {
      paramawgf.a(localAppShareID);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        paramawgf.b(paramGetResourceRespInfo);
        paramawgf.a(localAppShareID);
        if (QLog.isColorLevel()) {
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          bdhb.d(new File(this.app.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          bdhb.d(aeur.b);
          bool1 = false;
          aeur.a().a(this.app.getApplication());
  ...
  private void b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    do
    {
        ...
        for (;;)
        {
          ...
          if (localUpgradeInfo != null)
          {
            ...
            if ((localUpgradeInfo.iUpgradeType > 0) && (localUpgradeInfo.bNewSwitch == 1))
            {
              ...
              localObject = "1";
              azqs.b(localQQAppInterface, "CliOper", "", "", "0X8004DA5", "0X8004DA5", 0, 0, (String)localObject, "", amqe.a(), "");
            ...
            for (;;)
            {
              ...
              ((Intent)localObject).putExtra("StrTitle", alud.a(2131702810));
              ((Intent)localObject).putExtra("StrUpgradeDesc", alud.a(2131702813));
      ...
      if (paramUpgradeDetailWrapper.jdField_a_of_type_ComTencentMobileqqAppNewUpgradeConfig.dialog.jdField_a_of_type_Boolean)
      {
        ...
        bfox.a().a(BaseActivity.sTopActivity, "biz_src_yyb");
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   183: aload_0
    //   184: aload 12
    //   186: invokespecial 731	alqf:a	(Landroid/content/Intent;)V
    //   189: aload_0
    //   190: bipush 11
    //   192: iload 8
    //   194: iload 6
    //   196: invokestatic 382	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: invokevirtual 273	alqf:notifyUI	(IZLjava/lang/Object;)V
    //   202: return
    //   203: iconst_0
    //   204: istore 8
    //   206: goto -180 -> 26
    ...
    //   433: invokestatic 901	bhqi:a	(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Z
    //   436: istore 6
    ...
    //   721: invokestatic 942	bhqi:a	(Landroid/content/Context;)Z
    //   724: pop
    //   725: iload 5
    //   727: istore 6
    //   729: goto -684 -> 45
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localakgu = (akgu)this.app.getManager(114);
    ...
    this.app.a(new ConfigHandler.3(this, paramGetResourceRespInfo, localakgu, l1));
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        amqe.a().a(bool1, str2, paramToServiceMsg);
        return;
        i = 0;
        break;
  ...
  {
    arbq.jdField_a_of_type_Boolean = true;
      ...
      while (QLog.isColorLevel())
      {
        ...
        if (i == 10)
        {
          ...
          for (paramObject = paramObject.string_tips_action_url.get();; paramObject = "")
          {
            ...
            paramObject = (aqfk)this.app.getManager(292);
            paramObject.a(bool1);
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      localayec = (ayec)this.app.getManager(15);
    } while (localayec == null);
    if (!localayec.a(paramGetResourceRespInfo.uiNewVer))
    {
      notifyUI(7, true, Integer.valueOf(100));
      return;
    }
    ...
    this.app.a(new ConfigHandler.6(this, str, localayec, paramGetResourceRespInfo));
  }
  ...
  public int a(ArrayList<GetResourceReqInfo> paramArrayList, GetResourceReqInfo... paramVarArgs)
  {
    ...
    i = ayyb.jdField_a_of_type_Int;
    ayyb.jdField_a_of_type_Int = i + 1;
  ...
  public void a(int paramInt, UpgradeDetailWrapper paramUpgradeDetailWrapper, amqe paramamqe)
  {
    paramamqe = paramUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo;
    if ((paramInt == 0) && (paramamqe != null))
    {
      BaseApplicationImpl.sApplication.getPackageName();
      a(paramamqe);
      a(this.app, paramamqe.strNewTipsDescURL, paramamqe.iTipsWaitDay);
      b(this.app, paramamqe.strBannerPicUrl, paramamqe.iDisplayDay);
  ...
  public void a(String paramString, int paramInt, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    Object localObject2 = aozd.a(this.app);
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      QQOperationViopTipTask localQQOperationViopTipTask = ((aozd)localObject2).a(((QQOperationViopTipTask)paramArrayList.next()).taskid);
      ...
      ((aozd)localObject2).a(this.app, localQQOperationVoipTipsTaskExcuteRecord);
    }
    notifyUI(8, true, localObject1);
  }
  
  public void a(String paramString, int paramInt, ArrayList<aozg> paramArrayList, boolean paramBoolean)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
      ...
      try
      {
        ...
        if (paramInt == 3000)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            if (paramArrayList.hasNext())
            {
              aozg localaozg = (aozg)paramArrayList.next();
              MobileTips.TaskInfo localTaskInfo = new MobileTips.TaskInfo();
              localTaskInfo.task_id.set(localaozg.jdField_a_of_type_Int);
              localTaskInfo.msgcnt.set(localaozg.b);
              localTaskInfo.keywords.set(localaozg.jdField_a_of_type_JavaUtilArrayList);
  ...
  public boolean a()
  {
    boolean bool = bhqi.b(BaseApplicationImpl.sApplication);
    if (QLog.isDevelopLevel()) {
    ...
    try
    {
      localObject2 = bhqd.a(new File(BaseApplicationImpl.sApplication.getPackageResourcePath()));
    ...
    ((ToServiceMsg)localObject2).extraData.putInt("mv", apao.a(this.app.getApp()));
    ((ToServiceMsg)localObject2).extraData.putInt("sv", bdgk.a());
  ...
  public boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    localToServiceMsg.extraData.putInt("mv", apao.a(this.app.getApp()));
    localToServiceMsg.extraData.putInt("sv", bdgk.a());
  ...
  {
    Object localObject = (ayec)this.app.getManager(15);
    if (localObject == null) {
      return null;
    }
    long l = ((ayec)localObject).a();
  ...
  public void d()
  {
    ...
    try
    {
      ...
      ((ByteBuffer)localObject).putInt(bdeu.a(Long.parseLong(this.app.getAccount()))).putShort((short)16);
  ...
  {
    alpy localalpy = (alpy)this.app.getManager(59);
    if (localalpy == null) {
      return null;
    }
    GetResourceReqInfo localGetResourceReqInfo = new GetResourceReqInfo();
    ...
    localGetResourceReqInfo.uiCurVer = localalpy.a(true);
    localGetResourceReqInfo.sResType = 2;
    localGetResourceReqInfo.sLanType = 0;
    localGetResourceReqInfo.sReqType = 1;
    return localGetResourceReqInfo;
  ...
  public void e()
  {
    ...
    do
    {
      ...
      {
        return;
        if (aqbd.a().a(this.app, BaseApplicationImpl.getApplication()) != 0) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    else
    {
      ...
      if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
        ((alpy)this.app.getManager(59)).a(null);
      }
    }
    label119:
    do
    ...
    for (;;)
    {
      ...
      else if (paramFromServiceMsg.sResType == 2)
      {
        ...
        {
          paramObject = (alpy)this.app.getManager(59);
          if (paramObject != null) {
      ...
      {
        paramObject = (apks)this.app.getManager(77);
        if (paramObject != null) {
          paramObject.a(paramFromServiceMsg);
        }
      }
