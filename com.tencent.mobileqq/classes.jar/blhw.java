  ...
  implements Manager
{
  ...
  public blhw(QQAppInterface paramQQAppInterface)
  {
  ...
  private begb a(String paramString)
  {
    paramString = new begb(paramString, 16);
    paramString.setSpan(new ForegroundColorSpan(BaseApplicationImpl.context.getResources().getColor(2131166227)), 0, paramString.length(), 33);
    return paramString;
  }
  
  public static blhw a()
  {
    return a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  
  public static blhw a(QQAppInterface paramQQAppInterface)
  {
    return (blhw)paramQQAppInterface.getManager(313);
  }
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (amjp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = anzj.a(2131706515) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new begb("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(anzj.a(2131706514)));
      paramSpannableStringBuilder.append(new begb(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((amjp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(anzj.a(2131706516)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = anzj.a(2131706517) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131698509) + paramString;
  }
  
  public void b()
  {
    ((anum)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).h();
  }
  ...
  {
    return amjp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
