  ...
  extends pbe
{
  ...
  public paa(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  private void b()
  {
    ...
    Object localObject = this.jdField_a_of_type_Aukp.a(ChannelInfo.class, true, null, null, null, null, null, null);
    if (localObject == null)
    {
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 2) {
      if ((j == 0) && (paramToServiceMsg.msg_ks_get_subscribed_list_rsp.has()) && (((oidb_cmd0xd46.KsGetSubscribedListRsp)paramToServiceMsg.msg_ks_get_subscribed_list_rsp.get()).bytes_ks_subscribed_list.has()))
      {
        ...
        osj.a().a(new pab(this, j, paramToServiceMsg));
      }
    }
    while (i != 1) {
      for (;;)
  ...
  protected ToServiceMsg a(pox parampox)
  {
    ...
    if (parampox.jdField_a_of_type_Boolean) {
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_all_channel_list.set(1);
    }
    if (parampox.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_important.set(parampox.jdField_b_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_id.set(parampox.jdField_c_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_cover.set(parampox.jdField_d_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_seq.set(parampox.jdField_e_of_type_Int);
      localObject = pot.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      ((ToServiceMsg)localObject).getAttributes().put(c, Integer.valueOf(parampox.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put("debug", Boolean.valueOf(parampox.l));
      return localObject;
  ...
  public void a(int paramInt1, int paramInt2, List<Integer> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((oidb_cmd0x908.ReqBody)localObject).uint64_uin.set(Long.valueOf(onh.a()).longValue());
    ...
    for (;;)
    {
      ...
      localObject = pot.a("OidbSvc.0x908", 2312, 0, ((oidb_cmd0x908.ReqBody)localObject).toByteArray());
  ...
  public void a(String paramString)
  {
    ...
    localObject = pot.a("OidbSvc.0xd46", 3398, 0, ((oidb_cmd0xd46.ReqBody)localObject).toByteArray());
  ...
  public void a(boolean paramBoolean, int paramInt, List<Integer> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      a(pot.a("OidbSvc.0x8f5", 2293, 0, localReqBody.toByteArray()));
      if (QLog.isColorLevel()) {
        if (paramList != null) {
          break label150;
        }
  ...
  public void b(List<Integer> paramList)
  {
    ...
    localObject = pot.a("OidbSvc.0x69e", 1694, 0, ((oidb_cmd0x69e.ReqBody)localObject).toByteArray());
  ...
  {
    Object localObject = new pox();
    ((pox)localObject).jdField_a_of_type_Int = 4;
    ((pox)localObject).jdField_a_of_type_Boolean = true;
    ((pox)localObject).jdField_b_of_type_Boolean = true;
    ((pox)localObject).jdField_c_of_type_Boolean = false;
    ((pox)localObject).jdField_d_of_type_Boolean = true;
    ((pox)localObject).j = true;
    ((pox)localObject).k = true;
    ((pox)localObject).jdField_e_of_type_Boolean = false;
    ((pox)localObject).f = false;
    ((pox)localObject).g = false;
    ((pox)localObject).h = false;
    ((pox)localObject).jdField_b_of_type_Int = 1;
    ((pox)localObject).l = paramBoolean;
    localObject = a((pox)localObject);
  ...
  protected void c(List<qaq> paramList)
  {
    if (paramList == null) {
      return;
    }
    ...
    while (paramList.hasNext())
    {
      Iterator localIterator = ((qaq)paramList.next()).a.iterator();
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (i == 1)
      {
        ...
        {
          paramObject = poq.a(localRspBody.rpt_channel_list.get());
  ...
  public List<ChannelInfo> e()
  {
    ...
    Collections.sort((List)localObject1, new pac(this));
  ...
  {
    if (pot.a(paramFromServiceMsg, paramObject, new oidb_cmd0x69e.RspBody()) == 0) {}
  ...
  public List<Integer> g()
  {
    ...
    Collections.sort((List)localObject1, new pad(this));
    localObject2 = new ArrayList(((ArrayList)localObject1).size());
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext()) {
  ...
  {
    int i = pot.a(paramFromServiceMsg, paramObject, new oidb_cmd0x8f5.RspBody());
    if (QLog.isColorLevel()) {
