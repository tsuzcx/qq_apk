...
public class tqs
{
  ...
  private tqu jdField_a_of_type_Tqu = new tqu(this.jdField_a_of_type_Tqt);
  private tqy jdField_a_of_type_Tqy = new tqy();
  
  public tqs(@NonNull Context paramContext)
  {
  ...
  {
    urk.d("StoryPlayerTVKWrapper", "createPlayerVideoInfo, %s", new Object[] { paramString2 });
  ...
  private void b()
  {
    TVK_SDKMgr.setOnLogListener(this.jdField_a_of_type_Tqy);
    ...
    urk.d("StoryPlayerTVKWrapper", "TVK version: %s", new Object[] { TVK_SDKMgr.getSdkVersion() });
  }
