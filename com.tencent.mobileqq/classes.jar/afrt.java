...
public class afrt
  extends akil
{
  public afrt(TroopFragment paramTroopFragment) {}
  ...
  {
    if (this.a.jdField_a_of_type_Afpm != null) {
      this.a.jdField_a_of_type_Afpm.b();
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (this.a.c)
    {
      ...
      if (this.a.jdField_a_of_type_Afqs != null) {
        this.a.jdField_a_of_type_Afqs.a(this.a.b(), paramBoolean, null);
      }
    }
