...
public class axom
{
  ...
  private axos jdField_a_of_type_Axos;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajrx.jdField_a_of_type_JavaLangString + "/capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    f = ajrx.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lek.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lek.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  
  public static final axom a()
  {
    return axon.a();
  }
  
  private static axot a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lek.c("CaptureVideoFilterManager", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localaxot = new axot(i, str1, str2);
        try
        {
          lek.c("CaptureVideoFilterManager", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localaxot;
        }
      ...
      try
      {
        ...
        lek.c("CaptureVideoFilterManager", "parseConfig failed. info = " + localJSONObject);
        return localaxot;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lek.c("CaptureVideoFilterManager", "parseConfig|parse failed.context = " + paramString);
        return localaxot;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lek.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  public static void a(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lek.c("CaptureVideoFilterManager", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new baub();
          ((baub)localObject).jdField_a_of_type_Baug = new axoq();
          ...
          ((baub)localObject).jdField_c_of_type_JavaLangString = (f + "skin_color.zip");
  ...
  {
    lek.c("CaptureVideoFilterManager", "setQQShortVideoFilterConfigVersion:" + paramInt);
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if ((paramString2 != null) && (!paramString2.equals("")))
      {
        ...
        lek.c("CaptureVideoFilterManager", "compareContent newList.size=0");
        bdhb.a(jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        long l2 = System.currentTimeMillis();
        lek.c("CaptureVideoFilterManager", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lek.c("CaptureVideoFilterManager", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                if ((localFilterDesc.resMD5 != null) && (!localFilterDesc.resMD5.equals(paramString2.resMD5))) {
                  bdhb.a(paramString2.getResFold(jdField_b_of_type_JavaLangString));
                }
                lek.c("CaptureVideoFilterManager", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
                if ((localFilterDesc.iconMD5 != null) && (!localFilterDesc.iconMD5.equals(paramString2.iconMD5))) {
                  bdhb.d(paramString2.getIconFile(jdField_b_of_type_JavaLangString));
                }
              }
            }
          }
  ...
  private boolean a()
  {
    String str = bdhb.d("filter_template.cfg");
    boolean bool = b(str);
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lek.c("CaptureVideoFilterManager", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = lnz.e();
    if (paramInt2 < paramInt1)
    {
      lek.c("CaptureVideoFilterManager", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = lnz.d();
    if (l < paramLong1)
    {
      lek.c("CaptureVideoFilterManager", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = bdgk.d();
    if (paramLong1 < paramLong2)
    {
      lek.c("CaptureVideoFilterManager", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lek.c("CaptureVideoFilterManager", "getVideoEffectBeautyConfig:" + f + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bdhb.b(localFile);
      }
      b(paramContext, 0);
  ...
  {
    lek.c("CaptureVideoFilterManager", "setVideoEffectBeautyConfigVersion:" + paramInt);
  ...
  private static boolean b(Context paramContext)
  {
    ...
    lek.c("CaptureVideoFilterManager", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public void a()
  {
    this.jdField_a_of_type_Axoo = null;
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lek.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig error ");
      return;
    }
    ...
    bdhb.a(jdField_a_of_type_JavaLangString, "filter_config.xml", paramString);
    a(paramContext, paramInt);
    c();
    a(paramString);
    lek.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig sendBroadcast");
    paramContext.sendBroadcast(new Intent("action_brocassreceiver_for_filter"));
  }
  
  public void a(axoo paramaxoo)
  {
    this.jdField_a_of_type_Axoo = paramaxoo;
  }
  
  public void a(axos paramaxos)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() == 0)) {
      lek.c("CaptureVideoFilterManager", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      this.jdField_a_of_type_Axos = paramaxos;
      lek.c("CaptureVideoFilterManager", "preDownloadResource list size: " + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramaxos = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (paramaxos.hasNext())
      {
        Object localObject1 = (FilterCategory)paramaxos.next();
        if (((FilterCategory)localObject1).a != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            {
              lek.c("CaptureVideoFilterManager", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  lek.c("CaptureVideoFilterManager", "preDownloadResource icon " + (String)localObject2 + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject3 = new baub();
                    ((baub)localObject3).jdField_a_of_type_Baug = new axor(this);
                    ((baub)localObject3).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
                    ((baub)localObject3).jdField_a_of_type_Int = 0;
                    ((baub)localObject3).jdField_c_of_type_JavaLangString = ((String)localObject2);
                    ((baub)localObject3).a(localFilterDesc);
                    lel.a().a((bave)localObject3);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  lek.c("CaptureVideoFilterManager", "preDownloadResource file " + (String)localObject2 + "params.json" + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject2 = new baub();
                    ((baub)localObject2).jdField_a_of_type_Baug = new axop(this);
                    ((baub)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
                    ((baub)localObject2).jdField_a_of_type_Int = 0;
                    ((baub)localObject2).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
                    ((baub)localObject2).a(localFilterDesc);
                    lel.a().a((bave)localObject2);
                    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
                  }
                }
              }
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Axos == null));
    this.jdField_a_of_type_Axos.a(false);
  }
  ...
  public void b()
  {
    ...
    lek.c("CaptureVideoFilterManager", "init mFilterCategoryRaw size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
  }
  ...
  public void b(Context paramContext)
  {
    if (new File(f + "beauty_config.json").exists())
    {
      ...
      {
        lek.c("CaptureVideoFilterManager", "!JasonFile.exists()");
        a(paramContext);
      }
      return;
    }
    lek.c("CaptureVideoFilterManager", "BEAUTY_CONFIG  is not exsit");
  }
