...
{
  private static abws jdField_a_of_type_Abws;
  ...
  {
    if (jdField_a_of_type_Abws == null) {}
    try
    {
      if (jdField_a_of_type_Abws == null)
      {
        jdField_a_of_type_Abws = new abws();
        new HardCoderManager.1().start();
      }
      return jdField_a_of_type_Abws;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = abwo.a().a();
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, long paramLong, int paramInt7, String paramString, boolean paramBoolean)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      return abwo.a().a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramLong, paramInt7, paramString);
    }
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
    abwp localabwp = (abwp)abwo.a.obtain(abwp.class);
    localabwp.jdField_a_of_type_Int = paramInt1;
    localabwp.c = paramInt2;
    localabwp.d = paramInt3;
    localabwp.e = paramInt4;
    localabwp.b = paramInt5;
    localabwp.f = paramInt6;
    localabwp.jdField_a_of_type_Long = paramLong;
    localabwp.jdField_a_of_type_JavaLangString = paramString;
    localMessage.obj = localabwp;
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((Math.abs(System.currentTimeMillis() - l) <= 86400000L) || (!bdin.h(BaseApplicationImpl.getContext()))) {
          continue;
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      Object localObject = (abwp)paramMessage.obj;
      jdField_a_of_type_AndroidOsBundle.putInt("key_delay", ((abwp)localObject).jdField_a_of_type_Int);
      jdField_a_of_type_AndroidOsBundle.putInt("key_cpu", ((abwp)localObject).c);
      jdField_a_of_type_AndroidOsBundle.putInt("key_io", ((abwp)localObject).d);
      jdField_a_of_type_AndroidOsBundle.putInt("key_bind", ((abwp)localObject).e);
      jdField_a_of_type_AndroidOsBundle.putInt("key_timeout", ((abwp)localObject).b);
      jdField_a_of_type_AndroidOsBundle.putInt("key_scene", ((abwp)localObject).f);
      jdField_a_of_type_AndroidOsBundle.putLong("key_action", ((abwp)localObject).jdField_a_of_type_Long);
      jdField_a_of_type_AndroidOsBundle.putString("key_tag", ((abwp)localObject).jdField_a_of_type_JavaLangString);
