  ...
  implements bdgn
{
  ...
  private static Map<String, bdge> jdField_a_of_type_JavaUtilMap = new HashMap();
  private static Set<String> jdField_a_of_type_JavaUtilSet = new DownSoLoader.2();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private bdgt jdField_a_of_type_Bdgt;
  ...
  private int a(LoadParam.LoadItem paramLoadItem, @NonNull SoLoadInfo paramSoLoadInfo)
  {
    ...
    if (j == 0)
    {
      ...
      bdgv.a(paramLoadItem, paramSoLoadInfo.soPathToLoad);
      bdgv.a(paramLoadItem, paramSoLoadInfo);
      bdgv.a(paramLoadItem.name);
      i = j;
    }
    label116:
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        catch (Throwable paramString)
        {
          ...
          this.jdField_a_of_type_JavaLangString = alil.a(paramString);
        }
      }
    }
    return 6;
  ...
  private LoadExtResult a(int paramInt, String paramString)
  {
    ...
    VACDReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mReportSeq, "ver=" + this.jdField_a_of_type_ComTencentMobileqqSoloadSoLoadInfo.getVer(), "load.item.load", this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, paramInt, paramString);
    ...
    {
      bdge localbdge = (bdge)jdField_a_of_type_JavaUtilMap.get(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name);
      paramString = localbdge;
      if (localbdge == null) {
        paramString = new bdge();
      }
      boolean bool = bhnv.d(BaseApplicationImpl.getApplication());
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mCallType == LoadParam.CALL_TYPE_SYNC) {
      localLoadExtResult.failInfo = ((bdge)jdField_a_of_type_JavaUtilMap.get(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name));
    }
    if (this.jdField_a_of_type_Bdgt != null) {
      this.jdField_a_of_type_Bdgt.onLoadResult(paramInt, localLoadExtResult);
    }
  ...
  private void a(boolean paramBoolean, String paramString1, String paramString2, LoadParam.LoadItem paramLoadItem)
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      paramLoadItem.append(BaseApplicationImpl.processName).append("_").append(alil.c(paramString2));
      if (QLog.isColorLevel()) {
  ...
  private boolean a(LoadParam.LoadItem paramLoadItem)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (new File(str).exists()))
    {
      ...
      VACDReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mReportSeq, null, "load.item.load.oldpath", null, i, null);
      return i == 0;
    }
    return false;
  }
  ...
  private void b(LoadParam paramLoadParam, bdgt parambdgt)
  {
    ...
    VACDReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mReportSeq, null, "load.item.start", this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, 0, null);
  }
  ...
  private boolean b(LoadParam.LoadItem paramLoadItem)
  {
    ...
    {
      String str = bdgv.a(paramLoadItem);
      if (!TextUtils.isEmpty(str))
      {
        int i = a(str, paramLoadItem);
        VACDReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mReportSeq, null, "load.item.load.last", null, i, null);
        return i == 0;
      }
    }
    return false;
  ...
  public LoadExtResult a(LoadParam paramLoadParam)
  {
    ...
    return a(a(new bdgm(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem).a()));
  }
  
  public void a(LoadParam paramLoadParam, bdgt parambdgt)
  {
    b(paramLoadParam, parambdgt);
    if (a())
    {
      a(0);
      return;
    }
    new bdgh(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem).a(new bdgg(this));
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      bdgu.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, this.jdField_a_of_type_ComTencentMobileqqSoloadSoLoadInfo.getVer(), 0);
      return;
