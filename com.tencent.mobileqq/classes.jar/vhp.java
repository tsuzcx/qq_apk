...
{
  public vhp(StructingMsgItemBuilder paramStructingMsgItemBuilder) {}
    ...
    case 2131368590: 
      do
      {
        ...
        do
        {
          ...
          paramView = paramView.getContext().getResources().getDrawable(2130841490);
        ...
        localTroopTopicMgr.a((ChatMessage)localObject2, 1, new vhq(this));
        return;
