  ...
  implements Handler.Callback
{
  ...
  public ayhx(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Bjqz = new ayia(this);
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new ayif(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new ayig(this, paramView3);
    }
  ...
  private void b(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new ayhy(this, paramView2, paramView1, paramView3));
      this.jdField_b_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new ayhz(this, paramView3, paramView1);
    }
  ...
  public void a()
  {
    ...
    ((PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(79)).d();
  ...
  {
    PortalManager localPortalManager = (PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(79);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsCountDownTimer = new ayib(this, arrayOfLong[1], 40L, arrayOfLong);
  ...
  public boolean c()
  {
    ...
    localAlphaAnimation.setAnimationListener(new ayic(this));
    ...
    localTranslateAnimation.setAnimationListener(new ayid(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new ayie(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_e_of_type_Int = 0;
      ((PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(79)).a(this.jdField_a_of_type_AndroidAppActivity);
      return false;
      if (!this.jdField_d_of_type_Boolean) {
        break;
      }
      paramMessage = (PortalManager)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().getAppInterface().getManager(79);
      if (paramMessage == null) {
        break;
      }
      paramMessage.b(4);
