...
public class aktz
{
  public static aktz a;
  private static LRULinkedHashMap<String, LruCache<String, akub>> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(2);
  private static HashMap<String, aljn> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  public static aktz a()
  {
    if (jdField_a_of_type_Aktz == null) {}
    try
    {
      if (jdField_a_of_type_Aktz == null) {
        jdField_a_of_type_Aktz = new aktz();
      }
      return jdField_a_of_type_Aktz;
    }
    finally {}
  }
  ...
  {
    return aliu.a + "/game/" + String.valueOf(paramString);
  }
  
  /* Error */
  public akub a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_1
    ...
    //   11: ifne +666 -> 677
    //   14: getstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   17: ifnonnull +13 -> 30
    //   20: new 22	java/util/HashMap
    //   23: dup
    //   24: invokespecial 24	java/util/HashMap:<init>	()V
    //   27: putstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   30: aload_2
    //   31: invokestatic 72	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   34: istore_3
    //   35: iload_3
    //   36: invokestatic 77	aljn:a	(I)Z
    //   39: ifne +654 -> 693
    ...
    //   58: iload_3
    //   59: ifeq +62 -> 121
    //   62: getstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   65: astore 5
    //   67: aload 5
    //   69: monitorenter
    //   70: aload_2
    ...
    //   74: istore 4
    //   76: getstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   79: aload_2
    //   80: invokevirtual 95	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   83: checkcast 74	aljn
    //   86: ifnonnull +32 -> 118
    //   89: new 74	aljn
    //   92: dup
    //   93: iload 4
    //   95: invokespecial 96	aljn:<init>	(I)V
    //   98: astore 6
    //   100: aload 6
    //   102: invokevirtual 99	aljn:b	()Z
    //   105: ifeq +251 -> 356
    //   108: getstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   111: aload_2
    //   112: aload 6
    ...
    //   126: aconst_null
    //   127: iconst_1
    //   128: invokestatic 108	akuf:a	(Ljava/lang/String;ILjava/lang/String;Z)Ljava/lang/String;
    //   131: astore 7
    //   133: aload 7
    //   135: invokestatic 66	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   138: ifne +539 -> 677
    //   141: getstatic 20	aktz:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   144: aload_2
    ...
    //   162: aload_0
    //   163: ldc 114
    //   165: invokespecial 117	akua:<init>	(Laktz;I)V
    //   168: astore 5
    //   170: getstatic 20	aktz:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   173: aload_2
    //   174: aload 5
    ...
    //   198: iload_3
    //   199: ifeq +366 -> 565
    //   202: getstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   205: astore 8
    //   207: aload 8
    //   209: monitorenter
    //   210: getstatic 26	aktz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   213: aload_2
    //   214: invokevirtual 95	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   217: checkcast 74	aljn
    //   220: astore 6
    //   222: aload_2
    //   223: invokestatic 123	aktz:a	(Ljava/lang/String;)Ljava/lang/String;
    //   226: astore_2
    //   227: aload 7
    ...
    //   259: aload 6
    //   261: aload_2
    //   262: invokevirtual 134	aljn:a	(Ljava/lang/String;)Z
    //   265: ifeq +14 -> 279
    //   268: aload 6
    //   270: aload 7
    //   272: aload_2
    //   273: invokevirtual 137	aljn:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   276: ifne +116 -> 392
    //   279: ldc 85
    //   281: iconst_1
    ...
    //   392: new 121	akub
    //   395: dup
    //   396: invokespecial 159	akub:<init>	()V
    //   399: astore 6
    //   401: aload 6
    //   403: astore_2
    //   404: aload 6
    //   406: aload 7
    //   408: putfield 161	akub:b	Ljava/lang/String;
    //   411: ldc 163
    //   413: astore_1
    //   414: aload 6
    //   416: astore_2
    ...
    //   433: aload 6
    //   435: aload_1
    //   436: putfield 171	akub:a	Ljava/lang/String;
    //   439: aload 6
    //   441: astore_2
    //   442: aload 6
    //   444: invokevirtual 173	akub:a	()V
    //   447: aload 6
    //   449: astore_2
    //   450: aload 5
    //   452: aload 7
    ...
    //   565: new 121	akub
    //   568: dup
    //   569: invokespecial 159	akub:<init>	()V
    //   572: astore_2
    //   573: aload_2
    //   574: aload 7
    //   576: putfield 161	akub:b	Ljava/lang/String;
    //   579: ldc 163
    //   581: astore_1
    //   582: aload 7
    //   584: ldc 165
    ...
    //   595: aload_2
    //   596: aload_1
    //   597: putfield 171	akub:a	Ljava/lang/String;
    //   600: aload_2
    //   601: invokevirtual 173	akub:a	()V
    //   604: aload 5
    //   606: aload 7
    //   608: aload_2
