...
public class xji
{
  public static final HashMap<String, xji> a;
  int jdField_a_of_type_Int = 0;
  public SharedPreferences a;
  public ClassLoader a;
  public Object a;
  public String a;
  mzv jdField_a_of_type_Mzv = new mzv();
  public xjh a;
  ...
  public xji(String paramString1, String paramString2)
  {
  ...
  public bbwl a()
  {
    return ((bbwi)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(47)).a(1);
  }
  
  public void a()
  {
    bcic localbcic = (bcic)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(107);
    try
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localbcic.notifyUI(3, true, Integer.valueOf(4));
        return;
      }
      ...
      if ((!mze.a(BaseApplicationImpl.getContext(), str, new xjj(this, l, localbcic, localBaseApplication))) && (QLog.isColorLevel()))
      {
  ...
  public void a(BaseActivity paramBaseActivity)
  {
    ...
    {
      this.jdField_a_of_type_Xjh = new xjh(paramBaseActivity, 0, this.jdField_a_of_type_Xjh);
      return;
    }
    this.jdField_a_of_type_Xjh = new xjh(paramBaseActivity, 0, this.e, this.jdField_a_of_type_JavaLangClassLoader);
  }
  ...
  public void a(JSONObject paramJSONObject, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = mzk.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      ThreadManager.post(new ViewPluginLoader.5(this, paramJSONObject, paramQQAppInterface, new xjl(this, paramQQAppInterface, bool2, bool1)), 8, null, false);
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  public boolean a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(mzk.b(str2)))
        {
          paramBoolean2 = false;
          continue;
        }
      ...
      else if (paramBoolean2)
      {
        ...
        if (((File)localObject).exists())
        {
          ...
          if (!paramBoolean2) {
            paramBoolean1 = bbdj.b(paramString, str2);
          }
        }
        else
        {
  ...
  public void b()
  {
    ...
    {
      mze.a = bool;
      String str = mze.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("ViewPluginLoader", 2, "checkOfflineAndLoad version = " + str);
      }
      if ((!new File(mzk.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.jdField_b_of_type_JavaLangString).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
        bbdj.a(mzk.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString);
      }
    ...
    mze.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new xjk(this, localQQAppInterface), false);
  }
  
  public void c()
  {
    this.jdField_a_of_type_Xjh = null;
  }
}
