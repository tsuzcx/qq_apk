  ...
  extends BaseAdapter
{
  ...
  public static final int c = bajq.b(10.0F);
  float jdField_a_of_type_Float;
  private Context jdField_a_of_type_AndroidContentContext;
  private ArrayList<bhge> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  ...
  static
  {
    jdField_a_of_type_Int = bajq.b(40.0F);
    jdField_b_of_type_Int = bajq.b(5.0F);
  }
  
  public bhgd(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      ((URLImageView)localObject1).setId(2131302061);
      ...
      localObject3 = new bhge();
      ((bhge)localObject3).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject1);
      ((bhge)localObject3).jdField_a_of_type_AndroidViewView = localFrameLayout;
      ((bhge)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject2);
      ((bhge)localObject3).jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
  ...
  private void b(ImageView paramImageView, String paramString)
  {
    ...
    localObject1 = baop.a(BaseApplicationImpl.sApplication.getRuntime(), (String)localObject1 + (String)localObject2, paramString, null, new int[] { 16 }, "-Transition-", null);
  ...
  public void a()
  {
    TransitionCategoryItem localTransitionCategoryItem = bjac.a().a();
    ...
    {
      localbhge = (bhge)localIterator.next();
      if (localbhge.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem == null) {
        break label116;
      }
      if (localTransitionCategoryItem == null) {
        break label111;
      }
      bool2 = TextUtils.equals(localTransitionCategoryItem.a, localbhge.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.a);
      bool1 = bool2;
      if (!bool2)
      {
        if (((localTransitionCategoryItem != null) && (!localTransitionCategoryItem.c())) || (!localbhge.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.c())) {
          break label105;
        }
        bool1 = true;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (this.jdField_b_of_type_Float = ((this.jdField_a_of_type_Float - paramViewGroup.getPaddingLeft() - paramViewGroup.getPaddingRight()) / 3.2F + 0.5F);; this.jdField_b_of_type_Float = ((this.jdField_a_of_type_Float - paramViewGroup.getPaddingLeft() - paramViewGroup.getPaddingRight()) / 4.0F + 0.5F))
    {
      ...
      if ((paramViewGroup.getTag() != null) && ((paramViewGroup.getTag() instanceof bhge))) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    bhge localbhge = (bhge)paramViewGroup.getTag();
    TextView localTextView = localbhge.jdField_a_of_type_AndroidWidgetTextView;
    URLImageView localURLImageView = localbhge.jdField_a_of_type_ComTencentImageURLImageView;
    ...
    localbhge.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem = localTransitionCategoryItem;
    paramView = bjac.a().a();
    if (paramView != null) {}
    for (boolean bool1 = TextUtils.equals(paramView.a, localTransitionCategoryItem.a);; bool1 = false)
    {
      ...
      try
      {
        ...
        paramViewGroup.setContentDescription(localTransitionCategoryItem.b + ajjy.a(2131649274));
        return paramViewGroup;
      }
