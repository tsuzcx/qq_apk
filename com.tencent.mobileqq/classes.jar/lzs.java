...
public class lzs
  extends lzj
{
  public lzs(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = "SmallScreenVideo";
    this.i = 2131559772;
    this.j = paramContext.getResources().getDimensionPixelSize(2131297857);
    this.k = paramContext.getResources().getDimensionPixelSize(2131297849);
  }
  
  private void a(int paramInt)
  {
    Object localObject = this.jdField_a_of_type_Lzp.a;
    WindowManager.LayoutParams localLayoutParams = this.jdField_a_of_type_Lzp.a();
  ...
  {
    if ((paramBoolean) && (!this.jdField_a_of_type_Lzp.b())) {
      a(paramInt);
    }
