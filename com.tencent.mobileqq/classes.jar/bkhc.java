...
{
  private final bkhd jdField_a_of_type_Bkhd;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bkhc(bkhd parambkhd, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bkhd = parambkhd;
  ...
  private void b(bkgi parambkgi)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Bkhd.a(parambkgi.a(), true, false, false, str2);
                return;
              }
            } while (parambkgi.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Bkhd.a(parambkgi.a(), false, false, true, "");
              return;
            }
          } while (parambkgi.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Bkhd.a(parambkgi.a(), false, true, false, "");
            return;
          }
        } while (parambkgi.d());
        localObject = IOUtils.ensureFilePath(str4, parambkgi.a().b);
      } while (parambkgi.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Bkhd.a(parambkgi.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (parambkgi.d());
    this.jdField_a_of_type_Bkhd.a(parambkgi.a(), false, false, false, (String)localObject);
  }
  
  public void a(bkgi parambkgi)
  {
    if (parambkgi == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, parambkgi));
  }
