  ...
  implements View.OnClickListener
{
  ...
  {
    if ((!adkr.a(this.a)) || (this.a.a()) || (System.currentTimeMillis() - adkr.a(this.a) < 600L)) {}
    ...
    do
    {
      do
      {
        ...
        {
          return;
          adkr.a(this.a, System.currentTimeMillis());
          localMessageForApollo = (MessageForApollo)((adlw)actj.a(paramView)).a;
          ...
          {
            bcql.a(paramView.getContext(), ajya.a(2131700343), 0).a();
            return;
          }
          if (!ApolloEngine.a())
          {
      ...
      localObject = (airx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    ...
    for (;;)
    {
      int k = ((airx)localObject).b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
