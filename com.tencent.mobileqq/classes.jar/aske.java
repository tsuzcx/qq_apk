  ...
  implements Manager
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = ajya.a(2131702220);
    jdField_b_of_type_JavaLangString = ajya.a(2131702219);
  }
  
  public aske(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    {
      i = ((aske)paramQQAppInterface.getManager(200)).a(paramMessageForMarketFace.time, String.valueOf(localMarkFaceMessage.dwTabID), localMarkFaceMessage.copywritingContent, localMarkFaceMessage.copywritingType);
      if (i != 0) {
        break label70;
      }
    ...
    for (;;)
    {
      try
      {
        paramMessageForMarketFace.msgData = akwa.a(localMarkFaceMessage);
        return;
      }
