  ...
  extends ajfb
{
  ...
  public kwl(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Kwk.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(mjg.b());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Kwg;
    localObject1 = kwg.a(paramArrayOfByte);
    paramArrayOfByte = ((kwh)localObject1).a;
    localObject1 = ((kwh)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      kwg localkwg = this.jdField_a_of_type_Kwg;
      localToServiceMsg.putWupBuffer(kwg.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (badq.g(this.mApp.getApplication().getApplicationContext())) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Kwg;
      paramObject = kwg.a(paramFromServiceMsg.getWupBuffer());
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Kwk.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.e())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Kwk.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              kwg localkwg = this.jdField_a_of_type_Kwg;
              QLog.d("AudioTransClientInterfaceHandler", 2, kwg.a(paramObject.fixed32_IP.get()));
              ...
              localkwg = this.jdField_a_of_type_Kwg;
              QLog.d("AudioTransClientInterfaceHandler", 2, kwg.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
