...
public class smj
{
  private static smj jdField_a_of_type_Smj;
  ...
  public static smj a()
  {
    if (jdField_a_of_type_Smj == null) {}
    try
    {
      if (jdField_a_of_type_Smj == null) {
        jdField_a_of_type_Smj = new smj();
      }
      return jdField_a_of_type_Smj;
    }
    finally {}
  }
  
  public static tkf a(Bundle paramBundle)
  {
    paramBundle = paramBundle.getParcelable("daily_bottom_entry_data");
    if ((paramBundle instanceof tkf)) {
      return (tkf)paramBundle;
    }
    return null;
  }
  ...
  public View.OnClickListener a(Activity paramActivity, View paramView, ogr paramogr)
  {
    switch (a())
    {
    case 1: 
    default: 
      return new smm(this, paramActivity);
    case 3: 
      return new smk(this, paramogr);
    case 0: 
      return null;
    }
    return new sml(this, paramActivity);
  }
  
  public void a()
  {
    if (a() != 0) {
      oat.a(null, "CliOper", "", "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", a(), false);
    }
  }
  ...
  public void b()
  {
    oat.a(null, "CliOper", "", "", "0X80094FF", "0X80094FF", 0, 0, "", "", "", a(), false);
  }
}
