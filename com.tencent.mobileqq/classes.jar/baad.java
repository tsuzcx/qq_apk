  ...
  implements anui, axrb
{
  ...
  public baad(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Awno.jdField_b_of_type_Boolean = true;
    paramQQAppInterface.removeObserver(this.jdField_a_of_type_Awmf);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    beic.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, paramString, j);
  ...
  {
    new biib("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getMusicList").a("getMusicList", new GetMusicListReq(paramLong, "", 100L, new SourceInfo(3, "8.4.5"), 0), new GetMusicListRsp(), this, false);
  }
  ...
  {
    new biib("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getQzoneMusicInfo").a("getQzoneMusicInfo", new GetQzoneMusicInfoReq(paramLong, paramArrayList, new SourceInfo(3, "8.4.5")), new GetQzoneMusicInfoRsp(), new baae(this), false);
  }
  ...
  public void a(Context paramContext, SongInfo paramSongInfo)
  {
    ...
    {
      return;
      new Intent(paramContext, QQBrowserActivity.class).putExtra("url", blhn.a(arns.a().jdField_b_of_type_JavaLangString, "uin", String.valueOf(this.jdField_a_of_type_Long)));
  ...
  public void a(SongInfo paramSongInfo)
  {
    ...
    this.jdField_a_of_type_Awno.jdField_a_of_type_JavaLangString = paramSongInfo.e;
    if (a()) {
  ...
  public void a(String paramString)
  {
    ...
    if (localawnq != null)
    {
      this.jdField_a_of_type_Awno.jdField_a_of_type_Int = localawnq.a().jdField_a_of_type_Int;
      this.jdField_a_of_type_Awno.jdField_b_of_type_Int = localawnq.a().jdField_b_of_type_Int;
      this.jdField_a_of_type_Awno.jdField_a_of_type_Boolean = localawnq.a().jdField_a_of_type_Boolean;
      if (localawnq.a()) {
        localawnq.b(localawnq.a().e, localawnq.a().jdField_b_of_type_JavaLangString);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("ProfileMusicBoxController", 2, "showLyrics");
    }
    if ((TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Awno.jdField_b_of_type_JavaLangString)))
    {
      super.a(j, this.jdField_a_of_type_Awno.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  public void c()
  {
    baac.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.getContext(), this.jdField_a_of_type_Awno.jdField_b_of_type_JavaLangString);
    String str;
    if (this.i)
    {
      str = "";
    ...
    for (int k = 1;; k = 2)
    {
      bdll.b(null, "dc00898", "", str, "qq_vip", "0X800A7DF", k, 0, "", "", "", "");
      return;
  ...
  public void d()
  {
    ...
    for (int k = 1;; k = 2)
    {
      bdll.b(null, "dc00898", "", str, "qq_vip", "0X800A7E0", k, 0, "", "", "", "");
      return;
      str = String.valueOf(this.jdField_a_of_type_Long);
      break;
    }
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Baaf = null;
    super.e();
    beic.a().b();
  }
  ...
  public void j()
  {
    super.b(j, this.jdField_a_of_type_Awno.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Awno.e = 0;
    b(j, this.jdField_a_of_type_Awno.jdField_b_of_type_JavaLangString, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      awnq localawnq = ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a();
      if (localawnq != null)
      {
        localawnq.a().jdField_a_of_type_Int = this.jdField_a_of_type_Awno.jdField_a_of_type_Int;
        localawnq.a().jdField_b_of_type_Int = this.jdField_a_of_type_Awno.jdField_b_of_type_Int;
        localawnq.a().jdField_a_of_type_Boolean = this.jdField_a_of_type_Awno.jdField_a_of_type_Boolean;
      }
      if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    if ((localawnq != null) && (!ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b())) {
      localJSONObject = new JSONObject();
    }
    try
    {
      localJSONObject.put("type", "musicboxResume");
      localJSONObject.put("uin", localawnq.a().jdField_b_of_type_JavaLangString);
      localJSONObject.put("uinType", localawnq.a().e);
  ...
  public void onPlaySongChanged(SongInfo paramSongInfo)
  {
    ...
    if (paramSongInfo.jdField_b_of_type_Int == 10)
    {
      if (this.jdField_a_of_type_Baaf != null) {
        this.jdField_a_of_type_Baaf.a(paramSongInfo, this.h);
      }
      n();
      if (QLog.isColorLevel()) {
  ...
  public void onPlayStateChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Baaf != null) {
          this.jdField_a_of_type_Baaf.a((SongInfo)localObject, true);
        }
      ...
      else
      {
        ...
        continue;
        if (this.jdField_a_of_type_Baaf != null) {
          this.jdField_a_of_type_Baaf.a(2);
        }
        d(false);
        this.h = false;
        ...
        for (;;)
        {
          bdll.b(null, "dc00898", "", String.valueOf(l), "qq_vip", (String)localObject, k, 0, String.valueOf((System.currentTimeMillis() - this.jdField_b_of_type_Long) / 1000L), "", "", "");
          break;
