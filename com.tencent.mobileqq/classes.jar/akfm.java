  ...
  extends ajtd
{
  ...
  public akfm(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new akfn(this, Looper.getMainLooper());
  }
          ...
          do
          {
            ...
            if (paramFromServiceMsg.getServiceCmd().equals("RegPrxySvc.PushParam"))
            {
              if (paramObject != null)
              {
                ...
                {
                  i = j;
                  if (((wih)this.app.getManager(335)).a(paramObject)) {
                    i = 1;
                  }
                  this.h = i;
                  c();
