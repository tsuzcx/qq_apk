    ...
    if (paramKeyEvent.getKeyCode() == 67)
    {
      ...
      if (paramKeyEvent.getAction() == 0)
      {
        if (QLog.isColorLevel()) {
          QLog.i(this.a.jdField_a_of_type_JavaLangString, 2, "on delete, start: " + this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getSelectionStart() + ", end: " + this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getSelectionEnd() + ", span: " + this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getTag(2131374006));
        }
        ...
        bool1 = bool2;
        if (this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getTag(2131374006) != null)
        {
          ...
          this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTag(2131374006, null);
    ...
    do
    {
      do
      {
        do
        {
          return bool1;
          bool1 = bool2;
        } while (this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getTag(2131374006) == null);
        bool1 = bool2;
