  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (akfl.a())
      {
        ...
        if ((ReportInfo)akfl.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        akfl.a(this.a).add(localObject5);
      }
      akfl.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      akfl.b(this.a).add(localObject1);
      akfl.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (akfl.a())
        {
          ...
          localObject5 = (ReportInfo)akfl.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (akfl.a())
        {
          ...
          localObject4 = (ReportInfo)akfl.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        akfl.a(this.a).add(???);
        akfl.b(this.a, 5);
        localObject4 = akfl.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          akfl.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (akfl.a())
      {
        ...
        if ((ReportInfo)akfl.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      akfl.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      akfl.b(this.a).add(localObject3);
      akfl.a(this.a).add(localObject5);
      akfl.a(this.a, 1);
      return;
      ??? = ".";
