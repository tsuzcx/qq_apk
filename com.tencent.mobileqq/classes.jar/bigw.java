...
public class bigw
{
  private bigu jdField_a_of_type_Bigu = new bigu();
  ...
  private List<String> a(QQAppInterface paramQQAppInterface)
  {
    ...
    localArrayList.add(antf.ba + paramQQAppInterface + File.separator);
  ...
  private void a(String paramString)
  {
    ...
    {
      paramString = new File(bigv.a(paramString));
  ...
  private void c(Context paramContext)
  {
    ...
    Iterator localIterator = bigz.a.iterator();
  ...
  private void d()
  {
    for (;;)
    {
      try
      {
        File[] arrayOfFile = new File(antf.ba).listFiles();
        if (arrayOfFile == null) {
          return;
        }
  ...
  public final void a()
  {
    Iterator localIterator = bigz.b.iterator();
    while (localIterator.hasNext()) {
  ...
  public void a(Context paramContext)
  {
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        this.jdField_a_of_type_Bigu.reportError(new Throwable("FileSystemManager proxy", paramContext));
  ...
  public void b(Context paramContext)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      FileSystemManager.setStatisticsCallback(this.jdField_a_of_type_Bigu);
    }
    if (BaseApplicationImpl.sProcessId == 1) {}
    for (;;)
    {
