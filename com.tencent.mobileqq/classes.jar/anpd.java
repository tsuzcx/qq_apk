  ...
  extends anpa
{
  ...
  public anpd(Context paramContext, int paramInt, SensorManager paramSensorManager, anos paramanos)
  {
    ...
    if (paramInt == 5)
    {
      ...
      paramanos.onSensorSupport(4, true);
    ...
    for (;;)
    {
      ...
      paramanos.onSensorSupport(1, true);
      this.jdField_a_of_type_JavaUtilList.add(localSensor);
      return;
      paramInt = 11;
      break;
      label150:
      paramanos.onSensorSupport(4, false);
    ...
    label298:
    paramanos.onSensorSupport(1, false);
  }
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    if ((paramSensorEvent.sensor.getType() == 11) || (paramSensorEvent.sensor.getType() == 15))
    {
      ...
      this.jdField_a_of_type_Anos.onRotationUpdateQuaternion(this.d);
    }
