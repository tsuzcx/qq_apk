  ...
  extends anpi
{
  ...
  public anpd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (localObject != null)
      {
        localObject = (anpd)((anox)localObject).a(jdField_a_of_type_JavaLangString);
        if (localObject != null)
        {
          ((anpd)localObject).a(true);
  ...
  public void a(String paramString)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        if (localObject != null)
        {
          ...
          anow.a((XmlData)localObject, new String[] { "loadState", "Version" });
        }
        QLog.e("ApolloSoLoader_libHandler", 1, "[doOnDownloadSuccess],unzip apollo lib failed!");
        if (i != 0)
        {
          ajlq.a(10, 200, 1001, new Object[] { "unzip sava lib failed" });
          ajoo.a = true;
        }
      }
    }
    for (;;)
    {
      ...
      if (i != 0) {
        ajlq.a(10, 200, 0, new Object[] { "libsava so download success" });
      }
      ajoo.a("after_ApolloSo_downloaded");
    }
  }
