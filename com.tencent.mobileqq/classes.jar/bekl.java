...
public class bekl
  implements bekm
{
  awfa jdField_a_of_type_Awfa;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bekl(QQAppInterface paramQQAppInterface)
  {
  ...
  public awfa a()
  {
    if (this.jdField_a_of_type_Awfa == null) {
      this.jdField_a_of_type_Awfa = ((awfa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(338));
    }
    return this.jdField_a_of_type_Awfa;
  }
  ...
  public void a(bekj parambekj, int paramInt, String paramString, long paramLong1, long paramLong2, Object paramObject)
  {
    ...
    a().a((WatchTogetherSession)parambekj, paramInt);
  }
  
  public boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2, Map<String, bekj> paramMap, @Nullable Bundle paramBundle)
  {
    if (paramInt2 == 0) {}
    for (paramContext = "2";; paramContext = "")
    {
      ...
      try
      {
        paramMap = (WatchTogetherSession)bekk.a(2, 1, paramString);
  ...
  public boolean b(Context paramContext, String paramString, int paramInt1, int paramInt2, Map<String, bekj> paramMap, @Nullable Bundle paramBundle)
  {
