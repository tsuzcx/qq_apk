  ...
  implements qft
{
  ...
  private void a(ArticleInfo paramArticleInfo, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (rdy.a().a(paramArticleInfo, false, rdy.jdField_a_of_type_Int)) {
      localHashMap.put("jump_src", Integer.valueOf(rec.a(paramArticleInfo)));
    }
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (localObject1 = ((Context)localObject1).getResources().getString(2131717066);; localObject1 = "")
    {
      ...
      if (paramBaseArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        if (paramInt < paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          rhx localrhx = (rhx)paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.get(paramInt);
          ((JSONObject)localObject2).put("video_jump_url", localrhx.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject2).put("video_cover_url", localrhx.c);
          ((JSONObject)localObject2).put("video_title_text", localrhx.jdField_b_of_type_JavaLangString);
          ((JSONObject)localObject2).put("rowkey", localrhx.jdField_a_of_type_JavaLangString);
          String str1 = bmqa.b(localrhx.jdField_a_of_type_Int);
          String str2 = bmqa.c(localrhx.jdField_b_of_type_Int);
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (localrhx.jdField_a_of_type_Int > 0)) {
      ...
      else
      {
        ...
        while (paramInt < paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          localObject2 = (rhx)paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.get(paramInt);
          ((JSONObject)localObject1).put("video_jump_url", ((rhx)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject1).put("video_cover_url", ((rhx)localObject2).c);
          ((JSONObject)localObject1).put("video_title_text", ((rhx)localObject2).jdField_b_of_type_JavaLangString);
          ((JSONObject)localObject1).put("rowkey", ((rhx)localObject2).jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject1).put("video_duration_text", bmqa.c(((rhx)localObject2).jdField_b_of_type_Int));
  ...
  public void a(int paramInt1, Container paramContainer, pxk parampxk, int paramInt2)
  {
    ...
    {
      localObject = String.format(paramContainer.getContext().getResources().getString(2131717067), new Object[] { localObject });
      ...
      localObject = (qly)localViewBase.findViewBaseByName("id_column_list");
      ((qly)localObject).a(parampxk);
      ((qly)localObject).a(new qed(this, localArticleInfo, paramContainer));
      ((qly)localObject).a(new qee(this, localArticleInfo, paramContainer));
      return;
    }
  }
  ...
  public boolean a(int paramInt, Container paramContainer, pxk parampxk, ViewBase paramViewBase)
  {
    ...
    do
    {
      ...
      {
        paramViewBase.setOnClickListener(new qef(this, parampxk, paramContainer));
        return true;
      }
    } while (!"multi_video_column_tail_click".equals(str));
    paramViewBase.setOnClickListener(new qeg(this, parampxk, paramContainer));
    return true;
  }
}
