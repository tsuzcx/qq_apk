...
public class aqvu
{
  ...
  public static Pair<StringBuilder, StringBuilder> a(Context paramContext, File paramFile)
  {
    ...
    a = true;
    paramContext = whj.a(Uri.parse("file://" + paramFile.getAbsolutePath()), paramContext);
    a = false;
    return paramContext;
  }
  ...
  public static String a(String paramString)
  {
    ...
    //   85: invokestatic 157	bbea:a	([B)Ljava/lang/String;
    //   88: astore_2
  ...
  public static msg_ctrl.MsgCtrl a(String paramString)
  {
    ...
    Object localObject2;
    long l2;
    if ((aqwf.a().f()) && (!TextUtils.isEmpty(paramString)))
    {
    ...
    for (;;)
    {
      ...
      axrn.a(BaseApplicationImpl.getContext()).a(null, "act_getMsgCtrlForPicMsg", true, 0L, 0L, localHashMap, "");
      return localMsgCtrl;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    Object localObject = aqwf.a();
    if (!((aqwf)localObject).e()) {}
    String str;
    do
    {
      return false;
      str = ((aqwf)localObject).a();
      localObject = ((aqwf)localObject).b();
