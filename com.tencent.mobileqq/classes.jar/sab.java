...
public class sab
{
  ...
  public sab(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          jdField_a_of_type_Int = afur.a(28.0F, paramActivity.getResources());
          this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
          this.jdField_a_of_type_JavaUtilRandom = new Random();
          paramActivity = a();
          if (paramActivity != null)
          {
            this.jdField_a_of_type_Saa = ((saa)paramActivity.a(138));
            this.jdField_a_of_type_Sac = new sac(this);
            paramActivity.addObserver(this.jdField_a_of_type_Sac);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = bmqa.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_Saa == null) || (!bmqa.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_Saa.a(paramInt);
          bmqa.a(System.currentTimeMillis());
      ...
      return;
    } while (this.jdField_a_of_type_Saa == null);
    this.jdField_a_of_type_Saa.a(paramInt);
    bmqa.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Sac);
    }
  }
