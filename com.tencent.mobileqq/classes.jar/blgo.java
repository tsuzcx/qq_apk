...
public class blgo
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new blgp(this);
  
  public blgo(Context paramContext, blfh paramblfh, QQAppInterface paramQQAppInterface)
  {
  ...
  private List<String> a()
  {
    ...
    if ((bgln.e()) || (bgmg.a() <= 1.048576E+008F))
    {
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localEditor.commit();
    this.jdField_a_of_type_Blfh.a(paramString, this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener, true);
    ...
    blae.a(1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void c()
  {
    if (!PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getString("plugin_pre_install_qq_version", "").equals(bgln.c()))
    {
      SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).edit();
  ...
  public void a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          if (this.jdField_a_of_type_Blfh.isPlugininstalled(str)) {
            continue;
          }
          int i = a(str);
          if (i >= 10) {
