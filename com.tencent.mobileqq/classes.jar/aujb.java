  ...
  implements agma, Handler.Callback
{
  ...
  private final DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new auje(this);
  ...
  public aujb(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a()
  {
    ...
    Map localMap = ((auke)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a(str);
    if (localMap == null)
    {
  ...
  private void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    aukj.a(this.jdField_a_of_type_AndroidOsBundle, a(), this.jdField_a_of_type_Long, false);
    ...
    augs.a(this.jdField_a_of_type_AndroidAppActivity, paramString1, new aujc(this, paramInt, paramString2));
  }
  
  public static void a(Activity paramActivity, aglu paramaglu)
  {
    ...
    {
      paramaglu = (aukj)paramaglu.a(13);
      if (paramaglu != null) {
        paramaglu.a(paramActivity.getIntent());
      }
    }
    do
    {
      return;
      paramActivity = (aujb)paramaglu.a(57);
  ...
  {
    paramMessageForArkApp = paramMessageForArkApp.getExtInfoFromExtStr(bbyw.w);
  ...
  {
    String str = paramMessageForArkApp.getExtInfoFromExtStr(bbyw.w);
    ...
    str = paramMessageForArkApp.getExtInfoFromExtStr(bbyw.y);
    if (TextUtils.isEmpty(str))
    {
      QLog.d("SDK_SHARE.ForwardSDKB77AIOHelper", 1, "resendSdkFakeMsg fakeShareInfo empty");
      return false;
    }
    aujf localaujf = new aujf();
    try
    {
      localaujf.a(paramMessageForArkApp, paramContext, new JSONObject(str));
      return true;
    }
  ...
  private void b(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aujd(this, paramString);
  ...
  private void c()
  {
    if (this.jdField_a_of_type_AndroidOsBundle != null)
    {
      ...
      if ((localObject instanceof AbsShareMsg))
      {
        ...
        this.jdField_a_of_type_Bgpa = aukj.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bgpa, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, ((AbsShareMsg)localObject).mSourceAppid, ((AbsShareMsg)localObject).mMsgServiceID, str);
      }
    }
    aukj.a(this.jdField_a_of_type_AndroidOsBundle, a(), this.jdField_a_of_type_Long, true);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    f();
    augs.a(this.jdField_a_of_type_AndroidAppActivity, anni.a(2131703581), this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener);
    return true;
  }
}
