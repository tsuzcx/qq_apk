  ...
  extends Drawable
{
  ...
  public bfri(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidGraphicsBitmap = bfpx.b(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130842104);
