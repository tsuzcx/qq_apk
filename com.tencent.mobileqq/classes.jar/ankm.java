...
public class ankm
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      str2 = paramArrayOfString[awrh.a(paramArrayOfString.length)];
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject).put("atlas", anhm.a(paramInt + "/role", 1));
          ((JSONObject)localObject).put("json", anhm.a(paramInt + "/role", 1));
          continue;
      ...
      localJSONObject2.put("atlas", anhm.a(localInteger + "/dress", 2));
      localJSONObject2.put("json", anhm.a(localInteger + "/dress", 2));
    }
    localJSONObject1.put("dressPath", localException1);
    return localJSONObject1;
  }
  
  public static void a(int paramInt1, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt2, String paramString3, anks paramanks)
  {
    amme localamme = (amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER);
    Object localObject = localamme.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt2 < j)
        {
          ...
          i = localApolloDress.jdField_b_of_type_Int;
          int[] arrayOfInt = localApolloDress.a();
          if ((anhm.a(paramString1, localApolloDress.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ankq(paramanks, paramInt1, paramQQAppInterface, paramString2, paramString3, localApolloDress, arrayOfInt))) && (localApolloDress.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramanks != null) {
              paramanks.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, localApolloDress.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramanks != null)
        {
          ...
          {
            paramInt2 = 2;
            paramanks.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt2, anex.a(paramInt2), 1);
          }
        }
        else
        {
          amme.a(paramQQAppInterface, paramString1, "apllo_game");
          ...
          paramQQAppInterface = localamme.b(paramString1);
        ...
        for (long l = paramQQAppInterface.apolloUpdateTime;; l = 0L)
        {
          ...
          paramanks.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, 1, anex.a(1), 1);
          break label282;
        }
      }
    }
  ...
  public static void a(int paramInt, String paramString, Activity paramActivity)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localamri = new amri();
        localObject1 = amwn.a(paramInt);
        if (localObject1 != null)
        {
          localObject1 = ((amyo)localObject1).a();
          if ((localObject1 != null) && (((CmGameStartChecker.StartCheckParam)localObject1).game != null))
          {
            localamri.jdField_b_of_type_Int = ((CmGameStartChecker.StartCheckParam)localObject1).game.actionId;
            localamri.jdField_b_of_type_JavaLangString = ((CmGameStartChecker.StartCheckParam)localObject1).game.name;
          }
        }
        if (localamri.jdField_b_of_type_Int <= 0) {
          localamri.jdField_b_of_type_Int = 439;
        }
        localamri.jdField_a_of_type_Int = paramInt;
        localamri.jdField_a_of_type_JavaLangString = anvx.a(2131699869);
        localamri.jdField_c_of_type_Int = i;
        ...
        ((JSONObject)localObject1).put("xyRootSrc", amta.a(paramInt));
        i = paramString.optInt("activityId");
        int j = paramString.optInt("reqCode");
        localObject2 = amwn.a(paramInt);
        if (localObject2 != null)
        {
          ((amyo)localObject2).jdField_b_of_type_Int = i;
          ((amyo)localObject2).jdField_c_of_type_Int = j;
        }
        localamri.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
        if (localamri.jdField_c_of_type_JavaLangString.length() >= 500)
        {
          QLog.w("cmgame.sendmsg", 1, "extendInfo is too long, len:" + localamri.jdField_c_of_type_JavaLangString.length() + ",content:" + localamri.jdField_c_of_type_JavaLangString);
          return;
        }
      }
      ...
      Object localObject1 = amyv.a();
      if ((localObject1 != null) && (((amyv)localObject1).a != null) && (0L != l)) {
        ((amyv)localObject1).a.roomId = l;
      }
      if (i == 0)
      {
        paramString.put("msgType", 4);
        amyd.a("cs.send_game_msg.local", paramString.toString(), true, null, paramInt);
        return;
      }
    } while (1 != i);
    a(localamri, paramActivity, 3);
  }
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject2 = amme.jdField_c_of_type_JavaLangString;
    localObject1 = amme.jdField_b_of_type_JavaLangString;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        a(paramLong, paramQQAppInterface, paramString2, "", 1, paramString1, new ankn());
        return;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, ankr paramankr)
  {
    amme localamme = (amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER);
    Object localObject = localamme.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt < j)
        {
          ...
          i = localApolloDress.jdField_b_of_type_Int;
          int[] arrayOfInt = localApolloDress.a();
          if ((anhm.a(paramString1, localApolloDress.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ankp(paramankr, paramLong, paramQQAppInterface, paramString2, paramString3, localApolloDress, arrayOfInt))) && (localApolloDress.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramankr != null) {
              paramankr.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, localApolloDress.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramankr != null)
        {
          ...
          {
            paramInt = 2;
            paramankr.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt, anex.a(paramInt), 1);
          }
        }
        else
        {
        ...
        for (paramLong = paramQQAppInterface.apolloUpdateTime;; paramLong = 0L)
        {
          ...
          paramankr.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, 1, anex.a(1), 1);
          break label285;
        }
      }
    }
  ...
  public static void a(amri paramamri, Activity paramActivity, int paramInt)
  {
    if (paramamri == null)
    {
    ...
    localBundle.putInt("forward.apollo.gameid", paramamri.jdField_a_of_type_Int);
    localBundle.putInt("forward.apollo.gameMode", paramamri.jdField_c_of_type_Int);
    localBundle.putInt("forward_type", 34);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloGameBasicEventUtil", 2, "[forwardGameMsg] gameId:" + paramamri.jdField_a_of_type_Int + ";fromtype:" + paramInt);
    }
    if (paramInt == 2)
    {
      localIntent.putExtras(localBundle);
      aupt.a(paramActivity, localIntent, 99999);
      return;
    }
    localBundle.putInt("forward.apollo.actionid", paramamri.jdField_b_of_type_Int);
    localBundle.putLong("forward.apollo.roomid", paramamri.jdField_a_of_type_Long);
    localBundle.putString("forward.apollo.gamename", paramamri.jdField_b_of_type_JavaLangString);
    localBundle.putString("forward.apollo.actionname", paramamri.jdField_a_of_type_JavaLangString);
    localBundle.putInt("forward.apollo.msgtype", paramamri.d);
    localBundle.putString("forward.apollo.sharejson", paramamri.jdField_c_of_type_JavaLangString);
    localIntent.putExtras(localBundle);
    aupt.a(paramActivity, localIntent, 20180426);
  }
    ...
    if (localJSONObject1.has("param"))
    {
      ...
      if (localJSONObject2 != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramString = bkyp.a(paramString, str, localJSONObject2.getString(str));
        }
      }
    }
    for (;;)
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localamri = new amri();
        ApolloGameData localApolloGameData = ((ankc)localObject).a(k);
        paramString = anvx.a(2131699851);
        if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
        {
          ...
          localamri.jdField_a_of_type_JavaLangString = paramString;
          localamri.jdField_b_of_type_Int = i;
          localamri.jdField_c_of_type_Int = j;
          localamri.jdField_a_of_type_Long = l;
          localamri.jdField_a_of_type_Int = k;
      ...
      localamri.jdField_b_of_type_JavaLangString = anvx.a(2131699870);
      int i = 0;
      continue;
      localamri.d = 3;
      continue;
      ...
      ApolloGameUtil.a(paramQQAppInterface, localamri, paramString.getSessionInfo());
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.i("ApolloGameBasicEventUtil", 1, "pass uin.");
          a(paramInt, paramQQAppInterface, paramString2, str, 1, paramString1, new anko(i));
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        String str = String.format("https://cmshow.qq.com/apollo/html/game-platform/buy-props.html?_wv=3&adtag=inside_game&gameId=%s&gameOrientation=%s&itemList=%s", new Object[] { Integer.valueOf(localamyo.a()), Integer.valueOf(i), URLEncoder.encode(paramString.optString("itemList"), "UTF-8") });
        ...
        VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 0, 0, new String[] { localamyo.a().mGameName });
        if (QLog.isColorLevel())
        {
          ...
          VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 1, 0, new String[] { localamyo.a().mGameName });
        }
      }
      else
      {
  ...
  private static String b()
  {
    ...
    {
      if ((anvx.a(2131699878).equals(str)) || (str.contains(anvx.a(2131699863)))) {
        return a(b);
      }
      if ((anvx.a(2131699876).equals(str)) || (str.contains(anvx.a(2131699837)))) {
        return a(c);
      }
      if ((anvx.a(2131699849).equals(str)) || (str.contains(anvx.a(2131699843)))) {
  ...
  public static void b(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = b(amme.jdField_c_of_type_JavaLangString.getBytes(), paramString.getBytes());
    try
    {
    ...
    if (localJSONObject.has("param"))
    {
      ...
      if (localJSONObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramString = bkyp.a(paramString, str, localJSONObject.getString(str));
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      ((ook)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.EC_SHOP_REPORT_HANDLER)).a(i, paramString, str1, str2, str3, l1, l2, l3, l4, bool);
      return;
    }
    catch (Exception paramQQAppInterface)
    {
