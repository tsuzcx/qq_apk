  ...
  extends ArkPlayer
{
  ...
  private static final Set<WeakReference<ankm>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  ...
  static
  {
    jdField_a_of_type_ComTencentArkArk$PlayerStubFactory = new ankn();
  }
  ...
  public static void a()
  {
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (ankm)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((ankm)localObject2).c();
          }
        }
