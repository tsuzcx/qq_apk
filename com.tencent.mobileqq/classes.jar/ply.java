  ...
  implements AladdinConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject1 = pku.a(paramString);
        ...
        else
        {
          if (paramInt1 != 0)
          {
            ...
            {
              bmhv.a((AppRuntime)localObject1, "local_kd_native_main_text_style", paramString.toString());
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    if (localAppRuntime != null) {
      bmhv.a(localAppRuntime, "local_kd_native_main_text_style", "");
    }
  }
}
