  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  private asfo jdField_a_of_type_Asfo;
  ...
  public asfn(Context paramContext, QQAppInterface paramQQAppInterface, asfo paramasfo)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Asfo = paramasfo;
    d();
  }
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560751, null);
    View localView;
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365270);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363961));
      ...
      this.c = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363405));
      ...
      this.jdField_a_of_type_ComTencentWidgetSwitch = ((Switch)this.jdField_a_of_type_AndroidViewView.findViewById(2131376748));
      this.jdField_a_of_type_ComTencentWidgetSwitch.setOnCheckedChangeListener(this);
      this.d = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363852));
      this.d.setOnClickListener(this);
      this.e = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376717));
      this.e.setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131368372).setOnClickListener(this);
      a();
      return;
      label313:
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844310);
  ...
  private void e()
  {
    ...
    aoix.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Int);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localaoeo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), this.jdField_a_of_type_Boolean);
      return;
  ...
  {
    boolean bool = aoix.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).booleanValue();
    int i = aoix.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    a(bool);
    a(i);
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Asfo != null) {
      this.jdField_a_of_type_Asfo.g();
    }
  }
