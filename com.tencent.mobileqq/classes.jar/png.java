...
public class png
  extends pne
{
  public png(AppInterface paramAppInterface)
  {
  ...
  public int a(int paramInt)
  {
    ...
    try
    {
      paramInt = this.jdField_a_of_type_Atmp.a(GuideData.class.getSimpleName(), "source=?", new String[] { String.valueOf(paramInt) });
      return paramInt;
    }
  ...
  public BaseResData a(String paramString)
  {
    ...
    for (paramString = GuideData.class;; paramString = null)
    {
      ...
      do
      {
        ...
        paramString = this.jdField_a_of_type_Atmp.a(paramString, paramString.getSimpleName(), true, "uin=? and showTime!=0 and business=?", new String[] { str2, str1 }, null, null, "showTime desc", "1");
  ...
  public List<GuideData> a(String paramString1, String paramString2)
  {
    ...
    return this.jdField_a_of_type_Atmp.a(GuideData.class, GuideData.class.getSimpleName(), true, "uin=? and showTime=? and business=? and endTime>? and id=?", new String[] { paramString1, "0", str, String.valueOf(i), paramString2 }, null, null, "seq desc", null);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Atmp.a(GuideData.class);
      return;
    }
  ...
  public void a(String paramString, BaseResData paramBaseResData)
  {
    ...
    this.jdField_a_of_type_Atmp.b(paramBaseResData);
  }
  ...
  {
    return axbo.a(new File(b(paramString, paramBaseResData.id)));
  }
