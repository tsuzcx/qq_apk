  ...
  extends anud
{
  ...
  {
    paramObject = (aocm)this.app.getManager(92);
    Object localObject;
  ...
  private void a(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg, int paramInt, aocm paramaocm)
  {
    int i = 0;
    ...
    if (i + 1 <= j) {}
    for (paramOIDBSSOPkg = bhvd.a(paramOIDBSSOPkg, 1, i);; paramOIDBSSOPkg = null)
    {
  ...
  private void a(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg, ToServiceMsg paramToServiceMsg, aocm paramaocm)
  {
    paramOIDBSSOPkg = paramOIDBSSOPkg.bytes_bodybuffer.get().toByteArray();
    ...
    int j = 0;
    if (4 <= i3) {
      l = bhvd.a(paramOIDBSSOPkg, 0);
    }
    if (6 <= i3) {}
    for (int m = bhvd.a(paramOIDBSSOPkg, 4);; m = 0)
    {
      if (8 <= i3) {}
      for (int n = bhvd.a(paramOIDBSSOPkg, 6);; n = 0)
      {
        if (10 <= i3) {
          i = bhvd.a(paramOIDBSSOPkg, 8);
        }
        if (12 <= i3) {
          j = bhvd.a(paramOIDBSSOPkg, 10);
        }
        if ((i == 0) && (j == 0) && (m == 0) && (n == 0))
        {
          if (QLog.isColorLevel()) {
        ...
        while (k < i4)
        {
          ...
          if (i1 + 4 <= i3)
          {
            arrayOfLong[k] = bhvd.a(paramOIDBSSOPkg, i1);
            i2 = i1 + 4;
          }
          k += 1;
          i1 = i2;
        ...
        for (;;)
        {
          ...
          paramaocm.a().a(l, k, i2, (int)arrayOfLong[i1], i3);
          if (i2 - 1 > 0)
          {
            i3 = i2 - 1;
            i2 = k;
          ...
          while ((i2 < m) || ((i2 == m) && (k < n)))
          {
            paramaocm.b(i6, i7, i4);
            paramaocm.a().a(String.valueOf(l), m, n, i, j);
            paramaocm.m();
            paramaocm.c();
            paramaocm.a(2003);
            paramaocm.a(18, null);
    ...
    if (1000 == i)
    {
      ...
      if (paramToServiceMsg != null)
      {
        ...
        if (paramToServiceMsg.uint32_result.has())
        {
          ...
          if (j == 0)
          {
            paramToServiceMsg = (aocm)this.app.getManager(92);
            i = j;
            if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ((aocm)this.app.getManager(92)).a(34, null);
      return;
      bool = false;
      break;
      bool = false;
  ...
  public aocj a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null)
    {
      apdo localapdo = new apdo(this, paramInt);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localapdo);
    }
    return (aocj)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    try
    {
      ...
      bhvd.a(paramString, 4, paramInt1);
      bhvd.a(paramString, 6, paramInt2);
      bhvd.a(paramString, 8, paramInt3);
      bhvd.a(paramString, 10, paramInt4);
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean, int paramInt)
  {
    ...
    paramString = (aocm)this.app.getManager(92);
    if (paramBoolean) {}
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    paramCalendar = localaocm.a((Calendar)paramCalendar.clone());
    long l1 = ((Long)paramCalendar.first).longValue();
    long l2 = ((Long)paramCalendar.second).longValue();
    this.app.a().a(paramString, l1, 0L, l2, (short)0, 0L, 1, localaocm.a(), localaocm.b(), paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
  }
  ...
  public void a(short paramShort)
  {
    try
    {
      ...
      bhvd.a((byte[])localObject, 7, 41813);
      bhvd.a((byte[])localObject, 9, (short)2);
      bhvd.a((byte[])localObject, 11, paramShort);
  ...
  {
    aocm localaocm = (aocm)this.app.getManager(92);
    Object localObject = localaocm.a(paramCalendar);
    if (localObject == null)
    {
      if (QLog.isColorLevel()) {
    ...
    {
      localaocm.a((Calendar)localObject);
    ...
    {
      localaocm.a((Calendar)localObject);
      paramCalendar = localaocm.a((Calendar)((Calendar)localObject).clone());
      int m = localaocm.a(paramString, ((Long)paramCalendar.first).longValue(), ((Long)paramCalendar.second).longValue());
      if (QLog.isColorLevel()) {
  ...
  public aocj b(int paramInt)
  {
    aocj localaocj = (aocj)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
