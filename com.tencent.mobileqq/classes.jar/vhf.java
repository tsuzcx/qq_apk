  ...
  extends beqg
{
  ...
  public void clearView(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    if ((paramViewHolder instanceof vhb))
    {
      ((vhb)paramViewHolder).a = false;
  ...
  public void onSelectedChanged(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if ((paramInt == 2) && ((paramViewHolder instanceof vhb)))
    {
      paramViewHolder = (vhb)paramViewHolder;
      paramViewHolder.a = true;
      if ((this.a instanceof vgy)) {
        ((vgy)this.a).notifyItemChanged(paramViewHolder.getAdapterPosition(), Integer.valueOf(0));
      }
    }
  }
