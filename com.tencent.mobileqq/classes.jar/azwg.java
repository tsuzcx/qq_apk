...
public class azwg
{
  ...
  public azwg(Context paramContext, AppInterface paramAppInterface)
  {
    this(paramAppInterface);
  }
  
  public azwg(AppInterface paramAppInterface)
  {
    if ((paramAppInterface instanceof QQAppInterface)) {
      this.a = new azwk((QQAppInterface)paramAppInterface);
    }
    while (this.a == null)
    {
      throw new NullPointerException("can not Instantiation FaceDecoder");
      if ((paramAppInterface instanceof NearbyAppInterface)) {
        this.a = new azye((NearbyAppInterface)paramAppInterface);
      }
    }
  }
