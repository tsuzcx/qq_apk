...
public class bdpj
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bfnn.a("b84cf5");
    j = bbdh.b();
    try
    {
      jdField_b_of_type_Int = bbdh.e();
      return;
    }
    catch (Exception localException) {}
  }
  
  public static bdpj a()
  {
    bdpj localbdpj = new bdpj();
    try
    {
      localbdpj.jdField_a_of_type_Boolean = AppNetConnInfo.isWifiConn();
      localbdpj.jdField_b_of_type_Long = (bbdh.e() / 1048576L);
      localbdpj.k = String.valueOf(bbdh.b()[1]);
      localbdpj.jdField_b_of_type_JavaLangString = "";
      localbdpj.jdField_a_of_type_Int = 0;
      return localbdpj;
    }
    catch (Exception localException)
    {
  ...
  public bdpj a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    return this;
  }
  
  public bdpj a(String paramString)
  {
