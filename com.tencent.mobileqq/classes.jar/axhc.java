  ...
  implements awfy
{
  ...
  public axhc(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString, int paramInt)
  {
  ...
  public void b(awfz paramawfz)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ReceiptMsgManager", 2, "upload receipt msg pack failed, result.errStr=" + paramawfz.b + ",result.errStr=" + paramawfz.jdField_a_of_type_JavaLangString + " uniseq=" + this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
    }
