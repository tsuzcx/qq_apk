  ...
  extends RemoteCommand
{
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    case 5: 
          ...
          do
          {
            ...
            do
            {
              do
              {
                ...
                localSharedPreferences = bhvh.a(this.a, 1);
            ...
            bbcl.h(this.a, paramBundle);
            paramOnInvokeFinishLinstener.putString("result_key", bbcl.j(this.a, paramBundle));
            return paramOnInvokeFinishLinstener;
            paramBundle = paramBundle.getString("param_uin");
            paramOnInvokeFinishLinstener.putParcelable("result_key", this.a.a(paramBundle, true));
            return paramOnInvokeFinishLinstener;
            paramBundle = paramBundle.getString("param_uin");
            localObject = (ajxn)this.a.getManager(51);
          } while ((localObject == null) || (TextUtils.isEmpty(paramBundle)));
          paramBundle = ((ajxn)localObject).b(paramBundle);
      ...
      paramOnInvokeFinishLinstener.putString("result_key", Boolean.toString(osj.a().a(paramBundle)));
      return paramOnInvokeFinishLinstener;
    case 6: 
      paramBundle = bhvh.a(this.a);
    ...
    case 7: 
      paramOnInvokeFinishLinstener.putString("result_key", onk.b());
      return paramOnInvokeFinishLinstener;
    }
    paramBundle = paramBundle.getString("param_uin");
    new now(this.a, paramBundle, this.a.getApp().getApplicationContext()).a();
