...
class bbbr
  extends bbbk
{
  bbbr(bbbq parambbbq, QCircleRedPointManager.OnGetQQCircleNumRedMsgListener paramOnGetQQCircleNumRedMsgListener, int paramInt) {}
  ...
  public void a(String paramString, List<NumRedMsg.NumMsgBusi> paramList)
  {
    ...
    if ("QQCircleRedCircle".equals(paramString))
    {
      ...
      if (paramList != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if ((paramList != null) && (paramList.str_ext.get() != null)) {
            try
            {
              ...
              long l = bbbq.a(this.jdField_a_of_type_Bbbq);
              if (l > 0L) {
                try
                {
                  if (Long.parseLong(localJSONObject.optString("_red_ext_feed_time")) < bbbq.a(this.jdField_a_of_type_Bbbq))
                  {
                    localArrayList.add(Long.valueOf(paramList.ui64_msgid.get()));
                    bbbq.a(this.jdField_a_of_type_Bbbq, 140000, (int)paramList.ui64_msgid.get(), 3);
                  }
                }
        ...
        if (this.jdField_a_of_type_CooperationQqcircleRedpointQCircleRedPointManager$OnGetQQCircleNumRedMsgListener != null)
        {
          this.jdField_a_of_type_CooperationQqcircleRedpointQCircleRedPointManager$OnGetQQCircleNumRedMsgListener.onGet(paramString, this.b);
          QLog.d("RedPointLog.RedTouchManager", 1, "getPassiveRedNumQQCircle listener returns successfully: " + paramString.size() + ", num = " + this.b);
        }
        if (bbbq.a(this.jdField_a_of_type_Bbbq) > 0L)
        {
          bbbq.a(this.jdField_a_of_type_Bbbq, 0L);
          if (localArrayList.size() > 0)
          {
            paramString = this.jdField_a_of_type_Bbbq.a("140000");
            bbbq.a(this.jdField_a_of_type_Bbbq, paramString, 9, false, null, localArrayList, "");
