...
public class bena
{
  ...
  public bena(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str = noe.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      bend localbend = new bend(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localbend), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!new File(noe.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.b).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
    ...
    nny.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new benb(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!nny.a(BaseApplicationImpl.getContext(), str, new benc(this, l))) && (QLog.isColorLevel())) {
