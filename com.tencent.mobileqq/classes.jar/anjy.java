...
public class anjy
{
  ...
  protected static Intent a(Context paramContext, String paramString1, boolean paramBoolean, long paramLong, MessageForArkApp paramMessageForArkApp, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      if (paramString1 != null)
      {
        ...
        if (paramString1 != null)
        {
          ...
          localIntent.putExtra("h5_ark_url_web_sender_uin", afii.c);
          if (bool2) {
            localIntent.putExtra("puin", afii.c);
          }
          QLog.d("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.launchQQBrowser,appname=", paramString3, ", enableCheck=", Boolean.valueOf(paramBoolean), ", appEnableCheck=", Boolean.valueOf(bool1), ", isPublicAccount=", Boolean.valueOf(bool2), ", senderUin=", afii.c, ", mUrlChecker=", paramString1.toString() });
          anqp.a().a(new anka());
        }
      }
    }
    paramString1 = aolx.b(186).a();
    if (!TextUtils.isEmpty(paramString1)) {
    ...
    if (paramMessageForArkApp != null)
    {
      ...
      if (paramString1 != null)
      {
        ...
        anoe.a(a(), paramString1.appName, "AIOArkSdkCardClick", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
    for (;;)
    {
      ...
      if (paramString1.from == 1) {
        anoe.a(a(), paramString1.appName, "AIOArkMapCardClick ", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
  }
  ...
  public static String a()
  {
    ...
    if (localQQAppInterface != null) {
      return ((aufv)localQQAppInterface.getManager(11)).a().nationCode;
    }
    return "";
  }
  ...
  public static String a(boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((aufv)((QQAppInterface)localObject).getManager(11)).a();
  ...
  public static void a(ark.ModuleRegister paramModuleRegister, ark.Application paramApplication)
  {
    ...
    for (long l = 1L;; l = 0L)
    {
      ...
      for (localObject1 = ((ArkAppCenter)localObject1).a();; localObject1 = null)
      {
        ...
        ((List)localObject2).add(new anke(paramApplication, l));
        ((List)localObject2).add(new anif(paramApplication, l));
        if (1 == BaseApplicationImpl.sProcessId)
        {
          ((List)localObject2).add(new aniz(paramApplication, l));
          ((List)localObject2).add(new anlk(paramApplication, l));
        }
        if (l == 0L) {
          ((List)localObject2).add(new ankt(paramApplication, l));
        }
        paramApplication = ((List)localObject2).iterator();
        while (paramApplication.hasNext())
        {
          localObject2 = (ankc)paramApplication.next();
          if (localObject1 != null) {
            ((ankc)localObject2).a((List)anly.a.get(((ankc)localObject2).GetTypeName()));
          }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, ankb paramankb)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString3)) && (a() != null)) {
      ArkAppMgr.getInstance().getAppPathByNameTimeout(3000L, paramString1, paramString2, "0.0.0.1", null, new anjz(paramString1, paramString3, paramankb));
    }
  }
  ...
  public static boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (((localObject2 instanceof FragmentActivity)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if ((!(localObject3 instanceof agti)) || (!"biz_src_ads".equals("biz_src_jc_ark"))) {
        break label847;
      }
    ...
    for (;;)
    {
      if (anla.a(paramString1, null, null, paramInt, paramString2))
      {
        anoe.a(null, paramString2, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
        Log.d("ark.OpenUrl ", paramString1);
        anoe.a(null, paramString2, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
        return true;
      }
      int j;
      int i;
      ...
      for (;;)
      {
        anrm.b(paramString2, paramString1, j, i, afii.c);
        if (paramInt == 0)
        {
        ...
        localObject1 = bdib.a(a(), (Context)localObject2, paramString1);
        if (localObject1 == null) {
          break;
        }
