  ...
  extends alko
{
  ...
  public anjy(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString, boolean paramBoolean, byte[] paramArrayOfByte, int paramInt1, int paramInt2, alkr paramalkr)
  {
    paramalkr = super.createToServiceMsg(paramString, paramalkr);
    paramalkr.addAttribute("SendTime", Long.valueOf(System.currentTimeMillis()));
    paramalkr.addAttribute("IsGenericCmd", Boolean.valueOf(paramBoolean));
    paramalkr.addAttribute("IsPanelRequest", Boolean.valueOf(false));
    paramalkr.addAttribute("NotifyType", Integer.valueOf(paramInt2));
    paramalkr.putWupBuffer(paramArrayOfByte);
    if (paramInt1 > 0) {
      paramalkr.setTimeout(paramInt1);
    }
    if (!allh.a().containsKey(paramString)) {
      allh.a(paramString, a);
    }
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (paramalkr == null)) {
      return false;
    }
    paramalkr = super.createToServiceMsg(paramString, paramalkr);
    paramalkr.addAttribute("SendTime", Long.valueOf(System.currentTimeMillis()));
    paramalkr.addAttribute("IsGenericCmd", Boolean.valueOf(true));
    paramalkr.addAttribute("IsPanelRequest", Boolean.valueOf(true));
    paramalkr.addAttribute("NotifyType", Integer.valueOf(paramInt2));
    if (paramInt1 > 0) {
      paramalkr.setTimeout(paramInt1);
    }
  ...
  {
    if ((TextUtils.isEmpty(paramString1)) || (paramalkr == null)) {
      return false;
    }
    ...
    try
    {
      ...
      a(paramString1, true, paramString2, paramInt1, paramInt2, paramalkr);
      return true;
    }
