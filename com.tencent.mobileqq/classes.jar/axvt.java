  ...
  extends MSFServlet
{
  ...
  {
    int j = 0;
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), axvt.class);
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 2, bool1, localBundle, axvs.class);
      return;
  ...
  {
    int i = 0;
    axvp localaxvp = (axvp)paramQQAppInterface.getManager(370);
    ...
    for (;;)
    {
      localaxvp.a(new OnlineStatusFriendsPermissionItem(bool, paramQQAppInterface));
      if (paramIntent != null) {
        localaxvp.a(paramIntent);
      }
      return;
      label134:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          axvp localaxvp = (axvp)((QQAppInterface)getAppRuntime()).getManager(370);
          localObject = new OnlineStatusFriendsPermissionItem(bool, (List)localObject);
          localaxvp.a(paramRspBody);
          localaxvp.a((OnlineStatusFriendsPermissionItem)localObject);
          return;
        }
        localObject = null;
      }
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   10: ldc 112
    //   12: iconst_0
    //   13: invokevirtual 411	android/content/Intent:getBooleanExtra	(Ljava/lang/String;Z)Z
    //   16: istore 6
    ...
    //   166: invokevirtual 416	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   169: ifeq +111 -> 280
    //   172: aload 8
    //   174: getfield 320	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   177: invokevirtual 419	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   180: ifnull +100 -> 280
    //   183: aload 8
    //   185: getfield 320	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   188: invokevirtual 419	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   191: invokevirtual 420	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   194: astore_2
    //   195: new 379	tencent/im/oidb/cmd0xe63/oidb_cmd0xe63$RspBody
    //   198: dup
    //   199: invokespecial 421	tencent/im/oidb/cmd0xe63/oidb_cmd0xe63$RspBody:<init>	()V
    //   202: astore 7
    //   204: aload 7
    //   206: aload_2
    //   207: invokevirtual 422	tencent/im/oidb/cmd0xe63/oidb_cmd0xe63$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   210: pop
    //   211: aload_0
    //   212: aload 7
    //   214: invokespecial 424	axvt:a	(Ltencent/im/oidb/cmd0xe63/oidb_cmd0xe63$RspBody;)V
    //   217: iconst_1
    //   218: istore 6
    //   220: aload_0
    //   221: aload_1
    ...
    //   225: aload 9
    //   227: ldc 225
    //   229: invokevirtual 229	axvt:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   232: return
    //   233: astore 7
    //   235: aconst_null
    //   236: astore_2
