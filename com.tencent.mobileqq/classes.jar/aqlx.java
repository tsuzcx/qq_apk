...
public class aqlx
{
  private static Map<String, aqlx> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aqly(this);
  ...
  private final List<aqlz> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private aqlx(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.2.6");
      return localIntent;
    }
  }
  
  public static aqlx a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      aqlx localaqlx2 = (aqlx)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      aqlx localaqlx1 = localaqlx2;
      if (localaqlx2 == null)
      {
        localaqlx1 = new aqlx(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localaqlx1);
      }
      return localaqlx1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", ajjy.a(2131639846));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", ajjy.a(2131639856) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", ajjy.a(2131639860) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + ajjy.a(2131639855) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", ajjy.a(2131639854) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", ajjy.a(2131639844) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!aqlr.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        aqmd.a("2691707");
      ...
      a("HuayangPluginLauncher", ajjy.a(2131639859) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + ajjy.a(2131639852) + (System.currentTimeMillis() - l));
      return;
      if (aqlr.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        aqmd.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", ajjy.a(2131639850) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", ajjy.a(2131639848) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + ajjy.a(2131639845) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
  ...
  {
    if (paramaqlz != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramaqlz);
    }
  }
  ...
  public void b(aqlz paramaqlz)
  {
    if (paramaqlz != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramaqlz);
    }
  }
}
