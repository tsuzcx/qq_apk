...
import com.tencent.mobileqq.troop.luckycharacter.TroopLuckyCharacterUtil.1;
...
public class bfyd
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo)
  {
    ...
    long l = paramTroopInfo.mTroopInfoExtObj.lucky_word_id;
    if (l == 0L) {
      return "";
    }
    int i = paramTroopInfo.mTroopInfoExtObj.light_char_num;
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (a(str) != paramBoolean)
    {
      ...
      localEditor.apply();
      ((bfyc)paramQQAppInterface.getManager(QQManagerFactory.TROOP_LUCKY_CHARACTER_MANAGER)).a(paramBoolean);
  ...
  {
    if (!((bfyc)paramQQAppInterface.getManager(QQManagerFactory.TROOP_LUCKY_CHARACTER_MANAGER)).a(paramTroopInfo)) {
      return false;
    }
