...
public class bfyd
{
  ...
  public static void a(bfxs parambfxs, String paramString, long paramLong)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("module_id", parambfxs.a);
    localHashMap.put("module_url", parambfxs.d);
    localHashMap.put("module_version", parambfxs.b);
    localHashMap.put("resolveClassState", paramString);
    localHashMap.put("param_FailCode", "v" + parambfxs.b + "_" + paramString);
    boolean bool = "1".equalsIgnoreCase(paramString);
    a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambfxs.a + "_resolveClassRes", bool, paramLong, 0L, localHashMap, "");
  }
  
  public static void a(bfxs parambfxs, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("module_id", parambfxs.a);
      localHashMap.put("module_url", parambfxs.d);
      localHashMap.put("module_version", String.valueOf(parambfxs.b));
      localHashMap.put("downloadState", str);
      localHashMap.put("param_FailCode", "v" + parambfxs.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambfxs.a + "_downloadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public static void b(bfxs parambfxs, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("param_FailCode", "v" + parambfxs.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambfxs.a + "_loadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
}
