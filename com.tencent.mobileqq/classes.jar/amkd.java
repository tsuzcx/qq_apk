  ...
  implements Handler.Callback, Manager
{
  ...
  public amkd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_MqqOsMqqHandler = new bdbw(ThreadManagerV2.getSubThreadLooper(), this);
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_b_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Amkk = new amke(this);
  ...
  {
    amkd localamkd = (amkd)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(359);
    if (localamkd != null) {
      localamkd.b(paramInt);
    }
  }
  ...
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new amkf(this);
  ...
  private void a(List<oidb_cmd0xe27.InOutQQ> paramList)
  {
    ...
    {
      return;
      amkj localamkj = (amkj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(173);
      localamkj.a(paramList);
      localamkj.a(this.jdField_a_of_type_Amkk);
  ...
  private boolean a(List<FrontBackData> paramList)
  {
    ...
    //   42: ireturn
    //   43: aload_0
    //   44: getfield 291	amkd:jdField_a_of_type_Awbw	Lawbw;
    //   47: ifnonnull +30 -> 77
    //   50: iload 4
    //   52: istore_3
    //   53: aload_0
    //   54: getfield 31	amkd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   57: invokevirtual 294	com/tencent/mobileqq/app/QQAppInterface:isLogin	()Z
    //   60: ifeq -21 -> 39
    //   63: aload_0
    //   64: aload_0
    //   65: getfield 31	amkd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   68: invokevirtual 298	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   71: invokevirtual 304	awbx:createEntityManager	()Lawbw;
    //   74: putfield 291	amkd:jdField_a_of_type_Awbw	Lawbw;
    //   77: aload_0
    //   78: getfield 291	amkd:jdField_a_of_type_Awbw	Lawbw;
    //   81: invokevirtual 309	awbw:a	()Lawby;
    //   84: astore 5
    //   86: aload 5
    //   88: invokevirtual 312	awby:a	()V
    //   91: aload_1
    ...
    //   119: astore 7
    //   121: aload_0
    //   122: getfield 291	amkd:jdField_a_of_type_Awbw	Lawbw;
    //   125: aload 7
    //   127: invokevirtual 315	awbw:a	(Lawbv;)V
    //   130: goto -31 -> 99
    //   133: astore 6
    ...
    //   154: aload 5
    //   156: invokevirtual 321	awby:b	()V
    ...
    //   197: aload_0
    //   198: aload_1
    //   199: invokespecial 327	amkd:b	(Ljava/util/List;)Ljava/lang/String;
    ...
    //   213: goto -174 -> 39
    //   216: aload 5
    //   218: invokevirtual 328	awby:c	()V
    //   221: aload 5
    //   223: invokevirtual 321	awby:b	()V
    //   226: goto -67 -> 159
    //   229: astore_1
    //   230: aload_0
    //   231: monitorexit
    ...
    //   234: astore_1
    //   235: aload 5
    //   237: invokevirtual 321	awby:b	()V
    //   240: aload_1
    //   241: athrow
  ...
  private void d()
  {
    ...
    try
    {
      ...
      try
      {
        localObject = this.jdField_a_of_type_Awbw.a(FrontBackData.class);
        if (localObject != null)
        {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        {
          this.jdField_a_of_type_Awbw.b(localFrontBackData);
          i += 1;
        }
      }
      else
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      ((amkj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(173)).b(this.jdField_a_of_type_Amkk);
