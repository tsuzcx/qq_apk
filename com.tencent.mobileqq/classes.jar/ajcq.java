  ...
  implements Manager
{
  ...
  public int a;
  private aiwu jdField_a_of_type_Aiwu;
  ...
  private CopyOnWriteArrayList<ajch> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public ajcq(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(ajae.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ajcs();
  ...
  public aiwu a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 379	ajcq:jdField_a_of_type_Aiwu	Laiwu;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 381	aiwu
    //   28: dup
    //   29: invokespecial 382	aiwu:<init>	()V
    //   32: putfield 379	ajcq:jdField_a_of_type_Aiwu	Laiwu;
    ...
    //   50: aload_0
    //   51: getfield 379	ajcq:jdField_a_of_type_Aiwu	Laiwu;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public ajch a()
  {
    ...
    {
      ajch localajch = (ajch)localIterator.next();
      if ((localajch != null) && (!ajae.a(localajch.a())) && (!ajae.b(localajch.a()))) {
        return localajch;
      }
    }
    return null;
  ...
  public ajch a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      ajch localajch = (ajch)localIterator.next();
      if ((localajch != null) && (paramInt == localajch.a())) {
        return localajch;
      }
    }
    return null;
  ...
  public ajch a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      ajch localajch = new ajch(paramInt1);
      localajch.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localajch);
  ...
  /* Error */
  public ajch a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	ajcq:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   28: checkcast 390	ajch
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 423	ajch:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
  ...
  public List<ajct> a()
  {
    ...
    Collections.sort(localArrayList, new ajcr(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ajct localajct = (ajct)localIterator.next();
      if (localajct != null) {
        if (localajct.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localajct);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localajct.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localajct.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localajct);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localajct.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localajct = (ajct)localIterator.next();
        if ((localajct != null) && (localajct.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localajct.jdField_a_of_type_Int = 1;
          localajct.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localajct);
        }
      }
      for (;;)
      {
        ...
        localajct = new ajct();
        localajct.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localajct.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localajct.jdField_a_of_type_Int = 1;
        localajct.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localajct);
        return;
        localajct = null;
      }
    }
  ...
  /* Error */
  public ajch b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 392	ajch:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 406	ajch:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	ajcq:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    ...
    //   89: aload_0
    //   90: getfield 47	ajcq:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localajct != null) && (localajct.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localajct.jdField_a_of_type_Int = 2;
          localajct.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localajct.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localajct);
        }
      }
      for (paramActivity = localajct; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (ajct)localIterator.next();
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      aiyf.a();
      if (this.jdField_a_of_type_Aiwu != null) {
        this.jdField_a_of_type_Aiwu.a();
      }
      this.c = false;
      return;
    }
