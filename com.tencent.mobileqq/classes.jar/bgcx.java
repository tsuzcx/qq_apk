...
{
  public bgcx(QZoneShareActivity paramQZoneShareActivity, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, String paramString4, String paramString5, int paramInt4, String paramString6, MiniAppCmdInterface paramMiniAppCmdInterface) {}
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_CooperationQzoneShareQZoneShareActivity.runOnUiThread(new QZoneShareActivity.4.1(this));
      return;
    }
    long l;
    ...
    {
      this.jdField_a_of_type_CooperationQzoneShareQZoneShareActivity.runOnUiThread(new QZoneShareActivity.4.2(this, paramJSONObject, l));
      return;
      l = 0L;
      break;
    }
