...
public class bgur
{
  ...
  private bgvh jdField_a_of_type_Bgvh = new bgut(this);
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bgus(this);
  private String jdField_a_of_type_JavaLangString = "#FDFDFD";
  private ArrayList<bgvg> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<bgvg> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bgur(Activity paramActivity)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      bgwf.e("ReaderTabConfigDataHelper", " url=" + (String)localObject);
      return localObject;
    }
  }
  ...
  private void a(ArrayList<bgvg> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      this.jdField_c_of_type_ArrayOfJavaLangString[i] = localbgvg.jdField_c_of_type_JavaLangString;
      int k = localbgvg.jdField_a_of_type_Int;
  ...
  private boolean a(ArrayList<bgvg> paramArrayList1, ArrayList<bgvg> paramArrayList2)
  {
    ...
    if (paramArrayList1.size() == paramArrayList2.size())
    {
      ...
      while (i < j)
      {
        if (!((bgvg)paramArrayList1.get(i)).equals(paramArrayList2.get(i))) {
          return false;
        }
        i += 1;
      }
  ...
  private boolean a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject1 = new bgvg(((JSONObject)localObject1).optInt("tabID", -1), ((JSONObject)localObject1).optString("tabName"), ((JSONObject)localObject1).optString("n_tabIcon"), ((JSONObject)localObject1).optString("h_tabIcon"), localArrayList, k);
      if (k != 0) {
        break label397;
      }
    ...
    {
      bgwd.d(paramJSONObject, paramBoolean);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      return;
      bgwf.d("ReaderTabConfigDataHelper", "tab url from local");
      a(4);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      bgvg localbgvg = new bgvg();
      localbgvg.jdField_a_of_type_Int = 100;
      localbgvg.jdField_a_of_type_JavaLangString = "书城";
      localbgvg.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_ELPT79nUxC.png";
      localbgvg.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_AXwBTwpLm8.png";
      ...
      localbgvg.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbgvg);
      localbgvg = new bgvg();
      localbgvg.jdField_a_of_type_Int = 101;
      localbgvg.jdField_a_of_type_JavaLangString = "分类";
      localbgvg.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_u3wddLskp6.png";
      localbgvg.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_xYKQeprMCg.png";
      localArrayList = new ArrayList(1);
      localArrayList.add(a("https://cdn.vip.qq.com/club/client/read/6/rel/category_index.html?configfrom=local&_bid=2036"));
      localbgvg.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbgvg);
      localbgvg = new bgvg();
      localbgvg.jdField_a_of_type_Int = 102;
      localbgvg.jdField_a_of_type_JavaLangString = "书架";
      localbgvg.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_G6VUELHdgC.png";
      localbgvg.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_f9xtLKYkBV.png";
      localArrayList = new ArrayList(2);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(localbgvg);
      localbgvg = new bgvg();
      localbgvg.jdField_a_of_type_Int = 104;
      localbgvg.jdField_a_of_type_JavaLangString = "我的";
      localbgvg.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190604150617_XAeQPgB9Z8.png";
      localbgvg.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_wdBlMCyKuS.png";
      localArrayList = new ArrayList(1);
  ...
  private void f()
  {
    ...
    {
      bgwf.a("ReaderTabConfigDataHelper", "getTabConfigDataFromDB," + localJSONException.getMessage());
    }
  }
  ...
  public String d()
  {
    ...
    return "&height=" + (baxn.b(this.jdField_a_of_type_AndroidContentContext, i) + 50);
  }
}
