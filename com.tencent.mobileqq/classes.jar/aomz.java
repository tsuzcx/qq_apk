  ...
  implements Animatable
{
  ...
  public aomz(int paramInt1, int[] paramArrayOfInt, ImageView paramImageView, int paramInt2)
  {
  ...
  public aomz(int[] paramArrayOfInt, ImageView paramImageView, int paramInt)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new aona(this);
    this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new aonb(this);
  }
