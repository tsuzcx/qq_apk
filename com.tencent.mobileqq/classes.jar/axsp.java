...
{
  public axsp(AccountOnlineStateActivity paramAccountOnlineStateActivity) {}
  ...
  public void onSetAutoReplyList(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      axvj localaxvj = AccountOnlineStateActivity.a(this.a).a();
      AppRuntime.Status localStatus = axuy.a().a(localaxvj);
      if ((localStatus != null) && (!AccountOnlineStateActivity.a(this.a, localaxvj, localStatus)))
      {
        AccountOnlineStateActivity.a(this.a, true);
        AccountOnlineStateActivity.a(this.a).updateOnlineStatus(localStatus, localaxvj.a);
      }
    }
    for (;;)
    {
