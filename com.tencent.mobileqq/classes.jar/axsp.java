  ...
  implements IServiceCmdCallback
{
  ...
  public axsp(axsn paramaxsn, String paramString)
  {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        axsn.b(this.jdField_b_of_type_Axsn, new String[] { "fg30CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          axsn.b(this.jdField_b_of_type_Axsn, new String[] { "fg30CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        axsn.b(this.jdField_b_of_type_Axsn, new String[] { "bg5CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          axsn.b(this.jdField_b_of_type_Axsn, new String[] { "bg5CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      return;
  ...
  public void onCmdRequest(String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Axte.a(paramString);
    ...
    if ((localMap == null) || ((localMap != null) && (localMap.size() > 0)))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (!axsn.a())
        {
          ...
          label299:
          if (!axsn.a.contains(localObject)) {
            break label475;
          }
          i = 1;
        }
    ...
    for (;;)
    {
      ...
      axsn.a(this.jdField_b_of_type_Axsn, new String[] { "cmd|", localStringBuilder.toString() });
      localObject = this.jdField_b_of_type_Axsn;
      if (j > this.jdField_c_of_type_Int)
      {
        i = 1;
        axsn.a((axsn)localObject, 3, 0, i, ajyc.a(2131701068) + paramString, "2秒钟命令字请求次数：" + j);
      }
      for (;;)
      {
        ...
        if ((axsn.a(this.jdField_b_of_type_Axsn) != null) && (QLog.isColorLevel())) {
          axsn.a(this.jdField_b_of_type_Axsn, "No high frequnecy cmd in last 2seconds");
        }
      }
      break label236;
    }
