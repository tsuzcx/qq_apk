  ...
  implements Manager
{
  ...
  private axis jdField_a_of_type_Axis;
  private NearbyAppInterface jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface;
  private final List<axir> jdField_a_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  private boolean[] jdField_a_of_type_ArrayOfBoolean;
  private final List<axir> jdField_b_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public axiq(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_Axis = new axis(paramNearbyAppInterface, this);
  ...
  {
    return this.jdField_a_of_type_Axis.a(paramInt);
  }
  
  private Message b(Message paramMessage)
  {
    return this.jdField_a_of_type_Axis.a(paramMessage);
  }
  
  private Object[] b(int paramInt, Object... paramVarArgs)
  {
    return this.jdField_a_of_type_Axis.a(paramInt, paramVarArgs);
  }
  
  public int a()
  {
    Object[] arrayOfObject = this.jdField_a_of_type_Axis.a(4156);
  ...
  public Message a(Message paramMessage)
  {
    ...
    ((aocs)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(FaceInfo.a(i, (String)localObject, j, 3));
    return null;
  }
  ...
  public ayab a()
  {
    ...
    try
    {
      localayab.jdField_a_of_type_Int = ((Integer)arrayOfObject[0]).intValue();
      localayab.b = ((Integer)arrayOfObject[1]).intValue();
      localayab.c = ((Integer)arrayOfObject[2]).intValue();
      localayab.d = ((Integer)arrayOfObject[3]).intValue();
      return localayab;
    }
    catch (Exception localException)
    {
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 28	axiq:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: iconst_0
    ...
    //   14: iload_3
    //   15: aload_0
    //   16: getfield 28	axiq:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: invokeinterface 290 1 0
    //   24: if_icmpge +45 -> 69
    //   27: aload_0
    //   28: getfield 28	axiq:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   31: iload_3
    //   32: invokeinterface 293 2 0
    //   37: checkcast 295	axir
    //   40: astore 6
    //   42: aload_0
    //   43: getfield 45	axiq:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   46: new 297	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1
    //   49: dup
    //   50: aload_0
    //   51: aload 6
    //   53: iload_1
    //   54: aload_2
    //   55: invokespecial 300	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1:<init>	(Laxiq;Laxir;I[Ljava/lang/Object;)V
    //   58: invokevirtual 306	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   61: pop
    //   62: iload_3
    //   63: iconst_1
    //   64: iadd
    ...
    //   71: monitorexit
    //   72: aload_0
    //   73: getfield 26	axiq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: astore 5
    //   78: aload 5
    //   80: monitorenter
    //   81: iload 4
    ...
    //   84: iload_3
    //   85: aload_0
    //   86: getfield 26	axiq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   89: invokeinterface 290 1 0
    //   94: if_icmpge +51 -> 145
    //   97: aload_0
    //   98: getfield 26	axiq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   101: iload_3
    //   102: invokeinterface 293 2 0
    //   107: checkcast 295	axir
    //   110: astore 6
    //   112: aload_0
    //   113: getfield 50	axiq:jdField_b_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   116: new 308	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2
    //   119: dup
    //   120: aload_0
    //   121: aload 6
    //   123: iload_1
    //   124: aload_2
    //   125: invokespecial 309	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2:<init>	(Laxiq;Laxir;I[Ljava/lang/Object;)V
    //   128: invokevirtual 306	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   131: pop
    //   132: iload_3
    //   133: iconst_1
    //   134: iadd
  ...
  public void a(axir paramaxir, boolean paramBoolean)
  {
    if (paramaxir == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_a_of_type_JavaUtilList.contains(paramaxir)) {
          this.jdField_a_of_type_JavaUtilList.add(paramaxir);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_b_of_type_JavaUtilList.contains(paramaxir)) {
        this.jdField_b_of_type_JavaUtilList.add(paramaxir);
      }
      return;
    }
  }
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    try
    {
      ...
      if (localObject1 == null)
      {
        ...
        axei.a("Q.nearby", "updateSelfCard", new Object[] { paramSelfInfo, localObject1 });
        return;
      }
    }
    catch (Exception localException)
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Axis.a();
  }
  ...
  public boolean a(int paramInt, boolean paramBoolean)
  {
    boolean bool1 = false;
    Object localObject = null;
    SharedPreferences localSharedPreferences = axdz.a("nearby_event_file", this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getAccount(), 4);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            ...
            if (QLog.isColorLevel()) {
              axei.a("onGetMyTabConfig", new Object[] { Boolean.valueOf(bool2), Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean) });
            }
            return bool1;
          }
          ...
          catch (Exception localException)
          {
            ...
            {
              localException.printStackTrace();
              axei.a("onGetMyTabConfig", new Object[] { "save config", Integer.valueOf(paramInt), localException.toString() });
            }
            bool1 = true;
          }
        }
  ...
  public Object[] a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 4146: 
      do
      {
        do
        {
          do
          {
            do
            {
              for (;;)
              {
                ...
                if ((paramVarArgs != null) && (paramVarArgs.length == 1) && ((paramVarArgs[0] instanceof Integer)))
                {
                  ...
                  if (QLog.isColorLevel())
                  {
                    axei.a("MSG_NOTIFY_HAS_UNREAD_MSG", new Object[] { Integer.valueOf(paramInt) });
                    return null;
                        ...
                        if ((paramVarArgs != null) && (paramVarArgs.length == 2))
                        {
                          ...
                          if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                          {
                            ...
                            if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                            {
                              a(4116, paramVarArgs);
                              return null;
                              aybu.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface, 0, true);
                              return null;
            ...
            return null;
            ((aqlc)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(210)).a();
            return null;
        ...
        try
        {
          ...
          ((axdx)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(219)).a(l, paramInt, i, j);
          return null;
        }
        catch (Exception paramVarArgs)
        {
      ...
      ((anqv)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(3)).a(paramInt, i);
      return null;
    case 4159: 
      a(4159, new Object[0]);
      return null;
  ...
  public int b()
  {
    Object[] arrayOfObject = b(4163, new Object[] { anhk.I });
    try
    {
      int i = ((Integer)arrayOfObject[0]).intValue();
      if (QLog.isColorLevel()) {
  ...
  public ayab b()
  {
    ...
    try
    {
      ...
      localayab.c = ((Integer)arrayOfObject[2]).intValue();
      localayab.d = ((Integer)arrayOfObject[3]).intValue();
      localayab.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[4]);
      return localayab;
    }
    catch (Exception localException)
    {
  ...
  public void b(axir paramaxir)
  {
    ...
    {
      if (this.jdField_b_of_type_JavaUtilList.contains(paramaxir)) {
        this.jdField_b_of_type_JavaUtilList.remove(paramaxir);
      }
    }
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramaxir)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramaxir);
      }
      return;
      paramaxir = finally;
      throw paramaxir;
  ...
  {
    b();
    this.jdField_a_of_type_Axis = null;
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
