...
public class usv
{
  ...
  public usv(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public usv(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.b = paramString2;
    this.c = a(paramInt);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = usu.a(paramContext, paramInt);
    ...
    {
      paramString1 = aegl.b(paramContext, paramString2);
    ...
    {
      return;
      aegl.a(paramQQAppInterface, paramContext, paramString2, new aegm(paramContext, new usw(this, paramQQAppInterface, this.c), new Object[0]));
      return;
    }
