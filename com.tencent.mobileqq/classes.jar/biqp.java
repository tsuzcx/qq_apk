  ...
  extends biql
{
  ...
  private String jdField_c_of_type_JavaLangString = ajjy.a(2131640230);
  ...
  public biqp(Context paramContext, String paramString)
  {
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.i = this.jdField_a_of_type_Bipz.a("lineHeight", 20L, 200L, 0, this.jdField_b_of_type_Int - a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), new LinearInterpolator());
        this.j = this.jdField_a_of_type_Bipz.a("offsetX", 180L, 330L, -this.jdField_a_of_type_Int, 0, new LinearInterpolator());
        return;
      }
