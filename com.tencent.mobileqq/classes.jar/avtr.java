  ...
  implements avsc
{
  ...
  public avtr(avto paramavto, String paramString, IVPluginInfo paramIVPluginInfo, InstalledPlugin paramInstalledPlugin, boolean paramBoolean, long paramLong)
  {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      avto.a(this.jdField_a_of_type_Avto).a(5, new Object[] { "" });
      return;
    }
    if (paramBoolean1) {}
  ...
  public void onGetKeyComplete(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean) {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_a_of_type_AndroidOsBundle = avto.a(this.jdField_a_of_type_Avto).a().a.getExtras();
        ...
        i = 1;
        label182:
        ykv.a(str, "getLoginKey", i, (int)l1, new String[] { avto.c(this.jdField_a_of_type_Avto), paramInt + "", paramString, "8.4.10" });
        paramString = avto.a(this.jdField_a_of_type_Avto).opName(avto.a(this.jdField_a_of_type_Avto)).opType("getLoginKey");
        if (!paramBoolean) {
          break label446;
        }
      }
    ...
    for (int i = j;; i = 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_a_of_type_AndroidOsBundle = avwp.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo, avto.a(this.jdField_a_of_type_Avto));
      ...
      for (;;)
      {
        Toast.makeText(avto.a(this.jdField_a_of_type_Avto), anvx.a(2131705111) + paramInt, 0).show();
        break;
        if ("Od".equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_a_of_type_JavaLangString)) {
          avue.a("2691712");
        }
      }
      l1 = avto.b(this.jdField_a_of_type_Avto);
      break label99;
      str = "group_video";
      break label175;
      i = 0;
