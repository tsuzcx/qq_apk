...
public class apfg
{
  ...
  private aqdk jdField_a_of_type_Aqdk;
  private aqdo jdField_a_of_type_Aqdo = new apfh(this);
  ...
  public static boolean a()
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      arrayOfString[0] = "";
      int i = DeviceProfileManager.a(str, arrayOfString, new anth());
      if (i >= 1) {
  ...
  public void a(Context paramContext, apfi paramapfi)
  {
    long l = System.currentTimeMillis();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Apfi = paramapfi;
    b();
    jdField_a_of_type_Boolean = this.jdField_a_of_type_Aqdk.b();
    apmk.a().c(System.currentTimeMillis() - l);
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Aqdk == null) {
      if (!a()) {
        break label57;
      }
    }
    label57:
    for (this.jdField_a_of_type_Aqdk = new aqdk(this.jdField_a_of_type_AndroidContentContext, 5);; this.jdField_a_of_type_Aqdk = new aqdk(this.jdField_a_of_type_AndroidContentContext, 4))
    {
      if (QLog.isColorLevel()) {
        QLog.d("SensorTrackManager", 2, "startupSensor");
      }
      this.jdField_a_of_type_Aqdk.a(this.jdField_a_of_type_Aqdo, 1);
      return;
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Aqdk != null)
    {
      this.jdField_a_of_type_Aqdk.a();
      this.jdField_a_of_type_Aqdk = null;
    }
  }
