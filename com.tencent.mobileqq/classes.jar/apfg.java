  ...
  implements VoiceRecognizerListener
{
  ...
  public apfg(WebViewPlugin paramWebViewPlugin)
  {
  ...
  private Activity a()
  {
    ...
    for (becq localbecq = null; localbecq == null; localbecq = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime) {
      return null;
    }
    return localbecq.a();
  }
  ...
  public static void a(AppInterface paramAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        new bbzb(paramAppInterface.getApplication().getApplicationContext(), "3171", "libWXVoice.so", "WXVoice").a();
  ...
  private void b()
  {
    ...
    localAppActivity.requestPermissions(new apfh(this), 1818, new String[] { "android.permission.RECORD_AUDIO" });
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new apfi(this, Looper.getMainLooper());
    }
  ...
  private boolean c()
  {
    if (!bbzb.a(this.jdField_a_of_type_AndroidContentContext, "libWXVoice.so"))
    {
      QLog.e("VoiceInputHelper", 1, "setup error, so lib not exists");
      return false;
    }
    int i = VoiceRecognizer.shareInstance().init(this.jdField_a_of_type_AndroidContentContext, "wxcd8072f67d2d78d4", bbzb.a(this.jdField_a_of_type_AndroidContentContext, "libWXVoice.so"));
    if (i < 0)
    {
