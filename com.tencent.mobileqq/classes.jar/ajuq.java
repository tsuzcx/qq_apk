...
{
  public ajuq(TroopGiftActionButton paramTroopGiftActionButton, TextView paramTextView) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      paramMotionEvent.setAnimationListener(new ajur(this));
      ...
      ((ScaleAnimation)localObject).setAnimationListener(new ajus(this, paramMotionEvent));
