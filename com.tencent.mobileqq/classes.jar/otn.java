  ...
  extends ViewBase
{
  ...
  private oqv jdField_a_of_type_Oqv = new oqv();
  private otl jdField_a_of_type_Otl;
  private otm jdField_a_of_type_Otm;
  ...
  private otm jdField_b_of_type_Otm;
  private int c = -1;
  private int d;
  private int e;
  private int f;
  ...
  public otn(VafContext paramVafContext)
  {
  ...
  private Boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool1 = true;
    float f1 = this.jdField_a_of_type_Otm.d;
    float f2 = this.jdField_a_of_type_Otm.c;
    float f3 = this.jdField_b_of_type_Otm.d;
    float f4 = this.jdField_b_of_type_Otm.c;
    if (f1 == f3)
    {
      if (paramFloat2 <= f1) {}
      for (;;)
  ...
  private otm a(String paramString)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131560033, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369026));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369028));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView = ((ReadInjoyCutImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369027));
  ...
  private void a(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_Pxk != null) && (this.jdField_a_of_type_Pxk.a() != null) && (this.jdField_a_of_type_Pxk.a().a() != null))
    {
      this.jdField_b_of_type_Int = this.jdField_a_of_type_Pxk.a().a().getPaddingTop();
      this.c = this.jdField_a_of_type_Pxk.a().a().getTop();
      if (this.jdField_a_of_type_Int <= 0) {
        this.jdField_a_of_type_Int = this.jdField_a_of_type_Pxk.a().a().getBottom();
      }
    }
    for (;;)
    {
  ...
  private void a(String paramString)
  {
    ...
    if (localObject.length == 2)
    {
      ...
      this.jdField_a_of_type_Otm = a(paramString);
      this.jdField_b_of_type_Otm = a((String)localObject);
    }
  }
  ...
  private void a(String paramString, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if ((paramDrawable != null) && (paramDrawable.getStatus() == 1))
      {
        ...
        this.jdField_a_of_type_Otl = new otl(paramDrawable.getCurrDrawable(), this.d, this.jdField_a_of_type_Int - (this.jdField_b_of_type_Int + this.c));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Otl);
        this.jdField_a_of_type_JavaLangString = paramString;
        return;
      }
    } while (paramDrawable == null);
    paramDrawable.setURLDrawableListener(new oto(this, paramString));
  }
  
  private void a(ArrayList<String> paramArrayList)
  {
    if ((oqj.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
      if (!oqj.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
      {
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c)) || (this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialWidth == 0) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialHeight == 0) || (this.jdField_a_of_type_JavaLangRunnable != null) || (this.jdField_a_of_type_Oqv.a() != null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView == null)) {
      return;
    }
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView.setOnTouchListener(new otp(this));
    if ((this.jdField_a_of_type_Otm != null) && (this.jdField_b_of_type_Otm != null)) {
      this.jdField_a_of_type_Oqv.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView, this.jdField_a_of_type_Otm, this.jdField_b_of_type_Otm, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.k, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.l, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.o);
    }
    this.jdField_a_of_type_Oqv.a(new otq(this));
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Otl.getCallback() == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Otl);
    }
    ...
    this.jdField_a_of_type_Otl.a(paramInt1, paramInt2);
  }
  ...
  public void a(pxk parampxk)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (oqj.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      d();
    }
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (oqj.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView);
    }
  }
  ...
  public void reset()
  {
    ...
    {
      this.jdField_a_of_type_Oqv.a();
      this.jdField_a_of_type_Oqv.a(null);
