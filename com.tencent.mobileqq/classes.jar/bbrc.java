  ...
  extends ajtd
{
  ...
  public bbrc(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, ArrayList<String> paramArrayList, ArrayList<Float> paramArrayList1, String paramString2)
  {
    try
    {
      paramString2 = "uip:" + zzb.k() + ", " + paramString2;
    ...
    paramArrayList.qqversion.set("8.2.8.4440");
    ...
    ((bbrc)paramQQAppInterface.a(103)).sendPbReq(paramArrayList1);
    if (QLog.isColorLevel()) {
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (bbrc)paramAppRuntime.a(103);
      if (!((bbrc)localObject).b.get()) {
        ((bbrc)localObject).a(paramAppRuntime, false);
      }
      if (((bbrc)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (((bbrc)localObject).jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramString1))
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      ThreadManager.post(new VasMonitorHandler.1(paramAppRuntime, paramString1, a(new String[] { "109", "8.2.8", paramString2, localObject, paramString4, paramString5 }), a(new Float[] { Float.valueOf(1.0F), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) }), paramString3), 5, null, false);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    QLog.i("VasMonitorHandler", 2, "onReceive res.isSuccess=" + paramFromServiceMsg.isSuccess() + ",data=" + bbmj.a((byte[])paramObject));
  }
}
