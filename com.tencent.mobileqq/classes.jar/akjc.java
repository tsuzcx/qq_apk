...
public class akjc
{
  ...
  private JSONArray a(List<Long> paramList, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = akwt.a((QQAppInterface)localObject, paramInt, str, paramString, true);
      continue;
      label200:
  ...
  public MessageForArkApp a(MessageForApollo paramMessageForApollo, MessageForArkApp paramMessageForArkApp)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localArkAppMessage.appDesc = alpo.a(2131700723);
        ...
        else
        {
          ...
          localObject1 = ((akji)paramMessageForArkApp.getManager(153)).a();
      ...
      paramMessageForArkApp.put("nickname", ((akqu)localObject1).a.get(paramMessageForApollo.senderuin));
      paramMessageForArkApp.put("avatarUrl", ((akqu)localObject1).b.get(paramMessageForApollo.senderuin));
    ...
    for (paramMessageForArkApp = paramMessageForApollo.frienduin;; paramMessageForArkApp = paramMessageForApollo.selfuin)
    {
      ...
      localJSONObject3.put("nickname", ((akqu)localObject1).a.get(paramMessageForArkApp));
      localJSONObject3.put("avatarUrl", ((akqu)localObject1).b.get(paramMessageForArkApp));
    ...
    for (;;)
    {
      ...
      if ((paramMessageForApollo != null) && (paramMessageForApollo.length() > 0))
      {
        ...
        continue;
        localObject2 = ((aleh)paramMessageForArkApp.getManager(155)).a(paramMessageForApollo.gameId);
        paramMessageForArkApp = alpo.a(2131700724);
  ...
  public String a(String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 19	akjc:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   5: ifnull +12 -> 17
    //   8: aload_1
    ...
    //   21: aload_3
    //   22: areturn
    //   23: getstatic 19	akjc:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   26: aload_1
    ...
    //   46: aload_0
    //   47: aload_1
    //   48: invokespecial 428	akjc:a	(Ljava/lang/String;)V
    //   51: aconst_null
    //   52: astore_3
    //   53: goto -34 -> 19
    //   56: astore_1
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    //   25: monitorexit
    //   26: return
    //   27: getstatic 19	akjc:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   30: aload_1
    //   31: aload_2
