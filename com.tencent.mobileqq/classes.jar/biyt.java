...
public class biyt
{
  ...
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new biyw();
  private static Bundle jdField_a_of_type_AndroidOsBundle = new Bundle();
  private static biyt jdField_a_of_type_Biyt;
  ...
  public static biyt a()
  {
    if (jdField_a_of_type_Biyt == null)
    {
      jdField_a_of_type_Biyt = new biyt();
      a();
    }
    return jdField_a_of_type_Biyt;
  }
  ...
  {
    return new biyx(paramString, paramInt, paramLong, paramBankcodeCtrlInfo, paramBoolean);
  }
  ...
  public static void a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    //   500: ifne +696 -> 1196
    //   503: invokestatic 215	biyt:a	()Lbiyt;
    //   506: aload 19
    //   508: invokevirtual 266	biyt:a	(Ljava/lang/String;)Z
    //   511: ifne +685 -> 1196
    //   514: iconst_1
    //   515: istore 16
    //   517: goto -96 -> 421
    ...
    //   707: iload 10
    //   709: isub
    //   710: invokestatic 293	biyt:a	(Ljava/lang/String;I)I
    //   713: istore 13
    //   715: aload 21
    ...
    //   725: iload 10
    //   727: isub
    //   728: invokestatic 293	biyt:a	(Ljava/lang/String;I)I
    //   731: istore 15
    //   733: iload 8
    //   735: iload 13
    //   737: iadd
    ...
    //   806: iload 7
    //   808: isub
    //   809: invokestatic 306	biyt:a	(Ljava/lang/String;IJZLcom/tencent/ims/bankcode_info$BankcodeCtrlInfo;IILcom/tencent/mobileqq/data/MessageForText;I)V
    //   812: iload 7
    //   814: aload 21
    ...
    //   827: invokestatic 293	biyt:a	(Ljava/lang/String;I)I
    //   830: aload 21
  ...
  public static void a(String paramString1, int paramInt, long paramLong, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    for (k = i2;; k = 0) {
      for (;;)
      {
        ...
        localObject3 = bhdj.a(BaseActivity.sTopActivity, 230);
        ((QQCustomDialog)localObject3).setTitle(paramString2);
        ((QQCustomDialog)localObject3).setMessage(paramString3);
        if (!TextUtils.isEmpty(paramString4)) {
          ((QQCustomDialog)localObject3).setPositiveButton(paramString4, new biyu((String)localObject2, j, i, (QQMessageFacade)localObject1, paramString1, paramInt, paramLong));
        }
        if (!TextUtils.isEmpty(paramString5)) {
          ((QQCustomDialog)localObject3).setNegativeButton(paramString5, new biyv((String)localObject2, j, i));
        }
