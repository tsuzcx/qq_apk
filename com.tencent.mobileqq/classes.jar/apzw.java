...
public class apzw
{
  ...
  private agyz jdField_a_of_type_Agyz = new apzx(this);
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new aqaa(this);
  private Button jdField_a_of_type_AndroidWidgetButton;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private aqab jdField_a_of_type_Aqab;
  ...
  private ArrayList<agyv> jdField_a_of_type_JavaUtilArrayList;
  ...
  public apzw(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    Object localObject1 = (aqax)this.jdField_a_of_type_JavaUtilList.get(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      localObject2 = (agyv)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int);
      ((agyv)localObject2).a(((aqax)localObject1).a, ((aqax)localObject1).b, ((aqax)localObject1).c, ((aqax)localObject1).f, aqbx.a(), null, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      Object localObject3;
      int j;
      if (Boolean.FALSE.equals(this.jdField_b_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)))
      {
        aqca.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ShowView", ((aqax)localObject1).a, null, aqca.g, 0, 0);
        ...
        {
          localObject3 = (aqcd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(95);
      ...
      {
        k -= j;
        ((agyv)localObject2).setViewRect(((agyv)localObject2).descaleRect(new Rect(0, 0, i, k)));
        ((agyv)localObject2).setFixSize(i, k);
        ((agyv)localObject2).setMaxSize(i, k);
        ((agyv)localObject2).a(this.jdField_a_of_type_Agyz);
        QLog.d("ArkAiAppPanel", 2, String.format("ArkAiAppPanel.initArkApp app:%s view%s width:%d height:%d.", new Object[] { ((aqax)localObject1).a, ((aqax)localObject1).b, Integer.valueOf(i), Integer.valueOf(k) }));
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView.a((agyw)localObject2, null);
  ...
  private void d()
  {
    ...
    for (int i = 0;; i = this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      while ((j < jdField_a_of_type_Int) && (j < i))
      {
        ...
        agyv localagyv = new agyv();
        localagyv.a = new ArkAppMessage.Config();
        localagyv.a.round = Integer.valueOf(1);
        this.jdField_a_of_type_JavaUtilArrayList.add(localagyv);
      ...
      {
        localObject = (agyv)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localObject != null) {
          ((agyv)localObject).doOnEvent(2);
        }
        i += 1;
      }
    ...
    this.jdField_a_of_type_Aqab.a((List)localObject);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362928));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView.setCallback(new apzy(this));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362930));
    ...
    this.jdField_a_of_type_Aqab = new aqab(this, localContext);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Aqab);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362942));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new apzz(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362944));
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        agyv localagyv = (agyv)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localagyv != null) {
          localagyv.doOnEvent(2);
        }
        i += 1;
      }
      this.jdField_a_of_type_JavaUtilArrayList.clear();
  ...
  public void a(List<aqax> paramList, int paramInt, aqae paramaqae)
  {
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      {
        aqax localaqax = (aqax)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localaqax != null) {
          aqbu.a(localaqax.a);
        }
        i += 1;
      ...
      if (this.jdField_a_of_type_Aqae != null) {
        this.jdField_a_of_type_Aqae.a(this.jdField_a_of_type_JavaUtilList);
      }
