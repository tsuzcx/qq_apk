  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public boea(bqai parambqai, bqah parambqah)
  {
    super(parambqai, parambqah);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new boeb(this);
    this.jdField_a_of_type_Bqaa = new bqaa(10007, 7, 6);
  ...
  public static Bundle a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, String paramString1, String paramString2, boolean paramBoolean6, boolean paramBoolean7, String paramString3, String paramString4, int paramInt2, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, bodz parambodz)
  {
    ...
    if (parambodz != null)
    {
      localBundle.putBoolean("arg_support_combo", parambodz.jdField_a_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_combo", parambodz.jdField_b_of_type_Boolean);
      localBundle.putString("arg_combo_name", parambodz.jdField_c_of_type_JavaLangString);
      localBundle.putString("arg_combo_id", parambodz.jdField_d_of_type_JavaLangString);
      localBundle.putBoolean("arg_support_music", parambodz.jdField_c_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_music", parambodz.jdField_d_of_type_Boolean);
      localBundle.putString("arg_music_name", parambodz.g);
      localBundle.putString("arg_music_id", parambodz.h);
    }
  ...
  public View a()
  {
    ...
    if ((this.B) && (!this.C))
    {
      ...
      this.f = this.jdField_a_of_type_Bqai.a().getIntent().getIntExtra("videoId", 0);
      if (this.f == 0) {
        break label103;
      }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (paramInt1 = 15;; paramInt1 = 32)
    {
      ...
      boed.a(localActivity, (SessionInfo)localObject, localPublishParam, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, paramIntent, null);
  ...
  {
    super.a(paramBundle);
    this.g = this.jdField_a_of_type_Bqai.a().getIntent().getIntExtra("type", 1);
    this.h = this.jdField_a_of_type_Bqai.a().getIntent().getIntExtra("WebSceneType", aluf.jdField_d_of_type_Int);
    paramBundle = new IntentFilter();
    paramBundle.addAction("tencent.video.q2v.startUploadPTV");
    this.jdField_a_of_type_Bqai.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramBundle);
  }
  
  public void a(bbhq parambbhq)
  {
    super.a(parambbhq);
    bqab localbqab = new bqad(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(3).a();
    localbqab.jdField_a_of_type_Int = this.jdField_j_of_type_Int;
    localbqab.jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    Object localObject = new bqag().b(3).a();
    if (this.jdField_j_of_type_Int == jdField_d_of_type_Int)
    {
      ((bqae)localObject).i = true;
      ((bqae)localObject).jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
    }
    ((bqae)localObject).jdField_a_of_type_Int = this.g;
    ((bqae)localObject).jdField_b_of_type_Int = this.h;
    ((bqae)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Bqai.a().getIntent().getStringExtra("succUrl");
    ((bqae)localObject).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bqai.a().getIntent().getStringExtra("failedUrl");
    this.jdField_a_of_type_Bqaa.a((bqae)localObject);
    a(paramLocalMediaInfo);
    localObject = new brdk();
    if (this.h == aluf.jdField_b_of_type_Int)
    {
      ...
      {
        ((brdk)localObject).jdField_a_of_type_Int = this.jdField_c_of_type_Int;
        ((brdk)localObject).jdField_a_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
        ((brdk)localObject).g = this.jdField_e_of_type_JavaLangString;
        ((brdk)localObject).f = this.jdField_d_of_type_JavaLangString;
        ((brdk)localObject).jdField_b_of_type_JavaLangString = (localPtvTemplateInfo.categoryId + "");
        ((brdk)localObject).jdField_c_of_type_JavaLangString = localPtvTemplateInfo.id;
        ((brdk)localObject).jdField_a_of_type_Boolean = true;
        if (localPtvTemplateInfo.kind != 8) {
          break label387;
        }
        bool1 = true;
        ((brdk)localObject).jdField_b_of_type_Boolean = bool1;
        if (localPtvTemplateInfo.kind != 9) {
          break label392;
        }
        bool1 = true;
        label324:
        ((brdk)localObject).jdField_c_of_type_Boolean = bool1;
    ...
    {
      ((brdk)localObject).jdField_d_of_type_Boolean = bool1;
      ((brdk)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView.e();
      brdx.a(this.jdField_a_of_type_Bqai.a(), paramVideoCaptureResult, paramLocalMediaInfo, this.jdField_a_of_type_Bqaa, this.jdField_a_of_type_AndroidOsBundle, 5, (brdk)localObject);
      return;
      bool1 = false;
      break;
      bool1 = false;
