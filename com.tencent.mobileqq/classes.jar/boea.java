...
{
  public static final boeb a;
  private List<CutModelKt> a;
  
  static
  {
    jdField_a_of_type_Boeb = new boeb(null);
  }
  ...
  public void onBindViewHolder(@NotNull RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if ((paramViewHolder instanceof boej))
    {
      CutModelKt localCutModelKt = (CutModelKt)this.jdField_a_of_type_JavaUtilList.get(paramInt - 1);
      ((boej)paramViewHolder).a().setClipUrl(localCutModelKt.getUuid(), localCutModelKt.getResource().getPath(), localCutModelKt.getResource().getSelectTimeStart());
      int i = boek.a.a(localCutModelKt.getUuid());
      if (i != -1) {
        ((boej)paramViewHolder).a().setId(i);
      }
      ((boej)paramViewHolder).a().setText((CharSequence)TimeFormatUtil.getDurationSecondsEnglish(localCutModelKt.getResource().getScaleDuration()));
    }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup paramViewGroup, int paramInt)
  {
    ...
    default: 
      ...
      return (RecyclerView.ViewHolder)new boej(new SelectableThumbClipView(paramViewGroup, null, 0, 6, null));
    }
    ...
    return (RecyclerView.ViewHolder)new boec(localView);
  }
}
