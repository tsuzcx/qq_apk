...
public class zqj
{
  private static ConcurrentHashMap<Class, zqf> a;
  public static Class<? extends zqf>[] a;
  
  static
  {
    jdField_a_of_type_ArrayOfJavaLangClass = new Class[] { zqi.class };
  ...
  public static String a(ArrayList<Integer> paramArrayList)
  {
    ...
    if (i < k)
    {
      localzqf = a(arrayOfClass[i]);
      localObject1 = paramArrayList.iterator();
      int m = 0;
      while (((Iterator)localObject1).hasNext())
      {
        boolean bool = localzqf.a(((Integer)((Iterator)localObject1).next()).intValue());
        m = bool;
        if (bool) {
          m = bool;
        }
    ...
    label167:
    for (localObject2 = localzqf.a;; localObject2 = "")
    {
      if (j == 1) {
  ...
  /* Error */
  public static zqf a(Class paramClass)
  {
    // Byte code:
    //   0: getstatic 24	zqj:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   3: aload_0
    ...
    //   11: aload_1
    //   12: ifnonnull +53 -> 65
    //   15: getstatic 24	zqj:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   18: astore_3
    //   19: aload_3
    //   20: monitorenter
    //   21: aload_0
    ...
    //   29: aload_2
    //   30: astore_1
    //   31: getstatic 24	zqj:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   34: aload_0
    //   35: aload_1
  ...
  public static void a(String paramString, HashMap<String, String> paramHashMap)
  {
    ...
    do
    {
      ...
      {
        return;
        paramHashMap.put("deviceLv", String.valueOf(babp.f()));
