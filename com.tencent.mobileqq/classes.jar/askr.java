...
public class askr
  extends QIPCModule
{
  private static volatile askr a;
  
  public askr(String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
      ...
      {
        paramBundle = (asil)paramBundle.getManager(358);
      ...
      {
        ((asil)paramBundle.getManager(358)).a(0);
    ...
    paramString = (asil)paramBundle.getManager(358);
    paramBundle = new Bundle();
