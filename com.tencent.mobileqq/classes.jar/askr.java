  ...
  extends BaseAdapter
{
  ...
  public askr(List<FeedsItemData.LabelInfo> paramList, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = new askq();
      paramView = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
      paramView.setLayoutParams(new AbsListView.LayoutParams(-1, -2));
      localObject1 = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
      ((RelativeLayout)localObject1).setId(2131368175);
      Object localObject2 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject2).addRule(14);
      ((RelativeLayout.LayoutParams)localObject2).topMargin = aepi.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ((RelativeLayout)localObject1).setPadding(aepi.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      Object localObject3 = new ImageSwitcher(this.jdField_a_of_type_AndroidContentContext);
      ((ImageSwitcher)localObject3).setId(2131368054);
      ((ImageSwitcher)localObject3).setFactory(new asks(this));
      Object localObject4 = new RelativeLayout.LayoutParams(aepi.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      ((ImageSwitcher)localObject4).setFactory(new askt(this));
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aepi.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.addRule(5, ((ImageSwitcher)localObject3).getId());
      localLayoutParams.leftMargin = aepi.a(22.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      paramViewGroup.jdField_a_of_type_Asoc = new asoc(paramViewGroup.jdField_a_of_type_AndroidWidgetImageSwitcher, paramViewGroup.jdField_b_of_type_AndroidWidgetImageSwitcher);
      localObject2 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      ((ImageView)localObject2).setId(2131368053);
      localObject3 = new RelativeLayout.LayoutParams(aepi.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(32.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      ((RelativeLayout.LayoutParams)localObject2).topMargin = aepi.a(9.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      ((RelativeLayout.LayoutParams)localObject4).topMargin = aepi.a(2.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      ((ImageView)localObject3).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849801));
      localObject4 = new RelativeLayout.LayoutParams(aepi.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      paramView.setPadding(aepi.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aepi.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      paramView.setTag(paramViewGroup);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      if (asnl.a(localLabelInfo.redInfo))
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilMap.containsKey(localLabelInfo.name))
        {
          ...
          aahi.a((Map)localObject1, localLabelInfo.msgId);
          ...
          aahi.a(akwd.a(), "769", "205648", localLabelInfo.appId, "76903", "1", "160", (Map)localObject1);
        }
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localLabelInfo.friendList.size() >= 4)
        {
          ...
          if (paramInt < localLabelInfo.friendList.size())
          {
            ...
            paramInt += 1;
            continue;
            paramViewGroup = (askq)paramView.getTag();
            break;
          }
          paramViewGroup.jdField_a_of_type_Asoc.a((List)localObject1);
        }
      }
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(alud.a(2131710711));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(alud.a(2131710706) + localLabelInfo.friendNum + alud.a(2131710698));
      return paramView;
      localObject1 = URLDrawable.getDrawable(((FeedsItemData.FriendInfo)localLabelInfo.friendList.get(0)).icon);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageSwitcher.setVisibility(0);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject1);
    ...
    try
    {
      ...
      if ((localLabelInfo.icons != null) && (localLabelInfo.icons.size() > 0))
      {
        ...
        if (localLabelInfo.icons.size() >= 4) {
          paramViewGroup.jdField_a_of_type_Asoc.a(localLabelInfo.icons);
        }
      }
      for (;;)
      {
