...
public class anov
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "mqqapi://forward/url?src_type=internal&plg_auth=1&version=1&style=home&url_prefix=" + bgku.encodeToString("https://buluo.qq.com/mobile/v2/buluoindex.html?_wv=16778243&_bid=128&from=dongtai&target=hot&_nav_txtclr=000000&_wwv=265&sonic=1".getBytes(), 0);
  }
  ...
  private void j()
  {
    ...
    localLebaPluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131716425);
  ...
  private void k()
  {
    ...
    Map localMap = anoy.a(anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    if (localMap == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        ...
        {
          LebaPluginInfo localLebaPluginInfo = (LebaPluginInfo)localList.get(i);
          anow localanow = (anow)localMap.get(Long.valueOf(localLebaPluginInfo.uiResId));
          if (localanow == null)
          {
          ...
          else
          {
            ...
            localLebaPluginInfo.sPriority = anoy.a(localanow);
          }
        }
      }
  ...
  public PluginConfig.GetResourceReq a()
  {
    ...
    if (anoy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.i("LebaHelper", 1, "getLebaPluginInfoReq ，isAppUpgrade");
      anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
      anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    if (anpe.c())
    {
    ...
    if (anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.i("LebaHelper", 1, "getLebaPluginInfoReq ，isChangeModel");
      anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
    }
    int k = anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void a(int paramInt1, List<anow> paramList, int paramInt2, int paramInt3)
  {
    int j = anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (paramList == null) {}
    for (int i = -1;; i = paramList.size())
    {
      ...
      {
        anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1);
        anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList);
        anoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt2, paramInt3);
      }
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, List<anow> arg3, List<LebaPluginInfo> paramList1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      h();
      if (bool3) {
        ((antv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(87)).a(1);
      }
      if (bool1)
      {
  ...
  public boolean a()
  {
    return anoy.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1;
  }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Boolean = false;
      ((avrf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(128)).a();
  ...
  public void b(boolean paramBoolean, int paramInt1, List<anow> paramList, List<LebaPluginInfo> paramList1, int paramInt2, int paramInt3)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        anow localanow = (anow)paramList.next();
        if (localanow != null) {
          localStringBuilder.append(localanow.toString());
        }
      }
    }
  ...
  public void f()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 64	anov:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: ifnull +13 -> 17
    //   7: aload_0
    //   8: getfield 64	anov:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   32: return
    //   33: aload_0
    //   34: getfield 71	anov:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_1
    //   39: monitorenter
    //   40: aload_0
    //   41: getfield 71	anov:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   44: invokeinterface 505 1 0
    //   49: aload_1
    //   50: monitorexit
    //   51: aload_0
    //   52: invokespecial 516	anov:j	()V
    //   55: aload_0
    //   56: invokespecial 518	anov:k	()V
    //   59: aload_0
    //   60: getfield 54	anov:jdField_a_of_type_ArrayOfByte	[B
    //   63: astore_1
    //   64: aload_1
    //   65: monitorenter
    //   66: aload_0
    //   67: getfield 69	anov:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   70: invokeinterface 505 1 0
    //   75: aload_0
    //   76: getfield 69	anov:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   79: aload_0
    //   80: getfield 71	anov:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   113: aload_0
    //   114: getfield 69	anov:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   131: aload_0
    //   132: iconst_1
    //   133: putfield 522	anov:jdField_b_of_type_Boolean	Z
    //   136: return
    //   137: astore_2
