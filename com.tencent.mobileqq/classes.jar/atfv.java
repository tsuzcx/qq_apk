...
public class atfv
  implements bdhu, bdkt
{
  private double jdField_a_of_type_Double;
  int jdField_a_of_type_Int = 0;
  private Handler jdField_a_of_type_AndroidOsHandler = new atfw(this, Looper.getMainLooper());
  ...
  public atfv(WebRecordApiPlugin paramWebRecordApiPlugin, AppInterface paramAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  private void e(String paramString)
  {
    ...
    {
      return;
      localObject = bczr.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "LAST_DELETE_TIME");
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (paramInt1 != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719540) + "'}" });
        return;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131694851) + "'}" });
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    {
      awtg.b(paramString);
      bczr.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_JavaLangString, Double.toString(this.jdField_a_of_type_Double));
      arrayOfByte = bdcs.a(paramString);
      localObject = null;
  ...
  public void a(JSONArray paramJSONArray, String paramString1, String paramString2)
  {
    ...
    if (i < paramJSONArray.length())
    {
      ...
      String str = bczr.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (String)localObject);
      long l;
  ...
  public void b(String paramString)
  {
    ...
    if ((((File)localObject).exists()) && (bczr.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString) != null))
    {
      double d = Double.valueOf(bczr.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString)).doubleValue();
      long l;
      if (((File)localObject).exists())
      {
        ...
        this.jdField_a_of_type_Bdks = new bdks(((AudioInfo)localObject).path, new Handler(), ((AudioInfo)localObject).getAudioType());
        this.jdField_a_of_type_Bdks.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
