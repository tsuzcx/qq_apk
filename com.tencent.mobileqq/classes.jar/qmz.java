...
public class qmz
{
  private static final String jdField_a_of_type_JavaLangString = qmz.class.getSimpleName();
  ...
  public qmz(ColorBandVideoEntranceButton paramColorBandVideoEntranceButton, Context paramContext)
  {
    ...
    paramColorBandVideoEntranceButton = onh.a();
    ...
    for (;;)
    {
      this.jdField_a_of_type_Nps = ((nps)paramColorBandVideoEntranceButton.a(90));
      this.jdField_a_of_type_Npt = new qna(this, null);
      paramColorBandVideoEntranceButton.addObserver(this.jdField_a_of_type_Npt);
      this.jdField_a_of_type_Qnc = new qnc(this, null);
      osj.a().a(this.jdField_a_of_type_Qnc);
      return;
      label121:
  ...
  {
    SharedPreferences localSharedPreferences = bhvy.a(this.jdField_c_of_type_JavaLangString);
  ...
  private VideoInfo a()
  {
    Object localObject = bhvy.a(this.jdField_c_of_type_JavaLangString);
  ...
  public static void a(rux paramrux)
  {
    qjk.a().a(paramrux);
    if (paramrux == null) {}
    label201:
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            if (!(paramrux instanceof VideoInfo)) {
              break label244;
            }
            localObject = (VideoInfo)paramrux;
            ...
            if (localObject != null)
            {
              ...
              paramrux = ((VideoInfo)localObject).jdField_g_of_type_JavaLangString;
              localJSONObject.put("rowkey", paramrux);
              nol.a(null, "CliOper", "", "", "0X80081C6", "0X80081C6", 0, 0, "", "", "", localJSONObject.toString(), false);
              if (QLog.isColorLevel()) {
              ...
              nol.a(null, "", "0X8009A22", "0X8009A22", 0, 0, "", "", "", onh.a((VideoInfo)localObject, i), false);
              return;
            }
          }
          catch (Exception paramrux)
          {
            paramrux.printStackTrace();
            return;
          }
          i = 1;
          continue;
      ...
      nol.a(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", onh.a((VideoInfo)localObject, i), false);
      return;
    } while (!(paramrux instanceof VideoInfo.EntranceDownloadInfo));
    paramrux = (VideoInfo.EntranceDownloadInfo)paramrux;
    Object localObject = new qzb("", "", "", "");
    ((qzb)localObject).W(1).a(paramrux.jdField_c_of_type_JavaLangString).a(0);
    nol.a(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", ((qzb)localObject).a().a(), false);
  }
  ...
  public static void b(rux paramrux)
  {
    ThreadManager.excute(new VideoFeedsFirstVideoRecommendationManager.1(paramrux), 16, null, true);
  }
  ...
  private void e()
  {
    ...
    {
      localObject = bhvy.a(this.jdField_c_of_type_JavaLangString);
      if (localObject != null) {
  ...
  {
    boolean bool;
    if ((this.jdField_a_of_type_Nps != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean))
    {
      nps localnps = this.jdField_a_of_type_Nps;
      npt localnpt = this.jdField_a_of_type_Npt;
      String str = this.jdField_b_of_type_JavaLangString;
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        bool = true;
        localnps.a(localnpt, str, paramInt, bool);
        if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    QQAppInterface localQQAppInterface = onh.a();
    if ((localQQAppInterface != null) && (this.jdField_a_of_type_Npt != null)) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Npt);
    }
  }
  ...
  public void c()
  {
    ...
    osj.a().b(this.jdField_a_of_type_Qnc);
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Nps = ((nps)localQQAppInterface.a(90));
      localQQAppInterface.addObserver(this.jdField_a_of_type_Npt);
