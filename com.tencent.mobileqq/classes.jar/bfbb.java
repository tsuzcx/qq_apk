...
{
  private FilenameFilter jdField_a_of_type_JavaIoFilenameFilter = new bfbc(this);
  ...
  {
    boolean bool2 = false;
    File localFile1 = new File(ajed.aT, "/tencent/MobileQQ/qqcomic/offline/");
  ...
  {
    Object localObject = new File(ajed.aT, "/tencent/MobileQQ/qqcomic/offline/").list(this.jdField_a_of_type_JavaIoFilenameFilter);
    boolean bool;
  ...
  {
    return new File(new File(ajed.aT, "/tencent/MobileQQ/qqcomic/offline/"), paramString);
  }
  ...
  public String[] reportHistoryFileInfo()
  {
    ...
    File localFile = new File(ajed.aT, "/tencent/MobileQQ/qqcomic/offline/");
