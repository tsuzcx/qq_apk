  ...
  extends ball
{
  ...
  public Bundle a(int paramInt, Bundle paramBundle)
  {
    ...
    if (paramInt == 16)
    {
      baln.a("PTV.RichmediaClient", "ICallBack.Stub() getData start. ICALLBACK_CMD_GET_PRESEND_MGR_HANDLER");
    ...
    for (;;)
    {
      ...
      return localBundle;
      label113:
      paramBundle = new Messenger(localPresendPicMgr.jdField_a_of_type_Ayyk).getBinder();
      baln.a("PTV.RichmediaClient", "ICallBack.Stub() getData. ICALLBACK_CMD_GET_PRESEND_MGR_HANDLER , b = " + paramBundle);
    }
  }
  
  public void a(int paramInt, Bundle paramBundle)
  {
    baln.a("PTV.RichmediaClient", "sendRequest. cmd = " + paramInt + ",data = " + paramBundle);
    if (paramBundle != null)
    {
    ...
    do
    {
          ...
          do
          {
            do
            {
              ...
              if (paramBundle != null)
              {
                ...
                paramBundle = PresendPicMgr.b(ayxf.a(paramBundle.a));
                baln.a("PTV.RichmediaClient", "ICALLBACK_CMD_INIT_PRESEND_PIC_MGR  presendMgr = " + paramBundle);
                return;
              }
              baln.a("PTV.RichmediaClient", "ICALLBACK_CMD_INIT_PRESEND_PIC_MGR  failed, bw is null ! ");
              return;
      ...
      ayzb.e = paramBundle[0];
      ayzb.f = paramBundle[1];
      ayzb.g = paramBundle[2];
      ayzb.h = paramBundle[3];
      ayzb.i = paramBundle[4];
      ayzb.j = paramBundle[5];
      ayzb.a = paramBundle[6];
      ayzb.b = paramBundle[7];
      ayzb.c = paramBundle[8];
  ...
  {
    baln.a("PTV.RichmediaClient", "ICallBack.Stub() compress start. info.src = " + paramCompressInfo.c + ",uuid = " + paramCompressInfo.a);
    ayyz.a(paramCompressInfo);
    baln.a("PTV.RichmediaClient", "ICallBack.Stub() compress finish. info = " + paramCompressInfo);
  }
}
