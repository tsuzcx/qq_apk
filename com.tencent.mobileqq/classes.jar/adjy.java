...
public class adjy
{
  private adkc jdField_a_of_type_Adkc = new adjz(this);
  ...
  public adjy(Context paramContext, String paramString)
  {
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    if ((paramString.toLowerCase().startsWith("http://")) || (paramString.toLowerCase().startsWith("https://")))
    {
      ...
      localIntent.putExtra("selfSet_leftViewText", ajya.a(2131706548));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Adkc = null;
    this.jdField_a_of_type_AndroidContentContext = null;
  }
  
  public void a(adkd paramadkd)
  {
    this.jdField_a_of_type_Adkd = paramadkd;
  }
  ...
  public void a(Context paramContext, ArrayList<IntimateInfo.MemoryDayInfo> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      while (i < localArrayList.size())
      {
        ...
        localObject = new adka(this, paramContext);
        if (localObject != null)
        {
          ((adka)localObject).a(paramArrayList);
          ((adka)localObject).a(this.jdField_a_of_type_Adkc);
          if (((adka)localObject).a() != null) {
            this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(((adka)localObject).a());
          }
        }
        i += 1;
        continue;
