...
public class anbw
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new anbx(this);
  ...
  public anbw(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Anbu = ((anbu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(259));
  }
  ...
  private String b(String paramString)
  {
    if ((paramString != null) && (!"".equals(paramString)))
    {
      ...
      return ajed.bf + akhi.a(str) + paramString + ".jpg";
    }
    return "";
  }
  ...
  public int a()
  {
    return (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - awmc.a(11.0F) * 2 - awmc.a(2.0F) * 2) / 3;
  }
  ...
  public int a(URLDrawable paramURLDrawable)
  {
        ...
        if (axoa.b(str))
        {
          ...
          if (str != null)
          {
            ...
            if (!"".equals(str))
            {
              ...
              str = ajed.bf + akhi.a((String)localObject) + str + ".jpg";
            }
          }
        }
      }
    ...
    try
    {
      ...
      i = adwz.a(this.jdField_a_of_type_AndroidContentContext, str);
      return i;
    }
  ...
  public Drawable a(Drawable paramDrawable, int paramInt)
  {
    ...
    for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
    {
      ...
      return new BitmapDrawable(bacm.a((Bitmap)localObject, ((Bitmap)localObject).getWidth(), ((Bitmap)localObject).getHeight()));
    }
  }
  ...
  public EmoticonFromGroupEntity a(MessageRecord paramMessageRecord)
  {
    ...
    if ((localMessageForPic.imageType == 3) || (localMessageForPic.imageType == 2000))
    {
      ...
      paramMessageRecord = axwd.a(localMessageForPic, 65537);
      ...
      paramMessageRecord = axwd.a(localMessageForPic, 1);
      if (paramMessageRecord != null) {
        break label162;
      }
    }
    ...
    if (l >= paramLong)
    {
      ...
      if (7 > i)
      {
        ...
        default: 
          return null;
        case 0: 
          return ajjy.a(2131638271);
        case 1: 
          return ajjy.a(2131638295);
        case 2: 
          return ajjy.a(2131638258);
        case 3: 
          return ajjy.a(2131638272);
        case 4: 
          return ajjy.a(2131638254);
        case 5: 
          return ajjy.a(2131638278);
        }
        return ajjy.a(2131638286);
      }
  ...
  {
    if ((paramString != null) && (!paramString.isEmpty()) && (axoa.b(paramString)))
    {
      paramString = axoa.a(paramString);
      if (paramString != null) {
  ...
  {
    return this.jdField_a_of_type_Anbu.c();
  }
  ...
  public Map<String, List<EmoticonFromGroupEntity>> a(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        localObject = new TreeMap(new anby(this));
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonFromGroup_Manager", 2, "init mEmoManager.mCountOfSpare:" + this.jdField_a_of_type_Anbu.b);
    }
  }
  ...
  public void a(Context paramContext, MessageForPic paramMessageForPic, View paramView)
  {
    ...
    bfcq.a(paramContext, localBundle, new AIOImageProviderService(paramMessageForPic.selfuin, null, -1, paramMessageForPic), adwz.a(paramMessageForPic), -1, -1);
  }
  
  public void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Anbu.a(paramEmoticonFromGroupEntity, 2);
  }
  
  public void a(MessageRecord paramMessageRecord)
  {
    if (a(paramMessageRecord)) {
      this.jdField_a_of_type_Anbu.b(paramMessageRecord);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (String)localObject;; paramString = null)
    {
      if (paramString != null)
      {
        ...
        {
          if ((ajke.a(paramString.msg)) || (ajhz.a(paramString.msg))) {
            apcb.a(2131627031);
          }
        }
        else
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString.msg, new ancc(localMqqHandler));
  ...
  public void a(List<MessageRecord> paramList)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Anbu.a() >= 600) || (this.jdField_a_of_type_Anbu.b() >= 300))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((this.jdField_a_of_type_JavaUtilList.contains(localInteger)) && (!ajhz.a(localMessageRecord)) && (!ascr.a(localMessageRecord)))
          {
            if (QLog.isColorLevel()) {
              QLog.i("EmoticonFromGroup_Manager", 2, "filterMessageByType type: " + localInteger);
            }
            this.jdField_a_of_type_Anbu.a(localMessageRecord);
          }
        }
      }
    }
  ...
  public boolean a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (this.jdField_a_of_type_Anbu.b < 1)
    {
      if (300 == ance.a) {
      ...
      do
      {
        do
        {
          ...
          paramEmoticonFromGroupEntity = new anbz(this, (BaseActivity)localObject);
        } while (localObject == null);
        paramEmoticonFromGroupEntity = babr.a((Context)localObject, 0, ajjy.a(2131638275), ((BaseActivity)localObject).getString(2131624148), ajjy.a(2131638273), ajjy.a(2131638297), paramEmoticonFromGroupEntity, paramEmoticonFromGroupEntity);
      } while (paramEmoticonFromGroupEntity == null);
      paramEmoticonFromGroupEntity.show();
      return false;
    }
    localObject = this.jdField_a_of_type_Anbu;
    ((anbu)localObject).b -= 1;
    c(paramEmoticonFromGroupEntity);
    bbmy.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131626441, 0).b(2131167766);
    return true;
  }
  ...
  {
    return this.jdField_a_of_type_Anbu.b();
  }
  
  public void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Anbu.a(paramEmoticonFromGroupEntity);
  }
  ...
  {
    this.jdField_a_of_type_Anbu.a(paramList, 2);
  }
  ...
  public void c(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    {
      this.jdField_a_of_type_Anbu.jdField_a_of_type_JavaUtilList.add(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new ancb(this, localURLDrawable));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Anbu.jdField_a_of_type_JavaUtilList.remove(localURLDrawable);
  ...
  {
    this.jdField_a_of_type_Anbu.a(paramList);
  }
