...
public class aeis
  extends aedo
  implements Handler.Callback, avgh
{
  public RobotChatPanelLayout a;
  private RobotChatTipLayout a;
  private View o;
  
  public aeis(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private void bm()
  {
    if (baig.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
  ...
  private void bn()
  {
    ...
    localObject = (ImageView)this.c.findViewById(2131311579);
    if (localObject != null)
    {
      ((ImageView)localObject).setImageDrawable(avgi.a(this.jdField_a_of_type_AndroidContentContext));
      ((ImageView)localObject).setVisibility(0);
    }
    localObject = (acyp)this.jdField_a_of_type_Acxb.a(23);
    if (localObject != null) {
      ((acyp)localObject).b();
    }
  ...
  {
    super.M();
    acyc localacyc = (acyc)a(36);
    if ((localacyc != null) && (localacyc.a())) {
      localacyc.a(this.jdField_a_of_type_AndroidWidgetTextView);
    }
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRobotchatRobotChatPanelLayout != null) {
      this.jdField_a_of_type_ComTencentMobileqqRobotchatRobotChatPanelLayout.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, d(), this, new aeit(this));
    }
  }
  ...
  {
    baig.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
    ...
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A486", "0X800A486", 0, 0, "", "", "", "");
  }
  ...
  {
    super.b(paramIntent);
    this.e.setOnClickListener(new aeiu(this));
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    acyc localacyc = (acyc)a(36);
    if ((localacyc != null) && (localacyc.a())) {
      localacyc.a(paramInt1, paramInt2);
    }
  }
  ...
  public void i(int paramInt)
  {
    ...
    acyp localacyp = (acyp)this.jdField_a_of_type_Acxb.a(23);
    if (localacyp != null) {
      localacyp.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqRobotchatRobotChatPanelLayout, this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((localacyc != null) && (localacyc.a())) {
        ...
        {
          localacyc.a(false);
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A487", "0X800A487", 0, 0, "", "", "", "");
        }
        else
        {
          localacyc.a(true);
  ...
  public void x()
  {
    azgu.a(this.jdField_a_of_type_AndroidContentContext, null, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    awqx.b(null, "dc00898", "", "", "0X800A48B", "0X800A48B", 0, 0, "", "", "", "");
  }
}
