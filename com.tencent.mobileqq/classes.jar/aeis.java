  ...
  extends AbstractImageAdapter
{
  ...
  private aeic jdField_a_of_type_Aeic;
  public aejb a;
  private Context jdField_a_of_type_AndroidContentContext;
  Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable;
  private LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  bfob jdField_a_of_type_Bfob = new bfob(ThreadManager.getSubThreadLooper(), null);
  ...
  public aeis(Activity paramActivity, int paramInt, aeic paramaeic, aejb paramaejb, GridView paramGridView)
  {
    this.jdField_a_of_type_AndroidContentContext = paramActivity;
    this.jdField_a_of_type_AndroidViewLayoutInflater = paramActivity.getLayoutInflater();
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Aeic = paramaeic;
    paramaeic.d(4);
    this.jdField_a_of_type_Aejb = paramaejb;
    this.jdField_a_of_type_ComTencentWidgetGridView = paramGridView;
    this.jdField_b_of_type_Int = actj.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    if (!aeiy.class.isInstance(localObject2))
    {
      QLog.d("AIOPhotoListAdapter", 2, "[updateView] is not AIORichMediaInfo, position:" + paramInt);
      return;
    }
    if (!(localObject1 instanceof aeit))
    {
      QLog.d("AIOPhotoListAdapter", 2, "[updateView] is not ContentHolder, position:" + paramInt);
      return;
    }
    localObject1 = (aeit)localObject1;
    aeiy localaeiy = (aeiy)localObject2;
    URLImageView localURLImageView = ((aeit)localObject1).jdField_a_of_type_ComTencentImageURLImageView;
    ImageView localImageView1 = ((aeit)localObject1).jdField_a_of_type_AndroidWidgetImageView;
    ImageView localImageView2 = ((aeit)localObject1).jdField_b_of_type_AndroidWidgetImageView;
    localObject2 = ((aeit)localObject1).c;
    Object localObject3 = ((aeit)localObject1).jdField_a_of_type_AndroidWidgetTextView;
    TextView localTextView = ((aeit)localObject1).jdField_b_of_type_AndroidWidgetTextView;
    Object localObject4 = ((aeit)localObject1).jdField_a_of_type_AndroidViewView;
    ((View)localObject4).setVisibility(8);
    localTextView.setVisibility(8);
    localURLImageView.setBackgroundColor(0);
    File localFile = null;
    if (AIOImageData.class.isInstance(localaeiy.a))
    {
      ((ImageView)localObject2).setVisibility(4);
      ((TextView)localObject3).setVisibility(4);
      localObject1 = (AIOImageData)localaeiy.a;
      ...
      if (localFile != null)
      {
        ...
        ((URLDrawable.URLDrawableOptions)localObject3).mLoadingDrawable = aywm.b;
    ...
    if (AppSetting.d)
    {
      localObject1 = ajya.a(2131700116);
      if (localObject1 != null)
      {
        i = paramInt / 4;
        paramView.setContentDescription(ajya.a(2131700117) + (i + 1) + ajya.a(2131700118) + (paramInt % 4 + 1) + (String)localObject1);
      }
      ...
      {
        QLog.d("AIOPhotoListAdapter", 2, "[updateView] cost: " + (SystemClock.uptimeMillis() - l) + " data" + localaeiy.a);
        return;
        localURLImageView.setImageDrawable(URLDrawable.getDrawable(localFile, (URLDrawable.URLDrawableOptions)localObject3));
        break label324;
        ...
        localURLImageView.setImageDrawable(aywm.b);
        this.jdField_a_of_type_Bfob.post(new AIOPhotoListAdapter.1(this, (AIOImageData)localObject1));
        break label324;
        if (AIOShortVideoData.class.isInstance(localaeiy.a))
        {
          ((View)localObject4).setVisibility(0);
          localObject4 = (AIOShortVideoData)localaeiy.a;
          if (((AIOShortVideoData)localObject4).jdField_b_of_type_Int == 0)
          {
            ...
            ((URLDrawable.URLDrawableOptions)localObject2).mLoadingDrawable = aywm.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          ...
          for (;;)
          {
            ...
            localObject1 = ajya.a(2131700114);
            break;
            ((ImageView)localObject2).setImageResource(2130839075);
            ((aeit)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
            break label663;
            localURLImageView.setImageDrawable(URLDrawable.getDrawable((String)localObject1, (URLDrawable.URLDrawableOptions)localObject2));
            continue;
            ...
            {
              localURLImageView.setImageDrawable(aywm.b);
              this.jdField_a_of_type_Bfob.post(new AIOPhotoListAdapter.2(this, (AIOShortVideoData)localObject4));
            }
          }
        }
        if (AIOFilePicData.class.isInstance(localaeiy.a))
        {
          ((ImageView)localObject2).setVisibility(4);
          ((TextView)localObject3).setVisibility(4);
          localObject4 = (AIOFilePicData)localaeiy.a;
          ...
          for (;;)
          {
            ...
            localObject1 = ajya.a(2131700110);
            break;
            ...
            else
            {
              localURLImageView.setImageDrawable(aywm.b);
              if ((apei.a()) || (this.c != 2)) {
                this.jdField_a_of_type_Bfob.post(new AIOPhotoListAdapter.3(this, (AIOFilePicData)localObject4));
              }
            }
          }
        }
        if (AIOFileVideoData.class.isInstance(localaeiy.a))
        {
          localObject1 = (AIOFileVideoData)localaeiy.a;
          ((View)localObject4).setVisibility(0);
          ((ImageView)localObject2).setImageResource(2130839207);
          ((ImageView)localObject2).setVisibility(0);
          ...
          for (;;)
          {
            ...
            localObject1 = ajya.a(2131700113);
            break;
            localURLImageView.setImageDrawable(URLDrawable.getDrawable((String)localObject1, (URLDrawable.URLDrawableOptions)localObject3));
            continue;
        ...
        localObject1 = localFile;
        if (!AIOLightVideoData.class.isInstance(localaeiy.a)) {
          break label337;
        }
        ((View)localObject4).setVisibility(0);
        localObject1 = (AIOLightVideoData)localaeiy.a;
        ((ImageView)localObject2).setImageResource(2130839075);
        ...
        for (;;)
        {
          ...
          localObject1 = ajya.a(2131700111);
          break;
          localURLImageView.setImageDrawable(URLDrawable.getDrawable((String)localObject1, (URLDrawable.URLDrawableOptions)localObject2));
          continue;
          localURLImageView.setImageDrawable(aywm.b);
          this.jdField_a_of_type_Bfob.post(new AIOPhotoListAdapter.4(this, (AIOLightVideoData)localObject1));
        }
        if (localImageView1 != null) {
        ...
        if (localImageView2 != null)
        {
          localImageView2.setImageResource(2130844862);
          ...
          if (localImageView2 != null)
          {
            localImageView2.setImageResource(2130844859);
            localImageView2.setVisibility(0);
            continue;
            if (localImageView1 != null) {
              localImageView1.setVisibility(4);
  ...
  public Object getItem(int paramInt)
  {
    ...
    if (paramInt < this.jdField_a_of_type_Aeic.g()) {
      return this.jdField_a_of_type_Aeic.a(paramInt);
    }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if ((localObject instanceof aeiy)) {}
    do
    {
      return 0;
      if (aeic.b.equals(localObject)) {
        return 1;
      }
      if ((localObject instanceof String)) {
        return 2;
      }
      if (aeic.jdField_a_of_type_JavaLangObject.equals(localObject)) {
        return 3;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        ...
        break;
        if (aeit.class.isInstance(paramViewGroup)) {
          break label48;
        }
        ...
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560955, null);
        paramView.setLayoutParams(new AbsListView.LayoutParams(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int));
        localObject1 = new aeit(this);
        ((aeit)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131371559));
        ((aeit)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
        ((aeit)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368351));
        ((aeit)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371564));
        ((aeit)localObject1).c = ((ImageView)paramView.findViewById(2131371491));
        ((aeit)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379017));
        ((aeit)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366249));
        ((aeit)localObject1).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131363373);
        paramView.setTag(localObject1);
        break label48;
        if (aeic.b.equals(paramViewGroup)) {
          break label48;
        }
        paramView = new View(this.jdField_a_of_type_AndroidContentContext);
        paramView.setLayoutParams(new AbsListView.LayoutParams(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int));
        paramView.setTag(aeic.b);
        break label48;
        ...
        paramViewGroup = new aeiv(this);
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131377190));
        paramView = new aeiu(this, this.jdField_a_of_type_AndroidContentContext);
        ...
        break label48;
        if (aeic.jdField_a_of_type_JavaLangObject.equals(paramViewGroup)) {
          break label48;
        }
        paramView = new View(this.jdField_a_of_type_AndroidContentContext);
        paramView.setMinimumHeight(this.jdField_b_of_type_Int);
        paramView.setVisibility(4);
        paramView.setTag(aeic.jdField_a_of_type_JavaLangObject);
        break label48;
        ...
        return paramView;
      } while (!aeiv.class.isInstance(paramViewGroup));
      paramViewGroup = (aeiv)paramViewGroup;
    ...
    paramInt /= 4;
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajya.a(2131700112) + (paramInt + 1) + ajya.a(2131700115) + (String)localObject1);
    return paramView;
  }
