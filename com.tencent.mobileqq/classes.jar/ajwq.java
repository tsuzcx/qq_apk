...
{
  public ajwq(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.UploadFileRspBody paramUploadFileRspBody, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      ...
      TroopTechReportUtils.a(TroopTechReportUtils.TroopFileReportResultCode.b, TroopTechReportUtils.TroopFileReportResultCode.z);
      return;
    }
    ...
    if (i < 0)
    {
      ...
      case -138: 
        for (;;)
        {
          ...
          paramInt = 208;
          continue;
          new Handler(Looper.getMainLooper()).postDelayed(new ajwr(this, paramBundle), 1000L);
          return;
