  ...
  implements PolymericContainer
{
  ...
  private EventCallback jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerPolymericEventCallback = new qfa(this);
  public PolymericContainerHelper a;
  private VafContext jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext;
  protected Map<String, Integer> a;
  protected ppu a;
  private qfc jdField_a_of_type_Qfc;
  private qfd jdField_a_of_type_Qfd;
  private tpd jdField_a_of_type_Tpd = new tpd();
  private boolean jdField_a_of_type_Boolean = true;
  private List<BaseArticleInfo> jdField_b_of_type_JavaUtilList;
  protected Map<Integer, String> b;
  
  public qeu(VafContext paramVafContext)
  {
  ...
  {
    QLog.d("RecycleViewAdapterHelper", 1, "addExportItem curPosition: " + paramInt + "  model :" + this.jdField_a_of_type_Ppu);
    ...
    if ((this.jdField_a_of_type_Ppu != null) && (this.jdField_a_of_type_Ppu.a() != null) && (localTemplateBean != null)) {}
    try
    {
      if ((this.jdField_a_of_type_Ppu.a().mGroupSubArticleList != null) && (this.jdField_a_of_type_Ppu.a().mGroupSubArticleList.size() > paramInt) && (ozs.s(this.jdField_a_of_type_Ppu.a())) && (this.jdField_a_of_type_Ppu.a().mNewPolymericInfo.jdField_a_of_type_Boolean)) {
        a((BaseArticleInfo)this.jdField_a_of_type_Ppu.a().mGroupSubArticleList.get(paramInt), paramInt);
      }
      for (;;)
      {
        ...
        {
          return;
          localObject2 = (List)c.get(Long.valueOf(this.jdField_a_of_type_Ppu.a().mArticleID));
          localObject1 = localObject2;
          if (localObject2 == null)
          {
            localObject1 = new ArrayList();
            c.put(Long.valueOf(this.jdField_a_of_type_Ppu.a().mArticleID), localObject1);
          }
        } while (paramInt < ((List)localObject1).size());
        Object localObject2 = this.jdField_a_of_type_Ppu.a().clone();
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Ppu.a().getContext();
    ...
    for (int i = 1;; i = 0)
    {
      localObject = new pqk((Context)localObject, localArticleInfo, j, k, i, paramInt, false, a(), null, this.jdField_a_of_type_Ppu.a());
      this.jdField_a_of_type_Ppu.a().a(paramBaseArticleInfo, (ppu)localObject, System.currentTimeMillis(), paramInt);
      return;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Tpd != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext != null)) {
      this.jdField_a_of_type_Tpd.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getContext(), this.jdField_a_of_type_Ppu, paramInt, nzq.jdField_b_of_type_Int);
    }
  }
  
  private void b(ppu paramppu)
  {
    if ((this.jdField_a_of_type_Ppu != null) && (this.jdField_a_of_type_Ppu != paramppu) && (this.jdField_a_of_type_Ppu.a() != null) && (this.jdField_a_of_type_Ppu.a().getId() != paramppu.a().getId()) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView != null)) {
  ...
  public void a(ppu paramppu)
  {
    ...
    } while (this.jdField_a_of_type_Ppu.a() == null);
    a(this.jdField_a_of_type_Ppu.a().mGroupSubArticleList);
  }
  
  public void a(qfc paramqfc)
  {
    this.jdField_a_of_type_Qfc = paramqfc;
  }
  
  public void a(qfd paramqfd)
  {
    this.jdField_a_of_type_Qfd = paramqfd;
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    int i = a(paramInt);
    Object localObject1;
    if ((paramViewHolder instanceof qfe))
    {
    ...
    for (;;)
    {
      ...
      a(i);
      b(i);
      Object localObject2 = (qfe)paramViewHolder;
      Container localContainer = (Container)((qfe)localObject2).itemView;
      BindDataUtil.bindDynamicValueWithoutRecursion(localContainer, ((qfe)localObject2).a, (TemplateBean)localObject1);
      ...
      ViewFactory.findClickableViewListener(((Container)((qfe)localObject2).itemView).getVirtualView(), new qev(this, i, (TemplateBean)localObject1));
      continue;
      if ((paramViewHolder instanceof qfb))
      {
        localObject1 = (qfb)paramViewHolder;
        localObject2 = ((qfb)localObject1).itemView.getLayoutParams();
        if (localObject2 != null)
        {
          ((ViewGroup.LayoutParams)localObject2).width = 0;
          ((ViewGroup.LayoutParams)localObject2).height = 0;
          ((qfb)localObject1).itemView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        }
      }
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (localObject == null)
    {
      ...
      tyd.a("error", "", paramViewGroup);
      a(new RecycleViewAdapterHelper.2(this));
      return new qfb(this, a());
    }
    ...
    return new qfe(this, (Container)localObject, null);
  }
