  ...
  extends ajqv
{
  ...
  public ajrz(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  private void f()
  {
    bmnm.a(this.jdField_a_of_type_Int, this.mActivity, this.mPhotoCommonData, false);
  ...
  public boolean addAndRemovePhotoByGesture(LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    if (((NewPhotoListActivity)this.mActivity).isGif(paramLocalMediaInfo)) {
      QQToast.a(this.mActivity, amtj.a(2131689747), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
    }
    long l;
    do
    {
      ...
      do
      {
        ...
        } while ((!this.jdField_a_of_type_Ajqu.isSupportVideoCheckbox) && (arrayOfString != null) && (!"image".equals(arrayOfString[0])));
    ...
    } while (l - this.jdField_a_of_type_Ajqu.lastTimeShowToast < 700L);
    paramLocalMediaInfo = BaseApplicationImpl.sApplication.getResources().getString(2131689748, new Object[] { Integer.valueOf(9 - this.e) });
    ...
    this.jdField_a_of_type_Ajqu.hasShownMaxSelectToast = true;
    return false;
    this.jdField_a_of_type_Ajqu.hasShownMaxSelectToast = false;
    if (paramBoolean) {
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      f();
      return;
      QQToast.a(this.mActivity, String.format(amtj.a(2131689742), new Object[] { Integer.valueOf(2) }), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, amtj.a(2131689752), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, amtj.a(2131689753), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, amtj.a(2131689751), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, amtj.a(2131689754), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, amtj.a(2131689749), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
    }
  }
  ...
  {
    AEResUtil.peakRequestAEResBasePackage();
    this.mPhotoCommonData.needMediaInfo = true;
    super.initData(paramIntent);
    int i = blvr.y.a();
    if (blvr.k(((NewPhotoListActivity)this.mActivity).getIntent())) {
      i = blvr.A.a();
    }
    for (;;)
    {
      ...
      bmbx.a("PhotoListLogicAECircle", "[AdditionalPick] initData---initialHasPickedNum=" + this.e + ", canPickVideo=" + this.jdField_a_of_type_Boolean);
      this.b = 3000;
      this.c = 3000;
      this.d = 60000;
      if (!TextUtils.isEmpty(paramIntent.getStringExtra("qq_camera_from_qcircle_scheme"))) {
        QQToast.a(this.mActivity, 0, amtj.a(2131689669), 1).a();
      }
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 0)
      {
        if (i == 0)
        {
          ...
          {
            QQToast.a(this.mActivity, amtj.a(2131689743), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
            return;
          }
          if (this.mPhotoCommonData.selectedPhotoList.size() + this.e >= 9)
          {
            paramView = BaseApplicationImpl.sApplication.getResources().getString(2131689748, new Object[] { Integer.valueOf(9 - this.e) });
