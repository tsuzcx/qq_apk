...
public class alvh
{
  ...
  public alvh(alvg paramalvg) {}
  
  public alvh a()
  {
    alvg.a().a(alvg.a().a(this.jdField_a_of_type_Alvf.b, this.jdField_a_of_type_Alvf.jdField_a_of_type_Long), this);
    return this;
  }
  
  public alvh a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    return this;
  }
  
  public alvh a(alvf paramalvf)
  {
    this.jdField_a_of_type_Alvf = paramalvf;
    return this;
  }
  
  public alvh a(alvl paramalvl)
  {
    this.jdField_a_of_type_Alvl = paramalvl;
    return this;
  }
  
  public alvh a(List<DanmuItemBean> paramList)
  {
    this.jdField_c_of_type_JavaUtilList = paramList;
    return this;
  }
  
  public alvh a(boolean paramBoolean)
  {
  ...
  public String a()
  {
    return String.format("CacheHolder - topicUin:%s, groupUin:%s, msgType:%s, peakCached:%s, videoStartTime:%s, videoEndTime:%s, nextStartIdx:%s, count:%s", new Object[] { Long.valueOf(this.jdField_a_of_type_Alvf.jdField_a_of_type_Long), Long.valueOf(this.jdField_a_of_type_Alvf.b), Integer.valueOf(this.jdField_a_of_type_Alvf.jdField_a_of_type_Int), Boolean.valueOf(this.jdField_a_of_type_Alvf.jdField_a_of_type_Boolean), Integer.valueOf(this.jdField_c_of_type_Int), Integer.valueOf(this.jdField_d_of_type_Int), Integer.valueOf(this.e), Integer.valueOf(this.f) });
  }
  ...
  public alvh b(List<Long> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    return this;
  }
  
  public alvh c(int paramInt)
  {
    this.e = paramInt;
    return this;
  }
  
  public alvh d(int paramInt)
  {
    this.jdField_c_of_type_Int = paramInt;
    return this;
  }
  
  public alvh e(int paramInt)
  {
