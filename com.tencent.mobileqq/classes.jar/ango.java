...
public class ango
{
  ...
  private Map<Integer, angq> jdField_a_of_type_JavaUtilMap;
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger;
  
  public ango(Activity paramActivity)
  {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    localangq.jdField_a_of_type_JavaLangString = paramString1;
    localangq.b = paramString2;
    localangq.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    if (this.jdField_a_of_type_JavaUtilMap != null) {
      this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(this.jdField_a_of_type_Int), localangq);
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilMap != null)
    {
      if ((angq)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt)) != null) {}
  ...
  void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_AndroidAppProgressDialog = new ProgressDialog(this.jdField_a_of_type_AndroidAppActivity, 2131690181);
      this.jdField_a_of_type_AndroidAppProgressDialog.setOnDismissListener(new angp(this));
