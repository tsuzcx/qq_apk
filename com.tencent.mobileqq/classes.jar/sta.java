  ...
  implements Boss, MonitorThreadPoolExecutor.ThreadPoolMonitorListener
{
  ...
  private final Executor jdField_a_of_type_JavaUtilConcurrentExecutor = new stc("StoryBoss.NetworkExecutor", 128, jdField_c_of_type_Int, null);
  private final Executor[] jdField_a_of_type_ArrayOfJavaUtilConcurrentExecutor = new Executor[3];
  private long jdField_b_of_type_Long;
  private final Executor jdField_b_of_type_JavaUtilConcurrentExecutor = new stc("StoryBoss.CpuExecutor", 16, jdField_a_of_type_Int, null);
  private final Executor jdField_c_of_type_JavaUtilConcurrentExecutor = new stc("StoryBoss.FileExecutor", 64, jdField_b_of_type_Int, null);
  
  public sta(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTribeAsyncAsyncLightWeightExecutor = new LightWeightExecutor(ste.a().getDefaultLooper(), 100);
    this.jdField_a_of_type_ComTribeAsyncAsyncLightWeightExecutor.setMonitorListener(this);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ste.a().getDefaultLooper());
    this.jdField_a_of_type_ComTribeAsyncAsyncJobController = new JobController(this);
    ste.a().registerSubscriber("root_group", this.jdField_a_of_type_ComTribeAsyncAsyncJobController);
  }
  ...
  private <Params, Progress, Result> Future<Result> a(Job<Params, Progress, Result> paramJob, int paramInt1, int paramInt2, @Nullable FutureListener<Progress, Result> paramFutureListener, @Nullable Params paramParams)
  {
    ...
    paramJob.addFutureListener(new stb(this, paramJob));
    if (paramInt1 == 0)
    {
      ste.a().dispatch(paramJob);
      return paramJob;
    }
    ste.a().dispatchDelayed(paramJob, paramInt1);
    return paramJob;
  }
  ...
  public <Params, Progress, Result> Future<Result> a(Job<Params, Progress, Result> paramJob, @Nullable FutureListener<Progress, Result> paramFutureListener, @Nullable Params paramParams)
  {
    ...
    if (paramJob != null) {
      veg.b("StoryBoss", "work hash code:" + paramJob.hashCode());
    }
    return paramJob;
  }
  ...
  public <Result> void cancelJob(Future<Result> paramFuture, boolean paramBoolean)
  {
    if ((paramFuture instanceof Worker)) {
      ste.a().cancelDispatch("", (Worker)paramFuture);
    }
    ste.a().dispatch(new JobController.CancelCommand(paramFuture, paramBoolean));
  }
  ...
  {
    veg.e("StoryBoss", paramString + " onQueueExceedLimit, size = " + paramInt);
  ...
  public void onWorkerExceedTime(String paramString, List<Runnable> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      veg.e("StoryBoss", paramString + " onWorkerExceedTime, runnable = " + paramList);
