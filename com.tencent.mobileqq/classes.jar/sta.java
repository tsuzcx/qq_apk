  ...
  implements ssp
{
  ...
  public sta(XListView paramXListView, List<BaseData> paramList, ssm paramssm)
  {
  ...
  private ssm a()
  {
    ...
    {
      bjqx localbjqx = (bjqx)this.jdField_a_of_type_ComTencentWidgetXListView.getAdapter();
      if ((localbjqx.getWrappedAdapter() instanceof ssm)) {
        return (ssm)localbjqx.getWrappedAdapter();
      }
    }
    return null;
  }
  ...
  private int b(int paramInt)
  {
    ...
    try
    {
      localObject = ((ssm)localObject).a(paramInt, null, this.jdField_a_of_type_ComTencentWidgetXListView, true);
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    paramView.getViewTreeObserver().addOnGlobalLayoutListener(new stb(this, paramInt, paramView));
  }
}
