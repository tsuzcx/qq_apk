...
public class alqo
  extends alqb
{
  public alqo(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = anzj.a(2131696777);
  ...
  {
    if ((paramObject instanceof alqo))
    {
      paramObject = (alqo)paramObject;
      paramObject.jdField_a_of_type_Bfoz.a(parambfoy.jdField_a_of_type_Bfoz);
      return paramObject;
    }
    paramObject = new alqo(BaseApplication.getContext());
