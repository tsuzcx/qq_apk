...
public class azjh
  implements Manager
{
  ajuc jdField_a_of_type_Ajuc = new azji(this);
  ...
  public azjh(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    ((ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).d(new azjk(paramString, new azjm(paramBoolean, paramLong)));
  }
  
  private void b(String paramString)
  {
    ((ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).d(new azjk(paramString, a(paramString)));
  }
  
  private void b(String paramString, boolean paramBoolean, long paramLong)
  {
    ajex localajex = (ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22);
    paramString = new azjk(paramString, new azjl(paramBoolean, paramLong));
    paramString.b = 3;
    localajex.d(paramString);
  }
  
  public azjn a(String paramString, boolean paramBoolean)
  {
    ...
    if (localObject == null) {
      return new azjn(this, paramString, false, "", 0L);
    }
    ...
    if ((((TroopInfo)localObject).dwGagTimeStamp != 0L) && (!bool))
    {
      ...
      return new azjn(this, paramString, true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131631776), 60L);
    }
    if ((((TroopInfo)localObject).dwGagTimeStamp_me != 0L) && (l < ((TroopInfo)localObject).dwGagTimeStamp_me + 3L))
    {
      ...
      String str = localContext.getString(2131632256);
      l = ((TroopInfo)localObject).dwGagTimeStamp_me + 3L;
      if (paramBoolean) {
        l = ((TroopInfo)localObject).dwGagTimeStamp_me - 30L;
      }
      return new azjn(this, paramString, true, String.format(str, new Object[] { b(localContext, l) }), 60L);
    }
    if (QLog.isDevelopLevel()) {
  ...
  public azjo a(String paramString)
  {
    Object localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    if (localObject == null) {
      return new azjo(this, paramString, 0L);
    }
    localObject = ((TroopManager)localObject).c(paramString);
    if (localObject == null) {
      return new azjo(this, paramString, 0L);
    }
    return new azjo(this, paramString, ((TroopInfo)localObject).dwGagTimeStamp);
  }
  
  public String a(Context paramContext, long paramLong)
  {
    return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131632120), new Object[] { b(paramContext, paramLong) });
  }
  ...
  public String a(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    paramContext = ((Context)localObject).getString(2131631953);
    String str1 = ((Context)localObject).getString(2131631952);
    localObject = ((Context)localObject).getString(2131631951);
    String str2 = ajjy.a(2131649598);
    if (paramLong1 < 60L) {
  ...
  public ArrayList<ajty> a(String paramString, boolean paramBoolean)
  {
    Object localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    if (localObject == null) {
      localObject = null;
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramLong3 == 0L)
        {
          paramString = ((Context)localObject2).getResources().getString(2131630657);
          localObject2 = (MessageForGrayTips)awbi.a(-2030);
      ...
      paramString = ((Context)localObject2).getResources().getString(2131630647);
      continue;
      label244:
      if (paramLong3 == 0L) {
        paramString = ((Context)localObject2).getResources().getString(2131630649, new Object[] { paramString });
      } else {
        paramString = ((Context)localObject2).getResources().getString(2131630650, new Object[] { paramString, c((Context)localObject2, paramLong3) });
      }
    }
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, long paramLong3, ArrayList<akcc> paramArrayList)
  {
    int i = 0;
    label528:
    label563:
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(((TroopInfo)localObject).troopowneruin)) {
          ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).b(((TroopInfo)localObject).troopuin, false);
        }
        ...
        localakcc = (akcc)paramArrayList.next();
        str4 = localakcc.jdField_a_of_type_JavaLangString;
        if ((localakcc.jdField_a_of_type_Long == 0L) || (localakcc.jdField_a_of_type_Long == 4294967295L))
        {
          paramLong2 = localakcc.jdField_a_of_type_Long;
          if (str4.equals(str2))
          {
            if (QLog.isColorLevel()) {
            ...
            a(str1, true);
            a(str1, str3, paramLong3, localakcc.jdField_a_of_type_Long, paramInt, false, bool);
            i = 1;
          }
          if (!str4.equals("0")) {
            break label467;
          ...
          b(str1);
          a(str1, true);
          a(str1, str3, paramLong3, localakcc.jdField_a_of_type_Long, paramInt, true, bool);
          i = 1;
          continue;
        }
        paramLong2 = localakcc.jdField_a_of_type_Long + paramLong3;
      }
      finally {}
      continue;
      label467:
      if (!str4.equals(str2)) {
        a(str1, paramLong3, localakcc.jdField_a_of_type_Long, paramInt, str3, str4, bool);
      }
      ...
      paramArrayList = (ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
      try
      {
  ...
  public void a(String paramString)
  {
    ...
    ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).h(paramString);
  }
  ...
  public final void a(String paramString, long paramLong)
  {
    ...
    ((ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).a("OidbSvc.0x89a_0", ((oidb_sso.OIDBSSOPkg)localObject2).toByteArray(), (Bundle)localObject1);
  }
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, int paramInt, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (bool))
    {
      ...
      str1 = babh.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
      str2 = babh.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString3);
      j = 0;
      i = 0;
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      if (((String)localObject2).equalsIgnoreCase(paramString2))
      {
        localObject1 = ajjy.a(2131649593);
        str1 = "";
        i = 1;
      }
      ...
      localObject1 = ajjy.a(2131649594) + (String)localObject1;
      str2 = "";
      j = 1;
    }
    label545:
    ...
    for (;;)
    {
      ...
      for (localObject2 = localObject3;; localObject2 = " " + (String)localObject3)
      {
        ...
        localObject3 = (MessageForGrayTips)awbi.a(-2030);
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      localObject1 = ((Context)localObject3).getString(2131631949);
      if ((paramBoolean2) && (bool))
      {
        str = (String)localObject1 + ((Context)localObject3).getString(2131632271);
        if (!paramBoolean1) {
          break label422;
        }
        if (paramLong2 == 0L) {
        ...
        localObject1 = ((Context)localObject3).getString(2131631943);
        localObject2 = babh.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
        if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equalsIgnoreCase(paramString2)) {
          break label570;
        }
        str = ajjy.a(2131649596);
      }
    }
    label409:
    label422:
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        ((MessageForGrayTips)localObject2).isread = true;
        if (!ajml.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2, false)) {
          break label550;
        }
        return;
        str = (String)localObject1 + ((Context)localObject3).getString(2131632270);
        break;
        if ((paramBoolean2) && (bool))
        {
          str = ((Context)localObject3).getString(2131631948);
          break;
        }
        str = ((Context)localObject3).getString(2131631941);
        break;
        localObject1 = ((Context)localObject3).getString(2131631857);
        break label126;
        if (paramLong2 != 0L) {}
        for (i = 2131631940;; i = 2131631856)
        {
  ...
  public final void a(String paramString, ArrayList<azjj> paramArrayList)
  {
    ...
    {
      localObject = (azjj)paramArrayList.get(i);
      str = str + ((azjj)localObject).jdField_a_of_type_JavaLangString + ((azjj)localObject).jdField_a_of_type_Long + "|";
      i += 1;
    }
    if (QLog.isDevelopLevel()) {
    ...
    while (i < paramArrayList.size())
    {
      azjj localazjj = (azjj)paramArrayList.get(i);
      ((ByteBuffer)localObject).putInt((int)Long.valueOf(localazjj.jdField_a_of_type_JavaLangString).longValue());
      ((ByteBuffer)localObject).putInt((int)localazjj.jdField_a_of_type_Long);
      str = localazjj.jdField_a_of_type_JavaLangString;
      l = localazjj.jdField_a_of_type_Long;
      i += 1;
    }
    ...
    ((ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).a("OidbSvc.0x570_8", paramArrayList.toByteArray(), (Bundle)localObject);
  }
  
  public void a(String paramString, boolean paramBoolean)
  {
    ((ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).d(new azjk(paramString, a(paramString, paramBoolean)));
  }
  ...
  public final boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (ajex)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22);
    if ((paramObject == null) || (!paramFromServiceMsg.isSuccess()))
    {
      a(str, false, l);
      if (l == 0L) {}
      for (i = 2131631858;; i = 2131631944)
      {
        a(i, false);
        if (QLog.isDevelopLevel()) {
  ...
  public boolean a(String paramString1, String paramString2, long paramLong)
  {
    ...
    localArrayList.add(new azjj(paramString2, paramLong));
    a(paramString1, localArrayList);
    return true;
  }
  
  public boolean a(String paramString, ArrayList<azjj> paramArrayList)
  {
    if (QLog.isDevelopLevel()) {
  ...
  public boolean a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (i == 12)
    {
      ...
      l2 = bakz.a(paramArrayOfByte, 6);
      bakz.a(paramArrayOfByte, 10);
      l3 = NetConnInfoCenter.getServerTime();
      int k = bakz.a(paramArrayOfByte, 14);
      int j = 16;
      ArrayList localArrayList = new ArrayList();
      i = 0;
      while (i < k)
      {
        long l4 = bakz.a(paramArrayOfByte, j);
        j += 4;
        long l5 = bakz.a(paramArrayOfByte, j);
        j += 4;
        localArrayList.add(new akcc(String.valueOf(l4), l5));
        i += 1;
      }
    ...
    {
      i = paramArrayOfByte[5];
      bakz.a(paramArrayOfByte, 6);
      l2 = NetConnInfoCenter.getServerTime();
      l3 = bakz.a(paramArrayOfByte, 10);
      i = paramArrayOfByte[14];
      a(paramInt, l1, l2, l3, bakz.a(paramArrayOfByte, 15, i), paramArrayOfByte[(i + 15)]);
    }
    return false;
  }
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    Context localContext = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext();
    int i = localContext.getResources().getDimensionPixelSize(2131167766);
    ...
    if (paramBoolean)
    {
      bbmy.a(localContext, 2, paramString, 0).b(i);
      return;
    }
    bbmy.a(localContext, 2130839293, paramString, 0).b(i);
  }
  ...
  public final boolean b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 2131631860;; i = 2131631947)
    {
      a(i, true);
      return true;
    }
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    if (localajtg != null)
    {
      try
      {
        ...
        {
          localajtg.a(Long.parseLong(paramString1), 0L, 6, null, 0, 0);
        }
        else
        {
          ...
          localajtg.a(l1, 0L, 3, paramString1, 0, 0);
        }
      }
  ...
  public String c(Context paramContext, long paramLong)
  {
    ...
    String str1 = paramContext.getString(2131631953);
    String str2 = paramContext.getString(2131631952);
    Object localObject = paramContext.getString(2131631951);
    if (paramLong < 60L) {
      paramContext = 1 + str1;
    }
    long l2;
