...
public class mlz
  implements Handler.Callback, ViewTreeObserver.OnGlobalLayoutListener, arxd
{
  private final int jdField_a_of_type_Int = 2130842125;
  ...
  private final String jdField_a_of_type_JavaLangString = BaseApplication.getContext().getString(2131694821);
  private mmg jdField_a_of_type_Mmg;
  public boolean a;
  private final int jdField_b_of_type_Int = 2130842127;
  private final String jdField_b_of_type_JavaLangString = BaseApplication.getContext().getString(2131694824);
  private int c = 0;
  private int d = 0;
  private int e = -1;
  private int f = -1;
  
  private mlz(Activity paramActivity)
  {
  ...
  public static mlz a(Activity paramActivity)
  {
    return new mlz(paramActivity);
  }
  ...
  private void a(int paramInt, long paramLong)
  {
    if (this.d != paramInt)
    {
      ...
      if (this.jdField_a_of_type_Mmg != null) {
        this.jdField_a_of_type_Mmg.a(this.d, paramLong);
      }
    }
  }
  ...
  private void g()
  {
    ...
    if ((localObject instanceof bdod))
    {
      localbdod = (bdod)localObject;
      localObject = null;
    }
    for (;;)
    {
      if (localbdod != null) {
        localObject = ljs.a(localbdod);
      }
      this.jdField_a_of_type_AndroidWidgetEditText.setText("");
      if ((this.jdField_a_of_type_Mmg != null) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        this.jdField_a_of_type_Mmg.a((String)localObject);
      }
      return;
      localObject = localObject.toString();
      if (bdol.a((String)localObject)) {
        localbdod = new bdod((CharSequence)localObject, 3, 16);
      }
    }
  }
  ...
  private void h()
  {
    ...
    if (this.jdField_a_of_type_Bkgm.hasMessages(2)) {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842127);
    if (c())
    {
      a(5, l);
      f();
      ...
      localMessage.arg1 = 0;
      localMessage.arg2 = 0;
      this.jdField_a_of_type_Bkgm.sendMessageDelayed(localMessage, 100L);
      return;
    }
    i();
  }
  ...
  private void j()
  {
    ...
    {
      if (this.jdField_a_of_type_Mmg != null) {
        this.jdField_a_of_type_Mmg.a(j, i, this.d, l);
      }
      return;
      i = 2;
      break;
  ...
  public mlz a(ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    return this;
  }
  
  public mlz a(EditText paramEditText)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnClickListener(new mma(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new mmb(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnKeyListener(new mmc(this));
    ViewCompat.setAccessibilityDelegate(this.jdField_a_of_type_AndroidWidgetEditText, new mmd(this));
    return this;
  }
  
  public mlz a(ImageView paramImageView)
  {
    this.jdField_a_of_type_AndroidWidgetImageView = paramImageView;
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842125);
  ...
  public mlz a(VideoChatRoomListView paramVideoChatRoomListView)
  {
    this.jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView = paramVideoChatRoomListView;
    this.jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView.setOnDispatchTouchEventResponseListener(new mmf(this));
    return this;
  }
  
  public mlz a(mmg parammmg)
  {
    this.jdField_a_of_type_Mmg = parammmg;
    return this;
  }
  ...
  public void a(arxg paramarxg)
  {
    if ((paramarxg instanceof ascv)) {
      ((ascv)paramarxg).a(null, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidWidgetEditText, null);
    }
  }
