  ...
  extends bcgw
{
  ...
  List<bcgw> jdField_a_of_type_JavaUtilList = null;
  ...
  private View a(View paramView)
  {
    ...
    ((ImageView)localObject).setImageResource(2130844332);
    ...
    localObject = paramView.findViewById(2131379856);
    if (localObject != null) {
  ...
  private void a(Resources paramResources, ImageView paramImageView)
  {
    ...
    {
      paramImageView.setBackgroundResource(2130844331);
      return;
    }
    paramImageView.setBackgroundResource(2130844330);
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (bcgw)this.jdField_a_of_type_JavaUtilList.get(i);
      paramView = ((bcgw)localObject2).jdField_a_of_type_JavaLangString;
      if (!"summary".equals(paramView)) {
        break label334;
      }
      paramView = new LinearLayout(paramContext);
      paramView.setId(2131377855);
      ...
      localObject3 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377856);
      ...
      ((ImageView)localObject1).setId(2131377854);
    ...
    do
    {
      for (;;)
      {
        ...
        paramView = ((bcgw)localObject2).a(paramContext, null, paramBundle);
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
        localObject2 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377856);
    ...
    label430:
    Object localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377856);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinearLayout(paramContext);
      paramView.setOrientation(1);
      paramView.setId(2131377856);
      if (!this.jdField_a_of_type_Boolean) {
        break label646;
      }
    ...
    for (;;)
    {
      ...
      paramView.setBackgroundColor(localResources.getColor(2131167193));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).rightMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      localObject3 = ((bcgw)localObject2).a(paramContext, null, paramBundle);
  ...
  public void a()
  {
    ...
    {
      return;
      localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377856);
    } while (localLinearLayout == null);
    localLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Boolean = false;
    a(this.jdField_a_of_type_AndroidContentContext.getResources(), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377854));
  }
  ...
  public boolean a(bcin parambcin)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_JavaLangString = parambcin.a("url");
      this.o = 0;
      Object localObject = parambcin.a("expand");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("true"))) {
        this.jdField_a_of_type_Boolean = true;
      }
      localObject = parambcin.a("animation");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("false"))) {
        this.jdField_b_of_type_Boolean = false;
      }
      localObject = parambcin.a("duration");
      if (localObject != null) {}
      try
      {
        this.jdField_c_of_type_Long = Long.parseLong((String)localObject);
        label157:
        if ((parambcin.jdField_a_of_type_JavaUtilList != null) && (parambcin.a() > 0))
        {
          Iterator localIterator = parambcin.jdField_a_of_type_JavaUtilList.iterator();
          localObject = null;
          if (localIterator.hasNext())
          {
            bcin localbcin = (bcin)localIterator.next();
            if (("summary".equals(localbcin.jdField_b_of_type_JavaLangString)) || ("hr".equals(localbcin.jdField_b_of_type_JavaLangString))) {
              parambcin = bchg.a(localbcin.jdField_b_of_type_JavaLangString);
            }
            do
            {
              ...
              localObject = parambcin;
              if (!parambcin.a(localbcin)) {
                break;
              }
              a(parambcin);
              localObject = parambcin;
              break;
              parambcin = (bcin)localObject;
            } while (!"item".equals(localbcin.jdField_b_of_type_JavaLangString));
            parambcin = localbcin.a("layout");
            try
            {
              if (!TextUtils.isEmpty(parambcin)) {}
              for (int i = Integer.parseInt(parambcin);; i = 0)
              {
                parambcin = bchg.a(i);
                this.o += 1;
                break;
  ...
  public void b()
  {
    ...
    {
      return;
      localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377856);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localObject2 = new bcid((ViewGroup)localObject1);
        ((bcid)localObject2).setDuration(this.jdField_c_of_type_Long);
        ((bcid)localObject2).setInterpolator(new DecelerateInterpolator());
      ...
      for (;;)
      {
        ...
        localObject2 = (bing)((QQAppInterface)localObject3).getBusinessHandler(85);
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append(this.d).append("&expand=").append(this.jdField_a_of_type_Boolean);
        ((bing)localObject2).a(((StringBuilder)localObject3).toString(), 1, false, 0.0D, 0.0D, (String)localObject1, 1, "", "", "");
        return;
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject2 = new bcic((ViewGroup)localObject1);
      ((bcic)localObject2).setDuration(this.jdField_c_of_type_Long);
      ((bcic)localObject2).setInterpolator(new AccelerateInterpolator());
      ((LinearLayout)localObject1).startAnimation((Animation)localObject2);
    }
    for (;;)
    {
