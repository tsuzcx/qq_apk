  ...
  implements aytw
{
  ...
  private aoqm(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, aoqn paramaoqn, aoqo paramaoqo)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, 1, paramaoqn, paramaoqo);
  }
  
  public static aytw a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, aoqn paramaoqn, aoqo paramaoqo)
  {
    if (paramaoqn == null) {
    ...
    return null;
    return new aoqm(paramQQAppInterface, paramLong1, paramLong2, paramaoqn, paramaoqo);
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Aytx != null) {
      this.jdField_a_of_type_Aytx.a(paramLong1);
    }
  }
  ...
  protected void a(ExcitingTransferUploadBizInfo paramExcitingTransferUploadBizInfo)
  {
    ...
    if ((this.jdField_a_of_type_Aoql instanceof aoqn))
    {
      aoqn localaoqn = (aoqn)this.jdField_a_of_type_Aoql;
      paramExcitingTransferUploadBizInfo.groupCode = localaoqn.jdField_a_of_type_Long;
      paramExcitingTransferUploadBizInfo.bufUuid = localaoqn.jdField_a_of_type_ArrayOfByte;
      paramExcitingTransferUploadBizInfo.bufUploadKey = localaoqn.b;
      return;
    }
  ...
  protected void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    for (String str = paramExcitingTransferUploadResultRp.m_strFileUrl;; str = "")
    {
      ...
      b(paramExcitingTransferUploadResultRp);
      if (this.jdField_a_of_type_Aytx != null) {
        this.jdField_a_of_type_Aytx.a(true, this.c, paramInt, "", "");
      }
      return;
    }
  }
