...
public class bijg
  extends bija
{
  public bijg(Activity paramActivity, JSONObject paramJSONObject, azxr paramazxr)
  {
    super(paramActivity, paramJSONObject, paramazxr);
    this.d = zps.a(paramActivity, 3.0F);
  }
  
  public ProfileCardFavorShowView a(Activity paramActivity)
  {
    return new ProfileCardFavorShowView(paramActivity, null, 2131562091);
  }
  ...
  protected void a(JSONObject paramJSONObject, View paramView, TextView paramTextView, ImageView paramImageView)
  {
    if ((paramView != null) && (paramTextView != null))
    {
      ...
      int i = zps.a(this.jdField_a_of_type_AndroidAppActivity, 300.0F);
      int j = (int)paramTextView.getPaint().measureText(paramTextView.getText().toString());
      int k = zps.a(this.jdField_a_of_type_AndroidAppActivity, 23.0F);
      int m = zps.a(this.jdField_a_of_type_AndroidAppActivity, 40.0F);
      paramView.setBackgroundDrawable(a(str, new bijh(Math.min(j + k, i), m)));
    }
    for (;;)
    {
  ...
  public void a(JSONObject paramJSONObject, TextView paramTextView, View paramView1, ImageView paramImageView, View paramView2, View paramView3)
  {
    ...
    if ((paramView1 instanceof TextView))
    {
      ...
      {
        i = zps.a(this.jdField_a_of_type_AndroidAppActivity, 6.0F);
        int j = zps.a(this.jdField_a_of_type_AndroidAppActivity, 12.0F);
        int k = zps.a(this.jdField_a_of_type_AndroidAppActivity, 12.0F);
        ...
        i = zps.a(this.jdField_a_of_type_AndroidAppActivity, 300.0F);
        j = (int)paramTextView.getPaint().measureText(paramTextView.getText().toString());
        k = zps.a(this.jdField_a_of_type_AndroidAppActivity, 23.0F);
        int m = zps.a(this.jdField_a_of_type_AndroidAppActivity, 40.0F);
        paramView2.setBackgroundDrawable(a(paramView1, new bijh(Math.min(j + k, i), m)));
  ...
  {
    paramHashMap.put("map_key_qzone", this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562100, null));
  }
}
