  ...
  extends bkhg
{
  ...
  private String jdField_c_of_type_JavaLangString = ajyc.a(2131706015);
  ...
  public bkhk(Context paramContext, String paramString)
  {
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.i = this.jdField_a_of_type_Bkgu.a("lineHeight", 20L, 200L, 0, this.jdField_b_of_type_Int - a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), new LinearInterpolator());
        this.j = this.jdField_a_of_type_Bkgu.a("offsetX", 180L, 330L, -this.jdField_a_of_type_Int, 0, new LinearInterpolator());
        return;
      }
