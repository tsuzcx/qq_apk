  ...
  extends PopupWindow
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bfse(this);
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  bfsg jdField_a_of_type_Bfsg;
  bfsh jdField_a_of_type_Bfsh = new bfsf(this);
  ...
  public bfsc(@NonNull Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_b_of_type_JavaLangString = ajyc.a(2131705914);
  ...
  private void a(Object paramObject, boolean paramBoolean)
  {
    ...
    noo.a(null, "", "0X8009990", "0X8009990", 0, 0, String.valueOf(this.r), "", this.jdField_c_of_type_JavaLangString, localJSONObject.toString(), false);
  }
  ...
  private void e()
  {
    ...
    {
      if (i1 <= 1) {
        ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842384);
      }
    }
    else {
      return;
    }
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842386);
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(i1 - 1)).setBackgroundResource(2130842385);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<DislikeInfo> paramArrayList, String paramString)
  {
    ...
    for (paramInt1 = paramArrayList.size();; paramInt1 = 0)
    {
      ...
      paramArrayList = new DislikeInfo();
      paramArrayList.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131718468);
      paramArrayList.jdField_c_of_type_Int = 8;
      paramArrayList.jdField_b_of_type_JavaLangString = "";
      this.jdField_e_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_b_of_type_AndroidViewView, 2130841226, ajyc.a(2131705920), true);
      a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_c_of_type_AndroidViewView, 2130841230, ajyc.a(2131705930), true);
      a(this.jdField_c_of_type_JavaUtilArrayList, this.jdField_d_of_type_AndroidViewView, 2130841219, a(this.jdField_c_of_type_JavaUtilArrayList), false);
      a(this.jdField_d_of_type_JavaUtilArrayList, this.jdField_e_of_type_AndroidViewView, 2130841223, ajyc.a(2131705926), false);
      a(this.jdField_e_of_type_JavaUtilArrayList, this.jdField_f_of_type_AndroidViewView, 2130841218, BaseApplicationImpl.getContext().getString(2131718468), false);
      a();
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(1L), ajyc.a(2131705927));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(2L), ajyc.a(2131705925));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(3L), ajyc.a(2131705916));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(4L), ajyc.a(2131705917));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(5L), ajyc.a(2131705922));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(6L), ajyc.a(2131705921));
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298568));
    this.jdField_e_of_type_AndroidViewView.findViewById(2131375887).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    setOnDismissListener(new bfsd(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  
  public void a(View paramView, bfsg parambfsg)
  {
    if (isShowing()) {
      dismiss();
    }
    this.jdField_a_of_type_Bfsg = parambfsg;
    parambfsg = new int[2];
    try
    {
      bool = a(paramView, parambfsg);
      if (bool)
      {
        showAtLocation(paramView, 51, parambfsg[0], parambfsg[1]);
        a(0.8F);
        a(this);
      }
      return;
  ...
  public void a(pbi parampbi, ArrayList<DislikeInfo> paramArrayList)
  {
    int i2 = 0;
    String str = null;
    if (parampbi != null) {}
    for (;;)
    {
      try
      {
        i1 = parampbi.jdField_b_of_type_Int;
        i2 = parampbi.jdField_a_of_type_Int;
        parampbi = parampbi.a();
        int i3 = onk.a(parampbi);
        str = "";
        if (parampbi != null) {
          str = parampbi.innerUniqueID;
        }
        a(i1, i2, i3, paramArrayList, str);
        return;
      }
      catch (Exception parampbi)
      {
        return;
      }
      int i1 = 0;
  ...
  protected void c(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Bfsg == null);
      paramView = paramView.getTag();
    } while (!(paramView instanceof DislikeInfo));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((DislikeInfo)paramView);
    this.jdField_a_of_type_Bfsg.a(null, this.o, localArrayList, null);
  }
