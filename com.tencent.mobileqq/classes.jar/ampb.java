  ...
  extends QIPCModule
{
  ...
  private amrq jdField_a_of_type_Amrq = new amrq();
  ...
  public ampb(String paramString)
  {
    super(paramString);
  }
  
  public static ampb a()
  {
    return ampi.a();
  }
  ...
  public static void b()
  {
    ...
    {
      QIPCServerHelper.getInstance().register(localampb);
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Amrq != null) {
      return this.jdField_a_of_type_Amrq.a();
    }
  ...
  {
    if (this.jdField_a_of_type_Amrq != null) {
      return this.jdField_a_of_type_Amrq.a(paramInt);
    }
    return null;
  }
  ...
  public amrq a()
  {
    return this.jdField_a_of_type_Amrq;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Amrq != null)
    {
      List localList = this.jdField_a_of_type_Amrq.a();
      if (localList != null)
      {
        int i = 0;
        while (i < localList.size())
        {
          amrp localamrp = (amrp)localList.get(i);
          if ((localamrp != null) && (!ampj.a(localamrp.a())) && (!ampj.a(localamrp.a())))
          {
            amoz.a(localamrp.a());
            QLog.i("cmgame_process.CmGameServerQIPCModule", 1, "closeAllGame gameId:" + localamrp.a());
          }
          i += 1;
        }
      }
  ...
  public void a(CmGameStartChecker.StartCheckParam paramStartCheckParam, long paramLong, CmGameInitParams paramCmGameInitParams)
  {
    ...
    this.c = true;
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (ampj.a(BaseApplicationImpl.getContext())))
    {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      QIPCServerHelper.getInstance().callClient(LocalMultiProcConfig.PROCESS_NAME, "cm_game_client_module", "action_dress_changed", (Bundle)localObject, new amph(this));
      return;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      if ("action_aduio_query_voice_status".equals(paramString))
      {
        ...
        paramBundle = (amhd)((QQAppInterface)localObject1).getManager(153);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putBoolean("isOpen", paramBundle.a().a(paramString));
        ((Bundle)localObject1).putBoolean("display", amnw.b);
      ...
      {
        paramString = paramBundle.getString("key_game_friUin");
        ((amhd)((QQAppInterface)localObject1).getManager(153)).a().c(paramString, 318);
      }
    }
    ...
    if ("action_aduio_enter_room".equals(paramString))
    {
      ...
      paramBundle = ((amhd)((QQAppInterface)localObject1).getManager(153)).a();
      if ((bool) || ((amnw.jdField_a_of_type_Boolean) && (!paramBundle.b()))) {
    ...
    {
      paramString = paramBundle.getString("key_game_friUin");
      ((amhd)((QQAppInterface)localObject1).getManager(153)).a().a(paramString, 318);
    }
    ...
    else if ("action_loadyoutu".equals(paramString))
    {
      ...
      if ((paramString != null) && ((paramString instanceof QQAppInterface)))
      {
        ...
        break label2282;
        paramString = new ovh(paramString, BaseApplicationImpl.getContext());
        b = true;
        paramString.a(new ampc(this, paramInt));
        paramString.a();
        break label2280;
      }
    }
    else
    {
      ...
      if ("game_activity_lifecycle".equals(paramString))
      {
        ...
        if ((paramString != null) && ((paramString instanceof CmGameStartChecker.StartCheckParam)))
        {
          ...
          this.jdField_a_of_type_Amrq.a(paramInt, i, j, paramString);
          break label2280;
        }
      }
    ...
    while (paramString != null)
    {
      ...
      if ("action_update_game_push".equals(paramString))
      {
        ...
        paramString = (QQAppInterface)ampj.a();
        if (paramString == null) {
          return null;
        }
        paramBundle = (CmGamePushItem)paramBundle.getSerializable("CmGamePushItem");
        if (paramBundle != null) {
          ((amhd)paramString.getManager(153)).a().a(paramBundle);
        }
      }
      ...
      {
        if ((localObject1 instanceof QQAppInterface)) {
          amzq.a((QQAppInterface)localObject1);
        }
        paramString = new Bundle();
        paramString.putString("sApolloBaseScriptId", ancb.au);
        paramString.putBoolean("sDisableCreateRenderThread", amhd.q);
        paramString.putBoolean("sApolloEngineLockEnable", amhd.r);
      ...
      else
      {
        ...
        if ("action_init_cmshow_data".equals(paramString))
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            Object localObject3 = (amhd)((QQAppInterface)localObject1).getManager(153);
            localObject1 = (VasExtensionHandler)((QQAppInterface)localObject1).a(71);
            localObject2 = ((amhd)localObject3).b(paramString);
            ApolloBaseInfo localApolloBaseInfo = ((amhd)localObject3).b(paramBundle);
            ...
            if (!((List)localObject3).isEmpty())
            {
              ...
              ((VasExtensionHandler)localObject1).a(new ampd(this, (List)localObject3, paramString, paramBundle, paramInt));
              ((VasExtensionHandler)localObject1).a((String[])localObject2);
            }
            else
            {
              i = amhd.a(ApolloUtil.a(), paramString, true);
              j = amhd.a(ApolloUtil.a(), paramBundle, true);
              paramString = new Bundle();
        ...
        else if ("action_render_view_preload_res".equals(paramString))
        {
          ...
          else
          {
            ...
            {
              localObject1 = amuo.a(ApolloUtil.a(), paramString[i]);
              localObject2 = new amxj(3, paramString[i]);
              ((amxj)localObject2).c = ((ApolloActionData)localObject1).actionType;
              paramBundle.add(localObject2);
              i += 1;
            }
            amxb.a(ApolloUtil.a(), "", new ampf(this, paramInt), paramBundle, false);
          }
        }
        else if ("action_cmshow_tracereport".equals(paramString))
        {
          anbf.a(paramBundle.getString("action"), paramBundle.getBundle("bundle"));
        }
        else
        {
          ...
          if ("action_render_view_change_mode".equals(paramString))
          {
            ...
            paramString.a(new ampg(this, paramString, paramInt));
            if (i == 2) {}
