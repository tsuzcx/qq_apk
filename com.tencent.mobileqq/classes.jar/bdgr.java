...
public class bdgr
{
  ...
  public static bdgr a(bdcz parambdcz, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject.jdField_a_of_type_ArrayOfByte = parambdcz.a(i);
    paramJSONObject.c = jdField_a_of_type_Int;
    return paramJSONObject;
  }
  
  public static void a(bdcz parambdcz, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      catch (JSONException parambdcz)
      {
        bdnw.d("[minigame]", "packNativeBuffer err :", parambdcz);
        return;
      }
      if (paramInt3 == jdField_a_of_type_Int) {
        localJSONObject.put("id", parambdcz.a(paramArrayOfByte, paramInt1, paramInt2));
      }
    }
  }
  
  public static void a(bdcz parambdcz, byte[] paramArrayOfByte, int paramInt, String paramString, JSONObject paramJSONObject)
  {
    a(parambdcz, paramArrayOfByte, 0, paramArrayOfByte.length, paramInt, paramString, paramJSONObject);
  }
