...
public class ames
  extends alkl
{
  public ames(HiddenChatFragment paramHiddenChatFragment) {}
  ...
  public void a(int paramInt1, int paramInt2, Map<String, Integer> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt2 != 0)
      {
        ...
        continue;
        if (paramInt1 == 0) {
          bdiv.j(this.a.getActivity(), HiddenChatFragment.a(this.a).getCurrentAccountUin());
        }
        return;
      }
    }
