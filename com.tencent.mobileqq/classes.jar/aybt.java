  ...
  implements bhqp
{
  ...
  public aybt(Context paramContext, List<ShareActionSheetBuilder.ActionSheetItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Aybu == null) {
      this.jdField_a_of_type_Aybu = new aybu(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    if (paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.firstLineCount > 0)
    {
      ...
      localObject1 = this.jdField_a_of_type_Aybu.a((Drawable)localObject1, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label486;
      }
      localObject2 = aybu.a(this.jdField_a_of_type_Aybu, (Drawable)localObject1);
      localObject1 = this.jdField_a_of_type_Aybu.a((Drawable)localObject1, (Drawable)localObject2);
    ...
    for (paramViewGroup = paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.label;; paramViewGroup = "")
    {
      ...
      break label324;
      label486:
      localObject1 = aybu.b(this.jdField_a_of_type_Aybu, (Drawable)localObject1);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
      break label403;
      label509:
