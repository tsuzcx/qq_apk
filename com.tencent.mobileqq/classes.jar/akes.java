  ...
  extends BusinessHandler
{
  ...
  Comparator<RecentBaseData> jdField_a_of_type_JavaUtilComparator = new aket(this);
  ...
  private List<RecentBaseData> a(List<RecentUser> paramList, List<RecentBaseData> paramList1)
  {
    ...
    if (paramList == null)
    {
      ...
      Object localObject3 = algs.a(localRecentUser.uin, localRecentUser.getType());
      localObject2 = algs.a().a((String)localObject3);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = alfm.a(localRecentUser, this.app, BaseApplicationImpl.getContext());
        if (localObject1 != null) {
          algs.a().a((RecentBaseData)localObject1, (String)localObject3);
        }
      }
      if (localObject1 != null)
      {
        ...
        localObject3 = ((bikt)this.app.getBusinessHandler(BusinessHandlerFactory.WEREWOLVES_HANDLER)).a("");
        if ((!((HotChatInfo)localObject2).isGameRoom) && (!((HotChatInfo)localObject2).troopUin.equals(((bilj)localObject3).a))) {
          break label242;
        }
      }
    }
  ...
  private void a(List<RecentUser> paramList)
  {
    ...
    for (Object localObject2 = this.app.getHotChatMng(true);; localObject2 = localObject1)
    {
      ...
      {
        localObject2 = ((antp)this.app.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(str);
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    if (((paramInt1 == 1) || (paramInt1 == 0) || (paramInt1 == 3000)) && (!a(paramInt2)))
    {
      ...
      if (!TextUtils.isEmpty(paramString)) {
        akeu.a().a(paramString, paramInt1);
      }
    }
  }
