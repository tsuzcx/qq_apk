...
public class akes
  extends aojs
{
  public akes(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  {
    if (!bhjx.a(String.valueOf(paramLong1), this.a.jdField_c_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localakfc.a = (localGroupFeeMember.uint64_uin.get() + "");
      localakfc.b = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Akfs != null) {
        this.a.jdField_a_of_type_Akfs.a(localakfc);
      }
  ...
  protected void b(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.isHomeworkTroop()))
    {
      ...
      this.a.g = bguq.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo, paramList, false);
      paramList = this.a;
