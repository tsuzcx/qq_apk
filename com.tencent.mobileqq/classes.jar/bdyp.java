  ...
  extends bdsh
{
  ...
  public java.lang.Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   4: astore_3
    //   5: aload_3
    //   6: invokestatic 120	bgmg:b	(Ljava/lang/String;)Z
    //   9: ifne +21 -> 30
    ...
    //   86: invokevirtual 164	bdyp:a	(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    //   147: iconst_2
    //   148: iaload
    //   149: invokestatic 189	bdyp:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   152: astore_1
    //   153: aload_1
    //   154: astore_2
    //   155: aload_3
