  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<Long, List<aqon>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentHashMap<Long, Long> b;
  private ConcurrentHashMap<String, List<aqon>> c;
  private ConcurrentHashMap<String, Integer> d;
  
  public aqpc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    a();
  }
  
  public static aqpc a(QQAppInterface paramQQAppInterface)
  {
    return (aqpc)paramQQAppInterface.getManager(380);
  }
  ...
  public aqoy a()
  {
    return (aqoy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(186);
  }
  ...
  public List<aqon> a(Long paramLong)
  {
    ...
    if (((List)localObject).size() > i)
    {
      ...
      localObject = new aqon();
      ((aqon)localObject).b = BaseApplicationImpl.getContext().getResources().getString(2131690566);
      ((aqon)localObject).c = "https://qzonestyle.gtimg.cn/aoi/sola/20191009150544_g1DgkNhLui.png";
  ...
  public List<aqon> a(String paramString)
  {
  ...
  public void a(Long paramLong, List<aqon> paramList)
  {
  ...
  public void a(String paramString, List<aqon> paramList)
  {
