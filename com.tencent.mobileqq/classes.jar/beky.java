  ...
  extends FilterOutputStream
{
  ...
  private static beky jdField_b_of_type_Beky;
  ...
  private beky(OutputStream paramOutputStream)
  {
    this(paramOutputStream, 8192);
  }
  
  private beky(OutputStream paramOutputStream, int paramInt)
  {
  ...
  public static beky a(OutputStream paramOutputStream)
  {
    beky localbeky = null;
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_b_of_type_Beky != null)
      {
        localbeky = jdField_b_of_type_Beky;
        jdField_b_of_type_Beky = localbeky.jdField_a_of_type_Beky;
        localbeky.jdField_a_of_type_Beky = null;
        c -= 1;
      }
      if (localbeky != null)
      {
        localbeky.out = paramOutputStream;
        localbeky.jdField_a_of_type_Boolean = true;
        return localbeky;
      }
    }
    return new beky(paramOutputStream);
  }
  ...
  private void a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (c < 4)
      {
        this.jdField_a_of_type_Beky = jdField_b_of_type_Beky;
        jdField_b_of_type_Beky = this;
        c += 1;
      }
      return;
    }
