      ...
      if ((bool4) || (bool2) || (bool1) || (bool3))
      {
        ...
        if (!bool5)
        {
          if ((bool4) || (((Submsgtype0x94.MsgBody)localObject1).uint32_only_discover_reddot_flag.get() == 1))
          {
            ...
            ((ofx)paramQQAppInterface.getManager(88)).a(NetConnInfoCenter.getServerTime(), bool5);
            label1211:
            ((ogb)paramQQAppInterface.getBusinessHandler(68)).a();
          ...
          for (;;)
          {
            bcef.b(paramQQAppInterface, "dc00898", "", "", "Shop_folder", paramMsgType0x210, 0, 0, "", "", "", "");
            return;
            bool4 = false;
            break;
            label1266:
