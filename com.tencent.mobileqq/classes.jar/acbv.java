...
public class acbv
  extends alox
{
  public acbv(AuthDevActivity paramAuthDevActivity) {}
  ...
  protected void onDelAuthDevResult(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    while (paramBoolean)
    {
      ...
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131692194), 0).b(this.a.getTitleBarHeight());
      return;
    }
    if (TextUtils.isEmpty(paramString))
    {
      QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131692193), 0).b(this.a.getTitleBarHeight());
      return;
    }
  ...
  protected void onDelHistoryDevResult(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      azmj.b(this.a.app, "CliOper", "", "", "My_eq", "Delete_eq", 0, 0, "", "", "", "");
    ...
    if (TextUtils.isEmpty(paramString))
    {
      QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131694643), 0).b(this.a.getTitleBarHeight());
      return;
    }
    QQToast.a(this.a.getApplicationContext(), 1, paramString, 0).b(this.a.getTitleBarHeight());
  }
  ...
  protected void onGetAuthDevResult(boolean paramBoolean, SvcRspGetDevLoginInfo paramSvcRspGetDevLoginInfo)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.a, 1, this.a.getString(2131692210), 0).b(this.a.getTitleBarHeight());
      return;
