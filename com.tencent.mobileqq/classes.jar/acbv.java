...
public class acbv
  extends ajxj
{
  public acbv(ShieldFriendsListActivity paramShieldFriendsListActivity) {}
  ...
  protected void onUpdateFriendShieldFlag(long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString)
  {
    ...
    if (!paramBoolean2)
    {
      ...
      if (!paramBoolean1)
      {
        ...
        if (ShieldFriendsListActivity.a(paramString, paramLong, paramBoolean1)) {
          bcql.a(BaseApplication.getContext(), ajya.a(2131714004), 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131298865));
        }
      }
    }
    do
    {
      ...
      paramString = ((ajxl)this.a.app.getManager(51)).e(String.valueOf(paramLong));
