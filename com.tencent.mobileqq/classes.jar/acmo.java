...
public class acmo
  implements Runnable
{
  public acmo(FileVideoManager.VideoControl paramVideoControl, FileManagerEntity paramFileManagerEntity, FileVideoManager.FileVideoManagerCallback paramFileVideoManagerCallback) {}
  ...
  public void run()
  {
    ...
    {
      FileVideoManager.VideoControl.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreFileVideoManager$VideoControl, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, new acmp(this));
      return;
    }
    FileVideoManager.VideoControl.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreFileVideoManager$VideoControl, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, new acmq(this));
  }
}
