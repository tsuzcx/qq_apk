  ...
  implements bfyc
{
  ...
  private bgat jdField_a_of_type_Bgat = new ufb(this);
  ...
  public ufa(Activity paramActivity, String paramString, bgve parambgve)
  {
    this.jdField_a_of_type_Bgve = parambgve;
  ...
  private void j()
  {
    SpannableString localSpannableString = new SpannableString(this.jdField_a_of_type_AndroidAppActivity.getString(2131697964));
    bfur.a(this.jdField_a_of_type_AndroidAppActivity, amtj.a(2131707911), localSpannableString, 0, 2131719087, null, null, new ufc(this)).show();
  }
  ...
  public int a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bgve.a() != null) {
        this.jdField_a_of_type_Bgve.a().callJs(ufd.c, new String[] { localJSONObject.toString() });
      }
      bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, 0, "1", "", "", "");
      i();
      return 0;
    }
  ...
  {
    bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bgve.a() != null) {
        this.jdField_a_of_type_Bgve.a().callJs(ufd.c, new String[] { paramString.toString() });
      }
      bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      try
      {
        if (jdField_a_of_type_Double == this.jdField_b_of_type_Int)
        {
          ...
          paramString.put("msg", amtj.a(2131707891));
          paramString.put("localId", d());
          if (this.jdField_a_of_type_Bgve.a() != null) {
            this.jdField_a_of_type_Bgve.a().callJs(ufd.g, new String[] { paramString.toString() });
          }
          bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2B", "0X8005D2B", 0, 0, "1", "", "", "");
          return;
        }
        if (this.jdField_a_of_type_JavaIoFile.exists())
        {
          paramString.put("retCode", 0);
          paramString.put("msg", amtj.a(2131707857) + d());
          paramString.put("localId", d());
          bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, 0, "1", "", "", "");
          if (this.jdField_a_of_type_Bgve.a() == null) {
            break;
          }
          this.jdField_a_of_type_Bgve.a().callJs(ufd.d, new String[] { paramString.toString() });
          return;
        }
      }
      ...
      paramString.put("retCode", -1);
      paramString.put("msg", amtj.a(2131707917));
      paramString.put("localId", d());
      bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, -1, "1", "", "", "");
    }
  }
  ...
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bgve.a() != null) {
        this.jdField_a_of_type_Bgve.a().callJs(ufd.c, new String[] { paramString1.toString() });
      }
      bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
  ...
  public void b()
  {
    ...
    bftt.a(this.jdField_a_of_type_AndroidAppActivity, true);
  ...
  public void b(String paramString)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bgas == null) || (this.jdField_a_of_type_AndroidOsHandler == null) || ((this.jdField_a_of_type_Bgas != null) && (this.jdField_a_of_type_Bgas.a() != 3)))
      {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
        this.jdField_a_of_type_Bgas = new bgas(paramString, this.jdField_a_of_type_AndroidOsHandler);
      }
      this.jdField_a_of_type_Bgas.a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_Bgas.b();
      this.jdField_a_of_type_Bgas.a(this.jdField_a_of_type_Bgat);
      if (this.jdField_a_of_type_Bgas.a() == 1)
      {
        this.jdField_a_of_type_Bgas.b();
        return;
      }
    } while (this.jdField_a_of_type_Bgas.a() != 3);
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Bgas != null) && (this.jdField_a_of_type_Bgas.a() == 2);
  }
  ...
  public void c()
  {
    ...
    d();
    bftt.a(this.jdField_a_of_type_AndroidAppActivity, false);
  }
  ...
  public void e()
  {
    ...
    {
      localJSONObject.put("retCode", 0);
      localJSONObject.put("msg", amtj.a(2131707860) + d() + amtj.a(2131707928));
      localJSONObject.put("localId", d());
      if (this.jdField_a_of_type_Bgve.a() != null) {
        this.jdField_a_of_type_Bgve.a().callJs(ufd.f, new String[] { localJSONObject.toString() });
      }
      return;
    }
    catch (JSONException localJSONException)
