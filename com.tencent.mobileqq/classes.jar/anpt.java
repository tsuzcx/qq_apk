...
public class anpt
{
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new DataInputStream(new ByteArrayInputStream(bgku.decode((String)localObject, 0)));
  ...
  public void c()
  {
    try
    {
      ...
      BaseApplicationImpl.getApplication().getSharedPreferences("MemoryManagerMemoryStat", 0).edit().putString("LowMemoryStat", bgku.encodeToString((byte[])localObject, 0)).commit();
      return;
    }
    catch (Exception localException) {}
  }
