...
public class nip
  implements njv
{
  public nip(PublicAccountAdvertisementActivity paramPublicAccountAdvertisementActivity) {}
  ...
  public void a(VerticalPagerView paramVerticalPagerView, View paramView, int paramInt)
  {
    ...
    axqw.a(null, "dc00898", "", PublicAccountAdvertisementActivity.a(this.a).a.a, "0X8008F68", "0X8008F68", 0, 0, PublicAccountAdvertisementActivity.a(this.a).a.c, PublicAccountAdvertisementActivity.a(this.a) + "", "" + PublicAccountAdvertisementActivity.a(this.a).a.d, PublicAccountAdvertisementActivity.a(this.a).a.b);
    paramVerticalPagerView = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramVerticalPagerView instanceof ToolAppRuntime)) {
      ardb.a().a(PublicAccountAdvertisementActivity.a(this.a), this.a, (AppInterface)((ToolAppRuntime)paramVerticalPagerView).onGetSubRuntime("imax"));
    }
