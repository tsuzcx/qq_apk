  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      {
        return;
        paramMessage = (fw)paramMessage.obj;
      ...
      if (ETTextView.access$300() == null)
      {
        ...
        ??? = paramMessage.jdField_a_of_type_Fn.a(localETEngine, false);
        if (??? != null) {
          ((ETDecoration)???).gotoFrame(paramMessage.jdField_a_of_type_Int);
        }
        paramMessage.jdField_a_of_type_Fn.a(localETEngine, ETTextView.access$300(), (ETDecoration)???, true);
        if (??? != null) {
