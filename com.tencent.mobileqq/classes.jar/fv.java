  ...
  implements Handler.Callback, Manager
{
  ...
  public static ConcurrentHashMap<Integer, fu> a;
  ...
  private CopyOnWriteArrayList<fy> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  public AtomicBoolean a;
  public boolean a;
  public ETEngine b;
  private Map<Integer, String> jdField_b_of_type_JavaUtilMap = new ConcurrentHashMap();
  ConcurrentHashMap<String, fu> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public AtomicBoolean b;
  public volatile boolean b;
  public int c;
  public String c;
  private Map<Integer, Long> jdField_c_of_type_JavaUtilMap = new ConcurrentHashMap();
  private ConcurrentHashMap<String, ConcurrentHashMap<Integer, fu>> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + ".font_info";
    ...
    jdField_f_of_type_JavaLangString = ajed.aU + ".font_effect";
    jdField_g_of_type_JavaLangString = jdField_f_of_type_JavaLangString + File.separator + "magicFontConfig.json";
  }
  
  public fv(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Bats = null;
    ...
    this.jdField_h_of_type_JavaLangString = ajjy.a(2131638894);
    this.jdField_i_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    a(baig.a(paramQQAppInterface.getApp(), paramQQAppInterface.c(), "vas_font_switch_config"));
    ...
    if (!this.jdField_d_of_type_Boolean) {
      paramQQAppInterface.append(babp.i()).append("; CPU number: ").append(babp.b()).append("; CPU frequency: ").append(babp.a()).append("; RAM: ").append(babp.d());
    }
  ...
  private fu a()
  {
    ??? = (fu)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(this.jdField_c_of_type_JavaLangString);
    Object localObject3;
    if (??? != null)
    {
      localObject3 = ???;
      if (((fu)???).jdField_b_of_type_Int == 4)
      {
        g.a().a(((fu)???).jdField_a_of_type_Int, ((fu)???).jdField_a_of_type_JavaLangString);
        localObject3 = ???;
      }
      return localObject3;
    }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        ??? = new fu(this.jdField_c_of_type_JavaLangString.hashCode(), j + this.jdField_c_of_type_JavaLangString);
        localObject3 = new ETFont(((fu)???).jdField_a_of_type_Int, j + this.jdField_c_of_type_JavaLangString, 1.0F);
        ((fu)???).jdField_c_of_type_Int = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getVariantStyleComboCount((ETFont)localObject3);
        if (QLog.isColorLevel()) {
          QLog.d("VasFont", 2, "getTestFont: fontId=" + ((fu)???).jdField_a_of_type_Int + " styleCount=" + ((fu)???).jdField_c_of_type_Int);
        }
        ((fu)???).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
        localObject3 = ???;
        if (??? == null) {
          break;
        }
      ...
      {
        ??? = new fu(this.jdField_c_of_type_JavaLangString.hashCode(), k + this.jdField_c_of_type_JavaLangString);
        ((fu)???).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
        ((fu)???).jdField_a_of_type_AndroidGraphicsTypeface = Typeface.createFromFile(k + this.jdField_c_of_type_JavaLangString);
        continue;
      }
      if (this.jdField_a_of_type_Int == 4)
      {
        ...
        {
          ??? = new fu(49152 + (this.jdField_c_of_type_JavaLangString.hashCode() & 0x3FFF), l + this.jdField_c_of_type_JavaLangString);
          ((fu)???).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
          g.a().a(((fu)???).jdField_a_of_type_Int, ((fu)???).jdField_a_of_type_JavaLangString);
          ((fu)???).jdField_c_of_type_Int = f.f(((fu)???).jdField_a_of_type_Int);
          continue;
        }
        return null;
      }
      ...
      ??? = new fu(1000, m + this.jdField_c_of_type_JavaLangString);
      ((fu)???).jdField_b_of_type_Int = 1;
      ??? = new File(m + "config.json");
      if (((File)???).exists()) {
        ((fu)???).jdField_b_of_type_JavaLangString = fe.a((File)???);
      }
      ((fu)???).jdField_a_of_type_ComEtrumpMixlayoutETFont = new ETFont(((fu)???).jdField_a_of_type_Int, ((fu)???).jdField_a_of_type_JavaLangString, 16.0F, ((fu)???).jdField_b_of_type_Int, ((fu)???).jdField_a_of_type_AndroidGraphicsTypeface);
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(j + this.jdField_c_of_type_JavaLangString, ((fu)???).jdField_a_of_type_Int, true);
        this.jdField_b_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(j + this.jdField_c_of_type_JavaLangString, ((fu)???).jdField_a_of_type_Int, true);
        ((fu)???).jdField_a_of_type_ComEtrumpMixlayoutETFont.parseDIYJsonString(((fu)???).jdField_b_of_type_JavaLangString);
      }
    }
  }
  ...
  public static String a(MessageRecord paramMessageRecord)
  {
    ...
    case 1: 
      ...
      } while (mnf.a(paramMessageRecord));
      if (paramMessageRecord.isSend()) {
        return paramMessageRecord.selfuin;
      }
  ...
  public static void a(BaseChatPie paramBaseChatPie)
  {
    if (paramBaseChatPie.a != null)
    {
      ...
      if (n <= i2)
      {
        ...
        if (localObject != null)
        {
          if (!(aciy.a((View)localObject) instanceof adrh)) {
            break label113;
          }
          localObject = (adrh)aciy.a((View)localObject);
          if ((((adrh)localObject).d instanceof ETTextView)) {
            ((ETTextView)((adrh)localObject).d).a(false, true);
          }
        }
        for (;;)
        {
          ...
          break;
          label113:
          if ((aciy.a((View)localObject) instanceof adnv))
          {
            localObject = (adnv)aciy.a((View)localObject);
            if ((((adnv)localObject).a != null) && (((adnv)localObject).a.a != null)) {
              ((adnv)localObject).a.a.a(false, true);
            }
          }
          else if ((aciy.a((View)localObject) instanceof adic))
          {
            ((adic)aciy.a((View)localObject)).a.c();
          }
        }
      }
    }
  ...
  private void a(String paramString, fu paramfu, int paramInt)
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new FontManager.9(this, paramString, paramfu, paramInt));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, ExtensionInfo paramExtensionInfo, int paramInt1, int paramInt2)
  {
    ...
    if ((localExtensionInfo.diyFontTimestampMap.get(Integer.valueOf(paramInt1)) == null) || (((Integer)localExtensionInfo.diyFontTimestampMap.get(Integer.valueOf(paramInt1))).intValue() < paramInt2))
    {
      ...
      paramQQAppInterface = (ajrm)paramQQAppInterface.a(13);
  ...
  private boolean a(String paramString)
  {
    ...
    {
      if (((babp.b() < 2) || (babp.a() <= 1000L)) && ((babp.b() < 4) || (babp.d() <= 838860800L))) {
        break label92;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      bapf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "individual_v2_font_dpc_fail", "font_dpc_fail", this.jdField_d_of_type_JavaLangString, paramString, 0.0F);
      if (this.jdField_f_of_type_Int != 1) {
        break;
      }
      return true;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VasFont", 2, "getChatFontAbilityFromLocal return false. CPU number = " + babp.b() + " CPU Frequency = " + babp.a() + " Memory = " + babp.d());
      }
    }
    return false;
  }
  
  private boolean a(String paramString, fu paramfu, int paramInt)
  {
    if (paramfu.jdField_a_of_type_ComEtrumpMixlayoutETFont == null) {
      paramfu.jdField_a_of_type_ComEtrumpMixlayoutETFont = new ETFont(paramfu.jdField_a_of_type_Int, paramfu.jdField_a_of_type_JavaLangString, 16.0F, paramfu.jdField_b_of_type_Int, paramfu.jdField_a_of_type_AndroidGraphicsTypeface);
    }
    ...
    for (;;)
    {
      if (ETEngine.getInstance().native_diyFontIsDIYFont(paramfu.jdField_a_of_type_ComEtrumpMixlayoutETFont))
      {
        paramfu.jdField_a_of_type_Boolean = true;
        Object localObject2 = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(paramString);
        ...
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, (ExtensionInfo)localObject1, paramfu.jdField_a_of_type_Int, paramInt))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VasFont", 2, "isDIYFont fontId = " + paramfu.jdField_a_of_type_Int + " uin = " + paramString + " needUpdateDiyConfig");
          }
          if (!localConcurrentHashMap.containsKey(Integer.valueOf(paramfu.jdField_a_of_type_Int)))
          {
            localObject1 = new fu(0, "");
            localConcurrentHashMap.put(Integer.valueOf(paramfu.jdField_a_of_type_Int), localObject1);
        ...
        if (localConcurrentHashMap.containsKey(Integer.valueOf(paramfu.jdField_a_of_type_Int)))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("VasFont", 2, "isDIYFont fontid = " + paramfu.jdField_a_of_type_Int + " is diy font handle = " + paramfu.jdField_a_of_type_ComEtrumpMixlayoutETFont.m_diyHandle);
            }
            paramfu.jdField_a_of_type_Boolean = true;
            return true;
          }
        ...
        {
          if ((((ExtensionInfo)localObject1).diyFontConfigMap != null) && (((ExtensionInfo)localObject1).diyFontConfigMap.containsKey(Integer.valueOf(paramfu.jdField_a_of_type_Int))))
          {
            localObject1 = (String)((ExtensionInfo)localObject1).diyFontConfigMap.get(Integer.valueOf(paramfu.jdField_a_of_type_Int));
            if (QLog.isColorLevel()) {
              QLog.d("VasFont", 2, "isDIYFont fontId = " + paramfu.jdField_a_of_type_Int + " uin = " + paramString + " config = " + (String)localObject1);
            }
            paramfu.jdField_a_of_type_ComEtrumpMixlayoutETFont.parseDIYJsonString((String)localObject1);
            localObject1 = new fu(paramfu.jdField_a_of_type_Int, paramfu.jdField_a_of_type_JavaLangString);
            ((fu)localObject1).jdField_b_of_type_Int = paramfu.jdField_b_of_type_Int;
            ((fu)localObject1).jdField_a_of_type_Boolean = true;
            localObject2 = new ETFont(paramfu.jdField_a_of_type_Int, paramfu.jdField_a_of_type_JavaLangString, 16.0F, paramfu.jdField_b_of_type_Int, null);
            ((ETFont)localObject2).copy(paramfu.jdField_a_of_type_ComEtrumpMixlayoutETFont);
            ((fu)localObject1).jdField_a_of_type_ComEtrumpMixlayoutETFont = ((ETFont)localObject2);
            localConcurrentHashMap.put(Integer.valueOf(paramfu.jdField_a_of_type_Int), localObject1);
            this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localConcurrentHashMap);
            return true;
          }
          ...
          ((fu)localObject1).jdField_b_of_type_Int = paramfu.jdField_b_of_type_Int;
          ((fu)localObject1).jdField_a_of_type_Boolean = true;
          ((fu)localObject1).jdField_a_of_type_ComEtrumpMixlayoutETFont = new ETFont(paramfu.jdField_a_of_type_Int, paramfu.jdField_a_of_type_JavaLangString, 16.0F, paramfu.jdField_b_of_type_Int, null);
          localConcurrentHashMap.put(Integer.valueOf(paramfu.jdField_a_of_type_Int), localObject1);
          this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localConcurrentHashMap);
          return true;
        }
  ...
  public static int c(long paramLong)
  {
    ...
    if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      localfu = (fu)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf((int)paramLong));
    }
    if (localfu != null) {}
    for (int n = localfu.jdField_c_of_type_Int;; n = 0)
    {
      if (n > 0) {}
  ...
  {
    fu localfu = (fu)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
    Object localObject = localfu;
    if (localfu == null)
    {
      localObject = new File(a(paramInt1, paramInt2));
      boolean bool = ((File)localObject).exists();
      if (bool) {
        localfu = new fu(paramInt1, ((File)localObject).getAbsolutePath());
      }
      localObject = localfu;
      if (QLog.isColorLevel())
      {
  ...
  public fu a(int paramInt1, int paramInt2, boolean paramBoolean, String paramString, int paramInt3)
  {
    ...
    do
    {
      ...
      if (g.a().jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
      {
        g.a().a().a();
        g.a().jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
        localfu = (fu)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
        if (localfu == null)
        {
      ...
      if (localfu.jdField_b_of_type_Int == 4)
      {
        long l1 = System.currentTimeMillis();
        paramInt2 = g.a().a(paramInt1, localfu.jdField_a_of_type_JavaLangString);
        localfu.jdField_c_of_type_Int = f.f(paramInt1);
        long l2 = System.currentTimeMillis();
        if (paramInt2 != 0) {
          gc.a("action_load", paramInt1, 4, 0, l2 - l1);
        }
      }
      if (localfu.jdField_a_of_type_ComEtrumpMixlayoutETFont == null) {
        localfu.jdField_a_of_type_ComEtrumpMixlayoutETFont = new ETFont(paramInt1, localfu.jdField_a_of_type_JavaLangString, 16.0F, localfu.jdField_b_of_type_Int, localfu.jdField_a_of_type_AndroidGraphicsTypeface);
      }
      localObject = localfu;
    } while (!localfu.jdField_a_of_type_Boolean);
    ...
    {
      localObject = (fu)((ConcurrentHashMap)localObject).get(Integer.valueOf(paramInt1));
      this.jdField_a_of_type_AndroidOsHandler.post(new FontManager.4(this, paramString, paramInt1, paramInt3));
      return localObject;
    }
    a(paramString, localfu, paramInt3);
    return null;
  }
  
  fu a(ChatMessage paramChatMessage)
  {
    boolean bool = false;
    ...
    for (int i2 = Integer.parseInt(str);; i2 = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i1 == 0)
        {
          ...
          localObject = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a((String)localObject, false);
          if (localObject != null)
          {
  ...
  public JSONObject a(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      if (a(paramInt1, paramInt2) != null)
      {
        ...
        localJSONObject1.put("message", ajjy.a(2131638895));
      }
      for (;;)
      {
        ...
        localJSONObject2.put("status", 3);
        localJSONObject1.put("result", 0);
        localJSONObject1.put("message", ajjy.a(2131638896));
        break label392;
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (f1 == 2.0F)
        {
          ...
          localJSONObject1.put("message", ajjy.a(2131638893));
        }
        else
        {
          localException.put("status", 2);
          localJSONObject1.put("result", 0);
          localJSONObject1.put("message", ajjy.a(2131638891));
          break label392;
          label344:
          localException.put("status", 1);
          localException.put("progress", 0);
          localJSONObject1.put("result", 0);
          localJSONObject1.put("message", ajjy.a(2131638892));
          continue;
        }
        label392:
        if (f1 == 3.0F) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      gf.a().a(paramInt1, -102);
    } while ((TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) || (this.jdField_a_of_type_Bats == null));
    Bundle localBundle = new Bundle();
    localBundle.putString("callbackId", this.jdField_e_of_type_JavaLangString);
    localBundle.putInt("srcType", 9);
    this.jdField_a_of_type_Bats.a(0L, -1, localBundle);
  ...
  public void a(int paramInt1, int paramInt2, String arg3)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        {
          if (l1 > 0L) {
            gc.a("action_download", paramInt1, 4, 0, System.currentTimeMillis() - l1);
          }
          ...
          if (TextUtils.isDigitsOnly(???))
          {
            ...
            gf.a().callbackResult(i1, (EIPCResult)localObject1);
          }
          if (this.jdField_a_of_type_Bats != null)
          {
      ...
      if (paramInt2 == 0)
      {
        bajo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        f();
        return;
        label406:
        l1 = 0L;
  ...
  public void a(TextView paramTextView)
  {
    ...
    float f1 = localfv.jdField_g_of_type_Float;
    if (ajia.a() == 18.0F) {
      f1 = localfv.jdField_h_of_type_Float;
    }
    for (;;)
    {
  ...
  public void a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForText))
    {
      ...
      {
        localObject = (fv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(42);
        if (!(paramChatMessage instanceof axkd)) {
          break;
        }
        paramChatMessage = (axkk[])((axkd)paramChatMessage).getSpans(0, paramChatMessage.length(), axkk.class);
        int i1 = paramChatMessage.length;
        int n = 0;
        while (n < i1)
        {
          paramChatMessage[n].a(awmc.a(Math.round(((fv)localObject).jdField_i_of_type_Float * 32.0F)));
          n += 1;
        }
      }
    }
  ...
  {
    if ((paramfy == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramfy))) {
      return;
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramfy);
  }
  ...
  public void a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramFile = new JSONObject(bace.a(paramFile));
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    ExtensionInfo localExtensionInfo2 = localajjj.a(paramString);
    int n = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if ((bool1) && (bool3))
          {
            ...
            if (paramBoolean)
            {
              ...
              String str1 = "1";
              localObject = ((ajjj)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
              if ((localObject == null) || (0L == ((ExtensionInfo)localObject).uVipFont) || (((ExtensionInfo)localObject).vipFontType != 1)) {
                break label604;
              }
              localObject = "0";
              awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Font_Mall", "0X80072CB", 0, 0, str1, (String)localObject, "", "");
              if (QLog.isColorLevel()) {
            ...
            awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Font_Mall", "0X80072C9", 0, 0, "", "", "", "");
            if (!QLog.isColorLevel()) {
              break label596;
            }
        ...
        catch (Exception localException)
        {
          ...
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Font_Mall", "load_font_fail", 0, 1, "-1", "", "", "");
          return;
        }
        int i1 = 0;
      }
  ...
  public boolean a(acju paramacju, ChatMessage paramChatMessage)
  {
    if ((paramacju instanceof adrh))
    {
      paramacju = (adrh)paramacju;
      if ((paramacju.d instanceof ETTextView))
      {
        if (((ETTextView)paramacju.d).jdField_a_of_type_ComEtrumpMixlayoutETFont == null)
        {
          if (QLog.isColorLevel()) {
        ...
        fu localfu = b(paramChatMessage);
        if ((localfu != null) && ((paramacju.d instanceof ETTextView)))
        {
          ETTextView localETTextView = (ETTextView)paramacju.d;
          if (localETTextView.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId != localfu.jdField_a_of_type_Int)
          {
            if (QLog.isColorLevel()) {
          ...
          if ((localfu.jdField_a_of_type_ComEtrumpMixlayoutETFont != null) && (localfu.jdField_a_of_type_ComEtrumpMixlayoutETFont.m_diyHandle != localETTextView.jdField_a_of_type_ComEtrumpMixlayoutETFont.m_diyHandle))
          {
            if (QLog.isColorLevel()) {
        ...
        if (a(paramChatMessage) != ((ETTextView)paramacju.d).jdField_a_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        paramacju = (ETTextView)paramacju.d;
        if ((paramacju.a() != null) && (paramacju.jdField_a_of_type_Boolean != paramacju.a().jdField_b_of_type_Boolean))
        {
          if (QLog.isColorLevel()) {
  ...
  public boolean a(fu paramfu, String paramString, int paramInt)
  {
    boolean bool2 = true;
    for (;;)
    {
      try
      {
        ...
        try
        {
          ??? = new File(paramfu.jdField_a_of_type_JavaLangString);
          if (!((File)???).exists())
          {
            a(paramfu.jdField_a_of_type_Int, null, 1);
            if (QLog.isColorLevel()) {
              QLog.d("VasFont", 2, "load font fail file not exist font id=" + paramfu.jdField_a_of_type_Int);
            }
            bool1 = false;
            return bool1;
          }
          if (bace.a((File)???) == null)
          {
            b(paramfu.jdField_a_of_type_Int, 1);
            VasWebviewUtil.reportVasStatus("Font", "FontMd5Check", "0", 0, 0, paramfu.jdField_a_of_type_Int, 1, "", "");
            bool1 = false;
            continue;
          }
          QLog.d("VasFont", 1, "ET load font start id = " + paramfu.jdField_a_of_type_Int + " time = " + System.currentTimeMillis());
        }
        catch (Throwable paramfu)
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.e("VasFont", 2, "load font fail", paramfu);
          continue;
        }
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          bool1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(paramfu.jdField_a_of_type_JavaLangString, paramfu.jdField_a_of_type_Int, bool3);
          bool3 = this.jdField_b_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(paramfu.jdField_a_of_type_JavaLangString, paramfu.jdField_a_of_type_Int, bool3);
          QLog.d("VasFont", 1, "ET load font end id = " + paramfu.jdField_a_of_type_Int + " time = " + System.currentTimeMillis());
          if ((!bool1) || (!bool3))
          {
            if (QLog.isColorLevel()) {
              QLog.d("VasFont", 2, "load font fail font id=" + paramfu.jdField_a_of_type_Int + " ret=" + bool1 + " ret2=" + bool3);
            }
            bool1 = false;
          }
        }
      ...
      label397:
      boolean bool1 = bool2;
      if (a(paramString, paramfu, paramInt))
      {
        bajo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        bool1 = bool2;
      }
  ...
  public fu b(ChatMessage paramChatMessage)
  {
    this.jdField_a_of_type_Boolean = c();
    if (!this.jdField_a_of_type_Boolean)
    {
    ...
    ajjj localajjj = (ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    ExtensionInfo localExtensionInfo = localajjj.a(str1, false);
    ...
    for (;;)
    {
      ...
      if (a(l2) != localExtensionInfo.magicFont)
      {
        ...
        new QueryTask(new fw(this, localajjj, str1), new fx(this, paramChatMessage)).a(null);
        if (QLog.isColorLevel()) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = new File(((fu)localObject).jdField_a_of_type_JavaLangString);
  ...
  public void b(fy paramfy)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramfy);
  }
  ...
  public boolean b(ChatMessage paramChatMessage)
  {
    ...
    if (paramChatMessage.isSend())
    {
      ...
      if (localajjj != null)
      {
        ExtensionInfo localExtensionInfo = localajjj.a(str, false);
        if (localExtensionInfo == null) {
          break label517;
        }
        if (QLog.isColorLevel()) {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      break;
      ThreadManager.post(new FontManager.8(this, localajjj, str), 5, null, true);
      break label438;
    }
  }
  ...
  public void d()
  {
    if ((ETEngine.getInstance().isEngineInited.compareAndSet(false, true)) && (gd.c())) {
  ...
  public void onDestroy()
  {
    // Byte code:
    //   0: lconst_0
    //   1: putstatic 1593	fv:jdField_a_of_type_Long	J
    //   4: lconst_0
    //   5: putstatic 1595	fv:jdField_b_of_type_Long	J
    //   8: getstatic 221	fv:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   11: invokevirtual 1596	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   14: aload_0
    //   15: getfield 317	fv:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   18: ifnull +11 -> 29
    //   21: aload_0
    //   22: getfield 317	fv:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   25: aconst_null
    //   26: invokevirtual 1599	android/os/Handler:removeCallbacksAndMessages	(Ljava/lang/Object;)V
    //   29: aload_0
    //   30: getfield 301	fv:jdField_a_of_type_AndroidOsHandlerThread	Landroid/os/HandlerThread;
    //   33: ifnull +45 -> 78
    //   36: getstatic 1600	com/etrump/mixlayout/ETTextView:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   39: ifnull +14 -> 53
    //   42: getstatic 1600	com/etrump/mixlayout/ETTextView:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   45: aconst_null
    //   46: invokevirtual 1599	android/os/Handler:removeCallbacksAndMessages	(Ljava/lang/Object;)V
    //   49: aconst_null
    //   50: putstatic 1600	com/etrump/mixlayout/ETTextView:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   53: getstatic 1601	com/tencent/mobileqq/hiboom/HiBoomTextView:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   56: ifnull +14 -> 70
    //   59: getstatic 1601	com/tencent/mobileqq/hiboom/HiBoomTextView:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   62: aconst_null
    //   63: invokevirtual 1599	android/os/Handler:removeCallbacksAndMessages	(Ljava/lang/Object;)V
    //   66: aconst_null
    //   67: putstatic 1601	com/tencent/mobileqq/hiboom/HiBoomTextView:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   70: aload_0
    //   71: getfield 301	fv:jdField_a_of_type_AndroidOsHandlerThread	Landroid/os/HandlerThread;
    //   74: invokevirtual 1604	android/os/HandlerThread:quit	()Z
    //   77: pop
    //   78: aload_0
    //   79: getfield 370	fv:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   82: ifnull +53 -> 135
    //   85: aload_0
    //   86: getfield 180	fv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   89: astore_1
    //   90: aload_1
    //   91: monitorenter
    //   92: aload_0
    //   93: getfield 370	fv:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   96: invokestatic 1377	com/etrump/mixlayout/ETDecoration:clearMap	(Lcom/etrump/mixlayout/ETEngine;)V
    //   99: aload_0
    //   100: getfield 370	fv:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   103: invokevirtual 1607	com/etrump/mixlayout/ETEngine:native_doneEngine	()V
    //   106: aload_1
    //   107: monitorexit
    //   108: aload_0
    //   109: getfield 370	fv:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   112: getfield 361	com/etrump/mixlayout/ETEngine:isEngineInited	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   115: iconst_0
    //   116: invokevirtual 434	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   119: aload_0
    //   120: getfield 370	fv:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   123: getfield 368	com/etrump/mixlayout/ETEngine:isEngineReady	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   126: iconst_0
    //   127: invokevirtual 434	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   130: aload_0
    //   131: aconst_null
    //   132: putfield 370	fv:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   135: aload_0
    //   136: getfield 381	fv:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   139: ifnull +53 -> 192
    //   142: aload_0
    //   143: getfield 180	fv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   146: astore_1
    //   147: aload_1
    //   148: monitorenter
    //   149: aload_0
    //   150: getfield 381	fv:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   153: invokestatic 1377	com/etrump/mixlayout/ETDecoration:clearMap	(Lcom/etrump/mixlayout/ETEngine;)V
    //   156: aload_0
    //   157: getfield 381	fv:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   160: invokevirtual 1607	com/etrump/mixlayout/ETEngine:native_doneEngine	()V
    //   163: aload_1
    //   164: monitorexit
    //   165: aload_0
    //   166: getfield 381	fv:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   169: getfield 361	com/etrump/mixlayout/ETEngine:isEngineInited	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   172: iconst_0
    //   173: invokevirtual 434	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   176: aload_0
    //   177: getfield 381	fv:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   180: getfield 368	com/etrump/mixlayout/ETEngine:isEngineReady	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   183: iconst_0
    //   184: invokevirtual 434	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   187: aload_0
    //   188: aconst_null
    //   189: putfield 381	fv:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   192: invokestatic 1612	aqcx:a	()Laqcx;
    //   195: getfield 1613	aqcx:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   198: iconst_0
    //   199: invokevirtual 434	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   202: invokestatic 1612	aqcx:a	()Laqcx;
    //   205: getfield 1614	aqcx:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   208: iconst_0
    //   209: invokevirtual 434	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   212: aload_0
    //   213: getfield 185	fv:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   216: invokevirtual 1615	java/util/concurrent/CopyOnWriteArrayList:clear	()V
    //   219: invokestatic 399	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   222: ifeq +13 -> 235
    //   225: ldc_w 293
    //   228: iconst_2
    //   229: ldc_w 1617
    //   232: invokestatic 406	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   235: return
    //   236: astore_2
    //   237: aload_1
    //   238: monitorexit
    ...
    //   240: athrow
    //   241: astore_1
    //   242: invokestatic 399	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   245: ifeq -137 -> 108
    //   248: ldc_w 293
    //   251: iconst_2
    //   252: aload_1
    //   253: invokevirtual 1618	java/lang/UnsatisfiedLinkError:getMessage	()Ljava/lang/String;
    //   256: invokestatic 1180	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   259: goto -151 -> 108
    //   262: astore_2
    //   263: aload_1
    //   264: monitorexit
    ...
    //   266: athrow
    //   267: astore_1
    //   268: invokestatic 399	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   271: ifeq -106 -> 165
    //   274: ldc_w 293
    //   277: iconst_2
    //   278: aload_1
    //   279: invokevirtual 1618	java/lang/UnsatisfiedLinkError:getMessage	()Ljava/lang/String;
    //   282: invokestatic 1180	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   285: goto -120 -> 165
