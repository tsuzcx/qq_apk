...
public abstract class aozu
{
  public static final String a;
  public static final String b = arrw.b + "file/";
  protected QQAppInterface a;
  
  static
  {
    jdField_a_of_type_JavaLangString = arrw.b + "fileThumb/";
  }
  
  public aozu(QQAppInterface paramQQAppInterface)
  {
  ...
  protected MsgBackupResEntity a(MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    ...
    arsc.a(paramMessageRecord, localMsgBackupResEntity);
    localMsgBackupResEntity.extraDataStr = a(apck.a((ChatMessage)paramMessageRecord), paramInt);
    ...
    if (bace.b(paramString)) {
      localMsgBackupResEntity.fileSize = bace.a(paramString);
    }
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if ((!TextUtils.isEmpty(paramMsgBackupResEntity)) && (!TextUtils.isEmpty(str)) && (paramMsgBackupResEntity.equals(str)))
      {
        if (QLog.isDebugVersion()) {
          QLog.i("FileMsgBackupHandler<QFile>", 1, "isResourceRelateToMsg: multi msg match res. fileId[" + str + "] " + apdq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
        }
        return true;
      }
      return false;
