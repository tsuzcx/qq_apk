...
public class avue
{
  public static void a(Context paramContext, String paramString, List<Object> paramList)
  {
    ...
    bdhb.a(paramString + "v5.8.nbr", new Object[] { paramList });
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (a(paramQQAppInterface))
    {
      ...
      if (i <= Math.abs(l3 - l1) / 1000L)
      {
        ...
        localObject = paramQQAppInterface.b(alof.H, 1001).iterator();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    MessageForNearbyRecommenderTips localMessageForNearbyRecommenderTips = (MessageForNearbyRecommenderTips)azaf.a(-4011);
    long l = ayzl.a();
    localMessageForNearbyRecommenderTips.init(paramQQAppInterface.getCurrentAccountUin(), alof.as, alof.as, "", l, -4011, 1001, l);
    localMessageForNearbyRecommenderTips.isread = true;
    abti.a(localMessageForNearbyRecommenderTips, false);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyRecommenderUtils", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + bdeu.a(paramString3));
    }
    long l = ayzl.a();
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)azaf.a(-5007);
    ...
    if ((!paramBoolean1) || (!alww.a(paramQQAppInterface, localMessageForGrayTips, false))) {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(alof.H, 1001);
