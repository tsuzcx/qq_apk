  ...
  implements ImageAssetDelegate
{
  ...
  public Bitmap fetchBitmap(LottieImageAsset paramLottieImageAsset)
  {
    ...
    try
    {
      paramLottieImageAsset = mpy.a(str, this.a.jdField_a_of_type_Int, this.a.b);
    ...
    catch (Exception localException)
    {
      ...
      QLog.w(augf.jdField_a_of_type_JavaLangString, 1, "PromotionGuide Exception, imagePath[" + str + "]", localException);
    }
    return null;
  }
}
