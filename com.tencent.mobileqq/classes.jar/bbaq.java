...
public final class bbaq
{
  ...
  public static <T> void a(WebView paramWebView, bbav<T> parambbav)
  {
    ...
    if (paramWebView == null)
    {
      ...
      parambbav.a(new NullPointerException("mWebView is null"));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      parambbav.a(new NullPointerException("context is null"));
      return;
    }
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    localObject1 = new audw((Context)localObject1);
    ((audw)localObject1).a(ajya.a(2131699370));
    ((audw)localObject1).a(true);
    ((audw)localObject1).a(new bbar(localAtomicBoolean, (audw)localObject1));
    ((audw)localObject1).show();
    ...
    Object localObject2 = new bbas((audw)localObject1);
    ...
    ((audw)localObject1).setOnDismissListener(new bbat((AnimatorSet)localObject2));
    a(paramWebView, new bbau(localAtomicBoolean, (audw)localObject1, parambbav, paramWebView, (AnimatorSet)localObject2));
  }
  
  public static void a(WebView paramWebView, bbaw parambbaw)
  {
    if ((paramWebView == null) || (parambbaw == null)) {}
    int i;
    int j;
    Bitmap localBitmap;
    do
            ...
            try
            {
              ...
              try
              {
                if (jdField_a_of_type_JavaLangReflectMethod != null) {
                  jdField_a_of_type_JavaLangReflectMethod.invoke(paramWebView.getX5WebViewExtension(), new Object[] { localBitmap, Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Integer.valueOf(1), Integer.valueOf(1), new ScreenShotUtil.1(parambbaw, localBitmap) });
                }
                i = 1;
              }
  ...
  public static <T> boolean a(WebView paramWebView, bbav<T> parambbav)
  {
    ...
    for (;;)
    {
      ...
      if ((i <= 0) || (k <= 0) || (j <= 0))
      {
        ...
        parambbav.a(new IllegalStateException("measuredWidth <= 0 || contentWidth <= 0 || contentHeight <= 0"));
        return false;
      }
      float f = i / k;
      j = (int)(j * f);
      if (j > 20000)
      {
        ...
        parambbav.a(new IllegalStateException(ajya.a(2131719049)));
        return false;
      }
      try
      {
        ...
        if (localBitmap != null)
        {
          Canvas localCanvas = new Canvas(localBitmap);
          localCanvas.scale(f, f);
          ThreadManagerV2.executeOnNetWorkThread(new ScreenShotUtil.2(paramWebView, localCanvas, parambbav, localBitmap));
          return true;
        }
      }
