  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Integer, bbap> a;
  private boolean a;
  
  public bbaq(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aodd = ((aodd)paramQQAppInterface.a(56));
  }
  ...
  private void a(long[] paramArrayOfLong, bbap parambbap, String paramString, boolean paramBoolean)
  {
    ThreadManager.post(new NumRedMsgManager.2(this, paramArrayOfLong, parambbap, paramBoolean, paramString), 5, null, false);
  }
  ...
  {
    boolean bool = bhmi.a(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "NumRedMsgFileName_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramNumMsgRspBody.toByteArray(), false);
    if (bool) {
  ...
  public void a(NumRedMsg.NumMsgRspBody paramNumMsgRspBody, ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      paramNumMsgRspBody = (bbap)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
      if (paramNumMsgRspBody == null) {
        break;
      }
  ...
  public void a(List<Submsgtype0x89.NumRedBusiInfo> paramList, String paramString, bbap parambbap)
  {
    ThreadManager.post(new NumRedMsgManager.1(this, paramList, parambbap, paramString), 5, null, false);
  }
  
  public void a(long[] paramArrayOfLong, String paramString, bbap parambbap)
  {
    a(paramArrayOfLong, parambbap, paramString, false);
  }
