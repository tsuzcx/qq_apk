  ...
  extends ajfb
{
  ...
  private CopyOnWriteArrayList<anfq> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public ajhm(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        case 1: 
          ...
          if (this.app != null)
          {
            localObject3 = (arnz)this.app.getManager(14);
            if (localObject3 != null)
            {
              localObject1 = ((arnz)localObject3).a((String)localObject1);
              ((EmoticonPackage)localObject1).ipSiteInfo = ((VipIPSiteInfo)localObject2);
              ((EmoticonPackage)localObject1).ipSiteInfoBytes = ((arnz)localObject3).a((VipIPSiteInfo)localObject2);
              ...
              ((arnz)localObject3).a((EmoticonPackage)localObject1);
            }
          }
          if (!QLog.isColorLevel()) {
            return;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localReqBody.str_app_version.set("8.2.6");
  ...
  public void a(int paramInt, ArrayList<Emoticon> paramArrayList, String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      try
      {
        localObject3 = ByteStringMicro.copyFrom(anjd.a(((Emoticon)localObject3).eId));
  ...
  public void a(anfq paramanfq)
  {
    if (paramanfq != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.addIfAbsent(paramanfq);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    paramString.str_app_version.set("8.2.6");
  ...
  public void a(String paramString, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramList2.str_app_version.set("8.2.6");
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    localModuleReq.mqqver.set("8.2.6");
  ...
  public void a(List<String> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        ...
        paramList.str_app_version.set("8.2.6");
  ...
  public void b()
  {
    ...
    localReqBody.str_app_version.set("8.2.6");
    Object localObject1 = ((anho)this.app.getManager(172)).b();
  ...
  public void b(anfq paramanfq)
  {
    if (paramanfq != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramanfq);
    }
  }
    ...
    if (localObject1 != null)
    {
      ...
      if ((localJSONArray != null) && (localJSONArray.length() > 0))
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          localObject1 = "";
          if (k == 3) {
            localObject1 = anjd.k.replace("[epId]", String.valueOf(j)).replace("[mod]", String.valueOf(j % 10));
          }
          for (;;)
          {
            String str2 = bant.a(BaseApplicationImpl.context, "emojiDetail", String.valueOf(j), "") + "&sceneType=1";
            ...
            break;
            if (k == 6) {
              localObject1 = anjd.l.replace("[epId]", String.valueOf(j));
            }
          }
        }
        ...
        localObject2 = (arnz)this.app.getManager(14);
        if (localObject2 != null) {
          ((arnz)localObject2).a((EmosmPb.SubCmd0x5RspBQRecommend)localObject1, 1);
        }
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
            ...
            for (;;)
            {
              try
              {
                ...
                if (m != 0)
                {
                  ...
                  bool2 = bool1;
                  j = i;
                  paramToServiceMsg = (arnz)this.app.getManager(14);
                  if (j != 2) {
                    break label3782;
                  }
                  if (!bool2) {
              ...
              catch (Exception paramObject)
              {
                ...
                paramObject = null;
                continue;
                localObject1 = (arnz)this.app.getManager(14);
                switch (i)
                {
                }
              }
              ...
              do
              {
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                            ...
                            ((arnz)localObject1).g(paramToServiceMsg, k);
                            paramToServiceMsg = ((arnz)localObject1).a(paramToServiceMsg, k);
                            anfi.a().b(paramToServiceMsg);
                            break;
                          ...
                          while (paramToServiceMsg.hasNext())
                          {
                            ...
                            ((arnz)localObject1).g(paramObject, k);
                            paramObject = ((arnz)localObject1).a(paramObject, k);
                            anfi.a().b(paramObject);
                          }
                          break;
                      ...
                      if (bool2)
                      {
                        ...
                        ((arnz)localObject1).a(paramToServiceMsg, k);
                      }
                    } while (!QLog.isColorLevel());
                ...
                localObject2 = (arnz)this.app.getManager(14);
                localObject3 = ((arnz)localObject2).a(String.valueOf(j), k);
              ...
              if (TextUtils.isEmpty(paramObject)) {
                paramToServiceMsg = ajjy.a(2131638298);
              }
              ...
              for (l = 86400L;; l = ((EmosmPb.SubCmd0x19Rsp)localObject1).fixed32_time.get())
              {
                ...
                ((arnz)localObject2).a((EmoticonPackage)localObject3);
                break;
              }
              localEmoticonResp.resultcode = -1;
              if (QLog.isColorLevel()) {
      ...
      if (j == 3)
      {
        ...
        while (paramToServiceMsg.hasNext()) {
          ((anfq)paramToServiceMsg.next()).a(bool2, j, localEmoticonResp);
        }
      }
      notifyUI(j, bool2, localEmoticonResp);
      return;
