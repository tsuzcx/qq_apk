  ...
  extends Handler
{
  ...
  public ajhm(PublishHomeWorkFragment paramPublishHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
  ...
  void a()
  {
    ...
    localObject = localPublishHomeWorkFragment.getString(2131430626, new Object[] { Integer.valueOf(i), Integer.valueOf(j), PublishHomeWorkFragment.e(localPublishHomeWorkFragment) }).trim();
    String str1 = localPublishHomeWorkFragment.getString(2131430626, new Object[] { Integer.valueOf(i), Integer.valueOf(j), "" }).trim();
    ...
    do
    {
      ...
      case 102: 
        ...
        if (!NetworkUtil.d(localPublishHomeWorkFragment.getActivity()))
        {
          ...
          QQToast.a(localPublishHomeWorkFragment.getActivity(), 2131430298, 0).a();
          PublishHomeWorkFragment.f(localPublishHomeWorkFragment, false);
          PublishHomeWorkFragment.g(localPublishHomeWorkFragment);
          return;
        }
