  ...
  extends BaseAdapter
{
  ...
  public bbjf(Context paramContext, List<ShareActionSheetBuilder.ActionSheetItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Bbjg == null) {
      this.jdField_a_of_type_Bbjg = new bbjg(paramViewGroup.getContext());
    }
    View localView;
    if (paramView == null)
    {
    ...
    paramView.jdField_a_of_type_AndroidWidgetTextView.setText(bbjd.a(paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.label, 6));
    int i = -8947849;
    ...
    if (paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable)
    {
      ...
      localObject = this.jdField_a_of_type_Bbjg.a((Drawable)localObject, i, j);
      if (!paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label459;
      }
      Drawable localDrawable = bbjg.a(this.jdField_a_of_type_Bbjg, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Bbjg.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label328;
      label459:
      localObject = bbjg.b(this.jdField_a_of_type_Bbjg, (Drawable)localObject);
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      break label408;
      label482:
