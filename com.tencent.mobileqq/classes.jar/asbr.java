...
public class asbr
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    a = asbo.a(paramQQAppInterface);
    int k = asbq.a(localBaseApplication, str1);
    long l = asbq.a(localBaseApplication, str1);
    ...
    if (AudioHelper.a(10) == 1)
    {
      ...
      if (i != 0)
      {
        AudioHelper.a(anzj.a(2131713624) + a.jdField_a_of_type_JavaLangString);
    ...
    for (int j = 1;; j = 0)
    {
      if (((a.jdField_a_of_type_Boolean) && (k < a.jdField_a_of_type_Int) && (paramLong1 - l > 30L) && (!paramString2.equals(str1))) || (j != 0))
      {
        ...
        paramString1 = new avpd(paramString1, paramString2, str3, paramInt, -5040, 3276801, paramLong1);
        ...
        if (avpe.a(paramQQAppInterface, paramString2))
        {
          asbq.b(localBaseApplication, str1, k + 1);
          asbq.b(localBaseApplication, str1, paramLong1);
          asbw.a("0X80094AA");
        }
      }
      return;
  ...
  {
    if (a == null) {
      a = asbo.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    }
