...
public class aqda
{
  ...
  public static ColorNote a(ColorNote paramColorNote)
  {
    ...
    String str = BaseApplicationImpl.getContext().getString(2131690767);
    int i = paramColorNote.getServiceType();
    return new aqcs().a(i | 0x80000000).a(paramColorNote.getSubType()).b(0).b(paramColorNote.getMainTitle()).c(str).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).a();
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localbgpa.dismissMessage();
    ((RelativeLayout.LayoutParams)localbgpa.getTitleTextView().getLayoutParams()).bottomMargin = bgtn.a(26.0F);
    localbgpa.setCanceledOnTouchOutside(false);
    localbgpa.setTitle(paramContext.getString(2131690759));
    localbgpa.setNegativeButton(paramContext.getString(2131690758), new aqdb(localbgpa, paramContext));
    if (localbgpa.isShowing()) {
      localbgpa.dismiss();
    }
    localbgpa.show();
    paramContext = localbgpa.getTitleTextView();
    paramContext.setClickable(true);
    paramContext.setFocusable(true);
    paramContext.setFocusableInTouchMode(true);
    bgfz.a(paramContext, true);
  }
  ...
  public static boolean a(ColorNote paramColorNote)
  {
    ...
    boolean bool1 = bool2;
    if (paramColorNote != null) {
      if (bgsp.a(paramColorNote.mMainTitle))
      {
        bool1 = bool2;
        if (bgsp.a(paramColorNote.mSubTitle)) {}
      }
      else
      {
        bool1 = true;
  ...
  {
    if ((a == null) || (a.size() == 0) || (bgsp.a(paramString))) {}
    for (;;)
    {
      return false;
      int i = 0;
  ...
  public static ColorNote b(ColorNote paramColorNote)
  {
    ...
    return new aqcs().a(i).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).a(paramColorNote.getReserve()).a();
  }
  ...
  {
    if ((b.size() == 0) || (bgsp.a(paramString))) {}
    for (;;)
    {
      return false;
      int i = 0;
  ...
  public static ColorNote c(ColorNote paramColorNote)
  {
    ...
    return new aqcs().a(paramColorNote.getServiceType()).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).b(paramColorNote.mExtra).a();
  }
  ...
  {
    if ((c.size() == 0) || (bgsp.a(paramString))) {}
    for (;;)
    {
      return false;
      int i = 0;
