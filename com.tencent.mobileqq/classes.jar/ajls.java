  ...
  implements Manager
{
  ...
  ajjh jdField_a_of_type_Ajjh = new ajlv(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ajlw(this);
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private aroi jdField_a_of_type_Aroi = new ajlx(this);
  ...
  private ArrayList<afai> jdField_c_of_type_JavaUtilArrayList;
  ...
  public ajls(QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Aroi != null)
      {
        ...
        if (paramQQAppInterface != null) {
          paramQQAppInterface.a(this.jdField_a_of_type_Aroi);
        }
      }
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        QLog.e("MayknowRecommendManager", 1, "LebaFeedsAdapter registerReceiver exception", localException);
      }
    }
  }
  
  private afai a(oidb_0xc26.TabInfo paramTabInfo)
  {
    afai localafai = new afai();
    localafai.jdField_a_of_type_Int = paramTabInfo.uint32_tab_id.get();
    localafai.jdField_b_of_type_Int = paramTabInfo.uint32_recommend_count.get();
    String str;
    if (paramTabInfo.bytes_table_name.has())
    {
      str = paramTabInfo.bytes_table_name.get().toStringUtf8();
      localafai.jdField_a_of_type_JavaLangString = str;
      if (!paramTabInfo.bytes_icon_url_select.has()) {
        break label116;
      }
      str = paramTabInfo.bytes_icon_url_select.get().toStringUtf8();
      label77:
      localafai.jdField_b_of_type_JavaLangString = str;
  ...
  private RecentRecommendTroopItem a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (!((RecentRecommendTroopItem)this.jdField_a_of_type_JavaUtilList.get(j)).uin.equalsIgnoreCase(paramString)) {
          break label250;
        }
        localObject2 = (RecentRecommendTroopItem)this.jdField_a_of_type_JavaUtilList.remove(j);
      ...
      ??? = ((akeu)localObject2).b(paramString, 8113);
      paramString = localObject1;
      if (??? == null) {
        break;
      }
      ((akeu)localObject2).b((RecentUser)???);
      return localObject1;
      label250:
      j += 1;
      continue;
  ...
  private ArrayList<RecentRecommendTroopItem> a(ArrayList<RecentRecommendTroopItem> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if (localTroopManager.d(((RecentRecommendTroopItem)paramArrayList.get(j)).uin) != null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_Atmp.b((String)localObject2);
        }
        if (paramArrayList.size() > 0)
        {
          ...
          while (paramArrayList.hasNext())
          {
            ...
            this.jdField_a_of_type_Atmp.a((atmo)localObject2);
          }
        }
      }
      catch (Exception paramArrayList)
      {
        ...
        label191:
        ??? = this.jdField_e_of_type_JavaLangObject;
        if (paramBoolean) {}
        for (;;)
        {
          try
  ...
  private <T extends MayKnowRecommend> ArrayList<T> b(@NonNull ArrayList<T> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (!localajjj.b(localMayKnowRecommend.uin))
      {
        boolean bool = localajjj.a(localMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int j = 1;; j = 0)
        {
          localMayKnowRecommend.friendStatus = j;
          if (bool) {
            break;
          }
  ...
  private void c(List<oidb_0xc26.TabInfo> paramList)
  {
    ...
    for (??? = "null";; ??? = Integer.valueOf(paramList.size()))
    {
      ...
      synchronized (this.jdField_c_of_type_JavaLangObject)
      {
        ...
        if (((afai)localObject2).jdField_a_of_type_Int == 23) {
          ((afai)localObject2).jdField_b_of_type_Int += c().size();
        }
  ...
  private boolean c()
  {
    return !((afgd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c();
  }
  
  private void d(List<afai> paramList)
  {
    for (;;)
    {
      SharedPreferences localSharedPreferences;
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        paramList = paramList.iterator();
        if (paramList.hasNext()) {
          localJSONArray.put(afai.a((afai)paramList.next()));
        }
      }
  ...
  private void e(int paramInt)
  {
    synchronized (this.jdField_e_of_type_JavaLangObject)
    {
      ...
      {
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Atmp.a(MayKnowRecommend.class, false, "tabID=?", new String[] { paramInt + "" }, null, null, null, null);
        synchronized (this.jdField_e_of_type_JavaLangObject)
        {
  ...
  private void j()
  {
    ...
    {
      localatmr.a();
      this.jdField_a_of_type_Atmp.b("delete from MayKnowRecommend");
      this.jdField_a_of_type_Atmp.b("delete from MayKnowExposure");
      localatmr.c();
      bool1 = true;
    }
    catch (Exception localException)
  ...
  private void k()
  {
    ...
    int j = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("sp_conversation_tab_show_type", -1);
    ...
    amaj localamaj = amai.a();
    StringBuilder localStringBuilder;
    if (localamaj != null)
    {
      this.jdField_g_of_type_Int = localamaj.jdField_a_of_type_Int;
      this.jdField_a_of_type_JavaLangString = localamaj.jdField_a_of_type_JavaLangString;
      if (localamaj.jdField_b_of_type_Int == 1)
      {
        bool1 = true;
    ...
    else
    {
      ...
      {
        ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1)).notifyUI(123, true, new Object[] { Integer.valueOf(j) });
  ...
  private void l()
  {
    ...
    {
      Object localObject2 = this.jdField_a_of_type_Atmp.a(MayKnowExposure.class, false, null, null, null, null, null, null);
  ...
  private void m()
  {
    Object localObject1 = (ArrayList)this.jdField_a_of_type_Atmp.a(RecentRecommendTroopItem.class);
    Object localObject3;
    int j;
    ...
    if (QLog.isColorLevel())
    {
      ...
      {
        j = 0;
        QLog.i("MayknowRecommendManager", 2, j);
      }
    }
    else
    {
  ...
  private void n()
  {
    ...
    ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Atmp.a(MayKnowRecommend.class, false, "tabID=? or tabID is null", new String[] { "23" }, null, null, null, null);
    Object localObject3;
    if (QLog.isColorLevel())
    {
    ...
    synchronized (this.jdField_c_of_type_JavaLangObject)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          {
            localArrayList.add(afai.a(((JSONArray)localObject4).getJSONObject(j)));
            j += 1;
          }
  ...
  private void q()
  {
    ...
    for (;;)
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("MayknowRecommendManager", 2, "reportExplosure size=" + this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() + " isExplosuresInited=" + this.jdField_g_of_type_Boolean);
      }
      if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() <= 0) || (!this.jdField_g_of_type_Boolean)) {
        continue;
      }
      synchronized (jdField_b_of_type_JavaLangObject)
      {
  ...
  public int a()
  {
    ...
    int j = 0;
    o();
    if (!((afgd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c()) {}
    for (int k = 1;; k = 0) {
      label148:
      for (;;)
      {
        synchronized (this.jdField_c_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              afai localafai = (afai)localIterator.next();
              if ((localafai.jdField_a_of_type_Int != 23) && (k == 0)) {
                break label148;
              }
              j = localafai.jdField_b_of_type_Int + j;
              break label148;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("MayknowRecommendManager", 2, "getConnectionsPersonAllNum " + m);
          }
          return m;
        }
      }
  ...
  public int a(int paramInt)
  {
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        if (j < m)
        {
          MayKnowRecommend localMayKnowRecommend = (MayKnowRecommend)localArrayList.get(j);
  ...
  public ArrayList<afai> a()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_c_of_type_JavaLangObject)
      {
        ...
        localafai = afai.a((afai)localIterator.next());
        if (localafai.jdField_a_of_type_Int == 23)
        {
          localafai.jdField_a_of_type_Boolean = true;
          localArrayList.add(localafai);
        }
      }
      localafai.jdField_a_of_type_Boolean = bool;
    }
    if (QLog.isColorLevel()) {
  ...
  public List<RecentRecommendTroopItem> a(int paramInt)
  {
    ...
    while ((l - this.jdField_b_of_type_Long < j * 60) && (paramInt > 0))
    {
      if (QLog.isColorLevel()) {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      int k = Math.min(this.jdField_e_of_type_Int, j);
      paramInt = 0;
      while ((this.jdField_f_of_type_Int < j) && (paramInt < k))
      {
        localArrayList.add(this.jdField_a_of_type_JavaUtilList.get(this.jdField_f_of_type_Int));
        int m = this.jdField_f_of_type_Int + 1;
        this.jdField_f_of_type_Int = m;
        this.jdField_f_of_type_Int = (m % j);
        paramInt += 1;
      }
      if (localArrayList.size() > 0) {
  ...
  public void a(int paramInt, String paramString)
  {
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if (paramString != null)
        {
          int j = Integer.valueOf(paramString.optString("reportInterval").trim()).intValue();
          if ((j <= 86400000) && (j > 0)) {
            jdField_a_of_type_Long = j;
          }
          j = Integer.valueOf(paramString.optString("showCount").trim()).intValue();
          if ((j > 0) && (j <= 100)) {
            jdField_a_of_type_Int = j;
          }
          j = Integer.valueOf(paramString.optString("totalCount").trim()).intValue();
          if ((j <= 100) && (j > 0)) {
            jdField_c_of_type_Int = j;
          }
          j = Integer.valueOf(paramString.optString("newfriendCount")).intValue();
          if (j > 0) {
  ...
  public void a(int paramInt, ArrayList<MayKnowRecommend> paramArrayList, List<oidb_0xc26.TabInfo> paramList, byte[] paramArrayOfByte, boolean paramBoolean, Bundle paramBundle)
  {
        ...
        if (paramList.hasNext())
        {
          ...
          if (((oidb_0xc26.TabInfo)???).uint32_tab_id.get() == paramInt)
          {
            ...
            if (??? != null)
            {
              j = ((ArrayList)???).size();
              if (QLog.isColorLevel()) {
                QLog.d("MayknowRecommendManager", 2, "onGetConnectionsPersonData update count " + j + " " + paramList.jdField_b_of_type_Int);
              }
              paramList.jdField_b_of_type_Int = (j + paramList.jdField_b_of_type_Int);
            }
          }
        }
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        synchronized (this.jdField_c_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              afai localafai = (afai)((Iterator)localObject3).next();
              if ((localafai.equals(paramList)) && ((localafai.jdField_b_of_type_Int != paramList.jdField_b_of_type_Int) || (!localafai.jdField_a_of_type_JavaLangString.equals(paramList.jdField_a_of_type_JavaLangString)) || (!localafai.jdField_b_of_type_JavaLangString.equals(paramList.jdField_b_of_type_JavaLangString)) || (!localafai.c.equals(paramList.c))))
              {
                localafai.jdField_b_of_type_Int = paramList.jdField_b_of_type_Int;
                localafai.jdField_a_of_type_JavaLangString = paramList.jdField_a_of_type_JavaLangString;
                localafai.jdField_b_of_type_JavaLangString = paramList.jdField_b_of_type_JavaLangString;
                localafai.c = paramList.c;
                d(this.jdField_c_of_type_JavaUtilArrayList);
              }
            }
          }
      ...
      label570:
      label593:
      for (j = 3;; j = paramBundle.getInt("update_type", 3))
      {
        ContactReportUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, j, paramList, String.valueOf(paramInt), paramArrayList);
  ...
  public void a(View paramView, Context paramContext, String paramString)
  {
    ...
    if ((paramString.equals("sp_uin_for_title")) && (j == 2131309210))
    {
      paramView = begr.a(paramContext);
      paramView.b(2131625677);
      paramView.c(2131625035);
      paramView.a(new ajlu(this, paramView));
      paramView.show();
      awqx.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_ellipsis", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return;
      if ((paramView.getTag() != null) && ((paramView.getTag() instanceof ahcn)))
      {
        paramView = (ahcn)paramView.getTag();
        if (paramView.a == null) {
          break;
        }
        ...
        for (paramView = (RecentRecommendTroopItem)paramView.a.mUser.extraInfo; paramView != null; paramView = null)
        {
          ...
          if (j == 2131298020)
          {
            ...
            awqx.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_add", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
            return;
          }
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty(paramView.recommendReason))
              {
                ...
                localObject = mne.a(paramView);
                if (localObject != null) {
                  paramString.labels = ((ArrayList)localObject);
                }
                paramString.strJoinSig = paramView.authSig;
                azlj.a(paramContext, azlj.a(107, paramString, 10018, false), 2);
                awqx.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_grp", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
                return;
              }
            }
  ...
  public void a(String paramString)
  {
    ...
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject3).has("shield_sub_source_id"))
        {
          ...
          j = 0;
          while ((localObject3 != null) && (j < ((JSONArray)localObject3).length()))
          {
            int k = ((JSONArray)localObject3).getInt(j);
    ...
    try
    {
      ...
      {
        ((StringBuilder)???).append(this.jdField_b_of_type_JavaUtilArrayList.get(j)).append(",");
        j += 1;
        continue;
        paramString = finally;
        throw paramString;
      ...
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaLangObject)
        {
          ...
          if ((paramBoolean) && (localMayKnowRecommend != null)) {
            this.jdField_a_of_type_Atmp.b(localMayKnowRecommend);
          }
          o();
          ...
          synchronized (this.jdField_c_of_type_JavaUtilArrayList)
          {
            ...
            for (;;)
            {
              ...
              localafai = (afai)localIterator.next();
              label217:
              label222:
              synchronized (this.jdField_e_of_type_JavaLangObject)
              {
                ...
                {
                  if (localafai.jdField_b_of_type_Int <= 0) {
                    break;
                  }
                  j = localafai.jdField_b_of_type_Int - 1;
                  localafai.jdField_b_of_type_Int = j;
                }
              }
            }
          }
        ...
        break label217;
        label252:
        Object localObject3 = (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(localafai.jdField_a_of_type_Int));
        if (localObject3 != null)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            localafai.jdField_b_of_type_Int -= 1;
          }
        }
      }
      label336:
  ...
  public void a(@NonNull ArrayList<MayKnowRecommend> paramArrayList)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_1
    //   5: invokevirtual 338	java/util/ArrayList:isEmpty	()Z
    //   8: ifeq +29 -> 37
    //   11: invokestatic 266	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +22 -> 36
    //   17: ldc 202
    //   19: iconst_2
    //   20: invokestatic 1264	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   23: ldc_w 1266
    //   26: iconst_0
    //   27: anewarray 4	java/lang/Object
    //   30: invokestatic 1270	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   33: invokestatic 281	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   36: return
    //   37: aload_0
    //   38: aload_1
    //   39: invokespecial 354	ajls:b	(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    //   42: astore 4
    //   44: aload 4
    //   46: astore_3
    //   47: aload 4
    ...
    //   62: iconst_0
    //   63: sipush 1000
    //   66: invokeinterface 1274 3 0
    //   71: astore_3
    //   72: getstatic 46	ajls:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   75: astore 4
    //   77: aload 4
    //   79: monitorenter
    //   80: aload_0
    //   81: getfield 140	ajls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   84: invokevirtual 1217	java/util/ArrayList:clear	()V
    //   87: aload_0
    //   88: getfield 140	ajls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: aload_3
    //   92: invokevirtual 358	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   95: pop
    //   96: aload 4
    //   98: monitorexit
    //   99: aload_0
    //   100: getfield 129	ajls:jdField_a_of_type_Atmp	Latmp;
    //   103: invokevirtual 363	atmp:a	()Latmr;
    //   106: astore 4
    //   108: aload 4
    //   110: invokevirtual 367	atmr:a	()V
    //   113: aload_0
    //   114: getfield 129	ajls:jdField_a_of_type_Atmp	Latmp;
    //   117: ldc_w 656
    //   120: invokevirtual 374	atmp:b	(Ljava/lang/String;)Z
    //   123: pop
    //   124: aload_3
    //   125: invokeinterface 292 1 0
    //   130: ifle +145 -> 275
    //   133: aload_3
    //   134: invokeinterface 549 1 0
    //   139: astore_3
    //   140: aload_3
    //   141: invokeinterface 383 1 0
    //   146: ifeq +129 -> 275
    //   149: aload_0
    //   150: aload_3
    //   151: invokeinterface 387 1 0
    //   156: checkcast 389	com/tencent/mobileqq/data/MayKnowRecommend
    //   159: invokevirtual 1276	ajls:a	(Latmo;)Z
    //   162: pop
    //   163: goto -23 -> 140
    //   166: astore_3
    //   167: invokestatic 266	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +13 -> 183
    //   173: ldc 202
    //   175: iconst_2
    //   176: ldc_w 1278
    //   179: aload_3
    //   180: invokestatic 396	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   183: aload 4
    //   185: invokevirtual 398	atmr:b	()V
    //   188: iconst_0
    //   189: istore_2
    //   190: aload_0
    //   191: getfield 96	ajls:jdField_e_of_type_JavaLangObject	Ljava/lang/Object;
    //   194: astore_3
    //   195: aload_3
    //   196: monitorenter
    //   197: aload_0
    //   198: getfield 83	ajls:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   201: ifnull +10 -> 211
    //   204: aload_0
    //   205: getfield 83	ajls:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   208: invokevirtual 1279	java/util/HashMap:clear	()V
    //   211: aload_3
    //   212: monitorexit
    //   213: invokestatic 266	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   216: ifeq -180 -> 36
    //   219: ldc 202
    //   221: iconst_2
    //   222: invokestatic 1264	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   225: ldc_w 1281
    //   228: iconst_3
    ...
    //   233: iconst_0
    //   234: aload_1
    //   235: invokevirtual 341	java/util/ArrayList:size	()I
    //   238: invokestatic 404	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   241: aastore
    //   242: dup
    //   243: iconst_1
    //   244: aload_0
    //   245: getfield 140	ajls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   248: invokevirtual 341	java/util/ArrayList:size	()I
    //   251: invokestatic 404	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   254: aastore
    //   255: dup
    //   256: iconst_2
    //   257: iload_2
    //   258: invokestatic 1286	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   261: aastore
    //   262: invokestatic 1270	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   265: invokestatic 281	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   268: return
    //   269: astore_1
    //   270: aload 4
    //   272: monitorexit
    ...
    //   274: athrow
    //   275: aload 4
    //   277: invokevirtual 413	atmr:c	()V
    //   280: aload 4
    //   282: invokevirtual 398	atmr:b	()V
    //   285: iconst_1
    //   286: istore_2
    //   287: goto -97 -> 190
    //   290: astore_1
    //   291: aload 4
    //   293: invokevirtual 398	atmr:b	()V
    //   296: aload_1
    //   297: athrow
    //   298: astore_1
    //   299: aload_3
  ...
  public void a(List<String> paramList, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    //   21: astore 7
    //   23: getstatic 46	ajls:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   26: astore 8
    //   28: aload 8
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 140	ajls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   67: aload_1
    //   68: aload 10
    //   70: getfield 577	com/tencent/mobileqq/data/MayKnowRecommend:uin	Ljava/lang/String;
    //   73: invokeinterface 1288 2 0
    //   78: ifeq -38 -> 40
    //   81: iload 6
    //   83: ifeq +39 -> 122
    //   86: aload 10
    //   88: getfield 1314	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   91: lload 4
    //   93: ladd
    //   94: lload_2
    //   95: lcmp
    ...
    //   99: aload 10
    //   101: lload_2
    //   102: putfield 1314	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   105: aload 7
    //   107: aload 10
    //   109: invokevirtual 585	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   112: pop
    //   113: goto -73 -> 40
    //   116: astore_1
    //   117: aload 8
    ...
    //   122: aload 10
    //   124: lload_2
    //   125: putfield 1314	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   128: aload 7
    //   130: aload 10
    //   132: invokevirtual 585	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   135: pop
    //   136: goto -96 -> 40
    //   139: aload 8
    //   141: monitorexit
    //   142: aload 7
    //   144: invokevirtual 338	java/util/ArrayList:isEmpty	()Z
    //   147: ifne -134 -> 13
    //   150: aload_0
    //   151: getfield 129	ajls:jdField_a_of_type_Atmp	Latmp;
    //   154: invokevirtual 363	atmp:a	()Latmr;
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 367	atmr:a	()V
    //   162: aload 7
    ...
    //   196: aload_0
    //   197: aload 8
    //   199: invokevirtual 1276	ajls:a	(Latmo;)Z
    //   202: pop
    //   203: goto -34 -> 169
    //   206: astore 7
    //   208: ldc 202
    //   210: iconst_1
    //   211: ldc_w 1316
    //   214: invokestatic 1008	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   217: aload_1
    //   218: invokevirtual 398	atmr:b	()V
    //   221: return
    //   222: aload_1
    //   223: invokevirtual 413	atmr:c	()V
    //   226: aload_1
    //   227: invokevirtual 398	atmr:b	()V
    //   230: return
    //   231: astore 7
    //   233: aload_1
    //   234: invokevirtual 398	atmr:b	()V
    //   237: aload 7
    //   239: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void a(boolean paramBoolean, ArrayList<MayKnowRecommend> paramArrayList, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle, List<oidb_0xc26.TabInfo> paramList, byte[] arg9)
  {
    ...
    if (paramBundle != null)
    {
      ...
      if (!paramList.isEmpty())
      {
        ...
        j = 3;
        ContactReportUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, j, paramList);
      }
    }
    boolean bool;
    if (paramInt2 != 0)
    ...
    label430:
    label436:
    for (int j = 0;; j = paramArrayList.size())
    {
      QLog.i("MayknowRecommendManager", 1, "handleReqMayknownFriendList, isSuc = " + paramBoolean + ",dataSize=" + j + ",timestamp=" + paramInt1 + ",isMsgUp=" + paramInt2 + ",msgTabListSwitch=" + paramInt3 + ",addPageListSwitch=" + paramInt4);
      return;
  ...
  public void a(boolean paramBoolean, List<oidb_0xc26.RecommendInfo> arg2)
  {
    ...
    localatmr.a();
    this.jdField_a_of_type_Atmp.b("delete from RecentRecommendTroopItem");
        ...
        for (;;)
        {
          if (localIterator2.hasNext())
          {
            ...
            if (localRgroupInfo.uint64_group_code.has())
            {
              ...
              localRecentRecommendTroopItem.labelList = ajqt.b(localRgroupInfo.rpt_group_label.get());
              ...
              {
                k = Math.min(3, localRecentRecommendTroopItem.labelList.size());
    ...
    for (;;)
    {
      ...
      if (j == k)
      {
        ...
        label585:
        localRecentRecommendTroopItem.activity = j;
      ...
      {
        localRecentRecommendTroopItem.privilege = j;
        this.jdField_a_of_type_Atmp.b(localRecentRecommendTroopItem);
  ...
  protected boolean a(atmo paramatmo)
  {
    ...
    QLog.d("MayknowRecommendManager", 2, "updateEntity em closed e=" + paramatmo.getTableName());
    return false;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      paramString = localakeu.b(paramString, 8112);
      bool1 = bool2;
      if (paramString != null)
      {
  ...
  public boolean a(List<RecentBaseData> paramList)
  {
              ...
              if (localObject1 != null)
              {
                ...
                if (j < 3) {
                  if (i1 <= 3)
                  {
                    ...
                    if (QLog.isColorLevel()) {
                      QLog.d("MayknowRecommendManager", 2, "checkAndReOrderRecentData insertIndex = " + k + ",setTopItemCount = " + j + ",listsize = " + i1);
                    }
                    long l = NetConnInfoCenter.getServerTime();
                    ...
                    label349:
                    if (QLog.isColorLevel()) {
                      QLog.d("MayknowRecommendManager", 2, "checkAndReOrderRecentData insertIndex = " + k + ",setTopItemCount = " + j + ",listsize = " + i1 + ",lastmsgtime = " + ((RecentItemMayKnowFriendData)localObject1).mUser.lastmsgtime);
                    }
    ...
    for (;;)
    {
      ...
      if (k < paramList.size())
      {
        localObject2 = (RecentBaseData)paramList.get(k);
        n = m;
        if (!ahai.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject2)) {
          n = m + 1;
        }
        if (n == 3) {
          k += 1;
  ...
  public boolean a(boolean paramBoolean, List<MayKnowRecommend> paramList)
  {
    ...
    for (paramList = new LinkedList(this.jdField_a_of_type_JavaUtilArrayList);; paramList = null)
    {
      ...
      if ((paramList != null) && (!paramList.isEmpty()))
      {
        ...
        {
          ((atmr)???).a();
          this.jdField_a_of_type_Atmp.b("delete from MayKnowRecommend where tabID=23");
          paramList = paramList.iterator();
  ...
  public ArrayList<String> b()
  {
    ...
    Object localObject4 = this.jdField_c_of_type_JavaLangObject;
    ...
    try
    {
      if (this.jdField_c_of_type_JavaUtilArrayList != null)
      {
        ...
        if (!this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
          localObject1 = (afai)this.jdField_c_of_type_JavaUtilArrayList.get(0);
        }
      }
      if (localObject1 != null)
      {
        localObject1 = a(((afai)localObject1).jdField_a_of_type_Int);
        if (localObject1 != null) {
          while ((j < ((ArrayList)localObject1).size()) && (j < 4))
          {
            localArrayList.add(((MayKnowRecommend)((ArrayList)localObject1).get(j)).uin);
            j += 1;
          }
        }
      }
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localafai.jdField_a_of_type_Int != 23)
        {
          a(localafai.jdField_a_of_type_Int, new ArrayList(0), true);
          a(localafai.jdField_a_of_type_Int, null);
        }
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_c_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          if (((afai)localIterator.next()).jdField_a_of_type_Int != paramInt) {
            continue;
          }
  ...
  public void b(List<oidb_0xc26.EntryDelay> paramList)
  {
    ...
    {
      if (j > 0) {
        localEditor.putLong("pull_interval_conversation_tab", j * 1000);
      }
      if (k > 0) {
        localEditor.putLong("pull_interval_contact_head", k * 1000);
      }
      if (m > 0) {
        localEditor.putLong("pull_interval_recommend_tab", m * 1000);
      }
      if (n > 0) {
        localEditor.putLong("pull_interval_new_friend", n * 1000);
      }
      if (i1 > 0) {
        localEditor.putLong("pull_interval_add_page", i1 * 1000);
      }
      localEditor.commit();
      QLog.i("MayknowRecommendManager", 1, "saveReqTimeAndIntervalInfo,msgIntervel = " + j + ",headIntervel = " + k + ",recommendIntervel = " + m + ",newIntervel = " + n + ",addIntervel = " + i1);
      return;
      n = 0;
      m = 0;
      k = 0;
  ...
  public boolean b()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("MayknowRecommendManager", 2, "isConversationTabNeedShowRecommendTroop result: " + bool);
      }
      return bool;
      bool = false;
    }
        ...
        if (bool1)
        {
          ...
          if (!TextUtils.equals(paramString, "sp_mayknow_ml_s_a_vl"))
          {
            ...
            if (!TextUtils.equals(paramString, "sp_mayknow_addpage_s_a_vl"))
            {
              ...
              {
                afgd localafgd = (afgd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
                bool2 = bool1;
                if (localafgd != null)
                {
                  bool2 = bool1;
        ...
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            if (??? != null)
            {
              ...
              this.jdField_a_of_type_Atmp.a((atmo)???, "uin=?", new String[] { localObject4 });
            }
          }
          return false;
        }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if ((localObject4 != null) && (!((List)localObject4).isEmpty()) && (bool))
        {
          akeu localakeu = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
          localakeu.b(8112);
          ??? = localakeu.b(ajed.af, 8111);
          if (??? != null) {
            localakeu.b((RecentUser)???);
          }
          localakeu.b(8113);
          Object localObject2 = localakeu.b("sp_uin_for_title", 8113);
          ??? = localObject2;
          if (localObject2 == null) {
          ...
          ??? = localakeu.b(localRecentRecommendTroopItem.uin, 8113);
          if (??? != null) {
            break label404;
          }
  ...
  public void c(String paramString)
  {
    ...
    a(paramString);
    ((ajqt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new ajly(this, paramString));
    ...
    if (this.jdField_e_of_type_Int == 0)
    {
      ...
      awqx.b(null, "dc00899", "Grp_recom", "", "link_top", "clk_hide", 0, 0, "", "", "", "");
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject1 = localakeu.b(ajed.af, 8111);
      if (localObject1 != null) {
        localakeu.b((RecentUser)localObject1);
      }
      localakeu.b(8112);
      localRecentUser = localakeu.b("sp_uin_for_title", 8112);
      ...
      localakeu.a((RecentUser)localObject1);
      Iterator localIterator = ((ArrayList)localObject2).iterator();
      if (!localIterator.hasNext()) {
        break label462;
      }
      localMayKnowRecommend = (MayKnowRecommend)localIterator.next();
      localRecentUser = localakeu.b(localMayKnowRecommend.uin, 8112);
      if (localRecentUser != null) {
        break label479;
      }
    ...
    for (;;)
    {
      ...
      break;
      localakeu.b(8112);
      localRecentUser = localakeu.b(ajed.af, 8111);
      if (QLog.isColorLevel()) {
      ...
      localObject1 = localRecentUser;
      if (localRecentUser == null) {
        localObject1 = new RecentUser(ajed.af, 8111);
      }
      localakeu.a((RecentUser)localObject1);
  ...
  public void d(String paramString)
  {
    ...
    ((ajqt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new ajlt(this, paramString));
    ...
    {
      awqx.b(null, "dc00899", "Grp_recom", "", "msg_tab", "slide_delete", 0, 0, paramString, (String)localObject, "", "");
      return;
  ...
  public void e()
  {
    ...
    akeu localakeu = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    localakeu.b(8112);
    RecentUser localRecentUser = localakeu.b(ajed.af, 8111);
    if (QLog.isColorLevel()) {
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_Atmp == null)) {}
    for (;;)
    {
      return;
  ...
  public void h()
  {
    ...
    ((FriendListHandler)localObject).g();
  }
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        QLog.e("MayknowRecommendManager", 2, "onDestroy unregisterReceiver exception", localException);
      }
    }
  }
}
