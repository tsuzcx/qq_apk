...
public class oce
{
  private static oce jdField_a_of_type_Oce;
  private final int jdField_a_of_type_Int = 8;
  private final long jdField_a_of_type_Long = 86400000L;
  private final String jdField_a_of_type_JavaLangString = oce.class.getSimpleName();
  private ArrayList<oci> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, och> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ArrayList<och> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<oci> a(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    Iterator localIterator = this.jdField_b_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      och localoch = (och)localIterator.next();
      paramQQAppInterface.add(new oci(this, localoch.jdField_a_of_type_JavaLangString, localoch.jdField_b_of_type_JavaLangString, localoch.jdField_a_of_type_Boolean));
    }
  ...
  public static oce a()
  {
    if (jdField_a_of_type_Oce == null) {}
    try
    {
      jdField_a_of_type_Oce = new oce();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_Oce.jdField_a_of_type_JavaLangString, 2, "newInstance!");
      }
      return jdField_a_of_type_Oce;
    }
    finally {}
  }
  
  private void a(QQAppInterface paramQQAppInterface, ocg paramocg)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramocg.a(new ArrayList(), null, true);
      return;
    }
  ...
  private void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = tzq.a(paramQQAppInterface);
          if (paramQQAppInterface != null)
          {
            ...
            while (i < paramQQAppInterface.length())
            {
              ...
              localObject = new oci(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optBoolean("isPA", true));
  ...
  private void b(QQAppInterface paramQQAppInterface, ocg paramocg)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, "sendGetPublicAccountSearchRecommendRequest->begin!");
    }
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), ocj.class);
    ...
    localGetRecommendPubAccountRequest.version.set(tzq.a());
    ...
    localNewIntent.setObserver(new ocf(this, localNewIntent, paramQQAppInterface, paramocg));
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            {
              Object localObject = (JSONObject)paramQQAppInterface.get(i);
              localObject = new och(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optLong("time"), ((JSONObject)localObject).optBoolean("isPA", true));
              this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
              this.jdField_a_of_type_JavaUtilHashMap.put(((och)localObject).jdField_a_of_type_JavaLangString, localObject);
              i += 1;
            }
          }
          return;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      paramString1 = (och)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    ...
    for (;;)
    {
      ...
      {
        paramString1 = (och)paramQQAppInterface.next();
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, paramString1.toString());
      }
      break;
      paramString2 = new och(this, paramString1, paramString2, l, paramBoolean);
      ...
      if (i > 8)
      {
        paramString1 = (och)this.jdField_b_of_type_JavaUtilArrayList.get(i - 1);
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramString1);
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, ocg paramocg)
  {
    if (QLog.isColorLevel()) {
