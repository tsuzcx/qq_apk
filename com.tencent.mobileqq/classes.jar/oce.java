  ...
  implements View.OnClickListener
{
  ...
  public oce(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131559788, null);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131369624));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362649));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView = ((NativeAdDownloadView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379153));
  ...
  private int d()
  {
    int j = actn.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    int i = j;
    if (this.jdField_b_of_type_OrgJsonJSONObject != null)
    {
      ...
      i = j;
      if (k > 0) {
        i = actn.a(k, this.jdField_a_of_type_AndroidContentContext.getResources());
      }
    }
    return i;
  }
  ...
  private boolean i()
  {
    if ((b()) && (this.jdField_a_of_type_Qjf != null)) {
      try
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          if ((nlx.a(this.jdField_a_of_type_AndroidContentContext, str)) && (localDownloadInfo != null) && (localDownloadInfo.a() == 4))
          {
            m();
            return true;
          }
  ...
  private void p()
  {
    if ((b()) && (this.jdField_a_of_type_Qjf != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Qjf.c)))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setClickable(true);
      this.jdField_a_of_type_AndroidViewView.setClickable(true);
  ...
  private void r()
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"))) {
        i = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"), "#12B7F5");
      }
      ...
      do
      {
        ...
        {
          return;
        } while ((this.jdField_a_of_type_Pax == null) || (this.jdField_a_of_type_Pax.a() == null) || (this.jdField_a_of_type_Qjf == null) || (this.jdField_a_of_type_Qjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null));
        localObject = this.jdField_a_of_type_Pax.a().a();
      } while (localObject == null);
      ((nlx)localObject).b(this.jdField_a_of_type_Qjf, this.jdField_a_of_type_Qjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState);
      return;
    }
    catch (Exception localException)
    {
  ...
  protected Drawable a()
  {
    ...
    if (this.jdField_b_of_type_OrgJsonJSONObject != null)
    {
      ...
      {
        localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842181);
        if ((this.jdField_a_of_type_Qjf == null) || (!bbfd.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Qjf.d))) {
          break label87;
        }
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842181);
      }
    }
    label87:
    do
    {
      return localObject1;
      if (f()) {
        return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842179);
      }
      if ((d()) || (e())) {
        return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842182);
      }
      localObject1 = localObject2;
    } while (c());
  ...
  protected String a()
  {
    return oau.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    case 1: 
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131712871));
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.a(paramInt1, paramInt2);
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.setVisibility(8);
      return;
    case 4: 
    ...
    case 6: 
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.setVisibility(8);
      bcpw.a(this.jdField_a_of_type_AndroidContentContext, ajyc.a(2131712977), 0).a();
      return;
    }
    f();
  }
  ...
  protected void a(AdData paramAdData)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.setVisibility(8);
    c();
    if (((paramAdData != null) && (oax.a(paramAdData))) || (oax.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a();
    }
    int i;
    do
  ...
  protected void d()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i1 = 0;
        String str1 = b();
        olb.a(this.jdField_a_of_type_AndroidWidgetTextView, null);
        f2 = f1;
        if (this.jdField_b_of_type_OrgJsonJSONObject != null)
        {
          if (TextUtils.isEmpty(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"))) {
          ...
          i1 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"), "#40A0FF");
          if (!TextUtils.isEmpty(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextSize")))
          {
            f1 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextSize"), 14);
            f2 = f1;
            if (f1 >= 10.0F) {
              break label1094;
            }
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) || (!TextUtils.isEmpty((CharSequence)localObject1)) || (!TextUtils.isEmpty(str2)) || (!TextUtils.isEmpty(str3)))
          {
            ...
            if (!TextUtils.isEmpty(str2)) {
              localGradientDrawable.setColor(nmk.a(str2, "#40A0FF"));
            }
            if (nmk.a((String)localObject1, 0.0F) > 0.0F)
            {
              f3 = nmk.a((String)localObject1, 0.0F);
              f2 = f3;
              if (f3 > 2.0F) {
                f2 = 2.0F;
              }
              localGradientDrawable.setStroke(actn.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources()), nmk.a((String)localObject2, "#40A0FF"));
            }
            if (!TextUtils.isEmpty(str3))
            {
              ...
              f2 = 0.0F;
              localGradientDrawable.setCornerRadius(actn.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources()));
            }
          ...
          f3 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonHorizontalPadding").trim(), 0.0F);
          f4 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonVerticalPadding").trim(), 0.0F);
          if (f3 >= 0.0F) {
            break label1140;
          }
          f2 = 0.0F;
          ...
          k = actn.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources());
          j = k;
          if (f3 <= 0.0F) {
            break label1068;
          }
          n = actn.a(f3, this.jdField_a_of_type_AndroidContentContext.getResources());
          m = n;
          ...
          int i7 = a(i1);
          f2 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonWidth").trim(), 0.0F);
          f3 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonHeight").trim(), 0.0F);
          if ((f2 <= 0.0F) || (f3 <= 0.0F)) {
            break label1041;
          }
          localObject2 = (FrameLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
          ((FrameLayout.LayoutParams)localObject2).height = actn.a(f3, this.jdField_a_of_type_AndroidContentContext.getResources());
          ((FrameLayout.LayoutParams)localObject2).width = actn.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources());
          this.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
          ...
          k = 0;
          j = 0;
          f4 = nmk.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("width").trim(), 0.0F);
          i1 = j;
          i2 = k;
          i3 = m;
          i4 = n;
          ...
          if (f4 > 0.0F)
          {
            ...
            ((Layout.Params)localObject1).mLayoutWidth = actn.a(f2 * 2.0F + f4, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  protected void e()
  {
    ...
    localnyc.c = true;
    sht.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_Pax.a(), (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mChannelID, true, localnyc);
  }
  
  protected boolean e()
  {
    return oau.e(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  
  public void f()
  {
    if ((this.jdField_a_of_type_Qjf == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null)) {
      return;
    }
    if (nlw.a(this.jdField_a_of_type_Qjf, c()))
    {
      ...
      nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.jdField_a_of_type_Int).b(nmf.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
      return;
    }
    h();
    nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.jdField_a_of_type_Int).b(nmf.aa).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
  }
  
  protected boolean f()
  {
    return oau.c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  
  protected void g()
  {
    if ((this.jdField_a_of_type_Pax != null) && (this.jdField_a_of_type_Pax.a() != null) && (this.jdField_a_of_type_Qjf != null))
    {
      nlx localnlx = this.jdField_a_of_type_Pax.a().a();
      if (localnlx != null) {
        localnlx.b(this.jdField_a_of_type_Qjf);
      }
    }
  }
  ...
  protected boolean g()
  {
    return oat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  ...
  protected void h()
  {
    if ((this.jdField_a_of_type_Pax != null) && (this.jdField_a_of_type_Pax.a() != null) && (this.jdField_a_of_type_Qjf != null))
    {
      nlx localnlx = this.jdField_a_of_type_Pax.a().a();
      if (localnlx != null) {
        localnlx.a(this.jdField_a_of_type_Qjf);
      }
  ...
  protected void i()
  {
    if ((this.jdField_a_of_type_Pax != null) && (this.jdField_a_of_type_Pax.a() != null) && (this.jdField_a_of_type_Qjf != null))
    {
      nlx localnlx = this.jdField_a_of_type_Pax.a().a();
      if (localnlx != null) {
        localnlx.e(this.jdField_a_of_type_Qjf);
      }
    }
  }
  ...
  protected void j()
  {
    if ((this.jdField_a_of_type_Pax != null) && (this.jdField_a_of_type_Pax.a() != null) && (this.jdField_a_of_type_Qjf != null))
    {
      nlx localnlx = this.jdField_a_of_type_Pax.a().a();
      if (localnlx != null) {
        localnlx.c(this.jdField_a_of_type_Qjf);
      }
    }
  }
  ...
  protected void k()
  {
    ...
    sht.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, null, (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mChannelID, true);
  }
  ...
  public void l()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null)
    {
      String str = oau.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
      if (b()) {
        r();
      }
      if (!TextUtils.isEmpty(str)) {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        case 2131362649: 
          try
          {
            if (oax.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
            {
              oax.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
              return;
            }
          }
          ...
          j = oau.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
        }
      } while (j == 1);
      if (e())
      {
        s();
        nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.J).b(nmf.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
        return;
      }
    } while (this.jdField_a_of_type_Qjf == null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mProgressFromFeeds = true;
    paramView = this.jdField_a_of_type_Qjf.d;
    if (bbfd.a(BaseApplicationImpl.getContext(), paramView))
    {
      k();
    ...
    {
      paramView = bdgv.a().c(this.jdField_a_of_type_Qjf.d);
      bdgv.a().a(paramView);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 5;
      nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.jdField_a_of_type_Int).b(nmf.X).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
      return;
    }
    if (nlw.a(this.jdField_a_of_type_Qjf, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState))
    {
      i();
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 5;
      nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.jdField_a_of_type_Int).b(nmf.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
    ...
    if ((bbev.b(this.jdField_a_of_type_AndroidContentContext)) && (oat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdExtInfo))) {}
    for (;;)
    {
      for (;;)
      {
        ...
        sht.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_Pax.a(), (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mChannelID, true, null);
        nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.jdField_a_of_type_Int).b(nmf.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
        return;
        try
        {
          ...
          paramView = this.jdField_a_of_type_Qjf.d;
          i = oau.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
          if (bbfd.a(BaseApplicationImpl.getContext(), paramView))
          {
            k();
            this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 1;
      ...
      if ((i == 2) && (nlw.a(this.jdField_a_of_type_Qjf, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState)))
      {
        i();
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 5;
        nmf.a(new nyg().a(this.jdField_a_of_type_AndroidContentContext).a(nmf.jdField_a_of_type_Int).b(nmf.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
      ...
      {
        i = j;
        if (oat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdExtInfo)) {
          i = 1;
        }
      }
      if ((yyq.a()) || (i != 0)) {
        ...
        do
        {
          do
          {
            do
            {
              ...
              this.jdField_a_of_type_Qjf = qjf.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
              return true;
              bool1 = bool2;
