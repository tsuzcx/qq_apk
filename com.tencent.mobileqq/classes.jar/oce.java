  ...
  extends BaseAdapter
{
  ...
  public oce(EditVideoArtFilter paramEditVideoArtFilter, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = BitmapManager.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_AndroidContentContext.getResources(), 2130839555, this.b, this.jdField_a_of_type_Int);
