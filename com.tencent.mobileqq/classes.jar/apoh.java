...
public abstract class apoh
  extends apon
{
  private Context jdField_a_of_type_AndroidContentContext;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public apoh(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public boolean b()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (l > 0L) && (l > ((aoww)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a(bahy.a(str)).b)) {
      return true;
    }
    return l > 1048576L;
  }
