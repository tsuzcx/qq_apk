...
public class abyt
  implements Runnable
{
  public abyt(EmotionPanelViewPagerAdapter paramEmotionPanelViewPagerAdapter, int paramInt, EmotionPanelInfo paramEmotionPanelInfo, BaseEmotionAdapter paramBaseEmotionAdapter, ListView paramListView) {}
  ...
  public void run()
  {
    ...
    for (int i = this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelViewPagerAdapter.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().jdField_a_of_type_Int;; i = -1)
    {
      ...
      ThreadManager.getUIHandler().post(new abyu(this, (List)localObject));
      return;
    }
  }
}
