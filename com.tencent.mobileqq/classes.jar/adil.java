  ...
  extends adic
{
  ...
  {
    MessageForShortVideo localMessageForShortVideo = (MessageForShortVideo)bcry.a(-2022);
    ...
    for (localMessageForShortVideo.msg = bcww.b;; localMessageForShortVideo.msg = bcww.a)
    {
      ...
      try
      {
        ...
        ((antk)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(53)).a(arrayOfByte);
      }
