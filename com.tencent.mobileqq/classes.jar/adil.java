  ...
  implements adif
{
  ...
  public adil(BaseChatPie paramBaseChatPie)
  {
  ...
  private auko a(auko paramauko)
  {
    ...
    //   0	214	0	this	adil
    //   0	214	1	paramauko	auko
    //   75	47	2	i	int
    //   73	10	3	j	int
    //   54	56	4	localauko1	auko
    //   125	47	4	localException	Exception
    //   177	35	4	localObject	Object
    //   50	58	5	localauko2	auko
  ...
  public static FileManagerEntity a(azqv paramazqv)
  {
    ...
    if (apvd.a(paramazqv.jdField_b_of_type_JavaLangString))
    {
      ...
      localFileManagerEntity.nFileType = apug.a(paramazqv.g);
    ...
    for (;;)
    {
      ...
      localFileManagerEntity.strTroopFilePath = paramazqv.e;
      ...
      QLog.i("MultiFavoriteHelper", 1, "=_= create new Entity[" + localFileManagerEntity.nSessionId + "] fileName[" + paramazqv.g + "] by troop size(" + localFileManagerEntity.imgHeight + ":" + localFileManagerEntity.imgWidth + ")");
      ...
      for (int i = Integer.parseInt((String)localObject); (i == 1) || (i == 2) || (i == 3); i = -1)
      {
        ...
        for (;;)
        {
          ...
          if (i == 1)
          {
            ...
            label148:
            ((FileManagerEntity)localObject).peerNick = apug.a(paramQQAppInterface, ((FileManagerEntity)localObject).peerUin, null, ((FileManagerEntity)localObject).peerType);
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      if (paramChatMessage.isMultiMsg)
      {
        ...
        if (!myb.a(paramChatMessage))
        {
          ...
          if (TextUtils.isEmpty(str2)) {
            str1 = asua.a().a(paramChatMessage.senderuin, paramChatMessage.msgseq, paramQQAppInterface);
          }
        }
      }
      if (str1 != null)
      ...
      {
        paramQQAppInterface = asuh.a(paramChatMessage.senderuin);
      }
  ...
  private ArrayList<ChatMessage> a(MessageForStructing paramMessageForStructing, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    //   100: aload_0
    //   101: aload 7
    //   103: invokespecial 457	adil:a	(Lauko;)Lauko;
    ...
    //   348: goto -279 -> 69
    //   351: aload 7
    //   353: invokevirtual 492	com/tencent/mobileqq/data/ChatMessage:deepCopyByReflect	()Lauko;
  ...
  private void a(acup paramacup, ChatMessage paramChatMessage)
  {
    if ((paramChatMessage == null) || (paramacup == null)) {}
    for (;;)
    {
      return;
      ...
      bgqj.a().a = false;
      paramacup.a.a(paramChatMessage, paramacup).a(2131365928, this.jdField_a_of_type_AndroidContentContext, paramChatMessage);
      if (bgqj.a().a) {
        bgqj.a().a = false;
      }
      while (aibn.a().c())
  ...
  private void a(List<ChatMessage> paramList)
  {
    ...
    {
      return;
      adfy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 4);
      asua.a().b(paramList);
      if (QLog.isColorLevel()) {
    ...
    asua.a().jdField_a_of_type_Int = 6;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aeqz)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = asua.a().a();
    }
  ...
  private void a(List<ChatMessage> paramList, List<String> paramList1)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        String str = akpx.c((ChatMessage)paramList.next());
  ...
  private boolean a(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
        } while (!asuh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage));
        if (!(paramChatMessage instanceof MessageForStructing)) {
          break;
        }
      } while (((MessageForStructing)paramChatMessage).structingMsg.mMsgServiceID != 35);
      return true;
    } while (((paramChatMessage instanceof MessageForArkApp)) || (((paramChatMessage instanceof MessageForPic)) && (aezl.a((MessageForPic)paramChatMessage))));
    return true;
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, acup paramacup, MessageForStructing paramMessageForStructing)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiFavoriteHelper", 2, "onClickMultiFavoriteBtn");
    }
    int i = asua.a().c();
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C5B", "0X8009C5B", 0, i, "", "", "", "");
    if (paramMessageForStructing == null)
    {
      paramMessageForStructing = asua.a().a();
      if (paramMessageForStructing.size() == 1)
      {
        localArrayList = asuh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ArrayList)paramMessageForStructing);
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          paramMessageForStructing = (ChatMessage)localArrayList.get(0);
          a(paramacup, paramMessageForStructing);
          paramBaseChatPie.a(false, null, false);
        }
      }
    }
    while (!bgqm.a(paramMessageForStructing))
    {
      for (;;)
      {
      ...
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698475, 0).b(paramBaseChatPie.a());
      return;
    }
    paramacup = new ArrayList();
    paramacup.add(paramMessageForStructing);
    for (;;)
    {
      bgqj.a().a = true;
      if (!a(paramacup, asua.a().a()))
      {
        bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694083, 0).b(paramBaseChatPie.a());
        return;
      }
      i = a(paramacup);
      paramMessageForStructing = paramacup;
      if (i > 0)
      {
        if (paramacup.size() == i)
        {
          bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694435, 0).b(paramBaseChatPie.a());
          paramBaseChatPie.a(false, null, false);
          return;
        }
        ...
        {
          bgqm.b(paramMessageForStructing);
          a(this.jdField_a_of_type_AndroidContentContext.getString(2131693408), this.jdField_a_of_type_AndroidContentContext.getString(2131694436), new adim(this, paramacup, paramBaseChatPie));
          return;
        }
      ...
      return;
      label423:
      paramacup = paramMessageForStructing;
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, LinearLayout paramLinearLayout, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setId(2131364156);
        if (AppSetting.d) {
          this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131707006));
        }
      }
      ...
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839102);
      paramBaseChatPie.addState(new int[] { 16842919 }, (Drawable)localObject);
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839101);
  ...
  public void a(String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener)
  {
    try
    {
      bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, paramString1, "", paramString2, new adin(this, paramOnClickListener), null).show();
      return;
    }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject1 = bbcz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if ((paramArrayList != null) && (paramArrayList.size() == 1) && (bgqm.a((ChatMessage)paramArrayList.get(0))))
      {
        localObject1 = (MessageForStructing)paramArrayList.get(0);
        localObject2 = null;
        label87:
        paramArrayList = bgpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForStructing)localObject1, (List)localObject2, paramMap);
        ...
        paramArrayList = this.jdField_a_of_type_AndroidContentContext.getString(paramArrayList.getIntExtra("nReasonInt", 2131692326));
      ...
      {
        localObject1 = aanz.a((Context)localObject2, (String)localObject1, paramArrayList, paramMap, bool);
        if (localObject1 == null) {
          break;
        }
        MessageForStructing localMessageForStructing = asua.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString, (AbsStructMsg)localObject1);
      ...
      label399:
      bgpw.a(this.jdField_a_of_type_AndroidContentContext, paramMap, bool, null, false);
      return;
      label412:
