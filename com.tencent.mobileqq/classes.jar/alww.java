...
public class alww
{
  ...
  {
    return asnd.a(a(paramQQAppInterface, paramLong1, paramLong2, paramLong3), paramUinPairMsg, paramQQAppInterface);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((str != null) && (str.equals(paramString1))) {
      return alud.a(2131707016);
    }
    paramString2 = bdgc.a(paramQQAppInterface, paramString1, paramString2, 1, 0);
    if (paramString2 == paramString1)
    {
      paramQQAppInterface = ((alto)paramQQAppInterface.getManager(51)).e(paramString1);
      if (paramQQAppInterface != null) {
        return bdgc.a(paramQQAppInterface);
      }
    }
    return paramString2;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    while (localObject1 == null)
    {
      ...
      {
        localObject1 = azad.a((MessageForPtt)paramMessageRecord);
        i = ((MessageForPtt)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2007)
      {
        localObject1 = azad.a((MessageForMarketFace)paramMessageRecord);
      ...
      {
        localObject1 = azad.a((MessageForApollo)paramMessageRecord);
        i = 0;
      }
      else if ((paramMessageRecord.msgtype == -2011) || (paramMessageRecord.msgtype == -2051) || (paramMessageRecord.msgtype == -7002))
      {
        localObject1 = azad.a((MessageForStructing)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2010)
      {
        localObject1 = azad.a((MessageForFunnyFace)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2020)
      {
        localObject1 = azad.a((MessageForShakeWindow)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2022)
      {
        localObject1 = azad.a((MessageForShortVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2071)
      {
        localObject1 = azad.a((MessageForLightVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localObject1 = azad.a((ChatMessage)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5013)
      {
        localObject1 = azad.c((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localObject1 = azad.d((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5012)
      {
        localObject1 = azad.e((MessageForPoke)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5018)
      {
        localObject1 = azad.f((MessageForPokeEmo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localObject1 = azad.a((MessageForLongTextMsg)paramMessageRecord, true);
        i = 0;
      }
      ...
      {
        localObject1 = azad.a((MessageForMixedMsg)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2057)
      {
        localObject1 = azad.a((MessageForTroopStory)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7001)
      {
        localObject1 = azad.g((MessageForScribble)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localObject1 = azad.c((MessageForArkBabyqReply)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localObject1 = azad.b((MessageForArkApp)paramMessageRecord, false);
        i = 0;
      }
      else
      {
        ...
        localObject1 = azad.b((MessageForLimitChatConfirm)paramMessageRecord);
        i = 0;
      }
    }
    if (QLog.isColorLevel()) {
    ...
    do
    {
      localObject2 = apib.a(paramMessageRecord);
      ...
      localObject2 = (amqv)paramQQAppInterface.getManager(199);
      if ((localObject2 != null) && (((amqv)localObject2).a()) && (((amqv)localObject2).a() == 1L) && ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 3000)))
      {
        localObject2 = ((amqv)localObject2).a();
        if (localObject2 != null)
        {
      ...
      if (((alto)paramQQAppInterface.getManager(51)).a)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject1 = azad.a(paramQQAppInterface, paramMessageRecord, (im_msg_body.RichText)localObject1, i);
      ...
      localObject4 = (alto)paramQQAppInterface.getManager(51);
      ...
      {
        localObject3 = aoiy.b(paramMessageRecord);
    ...
    for (;;)
    {
      try
      {
        localObject2 = (String)auwq.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        k = ((Integer)auwq.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        j = ((Integer)auwq.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((j >= 0) && (k >= 0)) {
          continue;
        }
        localFriends = ((alto)localObject4).e(paramQQAppInterface.getCurrentAccountUin());
      ...
      if (paramMessageRecord.msgtype == -2011)
      {
        ...
        k = 0;
        continue;
        localObject4 = ((alto)localObject4).b(paramQQAppInterface.getCurrentAccountUin());
      ...
      if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034))
      {
        ...
        aoiy.a(localElem, paramMessageRecord);
      ...
      {
        localElem = aoiy.a(paramMessageRecord);
        if (localElem != null) {
          ((im_msg_body.RichText)localObject1).elems.add(localElem);
        }
        if (!QLog.isColorLevel()) {
      ...
      asnd.a(localElem, paramMessageRecord);
      ((im_msg_body.RichText)localObject1).elems.add(localElem);
      if (!QLog.isColorLevel()) {
        break label1061;
      }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, acjq paramacjq)
  {
    int i = 0;
    Object localObject1;
    boolean bool1;
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandlerUtils", 2, String.format("getPbSendReqFromBlessMsg, hongbao param, temp_id: %d, video_len: %d, redbag_id: %s, redbag_amount: %d, has_readbag: %d, has_video: %d", new Object[] { Long.valueOf(paramacjq.jdField_a_of_type_Long), Long.valueOf(paramacjq.jdField_b_of_type_Long), paramacjq.jdField_a_of_type_ArrayOfByte, Long.valueOf(paramacjq.c), Integer.valueOf(paramacjq.jdField_a_of_type_Int), Integer.valueOf(paramacjq.jdField_b_of_type_Int) }));
      }
      ((msg_svc.MultiMsgAssist)localObject1).uint64_temp_id.set(paramacjq.jdField_a_of_type_Long);
      ((msg_svc.MultiMsgAssist)localObject1).uint64_vedio_len.set(paramacjq.jdField_b_of_type_Long);
      ((msg_svc.MultiMsgAssist)localObject1).uint32_has_readbag.set(paramacjq.jdField_a_of_type_Int);
      if (paramacjq.jdField_a_of_type_Int == 1)
      {
        if (paramacjq.jdField_a_of_type_ArrayOfByte != null) {
          ((msg_svc.MultiMsgAssist)localObject1).bytes_redbag_id.set(ByteStringMicro.copyFrom(paramacjq.jdField_a_of_type_ArrayOfByte));
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint64_redbag_amount.set(paramacjq.c);
      }
      ((msg_svc.MultiMsgAssist)localObject1).uint32_has_vedio.set(paramacjq.jdField_b_of_type_Int);
    }
    int j = azah.a(paramMessageRecord.msgUid);
    int k = (short)(int)paramMessageRecord.msgseq;
    paramacjq = paramQQAppInterface.a().a();
    ...
    if (paramacjq != null) {
      paramArrayList.sync_cookie.set(ByteStringMicro.copyFrom(paramacjq));
    }
    if (paramArrayList != null)
    {
      i = paramArrayList.toByteArray().length;
      paramacjq = (amca)paramQQAppInterface.a(13);
      j = paramacjq.d();
    ...
    for (;;)
    {
      ...
      if ((paramArrayList.msg_body.has()) && (((im_msg_body.MsgBody)paramArrayList.msg_body.get()).rich_text.has()))
      {
        ...
        {
          paramacjq = new im_msg_body.GeneralFlags();
          localObject1 = new generalflags.ResvAttr();
          if ((!bool1) || ((j > 0) && ((i + 7 >= j) || (j <= 0))) || (paramMessageRecord.vipBubbleDiyTextId <= 0)) {
            break label1203;
          }
          j = 1;
          paramacjq.uint32_bubble_diy_text_id.set(paramMessageRecord.vipBubbleDiyTextId);
          i = j;
          if (QLog.isColorLevel()) {
      ...
      for (i = j;; i = 0)
      {
        ...
        {
          j = 1;
          paramacjq.uint32_bubble_sub_id.set(paramMessageRecord.vipSubBubbleId);
          i = j;
          if (QLog.isColorLevel())
          {
        ...
        for (;;)
        {
          ...
          {
            i = 1;
            paramacjq.bytes_pb_reserve.set(ByteStringMicro.copyFrom(((generalflags.ResvAttr)localObject1).toByteArray()));
          }
          if (i != 0)
          {
            paramMessageRecord = new im_msg_body.Elem();
            paramMessageRecord.general_flags.set(paramacjq);
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject1 = paramMessageRecord.getExtInfoFromExtStr(ayzs.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localGeneralFlags.babyq_guide_msg_cookie.set(ByteStringMicro.copyFrom(paramQQAppInterface.toByteArray()));
        return localGeneralFlags;
        paramQQAppInterface = bdeu.a(paramMessageRecord.msg);
        if (paramQQAppInterface == null) {
          continue;
        }
      ...
      if (paramPbSendMsgReq != null)
      {
        ...
        localObject2 = (amca)paramQQAppInterface.a(13);
        k = ((amca)localObject2).d();
        m = ((amca)localObject2).b();
        if (m <= 0) {
          break label3296;
        }
        localObject1 = ((BubbleManager)localObject1).a(m, false);
        if ((localObject1 != null) && ((localObject1 == null) || (((anwl)localObject1).a == null) || (((anwl)localObject1).a.size() <= 0))) {
          break label2164;
        }
      }
      label1866:
        ...
        for (j = k;; j = 0) {
          for (;;)
          {
            ...
            if ((paramMessageRecord instanceof MessageForFoldMsg))
            {
              i1 = i;
              n = j;
              if (aiul.a(paramQQAppInterface))
              {
                bool = aiul.b(paramQQAppInterface);
                localObject2 = (aiul)paramQQAppInterface.getManager(125);
                ...
                if (((MessageForFoldMsg)localObject1).redBagId != null)
                {
                  k = i;
                  m = j;
                  if (aiul.b(paramQQAppInterface))
                  {
                    n = 1;
                    i1 = 1;
                    if ((!bool) || (((aiul)localObject2).e)) {
                      break label2170;
                    }
                    i = 1;
                    label1018:
            ...
            if ((paramMessageRecord instanceof MessageForLongTextMsg))
            {
              ...
              localObject1 = ((alto)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.c());
              k = j;
              j = i;
              if (localObject1 != null)
              {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if ((k & 0x1) == 1)
                  {
                    ...
                    if (!((bcpg)paramQQAppInterface.getManager(203)).a(paramMessageRecord)) {
                      break label2338;
                    }
                    ...
                    azad.a(paramPbSendMsgReq, ((MessageForPtt)localObject1).mInputContent, ((MessageForPtt)localObject1).atInfoList);
                    i = k;
                ...
                catch (NumberFormatException localNumberFormatException)
                {
                  ...
                  {
                    k = i;
                    if (ahbf.b((MessageForPic)paramMessageRecord))
                    {
                      i = 1;
                  ...
                  catch (Exception paramQQAppInterface)
                  {
                    try
                    {
                      ...
                      localResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(bdjf.a(paramQQAppInterface.waveformArray).toByteArray()));
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localMessageRecord != null) && (localMessageRecord.msgtype == paramMessageRecord.msgtype) && (bdeu.a(localMessageRecord.msg, paramMessageRecord.msg)))
        {
          ...
          bhsm.a().h(System.currentTimeMillis() - l);
          return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 1026) || (paramMessageRecord.istroop == 3000))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            if (abti.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, false, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (abti.d(paramMessageRecord.istroop))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          localObject = ((List)localObject).iterator();
          while (((Iterator)localObject).hasNext()) {
            if (abti.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (paramMessageRecord.istroop == 7220)
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          } while (!abti.a((MessageRecord)paramQQAppInterface.next(), paramMessageRecord, true));
          if ((QLog.isColorLevel()) && (localStringBuilder != null))
          {
            localStringBuilder.append(" filterType: other");
            QLog.w("Q.msg.MessageHandlerUtils", 2, localStringBuilder.toString());
