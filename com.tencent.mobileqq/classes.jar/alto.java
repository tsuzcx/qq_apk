  ...
  implements Comparator<PhoneContact>
{
  ...
  public alto(int[] paramArrayOfInt, Set<String> paramSet, aloz paramaloz)
  {
  ...
  {
    int j = bdbt.a(paramPhoneContact.detalStatusFlag, paramPhoneContact.iTermType);
    if ((j != 6) && (j != 0)) {}
  ...
  private int c(PhoneContact paramPhoneContact1, PhoneContact paramPhoneContact2)
  {
    ...
    boolean bool1 = this.jdField_a_of_type_Aloz.a(paramPhoneContact1.unifiedCode, true);
    boolean bool2 = this.jdField_a_of_type_Aloz.a(paramPhoneContact2.unifiedCode, true);
    if (bool1) {}
    for (;;)
    {
      return i;
