...
public class bfqs
  extends Handler
{
  bfqs(bfqq parambfqq, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    paramMessage = bfqq.a(BaseApplicationImpl.getApplication(), "qzone_plugin.apk");
    int i;
    ...
    for (;;)
    {
      ...
      bfqq.a(this.a, i, bfqq.a(this.a), k);
      ...
      {
        if (j != 0) {
          bgfy.a(new CaughtQZonePluginException("start failed. " + paramMessage.getMessage()), localStringBuilder.toString());
        }
        if (i == 0) {
          break;
        }
