  ...
  implements Cloneable
{
  ...
  public SpannableStringBuilder a(int paramInt, ArticleInfo paramArticleInfo, String paramString, pyb parampyb)
  {
    return SocializeFeedsInfo.a(paramInt, paramArticleInfo, paramString, parampyb, this.jdField_a_of_type_JavaUtilList);
  }
  
  public SpannableStringBuilder a(ArticleInfo paramArticleInfo, String paramString, pyb parampyb)
  {
    return SocializeFeedsInfo.a(paramArticleInfo, paramString, parampyb, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public rgy a()
  {
    try
    {
      rgy localrgy = (rgy)super.clone();
      try
      {
        localrgy.jdField_a_of_type_JavaUtilList = new ArrayList();
        ...
        while (localIterator.hasNext())
        {
          ...
          localrgy.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo.a());
        }
        return localrgy;
      }
