...
public class apgo
  extends apgu
{
  public apgo(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (localObject != null)
      {
        localObject = (apgo)((apgj)localObject).a("android.qq.apollo.jsc820");
        if (localObject != null)
        {
          ((apgo)localObject).a(true);
  ...
  public void a(String paramString)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        if (i != 0)
        {
          alda.a(10, 201, 1001, new Object[] { "unzip jsc lib failed" });
          alfz.a = true;
        }
      }
    }
    for (;;)
    {
      ...
      label189:
      if (i != 0) {
        alda.a(10, 201, 0, new Object[] { "libjsc so download success" });
      }
      alfz.a("after_JSC_downloaded");
    }
  }
