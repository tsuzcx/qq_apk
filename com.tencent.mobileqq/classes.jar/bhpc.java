...
public class bhpc
{
  ...
  public static bhpc a()
  {
    try
    {
      if (jdField_a_of_type_Bhpc == null) {
        jdField_a_of_type_Bhpc = new bhpc();
      }
      bhpc localbhpc = jdField_a_of_type_Bhpc;
      return localbhpc;
    }
    finally {}
  }
  ...
  public long a()
  {
    try
    {
      ...
      bhzm.b("CommonDataAdapter", "get uin from app runtim succ:" + this.jdField_a_of_type_Long);
      label46:
  ...
  protected void a()
  {
    ...
    {
      bhzm.e("AppUpdate", "getPackageInfo NameNotFoundException : " + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
      bhzm.e("AppUpdate", "getPackageInfo exception : " + localException.toString());
    }
  }
  ...
  public void a(String paramString, Context paramContext, WebView paramWebView)
  {
    try
    {
      ...
      localJSONObject2.put("imei", biaq.c());
      localJSONObject2.put("imsi", biaq.d());
      localJSONObject2.put("mac_addr", biaq.a());
      localJSONObject2.put("model_info", Build.MODEL);
      localJSONObject2.put("network_type", bhzh.a(a().a()));
      localJSONObject2.put("network_operater", "");
      localJSONObject2.put("location", biaq.f());
    ...
    {
      bhzm.e("AppUpdate", "getUpdateApp parse H5 params error : " + localJSONException.toString());
      if (!paramContext.getSharedPreferences("appcenter_app_report", 0).getBoolean("is_app_last_fullReport_success", false))
      {
        bhzm.c("AppUpdate", "getUpdateApp will do full report");
        biat.a(paramContext, paramString, paramWebView, String.valueOf(a().a()), false);
        return;
      ...
      {
        bhzm.c("AppUpdate", "getUpdateApp will do incremental report");
        biat.a(paramContext, null, 0, paramString, paramWebView, String.valueOf(a().a()));
        return;
      }
      bhzm.c("AppUpdate", "getUpdateApp will get update app directly");
      biau.a(paramContext, paramWebView, paramString, true, String.valueOf(a().a()));
    }
  }
