...
public class beyf
  extends bexy
  implements atvc, bexn, IVideoOuterStatusListener
{
  private IVideoInnerStatusListener a;
  private ImageView b;
  
  beyf(Context paramContext)
  {
    super(paramContext);
  ...
  private void f()
  {
    View localView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373658);
  ...
  public void a(Context paramContext)
  {
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373655));
    this.b.setContentDescription(alud.a(2131705027));
    a(new View[] { this.b });
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(2, new beyg(this));
    }
  }
