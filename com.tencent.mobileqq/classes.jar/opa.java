  ...
  extends opc
{
  ...
  private List<pox> jdField_a_of_type_JavaUtilList;
  ...
  public opa(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  private void a(List<pox> paramList1, List<pox> paramList2)
  {
    ...
    {
      localObject1 = ((pox)paramList2.next()).jdField_a_of_type_JavaUtilList.iterator();
    ...
    {
      localObject1 = (pox)paramList2.next();
      localObject2 = ((pox)localObject1).jdField_a_of_type_JavaUtilList.iterator();
      label272:
      label285:
      label291:
      label296:
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i = 11;
          label214:
          if ((paramList1.indexOf(localObject1) != 0) || (((pox)localObject1).jdField_a_of_type_JavaUtilList.indexOf(localTabChannelCoverInfo1) >= i)) {
            break label291;
          }
          i = 1;
          label243:
  ...
  private boolean a()
  {
    ...
    this.d = 0;
    bgmq.a("UPDATE_CHANNEL_LIST_KEY_0xbbc", Boolean.valueOf(false));
    return false;
  }
  
  public static boolean a(int paramInt)
  {
    if (!((Boolean)bgmq.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(false))).booleanValue())
    {
      QLog.d("ChannelCoverInfoModule", 1, "isSupportChannelDynamicOrder, switch is off.");
      return false;
    }
    Object localObject1 = (QQAppInterface)obz.a();
    if (localObject1 != null)
    {
      localObject1 = (ohd)((QQAppInterface)localObject1).getManager(163);
      if (localObject1 != null)
      {
        localObject1 = ((ohd)localObject1).a().a();
          ...
          do
          {
            ...
            while (!((Iterator)localObject2).hasNext())
            {
              do
              {
                ...
                localObject2 = ((pox)((Iterator)localObject1).next()).jdField_a_of_type_JavaUtilList;
  ...
  private List<TabChannelCoverInfo> b(List<pox> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    int i = 0;
    ...
    {
      pox localpox = (pox)paramList.next();
      if ((localpox.jdField_a_of_type_JavaUtilList == null) || (localpox.jdField_a_of_type_JavaUtilList.isEmpty())) {
        break label129;
      }
      Iterator localIterator = localpox.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        TabChannelCoverInfo localTabChannelCoverInfo = (TabChannelCoverInfo)localIterator.next();
        localTabChannelCoverInfo.channelConfigType = localpox.jdField_a_of_type_Long;
        localTabChannelCoverInfo.seq = i;
        localArrayList.add(localTabChannelCoverInfo);
        i += 1;
      }
  ...
  private void b(boolean paramBoolean, List<TabChannelCoverInfo> paramList)
  {
    if (Looper.getMainLooper() == Looper.myLooper()) {
      ohb.a().e(paramBoolean, paramList);
    }
  ...
  private List<pox> c(List<pox> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        Object localObject = (pox)paramList.next();
        pox localpox = new pox(((pox)localObject).jdField_a_of_type_Long, ((pox)localObject).jdField_a_of_type_JavaLangString, ((pox)localObject).b);
        localObject = ((pox)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          ...
          localpox.jdField_a_of_type_JavaUtilList.add(localTabChannelCoverInfo2);
          i += 1;
        }
        localArrayList.add(localpox);
      }
    }
    return localArrayList;
  }
  ...
  private List<TabChannelCoverInfo> d(List<TabChannelCoverInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      label275:
      for (paramList = a();; paramList = ajjy.a(2131635717))
      {
        if (!bool2) {
        ...
        ((List)localObject2).add(0, new TabChannelCoverInfo(70, ajjy.a(2131635740), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
  ...
  private List<ChannelCoverInfo> e(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Atmp.a(ChannelCoverInfo.class, true, "mChannelID = ?", new String[] { String.valueOf(paramInt) }, null, null, null, null);
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          str = bcdu.d(str.toLowerCase()).toLowerCase();
      ...
      catch (Throwable localThrowable)
      {
        ...
        int i;
        int j;
        QLog.e("ChannelCoverInfoModule", 2, "requestWeiShiChannelCoverListFromServer failed for param error:" + obz.a(localThrowable));
        return;
      }
      try
      {
      ...
      a(pde.a("OidbSvc.0xbe6", 3046, 1, localReqBody.toByteArray()));
      return;
      str = babp.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty(str))
      {
        str = bcdu.d(str.replaceAll(":", "").toUpperCase()).toLowerCase();
        localPhoneInfo.bytes_muid.set(ByteStringMicro.copyFromUtf8(str));
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(51, ajjy.a(2131635746)));
    localArrayList.add(new TabChannelCoverInfo(58, ajjy.a(2131635733)));
    localArrayList.add(new TabChannelCoverInfo(59, ajjy.a(2131635732)));
    localArrayList.add(new TabChannelCoverInfo(10, ajjy.a(2131635735)));
    localArrayList.add(new TabChannelCoverInfo(52, ajjy.a(2131635748)));
    localArrayList.add(new TabChannelCoverInfo(53, ajjy.a(2131635729)));
    localArrayList.add(new TabChannelCoverInfo(9, ajjy.a(2131635739)));
    localArrayList.add(new TabChannelCoverInfo(54, ajjy.a(2131635724)));
    localArrayList.add(new TabChannelCoverInfo(55, ajjy.a(2131635726)));
    localArrayList.add(new TabChannelCoverInfo(40007, ajjy.a(2131635728)));
    return localArrayList;
  }
  ...
  private List<TabChannelCoverInfo> l()
  {
    ...
    return this.jdField_a_of_type_Atmp.a(TabChannelCoverInfo.class);
  }
  ...
  public List<TabChannelCoverInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 408	opa:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnull +36 -> 42
    //   9: aload_0
    //   10: getfield 408	opa:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   13: invokeinterface 401 1 0
    //   18: ifne +24 -> 42
    //   21: aload_0
    //   22: getfield 408	opa:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: iconst_0
    //   26: invokeinterface 255 2 0
    //   31: checkcast 268	pox
    //   34: getfield 270	pox:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_0
    //   39: monitorexit
    //   40: aload_1
  ...
  public List<TabChannelCoverInfo> a(int paramInt)
  {
    ...
    //   19: checkcast 268	pox
    //   22: getfield 270	pox:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_2
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    for (Object localObject = paramTabChannelCoverInfo.toString();; localObject = "null")
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (a(paramTabChannelCoverInfo, ((pox)((Iterator)localObject).next()).jdField_a_of_type_JavaUtilList)) {
  ...
  public void a(List<channel_button.Section> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        pox localpox = new pox(localSection);
        localJSONArray.put(localpox.a());
        localpox.jdField_a_of_type_JavaUtilList = pdb.b(localSection.rpt_msg_channel.get());
        this.jdField_a_of_type_JavaUtilList.add(localpox);
      }
  ...
  public void a(List<pox> paramList, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (pox)((Iterator)localObject1).next();
        a(((pox)localObject2).jdField_a_of_type_JavaUtilList, "0xbbc update sectionId=" + ((pox)localObject2).jdField_a_of_type_Long);
      }
    }
    ...
    {
      pox localpox = (pox)localIterator1.next();
      channel_button.Section localSection = new channel_button.Section();
      ArrayList localArrayList = new ArrayList();
      if (localpox.jdField_a_of_type_JavaUtilList != null)
      {
        Iterator localIterator2 = localpox.jdField_a_of_type_JavaUtilList.iterator();
      ...
      {
        localSection.uint64_section_id.set(localpox.jdField_a_of_type_Long);
        localSection.str_section_name.set(localpox.jdField_a_of_type_JavaLangString);
        localSection.str_note_text.set(localpox.b);
    ...
    {
      localObject2 = bcdu.d(((String)localObject2).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      a(pde.a("OidbSvc.0xbbc", 3004, 1, ((oidb_cmd0xbbc.ReqBody)localObject1).toByteArray()));
      bgmq.a("UPDATE_CHANNEL_LIST_KEY_0xbbc", Boolean.valueOf(true));
      return;
      localObject2 = babp.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        localObject2 = bcdu.d(((String)localObject2).replaceAll(":", "").toUpperCase()).toLowerCase();
        paramList.bytes_muid.set(ByteStringMicro.copyFromUtf8((String)localObject2));
  ...
  public void a(List<pox> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((pox)paramList.get(0)).jdField_a_of_type_JavaUtilList = d(((pox)paramList.get(0)).jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_JavaUtilList = c(paramList);
      paramList = b(this.jdField_a_of_type_JavaUtilList);
      if (paramBoolean) {
        b(true, ((pox)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaUtilList);
      }
      if (!QLog.isColorLevel()) {
        break label193;
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(70, ajjy.a(2131635731), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
    localArrayList.add(new TabChannelCoverInfo(0, ajjy.a(2131635730), 4, "https://p.qpic.cn/kandianac/0/9558fc75932c5.png/0"));
    TabChannelCoverInfo localTabChannelCoverInfo = new TabChannelCoverInfo(56, ajjy.a(2131635741));
    localTabChannelCoverInfo.reason = 4;
    localTabChannelCoverInfo.mChannelType = 3;
    localArrayList.add(localTabChannelCoverInfo);
    localArrayList.add(new TabChannelCoverInfo(40531, ajjy.a(2131635743)));
    localArrayList.add(new TabChannelCoverInfo(14, ajjy.a(2131635727)));
    localArrayList.add(new TabChannelCoverInfo(8, ajjy.a(2131635745)));
    localArrayList.add(new TabChannelCoverInfo(1, ajjy.a(2131635734)));
    localArrayList.add(new TabChannelCoverInfo(13, ajjy.a(2131635720)));
    localArrayList.add(new TabChannelCoverInfo(5, ajjy.a(2131635750)));
    localArrayList.add(new TabChannelCoverInfo(11, ajjy.a(2131635719)));
    localArrayList.add(new TabChannelCoverInfo(40466, ajjy.a(2131635744)));
    localArrayList.add(new TabChannelCoverInfo(40013, ajjy.a(2131635742)));
    localArrayList.add(new TabChannelCoverInfo(16, ajjy.a(2131635737)));
    localArrayList.add(new TabChannelCoverInfo(15, ajjy.a(2131635723)));
    return localArrayList;
  }
  ...
  public void b()
  {
    ...
    //   15: ldc 48
    //   17: iconst_0
    //   18: invokestatic 312	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   21: invokestatic 323	bgmq:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   24: checkcast 309	java/lang/Boolean
    //   27: invokevirtual 326	java/lang/Boolean:booleanValue	()Z
    //   30: ifeq +29 -> 59
    //   33: aload_0
    //   34: invokespecial 931	opa:a	()Z
    //   37: ifeq +22 -> 59
    //   40: ldc 60
    //   42: iconst_2
    //   43: ldc_w 933
    ...
    //   49: aload_0
    //   50: aload_0
    //   51: getfield 408	opa:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   54: iconst_3
    //   55: invokevirtual 935	opa:a	(Ljava/util/List;I)V
    //   58: return
    //   59: getstatic 938	nia:a	Z
    //   62: ifeq +13 -> 75
    //   65: ldc 60
    //   67: iconst_2
    //   68: ldc_w 940
    ...
    //   74: return
    //   75: invokestatic 945	java/lang/System:currentTimeMillis	()J
    //   78: ldc2_w 946
    //   81: ldiv
    //   82: aload_0
    //   83: getfield 948	opa:jdField_a_of_type_Long	J
    //   86: lcmp
    //   87: iflt -29 -> 58
    //   90: new 950	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody
    //   93: dup
    //   94: invokespecial 951	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:<init>	()V
    //   97: astore_2
    //   98: aload_2
    //   99: getfield 954	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:bytes_city	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   102: invokestatic 957	akfu:a	()Ljava/lang/String;
    //   105: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   108: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   111: aload_2
    //   112: getfield 960	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:str_city	Lcom/tencent/mobileqq/pb/PBStringField;
    //   115: invokestatic 962	akfu:b	()Ljava/lang/String;
    //   118: invokevirtual 628	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   121: aload_0
    //   122: getfield 616	opa:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   125: checkcast 106	com/tencent/mobileqq/app/QQAppInterface
    //   128: bipush 51
    //   130: invokevirtual 337	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   133: checkcast 964	ajjj
    //   136: aload_0
    //   137: getfield 616	opa:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   140: checkcast 106	com/tencent/mobileqq/app/QQAppInterface
    //   143: invokevirtual 965	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   146: invokevirtual 968	ajjj:c	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   149: astore_3
    //   150: aload_3
    //   151: ifnull +25 -> 176
    //   154: aload_2
    //   155: getfield 971	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:uint32_age	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   158: aload_3
    //   159: getfield 976	com/tencent/mobileqq/data/Friends:age	I
    //   162: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   165: aload_2
    //   166: getfield 979	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:uint32_sex	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   169: aload_3
    //   170: getfield 983	com/tencent/mobileqq/data/Friends:gender	B
    //   173: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   176: new 985	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo
    //   179: dup
    //   180: invokespecial 986	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:<init>	()V
    //   183: astore_3
    //   184: invokestatic 531	obz:f	()Ljava/lang/String;
    //   187: astore 4
    //   189: aload 4
    //   191: invokestatic 480	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   194: ifne +329 -> 523
    //   197: aload 4
    //   199: invokevirtual 534	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   202: astore 4
    //   204: aload 4
    //   206: invokestatic 539	bcdu:d	(Ljava/lang/String;)Ljava/lang/String;
    //   209: invokevirtual 534	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   212: astore 4
    //   214: aload_3
    //   215: getfield 987	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   218: aload 4
    //   220: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   223: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   226: aload_3
    //   227: getfield 988	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   230: iconst_1
    //   231: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   234: invokestatic 566	myn:a	()I
    //   237: istore_1
    //   238: aload_3
    //   239: getfield 989	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_conn	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   242: iload_1
    //   243: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   246: invokestatic 573	babp:e	()I
    //   249: istore_1
    //   250: aload_3
    //   251: getfield 990	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_carrier	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   254: iload_1
    //   255: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   258: invokestatic 578	babp:e	()Ljava/lang/String;
    //   261: astore 4
    //   263: aload_3
    //   264: getfield 991	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_os_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   267: aload 4
    //   269: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   272: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   275: invokestatic 583	babp:c	()Ljava/lang/String;
    //   278: astore 4
    //   280: aload_3
    //   281: getfield 992	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_qq_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   284: aload 4
    //   286: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   289: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   292: invokestatic 589	com/tencent/common/config/AppSetting:a	()I
    //   295: istore_1
    //   296: aload_3
    //   297: getfield 993	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_appid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   300: iload_1
    //   301: invokestatic 514	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   304: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   307: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   310: invokestatic 597	dp:a	()J
    //   313: invokestatic 600	dp:a	(J)Ljava/lang/String;
    //   316: astore 4
    //   318: aload_3
    //   319: getfield 994	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_client_ip	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   322: aload 4
    //   324: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   327: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   330: aload_3
    //   331: getfield 995	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_os_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   334: iconst_2
    //   335: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   338: aload_2
    //   339: getfield 998	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:msg_phone_type	Ltencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo;
    //   342: aload_3
    //   343: iconst_1
    //   344: invokevirtual 999	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;Z)V
    //   347: invokestatic 1000	ogy:a	()Logy;
    //   350: invokevirtual 1003	ogy:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule;
    //   353: astore_3
    //   354: aload_3
    //   355: ifnull +132 -> 487
    //   358: aload_3
    //   359: invokevirtual 1008	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData;
    //   362: astore_3
    ...
    //   385: aload_3
    //   386: invokevirtual 1013	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   389: invokevirtual 126	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   392: invokestatic 417	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   395: aload_3
    //   396: ifnull +91 -> 487
    //   399: aload_3
    //   400: getfield 1018	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:city	Ljava/lang/String;
    //   403: invokestatic 480	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   406: ifne +81 -> 487
    //   409: new 1020	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo
    //   412: dup
    //   413: invokespecial 1021	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:<init>	()V
    //   416: astore 4
    //   418: aload 4
    //   420: getfield 1022	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_city	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   423: aload_3
    //   424: getfield 1018	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:city	Ljava/lang/String;
    //   427: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   430: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   433: aload 4
    //   435: getfield 1025	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_province	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   438: aload_3
    //   439: getfield 1028	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:province	Ljava/lang/String;
    //   442: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   445: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   448: aload 4
    //   450: getfield 1031	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_country	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   453: aload_3
    //   454: getfield 1034	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:country	Ljava/lang/String;
    //   457: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   460: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   463: aload 4
    //   465: getfield 1037	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_city_code	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   468: aload_3
    //   469: getfield 1040	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:cityCode	Ljava/lang/String;
    //   472: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   475: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   478: aload_2
    //   479: getfield 1044	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:msg_location_info	Ltencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo;
    //   482: aload 4
    //   484: invokevirtual 1047	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   487: aload_0
    //   488: ldc_w 1049
    //   491: sipush 3003
    //   494: iconst_1
    //   495: aload_2
    //   496: invokevirtual 1050	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:toByteArray	()[B
    //   499: invokestatic 639	pde:a	(Ljava/lang/String;II[B)Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   502: invokevirtual 642	opa:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   505: return
    //   506: astore 4
    //   508: aload_3
    //   509: getfield 987	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   512: ldc 181
    //   514: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   517: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   520: goto -294 -> 226
    //   523: invokestatic 648	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   526: invokestatic 651	babp:c	(Landroid/content/Context;)Ljava/lang/String;
    //   529: astore 4
    //   531: aload 4
    //   533: invokestatic 480	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   536: ifne -302 -> 234
    //   539: aload 4
    //   541: ldc_w 653
    //   544: ldc 181
    //   546: invokevirtual 656	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   549: invokevirtual 659	java/lang/String:toUpperCase	()Ljava/lang/String;
    //   552: invokestatic 539	bcdu:d	(Ljava/lang/String;)Ljava/lang/String;
    //   555: invokevirtual 534	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   558: astore 4
    //   560: aload_3
    //   561: getfield 987	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   564: aload 4
    //   566: invokestatic 549	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   569: invokevirtual 554	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   572: aload_3
    //   573: getfield 988	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   576: iconst_3
    //   577: invokevirtual 563	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   580: goto -346 -> 234
    //   583: astore 4
    //   585: iconst_0
    //   586: istore_1
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localObject = pde.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      if (paramInt != 0) {
        break label247;
      }
  ...
  public void b(List<oidb_cmd0x69f.ChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo1 = pdb.a((oidb_cmd0x69f.ChannelInfo)paramList.next(), paramInt);
  ...
  public List<pox> c()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      Object localObject2 = bace.a(new File(BaseApplicationImpl.getApplication().getDir("readinjoy", 0).getAbsolutePath() + "/channel_section_data"));
        ...
        try
        {
          ...
          while (i < ((JSONArray)localObject2).length())
          {
            ...
            if (localJSONObject != null) {
              localArrayList.add(new pox(localJSONObject));
            }
            i += 1;
          }
        }
  ...
  public void c()
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new pox(TabChannelCoverInfo.TYPE_CHANNEL_MY_CONFIG, ajjy.a(2131635718), ajjy.a(2131635722)));
        this.jdField_a_of_type_JavaUtilList.add(new pox(TabChannelCoverInfo.TYPE_CHANNEL_RECOMMEND_CONFIG, ajjy.a(2131635725), ajjy.a(2131635736)));
      }
  ...
  {
    int i = pde.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbbc.RspBody());
  ...
  public void c(List<oidb_cmd0xbe6.MsgChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo = pdb.a((oidb_cmd0xbe6.MsgChannelInfo)paramList.next(), paramInt);
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pde.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    if (QLog.isColorLevel()) {
