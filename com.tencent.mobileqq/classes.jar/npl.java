  ...
  implements View.OnClickListener, AbsListView.OnScrollListener
{
  ...
  private ndm jdField_a_of_type_Ndm = new npm(this);
  ...
  public npl(Activity paramActivity, QQAppInterface paramQQAppInterface, SwipListView paramSwipListView, View paramView, String paramString)
  {
    ...
    this.b = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296619);
    this.c = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296618);
    e();
    a(this);
  }
  ...
  private void f()
  {
    ...
    this.d = this.e;
    this.jdField_a_of_type_Boolean = true;
    localncz.a(this.jdField_a_of_type_JavaLangString, this.d, 2);
  }
  ...
  public void d()
  {
    ...
    if (localncz != null) {
      localncz.a(this.jdField_a_of_type_JavaLangString, 0, 2);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558761, null);
      paramView = new npo();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363295));
      paramView.b = ((TextView)localView.findViewById(2131363296));
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131363294));
      localView.setTag(paramView);
      localView.setOnClickListener(this);
      localView.setOnTouchListener(new npn(this));
    ...
    for (Object localObject1 = (RoomInfo)localObject1;; localObject1 = null)
    {
      ...
      {
        localObject2 = new StringBuilder(nqf.a(((RoomInfo)localObject1).id));
        if (((StringBuilder)localObject2).length() == 9)
        {
          ((StringBuilder)localObject2).insert(6, "-");
          ((StringBuilder)localObject2).insert(3, "-");
        }
        localObject2 = this.jdField_a_of_type_AndroidAppActivity.getString(2131690436) + " " + ((StringBuilder)localObject2).toString();
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
        localObject2 = String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131690435), new Object[] { Integer.valueOf(((RoomInfo)localObject1).players.size()) });
      ...
      return localView;
      localObject1 = (npo)paramView.getTag();
      localView = paramView;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      return;
    } while (!(localObject instanceof npo));
    localObject = ((npo)localObject).jdField_a_of_type_ComTencentAvgameGamelogicDataRoomInfo;
    ncz localncz = (ncz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.AV_GAME_MANAGER);
    if (localncz != null) {
      localncz.a(this.jdField_a_of_type_AndroidAppActivity, 5, String.valueOf(((RoomInfo)localObject).id), this.jdField_a_of_type_JavaLangString);
    }
    if (this.jdField_a_of_type_JavaLangString != null) {}
    for (localObject = this.jdField_a_of_type_JavaLangString;; localObject = "")
    {
      bdla.b(null, "dc00898", "", "", "0X800B01C", "0X800B01C", 0, 0, "", "", (String)localObject, "");
      break;
    }
  }
