...
public class npl
{
  private static volatile npl jdField_a_of_type_Npl;
  ...
  public static npl a()
  {
    if (jdField_a_of_type_Npl == null) {}
    try
    {
      if (jdField_a_of_type_Npl == null) {
        jdField_a_of_type_Npl = new npl();
      }
      return jdField_a_of_type_Npl;
    }
    finally {}
  }
  ...
  public static String b()
  {
    try
    {
      String str = obz.a().a("ad_mengceng", String.valueOf(1)).a();
      return str;
    }
  ...
  public MaterialData a()
  {
    ...
    Iterator localIterator = nof.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(2).iterator();
  ...
  public String a()
  {
    ...
    String str = nof.a((QQAppInterface)localObject1).a(String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.h), String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdAid));
    ...
    {
      nof.a((QQAppInterface)localObject1).a(String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.h), String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdAid));
      return "";
    }
    Object localObject3 = new StringBuffer();
    ew.a((StringBuffer)localObject3, ((File)localObject2).getPath());
  ...
  public ArrayList a()
  {
    Object localObject = nof.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(2);
  ...
  public void a(int paramInt)
  {
    ...
    if ((paramInt == 4) && (this.jdField_a_of_type_Nqh != null) && (this.jdField_a_of_type_Nqh.a())) {
  ...
  {
    if ((!npj.m(paramAdvertisementInfo)) || (!e()) || (!c())) {
      return;
    }
  ...
  public void a(boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_Nqh != null) && (this.jdField_a_of_type_Nqh.a())) {
      this.jdField_a_of_type_Nqh.a(paramBoolean);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo != null)) {
      nbe.a(new nmv().a(BaseApplication.getContext()).a(nbe.jdField_b_of_type_Int).b(nbe.an).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).e(new JSONObject()).a());
    }
  }
  ...
  public void b(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo != null))
    {
      if (paramInt == 1)
      {
        ...
        ndn.a(null, "", "0X8009819", "0X8009819", 0, 0, "", "", "", b(), false);
      }
    }
    else {
      return;
    ...
    try
    {
      ...
      if ((paramInt == nbe.jdField_a_of_type_Int) || (paramInt == nbe.B))
      {
        ...
        nbe.a(new nmv().a(BaseApplication.getContext()).a(paramInt).b(nbe.an).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).e(localJSONObject1).a());
        return;
      }
    }
    catch (JSONException localJSONException)
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Nqh != null) {
      this.jdField_a_of_type_Nqh = null;
    }
  }
  
  public boolean d()
  {
    return baig.az(BaseApplicationImpl.getApplication(), BaseApplicationImpl.getApplication().getRuntime().getAccount()) == 1;
  }
}
