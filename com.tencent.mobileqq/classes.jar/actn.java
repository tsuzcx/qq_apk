...
public final class actn
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new acto();
  ...
  public static int a(axwe paramaxwe, String paramString)
  {
    paramaxwe = paramaxwe.a(paramString);
    ...
    do
    {
      ...
      try
      {
        int i1 = Integer.parseInt(paramaxwe);
        return i1;
      }
  ...
  public static final void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, acut paramacut, ChatMessage paramChatMessage)
  {
    int i4 = 0;
    Object localObject;
    boolean bool;
    if (acqz.jdField_a_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (acqz.jdField_a_of_type_Boolean)
        {
          acqz.jdField_a_of_type_Int = i1;
          if (acqz.jdField_a_of_type_Int == -1) {
            acqz.jdField_a_of_type_Int = 0;
          }
          if (acqz.jdField_a_of_type_Int > 0) {
            break label153;
          }
          return;
          label133:
    ...
    if (paramChatMessage == null)
    {
      ...
      if (paramacut != null)
      {
        ...
        if (paramacut.size() > 0)
        {
          ...
          i1 = acqz.jdField_a_of_type_Int;
          if (i2 <= i1) {
            break label296;
          }
          label210:
          if (!(paramBaseChatPie instanceof aerv)) {
            break label349;
          }
        }
      }
    ...
    for (int i2 = 1;; i2 = 0)
    {
      ...
      if (i3 > -1)
      {
        paramBaseChatPie = (ChatMessage)paramacut.get(i3);
        if (i2 == 0) {
          break label303;
        }
        if (!acqz.a(paramBaseChatPie)) {
          break label323;
        }
        i1 = 1;
      }
      for (;;)
      {
        ...
        ((WebProcessManager)paramQQAppInterface.getManager(13)).a(1, new actp());
        return;
        i1 = 10;
        break;
        i1 = i2;
        break label210;
        if ((!paramBaseChatPie.isread) && (acqz.a(paramBaseChatPie)))
        {
          i1 = 1;
        }
        else
  ...
  private static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    try
    {
      ...
      if (i1 == -1)
      {
        bcpw.a(paramBaseActivity, paramBaseActivity.getString(2131719538), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      if (paramIntent.hasExtra("account"))
      {
        axqw.b(paramQQAppInterface, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "1", "", "", "");
        if (!((ajxn)paramQQAppInterface.getManager(51)).b(str))
        {
      ...
      if ((paramIntent.getBooleanExtra("shortcut", false)) && (!((ajxn)paramQQAppInterface.getManager(51)).b(str)))
      {
        bcpw.a(paramBaseActivity.getApplicationContext(), paramBaseActivity.getString(2131719539), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      return true;
    }
  ...
  {
    bbjv.a(null, "AIO_doOnCreate_BeforeEnterCost");
    ...
    do
    {
      do
      {
        ...
        return true;
        if (!wxb.a().a(paramIntent, paramBaseActivity, paramQQAppInterface)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    label212:
    bbjv.a("AIO_doOnCreate_BeforeEnterCost", null);
    return false;
  }
