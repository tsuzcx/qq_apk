...
{
  private static bdpr jdField_a_of_type_Bdpr;
  ...
  private bdpr(String paramString)
  {
    super(paramString);
  }
  ...
  public static bdpr a()
  {
    try
    {
      if (jdField_a_of_type_Bdpr == null) {
        jdField_a_of_type_Bdpr = new bdpr("VasApngIPCModule");
      }
      bdpr localbdpr = jdField_a_of_type_Bdpr;
      return localbdpr;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (bdkd.a(str2, str1, "libAPNG_release_813.so"))
      {
  ...
  public void a(URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    QIPCClientHelper.getInstance().callServer("VasApngIPCModule", jdField_a_of_type_JavaLangString, null, new bdps(this, paramURLDrawableHandler));
  }
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          if (new File(str).exists())
          {
            ...
            catch (Throwable localThrowable)
            {
              ...
              azmj.b(null, "CliOper", "", "", "Font_Mall", "0X80073FE", 0, 0, "101", "", "", "");
              break label206;
            }
          }
