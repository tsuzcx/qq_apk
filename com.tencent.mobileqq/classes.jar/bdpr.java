  ...
  extends bdnw
{
  ...
  public bdpr()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bdpu(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (i > 1) {
      if (j == 0)
      {
        paramContext.setBackgroundResource(2130838342);
        i = 0;
      }
    }
    for (;;)
    {
      paramContext.setTag(2131378124, Integer.valueOf(i));
      ...
      if ((!b()) || ((b()) && (a())))
      {
        ...
        paramContext.setOnLongClickListener(new bdps(this));
        paramContext.setOnTouchListener(new bdpt(this));
        return paramContext;
        if (j == i - 1)
        {
          paramContext.setBackgroundResource(2130838346);
          i = 2;
        }
        else
        {
          paramContext.setBackgroundResource(2130838344);
          i = 1;
        }
      }
      else
  ...
  public void a(String paramString, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    try
    {
      ...
      if ((i != 23001027) && (i != 0) && (i != -4) && (i != -6))
      {
        ...
        if (!((aktz)paramString.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).a(paramMessageRecord.frienduin))
        {
          j = 1;
          i = -4;
          if (j != 0) {
