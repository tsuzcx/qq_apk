...
public class sbq
  extends BaseAdapter
  implements rxx<ObservableArrayList<ResultRecord>>
{
  ...
  public sbq(@NonNull ObservableArrayList<ResultRecord> paramObservableArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      int i = getCount();
      localObject1 = paramView.findViewById(2131368623);
    ...
    for (;;)
    {
      ...
      return paramView;
      paramView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560321, paramViewGroup, false);
      localObject1 = (ReadInJoyHeadImageView)paramView.findViewById(2131368622);
