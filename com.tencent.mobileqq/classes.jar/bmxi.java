  ...
  extends bmxd<bmwn, bmwn>
{
  ...
  public bmxi(@NonNull EditVideoParams paramEditVideoParams)
  {
  ...
  protected void a(JobContext paramJobContext, bmwn parambmwn)
  {
    ...
    PublishVideoEntry localPublishVideoEntry = parambmwn.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry;
    ...
    localPublishVideoEntry.videoUploadTempDir = parambmwn.jdField_b_of_type_JavaLangString;
    ...
    if ((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource))
    {
      ...
      paramJobContext = (EditTakeVideoSource)parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
      ...
      for (localPublishVideoEntry.videoHeight = paramJobContext.a();; localPublishVideoEntry.videoHeight = paramJobContext.b())
      {
        ...
        if ((localPublishVideoEntry.saveMode != 5) || (xmx.c(localPublishVideoEntry.mIFrameVideoPath))) {
          break;
        }
      ...
      i = 1;
      if (i != 0) {
        bncp.a().a(localPublishVideoEntry);
      }
      wsv.d("Q.qqstory.publish.edit.PublishVideoSegment", "publish : edit source = %s", new Object[] { parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource });
      ...
      localPublishVideoEntry.putExtra("composite_key_merge_thumb_cost", Long.valueOf(System.currentTimeMillis() - parambmwn.jdField_a_of_type_Long));
      if (this.a.a() == 14) {
    ...
    else if ((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))
    {
      localPublishVideoEntry.isPicture = false;
      if (this.a.a("extra_is_slide_show_video", false))
      {
        ...
        localObject2 = (EditLocalVideoSource)parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
    ...
    for (;;)
    {
      ...
      if ((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditRecordVideoSource))
      {
        localPublishVideoEntry.isPicture = false;
        localPublishVideoEntry.isLocalPublish = false;
        paramJobContext = (EditRecordVideoSource)parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
        localPublishVideoEntry.mLocalRawVideoDir = paramJobContext.a();
      ...
      if (((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakePhotoSource)) || ((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalPhotoSource)))
      {
        localPublishVideoEntry.isPicture = true;
        paramJobContext = parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
        if ((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalPhotoSource))
        {
          localObject1 = (EditLocalPhotoSource)parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
          localPublishVideoEntry.isLocalPublish = true;
        ...
        for (;;)
        {
          ...
          if ((parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakePhotoSource)) {
            localPublishVideoEntry.mLocalRawPicPath = parambmwn.jdField_a_of_type_Bmwt.a;
          }
      ...
      for (;;)
      {
        localPublishVideoEntry.mLocalRawVideoDir = paramJobContext;
        break;
        super.notifyError(new ErrorMessage(-1, "illegal argument " + parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource));
        return;
        if (localPublishVideoEntry.thumbPath != null)
        {
        ...
        i = 0;
        if (parambmwn.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.saveMode != 0) {
          i = 1;
        }
        if (parambmwn.jdField_b_of_type_Boolean) {
          i = 1;
        }
        ...
        for (;;)
        {
          ...
          for (int m = 1;; m = 0)
          {
            parambmwn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoPublishPublishParam = new PublishParam(paramJobContext, (String)localObject1, (String)localObject2, str1, str2, str3, n, i1, l, i2, i3, i, i4, i5, str4, str5, j, k, m, localPublishVideoEntry.mLocalRawVideoDir, localPublishVideoEntry.mAudioFilePath, localPublishVideoEntry.mIFrameVideoPath, localPublishVideoEntry.mosaicPath, parambmwn.jdField_b_of_type_Int, localPublishVideoEntry.isLocalPublish, localPublishVideoEntry.videoLocationDescription, localPublishVideoEntry.videoLongitude, localPublishVideoEntry.videoLatitude, localPublishVideoEntry.redBagType, localPublishVideoEntry.specialVideoType);
