  ...
  implements Manager
{
  ...
  private SosoInterface.OnLocationListener jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new amzr(this, 3, true, true, 60000L, false, false, "TroopNotifyAndRecommendView");
  ...
  public amzp(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong, oidb_0x935.RspBody paramRspBody)
  {
    ...
    this.jdField_a_of_type_Anca.notifyUI(29, true, this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      localObject1 = new NewIntent(paramAppInterface.getApplication(), nma.class);
  ...
  private void e()
  {
    ...
    try
    {
      ...
      Object localObject = (apus)apub.a().a(691);
      if ((localObject == null) || (!((apus)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
      {
        ...
        localObject = (amzo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
        MessageRecord localMessageRecord = a();
        if ((localMessageRecord != null) && (!((amzo)localObject).a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, localMessageRecord.time))) {
          ((amzo)localObject).a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, amtj.a(2131690989), localMessageRecord.time, localMessageRecord.time);
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt1, oidb_0x935.GPS paramGPS, int paramInt2, BusinessObserver paramBusinessObserver)
  {
    ...
    for (long l1 = ((Long)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1)).longValue();; l1 = 0L)
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), nma.class);
  ...
  {
    a(2, paramGPS, paramInt, new amzq(this, paramLong));
  }
