  ...
  extends anpi
{
  ...
  public anpf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(XmlData paramXmlData)
  {
    ...
    try
    {
      ...
      if (((SharedPreferences)localObject1).getBoolean(jdField_a_of_type_JavaLangString, true))
      {
        ...
        localObject1 = new File(albz.a() + File.separator).listFiles();
        ...
        while (i < j)
        {
          ...
          if ((localObject2.isFile()) && (localObject2.getName().startsWith("libArMapEngine")) && (!localObject2.getName().contains(albz.jdField_a_of_type_JavaLangString)))
          {
            localObject2.delete();
            if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        str = BaseApplicationImpl.sApplication.getSharedPreferences("mobileQQ", 0).getString("ar_native_" + albz.jdField_a_of_type_JavaLangString, "");
        if (!TextUtils.isEmpty(str))
        {
          ...
          localObject = "0";
          axqw.b(localQQAppInterface, "dc01440", "", "", "0X8007A3D", "0X8007A3D", 0, 0, "", String.valueOf(i), (String)localObject, jdField_a_of_type_JavaLangString);
          ...
          axrl.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "armap_so_update_rate", true, 0L, 0L, (HashMap)localObject, "", false);
        }
      }
      catch (Exception localException)
      {
