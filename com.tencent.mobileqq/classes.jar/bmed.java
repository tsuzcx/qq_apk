...
public class bmed
  extends bmiv
{
  public bmed(@NonNull bmix parambmix)
  {
    super(parambmix);
  }
  ...
  public void a(int paramInt, @NonNull bmwn parambmwn)
  {
    ...
    //   1: iload_1
    //   2: aload_2
    //   3: invokespecial 17	bmiv:a	(ILbmwn;)V
    //   6: invokestatic 22	bncp:a	()Lbncp;
    //   9: invokestatic 22	bncp:a	()Lbncp;
    //   12: invokevirtual 26	bncp:c	()I
    //   15: invokevirtual 29	bncp:a	(I)Ldov/com/qq/im/capture/data/QIMFilterCategoryItem;
    //   18: astore 5
    //   20: invokestatic 22	bncp:a	()Lbncp;
    //   23: invokestatic 22	bncp:a	()Lbncp;
    //   26: invokevirtual 26	bncp:c	()I
    //   29: invokevirtual 32	bncp:b	(I)Ldov/com/qq/im/capture/data/QIMFilterCategoryItem;
    //   32: astore 6
    //   34: invokestatic 37	blmf:a	()Lblmf;
    //   37: bipush 8
    //   39: invokevirtual 40	blmf:c	(I)Lbllx;
    //   42: checkcast 42	blpo
    //   45: invokevirtual 45	blpo:a	()Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;
    //   48: astore 4
    ...
    //   60: ifnull +96 -> 156
    //   63: aload_2
    //   64: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   70: ifnonnull +17 -> 87
    //   73: aload_2
    //   74: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   87: aload_2
    //   88: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   102: aload_2
    //   103: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   125: ifne +207 -> 332
    //   128: aload_3
    //   129: getstatic 91	vcb:B	Ljava/lang/String;
    //   132: aload 5
    ...
    //   140: pop
    //   141: aload_2
    //   142: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   177: ifne +85 -> 262
    //   180: aload_2
    //   181: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   190: aload_2
    //   191: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   204: aload_2
    //   205: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   219: aload_2
    //   220: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   234: aload_2
    //   235: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   249: aload_3
    //   250: getstatic 116	vcb:z	Ljava/lang/String;
    //   253: aload 6
    ...
    //   275: ifne +16 -> 291
    //   278: aload_3
    //   279: getstatic 124	vcb:A	Ljava/lang/String;
    //   282: aload 4
    ...
    //   291: aload_0
    //   292: ldc 126
    //   294: invokevirtual 129	bmed:a	(Ljava/lang/Class;)Lbmiw;
    //   297: checkcast 126	bmee
    //   300: astore 4
    //   302: aload 4
    //   304: ifnull +13 -> 317
    //   307: aload 4
    ...
    //   340: ifne -184 -> 156
    //   343: aload_3
    //   344: getstatic 91	vcb:B	Ljava/lang/String;
    //   347: aload 5
    ...
    //   355: pop
    //   356: aload_2
    //   357: getfield 55	bmwn:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   381: invokevirtual 153	dov/com/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout:a	()Lbmlu;
    //   384: astore 5
    //   386: ldc 155
    //   388: getstatic 158	blmo:b	Ljava/lang/String;
    //   391: invokevirtual 164	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   394: ifeq +16 -> 410
    //   397: aload 5
    //   399: ifnull +24 -> 423
    //   402: aload 5
    //   404: invokevirtual 168	bmlu:a	()Z
    //   407: ifne +16 -> 423
    //   410: aload_3
    //   411: getstatic 171	vcb:y	Ljava/lang/String;
    //   414: ldc 172
    //   416: invokestatic 177	alpo:a	(I)Ljava/lang/String;
    ...
    //   441: ifne +13 -> 454
    //   444: aload_3
    //   445: getstatic 181	vcb:x	Ljava/lang/String;
    //   448: aload 4
    ...
    //   461: ldc 187
    //   463: aload_3
    //   464: invokestatic 192	wsv:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   467: aload_2
    //   468: getfield 195	bmwn:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   471: ldc 197
    //   473: aload_3
