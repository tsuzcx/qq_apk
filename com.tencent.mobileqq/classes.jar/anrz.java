...
public class anrz
  extends anqm<CameraEmotionData>
{
  private boolean a;
  private boolean b;
  ...
  private CameraEmotionData a(ajti paramajti, int paramInt)
  {
    if ((paramajti == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return null;
    }
    ...
    localCameraEmotionData.resid = paramajti.a;
    localCameraEmotionData.strContext = paramajti.b;
    if (bbjw.a(paramajti.d)) {}
    for (localCameraEmotionData.md5 = anrp.a(paramajti.a);; localCameraEmotionData.md5 = paramajti.d)
    {
      localCameraEmotionData.url = paramajti.jdField_c_of_type_JavaLangString;
  ...
  public anyc a(CameraEmotionData paramCameraEmotionData)
  {
    anxq localanxq = new anxq();
    localanxq.jdField_c_of_type_Int = 11;
    localanxq.d = a(paramCameraEmotionData);
    localanxq.a = paramCameraEmotionData.strContext;
    localanxq.e = paramCameraEmotionData.url;
    localanxq.jdField_g_of_type_Int = paramCameraEmotionData.emoId;
    localanxq.jdField_c_of_type_JavaLangString = paramCameraEmotionData.resid;
    localanxq.jdField_g_of_type_JavaLangString = paramCameraEmotionData.RomaingType;
    localanxq.b = paramCameraEmotionData.thumbPath;
    localanxq.f = paramCameraEmotionData.resid;
    return localanxq;
  }
  ...
  public String a(CameraEmotionData paramCameraEmotionData)
  {
    ...
    if (TextUtils.isEmpty(str2))
    {
      ...
      str1 = anrp.a(paramCameraEmotionData.resid);
    }
    return anrp.a(str1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  }
  ...
  public List<CameraEmotionData> a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        {
          localObject2 = ((aukn)localObject3).a(a(), false, null, null, null, null, null, null);
          ...
          if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              if (this.jdField_a_of_type_Boolean) {
                axrl.a(BaseApplication.getContext()).a("", "CameraEmoDBError", true, 0L, 0L, null, "");
              }
            }
          }
          break;
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      aexd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).g();
    }
  }
  ...
  public void a(List<ajti> paramList, List<String> paramList1, List<String> paramList2)
  {
    int k = 0;
    ...
    if (((List)localObject2).size() < paramList.size())
    {
      ...
      while (paramList1.hasNext()) {
        paramList.remove((ajti)paramList1.next());
      }
    }
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            paramList2 = (ajti)paramList.next();
            j += 1;
  ...
  public void b()
  {
    if (!this.b)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "CamEmoUpload", false, 0L, 0L, localHashMap, null);
    }
  }
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          else
          {
            anxq localanxq = new anxq();
            localanxq.jdField_c_of_type_Int = 11;
            localanxq.d = a(localCameraEmotionData);
            localanxq.a = localCameraEmotionData.strContext;
            localanxq.e = localCameraEmotionData.url;
            localanxq.jdField_g_of_type_Int = localCameraEmotionData.emoId;
            localanxq.jdField_c_of_type_JavaLangString = localCameraEmotionData.resid;
            localanxq.jdField_g_of_type_JavaLangString = localCameraEmotionData.RomaingType;
            localanxq.b = localCameraEmotionData.thumbPath;
            localanxq.f = localCameraEmotionData.resid;
            localArrayList.add(localanxq);
          }
        }
      }
      catch (OutOfMemoryError localOutOfMemoryError)
