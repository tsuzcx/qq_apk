...
class anrz
  extends aywb
{
  anrz(anrx paramanrx, Looper paramLooper, CameraEmotionData paramCameraEmotionData)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (anrx.b(this.jdField_a_of_type_Anrx) == null) {
      label19:
      return;
    }
    if ((localayqo == null) || (localayqo.c != this.jdField_a_of_type_Anrx.a()))
    {
      anrx.c(this.jdField_a_of_type_Anrx).a().b(this);
      return;
    }
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        anrx.d(this.jdField_a_of_type_Anrx).a().b(this);
        ((ajtf)anrx.e(this.jdField_a_of_type_Anrx).a(160)).a(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData, true);
        ((HashMap)localObject3).put("sucFlag", "1");
        ((HashMap)localObject3).put("retCode", String.valueOf(paramMessage.what));
        axrn.a(BaseApplication.getContext()).a(null, "CamEmoRealUpload", true, 0L, 0L, (HashMap)localObject3, null);
        return;
      }
      anrx.f(this.jdField_a_of_type_Anrx).a().b(this);
      QLog.i("CameraEmoRoamingManager", 1, "upload camera emo error:" + localCommFileExtRsp.int32_retcode.get());
      ((ajtf)anrx.g(this.jdField_a_of_type_Anrx).a(160)).a(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData, false);
      ((HashMap)localObject3).put("sucFlag", "0");
      ((HashMap)localObject3).put("retCode", String.valueOf(localCommFileExtRsp.int32_retcode.get()));
      axrn.a(BaseApplication.getContext()).a(null, "CamEmoRealUpload", false, 0L, 0L, (HashMap)localObject3, null);
      return;
      anrx.h(this.jdField_a_of_type_Anrx).a().b(this);
      QLog.i("CameraEmoRoamingManager", 1, "upload camera emo cancel:" + (String)localObject2);
      ((ajtf)anrx.i(this.jdField_a_of_type_Anrx).a(160)).a(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData, false);
      ((HashMap)localObject3).put("sucFlag", "0");
      ((HashMap)localObject3).put("retCode", String.valueOf(paramMessage.what));
      axrn.a(BaseApplication.getContext()).a(null, "CamEmoRealUpload", false, 0L, 0L, (HashMap)localObject3, null);
      return;
