...
public class bcfw
  extends bcjt
{
  bcfw(bcfr parambcfr, MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean) {}
  ...
  public void a(int paramInt, oidb_0x962.RspBody paramRspBody)
  {
    if (paramInt == 0)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.interactState == 2) && (paramRspBody.msg_finish_info.has()))
      {
        ...
        this.jdField_a_of_type_Bcfr.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Bcfr.jdField_a_of_type_AndroidOsHandler.post(new AIOAnimationControlManager.2.1(this));
      return;
      List localList = (List)this.jdField_a_of_type_Bcfr.c.get(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin);
      paramRspBody = localList;
      if (localList == null)
      {
        paramRspBody = new ArrayList();
        this.jdField_a_of_type_Bcfr.c.put(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, paramRspBody);
      }
      try
      {
        ...
        paramRspBody = (List)this.jdField_a_of_type_Bcfr.b.get(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin);
      ...
      finally
      {
        try
        {
          ...
          bcfr.b(this.jdField_a_of_type_Bcfr);
          this.jdField_a_of_type_Bcfr.notifyObservers(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
          break;
        }
        finally {}
