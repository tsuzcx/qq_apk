...
{
  protected static HashMap<Long, bcfw> a;
  protected int a;
  protected Context a;
  protected String a;
  ...
  protected bcfw(Context paramContext, String paramString, SQLiteDatabase.CursorFactory paramCursorFactory, int paramInt)
  {
  ...
  public static bcfw a(Context paramContext, long paramLong)
  {
    try
    {
      bcfw localbcfw2 = (bcfw)jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
      bcfw localbcfw1 = localbcfw2;
      if (localbcfw2 == null)
      {
        localbcfw1 = new bcfw(paramContext, bcdu.b(String.valueOf(paramLong) + "_opensdk"), null, 74);
        jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localbcfw1);
      }
      return localbcfw1;
    }
    finally {}
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    //   12: astore_2
    //   13: aload_0
    //   14: getfield 103	bcfw:jdField_a_of_type_Boolean	Z
    //   17: ifeq +29 -> 46
    //   20: aload_1
    //   21: ifnull +7 -> 28
    //   24: aload_1
    ...
    //   39: aload_0
    //   40: iconst_0
    //   41: putfield 103	bcfw:jdField_a_of_type_Boolean	Z
    //   44: aload_1
    //   45: astore_2
    //   46: aload_0
    //   47: monitorexit
    ...
    //   63: astore_2
    //   64: aload_0
    //   65: getfield 103	bcfw:jdField_a_of_type_Boolean	Z
    //   68: ifeq -22 -> 46
    //   71: aload_0
    //   72: iconst_0
    //   73: putfield 103	bcfw:jdField_a_of_type_Boolean	Z
    //   76: aload_1
    //   77: astore_2
    //   78: goto -32 -> 46
    //   81: astore_1
    ...
    //   86: astore_1
    //   87: aload_0
    //   88: getfield 103	bcfw:jdField_a_of_type_Boolean	Z
    //   91: ifeq +29 -> 120
    //   94: iconst_0
    //   95: ifeq +11 -> 106
    ...
    //   105: athrow
    //   106: aload_0
    //   107: invokevirtual 110	bcfw:a	()V
    //   110: aload_0
    ...
    //   115: aload_0
    //   116: iconst_0
    //   117: putfield 103	bcfw:jdField_a_of_type_Boolean	Z
    //   120: aload_1
    //   121: athrow
    //   122: astore_2
    //   123: goto -84 -> 39
