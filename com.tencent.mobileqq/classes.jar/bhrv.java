  ...
  extends bhsh
{
  ...
  private void a(bcdp parambcdp, String[] paramArrayOfString)
  {
    try
    {
      ...
      parambcdp.putInt("key_personal_album_enter_model", 0);
      parambcdp.putBoolean("key_pass_result_by_bundle", true);
      parambcdp.putString("key_accept_album_anonymity", paramArrayOfString.optString("acceptType"));
      parambcdp.putString("key_deny_delect_tips", paramArrayOfString.optString("denyTips"));
      parambcdp.putBoolean("key_can_new_album", false);
      parambcdp.putString("key_from_type", paramArrayOfString.optString("fromType"));
      paramArrayOfString = bgyw.a();
      ...
      parambcdp.putBoolean("key_need_change_to_jpg", false);
      bgyp.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), paramArrayOfString, parambcdp, bgyp.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 7));
      return;
    }
