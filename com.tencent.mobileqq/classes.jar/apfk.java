  ...
  implements View.OnClickListener
{
  ...
  public apfo a;
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new apfl(this);
  ...
  public apfk(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, boolean paramBoolean, apfo paramapfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Apfo = paramapfo;
    if ((paramBoolean) && (this.jdField_a_of_type_Apfo != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Apfo.b))) {}
    ...
    this.jdField_b_of_type_Int = aekt.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.c = aekt.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = aekt.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = aekt.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        return null;
        paramViewGroup = (apfm)paramView.getTag();
        break;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = (apfm)paramView;; paramView = null)
    {
      if (paramView == null) {}
      do
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", "", "", "");
