  ...
  implements View.OnClickListener
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjr.class.getSimpleName();
  }
  
  public ajjr(BaseActivity paramBaseActivity, int paramInt, View paramView)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBaseActivity);
    this.jdField_a_of_type_Int = paramInt;
    paramBaseActivity = paramView.findViewById(2131377187);
    IphoneTitleBarActivity.setLayerType(paramBaseActivity);
    paramView = paramBaseActivity.findViewById(2131363845);
    if (paramView != null) {
      paramView.setVisibility(8);
    }
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramBaseActivity.findViewById(2131366280));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBaseActivity.findViewById(2131380145));
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(bbzh.b());
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bcjs.a(null, i, 0, "0X8009D15", 0, 0, null, null);
