  ...
  extends ajfb
{
  ...
  public bbfc(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new LruCache(100);
    this.jdField_a_of_type_Bbfk = new bbfk();
    this.jdField_a_of_type_Bbfs = null;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bbfi(this);
  ...
  public bbfs a(String paramString)
  {
    if (this.jdField_a_of_type_Bbfs == null) {
      this.jdField_a_of_type_Bbfs = new bbfs(paramString);
    }
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_Bbfs.jdField_a_of_type_JavaLangString = paramString;
    }
    return this.jdField_a_of_type_Bbfs;
  }
  
  protected mmn a(bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    return new bbfg(this, parambbfj);
  }
  ...
  public void a(int paramInt1, int paramInt2, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    ...
    mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_1", 2276, 1, new Bundle(), 5000L);
  }
  ...
  public void a(TextView paramTextView, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (((ajjj)localObject).b(paramString1))
      {
        paramString1 = babh.j(this.app, paramString1);
        try
        {
      ...
      localObject = ((ajjj)localObject).a(paramString1);
  ...
  public void a(bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "reqInviteId");
    }
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_6", 2276, 6, new Bundle(), 5000L);
  }
  ...
  public void a(HotChatInfo paramHotChatInfo, int paramInt1, int paramInt2, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    oidb_0x8ed.ReqBody localReqBody = new oidb_0x8ed.ReqBody();
    bbfe localbbfe = new bbfe(this, parambbfj);
    try
    {
      long l = Long.parseLong(paramHotChatInfo.troopUin);
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      mmj.a(this.app, b(new bbff(this, localbbfe, paramHotChatInfo, l, paramInt2, paramInt1, parambbfj)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      return;
    }
    catch (Exception paramHotChatInfo)
    {
  ...
  public void a(HotChatInfo paramHotChatInfo, bbfj<oidb_0x8ed.RspBody> parambbfj)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    ...
    try
    {
      ...
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      mmj.a(this.app, b(new bbfd(this, parambbfj, paramHotChatInfo)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      asgb.a().a(l);
      asfc.a(this.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(awao.a()));
      try
      {
  ...
  public void a(String paramString, long paramLong, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    if (QLog.isColorLevel()) {
    ...
    mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_5", 2276, 5, new Bundle(), 5000L);
  }
  
  public void a(String paramString, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    localReqBody.string_invite_id.set(ByteStringMicro.copyFromUtf8(paramString), true);
    mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_3", 2276, 3, new Bundle(), 5000L);
  }
  
  public void a(String paramString, boolean paramBoolean, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_2", 2276, 2, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void a(TroopTips0x857.WereWolfPush paramWereWolfPush, byte[] paramArrayOfByte)
  {
    ...
    for (paramWereWolfPush = "";; paramWereWolfPush = str1.substring(0, 1) + "***" + str1.substring(str1.length() - 1) + "|msg len:" + str1.length())
    {
      ...
      this.jdField_a_of_type_Bbfs.a("WereWolfPush", paramArrayOfByte);
      return;
    }
  }
  ...
  protected mmn b(bbfj<oidb_0x8ed.RspBody> parambbfj)
  {
    return new bbfh(this, parambbfj);
  }
  
  public void b(int paramInt1, int paramInt2, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    if (QLog.isColorLevel()) {
    ...
    localReqBody.uint32_zone_id.set(paramInt2);
    mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_4", 2276, 4, new Bundle(), 5000L);
  }
  
  public void b(String paramString, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, boolean paramBoolean, bbfj<oidb_0x8e4.RspBody> parambbfj)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    ...
    {
      paramString.set(i);
      mmj.a(this.app, a(parambbfj), localReqBody.toByteArray(), "OidbSvc.0x8e4_7", 2276, 7, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Bbfk.removeCallbacksAndMessages(null);
    super.onDestroy();
  }
    ...
    if ("ProfileService.GetSimpleInfo".equals(localObject))
    {
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if ((localObject != null) && (paramToServiceMsg != null) && (((ArrayList)localObject).size() > 0) && (paramToServiceMsg.size() > 0))
        {
          ...
          this.jdField_a_of_type_Bbfk.sendMessage(paramFromServiceMsg);
        }
      }
    }
  }
