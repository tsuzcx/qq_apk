  ...
  implements BaseLayer.OnLayerTouchListener
{
  ...
  private anzm(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new anzn(this));
    ...
    localAlphaAnimation.setAnimationListener(new anzo(this));
    if (paramBoolean2) {
