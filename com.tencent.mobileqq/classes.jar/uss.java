...
public class uss
{
  ...
  public uss(usq paramusq, BaseApplicationImpl paramBaseApplicationImpl, int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangString = ("PubAccountHttpDownloader." + this.jdField_b_of_type_Int);
  }
  ...
  {
    return new ust(this, paramURLDrawableHandler, this);
  }
  ...
  public void a(int paramInt, DownloadParams paramDownloadParams)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        switch (uuc.a((QQAppInterface)localObject2, (String)localObject1))
        {
        }
      ...
      if (paramDownloadParams != null)
      {
        ...
        this.jdField_a_of_type_JavaUtilHashMap.put("param_FailCode", this.jdField_d_of_type_Int + "");
