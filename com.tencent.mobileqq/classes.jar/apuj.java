...
final class apuj
  implements apvh
{
  apuj(QQAppInterface paramQQAppInterface) {}
  ...
  {
    paramString5 = bajy.a(this.a, Long.parseLong(paramString2));
    ...
    try
    {
      ...
      l1 = l2;
      paramString5 = bajy.a(this.a, l2).a(paramString3);
      l1 = l2;
    }
    ...
    if ((paramString5 != null) && (apvd.b(paramString5.k)))
    {
      paramString4 = new BitmapFactory.Options();
      paramString4.inJustDecodeBounds = true;
      apuy.a(paramString5.k, paramString4);
    ...
    paramString4 = axas.a(-1000);
    adgc.a().a(paramString4.uniseq, paramLong2, paramInt4);
    ...
    if (paramInt1 == 0)
    {
      ...
      localFileManagerEntity.peerNick = apug.a(this.a, paramString1, null, paramInt1);
      ...
      this.a.a().a(paramString1, paramString2, true, "", paramLong1, true, paramInt1, str, localFileManagerEntity.msgSeq, localFileManagerEntity.msgSeq, paramString3, 1, paramLong2, localFileManagerEntity.msgUid, -1L, awzy.a());
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (localFileManagerEntity.nOpType == 24)
    {
      ...
      paramString2 = "1";
      label283:
      axqy.b(paramString4, "P_CliOper", "Grp_files", "", "transfer", "Clk_fri", 0, 0, paramString3, str, paramString2, localFileManagerEntity.peerUin);
      label315:
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      for (;;)
      {
        ...
        break;
        if (apug.a(localFileManagerEntity.fileName) == 2)
        {
          ...
          if (apug.a(localFileManagerEntity.fileName) == 0) {
            paramString2 = this.a.a().a(localFileManagerEntity, 5);
          } else if (apug.a(localFileManagerEntity.fileName) == 2) {
      ...
      {
        axqy.b(paramString4, "P_CliOper", "Grp_files", "", "transfer", "Clk_talk", 0, 0, paramString3, str, paramString2, "");
        break;
      }
    }
  }
