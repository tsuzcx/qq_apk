  ...
  implements View.OnClickListener
{
  ...
  private List<ajiy> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public ajlx(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean, PhoneContactFragment paramPhoneContactFragment)
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!localPhoneContact.isHiden) {
          ((List)localObject1).add(ajix.a(1, localPhoneContact, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        }
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (a())
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558983, null);
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130839458);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131369395).setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131369501).setVisibility(8);
        localObject1 = (SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367894);
        ((SingleLineTextView)localObject1).setText(anvx.a(2131707453));
        ...
        ((SimpleTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365094)).setText("0");
      }
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = ((ajiy)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, this);
      if (localObject1 != null)
      {
        localObject2 = (ajjb)((View)localObject1).getTag();
        if (((ajjb)localObject2).d != null) {
          ((ajjb)localObject2).d.setBackgroundDrawable(new BitmapDrawable(a(((ajjb)localObject2).b, ((ajjb)localObject2).jdField_a_of_type_JavaLangString)));
        }
        ((View)localObject1).setOnClickListener(this);
        if ((localObject2 instanceof ajlw)) {
          ((ajlw)localObject2).a.setOnClickListener(this);
        }
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    int i = 17;
    Object localObject;
    if ((paramView != null) && (paramView.getId() == 2131376596) && ((paramView.getTag() instanceof PhoneContact)))
    {
    ...
    for (;;)
    {
      ...
      localObject = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, ((PhoneContact)localObject).unifiedCode, null, 3006, i, ((PhoneContact)localObject).name, null, null, anvx.a(2131707448), null);
      this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "contact", "", "addbook", "add_friend", 0, 0, "", "", "", "");
      do
      {
        do
        {
          ...
          return;
        } while ((paramView == null) || (!(paramView.getTag() instanceof ajjb)));
        localObject = (ajjb)paramView.getTag();
      } while (!(((ajjb)localObject).jdField_a_of_type_JavaLangObject instanceof PhoneContact));
      PhoneContact localPhoneContact = (PhoneContact)((ajjb)localObject).jdField_a_of_type_JavaLangObject;
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80053DF", "0X80053DF", 0, 0, "1", "", "", "");
        break;
