  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  public bcbq a;
  public bcbv a;
  private bcfa jdField_a_of_type_Bcfa;
  public final bcfm a;
  public bcsc a;
  ...
  public bcfj()
  {
    ...
    this.jdField_a_of_type_Bcfm = new bcfm();
  ...
  {
    return (TouchWebView)this.jdField_a_of_type_Bcdt.a();
  }
  ...
  public void a()
  {
    ...
    {
      WebView localWebView = this.jdField_a_of_type_Bcdt.a();
      localWebView.setId(2131379397);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      return;
    case 2: 
      nax.a("Web_updateTitleBarUI");
      if (this.jdField_a_of_type_Bcfm.q) {
        this.jdField_a_of_type_Bcbv.g();
      }
      nax.b("Web_updateTitleBarUI");
      return;
    case 3: 
      ...
      this.jdField_a_of_type_Bcbv.e();
      return;
    case 4: 
      if ((this.jdField_a_of_type_Bcbq.jdField_a_of_type_AndroidViewView != null) && (8 == this.jdField_a_of_type_Bcbq.c.getVisibility())) {
        this.jdField_a_of_type_Bcbq.a();
      }
      if (paramBundle.containsKey("Configuration")) {}
      for (paramBundle = (Configuration)paramBundle.getParcelable("Configuration"); (paramBundle != null) && (this.jdField_a_of_type_Bcbq.c != null) && (paramBundle.orientation == 2) && (this.jdField_a_of_type_Bcbq.c.getVisibility() == 0); paramBundle = null)
      {
        this.jdField_a_of_type_Bcbq.c.setVisibility(8);
        return;
      }
    case 6: 
      if ((!this.jdField_a_of_type_Bcfa.j) && (this.jdField_a_of_type_Bcsc != null) && (this.jdField_a_of_type_Bcsc.b() != 0)) {
    ...
    for (paramBundle = paramBundle.getString("url");; paramBundle = null)
    {
      ...
      if ((localObject1 != null) && (((Uri)localObject1).isHierarchical()) && ("simple".equals(((Uri)localObject1).getQueryParameter("style"))))
      {
        ...
        this.jdField_a_of_type_Bcfm.w = true;
      }
      a(this.jdField_a_of_type_Bcdt.a());
      return;
      if (this.jdField_a_of_type_Bcsc != null) {
        this.jdField_a_of_type_Bcsc.a((byte)2);
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      if ((this.jdField_a_of_type_Bcfm.B) || (this.jdField_b_of_type_AndroidWidgetTextView == null)) {
        break;
      }
      ...
      localObject1 = (TouchWebView)this.jdField_a_of_type_Bcdt.a();
      ...
      for (;;)
      {
        ...
        ((TouchWebView)localObject1).setOnOverScrollHandler(new bcfk(this, (TouchWebView)localObject1, paramBundle));
        ((TouchWebView)localObject1).setOnScrollChangedListener(new bcfl(this));
        b(this.jdField_a_of_type_Bcdt.a());
        return;
        label562:
  ...
  public void a(Intent paramIntent)
  {
    int i;
    boolean bool;
    if (((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x20000) != 0L) || (paramIntent.getBooleanExtra("isFullScreen", false)))
    {
      i = 1;
      if (i != 0) {
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean = true;
      }
      bcfm localbcfm = this.jdField_a_of_type_Bcfm;
      if (((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x1000000) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitle", false))) {
        break label666;
      }
      bool = true;
      label76:
      localbcfm.jdField_b_of_type_Boolean = bool;
      localbcfm = this.jdField_a_of_type_Bcfm;
      if (((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitleAndClickable", false))) {
        break label671;
      }
      bool = true;
      label115:
      localbcfm.m = bool;
      localbcfm = this.jdField_a_of_type_Bcfm;
      if (((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x2) == 0L) && (!paramIntent.getBooleanExtra("hide_more_button", false))) {
        break label676;
      }
      bool = true;
      label156:
      localbcfm.e = bool;
      localbcfm = this.jdField_a_of_type_Bcfm;
      if (((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("hide_operation_bar", false)) && (!"noBottomBar".equals(paramIntent.getStringExtra("webStyle")))) {
        break label681;
      }
      bool = true;
      label211:
      localbcfm.f = bool;
      localbcfm = this.jdField_a_of_type_Bcfm;
      if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 0x100) == 0L) {
        break label686;
      }
      bool = true;
      label241:
      ...
      {
        this.jdField_a_of_type_Bcfm.e = true;
        this.jdField_a_of_type_Bcfm.f = true;
      }
      i = paramIntent.getIntExtra("reqType", -1);
      if ((!this.jdField_a_of_type_Bcfm.f) && (i == 6)) {
        this.jdField_a_of_type_Bcfm.f = true;
      }
      this.jdField_a_of_type_Bcfm.g = paramIntent.getBooleanExtra("fromOneCLickCLose", false);
      if ((!this.jdField_a_of_type_Bcfm.e) && ((i == 3) || (i == 1) || (!paramIntent.getBooleanExtra("ba_is_login", true)) || (i == 7))) {
        this.jdField_a_of_type_Bcfm.e = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x20000) > 0L) {
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x20000000) != 0L) {
        this.jdField_a_of_type_Bcfm.q = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x800) > 0L)
      {
        this.jdField_a_of_type_Bcfm.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 0x4) > 0L)
      {
        this.jdField_a_of_type_Bcfm.jdField_d_of_type_Boolean = false;
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 0x2) > 0L) {
        this.jdField_a_of_type_Bcfm.h = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 0x200) > 0L) {
        this.jdField_a_of_type_Bcfm.B = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 0x400) > 0L)
      {
        localbcfm = this.jdField_a_of_type_Bcfm;
        this.jdField_a_of_type_Bcfm.z = true;
        localbcfm.C = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long & 0x2000) > 0L) {
        this.jdField_a_of_type_Bcfm.p = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_d_of_type_Long & 1L) > 0L) {
        this.jdField_a_of_type_Bcfm.jdField_b_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Bcfm.jdField_d_of_type_Long & 0x8) > 0L) {
        this.jdField_a_of_type_Bcfm.m = true;
      }
    ...
    label686:
    label691:
    while ((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x80000000) <= 0L)
    {
      return;
      i = 0;
      break;
    ...
    this.jdField_a_of_type_Bcfm.D = mvv.a().j(paramIntent.getStringExtra("url"));
  }
  
  public void a(Intent paramIntent, String paramString)
  {
    this.jdField_a_of_type_Bcbv.a(paramIntent, paramString);
    a(this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject, false);
    d();
  }
  ...
  {
    this.jdField_a_of_type_Bcbv.a(paramView, paramInt1, paramInt2, paramInt3);
  }
  ...
  public void a(View paramView, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      return;
      int i;
      if ((this.jdField_a_of_type_Bcfm.z) && (!"1000".equals(ThemeUtil.getCurrentThemeId()))) {
        i = 1;
      }
  ...
  {
    this.jdField_a_of_type_Bcbv.a(paramTouchWebView);
  }
  ...
  public void a(WebBrowserViewContainer paramWebBrowserViewContainer, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    ...
    {
      paramWebBrowserViewContainer.b(this.jdField_a_of_type_Bcfm.F);
      this.jdField_a_of_type_Bcbq.a(paramWebBrowserViewContainer, this.jdField_a_of_type_AndroidViewView$OnClickListener);
      this.jdField_a_of_type_Bcbq.a(this.jdField_a_of_type_AndroidAppActivity);
    }
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Bcfa.s = (l1 - l2);
    ...
    paramIntent = this.jdField_a_of_type_Bcsc;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      nax.a("Web_qqbrowser_initView_WebViewWrapper");
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379407));
      nax.b("Web_qqbrowser_initView_WebViewWrapper");
      l2 = System.currentTimeMillis();
      this.jdField_a_of_type_Bcfa.m = (l2 - l1);
      if (!this.jdField_a_of_type_Bcfm.B)
      {
        this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363422);
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363423));
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131376899));
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(4);
        if ((this.jdField_a_of_type_Bcfm.jdField_b_of_type_Boolean) && ((this.jdField_a_of_type_AndroidAppActivity instanceof BaseActivity))) {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131375054));
      }
      if ((this.jdField_a_of_type_Bcfm.A) && (this.jdField_b_of_type_AndroidViewView != null)) {
        this.jdField_b_of_type_AndroidViewView.setPadding(0, (int)bbdh.a(BaseApplicationImpl.getContext(), 30.0F), 0, 0);
      }
      j();
  ...
  {
    if (this.jdField_a_of_type_Bcfm.g)
    {
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long = Long.parseLong(str1, 10);
    ...
    catch (NumberFormatException localNumberFormatException7)
    {
      try
      {
        this.jdField_a_of_type_Bcfm.jdField_c_of_type_Long = Long.parseLong(str1, 10);
        str1 = paramString.getQueryParameter("_fu");
        this.jdField_a_of_type_Bcfm.jdField_c_of_type_Boolean = false;
        if (str1 == null) {}
      }
      catch (NumberFormatException localNumberFormatException7)
      {
        try
        {
          if (Long.parseLong(str1) == 2019L) {
            this.jdField_a_of_type_Bcfm.jdField_c_of_type_Boolean = true;
          }
        ...
        catch (NumberFormatException localNumberFormatException7)
        {
          try
          {
            this.jdField_a_of_type_Bcfm.jdField_b_of_type_Long = Long.parseLong(str1, 10);
          ...
          catch (NumberFormatException localNumberFormatException7)
          {
            ...
            {
              String str2;
              this.jdField_a_of_type_Bcfm.jdField_d_of_type_Long = Long.parseLong(str2, 10);
              str1 = paramString.getQueryParameter("channel");
              if (!TextUtils.isEmpty(str1)) {
                this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangString = URLDecoder.decode(str1);
              }
            ...
            catch (NumberFormatException localNumberFormatException7)
            {
              try
              {
                this.jdField_a_of_type_Bcfm.jdField_a_of_type_Int = Integer.parseInt(str1.trim());
              ...
              catch (NumberFormatException localNumberFormatException7)
              {
                ...
                catch (NumberFormatException localNumberFormatException7)
                {
                  try
                  {
                    for (;;)
                    {
                      this.jdField_a_of_type_Bcfm.jdField_b_of_type_Int = Integer.parseInt(str1.trim());
                  ...
                  catch (NumberFormatException localNumberFormatException8)
                  {
                    ...
                    this.jdField_a_of_type_Bcfm.F = false;
                  }
                }
              }
            }
  ...
  {
    this.jdField_a_of_type_Bcbv.a(paramJSONObject, paramBoolean);
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bcfm.n == paramBoolean) {}
    Object localObject;
    for (;;)
    {
      return;
      this.jdField_a_of_type_Bcfm.n = paramBoolean;
      localObject = null;
      ...
      while (localObject != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          localObject = this.jdField_a_of_type_Bcbv.jdField_a_of_type_AndroidViewViewGroup;
        }
      }
    }
    label98:
  ...
  public void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Bcbv.a((TouchWebView)this.jdField_a_of_type_Bcdt.a(), paramBoolean1, paramInt1, paramInt2, paramInt3, paramBoolean2, paramString1, paramString2, paramString3);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    {
      return false;
      if (this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject == null) {
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject = this.jdField_a_of_type_Bcbv.a(paramString);
      }
    } while ((this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject == null) || (this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject.length() == 0));
    if (this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject.optInt("trans", -1) == 0) {
      this.jdField_a_of_type_Bcfm.u = true;
    }
    if (!this.jdField_a_of_type_Bcfm.u) {
      this.jdField_a_of_type_Bcfm.u = this.jdField_a_of_type_Bcbv.a();
    }
    return true;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bcfa = ((bcfa)this.jdField_a_of_type_Bcdt.a().a(-2));
  }
  ...
  public void b(Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("1".equals(localUri.getQueryParameter("_qStyle")))
      {
        ...
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = paramIntent;
        return;
      }
      WebViewTitleStyle localWebViewTitleStyle = a((String)localObject);
      if (localWebViewTitleStyle != null)
      {
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = localWebViewTitleStyle;
        return;
      }
      Object localObject = b((String)localObject);
      if (localObject != null)
      {
        this.jdField_a_of_type_Bcfm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = ((WebViewTitleStyle)localObject);
        return;
      }
      ...
      paramIntent = (WebViewTitleStyle)bcbi.a().a.get(paramIntent);
  ...
  {
    if (this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean) {}
    do
    {
      do
      {
        return;
      } while ((this.jdField_a_of_type_AndroidViewViewGroup != null) || (!this.jdField_a_of_type_Bcfm.g));
      paramIntent = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363378);
    } while (paramIntent == null);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramIntent.inflate());
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131362985));
  ...
  public void b(WebView paramWebView)
  {
    if (this.jdField_a_of_type_Bcfm.g)
    {
      if (!this.jdField_a_of_type_Bcfm.k) {
        break label26;
      }
      a(paramWebView);
    }
  ...
  {
    if ((!this.jdField_a_of_type_Bcfm.g) || (this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean)) {}
    ...
    do
    {
      ...
      localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bcdt.a();
    ...
    axqw.a(null, "dc00898", "", "", "0X8009B1E", "0X8009B1E", 0, 0, "", "", "", "");
    return;
    this.e = false;
    f();
    this.jdField_a_of_type_AndroidViewViewGroup.clearAnimation();
  ...
  public void c()
  {
    this.jdField_a_of_type_Bcbv = bcas.a(this);
    this.jdField_a_of_type_Bcbq = bcbp.a(this);
  }
  
  public void c(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bcbq.a(paramBoolean);
  }
  
  public void d()
  {
    if ((this.jdField_a_of_type_Bcdt.a() != null) && (!this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean)) {
      a((TouchWebView)this.jdField_a_of_type_Bcdt.a());
    }
  }
  
  public void d(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bcbv.jdField_a_of_type_Bcfm.l = paramBoolean;
    if (paramBoolean)
    {
      this.jdField_a_of_type_Bcbv.a("");
      return;
    }
    this.jdField_a_of_type_Bcbv.c();
  }
  
  public void e()
  {
    ViewStub localViewStub = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363338);
    if (localViewStub == null) {
      return;
    }
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)localViewStub.inflate());
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131378008));
  ...
  public void f()
  {
    ...
    if ((this.jdField_a_of_type_Bcdt.a() != null) && (this.jdField_a_of_type_AndroidViewViewGroup != null))
    {
    ...
    if (this.e)
    {
      ...
      f = this.jdField_a_of_type_Bcfm.jdField_c_of_type_Int;
    }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Bcbq.g != null) {
      this.jdField_a_of_type_Bcbq.g.setVisibility(0);
    }
    if ((this.jdField_a_of_type_Bcbq.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_Bcbq.jdField_a_of_type_AndroidViewView.getVisibility() == 8) || (this.jdField_a_of_type_Bcbq.jdField_a_of_type_AndroidViewView.getVisibility() == 4))) {
      this.jdField_a_of_type_Bcbq.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
  }
  ...
  public void j()
  {
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_Bcfm.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangBoolean.booleanValue()))
    {
      i = 1;
      if (i != 0) {
        break label74;
      }
      if ((!this.jdField_a_of_type_Bcfm.e) || (this.jdField_a_of_type_Bcfm.h)) {
        break label69;
      }
      bool = true;
    }
    for (;;)
    {
      ...
      continue;
      label74:
      bool = this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangBoolean.booleanValue();
    }
    label88:
    if (this.jdField_a_of_type_Bcfm.jdField_d_of_type_Boolean)
    {
  ...
  public void onClick(View paramView)
  {
    ...
    TouchWebView localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bcdt.a();
    ...
    do
    {
      ...
      b(localTouchWebView);
      axqw.a(null, "dc00898", "", "", "0X8009B21", "0X8009B21", 0, 0, "", "", "", "");
      return;
    ...
    b(localTouchWebView);
    axqw.a(null, "dc00898", "", "", "0X8009B20", "0X8009B20", 0, 0, "", "", "", "");
  }
}
