  ...
  implements Manager
{
  ...
  private Map<String, bcsh> a;
  private Map<String, TroopAllOnlineData> b = new ConcurrentHashMap();
  
  public bcsj(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramString = (bcsh)this.jdField_a_of_type_JavaUtilMap.get(paramString);
  ...
  public List<bcsi> a(String paramString)
  {
    paramString = (bcsh)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    if (paramString == null) {
      return null;
  ...
  public void a(String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    bcsh localbcsh2 = (bcsh)this.jdField_a_of_type_JavaUtilMap.get(paramString1);
    bcsh localbcsh1 = localbcsh2;
    if (localbcsh2 == null)
    {
      localbcsh1 = new bcsh();
      this.jdField_a_of_type_JavaUtilMap.put(paramString1, localbcsh1);
    }
    if ((i != 4) || (!TextUtils.isEmpty(paramString2)))
    {
      localbcsh1.jdField_a_of_type_JavaLangString = paramString2;
      localbcsh1.jdField_b_of_type_Int = paramInt3;
    }
    localbcsh1.jdField_a_of_type_Long = (NetConnInfoCenter.getServerTime() + i);
    if (paramInt2 != -1) {
      localbcsh1.jdField_a_of_type_Int = paramInt2;
    }
  }
  ...
  public void a(String paramString1, List<bcsi> paramList, int paramInt1, String paramString2, int paramInt2)
  {
    int i = paramInt1;
    if (paramInt1 <= 0) {
      i = 10;
    ...
    {
      localbcsh1.jdField_a_of_type_JavaLangString = paramString2;
      localbcsh1.jdField_b_of_type_Int = paramInt2;
    }
    if ((paramList != null) && (paramList.size() > 0)) {
      localbcsh1.jdField_a_of_type_JavaUtilList = paramList;
    }
    localbcsh1.jdField_b_of_type_Long = (NetConnInfoCenter.getServerTime() + i);
  }
  ...
  public List<String> b(String paramString)
  {
    ...
    paramString = (TroopAllOnlineData)localawbw.a(TroopAllOnlineData.class, paramString);
    localawbw.a();
    if (paramString == null) {
      return null;
    }
