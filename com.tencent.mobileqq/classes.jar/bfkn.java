...
class bfkn
{
  ...
  void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        if (!bfkl.a().equals(new bfkr(arrayOfByte))) {
          break;
        }
    ...
    } while (!bfkl.b().equals(new bfkr(paramArrayOfByte)));
    if (i - j <= 2)
    {
    ...
    localByteBuffer.get(paramArrayOfByte);
    int k = new bfks(paramArrayOfByte).a();
    if (i - j - 2 < k)
    {
    ...
    return;
    if (bfkl.b().equals(new bfkr(arrayOfByte)))
    {
      j = bfkl.b().a().length;
      if (paramArrayOfByte.length - i <= 2)
      {
  ...
  byte[] a()
  {
    ...
    {
      localByteArrayOutputStream.write(bfkl.a().a());
      ...
      localByteArrayOutputStream.write(new bfks(localObject1.length).a());
      localByteArrayOutputStream.write((byte[])localObject1);
    }
    if ((this.jdField_a_of_type_ArrayOfByte != null) && (this.jdField_a_of_type_ArrayOfByte.length > 0))
    {
      localByteArrayOutputStream.write(bfkl.b().a());
      localByteArrayOutputStream.write(new bfks(this.jdField_a_of_type_ArrayOfByte.length).a());
