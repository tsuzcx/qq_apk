...
public class bfkn
{
  ...
  public static bfkn a(aqlg[] paramArrayOfaqlg)
  {
    boolean bool2 = true;
    ...
    int i1 = 0;
    int n = 0;
    if (i4 < paramArrayOfaqlg.length)
    {
      Object localObject = paramArrayOfaqlg[i4].a;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      paramArrayOfaqlg.jdField_a_of_type_JavaUtilArrayList = localArrayList1;
      paramArrayOfaqlg.jdField_a_of_type_Int = i3;
      paramArrayOfaqlg.jdField_b_of_type_Int = i2;
      paramArrayOfaqlg.jdField_b_of_type_JavaUtilArrayList = localArrayList2;
      if (QLog.isColorLevel()) {
        QLog.d("TroopShortcutBarConfig", 2, "parse:" + paramArrayOfaqlg.toString());
      }
