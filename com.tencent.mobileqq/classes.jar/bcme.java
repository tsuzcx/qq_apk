  ...
  extends bcgw
{
  ...
  String ax;
  public String ay = "";
  private View.OnClickListener b = new bcmf(this);
  public boolean b;
  public long c;
  public boolean c;
  boolean d;
  ...
  public bcme()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bcmi(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bcmj(this);
    this.jdField_a_of_type_JavaLangString = "video";
    this.jdField_a_of_type_Int = 18;
  }
  
  public bcme(String paramString1, int paramInt1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, String paramString5, String paramString6, String paramString7, int paramInt7, long paramLong)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bcmi(this);
  ...
  public bcme(String paramString1, String paramString2, boolean paramBoolean)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bcmi(this);
  ...
  private void a()
  {
    try
    {
      if (!ofx.b(this.Y))
      {
        ...
        localogh.jdField_a_of_type_Int = 3;
        localogh.f = 1;
        localogh = oge.a(localogh, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message);
        ((oge)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(139)).a(localogh, null);
      }
      return;
    }
  ...
  private void a(Context paramContext)
  {
    ...
    do
    {
      ...
      paramContext = bcha.a(b());
    } while (TextUtils.isEmpty(paramContext));
    bcef.b(null, "CliOper", "", "", "0X8005F58", "0X8005F58", 0, 0, "", "", paramContext, "");
  }
  ...
  private void a(Context paramContext, View paramView)
  {
    if (this.o == 1)
    {
      if ((paramView instanceof AnyScaleTypeImageView)) {
        ((AnyScaleTypeImageView)paramView).setImageResource(2130839443);
      }
      if (this.jdField_a_of_type_Bcmm == null) {
        this.jdField_a_of_type_Bcmm = new bcmm(this);
      }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(b()))
    {
      ...
      if (!TextUtils.isEmpty(paramContext)) {
        bcef.b(null, "CliOper", "", "", "0X8005F57", "0X8005F57", 0, 0, "", "", paramContext, "");
      }
    }
  }
  ...
  {
    boolean bool2 = bcgr.a().a(paramContext, 3, paramInt);
    boolean bool3 = pay.B();
    if ((bool2) && (bool3)) {}
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (this.ai = localBundle.getString("VIDEO_PUB_ACCOUNT_NAME");; this.ai = String.valueOf(((StructMsgForGeneralShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg).mSourceName))
    {
      ...
      if (paramView.getTag(2131377864) != null)
      {
        paramContext = paramView.getTag(2131377864);
        if ((paramContext instanceof bcml))
        {
          paramContext = (bcml)paramContext;
          if (QLog.isColorLevel()) {
    ...
    paramBundle.setId(2131377864);
    paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramBundle.setContentDescription(((Resources)localObject1).getText(2131718615));
    ...
    if (bool1)
    {
      ...
      if (this.r >= this.s)
      {
        ...
        ((ImageView)localObject2).setImageResource(2130843258);
        ((ImageView)localObject2).setVisibility(8);
        i = AIOUtils.dp2px(62.0F, (Resources)localObject1);
        if (bool1) {
          i = AIOUtils.dp2px(50.0F, (Resources)localObject1);
        }
        localObject3 = new RelativeLayout.LayoutParams(i, i);
        ((RelativeLayout.LayoutParams)localObject3).addRule(13);
        if (bool1)
        {
          i = AIOUtils.dp2px(10.0F, (Resources)localObject1) / 2;
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(5, 2131377864);
        ((RelativeLayout.LayoutParams)localObject4).addRule(7, 2131377864);
        ((RelativeLayout.LayoutParams)localObject4).addRule(8, 2131377864);
        if (!bool1) {
          break label1462;
        }
        i = AIOUtils.dp2px(7.0F, (Resources)localObject1);
        if (!bool1) {
          break label1530;
        }
        ...
        j = AIOUtils.dp2px(10.0F, (Resources)localObject1) + i;
        k = i;
      }
    }
    for (;;)
    {
      ...
      ((TextView)localObject4).setId(2131377863);
      ...
      if (bool1)
      {
        ...
        ((LinearLayout.LayoutParams)localObject5).rightMargin = AIOUtils.dp2px(7.0F, (Resources)localObject1);
        ...
        localObject5 = new bcml();
        ((bcml)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView = paramBundle;
        ((bcml)localObject5).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject4);
        ((bcml)localObject5).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localObject2);
        ((bcml)localObject5).b = ((TextView)localObject1);
        ((bcml)localObject5).jdField_a_of_type_AndroidViewView = ((View)localObject3);
        paramView.setTag(2131377864, localObject5);
        paramView.setTag(this);
        ((bcml)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.a(this, (bcml)localObject5);
        ...
        ((bcml)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.d();
      }
      for (;;)
      {
        if (this.q > 0) {
          ((bcml)localObject5).b.setText(ShortVideoUtils.stringForTime(this.q * 1000));
        }
        if (!TextUtils.isEmpty(this.au)) {
          paramView.setTag(2131377871, this.au);
        }
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null) && (!bfth.a().a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message, "0X800B375")))
        {
          odq.a(null, null, "0X800B375", "0X800B375", 0, 0, "", "", "", new sie(null, null, this.ae, this.aj).i(this.aj).l(bool2).m(pay.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg)).a().a(), false);
          bfth.a().a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message, "0X800B375");
        }
        return paramView;
        paramBundle.i = false;
        ...
        break label549;
        label1462:
        i = AIOUtils.dp2px(12.0F, (Resources)localObject1);
        break label630;
        label1475:
        k = AIOUtils.dp2px(10.0F, (Resources)localObject1) + i;
        j = i;
        break label675;
        ...
        break label818;
        label1519:
        ((bcml)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.f();
      }
      label1530:
      j = i;
      k = i;
  ...
  protected void a(Context paramContext, StructMsgForGeneralShare paramStructMsgForGeneralShare, long paramLong)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        if ((sek.a(paramContext)) || ((localQQAppInterface != null) && (localQQAppInterface.isVideoChatting())))
        {
      ...
      for (Object localObject = paramStructMsgForGeneralShare.mCreateTime.substring(0, paramStructMsgForGeneralShare.mCreateTime.indexOf(" "));; localObject = paramStructMsgForGeneralShare.mCreateTime)
      {
        ...
        if (!bool1)
        {
          ...
          {
            sjo.a();
            localBundle.putString("VIDEO_THIRD_URL", sjo.a(this.af));
          }
        }
        if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null) {
          bcef.b(null, "dc00899", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message.frienduin, "0X8006830", "0X8006830", 0, 0, this.ae, "" + this.v, "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.msgId, "");
        }
        ...
        if (((paramStructMsgForGeneralShare.mSourceName == null) || (!paramStructMsgForGeneralShare.mSourceName.equals(amtj.a(2131716054)))) && (((AladdinConfig)localObject).getIntegerFromString("enable_floating_layer_style", 0) == 1) && (bkwt.a(paramContext, this.aj, localBundle))) {
          break;
        }
        bool1 = false;
        try
        {
          boolean bool2 = pcv.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
          bool1 = bool2;
        }
        ...
        sgi.a(paramContext, paramStructMsgForGeneralShare);
        if (!(paramContext instanceof Activity)) {
          break;
        }
        ((Activity)paramContext).overridePendingTransition(2130772039, 2130772041);
        return;
  ...
  public boolean a(bcin parambcin)
  {
    ...
    for (;;)
    {
      ...
      this.ad = parambcin.a("src");
      Object localObject = parambcin.a("load");
      this.ae = parambcin.a("vInfo");
      this.af = parambcin.a("tInfo");
      String str = parambcin.a("preTime");
      if (str != null) {}
      try
      {
        this.q = Integer.valueOf(str).intValue();
        label81:
        str = parambcin.a("preWidth");
        if (str == null) {}
      }
            ...
            try
            {
              ...
              catch (RuntimeException localNumberFormatException9)
              {
                try
                {
                  ...
                  label199:
                  this.aj = parambcin.a("aID");
                  this.au = parambcin.a("jumpUrl");
                  this.jdField_d_of_type_Boolean = "1".equals(parambcin.a("isJump2Web"));
                  localObject = parambcin.a("preStartPosi");
                  if (!TextUtils.isEmpty((CharSequence)localObject)) {}
                  try
                  {
                    this.p = Integer.valueOf((String)localObject).intValue();
                    this.av = parambcin.a("apurl");
                    this.aw = parambcin.a("rl");
                    this.ax = parambcin.a("disType");
                    localObject = parambcin.a("feedId");
                    if (TextUtils.isEmpty((CharSequence)localObject)) {}
                  }
                  catch (Exception localNumberFormatException9)
                  {
                    try
                    {
                      ...
                      localObject = parambcin.a("feedType");
                      if (TextUtils.isEmpty((CharSequence)localObject)) {}
                    }
                    catch (Exception localNumberFormatException9)
                    {
                      try
                      {
                        ...
                        if (this.jdField_a_of_type_Int >= 13)
                        {
                          localObject = parambcin.a("action_type");
                          if (TextUtils.isEmpty((CharSequence)localObject)) {}
                        }
                      }
                      catch (Exception localNumberFormatException9)
                      {
                        try
                        {
                          ...
                          localObject = parambcin.a("dest_type");
                          if (TextUtils.isEmpty((CharSequence)localObject)) {}
                        }
                        catch (NumberFormatException localNumberFormatException9)
                        {
                          try
                          {
                            ...
                            localObject = parambcin.a("product_type");
                            if (TextUtils.isEmpty((CharSequence)localObject)) {}
                          }
                          catch (NumberFormatException localNumberFormatException9)
                          {
                            try
                            {
                              ...
                              this.r = parambcin.a("advertiser_id");
                              this.s = parambcin.a("aid");
                              this.t = parambcin.a("app_download_schema");
                              this.u = parambcin.a("canvas_json");
                              this.v = parambcin.a("customized_invoke_url");
                              this.w = parambcin.a("effect_url");
                              this.x = parambcin.a("landing_page");
                              this.y = parambcin.a("landing_page_report_url");
                              this.z = parambcin.a("noco_id");
                              this.A = parambcin.a("product_id");
                              this.C = parambcin.a("subordinate_product_id");
                              this.D = parambcin.a("traceid");
                              this.E = parambcin.a("via");
                              this.F = parambcin.a("video_url");
                              this.G = parambcin.a("appname");
                              this.H = parambcin.a("customized_invoke_url");
                              this.I = parambcin.a("pkg_name");
                              this.J = parambcin.a("pkgurl");
                              this.B = parambcin.a("rl");
                              this.q = parambcin.a("apurl");
                              this.N = parambcin.a("corporate_image_name");
                              this.O = parambcin.a("corporate_logo");
                              if (this.jdField_a_of_type_Int >= 14)
                              {
                                localObject = parambcin.a("mini_program_type");
                                if (TextUtils.isEmpty((CharSequence)localObject)) {}
                              }
                            }
                            catch (NumberFormatException localNumberFormatException9)
                            {
                              try
                              {
                                ...
                                if ((parambcin.a != null) && (parambcin.a.a != null))
                                {
                                  localObject = parambcin.a.a;
                                  if (this.jdField_a_of_type_Int >= 15)
                                  {
                                    str = ((bcin)localObject).a("tab_id");
                              ...
                              catch (NumberFormatException localNumberFormatException9)
                              {
                                try
                                {
                                  ...
                                  str = ((bcin)localObject).a("is_hidden");
                                  if (StringUtil.isEmpty(str)) {}
                                }
                                catch (NumberFormatException localNumberFormatException9)
                                {
                                  try
                                  {
                                    ...
                                    if (this.jdField_a_of_type_Int >= 16)
                                    {
                                      this.P = ((bcin)localObject).a("negative_feedback_url");
                                      this.Q = ((bcin)localObject).a("sdk_exposure_monitor_url");
                                      this.R = ((bcin)localObject).a("sdk_click_monitor_url");
                                      str = ((bcin)localObject).a("media_duration");
                                      if (StringUtil.isEmpty(str)) {}
                                    }
                                  }
                                  catch (NumberFormatException localNumberFormatException9)
                                  {
                                    try
                                    {
                                      ...
                                      str = ((bcin)localObject).a("video_file_size");
                                      if (StringUtil.isEmpty(str)) {}
                                    }
                                    catch (NumberFormatException localNumberFormatException9)
                                    {
                                      try
                                      {
                                        ...
                                        str = ((bcin)localObject).a("app_score_num");
                                        if (StringUtil.isEmpty(str)) {}
                                      }
                                      catch (NumberFormatException localNumberFormatException9)
                                      {
                                        try
                                        {
                                          ...
                                          str = ((bcin)localObject).a("download_num");
                                          if (StringUtil.isEmpty(str)) {}
                                        }
                                        catch (NumberFormatException localNumberFormatException9)
                                        {
                                          try
                                          {
                                            for (;;)
                                            {
                                              for (;;)
                                              {
                                                ...
                                                this.S = ((bcin)localObject).a("universal_link");
                                                this.T = ((bcin)localObject).a("sdk_data");
                                                this.U = ((bcin)localObject).a("tencent_video_id");
                                                this.V = ((bcin)localObject).a("view_id");
                                                if (this.jdField_a_of_type_Int >= 17) {
                                                  this.W = ((bcin)localObject).a("qgg_ext");
                                                }
                                                if (this.jdField_a_of_type_Int >= 18)
                                                {
                                                  this.X = ((bcin)localObject).a("adInfo");
                                                  this.Y = ((bcin)localObject).a("is_report_click");
                                                }
                                                if (this.jdField_a_of_type_Int < 18) {
                                                  break;
                                                }
                                                this.ay = parambcin.a("noAutoPlay");
                                                return true;
  ...
  protected View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle.getBoolean("has_cnr"))
    {
      ...
      for (;;)
      {
        paramView.setImageResource(2130845310);
        paramView.setTag(this);
        try
        {
          localObject2 = new bchc(-16777216, j, j, i);
          if (TextUtils.isEmpty(this.ac))
          {
            ...
            paramView.setId(2131368518);
            paramView.setContentDescription(((Resources)localObject1).getString(2131694169));
            paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            paramView.setContentDescription(((Resources)localObject1).getText(2131718615));
            localObject1 = paramView;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBundle.getBoolean("has_cnr")) {
          localURLDrawable.setDecodeHandler(new bcmk(this, i, j, j));
        }
