...
public class abpz
  extends ajtq
{
  public abpz(NotifyPushSettingActivity paramNotifyPushSettingActivity) {}
  ...
  protected void onSetHelloLiveMessageState(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    NotifyPushSettingActivity.a(this.a).sendMessage(localMessage);
    bcpw.a(this.a, paramString1, 0).b(5);
  ...
  protected void onSetShowPushNotice(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
      ...
      {
        axqw.b(null, "dc00898", "", "", (String)localObject, (String)localObject, 0, 1, "", "", "", "");
        return;
      }
    }
    ...
    bcpw.a(this.a.app.getApp(), 1, this.a.getString(2131719375), 0).b(5);
