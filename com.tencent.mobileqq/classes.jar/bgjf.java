...
{
  public static final DownloadParams.DecodeHandler a = new bgjg();
  public static final DownloadParams.DecodeHandler b = new bgjh(bgey.t, a);
  ...
  public static Bitmap a(@NonNull Bitmap paramBitmap1, @NonNull Bitmap paramBitmap2, int paramInt1, int paramInt2)
  {
    ...
    paramBitmap2.setDensity((int)bgtn.c());
