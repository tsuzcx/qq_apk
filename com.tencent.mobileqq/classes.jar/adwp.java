...
public class adwp
  implements Runnable
{
  public adwp(QQApiPlugin paramQQApiPlugin, String paramString1, String paramString2, int paramInt, Map paramMap, String paramString3, String paramString4, String paramString5, String paramString6) {}
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqJspQQApiPlugin.jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener = new adwq(this);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqJspQQApiPlugin.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonWxShareHelperFromReadInjoy$WXShareHelperFromReadInjoyListener = new adwr(this);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqJspQQApiPlugin.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.d(new adws(this, (Bitmap)localObject));
      return;
    }
