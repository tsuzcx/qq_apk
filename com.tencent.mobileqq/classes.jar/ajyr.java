  ...
  extends ajwv
{
  ...
  public ajyr(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, int paramInt)
  {
  ...
  private void e()
  {
    ...
    View localView = getLayoutInflater().inflate(2131559340, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131561915, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131371775));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setClickable(false);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setClickable(false);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131376313).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131372927).setVisibility(8);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371326)).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131717627));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ajys(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new ajyt(this));
  }
  
  private void f()
  {
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131366102));
    this.jdField_b_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new InputFilter.LengthFilter(15) });
    this.jdField_b_of_type_AndroidWidgetEditText.addTextChangedListener(new ajyu(this));
    this.jdField_b_of_type_AndroidWidgetEditText.setImeOptions(3);
    ajww localajww = new ajww(this);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnEditorActionListener(localajww);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnKeyListener(localajww);
    this.jdField_b_of_type_AndroidWidgetEditText.setHint(this.jdField_a_of_type_AndroidContentContext.getString(2131690667));
  ...
  private void g()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new ajyv(this));
    Button localButton = (Button)findViewById(2131363719);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new ajyw(this));
  }
  ...
  protected void a()
  {
    ...
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A174", "0X800A174", this.jdField_b_of_type_Int, 0, "", "", "s_qq_history_tab", "");
  }
