  ...
  implements Handler.Callback, EIPCResultCallback
{
  ...
  public int a;
  private aukd jdField_a_of_type_Aukd;
  ...
  @RequiresApi(api=18)
  public aukc(QQIdentiferActivity paramQQIdentiferActivity, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity = paramQQIdentiferActivity;
    this.jdField_a_of_type_Aukd = aukd.a(paramInt, paramQQIdentiferActivity.getIntent(), paramQQIdentiferActivity);
  ...
  public static boolean a()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!a("new_qq_android_native_short_new_other_", bfyz.b())) && (b())) {
      return false;
    }
    bfyz.c("");
    bfyz.b(0);
  ...
  {
    String str1 = a();
    String str2 = AEResUtil.getUnzippedPackageDir(AEResInfo.AE_RES_ADDITIONAL_PACKAGE) + "libYTCommon.so";
    ...
    if ((a("new_qq_android_native_short_new_other_", bfyz.b())) || (b(AEResInfo.AE_RES_BASE_PACKAGE.resPrefix, AEResUtil.getDownloadPackageVersion(AEResInfo.AE_RES_BASE_PACKAGE.index))))
    {
    ...
    QLog.d("qq_Identification.Helper", 1, new Object[] { "preCheck is pass, so version is ", Integer.valueOf(bfyz.b()), " current bits is : ", Integer.valueOf(b()) });
  ...
  public void b()
  {
    ...
    {
      jdField_a_of_type_Boolean = this.jdField_a_of_type_Aukd.a(AEResUtil.getUnzippedPackageDir(AEResInfo.AE_RES_ADDITIONAL_PACKAGE), aukd.b);
      jdField_a_of_type_Boolean &= this.jdField_a_of_type_Aukd.a(this.jdField_a_of_type_JavaLangString + "identification/so/", aukd.a);
    }
    int i;
    if (jdField_a_of_type_Boolean)
    {
    ...
    for (;;)
    {
      ...
      return;
      i = this.jdField_a_of_type_Aukd.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity, this.jdField_a_of_type_JavaLangString);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      if (paramMessage.arg1 == 0)
      {
        ...
        this.jdField_a_of_type_Aukd.a(true, this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity);
      }
      if (paramMessage.arg1 != 0) {
        break label238;
      }
