...
public final class ykd
  implements Runnable
{
  public ykd(AppInterface paramAppInterface) {}
  ...
  public void run()
  {
    if (this.a != null)
    {
      ...
      boolean bool = this.a.getApplication().getSharedPreferences("apollo_sp", 0).getBoolean("7.6.3" + this.a.getCurrentAccountUin(), false);
