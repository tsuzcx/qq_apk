  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      ...
      if (paramFromServiceMsg != null)
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          notifyObserver(paramIntent, 1010, true, localBundle, atdk.class);
          return;
        }
        ...
        notifyObserver(paramIntent, 1010, false, localBundle, atdk.class);
        return;
      }
    }
    catch (Throwable paramIntent)
    {
      ...
      notifyObserver(null, 1010, false, null, atdk.class);
    }
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    try
    {
      ...
      arrayOfByte = new wxz((COMM.StCommonExt)localObject, l1, l2).encode(paramIntent, -1, a());
