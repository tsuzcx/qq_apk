...
public class wyb
{
  ...
  public boolean a(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    wsv.a("NewStoryCameraZoom", "onTouchEvent %s", new Object[] { paramMotionEvent });
    float f4;
    float f2;
    float f3;
    if (i == 2)
    ...
    for (float f1 = paramMotionEvent.getY(1);; f1 = paramMotionEvent.getY(2)) {
      ...
      default: 
        return false;
      case 2: 
        f1 = wyg.a(f4, f2, f3, f1);
        i = new BigDecimal((f1 - this.b) / 20.0F).setScale(0, 4).intValue();
        if (i != 0)
        {
          wsv.a("NewStoryCameraZoom", "set camera zoom increase value %d", new Object[] { Integer.valueOf(i) });
          azcx.a().b(i);
          this.b = f1;
        }
        return true;
