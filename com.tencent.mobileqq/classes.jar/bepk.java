...
public class bepk
{
  ...
  @beqm(a="com.tencent.qqmini.sdk.launcher.AppUIProxy")
  private beqe jdField_a_of_type_Beqe;
  private besb jdField_a_of_type_Besb;
  @beqm(a="com.tencent.qqmini.sdk.ipc.AppBrandProxy")
  private bese jdField_a_of_type_Bese;
  @beqm(a="com.tencent.qqmini.sdk.launcher.AppBrandLaunchManager")
  private besf jdField_a_of_type_Besf;
  @beqm(a="com.tencent.qqmini.sdk.core.MiniAppEnv")
  private besh jdField_a_of_type_Besh;
  @beqm(a="com.tencent.qqmini.sdk.receiver.MainReceiverProxy")
  private besj jdField_a_of_type_Besj;
  @beqm(a="com.tencent.qqmini.sdk.core.log.LogImpl")
  private besk jdField_a_of_type_Besk;
  private String jdField_a_of_type_JavaLangString;
  @beqm(a="com.tencent.qqmini.sdk.minigame.ui.GameUIProxy")
  private beqe b;
  ...
  private Object a(Field paramField)
  {
    ...
    {
      return paramField;
      if (!paramField.isAnnotationPresent(beqm.class)) {
        break;
      }
      paramField.setAccessible(true);
      str = ((beqm)paramField.getAnnotation(beqm.class)).a();
      localObject = beqp.a().a(str);
  ...
  private void a()
  {
    ...
    //   33: aload_0
    //   34: aload 4
    //   36: invokespecial 106	bepk:a	(Ljava/lang/reflect/Field;)Ljava/lang/Object;
    //   39: pop
    //   40: aload_3
    //   41: arraylength
    //   42: istore_2
    ...
    //   65: aload_0
    //   66: aload 4
    //   68: invokespecial 106	bepk:a	(Ljava/lang/reflect/Field;)Ljava/lang/Object;
    //   71: astore 4
    //   73: aload 4
    //   75: ifnull +46 -> 121
    //   78: aload 4
    ...
    //   136: aload_0
    //   137: aload 4
    //   139: invokespecial 106	bepk:a	(Ljava/lang/reflect/Field;)Ljava/lang/Object;
    //   142: pop
    //   143: iload_1
    //   144: iconst_1
    //   145: iadd
    ...
    //   154: ldc 115
    //   156: aload 4
    //   158: invokestatic 121	besl:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   161: iload_1
    //   162: iconst_1
    //   163: iadd
    //   164: istore_1
    ...
    //   172: ldc 123
    //   174: aload 4
    //   176: invokestatic 121	besl:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   179: iload_1
    //   180: iconst_1
    //   181: iadd
    //   182: istore_1
    ...
    //   210: aload 5
    //   212: invokestatic 121	besl:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   215: goto -72 -> 143
    //   218: return
  ...
  public beqe a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    return this.jdField_a_of_type_Beqe;
  }
  
  public besb a()
  {
    return this.jdField_a_of_type_Besb;
  }
  
  public bese a()
  {
    return this.jdField_a_of_type_Bese;
  }
  
  public besf a()
  {
    return this.jdField_a_of_type_Besf;
  }
  
  public besh a()
  {
    return this.jdField_a_of_type_Besh;
  }
  
  public besj a()
  {
    return this.jdField_a_of_type_Besj;
  }
  
  public Class a(String paramString)
  {
    return beqp.a().a(paramString);
  }
  ...
  public String a()
  {
    ...
    for (;;)
    {
      ...
      {
        besl.d("minisdk-start", "getCurrentProcessName", localThrowable);
        localObject = str2;
      }
    }
  }
  ...
  public void a(Context paramContext)
  {
    ...
    beqp.a().a(paramContext);
    beqp.a().a();
    a();
    besl.a(this.jdField_a_of_type_Besk);
    this.jdField_a_of_type_Besh.init(paramContext);
    this.jdField_a_of_type_Bese.init(paramContext);
  }
  
  public void a(besb parambesb)
  {
    if (parambesb != null) {
  ...
  public String b()
  {
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        besl.d("minisdk-start", "getProcessName exception!", localThrowable);
      }
    }
    return this.jdField_a_of_type_JavaLangString;
  }
