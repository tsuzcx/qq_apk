  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new pnp(this);
  ...
  private pnn jdField_a_of_type_Pnn;
  private pnx jdField_a_of_type_Pnx;
  private pny jdField_a_of_type_Pny;
  ...
  public pno(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_Pny = new pny(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Pny);
    this.jdField_a_of_type_Pny.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Pny.a(new pnq(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new pnr(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Pny.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130848438);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130848439);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Pnx != null))
    {
      if (this.jdField_a_of_type_Pny.a() > 1)
      {
        this.jdField_a_of_type_Pnx.a();
        this.jdField_a_of_type_Pnx.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Pnx.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Pnx.b();
  }
  ...
  private void d()
  {
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new pnv(this));
      return;
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Pny == null) {
      return;
    }
    b();
  }
  ...
  {
    this.jdField_a_of_type_Pny.a(parampau);
    a();
  }
  
  public void a(pnn parampnn)
  {
    this.jdField_a_of_type_Pnn = parampnn;
  }
  
  public void a(poi parampoi)
  {
    this.jdField_a_of_type_Pny.a(parampoi);
  }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Pnx == null))
    {
      this.jdField_a_of_type_Pnx = new pnx();
      this.jdField_a_of_type_Pnx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Pnx.a(new pnu(this));
    }
    if (this.jdField_a_of_type_Pok == null)
    {
      this.jdField_a_of_type_Pok = new pok(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Pok);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Pny.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
  ...
  public boolean setAttribute(int paramInt, Object paramObject)
  {
    ...
    case 1052: 
      try
      {
        ...
        this.jdField_a_of_type_Pny.a(localList);
