  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Akos != null) {
        this.a.jdField_a_of_type_Akos.a(0);
      }
      long l = System.currentTimeMillis();
      if (akwv.a(ahwl.jdField_a_of_type_Long, l))
      {
        ahwl.jdField_a_of_type_Long = l;
        int m = blqo.a(paramView.getTag(2131378254), 0);
        ...
        {
          QLog.i(ahwl.jdField_a_of_type_JavaLangString, 2, "error, qqWalletMsg: " + localMessageForQQWalletMsg + ", sessionInfo: " + this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
        }
        else
        {
          ...
          for (;;)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(ahwl.jdField_a_of_type_JavaLangString, 2, "elem.actionsPriority: " + ((QQWalletBaseMsgElem)localObject1).actionsPriority);
            }
            int i;
            if (TextUtils.isEmpty(((QQWalletBaseMsgElem)localObject1).actionsPriority))
            {
              akwv.b(paramView.getContext(), ((QQWalletBaseMsgElem)localObject1).linkUrl);
              break;
            ...
            for (;;)
            {
              if ((localMessageForQQWalletMsg.fromHBList != 1) && ((localMessageForQQWalletMsg.istroop == 1) || (localMessageForQQWalletMsg.istroop == 3000)) && (localMessageForQQWalletMsg.mQQWalletRedPacketMsg != null)) {
                akrp.a(localMessageForQQWalletMsg.frienduin, localMessageForQQWalletMsg.istroop, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.redPacketId);
              }
              ...
              localMessageForQQWalletMsg.msgData = localMessageForQQWalletMsg.getBytes();
              this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localMessageForQQWalletMsg.uniseq, localMessageForQQWalletMsg.msgData);
              bcst.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "transferaccountmsg", "show", 0, 0, "" + localMessageForQQWalletMsg.mQQWalletRedPacketMsg.templateId, "", "", "");
              if ((((QQWalletBaseMsgElem)localObject4).skinId > 0) && ((localMessageForQQWalletMsg.messageType == 2) || (localMessageForQQWalletMsg.messageType == 3))) {
                bcst.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "wrap.aio.click", 0, 0, "" + ((QQWalletBaseMsgElem)localObject4).skinId, "", "", "");
              }
              localObject3 = localObject1;
              localObject1 = localObject4;
              break label323;
              ...
              for (;;)
              {
                for (;;)
                {
                  ...
                  try
                  {
                    ...
                    if (k == 1)
                    {
                      if (!akwv.b(paramView.getContext(), ((QQWalletBaseMsgElem)localObject1).linkUrl)) {
                        break label1098;
                      }
                      if (!QLog.isColorLevel()) {
                        break;
                      }
                      QLog.d(ahwl.jdField_a_of_type_JavaLangString, 2, "start browser...");
                    }
                  }
                  catch (Exception localException)
                  {
                    ...
                    for (;;)
                    {
                      ...
                      if (QLog.isColorLevel())
                      {
                        QLog.d(ahwl.jdField_a_of_type_JavaLangString, 2, "QQWalletMsgItemBuilder failed to convert String:" + localObject4[j] + " to Interger,", localException);
                        k = i;
                      }
                    }
                    if (k == 2)
                    {
                      String str = blqo.a(((QQWalletBaseMsgElem)localObject1).jumpUrl, ahwl.a(this.a, m), true);
                      if (!akwv.a(paramView.getContext(), str)) {
                        break label1098;
                      }
                      if (!QLog.isColorLevel()) {
                        break;
                      }
                      QLog.d(ahwl.jdField_a_of_type_JavaLangString, 2, "do jump action...");
                      break;
                    }
                    if ((k == 3) && (ahwl.a(this.a, paramView.getContext(), (QQWalletBaseMsgElem)localObject1, (String)localObject2, localObject3, localMessageForQQWalletMsg, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)))
                    {
                      if (!QLog.isColorLevel()) {
                        break;
                      }
                      QLog.d(ahwl.jdField_a_of_type_JavaLangString, 2, "do wallet action...");
                      break;
                    }
                    i = -1;
                  }
