...
public class ardw
{
  ...
  public static ardw a(araj[] paramArrayOfaraj)
  {
    ardw localardw = new ardw();
    int k;
    int i;
    try
    {
    ...
    {
      boolean bool;
      QLog.d("EmoticonTabSortConfProcessor", 2, "parse S$EConfBean failed!", paramArrayOfaraj);
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject2).has("setting_change_style")) {
          localardw.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("setting_change_style", 0);
        }
        ...
        if (((JSONObject)localObject2).has("setting_orders"))
        {
          ...
          localardw.jdField_a_of_type_JavaUtilList.clear();
          localardw.jdField_a_of_type_JavaUtilList.addAll(localArrayList);
        }
        if (((JSONObject)localObject2).has("face_orders"))
        {
          ...
          localardw.b.clear();
          localardw.b.addAll(localArrayList);
        }
      }
