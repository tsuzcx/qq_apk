...
public class apbd
{
  ...
  private ArrayList<WeakReference<apbf>> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public apbd(AppInterface paramAppInterface)
  {
  ...
  private boolean a()
  {
    ...
    {
      apbc localapbc = ((apbm)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(180)).a();
      if (this.jdField_a_of_type_Int + 1 > localapbc.b)
      {
          ...
          if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              if ((localWeakReference != null) && (localWeakReference.get() != null)) {
                ((apbf)localWeakReference.get()).a(paramString, false, false);
              }
            }
          }
        }
      ...
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          while (localIterator.hasNext())
          {
            WeakReference localWeakReference = (WeakReference)localIterator.next();
            if ((localWeakReference != null) && (localWeakReference.get() != null)) {
              ((apbf)localWeakReference.get()).a(paramString, true, true);
            }
          }
        }
      }
  ...
  public void a(apbf paramapbf)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        {
          WeakReference localWeakReference = (WeakReference)localIterator.next();
          if ((localWeakReference == null) || (localWeakReference.get() == null) || (localWeakReference.get() != paramapbf)) {
            continue;
          }
          i = 1;
          if (i == 0) {
            this.jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(paramapbf));
          }
          return;
        }
      }
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      localHttpNetReq.mCallback = new apbe(this);
