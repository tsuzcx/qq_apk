...
public class bhex
{
  private static bhex jdField_a_of_type_Bhex;
  ...
  public static bhex a()
  {
    if (jdField_a_of_type_Bhex == null) {}
    try
    {
      if (jdField_a_of_type_Bhex == null) {
        jdField_a_of_type_Bhex = new bhex();
      }
      return jdField_a_of_type_Bhex;
    }
    finally {}
  }
  ...
  private static String a()
  {
    ...
    try
    {
      localObject = avjc.b((String)localObject);
      return localObject;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        if (a().a())
        {
          ...
          {
            if (paramBoolean) {
              QQToast.a(paramActivity, 1, str, 1000).b(paramActivity.getResources().getDimensionPixelSize(2131299080));
            }
