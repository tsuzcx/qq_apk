...
public class blmi<K extends bllh>
  extends blly<K>
  implements bllz, blma, blmb
{
  private float jdField_a_of_type_Float;
  private int jdField_a_of_type_Int;
  private bmce jdField_a_of_type_Bmce;
  private String jdField_a_of_type_JavaLangString;
  private ArrayList<LocalMediaInfo> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Map<String, bllb> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  @Nullable
  private bllb a(@NonNull String paramString)
  {
    bmbx.a("AEPhotoListLogicBase", "[queryPhotoCropInfo]");
    if ((this.jdField_a_of_type_JavaUtilMap == null) || (this.jdField_a_of_type_JavaUtilMap.size() == 0)) {
      return null;
    }
    return (bllb)this.jdField_a_of_type_JavaUtilMap.get(paramString);
  }
  ...
  private URLDrawable a()
  {
    try
    {
      URLDrawable localURLDrawable = URLDrawableHelper.getDrawable("https://downv6.qq.com/shadow_qqcamera/Android/image/ae_camera_circle_no_photo_tip_light.png");
      return localURLDrawable;
    }
    catch (Exception localException)
    {
      bmbx.a("AEPhotoListLogicBase", "getNoPhotoTipDrawable---error: ", localException);
    }
    return null;
  }
  ...
  {
    bmbx.a("AEPhotoListLogicBase", "[prepareEditorPicInfo]");
    Object localObject = a(paramString);
    if ((localObject == null) || (((bllb)localObject).jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo == null))
    {
    ...
    return ((bllb)localObject).jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo;
  }
  ...
  private void a()
  {
    Intent localIntent = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
  ...
  private void a(bllo parambllo)
  {
    parambllo.c.setVisibility(0);
  }
  
  private void a(LocalMediaInfo paramLocalMediaInfo, bllo parambllo)
  {
    bmbx.a("AEPhotoListLogicBase", "[setSelected], photoPath=" + paramLocalMediaInfo.path);
    parambllo.jdField_a_of_type_Blln.onClick(parambllo.jdField_a_of_type_AndroidViewView);
  }
  
  private void a(@NonNull String paramString)
  {
    bmbx.a("AEPhotoListLogicBase", "[removePhotoCropInfo]");
    if ((this.jdField_a_of_type_JavaUtilMap != null) && (this.jdField_a_of_type_JavaUtilMap.size() > 0)) {
      this.jdField_a_of_type_JavaUtilMap.remove(paramString);
    }
  }
  
  private void a(@NonNull String paramString, @NonNull bllb parambllb)
  {
    bmbx.a("AEPhotoListLogicBase", "[addOrUpdatePhotoCropInfo], inner");
    this.jdField_a_of_type_JavaUtilMap.put(paramString, parambllb);
  }
  
  private void a(@NonNull String paramString, @NonNull EditorPicInfo paramEditorPicInfo, Matrix paramMatrix)
  {
    bmbx.a("AEPhotoListLogicBase", "[addOrUpdatePhotoCropInfo]");
    if (this.jdField_a_of_type_JavaUtilMap == null)
    {
      bmbx.a("AEPhotoListLogicBase", "[addOrUpdatePhotoCropInfo], cropInfoMap=null");
      return;
    }
    bllb localbllb = a(paramString);
    if (localbllb != null) {}
    for (;;)
    {
      localbllb.jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo = paramEditorPicInfo;
      localbllb.jdField_a_of_type_AndroidGraphicsMatrix = paramMatrix;
      a(paramString, localbllb);
      return;
      localbllb = new bllb();
    }
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setImageBitmap(BitmapUtils.decodeSampledBitmapFromFileCheckExif(paramString, 1440, 1440));
    if ((this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canMixPhotoAndVideo) && (((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a() == 1)) {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
    }
    this.jdField_a_of_type_Float = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
    this.jdField_b_of_type_Float = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.b();
    f(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a());
    bllb localbllb = a(paramString);
    if ((localbllb != null) && (localbllb.jdField_a_of_type_AndroidGraphicsMatrix != null) && (a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList, paramString))) {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setImageMatrix(localbllb.jdField_a_of_type_AndroidGraphicsMatrix);
    }
    for (;;)
    {
      if (paramBoolean) {
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
      }
      if (!f()) {
        break;
      }
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).d();
      return;
      a(paramString);
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).c();
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a());
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setVisibility(4);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.setVisibility(4);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(false);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).d();
      l();
      this.jdField_b_of_type_JavaLangString = null;
      return;
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    if (paramBoolean2)
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setVisibility(0);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.setVisibility(4);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(false);
      l();
      return;
    ...
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setVisibility(4);
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.setVisibility(0);
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).d();
  }
  ...
  private void b(int paramInt)
  {
    ...
    {
      bmbx.a("AEPhotoListLogicBase", "!currentFocusedImagePath.equals(mAllImages.get(position).path), position = " + paramInt);
      ...
      if (i >= 0) {
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.notifyItemChanged(i);
      }
    }
  }
  
  private void b(int paramInt, bllo parambllo)
  {
    boolean bool1 = true;
    bmbx.a("AEPhotoListLogicBase", "handlePhotoItemClick, position = " + paramInt);
    LocalMediaInfo localLocalMediaInfo = (LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    if ((!parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambllo.c.getVisibility() == 8))
    {
      bmbx.a("AEPhotoListLogicBase", "没有选中，没有focus，点击后变选中且focus, position = " + paramInt);
      ...
      {
        bmbx.a("AEPhotoListLogicBase", "handlePhotoItemClick, exceededPhotoLimit");
        a(localLocalMediaInfo, parambllo);
      }
    }
    label279:
    do
    {
      do
      {
        ...
        if (!bool1)
        {
          i = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetGridLayoutManager.findFirstVisibleItemPosition();
          paramInt = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildAt(paramInt - i).getTop();
          this.jdField_a_of_type_Int = (DisplayUtil.dip2px(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2.0F) + paramInt);
        }
        if (!this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canMixPhotoAndVideo)
        {
          if (bool1)
        ...
        {
          parambllo = localLocalMediaInfo.path;
          if (bool1) {
            break label279;
          }
        }
        ...
        if ((parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambllo.c.getVisibility() == 8))
        {
          bmbx.a("AEPhotoListLogicBase", "选中，没有focus，点击后变选中且focus, position = " + paramInt);
          a(parambllo);
          boolean bool2 = c();
          b(paramInt);
          if (!bool2)
        ...
        if ((parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambllo.c.getVisibility() == 0))
        {
          if (a().size() > 1)
          {
            bmbx.a("AEPhotoListLogicBase", "选中，有focus，选中的图大于一张，点击后变未选中且无focus, position = " + paramInt);
            b(parambllo);
            b(localLocalMediaInfo, parambllo);
            k();
            return;
          }
          bmbx.a("AEPhotoListLogicBase", "选中，有focus，选中的图只有这一张，点击后变未选但有focus, position = " + paramInt);
          b(localLocalMediaInfo, parambllo);
          ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.notifyDataSetChanged();
          return;
        }
      } while ((parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) || (parambllo.c.getVisibility() != 0));
      bmbx.a("AEPhotoListLogicBase", "没有选中，有focus，点击后变选中且focus, position = " + paramInt);
      a(localLocalMediaInfo, parambllo);
    } while (this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canMixPhotoAndVideo);
    c(0);
  }
  
  private void b(bllo parambllo)
  {
    parambllo.c.setVisibility(8);
  }
  
  private void b(LocalMediaInfo paramLocalMediaInfo, bllo parambllo)
  {
    parambllo.jdField_a_of_type_Blln.onClick(parambllo.jdField_a_of_type_AndroidViewView);
    bmbx.a("AEPhotoListLogicBase", "cancelSelected image.path = " + paramLocalMediaInfo.path);
    a(paramLocalMediaInfo.path);
  }
  
  private void b(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    bmbx.b("AEPhotoListLogicBase", "doShowPreviewVideo: " + paramString + ", autoPlay=" + paramBoolean2);
    if (paramBoolean1) {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
    }
    BaseVideoView localBaseVideoView = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
    if ((paramString != null) && (paramString.equals(this.jdField_b_of_type_JavaLangString)))
    {
      ...
      {
        bmbx.b("AEPhotoListLogicBase", "doShowPreviewVideo---same as the last previewed path, just resume play");
        localBaseVideoView.play();
      }
      bmbx.b("AEPhotoListLogicBase", "doShowPreviewVideo---same as the last previewed path, quick return");
    }
    do
    {
      return;
      ...
      localVideoPlayParam.mSceneName = azjn.a(113);
      localVideoPlayParam.mVideoPath = paramString;
      localVideoPlayParam.mCallback = new blmj(this, localVideoPlayParam, paramString);
  ...
  private void b(ArrayList<AEAlbumVideoModel> paramArrayList)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        bmbx.b("AEPhotoListLogicBase", "batchCompress---begin, index=" + k);
        ThreadManager.getUIHandler().post(new AEPhotoListLogicBase.17(this, k, j));
        a(localLocalMediaInfo, new blmm(this, k, localAEAlbumVideoModel));
  ...
  private void c(int paramInt)
  {
    ...
    {
      if (paramInt > 0) {
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.postDelayed(new AEPhotoListLogicBase.9(this), paramInt);
      }
    }
    else {
      return;
  ...
  {
    Activity localActivity = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity();
    Intent localIntent = localActivity.getIntent();
    if (blvr.m(localIntent))
    {
      bmbx.b("AEPhotoListLogicBase", "doRealJumpForMix---is additional pick case, setResult and finish");
    ...
    int i = blvr.y.a();
    if (blvr.k(localIntent)) {
      i = blvr.A.a();
    }
    bmct.a(localActivity, 2, localBundle, i);
  }
  
  private void d(int paramInt)
  {
    bmbx.b("AEPhotoListLogicBase", "handlePhotoRatioChanged---lastRatio=" + paramInt);
    label64:
    String str;
  ...
  {
    if (paramInt == 1) {
      QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getString(2131689675), 1).a();
    }
    while (paramInt != 2) {
      return;
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size() > 1) {
          bool1 = bmbk.a().a("sp_key_ae_ratio_toasted", true, 0);
        }
      }
    }
    return bool1;
  ...
  private void f(int paramInt)
  {
    if (paramInt == 1)
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setGestureEnabled(true);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setMinZoom(this.jdField_b_of_type_Float);
    }
    while (paramInt != 2) {
      return;
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setGestureEnabled(true);
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setMinZoom(this.jdField_a_of_type_Float);
  }
  ...
  private void j()
  {
    ...
    for (;;)
    {
      ...
      if (i > 0) {
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.post(new AEPhotoListLogicBase.1(this, i));
      }
      return;
      label160:
      ...
      continue;
      label177:
      bmbx.b("AEPhotoListLogicBase", "changeFocusAndPreviewWhenDataChanged---already picked some items, preview won't change");
      return;
      label186:
      localObject = null;
      i = -1;
  ...
  private void k()
  {
    ...
    if (!a().isEmpty())
    {
      bmbx.a("AEPhotoListLogicBase", "mPhotoCommonData.selectedPhotoList.size() = " + a().size());
    ...
    for (;;)
    {
      bmbx.a("AEPhotoListLogicBase", "!mPhotoCommonData.selectedPhotoList.isEmpty(), lastImagePosition = " + i);
      if (i >= 0)
      {
  ...
  private void l()
  {
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.releasePlayer(false);
  }
  ...
  private void o()
  {
    ...
    do
    {
      ...
      localObject = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a((EditorPicInfo)localObject);
      localMatrix = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
  ...
  private void p()
  {
    ...
    if (!CollectionUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        bmbx.b("AEPhotoListLogicBase", "clearSelectedData---failed get media info at first, try another way");
        localObject = a(str);
      }
    }
    label161:
    for (;;)
    {
      ...
      bmbx.d("AEPhotoListLogicBase", "clearSelectedData---still failed to get media info");
      break;
  ...
  private void q()
  {
    ...
    if (i < ((List)localObject).size())
    {
      ...
      if (TextUtils.isEmpty(str)) {
        bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForOnlyPhoto--empty path, drop it: " + str);
      }
      for (;;)
      {
        i += 1;
        break;
        bllb localbllb = a(str);
        if ((localbllb == null) || (localbllb.jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo == null)) {
          bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForOnlyPhoto--no crop info, drop it: " + str);
        } else if (!new File(str).exists()) {
          bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForOnlyPhoto--file not exists, drop it: " + str);
        } else {
          localArrayList.add(localbllb.jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo);
        }
      }
    }
    if (CollectionUtils.isEmpty(localArrayList))
    {
      QQToast.a(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2131689744, 0).a();
      return;
    }
    localObject = new Bundle();
    ((Bundle)localObject).putSerializable("AEEditorConstants_CLIPPED_PIC_INFOS", localArrayList);
    i = blvr.y.a();
    if (blvr.k(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent())) {
      i = blvr.A.a();
    }
    bmct.a(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 0, (Bundle)localObject, i);
  }
  ...
  private void r()
  {
    ...
    if (i < localLinkedList.size())
    {
      ...
      if (TextUtils.isEmpty(str1)) {
        bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForMixPhotoAndVideo--empty path, drop it: " + str1);
      }
      for (;;)
      {
        i += 1;
        ...
        {
          bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForMixPhotoAndVideo--file not exists, drop it: " + str1);
        }
        else
        {
          ...
          if ((localObject != null) && (QAlbumUtil.getMediaType((LocalMediaInfo)localObject) == 1))
          {
            ...
            if ((j == 2) || (j == 0))
            {
              ...
              if (j == 2)
              {
                ...
                {
                  bmbx.a("AEPhotoListLogicBase", "hit cache, no need compress for: " + str1);
            ...
            {
              bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForMixPhotoAndVideo--not supported video, drop it: " + str1);
            }
          }
          else
          {
            localObject = a(str1);
            if ((localObject == null) || (((bllb)localObject).jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo == null)) {
              bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForMixPhotoAndVideo--no crop info, drop it: " + str1);
            } else {
              localArrayList1.add(new AEAlbumImageModel(str1, ((bllb)localObject).jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo));
            }
          }
        }
      }
    ...
    {
      bmbx.d("AEPhotoListLogicBase", "handleClickNextBtnForMixPhotoAndVideo--no media selected, should NOT happen");
      QQToast.a(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2131689745, 0).a();
      return;
    }
    ...
    {
      this.jdField_a_of_type_Bmce = new bmce(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity());
      this.jdField_a_of_type_Bmce.a(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131719467));
      this.jdField_a_of_type_Bmce.a(new blmk(this));
    }
    this.jdField_a_of_type_Bmce.show();
    bmbx.a("AEPhotoListLogicBase", "after show, submit compress task");
    ThreadManagerV2.excute(new AEPhotoListLogicBase.15(this, localArrayList2, localArrayList1), 16, new blml(this), true);
  }
  
  public View a()
  {
    View localView = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558486, null);
    localView.setLayoutParams(new ViewGroup.LayoutParams(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Int, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Int));
    return localView;
  }
  ...
  String a(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    return ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131694431, new Object[] { Integer.valueOf(i) });
  }
  ...
  public List<LocalMediaInfo> a()
  {
    ...
    List localList2 = QAlbumUtil.getAlbumMedias(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName, i, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.filterVideoDurationLimit);
  ...
  {
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumPreviewMaskLayout.setAlpha(paramFloat);
    paramFloat = 1.0F - paramFloat;
    if ((this.jdField_a_of_type_Int != 0) && (this.jdField_b_of_type_Int == 2)) {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.scrollBy(0, (int)(this.jdField_a_of_type_Int * (paramFloat - this.jdField_c_of_type_Float)));
    }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumPreviewMaskLayout.setVisibility(0);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).d();
      if (this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canSwitchSelectionMode) {
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      }
    }
  }
  
  protected void a(int paramInt, bllo parambllo)
  {
    bmbx.a("AEPhotoListLogicBase", "handleVideoItemClickForMix, position = " + paramInt);
    LocalMediaInfo localLocalMediaInfo = (LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    if ((!parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambllo.c.getVisibility() == 8))
    {
      bmbx.a("AEPhotoListLogicBase", "没有选中，没有focus，点击后变选中且focus, position = " + paramInt);
      if ((a() != null) && (a().size() + this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.initialHasPickedNum >= this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum))
      {
        bmbx.a("AEPhotoListLogicBase", "handleVideoItemClickForMix, exceededPhotoLimit");
        a(localLocalMediaInfo, parambllo);
      }
    }
    int i;
  ...
  public void a(int paramInt, bllo parambllo, blln paramblln)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum > 100) {
      parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setTextSize(10.0F);
    }
    parambllo.jdField_a_of_type_Blln = paramblln;
    Object localObject1;
    label327:
    int i;
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_JavaLangString = ((LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).path;
      parambllo.c.setVisibility(0);
      if ((!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isSingleMode) && (parambllo.jdField_a_of_type_AndroidViewView != null)) {
        parambllo.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      paramblln = new blmn(this, parambllo, paramInt);
      parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setOnTouchListener(paramblln);
      parambllo.jdField_a_of_type_AndroidViewView.setOnTouchListener(paramblln);
      parambllo.jdField_a_of_type_Blln.a(paramInt);
      parambllo.jdField_a_of_type_Blln.a(parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
      parambllo.itemView.setOnClickListener(new blmo(this, paramInt, parambllo));
      localObject1 = parambllo.jdField_b_of_type_AndroidWidgetImageView;
      ((ImageView)localObject1).setAdjustViewBounds(false);
      paramblln = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.a(paramInt);
      Object localObject2 = QAlbumUtil.createContentDescription(0, paramblln, paramInt);
      parambllo.itemView.setContentDescription((CharSequence)localObject2);
      if (paramblln != null)
      {
        parambllo.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.showGifTypeIcon) || (!((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramblln))) {
          break label739;
        }
        if (parambllo.jdField_b_of_type_AndroidWidgetTextView == null)
        {
          parambllo.jdField_b_of_type_AndroidWidgetTextView = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.a();
          parambllo.jdField_b_of_type_AndroidWidgetTextView.setText("GIF");
          localObject2 = new RelativeLayout.LayoutParams(-2, -2);
          ((RelativeLayout.LayoutParams)localObject2).addRule(11);
          ((RelativeLayout.LayoutParams)localObject2).addRule(12);
          ((RelativeLayout)parambllo.itemView).addView(parambllo.jdField_b_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject2);
        }
        parambllo.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        i = AlbumThumbDownloader.THUMB_WIDHT;
        paramblln.thumbHeight = i;
        paramblln.thumbWidth = i;
        localObject2 = parambllo.jdField_a_of_type_ComTencentImageURLDrawable;
        StringBuilder localStringBuilder = new StringBuilder("albumthumb");
        localStringBuilder.append("://");
        localStringBuilder.append(paramblln.path);
        if ((localObject2 == null) || (!((URLDrawable)localObject2).getURL().toString().equals(localStringBuilder.toString())))
        {
          localObject2 = QAlbumUtil.generateAlbumThumbURL(paramblln);
          if (QLog.isColorLevel()) {
            QLog.d("PhotoListActivity", 2, "photoGridAdapter,getView(),image url :" + ((URL)localObject2).toString());
          }
          localObject2 = URLDrawableHelper.getDrawable((URL)localObject2, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          ((URLDrawable)localObject2).setTag(paramblln);
          ((ImageView)localObject1).setImageDrawable((Drawable)localObject2);
          ((URLImageView)localObject1).setURLDrawableDownListener(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm);
          parambllo.jdField_a_of_type_ComTencentImageURLDrawable = ((URLDrawable)localObject2);
        }
        i = paramblln.selectStatus;
        if (i != 1) {
          break label758;
        }
        parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setCheckedNumber(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.indexOf(paramblln.path) + 1 + this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.initialHasPickedNum);
        if (parambllo.itemView.getBackground() != null) {
          parambllo.itemView.setBackgroundDrawable(null);
        }
      }
    }
    for (;;)
    {
      ...
      {
        localObject1 = QAlbumUtil.createContentDescriptionWithCheckBox(0, paramblln, paramInt, parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked());
        parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setContentDescription((CharSequence)localObject1);
      }
      paramblln.visableTime = SystemClock.uptimeMillis();
      paramblln.listViewPosition = paramInt;
      a(parambllo, paramblln);
      ...
      parambllo.jdField_b_of_type_AndroidWidgetImageView.setAlpha(0.3F);
      return;
      paramblln = parambllo.c;
      if (this.jdField_a_of_type_JavaLangString.equals(((LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).path)) {}
      for (i = 0;; i = 8)
      {
        paramblln.setVisibility(i);
        break;
      }
      label739:
      if (parambllo.jdField_b_of_type_AndroidWidgetTextView == null) {
      ...
      parambllo.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      break label327;
      label758:
      if (i == 3)
      {
        parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
      }
      else
      {
        parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
    ...
    label804:
    parambllo.jdField_b_of_type_AndroidWidgetImageView.setAlpha(1.0F);
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumPreviewMaskLayout.setVisibility(8);
      if (!f()) {
        break label85;
      }
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).d();
    ...
    {
      if (this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canSwitchSelectionMode) {
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      }
      return;
      label85:
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).c();
  ...
  public void a(Intent paramIntent)
  {
    ...
    for (Object localObject = QAlbumCustomAlbumConstants.RECENT_ALBUM_NAME_VIDEO;; localObject = QAlbumCustomAlbumConstants.RECENT_ALBUM_NAME)
    {
      ...
      this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.initialHasPickedNum = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getIntExtra("BUNDLE_KEY_CIRCLE_HAS_PICKED_NUM", 0);
      this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canPickVideo = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("BUNDLE_KEY_CIRCLE_CAN_PICK_VIDEO", true);
      a();
      bmbx.b("AEPhotoListLogicBase", "initData---aeAlbumData=" + this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData);
      return;
  ...
  public void a(View paramView)
  {
    ...
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().finish();
    QAlbumUtil.anim(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), false, false);
  }
  ...
  {
    bmbx.b("AEPhotoListLogicBase", "checkShowImagePreview--");
    if (!paramBoolean2)
    {
      a(paramString, paramBoolean1);
      return;
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.post(new AEPhotoListLogicBase.10(this, paramString, paramBoolean1));
  }
  
  protected void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    bmbx.b("AEPhotoListLogicBase", "checkShowVideoPreview--");
    if (!paramBoolean2)
    {
      b(paramString, paramBoolean1, paramBoolean3);
      return;
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.post(new AEPhotoListLogicBase.11(this, paramString, paramBoolean1, paramBoolean3));
  }
  ...
  {
    a();
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).b(paramBoolean);
    int i;
    if (paramBoolean)
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).d();
      i = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
      if (i == 1)
      {
        d(i);
        ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
  ...
  void a(boolean paramBoolean, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      PhotoListBaseData.sPhotoListFirstPos = ((GridLayoutManager)((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
      paramIntent.setClass(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).a());
      paramIntent.addFlags(603979776);
      c(paramIntent);
      QAlbumUtil.anim(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), true, true);
      return;
  ...
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity() == null)) {
      return false;
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.6(this));
    Object localObject;
    if (paramList == null)
    {
      ...
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.a((List)localObject);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.7(this));
      return false;
    }
    ...
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.a(paramList);
    boolean bool = paramList.isEmpty();
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.8(this, bool));
    return true;
  }
  
  public View b()
  {
    View localView = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558487, null);
    localView.setLayoutParams(new ViewGroup.LayoutParams(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Int, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Int));
    return localView;
  }
  ...
  public void b(int paramInt, bllo parambllo, blln paramblln)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum > 100) {
      parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setTextSize(10.0F);
    }
    ...
    if (this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canMixPhotoAndVideo) {
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        parambllo.c.setVisibility(0);
        parambllo.jdField_a_of_type_Blln = paramblln;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isSingleMode) || (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isSupportVideoCheckbox) || (parambllo.jdField_a_of_type_AndroidViewView == null)) {
          break label652;
        }
        parambllo.jdField_a_of_type_AndroidViewView.setVisibility(0);
        paramblln = new blmp(this, parambllo, paramInt);
        parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setOnTouchListener(paramblln);
        parambllo.jdField_a_of_type_AndroidViewView.setOnTouchListener(paramblln);
        parambllo.itemView.setOnClickListener(new blmq(this, parambllo, paramInt));
        parambllo.jdField_a_of_type_Blln.a(paramInt);
        parambllo.jdField_a_of_type_Blln.a(parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
        ImageView localImageView = parambllo.jdField_b_of_type_AndroidWidgetImageView;
        localImageView.setAdjustViewBounds(false);
        localObject = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.a(paramInt);
        paramblln = QAlbumUtil.createContentDescription(1, (LocalMediaInfo)localObject, paramInt);
        parambllo.itemView.setContentDescription(paramblln);
        if (!((LocalMediaInfo)localObject).isSystemMeidaStore) {
          break label664;
        }
        paramblln = QAlbumUtil.generateAlbumThumbURL((LocalMediaInfo)localObject, "VIDEO");
        i = AlbumThumbDownloader.THUMB_WIDHT;
        ((LocalMediaInfo)localObject).thumbHeight = i;
        ((LocalMediaInfo)localObject).thumbWidth = i;
        URLDrawable localURLDrawable = parambllo.jdField_a_of_type_ComTencentImageURLDrawable;
        if ((localURLDrawable == null) || (!localURLDrawable.getURL().equals(paramblln)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("PhotoListActivity", 2, "PhotoListAdapter,getView(),vedio url :" + paramblln.toString());
          }
          paramblln = URLDrawableHelper.getDrawable(paramblln, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          paramblln.setTag(localObject);
          localImageView.setImageDrawable(paramblln);
          ((URLImageView)localImageView).setURLDrawableDownListener(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm);
          parambllo.jdField_a_of_type_ComTencentImageURLDrawable = paramblln;
          if (localURLDrawable != null) {
            localURLDrawable.cancelDownload();
          }
        }
        paramblln = parambllo.jdField_a_of_type_AndroidWidgetTextView;
        if ((((LocalMediaInfo)localObject).isSystemMeidaStore) || (((LocalMediaInfo)localObject).mDuration > 0L)) {
          break label676;
        }
        paramblln.setVisibility(8);
        paramblln = MediaScanner.getInstance(BaseApplicationImpl.getContext());
        if (paramblln != null) {
          paramblln.queryMediaInfoDuration(this, (LocalMediaInfo)localObject, paramInt);
        }
        label448:
        ...
        parambllo.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setCheckedNumber(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.indexOf(((LocalMediaInfo)localObject).path) + 1 + this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.initialHasPickedNum);
        if (parambllo.itemView.getBackground() != null) {
          parambllo.itemView.setBackgroundDrawable((Drawable)null);
        }
      }
    }
    for (;;)
    {
      ...
      break;
      label652:
      parambllo.jdField_a_of_type_AndroidViewView.setVisibility(8);
      break label110;
      label664:
      paramblln = QAlbumUtil.generateAlbumThumbURL((LocalMediaInfo)localObject, "APP_VIDEO");
      break label237;
      label676:
      paramblln.setVisibility(0);
      paramblln.setText(AbstractPhotoListActivity.formatTimeToString(((LocalMediaInfo)localObject).mDuration));
      break label448;
      label696:
      if (i == 3)
      {
  ...
  {
    a(false, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent());
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      int i = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetGridLayoutManager.findFirstVisibleItemPosition();
      i = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildAt(0 - i).getTop();
      this.jdField_a_of_type_Int = (DisplayUtil.dip2px(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2.0F) + i);
    }
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
  }
  ...
  public View c()
  {
    ImageView localImageView = new ImageView(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity());
    localImageView.setLayoutParams(new ViewGroup.LayoutParams(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Int, ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Int));
    localImageView.setBackgroundColor(-16777216);
    localImageView.setImageResource(2130841519);
  ...
  public void c()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      bmbc.a().a(this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canMixPhotoAndVideo);
      return;
    }
  }
  
  public void c(int paramInt, bllo parambllo, blln paramblln) {}
  
  public void c(Intent paramIntent)
  {
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).startActivity(paramIntent);
    ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().finish();
  }
  ...
  protected boolean c()
  {
    return ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.a();
  }
  
  public void d()
  {
    TextView localTextView = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetTextView;
    if (this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.canSwitchSelectionMode) {}
    for (int i = 0;; i = 8)
    {
  ...
  {
    int i = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
    if (i == 1) {
      bmbc.a().e(0);
    }
    for (;;)
    {
      if (e())
      {
        bmbk.a().a("sp_key_ae_ratio_toasted", false, 0);
        e(i);
      }
      d(i);
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
  ...
  public void e()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      return;
      str = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131694416);
      break;
    }
  }
  ...
  public void f()
  {
    ...
    {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.13(this));
      return;
    }
  ...
  public void g()
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.backPressed) {
      AlbumThumbManager.getInstance(((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity()).clear();
    }
    if (((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm != null)
    {
      int i = ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bllm.getItemCount();
    ...
    if (((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidOsAsyncTask != null) {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidOsAsyncTask.cancel(true);
    }
    if (this.jdField_a_of_type_JavaUtilMap != null) {
  ...
  public void h()
  {
    if (((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b()) {
      ((bllh)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
    }
  }
