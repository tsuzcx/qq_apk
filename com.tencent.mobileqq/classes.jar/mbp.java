  ...
  extends lgl
{
  ...
  {
    if (this.a.jdField_a_of_type_Mhf != null) {
      this.a.jdField_a_of_type_Mhf.a(paramInt);
    }
  }
  ...
  {
    if (this.a.jdField_a_of_type_Mhf != null) {
      this.a.jdField_a_of_type_Mhf.a(paramInt1, paramInt2);
    }
  }
  ...
  protected void a(long paramLong)
  {
    ...
    liz.a(31);
    String str1 = locallgf.jdField_d_of_type_JavaLangString;
    ...
    {
      bool1 = true;
      QLog.w(str2, 1, bool1 + "], peerUin[" + str1 + "], mShutCamera[" + this.a.f + "], SessionType[" + locallgf.jdField_d_of_type_Int + "], seq[" + paramLong + "]");
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null)
      {
        ...
        if ((2 == locallgf.jdField_d_of_type_Int) || (this.a.g)) {
  ...
  protected void a(long paramLong, int paramInt, String paramString)
  {
    ...
    if ((paramString != null) && (!muf.a(paramString, this.a.c))) {
      return;
    }
    if ((paramInt == 49) && (this.a.jdField_a_of_type_ComTencentAvVideoController != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().A) && (this.a.jdField_a_of_type_Miq != null)) {
      this.a.jdField_a_of_type_Miq.c();
    }
    if ((this.a.jdField_a_of_type_Mcd != null) && (this.a.jdField_a_of_type_Mcd.a())) {
    ...
    lcl.c(this.a.jdField_b_of_type_JavaLangString, "DataReport onClose: ");
    liw.a(this.a.jdField_b_of_type_JavaLangString, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    axqo.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    lhz.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString);
    lhz.a(2, paramString);
    lhz.a(2);
  ...
  {
    if (this.a.jdField_a_of_type_Mhf != null) {
      this.a.jdField_a_of_type_Mhf.a(paramLong1, paramLong2, paramLong3);
    }
  }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          lcl.d(this.a.jdField_b_of_type_JavaLangString, "onDestroyUI, peerUin[" + paramString + "], isQuit[" + paramBoolean + "], mPeerUin[" + this.a.c + "], mIsDoubleVideoMeeting[" + this.a.g + "], mSessionType[" + this.a.jdField_b_of_type_Int + "], mSessionId[" + this.a.jdField_a_of_type_JavaLangString + "], mRelationId[" + this.a.jdField_d_of_type_JavaLangString + "], seq[" + l + "], \nsession[" + locallgf + "]");
          ...
          if ((this.a.c != null) && (paramString != null) && (this.a.c.equals(paramString)))
          {
            ...
            lcl.d(this.a.jdField_b_of_type_JavaLangString, "onDestroyUI exit 1");
            this.a.finish();
            this.a.b(true);
            if (paramBoolean) {
              break label349;
          ...
          {
            paramString = bbjn.a(this.a.getApplicationContext()).edit();
            paramString.putInt("video_position", this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.g());
            paramString.commit();
            mqz.a(this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.g());
            return;
    ...
    this.a.jdField_e_of_type_Boolean = paramBoolean;
    lcl.d(this.a.jdField_b_of_type_JavaLangString, "onDestroyUI exit 2");
    this.a.b(l);
    this.a.h = true;
    this.a.finish();
    this.a.b(true);
  ...
  {
    if (this.a.jdField_a_of_type_Mhf != null) {
      this.a.jdField_a_of_type_Mhf.a(paramBoolean, paramInt1, paramString, paramInt2);
    }
  }
  ...
  protected void b(long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString.equals(this.a.c)) {
      mtt.a().a(paramLong, "DEVICE_SPEAKERPHONE");
    }
    if ((this.a.jdField_a_of_type_Miq != null) && (this.a.jdField_a_of_type_Miq.d() != 1)) {
  ...
  {
    lcl.d(this.a.jdField_b_of_type_JavaLangString, "onFinish peerUin = " + paramString + " # isQuit :" + paramBoolean + "|" + this.a.jdField_b_of_type_Int + "|" + this.a.c);
    if ((this.a.jdField_b_of_type_Int == 1) || (this.a.jdField_b_of_type_Int == 2)) {
      if ((this.a.c != null) && (paramString != null) && (this.a.c.equals(paramString)))
      {
        this.a.jdField_e_of_type_Boolean = paramBoolean;
  ...
  protected void c()
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Mhf != null) {
        this.a.jdField_a_of_type_Mhf.c();
      }
      if (this.a.jdField_a_of_type_Mlo != null) {
        this.a.jdField_a_of_type_Mlo.b();
      }
      boolean bool5;
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController != null) && (this.a.jdField_a_of_type_Miq != null) && (this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils != null))
      {
        bool1 = locallgf.s;
        boolean bool2 = this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils.b(l);
        boolean bool3 = locallgf.k;
        boolean bool4 = locallgf.A;
        bool5 = locallgf.B;
        ...
        if ((bool1) || (!bool3))
        {
          ...
          if (!bool1)
          {
            mns.a("0X8008ACB");
            if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131696063);
            }
          }
        }
      }
  ...
  protected void c(int paramInt)
  {
    ...
    int i = bbyt.a();
    String str = bbyt.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, i, null);
    if (str == null) {}
    do
    {
      return;
      ...
      if ((localFile != null) && (localFile.exists()) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().g != 4) && (this.a.jdField_b_of_type_Int == 1) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() != null))
      {
        ...
        if (this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView == null) {
          this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView = bbyt.a((Activity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), (RelativeLayout)this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent(), false);
        }
        if (!bbyt.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext(), this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView, str, i, this.a.jdField_a_of_type_Bbyz, paramInt, false)) {}
      }
  ...
  protected void c(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label318:
      if ((bool) && (this.a.jdField_a_of_type_Mck != null)) {
        this.a.jdField_a_of_type_Mck.a("self", String.valueOf(3));
      }
    }
  }
