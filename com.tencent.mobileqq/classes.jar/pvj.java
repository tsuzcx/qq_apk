...
public class pvj
{
  private long a(String paramString)
  {
    ...
    return ((SharedPreferences)localObject).getLong("event_simple_g_info_" + pvk.a(paramString), -1L);
  }
  ...
  private void a(String paramString, long paramLong)
  {
    ...
    ((SharedPreferences.Editor)localObject).putLong("event_simple_g_info_" + pvk.a(paramString), paramLong);
  ...
  private void a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    while ((paramTroopInfo.timeSec == a(paramTroopInfo.troopuin)) && (!pvi.a().a)) {
      return;
    }
    ...
    bctj.a(null).a(paramString, "event_simple_g_info", false, 1000L, 1000L, localHashMap, null);
