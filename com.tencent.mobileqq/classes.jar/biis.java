...
public class biis
{
  ...
  private static Map<String, biit> b;
  ...
  public static List<biit> a()
  {
    ...
    if ((localObject != null) && (!((Map)localObject).isEmpty()))
    {
      ...
      {
        biit localbiit = (biit)((Iterator)localObject).next();
        if (localbiit.jdField_a_of_type_Int >= 0) {
          localArrayList.add(localbiit);
        }
      }
  ...
  public static Map<String, biit> a()
  {
    if (b == null) {
      a();
    }
  ...
  {
    String str = bdcs.a(new File(a(), "vipComic_nav_config.json"));
      ...
      try
      {
        ...
        if (localJSONObject1 != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((localJSONObject2 == null) || (!befr.a(localJSONObject2, str))) {
              break label247;
            }
            localObject = new biit();
            ((biit)localObject).jdField_a_of_type_JavaLangString = localJSONObject2.optString("tabKey");
            if ((TextUtils.isEmpty(((biit)localObject).jdField_a_of_type_JavaLangString)) && (jdField_a_of_type_JavaUtilMap.containsKey(str))) {
              ((biit)localObject).jdField_a_of_type_JavaLangString = ((String)jdField_a_of_type_JavaUtilMap.get(str));
            }
            ((biit)localObject).jdField_a_of_type_Int = localJSONObject2.optInt("sequence");
            ((biit)localObject).b = localJSONObject2.optString("tabName");
            ((biit)localObject).c = localJSONObject2.optString("tabUrl");
            ((biit)localObject).d = localJSONObject2.optString("tabIcon");
    ...
    if ((localObject1 != null) && (!((Map)localObject1).isEmpty()))
    {
      ...
      if ((localObject2 != null) && (localObject2.length > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext()) {
          if (!((List)localObject2).contains(((biit)((Iterator)localObject1).next()).d)) {
            return false;
          }
        }
        return true;
