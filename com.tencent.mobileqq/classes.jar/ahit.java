...
public class ahit
  extends alsi
{
  public ahit(SystemMsgListView paramSystemMsgListView) {}
  
  protected void a(String paramString)
  {
    if (this.a.jdField_a_of_type_Ahgn.a())
    {
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131720539);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localStructMsg = baaz.a().a(Long.valueOf(l1));
        if (this.a.jdField_a_of_type_Ahgn.a()) {
          break label90;
        }
      ...
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          babb.a(localStructMsg, paramInt3, paramString2, paramString4);
          return;
          paramString3 = SystemMsgListView.a(this.a).getResources().getString(2131719743);
        }
      }
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131692864);
      QQToast.a(SystemMsgListView.a(this.a), 2, paramString1, 0).b(this.a.a());
      long l2 = baaz.a().a();
      babb.a(localStructMsg, paramInt1, paramString2, paramInt2);
      if ((l2 != 0L) && (localStructMsg != null)) {}
      try
      {
        this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(aljq.M, 0, l2, localStructMsg.toByteArray());
        ...
        if (avpz.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(this.a.jdField_a_of_type_Ahgn.getActivity(), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
