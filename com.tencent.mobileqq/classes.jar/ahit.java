  ...
  extends amwl
{
  ...
  private void a(int paramInt)
  {
    ...
    QQToast.a(this.a.mActivity, this.a.mActivity.getString(2131717760), 0).b(this.a.mActivity.getTitleBarHeight());
  }
  ...
  protected void onSendResult(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    if (this.a.c)
    {
      ...
      paramString.what = 39;
      paramString.obj = this.a.d;
      this.a.getUIHandler().removeMessages(39);
      this.a.getUIHandler().sendMessage(paramString);
    }
    ThreadManagerV2.excute(new NearbyChatPieObserver.1(this, paramBoolean, this.a.mActivity.getIntent().getStringExtra("NEARBY_MSG_REPORT_SOURCE"), (awhw)this.a.app.getManager(106)), 16, null, false);
  }
