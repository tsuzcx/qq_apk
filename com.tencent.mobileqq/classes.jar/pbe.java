...
public class pbe
  implements ozw
{
  private static Map<String, pbe> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private bkfu<Pair<String, BaseCommentData>> jdField_a_of_type_Bkfu = new bkfu();
  ...
  private pcr jdField_a_of_type_Pcr = new pcr();
  private pcu jdField_a_of_type_Pcu;
  private pcy jdField_a_of_type_Pcy = new pcy();
  ...
  private List<pcp> jdField_e_of_type_JavaUtilList = new ArrayList();
  ...
  private pbe(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = "";
    paramString = pha.a();
    if (paramString != null)
    {
      this.jdField_a_of_type_Pcq = ((pmm)paramString.getManager(163)).a().a();
      this.jdField_a_of_type_Pcq.a(this);
    }
    this.jdField_a_of_type_Pcu = new pcu();
    this.jdField_a_of_type_Pcu.a(this);
    a(this.jdField_a_of_type_Pcy);
  }
  ...
  private List<pay> a(int paramInt, List<BaseCommentData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new pay(paramInt, a(localBaseCommentData), localBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    }
    return localArrayList;
  }
  
  private List<pay> a(boolean paramBoolean, BaseCommentData paramBaseCommentData, List<SubCommentData> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramBoolean)
    {
      localArrayList.add(new pay(0, paramBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      localArrayList.add(new pay(3, paramBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    }
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (paramBaseCommentData.hasNext())
      {
        ...
        for (int i = 4;; i = 0)
        {
          localArrayList.add(new pay(i, paramList, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
          break;
        }
      }
    }
  ...
  public static pbe a(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo == null) {
      return null;
    }
    return (pbe)jdField_a_of_type_JavaUtilMap.get(paramArticleInfo.innerUniqueID);
  }
  
  public static pbe a(ArticleInfo paramArticleInfo, int paramInt)
  {
    if (paramArticleInfo == null) {
      localObject = null;
    }
    ...
    {
      return localObject;
      localpbe = (pbe)jdField_a_of_type_JavaUtilMap.get(paramArticleInfo.innerUniqueID);
      localObject = localpbe;
    } while (localpbe != null);
    Object localObject = new pbe(paramArticleInfo.innerUniqueID);
    ((pbe)localObject).b(paramArticleInfo);
    ((pbe)localObject).jdField_a_of_type_Int = paramInt;
    if (paramInt == 1)
    {
      ((pbe)localObject).jdField_a_of_type_JavaLangString = (paramArticleInfo.mArticleID + "");
      ((pbe)localObject).jdField_g_of_type_JavaLangString = (paramArticleInfo.mArticleID + "");
    }
    for (;;)
    {
      jdField_a_of_type_JavaUtilMap.put(paramArticleInfo.innerUniqueID, localObject);
      ((pbe)localObject).h = paramArticleInfo.innerUniqueID;
      ...
      return localObject;
      ((pbe)localObject).jdField_a_of_type_JavaLangString = paramArticleInfo.innerUniqueID;
      ((pbe)localObject).h = paramArticleInfo.innerUniqueID;
    }
  }
  
  public static pbe a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return (pbe)jdField_a_of_type_JavaUtilMap.get(paramString);
  }
  
  private void a(int paramInt, String paramString1, String paramString2)
  {
    if ((this.jdField_a_of_type_Pcq == null) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      a(new pbi(this, paramInt));
      return;
    }
    ...
    this.jdField_a_of_type_Pcq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID, paramString1, paramString2, this.jdField_c_of_type_JavaLangString, 10, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataCommonCommentData);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      return;
      paramArticleInfo = (pbe)jdField_a_of_type_JavaUtilMap.remove(paramArticleInfo.innerUniqueID);
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt)
  {
    if (paramInt == 6)
    {
      paramArticleInfo = (pbe)jdField_a_of_type_JavaUtilMap.get(paramArticleInfo.innerUniqueID);
      if (paramArticleInfo != null) {
        paramArticleInfo.e();
      }
  ...
  private void a(List<pcp> paramList, boolean paramBoolean, pcm parampcm)
  {
    int i = 0;
    if (i < paramList.size())
    {
      pcp localpcp = (pcp)paramList.get(i);
      if (paramBoolean) {
        ThreadManager.getUIHandler().post(new ReadInJoyCommentDataManager.34(this, parampcm, localpcp));
      }
      for (;;)
      {
        i += 1;
  ...
  private void a(pcm parampcm)
  {
    a(parampcm, true);
  }
  
  private void a(pcm parampcm, boolean paramBoolean)
  {
    if ((!this.jdField_e_of_type_JavaUtilList.isEmpty()) && (parampcm != null)) {
      a(this.jdField_e_of_type_JavaUtilList, paramBoolean, parampcm);
    }
    ArrayList localArrayList = new ArrayList();
    if (oyp.a().a() != null) {
      localArrayList.addAll(oyp.a().a());
    }
    if ((localArrayList != null) && (parampcm != null)) {
      a(localArrayList, paramBoolean, parampcm);
    }
  }
  
  private boolean a(List<CommentData> paramList)
  {
    if ((paramList == null) || (this.jdField_a_of_type_Pcn == null) || (!this.jdField_a_of_type_Pcn.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Pcn.jdField_a_of_type_JavaLangString == null)) {
      return false;
    }
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      if ((localCommentData != null) && (this.jdField_a_of_type_Pcn.jdField_a_of_type_JavaLangString.equals(localCommentData.commentId)))
      {
  ...
  private List<pay> b(int paramInt, List<String> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    ...
    while (paramList.hasNext())
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (this.jdField_b_of_type_JavaUtilMap.get(str) != null)) {
        localArrayList.add(new pay(paramInt, a((BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(str)), (BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(str), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      }
    }
    return localArrayList;
  }
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_Pcn != null)
        {
          ...
          if (this.jdField_a_of_type_Pcn.jdField_a_of_type_Boolean) {
            localObject1 = this.jdField_a_of_type_Pcn.jdField_a_of_type_JavaLangString;
          }
        }
      }
  ...
  private void e(int paramInt)
  {
    ...
    for (String str = "";; str = this.jdField_f_of_type_JavaLangString)
    {
      ...
      this.jdField_a_of_type_Pcq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID, this.jdField_f_of_type_JavaLangString, 10, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataCommonCommentData);
      return;
    }
  }
  ...
  public BaseCommentData a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 1)
    {
      ...
      ((BaseCommentData)localObject1).uin = pha.a();
      ((BaseCommentData)localObject1).homepage = pha.h(((BaseCommentData)localObject1).uin);
    ...
    for (;;)
    {
      try
      {
        ...
        ((BaseCommentData)localObject1).commentContent = new String(bgku.decode(paramString.getString("comment"), 0));
        ...
        if (paramInt == 2)
        {
          ...
          if (paramString.optBoolean("isSecondReply", false))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject3))
            {
              ...
              ((SubCommentData)localObject2).repliedUserHomePage = pha.h((String)localObject3);
  ...
  public List<pay> a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        if ((localCommentData != null) && ((!localCommentData.isFamilyTopEntry()) || ((localCommentData.isFamilyTopEntry()) && (!ozc.a())))) {
          localArrayList2.add(localCommentData);
        }
        i += 1;
      }
      if ((localArrayList2.size() > 0) && (this.jdField_f_of_type_Boolean)) {
        localArrayList1.add(new pay(1, null, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      }
  ...
  public List<pay> a(int paramInt)
  {
  ...
  public List<pay> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    paramString = (BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(paramString);
    if (paramString == null) {
    ...
    localArrayList.add(new pay(0, paramString, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    localArrayList.add(new pay(3, paramString, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    return localArrayList;
  }
  
  public pcn a()
  {
    return this.jdField_a_of_type_Pcn;
  }
  
  public pcr a()
  {
    return this.jdField_a_of_type_Pcr;
  }
  
  public pcy a()
  {
    return this.jdField_a_of_type_Pcy;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Pcu != null) {
      this.jdField_a_of_type_Pcu.a();
    }
  }
  
  public void a(int paramInt)
  {
    a(new pcf(this, paramInt));
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (String str = "";; str = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((paramInt2 != 1) || (this.jdField_a_of_type_Pcn == null) || (!this.jdField_a_of_type_Pcn.jdField_a_of_type_Boolean)) {
        break;
      }
      ThreadManager.executeOnSubThread(new ReadInJoyCommentDataManager.5(this, this.jdField_a_of_type_Pcn.jdField_a_of_type_JavaLangString));
      return;
    }
    if (paramInt1 == 6)
    {
  ...
  public void a(int paramInt, String paramString, pcs parampcs, pct parampct)
  {
    boolean bool2 = true;
    boolean bool3 = TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString);
    pcs localpcs = parampcs;
    if (parampcs == null) {
      localpcs = new pcs();
    }
    if (parampct == null) {
    ...
    if (paramInt == 0)
    {
      this.jdField_b_of_type_Boolean = localpcs.jdField_a_of_type_Boolean;
      this.jdField_c_of_type_JavaLangString = localpcs.jdField_a_of_type_JavaLangString;
      if (localpcs.jdField_b_of_type_JavaUtilList == null) {
        break label342;
      }
      parampcs = localpcs.jdField_b_of_type_JavaUtilList.iterator();
      while (parampcs.hasNext())
      {
        parampct = (SubCommentData)parampcs.next();
        if (parampct != null)
        {
          if (TextUtils.isEmpty(parampct.parentCommentId)) {
            parampct.parentCommentId = paramString;
          }
          this.jdField_b_of_type_JavaUtilMap.put(parampct.commentId, parampct);
          this.jdField_c_of_type_JavaUtilList.add(parampct.commentId);
        }
      }
      parampcs = a(bool3, (BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(paramString), localpcs.jdField_b_of_type_JavaUtilList);
      bool1 = true;
    }
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        ...
        paramInt = localpcs.jdField_b_of_type_JavaUtilList.size();
        label212:
        if ((localpcs == null) || (!localpcs.jdField_a_of_type_Boolean)) {
          break label336;
        }
      }
      for (;;)
      {
        ...
        a(new pbz(this, bool3, bool1, parampcs));
        return;
        parampcs = null;
        bool1 = false;
        break;
  ...
  public void a(int paramInt, pcs parampcs1, pcs parampcs2, pct parampct)
  {
    boolean bool1;
    boolean bool2;
    Object localObject;
    ...
    if (paramInt == 0)
    {
      ...
      if (bool1)
      {
        this.jdField_c_of_type_Boolean = parampcs1.jdField_a_of_type_Boolean;
        this.jdField_d_of_type_Boolean = ((pcs)localObject).jdField_a_of_type_Boolean;
        if (((pcs)localObject).jdField_a_of_type_JavaUtilList == null) {
          break label492;
        }
        l = ((pcs)localObject).jdField_a_of_type_JavaUtilList.size();
        this.jdField_c_of_type_Long = l;
        this.jdField_d_of_type_JavaLangString = parampcs1.jdField_a_of_type_JavaLangString;
        this.jdField_e_of_type_JavaLangString = ((pcs)localObject).jdField_a_of_type_JavaLangString;
        this.jdField_g_of_type_Boolean = parampcs2.jdField_a_of_type_Boolean;
        this.jdField_a_of_type_Pcr = parampcs2.jdField_a_of_type_Pcr;
        a(((pcs)localObject).jdField_a_of_type_JavaUtilList, parampcs1.jdField_a_of_type_JavaUtilList);
      }
      if (!bool2) {
        break label519;
      }
      if (parampcs2.jdField_a_of_type_Long > 0L) {
        this.jdField_b_of_type_Long = parampcs2.jdField_a_of_type_Long;
      }
      this.jdField_a_of_type_Long = parampcs2.jdField_b_of_type_Long;
      if ((this.jdField_a_of_type_Pcn != null) && (this.jdField_a_of_type_Pcn.jdField_b_of_type_Boolean))
      {
        if (!a(((pcs)localObject).jdField_a_of_type_JavaUtilList)) {
          a(new pbn(this));
        }
        this.jdField_a_of_type_Pcn.jdField_b_of_type_Boolean = false;
      }
      paramInt = 3;
      List localList = a(3);
      if (localList != null)
      ...
      label284:
      if (!((pcs)localObject).a()) {
        break label507;
      }
      i = ((pcs)localObject).jdField_a_of_type_JavaUtilList.size();
      label304:
    ...
    label513:
    for (int j = parampcs1.jdField_a_of_type_JavaUtilList.size();; j = 0)
    {
      ...
      a(new pbo(this, bool1, parampct, bool2, paramInt));
      if (this.jdField_a_of_type_Pcn != null) {
        this.jdField_a_of_type_Pcn.a(false);
      }
      this.jdField_a_of_type_Pcy.a(parampcs2.jdField_a_of_type_Int);
      this.jdField_a_of_type_Pcy.a(parampcs2.jdField_a_of_type_JavaLangString);
      return;
      bool1 = false;
      break;
      label492:
    ...
    label519:
    if (parampcs1 != null) {}
    for (parampcs1 = a(2, new ArrayList(parampcs1.jdField_a_of_type_JavaUtilList));; parampcs1 = new ArrayList())
    {
      bool2 = this.jdField_a_of_type_Boolean;
      QLog.d("ReadInJoyCommentDataManager", 1, new Object[] { "onLoadMoreComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampcs1.size()), ", hasNext : ", Boolean.valueOf(bool2) });
      a(new pbq(this, bool1, parampcs1));
      return;
    }
  }
  
  public void a(int paramInt, pcs parampcs, pct parampct, CommentData paramCommentData)
  {
    boolean bool2 = TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString);
    paramCommentData = parampcs;
    if (parampcs == null) {
      paramCommentData = new pcs();
    }
    parampcs = parampct;
    if (parampct == null) {
      parampcs = new pct();
    ...
    if (paramInt == 0)
    {
      ...
      if (parampcs.jdField_a_of_type_Long > 0L) {
        this.jdField_b_of_type_Long = parampcs.jdField_a_of_type_Long;
      }
      parampcs = b();
      parampct = new StringBuilder().append(", new size : ");
    ...
    label227:
    if (paramCommentData.jdField_a_of_type_JavaUtilList != null) {}
    for (parampcs = a(2, new ArrayList(paramCommentData.jdField_a_of_type_JavaUtilList));; parampcs = new ArrayList())
    {
      bool2 = this.jdField_c_of_type_Boolean;
      QLog.d("ReadInJoyCommentDataManager", 2, new Object[] { "onLoadMoreNewComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampcs.size()), ", hasNext : ", Boolean.valueOf(bool2) });
      a(new pbs(this, bool1, parampcs, bool2));
      return;
    }
  }
  ...
  public void a(long paramLong, boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    Pair localPair = (Pair)this.jdField_a_of_type_Bkfu.a(paramLong);
    if (localPair == null) {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bkfu.b(paramLong);
      if (paramBoolean)
      {
        paa.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, (String)localPair.first);
        a(localBaseCommentData, paramString, paramInt2);
        return;
      }
      if ((localBaseCommentData instanceof CommentData))
      {
        a(new pcd(this, paramInt2));
        return;
      }
  ...
  public void a(BaseCommentData paramBaseCommentData, String paramString, int paramInt)
  {
    ...
    if ((paramBaseCommentData instanceof CommentData)) {
      if (paramInt == 6)
      {
        ...
        if (this.jdField_d_of_type_JavaUtilList.size() == 0)
        {
          ...
          a(new pcg(this, new pay(i, 0, paramBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo), bool, paramInt));
        }
      }
    }
    label319:
    ...
    a(paramString, 1);
    a(new pch(this, paramBaseCommentData));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_Pcu.a(paramString, 1, paramInt, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
    ...
    while (paramBoolean1)
    {
      ...
      else
      {
        ...
        for (paramBoolean1 = bool;; paramBoolean1 = false)
        {
          ...
          paramInt = 2131717355;
          a(new pck(this, a()));
          QQToast.a(BaseApplicationImpl.context, 2, anni.a(paramInt), 0).a();
          return;
        }
        this.jdField_a_of_type_JavaUtilList.remove(paramString);
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    this.jdField_a_of_type_Pcu.a(localBaseCommentData, this.jdField_a_of_type_JavaLangString, paramString2, paramInt, this.jdField_a_of_type_Int);
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      {
        a(new pci(this, a()));
        QQToast.a(BaseApplicationImpl.context, 2, anni.a(2131717350), 0).a();
        return;
    ...
    if (paramBoolean2) {}
    for (paramString = anni.a(2131717349);; paramString = anni.a(2131717348))
    {
  ...
  public void a(pay parampay)
  {
    ...
    do
    {
      ...
      if (this.jdField_b_of_type_JavaUtilMap != null) {
        this.jdField_b_of_type_JavaUtilMap.remove(parampay);
      }
      parampay = parampay.commentId;
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.contains(parampay)))
      {
        this.jdField_a_of_type_JavaUtilList.remove(parampay);
        a(new pbf(this));
      }
      if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.contains(parampay)))
      {
        this.jdField_b_of_type_JavaUtilList.remove(parampay);
        a(new pbp(this));
      }
    } while ((this.jdField_d_of_type_JavaUtilList == null) || (!this.jdField_d_of_type_JavaUtilList.contains(parampay)));
    this.jdField_d_of_type_JavaUtilList.remove(parampay);
    a(new pca(this));
  }
  
  public void a(pay parampay, int paramInt)
  {
    if ((this.jdField_a_of_type_Pcu == null) || (parampay == null) || (parampay.a == null)) {
      return;
    }
    ...
    a(new pbj(this, localBaseCommentData.getCommentLevel(), parampay, paramInt), false);
    this.jdField_a_of_type_Pcu.a(localBaseCommentData, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
  
  public void a(pcn parampcn)
  {
    if ("setCommentAnchor | commentid : " + parampcn != null) {}
    for (String str = parampcn.jdField_a_of_type_JavaLangString;; str = "")
    {
  ...
  public void a(pcp parampcp)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 82	pbe:jdField_e_of_type_JavaUtilList	Ljava/util/List;
    //   6: aload_1
    ...
    //   19: return
    //   20: aload_0
    //   21: getfield 82	pbe:jdField_e_of_type_JavaUtilList	Ljava/util/List;
    //   24: aload_1
  ...
  public void a(boolean paramBoolean, BaseCommentData paramBaseCommentData, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        QQToast.a(BaseApplication.getContext(), 2, anni.a(2131711724), 0).a();
      ...
      {
        pmk.a().a(true, this.jdField_a_of_type_JavaLangString, paramBaseCommentData.commentId, "onCommentDelete", paramString.getInt("seq"), i);
        return;
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, int paramInt2)
  {
    ...
    a(new pcc(this, paramBoolean, paramString, paramInt1, paramInt2));
    Object localObject = BaseActivity.sTopActivity;
    if (localObject != null)
    {
      localObject = ((Activity)localObject).getIntent().getBundleExtra("bundle");
      if (localObject != null) {
        pmk.a().a(paramBoolean, this.jdField_a_of_type_JavaLangString, paramString, String.valueOf(paramInt2), "onCommentLike", ((Bundle)localObject).getInt("seq"));
      }
    }
  }
  
  public void a(boolean paramBoolean1, pay parampay, int paramInt, String paramString, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      a(paramString);
      b(paramString);
      a(new pcb(this, paramString.getCommentLevel(), parampay, paramInt), false);
      return;
    }
    ...
    label150:
    for (parampay = anni.a(2131717345);; parampay = anni.a(2131717344))
    {
      QQToast.a(paramString, paramInt, parampay, 0).a();
      return;
      paramInt = 1;
      break;
    }
  ...
  public boolean a(pcp parampcp)
  {
    try
    {
      boolean bool = this.jdField_e_of_type_JavaUtilList.remove(parampcp);
      return bool;
    }
    finally
    {
    ...
    if (this.jdField_b_of_type_JavaUtilList.size() > 0)
    {
      ...
      if (i < this.jdField_b_of_type_JavaUtilList.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if ((!localCommentData.isFamilyTopEntry()) || ((localCommentData.isFamilyTopEntry()) && (!ozc.a()))) {
            localArrayList2.add(localCommentData);
          }
        }
      }
      if ((localArrayList2.size() > 0) && (this.jdField_f_of_type_Boolean)) {
        localArrayList1.add(new pay(2, null, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      }
  ...
  public List<pay> b(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
  ...
  public void b(int paramInt, pcs parampcs, pct parampct, CommentData paramCommentData)
  {
    ...
    if (paramInt == 0)
    {
      ...
      this.jdField_g_of_type_Boolean = parampcs.jdField_a_of_type_Boolean;
    ...
    while (bool2) {
      ...
      else
      {
        ...
        if (paramCommentData.jdField_a_of_type_JavaUtilList != null)
        {
          ...
          label235:
          parampct = new StringBuilder().append(", hot size : ");
          if (paramCommentData.jdField_a_of_type_JavaUtilList == null) {
            break label372;
          }
        }
    ...
    if (paramCommentData.jdField_a_of_type_JavaUtilList != null) {}
    for (parampcs = a(1, new ArrayList(paramCommentData.jdField_a_of_type_JavaUtilList));; parampcs = new ArrayList())
    {
      bool2 = this.jdField_d_of_type_Boolean;
      QLog.d("ReadInJoyCommentDataManager", 2, new Object[] { "onLoadMoreHotComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampcs.size()), ", hasNext : ", Boolean.valueOf(bool2) });
      a(new pbw(this, bool1, parampcs, bool2));
      return;
    }
  }
  ...
  public void b(ArticleInfo paramArticleInfo)
  {
    ...
    this.jdField_a_of_type_Pcy.a(paramArticleInfo);
  }
  ...
  public void b(String paramString)
  {
    ...
    pdz.a.a(localFirstCommentCreateData, new pbm(this), paramString, 2, true);
  }
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    for (int i = 1;; i = -1)
    {
      ...
      this.jdField_a_of_type_Pcu.a(paramString, 0, paramInt, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      return;
    }
  }
  
  public void b(pay parampay, int paramInt)
  {
    if ((parampay == null) || (parampay.a == null)) {
      return;
    }
    QLog.d("ReadInJoyCommentDataManager", 1, "authorDeleteComment | " + parampay.a);
    pdz.a.a(this.jdField_a_of_type_Int, parampay, paramInt, this);
  }
  ...
  public void c(int paramInt, pcs parampcs, pct parampct, CommentData paramCommentData)
  {
    paramCommentData = parampcs;
    if (parampcs == null) {
      paramCommentData = new pcs();
    ...
    if (paramInt == 0)
    {
      ...
      l = parampcs.jdField_a_of_type_Long;
      label106:
      this.jdField_d_of_type_Long = l;
      parampcs = new StringBuilder();
    ...
    label244:
    if (paramCommentData != null) {}
    for (parampcs = a(4, new ArrayList(paramCommentData.jdField_a_of_type_JavaUtilList));; parampcs = new ArrayList())
    {
      QLog.d("ReadInJoyCommentDataManager", 1, new Object[] { "onLoadMoreFamilyComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampcs.size()), ", hasNext : ", Boolean.valueOf(this.jdField_e_of_type_Boolean) });
      a(new pby(this, bool1, parampcs));
      return;
    }
  }
  ...
  public void c(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      long l = pdz.a.a(localSubCommentCreateData, new pbk(this), paramString, paramInt, false);
      if (l != -1L) {
        this.jdField_a_of_type_Bkfu.b(l, new Pair(paramString, localSubCommentData));
      }
  ...
  public void d(String paramString, int paramInt)
  {
    ...
    localFirstCommentCreateData.c(this.jdField_g_of_type_JavaLangString);
    localFirstCommentCreateData.a(localBaseCommentData.commentContent);
    long l = pdz.a.a(localFirstCommentCreateData, new pbl(this), paramString, paramInt, false);
    if (l != -1L) {
      this.jdField_a_of_type_Bkfu.b(l, new Pair(paramString, localBaseCommentData));
    }
