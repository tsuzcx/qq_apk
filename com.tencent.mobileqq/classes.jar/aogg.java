...
public class aogg
{
  ...
  public aogg()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new aogk(this, 0, true, true, 3000L, true, false, "QQARScan");
  }
  ...
  private void a(int paramInt, aohg paramaohg)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArModelArLBSActivity = aohg.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions, paramaohg);
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new aogl(this), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
  ...
  private void a(aohl paramaohl)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Aofs.a(paramaohl, new aogj(this, l1, paramaohl));
      return;
    }
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Aofs != null)
    {
      ...
      this.jdField_a_of_type_Aofs.a(paramString, paramInt1, paramInt2, new aogh(this));
    }
  }
  
  private void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList)
  {
    if (this.jdField_a_of_type_Aogz != null)
    {
      aohl localaohl = new aohl();
      this.jdField_a_of_type_Aogz.a(paramArrayOfByte, paramArrayList, new aogi(this, localaohl), this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    long l1;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Aogn != null))
    {
      l1 = System.currentTimeMillis();
      bool1 = this.jdField_a_of_type_Aogn.a(paramArrayOfByte);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Aogm.c(bool1);
      QLog.i("AREngine_ARCloudControl", 1, "isSameSceneWithBestImg = " + bool1 + " cost time:" + (System.currentTimeMillis() - l1) + "ms");
    }
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Aogn == null)) {
      return;
    }
    ...
    boolean bool1 = this.jdField_a_of_type_Aogn.a(paramArrayOfByte, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    ...
    if (this.jdField_a_of_type_Aogm != null)
    {
      boolean bool2 = this.jdField_a_of_type_Aogm.a();
      l1 = this.jdField_a_of_type_Aogm.a();
      if ((bool1) && (!this.jdField_m_of_type_Boolean) && (bool2))
      {
        ...
        i1 = 0;
        bool1 = false;
        this.jdField_a_of_type_Aogm.a(bool1);
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Aogm != null) {
          this.jdField_a_of_type_Aogm.b(true);
        }
        if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Aogm != null))
        {
          l1 = this.jdField_a_of_type_Aogm.b();
          aoem.a().a(l1, this.jdField_l_of_type_Long, this.jdField_m_of_type_Long, this.jdField_a_of_type_Aogn.jdField_c_of_type_Int);
          anxy.a().a(l1, this.jdField_m_of_type_Long);
          this.jdField_f_of_type_Boolean = true;
        }
        a(new ARCloudControl.3(this, paramArrayOfByte));
        return;
        paramArrayOfByte = this.jdField_a_of_type_Aogn.a();
      }
      label675:
      i1 = 0;
      break;
  ...
  public boolean a(aogm paramaogm, AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, ARCommonConfigInfo paramARCommonConfigInfo)
  {
    long l2 = System.currentTimeMillis();
    jdField_k_of_type_Boolean = a();
    aoji.a().b(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
    if (!jdField_k_of_type_Boolean) {
      return false;
    }
    this.jdField_a_of_type_Aogn = new aogn(aogn.jdField_b_of_type_Int);
    this.jdField_a_of_type_Aogz = new aogz();
    this.jdField_a_of_type_Aogn.a(BaseApplicationImpl.getContext().getApplicationContext());
    this.jdField_a_of_type_Aogz.a();
    ...
    this.jdField_a_of_type_Aofs = new aofs(paramAppInterface, true);
    this.jdField_a_of_type_Aofs.a();
    ...
    for (long l1 = ARRecognition.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions);; l1 = 0L)
    {
      ...
      aoji.a().c(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
      return true;
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Aogn != null)
    {
      this.jdField_a_of_type_Aogn.a();
      this.jdField_a_of_type_Aogn = null;
    }
    if (this.jdField_a_of_type_Aogz != null)
    {
      this.jdField_a_of_type_Aogz.b();
      this.jdField_a_of_type_Aogz = null;
    }
