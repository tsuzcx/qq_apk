  ...
  extends BusinessHandler
{
  ...
  public aogg(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public aogg(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private bcfs a(int paramInt1, String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt2)
  {
    switch (paramInt1)
    {
    case 5: 
    ...
    default: 
      return null;
    case 2: 
      return new bcfq(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 3: 
      return new bcgm(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 4: 
      return new bcfr(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 7: 
      return new bcfz(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 6: 
      return new bcgi(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 8: 
      return new bcgf(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 9: 
      return new bcgg(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 11: 
      return new bcfw(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 12: 
      return new bcfu(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 13: 
      return new bcfx(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 14: 
    ...
    case 17: 
      return new bcgd(paramString, paramLong, paramList, paramResultItem, paramInt2);
    }
    return new bcgb(paramString, paramLong, paramList, paramResultItem, paramInt2);
  }
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bcdm localbcdm = new bcdm(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new bcdn(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      bbyl.a.put(bbyl.a(localbcdm.a), localArrayList2);
      ...
      localObject1 = new bcdl((String)localObject1, (String)localObject2);
      bbyl.b.put(bbyl.a(localbcdm.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localbcdm, localArrayList2, (bcdl)localObject1));
    }
  ...
  {
    return (bdvn.a()) && ((paramLong == 1100L) || (paramLong == 1012L) || (paramLong == 1003L));
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        bcnc.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new bcfd((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bhhr.r(BaseApplicationImpl.getContext(), i);
    }
  ...
  public List<bcfi> a(Object... paramVarArgs)
  {
    ...
    label202:
    for (boolean bool1 = bcmz.b(i);; bool1 = true)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bhhr.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.search_ver.has()) {
          bcnc.a("UnifySearch.Tab", arrayOfLong, localRspBody.search_ver.get().toStringUtf8());
        }
        ...
        bool1 = true;
        paramObject = localRspBody.item_groups.get();
        Object localObject2 = new bchi();
        if (bool2) {
          ((bchi)localObject2).a(true);
        }
        paramToServiceMsg = ((bchi)localObject2).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new bdlf(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, ykv.a(null) }).a();
  }
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(bcnc.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bhhr.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", bbzq.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (bbyl.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              bcnc.a("sub_result", "active_search", new String[] { paramString1, bcnc.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = bbyl.a.values().iterator();
        paramInt1 = 2;
      }
      label620:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((bcdn)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<bcfi> paramList)
  {
    ...
    {
      localObject1 = new bcgp(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((bcgp)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((bcgp)localObject1).c(null);
      ((bcgp)localObject1).a(bool2);
      label445:
      if ((localObject1 != null) && (((bcfs)localObject1).b()))
      {
        ((bcfs)localObject1).u = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((bcfs)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        {
          localObject1 = new bcgs(paramString, str7, -4, str5);
          ((bcgs)localObject1).u = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
          localArrayList2.add(localObject1);
          l2 = l1;
        }
        else
        {
          localObject1 = new bceh(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
          l2 = l1;
          if (localObject1 != null)
          {
            ((bceh)localObject1).u = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            ((bceh)localObject1).c = bool1;
            ((bceh)localObject1).j = i;
            ((bceh)localObject1).a = paramInt;
            localArrayList2.add(localObject1);
            l2 = l1;
          }
        }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new bcfc(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label875:
      paramList.add(new bceg(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bhhr.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = bcgq.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
