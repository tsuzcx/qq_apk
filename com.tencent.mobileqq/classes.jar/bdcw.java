...
{
  public static int a;
  private static bdcw jdField_a_of_type_Bdcw;
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bdcx(this);
  ...
  public bdcw(AppInterface paramAppInterface)
  {
  ...
  private RelativeLayout.LayoutParams a(CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    if ((paramCustomFrameAnimationDrawable != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      paramCustomFrameAnimationDrawable = new RelativeLayout.LayoutParams(AIOUtils.dp2px(j / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()), AIOUtils.dp2px(k / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()));
  ...
  public static bdcw a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bdcw == null) {}
    try
    {
      if (jdField_a_of_type_Bdcw == null) {
        jdField_a_of_type_Bdcw = new bdcw(paramAppInterface);
      }
      return jdField_a_of_type_Bdcw;
    }
    finally {}
  }
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   11: getstatic 57	bdcw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   27: astore_1
    //   28: aload_1
    //   29: invokevirtual 187	java/io/File:exists	()Z
    //   32: ifeq +220 -> 252
    //   35: aload_1
    //   36: invokevirtual 191	java/io/File:listFiles	()[Ljava/io/File;
    //   39: astore_1
    //   40: new 193	java/util/ArrayList
    //   43: dup
    //   44: invokespecial 194	java/util/ArrayList:<init>	()V
    //   47: astore 4
    //   49: aload_1
    //   50: ifnull +202 -> 252
    //   53: aload_1
    ...
    //   88: goto +166 -> 254
    //   91: aload 4
    //   93: invokeinterface 203 1 0
    //   98: iconst_1
    //   99: if_icmple +129 -> 228
    //   102: aload 4
    //   104: invokestatic 209	java/util/Collections:sort	(Ljava/util/List;)V
    //   107: new 211	android/graphics/BitmapFactory$Options
    //   110: dup
    //   111: invokespecial 212	android/graphics/BitmapFactory$Options:<init>	()V
    //   114: astore_1
    //   115: aload_1
    //   116: iconst_1
    //   117: putfield 215	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   120: aload_1
    //   121: iconst_1
    //   122: putfield 218	android/graphics/BitmapFactory$Options:inMutable	Z
    //   125: aload 4
    //   127: ifnull +125 -> 252
    //   130: aload 4
    //   132: invokeinterface 203 1 0
    //   137: ifle +115 -> 252
    //   140: aload 4
    //   142: iconst_0
    //   143: invokeinterface 222 2 0
    //   148: checkcast 48	java/io/File
    //   151: invokevirtual 225	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   154: aload_1
    //   155: invokestatic 230	bheg:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    //   159: new 140	com/tencent/mobileqq/activity/aio/item/CustomFrameAnimationDrawable
    //   162: dup
    //   163: invokestatic 233	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   166: invokevirtual 234	com/tencent/qphone/base/util/BaseApplication:getResources	()Landroid/content/res/Resources;
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 236	bdcw:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   174: invokespecial 239	com/tencent/mobileqq/activity/aio/item/CustomFrameAnimationDrawable:<init>	(Landroid/content/res/Resources;Landroid/graphics/Bitmap;Lmqq/os/MqqHandler;)V
    //   177: astore_1
    //   178: iconst_0
    //   179: istore_2
    //   180: iload_2
    ...
    //   211: bipush 40
    //   213: aload 5
    //   215: invokevirtual 225	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   218: invokevirtual 242	com/tencent/mobileqq/activity/aio/item/CustomFrameAnimationDrawable:a	(IILjava/lang/String;)V
    //   221: iload_2
    //   222: iconst_1
    //   223: iadd
    //   224: istore_2
    //   225: goto -45 -> 180
    //   228: invokestatic 244	bdcw:c	()V
    //   231: goto -124 -> 107
    //   234: astore 4
    //   236: aconst_null
    //   237: astore_1
    //   238: aload 4
    //   240: invokevirtual 247	java/lang/Exception:printStackTrace	()V
    //   243: aload_1
    //   244: areturn
    //   245: astore 4
    //   247: goto -9 -> 238
  ...
  public static void a(Intent paramIntent, Activity paramActivity)
  {
    ...
    alik.a(paramActivity, paramIntent);
  }
  
  public static void a(View paramView, ahha paramahha, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131374283) != null)
          {
            paramView.findViewById(2131374282).setVisibility(0);
            paramahha = (ImageView)paramView.findViewById(2131374283);
            if (j == 1) {
              paramahha.setImageResource(2130849755);
            }
            for (;;)
            {
              paramahha.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131374282)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              paramView.rightMargin = AIOUtils.dp2px(6.0F, paramContext.getResources());
              ...
              break;
              if (j == 2) {
                paramahha.setImageResource(2130849756);
              } else if (j == 3) {
                paramahha.setImageResource(2130849754);
              }
            }
            paramView.rightMargin = 0;
            paramView.leftMargin = AIOUtils.dp2px(6.0F, paramContext.getResources());
            return;
          }
          paramahha = new ImageView(paramContext);
          paramahha.setBackgroundDrawable(paramContext.getResources().getDrawable(2130849753));
          paramahha.setId(2131374282);
          paramahha.setVisibility(0);
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, AIOUtils.dp2px(70.0F, paramContext.getResources()));
          localLayoutParams.addRule(7, 2131372790);
          localLayoutParams.addRule(8, 2131372790);
          if (paramChatMessage.isSend())
          {
            localLayoutParams.rightMargin = AIOUtils.dp2px(6.0F, paramContext.getResources());
            localLayoutParams.leftMargin = 0;
            ((RelativeLayout)paramView).addView(paramahha, localLayoutParams);
            paramahha = new ImageView(paramContext);
            if (j != 1) {
              break label441;
            }
          ...
          for (;;)
          {
            paramahha.setId(2131374283);
            paramahha.setVisibility(0);
            paramChatMessage = new RelativeLayout.LayoutParams(-2, -2);
            paramChatMessage.addRule(8, 2131372790);
            paramChatMessage.addRule(14);
            ((RelativeLayout)paramView).addView(paramahha, paramChatMessage);
            return;
            localLayoutParams.rightMargin = 0;
            localLayoutParams.leftMargin = AIOUtils.dp2px(6.0F, paramContext.getResources());
            break;
            if (j == 2) {
              paramahha.setImageResource(2130849756);
            } else if (j == 3) {
        ...
        paramView.findViewById(2131374283).setVisibility(4);
        paramView.findViewById(2131374282).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), bddg.class);
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      new bdde(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (bhhr.c(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramQQAppInterface.exists()) && (!paramQQAppInterface.isDirectory()))
    {
      try
      {
        paramQQAppInterface = FileUtils.readFileToString(paramQQAppInterface);
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        bhhr.e(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130849757);
    ...
    for (;;)
    {
      ...
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849767);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!anvx.a(2131712748).trim().equals(localObject)) {
          break;
        }
    ...
    } while (!anvx.a(2131712746).trim().equals(localObject));
    alpt.b("", "0X80088E6");
    j();
    a();
  }
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131712745));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166985));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130849758, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131712749));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new bddd(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131712747));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166986));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(16.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(AIOUtils.dp2px(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), AIOUtils.dp2px(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), AIOUtils.dp2px(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), AIOUtils.dp2px(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130849762);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.a(new bdcy(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849761);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849765);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    paramString.setId(2131374363);
    Object localObject = new RelativeLayout.LayoutParams(-1, AIOUtils.dp2px(180.0F, paramActivity.getResources()));
    ...
    ((TextView)localObject).setId(2131374364);
    localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(14);
    localLayoutParams.bottomMargin = AIOUtils.dp2px(10.0F, paramActivity.getResources());
    paramViewGroup.addView((View)localObject, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
    ((TextView)localObject).bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bddc(this));
    e();
    return paramString;
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new bdcz(this));
    }
    for (;;)
    {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (!paramString2.isEmpty())
      {
        ...
        while (paramString2.hasNext())
        {
          ...
          MessageRecord localMessageRecord = ((QQAppInterface)localObject).getMessageFacade().queryMsgItemByUniseq(paramString1, paramInt, l);
          if ((localMessageRecord != null) && ((localMessageRecord instanceof MessageForShortVideo)))
          {
            ...
            if (localMessageForShortVideo.redBagStat == 0)
            {
              ...
              ((QQAppInterface)localObject).getMessageFacade().updateMsgContentByUniseq(localMessageRecord.frienduin, localMessageRecord.istroop, localMessageRecord.uniseq, localMessageRecord.msgData);
            }
          }
        }
      }
