  ...
  extends xpv
{
  ...
  public aeiy(AIORichMediaData paramAIORichMediaData)
  {
    this.jdField_b_of_type_Int = -2;
    this.jdField_a_of_type_Aeiz = new aeiz();
  ...
  @Deprecated
  public static URLDrawable a(auoc paramauoc)
  {
    return aywm.b(paramauoc, 1);
  }
  ...
  public Drawable c()
  {
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (aywm.a(((File)localObject2).getAbsolutePath()) != 0) {
          break label631;
        }
        ...
        if (aywm.a(((File)localObject3).getAbsolutePath()) != 0) {
          break label631;
        }
