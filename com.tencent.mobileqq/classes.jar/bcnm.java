  ...
  extends MSFServlet
{
  ...
  {
    bcnk.a().a(paramString, paramInt);
  }
  
  private void a(byte[] paramArrayOfByte)
  {
    bcnk.a().b(paramArrayOfByte);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      bcnt.c("VideoChannelServlet", String.format("onReceive cmd=%s", new Object[] { paramIntent }));
    ...
    bcnt.c("VideoChannelServlet", String.format(">>> ip=%s", new Object[] { paramIntent }));
    a(paramIntent, 0);
    return;
    if ("VideoCCSvc.Adaptation".equalsIgnoreCase(paramIntent))
    {
      ...
      bcnt.a("VideoChannelServlet", String.format("onReceive get config fail, resultCode=%s", new Object[] { Integer.valueOf(paramFromServiceMsg.getResultCode()) }));
      return;
    }
    bcnt.b("VideoChannelServlet", "onReceive handle not process cmd.");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bcnt.c("VideoChannelServlet", String.format("onSend reqType=%s", new Object[] { Integer.valueOf(i) }));
    switch (i)
    {
    default: 
      bcnt.b("VideoChannelServlet", "onSend handle not define reqType.");
      return;
    case 1: 
