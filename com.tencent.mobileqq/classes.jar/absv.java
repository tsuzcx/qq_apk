  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("goShare".equals(paramString3))
    {
      ...
      try
      {
        ...
        {
          bjkv.a().a(this.mRuntime.a().getString(2131719903));
          return true;
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
        bjkv.a().a(this.mRuntime.a().getString(2131690242));
        return true;
      }
    ...
    try
    {
      bjko.c(this.TAG, "doReport");
      paramJsBridgeListener = new JSONObject(paramVarArgs[0]);
      absy.a(null, paramJsBridgeListener.optString("actionName"), paramJsBridgeListener.optInt("fromType"), paramJsBridgeListener.optInt("actionResult"), paramJsBridgeListener.optInt("ext2"));
      return true;
    }
    catch (JSONException paramJsBridgeListener)
    {
    ...
    try
    {
      paramString1 = new String(bhcu.decode(paramString1, 0));
    ...
    if ("jumpPublicDevice".equals(paramString3)) {
      try
      {
        bjko.c(this.TAG, "METHOD_JUMP_PUBLICDEVICE");
