  ...
  implements Manager
{
  ...
  public baif(AppInterface paramAppInterface)
  {
  ...
  private BusinessInfoCheckUpdate.TimeRspBody a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody1, BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody2)
  {
    ...
    while (paramTimeRspBody1.hasNext())
    {
      ...
      if ((localObject != null) && ((((BusinessInfoCheckUpdate.AppInfo)localObject).push_to.get() == 109) || (((BusinessInfoCheckUpdate.AppInfo)localObject).push_to.get() == 109110))) {
        localHashMap.put(Integer.valueOf(((BusinessInfoCheckUpdate.AppInfo)localObject).uiAppId.get()), localObject);
      }
    }
    ...
    for (;;)
    {
      ...
      {
        j = ((Integer)paramTimeRspBody1.next()).intValue();
        localObject = paramTimeRspBody2.rptMsgAppInfo.get().iterator();
        while (((Iterator)localObject).hasNext())
        {
          BusinessInfoCheckUpdate.AppInfo localAppInfo = (BusinessInfoCheckUpdate.AppInfo)((Iterator)localObject).next();
          if (localAppInfo.uiAppId.get() == j) {
            localAppInfo.set((MessageMicro)localHashMap.get(Integer.valueOf(j)));
          }
        }
      }
      for (int i = 1;; i = 0)
      {
        ...
        paramTimeRspBody2.rptMsgAppInfo.add((MessageMicro)localHashMap.get(Integer.valueOf(j)));
        break;
  ...
  public static String a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    StringBuilder localStringBuilder = afur.a().append(paramAppInfo.path.get()).append(":");
  ...
  {
    if (paramInt == 6) {
      blyl.a().a(paramAppInfo, 102);
    }
    while (paramInt != 1) {
      return;
    }
    blyl.a().a(paramAppInfo, 101);
  }
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      setChanged();
      if (i != 0) {
        antv.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      }
      return;
  ...
  private void a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody1, BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody2)
  {
    ...
    while (paramTimeRspBody1.hasNext())
    {
      ...
      int k;
      for (int i = 0; localIterator1.hasNext(); i = k)
      {
      ...
      try
      {
        ...
        if ((localTimeRspBody != null) && (localTimeRspBody.rptMsgAppInfo.has()))
        {
          ...
          if (i < localTimeRspBody.rptMsgAppInfo.size())
          {
            ...
            localObject = (bccg)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(12);
            if (localObject != null) {
              ((bccg)localObject).a(paramString);
            }
          }
        }
        a(localTimeRspBody);
  ...
  private int b(String paramString, int paramInt)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 35	baif:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: aload_1
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: invokevirtual 82	baif:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   25: astore 6
    //   27: iload 4
    //   29: istore_3
    //   30: aload 6
    ...
    //   61: ifnonnull +19 -> 80
    //   64: ldc 253
    //   66: invokestatic 52	baif:a	(Ljava/lang/String;)V
    //   69: aload 5
    //   71: monitorexit
    //   72: iconst_0
    //   73: ireturn
    ...
    //   111: getfield 256	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:num_red_path	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    ...
    //   156: checkcast 258	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath
    //   159: astore 8
    //   161: aload 8
    //   163: getfield 664	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:str_path	Lcom/tencent/mobileqq/pb/PBStringField;
    //   166: invokevirtual 207	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   169: aload_1
    //   170: invokevirtual 248	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   173: ifeq -37 -> 136
    //   176: bipush 100
    //   178: iload_2
    //   179: if_icmpne +29 -> 208
    //   182: aload 8
    //   184: getfield 270	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:uint32_msg_status	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   187: invokevirtual 126	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   190: ifeq +49 -> 239
    //   193: iconst_1
    //   194: aload 8
    //   196: getfield 270	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:uint32_msg_status	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   199: invokevirtual 126	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   202: if_icmpne +31 -> 233
    //   205: goto +34 -> 239
    //   208: aload 8
    //   210: getfield 270	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:uint32_msg_status	Lcom/tencent/mobileqq/pb/PBUInt32Field;
  ...
  private void b(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bcst.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00899", "Grp_tribe", "", "dynamic", "Clk_tribe", 0, 0, i + "", "", "", "");
      ...
      a(qnf.a("OidbSvc.0xd40_0", 3392, 0, paramAppInfo.toByteArray()));
      return;
    }
  }
  ...
  private void b(byte[] paramArrayOfByte)
  {
    ...
    for (QQAppInterface localQQAppInterface = (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface;; localQQAppInterface = null)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        for (;;)
        {
          QLog.e("RedPointManage", 1, "TimeRspBody handle push exception " + paramArrayOfByte);
          int i = 0;
        }
        if (!BaseActivity.mAppForground) {
          continue;
        }
        ((antv)localQQAppInterface.a(87)).a(true, true);
        return;
  ...
  private void c()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        try
        {
          byte[] arrayOfByte = bgmg.a(localFile);
          if (arrayOfByte != null) {
            break;
          }
  ...
  public int a(vqv paramvqv, boolean paramBoolean)
  {
    int n = 0;
    ...
    if (paramvqv != null)
    {
      ...
      if ((paramvqv == null) && (this.jdField_b_of_type_Long <= 0L) && (!paramBoolean)) {
        break label202;
      }
      j = 1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((j != 0) && (k > 0))
        {
          ...
          a((long[])localObject2, "QQCircleRedCircle", new baig(this, paramvqv, m));
          return m;
        }
        if (paramvqv == null) {
          break label378;
      ...
      catch (Exception paramvqv)
      {
        paramvqv.printStackTrace();
        QLog.e("RedPointManage", 1, "getPassiveRedNumQQCircle", paramvqv);
        return m;
      }
    }
    label378:
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(QQAppInterface paramQQAppInterface, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      else if (!anoy.a(paramQQAppInterface, ((BusinessInfoCheckUpdate.AppInfo)localObject5).uiAppId.get(), paramBoolean, paramMap))
      {
    ...
    if (paramArrayOfByte != null) {
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((a(localNumRedBusiInfo)) && (baij.a(localNumRedBusiInfo))) {
  ...
  public void a(long[] paramArrayOfLong, String paramString, bahz parambahz)
  {
    ((baia)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(65)).a(paramArrayOfLong, paramString, parambahz);
  }
  ...
  public boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	baif:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   4: invokevirtual 188	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7: astore 5
    //   9: aload_0
    //   10: getfield 35	baif:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 4
    //   15: aload 4
    //   17: monitorenter
    //   18: aload_1
    //   19: invokevirtual 1185	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:toByteArray	()[B
    //   22: astore 6
    //   24: aload 4
    //   26: monitorexit
    //   27: getstatic 30	baif:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   30: astore 4
    //   32: aload 4
    //   34: monitorenter
    //   35: getstatic 25	baif:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   38: invokevirtual 1188	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   41: istore_2
    //   42: new 783	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 37	baif:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   50: invokevirtual 786	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   53: invokevirtual 792	mqq/app/MobileQQ:getFilesDir	()Ljava/io/File;
    //   56: new 209	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 362	java/lang/StringBuilder:<init>	()V
    //   63: ldc_w 794
    //   66: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: aload 5
    //   71: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   74: invokevirtual 233	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   77: invokespecial 797	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   80: invokevirtual 1191	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   83: aload 6
    //   85: iconst_0
    //   86: invokestatic 1194	bgmg:a	(Ljava/lang/String;[BZ)Z
    //   89: istore_3
    //   90: iload_3
    //   91: ifeq +91 -> 182
    //   94: getstatic 1197	bccg:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload 5
    //   99: iconst_0
    //   100: invokestatic 1202	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   103: invokevirtual 1205	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   106: pop
    //   107: aload 4
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 35	baif:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   114: astore 4
    //   116: aload 4
    //   118: monitorenter
    //   119: iload_3
    //   120: ifeq +18 -> 138
    //   123: iload_2
    //   124: getstatic 25	baif:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   127: invokevirtual 1206	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   130: if_icmpne +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokespecial 1208	baif:b	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;)V
    //   138: aload 4
    //   140: monitorexit
    //   141: iload_3
    //   142: ireturn
    ...
    //   148: ldc_w 1210
    //   151: aload_1
    //   152: invokestatic 435	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   155: aload 4
    //   157: monitorexit
    //   158: iconst_0
    //   159: ireturn
    ...
    //   170: iconst_1
    //   171: ldc_w 1212
    //   174: invokestatic 503	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   177: aload 4
    //   179: monitorexit
    //   180: iconst_0
    //   181: ireturn
    ...
    //   185: iconst_1
    //   186: ldc_w 1214
    //   189: invokestatic 503	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   192: goto -85 -> 107
    //   195: astore_1
    //   196: aload 4
    //   198: monitorexit
  ...
  public boolean b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	baif:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    //   7: iload_1
    ...
    //   14: ireturn
    //   15: aload_0
    //   16: invokevirtual 82	baif:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnonnull +7 -> 30
    //   26: aload_3
    ...
    //   85: if_icmpne -31 -> 54
    //   88: aload 5
    //   90: getfield 1265	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:flag	Lcom/tencent/mobileqq/pb/PBBoolField;
    //   93: invokevirtual 967	com/tencent/mobileqq/pb/PBBoolField:get	()Z
    //   96: istore_2
    //   97: aload_3
    //   98: monitorexit
    //   99: iload_2
