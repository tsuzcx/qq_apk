...
public class ahed
{
  ...
  private static ahed jdField_a_of_type_Ahed;
  public static final String a;
  public static long b;
  public static final String b;
  public Handler a;
  public HandlerThread a;
  HashMap<String, ahee> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public MqqHandler a;
  ahef[] jdField_a_of_type_ArrayOfAhef = null;
  private ArrayList[] jdField_a_of_type_ArrayOfJavaUtilArrayList = new ArrayList[6];
  private ArrayList[] b;
  
  static
  {
    jdField_a_of_type_JavaLangString = bhgg.a("Tencent/MobileQQ/poke/");
  ...
  private ahed()
  {
    ...
    this.jdField_a_of_type_ArrayOfAhef = new ahef[6];
    ahef[] arrayOfahef = this.jdField_a_of_type_ArrayOfAhef;
    int k = arrayOfahef.length;
    i = j;
    while (i < k)
    {
      ahef localahef = arrayOfahef[i];
      localahef = new ahef(this);
      localahef.jdField_a_of_type_Int = 1;
      localahef.jdField_a_of_type_Long = -1L;
      i += 1;
    }
  ...
  {
    if (jdField_a_of_type_Ahed == null) {}
    try
    {
      if (jdField_a_of_type_Ahed == null) {
        jdField_a_of_type_Ahed = new ahed();
      }
      return jdField_a_of_type_Ahed;
    }
    finally {}
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject1 = new ahee(this);
      ((ahee)localObject1).jdField_a_of_type_ArrayOfAheg = new aheg[6];
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    Object localObject2 = (ahee)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localObject2 == null)
    {
      paramQQAppInterface = new HashMap();
      paramQQAppInterface.put(BaseConstants.RDM_NoChangeFailCode, "");
      bctj.a(BaseApplication.getContext()).a(null, "pokeStrengthNullPoint", false, 0L, 0L, paramQQAppInterface, "");
      return 0;
    }
    Object localObject1 = ((ahee)localObject2).jdField_a_of_type_ArrayOfAheg;
    paramInt2 = ((ahee)localObject2).jdField_a_of_type_Int;
    if (paramInt1 - 1 == -1) {
      paramInt1 = 0;
    }
    while ((paramInt1 >= 0) && (paramInt1 < 6))
    {
      ...
      {
        localObject1[paramInt1] = new aheg(this);
      ...
      if (paramInt3 != -1)
      {
        ...
        ((ahee)localObject2).jdField_a_of_type_Int = paramInt1;
      ...
      else
      {
        ...
        {
          if (paramInt2 != -1) {
            bcst.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
          }
          localObject1[paramInt1].jdField_a_of_type_Long = l1;
          if (QLog.isColorLevel()) {
    ...
    {
      bcst.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
      ((ahee)localObject2).jdField_a_of_type_Int = -1;
    }
    return 0;
  }
  ...
  public void a(View paramView)
  {
    ...
    Object localObject;
    if (aguj.class.isInstance(paramView))
    {
      localObject = (aguj)paramView;
      if (QLog.isColorLevel()) {
        QLog.d("GivingHeart", 2, new Object[] { "==>to be remove obj:", Integer.valueOf(((aguj)localObject).jdField_b_of_type_Int) });
      }
      if ((((aguj)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForPoke))
      {
        paramView = (MessageForPoke)((aguj)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if (aheh.a(paramView.interactType)) {
          break label82;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        } while (!((aguj)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a());
        localObject = ((aguj)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a();
        paramView.mUnlimitedState.jdField_a_of_type_Int = ((ahnu)localObject).jdField_a_of_type_Int;
        paramView.mUnlimitedState.jdField_b_of_type_Int = ((ahnu)localObject).jdField_b_of_type_Int;
        paramView.mUnlimitedState.jdField_a_of_type_Long = ((ahnu)localObject).jdField_a_of_type_Long;
        paramView.mFrameState.c = ((ahnu)localObject).jdField_b_of_type_Boolean;
        paramView.mFrameState.jdField_a_of_type_Boolean = ((ahnu)localObject).jdField_a_of_type_Boolean;
        return;
        localObject = ((aguj)localObject).jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getBackground();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new bkgm(Looper.getMainLooper(), paramFitSystemWindowsRelativeLayout);
  }
}
