...
public class axsb
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, axqa paramaxqa, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramaxqa == null) || (paramaxqa.b)) {
          break label519;
        }
        paramaxqa.b = true;
        if ((paramInt == 1) && (paramaxqa.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramaxqa, paramInt);
        paramaxqa = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramaxqa)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramaxqa.toString() + ",filePath:" + paramString2);
        paramaxqa = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramaxqa = (axqa)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramaxqa);
      if (QLog.isColorLevel())
      {
        if (paramaxqa != null) {
          continue;
