...
public class bcdd
  implements bcgv
{
  public bcdd(DINewForCommonWebView paramDINewForCommonWebView, String paramString) {}
  
  public void a(int paramInt, String paramString)
  {
    bcds.e("DINewForCommonWebView", "[innerQuery] [onException] errorCode=" + paramInt + ", errorMsg=" + paramString);
  }
  
  public void a(List<DownloadInfo> paramList)
  {
    bcds.c("DINewForCommonWebView", "[innerQuery] onResult = " + paramList.size());
    ...
    bcds.c("DINewForCommonWebView", "[innerQuery] querySucess : " + paramList);
