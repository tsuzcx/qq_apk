...
public class bcdd
  implements Handler.Callback, bcfc, Manager
{
  ...
  public bcdd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap(4);
    this.jdField_a_of_type_MqqOsMqqHandler = new bfum(ThreadManager.getSubThreadLooper(), this);
    a();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    try
    {
      ...
      paramMessage = (ActivityDAUInfo)this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.find(ActivityDAUInfo.class, (String)localObject3);
      if (paramMessage != null) {
        break label803;
      }
