...
public class lnr
{
  ...
  public static ArrayList<lnt> a(String paramString, Context paramContext)
  {
    ...
    if (DeviceCheck.b()) {
      if (DeviceCheck.e())
      {
        ((ArrayList)localObject1).add(new lnt(1, true));
        if (AudioHelper.f()) {
        ...
        ((ArrayList)localObject1).add(new lnt(2, true));
        if (AudioHelper.f()) {
    ...
    for (;;)
    {
      ...
      break;
      localObject2 = new lnx(lfh.a(paramContext));
      lnt locallnt = ((lnx)localObject2).c();
      if ((locallnt != null) && (locallnt.jdField_a_of_type_Boolean)) {
        if (DeviceCheck.e())
        {
          ((ArrayList)localObject1).add(locallnt);
          if (AudioHelper.f()) {
            QLog.w(paramString, 1, "checkSupportHWCodecAbility, 支持H264解码. maxW = " + locallnt.jdField_b_of_type_Int + ", maxH = " + locallnt.jdField_c_of_type_Int);
          }
        }
      }
      for (;;)
      {
        localObject2 = ((lnx)localObject2).a();
        if ((localObject2 == null) || (!((lnt)localObject2).jdField_a_of_type_Boolean)) {
          break label722;
        }
        if (!DeviceCheck.c()) {
          break label711;
        ...
        QLog.w(paramString, 1, "checkSupportHWCodecAbility, 支持H265解码. maxW = " + ((lnt)localObject2).jdField_b_of_type_Int + ", maxH = " + ((lnt)localObject2).jdField_c_of_type_Int);
        break;
      ...
      continue;
      label750:
      paramContext = new lnx(lfh.a(paramContext));
      ...
      if ((localObject2 != null) && (((lnt)localObject2).jdField_a_of_type_Boolean)) {
        if (DeviceCheck.f())
        {
          ((ArrayList)localObject1).add(localObject2);
          if (AudioHelper.f()) {
            QLog.w(paramString, 1, "checkSupportHWCodecAbility, 支持H264编码. maxW = " + ((lnt)localObject2).jdField_b_of_type_Int + ", maxH = " + ((lnt)localObject2).jdField_c_of_type_Int);
          }
        }
      }
      for (;;)
  ...
  private static boolean a(ArrayList<lnt> paramArrayList)
  {
    boolean bool2 = false;
    int m;
    int k;
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      locallnt = (lnt)paramArrayList.next();
      if ((locallnt.jdField_a_of_type_Int == 1) && (locallnt.jdField_a_of_type_Boolean) && (locallnt.jdField_b_of_type_Int >= 1920) && (locallnt.jdField_c_of_type_Int >= 1080))
      {
        n = m;
        j = k;
        k = 1;
    ...
    for (;;)
    {
      ...
      i = n;
      break;
      if ((locallnt.jdField_a_of_type_Int == 2) && (locallnt.jdField_a_of_type_Boolean) && (locallnt.jdField_b_of_type_Int >= 1920) && (locallnt.jdField_c_of_type_Int >= 1080))
      {
        i = m;
        m = j;
        n = 1;
      ...
      else if ((locallnt.jdField_a_of_type_Int == 4) && (locallnt.jdField_a_of_type_Boolean) && (locallnt.jdField_b_of_type_Int >= 1920) && (locallnt.jdField_c_of_type_Int >= 1080))
      {
        i1 = 1;
        m = j;
        n = i;
      ...
      else if ((locallnt.jdField_a_of_type_Int == 8) && (locallnt.jdField_a_of_type_Boolean) && (locallnt.jdField_b_of_type_Int >= 1920) && (locallnt.jdField_c_of_type_Int >= 1080))
      {
        n = m;
        k = j;
        j = 1;
  ...
  public lns a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   4: ifnonnull +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: new 456	lns
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 459	lns:<init>	(Llnr;)V
    //   17: astore_2
    //   18: aload_0
    //   19: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   22: getstatic 40	lnr:jdField_c_of_type_Int	I
    //   25: i2l
    //   26: invokevirtual 463	android/media/MediaCodec:dequeueInputBuffer	(J)I
    //   29: istore_1
    //   30: iload_1
    //   31: iflt -24 -> 7
    //   34: getstatic 79	android/os/Build$VERSION:SDK_INT	I
    //   37: bipush 20
    //   39: if_icmpgt +29 -> 68
    //   42: aload_0
    //   43: monitorenter
    //   44: aload_2
    //   45: iload_1
    //   46: putfield 464	lns:jdField_a_of_type_Int	I
    //   49: aload_2
    //   50: aload_0
    //   51: getfield 466	lnr:jdField_a_of_type_ArrayOfJavaNioByteBuffer	[Ljava/nio/ByteBuffer;
    //   54: iload_1
    //   55: aaload
    //   56: putfield 469	lns:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   59: aload_0
    //   60: monitorexit
    //   61: aload_2
    //   62: areturn
    ...
    //   70: aload_2
    //   71: iload_1
    //   72: putfield 464	lns:jdField_a_of_type_Int	I
    //   75: aload_2
    //   76: getstatic 347	lnr:jdField_a_of_type_JavaLangReflectMethod	Ljava/lang/reflect/Method;
    //   79: aload_0
    //   80: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   83: iconst_1
    //   84: anewarray 4	java/lang/Object
    //   87: dup
    //   88: iconst_0
    //   89: iload_1
    //   90: invokestatic 430	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   93: aastore
    //   94: invokevirtual 436	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   97: checkcast 445	java/nio/ByteBuffer
    //   100: putfield 469	lns:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   103: aload_0
    //   104: monitorexit
    //   105: aload_2
    //   106: areturn
    //   107: astore_3
    //   108: aload_3
    //   109: invokevirtual 470	java/lang/IllegalAccessException:printStackTrace	()V
    //   112: aload_2
    //   113: iconst_0
    //   114: putfield 471	lns:jdField_a_of_type_Boolean	Z
    //   117: goto -14 -> 103
    //   120: astore_2
    //   121: aload_0
    //   122: monitorexit
    ...
    //   125: astore_3
    //   126: aload_3
    //   127: invokevirtual 472	java/lang/IllegalArgumentException:printStackTrace	()V
    //   130: aload_2
    //   131: iconst_0
    //   132: putfield 471	lns:jdField_a_of_type_Boolean	Z
    //   135: goto -32 -> 103
    //   138: astore_3
    //   139: aload_3
    //   140: invokevirtual 473	java/lang/reflect/InvocationTargetException:printStackTrace	()V
    //   143: aload_2
    //   144: iconst_0
    //   145: putfield 471	lns:jdField_a_of_type_Boolean	Z
    //   148: goto -45 -> 103
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	151	0	this	lnr
    //   29	61	1	i	int
    //   17	45	2	locallns1	lns
    //   63	50	2	locallns2	lns
  ...
  public lns a(long paramLong)
  {
    ...
    int i = this.jdField_a_of_type_AndroidMediaMediaCodec.dequeueOutputBuffer(locallns.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, 3000L);
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          locallns.jdField_a_of_type_JavaNioByteBuffer = this.jdField_b_of_type_ArrayOfJavaNioByteBuffer[i];
          locallns.jdField_a_of_type_Int = i;
          locallns.jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_b_of_type_AndroidMediaMediaFormat;
          localObject3 = locallns;
          break;
          ...
          locallns.jdField_a_of_type_Int = -3;
          l1 = l2;
          break label100;
          locallns.jdField_a_of_type_Int = -2;
        ...
        l1 = l2;
        break label100;
        locallns.jdField_a_of_type_Int = -1;
        Object localObject4 = locallns;
        break;
        label417:
        locallns.jdField_a_of_type_Int = i;
        try
        {
          locallns.jdField_a_of_type_JavaNioByteBuffer = ((ByteBuffer)jdField_b_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
          locallns.jdField_a_of_type_AndroidMediaMediaFormat = ((MediaFormat)jdField_c_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
          localObject4 = locallns;
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
          for (;;)
          {
            ...
            locallns.jdField_a_of_type_Boolean = false;
          }
        }
  ...
  public void a(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   18: iload_1
    //   19: iconst_0
    //   20: invokevirtual 529	android/media/MediaCodec:releaseOutputBuffer	(IZ)V
    //   23: goto -12 -> 11
    //   26: astore_2
    //   27: aload_0
    //   28: monitorexit
  ...
  public void a(int paramInt1, int paramInt2, long paramLong, int paramInt3)
  {
    ...
    //   15: return
    //   16: aload_0
    //   17: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   20: iload_1
    //   21: iconst_0
    //   22: iload_2
    //   23: lload_3
    //   24: iload 5
    //   26: invokevirtual 534	android/media/MediaCodec:queueInputBuffer	(IIIJI)V
    //   29: goto -16 -> 13
    //   32: astore 6
    //   34: invokestatic 229	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   37: ifeq -24 -> 13
    //   40: aload_0
    //   41: getfield 72	lnr:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   44: iconst_1
    ...
    //   58: iload_1
    //   59: invokevirtual 195	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   62: ldc_w 538
    //   65: invokevirtual 64	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   68: iload_2
    //   69: invokevirtual 195	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   72: ldc_w 540
    //   75: invokevirtual 64	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: lload_3
    //   79: invokevirtual 543	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   82: ldc_w 545
    //   85: invokevirtual 64	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   88: iload 5
    //   90: invokevirtual 195	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   93: ldc 117
    ...
    //   101: aload 6
    //   103: invokestatic 121	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   106: goto -93 -> 13
    //   109: astore 6
    //   111: aload_0
    //   112: monitorexit
  ...
  boolean a(MediaCodec paramMediaCodec, lnv paramlnv)
  {
    if ((paramlnv != null) && (DeviceCheck.g()))
    {
      ...
      if (localObject != null) {
        try
        {
          ...
          boolean bool = mqv.a(localDexClassLoader, localObject, "setCallback", new Class[] { MediaCodec.class, lnv.class }, new Object[] { paramMediaCodec, paramlnv }, arrayOfObject);
          return bool;
        }
  ...
  /* Error */
  public boolean a(MediaFormat paramMediaFormat, int paramInt, lnv paramlnv)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    //   3: aload_0
    //   4: aload_1
    //   5: putfield 583	lnr:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   8: iload_2
    //   9: getstatic 55	lnr:jdField_b_of_type_Int	I
    //   12: if_icmpne +88 -> 100
    //   15: aload_0
    //   16: aload_0
    //   17: getfield 583	lnr:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   20: ldc_w 585
    //   23: invokevirtual 589	android/media/MediaFormat:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   26: invokestatic 593	android/media/MediaCodec:createDecoderByType	(Ljava/lang/String;)Landroid/media/MediaCodec;
    //   29: putfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   32: aload_0
    //   33: iload_2
    //   34: putfield 57	lnr:e	I
    //   37: aload_0
    //   38: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   41: ifnull +39 -> 80
    //   44: iload_2
    //   45: getstatic 23	lnr:jdField_a_of_type_Int	I
    //   48: if_icmpne +86 -> 134
    //   51: iconst_1
    //   52: istore_2
    //   53: aload_0
    //   54: aload_0
    //   55: aload_0
    //   56: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   59: aload_3
    //   60: invokevirtual 595	lnr:a	(Landroid/media/MediaCodec;Llnv;)Z
    //   63: putfield 597	lnr:jdField_d_of_type_Boolean	Z
    //   66: aload_0
    //   67: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   70: aload_0
    //   71: getfield 583	lnr:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   74: aconst_null
    //   75: aconst_null
    //   76: iload_2
    //   77: invokevirtual 601	android/media/MediaCodec:configure	(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    //   80: aload_0
    //   81: getfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   84: ifnull +6 -> 90
    //   87: iconst_1
    //   88: istore 4
    //   90: iload 4
    ...
    //   93: astore_1
    //   94: aload_1
    //   95: invokevirtual 602	java/lang/Exception:printStackTrace	()V
    //   98: iconst_0
    //   99: ireturn
    //   100: aload_0
    //   101: aload_0
    //   102: getfield 583	lnr:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   105: ldc_w 585
    //   108: invokevirtual 589	android/media/MediaFormat:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   111: invokestatic 605	android/media/MediaCodec:createEncoderByType	(Ljava/lang/String;)Landroid/media/MediaCodec;
    //   114: putfield 426	lnr:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   117: goto -85 -> 32
    //   120: astore_1
    //   121: aload_1
    //   122: invokevirtual 602	java/lang/Exception:printStackTrace	()V
    //   125: iconst_0
    //   126: ireturn
    //   127: astore_1
    //   128: aload_1
    //   129: invokevirtual 602	java/lang/Exception:printStackTrace	()V
    //   132: iconst_0
    //   133: ireturn
    //   134: iconst_0
    //   135: istore_2
  ...
  public boolean a(MediaFormat paramMediaFormat, String paramString, Surface paramSurface, lnv paramlnv)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramMediaFormat)
      {
        try
        {
          if (this.jdField_a_of_type_AndroidMediaMediaCodec != null)
          {
            this.jdField_d_of_type_Boolean = a(this.jdField_a_of_type_AndroidMediaMediaCodec, paramlnv);
  ...
  public boolean a(MediaFormat paramMediaFormat, String paramString, lnv paramlnv)
  {
    this.jdField_a_of_type_AndroidMediaMediaFormat = paramMediaFormat;
    paramMediaFormat = a(paramString);
    if ((paramMediaFormat != null) && (paramMediaFormat.isEncoder())) {
  ...
  public lns b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        lns locallns = new lns(this);
        i = this.jdField_a_of_type_AndroidMediaMediaCodec.dequeueOutputBuffer(locallns.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, jdField_c_of_type_Int);
        switch (i)
        {
        case -3: 
          if (NativeCodec.canLog()) {
