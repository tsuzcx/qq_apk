...
class bfvs
  extends nmf
{
  bfvs(bfvp parambfvp, String paramString1, String paramString2, String paramString3) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    {
      atqa.a("KEY_STAGE_2_GO_TO_CHAT_D55", bool1);
      this.jdField_a_of_type_Bfvp.c();
      if (!this.jdField_a_of_type_Bfvp.h) {
        break;
      }
      bcef.b(this.jdField_a_of_type_Bfvp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A40E", "0X800A40E", 0, 0, "", "", this.jdField_a_of_type_Bfvp.jdField_a_of_type_AndroidContentContext.getString(2131698644), "");
    ...
    for (;;)
    {
      if (paramInt <= 1)
      {
        paramBundle = (String)this.jdField_a_of_type_Bfvp.jdField_a_of_type_JavaUtilHashMap.get("uin");
        if ((paramBundle == null) || (paramBundle.length() < 5) || (SearchBaseActivity.b.matcher(paramBundle).matches()))
        {
          QQToast.a(BaseApplicationImpl.getApplication(), 1, 2131698643, 1).a();
          bcef.b(this.jdField_a_of_type_Bfvp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A40E", "0X800A40E", 0, 0, "", "", this.jdField_a_of_type_Bfvp.jdField_a_of_type_AndroidContentContext.getString(2131698645), "");
          bfvp.c(this.jdField_a_of_type_Bfvp);
          return;
          if (paramInt == 25501) {
            paramInt = 1;
        ...
        {
          bool2 = ((amsw)this.jdField_a_of_type_Bfvp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramBundle);
          paramArrayOfByte = ContactUtils.getFriendNick(this.jdField_a_of_type_Bfvp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBundle);
          if ((bool2) && (paramInt == 0))
          {
            localObject = new Intent(this.jdField_a_of_type_Bfvp.jdField_a_of_type_AndroidContentContext, SplashActivity.class);
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        bcef.b(this.jdField_a_of_type_Bfvp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A40F", "0X800A40F", 0, 0, "", "", "", "");
        if (!bool2) {
          break label658;
        }
      ...
      for (;;)
      {
        bfvp.a(this.jdField_a_of_type_Bfvp, (Bundle)localObject);
        bfvp.c(this.jdField_a_of_type_Bfvp);
        return;
        bool1 = false;
        break;
      ...
      bcef.a(this.jdField_a_of_type_Bfvp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "inter", "skip", "inter_fail", "", 1, "", paramArrayOfByte, "", "", "", "", "", "", "");
      ...
      bfvp.a(this.jdField_a_of_type_Bfvp, paramBundle);
    }
  }
}
