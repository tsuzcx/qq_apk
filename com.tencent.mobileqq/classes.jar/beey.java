  ...
  implements View.OnClickListener
{
  ...
  public beey(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment, View paramView)
  {
    super(paramView);
  }
  ...
  {
    befh localbefh = (befh)this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int);
    String str;
    ...
    for (;;)
    {
      ...
      str = "2";
      break;
      Object localObject1 = new ProfileActivity.AllInOne(String.valueOf(localbefh.jdField_c_of_type_Long), 86);
      ...
      boolean bool = BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(String.valueOf(localbefh.jdField_c_of_type_Long));
      ...
      for (;;)
      {
        bcst.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_poster", 0, 0, localbefh.d, localbefh.b + "", "", str);
        break;
      ...
      if (!localbefh.jdField_c_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(1, String.valueOf(localbefh.jdField_c_of_type_Long), new beez(this, localbefh, str));
        continue;
        ...
        label847:
        for (localObject1 = "" + localbefh.h;; localObject1 = "")
        {
          bcst.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localbefh.d, localbefh.b + "", (String)localObject1, str);
          break;
        ...
        for (;;)
        {
          bcst.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localbefh.d, localbefh.b + "", "", str);
          break;
        ...
        for (;;)
        {
          bcst.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_share", 0, 0, localbefh.d, localbefh.b + "", "", str);
          break;
          if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_c_of_type_Boolean)
          {
            if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).webView != null) {
        ...
        if (localbefh.k != 1)
        {
          this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(localbefh.b, localbefh.d, new befa(this, localbefh));
          bcst.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_like", 0, 0, localbefh.d, localbefh.b + "", "", str);
          continue;
          ...
          ((Intent)localObject1).putExtra("url", localbefh.g);
          ...
          bcst.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_detail", 0, 0, localbefh.d, localbefh.b + "", "", str);
        }
      }
    }
  }
