  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  public beey()
  {
    ...
    this.jdField_a_of_type_Befb = new befb();
  ...
  private void a(Uri paramUri)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x20000) != 0L) {
        azmj.a(null, "dc00898", "", "", "0X800ADD8", "0X800ADD8", 131072, 0, "", "", str, "");
      }
      if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x1000000) != 0L) {
        azmj.a(null, "dc00898", "", "", "0X800ADD8", "0X800ADD8", 16777216, 0, "", "", str, "");
      }
      if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x2) != 0L) {
        azmj.a(null, "dc00898", "", "", "0X800ADD8", "0X800ADD8", 2, 0, "", "", str, "");
      }
      return;
    }
  ...
  {
    return (TouchWebView)this.jdField_a_of_type_Bedi.a();
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Bedi.a() != null)
    {
      WebView localWebView = this.jdField_a_of_type_Bedi.a();
      localWebView.setId(2131380117);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    case 2: 
      ...
      if (this.jdField_a_of_type_Befb.s) {
    ...
    case 3: 
      ...
      this.jdField_a_of_type_Bebk.f();
      return;
    case 4: 
      if ((this.jdField_a_of_type_Bebf.jdField_a_of_type_AndroidViewView != null) && (8 == this.jdField_a_of_type_Bebf.jdField_c_of_type_AndroidViewView.getVisibility())) {
        this.jdField_a_of_type_Bebf.a();
      }
      if (paramBundle.containsKey("Configuration")) {}
      for (paramBundle = (Configuration)paramBundle.getParcelable("Configuration"); (paramBundle != null) && (this.jdField_a_of_type_Bebf.jdField_c_of_type_AndroidViewView != null) && (paramBundle.orientation == 2) && (this.jdField_a_of_type_Bebf.jdField_c_of_type_AndroidViewView.getVisibility() == 0); paramBundle = null)
      {
        this.jdField_a_of_type_Bebf.jdField_c_of_type_AndroidViewView.setVisibility(8);
        return;
      }
    case 6: 
      if ((!this.jdField_a_of_type_Beep.j) && (this.jdField_a_of_type_Besa != null) && (this.jdField_a_of_type_Besa.b() != 0)) {
    ...
    for (paramBundle = paramBundle.getString("url");; paramBundle = null)
    {
      ...
      if ((localObject1 != null) && (((Uri)localObject1).isHierarchical()) && ("simple".equals(((Uri)localObject1).getQueryParameter("style"))))
      {
        ...
        this.jdField_a_of_type_Befb.y = true;
      }
      a(this.jdField_a_of_type_Bedi.a());
      return;
      if (this.jdField_a_of_type_Besa != null) {
        this.jdField_a_of_type_Besa.a((byte)2);
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      if ((this.jdField_a_of_type_Befb.D) || (this.jdField_b_of_type_AndroidWidgetTextView == null)) {
        break;
      }
      if ((this.jdField_c_of_type_AndroidViewView != null) && (this.jdField_a_of_type_Int == -1)) {
        this.jdField_c_of_type_AndroidViewView.setBackgroundResource(2131167188);
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      if (this.jdField_a_of_type_Bedi.a() == null) {
        break;
      }
      localObject1 = (TouchWebView)this.jdField_a_of_type_Bedi.a();
      ...
      for (;;)
      {
        ...
        ((TouchWebView)localObject1).setOnOverScrollHandler(new beez(this, (TouchWebView)localObject1, paramBundle));
        ((TouchWebView)localObject1).setOnScrollChangedListener(new befa(this));
        b(this.jdField_a_of_type_Bedi.a());
        return;
        label564:
  ...
  public void a(Intent paramIntent)
  {
    int i;
    boolean bool;
    if (((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x20000) != 0L) || (paramIntent.getBooleanExtra("isFullScreen", false)))
    {
      i = 1;
      if (i != 0) {
        this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean = true;
      }
      befb localbefb = this.jdField_a_of_type_Befb;
      if (((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x1000000) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitle", false))) {
        break label696;
      }
      bool = true;
      label76:
      localbefb.jdField_b_of_type_Boolean = bool;
      localbefb = this.jdField_a_of_type_Befb;
      if (((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("isTransparentTitleAndClickable", false))) {
        break label701;
      }
      bool = true;
      label115:
      localbefb.m = bool;
      localbefb = this.jdField_a_of_type_Befb;
      if (((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x2) == 0L) && (!paramIntent.getBooleanExtra("hide_more_button", false))) {
        break label706;
      }
      bool = true;
      label156:
      localbefb.e = bool;
      localbefb = this.jdField_a_of_type_Befb;
      if (((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 1L) == 0L) && (!paramIntent.getBooleanExtra("hide_operation_bar", false)) && (!"noBottomBar".equals(paramIntent.getStringExtra("webStyle")))) {
        break label711;
      }
      bool = true;
      label211:
      localbefb.f = bool;
      localbefb = this.jdField_a_of_type_Befb;
      if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 0x100) == 0L) {
        break label716;
      }
      bool = true;
      label241:
      ...
      {
        this.jdField_a_of_type_Befb.e = true;
        this.jdField_a_of_type_Befb.f = true;
      }
      i = paramIntent.getIntExtra("reqType", -1);
      if ((!this.jdField_a_of_type_Befb.f) && (i == 6)) {
        this.jdField_a_of_type_Befb.f = true;
      }
      this.jdField_a_of_type_Befb.g = paramIntent.getBooleanExtra("fromOneCLickCLose", false);
      this.jdField_a_of_type_Befb.q = paramIntent.getBooleanExtra("rightTopCancel", false);
      this.jdField_a_of_type_Befb.r = paramIntent.getBooleanExtra("webViewMoveTop", false);
      if ((!this.jdField_a_of_type_Befb.e) && ((i == 3) || (i == 1) || (!paramIntent.getBooleanExtra("ba_is_login", true)) || (i == 7))) {
        this.jdField_a_of_type_Befb.e = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x20000) > 0L) {
        this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x20000000) != 0L) {
        this.jdField_a_of_type_Befb.s = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x800) > 0L)
      {
        this.jdField_a_of_type_Befb.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
      }
      if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 0x4) > 0L)
      {
        this.jdField_a_of_type_Befb.jdField_d_of_type_Boolean = false;
        this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
      }
      if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 0x2) > 0L) {
        this.jdField_a_of_type_Befb.h = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 0x200) > 0L) {
        this.jdField_a_of_type_Befb.D = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 0x400) > 0L)
      {
        localbefb = this.jdField_a_of_type_Befb;
        this.jdField_a_of_type_Befb.B = true;
        localbefb.E = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Long & 0x2000) > 0L) {
        this.jdField_a_of_type_Befb.p = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_d_of_type_Long & 1L) > 0L) {
        this.jdField_a_of_type_Befb.jdField_b_of_type_Boolean = true;
      }
      if ((this.jdField_a_of_type_Befb.jdField_d_of_type_Long & 0x8) > 0L) {
        this.jdField_a_of_type_Befb.m = true;
      }
      if (!paramIntent.getBooleanExtra("from_single_task", false)) {
        break label721;
      }
      this.jdField_a_of_type_Befb.G = true;
    }
    label696:
    label701:
    label706:
    ...
    label716:
    label721:
    while ((this.jdField_a_of_type_Befb.jdField_a_of_type_Long & 0x80000000) <= 0L)
    {
      return;
      i = 0;
      break;
    ...
    this.jdField_a_of_type_Befb.F = myl.a().j(paramIntent.getStringExtra("url"));
  }
  
  public void a(Intent paramIntent, String paramString)
  {
    this.jdField_a_of_type_Bebk.a(paramIntent, paramString);
    a(this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject, false);
    d();
  }
  ...
  {
    this.jdField_a_of_type_Bebk.a(paramView, paramInt1, paramInt2, paramInt3);
  }
  ...
  public void a(View paramView, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      return;
      int i;
      if ((this.jdField_a_of_type_Befb.B) && (!"1000".equals(ThemeUtil.getCurrentThemeId()))) {
        i = 1;
      }
  ...
  {
    this.jdField_a_of_type_Bebk.a(paramTouchWebView);
  }
  ...
  public void a(WebBrowserViewContainer paramWebBrowserViewContainer, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramWebBrowserViewContainer.findViewById(2131366993));
    ...
    {
      paramWebBrowserViewContainer.b(this.jdField_a_of_type_Befb.H);
      this.jdField_a_of_type_Bebf.a(paramWebBrowserViewContainer, this.jdField_a_of_type_AndroidViewView$OnClickListener);
      this.jdField_a_of_type_Bebf.a(this.jdField_a_of_type_AndroidAppActivity);
    }
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Beep.s = (l1 - l2);
    this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar = ((WebViewProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372322));
    ...
    paramIntent = this.jdField_a_of_type_Besa;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131380127));
      ndq.b("Web_qqbrowser_initView_WebViewWrapper");
      l2 = System.currentTimeMillis();
      this.jdField_a_of_type_Beep.m = (l2 - l1);
      if (!this.jdField_a_of_type_Befb.D)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131377421));
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(4);
        if ((this.jdField_a_of_type_Befb.jdField_b_of_type_Boolean) && ((this.jdField_a_of_type_AndroidAppActivity instanceof BaseActivity))) {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131375537));
      }
      if ((this.jdField_a_of_type_Befb.C) && (this.jdField_c_of_type_AndroidViewView != null)) {
        this.jdField_c_of_type_AndroidViewView.setPadding(0, (int)bdcq.a(BaseApplicationImpl.getContext(), 30.0F), 0, 0);
      }
      l();
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Befb.jdField_a_of_type_Long = Long.parseLong(str1, 10);
    ...
    catch (NumberFormatException localNumberFormatException7)
    {
      try
      {
        this.jdField_a_of_type_Befb.jdField_c_of_type_Long = Long.parseLong(str1, 10);
        str1 = paramString.getQueryParameter("_fu");
        this.jdField_a_of_type_Befb.jdField_c_of_type_Boolean = false;
        if (str1 == null) {}
      }
      catch (NumberFormatException localNumberFormatException7)
      {
        try
        {
          if (Long.parseLong(str1) == 2019L) {
            this.jdField_a_of_type_Befb.jdField_c_of_type_Boolean = true;
          }
        ...
        catch (NumberFormatException localNumberFormatException7)
        {
          try
          {
            this.jdField_a_of_type_Befb.jdField_b_of_type_Long = Long.parseLong(str1, 10);
          ...
          catch (NumberFormatException localNumberFormatException7)
          {
            ...
            {
              String str2;
              this.jdField_a_of_type_Befb.jdField_d_of_type_Long = Long.parseLong(str2, 10);
              str1 = paramString.getQueryParameter("channel");
              if (!TextUtils.isEmpty(str1)) {
                this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangString = URLDecoder.decode(str1);
              }
            ...
            catch (NumberFormatException localNumberFormatException7)
            {
              try
              {
                this.jdField_a_of_type_Befb.jdField_a_of_type_Int = Integer.parseInt(str1.trim());
              ...
              catch (NumberFormatException localNumberFormatException7)
              {
                ...
                catch (NumberFormatException localNumberFormatException7)
                {
                  try
                  {
                    for (;;)
                    {
                      this.jdField_a_of_type_Befb.jdField_b_of_type_Int = Integer.parseInt(str1.trim());
                  ...
                  catch (NumberFormatException localNumberFormatException8)
                  {
                    for (;;)
                    {
                      ...
                      continue;
                      this.jdField_a_of_type_Befb.H = false;
                    }
                  }
                }
              }
  ...
  {
    this.jdField_a_of_type_Bebk.a(paramJSONObject, paramBoolean);
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Befb.n == paramBoolean) {}
    Object localObject;
    for (;;)
    {
      return;
      this.jdField_a_of_type_Befb.n = paramBoolean;
      localObject = null;
      ...
      {
        ((View)localObject).setBackgroundColor(BaseApplicationImpl.getContext().getResources().getColor(2131166957));
        if (!paramBoolean) {
          break label98;
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          localObject = this.jdField_a_of_type_Bebk.jdField_a_of_type_AndroidViewViewGroup;
        }
      }
    }
    label98:
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Bedi.a() == null);
  ...
  public void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Bebk.a((TouchWebView)this.jdField_a_of_type_Bedi.a(), paramBoolean1, paramInt1, paramInt2, paramInt3, paramBoolean2, paramString1, paramString2, paramString3);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    {
      return false;
      if (this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject == null) {
        this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject = this.jdField_a_of_type_Bebk.a(paramString);
      }
    } while ((this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject == null) || (this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject.length() == 0));
    if (this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject.optInt("trans", -1) == 0) {
      this.jdField_a_of_type_Befb.w = true;
    }
    if (!this.jdField_a_of_type_Befb.w) {
      this.jdField_a_of_type_Befb.w = this.jdField_a_of_type_Bebk.a();
    }
    return true;
  }
  ...
  {
    super.b();
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Bedi.a();
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment = this.jdField_a_of_type_Bedi.a();
    this.jdField_a_of_type_Beep = ((beep)this.jdField_a_of_type_Bedi.a().a(-2));
  }
  ...
  public void b(Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("1".equals(localUri.getQueryParameter("_qStyle")))
      {
        ...
        this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = paramIntent;
        return;
      }
      WebViewTitleStyle localWebViewTitleStyle = a((String)localObject);
      if (localWebViewTitleStyle != null)
      {
        this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = localWebViewTitleStyle;
        return;
      }
      Object localObject = b((String)localObject);
      if (localObject != null)
      {
        this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle = ((WebViewTitleStyle)localObject);
        return;
      }
      ...
      paramIntent = (WebViewTitleStyle)beax.a().a.get(paramIntent);
  ...
  {
    if (this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean) {}
    do
    {
      do
      {
        return;
      } while ((this.jdField_a_of_type_AndroidViewViewGroup != null) || (!this.jdField_a_of_type_Befb.g));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setEnabled(false);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131366750));
  ...
  public void b(WebView paramWebView)
  {
    if (this.jdField_a_of_type_Befb.g)
    {
      if (!this.jdField_a_of_type_Befb.k) {
        break label26;
      }
      a(paramWebView);
    }
  ...
  {
    if ((!this.jdField_a_of_type_Befb.g) || (this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean)) {}
    ...
    do
    {
      ...
      localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bedi.a();
    ...
    azmj.a(null, "dc00898", "", "", "0X8009B1E", "0X8009B1E", 0, 0, "", "", "", "");
    return;
    this.e = false;
    h();
    this.jdField_a_of_type_AndroidViewViewGroup.clearAnimation();
  ...
  public void c()
  {
    this.jdField_a_of_type_Bebk = beah.a(this);
    this.jdField_a_of_type_Bebf = bebe.a(this);
  }
  
  public void c(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bebf.a(paramBoolean);
  }
  
  public void d()
  {
    if ((this.jdField_a_of_type_Bedi.a() != null) && (!this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean)) {
      a((TouchWebView)this.jdField_a_of_type_Bedi.a());
    }
  }
  
  public void d(boolean paramBoolean)
  {
    this.jdField_a_of_type_Bebk.jdField_a_of_type_Befb.l = paramBoolean;
    if (paramBoolean)
    {
      this.jdField_a_of_type_Bebk.a("");
      return;
    }
    this.jdField_a_of_type_Bebk.d();
  }
  
  public void e()
  {
    if ((this.jdField_a_of_type_Befb.r) && (!this.jdField_a_of_type_Befb.w)) {
      this.jdField_a_of_type_Befb.w = this.jdField_a_of_type_Bebk.a();
    }
  }
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131378559));
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Befb.q)
    {
      localViewStub = (ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131366488);
      if (localViewStub != null) {}
    }
    else
    {
  ...
  public void h()
  {
    ...
    if ((this.jdField_a_of_type_Bedi.a() != null) && (this.jdField_a_of_type_AndroidViewViewGroup != null))
    {
    ...
    if (this.e)
    {
      ...
      f = this.jdField_a_of_type_Befb.jdField_c_of_type_Int;
    }
  ...
  public void i()
  {
    if (this.jdField_a_of_type_Bebf.g != null) {
      this.jdField_a_of_type_Bebf.g.setVisibility(0);
    }
    if ((this.jdField_a_of_type_Bebf.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_Bebf.jdField_a_of_type_AndroidViewView.getVisibility() == 8) || (this.jdField_a_of_type_Bebf.jdField_a_of_type_AndroidViewView.getVisibility() == 4))) {
      this.jdField_a_of_type_Bebf.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
  }
  ...
  public void l()
  {
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_Befb.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangBoolean.booleanValue()))
    {
      i = 1;
      if (i != 0) {
        break label74;
      }
      if ((!this.jdField_a_of_type_Befb.e) || (this.jdField_a_of_type_Befb.h)) {
        break label69;
      }
      bool = true;
    }
    for (;;)
    {
      ...
      continue;
      label74:
      bool = this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangBoolean.booleanValue();
    }
    label88:
    if (this.jdField_a_of_type_Befb.jdField_d_of_type_Boolean)
    {
  ...
  public void onClick(View paramView)
  {
    ...
    TouchWebView localTouchWebView = (TouchWebView)this.jdField_a_of_type_Bedi.a();
    ...
    do
    {
      ...
      b(localTouchWebView);
      azmj.a(null, "dc00898", "", "", "0X8009B21", "0X8009B21", 0, 0, "", "", "", "");
      return;
    ...
    b(localTouchWebView);
    azmj.a(null, "dc00898", "", "", "0X8009B20", "0X8009B20", 0, 0, "", "", "", "");
  }
}
