...
{
  bjcx jdField_a_of_type_Bjcx = new bjcx();
  private volatile boolean jdField_a_of_type_Boolean = true;
  
  public bjcv()
  {
    this.jdField_a_of_type_Bjcx.a();
  }
  ...
  {
    return bdcb.b(BaseApplication.getContext());
  }
  ...
  {
    boolean bool = this.jdField_a_of_type_Bjcx.a(paramString);
  ...
  public void registerNetworkStateObserver(UploadConfiguration.NetworkStateObserver paramNetworkStateObserver)
  {
    ...
    cooperation.qzone.util.NetworkState.addListener(new bjcw(this, paramNetworkStateObserver));
  }
}
