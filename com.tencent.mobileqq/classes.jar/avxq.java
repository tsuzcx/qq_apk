...
public class avxq
{
  ...
  public static bgpa a(int paramInt, String paramString)
  {
    bgpa localbgpa = null;
    ...
    {
      localbgpa = bglp.a(localBaseActivity, 230, null, localBaseActivity.getString(2131718119), 2131690728, 2131691095, new avxv(), new avxw(localBaseActivity, paramInt, paramString));
      paramString = new LocationDialogUtil.14(localBaseActivity, localbgpa);
  ...
  static void a(Activity paramActivity, avzs paramavzs)
  {
    paramActivity = new LocationDialogUtil.4(paramActivity, paramavzs);
    ThreadManager.getUIHandlerV2().post(paramActivity);
  }
  
  public static void a(Activity paramActivity, bgpa parambgpa)
  {
  ...
  {
    a(paramActivity, bglp.a(paramActivity, 230, null, paramActivity.getResources().getString(2131693396), 2131690582, 2131694081, new avxr(paramActivity, paramString1, paramString2, paramString3, paramLatLng1, paramLatLng2), new avxz()));
  }
  ...
  public static void a(BaseActivity paramBaseActivity)
  {
    ...
    bier.b();
    bgpa localbgpa = bglp.a(paramBaseActivity, 230, null, "位置共享将收起为小窗进行展示，请开启QQ悬浮窗权限以正常使用功能。", paramBaseActivity.getString(2131690582), paramBaseActivity.getString(2131694081), new avxx(paramBaseActivity), null);
    localbgpa.setCancelable(false);
    a(paramBaseActivity, localbgpa);
  }
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt1, int paramInt2, String paramString)
  {
    ...
    avwv.a(paramBaseActivity.app).a(paramInt2, paramString, paramInt1, 2);
  }
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (paramInt2 == 1) {}
    for (String str = paramBaseActivity.getResources().getString(2131718117);; str = paramBaseActivity.getResources().getString(2131718116))
    {
  ...
  private static void b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      bcst.b(null, "CliOper", "", "", paramString, paramString, i, 0, "", "0", "0", "");
      return;
      if (paramInt != 2) {
        i = 0;
      }
