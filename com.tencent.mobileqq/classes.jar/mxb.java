...
public class mxb
  implements mwz, mxa, mzd, mze
{
  public int a;
  private ValueAnimator jdField_a_of_type_AndroidAnimationValueAnimator;
  Application.ActivityLifecycleCallbacks jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new mxg(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mxh(this);
  ...
  private mxj jdField_a_of_type_Mxj = new mxj();
  ...
  private void a(int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("FloatWindowController", 1, "updateCommonGameState and state:  " + paramInt + " mCommonGameFloatWindowLayout " + this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout + " mIsFloatWindowShowing " + this.jdField_f_of_type_Boolean + " mFloatParams.isForeground " + this.jdField_a_of_type_Mxj.jdField_a_of_type_Boolean);
    }
    if ((this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout == null) || (!this.jdField_f_of_type_Boolean) || (!this.jdField_a_of_type_Mxj.jdField_a_of_type_Boolean)) {
      return;
    }
    switch (paramInt)
    {
  ...
  private void a(String paramString, RoomInfo paramRoomInfo, GameRecordInfo paramGameRecordInfo)
  {
    ...
    QQToast.a(localBaseApplication, 2131690339, 0).a();
    c();
  }
  ...
  private boolean a()
  {
    ...
    this.jdField_a_of_type_Mxj.jdField_a_of_type_Int = (this.jdField_f_of_type_Int + this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.b() / 2);
    this.jdField_a_of_type_Mxj.jdField_b_of_type_Int = (this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.c() / 2 + afur.a(115.0F, BaseApplicationImpl.getContext().getResources()));
    this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a(this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a(this.jdField_a_of_type_Mxj), this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.b(this.jdField_a_of_type_Mxj));
  ...
  private void b(Activity paramActivity)
  {
    ...
    bgpa localbgpa = bglp.a(paramActivity, 230).setMessage(2131690266).setNegativeButton(null, null).setPositiveButton(2131698281, new mxc(this, paramActivity));
    localbgpa.setTitle(null);
    localbgpa.setCancelable(true);
    localbgpa.setCanceledOnTouchOutside(false);
    localbgpa.setOnDismissListener(new mxd(this, paramActivity));
    localbgpa.show();
    bcst.b(null, "dc00898", "", "", "0X800B037", "0X800B037", 0, 0, "", "", "", "");
  }
  ...
  private void b(AVGameAppInterface paramAVGameAppInterface)
  {
    ...
    this.jdField_c_of_type_Int = bgtn.b();
    int i = afur.a(10.0F, localBaseApplication.getResources());
    this.jdField_f_of_type_Int = i;
    this.jdField_d_of_type_Int = i;
    i = afur.a(16.0F, localBaseApplication.getResources());
    this.jdField_g_of_type_Int = i;
    this.jdField_e_of_type_Int = i;
    this.jdField_a_of_type_Mxj.jdField_a_of_type_Boolean = true;
    this.jdField_f_of_type_Boolean = false;
    this.jdField_a_of_type_Mxj.jdField_a_of_type_Int = -1000;
    this.jdField_a_of_type_Mxj.jdField_b_of_type_Int = -1000;
  ...
  private void k()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("FloatWindowController", 2, "updateCommonGameFloatWindow isForeground: " + this.jdField_a_of_type_Mxj.jdField_a_of_type_Boolean);
      }
      if (this.jdField_a_of_type_Mxj.jdField_a_of_type_Boolean)
      {
        k = this.jdField_a_of_type_Mxj.jdField_b_of_type_Int;
    ...
    for (;;)
    {
      this.jdField_a_of_type_Mxj.jdField_a_of_type_Int = j;
      this.jdField_a_of_type_Mxj.jdField_b_of_type_Int = i;
      d();
      this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a(this.jdField_a_of_type_Mxj);
      return;
      label287:
      i = 0;
      break;
  ...
  public void a()
  {
    ...
    a(String.valueOf(localmyc.a()), mxl.a().a().a(), localmyc.a());
    bcst.b(null, "dc00898", "", "", "0X800B036", "0X800B036", a(mxl.a().a().a()) + 1, 0, "", "", "", "");
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_f_of_type_Boolean)
    {
      j = this.jdField_a_of_type_Mxj.jdField_a_of_type_Int;
      int m = this.jdField_a_of_type_Mxj.jdField_b_of_type_Int;
      j -= paramInt1;
    ...
    for (;;)
    {
      this.jdField_a_of_type_Mxj.jdField_a_of_type_Int = paramInt1;
      this.jdField_a_of_type_Mxj.jdField_b_of_type_Int = paramInt2;
      this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a(this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a(this.jdField_a_of_type_Mxj), this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.b(this.jdField_a_of_type_Mxj));
      this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a();
      return;
      label111:
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Mxj.jdField_a_of_type_Boolean = paramBoolean;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("FloatWindowController", 2, "onGameStartSuc and engineData is " + parammyc);
    }
    e();
  }
  ...
  public void d()
  {
    ...
    int i = this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.a(this.jdField_a_of_type_Mxj);
    int j = this.jdField_a_of_type_ComTencentAvgameFloatwindowCommonGameFloatWindowLayout.b(this.jdField_a_of_type_Mxj);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new mxe(this, k, i, m, j));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new mxf(this, i, j));
