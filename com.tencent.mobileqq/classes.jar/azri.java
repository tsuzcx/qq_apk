...
public class azri
{
  ...
  private azri(azrk paramazrk)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic = paramazrk.jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView = paramazrk.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView;
    this.jdField_a_of_type_ArrayOfInt = paramazrk.jdField_a_of_type_ArrayOfInt;
    this.jdField_a_of_type_Ahbi = paramazrk.jdField_a_of_type_Ahbi;
  }
  ...
  private URLDrawable a(File paramFile)
  {
    ...
    float f1 = i2 / 160.0F;
    URL localURL = this.jdField_a_of_type_Ahbi.jdField_a_of_type_JavaNetURL;
    boolean bool1 = this.jdField_a_of_type_Ahbi.jdField_a_of_type_Boolean;
    boolean bool2 = bmgb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.imageType);
    if (bool1) {}
    label453:
    label710:
    for (;;)
    {
      ...
      try
      {
        ...
        paramFile = new ascx(localResources, ((SkinnableBitmapDrawable)beyq.b()).getBitmap(), j, i, -921103);
        paramFile = beyq.a(localURL, j, i, paramFile, beyq.a(), true, f1);
        paramFile.setProgressDrawable(new bjae(beyq.a(), 0, false));
      ...
      try
      {
        bhmq.a(paramFile.getAbsolutePath(), localOptions);
        j = localOptions.outWidth;
        i = localOptions.outHeight;
        k = beyq.a(paramFile.getAbsolutePath());
        if ((k != 90) && (k != 270)) {
          continue;
        }
      ...
      if ((j >= n) || (i >= i1))
      {
        ...
        if (localObject.height() < i)
        {
          ...
          if ((beyq.b() instanceof BitmapDrawable)) {
            paramFile = new ascx(localResources, ((BitmapDrawable)beyq.b()).getBitmap(), j, i, -921103);
          } else {}
        }
      }
    }
  ...
  private URLDrawable b()
  {
    ...
    URLDrawable localURLDrawable = beyq.a(this.jdField_a_of_type_Ahbi.jdField_a_of_type_JavaNetURL, 0, 0, null, null, true, 12.0F * f);
    if (this.jdField_a_of_type_ArrayOfInt != null)
    {
  ...
  private URLDrawable c()
  {
      ...
      if ((n < j) || (i1 < k)) {
        if (n < i1)
        {
          ...
          if (k > i)
          {
            ...
            localObject = new ascx(localResources, ((SkinnableBitmapDrawable)beyq.b()).getBitmap(), j, i, -921103);
          }
        }
      }
    }
    for (;;)
    {
      ...
      ((URLDrawable)localObject).setProgressDrawable(new bjae(beyq.a(), 0, false));
      return localObject;
      i = k;
      break;
      j = (int)(k / i1 * n + 0.5F);
      ...
      label574:
      if ((beyq.b() instanceof BitmapDrawable)) {
        localObject = new ascx(localResources, ((BitmapDrawable)beyq.b()).getBitmap(), j, i, -921103);
      }
    }
  }
  ...
  public URLDrawable a()
  {
    if (this.jdField_a_of_type_Ahbi == null) {
      this.jdField_a_of_type_Ahbi = new ahbi(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic);
    }
    Object localObject = this.jdField_a_of_type_Ahbi.jdField_a_of_type_JavaNetURL.toString();
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView != null) {
