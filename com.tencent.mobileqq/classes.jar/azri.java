...
public class azri
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, azri paramazri, String paramString2)
  {
    if ((paramView == null) || (paramazri == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramazri.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramazri = paramazri.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramazri == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramazri instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramazri);
                                      return;
                                    }
                                  } while (!(paramazri instanceof String));
                                  paramString1 = (String)paramazri;
                            ...
                            if ((paramazri instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramazri).getConstantState().newDrawable();
                              paramazri = new Rect();
                              paramString1.getPadding(paramazri);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramazri.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramazri.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramazri.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramazri.bottom;
                              paramazri = paramView.findViewById(2131374418);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramazri != null) {
                                  paramazri.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramazri != null) {
                                  paramazri.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramazri instanceof String));
                      ...
                      } while (!(paramazri instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramazri instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramazri).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramazri).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramazri).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramazri).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramazri instanceof Drawable));
      ((ImageView)paramView).setImageDrawable((Drawable)paramazri);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramazri instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramazri;
    paramazri = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = bhaa.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   6: ldc_w 773
    //   9: astore 5
    //   11: invokestatic 522	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +31 -> 45
    //   17: ldc_w 524
    //   20: iconst_2
    //   21: new 526	java/lang/StringBuilder
    //   24: dup
    //   25: invokespecial 527	java/lang/StringBuilder:<init>	()V
    //   28: ldc_w 775
    //   31: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   34: aload 5
    //   36: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: invokevirtual 536	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   42: invokestatic 539	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   45: lload_2
    //   46: lconst_1
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 777	azri:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 777	azri:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 779
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 781	azri:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 781	azri:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    //   87: invokestatic 522	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   90: ifeq +31 -> 121
    //   93: ldc_w 524
    //   96: iconst_2
    //   97: new 526	java/lang/StringBuilder
    //   100: dup
    //   101: invokespecial 527	java/lang/StringBuilder:<init>	()V
    //   104: ldc_w 783
    //   107: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: aload 5
    //   112: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: invokevirtual 536	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: invokestatic 539	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   121: aload_1
    //   122: ldc2_w 552
    //   125: invokestatic 558	bhaa:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    //   134: invokevirtual 453	java/lang/String:length	()I
    //   137: ifle +135 -> 272
    //   140: new 526	java/lang/StringBuilder
    //   143: dup
    //   144: invokespecial 527	java/lang/StringBuilder:<init>	()V
    //   147: aload_1
    //   148: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   151: getstatic 563	java/io/File:separator	Ljava/lang/String;
    //   154: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   157: aload 5
    //   159: invokevirtual 533	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   162: invokevirtual 536	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   165: astore_1
    //   166: new 560	java/io/File
    //   169: dup
    //   170: aload_1
    //   171: invokespecial 784	java/io/File:<init>	(Ljava/lang/String;)V
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 787	java/io/File:exists	()Z
    //   179: ifeq +239 -> 418
    //   182: new 630	java/io/FileInputStream
    //   185: dup
    //   186: aload_1
    //   187: invokespecial 790	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   190: astore 5
    //   192: aload 5
    //   194: astore_1
    //   195: new 792	java/io/ByteArrayOutputStream
    //   198: dup
    //   199: invokespecial 793	java/io/ByteArrayOutputStream:<init>	()V
    //   202: astore 6
    //   204: aload 5
    //   206: astore_1
    //   207: sipush 4096
    ...
    //   221: iconst_0
    //   222: sipush 4096
    //   225: invokevirtual 799	java/io/InputStream:read	([BII)I
    //   228: istore 4
    //   230: iload 4
    //   232: iconst_m1
    ...
    //   243: iconst_0
    //   244: iload 4
    //   246: invokevirtual 803	java/io/ByteArrayOutputStream:write	([BII)V
    //   249: goto -35 -> 214
    //   252: astore 6
    //   254: aload 5
    //   256: astore_1
    //   257: aload 6
    //   259: invokevirtual 280	java/lang/Exception:printStackTrace	()V
    //   262: aload 5
    //   264: ifnull +8 -> 272
    //   267: aload 5
    ...
    //   309: astore_1
    //   310: aload 7
    //   312: invokevirtual 453	java/lang/String:length	()I
    //   315: ifle +106 -> 421
    //   318: lload_2
    //   319: lconst_1
    //   320: lcmp
    ...
    //   324: aload 5
    //   326: astore_1
    //   327: new 445	org/json/JSONObject
    //   330: dup
    //   331: aload 7
    //   333: invokespecial 813	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   336: putstatic 777	azri:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 777	azri:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    ...
    //   371: aload 5
    //   373: astore_1
    //   374: new 445	org/json/JSONObject
    //   377: dup
    //   378: aload 7
    //   380: invokespecial 813	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   383: putstatic 781	azri:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 781	azri:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!azsl.a(paramQQAppInterface)) {
            continue;
          }
          str1 = azso.a(paramQQAppInterface.getApp());
