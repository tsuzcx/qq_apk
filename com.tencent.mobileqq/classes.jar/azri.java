...
public class azri
{
  ...
  private static volatile azri jdField_a_of_type_Azri;
  public static azrp a;
  ...
  azrl jdField_a_of_type_Azrl = new azrl();
  ...
  private LinkedList<azrk> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private Stack<String> jdField_a_of_type_JavaUtilStack = new Stack();
  boolean jdField_a_of_type_Boolean = false;
  private azrn[] jdField_a_of_type_ArrayOfAzrn = { new azrn("com.tencent.mtt", "qqBrowser"), new azrn("com.tencent.android.qqdownloader", "qqMarket"), new azrn("com.tencent.qqgame", "qqGame"), new azrn("com.tencent.qqmusic", "qqMusic"), new azrn("com.tencent.news", "qqNews"), new azrn("com.qq.reader", "qqReader"), new azrn("com.tencent.qqlive", "qqVideo"), new azrn("com.tencent.wblog", "qqMicroblog"), new azrn("com.tencent.qqphonebook", "qqPhonebook") };
  private int jdField_b_of_type_Int;
  private StringBuilder jdField_b_of_type_JavaLangStringBuilder = new StringBuilder("Thread info:\n");
  private String jdField_d_of_type_JavaLangString;
  
  protected azri(Context paramContext)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private azri(Context paramContext, long paramLong)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  ...
  public static azri a(Context paramContext)
  {
    return a(paramContext, 3000L);
  }
  
  public static azri a(Context paramContext, long paramLong)
  {
    if (jdField_a_of_type_Azri == null) {}
    for (;;)
    {
      try
      {
        ...
        {
          if (alzc.a()) {
            jdField_a_of_type_Azri = new azri(BaseApplicationImpl.getApplication(), paramLong);
          }
        }
        else if (jdField_a_of_type_Azri == null) {}
      }
      finally {}
      try
      {
        if ((alzc.a()) && ((jdField_a_of_type_Azri instanceof azrm))) {
          jdField_a_of_type_Azri = new azri(BaseApplicationImpl.getApplication(), paramLong);
        }
        return jdField_a_of_type_Azri;
      }
      finally {}
      jdField_a_of_type_Azri = new azrm(BaseApplicationImpl.getApplication());
    }
  }
  ...
  private static Map<String, String> a()
  {
    ...
    localHashMap.put("param_MODEL", bdgk.d());
    localHashMap.put("param_manu", bdgk.k());
    localHashMap.put("param_OS", bdgk.e());
    localHashMap.put("param_Resolution", MsfSdkUtils.getResolutionString(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_IMEI", bdgk.a());
    localHashMap.put("param_IMSI", bdgk.b());
    localHashMap.put("param_NetworkType", "" + bdin.b(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_ProductVersion", "" + AppSetting.a());
    localHashMap.put("param_CPU", bdgk.g());
    localHashMap.put("param_totalmemory", MsfSdkUtils.getTotalMemory());
    localHashMap.put("param_availmemory", String.valueOf(bdgk.e() / 1024L) + "kB");
    long[] arrayOfLong = bdgk.a();
    ...
    localHashMap.put("param_Camera", "" + bdgk.c());
    return localHashMap;
  }
  ...
  {
    Object localObject1 = bdqk.a("android.app.ActivityThread", "currentActivityThread", new Object[0], new Class[0]);
    paramContext = paramContext.getPackageName();
    paramContext = (Map)bdqk.a("android.app.LoadedApk", ((WeakReference)((Map)bdqk.a("android.app.ActivityThread", localObject1, "mPackages")).get(paramContext)).get(), "mReceivers");
  ...
  void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Azrl.jdField_a_of_type_Boolean = ((JSONObject)localObject).getBoolean("control_switch");
      this.jdField_a_of_type_Azrl.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("control_level");
      this.jdField_a_of_type_Azrl.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("control_window");
      this.jdField_a_of_type_Azrl.c = ((JSONObject)localObject).getInt("control_freq");
      ...
      ((StringBuilder)localObject).append(",switch=").append(this.jdField_a_of_type_Azrl.jdField_a_of_type_Boolean);
      ((StringBuilder)localObject).append(",level=").append(this.jdField_a_of_type_Azrl.jdField_a_of_type_Int);
      ((StringBuilder)localObject).append(",window=").append(this.jdField_a_of_type_Azrl.jdField_b_of_type_Int);
      ((StringBuilder)localObject).append(",Freq=").append(this.jdField_a_of_type_Azrl.c);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      paramString1 = new azrk(System.currentTimeMillis(), paramString1, paramString2);
      ...
      for (this.jdField_b_of_type_Int = (paramString1.jdField_a_of_type_Int + i); (this.jdField_b_of_type_Int > 15360L) && (this.jdField_a_of_type_JavaUtilLinkedList.size() > 1); this.jdField_b_of_type_Int -= paramString1.jdField_a_of_type_Int) {
        paramString1 = (azrk)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      }
    }
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean1, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap, String paramString3, boolean paramBoolean2)
  {
    ...
    abvj.a(paramString2, paramHashMap);
  ...
  public void a(StringBuilder paramStringBuilder)
  {
    ...
    //   3: dup
    //   4: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   7: ldc_w 1045
    //   10: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   13: invokestatic 779	android/os/Process:myPid	()I
    //   16: invokevirtual 254	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   19: ldc_w 1047
    //   22: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   25: invokevirtual 257	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   28: astore 11
    //   30: aload_1
    //   31: ldc_w 1049
    //   34: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   37: ldc_w 1051
    //   40: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   43: pop
    //   44: aconst_null
    //   45: astore 8
    //   47: aconst_null
    ...
    //   50: aconst_null
    //   51: astore 5
    //   53: invokestatic 647	java/lang/System:currentTimeMillis	()J
    //   56: lstore_3
    //   57: aload 8
    //   59: astore 7
    //   61: aload 9
    //   63: astore 6
    //   65: new 719	java/io/File
    //   68: dup
    //   69: aload 11
    //   71: invokespecial 722	java/io/File:<init>	(Ljava/lang/String;)V
    //   74: invokevirtual 1055	java/io/File:list	()[Ljava/lang/String;
    //   77: astore 10
    //   79: aload 8
    //   81: astore 7
    //   83: aload 9
    ...
    //   90: dup
    //   91: invokespecial 959	java/util/HashMap:<init>	()V
    //   94: astore 8
    //   96: iconst_0
    //   97: istore_2
    //   98: aload 5
    ...
    //   117: aload 5
    //   119: astore 6
    //   121: new 719	java/io/File
    //   124: dup
    //   125: new 115	java/lang/StringBuilder
    //   128: dup
    //   129: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   132: aload 11
    //   134: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: ldc_w 1057
    //   140: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   143: aload 10
    //   145: iload_2
    //   146: aaload
    ...
    //   156: invokevirtual 257	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   159: invokespecial 722	java/io/File:<init>	(Ljava/lang/String;)V
    //   162: astore 9
    //   164: aload 5
    //   166: astore 7
    //   168: aload 5
    //   170: astore 6
    //   172: invokestatic 647	java/lang/System:currentTimeMillis	()J
    //   175: lload_3
    //   176: lsub
    //   177: ldc2_w 1060
    //   180: lcmp
    ...
    //   188: aload 5
    //   190: astore 6
    //   192: invokestatic 527	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   195: ifeq +35 -> 230
    //   198: aload 5
    //   200: astore 7
    //   202: aload 5
    ...
    //   221: iconst_1
    //   222: aload_1
    //   223: invokevirtual 257	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   226: aastore
    //   227: invokestatic 542	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   230: aload 5
    //   232: astore 7
    //   234: aload 5
    //   236: astore 6
    //   238: aload 8
    //   240: invokevirtual 1066	java/util/HashMap:entrySet	()Ljava/util/Set;
    //   243: invokeinterface 448 1 0
    //   248: astore 8
    //   250: aload 5
    //   252: astore 7
    //   254: aload 5
    ...
    //   274: astore 6
    //   276: aload 8
    //   278: invokeinterface 361 1 0
    //   283: checkcast 1068	java/util/Map$Entry
    //   286: astore 9
    //   288: aload 5
    //   290: astore 7
    //   292: aload 5
    ...
    //   296: aload_1
    //   297: aload 9
    //   299: invokeinterface 1071 1 0
    //   304: checkcast 280	java/lang/String
    ...
    //   316: aload 9
    //   318: invokeinterface 1076 1 0
    //   323: invokevirtual 388	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   326: ldc_w 1078
    //   329: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   332: ldc_w 1080
    //   335: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   338: pop
    //   339: goto -89 -> 250
    //   342: astore_1
    //   343: aload 7
    ...
    //   351: ldc_w 1082
    //   354: aload_1
    //   355: invokestatic 547	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   358: aload 7
    //   360: ifnull +8 -> 368
    //   363: aload 7
    //   365: invokevirtual 1087	java/io/BufferedReader:close	()V
    //   368: return
    //   369: aload 5
    //   371: astore 7
    //   373: aload 5
    //   375: astore 6
    //   377: aload 9
    //   379: invokevirtual 725	java/io/File:exists	()Z
    //   382: ifeq +364 -> 746
    //   385: aload 5
    //   387: astore 7
    //   389: aload 5
    //   391: astore 6
    //   393: new 1084	java/io/BufferedReader
    //   396: dup
    //   397: new 1089	java/io/FileReader
    //   400: dup
    //   401: aload 9
    //   403: invokespecial 1092	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   406: bipush 64
    //   408: invokespecial 1095	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   411: astore 5
    //   413: aload 5
    //   415: invokevirtual 1098	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   418: astore 6
    //   420: aload 6
    //   422: ifnull +327 -> 749
    //   425: aload 6
    //   427: ldc_w 1100
    //   430: invokevirtual 484	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   433: ifeq -20 -> 413
    //   436: aload 6
    //   438: ldc_w 461
    //   441: invokevirtual 512	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   444: iconst_1
    //   445: aaload
    //   446: invokevirtual 1103	java/lang/String:trim	()Ljava/lang/String;
    //   449: astore 6
    //   451: aload 8
    //   453: aload 6
    //   455: invokevirtual 968	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   458: ifeq +49 -> 507
    //   461: aload 8
    //   463: aload 6
    //   465: aload 8
    //   467: aload 6
    //   469: invokevirtual 969	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   472: checkcast 514	java/lang/Integer
    //   475: invokevirtual 520	java/lang/Integer:intValue	()I
    //   478: iconst_1
    //   479: iadd
    //   480: invokestatic 532	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   483: invokevirtual 651	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   486: pop
    //   487: aload 5
    //   489: ifnull +47 -> 536
    //   492: aload 5
    //   494: invokevirtual 1087	java/io/BufferedReader:close	()V
    //   497: aconst_null
    //   498: astore 5
    //   500: iload_2
    //   501: iconst_1
    ...
    //   509: aload 6
    //   511: iconst_1
    //   512: invokestatic 532	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   515: invokevirtual 651	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   518: pop
    //   519: goto -32 -> 487
    //   522: astore 6
    //   524: ldc_w 383
    ...
    //   528: ldc_w 1082
    //   531: aload 6
    //   533: invokestatic 547	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   536: goto -36 -> 500
    //   539: aload 5
    //   541: astore 7
    //   543: aload 5
    ...
    //   547: aload_1
    //   548: ldc_w 1105
    //   551: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   554: aload 10
    //   556: arraylength
    //   557: invokevirtual 254	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   560: pop
    //   561: aload 5
    //   563: astore 7
    //   565: aload 5
    //   567: astore 6
    //   569: invokestatic 1110	com/tencent/mobileqq/app/ThreadLog:needRecordJob	()Z
    //   572: ifeq +36 -> 608
    //   575: aload 5
    //   577: astore 7
    //   579: aload 5
    ...
    //   598: astore 6
    //   600: aload_1
    //   601: invokestatic 1113	com/tencent/mobileqq/app/ThreadManager:reportCurrentState	()Ljava/lang/String;
    //   604: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   607: pop
    //   608: aload 5
    //   610: astore 7
    //   612: aload 5
    //   614: astore 6
    //   616: invokestatic 527	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   619: ifeq +52 -> 671
    //   622: aload 5
    //   624: astore 7
    //   626: aload 5
    ...
    //   644: dup
    //   645: iconst_1
    //   646: invokestatic 647	java/lang/System:currentTimeMillis	()J
    //   649: lload_3
    //   650: lsub
    //   651: invokestatic 1120	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   654: aastore
    //   655: dup
    //   656: iconst_2
    //   657: ldc_w 1122
    ...
    //   662: iconst_3
    //   663: aload_1
    //   664: invokevirtual 257	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   667: aastore
    //   668: invokestatic 542	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   671: aload 5
    //   673: ifnull -305 -> 368
    //   676: aload 5
    //   678: invokevirtual 1087	java/io/BufferedReader:close	()V
    //   681: return
    //   682: astore_1
    //   683: ldc_w 383
    //   686: iconst_2
    //   687: ldc_w 1082
    //   690: aload_1
    //   691: invokestatic 547	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   694: return
    //   695: astore_1
    //   696: ldc_w 383
    //   699: iconst_2
    //   700: ldc_w 1082
    //   703: aload_1
    //   704: invokestatic 547	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   707: return
    //   708: astore_1
    //   709: aload 6
    //   711: ifnull +8 -> 719
    //   714: aload 6
    //   716: invokevirtual 1087	java/io/BufferedReader:close	()V
    //   719: aload_1
    //   720: athrow
    //   721: astore 5
    //   723: ldc_w 383
    ...
    //   727: ldc_w 1082
    //   730: aload 5
    //   732: invokestatic 547	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   735: goto -16 -> 719
    //   738: astore_1
    //   739: aload 5
    //   741: astore 6
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    Object localObject = new NewIntent(paramAppRuntime.getApplication(), azci.class);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramAppRuntime.getApplication(), azci.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      paramString2 = new NewIntent(paramAppRuntime.getApplication(), azci.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), azci.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString, Map<String, Integer> paramMap)
  {
    ...
    paramMap = new NewIntent(paramAppRuntime.getApplication(), azci.class);
  ...
  void b()
  {
    if (!this.jdField_a_of_type_Azrl.jdField_a_of_type_Boolean) {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Azrl.jdField_a_of_type_Int == 2) && ((TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).contains("QQBroadcastReceiver"))))
      {
    ...
    if ((l1 <= 0L) || (l2 <= l1) || (i < 0) || (l2 - l1 > this.jdField_a_of_type_Azrl.jdField_b_of_type_Int * 1000))
    {
      i = 1;
      l1 = l2;
    }
    for (;;)
    {
      if (i > this.jdField_a_of_type_Azrl.c) {
  ...
  void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      localSharedPreferences.edit().putLong("starttime", l1).putInt("crashcount", i).putBoolean("allowpreload", bool1).putInt("controlwindow", this.jdField_a_of_type_Azrl.jdField_b_of_type_Int).commit();
      return;
      i += 1;
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    CrashReport.initCrashReport(jdField_a_of_type_AndroidContentContext, new azrj(this), null, bool, (CrashStrategyBean)localObject, 30000L);
    try
    {
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchInstallStatus", String.valueOf(aavv.jdField_a_of_type_Int));
      if (!TextUtils.isEmpty(aavv.jdField_a_of_type_JavaLangString)) {
        CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchNameInstalled", aavv.jdField_a_of_type_JavaLangString);
      }
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Revision", AppSetting.g());
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Version.buildNum", "8.3.5.4555");
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "topActivity", alzk.a());
