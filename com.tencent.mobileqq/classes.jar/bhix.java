...
public class bhix
{
  ...
  {
    vni localvni = vni.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    localArrayList.add("-formats");
    localvni.a((String[])localArrayList.toArray(new String[0]), new bhiz());
  }
  
  public static void a(String paramString1, String paramString2, bhjl parambhjl)
  {
    a();
    vni localvni = vni.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    ...
    localvni.a((String[])localArrayList.toArray(new String[0]), new bhiy(paramString2, parambhjl));
  }
  
  public static boolean a()
  {
    File localFile = new File(bhjk.a);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    try
    {
      new bhiv(BaseApplicationImpl.getContext()).a("svm_snr15_random_noise", localFile);
      return true;
    }
