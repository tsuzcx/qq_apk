  ...
  implements Handler.Callback, bhiw
{
  ...
  bhiy jdField_a_of_type_Bhiy = null;
  WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  boolean jdField_a_of_type_Boolean;
  int jdField_b_of_type_Int = 10;
  boolean jdField_b_of_type_Boolean = false;
  
  public bhix(bhiy parambhiy, Context paramContext)
  {
    this.jdField_a_of_type_Bhiy = parambhiy;
  ...
  void a(int paramInt)
  {
    ...
    if (paramInt != this.jdField_a_of_type_Int)
    {
      ...
      if (this.jdField_a_of_type_Bhiy != null) {
    ...
    {
      this.jdField_a_of_type_Bhiy.a(localView, i, paramInt);
      return;
    }
  }
