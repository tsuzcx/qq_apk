  ...
  implements bncf
{
  ...
  private bncj a(Bitmap paramBitmap, ArrayList<bncg> paramArrayList)
  {
    bncj localbncj = new bncj(this);
    ...
    {
      paramBitmap = (bncg)paramArrayList.get(i);
      int j = paramBitmap.jdField_b_of_type_Int;
      double d2 = paramBitmap.jdField_a_of_type_Int * j;
      double d3 = localbncj.jdField_a_of_type_Double;
      localbncj.jdField_a_of_type_Double = (d2 / d1 + d3);
      if (localbncj.jdField_a_of_type_Double > jdField_a_of_type_JavaLangDouble.doubleValue()) {
        localbncj.jdField_a_of_type_Boolean = true;
      }
      i += 1;
    }
    if ((paramArrayList.size() > 1) && (localbncj.jdField_a_of_type_Double > b.doubleValue())) {
      localbncj.b = true;
    }
    return localbncj;
  }
  
  private bncl a(String paramString)
  {
    bncl localbncl = new bncl();
    if (paramString == null) {}
    do
    {
      return null;
    ...
    while (i < localJSONArray1.length())
    {
      ...
      if (j < localJSONArray2.length())
      {
        ...
        {
          localbncl.jdField_a_of_type_Int = localJSONObject1.optInt("sceneLvOne");
          localbncl.jdField_b_of_type_Int = localJSONObject2.optInt("sceneLvTwo");
          localbncl.jdField_a_of_type_JavaLangString = localJSONObject2.optString("sceneName");
          localbncl.jdField_b_of_type_JavaLangString = localJSONObject2.optString("sceneFilterID");
          localbncl.jdField_a_of_type_Double = localJSONObject2.optDouble("sceneFilterPercent");
        }
      }
      else
      {
  ...
  private bncl a(JSONArray paramJSONArray)
  {
    double d2 = -1.0D;
    Object localObject1 = new bncl();
    ...
    if (paramJSONArray.length() > 0)
    {
      ...
      if (i < paramJSONArray.length())
      {
        ...
        bncl localbncl = a((String)localObject3);
        double d6;
        double d5;
        if (localbncl == null)
        {
        ...
        for (;;)
        {
          ...
          d5 = d2;
          d6 = d3;
          if (localbncl.jdField_b_of_type_Int != -1)
          {
            localObject3 = localObject1;
            double d1 = d2;
            if (localbncl.jdField_a_of_type_Int == 3)
            {
              localObject3 = localObject1;
              d1 = d2;
              if (d4 > c.doubleValue())
  ...
  private String a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if (i > paramInt)
    {
      paramBitmap = ayym.a(paramBitmap, i / paramInt);
      localByteArrayOutputStream = new ByteArrayOutputStream();
      paramBitmap.compress(Bitmap.CompressFormat.JPEG, 100, localByteArrayOutputStream);
      return bncd.a(localByteArrayOutputStream.toByteArray());
    }
  ...
  private JSONObject a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = bnce.a("https://tu.qq.com/cgi-bin/qq/get_face_detail.fcg", localJSONObject2.toString());
      return paramString;
    }
  ...
  private JSONObject b(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("token", b(paramString));
      paramString = bnce.a("https://tu.qq.com/cgi-bin/qq/do_image_classify.fcg", localJSONObject2.toString());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public void a(Bitmap paramBitmap, ArrayList<bncg> paramArrayList, bnch parambnch)
  {
    if (paramBitmap == null)
    {
      parambnch.a("image is null");
      return;
    }
    ...
    if (paramArrayList.jdField_a_of_type_Boolean) {
      if (paramArrayList.b) {
        paramBitmap = a(anvx.a(2131715192));
      }
    }
    while (paramBitmap == null)
    {
      parambnch.a("unknown error");
      bnce.a(System.currentTimeMillis() - l, 1);
      return;
      paramBitmap = a(paramBitmap);
      if ((paramBitmap == null) || (paramBitmap.isNull("retcode")))
      {
        parambnch.a("network error");
        bnce.a(System.currentTimeMillis() - l, 1);
        return;
      }
      if ((paramBitmap != null) && (paramBitmap.has("retcode")) && (paramBitmap.optInt("retcode") == 0))
      {
        ...
        if (i <= 5) {
          paramBitmap = a(anvx.a(2131715195));
        } else if (j < 50) {
          paramBitmap = a(anvx.a(2131715193));
        } else {
          paramBitmap = a(anvx.a(2131715190));
        }
      }
      else
      {
        paramBitmap = a(anvx.a(2131715194));
        continue;
        ...
        if ((paramArrayList == null) || (paramArrayList.isNull("retcode")))
        {
          ...
          bnce.a(l, 1);
          aanb.a("record_smart_filter", aanb.a(1L, l));
          return;
        }
        paramBitmap = localbncl;
    ...
    parambnch.a(paramBitmap);
    l = System.currentTimeMillis() - l;
    bnce.a(l, 0);
    aanb.a("record_smart_filter", aanb.a(0L, l));
  }
}
