...
public class agjb
{
  public static int a(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localapon.a((CustomEmotionData)((List)localObject).get(j), j);
      ...
      localapon.c((CustomEmotionBase)localObject);
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith(alof.bU))) {
        azqs.b(null, "CliOper", "", "", "ep_mall", "0X800695C", 0, 0, "", "", "", "");
      }
      paramContext = (apoo)paramContext.getManager(103);
      i = m;
    } while (paramContext == null);
    label260:
  ...
  public static int a(Context paramContext, String paramString, StructMsgForImageShare paramStructMsgForImageShare, PicMessageExtraData paramPicMessageExtraData)
  {
    ...
    if (localList != null)
    {
      ...
      for (;;)
      {
        ...
        if ((str != null) && (((CustomEmotionData)localList.get(j)).md5 != null) && (str.equals(((CustomEmotionData)localList.get(j)).md5)))
        {
          ...
          {
            ((apon)localObject).a((CustomEmotionData)localList.get(j), j);
    ...
    paramContext = new apnw(localQQAppInterface, paramContext, (CustomEmotionData)localObject, paramStructMsgForImageShare, 0);
    paramString = (apoo)localQQAppInterface.getManager(103);
    if (paramString != null) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    int m = 0;
    String str = HexUtil.bytes2HexStr(MD5.getFileMd5(paramString));
    Object localObject = (apon)paramQQAppInterface.getManager(149);
    if (QLog.isColorLevel()) {
      QLog.i("AIOGalleryUtils", 2, "Call getEmoticonDataList from addCustomEmotionForAIO.");
    }
    List localList = ((apon)localObject).a();
    ...
    do
    {
      ...
      paramString = new apnw(paramQQAppInterface, BaseApplicationImpl.getContext(), (CustomEmotionData)localObject, null, 3);
      paramQQAppInterface = (apoo)paramQQAppInterface.getManager(103);
      i = m;
    } while (paramQQAppInterface == null);
  ...
  {
    bbtn localbbtn = bcnt.a(paramQQAppInterface, paramMessageForTroopFile);
    if (localbbtn == null) {
    ...
    do
    {
      do
      {
        ...
        {
          return null;
          if (arrr.a(paramMessageForTroopFile.fileName) != 0)
          {
        ...
        QLog.w("AIOGalleryUtilstoTroopAIOFilePicData", 1, "id:" + localbbtn.jdField_a_of_type_JavaUtilUUID + " file is deleted!");
        return null;
        if ((localbbtn.jdField_b_of_type_Int != 4) && (localbbtn.jdField_b_of_type_Int != 5)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.w("AIOGalleryUtilstoTroopAIOFilePicData", 1, "id:" + localbbtn.jdField_a_of_type_JavaUtilUUID + " file is:" + localbbtn.jdField_b_of_type_Int);
      return null;
      if ((!bdhb.b(localbbtn.jdField_a_of_type_JavaLangString)) || ((localbbtn.jdField_b_of_type_Int != 1) && (localbbtn.jdField_b_of_type_Int != 2) && (localbbtn.jdField_b_of_type_Int != 3))) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.w("AIOGalleryUtilstoTroopAIOFilePicData", 1, "id:" + localbbtn.jdField_a_of_type_JavaUtilUUID + " file is:" + localbbtn.jdField_b_of_type_Int);
    return null;
    ((aqud)paramQQAppInterface.getManager(317)).a(bckt.a(localbbtn.jdField_g_of_type_JavaLangString));
    Object localObject = localbbtn.jdField_d_of_type_JavaLangString;
    if ((paramMessageForTroopFile.isMultiMsg) && (TextUtils.isEmpty((CharSequence)localObject))) {
      arrr.a(paramMessageForTroopFile);
    }
    ...
    ((AIOFilePicData)localObject).jdField_e_of_type_Int = localbbtn.jdField_i_of_type_Int;
    ((AIOFilePicData)localObject).jdField_h_of_type_JavaLangString = paramMessageForTroopFile.url;
    if (localbbtn.jdField_b_of_type_Int == 8) {}
    for (boolean bool = true;; bool = false)
    {
      ((AIOFilePicData)localObject).jdField_f_of_type_Boolean = bool;
      ((AIOFilePicData)localObject).a(localbbtn);
      ((AIOFilePicData)localObject).m = alww.b(paramMessageForTroopFile);
      return localObject;
    }
  }
  ...
  public static AIOImageData a(MessageForPic paramMessageForPic)
  {
    ...
    if (paramMessageForPic.isMixed)
    {
      i = 1;
      label222:
      localAIOImageData.jdField_a_of_type_JavaLangString = baqn.d(bayu.a(paramMessageForPic, i, "chatthumb").toString());
      if (!paramMessageForPic.isMixed) {
        break label515;
      }
    ...
    for (;;)
    {
      if (paramMessageForPic.fileSizeFlag == 1) {
        localAIOImageData.jdField_c_of_type_JavaLangString = baqn.d(bayu.a(paramMessageForPic, 131075, null).toString());
      }
      ...
      localAIOImageData.m = alww.b(paramMessageForPic);
      ...
      localAIOImageData.jdField_b_of_type_JavaLangString = baqn.d(((URL)localObject1).toString());
      if (paramMessageForPic.fileSizeFlag != 1)
      {
        ...
        localAIOImageData.jdField_d_of_type_JavaLangString = baqn.e(((URL)localObject1).toString());
  ...
  public static AIOImageData a(MessageForTroopFile paramMessageForTroopFile, QQAppInterface paramQQAppInterface)
  {
    ...
    bbtn localbbtn = bcnt.a(paramQQAppInterface, paramMessageForTroopFile);
    Object localObject;
    if (localbbtn.jdField_d_of_type_JavaLangString != null)
    {
      localObject = localbbtn.jdField_d_of_type_JavaLangString;
      ...
      if (!TextUtils.isEmpty(localbbtn.jdField_c_of_type_JavaLangString)) {
        localAIOImageData.jdField_b_of_type_JavaLangString = localbbtn.jdField_c_of_type_JavaLangString;
      }
      if ((!TextUtils.isEmpty(localbbtn.jdField_a_of_type_JavaLangString)) && (bdhb.a(localbbtn.jdField_a_of_type_JavaLangString))) {
        localAIOImageData.jdField_c_of_type_JavaLangString = localbbtn.jdField_a_of_type_JavaLangString;
      }
      if (localbbtn.jdField_b_of_type_Int != 8) {
        break label400;
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localAIOImageData.jdField_d_of_type_Long = localbbtn.jdField_a_of_type_Int;
      try
      {
        localObject = ageh.a(paramQQAppInterface.getApplication(), localbbtn, paramMessageForTroopFile);
        paramQQAppInterface = (QQAppInterface)localObject;
        if (localObject == null) {
          paramQQAppInterface = bayu.b();
        }
      }
      ...
      localAIOImageData.jdField_g_of_type_JavaLangString = localbbtn.jdField_g_of_type_JavaLangString;
      localAIOImageData.jdField_h_of_type_JavaLangString = localbbtn.jdField_e_of_type_JavaLangString;
      localAIOImageData.jdField_e_of_type_Long = localbbtn.jdField_c_of_type_Long;
      localAIOImageData.jdField_c_of_type_Int = localbbtn.jdField_h_of_type_Int;
      localAIOImageData.jdField_b_of_type_Int = 3;
      return localAIOImageData;
      localObject = localbbtn.jdField_b_of_type_JavaLangString;
      break;
    }
  }
  ...
  public static AIORichMediaData a(com.tencent.mobileqq.data.ChatMessage paramChatMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    //   23: astore 7
    //   25: aload_1
    //   26: invokevirtual 683	com/tencent/mobileqq/app/QQAppInterface:a	()Laqwl;
    //   29: aload 7
    ...
    //   44: invokevirtual 691	aqwl:a	(JLjava/lang/String;I)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   47: astore 8
    //   49: aload 8
    //   51: ifnull -41 -> 10
    //   54: aload 8
    ...
    //   241: aload 4
    //   243: aload_0
    //   244: invokestatic 370	alww:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    ...
    //   378: invokestatic 273	bdhb:b	(Ljava/lang/String;)Z
    //   381: istore_3
    //   382: iload_3
    //   383: ifeq +56 -> 439
    //   386: aload 8
    ...
    //   641: aload 6
    //   643: aload 4
    //   645: getfield 776	aotl:jdField_b_of_type_Int	I
    //   648: i2l
    ...
    //   781: invokestatic 756	arso:b	(Ljava/lang/String;)Z
    //   784: ifeq +12 -> 796
    //   787: aload 8
    ...
    //   801: invokestatic 756	arso:b	(Ljava/lang/String;)Z
    //   804: ifeq +619 -> 1423
    //   807: aload 8
    ...
    //   894: aload_1
    //   895: aload 5
    //   897: invokestatic 211	bcnt:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/data/MessageForTroopFile;)Lbbtn;
    //   900: astore 6
    //   902: aload 6
    ...
    //   930: invokestatic 228	arrr:a	(Ljava/lang/String;)I
    //   933: iconst_2
    ...
    //   946: areturn
    //   947: aload 6
    //   949: getfield 237	bbtn:jdField_b_of_type_Int	I
    //   952: bipush 12
    ...
    //   979: aload 6
    //   981: getfield 251	bbtn:jdField_a_of_type_JavaUtilUUID	Ljava/util/UUID;
    ...
    //   1000: areturn
    //   1001: aload 6
    //   1003: getfield 237	bbtn:jdField_b_of_type_Int	I
    //   1006: iconst_4
    //   1007: if_icmpeq +12 -> 1019
    //   1010: aload 6
    //   1012: getfield 237	bbtn:jdField_b_of_type_Int	I
    //   1015: iconst_5
    ...
    //   1041: aload 6
    //   1043: getfield 251	bbtn:jdField_a_of_type_JavaUtilUUID	Ljava/util/UUID;
    ...
    //   1055: aload 6
    //   1057: getfield 237	bbtn:jdField_b_of_type_Int	I
    ...
    //   1070: areturn
    //   1071: aload 6
    //   1073: getfield 269	bbtn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1076: invokestatic 273	bdhb:b	(Ljava/lang/String;)Z
    //   1079: ifeq +82 -> 1161
    //   1082: aload 6
    //   1084: getfield 237	bbtn:jdField_b_of_type_Int	I
    //   1087: iconst_1
    //   1088: if_icmpeq +21 -> 1109
    //   1091: aload 6
    //   1093: getfield 237	bbtn:jdField_b_of_type_Int	I
    //   1096: iconst_2
    //   1097: if_icmpeq +12 -> 1109
    //   1100: aload 6
    //   1102: getfield 237	bbtn:jdField_b_of_type_Int	I
    //   1105: iconst_3
    ...
    //   1131: aload 6
    //   1133: getfield 251	bbtn:jdField_a_of_type_JavaUtilUUID	Ljava/util/UUID;
    ...
    //   1145: aload 6
    //   1147: getfield 237	bbtn:jdField_b_of_type_Int	I
    ...
    //   1168: checkcast 275	aqud
    //   1171: aload 6
    //   1173: getfield 278	bbtn:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   1176: invokestatic 283	bckt:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1179: invokevirtual 286	aqud:a	(Ljava/lang/String;)Laotl;
    //   1182: astore 7
    //   1184: aload 6
    //   1186: getfield 288	bbtn:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   1189: astore 4
    //   1191: aload 4
    //   1193: astore_1
    //   1194: aload 4
    ...
    //   1199: ifeq +9 -> 1208
    //   1202: aload 6
    //   1204: getfield 591	bbtn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   1207: astore_1
    //   1208: aload_1
    //   1209: astore 4
    //   1211: aload 5
    ...
    //   1226: ifeq +10 -> 1236
    //   1229: aload 5
    //   1231: invokestatic 295	arrr:a	(Lcom/tencent/mobileqq/data/ChatMessage;)Ljava/lang/String;
    //   1234: astore 4
    ...
    //   1337: aload 4
    //   1339: aload 7
    //   1341: getfield 776	aotl:jdField_b_of_type_Int	I
    //   1344: i2l
    ...
    //   1368: aload 6
    //   1370: getfield 269	bbtn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1373: invokestatic 273	bdhb:b	(Ljava/lang/String;)Z
    //   1376: ifeq +19 -> 1395
    //   1379: aload 4
    //   1381: aload 6
    //   1383: getfield 269	bbtn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public static AIOShortVideoData a(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    localAIOShortVideoData.jdField_d_of_type_JavaLangString = abti.c(paramMessageForShortVideo);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localAIOShortVideoData.m = alww.b(paramMessageForShortVideo);
  ...
  {
    paramContext = (apon)((QQAppInterface)((BaseActivity)paramContext).getAppRuntime()).getManager(149);
    if (QLog.isColorLevel()) {
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, agjg paramagjg)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            b(paramActivity, paramFile, paramString, paramagjg);
            return;
          }
        }
    ...
    return;
    label145:
    bdgm.a(paramActivity, 230).setTitle(paramActivity.getString(2131719335)).setMessage(paramActivity.getString(2131695343)).setPositiveButton(paramActivity.getString(2131719209), new agjd(paramActivity, paramFile, paramString, paramagjg)).setNegativeButton(paramActivity.getString(2131694806), new agjc()).show();
  }
  
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, agkf paramagkf, boolean paramBoolean, String paramString3)
  {
    if ((paramagkf == null) || (!AIOImageData.class.isInstance(paramagkf.a))) {
      return;
    }
    ...
    {
      paramagkf = paramString1 + "_hd";
      if (new File(paramagkf).exists()) {
        paramString1 = paramagkf;
      }
    }
    for (;;)
    {
      paramagkf = localAIOImageData.jdField_e_of_type_JavaLangString;
      long l2 = localAIOImageData.jdField_c_of_type_Long;
      long l1 = 0L;
      if (paramBoolean) {
        l1 = localAIOImageData.jdField_d_of_type_Long;
      }
      bjdt.a(paramActivity, localbjea, paramBoolean, paramString3, paramString2, paramInt, paramString1, paramagkf, l2, l1, -1);
      return;
    }
  }
  
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, List<agkf> paramList, boolean paramBoolean, String paramString3)
  {
    if (paramList == null) {
      return;
    }
    ...
    {
      paramString1 = (agkf)localIterator.next();
    ...
    for (;;)
    {
      ...
      break;
      bjdt.a(paramActivity, localbjea, paramBoolean, paramString3, paramString2, paramInt, localArrayList1, localArrayList2, localArrayList3, localArrayList4, 98);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString4, String paramString5)
  {
    ...
    bjdt.a(paramActivity, localbjea, paramString2, paramString3, paramArrayList1, paramArrayList2, paramArrayList, paramInt, paramString4, paramString5);
  }
  ...
  {
    new agjf(paramContext, paramInt, paramURLDrawable, paramQQAppInterface, paramStructMsgForImageShare, paramPicMessageExtraData).execute(new Void[0]);
  }
  ...
  {
    paramStructMsgForImageShare = agiy.a(paramStructMsgForImageShare);
    ...
    {
      paramQQAppInterface = (appr)paramQQAppInterface.getManager(141);
  ...
  private static void b(Activity paramActivity, File paramFile1, File paramFile2, agjg paramagjg)
  {
    new agje(paramFile1, paramFile2, paramActivity, paramagjg).execute(new Void[0]);
  }
