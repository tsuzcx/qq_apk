  ...
  implements tch
{
  ...
  akil jdField_a_of_type_Akil = new tdi(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = tsr.b;
  }
      ...
      if (localIterator.hasNext())
      {
        ...
        else
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_Akhp.a(str1, localTroopInfo.troopcode, (ArrayList)localObject1);
            localObject1 = new ArrayList(20);
            i = 1;
          }
        }
