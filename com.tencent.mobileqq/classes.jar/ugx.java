...
public class ugx
{
  ...
  private static ugw jdField_a_of_type_Ugw;
  private static String jdField_b_of_type_JavaLangString;
  private static HashMap<String, Integer> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private static ugw jdField_b_of_type_Ugw;
  
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131715571);
  ...
  public static int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localPackageInfo != null)
      {
        ...
        i = j;
        upe.a("WeishiDownloadUtil", "versionName:" + localPackageInfo.versionName + ",versionCode:" + localPackageInfo.versionCode);
        return j;
      }
      i = j;
      upe.c("WeishiDownloadUtil", paramString + "获取 PackageInfo 失败");
      return -1;
    }
    catch (Exception paramString)
    {
      upe.a("WeishiDownloadUtil", paramString.getLocalizedMessage());
    }
    return i;
  }
  ...
  private static RockDownloadInfo a(ArrayList<RockDownloadInfo> paramArrayList, RockDownloadInfo paramRockDownloadInfo)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      {
        upe.a("WeishiDownloadUtil", "Rock包版本大于或等于要下载的版本，有效~~~");
  ...
  {
    Object localObject2 = bisa.a().b("com.tencent.weishi", 4);
    Object localObject1 = localObject2;
    if (((List)localObject2).size() == 0) {
      localObject1 = bisa.a().a("com.tencent.weishi", 4);
    }
    localObject2 = bivr.a().a("10261931");
    if (localObject2 != null)
    {
      ((DownloadInfo)localObject2).a(4);
      ((List)localObject1).add(localObject2);
    }
    upe.a("WeishiDownloadUtil", ">existValidQQDownloadWeishiApk, info:" + localObject1);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localObject2 != null)
      {
        upe.d("WeishiDownloadUtil", "downloadInfo 's url: " + ((DownloadInfo)localObject2).d);
        if ((((DownloadInfo)localObject2).a() == 4) && (TextUtils.equals(((DownloadInfo)localObject2).e, "com.tencent.weishi")) && (((DownloadInfo)localObject2).d != null) && (((DownloadInfo)localObject2).d.startsWith(b()))) {
          ...
          {
            upe.a("WeishiDownloadUtil", "QQ下载包filePath为空!!!");
          }
          else
          {
            int i = a(((DownloadInfo)localObject2).l);
            upe.a("WeishiDownloadUtil", "判断QQ下载包有没有过期，apkVersionCode：" + i + ",targetVersion:" + paramInt);
            if (i >= paramInt)
            {
              upe.a("WeishiDownloadUtil", "本地包版本(" + i + ")大于或等于要下载的版本" + paramInt + ")，直接安装~~~");
      ...
      {
        upe.d("WeishiDownloadUtil", "downloadInfo is null");
      }
    }
    return "";
  }
  ...
  private static ArrayList<RockDownloadInfo> a(RockDownloadPresenter paramRockDownloadPresenter, RockDownloadInfo paramRockDownloadInfo)
  {
    ...
    ArrayList localArrayList = apwe.a(paramRockDownloadInfo);
  ...
  public static ugw a(int paramInt1, int paramInt2)
  {
    if (b()) {
  ...
  {
    upe.a("WeishiDownloadUtil", "resetDownloadingMark");
  ...
  public static void a(Activity paramActivity, RockDownloadPresenter paramRockDownloadPresenter, WSDownloadParams paramWSDownloadParams, boolean paramBoolean, int paramInt)
  {
    ...
    ups.b(paramWSDownloadParams.mScheme);
  ...
  public static void a(Activity paramActivity, WSDownloadParams paramWSDownloadParams)
  {
    if ((paramActivity == null) || (paramWSDownloadParams == null)) {
      upe.a("WeishiDownloadUtil", "rock download activity or params is null");
    }
    ...
    do
    {
      ...
      {
        return;
        upe.d("WeishiDownloadUtil", "WSDownloadParams:" + paramWSDownloadParams.toString());
        localRockDownloadPresenter = new RockDownloadPresenter();
        if (zky.b(paramActivity)) {
          break;
        }
      } while (a(paramWSDownloadParams, localRockDownloadPresenter, localRockDownloadPresenter.a(), 3));
      QQToast.a(paramActivity, anni.a(2131715570), 0).a();
      return;
      if (c())
      {
        a(true);
        upe.d("WeishiDownloadUtil", "当前有正在下载的任务,不响应钩子下载请求,但更改下载类型为主动下载");
        if ((ugb.a().e()) && (a()))
        {
          b(3);
          return;
        ...
        umw.a(true, paramWSDownloadParams);
        umw.a(paramWSDownloadParams, 2);
        WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, 3, 1, 2, 0);
        ugq.a(paramActivity);
        return;
      }
      if ((ugb.a().d()) && (uoe.a(paramActivity)))
      {
        upe.d("WeishiDownloadUtil", "主动点击 执行厂商下载-----");
        uoe.a(paramActivity);
        b(3);
        ups.b(paramWSDownloadParams.mScheme);
        paramWSDownloadParams.mStReportItem = umq.a();
        ugq.a(115, paramWSDownloadParams);
        umw.a(false, paramWSDownloadParams);
        umw.a(paramWSDownloadParams, 3);
        WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, 3, 0, 3, 0);
        birz.a(paramActivity, paramWSDownloadParams.mScheme, "com.tencent.weishi", "biz_src_jc_gzh_weishi");
        return;
      }
    ...
    if ((!ugb.a().a()) && (!a()))
    {
      upe.a("WeishiDownloadUtil", "服务器关闭了4g开关");
      ugq.b(paramActivity, paramWSDownloadParams);
      return;
    }
    upe.a("WeishiDownloadUtil", "服务器打开了4g");
    if (ugb.a().e())
    {
      localRockDownloadPresenter.a(paramActivity, localRockDownloadInfo, 3, paramWSDownloadParams, null);
      return;
    }
    ugq.a(paramActivity, paramWSDownloadParams);
  }
  
  public static void a(Activity paramActivity, WSDownloadParams paramWSDownloadParams, ugw paramugw, RockDownloadListenerWrapper paramRockDownloadListenerWrapper)
  {
    paramugw = new RockDownloadPresenter();
    if (!zky.b(paramActivity)) {
      if (!a(paramWSDownloadParams, paramugw, paramugw.a(), 3)) {}
    }
    RockDownloadInfo localRockDownloadInfo;
    do
    {
      do
      {
        ...
        upe.d("WeishiDownloadUtil", "B链路点击 延迟执行厂商下载");
        LocalMultiProcConfig.putBool("need_appstore_download", true);
      } while (!c());
      if ((ugb.a().e()) && (a()))
      {
        upe.c("WeishiDownloadUtil", "当前有下载的Rock任务,开始中断-----");
        paramActivity = ugb.a().c();
        bise.a().b(paramActivity, false);
        return;
      }
      paramActivity = ugb.a().d();
      upe.c("WeishiDownloadUtil", "当当前有QQ下载的任务,开始中断~~");
      bise.a().b(paramActivity, false);
      return;
      paramugw = new RockDownloadPresenter();
      localRockDownloadInfo = paramugw.a();
    } while (a(paramWSDownloadParams, paramugw, localRockDownloadInfo, 2));
    if ((!ugb.a().a()) && (!a()))
    {
      upe.d("WeishiDownloadUtil", "不可以在非WIFI环境下，静默下载微视");
      return;
    }
    if (c())
    {
      upe.d("WeishiDownloadUtil", "当前有正在下载的任务,不响应静默下载请求");
      if ((ugb.a().e()) && (a()))
      {
        b(2);
        return;
    ...
    upe.d("WeishiDownloadUtil", "执行QQ或Rock下载");
    b(2);
    if (ugb.a().e())
    {
      paramugw.a(paramActivity, localRockDownloadInfo, 2, paramWSDownloadParams, paramRockDownloadListenerWrapper);
      return;
    }
  ...
  private static void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramString.hasNext())
      {
        ...
        upe.d("WeishiDownloadUtil", "删除了info:" + ((DownloadInfo)localObject1).d);
        bisa.a().b(((DownloadInfo)localObject1).d, false);
      }
    }
  }
  ...
  {
    upe.a("WeishiDownloadUtil", "setPreDownloadingClick");
  ...
  public static boolean a(Activity paramActivity, WSDownloadParams paramWSDownloadParams)
  {
    ...
    {
      upe.d("WeishiDownloadUtil", "本地已经安装微视app");
      return false;
    }
    if (!e())
    {
      upe.d("WeishiDownloadUtil", "预下载开关没打开");
      return false;
    }
    ...
    upe.c("WeishiDownloadUtil", "用QQ预下载兜底~");
    a(99, 1);
  ...
  public static boolean a(Activity paramActivity, WSDownloadParams paramWSDownloadParams, boolean paramBoolean, int paramInt)
  {
    if ((paramActivity == null) || (paramWSDownloadParams == null))
    {
      upe.a("startQQDownload: activity is null Or params is null:");
      return false;
    }
    upe.a("downloadWeishi:" + paramWSDownloadParams);
    String str = ugb.a().d();
    a(paramWSDownloadParams.mEventId, paramInt);
    ups.b(paramWSDownloadParams.mScheme);
  ...
  {
    upe.a("WeishiDownloadUtil", String.format("downloadWeishi : autoInstall = %s, showNotification = %s, mDownloadUrlStr = %s", new Object[] { Boolean.valueOf(paramBoolean1), Boolean.valueOf(paramBoolean2), paramString }));
    b();
    Bundle localBundle = new Bundle();
    localBundle.putString(bivp.jdField_b_of_type_JavaLangString, "10261931");
    localBundle.putString(bivp.l, jdField_a_of_type_JavaLangString);
    localBundle.putString(bivp.f, "com.tencent.weishi");
    localBundle.putString(bivp.j, paramString);
    localBundle.putInt(bivp.k, 2);
    localBundle.putBoolean(bivp.h, false);
    paramString = bivp.x;
    if (!paramBoolean2) {}
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      localBundle.putBoolean(paramString, paramBoolean1);
      bise.a().a(paramActivity, localBundle, "biz_src_jc_gzh_weishi", null, 0);
  ...
  {
    if (biub.a(biip.a().a(), paramString, "biz_src_jc_gzh_weishi", ""))
    {
      upe.a("WeishiDownloadUtil", "本地QQ包的版本有效，启动开始安装成功！");
      umw.a(1, 2);
      paramString = paramWSDownloadParams;
      if (paramWSDownloadParams == null)
      {
        paramString = new WSDownloadParams();
        upe.d("WeishiDownloadUtil", "WSDownloadParams异常！");
      }
      WSPublicAccReport.getInstance().reportDownload(paramString.mEventId, paramInt, 2, 2, 1);
      if (paramString.mStReportItem == null) {
        paramString.mStReportItem = umq.a();
      }
      umq.a(115, paramString.mStReportItem.pagetype, paramString.mStReportItem.comment_loctaion, null);
      ups.b(paramString.mScheme);
      return true;
    }
    upe.d("WeishiDownloadUtil", "本地QQ包安装失败,重新下载！");
    return false;
  }
  ...
  private static boolean a(WSDownloadParams paramWSDownloadParams, RockDownloadPresenter paramRockDownloadPresenter, RockDownloadInfo paramRockDownloadInfo, int paramInt)
  {
    ...
    if (a(localArrayList, paramRockDownloadInfo))
    {
      ...
      if (paramRockDownloadInfo != null)
      {
        if (paramInt == 1)
        {
          upe.c("WeishiDownloadUtil", "预下载包有效也不call安装----------------");
          return true;
        }
        if (ugb.a().a() == 2)
        {
          udo.b += 1;
          upe.c("WeishiDownloadUtil", "CCCCCCCCC onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + udo.b);
        }
        paramRockDownloadPresenter.a(paramRockDownloadInfo, 1);
        ups.b(paramWSDownloadParams.mScheme);
        upe.d("WeishiDownloadUtil", "本地Rock包的版本有效，直接安装");
        return true;
      }
    }
    paramRockDownloadPresenter = a(ugb.a().e());
    if (!TextUtils.isEmpty(paramRockDownloadPresenter))
    {
      upe.d("WeishiDownloadUtil", "checkAndInstallValidApp QQDownloader apkPath = " + paramRockDownloadPresenter);
      if (paramInt == 1)
      {
        upe.c("WeishiDownloadUtil", "预下载包有效也不call安装----------------");
        return true;
      ...
      {
        udo.b += 1;
        upe.c("WeishiDownloadUtil", "DDDDDDDDDDD onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + udo.b);
      }
      WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, paramInt, 1, 2, 0);
      a(paramWSDownloadParams.mEventId, paramInt);
      if (a(paramWSDownloadParams, paramInt, paramRockDownloadPresenter))
      {
        upe.a("WeishiDownloadUtil", "installApkByQQDownloader！eventId:" + paramWSDownloadParams.mEventId + ",eventType:" + paramInt);
        return true;
      }
    }
    else
    {
      upe.a("WeishiDownloadUtil", "本地QQ包路径为空！");
    }
    return false;
  }
  ...
  private static ugw b(int paramInt1, int paramInt2)
  {
    if (jdField_a_of_type_Ugw != null)
    {
      if (!c()) {
        a(paramInt1);
      }
      b(paramInt2);
      return jdField_a_of_type_Ugw;
    }
    a(paramInt1);
    b(paramInt2);
    jdField_a_of_type_Ugw = new ugy();
    bisa.a().a(jdField_a_of_type_Ugw);
    return jdField_a_of_type_Ugw;
  }
  
  public static void b()
  {
    upe.a("WeishiDownloadUtil", "updateDownloadingMark");
  ...
  private static void b(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      upe.d("WeishiDownloadUtil", " 下载器的DB还没准备就绪,重新注册监听，并重试下载一次");
      ...
      for (;;)
      {
        ...
        upe.d("WeishiDownloadUtil", "onDownloadError retryCount = " + localInteger);
        if (localInteger.intValue() <= 3) {
          break;
        }
        upe.d("WeishiDownloadUtil", "重试次数已经达到3次，中止！");
        return;
    ...
    upe.d("WeishiDownloadUtil", "下载器其他错误");
  }
  
  private static void b(DownloadInfo paramDownloadInfo, int paramInt1, int paramInt2, String paramString)
  {
    upe.d("WeishiDownloadUtil", paramString + " onDownloadFinish info = " + paramDownloadInfo);
    upe.d("WeishiDownloadUtil", paramString + " onDownloadFinish eventId:" + paramInt1 + ",eventType:" + paramInt2);
    int i;
    if (b(paramDownloadInfo))
    {
      ...
      ugq.a();
      upe.c("WeishiDownloadUtil", paramString + " onDownloadFinish ACTIVE closeDownloadDialog");
      i = 1;
      unh.a(paramInt1);
      umw.a(2);
    ...
    for (;;)
    {
      if (jdField_b_of_type_JavaUtilHashMap.containsKey(paramDownloadInfo.d))
      {
        ...
        upe.d("WeishiDownloadUtil", paramString + " onDownloadFinish remove retryCount!");
      }
      if (i != 0)
      {
        paramString = a(ugb.a().e());
        a(jdField_a_of_type_ComTencentBizPubaccountWeishi_newDownloadWSDownloadParams, paramInt2, paramString);
      }
      a(paramDownloadInfo.d, ugb.a().e());
      return;
      label254:
      if (paramInt2 == 2)
      {
        ...
        {
          udo.b += 1;
          upe.b("WeishiDownloadUtil", paramString + " onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + udo.b);
          i = 1;
          break;
        }
        upe.a("WeishiDownloadUtil", "processDownloadFinish, this is maybe DTest silent download,linktype is :" + ugb.a().a());
        i = 1;
        break;
      }
      if (d())
      {
        a(false);
        upe.d("WeishiDownloadUtil", paramString + " 预下载中用户点击了钩子，下载完成需弹起安装！！！ByQQ");
        i = 1;
        break;
      }
      upe.d("WeishiDownloadUtil", paramString + " 正常预下载无需安装");
      i = 0;
      break;
      label422:
      if (paramInt1 == 401) {
  ...
  {
    upe.d("WeishiDownloadUtil", "qq installSucceed appid = " + paramString1 + ", packageName = " + paramString2);
    int i;
    if ((TextUtils.equals(paramString1, "10261931")) && (TextUtils.equals(paramString2, "com.tencent.weishi")))
    {
      upe.d("WeishiDownloadUtil", "这是统一的DownloadListener，installSucceed, appId:" + paramString1 + ",packName:" + paramString2);
      bisa.a().b(jdField_a_of_type_Ugw);
      udo.b = 0;
      if (!paramBoolean) {
        break label154;
      }
      jdField_b_of_type_Ugw = null;
      i = a();
      int j = b();
      unh.b(i);
      umw.b(2);
  ...
  {
    String str = c();
    upe.b("WeishiDownloadUtil", "~~~~~~~~~~~~~~~~~~~~~~~~~currentProcessName:" + str);
  ...
  private static ugw c(int paramInt1, int paramInt2)
  {
    upe.a("WeishiDownloadUtil", "createQzoneListener~~~");
    if (jdField_b_of_type_Ugw != null)
    {
      if (!c()) {
        a(paramInt1);
      }
      b(paramInt2);
      return jdField_b_of_type_Ugw;
    }
    a(paramInt1);
    b(paramInt2);
    jdField_b_of_type_Ugw = new ugz();
    bisa.a().a(jdField_b_of_type_Ugw);
    upe.a("WeishiDownloadUtil", "qzone registerListener");
    return jdField_b_of_type_Ugw;
  }
  ...
  public static boolean c()
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      upe.b("WeishiDownloadUtil", "downloading  = " + bool2 + ", timeout = " + bool1 + ", time passed = " + l / 1000L + "s");
      if ((!bool2) || (bool1)) {
        break;
      }
      return true;
  ...
  {
    upe.a("WeishiDownloadUtil", "getPreDownloadingClick");
    return LocalMultiProcConfig.getBool("preDownloadingClick", false);
  }
  
  private static boolean e()
  {
    return (ugb.a().c()) && (!TextUtils.isEmpty(ugb.a().c())) && (ugb.a().c().startsWith("http"));
  }
}
