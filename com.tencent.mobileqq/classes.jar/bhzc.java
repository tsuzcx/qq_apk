...
public class bhzc
{
  private static final bhmc<bhzc, Void> jdField_a_of_type_Bhmc = new bhzd();
  public WeakReference<bhze> a;
  ...
  {
    return (bhzc)jdField_a_of_type_Bhmc.b(null);
  }
  ...
  public qq_ad_get.QQAdGet.DeviceInfo a()
  {
    for (;;)
    {
      ...
      {
        localObject = new yyt();
        ((yyt)localObject).a = "1018ec";
        localObject = yys.a(BaseApplicationImpl.getApplication(), (yyt)localObject);
        if (localObject == null) {
          continue;
        }
        localObject = ((yyu)localObject).jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo;
  ...
  public void a(int paramInt1, long paramLong, int paramInt2, String paramString, int paramInt3)
  {
    ...
    bhzf.a(paramLong, paramString, paramInt1, paramInt2, 1, paramInt3, this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo);
  ...
  public void a(long paramLong, int paramInt1, String paramString, int paramInt2, bhze parambhze)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhze);
  ...
  public void a(vac_adv_get.VacAdvRsp paramVacAdvRsp)
  {
    ...
    {
      ((bhze)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a((AlumBasicData)localArrayList.get(0));
