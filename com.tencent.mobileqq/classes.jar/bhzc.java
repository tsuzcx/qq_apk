  ...
  implements Handler.Callback
{
  ...
  public Handler a;
  public View a;
  private final bhze jdField_a_of_type_Bhze;
  public boolean a;
  private boolean c;
  ...
  @TargetApi(19)
  public bhzc(Window paramWindow, boolean paramBoolean)
  {
    ViewGroup localViewGroup = (ViewGroup)paramWindow.getDecorView();
    if (ImmersiveUtils.isSupporImmersive() == 1) {
      this.c = paramBoolean;
    }
    this.jdField_a_of_type_Bhze = new bhze(paramWindow, this.c, null);
    if (this.c) {
  ...
  private void a(Window paramWindow, ViewGroup paramViewGroup)
  {
    ...
    paramWindow = new FrameLayout.LayoutParams(-1, this.jdField_a_of_type_Bhze.a());
