  ...
  extends FilterOutputStream
{
  ...
  private static bhpr jdField_b_of_type_Bhpr;
  ...
  private bhpr(@NonNull OutputStream paramOutputStream)
  {
    this(paramOutputStream, 8192);
  }
  
  private bhpr(@NonNull OutputStream paramOutputStream, int paramInt)
  {
  ...
  public static bhpr a(@NonNull OutputStream paramOutputStream)
  {
    bhpr localbhpr = null;
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_b_of_type_Bhpr != null)
      {
        localbhpr = jdField_b_of_type_Bhpr;
        jdField_b_of_type_Bhpr = localbhpr.jdField_a_of_type_Bhpr;
        localbhpr.jdField_a_of_type_Bhpr = null;
        c -= 1;
      }
      if (localbhpr != null)
      {
        localbhpr.out = paramOutputStream;
        localbhpr.jdField_a_of_type_Boolean = true;
        return localbhpr;
      }
    }
    return new bhpr(paramOutputStream);
  }
  ...
  private void a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (c < 4)
      {
        this.jdField_a_of_type_Bhpr = jdField_b_of_type_Bhpr;
        jdField_b_of_type_Bhpr = this;
        c += 1;
      }
      return;
    }
