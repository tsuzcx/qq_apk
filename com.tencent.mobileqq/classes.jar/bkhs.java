...
public class bkhs
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bkht(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  bkhv jdField_a_of_type_Bkhv;
  ...
  public bkhs(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      bkfw.a().a(this.jdField_c_of_type_Int, 0L, paramInt1, paramString, paramInt2);
      return;
    }
    QZLog.i("VipGeneralGdtShowView", " @getGdtInfo sendBusinessReport");
  }
  
  public void a(View paramView, bkhv parambkhv)
  {
    if (paramView == null) {
      return;
    }
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131367120));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367127));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367128));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367130));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367126));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367131));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367132));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367129));
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getDrawable(2130840085);
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!azmk.b()))
        {
          ((URLDrawable)localObject1).setTag(bcyz.a(bdoo.a(40.0F), bdoo.a(40.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(bcyz.o);
          if (localURLDrawable != null)
          {
            this.jdField_e_of_type_Int = paramAlumBasicData.jdField_a_of_type_Int;
            this.f = paramAlumBasicData.jdField_b_of_type_Int;
            int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bdoo.b(56.0F);
            paramInt = i;
      ...
      ((URLDrawable)localObject1).setTag(bcyz.b(bdoo.a(40.0F), bdoo.a(40.0F), bdoo.a(3.5F)));
