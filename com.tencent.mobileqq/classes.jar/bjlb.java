  ...
  implements Handler.Callback
{
  ...
  Map<String, bjld> jdField_a_of_type_JavaUtilMap;
  Map<String, PluginRecord> b;
  
  bjlb(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    this.b = new HashMap();
    bjlc localbjlc = new bjlc(this);
    bjls.a(paramContext, this.b, localbjlc);
  }
  ...
  private boolean a(PluginRecord paramPluginRecord)
  {
    ...
    {
      if (!a(paramPluginRecord, bjls.a(BaseApplicationImpl.getContext(), paramPluginRecord.id), false)) {
        break label69;
      }
  ...
  private void b(bjld parambjld)
  {
    Object localObject1 = parambjld.jdField_a_of_type_Bjle;
    PluginRecord localPluginRecord = parambjld.jdField_a_of_type_CooperationQzonePluginPluginRecord;
    if (localObject1 != null) {
      ((bjle)localObject1).d(parambjld.jdField_a_of_type_CooperationQzonePluginPluginRecord);
    }
    Object localObject2 = bjls.e(this.jdField_a_of_type_AndroidContentContext, localPluginRecord.id);
    localObject1 = bjls.a(this.jdField_a_of_type_AndroidContentContext, localPluginRecord.id);
    File localFile1 = bjls.b(this.jdField_a_of_type_AndroidContentContext, localPluginRecord.id);
    long l1 = System.currentTimeMillis();
    if (!a(localPluginRecord, (File)localObject2, true))
    {
      QLog.w("QZonePluginManger", 1, "文件校验失败");
      Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 2, parambjld).sendToTarget();
      return;
    }
    ...
    catch (Exception localException1)
    {
      ...
      Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 3, parambjld).sendToTarget();
    }
  ...
  {
    QLog.i("plugin_tag", 1, "unInstallPluginInner : " + parambjld.jdField_a_of_type_CooperationQzonePluginPluginRecord);
    parambjld = parambjld.jdField_a_of_type_CooperationQzonePluginPluginRecord;
    File localFile1 = bjls.a(this.jdField_a_of_type_AndroidContentContext, parambjld.id);
    File localFile2 = bjls.b(this.jdField_a_of_type_AndroidContentContext, parambjld.id);
    localFile1.delete();
    localFile2.delete();
    bjls.c(parambjld);
  }
  
  public void a(PluginRecord paramPluginRecord, bjle parambjle)
  {
    QLog.i("plugin_tag", 1, "installPlugin: " + paramPluginRecord);
    bjld localbjld = new bjld(this);
    localbjld.jdField_a_of_type_CooperationQzonePluginPluginRecord = paramPluginRecord;
    localbjld.jdField_a_of_type_Bjle = parambjle;
    localbjld.jdField_a_of_type_JavaLangString = paramPluginRecord.id;
    Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 0, localbjld).sendToTarget();
  }
  
  public void a(PluginRecord paramPluginRecord, bjlf parambjlf)
  {
    QLog.i("plugin_tag", 1, "unInstallPlugin: " + paramPluginRecord);
    bjld localbjld = new bjld(this);
    localbjld.jdField_a_of_type_CooperationQzonePluginPluginRecord = paramPluginRecord;
    localbjld.jdField_a_of_type_Bjlf = parambjlf;
    Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 1, localbjld).sendToTarget();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return false;
              localObject2 = (bjld)paramMessage.obj;
            } while (this.jdField_a_of_type_JavaUtilMap.containsKey(((bjld)localObject2).jdField_a_of_type_JavaLangString));
            this.jdField_a_of_type_JavaUtilMap.put(((bjld)localObject2).jdField_a_of_type_JavaLangString, localObject2);
            localObject1 = ((bjld)localObject2).jdField_a_of_type_CooperationQzonePluginPluginRecord;
            localObject2 = ((bjld)localObject2).jdField_a_of_type_Bjle;
            if (localObject2 != null) {
              ((bjle)localObject2).d((PluginRecord)localObject1);
            }
            b((bjld)paramMessage.obj);
            return false;
            paramMessage = (bjld)paramMessage.obj;
          ...
          localObject2 = paramMessage.jdField_a_of_type_Bjle;
          if (localObject2 != null) {
            ((bjle)localObject2).a(false, (PluginRecord)localObject1);
          }
          this.jdField_a_of_type_JavaUtilMap.remove(paramMessage.jdField_a_of_type_JavaLangString);
          return false;
          paramMessage = (bjld)paramMessage.obj;
          localObject1 = paramMessage.jdField_a_of_type_CooperationQzonePluginPluginRecord;
          localObject2 = paramMessage.jdField_a_of_type_Bjlf;
          if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramMessage.jdField_a_of_type_JavaLangString))
          {
            if (localObject2 != null) {
              ((bjlf)localObject2).e((PluginRecord)localObject1);
            }
            ...
            bjls.c((PluginRecord)localObject1);
            if (localObject2 != null) {
              ((bjlf)localObject2).b(true, (PluginRecord)localObject1);
            }
          }
        } while (localObject2 == null);
        ((bjlf)localObject2).b(false, (PluginRecord)localObject1);
        return false;
        localObject1 = (bjld)paramMessage.obj;
      } while (!this.jdField_a_of_type_JavaUtilMap.containsKey(((bjld)localObject1).jdField_a_of_type_JavaLangString));
      paramMessage = ((bjld)localObject1).jdField_a_of_type_CooperationQzonePluginPluginRecord;
      this.jdField_a_of_type_JavaUtilMap.remove(((bjld)localObject1).jdField_a_of_type_JavaLangString);
      ...
      bjls.b(paramMessage);
      localObject1 = ((bjld)localObject1).jdField_a_of_type_Bjle;
    } while (localObject1 == null);
    ((bjle)localObject1).a(true, paramMessage);
    return false;
  }
}
