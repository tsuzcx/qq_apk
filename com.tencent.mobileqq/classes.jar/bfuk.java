  ...
  implements Manager
{
  ...
  public ArrayList<bful> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + anni.a(2131714467) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + anni.a(2131714468) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public bfuk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    if ((paramSysMsgBody.msg_type.get() == 2) && (paramSysMsgBody.light_app.has()))
    {
      ...
      if (paramSysMsgBody.sender.has())
      {
        ...
        localMessageForArkApp.saveExtInfoToExtStr("troop_msg_nick_color", String.valueOf(BaseApplication.getContext().getResources().getColor(2131167010)));
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (anqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, bbzw parambbzw)
  {
    ...
    do
    {
        ...
        try
        {
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_redtips.has())
            {
              ...
              {
                a(new bful(this, ((TroopTipsEntity)localObject2).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject2).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)bbzh.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject2).troopUin, "", "[QQWallet Tips]", bbyp.a(), -2029, 1, bbyp.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (bftx)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              bfpj.a(paramQQAppInterface, (TroopTipsEntity)localObject2);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                beui.a().a(String.valueOf(l1), paramQQAppInterface.getCurrentAccountUin(), true);
                ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!anqc.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1249;
              }
              return null;
              if (j != 11) {
      ...
      bfup.a(l1, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((awne)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l1), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(67, true, new Object[] { String.valueOf(l1), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label3721;
        if (!paramBoolean2)
        {
          if (parambbzw != null) {
          ...
          {
            parambbzw = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_recall.get();
            paramLong = parambbzw.uint64_uin.get();
            l2 = parambbzw.uint64_admin_uin.get();
            paramInt = parambbzw.uint32_op_type.get();
            paramQQAppInterface = new HashMap();
            try
            {
              paramArrayOfByte = new msgrevoke_userdef.MsgInfoUserDef();
              paramArrayOfByte.mergeFrom(parambbzw.bytes_userdef.get().toByteArray());
            ...
            parambbzw = ((ArrayList)parambbzw.uint32_recalled_msg_list.get()).iterator();
            while (parambbzw.hasNext())
            {
              localObject2 = (TroopTips0x857.MessageRecallReminder.MessageMeta)parambbzw.next();
              localObject1 = new RevokeMsgInfo();
              ((RevokeMsgInfo)localObject1).jdField_b_of_type_JavaLangString = String.valueOf(paramLong);
              ((RevokeMsgInfo)localObject1).jdField_c_of_type_JavaLangString = String.valueOf(l2);
              ...
              ((RevokeMsgInfo)localObject1).jdField_e_of_type_JavaLangString = String.valueOf(((TroopTips0x857.MessageRecallReminder.MessageMeta)localObject2).uint64_author_uin.get());
              ((RevokeMsgInfo)localObject1).jdField_e_of_type_Int = paramInt;
              ((RevokeMsgInfo)localObject1).f = ((TroopTips0x857.MessageRecallReminder.MessageMeta)localObject2).uint32_is_anony_msg.get();
              if (i == 1)
              {
                ...
                ((RevokeMsgInfo)localObject1).d = ((msgrevoke_userdef.MsgInfoUserDef.MsgInfoDef)localObject2).long_msg_index.get();
              }
            ...
            {
              parambbzw = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_objmsg_update.get();
              if (parambbzw.bytes_ext_msg.has())
              {
                paramArrayOfByte = new SubMsgType0xaa.MsgBody();
                try
                {
                  paramArrayOfByte.mergeFrom(parambbzw.bytes_ext_msg.get().toByteArray());
                  ((auwj)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
                }
                catch (Exception parambbzw)
                {
                  for (;;)
                  {
                    if (QLog.isColorLevel()) {
                ...
                if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.has())
                {
                  ...
                  ((bhte)paramQQAppInterface.a(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.get(), paramArrayOfByte);
                  break label3721;
                  if (QLog.isColorLevel()) {
                  ...
                  if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_stcm_game_state.has())
                  {
                    ...
                    {
                      ((amgz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l1), paramQQAppInterface);
                      break label3721;
                      if (QLog.isColorLevel()) {
                      ...
                      if (((TroopTips0x857.NotifyMsgBody)localObject1).apllo_msg_push.has())
                      {
                        ...
                        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
                        {
                          ((amhy)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
                          break label3721;
                          if (QLog.isColorLevel()) {
                          ...
                          if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.has())
                          {
                            ...
                            {
                              akrp.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.get(), null);
                              break label3721;
                              if (QLog.isColorLevel()) {
                              ...
                              if (paramBoolean1)
                              {
                                ...
                                {
                                  ((anwd)paramQQAppInterface.a(20)).a(String.valueOf(l1), false, "", false, true, false, true);
                                  break label3721;
                                  if (QLog.isColorLevel()) {
                                  ...
                                  {
                                    bdjg.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject2).troopUin);
                                    break label3721;
                                    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.has())
                                    {
                                      avto.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.get());
                                    }
                                    else
                                    {
                                      ...
                                      {
                                        paramQQAppInterface = (mwn)paramQQAppInterface.a(178);
                                        if (paramQQAppInterface != null) {
                                      ...
                                      else
                                      {
                                        ...
                                        if (paramBoolean1)
                                        {
                                          try
                                          {
                                            parambbzw = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_general_gray_tip.get();
                                            if (parambbzw.uint64_busi_type.has())
                                            {
                                              l1 = parambbzw.uint64_busi_type.get();
                                              if (!parambbzw.uint64_busi_id.has()) {
                                                break label2979;
                                              }
                                              l2 = parambbzw.uint64_busi_id.get();
                                              if (!parambbzw.uint64_templ_id.has()) {
                                                break label2985;
                                              }
                                              l3 = parambbzw.uint64_templ_id.get();
                                              if (!parambbzw.uint32_ctrl_flag.has()) {
                                                break label2991;
                                              }
                                              paramInt = parambbzw.uint32_ctrl_flag.get();
                                              if (parambbzw.uint32_c2c_type.has()) {
                                                parambbzw.uint32_c2c_type.get();
                                              }
                                              if (parambbzw.uint32_service_type.has()) {
                                                parambbzw.uint32_service_type.get();
                                              }
                                              if (!parambbzw.bytes_pb_reserv.has()) {
                                                break label2996;
                                              }
                                              paramArrayOfByte = parambbzw.bytes_pb_reserv.get().toByteArray();
                                              if (!parambbzw.bytes_content.has()) {
                                                break label3001;
                                              }
                                              parambbzw = parambbzw.bytes_content.get().toByteArray();
                                              localObject1 = "";
                                              if ((parambbzw == null) || (parambbzw.length <= 0)) {
                                                break label3007;
                                              }
                                              parambbzw = new String(parambbzw, "utf-8");
                                              paramInt = auxd.a(paramInt);
                                              paramArrayOfByte = auxd.a(paramQQAppInterface, ((TroopTipsEntity)localObject2).troopUin, 1, paramInt, paramLong, parambbzw, l1, l2, paramArrayOfByte);
                                              if (paramArrayOfByte == null) {
                                                break label3721;
                                              }
                                              ...
                                              paramArrayOfByte.saveExtInfoToExtStr("bytes_content", parambbzw);
                                              bcst.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                                              auxd.a(paramQQAppInterface, paramArrayOfByte);
                                            }
                                          }
                                        ...
                                        else
                                        {
                                          ...
                                          {
                                            paramArrayOfByte = ((bdrb)paramQQAppInterface.getManager(339)).a(2);
                                            if (paramArrayOfByte != null) {
                                          ...
                                          else
                                          {
                                            ...
                                            {
                                              paramArrayOfByte = ((bdrb)paramQQAppInterface.getManager(339)).a(4);
                                              if (paramArrayOfByte != null) {
                                            ...
                                            else
                                            {
                                              ...
                                              if (paramArrayOfByte != null)
                                              {
                                                if (paramArrayOfByte.uint32_group_honor_switch.has())
                                                {
                                                  ...
                                                  parambbzw = (bfgp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                                                  if (paramInt != 0) {
                                                    break label3725;
                                                  }
                                                  paramBoolean1 = true;
                                                  parambbzw.a(String.valueOf(paramLong), paramBoolean1);
                                                }
                                                if (paramArrayOfByte.uint32_group_member_level_switch.has())
                                                {
                                                  ...
                                                  paramArrayOfByte = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                                  parambbzw = paramArrayOfByte.c(String.valueOf(paramLong));
                                                  if (parambbzw != null)
                                                  {
                                                    if (QLog.isColorLevel()) {
                                                      QLog.d("TroopTipsMsgMgr", 1, "level switch push troopInfo groupUin = " + paramLong);
                                                    }
                                                    parambbzw.cNewGroupRankUserFlag = ((byte)paramInt);
                                                    paramArrayOfByte.b(parambbzw);
                                                    ...
                                                    if (paramQQAppInterface != null)
                                                    {
                                                      ...
                                                      paramBoolean1 = true;
                                                      label3464:
                                                      paramQQAppInterface.notifyUI(152, true, new Object[] { String.valueOf(paramLong), Boolean.valueOf(paramBoolean1) });
                                                      break label3721;
                                                      avxj.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject1);
                                                      break label3721;
                                                      if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.has())
                                                      {
                                                        parambbzw = (TroopTips0x857.GroupAnnounceTBCInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.get();
                                                        if (parambbzw != null) {
                                                          if (!parambbzw.feeds_id.has()) {
                                                            break label3740;
                                                          }
                                                        }
                                                      }
    ...
    label3731:
    label3740:
    for (paramArrayOfByte = parambbzw.feeds_id.get().toStringUtf8();; paramArrayOfByte = null)
    {
      paramLong = parambbzw.group_id.get();
      paramInt = parambbzw.action.get();
      switch (paramInt)
      {
      case 0: 
        bftr.b(paramQQAppInterface, paramArrayOfByte, String.valueOf(paramLong), 1);
        break;
      case 1: 
      case 2: 
  ...
  public void a(bful parambful)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsMsgMgr", 2, "addWalletTipsCache");
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(parambful);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localbful.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localbful.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", bbyp.a(), -2029, 1, bbyp.a());
