  ...
  extends bdsv
{
  ...
  private SpannableStringBuilder a(long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      String str = String.valueOf(paramLong) + anvx.a(2131713990);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    if ((paramView != null) && ((paramView instanceof CountdownTextView)))
    {
      ...
      paramContext.a(a(), new bdta(this, paramContext));
      paramContext.setTag(this);
      return paramContext;
    }
    paramContext = new CountdownTextView(paramContext);
    paramContext.setId(2131379860);
    paramContext.setTag(this);
    ...
    paramContext.a(l, new bdtb(this, paramContext));
    return paramContext;
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.at = bcsc.a(paramObjectInput.readUTF(), false);
  ...
  public boolean a(bdpl parambdpl)
  {
    ...
    this.c = bdpo.a(parambdpl.a("st"));
    this.q = bdpo.a(parambdpl.a("dr"));
    this.r = bdpo.a(parambdpl.a("index"));
    this.as = bcsc.a(parambdpl.a("summary"), false);
    this.at = bcsc.a(parambdpl.a("st"), false);
