...
public abstract class aphp
  implements DialogInterface.OnDismissListener, aphe, aphf, apig
{
  ...
  public long a;
  ajhi jdField_a_of_type_Ajhi = new aphs(this);
  public Activity a;
  public Context a;
  ...
  public aphp(Intent paramIntent)
  {
  ...
  private void H()
  {
    ...
    if (this.jdField_a_of_type_Xez == null) {
      this.jdField_a_of_type_Xez = new xez(this.jdField_a_of_type_AndroidAppActivity);
    }
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131653579);
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("app_name");
    Object localObject1 = localObject2;
    if (str != null) {
      localObject1 = (String)localObject2 + str;
    }
    localObject2 = new aphq(this);
    this.jdField_a_of_type_Xez.a((String)localObject1, (DialogInterface.OnClickListener)localObject2);
    this.jdField_a_of_type_Xez.a((DialogInterface.OnClickListener)localObject2);
  ...
  private void K()
  {
    apjo localapjo = new apjo(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Bafb = localapjo;
    if (!d()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      localapjo.b(210);
      localapjo.a(a());
      localapjo.setCanceledOnTouchOutside(false);
      localapjo.a(c(), d(), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(a()), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(b()), a(), b());
      a(localapjo);
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        localapjo.show();
      }
      this.jdField_a_of_type_Bafb.setOnDismissListener(this);
      return;
    }
  }
  ...
  private static void a(Activity paramActivity, Intent paramIntent, Class<?> paramClass, int paramInt1, int paramInt2)
  {
  ...
  private static void a(Context paramContext, Intent paramIntent, Class<?> paramClass, int paramInt)
  {
  ...
  private void a(Bundle paramBundle, int paramInt, String paramString)
  {
    ...
    {
      awqx.b(null, "dc00899", str, "", "video_tab", "videoark_share", 0, 0, paramString, paramBundle, "", "");
      return;
      paramBundle = l + "";
      break;
      bool = false;
  ...
  private void a(bagg parambagg)
  {
    ...
    String str3 = ajjy.a(2131638950);
    Object localObject = str1;
    if (str1.startsWith(str3)) {
      localObject = str1.substring(str3.length());
    }
    localObject = ((String)localObject).trim();
    parambagg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, str2, i, (String)localObject, bool);
    return;
    if (((List)localObject).size() == 1)
    {
      localObject = (ResultRecord)((List)localObject).get(0);
      parambagg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, ((ResultRecord)localObject).jdField_a_of_type_JavaLangString, ((ResultRecord)localObject).a(), ((ResultRecord)localObject).jdField_b_of_type_JavaLangString, false);
      return;
    }
    parambagg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, (List)localObject, true);
  }
  ...
  private void a(MessageForPic paramMessageForPic, String paramString)
  {
    ...
    for (Object localObject = Long.valueOf(paramMessageForPic.uniseq);; localObject = "")
    {
      ...
      if (paramMessageForPic != null)
      {
        ...
        localObject = new Bundle();
        ((Bundle)localObject).putBoolean("extra.EXTRA_NOT_CLEAR_TOP", true);
        a((Bundle)localObject, paramString, adwz.a(paramMessageForPic));
        D();
      }
      return;
    }
  ...
  private void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_AndroidContentIntent != null) && (("ChatActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))) || ("SplashActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))))) {
      adkt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F55", paramString);
    }
    ...
    adkt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F56", paramString);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      awqx.b(null, "dc00899", str, "", "music_tab", "musicark_share", 0, 0, paramString, "", "", "");
      return;
      bool = false;
      break;
      str = "Grp_AIO";
  ...
  private void e()
  {
    if (jdField_a_of_type_Int <= 0)
    {
      ...
      int i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131166199);
      int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131166201);
  ...
  public void A()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "reportShowForwardRecent srcBusinessType = " + i);
    }
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A7EB", "0X800A7EB", i, 0, "", "", String.valueOf(j), "");
  }
  ...
  public void B()
  {
    ...
    int j = a(k);
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "reportFinalSelectedTargets srcBusinessType = " + i + ",forwardType = " + k + ",forwardMsgType = " + j + ",operateTime = " + str1);
    }
    Object localObject;
    ...
    {
      ResultRecord localResultRecord = (ResultRecord)((Iterator)localObject).next();
      String str2 = localResultRecord.jdField_a_of_type_JavaLangString;
      k = localResultRecord.jdField_b_of_type_Int;
      int m = a(str2, k);
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", str2, "0X800A7EC", "0X800A7EC", i, 0, str1, String.valueOf(m), String.valueOf(j), "");
      if (QLog.isColorLevel())
      {
        QLog.d("ForwardOption.ForwardBaseOption", 2, "reportFinalSelectedTargets multi,,targetUin = " + str2 + ",targetUinType = " + k + ",forwardTargetType = " + m);
        continue;
        ...
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", (String)localObject, "0X800A7EC", "0X800A7EC", i, 0, str1, String.valueOf(m), String.valueOf(j), "");
        if (QLog.isColorLevel()) {
          QLog.d("ForwardOption.ForwardBaseOption", 2, "reportFinalSelectedTargets single,,targetUin = " + (String)localObject + ",targetUinType = " + k + ",forwardTargetType = " + m);
        }
      }
    }
  }
  ...
  public void C()
  {
    ...
    int k = a(i);
    Object localObject1 = "";
    if ((this.jdField_a_of_type_Bafb instanceof bafw))
    {
      localObject1 = ((bafw)this.jdField_a_of_type_Bafb).getInputValue();
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("ForwardOption.ForwardBaseOption", 2, "reportClickSend srcBusinessType = " + j + ",forwardType = " + i + ",forwardMsgType = " + k + ",hasLeftAMessage = " + bool + ",operateTime = " + str2);
      }
      Object localObject2;
      int m;
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          {
            awqx.b(localQQAppInterface, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, str2, String.valueOf(i), String.valueOf(k), (String)localObject1);
            if (QLog.isColorLevel()) {
              QLog.d("ForwardOption.ForwardBaseOption", 2, "reportClickSend multi,,targetUin = " + str1 + ",targetUinType = " + m + ",forwardTargetType = " + i);
            }
            localObject1 = str1;
            break label205;
            if (!(this.jdField_a_of_type_Bafb instanceof apjo)) {
              break;
            }
            localObject1 = ((apjo)this.jdField_a_of_type_Bafb).getInputValue();
            break;
          }
        }
      }
      else
      {
        ...
        localObject1 = "1";
        awqx.b((QQAppInterface)localObject2, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, str2, String.valueOf(i), String.valueOf(k), (String)localObject1);
        if (QLog.isColorLevel()) {
          QLog.d("ForwardOption.ForwardBaseOption", 2, "reportClickSend single,,targetUin = " + str1 + ",targetUinType = " + m + ",forwardTargetType = " + i);
        }
        localObject1 = str1;
      }
  ...
  public void D()
  {
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BE9", "0X8009BE9", this.jdField_b_of_type_Int, 0, "", "", "", "");
  }
  
  public void E()
  {
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BEA", "0X8009BEA", this.jdField_b_of_type_Int, 0, "", "", "", "");
    C();
  }
  ...
  public void F()
  {
    ...
    do
    {
      ...
      awqx.b(null, "dc00898", "", "", "0X800A27", "0X800A27", 0, 0, "", ForwardUtils.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype")), str, ForwardUtils.b(i));
  ...
  public float a(float paramFloat)
  {
    ...
    int i = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131165691);
    float f1 = paramFloat;
    if (i > f2 * paramFloat)
    {
  ...
  protected final DialogInterface.OnClickListener a()
  {
    if (this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new apht(this);
    }
  ...
  protected View.OnClickListener a(apib paramapib)
  {
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    if (this.jdField_a_of_type_AndroidViewView$OnClickListener == null) {
      this.jdField_a_of_type_AndroidViewView$OnClickListener = new aphw(this, str, paramapib);
    }
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!azzz.a(localRecentUser.uin)) && (localRecentUser.getType() != 1020) && (localRecentUser.getType() != 1008) && (localRecentUser.getType() != 1005) && ((localRecentUser.getType() != 1006) || (a(aphf.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 1009) && (localRecentUser.getType() != 1021) && (localRecentUser.getType() != 1001) && (localRecentUser.getType() != 10002) && (localRecentUser.getType() != 10004) && (localRecentUser.getType() != 1022) && (localRecentUser.getType() != 1032) && (localRecentUser.getType() != 1033) && (localRecentUser.getType() != 1034) && (localRecentUser.getType() != 7000) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1) || (!a(localRecentUser.uin))) && ((localRecentUser.getType() != 0) || (!mqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) && (((localRecentUser.getType() != 1004) && (localRecentUser.getType() != 1000)) || (this.jdField_b_of_type_Boolean))) {
  ...
  public void a(int paramInt)
  {
    if (this.jdField_b_of_type_Bbms == null) {
      this.jdField_b_of_type_Bbms = new bbms(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766));
    }
    this.jdField_b_of_type_Bbms.c(paramInt);
    if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
  ...
  {
    if (paramBoolean) {
      axwd.a((URLDrawable)paramDrawable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
    }
    if (paramDrawable == null) {}
    while (paramBoolean) {
      return;
    }
    paramDrawable.setBounds(bacm.a(paramDrawable, 36, 100, this.jdField_a_of_type_Float));
  }
  ...
  {
    bfcq.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, paramAIOImageProviderService, paramAIORichMediaData, 19001, 4);
  }
  
  protected void a(Bundle paramBundle, String paramString, cy paramcy)
  {
    ajgm localajgm = (ajgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
    paramBundle = "";
    if ((this.jdField_a_of_type_Bafb instanceof bafw)) {
      paramBundle = ((bafw)this.jdField_a_of_type_Bafb).getInputValue();
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(paramBundle))
      {
        ...
        int i = localajgm.a().b(paramString, localBundle, paramcy);
        if (QLog.isColorLevel()) {
      ...
      return;
      if ((this.jdField_a_of_type_Bafb instanceof apjo)) {
        paramBundle = ((apjo)this.jdField_a_of_type_Bafb).getInputValue();
      }
    }
  }
  ...
  protected final void a(String paramString, bafb parambafb)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "addSourceNameView start! sourceName =" + paramString);
    }
    if ((paramString == null) || ("".equals(paramString)) || (parambafb == null)) {
      return;
    }
    ...
    parambafb.addView(localTextView);
  }
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    localBundle.putString("uinname", ajjy.a(2131638949) + paramString2);
    a(aphf.jdField_d_of_type_JavaLangInteger.intValue(), localBundle);
  }
  ...
  public boolean a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_c_of_type_Boolean) || ((this instanceof apma)) || ((this instanceof apic)) || (this.jdField_a_of_type_AndroidOsBundle.getInt("cmshow_game_id") > 0));
    ...
    if (paramInt1 == 1) {
      if (((azjh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramString, true).jdField_a_of_type_Boolean)
      {
        bool1 = false;
        bool2 = bool1;
        if (bool1)
        {
          bool2 = bool1;
          if ((this instanceof apir))
          {
            paramString = (apir)this;
            bool2 = bool1;
  ...
  protected boolean a(Intent paramIntent)
  {
    ...
    if (!bool2)
    {
      ...
      {
        bool1 = bool2;
        if (str.equals(this.jdField_a_of_type_AndroidAppActivity.getString(2131626744))) {
          bool1 = true;
        }
      }
    }
    if (bool1)
    {
      ...
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", this.jdField_a_of_type_AndroidAppActivity.getString(2131654133));
  ...
  protected final DialogInterface.OnClickListener b()
  {
    if (this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new aphu(this);
    }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false))
      {
        ...
        paramInt = localajgm.a().a(str, localBundle, localaphz);
        a(localBundle, str, null);
        label257:
        if ((f()) || (paramInt != 0)) {
          break label359;
        }
        cv.b(this.jdField_a_of_type_AndroidAppActivity, paramInt);
      ...
      for (;;)
      {
        ...
        b(localIntent);
        localBundle.putAll(localIntent.getExtras());
        paramInt = localajgm.a().b(str, localBundle, localaphz);
        a(localBundle, str, null);
        break label257;
        label359:
        break;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle != null) {
      a(paramBundle.getInt("key_forward_ability_type", aphf.a.intValue()), paramBundle);
    }
  }
  
  protected void b(String paramString) {}
  
  protected final void b(String paramString, bafb parambafb)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "updateImageView: filepath=" + paramString);
    }
    ThreadManager.post(new ForwardBaseOption.8(this, paramString, parambafb), 8, null, false);
    if (QLog.isColorLevel()) {
  ...
  protected boolean b(String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Bafb instanceof bafw))
    {
      str = ((bafw)this.jdField_a_of_type_Bafb).getInputValue();
      if (TextUtils.isEmpty(str)) {
        break label270;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (!(this instanceof apmn)) {
        acvh.a().a((SessionInfo)localObject, str, i);
      }
      return true;
      if (!(this.jdField_a_of_type_Bafb instanceof apjo)) {
        break;
      }
      str = ((apjo)this.jdField_a_of_type_Bafb).getInputValue();
      break;
      label241:
  ...
  protected final DialogInterface.OnClickListener c()
  {
    if (this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new aphv(this);
    }
  ...
  public void c()
  {
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "0", "", "", "");
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajjy.a(2131638942));
  ...
  protected void c(String paramString)
  {
    ...
    Object localObject2 = ((xrh)localObject1).a(Long.parseLong(paramString));
    ((xrh)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, (DeviceInfo)localObject2, false);
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false)) {
  ...
  protected void d(int paramInt)
  {
    ...
    x();
    aphr localaphr = new aphr(this);
    if (this.jdField_a_of_type_Xfc == null) {
      this.jdField_a_of_type_Xfc = new xfc(this.jdField_a_of_type_AndroidAppActivity);
    }
    for (;;)
    {
      String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131625011);
      ...
      this.jdField_a_of_type_Xfc.a((String)localObject, localaphr);
      this.jdField_a_of_type_Xfc.a(2131626644);
      localObject = this.jdField_a_of_type_Xfc;
      boolean bool;
      if (paramInt == 0)
      {
        bool = true;
        ((xfc)localObject).a(bool);
        this.jdField_a_of_type_Xfc.a(2131653615);
        this.jdField_a_of_type_Xfc.b(0);
        this.jdField_a_of_type_Xfc.c(2131653616);
        this.jdField_a_of_type_Xfc.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131629217), localaphr);
      }
      try
      {
        this.jdField_a_of_type_Xfc.show();
        return;
  ...
  public void d(String paramString)
  {
    ...
    do
    {
      ...
      awqx.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, paramString, ForwardUtils.b(i), str, "");
    } while (!QLog.isColorLevel());
  ...
  protected boolean e()
  {
    ...
    if ((this.jdField_a_of_type_Xfc != null) && (this.jdField_a_of_type_Xfc.isShowing())) {
      this.jdField_a_of_type_Xfc.dismiss();
    }
    x();
    return true;
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A220", "0X800A220", 0, 0, "0", "", "", "");
    }
    B();
  }
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_Bafb instanceof baes)) {
      ((baes)this.jdField_a_of_type_Bafb).a(0);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Bafb instanceof baes)) {
      ((baes)this.jdField_a_of_type_Bafb).a(1);
    }
  ...
  protected boolean k()
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajhh)localObject).a();
  ...
  public final void l()
  {
    ...
    if (i == 0)
    {
      ...
      if ((i == 27) || (i == 39))
      {
        this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131361802));
        this.jdField_a_of_type_Bafb.setMessage("");
        this.jdField_a_of_type_Bafb.setNegativeButton(2131625035, b());
        this.jdField_a_of_type_Bafb.setPositiveButton(2131625184, a());
        this.jdField_a_of_type_Bafb.show();
      }
    }
    for (;;)
    {
      if ((this.jdField_a_of_type_Bafb instanceof bagg)) {
        a((bagg)this.jdField_a_of_type_Bafb);
      }
      Object localObject1 = d();
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        this.jdField_a_of_type_Bafb.setEditLint((String)localObject1);
      }
      if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("miniAppNeedOnlyPreview", false))
      {
        ((baes)this.jdField_a_of_type_Bafb).a(c());
        ((baes)this.jdField_a_of_type_Bafb).a();
      }
      this.jdField_a_of_type_Bafb.setOnDismissListener(this);
      this.jdField_a_of_type_Bafb.adjustTitle();
      b();
      this.jdField_a_of_type_Bafb.setMsgMaxLineWithEnd(this.jdField_a_of_type_JavaLangString, 3);
      if (a(this.jdField_a_of_type_Bafb)) {
        b(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Bafb);
      }
      if (this.jdField_a_of_type_AndroidOsBundle.getInt(jdField_e_of_type_JavaLangString, 0) == 1) {
        this.jdField_a_of_type_Bafb.setPreviewImageScaleType(true);
      }
      if (this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        break;
      }
      this.jdField_a_of_type_Bafb.show();
      return;
      this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), d(), a(), b(), a(), b());
      continue;
      if (i == 1)
      {
        m();
        ...
        this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b());
        continue;
      }
      if (i == 2)
      {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
          alep.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, "AIOArkSdkSelectSend", 1, 0, 0L, 0L, 0L, (String)localObject2, "");
        }
        label690:
        this.jdField_a_of_type_Bafb.setMessage("");
        this.jdField_a_of_type_Bafb.setNegativeButton(2131625035, b());
        ...
        this.jdField_a_of_type_Bafb.show();
        continue;
        this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131361802));
        ...
        localObject1 = (bafw)this.jdField_a_of_type_Bafb;
        ((bafw)localObject1).b();
        ((bafw)localObject1).getEditText().setHint(ajjy.a(2131638944));
        continue;
        if (i == 3)
        {
          this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131361802), false);
          continue;
        }
        if (i == 4)
        {
          ...
          this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), (String)localObject1, (String)localObject2, (ArrayList)localObject3, null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131361802), false);
          continue;
        }
        if (i == 5)
        {
          i = this.jdField_a_of_type_AndroidOsBundle.getInt("key_hiboom_id");
          this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), "", null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131361802), false);
          localObject1 = new HiBoomTextView(this.jdField_a_of_type_AndroidAppActivity);
          ((HiBoomTextView)localObject1).setHiBoom(i, 0, aqdf.jdField_a_of_type_Aqcy);
          ((HiBoomTextView)localObject1).setText(this.jdField_a_of_type_JavaLangString);
          ((HiBoomTextView)localObject1).setMaxSize(aqdf.jdField_a_of_type_Int);
          localObject2 = new LinearLayout.LayoutParams(500, 500);
          ((LinearLayout.LayoutParams)localObject2).gravity = 17;
          this.jdField_a_of_type_Bafb.addView((View)localObject1, (LinearLayout.LayoutParams)localObject2);
          continue;
        }
        this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131361802), false);
      }
  ...
  protected boolean m()
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajjj)localObject).e();
      if (localObject != null)
      {
  ...
  protected boolean o()
  {
    ...
    do
    {
      ...
      i = 0;
      break;
      Object localObject = (xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
      bool1 = bool2;
      if (localObject != null)
      {
        bool1 = bool2;
        if (((xrh)localObject).a())
        {
          localObject = ((xrh)localObject).a();
          bool1 = bool2;
          if (localObject != null)
          {
            bool1 = bool2;
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    if ((this.jdField_a_of_type_AndroidAppActivity.getIntent() != null) && (this.jdField_a_of_type_AndroidAppActivity.getIntent().getBooleanExtra("key_share_from_screen_need_finish", false))) {
      this.jdField_a_of_type_AndroidAppActivity.finish();
    }
    if ((this.jdField_a_of_type_Bafb instanceof baes)) {
  ...
  protected void q()
  {
    ...
    for (;;)
    {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8009AAE", "0X8009AAE", i, 0, "", "", "", "");
      return;
      label80:
      if (j == 1) {
        i = 2;
  ...
  protected void t()
  {
    this.jdField_a_of_type_Bafb.setImageOnClickListener(a(new aphy(this)));
  }
  ...
  protected void v()
  {
    ...
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004047", "0X8004047", 0, 0, "", "", "", "");
  }
