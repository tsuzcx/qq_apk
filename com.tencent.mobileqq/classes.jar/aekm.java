...
public class aekm
{
  ...
  public aekm(aekh paramaekh, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new aekn(this, paramaekh));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams = new RelativeLayout.LayoutParams(-1, -1);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.topMargin = paramaekh.a;
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aeko(this, paramaekh);
    this.jdField_a_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.3(this, paramaekh);
    this.jdField_b_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.4(this, paramaekh);
  }
  ...
  public boolean a(aeke paramaeke, int paramInt)
  {
    this.jdField_a_of_type_Aeke = paramaeke;
    this.jdField_b_of_type_Int = paramInt;
    paramaeke.itemView.getLocationInWindow(this.jdField_c_of_type_ArrayOfInt);
    paramaeke = this.jdField_a_of_type_Aeke.a.getDrawable();
    this.jdField_a_of_type_ComTencentWidgetRoundRectImageView.setImageDrawable(paramaeke);
  ...
  void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_Aeke.itemView.clearAnimation();
