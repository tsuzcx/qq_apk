  ...
  extends avow
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = avpi.class.getSimpleName();
  }
  
  public avpi(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
  }
  
  public avpi(String paramString, long paramLong, List<String> paramList, DynamicSearch.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
  }
        ...
        while (i < paramString.length())
        {
          ...
          if (localObject2 != null)
          {
            ...
            while (m < ((JSONArray)localObject2).length())
            {
              ...
              localArrayList.add(new avop(localJSONObject.optString("url"), localJSONObject.optInt("type")));
              m += 1;
            }
          }
          localObject1 = new avmo((String)localObject1, str1, str2, str3, n, localArrayList);
