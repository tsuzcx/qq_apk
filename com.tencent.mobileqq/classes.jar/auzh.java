...
public class auzh
{
  ...
  private auzl jdField_a_of_type_Auzl;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_Auzl != null)) {
          this.jdField_a_of_type_Auzl.k();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  {
    if (QLog.isColorLevel()) {
      if (this.jdField_a_of_type_Auzy != null) {
        break label61;
      }
    }
    label61:
    ...
    if (this.jdField_a_of_type_Auzl != null) {
      this.jdField_a_of_type_Auzl.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_Auzy.a(0, paramMediaFormat);
  }
  
  public void a(auzf paramauzf)
  {
    this.jdField_a_of_type_JavaLangString = paramauzf.jdField_a_of_type_JavaLangString;
    Object localObject = MediaFormat.createVideoFormat("video/avc", paramauzf.jdField_a_of_type_Int, paramauzf.jdField_b_of_type_Int);
    ((MediaFormat)localObject).setInteger("color-format", 2130708361);
    ((MediaFormat)localObject).setInteger("bitrate", paramauzf.c);
    ((MediaFormat)localObject).setInteger("frame-rate", paramauzf.d);
    ((MediaFormat)localObject).setInteger("i-frame-interval", paramauzf.e);
    if (paramauzf.j != -1) {
      ((MediaFormat)localObject).setInteger("bitrate-mode", paramauzf.j);
    }
    if (paramauzf.k != -1)
    {
    ...
    if (paramauzf.jdField_b_of_type_Boolean)
    {
      ((MediaFormat)localObject).setInteger("profile", 1);
      ((MediaFormat)localObject).setInteger("level", 512);
    }
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoEncoder", 2, "start : encodeConfig = + " + paramauzf.toString() + " ; format: " + localObject);
    }
    ...
    localObject = new File(paramauzf.jdField_a_of_type_JavaLangString);
    if (!((File)localObject).exists()) {
      bace.c(((File)localObject).getAbsolutePath());
    }
    if (paramauzf.jdField_a_of_type_Auzy == null)
    {
      this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(paramauzf.jdField_a_of_type_JavaLangString, 0);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(paramauzf.g);
    }
    for (;;)
    {
      if (paramauzf.jdField_a_of_type_Auzl != null) {
        this.jdField_a_of_type_Auzl = paramauzf.jdField_a_of_type_Auzl;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_Auzy = paramauzf.jdField_a_of_type_Auzy;
      this.jdField_a_of_type_Auzy.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(paramauzf.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_Auzy == null)
    {
      ...
      if (this.jdField_a_of_type_Auzl != null)
      {
        ...
        this.jdField_a_of_type_Auzl.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_Auzy.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_Auzy != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
      ...
      catch (Exception localException2)
      {
        ...
        } while (this.jdField_a_of_type_Auzy == null);
        QLog.d("HWVideoEncoder", 1, "HWVideoEncoder release");
        this.jdField_a_of_type_Auzy.a();
      }
    }
  }
}
