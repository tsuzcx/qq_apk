...
{
  public bdcf(OpenAuthorityFragment paramOpenAuthorityFragment) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 0: 
      ...
      if (i != 0) {
        QLog.d("OpenAuthorityFragment", 1, "rec | cmd: G_A_L_D | uin : *" + bdfb.a(this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
      }
      break;
    }
    label2308:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          bdes.a().a(this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString, "", OpenAuthorityFragment.a(this.a), "1", "6", "" + i, false);
          if (TextUtils.isEmpty(localPreAuthResponse.msg.get()))
          {
            ...
            if (i == 110405)
            {
              this.a.a(paramMessage, new bdcg(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131696782), new Object[] { localPreAuthResponse.msg.get(), Integer.valueOf(i) });
            continue;
          }
          ...
          if (i == 100044)
          {
            ...
            bdes.a().a((Bundle)localObject3, OpenAuthorityFragment.a(this.a), this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString, false);
          }
          ...
          this.a.a(paramMessage, new bdch(this, localPreAuthResponse, (JSONObject)localObject1));
          continue;
        ...
        if (this.a.jdField_a_of_type_ComTencentOpenAgentOpenCardContainer.a(this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a().a(OpenAuthorityFragment.a(this.a)), localPreAuthResponse.authorized_union_text.get()))
        {
          ...
          axrn.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_pageview", false, System.currentTimeMillis() - this.a.jdField_a_of_type_Long, 0L, paramMessage, "");
        ...
        if (i != 0)
        {
          QLog.d("OpenAuthorityFragment", 1, "rec | cmd: A_D | uin : *" + bdfb.a(this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
          try
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              ...
              this.a.a(paramMessage, new bdci(this));
            }
            label1474:
            do
            {
            ...
            paramMessage = bdoo.a(OpenAuthorityFragment.a(this.a), this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString);
        ...
        catch (JSONException paramMessage)
        {
          ...
          for (paramMessage = "1";; paramMessage = "0")
          {
            ...
            axrn.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
      ...
      paramMessage = (aqas)paramMessage.obj;
      ...
      if ((!this.a.jdField_g_of_type_Boolean) && (paramMessage != null) && (paramMessage.jdField_a_of_type_JavaUtilList != null) && (!paramMessage.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        n = ForwardUtils.a(((xmv)paramMessage.jdField_a_of_type_JavaUtilList.get(i)).b.get());
        if (n < 100) {
          break label3064;
        }
      }
      for (;;)
      {
        localObject1 = (xmv)paramMessage.jdField_a_of_type_JavaUtilList.get(i);
        if (localObject1 != null) {
          ThreadManager.executeOnNetWorkThread(new OpenAuthorityFragment.9.4(this, (xmv)localObject1));
        }
        if (this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface != null) {
          QLog.d("OpenAuthorityFragment", 1, new Object[] { "user uin = ", bdfb.a(this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.getCurrentAccountUin()) });
        }
