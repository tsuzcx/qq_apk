...
public class ajeq
{
  ...
  {
    int i = 0 + bdgn.a().a(paramQQAppInterface) + antq.b(paramQQAppInterface);
  ...
  {
    if ((paramaobu == null) || (paramString == null) || (paramInt == -1)) {
      return null;
    }
    if (paramaobu.a()) {
      paramaobu.b();
    }
    Bitmap localBitmap2 = paramaobu.a(paramInt, paramString);
    Bitmap localBitmap1 = localBitmap2;
    if (localBitmap2 == null)
    {
      paramaobu.a(paramString, paramInt, true);
      if (paramInt != 4) {
        break label68;
      }
    }
    label68:
    for (localBitmap1 = bgmo.f();; localBitmap1 = bgmo.a()) {
