  ...
  implements aenz
{
  ...
  public aiqz(Context paramContext, View.OnClickListener paramOnClickListener)
  {
    ...
    paramContext = new RelativeLayout.LayoutParams(-1, aciy.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131636333));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(aciy.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener = a(2130838340);
    ...
    paramContext = new RelativeLayout.LayoutParams(-2, aciy.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramContext.addRule(15);
    paramContext.leftMargin = aciy.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    localLayoutParams.rightMargin = aciy.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    paramContext = new StateListDrawable();
    Drawable localDrawable1 = a(2130838437);
    Drawable localDrawable2 = a(2130838438);
    ...
    localObject = new RelativeLayout.LayoutParams(-1, aciy.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131636334));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(aciy.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawables(paramOnClickListener, null, null, null);
    paramOnClickListener = new RelativeLayout.LayoutParams(-2, aciy.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener.addRule(15);
    paramOnClickListener.leftMargin = aciy.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    ((RelativeLayout.LayoutParams)localObject).rightMargin = aciy.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
