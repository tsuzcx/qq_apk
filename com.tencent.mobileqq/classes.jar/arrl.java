...
public abstract class arrl<DATA, CONFIG extends arsf>
{
  ...
  protected final PriorityQueue<arrp> a;
  protected boolean a;
  protected float b;
  protected int b;
  protected long b;
  ...
  private void j()
  {
    try
    {
      this.jdField_a_of_type_Arsf = this.jdField_a_of_type_Arru.a(a());
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof arrn)) {
          ((arrn)localObject).a();
        }
      }
  ...
  public long a()
  {
    return this.jdField_a_of_type_Artd.a();
  }
  ...
  public final void a(long paramLong1, long paramLong2)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilPriorityQueue.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        arrp localarrp = (arrp)localIterator.next();
        localarrp.jdField_a_of_type_Long -= paramLong1;
        if (localarrp.jdField_a_of_type_Long <= 0L)
        {
          localIterator.remove();
          localarrp.jdField_a_of_type_Arro.a(this);
        }
      }
    }
  }
  ...
  public void a(artd paramartd)
  {
    this.jdField_a_of_type_Artd = paramartd;
  }
  
  public void a(DATA paramDATA)
  {
    if ((arqu.a().a().a()) && (paramDATA == null)) {
  ...
  public boolean a(long paramLong)
  {
    ...
    while (paramLong - this.jdField_b_of_type_Long < this.jdField_a_of_type_Artd.a()) {
      return false;
    }
    return true;
  }
  ...
  {
    return (this.jdField_a_of_type_Long > 0L) && (paramLong - this.jdField_a_of_type_Long >= this.jdField_a_of_type_Artd.a());
  }
  ...
  {
    this.jdField_a_of_type_Artd.a(paramFloat);
  }
  ...
  public boolean e()
  {
    return (this.jdField_a_of_type_Boolean) && (arsk.a());
  }
  ...
  public void f()
  {
    ...
    {
      artm.c("BaseDanmaku", "onFirstExposure, danmaku = " + toString());
      i();
      this.jdField_d_of_type_Boolean = true;
    }
    if ((this.jdField_a_of_type_Arrm != null) && (f1 <= 0.0F))
    {
      this.jdField_a_of_type_Arrm.a(this);
      this.jdField_a_of_type_Arrm = null;
    }
  }
  ...
  protected void i()
  {
    if (this.jdField_a_of_type_Arru != null) {
      this.jdField_a_of_type_Arru.a(this);
    }
  }
  
  public String toString()
  {
    return "BaseDanmaku" + this.jdField_a_of_type_Int + "[left:" + b() + ",top:" + c() + ",right:" + d() + ",bottom:" + e() + ", time:" + this.jdField_b_of_type_Long + ", mData=" + String.valueOf(this.jdField_a_of_type_JavaLangObject) + ", mType=" + a() + ", playerTime=" + this.jdField_a_of_type_Arru.a() + "]";
  }
}
