  ...
  implements View.OnClickListener
{
  ...
  public wtm(@NonNull wwe paramwwe)
  {
    super(paramwwe);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new wtn(this));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      if (!this.jdField_a_of_type_Wwe.a.jdField_a_of_type_Boolean) {
        break label193;
      }
      paramInt = (int)this.jdField_a_of_type_Wwe.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void a(@NonNull xgs paramxgs)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_Wwe.a.jdField_a_of_type_Boolean)
      {
        paramxgs.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_Wwe.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
        paramxgs.a.c = this.jdField_a_of_type_Boolean;
        if (QLog.isColorLevel()) {
  ...
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Wwe.jdField_b_of_type_Int == 21)
    {
      NativeGifImage.QZONE_DELAY = this.c;
      if (this.jdField_a_of_type_Wwe.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_Wwe.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131376279: 
      do
      {
        return;
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      } while (this.jdField_a_of_type_Wwe.jdField_b_of_type_Int != 21);
      this.jdField_a_of_type_Wwe.a(0);
      return;
    }
    a();
