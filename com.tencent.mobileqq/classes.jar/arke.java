  ...
  implements View.OnTouchListener
{
  ...
  private bhrq jdField_a_of_type_Bhrq = new arkj(this);
  ...
  public arke(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2131560682, this.jdField_a_of_type_AndroidViewViewGroup, false);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379539));
      this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131372317));
      this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375687));
      this.h.setText(alpo.a(2131716642));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372316));
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372052));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370168));
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131377987));
      this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363021));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131366320));
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      Rect localRect = aroo.a(this.jdField_a_of_type_AndroidAppActivity, a(), paramInt1, paramInt2);
      if (localRect != null) {
  ...
  public void a(String paramString, View.OnLongClickListener paramOnLongClickListener)
  {
    ...
    {
      this.jdField_c_of_type_AndroidViewView = aqsz.a(paramString).a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_c_of_type_AndroidViewView.setId(2131379840);
      ...
      if (paramString != null) {
        paramString.addOnLayoutChangeListener(new arkf(this));
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetDragContainerLayout.setGestureChangeListener(this.jdField_a_of_type_Bhrq);
      paramString = new RelativeLayout.LayoutParams(-1, -1);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130843853, 0, 0);
    ...
    if (arof.b(paramString1))
    {
      ...
      paramString2.setOnClickListener(new arkg(this, paramString1));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new arkh(this));
  }
  ...
  public void d()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new arki(this));
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130845253);
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131691182));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130845251);
    this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131691185));
  }
