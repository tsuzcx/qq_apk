...
public class axzq
  extends axup
{
  public final ArrayList<axup> a;
  public boolean a;
  public int k = actj.a(2.5F, BaseApplicationImpl.getContext().getResources());
  public int l = this.k;
  private int m;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if ((paramView != null) && ((paramView instanceof ViewGroup)))
      {
        ...
        localObject = (axup)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localObject instanceof axzk))
        {
          localaxzk = (axzk)localObject;
          localView = localaxzk.a(paramContext, null, paramBundle);
      ...
      {
        ((TextView)localView).setGravity(localaxzk.l);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    while (i < j)
    {
      ...
      {
        localObject = axuz.a((String)localObject);
        if (localObject != null)
        {
  ...
  {
    boolean bool2 = false;
    Object localObject1 = paramaxwg.a("mode");
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
    boolean bool1;
    try
    {
      this.m = Integer.valueOf((String)localObject1).intValue();
      localObject1 = paramaxwg.a("margin");
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        do
        {
          ...
          this.k = actj.a(Float.valueOf(localObject1[0]).floatValue(), (Resources)localObject2);
          this.l = actj.a(Float.valueOf(localObject1[1]).floatValue(), (Resources)localObject2);
          localObject1 = paramaxwg.a("hidden");
          ...
          while (i < paramaxwg.a())
          {
            localObject1 = paramaxwg.a(i);
            if ((localObject1 != null) && ("td".equals(((axwg)localObject1).b)))
            {
              localObject2 = axuz.a(((axwg)localObject1).b);
              bool1 = bool2;
              if (localObject2 == null) {
                return bool1;
              }
              bool1 = bool2;
              if (!((axup)localObject2).a((axwg)localObject1)) {
                return bool1;
              }
              a((axup)localObject2);
            }
