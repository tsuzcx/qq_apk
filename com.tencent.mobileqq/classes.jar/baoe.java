...
public class baoe
  implements IBinder.DeathRecipient, baof
{
  private long jdField_a_of_type_Long;
  private axlf jdField_a_of_type_Axlf;
  private String jdField_a_of_type_JavaLangString;
  
  private baoe(long paramLong, String paramString, axlf paramaxlf)
  {
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Axlf = paramaxlf;
    try
    {
      paramaxlf.asBinder().linkToDeath(this, 0);
      return;
    }
  ...
  public void binderDied()
  {
    ...
    baqy.a(this.jdField_a_of_type_Long).removeListener(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, this);
  }
  ...
  public void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      this.jdField_a_of_type_Axlf.onComplete(paramString1, paramInt1);
      return;
    }
  ...
  public void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    try
    {
      this.jdField_a_of_type_Axlf.onProgress(paramString1, paramLong2, paramLong3);
      return;
    }
    catch (RemoteException paramQQAppInterface)
    {
