...
class baoe
{
  ...
  {
    if (!baoc.a(this.jdField_a_of_type_Baoc).a()) {}
    for (int i = 2;; i = 5)
    {
      if (paramArrayOfInt != null)
      {
  ...
  FileStorageServerListInfo a()
  {
    ...
    ArrayList localArrayList = baoc.c(this.jdField_a_of_type_Baoc, 16);
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        int i = b(baoc.a(this.jdField_a_of_type_Baoc).a(baoc.a(this.jdField_a_of_type_Baoc).b()));
        localObject1 = localObject2;
        if (i > -1)
        {
          localObject1 = localObject2;
  ...
  {
    Object localObject2 = null;
    ArrayList localArrayList = baoc.c(this.jdField_a_of_type_Baoc, paramInt);
    Object localObject1 = localObject2;
    if (localArrayList != null)
    {
      localObject1 = localObject2;
  ...
  void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    if (paramFileStoragePushFSSvcList != null)
    {
      ...
      if (i <= 10)
      {
        paramFileStoragePushFSSvcList = baoc.a(this.jdField_a_of_type_Baoc, baoc.a(this.jdField_a_of_type_Baoc, i));
        if (paramFileStoragePushFSSvcList != null) {}
      ...
      if (i <= 15)
      {
        paramFileStoragePushFSSvcList = baoc.b(this.jdField_a_of_type_Baoc, baoc.b(this.jdField_a_of_type_Baoc, i));
        if (paramFileStoragePushFSSvcList != null) {}
        for (j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
          this.jdField_a_of_type_Array2dOfInt[i] = new int[j];
      ...
      paramFileStoragePushFSSvcList = baoc.b(this.jdField_a_of_type_Baoc, baoc.b(this.jdField_a_of_type_Baoc, 17));
      i = k;
      if (paramFileStoragePushFSSvcList != null) {
    ...
    baoc.a(this.jdField_a_of_type_Baoc).a();
  }
