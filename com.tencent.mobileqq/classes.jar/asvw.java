...
public class asvw
  extends anzm
{
  public asvw(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(asxl paramasxl)
  {
    ...
    else if ((this.a.jdField_b_of_type_Int == 0) && (paramasxl != null) && (!this.a.jdField_b_of_type_JavaUtilList.contains(paramasxl)))
    {
      this.a.jdField_b_of_type_JavaUtilList.add(paramasxl);
      if (this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() != this.a.jdField_d_of_type_JavaUtilList.size()) {
        break label162;
      }
      Face2FaceAddFriendActivity.a(this.a, paramasxl);
    }
    for (;;)
    {
      paramasxl = this.a;
      ...
      ((Message)localObject).obj = paramasxl;
  ...
  public void a(asxp paramasxp)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.a.jdField_f_of_type_Long == 0L) || (l2 >= 1000L) || (paramasxp.a != 0L)) {
          break label269;
        }
        localObject = Message.obtain();
        ((Message)localObject).what = 16;
        ((Message)localObject).obj = paramasxp;
        l3 = 1000L - l2;
    ...
    } while ((this.a.jdField_b_of_type_Int != 1) || (this.a.jdField_a_of_type_JavaUtilList.contains(paramasxp)));
    label269:
    this.a.jdField_a_of_type_JavaUtilList.add(paramasxp);
    if ((this.a.l) && (this.a.jdField_a_of_type_Asxm != null))
    {
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.a.jdField_a_of_type_JavaUtilList.size()));
      this.a.jdField_a_of_type_Asxm.a(paramasxp);
      return;
    }
    Face2FaceAddFriendActivity.a(this.a, paramasxp);
    this.a.e();
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    if (i == 0)
    {
      Iterator localIterator = this.a.jdField_a_of_type_Asww.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((paramBusiRespHead != null) && (paramBusiRespHead.a() == 2) && (paramString.equals(paramBusiRespHead.b())))
        {
          ...
          if (!(paramBusiRespHead instanceof asxl)) {
            break label477;
          }
        }
      }
    ...
    label477:
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((asxl)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      this.a.jdField_a_of_type_Asww.a(paramBusiRespHead);
      ...
      break;
      bdla.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.4.10", "", this.a.app.getCurrentAccountUin());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<asxl> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        bhdj.a(this.a, 230, this.a.getString(2131719342), anvx.a(2131703769), 2131690697, 2131692031, new asvx(this), null).show();
      }
    }
    label179:
    label185:
    do
    {
      ...
      for (;;)
      {
        ...
        {
          paramList = (asxo)paramBusiRespHead.next();
    ...
    label421:
    bhdj.a(this.a, 230, this.a.getString(2131719342), anvx.a(2131703762), 2131690697, 2131692031, new asvy(this), null).show();
  }
}
