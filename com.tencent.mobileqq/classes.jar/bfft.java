...
public class bfft
{
  ...
  public static List<bffu> a(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      bffu localbffu = new bffu();
      localbffu.jdField_a_of_type_JavaLangString = localAioKeywordInfo.word.get();
      localbffu.jdField_a_of_type_JavaUtilList = localAioKeywordInfo.rule_id.get();
      localArrayList.add(localbffu);
    }
    return localArrayList;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localFileOutputStream;
        localObject2 = localFileOutputStream;
        bhhr.P(BaseApplicationImpl.getApplication(), paramQQAppInterface.getCurrentAccountUin(), paramAioKeyword.version.get());
      }
  ...
  public static List<bffv> b(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      localbffv.jdField_a_of_type_Int = localAioKeywordRuleInfo.rule_id.get();
      localbffv.b = localAioKeywordRuleInfo.start_time.get();
      localbffv.c = localAioKeywordRuleInfo.end_time.get();
      localbffv.d = localAioKeywordRuleInfo.postion_flag.get();
      localbffv.jdField_a_of_type_JavaUtilList = localAioKeywordRuleInfo.match_group_class.get();
      localbffv.e = localAioKeywordRuleInfo.version.get();
      localArrayList.add(localbffv);
    }
    return localArrayList;
  }
}
