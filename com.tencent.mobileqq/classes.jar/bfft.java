  ...
  extends Dialog
{
  ...
  private bffv jdField_a_of_type_Bffv;
  private boolean jdField_a_of_type_Boolean;
  
  public bfft(@NonNull Context paramContext)
  {
  ...
  private void b()
  {
    ...
    localAnimationSet.setDuration(200L);
    localAnimationSet.setFillAfter(true);
    localAnimationSet.setAnimationListener(new bffu(this));
    this.jdField_a_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  public void show()
  {
    super.show();
    a();
    if (this.jdField_a_of_type_Bffv != null) {
      this.jdField_a_of_type_Bffv.a();
    }
  }
}
