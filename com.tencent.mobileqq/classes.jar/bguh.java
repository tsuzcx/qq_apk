  ...
  implements bcbo
{
  ...
  private bguk jdField_a_of_type_Bguk = new bguk(this);
  private JsBridgeListener jdField_a_of_type_ComTencentMobileqqWebviewSwiftJsBridgeListener;
  private ReaderJsCallback jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback = new bgui(this);
  ...
  private void a(JsBridgeListener paramJsBridgeListener, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      paramString.put("graylevel", bgty.a());
      paramString.put("is_update_newstyle", bgty.a());
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtras(bgsz.a(localIntent, 2));
  ...
  private void b(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if (bgtf.a().a())
    {
      bgvo.e("ReaderJsPlugin", "pluginHandleJS ->  handleJsCall");
      a(paramString1, paramString2, paramString3, paramVarArgs);
      return;
    }
    bgvo.e("ReaderJsPlugin", "js plugin is not ready...");
    ...
    this.jdField_a_of_type_Bguk.a(paramString1, paramString2, paramString3, paramVarArgs);
  }
  ...
  public bguh a(Handler paramHandler)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.b = paramString2;
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bguj(this));
  }
  ...
  void a(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      bgvo.d("ReaderJsPlugin", "create a new js plugin");
      this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy = bgtf.a().a(this.jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback);
    }
    if (this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy != null)
    {
      ...
      bgvo.d("ReaderJsPlugin", "create a new js ,method=" + paramString3);
    }
    do
    {
      return;
      bgvo.a("ReaderJsPlugin", "handleJsCall mJsPlugin is null!");
  ...
  {
    bgvo.e("ReaderJsPlugin", "handleJsRequest, url=" + paramString1 + " ,pakName=" + paramString2 + " ,method=" + paramString3);
    ...
    else if ("JSContent".equals(paramString2))
    {
      if ("registerWebSearch".equals(paramString3))
      {
        ...
        catch (JSONException paramJsBridgeListener)
        {
          for (;;)
          {
            bgvo.a("ReaderJsPlugin", "Failed to parse json str,json=" + paramVarArgs[0]);
          }
        }
      }
      ...
      if ("JSbookshelf".equals(paramString2))
      {
        if ("getGrayUpdateData".equals(paramString3))
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            for (;;)
            {
              bgvo.e("ReaderJsPlugin", paramJsBridgeListener.getMessage());
            }
          }
        }
