...
public class xcy
  extends QIPCModule
{
  private static xcy a;
  public long a;
  public SparseArray<baqu> a;
  public String a;
  public xda a;
  public String b;
  ...
  public static String a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        JSONObject localJSONObject = ((xct)((Iterator)localObject2).next()).a();
  ...
  public static xcy a()
  {
    if (jdField_a_of_type_Xcy == null) {}
    try
    {
      if (jdField_a_of_type_Xcy == null) {
        jdField_a_of_type_Xcy = new xcy();
      }
      return jdField_a_of_type_Xcy;
    }
    finally {}
  }
  ...
  public baqu a()
  {
    ...
    localbayk.b = 1;
    localbayk.jdField_a_of_type_Long = 0L;
    localbayk.jdField_a_of_type_Int = 0;
    localbayk.c = "";
    localbayk.jdField_a_of_type_Boolean = true;
    localbayk.e = false;
    return new baqu(((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(), localbayk, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a()
  {
    ...
    {
      ((baqu)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i)).a();
      i += 1;
    }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ("action_get_art_filter_path".equals(paramString))
      {
        ...
        if ((this.b != null) && (this.b.equals(str)))
        {
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            {
              if (this.jdField_a_of_type_Xda == null) {
                this.jdField_a_of_type_Xda = xda.a(str, l1);
              }
              paramBundle = a();
              paramBundle.a("current_TaskCount", String.valueOf(this.jdField_a_of_type_AndroidUtilSparseArray.size()));
              paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Xda, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Xda, true);
        }
      }
      else if ("action_cancel_art_filter_task".equals(paramString))
      {
        ...
        {
          ((baqu)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt)).a();
      ...
      else if ("action_exit_art_filter".equals(paramString))
      {
        a(true);
        a();
        this.jdField_a_of_type_Xda = null;
      }
    }
  }
}
