...
public class shm
  implements Runnable
{
  public shm(ChatSettingForTroop paramChatSettingForTroop, long paramLong) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l == this.jdField_a_of_type_Long)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.runOnUiThread(new shn(this, localImageView, (FaceDrawable)localObject));
          return;
        }
      }
