...
{
  private static apks jdField_a_of_type_Apks;
  ...
  private apks()
  {
    ...
    this.jdField_a_of_type_Apkr = new apkr(localQQAppInterface, localQQAppInterface.getProxyManager().a());
    a(localQQAppInterface);
    this.jdField_a_of_type_Boolean = true;
  }
  
  public static apks a()
  {
    if (jdField_a_of_type_Apks == null) {}
    try
    {
      if (jdField_a_of_type_Apks == null) {
        jdField_a_of_type_Apks = new apks();
      }
      return jdField_a_of_type_Apks;
    }
    finally {}
  }
  ...
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new apkt(this);
  ...
  private void c()
  {
    ...
    {
      aplh localaplh = localQQAppInterface.getProxyManager().a();
      this.jdField_a_of_type_Apkr.a(localQQAppInterface);
      this.jdField_a_of_type_Apkr.a(localaplh);
    }
  }
  
  private void d()
  {
    this.jdField_a_of_type_Apkr.a(null);
    this.jdField_a_of_type_Apkr.a(null);
  }
  ...
  EIPCResult a(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Apkr.a(paramBundle);
  ...
  EIPCResult c(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Apkr.b(str, i);
    paramBundle = new Bundle();
  ...
  EIPCResult e(Bundle paramBundle)
  {
    ...
    return EIPCResult.createResult(0, this.jdField_a_of_type_Apkr.a(str, bool));
  }
  ...
  EIPCResult f(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Apkr.b(str1, str2, str3, i);
    paramBundle = new Bundle();
  ...
  EIPCResult g(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Apkr.c(paramBundle);
    paramBundle = new Bundle();
  ...
  {
    boolean bool = apnb.a(paramBundle.getInt("color_note_service_type"));
    paramBundle = new Bundle();
