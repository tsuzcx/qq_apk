  ...
  implements suh
{
  ...
  public sud(Activity paramActivity)
  {
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localphi.k(1037);
        localphi.a(0);
        localphi.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localphi.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localphi.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localphi.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localphi.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localphi.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localphi.b("msgbox1000000000");
        if (paramBoolean) {
          break label220;
        }
        localphi.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      oat.a(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localphi.a(), false);
      return;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(new sue(this));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693821);
        }
        localJSONObject.put("msgbox_redpoint_content", new bdnt(bbzj.b((String)localObject1), 7, 17));
        ...
        localJSONObject.put("msgbox_redpoint_count", String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693822), new Object[] { bmqa.b(paramKandianMsgBoxRedPntInfo.mMsgCnt) }));
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(teh.a("default_feeds", true), localJSONObject);
        }
