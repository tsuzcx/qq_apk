...
public class bgjr
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new bgjs(ThreadManager.getSubThreadLooper());
  private static bkfu<Integer> jdField_a_of_type_Bkfu = new bkfu(40);
  ...
  private static void c()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        {
          jdField_a_of_type_Bkfu.a(localThread3.getId(), Integer.valueOf(localThread3.getPriority()));
  ...
  private static void d()
  {
    ...
    while (i < j)
    {
      ...
      {
        int k = ((Integer)jdField_a_of_type_Bkfu.a(localThread.getId(), Integer.valueOf(0))).intValue();
        if (k != 0) {
