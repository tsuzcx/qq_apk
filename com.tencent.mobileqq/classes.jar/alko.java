  ...
  extends alkj
{
  ...
  protected alko(AppInterface paramAppInterface)
  {
  ...
  protected alko(QQAppInterface paramQQAppInterface)
  {
  ...
  protected void checkReportErrorToMM(FromServiceMsg paramFromServiceMsg)
  {
    if (reportErrorToMM(paramFromServiceMsg))
    {
      ...
      bfdq.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), getCurrentAccountUin(), 1000277, alpo.a(2131701634) + paramFromServiceMsg.getServiceCmd(), true);
    }
  }
