...
public final class bphr
  extends bpds
{
  private static volatile bphr jdField_a_of_type_Bphr;
  ...
  private final int b = ((Integer)bpjj.b(Integer.valueOf(3), Integer.valueOf(5), Integer.valueOf(7))).intValue();
  ...
  static
  {
    jdField_d_of_type_JavaLangString = bpbq.b + File.separator + "frame";
  }
  
  private bphr()
  {
    super("camera/ae_camera_editor_download_resources.json", bpbq.b, 4, "AEEditorResourceManager");
    this.jdField_d_of_type_JavaUtilMap = new LinkedHashMap();
  }
  
  public static bphr a()
  {
    if (jdField_a_of_type_Bphr == null) {}
    try
    {
      if (jdField_a_of_type_Bphr == null) {
        jdField_a_of_type_Bphr = new bphr();
      }
      return jdField_a_of_type_Bphr;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      bpam.b("AEEditorResourceManager", "setupFrameEnv---pag file is already copied");
      return;
    }
  ...
  private void e()
  {
    bpam.b(this.jdField_c_of_type_JavaLangString, "setupDisplayFilterList--BEGIN");
    QIPCClientHelper.getInstance().callServer("AEEditorEffectIpcModule", "action_get_effect_list", new Bundle(), new bphs(this));
  }
  ...
  private void f()
  {
    synchronized (this.e)
    {
      ...
      {
        bpam.d(this.jdField_c_of_type_JavaLangString, "setupFontListConfig---read assets json content empty");
        return;
      }
    }
    Object localObject2 = (List)GsonUtils.json2Obj(str2, new bphu(this).getType());
  ...
  private void g()
  {
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaUtilMap)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          bpam.d(this.jdField_c_of_type_JavaLangString, "ensureSetupPagStickerConfig---read assets json content empty");
      ...
      localObject2 = (AEEditorPagStickerGroupWrapper)GsonUtils.json2Obj(str, new bphv(this).getType());
      if ((localObject2 == null) || (CollectionUtils.isEmpty(((AEEditorPagStickerGroupWrapper)localObject2).stickerGroupList)))
      {
        localObject2 = new LinkedList();
        bpam.d(this.jdField_c_of_type_JavaLangString, "ensureSetupPagStickerConfig---parsed result invalid");
      }
      else
      {
    ...
    {
      bpam.b((String)localObject3, localObject2);
      return;
  ...
  public Pair<String, String> a(@NonNull String paramString, int paramInt)
  {
    ...
    for (localObject = b((AEEditorDownloadResBean)localObject);; localObject = null)
    {
      ...
      {
        bpam.d("AEEditorResourceManager", "font not find.");
      ...
      if (b(paramString))
      {
        bpam.d("AEEditorResourceManager", "fontExceededLimit.");
  ...
  {
    return (AEEditorPagStickerConfig)GsonUtils.json2Obj(b(paramString), new bphw(this).getType());
  }
    ...
    if (a().getValue() != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localAEEditorFilterBean.getEditorEffectItem().getPreDownload() == 1) {
          paramList.add(bpdr.a(localAEEditorFilterBean));
        }
      }
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, String paramString)
  {
    ...
    {
      if (!TextUtils.isEmpty(str1)) {
        bozr.a().a(paramBoolean, 3, str1, paramString, paramInt, paramLong);
      }
      return;
  ...
  {
    return a(bpdr.a(paramAEEditorFilterBean)) + File.separator + "effectInfo.json";
  }
  ...
  public String c(AEEditorFilterBean paramAEEditorFilterBean)
  {
    ...
    if (!TextUtils.isEmpty(paramAEEditorFilterBean.getEffectExtendBean().getMotionID())) {
      str = a(bpdr.a(paramAEEditorFilterBean)) + File.separator + paramAEEditorFilterBean.getEffectExtendBean().getMotionID();
    }
    return str;
  }
