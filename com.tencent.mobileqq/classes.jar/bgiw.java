  ...
  implements Manager
{
  ...
  public bgiw(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private void a(String paramString)
  {
    ...
    //   6: ifne +16 -> 22
    //   9: aload_0
    //   10: getfield 22	bgiw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   13: aload_1
    ...
    //   24: return
    //   25: aload_0
    //   26: getfield 22	bgiw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   29: aload_1
    ...
    //   39: dup
    //   40: aconst_null
    //   41: invokespecial 128	bgix:<init>	(Lcom/tencent/mobileqq/troop/navigatebar/TroopAioNavigateBarManager$1;)V
  ...
  private void c()
  {
    for (;;)
    {
      try
      {
        ...
        if (localIterator1.hasNext())
        {
          ...
          if (localIterator2.hasNext())
          {
            ...
            if (localTroopMessageNavigateInfo != null) {
              ...
              {
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().doAddMsgQueue(localTroopMessageNavigateInfo.troopCode, 1, localTroopMessageNavigateInfo.getTableName(), localTroopMessageNavigateInfo, 3, null);
                i = 1;
              }
              else if (localTroopMessageNavigateInfo.status == TroopMessageNavigateInfo.STATUS_MODIFY)
              {
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().doAddMsgQueue(localTroopMessageNavigateInfo.troopCode, 1, localTroopMessageNavigateInfo.getTableName(), localTroopMessageNavigateInfo, 4, null);
                i = 1;
              }
              else if (localTroopMessageNavigateInfo.status == TroopMessageNavigateInfo.STATUS_DELETE)
              {
                localIterator2.remove();
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().doAddMsgQueue(localTroopMessageNavigateInfo.troopCode, 1, localTroopMessageNavigateInfo.getTableName(), localTroopMessageNavigateInfo, 5, null);
                i = 1;
              }
            }
          }
        ...
        {
          if (i != 0) {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().saveNotify();
          }
          return;
        }
      }
  ...
  public int a(String paramString)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokevirtual 193	bgiw:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/TroopMessageNavigateInfo;
    //   7: astore_1
    //   8: aload_1
    //   9: ifnull +12 -> 21
    //   12: aload_1
    //   13: getfield 196	com/tencent/mobileqq/data/TroopMessageNavigateInfo:type	I
    //   16: istore_2
    //   17: aload_0
    //   18: monitorexit
    //   19: iload_2
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    //   2: aload_0
    //   3: iload_2
    //   4: invokevirtual 200	bgiw:a	(I)Z
    //   7: istore_3
    //   8: iload_3
    //   9: ifne +9 -> 18
    //   12: iconst_m1
    ...
    //   19: aload_1
    //   20: iload_2
    //   21: invokestatic 202	bgiw:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   24: invokevirtual 204	bgiw:a	(Ljava/lang/String;)I
    //   27: istore_2
    //   28: goto -14 -> 14
    //   31: astore_1
    //   32: aload_0
  ...
  public long a(int paramInt, String paramString)
  {
    ...
    //   23: aload_2
    //   24: iload_1
    //   25: invokestatic 202	bgiw:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   28: invokevirtual 210	bgiw:a	(Ljava/lang/String;)J
    //   31: lstore 4
    //   33: goto -16 -> 17
    //   36: astore_2
    //   37: aload_0
  ...
  public long a(String paramString)
  {
    ...
    //   9: ifnull +12 -> 21
    //   12: aload_1
    //   13: getfield 214	com/tencent/mobileqq/data/TroopMessageNavigateInfo:msgseq	J
    //   16: lstore_2
    //   17: aload_0
    //   18: monitorexit
    //   19: lload_2
  ...
  public long a(String paramString, long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 22	bgiw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   6: aload_1
    //   7: invokevirtual 119	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   10: ifeq +88 -> 98
    //   13: aload_0
    //   14: getfield 22	bgiw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   17: aload_1
    ...
    //   24: astore_1
    //   25: aload_1
    //   26: invokestatic 220	bhnm:a	(Ljava/util/Collection;)Z
    //   29: istore 5
    //   31: iload 5
    //   33: ifeq +9 -> 42
    //   36: lconst_0
    ...
    //   57: aload_1
    //   58: iload 4
    //   60: invokeinterface 223 2 0
    //   65: checkcast 94	com/tencent/mobileqq/data/TroopMessageNavigateInfo
    //   68: astore 6
    //   70: aload 6
    //   72: getfield 214	com/tencent/mobileqq/data/TroopMessageNavigateInfo:msgseq	J
    //   75: lload_2
    //   76: lcmp
    //   77: ifne +12 -> 89
    //   80: aload 6
    //   82: getfield 226	com/tencent/mobileqq/data/TroopMessageNavigateInfo:shmsgseq	J
    //   85: lstore_2
    //   86: goto -48 -> 38
    //   89: iload 4
    //   91: iconst_1
  ...
  public Object a(String paramString)
  {
    ...
    //   9: ifnull +12 -> 21
    //   12: aload_1
    //   13: getfield 233	com/tencent/mobileqq/data/TroopMessageNavigateInfo:extObj	Ljava/lang/Object;
    //   16: astore_1
    //   17: aload_0
    //   18: monitorexit
    //   19: aload_1
  ...
  public void a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject1 = (ArrayList)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager().query(TroopMessageNavigateInfo.class, false, null, null, null, null, null, null);
        if (localObject1 == null) {
          break label251;
        }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   18: aload_1
    //   19: iload_2
    //   20: invokestatic 202	bgiw:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   23: iload_3
    //   24: invokevirtual 324	bgiw:a	(Ljava/lang/String;I)V
    //   27: goto -13 -> 14
    //   30: astore_1
    //   31: aload_0
    //   32: monitorexit
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, long paramLong2, String paramString2, int paramInt3, Object paramObject)
  {
    ...
    //   30: iload 9
    //   32: aload 10
    //   34: invokevirtual 328	bgiw:a	(Ljava/lang/String;IJJLjava/lang/String;ILjava/lang/Object;)V
    //   37: goto -23 -> 14
    //   40: astore_1
    //   41: aload_0
    //   42: monitorexit
  ...
  public void a(String paramString1, int paramInt1, long paramLong1, long paramLong2, String paramString2, int paramInt2, Object paramObject)
  {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          int j = bghv.a(paramInt1);
          if ((paramInt1 != 1) && (paramString2 != null) && (paramString2.status != TroopMessageNavigateInfo.STATUS_DELETE) && (!bfoz.a(bghv.a(paramString2.type), paramString2.shmsgseq, j, paramLong1)))
          {
            if (QLog.isColorLevel()) {
  ...
  public long b(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 29	bgiw:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: aload_1
    //   7: invokevirtual 361	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   10: ifeq +35 -> 45
    //   13: aload_0
    //   14: getfield 29	bgiw:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   17: aload_1
    //   18: invokevirtual 362	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: checkcast 260	java/lang/Long
    //   24: astore_1
    //   25: aload_1
    //   26: ifnonnull +11 -> 37
    //   29: ldc2_w 206
    ...
    //   36: lreturn
    //   37: aload_1
    //   38: invokevirtual 366	java/lang/Long:longValue	()J
    //   41: lstore_2
    //   42: goto -9 -> 33
    //   45: ldc2_w 206
    //   48: lstore_2
