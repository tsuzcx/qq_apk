  ...
  extends blws
{
  ...
  public blyh(int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(paramInt1);
    this.jdField_a_of_type_Float = (azkz.a(4.0F) + paramInt2);
    this.b = paramInt3;
  }
  ...
  public void a(Canvas paramCanvas, ArrayList<blyk> paramArrayList, int paramInt1, int paramInt2)
  {
    if ((paramCanvas == null) || (paramArrayList == null)) {
      return;
    }
    this.jdField_a_of_type_AndroidGraphicsPath.reset();
    RectF localRectF1 = ((blyk)paramArrayList.get(0)).jdField_a_of_type_AndroidGraphicsRectF;
    RectF localRectF2 = ((blyk)paramArrayList.get(paramArrayList.size() - 1)).jdField_a_of_type_AndroidGraphicsRectF;
    float f3 = localRectF1.width() / ((blyk)paramArrayList.get(0)).jdField_a_of_type_JavaLangString.length();
    ...
    if (paramArrayList.size() == 1)
    {
      ...
      d2 = ((blyk)paramArrayList.get(0)).jdField_a_of_type_AndroidGraphicsRectF.height();
    ...
    {
      localRectF1 = ((blyk)paramArrayList.get(i)).jdField_a_of_type_AndroidGraphicsRectF;
      if ((f2 != -1.0F) && (f1 != -1.0F)) {
        break label504;
      }
      localRectF2 = ((blyk)paramArrayList.get(i + 1)).jdField_a_of_type_AndroidGraphicsRectF;
