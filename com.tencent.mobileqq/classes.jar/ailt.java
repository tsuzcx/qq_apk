...
public class ailt
{
  ...
  public static ailt a()
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (jdField_a_of_type_Ailt != null) {
        break label71;
      }
    }
    label71:
  ...
  {
    // Byte code:
    //   0: getstatic 84	ailt:jdField_a_of_type_Ailt	Lailt;
    //   3: ifnull +4 -> 7
    //   6: return
    //   7: new 36	java/io/File
    //   10: dup
    //   11: getstatic 54	ailt:b	Ljava/lang/String;
    //   14: invokespecial 99	java/io/File:<init>	(Ljava/lang/String;)V
    //   17: astore_0
    //   18: new 36	java/io/File
    //   21: dup
    //   22: getstatic 58	ailt:c	Ljava/lang/String;
    ...
    //   106: new 2	ailt
    //   109: dup
    //   110: invokespecial 132	ailt:<init>	()V
    //   113: putstatic 84	ailt:jdField_a_of_type_Ailt	Lailt;
    //   116: aload_1
    //   117: astore_0
    //   118: getstatic 84	ailt:jdField_a_of_type_Ailt	Lailt;
    //   121: aload_2
    //   122: iconst_0
    //   123: aaload
    //   124: putfield 134	ailt:d	Ljava/lang/String;
    //   127: aload_1
    //   128: astore_0
    //   129: getstatic 84	ailt:jdField_a_of_type_Ailt	Lailt;
    //   132: aload_2
    //   133: iconst_1
    //   134: aaload
    //   135: putfield 136	ailt:e	Ljava/lang/String;
    //   138: aload_1
    //   139: ifnull -133 -> 6
    //   142: aload_1
    ...
    //   174: astore_0
    //   175: aconst_null
    //   176: putstatic 84	ailt:jdField_a_of_type_Ailt	Lailt;
    //   179: aload_1
    //   180: ifnull -174 -> 6
    //   183: aload_1
