...
public class aexq
{
  ...
  private Set<aexu> jdField_a_of_type_JavaUtilSet;
  private Set<Integer> jdField_b_of_type_JavaUtilSet;
  
  static
  {
    jdField_a_of_type_JavaLangString = bdzf.a(alof.aW + "/Tencent/MobileQQ/pttPanelAnimations/");
    jdField_b_of_type_JavaLangString = bdzf.a(alof.aW + "/Tencent/MobileQQ/pttPanelAnimations/qq_android_ptt_transition_anim_res/");
  }
  ...
  private void a(Animator paramAnimator, int paramInt)
  {
    ...
    {
      aexu localaexu = (aexu)localIterator.next();
      if (localaexu != null) {
        localaexu.a(paramAnimator, paramInt);
      }
    }
  }
  ...
  private void a(LottieDrawable paramLottieDrawable, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      aexu localaexu = (aexu)localIterator.next();
      if (localaexu != null) {
        localaexu.a(paramLottieDrawable, paramInt);
      }
    }
  }
  ...
  public void a(aexu paramaexu)
  {
    this.jdField_a_of_type_JavaUtilSet.add(paramaexu);
  }
  ...
  public void a(LottieDrawable paramLottieDrawable, int paramInt, ImageView paramImageView, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramLottieDrawable.addAnimatorListener(new aexs(this, paramLottieDrawable, paramInt, paramImageView));
    } while (!paramBoolean);
  ...
  public boolean a()
  {
    ...
    return (localFile.exists()) && (localFile.listFiles().length == jdField_b_of_type_JavaUtilMap.size());
  }
