  ...
  extends vpk
{
  ...
  private vjh jdField_a_of_type_Vjh;
  ...
  public vjg(ImageView paramImageView, MediaMetadataRetriever paramMediaMetadataRetriever, Integer paramInteger, int paramInt1, int paramInt2, long paramLong, int paramInt3, boolean paramBoolean1, vjh paramvjh, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_Vjh = paramvjh;
  ...
  public void a()
  {
    urk.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround:%s", new Object[] { a() });
    long l3 = System.currentTimeMillis();
    if ((vms.a()) && (this.jdField_c_of_type_Boolean)) {
      urk.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround: TrimNative:%s", new Object[] { a() });
    }
    long l1;
    Object localObject;
    Bitmap localBitmap2;
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          if (TrimNative.getThumbnail(0L, l1, localBitmap1) == 0)
          {
            ...
            if (this.jdField_b_of_type_Boolean) {
              localObject = vms.a(localBitmap3, 90.0F);
            }
            a(new BitmapDrawable((Bitmap)localObject));
            localBitmap1.recycle();
            l1 = System.currentTimeMillis() - l3;
            urk.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround: TrimNative 完成时间:%s,key=%s", new Object[] { Long.valueOf(l1), a() });
            this.jdField_a_of_type_Vjh.a(this.jdField_a_of_type_JavaLangInteger.intValue(), l1);
          }
        }
        else
        {
      ...
      {
        urk.e("Q.qqstory.frameWidget.FrameLoader", "create bitmap width=%s,height=%s,error:%s", new Object[] { Integer.valueOf(this.jdField_b_of_type_Int), Integer.valueOf(this.jdField_c_of_type_Int), localException });
        continue;
        ...
        urk.e("Q.qqstory.frameWidget.FrameLoader", "mRetriever return null!");
        return;
      ...
      {
        urk.e("Q.qqstory.frameWidget.FrameLoader", "mRetriever is null!");
        return;
        urk.e("Q.qqstory.frameWidget.FrameLoader", "TrimNative return error!");
      }
      else
      {
    ...
    for (;;)
    {
      ...
      a(new BitmapDrawable((Bitmap)localObject));
      l1 = System.currentTimeMillis() - l3;
      urk.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround: mRetriever 完成时间:%s,key=%s", new Object[] { Long.valueOf(l1), a() });
      this.jdField_a_of_type_Vjh.a(this.jdField_a_of_type_JavaLangInteger.intValue(), l1);
      return;
