...
public class awmc
{
  private static volatile awmc jdField_a_of_type_Awmc;
  ...
  {
    if (jdField_a_of_type_Awmc == null) {}
    try
    {
      if (jdField_a_of_type_Awmc == null) {
        jdField_a_of_type_Awmc = new awmc();
      }
      return jdField_a_of_type_Awmc;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        bool1 = bmbc.a(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir + File.separator + "liteavsdk.jar", BaseApplicationImpl.getApplication().getApplicationContext(), getClass().getClassLoader(), "com.tencent.rtmp.ui.TXCloudVideoView", null, false);
        if (bool1)
        {
      ...
      catch (Exception localException)
      {
        ...
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir)))
        {
          ...
          bmio.a("com.tencent.rtmp.TXLiveBase", "setLibraryPath", false, bmio.a(new Class[] { String.class }), new Object[] { this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir });
        }
        return bool1;
      }
      boolean bool3 = false;
