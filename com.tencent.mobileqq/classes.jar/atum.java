...
public class atum
{
  ...
  public void a()
  {
    ...
    bdjl.a(localActivity, "com.guagua.qiqi", awzl.a("pt=$PT$&at=$AT$&openid=$OPID$&pf=$PF$"), 335544320);
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidOsAsyncTask = new atun(this);
    this.jdField_a_of_type_AndroidOsAsyncTask.execute(new Integer[] { Integer.valueOf(paramInt) });
    return;
    Bundle localBundle = new Bundle();
    localBundle.putString(bdlb.b, this.c);
    localBundle.putString(bdlb.j, this.d);
    localBundle.putString(bdlb.f, this.b);
    localBundle.putInt(bdlb.k, paramInt);
    localBundle.putString(bdlb.i, "ANDROIDQQ.MSG.QIQI");
    localBundle.putString(bdlb.l, "");
    localBundle.putBoolean(bdlb.x, false);
    localBundle.putBoolean(bdlb.g, true);
    localBundle.putBoolean(bdlb.h, false);
    bdkx.a(localNearbyPeopleProfileActivity, localBundle, "biz_src_yyb", null, 0);
  }
  ...
  public void a(com.tencent.common.app.AppInterface paramAppInterface, android.content.Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   10: aload_2
    //   11: iload 6
    //   13: invokespecial 219	atuo:<init>	(Latum;Ljava/lang/String;Landroid/content/Context;I)V
    //   16: astore 14
    //   18: aload_0
    //   19: getfield 28	atum:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   22: ifnonnull +17 -> 39
    //   25: aload_0
    ...
    //   36: putfield 28	atum:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    ...
    //   93: aload_2
    //   94: invokestatic 262	bdjl:a	(Landroid/content/Context;)Ljava/lang/String;
    //   97: astore_3
    //   98: aload 15
    ...
    //   168: aload_0
    //   169: getfield 205	atum:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   172: invokestatic 288	awzl:a	(Ljava/lang/String;)I
    //   175: istore 7
    //   177: iload 7
    //   179: ifne +28 -> 207
    //   182: aload_2
    //   183: aload 4
    //   185: aload_0
    //   186: getfield 205	atum:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   189: invokestatic 64	awzl:a	(Ljava/lang/String;)Landroid/os/Bundle;
    //   192: iload 6
    //   194: invokestatic 70	bdjl:a	(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;I)Z
    //   197: pop
    //   198: return
    //   199: astore 12
    //   201: lconst_0
    ...
    //   294: invokestatic 340	bbea:a	([B)Ljava/lang/String;
    //   297: astore 5
    //   299: aload 5
    ...
    //   351: aload 4
    //   353: aload_0
    //   354: getfield 205	atum:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   357: invokestatic 64	awzl:a	(Ljava/lang/String;)Landroid/os/Bundle;
    //   360: iload 6
    //   362: invokestatic 70	bdjl:a	(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;I)Z
    //   365: pop
    //   366: return
    //   367: astore 13
    //   369: aload 12
    ...
    //   401: aload_0
    //   402: getfield 28	atum:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   405: ldc_w 358
    //   408: ldc_w 360
    //   411: invokevirtual 364	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   414: pop
    //   415: aload_0
    //   416: getfield 28	atum:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   419: ldc_w 366
    //   422: aload 15
    ...
    //   430: pop
    //   431: aload_0
    //   432: getfield 28	atum:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   435: aload 14
    //   437: invokevirtual 34	mqq/app/NewIntent:setObserver	(Lmqq/observer/BusinessObserver;)V
    //   440: aload_1
    //   441: aload_0
    //   442: getfield 28	atum:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   445: invokevirtual 374	com/tencent/common/app/AppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   448: aload_0
    //   449: getfield 76	atum:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   452: bipush 6
    //   454: ldc2_w 375
