...
public class arqt
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new arqy(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561065, null));
      ...
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367932));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561087, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367928));
      ...
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561086, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367928));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367929));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561074, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367928));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367933));
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    do
    {
      ...
      if (j > 0)
      {
        ...
        localObject = arid.a(localQQAppInterface, (String)localObject);
    ...
    if (localQQAppInterface != null) {
      arid.a(localQQAppInterface, paramArrayList);
    }
  ...
  void b()
  {
    ...
    for (int i = AIOUtils.dp2px(2.0F, ((Context)localObject2).getResources());; i = AIOUtils.dp2px(1.0F, ((Context)localObject2).getResources()))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(i, i, i, i);
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130845029);
      ...
      try
      {
        ...
        localObject1 = arid.a((AppInterface)localObject1, (String)localObject2);
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new arqu(this));
  ...
  void c()
  {
    ...
    int j = i - ((Context)localObject1).getResources().getDimensionPixelSize(2131298177);
    if (this.jdField_a_of_type_Int == 2)
    {
      j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298185);
      i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298183);
    }
    for (;;)
    {
      ...
      localObject3 = new arqw(this, (AnimatorSet)localObject1);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() > 1)
      {
        ...
        for (;;)
        {
          if (j < this.jdField_a_of_type_JavaUtilList.size() - 1)
          {
            ...
            j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298188);
            i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298186);
            break;
          }
        }
