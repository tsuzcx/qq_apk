...
public class bgfs
{
  ...
  public static void a(Context paramContext, String paramString, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      localObject1 = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tencent" + File.separator + "MobileQQ" + File.separator + "trace").listFiles(new bgft(paramLong1, paramLong2));
      localObject2 = new bgfu();
  ...
  public static void b(Context paramContext, String paramString, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      localbgfv = new bgfv(paramLong1, paramLong2);
    } while ((!paramContext.isDirectory()) || (paramContext.listFiles() == null));
    ...
    a(paramContext, localbgfv, str, paramString);
  }
  ...
  public static boolean b(File paramFile, String paramString1, String paramString2)
  {
    ...
    //   11: astore 7
    //   13: aload 7
    //   15: invokevirtual 208	java/io/File:exists	()Z
    //   18: ifne +5 -> 23
    //   21: iconst_0
    //   22: ireturn
    ...
    //   84: invokestatic 355	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   87: invokevirtual 356	java/util/UUID:toString	()Ljava/lang/String;
    //   90: astore_0
    //   91: new 358	java/net/URL
    //   94: dup
    //   95: ldc_w 360
    //   98: invokespecial 361	java/net/URL:<init>	(Ljava/lang/String;)V
    //   101: invokevirtual 365	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   104: checkcast 367	java/net/HttpURLConnection
    //   107: astore 6
    //   109: aload 6
    //   111: ldc_w 368
    //   114: invokevirtual 372	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   117: aload 6
    //   119: ldc_w 368
    //   122: invokevirtual 375	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   125: aload 6
    //   127: iconst_1
    //   128: invokevirtual 379	java/net/HttpURLConnection:setDoInput	(Z)V
    //   131: aload 6
    //   133: iconst_1
    //   134: invokevirtual 382	java/net/HttpURLConnection:setDoOutput	(Z)V
    //   137: aload 6
    //   139: iconst_0
    //   140: invokevirtual 385	java/net/HttpURLConnection:setUseCaches	(Z)V
    //   143: aload 6
    //   145: ldc_w 387
    //   148: invokevirtual 390	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   151: aload 6
    //   153: ldc_w 392
    //   156: ldc_w 394
    //   159: invokevirtual 397	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   162: aload 6
    //   164: ldc_w 399
    //   167: ldc_w 401
    //   170: invokevirtual 397	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   173: aload 6
    //   175: ldc_w 403
    ...
    //   198: invokevirtual 397	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   201: aload 7
    //   203: ifnull +189 -> 392
    //   206: aload 6
    //   208: invokevirtual 409	java/net/HttpURLConnection:getOutputStream	()Ljava/io/OutputStream;
    //   211: astore_1
    //   212: new 411	java/io/DataOutputStream
    //   215: dup
    //   216: aload_1
    //   217: invokespecial 412	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   220: astore 4
    //   222: new 414	java/lang/StringBuffer
    //   225: dup
    //   226: invokespecial 415	java/lang/StringBuffer:<init>	()V
    //   229: astore_1
    //   230: aload_1
    //   231: ldc_w 417
    //   234: invokevirtual 420	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   237: pop
    //   238: aload_1
    //   239: aload_0
    //   240: invokevirtual 420	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   243: pop
    //   244: aload_1
    //   245: ldc_w 422
    //   248: invokevirtual 420	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   251: pop
    //   252: aload_1
    ...
    //   289: invokevirtual 420	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   292: pop
    //   293: aload_1
    //   294: ldc_w 428
    //   297: invokevirtual 420	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   300: pop
    //   301: aload_1
    //   302: ldc_w 422
    //   305: invokevirtual 420	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   308: pop
    //   309: aload 4
    //   311: aload_1
    //   312: invokevirtual 429	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   315: invokevirtual 433	java/lang/String:getBytes	()[B
    //   318: invokevirtual 436	java/io/DataOutputStream:write	([B)V
    ...
    //   338: aload_1
    //   339: aload 5
    //   341: invokevirtual 439	java/io/InputStream:read	([B)I
    //   344: istore_3
    //   345: iload_3
    //   346: iconst_m1
    ...
    //   354: iconst_0
    //   355: iload_3
    //   356: invokevirtual 440	java/io/DataOutputStream:write	([BII)V
    //   359: goto -21 -> 338
    //   362: astore_0
    //   363: aload_1
    //   364: ifnull +7 -> 371
    ...
    //   378: ifnull +7 -> 385
    //   381: aload_1
    //   382: invokevirtual 441	java/io/DataOutputStream:close	()V
    //   385: aload_0
    //   386: athrow
    //   387: astore_0
    //   388: aload_0
    //   389: invokevirtual 442	java/net/MalformedURLException:printStackTrace	()V
    //   392: iconst_0
    //   393: ireturn
    //   394: aload_1
    //   395: ifnull +7 -> 402
    ...
    //   402: aload 4
    //   404: ldc_w 422
    //   407: invokevirtual 433	java/lang/String:getBytes	()[B
    //   410: invokevirtual 436	java/io/DataOutputStream:write	([B)V
    //   413: aload 4
    ...
    //   441: invokevirtual 433	java/lang/String:getBytes	()[B
    //   444: invokevirtual 436	java/io/DataOutputStream:write	([B)V
    ...
    //   588: invokevirtual 433	java/lang/String:getBytes	()[B
    //   591: invokevirtual 436	java/io/DataOutputStream:write	([B)V
    //   594: aload 4
    //   596: invokevirtual 451	java/io/DataOutputStream:flush	()V
    //   599: aload 4
    //   601: ifnull +8 -> 609
    //   604: aload 4
    //   606: invokevirtual 441	java/io/DataOutputStream:close	()V
    //   609: aload 6
    //   611: invokevirtual 454	java/net/HttpURLConnection:getResponseCode	()I
    //   614: istore_3
    //   615: new 456	java/io/BufferedReader
    //   618: dup
    //   619: new 458	java/io/InputStreamReader
    //   622: dup
    //   623: aload 6
    //   625: invokevirtual 462	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   628: ldc_w 464
    //   631: invokespecial 467	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   634: invokespecial 470	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   637: astore_0
    //   638: aload_0
    //   639: invokevirtual 473	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   642: astore_1
    //   643: aload_1
    //   644: ifnull +27 -> 671
  ...
  {
    // Byte code:
    //   0: invokestatic 483	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   3: ldc_w 485
    //   6: invokevirtual 489	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   9: invokevirtual 492	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   12: astore 9
    //   14: invokestatic 495	android/os/Environment:getExternalStorageState	()Ljava/lang/String;
    //   17: ldc_w 497
    //   20: invokevirtual 500	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   23: ifeq +475 -> 498
    ...
    //   37: invokestatic 201	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    ...
    //   52: getstatic 39	bgfs:b	Ljava/lang/String;
    ...
    //   73: invokespecial 46	java/io/File:<init>	(Ljava/lang/String;)V
    //   76: astore 8
    //   78: aload 8
    //   80: invokevirtual 208	java/io/File:exists	()Z
    //   83: ifne +45 -> 128
    //   86: invokestatic 111	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   89: ifeq +33 -> 122
    //   92: ldc 113
    //   94: iconst_4
    ...
    //   108: aload 8
    //   110: invokevirtual 191	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   119: invokestatic 119	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   122: aload 8
    //   124: invokevirtual 211	java/io/File:mkdirs	()Z
    //   127: pop
    ...
    //   139: invokestatic 201	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   142: invokevirtual 191	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   154: getstatic 39	bgfs:b	Ljava/lang/String;
    ...
    //   191: invokespecial 46	java/io/File:<init>	(Ljava/lang/String;)V
    //   194: astore 8
    //   196: aload 8
    //   198: invokevirtual 208	java/io/File:exists	()Z
    //   201: ifne +303 -> 504
    //   204: invokestatic 111	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   207: ifeq +33 -> 240
    //   210: ldc 113
    //   212: iconst_4
    ...
    //   226: aload 8
    //   228: invokevirtual 191	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   237: invokestatic 119	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   240: aload 8
    //   242: invokevirtual 511	java/io/File:createNewFile	()Z
    //   245: pop
    //   246: goto +258 -> 504
    //   249: sipush 1024
    //   252: newarray byte
    ...
    //   256: ldc_w 512
    //   259: istore_2
    //   260: invokestatic 111	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   263: ifeq +12 -> 275
    //   266: ldc 113
    //   268: iconst_4
    //   269: ldc_w 514
    //   272: invokestatic 119	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   275: new 50	java/io/FileOutputStream
    //   278: dup
    //   279: aload 8
    //   281: invokespecial 53	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   284: astore 8
    //   286: invokestatic 519	java/lang/System:currentTimeMillis	()J
    //   289: lstore 4
    //   291: iload_2
    //   292: ifle +78 -> 370
    //   295: invokestatic 519	java/lang/System:currentTimeMillis	()J
    //   298: lstore 6
    //   300: lload 6
    //   302: lload 4
    //   304: lsub
    ...
    //   308: lcmp
    //   309: ifle +77 -> 386
    //   312: invokestatic 111	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   315: ifeq +55 -> 370
    //   318: ldc 113
    //   320: iconst_4
    ...
    //   334: lload 6
    //   336: invokevirtual 330	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   339: ldc_w 525
    //   342: invokevirtual 20	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   345: lload 4
    //   347: invokevirtual 330	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   350: ldc_w 527
    //   353: invokevirtual 20	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   356: lload 6
    //   358: lload 4
    //   360: lsub
    //   361: invokevirtual 330	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   364: invokevirtual 31	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   367: invokestatic 119	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   370: aload 8
    //   372: invokevirtual 528	java/io/FileOutputStream:close	()V
    //   375: aload_0
    //   376: aload_1
    //   377: invokestatic 530	bgfs:d	(Landroid/content/Context;Ljava/lang/String;)V
    //   380: aload 9
    //   382: invokevirtual 102	java/io/InputStream:close	()V
    //   385: return
    //   386: aload 9
    //   388: aload 10
    //   390: iconst_0
    ...
    //   392: aload 10
    //   394: arraylength
    //   395: invokestatic 536	java/lang/Math:min	(II)I
    //   398: invokevirtual 97	java/io/InputStream:read	([BII)I
    //   401: istore_3
    //   402: iload_3
    //   403: iconst_m1
    //   404: if_icmpne +78 -> 482
    //   407: new 538	java/io/EOFException
    //   410: dup
    //   411: ldc_w 540
    //   414: invokespecial 541	java/io/EOFException:<init>	(Ljava/lang/String;)V
    //   417: athrow
    //   418: astore 10
    //   420: aload 8
    //   422: invokevirtual 528	java/io/FileOutputStream:close	()V
    //   425: aload_0
    //   426: aload_1
    //   427: invokestatic 530	bgfs:d	(Landroid/content/Context;Ljava/lang/String;)V
    //   430: aload 10
    //   432: athrow
    //   433: astore_0
    //   434: aload 9
    //   436: invokevirtual 102	java/io/InputStream:close	()V
    //   439: aload_0
    //   440: athrow
    //   441: astore_0
    //   442: aload_0
    //   443: invokevirtual 474	java/io/IOException:printStackTrace	()V
    //   446: invokestatic 111	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   449: ifeq -64 -> 385
    //   452: ldc 113
    //   454: iconst_4
    ...
    //   468: aload_0
    //   469: invokevirtual 544	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   478: invokestatic 119	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   481: return
    //   482: aload 8
    //   484: aload 10
    //   486: iconst_0
    //   487: iload_3
    //   488: invokevirtual 545	java/io/FileOutputStream:write	([BII)V
    //   491: iload_2
    //   492: iload_3
    //   493: isub
    //   494: istore_2
