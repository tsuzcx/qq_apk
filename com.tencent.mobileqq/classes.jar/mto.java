...
public class mto
{
  static volatile mto jdField_a_of_type_Mto;
  public int a;
  ...
  private mto(Context paramContext)
  {
    ...
    if (Looper.myLooper() != null) {
      this.jdField_a_of_type_Mtq = new mtq(this);
    }
  ...
  public static mto a(Context paramContext)
  {
    if (jdField_a_of_type_Mto == null) {}
    try
    {
      if (jdField_a_of_type_Mto == null) {
        jdField_a_of_type_Mto = new mto(paramContext);
      }
      return jdField_a_of_type_Mto;
    }
    finally {}
  }
  ...
  private String b()
  {
    ...
    {
      lcl.c("SignalStrengthReport", "getGateway e:" + localException);
    }
    return "";
  }
  ...
  private int g()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          ...
          {
            lcl.c("SignalStrengthReport", "getPingInterval config:" + (String)localObject);
    ...
    {
      lcl.c("SignalStrengthReport", "getPingInterval e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  int a(SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      ...
      {
        lcl.c("SignalStrengthReport", "getLevelPercentBySignalStrength reflect getLevel e:" + paramSignalStrength);
        return 0;
      }
    }
  }
  ...
  public void a()
  {
    ...
    {
      return;
      lcl.c("SignalStrengthReport", "report start");
    ...
    } while ((this.jdField_a_of_type_Mtq == null) || (this.jdField_a_of_type_AndroidTelephonyTelephonyManager == null));
    this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtq, 256);
  }
  ...
  int b(SignalStrength paramSignalStrength)
  {
    ...
    //   112: invokestatic 148	lcl:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: iconst_m1
    //   116: istore_2
    //   117: goto -74 -> 43
    //   120: aload_1
    ...
    //   183: invokestatic 148	lcl:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   186: iconst_m1
    //   187: ireturn
    //   188: iload_2
    //   189: ireturn
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Int = -1;
    if ((this.jdField_a_of_type_Mtq != null) && (this.jdField_a_of_type_AndroidTelephonyTelephonyManager != null)) {
      this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtq, 0);
    }
    ...
    this.jdField_a_of_type_JavaLangString = "";
    lcl.c("SignalStrengthReport", "report stop");
  }
  ...
  public int c()
  {
    ...
    {
      lcl.c("SignalStrengthReport", "getWifiLevelPercent e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  public int d()
  {
    ...
    {
      lcl.c("SignalStrengthReport", "getWifiDbm e:" + localException);
    }
    return -1;
  }
}
