...
public final class aqkv
  extends Animation
{
  static final WeakHashMap<View, aqkv> jdField_a_of_type_JavaUtilWeakHashMap;
  ...
  public static aqkv a(View paramView)
  {
    aqkv localaqkv2 = (aqkv)jdField_a_of_type_JavaUtilWeakHashMap.get(paramView);
    aqkv localaqkv1;
    if (localaqkv2 != null)
    {
      localaqkv1 = localaqkv2;
      if (localaqkv2 == paramView.getAnimation()) {}
    }
    else
    {
      localaqkv1 = new aqkv(paramView);
      jdField_a_of_type_JavaUtilWeakHashMap.put(paramView, localaqkv1);
    }
    return localaqkv1;
  }
