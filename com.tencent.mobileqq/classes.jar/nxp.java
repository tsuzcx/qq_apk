...
public class nxp
  extends osp
{
  public nxp(ReadinjoyJumpActivity paramReadinjoyJumpActivity) {}
    ...
    if ((paramBoolean) && (paramList1 != null) && (!paramList1.isEmpty()))
    {
      ...
      while (i < paramList1.size())
      {
        ...
        if (paramList.mArticleID == ReadinjoyJumpActivity.a(this.a))
        {
          ...
          if ((ont.a(ReadinjoyJumpActivity.a(this.a)) == 0) && (onk.a(ReadinjoyJumpActivity.a(this.a).mArticleContentUrl, 0L, ReadinjoyJumpActivity.a(this.a))))
          {
            paramList = osj.a().a();
            if (paramList != null)
            {
