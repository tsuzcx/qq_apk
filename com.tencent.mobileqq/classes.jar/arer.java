  ...
  implements arej
{
  ...
  public arer(String paramString, DynamicPluginManager paramDynamicPluginManager)
  {
  ...
  {
    boolean bool = TextUtils.isEmpty(areq.a().a());
    if (bool) {}
  ...
  public void enter(Context paramContext, long paramLong, Bundle paramBundle, EnterCallback paramEnterCallback)
  {
    ...
    areq.a().a(this.b, this.jdField_a_of_type_ComTencentShadowDynamicHostDynamicPluginManager);
