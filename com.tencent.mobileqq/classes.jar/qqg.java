  ...
  implements skl
{
  ...
  public qqg(ComponentHeaderTopicRecommend paramComponentHeaderTopicRecommend, String paramString, int paramInt)
  {
  ...
  {
    paramView = oyu.k + bhkv.encodeToString(this.jdField_a_of_type_JavaLangString.getBytes(), 0);
