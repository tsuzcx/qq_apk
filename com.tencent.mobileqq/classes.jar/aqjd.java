  ...
  extends ClickableSpan
{
  ...
  aqjd(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (int j = -1; i < paramArrayOfHotWordItem.length; j = k)
      {
        ...
        if (j != str.length())
        {
          ...
          localSpannableStringBuilder.setSpan(new aqjd(paramQQAppInterface, paramArrayOfHotWordItem[i].hotWord), str.length(), k, 33);
          if (paramQQAppInterface != null) {
            bdla.b(paramQQAppInterface, "P_CliOper", "aio_search", "", "aio_hotword", "view_hotword", 0, 0, "", "", paramArrayOfHotWordItem[i].hotWord, "");
          }
        }
        i += 1;
      }
  ...
  private void a(Context paramContext)
  {
    ...
    localbkzi.a(2131697006, 5);
    localbkzi.c(2131690697);
    localbkzi.a(new aqje(this, paramContext, localbkzi));
  ...
  public void onClick(View paramView)
  {
    ...
    bdla.b((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), "P_CliOper", "aio_search", "", "aio_hotword", "click_hotword", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, "");
  }
