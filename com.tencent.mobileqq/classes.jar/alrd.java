...
{
  public alrd(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public void onAnimationEnd(Animator paramAnimator)
  {
    ...
    {
      if (alps.a == 2) {
        this.a.jdField_a_of_type_Bdbf.e();
      }
      this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      if (NewFlowCameraActivity.i(this.a))
      {
        AVCodec.get().retake();
        ykq.c("PTV.NewFlowCameraActivity", "AVCodec.get().retake() by mbRetake flag");
        NewFlowCameraActivity.i(this.a, false);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Altr.u();
      ...
      for (;;)
      {
        ...
        return;
        label235:
        this.a.jdField_a_of_type_Bdbf.c(true);
      }
    }
    if (this.a.f) {
    ...
    int i = AIOUtils.dp2px(59.0F, this.a.getResources());
    ...
    i = AIOUtils.dp2px(84.0F, this.a.getResources());
    paramAnimator.width = i;
    paramAnimator.height = i;
    paramAnimator.addRule(13);
