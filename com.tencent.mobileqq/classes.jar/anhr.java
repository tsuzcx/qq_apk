...
public class anhr
{
  ...
  public static anhr a()
  {
    try
    {
      if (jdField_a_of_type_Anhr == null) {
        jdField_a_of_type_Anhr = new anhr();
      }
      anhr localanhr = jdField_a_of_type_Anhr;
      return localanhr;
    }
    finally {}
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      localankc = (ankc)paramQQAppInterface.getManager(QQManagerFactory.APOOLO_DAO_MANAGER);
      localObject1 = localankc.a(paramSessionInfo);
      ...
      localObject2 = paramQQAppInterface.getMessageFacade().getAllMessages(paramSessionInfo.curFriendUin, paramSessionInfo.curType, null, 5);
    ...
    if (i >= 0)
    {
      ...
      ApolloGameData localApolloGameData = localankc.a(((MessageForApollo)localObject1).gameId);
      if ((localApolloGameData == null) || (!anjy.a("8.4.10", localApolloGameData.minVer, localApolloGameData.maxVer))) {
        break label262;
      }
    }
    label262:
    ...
    do
    {
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = localankc.a(((MessageForApollo)localObject1).gameId);
            } while ((localObject1 != null) && (anjy.a("8.4.10", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
            paramQQAppInterface = ((anch)paramQQAppInterface.getManager(QQManagerFactory.SPRITE_SCRIPT_MANAGER)).a();
      ...
      } while ((!(localMessageRecord instanceof MessageForArkApp)) || ((paramSessionInfo.curType != 0) && (paramSessionInfo.curType != 1) && (paramSessionInfo.curType != 3000)));
