...
public class anhr
{
  ...
  private afdw jdField_a_of_type_Afdw = new anhs(this);
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new anhv(this);
  private Button jdField_a_of_type_AndroidWidgetButton;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private anhw jdField_a_of_type_Anhw;
  private anhz jdField_a_of_type_Anhz;
  ...
  private ArrayList<afds> jdField_a_of_type_JavaUtilArrayList;
  ...
  public anhr(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    Object localObject1 = (anis)this.jdField_a_of_type_JavaUtilList.get(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      localObject2 = (afds)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int);
      ((afds)localObject2).a(((anis)localObject1).a, ((anis)localObject1).b, ((anis)localObject1).c, ((anis)localObject1).f, anjs.a(), null, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      Object localObject3;
      int j;
      if (Boolean.FALSE.equals(this.jdField_b_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)))
      {
        anjv.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ShowView", ((anis)localObject1).a, null, anjv.g, 0, 0);
        ...
        {
          localObject3 = (anjy)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(95);
      ...
      {
        k -= j;
        ((afds)localObject2).setViewRect(((afds)localObject2).descaleRect(new Rect(0, 0, i, k)));
        ((afds)localObject2).setFixSize(i, k);
        ((afds)localObject2).setMaxSize(i, k);
        ((afds)localObject2).a(this.jdField_a_of_type_Afdw);
        QLog.d("ArkAiAppPanel", 2, String.format("ArkAiAppPanel.initArkApp app:%s view%s width:%d height:%d.", new Object[] { ((anis)localObject1).a, ((anis)localObject1).b, Integer.valueOf(i), Integer.valueOf(k) }));
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView.a((afdt)localObject2, null);
  ...
  private void d()
  {
    ...
    for (int i = 0;; i = this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      while ((j < jdField_a_of_type_Int) && (j < i))
      {
        ...
        afds localafds = new afds();
        localafds.a = new ArkAppMessage.Config();
        localafds.a.round = Integer.valueOf(1);
        this.jdField_a_of_type_JavaUtilArrayList.add(localafds);
      ...
      {
        localObject = (afds)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localObject != null) {
          ((afds)localObject).doOnEvent(2);
        }
        i += 1;
      }
    ...
    this.jdField_a_of_type_Anhw.a((List)localObject);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout = ((ArkAppRootLayout)LayoutInflater.from(localContext).inflate(2131559185, null));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView.setCallback(new anht(this));
    ...
    this.jdField_a_of_type_Anhw = new anhw(this, localContext);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Anhw);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new anhu(this));
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        afds localafds = (afds)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localafds != null) {
  ...
  public void a(List<anis> paramList, int paramInt, anhz paramanhz)
  {
    this.jdField_a_of_type_Anhz = paramanhz;
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      {
        anis localanis = (anis)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localanis != null) {
          anjp.a(localanis.a);
        }
        i += 1;
      }
      if (this.jdField_a_of_type_Anhz != null) {
        this.jdField_a_of_type_Anhz.a(this.jdField_a_of_type_JavaUtilList);
      }
