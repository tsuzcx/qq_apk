...
public class aqjw
{
  ...
  public static Bitmap a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, apss paramapss)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramapss, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = anni.a(2131701224);
  ...
  public static String a(AppInterface paramAppInterface, Context paramContext, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = zvc.a(paramContext, str, paramBitmap);
        paramAppInterface = paramContext;
        if (QLog.isColorLevel())
        {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    int i;
    int j;
    if (aqjz.a(paramString) > paramFloat)
    {
    ...
    for (;;)
    {
      if ((i >= paramString.length()) || (aqjz.a(paramString.substring(0, i) + "…") > paramFloat))
      {
  ...
  public static String a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramAppInterface = nlw.a(nmd.a("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", 1007), "cgi.connect.qq.com", str1, str2, null, localHashMap, (Map)localObject1, false);
        localObject2 = paramAppInterface;
        if (paramAppInterface == null) {
          localObject2 = nlw.a("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", "cgi.connect.qq.com", str1, str2, null, localHashMap, (Map)localObject1, true);
        }
        if (QLog.isColorLevel()) {
  ...
  public static ArrayList<aqkh> a(JSONArray paramJSONArray)
  {
    ...
    if (i < j)
    {
      ...
      do
      {
        ...
        localArrayList.add(new aqkh(str));
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, apss paramapss, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    if (paramInt3 == 0)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (aqka)paramJSONArray.next();
        localObject2 = ((aqka)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
        label721:
        if (((Iterator)localObject2).hasNext())
        {
          localObject3 = (aqkb)((Iterator)localObject2).next();
          paramString3.left = (((aqkb)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((aqkb)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
          paramString3.right = (((aqkb)localObject3).jdField_a_of_type_AndroidGraphicsRect.right + paramString2.left - 2);
          paramString3.bottom = (((aqkb)localObject3).jdField_a_of_type_AndroidGraphicsRect.bottom + paramString2.top - 2);
          paramPaint.setColor(((aqka)localObject1).jdField_a_of_type_Int);
          if (!((aqka)localObject1).jdField_b_of_type_Boolean) {
            break label913;
          }
          paramInt1 = 178;
          paramPaint.setAlpha(paramInt1);
          paramPaint.setFakeBoldText(((aqka)localObject1).jdField_a_of_type_Boolean);
          paramString1 = Paint.Align.CENTER;
          if (((aqka)localObject1).c != -1) {
            break label920;
          }
        ...
        {
          label849:
          a(paramCanvas, paramPaint, paramString3, ((aqkb)localObject3).jdField_a_of_type_JavaLangString, paramString1, ((aqka)localObject1).d, ((aqka)localObject1).jdField_b_of_type_Int);
          break label721;
          break;
          label913:
          paramInt1 = 255;
      ...
      if (paramapss != null)
      {
        paramAppInterface = paramapss.a(paramAppInterface.getCurrentAccountUin(), true);
        QLog.i("ConfessShareHelper", 4, "preLoadQQSelfHeaderBitmap " + paramAppInterface);
      }
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130844987))
      {
        ...
        paramContext = a(paramString4, 8.0F) + anni.a(2131701225);
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    aqjx[] arrayOfaqjx = a(paramInt2, paramInt1);
    paramInt2 = arrayOfaqjx.length;
    paramInt1 = 0;
    aqjx localaqjx;
    if (paramInt1 < paramInt2) {
      localaqjx = arrayOfaqjx[paramInt1];
    }
    for (;;)
    {
      try
      {
        localDrawable = paramContext.getResources().getDrawable(localaqjx.jdField_a_of_type_Int);
        if (localaqjx.jdField_a_of_type_Int == 2130844996) {
          break label316;
        }
        if (localaqjx.jdField_a_of_type_Int != 2130844989) {
          break label309;
        }
      }
      ...
      m = (int)(localaqjx.jdField_b_of_type_Int - j * localaqjx.jdField_a_of_type_Float * f1 / 2.0F);
      n = (int)(localaqjx.c * f2 - k * localaqjx.jdField_a_of_type_Float * f1 / 2.0F);
      f3 = localaqjx.jdField_b_of_type_Int;
      localDrawable.setBounds(m, n, (int)(j * localaqjx.jdField_a_of_type_Float * f1 / 2.0F + f3), (int)(f2 * localaqjx.c + k * localaqjx.jdField_a_of_type_Float * f1 / 2.0F));
      if (localaqjx.jdField_a_of_type_Boolean)
      {
  ...
  public static aqjx[] a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      switch (paramInt2)
      {
    ...
    do
    {
      ...
      {
        return new aqjx[0];
        return new aqjx[] { new aqjx(2130844961, 60, 60, true, 0.75F), new aqjx(2130844966, 458, 84, true, 0.75F), new aqjx(2130844967, 142, 250, true, 0.75F), new aqjx(2130844961, 368, 188, true, 0.75F), new aqjx(2130844959, 168, 120, true, 0.75F), new aqjx(2130844992, 120, 40, true, 0.75F), new aqjx(2130844993, 120, 110, true, 0.75F), new aqjx(2130844990, 30, 150, true, 0.75F), new aqjx(2130844990, 180, 200, true, 0.75F), new aqjx(2130844992, 420, 160, true, 0.75F), new aqjx(2130844993, 495, 150, true, 0.75F), new aqjx(2130844989, 257, 82, false, 1.0F) };
        return new aqjx[] { new aqjx(2130844968, 60, 88, true, 0.75F), new aqjx(2130844960, 226, 56, true, 0.75F), new aqjx(2130844967, 480, 140, true, 0.75F), new aqjx(2130844965, 330, 198, true, 0.75F), new aqjx(2130844966, 168, 244, true, 0.75F), new aqjx(2130844992, 300, 50, true, 0.75F), new aqjx(2130844993, 460, 50, true, 0.75F), new aqjx(2130844990, 60, 230, true, 0.75F), new aqjx(2130844992, 120, 120, true, 0.75F), new aqjx(2130844992, 440, 270, true, 0.75F), new aqjx(2130844989, 257, 82, false, 1.0F) };
        return new aqjx[] { new aqjx(2130844961, 174, 58, true, 0.75F), new aqjx(2130844963, 70, 146, true, 0.75F), new aqjx(2130844965, 390, 106, true, 0.75F), new aqjx(2130844960, 206, 240, true, 0.75F), new aqjx(2130844962, 470, 225, true, 0.75F), new aqjx(2130844993, 120, 88, true, 0.75F), new aqjx(2130844993, 480, 70, true, 0.75F), new aqjx(2130844990, 110, 230, true, 0.75F), new aqjx(2130844992, 340, 210, true, 0.75F), new aqjx(2130844989, 257, 82, false, 1.0F) };
        return new aqjx[] { new aqjx(2130844967, 138, 88, true, 0.75F), new aqjx(2130844961, 68, 232, true, 0.75F), new aqjx(2130844965, 298, 206, true, 0.75F), new aqjx(2130844968, 480, 140, true, 0.75F), new aqjx(2130844997, 382, 140, true, 0.75F), new aqjx(2130844992, 60, 90, true, 0.75F), new aqjx(2130844990, 182, 64, true, 0.75F), new aqjx(2130844990, 440, 210, true, 0.75F), new aqjx(2130844992, 440, 30, true, 0.75F), new aqjx(2130844992, 190, 200, true, 0.75F), new aqjx(2130844989, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new aqjx[] { new aqjx(2130844962, 110, 230, true, 1.0F), new aqjx(2130844965, 656, 170, true, 1.0F), new aqjx(2130844960, 516, 350, true, 1.0F), new aqjx(2130844961, 84, 550, true, 1.0F), new aqjx(2130844966, 656, 586, true, 1.0F), new aqjx(2130844961, 526, 735, true, 1.0F), new aqjx(2130844967, 198, 830, true, 1.0F), new aqjx(2130844963, 70, 1016, true, 1.0F), new aqjx(2130844965, 397, 952, true, 1.0F), new aqjx(2130844968, 670, 880, true, 1.0F), new aqjx(2130844960, 220, 1257, true, 1.0F), new aqjx(2130844964, 606, 1220, true, 1.0F), new aqjx(2130844997, 452, 475, true, 1.0F), new aqjx(2130844959, 240, 645, true, 1.0F), new aqjx(2130844990, 160, 300, true, 1.0F), new aqjx(2130844993, 660, 330, true, 1.0F), new aqjx(2130844991, 620, 450, true, 1.0F), new aqjx(2130844992, 175, 500, true, 1.0F), new aqjx(2130844992, 460, 570, true, 1.0F), new aqjx(2130844993, 180, 630, true, 1.0F), new aqjx(2130844990, 40, 690, true, 1.0F), new aqjx(2130844990, 260, 750, true, 1.0F), new aqjx(2130844993, 710, 600, true, 1.0F), new aqjx(2130844992, 600, 710, true, 1.0F), new aqjx(2130844992, 140, 970, true, 1.0F), new aqjx(2130844990, 85, 1200, true, 1.0F), new aqjx(2130844990, 600, 1050, true, 1.0F), new aqjx(2130844993, 420, 1100, true, 1.0F), new aqjx(2130844992, 540, 1250, true, 1.0F), new aqjx(2130844996, 375, 134, false, 1.0F) };
      return new aqjx[] { new aqjx(2130844965, 110, 368, true, 1.0F), new aqjx(2130844966, 570, 256, true, 1.0F), new aqjx(2130844961, 655, 475, true, 1.0F), new aqjx(2130844968, 75, 740, true, 1.0F), new aqjx(2130844960, 320, 686, true, 1.0F), new aqjx(2130844967, 670, 832, true, 1.0F), new aqjx(2130844965, 505, 955, true, 1.0F), new aqjx(2130844966, 260, 1020, true, 1.0F), new aqjx(2130844964, 75, 1216, true, 1.0F), new aqjx(2130844960, 565, 1235, true, 1.0F), new aqjx(2130844997, 430, 355, true, 1.0F), new aqjx(2130844959, 110, 174, true, 1.0F), new aqjx(2130844990, 140, 250, true, 1.0F), new aqjx(2130844993, 640, 195, true, 1.0F), new aqjx(2130844990, 170, 450, true, 1.0F), new aqjx(2130844992, 490, 1220, true, 1.0F), new aqjx(2130844991, 350, 520, true, 1.0F), new aqjx(2130844991, 630, 410, true, 1.0F), new aqjx(2130844993, 60, 500, true, 1.0F), new aqjx(2130844993, 680, 655, true, 1.0F), new aqjx(2130844993, 310, 1110, true, 1.0F), new aqjx(2130844992, 470, 660, true, 1.0F), new aqjx(2130844992, 190, 780, true, 1.0F), new aqjx(2130844992, 680, 1060, true, 1.0F), new aqjx(2130844990, 180, 1230, true, 1.0F), new aqjx(2130844996, 375, 134, false, 1.0F) };
      return new aqjx[] { new aqjx(2130844961, 110, 220, true, 1.0F), new aqjx(2130844967, 654, 240, true, 1.0F), new aqjx(2130844965, 562, 482, true, 1.0F), new aqjx(2130844963, 95, 537, true, 1.0F), new aqjx(2130844960, 295, 672, true, 1.0F), new aqjx(2130844962, 683, 660, true, 1.0F), new aqjx(2130844964, 60, 850, true, 1.0F), new aqjx(2130844966, 442, 872, true, 1.0F), new aqjx(2130844960, 114, 1046, true, 1.0F), new aqjx(2130844961, 680, 950, true, 1.0F), new aqjx(2130844966, 230, 1197, true, 1.0F), new aqjx(2130844968, 480, 1260, true, 1.0F), new aqjx(2130844997, 670, 1200, true, 1.0F), new aqjx(2130844990, 140, 630, true, 1.0F), new aqjx(2130844990, 500, 960, true, 1.0F), new aqjx(2130844990, 330, 1050, true, 1.0F), new aqjx(2130844990, 50, 1150, true, 1.0F), new aqjx(2130844991, 290, 430, true, 1.0F), new aqjx(2130844991, 330, 760, true, 1.0F), new aqjx(2130844992, 60, 310, true, 1.0F), new aqjx(2130844992, 480, 580, true, 1.0F), new aqjx(2130844992, 220, 820, true, 1.0F), new aqjx(2130844993, 600, 150, true, 1.0F), new aqjx(2130844993, 700, 410, true, 1.0F), new aqjx(2130844993, 25, 900, true, 1.0F), new aqjx(2130844993, 150, 430, true, 1.0F), new aqjx(2130844996, 375, 134, false, 1.0F) };
      return new aqjx[] { new aqjx(2130844961, 104, 278, true, 1.0F), new aqjx(2130844964, 588, 200, true, 1.0F), new aqjx(2130844960, 690, 390, true, 1.0F), new aqjx(2130844963, 420, 534, true, 1.0F), new aqjx(2130844962, 92, 592, true, 1.0F), new aqjx(2130844966, 660, 624, true, 1.0F), new aqjx(2130844961, 475, 735, true, 1.0F), new aqjx(2130844967, 192, 818, true, 1.0F), new aqjx(2130844968, 696, 880, true, 1.0F), new aqjx(2130844965, 430, 990, true, 1.0F), new aqjx(2130844960, 64, 1034, true, 1.0F), new aqjx(2130844960, 272, 1250, true, 1.0F), new aqjx(2130844964, 584, 1205, true, 1.0F), new aqjx(2130844959, 254, 638, true, 1.0F), new aqjx(2130844990, 200, 320, true, 1.0F), new aqjx(2130844990, 260, 780, true, 1.0F), new aqjx(2130844990, 620, 1000, true, 1.0F), new aqjx(2130844990, 150, 1250, true, 1.0F), new aqjx(2130844991, 70, 420, true, 1.0F), new aqjx(2130844991, 460, 590, true, 1.0F), new aqjx(2130844991, 630, 450, true, 1.0F), new aqjx(2130844992, 70, 800, true, 1.0F), new aqjx(2130844992, 280, 980, true, 1.0F), new aqjx(2130844992, 610, 720, true, 1.0F), new aqjx(2130844992, 480, 1220, true, 1.0F), new aqjx(2130844993, 170, 590, true, 1.0F), new aqjx(2130844993, 330, 1160, true, 1.0F), new aqjx(2130844993, 700, 680, true, 1.0F), new aqjx(2130844993, 660, 290, true, 1.0F), new aqjx(2130844996, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new aqjx[] { new aqjx(2130844962, 110, 310, true, 1.0F), new aqjx(2130844965, 650, 216, true, 1.0F), new aqjx(2130844960, 516, 350, true, 1.0F), new aqjx(2130844962, 92, 592, true, 1.0F), new aqjx(2130844966, 656, 586, true, 1.0F), new aqjx(2130844961, 470, 716, true, 1.0F), new aqjx(2130844967, 198, 830, true, 1.0F), new aqjx(2130844968, 670, 980, true, 1.0F), new aqjx(2130844965, 397, 1060, true, 1.0F), new aqjx(2130844963, 70, 1016, true, 1.0F), new aqjx(2130844990, 200, 320, true, 1.0F), new aqjx(2130844959, 240, 438, true, 1.0F), new aqjx(2130844997, 452, 475, true, 0.75F), new aqjx(2130844990, 200, 600, true, 1.0F), new aqjx(2130844990, 1000, 620, true, 1.0F), new aqjx(2130844991, 70, 420, true, 1.0F) };
  }
  
  public static Bitmap b(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, apss paramapss)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() < 1) || (paramContext == null))
    {
      paramAppInterface = null;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          try
          {
            ...
            localPaint.setColor(-1);
            a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, null, paramString2, paramString3, paramJSONArray, paramapss, i, j, 5, 5, str, localCanvas, localPaint);
            localPaint.setAlpha(255);
            localPaint.setColor(-1);
            return paramString1;
          }
