  ...
  extends QIPCModule
{
  ...
  private akym jdField_a_of_type_Akym = new akym();
  ...
  public akvv(String paramString)
  {
    super(paramString);
  }
  ...
  public static void b()
  {
    ...
    {
      QIPCServerHelper.getInstance().register(localakvv);
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Akym != null) {
      return this.jdField_a_of_type_Akym.a();
    }
  ...
  {
    if (this.jdField_a_of_type_Akym != null) {
      return this.jdField_a_of_type_Akym.a(paramInt);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Akym != null)
    {
      List localList = this.jdField_a_of_type_Akym.a();
      if (localList != null)
      {
        int i = 0;
        while (i < localList.size())
        {
          akyl localakyl = (akyl)localList.get(i);
          if ((localakyl != null) && (!akwd.a(localakyl.a())) && (!akwd.a(localakyl.a())))
          {
            akvt.a(localakyl.a());
            QLog.i("cmgame_process.CmGameServerQIPCModule", 1, "closeAllGame gameId:" + localakyl.a());
          }
          i += 1;
        }
      }
  ...
  public void a(CmGameStartChecker.StartCheckParam paramStartCheckParam, long paramLong, CmGameInitParams paramCmGameInitParams)
  {
    ...
    this.c = true;
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (akwd.a(BaseApplicationImpl.getContext())))
    {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      QIPCServerHelper.getInstance().callClient(LocalMultiProcConfig.PROCESS_NAME, "cm_game_client_module", "action_dress_changed", (Bundle)localObject, new akwb(this));
      return;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      if ("action_aduio_query_voice_status".equals(paramString))
      {
        ...
        paramBundle = (aknx)((QQAppInterface)localObject1).getManager(153);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putBoolean("isOpen", paramBundle.a().a(paramString));
        ((Bundle)localObject1).putBoolean("display", akuq.b);
      ...
      {
        paramString = paramBundle.getString("key_game_friUin");
        ((aknx)((QQAppInterface)localObject1).getManager(153)).a().c(paramString, 318);
      }
    }
    ...
    if ("action_aduio_enter_room".equals(paramString))
    {
      ...
      paramBundle = ((aknx)((QQAppInterface)localObject1).getManager(153)).a();
      if ((bool) || ((akuq.jdField_a_of_type_Boolean) && (!paramBundle.b()))) {
    ...
    {
      paramString = paramBundle.getString("key_game_friUin");
      ((aknx)((QQAppInterface)localObject1).getManager(153)).a().a(paramString, 318);
    }
    ...
    else if ("action_loadyoutu".equals(paramString))
    {
      ...
      if ((paramString != null) && ((paramString instanceof QQAppInterface)))
      {
        ...
        b = true;
        paramString.a(new akvw(this, paramInt));
        paramString.a();
        break label2270;
      }
    }
    else
    {
      ...
      if ("game_activity_lifecycle".equals(paramString))
      {
        ...
        if ((paramString != null) && ((paramString instanceof CmGameStartChecker.StartCheckParam)))
        {
          ...
          this.jdField_a_of_type_Akym.a(paramInt, i, j, paramString);
          break label2270;
        }
      }
    ...
    while (paramString != null)
    {
      ...
      if ("action_update_game_push".equals(paramString))
      {
        ...
        paramString = (QQAppInterface)akwd.a();
        if (paramString == null) {
          return null;
        }
        paramBundle = (CmGamePushItem)paramBundle.getSerializable("CmGamePushItem");
        if (paramBundle != null) {
          ((aknx)paramString.getManager(153)).a().a(paramBundle);
        }
      }
      ...
      {
        if ((localObject1 instanceof QQAppInterface)) {
          algj.a((QQAppInterface)localObject1);
        }
        paramString = new Bundle();
        paramString.putString("sApolloBaseScriptId", aliu.au);
        paramString.putBoolean("sDisableCreateRenderThread", aknx.q);
      ...
      else
      {
        ...
        if ("action_init_cmshow_data".equals(paramString))
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            Object localObject3 = (aknx)((QQAppInterface)localObject1).getManager(153);
            localObject1 = (bdug)((QQAppInterface)localObject1).a(71);
            localObject2 = ((aknx)localObject3).b(paramString);
            ApolloBaseInfo localApolloBaseInfo = ((aknx)localObject3).b(paramBundle);
            ...
            if (!((List)localObject3).isEmpty())
            {
              ...
              ((bdug)localObject1).a(new akvx(this, (List)localObject3, paramString, paramBundle, paramInt));
              ((bdug)localObject1).a((String[])localObject2);
            }
            else
            {
              i = aknx.a(ApolloUtil.a(), paramString, true);
              j = aknx.a(ApolloUtil.a(), paramBundle, true);
              paramString = new Bundle();
        ...
        else if ("action_render_view_preload_res".equals(paramString))
        {
          ...
          else
          {
            ...
            {
              localObject1 = albi.a(ApolloUtil.a(), paramString[i]);
              localObject2 = new alec(3, paramString[i]);
              ((alec)localObject2).c = ((ApolloActionData)localObject1).actionType;
              paramBundle.add(localObject2);
              i += 1;
            }
            aldv.a(ApolloUtil.a(), "", new akvz(this, paramInt), paramBundle, false);
          }
        }
        else if ("action_cmshow_tracereport".equals(paramString))
        {
          alhy.a(paramBundle.getString("action"), paramBundle.getBundle("bundle"));
        }
        else
        {
          ...
          if ("action_render_view_change_mode".equals(paramString))
          {
            ...
            paramString = (bdug)((QQAppInterface)localObject1).a(71);
            paramString.a(new akwa(this, paramString, paramInt));
            if (i == 2) {}
