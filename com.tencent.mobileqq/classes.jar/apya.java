  ...
  extends apxy
{
  ...
  public static apxy a(JSONObject paramJSONObject)
  {
    ...
    localapya.jdField_a_of_type_JavaLangString = paramJSONObject.optString("align");
    localapya.d = (bggq.c(localContext, paramJSONObject.optInt("text_size") / 2) + 1);
    localapya.jdField_c_of_type_JavaLangString = paramJSONObject.optString("text_align");
    ...
    try
    {
      localapya.jdField_c_of_type_Int = Color.parseColor("#" + (String)localObject);
      if (paramJSONObject.has("rect"))
      {
        localObject = paramJSONObject.optJSONArray("rect");
        localapya.jdField_a_of_type_ArrayOfInt = new int[4];
        int i = 0;
        while (i < ((JSONArray)localObject).length())
        {
          localapya.jdField_a_of_type_ArrayOfInt[i] = bggq.a(localContext, ((JSONArray)localObject).optInt(i) / 2);
          i += 1;
        }
      }
    }
    catch (Exception localException)
    {
      ...
      localapya.e = paramJSONObject.optInt("text_max_count");
      if (QLog.isColorLevel()) {
  ...
  @TargetApi(11)
  public Rect a(apym paramapym, Canvas paramCanvas, Paint paramPaint)
  {
    float f1 = 0.0F;
    paramCanvas = paramapym.getBounds();
    Object localObject = BaseApplicationImpl.getContext().getResources();
    if (b == -1) {
      b = afur.a(48.0F, (Resources)localObject);
    }
    float f4 = 1.0F;
    ...
    {
      i = afur.a(2.0F, (Resources)localObject);
      int j = afur.a(9.0F, (Resources)localObject);
      int k = afur.a(7.0F, (Resources)localObject);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_JavaLangString.endsWith("L"))
        {
          ...
          localObject = apwr.a().a(paramapym, paramapym.jdField_a_of_type_JavaLangString);
          Paint.FontMetrics localFontMetrics = paramPaint.getFontMetrics();
          f4 = apxy.a(paramPaint, (String)localObject);
  ...
  public void a(apym paramapym, Canvas paramCanvas)
  {
    ...
    {
      return;
      str = apwr.a().a(paramapym, paramapym.jdField_a_of_type_JavaLangString);
    ...
    paramapym = a(paramapym, paramCanvas, localPaint);
    paramCanvas.drawText(str, paramapym.left, paramapym.top, localPaint);
  }
}
