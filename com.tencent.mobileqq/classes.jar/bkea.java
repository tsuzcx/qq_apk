...
public class bkea
  implements bkaw<bkav>
{
  private final int jdField_a_of_type_Int = bkht.a(DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  private bkea(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bkav parambkav, MotionEvent paramMotionEvent)
  {
    boolean bool = true;
    if ((parambkav instanceof bjzt)) {
      localRect = new Rect();
    }
    for (Rect localRect = ((bjzt)parambkav).a(localRect);; localRect = null)
    {
      if (bkur.b()) {}
      for (float f1 = bkur.e;; f1 = 0.0F)
      {
        ...
        case 6: 
          do
          {
            ...
            parambkav = this.jdField_a_of_type_AndroidGraphicsRect;
            parambkav.top -= this.jdField_a_of_type_Int;
            parambkav = this.jdField_a_of_type_AndroidGraphicsRect;
            parambkav.bottom += this.jdField_a_of_type_Int;
        ...
        if ((this.jdField_a_of_type_AndroidGraphicsRect != null) && ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.e())))
        {
          ...
          if ((DoodleLayout.e(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) && ((this.jdField_a_of_type_AndroidGraphicsRect.contains(i + j, k + m)) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(f1, f3, localRect, f2))))
          {
            if ((parambkav instanceof bjzt))
            {
              veg.b("DoodleLayout", "remove face.");
              ((bjzt)parambkav).c();
          ...
          {
            label710:
            if ((!DoodleLayout.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) || (DoodleLayout.c(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) || (!(parambkav instanceof bjzr))) {
              break label1149;
            }
            parambkav = (bjzr)parambkav;
            paramMotionEvent = parambkav.jdField_a_of_type_Bjzx;
            if ((!parambkav.jdField_a_of_type_Bkhv.a(paramMotionEvent, f1, f3, false)) || (parambkav.jdField_a_of_type_Boolean) || (!paramMotionEvent.b) || (paramMotionEvent.c)) {
              break label1149;
            }
        ...
        for (i = 1;; i = 0)
        {
          ...
          for (;;)
          {
            ...
            this.b = false;
            return false;
            if ((parambkav instanceof bkaj))
            {
              veg.b("DoodleLayout", "editpic remove text.");
              ((bkaj)parambkav).h();
              parambkav.d(false);
              break;
            }
            if (!(parambkav instanceof bkah)) {
              break;
            }
            paramMotionEvent = ((bkah)parambkav).a();
            ...
            if ((parambkav instanceof bkaj))
            {
              veg.b("DoodleLayout", "remove text.");
              ((bkaj)parambkav).h();
              parambkav.d(false);
            }
            for (;;)
            {
              ...
              else if ((parambkav instanceof bkah))
              {
                paramMotionEvent = ((bkah)parambkav).a();
                DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout, paramMotionEvent);
                this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setTrackerState(((bkah)parambkav).a(), 0);
                ((bkah)parambkav).c();
              }
            }
