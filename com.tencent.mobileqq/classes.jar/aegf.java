...
{
  public aegf(ShowReactiveActivity paramShowReactiveActivity) {}
  ...
  public void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      ...
      {
        localObject = ((amsw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  public void onSetCalReactiveDays(boolean paramBoolean)
  {
    ...
    {
      localObject1 = ((amsw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
      localObject2 = this.a;
      localSwitch = this.a.a.a();
