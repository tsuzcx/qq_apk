  ...
  implements atxi
{
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Atxw.jdField_a_of_type_ArrayOfJavaLangString == null)
    {
      this.jdField_a_of_type_Boolean = true;
      return this.jdField_a_of_type_Atxw.jdField_a_of_type_JavaLangString;
    }
    int i = this.jdField_a_of_type_Int + 1;
    if (i >= this.jdField_a_of_type_Atxw.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      atxw localatxw = this.jdField_a_of_type_Atxw;
      localatxw.jdField_a_of_type_Int -= 1;
      if (this.jdField_a_of_type_Atxw.jdField_a_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Boolean = true;
        return this.jdField_a_of_type_Atxw.jdField_a_of_type_JavaLangString;
      }
      ...
      return this.jdField_a_of_type_Atxw.jdField_a_of_type_ArrayOfJavaLangString[(i + 1)];
    }
    return this.jdField_a_of_type_Atxw.jdField_a_of_type_ArrayOfJavaLangString[i];
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Atxw == null) {
  ...
  public void a(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Atxw.jdField_a_of_type_Atxj != null) {
      this.jdField_a_of_type_Atxw.jdField_a_of_type_Atxj.a((Bitmap)paramMessage.obj);
    }
    this.jdField_a_of_type_Int += 1;
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 5, null, true);
  }
  
  public void a(atxw paramatxw)
  {
    this.jdField_a_of_type_Atxw = paramatxw;
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Atxw != null) {
      this.jdField_a_of_type_Atxw.jdField_a_of_type_JavaLangString = paramString;
    }
  }
