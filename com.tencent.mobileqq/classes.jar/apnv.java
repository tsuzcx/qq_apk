...
public class apnv
  extends xaw
{
  public apnv(TroopFileModel.15 param15) {}
  ...
  {
    paramByteStringMicro1 = apue.a(paramByteStringMicro1);
    paramString2 = null;
    ...
    if (paramBoolean)
    {
      ...
      if (!TextUtils.isEmpty(paramByteStringMicro1))
      {
        ...
        paramString1 = "http://" + paramString3 + ":" + paramInt3 + "/ftn_compress_getfile/rkey=" + paramByteStringMicro1 + "&filetype=" + paramInt1 + "&path=" + bfng.a(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.zipInnerPath) + "&";
      }
    }
    if (!TextUtils.isEmpty(paramString1))
    {
      if (this.a.jdField_a_of_type_Apmz != null) {
        this.a.jdField_a_of_type_Apmz.a(paramString1, paramString4);
      }
      ...
      if (this.a.this$0.a.a() != null)
      {
        ...
        paramString2 = apue.b(this.a.this$0.a.a().nFileType);
        label269:
        axqw.b(null, "dc00899", "Grp_files", "", "oper", "Clk_pre_video", 0, 0, paramString1, "", paramString2, "1");
      }
    }
    label299:
    do
    {
      ...
      break label269;
      if (this.a.jdField_a_of_type_Apmz != null) {
        this.a.jdField_a_of_type_Apmz.c();
      }
