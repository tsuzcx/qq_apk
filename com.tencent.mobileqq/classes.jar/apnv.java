...
public class apnv
  extends apmi<CameraEmotionData>
{
  private boolean a;
  private boolean b;
  ...
  private CameraEmotionData a(alpi paramalpi, int paramInt)
  {
    if ((paramalpi == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return null;
    }
    ...
    localCameraEmotionData.resid = paramalpi.a;
    localCameraEmotionData.strContext = paramalpi.b;
    localCameraEmotionData.templateId = paramalpi.e;
    if (bdnn.a(paramalpi.d)) {}
    for (localCameraEmotionData.md5 = apnl.a(paramalpi.a);; localCameraEmotionData.md5 = paramalpi.d)
    {
      localCameraEmotionData.url = paramalpi.jdField_c_of_type_JavaLangString;
  ...
  public apuf a(CameraEmotionData paramCameraEmotionData)
  {
    aptr localaptr = new aptr();
    localaptr.jdField_c_of_type_Int = 11;
    localaptr.e = a(paramCameraEmotionData);
    localaptr.a = paramCameraEmotionData.strContext;
    localaptr.jdField_c_of_type_JavaLangString = paramCameraEmotionData.templateId;
    localaptr.f = paramCameraEmotionData.url;
    localaptr.jdField_g_of_type_Int = paramCameraEmotionData.emoId;
    localaptr.d = paramCameraEmotionData.resid;
    localaptr.h = paramCameraEmotionData.RomaingType;
    localaptr.b = paramCameraEmotionData.thumbPath;
    localaptr.jdField_g_of_type_JavaLangString = paramCameraEmotionData.resid;
    return localaptr;
  }
  ...
  public String a(CameraEmotionData paramCameraEmotionData)
  {
    ...
    if (TextUtils.isEmpty(str2))
    {
      ...
      str1 = apnl.a(paramCameraEmotionData.resid);
    }
    return apnl.a(str1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  }
  ...
  public List<CameraEmotionData> a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        {
          localObject2 = ((awgf)localObject3).a(a(), false, null, null, null, null, null, null);
          ...
          if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              if (this.jdField_a_of_type_Boolean) {
                azri.a(BaseApplication.getContext()).a("", "CameraEmoDBError", true, 0L, 0L, null, "");
              }
            }
          }
          break;
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      agyv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).g();
    }
  }
  ...
  public void a(List<alpi> paramList, List<String> paramList1, List<String> paramList2)
  {
    int k = 0;
    ...
    if (((List)localObject2).size() < paramList.size())
    {
      ...
      while (paramList1.hasNext()) {
        paramList.remove((alpi)paramList1.next());
      }
    }
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            paramList2 = (alpi)paramList.next();
            j += 1;
  ...
  public void b()
  {
    if (!this.b)
    {
      ...
      azri.a(BaseApplication.getContext()).a(null, "CamEmoUpload", false, 0L, 0L, localHashMap, null);
    }
  }
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          else
          {
            aptr localaptr = new aptr();
            localaptr.jdField_c_of_type_Int = 11;
            localaptr.e = a(localCameraEmotionData);
            localaptr.a = localCameraEmotionData.strContext;
            localaptr.jdField_c_of_type_JavaLangString = localCameraEmotionData.templateId;
            localaptr.f = localCameraEmotionData.url;
            localaptr.jdField_g_of_type_Int = localCameraEmotionData.emoId;
            localaptr.d = localCameraEmotionData.resid;
            localaptr.h = localCameraEmotionData.RomaingType;
            localaptr.b = localCameraEmotionData.thumbPath;
            localaptr.jdField_g_of_type_JavaLangString = localCameraEmotionData.resid;
            localArrayList.add(localaptr);
          }
        }
      }
      catch (OutOfMemoryError localOutOfMemoryError)
