...
public class acjz
{
  public static acju a(@NonNull Activity paramActivity, int paramInt, String paramString)
  {
    return a(paramActivity, paramInt, paramString, null);
  }
  
  public static acju a(@NonNull Activity paramActivity, int paramInt, String paramString, Bundle paramBundle)
  {
    String str = null;
    ackb localackb = null;
    ...
    Object localObject = localackb;
    switch (paramInt)
    {
    default: 
      localObject = localackb;
    case 2: 
    case 0: 
    case 1: 
    case 3: 
    ...
    case 5: 
      while (localObject == null)
      {
        ...
        localObject = new aclu(paramActivity, paramInt, paramString, paramBundle);
        continue;
        localackb = new ackb(paramActivity, paramInt, paramString);
        if (paramBundle == null) {
          break label305;
        }
    ...
    for (;;)
    {
      ((ackb)localackb).a((String)localObject, paramBundle, paramActivity);
      localObject = localackb;
      break;
      localObject = new ackr(paramActivity, paramInt, paramString);
      break;
      ((acju)localObject).a();
      return localObject;
      label305:
