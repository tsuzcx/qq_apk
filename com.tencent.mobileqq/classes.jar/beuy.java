  ...
  extends behn
{
  ...
  private beuv jdField_a_of_type_Beuv;
  private beux jdField_a_of_type_Beux;
  private final beyu jdField_a_of_type_Beyu = new beyu();
  private final FPSCallback jdField_a_of_type_ComTencentMobileqqTritonSdkFPSCallback = new beuz(this);
  private ITTEngine jdField_a_of_type_ComTencentMobileqqTritonSdkITTEngine;
  private MiniAppInfo jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, beuw> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public beuy()
  {
    this.jdField_a_of_type_Besl = new besl();
  }
  ...
  private void a(ITTEngine paramITTEngine, IJSEngine paramIJSEngine)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTritonSdkITTEngine.addGameLifeCycle(new beuu(this));
    ...
    this.jdField_a_of_type_ComTencentMobileqqTritonSdkITTEngine.setEngineListener(new beva(this));
    boolean bool = bema.a("MiniGame", "MiniGameCodeCacheEnable", true);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqTritonSdkITTEngine != null)
    {
      ...
      if ((this.jdField_c_of_type_Boolean) && (l > 0L))
      {
        ...
        if (l > 0L)
        {
          ...
          bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 1018, null, null, null, 0, "1", l, null);
          betc.d("GameRuntime", "doOnPause blackTimeDuration " + l);
        }
      }
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Long > 0L))
      {
        this.jdField_b_of_type_Boolean = false;
        bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 1016, "1");
        l = System.currentTimeMillis() - this.jdField_a_of_type_Long;
        if (l > 0L) {
          bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 1020, null, null, null, 0, "1", l, null);
        }
      }
      l = System.currentTimeMillis() - this.jdField_a_of_type_Long;
      if ((l > 0L) && (this.jdField_a_of_type_Long > 0L)) {
        bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 1021, null, null, null, 0, "1", l, null);
      }
    ...
    label267:
    for (long l = beix.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo.appId);; l = -1L)
    {
      if ((l >= 0L) && (!jdField_a_of_type_Boolean))
      {
        jdField_a_of_type_Boolean = true;
        bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 639, null, String.valueOf(l), null, 1, "1", 0L, null);
      }
      bezl.a();
      return;
      l = 0L;
  ...
  private void i()
  {
    bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 22, "1");
    bezl.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, "1", null, "unload", null);
    beyq.a("2unload", null, null, this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
    bezl.a();
  }
  
  private void j()
  {
    if (bema.a("MiniGame", "MiniGameKillAllGamesWhenDestroy", 0) != 1)
    {
    ...
    betc.b("GameRuntime", "[MiniEng]doOnDestroy killProcess");
  ...
  private void k()
  {
    ...
    try
    {
      a().getApplicationContext().registerComponentCallbacks(new bevb(this));
      return;
    }
  ...
  public behs a()
  {
    return this.jdField_a_of_type_Beux;
  }
  
  public beuw a(int paramInt)
  {
    beuw localbeuw = (beuw)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localbeuw != null) {
      return localbeuw;
    }
    try
    {
      localbeuw = new beuw(this.jdField_a_of_type_ComTencentMobileqqTritonSdkITTEngine.getJsRuntime(paramInt), paramInt);
      this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), localbeuw);
      return localbeuw;
    }
    finally {}
  }
  ...
  {
    return this.jdField_a_of_type_Beuv.a();
  }
  
  public CapsuleButton a()
  {
    return this.jdField_a_of_type_Beux.a();
  }
  ...
  {
    this.jdField_a_of_type_Beux.a(paramActivity);
  ...
  public void a(Activity paramActivity, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Beux.a(paramActivity, paramViewGroup);
  }
  ...
  public void a(ITTEngine paramITTEngine)
  {
    ...
    k();
    this.jdField_a_of_type_Beuv = new beuv(this);
    a(paramITTEngine, this.jdField_a_of_type_Beuv);
    long l2 = System.currentTimeMillis();
    bezi.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 1038, null, null, null, 0, "1", l2 - l1, null);
    this.jdField_a_of_type_Beux = new beux(paramITTEngine);
    this.jdField_a_of_type_Beux.a(this);
  }
  ...
  public void a(MiniAppInfo paramMiniAppInfo, String paramString)
  {
    ...
    paramMiniAppInfo = (bekp)paramMiniAppInfo.apkgInfo;
    paramMiniAppInfo.a = new berl();
    paramMiniAppInfo.a.a = new besa();
  ...
  public void a(MiniAppInfo paramMiniAppInfo, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Beux.b(paramMiniAppInfo);
    this.jdField_a_of_type_Beuv.a();
    this.jdField_a_of_type_Beyu.b();
  ...
  {
    this.jdField_a_of_type_Beuv.onCreate(a());
    this.jdField_a_of_type_Beux.a(paramMiniAppInfo);
    this.jdField_a_of_type_Beyu.a(paramMiniAppInfo);
  }
  ...
  public void c()
  {
    try
    {
      ...
      this.jdField_a_of_type_Beux.a();
      this.jdField_a_of_type_Beuv.b();
      this.e = false;
      this.jdField_a_of_type_Beyu.c();
      g();
      return;
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        betc.d("GameRuntime", "doOnPause reportOnPause ", localThrowable);
      }
    }
  }
  ...
  public boolean d()
  {
    return this.jdField_a_of_type_Beux.b();
  }
  
  public void e()
  {
    if (beqf.a().a() != null) {
      beqf.a().a().notifyRuntimeEvent(64, new Object[0]);
    }
    j();
    this.jdField_a_of_type_Beux.b();
    this.jdField_a_of_type_Beuv.onDestroy();
    i();
  }
  ...
  public void f()
  {
    ...
    if (!this.e)
    {
      bezl.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, "1", null, "load_fail", "not_foreground");
      beyq.a("2launch_fail", "not_foreground", null, this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
      betc.d("GameRuntime", "not in forground, donot lauchGame");
      return;
    }
