  ...
  implements ygp
{
  ...
  private float a()
  {
    return this.jdField_e_of_type_Int / this.jdField_d_of_type_Int;
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView = ((VideoPlayerView)paramView.findViewById(2131380047));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131369650);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131369280);
    ...
    this.jdField_a_of_type_Bhzf = new bhzf(a(), new yau(this, null));
  ...
  {
    if (bdje.a(paramStFeed.video.fileId.get())) {
      QLog.w(jdField_a_of_type_JavaLangString, 1, "video fileId is empty");
    }
    do
    {
      return;
      if (bdje.a(paramStFeed.video.playUrl.get()))
      {
  ...
  private void q()
  {
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new yao(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setPreviewVideoClickListener(new yap(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setNextVideoClickListener(new yaq(this));
    if (a() != null) {
      a().a(new yar(this));
    }
    a().addOnItemTouchListener(new yas(this));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setOnTouchListener(new yat(this));
  }
  ...
  private void s()
  {
    ...
    this.jdField_e_of_type_Int = this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.video.height.get();
    QLog.i(jdField_a_of_type_JavaLangString, 1, "resetVideoHW width:" + this.jdField_d_of_type_Int + ", height:" + this.jdField_e_of_type_Int);
    if (this.jdField_d_of_type_Int <= 0)
    {
      this.jdField_d_of_type_Int = 1920;
      this.jdField_e_of_type_Int = 1080;
    }
  ...
  public xzz a()
  {
    return (xzz)a().a("RELATIVE_ADAPTER_UNIQUE_KEY");
  }
  ...
  protected void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (xxk.a(paramStGetFeedDetailRsp.type.get())))
    {
      ...
      if ((this.jdField_c_of_type_AndroidWidgetImageView != null) && (Build.VERSION.SDK_INT > 20) && (this.jdField_d_of_type_Boolean)) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((!azib.b()) && (this.jdField_a_of_type_ComTencentWidgetImmersiveSystemBarCompact != null)) {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView = ((SubscribeFollowInfoView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369597));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368698));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368885));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368932));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368756));
    if (a() != null)
    {
      bngs.a(a());
      bngs.c(a());
    }
    if ((Build.VERSION.SDK_INT <= 20) || (!this.jdField_d_of_type_Boolean)) {
      this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    }
  ...
  {
    if (("share_key_continue_feeds".equals(paramString)) && (paramydw != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)) {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setContinueFeeds((List)paramydw.a);
    }
  }
  ...
  public void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      ...
      yvu.a(paramStFeed.poster.id.get(), "auth_" + yjq.a(a()), "clk_recom", 0, 0, new String[] { "", "", paramStFeed.id.get(), paramStFeed.title.get() });
    ...
    b("share_key_subscribe_feeds_update", new ydw(paramStFeed, true));
