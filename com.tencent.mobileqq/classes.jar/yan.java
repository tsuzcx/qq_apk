  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    {
      yak.a(this.a).sendEmptyMessage(1003);
      new yml().a();
      this.a.b = 2;
    }
    long l;
    do
    {
        ...
        do
        {
          do
          {
            do
            {
              ...
              yak.a(this.a, "DeviceList @@ cache receivechange for ui list:" + paramContext);
            ...
            if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_login"))
            {
              ...
              yak.a(this.a, "SmartDeviceProxyMgr::receive qq login broadcast!!!resultCode = " + i);
              SettingCloneUtil.writeValue(this.a.app.getApp(), this.a.app.getCurrentAccountUin(), null, "account_login_success_time", String.valueOf(awzw.a()));
              if (i == 0)
              {
            ...
            if ((paramIntent.getAction().equalsIgnoreCase("mqq.intent.action.LOGOUT")) || (paramIntent.getAction().equalsIgnoreCase("mqq.intent.action.ACCOUNT_CHANGED")))
            {
              if (this.a.a())
              {
                yak.a(this.a, "SmartDeviceProxyMgr::receive qq logout broadcast!!!");
                this.a.d();
              }
              yml.c();
              return;
            ...
            if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_clickOnDeviceList"))
            {
              ...
              ymw.a(null, "Usr_Click_MyDevice", 0, 0, 0);
              return;
            }
      ...
      yak.a(this.a, 1);
      SettingCloneUtil.writeValueForInt(BaseApplication.getContext(), this.a.app.getCurrentAccountUin(), null, "qqsetting_deviceplugin_bind_flag", yak.a(this.a));
