...
public class zsg
  extends zou<CertifiedAccountMeta.StFollowRcmd>
{
  public static int a;
  ...
  {
    paramViewGroup = LayoutInflater.from(a()).inflate(2131558794, paramViewGroup, false);
    URLImageView localURLImageView = (URLImageView)paramViewGroup.findViewById(2131369522);
    ...
    if (this.e)
    {
      ...
      ((TextView)paramViewGroup.findViewById(2131380282)).setTextColor(-10132123);
      paramViewGroup.findViewById(2131365769).setBackgroundColor(-14540254);
    }
  ...
  {
    aanb.b("auth_follow", "exp_more", 0, 0, new String[0]);
    paramViewGroup = LayoutInflater.from(a()).inflate(2131558793, paramViewGroup, false);
    LinearLayout localLinearLayout = (LinearLayout)paramViewGroup.findViewById(2131370380);
    ...
    for (int i = -13224394;; i = -460552)
    {
      ...
      localLinearLayout.setOnClickListener(new zsh(this));
      if (this.e) {
        ((TextView)paramViewGroup.findViewById(2131380281)).setTextColor(-5723992);
      }
      return paramViewGroup;
    }
  }
  ...
  protected void a(Rect paramRect, View paramView, RecyclerView paramRecyclerView, RecyclerView.State paramState)
  {
    ...
    while (paramView.getId() != 2131376963) {
      return;
    }
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      ((zsi)paramViewHolder).a(localStFollowRcmd, i);
    }
  }
  ...
  {
    if (paramInt == 100000) {
      return new zsi(this, a(paramViewGroup));
    }
    if (paramInt == 100001) {
      return new zsi(this, b(paramViewGroup));
    }
    paramViewGroup = new BlankRecommendItemView(paramViewGroup.getContext());
    paramViewGroup.setIsInNightMode(this.e);
    return new zsi(this, paramViewGroup);
  }
