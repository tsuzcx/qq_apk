  ...
  implements bhrb
{
  ...
  static
  {
    jdField_a_of_type_Bhrn = new bhrn(null);
  }
  
  public bhrm(@NotNull String paramString, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof bhrm))
      {
        paramObject = (bhrm)paramObject;
