  ...
  implements DownloadListener
{
  ...
  public static bidg a()
  {
    if (jdField_a_of_type_Bidg == null) {
      jdField_a_of_type_Bidg = new bidg();
    }
    return jdField_a_of_type_Bidg;
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bhzm.c("WebViewDownloadListener", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  {
    biap localbiap = biap.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbiap.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (biao)localbiap.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((biao)localObject).getJsCallbackMethod()))
            {
              ...
              bhzm.a("WebViewDownloadListener", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bhzm.c("WebViewDownloadListener", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
