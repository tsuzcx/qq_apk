  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, i, bool1, localBundle, awdj.class);
      return;
      long l;
      ...
      else
      {
        for (paramFromServiceMsg = paramIntent.getStringExtra("k_uin");; paramFromServiceMsg = null)
        {
          if (paramFromServiceMsg != null)
          {
            ...
            localEditor.putString(aenb.b(paramFromServiceMsg), String.valueOf(l));
            ...
            localEditor.putString(aenb.c(paramFromServiceMsg), (String)localObject1);
            localEditor.commit();
            if (!QLog.isColorLevel()) {
              break label694;
            }
