  ...
  implements UpCallBack
{
  ...
  afwn(afwm paramafwm, int paramInt, String paramString)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqPicPicResult = ((PicResult)paramafwm.a.a.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int));
    this.jdField_a_of_type_ComTencentMobileqqPicPicFowardInfo = ((PicFowardInfo)paramafwm.a.a.b.get(paramInt));
  ...
  public MessageRecord a(im_msg_body.RichText arg1)
  {
    ...
    {
      int i;
      synchronized (this.jdField_a_of_type_Afwm.a.a.jdField_a_of_type_JavaUtilArrayList)
      {
      ...
      synchronized (this.jdField_a_of_type_Afwm.a.a.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqPicPicFowardInfo.a.b == 1) || (this.jdField_a_of_type_ComTencentMobileqqPicPicFowardInfo.a.b == 3000))
        {
          this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_JavaLangObject = this.jdField_a_of_type_Afwm.a.a.a(null, null, this.jdField_a_of_type_Int);
          ...
          afwl.a(this.jdField_a_of_type_Afwm.a);
          if (afwl.a(this.jdField_a_of_type_Afwm.a) == 0) {
            afwk.a(this.jdField_a_of_type_Afwm.a.a);
          }
          return null;
          ...
          if (???.custom_face.has())
          {
            ...
            for (;;)
            {
              ...
              im_msg_body.NotOnlineImage localNotOnlineImage2 = afwl.a(this.jdField_a_of_type_Afwm.a, localCustomFace2);
              synchronized (this.jdField_a_of_type_Afwm.a.a.jdField_a_of_type_JavaUtilArrayList)
              {
                this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_Int = 0;
