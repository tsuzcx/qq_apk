...
public class aizo
  extends Handler
{
  public aizo(NonMainAppListViewFaceLoader paramNonMainAppListViewFaceLoader, Looper paramLooper)
  {
    super(paramLooper);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else if ((localObject2 instanceof VideoFeedsAdapter.VideoItemHolder))
        {
          ...
          if ((((VideoFeedsAdapter.VideoItemHolder)localObject2).a != null) && (((VideoFeedsAdapter.VideoItemHolder)localObject2).a.a != null) && ((((VideoFeedsAdapter.VideoItemHolder)localObject2).a.a.jdField_a_of_type_Int == 1) || (((VideoFeedsAdapter.VideoItemHolder)localObject2).a.a.jdField_a_of_type_Int == 6)) && (!TextUtils.isEmpty(((VideoFeedsAdapter.VideoItemHolder)localObject2).a.a.j)) && (((VideoFeedsAdapter.VideoItemHolder)localObject2).a.a.j.equals(localObject1))) {
            ((VideoFeedsAdapter.VideoItemHolder)localObject2).b.setImageBitmap(paramMessage);
          }
        }
      }
