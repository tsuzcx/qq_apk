  ...
  extends MSFServlet
{
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/if_proxy", "application/json", localJSONObject.toString(), new bcvi(paramBusinessObserver));
      return;
    }
  ...
  public static void a(int paramInt, byte[] paramArrayOfByte, long paramLong, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/available", "application/json", ((JSONObject)localObject).toString(), 2000, 2000, new bcvj(paramBusinessObserver));
      return;
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(paramQQAppInterface.getApp(), bcvh.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, ayra paramayra)
  {
    a(paramQQAppInterface, 2478, "OidbSvc.0x9ae_13", 13, new cmd0x9ae.ReqBody().toByteArray(), paramayra);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ayra paramayra)
  {
    paramString = new FaceSecureCheck.SecureCheckRequest();
    Object localObject = qcg.a(BaseApplicationImpl.getApplication());
    boolean bool;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      localObject = new NewIntent(paramQQAppInterface.getApp(), bcvh.class);
      ((NewIntent)localObject).setObserver(paramayra);
  ...
  public static void a(String paramString1, long paramLong, String paramString2, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/appconf", "application/json", localJSONObject.toString(), new bcvk(paramBusinessObserver));
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  private static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, bcvm parambcvm)
  {
    ThreadManager.getNetExcutor().execute(new LoginVerifyServlet.4(paramString1, paramInt1, paramInt2, paramString2, paramString3, parambcvm));
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, bcvm parambcvm)
  {
    a(paramString1, paramString2, paramString3, 10000, 30000, parambcvm);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, ayra paramayra)
  {
    a(paramQQAppInterface, 2478, "OidbSvc.0x9ae_14", 14, new cmd0x9ae.ReqBody().toByteArray(), paramayra);
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface, ayra paramayra)
  {
    a(paramQQAppInterface, 2478, "OidbSvc.0x9ae_15", 15, new cmd0x9ae.ReqBody().toByteArray(), paramayra);
  }
