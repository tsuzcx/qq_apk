...
{
  nqz(nqy paramnqy, int paramInt, JSONObject paramJSONObject, Context paramContext, MessageRecord paramMessageRecord) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      if ((nqy.a(this.jdField_a_of_type_Nqy) != null) && (nqy.a(this.jdField_a_of_type_Nqy).isShowing())) {
        nqy.a(this.jdField_a_of_type_Nqy).dismiss();
      }
      return;
      ...
      if (!bbkk.a(paramView))
      {
        ...
        ((nqu)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(139)).a(8, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        ...
        ((nqu)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(139)).a(7, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        bcql.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getString(2131692381), 1).a();
      }
    }
  }
