...
{
  public bmhq(AEEditorCommonEditFragment paramAEEditorCommonEditFragment) {}
  
  public void a(@Nullable List<AEEditorFilterBean> paramList)
  {
    bmbx.b(AEEditorCommonEditFragment.c(), "mFiltersObserver-onChanged");
    ...
    bmkn.a().d();
    bmkn.a(this.a.getActivity().getApplicationContext());
    this.a.m();
  }
}
