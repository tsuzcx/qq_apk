  ...
  implements Manager
{
  ...
  public agmq(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong, agmt paramagmt, String paramString, Map<String, String> paramMap)
  {
    if (a())
    {
    ...
    for (long l2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin();; l2 = 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QWalletConfigManager", 2, "realGetConfig:" + paramLong + "|" + paramagmt + "|" + paramString + "|" + paramMap + "|" + localReqWalletConfig);
      }
      agkg.a(localReqWalletConfig, new agmr(this, paramLong, paramagmt, new WeakReference(this)), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      l1 = 0L;
      break;
    }
  ...
  public static void a(String paramString, agmu paramagmu)
  {
    ...
    {
      ((agmq)localAppRuntime.getManager(245)).c(paramString, paramagmu);
      return;
    }
    agwb.a(paramString, paramagmu);
  }
  ...
  public static void b(String paramString, agmu paramagmu)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((agmq)localAppRuntime.getManager(245)).d(paramString, paramagmu);
      return;
    }
    agwb.b(paramString, paramagmu);
  }
  
  public int a(String paramString, int paramInt, String... paramVarArgs)
  {
    return agmn.a(a(paramString), paramInt, paramVarArgs);
  }
  ...
  public agmo a(String paramString)
  {
  ...
  {
    return agmn.a(a(paramString1), paramString2, paramVarArgs);
  }
  
  public JSONArray a(String paramString, String... paramVarArgs)
  {
    return agmn.a(a(paramString), paramVarArgs);
  }
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    do
    {
      ...
      agkg.a(paramMap, 1, new agms(this));
    } while (!QLog.isColorLevel());
  ...
  public void b(int paramInt)
  {
    ...
    try
    {
      String str = ((agqj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(273)).a();
  ...
  public void c(String paramString, agmu paramagmu)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.addUpdateListener(paramString, paramagmu);
  }
  
  public void d(String paramString, agmu paramagmu)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.removeUpdateListener(paramString, paramagmu);
  }
