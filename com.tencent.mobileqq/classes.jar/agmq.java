  ...
  implements Animator.AnimatorListener
{
  ...
  private agnq jdField_a_of_type_Agnq;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private LottieDrawable jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable;
  private String jdField_a_of_type_JavaLangString = "";
  
  public agmq(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Agnq = new agnq(paramContext);
    this.jdField_a_of_type_Agnq.a(new agmr(this));
  }
  ...
  public void a(agnf paramagnf)
  {
    ...
    this.jdField_a_of_type_JavaLangString = axtp.c();
    ...
    if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new agms(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), localFileInputStream, new agmt(this));
      super.a(paramagnf);
      paramagnf.a(bool);
      return;
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Agnq != null)
    {
      this.jdField_a_of_type_Agnq.b();
      this.jdField_a_of_type_Agnq.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Agnq != null) && (this.jdField_a_of_type_Agnq.a())) {
      this.jdField_a_of_type_Agnq.d();
    }
  }
