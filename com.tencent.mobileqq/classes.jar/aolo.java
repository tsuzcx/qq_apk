...
public class aolo
  extends aolh
{
  public aolo(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg, GetLastLoginInfoResp paramGetLastLoginInfoResp)
  {
    if ((paramFromServiceMsg.isSuccess()) && (paramGetLastLoginInfoResp != null) && (paramGetLastLoginInfoResp.errorCode == 0))
    {
      ...
      {
        bhdd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), paramGetLastLoginInfoResp.iRefreshIntervalMin);
  ...
  private void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = paramFromServiceMsg.intervalTimeMin * 60 * 1000;; i = 180000)
    {
      ...
      ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramFromServiceMsg.vecFriendInfo);
      a(13, true, null);
      return;
      i = 30000;
      break;
  ...
  private void a(List<LastLoginInfo> paramList)
  {
    ...
    else
    {
      ...
      localObject2 = ((anvk)localObject1).d();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localFriends = ((anvk)localObject1).e(String.valueOf(((LastLoginInfo)localObject2).dwFriendUin));
      ...
      for (i = 1;; i = 0)
      {
        ...
        break;
        ((anvk)localObject1).a((Friends[])localArrayList.toArray(new Friends[localArrayList.size()]), localArrayList.size());
        if (QLog.isColorLevel()) {
