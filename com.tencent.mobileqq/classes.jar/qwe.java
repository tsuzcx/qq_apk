...
{
  private static final String jdField_c_of_type_JavaLangString = ajyc.a(2131716919);
  private WeishiRedDotInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructWeishiRedDotInfo;
  private otp jdField_a_of_type_Otp = (otp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(274);
  private boolean jdField_c_of_type_Boolean;
  private boolean d;
  
  public qwe(qjt paramqjt, Bundle paramBundle, QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
  ...
  private void a(WeishiRedDotInfo paramWeishiRedDotInfo)
  {
    ...
    this.jdField_a_of_type_Npv.a(this.jdField_a_of_type_Npw, l1, a(), i, null, str1, l3, true, 0, str2, str3, paramWeishiRedDotInfo, 0, null, null, 0, null);
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842596);
      return;
    }
    super.a(paramInt);
  }
  ...
  public boolean a(Bundle paramBundle)
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        ...
        this.jdField_a_of_type_Otp.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
        return true;
      }
    }
  ...
  public void b()
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mRequestWidth = ((int)bbct.k());
    ((URLDrawable.URLDrawableOptions)localObject).mRequestHeight = ((int)bbct.l());
    ColorDrawable localColorDrawable = new ColorDrawable(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131165275));
  ...
  {
    if ((paramVideoInfo != null) && (this.jdField_a_of_type_Otp != null))
    {
      if (paramVideoInfo.a == null) {
        qol.a(paramVideoInfo);
      }
      long l = NetConnInfoCenter.getServerTime();
      this.jdField_a_of_type_Otp.a(sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramVideoInfo.a), l);
    }
  }
