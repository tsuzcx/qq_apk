...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42, 50 }, new String[] { "nick", "avatar", "ranks", "score", "unit", "uid" }, new Object[] { "", "", Integer.valueOf(0), Integer.valueOf(0), "", "" }, StRankingList.class);
