...
public class adkg
  implements Runnable
{
  public adkg(FileViewMusicService paramFileViewMusicService, String paramString, FileViewMusicService.IGetTotalTime paramIGetTotalTime) {}
  
  /* Error */
  public void run()
  {
    // Byte code:
    //   0: new 35	android/media/MediaPlayer
    //   3: dup
    //   4: invokespecial 36	android/media/MediaPlayer:<init>	()V
    //   7: astore_3
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 16	adkg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   20: invokespecial 43	java/io/File:<init>	(Ljava/lang/String;)V
    //   23: invokespecial 46	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   26: astore_2
    //   27: aload_2
    //   28: astore_1
    //   29: aload_3
    //   30: iconst_3
    //   31: invokevirtual 50	android/media/MediaPlayer:setAudioStreamType	(I)V
    //   34: aload_2
    //   35: astore_1
    //   36: aload_3
    //   37: aload_2
    //   38: invokevirtual 54	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   41: invokevirtual 58	android/media/MediaPlayer:setDataSource	(Ljava/io/FileDescriptor;)V
    //   44: aload_2
    //   45: astore_1
    //   46: aload_3
    //   47: new 60	adkh
    ...
    //   51: aload_0
    //   52: aload_3
    //   53: invokespecial 63	adkh:<init>	(Ladkg;Landroid/media/MediaPlayer;)V
    //   56: invokevirtual 67	android/media/MediaPlayer:setOnPreparedListener	(Landroid/media/MediaPlayer$OnPreparedListener;)V
    //   59: aload_2
    //   60: astore_1
    //   61: aload_3
    //   62: invokevirtual 70	android/media/MediaPlayer:prepareAsync	()V
    //   65: aload_2
    //   66: ifnull +7 -> 73
    //   69: aload_2
    //   70: invokevirtual 73	java/io/FileInputStream:close	()V
    //   73: return
    //   74: astore_1
    //   75: aload_1
    //   76: invokevirtual 76	java/io/IOException:printStackTrace	()V
    //   79: return
    //   80: astore_3
    //   81: aconst_null
    //   82: astore_2
    ...
    //   84: astore_1
    //   85: aload_3
    //   86: invokevirtual 77	java/lang/IllegalArgumentException:printStackTrace	()V
    //   89: aload_2
    //   90: ifnull -17 -> 73
    //   93: aload_2
    //   94: invokevirtual 73	java/io/FileInputStream:close	()V
    //   97: return
    //   98: astore_1
    //   99: aload_1
    //   100: invokevirtual 76	java/io/IOException:printStackTrace	()V
    //   103: return
    //   104: astore_3
    //   105: aconst_null
    //   106: astore_2
    ...
    //   108: astore_1
    //   109: aload_3
    //   110: invokevirtual 78	java/lang/SecurityException:printStackTrace	()V
    //   113: aload_2
    //   114: ifnull -41 -> 73
    //   117: aload_2
    //   118: invokevirtual 73	java/io/FileInputStream:close	()V
    //   121: return
    //   122: astore_1
    //   123: aload_1
    ...
    //   132: astore_1
    //   133: aload_3
    //   134: invokevirtual 79	java/lang/IllegalStateException:printStackTrace	()V
    //   137: aload_2
    //   138: ifnull -65 -> 73
    //   141: aload_2
    //   142: invokevirtual 73	java/io/FileInputStream:close	()V
    //   145: return
    //   146: astore_1
    //   147: aload_1
    //   148: invokevirtual 76	java/io/IOException:printStackTrace	()V
    //   151: return
    //   152: astore_3
    //   153: aconst_null
    //   154: astore_2
    ...
    //   162: ifnull -89 -> 73
    //   165: aload_2
    //   166: invokevirtual 73	java/io/FileInputStream:close	()V
    //   169: return
    //   170: astore_1
    //   171: aload_1
    //   172: invokevirtual 76	java/io/IOException:printStackTrace	()V
    //   175: return
    //   176: astore_3
    //   177: aconst_null
    //   178: astore_2
    ...
    //   180: astore_1
    //   181: aload_3
    //   182: invokevirtual 80	java/lang/NullPointerException:printStackTrace	()V
    //   185: aload_2
    //   186: ifnull -113 -> 73
    //   189: aload_2
    //   190: invokevirtual 73	java/io/FileInputStream:close	()V
    //   193: return
    //   194: astore_1
    //   195: aload_1
    ...
    //   204: ifnull +7 -> 211
    //   207: aload_1
    //   208: invokevirtual 73	java/io/FileInputStream:close	()V
    //   211: aload_2
    //   212: athrow
    //   213: astore_1
    //   214: aload_1
    //   215: invokevirtual 76	java/io/IOException:printStackTrace	()V
    //   218: goto -7 -> 211
    //   221: astore_2
    //   222: goto -19 -> 203
    //   225: astore_3
