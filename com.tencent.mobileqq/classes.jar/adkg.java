...
public class adkg
{
  ...
  public adkg(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static adkg a(JSONObject paramJSONObject)
  {
    adkg localadkg = new adkg();
    try
    {
      localadkg.a = paramJSONObject.getString("name").trim();
      localadkg.b = paramJSONObject.getString("ver").trim();
      localadkg.c = paramJSONObject.getString("system").trim();
      localadkg.d = paramJSONObject.getString("driver").trim();
      localadkg.e = paramJSONObject.getString("url").trim();
      localadkg.f = paramJSONObject.getString("type").trim();
      localadkg.h = paramJSONObject.getString("enabled").trim();
      localadkg.k = paramJSONObject.optString("previousPatch", "").trim();
      return localadkg;
    }
    catch (Exception paramJSONObject)
    {
      adjv.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      adjv.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
