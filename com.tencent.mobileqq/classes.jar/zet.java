  ...
  implements zek
{
  ...
  private void a(Activity paramActivity)
  {
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(paramActivity.getResources(), 2130848026);
    ...
    this.jdField_a_of_type_Benq = new benq((Bitmap)localObject2, (int)(paramActivity.getResources().getDisplayMetrics().density * 12.0F));
  ...
  public void a()
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 4))
    {
      if ((this.jdField_a_of_type_AndroidGraphicsRect.width() == 0) || (this.jdField_a_of_type_AndroidGraphicsRect.height() == 0))
      {
        ...
        this.jdField_a_of_type_Benq.setBounds(this.jdField_a_of_type_AndroidGraphicsRect);
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Benq.setLevel(paramInt * 100);
  ...
  public void a(Activity paramActivity, zdy paramzdy)
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((RelativeLayout)paramzdy.a()).findViewById(2131372351));
    a(paramActivity);
  }
