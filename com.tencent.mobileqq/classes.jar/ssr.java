  ...
  implements Manager
{
  ...
  public ssr(QQAppInterface paramQQAppInterface)
  {
  ...
  @NonNull
  public static ssr a(QQAppInterface paramQQAppInterface)
  {
    return (ssr)paramQQAppInterface.getManager(253);
  }
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    int j = bbkb.aC(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str;
    if (i != j)
    {
    ...
    {
      return;
      bbkb.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramConfig.version.get(), str);
      try
      {
        b(str);
        return;
  ...
  public void a(@NonNull MessageForQQStoryFeed paramMessageForQQStoryFeed)
  {
    ...
    vei.a("aio_msg", "aio_push", 0, 0, new String[] { paramMessageForQQStoryFeed.frienduin });
    acuo localacuo = (acuo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(282);
    Object localObject = localacuo.a(paramMessageForQQStoryFeed.frienduin, 0, 5);
    int i;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      bbkb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramMessageForQQStoryFeed.frienduin, i);
      return;
