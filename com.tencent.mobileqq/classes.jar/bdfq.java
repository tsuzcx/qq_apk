  ...
  extends Dialog
{
  ...
  private BaseAdapter adapter = new bdfr(this);
  ...
  ListView list;
  private bdgb mBrandColorManager = new bdgb(null);
  ...
  @TargetApi(14)
  public bdfq(Context paramContext)
  {
    super(paramContext);
  ...
  @TargetApi(14)
  public bdfq(Context paramContext, int paramInt)
  {
  ...
  @TargetApi(14)
  protected bdfq(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
  ...
  {
    bdfs localbdfs = new bdfs(paramActivity);
    showPermissionSettingDialog(paramActivity, paramString1, paramString2, localbdfs, localbdfs, null);
  }
  ...
  {
    bdfq localbdfq = bdcd.a(paramActivity, 230);
    ...
    {
      paramActivity = alpo.a(2131710586);
    }
    ...
    {
      paramActivity = alpo.a(2131710578);
    }
    localbdfq.setMessage(paramActivity);
    localbdfq.setNegativeButton(alpo.a(2131710585), paramOnClickListener1);
    localbdfq.setPositiveButton(alpo.a(2131710570), paramOnClickListener2);
    localbdfq.setOnCancelListener(paramOnCancelListener);
    localbdfq.show();
  }
  
  public bdfq addCenterView(View paramView, LinearLayout.LayoutParams paramLayoutParams)
  {
  ...
  public bdfq addView(View paramView)
  {
    this.text.setVisibility(8);
  ...
  public bdfq addView(View paramView, LinearLayout.LayoutParams paramLayoutParams)
  {
    this.text.setVisibility(8);
    this.countText.setVisibility(8);
    this.bodyLayout.addView(paramView, paramLayoutParams);
  ...
  public void adjustMessageBottomMargin(float paramFloat)
  {
    if (this.bodyLayout != null)
    {
      ...
      localLayoutParams.bottomMargin = azgq.a(paramFloat);
  ...
  public void adjustMessageTopBottomMargin(float paramFloat1, float paramFloat2)
  {
    ...
    {
      RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.bodyLayout.getLayoutParams();
      localLayoutParams.bottomMargin = azgq.a(paramFloat2);
      localLayoutParams.topMargin = azgq.a(paramFloat1);
      this.bodyLayout.setLayoutParams(localLayoutParams);
    }
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 270	abqm:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 270	abqm:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 270	abqm:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    if (paramAccessibilityEvent.getEventType() == 32) {
      paramAccessibilityEvent.getText().add(getContext().getString(2131691161));
    }
  ...
  {
    return (TextView)findViewById(2131365233);
  }
  ...
  public bdfq setCheckBox(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    findViewById(2131369159).setVisibility(0);
    this.checkTxt.setText(paramString);
    if (this.checkBox != null) {
      this.checkBox.setOnCheckedChangeListener(new bdfu(this, paramOnClickListener));
    }
    setSeperatorState();
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.title = ((TextView)findViewById(2131365235));
    this.text = ((TextView)findViewById(2131365231));
    this.dialogEdit = ((EditText)findViewById(2131365216));
    this.countText = ((TextView)findViewById(2131365209));
    this.dummyFirstPreviewImage = ((TextView)findViewById(2131365502));
    this.previewImage = ((TextView)findViewById(2131372226));
    this.operateImage = ((ImageView)findViewById(2131371394));
    this.framePreviewImage = ((ImageView)findViewById(2131366809));
    this.framePreview = findViewById(2131366808);
    this.mVideoIcon = ((ImageView)findViewById(2131379671));
    this.mVideoSize = ((TextView)findViewById(2131369851));
    this.mVideoTime = ((TextView)findViewById(2131369852));
    this.lBtn = ((TextView)findViewById(2131365220));
    this.rBtn = ((TextView)findViewById(2131365226));
    this.editPicTag = ((TextView)findViewById(2131365217));
    this.progressBar = ((ProgressBar)findViewById(2131365261));
    this.lBtn.setVisibility(8);
    this.rBtn.setVisibility(8);
    this.bodyLayout = ((LinearLayout)findViewById(2131363352));
    this.checkBox = ((CheckBox)findViewById(2131378161));
    this.mSwitch = ((FormSwitchItem)findViewById(2131378163));
    this.checkTxt = ((TextView)findViewById(2131379069));
    this.list = ((ListView)findViewById(2131369501));
    this.rootView = ((ViewGroup)findViewById(2131365227));
    if ((this.list != null) && (Build.VERSION.SDK_INT >= 9)) {
      this.list.setOverScrollMode(2);
    }
    this.mBrandColorManager.a(findViewById(2131365194));
  }
  ...
  public bdfq setFirstDummyPreviewImage(Drawable paramDrawable)
  {
  ...
  public bdfq setImageOnClickListener(View.OnClickListener paramOnClickListener)
  {
  ...
  public bdfq setItems(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
  ...
  public bdfq setItems(String[] paramArrayOfString, DialogInterface.OnClickListener paramOnClickListener)
  {
  ...
  public bdfq setMessage(int paramInt)
  {
  ...
  public bdfq setMessage(CharSequence paramCharSequence)
  {
  ...
  public bdfq setMessageCount(String paramString)
  {
    if (paramString != null)
    {
  ...
  public bdfq setMessageMaxLine(int paramInt)
  {
    if (this.text != null)
    {
  ...
  public bdfq setMessageWithEmo(String paramString, float paramFloat)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      this.text.setText(new baig(paramString, 3));
  ...
  public bdfq setMessageWithUrl(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  public bdfq setMessageWithoutAutoLink(CharSequence paramCharSequence)
  {
    if (!TextUtils.isEmpty(paramCharSequence))
    {
      this.text.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  public bdfq setMsgMaxLineWithEnd(String paramString, int paramInt)
  {
    if (this.text != null)
    {
      this.text.setMaxLines(paramInt);
      this.text.getViewTreeObserver().addOnGlobalLayoutListener(new bdft(this, paramInt, paramString));
    }
    return this;
  }
  ...
  public bdfq setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bdfz(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  
  public bdfq setNegativeButton(String paramString, int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.lBtn.setVisibility(8);
  ...
  public bdfq setNegativeButton(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.lBtn.setVisibility(8);
    ...
    this.lBtn.setVisibility(0);
    this.lBtn.setOnClickListener(new bdfw(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bdfq setOperateImage(Drawable paramDrawable)
  {
  ...
  public bdfq setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bdga(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  
  public bdfq setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
    ...
    this.rBtn.setText(paramInt);
    this.rBtn.setContentDescription(getContext().getString(paramInt) + getContext().getString(2131691158));
    this.rBtn.setVisibility(0);
    this.rBtn.setOnClickListener(new bdfy(this, paramOnClickListener, paramBoolean));
    setSeperatorState();
    return this;
  }
  
  public bdfq setPositiveButton(String paramString, int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
  ...
  public bdfq setPositiveButton(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
    ...
    this.rBtn.setVisibility(0);
    this.rBtn.setOnClickListener(new bdfx(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bdfq setPreviewFixDimension(int paramInt1, int paramInt2)
  {
    ...
    localMarginLayoutParams.topMargin = aekt.a(12.0F, this.framePreview.getResources());
    this.framePreviewImage.getLayoutParams().width = paramInt1;
    this.framePreviewImage.getLayoutParams().height = paramInt2;
    return this;
  }
  
  public bdfq setPreviewImage(Drawable paramDrawable)
  {
    return setPreviewImage(paramDrawable, false, 0);
  }
  
  public bdfq setPreviewImage(Drawable paramDrawable, boolean paramBoolean, int paramInt)
  {
  ...
  public bdfq setPreviewImage(Drawable paramDrawable, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (paramInt == 2)
      {
        this.framePreview.setBackgroundResource(2130839725);
        return this;
      }
  ...
  public bdfq setPreviewImageScaleType(boolean paramBoolean)
  {
  ...
  public bdfq setSwitch(String paramString, boolean paramBoolean, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (this.mSwitch != null)
    {
      ...
      if (paramOnClickListener != null) {
        this.mSwitch.setOnCheckedChangeListener(new bdfv(this, paramOnClickListener));
      }
    }
    return this;
  }
  ...
  public bdfq setText(String paramString, int paramInt)
  {
  ...
  public bdfq setTitle(String paramString)
  {
    if (paramString != null)
    {
  ...
  public bdfq setTitleWithEmo(CharSequence paramCharSequence)
  {
  ...
  public bdfq setVideoFormat(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
  ...
  public bdfq setView(View paramView)
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
    this.bodyLayout.addView(paramView, localLayoutParams);
    return this;
