...
public class avek
{
  ...
  private static View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new avel();
  ...
  public static TextView a(Context paramContext, RelativeLayout paramRelativeLayout)
  {
    ...
    paramRelativeLayout.addRule(0, 2131374358);
    ...
    paramContext.setBackgroundResource(2130844368);
  ...
  public static aveo a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    ...
    try
    {
      ...
      aveo localaveo = new aveo();
      localaveo.jdField_a_of_type_JavaLangString = paramStructMsgForImageShare.optString("game_source_pic_txt");
      localaveo.jdField_b_of_type_JavaLangString = paramStructMsgForImageShare.optString("game_source_pic_url");
      localaveo.jdField_a_of_type_Int = paramStructMsgForImageShare.optInt("game_source_type_pic", 0);
      localaveo.jdField_b_of_type_Int = paramStructMsgForImageShare.optInt("game_source_subtype_pic", 0);
      localaveo.jdField_a_of_type_Boolean = paramStructMsgForImageShare.optBoolean("game_source_pic_has_data");
      return localaveo;
    }
  ...
  public static void a(View paramView, RelativeLayout paramRelativeLayout, boolean paramBoolean, Resources paramResources, Context paramContext, AbsStructMsg paramAbsStructMsg)
  {
    ...
    catch (Throwable paramView)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).addRule(7, 2131364522);
        ((RelativeLayout.LayoutParams)localObject).addRule(1, 2131364531);
    ...
    paramRelativeLayout.setBackgroundResource(2130842657);
    ...
    if (paramBoolean)
    {
      ...
      paramContext.addRule(6, 2131378138);
      paramContext.addRule(1, 2131378138);
      paramContext.addRule(11, -1);
      paramContext.addRule(8, 2131378138);
      ...
      paramRelativeLayout = paramResources.getDrawable(2130848544);
      ...
      aveh.a().a(localStructMsgForImageShare.mSourceAppid, localStructMsgForImageShare.message);
      ...
      abuf.a(null, "870", "206672", paramContext, "87006", "1", "145", paramView);
      jdField_a_of_type_JavaUtilMap.put(Long.valueOf(paramAbsStructMsg.message.uniseq), Integer.valueOf(j));
    }
  }
  
  public static void a(TextView paramTextView, Context paramContext, AIOImageData paramAIOImageData, ahsj paramahsj)
  {
    ...
    aveo localaveo = a(localStructMsgForImageShare);
    if ((localaveo != null) && (!TextUtils.isEmpty(localaveo.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty(localaveo.jdField_b_of_type_JavaLangString)))
    {
      Object localObject1 = localStructMsgForImageShare.mSourceAppid + "";
      paramTextView.setVisibility(0);
      paramTextView.setText(localaveo.jdField_a_of_type_JavaLangString);
      paramTextView.setTag(-1, localaveo.jdField_b_of_type_JavaLangString);
      paramTextView.setTag(-4, localObject1);
      paramTextView.setTag(-2, Integer.valueOf(localaveo.jdField_a_of_type_Int));
      paramTextView.setTag(-3, Integer.valueOf(localaveo.jdField_b_of_type_Int));
      paramTextView.setTag(-5, Integer.valueOf(2));
      a((String)localObject1, localaveo.jdField_b_of_type_Int, paramAIOImageData);
      paramTextView.setOnClickListener(jdField_a_of_type_AndroidViewView$OnClickListener);
      albw.a(paramTextView, 0.5F);
      localObject1 = localStructMsgForImageShare.mSourceIcon;
      Object localObject2 = paramContext.getResources();
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        Object localObject3 = ((Resources)localObject2).getDrawable(2130850493);
        ...
        Object localObject4 = new BitmapDrawable(bdpx.a((Drawable)localObject3));
        ...
        localObject4 = ((Resources)localObject2).getDrawable(2130850494);
        ((Drawable)localObject4).setBounds(0, 0, AIOUtils.dp2px(20.0F, (Resources)localObject2), AIOUtils.dp2px(20.0F, (Resources)localObject2));
        ...
        paramahsj = new WeakReference(paramahsj);
        long l1 = paramAIOImageData.jdField_f_of_type_Long;
        long l2 = paramAIOImageData.jdField_f_of_type_Int;
        QWalletPicHelper.decodeDrawable((Drawable)localObject1, new avem((WeakReference)localObject2, (WeakReference)localObject3, paramahsj, l1, l2));
        if (!localaveo.jdField_a_of_type_Boolean) {
          aveh.a().a(localStructMsgForImageShare.mSourceAppid, new aven((WeakReference)localObject2, (WeakReference)localObject3, paramahsj, l1, l2, paramAIOImageData));
        }
      }
    }
    for (;;)
  ...
  public static void a(StructMsgForImageShare paramStructMsgForImageShare, ImageView paramImageView, bdqa parambdqa)
  {
    int i;
    int j;
    if ((a(paramStructMsgForImageShare)) && (a(paramStructMsgForImageShare)) && (paramImageView != null) && (parambdqa != null))
    {
      i = AIOUtils.dp2px(parambdqa.q, paramImageView.getContext().getResources());
      j = AIOUtils.dp2px(parambdqa.r, paramImageView.getContext().getResources());
  ...
  public static void a(StructMsgForImageShare paramStructMsgForImageShare, MessageForPic paramMessageForPic, bdqa parambdqa)
  {
    if ((a(paramStructMsgForImageShare)) && (a(paramStructMsgForImageShare)) && (parambdqa != null)) {
    ...
    for (paramStructMsgForImageShare = null;; paramStructMsgForImageShare = paramMessageForPic.thumbWidthHeightDP)
    {
      if (paramStructMsgForImageShare != null)
      {
        ...
        parambdqa.q = Math.max(paramStructMsgForImageShare.mMaxWidth, parambdqa.q);
        parambdqa.r = Math.max(paramStructMsgForImageShare.mMaxHeight, parambdqa.r);
      }
      return;
    }
  }
  ...
  public static void a(String paramString, int paramInt, Object paramObject)
  {
    ...
    if ((localObject == null) || (((Integer)localObject).intValue() != paramInt))
    {
      ...
      abuf.a(null, "870", "206673", paramString, "87007", "1", "145", (Map)localObject);
  ...
  public static boolean a(long paramLong)
  {
    try
    {
      avef localavef = aveg.a();
      if (localavef != null)
      {
        boolean bool = localavef.a(paramLong + "");
        if (bool) {
          return true;
        }
      }
