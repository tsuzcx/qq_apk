...
public class bhsm
{
  ...
  private bhso jdField_a_of_type_Bhso;
  private boolean jdField_a_of_type_Boolean = true;
  private int b;
  
  public bhsm(View paramView, int paramInt, bhso parambhso)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Bhso = parambhso;
    b();
  }
  ...
  public static int a(int paramInt)
  {
    int i;
    if (paramInt == 0) {
      i = agej.a(210.0F, BaseApplicationImpl.getContext().getResources());
    }
    do
    {
      return i;
  ...
  private static int b()
  {
    ...
    if (blry.a(localBaseApplication)) {
      i = blry.a(localBaseApplication);
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bhsn(this);
  }
  ...
  public int a()
  {
    ...
    if (localSharedPreferences.contains("key_height"))
    {
      ...
      this.jdField_a_of_type_Bhso.a(i, true);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
