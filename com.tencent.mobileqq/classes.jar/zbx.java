  ...
  extends WebViewPlugin
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new zby(this, Looper.getMainLooper());
  public String a;
  private zbz jdField_a_of_type_Zbz = new zbz();
  ...
  private void a(Bundle paramBundle)
  {
    ...
    for (CustomWebView localCustomWebView = this.mRuntime.a();; localCustomWebView = null)
    {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        this.jdField_a_of_type_Zbz.a(this, localWebSo3);
        return;
      }
      this.jdField_a_of_type_Zbz.a();
      if ((!bool3) && (Build.VERSION.SDK_INT >= 17))
      {
        ...
        {
          this.jdField_a_of_type_Zca = new zca(this, localCustomWebView);
          localCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Zca, "_webso");
          if (QLog.isColorLevel()) {
            QLog.d("WebSoPlugin", 1, "js method : " + Arrays.toString(this.jdField_a_of_type_Zca.getClass().getDeclaredMethods()));
          }
        }
      }
      label424:
      if ((!this.jdField_b_of_type_Boolean) && (!bool3) && (i != 0))
      {
        ...
        if (bool2) {}
        for (paramBundle = begt.a(str2, str1);; paramBundle = begt.b(str2, str1))
        {
          ...
          this.jdField_a_of_type_Zca.a(str1);
          return;
        }
      }
      if (bool4)
      {
        ...
        if (this.jdField_a_of_type_Zca != null) {
          this.jdField_a_of_type_Zca.a("{\"code\":0,\"data\":null}");
        }
      ...
      label768:
      for (paramBundle = begt.b(str2, str1);; paramBundle = str1)
      {
        a(localCustomWebView, str2, paramBundle);
        return;
  ...
  public static void a(CustomWebView paramCustomWebView, String paramString1, String paramString2)
  {
    ...
    {
      paramCustomWebView.setTag(2131373582, paramString2);
      paramCustomWebView.setTag(2131373583, Long.valueOf(System.currentTimeMillis()));
  ...
  private boolean a(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    do
    {
      ...
      a(paramString);
    } while ((!begt.b(paramString)) || (begt.e(paramString)));
  ...
  {
    if ((this.mRuntime == null) || (this.mRuntime.a() == null) || (this.mRuntime.a().getRootView() == null) || (this.mRuntime.a().getRootView().findViewById(2131380127) == null)) {}
    View localView;
    do
    {
      return;
      localView = this.mRuntime.a().getRootView().findViewById(2131380127).findViewById(2131372322);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if ((paramString2 != null) && ("WebSo".equals(paramString2)))
    {
      ...
      do
      {
        ...
        {
          begt.a("js call getData");
          this.jdField_a_of_type_Zbz.a(this, paramJsBridgeListener);
          return true;
        }
        if ("updateWebsoCache".equals(paramString3)) {}
        try
        {
          begt.a("js call updateWebsoCache");
          if (this.jdField_a_of_type_Zbz.a() != null)
          {
            if (this.mRuntime != null) {
        ...
        if ("updateScreenshot".equals(paramString3)) {
          try
          {
            begt.a("js call updateScreenshot");
            if (this.mRuntime != null)
            {
              paramString1 = this.mRuntime.a();
              paramString2 = paramString1.getUrl();
              if (begt.b(paramString2)) {
