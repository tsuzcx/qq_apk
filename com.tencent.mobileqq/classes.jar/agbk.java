  ...
  extends agax
{
  ...
  public agbk(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentWidgetListView.getResources().getDrawable(2130837975);
      ...
      this.jdField_a_of_type_AndroidViewView = new agbp(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new agbp(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new agbl(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new agbn(this));
      paramVarArgs = new agbo(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
