...
public class azqp
{
  ...
  private static azqr jdField_a_of_type_Azqr = new azqr();
  ...
  public static int a()
  {
    ...
    if (!((alzl)((AppRuntime)localObject).getManager(56)).a(Long.valueOf(Long.parseLong("2290230341"))))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    bjqu.a().a(new azqq(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig, int paramInt, String paramString)
  {
    ...
    int j = bdne.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString);
    if (QLog.isColorLevel()) {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        try
        {
          ...
          bdne.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString, i);
          return;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), azcf.class);
    ...
    for (String str = "1";; str = "0")
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(jdField_a_of_type_Azqr);
      BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
      azqs.b(paramQQAppInterface, "CliOper", "", "", "0X800915C", "0X800915C", 0, 0, "", "", "", "");
      return;
    }
  }
}
