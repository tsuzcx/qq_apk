...
public class aquz
{
  ...
  {
    return a(attu.a(paramRichText), paramInt);
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((JSONObject)localObject5).has("audio_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + amtj.a(2131706061);
            }
          ...
          if (((JSONObject)localObject5).has("video_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + amtj.a(2131706062);
            }
          }
          else
          {
            ...
            if (((JSONObject)localObject5).has("pic_list"))
            {
              ...
              {
                localObject4 = localObject3;
                localObject1 = (String)localObject3 + amtj.a(2131706060);
              }
            }
            else
            {
      ...
      if (i < ((JSONArray)localObject5).length())
      {
        ...
        {
          localObject4 = localObject3;
          localObject1 = (String)localObject3 + amtj.a(2131706058);
          break label450;
        }
        localObject4 = localObject3;
        localObject1 = localObject3;
        ...
        localObject4 = localObject3;
        localObject1 = (String)localObject3 + amtj.a(2131706059);
        break label450;
