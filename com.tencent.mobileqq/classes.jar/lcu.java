...
public class lcu
{
  ...
  public lcu(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = mnl.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          str2 = localley.e;
          i = localley.F;
          j = localley.jdField_d_of_type_Int;
          bool1 = localley.N;
          bool2 = localley.P;
          bool3 = localley.g;
          l = localVideoController.a(str1);
  ...
  public void a()
  {
    ...
    {
      lcv.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((ley)localObject).j, ((ley)localObject).jdField_d_of_type_JavaLangString, ((ley)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      lcv.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = lbu.a(j, (String)localObject1, new int[0]);
        localObject3 = lbu.a().a((String)localObject3, false);
        ((ley)localObject3).j = 0;
        ((ley)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((ley)localObject3).e = ((String)localObject2);
        ((ley)localObject3).F = j;
        ((ley)localObject3).ai = true;
        ((ley)localObject3).i = l2;
        ((ley)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((ley)localObject3).S = true;
        ((ley)localObject3).N = bool1;
        ((ley)localObject3).g = bool3;
        ...
        if (lyu.f())
        {
          lyu.a(l3, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((mts)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          lcv.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      lyu.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label589:
