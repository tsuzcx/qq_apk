...
{
  qfg(qfa paramqfa, ViewBase paramViewBase, pxk parampxk) {}
  
  public void onClick(ViewBase paramViewBase)
  {
    boolean bool = true;
    paramViewBase = (qkf)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreViewBase.getParent().findViewBaseByName("id_pgc_short_content_video_view");
