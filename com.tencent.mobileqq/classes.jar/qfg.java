  ...
  extends qhj
{
  ...
  private HashMap<String, qfl<Parcelable>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ConcurrentHashMap<String, qfl<FastWebArticleInfo>> b = new ConcurrentHashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = qfg.class.getSimpleName();
  }
  
  public qfg(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qxn paramqxn, Handler paramHandler)
  {
  ...
  {
    int i = bizo.a(null);
    Object localObject = bmhv.f(pkh.a());
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new qfh(this, 2012, 30, 1);
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      paramFromServiceMsg = (qfk)a(Integer.valueOf(i));
      ...
      if (str != null)
      {
        ...
        this.b.put(str, new qfl(this, paramToServiceMsg));
      }
      for (;;)
      {
        ...
        {
          paramFromServiceMsg = (qfl)this.b.get(str);
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qxp.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    paramFromServiceMsg = new tjs();
    boolean bool;
    ...
    for (;;)
    {
      paramToServiceMsg = (qfj)a(Integer.valueOf(i));
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qxp.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (tpy)a(Integer.valueOf(i));
    paramToServiceMsg = "";
  ...
  public int a(String paramString1, String paramString2, String paramString3, int paramInt, qfk paramqfk)
  {
    for (;;)
    {
      Object localObject1;
      try
      {
        QLog.d("Q.readinjoy.fast_web", 1, "getArticleContent, rowkey : " + paramString2 + ", url : " + paramString1 + " callback: " + paramqfk + ", reqType : " + paramInt);
        if ((paramInt != 2) && (paramString2 != null))
        {
          localObject1 = (qfl)this.b.get(paramString2);
          if (localObject1 != null)
          {
            if (!((qfl)localObject1).a()) {
              continue;
            }
        ...
        ((oidb_cmd0xad6.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
        ...
        if (paramInt == 1)
        {
          ...
          paramString3 = qxp.a("OidbSvc.0xad6", 2774, 0, ((oidb_cmd0xad6.ReqBody)localObject1).toByteArray());
          ...
          if (paramqfk != null)
          {
            paramqfk.a(true, ((qfl)localObject1).a, (FastWebArticleInfo)((qfl)localObject1).a());
            olh.a(null, "CliOper", "", "", "0X8009C51", "0X8009C51", 0, 0, "", "", "", "", false);
          }
          QLog.d("Q.readinjoy.fast_web", 2, "hit cache, rowkey : " + paramString2 + ", url : " + paramString1 + " isUserWeb " + ((qfl)localObject1).a);
          return -1;
        }
        if (paramInt == 3)
        {
  ...
  {
    paramString = (qfl)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
  ...
  {
    paramString = (qfl)this.b.get(paramString);
    if (paramString != null) {
  ...
  {
    return tke.a((List)this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache.get(paramString));
  }
  ...
  public void a(@NonNull ArticleInfo paramArticleInfo, int paramInt, tpy paramtpy)
  {
    ...
    for (;;)
    {
      ...
      localFeedParam.multi_level_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.a());
      ...
      try
      {
        ...
        localObject = qxp.a("OidbSvc.0xbd3", 3027, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(ArticleInfo paramArticleInfo, qfj paramqfj, boolean paramBoolean)
  {
    Object localObject1 = new oidb_cmd0xb54.ReqBody();
    Object localObject2 = new oidb_cmd0xb54.Client();
    ((oidb_cmd0xb54.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
    ...
    if (bmhv.j(this.jdField_a_of_type_ComTencentCommonAppAppInterface) != 1) {
    ...
    Object localObject3 = (qfl)this.b.get(paramArticleInfo.innerUniqueID);
    if (localObject3 != null)
    {
      localObject3 = (FastWebArticleInfo)((qfl)localObject3).a();
    ...
    localObject1 = qxp.a("OidbSvc.0xb54", 2900, 0, ((oidb_cmd0xb54.ReqBody)localObject1).toByteArray());
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, List<BaseData> paramList)
  {
    ...
    qxl.a(localReqBody.bytes_qq, pkh.a());
    Object localObject = new oidb_cmd0xe7e.WebInfo();
    qxl.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_url, paramBaseArticleInfo.mArticleContentUrl);
    try
    {
      qxl.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_domain, new URL(paramBaseArticleInfo.mArticleContentUrl).getHost());
      localReqBody.rpt_web_info.set((MessageMicro)localObject);
      qxl.a(localReqBody.bytes_rowkey, paramBaseArticleInfo.innerUniqueID);
      localObject = new ArrayList();
    ...
    catch (MalformedURLException localMalformedURLException)
    {
      for (;;)
      {
        qxl.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_domain, "post.mp.qq.com");
        ...
        if ((paramBaseArticleInfo instanceof PtsData))
        {
          ...
          a(qxp.a("OidbSvc.0xe7e", 3710, 0, localReqBody.toByteArray()));
        }
        else
        {
  ...
  {
    qfl localqfl = (qfl)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localqfl == null)
    {
      paramParcelable = new qfl(this, paramParcelable);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramParcelable);
      return;
    }
    localqfl.a(paramParcelable);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, qfj paramqfj)
  {
    oidb_cmd0xad7.ReqBody localReqBody = new oidb_cmd0xad7.ReqBody();
    Object localObject = new oidb_cmd0xad7.Client();
    ((oidb_cmd0xad7.Client)localObject).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
    ...
    try
    {
      ...
      if (paramInt == 72)
      {
        ...
        paramString3 = qxp.a("OidbSvc.0xad7", 2775, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = localRspBody.rpt_insert_module_info.get();; paramToServiceMsg = null)
    {
      ...
      pvm.a().a(new qfi(this, paramToServiceMsg, paramFromServiceMsg));
      return;
    }
  }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = qxp.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (qfj)b(Integer.valueOf(i));
    paramObject = (qfl)this.b.get(str2);
    if (paramObject == null) {
      return;
    }
    ...
    if (j == 0)
    {
      qfm.a(localRspBody, paramObject, paramFromServiceMsg, str1);
      qfm.b(localRspBody, paramObject, paramFromServiceMsg, str1);
      qfm.a(localRspBody, paramObject, paramFromServiceMsg);
      qfm.c(localRspBody, paramObject, paramFromServiceMsg, str1);
      qfm.a(localRspBody, paramObject);
      if (((Boolean)paramToServiceMsg.getAttribute("fetchBusiness", Boolean.valueOf(false))).booleanValue()) {
        qfm.b(localRspBody, paramObject, paramFromServiceMsg);
      }
    }
    for (;;)
    {
