  ...
  extends bmiv
{
  ...
  public bmjl(@NonNull bnbg parambnbg)
  {
    super(parambnbg);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(a()).inflate(2131562039, localRelativeLayout, false));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, aekt.a(40.0F, a()));
    LinearLayout localLinearLayout = this.jdField_a_of_type_AndroidWidgetLinearLayout;
    if (this.jdField_a_of_type_Bnbg.l)
    {
      i = 0;
    ...
    label120:
    for (int i = bngs.e + aekt.a(40.0F, a());; i = aekt.a(100.0F, a()))
    {
  ...
  private void j()
  {
    if ((this.jdField_a_of_type_Long < 0L) && (this.jdField_a_of_type_Bnbg.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer != null) && (this.jdField_a_of_type_Bnbg.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.a() != null))
    {
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Bnbg.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.a().mDuration;
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer = this.jdField_a_of_type_Bnbg.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer;
      ...
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130847144);
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130847143);
  ...
  public void a()
  {
    super.a();
    d();
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewRotationSeekBar = ((RotationSeekBar)a(2131365519));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)a(2131365520));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131365521));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131365518));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new bmjm(this));
