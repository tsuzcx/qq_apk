...
public class baed
{
  ...
  public baed(AppInterface paramAppInterface, Activity paramActivity, beby parambeby, Intent paramIntent, boolean paramBoolean)
  {
  ...
  {
    baee localbaee = new baee(this);
    paramTouchWebView.setWebChromeClient(localbaee);
    this.jdField_a_of_type_Nmx = localbaee;
  }
  ...
  public TouchWebView a(AppInterface paramAppInterface, Activity paramActivity, Intent paramIntent, boolean paramBoolean)
  {
    ...
    Object localObject2;
    if (badz.a(paramActivity, paramIntent.getStringExtra("url")))
    {
      localObject2 = badz.a(paramActivity);
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        ...
        String str2 = a(this.jdField_a_of_type_Beby);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label891;
        }
        paramBoolean = true;
        QLog.i("WebLog_WebViewWrapper", 1, befr.a(str1, str2, paramBoolean));
        localObject3 = new StringBuilder();
        str1 = localWebSettings.getUserAgentString();
        str2 = a(this.jdField_a_of_type_Beby);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label897;
        }
        paramBoolean = true;
        localWebSettings.setUserAgentString(befr.a(str1, str2, paramBoolean) + (String)localObject2);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aqrd = new aqrd(paramAppInterface, paramActivity, (TouchWebView)localObject1);
        this.jdField_a_of_type_Aqrd.a(paramBoolean);
        ((TouchWebView)localObject1).setDownloadListener(this.jdField_a_of_type_Aqrd);
        CookieSyncManager.createInstance(paramAppInterface.getApplication().getApplicationContext());
        if (((TouchWebView)localObject1).getX5WebViewExtension() != null)
        {
          ((TouchWebView)localObject1).getX5WebViewExtension().setWebViewClientExtension(new baeh(this, (TouchWebView)localObject1, this.jdField_a_of_type_Beby));
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(beep.x), " cost:", Long.valueOf(befq.a) });
          }
          return localObject1;
          ...
          paramAppInterface.put("coreInit", String.valueOf(befq.a));
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          baea.a().a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
        }
        for (;;)
        {
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new baef(this);; localObject = new baeg(this))
    {
