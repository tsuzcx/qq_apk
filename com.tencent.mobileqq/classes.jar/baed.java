...
public class baed
  implements SurfaceTexture.OnFrameAvailableListener, baem, AEDecoder
{
  ...
  public baed(String paramString)
  {
    this.jdField_a_of_type_Baej = new baej(paramString, 0, false, false);
  }
  ...
  public void setTexture(int paramInt)
  {
    a();
    this.j = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWVideoDecoder.a(this.jdField_a_of_type_Baej, this.k, this, this);
    this.g = 2;
  }
}
