...
public class bqit
{
  public static int a(String paramString, bqiu parambqiu)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          parambqiu.a[0] = Integer.parseInt(str1);
          parambqiu.a[1] = Integer.parseInt(str2);
          parambqiu.a[3] = Integer.parseInt(str3);
          i = 0;
        }
        ...
        try
        {
          parambqiu.a[2] = Integer.parseInt(paramString);
          parambqiu.a[4] = 0;
          return i;
        }
