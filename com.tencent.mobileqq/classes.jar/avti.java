...
public class avti
{
  ...
  public avti(QQAppInterface paramQQAppInterface, long paramLong)
  {
    this(paramQQAppInterface, paramLong, "OnlineDating", "Group");
  }
  
  public avti(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2)
  {
  ...
  private CommProtocolProto.commRequest a(int paramInt)
  {
    ...
    localcommRequest.network.set(avtm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
    ...
    localcommRequest.client_release.set("8.4.10");
  ...
  private void a(int paramInt, CommProtocolProto.commResponse paramcommResponse, Bundle paramBundle, avtl paramavtl)
  {
    ...
    for (paramcommResponse = "null";; paramcommResponse = paramBundle.toString())
    {
      ...
      if (paramavtl != null)
      {
        ...
        paramavtl.a(paramInt, (byte[])localObject, paramBundle);
      }
      return;
    ...
    label287:
    ThreadManager.getUIHandler().post(new ODCsChannel.4(this, paramavtl, paramInt, (byte[])localObject, paramBundle));
  }
  ...
  private void b(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, avtl paramavtl)
  {
    ThreadManagerV2.excute(new ODCsChannel.1(this, paramInt2, paramInt1, paramArrayOfByte, paramBoolean, paramavtl), 128, null, true);
  }
  ...
  private void c(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, avtl paramavtl)
  {
    ...
    ntb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new avtk(this, paramInt2, paramInt1, paramBoolean, paramavtl), localcommRequest.toByteArray(), this.jdField_a_of_type_JavaLangString + "." + localcommRequest.cmd);
  }
  
  public void a(int paramInt1, byte[] paramArrayOfByte, int paramInt2, avtl paramavtl)
  {
    ...
    ntb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new avtj(this, paramInt2, paramInt1, paramavtl), localcommRequest.toByteArray(), this.jdField_a_of_type_JavaLangString + "." + 10401);
  }
  
  public void a(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, avtl paramavtl)
  {
    if (this.jdField_a_of_type_AndroidOsBundle == null)
    {
      b(paramInt1, paramArrayOfByte, paramBoolean, paramInt2, paramavtl);
      return;
    }
    if ((this.jdField_a_of_type_ComTencentJungleVideohubProtoCommonUserProto$LoginCheckRsp == null) && (paramBoolean))
    {
      a(paramInt1, paramArrayOfByte, paramInt2, paramavtl);
      return;
    }
    c(paramInt1, paramArrayOfByte, paramBoolean, paramInt2, paramavtl);
  }
  
  public void a(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean, avtl paramavtl)
  {
    a(paramInt, paramArrayOfByte, paramBoolean, 0, paramavtl);
  }
}
