  ...
  extends ayoy
{
  ...
  akat jdField_a_of_type_Akat = new aypo(this);
  protected ayvx a;
  ...
  private aypd e;
  protected byte[] e;
  private aypd jdField_f_of_type_Aypd = new aypd();
  private byte[] jdField_f_of_type_ArrayOfByte;
  private boolean jdField_g_of_type_Boolean;
  private byte[] jdField_g_of_type_ArrayOfByte;
  
  public aypl(ayvx paramayvx, aywc paramaywc)
  {
    super(paramayvx, paramaywc);
    this.jdField_e_of_type_Aypd = new aypd();
    ...
    this.jdField_a_of_type_Ayqo.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Ayqo.q = this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Ayqo.jdField_h_of_type_Int = 0;
    this.jdField_a_of_type_Ayqo.jdField_a_of_type_Boolean = true;
    ...
    {
      this.jdField_g_of_type_Boolean = ((MessageForPic)this.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).isStoryPhoto;
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_Ayqo.jdField_h_of_type_JavaLangString != null) {
            ((im_msg_body.NotOnlineImage)localObject3).download_path.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Ayqo.jdField_h_of_type_JavaLangString));
          }
          if (this.jdField_a_of_type_Ayqo.jdField_g_of_type_JavaLangString != null) {
            ((im_msg_body.NotOnlineImage)localObject3).res_id.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Ayqo.jdField_g_of_type_JavaLangString));
          }
          ...
          case 1008: 
            if (QLog.isColorLevel()) {
              b("busiTypeStat", "uiBusiType:" + this.jdField_a_of_type_Aywc.jdField_e_of_type_Int + " protoBusiType:" + ((im_msg_body.NotOnlineImage)localObject3).biz_type.get());
            }
            localObject1 = new im_msg_body.Elem();
            if (!ajwb.a((MessageRecord)localObject4)) {
              break label1020;
            }
            ...
            ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8(ajya.a(2131701292)));
            ...
            localObject5 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, this.jdField_a_of_type_Aywc.jdField_a_of_type_Long);
            ...
            ((axwv)localObject4).U = this.jdField_c_of_type_JavaLangString;
            if (this.jdField_f_of_type_JavaLangString != null) {
              break label1040;
            }
            localObject1 = this.jdField_l_of_type_JavaLangString;
            ((axwv)localObject4).T = ((String)localObject1);
            ((axwv)localObject4).d = this.jdField_q_of_type_Long;
            ((axwv)localObject4).jdField_e_of_type_Long = ((MessageRecord)localObject5).time;
            if (!aeht.b(localStructMsgForImageShare.mMsgActionData)) {
              break label1048;
            }
            localObject5 = ((axwv)localObject4).S;
            ((axwv)localObject4).S = "";
            localObject1 = ((MessageForStructing)localObject3).structingMsg.getXmlBytes();
            ((axwv)localObject4).S = ((String)localObject5);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        this.jdField_a_of_type_Ayqo.jdField_g_of_type_JavaLangString = paramArrayOfByte;
        this.jdField_f_of_type_JavaLangString = paramArrayOfByte;
        this.jdField_a_of_type_Ayqo.jdField_h_of_type_JavaLangString = paramArrayOfByte;
  ...
  private void v()
  {
    this.jdField_a_of_type_Ayvx.a.post(new C2CPicUploadProcessor.2(this));
  }
  
  private void w()
  {
    this.jdField_a_of_type_Ayqo.jdField_a_of_type_Ayqp.a();
    this.jdField_a_of_type_Ayqo.jdField_b_of_type_Ayqp.a();
    ...
    localayqo.jdField_g_of_type_Long = l;
    this.jdField_k_of_type_Long = l;
    this.jdField_a_of_type_Ayqo.jdField_h_of_type_Long = 0L;
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_Aypd.a(1) + ";" + this.jdField_b_of_type_Aypd.a(2) + ";" + this.jdField_c_of_type_Aypd.a(3);
    Object localObject2 = this.jdField_e_of_type_Aypd.a(21) + ";" + this.jdField_f_of_type_Aypd.a(22);
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("C2CPicUploadProcessor", 2, "<BDH_LOG> mStepUrl: " + this.jdField_a_of_type_Aypd.toString() + ";mStepTrans: " + this.jdField_b_of_type_Aypd.toString() + ";mStepMsg: " + this.jdField_c_of_type_Aypd.toString() + ";mStepTransPre: " + this.jdField_e_of_type_Aypd.toString() + ";mStepTransLeft: " + this.jdField_f_of_type_Aypd.toString() + ";");
    }
    if (!bool)
    {
    ...
    if (this.jdField_a_of_type_Aywc.jdField_e_of_type_Int == 1030) {}
    label505:
    Object localObject3;
    while (((!bool) && (ayuc.b(this.jdField_j_of_type_Int))) || (this.h) || ((bool) && ((this.jdField_m_of_type_Int & 0x2) > 0)) || ((!bool) && ((this.jdField_m_of_type_Int & 0x1) > 0)))
    {
      return;
    ...
    if (bool)
    {
      ...
      Log.i("AutoMonitor", "SendC2CPic, cost=" + (this.jdField_b_of_type_Aypd.jdField_b_of_type_Long - this.jdField_b_of_type_Aypd.jdField_a_of_type_Long) / 1000000L);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_Aywc.jdField_i_of_type_Boolean)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("C2CPicUploadProcessor", 2, "doReport ,mStartTime = " + this.jdField_k_of_type_Long + ",mEnterAioTime = " + this.jdField_u_of_type_Long + ",finishTime  = " + l3 + ", aioDuration = " + l1 + ", duration = " + l2 + "processor:" + this + ",mUiRequest.myPresendInvalid = " + this.jdField_a_of_type_Aywc.j + ",Percent = " + d1);
        }
      }
    ...
    axrn.a(BaseApplication.getContext()).a(null, b(), true, l2, this.jdField_q_of_type_Long, (HashMap)localObject1, "");
    for (;;)
    {
      b(bool, l2);
      l();
  ...
  protected byte[] a()
  {
    this.jdField_f_of_type_ArrayOfByte = SessionInfo.getInstance(this.jdField_a_of_type_Aywc.jdField_b_of_type_JavaLangString).getSessionKey();
    ...
    do
    {
      ...
      {
        return null;
        this.jdField_g_of_type_ArrayOfByte = SessionInfo.getInstance(this.jdField_a_of_type_Aywc.jdField_b_of_type_JavaLangString).getHttpconn_sig_session();
        if ((this.jdField_g_of_type_ArrayOfByte == null) || (this.jdField_g_of_type_ArrayOfByte.length == 0))
        {
          ...
          try
          {
            l1 = Long.valueOf(this.jdField_a_of_type_Aywc.jdField_b_of_type_JavaLangString).longValue();
            localObject2 = this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString;
  ...
  public int b()
  {
    if (this.jdField_k_of_type_Boolean)
    {
      ...
      w();
      this.jdField_a_of_type_Ayvx.a.post(new C2CPicUploadProcessor.5(this));
    }
    return 0;
  }
  ...
  protected void b(ayyp paramayyp, ayze paramayze)
  {
    ...
    if (paramayze != null)
    {
      ...
      if (i < paramayze.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        if (paramayyp.jdField_a_of_type_Boolean)
        {
          ...
          str = paramayyp.jdField_a_of_type_JavaLangString;
          localayqo.jdField_g_of_type_JavaLangString = str;
          this.jdField_f_of_type_JavaLangString = str;
          localayqo = this.jdField_a_of_type_Ayqo;
          paramayyp = paramayyp.jdField_b_of_type_JavaLangString;
          localayqo.jdField_h_of_type_JavaLangString = paramayyp;
    ...
    do
    {
      ...
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_f_of_type_JavaLangString = str;
        localayqo = this.jdField_a_of_type_Ayqo;
        str = paramayyp.jdField_b_of_type_JavaLangString;
        localayqo.jdField_h_of_type_JavaLangString = str;
        this.jdField_l_of_type_JavaLangString = str;
      }
      for (;;)
      {
        this.jdField_m_of_type_JavaLangString = paramayyp.jdField_c_of_type_JavaLangString;
        this.jdField_r_of_type_Long = paramayyp.jdField_a_of_type_Long;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_f_of_type_Aypd.a();
        break;
        this.jdField_b_of_type_Aypd.jdField_a_of_type_Long = 0L;
        this.jdField_b_of_type_Aypd.a();
      }
      s();
      break;
      d("<BDH_LOG> onBusiProtoResp() error : " + paramayyp.jdField_c_of_type_Int + " ,select HTTP channel");
      this.w = 2;
    } while ((this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.isFinish.get()) && (this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.isSuccess.get()));
    label425:
    label432:
  ...
  protected byte[] b()
  {
    ...
    case 2: 
      ...
      localObject = this.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
  ...
  public int c()
  {
    ...
    localObject = this.jdField_a_of_type_Aywc.jdField_i_of_type_JavaLangString;
  ...
  void e()
  {
    ...
    if (this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq != null)
    {
      ...
      if (this.jdField_f_of_type_JavaLangString == null)
      {
        ...
        if (this.jdField_a_of_type_Aywc.r) {
          localauor.jdField_a_of_type_JavaLangObject = a();
        }
        this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq.b(localauor);
      }
    }
  ...
  protected void f()
  {
    ...
    if (this.jdField_a_of_type_Aywc.jdField_a_of_type_Int == 1006)
    {
      ...
      localayyy.b = this.jdField_l_of_type_Boolean;
  ...
  protected void r()
  {
    ...
    {
      this.p = localaywc.l;
      this.jdField_q_of_type_Int = localaywc.jdField_m_of_type_Int;
  ...
  public void s()
  {
    ...
    aypm localaypm = new aypm(this, SystemClock.uptimeMillis());
    if (this.jdField_a_of_type_Boolean) {}
    for (this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4, this.jdField_a_of_type_Aywc.jdField_i_of_type_JavaLangString, (int)this.jdField_r_of_type_Long, this.jdField_d_of_type_ArrayOfByte, this.jdField_a_of_type_ArrayOfByte, localaypm, this.jdField_a_of_type_Int, this.jdField_e_of_type_ArrayOfByte, this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolCSDataHighwayHead$LoginSigHead);; this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1, this.jdField_a_of_type_Aywc.jdField_i_of_type_JavaLangString, (int)this.jdField_r_of_type_Long, (byte[])localObject, this.jdField_a_of_type_ArrayOfByte, localaypm))
    {
      localObject = new aypn(this);
