...
public class tlb
{
  ...
  public static tlb a(int paramInt, JSONObject paramJSONObject)
  {
    JSONObject localJSONObject = paramJSONObject;
    if (paramJSONObject == null) {
      localJSONObject = new JSONObject();
    }
    paramJSONObject = new tlb(paramInt);
    paramJSONObject.jdField_a_of_type_Int = paramInt;
    paramJSONObject.jdField_c_of_type_Int = nzv.a(localJSONObject.optString("width"), 50);
    paramJSONObject.jdField_d_of_type_Int = nzv.a(localJSONObject.optString("minWidth"), 50);
    if (paramJSONObject.jdField_c_of_type_Int < paramJSONObject.jdField_d_of_type_Int)
    {
      ...
      paramJSONObject.jdField_e_of_type_Int = nzv.a(localJSONObject.optString("height"), 20);
      paramJSONObject.jdField_f_of_type_Int = nzv.a(localJSONObject.optString("maxHeight"), 22);
      if (paramJSONObject.jdField_e_of_type_Int >= 18) {
        break label275;
      }
      paramJSONObject.jdField_e_of_type_Int = 18;
      label122:
      paramJSONObject.jdField_a_of_type_Float = nzv.a(localJSONObject.optString("corner"), 2.0F);
    ...
    for (;;)
    {
      paramJSONObject.jdField_b_of_type_JavaLangString = nzv.a(localJSONObject, "progressBg", "#F2F2F2");
      paramJSONObject.jdField_c_of_type_JavaLangString = nzv.a(localJSONObject, "secondaryProgressBg", "#F2F2F2");
      paramJSONObject.jdField_a_of_type_JavaLangString = nzv.a(localJSONObject, "progressColor", "#12B7F5");
      paramJSONObject.jdField_d_of_type_JavaLangString = nzv.a(localJSONObject, "textColor", "#ffffff");
      paramJSONObject.g = localJSONObject.optInt("textSize", 12);
      paramJSONObject.h = 10;
      paramJSONObject.i = 16;
      paramJSONObject.jdField_e_of_type_JavaLangString = nzv.a(localJSONObject, "buttonBorderColor", "#12B7F5");
      paramJSONObject.jdField_b_of_type_Float = nzv.a(localJSONObject.optString("buttonBorderSize", "0"), 0.0F);
      paramJSONObject.j = 2;
