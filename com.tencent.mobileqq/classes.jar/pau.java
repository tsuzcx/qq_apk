  ...
  extends pbh
{
  ...
  public pau(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  public static void a(String paramString)
  {
    ...
    for (;;)
    {
      noo.a(null, "", paramString, paramString, 0, 0, "" + i, onk.a(), "0", null, false);
      return;
      i = 1;
      continue;
      i = 0;
  ...
  {
    Object localObject = ajyc.a(2131704860);
    int i = ((String)localObject).indexOf("领取1G流量");
    localObject = new SpannableString((CharSequence)localObject);
    ((SpannableString)localObject).setSpan(new pav(), i, i + 6, 33);
    return localObject;
  }
    ...
    if (i == 0) {
      if (paramToServiceMsg.has())
      {
        if (this.jdField_a_of_type_Paw == null) {
          this.jdField_a_of_type_Paw = new paw();
        }
        if (paramToServiceMsg.uint32_receive_status.has()) {
          this.jdField_a_of_type_Paw.jdField_a_of_type_Int = paramToServiceMsg.uint32_receive_status.get();
        }
        if (paramToServiceMsg.bytes_jump_url.has()) {
          this.jdField_a_of_type_Paw.jdField_a_of_type_JavaLangString = paramToServiceMsg.bytes_jump_url.get().toStringUtf8();
        }
        if (paramToServiceMsg.uint32_flag.has())
        {
          paramFromServiceMsg = this.jdField_a_of_type_Paw;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("FreeNetFlowInfoModule", 2, "free netflow, status: " + this.jdField_a_of_type_Paw.jdField_a_of_type_Int + ", jumpUrl: " + this.jdField_a_of_type_Paw.jdField_a_of_type_JavaLangString + ", isActive: " + this.jdField_a_of_type_Paw.jdField_a_of_type_Boolean);
        }
      }
    }
    label223:
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Paw != null)
    {
      String str = this.jdField_a_of_type_Paw.jdField_a_of_type_JavaLangString;
      localObject = str;
      if (QLog.isColorLevel())
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Paw != null)) {
        this.jdField_a_of_type_Paw.a();
      }
      return;
    }
  }
  ...
  public boolean a()
  {
    return (!this.b) && (this.jdField_a_of_type_Paw != null) && (this.jdField_a_of_type_Paw.a());
  }
