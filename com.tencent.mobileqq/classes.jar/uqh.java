...
public class uqh
{
  ...
  {
    paramString2 = uqt.b(paramString2);
    uqf.d("WeishiScehmeUtil", "openWeishi: scheme = " + paramString2);
    jdField_a_of_type_Boolean = true;
    zqd.a(paramContext, paramString1, paramString2);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      uqf.d("WeishiScehmeUtil", "openWeishi context = " + paramContext + "scheme = " + paramString2);
      return;
    }
    ...
    uqf.c("WeishiScehmeUtil", "openWeishi final scheme = " + paramString2);
