...
class arcg
{
  ...
  private ArrayList<arci> jdField_a_of_type_JavaUtilArrayList;
  
  public arcg(String paramString)
  {
  ...
  public Object a(Map<String, Object> paramMap)
  {
    ...
    for (;;)
    {
      ...
      paramMap = ((arci)localIterator.next()).a(paramMap);
    }
  }
  
  public ArrayList<arci> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (i < localArrayList.size())
        {
          ...
          if (str1.charAt(0) == '.')
          {
            paramString.add(new arcj(str1.substring(1)));
          }
          else
          {
            String str2 = arck.a().b(str1);
            if (!TextUtils.isEmpty(str2)) {
              paramString.add(new arcj(str2));
            }
          }
        }
      }
      ...
      return paramString;
      String str1 = arck.a().a(str1);
      if (!TextUtils.isEmpty(str1)) {
        paramString.add(new arch(Integer.parseInt(str1)));
      } else {
        return null;
      }
      i += 1;
