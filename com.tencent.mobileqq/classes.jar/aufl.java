...
public class aufl
  ...
  implements Manager
{
  private ajhi jdField_a_of_type_Ajhi = new aufn(this);
  private ajjh jdField_a_of_type_Ajjh = new aufm(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public aufl(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Ajjh);
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Ajhi);
  }
  ...
  public static aufo a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    return new aufo(paramQQAppInterface, paramString, paramInt1, paramInt2, paramMessage, null);
  }
  ...
  private QCallRecent a(MessageForVideo paramMessageForVideo)
  {
    ...
    localQCallRecent.lastCallMsg = bado.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramMessageForVideo.text);
    ...
    catch (Exception paramMessageForVideo)
    {
      for (;;)
      {
        ...
        else
        {
          ...
          if (QLog.isColorLevel())
          {
            QLog.d("QCallFacade", 2, "getMessageToCallRecord java.lang.NumberFormatException: Invalid int: " + arrayOfString[1] + " msg byte " + azzz.a(str));
            paramMessageForVideo = (MessageForVideo)localObject;
          }
        }
      }
  ...
  private void a(QCallRecent paramQCallRecent, String paramString)
  {
    ...
    if ((akbm.c(paramQCallRecent.type)) && (paramQCallRecent.state == 5))
    {
      a(1);
      return;
    }
  ...
  public int a()
  {
    ...
    do
    {
      ...
      localObject = ((akeu)localObject).a(false);
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        DiscussionMemberInfo localDiscussionMemberInfo = ((ajhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      if ((localRecentUser.getType() != 0) || ((!FriendsStatusUtil.a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (!acxd.a(localRecentUser.uin, localRecentUser.getType(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))) {
  ...
  public int a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    while ((paramMessageRecord.msgtype != -2026) && (!akbm.c(paramInt))) {
      return i;
    }
    return 1;
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    for (j = k;; j = k)
    {
      ...
      if ((j == 1) || (i == 1)) {
        if (paramBoolean) {
          if (paramString != null) {
            ((StringBuilder)localObject1).append(paramString).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630197));
          }
        }
      }
      for (;;)
      {
        ...
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630538));
        }
        else
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630001));
          continue;
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630159, new Object[] { "" + i, "" + j }));
        }
      }
      break label238;
      break label192;
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        if (localQCallRecord.time > l1)
        {
          ...
          localObject = awbi.a(-2016);
          ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630245);
      ...
      for (((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630246);; ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131630244))
      {
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    ...
    ((QCallRecord)localObject).time = awao.a();
    ...
    if (paramInt == 1)
    {
      ...
      ((QCallRecent)localObject).lastCallTime = awao.a();
  ...
  public void a(int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    localQCallRecent.lastCallTime = awao.a();
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean1, long paramLong3, boolean paramBoolean2)
  {
    ...
    while ((((ajhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(String.valueOf(paramLong1)) == null) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong2)))) {
      return;
    }
  ...
  public void a(MessageForVideo paramMessageForVideo)
  {
    ...
    {
      awqx.b(localQQAppInterface, "CliOper", "", "", "0X8004067", "0X8004067", 0, 0, paramMessageForVideo, "", "", "");
    ...
    for (paramMessageForVideo = "1";; paramMessageForVideo = "0")
    {
      awqx.b(localQQAppInterface, "CliOper", "", "", "Msg_tab", "Call_history_count", 0, 0, paramMessageForVideo, "", "", "");
      break;
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    localQCallRecent.readTime = awao.a();
    if (QLog.isDevelopLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4)
  {
    ...
    do
    {
      ...
      } while ((localajjj != null) && (!localajjj.b(paramString1)));
    } while ((paramString1 == null) || ((paramInt1 == 3000) && (((ajhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString1) == null)));
    paramString1 = a().a(paramString1, paramInt1);
    if ((paramInt4 == 6) || (paramInt4 == 5) || (paramString1.isMissedCall())) {
      paramString1.lastCallTime = awao.a();
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    localaufp.a((QCallRecord)localObject);
    localObject = localaufp.a(paramString1, paramInt1);
    ...
    localaufp.d((QCallRecent)localObject);
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    paramString2.lastCallTime = awao.a();
  ...
  {
    int k = 0;
    Object localObject2 = (aroh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11);
    ...
    for (;;)
    {
      ...
      return;
      localObject2 = ((aroh)localObject2).c(paramString);
      break;
      label152:
      i = 0;
      break label57;
      ...
      break label77;
      label162:
      localObject1 = ((ajjj)localObject1).e(((PhoneContact)localObject2).uin);
      break label89;
      label177:
      j = 0;
      break label104;
