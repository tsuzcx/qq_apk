...
{
  public biff(HealthBusinessPlugin paramHealthBusinessPlugin, bifn parambifn, IVideoViewBase paramIVideoViewBase, FrameLayout paramFrameLayout) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Bifn.c.setImageResource(2130841767);
      ((View)this.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).setOnTouchListener(new bifg(this));
      this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131376731).setVisibility(8);
    ...
    for (this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.d = true;; this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.d = false)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131376731).setVisibility(0);
      if (((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(16908290).getParent().getParent()).getChildAt(1) != null) {
      ...
      this.jdField_a_of_type_Bifn.c.setImageResource(2130841766);
