...
public class zyh
{
  ...
  private static final Property<ImageView, Matrix> jdField_a_of_type_AndroidUtilProperty = new zyl(Matrix.class, "animatedTransform");
  ...
  private zyo jdField_a_of_type_Zyo;
  ...
  public zyh(Bundle paramBundle, zyp paramzyp)
  {
    if ((paramBundle == null) || (paramzyp == null)) {
      return;
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 16)
          {
            ...
            localBundle.putString("bundle_key_source_image_param", new zyo((String)localObject, paramInt1, paramInt2).a());
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_Zyg != null) && (this.jdField_a_of_type_Zyg.a())) {
      return;
    }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (this.jdField_a_of_type_Zyg != null) {
      this.jdField_a_of_type_Zyg.a(2);
    }
    ...
    ((ObjectAnimator)localObject1).addListener(new zyj(this, paramInt4, paramInt3, paramInt1, paramInt2));
    ...
    localObject2 = ObjectAnimator.ofObject(this.jdField_a_of_type_AndroidWidgetImageView, jdField_a_of_type_AndroidUtilProperty, new zym(), new Matrix[] { localObject2, localObject3 });
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new zyk(this));
  ...
  {
    this.jdField_a_of_type_Zyg = new zyg();
    ...
    this.jdField_a_of_type_Zyo = new zyo();
    this.jdField_a_of_type_Zyo.a(str);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Zyo.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Zyo.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Zyo.jdField_b_of_type_Int;
  ...
  private void c()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
      {
        ...
        localLayoutParams.topMargin = this.jdField_a_of_type_Zyp.a();
    ...
    } while (this.jdField_a_of_type_Zyg == null);
    this.jdField_a_of_type_Zyg.a(1);
  }
  
  private void d()
  {
    int[] arrayOfInt = this.jdField_a_of_type_Zyp.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_Zyg == null) || (!this.jdField_a_of_type_Zyg.b())) {
      QLog.d("TransitionAnimHelper", 1, "initImageEnterAnimation error!");
    }
    while (this.jdField_b_of_type_AndroidWidgetImageView == null) {
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnPreDrawListener(new zyi(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Zyg != null) {
      this.jdField_a_of_type_Zyg.a(paramzyq);
    }
  }
}
