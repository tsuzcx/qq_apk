...
public class aroo
{
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramActivity = arvo.a(paramFileManagerEntity);
    paramActivity.b(i);
    ...
    paramActivity.putExtra("forward_text", alpo.a(2131710094) + arni.d(paramFileManagerEntity.fileName) + alpo.a(2131710106) + arof.a(paramFileManagerEntity.fileSize) + "。");
    paramActivity.putExtra("k_favorites", arni.c(paramFileManagerEntity));
    if ((!arof.b(paramFileManagerEntity.getFilePath())) && ((paramFileManagerEntity.getCloudType() == 6) || (paramFileManagerEntity.getCloudType() == 7)) && (paramFileManagerEntity.nFileType == 0)) {
      paramActivity.putExtra("forward_type", 0);
    }
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    bbpe localbbpe = bcjk.a(paramQQAppInterface, localFileManagerEntity);
    ...
    if (!TextUtils.isEmpty(localFileManagerEntity.getFilePath())) {
      localForwardFileInfo.a(localbbpe.jdField_a_of_type_JavaLangString);
    }
    localForwardFileInfo.d(localbbpe.g);
    localForwardFileInfo.d(localbbpe.jdField_c_of_type_Long);
    localForwardFileInfo.a(localFileManagerEntity.TroopUin);
    paramFileManagerEntity = localbbpe.d;
    paramQQAppInterface = paramFileManagerEntity;
    if (TextUtils.isEmpty(paramFileManagerEntity)) {
      paramQQAppInterface = localbbpe.jdField_c_of_type_JavaLangString;
    }
    ...
    for (;;)
    {
      ...
      paramFileManagerEntity.putExtra("forward_text", localbbpe.g);
      paramFileManagerEntity.putExtra("forward_from_troop_file", true);
      return paramFileManagerEntity;
      if (localbbpe.jdField_a_of_type_JavaUtilUUID != null) {
        localForwardFileInfo.e(localbbpe.jdField_a_of_type_JavaUtilUUID.toString());
      }
  ...
  public static Rect a(Context paramContext, Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if ((bngs.c) && (bngs.a))
      {
        paramInt1 = bngs.b((Activity)paramContext);
  ...
  public static SpannableString a(String paramString1, String paramString2, arnx paramarnx)
  {
    ...
    for (int i = Color.parseColor("#A3CCEF");; i = j)
    {
      ...
      paramString1.setSpan(new aper(new arop(paramarnx), paramString2), k, k + m, 33);
      return paramString1;
    }
  }
  
  public static bbpe a(QQAppInterface paramQQAppInterface, long paramLong, bbnr parambbnr)
  {
    bbpe localbbpe2 = TroopFileTransferManager.a(paramQQAppInterface, paramLong).a(parambbnr.b);
    bbpe localbbpe1 = localbbpe2;
    if (localbbpe2 == null)
    {
      localbbpe1 = bcjk.a(paramQQAppInterface, paramLong, parambbnr.jdField_a_of_type_JavaUtilUUID.toString(), parambbnr.b, parambbnr.jdField_c_of_type_JavaLangString, parambbnr.jdField_a_of_type_Long, parambbnr.jdField_a_of_type_Int);
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, TextView paramTextView1, TextView paramTextView2, String paramString1, String paramString2)
  {
    ...
    int i = aekt.a(7.0F, paramContext.getResources());
    int j = (int)paramTextView2.measureText(paramString2);
    int k = aekt.a(15.0F, paramContext.getResources());
    switch (paramInt1)
    {
    case 1: 
    default: 
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      if (localStringBuilder.length() > 0) {
        localStringBuilder.append(paramContext.getString(2131692552));
      }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    localFile = new File(armo.a().b() + ".video_frame/");
    bdcs.a(localFile.getAbsolutePath());
    localFile.mkdirs();
    localFile = new File(localFile.getAbsolutePath(), System.currentTimeMillis() + ".jpg");
    try
    {
      bdda.a(paramBitmap, localFile);
  ...
  private static String a(AppInterface paramAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (arni.b((String)localObject)))
      {
        if (QLog.isDebugVersion()) {
      ...
      str1 = str1 + bdcv.a(paramAppInterface.getBytes()) + ".tmp";
      if (arof.a(str1) > 0L) {
        localObject = str1;
      }
      for (;;)
      {
        if (arni.b((String)localObject))
        {
          if (QLog.isDebugVersion()) {
        ...
        paramAppInterface = armo.a().c() + bhma.a(paramAppInterface);
        if (!arni.b(paramAppInterface)) {
          break;
        }
        if (QLog.isDebugVersion()) {
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      if (((bcjl)localObject).a(String.valueOf(paramLong1), String.valueOf(paramLong2))) {
        return alpo.a(2131710095);
      }
      localObject = ((bcjl)localObject).a(String.valueOf(paramLong1));
      paramQQAppInterface = (TroopManager)paramQQAppInterface.getManager(52);
      if ((localObject != null) && (((bcjs)localObject).jdField_a_of_type_Long != 0L))
      {
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   194: iconst_1
    //   195: invokestatic 900	avqz:a	(Ljava/lang/String;I)Z
    //   198: istore 4
    //   200: aload 8
    //   202: ldc_w 902
    //   205: iload 4
    ...
    //   224: invokestatic 903	avqz:a	(Ljava/lang/String;)Ljava/lang/String;
    //   227: astore 7
    //   229: aload 7
    ...
    //   326: aload_2
    //   327: aload 7
    //   329: invokestatic 929	agem:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   332: iconst_m1
    //   333: iload 6
    //   335: invokestatic 934	bilx:a	(Landroid/content/Context;Landroid/os/Bundle;Lagft;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   338: return
    //   339: aload 8
    //   341: ldc_w 850
    //   344: iconst_1
    ...
    //   441: aload_2
    //   442: aload 7
    //   444: invokestatic 929	agem:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   447: iconst_m1
    //   448: aload_3
    //   449: getfield 949	com/tencent/mobileqq/activity/aio/SessionInfo:c	I
    //   452: invokestatic 934	bilx:a	(Landroid/content/Context;Landroid/os/Bundle;Lagft;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   455: return
    //   456: astore_0
    //   457: aload_0
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, arnx paramarnx)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramString2))) {
      if (paramTextView.getWidth() == 0) {
        paramTextView.post(new QFileUtils.2(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramarnx));
      }
    }
    while (TextUtils.isEmpty(str.replace(" ", "")))
    {
      return;
      b(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramarnx);
      return;
    }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, String paramString7, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("report_params", xwb.a(paramString3, paramString1, paramString5, paramString2, paramString6, paramInt1));
  ...
  public static void a(Context paramContext, String paramString, areh paramareh)
  {
    if (!bdcs.b(paramString)) {
      return;
    }
    ThreadManagerV2.executeOnSubThread(new QFileUtils.7(paramContext, paramString, paramareh));
  }
  ...
  {
    if (bdee.a(paramActivity) == 0)
    {
      bcig.a(paramActivity, paramActivity.getString(2131698040));
      return;
    }
    ...
    arum.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    {
      return;
      paramString2 = bcjk.a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramString3, paramLong2, paramInt);
    } while (paramString2 == null);
    paramString1 = new Bundle();
    paramString1.putInt("dataline_forward_type", 100);
    if (bdcs.b(paramString2.jdField_a_of_type_JavaLangString)) {
      paramString1.putString("dataline_forward_path", paramString2.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      paramQQAppInterface = (allz)paramQQAppInterface.a(8);
      paramString2 = new aroq(paramContext);
      paramInt = paramQQAppInterface.a().b(aljq.z, paramString1, paramString2);
      if ((paramString2.a) && (paramInt != 0)) {
        break;
      }
      cx.b(paramContext, paramInt);
      return;
      paramString3 = arni.a(paramString2);
      paramString3.status = 2;
      paramString3.nOpType = 24;
      paramString3 = arvo.a(paramString3);
      paramString3.d(1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bbpe parambbpe, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    a(paramQQAppInterface, paramContext, paramSessionInfo, paramChatMessage, paramLong1, parambbpe, paramString, paramLong2, paramInt1, paramInt2, paramRect, paramBoolean1, paramBoolean2, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bbpe parambbpe, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      parambbpe = new arhn(paramQQAppInterface, paramContext, paramLong1, parambbpe, paramInt1);
      parambbpe.a(paramLong2);
      parambbpe.a(paramString);
      parambbpe.a(paramSessionInfo);
      parambbpe.a(paramChatMessage);
      parambbpe.a(paramBoolean1);
      parambbpe.b(paramBoolean3);
      ...
      paramContext = new arhj(paramContext, parambbpe);
  ...
  {
    aqsz.a(paramContext, new aros(paramQQAppInterface, paramContext, paramFileManagerEntity, paramInt2, paramSessionInfo, paramChatMessage, paramBoolean1, paramBoolean2, paramInt1, paramRect));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity)
  {
    ...
    do
    {
      ...
      paramFileManagerEntity = (allz)paramQQAppInterface.a(8);
      localarow = new arow(paramContext);
      i = paramFileManagerEntity.a().b(aljq.z, localBundle, localarow);
    } while ((localarow.a) && (i != 0));
    cx.b(paramContext, i);
    azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800644B", "0X800644B", 0, 0, "6", "", "", "");
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!arni.a(paramMessageRecord1))) {}
    int i;
    do
    {
      String str;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<bbnr> paramList, Activity paramActivity, long paramLong)
  {
    ...
    {
      bbpe localbbpe = a(paramQQAppInterface, paramLong, (bbnr)paramList.next());
      FileManagerEntity localFileManagerEntity = arni.a(localbbpe);
      localFileManagerEntity.status = 2;
      ...
      {
        localForwardFileInfo.f(localbbpe.jdField_c_of_type_JavaLangString);
        label209:
        localForwardFileInfo.d(1);
        localForwardFileInfo.a(3);
        if (!bdcs.b(localbbpe.jdField_a_of_type_JavaLangString)) {
          break label295;
        }
        localArrayList2.add(Uri.parse(localbbpe.jdField_a_of_type_JavaLangString));
      }
      for (;;)
      {
        long l2 = localbbpe.jdField_c_of_type_Long;
        localArrayList1.add(localForwardFileInfo);
        l1 = l2 + l1;
        break;
        if (TextUtils.isEmpty(localbbpe.d)) {
          break label209;
        }
        localForwardFileInfo.f(localbbpe.d);
        break label209;
        label295:
    ...
    paramQQAppInterface = alpo.a(2131710096);
    if (localArrayList1.size() == 1) {
      paramQQAppInterface = alpo.a(2131710104) + arni.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + alpo.a(2131710105) + arof.a(((ForwardFileInfo)localArrayList1.get(0)).d()) + "。";
    }
    for (;;)
    {
      paramList.putExtra("forward_text", paramQQAppInterface);
      paramList.putExtra("k_favorites", false);
      arum.a(paramActivity, paramList, 103);
      return;
      if (localArrayList1.size() > 1) {
        paramQQAppInterface = alpo.a(2131710100) + arni.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + alpo.a(2131710099) + localArrayList1.size() + alpo.a(2131710102) + arof.a(l1) + "。";
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    return a(paramContext, paramString, arni.a(arni.a(paramString)));
  }
  ...
  public static boolean a(Context paramContext, String paramString, Uri paramUri)
  {
    ...
    //   1: astore 5
    //   3: aload_1
    //   4: invokestatic 1025	bdcs:b	(Ljava/lang/String;)Z
    //   7: ifne +5 -> 12
    //   10: iconst_0
    //   11: ireturn
    //   12: aload_2
  ...
  public static boolean a(Context paramContext, boolean paramBoolean, aroi paramaroi)
  {
    int j = 2;
    boolean bool1;
    ...
    do
    {
      ...
      i = 3;
      bool2 = bdvr.a(localActivity, i, new arot(paramaroi), "");
      bool1 = bool2;
    } while (!bool2);
    ...
    for (int i = j;; i = 1)
    {
      return bevd.a(paramContext, i, new arou(paramaroi));
      i = 2;
      break;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (aqpu)paramQQAppInterface.getManager(317);
    if (i >> 8 == 2)
    {
  ...
  public static String b(long paramLong)
  {
    ...
    if (paramLong > 1048576L)
    {
      ...
      return alpo.a(2131710098) + str + "MB/s";
    }
    if (paramLong > 1024L)
    {
      f = (float)paramLong / 1024.0F;
      str = new DecimalFormat("0.00").format(f);
      return alpo.a(2131710097) + str + "KB/s";
    }
    return alpo.a(2131710103) + paramLong + "KB/s";
  }
  
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, arnx paramarnx)
  {
    String str = a(paramContext, paramString1, paramString2, paramString3, paramString4);
    Object localObject = null;
    str = arni.a(paramTextView, 2, paramString5 + str, paramString2);
    paramString2 = localObject;
    if (!TextUtils.isEmpty(str))
    {
      paramContext = a(paramContext, paramString1, str, paramString3, paramString4);
      paramContext = arni.a(paramTextView, paramString5 + paramContext);
      paramString1 = a(paramContext, str, alpo.a(2131710101));
      if (!paramBoolean) {
        break label155;
      }
    }
    label155:
    for (paramString2 = a(paramContext, paramString1, paramarnx);; paramString2 = new SpannableString(paramContext))
    {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity, boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      armv.a(paramActivity, 2131692752, 2131692757, new arov(paramActivity, paramQQAppInterface));
      return;
    }
    arum.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!arni.a(paramMessageRecord1))) {}
    while ((paramMessageRecord2 == null) || (!arni.a(paramMessageRecord2))) {
      return;
    }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    String str1 = arni.a(paramString);
    String str2 = bavn.a(paramContext, str1);
  ...
  {
    if (paramFileManagerEntity == null) {}
    while ((6 != paramFileManagerEntity.getCloudType()) || (arof.b(paramFileManagerEntity.getFilePath()))) {
      return false;
    }
    return true;
  }
