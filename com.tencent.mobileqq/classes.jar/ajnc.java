...
public class ajnc
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      str2 = paramArrayOfString[ascl.a(paramArrayOfString.length)];
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject).put("atlas", ajki.a(paramInt + "/role", 1));
          ((JSONObject)localObject).put("json", ajki.a(paramInt + "/role", 1));
          continue;
      ...
      localJSONObject2.put("atlas", ajki.a(localInteger + "/dress", 2));
      localJSONObject2.put("json", ajki.a(localInteger + "/dress", 2));
    }
    localJSONObject1.put("dressPath", localException1);
    return localJSONObject1;
  }
  
  public static void a(int paramInt1, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt2, String paramString3, ajni paramajni)
  {
    airx localairx = (airx)paramQQAppInterface.getManager(153);
    Object localObject = localairx.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt2 < j)
        {
          aiwl localaiwl = localObject[paramInt2];
          i = localaiwl.jdField_b_of_type_Int;
          int[] arrayOfInt = localaiwl.a();
          if ((ajki.a(paramString1, localaiwl.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ajng(paramajni, paramInt1, paramQQAppInterface, paramString2, paramString3, localaiwl, arrayOfInt))) && (localaiwl.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramajni != null) {
              paramajni.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, localaiwl.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramajni != null)
        {
          ...
          {
            paramInt2 = 2;
            paramajni.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt2, ajhu.a(paramInt2), 1);
          }
        }
        else
        {
          airx.a(paramQQAppInterface, paramString1, "apllo_game");
          paramQQAppInterface = (ajxl)paramQQAppInterface.getManager(51);
          if ((paramQQAppInterface == null) || (paramQQAppInterface.b(paramString1))) {
            continue;
          }
          paramQQAppInterface = localairx.b(paramString1);
        ...
        for (long l = paramQQAppInterface.apolloUpdateTime;; l = 0L)
        {
          ...
          paramajni.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, 1, ajhu.a(1), 1);
          break label282;
        }
      }
    }
  ...
  public static void a(int paramInt, String paramString, Activity paramActivity)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localajrd = new ajrd();
        localObject1 = ajac.a(paramInt);
        if (localObject1 != null)
        {
          localObject1 = ((ajcf)localObject1).a();
          if ((localObject1 != null) && (((CmGameStartChecker.StartCheckParam)localObject1).game != null))
          {
            localajrd.jdField_b_of_type_Int = ((CmGameStartChecker.StartCheckParam)localObject1).game.actionId;
            localajrd.jdField_b_of_type_JavaLangString = ((CmGameStartChecker.StartCheckParam)localObject1).game.name;
          }
        }
        if (localajrd.jdField_b_of_type_Int <= 0) {
          localajrd.jdField_b_of_type_Int = 439;
        }
        localajrd.jdField_a_of_type_Int = paramInt;
        localajrd.jdField_a_of_type_JavaLangString = ajya.a(2131700370);
        localajrd.jdField_c_of_type_Int = i;
        ...
        ((JSONObject)localObject1).put("xyRootSrc", aiye.a(paramInt));
        i = paramString.optInt("activityId");
        int j = paramString.optInt("reqCode");
        localObject2 = ajac.a(paramInt);
        if (localObject2 != null)
        {
          ((ajcf)localObject2).jdField_b_of_type_Int = i;
          ((ajcf)localObject2).jdField_c_of_type_Int = j;
        }
        localajrd.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
        if (localajrd.jdField_c_of_type_JavaLangString.length() >= 500)
        {
          QLog.w("cmgame.sendmsg", 1, "extendInfo is too long, len:" + localajrd.jdField_c_of_type_JavaLangString.length() + ",content:" + localajrd.jdField_c_of_type_JavaLangString);
          return;
        }
      }
      ...
      Object localObject1 = ajcm.a();
      if ((localObject1 != null) && (((ajcm)localObject1).a != null) && (0L != l)) {
        ((ajcm)localObject1).a.roomId = l;
      }
      if (i == 0)
      {
        paramString.put("msgType", 4);
        ajbu.a("cs.send_game_msg.local", paramString.toString(), true, null, paramInt);
        return;
      }
    } while (1 != i);
    a(localajrd, paramActivity, 3);
  }
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (airx)paramQQAppInterface.getManager(153);
    Object localObject2 = airx.jdField_c_of_type_JavaLangString;
    localObject1 = airx.jdField_b_of_type_JavaLangString;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        a(paramLong, paramQQAppInterface, paramString2, "", 1, paramString1, new ajnd());
        return;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, ajnh paramajnh)
  {
    airx localairx = (airx)paramQQAppInterface.getManager(153);
    Object localObject = localairx.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt < j)
        {
          aiwl localaiwl = localObject[paramInt];
          i = localaiwl.jdField_b_of_type_Int;
          int[] arrayOfInt = localaiwl.a();
          if ((ajki.a(paramString1, localaiwl.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ajnf(paramajnh, paramLong, paramQQAppInterface, paramString2, paramString3, localaiwl, arrayOfInt))) && (localaiwl.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramajnh != null) {
              paramajnh.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, localaiwl.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramajnh != null)
        {
          ...
          {
            paramInt = 2;
            paramajnh.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt, ajhu.a(paramInt), 1);
          }
        }
        else
        {
        ...
        for (paramLong = paramQQAppInterface.apolloUpdateTime;; paramLong = 0L)
        {
          ...
          paramajnh.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, 1, ajhu.a(1), 1);
          break label285;
        }
      }
    }
  ...
  public static void a(ajrd paramajrd, Activity paramActivity, int paramInt)
  {
    if (paramajrd == null)
    {
    ...
    localBundle.putInt("forward.apollo.gameid", paramajrd.jdField_a_of_type_Int);
    localBundle.putInt("forward.apollo.gameMode", paramajrd.jdField_c_of_type_Int);
    localBundle.putInt("forward_type", 34);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloGameBasicEventUtil", 2, "[forwardGameMsg] gameId:" + paramajrd.jdField_a_of_type_Int + ";fromtype:" + paramInt);
    }
    if (paramInt == 2)
    {
      localIntent.putExtras(localBundle);
      aqbe.a(paramActivity, localIntent, 99999);
      return;
    }
    localBundle.putInt("forward.apollo.actionid", paramajrd.jdField_b_of_type_Int);
    localBundle.putLong("forward.apollo.roomid", paramajrd.jdField_a_of_type_Long);
    localBundle.putString("forward.apollo.gamename", paramajrd.jdField_b_of_type_JavaLangString);
    localBundle.putString("forward.apollo.actionname", paramajrd.jdField_a_of_type_JavaLangString);
    localBundle.putInt("forward.apollo.msgtype", paramajrd.d);
    localBundle.putString("forward.apollo.sharejson", paramajrd.jdField_c_of_type_JavaLangString);
    localIntent.putExtras(localBundle);
    aqbe.a(paramActivity, localIntent, 20180426);
  }
    ...
    if (localJSONObject1.has("param"))
    {
      ...
      if (localJSONObject2 != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramString = bfnx.a(paramString, str, localJSONObject2.getString(str));
        }
      }
    }
    for (;;)
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localajrd = new ajrd();
        ApolloGameData localApolloGameData = ((ajmu)localObject).a(k);
        paramString = ajya.a(2131700352);
        if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
        {
          ...
          localajrd.jdField_a_of_type_JavaLangString = paramString;
          localajrd.jdField_b_of_type_Int = i;
          localajrd.jdField_c_of_type_Int = j;
          localajrd.jdField_a_of_type_Long = l;
          localajrd.jdField_a_of_type_Int = k;
      ...
      localajrd.jdField_b_of_type_JavaLangString = ajya.a(2131700371);
      int i = 0;
      continue;
      localajrd.d = 3;
      continue;
      ...
      ApolloGameUtil.a(paramQQAppInterface, localajrd, paramString.a());
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.i("ApolloGameBasicEventUtil", 1, "pass uin.");
          a(paramInt, paramQQAppInterface, paramString2, str, 1, paramString1, new ajne(i));
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        String str = String.format("https://cmshow.qq.com/apollo/html/game-platform/buy-props.html?_wv=3&adtag=inside_game&gameId=%s&gameOrientation=%s&itemList=%s", new Object[] { Integer.valueOf(localajcf.a()), Integer.valueOf(i), URLEncoder.encode(paramString.optString("itemList"), "UTF-8") });
        ...
        VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 0, 0, new String[] { localajcf.a().mGameName });
        if (QLog.isColorLevel())
        {
          ...
          VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 1, 0, new String[] { localajcf.a().mGameName });
        }
      }
      else
      {
  ...
  private static String b()
  {
    ...
    {
      if ((ajya.a(2131700379).equals(str)) || (str.contains(ajya.a(2131700364)))) {
        return a(b);
      }
      if ((ajya.a(2131700377).equals(str)) || (str.contains(ajya.a(2131700338)))) {
        return a(c);
      }
      if ((ajya.a(2131700350).equals(str)) || (str.contains(ajya.a(2131700344)))) {
  ...
  public static void b(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = b(airx.jdField_c_of_type_JavaLangString.getBytes(), paramString.getBytes());
    try
    {
    ...
    if (localJSONObject.has("param"))
    {
      ...
      if (localJSONObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramString = bfnx.a(paramString, str, localJSONObject.getString(str));
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      ((nrf)paramQQAppInterface.a(88)).a(i, paramString, str1, str2, str3, l1, l2, l3, l4, bool);
      return;
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    int j = bbfj.b(paramQQAppInterface.getApp());
    long l1 = 0L;
    label199:
    label204:
    label210:
