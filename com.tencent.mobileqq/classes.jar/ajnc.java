...
{
  public ajnc(AntiFraudConfigFileUtil paramAntiFraudConfigFileUtil) {}
  ...
  protected void b(int paramInt, Bundle paramBundle)
  {
    ...
    ThreadManager.post(new ajnd(this, (String)localObject, paramBundle.getInt("effect_time", 0), paramBundle.getString("md5"), paramBundle.getString("download_url")), 5, null, false);
  }
}
