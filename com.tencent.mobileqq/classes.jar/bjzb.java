...
public class bjzb
{
  public static Intent a(String paramString1, String paramString2, bklx parambklx, String paramString3)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("uin", parambklx.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("troop_uin", parambklx.b);
    localIntent.putExtra("uintype", parambklx.jdField_a_of_type_Int);
    localIntent.putExtra("from_uin_type", parambklx.jdField_a_of_type_Int);
    ...
    paramString3 = bbdm.a(apue.d(paramString2));
    ...
    parambklx.g = str;
    parambklx = new blbt();
    int i = blbs.a(paramString1, parambklx);
    if (i != 0)
    {
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3)
  {
    ...
    String str2 = bbdm.a(apue.d(paramString1));
    if (str2 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return;
    }
    String str1 = bbdm.a(apue.d(paramString2));
    if (str1 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return;
    ...
    int i = blbs.a(paramString1, localblbt);
    if (i != 0)
    {
      QLog.e("ShortVideoForwardManager", 1, new Object[] { "video file getRotationDegree fail, code:", Integer.valueOf(i) });
      return;
    ...
    while ((paramActivity instanceof QQStoryBaseActivity))
    {
      ...
      {
        localIntent.putExtra("qq_camera_scheme", bkuq.a(paramString1));
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramString2.startsWith("http"))
          {
            ...
            localIntent.putExtra("qq_camera_scheme", bkuq.a(paramString2));
            localIntent.putExtra("qq_camera_top_title", "魔法视频");
          }
          for (;;)
          {
            ...
            break label605;
            if ((!bbjw.a(paramString2)) && (!bbjw.a(paramString1)))
            {
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      aqbc.a(paramActivity, "caller_aecamera", localIntent, 21, 100200);
      return;
      if (paramBoolean2) {
        localIntent.putExtra("forward_summary_extra", ajyc.a(2131714039));
      }
    }
    aqbc.a(paramActivity, localIntent, 21, 100200);
  }
}
