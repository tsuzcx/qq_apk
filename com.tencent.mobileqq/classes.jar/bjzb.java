  ...
  implements bjqx
{
  ...
  private void a(bjzc parambjzc)
  {
    int i = 0;
    if (TextUtils.isEmpty(parambjzc.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (TextUtils.isEmpty(parambjzc.jdField_a_of_type_JavaLangString)) {
      i = 101;
    ...
    while (i != 0)
    {
      ...
      try
      {
        ...
        localJSONObject2.put("id", parambjzc.jdField_a_of_type_Int);
        localJSONObject2.put("url", "");
        localJSONObject1.put("data", localJSONObject2);
        localJSONObject1.put("msg", "");
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(parambjzc.c, new String[] { localJSONObject1.toString() });
        return;
      }
      catch (JSONException parambjzc)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "JSONException error !", parambjzc);
        return;
        parambjzc.d = bjza.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), parambjzc.jdField_a_of_type_JavaLangString);
        if ((!TextUtils.isEmpty(parambjzc.d)) && (new File(parambjzc.d).exists()))
        {
          this.jdField_a_of_type_JavaUtilMap.put(parambjzc.d, Integer.valueOf(parambjzc.jdField_a_of_type_Int));
          if (!bjza.a(parambjzc.d, parambjzc.b)) {
            i = 102;
          }
        }
        else
      ...
      catch (Exception parambjzc)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "parentPlugin.callJs error !", parambjzc);
      }
    }
  }
  ...
  protected void a(String... paramVarArgs)
  {
    ...
    //   30: invokespecial 202	bjzc:<init>	(Lbjzb;I)V
    //   33: astore_1
    //   34: aload_1
    //   35: aload_2
    //   36: ldc 204
    //   38: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   41: putfield 42	bjzc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   44: aload_1
    //   45: aload_2
    //   46: ldc 206
    //   48: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   51: putfield 156	bjzc:b	Ljava/lang/String;
    //   54: aload_1
    //   55: aload_2
    //   56: ldc 184
    //   58: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   61: putfield 103	bjzc:c	Ljava/lang/String;
    //   64: aload_1
    //   65: ifnull +26 -> 91
    //   68: aload_0
    //   69: getfield 31	bjzb:jdField_b_of_type_JavaUtilMap	Ljava/util/Map;
    //   72: aload_1
    //   73: getfield 86	bjzc:jdField_a_of_type_Int	I
    ...
    //   86: aload_0
    //   87: aload_1
    //   88: invokespecial 208	bjzb:a	(Lbjzc;)V
    //   91: return
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_1
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (bjzc)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(j));
    if (paramBundle == null)
    {
