    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
            if (aehv.a(((StructMsgForImageShare)paramView).mMsgActionData))
            {
              this.a.b((StructMsgForImageShare)paramView, "5");
              return;
            }
          } while (!aehv.b(((StructMsgForImageShare)paramView).mMsgActionData));
          aehv.a(this.a, (StructMsgForImageShare)paramView);
          localObject2 = aehv.b(((StructMsgForImageShare)paramView).mMsgActionData);
        ...
        noo.a(null, "", "0X800712E", "0X800712E", 0, 0, (String)localObject1, paramView, "", "");
        noo.a("0X800712E", "", (String)localObject1, paramView, "", "");
        return;
