...
public class aehw
{
  public static int a(Context paramContext, String paramString)
  {
    ...
    answ localansw = (answ)paramContext.getManager(149);
    ...
    do
    {
      do
      {
        ...
        localansw.a((CustomEmotionData)((List)localObject).get(j), j);
      ...
      paramContext = (ansx)paramContext.getManager(103);
      i = m;
    } while (paramContext == null);
    label260:
  ...
  public static int a(Context paramContext, String paramString, StructMsgForImageShare paramStructMsgForImageShare, PicMessageExtraData paramPicMessageExtraData)
  {
    ...
    if (localList != null)
    {
      ...
      for (;;)
      {
        ...
        if ((str != null) && (((CustomEmotionData)localList.get(j)).md5 != null) && (str.equals(((CustomEmotionData)localList.get(j)).md5)))
        {
          ...
          {
            ((answ)localObject).a((CustomEmotionData)localList.get(j), j);
    ...
    paramContext = new ansf(localQQAppInterface, paramContext, (CustomEmotionData)localObject, paramStructMsgForImageShare, 0);
    paramString = (ansx)localQQAppInterface.getManager(103);
    if (paramString != null) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    int m = 0;
    String str = HexUtil.bytes2HexStr(MD5.getFileMd5(paramString));
    Object localObject = (answ)paramQQAppInterface.getManager(149);
    if (QLog.isColorLevel()) {
      QLog.i("AIOGalleryUtils", 2, "Call getEmoticonDataList from addCustomEmotionForAIO.");
    }
    List localList = ((answ)localObject).a();
    ...
    do
    {
      ...
      paramString = new ansf(paramQQAppInterface, BaseApplicationImpl.getContext(), (CustomEmotionData)localObject, null, 3);
  ...
  {
    azqv localazqv = bakx.a(paramQQAppInterface, paramMessageForTroopFile);
    if (localazqv == null) {
    ...
    do
    {
      do
      {
        ...
        {
          return null;
          if (apug.a(paramMessageForTroopFile.fileName) != 0)
          {
        ...
        QLog.w("AIOGalleryUtilstoTroopAIOFilePicData", 1, "id:" + localazqv.jdField_a_of_type_JavaUtilUUID + " file is deleted!");
        return null;
        if ((localazqv.jdField_b_of_type_Int != 4) && (localazqv.jdField_b_of_type_Int != 5)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.w("AIOGalleryUtilstoTroopAIOFilePicData", 1, "id:" + localazqv.jdField_a_of_type_JavaUtilUUID + " file is:" + localazqv.jdField_b_of_type_Int);
      return null;
      if ((!bbdx.b(localazqv.jdField_a_of_type_JavaLangString)) || ((localazqv.jdField_b_of_type_Int != 1) && (localazqv.jdField_b_of_type_Int != 2) && (localazqv.jdField_b_of_type_Int != 3))) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.w("AIOGalleryUtilstoTroopAIOFilePicData", 1, "id:" + localazqv.jdField_a_of_type_JavaUtilUUID + " file is:" + localazqv.jdField_b_of_type_Int);
    return null;
    ((aoww)paramQQAppInterface.getManager(317)).a(bahy.a(localazqv.jdField_g_of_type_JavaLangString));
    Object localObject = localazqv.jdField_d_of_type_JavaLangString;
    if ((paramMessageForTroopFile.isMultiMsg) && (TextUtils.isEmpty((CharSequence)localObject))) {
      apug.a(paramMessageForTroopFile);
    }
    ...
    ((AIOFilePicData)localObject).jdField_e_of_type_Int = localazqv.jdField_i_of_type_Int;
    ((AIOFilePicData)localObject).jdField_h_of_type_JavaLangString = paramMessageForTroopFile.url;
    if (localazqv.jdField_b_of_type_Int == 8) {}
    for (boolean bool = true;; bool = false)
    {
      ((AIOFilePicData)localObject).jdField_f_of_type_Boolean = bool;
      ((AIOFilePicData)localObject).a(localazqv);
      ((AIOFilePicData)localObject).m = akas.b(paramMessageForTroopFile);
      return localObject;
    }
  }
  ...
  public static AIOImageData a(MessageForPic paramMessageForPic)
  {
    ...
    Object localObject1;
    if (myb.a(paramMessageForPic))
    {
      localObject1 = myb.a(paramMessageForPic);
      if ((((myc)localObject1).jdField_a_of_type_JavaLangString != null) || (((myc)localObject1).jdField_a_of_type_Int == 2)) {
        break label438;
      }
      if (QLog.isColorLevel()) {
    ...
    if (paramMessageForPic.isMixed)
    {
      i = 1;
      label222:
      localAIOImageData.jdField_a_of_type_JavaLangString = ayoi.d(aywm.a(paramMessageForPic, i, "chatthumb").toString());
      if (!paramMessageForPic.isMixed) {
        break label516;
      }
    ...
    for (;;)
    {
      if (paramMessageForPic.fileSizeFlag == 1) {
        localAIOImageData.jdField_c_of_type_JavaLangString = ayoi.d(aywm.a(paramMessageForPic, 131075, null).toString());
      }
      ...
      localAIOImageData.m = akas.b(paramMessageForPic);
      return localAIOImageData;
      label438:
      Object localObject2 = ((myc)localObject1).a();
      if ((localObject2 == null) || (((myc)localObject1).jdField_a_of_type_Int == 2)) {
        break;
      }
      localObject1 = URLEncoder.encode(Base64.encodeToString((byte[])localObject2, 2));
      myb.a().a(paramMessageForPic.frienduin, (String)localObject1, paramMessageForPic);
      localAIOImageData.jdField_j_of_type_Boolean = true;
      localAIOImageData.n = myb.a().a(paramMessageForPic.frienduin, (String)localObject1);
      break;
      i = 65537;
      break label222;
      label516:
      localObject1 = aywm.a(paramMessageForPic, 1, null);
      localAIOImageData.jdField_b_of_type_JavaLangString = ayoi.d(((URL)localObject1).toString());
      if (paramMessageForPic.fileSizeFlag != 1)
      {
        ...
        localAIOImageData.jdField_d_of_type_JavaLangString = ayoi.e(((URL)localObject1).toString());
  ...
  public static AIOImageData a(MessageForTroopFile paramMessageForTroopFile, QQAppInterface paramQQAppInterface)
  {
    ...
    azqv localazqv = bakx.a(paramQQAppInterface, paramMessageForTroopFile);
    Object localObject;
    if (localazqv.jdField_d_of_type_JavaLangString != null)
    {
      localObject = localazqv.jdField_d_of_type_JavaLangString;
      ...
      if (!TextUtils.isEmpty(localazqv.jdField_c_of_type_JavaLangString)) {
        localAIOImageData.jdField_b_of_type_JavaLangString = localazqv.jdField_c_of_type_JavaLangString;
      }
      if ((!TextUtils.isEmpty(localazqv.jdField_a_of_type_JavaLangString)) && (bbdx.a(localazqv.jdField_a_of_type_JavaLangString))) {
        localAIOImageData.jdField_c_of_type_JavaLangString = localazqv.jdField_a_of_type_JavaLangString;
      }
      if (localazqv.jdField_b_of_type_Int != 8) {
        break label400;
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localAIOImageData.jdField_d_of_type_Long = localazqv.jdField_a_of_type_Int;
      try
      {
        localObject = aede.a(paramQQAppInterface.getApplication(), localazqv, paramMessageForTroopFile);
        paramQQAppInterface = (QQAppInterface)localObject;
        if (localObject == null) {
          paramQQAppInterface = aywm.b();
        }
      }
      ...
      localAIOImageData.jdField_g_of_type_JavaLangString = localazqv.jdField_g_of_type_JavaLangString;
      localAIOImageData.jdField_h_of_type_JavaLangString = localazqv.jdField_e_of_type_JavaLangString;
      localAIOImageData.jdField_e_of_type_Long = localazqv.jdField_c_of_type_Long;
      localAIOImageData.jdField_c_of_type_Int = localazqv.jdField_h_of_type_Int;
      localAIOImageData.jdField_b_of_type_Int = 3;
      return localAIOImageData;
      localObject = localazqv.jdField_b_of_type_JavaLangString;
      break;
    }
  }
  ...
  public static AIORichMediaData a(com.tencent.mobileqq.data.ChatMessage paramChatMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    //   23: astore 7
    //   25: aload_1
    //   26: invokevirtual 677	com/tencent/mobileqq/app/QQAppInterface:a	()Laoze;
    //   29: aload 7
    ...
    //   44: invokevirtual 685	aoze:a	(JLjava/lang/String;I)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   47: astore 8
    //   49: aload 8
    //   51: ifnull -41 -> 10
    //   54: aload 8
    ...
    //   241: aload 4
    //   243: aload_0
    //   244: invokestatic 370	akas:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    ...
    //   378: invokestatic 273	bbdx:b	(Ljava/lang/String;)Z
    //   381: istore_3
    //   382: iload_3
    //   383: ifeq +56 -> 439
    //   386: aload 8
    ...
    //   591: aload 6
    //   593: aload 4
    //   595: getfield 765	amxv:jdField_b_of_type_Int	I
    //   598: i2l
    ...
    //   731: invokestatic 750	apvd:b	(Ljava/lang/String;)Z
    //   734: ifeq +12 -> 746
    //   737: aload 8
    ...
    //   751: invokestatic 750	apvd:b	(Ljava/lang/String;)Z
    //   754: ifeq +589 -> 1343
    //   757: aload 8
    ...
    //   844: aload_1
    //   845: aload 5
    //   847: invokestatic 211	bakx:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/data/MessageForTroopFile;)Lazqv;
    //   850: astore 6
    //   852: aload 6
    ...
    //   880: invokestatic 228	apug:a	(Ljava/lang/String;)I
    //   883: iconst_2
    ...
    //   896: areturn
    //   897: aload 6
    //   899: getfield 237	azqv:jdField_b_of_type_Int	I
    //   902: bipush 12
    ...
    //   929: aload 6
    //   931: getfield 251	azqv:jdField_a_of_type_JavaUtilUUID	Ljava/util/UUID;
    ...
    //   950: areturn
    //   951: aload 6
    //   953: getfield 237	azqv:jdField_b_of_type_Int	I
    //   956: iconst_4
    //   957: if_icmpeq +12 -> 969
    //   960: aload 6
    //   962: getfield 237	azqv:jdField_b_of_type_Int	I
    //   965: iconst_5
    ...
    //   991: aload 6
    //   993: getfield 251	azqv:jdField_a_of_type_JavaUtilUUID	Ljava/util/UUID;
    ...
    //   1005: aload 6
    //   1007: getfield 237	azqv:jdField_b_of_type_Int	I
    ...
    //   1020: areturn
    //   1021: aload 6
    //   1023: getfield 269	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1026: invokestatic 273	bbdx:b	(Ljava/lang/String;)Z
    //   1029: ifeq +82 -> 1111
    //   1032: aload 6
    //   1034: getfield 237	azqv:jdField_b_of_type_Int	I
    //   1037: iconst_1
    //   1038: if_icmpeq +21 -> 1059
    //   1041: aload 6
    //   1043: getfield 237	azqv:jdField_b_of_type_Int	I
    //   1046: iconst_2
    //   1047: if_icmpeq +12 -> 1059
    //   1050: aload 6
    //   1052: getfield 237	azqv:jdField_b_of_type_Int	I
    //   1055: iconst_3
    ...
    //   1081: aload 6
    //   1083: getfield 251	azqv:jdField_a_of_type_JavaUtilUUID	Ljava/util/UUID;
    ...
    //   1095: aload 6
    //   1097: getfield 237	azqv:jdField_b_of_type_Int	I
    ...
    //   1118: checkcast 275	aoww
    //   1121: aload 6
    //   1123: getfield 278	azqv:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   1126: invokestatic 283	bahy:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1129: invokevirtual 286	aoww:a	(Ljava/lang/String;)Lamxv;
    //   1132: astore 7
    //   1134: aload 6
    //   1136: getfield 288	azqv:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   1139: astore 4
    //   1141: aload 4
    //   1143: astore_1
    //   1144: aload 4
    ...
    //   1149: ifeq +9 -> 1158
    //   1152: aload 6
    //   1154: getfield 585	azqv:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   1157: astore_1
    //   1158: aload_1
    //   1159: astore 4
    //   1161: aload 5
    ...
    //   1176: ifeq +10 -> 1186
    //   1179: aload 5
    //   1181: invokestatic 295	apug:a	(Lcom/tencent/mobileqq/data/ChatMessage;)Ljava/lang/String;
    //   1184: astore 4
    ...
    //   1257: aload 4
    //   1259: aload 7
    //   1261: getfield 765	amxv:jdField_b_of_type_Int	I
    //   1264: i2l
    ...
    //   1288: aload 6
    //   1290: getfield 269	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1293: invokestatic 273	bbdx:b	(Ljava/lang/String;)Z
    //   1296: ifeq +19 -> 1315
    //   1299: aload 4
    //   1301: aload 6
    //   1303: getfield 269	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public static AIOShortVideoData a(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    localAIOShortVideoData.jdField_d_of_type_JavaLangString = akpx.c(paramMessageForShortVideo);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localAIOShortVideoData.m = akas.b(paramMessageForShortVideo);
  ...
  {
    paramContext = (answ)((QQAppInterface)((BaseActivity)paramContext).getAppRuntime()).getManager(149);
    if (QLog.isColorLevel()) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, ArrayList<String> paramArrayList, int paramInt2)
  {
    ...
    bgyp.a(paramActivity, localbgyw, paramIntent, paramString2, paramString3, paramString4, paramString5, paramInt1, paramArrayList, 7001, paramInt2);
  }
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, aeib paramaeib)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          str = bbdx.b(paramFile.getAbsolutePath());
          str = paramString + "." + str;
        }
        paramString = new File(ajsd.bc, str);
        ...
        try
        {
          ...
          {
            b(paramActivity, paramFile, paramString, paramaeib);
            return;
          }
        }
        catch (IOException paramFile)
        {
          bcql.a(paramActivity, paramActivity.getString(2131695190), 0).a();
        }
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    label145:
    bbdj.a(paramActivity, 230).setTitle(paramActivity.getString(2131718848)).setMessage(paramActivity.getString(2131695183)).setPositiveButton(paramActivity.getString(2131718724), new aehy(paramActivity, paramFile, paramString, paramaeib)).setNegativeButton(paramActivity.getString(2131694648), new aehx()).show();
  }
  
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, aeiy paramaeiy, boolean paramBoolean, String paramString3)
  {
    if ((paramaeiy == null) || (!AIOImageData.class.isInstance(paramaeiy.a))) {
      return;
    }
    bgyw localbgyw = bgyw.a();
    localbgyw.jdField_a_of_type_JavaLangString = paramString1;
    ...
    {
      paramaeiy = paramString1 + "_hd";
      if (new File(paramaeiy).exists()) {
        paramString1 = paramaeiy;
      }
    }
    for (;;)
    {
      paramaeiy = localAIOImageData.jdField_e_of_type_JavaLangString;
      long l2 = localAIOImageData.jdField_c_of_type_Long;
      long l1 = 0L;
      if (paramBoolean) {
        l1 = localAIOImageData.jdField_d_of_type_Long;
      }
      bgyp.a(paramActivity, localbgyw, paramBoolean, paramString3, paramString2, paramInt, paramString1, paramaeiy, l2, l1, -1);
      return;
    }
  }
  
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, List<aeiy> paramList, boolean paramBoolean, String paramString3)
  {
    if (paramList == null) {
      return;
    }
    ...
    {
      paramString1 = (aeiy)localIterator.next();
    ...
    for (;;)
    {
      ...
      break;
      bgyp.a(paramActivity, localbgyw, paramBoolean, paramString3, paramString2, paramInt, localArrayList1, localArrayList2, localArrayList3, localArrayList4, 98);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, long paramLong, int paramInt)
  {
    ...
    bgyp.a(paramActivity, localbgyw, paramString2, paramString3, paramString4, paramString5, paramLong, paramInt);
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString4, String paramString5)
  {
    ...
    bgyp.a(paramActivity, localbgyw, paramString2, paramString3, paramArrayList1, paramArrayList2, paramArrayList, paramInt, paramString4, paramString5);
  }
  ...
  {
    new aeia(paramContext, paramInt, paramURLDrawable, paramQQAppInterface, paramStructMsgForImageShare, paramPicMessageExtraData).execute(new Void[0]);
  }
  ...
  private static void b(Activity paramActivity, File paramFile1, File paramFile2, aeib paramaeib)
  {
    new aehz(paramFile1, paramFile2, paramActivity, paramaeib).execute(new Void[0]);
  }
