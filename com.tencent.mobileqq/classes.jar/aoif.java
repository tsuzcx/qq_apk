  ...
  implements Handler.Callback
{
  ...
  WeakReference<aoig> b;
  
  public aoif(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    {
      return;
      ??? = bbdj.a(String.format("%s%s", new Object[] { "extend_frd_search_history_", ((QQAppInterface)???).getCurrentAccountUin() }));
  ...
  private void c()
  {
    ...
    bbdj.a(String.format("%s%s", new Object[] { "extend_frd_search_history_", localQQAppInterface.getCurrentAccountUin() }), this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public void a()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (!this.jdField_a_of_type_Bfmt.hasMessages(0)) {
        this.jdField_a_of_type_Bfmt.sendEmptyMessageDelayed(0, 300L);
      }
      return;
    }
  }
  
  public void a(aoig paramaoig)
  {
    if (paramaoig != null)
    {
      this.b = new WeakReference(paramaoig);
      return;
    }
    this.b = null;
  }
