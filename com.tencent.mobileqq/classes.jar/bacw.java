  ...
  extends BitmapDrawable
{
  ...
  public bacw(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static bacw[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      bacw[] arrayOfbacw2 = new bacw[paramInt];
      e = paramBitmap.getWidth() / 2;
      d = paramBitmap.getHeight() / 2;
      int i = 0;
      for (;;)
      {
        arrayOfbacw1 = arrayOfbacw2;
        if (i >= paramInt) {
          break;
        }
        arrayOfbacw2[i] = new bacw(paramResources, paramBitmap);
        i += 1;
      }
    }
    bacw[] arrayOfbacw1 = null;
    return arrayOfbacw1;
  }
