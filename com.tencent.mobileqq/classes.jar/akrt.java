  ...
  implements akrp, akrq, Manager
{
  ...
  private long a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return l3;
          ConcurrentHashMap localConcurrentHashMap = this.jdField_a_of_type_Akrm.a();
          ...
          if (localObject != null)
          {
            ...
            if (((List)localObject).size() > 0)
            {
              ...
              for (;;)
              {
                ...
                akro localakro = (akro)localConcurrentHashMap.get(str);
                l2 = l1;
                if (localakro != null)
                {
                  l2 = l1 + localakro.jdField_a_of_type_Long;
                  localakro.b += 1;
                  this.jdField_a_of_type_Akrm.a(str, localakro);
                }
                l1 = l2;
              }
            }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else if (akrw.c(i))
        {
          paramList = aukh.a(paramList);
          if (paramList != null) {
            paramList = apvm.a(this.jdField_a_of_type_ComTencentMobileqqAppPeakAppInterface, paramList);
          }
        }
        else if (akrw.d(i))
        {
        ...
        {
          paramList = aukh.a(paramList);
          if ((paramList != null) && ((paramList instanceof MessageForStructing)) && (asuh.a((MessageForStructing)paramList))) {
            b(paramString, this.jdField_a_of_type_Akru.c(MessageRecord.class, "select * from mr_multimessage where msgseq=?", "mr_multimessage", "msgseq=?", new String[] { String.valueOf(paramList.uniseq) }));
          }
        }
        paramList = "";
        continue;
  ...
  private String a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str1 = this.jdField_a_of_type_Akru.a(paramMessageRecord.frienduin);
      continue;
      if (this.jdField_a_of_type_Aejb != null)
      {
        str1 = this.jdField_a_of_type_Aejb.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
        continue;
        str1 = this.jdField_a_of_type_Akru.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
      }
    }
  }
  ...
  private boolean a(akrl paramakrl)
  {
    if ((paramakrl == null) || (this.jdField_a_of_type_Aejb == null)) {}
    String str;
    do
    {
      return true;
      str = MessageRecord.getTableName(paramakrl.jdField_a_of_type_JavaLangString, paramakrl.jdField_a_of_type_Int);
    } while (TextUtils.isEmpty(str));
    b(str);
    if (this.jdField_a_of_type_Aejb != null) {
      this.jdField_a_of_type_Aejb.b(paramakrl.jdField_a_of_type_JavaLangString, paramakrl.jdField_a_of_type_Int);
    }
    a(str);
    return true;
  }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null))
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          akro localakro = (akro)localConcurrentHashMap.get(str1);
          if (localakro != null)
          {
            localakro.b -= 1;
            if (localakro.b == 0)
            {
              String str2 = this.jdField_a_of_type_Akrm.a(localakro);
              if (!TextUtils.isEmpty(str2))
              {
                this.jdField_a_of_type_Long += localakro.jdField_a_of_type_Long;
                paramString.add(str2);
              }
              this.jdField_a_of_type_Akrm.a(str1);
            }
            else
            {
              this.jdField_a_of_type_Akrm.a(str1, localakro);
            }
          }
        }
        this.jdField_a_of_type_Akrm.a(paramString);
      }
    }
  }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Akrm != null) && (this.jdField_a_of_type_Akrm.a());
  }
  
  private void c()
  {
    this.jdField_a_of_type_Akru = new akru();
    AppInterface localAppInterface = this.jdField_a_of_type_Akru.a();
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Akru.a(this);
    this.jdField_a_of_type_Akrm = new akrm(this);
  }
  ...
  private void f()
  {
    ...
    Object localObject = this.jdField_a_of_type_Akru.a();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      b(str1, this.jdField_a_of_type_Akru.a(MessageRecord.class, str2, str1, null, null));
    }
    this.jdField_b_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
  ...
  private void g()
  {
    ...
    Object localObject = this.jdField_a_of_type_Akru.b();
    if ((localObject == null) || (((ArrayList)localObject).size() == 0))
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject).hasNext())
    {
      String str1 = (String)((Iterator)localObject).next();
      String str2 = String.format("select * from %s", new Object[] { str1 });
      b(str1, this.jdField_a_of_type_Akru.b(MessageRecord.class, str2, str1, null, null));
    }
    this.c = true;
    if (QLog.isColorLevel()) {
  ...
  private void h()
  {
    if ((a()) && (b()))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localakrl.jdField_a_of_type_JavaLangString = ((MessageRecord)localObject).frienduin;
          localakrl.jdField_b_of_type_JavaLangString = a((MessageRecord)localObject);
          localakrl.jdField_a_of_type_Int = ((MessageRecord)localObject).istroop;
          localakrl.jdField_b_of_type_Long = ((MessageRecord)localObject).time;
          localakrl.jdField_a_of_type_Long = a(MessageRecord.getTableName(localakrl.jdField_a_of_type_JavaLangString, ((MessageRecord)localObject).istroop));
          if ((localakrl.jdField_a_of_type_Long > 0L) && (this.jdField_a_of_type_JavaUtilList != null))
          {
            localakrl.c = akrn.a(localakrl.jdField_a_of_type_Long);
            this.jdField_a_of_type_JavaUtilList.add(localakrl);
          }
        }
      }
      ...
      if (this.jdField_a_of_type_Akrr != null)
      {
        ...
        this.jdField_a_of_type_Akrr.a(this.jdField_a_of_type_JavaUtilList);
      }
    }
    label283:
    while (this.jdField_a_of_type_Akrr == null)
    {
  ...
  private void i()
  {
    ...
    if (this.jdField_a_of_type_Akru != null) {
      this.jdField_a_of_type_Akru.a();
    }
    if (this.jdField_a_of_type_Akrm != null) {
      this.jdField_a_of_type_Akrm.b();
    }
  }
  ...
  public List<akrl> a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilList != null) {
      Collections.sort(this.jdField_a_of_type_JavaUtilList, new akrk(paramInt));
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  
  public List<akrl> a(List<akrl> paramList)
  {
    if ((paramList == null) || (paramList.isEmpty()) || (this.jdField_a_of_type_Aejb == null)) {
      return this.jdField_a_of_type_JavaUtilList;
    }
    if (QLog.isColorLevel()) {
    ...
    {
      akrl localakrl = (akrl)paramList.next();
      if (this.jdField_a_of_type_JavaUtilList != null) {
        this.jdField_a_of_type_JavaUtilList.remove(localakrl);
      }
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(akrr paramakrr)
  {
    this.jdField_a_of_type_Akrr = paramakrr;
  }
  
  public void a(String paramString, auko paramauko)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramauko == null)) {
      if (QLog.isColorLevel()) {
        QLog.e("MessageCleanManager", 2, "onNotifyLastMsg tableName or entity is null");
      }
    }
    while ((!(paramauko instanceof MessageRecord)) || (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap == null)) {
      return;
    }
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, (MessageRecord)paramauko);
  }
  
  public void a(String paramString, List<? extends auko> paramList)
  {
    if ((paramList == null) || (paramList.isEmpty())) {
      if (QLog.isColorLevel()) {
  ...
  {
    i();
    this.jdField_a_of_type_Akrr = null;
    this.jdField_a_of_type_Aejb = null;
  }
}
