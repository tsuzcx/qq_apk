  ...
  extends bame
{
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramDownloadParams = bjdq.a(BaseApplication.getContext(), paramOutputStream);
    if (QLog.isColorLevel())
    {
      QLog.i("Q.qzonecover.", 2, "downloadImage|path = " + paramDownloadParams);
      if (!bdcs.b(paramDownloadParams)) {
        break label198;
      }
    ...
    if ((paramURLDrawableHandler.exists()) || ((paramOutputStream.startsWith("http://")) && (bdvx.a(new bdvv(paramOutputStream, paramURLDrawableHandler), null) == 0) && (paramURLDrawableHandler.exists()))) {
