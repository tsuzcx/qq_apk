  ...
  extends akbp
{
  ...
  protected List<akcy> a;
  public Set<Long> a;
  
  public akbt(Context paramContext, bkyc parambkyc, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  {
    Object localObject = ((akcy)getItem(paramInt)).a;
    try
    {
      localObject = bfce.a(((MessageRecord)localObject).msgData);
      if (localObject != null)
      {
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      MessageForText localMessageForText = bcsa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), localC2CLinkElement.uin, "", 0, (byte)1, (byte)0, (short)0, localC2CLinkElement.description());
      localMessageForText.msgData = bfce.a(localC2CLinkElement);
  ...
  public void a(List<Object> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      localObject = C2CLinkElement.parseFrom(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localObject, this.jdField_a_of_type_Anvk, this.jdField_a_of_type_JavaTextSimpleDateFormat, i);
      if (localObject != null) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559389, null);
      localakbq = new akbq();
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localCharSequence = localakcy.a(((C2CLinkElement)localObject).title, -11353092);
        localakbq.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.setText(localCharSequence);
        localakbq.jdField_a_of_type_AndroidWidgetTextView.setText(localakcy.a(((C2CLinkElement)localObject).timeSecond, -11353092));
        ajwl.a(localakbq.jdField_a_of_type_AndroidWidgetImageView, ((C2CLinkElement)localObject).iconUrl);
      }
