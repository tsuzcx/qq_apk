...
{
  public tzl(TroopRequestActivity paramTroopRequestActivity) {}
        ...
        catch (NumberFormatException paramString)
        {
          for (;;)
          {
            if (QLog.isColorLevel())
            {
              ...
              continue;
              QQToast.a(this.a.app.getApplication(), 2131434414, 0).b(this.a.getTitleBarHeight());
            }
          }
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
        }
  ...
  protected void b(boolean paramBoolean, long paramLong, int paramInt1, TroopInfo paramTroopInfo, int paramInt2, String paramString)
  {
    ...
    ThreadManager.post(new tzm(this, paramTroopInfo), 8, null, true);
  }
}
