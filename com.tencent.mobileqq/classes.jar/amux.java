  ...
  implements Handler.Callback
{
  ...
  private void b()
  {
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Amuy.c();
        this.jdField_a_of_type_Amuy = null;
      }
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Amuy != null) {
          this.jdField_a_of_type_Amuy.a(2);
        }
      }
    }
  }
  ...
  private void b(long paramLong)
  {
    ...
    catch (Exception localException)
    {
      ...
      } while (this.jdField_a_of_type_Amuy == null);
      this.jdField_a_of_type_Amuy.a(4);
    }
  }
  ...
  private void b(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Amuy.a(3);
    }
  }
  ...
  public void a(axvi paramaxvi, amuy paramamuy)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoEncoderCore.a(paramaxvi, paramamuy);
      if (this.jdField_a_of_type_Amuy != null) {
        this.jdField_a_of_type_Amuy.a();
      }
      return;
    }
    catch (Exception paramaxvi)
    {
      for (;;)
      {
        QLog.e("VideoEncoder", 1, "startRecording start encoder fail.", paramaxvi);
        if (this.jdField_a_of_type_Amuy != null) {
          this.jdField_a_of_type_Amuy.a(1);
        }
      }
    }
  }
