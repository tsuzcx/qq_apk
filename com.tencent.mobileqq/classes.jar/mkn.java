...
public class mkn
  extends mkk
{
  public mkn(VideoInviteActivity paramVideoInviteActivity)
  {
  ...
  private boolean a()
  {
    ...
    {
      mqw.e(false, true);
      bglp.b(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity, a(2131694798), a(2131694795), null, new mkp(this), null);
      bool = true;
    }
    return bool;
  }
  ...
  public void BtnOnClick(View paramView)
  {
    ...
    QLog.d("VideoInviteUILock", 1, "avideo BtnOnClick, id[" + mdy.a(paramView.getId()) + "], isDoubleVideoMeeting[" + bool + "], seq[" + l + "]");
  ...
  public void a(Context paramContext, String paramString, Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("android.intent.action.SCREEN_OFF".equals(paramString))
      {
        ...
        lcc.a = "4";
        if (msf.b(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity))
        {
          this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.a(l);
          if ((mts.a() != null) && (!this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.a().e)) {
            mts.a().b();
          }
        }
        ...
        {
          boolean bool = mqo.b(paramContext);
          if (QLog.isColorLevel()) {
            QLog.w("VideoInviteUILock", 1, "ACTION_SCREEN_OFF avCallBtnState[" + bool + "], seq[" + l + "]");
          }
          if (bool) {
            mts.a(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, false, l);
          }
          if (!this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_b_of_type_Boolean) {
            break;
          }
  ...
  public void d()
  {
    super.d();
    long l = AudioHelper.b();
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.setContentView(2131559788);
    ...
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel = ((QavPanel)this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.findViewById(2131373414));
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131559743);
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.setWaveVisibility(8);
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(new mko(this, l));
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.findViewById(2131380723));
    this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.findViewById(2131380724));
    ...
    if (this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_Ley.j == 9500)
    {
      ...
      Object localObject = this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_d_of_type_JavaLangString + a(2131690151);
      ...
      if ((anll.a() == 20.0F) || (anll.a() == 18.0F) || (anll.a() == 17.0F))
      {
        ...
        if ((anll.a() == 20.0F) && (!this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_b_of_type_Boolean))
        {
          this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131373371, 1, a().getDimensionPixelSize(2131297539));
          this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131363083, 2, a().getDimensionPixelSize(2131297539));
        }
        if ((this.jdField_b_of_type_Int <= 800) || ((mue.a()) && (this.jdField_b_of_type_Int <= 1280))) {
          this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131373367, 4, 0);
        }
      }
      k();
      if (!this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131363083, 8);
        this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.b(2131363082, 11);
        this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131363082, 2, a().getDimensionPixelSize(2131297719));
        this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131373368, 2130841919);
        mue.a(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_b_of_type_AndroidWidgetTextView, a(2131695283));
        break;
      }
      mue.a(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.jdField_b_of_type_AndroidWidgetTextView, a(2131719076));
      break;
      label785:
      a("0X80043FC");
    }
  ...
  void k()
  {
    ImageView localImageView = (ImageView)this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.findViewById(2131380723);
    ...
    if (i <= 320)
    {
      localLayoutParams.topMargin = a().getDimensionPixelSize(2131297668);
      localLayoutParams.width = a().getDimensionPixelSize(2131297664);
      localLayoutParams.height = a().getDimensionPixelSize(2131297664);
    }
    for (;;)
    {
      ...
      if (i <= 480)
      {
        localLayoutParams.topMargin = a().getDimensionPixelSize(2131297669);
        localLayoutParams.width = a().getDimensionPixelSize(2131297665);
        localLayoutParams.height = a().getDimensionPixelSize(2131297665);
      }
      else
      {
        localLayoutParams.topMargin = a().getDimensionPixelSize(2131297671);
        localLayoutParams.width = a().getDimensionPixelSize(2131297667);
        localLayoutParams.height = a().getDimensionPixelSize(2131297667);
      }
    }
  }
}
