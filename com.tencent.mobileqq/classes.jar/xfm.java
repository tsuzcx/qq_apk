...
public class xfm
{
  ...
  ArrayList<bdzc> b;
  private ArrayList<xgc> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = aljq.aX + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public xfm(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bdzc(k, (String)localObject4, (String)localObject5, 0, j, 1, new bdzd(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bdzc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bdzc)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bdzc)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bdzc)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bdzc)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bdzc)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bdzc)localObject5).jdField_a_of_type_Int))) {
          ((bdzc)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bdzc)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bdou.a(((JSONObject)localObject4).getString("QQVersion"), "8.3.3"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bdzc)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bdzc)localObject3).d = 1;
            ((bdzc)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bdzc)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bdzc)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bdzc)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bdzc)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bdzc)localObject3).jdField_a_of_type_Bdzd.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bdmy.jdField_a_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bdzc)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bdzc)localObject4).jdField_a_of_type_Int))) {
            ((bdzc)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bdzc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bdzc)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bdzc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bdzc)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new xfn(this, this.jdField_a_of_type_Uip, l).executeOnExecutor(Bosses.get().getExecutor(16), new utt[] { new utt(str1, str2, null) });
  }
  ...
  public void a(xgc paramxgc)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        bdcs.a(new File((String)localObject1), localFile);
      }
      localObject2 = new bdzb((String)localObject2, i, 64000, 2, paramxgc.c);
      bdze.a(BaseApplicationImpl.getContext(), (bdzb)localObject2, jdField_c_of_type_JavaLangString, new xfo(paramxgc, (String)localObject1), new bdzg(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramxgc.c);
      agye.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        bdcs.a(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bdzc localbdzc = (bdzc)localIterator.next();
        if (localbdzc.jdField_b_of_type_Int == 2)
        {
          xgc localxgc = new xgc(4, localbdzc.jdField_a_of_type_JavaLangString, localbdzc.jdField_a_of_type_Bdzd.jdField_a_of_type_Int, localbdzc.jdField_a_of_type_Int);
          if ((localbdzc.jdField_a_of_type_Bdzd.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbdzc.jdField_a_of_type_Bdzd.jdField_a_of_type_JavaLangString))) {
            localxgc.g = (jdField_b_of_type_JavaLangString + localbdzc.jdField_a_of_type_Bdzd.jdField_a_of_type_JavaLangString.substring(localbdzc.jdField_a_of_type_Bdzd.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localxgc);
        }
      }
    }
