  ...
  extends arnz
{
  ...
  public aroe(QQAppInterface paramQQAppInterface)
  {
  ...
  public void c()
  {
    boolean bool = atwl.a(new File(apdh.a()));
    if (QLog.isColorLevel()) {
  ...
  {
    int i = 0;
    long l1 = apdk.a("report_tag_so_cover", 0L);
    ...
    for (;;)
    {
      apdk.a(paramBoolean, i, str);
      apdk.a("report_tag_so_cover", l2);
      return;
      label102:
      paramBoolean = false;
      continue;
