  ...
  extends armf<arod>
{
  ...
  @NonNull
  public arod a(araj[] paramArrayOfaraj)
  {
    int j = -1;
    ...
    if (i < m)
    {
      ...
      int k = localaraj.jdField_a_of_type_Int;
      if (k < j) {
        yuk.e("QVipStickerProcessor", "received old task id " + k + ", latest task id: " + j);
      }
      for (;;)
      {
        i += 1;
        ...
        try
        {
          JSONObject localJSONObject = new JSONObject(new String(localaraj.jdField_a_of_type_JavaLangString.getBytes("utf-8")));
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          ...
          yuk.e("QVipStickerProcessor", "item.content=" + localaraj.jdField_a_of_type_JavaLangString + " e=" + localUnsupportedEncodingException);
        }
        catch (JSONException localJSONException)
        {
          localJSONException.printStackTrace();
          yuk.e("QVipStickerProcessor", "item.content=" + localaraj.jdField_a_of_type_JavaLangString + " e=" + localJSONException);
        }
      }
    }
    return new arod();
