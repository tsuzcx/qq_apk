  ...
  extends LoadingLayoutBase
{
  ...
  public aroe(Context paramContext, PullToRefreshBase.Mode paramMode, PullToRefreshBase.Orientation paramOrientation, TypedArray paramTypedArray)
  {
    super(paramContext);
    ...
    int i;
    switch (arof.a[paramOrientation.ordinal()])
    {
    default: 
      LayoutInflater.from(paramContext).inflate(2131559596, this);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131366773));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373187));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373185));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373186));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373182));
      localLayoutParams = (FrameLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetFrameLayout.getLayoutParams();
      switch (arof.b[paramMode.ordinal()])
      {
      default: 
        if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL)
        {
          ...
          this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131694830);
          this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131694831);
          this.c = paramContext.getString(2131694832);
          if (paramTypedArray.hasValue(7))
          {
            paramOrientation = paramTypedArray.getDrawable(7);
            if (paramOrientation != null) {
              arog.a(this, paramOrientation);
            }
          }
    ...
    for (;;)
    {
      ...
      g();
      return;
      LayoutInflater.from(paramContext).inflate(2131559595, this);
      break;
      if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL) {}
      for (i = 48;; i = 3)
      {
        localLayoutParams.gravity = i;
        this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131694827);
        this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131694828);
        this.c = paramContext.getString(2131694829);
        break;
      }
      i = 5;
      break label179;
  ...
  public final int a()
  {
    switch (arof.a[this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$Orientation.ordinal()])
    {
    default: 
