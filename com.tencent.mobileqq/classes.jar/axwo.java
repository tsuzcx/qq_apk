  ...
  extends axwa
{
  ...
  public void a()
  {
    ...
    new axww(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_b_of_type_JavaLangString + "&start=" + this.jdField_b_of_type_Int + "&num=" + 10, new axwp(this));
  }
