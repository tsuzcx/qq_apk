  ...
  extends bdol
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bdpp(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramView = (bdol)this.jdField_a_of_type_JavaUtilList.get(j);
      ...
      localView = ((View)localObject).findViewById(2131378085);
      if (localView != null)
      {
        if ((LinearLayout)((View)localObject).findViewById(2131378086) != null) {
          break label231;
        }
    ...
    for (;;)
    {
      ...
      {
        paramView = paramView.a(paramContext, null, paramBundle);
        localObject = new LinearLayout.LayoutParams(-1, agej.a(50.0F, paramContext.getResources()));
        ((TextView)paramView).setGravity(16);
        ((LinearLayout.LayoutParams)localObject).leftMargin = agej.a(12.0F, paramContext.getResources());
        ((LinearLayout.LayoutParams)localObject).rightMargin = 0;
        ((LinearLayout.LayoutParams)localObject).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject).bottomMargin = 0;
        this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject);
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    while (i < k)
    {
      ...
      {
        if ("item".equals(localbdqc.b)) {}
        for (Object localObject = localbdqc.a("layout");; localObject = bdov.a(localbdqc.b))
        {
          try
          {
            ...
            for (int j = Integer.parseInt((String)localObject);; j = 0)
            {
              ...
              bool1 = bool2;
              if (!((bdol)localObject).a(localbdqc)) {
                break;
              }
              a((bdol)localObject);
              break label39;
