  ...
  extends BaseAdapter
{
  ...
  public alim(alil paramalil, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561089, null);
    ...
    for (;;)
    {
      ...
      {
        localCustomImgView.setImageDrawable(this.jdField_a_of_type_Alil.a.a(localMessageRecord.istroop, localMessageRecord.senderuin));
