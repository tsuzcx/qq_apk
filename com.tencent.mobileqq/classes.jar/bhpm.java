...
public class bhpm
  implements bhpl
{
  private bhpl jdField_a_of_type_Bhpl;
  
  public bhpm(AbsListView paramAbsListView) {}
  
  public void a(ActionMode paramActionMode, int paramInt, long paramLong, boolean paramBoolean)
  {
    this.jdField_a_of_type_Bhpl.a(paramActionMode, paramInt, paramLong, paramBoolean);
    if (this.jdField_a_of_type_ComTencentWidgetAbsListView.getCheckedItemCount() == 0) {
      paramActionMode.finish();
    }
  }
  
  public void a(bhpl parambhpl)
  {
    this.jdField_a_of_type_Bhpl = parambhpl;
  }
  
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    return this.jdField_a_of_type_Bhpl.onActionItemClicked(paramActionMode, paramMenuItem);
  }
  
  public boolean onCreateActionMode(ActionMode paramActionMode, Menu paramMenu)
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Bhpl.onCreateActionMode(paramActionMode, paramMenu))
    {
  ...
  {
    this.jdField_a_of_type_Bhpl.onDestroyActionMode(paramActionMode);
  ...
  {
    return this.jdField_a_of_type_Bhpl.onPrepareActionMode(paramActionMode, paramMenu);
  }
}
