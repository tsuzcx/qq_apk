...
public class bhpm
{
  public static final LruCache<String, bhpm> a;
  public static final AtomicInteger c = new AtomicInteger(1);
  public String a;
  public final CopyOnWriteArrayList<bhpp> a;
  ...
  /* Error */
  public static bhpm a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokestatic 90	bhpm:b	(Ljava/lang/String;)Lbhpm;
    //   65: astore_2
    //   66: goto -52 -> 14
    //   69: astore_0
    //   70: aload_0
  ...
  public static bhpm b(String paramString)
  {
    ...
    try
    {
      ...
      {
        bhpm localbhpm = (bhpm)jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
        localObject = localbhpm;
        if (localbhpm == null)
        {
          localObject = new bhpm(paramString);
  ...
  public void a(bhpp parambhpp, String paramString)
  {
    if ((this.b.get() == 3) && (parambhpp != null))
    {
      ...
      parambhpp.onCheckOfflineFinish(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
    }
    do
    {
      return;
      if ((parambhpp != null) && (!this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(parambhpp))) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambhpp);
      }
      parambhpp = new SwiftBrowserOfflineHandler.1(this, paramString);
    ...
    ThreadManager.postImmediately(parambhpp, new bhpo(this), false);
  }
  ...
  public void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Nhe.a("ex_offline", "");
