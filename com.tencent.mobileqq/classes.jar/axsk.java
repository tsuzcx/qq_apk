...
public class axsk
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new axsl(ThreadManager.getFileThreadLooper());
  ...
  {
    if (d == null) {
      d = bbuv.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/");
    }
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      if (bbdj.a((List)localObject1, (String)localObject2)) {
