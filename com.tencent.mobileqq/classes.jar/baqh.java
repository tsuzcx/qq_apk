  ...
  extends baqk
{
  ...
  private WeakReference<Map<Long, baqk>> jdField_a_of_type_JavaLangRefWeakReference;
  private WeakReference<QQAppInterface> b;
  private WeakReference<baqi> c;
  
  public baqh(long paramLong, WeakReference<Map<Long, baqk>> paramWeakReference, WeakReference<QQAppInterface> paramWeakReference1, WeakReference<baqi> paramWeakReference2)
  {
  ...
  private boolean a(Map<Long, baqk> paramMap, QQAppInterface paramQQAppInterface)
  {
    QLog.d("QuickLoginObserver", 1, "wrapper.remove");
    paramMap = (baqk)paramMap.remove(Long.valueOf(this.jdField_a_of_type_Long));
    if (paramMap == null)
    {
  ...
  public void a(boolean paramBoolean, long paramLong)
  {
    ...
    ((baqi)this.c.get()).a(paramBoolean);
  }
}
