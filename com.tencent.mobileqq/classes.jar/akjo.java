  ...
  extends ajtd
{
  ...
  public akjo(QQAppInterface paramQQAppInterface)
  {
  ...
  private static PayRuleCfg a(String arg0, String paramString2)
  {
    ...
    {
      paramString2 = bbdj.a(paramString2);
      if (paramString2 != null) {
        return (PayRuleCfg)bhnw.a(PayRuleCfg.class, paramString2);
      }
    }
    return null;
  }
  ...
  public static String a(PayRuleCfg paramPayRuleCfg)
  {
    ...
    return Base64.encodeToString(bhnw.a(paramPayRuleCfg), 2) + "\n" + paramPayRuleCfg;
  }
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    localbhzw.b = (str + "_" + l1);
    localbhzw.jdField_a_of_type_Int = 1;
    localbhzw.jdField_e_of_type_JavaLangString = "tianshu.47";
    localbhzw.jdField_f_of_type_JavaLangString = "tianshu.47";
    localbhzw.g = paramString;
    localbhzw.h = "";
    localbhzw.jdField_a_of_type_Long = l1;
  ...
  private void a(@NonNull PrivExtV2Rsp paramPrivExtV2Rsp, String paramString)
  {
    ...
    Friends localFriends = localajxn.d(paramString);
    ...
    if (QLog.isColorLevel()) {
      QLog.d(q, 2, "redpacketinfo : icanusedred = " + paramPrivExtV2Rsp.iCanUseRed + ";iRedDisable = " + paramPrivExtV2Rsp.iRedDisable + "iRedPacketId = " + paramPrivExtV2Rsp.iRedPackId + ";sRedPackRemard = " + paramPrivExtV2Rsp.sRedPackRemard);
    }
    localajxn.a(localFriends);
    ...
    {
      paramString = (ajzf)this.app.getManager(131);
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(q, 2, "vip url = " + paramString);
      }
    ...
    for (;;)
    {
      bbvz.a().a(this.app, paramPrivExtV2Rsp);
      return;
      label508:
      paramString.apply();
    }
  ...
  private void a(VipMedalList paramVipMedalList, String paramString)
  {
    ...
    ajxn localajxn = (ajxn)this.app.getManager(51);
    paramString = localajxn.d(paramString);
  ...
  private static boolean a(PayRuleCfg paramPayRuleCfg1, PayRuleCfg paramPayRuleCfg2)
  {
    ...
    return Arrays.equals(bhnw.a(paramPayRuleCfg1), bhnw.a(paramPayRuleCfg2));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, PayRuleCfg paramPayRuleCfg, boolean paramBoolean)
  {
    ...
    for (paramQQAppInterface = Boolean.valueOf(false);; paramQQAppInterface = Integer.valueOf(paramPayRuleCfg.enable))
    {
      ...
      return false;
      long l1 = bbwv.a(paramQQAppInterface, "last_pull_pay_rule", 0L);
  ...
  private static void b(String paramString1, String arg1, PayRuleCfg paramPayRuleCfg)
  {
    ...
    paramPayRuleCfg = bhnw.a(paramPayRuleCfg);
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      bbdj.a(paramPayRuleCfg, paramString1.getAbsolutePath());
      return;
    }
  }
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    localToServiceMsg.extraData.putString(n, paramString);
  ...
  public void a(UniGetReq paramUniGetReq, ajtg paramajtg, boolean paramBoolean)
  {
    paramajtg = createToServiceMsg("QCUniBusinessLogic.uniGet", paramajtg, paramBoolean);
    paramUniGetReq.stLogin = a();
    paramajtg.extraData.putSerializable("req", paramUniGetReq);
    send(paramajtg);
  }
  
  public void a(UniSetReq paramUniSetReq, ajtg paramajtg, boolean paramBoolean)
  {
    paramajtg = createToServiceMsg("QCUniBusinessLogic.uniSet", paramajtg, paramBoolean);
    paramUniSetReq.stLogin = a();
    paramajtg.extraData.putSerializable("req", paramUniSetReq);
    send(paramajtg);
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            if ("ClubInfoSvc.queryPrivExt".equals(localObject1))
            {
              ...
              if (i1 == 1)
              {
                ...
                QLog.e("QVipSettingMe." + q, 1, "bUpdate=" + ((VipUserInfo)localObject2).bUpdate + " it do not need to update vip info");
                bbwc.a(((PrivExtV2Rsp)localObject1).trafficResult, paramToServiceMsg.extraData);
                if ((localObject2 != null) && (((VipUserInfo)localObject2).bUpdate == 1) && (((PrivExtV2Rsp)localObject1).trafficResult != null) && (((PrivExtV2Rsp)localObject1).trafficResult.bUpdate == 1) && (((PrivExtV2Rsp)localObject1).medalInfoList != null) && (((PrivExtV2Rsp)localObject1).medalInfoList.bUpdate == 1)) {
                  bbwv.a(this.app, "setting_me_get_vip_info_sequence", NetConnInfoCenter.getServerTime());
                }
                bbwv.a(this.app, "setting_me_last_request_success_time", NetConnInfoCenter.getServerTime());
                bbwv.a(this.app, "setting_me_vip_sync_freq", ((PrivExtV2Rsp)localObject1).iSyncFreq);
                if ((((PrivExtV2Rsp)localObject1).medalInfoList != null) && (((PrivExtV2Rsp)localObject1).medalInfoList.bUpdate == 1))
                {
                  ...
                  l1 = 1L;
                  bbwv.a(this.app, "key_long_setting_me_vip_medal_list_record", l1);
                }
                paramToServiceMsg = ((PrivExtV2Rsp)localObject1).itemCfgList;
                if (paramToServiceMsg != null)
                {
                  l1 = bbwv.a(this.app, "name_plate_config_version", 0L);
                  ...
                  {
                    bbwv.a(this.app, "name_plate_config_version", paramToServiceMsg.iItemCfgVer);
                ...
                QLog.e(q, 1, new Object[] { "privExtRsp.payRule ", ((PrivExtV2Rsp)localObject1).payRule.iconText, " url=", ((PrivExtV2Rsp)localObject1).payRule.iconUrl, " update=", Integer.valueOf(((PrivExtV2Rsp)localObject1).payRule.update), " new:\n", a(((PrivExtV2Rsp)localObject1).payRule) });
                if (((PrivExtV2Rsp)localObject1).payRule.update == 1)
                {
                  bbwv.a(this.app, "last_pull_pay_rule", NetConnInfoCenter.getServerTime());
              ...
              {
                if (QLog.isColorLevel()) {
                  QLog.d(q, 2, "onReceive: GetBaseVipInfoReq,isSuccess=" + bool2);
                }
                ...
                bded.a().a("ClubInfoSvc.queryPrivExt", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, "[CMD:ClubInfoSvc.queryPrivExtfailed]", true);
              }
            }
          ...
          QLog.d(q, 2, "onReceive: guanjiaReport,isSuccess=" + bool1);
          return;
