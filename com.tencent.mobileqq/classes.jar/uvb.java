  ...
  implements uvc
{
  ...
  public uvb(@NonNull uut paramuut)
  {
    super(paramuut);
  }
  ...
  private int a()
  {
    int i = ((Integer)((spz)sqg.a(10)).b("key_last_used_permission", Integer.valueOf(10000))).intValue();
    urk.a("Q.qqstory.publish.edit.EditVideoPermission", "get default permission from local. type is %d.", Integer.valueOf(i));
    return i;
  }
  ...
  private void b(int paramInt)
  {
    ...
    default: 
      ...
      paramInt = 1;
      switch (this.jdField_a_of_type_Uut.a.b())
      {
      case 2: 
      default: 
        urk.e("Q.qqstory.publish.edit.EditVideoPermission", "unKnown entrance:%s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Uut.a.b()) });
        i = 99;
      }
      break;
    }
  ...
  private void g()
  {
    ...
    {
    default: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131633740));
      return;
    case 10004: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131633748));
      return;
    case 10000: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131633740));
      return;
    case 10001: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131633744));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131633749));
  }
  
  public void Z_()
  {
    urk.b("Q.qqstory.publish.edit.EditVideoPermission", "onStop, set jump flag false.");
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131305677));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetRedDotImageView = ((RedDotImageView)a(2131305685));
  ...
  public void a(int paramInt, @NonNull vfh paramvfh)
  {
    ...
    try
    {
      for (;;)
      {
        ...
        urk.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionType:" + i);
        urk.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionUinList:" + localObject.toString());
        ...
        paramvfh.a.readerConfBytes = localVideoReaderConf.toByteArray();
        if ((paramInt == 0) && (this.jdField_b_of_type_Int != this.jdField_a_of_type_Int))
        {
          urk.b("Q.qqstory.publish.edit.EditVideoPermission", "user has changed permission during editing session. default permission is %d, new permission is %d.", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Int));
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        urk.e("Q.qqstory.publish.edit.EditVideoPermission", "MyUin , can't format uin:%s", new Object[] { this.jdField_a_of_type_JavaLangString });
      }
    }
  }
}
