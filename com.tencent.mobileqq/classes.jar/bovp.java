  ...
  extends bovr
{
  ...
  public bovp(DoodleView paramDoodleView)
  {
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 20	zdr:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            localDynamicStickerData.centerP = localbovv.jdField_a_of_type_AndroidGraphicsPointF;
            localDynamicStickerData.scale = localbovv.q;
            localDynamicStickerData.rotate = localbovv.r;
            localDynamicStickerData.translateX = (localbovv.s + paramInt1);
            localDynamicStickerData.translateY = (localbovv.t + paramInt2);
            localDynamicStickerData.height = localbovv.v;
            localDynamicStickerData.width = localbovv.u;
            localDynamicStickerData.path = localbovv.jdField_f_of_type_JavaLangString;
            localDynamicStickerData.type = localbovv.h;
            localDynamicStickerData.data = localbovv.jdField_g_of_type_JavaLangString;
            localDynamicStickerData.layerWidth = j;
            localDynamicStickerData.layerHeight = i;
            localDynamicStickerData.mapMotionTrack = localbovv.jdField_a_of_type_JavaUtilMap;
        ...
        if (((ArrayList)localObject).size() > 0)
        {
          ...
          return bpde.a((ArrayList)localObject);
        }
      }
      return null;
      i = m;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      if ((localPasterParcelData.jdField_d_of_type_Int == 3) && (!TextUtils.isEmpty(localPasterParcelData.jdField_e_of_type_JavaLangString)))
      {
        ...
        j = 1;
        localbpcq = bpbb.a(BaseApplicationImpl.getContext(), localPasterParcelData.jdField_e_of_type_JavaLangString);
        if (j == 0) {
          break label443;
        }
        paramJSONArray = localbpcq;
      }
    }
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        localbovv = new bovv(this, paramJSONArray, new bovz(localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.x, localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.y, localPasterParcelData.jdField_a_of_type_Float, localPasterParcelData.jdField_b_of_type_Float, localPasterParcelData.jdField_c_of_type_Float, localPasterParcelData.jdField_d_of_type_Float, (int)localPasterParcelData.jdField_e_of_type_Float, (int)localPasterParcelData.f), localPasterParcelData.jdField_a_of_type_JavaLangString, localPasterParcelData.jdField_b_of_type_JavaLangString, localPasterParcelData.jdField_c_of_type_JavaLangString, localPasterParcelData.jdField_d_of_type_Int);
        localbovv.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.set(localPasterParcelData.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper);
        localbovv.jdField_g_of_type_JavaLangString = localPasterParcelData.jdField_e_of_type_JavaLangString;
        localbovv.jdField_g_of_type_Int = localPasterParcelData.jdField_e_of_type_Int;
        localbovv.jdField_e_of_type_Int = 0;
        localbovv.jdField_f_of_type_Int = 1;
        localbovv.b = bpbb.a(localbpcq.a());
        localbovv.c = bpbb.b(localbpcq.a());
        if (localbovv.b)
        {
          this.b.add(localbovv);
          if (!TextUtils.isEmpty(localPasterParcelData.jdField_d_of_type_JavaLangString))
          {
            localbovv.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", localPasterParcelData.jdField_d_of_type_JavaLangString, 0, "", 0, "");
            localbovv.jdField_a_of_type_Long = System.currentTimeMillis();
          }
        }
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())) {
          break label471;
        ...
        this.jdField_a_of_type_JavaUtilList.add(localbovv);
      }
      for (;;)
      {
        i += 1;
        ...
        paramJSONArray = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localbpcq.a());
        break label90;
        label471:
        localbovv.h = 0;
        paramJSONArray = (bovr)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(bovr.jdField_a_of_type_JavaLangString);
        if (paramJSONArray != null) {
          paramJSONArray.jdField_a_of_type_JavaUtilList.add(localbovv);
        }
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        {
          Object localObject = (bovv)localIterator.next();
          if ((((bovv)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((((bovv)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof URLDrawable)))
          {
            localObject = (URLDrawable)((bovv)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            if (localObject != null)
            {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        Drawable localDrawable = ((bovv)localIterator.next()).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        if ((localDrawable instanceof bpdb)) {
          ((bpdb)localDrawable).a();
        }
      }
    }
    super.b();
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      bovv localbovv = (bovv)localIterator.next();
      Object localObject2 = a(a(localbovv.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localbovv.u, (int)localbovv.v);
      }
      Object localObject1 = localObject2;
      if (localbovv.h == 3)
      {
        localObject1 = localObject2;
        if (localbovv.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localObject1 = localObject2;
          if (!(localbovv.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bpcq)) {}
        }
      }
      for (;;)
      {
        try
        {
          localObject1 = (bpcq)localbovv.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((bpcq)localObject1).a());
        }
        catch (Exception localException2)
        {
          try
          {
            ...
            paramCanvas.save();
            paramCanvas.translate(-localbovv.u / 2.0F, -localbovv.v / 2.0F);
