...
public class bapn
{
  ...
  private bapn(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Int = localbapk.b(paramString, paramInt1);
      ...
      if (!bhca.b(paramMessage.msgtype))
      {
        bool = bhca.c(paramMessage.msgtype);
        if (!bool) {
          break label236;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_JavaLangString = anvx.a(2131709030);
      }
      catch (Exception paramMessage) {}
