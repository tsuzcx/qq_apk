  ...
  extends bawa
{
  ...
  void a(int paramInt, bawz parambawz, cmd0x352.ReqBody paramReqBody)
  {
    ...
    //   30: aload 8
    //   32: getfield 32	bawp:d	Ljava/lang/String;
    ...
    //   49: aload 8
    //   51: getfield 56	bawp:jdField_b_of_type_Int	I
    //   54: invokevirtual 61	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   57: aload 8
    //   59: getfield 64	bawp:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   62: astore 7
    //   64: aload 7
    //   66: astore_2
    //   67: aload 7
    ...
    //   103: aload 8
    //   105: getfield 81	bawp:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   108: ldc 83
    ...
    //   131: aload 8
    //   133: getfield 109	bawp:jdField_a_of_type_Boolean	Z
    //   136: invokevirtual 113	com/tencent/mobileqq/pb/PBBoolField:set	(Z)V
    //   139: ldc 115
    //   141: aload 8
    //   143: getfield 117	bawp:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   175: aload 8
    //   177: getfield 109	bawp:jdField_a_of_type_Boolean	Z
    ...
    //   202: aload 8
    //   204: getfield 135	bawp:jdField_a_of_type_Int	I
    //   207: istore_1
    //   208: iload_1
    //   209: ldc 136
    //   211: if_icmpne +136 -> 347
    //   214: invokestatic 141	azls:a	()Z
    //   217: ifeq +122 -> 339
    //   220: bipush 16
    //   222: istore_1
    //   223: iconst_4
    ...
    //   250: invokestatic 155	basj:a	()Ljava/lang/String;
    ...
    //   264: aload 8
    //   266: getfield 164	bawp:jdField_c_of_type_Int	I
    ...
    //   300: ldc 182
    //   302: aload 8
    //   304: getfield 117	bawp:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   0	381	2	parambawz	bawz
    //   0	381	3	paramReqBody	cmd0x352.ReqBody
    //   2	375	4	i	int
    //   91	8	5	l	long
    //   62	16	7	str	String
    //   8	295	8	localbawp	bawp
  ...
  public void a(bari parambari, barh parambarh)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        parambari = ((cmd0x352.RspBody)new cmd0x352.RspBody().mergeFrom(arrayOfByte)).rpt_msg_getimg_url_rsp.get();
    ...
    while (localIterator.hasNext())
    {
      ...
      try
      {
        localbaxp = (baxp)localbaxd.jdField_a_of_type_JavaUtilList.get(0);
      }
      catch (Exception parambari)
      {
        for (;;)
      ...
      try
      {
        localbawp = (bawp)localbawo.jdField_a_of_type_JavaUtilList.get(0);
        if (localbaxp == null) {
          continue;
        }
        if (localFromServiceMsg.getAttributes().containsKey("_attr_send_by_quickHttp")) {
          localbaxp.d = ((Boolean)localFromServiceMsg.getAttribute("_attr_send_by_quickHttp", Boolean.valueOf(false))).booleanValue();
        }
        ...
        if (azls.a())
        {
          parambari = localGetImgUrlRsp.bytes_big_thumb_down_para.get();
          ...
          if (parambari == null)
          {
            parambari = null;
            break label1050;
            if (localbawp.jdField_a_of_type_Int != 65537) {
              break label628;
            }
            localbaxp.jdField_a_of_type_JavaLangString = parambari;
            ...
            while (i < parambari.size())
            {
              ...
              ((basp)localObject2).jdField_a_of_type_JavaLangString = bdlr.a(((Integer)parambari.get(i)).intValue() & 0xFFFFFFFF);
              ((basp)localObject2).jdField_a_of_type_Int = ((Integer)((List)localObject1).get(i)).intValue();
              localbaxp.jdField_a_of_type_JavaUtilArrayList.add(i, localObject2);
              i += 1;
            }
          }
        }
        ...
        {
          parambari = localGetImgUrlRsp.bytes_thumb_down_para.get();
          break label396;
        }
        parambari = parambari.toStringUtf8();
        break label1050;
        localObject1 = ((ByteStringMicro)localObject1).toStringUtf8();
        break label1058;
        localObject2 = ((ByteStringMicro)localObject2).toStringUtf8();
        break label425;
        if (localbawp.jdField_a_of_type_Int == 1)
        {
          parambari = (bari)localObject2;
          break label435;
        }
        if (localbawp.jdField_a_of_type_Int != 131075) {
          break label1045;
        }
        ...
        if ((localGetImgUrlRsp.rpt_msg_down_ip6.has()) && (localGetImgUrlRsp.rpt_msg_down_ip6.size() > 0))
        {
          ...
          while (i < parambari.size())
          {
            localObject1 = new basp();
            ((basp)localObject1).jdField_a_of_type_JavaLangString = Inet6Address.getByAddress(((cmd0x352.IPv6Info)parambari.get(i)).bytes_ip6.get().toByteArray()).getHostAddress();
            ((basp)localObject1).jdField_a_of_type_Int = ((cmd0x352.IPv6Info)parambari.get(i)).uint32_port.get();
            ((basp)localObject1).jdField_a_of_type_Boolean = true;
            localbaxp.jdField_b_of_type_JavaUtilArrayList.add(i, localObject1);
            i += 1;
          }
        }
        if (localGetImgUrlRsp.bytes_down_domain.has())
        {
          ...
          localbaxp.jdField_a_of_type_JavaUtilArrayList.add(parambari);
          localbaxp.jdField_b_of_type_JavaLangString = parambari.jdField_a_of_type_JavaLangString;
        }
        if (localGetImgUrlRsp.uint32_https_url_flag.has()) {
          localbaxp.jdField_a_of_type_Int = localGetImgUrlRsp.uint32_https_url_flag.get();
        }
        a(0, 0, "", "", localalsj, localbaxp);
      }
      catch (Exception parambari)
      {
        localObject1 = localbaxp;
      }
      if (localObject1 != null)
      {
    ...
    {
      label396:
      a(-1, -9527, bamw.a(i), bamw.a(i), localalsj, localbaxp);
      break label272;
      break;
      label1024:
      azmp.a("Download_C2C_Pic_Request_Error_Param_Check", localbawp.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void a(bawo parambawo)
  {
    if ((parambawo != null) && (parambawo.jdField_a_of_type_JavaUtilList != null) && (parambawo.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localbarh.jdField_a_of_type_JavaLangString = "LongConn.OffPicDown";
