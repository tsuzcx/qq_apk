...
public class bawb
  ...
  implements bgtk
{
  public bawb(Context paramContext, Activity paramActivity, AppInterface paramAppInterface, TouchWebView paramTouchWebView)
  {
  ...
  public void buildWebView(AppInterface paramAppInterface)
  {
    ...
    this.mWebview.setWebViewClient(new bawc(this, this.mWebview.getPluginEngine()));
  }
