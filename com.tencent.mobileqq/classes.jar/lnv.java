...
public class lnv
{
  ...
  {
    bacn localbacn = new bacn(paramQQAppInterface, paramContext);
    if ((paramContext instanceof JumpActivity))
    {
      paramQQAppInterface = ((JumpActivity)paramContext).getIntent();
      if (paramQQAppInterface != null) {
        localbacn.a("from_url_InternalCheck", paramQQAppInterface.getStringExtra("url"));
      }
    }
    paramContext = bade.a(paramString, "?");
    ...
    localbacn.jdField_a_of_type_JavaLangString = paramString;
    localbacn.jdField_b_of_type_JavaLangString = "mqqavshare://";
    localbacn.c = paramQQAppInterface[1];
    paramQQAppInterface = "parser, jumpStr[" + paramString + "], server_name[" + localbacn.jdField_b_of_type_JavaLangString + "], action_name[" + localbacn.c + "]";
    ...
    while (i < j)
    {
      ...
      {
        paramContext = bade.a(arrayOfString[1], false);
        localbacn.a(arrayOfString[0], paramContext);
  ...
  {
    return paramContext.getString(2131627605);
  }
  ...
  static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = babh.h(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin());
    return paramString + paramQQAppInterface.getApp().getString(2131627608);
  }
  
  static String a(String paramString)
  {
    return azge.a("", paramString, 0) + "100";
  }
  
  static String a(lof paramlof)
  {
    String str = null;
    if (paramlof != null) {
      str = paramlof.a();
  ...
  static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, int paramInt)
  {
    ...
    new loa(l, 0).a(paramContext, paramString1, new lny(paramString2, paramQQAppInterface, paramString1, paramInt, l, new WeakReference(paramContext)));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, View paramView, Intent paramIntent)
  {
    ...
    mgc.b();
    new lnv().a(paramQQAppInterface, paramBaseActivity, str, l, i);
  }
  
  static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, View paramView, String paramString)
  {
    azgu.a(paramBaseActivity, paramString);
  }
  
  public static boolean a(bacn parambacn)
  {
    if ("avshare/group".equals(parambacn.c)) {
      return b(parambacn);
    }
    if ("avshare/forward".equals(parambacn.c)) {
      return d(parambacn);
    }
    return false;
  }
  
  static String b(lof paramlof)
  {
    if (paramlof != null) {
      return paramlof.b();
    }
  ...
  public static boolean b(bacn parambacn)
  {
    if (!"avshare/group".equals(parambacn.c)) {
      return false;
    }
    String str = (String)parambacn.jdField_a_of_type_JavaUtilHashMap.get("guid");
    ...
    abju.a(parambacn.jdField_a_of_type_AndroidContentContext, localIntent, PublicTransFragmentActivity.class, AVSchema.class);
    mgc.c();
    return true;
  }
  
  static boolean c(bacn parambacn)
  {
    if (!parambacn.a())
    {
      parambacn = (String)parambacn.jdField_a_of_type_JavaUtilHashMap.get("from_url_InternalCheck");
      QLog.w("ShareChat", 1, "handle_forward, KEY_CurrentUrl[" + parambacn + "]");
      if (!TextUtils.isEmpty(parambacn))
      {
        parambacn = parambacn.replace('\\', '/');
        if ((parambacn.startsWith("https://web.qun.qq.com/")) || (parambacn.startsWith("http://web.qun.qq.com/"))) {
          return true;
        }
      }
      return false;
  ...
  public static boolean d(bacn parambacn)
  {
    if (!"avshare/forward".equals(parambacn.c)) {
      return false;
    }
    ...
    String str1 = (String)parambacn.jdField_a_of_type_JavaUtilHashMap.get("url");
    Object localObject1 = (String)parambacn.jdField_a_of_type_JavaUtilHashMap.get("exp");
    String str2 = (String)parambacn.jdField_a_of_type_JavaUtilHashMap.get("guin");
    Object localObject2 = (String)parambacn.jdField_a_of_type_JavaUtilHashMap.get("fromchannel");
    if (TextUtils.isEmpty(str1)) {
      return false;
    }
    int i = (int)baip.a("ShareChat", (String)localObject2);
    if (i == 0) {
      return false;
    }
    mgc.a(i, str2);
    AudioHelper.b("handle_forward");
    long l1 = baip.a("ShareChat", (String)localObject1);
    long l2 = AudioHelper.a();
    if (l1 < l2)
    {
      parambacn = bbmy.a(parambacn.jdField_a_of_type_AndroidContentContext, 2131627609, 1);
      parambacn.a();
      parambacn.a();
      QLog.w("ShareChat", 1, "handle_forward, expTime[" + l1 + "], curTime[" + l2 + "]");
      return true;
    }
    if (((TroopManager)parambacn.a().getManager(52)).b(str2) == null)
    {
    ...
    localObject1 = parambacn.a();
    localObject2 = (azjh)((QQAppInterface)localObject1).getManager(48);
    boolean bool1 = ((azjh)localObject2).a(str2);
    boolean bool2 = ((azjh)localObject2).b(str2);
    if ((!bool1) && (!bool2))
    {
      if (AudioHelper.e()) {
        QLog.w("ShareChat", 1, "handle_forward, troopUin[" + str2 + "], isAdmin[" + bool1 + "], isOwner[" + bool2 + "]");
      }
      parambacn = bbmy.a(parambacn.jdField_a_of_type_AndroidContentContext, 2131627610, 1);
      parambacn.a();
      parambacn.a();
      return true;
    }
    parambacn.jdField_b_of_type_Boolean = false;
    if ((parambacn.jdField_a_of_type_AndroidContentContext instanceof JumpActivity)) {
      ((JumpActivity)parambacn.jdField_a_of_type_AndroidContentContext).a();
    }
    a((QQAppInterface)localObject1, parambacn.jdField_a_of_type_AndroidContentContext, str2, str1, i);
    return true;
  }
  ...
  void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, String paramString, long paramLong, int paramInt)
  {
    ...
    paramQQAppInterface = baei.a().a(paramString);
    long l = AudioHelper.b();
    if (paramQQAppInterface == null)
    {
    ...
    {
      this.jdField_a_of_type_Loa = new loa(l, paramInt);
      this.jdField_a_of_type_Loa.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_JavaLangString, new lnw(this, l));
      return;
      ...
      QLog.w("ShareChat", 1, "ShareChat, 从缓存中找到url, groupUin[" + paramString + "], m_share_url_with_no_sig[" + this.jdField_b_of_type_JavaLangString + "], m_share_url[" + this.c + "], seq[" + l + "], mSharePanel[" + this.jdField_a_of_type_Loa + "]");
      break;
      paramInt = 0;
      break label152;
      i = 0;
  ...
  {
    ((ajtg)paramQQAppInterface.a(20)).b(paramString, false);
    if (this.jdField_a_of_type_Lnz == null)
    {
      this.jdField_a_of_type_Lnz = new lnz(this, null);
      this.jdField_a_of_type_Lnz.jdField_a_of_type_JavaLangString = paramString;
      paramQQAppInterface.addObserver(this.jdField_a_of_type_Lnz);
    }
  }
  ...
  void b(long paramLong1, long paramLong2, int paramInt)
  {
    ...
    long l = baip.a("ShareChat", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopCard;
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = babh.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
    }
    ...
    for (;;)
    {
      ...
      kwo.a(paramLong1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "QQRTCSvc.group_video_create_share_url", localReqCreateShareUrl, (kwr)localObject1);
      return;
