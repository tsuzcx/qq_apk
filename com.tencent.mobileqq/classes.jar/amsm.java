...
public class amsm
{
  ...
  private SurfaceHolder.Callback jdField_a_of_type_AndroidViewSurfaceHolder$Callback = new amsn(this);
  public SurfaceView a;
  
  public amsm(Context paramContext, int paramInt)
  {
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = anmc.a(this.jdField_a_of_type_AndroidContentContext).a();
