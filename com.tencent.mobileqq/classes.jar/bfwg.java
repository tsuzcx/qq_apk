...
public class bfwg
{
  public static bfvp a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    catch (Exception paramString)
    {
      ...
      paramQQAppInterface = new bfvp(paramQQAppInterface, paramContext);
    ...
    localObject3 = paramString;
    Object localObject1 = anrm.a(paramQQAppInterface, paramContext, paramString);
      ...
      if (AudioHelper.e())
      {
        ...
        if (AudioHelper.a(8) == 1)
        {
          ...
          if (((String)localObject1).startsWith("mqqconferenceflyticket://"))
          {
            ...
            {
              localObject3 = localObject1;
              return lyc.a(paramQQAppInterface, paramContext, paramString);
            }
            localObject3 = localObject1;
            if (paramString.startsWith("mqqapi://qzone/groupalbum"))
            {
              ...
              localObject3 = localObject1;
              localObject4 = new bfvp(paramQQAppInterface, paramContext);
              localObject3 = localObject1;
              ...
              localObject3 = localObject1;
              ((bfvp)localObject4).a = paramString;
              localObject3 = localObject1;
              ((bfvp)localObject4).b = localObject2[0];
              localObject3 = localObject1;
              ((bfvp)localObject4).c = localObject2[1];
              localObject3 = localObject1;
    ...
    for (;;)
    {
      ...
      if (i < paramString.length)
      {
        ...
        try
        {
          ...
          localObject3 = localObject1;
          ((bfvp)localObject4).a(localObject2[0], localObject2[1]);
        }
  ...
  private static bfvp a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
  ...
  private static bfvp a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    String str = "";
    bfvp localbfvp = new bfvp(paramQQAppInterface, paramContext);
    if (paramString2.startsWith("mqqapi://now/openroom"))
    {
      localbfvp.a = paramString2;
      ...
      localbfvp.a("attr_original_url", paramString1);
    }
    label144:
    int i;
    for (;;)
    ...
    label399:
    localbfvp.a = paramContext;
    localbfvp.b = paramQQAppInterface[0];
    ...
    if (paramBoolean1)
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        for (paramBoolean1 = true;; paramBoolean1 = false)
        {
          ...
          if (j > 0) {
            localbfvp.a(paramContext.substring(0, j), paramContext.substring(j + 1, paramContext.length()));
          }
          i += 1;
          break;
        }
    ...
    else
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        if (paramContext.length == 2)
        {
          ...
          localbfvp.a(paramContext[0], a(paramContext[1], false));
        }
        for (;;)
        {
          i += 1;
          break;
          label587:
          localbfvp.a(paramContext[0], paramContext[1]);
        }
      }
    }
    return localbfvp;
