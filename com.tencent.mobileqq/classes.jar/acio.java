...
public class acio
{
  ...
  public static void a(Intent paramIntent)
  {
    ...
    if ((jdField_a_of_type_JavaUtilHashMap == null) || (jdField_a_of_type_JavaUtilHashMap.size() > 25))
    {
      ...
      jdField_a_of_type_JavaUtilHashMap.put("network_type", mpl.a() + "");
    ...
    for (;;)
    {
      ...
      break label249;
      label465:
      if ((bbca.s) || (jdField_a_of_type_Int > 1)) {
        i = 2;
      } else {
        i = 3;
      }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    int j = awup.a(paramMessageRecord.istroop);
    if (acgk.a) {}
    for (int i = 1;; i = 2)
    {
      a(paramIntent, j, i);
    ...
    catch (Exception localException)
    {
      try
      {
        for (;;)
        {
          ...
          awrn.a(BaseApplication.getContext()).a(null, "AIOWeb", false, 0L, 0L, jdField_a_of_type_JavaUtilHashMap, "", false);
          b = -1;
          if (Build.VERSION.SDK_INT > 10)
          {
            paramIntent = BaseApplicationImpl.getApplication().getSharedPreferences("web_process_preload_file", 4);
      ...
      catch (Exception paramIntent)
      {
        for (;;)
        {
          ...
          if (l2 - l1 > 86400000L)
          {
            ...
            awrn.a(BaseApplication.getContext()).a(null, "AIOWebPreloadhit", false, 0L, 0L, localHashMap, "", false);
