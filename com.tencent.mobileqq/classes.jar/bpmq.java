  ...
  extends bpma
{
  ...
  {
    int k = 0;
    yqp.b("MosaicOperator", "increaseMask:x=" + paramInt1 + ",y=" + paramInt2 + ",MosaicMaskWidth:" + this.jdField_e_of_type_Int + ",MosaicMaskHeight:" + this.f);
  ...
  {
    int k = 0;
    yqp.b("MosaicOperator", "decreaseMask:x=" + paramInt1 + ",y=" + paramInt2 + ",MosaicMaskWidth:" + this.jdField_e_of_type_Int + ",MosaicMaskHeight:" + this.f);
    int[] arrayOfInt1 = new int[5];
    arrayOfInt1[0] = paramInt1;
    arrayOfInt1[1] = (paramInt1 - 1);
    arrayOfInt1[2] = paramInt1;
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      while (k < this.jdField_a_of_type_Array2dOfByte.length)
      {
        ...
        yqp.b("MosaicOperator", localStringBuilder.toString());
  ...
  public void a(Canvas paramCanvas, bpmp parambpmp, float paramFloat)
  {
    if (parambpmp.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (parambpmp.jdField_a_of_type_Int == 104)
      {
        ...
        paramCanvas.drawPath(parambpmp.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (parambpmp.jdField_a_of_type_Int != 105);
    if (this.jdField_a_of_type_AndroidGraphicsCanvas == null)
    {
      yqp.d("MosaicOperator", "do not init yet");
      return;
    }
    ...
    if (this.h == 0) {
      this.h = afur.a(16.0F, BaseApplicationImpl.getContext().getResources());
    }
    this.jdField_a_of_type_AndroidGraphicsPaint.setXfermode(null);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(this.h);
    this.jdField_a_of_type_AndroidGraphicsPaint.setShader(null);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(parambpmp.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsCanvas.restore();
    this.jdField_b_of_type_Boolean = true;
  }
  
  public void a(bphz parambphz, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
    this.jdField_a_of_type_Bphz = parambphz;
    this.jdField_c_of_type_Float = paramFloat;
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_AndroidGraphicsRect = paramRect;
  }
  
  public void a(bpmp parambpmp)
  {
    if (parambpmp.jdField_a_of_type_Int == 103)
    {
      DoodleLayout.a("delete_mosaics");
      yqv.a("0X80076C2");
      List localList = parambpmp.jdField_a_of_type_JavaUtilList;
      parambpmp = parambpmp.b;
      int k = 0;
      while ((k < localList.size()) && (k < parambpmp.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)parambpmp.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      yqp.a("MosaicOperator", "clearMp4MosaicCanvasAndDraw notify=%s", Boolean.valueOf(paramBoolean));
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bpmp = new bpmp(this.g);
      if (this.jdField_a_of_type_Bplw != null) {
        this.jdField_a_of_type_Bplw.a(this.jdField_a_of_type_Bpmp);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Bpmp.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Bpmp.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Bpmp.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Bpmp.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
        this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilArrayList.add(new bpmx(bpmx.jdField_a_of_type_Int, f1, f2));
        this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilArrayList.add(new bpmx(bpmx.jdField_b_of_type_Int, f1 + 1.0F, 1.0F + f2));
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Bpmp.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Bpmp.b.get(this.jdField_a_of_type_Bpmp.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Bpmp.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        else
        {
          ...
          if (this.g == 104)
          {
            ...
            this.jdField_a_of_type_Bpmp.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, f3, f4);
            this.jdField_a_of_type_Bpmp.jdField_a_of_type_JavaUtilArrayList.add(new bpmx(bpmx.jdField_c_of_type_Int, this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, f3, f4));
            this.jdField_d_of_type_Float = f1;
            this.jdField_e_of_type_Float = f2;
          }
          else if (this.g == 105)
  ...
  public void b()
  {
    ...
    {
      k = zlx.a(BaseApplicationImpl.getContext());
      m = zlx.d(BaseApplicationImpl.getContext());
    ...
    for (int k = 2;; k = 8)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          yqp.a("MosaicOperator", "init matrix. scale[%f, %f]. translate[%f, %f].", Float.valueOf(f1), Float.valueOf(f1), Float.valueOf(f2), Float.valueOf(f3));
        ...
        {
          yqp.c("MosaicOperator", "initMosaicPicMode.", localOutOfMemoryError);
          return;
        }
        catch (IllegalArgumentException localIllegalArgumentException)
        {
          yqp.c("MosaicOperator", "initMosaicPicMode.", localIllegalArgumentException);
          return;
        }
        localBitmap = null;
        break label26;
  ...
  {
    yqp.b("MosaicOperator", "set MosaicSize:" + paramInt);
    this.jdField_b_of_type_Int = paramInt;
  }
  
  public void b(int paramInt1, int paramInt2)
  {
    yqp.b("MosaicOperator", "standardWidth:" + paramInt1 + ",standardHeight:" + paramInt2);
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Bphz != null)
    {
      if (this.g != 105) {
        break label50;
      }
      this.jdField_a_of_type_Bphz.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Bphz.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    {
      yqp.e("MosaicOperator", "mosaicHeightScale <= 0.");
    ...
    yqp.b("MosaicOperator", "create mosaic mask array, width:" + this.jdField_e_of_type_Int + ",height:" + this.f + ",array length:" + this.jdField_e_of_type_Int * this.f);
