...
public class bgyh
{
  private static bgyh jdField_a_of_type_Bgyh;
  ...
  public static bgyh a()
  {
    if (jdField_a_of_type_Bgyh == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bgyh == null) {
        jdField_a_of_type_Bgyh = new bgyh();
      }
      return jdField_a_of_type_Bgyh;
    }
  }
  ...
  public String a()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = bfnn.a("52b7f2");
    }
  ...
  public String c()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((StringBuilder)localObject2).append("mm=").append(bbdh.d() / 1048576L).append('&');
      ((StringBuilder)localObject2).append("cf=").append(bbdh.a()).append('&');
      ((StringBuilder)localObject2).append("cc=").append(bbdh.b()).append('&');
      ((StringBuilder)localObject2).append("aid=").append(bbdh.f()).append('&');
  ...
  public String f()
  {
    ...
    ((StringBuilder)localObject).append("mm=").append(bbdh.d() / 1048576L).append('&');
    ((StringBuilder)localObject).append("cf=").append(bbdh.a()).append('&');
    ((StringBuilder)localObject).append("cc=").append(bbdh.b()).append('&');
    ((StringBuilder)localObject).append("qqversion=").append("8.3.0");
