  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  aphv jdField_a_of_type_Aphv;
  apia jdField_a_of_type_Apia = new apia();
  ...
  private apic[] jdField_a_of_type_ArrayOfApic = new apic[300];
  ...
  public apib(aphq paramaphq)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Aphq = paramaphq;
    this.jdField_a_of_type_Aphv = paramaphq.a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Apia.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844893, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Aphq.a().getResources(), 2130844894, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Aphv.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Aphv.c = 0L;
    this.jdField_a_of_type_Aphv.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Apia != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Apia.a(paramSize.getHeight(), paramSize.getWidth(), apsm.jdField_a_of_type_Int, apsm.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localapic2 = this.jdField_a_of_type_ArrayOfApic[i4];
      if ((localapic2 != null) && (!localapic2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localapic2.jdField_b_of_type_Float * 0.35F - Math.abs(localapic2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localapic2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localapic2 != null)
        {
          localapic1 = localapic2;
          i3 = i2;
          if (!localapic2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localapic2.jdField_b_of_type_Float;
      localapic2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localapic2.jdField_b_of_type_Float + f2 + f4);
      if (localapic2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localapic2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localapic2 == null)
      {
        localapic1 = new apic(this);
        this.jdField_a_of_type_ArrayOfApic[i4] = localapic1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localapic1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localapic1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localapic1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localapic1 == null) || (localapic1.jdField_a_of_type_Boolean) || (localapic1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfApic[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfApic[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localapic1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aphv.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Aphv.c > this.jdField_a_of_type_Aphv.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Aphv;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Apia != null) && (this.u == 2)) {
        this.jdField_a_of_type_Apia.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    a();
    if (apmm.a() != null) {
      this.jdField_a_of_type_Apia.a(BaseApplicationImpl.getContext());
    }
  }
}
