...
class ahbv
  implements Runnable
{
  ahbv(ahbu paramahbu, int paramInt, RichStatus paramRichStatus, TipsInfo paramTipsInfo) {}
  
  public void run()
  {
    if (StatusManager.b(this.jdField_a_of_type_Ahbu.a.a) != null)
    {
      Iterator localIterator = StatusManager.b(this.jdField_a_of_type_Ahbu.a.a).iterator();
