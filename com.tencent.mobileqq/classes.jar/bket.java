...
public class bket
  implements bkbn<bkbi>
{
  private final int jdField_a_of_type_Int = bkik.a(DoodleLayout.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  
  private bket(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bkbi parambkbi, MotionEvent paramMotionEvent)
  {
    ...
    for (float f1 = bkvi.e;; f1 = 0.0F)
    {
      ...
      case 6: 
        do
        {
          ...
          parambkbi = this.jdField_a_of_type_AndroidGraphicsRect;
          parambkbi.top -= this.jdField_a_of_type_Int;
          parambkbi = this.jdField_a_of_type_AndroidGraphicsRect;
          parambkbi.bottom += this.jdField_a_of_type_Int;
