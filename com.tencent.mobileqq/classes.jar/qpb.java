...
public class qpb
{
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      {
        paramBaseArticleInfo = bjnd.a(paramBaseArticleInfo);
        ...
        {
          paramBaseArticleInfo = (String)bjnd.a(Uri.decode(str)).get("rowkey");
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.d = bfwv.a(BaseApplicationImpl.getApplication(), "com.tencent.reading");
      c = false;
      return;
      bool = false;
    }
  ...
  public String a(String paramString)
  {
    ...
    {
      return paramString;
      str = (String)bjnd.a(paramString).get("rowkey");
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    b(pkm.a().a(Integer.valueOf(paramInt), paramList));
  }
