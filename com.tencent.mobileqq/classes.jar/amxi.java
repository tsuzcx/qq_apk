  ...
  implements bbnm
{
  ...
  public amxi(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private boolean a(bboi parambboi, String paramString)
  {
    if (parambboi == null) {}
    while (parambboi.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.4.8");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)DeviceInfoUtil.getSystemTotalMemory() / 1048576);
      ...
      Object localObject4 = bfza.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (bboi)this.a.getManager(12);
      ...
      System.arraycopy(bfqc.b(i), 0, localObject2, 0, 4);
    ...
    if (paramRespItem != null)
    {
      ...
      if (i == 2) {
        try
        {
          ...
          {
            i = (int)PkgTools.getLongData((byte[])localObject1, 0);
            paramRespItem = new byte[i - 4];
            PkgTools.copyData(paramRespItem, 0, (byte[])localObject1, 4, i - 4);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          bfza.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
