  ...
  implements adif, Handler.Callback
{
  ...
  public adit(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    paramString = new aqvb(paramChatMessage.frienduin, paramChatMessage.selfuin, paramString, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, -5020, 655392, paramChatMessage.time);
    ...
    aqvc.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForUniteGrayTip);
    QLog.e("vip_ptt.helper", 1, "It is need add gray msg and insert success");
  }
  
  private boolean a()
  {
    if ((amzc.c().a <= 1) && (adwt.d)) {
      return !bbxj.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_gray_msg", false);
    }
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (amzc.c().a <= 1)
    {
      a(paramMessage, ajya.a(2131708719));
      bbxj.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_gray_msg", true);
    }
    return true;
  }
}
