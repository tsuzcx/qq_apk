  ...
  implements abrg
{
  ...
  public abrn(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, abrh paramabrh)
  {
    ...
    if (localJSONObject != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject3 = new YunYingFileUploadRunnable((URL)localObject2, (String)localObject3, paramabrh, paramResultObject.dbId, this.a);
    ...
    paramResultObject = new JsonUploadRunnable(new URL("http://zhizi.qq.com/json.php"), localJSONObject, paramabrh, paramResultObject.dbId, this.a);
