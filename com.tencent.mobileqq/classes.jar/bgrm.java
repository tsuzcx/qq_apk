...
public class bgrm
{
  ...
  private static bgrp jdField_a_of_type_Bgrp = new bgrp(Looper.getMainLooper(), null);
  ...
  private static BlockingQueue<WeakReference<bgrm>> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new LinkedBlockingQueue();
  ...
  public bgrm(Context paramContext)
  {
  ...
  public static bgrm a(Context paramContext, int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    paramContext = new bgrm(paramContext);
  ...
  public static bgrm a(Context paramContext, CharSequence paramCharSequence, int paramInt)
  {
  ...
  {
    return a(paramInt, 2131559360, null);
  }
  
  public Toast a(int paramInt1, int paramInt2, View.OnTouchListener paramOnTouchListener)
  {
    bgro localbgro = new bgro(this.jdField_a_of_type_AndroidContentContext);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      localbgro.setGravity(55, 0, 0);
    }
    for (;;)
    {
      localbgro.setView(localView);
      localbgro.setDuration(this.jdField_c_of_type_Int);
      if (a()) {
        localView.setOnTouchListener(new bgrn(this, localbgro, paramOnTouchListener));
      }
      return localbgro;
      ...
      if (paramInt1 == 6316128) {
        localbgro.setGravity(55, 0, a());
      } else {
        localbgro.setGravity(55, 0, b());
      }
    }
  }
  ...
  public void a()
  {
    ...
    jdField_a_of_type_Bgrp.sendEmptyMessage(2);
  }
