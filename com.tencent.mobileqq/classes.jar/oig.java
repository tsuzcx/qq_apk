...
public class oig
{
  ...
  pgr jdField_a_of_type_Pgr = new oih(this);
  ...
  public oig(ReadInjoyFriendsBiuComponentFragment paramReadInjoyFriendsBiuComponentFragment, Context paramContext)
  {
    a(paramContext);
  ...
  {
    ReadInJoyUserInfo localReadInJoyUserInfo = ReadInJoyUserInfoModule.a(paramLong, new oii(this, paramLong));
  ...
  public void a(MultiBiuSameContent paramMultiBiuSameContent, int paramInt)
  {
    ...
    Object localObject = orr.a(paramMultiBiuSameContent.jdField_b_of_type_Int, true);
    if (localObject != null) {
