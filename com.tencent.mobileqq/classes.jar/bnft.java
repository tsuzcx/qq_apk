  ...
  implements bnfr
{
  ...
  protected bnft(bnfm parambnfm)
  {
    super(parambnfm);
    this.jdField_a_of_type_Boolean = bnzc.a();
    this.jdField_a_of_type_Bnfr = this;
    this.a = new akhi();
    this.jdField_a_of_type_Akhi = ((akhi)this.a);
  }
  
  public static bnfq a(bnfm parambnfm)
  {
    if ((jdField_a_of_type_Bnfq == null) || (jdField_a_of_type_Bnfq.jdField_a_of_type_MqqUtilWeakReference.get() != parambnfm)) {}
    try
    {
      if ((jdField_a_of_type_Bnfq == null) || (jdField_a_of_type_Bnfq.jdField_a_of_type_MqqUtilWeakReference.get() != parambnfm)) {
        jdField_a_of_type_Bnfq = new bnft(parambnfm);
      }
      return jdField_a_of_type_Bnfq;
    }
    finally {}
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = paramViewGroup.jdField_a_of_type_AndroidContentResResources.getDrawable(2130847649);
  ...
  protected bnex a()
  {
    return new bney((bnfm)this.jdField_a_of_type_MqqUtilWeakReference.get());
  }
  ...
  {
    super.a(paramIntent);
    this.jdField_a_of_type_Akhi.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_FINISH_RESTART_INIT_ACTIVITY", false);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.isShowQzoneAlbum)
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(this.jdField_a_of_type_Akhi.jdField_a_of_type_Ayev);
  ...
  public boolean a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    if (paramQQAlbumInfo._id.equals("qzone_album"))
    {
      ...
      blsb.a(((bnfm)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), localblsi, (Bundle)localObject, 100016);
