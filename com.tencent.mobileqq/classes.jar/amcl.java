...
public class amcl
{
  ...
  public static HashMap<String, amcl> a(int paramInt, JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject.has("animation_sets"))
    {
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (localObject1 = amcn.a((JSONObject)localObject1);; localObject1 = amcm.a((JSONObject)localObject1))
          {
            if (localObject1 == null) {
              break label226;
            }
            ((amcl)localObject1).jdField_a_of_type_Int = paramInt;
            paramJSONObject.put(((amcl)localObject1).jdField_a_of_type_JavaLangString, localObject1);
            break;
          }
        }
      }
    ...
    if ((localObject1 != null) && (((HashMap)localObject1).size() > 0)) {
      ambe.a().a.put(Integer.valueOf(paramInt), localObject1);
    }
    return localObject1;
  }
