  ...
  extends SQLiteOpenHelper
{
  ...
  {
    bfhg.b("PCPushDBHelper", "addPkgEntry>>>insert entry = " + parambfmw.toString());
    ...
    try
    {
      ...
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("key", parambfmw.jdField_a_of_type_JavaLangString);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("appid", parambfmw.jdField_b_of_type_JavaLangString);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("appname", parambfmw.e);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("appsize", parambfmw.h);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("appurl", parambfmw.f);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("downloadtype", Integer.valueOf(parambfmw.jdField_d_of_type_Int));
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("filetype", Integer.valueOf(parambfmw.jdField_b_of_type_Int));
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("iconurl", parambfmw.g);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("pkgname", parambfmw.jdField_d_of_type_JavaLangString);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("source", parambfmw.i);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("srciconurl", parambfmw.j);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("versioncode", Integer.valueOf(parambfmw.jdField_a_of_type_Int));
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("via", parambfmw.jdField_c_of_type_JavaLangString);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("key", parambfmw.jdField_a_of_type_JavaLangString);
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("installstate", Integer.valueOf(parambfmw.jdField_c_of_type_Int));
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      localContentValues.put("timestamp", Long.valueOf(System.currentTimeMillis()));
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      int i = localSQLiteDatabase.update("pcpush_package_info", localContentValues, "key = ?", new String[] { parambfmw.jdField_a_of_type_JavaLangString });
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
      bfhg.a("PCPushDBHelper", "addPkgEntry>>>update affected rowNum=" + i);
      if (i == 0)
      {
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
        ...
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
        bfhg.a("PCPushDBHelper", "addPkgEntry>>>insert rowID = " + l);
      }
      localObject1 = localSQLiteDatabase;
      localObject2 = localSQLiteDatabase;
    ...
    catch (Exception parambfmw)
    {
      localObject2 = localObject1;
      bfhg.c("PCPushDBHelper", "addPkgEntry error", parambfmw);
      return;
    }
    finally
    {
  ...
  {
    bfhg.a("PCPushDBHelper", "--> delete key = " + paramString);
    try
    {
      SQLiteDatabase localSQLiteDatabase = getWritableDatabase();
    ...
    {
      bfhg.c("PCPushDBHelper", "deletePkgEntry error", paramString);
    }
  }
  
  /* Error */
  public void a(java.util.concurrent.ConcurrentHashMap<String, bfmw> paramConcurrentHashMap)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    ...
    //   9: astore 4
    //   11: aload_0
    //   12: invokevirtual 240	bfmt:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   15: astore 5
    //   17: aload 7
    //   19: astore_3
    //   20: aload 6
    ...
    //   83: new 103	bfmw
    //   86: dup
    //   87: invokespecial 255	bfmw:<init>	()V
    //   90: astore 7
    //   92: aload 6
    //   94: astore_3
    //   95: aload 6
    ...
    //   117: putfield 113	bfmw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   120: aload 6
    //   122: astore_3
    //   123: aload 6
    //   125: astore 4
    ...
    //   145: putfield 118	bfmw:e	Ljava/lang/String;
    //   148: aload 6
    //   150: astore_3
    //   151: aload 6
    //   153: astore 4
    ...
    //   173: putfield 123	bfmw:h	Ljava/lang/String;
    //   176: aload 6
    //   178: astore_3
    //   179: aload 6
    //   181: astore 4
    ...
    //   201: putfield 128	bfmw:f	Ljava/lang/String;
    //   204: aload 6
    //   206: astore_3
    //   207: aload 6
    //   209: astore 4
    ...
    //   229: putfield 147	bfmw:jdField_b_of_type_Int	I
    //   232: aload 6
    //   234: astore_3
    //   235: aload 6
    //   237: astore 4
    ...
    //   257: putfield 152	bfmw:g	Ljava/lang/String;
    //   260: aload 6
    //   262: astore_3
    //   263: aload 6
    //   265: astore 4
    ...
    //   285: putfield 156	bfmw:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   288: aload 6
    //   290: astore_3
    //   291: aload 6
    //   293: astore 4
    ...
    //   313: putfield 161	bfmw:i	Ljava/lang/String;
    //   316: aload 6
    //   318: astore_3
    //   319: aload 6
    //   321: astore 4
    ...
    //   341: putfield 166	bfmw:j	Ljava/lang/String;
    //   344: aload 6
    //   346: astore_3
    //   347: aload 6
    //   349: astore 4
    ...
    //   369: putfield 170	bfmw:jdField_a_of_type_Int	I
    //   372: aload 6
    //   374: astore_3
    //   375: aload 6
    //   377: astore 4
    ...
    //   397: putfield 174	bfmw:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   400: aload 6
    //   402: astore_3
    //   403: aload 6
    //   405: astore 4
    ...
    //   425: putfield 134	bfmw:jdField_d_of_type_Int	I
    //   428: aload 6
    //   430: astore_3
    //   431: aload 6
    //   433: astore 4
    ...
    //   453: putfield 106	bfmw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   456: aload 6
    //   458: astore_3
    //   459: aload 6
    //   461: astore 4
    ...
    //   481: putfield 178	bfmw:jdField_c_of_type_Int	I
    //   484: aload 6
    //   486: astore_3
    //   487: aload 6
    //   489: astore 4
    //   491: aload_1
    //   492: aload 7
    //   494: getfield 106	bfmw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   497: aload 7
    ...
    //   550: ldc_w 278
    //   553: aload_3
    //   554: invokestatic 228	bfhg:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   557: aload 4
    //   559: ifnull +10 -> 569
    //   562: aload 4
    ...
    //   0	630	0	this	bfmt
    //   0	630	1	paramConcurrentHashMap	java.util.concurrent.ConcurrentHashMap<String, bfmw>
  ...
  {
    bfhg.a("PCPushDBHelper", "--> start--DatabaseHelper onCreate<<<<");
    ...
    bfhg.a("PCPushDBHelper", "--> end--DatabaseHelper onCreate<<<<");
  }
  
  public void onDowngrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    bfhg.c("PCPushDBHelper", "onDowngrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
  
  public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    bfhg.c("PCPushDBHelper", "onUpgrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
}
