...
public class bfmt
{
  public Context a;
  public Handler a;
  private aofu jdField_a_of_type_Aofu = new bfmu(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  
  public bfmt(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, Handler paramHandler)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ((aoep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a(true, this.jdField_a_of_type_JavaLangString, str, 5);
      if (l1 == 0L)
      {
