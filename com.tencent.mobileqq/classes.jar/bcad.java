...
import com.tencent.mobileqq.startup.director.StartupDirector.4;
import com.tencent.mobileqq.startup.director.StartupDirector.6;
  ...
  implements Handler.Callback
{
  ...
  private static long jdField_l_of_type_Long;
  ...
  private final int a(android.content.Context paramContext)
  {
    ...
    //   12: iconst_0
    //   13: istore_2
    //   14: new 115	java/io/File
    //   17: dup
    //   18: aload_1
    //   19: invokevirtual 121	android/content/Context:getFilesDir	()Ljava/io/File;
    //   22: ldc 123
    //   24: invokespecial 126	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   27: astore 9
    //   29: iload 4
    //   31: istore_3
    //   32: aload 9
    //   34: invokevirtual 130	java/io/File:exists	()Z
    //   37: ifeq +49 -> 86
    //   40: new 132	java/io/BufferedInputStream
    //   43: dup
    //   44: new 134	java/io/FileInputStream
    //   47: dup
    //   48: aload 9
    //   50: invokespecial 137	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   53: invokespecial 140	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   56: astore 5
    //   58: aload 5
    //   60: astore_1
    //   61: aload 5
    //   63: invokevirtual 144	java/io/BufferedInputStream:read	()I
    //   66: istore_3
    //   67: iload_3
    //   68: iconst_m1
    ...
    //   76: ifnull +10 -> 86
    //   79: aload 5
    //   81: invokevirtual 147	java/io/BufferedInputStream:close	()V
    //   84: iload_2
    //   85: istore_3
    //   86: iload_3
    //   87: iconst_1
    ...
    //   90: aload 8
    //   92: astore_1
    //   93: new 149	java/io/FileOutputStream
    //   96: dup
    //   97: aload 9
    //   99: invokespecial 150	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   102: astore 5
    //   104: aload 5
    //   106: iload_2
    //   107: invokevirtual 153	java/io/FileOutputStream:write	(I)V
    //   110: aload 5
    //   112: ifnull +8 -> 120
    //   115: aload 5
    //   117: invokevirtual 154	java/io/FileOutputStream:close	()V
    //   120: iload_2
    //   121: ireturn
    //   122: astore_1
    //   123: aload_1
    //   124: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   127: iload_2
    //   128: istore_3
    //   129: goto -43 -> 86
    //   132: astore 6
    ...
    //   139: astore_1
    //   140: aload 6
    //   142: invokevirtual 158	java/lang/Exception:printStackTrace	()V
    //   145: iload 4
    //   147: istore_3
    //   148: aload 5
    //   150: ifnull -64 -> 86
    //   153: aload 5
    //   155: invokevirtual 147	java/io/BufferedInputStream:close	()V
    //   158: iload 4
    //   160: istore_3
    //   161: goto -75 -> 86
    //   164: astore_1
    //   165: aload_1
    //   166: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   169: iload 4
    //   171: istore_3
    //   172: goto -86 -> 86
    //   175: astore_1
    ...
    //   182: ifnull +8 -> 190
    //   185: aload 5
    //   187: invokevirtual 147	java/io/BufferedInputStream:close	()V
    //   190: aload_1
    //   191: athrow
    //   192: astore 5
    //   194: aload 5
    //   196: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   199: goto -9 -> 190
    //   202: astore_1
    //   203: aload_1
    //   204: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   207: iload_2
    //   208: ireturn
    //   209: astore 6
    //   211: aload 7
    ...
    //   217: astore_1
    //   218: aload 6
    //   220: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   223: aload 5
    //   225: ifnull -105 -> 120
    //   228: aload 5
    //   230: invokevirtual 154	java/io/FileOutputStream:close	()V
    //   233: iload_2
    //   234: ireturn
    //   235: astore_1
    //   236: aload_1
    //   237: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   240: iload_2
    //   241: ireturn
    //   242: astore 6
    //   244: aload_1
    ...
    //   252: ifnull +8 -> 260
    //   255: aload 5
    //   257: invokevirtual 154	java/io/FileOutputStream:close	()V
    //   260: aload_1
    //   261: athrow
    //   262: astore 5
    //   264: aload 5
  ...
  public static bcad a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("AutoMonitor", 2, "onApplicationCreate ");
    }
    bcad localbcad = new bcad();
    localbcad.a(0);
    bccs.b(0, localbcad, jdField_b_of_type_ArrayOfInt).step();
    ...
    try
    {
      ...
      jdField_a_of_type_Boolean = false;
      bccs.b(13, localbcad, null).step();
      if (BaseApplicationImpl.sProcessId == 2)
      {
        bccs.b(11, localbcad, null).step();
        bccs.b(40, localbcad, null).step();
        ThreadManager.post(bccs.b(0, localbcad, jdField_l_of_type_ArrayOfInt), 10, null, false);
        bccs.b(0, localbcad, jdField_k_of_type_ArrayOfInt).step();
      }
      for (;;)
      {
        return null;
        ...
        {
          bccs.b(0, localbcad, r).step();
        }
        else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
        {
          bccs.b(11, localbcad, null).step();
          bccs.b(8, localbcad, null).step();
          bccs.b(0, localbcad, jdField_i_of_type_ArrayOfInt).step();
          bccs.b(12, localbcad, null).step();
          bccs.b(47, localbcad, null).step();
          if (BaseApplicationImpl.sProcessId == 7) {
            bccs.b(49, localbcad, null).step();
          }
        }
        ...
        else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
        {
          ...
          {
            ThreadManager.excute(bccs.b(0, localbcad, jdField_a_of_type_ArrayOfInt), 16, null, false);
          }
          else
          {
      ...
      if (BaseApplicationImpl.processName.endsWith(":troopbar"))
      {
        bccs.b(12, localbcad, null).step();
        bccs.b(11, localbcad, null).step();
        bccs.b(14, localbcad, null).step();
      }
      for (;;)
      {
        if (BaseApplicationImpl.processName.endsWith(":troophomework")) {
          bccs.b(38, localbcad, null).step();
        }
        if (!BaseApplicationImpl.processName.endsWith(":live")) {
          break;
        }
        bccs.b(48, localbcad, null).step();
        break;
        bccs.b(0, localbcad, jdField_j_of_type_ArrayOfInt).step();
      }
    }
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = a();
        bool = DeviceInfoUtil.isLowPerfDevice();
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              anez.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
    ...
    if ((jdField_a_of_type_Boolean) || (BaseApplicationImpl.sProcessId == 1))
    {
      ...
      if (this.jdField_e_of_type_Int != -1)
      {
        ...
        if (jdField_a_of_type_Boolean) {
          Log.i("AutoMonitor", "STATE_" + this.jdField_e_of_type_Int + ", cost=" + (l2 - jdField_l_of_type_Long) + " then " + paramInt);
        }
        l1 = l2;
        if (BaseApplicationImpl.sProcessId == 1)
        {
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(this.jdField_e_of_type_Int), Long.valueOf(l2 - jdField_l_of_type_Long));
          l1 = l2;
        }
      }
      if (paramInt != 1000)
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(bccs.b(10, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(bccs.b(22, this, null));
      }
    }
    ...
    for (BaseApplicationImpl.sShowTime = -l1;; BaseApplicationImpl.sShowTime = 0L)
    {
      ...
      if (this.jdField_a_of_type_Bcae != null)
      {
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = bccs.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = bccs.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693121);
    }
    for (;;)
    {
      paramAppActivity.setContentView(localTextView);
      QLog.flushLog();
      this.jdField_b_of_type_AndroidOsHandler.postDelayed(new StartupDirector.6(this, paramAppActivity), 8000L);
      return;
      localTextView.setText(amtj.a(2131713384));
    }
  }
  ...
  public void a(bcae parambcae)
  {
    this.jdField_a_of_type_Bcae = parambcae;
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)bccs.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(bccs.b(14, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            bccs.b(0, this, paramObject).step();
            aafi.f();
        ...
        for (;;)
        {
          ...
          if (this.jdField_e_of_type_Int == 2)
          {
            bccs.b(0, this, jdField_m_of_type_ArrayOfInt).step();
            a(101);
          }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)bccs.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = bccs.b(13, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bfzb.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bfzb.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            if (paramMessage.arg1 == 0)
            {
              if (this.jdField_a_of_type_Long > 0L) {
                this.jdField_j_of_type_Long = (this.jdField_k_of_type_Long + this.jdField_a_of_type_Long - SystemClock.uptimeMillis());
              }
              if (BaseApplicationImpl.isCurrentVersionFirstLaunch)
              {
                System.gc();
                this.jdField_j_of_type_Long = 2000L;
              }
              if ((this.jdField_j_of_type_Long > 0L) && (this.jdField_j_of_type_Long < 6000L))
              {
                if (this.jdField_a_of_type_Bcae != null)
                {
                  a(6, 2, this.jdField_j_of_type_Long);
                  return true;
                }
                a(6, 1, this.jdField_j_of_type_Long);
                return true;
              }
              c();
              return true;
            ...
            this.jdField_a_of_type_Bcae.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
              this.jdField_j_of_type_Long = this.jdField_a_of_type_Long;
            }
            QLog.i("SplashAD", 1, "mDelay" + this.jdField_j_of_type_Long);
            if ((this.jdField_j_of_type_Long > 0L) && (this.jdField_j_of_type_Long < 11000L))
            {
              a(15, 1, this.jdField_j_of_type_Long);
              return true;
            }
            c();
            return true;
            bccs.b(14, this, null).step();
            if (BaseApplicationImpl.sProcessId == 7)
            {
              a(13, 0, 0L);
              return true;
      ...
      bccs.b(29, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Bcae.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Bcae.a();
