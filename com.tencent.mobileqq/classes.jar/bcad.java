  ...
  implements Manager
{
  ...
  public static HashMap<String, bcah> a;
  public static String[] a;
  bbwt jdField_a_of_type_Bbwt = new bcae(this);
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = ajsd.aW + "voiceChange/";
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { null, null, null };
  }
  
  public bcad(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	bcad:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	bcah
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	bcah:jdField_a_of_type_Bcai	Lbcai;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	bcaj:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	bcah:jdField_a_of_type_Bcai	Lbcai;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	bcad:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 117	bcah:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 120	bcah:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
  ...
  public static void a(Context paramContext, bcaa parambcaa, String paramString, bbzz parambbzz)
  {
    if ((bcah)jdField_a_of_type_JavaUtilHashMap.get(parambcaa.jdField_a_of_type_JavaLangString) == null) {
      b(paramContext, parambcaa, paramString, parambbzz);
    }
    ((bcah)jdField_a_of_type_JavaUtilHashMap.get(parambcaa.jdField_a_of_type_JavaLangString)).jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.c();
  }
  
  public static void a(Context paramContext, bcaa parambcaa, String paramString, bbzz parambbzz, bcaf parambcaf)
  {
    bcah localbcah = (bcah)jdField_a_of_type_JavaUtilHashMap.get(parambcaa.jdField_a_of_type_JavaLangString);
    if (localbcah != null) {
      localbcah.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.jdField_a_of_type_Boolean = false;
    }
    localbcah = new bcah();
    localbcah.jdField_a_of_type_Bcaa = parambcaa;
    localbcah.jdField_a_of_type_Bcaf = parambcaf;
    localbcah.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread = new QQVoiceChangerThread(paramContext, parambcaa, parambcaf, paramString, parambbzz);
    jdField_a_of_type_JavaUtilHashMap.put(parambcaa.jdField_a_of_type_JavaLangString, localbcah);
    localbcah.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.start();
  }
  
  public static void a(bcaa parambcaa)
  {
    bcah localbcah = (bcah)jdField_a_of_type_JavaUtilHashMap.get(parambcaa.jdField_a_of_type_JavaLangString);
    if (localbcah != null)
    {
      localbcah.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.d();
      jdField_a_of_type_JavaUtilHashMap.remove(parambcaa.jdField_a_of_type_JavaLangString);
    }
  }
  
  public static boolean a(String paramString, bcai parambcai)
  {
    for (;;)
    {
      try
      {
        ...
        bcah localbcah = (bcah)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if (localbcah == null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (localbcah.jdField_a_of_type_Boolean)
        {
          bcaj.a(paramString, localbcah.jdField_a_of_type_Bcaa.jdField_a_of_type_JavaLangString, localbcah.jdField_a_of_type_Bcaa.f);
          jdField_a_of_type_JavaUtilHashMap.remove(paramString);
          parambcai.a(paramString, localbcah.jdField_a_of_type_Bcaa.e, localbcah.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VoiceChangeManager", 2, "queryStateByPath onCompressFinished filePath=" + paramString + " time=" + localbcah.jdField_a_of_type_Int + " voiceType=" + localbcah.jdField_a_of_type_Bcaa.e);
          }
        }
        else
        {
          localbcah.jdField_a_of_type_Bcai = parambcai;
        }
      }
      finally {}
      boolean bool = true;
  ...
  public static void b(Context paramContext, bcaa parambcaa, String paramString, bbzz parambbzz)
  {
    a(paramContext, parambcaa, paramString, parambbzz, bcaf.a());
  }
  
  public static void b(bcaa parambcaa)
  {
    bcah localbcah = (bcah)jdField_a_of_type_JavaUtilHashMap.get(parambcaa.jdField_a_of_type_JavaLangString);
    if (localbcah != null)
    {
  ...
  public boolean a(ArrayList<bcab> paramArrayList, JSONObject paramJSONObject)
  {
    boolean bool = bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "VoiceChangeManager", false);
    if (!bool)
    {
      ...
      if (i < arrayOfInt.length)
      {
        if (arrayOfInt[i] == j)
        {
          ...
          if (i < 0)
          {
            ...
            break label1363;
            this.jdField_a_of_type_Bbwt.onDone(null);
            return true;
          }
        }
        else
        ...
        paramJSONObject = (bcab)paramArrayList.get(i);
        label687:
        if (paramJSONObject == null)
        {
          if (!QLog.isColorLevel()) {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (bbqa.a(((JSONObject)localObject2).getString("QQVersion"), "8.3.0"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          paramJSONObject.jdField_a_of_type_Bcac.jdField_a_of_type_JavaLangString = ((String)localObject3);
          break label1363;
          localObject3 = bboe.jdField_a_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = bboe.jdField_a_of_type_JavaLangString + (String)localObject1;
