  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  berc jdField_a_of_type_Berc;
  bese jdField_a_of_type_Bese;
  ...
  private void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetURLThemeImageView == null) {
      this.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379098));
    }
    if (this.jdField_a_of_type_Berc.a(this.g, this.jdField_a_of_type_ComTencentWidgetURLThemeImageView, paramString)) {
      return;
    }
    Object localObject2;
    if ((this.g != 1) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      for (;;)
      {
        ...
        if ((localObject2 == null) || (!((HotChatManager)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin)) || (localObject1 == null) || (((amsw)localObject1).b(paramString))) {
          break;
        }
      ...
      if (this.g == 22)
      {
        ...
        if (!(localObject1 instanceof bdyo)) {
          break label580;
        }
        long l = ((bdyo)localObject1).jdField_a_of_type_Long;
        ...
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          label437:
          if ((localObject1 == null) || (!nmy.a((MessageRecord)localObject1))) {
            break label580;
          }
          localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843682);
        }
      }
    }
    label578:
    label580:
    for (Object localObject1 = URLDrawable.getDrawable(nmy.a(nmy.a((MessageRecord)localObject1).b), (Drawable)localObject2, (Drawable)localObject2);; localObject1 = null)
    {
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, this.g);
      if (paramInt != 0) {
        break label129;
      }
      this.g = -1;
  ...
  private void l()
  {
    ...
    this.jdField_a_of_type_Berc.a(this.g, this.jdField_b_of_type_AndroidViewView.getTag(), this.jdField_b_of_type_JavaLangString);
  }
  ...
  private void n()
  {
    ...
    bcef.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "qq_vip", "0X800A8FC", 0, 1, 0, "", "", "", "");
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 3000) {
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800621C", "0X800621C", 0, 0, "", "", "", "");
    }
    if ((this.jdField_e_of_type_Boolean) && (c())) {
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_work", "", "use", "Clk_owner", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "", "");
    }
    if (besg.a(this.g))
    {
      o();
    ...
    this.jdField_a_of_type_Berc.b(this.g, this.jdField_b_of_type_AndroidViewView.getTag(), this.jdField_b_of_type_JavaLangString);
    k();
  }
  
  private void o()
  {
    if ((bfwk.a(this.jdField_a_of_type_JavaUtilList)) || (!(this.jdField_b_of_type_AndroidViewView.getTag() instanceof bdyo)))
    {
      k();
      return;
    }
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
    bdyo localbdyo = (bdyo)this.jdField_b_of_type_AndroidViewView.getTag();
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      long l1 = ((Long)this.jdField_a_of_type_JavaUtilList.remove(0)).longValue();
      bdyo.a(this.g, l1, localbdyo);
      ...
      this.jdField_a_of_type_Berc.a(this.g, localbdyo, this.jdField_b_of_type_JavaLangString, i, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetTextView, l1);
  ...
  protected MessageRecord a()
  {
    ...
    if (this.jdField_a_of_type_Aezn != null)
    {
      localObject1 = localObject2;
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null) {
        localObject1 = (MessageRecord)this.jdField_a_of_type_Aezn.getItem(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getFirstVisiblePosition());
      }
    }
    return localObject1;
  }
  ...
  public void a(int paramInt, String paramString1, Object paramObject, String paramString2)
  {
    ...
    try
    {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560577, null);
      ...
      int i = a(new int[] { 2131379277, 2131374032, 2131374141, 2131374136 });
      if (i > 0) {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379101));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379100));
      ...
      a(paramString2);
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130843899);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166246));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166246));
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130850661);
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_a_of_type_Berc.a(paramInt, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  protected void a(bera parambera)
  {
    if (this.g != 102) {
      return;
    }
    this.jdField_c_of_type_Boolean = parambera.a();
    this.jdField_b_of_type_JavaLangString = parambera.a();
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramList = (bdyo)this.jdField_b_of_type_AndroidViewView.getTag();
        ...
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131718118));
          return;
        }
      }
      finally {}
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131718134));
      continue;
      label214:
      ...
      if ((paramList != null) && (paramList.c == 17))
      {
        ...
        {
          ((TextView)localObject).setText(localResources.getString(2131693998, new Object[] { paramList }));
          break;
        }
      }
      if ((paramList != null) && (paramList.c == 100))
      {
        ...
        for (paramList = "99+";; paramList = Integer.valueOf(i))
        {
          ((TextView)localObject).setText(localResources.getString(2131698721, new Object[] { paramList }));
          break;
        }
        label354:
        this.jdField_f_of_type_Boolean = false;
  ...
  {
    return this.jdField_a_of_type_Berc.a(paramInt);
  }
  ...
  public boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
    boolean bool = this.jdField_a_of_type_Berc.a(i, this.jdField_d_of_type_Int);
  ...
  protected void c()
  {
    this.jdField_a_of_type_Bese = ((bese)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(363));
    this.jdField_b_of_type_Boolean = false;
    ...
    if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin)) {
      this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 1, this.jdField_b_of_type_Long, this.jdField_b_of_type_Long, "", 0, null);
    }
    ...
    this.jdField_f_of_type_Int = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297971));
    ...
    this.jdField_a_of_type_Berc = new bere(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
  }
  
  public boolean c()
  {
    return (besg.a(this.g)) && (!bfwk.a(this.jdField_a_of_type_JavaUtilList));
  }
  ...
  protected void d()
  {
    ...
    this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 0);
    this.jdField_b_of_type_Boolean = false;
  ...
  public void e()
  {
    ...
    {
      Object localObject = (bdyo)this.jdField_b_of_type_AndroidViewView.getTag();
      if (localObject != null)
      {
        long l2 = ((bdyo)localObject).jdField_a_of_type_Long;
        long l1 = l2;
        if (((bdyo)localObject).jdField_b_of_type_Long != 0L)
        {
          localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgItemByUniseq(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, ((bdyo)localObject).jdField_b_of_type_Long);
          l1 = l2;
          if (localObject != null) {
        ...
        if (l1 > 0L)
        {
          ...
          localObject = (ChatMessage)this.jdField_a_of_type_Aezn.getItem(i);
  ...
  protected void g()
  {
    this.g = this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
    this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.g);
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 1) {
      this.jdField_a_of_type_JavaLangObject = this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
    }
    if (c())
    {
      if (this.jdField_a_of_type_Bese.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin) != -1L) {
        Collections.sort(this.jdField_a_of_type_JavaUtilList, new berj(null));
      }
      if (bfwk.a(this.jdField_a_of_type_JavaUtilList)) {}
    }
    for (this.jdField_c_of_type_Long = ((Long)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilList.size() - 1)).longValue();; this.jdField_c_of_type_Long = this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin))
    {
      this.jdField_d_of_type_Long = this.jdField_a_of_type_Bese.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_c_of_type_Long);
      if (QLog.isColorLevel()) {
  ...
  public void h()
  {
    ...
    if (c())
    {
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        if (??? != null)
        {
          ...
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_work", "", "use", "his_owner", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "", l1 - l2 + "");
        }
      }
      if ((!bfwk.a(this.jdField_a_of_type_JavaUtilList)) && (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null) && (this.jdField_a_of_type_Aezn != null))
      {
        localObject2 = (ChatMessage)this.jdField_a_of_type_Aezn.getItem(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getFirstVisiblePosition());
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        l1 = bdyo.a(this.g, ((ChatMessage)localObject2).shmsgseq, ((ChatMessage)localObject2).uniseq);
      ...
      continue;
      label526:
      if ((c()) && (bfwk.a(this.jdField_a_of_type_JavaUtilList))) {}
  ...
  public void i()
  {
    ...
    {
      return;
      localbeqz = this.jdField_a_of_type_Berc.a(102);
    } while (!(localbeqz instanceof berw));
    ((berw)localbeqz).c();
  }
  ...
  protected void j()
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      m();
      b();
      bcef.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "qq_vip", "0X800A8FB", 0, 1, 0, "", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        setChanged();
        notifyObservers(bdyo.a(this.g, this.jdField_c_of_type_Long, this.jdField_d_of_type_Int));
        if (QLog.isColorLevel()) {
