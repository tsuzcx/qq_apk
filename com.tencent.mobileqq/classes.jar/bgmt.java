...
public class bgmt
{
  ...
  public bgmt(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, whu paramwhu)
  {
    if (paramActivity == null) {
      return;
    }
    String str = ajyc.a(2131710699);
    if (1 == paramInt) {
      paramString = str + ajyc.a(2131710702) + paramString + ajyc.a(2131710697);
    }
    for (;;)
    {
      bbcv.a(paramActivity, 230, paramActivity.getString(2131698376), paramString, 2131698370, 2131698370, new bgnc(this, paramwhu), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + ajyc.a(2131710701) + paramString + ajyc.a(2131710696);
      } else {
        paramString = ajyc.a(2131710698);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), ajyc.a(2131710700), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof xjh)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bgmt:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bgmt:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bgmt:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbgmt;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bgmu(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	bgmv
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	bgmv:<init>	(Lbgmt;)V
    //   20: putfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bgmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bgmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bgmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bgmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bgmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = bbcl.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131698416) + str1 + paramActivity.getResources().getString(2131698417);
        ...
        {
          this.jdField_a_of_type_Bbgg = bbcv.a(paramActivity, 230, paramActivity.getResources().getString(2131698377), paramOnClickListener3, paramActivity.getResources().getString(2131698418), paramActivity.getResources().getString(2131698418), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bbgg.setOnDismissListener(new bgmz(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bbgg = bbcv.a(paramActivity, 230, paramActivity.getResources().getString(2131698377), paramOnClickListener3, paramActivity.getResources().getString(2131698418), paramActivity.getResources().getString(2131698419), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131698415);
          this.jdField_a_of_type_Bbgg = bbcv.a(paramActivity, 230, paramActivity.getResources().getString(2131698377), paramOnClickListener1, paramActivity.getResources().getString(2131698414), paramActivity.getResources().getString(2131698414), paramOnClickListener3, null);
          this.jdField_a_of_type_Bbgg.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new bgmw(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bgmx(this), new bgmy(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = apue.a(paramInsertFMFileInfo.filePath);
    long l1 = apue.a(paramInsertFMFileInfo.filePath);
    long l2 = axaq.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = apue.a(paramInsertFMFileInfo.filePath);
    ...
    if (localajxn.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localajxn.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      aywi.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      aywi.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      aypf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = bbcl.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    ajxn localajxn = (ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    bgnl.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, whu paramwhu)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    bgng localbgng = bgnf.a(paramString);
    if (localbgng == null)
    {
      bbcv.a(paramAppActivity, 230, paramAppActivity.getString(2131698376), paramAppActivity.getString(2131698396), 2131698370, 2131698370, new bgna(this, paramwhu), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramwhu);
      return;
    }
    ...
    paramwhu = new Bundle();
    paramwhu.putString("url", paramString);
    paramwhu.putString("key", localbgng.a);
    paramwhu.putString("peerUin", localbgng.b);
    paramwhu.putString("peerNick", localbgng.c);
    paramwhu.putString("peerOS", localbgng.d);
    paramwhu.putString("apSSID", localbgng.e);
    paramwhu.putString("preSharedKey", localbgng.f);
    paramwhu.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramwhu.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramwhu);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, whu paramwhu)
  {
    if (paramAppActivity == null) {
      return;
    }
    bbcv.a(paramAppActivity, 230, paramAppActivity.getString(2131698394), paramAppActivity.getString(2131698395), 2131698370, 2131698370, new bgnb(this, paramwhu), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = apue.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = apue.a(paramList);
  ...
  {
    if (1 == paramInt) {
      apue.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
