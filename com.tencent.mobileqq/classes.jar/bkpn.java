...
public class bkpn
{
  private static bkpn jdField_a_of_type_Bkpn;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bkpo(this));
  private bkpp jdField_a_of_type_Bkpp = new bkpp(this, null);
  private bkpr jdField_a_of_type_Bkpr;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private bkpn(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Bkpp);
    }
  }
  
  public static bkpn a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bkpn == null) {
      jdField_a_of_type_Bkpn = new bkpn(paramAppInterface);
    }
    return jdField_a_of_type_Bkpn;
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Bkpn != null)
    {
      jdField_a_of_type_Bkpn.b();
      jdField_a_of_type_Bkpn = null;
    }
  }
  ...
  private void a(double paramDouble1, double paramDouble2, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), bjpe.class);
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bkpr != null)
    {
      Object localObject = paramArrayList;
      if (paramArrayList == null) {
        localObject = new ArrayList(1);
      }
      this.jdField_a_of_type_Bkpr.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Bkpp);
      this.jdField_a_of_type_ComTencentCommonAppAppInterface = null;
    }
    this.jdField_a_of_type_Bkpr = null;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new bkpq(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Bkpr != null) {
          this.jdField_a_of_type_Bkpr.a(paramInt, bool2);
        }
        return;
      }
  ...
  public void a(bkpr parambkpr)
  {
    this.jdField_a_of_type_Bkpr = parambkpr;
  }
}
