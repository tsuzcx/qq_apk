...
public class abbn
{
  ...
  public abbn(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean, int paramInt4)
  {
  ...
  @TargetApi(17)
  @RequiresApi(api=17)
  public void a(List<Bitmap> paramList, abbh paramabbh)
  {
    abbi localabbi = new abbi(0, "success");
    this.jdField_a_of_type_Bbmq = new bbmq();
    bbmc localbbmc = new bbmc(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int, this.c, 1, false, 0);
    ...
    this.jdField_a_of_type_Bbmq.a(localbbmc, new abbo(this, paramList, paramabbh, localabbi));
    try
    {
      try
      {
