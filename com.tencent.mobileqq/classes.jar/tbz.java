...
public class tbz
{
  ...
  static
  {
    jdField_b_of_type_JavaLangString = "QQ/8.4.5 Android/0.17 Android/" + Build.VERSION.RELEASE;
  }
  ...
  public static String a()
  {
    return "https://viola.qq.com/js/VShortVideo.js?_rij_violaUrl=1&v_tid=15&v_bundleName=VShortVideo&hideNav=1&v_nav_immer=1&statusColor=1&v_bid=3811&statusBarStyle=1&_cache_bunle=1&v_bg_color=000000&v_content_full=1&statusColor=1&supportNV=1&supportColorBall=1";
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
      {
        ...
        {
          Object localObject2 = biru.a(paramString);
          if ((localObject2 != null) && (!TextUtils.isEmpty(((birv)localObject2).jdField_b_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ViolaAccessHelper", 2, "load offline想 data cache on loadRes");
            }
            return ((birv)localObject2).jdField_b_of_type_JavaLangString;
          }
          try
          {
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              localObject2 = nmp.a((String)localObject1);
  ...
  public static void a()
  {
    ...
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_JavaLangString = ozs.a();
    }
    HippyQQLibraryManager.getInstance().preDownload();
    NativeVueLoaderManager.a().b();
    if ((System.currentTimeMillis() - jdField_a_of_type_Long >= 18000000L) || ((!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) && (!jdField_a_of_type_JavaLangString.equals(ozs.a()))))
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      ...
      else
      {
        ...
        rze.a(paramContext, (Intent)localObject2, (String)localObject1);
        return;
      }
      break;
    case 2: 
    ...
    for (;;)
    {
      try
      {
        ((JSONObject)localObject2).put("autoPlayDisable", bnrf.h());
        i = j;
      }
      catch (JSONException localJSONException)
      {
  ...
  @Deprecated
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, tch paramtch)
  {
    if (!a(paramContext)) {
      if (paramtch != null) {
        paramtch.a();
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        label439:
        afez.a(paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class);
      }
      label454:
      ...
      afez.a((Activity)paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class, paramBundle.getInt("requestCode", -1));
    ...
    if (a(paramBundle))
    {
      ...
      localIntent.putExtra(tdl.jdField_a_of_type_JavaLangString, paramString1);
  ...
  public static void a(Context paramContext, String paramString, tch paramtch) {}
  ...
  public static void a(Context paramContext, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      try
      {
        bool = pbn.a(((Bundle)localObject2).getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(((Bundle)localObject2).getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(((Bundle)localObject2).getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(((Bundle)localObject2).getString("VIDEO_TIME")).intValue());
        k = bool;
      }
      ...
      rze.a(paramContext, (Intent)localObject1);
      return;
    ...
    for (str2 = paramJSONObject.optString("isAwesome", null);; str2 = paramJSONObject.optString("isawesome", null))
    {
      ...
      try
      {
        bool = pbn.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
        k = bool;
      }
  ...
  /* Error */
  public static void a(com.tencent.common.app.AppInterface paramAppInterface, String paramString, tdd paramtdd, tcf paramtcf)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 285	com/tencent/viola/core/ViolaSDKEngine:isInitialized	()Z
    //   6: ifne +91 -> 97
    ...
    //   24: new 806	tcw
    //   27: dup
    //   28: invokespecial 807	tcw:<init>	()V
    ...
    //   34: new 813	tdf
    //   37: dup
    //   38: invokespecial 814	tdf:<init>	()V
    ...
    //   48: new 824	tdc
    //   51: dup
    //   52: invokespecial 825	tdc:<init>	()V
    ...
    //   60: ifnull +32 -> 92
    //   63: aload_0
    //   64: invokevirtual 835	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   67: astore_1
    //   68: aload_1
    //   69: aload_2
    //   70: invokevirtual 839	com/tencent/viola/core/InitConfig$Builder:build	()Lcom/tencent/viola/core/InitConfig;
    //   73: new 841	tcd
    //   76: dup
    //   77: aload_0
    //   78: aload_3
    //   79: invokespecial 844	tcd:<init>	(Lcom/tencent/common/app/AppInterface;Ltcf;)V
    //   82: invokestatic 845	thy:a	()Ljava/lang/String;
    //   85: invokestatic 849	com/tencent/viola/core/ViolaSDKEngine:initialize	(Landroid/app/Application;Lcom/tencent/viola/core/InitConfig;Lcom/tencent/viola/core/ViolaSDKEngine$InitCallback;Ljava/lang/String;)V
    //   88: ldc 2
    //   90: monitorexit
    //   91: return
    //   92: aconst_null
    ...
    //   100: ldc_w 853
    //   103: iconst_0
    //   104: invokestatic 857	com/tencent/viola/core/ViolaSDKEngine:registerModule	(Ljava/lang/String;Ljava/lang/Class;Z)Z
    //   107: pop
    //   108: aload_3
    //   109: ifnull -21 -> 88
    //   112: aload_0
    //   113: new 859	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5
    //   116: dup
    //   117: aload_3
    //   118: invokespecial 862	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5:<init>	(Ltcf;)V
    //   121: invokevirtual 866	com/tencent/common/app/AppInterface:runOnUiThread	(Ljava/lang/Runnable;)V
    //   124: goto -36 -> 88
    //   127: astore_0
    ...
    //   150: aload_0
    //   151: invokevirtual 504	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   0	172	2	paramtdd	tdd
    //   0	172	3	paramtcf	tcf
    // Exception table:
    //   from	to	target	type
  ...
  @Deprecated
  public static void a(String paramString, tcf paramtcf)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)ozs.a();
    if ((localQQAppInterface == null) && (paramtcf != null))
    {
      paramtcf.a();
      return;
    }
    a(localQQAppInterface, paramString, null, paramtcf);
  }
  
  public static void a(String paramString, tcg paramtcg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)ozs.a();
    ...
    ThreadManager.post(new ViolaAccessHelper.3(paramString, localQQAppInterface, paramtcg, System.currentTimeMillis()), 8, null, true);
  }
  
  public static void a(String paramString, tjn paramtjn)
  {
    ThreadManager.post(new ViolaAccessHelper.6(paramString, paramtjn), 8, null, false);
  }
  ...
  private static boolean a(Context paramContext)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            a(paramContext, anzj.a(2131715245));
          } while (!QLog.isColorLevel());
          ...
          a(paramContext, anzj.a(2131715247));
        } while (!QLog.isColorLevel());
        QLog.d("ViolaAccessHelper", 2, "isViolaPermit checkSO is false");
        return false;
        str = thy.b("https://kd.qpic.cn/viola/lib/viola.js?v_bid=3547");
        if (!TextUtils.isEmpty(str)) {
          break;
        }
      ...
      a(paramContext, anzj.a(2131715246));
      if (QLog.isColorLevel()) {
  ...
  {
    a("https://sqimg.qq.com/qq_product_operations/kan/viola_config/viola_config.json?v_bid=3192", new tce());
  }
