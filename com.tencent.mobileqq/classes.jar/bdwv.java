...
public class bdwv
  implements bdxp
{
  public bdwv(NewTroopContactView paramNewTroopContactView) {}
  ...
  public void a()
  {
    this.a.jdField_a_of_type_Bdwj.notifyDataSetChanged();
    if (this.a.jdField_a_of_type_Bdwj.getGroupCount() > 0)
    {
      Groups localGroups1 = this.a.jdField_a_of_type_Bdwj.a(1007L);
      Groups localGroups2 = this.a.jdField_a_of_type_Bdwj.a(1008L);
