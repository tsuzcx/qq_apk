  ...
  implements bdxb
{
  ...
  public bdwv(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
  ...
  public File a()
  {
    ...
    bdwl localbdwl = new bdwl();
    localbdwl.a(BaseApplicationImpl.getContext());
    localbdwl.a(this.jdField_a_of_type_JavaLangString, new bdwx(this, localFile, arrayOfException, localCountDownLatch));
    localbdwl.a(bdwn.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = ThreadManagerExecutor.getExecutorService(192).submit(new bdww(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
