public final class ii
{
  ...
  {
    int j = paramii.jdField_a_of_type_Int;
  ...
  public void b(ii paramii)
  {
    if (this.jdField_a_of_type_ArrayOfInt.length != paramii.jdField_a_of_type_ArrayOfInt.length) {
    ...
    {
      int[] arrayOfInt = this.jdField_a_of_type_ArrayOfInt;
      arrayOfInt[i] ^= paramii.jdField_a_of_type_ArrayOfInt[i];
      i += 1;
    }
  }
