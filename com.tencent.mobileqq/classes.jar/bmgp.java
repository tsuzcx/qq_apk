...
public final class bmgp
{
  ...
  @Deprecated
  public static String b = "qqreader_1.0." + "8.4.10".replace(".", "") + ".0001_android_qqplugin";
  private static String c = "0x0";
  
  private static String a(Context paramContext)
  {
    if (("0x0".equals(c)) && ((paramContext instanceof Activity))) {
      c = bmgr.a((Activity)paramContext);
    }
    return c;
  }
  ...
  {
    a(null, "dc05135", new String[] { "109", Build.VERSION.RELEASE, "mobile qq", "8.4.10.4875", "", "", DeviceInfoUtil.getNetInfo(paramContext).networkType, "ReaderShadowPlugin_5", a(paramContext), "2", "/plugin/ReaderHost", String.valueOf(paramInt), paramString1, "", "0", a(paramString2) });
  }
  
  public static void a(Context paramContext, String paramString)
  {
    a(null, "dc05133", new String[] { "109", Build.VERSION.RELEASE, "mobile qq", "8.4.10.4875", "", "", DeviceInfoUtil.getNetInfo(paramContext).networkType, "5", a(paramContext), "11", "", "", "", "", "", "", paramString, "", "", "", "", "", "", "", "", "", "" });
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    a(null, "dc05133", new String[] { "109", Build.VERSION.RELEASE, "mobile qq", "8.4.10.4875", "", "", DeviceInfoUtil.getNetInfo(paramContext).networkType, "5", a(paramContext), "10", "", "", "", "", paramString1, "", "", "", "", "", "", "", "", "", "", "", paramString2 });
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, String... paramVarArgs)
  {
    ...
    bdka.a(paramQQAppInterface, paramString, paramVarArgs, false);
  }
  ...
  {
    a(null, "dc05133", new String[] { "109", Build.VERSION.RELEASE, "mobile qq", "8.4.10.4875", "", "", paramString1, b, bmgr.b(), paramString2, paramString3, String.valueOf(paramInt1), String.valueOf(paramFloat), String.valueOf(paramInt2), String.valueOf(paramLong), paramString4, "", "", "", "", "", "", "", "", "", "", String.valueOf(paramInt3) });
  }
  ...
  {
    a("109", Build.VERSION.RELEASE, "mobile qq", "8.4.10", "", "", "android", paramString1, "", "", b, paramString2, paramString3, paramString4, "", paramString5, "", paramString6, paramString7, "", "", "", paramString8, paramString9, "", "");
  }
  ...
  {
    a("109", Build.VERSION.RELEASE, "mobile qq", "8.4.10", "", "", "android", paramString1, "", "", b, paramString2, paramString3, paramString4, "", paramString5, "", paramString6, paramString7, paramString8, paramString9, paramString10, "", "", "", "");
  }
  ...
  {
    a(null, "dc05135", new String[] { "109", Build.VERSION.RELEASE, "mobile qq", "8.4.10.4875", "", "", DeviceInfoUtil.getNetInfo(paramContext).networkType, "", a(paramContext), "2", "/h5/BlankScreen", String.valueOf(paramInt), paramString, "", "0", "" });
  }
}
