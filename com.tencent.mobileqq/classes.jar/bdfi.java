...
public class bdfi
{
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   50: aload_2
    //   51: iload_3
    //   52: invokestatic 77	bdfi:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    //   55: istore_3
    //   56: goto -33 -> 23
    //   59: astore_0
    //   60: ldc 2
  ...
  private static boolean b(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      bdgo.a(str1, false);
    } while ((!bdgo.a(paramString2, paramString3)) || (!paramString3.exists()));
    bdgo.a(paramString1, true);
    return true;
  }
  ...
  private static boolean c(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   274: invokespecial 141	bdfj:<init>	(Ljava/lang/String;II)V
    ...
    //   387: checkcast 138	bdfj
    //   390: astore 7
    //   392: new 8	java/io/File
    //   395: dup
    //   396: aload_1
    //   397: aload 7
    //   399: getfield 168	bdfj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   402: invokespecial 74	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   405: astore 8
    //   407: aload_2
    //   408: aload 7
    //   410: getfield 171	bdfj:jdField_a_of_type_Int	I
    //   413: i2l
    //   414: invokevirtual 111	java/io/RandomAccessFile:seek	(J)V
    //   417: aload 7
    //   419: getfield 173	bdfj:b	I
    //   422: newarray byte
    //   424: astore 9
    //   426: aload_2
    //   427: aload 9
    //   429: iconst_0
    //   430: aload 7
    //   432: getfield 173	bdfj:b	I
    //   435: invokevirtual 124	java/io/RandomAccessFile:read	([BII)I
    //   438: pop
    //   439: aload 8
    //   441: aload 9
    //   443: invokestatic 175	bdfi:a	(Ljava/io/File;[B)V
    //   446: goto -74 -> 372
    //   449: astore_0
    //   450: aload_2
    //   451: ifnull +7 -> 458
