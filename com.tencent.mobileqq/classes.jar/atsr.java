  ...
  implements atmi
{
  ...
  private atsr(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, atss paramatss, atsw paramatsw)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, 0, paramatss, paramatsw);
  ...
  public static atmi a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, atss paramatss, atsw paramatsw)
  {
    if (paramatss == null) {
    ...
    return null;
    return new atsr(paramQQAppInterface, paramLong1, paramLong2, paramatss, paramatsw);
  }
  ...
  protected List<ExcitingTransferHostInfo> a()
  {
    Object localObject;
    List localList;
    if (atlb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1))
    {
      ...
      localList = atlb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
      if (localList != null)
      {
        if (localObject != null) {
          break label162;
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Atly != null) {
      this.jdField_a_of_type_Atly.a(paramLong1);
    }
  }
  ...
  protected void a(ExcitingTransferUploadBizInfo paramExcitingTransferUploadBizInfo)
  {
    ...
    if ((this.jdField_a_of_type_Atst instanceof atss))
    {
      atss localatss = (atss)this.jdField_a_of_type_Atst;
      paramExcitingTransferUploadBizInfo.bufUuid = localatss.jdField_a_of_type_ArrayOfByte;
      paramExcitingTransferUploadBizInfo.bufUploadKey = localatss.b;
      paramExcitingTransferUploadBizInfo.bUseMediaPlatform = localatss.jdField_a_of_type_Boolean;
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Atst.a(paramArrayOfByte);
    b();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    e();
    b(null);
    if ((this.jdField_a_of_type_Atst.d() == null) || (this.jdField_a_of_type_Atst.d().length == 0))
    {
      if (this.jdField_a_of_type_Atly != null)
      {
        Bundle localBundle = new Bundle();
        byte[] arrayOfByte = this.jdField_a_of_type_Atly.a(localBundle);
        ...
        this.jdField_a_of_type_Atst.a(arrayOfByte);
      }
    }
    else {
      return b();
  ...
  protected void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    for (String str = paramExcitingTransferUploadResultRp.m_strFileUrl;; str = "")
    {
      ...
      paramInt = a(paramInt);
      if (this.jdField_a_of_type_Atly != null) {
        this.jdField_a_of_type_Atly.a(true, this.jdField_c_of_type_Long, paramInt, "", "");
      }
      return;
    }
  }
