  ...
  extends ayfd
{
  ...
  public void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && ((paramTeamWorkFileImportInfo.a()) || ((paramTeamWorkFileImportInfo.b()) && (paramTeamWorkFileImportInfo.g == 0))))
    {
      ...
      if (paramTeamWorkFileImportInfo.b()) {
        axqy.b(null, "dc00898", "", "", "0X800A627", "0X800A627", 1, 0, "", "", "", "");
      }
      if (TextUtils.isEmpty(paramTeamWorkFileImportInfo.h)) {
        break label136;
      }
      bcql.a(localQQAppInterface.getApp(), 1, paramTeamWorkFileImportInfo.h, 0).a();
    }
    for (;;)
    {
      if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c())) {
        ayhm.a(null, "0X800ABAD");
      }
      return;
      label136:
      bcql.a(localQQAppInterface.getApp(), 1, 2131720253, 0).a();
    }
  }
  ...
  public void a(String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c()))
    {
      if (paramTeamWorkFileImportInfo.l == 2)
      {
        ...
        ayhm.a(null, "0X800ABA7");
        if ((!bool) && (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxa != null)) {
          this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxa.a(1, paramString, bool);
        }
        if ((appo.a(this.a)) && (bool)) {
          appo.a(this.a, true);
        }
        if (!bool)
        {
          if (((paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 1) && (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 0) && (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 3000)) || (paramTeamWorkFileImportInfo.jdField_a_of_type_JavaLangString == this.a.jdField_a_of_type_Apnb.h())) {
            break label452;
          }
          i = 1;
          label147:
    ...
    else
    {
      ...
      i = 1;
      label249:
      if ((i == 0) || (!paramTeamWorkFileImportInfo.b()) || (paramTeamWorkFileImportInfo.g != 0) || (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer == null) || (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxc == null)) {
        break label462;
      }
      long l = ayhm.a(paramTeamWorkFileImportInfo.k + "-" + paramTeamWorkFileImportInfo.d);
      if (l > 0L) {
        axqy.b(null, "dc00898", "", "", "0X800A62E", "0X800A62E", 0, 0, "", "", String.valueOf(l), "");
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.e();
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxc.a(paramString, paramTeamWorkFileImportInfo, true, this.a.jdField_a_of_type_Apnb.h());
  ...
  public void a(String paramString1, String paramString2, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      anch localanch = ancl.a();
      ThreadManager.getFileThreadHandler().post(new SimpleFilePresenter.1.2(this, localanch, paramTeamWorkFileImportInfo, paramString2, localQQAppInterface, paramString1));
    }
  ...
  public void b(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      String str = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131698477);
      if (paramTeamWorkFileImportInfo.b()) {
        str = ajya.a(2131714172);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.h(str);
      ayhm.a(null, "0X800A21E");
    }
  }
  ...
  public void c(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.b())) {
      if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer != null)
      {
        ...
        appo.a(this.a, true, paramTeamWorkFileImportInfo.jdField_a_of_type_Int);
      }
    }
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxa == null)
    {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxa.a();
  }
}
