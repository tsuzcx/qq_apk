...
public class bhsv
{
  ...
  public bhsv(QQAppInterface paramQQAppInterface, EntityManager paramEntityManager)
  {
  ...
  private long a()
  {
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = bhzf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_last_pull_timestamp", 0L);
    }
    return this.jdField_a_of_type_Long;
  }
  
  public static bhsv a(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong)
  {
    ...
    bhzf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_last_pull_timestamp", paramLong);
  }
  ...
  public static boolean a()
  {
    ...
    if (bhzf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_open", true)) {}
    for (int i = 1;; i = 0)
    {
  ...
  public bhsu a(String paramString)
  {
    bhsu localbhsu = new bhsu();
    if ((TextUtils.isEmpty(paramString)) || (!a()))
    {
      localbhsu.jdField_a_of_type_JavaLangString = "";
      localbhsu.jdField_a_of_type_Boolean = false;
      localbhsu.c = 1;
    ...
    {
      localObject1 = ((Resources)localObject1).getString(2131692830);
      if ((!bhzf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_guide_clicked", false)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.isEmpty()))
      {
        bool = true;
        if (!bool) {
          break label244;
    ...
    for (;;)
    {
      ...
      localbhsu.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localbhsu.jdField_a_of_type_Boolean = bool;
      localbhsu.c = i;
      return localbhsu;
      bool = false;
      break;
      ...
      localbhsu.jdField_a_of_type_Int = j;
      localbhsu.jdField_b_of_type_Int = i;
      localbhsu.jdField_b_of_type_JavaLangString = localExpireSet.toJson();
      localObject2 = bhzf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_expire_list_" + paramString, null);
      if (!ExpireSet.fromJson((String)localObject2).containsAll(localExpireSet))
      {
        ...
        QLog.e("TroopKeywordManager.troop.special_msg.keyword", 1, "expireList hasNewExpiredId, last:" + (String)localObject2 + " now:" + localbhsu.jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        if (j <= 0) {
        ...
        localObject1 = ((Resources)localObject1).getString(2131699041, new Object[] { Integer.valueOf(j) });
        i = 5;
        break;
        bool = false;
        break label428;
        label510:
        bhzf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_expire_list_" + paramString, localbhsu.jdField_b_of_type_JavaLangString);
      }
      label546:
      if (i > 0)
      {
        localObject1 = ((Resources)localObject1).getString(2131699046);
        i = 4;
      }
      else
      {
        localObject1 = ((Resources)localObject1).getString(2131699042, new Object[] { Integer.valueOf(localList.size()) });
        bool = false;
        i = 3;
      }
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bhzf.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_open", paramBoolean);
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      jdField_a_of_type_Int = i;
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    bdla.b(null, "dc00898", "", paramString2, "qq_vip", "0X800A8FD", 0, 1, 0, "", "", localTroopKeyWord.keyword, "");
    return true;
  }
  ...
  public void b()
  {
    ...
    ((aocy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(new bhsw(this), true);
  }
}
