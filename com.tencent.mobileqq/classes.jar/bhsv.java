  ...
  implements bhko
{
  ...
  public bhsv()
  {
    this.jdField_a_of_type_JavaLangString = bhsv.class.getSimpleName();
  }
  ...
  private void a(String paramString)
  {
    try
    {
      ...
      if (((ArrayList)localObject).size() > 0) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bhsv.class).post(new QzoneVideoTabJsPlugin.2(this, (ArrayList)localObject, localArrayList));
      }
      return;
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bhsv.class).post(new QzoneVideoTabJsPlugin.4(this));
  }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (localArrayList1.size() > 0) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bhsv.class).post(new QzoneVideoTabJsPlugin.3(this, localArrayList1, localArrayList2));
      }
      return;
    }
    catch (JSONException paramString)
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bhsv.class).post(new QzoneVideoTabJsPlugin.5(this, paramString));
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("videoProxySaveVideoToAlbum".equals(paramString3))
    {
      ...
      if ((paramJsBridgeListener != null) && (bhos.a(paramJsBridgeListener, new bhsw(this, paramVarArgs, paramJsBridgeListener), 1))) {
        c(paramVarArgs[0]);
      }
    }
    return false;
