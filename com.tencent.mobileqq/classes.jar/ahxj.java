...
public class ahxj
  extends Handler
{
  public ahxj(P2VEditMusicDialog paramP2VEditMusicDialog) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        do
        {
          return;
          this.a.b();
          if (this.a.jdField_a_of_type_Vrk != null)
          {
            this.a.jdField_a_of_type_Vrk.a(this.a.jdField_a_of_type_JavaUtilArrayList);
            this.a.jdField_a_of_type_Vrk.notifyDataSetChanged();
          }
          paramMessage = this.a.jdField_a_of_type_Ahxl.a();
          if (this.a.jdField_a_of_type_Vrk != null) {
            this.a.jdField_a_of_type_Vrk.a(paramMessage);
          }
        ...
        return;
        if (!this.a.jdField_a_of_type_Ahxl.c())
        {
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
          return;
        }
      ...
      this.a.jdField_a_of_type_Ahxl.a(3);
      ...
      this.a.c();
      MusicHorizontalSeekView.a((this.a.a() + 500) / 1000, this.a.getContext().getResources().getDisplayMetrics().widthPixels - bbkx.a(8.0F));
    ...
    case 11: 
      this.a.b();
      paramMessage = this.a.jdField_a_of_type_Vrn;
      paramMessage.f = ((int)ShortVideoUtils.a(paramMessage.g));
      if (paramMessage.d < 0) {
        paramMessage.d = 0;
      }
      ...
      paramMessage.e = (paramMessage.d + this.a.jdField_a_of_type_Int);
      this.a.jdField_a_of_type_Ahxl.a(paramMessage);
      this.a.jdField_a_of_type_Ahxl.a(3);
      this.a.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      this.a.jdField_b_of_type_AndroidViewView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(0);
    ...
    case 3: 
      this.a.b();
      this.a.jdField_a_of_type_Ahxl.a(vrn.jdField_a_of_type_Vrn);
      this.a.jdField_a_of_type_Ahxl.a(0);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131707860));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      return;
    case 6: 
      this.a.b();
      this.a.jdField_a_of_type_Ahxl.a(vrn.jdField_b_of_type_Vrn);
      this.a.jdField_a_of_type_Ahxl.a(1);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131707859));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
    ...
    case 7: 
      ...
      bcpw.a(this.a.getContext(), paramMessage, 0).a();
      return;
    case 8: 
    ...
    paramMessage = (vrn)paramMessage.obj;
