  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localActionSheetItem.label = paramContext.getString(2131690062);
    localActionSheetItem.icon = 2130840347;
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if ("S".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anzj.a(2131715155) + anzj.a(2131715163);
    }
    if ("A".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anzj.a(2131715149) + anzj.a(2131715139);
    }
    if ("B".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anzj.a(2131715151) + anzj.a(2131715159);
    }
    if ("C".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anzj.a(2131715145) + anzj.a(2131715174);
    }
    return "[QQ高能舞室]" + anzj.a(2131715164);
  }
  ...
  {
    new zap(this.jdField_a_of_type_AndroidAppActivity, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramInt1, this.jdField_a_of_type_MqqUtilWeakReference, paramInt2).execute(new Void[0]);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt2 == 2)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, anzj.a(2131715141), 1).a();
    }
    do
    {
      do
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bbjd = new bbjd(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Bbjd.a(a(this.jdField_a_of_type_AndroidAppActivity));
    this.jdField_a_of_type_Bbjd.a(this);
    this.jdField_a_of_type_Bbjd.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131718159));
  ...
  protected void a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      bhmi.a(new File(paramString).getParent());
    }
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bbjd != null) {
      this.jdField_a_of_type_Bbjd.a();
    }
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (this.jdField_a_of_type_Bbjd.a().isShowing()) {
      this.jdField_a_of_type_Bbjd.a().dismiss();
    }
    ShareActionSheetBuilder.ActionSheetItem localActionSheetItem = ((bhsc)paramView.getTag()).a;
