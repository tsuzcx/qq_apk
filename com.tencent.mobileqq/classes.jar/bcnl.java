...
public class bcnl
{
  ...
  {
    int i = ((Integer)paramView.getTag(2131381110)).intValue();
    Object localObject;
    View localView;
    ...
    if ((paramView instanceof LinearLayout))
    {
      ...
      paramView.removeView(paramView.findViewById(2131374471));
      paramView.removeView(paramView.findViewById(2131374472));
      if (paramView.getChildCount() == 1)
      {
        ...
        int j = ((Context)localObject).getResources().getDimensionPixelSize(2131298399);
        k = ((Context)localObject).getResources().getDimensionPixelSize(2131298400);
        switch (paramInt2)
        {
        default: 
    ...
    for (;;)
    {
      if (bcgd.a(paramInt3))
      {
        localObject = new bcoi((Context)localObject, paramInt3).a();
        ((View)localObject).setId(2131374472);
      ...
      if (((paramInt2 == 0) || (paramInt1 == 1)) && (paramBoolean1) && (i != 1))
      {
        ...
        ((View)localObject).setId(2131374471);
        ((View)localObject).setLayoutParams(new LinearLayout.LayoutParams(-1, paramView.getContext().getResources().getDimensionPixelSize(2131298393)));
        paramView.addView((View)localObject, 0);
  ...
  public static void a(bcfr parambcfr, int paramInt1, int paramInt2)
  {
    int j = 1;
    int i = j;
    if (paramInt1 > 1)
