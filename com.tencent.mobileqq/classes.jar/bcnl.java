...
class bcnl
{
  ...
  bcnl(LoadParam paramLoadParam, LoadParam.LoadItem paramLoadItem)
  {
  ...
  static int a()
  {
    ...
    return aqlk.a().a(526, ((QQAppInterface)localAppRuntime).getCurrentAccountUin());
  }
  ...
  protected static boolean a(@NonNull bcoq parambcoq)
  {
    return (!TextUtils.isEmpty(parambcoq.c)) && (new File(parambcoq.c).exists());
  }
  
  protected static boolean a(@NonNull bcoq parambcoq, @NonNull SoConfig.SoDetailInfo paramSoDetailInfo)
  {
    return (paramSoDetailInfo.relatedFileInfo == null) || ((!TextUtils.isEmpty(parambcoq.f)) && (new File(parambcoq.f).exists()));
  }
  ...
  boolean a(SoConfig.SoInfo paramSoInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("SoLoadWidget.AbsGetSoTask", 2, "[initConfig] isConfValid=" + bool + ",info:" + paramSoInfo + ",is64:" + bcoe.a());
      }
      return bool;
