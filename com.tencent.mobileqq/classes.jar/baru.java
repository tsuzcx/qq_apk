  ...
  implements SensorEventListener
{
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    if ((barr.jdField_b_of_type_Int == 1) && (barr.jdField_b_of_type_Boolean))
    {
      this.a.c = ((int)paramSensorEvent.values[0]);
      barr.jdField_b_of_type_Boolean = false;
    }
    if (barr.jdField_b_of_type_Int == 3)
    {
      barr.jdField_b_of_type_Int = 0;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        barr.jdField_b_of_type_Boolean = true;
        return;
      }
