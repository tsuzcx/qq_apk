  ...
  implements ITransactionCallback
{
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMWebVideoUploaderFirstFrame", 2, "<BDH_LOG> Transaction End : Failed. New : SendTotalCost:" + (l - bart.a(this.a)) + "ms");
    }
    bart.a(this.a).put("serverip", paramHashMap.get("ip"));
    bart.a(this.a).put("param_bdhSrv", paramHashMap.get("ip"));
    bart.a(this.a).put("param_bdhPort", paramHashMap.get("port"));
    bart.a(this.a).put("X-piccachetime", paramArrayOfByte);
    bart.a(this.a).put("param_BdhTrans", str1);
    bart.a(this.a).put("param_segspercnt", str2);
    bart.a(this.a).put("param_conf_segSize", str3);
    bart.a(this.a).put("param_conf_segNum", str4);
    bart.a(this.a).put("param_conf_connNum", str5);
    bart.a(this.a).put("param_fin_lost", str6);
    bart.a(this.a).put("param_retry_seg_count", paramHashMap.get("param_retry_seg_count"));
    bart.a(this.a).put("param_max_retry_times", paramHashMap.get("param_max_retry_times"));
    bart.a(this.a).put("param_total_retry_times", paramHashMap.get("param_total_retry_times"));
    bart.a(this.a).put("param_retry_code", paramHashMap.get("param_retry_code"));
    bart.a(this.a).put("param_heart_resp", paramHashMap.get("param_heart_resp"));
    bart.a(this.a).put("param_ip_index", paramHashMap.get("param_ip_index"));
    bart.a(this.a).put("param_Ip_ConnCost", paramHashMap.get("param_Ip_ConnCost"));
    if (((String)paramHashMap.get("param_BDH_Cache_Diff")).equals(String.valueOf(true))) {
      bart.a(this.a, true);
    }
    bart.a(this.a, paramInt);
    bart.b(this.a, "sessionKey or sigSession is null");
    bart.a(this.a).b(paramInt, bart.b(this.a));
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        String str2;
        String str3;
        bart.a(this.a).b(i, "mergeFrom respData Exception");
      ...
      bart.a(this.a, (String)paramHashMap.get("rep_bdhTrans"));
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QIMWebVideoUploaderFirstFrame", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l3 - bart.a(this.a)) + "ms transInfo:" + bart.a(this.a));
      }
      bart.a(this.a).put("serverip", paramHashMap.get("ip"));
      bart.a(this.a).put("param_bdhSrv", paramHashMap.get("ip"));
      bart.a(this.a).put("param_bdhPort", paramHashMap.get("port"));
      bart.a(this.a).put("X-piccachetime", String.valueOf(bart.a(this.a).mTransReport.timeCost_Cache));
      bart.a(this.a).put("param_BdhTrans", bart.a(this.a));
      bart.a(this.a).put("param_segspercnt", paramArrayOfByte);
      bart.a(this.a).put("param_conf_segSize", localObject);
      bart.a(this.a).put("param_conf_segNum", str1);
      bart.a(this.a).put("param_conf_connNum", str2);
      bart.a(this.a).put("param_fin_lost", str3);
      bart.a(this.a).put("param_retry_seg_count", paramHashMap.get("param_retry_seg_count"));
      bart.a(this.a).put("param_max_retry_times", paramHashMap.get("param_max_retry_times"));
      bart.a(this.a).put("param_total_retry_times", paramHashMap.get("param_total_retry_times"));
      bart.a(this.a).put("param_retry_code", paramHashMap.get("param_retry_code"));
      ...
      bart.a(this.a).b(i, paramArrayOfByte);
    }
  }
