  ...
  implements View.OnClickListener
{
  ...
  private aney jdField_a_of_type_Aney;
  private bkqo jdField_a_of_type_Bkqo;
  private URLImageView jdField_a_of_type_ComTencentImageURLImageView;
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  public ApolloGameData a;
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager();
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  private WeakReference<anfc> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public anet(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup != paramView)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367321));
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364981));
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368159));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368149));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368179));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368160));
      this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368158));
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131364977));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363883));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363928));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363929));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363713));
      this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364990));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_d_of_type_AndroidViewViewGroup.findViewById(2131372943));
      this.e = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372946));
  ...
  private void a(ApolloGameData paramApolloGameData)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a();
        if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          localObject2 = new anfc(this);
          this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject2);
          ((amop)localObject1).a((amor)localObject2);
        }
        ((anfc)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int = ((int)(System.currentTimeMillis() / 1000L));
        if (!paramApolloGameData.isGameApp)
        {
          ((amop)localObject1).a(paramApolloGameData.gameId, ((anfc)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          ...
          if (((SparseArray)localObject1).get(2000) != null)
          {
            ...
            if (this.jdField_a_of_type_Aney != null) {
              this.jdField_a_of_type_Aney.notifyDataSetChanged();
            }
          }
        }
      }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (localObject2 = "1";; localObject2 = "0")
        {
          ...
          return;
          amol.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramApolloGameData, ((anfc)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          break;
          j = paramApolloGameData.gameId;
          k = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int;
          int m = ApolloGameUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  private void b(ApolloGameData paramApolloGameData)
  {
    ...
    bglp.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690033)).setPositiveButton(2131690021, new anew(this, paramApolloGameData)).setNegativeButton(2131690022, new anev(this)).show();
  }
  ...
  private void c(ApolloGameData paramApolloGameData)
  {
    ...
    bglp.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690023)).setPositiveButton(2131690022, new anex(this)).show();
  }
  
  private void e()
  {
    QQToast.a(BaseApplicationImpl.getContext(), 1, anni.a(2131699157), 0).a();
  }
  ...
  public View a()
  {
    ...
    do
    {
      ...
      {
      default: 
        localObject1 = (ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558664, null);
        localObject2 = (XListView)((ViewGroup)localObject1).findViewById(2131367321);
        return localObject1;
      }
      localObject2 = (ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558669, null);
      localTextView = (TextView)((ViewGroup)localObject2).findViewById(2131371753);
      if (amgz.a())
      {
        localTextView.setOnClickListener(null);
        localTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690042));
        return localObject2;
      }
      localObject1 = localObject2;
    } while (!bgnt.g(this.jdField_a_of_type_AndroidContentContext));
    localTextView.setText(anni.a(2131699187));
    localTextView.setOnClickListener(new aneu(this));
    return localObject2;
  }
  ...
  public ApolloGameData a()
  {
    ...
    localApolloGameData.name = ammy.a("aio.enter.name");
    localApolloGameData.listCoverUrl = ammy.a("aio.enter.bg");
    localApolloGameData.isSetting = true;
    localApolloGameData.toolUrl = ammy.a("aio.enter");
  ...
  public void a()
  {
    super.a();
    if (this.jdField_a_of_type_Aney != null) {
      this.jdField_a_of_type_Aney.a();
    }
    if ((a()) && (amgz.a("apollo_aio_game_guide") == -1))
    {
      amgz.a("apollo_aio_game_guide", 1);
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        anfc localanfc = (anfc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localanfc != null)
        {
          ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().b(localanfc);
  ...
  public void a(amlv paramamlv)
  {
    ...
    label41:
    for (int i = -1;; i = paramamlv.jdField_a_of_type_Int)
    {
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aney == null) {
      this.jdField_a_of_type_Aney = new aney(this.jdField_a_of_type_AndroidContentContext, this);
    }
    this.jdField_a_of_type_Aney.a(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aney);
    if ((this.jdField_a_of_type_Amlv != null) && (this.jdField_a_of_type_Amlv.jdField_a_of_type_Int > 0) && (this.jdField_b_of_type_JavaUtilList.size() > 1))
    {
      paramView = this.jdField_b_of_type_JavaUtilList.iterator();
      while (paramView.hasNext()) {
        if (((ApolloGameData)paramView.next()).gameId == this.jdField_a_of_type_Amlv.jdField_a_of_type_Int)
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloGameViewBinder", 2, new Object[] { "[updatePanel] jump gameId:", Integer.valueOf(this.jdField_a_of_type_Amlv.jdField_a_of_type_Int), ",from:", Integer.valueOf(this.jdField_a_of_type_Amlv.jdField_b_of_type_Int) });
          }
          VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "avatar_clk_togame", this.g, this.jdField_a_of_type_Amlv.jdField_b_of_type_Int, new String[] { String.valueOf(this.jdField_a_of_type_Amlv.jdField_a_of_type_Int) });
        }
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(List<ApolloGameData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1036) && (paramList != null) && (ammy.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == ammz.d)) {
      paramList.add(0, a());
    }
    ...
    this.jdField_c_of_type_JavaUtilList = ((ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).h(6);
  }
  ...
  public boolean a(int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ??? = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (TextUtils.isEmpty(a())) {
        return false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) {
        this.jdField_c_of_type_JavaUtilList = ((ancd)???).a(ApolloGameUtil.a(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
  ...
  public void b(List<ApolloGameData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1036))
    {
    ...
    {
      return;
      if ((paramList != null) && (ammy.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == ammz.d)) {
        paramList.add(0, a());
      }
    } while ((this.jdField_b_of_type_JavaUtilList == null) || (paramList == null) || (this.jdField_a_of_type_Aney == null));
    this.jdField_b_of_type_JavaUtilList.clear();
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    this.jdField_a_of_type_Aney.notifyDataSetChanged();
  }
  ...
  public void d()
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      if (ammy.a("aio.panel.rank.time") < System.currentTimeMillis() / 1000L)
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)) {
        ...
        ammy.a("aio.panel.rank.time", (int)(System.currentTimeMillis() / 1000L) + 300);
      }
      return;
    }
  }
