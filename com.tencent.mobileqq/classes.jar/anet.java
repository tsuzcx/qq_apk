...
public class anet
{
  ...
  private static aneu jdField_a_of_type_Aneu;
  ...
  {
    jdField_a_of_type_Aneu = new aneu(null);
    jdField_a_of_type_Aneu.jdField_a_of_type_Long = System.currentTimeMillis();
  }
  
  public static void a(int paramInt)
  {
    aneu localaneu = jdField_a_of_type_Aneu;
    if (localaneu == null) {}
    long l;
    do
    {
      return;
      jdField_a_of_type_Aneu = null;
      l = System.currentTimeMillis() - localaneu.jdField_a_of_type_Long;
    } while ((l > 600000L) || (localaneu.jdField_a_of_type_Int <= 0));
    int k = localaneu.jdField_a_of_type_Int;
    int m = localaneu.b;
    int n = localaneu.c;
    int i1 = localaneu.d / k;
    int i;
    if (m <= 0)
    {
      i = 0;
  ...
  {
    if ((jdField_a_of_type_Aneu == null) || (paramInt1 <= 1) || (paramInt1 > 15000)) {
      return;
    }
    switch (paramInt2)
    {
    default: 
      return;
    case 0: 
      localaneu = jdField_a_of_type_Aneu;
      localaneu.jdField_a_of_type_Int += 1;
      localaneu = jdField_a_of_type_Aneu;
      localaneu.d += paramInt1;
      return;
    case 1: 
      localaneu = jdField_a_of_type_Aneu;
      localaneu.b += 1;
      localaneu = jdField_a_of_type_Aneu;
      localaneu.e += paramInt1;
      return;
    }
    aneu localaneu = jdField_a_of_type_Aneu;
    localaneu.c += 1;
    localaneu = jdField_a_of_type_Aneu;
    localaneu.f += paramInt1;
  }
