...
public class zbj
  implements View.OnClickListener, bfdt
{
  ...
  public zbj(AppInterface paramAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_MqqObserverBusinessObserver = new zbm(this);
    this.jdField_a_of_type_AndroidOsHandler = new zbn(this);
    ...
    if ((paramActivity instanceof bebx)) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((bebx)paramActivity);
    }
    while (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      QLog.e(jdField_a_of_type_JavaLangString, 2, "Error! mWebUiUtils still null! " + paramActivity.toString());
      return;
      if ((paramActivity instanceof bebt))
      {
        paramAppInterface = ((bebt)paramActivity).b();
    ...
    paramAppInterface = (bebx)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((paramAppInterface != null) && ((paramAppInterface instanceof behk)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((behk)paramAppInterface).getWebView();
      if (QLog.isColorLevel())
      {
  ...
  public static final String a(List<zbo> paramList, int paramInt)
  {
    ...
    label270:
    label276:
    for (localObject2 = (zbo)paramList.get(i1);; localObject3 = localObject1)
    {
      try
      {
        int i3 = Integer.valueOf(((zbo)localObject2).b.get()).intValue();
        if (i3 >= paramInt)
        {
          localObject2 = ((zbo)localObject2).a.get();
          localObject1 = localObject2;
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            if (localObject2 == null)
            {
              ...
              localObject2 = (zbo)paramList.get(i1);
            }
          }
          i1 += 1;
        }
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          i2 = Integer.valueOf(((zbo)localObject2).b.get()).intValue();
          if (i2 >= paramInt) {
            break label267;
          }
          localObject2 = ((zbo)localObject2).a.get();
  ...
  public static List<zbo> a(PBRepeatMessageField<GetAppInfoProto.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        paramPBRepeatMessageField.add(new zbo(localMsgIconsurl.url, localMsgIconsurl.size));
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        ((Bundle)localObject2).putString("intext_3", "" + bfdw.b(paramInt));
        ((Bundle)localObject2).putString("intext_2", "" + i2);
        ((Bundle)localObject2).putString("stringext_1", paramString3);
        bfdq.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      }
      ...
      ((Bundle)localObject1).putLong("share_begin_time", beei.jdField_b_of_type_Long);
      if (!(this.jdField_a_of_type_AndroidAppActivity instanceof bebt)) {
        break label3714;
      }
      paramString1 = ((bebt)this.jdField_a_of_type_AndroidAppActivity).b();
    ...
    for (;;)
    {
      if ((paramInt != 0) || (!bjao.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null))) {
        xxb.a(1, 2131689512);
      }
      return;
      ...
      if (paramInt == 1)
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity instanceof bebt))
        {
          paramBitmap = ((bebt)this.jdField_a_of_type_AndroidAppActivity).b();
          if ((paramBitmap == null) || (paramBitmap.b() == null)) {
            break label3704;
          }
          localObject1 = (beei)paramBitmap.b().a(4);
          if (localObject1 == null) {
            break label3704;
          }
          paramBitmap = ((beei)localObject1).a();
          localObject1 = ((beei)localObject1).jdField_e_of_type_JavaLangString;
        }
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            catch (Exception paramBitmap)
            {
              ...
              localObject4 = ((Resources)localObject9).getString(2131696889);
              continue;
              paramBitmap = "plugin";
            ...
            if ((this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser))
            {
              ...
              if ((TextUtils.isEmpty(str2)) || (TextUtils.isEmpty((CharSequence)localObject4))) {
                if (jdField_f_of_type_Boolean)
                {
                  ...
                  if (paramInt != 0)
                  {
                    localObject4 = this.jdField_b_of_type_AndroidAppActivity.getString(2131696893);
                  ...
                  bdir.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "web_share", str2, paramString4, paramString1, paramString2, String.format(((Resources)localObject9).getString(2131696873), new Object[] { paramString1 }), paramString3, "web", null, null, null, paramBitmap, null, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject4, "", localIntent, -1, null, -1L);
                  i1 = 0;
                  if (TextUtils.isEmpty(paramString4)) {
                    i1 = 1;
                  }
                  ...
                  bfdq.a().a(paramString1, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
                  return;
                  localIntent.putExtra("isWebCompShare", true);
            ...
            for (;;)
            {
              ...
              for (localObject1 = "http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/logo_16.png";; localObject1 = paramBitmap)
              {
                ...
                if ((this.jdField_a_of_type_AndroidAppActivity instanceof bebt))
                {
                  localObject8 = ((bebt)this.jdField_a_of_type_AndroidAppActivity).b();
                  paramBitmap = (Bitmap)localObject6;
                ...
                label1942:
                if (badt.a(paramString3))
                {
                  localObject7 = "web";
                  localObject4 = alpo.a(2131714253);
                  if (TextUtils.isEmpty(aosx.a().h()))
                  {
                    localObject1 = badt.jdField_b_of_type_JavaLangString;
                    label1980:
                    localObject2 = badt.jdField_d_of_type_JavaLangString;
                    paramInt = 95;
                    l1 = badt.jdField_a_of_type_Long;
                ...
                for (;;)
                {
                  if ((bool2) || (bool1))
                  {
                    ...
                    localObject8 = this.jdField_b_of_type_AndroidAppActivity.getString(2131696873, new Object[] { paramString1 });
                  ...
                  for (i2 = -1;; i2 = 1001)
                  {
                    bdir.a((Context)localObject7, i1, paramInt, "web_share", paramBitmap, paramString4, paramString1, paramString2, (String)localObject8, paramString3, "web", null, null, null, (String)localObject1, null, (String)localObject5, (String)localObject3, (String)localObject2, (String)localObject4, "", localIntent, i2, (String)localObject6, l1);
                    break;
                    localObject2 = this.jdField_b_of_type_AndroidAppActivity.getString(2131696889);
                  ...
                  if ((paramInt == 3) || (paramInt == 4)) {
                    if (paramInt == 3)
                    {
                      ...
                      {
                        this.jdField_a_of_type_Bevy = new zbl(this, paramString3);
                        WXShareHelper.a().a(this.jdField_a_of_type_Bevy);
                      }
                      this.o = String.valueOf(System.currentTimeMillis());
                      if ((TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) || (!badt.jdField_b_of_type_JavaUtilMap.containsKey(this.jdField_f_of_type_JavaLangString))) {
                        break label2586;
                      }
                      paramString4 = (Integer)badt.jdField_b_of_type_JavaUtilMap.get(this.jdField_f_of_type_JavaLangString);
                  ...
                  for (;;)
                  {
                    ...
                    if ((paramString3 != null) && (paramString3.contains("docs.qq.com/")))
                    {
                      if (paramInt == 3)
                      {
                        ...
                        if ((a() != null) && (a().l != null))
                        {
                          ...
                          paramString1 = badt.a(this.jdField_g_of_type_JavaLangString);
                          if ((TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) || (!badt.d(this.jdField_g_of_type_JavaLangString))) {
                            break label2664;
                          }
                          if (paramString1 == null) {
                            break label2655;
                    ...
                    if (paramInt == 5)
                    {
                      ...
                      {
                        azmj.b(null, "CliOper", "", "", "0X8006277", "0X8006277", 0, 0, "", "", "", "");
                      ...
                      if (bjxp.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null, 0)) {
                        break;
                      }
                      xxb.a(1, 2131689512);
                      return;
                    ...
                    {
                      bfua.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, paramString1, paramString2, paramString3, paramString4, "", 0, false);
                      return;
                    }
                    if (paramInt == 8)
                    {
                      ...
                      catch (PackageManager.NameNotFoundException paramString2)
                      {
                        for (;;)
                        {
                          ...
                          {
                            Toast.makeText(BaseApplicationImpl.getContext(), alpo.a(2131714254), 1).show();
  ...
  {
    Bundle localBundle = bdfk.a(paramString2, paramString3, "0.0.0.1", paramString4, this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().scaledDensity, null, null);
  ...
  public static final void a(AppInterface paramAppInterface, Context paramContext, String paramString1, long paramLong1, long paramLong2, BusinessObserver paramBusinessObserver, String paramString2)
  {
    ...
    localGetAppinfoRequest.qqv.set("8.3.3");
    ...
    paramContext = new NewIntent(paramContext, bfen.class);
  ...
  public static List<zbo> b(PBRepeatMessageField<appType.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      Object localObject = paramPBRepeatMessageField.get();
  ...
  private void b(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      if (((paramString.length() > 180) || ((!(this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser)) && (paramString.length() > 60))) && (!(this.jdField_a_of_type_AndroidAppActivity instanceof TeamWorkDocEditBrowserActivity)) && (!badt.a(paramString))) {
  ...
  public babw a()
  {
    return this.jdField_a_of_type_Babw;
  }
  ...
  public bepp a()
  {
    ...
    if (this.jdField_a_of_type_Bepp == null)
    {
      ...
      localbebx = (bebx)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localbebx == null) || (!(localbebx instanceof behj)) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        break label134;
      }
      i1 = ((behj)localbebx).b();
    }
    for (;;)
    {
      this.jdField_a_of_type_Bepp = new bepp(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bepp.c(2131689506);
  ...
  public String a()
  {
    ...
    for (;;)
    {
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          localObject = (bebx)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if ((localObject != null) && ((localObject instanceof behk))) {
            localObject = ((behk)localObject).b();
          }
        }
      }
      else
  ...
  void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131368982));
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131368983);
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
        a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.n, bdaw.b(this.jdField_a_of_type_Long), 0L, this.jdField_a_of_type_MqqObserverBusinessObserver);
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841704);
        ...
        this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130840147);
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841500);
      ...
      } while (!(this.jdField_a_of_type_AndroidAppActivity instanceof bebt));
      localObject2 = ((bebt)this.jdField_a_of_type_AndroidAppActivity).b();
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        if ((paramInt3 == 1) && ((paramInt2 == 0) || (paramInt2 == 1)) && (this.jdField_a_of_type_Babw != null)) {
    ...
    catch (Exception paramContext)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          paramContext = ndd.a(paramContext, String.format("http://openmobile.qq.com/api/get_app_info_by_id?appid=%d", new Object[] { Long.valueOf(bdaw.b(this.jdField_a_of_type_Long)) }), "GET", null, null);
        ...
        if (bdem.a(paramContext, localAndroidInfo.packName.get()))
        {
          paramContext = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1001);
          try
          {
  ...
  public void a(bebx parambebx)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambebx);
    }
    parambebx = (bebx)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((parambebx != null) && ((parambebx instanceof behk)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((behk)parambebx).getWebView();
      if (QLog.isColorLevel())
      {
        parambebx = jdField_a_of_type_JavaLangString;
        localObject = new StringBuilder().append(" Share secret webview is null?");
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
          break label122;
        }
        bool = true;
        QLog.d(parambebx, 2, bool);
      }
    }
    label122:
    while (!QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    for (Object localObject = null;; localObject = this.h)
    {
      ...
      localQZoneShareData.jdField_b_of_type_Long = beei.jdField_b_of_type_Long;
      ...
      bjao.a(this.jdField_b_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localQZoneShareData, null, -1);
      return true;
      this.jdField_b_of_type_AndroidAppActivity = this.jdField_a_of_type_AndroidAppActivity;
      break;
      localObject = this.jdField_e_of_type_JavaLangString;
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Bfdy.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bfdy.jdField_b_of_type_Int = bfdw.b(paramInt);
      localBundle = new Bundle();
      localBundle.putString("report_type", "102");
      localBundle.putString("act_type", "90");
      localStringBuilder = new StringBuilder().append("");
      if (this.jdField_a_of_type_Bfdy.jdField_a_of_type_Int != 0) {
        break label407;
      }
    }
    label407:
    for (int i1 = 0;; i1 = 1)
    {
      ...
      localBundle.putString("intext_3", "" + this.jdField_a_of_type_Bfdy.jdField_b_of_type_Int);
      localBundle.putString("intext_2", "" + this.jdField_a_of_type_Bfdy.jdField_a_of_type_Int);
      localBundle.putString("stringext_1", "" + paramString);
      bfdq.a().a(localBundle, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      this.jdField_a_of_type_Bfdy.jdField_a_of_type_Boolean = false;
      ...
      paramString.putString("intext_1", "" + bfdw.a(1));
      paramString.putString("intext_3", "1");
      paramString.putString("intext_4", "0");
      bfdq.a().a(paramString, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      return false;
    }
    ...
    if ((!this.jdField_a_of_type_Bepp.isShowing()) && (bool)) {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, Bundle paramBundle)
  {
    ...
    //   7: aload_0
    //   8: aload_3
    //   9: invokevirtual 1690	zbj:a	(Ljava/lang/String;)Z
    //   12: ifne +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: aload_0
    //   18: aload_1
    //   19: putfield 375	zbj:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   22: aload_0
    //   23: aload_2
    //   24: putfield 379	zbj:h	Ljava/lang/String;
    //   27: aload_0
    //   28: aload 4
    //   30: putfield 383	zbj:i	Ljava/lang/String;
    //   33: aload_0
    //   34: getfield 383	zbj:i	Ljava/lang/String;
    //   37: ifnull +43 -> 80
    //   40: aload_0
    //   41: getfield 383	zbj:i	Ljava/lang/String;
    //   44: ldc_w 1692
    ...
    //   67: aload_0
    //   68: getfield 383	zbj:i	Ljava/lang/String;
    ...
    //   77: putfield 383	zbj:i	Ljava/lang/String;
    //   80: aload_0
    //   81: iconst_1
    //   82: putfield 1137	zbj:jdField_e_of_type_Boolean	Z
    //   85: aload 5
    //   87: ifnull +173 -> 260
    //   90: aload 5
    //   92: ldc_w 1699
    ...
    //   125: aload_0
    //   126: getfield 375	zbj:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 379	zbj:h	Ljava/lang/String;
    ...
    //   151: aload_0
    //   152: getfield 383	zbj:i	Ljava/lang/String;
    ...
    //   174: aload_0
    //   175: getfield 76	zbj:jdField_a_of_type_Bfdy	Lbfdy;
    //   178: iconst_1
    //   179: putfield 1641	bfdy:jdField_a_of_type_Boolean	Z
    //   182: aload_0
    //   183: getfield 76	zbj:jdField_a_of_type_Bfdy	Lbfdy;
    //   186: iconst_0
    //   187: putfield 1645	bfdy:jdField_a_of_type_Int	I
    //   190: aload 4
    //   192: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   195: ifeq +430 -> 625
    //   198: aload_0
    //   199: getfield 76	zbj:jdField_a_of_type_Bfdy	Lbfdy;
    //   202: astore 4
    //   204: aload 4
    //   206: aload 4
    //   208: getfield 1645	bfdy:jdField_a_of_type_Int	I
    //   211: iconst_1
    //   212: ior
    //   213: putfield 1645	bfdy:jdField_a_of_type_Int	I
    //   216: aload_2
    //   217: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   220: ifeq +18 -> 238
    //   223: aload_0
    //   224: getfield 76	zbj:jdField_a_of_type_Bfdy	Lbfdy;
    //   227: astore_2
    //   228: aload_2
    //   229: aload_2
    //   230: getfield 1645	bfdy:jdField_a_of_type_Int	I
    //   233: iconst_2
    //   234: ior
    //   235: putfield 1645	bfdy:jdField_a_of_type_Int	I
    //   238: aload_1
    //   239: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifeq +18 -> 260
    //   245: aload_0
    //   246: getfield 76	zbj:jdField_a_of_type_Bfdy	Lbfdy;
    //   249: astore_1
    //   250: aload_1
    //   251: aload_1
    //   252: getfield 1645	bfdy:jdField_a_of_type_Int	I
    //   255: iconst_4
    //   256: ior
    //   257: putfield 1645	bfdy:jdField_a_of_type_Int	I
    //   260: aload_0
    //   261: aconst_null
    //   262: putfield 1135	zbj:jdField_a_of_type_JavaLangRefSoftReference	Ljava/lang/ref/SoftReference;
    //   265: aload 5
    //   267: ifnull +263 -> 530
    //   270: getstatic 62	zbj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   273: iconst_1
    //   274: ldc_w 1709
    ...
    //   435: putfield 71	zbj:jdField_a_of_type_Int	I
    //   438: aload_0
    //   439: aload 5
    //   441: ldc_w 1736
    //   444: invokevirtual 1723	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   447: putfield 1738	zbj:jdField_c_of_type_Boolean	Z
    //   450: aload_0
    //   451: getfield 127	zbj:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   454: ifnull +76 -> 530
    //   457: aload_0
    //   458: getfield 127	zbj:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   461: instanceof 1131
    //   464: ifeq +66 -> 530
    //   467: aload_0
    //   468: getfield 127	zbj:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   485: aload_1
    //   486: aload_0
    //   487: getfield 69	zbj:jdField_a_of_type_Boolean	Z
    //   490: aload_0
    //   491: getfield 71	zbj:jdField_a_of_type_Int	I
    ...
    //   497: aload_1
    //   498: aload_0
    //   499: getfield 1729	zbj:jdField_d_of_type_Boolean	Z
    ...
    //   510: iconst_1
    //   511: aload_0
    //   512: getfield 1734	zbj:j	Ljava/lang/String;
    //   515: aconst_null
    ...
    //   567: ldc_w 1767
    //   570: aload_0
    //   571: getfield 80	zbj:jdField_d_of_type_Int	I
    //   574: invokestatic 1768	cooperation/qzone/LocalMultiProcConfig:putInt	(Ljava/lang/String;I)V
    //   577: aload_0
    //   578: getfield 222	zbj:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   581: ifnull +16 -> 597
    //   584: ldc_w 1770
    //   587: aload_0
    //   588: getfield 222	zbj:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    ...
    //   607: astore_1
    //   608: aload_0
    //   609: getfield 127	zbj:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   612: ifnull +11 -> 623
    //   615: aload_0
    //   616: getfield 127	zbj:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   619: aload_1
    ...
    //   625: aload_0
    //   626: iconst_2
    //   627: putfield 1777	zbj:jdField_b_of_type_Int	I
    //   630: goto -414 -> 216
    //   633: astore_1
    //   634: getstatic 62	zbj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   637: iconst_1
    //   638: ldc_w 1779
    //   641: invokestatic 179	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   644: aload_0
    //   645: iconst_m1
    //   646: putfield 78	zbj:jdField_c_of_type_Int	I
    //   649: goto -281 -> 368
    //   652: astore_1
    //   653: getstatic 62	zbj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   656: iconst_1
    //   657: ldc_w 1781
    ...
    //   667: aload_0
    //   668: aconst_null
    //   669: putfield 1734	zbj:j	Ljava/lang/String;
    //   672: getstatic 62	zbj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   675: iconst_1
    //   676: ldc_w 1783
    ...
    //   686: aload_0
    //   687: iconst_m1
    //   688: putfield 71	zbj:jdField_a_of_type_Int	I
    //   691: goto -253 -> 438
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (this.jdField_a_of_type_Bepp == null)
    {
      paramString7 = (bebx)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((paramString7 == null) || (!(paramString7 instanceof behj))) {
        break label456;
      }
    }
    label139:
    ...
    label192:
    label456:
    for (int i1 = ((behj)paramString7).b();; i1 = 0)
    {
      this.jdField_a_of_type_Bepp = new bepp(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bepp.c(2131689506);
      boolean bool;
      ...
      for (;;)
      {
        ...
        String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131696873), new Object[] { paramString2 });
        bdir.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "struct_msg_from_h5", paramString1, paramString5, paramString2, paramString3, str, paramString4, "web", null, null, null, "plugin", null, paramString7, paramString8, "http://url.cn/JS8oE7", paramString6, null);
        int i2 = 0;
  ...
  public void b()
  {
    ...
    this.m = null;
    this.p = null;
    this.jdField_a_of_type_Absf = null;
    this.q = null;
    this.r = null;
    this.s = null;
    this.t = null;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null) && (this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.androidInfo != null))
    {
      ...
      if (!bdem.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get())) {
        break label97;
      }
      bdem.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get(), null);
      paramView = "run";
      ndq.a(null, "", "webviewsourceclick", bdaw.b(this.jdField_a_of_type_Long), 0L, paramView);
    }
    label97:
    do
    {
      for (;;)
      {
        ...
        bfei.a(this.jdField_a_of_type_AndroidAppActivity, String.valueOf(bdaw.b(this.jdField_a_of_type_Long)), 2470, paramView);
        paramView = "setup";
        break;
        ...
        {
          bdem.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get(), null);
          bfja.a().a(this.n, String.valueOf(bdaw.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "203", false);
        }
        while (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
        {
          ...
          paramView.putBoolean("autoDownload", true);
          paramView.putString("packageName", localAndroidInfo.packName.get());
          paramView.putString("appId", String.valueOf(bdaw.b(this.jdField_a_of_type_Long)));
          bfei.b(this.jdField_a_of_type_AndroidAppActivity, paramView);
          bfja.a().a(this.n, String.valueOf(bdaw.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "202", false);
        }
      }
