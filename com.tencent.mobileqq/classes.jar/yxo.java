  ...
  implements yxh
{
  ...
  private GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      yxs.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      ...
      if (localGdtAd.getImageData() == null)
      {
        ...
        if (paramAdInfo != null) {
          localObject1 = yxr.a(paramAdInfo);
        }
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (ywn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(ywn paramywn, String paramString, String... paramVarArgs)
  {
    ...
    j = 0;
    if (paramywn != null) {}
    for (Object localObject1 = paramywn.a(); (paramywn == null) || (localObject1 == null); localObject1 = null)
    {
      yxs.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    for (;;)
    {
      ...
      catch (Throwable paramVarArgs)
      {
        try
        {
          ...
          j = k;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(yxr.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(str)));
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramywn.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramywn == null) {
            break label322;
          }
