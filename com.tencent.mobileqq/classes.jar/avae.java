...
public class avae
{
  ...
  public static Drawable a(Bitmap paramBitmap)
  {
    ...
    Bitmap localBitmap = bhmq.a(paramBitmap, paramBitmap.getWidth(), paramBitmap.getHeight());
  ...
  {
    Object localObject = null;
    Bitmap localBitmap = bhmq.a(paramBitmap, a(0, paramDouble));
    paramBitmap = localObject;
    if (localBitmap != null) {
      paramBitmap = new BitmapDrawable(BaseApplicationImpl.getApplication().getResources(), localBitmap);
    }
  ...
  {
    return a(bhjd.a(paramDrawable), paramDouble);
  }
