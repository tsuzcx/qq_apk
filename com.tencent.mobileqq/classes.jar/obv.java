...
public class obv
{
  private static obv jdField_a_of_type_Obv;
  ...
  private List<obw> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  private String a(obw paramobw, BaseArticleInfo paramBaseArticleInfo, TemplateBean paramTemplateBean, ViewBase paramViewBase)
  {
    if (paramBaseArticleInfo == null) {
      return "";
    }
    if ((TextUtils.isEmpty(paramobw.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(paramobw.c)) || (TextUtils.isEmpty(paramobw.jdField_a_of_type_JavaLangString))) {
      return "";
    }
    String str3 = paramobw.jdField_a_of_type_JavaLangString;
    String str1 = paramobw.jdField_b_of_type_JavaLangString;
    String str2 = paramobw.c;
  ...
  public static obv a()
  {
    try
    {
      if (jdField_a_of_type_Obv == null) {
        jdField_a_of_type_Obv = new obv();
      }
      obv localobv = jdField_a_of_type_Obv;
      return localobv;
    }
    finally {}
  }
  
  private obw a(oidb_cmd0x64e.SRTRule paramSRTRule)
  {
    if (paramSRTRule == null) {
      return null;
    }
    obw localobw = new obw(this);
    if (paramSRTRule.uint32_click_number.has()) {
      localobw.jdField_b_of_type_JavaUtilList = paramSRTRule.uint32_click_number.get();
    }
    if (paramSRTRule.uint32_feeds_type.has()) {
      localobw.jdField_a_of_type_JavaUtilList = paramSRTRule.uint32_feeds_type.get();
    }
    if (paramSRTRule.uint32_network_type.has()) {
      localobw.jdField_a_of_type_Int = paramSRTRule.uint32_network_type.get();
    }
    if (paramSRTRule.bytes_app_package_name.has()) {
      localobw.jdField_a_of_type_JavaLangString = paramSRTRule.bytes_app_package_name.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_schema.has()) {
      localobw.c = paramSRTRule.bytes_schema.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_h5.has()) {
      localobw.jdField_b_of_type_JavaLangString = paramSRTRule.bytes_h5.get().toStringUtf8();
    }
    QLog.d("ReadInJoySrtUtils", 1, "convertSRTPbToSRTClassclickNumList = " + localobw.jdField_b_of_type_JavaUtilList + " feedsTypeList= " + localobw.jdField_a_of_type_JavaUtilList + " netWorkType= " + localobw.jdField_a_of_type_Int + " packageName = " + localobw.jdField_a_of_type_JavaLangString + " schemaUrl= " + localobw.c + " h5Url= " + localobw.jdField_b_of_type_JavaLangString);
    return localobw;
  }
  ...
  private oidb_cmd0x64e.SRTRule a(obw paramobw)
  {
    if (paramobw == null) {
      return null;
    }
    ...
    if (paramobw.c != null) {
      localSRTRule.bytes_schema.set(ByteStringMicro.copyFromUtf8(paramobw.c));
    }
    if (paramobw.jdField_b_of_type_JavaLangString != null) {
      localSRTRule.bytes_h5.set(ByteStringMicro.copyFromUtf8(paramobw.jdField_b_of_type_JavaLangString));
    }
    if (paramobw.jdField_a_of_type_JavaLangString != null) {
      localSRTRule.bytes_app_package_name.set(ByteStringMicro.copyFromUtf8(paramobw.jdField_a_of_type_JavaLangString));
    }
    if (paramobw.jdField_b_of_type_JavaUtilList != null) {
      localSRTRule.uint32_click_number.set(paramobw.jdField_b_of_type_JavaUtilList);
    }
    if (paramobw.jdField_a_of_type_JavaUtilList != null) {
      localSRTRule.uint32_feeds_type.set(paramobw.jdField_a_of_type_JavaUtilList);
    }
    localSRTRule.uint32_network_type.set(paramobw.jdField_a_of_type_Int);
    return localSRTRule;
  }
  
  private void a(obw paramobw, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramobw != null)
      {
        ...
        paramobw.uint32_click_number.set(localArrayList1);
        paramobw.uint32_feeds_type.set(localArrayList2);
      }
    ...
    this.jdField_a_of_type_TencentImOidbCmd0x64eOidb_cmd0x64e$SRTClickInfo.msg_hit_srt_rule.set(paramobw);
  }
  
  private boolean a(obw paramobw, int paramInt)
  {
    if (paramobw == null) {}
    int i;
    int j;
    do
    {
      ...
      {
        return false;
      } while ((paramobw.jdField_b_of_type_JavaUtilList == null) || (paramobw.jdField_a_of_type_JavaUtilList == null));
      i = paramobw.jdField_a_of_type_Int;
      j = mpq.a(BaseActivity.sTopActivity);
    } while ((j == 0) || ((i == 1) && (j != 1)) || ((i == 2) && (j == 1)) || (!paramobw.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))) || (!paramobw.jdField_b_of_type_JavaUtilList.contains(Integer.valueOf(this.jdField_a_of_type_Int))));
    return true;
  }
  ...
  private void c()
  {
    try
    {
      Object localObject = (String)bgmq.a("readinjoy_srt_click_time_key", "");
      String str1;
      int i;
      ...
      for (;;)
      {
        ...
        bgmq.a("readinjoy_srt_click_time_key", ((JSONObject)localObject).toString());
        return;
  ...
  public void a(List<oidb_cmd0x64e.SRTRule> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        obw localobw = a((oidb_cmd0x64e.SRTRule)localIterator.next());
        if (localobw != null) {
          localArrayList.add(localobw);
        }
      }
  ...
  {
    if ((this.jdField_b_of_type_JavaUtilList == null) || (this.jdField_b_of_type_JavaUtilList.size() == 0) || (paramBaseArticleInfo == null) || ((paramBaseArticleInfo.mChannelID != 0L) && (!odm.c((int)paramBaseArticleInfo.mChannelID)))) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        obw localobw = (obw)this.jdField_b_of_type_JavaUtilList.get(i);
        int j = obz.a(paramBaseArticleInfo);
        QLog.d("ReadInJoySrtUtils", 1, "startJudge feedsType:" + j + " clickTimes: " + this.jdField_a_of_type_Int + " position" + i);
        if (a(localobw, j))
        {
          paramBaseArticleInfo = a(localobw, paramBaseArticleInfo, paramTemplateBean, paramViewBase);
          if (TextUtils.isEmpty(paramBaseArticleInfo)) {
            break;
          }
          this.jdField_a_of_type_JavaLangString = paramBaseArticleInfo;
          a(localobw, j, this.jdField_a_of_type_Int, i);
