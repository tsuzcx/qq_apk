...
public class atbj
{
  private static volatile atbj jdField_a_of_type_Atbj;
  private long jdField_a_of_type_Long;
  private atbn jdField_a_of_type_Atbn;
  private beck jdField_a_of_type_Beck;
  ...
  private WeakReference<atbm> jdField_a_of_type_MqqUtilWeakReference;
  ...
  private int a(Context paramContext, float paramFloat)
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      atbd.a(paramContext, 4, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin());
      return i;
    }
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(localFloatingScreenManager.setFloatingVideoListener(new atbk(this), 2));
    localFloatingScreenManager.setWindowClickListener(2, new atbl(this, paramContext));
    return 0;
  }
  
  public static atbj a()
  {
    if (jdField_a_of_type_Atbj == null) {}
    try
    {
      if (jdField_a_of_type_Atbj == null) {
        jdField_a_of_type_Atbj = new atbj();
      }
      return jdField_a_of_type_Atbj;
    }
    finally {}
  }
  ...
  public int a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    ...
    {
      QQToast.a(BaseApplicationImpl.getContext(), 2131694766, 0).a();
    ...
    this.jdField_a_of_type_Beck = new beck(localIntent, paramContext);
    this.jdField_a_of_type_Beck.a();
    atbd.a(true, paramWatchTogetherFloatingData.getCurUin(), paramWatchTogetherFloatingData.getCurType(), true);
  ...
  public void a(atbm paramatbm)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramatbm);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((atbm)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt2);
      }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData = null;
    if (this.jdField_a_of_type_Beck != null)
    {
      this.jdField_a_of_type_Beck.e();
      this.jdField_a_of_type_Beck.c();
      this.jdField_a_of_type_Beck = null;
    }
    ...
    atbd.a(false, paramString, paramInt, paramBoolean);
    if (this.jdField_a_of_type_Atbn != null)
    {
      atxn.a().a(this.jdField_a_of_type_Atbn);
      this.jdField_a_of_type_Atbn = null;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    atbm localatbm = (atbm)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      localatbm.b(i);
  ...
  public boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingView == null) || (this.jdField_a_of_type_Beck == null)) {}
    TouchWebView localTouchWebView;
    do
    {
      return false;
      localTouchWebView = this.jdField_a_of_type_Beck.a;
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      azmj.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
      return;
      if (QLog.isColorLevel()) {
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_Atbn == null)
        {
          this.jdField_a_of_type_Atbn = new atbn(this.jdField_b_of_type_MqqUtilWeakReference);
          atxn.a().a(1, this.jdField_a_of_type_Atbn);
          return;
        }
        this.jdField_a_of_type_Atbn.a(this.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
    } while (paramInt != 2);
    azmj.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
  ...
  public void b(atbm paramatbm)
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() == paramatbm)) {
