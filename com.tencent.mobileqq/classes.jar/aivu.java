  ...
  implements aiwf, View.OnClickListener
{
  ...
  public aivu(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aiwh paramaiwh, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  public static aivv a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = new aivv(new JSONObject(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, aivv paramaivv, String paramString2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramaivv != null)
    {
      paramQQAppInterface.a().b(paramString1, 1008, paramaivv.jdField_d_of_type_Long, true);
      if (QLog.isColorLevel()) {
        QLog.i("PubAccountTips", 2, "removeMsgByUniseq. uniqSeqno:" + paramaivv.jdField_d_of_type_Long);
      }
    }
    paramaivv = localSharedPreferences.edit();
    paramQQAppInterface = "selfuin_" + paramQQAppInterface.getCurrentAccountUin() + "_puin_" + paramString1 + "_msgdata";
    if (paramString2 != null) {
      paramaivv.putString(paramQQAppInterface, paramString2);
    }
    for (;;)
    {
      paramaivv.commit();
      return;
      paramaivv.remove(paramQQAppInterface);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    //   152: dup
    //   153: aload_1
    //   154: invokespecial 90	aivv:<init>	(Lorg/json/JSONObject;)V
    //   157: astore_3
    //   158: aload_3
    //   159: invokevirtual 221	aivv:a	()Z
    //   162: ifeq -158 -> 4
    //   165: aload_3
    //   166: getfield 224	aivv:jdField_b_of_type_Int	I
    //   169: iconst_1
    //   170: if_icmpne +145 -> 315
    //   173: sipush -2011
    //   176: invokestatic 229	bcry:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   202: aload_3
    //   203: getfield 235	aivv:jdField_a_of_type_Long	J
    ...
    //   212: astore 7
    //   214: aload_3
    //   215: getfield 238	aivv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   218: astore 6
    //   220: aload 4
    //   222: aload 5
    //   224: aload 7
    ...
    //   241: invokestatic 247	bdow:a	()Lcom/tencent/mobileqq/structmsg/StructMsgForGeneralShare;
    //   244: astore 7
    //   246: aload 7
    //   248: aload 6
    ...
    //   253: aload 7
    //   255: aload_3
    //   256: getfield 255	aivv:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   337: aload_3
    //   338: getfield 289	aivv:jdField_a_of_type_Int	I
    ...
    //   388: aload_3
    //   389: getfield 235	aivv:jdField_a_of_type_Long	J
    ...
    //   398: invokestatic 292	aivu:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Laivv;
    //   401: astore 4
    //   403: aload_0
    ...
    //   416: aload_3
    //   417: getfield 235	aivv:jdField_a_of_type_Long	J
    ...
    //   432: invokestatic 294	aivu:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Laivv;Ljava/lang/String;)V
    //   435: aload_0
    //   436: ldc_w 296
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a()).inflate(2131559978, null);
    ImageView localImageView;
    if (this.jdField_a_of_type_Aivv != null)
    {
      if (this.jdField_a_of_type_Aivv.jdField_a_of_type_Int != 1) {
        break label106;
      }
      paramVarArgs.setBackgroundResource(2131165877);
      ((TextView)paramVarArgs.findViewById(2131362527)).setText(this.jdField_a_of_type_Aivv.jdField_a_of_type_JavaLangString);
      localImageView = (ImageView)paramVarArgs.findViewById(2131362523);
      String str = this.jdField_a_of_type_Aivv.jdField_b_of_type_JavaLangString;
      if (TextUtils.isEmpty(str)) {
        break label127;
      }
      localImageView.setImageDrawable(beyq.a(str, null, null));
    }
    for (;;)
    {
      ...
      return paramVarArgs;
      label106:
      if (this.jdField_a_of_type_Aivv.jdField_a_of_type_Int != 2) {
        break;
      }
      paramVarArgs.setBackgroundResource(2131165878);
      break;
      label127:
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aivv = paramVarArgs;
    } while (!this.jdField_a_of_type_Aiwh.a(this, new Object[0]));
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "school", "school.aio.tips.show", 0, 0, "" + paramVarArgs.jdField_d_of_type_Int, "", "", "");
    return;
    if (QLog.isColorLevel()) {
  ...
  public void onClick(View paramView)
  {
    Object localObject2;
    Object localObject1;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1008) && (this.jdField_a_of_type_Aivv != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aivv.jdField_c_of_type_JavaLangString)))
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PubAccountTips", 2, "clickedTimes:" + (this.jdField_a_of_type_Aivv.e + 1));
        }
        aivv localaivv = this.jdField_a_of_type_Aivv;
        int i = localaivv.e + 1;
        localaivv.e = i;
        if (i < this.jdField_a_of_type_Aivv.jdField_c_of_type_Int) {
          break label325;
        }
        a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "" + this.jdField_a_of_type_Aivv.jdField_a_of_type_Long, this.jdField_a_of_type_Aivv, null);
    ...
    for (;;)
    {
      ...
      ((Intent)localObject2).putExtra("url", this.jdField_a_of_type_Aivv.jdField_c_of_type_JavaLangString);
      ((Context)localObject1).startActivity((Intent)localObject2);
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "school", "school.aio.tips.click", 0, 0, "" + this.jdField_a_of_type_Aivv.jdField_d_of_type_Int, "", "", "");
      ...
      try
      {
        this.jdField_a_of_type_Aivv.jdField_a_of_type_OrgJsonJSONObject.put("clicked", this.jdField_a_of_type_Aivv.e);
        ((SharedPreferences.Editor)localObject2).putString((String)localObject1, this.jdField_a_of_type_Aivv.jdField_a_of_type_OrgJsonJSONObject.toString()).commit();
      }
