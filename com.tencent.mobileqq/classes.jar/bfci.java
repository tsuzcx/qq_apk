  ...
  implements Manager
{
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, oidb_0x6b6.SendFlowerReq paramSendFlowerReq, oidb_0x6b6.ThrowFlowerReq paramThrowFlowerReq, long paramLong, bfch parambfch)
  {
    if (parambfch == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b6. callback=" + parambfch);
      }
      label37:
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if (nmy.a().a(paramString2))
          {
            paramThrowFlowerReq = new oidb_0x6b6.AnonymousGroupMsg();
            paramString2 = nmy.a().a(paramString2);
          ...
          if (paramSendFlowerReq != null)
          {
            paramString2 = ((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).getMsgCache().n(String.valueOf(paramSendFlowerReq.uint64_to_uin.get()));
            if (paramString2 != null) {
              localReqBody.msg_tmp_msg_token.buf.set(ByteStringMicro.copyFrom(paramString2), true);
            }
          }
          if ((paramInt3 >= 4) && (System.currentTimeMillis() - awng.jdField_a_of_type_Long < 600000L))
          {
            paramString2 = new oidb_0x6b6.GPSInfo();
            paramString2.int32_gps_type.set(1, true);
            paramString2.int64_longitude.set(awng.jdField_a_of_type_ArrayOfLong[0], true);
            paramString2.int64_latitude.set(awng.jdField_a_of_type_ArrayOfLong[1], true);
          ...
          nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcj(this, parambfch), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
      ...
      else
      {
        ...
        if (paramInt3 == 8)
        {
          ...
          if (paramSendFlowerReq != null)
          {
            paramString2 = ((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).getMsgCache().k(String.valueOf(paramSendFlowerReq.uint64_to_uin.get()));
            if (paramString2 != null)
            {
              localReqBody.msg_tmp_msg_token.buf.set(ByteStringMicro.copyFrom(paramString2), true);
              continue;
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, bfch parambfch)
  {
    if (parambfch == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c3. troopUin is null. callback=" + parambfch);
      }
      return;
    }
    ...
    for (paramGetStockReq = paramGetStockReq.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramGetStockReq = "")
    {
      ...
      nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcl(this, parambfch), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramGetStockReq, paramLong);
      return;
    }
  }
  
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, long paramLong, bfch parambfch)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (parambfch == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c2. troopUin=" + paramString1 + " giftBagID=" + paramString2 + " callback=" + parambfch);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcn(this, parambfch, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfco(this, parambfch), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(bfch parambfch)
  {
    ...
    nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfck(this, parambfch), localReqBody.toByteArray(), "OidbSvc.0xcd1_0", 3281, 0, null, 0L);
  }
  
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, bfch parambfch)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)) || (parambfch == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b5. troopUin=" + paramString2 + " giftBagID=" + paramString3 + " callback=" + parambfch);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcm(this, parambfch, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public TroopGiftBagInfo a(String paramString1, String paramString2, bfch parambfch)
  {
    ...
    a(paramString1, paramString2, 0, 0, 1000L, parambfch);
    return null;
  }
  ...
  public void a(int paramInt, bfch parambfch)
  {
    if (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    ...
    nmb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcq(this, parambfch), localReqBody.toByteArray(), "OidbSvc.0x9e9_0", 2537, 0);
  }
  
  public void a(bfch parambfch)
  {
    if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, int paramInt6, int paramInt7, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, 0, null, localThrowFlowerReq, 0L, parambfch);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, long paramLong, int paramInt6, int paramInt7, int paramInt8, int paramInt9, bfch parambfch, int paramInt10)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, paramInt9, localSendFlowerReq, null, 0L, parambfch);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, int paramInt5, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, null, localGetExtraDataReq, 0L, parambfch);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, bfch parambfch)
  {
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, false, false, parambfch);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, localGetStockReq, null, 0L, parambfch);
      return;
    }
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
      QLog.e(".troop.send_gift .troop.send_gift", 2, "grabGift. troopUin:" + paramString2 + " bagID:" + paramString3);
    }
    b(paramString1, paramInt1, paramInt2, paramString2, paramString3, paramLong, parambfch);
  }
  
  public void a(String paramString, bfch parambfch)
  {
    try
    {
      ...
      nmb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcr(this, parambfch), paramString.toByteArray(), "OidbSvc.0xa48_1", 2632, 1, new Bundle(), 6000L);
      return;
    }
    catch (Exception paramString)
    {
      parambfch.a(-1, "troop uin error");
    }
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramString2, paramInt1, paramInt2, 0, paramLong, parambfch);
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "reportInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, paramInt2, paramInt1, 3, parambfch);
  }
  
  public void a(String paramString1, String paramString2, int paramInt, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "chechInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 1, parambfch);
  }
  
  public void a(zsy paramzsy, int paramInt, String paramString, long paramLong, bfch parambfch)
  {
    if ((paramzsy == null) || (parambfch == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localReqBody.product_id.set(paramzsy.jdField_a_of_type_Int, true);
      localReqBody.amount.set(paramzsy.f, true);
      ...
      try
      {
        ...
        nmb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bfcp(this, parambfch, paramzsy), localReqBody.toByteArray(), "OidbSvc.0xdad_" + paramInt, 3501, paramInt, paramString, 0L);
        return;
      }
      catch (NumberFormatException paramzsy) {}
    } while (!QLog.isColorLevel());
  ...
  public void b(String paramString1, String paramString2, int paramInt, bfch parambfch)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "startInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 2, parambfch);
  }
