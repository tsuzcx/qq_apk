...
public class bfci
{
  ...
  {
    bdmc.a(BaseApplication.getContext()).a(null, paramString, this.jdField_b_of_type_Boolean, this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, paramHashMap, "");
    String str;
    ...
    {
      bdmc.a(BaseApplication.getContext()).a(null, paramString + "_ipv6", this.jdField_b_of_type_Boolean, this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, paramHashMap, "");
      if (QLog.isColorLevel())
      {
