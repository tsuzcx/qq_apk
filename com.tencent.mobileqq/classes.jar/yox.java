...
public class yox
{
  public static int a(Context paramContext, GdtAppBtnData paramGdtAppBtnData)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        return -1;
        localDownloadInfo = bccu.a().b(paramGdtAppBtnData);
  ...
  {
    ajsi.a("scheme", paramString1, paramString2, "4", "gdtAppAd", paramContext.getClass().getName());
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject5 = bcax.a(str);
        localObject4 = (String)((HashMap)localObject5).get("appid");
        localObject1 = localObject4;
        localObject3 = str;
        if (TextUtils.isEmpty((CharSequence)localObject4))
        {
          localObject1 = (String)((HashMap)localObject5).get(bcgl.b);
          localObject3 = str;
        }
        str = bcax.f() + File.separator + "qapp_center_detail.htm";
        ...
        if ("1".equals((String)bcax.a(paramBundle.getString("schemaUrl")).get("auto_download")))
        {
          localObject3 = localObject1;
      ...
      continue;
      label456:
      localObject2 = bcax.l() + File.separator + "qapp_center_detail.htm";
      continue;
      label487:
  ...
  public static void a(GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    {
      ((ynz)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(110)).a(BaseApplicationImpl.getContext(), paramGdtBaseAdItem);
  ...
  {
    return badq.h(BaseApplicationImpl.getContext());
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      localDownloadInfo = bccu.a().c(paramString);
      if (localDownloadInfo == null)
      {
  ...
  public static int b(Context paramContext, GdtAppBtnData paramGdtAppBtnData)
  {
    ...
    do
    {
      ...
      paramContext = bccu.a().b(paramGdtAppBtnData);
  ...
  public static boolean b(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    try
    {
      ...
      bool2 = true;
      bool1 = bool3;
      yoo.a(138, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
      bool1 = bool3;
      a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
      bool1 = bool3;
      yny.a("GdtAppOpenUtil", "launchAPPMain report " + paramGdtBaseAdItem.toString());
      bool1 = bool2;
      return bool1;
    }
    catch (Exception paramContext)
    {
      yny.d("GdtAppOpenUtil", "launchApp failed", paramContext);
    }
    return bool1;
  }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localDownloadInfo = bccu.a().b(paramString);
        bool2 = bool1;
  ...
  private static boolean c(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (a(paramContext, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramGdtBaseAdItem.c))
    {
      ...
      try
      {
        ...
        bool2 = true;
        bool1 = bool3;
        yoo.a(137, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
        bool1 = bool3;
        a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
        bool1 = bool3;
        yny.a("GdtAppOpenUtil", "launchAPPDeepLink report " + paramGdtBaseAdItem.toString());
        bool1 = bool2;
        return bool1;
      }
      catch (Exception paramContext)
      {
        yny.d("GdtAppOpenUtil", "launchAPPDeepLink failed", paramContext);
        return bool1;
      }
    }
    yny.a("GdtAppOpenUtil", "launchAPPDeepLink isDLURISupported false");
    return false;
  }
}
