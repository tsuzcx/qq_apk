  ...
  implements ymm
{
  ...
  ynm jdField_a_of_type_Ynm = null;
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            this.jdField_a_of_type_Ymk.b(paramString, (String)localObject);
            return;
          }
        }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("anonymousNickChanged".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Ymk.a(paramString1, l, i, paramString2, j, paramString3, this);
        return true;
      }
    ...
    for (;;)
    {
      ...
      if ("cleanDynamicRedPoint".equals(paramString3)) {
        try
        {
          ...
          this.jdField_a_of_type_Ymk.c(paramJsBridgeListener, this);
          return true;
        }
        catch (JSONException paramJsBridgeListener)
        {
      ...
      else if ("getTroopBarPublishInfo".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Ymk.a(new ymp(this, paramJsBridgeListener));
        }
        catch (JSONException paramJsBridgeListener)
        {
          paramJsBridgeListener.printStackTrace();
      ...
      else
      {
        if (("createVideoAndSend".equals(paramString3)) || ("prepareVideoResources".equals(paramString3))) {
          try
          {
            ...
            if (this.jdField_a_of_type_Ynm == null) {
              this.jdField_a_of_type_Ynm = new ynm((BaseActivity)this.mRuntime.a());
            }
            localObject2 = this.jdField_a_of_type_Ynm;
            localObject2.getClass();
            localObject2 = new ynw((ynm)localObject2);
            ((ynw)localObject2).jdField_a_of_type_JavaLangString = paramString1;
            ((ynw)localObject2).b = ((String)localObject1);
            ((ynw)localObject2).c = paramString2;
            ((ynw)localObject2).jdField_a_of_type_Int = i;
            i = 0;
            while (i < paramVarArgs.length())
            {
              paramString1 = paramVarArgs.getString(i);
              ((ynw)localObject2).jdField_a_of_type_JavaUtilArrayList.add(paramString1);
              i += 1;
            }
            if ("createVideoAndSend".equals(paramString3)) {
              this.jdField_a_of_type_Ynm.a((ynw)localObject2, new ymq(this, paramJsBridgeListener));
            } else {
              this.jdField_a_of_type_Ynm.a((ynw)localObject2, new ymr(this, paramJsBridgeListener));
            }
          }
        ...
        else if (("enableShortVideoPublish".equals(paramString3)) && (paramVarArgs.length == 1))
        {
          try
          {
            ...
            paramJsBridgeListener.put("enableShortVideoPublish", axld.a());
            if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Ynm = null;
  }
}
