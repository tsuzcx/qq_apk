...
public final class bhao
{
  ...
  public static <T> void a(WebView paramWebView, bhat<T> parambhat)
  {
    ...
    if (paramWebView == null)
    {
      ...
      parambhat.a(new NullPointerException("mWebView is null"));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      parambhat.a(new NullPointerException("context is null"));
      return;
    }
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    localObject1 = new ayvn((Context)localObject1);
    ((ayvn)localObject1).a(anvx.a(2131698788));
    ((ayvn)localObject1).a(true);
    ((ayvn)localObject1).a(new bhap(localAtomicBoolean, (ayvn)localObject1));
    ((ayvn)localObject1).show();
    ...
    Object localObject2 = new bhaq((ayvn)localObject1);
    ...
    ((ayvn)localObject1).setOnDismissListener(new bhar((AnimatorSet)localObject2));
    a(paramWebView, new bhas(localAtomicBoolean, (ayvn)localObject1, parambhat, paramWebView, (AnimatorSet)localObject2));
  }
  
  public static void a(WebView paramWebView, bhau parambhau)
  {
    if ((paramWebView == null) || (parambhau == null)) {}
    int i;
    int j;
    Bitmap localBitmap;
    do
            ...
            try
            {
              ...
              try
              {
                if (jdField_a_of_type_JavaLangReflectMethod != null) {
                  jdField_a_of_type_JavaLangReflectMethod.invoke(paramWebView.getX5WebViewExtension(), new Object[] { localBitmap, Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Integer.valueOf(1), Integer.valueOf(1), new ScreenShotUtil.1(parambhau, localBitmap) });
                }
                i = 1;
              }
  ...
  public static <T> boolean a(WebView paramWebView, bhat<T> parambhat)
  {
    ...
    for (;;)
    {
      ...
      if ((i <= 0) || (j <= 0) || (k <= 0))
      {
        ...
        parambhat.a(new IllegalStateException("measuredWidth <= 0 || contentWidth <= 0 || contentHeight <= 0"));
        return false;
      }
      float f = i / j;
      j = (int)(k * f);
      if (j > 20000)
      {
        ...
        parambhat.a(new IllegalStateException(anvx.a(2131718330)));
        return false;
      }
      try
      {
        ...
        if (localBitmap != null)
        {
          Canvas localCanvas = new Canvas(localBitmap);
          localCanvas.scale(f, f);
          ThreadManagerV2.executeOnNetWorkThread(new ScreenShotUtil.2(paramWebView, localCanvas, parambhat, localBitmap));
          return true;
        }
      }
