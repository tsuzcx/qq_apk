...
public class bhao
  implements bhae
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bhaq(this);
  ...
  public void a(VConsoleView paramVConsoleView, VConsoleDragView paramVConsoleDragView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWebkitWebView.setWebViewClient(new bhap(this));
