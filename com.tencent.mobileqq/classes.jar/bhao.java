...
public class bhao
  implements bbzl, bbzu
{
  private static bhao jdField_a_of_type_Bhao;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  public bbzm a;
  private bhqq jdField_a_of_type_Bhqq;
  private String jdField_a_of_type_JavaLangString = mtt.a(BaseApplicationImpl.getContext());
  ...
  public static bhao a()
  {
    if (jdField_a_of_type_Bhao == null) {}
    try
    {
      if (jdField_a_of_type_Bhao == null) {
        jdField_a_of_type_Bhao = new bhao();
      }
      return jdField_a_of_type_Bhao;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = mtt.a(BaseApplicationImpl.getContext());
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        bcpw.a(BaseApplicationImpl.getContext(), ajyc.a(2131713277), 1);
      }
    }
    while (this.jdField_a_of_type_Bbzm == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Bbzm.f = paramInt;
    bbzp.b(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Bbzm, this.jdField_a_of_type_JavaLangString, this);
  }
  ...
  public void a(Intent paramIntent, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Bbzm = new bbzm(this.jdField_b_of_type_JavaLangString, i, j, k, 0);
      switch (paramInt)
      {
      default: 
        return;
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bhqq.a(this.c, localStringBuilder.toString());
      return;
    }
  ...
  public void a(String paramString, int paramInt, bhqq parambhqq)
  {
  ...
  public void a(String paramString, bhqq parambhqq)
  {
  ...
  public void b(String paramString, int paramInt, bhqq parambhqq)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = mtt.a(BaseApplicationImpl.getContext());
      ...
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        bcpw.a(BaseApplicationImpl.getContext(), ajyc.a(2131713278), 1);
      }
      return;
    }
    QZLog.d("RecordAndChangeVoiceService", 2, "getMoodVoiceData callback" + paramString + " voiceID " + paramInt);
    this.c = paramString;
    this.jdField_a_of_type_Bhqq = parambhqq;
    bbzp.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Bbzm, this.jdField_a_of_type_JavaLangString, this);
    bbzp.a(this.jdField_b_of_type_JavaLangString, this);
  }
  ...
  public void e()
  {
    ...
    this.c = null;
    this.jdField_a_of_type_Bbzm = null;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Long = -1L;
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Bhqq = null;
  }
}
