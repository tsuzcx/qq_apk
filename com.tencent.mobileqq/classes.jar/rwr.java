...
public class rwr
{
  ...
  public rwr(Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity != null) && (this.jdField_a_of_type_AndroidAppActivity.getIntent() != null))
        {
          ...
          ocd.b(null, null, "0X80087C7", "0X80087C7", 0, 0, String.valueOf(0), "", "", new sbg(odr.a(localJSONObject)).N(paramInt).a().a(), false);
          return;
          paramInt = 1;
          continue;
          paramInt = 2;
  ...
  public void a(int paramInt, BaseArticleInfo paramBaseArticleInfo, long paramLong1, long paramLong2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        i = j;
        if ((i != 0) && (this.jdField_a_of_type_Rws != null))
        {
          if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_Rws.a(this.jdField_a_of_type_Boolean, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo);
        }
      }
      if (paramInt != 0) {
        break label347;
