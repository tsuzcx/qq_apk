...
public class ajbi
{
  ...
  public static ajbi a(SharedPreferences paramSharedPreferences, int paramInt)
  {
    ...
    ajbi localajbi = new ajbi();
    localajbi.jdField_a_of_type_Long = paramSharedPreferences.getLong(str1, 0L);
    if (DateUtils.isToday(localajbi.jdField_a_of_type_Long)) {
      try
      {
        ...
        {
          localajbi.a(paramSharedPreferences.getString(paramInt), paramSharedPreferences.getInt(paramInt + 1));
          paramInt += 2;
          continue;
          localajbi.jdField_a_of_type_Long = System.currentTimeMillis();
        }
      }
  ...
  public static void a(SharedPreferences paramSharedPreferences, ajbi paramajbi, int paramInt)
  {
    paramajbi.a();
    Object localObject = new JSONArray();
    Iterator localIterator = paramajbi.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
    ...
    if (paramInt == 2)
    {
      ...
      paramSharedPreferences.putLong("web_uin_list_time_millis", paramajbi.jdField_a_of_type_Long);
    }
    for (;;)
    {
      ...
      paramSharedPreferences.putLong("bless_uin_list_time_millis", paramajbi.jdField_a_of_type_Long);
    }
  }
