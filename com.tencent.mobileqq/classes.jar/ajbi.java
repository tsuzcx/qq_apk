  ...
  extends ajbn
{
  ...
  public ajbi(MessageForSystemMsg paramMessageForSystemMsg)
  {
  ...
  public ajbi(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
        ...
        if (!TextUtils.isEmpty(paramStructMsg.msg.msg_qna.get()))
        {
          ...
          if (bool)
          {
            ...
            if (!TextUtils.isEmpty(str)) {
              paramStructMsg = paramContext.getString(2131693279) + paramContext.getString(2131693278) + str;
            }
          }
        }
      }
      for (;;)
      {
        ...
        if (bool)
        {
          paramStructMsg = str;
          if (!TextUtils.isEmpty(str)) {
            paramStructMsg = paramContext.getString(2131693277) + paramContext.getString(2131693278) + str;
          }
        }
      }
    }
