  ...
  extends alxy
{
  ...
  public alxt(QSecLibMgr paramQSecLibMgr)
  {
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      this.b = true;
      alxv localalxv = (alxv)QSecLibMgr.a(this.jdField_a_of_type_ComTencentQqprotectQsecQSecLibMgr).get(Integer.valueOf(paramInt1));
      if (localalxv == null) {
        break label236;
      }
      QSecLibMgr.a(this.jdField_a_of_type_ComTencentQqprotectQsecQSecLibMgr, localalxv, paramString2, paramString1);
      if (localalxv.d == 0) {
        break;
      }
      QSecLibMgr.a(this.jdField_a_of_type_ComTencentQqprotectQsecQSecLibMgr).remove(Integer.valueOf(localalxv.jdField_a_of_type_Int));
      return;
