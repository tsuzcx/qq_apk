...
public class bozp
  implements bowo<bown>
{
  private final int jdField_a_of_type_Int = bpdd.b(DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  private bozp(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bown parambown, MotionEvent paramMotionEvent)
  {
    boolean bool = true;
    if ((parambown instanceof bovr)) {
      localRect = new Rect();
    }
    for (Rect localRect = ((bovr)parambown).a(localRect);; localRect = null)
    {
      if (LiuHaiUtils.b()) {}
      for (float f1 = LiuHaiUtils.e;; f1 = 0.0F)
      {
        float f2 = f1;
        if (blhi.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext())) {
          f2 = f1 + blhi.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext());
        }
        ...
        case 6: 
          do
          {
            ...
            if (DoodleLayout.d(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) {
              bovj.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
            }
            ...
            parambown = this.jdField_a_of_type_AndroidGraphicsRect;
            parambown.top -= this.jdField_a_of_type_Int;
            parambown = this.jdField_a_of_type_AndroidGraphicsRect;
            parambown.bottom += this.jdField_a_of_type_Int;
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            else if ((parambown instanceof bowd))
            {
              this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setTrackerState(((bowd)parambown).a(), 0);
              ((bowd)parambown).c();
            }
          }
          label926:
          DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout).a.a(Message.obtain(null, 15, 0, 0, new bots(false, false, false, false, true)));
          break label714;
          label963:
          bool = false;
        }
