...
public class avuo
{
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bdkz.a(paramInt1, paramString, paramInt2);
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a(bdbk.a(this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow, paramView.getContext(), this.jdField_a_of_type_Bdkz, this.jdField_a_of_type_AndroidViewView$OnClickListener, true));
