  ...
  implements azug
{
  ...
  public void a(azue paramazue, azuf paramazuf)
  {
    if (((paramazue instanceof SilkCodecWrapper)) || ((paramazue instanceof AmrInputStreamWrapper))) {
      this.b += (int)QQRecorder.a(this.jdField_a_of_type_Int, 4, 2, paramazuf.jdField_a_of_type_Int);
    }
  }
  ...
  public boolean a(Context paramContext, String paramString1, int paramInt, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    try
    {
      ...
      if (paramInt != 0) {
        this.jdField_a_of_type_Azui.a(new VoiceChange(paramContext, paramInt, paramString2));
      }
      if (paramRecorderParam.c == 0) {
        this.jdField_a_of_type_Azui.a(new AmrInputStreamWrapper(paramContext));
      }
      for (;;)
      {
        this.jdField_a_of_type_Azui.a(paramRecorderParam.jdField_a_of_type_Int, paramRecorderParam.b, paramRecorderParam.c);
        ...
        paramContext = bgrn.a(paramRecorderParam.c, paramRecorderParam.jdField_a_of_type_Int);
        ...
        return true;
        this.jdField_a_of_type_Azui.a(new SilkCodecWrapper(paramContext));
      }
      return false;
    }
  ...
  public boolean a(byte[] paramArrayOfByte, int paramInt)
  {
    try
    {
      if (this.jdField_a_of_type_Azui != null)
      {
        paramArrayOfByte = this.jdField_a_of_type_Azui.a(paramArrayOfByte, 0, paramInt);
