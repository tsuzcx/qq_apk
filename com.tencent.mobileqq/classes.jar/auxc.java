...
public class auxc
{
  ...
  public auxc(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, long paramLong)
  {
  ...
  public void a(int paramInt1, int paramInt2, Bundle paramBundle)
  {
    if (paramInt1 >= paramInt2)
    {
      if (QLog.isColorLevel()) {
        QLog.e(auxd.jdField_a_of_type_JavaLangString, 2, new Object[] { "revoke msg UniteGrayTipParam addHightlightItem start >= end error,start=", Integer.valueOf(paramInt1), ",end=", Integer.valueOf(paramInt2) });
      }
      return;
    }
    ...
    for (;;)
    {
      ...
      QLog.e(auxd.jdField_a_of_type_JavaLangString, 2, "getHightlightMsgText ==>NumberFormatException");
      return;
      label696:
  ...
  public boolean a()
  {
    boolean bool = acwh.j(this.jdField_c_of_type_Int);
