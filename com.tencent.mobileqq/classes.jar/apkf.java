...
public class apkf
  extends apib<CustomEmotionData>
{
  public int a;
  private alnn jdField_a_of_type_Alnn = new apkh(this);
  private apjr jdField_a_of_type_Apjr;
  public apns a;
  private apnt jdField_a_of_type_Apnt = new apkj(this);
  public batw a;
  protected baua a;
  WeakReference<baub> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public apkf(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_a_of_type_JavaUtilMap = new HashMap();
    this.jdField_a_of_type_Baua = new apkg(this, ThreadManager.getSubThreadLooper());
    this.jdField_a_of_type_Apns = new apki(this);
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (i > 144) {
        apkc.jdField_a_of_type_Int = i;
      }
    }
  }
  
  public static apkf a(QQAppInterface paramQQAppInterface)
  {
    return (apkf)paramQQAppInterface.getManager(103);
  }
  ...
  private String a(String paramString)
  {
    ...
    return String.format(BaseApplicationImpl.getApplication().getString(2131692058), new Object[] { str });
  }
  
  private void a(String paramString, apjr paramapjr)
  {
    ...
    if (localList != null)
    {
      ...
      for (int i = 1;; i = k)
      {
        ...
        if ((str != null) && (str.equals(localCustomEmotionData.md5)))
        {
          ...
          {
            ((apke)localObject).a(localCustomEmotionData, j);
            if (paramapjr != null) {
              paramapjr.a(0, str);
            }
          }
          while (paramapjr == null) {
            return;
          }
          paramapjr.a(1, str);
          return;
    ...
    paramString = new apjn(localQQAppInterface, null, (CustomEmotionData)localObject, null, 2);
    paramString.a(paramapjr);
  ...
  private void i()
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size())
    {
      ...
      {
        apkn localapkn = (apkn)((WeakReference)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i)).get();
        if (localapkn != null) {
          localapkn.a(j);
        }
      }
  ...
  {
    int i = 0;
    if ((paramList == null) || (paramList.size() == 0) || (!bdee.d(BaseApplication.getContext()))) {
      return 0;
    }
    Object localObject = paramList;
    if (paramList.size() > apkc.jdField_a_of_type_Int)
    {
      j = paramList.size() - apkc.jdField_a_of_type_Int;
      localObject = paramList.subList(j, apkc.jdField_a_of_type_Int + j);
    }
  ...
  protected ally<CustomEmotionData> a()
  {
    return (alnm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
  }
  
  protected aphz<CustomEmotionData> a()
  {
    return (apke)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149);
  }
  
  public baub a(CustomEmotionData paramCustomEmotionData, awfy paramawfy)
  {
    ...
    localbaub.jdField_c_of_type_Int = 9;
    localbaub.jdField_a_of_type_JavaLangString = "scbqmanyou";
    ...
    {
      b(paramCustomEmotionData, localbaub);
      return localbaub;
    }
    a(paramCustomEmotionData, localbaub);
    return localbaub;
  }
  ...
  public void a(CustomEmotionData paramCustomEmotionData, baub parambaub)
  {
    int j = 1;
    int i = 1;
    if ((paramCustomEmotionData == null) || (parambaub == null)) {
      return;
    }
    ...
    Object localObject = alpc.a(paramCustomEmotionData.emoPath);
    if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).contains("qto_")))
    {
      ...
      j = alpc.a(paramCustomEmotionData.eId);
      if (j != 0) {
        break label352;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        parambaub.jdField_a_of_type_ArrayOfByte = localExtensionExpRoamTryUp.toByteArray();
        parambaub.jdField_a_of_type_Long = paramCustomEmotionData.emoId;
        parambaub.i = paramCustomEmotionData.emoPath;
        if (this.jdField_a_of_type_Batw == null) {
          break;
        }
        this.jdField_a_of_type_Batw.a(parambaub);
        return;
        localObject = almy.a(paramCustomEmotionData.emoPath);
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    do
    {
      return;
      localalnm = (alnm)a();
    } while (localalnm == null);
    localalnm.a(paramCustomEmotionData, paramString);
  }
  ...
  public void a(CustomEmotionData paramCustomEmotionData, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((localObject != null) && (paramBoolean))
      {
        ...
        ((apke)localObject).b(paramCustomEmotionData);
      }
      for (;;)
      {
        i = 0;
        while (i < this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size())
        {
          if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i) != null)
          {
            localObject = (apkn)((WeakReference)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i)).get();
            if (localObject != null) {
              ((apkn)localObject).a(paramCustomEmotionData, this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
            }
          }
          i += 1;
        }
  ...
  public void a(String paramString)
  {
    ...
    apne.a().a(this.jdField_a_of_type_Apnt);
    ((apnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43)).a(paramString, apnf.jdField_c_of_type_Int, null, false);
  }
  ...
  public void a(List<String> paramList, apkl paramapkl)
  {
    if (paramList == null) {}
    int i;
    do
    ...
    ThreadManager.excute(new FavroamingManager.8(this, i, paramapkl, paramList), 64, null, true);
  }
  
  public baub b(CustomEmotionData paramCustomEmotionData, awfy paramawfy)
  {
    return a(paramCustomEmotionData, paramawfy);
  }
  ...
  public void b(CustomEmotionData paramCustomEmotionData, baub parambaub)
  {
    if ((paramCustomEmotionData == null) || (parambaub == null)) {
      return;
    }
    ...
    try
    {
      ...
      parambaub.jdField_a_of_type_ArrayOfByte = localExtensionExpRoamTryUp.toByteArray();
      parambaub.jdField_a_of_type_Long = paramCustomEmotionData.getId();
      paramCustomEmotionData = apnf.a(paramCustomEmotionData.emoPath, paramCustomEmotionData.eId, false);
      parambaub.i = paramCustomEmotionData[1];
      ThreadManager.post(new FavroamingManager.7(this, paramCustomEmotionData, parambaub), 5, null, true);
      return;
    }
  ...
  public void c()
  {
    ...
    {
      return;
      localalnm = (alnm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
    } while (localalnm == null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Alnn);
    ThreadManager.excute(new FavroamingManager.3(this, localalnm), 128, null, true);
  }
  ...
  public void c(CustomEmotionData paramCustomEmotionData)
  {
    ...
    a().b(paramCustomEmotionData);
    agug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).h();
  }
  ...
  public void d()
  {
    ...
    do
    {
      ...
      localObject2 = ((apke)localObject1).b("needDownload");
      localObject3 = ((apke)localObject1).b("overflow");
  ...
  public void e()
  {
    ...
    {
      baub localbaub = (baub)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbaub != null) {
  ...
  public void h()
  {
    ...
    {
      return;
      localObject = (apke)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149);
