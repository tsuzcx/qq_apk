  ...
  implements View.OnLongClickListener
{
  ...
  public baki(Activity paramActivity, bajk parambajk)
  {
    super(paramActivity, parambajk);
    this.jdField_a_of_type_Bajk = parambajk;
    if ((this.jdField_a_of_type_Bajk != null) && (this.jdField_a_of_type_Bajk.getRecyclerView() != null))
    {
      this.mScreenWidthPx = this.jdField_a_of_type_Bajk.getRecyclerView().getWidth();
      this.mScreenHeightPx = this.jdField_a_of_type_Bajk.getRecyclerView().getHeight();
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setOnDismissListener(new bakj(this));
    ...
    for (int i = ((AIOBrowserBaseData)((RichMediaBrowserInfo)localObject).baseData).b;; i = 0)
    {
      ...
      for (;;)
      {
        bcef.b(null, "dc00898", "", "", "0X8009EFB", "0X8009EFB", j, 0, String.valueOf(i), String.valueOf(k), String.valueOf(paramInt), "");
        return;
        if (paramInt == 1) {
          paramInt = 2;
        } else {
  ...
  {
    return this.jdField_a_of_type_Bajk.a(paramRichMediaBrowserInfo);
  }
  ...
  public boolean b()
  {
    return (!bais.a().c()) && (bais.a().a() != 1037) && (abwz.a(bais.a().a()) != 1044) && (abwz.a(bais.a().a()) != 1032) && (bais.a().c() != 3) && (bais.a().c() != 4) && (bais.a().h());
  }
  ...
  public boolean back()
  {
    ...
    if (bais.a().f())
    {
      RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bajk.getSelectedItem();
      if ((localRichMediaBrowserInfo != null) && ((localRichMediaBrowserInfo.baseData instanceof AIOBrowserBaseData)))
      {
        Intent localIntent = new Intent();
        localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", bakb.a((AIOBrowserBaseData)localRichMediaBrowserInfo.baseData));
  ...
  protected void c()
  {
    ...
    {
      RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bajk.getSelectedItem();
      bakd.a(this.mContext, bais.a().c(), bais.a().a(), localRichMediaBrowserInfo);
      this.mContext.getIntent().putExtra("extra.IS_STARTING_CHAT_FILE_HISTORY", true);
      this.mContext.overridePendingTransition(2130772295, 2130772236);
      if (i == 0) {
        this.mContext.finish();
      }
      this.jdField_a_of_type_Bajk.a.e();
      return;
    }
  }
  ...
  public void e()
  {
    ImmersionHelper localImmersionHelper = this.jdField_a_of_type_Bajk.a();
    ...
    if (localImmersionHelper.c) {
      this.jdField_a_of_type_Bajk.b(true);
    }
    this.jdField_a_of_type_Bajk.a().d();
    this.jdField_a_of_type_Bajk.f();
    this.jdField_a_of_type_Bajk.g();
  ...
  {
    this.jdField_a_of_type_Bajk.a().c();
  }
  ...
  public void g()
  {
    this.jdField_a_of_type_Bajk.a().b();
    this.jdField_a_of_type_Bajk.a().a = false;
    this.jdField_a_of_type_Bajk.a().a();
  }
  ...
  {
    if (((bais.a().d() == -3321) || (bais.a().d() == 1)) && (!bais.a().f())) {
      return false;
    }
    if (bais.a().e() == -2147483648) {
      return false;
    }
  ...
  public void onItemSelected(int paramInt)
  {
    if (!bais.a().b())
    {
      if (!this.jdField_a_of_type_Bajk.a()) {
        break label91;
      }
    ...
    for (;;)
    {
      ...
      return;
      int i = this.jdField_a_of_type_Bajk.getCount();
      if (bais.a().f())
      {
        if (i - paramInt <= 0) {
          break label234;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Int = this.jdField_a_of_type_Bajk.getCount();
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    if (82 == paramKeyEvent.getKeyCode()) {
      try
      {
        if (this.jdField_a_of_type_Bajk.getSelectedItem() != null)
        {
          a(3);
  ...
  {
    if (this.jdField_a_of_type_Bajk.a(this.jdField_a_of_type_Bajk.getCurrentPosition())) {
      this.jdField_a_of_type_Bajk.a();
    }
    b(true);
  }
  ...
  {
    if (this.jdField_a_of_type_Bajk.a(this.jdField_a_of_type_Bajk.getCurrentPosition())) {
      this.jdField_a_of_type_Bajk.a(false);
    }
    b(false);
  }
  ...
  {
    this.jdField_a_of_type_Bajk.showContentView(paramBoolean);
    if (paramBoolean) {
      f();
    }
  }
