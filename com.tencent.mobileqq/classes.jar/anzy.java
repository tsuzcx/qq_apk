...
public class anzy
{
  ...
  private ansy jdField_a_of_type_Ansy = new anzz(this);
  ...
  public anzy(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    ...
    if (aoxv.a((ProxyManager)localObject2, "mr_dataline_printer")) {
  ...
  {
    if (!ansr.a(paramSession, "printer")) {}
    Object localObject;
    do
    {
      do
      {
        ...
        ((PrinterItemMsgRecord)localObject).time = bcrg.a();
  ...
  public void a(ansr paramansr)
  {
    Object localObject = (aocn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER);
    if ((((aocn)localObject).a() == 0) || (((aocn)localObject).e() != 1))
    {
      paramansr.a(12, false, null);
      if (this.jdField_a_of_type_JavaUtilHashMap.size() > 0)
      {
        localObject = new Timer();
        ((Timer)localObject).schedule(new PrinterHandler.1(this, paramansr, (Timer)localObject), 5000L);
      }
    }
  }
  
  public void a(ansr paramansr, msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    boolean bool = false;
    int j;
    int i;
    ...
    case 2: 
      do
      {
        ...
        paramMsg = (aoab)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.PRINTER_STATUS_HANDLER);
        paramMsg.a(false);
      ...
      if ((((aocn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER)).a() != 0) && (this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
        paramMsg.a(true);
      }
      paramansr.a(12, false, null);
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004022", "0X8004022", 0, 0, "", "", "", "");
      return;
    case 3: 
      j = -1;
    ...
    for (;;)
    {
      ...
      paramansr.a(18, bool, Long.valueOf(l));
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)l, i, "", "", "", "");
      return;
      ...
      else
      {
        ...
        paramansr.notifyUI(19, true, new Object[] { Long.valueOf(paramMsg.uint64_printer_din.get()), paramMsg.str_printer_qr_pic_url.get(), paramMsg.str_printer_qr_open_url.get(), paramMsg.str_printer_tip_url.get() });
        return;
      }
      label581:
      l = 0L;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    if (auea.a())
    {
      if (FileUtils.getFileSizes(paramString) > atpj.a())
      {
        audn.a(paramBaseActivity, 2131692476, 2131692481, new aoaa(this, paramBaseActivity, paramString));
        return;
      }
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004059", "0X8004059", 0, 0, "", "", "", "");
      return;
    }
  ...
  public void a(PrinterItemMsgRecord paramPrinterItemMsgRecord)
  {
    ...
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)paramPrinterItemMsgRecord.uSessionID, -2, "", "", "", "");
  ...
  public String[] a()
  {
    if ((((aoab)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.PRINTER_STATUS_HANDLER)).a()) && (this.b != null))
    {
