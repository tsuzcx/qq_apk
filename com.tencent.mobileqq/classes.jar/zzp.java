  ...
  implements bcxg
{
  ...
  public zzp(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = zzo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bcxa(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bcwx)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bcxf)((bcxa)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bcxf)localObject1).a(this);
          ((bcxf)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
