...
{
  public static int a;
  private final akhm jdField_a_of_type_Akhm;
  ...
  public akou(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)paramViewGroup.findViewById(2131376038));
    this.jdField_a_of_type_ComTencentMobileqqFpsreportFPSSwipListView = ((FPSSwipListView)paramViewGroup.findViewById(2131376025));
    k();
    b();
    this.jdField_a_of_type_Akhm = new akov(this);
    akhn.a(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a).a(this.jdField_a_of_type_Akhm);
  }
  ...
  private void b(int paramInt1, int paramInt2)
  {
    if (this.jdField_b_of_type_Int != paramInt1)
    {
      ...
      bcef.b(null, "dc00898", "", "", "0X800A493", "0X800A493", 0, 0, "", "", "", "");
    ...
    for (;;)
    {
      ...
      {
        this.d = paramInt1;
        bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A8F9", paramInt1, 1, 0, "", "", "", "");
        return;
      }
    }
  }
      ...
      for (int i = ((RecentBaseData)localObject1).getUnreadNum();; i = 0)
      {
        ...
        if ((paramObject instanceof RecentUserBaseData))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 instanceof akoo))
            {
              i = 1;
              boolean bool = BaseApplicationImpl.getContext().getResources().getString(2131698750).equals(((RecentUserBaseData)localObject1).mContentDesc);
              if ((i == 0) && (!bool)) {
                break label150;
              }
              i = 1;
        ...
        for (;;)
        {
          ...
          return true;
          if ((localObject2 instanceof aknz))
          {
            ((aknz)localObject2).a();
            i = 0;
            break;
  ...
  private boolean c()
  {
    if ((!bjnm.a()) && (this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.f == 17)) {}
  ...
  private boolean c(Object paramObject)
  {
    if ((paramObject instanceof RecentUserBaseData))
    {
      ...
      if (paramObject.mUser.getType() == 1)
      {
        ...
        {
          paramObject = ((bese)localAppRuntime.getManager(363)).a(paramObject.mUser.uin, 100);
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_Bjng.post(local4);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bjng.post(local2);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1381653; paramView.getTag(2131374806) == null; i = 11580351)
      {
        paramView.setTag(2131374806, paramView.getBackground());
  ...
  public boolean a(akkk paramakkk)
  {
    boolean bool2 = false;
    int j = 0;
    boolean bool1 = bool2;
  ...
  public boolean a(Object paramObject)
  {
    ...
    label109:
    for (bool1 = alem.a((String)localObject + str);; bool1 = false)
    {
      boolean bool3 = BaseApplicationImpl.getContext().getResources().getString(2131716379).equals(((RecentUserBaseData)paramObject).mMsgExtroInfo);
      if (!bool1)
      {
        bool1 = bool2;
        if (!bool3) {}
  ...
  public void b()
  {
    ...
    akkk localakkk = this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a();
    int j = 0;
    int k = 0;
    int i = 0;
    if (j < localakkk.getCount())
    {
      Object localObject = localakkk.getItem(j);
      int m = k;
      int n = i;
      int i1;
      if ((localObject instanceof RecentBaseData))
  ...
  public boolean b()
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376041));
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376040));
  ...
  public void c()
  {
    String str;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.f == 17) {
      str = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getString(2131716380, new Object[] { Integer.valueOf(this.jdField_b_of_type_Int) });
    }
    for (int i = 2130839574;; i = 2130847390)
    {
      ...
      return;
      str = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getString(2131698722, new Object[] { Integer.valueOf(this.c) });
    }
  }
  ...
  public void e()
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131376037);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376041);
    if (bool)
    {
      localLinearLayout.setBackgroundResource(2130849472);
      localTextView.setTextColor(Color.parseColor("#ee7f31"));
      return;
    }
    localLinearLayout.setBackgroundResource(2130850612);
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      float f1 = BaseApplication.context.getResources().getDimension(2131298447);
  ...
  public void h()
  {
    akhn.a(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a).b(this.jdField_a_of_type_Akhm);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.c > 0) {
        bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A8FA", this.d, 1, 0, "", "", "", "");
      }
    }
  }
}
