  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    if (akot.a(this.a))
    {
      ...
      akot.a(this.a, String.format(((NewPhotoPreviewActivity)this.a.mActivity).getString(2131689749), new Object[] { Integer.valueOf(akot.a(this.a).maxSelectNum) }));
    }
    for (;;)
    {
      ...
      localIntent.putStringArrayListExtra("PhotoConst.SELECTED_PATHS", akot.b(this.a).selectedPhotoList);
