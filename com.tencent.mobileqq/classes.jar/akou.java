...
public class akou
  implements Runnable
{
  public akou(SwiftBrowserLongClickHandler paramSwiftBrowserLongClickHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localObject == null) {
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new akov(this));
    }
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_b_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new akow(this));
        return;
      }
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new akox(this));
  }
}
