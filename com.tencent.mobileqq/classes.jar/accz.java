...
public final class accz
{
  ...
  public static accz a()
  {
    try
    {
      if (jdField_a_of_type_Accz == null) {
        jdField_a_of_type_Accz = new accz();
      }
      accz localaccz = jdField_a_of_type_Accz;
      return localaccz;
    }
    finally {}
  }
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString3, String paramString4)
  {
    ...
    {
      bcst.b(localQQAppInterface, "CliOper", "", paramString2, "SmartDevice", paramString1, paramInt1, paramInt2, str1, str2, paramAppRuntime, paramString3);
      return;
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, int paramInt2, String paramString2, long paramLong)
  {
    ...
    for (paramAppRuntime = "";; paramAppRuntime = paramString2)
    {
      ...
      bcst.b(localQQAppInterface, "CliOper", "", "" + paramLong, "SmartDevice", paramString1, paramInt1, 0, Long.toString(paramInt2), "", paramAppRuntime, "");
      return;
    }
  }
  ...
  public void b(AppRuntime paramAppRuntime, String paramString, int paramInt)
  {
    ...
    for (paramAppRuntime = "";; paramAppRuntime = this.jdField_a_of_type_JavaLangString)
    {
      ...
      bcst.b(localQQAppInterface, "CliOper", "", "0", "SmartDevice", paramString, 0, paramInt, Long.toString(this.jdField_a_of_type_Int), Long.toString(l), paramAppRuntime, "");
      return;
    }
    bcst.b(localQQAppInterface, "CliOper", "", "0", "SmartDevice", paramString, paramInt, 0, Long.toString(this.jdField_a_of_type_Int), Long.toString(l), paramAppRuntime, "");
  }
}
