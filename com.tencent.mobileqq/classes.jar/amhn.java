  ...
  extends BaseAdapter
{
  ...
  public amhn(Context paramContext, JSONArray paramJSONArray, aapk paramaapk)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Aapk = paramaapk;
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_Aapk != null)
      {
        this.jdField_a_of_type_Aapk.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) && (this.jdField_a_of_type_Boolean)) {
      paramView = this.jdField_a_of_type_Aapk.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
    }
    Object localObject;
    for (;;)
    {
      ...
      if (paramView != null) {
        ((View)localObject).setOnClickListener(new amhp(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        aapk.a((View)localObject, paramView.toString());
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new amho(this));
