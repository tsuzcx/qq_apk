...
public class biyk
{
  private static biyk jdField_a_of_type_Biyk;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new biyl(this));
  private biym jdField_a_of_type_Biym = new biym(this, null);
  private biyo jdField_a_of_type_Biyo;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private biyk(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Biym);
    }
  }
  
  public static biyk a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Biyk == null) {
      jdField_a_of_type_Biyk = new biyk(paramAppInterface);
    }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Biyk != null)
    {
      jdField_a_of_type_Biyk.b();
      jdField_a_of_type_Biyk = null;
    }
  }
  ...
  private void a(double paramDouble1, double paramDouble2, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), bhws.class);
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Biyo != null)
    {
      Object localObject = paramArrayList;
      if (paramArrayList == null) {
        localObject = new ArrayList(1);
      }
      this.jdField_a_of_type_Biyo.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Biym);
      this.jdField_a_of_type_ComTencentCommonAppAppInterface = null;
    }
    this.jdField_a_of_type_Biyo = null;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new biyn(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Biyo != null) {
          this.jdField_a_of_type_Biyo.a(paramInt, bool2);
        }
        return;
      }
  ...
  public void a(biyo parambiyo)
  {
    this.jdField_a_of_type_Biyo = parambiyo;
  }
}
