...
public class aavb
  implements acxw, IMemoryManager, MemoryManager.IReportListener, IAppStateChangeListener
{
  private static aavb jdField_a_of_type_Aavb;
  ...
  private Vector<aavc> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  {
    if (jdField_a_of_type_Aavb == null) {}
    try
    {
      if (jdField_a_of_type_Aavb == null) {
        jdField_a_of_type_Aavb = new aavb();
      }
      return jdField_a_of_type_Aavb;
    }
    finally {}
  }
  ...
  public void a()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", aoam.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", bdlm.a().a());
  ...
  public void a(int paramInt, aauy paramaauy)
  {
    aaux localaaux = MagnifierSDK.a().a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localaaux.jdField_a_of_type_Boolean + "configId" + localaaux.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramaauy.jdField_b_of_type_Int * localaaux.jdField_b_of_type_Int * 1000)) && (localaaux.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramaauy);
      return;
    }
    catch (Exception paramaauy)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramaauy);
    }
  }
  ...
  public void a(aavc paramaavc)
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramaavc);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", aoam.a());
  ...
  public void b(int paramInt, aauy paramaauy)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((aavc)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramaauy.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramaauy.a > 0.0F) && (paramaauy.a < 1.0F))
          {
            l4 = MemoryManager.getAvailClassSize() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramaauy.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramaauy.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramaauy.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramaauy = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramaauy.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramaauy.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramaauy = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramaauy.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramaauy.next();
              ...
              break label1465;
              label842:
              paramaauy = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramaauy.length < 2) {
                break label1522;
              }
              if ((paramaauy[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramaauy[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramaauy[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramaauy[1].toString());
              i1 = i2;
              break label1522;
            }
          }
    ...
    for (;;)
    {
      aauz.a(BaseApplicationImpl.class.getClassLoader());
  ...
  public void b(aavc paramaavc)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramaavc);
      return;
    }
  }
