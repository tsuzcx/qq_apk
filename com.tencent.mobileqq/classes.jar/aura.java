  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, DownloadListener
{
  ...
  final MqqHandler jdField_a_of_type_MqqOsMqqHandler = new blha(Looper.getMainLooper(), this, true);
  ...
  public aura(AppInterface paramAppInterface, Activity paramActivity, TouchWebView paramTouchWebView)
  {
  ...
  private void a(String paramString1, String paramString2, long paramLong, Activity paramActivity, AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(paramActivity.getApplicationContext(), awjk.class);
      ...
      paramString2.setObserver(new aurb(this, paramString1, paramLong, paramBoolean));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAppDialog == null)
      {
        ...
        this.jdField_a_of_type_AndroidAppDialog.setContentView(2131561929);
        this.jdField_a_of_type_AndroidAppDialog.findViewById(2131363400).setBackgroundColor(0);
        ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131378603)).setText(anzj.a(2131714669));
      }
  ...
  public void onDownloadStart(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong)
  {
    ...
    } while ((!auqy.a(localActivity, paramString1, (Bundle)localObject2)) || (!bool));
