  ...
  implements bayu
{
  ...
  public void a(String paramString)
  {
    ...
    boolean bool1 = auqx.a(auqx.a(paramString, "isNew"));
    boolean bool2 = auqx.a(auqx.a(paramString, "isInsert"));
    auqx.a(paramString, "title");
    auqx.a(auqx.a(paramString, "startDate")).longValue();
    auqx.a(auqx.a(paramString, "endDate")).longValue();
    if (bool1)
    {
      paramString = "0";
      if (!bool2) {
    ...
    for (String str = "0";; str = "1")
    {
      ...
      awqx.b(null, "CliOper", "", "", "Time_reminder", "Updata_clock", 0, 0, str, paramString, "", "");
      return;
      paramString = "1";
      break;
    }
  ...
  {
    long l = auqx.a(auqx.a(paramString, "currentDate")).longValue();
    auqx.a(this.jdField_a_of_type_AndroidAppActivity, l * 1000L, new aurb(this), paramJsBridgeListener);
  }
  ...
  public void b(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "startTime : " + aurc.a(1000L * l2) + " endTime : " + aurc.a(1000L * l3));
        }
        i = auqx.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject2, 1000L * l2, 1000L * l3, str1, str2, paramString);
      ...
      awqx.b(null, "CliOper", "", "", "Time_reminder", "Rec_ckl_add", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (("calendar".equals(paramString2)) && ("remindDelete".equals(paramString3)))
    {
      ...
      awqx.b(null, "CliOper", "", "", "Time_reminder", "Delete_clock", 0, 0, "", "", "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindMsgReport".equals(paramString3)))
    {
      ...
      awqx.b(null, "CliOper", "", "", "Time_reminder", "Obj_clock", 0, 0, auqx.a(paramVarArgs[0], "entranceType"), auqx.a(paramVarArgs[0], "role"), "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindAioReport".equals(paramString3)))
    {
      ...
      awqx.b(null, "CliOper", "", "", "Time_reminder", "Clock_card_clk", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
