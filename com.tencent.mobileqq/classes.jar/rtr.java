...
public class rtr
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        Object localObject = ((ajoy)localObject).b(paramString);
        if (localObject != null)
        {
        ...
        paramQQAppInterface = (ajhq)paramQQAppInterface.getManager(69);
        k = i;
  ...
  public static int a(String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      } else if ((localRecentUserBaseData.mUser.getType() == 1008) && (rol.b((QQAppInterface)obz.a(), localRecentUserBaseData.mUser.uin))) {
        ((Iterator)localObject2).remove();
      }
    }
    int i = 0;
  ...
  public static String a(ArticleInfo paramArticleInfo, oqi paramoqi)
  {
    ...
    for (;;)
    {
      return awbk.b(paramArticleInfo);
      label145:
      localObject1 = localObject2;
      ...
      paramoqi = ReadInJoyUserInfoModule.a(Long.valueOf(paramArticleInfo.msgBoxBriefPreFix).longValue(), paramoqi);
      if (paramoqi == null)
      {
        localObject1 = ReadInJoyUserInfoModule.a() + ": ";
        break;
      }
      localObject1 = paramoqi.nick + ": ";
      break;
        ...
        for (;;)
        {
          ...
          if (paramBaseArticleInfo.mTopicRecommendFeedsInfo != null)
          {
            ...
            if (paramBaseArticleInfo.mTopicRecommendFeedsInfo.a != null)
            {
              ...
              {
                localObject = ((prx)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c;
                str1 = ((prx)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_JavaLangString;
              }
            }
          }
  ...
  public static String a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localObject1 = baig.p(BaseApplicationImpl.getApplication(), str);
      if (localObject1 == null) {
        break label123;
      }
    }
    for (;;)
    {
      try
      {
        ...
        {
          paramString = mof.a(paramString, "_kdSkinID=" + localSkinData.id);
          if (baig.u(BaseApplicationImpl.getApplication(), str)) {
            localObject1 = mof.a(paramString, "_kdSkinVoice=1");
          }
        }
        else
        {
      ...
      return mof.a(paramString, "_kdSkinVoice=0");
      label123:
      Object localObject2 = null;
    }
  }
  ...
  public static NewIntent a(QQAppInterface paramQQAppInterface, Context paramContext, MqqHandler paramMqqHandler, String paramString)
  {
    ...
    //   36: ifnull +7 -> 43
    //   39: aload_2
    //   40: putstatic 399	rtr:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   43: ldc 2
    //   45: monitorexit
    ...
    //   130: dup
    //   131: aload_0
    //   132: invokespecial 458	rts:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, ProfileParams paramProfileParams)
  {
    ...
    for (;;)
    {
      ...
      localObject = new rtt(paramActivity, paramQQAppInterface, paramProfileParams);
      localObject = bfqn.a(paramQQAppInterface, paramProfileParams.a(), (ajfe)localObject);
      if (localObject != null)
      {
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    mqb.a(paramContext, paramIntent, paramString, false, -1, true, -1);
  }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    } while (!mnz.a(paramActivity, paramString));
    a(paramIntent, paramActivity, paramString, paramInt2, paramInt3);
    return;
    mqb.a(paramActivity, paramIntent, paramString, false, 5, true, paramInt2);
  }
  ...
  private static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      String str = obb.k + baaw.encodeToString(paramString.getBytes(), 0);
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        break;
      case -6: 
        if (!mnz.a(paramContext, paramString)) {
          break;
        }
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, ajpe paramajpe)
  {
    a(paramAppInterface, paramContext, paramString, paramajpe, true, 0);
  }
  
  @Deprecated
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, ajpe paramajpe, int paramInt)
  {
    ...
    localQQAppInterface.addObserver(new akig(new ruc(paramajpe, paramString, paramAppInterface, paramContext), localQQAppInterface));
    akil.a(localQQAppInterface, true, paramString, 0);
    if ((paramAppInterface instanceof QQAppInterface)) {
      paramAppInterface = (QQAppInterface)paramAppInterface;
    }
    for (;;)
    {
      ndn.a(paramAppInterface, paramString, 0);
      return;
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, ajpe paramajpe, boolean paramBoolean)
  {
    a(paramAppInterface, paramContext, paramString, paramajpe, paramBoolean, 0);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, ajpe paramajpe, boolean paramBoolean, int paramInt)
  {
    a(paramAppInterface, paramContext, paramString, paramajpe, paramBoolean, paramInt, false);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, ajpe paramajpe, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    if ((paramAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        paramajpe = new akig(new rty(paramajpe, paramString, paramAppInterface, paramContext, paramInt, paramBoolean1));
        paramContext = new PublicAccountIntent(paramContext.getApplicationContext(), akii.class);
        paramContext.a(paramajpe);
        ...
        return;
        localObject = (ajoy)paramAppInterface.getManager(56);
        if (localObject != null)
        {
          localObject = ((ajoy)localObject).a(paramString);
      ...
      {
        localObject = new NewIntent(paramContext.getApplicationContext(), ndt.class);
        ...
        try
        {
          ...
          ((NewIntent)localObject).setObserver(new rtz(paramajpe, paramString, paramBoolean1, paramContext, paramAppInterface, paramInt));
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser, int paramInt, RecentBaseData paramRecentBaseData)
  {
    ...
    vvy.a(paramActivity, 9004, paramRecentUser);
    if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    localbegr.a(paramContext.getResources().getString(2131630692));
    localbegr.a(2131625931, 3);
    if (paramString.equals("2010741172")) {
      localbegr.b(2131629852);
    }
    localbegr.c(2131625035);
    localbegr.a(new rtx(paramQQAppInterface, paramString, paramInt, paramLong, paramBoolean, paramContext, localbegr));
    localbegr.show();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean, ajpe paramajpe)
  {
    a(paramQQAppInterface, paramContext, paramString, paramBoolean, paramajpe, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean1, ajpe paramajpe, boolean paramBoolean2)
  {
    if ((paramQQAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    {
      localObject2 = ((ajoy)localObject3).a(paramString);
      ((ajoy)localObject3).b(paramString);
      paramContext = (Context)localObject2;
      localObject1 = localNewIntent;
      if (localObject2 == null)
      {
        localObject3 = (ajhq)paramQQAppInterface.getManager(69);
        paramContext = (Context)localObject2;
        localObject1 = localNewIntent;
        if (localObject3 != null)
        {
          localObject1 = ((ajhq)localObject3).a(paramString);
          paramContext = (Context)localObject2;
        }
      }
    }
    ...
    if ((paramBoolean2) || (paramContext == null) || (a(paramContext.accountFlag) != -4))
    {
      ...
      if ((!paramBoolean2) && (paramContext != null) && (a(paramContext.accountFlag) == -4))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApp().getApplicationContext(), ndt.class);
    ...
    else
    {
      for (;;)
      {
        try
        {
          ...
          paramContext = new rua(paramajpe, paramString, paramBoolean1, localBaseApplication, localObject1, paramQQAppInterface);
    ...
    for (;;)
    {
      paramContext = new akig(new rub(localObject1, paramQQAppInterface, paramString, paramajpe, paramBoolean1, localBaseApplication), paramQQAppInterface);
      ...
      akil.a(paramQQAppInterface, false, paramString, 0);
      return;
      localObject1 = paramContext;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    akij.a(paramQQAppInterface, paramChatMessage.senderuin, 0, 6, paramChatMessage.msgId, str);
  }
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (jdField_a_of_type_Int == 0)
        {
          ...
          if ((bool) && (paramBoolean))
          {
            ...
            if (??? != null)
            {
              localObject2 = ((akeu)???).b(ajed.ax, 1008);
              if (localObject2 != null)
              {
                ((akeu)???).b((RecentUser)localObject2);
            ...
            ??? = (ajoy)paramQQAppInterface.getManager(56);
            if (??? != null)
            {
              ((ajoy)???).c(ajed.ax);
  ...
  public static int b(String paramString)
  {
    ...
    if (((RecentUserBaseData)localObject2).mUser.getType() == 1008)
    {
      ...
      if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, paramString))
      {
        if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, ajed.C)) {
          break label215;
        }
        k = i;
      }
  ...
  private static MessageForStructing b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localMessageForStructing.frienduin = ajed.ay;
  ...
  private static MessageForStructing b(MessageForStructing paramMessageForStructing, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    MessageForStructing localMessageForStructing = (MessageForStructing)awbi.a(paramMessageForStructing.msgtype);
  ...
  public static String b()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = obz.f();
        localObject2 = babp.d(BaseApplication.getContext());
        if (localObject1 == null) {
          continue;
        }
      }
      ...
      {
        return baaw.encodeToString((byte[])localObject2, 2);
      }
      label225:
      if (localObject2 == null) {}
    }
  ...
  public static String b(QQAppInterface paramQQAppInterface, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBaseArticleInfo.mFeedType == 4) || (paramBaseArticleInfo.mFeedType == 5))
      {
        ...
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqo.a, null);
          if (paramBaseArticleInfo != null) {}
      ...
      {
        if (qoe.f((ArticleInfo)paramBaseArticleInfo))
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqo.a, null);
          if (paramBaseArticleInfo != null) {}
          for (paramBaseArticleInfo = paramBaseArticleInfo.nick;; paramBaseArticleInfo = ReadInJoyUserInfoModule.a())
        ...
        {
          paramQQAppInterface = new StringBuilder(ajjy.a(2131642972));
          ...
          {
            paramQQAppInterface.append(i + 1).append(".").append(((ppk)paramBaseArticleInfo.hotWordInfo.a.get(i)).jdField_a_of_type_JavaLangString).append("  ");
            i += 1;
          }
          continue;
        }
  ...
  private static void b(AppInterface paramAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramContext, ndt.class);
    ...
    try
    {
      ...
      localNewIntent.setObserver(new rud(paramContext, paramAppInterface, paramInt, paramString));
  ...
  {
    if (jdField_a_of_type_Bafb != null)
    {
      jdField_a_of_type_Bafb.dismiss();
      jdField_a_of_type_Bafb = null;
    }
    paramQQAppInterface = new rtu(paramActivity, paramProfileParams, paramQQAppInterface);
    paramProfileParams = new rtv(paramActivity, paramProfileParams);
    jdField_a_of_type_Bafb = babr.a(paramActivity, 230);
    jdField_a_of_type_Bafb.setMessage(2131629880);
    jdField_a_of_type_Bafb.setTitle(2131626648);
    jdField_a_of_type_Bafb.setNegativeButton(2131625035, paramQQAppInterface);
    jdField_a_of_type_Bafb.setPositiveButton(2131653589, paramQQAppInterface);
    jdField_a_of_type_Bafb.setOnCancelListener(paramProfileParams);
  ...
  public static void c(String paramString)
  {
    ...
    ndn.a(null, "CliOper", "", "", "0X8009A7C", "0X8009A7C", 0, 0, paramString, "", "", "", false);
  }
