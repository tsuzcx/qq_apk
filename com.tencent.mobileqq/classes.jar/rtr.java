  ...
  extends rtp
{
  ...
  bdzm jdField_a_of_type_Bdzm = new rts(this);
  ...
  public rtr(Context paramContext, QQAppInterface paramQQAppInterface, rtq paramrtq)
  {
  ...
  private void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localbctj.a(str, "actReadInJoyDeliverVideoCompressCover", bool, this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  private void c(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localbctj.a(str, "actReadInJoyDeliverVideoUploadCover", bool, this.jdField_c_of_type_Long - this.jdField_d_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    if (!ayyz.a((CompressInfo)localObject)) {
      a(1001);
    }
    if (QLog.isColorLevel()) {
