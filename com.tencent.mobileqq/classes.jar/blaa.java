...
public class blaa
{
  ...
  public static void a(Activity paramActivity, MiniAppInfo paramMiniAppInfo, blaf paramblaf)
  {
    ...
    do
    {
      ...
      paramActivity = blag.a(paramActivity, anzj.a(2131712880), anzj.a(2131712893), anzj.a(2131712895), new blab(paramActivity), new blac());
      paramActivity.a(false);
      paramActivity.show();
    } while (paramblaf == null);
    paramblaf.a(2, anzj.a(2131712874));
    return;
    b(paramActivity, paramMiniAppInfo, paramblaf);
  }
  ...
  {
    paramMiniAppInfo = bhmq.b(URLDrawable.getDrawable(URLDecoder.decode(paramMiniAppInfo.iconUrl), null));
    ...
    for (;;)
    {
      return bhmq.a(a(paramMiniAppInfo, i, i), (int)(i * 0.15D));
    }
  }
  
  public static void b(Activity paramActivity, MiniAppInfo paramMiniAppInfo, blaf paramblaf)
  {
    ThreadManagerV2.executeOnSubThread(new ShortcutUtils.3(paramActivity, paramMiniAppInfo, paramblaf));
  }
