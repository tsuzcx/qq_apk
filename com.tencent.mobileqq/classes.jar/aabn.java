...
public class aabn
{
  public static String a(DeviceInfo paramDeviceInfo)
  {
    ...
    {
      localObject = ((zpa)((QQAppInterface)localObject).a(51)).a(paramDeviceInfo.productId);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, DeviceInfo paramDeviceInfo, String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            bjxx.a().a((Activity)paramContext, paramQQAppInterface, paramQQAppInterface.getAccount(), paramDeviceInfo, "com.tencent.device.activities.DeviceSquareActivity", 0, null, SmartDevicePluginProxyActivity.class);
            aabm.a(null, "Usr_NewDevice_Aio", 2, 0, 0);
            return;
          }
        }
        catch (Exception paramQQAppInterface)
        {
          bfhg.c("SmartDeviceUtil", "jumpLightApp, Exception >>>", paramQQAppInterface);
          return;
        }
      ...
      ((zpa)paramQQAppInterface.a(51)).a(paramString);
    ...
    paramBundle = (zpa)paramQQAppInterface.a(51);
  ...
  public static void a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      paramJSONObject = (StructMsgForGeneralShare)azqu.a((Bundle)localObject);
      localObject = (MessageForStructing)ayvw.a(-2011);
  ...
  public static void a(String paramString1, Bundle paramBundle, int paramInt, String paramString2, AppRuntime paramAppRuntime, BusinessObserver paramBusinessObserver)
  {
    ...
    paramBundle.putString("version", "8.3.3");
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), zfd.class);
