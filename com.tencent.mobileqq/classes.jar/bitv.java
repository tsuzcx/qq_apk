  ...
  extends bitm<Void, Void, Bitmap>
{
  ...
  public bitv(String paramString1, String paramString2, Bundle paramBundle, String paramString3, bitw parambitw)
  {
    super(paramString2, paramString3);
    this.jdField_a_of_type_OrgApacheHttpImplConnTsccmThreadSafeClientConnManager = null;
    this.c = paramString1;
    this.jdField_a_of_type_Bitw = parambitw;
    ...
    for (;;)
    {
      ...
      return;
      paramString1.register(new Scheme("https", new bdzf(bitv.class.getSimpleName()), 443));
    }
  }
  ...
  protected Bitmap a(Void... paramVarArgs)
  {
    ...
    //   19: dup
    //   20: aload_0
    //   21: getfield 20	bitv:jdField_a_of_type_OrgApacheHttpImplConnTsccmThreadSafeClientConnManager	Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;
    //   24: aconst_null
    ...
    //   36: dup
    //   37: aload_0
    //   38: getfield 124	bitv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   41: invokespecial 125	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   44: astore 7
    //   46: aload 5
    //   48: astore_1
    //   49: aload_0
    //   50: getfield 26	bitv:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   53: ifnull +124 -> 177
    //   56: aload 5
    //   58: astore_1
    //   59: aload_0
    //   60: getfield 26	bitv:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    ...
    //   103: astore_1
    //   104: aload_0
    //   105: getfield 26	bitv:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   108: aload 9
    ...
    //   216: aload_0
    //   217: aload_1
    //   218: invokevirtual 183	bitv:a	(Ljava/io/InputStream;)[B
    //   221: astore_3
    //   222: aload_3
    //   223: iconst_0
    //   224: aload_3
  ...
  {
    if (this.jdField_a_of_type_Bitw != null) {
      this.jdField_a_of_type_Bitw.a(this.c, paramBitmap);
    }
  }
