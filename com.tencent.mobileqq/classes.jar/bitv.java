  ...
  extends beot
{
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", ajjy.a(2131645203), 0, "", 0, "");
  }
  
  public bitv(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495747, null);
      paramViewGroup = new bitw();
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131310057));
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      return paramView;
      paramViewGroup = (bitw)paramView.getTag();
      break;
    }
  }
}
