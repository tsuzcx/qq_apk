  ...
  extends WebViewPlugin
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bitv.class.getSimpleName();
  }
  ...
  private void c(String paramString)
  {
    ...
    do
    {
      ...
      paramString = bhni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject, paramString);
  ...
  {
    paramString = bhni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString);
    if (paramString != null) {
      paramString.a();
    }
  }
      ...
      } else if (paramLong == 8589934601L)
      {
        if ((!TextUtils.isEmpty(paramString)) && ((paramString.contains("chatplay/hall")) || (paramString.contains("avwithstranger/avchathall")) || (paramString.contains("chatplay/avchathall"))) && (paramString.endsWith("#child")))
        {
          if ((paramString.contains("adtag=client.tab")) && (this.mRuntime != null) && (this.mRuntime.a() != null))
          {
            ...
            ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131718522);
          }
          while ((this.mRuntime != null) && (this.mRuntime.a() != null) && (this.mRuntime.a().canGoBack()))
          {
            ...
            return true;
            label178:
            if (((this.mRuntime.a() instanceof binz)) && (!birz.a()))
            {
              paramString = this.mRuntime.a();
              if ((paramString != null) && (paramString.mSwiftTitleUI.a != null)) {
                paramString.mSwiftTitleUI.a.setText(2131718522);
              }
            }
          }
        }
        ...
        if ((this.mRuntime.a() instanceof IphoneTitleBarActivity))
        {
          ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131690559);
        }
        else if (((this.mRuntime.a() instanceof binz)) && (!birz.a()))
        {
          paramString = this.mRuntime.a();
          if ((paramString != null) && (paramString.mSwiftTitleUI.a != null)) {
            paramString.mSwiftTitleUI.a.setText(2131690559);
          }
        }
      }
    }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
            ...
            do
            {
              do
              {
                do
                {
                      ...
                      do
                      {
                        do
                        {
                          do
                          {
                            ...
                            {
                              return bool1;
                              if ((zyx.a(paramString1)) && (zxx.a(paramString1))) {
                                return false;
                              }
                              localObject1 = null;
                              localObject2 = a();
                              ...
                              if (paramString1.startsWith("tel:"))
                              {
                                ...
                                if ((!bhvl.jdField_a_of_type_Boolean) && (bhvi.a().a())) {
                                  bhvi.a().a(paramString1);
                                }
                                a(paramString1);
                                return true;
                              }
                          ...
                          this.b = true;
                          paramString1 = bhni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString1);
                          bool1 = bool2;
                        ...
                        this.b = false;
                        return true;
                        if ((!zyx.a(paramString1)) && (!paramString1.startsWith("mqqopensdkapi:"))) {
                          break;
                        }
                        paramString2 = this.mRuntime.a();
                        bool1 = bool2;
                      } while (paramString2 == null);
                      paramString2 = bhni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1);
                  ...
                  paramString1 = bhni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1);
                  ...
                  if (paramString1.startsWith("http://clientui.3g.qq.com/mqqapi/"))
                  {
                    ...
                    {
                      paramString2 = noe.b(paramString1, new String[0]);
                      paramString1 = paramString2;
                      if (paramString2.length() > 512) {
                        paramString1 = paramString2.substring(0, 512);
                      }
                      bdll.b(null, "P_CliOper", "BizTechReport", "", "webview_jump", "http_jumpaction", 0, 1, 0, noe.b((String)localObject1, new String[0]), paramString1, "", "");
                    }
                    return false;
                  }
    ...
    return true;
    if ((paramString1.startsWith("mqqflyticket://")) || (zyx.b(paramString1)))
    {
      c(paramString1);
      return true;
    }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = blhn.a(paramString1);
          ...
          for (;;)
          {
            try
            {
              ...
              QzonePluginProxyActivity.a(paramString2, "com.qzone.homepage.ui.activity.QZoneUserHomeActivity");
              QzonePluginProxyActivity.a(this.mRuntime.a(), this.mRuntime.a().getAccount(), paramString2, 0);
            ...
            else
            {
              ...
              QzonePluginProxyActivity.a((Intent)localObject2, "com.qzone.homepage.ui.activity.QZoneFamousSpaceHomePageActivity");
        ...
        {
          paramString2 = bhni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString1);
          if (paramString2 != null) {
            paramString2.a();
          }
        }
