...
public class apau
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    case 7230: 
      ...
      for (;;)
      {
        ...
        bhxh.a(paramQQAppInterface, "qqsport_click_messagetab", null);
        break label261;
        label421:
        i = j;
        if (j != 2) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        ...
        usf.a(paramQQAppInterface, "", "", paramMessageRecord.senderuin, str1, str3, localArrayList);
        return;
      }
    } while (!"2290230341".equals(paramMessageRecord.frienduin));
    bdla.b(paramQQAppInterface, "CliOper", "", "", "0X80090E1", "0X80090E1", 0, 0, "", "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while (!(paramAbsListView.getAdapter() instanceof blcj));
      localObject = (blcj)paramAbsListView.getAdapter();
    } while (!(((blcj)localObject).getWrappedAdapter() instanceof algc));
    b.clear();
    algc localalgc = (algc)((blcj)localObject).getWrappedAdapter();
    ...
    if (i < k - 1)
    {
      paramAbsListView = localalgc.getItem(i);
      ...
      do
      {
        for (;;)
        {
          ...
          bhxh.a(paramQQAppInterface, "qqsport_exposure_messagetab", null);
          break label312;
          switch (paramInt)
          {
          default: 
