...
public class auab
{
  public static atzp a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      if (n < paramMessageRecord.size())
      {
        ...
        ArrayList localArrayList = ((bcgx)paramMessageRecord.get(n)).a;
        k = i;
        i = j;
        i1 = 0;
        j = k;
        ...
        {
          k = i;
          if (!(localArrayList.get(i1) instanceof bciz)) {
            continue;
          }
          j = 1;
          k = i;
  ...
  public static atzp a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity)
  {
    if ((paramActivity != null) && (!paramActivity.isFinishing()))
    {
