...
{
  public auab(ProfileHeaderView paramProfileHeaderView, String paramString, int paramInt, View paramView) {}
  ...
  public void onClick(View paramView)
  {
    if ((avgf.a(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_Int >= 0))
    {
      ...
      atxr.a().c(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileHeaderView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
