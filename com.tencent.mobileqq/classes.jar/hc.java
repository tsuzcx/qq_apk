final class hc
{
  static int a(gz paramgz)
  {
    return a(paramgz, true) + a(paramgz, false);
  }
  
  private static int a(gz paramgz, boolean paramBoolean)
  {
    int m;
    int n;
    label20:
  ...
  static int b(gz paramgz)
  {
    byte[][] arrayOfByte = paramgz.a();
    int n = paramgz.b();
    int i1 = paramgz.a();
    int i = 0;
    int j = 0;
