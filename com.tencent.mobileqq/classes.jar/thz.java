  ...
  implements tgs, tgx
{
  ...
  public tgr a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    try
    {
      ...
      piv.a(((Container)localObject).getVirtualView(), localProteusItemData.a.getViewBean());
      paramViewGroup = (ViewGroup)localObject;
    ...
    return new tia(this, (View)localObject, localProteusItemData);
  }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext == null)
        {
          ...
          {
            QLog.d("WebProteusViewCreator", 1, "VIEW_TYPE_COUNT=" + tgr.a + ",NAME_VIEWTYPE_MAP size=" + this.jdField_a_of_type_JavaUtilMap.size() + "type=" + i);
            tgr.a += this.jdField_a_of_type_JavaUtilMap.size() + 1;
          }
        }
        else
        {
