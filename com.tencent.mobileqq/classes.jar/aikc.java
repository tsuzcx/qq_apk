  ...
  implements ailp
{
  ...
  public aikc(QQAppInterface paramQQAppInterface, ailr paramailr, Activity paramActivity, SessionInfo paramSessionInfo, afqz paramafqz)
  {
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560996, null);
    ((TextView)paramVarArgs.findViewById(2131374265)).setText(2131691730);
    ((ImageView)paramVarArgs.findViewById(2131374263)).setImageResource(2130849863);
    paramVarArgs.findViewById(2131374262).setOnClickListener(new aikd(this));
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (arpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 1)) {
          return;
        }
        ...
        paramInt = mvk.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
        ...
        if (j >= 0)
        {
          ...
          {
            i = paramInt;
            if (acnh.p(((ChatMessage)localObject2).msgtype))
            {
              i = paramInt;
