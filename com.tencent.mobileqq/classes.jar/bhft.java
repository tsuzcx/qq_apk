...
public class bhft
{
  ...
  public static ArrayList<bhfu> a(String paramString)
  {
  ...
  public static ArrayList<bhfu> a(JSONArray paramJSONArray)
  {
    Object localObject2;
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramJSONArray.length())
        {
          ...
          {
            localArrayList.add(new bhfu(str1));
            localObject2 = str1;
          }
          localArrayList.add(new bhfu(str1, str3, str2, str4));
          i += 1;
  ...
  public static LinkedHashMap<String, Integer> a(String[] paramArrayOfString, List<bhfu> paramList)
  {
    int j = 0;
    ...
    {
      bhfu localbhfu = (bhfu)paramList.next();
      if (localLinkedHashMap.containsKey(localbhfu.jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        localLinkedHashMap.put(localbhfu.jdField_a_of_type_JavaLangString, Integer.valueOf(i));
        i += 1;
      }
    }
