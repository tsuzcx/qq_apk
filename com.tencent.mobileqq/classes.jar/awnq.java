...
public class awnq
  extends ajfb
{
  axmg jdField_a_of_type_Axmg = new awnr(this);
  ...
  axmg jdField_b_of_type_Axmg = new awns(this);
  ...
  private boolean a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    ...
    String str = ThemeUtil.getUserCurrentThemeId(this.app);
    Object localObject1 = axmf.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramBoolean1) {}
        for (paramString2 = this.jdField_b_of_type_Axmg;; paramString2 = this.jdField_a_of_type_Axmg) {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder(1024);; localStringBuilder = null)
    {
      ...
      if (i != 0)
      {
        ...
        if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()) && (paramToServiceMsg.uint32_result.get() == 0)) {
          if ((paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
          {
            l2 = azzz.a(ByteBuffer.wrap(paramToServiceMsg.bytes_bodybuffer.get().toByteArray()).getInt());
            ...
            if (bool2)
            {
              awnu.a(this.app.getCurrentAccountUin(), bool3, 3);
              awnu.a(this.app.getCurrentAccountUin(), j, 3);
              bool1 = bool2;
            }
            if ((QLog.isColorLevel()) && (localStringBuilder != null)) {
            ...
            if (l1 == this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
            {
              ...
              bool2 = a(false, "211", awnu.b(), false, awnp.b[awnu.c()]);
              if (!bool2)
              {
  ...
  public long a(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      localByteBuffer.putInt(azzz.a(l2)).put((byte)0).putShort((short)2).putShort((short)-23251).putShort((short)2).putShort(s).putShort((short)-23238).putShort((short)2).putShort((short)paramInt);
  ...
  public boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool2 = a(paramBoolean, awnp.b[paramInt]);
    if (bool2) {}
    for (boolean bool1 = a(false, "212", paramBoolean, false, awnp.b[paramInt]);; bool1 = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    Object localObject = awnp.b[paramInt];
    ...
    {
      return bool;
      long l = ((awnq)this.app.a(154)).a(paramBoolean1, paramInt, paramBoolean2);
