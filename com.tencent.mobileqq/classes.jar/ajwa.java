...
public class ajwa
  extends ajun<CustomEmotionData>
{
  public ajwa(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new ansz((String)localObject1);
          if ((!((ansz)localObject2).a()) || (TextUtils.isEmpty(((ansz)localObject2).c)) || (TextUtils.isEmpty(((ansz)localObject2).d)))
          {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localansz1 = new ansz((String)localObject2);
          if ((!localansz1.a()) || (TextUtils.isEmpty(localansz1.c)) || (TextUtils.isEmpty(localansz1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localansz1);
          }
        }
      }
      ...
      {
        localansz1 = (ansz)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          ansz localansz2 = (ansz)((List)localObject1).get(j);
          if ((localansz1.c.equals(localansz2.c)) && (localansz2.c.equals("0")) && (localansz2.d.equals(localansz1.d)))
          {
            paramList1.remove(localansz2.a);
            ((StringBuilder)localObject2).append(localansz2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.2.8");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if (!bbev.a())
    {
      notifyUI(3, false, this.app.getApp().getString(2131693944));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.2.8");
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        axrl.a(BaseApplication.getContext()).a(null, "favEmoModifyOcrsSuc", false, 0L, 0L, (HashMap)localObject, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((ansr)this.app.getManager(149)).a();
              if (paramObject != null)
              {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        axrl.a(BaseApplication.getContext()).a(null, "favEmoGetOcrSuc", false, 0L, 0L, (HashMap)localObject1, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          paramFromServiceMsg = new FavEmotionOcr.RspBody();
          paramFromServiceMsg.mergeFrom(paramObject.bytes_bodybuffer.get().toByteArray());
          ...
          paramObject = (ansr)this.app.getManager(149);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((ansr)this.app.getManager(149)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.2.8");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        ansz localansz = new ansz((String)paramList.next());
        if (!TextUtils.isEmpty(localansz.d)) {
          localArrayList.add(localansz.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((antv)this.app.getManager(141)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (anss)this.mApp.getManager(72);
