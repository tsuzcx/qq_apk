  ...
  extends begw
{
  ...
  public begy(char[] paramArrayOfChar, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    super(-1, paramInt, 2);
    this.d = paramInt;
    this.b = paramBoolean1;
    this.a = paramBoolean2;
    paramArrayOfChar = asfa.a(paramArrayOfChar);
  ...
  private void a()
  {
    ...
    try
    {
      askd localaskd = (askd)((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(begp.d())).getManager(43);
      if (localaskd != null) {
        localaskd.a.execute(local1, 128, true);
      }
      return;
    }
  ...
  public String a()
  {
    ...
    axfj localaxfj = asos.a();
    if (localaxfj != null) {
      localEmoticon = localaxfj.a(Integer.toString(this.e), Integer.toString(this.f));
    }
  ...
  {
    Object localObject = new asrv(begp.d());
    ...
    if (!this.b)
    {
      ...
      ((asrv)localObject).a = localEmoticon;
      localObject = ((asrv)localObject).a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getDisplayMetrics().density);
    }
    for (;;)
    {
      if (localObject != null) {
      ...
      ((asrv)localObject).b = this.a;
      localObject = ((asrv)localObject).b(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getDisplayMetrics().density);
      a();
    }
  }
