...
final class afuw
  implements afve
{
  afuw(MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, BubbleImageView paramBubbleImageView, ETTextView paramETTextView1, ETTextView paramETTextView2, int paramInt, String paramString, MessageRecord paramMessageRecord) {}
  ...
  {
    if ((paramMessageRecord2 != null) && (afus.b(paramMessageRecord2)))
    {
