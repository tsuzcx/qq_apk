...
public class ayrg
  implements Manager
{
  ayri jdField_a_of_type_Ayri = new ayrh(this);
  ...
  public ayrg(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addDefaultObservers(this.jdField_a_of_type_Ayri);
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    {
      boolean bool2;
      if (aytx.a().jdField_a_of_type_Int == 1)
      {
        bool2 = true;
        label68:
        if (QLog.isColorLevel()) {
          QLog.d("Q.ocr", 2, "isSupportOcr, uin:" + paramString + "form:" + paramInt + ",isSupport:" + bool1 + ",dpcSwitch:" + bool2 + ",sdcard:" + aytg.a);
        }
        if ((!bool1) || (!bool2) || (!aytg.a)) {
          break label209;
        }
      }
      label209:
  ...
  public aysw a(List<OCRTextSearchInfo.SougouSearchInfo> paramList)
  {
    aysw localaysw = new aysw();
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      localaysw.jdField_a_of_type_JavaUtilList = new ArrayList();
      aysu localaysu = new aysu();
      localaysu.jdField_a_of_type_Int = 2049;
      localaysu.jdField_a_of_type_JavaLangString = anvx.a(2131707269);
      ...
      while (paramList.hasNext())
      {
        ...
        localaysv.jdField_a_of_type_JavaLangObject = localSougouSearchInfo;
        localaysu.jdField_a_of_type_JavaUtilList.add(localaysv);
      }
      localaysw.jdField_a_of_type_JavaUtilList.add(localaysu);
    }
    return localaysw;
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    if (!NetworkUtil.isNetworkAvailable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      ((ayre)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.OCR_HANDLER)).notifyUI(3, false, new Object[] { Integer.valueOf(-2), paramString1, null });
    }
    ...
    ((ayre)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.OCR_HANDLER)).a(paramString1, str, paramLong);
  }
  ...
  public void a(boolean paramBoolean, OcrConfig paramOcrConfig)
  {
    ...
    //   45: ifeq +31 -> 76
    //   48: aload_0
    //   49: getfield 26	ayrg:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   52: astore_3
    //   53: aload_3
    //   54: monitorenter
    //   55: aload_0
    //   56: aload_2
    //   57: putfield 285	ayrg:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   60: aload_0
    //   61: getfield 28	ayrg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   64: invokevirtual 65	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   67: aload_0
    //   68: getfield 285	ayrg:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   71: invokestatic 300	ayrg:a	(Ljava/lang/String;Lcom/tencent/mobileqq/ocr/data/OcrConfig;)V
    //   74: aload_3
    //   75: monitorexit
    ...
    //   80: aload_0
    //   81: iload_1
    //   82: invokespecial 353	com/tencent/mobileqq/ocr/OCRManager$3:<init>	(Layrg;Z)V
    //   85: bipush 8
    //   87: aconst_null
    //   88: iconst_0
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ayri);
