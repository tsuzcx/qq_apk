  ...
  implements ITransactionCallback
{
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("GroupPicUploadProcessor", 2, "<BDH_LOG> Transaction End : Failed. New : SendTotalCost:" + (l1 - ayrf.a(this.a)) + "ms");
    }
    ...
    this.a.a(paramInt, "OnFailed.", "", this.a.jdField_b_of_type_Aypd);
    this.a.d();
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("GroupPicUploadProcessor", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l1 - ayrf.a(this.a)) + "ms ,fileSize:" + this.a.jdField_a_of_type_Ayqo.a + " transInfo:" + paramArrayOfByte);
    }
    ...
    this.a.jdField_a_of_type_JavaUtilHashMap.put("param_is_ipv6", paramHashMap.get("param_is_ipv6"));
    this.a.jdField_a_of_type_JavaUtilHashMap.put("param_net_ip_type", paramHashMap.get("param_net_ip_type"));
    this.a.jdField_b_of_type_Aypd.b();
    this.a.jdField_b_of_type_Aypd.a = 1;
    ...
    this.a.jdField_a_of_type_Ayqo.a();
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    this.a.jdField_a_of_type_JavaUtilHashMap.put("param_switchChannel", String.valueOf(l - ayrf.a(this.a)));
  }
  
  public void onTransStart()
  {
    this.a.jdField_b_of_type_Aypd.a();
  }
  
  public void onUpdateProgress(int paramInt)
  {
    ayrf localayrf = this.a;
    ...
    if ((paramInt < this.a.jdField_q_of_type_Long) && (!this.a.jdField_o_of_type_Boolean) && (!this.a.k))
    {
      this.a.i();
      if (ayrf.a(this.a)) {
        bjmu.a(ayrf.a(this.a), 1002, this.a.f());
      }
    }
  }
}
