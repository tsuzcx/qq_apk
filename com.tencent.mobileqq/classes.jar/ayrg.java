...
public class ayrg
{
  ...
  {
    int i = ((Integer)paramView.getTag(2131379914)).intValue();
    Object localObject;
    View localView;
    ...
    if ((paramView instanceof LinearLayout))
    {
      ...
      paramView.removeView(paramView.findViewById(2131373579));
      paramView.removeView(paramView.findViewById(2131373580));
    ...
    for (;;)
    {
      if (ayjx.a(paramInt3))
      {
        localObject = new aysd((Context)localObject, paramInt3).a();
        ((View)localObject).setId(2131373580);
      ...
      if (((paramInt2 == 0) || (paramInt1 == 1)) && (paramBoolean1) && (i != 1))
      {
        ...
        ((View)localObject).setId(2131373579);
  ...
  public static void a(ayjl paramayjl, int paramInt1, int paramInt2)
  {
    int j = 1;
    int i = j;
    if (paramInt1 > 1)
