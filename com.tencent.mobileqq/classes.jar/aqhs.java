...
public class aqhs
  extends BaseAdapter
{
  public aqhs(LangSettingFragment paramLangSettingFragment) {}
  
  private View.OnClickListener a(int paramInt)
  {
    return new aqht(this, paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == LangSettingFragment.a(this.a)) {
      paramView.setRightIcon(this.a.getResources().getDrawable(2130843903));
    }
    for (;;)
    {
