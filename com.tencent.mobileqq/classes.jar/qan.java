  ...
  implements Cloneable
{
  ...
  public static qan a(articlesummary.ArkAppFeedsInfo paramArkAppFeedsInfo)
  {
    ...
    if (paramArkAppFeedsInfo.uint64_feeds_id.has())
    {
      ...
      label103:
      localqan.jdField_a_of_type_JavaLangString = str;
    ...
    {
      localqan.f = paramArkAppFeedsInfo;
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppFeedsInfo", 2, new Object[] { "mFeedsId: ", Long.valueOf(localqan.jdField_a_of_type_Long), ", mFeedsStyle: ", Integer.valueOf(localqan.jdField_a_of_type_Int), ", appName: ", localqan.jdField_a_of_type_JavaLangString, ", appView: ", localqan.b, ", appMinVersion: ", localqan.e, ", metaList: ", localqan.f });
      }
      return localqan;
      l = 0L;
      break;
