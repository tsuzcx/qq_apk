...
public class akln
{
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131718543);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131695823);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131695822);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131695824);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131695821);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131695805);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131695806);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131695803);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131695807);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131693250);
    }
    return paramContext.getString(2131695820);
  }
  
  public static String a(List<akjf> paramList, TroopInfo paramTroopInfo)
  {
    String str = akjf.a;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(akjf.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(bghb.b(bghb.a(str, paramString2, 1)));
    if (localURL != null)
    {
    ...
    paramString2 = a(bghb.a(bghb.a(str, paramString2, 1)));
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (aznv.a(paramString[0])) && (aznv.a(paramString[1])) && (aznv.a(paramString[2])) && (aznv.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = bheg.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = bheg.a(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        ...
        if (i != 0) {
          paramString1 = bheg.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          bheg.a(paramString1, paramString2);
          return 0;
        }
      }
