...
public class athc
{
  ...
  private static Map<String, athd> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  {
    athd localathd = new athd();
    localathd.jdField_a_of_type_JavaLangString = paramString;
    localathd.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localathd);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      atvf.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131692311), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131692318);
      atvf.a(0, str + atwl.a(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      str = atwl.a(((FileInfo)localIterator.next()).d());
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
      if (!bdjg.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
    ...
    while (localIterator.hasNext())
    {
      str = atwl.a(((FileManagerEntity)localIterator.next()).fileName);
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
  ...
  {
    paramFileInfo = atwl.a(paramFileInfo.d());
    if ((paramFileInfo == null) || (paramFileInfo.length() == 0)) {}
    do
    {
      return false;
      paramFileInfo = paramFileInfo.toLowerCase();
    } while (!bdjg.jdField_a_of_type_JavaLangString.contains(paramFileInfo));
    return true;
  }
  ...
  public static boolean b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    } while (!bdjg.jdField_a_of_type_JavaLangString.contains(paramFileManagerEntity));
    return true;
  }
  ...
  public static long c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (atul.a(localFileManagerEntity).a(false)) {
        l += atwl.a(localFileManagerEntity.getFilePath());
      }
    }
    return l;
  }
