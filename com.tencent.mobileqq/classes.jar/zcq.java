...
public class zcq
{
  ...
  public zcq(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
  }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          zcl localzcl = zcl.a(this.jdField_a_of_type_JavaLangString, paramJSONObject.getJSONObject(i));
          if (localzcl != null) {
            this.jdField_a_of_type_Zcl = localzcl;
          }
        }
        else
        {
  ...
  public zcl a()
  {
    return this.jdField_a_of_type_Zcl;
  }
  ...
  public boolean a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (!"a9855103".equals(this.c))
    {
      QLog.d("PatchLogTag", 1, "PatchConfig isValidConfig revision not match expect: a9855103");
      return false;
    }
    if ((TextUtils.isEmpty(this.b)) || (!this.b.equals(aney.a(paramContext) + "." + aney.a(paramContext))))
    {
      QLog.d("PatchLogTag", 1, "PatchConfig isValidConfig app version not match expect: " + aney.a(paramContext) + "." + aney.a(paramContext));
      return false;
    }
    if ((this.jdField_a_of_type_Zcl == null) || (!this.jdField_a_of_type_Zcl.a(paramBoolean)))
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Zcl != null) {
      return this.jdField_a_of_type_Zcl.jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  {
    if (this.jdField_a_of_type_Zcl != null) {
      return this.jdField_a_of_type_Zcl.jdField_a_of_type_JavaLangString;
    }
    return null;
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Zcl != null) && (this.jdField_a_of_type_Zcl.a());
  }
  
  public int c()
  {
    if ((!b()) && (PatchCommonUtil.isArtGeN()) && (this.jdField_a_of_type_Zcl != null)) {
      return ((zcm)this.jdField_a_of_type_Zcl).a();
    }
    return b();
  }
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Zcl != null) && (this.jdField_a_of_type_Zcl.b());
  }
  
  public String d()
  {
    if (this.jdField_a_of_type_Zcl != null) {
      return this.jdField_a_of_type_Zcl.b;
    }
    return null;
  }
  ...
  public String e()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Zcl != null)
      {
        String str = this.jdField_a_of_type_Zcl.a();
