final class anlz
  extends anjb
{
  anlz(String paramString1, String paramString2, String paramString3, String paramString4) {}
  ...
  public void b(boolean paramBoolean, long paramLong, byte[] arg4)
  {
    ...
    //   22: dup
    //   23: aload_0
    //   24: getfield 13	anlz:a	Ljava/lang/String;
    ...
    //   96: aload_0
    //   97: getfield 15	anlz:b	Ljava/lang/String;
    //   100: aload_0
    //   101: getfield 17	anlz:c	Ljava/lang/String;
    //   104: aload_0
    //   105: getfield 17	anlz:c	Ljava/lang/String;
    //   108: aload_0
    //   109: getfield 19	anlz:d	Ljava/lang/String;
    //   112: invokestatic 60	anly:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   115: ifeq +142 -> 257
    //   118: iconst_4
    //   119: invokestatic 63	anly:a	(I)V
    //   122: ldc 65
    //   124: iconst_2
    //   125: ldc 67
    //   127: invokestatic 73	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   130: aload_0
    //   131: getfield 19	anlz:d	Ljava/lang/String;
    //   134: ldc 75
    //   136: invokestatic 78	anly:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   139: invokestatic 81	anly:a	()Ljava/lang/Object;
    //   142: astore 4
    //   144: aload 4
    //   146: monitorenter
    //   147: iconst_0
    //   148: invokestatic 84	anly:a	(Z)Z
    //   151: pop
    //   152: aload 4
    //   154: monitorexit
    //   155: return
    ...
    //   254: goto -17 -> 237
    //   257: iconst_5
    //   258: invokestatic 63	anly:a	(I)V
    //   261: ldc 65
    //   263: iconst_2
    //   264: ldc 92
    ...
    //   269: goto -130 -> 139
    //   272: bipush 6
    //   274: invokestatic 63	anly:a	(I)V
    //   277: ldc 65
    //   279: iconst_2
    //   280: ldc 94
