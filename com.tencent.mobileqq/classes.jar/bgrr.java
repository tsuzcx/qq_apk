...
public class bgrr
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130849434);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130849435);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new bgru(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new bgrv(this);
  ...
  public bgrr(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(int paramInt)
  {
    ...
    bajq.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, jdField_c_of_type_AndroidGraphicsDrawableDrawable);
  ...
  private int c()
  {
    ...
    return bajq.b() - localRect.height();
  }
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new bgrs(this));
    this.jdField_a_of_type_Bgrw = new bgrw(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299833));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Bgrw);
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new bgrt(this));
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      bajq.b(this.jdField_a_of_type_AndroidWidgetListView, f3);
      bajq.c(this.jdField_a_of_type_AndroidWidgetListView, f3);
      if (this.jdField_c_of_type_Boolean)
      {
        bajq.e(this.jdField_a_of_type_AndroidWidgetListView, 0.0F);
        bajq.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      for (;;)
      {
        ...
        f3 = f2;
        break;
        bajq.e(this.jdField_a_of_type_AndroidWidgetListView, this.d);
        bajq.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      label221:
      break;
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bajq.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void a(bgrx parambgrx)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (parambgrx != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambgrx);
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = bajq.a() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingRight() * 2;
    ...
    localLayoutParams1.topMargin = (paramInt2 - i - bajq.b(5.0F));
  ...
  public int b()
  {
    ...
    {
      i = bajq.b() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight();
      if (i > bajq.b(25.0F)) {}
    }
    int j;
    do
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bajq.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_AndroidWidgetListView != null) {
      this.jdField_a_of_type_AndroidWidgetListView.setPadding(this.jdField_a_of_type_AndroidWidgetListView.getPaddingLeft(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingTop() + bajq.b(9.0F), this.jdField_a_of_type_AndroidWidgetListView.getPaddingRight(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingBottom());
    }
    super.showAtLocation(a(), 17, 0, 0);
    c();
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Bgrw.getCount())
    {
      View localView = this.jdField_a_of_type_Bgrw.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
      j += localView.getMeasuredHeight();
      i += 1;
    }
    this.jdField_b_of_type_Int = (bajq.b(9.0F) + j);
  }
}
