...
{
  public rst(BaseChatPie paramBaseChatPie) {}
  ...
  protected void onAddFriend(String paramString)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new rsu(this));
        return;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (MultiMsgManager.a().b.size() == 0) {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131433424, 0).b(this.a.a());
        }
        while (QLog.isDevelopLevel())
        {
  ...
  protected void onGetSigZanInfo(boolean paramBoolean, Object paramObject)
  {
    ...
    ThreadManager.post(new rsw(this, (RichStatus.SigZanInfo)paramObject), 5, null, false);
  }
  ...
  protected void onQueryUinSafetyFlag(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new rsv(this, paramLong));
  }
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map paramMap)
  {
    if ((!paramBoolean) && (this.a.q())) {
      QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2130838739, this.a.jdField_a_of_type_AndroidContentContext.getString(2131434514), 0).b(this.a.a());
    }
  }
