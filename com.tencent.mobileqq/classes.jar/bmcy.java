...
public class bmcy
  extends QIPCModule
{
  private static bmcy a;
  
  private bmcy(String paramString)
  {
    super(paramString);
  }
  ...
  public static bmcy a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bmcy:a	Lbmcy;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bmcy:a	Lbmcy;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bmcy
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bmcy:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bmcy:a	Lbmcy;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bmcy:a	Lbmcy;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_start_send".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        localObject1 = azdd.a(3, 0);
        localObject2 = azdd.a(0, paramBundle, (azdx)localObject1);
        ((azdi)localObject2).c = true;
        ((azdx)localObject1).a((azdi)localObject2);
        azdd.a((azdx)localObject1, paramString);
      }
      if (QLog.isColorLevel())
      {
    ...
    if ("action_cancel_send".equals(paramString))
    {
      ...
      if (localObject1 != null)
      {
        ...
        label350:
        if ((!(paramString instanceof baxe)) || (((baxe)paramString).q)) {
          break label570;
        }
        ((baxe)paramString).c();
        bool1 = true;
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        axwx.a(paramBundle, (String)localObject2, l2);
        bool2 = bool3;
        if (localObject1 != null) {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        for (;;)
        {
          for (;;)
          {
            ...
            break label350;
            label570:
            if (((paramString instanceof barp)) && (!((barp)paramString).b))
            {
              ((barp)paramString).c();
              bool1 = true;
              paramString = "C2CPic";
            ...
            if ((!(paramString instanceof batj)) || (((batj)paramString).q)) {
              break label1832;
            }
            ((batj)paramString).c();
            bool1 = true;
            ...
            if ("action_re_send".equals(paramString))
            {
              ...
              if ((paramBundle instanceof MessageForShortVideo))
              {
                ...
                if ((bdhb.b(ShortVideoUtils.a(((MessageForShortVideo)localObject1).thumbMD5, "jpg"))) && (!TextUtils.isEmpty(((MessageForShortVideo)localObject1).videoFileName)) && (((MessageForShortVideo)localObject1).isStoryVideo))
                {
                  ((axwx)paramString.getManager(326)).a(((MessageForShortVideo)localObject1).frienduin, (MessageRecord)localObject1, ((MessageForShortVideo)localObject1).videoFileName);
                  localObject1 = azdd.a(4, 0);
                  localObject2 = azdd.a(0, paramBundle, (azdx)localObject1);
                  ((azdi)localObject2).c = true;
                  ((azdx)localObject1).a((azdi)localObject2);
                  azdd.a((azdx)localObject1, paramString);
              ...
              for (paramString = paramBundle.toString();; paramString = "")
              {
                ...
                bool1 = bool2;
                if (!bdhb.b(((MessageForPic)localObject1).path)) {
                  break label1014;
                }
                bool1 = bool2;
                ...
                localObject2 = new awjv();
                ((awjv)localObject2).a(((MessageForPic)localObject1).path);
                ((awjv)localObject2).d(5);
                ((awjv)localObject2).d(((MessageForPic)localObject1).frienduin);
                if (((MessageForPic)localObject1).fileSizeFlag == 1) {
                  ((awjv)localObject2).c(baye.e);
                }
                for (;;)
                {
                  ((awjv)localObject2).e(((MessageForPic)localObject1).senderuin);
                  ((awjv)localObject2).c(((MessageForPic)localObject1).selfuin);
                  ((awjv)localObject2).e(((MessageForPic)localObject1).istroop);
                  ((awjv)localObject2).l(((MessageForPic)localObject1).getConfessTopicId());
                  ((awjv)localObject2).jdField_i_of_type_Int = ((MessageForPic)localObject1).extLong;
                  ((awjv)localObject2).jdField_i_of_type_JavaLangString = ((MessageForPic)localObject1).extStr;
                  ((awjv)localObject2).b(true);
                  localObject3 = new awjw();
                  ((awjw)localObject3).a = ((MessageForPic)localObject1).msgseq;
                  ((awjw)localObject3).b = ((MessageForPic)localObject1).shmsgseq;
                  ((awjw)localObject3).c = ((MessageForPic)localObject1).msgUid;
                  ((awjv)localObject2).a((awjw)localObject3);
                  ((awjv)localObject2).b(((MessageForPic)localObject1).uniseq);
                  ((axwx)paramString.getManager(326)).a(((MessageForPic)localObject1).frienduin, ((MessageForPic)localObject1).uniseq);
                  localObject3 = awjb.a(4, 5);
                  ((awjl)localObject3).a(((awjv)localObject2).a());
                  ((awjl)localObject3).a = ((MessageForPic)localObject1).picExtraData;
                  awjb.a((awjl)localObject3, paramString);
                  bool1 = true;
                  break;
                  ((awjv)localObject2).c(baye.d);
                }
              }
            }
        ...
        if ("action_get_name".equals(paramString))
        {
          ...
          try
          {
            paramString = bdgc.b((QQAppInterface)localObject1, paramString);
            localBundle.putBoolean("key_result", true);
            localBundle.putString("uinname", paramString);
            paramString = EIPCResult.createSuccessResult(localBundle);
            return paramString;
