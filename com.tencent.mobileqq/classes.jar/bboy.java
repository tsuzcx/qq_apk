  ...
  implements IBrowserAnimationListener
{
  ...
  public bboy(RichMediaBaseData paramRichMediaBaseData)
  {
  ...
  public Drawable getAnimationDrawable()
  {
    for (;;)
    {
      try
      {
        ...
        {
          localDrawable = new bbpx().a((AIOPictureData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
        ...
        else
        {
          ...
          {
            localDrawable = new bbpy().a((AIOVideoData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
            continue;
          }
          if ((this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData instanceof AIOFilePictureData))
          {
            localDrawable = new bbpt().a((AIOFilePictureData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
            continue;
          }
          if (!(this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData instanceof AIOFileVideoData)) {
            break label219;
          }
          localDrawable = new bbpu().a((AIOFileVideoData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
          continue;
        }
        return null;
      }
  ...
  {
    paramRichMediaBaseData = new bboy(paramRichMediaBaseData);
