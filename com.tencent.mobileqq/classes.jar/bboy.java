...
public class bboy
{
  ...
  public final String a()
  {
    if (a())
    {
      ...
      if (bbpa.a(this.jdField_a_of_type_Int)) {
  ...
  {
    this.jdField_a_of_type_Int = bbpa.b(paramCustomOnlineStatusMsg);
    this.jdField_a_of_type_JavaLangString = bbpa.a(paramCustomOnlineStatusMsg);
    this.b = bbpa.a(paramCustomOnlineStatusMsg);
    b();
  }
  ...
  {
    int j = this.c;
    amyj localamyj = (amyj)ampm.a().a(479);
    if ((localamyj == null) || (localamyj.a)) {}
    for (int i = 1;; i = 0)
    {
      this.c = i;
      if (j != this.c) {
