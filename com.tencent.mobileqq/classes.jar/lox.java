  ...
  extends kvw
{
  ...
  protected void a(long paramLong)
  {
    ...
    if (this.a.jdField_a_of_type_Loz != null) {
      this.a.jdField_a_of_type_Loz.v();
    }
    Object localObject;
    boolean bool2;
    if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 2)
    {
      ...
      bool1 = true;
      ((kvq)localObject).a(paramLong, bool1);
      if (this.a.jdField_c_of_type_Boolean) {
    ...
    {
      this.a.jdField_a_of_type_Loz.a((String)localObject, 1, bool2, false, bool1);
      ...
      lxz.a(this.a.jdField_a_of_type_ComTencentAvVideoController);
      return;
      bool1 = false;
      break;
    }
  ...
  protected void a(long paramLong, int paramInt)
  {
    ...
    {
      this.a.jdField_a_of_type_Lru.update(null, new Object[] { Integer.valueOf(106), Long.valueOf(paramLong) });
  ...
  protected void a(long paramLong, int paramInt, String paramString)
  {
    ...
    {
      this.a.jdField_a_of_type_Loz.a(paramString, 1, false, false, bool);
      this.a.jdField_a_of_type_Loz.a(false, false);
      this.a.jdField_a_of_type_Loz.u_();
      if (this.a.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
        break;
      }
  ...
  protected void a(RecvMsg paramRecvMsg)
  {
    ...
    if ((this.a.jdField_a_of_type_Loz != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController != null)) {
      this.a.jdField_a_of_type_Loz.a(0, 0, true);
    }
  }
  ...
  protected void b(int paramInt)
  {
    ...
    int i = bavz.a();
    Object localObject = bavz.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, i, null);
    if (localObject == null) {}
    do
    {
      return;
      localObject = new File((String)localObject);
      if ((localObject != null) && (((File)localObject).exists()) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().g != 4) && (this.a.jdField_c_of_type_Int == 1) && (this.a.jdField_a_of_type_Loz != null)) {
        this.a.jdField_a_of_type_Loz.w();
      }
  ...
  protected void b(long paramLong)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.a.jdField_a_of_type_Loz.a(str, 1, true, false, bool);
      this.a.jdField_a_of_type_Loz.a(this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_JavaLangString, 1, this.a.jdField_a_of_type_AndroidGraphicsBitmap, true, false);
      return;
    }
  }
  ...
  {
    if (paramInt != this.a.jdField_a_of_type_ComTencentAvVideoController.a().P) {
      QLog.d("SmallScreenVideoController", 1, "setGlassWaitTime nTime=" + paramInt + ", mCurrentVideoGlassWaitTime=" + this.a.jdField_a_of_type_ComTencentAvVideoController.a().P);
    }
    this.a.jdField_a_of_type_ComTencentAvVideoController.a().P = paramInt;
  }
  ...
  protected void b(String paramString, boolean paramBoolean)
  {
    ...
    if ((this.a.jdField_c_of_type_Int == 1) || (this.a.jdField_c_of_type_Int == 2))
    {
      ...
      if (this.a.jdField_a_of_type_Loz != null)
      {
        paramString = baig.a(this.a.jdField_a_of_type_AndroidContentContext).edit();
        paramString.putInt("video_position", this.a.jdField_a_of_type_Loz.g());
        paramString.commit();
      }
    }
  }
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    lou.a(localSmallScreenRelativeLayout);
  }
  ...
  protected void c()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.a.jdField_a_of_type_Loz.a(str, 1, false, false, bool);
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().i == 1011) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().j))
      {
        ...
        if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().F == 3) {
          this.a.jdField_a_of_type_ComTencentAvVideoController.a().F = 0;
        }
      }
      return;
    }
  ...
  protected void c(String paramString, boolean paramBoolean)
  {
    ...
    ZimuToolbar.sendSupportionToPeer(this.a.jdField_a_of_type_ComTencentAvVideoController);
    if ((this.a.jdField_a_of_type_Loz != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().k))
    {
    ...
    {
      this.a.jdField_a_of_type_Loz.a(paramString, paramBoolean);
      lxz.a(this.a.jdField_a_of_type_ComTencentAvVideoController);
      return;
    }
  }
  ...
  public void e(String paramString)
  {
    ...
    this.a.jdField_a_of_type_ComTencentAvVideoController.a().F = 2;
    this.a.b();
  }
  ...
  public void f(String paramString)
  {
    ...
    if (this.a.jdField_a_of_type_Loz != null)
    {
      this.a.jdField_a_of_type_Loz.a(true, false);
      this.a.jdField_a_of_type_Loz.c(l, this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
    }
  }
