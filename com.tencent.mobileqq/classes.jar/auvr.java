  ...
  implements Manager
{
  ...
  protected HashMap<Long, auvw> a;
  protected HashSet<String> a;
  protected boolean a;
  protected boolean b = true;
  
  public auvr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Auvy = new auvy();
  ...
  {
    azqs.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "pay_like", paramString1, 0, 0, paramString3, paramString4, paramString5, paramString6);
  ...
  {
    if ((this.jdField_a_of_type_Auvy == null) || (this.jdField_a_of_type_Auvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg == null)) {
      return null;
    }
    return a(this.jdField_a_of_type_Auvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_first_info.get());
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      if (this.jdField_a_of_type_Auvy != null)
      {
        this.jdField_a_of_type_Auvy.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Auvy.c = paramInt2;
        this.jdField_a_of_type_Auvy.d = paramInt3;
        if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        auvw localauvw = (auvw)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localauvw == null)
        {
          if ((paramInt1 > 0) || (paramInt2 > 0))
          {
            localauvw = new auvw();
            localauvw.jdField_a_of_type_Long = paramLong;
            localauvw.jdField_a_of_type_Int += paramInt1;
            localauvw.b += paramInt2;
            localauvw.c += this.jdField_a_of_type_Auvy.b * paramInt2;
            this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localauvw);
            localObject2 = this.jdField_a_of_type_Auvy;
            ((auvy)localObject2).f += 1;
            localObject2 = this.jdField_a_of_type_Auvy;
            ((auvy)localObject2).e -= this.jdField_a_of_type_Auvy.b * paramInt2;
          }
          if (QLog.isColorLevel())
          {
      ...
      localObject1.c += this.jdField_a_of_type_Auvy.b * paramInt2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localObject1);
      Object localObject2 = this.jdField_a_of_type_Auvy;
      ((auvy)localObject2).e -= this.jdField_a_of_type_Auvy.b * paramInt2;
      continue;
      label377:
      boolean bool = false;
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString1, auvz paramauvz, String paramString2)
  {
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyLikeLimitManager", 2, "checkCanDoVote, uin=" + paramString1 + ", from=" + paramString2 + ", mLimitInfo=" + this.jdField_a_of_type_Auvy);
        }
        ...
        if ((bool1) && (c()))
        {
          ...
          if (i != 0)
          {
            paramActivity = bdgm.a(paramActivity, 0, null, localSpannableString, alud.a(2131707597), alud.a(2131707593), alud.a(2131707592), new auvs(this, bool1, paramString1, paramauvz, paramQQAppInterface, paramString2, paramActivity), new auvt(this, paramActivity, paramQQAppInterface, paramString2));
        ...
        if (a())
        {
          ...
          paramauvz.a(paramString1, false);
  ...
  {
    bdgm.a(paramActivity, 230).setTitle(alud.a(2131707598)).setMessage(alud.a(2131707594)).setNegativeButton(alud.a(2131707596), new auvv(this)).setPositiveButton(alud.a(2131707595), new auvu(this, paramActivity)).show();
  }
  
  public void a(auvy paramauvy, List<auvw> paramList, int paramInt)
  {
    try
    {
      this.jdField_a_of_type_Auvy = paramauvy;
      if (paramInt == 511) {
        this.jdField_a_of_type_JavaUtilHashMap.clear();
      }
      paramauvy = new StringBuilder();
      if ((paramList != null) && (paramList.size() > 0))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          auvw localauvw = (auvw)paramList.next();
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localauvw.jdField_a_of_type_Long), localauvw);
          if (QLog.isColorLevel()) {
            paramauvy.append(localauvw).append(" | ");
          }
        }
      }
      if (!QLog.isColorLevel()) {
    ...
    QLog.d("NearbyLikeLimitManager", 2, "updateFromServer, mLimitInfo=" + this.jdField_a_of_type_Auvy + ", mLikeItemMap=[" + paramauvy + "]");
    label165:
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Auvy.e >= this.jdField_a_of_type_Auvy.b)
        {
          bool1 = bool2;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Auvy.f < this.jdField_a_of_type_Auvy.c) {
          break label165;
        }
        bool1 = true;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        bool1 = false;
        break label219;
        if ((this.jdField_a_of_type_Auvy.f >= this.jdField_a_of_type_Auvy.c) && (localObject.b > 0))
        {
  ...
  public boolean a(String paramString)
  {
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 35	auvr:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   61: aload_1
  ...
  public SpannableString b()
  {
    ...
    return a(this.jdField_a_of_type_Auvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_user_num_limit_info.get());
  }
  ...
  public boolean b(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        auvw localauvw = (auvw)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        boolean bool1;
        if ((this.jdField_a_of_type_Auvy == null) || (localauvw == null))
        {
          if (QLog.isColorLevel())
          {
        ...
        if (localauvw.jdField_a_of_type_Int >= this.jdField_a_of_type_Auvy.d)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public SpannableString c()
  {
    ...
    return a(this.jdField_a_of_type_Auvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_zan_limit_info.get());
  }
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Auvy != null) && (this.jdField_a_of_type_Auvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	auvr:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: lload_1
    ...
    //   13: checkcast 335	auvw
    //   16: astore 5
    //   18: aload_0
    //   19: getfield 25	auvr:jdField_a_of_type_Auvy	Lauvy;
    //   22: astore 6
    //   24: aload 6
    //   26: ifnull +8 -> 34
    //   29: aload 5
    ...
    //   16	27	5	localauvw	auvw
    //   64	5	5	localObject	Object
    //   22	3	6	localauvy	auvy
    // Exception table:
    //   from	to	target	type
    //   2	24	64	finally
    //   42	48	64	finally
  ...
  public boolean d()
  {
    if ((this.b) && (this.jdField_a_of_type_Auvy != null) && (this.jdField_a_of_type_Auvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    try
    {
      this.jdField_a_of_type_Auvy = null;
      this.jdField_a_of_type_JavaUtilHashMap.clear();
      if (QLog.isColorLevel()) {
