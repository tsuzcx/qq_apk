  ...
  extends bcvt
{
  ...
  public bcye()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bcyf(this);
  }
  
  private FrameLayout a(Context paramContext)
  {
    FrameLayout localFrameLayout = new FrameLayout(paramContext);
    localFrameLayout.setLayoutParams(new FrameLayout.LayoutParams(-2, afur.a(105.0F, paramContext.getResources())));
    localFrameLayout.setId(2131371575);
    if (AppSetting.c) {
      localFrameLayout.setContentDescription(this.aa);
    }
  ...
  public static String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if ((paramAbsStructMsg instanceof AbsShareMsg))
    {
      ...
      if ((paramAbsStructMsg.getItemCount() > 0) && ((paramAbsStructMsg.getItemByIndex(0) instanceof bcye)))
      {
        paramAbsStructMsg = (bcye)paramAbsStructMsg.getItemByIndex(0);
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForStructing))
    {
      ...
      if ((paramChatMessage.structingMsg != null) && ((paramChatMessage.structingMsg instanceof AbsShareMsg)) && (paramChatMessage.structingMsg.mMsgServiceID == 52))
      {
        ...
        if ((paramChatMessage.getItemCount() > 0) && ((paramChatMessage.getItemByIndex(0) instanceof bcye))) {
          return true;
        }
      }
    }
  ...
  {
    paramView.setOnTouchListener(new bcyg(this, paramView));
  }
    ...
    if (((JSONObject)localObject8).has("cMean"))
    {
      ...
      for (i = 0;; i = Integer.valueOf(str5).intValue())
      {
        ...
        do
        {
          ...
          localObject10 = (bcvs)((Iterator)localObject9).next();
        } while (!(localObject10 instanceof bcxv));
        localObject9 = ((bcxv)localObject10).aa;
        str11 = b(str11);
        String str15 = b((String)localObject7);
        localObject7 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        Object localObject10 = (anmw)((QQAppInterface)localObject7).getManager(51);
        this.jdField_a_of_type_AndroidOsBundle.putString("sNick", str15);
        if (!bool1)
        {
          if ((localObject10 == null) || (!((anmw)localObject10).b(str7))) {
            break label1479;
          }
          j = 1;
          if (j != 0)
          {
            str15 = bglf.j((QQAppInterface)localObject7, str7);
            this.jdField_a_of_type_AndroidOsBundle.putString("sNick", str15);
            if (bool2) {
        ...
        if (!bool2)
        {
          if ((localObject10 == null) || (!((anmw)localObject10).b(str6))) {
            break label1484;
          }
          j = 1;
          if (j != 0)
          {
            localObject7 = bglf.j((QQAppInterface)localObject7, str6);
        ...
        localObject4 = (bcvs)((Iterator)localObject6).next();
        str1 = ((bcvs)localObject4).jdField_a_of_type_JavaLangString;
        if (!"remark".equals(str1)) {
          break;
        }
        localObject4 = ((bdap)localObject4).b();
      ...
      if ("summary".equals(str1))
      {
        ...
        for (;;)
        {
          ...
          this.aa = ((StringBuilder)localObject5).toString();
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!TextUtils.isEmpty(str1)) {
      if (bool1)
      {
        ...
        anqt.a(((BaseActivity)paramContext).app, (String)localObject1);
        localResources = paramContext.getResources();
        if ((paramView == null) || (!(paramView instanceof FrameLayout)) || (((FrameLayout)paramView).getChildCount() != 2) || (!(((FrameLayout)paramView).getTag() instanceof bcyh))) {
          break label523;
        }
        localObject1 = (FrameLayout)paramView;
        paramView = (bcyh)((FrameLayout)localObject1).getTag();
        if (paramView.c != null) {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramView.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding(0, 0, afur.a(15.0F, localResources), 0);
      ...
      for (;;)
      {
        if (((Iterator)localObject2).hasNext())
        {
          ...
          Object localObject4 = ((bcvs)localObject3).jdField_a_of_type_JavaLangString;
          Object localObject5;
          int i;
          if ("title".equals(localObject4))
          {
            ...
            localObject4 = ((bcvs)localObject3).a(paramContext, paramView.c, paramBundle);
            localObject5 = (TextView)((View)localObject4).findViewById(2131379957);
            if (paramView.c == null)
            {
            ...
            for (;;)
            {
              ...
              QLog.i("StructMsgItemLayout12", 2, "getview title:" + ((bcvu)localObject3).b() + " realText:" + ((TextView)localObject5).getText());
              break label288;
              if (bool2)
              {
              ...
              ((FrameLayout.LayoutParams)localObject2).setMargins(0, afur.a(10.0F, localResources), 0, 0);
              if (this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable == null)
              {
                ...
                this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable.setCornerRadius(afur.a(14.0F, localResources));
              }
              ...
              localObject2 = new LinearLayout.LayoutParams(afur.a(135.0F, localResources), -2);
              ((LinearLayout.LayoutParams)localObject2).weight = 1.0F;
              ((LinearLayout.LayoutParams)localObject2).topMargin = afur.a(5.0F, localResources);
              ...
              paramView.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding(afur.a(15.0F, localResources), 0, 0, 0);
              break label279;
          ...
          else
          {
            if ("summary".equals(localObject4))
            {
              if ((localObject3 instanceof bdaq)) {
                ((bdaq)localObject3).b("black");
              }
              localObject4 = ((bcvs)localObject3).a(paramContext, paramView.d, paramBundle);
              localObject5 = (TextView)localObject4;
              if (!TextUtils.isEmpty(str1))
              {
                ((TextView)localObject5).setMaxLines(1);
                if ((localObject3 instanceof bdaq)) {
                  ((bdaq)localObject3).a(str2);
                }
                if (paramView.d != null) {
                  break label1026;
                }
                ...
                ((LinearLayout.LayoutParams)localObject5).setMargins(0, afur.a(4.0F, localResources), 0, 0);
                paramView.jdField_b_of_type_AndroidWidgetLinearLayout.addView((View)localObject4, (ViewGroup.LayoutParams)localObject5);
              }
              for (;;)
              {
                localObject3 = (bdaq)localObject3;
                if ((this.jdField_a_of_type_AndroidOsBundle.size() <= 0) || (!TextUtils.isEmpty(str1))) {
                  break;
                }
                this.jdField_a_of_type_AndroidOsBundle.putString("cMeanPostfix", ((bdaq)localObject3).b());
                break;
            ...
            {
              localObject4 = (bcxv)localObject3;
              if (!((bcxv)localObject4).aa.startsWith("https://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s".substring(0, 4))) {
                ((bcxv)localObject4).aa = String.format("https://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s", new Object[] { ((bcxv)localObject4).aa });
              }
              localObject3 = ((bcvs)localObject3).a(paramContext, paramView.jdField_b_of_type_AndroidViewView, paramBundle);
              if (this.jdField_a_of_type_AndroidOsBundle.getInt("count", 0) > 9)
              {
                ...
                localObject4 = new LinearLayout.LayoutParams(afur.a(115.0F, localResources), -1);
            ...
            {
              if ((localObject3 instanceof bdap)) {
                ((bdap)localObject3).b("#FF9B9B9B");
              }
              localObject4 = ((bcvs)localObject3).a(paramContext, paramView.e, paramBundle);
              if (paramView.e == null)
              {
                paramView.e = ((View)localObject4);
                localObject5 = new LinearLayout.LayoutParams(-1, -2);
                ((LinearLayout.LayoutParams)localObject5).topMargin = afur.a(7.0F, localResources);
                paramView.jdField_b_of_type_AndroidWidgetLinearLayout.addView((View)localObject4, (ViewGroup.LayoutParams)localObject5);
              }
              for (;;)
              {
                localObject4 = (bdap)localObject3;
                if (this.jdField_a_of_type_AndroidOsBundle.size() > 0)
                {
                  this.jdField_a_of_type_AndroidOsBundle.putString("remark", ((bdap)localObject4).b());
                  if (!TextUtils.isEmpty(str1)) {
                    this.jdField_a_of_type_AndroidOsBundle.putString("cMeanPostfix", ((bdap)localObject4).b());
                  }
                }
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("StructMsgItemLayout12", 2, "getview remark:" + ((bcvu)localObject3).b());
                break;
