...
{
  private static acjp jdField_a_of_type_Acjp;
  ...
  {
    if (jdField_a_of_type_Acjp == null) {}
    try
    {
      if (jdField_a_of_type_Acjp == null)
      {
        jdField_a_of_type_Acjp = new acjp();
        new HardCoderManager.1().start();
      }
      return jdField_a_of_type_Acjp;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = acjl.a().a();
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, long paramLong, int paramInt7, String paramString, boolean paramBoolean)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      return acjl.a().a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramLong, paramInt7, paramString);
    }
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
    acjm localacjm = (acjm)acjl.a.obtain(acjm.class);
    localacjm.jdField_a_of_type_Int = paramInt1;
    localacjm.c = paramInt2;
    localacjm.d = paramInt3;
    localacjm.e = paramInt4;
    localacjm.b = paramInt5;
    localacjm.f = paramInt6;
    localacjm.jdField_a_of_type_Long = paramLong;
    localacjm.jdField_a_of_type_JavaLangString = paramString;
    localMessage.obj = localacjm;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      Object localObject = (acjm)paramMessage.obj;
      jdField_a_of_type_AndroidOsBundle.putInt("key_delay", ((acjm)localObject).jdField_a_of_type_Int);
      jdField_a_of_type_AndroidOsBundle.putInt("key_cpu", ((acjm)localObject).c);
      jdField_a_of_type_AndroidOsBundle.putInt("key_io", ((acjm)localObject).d);
      jdField_a_of_type_AndroidOsBundle.putInt("key_bind", ((acjm)localObject).e);
      jdField_a_of_type_AndroidOsBundle.putInt("key_timeout", ((acjm)localObject).b);
      jdField_a_of_type_AndroidOsBundle.putInt("key_scene", ((acjm)localObject).f);
      jdField_a_of_type_AndroidOsBundle.putLong("key_action", ((acjm)localObject).jdField_a_of_type_Long);
      jdField_a_of_type_AndroidOsBundle.putString("key_tag", ((acjm)localObject).jdField_a_of_type_JavaLangString);
