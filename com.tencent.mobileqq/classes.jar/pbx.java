  ...
  extends pbh
{
  ...
  private SparseArray<WeakReference<pby>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  
  public pbx(aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
    super(null, paramaukn, paramExecutorService, parampou, paramHandler);
  }
  
  public pbx(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  private ToServiceMsg a(List<ReportInfo> paramList)
  {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          ...
          if (localObject2 != null)
          {
            ...
            localFeedsReportData.uint64_feeds_id.set(((qcc)localObject2).jdField_a_of_type_Long);
            localFeedsReportData.uint64_publish_uin.set(((qcc)localObject2).jdField_b_of_type_Long);
            localFeedsReportData.uint32_like_total_count.set(((qcc)localObject2).jdField_a_of_type_Int);
            localFeedsReportData.uint32_comment_total_count.set(((qcc)localObject2).jdField_b_of_type_Int);
            localArrayList2 = new ArrayList();
            if ((((qcc)localObject2).jdField_a_of_type_JavaUtilList != null) && (!((qcc)localObject2).jdField_a_of_type_JavaUtilList.isEmpty()))
            {
              localObject2 = ((qcc)localObject2).jdField_a_of_type_JavaUtilList.iterator();
        ...
        catch (Exception localException)
        {
          ...
          qcd localqcd = localReportInfo.mVideoExtraRepoerData;
          if (localqcd != null)
          {
            localReportInfo1.enum_network_type.set(b());
            localReportInfo1.operator_platform.set(3);
            if (localqcd.jdField_b_of_type_Boolean) {
              localReportInfo1.whether_click_in.set(localqcd.jdField_a_of_type_Boolean);
            }
            if (localqcd.jdField_a_of_type_Int != -1) {
              localReportInfo1.enum_jumpway_which.set(localqcd.jdField_a_of_type_Int);
            }
            if (localqcd.jdField_b_of_type_Int != -1) {
              localReportInfo1.enum_in_onetree_source.set(localqcd.jdField_b_of_type_Int);
            }
            if (localqcd.c != -1) {
              localReportInfo1.enum_in_videochannel_source.set(localqcd.c);
            }
            if (localqcd.d != -1) {
              localReportInfo1.uint32_current_video_time.set(localqcd.d);
            }
            if (localqcd.e != -1) {
              localReportInfo1.uint32_video_duration.set(localqcd.e);
            }
            if ((localReportInfo.mOpSource == 5) && (localqcd.f != -1)) {
              localReportInfo1.uint32_onetree_video_from_type.set(localqcd.f);
            }
          }
    ...
    return pow.a("OidbSvc.0x64e", 1614, 0, localReqBody.toByteArray());
  }
  ...
  private ToServiceMsg b(List<ReportInfo> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localReportInfo.mFolderStatus == 0) {
          localReportInfo.mFolderStatus = onk.d;
        }
        localReportInfo1.enum_op_source.set(3);
        localReportInfo1.uint32_folder_status.set(localReportInfo.mFolderStatus);
        localReportInfo1.enum_operation.set(localReportInfo.mOperation);
        localReportInfo1.bytes_device_id.set(ByteStringMicro.copyFromUtf8(onk.h()));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (long l1 = paramToServiceMsg.uint64_uin.get();; l1 = 0L)
    {
      ...
      if ((paramToServiceMsg.AIOPulseMaxCnt.has()) && (paramToServiceMsg.firstScnRedPntPulseMaxCnt.has()) && (paramToServiceMsg.leftBtmRedPntPulseMaxCnt.has()))
      {
        ...
        bhvh.a(onk.a(), l1, l2, l3);
      }
      if ((paramToServiceMsg.lastRecvMsgDuration.has()) && (paramToServiceMsg.lastSendMsgDuration.has())) {
        bhvh.a((int)paramToServiceMsg.lastRecvMsgDuration.get(), (int)paramToServiceMsg.lastSendMsgDuration.get());
      }
      if ((paramToServiceMsg.pulseTimerDuration.has()) && (paramToServiceMsg.pulseTimerDuration.get() != 12345678L)) {
        ota.a().b((int)paramToServiceMsg.pulseTimerDuration.get());
      }
      if (paramToServiceMsg.leftBtmRedCntMaxForExitAIO.has()) {
        bhvh.f((int)paramToServiceMsg.leftBtmRedCntMaxForExitAIO.get());
      }
      if ((paramToServiceMsg.uint64_main_video_tab_red.has()) && (paramToServiceMsg.uint64_main_video_tab_red.get() > 0L)) {
        ((KandianMergeManager)onk.a().getManager(162)).a(new KandianRedDotInfo("kandian_video_tab_reddot_info"));
      }
      if (paramToServiceMsg.uint64_scroll_interval_time.has()) {
        otm.jdField_a_of_type_Long = paramToServiceMsg.uint64_scroll_interval_time.get();
      }
      if (paramToServiceMsg.uint64_scroll_all_time.has()) {
        otm.jdField_b_of_type_Long = paramToServiceMsg.uint64_scroll_all_time.get();
      }
      if (paramToServiceMsg.uint64_chat_aio_time.has()) {
        ota.c = paramToServiceMsg.uint64_chat_aio_time.get();
      }
      ...
      if (paramToServiceMsg.idle_push_wake_param.has()) {
        sip.a(paramToServiceMsg.idle_push_wake_param.get());
      }
      if (paramToServiceMsg.msg_srt_rule_list.has()) {
        ong.a().a(paramToServiceMsg.msg_srt_rule_list.get());
      }
      if (QLog.isColorLevel()) {
  ...
  {
    int i = pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0x64e.RspBody());
    if (QLog.isColorLevel()) {
  ...
  {
    int i = pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0xde0.RspBody());
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, List<oidb_cmd0x80a.AttributeList> paramList, String paramString2, int paramInt3)
  {
    ...
    if (axmt.b())
    {
      ...
      localReqBody.uint32_privacy_status.set(shh.b());
      if (!bhvh.j()) {
        break label223;
      }
    ...
    for (;;)
    {
      ...
      a(pow.a(paramString2, paramInt3, 0, localReqBody.toByteArray()));
      return;
      i = 0;
      break;
      label223:
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      bbmj.a(paramString, 0, l);
      paramString[4] = 0;
      bbmj.a(paramString, 5, (short)1);
      bbmj.a(paramString, 7, jdField_a_of_type_Int);
      paramString = pow.a("OidbSvc.0x480_9", 1152, 9, paramString);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      bbmj.a(paramString, 5, (short)1);
      bbmj.a(paramString, 7, jdField_a_of_type_Int);
      bbmj.a(paramString, 9, (short)2);
      bbmj.a(paramString, 11, (short)paramInt);
      paramString = pow.a("OidbSvc.0x4ff_9", 1279, 9, paramString);
      paramString.extraData.putBoolean("reqFromReadinjoyHandler", true);
      a(paramString);
      return;
    }
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean, pca parampca, int paramInt)
  {
    a(paramString, String.valueOf(paramLong), paramBoolean, parampca, paramInt);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, pca parampca)
  {
    a(paramString1, paramString2, paramBoolean, parampca, 2);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, pca parampca, int paramInt)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        ...
        Object localObject1 = pow.a("OidbSvc.0x978", 2424, 0, ((oidb_cmd0x978.ReqBody)localObject2).toByteArray());
        paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampca));
  ...
  public void a(ArrayList<paa> paramArrayList, pbz parampbz, int paramInt)
  {
    a(paramArrayList, true, parampbz, paramInt);
  }
  
  protected void a(ArrayList<paa> paramArrayList, boolean paramBoolean, pby parampby, int paramInt)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
      QLog.d("UserOperationModule", 2, "batch0x978, followList = " + paramArrayList + ", isFollow = " + paramBoolean + ", callback = " + parampby + ", refer = " + paramInt);
    }
    ...
    {
      localObject = (paa)paramArrayList.get(i);
      oidb_cmd0x978.OneFollowOperationInfo localOneFollowOperationInfo = new oidb_cmd0x978.OneFollowOperationInfo();
      localOneFollowOperationInfo.uint64_dst_uin.set(Long.valueOf(((paa)localObject).jdField_a_of_type_Long).longValue());
      localOneFollowOperationInfo.uint32_op_account_type.set(((paa)localObject).jdField_a_of_type_Int);
    ...
    paramArrayList = pow.a("OidbSvc.0x978", 2424, 0, paramArrayList.toByteArray());
    paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampby));
  ...
  public void a(pyq parampyq, Context paramContext)
  {
    ThreadManager.executeOnSubThread(new UserOperationModule.4(this, parampyq, paramContext));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg.getAttribute("distUin") != null)
    {
      ...
      paramToServiceMsg = (pby)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(i);
      localObject2 = new oidb_cmd0x978.RspBody();
      i = pow.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject2);
    ...
    if (bool)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          paramObject.add(new paa(l, i, bool));
          break;
        }
      }
    ...
    while (paramFromServiceMsg.hasNext())
    {
      ...
      {
        osj.a().a(Long.valueOf((String)localObject1).longValue(), paramObject.enum_follow_status.get());
  ...
  public void b(ArrayList<paa> paramArrayList, pbz parampbz, int paramInt)
  {
    a(paramArrayList, false, parampbz, paramInt);
  }
