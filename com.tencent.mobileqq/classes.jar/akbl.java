...
public abstract class akbl
{
  ...
  public akbl(AppRuntime paramAppRuntime)
  {
  ...
  public static String a(String paramString, int paramInt)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        akco.a(paramString, paramInt, NetConnInfoCenter.getServerTimeMillis());
        return str;
      }
    }
    return null;
  ...
  {
    return akgj.c + paramAppRuntime.getAccount() + "/" + ".preloaduni" + "/";
  }
  ...
  public abstract void a(DownloadParam paramDownloadParam, akbj paramakbj);
  ...
  public void c(String paramString, akbj paramakbj)
  {
