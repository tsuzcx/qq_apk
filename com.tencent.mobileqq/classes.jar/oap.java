...
public class oap
  extends oxe
{
  public oap(ReadInJoyVideoSubChannelActivity paramReadInJoyVideoSubChannelActivity) {}
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      Object localObject2 = owy.a().a(ReadInJoyVideoSubChannelActivity.c(this.a), ((Long)localObject1).longValue());
    ...
    label270:
    this.a.jdField_a_of_type_Ore.b = 0L;
    paramList = this.a;
  ...
  public void b(int paramInt, List<Long> paramList)
  {
    ...
    ReadInJoyVideoSubChannelActivity.a(this.a).b(owy.a().a(Integer.valueOf(ReadInJoyVideoSubChannelActivity.c(this.a)), paramList));
