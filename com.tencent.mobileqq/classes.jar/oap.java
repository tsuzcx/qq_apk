...
public class oap
{
  ...
  public static void a(ProteusInnerData paramProteusInnerData, int paramInt)
  {
    ...
    nmc.a(new nyd().a(localQQAppInterface).a(BaseApplication.getContext()).a(nmc.a).b(nmc.W).a(oas.a(paramProteusInnerData)).d(paramInt).d(nmc.a(paramProteusInnerData)).a());
  }
}
