  ...
  extends Drawable
{
  ...
  protected bggf(Drawable paramDrawable1, Drawable paramDrawable2)
  {
  ...
  protected void onBoundsChange(Rect paramRect)
  {
    ...
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(BaseApplicationImpl.getApplication().getResources(), bgjc.a(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable));
