  ...
  extends bdol
{
  ...
  public bdtd()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bdte(this);
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdtf(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBundle = paramBundle.getDrawable(2130841729);
        if (TextUtils.isEmpty(this.ac))
        {
          ...
          paramView.setContentDescription(paramBundle.getString(2131694067));
          paramView.setDisplayRuleDef(biwr.a);
          paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
          paramView.setContentDescription(paramBundle.getText(2131718373));
        }
      }
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    this.ae = parambdqc.a("video_info");
