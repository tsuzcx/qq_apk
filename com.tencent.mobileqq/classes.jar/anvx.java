...
public class anvx
  extends Handler
{
  public anvx(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      return;
    case 3: 
      this.a.jdField_a_of_type_Anvy.a(1, false);
      return;
    case 4: 
      i = paramMessage.arg1;
      k = paramMessage.arg2;
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        paramMessage = (anws)paramMessage.obj;
        if (paramMessage.a)
        {
          i = 2;
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        {
          this.a.jdField_a_of_type_Anvy.c();
          bool1 = true;
        }
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_Anvy.a(paramMessage, ((Boolean)localObject).booleanValue(), i, bool2, bool1);
          ...
          paramMessage = (anwq)paramMessage.obj;
          if (this.a.b == 0)
          {
          ...
          for (;;)
          {
            ...
            this.a.jdField_a_of_type_Ajlf.a(this.a.app.getCurrentAccountUin(), true);
            ...
            paramMessage = this.a.getResources().getString(2131626683);
            bbmy.a(this.a, 0, paramMessage, 0).b(this.a.getTitleBarHeight());
            return;
            this.a.a();
            return;
            this.a.jdField_a_of_type_Anvy.b();
            return;
            this.a.f();
            return;
            Face2FaceAddFriendActivity.a(this.a, (anwq)paramMessage.obj);
            return;
            Face2FaceAddFriendActivity.a(this.a, paramMessage.arg1);
            return;
            this.a.a((anwn)paramMessage.obj);
            return;
            paramMessage = this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
            while (paramMessage.hasNext())
            {
              localObject = (anwq)paramMessage.next();
              if ((((anwq)localObject).a == 1) && (Face2FaceAddFriendActivity.a(this.a, ((anwq)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((anwq)localObject).a);
              } else if ((((anwq)localObject).a == 2) && (this.a.a(((anwq)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((anwq)localObject).a);
              }
            }
            long l = this.a.o;
            paramMessage = new anwr(l + 2396794490L + "", "Member " + this.a.o, 1, 1, "");
            localObject = this.a;
            ...
            return;
            if (!(paramMessage.obj instanceof anwr)) {
              break;
            }
            paramMessage = (anwr)paramMessage.obj;
            this.a.a(paramMessage);
            return;
            if (!(paramMessage.obj instanceof anwr)) {
              break;
            }
            this.a.jdField_a_of_type_JavaUtilArrayList.add((anwr)paramMessage.obj);
            return;
            if (!(paramMessage.obj instanceof anwr)) {
              break;
            }
            Face2FaceAddFriendActivity.a(this.a).a((anwr)paramMessage.obj);
            return;
