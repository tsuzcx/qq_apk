...
public class bkao
{
  private bkap jdField_a_of_type_Bkap = new bkap();
  private WadlJsBridge jdField_a_of_type_ComTencentOpenWadlWadlJsBridge = new WadlJsBridge(null, null, this.jdField_a_of_type_Bkap);
  
  public void a()
  {
    this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.doOnDestroy();
    this.jdField_a_of_type_Bkap = null;
  }
  
  public void a(bkaq parambkaq)
  {
    this.jdField_a_of_type_Bkap.a(parambkaq);
  }
  ...
  public boolean a(String paramString1, String paramString2, int paramInt, ArrayList<WadlResult> paramArrayList)
  {
    ...
    if ((paramString1.equals(localWadlParams.a)) && (paramString2.equals(localWadlParams.jdField_e_of_type_JavaLangString)) && (paramInt == localWadlParams.jdField_e_of_type_Int) && (!TextUtils.isEmpty(localWadlResult.b)) && (auog.a(localWadlResult.b))) {
      bool1 = false;
    }
    for (;;)
    {
