  ...
  implements awmy
{
  ...
  bgnw(String paramString, int paramInt1, int paramInt2)
  {
  ...
  public awmz a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localawmz.jdField_a_of_type_Float = (m / k);
        localawmz.jdField_a_of_type_Int = ((int)(this.jdField_a_of_type_Int * localawmz.jdField_a_of_type_Float * localawmz.jdField_a_of_type_Float + 0.5F));
        if (localawmz.jdField_a_of_type_Int <= i * 1024) {
          break label382;
        }
        localawmz.jdField_a_of_type_Int = (i * 1024);
        paramInt2 = paramInt1;
        if (this.jdField_b_of_type_Int <= paramInt1) {
          paramInt2 = this.jdField_b_of_type_Int;
        }
        localawmz.jdField_b_of_type_Int = paramInt2;
        localawmz.jdField_b_of_type_Boolean = a();
        if (QLog.isColorLevel()) {
          QLog.d("TroopHomeworkHelper", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localawmz.jdField_b_of_type_Boolean);
        }
        return localawmz;
      }
      ...
      continue;
      label382:
      if (localawmz.jdField_a_of_type_Int < j * 1024)
      {
        localawmz.jdField_a_of_type_Int = (j * 1024);
        continue;
        paramInt2 = 0;
        paramInt1 = 0;
        j = 0;
