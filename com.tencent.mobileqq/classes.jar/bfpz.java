...
public class bfpz
{
  ...
  public static int a(String paramString, java.io.File paramFile)
  {
    ...
    //   15: ifeq +231 -> 246
    //   18: getstatic 35	bfqa:a	Lbfqa;
    //   21: astore 4
    //   23: aload 4
    //   25: ifnull +395 -> 420
    //   28: aload_0
    //   29: invokestatic 38	bfpz:a	(Ljava/lang/String;)[Ljava/lang/String;
    //   32: astore 5
    //   34: new 40	java/lang/StringBuilder
    //   37: dup
    //   38: invokespecial 43	java/lang/StringBuilder:<init>	()V
    //   41: aload 4
    //   43: invokevirtual 47	bfqa:toString	()Ljava/lang/String;
    ...
    //   134: astore 4
    //   136: iload_2
    //   137: invokestatic 98	bfpz:a	(I)Z
    //   140: ifeq +133 -> 273
  ...
  public static HttpResponse a(Context paramContext, String paramString, HttpEntity paramHttpEntity, bfqc parambfqc)
  {
    return a(false).execute(a(paramContext, paramString, paramHttpEntity, parambfqc));
  }
  ...
  public static HttpPost a(Context paramContext, String paramString, HttpEntity paramHttpEntity, bfqc parambfqc)
  {
    ...
    a(paramContext, (HttpRequest)localObject, parambfqc);
    return localObject;
  }
  
  private static void a(Context paramContext, HttpRequest paramHttpRequest, bfqc parambfqc)
  {
    boolean bool1;
    if (parambfqc != null)
    {
    ...
    label90:
    for (boolean bool2 = parambfqc.b;; bool2 = false)
    {
