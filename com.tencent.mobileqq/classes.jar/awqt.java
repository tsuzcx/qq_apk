...
public class awqt
{
  ...
  {
    awqs.a();
    awqs.a.jdField_a_of_type_Long = d;
    awqs.a.p = g;
    String str1;
    String str2;
    if (awql.a().e() == 2)
    {
      awqs.a.q = e;
      if (d > 0L) {
        awqs.a.jdField_a_of_type_Double = (jdField_c_of_type_Long * 1000.0D / d);
      }
      if (jdField_a_of_type_Boolean)
      {
        str1 = awqu.a(jdField_b_of_type_Long);
        str2 = awqu.a(jdField_a_of_type_Long);
        if (d != 0L) {
          break label120;
        }
        awqu.b(jdField_a_of_type_JavaLangString, "transport speed error", new Object[0]);
      }
    }
    label120:
    do
    {
      ...
      awqs.a.q = f;
      break;
      awqu.b(jdField_a_of_type_JavaLangString, "transport speed sSizeCache.size = %d, sLogs.size = %d", new Object[] { Integer.valueOf(jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.size()), Integer.valueOf(jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size()) });
      long l1 = jdField_c_of_type_Long * 1000L / d;
      awqu.b(jdField_a_of_type_JavaLangString, "transport speed totalLength = %d B, totalElipse = %d ms", new Object[] { Long.valueOf(jdField_c_of_type_Long), Long.valueOf(d) });
      String str3 = awqu.a(l1);
      awqu.b(jdField_a_of_type_JavaLangString, "transport speed max = %s, min = %s, average = %s", new Object[] { str1, str2, str3 });
    } while (awql.a().e() != 2);
    awqu.b(jdField_a_of_type_JavaLangString, anni.a(2131705701), new Object[] { Long.valueOf(e) });
  }
  ...
  public static void a(long paramLong)
  {
    if (jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(paramLong)))
    {
      ...
      if (localLong != null)
      {
        awqu.b(jdField_a_of_type_JavaLangString, "transport complete complete = %d", new Object[] { localLong });
  ...
  {
    awqu.b(jdField_a_of_type_JavaLangString, "transport reset", new Object[0]);
  ...
  public static void b(long paramLong1, long paramLong2)
  {
    ...
    awqu.b(jdField_a_of_type_JavaLangString, "transport increment = %d sMaxSpeed = %d, sMinSpeed = %d", new Object[] { Long.valueOf(paramLong2), Long.valueOf(jdField_b_of_type_Long), Long.valueOf(jdField_a_of_type_Long) });
    awqu.b(jdField_a_of_type_JavaLangString, "transport storeSpeed increment = %s", new Object[] { awqu.a(paramLong2) });
  ...
  public static void d()
  {
    if ((jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_start")) && (jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_end")))
    {
      ...
      awqu.b(jdField_a_of_type_JavaLangString, "pure qianchu time cost = %d,pb_pack cost time = %d ", new Object[] { Long.valueOf(h), Long.valueOf(i) });
    }
  }
  ...
  public static void f()
  {
    if ((jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_start")) && (jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_end")))
    {
      ...
      awqu.b(jdField_a_of_type_JavaLangString, "pure qianru time cost = %d ", new Object[] { Long.valueOf(l) });
      awqu.b(jdField_a_of_type_JavaLangString, "pure daoru time cost = %d,pb_unpack cost time = %d ", new Object[] { Long.valueOf(j), Long.valueOf(k) });
    }
  }
}
