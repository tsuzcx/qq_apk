...
public class rdv
{
  private static String jdField_a_of_type_JavaLangString = Environment.getExternalStorageDirectory().getAbsolutePath() + "/tencent/MobileQQ/pddata/" + "proteus/";
  ...
  public rdv(String paramString1, String paramString2)
  {
  ...
  private File a(String paramString1, String paramString2)
  {
    ...
    //   22: invokestatic 61	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    ...
    //   36: aload_0
    //   37: invokespecial 63	rdv:a	()Ljava/lang/String;
    ...
    //   55: invokespecial 68	java/io/File:<init>	(Ljava/lang/String;)V
    //   58: astore 6
    //   60: aload 6
    //   62: invokevirtual 71	java/io/File:getParentFile	()Ljava/io/File;
    //   65: invokestatic 76	rdy:a	(Ljava/io/File;)Z
    //   68: pop
    //   69: aload 6
    //   71: invokevirtual 80	java/io/File:exists	()Z
    //   74: ifne +11 -> 85
    //   77: aload 6
    //   79: invokevirtual 83	java/io/File:isDirectory	()Z
    //   82: ifeq +8 -> 90
    //   85: aload 6
    //   87: invokevirtual 86	java/io/File:deleteOnExit	()V
    //   90: new 88	java/io/BufferedOutputStream
    //   93: dup
    //   94: new 90	java/io/FileOutputStream
    //   97: dup
    //   98: aload 6
    //   100: invokespecial 93	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   103: invokespecial 96	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   106: astore_3
    //   107: new 98	java/io/ByteArrayInputStream
    //   110: dup
    //   111: aload_1
    //   112: invokevirtual 104	java/lang/String:getBytes	()[B
    //   115: invokespecial 107	java/io/ByteArrayInputStream:<init>	([B)V
    //   118: astore_1
    //   119: aload_1
    //   120: astore 5
    //   122: aload_3
    ...
    //   125: aload_1
    //   126: aload_3
    //   127: invokestatic 110	rdy:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   130: pop2
    //   131: aload_1
    //   132: invokestatic 113	rdy:a	(Ljava/io/Closeable;)V
    //   135: aload_3
    //   136: invokestatic 113	rdy:a	(Ljava/io/Closeable;)V
    //   139: aload 6
    //   141: areturn
    //   142: astore 6
    //   144: aconst_null
    ...
    //   176: aload 6
    //   178: invokestatic 119	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   181: aload_1
    //   182: invokestatic 113	rdy:a	(Ljava/io/Closeable;)V
    //   185: aload_3
    //   186: invokestatic 113	rdy:a	(Ljava/io/Closeable;)V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aconst_null
    ...
    //   196: astore_3
    //   197: aload 5
    //   199: invokestatic 113	rdy:a	(Ljava/io/Closeable;)V
    //   202: aload_3
    //   203: invokestatic 113	rdy:a	(Ljava/io/Closeable;)V
    //   206: aload_1
    //   207: athrow
    //   208: astore_1
    //   209: aconst_null
  ...
  private String a()
  {
    return jdField_a_of_type_JavaLangString + obz.a() + "/" + this.c + "/" + "styles";
  }
  
  private boolean a()
  {
    if (this.d == null) {}
    while (!this.d.equals(obz.a())) {
      return true;
    }
    return false;
  }
  ...
  public rdw a(boolean paramBoolean)
  {
    Object localObject3;
    Object localObject1;
    if ((paramBoolean) && (this.jdField_a_of_type_Boolean) && (!a()))
    {
      localObject3 = rdw.a(this.jdField_b_of_type_JavaLangString, false);
    ...
    {
      this.d = obz.a();
      localObject1 = new rdw();
      ((rdw)localObject1).a(rdm.a());
      ((rdw)localObject1).b(this.jdField_b_of_type_JavaLangString);
      ((rdw)localObject1).a(3);
      l = System.currentTimeMillis();
      for (;;)
      {
        try
        {
          localObject3 = new rds(a());
          localObject4 = ((rdq)localObject3).a();
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          rdw localrdw = null;
          return localrdw;
          Object localObject5 = rdz.a((InputStream)localObject5);
          a(localrdw, new JSONObject((String)localObject5), false);
        ...
        if (localIterator.hasNext())
        {
          ...
          try
          {
            ...
            localObject5 = ((rdq)localObject3).a((String)localObject4);
  ...
  public void a(rdw paramrdw, JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramrdw.a(str1, str2, (String)localJSONObject.keys().next());
      localProteusParser.createViewTemplate(paramrdw, localJSONObject, null);
