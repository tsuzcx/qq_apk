...
public class qbx
{
  ...
  public static qbx a(articlesummary.RecommendFollowInfos paramRecommendFollowInfos)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      localqbx.jdField_a_of_type_Boolean = bool;
      if (paramRecommendFollowInfos.bytes_account_next_cookie.has()) {
        localqbx.jdField_a_of_type_ArrayOfByte = paramRecommendFollowInfos.bytes_account_next_cookie.get().toByteArray();
      }
      localqbx.jdField_a_of_type_Int = paramRecommendFollowInfos.uint32_card_style.get();
      localqbx.jdField_a_of_type_JavaLangString = paramRecommendFollowInfos.bytes_card_title.get().toStringUtf8();
      localqbx.jdField_b_of_type_JavaLangString = paramRecommendFollowInfos.bytes_jump_url.get().toStringUtf8();
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        localqbx.jdField_a_of_type_JavaUtilList.add(localRecommendFollowInfo);
        if ((localqbx.jdField_a_of_type_Int == 2) && (!TextUtils.isEmpty(localRecommendFollowInfo.className)))
        {
    ...
    if (!((HashMap)localObject2).isEmpty())
    {
      ...
      while (paramRecommendFollowInfos.hasNext())
      {
        ...
        {
          localObject3 = new qbb();
          ((qbb)localObject3).jdField_a_of_type_JavaLangString = ((String)((Map.Entry)localObject1).getKey());
          ((qbb)localObject3).jdField_a_of_type_JavaUtilList = ((List)localObject2);
          localqbx.jdField_b_of_type_JavaUtilList.add(localObject3);
        }
      }
    }
    return localqbx;
  ...
  public static qbx a(oidb_0xc2f.GetFollowUserRecommendListRsp paramGetFollowUserRecommendListRsp)
  {
    qbx localqbx = new qbx();
    localqbx.jdField_b_of_type_JavaLangString = paramGetFollowUserRecommendListRsp.bytes_jump_url.get().toStringUtf8();
