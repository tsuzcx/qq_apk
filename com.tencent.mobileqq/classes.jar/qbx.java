  ...
  public HashMap<String, String> a()
  {
    ...
    for (String str = "";; str = this.jdField_a_of_type_JavaLangString)
    {
      ...
      if (this.jdField_a_of_type_Int == 2)
      {
        ...
        localHashMap.put("param_device_info", qla.a(false));
      }
      ...
      localHashMap.put("param_prepareOptimizeConfigJson", onk.j());
      localHashMap.put("param_httpbuffertime_for_playpreload", String.valueOf(bhvh.f()));
      localHashMap.put("param_dynamic_buffer_switch", String.valueOf(bhvh.g()));
      localHashMap.put("param_dynamic_buffer_config_json", bhvh.b());
