  ...
  extends usp
{
  ...
  public vbx(QQAppInterface paramQQAppInterface)
  {
  ...
  void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Uxh;
      this.jdField_a_of_type_Uxh = null;
  ...
  void b(int paramInt)
  {
    ...
    ArkAppCenter.a().post(new vca(this, localWeakReference, paramInt));
  }
  ...
  public boolean b(String paramString)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    if (!((ArkAppSSO)localObject).a(str, paramString, this.jdField_a_of_type_Int, i, new vby(this, localWeakReference)))
    {
