  ...
  implements ailp
{
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        localObject3 = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).e(paramString);
        if (localObject3 == null) {
          continue;
        }
        localObject1 = localObject2;
      ...
      finally
      {
        try
        {
          ...
          int n;
          int i1;
          bdla.b(paramQQAppInterface, "CliOper", "", "", "Free_call", "Free_call_tips", 0, 0, "", "", "", "");
          int i = 1;
          if (!QLog.isColorLevel()) {
            continue;
          }
            ...
            else
            {
              ...
              if (localObject4 == null)
              {
                ...
                if (paramBoolean)
                {
                  ...
                  localObject2 = new NewIntent(paramQQAppInterface.getApp(), bcwc.class);
                  localObject1 = paramString;
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    paramVarArgs.findViewById(2131374262).setOnClickListener(new aikj(this));
    return paramVarArgs;
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      {
        return;
        localarpb = arpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (!localarpb.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 1)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("FriendHotTipsBar", 2, "hasNetTipShow today");
      return;
    } while ((a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, true) != 1) || (!this.jdField_a_of_type_Ailr.a(this, new Object[0])));
    ...
    localarpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 1);
  }
