...
public class qfi
  extends nac
{
  public qfi(RIJRedPacketManager paramRIJRedPacketManager, int paramInt, qft paramqft) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      for (;;)
      {
        ...
        int n;
        label634:
        this.jdField_a_of_type_Qft.a(false);
        label663:
        label669:
    ...
    if (((cmd0xe23.GetConsumeInfoItem)paramBundle.rpt_consume_info_item.get()).need_record.has())
    {
      ...
      if (((cmd0xe23.GetConsumeInfoItem)paramBundle.rpt_consume_info_item.get()).next_request_time.has())
      {
        ...
        else
        {
          ...
          {
            break label812;
            paramArrayOfByte = this.jdField_a_of_type_Qft;
