...
{
  avig(SoftReference paramSoftReference, URLDrawable paramURLDrawable, avii paramavii) {}
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    do
    {
      ...
      localAbstractGifImage.setStrongGIFPlayOnceListener(new avih(this, localAbstractGifImage));
      paramURLDrawable.setVisibility(0);
      paramURLDrawable.setImageDrawable(this.jdField_a_of_type_ComTencentImageURLDrawable);
    } while (this.jdField_a_of_type_Avii == null);
    this.jdField_a_of_type_Avii.a();
  }
}
