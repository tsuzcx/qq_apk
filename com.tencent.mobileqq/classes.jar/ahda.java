...
{
  private afzp jdField_a_of_type_Afzp = new afzp();
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener;
  private bhud jdField_a_of_type_Bhud = new ahdc(this);
  private ArrayList<String> jdField_a_of_type_JavaUtilArrayList;
  private View.OnClickListener b;
  protected long c;
  
  public ahda(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new ahdb(this);
    this.jdField_a_of_type_Afzp.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
  ...
  {
    MessageForText localMessageForText = (MessageForText)bbzh.a(-1000);
  ...
  private CharSequence a(MessageRecord paramMessageRecord, CharSequence paramCharSequence, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (str = ((bdnt)paramCharSequence).d;; str = paramCharSequence.toString())
      {
        ...
        return new bdnt(str.substring(1), 13, i, paramMessageRecord);
      }
    } while (!str.endsWith("\n"));
    return new bdnt(str.substring(0, str.length() - 1), 13, i, paramMessageRecord);
  }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList, afwr paramafwr)
  {
    ...
    localArrayList.add(a(localSpannableStringBuilder1, localSpannableStringBuilder2));
    a(paramafwr, bdol.e(localSpannableStringBuilder1.toString()));
    return localArrayList;
  }
  
  private void a(afwr paramafwr, String paramString)
  {
    if (paramafwr.jdField_b_of_type_JavaLangStringBuilder == null) {
      paramafwr.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
    }
    if (e) {
      paramafwr.jdField_b_of_type_JavaLangStringBuilder.append(paramString);
    }
  }
  ...
  private void a(ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (alqc.a().c())
    {
      ...
      if (localObject != null) {
        if (((CharSequence)localObject).length() != alqc.a().a())
        {
          i = 1;
          if (i != 0) {
            break label234;
          }
          localObject = alqc.a().c();
        }
      }
    }
    label61:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramChatMessage.isMultiMsg) {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009D65", "0X8009D65", 3, 0, "3", "", "", "");
        }
        return;
        i = 0;
        break;
  ...
  private void a(ArrayList<bfqd> paramArrayList, ArrayList<TextView> paramArrayList1, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (i < m)
      {
        ...
        localObject2 = (bfqd)paramArrayList.get(i);
        if ((localObject2 == null) || (((bfqd)localObject2).jdField_b_of_type_Int == -1))
        {
        ...
        {
          localStringBuilder.append(((bfqd)localObject2).b());
          if (i != m - 1) {
            localStringBuilder.append(" ");
          }
    ...
    for (;;)
    {
      localTextView.setTag(2131366734, "school_troop_span");
      k = j;
      localObject2 = localObject1;
      break label139;
      if (((bfqd)localObject2).jdField_b_of_type_Int < localObject1.jdField_b_of_type_Int)
      {
        localObject1 = localObject2;
        j = i;
        continue;
        if (localObject1 != null)
        {
          localObject2 = new bfqd();
          ((bfqd)localObject2).jdField_a_of_type_Long = paramMessageRecord.uniseq;
          ((bfqd)localObject2).jdField_a_of_type_Int = localObject1.jdField_a_of_type_Int;
          ((bfqd)localObject2).jdField_a_of_type_JavaLangString = localObject1.jdField_a_of_type_JavaLangString;
          ((bfqd)localObject2).jdField_b_of_type_JavaLangString = localObject1.jdField_b_of_type_JavaLangString;
          ((bfqd)localObject2).jdField_b_of_type_Int = localObject1.jdField_b_of_type_Int;
          ((bfqd)localObject2).a(localStringBuilder.toString());
          ((bfqd)localObject2).c = localObject1.c;
          ((bfqd)localObject2).d = localObject1.d;
          ((Spannable)((TextView)paramArrayList1.get(j)).getText()).setSpan(new bfqe(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (bfqd)localObject2), ((bfqd)localObject2).c, ((bfqd)localObject2).d, 17);
  ...
  private boolean a(ahde paramahde)
  {
    return (paramahde.jdField_b_of_type_AndroidWidgetTextView != null) && (paramahde.jdField_a_of_type_AndroidWidgetTextView != null) && (paramahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView != null) && (paramahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView != null);
  }
  ...
  private void b(ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (alqc.a().c())
    {
      ...
      if (localObject1 != null) {
        if (((String)localObject1).length() == alqc.a().a())
        {
          i = 1;
          if (i != 0) {
            break label559;
          }
          localObject1 = alqc.a().c();
        }
      }
    }
    label515:
    ...
    for (;;)
    {
      ...
      {
        localObject2 = bgsg.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext());
      ...
      for (;;)
      {
        try
        {
          ...
          if (j == 1)
          {
            ...
            ((awmg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(174)).a.put(Long.valueOf(paramChatMessage.uniseq), paramChatMessage);
            ...
            aufz.a((Activity)this.jdField_a_of_type_AndroidContentContext, (Intent)localObject1, 21);
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005637", "0X8005637", 0, 0, "", "", "", "");
            ...
            if (paramChatMessage.isMultiMsg) {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009D66", "0X8009D66", 9, 0, "9", "", "", "");
            }
            return;
            i = 0;
            break;
  ...
  private void c(ChatMessage paramChatMessage, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((i != 0) || (str == null))
      {
        bljl.b(paramChatMessage).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage).a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
        bljv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, 0, paramChatMessage.istroop);
        label111:
      ...
      {
        if (paramChatMessage.isMultiMsg) {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009D67", "0X8009D67", 9, 0, "9", "", "", "");
        }
        return;
        i = 0;
        break;
        ...
        bljl.a(null, str).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage).a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
        break label111;
  ...
  {
    ahde localahde = (ahde)paramafwr;
    if (localahde.jdField_b_of_type_JavaLangStringBuilder == null) {
      localahde.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
    }
    Object localObject1 = (bftx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    if (QLog.isColorLevel()) {
      QLog.i("MixedMsgItemBuilder", 1, "getBubbleView: check is need refresh[" + localahde.jdField_a_of_type_Boolean + "]");
    }
    if ((!e) && (ahde.a(localahde) != null) && (ahde.a(localahde) == paramChatMessage.uniseq) && (!localahde.jdField_a_of_type_Boolean) && (TextUtils.isEmpty(paramChatMessage.getExtInfoFromExtStr("sens_msg_ctrl_info"))))
    {
      if (((bftx)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage))
      {
        localahde.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setRobotNextTipsView(true, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        return paramView;
      }
      localahde.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setRobotNextTipsView(false, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
      return paramView;
    }
    if ((paramChatMessage instanceof MessageForMixedMsg))
    {
      ...
      for (;;)
      {
        ...
        if ((localObject2 instanceof MessageForReplyText))
        {
          ...
          a(paramafwr, bdol.b(((MessageRecord)localObject2).msg));
        }
      }
      label351:
      paramBaseChatItemLayout = a(paramafwr, (MixedMsgLinearLayout)paramView, paramBaseChatItemLayout.msgElemList, paramafzq, paramBaseChatItemLayout);
      ahde.a(localahde, paramChatMessage.uniseq);
      localahde.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setRobotNextTipsView(((bftx)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage), this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
    }
    for (;;)
    {
      paramafwr = afyj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (paramafwr != null) {
        paramafwr.a(paramBaseChatItemLayout, this);
      }
      if (paramBaseChatItemLayout != null) {
        paramBaseChatItemLayout.setTag(localahde);
      }
      paramView = paramBaseChatItemLayout;
      if (localahde.jdField_a_of_type_Alqf == null) {
        break;
      }
      localahde.jdField_a_of_type_Alqf.b(paramChatMessage);
      ...
      if ((paramChatMessage instanceof MessageForLongMsg))
      {
        ...
        if (((MessageForLongMsg)localObject1).longMsgFragmentList != null)
        {
          ...
          {
            paramBaseChatItemLayout = a(((MessageForLongMsg)localObject1).longMsgFragmentList, localahde);
            paramBaseChatItemLayout = a(paramafwr, (MixedMsgLinearLayout)paramView, paramBaseChatItemLayout, paramafzq, paramChatMessage);
            ahde.a(localahde, paramChatMessage.uniseq);
          }
        }
      }
  ...
  {
    int i = 0;
    parambguh.a(this.jdField_a_of_type_AndroidContentContext.getString(2131691093));
    if ((paramChatMessage instanceof MessageForMixedMsg)) {
    ...
    {
      if (i != 0) {
        parambguh.a(2131365147, this.jdField_a_of_type_AndroidContentContext.getString(2131717281), 2130838922);
      }
  ...
  public MixedMsgLinearLayout a(afwr paramafwr, MixedMsgLinearLayout paramMixedMsgLinearLayout, List<MessageRecord> paramList, afzq paramafzq, MessageRecord paramMessageRecord)
  {
    ...
    if (paramMixedMsgLinearLayout == null)
    {
      ...
      paramList.setId(2131364379);
      paramList.setOrientation(1);
      paramList.setFocusable(false);
      paramList.setClickable(true);
      paramList.setMinimumHeight(afur.a(44.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      paramList.setPadding(2131296328, 2131296330, 2131296327, 2131296329);
      paramMixedMsgLinearLayout = new RelativeLayout.LayoutParams(-2, -2);
      paramMixedMsgLinearLayout.addRule(1, 2131368138);
      paramMixedMsgLinearLayout.addRule(3, 2131378460);
      paramMixedMsgLinearLayout.leftMargin = afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramMixedMsgLinearLayout.rightMargin = afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramList.setLayoutParams(paramMixedMsgLinearLayout);
      paramList.jdField_a_of_type_Bhud = this.jdField_a_of_type_Bhud;
      ahde.a((ahde)paramafwr, paramList);
      ((ahde)paramafwr).jdField_a_of_type_Alqf = new alqf();
      ((ahde)paramafwr).jdField_a_of_type_Alqf.a(paramList);
      ((ahde)paramafwr).jdField_a_of_type_Alqf.a(paramafwr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout, paramafwr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout);
    }
    ((ahde)paramafwr).e = -1;
    ((ahde)paramafwr).jdField_a_of_type_Boolean = false;
    paramList.a(localArrayList1, (ahde)paramafwr);
    if (bfqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) {}
    for (paramMixedMsgLinearLayout = (bfqc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(262);; paramMixedMsgLinearLayout = null)
    {
        ...
        if (i < j)
        {
          ...
          else if ((localObject1 instanceof MessageForReplyText))
          {
            if ((localView instanceof LinearLayout))
            {
              ...
              ((ViewGroup)localObject2).setId(2131364407);
              ((ViewGroup)localObject2).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
              ((ViewGroup)localObject2).setOnTouchListener(paramafzq);
              ((ViewGroup)localObject2).setOnLongClickListener(paramafzq);
              ((ViewGroup)localObject2).findViewById(2131371338).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
              ((ViewGroup)localObject2).findViewById(2131369181).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
              ((ViewGroup)localObject2).findViewById(2131378666).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      for (;;)
      {
        ...
        for (((LinearLayout.LayoutParams)localObject1).bottomMargin = BaseChatItemLayout.m;; ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0)
        {
          ...
          if ((localObject1 instanceof MessageForText))
          {
            ...
            if (!bftx.b(paramMessageRecord)) {
              break label715;
            }
            bftx.a((TextView)localObject2, (MessageRecord)localObject1);
            break label715;
          }
          if ((localObject1 instanceof MessageForPic))
          {
            ...
            tmp909_905[1] = 0;
            tmp909_905;
            localObject4 = ahdu.a(this.jdField_a_of_type_AndroidContentContext, (MessageForPic)localObject1, (ChatThumbView)localObject2, (int[])localObject3);
            ((ChatThumbView)localObject2).setTag(2131364393, localObject1);
            ((ChatThumbView)localObject2).setImageDrawable((Drawable)localObject4);
            String str = ((URLDrawable)localObject4).getURL().getProtocol();
            URL localURL = bdzx.a((ayye)localObject1, 65537);
            if (ahdu.a(this.jdField_a_of_type_AndroidContentContext, bley.a(((MessageForPic)localObject1).imageType), str.equals("chatthumb"), localObject3[0], localObject3[1], localURL))
            {
              ((URLDrawable)localObject4).setWatermarkDrawable(ahdu.a(), afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        ...
        paramList.setOnTouchListener(paramafzq);
        paramList.setOnLongClickListener(paramafzq);
        paramList.b = this.jdField_a_of_type_Bhud;
        return paramList;
        label1217:
        bool = false;
      }
  ...
  {
    ahde localahde = (ahde)paramafwr;
    if ((localahde.e != -1) && (a(localahde)))
    {
      localahde.jdField_b_of_type_AndroidWidgetTextView.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_Int);
      if ((paramapwt.jdField_a_of_type_Int == 0) || (!paramapwt.a()) || (bcnj.b()))
      {
        ...
        if (paramChatMessage.isSend())
        {
          ...
          localahde.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramafwr);
          localahde.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramafwr);
          localahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramafwr);
          localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramafwr);
          if (!paramChatMessage.isSend()) {
            break label206;
          }
        }
        ...
        {
          localahde.jdField_b_of_type_AndroidWidgetTextView.setLinkTextColor(paramafwr);
          localahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramafwr);
          localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramafwr);
          ImmersiveUtils.a(localahde.jdField_a_of_type_AndroidWidgetTextView, 0.9F);
          ImmersiveUtils.a(localahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
          ImmersiveUtils.a(localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
          return;
      ...
      {
        localahde.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-16777216);
        localahde.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-16777216);
        localahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(-16777216);
        localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTextColor(-16777216);
        if (paramapwt.c != 0) {
          break label404;
        }
      ...
      for (;;)
      {
        ...
        ImmersiveUtils.a(localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView, 0.9F);
        return;
        localahde.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramapwt.jdField_b_of_type_Int);
        localahde.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramapwt.jdField_b_of_type_Int);
        localahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramapwt.jdField_b_of_type_Int);
        localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTextColor(paramapwt.jdField_b_of_type_Int);
        break;
        label404:
        localahde.jdField_b_of_type_AndroidWidgetTextView.setLinkTextColor(paramapwt.c);
        localahde.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramapwt.c);
        localahde.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setLinkTextColor(paramapwt.c);
      }
    }
    if ((paramapwt.jdField_a_of_type_Int == 0) || (!paramapwt.a()) || (bcnj.b()))
    {
      ...
      label525:
      for (paramView = paramView.getColorStateList(2131167007);; paramView = paramView.getColorStateList(2131167006))
      {
        ahde.a(localahde).a(paramafwr, paramView);
        return;
        paramafwr = paramView.getColorStateList(2131167004);
        break;
      }
    }
    paramafwr = ColorStateList.valueOf(-16777216);
    paramView = paramView.getResources().getColorStateList(2131167006);
    if (paramapwt.jdField_b_of_type_Int != 0) {
      paramafwr = ColorStateList.valueOf(paramapwt.jdField_b_of_type_Int);
    }
    if (paramapwt.c != 0) {
      paramView = ColorStateList.valueOf(paramapwt.c);
    }
    ahde.a(localahde).a(paramafwr, paramView);
  }
  ...
  {
    paramafwr = (ahde)paramafwr;
    if (ahde.a(paramafwr) != null) {
      ahde.a(paramafwr).a(go.a(paramChatMessage));
    }
    if ((paramafwr.e != -1) && (a(paramafwr)))
    {
      paramChatMessage = go.a("");
      paramafwr.jdField_b_of_type_AndroidWidgetTextView.setTypeface(paramChatMessage);
      paramafwr.jdField_a_of_type_AndroidWidgetTextView.setTypeface(paramChatMessage);
      paramafwr.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTypeface(paramChatMessage);
      paramafwr.jdField_b_of_type_ComEtrumpMixlayoutETTextView.setTypeface(paramChatMessage);
    }
  }
  
  public void a(View paramView)
  {
    paramView = (ahde)afur.a(paramView);
    if ((paramView.jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForMixedMsg))
    {
      ...
      if (paramView.isSendFromLocal())
      {
        ...
        localbkho.a(new ahdd(this, paramView, localbkho));
        localbkho.show();
      }
    }
  }
  ...
  public void a(View paramView, bduk parambduk, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      Object localObject1 = (ahde)afur.a(paramView);
      paramView = null;
      Object localObject2;
      if ((((ahde)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForMixedMsg))
      {
        paramView = (MessageForMixedMsg)((ahde)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if ((ahde.a((ahde)localObject1) != null) && (paramView != null) && (paramView.msgElemList != null)) {
          for (paramView = paramView.msgElemList.iterator(); paramView.hasNext(); paramView = (MessageForPic)localObject2)
          {
            ...
            if ((localObject2 == null) || (((MessageRecord)localObject2).uniseq != parambduk.b) || (!(localObject2 instanceof MessageForPic)) || (((MessageForPic)localObject2).subMsgId != parambduk.c)) {
              break label68;
            }
          }
        }
      ...
      else
      {
        for (;;)
        {
          ...
          paramInt2 = ahde.a((ahde)localObject1).getChildCount();
          paramInt1 = 0;
          label232:
          Object localObject3;
          Object localObject4;
          ...
          {
            parambduk = ahde.a((ahde)localObject1).getChildAt(paramInt1);
            if ((parambduk instanceof ChatThumbView))
            {
              localObject2 = ((ChatThumbView)parambduk).getTag(2131364393);
              ...
              {
                parambduk = (ChatThumbView)parambduk;
                if (parambduk == null) {
                  break label577;
                }
                ...
                tmp247_243[1] = 0;
                tmp247_243;
                localObject2 = ahdu.a(this.jdField_a_of_type_AndroidContentContext, paramView, parambduk, (int[])localObject1);
                localObject3 = ((URLDrawable)localObject2).getURL().getProtocol();
                localObject4 = bdzx.a(paramView, 65537);
                boolean bool = ahdu.a(this.jdField_a_of_type_AndroidContentContext, bley.a(paramView.imageType), ((String)localObject3).equals("chatthumb"), localObject1[0], localObject1[1], (URL)localObject4);
                parambduk.setImageDrawable((Drawable)localObject2);
                if (!bool) {
                  break label567;
                }
                ((URLDrawable)localObject2).setWatermarkDrawable(ahdu.a(), afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
                ((URLDrawable)localObject2).setWatermarkVisibility(0);
                return;
                if (!(((ahde)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForLongMsg)) {
                  break label585;
                }
                localObject2 = (MessageForLongMsg)((ahde)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
                ...
                if (((MessageRecord)localObject3).uniseq != parambduk.b) {
                  break label579;
                }
            ...
            if ((localObject3 instanceof MessageForMixedMsg))
            {
              ...
              for (;;)
              {
                if (((Iterator)localObject3).hasNext())
                {
                  ...
                  if (((localObject4 instanceof MessageForPic)) && (((MessageForPic)localObject4).subMsgId == parambduk.c))
                  {
  ...
  {
    paramView = (ahde)paramView.getTag();
    int i = BaseChatItemLayout.h;
    if (paramChatMessage.isSend())
    {
      ahde.a(paramView).setPadding(ahkf.f, i, ahkf.e, ahkf.d);
      return;
    }
    ahde.a(paramView).setPadding(ahkf.e, i, ahkf.f, ahkf.d);
  }
  
  public void a(View paramView, boolean paramBoolean)
  {
    Object localObject = (ahde)afur.a(paramView);
    if ((!paramBoolean) && ((paramView instanceof ChatThumbView))) {
      ((ChatThumbView)paramView).a(paramView, true);
    }
    localObject = ahde.a((ahde)localObject).getBackground();
    if (localObject != null) {
      if (!paramBoolean) {
        break label56;
      }
  ...
  public bguj[] a(View paramView)
  {
    ...
    if (localChatMessage != null)
    {
      ...
      a(localbguh, localChatMessage, null);
    }
    for (;;)
    {
      return localbguh.a();
      label45:
      b(localbguh, localChatMessage, paramView);
    }
  }
  ...
  public bguh b(bguh parambguh, ChatMessage paramChatMessage, afxj paramafxj)
  {
    ...
    for (;;)
    {
      ...
      a(parambguh, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramafxj.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
