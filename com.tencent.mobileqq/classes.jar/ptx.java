...
public class ptx
  extends ptr<String, DynamicChannelDataModel>
{
  private ptw a;
  
  public ptx(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    super(paramActivity, paramRecyclerViewWithHeaderFooter, paramInt);
    this.jdField_a_of_type_Ptw = new ptw();
    this.jdField_a_of_type_Ptw.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 0);
  }
  ...
  {
    if (this.jdField_a_of_type_Ptw.a(paramInt))
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        return new pty(this, (View)localObject);
      }
  ...
  public void a(blij paramblij, int paramInt)
  {
    ...
    {
      if (!this.jdField_a_of_type_Ptw.a(i)) {
        break label156;
      }
      if (i != pto.b) {
        break label136;
    ...
    for (;;)
    {
      ...
      return;
      label136:
      this.jdField_a_of_type_Ptw.a(localProteusItemView, i, localDynamicChannelDataModel, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label156:
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    {
      paramInt = i;
      if (this.jdField_a_of_type_Ptw.a((DynamicChannelDataModel)localObject))
      {
        i = this.jdField_a_of_type_Ptw.a((DynamicChannelDataModel)localObject);
