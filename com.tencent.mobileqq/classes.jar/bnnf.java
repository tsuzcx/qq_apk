...
public class bnnf
{
  ...
  public bnnf(Context paramContext)
  {
    ...
    this.e = paramContext.getDimensionPixelSize(2131296685);
    this.f = this.e;
    this.g = paramContext.getDimensionPixelOffset(2131296687);
    this.h = paramContext.getDimensionPixelOffset(2131296688);
    this.jdField_a_of_type_Bnnk = new bnnk();
  ...
  protected View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558864, null);
    this.jdField_a_of_type_Bnnk.a((RelativeLayout)localView.findViewById(2131362143));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          localObject4 = (GridView)localView.findViewById(2131367308);
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new bnnh(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            localObject1 = (GridView)localView.findViewById(2131367309);
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new bnnh(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new bnng(this));
            if (j == 0) {
