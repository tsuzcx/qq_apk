  ...
  extends PagerAdapter
{
  ...
  public bnhj(VideoFilterViewPager paramVideoFilterViewPager)
  {
  ...
  public void a(List<QIMFilterCategoryItem> paramList)
  {
    ...
    if (!bnhb.a().c()) {
      bnhb.a(this.jdField_a_of_type_JavaUtilArrayList);
    }
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (View)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      if (localObject1 == null)
      {
        localObject2 = ((LayoutInflater)this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaVideoFilterViewPager.getContext().getSystemService("layout_inflater")).inflate(2131559034, null);
