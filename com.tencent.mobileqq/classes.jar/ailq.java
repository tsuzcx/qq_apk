...
class ailq
{
  ...
  public ailq(ailo paramailo)
  {
    this.jdField_a_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector = new HighFrequencyDetector(ailo.a(paramailo), ailo.a(paramailo));
    this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector = new HighFrequencyDetector(ailo.b(paramailo), ailo.b(paramailo));
  }
