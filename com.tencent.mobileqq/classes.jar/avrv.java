...
public class avrv
{
  ...
  private void b(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    int i;
    switch (((bmqn)localObject).jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      i = ((bmqn)localObject).jdField_b_of_type_Int;
      if (i > 99) {
    ...
    case 3: 
      ...
      i = ((bmqn)localObject).jdField_c_of_type_Int;
      ...
      return;
    case 2: 
      localObject = ((bmqn)localObject).jdField_b_of_type_JavaLangString;
      ...
      localRedTypeInfo.red_content.set(bggq.a(paramContext, 3.0F) + "");
      ...
      return;
    case 4: 
      paramContext = ((bmqn)localObject).jdField_b_of_type_JavaLangString;
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bcst.b(paramQQAppInterface, "dc00899", "Grp_tribe", "", "dynamic", "exp_tribe", 0, 0, i + "", "", "", "");
      return;
    }
  }
  ...
  protected void a(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    if (paramQQAppInterface != null)
    {
      if (!aqji.a(paramQQAppInterface, "redpoint_leba_show")) {
        break label356;
      }
      localObject = ((aqjm)paramQQAppInterface.getManager(269)).b();
      if (localObject == null) {
        break label263;
      }
      localObject = ((aqji)localObject).a(paramQQAppInterface);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.setMaxWidth(afur.a(200.0F, paramContext.getResources()));
        paramRedTouch.weight = 1.0F;
        paramRedTouch.width = 0;
        paramRedTouch.rightMargin = afur.a(4.0F, paramContext.getResources());
  ...
  public void a(QQAppInterface paramQQAppInterface, ayaa paramayaa, RedTouch paramRedTouch)
  {
    int i = 1;
    int j = 1;
    ...
    {
      return;
      this.jdField_a_of_type_Int = paramayaa.d;
      this.jdField_b_of_type_Int = paramayaa.jdField_c_of_type_Int;
      switch (paramayaa.jdField_a_of_type_Int)
      {
      default: 
    ...
    } while ((TextUtils.isEmpty(paramayaa.jdField_b_of_type_JavaLangString)) && (TextUtils.isEmpty(paramayaa.jdField_c_of_type_JavaLangString)));
    BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
    if (!TextUtils.isEmpty(paramayaa.jdField_b_of_type_JavaLangString))
    {
      localRedTypeInfo.red_type.set(11);
      localRedTypeInfo.red_content.set(paramayaa.jdField_b_of_type_JavaLangString);
      ((BusinessInfoCheckUpdate.RedDisplayInfo)localObject).red_type_info.add(localRedTypeInfo);
    }
    for (i = 1;; i = 0)
    {
      if (!TextUtils.isEmpty(paramayaa.jdField_c_of_type_JavaLangString))
      {
        localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
        localRedTypeInfo.red_type.set(-100);
        localRedTypeInfo.red_content.set(paramayaa.jdField_c_of_type_JavaLangString);
        ((BusinessInfoCheckUpdate.RedDisplayInfo)localObject).red_type_info.add(localRedTypeInfo);
      }
      for (;;)
      {
        if ((i == 0) && (j != 0))
        {
          paramayaa = new BusinessInfoCheckUpdate.RedTypeInfo();
          paramayaa.red_type.set(0);
          ((BusinessInfoCheckUpdate.RedDisplayInfo)localObject).red_type_info.add(paramayaa);
        }
        ...
        paramQQAppInterface = (String)paramayaa.jdField_a_of_type_JavaUtilList.get(0);
        paramayaa = new BusinessInfoCheckUpdate.RedTypeInfo();
        paramayaa.red_type.set(3);
        paramayaa.red_content.set(paramQQAppInterface);
        paramayaa.red_desc.set("{'av':1, 'dot':1}");
        paramRedTouch.a(paramayaa);
        return;
        localObject = new BusinessInfoCheckUpdate.RedTypeInfo();
        ((BusinessInfoCheckUpdate.RedTypeInfo)localObject).red_type.set(5);
        paramQQAppInterface = paramayaa.jdField_b_of_type_Int + "";
        if (paramayaa.jdField_b_of_type_Int > 99) {
  ...
  protected void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    paramQQAppInterface = (njg)paramQQAppInterface.getManager(70);
    ...
    yqu.a("dynamic", "exp_story", 0, paramQQAppInterface.b(), new String[0]);
    BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
    ...
    case 35: 
      ...
      while (i != -1)
      {
        if (QLog.isColorLevel()) {
          QLog.i("storyRedDotDebug", 2, "更新动态红点:" + njg.a(localRedDotInfo));
        }
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            yqp.d("Q.lebatab.LebaSpecificRedTouch", "tag red dot json parse error , %s", new Object[] { localException.getMessage() });
          }
        }
        ...
        try
        {
          ...
          yqp.e("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: red display=%d", new Object[] { Long.valueOf(l) });
          if (l != 0L) {
            break label445;
          }
          paramRedTouch.d();
        ...
        {
          yqp.c("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: Error parse json: ", paramQQAppInterface);
          i = -1;
        }
      }
      label436:
      yqp.b("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: str_custom_buffer is null");
      label445:
      ...
      for (;;)
      {
        ...
        paramQQAppInterface = "https://p.qlogo.cn/gh/" + localRedDotInfo.uint64_cmd_uin.get() + "/" + localRedDotInfo.uint64_cmd_uin.get() + "/100?t=" + njg.d;
        localRedTypeInfo.red_content.set(paramQQAppInterface);
  ...
  {
    Object localObject2 = (baif)paramQQAppInterface.getManager(36);
    int i;
    if (localObject2 != null)
    {
      paramString2 = ((baif)localObject2).a(paramString1);
      if (paramString2 != null)
      {
        ...
        {
          paramString1 = null;
          localObject2 = ((baif)localObject2).a(paramString2);
          if (QLog.isColorLevel()) {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, RedTouch paramRedTouch, String paramString, Map<Long, avrx> paramMap, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilMap = paramMap;
    boolean bool = false;
    paramMap = String.valueOf(paramLong);
    if ((paramMap != null) && (bmqn.jdField_a_of_type_JavaLangString.equals(paramMap)))
    {
    ...
    {
      return bool;
      if (String.valueOf(noq.jdField_a_of_type_Int).equals(paramMap))
      {
        a(paramQQAppInterface, paramRedTouch);
        a(paramLong, paramRedTouch);
        return true;
      }
      if (bhtw.jdField_a_of_type_JavaLangString.equals(paramString))
      {
        bhtw.a(paramQQAppInterface, paramRedTouch);
        a(paramLong, paramRedTouch);
        return true;
      }
      if (7759L == paramLong)
