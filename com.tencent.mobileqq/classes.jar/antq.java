  ...
  implements Manager
{
  ...
  protected anwd a;
  private aopa jdField_a_of_type_Aopa = new ants(this, 3, true, true, 60000L, false, false, "TroopNotifyAndRecommendView");
  ...
  public antq(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(anhk.Y, 4001);
    int j;
  ...
  private void a(long paramLong, oidb_0x935.RspBody paramRspBody)
  {
    ...
    this.jdField_a_of_type_Anwd.notifyUI(29, true, this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      localObject1 = new NewIntent(paramAppInterface.getApplication(), niq.class);
      ...
      try
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          if (k == 0)
          {
            ...
            localObject = bbzh.a(-1039);
            String str = localRecommendTroopInfo.name;
            ((MessageRecord)localObject).extStr = localRecommendTroopInfo.uin;
            ((MessageRecord)localObject).init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), anhk.Y, "0", str, paramLong, -1039, 4001, 0L);
  ...
  private void e()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(anhk.W, 9000, b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      Object localObject = (antp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
      MessageRecord localMessageRecord = a();
      if ((localMessageRecord != null) && (!((antp)localObject).a(anhk.W, 9000, localMessageRecord.time))) {
        ((antp)localObject).a(anhk.W, 9000, anni.a(2131690949), localMessageRecord.time, localMessageRecord.time);
      }
  ...
  public MessageRecord a()
  {
    try
    {
      List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(anhk.Y, 4001);
      if ((localList != null) && (localList.size() > 0))
      {
        int i = localList.size() - 1;
        while (i >= 0)
  ...
  public String a()
  {
    try
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(anhk.Y, 4001);
  ...
  public void a(int paramInt1, oidb_0x935.GPS paramGPS, int paramInt2, BusinessObserver paramBusinessObserver)
  {
    ...
    for (long l1 = ((Long)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1)).longValue();; l1 = 0L)
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), niq.class);
  ...
  {
    a(2, paramGPS, paramInt, new antr(this, paramLong));
  }
  ...
  public void a(List<group_activity.GroupAct> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        paramList = bbzh.a(-1040);
        paramList.extStr = ((RecTroopBusinessItem)localObject).id;
        paramList.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), anhk.Y, "0", ((RecTroopBusinessItem)localObject).title, l, -1040, 4001, 0L);
      ...
      for (;;)
      {
        ...
        return;
        label396:
        a(paramList, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(anhk.Y, 4001));
      }
      paramList = null;
    }
  }
