...
public class wgu
  extends Handler
{
  public wgu(QRLoginAuthActivity paramQRLoginAuthActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 77313)
      {
        label263:
        this.a.c = "Windows";
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846079));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131717211, new Object[] { this.a.c }));
        if (TextUtils.isEmpty(this.a.d)) {
          this.a.d = this.a.getString(2131720649);
        }
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131717217, new Object[] { this.a.d }));
        if (!this.a.jdField_a_of_type_Boolean) {
          break label958;
        }
        this.a.jdField_b_of_type_AndroidWidgetButton.setVisibility(0);
        label410:
        axqw.b(null, "dc00898", "", "", "0X800A46D", "0X800A46D", wik.a(this.a.jdField_b_of_type_Int), 0, "", "", "", "");
        return;
        if (k == 32) {
          i = j;
        }
      ...
      for (;;)
      {
        ...
        {
          this.a.c = "Mac";
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846077));
          break;
        }
        if (this.a.jdField_b_of_type_Int == 3)
        {
          this.a.c = "iPad";
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846076));
          break;
        }
        if (wik.b(this.a.jdField_b_of_type_Int))
        {
          this.a.c = ajyc.a(2131711200);
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846078));
          break;
        }
        this.a.c = ajyc.a(2131711201);
        ...
        for (;;)
        {
          try
          {
            ...
            if (this.a.jdField_a_of_type_Bcpq.isShowing()) {
