...
public class bbvs
  implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, bbvo
{
  private int jdField_a_of_type_Int = 0;
  private MediaPlayer jdField_a_of_type_AndroidMediaMediaPlayer;
  private bbvp jdField_a_of_type_Bbvp;
  private bbvq jdField_a_of_type_Bbvq;
  private bbvr jdField_a_of_type_Bbvr;
  private int b;
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bbvq != null) {
      this.jdField_a_of_type_Bbvq.a(this.jdField_a_of_type_Int);
    }
  }
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Bbvp != null) {
      this.jdField_a_of_type_Bbvp.a(this);
    }
  }
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Bbvr != null) {
      this.jdField_a_of_type_Bbvr.a(this);
    }
    a();
    if (this.b > 0) {
      a(this.b);
