  ...
  extends aksu
{
  ...
  public apwd(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
  }
  
  private void a(UniformDownloadBPTransEntity paramUniformDownloadBPTransEntity, aktd paramaktd)
  {
    ...
    if (localUniformDownloadBPTransEntity.getStatus() == 1000) {
      paramaktd.a(localUniformDownloadBPTransEntity);
    }
    for (;;)
    {
      paramaktd.a();
  ...
  private UniformDownloadBPTransEntity b(String paramString)
  {
    ...
    localObject = localaukp.a(UniformDownloadBPTransEntity.class, (String)localObject, null);
    if (localObject == null)
    {
      localaukp.a();
      return null;
  ...
  private void c()
  {
    ...
    aukp localaukp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_JavaUtilList = localaukp.a(UniformDownloadBPTransEntity.class, (String)localObject, null);
    if (this.jdField_a_of_type_JavaUtilList == null) {
