  ...
  implements apts<String>
{
  ...
  public long a;
  public String a;
  public ArrayList<apwk> a;
  public int b;
  public String b;
  public ArrayList<String> b;
  public int c;
  public String c;
  public ArrayList<apwh> c;
  public int d;
  public ArrayList<apwg> d;
  public int e;
  public ArrayList<String> e;
  public int f;
  public ArrayList<String> f;
  public int g;
  public ArrayList<apwf> g;
  public int h;
  public int i;
  public int j;
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        localObject3 = new apwk();
        ((apwk)localObject3).jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("context", "");
        ((apwk)localObject3).jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("type", "");
        ((apwk)localObject3).jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(((JSONObject)localObject2).optBoolean("enable", false));
        ((apwk)localObject3).jdField_c_of_type_JavaLangString = ((JSONObject)localObject2).optString("regex", "");
        ((apwk)localObject3).d = ((JSONObject)localObject2).optString("tips", "");
        ArkAppCenter.c("AiKeywordConfig", String.format("onParse, ark_server_keyword_configs, name=%s, type=%s, enable=%s, pattern=%s, tip=%s", new Object[] { ((apwk)localObject3).jdField_a_of_type_JavaLangString, ((apwk)localObject3).jdField_b_of_type_JavaLangString, Boolean.toString(((apwk)localObject3).jdField_a_of_type_JavaLangBoolean.booleanValue()), ((apwk)localObject3).jdField_c_of_type_JavaLangString, ((apwk)localObject3).d }));
        if ((TextUtils.isEmpty(((apwk)localObject3).jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(((apwk)localObject3).jdField_b_of_type_JavaLangString)) || (!((apwk)localObject3).jdField_a_of_type_JavaLangBoolean.booleanValue()) || (TextUtils.isEmpty(((apwk)localObject3).jdField_c_of_type_JavaLangString)) || (TextUtils.isEmpty(((apwk)localObject3).d))) {
          break label1802;
        }
    ...
    if (localObject1 != null)
    {
      ...
      if (k < ((JSONArray)localObject1).length())
      {
        ...
        localObject2 = new apwh((String)localObject3, (String)localObject4, l1, l2);
    ...
    if (localObject1 != null)
    {
      ...
      if (k < m)
      {
        ...
        this.jdField_d_of_type_JavaUtilArrayList.add(new apwg((String)localObject2, (String)localObject3, (String)localObject4));
        break label1823;
      }
    }
        ...
        if (m < ((JSONArray)localObject1).length())
        {
          ...
          if (localObject5 != null)
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject3)) && (!TextUtils.isEmpty((CharSequence)localObject4)) && (!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject5)))
            {
              ...
              ((ArrayList)localObject2).add(new apwp((String)localObject3, (String)localObject4, str, (String)localObject5));
            }
          }
        }
        else
        {
          this.jdField_g_of_type_JavaUtilArrayList.add(new apwf(n, i1, null, (ArrayList)localObject2));
          break label1851;
          if (n <= 0) {
            break label1851;
          }
          ...
          this.jdField_g_of_type_JavaUtilArrayList.add(new apwf(n, i1, (String)localObject1, null));
          break label1851;
