...
public class amis
  implements amuu, Manager
{
  int jdField_a_of_type_Int = 0;
  amiw jdField_a_of_type_Amiw;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new amit(this);
  ...
  Comparator<ApolloActionData> jdField_a_of_type_JavaUtilComparator = new amiu(this);
  
  public amis(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetListView != null)
    {
      ...
      this.jdField_a_of_type_Amiw = null;
    }
  ...
  public void a(BaseChatPie paramBaseChatPie, ApolloActionData paramApolloActionData, int paramInt, String paramString)
  {
    ...
    if (amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      if (amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()) == 1) {
    ...
    for (;;)
    {
      ...
      paramBaseChatPie = (RelativeLayout)paramBaseChatPie.a().findViewById(2131364345);
      int i;
      if (this.jdField_a_of_type_ComTencentWidgetListView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetListView.setSelector(localBaseActivity.getResources().getDrawable(2130850664));
        this.jdField_a_of_type_ComTencentWidgetListView.setCacheColorHint(2131165486);
        ...
        i = afur.a(9.0F, localBaseActivity.getResources());
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, i);
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(localBaseActivity.getResources().getColor(2131166993));
        ...
        this.jdField_a_of_type_Amiw = new amiw(this, localBaseActivity);
        this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Amiw);
        localObject = new RelativeLayout.LayoutParams(afur.a(99.0F, localBaseActivity.getResources()), -2);
        ((RelativeLayout.LayoutParams)localObject).addRule(11);
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131368652);
        ((RelativeLayout.LayoutParams)localObject).rightMargin = afur.a(10.0F, localBaseActivity.getResources());
      ...
      try
      {
        for (;;)
        {
          ...
          if (paramBaseChatPie.getBoolean("first_show_resp", true))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131699323));
            this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130838433, 0);
          }
          else
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
            continue;
            paramBaseChatPie = bglf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
            paramBaseChatPie = String.format(anni.a(2131699325), new Object[] { paramBaseChatPie });
        ...
        this.jdField_a_of_type_Amiw.a(paramBaseChatPie, paramInt);
        return;
      }
  ...
  public void a(SpriteTaskParam paramSpriteTaskParam, long paramLong)
  {
    ...
    do
    {
      do
      {
        ...
        localApolloActionData = ((ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).b(i);
