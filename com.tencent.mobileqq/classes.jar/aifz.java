...
public class aifz
  extends amsu
{
  public aifz(SystemMsgListView paramSystemMsgListView) {}
  ...
  public void onGetConnectionsPerson(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramBoolean)
    {
      localaidm = SystemMsgListView.a(this.a).a();
      if ((localaidm != null) && (localaidm.a()) && (localaidm.a == paramInt2) && (!SystemMsgListView.a(this.a, paramInt2, paramInt3))) {
