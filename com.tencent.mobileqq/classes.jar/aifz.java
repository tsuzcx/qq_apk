  ...
  extends BaseChatPie
{
  ...
  private anvi jdField_a_of_type_Anvi = new aige(this);
  Comparator<MessageRecord> jdField_a_of_type_JavaUtilComparator = new aigc(this);
  private List<ChatMessage> jdField_a_of_type_JavaUtilList;
  private Long[] jdField_a_of_type_ArrayOfJavaLangLong;
  Comparator<MessageRecord> jdField_b_of_type_JavaUtilComparator = new aigd(this);
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  
  public aifz(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private void a()
  {
    ((aimf)this.helperProvider.a(59)).a(this.jdField_a_of_type_JavaUtilList);
  }
  ...
  private void a(View paramView)
  {
    ...
    paramView.b(2131690006);
    paramView.b(2131690007);
    paramView.c(2131690697);
    paramView.a(new aigb(this, paramView));
    paramView.show();
  }
  ...
  private void a(View paramView, int paramInt, bkzi parambkzi)
  {
    ...
    if (str.equals(paramView.getResources().getString(2131690006)))
    {
      a();
      bdla.b(null, "dc00898", "", "", "0X800AE92", "0X800AE92", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      parambkzi.dismiss();
      return;
      if (str.equals(paramView.getResources().getString(2131690007)))
      {
        b();
        bdla.b(null, "dc00898", "", "", "0X800AE93", "0X800AE93", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      ((aimn)this.app.getManager(QQManagerFactory.UPCOMING_MSG_PRE_MANAGER)).a(getActivity(), localChatMessage, this.sessionInfo.curFriendNick);
    }
  }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_ArrayOfJavaLangLong != null) && (this.jdField_a_of_type_ArrayOfJavaLangLong.length > 0))
    {
      ...
      if (i < j)
      {
        ...
        if (((localMessageRecord instanceof ChatMessage)) && (aimq.a(localMessageRecord))) {
  ...
  public boolean doOnCreate(boolean paramBoolean)
  {
    ...
    Object localObject2 = this.mAIORootView.findViewById(2131362559);
    if (localObject2 != null) {
      ((ViewGroup)localObject1).removeView((View)localObject2);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = new UpComingRelativeLayout(getActivity());
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131362559);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getActivity().getResources().getString(2131690009));
    ...
    this.jdField_a_of_type_Afqz = new afqz(this.app, this.mActivity, this.sessionInfo, this.mAnimContainer, this);
    this.jdField_a_of_type_Afqz.a = Boolean.valueOf(false);
    ...
    this.listView.setAdapter(this.jdField_a_of_type_Afqz);
    ...
    this.mTitleText.setText(getActivity().getResources().getString(2131690004));
    if (!this.isThemeDefault)
    {
      ...
      ((ImageView)localObject1).setOnClickListener(new aiga(this));
    ...
    for (;;)
    {
      ...
      if ((paramMessage.obj instanceof List))
      {
        ...
        if (this.jdField_a_of_type_JavaUtilList.size() <= 0)
        {
          ...
          bdla.b(null, "dc00898", "", "", "0X800AE95", "0X800AE95", 1, 0, "", "", "", "");
        }
        for (;;)
        {
          if (!QLog.isColorLevel()) {
          ...
          {
            QQToast.a(getActivity(), 0, 2131690010, 3000).a();
            bdla.b(null, "dc00898", "", "", "0X800AE95", "0X800AE95", 2, 0, "", "", "", "");
          }
          this.mTitleBtnRight.setVisibility(0);
          this.jdField_a_of_type_Afqz.a(localList, null);
        }
      }
    }
  }
  ...
  {
    alvw localalvw = (alvw)getHelper(4);
    return (localalvw != null) && (localalvw.a());
  }
  ...
  {
    bdla.b(null, "dc00898", "", "", "0X800AE91", "0X800AE91", 0, 0, "", "", "", "");
  }
