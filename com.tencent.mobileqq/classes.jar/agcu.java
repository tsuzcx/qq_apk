...
{
  private agdt jdField_a_of_type_Agdt;
  ...
  public agcu(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Agdt = new agdt(paramContext);
    this.jdField_a_of_type_Agdt.a(new agcv(this));
  }
  ...
  {
    this.jdField_a_of_type_JavaLangString = awzx.a(paramQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new agcx(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), paramQQAppInterface, new agcy(this));
      return;
    }
  ...
  public void a(agdf paramagdf)
  {
    ...
    if (awzx.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c))
    {
      a(localQQAppInterface);
      paramagdf.a(true);
      return;
    }
    awzx.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c, new agcw(this, paramagdf));
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Agdt != null)
    {
      this.jdField_a_of_type_Agdt.b();
      this.jdField_a_of_type_Agdt.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Agdt != null) && (this.jdField_a_of_type_Agdt.a())) {
      this.jdField_a_of_type_Agdt.d();
    }
