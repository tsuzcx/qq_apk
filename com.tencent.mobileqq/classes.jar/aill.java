...
{
  public aill(TroopNotifyAndRecommendView paramTroopNotifyAndRecommendView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    ((FriendListHandler)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).getFriendInfo(String.valueOf(((aikf)localObject).a.req_uin.get()));
    aimg.a((structmsg.StructMsg)((aikf)localObject).a.get());
    TroopNotifyAndRecommendView.a(this.a, (structmsg.StructMsg)((aikf)localObject).a.get(), ((aikf)localObject).c);
    String str1 = ((aikf)localObject).a.msg.group_info.msg_alert.get();
    String str2 = ((aikf)localObject).a.msg.group_code.get() + "";
    if ((str1 == null) || ("".equals(str1)))
    {
      TroopNotifyAndRecommendView.b(this.a, 1, (structmsg.StructMsg)((aikf)localObject).a.get());
      if ((((aikf)localObject).a.msg.has()) && (((aikf)localObject).a.msg.req_uin_nick.has())) {
        ((TroopManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(str2, ((aikf)localObject).a.req_uin.get() + "", ((aikf)localObject).a.msg.req_uin_nick.get());
      }
    ...
    for (;;)
    {
      ...
      break;
      TroopNotifyAndRecommendView.b(this.a, 0, (structmsg.StructMsg)((aikf)localObject).a.get());
    }
  }
}
