  ...
  implements ayst
{
  ...
  public aopu(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, aopt paramaopt)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, paramInt, paramaopt);
  }
  
  public static ayst a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, String paramString, aopt paramaopt)
  {
    if (paramaopt == null)
    {
    ...
    paramQQAppInterface = new aopu(paramQQAppInterface, paramLong1, paramLong2, 1, paramaopt);
  ...
  protected void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aysu != null)
    {
      ...
      this.jdField_a_of_type_Aysu.a(true, a(), paramInt, "", "", localBundle);
    }
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Aysu != null) {
      this.jdField_a_of_type_Aysu.a(paramLong2, this.jdField_a_of_type_Aopt.a());
    }
  }
  ...
  protected void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aysu != null) {
      this.jdField_a_of_type_Aysu.a(paramExcitingTransferDownloadCompletedInfo.m_strFileSavePath);
    }
  }
