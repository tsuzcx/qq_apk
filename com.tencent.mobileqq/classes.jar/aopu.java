...
public class aopu
{
  ...
  public static FullMessageSearchResult.SearchResultItem a(QQAppInterface paramQQAppInterface, EntityManager paramEntityManager, Cursor paramCursor, String paramString1, int paramInt, String paramString2, aops paramaops)
  {
    ...
    do
    {
      ...
      {
        if ((paramaops.c == 3) || (paramaops.c == 2)) {
          return null;
        }
        paramInt = 0;
  ...
  private static String a(byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte != null)
    {
      ...
      {
        AbsStructMsg localAbsStructMsg = bdow.a(paramArrayOfByte);
        localObject = str;
