...
public class bmtw
{
  ...
  public static void a(Context paramContext, bmtz parambmtz)
  {
    ...
    {
      if (parambmtz != null) {
        parambmtz.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = bmub.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    bmsl.a().a(b, str1, "SoHelper", new bmtx(str2, str1, parambmtz, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = bmtv.a(paramContext, "0", "key_local_so_version");
