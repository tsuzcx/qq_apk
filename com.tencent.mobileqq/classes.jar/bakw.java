...
import com.tencent.mobileqq.profilesetting.ProfileCardMoreActivity.7.1;
import com.tencent.mobileqq.profilesetting.ProfileCardMoreActivity.7.2;
...
public class bakw
  extends anyu
{
  public bakw(ProfileCardMoreActivity paramProfileCardMoreActivity) {}
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject2 = (anyw)this.a.app.getManager(51);
      ...
      if (localObject1 != null)
      {
        ...
        if ((localObject1 != null) && (!bhjx.a(this.a.jdField_c_of_type_JavaLangString, ((Groups)localObject1).group_name)))
        {
    ...
    for (Object localObject1 = "";; localObject1 = this.a.jdField_c_of_type_JavaLangString)
    {
      ...
      return;
      localObject1 = ((anyw)localObject2).e(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a);
      break;
    }
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a)) || (!bhjx.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a, paramString))) {}
    for (;;)
    {
      return;
      paramString = (anyw)this.a.app.getManager(51);
      if (paramString == null) {}
      for (paramString = null; (paramString != null) && (!bhjx.a(this.a.jdField_c_of_type_JavaLangString, paramString.group_name)); paramString = paramString.a(String.valueOf(paramByte1)))
      {
