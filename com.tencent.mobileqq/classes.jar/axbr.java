...
{
  public static int a;
  public static volatile HashMap<Integer, axcw> a;
  public static volatile List<bhjz> a;
  ...
  public static int b;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new axbs(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new CliNotifyPush.1(this);
  private volatile ArrayList<axcw> jdField_a_of_type_JavaUtilArrayList;
  private volatile ArrayList<axcw> b;
  private int c;
  ...
  private String a(ArrayList<axcw> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        localaxcw = (axcw)paramArrayList.next();
        if ((localaxcw != null) && (localaxcw.jdField_a_of_type_JavaUtilMap != null)) {
      ...
      else
      {
        try
        {
          localJSONObject.put("addTime", localaxcw.jdField_a_of_type_Long);
          localJSONObject.put("opUin", localaxcw.jdField_b_of_type_Long);
          Iterator localIterator = localaxcw.jdField_a_of_type_JavaUtilMap.keySet().iterator();
          while (localIterator.hasNext())
          {
            String str = (String)localIterator.next();
            localJSONObject.put(str, localaxcw.jdField_a_of_type_JavaUtilMap.get(str));
          }
      ...
      for (;;)
      {
        ...
        if ((this.c == 0) || (this.c == 10000))
        {
          ...
          if (this.jdField_a_of_type_JavaUtilArrayList != null)
          {
            ...
            while (localIterator.hasNext())
            {
              axcw localaxcw = (axcw)localIterator.next();
              a(localaxcw, (QQAppInterface)getAppRuntime(), 2L);
              a(localaxcw, true);
              a(localaxcw);
            }
          }
  ...
  private void a(int paramInt)
  {
    ...
    b(paramInt);
    bgxy.a((QQAppInterface)getAppRuntime(), "qzonenewservice.callqzonev2", paramInt, "CliNotifyPush", 1, System.currentTimeMillis());
  }
  
  private void a(axcw paramaxcw)
  {
    QLog.e("CliNotifyPush", 1, "dispathQzonePushMsg()");
    QQAppInterface localQQAppInterface = (QQAppInterface)getAppRuntime();
    if (localQQAppInterface == null) {}
    while ((paramaxcw == null) || (paramaxcw.jdField_a_of_type_JavaUtilMap == null)) {
      return;
    }
    Object localObject;
    if ((paramaxcw.jdField_a_of_type_JavaUtilMap != null) && (paramaxcw.jdField_a_of_type_JavaUtilMap.get("utime") != null) && (LocalMultiProcConfig.getInt4Uin("qzone_preget_passive_open", 0, localQQAppInterface.getLongAccountUin()) == 1))
    {
      localObject = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("utime");
      if (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", localQQAppInterface.getLongAccountUin()).equals(localObject))
      {
        paramaxcw.jdField_a_of_type_Boolean = true;
        int i = bhkl.a().a().a(localQQAppInterface.getLongAccountUin());
        jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(i), paramaxcw);
      }
    }
    if (a(localQQAppInterface, paramaxcw))
    {
      if (jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_b_of_type_JavaUtilArrayList.add(paramaxcw);
        return;
      }
      localObject = new ArrayList();
      ((ArrayList)localObject).add(paramaxcw);
  ...
  public static void a(axcw paramaxcw, QQAppInterface paramQQAppInterface, long paramLong)
  {
    if (paramaxcw == null) {
      return;
    }
    ...
    for (long l1 = Long.parseLong(paramQQAppInterface.getAccount());; l1 = 0L)
    {
      ...
      if (paramaxcw.jdField_a_of_type_Long != 0L)
      {
        l2 = paramLong;
        if (l1 != 0L)
        {
          localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), axcm.class);
          localNewIntent.putExtra("timestamp", paramaxcw.jdField_a_of_type_Long);
          localNewIntent.putExtra("hostuin", l1);
          if (!paramaxcw.jdField_b_of_type_Boolean) {
            break label230;
          }
        }
      }
      ...
      {
        String str2 = paramaxcw.jdField_a_of_type_JavaLangString;
        String str1;
        ...
        {
          str1 = str2;
          if (paramaxcw.jdField_a_of_type_JavaUtilMap != null) {
            str1 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("pushstatkey");
          }
        }
        ...
        l2 = paramLong;
        QLog.e("CliNotifyPush", 1, "sentQzoneMsfPushAck: localTimeStamp=" + paramaxcw.jdField_a_of_type_Long + " uin=" + l1 + " flag=" + l2);
        return;
      }
    }
  }
  
  private void a(axcw paramaxcw, boolean paramBoolean)
  {
    if ((paramaxcw == null) || (paramaxcw.jdField_a_of_type_JavaUtilMap == null)) {
    ...
    do
    {
      ...
      localaxch = (axch)((QQAppInterface)localObject1).getManager(10);
    } while (localaxch == null);
    for (;;)
    {
      int m;
      try
      {
        int k = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("pushtype"));
        QLog.i("CliNotifyPush", 1, "showRedTouch type:" + k + ",uin:" + paramaxcw.jdField_b_of_type_Long + ",isBackground_Pause:" + ((QQAppInterface)localObject1).isBackground_Pause);
        if ((k != 1) && (k != 300) && (k != 302)) {
          break;
        }
        localObject1 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("conent");
        m = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("count"));
        l = paramaxcw.jdField_b_of_type_Long;
        int i = 0;
        try
        {
          boolean bool = paramaxcw.jdField_a_of_type_JavaUtilMap.containsKey("opuin_qzoneVipLevel");
          if (!bool) {
            break label673;
          }
          i = 1;
        ...
        catch (Exception localException1)
        {
          try
          {
            j = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("opuin_qzoneVipLevel"));
            i = 1;
            ...
            paramaxcw.jdField_a_of_type_ArrayOfByte = bhnw.a(paramaxcw.jdField_a_of_type_ArrayOfByte);
            if (paramaxcw.jdField_a_of_type_ArrayOfByte != null)
            {
              localObject3 = (PassiveFeedsPush)bhnw.a(PassiveFeedsPush.class, paramaxcw.jdField_a_of_type_ArrayOfByte);
            ...
            localObject2 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("shcemaUrlAnd");
          }
          ...
          try
          {
            paramaxcw = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("psv_tab_textlist");
            if (!TextUtils.isEmpty(paramaxcw))
            {
              paramaxcw = new JSONObject(paramaxcw);
              paramaxcw.getJSONObject("psv_tab_list");
              paramaxcw = paramaxcw.getJSONObject("psv_tab_list").getJSONArray("text_data");
              i = 0;
              if (i < paramaxcw.length())
              {
                localObject4 = (JSONObject)paramaxcw.get(i);
          ...
          catch (Exception paramaxcw)
          {
            QLog.e("CliNotifyPush", 1, "psv_tab_textlist failed" + paramaxcw);
            if (k != 302) {
              break label644;
            }
          }
        }
        localaxch.a(1, m, localException1, (String)localObject1, paramBoolean, true, (String)localObject2);
        return;
      }
      catch (Exception paramaxcw)
      {
      ...
      label644:
      long l = m;
      localaxch.a(1, l, localException1, (String)localObject1, paramBoolean, true, "");
      return;
      label673:
      int j = 0;
    }
  ...
  private void a(ArrayList<axcw> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      while (localIterator.hasNext()) {
        ((axcw)localIterator.next()).a(true);
      }
      return;
    }
    catch (Exception localException)
    {
      jdField_a_of_type_Boolean = false;
      paramQQAppInterface.getHandler(axbr.class).removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
      ...
      paramQQAppInterface.getHandler(axbr.class).postDelayed(this.jdField_a_of_type_JavaLangRunnable, QzoneConfig.getInstance().getConfig("QZoneSetting", "CallQZoneWNSFromPushTimeout", 20000));
  ...
  private void a(Map<String, String> paramMap, String paramString)
  {
    ...
    try
    {
      ...
      localbhop.jdField_a_of_type_Int = Integer.parseInt((String)paramMap.get("key_ctrl_cmd"));
      localbhop.jdField_a_of_type_JavaUtilMap.putAll(paramMap);
      bhoo.a(paramString).a(localbhop);
      return;
    }
  ...
  private boolean a(axcw paramaxcw)
  {
    boolean bool = false;
    int i = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("pushtype"));
    QQAppInterface localQQAppInterface = (QQAppInterface)getAppRuntime();
    Object localObject;
    bhjz localbhjz2;
    if (i == 301) {
      ...
      {
        localObject = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("live_roomid");
        if (localObject != null)
        {
          localbhjz2 = (bhjz)jdField_a_of_type_JavaUtilList.get(jdField_a_of_type_JavaUtilList.size() - 1);
          if ((localbhjz2 == null) || (!((String)localObject).equals(localbhjz2.jdField_a_of_type_JavaLangString))) {
            break label257;
          }
          jdField_a_of_type_JavaUtilList.remove(localbhjz2);
    ...
    for (;;)
    {
      ...
      a(paramaxcw, localQQAppInterface, 16L);
      bool = true;
      return bool;
      label187:
      bhjz localbhjz1 = (bhjz)jdField_a_of_type_JavaUtilList.get(jdField_a_of_type_JavaUtilList.size() - 1);
      if (localbhjz1 != null)
      {
        bhjx.a().a(localQQAppInterface, 0, null, localbhjz1.b, null, null, localbhjz1.jdField_a_of_type_Boolean, localbhjz1.jdField_a_of_type_Int, localbhjz1.c, localbhjz1.d, false, false);
        continue;
        label257:
        if (jdField_a_of_type_JavaUtilList.size() > 1)
        {
          ...
          {
            localbhjz2 = (bhjz)jdField_a_of_type_JavaUtilList.get(i);
            if ((localbhjz2 != null) && (localbhjz1.equals(localbhjz2.jdField_a_of_type_JavaLangString))) {
              jdField_a_of_type_JavaUtilList.remove(localbhjz2);
            }
            i += 1;
          }
  ...
  private void b(int paramInt)
  {
    ...
    axrl.a(BaseApplication.getContext()).a(localQQAppInterface.getAccount(), "callqzonefrompushv2", true, 0L, 0L, localHashMap, null, true);
  }
  
  private void b(axcw paramaxcw)
  {
    QLog.e("CliNotifyPush", 1, "showPush()");
    if ((paramaxcw.jdField_a_of_type_Boolean) && (paramaxcw.jdField_a_of_type_Int == 0)) {
      paramaxcw.jdField_a_of_type_Int += 1;
    }
    ...
    do
    {
      ...
      m = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("pushtype"));
      QLog.e("CliNotifyPush", 1, "pushType:" + m);
      if (m == 10000)
      {
        a(paramaxcw.jdField_a_of_type_JavaUtilMap, localQQAppInterface.getAccount());
        a(paramaxcw, localQQAppInterface, 16L);
        return;
      }
      if (m == 350)
    ...
    String str1 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("conent");
    String str2 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("pushstatkey");
    String str3 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("shcemaUrlAnd");
    String str4 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("title");
    String str5 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("fake_push");
    String str6 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("icon_type");
    String str7 = (String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("icon_url");
    if (QLog.isColorLevel()) {
      QLog.d("CliNotifyPush", 2, new Object[] { "showPush: invoked. ", " iconType: ", str6, " title: ", str4, " message: ", str1 });
    }
    long l = paramaxcw.jdField_b_of_type_Long;
    if (paramaxcw.jdField_a_of_type_JavaUtilMap.get("count") != null) {
      QLog.i("CliNotifyPush", 1, "showPush receive push time:" + paramaxcw.jdField_a_of_type_Long + ",unreadCount=" + 1 + ",uin=" + l + ",type=" + m);
    }
    for (;;)
    {
      int j;
      ...
      try
      {
        j = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("count"));
        i = j;
        if (j < 1) {
          i = 1;
        }
      ...
      catch (Exception localException2)
      {
        try
        {
          j = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("CtrlFlag"));
          if (QLog.isColorLevel())
          {
            QLog.i("CliNotifyPush", 2, "qzone redtypeinfo:receive push time:" + paramaxcw.jdField_a_of_type_Long + "=unreadCount=" + i + "=uin=" + l + "=type=" + m + "=CtrlFlag=" + j + "=message=" + str1);
            if (j != 1) {
              continue;
            }
            bool1 = true;
        ...
        catch (Exception localException2)
        {
          try
          {
            k = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("show_level"));
            ...
            if (!a(localQQAppInterface, m))
            {
              ...
              j = 0;
              continue;
              QLog.i("CliNotifyPush", 1, "qzone redtypeinfo:receive push time:" + paramaxcw.jdField_a_of_type_Long + "=unreadCount=" + i + "=uin=" + l + "=type=" + m + "=CtrlFlag=" + j);
              continue;
              bool1 = false;
            }
          }
          catch (Exception localException3)
          {
            ...
            if (j == 1)
            {
              ...
              a(paramaxcw, localQQAppInterface, 128L);
              return;
            }
      ...
      for (;;)
      {
        if ((j != 0) && (!a(k, 0)))
        {
          a(paramaxcw, localQQAppInterface, 64L);
          return;
          j = 0;
        }
        else
        {
          ...
          {
            a(paramaxcw, localQQAppInterface, 512L);
            return;
          }
          boolean bool3;
          if (str1 != null)
          {
            ...
            str1 = localQQAppInterface.getApp().getApplicationContext().getString(2131718125) + i + localQQAppInterface.getApp().getApplicationContext().getString(2131718126);
          }
          label1112:
          label1122:
          for (;;)
          {
            ...
            {
              bool1 = bool2;
              if (paramaxcw.jdField_a_of_type_JavaUtilMap.get("daemonShow") != null) {
                bool1 = "1".equals(paramaxcw.jdField_a_of_type_JavaUtilMap.get("daemonShow"));
              }
            }
            if (bool1)
            {
              bhjx.a().a(localQQAppInterface, 1, str4, str1, str6, str7, bool3, m, str3, str2, true, "1".equals(str5));
              a(paramaxcw, localQQAppInterface, 4L);
            }
            QLog.e("CliNotifyPush", 1, "show push: XXX");
            return;
            a(paramaxcw, localQQAppInterface, 256L);
            return;
            a(paramaxcw, localQQAppInterface, 32L);
            return;
          }
          label1125:
          j = 0;
  ...
  private void c(axcw paramaxcw)
  {
    ...
    if ((paramaxcw.jdField_a_of_type_ArrayOfByte != null) && (paramaxcw.jdField_a_of_type_ArrayOfByte.length > 0)) {
      localIntent.putExtra("update_feeds_buffer", paramaxcw.jdField_a_of_type_ArrayOfByte);
    }
    for (;;)
    {
      BaseApplication.getContext().sendBroadcast(localIntent, "com.tencent.msg.permission.pushnotify");
      return;
      if ((paramaxcw.jdField_a_of_type_JavaUtilMap != null) && ((paramaxcw.jdField_a_of_type_JavaUtilMap instanceof HashMap))) {
        localIntent.putExtra("update_feeds", (HashMap)paramaxcw.jdField_a_of_type_JavaUtilMap);
      }
    }
  }
  
  /* Error */
  private void d(axcw paramaxcw)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   3: ifnull +10 -> 13
    //   6: aload_1
    //   7: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   10: ifnonnull +4 -> 14
    //   13: return
    //   14: aload_1
    //   15: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   18: ldc_w 880
    //   21: invokeinterface 188 2 0
    //   26: checkcast 24	java/lang/String
    //   29: astore 6
    //   31: aload_1
    //   32: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   35: ldc_w 882
    ...
    //   73: istore_2
    //   74: aload_0
    //   75: invokevirtual 233	axbr:getAppRuntime	()Lmqq/app/AppRuntime;
    ...
    //   97: aload 7
    //   99: aload_1
    //   100: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   122: invokestatic 739	axrl:a	(Landroid/content/Context;)Laxrl;
    //   125: aload 6
    ...
    //   138: aconst_null
    //   139: iconst_1
    //   140: invokevirtual 744	axrl:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   143: return
    ...
    //   147: aload 6
    //   149: invokestatic 896	axbr:a	(Landroid/content/Context;Ljava/lang/String;)Z
    //   152: istore 5
    //   154: iload 5
    //   156: ifeq +212 -> 368
    //   159: aload_1
    //   160: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   163: ldc_w 898
    ...
    //   191: istore_3
    //   192: aload_1
    //   193: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   196: ldc_w 900
    ...
    //   226: aload 6
    //   228: invokestatic 902	axbr:a	(Landroid/content/Context;Ljava/lang/String;)I
    //   231: istore 4
    //   233: iload 4
    //   235: iload_3
    ...
    //   245: aload_0
    //   246: aload_1
    //   247: getfield 159	axcw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   250: aload 6
    //   252: aload 7
    //   254: invokevirtual 905	axbr:a	(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V
    //   257: iconst_0
    //   258: istore_2
    //   259: goto +133 -> 392
    //   262: astore 8
  ...
  public Map<Integer, axcw> a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 1) || (i == 2) || (i == 4) || (i == 301) || (i == 8) || (i == 300) || (i == 10000) || (i == 302) || (i == 350) || (i == 100))
      {
        ...
        if (QzoneConfig.getInstance().getConfig("QZoneSetting", "PushDeduplication", 1) == 1)
        {
          ...
          a(new axcw(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark), localQQAppInterface, 8L);
          a(2014);
          break;
        ...
        {
          axcw localaxcw = (axcw)((Map)localObject1).get(Integer.valueOf(i));
          if ((localaxcw != null) && (localaxcw.jdField_a_of_type_Long < localSingleMsg.addTime))
          {
            ((Map)localObject1).put(Integer.valueOf(i), new axcw(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark, localSingleMsg.extBuffer));
            QLog.e("CliNotifyPush", 1, "PushDeduplication: msg localTimeStap:" + localSingleMsg.addTime + " sm newTimeStap:" + localaxcw.jdField_a_of_type_Long + " msg:" + (String)localaxcw.jdField_a_of_type_JavaUtilMap.get("conent"));
            a(localaxcw, localQQAppInterface, 8L);
            label713:
      ...
      for (;;)
      {
        ...
        if (i == 7066) {
          ...
          a(new axcw(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark), localQQAppInterface, 256L);
        }
      }
      if (l3 < l1) {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, axcw paramaxcw)
  {
    ...
    try
    {
      if ((paramaxcw.jdField_a_of_type_JavaUtilMap.containsKey("CtrlFlag")) && (Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("CtrlFlag")) == 1))
      {
    ...
    catch (Exception localException)
    {
      ...
      int j = Integer.parseInt((String)paramaxcw.jdField_a_of_type_JavaUtilMap.get("pushtype"));
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (axcw)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i));
    ...
    b((axcw)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i)));
  }
}
