  ...
  implements DialogInterface.OnClickListener, Handler.Callback, View.OnClickListener
{
  ...
  private volatile aush jdField_a_of_type_Aush;
  ...
  public autr(auto paramauto, View paramView, boolean paramBoolean)
  {
    this.jdField_a_of_type_Auto = paramauto;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131373003);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373002));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131372996);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131372998);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372997));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372999));
    paramView.findViewById(2131373000).setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131369997);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370010));
    paramView.findViewById(2131369999).setOnClickListener(this);
    paramView.findViewById(2131370008).setOnClickListener(this);
    this.jdField_a_of_type_MqqOsMqqHandler = new blha(Looper.getMainLooper(), this, true);
    this.jdField_b_of_type_MqqOsMqqHandler = new blha(ThreadManagerV2.getFileThreadLooper(), this, false);
    this.jdField_c_of_type_MqqOsMqqHandler = new blha(ThreadManagerV2.getSubThreadLooper(), this, false);
    a();
  }
  ...
  private String a()
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      if (((localObject instanceof String)) && (!TextUtils.isEmpty((String)localObject))) {
        return str + " " + BaseApplicationImpl.sApplication.getString(2131697520) + ":" + localObject;
      }
      return str;
    }
    return null;
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 2) {
      paramString = BaseApplicationImpl.sApplication.getResources().getString(2131693965);
    }
    if (!TextUtils.isEmpty(paramString))
    {
      autq.a(1, paramString, true);
      return;
    }
    paramString = BaseApplicationImpl.sApplication.getResources();
    if (this.jdField_a_of_type_Boolean) {}
    for (int i = 2131697504;; i = 2131697505)
    {
  ...
  private void a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      a();
      return;
      this.jdField_a_of_type_Auto.a(paramBitmap, paramInt, paramString);
  ...
  {
    AppInterface localAppInterface = this.jdField_a_of_type_Auto.a().getAppInterface();
    if ((localAppInterface instanceof QQAppInterface))
    {
      Message localMessage = new Message();
      localMessage.what = 9;
      localMessage.obj = new Object[] { (QQAppInterface)localAppInterface, paramFileManagerEntity, this.jdField_a_of_type_Auto.a(), Boolean.valueOf(this.jdField_a_of_type_Boolean), paramString };
  ...
  private void a(String paramString)
  {
    ...
    localObject = this.jdField_a_of_type_Auto.a().getAppInterface();
  ...
  private void b(Object[] paramArrayOfObject)
  {
    ...
    {
      paramArrayOfObject = localQQAppInterface.a().a().a(paramArrayOfObject, null, new autu(this, paramArrayOfObject, null));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Aush = paramArrayOfObject;
      i = 0;
      continue;
      i = 2;
    }
  ...
  private void c(Object[] paramArrayOfObject)
  {
    ...
    a(1.0F);
    this.jdField_a_of_type_Aush = null;
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Boolean) {}
    for (int i = 2131697496;; i = 2131697498)
    {
  ...
  private void e()
  {
    ...
    {
      this.jdField_a_of_type_Bhpc = new bhpc(this.jdField_a_of_type_Auto.a(), 2131755824);
      this.jdField_a_of_type_Bhpc.setContentView(2131559008);
      this.jdField_a_of_type_Bhpc.setTitle(2131697506);
    ...
    label130:
    for (int i = 2131697508;; i = 2131697507)
    {
      localbhpc.setMessage(i);
      this.jdField_a_of_type_Bhpc.setNegativeButton(2131690580, this);
      this.jdField_a_of_type_Bhpc.setPositiveButton(2131697509, this);
  ...
  private void e(Object[] paramArrayOfObject)
  {
    ...
    Object localObject2 = (autp)paramArrayOfObject[2];
    boolean bool1 = ((Boolean)paramArrayOfObject[3]).booleanValue();
    paramArrayOfObject = (String)paramArrayOfObject[4];
    if (bhnv.d(BaseApplicationImpl.sApplication))
    {
      long l = autq.a(((autp)localObject2).jdField_a_of_type_Int);
      if (auog.b(paramArrayOfObject))
      {
        aurp localaurp = ((QQAppInterface)localObject1).a().a();
        if (!((autp)localObject2).jdField_a_of_type_Boolean) {
          break label222;
        }
        localObject1 = ((autp)localObject2).jdField_a_of_type_JavaLangString;
        label113:
        boolean bool2 = ((autp)localObject2).jdField_b_of_type_Boolean;
        i = ((autp)localObject2).jdField_a_of_type_Int;
        if (!((autp)localObject2).jdField_a_of_type_Boolean) {
          break label228;
        }
        localObject2 = ((autp)localObject2).jdField_a_of_type_JavaLangString;
        label141:
        localaurp.a(localFileManagerEntity, l, (String)localObject1, bool2, bool1, new autt(this, i, (String)localObject2, paramArrayOfObject, bool1, null));
      }
    }
    for (int i = 0;; i = 2)
    {
  ...
  private void f()
  {
    FileManagerEntity localFileManagerEntity = this.jdField_a_of_type_Auto.a();
    String str2 = this.jdField_a_of_type_Auto.b();
    ...
    this.jdField_a_of_type_Auto.b();
    Object localObject = this.jdField_a_of_type_Auto.a();
    String str1;
    if (this.jdField_a_of_type_Boolean)
    {
      str1 = "0X800A9D7";
      String str3 = autq.b(((autp)localObject).jdField_a_of_type_Int);
      if (!this.jdField_a_of_type_Boolean) {
        break label138;
      }
      localObject = null;
      label104:
      autq.a(str1, str3, (String)localObject);
      if (!autq.a(localFileManagerEntity, false)) {
        break label149;
      }
    ...
    for (;;)
    {
      ...
      break;
      label138:
      localObject = autq.a(((autp)localObject).jdField_a_of_type_Boolean);
      break label104;
      label149:
      a(str2);
    }
  ...
  private void g(Object[] paramArrayOfObject)
  {
    ...
    try
    {
      paramArrayOfObject = autq.a((String)localObject, bhtq.a(184.0F));
  ...
  private void h()
  {
    ...
    {
      autq.a("0X800A9D9", null, null);
      this.jdField_a_of_type_Auto.a(null);
    }
  }
  ...
  public void a()
  {
    ...
    label147:
    for (int i = 2131697495;; i = 2131697497)
    {
      localTextView.setText(i);
  ...
  public void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            localObject1 = this.jdField_a_of_type_Auto.a();
          } while ((localObject1 == null) || (((BaseActivity)localObject1).isFinishing()));
          if (bhnv.d((Context)localObject1)) {
            break;
          }
    ...
    case 2: 
      ...
      auxu.a((Activity)localObject1, paramActionSheetItem, 1, -1);
      return;
    case 3: 
      ...
      bmtd.a((Activity)localObject1, paramActionSheetItem, "", ((BaseActivity)localObject1).getString(2131691912), str, 2);
      return;
    case 9: 
    case 10: 
    ...
    auxu.a((Activity)localObject1, paramActionSheetItem, ForwardRecentTranslucentActivity.class, 1, -1, "");
  }
  ...
  public void b()
  {
    aush localaush = this.jdField_a_of_type_Aush;
    this.jdField_a_of_type_Aush = null;
    if (localaush != null) {
      localaush.a();
    }
  ...
  public boolean b()
  {
    return this.jdField_a_of_type_Aush != null;
  }
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    BaseActivity localBaseActivity = this.jdField_a_of_type_Auto.a();
    if (this.jdField_a_of_type_Boolean) {}
    for (paramDialogInterface = "an_qq_qrcode_overcapacity";; paramDialogInterface = "an_qq_link_overcapacity")
    {
      boch.a(localBaseActivity, paramDialogInterface, false);
      return;
    }
  }
