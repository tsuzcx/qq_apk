...
public class bclg
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString2.putExtra("selfSet_leftViewText", alud.a(2131713877));
    if (behc.a.containsKey("robotsummary")) {
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt)
  {
    ...
    paramString5 = aepi.a(new Intent(paramContext, SplashActivity.class), null);
    if (paramInt == 1)
    {
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", alud.a(2131713879));
    if (behc.a.containsKey("robotsummary")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      paramString1 = alud.a(2131713878) + paramString2;
      localObject2 = new azup(StructMsgForGeneralShare.class).c(14).a(alud.a(2131713881) + paramString3).a(2).a(1).a("web", paramQQAppInterface, (String)localObject2, (String)localObject1, (String)localObject1).d(paramActivity.getResources().getString(2131719139)).a();
      azyr localazyr = new azyr();
      localazyr.b(1);
      localazyr.a(alud.a(2131713880));
      azxl localazxl = new azxl();
      localazxl.b(1);
      localazxl.a(new azwv((String)localObject1));
      localazxl.a(new StructMsgItemTitle(paramString3));
      localazxl.a(new azzm(paramString1));
      ((AbsShareMsg)localObject2).addItem(localazyr);
      ...
      aryv.a(paramActivity, (Intent)localObject2, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      azqs.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", paramString3, "");
      return;
    }
    catch (Exception paramString2)
    {
      azqs.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "0", "", paramString3, "");
    }
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ((bcpg)localObject).a(paramBoolean, paramString);
      return;
    }
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    ((amdu)localQQAppInterface.a(20)).a(paramString1, paramString2, paramString3, Boolean.valueOf(paramBoolean));
    return true;
  }
  ...
  public static String b(String paramString)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return bdgc.a((QQAppInterface)localAppRuntime, paramString, false);
    }
    return null;
  }
