...
{
  oew(oev paramoev, int paramInt, JSONObject paramJSONObject, Context paramContext, MessageRecord paramMessageRecord) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      if ((oev.a(this.jdField_a_of_type_Oev) != null) && (oev.a(this.jdField_a_of_type_Oev).isShowing())) {
        oev.a(this.jdField_a_of_type_Oev).dismiss();
      }
      ...
      if (!bhsr.a((String)localObject))
      {
        ...
        ((oer)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(139)).a(8, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        ...
        ((oer)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(139)).a(7, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getString(2131692048), 1).a();
      }
    }
  }
