...
public class akdz
  extends Handler
{
  public akdz(QQAppInterface paramQQAppInterface, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 990)
    {
      ...
      if (QLog.isColorLevel()) {
        bbjc.a("Q.qqhead.broadcast", 2, "headQQHeadBroadcast, user getQQHead resp uinList: ", paramMessage);
      }
    }
    do
    {
      do
      {
        do
        {
          ...
          bbjc.a("Q.qqhead.broadcast", 2, "headQQHeadBroadcast, group getQQHead resp uinList: ", paramMessage);
          return;
        ...
        bbjc.a("Q.qqhead.broadcast", 2, "headQQHeadBroadcast, dis getQQHead resp uinList: ", paramMessage);
        return;
    ...
    bbjc.a("Q.qqhead.broadcast", 2, "headQQHeadBroadcast, newGroup getQQHead resp uinList: ", paramMessage);
  }
}
