  ...
  implements ayyt
{
  ...
  public awmk(MessageForMixedMsg paramMessageForMixedMsg, Map<String, List<Integer>> paramMap, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
  ...
  private void a(MessageForMixedMsg paramMessageForMixedMsg)
  {
    ...
    if (paramMessageForMixedMsg.istroop == 1)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        njo.a().a(localMessageRecord);
      }
    }
    awmg.a(this.jdField_a_of_type_Awmg, this.jdField_a_of_type_Awmg.a, paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.istroop, paramMessageForMixedMsg, true);
  }
  ...
  public void b(ayyu paramayyu)
  {
    ...
    {
      localObject1 = new ErrorMessage(paramayyu.jdField_b_of_type_Int, paramayyu.jdField_a_of_type_JavaLangString);
      QLog.d("MixedMsgManager", 2, "reqUploadMultiPics UiCallBack success result = " + paramayyu + ", error = " + localObject1);
    }
    if (paramayyu.jdField_b_of_type_Int != 0) {
      awmg.a(this.jdField_a_of_type_Awmg, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "send Msg fail: " + paramayyu);
    }
    do
    {
      do
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject2 instanceof MessageForPic))
        {
          ...
          ((MessageForPic)localObject2).md5 = paramayyu.d;
          ((MessageForPic)localObject2).uuid = paramayyu.c;
          ((MessageForPic)localObject2).size = paramayyu.jdField_a_of_type_Long;
          ((MessageForPic)localObject2).groupFileID = paramayyu.jdField_b_of_type_Long;
          if (QLog.isColorLevel()) {
