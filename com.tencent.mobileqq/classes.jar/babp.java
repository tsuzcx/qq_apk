...
public abstract class babp
{
  ...
  public babp(long paramLong, String paramString, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_b_of_type_ComTencentUploadUinterfaceIUploadTaskCallback = new babq(this);
    this.jdField_a_of_type_Long = paramLong;
    this.g = paramString;
    this.h = babn.a(paramString);
