...
public class axnz
  extends axpm
{
  public axnz(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    try
    {
      ...
      paramDownloadParams.inPreferredConfig = axwd.a;
      ...
      if (bool) {
        try
        {
          ...
          if (paramDownloadParams != null) {
            return new axwr(paramFile.getAbsolutePath()).a(paramDownloadParams);
          }
          paramFile.delete();
