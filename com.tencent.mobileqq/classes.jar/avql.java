  ...
  implements bccc
{
  ...
  public void a(String paramString)
  {
    ...
    boolean bool1 = avqi.a(avqi.a(paramString, "isNew"));
    boolean bool2 = avqi.a(avqi.a(paramString, "isInsert"));
    avqi.a(paramString, "title");
    avqi.a(avqi.a(paramString, "startDate")).longValue();
    avqi.a(avqi.a(paramString, "endDate")).longValue();
    if (bool1)
    {
      paramString = "0";
      if (!bool2) {
    ...
    for (String str = "0";; str = "1")
    {
      ...
      axqy.b(null, "CliOper", "", "", "Time_reminder", "Updata_clock", 0, 0, str, paramString, "", "");
      return;
      paramString = "1";
      break;
    }
  ...
  {
    long l = avqi.a(avqi.a(paramString, "currentDate")).longValue();
    avqi.a(this.jdField_a_of_type_AndroidAppActivity, l * 1000L, new avqm(this), paramJsBridgeListener);
  }
  ...
  public void b(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "startTime : " + avqn.a(1000L * l2) + " endTime : " + avqn.a(1000L * l3));
        }
        i = avqi.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject2, 1000L * l2, 1000L * l3, str1, str2, paramString);
      ...
      axqy.b(null, "CliOper", "", "", "Time_reminder", "Rec_ckl_add", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (("calendar".equals(paramString2)) && ("remindDelete".equals(paramString3)))
    {
      ...
      axqy.b(null, "CliOper", "", "", "Time_reminder", "Delete_clock", 0, 0, "", "", "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindMsgReport".equals(paramString3)))
    {
      ...
      axqy.b(null, "CliOper", "", "", "Time_reminder", "Obj_clock", 0, 0, avqi.a(paramVarArgs[0], "entranceType"), avqi.a(paramVarArgs[0], "role"), "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindAioReport".equals(paramString3)))
    {
      ...
      axqy.b(null, "CliOper", "", "", "Time_reminder", "Clock_card_clk", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
