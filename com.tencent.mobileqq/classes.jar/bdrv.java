    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          bdcs.a(paramContext, str1, false);
          if (localFile1.exists()) {
            bdcs.a(localFile1.getAbsolutePath(), false);
          }
          int j = 1;
          boolean bool = true;
          ...
          bdcs.c(str1, localFile1.getAbsolutePath());
          QLog.d("GLDrawable", 1, "unzip succ..." + new File(paramContext).length() + "..." + bfhi.a(paramContext));
        }
        catch (IOException localIOException)
        {
          bdry.a("unzip", localIOException.getMessage());
      ...
      bdry.a("unzip", "unzip crc not valid.");
      continue;
