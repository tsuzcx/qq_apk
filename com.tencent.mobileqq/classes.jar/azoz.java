...
public class azoz
{
  private static azoz jdField_a_of_type_Azoz;
  ...
  public static azoz a()
  {
    if (jdField_a_of_type_Azoz == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Azoz == null) {
        jdField_a_of_type_Azoz = new azoz();
      }
      return jdField_a_of_type_Azoz;
    }
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.regGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.4.5", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbhpc.setTitle(2131715904);
    localbhpc.setMessage(2131715903);
    paramQQAppInterface = new azpa(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new azpb(this);
    localbhpc.setPositiveButton(2131715902, paramQQAppInterface);
