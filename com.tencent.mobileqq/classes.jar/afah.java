...
{
  public afah(RegisterActivity paramRegisterActivity) {}
  ...
  public void onRegQueryAccountResp(boolean paramBoolean, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    {
      this.a.c();
      QQToast.a(this.a.getApplicationContext(), anni.a(2131712130), 1).a();
      return;
    }
    label166:
    for (;;)
    ...
    return;
    this.a.c();
    this.a.b("该手机号码已绑定其他QQ号码", anni.a(2131712135));
    return;
    this.a.c();
  ...
  public void onRegisterCommitMobileResp(boolean paramBoolean, int paramInt, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        QQToast.a(this.a.getApplicationContext(), anni.a(2131712106), 1).a();
        return;
      }
      switch (paramInt)
      {
      default: 
        QQToast.a(this.a.getApplicationContext(), anni.a(2131712127), 1).a();
        return;
      case 0: 
        ...
        catch (UnsupportedEncodingException paramArrayOfByte2)
        {
          try
          {
            for (;;)
            {
              ...
              QQToast.a(this.a.getApplicationContext(), anni.a(2131712132), 1).a();
              return;
      ...
      case 3: 
        try
        {
          ...
          {
            QQToast.a(this.a.getApplicationContext(), anni.a(2131712124), 1).a();
            return;
          }
        }
        catch (UnsupportedEncodingException paramArrayOfByte1)
  ...
  public void onRegisterCommitPassResp(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    ...
    {
      this.a.c();
      QQToast.a(this.a.getApplicationContext(), anni.a(2131712117), 1).a();
      return;
    }
  ...
  public void onRegisterCommitSmsCodeResp(boolean paramBoolean, int paramInt, String paramString1, String paramString2, String paramString3, byte[] paramArrayOfByte)
  {
    ...
    {
      this.a.c();
      QQToast.a(this.a.getApplicationContext(), anni.a(2131712123), 1).a();
      return;
    }
    if (paramInt == 0) {
      this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(8);
    ...
    for (;;)
    {
      ...
      return;
      this.a.jdField_a_of_type_JavaLangString = anni.a(2131712110);
  ...
  public void onRegisterQuerySmsStatResp(boolean paramBoolean, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        ...
        QQToast.a(this.a.getApplicationContext(), anni.a(2131712118), 1).a();
        return;
      }
      paramString1 = null;
  ...
  public void onRegisterSendResendSmsreqResp(boolean paramBoolean, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    if (!paramBoolean)
    {
      QQToast.a(this.a.getApplicationContext(), anni.a(2131712122), 1).a();
      return;
    }
    try
    {
