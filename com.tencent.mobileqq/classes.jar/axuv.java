...
{
  static final int[] jdField_a_of_type_ArrayOfInt = { 2131376885, 2131376881, 2131376880, 2131376886, 2131376883, 2131376884, 2131376882 };
  int jdField_a_of_type_Int;
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new axvn(this);
  ...
  private aqiw jdField_a_of_type_Aqiw = new axvd(this);
  axre jdField_a_of_type_Axre;
  private axvx jdField_a_of_type_Axvx;
  private bdzm jdField_a_of_type_Bdzm = new axvm(this);
  ...
  private aqiw jdField_b_of_type_Aqiw = new axve(this);
  ...
  private aqiw jdField_c_of_type_Aqiw = new axvo(this);
  ...
  public axuv(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Axvx = new axvx(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
    ...
    int k = axre.jdField_a_of_type_ArrayOfInt.length - 1;
    this.jdField_a_of_type_ArrayOfAxid = new axid[k];
    int j = 0;
    while (j < k)
    {
      this.jdField_a_of_type_ArrayOfAxid[j] = new axid(axre.jdField_a_of_type_ArrayOfInt[j]);
      j += 1;
    }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Axvx);
    }
  ...
  private void a(PicInfo paramPicInfo, View paramView)
  {
    ...
    paramPicInfo = bglp.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, anni.a(2131706115), 0, 0, null, null);
    paramPicInfo.setPositiveButton(2131694081, new axvw(this, paramPicInfo));
    paramPicInfo.show();
  }
  ...
  private void a(CustomImgView paramCustomImgView, PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (paramDrawable == null) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getDrawable(2130845696);
    }
    try
    {
    ...
    {
      paramCustomImgView.setImageDrawable(URLDrawable.getDrawable(bdwn.a(paramDrawable), localURLDrawableOptions));
      return;
    }
    label258:
  }
  ...
  private View b()
  {
    ...
    ((TextView)localObject).setText(anni.a(2131706134));
  ...
  private boolean e()
  {
    ...
    if (!bgsp.a(str))
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anni.a(2131706053));
        return false;
      }
    }
    else
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anni.a(2131706066));
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    bkho localbkho = bkho.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    ...
    localObject = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131561215, null);
    ((IphonePickerView)localObject).a(this.jdField_b_of_type_Aqiw);
    if (this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null)
    {
      ...
      ((IphonePickerView)localObject).setPickListener(new axvr(this, (IphonePickerView)localObject, localbkho));
      localbkho.a(new axvs(this));
    ...
    localbkho.show();
    a(this.jdField_e_of_type_AndroidWidgetLinearLayout, localbkho.a());
        ...
        if (((RelativeLayout)localObject).getChildCount() == 2) {
          if (j == 0)
          {
            ...
            if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j) != null) {
              this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).setContentDescription(anni.a(2131706044) + (j + 1));
            }
          }
        }
      }
  ...
  private void m()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "del_pho", 0, 0, "", "", "", "");
  }
  
  private void n()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "up_gif", 0, 0, "", "", "", "");
  }
  ...
  private void o()
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131693940, new Object[] { this.jdField_a_of_type_JavaLangString });
      localObject = bglp.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, (String)localObject, 0, 0, null, null);
      ((bgpa)localObject).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694180), new axvv(this, (bgpa)localObject));
  ...
  private void p()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131706073));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131706034));
    ...
    localTextView.setOnClickListener(new axvf(this));
    ...
    localTextView.setOnClickListener(new axvh(this));
  ...
  private void q()
  {
    if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      Object localObject = new StringBuilder(anni.a(2131706062));
  ...
  Intent a(String paramString)
  {
    ...
    paramString = anhk.ba + "nearby_people_photo/";
    ...
    localIntent.putExtra("PhotoConst.QZONE_COVER_CROP_LEFT_TITLE", anni.a(2131706067));
                      ...
                      if ((paramInt2 == -1) && (paramIntent != null))
                      {
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            paramInt1 = j;
                            if (paramInt1 < this.jdField_a_of_type_ArrayOfAxid.length)
                            {
                              if (this.jdField_a_of_type_ArrayOfAxid[paramInt1].jdField_a_of_type_Int != paramInt2) {
                                break label406;
                              }
                              paramIntent = this.jdField_a_of_type_ArrayOfAxid[paramInt1];
                            ...
                            this.jdField_a_of_type_Axre.a(this.jdField_a_of_type_ArrayOfAxid);
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131365828));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getColor(2131167044));
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)paramView.findViewById(2131365829));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365809));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372397));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378006));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131365826));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365827));
    this.jdField_e_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131377817));
    ...
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364215));
    this.jdField_d_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131369372));
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369373));
    this.jdField_e_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131364866));
    this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364635));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364634));
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364238));
    this.jdField_f_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131368014));
    this.jdField_g_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131381363));
    this.jdField_h_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131377812));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)paramView.findViewById(2131366875));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setVisibility(8);
    this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376879));
    ...
    paramView = (LinearLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131369508);
    this.jdField_a_of_type_Axre = new axre();
    this.jdField_a_of_type_Axre.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramView);
    p();
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    else
    {
      ...
      this.jdField_a_of_type_JavaLangString = anni.a(2131706063);
      if (!this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) {
        break label1232;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131693931));
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(anni.a(2131706027));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new axux(this));
      e();
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setText(bght.d(j));
      if (!bgsp.a(bght.d(j))) {
        break label1276;
      }
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetEditText.setText(bght.e(j));
      ...
      paramNearbyPeopleCard = (String)axdz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", "");
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.i = ((Integer)axdz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(0))).intValue();
        if (this.i != 2) {
          break label1298;
        }
      ...
      this.jdField_h_of_type_AndroidWidgetEditText.setText(bght.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus - 1));
      ...
      if (bght.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.vGiftInfo) == 0) {
        break label1439;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag)
      {
        paramNearbyPeopleCard = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131693941, new Object[] { this.jdField_a_of_type_JavaLangString });
        paramNearbyPeopleCard = bglp.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramNearbyPeopleCard, 0, 0, null, null);
        paramNearbyPeopleCard.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694180), new axuy(this, paramNearbyPeopleCard));
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131377817).setOnClickListener(this);
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131369373).setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131368015).setOnClickListener(this);
      this.jdField_f_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new axuz(this));
      this.jdField_g_of_type_AndroidWidgetEditText.addTextChangedListener(new axva(this));
      this.jdField_e_of_type_AndroidWidgetEditText.addTextChangedListener(new axvb(this));
      this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new axvc(this));
      return;
      ...
      this.jdField_a_of_type_JavaLangString = anni.a(2131706118);
      break label268;
      label1232:
      if (this.jdField_a_of_type_JavaUtilArrayList.size() <= NearbyPeopleProfileActivity.jdField_b_of_type_Int) {
        break label295;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131693932, new Object[] { this.jdField_a_of_type_JavaLangString }));
      break label295;
      label1276:
      this.jdField_e_of_type_AndroidWidgetTextView.setBackgroundResource(bght.b(j));
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
      break label587;
      label1298:
      ...
      for (;;)
      {
        axdz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college);
        axdz.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(this.i));
        break;
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        this.i = 2;
        continue;
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
    {
      ...
      if (!bgsp.d(this.jdField_e_of_type_AndroidWidgetEditText.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company)) {
        return true;
      }
      if (!bgsp.d(this.jdField_f_of_type_AndroidWidgetTextView.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college)) {
        return true;
      }
      ...
      Object localObject2 = this.jdField_a_of_type_ArrayOfAxid;
    ...
    for (int k = j;; k = j)
    {
      if (k != 0)
      {
        ...
        j = 0;
        break label440;
        localObject1 = ((axid)localObject1).toString();
        break label507;
      }
      return false;
      break;
  ...
  void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.oldPhotoCount > 0) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age >= 14) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age <= 24) && (this.jdField_a_of_type_JavaUtilArrayList.size() <= 1)) {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481B", "0X800481B", 0, 0, "", "", "", "");
    }
    if (Build.VERSION.SDK_INT >= 11)
    {
  ...
  void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(anni.a(2131706110));
    ...
    for (int j = 1;; j = 3)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender == 0))
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          if ((this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null) && (((Byte)this.jdField_h_of_type_AndroidWidgetEditText.getTag()).byteValue() != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus))
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 3, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.job)
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 6, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 7, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 8, 0, "", "", "", "");
          }
          ...
          if (!Arrays.equals((Object[])localObject, new String[] { this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCountry, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownProvice, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCity, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownDistrict }))
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 9, 0, "", "", "", "");
          }
          boolean bool2 = this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a();
          if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.switchGiftVisible != 0L) {
            break label1242;
          ...
          if (bool2 != bool1)
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BB", "0X80060BB", 0, 0, "", "", "", "");
          }
          if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a(new NearbyProfileEditPanel.23(this, (axeq)localObject, localBundle, localArrayList));
      }
      label1242:
      label1247:
      label1252:
      while (!QLog.isDevelopLevel())
      {
        ...
        j = 1;
        break label1110;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BC", "0X80060BC", 0, 0, "", "", "", "");
        break label1158;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getId() == 2131367407) || (paramView == this.jdField_b_of_type_AndroidWidgetEditText))
    {
      ...
      ((IphonePickerView)localObject2).a(this.jdField_c_of_type_Aqiw);
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new axuw(this, (IphonePickerView)localObject2, (bkho)localObject1));
        ((bkho)localObject1).a(new axvg(this));
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          else if ((paramView.getId() == 2131368015) || (paramView == this.jdField_f_of_type_AndroidWidgetEditText))
          {
            c();
          }
          else if ((paramView.getId() == 2131381364) || (paramView == this.jdField_g_of_type_AndroidWidgetEditText))
          {
            i();
          }
          else
          {
            if ((paramView.getId() != 2131377817) && (paramView != this.jdField_h_of_type_AndroidWidgetEditText)) {
              break;
            }
            j();
          }
        }
      } while ((paramView.getId() != 2131362287) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText));
      localObject1 = bkho.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new axvp(this, (IphonePickerView)localObject3, (bkho)localObject1));
      ...
      ((bkho)localObject1).a(new axvq(this));
