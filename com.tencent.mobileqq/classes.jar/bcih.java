  ...
  extends Handler
{
  ...
  public bcih(Looper paramLooper)
  {
    super(paramLooper);
    this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam = new NoticeParam();
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject2 = ((Bundle)localObject1).getString(bcgl.jdField_b_of_type_JavaLangString);
    bcds.a("NoticeUpdateHandler", "+++++what:" + paramMessage.what + "+++++" + localObject1);
    ...
    if (localObject2 != null)
    {
      if (((DownloadInfo)localObject2).i == TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE) {
        bcds.c("NoticeUpdateHandler", "notification isShowNotification=" + ((DownloadInfo)localObject2).i);
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      ...
      {
        bcds.c("NoticeUpdateHandler", "init Notification>>>", localException);
        continue;
        bcds.b("NoticeUpdateHandler", ">>downloading:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
        bcds.c("NoticeUpdateHandler", "size = " + ((DownloadInfo)localObject2).jdField_f_of_type_Int + " content = ");
        ...
        continue;
        bcds.b("NoticeUpdateHandler", ">>complete:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      for (;;)
      {
        ...
        bcia.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
        break;
        bcds.b("NoticeUpdateHandler", ">>download icon fail,so we use default notification icon");
        this.jdField_a_of_type_AndroidAppNotification.contentView.setImageViewResource(2131305274, 2130843460);
      }
      bcds.b("NoticeUpdateHandler", ">>pause:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      bcia.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
      continue;
      bcds.b("NoticeUpdateHandler", ">>error:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131305273, 0);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131305269, 8);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131305277, 8);
