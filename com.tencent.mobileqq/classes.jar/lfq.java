...
public class lfq
{
  ...
  public static lfr a(byte[] paramArrayOfByte)
  {
    ...
    localObject = new lfr(j, k);
    System.arraycopy(paramArrayOfByte, 9, ((lfr)localObject).a, 0, j);
    System.arraycopy(paramArrayOfByte, j + 9, ((lfr)localObject).b, 0, k);
    return localObject;
  }
