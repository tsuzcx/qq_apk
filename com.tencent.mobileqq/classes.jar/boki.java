...
public class boki
  extends bogb
  implements Handler.Callback, bokh
{
  ...
  ArrayList<bokk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  LinkedList<bokg> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  public boolean a;
  ArrayList<bokk> b;
  public boolean b;
  ...
  private bokg a(int paramInt1, String paramString, int paramInt2)
  {
    bokg localbokg = new bokg();
    localbokg.jdField_a_of_type_Int = paramInt1;
    localbokg.jdField_a_of_type_JavaLangString = paramString;
    localbokg.b = paramInt2;
    localbokg.a(this);
    return localbokg;
  }
  ...
  private void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        bokj localbokj = bokj.a(paramString);
  ...
  private void c()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("QIMPredownManager", 2, String.format("startPredown level:%d  queue:%d  left:%d", new Object[] { Integer.valueOf(this.jdField_a_of_type_Bokj.jdField_a_of_type_Int), Integer.valueOf(this.jdField_a_of_type_JavaUtilLinkedList.size()), Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
    }
    ...
    bokk localbokk = (bokk)localArrayList.get(j);
    bokg localbokg;
    if (this.jdField_a_of_type_Bokj.jdField_a_of_type_Int >= localbokk.b)
    {
      localbokg = a(localbokk.jdField_a_of_type_Int, localbokk.jdField_a_of_type_JavaLangString, localbokk.c);
      switch (localbokg.a())
      {
      }
    }
    for (;;)
    {
      j += 1;
      break;
      this.jdField_b_of_type_JavaUtilArrayList.remove(localbokk);
      this.jdField_a_of_type_JavaUtilLinkedList.offer(localbokg);
      continue;
      this.jdField_a_of_type_JavaUtilArrayList.remove(localbokk);
      this.jdField_b_of_type_JavaUtilArrayList.remove(localbokk);
      i = 1;
    }
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject2 = bokj.a((String)localObject4);
      localObject1 = localObject2;
      if (QLog.isColorLevel())
      {
        localObject1 = localObject2;
    ...
    try
    {
      String str = bonn.a("predownload11111.cfg");
      localObject4 = localObject1;
      localObject1 = bokj.a(str);
      localObject2 = localObject1;
      localObject4 = localObject1;
      if (QLog.isColorLevel())
      {
  ...
  public void a(bokj parambokj)
  {
    ...
    if (localObject1 == null)
    {
      parambokj = parambokj.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (parambokj.hasNext())
      {
        localObject1 = (bokk)parambokj.next();
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        try
        {
          ...
          localObject2 = parambokj.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            bokk localbokk = (bokk)((Iterator)localObject2).next();
            if (localbokk.jdField_a_of_type_Int == k)
            {
              this.jdField_a_of_type_JavaUtilArrayList.add(localbokk);
              this.jdField_b_of_type_JavaUtilArrayList.add(localbokk);
            }
          }
        }
  ...
  public void a(boolean paramBoolean, bokg parambokg)
  {
    Handler localHandler = this.jdField_a_of_type_AndroidOsHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      parambokg = Message.obtain(localHandler, 2, i, 0, parambokg);
      this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(parambokg, 3000L);
      return;
    }
  }
  ...
  public void b()
  {
    ...
    {
      bokk localbokk = (bokk)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (i == 0) {
        ((StringBuilder)localObject).append(localbokk.jdField_a_of_type_Int);
      }
      for (;;)
      {
        i += 1;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          localObject1 = (bokg)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.i("QIMPredownManager", 2, "onJobFinish: " + ((bokg)localObject1).jdField_a_of_type_Int + ", " + ((bokg)localObject1).jdField_a_of_type_JavaLangString);
          }
          localObject2 = new QIMPredownHistory();
          ((QIMPredownHistory)localObject2).resId = ((bokg)localObject1).jdField_a_of_type_JavaLangString;
          ...
          if (paramMessage.arg1 == 1)
          {
            ...
            if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
            {
              paramMessage = (bokk)this.jdField_a_of_type_JavaUtilArrayList.get(i);
              if (paramMessage.jdField_a_of_type_Int != ((bokg)localObject1).jdField_a_of_type_Int) {
                break label366;
              }
              if (QLog.isColorLevel()) {
                QLog.i("QIMPredownManager", 2, "onJobFinish: remove " + ((bokg)localObject1).jdField_a_of_type_Int + ", " + ((bokg)localObject1).jdField_a_of_type_JavaLangString);
              }
        ...
        if (a())
        {
          ...
          if (i != 0)
          {
            paramMessage = (bokg)this.jdField_a_of_type_JavaUtilLinkedList.poll();
            if (paramMessage != null)
            {
              ...
              for (;;)
              {
                ...
                i += 1;
                break;
                this.jdField_a_of_type_Bokg = paramMessage;
                paramMessage.a();
                i = 0;
                continue;
                this.jdField_a_of_type_Bokg = paramMessage;
      ...
      localObject3 = this.jdField_a_of_type_Bokj;
    ...
    if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
    {
      ...
      i = 1;
      label649:
      localObject2 = new bdnc();
      ((bdnc)localObject2).d = "0X80090DF";
      ((bdnc)localObject2).f = String.valueOf(m);
      ((bdnc)localObject2).h = ((String)localObject1);
      ((bdnc)localObject2).i = String.valueOf(bhhr.A(BaseApplicationImpl.context));
      if (j == 0) {
        break label877;
      }
      paramMessage = "2";
      label705:
      ((bdnc)localObject2).j = paramMessage;
      int k = -1;
      paramMessage = ((bokj)localObject3).jdField_b_of_type_JavaUtilArrayList.iterator();
      do
      {
        j = k;
        ...
        localObject3 = (bokk)paramMessage.next();
      } while ((!TextUtils.equals((CharSequence)localObject1, ((bokk)localObject3).jdField_a_of_type_JavaLangString)) || (m != ((bokk)localObject3).c));
      j = ((bokk)localObject3).b;
      if ((j == -1) && (i == 0)) {
        break label884;
      }
      paramMessage = "1";
      label788:
      ((bdnc)localObject2).k = paramMessage;
      paramMessage = new bokg();
    ...
    {
      ((bdnc)localObject2).l = paramMessage;
      ((bdnc)localObject2).m = String.valueOf(j);
      bdkw.a(null, (bdnc)localObject2);
      break;
      j = 0;
      break label548;
      label872:
