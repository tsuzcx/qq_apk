...
public class red
{
  private static red jdField_a_of_type_Red;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new ree(this, "Module_VideoFeedsIPCServer");
  private List<ref> jdField_a_of_type_JavaUtilList = new Vector();
  ...
  public static red a()
  {
    if (jdField_a_of_type_Red == null) {}
    try
    {
      jdField_a_of_type_Red = new red();
      return jdField_a_of_type_Red;
    }
    finally {}
  }
  ...
  public void a(ref paramref)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramref);
      return;
    }
  }
  
  public void b(ref paramref)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramref);
      return;
    }
  }
}
