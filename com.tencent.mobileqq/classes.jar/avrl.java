  ...
  implements Manager
{
  ...
  public static avre b;
  public static AtomicBoolean b;
  public static AtomicBoolean c;
  public Handler a;
  avrs jdField_a_of_type_Avrs = null;
  private biia jdField_a_of_type_Biia;
  public QQAppInterface a;
  public final Object a;
  public Vector<Integer> a;
  public ConcurrentHashMap<Integer, avrk> a;
  ...
  static
  {
    ...
    jdField_a_of_type_Avre = new avro();
    jdField_b_of_type_Avre = new avrp();
  }
  
  public avrl(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    avrf localavrf = avrd.a().a(paramInt, 0, jdField_a_of_type_Avre);
    if ((localavrf.jdField_a_of_type_Int != 2) && (localavrf.jdField_a_of_type_Int != 1) && (localavrf.jdField_a_of_type_Int != 4) && (localavrf.jdField_a_of_type_Int != 3)) {
      localavrf.a(false);
    }
    return localavrf.jdField_a_of_type_Int;
  }
  
  public static avrl a(QQAppInterface paramQQAppInterface)
  {
    return (avrl)paramQQAppInterface.getManager(219);
  }
  
  public static bjbs a(Context paramContext)
  {
    if ((((FragmentActivity)paramContext).getChatFragment() != null) && (((FragmentActivity)paramContext).getChatFragment().a() != null))
    {
      if (((FragmentActivity)paramContext).getChatFragment().a().jdField_a_of_type_Bjbs == null) {
        ((FragmentActivity)paramContext).getChatFragment().a().jdField_a_of_type_Bjbs = new bjbs(paramContext);
      }
      return ((FragmentActivity)paramContext).getChatFragment().a().jdField_a_of_type_Bjbs;
    }
    return null;
  }
        ...
        try
        {
          ...
          if (TextUtils.isEmpty(str2))
          {
            ...
            if (TextUtils.isEmpty(paramArrayOfByte))
            {
              ...
              if (i == 1)
              {
                paramArrayOfByte = anzj.a(2131704367);
                str3 = localTTipsInfo.str_button.get();
                str1 = str3;
                if (TextUtils.isEmpty(str3))
                {
                  if (i == 1) {
                    str1 = anzj.a(2131704368);
                  }
                }
                else
                {
                  str3 = localTTipsInfo.str_url.get();
                  bhlq.a(paramContext, 230, str2, paramArrayOfByte, anzj.a(2131704371), str1, new avrm(i, str3, paramContext, localTTipsInfo, paramInt), new avrn()).show();
                  ...
                  ((avrl)paramContext.getChatFragment().a().jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
                }
              }
              else
              {
                ...
                paramArrayOfByte = anzj.a(2131704372);
                continue;
              }
              String str1 = str3;
              if (i != 2) {
  ...
  private void f()
  {
    ...
    {
      avrk localavrk = (avrk)localIterator.next();
      if (!localavrk.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        a(localavrk.jdField_a_of_type_Int, true, false, false);
      }
    }
  }
  
  public avrk a(int paramInt)
  {
    try
    {
      avrk localavrk2 = (avrk)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      avrk localavrk1 = localavrk2;
      if (localavrk2 == null)
      {
        localavrk1 = new avrk();
        localavrk1.jdField_a_of_type_Int = paramInt;
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), localavrk1);
      }
      return localavrk1;
    }
    finally {}
  ...
  public JSONObject a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject1.put("message", anzj.a(2131704374));
      ...
      catch (Exception localException)
      {
        ...
        localJSONObject1.put("message", anzj.a(2131704364));
        continue;
        localException.put("status", 2);
        localJSONObject1.put("result", 0);
        localJSONObject1.put("message", anzj.a(2131704369));
        continue;
        i = 0;
        continue;
      }
      ...
      if (!localavrk.jdField_a_of_type_Boolean) {
        continue;
      }
      localJSONObject2.put("status", 3);
      localJSONObject1.put("result", 0);
      localJSONObject1.put("message", anzj.a(2131704362));
      if (localavrk.c != -3) {
        continue;
      }
      localJSONObject2.put("canceling", i);
      localJSONObject2.put("progress", localavrk.c);
    }
  }
  ...
  {
    avrk localavrk = a(paramInt);
    localavrk.c = -3;
    localavrk.jdField_b_of_type_Boolean = false;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    jdField_a_of_type_Avre.a(paramInt);
  }
  
  public void a(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    avrk localavrk = a(paramInt);
    Object localObject = new File(avrd.c + localavrk.jdField_a_of_type_Int + File.separator + "hifont.json");
    if (((File)localObject).exists())
    {
      localObject = bhmi.a((File)localObject, -1);
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        for (;;)
        {
          try
          {
            ...
            localavrk.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).optString("name");
            localavrk.jdField_b_of_type_Int = ((JSONObject)localObject).optInt("engine");
            localavrk.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("tag");
            if (!TextUtils.isEmpty(localavrk.jdField_b_of_type_JavaLangString)) {
              localavrk.jdField_b_of_type_JavaLangString = localavrk.jdField_b_of_type_JavaLangString.toLowerCase();
            }
            localavrk.jdField_a_of_type_Boolean = avrd.a(paramInt);
            if (!localavrk.jdField_a_of_type_Boolean)
            {
              localObject = new File(avrd.c + localavrk.jdField_a_of_type_Int + File.separator + "panelImg.png");
              if (((File)localObject).exists()) {
                localavrk.jdField_a_of_type_AndroidGraphicsBitmap = bhmq.a(((File)localObject).getAbsolutePath(), null);
              }
            }
            else
            {
              if (paramBoolean3)
              {
                localObject = new File(avrd.c + paramInt + File.separator + "aiodbclick.png");
                if (!((File)localObject).exists()) {
                  break label450;
                }
                localavrk.jdField_b_of_type_AndroidGraphicsBitmap = bhmq.a(((File)localObject).getAbsolutePath(), null);
              }
              localavrk.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
              if (paramBoolean2) {
                a();
              }
              ...
              ((Message)localObject).obj = localavrk.jdField_b_of_type_AndroidGraphicsBitmap;
            ...
            b(localavrk.jdField_a_of_type_Int);
            continue;
            if (!QLog.isColorLevel()) {
              break label488;
            }
  ...
  public void a(VipFontUpdate.TGetPosterFontRsp paramTGetPosterFontRsp, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        avrk localavrk = a(i);
        localavrk.jdField_a_of_type_Int = i;
        localavrk.jdField_a_of_type_Long = localTPosterFontInfo.u64_ts.get();
        if (a(localavrk.jdField_a_of_type_Long)) {
    ...
    a();
    if (paramBoolean) {
      bhmi.a(paramTGetPosterFontRsp.toByteArray(), jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean a()
  {
    auvv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    return (this.d.get()) && (b());
  }
  ...
  public boolean a(BaseChatPie paramBaseChatPie, String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (!behh.a((String)localObject)) {
        break label165;
      }
    } while (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getBoolean("HiBoom_CHN_Tips", false));
    QQToast.a(paramBaseChatPie.jdField_a_of_type_AndroidContentContext, anzj.a(2131704366), 0).a();
    ...
    aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, localHiBoomMessage, null);
    ...
    for (;;)
    {
      ...
      localObject = new aeau();
      paramBaseChatPie.a((aeau)localObject);
      ((aeau)localObject).i = paramBaseChatPie.I;
      paramBaseChatPie.I = false;
      if (paramBaseChatPie != null)
      {
        paramBaseChatPie = (agvx)paramBaseChatPie.a(27);
        if (paramBaseChatPie != null) {
          paramBaseChatPie.a(paramString, (aeau)localObject, 0);
        }
      }
      return true;
      localObject = "2";
  ...
  public void b()
  {
    ...
    ((aogu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).b();
  }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      ??? = a(paramInt1);
      ((avrk)???).jdField_b_of_type_Boolean = false;
      if (paramInt2 != 0) {
        break label267;
      }
      i = 100;
      ...
      ((avrk)???).jdField_a_of_type_Boolean = bool;
    }
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if ((!((String)localObject2).equals("0")) && (this.jdField_a_of_type_Biia != null))
          {
            ??? = new Bundle();
            ((Bundle)???).putString("callbackId", (String)localObject2);
            ((Bundle)???).putInt("srcType", 2);
            localObject2 = this.jdField_a_of_type_Biia;
            long l = paramInt1;
            if (paramInt2 != 0) {
              break label286;
            }
            paramInt1 = j;
            ((biia)localObject2).a(l, paramInt1, (Bundle)???);
          }
        }
        return;
        ??? = "1";
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Avrs != null) {
      this.jdField_a_of_type_Avrs.a(paramBoolean);
    }
  }
  ...
  public void c()
  {
    ...
    byte[] arrayOfByte = bhmi.a(jdField_a_of_type_JavaLangString);
  ...
  public void d()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Avrs = null;
      return;
    }
  }
