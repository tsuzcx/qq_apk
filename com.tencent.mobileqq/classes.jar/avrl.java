  ...
  implements axgj
{
  ...
  private avro jdField_a_of_type_Avro = new avrm(this);
  avrt jdField_a_of_type_Avrt;
  private avsp jdField_a_of_type_Avsp;
  private avvt jdField_a_of_type_Avvt;
  private axdh jdField_a_of_type_Axdh = new avrn(this);
  ...
  public avrl(AppInterface paramAppInterface, Context paramContext, GridView paramGridView, avvt paramavvt, avsp paramavsp, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Avsp = paramavsp;
    this.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  private void b(int paramInt)
  {
    PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo1 = avrt.a().a();
  ...
  public void a(int paramInt)
  {
    ...
    avrt.a().a(localPtvTemplateInfo);
    if (!localPtvTemplateInfo.id.equals("0"))
    {
      avrt localavrt = avrt.a();
      localavrt.a(localPtvTemplateInfo, 111);
      localavrt.a(3, localPtvTemplateInfo.categoryId, localPtvTemplateInfo.id);
    }
    this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = localPtvTemplateInfo;
    avrt.a().a(114, this.jdField_a_of_type_Avsp);
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) || (this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id.equals("0")))
    {
      ...
      if (this.jdField_a_of_type_Avvt != null) {
        this.jdField_a_of_type_Avvt.a(localPtvTemplateInfo, this.jdField_a_of_type_JavaLangString);
      }
      avrt.a().a(null);
      avrt.a().a(113, null);
      return;
    ...
    {
      this.jdField_a_of_type_JavaLangString = avrt.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.md5);
      if (this.jdField_a_of_type_Avvt != null) {
        this.jdField_a_of_type_Avvt.a(localPtvTemplateInfo, this.jdField_a_of_type_JavaLangString);
      }
      avrt.a().a(113, null);
    ...
    for (;;)
    {
      bbjn.a();
      return;
      if ((!this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.downloading) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) && (this.jdField_a_of_type_Avrt != null))
      {
        this.jdField_a_of_type_Avrt.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, this.jdField_a_of_type_Axdh);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Avro);
