...
{
  public static int a;
  private static volatile aucf jdField_a_of_type_Aucf;
  ...
  protected aubv a;
  private aubx jdField_a_of_type_Aubx;
  private auby jdField_a_of_type_Auby;
  public aucb a;
  private aucc jdField_a_of_type_Aucc = new aucc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  private auct jdField_a_of_type_Auct;
  private auey jdField_a_of_type_Auey = auey.a();
  ...
  private aucb b;
  public ConcurrentHashMap<String, audb> b;
  public ConcurrentHashMap<String, audb> c;
  private int d;
  public ConcurrentHashMap<Long, aufe> d;
  private int jdField_e_of_type_Int;
  private String jdField_e_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
  public ConcurrentHashMap<Long, aufe> e;
  private int f;
  public ConcurrentHashMap<Long, audc> f;
  public ConcurrentHashMap<Long, audc> g;
  ...
  private aucf()
  {
    ...
    this.jdField_a_of_type_Aubv = new aucg(this);
    this.jdField_b_of_type_Aucb = new auci(this);
  ...
  {
    if (jdField_a_of_type_Aucf == null) {}
    try
    {
      if (jdField_a_of_type_Aucf == null) {
        jdField_a_of_type_Aucf = new aucf();
      }
      return jdField_a_of_type_Aucf;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 6) {
      if (this.jdField_a_of_type_Aubx != null) {
        this.jdField_a_of_type_Aubx.a();
      }
    }
    while (paramInt != 20) {
      return;
  ...
  private void a(aucp paramaucp)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "processPush0x11aSucc: client ip = " + paramaucp.a().a() + ", udpport = " + localList.get(1) + ", tcpport = " + localList.get(0));
      }
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "pc端已经确认了，客户端收到了0x11a的push了--------> bizType= " + i);
      }
      paramaucp = new Intent();
      if (BaseActivity.sTopActivity != null) {
        break;
      }
      aufh.a("MsgBackup.BackupAndMigrateManager", "activity is null! please check whether is assigned!", new Object[0]);
      return;
      if (i == 2)
      {
        localauey.c(1);
    ...
    PublicFragmentActivity.a(BaseActivity.sTopActivity, paramaucp, MsgBackupPCConfirmFragment.class, 1000);
  }
  ...
  public aubu a()
  {
    if (this.jdField_a_of_type_Aubu == null) {
      this.jdField_a_of_type_Aubu = aubu.a();
    }
  ...
  public auct a()
  {
    return this.jdField_a_of_type_Auct;
  }
  
  public auey a()
  {
    if (this.jdField_a_of_type_Auey == null) {
      this.jdField_a_of_type_Auey = auey.a();
    }
  ...
  public void a(int paramInt, aucl paramaucl, Object paramObject)
  {
    if (paramaucl.jdField_a_of_type_Int == 0) {}
    while (paramaucl.jdField_a_of_type_Int != 2) {
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Auey.a(this.jdField_e_of_type_JavaLangString, paramInt, paramString);
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, BaseActivity paramBaseActivity)
  {
    ...
    for (;;)
    {
      localMessage.obj = String.format(str1, new Object[] { str2, aufh.a(paramLong) + "B/s" });
      localMessage.arg1 = paramInt2;
      aubu.a().a(paramInt2);
      localMqqHandler.sendMessage(localMessage);
      auey.a().a(null);
      auey.a().a(this.jdField_b_of_type_Aucb);
      a(paramBaseActivity);
  ...
  public void a(aubx paramaubx)
  {
    this.jdField_a_of_type_Aubx = paramaubx;
  }
  ...
  public void a(aucl paramaucl)
  {
    ...
    paramaucl.jdField_a_of_type_Aubz = this;
    this.jdField_a_of_type_Aucc.a(paramaucl, 10000);
  }
  
  public void a(aucl paramaucl, Object paramObject)
  {
    if (paramaucl.jdField_a_of_type_Int == 0) {
      if ((paramObject != null) && ((paramObject instanceof audb)))
      {
        paramaucl = (audb)paramObject;
        paramObject = new File(aufh.a(paramaucl.jdField_a_of_type_JavaLangString, aufh.b(paramaucl.jdField_a_of_type_Int), paramaucl.jdField_b_of_type_JavaLangString));
    ...
    label72:
    while ((paramaucl.jdField_a_of_type_Int != 2) || (this.jdField_a_of_type_Aucb == null))
    {
      return;
      paramaucl.jdField_a_of_type_Long = paramObject.length();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(aufh.a(paramaucl.jdField_a_of_type_JavaLangString, aufh.b(paramaucl.jdField_a_of_type_Int)), paramaucl);
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "onProgress, db prepared! result = 0, sessionInfo.uin = " + paramaucl.jdField_a_of_type_JavaLangString);
      }
      a().e(257);
      return;
    }
    this.jdField_a_of_type_Aucb.b(paramaucl.jdField_c_of_type_Int + 1, paramaucl.jdField_b_of_type_Int);
  }
  ...
  public void a(aucw paramaucw)
  {
    ...
    int i = paramaucw.a();
    a().a(i);
    paramaucw = paramaucw.a();
    a().a(paramaucw);
    localIntent.putExtra("0x11bpush_extra", paramaucw);
  ...
  {
    if ((paramObject instanceof aucp))
    {
  ...
  {
    if (paramString != null) {
      ((aubt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).c(paramString);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      a().a(i);
      this.jdField_a_of_type_Auey.a(this.jdField_e_of_type_JavaLangString, paramBoolean);
      return;
      this.jdField_a_of_type_Auct = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aubv);
    }
  }
  ...
  public void b(aucl paramaucl)
  {
    ...
    paramaucl.jdField_a_of_type_Aubz = this;
    this.jdField_a_of_type_Aucc.a(paramaucl, 10001);
  }
  ...
  public void c(aucl paramaucl)
  {
    ...
    paramaucl.jdField_a_of_type_Aubz = this;
    this.jdField_a_of_type_Aucc.a(paramaucl, -1);
  }
  
  public void d()
  {
    aufh.a("MsgBackup.BackupAndMigrateManager", "onDestory ......", new Object[0]);
    this.jdField_a_of_type_Auey.b();
    b();
    jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Aucc.a();
    auff.c();
  ...
  public void e()
  {
    this.jdField_a_of_type_Aucc.b();
    jdField_g_of_type_Boolean = false;
    jdField_a_of_type_Aucf = null;
  }
  ...
  public void g()
  {
    ((aubt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).a();
  }
  
  public void h()
  {
    aufh.b("MsgBackup.BackupAndMigrateManager", "sFileMeta = %s", new Object[] { jdField_a_of_type_JavaLangString });
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {}
    ((aubt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).b(jdField_a_of_type_JavaLangString);
  }
  
  public void i()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aubv);
  }
  
  public void j()
  {
    this.jdField_a_of_type_Auey.a(this.jdField_e_of_type_JavaLangString);
  }
  ...
  public void k()
  {
    ...
    if (this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener == null) {
      this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener = new auch(this);
    }
