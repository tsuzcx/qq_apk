...
public class boqm
  extends QIPCModule
{
  private static boqm a;
  
  private boqm(String paramString)
  {
    super(paramString);
  }
  ...
  public static boqm a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	boqm:a	Lboqm;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	boqm:a	Lboqm;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	boqm
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	boqm:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	boqm:a	Lboqm;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	boqm:a	Lboqm;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_start_send".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        localObject1 = bcwz.a(3, 0);
        localObject2 = bcwz.a(0, paramBundle, (bcxr)localObject1);
        ((bcxd)localObject2).c = true;
        ((bcxr)localObject1).a((bcxd)localObject2);
        bcwz.a((bcxr)localObject1, paramString);
      }
      if (QLog.isColorLevel())
      {
    ...
    if ("action_cancel_send".equals(paramString))
    {
      ...
      localObject1 = paramBundle.getMessageFacade().getMsgItemByUniseq((String)localObject2, i, l2);
      paramString = paramBundle.getTransFileController().findProcessor((String)localObject2, l2);
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        bool3 = paramBundle.getTransFileController().removeProcessor((String)localObject2 + l2);
        bbob.a(paramBundle, (String)localObject2, l2);
        bool2 = bool3;
        if (localObject1 != null) {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
          ...
          for (;;)
          {
            ...
            if ("action_pic_start_send".equals(paramString))
            {
              ...
              if (!TextUtils.isEmpty(paramString))
              {
                ...
                ForwardUtils.handleForwardEditedPhoto(localIntent, (SessionInfo)localObject2, paramString, (QQAppInterface)localObject1);
            ...
            if ("action_re_send".equals(paramString))
            {
              ...
              paramString = (QQAppInterface)localObject1;
              paramBundle = paramString.getMessageFacade().getMsgItemByUniseq((String)localObject2, i, l1);
              bool2 = false;
              if ((paramBundle instanceof MessageForShortVideo))
              {
                localObject1 = (MessageForShortVideo)paramBundle;
                if ((FileUtils.fileExistsAndNotEmpty(ShortVideoUtils.getShortVideoThumbPicPath(((MessageForShortVideo)localObject1).thumbMD5, "jpg"))) && (!TextUtils.isEmpty(((MessageForShortVideo)localObject1).videoFileName)) && (((MessageForShortVideo)localObject1).isStoryVideo))
                {
                  ((bbob)paramString.getManager(QQManagerFactory.MEDIA_MSG_ORDER_SEND_MANAGER)).a(((MessageForShortVideo)localObject1).frienduin, (MessageRecord)localObject1, ((MessageForShortVideo)localObject1).videoFileName);
                  localObject1 = bcwz.a(4, 0);
                  localObject2 = bcwz.a(0, paramBundle, (bcxr)localObject1);
                  ((bcxd)localObject2).c = true;
                  ((bcxr)localObject1).a((bcxd)localObject2);
                  bcwz.a((bcxr)localObject1, paramString);
              ...
              for (paramString = paramBundle.toString();; paramString = "")
              {
                ...
                bool1 = bool2;
                if (!FileUtils.fileExistsAndNotEmpty(((MessageForPic)localObject1).path)) {
                  break label1015;
                }
                bool1 = bool2;
                ...
                if (((MessageForPic)localObject1).isSendFromLocal()) {
                  paramString.getTransFileController().removeProcessor(paramString.getTransFileController().makeKey(((MessageForPic)localObject1).frienduin, ((MessageForPic)localObject1).uniseq));
                }
                localObject2 = new azko();
                ((azko)localObject2).a(((MessageForPic)localObject1).path);
                ((azko)localObject2).d(5);
                ((azko)localObject2).d(((MessageForPic)localObject1).frienduin);
                if (((MessageForPic)localObject1).fileSizeFlag == 1) {
                  ((azko)localObject2).c(TranDbRecord.PicDbRecord.EXTRA_FLAG_SEND_RAW_PHOTO);
                }
                for (;;)
                {
                  ((azko)localObject2).e(((MessageForPic)localObject1).senderuin);
                  ((azko)localObject2).c(((MessageForPic)localObject1).selfuin);
                  ((azko)localObject2).e(((MessageForPic)localObject1).istroop);
                  ((azko)localObject2).l(((MessageForPic)localObject1).getConfessTopicId());
                  ((azko)localObject2).jdField_i_of_type_Int = ((MessageForPic)localObject1).extLong;
                  ((azko)localObject2).jdField_i_of_type_JavaLangString = ((MessageForPic)localObject1).extStr;
                  ((azko)localObject2).b(true);
                  localObject3 = new azkp();
                  ((azkp)localObject3).a = ((MessageForPic)localObject1).msgseq;
                  ((azkp)localObject3).b = ((MessageForPic)localObject1).shmsgseq;
                  ((azkp)localObject3).c = ((MessageForPic)localObject1).msgUid;
                  ((azko)localObject2).a((azkp)localObject3);
                  ((azko)localObject2).b(((MessageForPic)localObject1).uniseq);
                  ((bbob)paramString.getManager(QQManagerFactory.MEDIA_MSG_ORDER_SEND_MANAGER)).a(((MessageForPic)localObject1).frienduin, ((MessageForPic)localObject1).uniseq);
                  localObject3 = azjv.a(4, 5);
                  ((azke)localObject3).a(((azko)localObject2).a());
                  ((azke)localObject3).a = ((MessageForPic)localObject1).picExtraData;
                  azjv.a((azke)localObject3, paramString);
                  bool1 = true;
                  break;
                  ((azko)localObject2).c(TranDbRecord.PicDbRecord.EXTRA_FLAG_SEND_PHOTO);
                }
              }
            }
        ...
        if ("action_get_name".equals(paramString))
        {
          ...
          try
          {
            paramString = ContactUtils.getFriendName((QQAppInterface)localObject1, paramString);
            localBundle.putBoolean("key_result", true);
            localBundle.putString("uinname", paramString);
            paramString = EIPCResult.createSuccessResult(localBundle);
            return paramString;
