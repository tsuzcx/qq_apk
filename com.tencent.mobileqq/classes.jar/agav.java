...
public class agav
{
  public static void a(PlusPanel paramPlusPanel, afzs paramafzs)
  {
  ...
  public static boolean a(TroopAIOAppInfo paramTroopAIOAppInfo, BaseChatPie paramBaseChatPie, afzs paramafzs)
  {
    if ((paramTroopAIOAppInfo != null) && (paramBaseChatPie != null) && (MiniAppLauncher.isMiniAppUrl(paramTroopAIOAppInfo.url)))
    {
      a(paramBaseChatPie.a(), paramTroopAIOAppInfo.url, paramBaseChatPie, paramafzs);
      return true;
    }
    return false;
  }
  
  private static void b(PlusPanel paramPlusPanel, afzs paramafzs)
  {
    if (paramafzs.a >= 0) {}
    do
    {
      ...
      do
      {
        ...
        if (paramPlusPanel.jdField_a_of_type_AndroidUtilSparseArray != null) {
          localObject = (TroopAIOAppInfo)paramPlusPanel.jdField_a_of_type_AndroidUtilSparseArray.get(paramafzs.b);
        }
      } while ((localObject == null) || (((TroopAIOAppInfo)localObject).url == null));
      paramafzs = ((TroopAIOAppInfo)localObject).url.replace("$UIN$", paramPlusPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).replace("$GCODE$", paramPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a).replace("$APPID$", String.valueOf(paramafzs.b));
      int j = 0;
      int i = j;
      try
      {
        if (TextUtils.equals(new URI(paramafzs).getScheme(), "mqqapi"))
        {
          localObject = bgng.a(paramPlusPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), paramafzs);
          i = j;
          if (localObject != null)
          {
            ((bgmp)localObject).a();
    ...
    ((Intent)localObject).putExtra("url", paramafzs);
    ((Intent)localObject).putExtra("selfSet_leftViewText", anni.a(2131714388));
