...
public class bacl
  extends bacq
{
  private aqpg jdField_a_of_type_Aqpg = new bacm(this);
  FileManagerEntity jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
  
  public bacl(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      if (i == 0)
      {
        ...
        this.jdField_a_of_type_Bacn.i(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
      }
