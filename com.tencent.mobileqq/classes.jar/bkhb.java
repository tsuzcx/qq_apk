...
public class bkhb
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bkhf parambkhf)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return bkhc.a().a("http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/qzone_yellow_icon_v6.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambkhf);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130848821);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bkhf parambkhf)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambkhf, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bkhf parambkhf, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      bkhc.a().a(paramString, paramInt1, "border", parambkhf);
      continue;
      switch (paramInt3)
      {
      }
    }
    return bkhc.a().a(paramString, paramInt1, "head", parambkhf);
    return bkhc.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambkhf);
    return bkhc.a().a(paramString, paramInt1, "right", parambkhf);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bkhf parambkhf)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return bkhc.a().a(paramString, paramInt2, str, true, parambkhf);
    }
    return null;
  }
