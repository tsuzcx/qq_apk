...
public class bnxu
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bnxv(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  bnxx jdField_a_of_type_Bnxx;
  ...
  public bnxu(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      localObject = new bnvd();
      ((bnvd)localObject).a(this.jdField_c_of_type_Int).a(l).b(paramInt1).a(paramString).c(paramInt2).d(1);
      paramString = ((bnvd)localObject).a();
      bnvx.a().a(paramString);
      return;
  ...
  public void a(View paramView, bnxx parambnxx)
  {
    if (paramView == null) {
      return;
    }
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131367473));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367481));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367482));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367484));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367480));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367485));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367486));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367483));
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getDrawable(2130840274);
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!bdgb.b()))
        {
          ((URLDrawable)localObject1).setTag(bhez.a(bhtq.a(40.0F), bhtq.a(40.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(bhez.p);
          if (localURLDrawable != null)
          {
            this.jdField_e_of_type_Int = paramAlumBasicData.jdField_a_of_type_Int;
            this.f = paramAlumBasicData.jdField_b_of_type_Int;
            int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bhtq.b(56.0F);
            paramInt = i;
      ...
      ((URLDrawable)localObject1).setTag(bhez.b(bhtq.a(40.0F), bhtq.a(40.0F), bhtq.a(3.5F)));
