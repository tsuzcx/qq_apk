...
public class acul
  implements acoi
{
  public acul(GdtInterstitialFragmentForJS paramGdtInterstitialFragmentForJS) {}
  ...
  public void onResponse(acoh paramacoh)
  {
    ...
    for (;;)
    {
      ...
      GdtInterstitialFragmentForJS.a(this.a, new acor(i));
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              paramacoh = (qq_ad_get.QQAdGetRsp.AdInfo)((qq_ad_get.QQAdGetRsp.PosAdInfo)paramacoh.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.pos_ads_info.get(0)).ads_info.get(0);
              GdtInterstitialFragmentForJS.a(this.a).a.a = new GdtAd(paramacoh);
              GdtInterstitialFragmentForJS.a(this.a, new acqa(this.a.getActivity(), GdtInterstitialFragmentForJS.a(this.a)));
              m = i;
              i = j;
              j = m;
            }
