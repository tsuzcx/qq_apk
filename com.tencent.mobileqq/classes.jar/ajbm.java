...
{
  public static int a;
  private SparseArray<ajbn> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  public WeakReference<ajcf> a;
  ...
  public ajbm(ajcf paramajcf)
  {
    a(new ajaz());
    if (paramajcf != null)
    {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajcf);
      this.b = paramajcf.a();
    }
  }
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) && (paramString2 != null)) {
      ajac.a().callbackFromRequest(paramLong, 0, paramString1, paramString2);
    }
  }
  ...
  public aivv a(long paramLong, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject = (ajcf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((ApolloSurfaceView)localObject).getLuaState() == paramLong))
          {
            ...
            {
              localObject = (ajbn)this.jdField_a_of_type_AndroidUtilSparseArray.get(i);
              paramString2.put("N_R_CMD", paramString1);
              paramString2.put("N_R_STATE", paramLong);
              if (localObject != null)
              {
                paramString1 = ((ajbn)localObject).a(this, paramString2);
                if (paramString2.optBoolean("N_R_SYNC"))
                {
                  if (paramString1 != null) {
                    paramString1.put("code", 0);
                  }
                  localObject = new aivv();
                  ((aivv)localObject).b = true;
                  if (paramString1 == null)
                  {
                    paramString1 = paramString2.toString();
                    ((aivv)localObject).a = paramString1;
                    return localObject;
                  }
              ...
              else
              {
                ...
                if (i < j)
                {
                  ...
                  paramString1 = (ajbn)this.jdField_a_of_type_AndroidUtilSparseArray.get(k);
                  if (paramString1 == null) {
                    break label327;
                  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null)
    {
      ...
      {
        int k = this.jdField_a_of_type_AndroidUtilSparseArray.keyAt(i);
        ajbn localajbn = (ajbn)this.jdField_a_of_type_AndroidUtilSparseArray.get(k);
        if (localajbn != null) {
          localajbn.a();
        }
        i += 1;
  ...
  public void a(ajbn paramajbn)
  {
    if (paramajbn != null)
    {
      ...
      if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null) {
        this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramajbn);
      }
    }
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        ...
        {
          ajac.a().callbackFromRequest(l, 0, str, paramJSONObject.toString());
          return;
        }
