  ...
  implements LoginKeyHelper.GetLoginKeyListener
{
  ...
  public adub(HuayangDowanloadHelper paramHuayangDowanloadHelper, String paramString, IVPluginInfo paramIVPluginInfo, InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new aduc(this, paramBoolean1, paramBoolean2), l);
      return;
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    for (int i = 1;; i = 0)
    {
      StoryReportor.a(str, "getLoginKey", i, (int)l1, new String[] { HuayangDowanloadHelper.c(this.jdField_a_of_type_ComTencentMobileqqIntervideoHuayangHuayangDowanloadHelper), paramInt + "", paramString, "7.6.3" });
      return;
