...
{
  public bhcn(MiniAppTextArea paramMiniAppTextArea, JSONObject paramJSONObject1, JSONObject paramJSONObject2, int paramInt, JSONObject paramJSONObject3, bgid parambgid) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt3 == 0)
        {
          ...
          this.jdField_a_of_type_Bgid.a("onKeyboardValueChange", localJSONObject.toString(), MiniAppTextArea.a(this.jdField_a_of_type_ComTencentQqminiSdkRuntimeCorePageWidgetMiniAppTextArea).b());
          return;
          if (this.b == null) {
            break;
          }
