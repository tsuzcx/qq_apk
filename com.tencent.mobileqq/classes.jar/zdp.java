...
public class zdp
  implements alrx, amfo, IMemoryManager, IAppStateChangeListener
{
  private static zdp jdField_a_of_type_Zdp;
  ...
  private Vector<zdq> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  public static zdp a()
  {
    if (jdField_a_of_type_Zdp == null) {}
    try
    {
      if (jdField_a_of_type_Zdp == null) {
        jdField_a_of_type_Zdp = new zdp();
      }
      return jdField_a_of_type_Zdp;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          azmz.a(BaseApplicationImpl.getApplication()).a((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  {
    a(2);
    zdn.a(BaseApplicationImpl.class.getClassLoader());
  }
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          if (!alrv.a().a.jdField_a_of_type_Boolean) {
            break label531;
          }
          str1 = "1";
          localHashMap.put("ClearEnable", str1);
          localHashMap.put("DpcConfigId", alrv.a().a.jdField_a_of_type_JavaLangString);
          ...
          label396:
          azmz.a(BaseApplicationImpl.getApplication()).a(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    zdl localzdl = alrv.a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localzdl.jdField_a_of_type_Boolean + "configId" + localzdl.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramzdm.jdField_b_of_type_Int * localzdl.jdField_b_of_type_Int * 1000)) && (localzdl.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramzdm);
      return;
    }
    catch (Exception paramzdm)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramzdm);
    }
  }
  ...
  public void a(zdq paramzdq)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramzdq);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", aluv.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        azmz.a(BaseApplicationImpl.getApplication()).a(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", aluv.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", azmu.a().a());
      ((SharedPreferences.Editor)localObject).putInt("hackArtResult", HackVm.jdField_d_of_type_Int);
      ((SharedPreferences.Editor)localObject).putString("clear_config_id", alrv.a().a.jdField_a_of_type_JavaLangString);
      ((SharedPreferences.Editor)localObject).putBoolean("clear_config_enable", alrv.a().a.jdField_a_of_type_Boolean);
  ...
  public void b(int paramInt, zdm paramzdm)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((zdq)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramzdm.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramzdm.a > 0.0F) && (paramzdm.a < 1.0F))
          {
            l4 = MemoryManager.a() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramzdm.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramzdm.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramzdm.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramzdm = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramzdm.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramzdm.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramzdm = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramzdm.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramzdm.next();
              ...
              break label1465;
              label842:
              paramzdm = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramzdm.length < 2) {
                break label1522;
              }
              if ((paramzdm[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramzdm[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramzdm[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramzdm[1].toString());
              i1 = i2;
              break label1522;
            }
          }
  ...
  public void b(zdq paramzdq)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramzdq);
      return;
    }
  }
  ...
  public final void d()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      azmz.a(BaseApplicationImpl.getApplication()).a(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
