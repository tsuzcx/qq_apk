...
public class bano
{
  private static volatile bano a;
  public static final String a;
  
  static
  {
    jdField_a_of_type_JavaLangString = antf.ba + "qbdownres";
  }
  ...
  {
    if (jdField_a_of_type_Bano == null) {}
    try
    {
      if (jdField_a_of_type_Bano == null) {
        jdField_a_of_type_Bano = new bano();
      }
      return jdField_a_of_type_Bano;
    }
    finally {}
  }
  ...
  public static boolean a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if ((QzoneConfig.getInstance().getConfig("Schema", "jump_installapp_scheme_enable", 0) == 0) && (auog.b((String)localObject)))
      {
  ...
  private boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (banv.a(paramString2))
    {
      a(paramQQAppInterface.getAccount(), paramString1);
      auog.c(str);
      return false;
    }
    bnfx.a().c(paramString4, null);
    return false;
  }
  ...
  private static void b(String paramString1, SoftReference<QQAppInterface> paramSoftReference, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      if (paramSoftReference != null)
      {
        paramSoftReference = (bezv)paramSoftReference.getManager(193);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (localbezv.a())
      {
        ...
        localbezv.a(10088, "vas", paramString2, 0, paramString2, paramString3, 1, 2, true, new banp(this, paramQQAppInterface, "qboss_pre_download_res", paramString1, paramString3, paramString2, paramString4));
        return;
      }
