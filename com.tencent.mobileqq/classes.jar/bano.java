...
public class bano
{
  private static bano jdField_a_of_type_Bano;
  ...
  public void a(BoyDataReport paramBoyDataReport)
  {
    ...
    while (paramBoyDataReport.hasNext())
    {
      ...
      {
        localObject2 = (banp)localHashMap.get(((BoyDataReport.BoyItem)localObject1).mId);
        ((banp)localObject2).b();
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          localObject2 = new banp(this, (String)localObject2, 1, i);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramBoyDataReport.put(localObject2, String.valueOf(((banp)localHashMap.get(localObject2)).a()));
    }
    bctj.a(BaseApplicationImpl.getContext()).a(null, "dg_action_match", true, 0L, 0L, paramBoyDataReport, "");
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localbctj.a(null, "dg_entrance_state", bool, 0L, 0L, (HashMap)localObject, "");
