...
{
  bbsq(String paramString, int paramInt, long paramLong, bankcode_info.BankcodeCtrlInfo paramBankcodeCtrlInfo, boolean paramBoolean) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramView))
      {
        ...
        paramView = (Bundle)baah.a().a("SensMsgTipsCfg", "Action", 1, i);
        if (paramView == null) {
          break;
        }
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          bbsm.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, (String)localObject2, str1, str2, (String)localObject3);
          continue;
        }
        break;
