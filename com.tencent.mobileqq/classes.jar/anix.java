...
public class anix
  extends anio
{
  public anix(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, Oidb_0x5d1.RspBody paramRspBody)
  {
    ...
    if ((i == 1) && (paramRspBody.msg_set_friend_id.has()))
    {
      ...
      if (j == 0)
      {
        paramRspBody = ((amsw)localObject2).e(String.valueOf(l1));
        paramToServiceMsg = (ToServiceMsg)localObject1;
        if (paramRspBody != null)
        {
          paramRspBody.setShieldFlag(true);
          ((amsw)localObject2).a(paramRspBody);
          paramToServiceMsg = this.a.getCurrentAccountUin();
          paramRspBody = amtj.a(2131704000);
          l2 = bbko.a();
          localObject2 = bbli.a(-2012);
    ...
    do
    {
      ...
      if ((i == 2) && (paramRspBody.msg_clear_friend_id.has()))
      {
        ...
        if (j == 0)
        {
          paramToServiceMsg = ((amsw)localObject2).e(String.valueOf(l1));
          if (paramToServiceMsg != null)
          {
            paramToServiceMsg.setShieldFlag(false);
            ((amsw)localObject2).a(paramToServiceMsg);
            paramToServiceMsg = this.a.getCurrentAccountUin();
            paramRspBody = amtj.a(2131704003);
            l2 = bbko.a();
            localObject1 = bbli.a(-2012);
