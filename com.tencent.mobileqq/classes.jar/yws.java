...
public final class yws
  implements Runnable
{
  public yws(Context paramContext, String paramString1, String paramString2, int paramInt) {}
  ...
  public void run()
  {
    ...
    Object localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130839193);
        ...
        if ((localObject2 instanceof RegionDrawable))
        {
          ...
          if (i != ((Bitmap)localObject1).getWidth())
          {
            ...
            catch (Exception localException1)
            {
              ...
              Bitmap localBitmap = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130839193);
              localObject2 = new Intent();
              ((Intent)localObject2).putExtra("android.intent.extra.shortcut.INTENT", localIntent);
              ((Intent)localObject2).putExtra("android.intent.extra.shortcut.NAME", this.jdField_a_of_type_JavaLangString);
