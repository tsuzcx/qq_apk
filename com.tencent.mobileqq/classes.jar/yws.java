  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localActionSheetItem.label = paramContext.getString(2131690054);
    localActionSheetItem.icon = 2130840337;
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if ("S".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anni.a(2131715046) + anni.a(2131715054);
    }
    if ("A".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anni.a(2131715040) + anni.a(2131715030);
    }
    if ("B".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anni.a(2131715042) + anni.a(2131715050);
    }
    if ("C".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + anni.a(2131715036) + anni.a(2131715065);
    }
    return "[QQ高能舞室]" + anni.a(2131715055);
  }
  ...
  {
    new ywu(this.jdField_a_of_type_AndroidAppActivity, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramInt1, this.jdField_a_of_type_MqqUtilWeakReference, paramInt2).execute(new Void[0]);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt2 == 2)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, anni.a(2131715032), 1).a();
    }
    do
    {
      do
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Baqk = new baqk(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Baqk.a(a(this.jdField_a_of_type_AndroidAppActivity));
    this.jdField_a_of_type_Baqk.a(this);
    this.jdField_a_of_type_Baqk.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131718027));
  ...
  protected void a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      bgmg.a(new File(paramString).getParent());
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Baqk.a().isShowing()) {
      this.jdField_a_of_type_Baqk.a().dismiss();
    }
    ShareActionSheetBuilder.ActionSheetItem localActionSheetItem = ((bgsa)paramView.getTag()).a;
