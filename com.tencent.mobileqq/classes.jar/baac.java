...
public class baac
{
  ...
  public static baad a(byte[] paramArrayOfByte)
  {
    baad localbaad = new baad();
    ...
    for (;;)
    {
      try
      {
        ...
        localbaad.jdField_a_of_type_Int = paramArrayOfByte.get();
        ...
        if (paramArrayOfByte.hasRemaining())
        {
          ...
          localbaad.c = i;
          localbaad.jdField_a_of_type_JavaLangString = new String(arrayOfByte);
          if (QLog.isColorLevel()) {
            QLog.d("ActionMsgUtil", 2, "decodeAppShareCookie succes appShareCookie.buissnessType =" + localbaad.jdField_a_of_type_Int + "appShareCookie.action" + localbaad.b + "appShareCookie.actionType" + localbaad.c + "appShareCookie.actionValue" + localbaad.jdField_a_of_type_JavaLangString);
          }
        }
      }
