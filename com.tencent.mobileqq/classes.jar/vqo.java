...
public class vqo
{
  ...
  private static volatile vqo jdField_a_of_type_Vqo;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = vqo.class.getSimpleName();
  }
  ...
  {
    paramPointF1 = ValueAnimator.ofObject(new vqs(this, paramPointF3, paramPointF4), new Object[] { paramPointF1, paramPointF2 });
    paramPointF1.setDuration(paramLong);
    paramPointF1.addUpdateListener(new vqr(this, paramView));
    return paramPointF1;
  }
  
  public static URLDrawable a(String paramString, int[] paramArrayOfInt, Drawable paramDrawable, int paramInt)
  {
    vqq localvqq = new vqq(paramArrayOfInt);
    Bundle localBundle = new Bundle();
    localBundle.putInt("key_loop", paramInt);
    return VasApngUtil.getApngURLDrawable(paramString, paramArrayOfInt, paramDrawable, localBundle, localvqq);
  }
  
  public static vqo a()
  {
    if (jdField_a_of_type_Vqo == null) {}
    try
    {
      if (jdField_a_of_type_Vqo == null) {
        jdField_a_of_type_Vqo = new vqo();
      }
      return jdField_a_of_type_Vqo;
    }
    finally {}
  }
