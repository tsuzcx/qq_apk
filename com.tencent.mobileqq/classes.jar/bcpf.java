  ...
  extends Drawable
{
  ...
  public bcpg a;
  public String a;
  WeakReference<bcph> jdField_a_of_type_JavaLangRefWeakReference;
  public boolean a;
  public float b;
  public int b;
  public Paint b;
  ...
  public bcpf(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bcpg = new bcpg(this);
  ...
  public void a()
  {
    this.jdField_a_of_type_Bcpg.removeMessages(0);
    this.jdField_a_of_type_Bcpg.a(this.jdField_b_of_type_Int);
    invalidateSelf();
  }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambcph);
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bcpg.a(paramInt);
    this.jdField_a_of_type_Bcpg.sendEmptyMessage(0);
    invalidateSelf();
  }
  ...
  public void c(int paramInt)
  {
    ...
    {
      localbcph = (bcph)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbcph != null)
      {
    ...
    for (;;)
    {
      ...
      return;
      label99:
      localbcph.a(this, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
