  ...
  extends akth
{
  ...
  public akti(QQAppInterface paramQQAppInterface, aktl paramaktl)
  {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList)
      {
        ...
        if (!localThrowable.isEmpty())
        {
          ...
          if ((QLog.isColorLevel()) || (paramLong > 60000L))
          {
            ...
            axrn.a(BaseApplication.getContext()).a(null, "actFTSMsgCost", true, paramLong, 0L, (HashMap)localObject3, null, false);
  ...
  private boolean a(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    paramSQLiteDatabase = ((aukp)localObject).a(FTSMessageSync.class, "msg_sync_log", false, "_id>?", new String[] { String.valueOf(this.jdField_a_of_type_Int) }, null, null, "_id", String.valueOf(300));
    ((aukp)localObject).a();
    int i;
    if (QLog.isColorLevel())
    {
  ...
  private boolean b(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    paramSQLiteDatabase = ((aukp)localObject1).a(FTSMessageDelete.class, "msg_del_log", false, "_id>?", new String[] { String.valueOf(this.jdField_b_of_type_Int) }, null, null, "_id", String.valueOf(50));
    ((aukp)localObject1).a();
    if (QLog.isColorLevel())
    {
  ...
  public ArrayList<FTSEntity> a(long paramLong, Pair<CharSequence, CharSequence> paramPair)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      Object localObject = aktg.a(FTSMessage.class, String.valueOf(paramLong));
      localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a((auly)localObject);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      do
      {
        ...
        paramString = bbmo.a((String)localObject);
        if (QLog.isColorLevel()) {
      ...
      Object localObject = bbmo.a((String)localObject);
      paramString = aktg.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      localObject = bbmo.a((String)localObject);
      paramString = aktg.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt);
      return this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a(paramString);
    }
    if (QLog.isColorLevel()) {
      QLog.e("Q.fts.FTSMsgOperator", 2, "ftsDatabase not init");
  ...
  public ArrayList<FTSEntity> a(String paramString1, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      paramString1 = bbmo.a((String)localObject);
      if (QLog.isColorLevel()) {
      ...
      localObject = bbmo.a((String)localObject);
      paramString1 = aktg.a(paramString1, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt, paramString2);
  ...
  public void a(aktc paramaktc, aukp paramaukp)
  {
    Object localObject1;
    Object localObject2;
    if ((paramaktc.c != null) && (!TextUtils.isEmpty(paramaktc.c)))
    {
      if (paramaktc.jdField_a_of_type_AndroidContentContentValues == null) {
        return;
      }
      localObject1 = "SELECT * FROM " + paramaktc.b + " WHERE " + paramaktc.c + ";";
      localObject2 = new String[paramaktc.jdField_a_of_type_ArrayOfJavaLangString.length];
      int i = 0;
      while (i < paramaktc.jdField_a_of_type_ArrayOfJavaLangString.length)
      {
        localObject2[i] = paramaktc.jdField_a_of_type_ArrayOfJavaLangString[i];
        i += 1;
      }
      localObject1 = a().a((String)localObject1, paramaktc.b, paramaktc.c, (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if ((localObject1 != null) && (bbmo.a(paramaktc.jdField_a_of_type_AndroidContentContentValues))) {
        paramaktc = ((List)localObject1).iterator();
      }
    }
    while (paramaktc.hasNext())
    {
      localObject1 = (MessageRecord)paramaktc.next();
      if ((((MessageRecord)localObject1).isSupportFTS()) && (((MessageRecord)localObject1).isValid) && (((MessageRecord)localObject1).msgtype != -2006))
      {
        ...
        paramaukp.b(FTSMessageCodec.a((FTSMessage)localObject1));
        if (QLog.isColorLevel())
        {
          QLog.d("Q.fts.FTSMsgOperator", 2, "updateMessageSync 1 msg:" + ((FTSMessage)localObject1).toString());
          continue;
          if ((localObject1 != null) && (bbmo.b(paramaktc.jdField_a_of_type_AndroidContentContentValues)))
          {
            ...
            while (((Iterator)localObject1).hasNext())
            {
              ...
              if ((((MessageRecord)localObject3).isSupportFTS()) && (((MessageRecord)localObject3).isValid) && (((MessageRecord)localObject3).msgtype != -2006))
              {
                ...
                paramaukp.b(FTSMessageCodec.a((FTSMessage)localObject2));
                localObject3 = bbmo.a(paramaktc.jdField_a_of_type_AndroidContentContentValues, (MessageRecord)localObject3);
                ((FTSMessage)localObject3).insertOpt();
                paramaukp.b(FTSMessageCodec.a((FTSMessage)localObject3));
                if (QLog.isColorLevel())
                {
  ...
  {
    if (((paramauko instanceof MessageRecord)) && (((MessageRecord)paramauko).isSupportFTS()))
    {
      paramauko = (MessageRecord)paramauko;
      paramauko.saveExtInfoToExtStr("ExtraFTSMsgCounter", String.valueOf(b(paramauko.frienduin)));
    }
  }
  
  public void a(auko paramauko, aukp paramaukp)
  {
    if (((paramauko instanceof MessageRecord)) && (((MessageRecord)paramauko).isSupportFTS()) && (((MessageRecord)paramauko).isValid) && (((MessageRecord)paramauko).msgtype != -2006))
    {
      paramauko = FTSMessageCodec.a((MessageRecord)paramauko);
      paramauko.insertOpt();
      paramaukp.b(FTSMessageCodec.a(paramauko));
    }
  }
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Akto = new aktj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
  ...
  public long b(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
    {
      ...
      if (((FTSMsgCounter)localObject).mMsgCnt > 1000L)
      {
        ...
        this.jdField_a_of_type_Aukx.a((auko)localObject);
      }
      for (;;)
      {
    ...
    ((aukp)localObject).b(localFTSMsgCounter);
    ((aukp)localObject).a();
    if ((System.currentTimeMillis() - this.jdField_c_of_type_Long > 30000L) && (QLog.isColorLevel()))
    {
  ...
  public void b()
  {
    if (bbmo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
    {
      if (!a()) {
        break label30;
      }
  ...
  public void b(aktc paramaktc, aukp paramaukp)
  {
    Object localObject;
    if ((paramaktc.c != null) && (!TextUtils.isEmpty(paramaktc.c)))
    {
      localObject = "SELECT * FROM " + paramaktc.b + " WHERE " + paramaktc.c + ";";
      String[] arrayOfString = new String[paramaktc.jdField_a_of_type_ArrayOfJavaLangString.length];
      int i = 0;
      while (i < paramaktc.jdField_a_of_type_ArrayOfJavaLangString.length)
      {
        arrayOfString[i] = paramaktc.jdField_a_of_type_ArrayOfJavaLangString[i];
        i += 1;
      }
      try
      {
        paramaktc = a().a((String)localObject, paramaktc.b, paramaktc.c, arrayOfString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (paramaktc == null) {
          break label288;
        }
        paramaktc = paramaktc.iterator();
        while (paramaktc.hasNext())
        {
          localObject = (MessageRecord)paramaktc.next();
          if ((((MessageRecord)localObject).isSupportFTS()) && (((MessageRecord)localObject).isValid) && (((MessageRecord)localObject).msgtype != -2006))
          {
            ...
            paramaukp.b(FTSMessageCodec.a((FTSMessage)localObject));
          }
        }
      }
      catch (OutOfMemoryError paramaktc)
      {
        for (;;)
        {
          QLog.e("Q.fts.FTSMsgOperator", 2, paramaktc, new Object[0]);
          paramaktc = null;
        }
      }
    }
    ...
    try
    {
      ((FTSMessage)localObject).uin = mqu.a(paramaktc.jdField_a_of_type_JavaLangString);
      ((FTSMessage)localObject).istroop = paramaktc.jdField_a_of_type_Int;
      ((FTSMessage)localObject).deleteOpt();
      paramaukp.b(FTSMessageCodec.a((FTSMessage)localObject));
      label288:
      return;
    }
    catch (NumberFormatException paramaktc) {}
  }
  
  public void c()
  {
    super.c();
    if (1 == bbmo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_a_of_type_Aktl.obtainMessage(1, this).sendToTarget();
    }
  }
  ...
  public boolean c()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      catch (Throwable localThrowable1)
      {
        ...
        akta.jdField_a_of_type_Boolean = false;
        return false;
      }
      for (int i = 0;; i = -1)
      {
        ...
        for (int j = 0;; j = -1)
        {
          ...
          Object localObject = localaukp.a(FTSMsgCounter.class, false, null, null, null, null, null, null);
          if (localObject != null)
          {
  ...
  public void e()
  {
    if ((!akta.jdField_a_of_type_Boolean) && (bbmo.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + akta.jdField_a_of_type_Boolean + ", FTSUpgradeFlag = " + bbmo.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
  ...
  {
    // Byte code:
    //   0: getstatic 722	akta:jdField_a_of_type_Boolean	Z
    //   3: ifne +64 -> 67
    //   6: aload_0
    //   7: getfield 71	akti:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10: invokestatic 734	bbmo:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   13: ifeq +54 -> 67
    ...
    //   38: getstatic 722	akta:jdField_a_of_type_Boolean	Z
    ...
    //   50: aload_0
    //   51: getfield 71	akti:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: invokestatic 734	bbmo:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    ...
    //   66: return
    //   67: aload_0
    //   68: getfield 71	akti:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 443	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   74: astore 9
    //   76: aload_0
    //   77: getfield 71	akti:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   80: invokevirtual 77	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   83: invokevirtual 300	aukq:createEntityManager	()Laukp;
    //   86: astore 7
    ...
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 263	akti:jdField_a_of_type_Int	I
    ...
    //   135: iconst_0
    //   136: aload_0
    //   137: getfield 263	akti:jdField_a_of_type_Int	I
    ...
    //   146: ldc_w 306
    //   149: aconst_null
    //   150: invokevirtual 311	aukp:a	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   153: astore 8
    //   155: aload 9
    //   157: ldc_w 374
    //   160: ldc_w 292
    ...
    //   168: iconst_0
    //   169: aload_0
    //   170: getfield 158	akti:jdField_b_of_type_Int	I
    ...
    //   198: iconst_0
    //   199: aload_0
    //   200: getfield 158	akti:jdField_b_of_type_Int	I
    ...
    //   209: ldc_w 306
    //   212: aconst_null
    //   213: invokevirtual 311	aukp:a	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   216: astore 9
    ...
    //   238: aload_0
    //   239: getfield 103	akti:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   242: ifnull +269 -> 511
    //   245: aload_0
    //   246: getfield 103	akti:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    ...
    //   286: istore_1
    //   287: aload_0
    //   288: getfield 103	akti:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   291: aload 11
    //   293: iconst_1
    //   294: iload_1
    ...
    //   299: aload_0
    //   300: aload_0
    //   301: getfield 263	akti:jdField_a_of_type_Int	I
    //   304: iload_1
    //   305: iadd
    //   306: putfield 263	akti:jdField_a_of_type_Int	I
    ...
    //   363: istore_1
    //   364: aload_0
    //   365: getfield 103	akti:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   368: aload 11
    //   370: iconst_2
    //   371: iload_1
    ...
    //   376: aload_0
    //   377: aload_0
    //   378: getfield 158	akti:jdField_b_of_type_Int	I
    //   381: iload_1
    //   382: iadd
    //   383: putfield 158	akti:jdField_b_of_type_Int	I
    ...
    //   428: aload_0
    //   429: getfield 175	akti:d	I
    //   432: i2l
    //   433: lstore 5
    //   435: aload_0
    //   436: aload_0
    //   437: getfield 103	akti:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   440: ldc_w 278
    //   443: invokevirtual 281	com/tencent/mobileqq/persistence/fts/FTSDatatbase:b	(Ljava/lang/String;)I
    //   446: putfield 175	akti:d	I
    ...
    //   511: aload 7
    //   513: invokevirtual 313	aukp:a	()V
    //   516: return
    //   517: iconst_0
    //   518: istore_1
    //   519: goto -232 -> 287
    ...
    //   553: aload 7
    //   555: invokevirtual 313	aukp:a	()V
    //   558: return
    //   559: astore 8
    //   561: aload 7
    //   563: invokevirtual 313	aukp:a	()V
    //   566: aload 8
    //   568: athrow
