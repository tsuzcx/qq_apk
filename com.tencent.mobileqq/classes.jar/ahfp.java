  ...
  implements View.OnClickListener
{
  ...
  public ahfp(LoginView paramLoginView, Context paramContext)
  {
    super(paramContext, 2131492876, 2131302762, paramLoginView.jdField_a_of_type_JavaUtilList);
  }
  ...
  public Filter getFilter()
  {
    if (this.jdField_a_of_type_AndroidWidgetFilter == null) {
      this.jdField_a_of_type_AndroidWidgetFilter = new ahfq(this);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (LinearLayout)paramView.findViewById(2131297459);
    ImageView localImageView = (ImageView)paramView.findViewById(2131302713);
    ...
    if ((localObject instanceof Bitmap))
    {
      ...
      localImageView = (ImageView)paramView.findViewById(2131302705);
      localImageView.setTag(Integer.valueOf(paramInt));
      localImageView.setOnClickListener(this);
      localImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131654155));
      paramView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131624009) + "%s", new Object[] { ((SimpleAccount)this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_JavaUtilList.get(paramInt)).getUin() }));
      if (getCount() != 1) {
        break label256;
      }
      paramViewGroup.setPadding(0, aciy.a(7.5F, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.getResources()), 0, aciy.a(7.5F, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.getResources()));
    }
    for (;;)
    {
      paramViewGroup.setOnClickListener(new ahfr(this, paramInt));
      paramView.setOnTouchListener(new mjh());
      return paramView;
      localImageView.setImageResource(2130840243);
      break;
      label256:
      if (paramInt == 0) {
        paramViewGroup.setPadding(0, aciy.a(7.5F, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.getResources()), 0, 0);
      } else if (paramInt == getCount() - 1) {
        paramViewGroup.setPadding(0, 0, 0, aciy.a(7.5F, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.getResources()));
      } else {
