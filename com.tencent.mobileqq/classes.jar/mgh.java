  ...
  extends lfe
{
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    if (paramInt3 == -5)
    {
      ...
      for (;;)
      {
        QQToast.a(this.a, 2131692834, 1).b(MultiVideoEnterPageActivity.b(this.a).getDimensionPixelSize(2131298998));
        return;
        this.a.jdField_a_of_type_Mgg.b.setVisibility(8);
      }
    }
    QQToast.a(this.a, 2131692833, 1).b(MultiVideoEnterPageActivity.c(this.a).getDimensionPixelSize(2131298998));
  }
