  ...
  implements ahan
{
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        localObject3 = ((alto)paramQQAppInterface.getManager(51)).e(paramString);
        if (localObject3 == null) {
          continue;
        }
        localObject1 = localObject2;
      ...
      finally
      {
        try
        {
          ...
          int n;
          int i1;
          azqs.b(paramQQAppInterface, "CliOper", "", "", "Free_call", "Free_call_tips", 0, 0, "", "", "", "");
          int i = 1;
          if (!QLog.isColorLevel()) {
            continue;
          }
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            else
            {
              ...
              localObject1 = localObject2;
              localObject4 = a(paramQQAppInterface, (String)localObject3, ayzl.a());
              if (localObject4 == null)
              {
                ...
                if (paramBoolean)
                {
                  ...
                  localObject2 = new NewIntent(paramQQAppInterface.getApp(), azch.class);
                  localObject1 = paramString;
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560824, null);
    paramVarArgs.findViewById(2131373446).setOnClickListener(new agzp(this));
    return paramVarArgs;
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      {
        return;
        localaozd = aozd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (!localaozd.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("FriendHotTipsBar", 2, "hasNetTipShow today");
      return;
    } while ((a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true) != 1) || (!this.jdField_a_of_type_Ahap.a(this, new Object[0])));
    ...
    localaozd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1);
  }
