  ...
  extends RemoteCommand
{
  ...
  public bmrf(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        bcst.b(this.a, "P_CliOper", "BizTechReport", "", "troop_member_card_plugin", "plugin_cmd_exp", 0, 0, paramBundle.getClass().getName(), null, null, null);
        return null;
      }
      ...
      bglj.a().a(this.a, paramBundle, this.a.getCurrentAccountUin(), this.a.getApp());
      paramBundle = localBundle;
      continue;
      ...
      localObject1 = (anmw)this.a.getManager(51);
      localObject2 = ((anmw)localObject1).b(paramBundle);
      if ((localObject2 == null) || (!((Friends)localObject2).isFriend())) {
        break label1375;
      }
      paramBundle = ((anmw)localObject1).a(paramBundle);
    ...
    for (long l1 = bbyp.a();; l1 = 0L)
    {
      ...
      if (bgjw.b(paramBundle)) {
        bcst.b(this.a, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
      }
      ...
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((anwd)this.a.a(20)).l(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((anwd)this.a.a(20)).k(paramBundle);
      paramBundle = localBundle;
      break;
      localObject1 = paramBundle.getString("uin");
      paramBundle = "";
      localObject1 = awzp.a(this.a, (String)localObject1, false);
      if (localObject1 != null)
      {
        if (((axap)localObject1).a == 1L) {
          paramBundle = this.a.getApp().getString(2131693066);
        }
        for (;;)
        {
          i = ((axap)localObject1).c;
          localBundle.putString("bind_name", paramBundle);
          localBundle.putInt("bind_icon", i);
          paramBundle = localBundle;
          break;
          if (((axap)localObject1).a == 2L) {
            paramBundle = this.a.getApp().getString(2131693064);
          } else if (((axap)localObject1).a == 3L) {
            paramBundle = this.a.getApp().getString(2131693065);
          }
        }
      }
      label1375:
