  ...
  implements WeiyunTransmissionGlobal.HostInterface
{
  ...
  public void fetchUploadServerInfo(UploadFile paramUploadFile, UploadType paramUploadType, WeiyunTransmissionGlobal.UploadServerInfoCallback paramUploadServerInfoCallback)
  {
    if (paramUploadFile.cmdType == 1)
    {
      ...
      if ((paramUploadFile.isCompress) && (!TextUtils.isEmpty(paramUploadFile.compressedPath)))
      {
        if (paramUploadFile.compressedSha != null) {
          ((WeiyunPB.DiskPicBackupReq)localObject).file_sha.set(bmua.a(paramUploadFile.compressedSha));
        }
        ((WeiyunPB.DiskPicBackupReq)localObject).file_size.set(paramUploadFile.compressedSize);
        ((WeiyunPB.DiskPicBackupReq)localObject).first_256k_crc.set((int)bmtt.a(paramUploadFile.compressedPath, 262144L));
        ...
        bmsd.a((WeiyunPB.DiskPicBackupReq)localObject, new bmrg(this, paramUploadServerInfoCallback, paramUploadFile));
      }
    }
    label311:
    while (paramUploadFile.cmdType != 0) {
      for (;;)
      {
        ...
        if (paramUploadFile.sha != null) {
          ((WeiyunPB.DiskPicBackupReq)localObject).file_sha.set(bmua.a(paramUploadFile.sha));
        }
        ((WeiyunPB.DiskPicBackupReq)localObject).file_size.set(paramUploadFile.fileSize);
        ((WeiyunPB.DiskPicBackupReq)localObject).first_256k_crc.set((int)bmtt.a(paramUploadFile.localPath, 262144L));
        continue;
    ...
    ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).pdir_key.set(bmua.a(paramUploadFile.pDirKey));
    ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).ppdir_key.set(bmua.a(paramUploadFile.pPDirKey));
    ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).use_mutil_channel.set(WeiyunTransmissionGlobal.getInstance().isNativeUpload());
    if ((paramUploadFile.isCompress) && (!TextUtils.isEmpty(paramUploadFile.compressedPath)))
    {
      if (paramUploadFile.compressedSha != null) {
        ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).file_sha.set(bmua.a(paramUploadFile.compressedSha));
      }
    ...
    for (;;)
    {
      ...
      bmsd.a((WeiyunPB.QqSdkFileUploadMsgReq)localObject, new bmrh(this, paramUploadServerInfoCallback, paramUploadFile));
      return;
      if (paramUploadFile.sha != null) {
        ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).file_sha.set(bmua.a(paramUploadFile.sha));
      }
