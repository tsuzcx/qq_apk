...
public class bmrf
{
  ...
  public bmrf(ReaderTabBarView paramReaderTabBarView, int paramInt1, String paramString, boolean paramBoolean, int paramInt2, RedTouchUI paramRedTouchUI)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          catch (NumberFormatException localNumberFormatException)
          {
            for (;;)
            {
              bmqw.a("ReaderTabBarView", localNumberFormatException.getMessage());
              continue;
              paramBoolean = false;
            }
          }
        ...
        catch (JSONException localJSONException)
        {
          for (;;)
          {
            bmqw.a("ReaderTabBarView", localJSONException.getMessage());
          }
        }
