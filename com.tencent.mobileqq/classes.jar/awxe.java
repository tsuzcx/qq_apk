  ...
  extends awum
{
  ...
  private TextViewWrapLayout a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(this.c)) {
      paramContext.setBackgroundResource(2130839144);
    }
    d(paramContext);
    return paramContext;
  }
  ...
  private void a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    int m = localResources.getDimensionPixelSize(2131167690);
  ...
  private void b(Context paramContext, ViewGroup paramViewGroup)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      int i = aciy.a(11.0F, paramContext);
      int j = aciy.a(14.0F, paramContext);
      paramViewGroup.setPadding(j, i, j, aciy.a(12.0F, paramContext));
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      Object localObject11 = (awul)((Iterator)localObject10).next();
      if ((localObject11 instanceof awwo))
      {
        localObject11 = (awwo)localObject11;
        if (((awwo)localObject11).n == awwo.m) {
          ((awwo)localObject11).n = awwo.k;
        }
      }
    }
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      localObject4 = (awul)((Iterator)localObject9).next();
      ((awul)localObject4).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      localObject5 = ((awul)localObject4).jdField_a_of_type_JavaLangString;
      if ((("picture".equals(localObject5)) || ("vote".equals(localObject5)) || ("video".equals(localObject5))) && (localObject3 == null)) {
        localObject3 = ((awul)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131302327), paramBundle);
      }
    }
    for (;;)
    {
      ...
      if (("title".equals(localObject5)) && (localObject2 == null))
      {
        ...
        localObject2 = (TextView)((awul)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131312553), paramBundle);
      }
      else if (localObject1 == null)
      {
        if (("summary".equals(localObject5)) || ("timer".equals(localObject5)))
        {
          localObject1 = (TextView)((awul)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131312537), paramBundle);
        }
        else if ("checklist".equals(localObject5))
        {
          paramView = (LinearLayout)((awul)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131312269), paramBundle);
          continue;
          ...
          {
            localObject5 = (awul)((Iterator)localObject10).next();
            ((awul)localObject5).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject6 = ((awul)localObject5).jdField_a_of_type_JavaLangString;
            if ((("picture".equals(localObject6)) || ("vote".equals(localObject6)) || ("video".equals(localObject6))) && (localObject3 == null)) {
              localObject3 = ((awul)localObject5).a(paramContext, null, paramBundle);
            }
          }
          for (;;)
          {
            ...
            if (("title".equals(localObject6)) && (localObject2 == null))
            {
              ...
              localObject2 = (TextView)((awul)localObject5).a(paramContext, null, paramBundle);
            }
            else if (localObject1 == null)
            {
              if (("summary".equals(localObject6)) || ("timer".equals(localObject6)))
              {
                localObject1 = (TextView)((awul)localObject5).a(paramContext, null, paramBundle);
              }
              else if ("checklist".equals(localObject6))
              {
                paramView = (LinearLayout)((awul)localObject5).a(paramContext, null, paramBundle);
                continue;
                ...
                if ((this.i == 1) || (this.i == 3)) {
                  if (this.i == 1)
                  {
                    localObject2 = new RelativeLayout.LayoutParams(aciy.a(50.0F, (Resources)localObject9), aciy.a(50.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = aciy.a(3.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = aciy.a(12.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).leftMargin = aciy.a(10.0F, (Resources)localObject9);
                    ...
                    if (localObject6 != null)
                    {
                      ...
                      i = k;
                      if ((paramContext instanceof awzf))
                      {
                        paramContext = (awzf)paramContext;
                        i = k;
                        if (paramContext != null)
                        {
                          if (TextUtils.isEmpty(paramContext.b())) {
                    ...
                    if (!(paramContext instanceof awzx)) {
                      break label1809;
                    }
                    paramContext = ((awzx)paramContext).jdField_a_of_type_JavaUtilArrayList;
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    return localObject4;
                    localObject2 = new RelativeLayout.LayoutParams(aciy.a(115.0F, (Resources)localObject9), aciy.a(70.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = aciy.a(3.0F, (Resources)localObject9);
                    break label819;
                    label1399:
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = aciy.a(7.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject7).topMargin = 0;
                    break label881;
                    if (!this.jdField_a_of_type_Boolean)
                    {
                      if (localObject1 != null) {
                        ((TextView)localObject1).setLineSpacing(aciy.a(1.0F, (Resources)localObject9), 1.0F);
                      }
                      localObject2 = new RelativeLayout.LayoutParams(aciy.a(50.0F, (Resources)localObject9), aciy.a(50.0F, (Resources)localObject9));
                      ((RelativeLayout.LayoutParams)localObject2).topMargin = aciy.a(7.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).leftMargin = aciy.a(10.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).addRule(3, ((TextView)localObject5).getId());
                      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
                      ((RelativeLayout.LayoutParams)localObject7).topMargin = aciy.a(5.0F, (Resources)localObject9);
                    ...
                    localObject2 = new RelativeLayout.LayoutParams(aciy.a(32.0F, (Resources)localObject9), aciy.a(32.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).leftMargin = aciy.a(6.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject2).addRule(11);
