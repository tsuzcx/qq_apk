  ...
  extends ajfb
{
  ...
  public long a;
  private auwp jdField_a_of_type_Auwp = new auwp(paramAppInterface, this.jdField_a_of_type_Avbn);
  private avbn jdField_a_of_type_Avbn = new avbn();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public avbo(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Avbn.b())
        {
          this.jdField_a_of_type_Avbn.a(2);
          paramArrayOfByte1 = (auwq)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Auwp.a(paramArrayOfByte2);
          this.jdField_a_of_type_Auwp.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Avbn.a(0);
  ...
  {
    Object localObject = kwg.a(paramArrayOfByte);
    paramArrayOfByte = ((kwh)localObject).a;
    localObject = ((kwh)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Avbn.d())
        {
          ...
          this.jdField_a_of_type_Auwp.a(paramLong);
          return;
        }
        ...
        {
          this.jdField_a_of_type_Avbn.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Avbn.g());
      this.jdField_a_of_type_Avbn.c(4);
      return;
    } while (this.jdField_a_of_type_Avbn.c());
    this.jdField_a_of_type_Avbn.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Avbn.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = kwg.a(paramString1.toByteArray(), paramString2.toByteArray());
        if (this.jdField_a_of_type_Auwp == null) {
          break;
        }
        if (this.jdField_a_of_type_Auwp.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Auwp.a(paramString1);
  }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Avbn.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Avbn.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Avbn.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Auwp.a())
            {
              ...
              this.jdField_a_of_type_Avbn.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(kwg.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Avbn.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Avbn.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
