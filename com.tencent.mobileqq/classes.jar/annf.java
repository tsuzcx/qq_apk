  ...
  extends WebViewPlugin
{
  ...
  public annf(Bundle paramBundle)
  {
    this.mPluginNameSpace = "ArkSecurity";
    if (paramBundle != null) {
      try
      {
        paramBundle.setClassLoader(annf.class.getClassLoader());
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentArkOpenSecurityArkBaseUrlChecker != null)
    {
      ...
      if (j == 0)
      {
        ...
        bool1 = true;
        label101:
        annd.c(this.jdField_a_of_type_JavaLangString, paramString1, j, i, this.b);
        bool2 = bool1;
        if (!bool1)
        {
  ...
  public void onDestroy()
  {
    ...
    anmg.a().a("callDisableReport", null, null);
  }
}
