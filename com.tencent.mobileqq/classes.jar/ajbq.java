  ...
  implements aivr
{
  ...
  private HashMap<String, aiyq> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public ajbq(int paramInt, Activity paramActivity)
  {
    this.jdField_b_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Ajnl = new ajnl(ajae.a(), paramActivity);
    this.jdField_a_of_type_Ajnp = new ajnp(paramActivity, ajae.a());
  ...
  private void a(long paramLong, int paramInt, ajcl paramajcl)
  {
    ApolloCmdChannel localApolloCmdChannel = ajae.a();
    if (localApolloCmdChannel != null)
    {
      localApolloCmdChannel.callbackFromRequest(paramLong, paramInt, "cs.get_redPacket_result.local", paramajcl.a());
      paramajcl.jdField_b_of_type_Int = 0;
      paramajcl.jdField_a_of_type_Boolean = false;
      return;
    }
    QLog.e("cmgame_process.CmGameSubProcessHandler", 1, "[notifyRedPacketResult] cmdChannel is null");
  }
  
  private void a(long paramLong, String paramString, aabp paramaabp)
  {
    if (paramaabp == null) {
      return;
    }
    ...
    paramaabp.a(str, null, new ajbv(this, paramString, paramLong));
  }
  
  private void a(long paramLong, String paramString1, String paramString2)
  {
    Object localObject = ajae.a(this.jdField_d_of_type_Int);
    if (localObject == null) {
    ...
    ((ajah)localObject).a(paramLong, paramString1, paramString2);
  }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_JavaUtilRegexPattern == null)
        {
          ...
          if (localObject != null)
          {
            localObject = ((ajcq)localObject).a(this.jdField_d_of_type_Int);
            if (QLog.isColorLevel()) {
  ...
  {
    if ((!paramString1.startsWith("cs.")) && (!paramString1.endsWith(".local")) && (!aivv.a(paramString1)) && (a(paramString1))) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramString2 = ajae.a(this.jdField_d_of_type_Int);
        ...
        if ("apollo_router_game.game_ad_linkcmd_get_ad".equals(paramString1))
        {
          ...
          ((ajdq)localObject2).a(paramString1, (String)localObject1, paramLong, 4, bool, paramString2);
          break;
  ...
  private byte[] a(String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = yyv.a((Context)localObject1);
  ...
  private void c()
  {
    ...
    do
    {
      ...
      {
        return;
        Activity localActivity = ((ajch)localObject).a();
  ...
  private void d()
  {
    ...
    if (localActivity != null) {
      ajae.a(this.jdField_d_of_type_Int, localActivity);
    }
  }
  ...
  private void e(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ajae.a(ajae.a(), i, j, this.jdField_d_of_type_Int, k, paramString);
        i = 0;
      }
      catch (Exception paramString)
      {
  ...
  private void f(long paramLong, String paramString)
  {
    ...
    ((ajdh)localObject).b(paramLong, paramString);
  }
  ...
  private void h(long paramLong, String paramString)
  {
    ...
    ((ajdh)localObject).a(paramLong, paramString);
  }
  ...
  private void h(String paramString)
  {
    ...
    paramString = a();
    if (paramString != null) {
      aqbc.a(paramString, localIntent, 20180427);
    }
  }
  ...
  private void i(long paramLong, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localCmGameInitParams = ((ajch)localObject).a();
      } while (localCmGameInitParams == null);
      localObject = ((ajch)localObject).a(localCmGameInitParams.appId, ((ajch)localObject).a());
    } while (localObject == null);
    if (localCmGameInitParams.accessTokenRet != 1)
    {
      ...
      ((aabp)localObject).a("login", null, new ajbu(this, paramString, paramLong, (aabp)localObject, localCmGameInitParams));
      return;
    }
    a(paramLong, paramString, (aabp)localObject);
  }
  ...
  private void i(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ajch localajch = ajae.a(this.jdField_d_of_type_Int);
        if (localajch != null)
        {
          localajch.jdField_c_of_type_Int = 0;
          ajrf localajrf2 = localajch.a();
          ajrf localajrf1;
          if ((localajrf2 != null) && (localajrf2.jdField_a_of_type_Long != 0L))
          {
            localajrf1 = localajrf2;
            if (localajrf2.jdField_a_of_type_Int != 0) {}
          }
          else
          {
            localajrf1 = this.jdField_a_of_type_Ajnl.a(paramString);
          }
          if (localajrf1 != null)
          {
            this.jdField_a_of_type_Ajnl.a(localajrf1);
            this.jdField_a_of_type_Ajnl.a(str);
            ThreadManager.getUIHandler().post(new CmGameSubProcessHandler.9(this));
            paramString = localajch.a();
            if (paramString != null)
            {
  ...
  private void j(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ajcl)localObject).jdField_d_of_type_Int = i;
        if ((((ajcl)localObject).jdField_a_of_type_Int <= 0) || (((ajcl)localObject).jdField_d_of_type_Int < ((ajcl)localObject).jdField_a_of_type_Int)) {
          break label345;
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameSubProcessHandler", 2, "[hanldeGetRedPacketResult] score:" + ((ajcl)localObject).jdField_d_of_type_Int + "info.grabState:" + ((ajcl)localObject).jdField_b_of_type_Int);
        }
        if (((ajcl)localObject).jdField_b_of_type_Int == 3)
        {
          a(paramLong, 0, (ajcl)localObject);
          if (!"0".equals(((ajcl)localObject).f)) {
            break label429;
          }
          ahiy.a(((ajcl)localObject).jdField_b_of_type_JavaLangString, ((ajcl)localObject).jdField_a_of_type_Long, ((ajcl)localObject).jdField_d_of_type_Int + "", Integer.parseInt(((ajcl)localObject).jdField_d_of_type_JavaLangString), bool1, false, this.jdField_d_of_type_Int);
          return;
        }
      }
      catch (Exception paramString)
      ...
      if (((ajcl)localObject).jdField_b_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          ahiy.a(ajae.a(), ((ajcl)localObject).g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.4(this, null, paramLong));
        }
        ((ajcl)localObject).jdField_b_of_type_Int = 1;
        return;
      }
      ((ajcl)localObject).jdField_a_of_type_Boolean = true;
      return;
      label345:
      a(paramLong, 0, (ajcl)localObject);
      if ("0".equals(((ajcl)localObject).f)) {}
  ...
  private void j(String paramString)
  {
    ...
    try
    {
      localajch = ajae.a(this.jdField_d_of_type_Int);
      if (localajch == null) {
        return;
      }
      localajrf = localajch.a();
      paramString = new JSONObject(paramString);
    ...
    localajrf.jdField_c_of_type_JavaLangString = paramString.optString("extendInfo");
    paramString = localajch.a();
    if (paramString != null)
    {
      paramString.mRoomId = l;
      localajrf.jdField_b_of_type_JavaLangString = paramString.mChineseName;
      localajrf.jdField_b_of_type_Int = paramString.mActionId;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          {
            ahiy.a(ajae.a(), paramString.g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.5(this, null, paramLong));
  ...
  private void k(String paramString)
  {
    ...
    if (localAppInterface != null) {
      ajne.a(localAppInterface, paramString);
    }
  }
  
  private void l(long paramLong, String paramString)
  {
    Object localObject = ajae.b(paramLong);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = ajae.a((int)paramLong);
    }
    if (paramString != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString.a("login", null, new ajbt(this, (CmGameInitParams)localObject, paramLong));
      }
    }
    try
    {
  ...
  private void m(long paramLong, String paramString)
  {
    ...
    {
      ajae.a().callbackFromRequest(paramLong, 6, "cs.xy_device_vibrate.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  private void n(long paramLong, String paramString)
  {
    ...
    {
      ajae.a().callbackFromRequest(paramLong, 4, "cs.xy_device_gyro_sensor_start.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  public aivx a(long paramLong, String paramString1, String paramString2)
  {
    ...
    ajch localajch = ajae.a(this.jdField_d_of_type_Int);
    if ((localajch != null) && (!localajch.b())) {
      if (paramLong == localajch.a()) {
        break label104;
      }
    }
    label104:
    do
    {
      do
      {
        ...
        {
          return null;
        } while ((localajch == null) || (localajch.a() == null));
        if (localajch.a().getLuaState() == paramLong) {
          break;
        }
      ...
      {
        ajne.a(this.jdField_d_of_type_Int, paramString2, a());
        return null;
      }
  ...
  {
    paramString = ajeg.a(paramString);
    ajch localajch = ajae.a(this.jdField_d_of_type_Int);
    if ((paramString == null) || (localajch == null))
    {
      QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[playADsVideo], adInfo or launcher is null.");
      return;
    }
    paramString.b = paramLong;
    localajch.a(paramString);
  }
  
  public void a(long paramLong, String paramString, aivs paramaivs)
  {
    if ((this.jdField_b_of_type_JavaUtilHashMap != null) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramaivs.a((Bitmap)this.jdField_b_of_type_JavaUtilHashMap.get(paramString), 200);
    }
    for (;;)
    {
      return;
      ...
      {
        ThreadManagerV2.excute(new CmGameSubProcessHandler.10(this, ((aiyq)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_a_of_type_JavaLangString, paramaivs, paramString), 128, null, true);
        return;
      }
      paramaivs = ajae.a();
      if (paramaivs != null)
      {
        Object localObject1 = ajae.a(this.jdField_d_of_type_Int);
        if (localObject1 == null)
        {
          QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
          return;
        }
        Object localObject2 = ((ajch)localObject1).a();
        try
        {
          ...
          paramaivs.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_a_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(long paramLong, String paramString, aivt paramaivt)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramaivt.a(((aiyq)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      return;
      ...
      if (paramaivt != null)
      {
        ...
        try
        {
          ...
          ((JSONArray)localObject2).put(paramString);
          ((JSONObject)localObject1).put("uidList", localObject2);
          paramaivt.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_b_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(aiyq paramaiyq)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramaiyq.jdField_c_of_type_JavaLangString, paramaiyq);
    }
  }
  ...
  {
    int i = this.e;
    if (ajne.a(a(), paramString, this.jdField_d_of_type_Int, i)) {}
    try
    {
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      paramString = ajae.a(this.jdField_d_of_type_Int);
      if (paramString != null) {
        paramString.a(i);
      }
      return;
  ...
  public void c(long paramLong, String paramString)
  {
    ...
    if (localajdq != null)
    {
      localObject1 = ajae.a(this.jdField_d_of_type_Int);
      if (localObject1 == null) {
        QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
      }
    }
    ...
    Object localObject1 = ((ajch)localObject1).a();
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localajdq.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject2).toString(), paramLong, jdField_c_of_type_Int, false, null);
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    Object localObject2 = ajae.b(paramLong);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = ajae.a((int)paramLong);
    }
    if (localObject1 != null)
    {
      localObject2 = ((ajch)localObject1).a();
      if (localObject2 != null) {
        try
        {
          CmGameInitParams localCmGameInitParams = ((ajch)localObject1).a();
