...
public class aals
{
  ...
  aume jdField_a_of_type_Aume = new aalu(this);
  ...
  public String a;
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new aalv(this);
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new aalt(this);
  public boolean a;
  ...
  public aals(QQAppInterface paramQQAppInterface, RegisterNewBaseActivity paramRegisterNewBaseActivity, Intent paramIntent)
  {
  ...
  {
    aumi.a().a(true);
    aumi.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqObserverWtloginObserver);
  }
  ...
  public void a()
  {
    if (QLog.isDevelopLevel()) {
      bbxx.a(getClass().getSimpleName(), a());
    }
    ...
    if ((this.h) && (this.i))
    {
      this.k = false;
      this.l = true;
      this.jdField_a_of_type_Bbyb = new bbyb(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity, null);
      this.jdField_a_of_type_Bbyb.a(this.jdField_d_of_type_JavaLangString, new aalw(this));
    }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      k();
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717120, 0);
    }
    for (;;)
    {
      this.k = false;
      ...
      if ((this.j) && (this.k)) {
        if (this.f) {
          ...
          aumg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      bcpw.a(BaseApplicationImpl.sApplication, ajyc.a(2131700828), 0).a();
    }
    j();
    LoginActivity.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
    h();
  ...
  public void e()
  {
    ...
    do
    {
      return;
      if (this.g) {
        axqw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80072FC", "0X80072FC", 0, 0, "", "", "", "");
      }
