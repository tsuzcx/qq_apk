...
public class ajfj
{
  ...
  {
    return airz.b(paramQQAppInterface);
  }
  
  public static aivx a(String paramString1, QQAppInterface paramQQAppInterface, int paramInt, String paramString2)
  {
    for (;;)
    {
      try
  ...
  public static ajes a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (ajes)((ajfg)paramQQAppInterface.getManager(249)).a().a(0);
  }
  
  public static ajey a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {}
    do
    {
  ...
  public static ajfb a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return ((ajfg)paramQQAppInterface.getManager(249)).a();
  }
  
  public static ajfc a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
  ...
  public static ajfg a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (ajfg)paramQQAppInterface.getManager(249);
  }
  ...
  public static ApolloActionData a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    return ((ajmw)paramQQAppInterface.getManager(155)).c(paramInt);
  }
  
  public static MessageForApollo a(String paramString, ajfb paramajfb)
  {
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          ((ApolloMessage)localObject).name = bbca.decode(paramString.getBytes("utf-8"), 0);
        }
        ...
        if (!paramString.isEmpty()) {
          ((ApolloMessage)localObject).text = bbca.decode(paramString.getBytes("utf-8"), 0);
        }
        ...
        if (paramString == null)
        {
          ...
          paramajfb = axaq.a(paramajfb.a(), paramajfb.a().a.jdField_a_of_type_JavaLangString, paramajfb.a().a.jdField_b_of_type_JavaLangString, paramajfb.jdField_a_of_type_Int, (ApolloMessage)localObject);
          paramajfb.inputText = paramString.optString("inputText");
          paramajfb.audioId = paramString.optInt("audioID");
          if (paramString.has("audioStartTime")) {
            paramajfb.audioStartTime = ((float)paramString.optDouble("audioStartTime"));
          }
          paramajfb.actionType = paramString.optInt("actionType");
          if (localJSONObject != null) {
            paramajfb.extendJson = localJSONObject.toString();
          }
          if (paramString.has("mApollo3DMessage"))
          {
            ...
            paramajfb.mApollo3DMessage = ((Apollo3DMessage)localObject);
          }
          return paramajfb;
        }
      }
  ...
  public static String a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    String str = "";
    if (-1 == paramInt) {
      paramString2 = bbcl.c(paramQQAppInterface, paramString1, true);
    }
    label253:
    do
    {
      for (;;)
      {
        ...
        if (paramBoolean) {}
        for (str = bbcl.f(paramQQAppInterface, paramString2, paramString1);; str = bbcl.e(paramQQAppInterface, paramString2, paramString1))
        {
          ...
          paramString2 = ((ajxn)paramQQAppInterface.getManager(51)).e(paramString1);
    ...
    label272:
    if (paramBoolean) {}
    for (str = bbcl.p(paramQQAppInterface, paramString1);; str = bbcl.c(paramQQAppInterface, paramString1, true))
    {
      paramString2 = str;
  ...
  public static void a(int paramInt, Object... paramVarArgs)
  {
    ...
    ((ajfg)localObject).a(i, paramVarArgs);
  }
  
  public static void a(ajfb paramajfb, List<SpriteTaskParam> paramList)
  {
    if ((paramajfb == null) || (paramList == null) || (paramList.size() == 0)) {}
    do
    {
      return;
      paramajfb = a(paramajfb.a());
    } while (paramajfb == null);
    paramajfb.a().a(paramList);
  }
  
  public static void a(ajfs paramajfs, int paramInt, ApolloActionData paramApolloActionData)
  {
    if (paramajfs == null) {
      return;
    }
    ...
    paramApolloActionData = paramajfs.a();
    ...
    paramajfs.a().a(localSpriteTaskParam);
  }
  
  public static void a(ajfs paramajfs, String paramString, int paramInt1, int paramInt2)
  {
    if ((paramajfs == null) || (paramajfs.a() == null)) {
      return;
    }
    ajes localajes = paramajfs.a();
    paramajfs.a().a(paramInt1);
    paramajfs = paramajfs.a();
    int i = 1;
    if (paramajfs != null) {
      i = airz.a(paramajfs, paramajfs.c());
    }
    localajes.a("", paramString, a(paramInt1, paramInt2, paramString, i));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    do
    {
      ...
      {
        return;
        localajfb = a(paramQQAppInterface);
      } while (localajfb == null);
      k = localajfb.jdField_a_of_type_Int;
      if ((1 == k) || (3000 == k))
      {
        i = 0;
        int j;
        ...
        {
          VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "g_msg_clk", j, k, new String[] { str, paramSpriteTaskParam, String.valueOf(i), String.valueOf(System.currentTimeMillis() / 1000L), localajfb.jdField_a_of_type_JavaLangString });
          return;
          i = 1;
          break;
          j = 1;
    ...
    for (int i = 0;; i = 1)
    {
      VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "msg_clk", i, 0, new String[] { Integer.toString(paramSpriteTaskParam.f), str, "", String.valueOf(System.currentTimeMillis() / 1000L), localajfb.jdField_a_of_type_JavaLangString });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    if ((paramInt == 0) && (bbbd.b(paramString)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramInt != 1) && (paramInt != 0) && ((paramInt != 3000) || (airz.c("discuss") != 1)))
    {
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString, SpriteTaskParam paramSpriteTaskParam, ajfb paramajfb, boolean paramBoolean)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((TextUtils.isEmpty(paramString)) || (paramajfb == null) || (paramajfb.a() == null)) {
      bool1 = false;
    }
    label111:
    do
    {
      do
      {
        ...
        {
          return bool1;
          paramajfb = paramajfb.a().getCurrentAccountUin();
          ...
          if ((!paramString.equals(paramSpriteTaskParam.jdField_b_of_type_JavaLangString)) || (!paramString.equals(paramajfb))) {
            break;
          }
          bool1 = bool2;
      ...
      bool1 = bool2;
    } while (paramString.equals(paramajfb));
    return false;
    return false;
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localSharedPreferences = localajfb.jdField_a_of_type_AndroidContentSharedPreferences;
        } while (localSharedPreferences == null);
        i = localSharedPreferences.getInt("audio_tips_times" + localajfb.jdField_b_of_type_JavaLangString, 0);
        if (QLog.isColorLevel()) {
          QLog.d("cmshow_scripted_SpriteUtil", 2, "totalTimes:" + i);
        }
      } while (3 == i);
      localSharedPreferences.edit().putInt("audio_tips_times" + localajfb.jdField_b_of_type_JavaLangString, i + 1).commit();
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    {
      ajlq.a(i, 10, 102, new Object[] { "not meet basic case" });
    ...
    do
    {
      ...
      {
        return false;
        if (1 != ajkk.a(paramQQAppInterface.c(), paramQQAppInterface))
        {
          ajlq.a(i, 10, 101, new Object[] { "cmshow switch NOT opend" });
        ...
        ajlq.a(i, 10, 104, new Object[] { "aio anonymous" });
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (airz.a(BaseApplicationImpl.getContext())) {
          break;
        }
      } while (!QLog.isColorLevel());
