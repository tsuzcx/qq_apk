...
public class xam
{
  public static azsh a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, xba paramxba)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    int i = apug.a(apvd.a(paramItem.FileName));
    ...
    for (;;)
    {
      ...
      return a(paramQQAppInterface, paramxba, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      bool = false;
      break;
      label250:
  ...
  public static azsh a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, xbc paramxbc)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramxbc, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static azsh a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, xbe paramxbe)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    return a(paramQQAppInterface, paramLong, paramItem.FileName, paramItem.LocalFile, paramItem.ProgressTotal, paramItem.isFromAIO, paramItem.Md5, paramItem.Sha, paramItem.Sha3, paramItem.BusId, paramItem.mParentId, localBundle, paramxbe);
  }
  
  public static azsh a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, xat paramxat)
  {
    ...
    return a(paramQQAppInterface, paramxat, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4, null);
  }
  
  public static azsh a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString3, int paramInt, String paramString4, Bundle paramBundle, xbe paramxbe)
  {
    ...
    for (paramInt = 5;; paramInt = 4)
    {
      ...
      return a(paramQQAppInterface, paramxbe, paramString1.toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, paramBundle);
      localUploadFileReqBody.str_parent_folder_id.set(paramString4);
      break;
    }
  }
  
  public static azsh a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, xbe paramxbe)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramxbe);
  }
  
  private static azsh a(QQAppInterface paramQQAppInterface, mxj parammxj, byte[] paramArrayOfByte, String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    paramArrayOfByte.jdField_a_of_type_Mxj = parammxj;
  ...
  private static String a(TroopFileTransferManager.Item paramItem)
  {
    try
    {
      ...
      Object localObject;
      if (vyf.c(paramItem.middleThumbnailFile)) {
        localObject = new File(paramItem.middleThumbnailFile);
      }
      for (String str = "mid";; str = "larg")
      {
        localObject = aqvu.a(BaseApplicationImpl.getContext(), (File)localObject);
        if (localObject == null) {
          break label175;
        }
        ...
        return paramItem.strQRUrl;
        if (!vyf.c(paramItem.largeThumbnailFile)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, xas paramxas)
  {
    boolean bool;
    ...
    for (;;)
    {
      ...
      mxf.b(paramQQAppInterface, paramxas, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label343:
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, msg_ctrl.MsgCtrl paramMsgCtrl, xbb paramxbb)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mxf.b(paramQQAppInterface, paramxbb, paramMsgCtrl.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, paramBundle);
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, xbb paramxbb)
  {
    a(paramQQAppInterface, paramLong, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, null, paramxbb);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, Bundle paramBundle, xaz paramxaz)
  {
    ...
    mxf.b(paramQQAppInterface, paramxaz, paramString.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, paramBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, xap paramxap)
  {
    ...
    mxf.b(paramQQAppInterface, paramxap, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, xaw paramxaw)
  {
    ...
    mxf.b(paramQQAppInterface, paramxaw, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, xav paramxav)
  {
    ...
    mxf.b(paramQQAppInterface, paramxav, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, azpi paramazpi, xbd paramxbd)
  {
    if ((paramLong == 0L) || (paramazpi == null)) {
      return;
    }
    ...
    localTransFileReqBody.uint32_bus_id.set(paramazpi.a);
    localTransFileReqBody.str_file_id.set(paramazpi.b);
    Bundle localBundle = new Bundle();
    localBundle.putLong("troopUin", paramLong);
    localBundle.putString("fileId", paramazpi.b);
    paramazpi = new oidb_0x6d9.ReqBody();
    paramazpi.trans_file_req.set(localTransFileReqBody);
    mxf.b(paramQQAppInterface, paramxbd, paramazpi.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, xbb paramxbb)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return;
    }
    ...
    localObject = aqvu.a(paramItem.LocalFile, paramItem.width, paramItem.height, (String)localObject);
    a(paramQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, paramItem.RandomNum, paramItem.width, paramItem.height, paramItem.duration, true, localBundle, (msg_ctrl.MsgCtrl)localObject, paramxbb);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, xao paramxao)
  {
    ...
    mxf.b(paramQQAppInterface, paramxao, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, xay paramxay)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
    ...
    mxf.b(paramQQAppInterface, paramxay, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, xaq paramxaq)
  {
    ...
    mxf.b(paramQQAppInterface, paramxaq, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, xar paramxar)
  {
    if (QLog.isDevelopLevel()) {
    ...
    mxf.b(paramQQAppInterface, paramxar, localReqBody.toByteArray(), "OidbSvc.0x6d8_1", 1752, 2, localBundle);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, xau paramxau)
  {
    ...
    mxf.a(paramQQAppInterface, paramxau, localReqBody.toByteArray(), "OidbSvc.0x6d8_3", 1752, 3, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, azsh paramazsh)
  {
    if ((paramQQAppInterface == null) || (paramazsh == null)) {
      return;
    }
    paramQQAppInterface.getTroopFileProtoReqMgr().b(paramazsh);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, xax paramxax)
  {
    paramString1 = new baid("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + bfnx.a(paramString4) + "&", "GET", new xan(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramxax), 1000, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, long paramLong1, TroopFileTransferManager.Item paramItem, long paramLong2, long paramLong3, xaz paramxaz)
  {
    ...
    for (;;)
    {
      ...
      mxf.b(paramQQAppInterface, paramxaz, localReqBody.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, (Bundle)localObject);
      return;
