  ...
  implements View.OnTouchListener
{
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            this.jdField_a_of_type_Bmht.a(paramMotionEvent);
            return true;
          }
          this.jdField_b_of_type_AndroidViewMotionEvent = MotionEvent.obtain(paramMotionEvent);
          this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bmht.a(this.jdField_a_of_type_AndroidViewMotionEvent, this.jdField_b_of_type_AndroidViewMotionEvent);
    ...
    if (!this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Bmht.onClick(paramView);
    }
