  ...
  extends anud
{
  ...
  public aodb(AppInterface paramAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      if ("1".equals(paramString2))
      {
        ...
        if (arrayOfByte != null) {
          localJSONObject.put("chat_sig", new String(bhkv.encode(arrayOfByte, 0)));
        }
      }
      ...
      for (;;)
      {
        ...
        paramString1 = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), nkl.class);
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, long[] paramArrayOfLong, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      paramArrayOfLong = new NewIntent(paramNearbyAppInterface.getApplication().getApplicationContext(), nkl.class);
  ...
  private void a(Oidb_0x66b.RspBody paramRspBody, NearbyMyTabCard paramNearbyMyTabCard)
  {
    ...
    for (;;)
    {
      ayuo.a(this.a, paramNearbyMyTabCard);
    ...
    try
    {
      ...
      if ((paramRspBody1.rpt_msg_uin_data.has()) && (paramRspBody1.rpt_msg_uin_data.size() > 0))
      {
        ...
        if ((paramNearbyMyTabCard.gender == 1) || (paramNearbyMyTabCard.gender == 2)) {
          axws.a(paramNearbyMyTabCard.uin + "", "self_gender", Integer.valueOf(paramNearbyMyTabCard.gender));
        }
  ...
  private boolean a(oidb_0xada.ReqBody paramReqBody)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      paramReqBody.version_code.set(arta.a(BaseApplicationImpl.sApplication));
    ...
    if (paramRspBody.stConfigList.has())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        else
        {
          ...
          localNearbyMyTabConfig.extraVal = ((NearbyMyTabCard.NearbyMyTabConfigExtraVal)ayuo.a.get(Integer.valueOf(localNearbyMyTabConfig.configId)));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramObject = axws.a("nearby_visitor_file", this.a.getAccount(), 0).edit();
      if (l1 > 0L)
      {
  ...
  cmd0x77f.VisitProfRec a(axwr paramaxwr)
  {
    cmd0x77f.VisitProfRec localVisitProfRec = new cmd0x77f.VisitProfRec();
    localVisitProfRec.uint64_tinyid.set(paramaxwr.jdField_a_of_type_Long);
    localVisitProfRec.uint32_seq.set(paramaxwr.jdField_a_of_type_Int);
    if (paramaxwr.c > 0) {
      localVisitProfRec.uint32_enter_count.set(paramaxwr.c);
    }
    if (paramaxwr.d > 0) {
      localVisitProfRec.uint32_visit_duration.set(paramaxwr.d);
    }
    if (paramaxwr.e > 0) {
      localVisitProfRec.uint32_visit_pic_count.set(paramaxwr.e);
    }
    if (paramaxwr.f > 0) {
      localVisitProfRec.uint32_opflag.set(paramaxwr.f);
    }
    if (QLog.isColorLevel()) {
      QLog.d("NearbyHandler", 2, "convert2VisitRec ,record =" + paramaxwr);
    }
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramToServiceMsg.msg_self_info.has())
      {
        ...
        ((araf)this.a.getManager(210)).a(this.a, paramObject);
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    localQueryRecommendReq.uint32_client_version.set(arta.a(BaseApplicationImpl.sApplication));
    SosoInterface.SosoLbsInfo localSosoLbsInfo = apch.a("LBSService.Point");
    if ((localSosoLbsInfo != null) && (localSosoLbsInfo.a != null))
    {
      localObject = new nearbyPeopleRecommend.Location();
      double d1 = Double.valueOf(localSosoLbsInfo.a.a * 1000000.0D).intValue();
      double d2 = Double.valueOf(localSosoLbsInfo.a.b * 1000000.0D).intValue();
  ...
  public void a(List<axwr> paramList, boolean paramBoolean)
  {
    int j = 0;
    ...
    if (k <= 200)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((cmd0x77f.ReqBody)localObject1).uint32_list_ruleid.set(((axwr)paramList.get(0)).b);
        i = j;
        while (i < k)
        {
          localObject2 = a((axwr)paramList.get(i));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramFromServiceMsg = "0";; paramFromServiceMsg = "-1")
    {
      ...
      paramObject.put("param_NetType", String.valueOf(bhnv.a(BaseApplication.getContext())));
      paramObject.put("param_DeviceType", String.valueOf(akrx.a()));
      long l = paramToServiceMsg.extraData.getLong("request_start_time");
      l = SystemClock.uptimeMillis() - l;
      bdmc.a(BaseApplicationImpl.getContext()).a(getCurrentAccountUin(), "actGetNearbyMyTab", bool, l, 0L, paramObject, "");
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if ("NeighborSvc.ReqGetPoint".equals(str))
        {
          ...
          for (int i = 5;; i = 6)
          {
            aocx.a(this, i, paramToServiceMsg, paramFromServiceMsg, paramObject);
            return;
          }
        }
        if ("OidbSvc.0x9c7_0".equals(str))
        {
          aocx.c(this, 10, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        if ("OidbSvc.0x686".equals(str))
        {
          aocx.b(this, 8, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
