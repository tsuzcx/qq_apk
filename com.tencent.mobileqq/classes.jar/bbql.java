...
public class bbql
{
  ...
  {
    return a(paramString, paramArrayOfInt, paramDrawable, null, new bbqm(paramArrayOfInt));
  }
  ...
  {
    return bbuv.a(new StringBuilder().append(ajsf.aW).append(".vipicon/").toString()) + paramString.hashCode() + ".png";
  }
