...
public class bbql
{
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, bbqp parambbqp)
  {
    ...
    {
      b(paramActivity, paramFile, paramString, parambbqp);
      return;
    }
    bhdj.a(paramActivity, 230).setTitle(paramActivity.getString(2131718171)).setMessage(paramActivity.getString(2131694680)).setPositiveButton(paramActivity.getString(2131718048), new bbqn(paramActivity, paramFile, paramString, parambbqp)).setNegativeButton(paramActivity.getString(2131694291), new bbqm()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    QZoneHelper.forwardToUploadPhoto(paramActivity, paramString, 0, 0, paramArrayList, paramActivity.getResources().getString(2131717494), paramInt);
  }
  
  private static void b(Activity paramActivity, File paramFile1, File paramFile2, bbqp parambbqp)
  {
    new bbqo(paramFile1, paramFile2, paramActivity, parambbqp).execute(new Void[0]);
  }
}
