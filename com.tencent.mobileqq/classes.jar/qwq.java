  ...
  extends PopupWindow
{
  ...
  public qwq(Context paramContext)
  {
    super(-2, -2);
  ...
  private void a()
  {
    ...
    qwr localqwr = new qwr(this, this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    this.jdField_a_of_type_Qwr = localqwr;
  ...
  private void b()
  {
    ...
    qwr.a(this.jdField_a_of_type_Qwr).setColor(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Qwr, this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    ...
    for (;;)
    {
      ...
      return;
      localLayoutParams.rightMargin = qwr.a(this.jdField_a_of_type_Qwr);
      this.jdField_a_of_type_Qwr.setRotation(90.0F);
      continue;
      localLayoutParams.bottomMargin = qwr.b(this.jdField_a_of_type_Qwr);
      this.jdField_a_of_type_Qwr.setRotation(180.0F);
      continue;
      localLayoutParams.leftMargin = qwr.a(this.jdField_a_of_type_Qwr);
      this.jdField_a_of_type_Qwr.setRotation(270.0F);
      continue;
      localLayoutParams.topMargin = qwr.b(this.jdField_a_of_type_Qwr);
      this.jdField_a_of_type_Qwr.setRotation(0.0F);
    }
  }
  ...
  {
    qwr.c(this.jdField_a_of_type_Qwr, paramInt);
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    qwr.a(this.jdField_a_of_type_Qwr, paramInt1);
    qwr.b(this.jdField_a_of_type_Qwr, paramInt2);
  }
  ...
  public int c()
  {
    return qwr.b(this.jdField_a_of_type_Qwr);
  }
