...
public class afco
  implements afcf, Handler.Callback, View.OnClickListener, View.OnTouchListener
{
  private int jdField_a_of_type_Int = 1;
  alox jdField_a_of_type_Alox = new afcq(this);
  public Context a;
  ...
  ased jdField_a_of_type_Ased = new afcs(this);
  auip jdField_a_of_type_Auip;
  private bcws jdField_a_of_type_Bcws;
  bcwt jdField_a_of_type_Bcwt = new afcr(this);
  ...
  public afco(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Context paramContext, String paramString)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity = paramFragmentActivity;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = paramString;
    paramQQAppInterface = LayoutInflater.from(paramContext).inflate(2131559200, null);
    this.jdField_a_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131376000);
    this.jdField_b_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131377981);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131363024));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131377944));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramQQAppInterface.findViewById(2131376328));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramQQAppInterface.findViewById(2131366906));
    this.jdField_c_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131364632);
    this.jdField_d_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131364636);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131364635));
    this.jdField_e_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131375360);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramQQAppInterface.findViewById(2131375358));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131375359));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131375361));
    this.g = paramQQAppInterface.findViewById(2131365595);
    this.jdField_f_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131366892);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramQQAppInterface.findViewById(2131366890));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramQQAppInterface.findViewById(2131362098));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131380054));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)paramQQAppInterface.findViewById(2131376154));
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131714949));
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131714947));
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131714950));
    }
  ...
  private void a(IntimateInfo paramIntimateInfo)
  {
    ...
    if ((paramIntimateInfo.commonTroopInfoList != null) && (paramIntimateInfo.commonTroopInfoList.size() > 0))
    {
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((IntimateInfo.CommonTroopInfo)localObject1).troopUin)))
      {
        ...
        localObject1 = bcxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, ((IntimateInfo.CommonTroopInfo)localObject1).troopCode);
        this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
        if (this.jdField_b_of_type_Boolean)
        {
          azmj.b(null, "dc00898", "", "", "0X800A21B ", "0X800A21B ", 0, 0, "", "", "", "");
        ...
        if (this.jdField_a_of_type_Auip != null) {
          paramIntimateInfo = this.jdField_a_of_type_Auip.a();
        }
        if (paramIntimateInfo != null) {
          break label819;
        }
        paramIntimateInfo = afcg.a(this.jdField_a_of_type_AndroidContentContext);
      }
    }
    label799:
    label808:
    ...
    for (;;)
    {
      localObject1 = (TextView)paramIntimateInfo.findViewById(2131377979);
      localObject4 = (TextView)paramIntimateInfo.findViewById(2131377868);
      ...
      if (((IntimateInfo.DNAInfo)localObject3).viceTitle != null)
      {
        ...
        if (!TextUtils.isEmpty(((IntimateInfo.DNAInfo)localObject3).linkWording))
        {
          ...
          ((SpannableString)localObject1).setSpan(new afcp(this, (IntimateInfo.DNAInfo)localObject3), j, k, 33);
      ...
      for (;;)
      {
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = bdkf.a(16.0F);
  ...
  private void f()
  {
    ...
    for (String str = ""; (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (str.equals(this.jdField_c_of_type_JavaLangString)); str = aojh.a().jdField_c_of_type_JavaLangString) {
      return;
    }
    Object localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840250);
  ...
  private void g()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetButton != null) && (this.jdField_f_of_type_AndroidWidgetTextView != null))
    {
      ...
      if (!localaloz.b(this.jdField_a_of_type_JavaLangString)) {
        break label77;
      }
    ...
    for (;;)
    {
      ...
      return;
      label77:
      if (!localaloz.d(this.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(8);
        if (this.jdField_b_of_type_Boolean)
        {
          azmj.b(null, "dc00898", "", "", "0X800A218 ", "0X800A218 ", 0, 0, "", "", "", "");
      ...
      else
      {
        ...
        if (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null)) {
          this.jdField_f_of_type_AndroidWidgetTextView.setBackgroundResource(2130840235);
        } else {
  ...
  public void a(auip paramauip)
  {
    ...
    if (this.jdField_a_of_type_Auip != null) {
      this.jdField_a_of_type_Auip.c(this.jdField_a_of_type_AndroidWidgetButton);
    }
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          ...
          this.jdField_a_of_type_Asdx.a(l1, (ArrayList)localObject, null);
          if (QLog.isColorLevel()) {
      ...
      ((Message)localObject).obj = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131720293);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 2131362098: 
        if ((this.jdField_a_of_type_Auip != null) && (this.jdField_a_of_type_Auip.a() == 1)) {
          azmj.b(null, "dc00898", "", "", "0X800A214", "0X800A214", 2, 0, "", "", "", "");
        }
        azmj.b(null, "dc00898", "", "", "0X800A219 ", "0X800A219 ", 0, 0, "", "", "", "");
        QLog.d("Intimate report test", 2, "REPORT_TAG_0X800A219");
      }
    } while (this.jdField_a_of_type_Auip == null);
    String str = this.jdField_a_of_type_Auip.a();
    paramView = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    Object localObject = this.jdField_a_of_type_Auip.a();
    if (localObject != null) {}
    for (paramView = ((auij)localObject).b();; paramView = paramView.b(str, this.jdField_a_of_type_JavaLangString))
    {
      ...
      azmj.b(null, "dc00898", "", "", "0X800A21A ", "0X800A21A ", this.jdField_a_of_type_Int, 0, "", "", "", "");
      ...
      localObject = aekt.a(new Intent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, SplashActivity.class), null);
