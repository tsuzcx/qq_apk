  ...
  extends ViewModel
{
  ...
  private Bitmap a(baky parambaky)
  {
    if (parambaky != null)
    {
      BitmapFactory.Options localOptions = new BitmapFactory.Options();
      localOptions.inScaled = false;
      if ((!ThemeUtil.isDefaultTheme()) && (!TextUtils.isEmpty(parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFilePath)))
      {
        if (QLog.isColorLevel()) {
          QLog.d("ResourceGrabViewModel", 2, "get theme package resource");
        }
        return BitmapFactory.decodeFile(parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFilePath, localOptions);
      }
      parambaky = parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName.substring(0, parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName.indexOf("."));
      BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
      String str = localBaseApplication.getPackageName();
      int i = localBaseApplication.getResources().getIdentifier(parambaky, "drawable", str);
      if (i > 0)
      {
        if (QLog.isColorLevel()) {
  ...
  private List<baky> a(List<baky> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        baky localbaky = (baky)paramList.next();
        if (!localHashSet.contains(localbaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName)) {
          localArrayList.add(localbaky);
        }
        localHashSet.add(localbaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName);
      }
    }
    return localArrayList;
  }
  
  private void a(Drawable paramDrawable, List<baky> paramList, String paramString)
  {
    if ((paramDrawable != null) && (paramDrawable.getConstantState() != null) && (paramList != null))
    {
      ...
      paramList.add(new baky(paramString, ((BaseConstantState)paramDrawable).skinData));
      if (QLog.isColorLevel()) {
  ...
  private void a(View paramView, List<baky> paramList)
  {
    ...
    paramList.add(new baky("text_color", ((SkinnableColorStateList)paramView).skinData));
  }
  
  private void a(baky parambaky, HashSet<String> paramHashSet)
  {
    if ((!ThemeUtil.isDefaultTheme()) && (!TextUtils.isEmpty(parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFilePath))) {
      paramHashSet.add(parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFilePath);
    }
    Object localObject;
    do
    {
      ...
      String str2 = parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName.substring(0, parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName.indexOf("."));
    ...
    parambaky = b(parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName);
    paramHashSet.add(parambaky.getAbsolutePath());
    try
    {
      if (!parambaky.exists())
      {
        if (!parambaky.getParentFile().exists()) {
          parambaky.getParentFile().mkdir();
        }
        parambaky.createNewFile();
      }
      parambaky = new OutputStreamWriter(new FileOutputStream(parambaky), "utf-8");
      parambaky.write((String)localObject);
      parambaky.flush();
      parambaky.close();
      return;
    }
    catch (Exception parambaky)
    {
      QLog.d("ResourceGrabViewModel", 1, parambaky, new Object[0]);
    }
  }
  ...
  private void a(HashSet<String> paramHashSet)
  {
    try
    {
      ...
      ((anjx)BaseActivity.sTopActivity.app.a(8)).a(localArrayList);
    }
  ...
  private void b(baky parambaky, HashSet<String> paramHashSet)
  {
    Bitmap localBitmap = a(parambaky);
    if (localBitmap != null)
    {
      localBitmap = a(localBitmap, parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName);
      parambaky = a(parambaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName);
      paramHashSet.add(parambaky.getAbsolutePath());
    }
    try
    {
      ...
      parambaky = new FileOutputStream(parambaky);
      localBitmap.compress(Bitmap.CompressFormat.PNG, 100, parambaky);
      parambaky.flush();
      parambaky.close();
      return;
    }
  ...
  public String a(List<baky> paramList)
  {
    ...
    while (i < j)
    {
      baky localbaky = (baky)paramList.get(i);
      if (localbaky != null)
      {
        localStringBuilder.append(localbaky.jdField_a_of_type_JavaLangString).append(":").append(localbaky.jdField_a_of_type_ComTencentThemeSkinData.mFileName);
        if (i != j - 1) {
          localStringBuilder.append("\n");
        }
      }
  ...
  public void a(View paramView, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (!paramBoolean)
      {
        if (!(localObject2 instanceof balg)) {
          return;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ResourceGrabViewModel", 2, "recovery onClick listener");
        }
        localObject1 = (balg)localObject2;
        paramView.setOnClickListener(((balg)localObject1).jdField_a_of_type_AndroidViewView$OnClickListener);
        paramView.setClickable(((balg)localObject1).jdField_a_of_type_Boolean);
        return;
      }
    }
    ...
    if ((!((List)localObject1).isEmpty()) && (!(localObject2 instanceof balg)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ResourceGrabViewModel", 2, "doReplace onClick listener");
      }
      paramView.setOnClickListener(new balg((List)localObject1, (View.OnClickListener)localObject2, paramView.isClickable()));
      paramView.setClickable(true);
    }
  }
  
  void a(List<baky> paramList)
  {
    if (!paramList.isEmpty())
    {
      HashSet localHashSet = new HashSet();
      Observable.from(paramList).distinct(new balf(this)).subscribeOn(Schedulers.io()).subscribe(new balc(this, localHashSet), new bald(this), new bale(this, localHashSet));
    }
  }
}
