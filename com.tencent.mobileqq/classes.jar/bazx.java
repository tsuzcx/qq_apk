  ...
  extends bayp
{
  ...
  public bazx(QQAppInterface paramQQAppInterface, PublicAccountInfo paramPublicAccountInfo, int paramInt)
  {
  ...
  protected long a(String paramString)
  {
    ...
    long l2 = bbgk.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name, 1073741824L);
    long l1 = l2;
  ...
  public void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        bbgk.a("all_result", "clk_public_uin", new String[] { "" + this.jdField_a_of_type_JavaLangString });
        bbda.a(null, 0, this.c, "0X8009D51", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), null);
      }
      String str = this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin();
      bfwu.a(null, "pubAcc_aio_open", str);
      Object localObject1 = (amxz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
      if (AppConstants.WEISHI_UIN.equals(str))
      {
        ukw.a((Context)localObject2, "from_search_result", 1, true);
        bbgk.a(this.jdField_a_of_type_JavaLangString, 50, 0, paramView, str, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.isOffLine, this.c);
        anap.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
        bbgk.a(this.jdField_a_of_type_JavaLangString, 50, paramView, false);
      ...
      for (;;)
      {
        ...
        if (this.c == 12)
        {
          bcef.b((QQAppInterface)localObject2, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 1, 0, this.jdField_a_of_type_Int + "", "", str, this.jdField_a_of_type_JavaLangString);
          label283:
          paramView = odr.a();
        ...
        for (boolean bool = true;; bool = false)
        {
          ...
          {
            ugf.a((Context)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            break label133;
          }
          ...
          if (("2747277822".equals(str)) && (atzb.a()))
          {
            atzd.b((Context)localObject2);
          ...
          if (axil.jdField_a_of_type_JavaLangString.equals(str))
          {
            axin.a((Context)localObject2, str, 3);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().a(axil.jdField_a_of_type_JavaLangString, 1008, false);
            break label133;
          }
          if (TextUtils.equals("3046055438", str))
          {
            ohn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject2);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().a("3046055438", 1008, false);
            break label133;
          }
          if (((localObject1 != null) && (((amxz)localObject1).a(Long.valueOf(str)))) || ((localObject1 == null) && (ugf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str))))
          {
            ...
            localIntent.putExtra("selfSet_leftViewText", ((Context)localObject2).getString(2131690599));
            akms.a = true;
            akms.a(localIntent);
            ...
            ((amxz)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
            break label133;
          }
          if (TextUtils.isEmpty(str))
          {
          ...
          paramView = "0X8005D1E";
          break label212;
          odq.a((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", str, paramView, paramView, 0, 0, this.jdField_a_of_type_Int + "", "", this.jdField_a_of_type_JavaLangString, "", false);
          break label283;
        }
        paramView = null;
      }
  ...
  {
    SpannableString localSpannableString = new bbfz(new ArrayList(), a()).a(bbgk.a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary));
