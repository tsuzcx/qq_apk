...
import com.tencent.mobileqq.location.window.LocationFloatWindowManager.2;
...
public class ardn
  implements Manager
{
  ardi jdField_a_of_type_Ardi;
  private ardq jdField_a_of_type_Ardq;
  private final ards jdField_a_of_type_Ards;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private FloatMapWidget jdField_a_of_type_ComTencentMobileqqLocationWindowFloatMapWidget;
  public boolean a;
  
  public ardn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ardq = new ardq(paramQQAppInterface);
    this.jdField_a_of_type_Ards = new ards(paramQQAppInterface);
    this.jdField_a_of_type_Ardi = new ardi(paramQQAppInterface);
  }
  
  public static ardn a(QQAppInterface paramQQAppInterface)
  {
    return (ardn)paramQQAppInterface.getManager(143);
  }
  ...
  private void a(aqyw paramaqyw)
  {
    ...
    for (localObject = new LatLng(((TencentLocation)localObject).getLatitude(), ((TencentLocation)localObject).getLongitude());; localObject = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqLocationWindowFloatMapWidget = ((FloatMapWidget)LayoutInflater.from(BaseApplicationImpl.context).inflate(2131493603, null).findViewById(2131303869));
      this.jdField_a_of_type_Ardi.a(paramaqyw, (CameraPosition)localObject, this.jdField_a_of_type_ComTencentMobileqqLocationWindowFloatMapWidget, null);
      return;
    }
  }
  
  private boolean b(BaseActivity paramBaseActivity, aqyw paramaqyw)
  {
    ...
    if (i == 1)
    {
      aqzw.a(paramBaseActivity);
      return false;
    }
    localFloatingScreenManager.setWindowClickListener(1, new ardo(this, paramBaseActivity, paramaqyw));
    return true;
  }
  ...
  {
    LocationFloatWindowManager.2 local2 = new LocationFloatWindowManager.2(this, paramInt);
    ThreadManager.getUIHandlerV2().post(local2);
  }
  
  public boolean a(BaseActivity paramBaseActivity, aqyw paramaqyw)
  {
    if (!AppNetConnInfo.isNetSupport()) {
      bbmy.a(BaseApplicationImpl.context, 2131628948, 0).a();
    }
    do
    {
      return false;
      a(paramaqyw);
      a();
    } while (!b(paramBaseActivity, paramaqyw));
    a().a(paramaqyw);
    aqzc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c(paramaqyw.a(), paramaqyw.a());
    ardg.d();
    int i = ardg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaqyw);
    if (i != 0) {
      awqx.b(null, "CliOper", "", "", "0X800A974", "0X800A974", i, 0, "0", "0", "0", "");
    }
    return true;
  }
  ...
  {
    this.jdField_a_of_type_Ardq.b();
    this.jdField_a_of_type_Ards.a();
    this.jdField_a_of_type_Ardi.a();
    a(2);
  }
}
