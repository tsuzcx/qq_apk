...
public class aaug
  extends akil
{
  public aaug(ChatSettingForTroop paramChatSettingForTroop) {}
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        if ((paramRspBody != null) && (paramRspBody.isShown())) {
          bbbp.a("Grp_game", "Grp_data", "rank_exp", 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin });
        }
        paramRspBody = this.a.jdField_a_of_type_ArrayOfAndroidViewView[30];
      } while ((paramRspBody == null) || (!paramRspBody.isShown()));
      bbbp.a("Grp_game", "Grp_data", "feeds_exp", 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin });
      return;
    }
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt, TroopInfo paramTroopInfo)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (!bbbr.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, String.valueOf(paramLong)));
        if ((this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))))
        {
          ...
          if (this.a.jdField_a_of_type_Bcqi == null) {
            this.a.jdField_a_of_type_Bcqi = new bcqi(this.a);
          }
          if (paramBoolean)
          {
            this.a.jdField_a_of_type_Bcqi.a(1, this.a.getString(2131693577), 1000);
            return;
          }
          this.a.jdField_a_of_type_Bcqi.a(2, this.a.getString(2131693576), 1000);
  ...
  protected void a(boolean paramBoolean, long paramLong, RespBatchProcess paramRespBatchProcess)
  {
    ...
    banb.a(this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo, this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isMember);
    this.a.b(true);
  }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!paramBoolean) || (!bbbr.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin)));
      if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean, ArrayList<TroopMemberCardInfo> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      for (bool = false;; bool = a(paramArrayList))
      {
        ...
        this.a.jdField_a_of_type_Bcqi.a(2, paramString, 1000);
        return;
      }
      if ((!paramBoolean) && ((this.a.b & 0x1) == 1))
      {
        ...
        this.a.jdField_a_of_type_Bcqi.b(2, 2131694297, 1000);
        return;
      }
    } while ((!bool) || ((this.a.b & 0x1) != 1));
    paramArrayList = this.a;
    paramArrayList.b &= 0xFFFFFFFE;
    this.a.jdField_a_of_type_Bcqi.b(1, 2131694298, 1000);
  }
  ...
  protected boolean a(ArrayList<TroopMemberCardInfo> paramArrayList)
  {
    ...
    if ((localObject == null) && (i < paramArrayList.size()))
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        if (bbbr.a(localTroopMemberCardInfo.troopuin, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin))
        {
          localObject = localTroopMemberCardInfo;
          if (bbbr.a(localTroopMemberCardInfo.memberuin, this.a.app.getCurrentAccountUin())) {}
        }
        else
        {
          localObject = null;
    ...
    if ((localObject != null) && (!bbbr.a(paramArrayList, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopCard)))
    {
  ...
  protected void b(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.nNewFileMsgNum = bbdd.a(this.a.app.getCurrentAccountUin(), "troop_file_new", this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
  ...
  protected void b(boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    if (paramBoolean1) {
      if ((paramBoolean2) && (this.a.app != null)) {
        ((batp)this.a.app.getManager(234)).a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
      }
    }
    for (;;)
    {
      ...
      return;
      bcql.a(BaseApplication.getContext(), 2131696414, 0).b(this.a.getTitleBarHeight());
    }
  }
  ...
  protected void b(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    do
    {
      ...
      if ((localObject == null) && (i < paramArrayList.size()))
      {
        ...
        for (;;)
        {
          ...
          break;
          localObject = localTroopInfo;
          if (!bbbr.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin)) {
            localObject = null;
          }
        }
      }
    ...
    try
    {
      ...
      bame.a(this.a.app, 0, l2, l1, 0L, "", 0, "OidbSvc.0x852_48", (short)23, false, false);
      return;
    }
