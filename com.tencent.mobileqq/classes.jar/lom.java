...
public class lom
{
  ...
  public BeautyRender a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender == null) {
      this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender = new BeautyRender(BaseApplicationImpl.getContext(), lbf.h());
    }
    if (paramInt == this.jdField_a_of_type_Int) {
      return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
    }
    this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender.setBeautyLevel(paramInt * 1.0F / 100.0F * lot.a());
    this.jdField_a_of_type_Int = paramInt;
    return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
  }
  
  public lpi a(int paramInt1, int paramInt2, lpi paramlpi, FilterDesc paramFilterDesc, int paramInt3)
  {
    if (!lot.a()) {}
    ...
    for (;;)
    {
      paramlpi = localBeautyRender.process(paramlpi.b, paramlpi.jdField_a_of_type_Int, paramInt1, paramInt2);
      return lpi.a(paramlpi.getFbo(), paramlpi.getTextureId());
  ...
  public byte[] a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, FilterDesc paramFilterDesc, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      {
        lbc.e("AVSDKBeautyRender", "convertI420ToNV21 or convertI420ToNV12 e = " + paramArrayOfByte.getMessage());
