  ...
  extends RelativeLayout
{
  ...
  public algr(ApolloGameInfoFragment paramApolloGameInfoFragment, Context paramContext, String paramString)
  {
    super(paramContext);
    a(paramString);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    setOnClickListener(new algu(this, paramString, paramInt));
  }
  ...
  public void a(Bitmap paramBitmap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      setOnClickListener(new algt(this));
      return;
  ...
  public void a(String paramString)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject).setMargins(aekt.a(12.0F, getResources()), aekt.a(17.0F, getResources()), 100, aekt.a(20.0F, getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848977);
    paramString = new RelativeLayout.LayoutParams(aekt.a(9.0F, getResources()), aekt.a(18.0F, getResources()));
    paramString.addRule(11);
    paramString.addRule(15);
    paramString.rightMargin = aekt.a(27.0F, getResources());
    ...
    paramString.rightMargin = aekt.a(11.0F, getResources());
    paramString.addRule(11);
    paramString.rightMargin = aekt.a(27.0F, getResources());
    paramString.addRule(15);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(4);
    paramString = new RelativeLayout.LayoutParams(aekt.a(25.0F, getResources()), aekt.a(25.0F, getResources()));
    paramString.rightMargin = aekt.a(11.0F, getResources());
    paramString.addRule(0, this.c);
    paramString.addRule(15);
    setBackgroundResource(2130839178);
    addView(this.jdField_a_of_type_ComTencentImageURLImageView, paramString);
    setOnClickListener(new algs(this));
  }
