  ...
  extends ajfb
{
  ...
  public ajuo(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      avmq localavmq = new avmq(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          localavld.jdField_b_of_type_JavaLangString = localAssociationItem.sub_word.get().toStringUtf8();
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        avwf.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new avoh((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      baig.s(BaseApplicationImpl.getContext(), i);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (((UnifyTabSearch.RspBody)localObject1).search_ver.has()) {
          avwf.a("UnifySearch.Tab", arrayOfLong, ((UnifyTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
        ...
        Object localObject3 = new avqm();
        if (bool2) {
          ((avqm)localObject3).a(true);
        }
        paramToServiceMsg = ((avqm)localObject3).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public List<avom> a(Object... paramVarArgs)
  {
    ...
    label193:
    for (boolean bool1 = avwc.b(i);; bool1 = true)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!baig.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(avwf.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = baig.b(this.app.getCurrentAccountUin());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = avhs.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((avmr)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<avom> paramList)
  {
    ...
    {
      localObject1 = new avpt(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((avpt)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((avpt)localObject1).c(null);
      ((avpt)localObject1).a(bool2);
      if ((localObject1 != null) && (((avow)localObject1).b()))
      {
        ((avow)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((avow)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        default: 
          break;
        case 2: 
          localObject1 = new avou(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 3: 
          localObject1 = new avpq(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 4: 
          localObject1 = new avov(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 7: 
          localObject1 = new avpd(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 6: 
          localObject1 = new avpm(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 8: 
          localObject1 = new avpj(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 9: 
          localObject1 = new avpk(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 11: 
          localObject1 = new avpa(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 12: 
          localObject1 = new avoy(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 13: 
          localObject1 = new avpb(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 14: 
          localObject1 = new avpl(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 15: 
          localObject1 = new avpi(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 16: 
          localObject1 = new avpg(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 17: 
          localObject1 = new avph(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 18: 
          localObject1 = new avpf(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
          l2 = l1 - 1L;
          continue;
          label939:
          ...
          {
            localObject1 = new avpw(paramString, str7, -4, str5);
            ((avpw)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            localArrayList2.add(localObject1);
            l2 = l1;
          }
          else
          {
            localObject1 = new avnl(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
            l2 = l1;
            if (localObject1 != null)
            {
              ((avnl)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
              ((avnl)localObject1).c = bool1;
              ((avnl)localObject1).g = i;
              ((avnl)localObject1).a = paramInt;
              localArrayList2.add(localObject1);
              l2 = l1;
            }
          }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new avog(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label1262:
      paramList.add(new avnk(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        baig.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = avpu.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
