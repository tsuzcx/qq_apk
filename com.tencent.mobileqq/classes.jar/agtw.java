...
public class agtw
  extends agsl
{
  protected agtw(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public static agse b(NewPhotoListActivity paramNewPhotoListActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Agse == null) || (jdField_a_of_type_Agse.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoListActivity)) {
        jdField_a_of_type_Agse = new agtw(paramNewPhotoListActivity);
      }
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    {
      localObject1 = (String)this.jdField_a_of_type_Agsb.a.get(i1);
      int m;
    ...
    for (i = 1;; i = 0)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("PhotoListActivity", 2, "PhotoListLogicDataline isConfirmed=" + paramBoolean + " allowUploadInXGTime=" + axdo.b);
        }
        if ((!bbev.b(BaseApplicationImpl.getContext())) || (paramBoolean) || (i == 0)) {
          break;
        }
        paramArrayList = ((NewPhotoListActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719246);
        paramIntent = new PhotoListLogicDataline.1(this, paramIntent, i2, (String)localObject1, (String)localObject2);
        if (bcvm.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), 4, new agtx(this, paramIntent))) {
          bbcv.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), 232, null, paramArrayList, new agty(this, paramIntent), new agtz(this)).show();
        }
        if (QLog.isColorLevel()) {
      ...
      a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramIntent, this.jdField_a_of_type_Agsb.a);
      axqw.b(null, "CliOper", "", "", "0X8009AB0", "0X8009AB0", i2, 0, (String)localObject1, (String)localObject2, "", "");
      return;
    }
  }
}
