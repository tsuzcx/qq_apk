  ...
  implements axwp
{
  ...
  public Bitmap a(java.net.URL paramURL)
  {
    ...
    //   29: aload_1
    //   30: invokestatic 86	bacm:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   33: astore_1
    //   34: aload 8
    ...
    //   167: invokestatic 102	axwd:a	(Ljava/lang/String;)I
    //   170: istore_2
    //   171: aload_1
    //   172: astore 6
    //   174: iload_2
    ...
    //   260: idiv
    //   261: iload_2
    //   262: invokespecial 114	agar:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   265: astore 7
    //   267: aload_1
    //   268: astore 6
    //   270: aload 7
    ...
    //   293: iload 4
    //   295: idiv
    //   296: invokespecial 114	agar:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   299: astore 7
    //   301: aload_1
    //   302: astore 6
    //   304: aload 7
    ...
    //   437: iload 4
    //   439: idiv
    //   440: invokespecial 114	agar:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   443: astore 7
    //   445: aload_1
    //   446: astore 6
    //   448: aload 7
    ...
    //   472: idiv
    //   473: iload_3
    //   474: invokespecial 114	agar:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   477: astore 6
    //   479: aload 6
    //   481: ifnull +88 -> 569
    //   484: aload_1
