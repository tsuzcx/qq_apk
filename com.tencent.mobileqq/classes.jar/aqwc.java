...
public class aqwc
{
  public static final String a = anvx.a(2131714638);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          String[] arrayOfString = bhey.a(localObject2[i], "=");
          ...
          localObject2 = new String(bhcu.decode(arrayOfString[1], 0));
          localObject1 = localObject2;
          if (!((String)localObject2).contains("&gc=")) {
            localObject1 = String.format("%s&gc=%s", new Object[] { localObject2, axqj.a(paramString2) });
          }
          paramString2 = bhcu.encodeToString(((String)localObject1).getBytes(), 2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    for (;;)
    {
      try
      {
        localObject = ((aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER)).b();
        if (localObject != null) {
          continue;
        }
      ...
      localStringBuilder.append("&").append("quin").append("=").append(axqj.a(paramString1));
      localStringBuilder.append("&").append("topicId").append("=").append(paramInt2);
      localStringBuilder.append("&").append("sUin").append("=").append(axqj.a(paramString2));
      localStringBuilder.append("&").append("rUin").append("=").append(axqj.a(paramString3));
      ...
      return;
      localObject = ((aquz)localObject).o;
      continue;
      str = "aio_card_insert";
    }
  }
          ...
          for (;;)
          {
            ...
            catch (InvalidProtocolBufferMicroException paramStringBuilder)
            {
              try
              {
                ...
                paramList = (MessageForTroopConfess)bcsa.a(-2067);
  ...
  {
    if ((paramBaseChatPie == null) || (paramBaseChatPie.getRoot() == null)) {
      return false;
    }
    int i = ConfessPanel.a(paramBaseChatPie.getRoot().getResources().getDisplayMetrics().widthPixels);
    int j = ConfessPanel.a(paramBaseChatPie);
    i = ConfessPanel.a(paramBaseChatPie.getActivity().getResources(), i, j);
    if (QLog.isColorLevel()) {
      QLog.i("TroopConfessUtil", 2, String.format("showConfessPanel dstHeight=%d", new Object[] { Integer.valueOf(i) }));
    }
    String str = paramBaseChatPie.getActivity().getIntent().getStringExtra("url");
    Intent localIntent = new Intent(paramBaseChatPie.getActivity(), ConfessHalfScreenActivity.class);
    localIntent.putExtra("finish_animation_up_down", true);
    localIntent.putExtra("url", str);
    localIntent.putExtra("isTransparentTitle", true);
    localIntent.putExtra("confessDstHeight", i);
    localIntent.addFlags(603979776);
    paramBaseChatPie.getActivity().startActivityForResult(localIntent, 15002);
    paramBaseChatPie.getActivity().overridePendingTransition(2130771979, 0);
    return true;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      localaoep.b(paramString, false, "", false, true, false, false);
    }
    for (;;)
    {
      paramQQAppInterface = ((TroopManager)paramQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).c(paramString);
      if ((paramQQAppInterface == null) || ((paramQQAppInterface.dwGroupFlagExt3 & 0x2000) != 0L)) {
        break;
      }
      return true;
  ...
  public static Object[] a(String paramString)
  {
    ...
    for (Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject2 != null) {
          if (bhbx.a(str, ((TroopInfo)localObject2).troopowneruin))
          {
            i = 2;
        ...
        for (;;)
        {
          ...
          if (paramString != null)
          {
            ...
            for (;;)
            {
              ...
              if (bhbx.d(((TroopMemberInfo)localObject1).memberuin)) {
  ...
  {
    boolean bool2 = false;
    paramMessageRecord = bgiz.a(paramMessageRecord);
    boolean bool1 = bool2;
