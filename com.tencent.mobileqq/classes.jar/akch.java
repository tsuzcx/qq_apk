...
public class akch
  extends akak
{
  public akch(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
        ...
        for (;;)
        {
          try
          {
            ...
            else
            {
              ...
              if (j == 0)
              {
                paramToServiceMsg = (axat)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
                if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    localaxau.jdField_c_of_type_JavaLangString = str1;
    if (QLog.isColorLevel()) {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("printPBuffer", 2, bach.a((byte[])paramObject));
      }
    ...
    else
    {
      ...
      awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", false, 0L, 0L, paramToServiceMsg, "");
      a(8003, false, localaxau);
      return;
    }
    label336:
    label351:
      ...
      for (;;)
      {
        ...
        default: 
          if ((i == 1200) || (i == 1214) || (i == 1215) || (i == 1218) || (i == 1232) || (i == 1233) || (i == 1240) || (i == 1241) || (i == 1242) || (i == 1221))
          {
            ...
            localaxau.jdField_a_of_type_JavaLangString = paramObject.errmsg.get();
            localaxau.jdField_c_of_type_Boolean = true;
            axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, str1);
            axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, 6);
            localaxau.d = true;
            localaxat.a(str1, null, true);
            bool1 = localaxat.a(str1, 3);
            localaxat.a(str1, i, paramObject.errmsg.get());
            localaxat.e(str1);
            if (bool1)
            {
              ...
              if (i != 0)
              {
                ...
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(new String[] { ajed.x, str1 });
              }
              if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sub.uin.all");
          continue;
          localaxau.jdField_a_of_type_Int = 1002;
          axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, str1);
          axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1);
          continue;
          localaxau.jdField_a_of_type_Int = 1006;
          continue;
                ...
                for (localObject1 = paramObject.sync_cookie.get().toByteArray();; localObject1 = null)
                {
                  ...
                  for (int j = paramObject.sync_flag.get();; j = 2)
                  {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        if (localaxat != null) {}
                        for (List localList1 = localaxat.a(Long.toString(l3));; localList1 = null)
                        {
                          ...
                          for (;;)
                          {
                            ...
                            if (m < localList2.size())
                            {
                              ...
                              do
                              {
                                ...
                                localawam = new awam(l1, l6, false, false, false, true);
                              } while ((paramObject == null) || (paramObject.size() <= 0));
                              Collections.sort(paramObject, new akci(this));
                                ...
                                if (localObject2 != null)
                                {
                                  ...
                                  for (;;)
                                  {
                                    for (;;)
                                    {
                                      ...
                                      paramObject.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131654822);
                                      paramObject.msgtype = 193;
                                      paramFromServiceMsg.add(paramObject);
                                      continue;
                                      if ((awbk.c(i)) && (((msg_comm.MsgHead)localObject3).c2c_cmd.has()) && ((i1 == 169) || (i1 == 241) || (i1 == 242) || (i1 == 243) || (i1 == 129) || (i1 == 131) || (i1 == 133)))
                                      {
                                          ...
                                          catch (Exception paramObject)
                                          {
                                            try
                                            {
                                              ...
                                              if (TextUtils.isEmpty(paramObject)) {
                                                paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131625716);
                                              }
                                              paramObject = awbi.a(-2005);
                                              paramObject.selfuin = String.valueOf(l1);
                                              paramObject.frienduin = String.valueOf(l6);
                                              paramObject.senderuin = String.valueOf(l6);
                                              paramObject.shmsgseq = ((msg_comm.MsgHead)localObject3).msg_seq.get();
                                      ...
                                      try
                                      {
                                        paramFromServiceMsg = a((msg_comm.Msg)localObject2, localawam);
                                        if (paramFromServiceMsg == null) {}
                                      }
                                      catch (Exception paramObject)
                                      {
                                  ...
                                  try
                                  {
                                    ...
                                    if (String.valueOf(ajed.G).equalsIgnoreCase(((MessageRecord)localObject4).frienduin))
                                    {
                                      paramFromServiceMsg = axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, ((MessageRecord)localObject4).msgtype, ((MessageRecord)localObject4).senderuin);
                                      if (paramFromServiceMsg == null)
                                      {
                                        i = 1;
                              ...
                              for (;;)
                              {
                                try
                                {
                                  if (!baac.a(((MessageRecord)localObject4).msgtype)) {
                                    continue;
                                  }
                                  localObject4 = baac.a(((MessageRecord)localObject4).msg);
                                  paramFromServiceMsg = paramObject;
                                ...
                                paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131654007);
                                continue;
                                if (ajhz.a((MessageRecord)localObject4))
                                {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131625717);
                                }
                                ...
                                {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131625721);
                                  continue;
                                  ...
                                  catch (Exception paramObject)
                                  {
                                    ...
                                    continue;
                                    paramFromServiceMsg = paramObject;
                                    if (paramObject.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131625716))) {
                                      continue;
                                    }
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131625716) + paramObject;
                                    continue;
                                  }
                                  if (TextUtils.isEmpty(paramObject))
                                  {
                                  ...
                                  {
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131625722);
                                    continue;
                                    if ((localObject4 instanceof MessageForMarketFace))
                                    {
                                      ...
                                      if ((paramFromServiceMsg != null) && (!TextUtils.isEmpty(paramFromServiceMsg.faceName))) {
                                        ...
                                        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131626457);
                                      }
                                    }
                                    else
                                    {
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131626457);
                                      continue;
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131653887);
                                      continue;
                                      ...
                                      continue;
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(baak.a(((MsgBody)localObject4).shareAppID));
                                      paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131624594) + paramFromServiceMsg.messagetail + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131624595);
                                      continue;
                                      paramFromServiceMsg = paramObject;
                                      if (!baac.b(((MessageRecord)localObject4).msgtype))
                                      {
                                        paramFromServiceMsg = paramObject;
                                        if (((MessageRecord)localObject4).msg != null)
                                        {
                                          ...
                                          {
                                            localObject4 = awbk.a(((MessageRecord)localObject4).msg);
                                            paramObject = "";
                                            paramFromServiceMsg = paramObject;
                                            if (localObject4 != null)
                                            {
                                            ...
                                            paramFromServiceMsg = "[" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131654467) + "] " + paramFromServiceMsg;
                                          }
                                        }
                                      }
                                    }
                              ...
                              if ((paramFromServiceMsg != null) && (paramFromServiceMsg.from_nick.has()))
                              {
                                ...
                                if (i != 0) {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131654085);
                                }
                                if (QLog.isColorLevel()) {
                                ...
                                if (i != 0)
                                {
                                  ((SubAccountMessage)localObject2).frienduin = String.valueOf(ajed.G);
                                  label4222:
                                  if (!bool1) {
                                    break label4897;
                                  }
                                ...
                                for (l4 = System.currentTimeMillis() / 1000L;; l4 = l5)
                                {
                                  ...
                                  ((SubAccountMessage)localObject2).mTimeString = baiu.a(1000L * l5, true, axam.jdField_a_of_type_JavaLangString);
                                  ...
                                  if (localaxat != null) {
                                    localaxat.a((SubAccountMessage)localObject2);
                                  }
                                  if (QLog.isColorLevel())
                                  {
                                  ...
                                  axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, 6);
                                  localaxau.d = true;
                                  paramFromServiceMsg = awbi.a(((MessageRecord)localObject3).msgtype);
                            ...
                            else
                            {
                              if ((localList1 != null) && (localList1.size() > 0) && (k != 0))
                              {
                                ...
                                if (i < localList1.size())
                                {
                                  ...
                                  for (;;)
                                  {
                                    i += 1;
                                    break;
                                    if (!paramFromServiceMsg.frienduin.equals(String.valueOf(ajed.G)))
                                    {
                                      m = 0;
                                      ...
                                      if ((k != 0) && (localHashMap.containsKey(paramFromServiceMsg.frienduin))) {
                                        localaxat.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l3), paramFromServiceMsg.frienduin, ((Integer)localHashMap.get(paramFromServiceMsg.frienduin)).intValue());
                                      }
                                      if ((k == 0) && (localaxat != null))
                                      {
                                        k = localaxat.a(String.valueOf(l3), paramFromServiceMsg.frienduin);
                                        if (k != 0)
                                        {
                              ...
                              {
                                if (localaxat != null) {
                                  localaxat.a(str1, (byte[])localObject1);
                                }
                                ...
                                awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", true, 0L, 0L, paramFromServiceMsg, "");
                                if (b <= 0) {
                                  break label5377;
                                }
                                if (l3 <= 0L) {
                                ...
                                localaxau.jdField_a_of_type_Boolean = false;
                                a(8003, true, localaxau);
                                return;
                                label5350:
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    return;
    new akcj(this, paramObject, str, (String)localObject, i, j).execute(new Void[0]);
  }
  ...
  public void a(byte paramByte, int paramInt, String paramString1, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    paramArrayList = (axat)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
    ...
    for (paramArrayList = paramArrayList.a(paramString1);; paramArrayList = null)
    {
      ...
      catch (Exception paramString1)
      {
        try
        {
          do
          {
            localPbBindUinGetMsgReq.bind_uin_sig.set(ByteStringMicro.copyFrom(bakz.a(paramString2)));
            if (paramArrayList == null) {
              break;
            }
            if (QLog.isColorLevel()) {
  ...
  public void a(RequestPushNotify paramRequestPushNotify)
  {
    ...
    {
      localObject = awag.a(((MsgInfo)localObject).vMsg);
    ...
    do
    {
      ...
      try
      {
        ...
        awbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localReqBody, paramRequestPushNotify.lBindedUin, true);
        return;
      }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    while (i < paramObject.thirdqq_resp_info.get().size())
    {
      ...
      axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, str, arrayOfByte, k, m, n, i1, i2);
      i += 1;
    }
    axam.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, j);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (Object localObject = ((axat)localObject).a(paramString1);; localObject = null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localObject2 != null)
        {
          try
          {
            ...
            localThirdQQReqInfo.third_uin_sig.set(ByteStringMicro.copyFrom(bakz.a((String)localObject3)));
            localObject3 = axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
  ...
  public boolean a(SubAccountInfo paramSubAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      ((Oidb_0x5d0.ReqBody)localObject1).uint32_start_time.set(axam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramSubAccountInfo.subuin));
      try
      {
