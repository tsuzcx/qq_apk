...
public class bass
  implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, vds
{
  public static final int a;
  private ValueAnimator.AnimatorUpdateListener jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new bast(this);
  ...
  static
  {
    jdField_a_of_type_Int = vzo.a(BaseApplicationImpl.getContext(), 111.0F);
  }
  
  public bass(QQAppInterface paramQQAppInterface, Context paramContext, RelativeLayout paramRelativeLayout1, RelativeLayout paramRelativeLayout2, aznm paramaznm)
  {
    this.jdField_b_of_type_Int = 1;
    this.jdField_a_of_type_AndroidGraphicsDrawableAnimatable = null;
    this.jdField_a_of_type_AndroidWidgetTextView = null;
    this.jdField_b_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new basu(this);
    ...
    this.jdField_a_of_type_Batb = ((batb)paramQQAppInterface.getManager(234));
  }
  ...
  public void P_()
  {
    ...
    for (int i = 8;; i = 1)
    {
      ...
      localIntent.putExtra("selfSet_leftViewText", ajyc.a(2131715690));
      localIntent.putExtra("sort_type", i);
      this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
      if (this.jdField_b_of_type_Int == 2)
      {
        bbbb.a("Grp_idol", "Grp_renshu", "right", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString });
        return;
      }
      new axra(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("online_box").d("enter_mberList").a(new String[] { this.jdField_a_of_type_JavaLangString }).a();
      return;
      j = 17;
    }
  }
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Basv.b.clear();
    return this.c;
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewWidgetStoryHomeHorizontalListView == null)
    {
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewWidgetStoryHomeHorizontalListView = ((StoryHomeHorizontalListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377870));
      ...
      if (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))
      {
        ...
        this.jdField_a_of_type_Basv = new basv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
        this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewWidgetStoryHomeHorizontalListView.setAdapter(this.jdField_a_of_type_Basv);
    ...
    {
      e();
      localObject = ((batb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(this.jdField_a_of_type_JavaLangString);
      if ((localObject == null) || (((List)localObject).isEmpty())) {
        break label384;
      }
      this.jdField_a_of_type_Basv.a((List)localObject);
      this.jdField_a_of_type_Basv.notifyDataSetChanged();
      this.c = 0;
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aznm != null) {
        this.jdField_a_of_type_Aznm.a(true);
      }
      ...
      bbbb.a("Grp_idol", "Grp_renshu", "exp", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString });
      return;
      ...
      label384:
      if (this.jdField_a_of_type_AndroidWidgetTextView == null) {
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362324));
      }
      this.jdField_a_of_type_Basv.a();
      this.jdField_a_of_type_Basv.notifyDataSetChanged();
    ...
    label459:
    new axra(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("online_box").d("exp").a(new String[] { this.jdField_a_of_type_JavaLangString }).a();
  }
  
  public void a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    int i = this.jdField_a_of_type_Batb.a(this.jdField_a_of_type_JavaLangString);
    if (i == 3)
    {
  ...
  public void d()
  {
    if (a())
    {
      List localList = ((batb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(this.jdField_a_of_type_JavaLangString);
      if (localList != null)
      {
        this.c = 0;
        e();
        this.jdField_a_of_type_Basv.a(localList);
        this.jdField_a_of_type_Basv.notifyDataSetChanged();
      }
    }
  }
  ...
  {
    paramAdapterView = ((basy)paramView.getTag()).jdField_a_of_type_Bata;
    if (paramAdapterView == null) {}
    for (;;)
    {
      return;
      if (paramAdapterView.jdField_a_of_type_Int == 2) {
        bbbb.a("Grp_idol", "Grp_renshu", "clk", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString });
      }
      while (!((balw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203)).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, Long.valueOf(paramAdapterView.jdField_a_of_type_JavaLangString).longValue()))
      {
        auvw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, paramAdapterView.jdField_a_of_type_JavaLangString, 0, -1);
        return;
        new axra(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("online_box").d("clk_mberHead").a(new String[] { this.jdField_a_of_type_JavaLangString, paramAdapterView.b }).a();
      }
    }
  }
  ...
  {
    paramAdapterView = (basy)paramView.getTag();
    paramView = paramAdapterView.jdField_a_of_type_Bata;
    ...
    new axra(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("online_box").d("press_mberHead").a(new String[] { this.jdField_a_of_type_JavaLangString, paramView.b }).a();
    return true;
  }
}
