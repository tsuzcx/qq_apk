...
public class mqa
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    Bitmap localBitmap = bfpx.a(paramString, localOptions);
    if (localBitmap == null) {
  ...
  public static mpe a(VideoAppInterface paramVideoAppInterface)
  {
    return (mpe)paramVideoAppInterface.a(7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramBundle = new aucf((String)localObject, paramQQAppInterface.getCurrentAccountUin(), paramBundle, i, -5040, 65560, 0L);
  ...
  public static boolean a()
  {
    ...
    if ((!lou.a(4, 1800000L)) && (!lou.a(8, 1400000L))) {}
    for (;;)
    {
  ...
  {
    boolean bool = mum.a(paramVideoAppInterface).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
