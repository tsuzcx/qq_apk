  ...
  implements View.OnClickListener
{
  ...
  {
    ProgressDialog localProgressDialog = bbcv.a(this.a, this.a.getResources().getDrawable(2130848549), 2131692193);
    localProgressDialog.setOnDismissListener(new abot(this));
    arzw.a(this.a.app.getAccount());
    ...
    for (paramView = paramView.getSkey((String)localObject);; paramView = "")
    {
      ...
      arzw.a(this.a.app.getHttpCommunicatort(), this.a.app.getApp(), localProgressDialog, (String)localObject, paramView);
      return;
    }
  }
}
