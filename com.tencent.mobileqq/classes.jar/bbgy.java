  ...
  extends bbkk
{
  ...
  public bbgy(Drawable paramDrawable1, Drawable paramDrawable2)
  {
    super(null, 0);
  ...
  public void a(bbgz parambbgz)
  {
    this.jdField_a_of_type_Bbgz = parambbgz;
  }
  ...
  public boolean a(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      if ((i == 1) && (this.jdField_a_of_type_Bbgz != null)) {
        this.jdField_a_of_type_Bbgz.a(this);
      }
      paramView.invalidate();
      return true;
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setState(StateSet.WILD_CARD);
