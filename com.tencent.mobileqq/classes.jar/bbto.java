  ...
  extends ypv
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    {
      bbrc.b("TroopFileUploadWorker", bbrc.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult.but stoped");
      return;
    }
    if ((paramResendRspBody == null) || (!paramBoolean))
    {
      bbrc.a("TroopFileUploadWorker", bbrc.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult isSuccess:false  errCode:" + paramInt);
      paramResendRspBody = new bcii(this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, this.a.d, 3, 207);
      this.a.jdField_a_of_type_Bbqo.c = 1;
      this.a.jdField_a_of_type_Bbqo.d = paramInt;
      this.a.a(true, bclj.b, bclj.A, paramResendRspBody);
      return;
    }
    int i = paramResendRspBody.int32_ret_code.get();
    bbrc.c("TroopFileUploadWorker", bbrc.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult isSuccess:true  errCode:" + paramInt + " retCode:" + i);
    if (i < 0)
    {
      ...
      for (;;)
      {
        ...
        bbqm.b(this.a.d, this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, paramInt);
        this.a.a(false, bclj.c, i);
        return;
        paramInt = 101;
        continue;
        paramInt = 102;
      ...
      this.a.a(true, bclj.c, i, paramInt);
      return;
    }
