  ...
  implements Cursor
{
  ...
  protected abwu(abwx paramabwx, List<MessageRecord> paramList)
  {
  ...
  private Object a(int paramInt)
  {
    ...
    case 14: 
      return ContactUtils.getDisplayName(this.jdField_a_of_type_Abwx.a(), localMessageRecord.senderuin, localMessageRecord.frienduin, 1, 0);
    case 15: 
      if (localMessageRecord.istroop == 3000) {
        return ContactUtils.getDiscussionNameDefaultUin(this.jdField_a_of_type_Abwx.a(), localMessageRecord.senderuin);
      }
      if (localMessageRecord.istroop == 1) {
        return ((TroopManager)this.jdField_a_of_type_Abwx.a().getManager(52)).a(localMessageRecord.senderuin);
      }
      return ContactUtils.getFriendNick(this.jdField_a_of_type_Abwx.a(), localMessageRecord.senderuin);
    case 16: 
      return Integer.valueOf(((amsw)this.jdField_a_of_type_Abwx.a().getManager(51)).b(localMessageRecord.frienduin));
    case 17: 
