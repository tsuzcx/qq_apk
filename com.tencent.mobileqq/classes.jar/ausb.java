...
public class ausb
{
  ...
  public static Pair<aurs, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((aurs)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((aurs)localObject4).a;
        }
      }
      localObject3 = paramString;
  ...
  {
    if (bbbm.a()) {
      return ajsd.aW + "pddata/prd/" + "res_precover";
    }
