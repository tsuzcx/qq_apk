  ...
  implements bgdv
{
  ...
  public anjo(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Anjp = new anjp(this);
  }
  ...
  public static bgdy a(UpgradeInfo paramUpgradeInfo)
  {
  ...
  private void a(EntityManager paramEntityManager, GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    {
      return;
      localAppShareID = bgkh.a(paramGetResourceRespInfo);
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          bgmg.d(new File(this.app.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          bgmg.d(agbb.b);
          bgmg.d(agbb.c);
          bool1 = false;
          agbb.a().a(this.app.getApplication());
  ...
  private void b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          bcst.b((QQAppInterface)localObject2, "CliOper", "", "", "0X8004DA5", "0X8004DA5", 0, 0, (String)localObject1, "", bgdt.a(), "");
          ...
          ((Intent)localObject1).putExtra("StrTitle", anni.a(2131701230));
          ((Intent)localObject1).putExtra("StrUpgradeDesc", anni.a(2131701233));
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localalzt = (alzt)this.app.getManager(114);
    ...
    this.app.a(new ConfigHandler.3(this, paramGetResourceRespInfo, localalzt, l1));
  }
  ...
  private void c(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    {
      biwe.a().a(BaseActivity.sTopActivity, "biz_src_yyb");
  ...
  {
    atha.jdField_a_of_type_Boolean = true;
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   183: aload_0
    //   184: aload 12
    //   186: invokespecial 656	anjo:a	(Landroid/content/Intent;)V
    //   189: aload_0
    //   190: bipush 11
    //   192: iload 8
    //   194: iload 6
    //   196: invokestatic 301	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: invokevirtual 349	anjo:notifyUI	(IZLjava/lang/Object;)V
    //   202: return
    //   203: iconst_0
    //   204: istore 8
    //   206: goto -180 -> 26
    ...
    //   433: invokestatic 929	bkds:a	(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Z
    //   436: istore 6
    ...
    //   721: invokestatic 970	bkds:a	(Landroid/content/Context;)Z
    //   724: pop
    //   725: iload 5
    //   727: istore 6
    //   729: goto -684 -> 45
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        bgdt.a().a(bool1, str2, paramToServiceMsg);
        return;
        i = 0;
        break;
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      localbbck = (bbck)this.app.getManager(15);
    } while (localbbck == null);
    if (!localbbck.a(paramGetResourceRespInfo.uiNewVer))
    {
      notifyUI(7, true, Integer.valueOf(100));
      return;
    }
    ...
    this.app.a(new ConfigHandler.6(this, str, localbbck, paramGetResourceRespInfo));
  }
      ...
      while (QLog.isColorLevel())
      {
        ...
        if (i == 10)
        {
          ...
          for (paramObject = paramObject.string_tips_action_url.get();; paramObject = "")
          {
            ...
            paramObject = (askk)this.app.getManager(292);
            paramObject.a(bool1);
  ...
  public int a(ArrayList<GetResourceReqInfo> paramArrayList, GetResourceReqInfo... paramVarArgs)
  {
    ...
    i = bbxe.jdField_a_of_type_Int;
    bbxe.jdField_a_of_type_Int = i + 1;
  ...
  public void a(int paramInt, UpgradeDetailWrapper paramUpgradeDetailWrapper, bgdt parambgdt)
  {
    parambgdt = paramUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo;
    if ((paramInt == 0) && (parambgdt != null))
    {
      BaseApplicationImpl.sApplication.getPackageName();
      a(parambgdt);
      a(this.app, parambgdt.strNewTipsDescURL, parambgdt.iTipsWaitDay);
      b(this.app, parambgdt.strBannerPicUrl, parambgdt.iDisplayDay);
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   68: invokestatic 661	bgdt:a	()Lbgdt;
    //   71: astore_3
    //   72: aload_3
    //   73: invokevirtual 1269	bgdt:a	()Lcom/tencent/mobileqq/upgrade/UpgradeDetailWrapper;
    //   76: astore_1
    //   77: aload_2
    //   78: ifnull +335 -> 413
    //   81: aload_2
    ...
    //   297: istore 6
    //   299: aload_0
    //   300: getfield 205	anjo:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   303: iload 6
    //   305: invokestatic 1297	anjo:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Z)V
    ...
    //   364: aload_0
    //   365: getfield 205	anjo:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   368: iconst_4
    //   369: invokevirtual 1304	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lanii;
    //   372: checkcast 2	anjo
    //   375: astore_2
    //   376: aload_3
    //   377: aload_1
    ...
    //   381: aload_2
    //   382: invokevirtual 1307	bgdt:a	(Lprotocol/KQQConfig/UpgradeInfo;Lbgdv;)Z
    //   385: pop
    //   386: aload_1
    //   387: monitorexit
    //   388: return
    ...
    //   425: invokestatic 661	bgdt:a	()Lbgdt;
    //   428: invokevirtual 1308	bgdt:b	()V
    //   431: goto +57 -> 488
    //   434: aload_1
  ...
  public void a(ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    if (paramObject == null) {
      if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
        ((anjh)this.app.getManager(59)).a(null);
      }
    }
    do
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramObject.sResType == 2)
        {
          ...
          {
            localObject = (anjh)this.app.getManager(59);
            if (localObject != null) {
              ((anjh)localObject).a(paramObject);
            }
          }
        ...
        {
          localObject = (arno)this.app.getManager(77);
          if (localObject != null) {
            ((arno)localObject).a(paramObject);
          }
        }
      }
    }
  ...
  public void a(String paramString, int paramInt, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    Object localObject2 = arcd.a(this.app);
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      QQOperationViopTipTask localQQOperationViopTipTask = ((arcd)localObject2).a(((QQOperationViopTipTask)paramArrayList.next()).taskid);
      ...
      ((arcd)localObject2).a(this.app, localQQOperationVoipTipsTaskExcuteRecord);
    }
    notifyUI(8, true, localObject1);
  }
  
  public void a(String paramString, int paramInt, ArrayList<arcg> paramArrayList, boolean paramBoolean)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
      ...
      try
      {
        ...
        if (paramInt == 3000)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            if (paramArrayList.hasNext())
            {
              arcg localarcg = (arcg)paramArrayList.next();
              MobileTips.TaskInfo localTaskInfo = new MobileTips.TaskInfo();
              localTaskInfo.task_id.set(localarcg.jdField_a_of_type_Int);
              localTaskInfo.msgcnt.set(localarcg.jdField_b_of_type_Int);
              localTaskInfo.keywords.set(localarcg.jdField_a_of_type_JavaUtilArrayList);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (short s = 1;; s = 2)
    {
      ((ByteBuffer)localObject).putInt(bgjw.a(l)).put((byte)0).putShort((short)1).putShort((short)-23463).putShort((short)2).putShort(s);
  ...
  public boolean a()
  {
    boolean bool = bkds.b(BaseApplicationImpl.sApplication);
    if (QLog.isDevelopLevel()) {
    ...
    try
    {
      localObject2 = bkdn.a(new File(BaseApplicationImpl.sApplication.getPackageResourcePath()));
    ...
    ((ToServiceMsg)localObject2).extraData.putInt("mv", ardl.a(this.app.getApp()));
    ((ToServiceMsg)localObject2).extraData.putInt("sv", bgln.a());
  ...
  public boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    localToServiceMsg.extraData.putInt("mv", ardl.a(this.app.getApp()));
    localToServiceMsg.extraData.putInt("sv", bgln.a());
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()) && (paramToServiceMsg.uint32_result.get() == 0) && (paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
    {
      ...
      paramToServiceMsg = String.valueOf(bgva.a(paramToServiceMsg, 0));
  ...
  {
    Object localObject = (bbck)this.app.getManager(15);
    if (localObject == null) {
      return null;
    }
    long l = ((bbck)localObject).a();
  ...
  {
    anjh localanjh = (anjh)this.app.getManager(59);
    if (localanjh == null) {
      return null;
    }
    GetResourceReqInfo localGetResourceReqInfo = new GetResourceReqInfo();
    ...
    localGetResourceReqInfo.uiCurVer = localanjh.a(true);
    localGetResourceReqInfo.sResType = 2;
    localGetResourceReqInfo.sLanType = 0;
    localGetResourceReqInfo.sReqType = 1;
    return localGetResourceReqInfo;
  ...
  public void e()
  {
    ...
    try
    {
      ...
      ((ByteBuffer)localObject).putInt(bgjw.a(Long.parseLong(this.app.getAccount()))).putShort((short)16);
  ...
  public void f()
  {
    ...
    do
    {
      ...
      {
        return;
        if (asfr.a().a(this.app, BaseApplicationImpl.getApplication()) != 0) {
          break;
        }
      } while (!QLog.isColorLevel());
