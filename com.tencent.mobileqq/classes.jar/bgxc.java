...
public abstract class bgxc
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler A = new bgxt();
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new bgxd();
    b = new bgxo();
    c = new bgxu();
    d = new bgxv();
    e = new bgxw();
