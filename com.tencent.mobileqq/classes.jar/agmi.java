  ...
  implements View.OnClickListener
{
  ...
  agmi(agmf paramagmf, boolean paramBoolean, int paramInt1, agmj paramagmj, String paramString, int paramInt2, MessageForQzoneFeed paramMessageForQzoneFeed) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Agmj.i.setText(agmf.a(this.jdField_a_of_type_Int));
      localObject1 = this.jdField_a_of_type_Agmj.d;
      if (!this.jdField_a_of_type_Boolean) {
        break label363;
      }
      i = 2130847439;
      ((ImageView)localObject1).setImageResource(i);
      long l = this.jdField_a_of_type_Agmf.a.getLongAccountUin();
      ...
      localObject2 = new QzoneCommonIntent(this.jdField_a_of_type_Agmf.a.getApplication(), aqru.class);
      ...
      this.jdField_a_of_type_Agmf.a.startServlet((NewIntent)localObject2);
    ...
    for (Object localObject1 = "1";; localObject1 = "0")
    {
      ...
      this.jdField_a_of_type_Agmf.a.getMessageFacade().removeMsgByMessageRecord(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed, false);
      this.jdField_a_of_type_Agmf.a.getMessageFacade().addMessage(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.selfuin);
