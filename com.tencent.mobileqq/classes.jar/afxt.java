...
class afxt
  implements akse
{
  afxt(afxs paramafxs, CustomizeStrategyFactory.RedPacketInfo paramRedPacketInfo) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      BitmapFactory.Options localOptions = bgmo.a(str1, paramInt);
    ...
    if (paramInt < j)
    {
      ...
      localObject2 = SafeBitmapFactory.decodeFile((String)localObject2, bgmo.a((String)localObject2, i));
