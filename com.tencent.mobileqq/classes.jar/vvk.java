  ...
  implements Manager
{
  ...
  private ArrayList<vvj> jdField_a_of_type_JavaUtilArrayList;
  private ArrayList<vvm> b;
  
  public vvk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 1)) {
      Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new vvl(this));
    }
  }
  ...
  public int a()
  {
    ...
    return ((vvj)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_b_of_type_Int;
  }
  ...
  public String a()
  {
    ...
    Object localObject = (amcb)alzw.a().a(528);
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (((amcb)localObject).a == 1)) {}
    for (boolean bool = SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, "qqsetting_qrlogin_set_mute", false);; bool = false)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.size() == 1)
      {
        localObject = (vvj)this.jdField_a_of_type_JavaUtilArrayList.get(0);
        localStringBuilder.append(((vvj)localObject).jdField_a_of_type_JavaLangString).append(" ").append(((vvj)localObject).jdField_b_of_type_JavaLangString).append(" ").append(ajjy.a(2131628383));
        if (bool) {
          localStringBuilder.append("，").append(ajjy.a(2131629371));
        }
      }
      for (;;)
      {
        return localStringBuilder.toString();
        localStringBuilder.append(ajjy.a(2131633342));
        localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (((Iterator)localObject).hasNext()) {
          localStringBuilder.append(((vvj)((Iterator)localObject).next()).jdField_a_of_type_JavaLangString).append("、");
        }
        if (bool)
        {
          localStringBuilder.replace(localStringBuilder.length() - 1, localStringBuilder.length(), "，");
          localStringBuilder.append(ajjy.a(2131629371));
        }
        else
        {
          localStringBuilder.replace(localStringBuilder.length() - 1, localStringBuilder.length(), "。");
  ...
  public String a(Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        localStringBuilder.append(((vvj)localIterator.next()).jdField_a_of_type_JavaLangString).append("、");
      }
      localStringBuilder.deleteCharAt(localStringBuilder.lastIndexOf("、"));
    }
    return paramContext.getString(2131651402, new Object[] { localStringBuilder.toString() });
  }
  ...
  public void a(vvm paramvvm)
  {
    try
    {
      ...
      if (!this.b.contains(paramvvm)) {
        this.b.add(paramvvm);
      }
      if (paramvvm != null) {
        paramvvm.a(this.jdField_a_of_type_JavaUtilArrayList);
      }
      return;
    }
    finally {}
  ...
  public boolean a(SvcRespParam paramSvcRespParam)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localOnlineInfos.onlineStatus != 0)
      {
        ...
        if (vvn.a(j))
        {
          vvj localvvj = new vvj(j);
          localvvj.jdField_a_of_type_Long = localOnlineInfos.instanceId;
          this.jdField_a_of_type_JavaUtilArrayList.add(localvvj);
          if (QLog.isDevelopLevel()) {
            QLog.d("LoginDevicesManager", 4, localvvj.toString());
          }
        }
        if ((j != 66818) && (j != 66831)) {
          break label326;
    ...
    for (;;)
    {
      ...
      {
        paramSvcRespParam = new vvj(paramSvcRespParam.iPCClientType);
      ...
      if (this.b != null)
      {
        ...
        while (paramSvcRespParam.hasNext()) {
          ((vvm)paramSvcRespParam.next()).a(this.jdField_a_of_type_JavaUtilArrayList);
        }
      }
  ...
  public boolean a(ArrayList<InstanceInfo> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (vvn.a(i))
      {
        vvj localvvj = new vvj(i);
        localvvj.jdField_a_of_type_Long = localInstanceInfo.iAppId;
        this.jdField_a_of_type_JavaUtilArrayList.add(localvvj);
        if (QLog.isDevelopLevel()) {
          QLog.d("LoginDevicesManager", 4, localvvj.toString());
        }
    ...
    if (this.b != null)
    {
      ...
      while (paramArrayList.hasNext()) {
        ((vvm)paramArrayList.next()).a(this.jdField_a_of_type_JavaUtilArrayList);
      }
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0) {}
  ...
  public void b(vvm paramvvm)
  {
    try
    {
      if (this.b != null) {
        this.b.remove(paramvvm);
      }
      return;
    }
    finally
