  ...
  extends ajtd
{
  ...
  public void a(String paramString1, long paramLong, String paramString2, ndl paramndl)
  {
    this.jdField_a_of_type_Ndl = null;
    ...
    paramndl = new ilive_get_record_info_svr.GetRoomStateReq();
    paramndl.source.set(paramString1);
    paramndl.roomid.set((int)paramLong);
    ...
    paramString1.busi_buf.set(ByteStringMicro.copyFrom(((ilive_get_record_info_svr.GetRoomStateReq)paramndl.get()).toByteArray()));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (this.jdField_a_of_type_Ndl != null) {
      this.jdField_a_of_type_Ndl.a(paramBoolean, paramString2, paramString1, paramLong, paramString3);
    }
  }
