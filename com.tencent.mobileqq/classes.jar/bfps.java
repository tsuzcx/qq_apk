  ...
  implements bfoj
{
  ...
  public static bfps a()
  {
    if (jdField_a_of_type_Bfps == null) {
      jdField_a_of_type_Bfps = new bfps();
    }
    return jdField_a_of_type_Bfps;
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bflp.c("WebViewDownloadListener", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  protected void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        int j = localbfmv.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bfmu)localbfmv.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bfmu)localObject).getJsCallbackMethod()))
            {
              ...
              bflp.a("WebViewDownloadListener", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bflp.c("WebViewDownloadListener", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
