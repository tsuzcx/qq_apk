...
public class bfps
{
  ...
  public bfps(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
  ...
  {
    return new File(AppConstants.SDCARD_PATH + "homework_troop");
  }
  ...
  private void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = bfpu.a(paramString, "config.cfg");
        if (!paramBoolean) {
          break label162;
        }
        switch (paramInt)
  ...
  private boolean b(Handler paramHandler, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((ArrayList)localObject).addAll(nwp.a(localFile2));
      ...
      nwp.b(localFile2.getAbsolutePath(), localFile1.getAbsolutePath());
  ...
  public boolean a(Handler paramHandler, int paramInt, boolean paramBoolean)
  {
    ...
    localHttpNetReq.mCallback = new bfpt(this, paramHandler, paramInt, paramBoolean);
