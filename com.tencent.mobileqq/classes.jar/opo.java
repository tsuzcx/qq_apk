  ...
  implements View.OnClickListener
{
  ...
  public opo(Context paramContext, ArrayList<ChannelCoverInfo> paramArrayList, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localObject1 = new opp(this);
      paramView = new ReadInJoyVideoTopicTextView(this.jdField_a_of_type_AndroidContentContext);
      paramView.setId(2131375924);
      paramView.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
      ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView = paramView;
      ...
      if (localObject2 != null)
      {
        ...
        ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTopicText(((ChannelCoverInfo)localObject2).mChannelCoverName);
        label192:
        if (this.jdField_a_of_type_Int != 56) {
          break label454;
        }
        ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTextColor(7566195);
        label211:
        if (TextUtils.isEmpty(((ChannelCoverInfo)localObject2).mIconUrl)) {
          break label470;
        }
        int i = ViewUtils.dip2px(21.0F);
        Object localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840441);
        ...
        ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setCompoundDrawables((Drawable)localObject3, null, null, null);
        label304:
        if (!((ChannelCoverInfo)localObject2).isReport)
        {
          ...
          opq.a("0X8007BE5", "1", "", "", (ChannelCoverInfo)localObject2, i);
        }
      }
    }
    for (;;)
    {
      opq.a("0X8007F01", (ChannelCoverInfo)localObject2, opq.b);
      ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setOnClickListener(this);
      ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo = ((ChannelCoverInfo)localObject2);
      localObject1 = paramView;
      localObject2 = paramView;
      break;
      localObject1 = (opp)paramView.getTag();
      break label152;
      label438:
      ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setSubChannelText(((ChannelCoverInfo)localObject2).mChannelCoverName);
      break label192;
      label454:
      ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTextColor(((ChannelCoverInfo)localObject2).mFontColor);
      break label211;
      label470:
      ((opp)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setCompoundDrawables(null, null, null, null);
      break label304;
      label485:
      if (pay.a(this.jdField_a_of_type_Int)) {
        ozb.a(this.jdField_a_of_type_AndroidContentContext, "0X8009A70", this.jdField_a_of_type_Int, ((ChannelCoverInfo)localObject2).mChannelCoverId);
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      localChannelCoverInfo = ((opp)paramView.getTag()).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo;
    ...
    if (TextUtils.isEmpty(localChannelCoverInfo.mChannelJumpUrl))
    {
      ...
      if (this.jdField_a_of_type_Int == 56)
      {
        okj.b(this.jdField_a_of_type_AndroidContentContext, localChannelCoverInfo.mChannelCoverId, localChannelCoverInfo.mChannelCoverName, localChannelCoverInfo.mChannelType, 4, (Map)localObject);
        label155:
        if (QLog.isColorLevel()) {
    ...
    {
      if (pay.a(this.jdField_a_of_type_Int)) {
        ozb.a(this.jdField_a_of_type_AndroidContentContext, "0X8009A71", this.jdField_a_of_type_Int, localChannelCoverInfo.mChannelCoverId);
      }
      opq.a("0X8007F02", localChannelCoverInfo, opq.b);
      break;
      okj.a(this.jdField_a_of_type_AndroidContentContext, localChannelCoverInfo.mChannelCoverId, localChannelCoverInfo.mChannelCoverName, localChannelCoverInfo.mChannelType, 4, (Map)localObject);
      break label155;
      if (tgc.b(localChannelCoverInfo.mChannelJumpUrl)) {
        tgc.a(this.jdField_a_of_type_AndroidContentContext, "", tgc.b(localChannelCoverInfo.mChannelJumpUrl), null);
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
