  ...
  implements bhlf
{
  ...
  private String a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      return bhsc.a(paramString, 200, 200, true);
    }
    return "";
  }
  ...
  private void a(String paramString, Bundle paramBundle, bhte parambhte)
  {
    Bundle localBundle;
    if ((paramBundle != null) && (parambhte != null))
    {
    ...
    try
    {
      parambhte.a(paramBundle, localBundle);
      if (paramString != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(paramString, new String[] { paramBundle.toString() });
      }
      return;
    }
    catch (Throwable parambhte)
    {
      for (;;)
      {
        QLog.e("QzoneRecommedPhotoJsPlugin", 1, "onCallJsBridge.setData error", parambhte);
      }
    }
  }
  ...
  private void a(String paramString1, String paramString2, Runnable paramRunnable, boolean paramBoolean)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bhtm.class).post(paramRunnable);
      return;
    }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bhtm.class).post(new QzoneRecommedPhotoJsPlugin.2(this));
      }
      return;
    }
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      bgyp.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bgyw.a(), localIntent, 0);
      return;
    }
    catch (Exception paramString)
    {
