...
public class msm
{
  ...
  {
    Object localObject2 = ((awmz)paramQQAppInterface.getManager(11)).b(paramString);
    Object localObject1 = null;
    if (localObject2 != null) {
      localObject1 = bglf.b(((PhoneContact)localObject2).name);
    }
    localObject2 = localObject1;
    if (localObject1 == null) {
      localObject2 = bglf.b(paramString);
    }
    paramString = new bghx(paramQQAppInterface.getApp(), (String)localObject2);
  ...
  public static List<AVPhoneUserInfo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    localObject1 = (ankw)paramQQAppInterface.getManager(53);
    if (localObject1 == null) {
      return null;
    }
    paramString = ((ankw)localObject1).a(paramString);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        paramQQAppInterface = ((awmz)localObject1).b(paramQQAppInterface);
        if (paramQQAppInterface == null) {
          break label266;
        }
      }
  ...
  public static List<Bitmap> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    Map localMap = ((ankw)localObject).a(paramString);
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      for (;;)
      {
        paramInt1 += 1;
        break;
        PhoneContact localPhoneContact = localawmz.b(str);
        paramString = null;
