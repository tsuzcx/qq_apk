...
public class msm
{
  ...
  {
    Object localObject2 = ((askn)paramQQAppInterface.getManager(11)).b(paramString);
    Object localObject1 = null;
    if (localObject2 != null) {
      localObject1 = bbcz.b(((PhoneContact)localObject2).name);
    }
    localObject2 = localObject1;
    if (localObject1 == null) {
      localObject2 = bbcz.b(paramString);
    }
    paramString = new bbab(paramQQAppInterface.getApp(), (String)localObject2);
  ...
  public static List<AVPhoneUserInfo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    localObject1 = (ajvi)paramQQAppInterface.getManager(53);
    if (localObject1 == null) {
      return null;
    }
    paramString = ((ajvi)localObject1).a(paramString);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        paramQQAppInterface = ((askn)localObject1).b(paramQQAppInterface);
        if (paramQQAppInterface == null) {
          break label266;
        }
      }
  ...
  public static List<Bitmap> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    Map localMap = ((ajvi)localObject).a(paramString);
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      for (;;)
      {
        paramInt1 += 1;
        break;
        PhoneContact localPhoneContact = localaskn.b(str);
        paramString = null;
