  ...
  extends nmo
{
  ...
  static
  {
    ...
    int[] arrayOfInt3 = { 3, 3, 3 };
    int[] arrayOfInt4 = { 3, 3, 3, 2 };
    jdField_a_of_type_Array2dOfInt = new int[][] { { 1 }, { 1, 1 }, { 1, 2 }, { 2, 2 }, { 2, 2, 1 }, arrayOfInt1, { 2, 2, 3 }, arrayOfInt2, arrayOfInt3, { 3, 3, 2, 2 }, arrayOfInt4, { 3, 3, 3, 3 }, { 3, 3, 3, 4 }, { 3, 3, 4, 4 }, { 3, 4, 4, 4 }, { 4, 4, 4, 4 } };
  ...
  public nmn(Context paramContext, AVGameAppInterface paramAVGameAppInterface)
  {
  ...
  {
    paramArrayOfnmr2 = new ArrayList(8);
    int j = paramArrayOfnmr1.length;
    int i = 0;
    while (i < j)
    {
      paramList = paramArrayOfnmr1[i];
      if (paramList.a()) {
        paramArrayOfnmr2.add(paramList);
      }
      i += 1;
    }
    if (paramArrayOfnmr2.isEmpty()) {
      return;
    }
    i = paramArrayOfnmr2.size();
    i = Math.min(i, i);
    ...
    for (;;)
    {
      paramArrayOfnmr1 = a(i, paramInt1, paramInt2);
      paramInt1 = 0;
      for (;;)
      {
        if (paramInt1 >= i) {
        ...
        paramList = (Rect)paramArrayOfnmr1.get(paramInt1);
        if (paramList == null) {
          break;
        }
        ((nmr)paramArrayOfnmr2.get(paramInt1)).b(paramList.left, paramList.top, paramList.right, paramList.bottom);
        ((nmr)paramArrayOfnmr2.get(paramInt1)).a(0, 0, 0, 0);
        paramInt1 += 1;
      }
      label176:
      break;
