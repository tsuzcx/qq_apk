...
public class zdc
  implements Runnable
{
  public zdc(ApolloGameShare paramApolloGameShare, int paramInt) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (new File(((StringBuilder)localObject).toString()).exists()) {
        ...
        localObject = BitmapManager.b(BaseApplicationImpl.getApplication().getResources(), 2130838160);
      }
    }
    ...
    while (localBitmap != null)
    {
      ...
      WXShareHelper.a().a(new zdd(this));
