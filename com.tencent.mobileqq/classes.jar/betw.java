...
public class betw
  extends betp
  implements atqt, bete, IVideoOuterStatusListener
{
  private IVideoInnerStatusListener a;
  private ImageView b;
  
  betw(Context paramContext)
  {
    super(paramContext);
  ...
  public void a(Context paramContext)
  {
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373604));
    this.b.setContentDescription(alpo.a(2131705015));
    a(new View[] { this.b });
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(2, new betx(this));
    }
  }
