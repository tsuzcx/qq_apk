  ...
  implements Handler.Callback, bgmm
{
  ...
  private volatile WeakReference<bgif> jdField_b_of_type_MqqUtilWeakReference;
  ...
  public void a(Setting paramSetting)
  {
    ...
    for (;;)
    {
      ...
      paramSetting = "";
      break;
      localObject = bghy.b(paramSetting.uin);
      ...
      if (HttpDownloadUtil.a(a(), new arul(MsfSdkUtils.insertMtype("friendlist", paramSetting), localFile2, 0), this) == 0) {
        bool1 = true;
      }
      boolean bool2;
      if (bool1)
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (paramMessage = (Drawable)paramMessage.obj;; paramMessage = null)
    {
      ...
      {
        localbgif = (bgif)this.jdField_b_of_type_MqqUtilWeakReference.get();
        if (localbgif != null)
        {
      ...
      {
        localbgif.a(str, bool, paramMessage);
