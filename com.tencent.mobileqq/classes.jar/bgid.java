...
public class bgid
  extends bghq
{
  public bgid(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  {
    paramObject = bfpe.a(paramInt1, paramLong1, paramInt2);
    String str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131697921);
    paramList = "";
    boolean bool2 = false;
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      return new bghs(true, str1, paramObject, paramList);
    }
    return null;
  }
  ...
  {
    paramTextView1.setText(anzj.a(2131713945));
    paramTextView2.setText(anzj.a(2131713956));
  ...
  public void a(int paramInt1, bfpe parambfpe, String paramString, int paramInt2, TextView paramTextView1, TextView paramTextView2, long paramLong)
  {
    ...
    if (paramString != null) {
      paramTextView1.setText(anzj.a(2131713950));
    }
    ...
    parambfpe.a = false;
    paramTextView2.setText(anzj.a(2131713948));
  }
