...
public class wij
{
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    bcql.a(localBaseApplication, paramInt1, paramInt2, 1).b(localBaseApplication.getResources().getDimensionPixelSize(2131298865));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3, wfi paramwfi)
  {
    paramString1 = wfg.a(paramInt, paramString1);
    ...
    paramString2 = new wik(paramwfi);
    paramContext = new NewIntent(paramContext, wfj.class);
