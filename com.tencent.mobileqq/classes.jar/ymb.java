  ...
  extends ylx
{
  ...
  private void a(DecodeConfig paramDecodeConfig, bafx parambafx, int paramInt)
  {
    if (paramInt != 0)
    {
      parambafx.h = paramInt;
      parambafx.g = 0;
    }
    paramInt = Math.min(parambafx.jdField_a_of_type_Int, parambafx.b);
    int i = Math.max(parambafx.jdField_a_of_type_Int, parambafx.b);
    parambafx.jdField_a_of_type_Int = paramInt;
    parambafx.b = i;
    paramDecodeConfig.width = parambafx.jdField_a_of_type_Int;
    paramDecodeConfig.height = parambafx.b;
  }
  
  private boolean a(ylu paramylu)
  {
    if (paramylu.jdField_b_of_type_Boolean) {}
    while (!paramylu.c) {
      return false;
    }
    return true;
  ...
  public void a(ylu paramylu)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoToVideo", 2, "[runLocalVideo2Video]run begin, taskid:" + paramylu.jdField_b_of_type_Long + " run:" + paramylu.d);
    }
    if (a(paramylu))
    {
      xwa.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramylu.jdField_a_of_type_JavaLangString, null, null, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramylu);
      return;
    }
    ...
    localObject1 = null;
    Object localObject2 = new File(paramylu.jdField_a_of_type_JavaLangString);
    ...
    ypi.g(this.jdField_a_of_type_JavaLangString);
    localObject1 = this.jdField_a_of_type_JavaLangString + ".dat";
    if (ypi.e((String)localObject1))
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "before,getPCMFromFile[Have audio File]:  " + paramylu.jdField_b_of_type_Long + " audioPath: " + (String)localObject1 + " audioFileSize=" + FileUtil.getFileSize((String)localObject1));
      }
      localObject2 = new ypf();
      l1 = System.currentTimeMillis();
      ((ypf)localObject2).a(paramylu.jdField_a_of_type_JavaLangString, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getMetaDataFromFile:  " + paramylu.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " mSampleRate: " + paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      localLocalMediaInfo.path = paramylu.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo.mDuration = paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long;
      l1 = System.currentTimeMillis();
      bool = ((ypf)localObject2).a(localLocalMediaInfo, 0, (int)paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long, (String)localObject1, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getPCMFromFile:  " + paramylu.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean);
      }
      if (paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean)
      {
        if ((!bool) || (!ypi.e((String)localObject1)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run,getPCMFromFile: failed " + paramylu.jdField_b_of_type_Long + " path=" + (String)localObject1 + " success=" + bool);
          }
          ypi.g((String)localObject1);
          xwa.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramylu.jdField_a_of_type_JavaLangString, null, null, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramylu);
        }
      }
      else
      {
        ypi.g((String)localObject1);
        ypf.a((String)localObject1, (int)paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long);
        if (!ypi.e((String)localObject1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run[video convert],createSilentPCMFile: failed " + paramylu.jdField_b_of_type_Long + " path=" + (String)localObject1);
          }
          xwa.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramylu.jdField_a_of_type_JavaLangString, null, null, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramylu);
          return;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "After,getPCMFromFile: hasAudioTrack= " + paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " path=" + (String)localObject1 + " success=" + bool + " audioFileSize=" + FileUtil.getFileSize((String)localObject1));
      }
    }
    paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    if (a(paramylu))
    {
      xwa.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramylu.jdField_a_of_type_JavaLangString, null, null, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramylu);
    ...
    boolean bool = a(paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramylu);
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, taskid:" + paramylu.jdField_b_of_type_Long + " run:" + paramylu.d + " cost:" + (l2 - l1) + " ms successVideo:" + bool);
      }
      if (!paramylu.d) {
        break;
      }
      a(this.jdField_a_of_type_Int, paramylu.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, null, paramylu.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramylu);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, [failed]file not exist:" + paramylu.jdField_b_of_type_Long + " file:" + this.jdField_a_of_type_JavaLangString);
      }
  ...
  /* Error */
  public boolean a(SlideItemInfo arg1, ylu paramylu)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +10 -> 11
    ...
    //   33: new 293	bnzy
    //   36: dup
    //   37: invokespecial 294	bnzy:<init>	()V
    //   40: putfield 296	ymb:jdField_a_of_type_Bnzy	Lbnzy;
    ...
    //   165: invokevirtual 327	ymb:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 5
    //   170: new 22	bafx
    //   173: dup
    //   174: aload 13
    ...
    //   194: invokespecial 335	bafx:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 14
    //   199: aload 14
    //   201: sipush 720
    //   204: putfield 31	bafx:jdField_a_of_type_Int	I
    //   207: aload 14
    //   209: sipush 1280
    //   212: putfield 34	bafx:b	I
    //   215: aload_1
    ...
    //   292: sipush 720
    //   295: sipush 1280
    //   298: invokestatic 341	yqs:a	(IIII)Z
    //   301: ifeq +9 -> 310
    //   304: aload 14
    //   306: iconst_1
    //   307: putfield 342	bafx:c	Z
    ...
    //   340: aload 14
    //   342: iload 5
    //   344: invokespecial 347	ymb:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lbafx;I)V
    //   347: aload 15
    //   349: iconst_1
    ...
    //   372: invokevirtual 64	ymb:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   488: aload_0
    //   489: getfield 296	ymb:jdField_a_of_type_Bnzy	Lbnzy;
    //   492: aload 15
    //   494: aload 14
    //   496: new 372	ymc
    //   499: dup
    //   500: aload_0
    //   501: aload_2
    //   502: invokespecial 375	ymc:<init>	(Lymb;Lylu;)V
    //   505: aconst_null
    //   506: invokevirtual 378	bnzy:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lbafx;Lbagj;Lbnzz;)V
    //   509: aload_0
    //   510: getfield 17	ymb:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   513: astore_1
    //   514: aload_1
    //   515: monitorenter
    ...
    //   538: aload_2
    //   539: getfield 57	ylu:jdField_b_of_type_Boolean	Z
    ...
    //   564: aload_2
    //   565: getfield 385	ylu:jdField_a_of_type_Boolean	Z
    ...
    //   577: aload_2
    //   578: getfield 57	ylu:jdField_b_of_type_Boolean	Z
    //   581: ifne +84 -> 665
    //   584: aload_2
    //   585: getfield 60	ylu:c	Z
    //   588: ifne +77 -> 665
    //   591: aload_2
    //   592: getfield 385	ylu:jdField_a_of_type_Boolean	Z
    //   595: istore 6
    //   597: iload 6
    //   599: ifne +66 -> 665
    //   602: aload_0
    //   603: getfield 17	ymb:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   667: aload_0
    //   668: aload_2
    //   669: invokespecial 393	ymb:a	(Lylu;)Z
    //   672: istore 7
    //   674: iload 7
    //   676: istore 6
  ...
  public void b(ylu paramylu)
  {
    ...
    {
      paramylu.jdField_b_of_type_Boolean = true;
