...
public class ymb
{
  ...
  public ymb(String paramString, GdtMvAppBtnView paramGdtMvAppBtnView1, GdtMvAppBtnView paramGdtMvAppBtnView2, GdtMvDownloadBtnManager paramGdtMvDownloadBtnManager)
  {
    yny.a("GdtMvDownloadBtnPresenter", "GdtMvDownloadBtnPresenter: ");
  ...
  private void g(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    localBundle.putString(bcgl.l, paramGdtMvAppBtnData);
  ...
  private void h(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    yny.b("GdtMvDownloadBtnPresenter", "pauseDownloadUi " + paramGdtMvAppBtnData.packageName);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(ajjy.a(2131639409));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(ajjy.a(2131639406));
    ...
    bccu.a().a(paramGdtMvAppBtnData.apkUrlhttp);
  }
  ...
  private void j(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639410));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639398));
  ...
  public void a(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639397));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639408));
  ...
  public void a(GdtMvAppBtnData paramGdtMvAppBtnData, int paramInt)
  {
    ...
    {
      yny.d("GdtMvDownloadBtnPresenter", "updatUIByClick mGdtAppDownloadManager == null");
      return;
    }
    if (paramGdtMvAppBtnData == null)
    {
      yny.d("GdtMvDownloadBtnPresenter", "updatUIByClick cGdtMvAppBtnData == null");
      if (this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(ajjy.a(2131639407));
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setProgress(0);
        this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(ajjy.a(2131639395));
  ...
  public void b(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639396));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639404));
    paramGdtMvAppBtnData.cState = 1;
  }
  
  public void b(GdtMvAppBtnData paramGdtMvAppBtnData, int paramInt)
  {
    yny.b("GdtMvDownloadBtnPresenter", "updateBtnProgressUI " + paramInt);
    if (Looper.myLooper() != Looper.getMainLooper()) {}
    do
    {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
            this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639400));
          }
        } while (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView == null);
        this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
        this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639399));
        return;
        ...
        if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
        {
          ...
          this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(ajjy.a(2131639401));
        }
      } while (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView == null);
      this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setProgress(paramGdtMvAppBtnData.cProgerss);
      this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(ajjy.a(2131639405));
      return;
      if ((paramGdtMvAppBtnData.cProgerss == 100) && (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null))
      {
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639402));
      }
    } while ((paramGdtMvAppBtnData.cProgerss != 100) || (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView == null));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(ajjy.a(2131639403));
  }
  ...
  {
    yny.a("GdtMvDownloadBtnPresenter", "onDownloadUpdate: ");
