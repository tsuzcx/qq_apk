  ...
  implements Manager
{
  ...
  private String jdField_b_of_type_JavaLangString = ajyc.a(2131713446);
  private boolean jdField_b_of_type_Boolean;
  private String jdField_c_of_type_JavaLangString = ajyc.a(2131713447);
  private boolean jdField_c_of_type_Boolean;
  
  public apzd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_b_of_type_Boolean = bbjn.A(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
  }
  
  public static apzd a(QQAppInterface paramQQAppInterface)
  {
    return (apzd)paramQQAppInterface.getManager(286);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (aqxh)paramQQAppInterface.getManager(219);
  ...
  {
    int j = bbjn.aJ(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    if (QLog.isColorLevel()) {
      QLog.d("RichTextChatManager", 2, "last Memoried Tab:" + j);
    }
    int i;
    if (j == -1) {
      if (!bbjn.z(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin()))
      {
        i = paramArrayList.indexOf(Integer.valueOf(a(paramQQAppInterface)));
        bbjn.q(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), true);
        if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Integer paramInteger, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bbjn.aH(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = bbjn.aI(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int n = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (m != n) {
      bbjn.Y(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), n);
    }
    for (;;)
    {
      if (k != i)
      {
        paramInteger = ando.b(paramConfig, i, paramInteger.intValue());
        if (QLog.isColorLevel()) {
        ...
        bbjn.f(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), k, paramInteger);
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    bbjn.r(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), paramBoolean);
  }
