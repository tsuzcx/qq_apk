  ...
  implements arpp
{
  ...
  public arpt(short paramShort, byte paramByte)
  {
  ...
  public long a(int paramInt)
  {
    ...
    return ((arpu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Long;
  }
  ...
  public android.graphics.Bitmap a(int paramInt)
  {
    ...
    //   17: iload_1
    //   18: aload_0
    //   19: getfield 166	arpt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 166	arpt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_1
    //   44: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   47: checkcast 178	arpu
    //   50: astore 8
    //   52: aload 7
    //   54: astore 5
    //   56: aload 8
    //   58: getfield 189	arpu:jdField_a_of_type_Byte	B
    //   61: istore_2
    //   62: aload 4
    //   64: astore 5
    //   66: iload_2
    ...
    //   96: astore 5
    //   98: aload 8
    //   100: getfield 192	arpu:b	Ljava/lang/String;
    //   103: invokestatic 197	bgyo:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   106: astore 4
    //   108: aload 4
    //   110: areturn
    //   111: aload 7
    //   113: astore 5
    //   115: aload_0
    //   116: getfield 166	arpt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   119: iload_1
    //   120: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   123: checkcast 178	arpu
    //   126: getfield 200	arpu:jdField_a_of_type_ArrayOfByte	[B
    //   129: astore 9
    //   131: aload 7
    //   133: astore 5
    //   135: aload_0
    //   136: getfield 166	arpt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   139: iload_1
    //   140: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   143: checkcast 178	arpu
    //   146: getfield 203	arpu:c	Ljava/lang/String;
    //   149: astore 10
    //   151: aload 10
    //   153: ifnull +47 -> 200
    //   156: aload 7
    //   158: astore 5
    //   160: aload_0
    //   161: getfield 204	arpt:jdField_a_of_type_Byte	B
    //   164: iconst_1
    //   165: if_icmpne +35 -> 200
    //   168: aload 7
    //   170: astore 5
    //   172: aload_0
    //   173: invokevirtual 206	arpt:a	()Z
    //   176: ifne +24 -> 200
    //   179: aload 7
    //   181: astore 5
    //   183: aload_0
    //   184: invokevirtual 208	arpt:b	()Z
    //   187: ifne +13 -> 200
    //   190: aload 7
    //   192: astore 5
    //   194: aload 10
    //   196: invokestatic 197	bgyo:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   199: areturn
    //   200: aload 10
    //   202: ifnull +94 -> 296
    //   205: aload 7
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 204	arpt:jdField_a_of_type_Byte	B
    //   213: ifne +83 -> 296
    //   216: aload 7
    //   218: astore 5
    ...
    //   237: astore 5
    //   239: aload 10
    //   241: invokestatic 197	bgyo:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   244: astore 4
    //   246: aload 4
    //   248: ifnonnull +261 -> 509
    //   251: aload 8
    //   253: getfield 209	arpu:jdField_a_of_type_Boolean	Z
    //   256: ifeq +253 -> 509
    //   259: aload 8
    //   261: iconst_0
    //   262: putfield 209	arpu:jdField_a_of_type_Boolean	Z
    //   265: aload_0
    //   266: aload 8
    //   268: getfield 192	arpu:b	Ljava/lang/String;
    //   271: invokevirtual 211	arpt:b	(Ljava/lang/String;)V
    //   274: aload 4
    //   276: areturn
    //   277: aload 7
    //   279: astore 5
    //   281: aload_0
    //   282: aload 8
    //   284: getfield 192	arpu:b	Ljava/lang/String;
    //   287: invokevirtual 211	arpt:b	(Ljava/lang/String;)V
    //   290: aconst_null
    //   291: astore 4
    //   293: goto -19 -> 274
    //   296: aload 7
    ...
    //   310: astore 5
    //   312: aload_0
    //   313: getfield 204	arpt:jdField_a_of_type_Byte	B
    //   316: iconst_2
    ...
    //   347: astore 5
    //   349: aload 10
    //   351: invokestatic 197	bgyo:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   354: astore 4
    //   356: aload 4
    //   358: astore 5
    //   360: aload 4
    ...
    //   369: aload_0
    //   370: aload 8
    //   372: getfield 192	arpu:b	Ljava/lang/String;
    //   375: invokevirtual 211	arpt:b	(Ljava/lang/String;)V
    //   378: aload 4
    //   380: areturn
    //   381: astore 6
    //   383: aload 5
  ...
  public arpu a(long paramLong, String paramString1, byte paramByte, String paramString2, String paramString3, String paramString4, String paramString5, short paramShort, String paramString6)
  {
    arpu localarpu = new arpu(this);
    localarpu.jdField_a_of_type_Long = paramLong;
    localarpu.jdField_a_of_type_JavaLangString = paramString1;
    localarpu.b = paramString2;
    localarpu.d = paramString3;
    localarpu.jdField_a_of_type_Byte = paramByte;
    localarpu.c = paramString4;
    localarpu.e = paramString5;
    localarpu.jdField_a_of_type_Short = paramShort;
    localarpu.f = paramString6;
    localarpu.jdField_a_of_type_Int = 0;
    return localarpu;
  }
  
  public arpu a(long paramLong, String paramString1, byte paramByte, String paramString2, byte[] paramArrayOfByte, String paramString3)
  {
    arpu localarpu = new arpu(this);
    localarpu.jdField_a_of_type_Long = paramLong;
    localarpu.jdField_a_of_type_JavaLangString = paramString1;
    localarpu.b = paramString2;
    localarpu.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    localarpu.d = paramString3;
    localarpu.jdField_a_of_type_Byte = paramByte;
    localarpu.jdField_a_of_type_Int = 0;
    return localarpu;
  ...
  public arpu a(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, short paramShort)
  {
    return a(paramLong, paramString1, (byte)3, paramString2, paramString3, paramString4, paramString5, paramShort, "");
  }
  
  public arpu a(long paramLong, String paramString1, String paramString2, byte[] paramArrayOfByte, String paramString3)
  {
  ...
  public String a(int paramInt)
  {
    ...
    return ((arpu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).e;
  }
      ...
      if (!paramString.startsWith("/"))
      {
        ...
        if ((paramString.startsWith("http://")) && (!paramString.endsWith(".png")))
        {
          if (this.jdField_a_of_type_Byte == 6) {
            str = paramString + "_" + aqwk.b + "_" + aqwk.jdField_a_of_type_Byte + ".png";
          } else if (this.jdField_a_of_type_Byte == 0) {
            str = paramString + "_" + (aqwk.jdField_a_of_type_Byte - 2) + ".png";
            ...
            str = paramString + "_" + aqwk.jdField_a_of_type_Byte + ".png";
          }
        }
        else
        {
  ...
  public short a(int paramInt)
  {
    ...
    return ((arpu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Short;
  }
    ...
    if (j > 0)
    {
      ...
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Byte == 2) {
          localarpu.b(paramDataInputStream);
        }
        for (;;)
        {
          a(localarpu);
          i += 1;
          break;
          localarpu.a(paramDataInputStream);
        }
      }
    }
  }
  ...
  public void a(DataOutputStream paramDataOutputStream)
  {
    ...
    if (i < j)
    {
      localarpu = (arpu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Byte != 2) {
        break label117;
      }
      localarpu.b(paramDataOutputStream);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label117:
      localarpu.a(paramDataOutputStream);
    }
  }
  ...
  public void a(String paramString, byte[] arg2)
  {
    ...
    {
      ArrayList localArrayList = aqwk.a();
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        arpu localarpu = (arpu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (paramString.startsWith(localarpu.b))
        {
          if (this.jdField_a_of_type_Byte == 1)
          {
            localarpu.c = (BaseApplication.getContext().getFilesDir().getAbsolutePath() + "/" + "flashlogo.png");
            a(???, localarpu.c, this.b);
            if (localArrayList == null) {
              break;
            }
            ??? = localArrayList.iterator();
            while (???.hasNext()) {
              ((aqwl)???.next()).a(true, this.jdField_a_of_type_Short, i, paramString);
            }
          }
          if (this.jdField_a_of_type_Byte == 0)
          {
            a(???, String.valueOf(localarpu.f));
            try
            {
              ??? = new File(localarpu.c);
              if (!MD5.getFileMD5(???).equalsIgnoreCase(localarpu.f))
              {
                ???.delete();
                if (localarpu.jdField_a_of_type_Int < 1)
                {
                  localarpu.jdField_a_of_type_Int += 1;
                  b(localarpu.b);
                }
              }
              if (localArrayList == null) {
          ...
          for (;;)
          {
            try
            {
              ...
              if (!paramString.equalsIgnoreCase(localarpu.f))
              {
                ???.delete();
                if (localarpu.jdField_a_of_type_Int >= 1) {
                  break label517;
              ...
              QLog.d("PicAndAdConf", 2, "handle download NearbyBanner image, cid = " + localarpu.jdField_a_of_type_Long + ", md5 is " + paramString.equalsIgnoreCase(localarpu.f));
              return;
            }
            ...
            QLog.d("PicAndAdConf", 2, "handleImgData exception, item md5 = " + localarpu.f, paramString);
            return;
            label517:
            synchronized (this.jdField_a_of_type_JavaUtilHashMap)
            {
              this.jdField_a_of_type_JavaUtilHashMap.put(localarpu.b, Long.valueOf(System.currentTimeMillis()));
            }
          }
        }
        i += 1;
  ...
  public String b(int paramInt)
  {
    ...
    return ((arpu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).f;
  }
  ...
  public String c(int paramInt)
  {
    ...
    return ((arpu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).d;
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Byte == 2)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if (localarpu.c != null)
        {
          File localFile = new File(localarpu.c);
        ...
        for (;;)
        {
          ...
          break;
          label92:
          localStringBuilder.append(" | ").append(localarpu.jdField_a_of_type_Long);
          ThreadManager.post(new PicAndAdConf.1(this, localarpu), 5, null, false);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  public void handleError(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      paramHttpMsg2 = (arpu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (paramHttpMsg1.getUrl().startsWith(paramHttpMsg2.b))
      {
        paramHttpMsg2 = aqwk.a();
        if (paramHttpMsg2 == null) {
          break;
        }
        paramHttpMsg2 = paramHttpMsg2.iterator();
        while (paramHttpMsg2.hasNext()) {
          ((aqwl)paramHttpMsg2.next()).a(false, this.jdField_a_of_type_Short, i, paramHttpMsg1.getUrl());
        }
      }
      i += 1;
    }
