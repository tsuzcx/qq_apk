...
public class pfi
{
  private static final apck jdField_a_of_type_Apck = new pfj("readinjoy_anti_cheating", false);
  private static boolean jdField_a_of_type_Boolean;
  
  private static int a()
  {
    String str1 = a();
    String str2 = (String)bnrf.a("readinjoy_sp_key_last_request_lbs_date", "");
    QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "getToadyRequestLbsTime, today = ", str1, ", lastRequestLbsDate = ", str2 });
    if (str1.equals(str2)) {
      return ((Integer)bnrf.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(0))).intValue();
    }
    return 0;
  }
  ...
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = apch.a("readinjoy_anti_cheating");
  ...
  public static void a()
  {
    ...
    bnrf.a("readinjoy_sp_key_app_launch_time", Long.valueOf(l));
  }
  ...
  private static boolean a()
  {
    ...
    if (localObject != null)
    {
      ...
      long l1 = ((Long)bnrf.a("readinjoy_sp_key_app_launch_time", Long.valueOf(System.currentTimeMillis()))).longValue();
  ...
  {
    String str = a();
    Object localObject = (String)bnrf.a("readinjoy_sp_key_last_request_lbs_date", "");
    QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "updateToadyRequestLbsTime, today = ", str, ", lastRequestLbsDate = ", localObject });
    if (str.equals(localObject))
    {
      localObject = (Integer)bnrf.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(0));
      QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "updateToadyRequestLbsTime, todayTime = ", localObject });
      bnrf.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(((Integer)localObject).intValue() + 1));
    }
    for (;;)
    {
      bnrf.a("readinjoy_sp_key_last_request_lbs_date", str);
      return;
      QLog.d("ReadInJoySpEventReportUtil", 1, "updateToadyRequestLbsTime, first time today.");
      bnrf.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(1));
    }
  }
}
