  ...
  extends qhj
{
  ...
  public pfi(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qxn paramqxn, Handler paramHandler)
  {
  ...
  private orr a(boolean paramBoolean, List<oidb_cmd0xc46.MedalInfo> paramList, String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      if (paramList.hasNext())
      {
        ...
        orr localorr = new orr();
        if (localMedalInfo.is_jump.has()) {
          localorr.jdField_b_of_type_Int = localMedalInfo.is_jump.get();
        }
        if (localMedalInfo.jump_url.has()) {
          localorr.jdField_c_of_type_JavaLangString = localMedalInfo.jump_url.get().toStringUtf8();
        }
        if (localMedalInfo.medal_type.has()) {
          localorr.jdField_a_of_type_Int = localMedalInfo.medal_type.get();
        }
        if (localMedalInfo.medal_id.has()) {
          localorr.jdField_a_of_type_Long = localMedalInfo.medal_id.get();
        }
        if (localMedalInfo.medal_name.has()) {
          localorr.jdField_a_of_type_JavaLangString = localMedalInfo.medal_name.get().toStringUtf8();
        }
        if (localMedalInfo.medal_url.has()) {
          localorr.jdField_b_of_type_JavaLangString = localMedalInfo.medal_url.get().toStringUtf8();
        }
        if (localMedalInfo.pic_width.has()) {
          localorr.jdField_c_of_type_Int = localMedalInfo.pic_width.get();
        }
        if (localMedalInfo.pic_height.has()) {
          localorr.jdField_d_of_type_Int = localMedalInfo.pic_height.get();
        }
        localorr.jdField_e_of_type_JavaLangString = "3";
        if (paramBoolean) {}
        for (localorr.f = "7";; localorr.f = "6")
        {
          localorr.h = paramString;
          localArrayList.add(localorr);
          break;
        }
      }
    }
    ...
    if (!localArrayList.isEmpty()) {
      paramList = (orr)localArrayList.get(0);
    }
    return paramList;
  }
    ...
    if ((paramComment.is_multi_media.has()) && (paramComment.is_multi_media.get() == 1))
    {
      ...
      for (paramComment = paramComment.rpt_media_data_list.get(); (paramComment != null) && (paramComment.size() > 0); paramComment = null)
      {
        ...
        while (i < j)
        {
          ...
          pdo localpdo = new pdo();
          localpdo.jdField_a_of_type_JavaLangString = localMediaData.text.get();
          localpdo.jdField_e_of_type_Int = localMediaData.media_type.get();
          localpdo.jdField_a_of_type_Int = localMediaData.pic_width.get();
          localpdo.jdField_b_of_type_Int = localMediaData.pic_length.get();
          localpdo.jdField_b_of_type_JavaLangString = localMediaData.pic_url.get();
          localpdo.jdField_e_of_type_JavaLangString = localMediaData.thumbnail_url.get();
          localpdo.jdField_d_of_type_JavaLangString = localMediaData.video_url.get();
          localpdo.jdField_d_of_type_Int = localMediaData.video_duration.get();
          localpdo.jdField_c_of_type_JavaLangString = localMediaData.sound_url.get();
          localpdo.jdField_c_of_type_Int = localMediaData.sound_duration.get();
          paramBaseCommentData.mediaDataList.add(localpdo);
          i += 1;
        }
      }
    }
  ...
  private static void a(String paramString)
  {
    ...
    try
    {
      ...
      localtlw.jdField_b_of_type_Int = ViewUtils.dpToPx(37.0F);
      localtlw.jdField_a_of_type_Int = ViewUtils.dpToPx(37.0F);
      localtlw.jdField_c_of_type_Int = 1;
      qdn.a.a(localtlw, paramString);
      tlv.a().a(localtlw, new pfj(paramString));
      return;
    }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = qxp.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject1);
    QLog.d("ReadInJoyCommentPBModule", 1, "handleCommonCommentList | retCode " + j);
    paramFromServiceMsg = new pfl();
    paramObject = new pfl();
    pfm localpfm = new pfm();
    localpfm.jdField_a_of_type_Pfk = new pfk();
    boolean bool;
    if (j == 0)
    {
      if (qxl.a(((oidb_cmd0xc46.RspBody)localObject1).next, 0) != 1) {
        break label1039;
      }
      bool = true;
    }
    for (;;)
    {
      ...
      paramObject.jdField_a_of_type_JavaLangString = qxl.a(((oidb_cmd0xc46.RspBody)localObject1).page_cookie, "");
      if (((oidb_cmd0xc46.RspBody)localObject1).extra_info.has())
      {
        if (qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).hot_next, 0) != 1) {
          break label1045;
        }
        bool = true;
        paramFromServiceMsg.jdField_a_of_type_Boolean = bool;
        paramFromServiceMsg.jdField_a_of_type_JavaLangString = qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).hot_page_cookie, "");
        localpfm.b = qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).hidden_comment_count, 0);
        localpfm.jdField_a_of_type_Int = qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).show_mask, 0);
        if (!((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).jump_kva_schema.has()) {}
      }
      try
      {
        localpfm.jdField_a_of_type_JavaLangString = new String(bhcu.decode(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).jump_kva_schema.get(), 0), "utf-8");
        if (qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).is_pgc_author, 0) == 1)
        {
          bool = true;
          localpfm.jdField_a_of_type_Boolean = bool;
          Object localObject2;
          if (((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).label.has())
          {
            localObject2 = localpfm.jdField_a_of_type_Pfk;
            if (qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).label.show_delete, 0) != 1) {
              break label1067;
            }
            bool = true;
            ((pfk)localObject2).jdField_a_of_type_Boolean = bool;
            localObject2 = localpfm.jdField_a_of_type_Pfk;
            if (qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).label.show_top, 0) != 1) {
              break label1073;
            }
            bool = true;
            ((pfk)localObject2).c = bool;
            localObject2 = localpfm.jdField_a_of_type_Pfk;
            if (qxl.a(((oidb_cmd0xc46.ExtraInfo)((oidb_cmd0xc46.RspBody)localObject1).extra_info.get()).label.show_sink, 0) != 1) {
              break label1079;
            }
            bool = true;
            ((pfk)localObject2).jdField_b_of_type_Boolean = bool;
          }
          ...
          if (((oidb_cmd0xc46.RspBody)localObject1).article_info.has())
          {
            ...
            localpfm.jdField_a_of_type_Long = qxl.a(((oidb_cmd0xc46.ArticleInfo)localObject2).comment_count, 0L);
          ...
          QLog.d("ReadInJoyCommentPBModule", 1, i + " ; extraInfo : " + localpfm);
          ...
          this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.2(this, j, paramFromServiceMsg, paramObject, localpfm));
          return;
          label1039:
          bool = false;
          continue;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      if (localRspBody.next.has())
      {
        ...
        bool = true;
        localpfl.jdField_a_of_type_Boolean = bool;
      ...
      if (localRspBody.page_cookie.has()) {
        localpfl.jdField_a_of_type_JavaLangString = localRspBody.page_cookie.get().toStringUtf8();
      }
      if (localRspBody.comment_list.has()) {
        localpfl.jdField_a_of_type_JavaUtilList = a(localRspBody.comment_list.get());
      }
      if (localRspBody.article_info.has())
      {
        ...
        if (paramFromServiceMsg.comment_count.has()) {
          localpfm.jdField_a_of_type_Long = paramFromServiceMsg.comment_count.get();
        }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.4(this, i, localpfl, localpfm, paramFromServiceMsg));
      return;
      label469:
      bool = false;
      break;
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.6(this, i, localpfl, localpfm, paramFromServiceMsg));
      return;
      label469:
      bool = false;
      break;
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (localRspBody.hot_comment_list.has()) {
        localpfl.jdField_a_of_type_JavaUtilList = a(localRspBody.hot_comment_list.get());
      }
      if (localRspBody.article_info.has())
      {
        paramFromServiceMsg = (oidb_cmd0xc46.ArticleInfo)localRspBody.article_info.get();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ReadInJoyCommentPBModule.8(this, i, localpfl, localpfm, paramFromServiceMsg));
      return;
      label469:
      bool = false;
      break;
  ...
  {
    int i = qxp.a(paramFromServiceMsg, paramObject, new oidb_cmd0xc46.RspBody());
    int j = ((Integer)paramToServiceMsg.getAttributes().get("service_type")).intValue();
    uvs.a(i, paramToServiceMsg, 5, null);
    if (pkh.a() == null) {
      return;
    }
    ...
    paramObject = StatisticCollector.getInstance(pkh.a().getApplication());
    if (i == 0) {}
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = qxp.a("OidbSvc.0xc46", 3142, 6, localReqBody.toByteArray());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = qxp.a("OidbSvc.0xc46", 3142, 5, localReqBody.toByteArray());
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      paramString1 = qxp.a("OidbSvc.0xdc8", 3528, 1, localReqBody.toByteArray());
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = qxp.a("OidbSvc.0xc46", 3142, 4, localReqBody.toByteArray());
  ...
  public void a(oidb_cmd0xc46.Comment paramComment, BaseCommentData paramBaseCommentData)
  {
    ...
    paramBaseCommentData.commentId = qxl.a(paramComment.comment_id, "");
    paramBaseCommentData.uin = qxl.a(paramComment.author_id, "");
    paramBaseCommentData.commentTime = qxl.a(paramComment.create_time);
    paramBaseCommentData.commentContent = qxl.a(paramComment.content, "");
    paramBaseCommentData.likeCnt = qxl.a(paramComment.like_num, 0);
    paramBaseCommentData.like = qxl.a(paramComment.like, 0);
    paramBaseCommentData.disLike = qxl.a(paramComment.dislike, 0);
    paramBaseCommentData.anonymous = qxl.a(paramComment.anonymous, 0);
    paramBaseCommentData.authorSelection = qxl.a(paramComment.author_selection, 0);
    paramBaseCommentData.rank = qxl.a(paramComment.rank, 0);
    paramBaseCommentData.level = qxl.a(paramComment.level);
    paramBaseCommentData.authorComment = qxl.a(paramComment.author_comment, "");
    paramBaseCommentData.nickName = qxl.a(paramComment.nick_name, "");
    boolean bool;
    if (qxl.a(paramComment.author_like) == 1) {
      bool = true;
    }
    for (;;)
    {
      paramBaseCommentData.isAuthorLike = bool;
      if (qxl.a(paramComment.follow_status) == 1)
      {
        bool = true;
        label204:
        paramBaseCommentData.isFollowing = bool;
        paramBaseCommentData.avatar = qxl.a(paramComment.avatar, "");
        a(paramBaseCommentData.avatar);
        paramBaseCommentData.myself = qxl.a(paramComment.myself, 0);
        paramBaseCommentData.homepage = qxl.a(paramComment.homepage, "");
        paramBaseCommentData.awesome = qxl.a(paramComment.awesome);
        paramBaseCommentData.rowKey = qxl.a(paramComment.rowkey, "");
        paramBaseCommentData.contentSrc = qxl.a(paramComment.content_source, 0);
        paramBaseCommentData.passthrough = qxl.a(paramComment.passthrough, "");
        paramBaseCommentData.isActivity = qxl.a(paramComment.is_activity);
        paramBaseCommentData.activityPicUrl = qxl.a(paramComment.pic_url, "");
        paramBaseCommentData.activityJumpUrl = qxl.a(paramComment.jump_url, "");
        paramBaseCommentData.isStar = qxl.a(paramComment.is_star);
        paramBaseCommentData.isApproved = qxl.a(paramComment.is_approved);
        if (paramComment.account_level_info.has())
        {
          paramBaseCommentData.accountLevelInfo = new pdn();
          paramBaseCommentData.accountLevelInfo.jdField_a_of_type_Int = qxl.a(paramComment.account_level_info.uint32_account_cc_level);
          paramBaseCommentData.accountLevelInfo.jdField_a_of_type_JavaLangString = qxl.a(paramComment.account_level_info.account_cc_level_icon_s, "");
        }
        paramBaseCommentData.createSrc = qxl.a(paramComment.create_source, 0);
        QLog.d("ReadInJoyCommentPBModule", 1, "create_source : " + paramComment.create_source.get());
        paramBaseCommentData.isAuthorReply = qxl.a(paramComment.is_author_reply);
        paramBaseCommentData.userTitle = qxl.a(paramComment.user_title, "");
        paramBaseCommentData.ksHomePage = qxl.a(paramComment.ks_homepage, "");
        if (paramComment.activity.has()) {
          paramBaseCommentData.activityCfgID = qxl.a(paramComment.activity.config_id);
        }
        if (!paramComment.jump_schema.has()) {}
      }
      try
      {
        paramBaseCommentData.flowGuidePtsData = new String(bhcu.decode(paramComment.jump_schema.get(), 0), "utf-8");
        ...
        paramBaseCommentData.styleData = qxl.a(paramComment.style_data, "");
        if (qxl.a(paramComment.comment_author_top) == 1) {}
        for (bool = true;; bool = false)
        {
          paramBaseCommentData.isAuthorSticky = bool;
          paramBaseCommentData.avatarPendantUrl = qxl.a(paramComment.avatar_pendant, "");
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (localLinkData != null)
            {
              ...
              localCommentLinkData.iconUrl = qxl.a(localLinkData.icon, "");
              localCommentLinkData.linkUrl = qxl.a(localLinkData.url, "");
              localCommentLinkData.type = qxl.a(localLinkData.type, 0);
              localCommentLinkData.wording = qxl.a(localLinkData.wording, "");
  ...
  public void b(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = qxp.a("OidbSvc.0xc46", 3142, 2, localReqBody.toByteArray());
  ...
  public void c(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, CommonCommentData paramCommonCommentData)
  {
    ...
    paramString1 = qxp.a("OidbSvc.0xc46", 3142, 3, localReqBody.toByteArray());
