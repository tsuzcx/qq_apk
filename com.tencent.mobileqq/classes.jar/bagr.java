  ...
  implements Manager
{
  ...
  aycb jdField_a_of_type_Aycb = new bagv(this);
  public bahg a;
  public bara a;
  barl jdField_a_of_type_Barl = new bagu(this);
  protected barx a;
  batd jdField_a_of_type_Batd;
  bbwf jdField_a_of_type_Bbwf = new bagy(this);
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = null;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  public Comparator<bahf> a;
  HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  String jdField_b_of_type_JavaLangString;
  HashMap<String, List<bahf>> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bagr(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_Int = 1;
    this.jdField_c_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_JavaUtilComparator = new bagx(this);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    a(paramAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  }
  
  private void a(bahf parambahf)
  {
    int i = 0;
    Object localObject = (List)this.jdField_b_of_type_JavaUtilHashMap.get(parambahf.getFriendUin());
    if (localObject == null)
    {
      localObject = new ArrayList();
      this.jdField_b_of_type_JavaUtilHashMap.put(parambahf.getFriendUin(), localObject);
    }
    for (;;)
    {
      int j;
      try
      {
        ((List)localObject).add(parambahf);
        int m = parambahf.getLimitType();
        int k = -1;
        j = 0;
        if (i < ((List)localObject).size())
        {
          parambahf = (bahf)((List)localObject).get(i);
          if ((parambahf == null) || (parambahf.getLimitType() != m)) {
            break label158;
          }
          if (k == -1)
          {
  ...
  private void a(String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    ...
    {
      Object localObject = new File(balg.a(paramString, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()));
      ...
      localObject = new bbwg(balg.c(paramMessageForDeliverGiftTips), (File)localObject);
      ((bbwg)localObject).jdField_b_of_type_Int = 2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOAnimationControlManager", 2, "start Download PackageId:" + balg.b(paramMessageForDeliverGiftTips));
      }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if (i < localList.size())
    {
      paramString1 = (bahf)localList.get(i);
      if (!(paramString1 instanceof MessageForDeliverGiftTips)) {
        break label87;
      }
      paramString1 = balg.b((MessageForDeliverGiftTips)paramString1);
    }
    for (;;)
    {
  ...
  public static boolean a(BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, Object paramObject)
  {
    ...
    for (;;)
    {
      if (ahfj.a(paramObject, paramQQAppInterface)) {
        paramBaseChatPie.o(false);
      }
      return false;
      label37:
      ...
      ((bagr)paramQQAppInterface.getManager(223)).a(paramBaseChatPie);
    }
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramString2.equals(balg.b((MessageForDeliverGiftTips)paramString1.get(i)))) {
  ...
  private void h()
  {
    Object localObject = new File(ajsf.ct);
    ...
    {
      label111:
      if (balg.a((String)localObject, i, bool))
      {
      ...
      for (;;)
      {
        ...
        bool = true;
        break label111;
        bbdj.a(arrayOfFile[j].getAbsolutePath());
      }
      return;
      label270:
      i = 0;
  ...
  public bbwl a()
  {
    return ((bbwi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(47)).a(1);
  }
  
  public void a()
  {
    int i = 0;
    Object localObject = new File(balg.a(0)).getParentFile();
    if (((File)localObject).exists())
    {
      ...
      if (i < localObject.length)
      {
        if (localObject[i].exists())
        {
          ...
          try
          {
            ...
            if (balg.a(Integer.parseInt(str))) {
  ...
  public void a(Activity paramActivity)
  {
    if (this.jdField_a_of_type_Bara == null) {
      this.jdField_a_of_type_Bara = new bara(null, paramActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    this.jdField_a_of_type_Bara.a(4);
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Bara.a();
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != paramBaseChatPie)
    {
      ...
      this.jdField_a_of_type_Bara = paramBaseChatPie.a();
      if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) {
        break label114;
      }
      this.jdField_a_of_type_Bara.a(1);
      this.jdField_a_of_type_Barx = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
      this.jdField_a_of_type_Batd = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
    }
    label114:
    do
    {
    ...
    } while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aerl));
    ...
    {
      this.jdField_a_of_type_Bara.a(8);
      return;
    }
    this.jdField_a_of_type_Bara.a(6);
  }
  ...
  {
    bahe.a().addObserver(paramObserver);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                } while ((!b()) && (balg.a((List)localObject3)));
                if ((this.jdField_a_of_type_Barx == null) || (balg.a((List)localObject3))) {
                  break label397;
                }
              } while ((this.jdField_a_of_type_Barx.b()) && (this.jdField_a_of_type_Barx.a()));
              this.jdField_a_of_type_Int = 2;
              localObject5 = (MessageForDeliverGiftTips)((List)localObject3).get(0);
              localObject6 = balg.b((MessageForDeliverGiftTips)localObject5);
            ...
            ((bakt)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(((MessageForDeliverGiftTips)localObject5).frienduin, ((MessageForDeliverGiftTips)localObject5).interactId, ((MessageForDeliverGiftTips)localObject5).giftId, new bagz(this, (MessageForDeliverGiftTips)localObject5, (List)localObject3, paramBoolean, (List)localObject4, (String)localObject6));
            return;
            ...
            return;
          } while ((this.jdField_a_of_type_Bara == null) || (balg.a((List)localObject4)));
          this.jdField_a_of_type_Int = 2;
          localObject3 = (bahf)((List)localObject4).get(0);
          ...
          {
            localObject3 = ((bakt)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a((String)localObject1, ((MessageForDeliverGiftTips)localObject5).bagId, new bahb(this, (MessageForDeliverGiftTips)localObject5, (String)localObject1, paramBoolean));
          ...
          for (;;)
          {
            if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
              ((MessageForDeliverGiftTips)localObject5).senderName = bbcl.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, (String)localObject1, "" + ((MessageForDeliverGiftTips)localObject5).senderUin);
            }
            localObject6 = balg.b((MessageForDeliverGiftTips)localObject5);
            if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() != 3)) {
              break label1241;
            }
            this.jdField_a_of_type_Bara.a(this.jdField_a_of_type_Aycb);
            if (QLog.isColorLevel()) {
              QLog.d("AIOAnimationControlManager", 2, "Playing! playMaigface id:" + balg.b((MessageForDeliverGiftTips)localObject5));
            }
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a() == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a.a())) {
              break;
            }
        ...
        } while (this.jdField_a_of_type_Barx == null);
        this.jdField_a_of_type_Barx.a((MessageForDeliverGiftTips)localObject5, (String)localObject6, false, new bahc(this, paramBoolean));
        return;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          localObject3 = "0";
          ...
          axqw.b((QQAppInterface)localObject4, "P_CliOper", "Grp_flower", "", "cartoon", "show", 0, 0, (String)localObject1, (String)localObject6, (String)localObject3, "" + mud.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), (String)localObject1));
          if (QLog.isColorLevel())
          {
        ...
        this.jdField_a_of_type_Bara.a((MessageForDeliverGiftTips)localObject5);
        this.jdField_a_of_type_Bara.jdField_a_of_type_Barl = this.jdField_a_of_type_Barl;
        return;
        if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() == 4))
        {
        ...
        this.jdField_a_of_type_Int = 3;
        return;
        if ((localObject3 instanceof ahfj))
        {
          localObject1 = (ahfj)localObject3;
          this.jdField_a_of_type_Bara.a((ahfj)localObject1);
          ((ahfj)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new bags(this, paramBoolean));
          ((List)localObject4).remove(localObject3);
          return;
        }
      } while ((!(localObject3 instanceof MessageForTroopEffectPic)) || (this.jdField_a_of_type_Batd == null));
      ...
      if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject3)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject3)).intValue() != 3) || (!balg.a(((MessageForTroopEffectPic)localObject5).effectId))) {
        break;
      }
      Object localObject1 = ((MessageForTroopEffectPic)localObject5).getPicDownloadInfo();
      ((aunl)localObject1).e = "chatimg";
      Object localObject6 = ((aunl)localObject1).c();
      ...
      for (;;)
      {
        ...
        try
        {
          if (localFile.exists())
          {
            ...
            localOptions.inSampleSize = ((int)bbdr.a((InputStream)localObject1, 720, 1080));
            ((BufferedInputStream)localObject1).close();
            localObject6 = bbdr.a((String)localObject6, localOptions);
            localObject1 = localObject3;
        ...
        this.jdField_a_of_type_Batd.a(((MessageForTroopEffectPic)localObject5).effectId, (Bitmap)localObject1, ((TroopChatPie)localObject3).s, new bagt(this, paramBoolean));
        ((List)localObject4).remove(localObject5);
        return;
        i = 90;
        continue;
    ...
    label1297:
    label1829:
    this.jdField_a_of_type_Batd.a((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, (MessageForTroopEffectPic)localObject5, false);
    return;
  ...
  public boolean a(bahf parambahf, boolean paramBoolean)
  {
    if (parambahf == null) {
      return false;
    }
    if (((parambahf instanceof MessageForDeliverGiftTips)) && (!balg.a((MessageForDeliverGiftTips)parambahf))) {
      return false;
    }
    a(parambahf);
    if (paramBoolean)
  ...
  public boolean a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean)
  {
    ...
    while (!balg.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    ...
    {
      return true;
      ((bakt)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.giftId, new bagw(this, paramMessageForDeliverGiftTips, paramBoolean));
    }
  }
  ...
  public boolean a(MessageForTroopEffectPic paramMessageForTroopEffectPic, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!balg.a(paramMessageForTroopEffectPic.effectId))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bbdj.d(balg.a(paramMessageForTroopEffectPic.effectId));
  ...
  public long[] a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        bahf localbahf = (bahf)((Iterator)localObject).next();
        if ((localbahf instanceof MessageForDeliverGiftTips)) {
          paramString.add(Long.valueOf(((MessageForDeliverGiftTips)localbahf).getId()));
        }
      }
    }
  ...
  public void b()
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;; localObject = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) || (balg.a((List)localObject))) {
        break label135;
      }
      int j;
      for (int i = 0; i < ((List)localObject).size(); i = j + 1)
      {
        bahf localbahf = (bahf)((List)localObject).get(i);
        j = i;
        if (localbahf.isReaded())
        {
          j = i;
          if (localbahf.getSenderUin() != this.jdField_a_of_type_ComTencentCommonAppAppInterface.getLongAccountUin())
          {
  ...
  {
    bahe.a().deleteObserver(paramObserver);
  }
  ...
  {
    if (!balg.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    String str = balg.b(paramMessageForDeliverGiftTips);
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!balg.a(str, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bbdj.a(balg.a(paramMessageForDeliverGiftTips));
        a(str, paramMessageForDeliverGiftTips);
        i = 2;
        if (QLog.isColorLevel()) {
          QLog.d("AIOAnimationControlManager", 2, "giftRealAnimationId:" + balg.b(paramMessageForDeliverGiftTips) + ",state:" + i);
        }
        if ((a()) && (i != 3)) {
          break label188;
        }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_Barx = null;
  }
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_Bara != null) && (this.jdField_a_of_type_Bara.a())) {
      this.jdField_a_of_type_Bara.c();
    }
    if ((this.jdField_a_of_type_Barx != null) && (!this.jdField_a_of_type_Barx.a())) {
