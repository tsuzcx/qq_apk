  ...
  implements Manager
{
  ...
  public aixs(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong, aixv paramaixv, String paramString, Map<String, String> paramMap)
  {
    if (a())
    {
    ...
    for (long l2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin();; l2 = 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QWalletConfigManager", 2, "realGetConfig:" + paramLong + "|" + paramaixv + "|" + paramString + "|" + paramMap + "|" + localReqWalletConfig);
      }
      aivh.a(localReqWalletConfig, new aixt(this, paramLong, paramaixv, new WeakReference(this)), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      l1 = 0L;
      break;
    }
  ...
  public static void a(String paramString, aixw paramaixw)
  {
    ...
    {
      ((aixs)localAppRuntime.getManager(245)).c(paramString, paramaixw);
      return;
    }
    ajem.a(paramString, paramaixw);
  }
  ...
  public static void b(String paramString, aixw paramaixw)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((aixs)localAppRuntime.getManager(245)).d(paramString, paramaixw);
      return;
    }
    ajem.b(paramString, paramaixw);
  }
  
  public int a(String paramString, int paramInt, String... paramVarArgs)
  {
    return aixp.a(a(paramString), paramInt, paramVarArgs);
  }
  ...
  {
    return aixp.a(a(paramString1), paramString2, paramVarArgs);
  }
  
  public JSONArray a(String paramString, String... paramVarArgs)
  {
    return aixp.a(a(paramString), paramVarArgs);
  }
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    do
    {
      ...
      aivh.a(paramMap, 1, new aixu(this));
    } while (!QLog.isColorLevel());
  ...
  public void b(int paramInt)
  {
    ...
    try
    {
      String str = ((ajbp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(273)).a();
  ...
  public void c(String paramString, aixw paramaixw)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.addUpdateListener(paramString, paramaixw);
  }
  
  public void d(String paramString, aixw paramaixw)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.removeUpdateListener(paramString, paramaixw);
  }
