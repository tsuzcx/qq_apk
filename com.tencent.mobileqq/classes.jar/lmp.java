...
public class lmp
{
  ...
  public void a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      try
      {
        ...
        do
        {
          localObject2 = new lmq((BufferedReader)localObject1);
          ...
          ((lmq)localObject2).a(arrayOfBitmapDrawable);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (i < j)
    {
      ((lmq)this.a.get(i)).a(paramCanvas);
      i += 1;
    }
  }
  ...
  public void a(PathMeasure paramPathMeasure)
  {
    ...
    while (i < j)
    {
      ((lmq)this.a.get(i)).a(paramPathMeasure);
      i += 1;
    }
  }
}
