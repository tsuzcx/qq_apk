...
public class bcie
{
  ...
  private static bcie jdField_a_of_type_Bcie;
  ...
  {
    int j = 0;
    if (!bcie.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          Object localObject = aqbj.b(BaseApplicationImpl.getContext());
  ...
  {
    if (jdField_a_of_type_Bcie == null) {}
    try
    {
      if (jdField_a_of_type_Bcie == null) {
        jdField_a_of_type_Bcie = new bcie();
      }
      return jdField_a_of_type_Bcie;
    }
    finally {}
  }
