...
@TargetApi(18)
public class mim
  implements Handler.Callback, View.OnClickListener, mnq, mnt, mnz
{
  ...
  public mim(AVActivity paramAVActivity, RelativeLayout paramRelativeLayout1, VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, RelativeLayout paramRelativeLayout2, VideoControlUI paramVideoControlUI)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI == null)
      {
        ...
        this.jdField_a_of_type_Mnr = mnr.a();
        this.jdField_a_of_type_Long = (this.jdField_a_of_type_Mnr.h * 60 * 1000L);
      ...
      try
      {
        ...
        paramAVActivity = DeviceInfoUtil.getManufactureInfo();
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong >= 0L)
      {
        ...
        mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695308);
        mnu.a("0X8008AB0");
      }
      else if (paramLong < 0L)
      {
        a(3, true);
        mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695283);
  ...
  public static void a(VideoController paramVideoController)
  {
    ...
    paramVideoController.a(8, "SUPPORT_TRUE");
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + mnr.a().h);
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + mnr.a().h);
  }
  
  private void a(VideoAppInterface paramVideoAppInterface)
  {
    LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131559799, this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380673));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376167));
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376166));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378463));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376152));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376149);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376148);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376147);
    ...
    this.jdField_a_of_type_Int = AIOUtils.dp2px(51.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    this.jdField_b_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131695296);
    this.jdField_c_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131695292);
    this.jdField_a_of_type_ComTencentAvUiFunchatRecordQavRecordButtonView = ((QavRecordButtonView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376139));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376155));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376154));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    if (AudioHelper.a(0) == 1)
    {
  ...
  private void b(long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoController.a().B = false;
    mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695284);
    this.jdField_a_of_type_ComTencentAvVideoController.E();
    n();
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
  ...
  private void h(int paramInt)
  {
    ...
    do
    {
      ...
      for (paramInt = 2131695298;; paramInt = 2131695297)
      {
  ...
  private void r()
  {
    ...
    AIOUtils.dp2px(7.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    AIOUtils.dp2px(64.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    b(2131297880);
    b(2131297877);
    b(2131297877);
    b(2131297879);
    ...
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener == null) {
      this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new min(this);
    }
    if (this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener == null) {
      this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new mio(this);
    }
  ...
  private void u()
  {
    ...
    {
      localAVActivity.jdField_a_of_type_Mcc.c(2);
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().B)
    {
      ...
      bcef.b(null, "CliOper", "", "", "0X800863B", "0X800863B", 0, 0, String.valueOf(l), "", "", "");
    ...
    if (!f())
    {
      if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
        mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695278);
      }
      j = 0;
    ...
    for (;;)
    {
      if (j != 0)
      {
        ...
        {
          localObject = (lgr)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
          if (((FaceItem)((lgr)localObject).a() != null) && (((lgr)localObject).a()) && (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
            mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695288);
          }
        }
        mnu.a("0X800863A");
        ...
        for (;;)
        {
          ...
          if (!this.jdField_a_of_type_ComTencentAvVideoController.a().A)
          {
            ...
            for (j = 2131695286;; j = 2131695285)
            {
              if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) {
                break label1192;
              }
              mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, j);
              j = 0;
              break;
              mnu.a("0X8008AB5");
            }
          ...
          {
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695291);
            }
            j = 0;
          ...
          if ((this.jdField_a_of_type_ComTencentAvVideoController.a().C) && (this.jdField_a_of_type_ComTencentAvVideoController.a().u < 735))
          {
            ...
            mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695289);
            j = 0;
            break;
          }
          if (!e())
          {
            ...
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695287);
            }
            j = 0;
            break;
          }
          ...
          {
            localObject = (lgr)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
            FaceItem localFaceItem = (FaceItem)((lgr)localObject).a();
            if (localFaceItem != null)
            {
              boolean bool1 = ((lgr)localObject).a();
              ...
              label801:
              for (j = 2131695311;; j = 2131695310)
              {
                mak.a((VideoAppInterface)localObject, 1022, j);
                j = 0;
          ...
          {
            localObject = (lir)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            if (localObject != null)
            {
              ...
              if (localObject != null)
              {
                ...
                for (j = 1;; j = 0)
                {
                  ...
                  mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695312);
                  j = 0;
          ...
          label931:
          if ((localAVActivity.jdField_a_of_type_Mmp != null) && (localAVActivity.jdField_a_of_type_Mmp.a()))
          {
            j = 0;
            mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695309);
            break;
          }
          if (mnh.a() < 31457280L)
          {
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              mak.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695303);
            }
            j = 0;
          ...
          if ((mqa.a()) && (mqa.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface).c()))
          {
          ...
          {
            localObject = (lhr)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
            if ((localObject != null) && (((lhr)localObject).a() != null))
            {
  ...
  private void w()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b() + b(2131297839));
      return;
    }
    this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b(2131297839));
  }
  ...
  public long a()
  {
    try
    {
      ...
      for (l = this.jdField_g_of_type_Long;; l = mnh.a(this.jdField_a_of_type_JavaIoFile))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      mnh.a(paramString, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        j = mnv.a(paramString2, this.jdField_a_of_type_Mnr.h);
    ...
    case 1: 
      ...
      for (;;)
      {
        ...
        {
          paramString1 = (lhr)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
    ...
    case 8: 
      ...
      {
        a(4, false);
        mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695282);
      }
      for (;;)
      {
        m();
        return;
        a(9, false);
        mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695281);
      }
    case 4: 
      a(3);
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject = (RedPacketGameView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131373487);
      if (localObject != null) {
  ...
  {
    if ((jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Mnx != null) && (paramInt1 == 100)) {
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        j = mit.b(paramInt1);
        this.jdField_d_of_type_JavaLangString = mnh.a();
        ...
        paramInt2 = this.jdField_a_of_type_Mnr.f;
        if (paramInt1 > paramInt2)
        {
          ...
          if (j % 2 == 1)
          {
            ...
            bafx localbafx = new bafx(this.jdField_d_of_type_JavaLangString, paramInt1, paramInt2, 5120000, 1, false, 0);
  ...
  public void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      mnu.a(this.jdField_a_of_type_Mnr.r, this.jdField_a_of_type_Mnr.s, paramInt, b());
      return;
      if (paramInt == 2)
      {
        b(b());
  ...
  public void b(int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout$LayoutParams.setMargins(b(2131297880), 0, 0, 0);
  ...
  public void d()
  {
    ...
    if ((this.jdField_c_of_type_Int == 90) || (this.jdField_c_of_type_Int == 270))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.leftMargin = AIOUtils.dp2px(15.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
      if (this.jdField_d_of_type_AndroidWidgetRelativeLayout != null) {
        this.jdField_d_of_type_AndroidWidgetRelativeLayout.setLayoutParams(this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams);
      }
  ...
  public void f(int paramInt)
  {
    ...
    case 180: 
      ...
      localLayoutParams.setMargins(AIOUtils.dp2px(10.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, 0);
      localLayoutParams.addRule(2, 0);
      localLayoutParams.addRule(1, 2131376139);
      localLayoutParams.addRule(6, 2131376139);
    ...
    localLayoutParams.setMargins(AIOUtils.dp2px(-12.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, AIOUtils.dp2px(32.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    localLayoutParams.addRule(2, 2131376139);
  ...
  public void g(int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      FaceItem localFaceItem = (FaceItem)((lgr)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      for (;;)
      {
        mnu.a("0X8008AC8");
        return;
        mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695294);
      }
      mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695293);
      mnu.a("0X8008AC9");
      return;
  ...
  public boolean h()
  {
    ...
    {
      localObject = (lgr)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
      FaceItem localFaceItem = (FaceItem)((lgr)localObject).a();
      if (localFaceItem != null)
      {
        bool4 = ((lgr)localObject).a();
    ...
    for (boolean bool5 = true;; bool5 = false)
    {
      ...
      {
        localObject = (lir)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
        if (localObject != null)
        {
          localObject = (ZimuItem)((lir)localObject).a();
          if (localObject != null) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (l > this.jdField_a_of_type_Long)
      {
        ...
        bcef.b(null, "CliOper", "", "", "0X800863C", "0X800863C", 0, 0, String.valueOf(l), "", "", "");
      ...
      if (!((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).i)
      {
        ...
        continue;
        if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
          mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695295);
        }
      }
    }
  }
  ...
  public boolean i()
  {
    ...
    {
      if (this.jdField_a_of_type_Mnr.r <= this.jdField_a_of_type_Mnr.jdField_d_of_type_Int) {
        break label111;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Mnr.jdField_a_of_type_Int != 1) {
      ...
      return true;
      label111:
      if ((this.jdField_a_of_type_Mnr.r == this.jdField_a_of_type_Mnr.jdField_d_of_type_Int) && (this.jdField_a_of_type_Mnr.s >= this.jdField_a_of_type_Mnr.jdField_e_of_type_Int)) {
        this.jdField_b_of_type_Int = 2;
      } else if (this.jdField_a_of_type_Mnr.r > this.jdField_a_of_type_Mnr.jdField_b_of_type_Int) {
        this.jdField_b_of_type_Int = 1;
      } else if ((this.jdField_a_of_type_Mnr.r == this.jdField_a_of_type_Mnr.jdField_b_of_type_Int) && (this.jdField_a_of_type_Mnr.s >= this.jdField_a_of_type_Mnr.jdField_c_of_type_Int)) {
        this.jdField_b_of_type_Int = 1;
      } else {
  ...
  public void l()
  {
    ...
    b(true);
    if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
      mak.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695314);
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a().C = false;
    n();
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
    long l = (System.currentTimeMillis() - this.jdField_c_of_type_Long) / 1000L;
    bcef.b(null, "CliOper", "", "", "0X800863E", "0X800863E", 0, 0, "", String.valueOf(l), "", "");
