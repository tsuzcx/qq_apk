  ...
  implements View.OnTouchListener
{
  ...
  public mim(Context paramContext, ImageView paramImageView1, ImageView paramImageView2, ShimmerTextView paramShimmerTextView, ImageView paramImageView3)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Mil == null);
        this.jdField_a_of_type_Mil.a(true);
        return true;
    ...
    this.jdField_a_of_type_Mil.a(false);
    return true;
  }
}
