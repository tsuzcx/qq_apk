  ...
  extends AsyncTask
{
  ...
  public vcr(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, MessageForShortVideo paramMessageForShortVideo)
  {
      ...
      if (ShortVideoTrimmer.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 0, 0))
      {
        ...
        if (Build.VERSION.SDK_INT >= 18)
        {
          ...
          if (((i & 0x1) > 0) && ((i & 0x2) > 0))
          {
            ...
            localObject = new vcv(this, str, (int)(((ShortVideoTrimmer.CompressConfig)localObject).b * 1024L), (int)((ShortVideoTrimmer.CompressConfig)localObject).jdField_a_of_type_Long, ((ShortVideoTrimmer.CompressConfig)localObject).c);
            if ((!new VideoConverter().a(localFile, (VideoConverter.Processor)localObject, true)) || (((vcv)localObject).a != null)) {
              break label928;
            }
            if (QLog.isColorLevel()) {
  ...
  protected void a(Integer paramInteger)
  {
    ...
    do
    {
      do
      {
        ...
        paramInteger = DialogUtil.a((Context)localObject1, 232, null, ((Context)localObject1).getString(2131437369), new vcs(this, paramInteger, (BaseActivity)localObject2), new vct(this, paramInteger));
        try
        {
          paramInteger.show();
          return;
      ...
      ThreadManager.postImmediately(new vcu(this, (MessageForShortVideo)localObject1), null, false);
      return;
    } while (!QLog.isColorLevel());
