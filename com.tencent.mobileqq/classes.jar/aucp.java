...
public class aucp
{
  ...
  private aucs jdField_a_of_type_Aucs = new aucq(this);
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private List<aucs> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public aucp(long paramLong, String paramString, Bundle paramBundle)
  {
  ...
  public static String a(int paramInt)
  {
    ...
    case 1: 
      return str + "[" + String.valueOf(paramInt) + "]";
    case 2: 
      return anni.a(2131714565);
    case 3: 
      return anni.a(2131714553);
    case 4: 
      return anni.a(2131714558);
    case 5: 
      return anni.a(2131714555);
    case 6: 
      return anni.a(2131714566);
    case 7: 
      return anni.a(2131714563);
    case 8: 
      return anni.a(2131714564);
    case 9: 
      return anni.a(2131714562);
    case 10: 
      return "SDK下载服务错误";
    case 11: 
      return anni.a(2131714557);
    case 12: 
      return "下载器DC失败";
    case 13: 
      return anni.a(2131714556);
    }
    return anni.a(2131714561);
  }
  ...
  private List<aucs> a()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        localArrayList.add((aucs)this.jdField_a_of_type_JavaUtilList.get(i));
        i += 1;
      }
  ...
  private boolean a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    //   8: ifnull +24 -> 32
    //   11: aload_0
    //   12: getfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    //   15: aconst_null
    //   16: invokeinterface 155 2 0
    //   21: pop
    //   22: aload_0
    //   23: getfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    ...
    //   36: aload_0
    //   37: iconst_1
    //   38: putfield 29	aucp:jdField_a_of_type_Int	I
    //   41: aload_0
    //   42: new 159	auct
    //   45: dup
    //   46: aload_0
    //   47: getfield 51	aucp:jdField_a_of_type_Long	J
    //   50: invokespecial 162	auct:<init>	(J)V
    //   53: putfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    //   56: aload_0
    //   57: getfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    //   60: aload_0
    //   61: getfield 45	aucp:jdField_a_of_type_Aucs	Laucs;
    //   64: invokeinterface 155 2 0
    //   69: pop
    //   70: iload_3
    //   71: istore_1
    //   72: aload_0
    //   73: getfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    //   76: aload_0
    //   77: getfield 47	aucp:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   80: aload_2
    //   81: invokeinterface 165 3 0
    //   86: ifeq +39 -> 125
    //   89: getstatic 22	aucp:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: iconst_1
    ...
    //   105: aload_0
    //   106: getfield 51	aucp:jdField_a_of_type_Long	J
    ...
    //   129: aload_0
    //   130: iconst_2
    //   131: putfield 29	aucp:jdField_a_of_type_Int	I
    //   134: aload_0
    //   135: new 180	audb
    //   138: dup
    //   139: aload_0
    //   140: getfield 51	aucp:jdField_a_of_type_Long	J
    //   143: invokespecial 181	audb:<init>	(J)V
    //   146: putfield 150	aucp:jdField_a_of_type_Aucr	Laucr;
    //   149: goto -93 -> 56
    //   152: astore_2
    //   153: aload_0
    //   154: monitorexit
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Aucr != null)
    {
      ...
      return this.jdField_a_of_type_Aucr.a();
    }
  ...
  public void a(aucs paramaucs)
  {
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramaucs)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramaucs);
      }
      return;
    }
  }
  
  public void a(aucs paramaucs, boolean paramBoolean)
  {
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        if ((aucs)this.jdField_a_of_type_JavaUtilList.get(i) == paramaucs)
        {
          if (paramBoolean == true)
          {
            ...
            paramaucs = (aucs)this.jdField_a_of_type_JavaUtilList.remove(i);
            this.jdField_a_of_type_JavaUtilList.add(paramaucs);
      ...
      if (paramaucs != null)
      {
        ...
        aucs localaucs = (aucs)this.jdField_a_of_type_JavaUtilList.remove(i - 1);
        this.jdField_a_of_type_JavaUtilList.add(paramaucs);
        this.jdField_a_of_type_JavaUtilList.add(localaucs);
      }
      for (;;)
      {
  ...
  public boolean a(Bundle paramBundle)
  {
    ...
    String str1 = atvo.b(atut.a().c() + (String)localObject1);
    String str2 = atut.a().b() + (String)localObject1;
    ...
    return a(auck.a((String)localObject1), (Bundle)localObject2);
  }
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Aucr != null)
    {
      ...
      return this.jdField_a_of_type_Aucr.c();
    }
  ...
  public int c()
  {
    if (this.jdField_a_of_type_Aucr != null)
    {
      ...
      return this.jdField_a_of_type_Aucr.d();
    }
  ...
  public int d()
  {
    if (this.jdField_a_of_type_Aucr != null)
    {
      ...
      return this.jdField_a_of_type_Aucr.b();
    }
  ...
  public int e()
  {
    if (this.jdField_a_of_type_Aucr != null)
    {
      ...
      return this.jdField_a_of_type_Aucr.f();
    }
  ...
  {
    if (this.jdField_a_of_type_Aucr != null) {
      return this.jdField_a_of_type_Aucr.e();
    }
