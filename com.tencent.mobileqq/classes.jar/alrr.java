...
public class alrr
{
  ...
  {
    bdla.b(null, "dc00898", "", "", "0X80072C1", "0X80072C1", 0, 0, "", "", "", "");
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      paramString3 = ((apgu)localEntry.getValue()).a();
  ...
  public static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, apgv paramapgv)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("camera_type", paramString1);
    ...
    localHashMap.put("is_dynamic", VideoEnvironment.configParam.mIsDynamic + "");
    if ((paramapgv == null) || (paramapgv.jdField_a_of_type_ArrayOfLong == null) || (paramapgv.jdField_a_of_type_ArrayOfLong.length == 0)) {
      return;
    }
    localHashMap.put("cost_time", paramapgv.jdField_a_of_type_ArrayOfLong[((int)(paramapgv.jdField_a_of_type_ArrayOfLong.length * 0.5F))] + "");
    StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(null, "dynamic_adjustment_on_triggering", true, paramapgv.jdField_a_of_type_ArrayOfLong[((int)(paramapgv.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (String str = "0"; (!StringUtil.isEmpty(paramString1)) || (!aqmy.a()); str = "1")
    {
      bdla.b(null, "dc00898", "", "", "0X80072C3", "0X80072C3", 0, 0, str, paramString1, "", "");
      if (paramBoolean) {
        bdla.b(null, "dc00898", "", "", "0X80083B0", "0X80083B0", 0, 0, str, paramString1, "", "");
      }
      if (!StringUtil.isEmpty(paramString2)) {
        bdla.b(null, "dc00898", "", "", "0X80083B6", "0X80083B6", 0, 0, paramString1, "", paramString2, "");
      }
      return;
    }
    bdla.b(null, "dc00898", "", "", "0X80072C2", "0X80072C2", 0, 0, str, "", "", "");
  }
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2, long paramLong)
  {
    ...
    for (paramString1 = "beauty";; paramString1 = "nBeauty")
    {
      ...
      paramString2 = (apgu)jdField_a_of_type_JavaUtilMap.get(localObject);
      paramString1 = paramString2;
      if (paramString2 == null)
      {
        paramString1 = new apgu(2147483647);
  ...
  public static void l()
  {
    ...
    while (localIterator.hasNext()) {
      ((apgu)((Map.Entry)localIterator.next()).getValue()).a();
    }
    jdField_a_of_type_JavaLangString = "";
  }
}
