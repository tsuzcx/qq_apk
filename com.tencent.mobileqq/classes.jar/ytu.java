...
public class ytu
{
  public static bbuz a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, yui paramyui)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    int i = arrr.a(arso.a(paramItem.FileName));
    ...
    for (;;)
    {
      ...
      return a(paramQQAppInterface, paramyui, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      bool = false;
      break;
      label250:
  ...
  public static bbuz a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, yuk paramyuk)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramyuk, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static bbuz a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, yum paramyum)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    return a(paramQQAppInterface, paramLong, paramItem.FileName, paramItem.LocalFile, paramItem.ProgressTotal, paramItem.isFromAIO, paramItem.Md5, paramItem.Sha, paramItem.Sha3, paramItem.BusId, paramItem.mParentId, localBundle, paramyum);
  }
  
  public static bbuz a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, yub paramyub)
  {
    ...
    return a(paramQQAppInterface, paramyub, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4, null);
  }
  
  public static bbuz a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString3, int paramInt, String paramString4, Bundle paramBundle, yum paramyum)
  {
    ...
    for (paramInt = 5;; paramInt = 4)
    {
      ...
      return a(paramQQAppInterface, paramyum, paramString1.toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, paramBundle);
      localUploadFileReqBody.str_parent_folder_id.set(paramString4);
      break;
    }
  }
  
  public static bbuz a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, yum paramyum)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramyum);
  }
  
  private static bbuz a(QQAppInterface paramQQAppInterface, nac paramnac, byte[] paramArrayOfByte, String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
  ...
  private static String a(TroopFileTransferManager.Item paramItem)
  {
    try
    {
      ...
      Object localObject;
      if (xrg.c(paramItem.middleThumbnailFile)) {
      ...
      for (String str = "mid";; str = "larg")
      {
        ...
        return paramItem.strQRUrl;
        if (!xrg.c(paramItem.largeThumbnailFile)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, yua paramyua)
  {
    boolean bool;
    ...
    for (;;)
    {
      ...
      mzy.b(paramQQAppInterface, paramyua, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label343:
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, msg_ctrl.MsgCtrl paramMsgCtrl, yuj paramyuj)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mzy.b(paramQQAppInterface, paramyuj, paramMsgCtrl.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, paramBundle);
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, yuj paramyuj)
  {
    a(paramQQAppInterface, paramLong, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, null, paramyuj);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, Bundle paramBundle, yuh paramyuh)
  {
    ...
    mzy.b(paramQQAppInterface, paramyuh, paramString.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, paramBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, ytx paramytx)
  {
    ...
    mzy.b(paramQQAppInterface, paramytx, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, yue paramyue)
  {
    ...
    mzy.b(paramQQAppInterface, paramyue, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, yud paramyud)
  {
    ...
    mzy.b(paramQQAppInterface, paramyud, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, bbsa parambbsa, yul paramyul)
  {
    if ((paramLong == 0L) || (parambbsa == null)) {
      return;
    }
    ...
    localTransFileReqBody.uint32_bus_id.set(parambbsa.a);
    localTransFileReqBody.str_file_id.set(parambbsa.b);
    Bundle localBundle = new Bundle();
    localBundle.putLong("troopUin", paramLong);
    localBundle.putString("fileId", parambbsa.b);
    parambbsa = new oidb_0x6d9.ReqBody();
    parambbsa.trans_file_req.set(localTransFileReqBody);
    mzy.b(paramQQAppInterface, paramyul, parambbsa.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, yuj paramyuj)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return;
    }
    ...
    localObject = asqr.a(paramItem.LocalFile, paramItem.width, paramItem.height, (String)localObject);
    a(paramQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, paramItem.RandomNum, paramItem.width, paramItem.height, paramItem.duration, true, localBundle, (msg_ctrl.MsgCtrl)localObject, paramyuj);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, ytw paramytw)
  {
    ...
    mzy.b(paramQQAppInterface, paramytw, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, yug paramyug)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
    ...
    mzy.b(paramQQAppInterface, paramyug, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, yty paramyty)
  {
    ...
    mzy.b(paramQQAppInterface, paramyty, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, ytz paramytz)
  {
    if (QLog.isDevelopLevel()) {
    ...
    mzy.b(paramQQAppInterface, paramytz, localReqBody.toByteArray(), "OidbSvc.0x6d8_1", 1752, 2, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, yuc paramyuc)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("TroopFileProtocol", 4, "getFileList" + paramLong);
    }
    ...
    mzy.a(paramQQAppInterface, paramyuc, localReqBody.toByteArray(), "OidbSvc.0x6d8_3", 1752, 3, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, bbuz parambbuz)
  {
    if ((paramQQAppInterface == null) || (parambbuz == null)) {
      return;
    }
    paramQQAppInterface.getTroopFileProtoReqMgr().b(parambbuz);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, yuf paramyuf)
  {
    paramString1 = new bcky("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + bhsz.a(paramString4) + "&", "GET", new ytv(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramyuf), 1000, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, long paramLong1, TroopFileTransferManager.Item paramItem, long paramLong2, long paramLong3, yuh paramyuh)
  {
    ...
    for (;;)
    {
      ...
      mzy.b(paramQQAppInterface, paramyuh, localReqBody.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, (Bundle)localObject);
      return;
