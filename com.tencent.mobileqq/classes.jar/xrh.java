  ...
  extends ajfb
{
  ...
  xrk jdField_a_of_type_Xrk = null;
  ...
  public xrh(QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      this.jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(ThreadManager.getSubThreadLooper(), new xri(this));
      label95:
      this.jdField_a_of_type_Axvs = new xrj(this, ThreadManager.getSubThreadLooper());
      ...
      if (this.jdField_a_of_type_MqqOsMqqHandler != null)
      {
        ...
        this.jdField_a_of_type_Xrk = new xrk(this);
        ...
        BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Xrk, localIntentFilter);
  ...
  private xxi a()
  {
    ...
    try
    {
      localObject = bace.a(new File((String)localObject));
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = xxj.a((String)localObject);
        return localObject;
      }
    }
    catch (Throwable localThrowable)
  ...
  private void a(int paramInt, long paramLong, byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_Bgnj != null) {
      this.jdField_a_of_type_Bgnj.a(localBundle);
    }
  }
  ...
  private boolean b()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 180	xrh:jdField_a_of_type_Bgnj	Lbgnj;
    //   8: ifnonnull +80 -> 88
    //   11: aload_0
    //   12: ldc_w 354
    //   15: invokespecial 89	xrh:b	(Ljava/lang/String;)V
    //   18: invokestatic 360	java/lang/System:currentTimeMillis	()J
    //   21: lstore_2
    //   22: aload_0
    //   23: iconst_1
    //   24: putfield 362	xrh:jdField_a_of_type_Boolean	Z
    //   27: aload_0
    //   28: new 276	bgnj
    //   31: dup
    //   32: aload_0
    //   33: getfield 286	xrh:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   36: invokespecial 363	bgnj:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   39: putfield 180	xrh:jdField_a_of_type_Bgnj	Lbgnj;
    //   42: aload_0
    //   43: getfield 286	xrh:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   46: bipush 49
    //   48: invokevirtual 366	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajfb;
    //   51: pop
    ...
    //   81: invokespecial 89	xrh:b	(Ljava/lang/String;)V
    //   84: aload_0
    //   85: monitorexit
    //   86: iload_1
    //   87: ireturn
  ...
  public int a(long paramLong, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Bgnj == null);
      paramString = this.jdField_a_of_type_Bgnj.a(localBundle);
  ...
  public int a(long paramLong1, String paramString1, long paramLong2, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      paramString1 = this.jdField_a_of_type_Bgnj.a(localBundle);
  ...
  public long a()
  {
    ...
    localBundle = this.jdField_a_of_type_Bgnj.a(localBundle);
    if (localBundle != null) {}
  ...
  public DeviceInfo a(long paramLong)
  {
    ...
    localObject = this.jdField_a_of_type_Bgnj.a((Bundle)localObject);
    if (localObject == null) {
      return new DeviceInfo();
    }
  ...
  public DeviceInfo a(String paramString, int paramInt)
  {
    ...
    paramString = this.jdField_a_of_type_Bgnj.a((Bundle)localObject);
    if (paramString == null) {
      return null;
    }
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          i = 0;
          yds.a(null, "QFind_BleState", i, 0, 0);
          if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          i = 1;
          yds.a(null, "QFind_GPSState", i, 0, 0);
          if (!QLog.isColorLevel()) {
            break;
          }
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_Bgnj != null) {
            this.jdField_a_of_type_Bgnj.a(paramBundle);
          }
        } while (paramInt == 2);
        if (paramInt == 6)
        {
          a(l, i, ajjy.a(2131648415));
          return;
        }
      } while (paramInt == 7);
      if (paramInt == 8)
      {
        a(l, i, ajjy.a(2131648414));
        return;
      }
    } while (paramInt != 9);
    a(l, i, ajjy.a(2131648420));
  }
  ...
  public void a(long paramLong, AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Bgnj != null) {
          this.jdField_a_of_type_Bgnj.a(paramAbsStructMsg);
        }
        return;
        label417:
  ...
  public void a(Activity paramActivity, DeviceInfo paramDeviceInfo, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      bcec.a().a(ajjy.a(2131648423));
      return;
    }
    paramDeviceInfo.displayName = ydt.a(paramDeviceInfo);
    new ydh(paramActivity).a(paramDeviceInfo, paramBundle, paramBoolean);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      for (;;)
      {
        paramString = bace.a(new File(str));
  ...
  {
    b("startPlugin flag:" + this.e + " ipc:" + this.jdField_a_of_type_Bgnj);
    if (this.e != 1) {
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    ((Intent)localObject).putExtra("din", paramArrayOfByte.uint64_din.get());
    ((Intent)localObject).putExtra("uin", aynw.a(paramArrayOfByte.uint32_uin.get()));
    BaseApplicationImpl.getApplication().sendBroadcast((Intent)localObject, "com.tencent.smartdevice.permission.broadcast");
  }
  ...
  public void b()
  {
    b("startPlugin force flag:" + this.e + " ipc:" + this.jdField_a_of_type_Bgnj);
    if (b()) {
      b(false);
    }
  }
  ...
  public void b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Axvo.a(paramBundle);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    //   35: invokespecial 89	xrh:b	(Ljava/lang/String;)V
    //   38: iconst_1
    //   39: aload_0
    //   40: getfield 53	xrh:jdField_a_of_type_Int	I
    //   43: if_icmpeq +13 -> 56
    //   46: aload_0
    //   47: getfield 55	xrh:jdField_b_of_type_Int	I
    //   50: istore_2
    //   51: iconst_1
    //   52: iload_2
    //   53: if_icmpne +13 -> 66
    ...
    //   70: aload_0
    //   71: iconst_0
    //   72: putfield 53	xrh:jdField_a_of_type_Int	I
    //   75: aload_0
    //   76: iconst_0
    //   77: putfield 55	xrh:jdField_b_of_type_Int	I
    //   80: aload_0
    //   81: getfield 53	xrh:jdField_a_of_type_Int	I
    //   84: ifeq +11 -> 95
    //   87: iconst_3
    //   88: aload_0
    //   89: getfield 53	xrh:jdField_a_of_type_Int	I
    //   92: if_icmpne -36 -> 56
    //   95: aload_0
    //   96: getfield 286	xrh:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   99: ifnull -43 -> 56
    //   102: aload_0
    //   103: getfield 286	xrh:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   106: invokevirtual 101	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   109: ifnull -53 -> 56
    //   112: aload_0
    //   113: ldc_w 1407
    //   116: aload_0
    //   117: getfield 286	xrh:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   126: aload_0
    //   127: invokevirtual 1409	xrh:a	()[B
    //   130: ldc_w 568
    //   133: ldc_w 568
    //   136: invokespecial 1411	xrh:a	(IJ[BLjava/lang/String;Ljava/lang/String;)V
    //   139: aload_0
    //   140: iconst_1
    //   141: putfield 53	xrh:jdField_a_of_type_Int	I
    //   144: goto -88 -> 56
    //   147: astore_3
    //   148: aload_0
    //   149: monitorexit
  ...
  public void d()
  {
    if ((this.jdField_a_of_type_Boolean) && (2 == this.jdField_a_of_type_Int))
    {
      ...
      if (this.jdField_a_of_type_Bgnj != null) {
        this.jdField_a_of_type_Bgnj.a((Bundle)localObject);
      }
    }
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
  ...
  public void onDestroy()
  {
    ...
    super.onDestroy();
    if ((BaseApplicationImpl.getContext() != null) && (this.jdField_a_of_type_Xrk != null)) {}
    try
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Xrk);
      this.jdField_a_of_type_Xrk = null;
      if (this.jdField_a_of_type_MqqOsMqqHandler != null)
      {
      ...
      {
        this.jdField_a_of_type_Axvs.getFilter().clear();
        this.jdField_a_of_type_Axvs.removeCallbacksAndMessages(null);
        this.jdField_a_of_type_Axvo.b(this.jdField_a_of_type_Axvs);
        this.jdField_a_of_type_Axvs = null;
        this.jdField_a_of_type_Axvo.c();
        this.jdField_a_of_type_Axvo = null;
      }
      if (this.jdField_a_of_type_Bgnj != null)
      {
        this.jdField_a_of_type_Bgnj.a();
        this.jdField_a_of_type_Bgnj = null;
      }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bgnj.a((Bundle)localObject1);
      return;
