  ...
  implements bbls
{
  private void a(MessageHandler paramMessageHandler, byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = (amtp)paramMessageHandler.app.getBusinessHandler(35);
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          } while (!((bfbz)paramMessageHandler.app.getManager(48)).a((byte[])localObject2, i));
          bblf.a(paramMessageHandler.app.getMsgHandler(), l1, i, l2, j);
          return;
          if ((k != 16) && (k != 17) && (k != 20) && (k != 21)) {
            break;
          }
          localObject2 = new bblx(this);
          if (localObject1.length > 7)
          {
            bfdz localbfdz = (bfdz)paramMessageHandler.app.getManager(81);
            byte[] arrayOfByte = new byte[localObject1.length - 7];
            PkgTools.copyData(arrayOfByte, 0, (byte[])localObject1, 7, arrayOfByte.length);
            paramList.add(localbfdz.a(paramMessageHandler.app, arrayOfByte, i, paramMsg.msg_head.msg_time.get(), true, parambbkm.d, (bblx)localObject2));
          }
        } while (!((bblx)localObject2).a);
        bblf.a(paramMessageHandler.app.getMsgHandler(), l1, i, l2, j);
