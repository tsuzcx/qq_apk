  ...
  implements BusinessObserver
{
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if ((paramBoolean) && ((paramObject instanceof GetQzoneMusicInfoRsp)))
    {
      ...
      if ((ayos.a(this.a)) || (!paramObject.mMusicList.containsKey(ayos.a(this.a).g))) {
        break label101;
      }
      ayos.a(this.a).b = ((MusicInfo)paramObject.mMusicList.get(ayos.a(this.a).g)).sSongUrl;
      this.a.a(BaseApplicationImpl.getContext(), ayos.a(this.a));
    }
    for (;;)
    {
      return;
