  ...
  extends BaseAdapter
{
  ...
  public pth(Context paramContext, List<ReadInJoyDraftboxItem> paramList)
  {
  ...
  private URLDrawable.URLDrawableOptions a()
  {
    ...
    localURLDrawableOptions.mRequestWidth = bajq.b(100.0F);
    localURLDrawableOptions.mRequestHeight = bajq.b(100.0F);
  ...
  private URLDrawable a(HotPicData paramHotPicData)
  {
    ...
    if (paramHotPicData.getDataType() != 2)
    {
      ...
      localURLDrawableOptions.mRequestWidth = bajq.a(50.0F);
      localURLDrawableOptions.mRequestHeight = bajq.a(50.0F);
      if (paramHotPicData.getDataType() != 2) {
        break label69;
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131494340, null);
    }
    Object localObject2 = (TextView)paramViewGroup.findViewById(2131312320);
    MiddleBracketsTitleTextView localMiddleBracketsTitleTextView = (MiddleBracketsTitleTextView)paramViewGroup.findViewById(2131312318);
    paramView = (TextView)paramViewGroup.findViewById(2131312319);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131302929);
    TextView localTextView = (TextView)paramViewGroup.findViewById(2131312301);
    ((TextView)localObject2).setEditableFactory(axkn.a);
    localMiddleBracketsTitleTextView.setEditableFactory(axkn.a);
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size()))
    {
      ...
      paramView.setText(oby.a(localReadInJoyDraftboxItem.time, false));
      paramView = localReadInJoyDraftboxItem.title;
      if (localReadInJoyDraftboxItem.type == 3) {
        paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131652702);
      }
      ...
      if (localReadInJoyDraftboxItem.type == 2) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131652698) + ": " + paramView;
      }
      ((TextView)localObject2).setText(new axkd((CharSequence)localObject1, 7, 16));
      ...
      localMiddleBracketsTitleTextView.setText(new axkd(paramView, 7, 16));
    ...
    for (;;)
    {
      paramViewGroup.setOnClickListener(new pti(this, localReadInJoyDraftboxItem));
      localTextView.setOnClickListener(new ptj(this, localReadInJoyDraftboxItem, paramInt));
      paramViewGroup.setTag(-3, Integer.valueOf(bajq.a(66.0F)));
