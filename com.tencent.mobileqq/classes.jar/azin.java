...
public class azin
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, TextView paramTextView, @NonNull Friends paramFriends, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      paramQQAppInterface = aqvy.a(paramTextView.getPaint(), paramFriends, bhtq.a(200.0F));
    }
  ...
  public static void a(azlq paramazlq, View paramView)
  {
    ...
    if ((paramView instanceof Integer))
    {
      ...
      if (i == 2)
      {
        paramazlq = paramazlq.c().iterator();
        while (paramazlq.hasNext()) {
          azir.a("0X800AF40", ((Integer)paramazlq.next()).intValue(), "2");
        }
      }
      if (i == 1)
      {
        paramazlq = paramazlq.c().iterator();
        while (paramazlq.hasNext()) {
          azir.a("0X800B00F", ((Integer)paramazlq.next()).intValue(), "2");
        }
      }
    }
  }
  ...
  private static void a(Friends paramFriends1, byte[] paramArrayOfByte, @Nullable Friends paramFriends2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusUtil", 2, new Object[] { "parseExtOnlineBusinessInfo: invoked. ", azla.a(paramFriends1) });
        }
        return;
      }
  ...
  public static boolean a()
  {
    ...
    return (localarfp != null) && (localarfp.a != null) && (a(localarfp.a.a));
  }
  ...
  public static boolean a(int paramInt, Resources paramResources)
  {
    ...
    if (paramInt < 7)
    {
      ...
      i = 2;
      label36:
      i = agej.a(i * 64 + 62, paramResources);
      if (agej.a(64.0F, paramResources) * paramInt <= j - i) {
        break label114;
      }
    }
    label109:
  ...
  public static boolean a(azib paramazib)
  {
    if (paramazib == null) {}
    while ((paramazib.jdField_a_of_type_Long != 40001L) || (TextUtils.isEmpty(paramazib.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramazib.b))) {
      return false;
    }
    return true;
  }
      ...
      for (;;)
      {
        ...
        try
        {
          if (TextUtils.isEmpty(paramFriends)) {
            localObject2 = BaseApplicationImpl.getContext().getString(2131718346);
          }
        ...
        if (bhlg.a(paramFriends)) {
          break label181;
        }
        localObject1 = bhlg.c(paramFriends.getNetWorkType());
        break;
        label170:
        return localObject2;
        label176:
  ...
  public static boolean b(azib paramazib)
  {
    if (paramazib == null) {}
    while ((paramazib.jdField_a_of_type_Long != 40001L) || (TextUtils.isEmpty(paramazib.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramazib.b)) || (TextUtils.isEmpty(paramazib.c))) {
      return false;
    }
    return true;
  }
  ...
  {
    String str = azla.b(paramFriends);
    if (QLog.isColorLevel()) {
