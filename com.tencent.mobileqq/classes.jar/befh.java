  ...
  extends befe
{
  ...
  public befh(JSONObject paramJSONObject)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      while (i1 < paramJSONObject.length())
      {
        ...
        {
          localObject = new beff(l1, ((JSONObject)localObject).optString("name") + anni.a(2131713774), this.jdField_e_of_type_JavaLangString.replace("${bid}", String.valueOf(l1)));
  ...
  public static ArrayList<befh> a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      if (i1 < paramJSONArray.length()) {
        try
        {
          befh localbefh = new befh(paramJSONArray.optJSONObject(i1));
          if (localbefh != null) {
            localArrayList.add(new befh(paramJSONArray.optJSONObject(i1)));
          }
          i1 += 1;
        }
