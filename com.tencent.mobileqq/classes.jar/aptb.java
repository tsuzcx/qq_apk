...
public class aptb
{
  ...
  private ServerConfigObserver jdField_a_of_type_MqqObserverServerConfigObserver = new aptc(this);
  private boolean jdField_a_of_type_Boolean = true;
  private boolean b;
  
  public aptb(QQAppInterface paramQQAppInterface)
  {
  ...
  private Hashtable<String, ResourcePluginInfo> a()
  {
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692926);
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692107);
    localResourcePluginInfo.strResDesc = "";
    localResourcePluginInfo.strResURL = "";
    localResourcePluginInfo.sResSubType = 2;
    localResourcePluginInfo.cCanChangeState = 0;
  ...
  {
    aptb localaptb = paramQQAppInterface.getAboutConfig();
    Object localObject2 = paramResourcePluginInfo.strGotoUrl;
    Object localObject1 = "version=8.4.8.4810&appid=" + AppSetting.a() + "&QUA=" + QZoneHelper.getQUA();
    Object localObject3;
    ...
    {
      localObject3 = (String)localObject1 + "&adtag=4810";
    }
    if (paramResourcePluginInfo.strPkgName.equals("com.tencent.Feedback_5_8"))
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramResourcePluginInfo.isNew == 0)
          {
            ...
            ThreadManager.post(new AboutConfig.3(localaptb, paramResourcePluginInfo), 8, null, false);
          }
          return;
  ...
  public void a(ResourcePluginInfo paramResourcePluginInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	aptb:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   4: ifnull +76 -> 80
    //   7: aload_1
    //   8: ifnull +72 -> 80
    //   11: aload_0
    //   12: getfield 39	aptb:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   15: aload_1
    ...
    //   22: ifeq +58 -> 80
    //   25: aload_0
    //   26: getfield 39	aptb:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   29: aload_1
    ...
    //   56: aload_0
    //   57: getfield 29	aptb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
