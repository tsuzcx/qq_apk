  ...
  extends apsl
{
  ...
  public aptb(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Agor = new agor(this.jdField_a_of_type_JavaLangString, 30000L);
  }
  ...
  private void a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    apuj.a(paramLong2, paramLong3, new apth(this, paramLong1));
  }
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    bhsf.a(a(), paramString);
    if (paramString.equals("NavigateTo"))
    {
      paramString = a();
      if ((paramString != null) && (paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1)) {
        apuh.a(paramString, paramArrayOfVariantWrapper[0].GetString(), true, 0L, null, null, 3, this.jdField_a_of_type_JavaLangString, null);
      }
      return true;
    }
    ...
    if (localObject5 != null)
    {
      ...
      localObject4 = uuc.b(((BaseChatPie)localObject3).sessionInfo.curFriendUin);
      ...
      paramArrayOfVariantWrapper = (agnx)agnx.a(paramArrayOfVariantWrapper).get();
      if ((paramArrayOfVariantWrapper == null) || (!(paramArrayOfVariantWrapper instanceof agnw))) {
        break label7654;
      }
      localMessageForArkApp = (MessageForArkApp)((agnw)paramArrayOfVariantWrapper).jdField_a_of_type_JavaLangRefWeakReference.get();
      label399:
      if (!aptq.a(paramString, (String)localObject1, (JSONObject)localObject5, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString)) {
        break label592;
      }
      apyp.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
      ...
      else
      {
        ...
        {
          l1 = oix.a(localMessageForArkApp.ark_app_message.getAppIdFromMeta(), 0L);
          if (l1 != 0L) {
            break label583;
          }
          paramArrayOfVariantWrapper = "";
          label503:
          bdla.b(null, "dc00898", "", "", "0X800A86C", "0X800A86C", 0, 0, paramArrayOfVariantWrapper, "", "", "");
          paramArrayOfVariantWrapper = paramString;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      apyp.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
      return true;
      ...
      {
        if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.BROWSER"))
        {
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", this.jdField_a_of_type_JavaLangString, ",url=", nwo.b(paramString, new String[0]), ", isValid set=true" });
          j = 1;
          i = 2;
          label843:
          a();
          label847:
          aqbw.b(this.jdField_a_of_type_JavaLangString, paramString, k, i, agnx.c);
          apyp.b(a(), this.jdField_a_of_type_JavaLangString, paramString, 2);
          if (j != 0) {
            break label933;
          }
          QLog.d("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", nwo.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
          return false;
          i = 0;
          break;
        }
        ...
        for (;;)
        {
          ...
          catch (JSONException paramArrayOfVariantWrapper)
          {
            ...
            paramArrayOfVariantWrapper = String.valueOf(l1);
            continue;
            apuh.a(localActivity, paramString, true, 0L, null, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject4);
            continue;
          }
          if (!(localObject3 instanceof aido)) {
            continue;
          ...
          l1 = oix.a(localMessageForArkApp.ark_app_message.getAppIdFromMeta(), 0L);
          apuh.a(localActivity, paramString, true, l1, localMessageForArkApp, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject4);
          ...
          if (localMessageForArkApp.buildTypeAndTitle().isSdkShare)
          {
            ...
            paramArrayOfVariantWrapper = "";
            bdla.b(null, "dc00898", "", "", "0X800A869", "0X800A869", 0, 0, paramArrayOfVariantWrapper, "", "", "");
          }
          paramArrayOfVariantWrapper = paramString;
          break;
          paramVariantWrapper = paramString + "&" + paramArrayOfVariantWrapper;
      ...
      if (this.jdField_a_of_type_Long == 0L)
      {
        paramVariantWrapper = bhey.a(a(), localActivity, paramString);
        paramArrayOfVariantWrapper = paramString;
        if (paramVariantWrapper != null)
        {
          ...
          for (bool1 = true;; bool1 = false)
          {
            ...
            QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", this.jdField_a_of_type_JavaLangString, ",url=", nwo.b(paramString, new String[0]), ", isValid set=true" });
            i = 1;
            j = 2;
            aqbw.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, agnx.c);
            if (i == 0) {
              break label1645;
            }
          ...
          label1645:
          QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", nwo.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
          paramArrayOfVariantWrapper = paramString;
        }
      }
    }
    if (paramString.equals("OpenVideo"))
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ((((String)localObject1).equalsIgnoreCase("http")) || (((String)localObject1).equalsIgnoreCase("https"))))
        {
          ...
          paramVariantWrapper.SetBool(true);
          apuh.a(paramString, paramArrayOfVariantWrapper);
          apyp.a(a(), this.jdField_a_of_type_JavaLangString, "AIOArkOpenVideo", 1, 0, 0L, 0L, 0L, paramArrayOfVariantWrapper, "");
        }
        return true;
      }
    ...
    if (paramString.equals("Report"))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bdla.b(paramString, "CliOper", "", "", "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), paramVariantWrapper, paramArrayOfVariantWrapper, "");
          apyp.a(paramString, this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper, i);
          return true;
        }
        catch (Exception paramVariantWrapper)
        {
          bdla.b(paramString, "CliOper", "", "", "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
          continue;
        }
        label2069:
        bdla.b(paramString, "CliOper", "", "", "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
    ...
    if (paramString.equals("ReportEx"))
    {
      ...
      if (paramVariantWrapper.equals("898")) {
        try
        {
          ...
          bdla.b(null, "dc00898", "", (String)localObject1, paramArrayOfVariantWrapper, paramVariantWrapper, i, j, k, Integer.toString(m), Integer.toString(n), (String)localObject2, (String)localObject3);
          return true;
        }
        catch (JSONException paramArrayOfVariantWrapper)
        {
    ...
    if (paramString.equals("GetNickName"))
    {
      ...
      for (paramString = paramArrayOfVariantWrapper[0].GetString();; paramString = ((QQAppInterface)localObject2).getCurrentAccountUin())
      {
        ...
        {
          localObject1 = null;
          if (!TextUtils.isEmpty(agnx.jdField_a_of_type_JavaLangString)) {
            localObject1 = ContactUtils.getTroopMemberName((QQAppInterface)localObject2, agnx.jdField_a_of_type_JavaLangString, paramString);
          }
      ...
      label2845:
      paramString = apuj.a(paramString);
    ...
    if (paramString.equals("GetContainerInfo"))
    {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsView()))
      {
        ...
        paramString = (agnx)agnx.a(paramString).get();
        if ((paramString == null) || (!(paramString instanceof agnw))) {
          break label7610;
        }
        paramArrayOfVariantWrapper = ((agnw)paramString).a();
        paramString = paramArrayOfVariantWrapper;
        if (paramArrayOfVariantWrapper == null) {
          paramString = a();
        }
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(paramString.curFriendUin)) {
          if (!nty.a().a(paramString.curFriendUin)) {
            break label3277;
          }
        }
        label3277:
    ...
    else
    {
      ...
      {
        paramVariantWrapper.CreateObject("DataRequest", new agpl(a(), this.jdField_a_of_type_JavaLangString));
        return true;
      }
      if (paramString.equals("GetPerformance"))
      {
        ...
        for (;;)
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            paramArrayOfVariantWrapper = agnw.a(paramString);
      ...
      {
        if ((this.jdField_a_of_type_Agor == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1) || (paramArrayOfVariantWrapper[0] == null) || (!paramArrayOfVariantWrapper[0].IsFunction())) {
          return false;
        }
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Agor.b(new aptc(this, l1));
        return true;
      }
      if (paramString.equals("WatchPosition"))
      {
        ...
        l1 = a(paramArrayOfVariantWrapper[0].Copy());
        this.jdField_a_of_type_Agor.a(new apte(this, l1));
        return true;
      }
      ...
      if (paramString.equals("GetCurrentAddress"))
      {
        ...
        l1 = a(paramArrayOfVariantWrapper[0].Copy());
        this.jdField_a_of_type_Agor.a(new apti(this, l1), true);
        return true;
      }
      if (paramString.equals("SendMessage"))
      {
        ...
        do
        {
          try
          {
            ...
            if (TextUtils.isEmpty(((ArkAppMessage)localObject2).promptText)) {
              ((ArkAppMessage)localObject2).promptText = String.format(anvx.a(2131700143), new Object[] { ((ArkAppMessage)localObject2).appDesc });
            }
            ...
            if (bool1)
            {
              if (paramString != null)
              {
                admh.b(a(), paramString, (ArkAppMessage)localObject2);
                if (QLog.isColorLevel()) {
        ...
        if (bool1)
        {
          ...
          paramString = bcsa.a(a(), a().getCurrentUin(), paramString.curFriendUin, paramString.troopUin, paramString.curType, (byte)1, (byte)0, (short)0, paramVariantWrapper);
      ...
      else
      {
        if (paramString.equals("GetPskeyAsync"))
        {
          ...
          apuj.a(paramArrayOfVariantWrapper[0].GetString(), new aptj(this, a(paramArrayOfVariantWrapper[1].Copy())));
          return true;
        }
        if (paramString.equals("Login"))
        {
          if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.LOGIN"))
          {
          ...
          for (;;)
          {
            try
            {
              ...
              if (paramString == null)
              {
                ...
                apsm.a(paramString, this.jdField_a_of_type_JavaLangString, "ark_authority_api_login", BaseApplicationImpl.getContext().getString(2131690154), new aptk(this, l2, paramString, l1));
                return true;
              }
            }
        ...
        {
          if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.USER_INFORMATION"))
          {
          ...
          {
            apsm.a(paramString, this.jdField_a_of_type_JavaLangString, "ark_authority_api_user_info", BaseApplicationImpl.getContext().getString(2131690155), new aptl(this, l1, paramString));
            return true;
          }
        }
        if (paramString.equals("TestGetJson")) {
        ...
        {
          if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.OPENVIEW")) {
            return false;
          }
        ...
        {
          if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.SHARE")) {
            return false;
          }
        ...
        {
          if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.STATUSBAR")) {
            return false;
          }
            ...
            for (;;)
            {
              ...
              if (localObject1 != null)
              {
                ...
                if (((aqys)localObject1).a() != null) {
                  paramString = ((aqys)localObject1).a().b;
                }
              }
              localObject1 = a();
              paramArrayOfVariantWrapper = paramString;
              if (TextUtils.isEmpty(paramString))
              {
                paramArrayOfVariantWrapper = paramString;
                if (localObject1 != null) {
                  paramArrayOfVariantWrapper = ((Activity)localObject1).getString(2131690193);
                }
              }
      ...
      else if (paramString.equals("GetNickNameByView"))
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (l2 != 0L)
          {
            ...
            paramString = (agnx)agnx.a(paramString).get();
            if (!(paramString instanceof agnw)) {
              break label7576;
            }
            paramArrayOfVariantWrapper = ((agnw)paramString).a();
            paramString = paramArrayOfVariantWrapper;
        ...
        else
        {
          ...
          paramVariantWrapper.SetString(apuj.a(paramString, l2));
          return true;
        }
      }
      else
      {
        if (paramString.equals("GetAppInfo"))
        {
          ...
          try
          {
            ...
            ((JSONObject)localObject1).put("name", BaseApplicationImpl.getApplication().getString(2131690119));
            paramArrayOfVariantWrapper = DeviceInfoUtil.getQQVersion();
            paramString = paramArrayOfVariantWrapper;
            if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
              paramString = "8.4.10";
        ...
        if (paramString.equals("SubscribePublicAccount"))
        {
          ...
          try
          {
            ...
            if ((int)paramArrayOfVariantWrapper[1].GetDouble() == 0) {
              zzk.a(BaseApplicationImpl.getContext(), paramString, new aptf(this, l1));
            } else {
              zzk.c(BaseApplicationImpl.getContext(), paramString, new aptg(this, l1));
            }
          }
          catch (Exception paramString)
          {
  ...
  public void a(List<apwm> paramList)
  {
    super.a(paramList);
    a("OpenUrl", 1L, 500L);
  ...
  protected apsr[] a()
  {
    return new apsr[] { new apto(null), new aptn(null), new aptm(null) };
  }
}
