  ...
  implements Manager, wnt
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = wnu.a("StorySvc.video_config_get");
    jdField_b_of_type_JavaLangString = wnu.a("StorySvc.video_config_set");
    jdField_c_of_type_JavaLangString = wnu.a("StorySvc.video_get_user_mask_list");
    jdField_d_of_type_JavaLangString = wnu.a("StorySvc.video_set_user_mask");
    jdField_e_of_type_JavaLangString = wnu.a("StorySvc.video_get_user_mask_states");
    jdField_f_of_type_JavaLangString = wnu.a("StorySvc.video_show_video_list");
  }
  
  public wjb(AppInterface paramAppInterface)
  {
  ...
  public List<QQStoryUserInfo> a(boolean paramBoolean)
  {
    ...
    {
      Bosses.get().postJob(new wjc(this, "QQStoryManager", paramBoolean));
      return localList;
  ...
  public void a()
  {
    ...
    b(bhsi.h(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()));
    this.jdField_a_of_type_Wrs = new wrs(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  }
