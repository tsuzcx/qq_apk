  ...
  extends WebViewPlugin
{
  ...
  protected ascz a;
  private bika jdField_a_of_type_Bika;
  private bikk jdField_a_of_type_Bikk;
  ...
  public avzf()
  {
    this.jdField_a_of_type_Ascz = new avzg(this);
  ...
  private void a(String paramString)
  {
    ...
    do
    {
      ...
      str1 = nwo.b(paramString);
      QLog.e("DataApiPlugin", 1, "can not find uin from " + nwo.b(paramString, new String[0]) + ", dump cookie: " + nwo.c((String)localObject, new String[0]));
    ...
    QLog.i("DataApiPlugin", 2, "set uin cookie for host " + str1 + ", cookie : " + nwo.c((String)localObject, new String[0]));
  }
  ...
  private void a(String paramString, String[] paramArrayOfString)
  {
    ...
    long l = 0L;
    String str = null;
    if ((this.jdField_a_of_type_Bikk != null) && (this.jdField_a_of_type_Biko != null))
    {
      i = this.jdField_a_of_type_Bikk.a();
      l = this.jdField_a_of_type_Biko.getmClickTime();
    }
    try
    {
      ...
      if ((j != 12) && (j != 13))
      {
        ...
        if ((i < j) && (this.jdField_a_of_type_Bikm != null))
        {
          if (QLog.isColorLevel()) {
            QLog.d("QQBrowser_report", 2, "try report web status, " + paramArrayOfString + ", step: " + j + ", stepTime: " + (System.currentTimeMillis() - l) + ", totalTime: " + (System.currentTimeMillis() - l) + ", \n " + this.jdField_a_of_type_Bikm.getCurrentUrl());
          }
          if (this.jdField_a_of_type_Bikk == null) {
            break label305;
          }
          this.jdField_a_of_type_Bikk.a(j);
          this.jdField_a_of_type_Bikk.a(System.currentTimeMillis());
        }
        label232:
        while (str == null)
        {
          ...
          return;
          paramString = (bihv)super.getBrowserComponent(-2);
          str = paramString;
          if (paramString == null) {
            break;
          }
      ...
      for (;;)
      {
        ...
        str.a.a(this.jdField_a_of_type_Bikm.getCurrentUrl());
        break label232;
        if (j != 12) {
          break label299;
        }
  ...
  private void c(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      QLog.e("DataApiPlugin", 1, "can not find p_uin from " + nwo.b(paramString1, new String[0]) + ", dump cookie: " + nwo.c((String)localObject, new String[0]));
      if (this.jdField_a_of_type_ComTencentSmttSdkCookieManager == null)
      {
        this.jdField_a_of_type_ComTencentSmttSdkCookieManager = CookieManager.getInstance();
        this.jdField_a_of_type_ComTencentSmttSdkCookieManager.setAcceptCookie(true);
    ...
    QLog.i("DataApiPlugin", 2, "set p_uin cookie for host " + paramString2 + ", cookie: " + nwo.c((String)localObject, new String[0]));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      str1 = bhpv.a(this.mRuntime.a(), "ticketInterval");
      ...
      if (!this.mRuntime.a().isLogin())
      {
        ...
        localJSONObject.put("message", anvx.a(2131702220));
    ...
    if ("skey".equals(str4))
    {
      ...
      if (System.currentTimeMillis() - l > i * 1000)
      {
        ...
        localEditor.commit();
        i = j;
        if (!this.jdField_a_of_type_Nro.a(paramString2)) {
          break label1006;
        }
        i = 4096;
        break label1006;
    ...
    for (;;)
    {
      ...
      {
        localJSONObject.put("result", -2);
        localJSONObject.put("message", anvx.a(2131702222));
        callJs(str2, new String[] { localJSONObject.toString() });
        return;
        localJSONObject.put("result", 1);
        localJSONObject.put("message", anvx.a(2131702221));
        callJs(str2, new String[] { localJSONObject.toString() });
        return;
        if ("pskey".equals(str4))
        {
          str1 = this.jdField_a_of_type_Nro.d(paramString2);
          ...
          localJSONObject.put("result", 1);
          localJSONObject.put("message", anvx.a(2131702223));
          callJs(str2, new String[] { localJSONObject.toString() });
          return;
        }
        ...
        {
          localObject1 = this.jdField_a_of_type_Nro.e(paramString2);
          ...
          {
            localJSONObject.put("result", 1);
            localJSONObject.put("message", anvx.a(2131702224));
            callJs(str2, new String[] { localJSONObject.toString() });
          }
        }
      }
      else
      {
        ...
        ((WtloginHelper)localObject1).SetListener(new avzh(this, paramString2, str2, str1, paramString1));
  ...
  void a(String paramString1, WUserSigInfo paramWUserSigInfo, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    String str = nwo.a(paramString1, 1);
    Object localObject2;
    Object localObject3;
    Object localObject1;
    if ((paramInt & 0x1000) != 0)
    {
      ...
      QLog.i("DataApiPlugin", 1, nwo.c("skey=" + (String)localObject1, new String[0]));
      label154:
      i = j;
      if (localObject3 != null)
      {
  ...
  public boolean handleJsRequest(com.tencent.mobileqq.webview.swift.JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    //   43: astore 11
    //   45: aload_0
    //   46: getfield 36	avzf:mRuntime	Lbifw;
    //   49: invokevirtual 523	bifw:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    ...
    //   70: ifeq +5003 -> 5073
    //   73: aload 5
    //   75: invokestatic 537	nuz:c	(Ljava/lang/String;)Ljava/lang/String;
    //   78: astore 5
    //   80: aload_0
    //   81: getfield 36	avzf:mRuntime	Lbifw;
    //   84: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    //   87: astore 17
    //   89: aload 5
    ...
    //   122: ldc_w 539
    //   125: aastore
    //   126: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   129: iconst_1
    //   130: ireturn
    //   131: aload_0
    //   132: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   135: ifnonnull +10 -> 145
    //   138: aload_0
    //   139: invokestatic 337	nro:a	()Lnro;
    //   142: putfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   145: aload_0
    //   146: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   149: aload 5
    //   151: invokevirtual 540	nro:a	(Ljava/lang/String;)Ljava/lang/String;
    //   154: invokestatic 47	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   157: ifne +915 -> 1072
    //   160: iconst_1
    //   161: istore 6
    //   163: aload_0
    //   164: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   167: aload 5
    //   169: invokevirtual 371	nro:a	(Ljava/lang/String;)Z
    //   172: istore 9
    //   174: aload_0
    //   175: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   178: aload 5
    //   180: invokevirtual 543	nro:f	(Ljava/lang/String;)Ljava/lang/String;
    //   183: astore 13
    //   185: aload_0
    //   186: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   189: aload 5
    //   191: invokevirtual 394	nro:e	(Ljava/lang/String;)Ljava/lang/String;
    //   194: astore 16
    //   196: aload_0
    //   197: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   200: aload 5
    //   202: invokevirtual 377	nro:d	(Ljava/lang/String;)Ljava/lang/String;
    //   205: astore 18
    //   207: aload 17
    //   209: iconst_2
    ...
    //   481: aload_0
    //   482: aload 5
    //   484: invokespecial 482	avzf:a	(Ljava/lang/String;)V
    //   487: aload 5
    //   489: invokestatic 83	nwo:b	(Ljava/lang/String;)Ljava/lang/String;
    //   492: astore_1
    //   493: aload_0
    //   494: getfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    ...
    //   504: putfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    //   507: aload_0
    //   508: getfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    //   511: iconst_1
    ...
    //   560: astore_1
    //   561: aload_0
    //   562: getfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    //   565: aload 5
    //   567: aload_1
    ...
    //   598: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   616: invokestatic 97	nwo:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   637: aload 5
    //   639: aload 18
    //   641: invokespecial 507	avzf:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   644: aload 14
    //   646: aload 15
    //   648: aload 18
    ...
    //   709: astore_1
    //   710: aload_0
    //   711: getfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    //   714: aload 5
    //   716: aload_1
    ...
    //   747: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   765: invokestatic 97	nwo:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   846: astore_1
    //   847: aload_0
    //   848: getfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    //   851: aload 5
    //   853: aload_1
    ...
    //   884: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   902: invokestatic 97	nwo:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   976: astore_1
    //   977: aload_0
    //   978: getfield 113	avzf:jdField_a_of_type_ComTencentSmttSdkCookieManager	Lcom/tencent/smtt/sdk/CookieManager;
    //   981: aload 5
    //   983: aload_1
    ...
    //   1014: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   1032: invokestatic 97	nwo:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   1066: aastore
    //   1067: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1070: iconst_1
    //   1071: ireturn
    //   1072: iconst_0
    //   1073: istore 6
    ...
    //   1181: aaload
    //   1182: aload_0
    //   1183: getfield 36	avzf:mRuntime	Lbifw;
    //   1186: invokevirtual 523	bifw:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   1189: invokevirtual 528	com/tencent/biz/pubaccount/CustomWebView:getUrl	()Ljava/lang/String;
    //   1192: invokespecial 659	com/tencent/mobileqq/jsp/DataApiPlugin$2:<init>	(Lavzf;Ljava/lang/String;Ljava/lang/String;)V
    //   1195: bipush 8
    //   1197: aconst_null
    //   1198: iconst_1
    ...
    //   1213: ifeq +259 -> 1472
    //   1216: aload_0
    //   1217: getfield 36	avzf:mRuntime	Lbifw;
    //   1220: invokevirtual 670	bifw:a	()Landroid/app/Activity;
    ...
    //   1244: astore_2
    //   1245: aload_0
    //   1246: getfield 36	avzf:mRuntime	Lbifw;
    //   1249: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    ...
    //   1320: aastore
    //   1321: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1324: goto -254 -> 1070
    //   1327: astore_1
    ...
    //   1509: aload_2
    //   1510: aload_0
    //   1511: getfield 36	avzf:mRuntime	Lbifw;
    //   1514: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    ...
    //   1551: aload_1
    //   1552: aload_0
    //   1553: getfield 24	avzf:jdField_a_of_type_Ascz	Lascz;
    //   1556: getfield 729	ascz:key	I
    //   1559: aload_3
    //   1560: invokestatic 734	asdd:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   1563: astore_1
    //   1564: invokestatic 739	ashz:a	()Lashz;
    //   1567: aload_1
    //   1568: invokevirtual 742	ashz:a	(Landroid/os/Bundle;)V
    //   1571: goto -501 -> 1070
    //   1574: astore_1
    //   1575: aload_1
    ...
    //   1656: aastore
    //   1657: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1660: iconst_1
    //   1661: ireturn
    //   1662: aconst_null
    //   1663: astore_1
    //   1664: aload_0
    //   1665: getfield 36	avzf:mRuntime	Lbifw;
    //   1668: invokevirtual 670	bifw:a	()Landroid/app/Activity;
    //   1671: astore_3
    //   1672: aload_3
    //   1673: ifnull +14 -> 1687
    //   1676: aload_3
    ...
    //   1703: aload_1
    //   1704: aastore
    //   1705: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1708: goto -638 -> 1070
    //   1711: astore_1
    //   1712: aload_1
    ...
    //   1716: goto -646 -> 1070
    //   1719: aload_1
    //   1720: invokestatic 757	nwo:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1723: astore_1
    //   1724: goto -29 -> 1695
    //   1727: ldc_w 759
    //   1730: aload 4
    ...
    //   1817: ldc_w 775
    //   1820: aastore
    //   1821: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1824: iconst_1
    //   1825: ireturn
    //   1826: aload_1
    ...
    //   1841: ldc_w 777
    //   1844: aastore
    //   1845: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1848: goto -778 -> 1070
    //   1851: astore_2
    //   1852: aconst_null
    //   1853: astore_1
    ...
    //   1943: iconst_0
    //   1944: aload_1
    //   1945: invokestatic 757	nwo:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1948: aastore
    //   1949: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   1952: goto -882 -> 1070
    //   1955: astore_1
    //   1956: ldc 85
    //   1958: iconst_1
    ...
    //   2076: ifne +102 -> 2178
    //   2079: aload_0
    //   2080: getfield 36	avzf:mRuntime	Lbifw;
    //   2083: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    //   2086: astore_1
    //   2087: aload_1
    //   2088: instanceof 803
    //   2091: ifeq +2953 -> 5044
    ...
    //   2101: aload_3
    //   2102: iload 9
    //   2104: invokestatic 808	bdka:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Z)V
    //   2107: aload 5
    //   2109: ldc_w 293
    //   2112: iconst_0
    ...
    //   2151: aastore
    //   2152: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   2155: goto -1085 -> 1070
    //   2158: astore_1
    ...
    //   2248: astore_1
    //   2249: aload_0
    //   2250: getfield 36	avzf:mRuntime	Lbifw;
    //   2253: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    //   2256: astore_2
    //   2257: ldc_w 822
    //   2260: aload_3
    ...
    //   2436: aload 15
    //   2438: aload 16
    //   2440: invokestatic 861	bdla:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   2443: goto -1373 -> 1070
    //   2446: astore_1
    ...
    //   2486: aload 15
    //   2488: aload 16
    //   2490: invokestatic 864	bdla:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   2493: goto -1423 -> 1070
    //   2496: ldc_w 866
    //   2499: aload_3
    ...
    //   2768: aload_1
    //   2769: aload_0
    //   2770: getfield 24	avzf:jdField_a_of_type_Ascz	Lascz;
    //   2773: getfield 729	ascz:key	I
    //   2776: aload_3
    //   2777: invokestatic 734	asdd:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   2780: astore_1
    //   2781: invokestatic 739	ashz:a	()Lashz;
    //   2784: aload_1
    //   2785: invokevirtual 742	ashz:a	(Landroid/os/Bundle;)V
    //   2788: goto -1718 -> 1070
    //   2791: astore_1
    ...
    //   2831: ldc 123
    //   2833: aload_0
    //   2834: getfield 36	avzf:mRuntime	Lbifw;
    //   2837: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    ...
    //   2945: aastore
    //   2946: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   2949: goto -1879 -> 1070
    //   2952: astore_1
    ...
    //   3047: astore 4
    //   3049: aload_0
    //   3050: getfield 36	avzf:mRuntime	Lbifw;
    //   3053: invokevirtual 41	bifw:a	()Lcom/tencent/common/app/AppInterface;
    //   3056: astore_2
    //   3057: aload_2
    ...
    //   3396: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   3407: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   3418: invokestatic 102	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   3436: invokestatic 97	nwo:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   3493: aastore
    //   3494: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   3497: goto -2427 -> 1070
    //   3500: astore_1
    ...
    //   3532: aload_2
    //   3533: aload 5
    //   3535: invokespecial 958	avzf:a	(Ljava/lang/String;[Ljava/lang/String;)V
    //   3538: goto -2468 -> 1070
    //   3541: ldc_w 960
    //   3544: aload 4
    ...
    //   3586: aload_2
    //   3587: astore_1
    //   3588: invokestatic 739	ashz:a	()Lashz;
    //   3591: invokevirtual 962	ashz:a	()Z
    //   3594: ifeq -2524 -> 1070
    //   3597: aload_2
    //   3598: astore_1
    ...
    //   3623: aload_2
    //   3624: aload_0
    //   3625: getfield 24	avzf:jdField_a_of_type_Ascz	Lascz;
    //   3628: getfield 729	ascz:key	I
    //   3631: aload 4
    //   3633: invokestatic 734	asdd:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   3636: astore_3
    //   3637: aload_2
    //   3638: astore_1
    //   3639: invokestatic 739	ashz:a	()Lashz;
    //   3642: aload_3
    //   3643: invokevirtual 742	ashz:a	(Landroid/os/Bundle;)V
    //   3646: goto -2576 -> 1070
    //   3649: astore_2
    //   3650: aload_1
    ...
    //   3679: aastore
    //   3680: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   3683: goto -2613 -> 1070
    //   3686: ldc_w 968
    //   3689: aload 4
    ...
    //   3722: ifeq +24 -> 3746
    //   3725: aload_0
    //   3726: getfield 36	avzf:mRuntime	Lbifw;
    //   3729: invokevirtual 670	bifw:a	()Landroid/app/Activity;
    //   3732: astore_2
    //   3733: aload_2
    //   3734: ifnull +12 -> 3746
    //   3737: aload_2
    ...
    //   3798: aload_0
    //   3799: getfield 36	avzf:mRuntime	Lbifw;
    //   3802: invokevirtual 670	bifw:a	()Landroid/app/Activity;
    //   3805: astore_1
    //   3806: aload_1
    ...
    //   3875: astore_1
    //   3876: aload_0
    //   3877: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   3880: ifnonnull +10 -> 3890
    //   3883: aload_0
    //   3884: invokestatic 337	nro:a	()Lnro;
    //   3887: putfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   3890: iconst_0
    //   3891: istore 10
    //   3893: iload 10
    //   3895: istore 9
    ...
    //   3961: astore_3
    //   3962: aload_0
    //   3963: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   3966: aload_1
    //   3967: aload_3
    //   3968: invokevirtual 998	nro:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   3971: istore 9
    //   3973: iload 9
    //   3975: ifeq +228 -> 4203
    //   3978: ldc_w 1000
    ...
    //   3990: aload_1
    //   3991: aastore
    //   3992: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   3995: goto -2925 -> 1070
    //   3998: astore_1
    ...
    //   4026: ifeq +16 -> 4042
    //   4029: aload_0
    //   4030: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   4033: aload_1
    //   4034: invokevirtual 371	nro:a	(Ljava/lang/String;)Z
    //   4037: istore 9
    //   4039: goto -66 -> 3973
    //   4042: ldc_w 1004
    //   4045: aload 4
    ...
    //   4050: ifeq +23 -> 4073
    //   4053: aload_0
    //   4054: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   4057: aload_1
    //   4058: invokevirtual 540	nro:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   4081: ifeq +23 -> 4104
    //   4084: aload_0
    //   4085: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   4088: aload_1
    //   4089: invokevirtual 377	nro:d	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   4122: astore_3
    //   4123: aload_0
    //   4124: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   4127: aload_1
    //   4128: aload_3
    //   4129: invokevirtual 1008	nro:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   4132: istore 9
    //   4134: goto -161 -> 3973
    //   4137: ldc_w 392
    //   4140: aload 4
    ...
    //   4145: ifeq +23 -> 4168
    //   4148: aload_0
    //   4149: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   4152: aload_1
    //   4153: invokevirtual 394	nro:e	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   4180: ifeq -207 -> 3973
    //   4183: aload_0
    //   4184: getfield 332	avzf:jdField_a_of_type_Nro	Lnro;
    //   4187: aload_1
    //   4188: invokevirtual 543	nro:f	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   4241: istore 9
    //   4243: aload_0
    //   4244: getfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4247: ifnonnull +17 -> 4264
    //   4250: aload_0
    //   4251: invokestatic 1021	aady:a	()Laady;
    //   4254: putfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4257: aload_0
    //   4258: getfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4261: invokevirtual 1023	aady:a	()V
    //   4264: aload_0
    //   4265: getfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4268: iload 9
    //   4270: invokevirtual 1025	aady:a	(Z)V
    ...
    //   4391: aload_0
    //   4392: getfield 183	avzf:jdField_a_of_type_Bikm	Lbikm;
    ...
    //   4468: invokevirtual 1061	aatc:a	(III)V
    //   4471: goto -3401 -> 1070
    //   4474: astore_1
    //   4475: aload_1
    ...
    //   4568: ifne -3498 -> 1070
    //   4571: aload_2
    //   4572: invokestatic 1070	axqj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   4575: astore_2
    ...
    //   4605: aastore
    //   4606: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   4609: goto -3539 -> 1070
    //   4612: astore_1
    //   4613: aload_1
    ...
    //   4706: ifne -3636 -> 1070
    //   4709: aload_2
    //   4710: invokestatic 1079	axqj:b	(Ljava/lang/String;)Ljava/lang/String;
    //   4713: astore_2
    ...
    //   4743: aastore
    //   4744: invokevirtual 230	avzf:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   4747: goto -3677 -> 1070
    //   4750: astore_1
    //   4751: aload_1
    ...
    //   4786: astore_1
    //   4787: aload_0
    //   4788: getfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4791: ifnonnull +17 -> 4808
    //   4794: aload_0
    //   4795: invokestatic 1021	aady:a	()Laady;
    //   4798: putfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4801: aload_0
    //   4802: getfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4805: invokevirtual 1023	aady:a	()V
    //   4808: aload_0
    //   4809: getfield 1016	avzf:jdField_a_of_type_Aady	Laady;
    //   4812: iconst_1
    //   4813: aload_1
    //   4814: invokevirtual 1088	aady:a	(ZLjava/lang/String;)V
    ...
    //   4883: ifeq -3813 -> 1070
    //   4886: aload_0
    //   4887: getfield 36	avzf:mRuntime	Lbifw;
    //   4890: invokevirtual 670	bifw:a	()Landroid/app/Activity;
    //   4893: astore_1
    //   4894: aload_1
  ...
  public void onCreate()
  {
    ...
    if ((localbifb != null) && ((localbifb instanceof bikk))) {
      this.jdField_a_of_type_Bikk = ((bikk)localbifb);
    }
