...
public class bjjp
{
  ...
  public static void a(Context paramContext, DownloadInfo paramDownloadInfo)
  {
    ...
    {
      return;
      bdmt.a().addDownloadURL(paramDownloadInfo.jdField_d_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramDownloadInfo))
      {
        ...
        {
          bdla.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
          if (!QLog.isColorLevel()) {
            break label1159;
          }
      ...
      for (paramContext = (String)localHashMap.get("Stack1");; paramContext = "")
      {
        bdla.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
        break label598;
        label1159:
        break;
      }
  ...
  public static void a(Context paramContext, WadlParams paramWadlParams)
  {
    ...
    bdmt.a().addDownloadURL(paramWadlParams.e);
    HashMap localHashMap = new HashMap();
