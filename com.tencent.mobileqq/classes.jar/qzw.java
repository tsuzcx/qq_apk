...
public class qzw
{
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, FastWebActivity paramFastWebActivity, JSONObject paramJSONObject, List<BaseData> paramList, ArrayList<String> paramArrayList)
  {
    ...
    try
    {
          ...
          if (bool) {
            try
            {
              ...
              if (((ProteusItemData)localObject).s == 2) {
                paramArrayList.add(obz.f(((ProteusItemData)localObject).b.getString("articleImageUrl")));
              }
            }
      ...
      azcm.a(paramFastWebActivity, paramArrayList.indexOf(obz.f(paramJSONObject)), paramArrayList, null, null, false, true, "4", 1000, null, null, null, null, "", true);
    }
    ...
    {
      raz.a(paramArticleInfo, "0X8008996", obz.a(paramFastWebActivity, paramArticleInfo, 0, paramFastWebArticleInfo).toString());
      return;
    }
  }
