...
public class qzw
{
  ...
  private pfu jdField_a_of_type_Pfu;
  ...
  public qzw(raw paramraw, List<VideoInfo> paramList, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, Handler paramHandler)
  {
    ...
    ors.a().getManager(163);
    this.jdField_a_of_type_Pfu = new qzx(this);
  }
  ...
  private VideoInfo a(AdvertisementInfo paramAdvertisementInfo, boolean paramBoolean)
  {
    ...
    localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo = noy.a(paramAdvertisementInfo);
    ...
    try
    {
      ...
      {
        localObject = ors.a(paramAdvertisementInfo.mJsonVideoList, paramAdvertisementInfo);
      ...
      if (paramAdvertisementInfo.mVideoCoverUrl != null)
      {
        ...
        localVideoInfo.p = paramAdvertisementInfo.mAdVideoUrl;
        ...
        localVideoInfo.n = paramAdvertisementInfo.mAdCorporateLogo;
        if (TextUtils.isEmpty(localVideoInfo.l)) {
          localVideoInfo.jdField_a_of_type_JavaLangString = localVideoInfo.p;
        }
        if (paramBoolean)
        {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          label394:
          localVideoInfo.n = paramAdvertisementInfo.thirdIcon;
          continue;
          label406:
  ...
  private void a(AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localnnv.jdField_a_of_type_Int = paramAdvertisementInfo.mAdMaterialId;
      localnnv.jdField_b_of_type_Int = 1;
      localnnv.jdField_c_of_type_Int = paramAdvertisementInfo.mAdKdPos;
      localnnv.jdField_a_of_type_Long = paramAdvertisementInfo.mAdPosID;
      owy.a().a().a(paramInt2, this.jdField_a_of_type_Pfu);
      ThreadManager.executeOnSubThread(new VideoAdExposureManager.1(this, paramInt3, paramInt2, localnnv));
      return;
  ...
  private void b(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Raw.notifyItemChanged(paramInt);
  }
  
  private void b(AdvertisementInfo paramAdvertisementInfo)
  {
    paramAdvertisementInfo = a(paramAdvertisementInfo, false);
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecyclerView != null) && (this.jdField_a_of_type_Raw != null) && ((this.e < this.jdField_a_of_type_JavaUtilList.size()) || (this.e <= 0)))
    {
      ...
      if ((localVideoInfo != null) && (!localVideoInfo.jdField_c_of_type_Boolean) && (this.e > k))
      {
        ...
        this.jdField_a_of_type_Raw.notifyItemInserted(this.e);
        this.e = 0;
      }
      if ((localVideoInfo != null) && (localVideoInfo.jdField_c_of_type_Boolean) && (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null) && (this.jdField_a_of_type_Raw.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)))
      {
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramAdvertisementInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == this.jdField_b_of_type_Int)
        {
          k = this.f;
          this.f = 0;
          AdvertisementInfo localAdvertisementInfo1 = owy.a().a(paramInt, k);
  ...
  public void a()
  {
    pes localpes = owy.a().a();
    if (localpes != null)
    {
      localpes.a(this.jdField_a_of_type_Int);
      localpes.a(this.jdField_b_of_type_Int);
    }
  }
  ...
  public void a(int paramInt, rfs paramrfs, ArrayList<VideoInfo> paramArrayList)
  {
    if ((paramrfs == null) || (paramrfs.a == null) || (!this.jdField_c_of_type_Boolean)) {}
    for (;;)
    {
      return;
      if (!paramrfs.a.jdField_c_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoAdExposureManager", 2, "checkAndInsert , mPlayVmCount=" + this.j);
        }
        b(paramInt, paramrfs, paramArrayList);
      }
      while (QLog.isColorLevel())
      {
  ...
  public void a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    a(noy.a(paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo), paramInt, this.jdField_b_of_type_Int, 6);
  }
  
  public void a(rbn paramrbn)
  {
    try
    {
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        if ((paramrbn != null) && (paramrbn.a != null) && (paramrbn.a.a != null) && (paramrbn.a.a.jdField_c_of_type_Boolean) && (paramrbn.a.a.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null))
        {
          d(paramrbn.jdField_b_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAndRecord reset notCountFlag , mPlayingVideoHolder.position=" + paramrbn.jdField_b_of_type_Int);
          }
        }
      }
      return;
  ...
  public void a(boolean paramBoolean, int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if ((!oed.f(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) || (!this.jdField_d_of_type_Boolean)) {
        break label740;
      }
    }
    label735:
  ...
  public void b(int paramInt, rfs paramrfs, ArrayList<VideoInfo> paramArrayList)
  {
    boolean bool;
    label25:
    int m;
      ...
      do
      {
        do
        {
          try
          {
            ...
            if (paramrfs != null)
            {
              bool = paramrfs.jdField_c_of_type_Boolean;
              if (!bool) {
                break label25;
              }
            }
      ...
      else
      {
        for (;;)
        {
          ...
          if (k == -1) {
            ...
            {
              paramrfs = (VideoInfo)this.jdField_b_of_type_JavaUtilArrayList.get(0);
              this.jdField_b_of_type_JavaUtilArrayList.remove(0);
            }
          }
          for (;;)
          {
            if ((paramrfs != null) || (n == -1) || (n >= paramArrayList.size())) {
              break label587;
            }
            ...
            paramrfs = (VideoInfo)paramArrayList.get(k);
          ...
          paramArrayList.add(m, paramrfs);
          if (this.jdField_a_of_type_Raw != null) {
            this.jdField_a_of_type_Raw.b(paramrfs);
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          paramrfs = (VideoInfo)paramArrayList.get(m);
          if ((paramrfs == null) || (!paramrfs.jdField_c_of_type_Boolean) || (paramrfs.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (this.jdField_a_of_type_Raw == null) || (!this.jdField_a_of_type_Raw.a(paramrfs.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h))) {
            break;
          }
          VideoInfo localVideoInfo = (VideoInfo)this.jdField_b_of_type_AndroidUtilSparseArray.get(m);
          paramrfs = localVideoInfo;
