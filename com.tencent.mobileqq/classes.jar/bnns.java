  ...
  extends bnnn
{
  ...
  bnns()
  {
    this.jdField_a_of_type_Bmzb = new bnnt(this);
  }
  
  private static void a(bioy parambioy, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bnpm.a(Integer.valueOf(i), Long.valueOf(parambioy.a().getLongAccountUin()));
      return;
    }
  ...
  public static void a(CustomWebView paramCustomWebView)
  {
    try
    {
      ...
      paramCustomWebView.setTag(2131375958, Boolean.FALSE);
      paramCustomWebView.setTag(2131375961, Boolean.FALSE);
      return;
    }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(bmyy.a(i, str1, str2, paramVarArgs)))
      {
        a(str2, 0, "success");
        return;
      }
      ...
      do
      {
        paramVarArgs = this.jdField_a_of_type_Bmzb;
        break;
  ...
  private void b()
  {
    ...
    try
    {
      ...
      localCustomWebView.setTag(2131375961, Boolean.TRUE);
    ...
    Object localObject2 = localException.getTag(2131375958);
  ...
  private static void b(bioy parambioy, String... paramVarArgs)
  {
    int j = 0;
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        new HashMap();
        localObject = bnpm.a(Long.valueOf(parambioy.a().getLongAccountUin()));
        i = j;
      ...
      bnpm.a((Map)localObject, Long.valueOf(parambioy.a().getLongAccountUin()));
      return;
      label190:
      i += 1;
    }
  ...
  private static void c(bioy parambioy, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    }
  ...
  private void c(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        localObject2 = new bmzh();
        ((bmzh)localObject2).jdField_a_of_type_Int = i;
        ((bmzh)localObject2).jdField_a_of_type_JavaLangString = bmzh.a(i, paramVarArgs, (String)localObject1, str1, str2, j);
        bmyy.a(l, (bmzh)localObject2);
        ...
        bmtd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bmtk.a(), paramVarArgs);
        if (i > 0)
        {
          bmyy.a(l, null);
          bmyy.a(l, null);
  ...
  private static void d(bioy parambioy, String... paramVarArgs)
  {
    int i = 0;
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {}
    for (;;)
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0))
          {
            if ((((JSONObject)localObject).has("toast")) && (((JSONObject)localObject).getBoolean("toast"))) {
              QQToast.a(parambioy.a(), 2, 2131689526, 0).a();
            }
            ...
            parambioy.a().setResult(-1, paramVarArgs);
            parambioy.a().finish();
            return;
          }
        }
  ...
  private void d(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        bmzj localbmzj = new bmzj();
        localbmzj.jdField_a_of_type_Int = i;
        localbmzj.jdField_a_of_type_JavaLangString = paramVarArgs;
        bmyy.a(l, localbmzj);
        if (i > 0)
        {
          bmyy.a(l, null);
  ...
  private void e(bioy parambioy, String... paramVarArgs)
  {
    Intent localIntent = new Intent("action_personalize_js2qzone");
    Bundle localBundle = new Bundle();
    ...
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0)) {
      for (;;)
      {
        ...
        try
        {
          ...
          i = localbmzi.jdField_a_of_type_Int;
        }
        ...
        continue;
        label194:
        int i = localbmzj.jdField_a_of_type_Int;
        continue;
        label203:
        i = localbmzh.jdField_a_of_type_Int;
      }
    }
  }
  ...
  private void f(String... paramVarArgs)
  {
    try
    {
      ...
      localIntent.putExtras(localBundle);
      bmtd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bmtk.a(), localIntent);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void g(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        {
          bmtd.a(((BasePluginActivity)localActivity).getOutActivity(), paramArrayOfString, -1, null, null);
          return;
        }
        bmtd.a(localActivity, paramArrayOfString, -1, null, null);
        return;
      }
      if ((localActivity instanceof BasePluginActivity))
      {
  ...
  private void h(String[] paramArrayOfString)
  {
    try
    {
      ...
      if (bool)
      {
        ...
        bngf.a().a("cmd.getYellowDiamondRedPocket", localBundle, false);
      }
      return;
    }
    catch (Exception paramArrayOfString)
  ...
  private void j(String[] paramArrayOfString)
  {
    try
    {
      ...
      bngf.a().a("cmd.setResponsiveLike", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  private void k(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      bngf.a().a("cmd.setDIYData", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  private void l(String[] paramArrayOfString)
  {
    try
    {
      ...
      bngf.a().a("cmd.setCustomTrack", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          bngf.a().a("cmd.reserveAdvertise", paramArrayOfString, false);
          return;
        }
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            bnpq.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
            return true;
          }
          if (paramString3.equals("SetPersonalizeFinished"))
          {
            bnpn.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
            return true;
          }
          if (paramString3.equals("openNameplateSucc"))
          {
            bnpj.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
            return true;
          }
          ...
          {
            bngf.a().a("cmd.refeshDecoCustom", null, false);
            return true;
          }
