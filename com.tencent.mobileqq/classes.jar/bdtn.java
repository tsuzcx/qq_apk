  ...
  implements IEventReceiver
{
  ...
  public bdtn(MiniAppActivity paramMiniAppActivity, String paramString, int paramInt)
  {
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      paramString = new JSONObject(bbdx.b(paramString)).optString("version");
      return paramString;
    }
  ...
  private void a(int paramInt)
  {
    ...
    localasiv.jdField_a_of_type_Int = 4;
    localasiv.jdField_a_of_type_Asiw = this.jdField_a_of_type_Asiw;
  ...
  private boolean a(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      bbdx.b(str2);
      paramBoolean = bool;
    } while (bbdx.a(str1, str2, false) < 0);
    return bbdx.d(a(paramString, "", "libsconfig.json"), a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "libsconfig.json"));
  }
  
  private String[] a()
  {
    String str3 = this.jdField_a_of_type_Asiw.a.getString("unzipped_path");
    String str2 = a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "ejecta.js");
    String str1 = null;
    if (!TextUtils.isEmpty(str3)) {
      str1 = a(str3, this.jdField_a_of_type_Asiw.h, "index.js");
    }
  ...
  private boolean b()
  {
    ...
    if (!jdField_a_of_type_Boolean)
    {
      ...
      {
        return false;
        localObject = ((File)localObject).listFiles(new bdto(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bdtp = new bdtp(this);
      stb.a().registerSubscriber(this.jdField_a_of_type_Bdtp);
      asiu localasiu = asjb.a().a("ak:3214");
      if (localasiu != null) {
        localasiu.a("ak:3214", "QGameApp", this.jdField_a_of_type_Asiw.h);
      }
    }
  }
  ...
  {
    super.c();
    if (this.jdField_a_of_type_Bdtp != null) {
      stb.a().unRegisterSubscriber(this.jdField_a_of_type_Bdtp);
    }
  }
