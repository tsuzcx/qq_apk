  ...
  implements wnt
{
  ...
  protected void a(com.tribe.async.async.JobContext paramJobContext, bqua parambqua)
  {
    ...
    //   4: astore 10
    //   6: aload_2
    //   7: getfield 27	bqua:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    ...
    //   27: invokespecial 44	bquq:notifyError	(Ljava/lang/Error;)V
    //   30: return
    //   31: aload_2
    //   32: getfield 27	bqua:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   35: getfield 47	com/tencent/biz/qqstory/database/PublishVideoEntry:doodleRawPath	Ljava/lang/String;
    //   38: astore 12
    //   40: aload_2
    //   41: getfield 27	bqua:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    ...
    //   59: aload_0
    //   60: aload_2
    //   61: invokespecial 54	bquq:notifyResult	(Ljava/lang/Object;)V
    //   64: return
    //   65: aload_2
    //   66: getfield 57	bqua:jdField_a_of_type_Bqui	Lbqui;
    //   69: getfield 63	bqui:c	I
    //   72: istore 5
    //   74: aload_2
    //   75: getfield 65	bqua:jdField_a_of_type_Int	I
    //   78: istore_3
    //   79: iload_3
    //   80: iconst_2
    //   81: if_icmpeq +31 -> 112
    ...
    //   117: aload 12
    //   119: aconst_null
    //   120: invokestatic 70	zoc:a	(Ljava/lang/String;Lzod;)Landroid/graphics/Bitmap;
    //   123: astore_1
    //   124: iconst_1
    //   125: istore 4
    //   127: aload_1
    ...
    //   192: istore_3
    //   193: aload_2
    //   194: getfield 92	bqua:jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource	Ldov/com/tencent/biz/qqstory/takevideo/EditVideoParams$EditSource;
    //   197: instanceof 94
    //   200: ifeq +39 -> 239
    //   203: ldc 96
    ...
    //   234: invokestatic 120	yuk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   237: iconst_0
    //   238: istore_3
    //   239: aload_1
    //   240: iload_3
    //   241: invokestatic 125	bqub:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   244: astore_1
    //   245: aload_1
    //   246: ifnull +574 -> 820
    //   249: iload 4
    ...
    //   255: aload 12
    //   257: aconst_null
    //   258: invokestatic 128	zoc:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Lzod;)V
    //   261: iconst_1
    //   262: istore 6
    //   264: iload 6
    //   266: istore 7
    ...
    //   286: bipush 60
    //   288: aload 11
    //   290: invokestatic 137	zoc:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   293: istore 7
    //   295: aload_1
    ...
    //   308: aload_0
    //   309: aload_2
    //   310: invokespecial 54	bquq:notifyResult	(Ljava/lang/Object;)V
    //   313: return
    //   314: astore_1
    //   315: ldc 96
    //   317: ldc 144
    //   319: aload_1
    //   320: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   323: iconst_0
    //   324: istore 4
    //   326: aconst_null
    //   327: astore_1
    ...
    //   334: ldc 149
    //   336: aload_1
    //   337: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   340: aload 10
    //   342: astore_1
    //   343: goto -165 -> 178
    //   346: astore 10
    ...
    //   357: ldc 151
    //   359: aload 10
    //   361: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   364: aload 8
    //   366: ifnull +465 -> 831
    //   369: aload 8
    ...
    //   381: ldc 149
    //   383: aload 8
    //   385: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   388: goto -210 -> 178
    //   391: astore 9
    //   393: aload 10
    //   395: astore 8
    ...
    //   407: ldc 153
    //   409: aload 10
    //   411: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   414: aload 8
    //   416: ifnull +415 -> 831
    //   419: aload 8
    ...
    //   431: ldc 149
    //   433: aload 8
    //   435: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   438: goto -260 -> 178
    //   441: astore_1
    //   442: aload 9
    //   444: ifnull +8 -> 452
    ...
    //   457: ldc 149
    //   459: aload_2
    //   460: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   463: goto -11 -> 452
    //   466: iload 5
    //   468: bipush 90
    ...
    //   483: ldc 155
    //   485: aload 8
    //   487: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   490: iconst_0
    //   491: istore 6
    //   493: goto -229 -> 264
    //   496: aload_0
    ...
    //   507: invokespecial 44	bquq:notifyError	(Ljava/lang/Error;)V
    //   510: return
    //   511: aload_0
    ...
    //   523: invokespecial 44	bquq:notifyError	(Ljava/lang/Error;)V
    //   526: return
    //   527: iload_3
    //   528: iconst_1
    ...
    //   537: aload 12
    //   539: aconst_null
    //   540: invokestatic 70	zoc:a	(Ljava/lang/String;Lzod;)Landroid/graphics/Bitmap;
    //   543: astore_1
    //   544: iconst_1
    //   545: istore 4
    //   547: aload_1
    ...
    //   567: ifnull +201 -> 768
    //   570: aload_2
    //   571: getfield 92	bqua:jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource	Ldov/com/tencent/biz/qqstory/takevideo/EditVideoParams$EditSource;
    //   574: instanceof 94
    //   577: ifeq +238 -> 815
    //   580: aload_2
    //   581: getfield 27	bqua:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   584: ldc 168
    //   586: iconst_0
    ...
    //   627: invokestatic 120	yuk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   630: aload_1
    //   631: iload_3
    //   632: invokestatic 125	bqub:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   635: astore_1
    //   636: aload_1
    //   637: ifnull +167 -> 804
    //   640: iload 4
    ...
    //   646: aload 12
    //   648: aconst_null
    //   649: invokestatic 128	zoc:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Lzod;)V
    //   652: iconst_1
    //   653: istore 6
    //   655: iload 6
    //   657: istore 7
    ...
    //   677: bipush 60
    //   679: aload 11
    //   681: invokestatic 137	zoc:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   684: istore 7
    //   686: aload_1
    ...
    //   699: aload_0
    //   700: aload_2
    //   701: invokespecial 54	bquq:notifyResult	(Ljava/lang/Object;)V
    //   704: return
    //   705: astore_1
    //   706: ldc 96
    //   708: ldc 144
    //   710: aload_1
    //   711: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   714: aconst_null
    //   715: astore_1
    //   716: iconst_0
    //   717: istore 4
    ...
    //   726: ldc 151
    //   728: aload 8
    //   730: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   733: goto -167 -> 566
    //   736: astore 8
    //   738: ldc 96
    //   740: ldc 155
    //   742: aload 8
    //   744: invokestatic 147	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   747: iconst_0
    //   748: istore 6
    //   750: goto -95 -> 655
    //   753: aload_0
    ...
    //   764: invokespecial 44	bquq:notifyError	(Ljava/lang/Error;)V
    //   767: return
    //   768: aload_0
    ...
    //   780: invokespecial 44	bquq:notifyError	(Ljava/lang/Error;)V
    //   783: return
    //   784: aload_0
    //   785: aload_2
    //   786: invokespecial 54	bquq:notifyResult	(Ljava/lang/Object;)V
    //   789: return
    //   790: astore_1
    //   791: goto -349 -> 442
    //   794: astore 10
