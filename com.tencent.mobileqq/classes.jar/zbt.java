  ...
  extends LinearLayout
{
  ...
  public zbt(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = zby.b(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = zby.b(getContext(), 7.0F);
      }
  ...
  public void a(zbi paramzbi, int paramInt1, int paramInt2)
  {
    int i = paramInt1 * this.b;
    if (paramInt1 == paramInt2 - 1) {}
    for (paramInt1 = paramzbi.b();; paramInt1 = this.b + i)
    {
      a(paramInt1 - i);
      paramInt2 = i;
      while (paramInt2 < paramInt1)
      {
        ...
        String str = paramzbi.a(paramInt2);
        localImageView.setTag(2131378283, str);
        localImageView.setTag(2131378270, Integer.valueOf(paramInt2));
        localImageView.setContentDescription(anni.a(2131706369) + paramInt2);
        yyc.a().a(getContext(), localImageView, str, this.d, this.d, null);
        paramInt2 += 1;
      }
    }
  }
