...
public class aykc
{
  ...
  private List<aykh> jdField_a_of_type_JavaUtilList;
  ...
  public aykc(String paramString, int paramInt)
  {
  ...
  private aykc a(aykh paramaykh)
  {
    if (paramaykh != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramaykh);
    }
  ...
  private void a(StringBuilder paramStringBuilder, int paramInt)
  {
    ...
    while (paramInt < m)
    {
      if ((paramStringBuilder.charAt(paramInt) == '<') && (paramInt < k - 2))
      {
        ...
        if ((i == 36) && (paramInt < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new aykf(paramStringBuilder.substring(paramInt, paramInt + 4), i, n));
            paramInt += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt + 6) == '>')
            {
              ...
              a(new aykg(paramStringBuilder.substring(paramInt, paramInt + 7), j, n));
              i = 2;
              if (i < 5)
              {
          ...
          else if (j == 250)
          {
            ...
            a(new aykf(paramStringBuilder.substring(paramInt, paramInt + 4), 10, n));
            paramInt += 4;
          }
        }
        else if (((i == 37) || (i == 38)) && (paramInt < k - 6))
        {
          a(new ayke(paramStringBuilder.substring(paramInt, paramInt + 7)));
          paramInt += 7;
        }
      }
      else
      {
        ...
        {
          a(new aykb(paramStringBuilder.substring(paramInt, paramInt + 2)));
          paramInt += 2;
          continue;
        }
        a(new aykd(String.valueOf(paramStringBuilder.charAt(paramInt))));
      }
      label637:
      paramInt += 1;
    }
  ...
  public aykc a(int paramInt)
  {
    aykc localaykc = new aykc();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      aykh localaykh = (aykh)localIterator.next();
      if (localaykh.a() == paramInt) {
        localaykc.a(localaykh);
      }
    }
    return localaykc;
  }
  ...
  @NonNull
  public aykh a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (aykh)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
  ...
  public String a()
  {
    ...
    {
      aykh localaykh = (aykh)localIterator.next();
      if ((localaykh.a() == 0) || (localaykh.a() == 1)) {
        localStringBuilder.append(localaykh.a());
      }
    }
    return localStringBuilder.toString();
  }
  
  public aykc b(int paramInt)
  {
    aykc localaykc = new aykc();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
  ...
  public String b()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localStringBuilder.append(((aykh)localIterator.next()).a());
    }
    return localStringBuilder.toString();
  }
