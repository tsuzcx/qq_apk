  ...
  extends wfm<wun>
{
  ...
  public wsi(String paramString, List<String> paramList, List<Long> paramList1, List<Integer> paramList2, int paramInt)
  {
  ...
  public String a()
  {
    return weg.a("StoryGroupSvc.add_video");
  }
  ...
  public wfh a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wun(localRspAddGroupVideo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        ykq.b("AddGroupVideoRequest", "decodeResponse", paramArrayOfByte);
      }
    }
  }
