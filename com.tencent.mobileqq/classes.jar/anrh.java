  ...
  implements View.OnClickListener
{
  ...
  public anrh(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  public View a()
  {
    ...
    case 0: 
      ...
      return this.jdField_a_of_type_ComTencentMobileqqApolloViewApolloPanelListView;
    case 1: 
      return LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558674, null);
    }
    return LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558669, null);
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Anpz = null;
  ...
  public void a(View paramView)
  {
    ...
    URLImageView localURLImageView1 = (URLImageView)paramView.findViewById(2131362752);
    URLImageView localURLImageView2 = (URLImageView)paramView.findViewById(2131362785);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131362784));
    localURLImageView1.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetButton.setText(anzj.a(2131699379));
    }
  ...
  public void a(anpz paramanpz)
  {
    this.jdField_a_of_type_Anpz = paramanpz;
  }
  ...
  public void b(View paramView)
  {
    ...
    {
      return;
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376099));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369469));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369470));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Anpz.d();
        if (this.jdField_a_of_type_Boolean)
        {
          this.jdField_a_of_type_Anpz.b();
        }
        else if (this.jdField_a_of_type_Anpz != null)
        {
          paramView.setClickable(false);
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)paramView.getParent()).findViewById(2131378932));
          this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          this.jdField_a_of_type_Anpz.a();
          continue;
          if (this.jdField_a_of_type_Anpz != null)
          {
            this.jdField_a_of_type_Anpz.c();
            this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
