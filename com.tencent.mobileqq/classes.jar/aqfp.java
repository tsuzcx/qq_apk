...
public class aqfp
  extends alsi
{
  public aqfp(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      Object localObject = baaz.a().a(Long.valueOf(l1));
      if (localObject != null)
      {
        ...
        this.a.jdField_a_of_type_Aqfv.b((String)localObject);
        localObject = this.a.getResources().getString(2131692345);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    if ((!paramBoolean) && (paramInt2 == 32))
    {
      ...
      localObject = baaz.a().a(Long.valueOf(l2));
      if (localObject != null)
      {
        localObject = String.valueOf(((structmsg.StructMsg)localObject).req_uin.get());
        Message localMessage = Face2FaceAddFriendActivity.a(this.a).obtainMessage();
    ...
    try
    {
      ...
      localObject = baaz.a().a(Long.valueOf(l1));
      if (localObject != null)
      {
        localObject = String.valueOf(((structmsg.StructMsg)localObject).req_uin.get());
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        new ArrayList();
        localObject = this.a.app.a().b(aljq.M, 0);
        if (QLog.isColorLevel()) {
      ...
      if (localException.structMsg.msg_type.get() == 1)
      {
        ...
        else
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            String str1 = this.a.getResources().getString(2131720534);
