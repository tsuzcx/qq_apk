...
public class ambx
  extends amby
{
  public ambx(int paramInt, amca paramamca, ambw paramambw)
  {
    super(paramInt, paramamca, paramambw);
  }
  
  public ambx(int paramInt, String paramString, amca paramamca, ambw paramambw)
  {
    super(paramInt, paramString, paramamca, paramambw);
  }
  ...
  private alrq b()
  {
    ...
    try
    {
      ...
      {
        localJSONObject.put("is3DBetaTester", ambc.a(localQQAppInterface));
  ...
  private alrq d(String paramString)
  {
    try
    {
      QLog.d("CmShow_SpriteActionScript", 1, new Object[] { "handleJsError mSpriteFrom:", Integer.valueOf(this.jdField_a_of_type_Amca.e) });
      paramString = new JSONObject(paramString).optString("data");
      amhk.a(ambc.b(this.jdField_a_of_type_Amca.e), 1000, 50, new Object[] { paramString });
      return null;
    }
    catch (Exception paramString)
    {
  ...
  private alrq f(String paramString)
  {
    try
    {
      ...
      if ((i == ambc.b(1)) || (i == ambc.b(2))) {
        amhk.a(i, null, new int[] { amhj.a(i, false, this.jdField_a_of_type_Amca.jdField_b_of_type_Int, -1, true) });
      }
      amhk.b(i);
      if ((i == ambc.b(1)) || (i == ambc.b(2)))
      {
        amhk.a(ambc.b(this.jdField_a_of_type_Amca.e), false);
        return null;
      }
    }
    catch (Throwable paramString)
  ...
  private alrq j(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_Amca.e != 0) {
        return null;
      }
  ...
  private alrq m(String paramString)
  {
    try
    {
      ...
      paramString = this.jdField_a_of_type_Ambw;
      if (paramString != null) {
        return null;
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("pet".equals(paramString.getString("config_name")))
        {
          ...
          if (localObject != null)
          {
            localObject = (alnr)((QQAppInterface)localObject).getManager(153);
            if (((alnr)localObject).j == null) {
              break label124;
            }
            paramString = new JSONArray(((alnr)localObject).j);
  ...
  private alrq p(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Amca.a();
    if (paramString != null)
    {
      paramString.a();
      return null;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject = ambc.a(ApolloUtil.a());
          if (localObject != null)
          {
  ...
  private alrq q(String paramString)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Amca == null) || (this.jdField_a_of_type_Amca.a() == null))
      {
      ...
      if (this.jdField_a_of_type_Amca.a().getActivity() == null)
      {
    ...
    ApolloUtil.a(this.jdField_a_of_type_Amca.a().getActivity(), (String)localObject);
    return null;
    label122:
    ...
    if (i > 0)
    {
      ApolloGameUtil.a(this.jdField_a_of_type_Amca.a(), i, 333002, "message", 1);
      return null;
    }
  ...
  public alrq a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localalrq.jdField_b_of_type_Boolean = true;
        JSONObject localJSONObject = new JSONObject();
        if ((1 == localQQAppInterface.getALLGeneralSettingRing()) && (((this.jdField_a_of_type_Amca.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Amca.jdField_a_of_type_Int != 3000)) || (((1 == localQQAppInterface.getTroopGeneralSettingRing()) || (this.jdField_a_of_type_Amca.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Amca.jdField_a_of_type_Int == -2)) && (!localQQAppInterface.isRingerVibrate()) && (!localQQAppInterface.isRingEqualsZero()) && (localQQAppInterface.isCallIdle()) && (!MediaPlayerManager.a(localQQAppInterface).a()) && ((localQQAppInterface.getCheckPttListener() == null) || (!localQQAppInterface.getCheckPttListener().isRecordingOrPlaying())) && (!localQQAppInterface.isVideoChatting()))))
        {
  ...
  {
    alqu localalqu = a();
    if ((localalqu == null) || (localalqu.getLuaState() != paramLong)) {}
    do
    {
      do
      {
      ...
      if ("cs.script_update_boundinglist.local".equals(paramString1)) {
        return a(paramString2, localalqu.getRenderImpl().a());
      }
  ...
  public alrq a(String paramString)
  {
    ...
    try
    {
      ...
      amcg localamcg = this.jdField_a_of_type_Ambw.a();
      if (localamcg != null)
      {
        int i = 0;
        if (i < localJSONArray1.length())
        {
          ...
          if (j == 1) {
            localJSONObject2.put("petPath", localamcg.a(new JSONArray(paramString.optString("actionList"))));
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localObject = localamcg.a((String)localObject);
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      ApolloUtil.a().callbackFromRequest(this.jdField_a_of_type_Amca.a().getLuaState(), 0, "sc.script_notify_user_operation.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Amca.jdField_b_of_type_Boolean) {
          break label890;
        }
        ...
        if (localObject != null)
        {
          ...
          localJSONObject.put("freeMemory", ((amkq)localObject).d);
          localJSONObject.put("totalMemory", ((amkq)localObject).jdField_c_of_type_Long);
          localJSONObject.put("maxMemory", ((amkq)localObject).jdField_b_of_type_Long);
        }
        localJSONObject.put("aioType", ApolloGameUtil.a(ApolloUtil.a(), paramInt4, this.jdField_a_of_type_Amca.jdField_a_of_type_JavaLangString));
        ...
        localJSONObject.put("uin", this.jdField_a_of_type_Amca.jdField_b_of_type_JavaLangString);
        ...
        {
          paramString.put(amge.a(1, Integer.valueOf(localObject[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
        ...
        localJSONObject.put("traceFeatureId", this.jdField_a_of_type_Amca.a());
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        ApolloCmdChannel.getChannel(paramString1).callbackFromRequest(this.jdField_a_of_type_Amca.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
      paramString1 = ApolloUtil.a();
      if (paramString1 != null)
      {
        ApolloCmdChannel.getChannelFromOtherProcess(paramString1).callbackFromRequest(this.jdField_a_of_type_Amca.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Amca != null) && (this.jdField_a_of_type_Amca.a() != null)) {
      a(this.jdField_a_of_type_Amca.a().getWidth(), this.jdField_a_of_type_Amca.a().getInitHeight(), this.jdField_a_of_type_Amca.a().getHeight(), this.jdField_a_of_type_Amca.jdField_a_of_type_Int, this.jdField_a_of_type_Amca.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amca.e);
    }
  }
  ...
  public alrq c(String paramString)
  {
    try
    {
      int i = this.jdField_a_of_type_Amca.e;
      if (i != 0) {}
      return null;
    }
    catch (Throwable paramString)
