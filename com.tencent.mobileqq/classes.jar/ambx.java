  ...
  implements View.OnClickListener
{
  ...
  public ambx(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, List<PhoneContact> paramList)
  {
    ...
    this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131298064);
    this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131298065);
    a(paramList);
  }
  
  public static amca a(List<PhoneContact> paramList, ArrayList<PhoneContact> paramArrayList, boolean paramBoolean)
  {
    ...
    localamca.jdField_a_of_type_JavaUtilList = ((List)localObject);
    label52:
    label53:
    ...
    {
      if (localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramArrayList) == null) {
        localamca.jdField_a_of_type_JavaUtilLinkedHashMap.put(paramArrayList, new ArrayList());
      }
      ((List)localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramArrayList)).add(localPhoneContact);
      ...
      if (localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get("★") == null) {
        localamca.jdField_a_of_type_JavaUtilLinkedHashMap.put("★", new ArrayList());
      }
      ((List)localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get("★")).add(localPhoneContact);
      break label53;
      paramList = null;
      break;
    ...
    if (paramList != null)
    {
      localamca.jdField_b_of_type_JavaUtilList = paramList;
      if (!paramBoolean)
      {
        if (localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get("★") == null) {
          localamca.jdField_a_of_type_JavaUtilLinkedHashMap.put("★", new ArrayList());
        }
        ((List)localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get("★")).addAll(paramList);
      }
    }
    paramArrayList = localamca.jdField_a_of_type_JavaUtilLinkedHashMap;
    localamca.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    for (char c1 = 'A'; c1 <= 'Z'; c1 = (char)(c1 + '\001')) {
      if (paramArrayList.get(String.valueOf(c1)) != null) {
        localamca.jdField_a_of_type_JavaUtilLinkedHashMap.put(String.valueOf(c1), paramArrayList.get(String.valueOf(c1)));
      }
    }
    if (paramArrayList.get("#") != null) {
      localamca.jdField_a_of_type_JavaUtilLinkedHashMap.put("#", paramArrayList.get("#"));
    }
    if ((paramList != null) && ((((List)localObject).size() > 10) || (!paramBoolean)) && (paramArrayList.get("★") != null)) {
      localamca.jdField_a_of_type_JavaUtilLinkedHashMap.put("★", paramList);
    }
    paramArrayList.clear();
    localamca.jdField_a_of_type_ArrayOfInt = new int[localamca.jdField_a_of_type_JavaUtilLinkedHashMap.keySet().size()];
    localamca.jdField_a_of_type_ArrayOfJavaLangString = new String[localamca.jdField_a_of_type_ArrayOfInt.length];
    paramList = new ArrayList(localamca.jdField_a_of_type_JavaUtilLinkedHashMap.keySet());
    Collections.sort(paramList, new amby());
    paramArrayList = paramList.iterator();
    if (localamca.jdField_a_of_type_ArrayOfInt.length == 0) {
      return localamca;
    }
    localamca.jdField_a_of_type_ArrayOfInt[0] = 0;
    int i = 1;
    while (i < localamca.jdField_a_of_type_ArrayOfInt.length)
    {
      localObject = localamca.jdField_a_of_type_ArrayOfInt;
      int j = localObject[i];
      int k = localamca.jdField_a_of_type_ArrayOfInt[(i - 1)];
      localObject[i] = (((List)localamca.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramArrayList.next())).size() + k + 1 + j);
      i += 1;
    }
    ...
    {
      localamca.jdField_a_of_type_ArrayOfJavaLangString[i] = ((String)paramList.next());
      i += 1;
    }
    return localamca;
  }
  ...
  {
    this.jdField_b_of_type_JavaUtilList = paramamca.jdField_a_of_type_JavaUtilList;
    this.jdField_a_of_type_ArrayOfInt = paramamca.jdField_a_of_type_ArrayOfInt;
    this.jdField_a_of_type_JavaUtilLinkedHashMap = paramamca.jdField_a_of_type_JavaUtilLinkedHashMap;
    this.jdField_a_of_type_ArrayOfJavaLangString = paramamca.jdField_a_of_type_ArrayOfJavaLangString;
    this.c = paramamca.jdField_b_of_type_JavaUtilList;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localObject2 = new ambz();
      Object localObject3 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561104, null);
      ((ambz)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject3).findViewById(2131371720));
      ((ambz)localObject2).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject3).findViewById(2131361795));
      ((ambz)localObject2).b = ((TextView)((View)localObject3).findViewById(2131376456));
      ((ambz)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject3).findViewById(2131377713));
      ((ambz)localObject2).jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject3).findViewById(2131376443));
      ((ambz)localObject2).d = ((TextView)((View)localObject3).findViewById(2131376453));
      ((ambz)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)((View)localObject3).findViewById(2131364462));
      ((ambz)localObject2).e = ((TextView)((View)localObject3).findViewById(2131379723));
      ((ambz)localObject2).jdField_a_of_type_AndroidViewView = ((View)localObject3).findViewById(2131374201);
      ((View)localObject3).setBackgroundDrawable(null);
      ((View)localObject3).setTag(localObject2);
      paramView = (View)localObject2;
      localObject1 = localObject3;
      if ((((ambz)localObject2).jdField_c_of_type_AndroidWidgetImageView instanceof ThemeImageView))
      {
        ((ThemeImageView)((ambz)localObject2).jdField_c_of_type_AndroidWidgetImageView).setSupportMaskView(false);
        localObject1 = localObject3;
        paramView = (View)localObject2;
      }
      ...
      ((View)localObject1).findViewById(2131376449).setPadding(0, 0, this.jdField_a_of_type_Int, 0);
      label265:
      if (i >= 0) {
        break label1072;
      }
      ...
      aiyi.a((View)localObject1, true);
      aiyi.b(paramView.jdField_a_of_type_AndroidViewView, true);
      label372:
      ...
      if (AppSetting.c)
      {
        bgfz.a(paramView.jdField_a_of_type_AndroidWidgetTextView, false);
      ...
      paramView.d.setText(anni.a(2131701264));
      ...
      if (AppSetting.c) {
        paramView.d.setContentDescription(anni.a(2131701259));
      }
      label643:
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject2 = (ambz)paramView.getTag();
      localObject1 = paramView;
      paramView = (View)localObject2;
      break;
      label779:
      ((View)localObject1).findViewById(2131376449).setPadding(0, 0, this.jdField_b_of_type_Int, 0);
      break label265;
      label800:
      aiyi.a((View)localObject1, false);
      aiyi.b(paramView.jdField_a_of_type_AndroidViewView, false);
      break label372;
      label817:
      ...
      break label538;
      label841:
      if (this.jdField_a_of_type_Anmw.a(((PhoneContact)localObject2).unifiedCode, true))
      {
        paramView.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramView.d.setVisibility(0);
        paramView.d.setText(anni.a(2131701262));
        if (this.jdField_a_of_type_Boolean)
        {
          paramView.jdField_a_of_type_AndroidViewView.setEnabled(false);
          paramView.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
        ...
        paramView.d.setContentDescription(anni.a(2131701268));
        break label643;
      }
      if (this.jdField_a_of_type_Boolean)
      {
      ...
      for (;;)
      {
        ...
        paramView.jdField_a_of_type_AndroidWidgetButton.setText(anni.a(2131689550));
        ...
        if (AppSetting.c) {
          paramView.jdField_a_of_type_AndroidWidgetButton.setContentDescription(anni.a(2131689550));
        }
      }
      label1065:
      i = 8;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 2131374201: 
        ...
        localObject1 = (ambz)localObject1;
        boolean bool2 = a(((ambz)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact);
        localObject2 = ((ambz)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
        if (bool2) {
          break label732;
        }
        bool1 = true;
        ...
        if (this.jdField_a_of_type_Amcb != null)
        {
          ...
          localObject1 = ((ambz)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
          if (bool2) {
            break label738;
          }
          bool1 = true;
          label147:
          ((amcb)localObject2).a((PhoneContact)localObject1, bool1);
        }
        break;
      }
    }
    ...
    for (int i = 3084;; i = 3006)
    {
      ...
      if (!((awmz)localObject1).i()) {
        if (this.c.contains(localObject2))
        {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077CD", "0X80077CD", 1, 0, "", "", "", "");
      ...
      for (localObject1 = "#";; localObject1 = String.valueOf(((PhoneContact)localObject2).pinyinFirst.charAt(0)).toUpperCase())
      {
        ...
        localObject1 = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, ((PhoneContact)localObject2).unifiedCode, null, i, j, ((PhoneContact)localObject2).name, null, null, anni.a(2131701265), null);
        this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject1);
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006A75", "0X8006A75", 0, 0, "", "", "", "");
        notifyDataSetChanged();
        break;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077CD", "0X80077CD", 2, 0, "", "", "", "");
        break label268;
        if (this.c.isEmpty())
        {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D0", "0X80077D0", 0, 0, "", "", "", "");
          break label311;
        }
        if (this.c.contains(localObject2)) {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D3", "0X80077D3", 1, 0, "", "", "", "");
        }
        for (;;)
        {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D3", "0X80077D3", 0, 0, "", "", "", "");
          break;
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D3", "0X80077D3", 2, 0, "", "", "", "");
        }
      }
      label732:
      bool1 = false;
      ...
      break label147;
      label744:
      this.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = ((ambz)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
