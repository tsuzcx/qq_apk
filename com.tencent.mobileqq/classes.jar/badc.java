  ...
  extends MSFServlet
{
  public static NewIntent a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (badd)paramQQAppInterface.getManager(61);
    if (localObject != null) {}
    for (localObject = ((badd)localObject).a(paramString);; localObject = null)
    {
      if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), badc.class);
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool3)
    {
      try
      {
        ...
        bacu.a = ((cmd0xe34.RspBody)localObject2).ReqInterval.get();
      ...
      for (j = 1;; j = 0)
      {
        ...
        localObject3 = (badd)getAppRuntime().getManager(61);
        if (localObject3 != null)
        {
          ((badd)localObject3).a((SubAccountMessage)localObject2);
          ((badd)localObject3).b((SubAccountMessage)localObject2);
          ((badd)localObject3).c(((SubAccountMessage)localObject2).subUin);
        }
        localObject2 = new bade();
        ((bade)localObject2).b = paramFromServiceMsg.getUin();
        ((bade)localObject2).jdField_c_of_type_JavaLangString = String.valueOf(l);
        ((bade)localObject2).jdField_c_of_type_Boolean = true;
        ((bade)localObject2).d = true;
        ((bade)localObject2).a = 0;
  ...
  public void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
        ...
        if (i < ((ArrayList)localObject1).size())
        {
          ...
          try
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localArrayList.get(i))) {
              ((cmd0xe34.LoginSig)localObject2).bytes_sig.set(ByteStringMicro.copyFrom(bdqa.a((String)localArrayList.get(i))));
            }
      ...
      paramPacket.putSendData(bdpd.a(((oidb_sso.OIDBSSOPkg)localObject1).toByteArray()));
