  ...
  extends BaseAdapter
{
  ...
  public badc(Context paramContext, List<ShareActionSheetBuilder.ActionSheetItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Int == 0) {
      this.jdField_a_of_type_Int = ((int)this.jdField_a_of_type_AndroidContentResResources.getDimension(2131296795));
    }
    if (this.jdField_a_of_type_Badd == null) {
      this.jdField_a_of_type_Badd = new badd(paramViewGroup.getContext());
    }
    View localView;
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558942, paramViewGroup, false);
    ...
    paramView.vLabel.setText(bada.a(paramView.sheetItem.label, 6));
    int i = -8947849;
    ...
    if (paramView.sheetItem.enable)
    {
      ...
      localObject = this.jdField_a_of_type_Badd.a((Drawable)localObject, i, j);
      if (!paramView.sheetItem.enable) {
        break label459;
      }
      Drawable localDrawable = badd.a(this.jdField_a_of_type_Badd, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Badd.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label328;
      label459:
      localObject = badd.b(this.jdField_a_of_type_Badd, (Drawable)localObject);
      paramView.vIcon.setImageDrawable((Drawable)localObject);
      break label408;
      label482:
