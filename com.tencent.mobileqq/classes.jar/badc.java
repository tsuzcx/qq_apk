...
public class badc
  extends baax
{
  private static volatile badc jdField_a_of_type_Badc;
  ...
  public static badc a()
  {
    if (jdField_a_of_type_Badc == null) {}
    try
    {
      if (jdField_a_of_type_Badc == null) {
        jdField_a_of_type_Badc = new badc();
      }
      return jdField_a_of_type_Badc;
    }
    finally {}
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    awrn.a(BaseApplicationImpl.getApplication()).a(null, "JumpIllegal", true, 0L, 0L, localHashMap, null);
  }
  ...
  public boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_Badc)
    {
      if (!this.jdField_a_of_type_Boolean) {
        a(paramContext);
      }
