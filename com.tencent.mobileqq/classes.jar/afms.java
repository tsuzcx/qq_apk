...
public final class afms
  implements Runnable
{
  public afms(QQAppInterface paramQQAppInterface, NowHandler paramNowHandler, ChannelResponse paramChannelResponse, SharedPreferences paramSharedPreferences) {}
  ...
  public void run()
  {
    ...
    Object localObject1 = ImageUtil.b(BitmapManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources(), 2130844114), k, i, i);
    ...
    do
    {
      ...
      localObject1 = new File(AppConstants.aJ + MD5.toMD5(this.jdField_a_of_type_ComTencentMobileqqNowChannelResponse.downloadLink) + ".apk");
      ...
      if ((!bool) || (i == 0))
      {
        ...
        ((DownloaderFactory)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(46)).a(1).a(new DownloadTask(this.jdField_a_of_type_ComTencentMobileqqNowChannelResponse.downloadLink, (File)localObject1), new afmt(this), null);
        return;
      }
