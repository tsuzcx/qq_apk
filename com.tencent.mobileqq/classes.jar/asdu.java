...
{
  public asdu(NearbyJsInterface paramNearbyJsInterface, String paramString, boolean paramBoolean) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramBundle.uint32_result.has()) && (paramBundle.uint32_result.get() == 0) && (paramBundle.bytes_bodybuffer.has()) && (paramBundle.bytes_bodybuffer.get() != null))
        {
          ...
          break label264;
          this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyJsInterface.jdField_a_of_type_Wis.a(paramBundle.bytes_xml_msg.get().toByteArray(), String.valueOf(paramBundle.uint64_uin.get()), 2, paramInt);
          paramBundle = new asdx(String.valueOf(paramBundle.uint64_uin.get()), paramBundle.int32_direction_flag.get());
