...
public class axqv
{
  ...
  private static axqx jdField_a_of_type_Axqx = new axqx();
  ...
  public static int a()
  {
    ...
    if (!((akdh)((AppRuntime)localObject).getManager(56)).a(Long.valueOf(Long.parseLong("2290230341"))))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    bhlc.a().a(new axqw(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig, int paramInt, String paramString)
  {
    ...
    int j = bbkb.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString);
    if (QLog.isColorLevel()) {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        try
        {
          ...
          bbkb.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString, i);
          return;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), axcs.class);
    ...
    for (String str = "1";; str = "0")
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(jdField_a_of_type_Axqx);
      BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
      axqy.b(paramQQAppInterface, "CliOper", "", "", "0X800915C", "0X800915C", 0, 0, "", "", "", "");
      return;
    }
  }
}
