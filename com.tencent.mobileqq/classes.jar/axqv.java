  ...
  extends atzo
{
  protected void e(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      int i = axqt.a().decrementAndGet();
      axqt.a(0);
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      localAppRuntime.getPreferences().edit().putInt(localAppRuntime.getAccount() + "_" + "qzone_xp_req_left", i).apply();
      axqt.b(((mobile_get_qzone_public_msg_rsp)paramBundle).next_req_tmstamp);
      if (QLog.isColorLevel()) {
        QLog.i("QZoneReport", 2, "next req time: " + axqt.b() + ", left: " + i);
      }
      axqw.b(null, "CliOper", "", "", "0X800915D", "0X800915D", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      axqt.a().set(false);
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(axqt.a());
      return;
      axqt.c();
      if (QLog.isColorLevel()) {
