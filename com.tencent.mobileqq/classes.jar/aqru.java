  ...
  private void a(Object paramObject)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileCome uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + arrr.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        localObject1 = (String)paramObject[3];
        i = ((Integer)paramObject[4]).intValue();
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileTransferStart uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + arrr.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        {
          paramObject = (Object[])paramObject[2];
          localObject1 = new arcg();
          ((arcg)localObject1).jdField_a_of_type_JavaLangString = ((String)paramObject[0]);
          ((arcg)localObject1).jdField_a_of_type_Int = ((Integer)paramObject[1]).intValue();
          ((arcg)localObject1).jdField_b_of_type_JavaLangString = ((String)paramObject[2]);
          ((arcg)localObject1).jdField_a_of_type_JavaLangObject = paramObject[3];
          QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess,fileId[" + ((arcg)localObject1).jdField_a_of_type_JavaLangString + "],filePath[" + ((arcg)localObject1).jdField_b_of_type_JavaLangString + "]");
          if ((((arcg)localObject1).jdField_a_of_type_JavaLangObject != null) && (((arcg)localObject1).jdField_b_of_type_JavaLangString != null) && (((arcg)localObject1).jdField_b_of_type_JavaLangString.length() > 0))
          {
            if (!(((arcg)localObject1).jdField_a_of_type_JavaLangObject instanceof WeiYunFileInfo)) {
              break label3135;
            }
            ((WeiYunFileInfo)((arcg)localObject1).jdField_a_of_type_JavaLangObject).h = ((arcg)localObject1).jdField_b_of_type_JavaLangString;
          }
          for (;;)
          {
            a((arcg)localObject1);
            return;
            if ((((arcg)localObject1).jdField_a_of_type_JavaLangObject instanceof OfflineFileInfo)) {
              ((OfflineFileInfo)((arcg)localObject1).jdField_a_of_type_JavaLangObject).c = ((arcg)localObject1).jdField_b_of_type_JavaLangString;
            } else if ((((arcg)localObject1).jdField_a_of_type_JavaLangObject instanceof FileManagerEntity)) {
              ((FileManagerEntity)((arcg)localObject1).jdField_a_of_type_JavaLangObject).strThumbPath = ((arcg)localObject1).jdField_b_of_type_JavaLangString;
            }
          }
        }
        localObject1 = (Object[])paramObject[2];
        localObject2 = (String)localObject1[0];
        paramObject = new arcg();
    ...
    for (i = ((Integer)localObject1[1]).intValue();; i = 0)
    {
      ...
      {
        localObject1 = new arcg();
        ((arcg)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
        ((arcg)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
        ((arcg)localObject1).jdField_b_of_type_Int = i;
        if (i == 7) {
          ((arcg)localObject1).jdField_b_of_type_JavaLangString = paramObject.strLargeThumPath;
        }
        for (;;)
        {
          ((arcg)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
          a((arcg)localObject1);
          return;
          if (i == 5) {
            ((arcg)localObject1).jdField_b_of_type_JavaLangString = paramObject.strMiddleThumPath;
          } else {
            ((arcg)localObject1).jdField_b_of_type_JavaLangString = paramObject.strThumbPath;
          }
        }
      }
      localObject1 = new arcg();
      ((arcg)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
      ((arcg)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
      ((arcg)localObject1).jdField_b_of_type_JavaLangString = null;
      ((arcg)localObject1).jdField_b_of_type_Int = i;
      ((arcg)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
      a((arcg)localObject1);
      return;
