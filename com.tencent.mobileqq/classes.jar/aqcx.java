  ...
  implements Handler.Callback
{
  ...
  private static ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, aqcz>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + ".hiboom_font/";
  ...
  private aqcz b(int paramInt1, int paramInt2, aqcy paramaqcy)
  {
    paramaqcy = new aqcz(paramInt1, paramaqcy);
    ((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).put(Integer.valueOf(paramInt1), paramaqcy);
    return paramaqcy;
  }
  
  public aqcz a(int paramInt1, int paramInt2, @Nonnull aqcy paramaqcy)
  {
    try
    {
      ...
      aqcz localaqcz2 = (aqcz)((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).get(Integer.valueOf(paramInt1));
      aqcz localaqcz1 = localaqcz2;
      if (localaqcz2 == null) {
        localaqcz1 = b(paramInt1, paramInt2, paramaqcy);
      }
      return localaqcz1;
    }
    finally {}
  ...
  public void a()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        ((aqcz)((Map.Entry)localIterator2.next()).getValue()).a(false);
      }
    }
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!gd.b()) && (ETEngine.getInstanceForAnimation().isEngineInited.compareAndSet(false, true)))
        {
          if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i = bajo.a(bajo.a(), "libFounderColorFont_818.so");
        if (!QLog.isColorLevel()) {
          break label130;
        }
