...
public class aqcx
{
  ...
  protected float a;
  protected int a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aqcy(this);
  protected Context a;
  public Bitmap a;
  protected Handler a;
  ...
  final List<aqdb> jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
  protected Handler b;
  protected LruCache<String, String> b;
  
  public aqcx(Context paramContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aqcz(this, Looper.getMainLooper());
    this.jdField_b_of_type_AndroidOsHandler = new aqda(this, ThreadManager.getSubThreadLooper());
  ...
  public void a(aqdb paramaqdb)
  {
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilList.contains(paramaqdb)) {
        this.jdField_a_of_type_JavaUtilList.add(paramaqdb);
      }
      return;
    }
  }
  ...
  public void b()
  {
    ...
    //   15: aload_0
    //   16: getfield 92	aqcx:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   19: aload_0
    //   20: getfield 65	aqcx:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   23: invokevirtual 314	android/content/Context:unregisterReceiver	(Landroid/content/BroadcastReceiver;)V
    //   26: aload_0
    //   27: getfield 56	aqcx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   30: astore_1
    //   31: aload_1
    //   32: monitorenter
    //   33: aload_0
    //   34: getfield 56	aqcx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: invokeinterface 317 1 0
    //   42: aload_1
    //   43: monitorexit
    //   44: aload_0
    //   45: getfield 43	aqcx:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   48: invokevirtual 318	java/util/HashSet:clear	()V
    //   51: aload_0
    //   52: getfield 78	aqcx:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   55: aconst_null
    //   56: invokevirtual 322	android/os/Handler:removeCallbacksAndMessages	(Ljava/lang/Object;)V
    //   59: aload_0
    //   60: getfield 88	aqcx:jdField_b_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   63: aconst_null
    //   64: invokevirtual 322	android/os/Handler:removeCallbacksAndMessages	(Ljava/lang/Object;)V
    //   67: aload_0
    //   68: getfield 38	aqcx:jdField_b_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   71: invokevirtual 325	android/support/v4/util/LruCache:evictAll	()V
    //   74: aload_0
    //   75: getfield 36	aqcx:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
  ...
  public void b(aqdb paramaqdb)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramaqdb);
      return;
    }
  }
}
