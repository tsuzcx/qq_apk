...
public class ypn
  implements Runnable
{
  public ypn(ApolloFloatActivity paramApolloFloatActivity, Resources paramResources, RelativeLayout paramRelativeLayout) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloFloatActivity.a.setBackgroundResource(2130846141);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloFloatActivity.a.setText(2131434920);
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloFloatActivity.a.setTextColor(this.jdField_a_of_type_AndroidContentResResources.getColor(2131494203));
    }
  }
}
