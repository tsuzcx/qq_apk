...
public final class bpiv
  implements abbj
{
  public bpiv(FrameVideoHelper paramFrameVideoHelper, abbj paramabbj) {}
  
  public void a(boolean paramBoolean, ArrayList<FrameVideoHelper.FrameBuffer> paramArrayList, long paramLong)
  {
    bpam.b("AEEditorMusicHelper", "[extractFrameForSmartMusic], onResult(), isSuccess=" + paramBoolean + ", dataArray=" + paramArrayList + ", frameSize=" + paramLong);
    int i;
    if (this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper != null)
    {
      ...
      {
        i = 0;
        bpam.a("AEEditorMusicHelper", i + ", size=" + this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper.b() + "KB");
      }
    }
    else if (this.jdField_a_of_type_Abbj != null)
    {
      if (paramArrayList != null) {
        break label169;
      }
    ...
    {
      this.jdField_a_of_type_Abbj.a(paramBoolean, paramArrayList, paramLong);
      if (this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper != null) {
