      ...
      do
      {
        do
        {
          do
          {
            ...
            new baji().a((AIOPictureData)localObject, paramInt2, paramString);
            return i;
          ...
          new bajj().a((AIOVideoData)localObject, paramInt2, paramString);
          return i;
        ...
        new baje().a((AIOFilePictureData)localObject, paramInt2, paramString);
        return i;
