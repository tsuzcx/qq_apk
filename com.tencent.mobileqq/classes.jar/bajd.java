...
public class bajd
{
  ...
  public static void a(Activity paramActivity, String paramString, baji parambaji)
  {
    ...
    paramActivity = bdcd.a(paramActivity, 0, null, paramActivity.getString(2131719861), paramActivity.getString(2131690648), paramActivity.getString(2131691088), new bajg(parambaji), new bajh(parambaji));
    paramActivity.show();
    paramActivity.setCancelable(false);
    a("0X800A5C9");
  }
  
  public static void a(bakk parambakk)
  {
    if (b()) {
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    String str = localBaseActivity.getString(2131719864);
    if (!paramBoolean1) {
      str = localBaseActivity.getString(2131719860);
    }
    paramString1 = bdcd.a(localBaseActivity, 0, null, str, localBaseActivity.getString(2131690648), localBaseActivity.getString(2131691088), new baje(paramBoolean1, paramBoolean2), new bajf(paramString1, paramString2));
    paramString1.show();
  ...
  public static boolean a(Activity paramActivity, String paramString, baji parambaji)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing())) {}
    while (!b()) {
      return false;
    ...
    if ((paramActivity.getResources().getConfiguration().uiMode & 0x30) == 32)
    {
      ...
      a(paramActivity, paramString, parambaji);
    }
    for (;;)
    {
      return true;
      ...
      break;
      label141:
      ThreadManager.getUIHandler().post(new DarkModeManager.6(paramActivity, paramString, parambaji));
    }
  }
  ...
  private static void b(bakk parambakk)
  {
    Object localObject;
    if (azib.b())
    {
    ...
    for (;;)
    {
      ...
      ThemeSwitcher.a((String)localObject, "202", parambakk);
      return;
      localObject = bakj.a(b());
  ...
  private static void b(boolean paramBoolean1, boolean paramBoolean2, bakk parambakk)
  {
