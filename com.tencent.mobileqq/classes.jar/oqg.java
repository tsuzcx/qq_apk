...
public class oqg
{
  ...
  public static void a(ProteusInnerData paramProteusInnerData, int paramInt)
  {
    ...
    nxw.a(new omp().a(localQQAppInterface).a(BaseApplication.getContext()).a(nxw.a).b(nxw.Y).a(oqk.a(paramProteusInnerData)).d(paramInt).d(nxw.a(paramProteusInnerData)).a());
  }
}
