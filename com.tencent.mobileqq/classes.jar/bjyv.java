...
public class bjyv
{
  ...
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new bjyw(this);
  ...
  private HashMap<String, bjyx> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = bjyv.class.getName();
  }
  
  public bjyv(Context paramContext)
  {
  ...
  public void a(String paramString1, String paramString2, bjyx parambjyx)
  {
    ...
    if (localFile.exists())
    {
      if (parambjyx != null)
      {
        parambjyx.a(paramString1, localFile.length(), localFile.length());
        parambjyx.a(paramString1, 3, 0, null, paramString2);
      }
      return;
    }
    if (!this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString1))
    {
      this.jdField_b_of_type_JavaUtilHashMap.put(paramString1, parambjyx);
