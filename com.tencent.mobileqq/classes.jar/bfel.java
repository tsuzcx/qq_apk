...
public class bfel
{
  ...
  public static int a()
  {
    return bexd.a().a().getSharedPreferences("qzoneappcenter", 4).getInt("appTabVersionCode", -1);
  }
  ...
  public static String a(WebView paramWebView, HashMap<String, atcm> paramHashMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < localJSONArray2.length())
        {
          ...
          bfhg.c("Common", "nameSpace:" + paramString + ",methodName=" + str1 + ",paramsStr=" + paramWebView);
      ...
      catch (UnsupportedEncodingException paramWebView)
      {
        try
        {
          ...
          {
            paramWebView = (Class)bfet.jdField_a_of_type_JavaUtilHashMap.get(paramString);
            if (bfet.jdField_a_of_type_JavaUtilArrayList.contains(str1)) {
            ...
            if (paramWebView != null)
            {
              ...
              if (j < k)
              {
                ...
                if ((paramWebView.getName().equals(str1)) && (paramWebView.getParameterTypes().length == ((List)localObject).size()))
                {
                  ...
                  try
                  {
                    bfhg.c("Common", "callBatch <call> class : " + paramString.getClass().getName() + " , method : " + str1 + "\n , args : " + localObject.toString());
                  ...
                  {
                    bfhg.c("Common", "callBatch error", paramWebView);
                  }
                  paramWebView = paramWebView;
                  bfhg.b("Common", "callBatch decode params format err", paramWebView);
        ...
        {
          bfhg.e("Common", "callBatch args error : " + paramWebView.toString());
        }
      }
      catch (JSONException paramWebView)
      {
        bfhg.b("Common", "callBatch request params format err", paramWebView);
        continue;
        j += 1;
        continue;
        ...
        else if ((paramString instanceof Boolean))
        {
          ...
          localJSONObject.put("data", localJSONArray1);
          bfhg.c("Common", "Response<callBatch> syncCallBatch result : " + localJSONObject);
        }
        else
        {
          paramWebView = "";
  ...
  public static void a()
  {
    try
    {
      bfhg.b("Common", "<initSystemFolder> begin to init system file... ");
  ...
  {
    SharedPreferences.Editor localEditor = bexd.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    bfhg.c("Common", "setResourceMD5=" + paramString);
    SharedPreferences.Editor localEditor = bexd.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  public static long[] a()
  {
    SharedPreferences localSharedPreferences = bexd.a().a().getSharedPreferences("qzoneappcenter", 4);
  ...
  public static String[] a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      bfhg.c("Common", "url params= " + str2 + " " + paramString);
  ...
  {
    bfhg.c("Common", "setLastResourceZipMd5=" + paramString);
    SharedPreferences.Editor localEditor = bexd.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    return bexd.a().a().getSharedPreferences("qzoneappcenter", 4).getBoolean("appstoreclearcache", false);
  }
  ...
  {
    String str = q();
    bfhg.b("Common", "<getSDResDir> getSDResDir=" + str);
    if (TextUtils.isEmpty(str)) {
      return "";
    }
  ...
  {
    return bexd.a().a().getSharedPreferences("qzoneappcenter", 4).getString("relastmd5", "");
  }
  
  public static String o()
  {
    return bexd.a().a().getSharedPreferences("qzoneappcenter", 4).getString("lastresourcezipmd5", "");
  }
  
  public static String p()
  {
    return bexd.a().a().getSharedPreferences("qzoneappcenter", 4).getString("appstoreagentversion", "");
  }
  
  public static String q()
  {
    return bexd.a().a().getSharedPreferences("qzoneappcenter", 4).getString("sdhtmldir", "");
  }
  ...
  public static String r()
  {
    ...
    {
      bfhg.c("Common", "exception happened!");
      return "";
    }
    return "";
  }
