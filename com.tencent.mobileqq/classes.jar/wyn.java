...
public class wyn
{
  ...
  public wyn(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean, int paramInt4)
  {
  ...
  @TargetApi(17)
  @RequiresApi(api=17)
  public void a(List<Bitmap> paramList, wyh paramwyh)
  {
    wyi localwyi = new wyi(0, "success");
    this.jdField_a_of_type_Auzt = new auzt();
    auzf localauzf = new auzf(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int, this.c, 1, false, 0);
    ...
    this.jdField_a_of_type_Auzt.a(localauzf, new wyo(this, paramList, paramwyh, localwyi));
    try
    {
      try
      {
