...
public class ankx
  implements DialogInterface.OnDismissListener, Handler.Callback, AdapterView.OnItemClickListener, bkzq
{
  ...
  public ankx(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.f = (anvx.a(2131699855) + this.jdField_a_of_type_JavaLangString);
  ...
  private void b()
  {
    ...
    for (localObject = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      ...
      {
        if ((localObject != null) && (localAppInterface != null) && (QZoneShareManager.jumpToQzoneShare(localAppInterface, (Context)localObject, localBundle, null)))
        {
          localObject = a();
          if (localObject != null) {
            break label172;
        ...
        label172:
        for (int i = -1;; i = ApolloUtil.b(((BaseChatPie)localObject).sessionInfo.curType))
        {
  ...
  private void c()
  {
    Object localObject1 = new bdnr(StructMsgForGeneralShare.class).c(96).a(this.f).e(this.c).a(anvx.a(2131699883), null).b("web", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326").a();
    Object localObject2 = bdoe.a(2);
    ((bdnv)localObject2).a(this.d, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localObject1 != null) {
        aupt.a((Activity)localObject1, (Intent)localObject2, 14002);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    localArrayList.add(bkzw.a(3));
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      if (paramString != null)
      {
        localbkzw = new bkzw(paramString);
        localbkzw.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bkzi == null) && (paramString != null)) {
        this.jdField_a_of_type_Bkzi = bkzw.a(paramString, localbkzw, this, this, this, false);
      }
      if ((this.jdField_a_of_type_Bkzi != null) && (!this.jdField_a_of_type_Bkzi.isShowing()))
      {
        this.jdField_a_of_type_Bkzi.setOnDismissListener(this);
        this.jdField_a_of_type_Bkzi.show();
      }
      paramString = a();
      if (paramString == null) {}
      for (i = -1;; i = ApolloUtil.b(paramString.sessionInfo.curType))
      {
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (Activity localActivity = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localActivity = null)
    {
      ...
      {
        localbkzw = new bkzw(localActivity);
        localbkzw.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bkzi == null) && (localActivity != null))
      {
        ...
        this.jdField_a_of_type_Bkzi = bkzw.a(localActivity, localbkzw, new anky(this, paramString), this, this, false);
      }
      if ((this.jdField_a_of_type_Bkzi == null) || (this.jdField_a_of_type_Bkzi.isShowing())) {
        break;
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localBundle.putString("summary", anvx.a(2131699840));
        ...
        QZoneShareManager.publishToQzone((AppInterface)localObject, paramMessage, localBundle, this, 15);
        return false;
      }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (int j = -1;; j = ApolloUtil.b(localBaseChatPie.sessionInfo.curType))
      {
