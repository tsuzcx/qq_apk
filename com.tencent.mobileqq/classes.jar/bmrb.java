...
public final class bmrb
{
  ...
  public static void a(Activity paramActivity)
  {
    ...
    if (DeviceProfileManager.a(paramActivity, arrayOfInteger, new anwm()) >= arrayOfInteger.length)
    {
  ...
  public static void a(Context paramContext)
  {
    ...
    localBusinessTask.a(new bmrc(paramContext), true);
    localBusinessTask.a();
  }
