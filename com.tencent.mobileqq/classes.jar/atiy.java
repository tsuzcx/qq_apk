  ...
  extends atir
{
  ...
  public atiy(String paramString, int paramInt)
  {
  ...
  {
    return bbup.a(((FileManagerEntity)this.jdField_a_of_type_JavaUtilList.get(0)).fileName.toLowerCase(), this.jdField_a_of_type_JavaLangString);
  }
  ...
  public List<bbmy> a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    while (paramContext.hasNext())
    {
      ...
      atiy localatiy = new atiy(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      localatiy.a(this.jdField_a_of_type_AndroidOsBundle);
      ArrayList localArrayList = new ArrayList(1);
      localArrayList.add(localFileManagerEntity);
      localatiy.a(localArrayList);
      paramQQAppInterface.add(localatiy);
    }
  ...
  public void a(List<FileManagerEntity> paramList)
  {
    ...
    {
      if ((!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaLangString.equals(anhk.z)))
      {
  ...
  protected void b(View paramView)
  {
    ...
    {
      bdjg.a(localFileManagerEntity.Uuid, paramView, this.jdField_a_of_type_Int, localFileManagerEntity, paramView.app);
      return;
    }
    atpw localatpw = new atpw(paramView.app, paramView, localFileManagerEntity, 10001);
    ...
    localatpw.a(localBundle);
    paramView = new atpy(paramView, localatpw);
    paramView.a(7);
    if (this.jdField_a_of_type_Int != 0) {
      paramView.a(this.jdField_a_of_type_Int);
    }
    paramView.a(anni.a(2131703296));
    paramView.a();
  }
  ...
  public boolean b()
  {
    ...
    if (localFileManagerEntity != null) {
      return athc.a(localFileManagerEntity);
    }
    return false;
  }
  ...
  public String c()
  {
    ...
    {
      if (localFileManagerEntity.nFileType == 13) {
        localObject1 = bdjg.f(localFileManagerEntity.Uuid);
      }
      return localObject1;
      if (i == 5) {
  ...
  protected void c(View paramView)
  {
    FileManagerEntity localFileManagerEntity = (FileManagerEntity)this.jdField_a_of_type_JavaUtilList.get(0);
    paramView = (BaseActivity)paramView.getContext();
    if (athc.a(localFileManagerEntity)) {
      athc.b(localFileManagerEntity);
    }
    for (;;)
    {
      if ((localFileManagerEntity.cloudType == 3) && (!atwl.b(localFileManagerEntity.getFilePath())))
      {
        atvf.a(atvo.d(localFileManagerEntity.fileName) + anni.a(2131708384));
        athc.b(localFileManagerEntity);
      }
      return;
      athc.a(localFileManagerEntity);
      bcst.b(null, "dc00898", "", "", "0X800AA91", "0X800AA91", 1, 0, "0", "0", "", "");
    }
  }
  ...
  public CharSequence d()
  {
    ...
    if (j > 1)
    {
      ...
      ((SpannableStringBuilder)localObject1).append("\"").append(anni.a(2131692126));
    ...
    if (str.indexOf(anni.a(2131692117)) == 0) {
      localSpannableStringBuilder.append(anni.a(2131692117) + " ");
    }
    for (;;)
    {
      localObject1 = str;
      ...
      try
      {
        ...
        return this.jdField_b_of_type_JavaLangCharSequence;
        if (str.indexOf(anni.a(2131692121)) == 0)
        {
          localSpannableStringBuilder.append(anni.a(2131692121) + " ");
        }
        else if (str.indexOf(anni.a(2131692118)) == 0)
        {
          localSpannableStringBuilder.append(anni.a(2131692118) + " ");
          i = 4;
        }
        else if (str.indexOf(anni.a(2131692122)) == 0)
        {
          localSpannableStringBuilder.append(anni.a(2131692122) + " ");
          i = 4;
        }
        else if (str.indexOf(anni.a(2131692116)) == 0)
        {
          localSpannableStringBuilder.append(anni.a(2131692116) + " ");
          i = 2;
        }
        else if (str.indexOf(anni.a(2131692120)) == 0)
        {
          localSpannableStringBuilder.append(anni.a(2131692120) + "  ");
          i = 2;
        }
        else if (str.indexOf(anni.a(2131692119)) == 0)
        {
          localSpannableStringBuilder.append(anni.a(2131692119));
          i = 2;
        }
      }
  ...
  public int e()
  {
    ...
    if (localFileManagerEntity != null)
    {
      ...
      return atvo.a(localFileManagerEntity.fileName);
    }
    return 11;
  }
}
