...
public class nlx
  extends Handler
{
  public nlx(ReadInJoyUploadAvatarActivity paramReadInJoyUploadAvatarActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
    default: 
      localBundle.putString("msg", ajjy.a(2131647235));
    ...
    for (;;)
    {
      ...
      localBundle.putString("msg", ajjy.a(2131647294));
      localIntent.putExtra("Bundle", localBundle);
      this.a.setResult(-1, localIntent);
    }
  }
