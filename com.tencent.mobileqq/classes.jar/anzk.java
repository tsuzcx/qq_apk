  ...
  extends anzt
{
  ...
  public anzk(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramInt1);
  ...
  {
    if (jdField_a_of_type_Anzm != null)
    {
      jdField_a_of_type_Anzm.a();
      jdField_a_of_type_Anzm = null;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (jdField_a_of_type_Anzm == null) {
        jdField_a_of_type_Anzm = new anzm();
      }
    } while (jdField_a_of_type_Anzm.a(paramInt, localView));
  }
  ...
  public View b(int paramInt)
  {
    ...
    if (jdField_a_of_type_Anzm != null) {
      localView1 = jdField_a_of_type_Anzm.a(i);
    }
