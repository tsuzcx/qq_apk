...
public abstract class aggy
  implements agfx, Handler.Callback, TextWatcher, View.OnClickListener, bfoa, bfob, bftk, Observer
{
  static int e;
  ...
  aggb jdField_a_of_type_Aggb;
  private ajxl jdField_a_of_type_Ajxl = new aghd(this);
  akqs jdField_a_of_type_Akqs;
  public Context a;
  ...
  bbjt jdField_a_of_type_Bbjt = new agha(this);
  ...
  public aggy(Context paramContext, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  private void A()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848763);
  ...
  private void B()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844029);
      localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368441);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849066));
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367906);
      Object localObject = localImageView.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = actn.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = actn.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849538));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166851));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166851));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setAlpha(0.8F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844028);
    ImageView localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368441);
    localImageView.setBackgroundResource(0);
    if (axmt.b()) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843966));
    }
    for (;;)
    {
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367906);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849539));
      return;
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849067));
    }
  }
  ...
  private void C()
  {
    ...
    mqn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, 3);
  }
  ...
  private void F()
  {
    ...
    List localList1 = this.jdField_a_of_type_Agfy.a();
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView == null)
    {
      ...
      ((TextView)localObject1).setId(2131370505);
      ((TextView)localObject1).setBackgroundResource(2130838189);
  ...
  {
    return this.jdField_a_of_type_Aggb.a(paramInt);
  }
  ...
  public SpannableString a(boolean paramBoolean)
  {
    ...
    {
      bool1 = true;
      str1 = bbcl.a(localQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_Int, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mSourceMsgSenderUin + "");
    ...
    {
      localObject = bafh.a(localQQAppInterface, localContext, str2, str3, str1, bool1, localXEditTextEx, bool2, true);
  ...
  {
    if (paramView == null) {
      paramLayoutInflater = paramLayoutInflater.inflate(2131558759, paramViewGroup, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramLayoutInflater.findViewById(2131362189));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364076));
  ...
  protected void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams = new WindowManager.LayoutParams(-1, bbjr.a(0), 2, 32, -1);
    ...
    this.jdField_a_of_type_Bbjr = new bbjr(((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Bbjt);
    this.jdField_j_of_type_Int = this.jdField_a_of_type_Bbjr.a();
    this.jdField_j_of_type_Int = bbjr.a(this.jdField_j_of_type_Int);
    paramContext = new aghb(this);
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      int k = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559018, null));
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new aghc(this));
      return;
    }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt, long paramLong, String paramString)
  {
    ...
    do
    {
      return;
      if (paramLong == 0L) {
        adyh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(paramChatMessage.senderuin));
      }
      paramString = aevf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage, paramInt, paramLong, paramString);
    ...
    paramString = bafk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo, paramInt - k, this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getPaint(), null);
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTag(2131372737, paramString);
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setMovementMethod(bafj.a());
  ...
  protected void a(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    this.jdField_a_of_type_Agfy.a(paramList2, null, 0);
    ...
    if (paramBoolean)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getOverScrollHeaderView() == null)
      {
        if (this.jdField_a_of_type_AndroidViewView == null) {
          this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558825, null);
        }
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_Aggb = new aggb(this);
    this.jdField_a_of_type_Aggb.a(2);
    b();
    e();
    g();
    d();
    ...
    x();
    a();
    this.jdField_a_of_type_Akqs = new akqs();
    this.jdField_a_of_type_Akqs.a = new acuw(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Akqs.jdField_h_of_type_Boolean = true;
    return true;
  }
  ...
  protected void b(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    default: 
      if (localaghm != null) {
        this.jdField_g_of_type_Int = localaghm.a(paramList1, paramList2, this.jdField_g_of_type_Int);
      }
      break;
    }
    for (;;)
    {
      ...
      return;
      k = aghm.b(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
      if (k != 0)
      {
      ...
      if (localaghm != null)
      {
        ...
        if (localaghm != null)
        {
          this.jdField_g_of_type_Int = localaghm.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
          continue;
          if (localaghm != null)
          {
            localaghm.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, 0, paramList1, paramList2);
            k = paramList1.size();
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 == 0)
    {
      paramCharSequence = (bafh[])this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().getSpans(paramInt1, paramInt1 + paramInt2, bafh.class);
  ...
  protected void d()
  {
    ...
    {
      if (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))) {
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130848963);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130849156);
  }
  ...
  protected void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369274));
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getHeaderViewsCount() == 0)
    {
      ...
      ((View)localObject).setId(2131362315);
    ...
    this.jdField_a_of_type_Agfy.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    Object localObject = this.jdField_a_of_type_Agfy;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 3) {}
    for (boolean bool = true;; bool = false)
    {
      ((agfy)localObject).a(bool);
  ...
  protected void g()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375327));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377350));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368429));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131375334));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377431));
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    ImageView localImageView1 = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368441);
    localImageView1.setOnClickListener(this);
    if ((this.jdField_e_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368436));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
    {
      ImageView localImageView2 = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367906);
      Object localObject = localImageView2.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = actn.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = actn.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView2.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView2.setImageResource(2130849031);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localImageView1.setImageResource(2130849151);
      if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void h()
  {
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368187));
    ...
    i();
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368186));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131366883));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      Object localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371243);
      ((PanelIconLinearLayout)localObject).setPanelIconListener(new aggz(this));
      if (this.jdField_d_of_type_Boolean)
      {
        ((PanelIconLinearLayout)localObject).setCustomHeight(actn.a(50.0F, ((PanelIconLinearLayout)localObject).getContext().getResources()));
        ...
        {
          localObject = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368195);
          if (localObject != null) {
            ((View)localObject).setBackgroundResource(2130848770);
          }
          this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130848770);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130848771);
          this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838098);
          this.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166840));
        }
        localObject = new aghe(this, null);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      a(paramMessage.arg1);
      continue;
      aebz.a(paramMessage, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      continue;
      boolean bool = bbkv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      if (QLog.isColorLevel()) {
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_Aggb.a(4);
  ...
  public void l()
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if ((localakpc != null) && (localakpc.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int) > 0))
      {
        if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_Aggb.a(8);
  ...
  public void n()
  {
    this.jdField_a_of_type_Aggb.a(3);
  }
  ...
  public void o()
  {
    ...
    this.jdField_a_of_type_Aggb.a(9);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131368441: 
      ...
      Intent localIntent = actn.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 0, 2 });
      ...
      if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface)) {
        ((aggl)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(147)).a();
      }
      aggn.a().d();
    ...
    case 2131366883: 
      ...
      axqw.b(null, "dc00898", "", "", "0X800A194", "0X800A194", k, 1, "", "", "", "");
      return;
    case 2131368186: 
      if (QLog.isColorLevel()) {
    ...
    case 2131362263: 
      ...
      if (this.jdField_i_of_type_Int == 0)
      {
        ...
        paramView.setImageResource(2130839620);
        this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
        t();
        return;
      }
      this.jdField_i_of_type_Int = 0;
      paramView.setImageResource(2130839619);
      s();
      return;
    case 2131370505: 
      this.jdField_g_of_type_Int = this.jdField_a_of_type_Agfy.getCount();
  ...
  {
    paramAbsListView = (aghm)a(1);
    if (paramAbsListView != null) {
      paramAbsListView.a(paramInt1, paramInt2, paramInt3);
    }
    this.jdField_a_of_type_Aggb.a(17);
  }
  ...
  public void p()
  {
    ...
    this.jdField_a_of_type_Aggb.a(11);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
    this.jdField_a_of_type_Aggb.a(10);
  ...
  protected void u()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Agfy.a(localList, null, 0);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          if (!(paramObject instanceof akqs)) {
            break;
          }
          paramObservable = (akqs)paramObject;
          paramObject = (acuw)paramObservable.a;
  ...
  protected void v()
  {
    if ((this.jdField_a_of_type_Agfy != null) && (this.jdField_a_of_type_Agfy.getCount() > 0))
    {
      this.jdField_a_of_type_Long = SystemClock.uptimeMillis();
      ((acuw)this.jdField_a_of_type_Akqs.a).a(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Akqs.jdField_e_of_type_Boolean = false;
  ...
  protected void w()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362263));
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    actn.a(this.jdField_a_of_type_AndroidWidgetImageButton, (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), 0, 0);
    if (this.jdField_d_of_type_Boolean) {
  ...
  public void x()
  {
    ...
    if ((k != 1033) && (k != 1034))
    {
      ...
      axqd.a(1, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, k);
    }
  ...
  public void z()
  {
    ...
    if (localChatMessage != null) {
      a(localChatMessage, 0, adyh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(localChatMessage.senderuin)), null);
    }
  }
}
