  ...
  implements View.OnTouchListener
{
  ...
  public aggy(Context paramContext, ViewGroup paramViewGroup, int[] paramArrayOfInt, int paramInt, aggx paramaggx, PhotoListPanel paramPhotoListPanel)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_a_of_type_ArrayOfInt = paramArrayOfInt;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Aggx = paramaggx;
    ...
    for (this.jdField_b_of_type_Aghd = new aghb(this, paramContext, paramViewGroup);; this.jdField_b_of_type_Aghd = new aghd(this, paramContext, paramViewGroup))
    {
      this.jdField_c_of_type_Aghd = new aggz(this, paramContext, paramViewGroup);
      return;
    }
  }
  ...
  {
    LocalMediaInfo localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.a(paramInt1);
    int i = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.getItemViewType(paramInt1);
    float f1;
    if (i == 1) {
    ...
    for (;;)
    {
      awen.a("PhotoListPanel", "calcuEndScale", "position = " + paramInt1 + ",scale = " + f1 + ",mediaType = " + i + ",info.mediaWidth = " + localLocalMediaInfo.mediaWidth + ",info.mediaHeight = " + localLocalMediaInfo.mediaHeight + ",sideLength = " + paramInt2);
      return f1;
  ...
  float a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      awen.a("PhotoListPanel", "calcuEndScale", "position = " + paramInt1 + ",scale = " + f1 + ",mediaType = " + i + ",info.mediaWidth = " + localLocalMediaInfo.mediaWidth + ",info.mediaHeight = " + localLocalMediaInfo.mediaHeight);
      return f1;
      if ((localLocalMediaInfo.mediaWidth > 100) || (localLocalMediaInfo.mediaHeight > 100)) {
  ...
  aghd a(MotionEvent paramMotionEvent, float paramFloat1, float paramFloat2)
  {
    boolean bool5 = false;
    boolean bool4 = false;
    boolean bool1;
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      for (bool3 = true;; bool3 = false)
      {
        ...
        awen.a("PhotoListPanel", "detectGesture", "Xvelocity=" + this.jdField_a_of_type_AndroidViewVelocityTracker.getXVelocity(i) + "Yvelocity=" + f1 + ",delX = " + paramFloat1 + ", delY = " + paramFloat2 + "tanA = " + Math.abs(paramFloat1 / paramFloat2) + ",Angle A = " + Math.toDegrees(Math.atan(Math.abs(paramFloat1 / paramFloat2))) + ",Velocity Angle = " + Math.toDegrees(Math.atan(Math.abs(this.jdField_a_of_type_AndroidViewVelocityTracker.getXVelocity(i) / f1))) + " vThresh = " + bool1 + ",direction = " + bool2 + ",anc = " + bool3 + ",satate = " + bool4 + ",mGestureHandler = " + this.jdField_a_of_type_Aghd);
        awen.a("PhotoListPanel", "detectGesture", "mActivePointerId x = " + paramMotionEvent.getX() + ",mActivePointerId y = " + paramMotionEvent.getY());
        if ((this.jdField_a_of_type_Aghd != null) || (!bool2) || (!bool3) || (!bool4)) {
          break label775;
        }
        awen.a("PhotoListPanel", "detectGesture", "return mDragHandler.");
        return this.jdField_c_of_type_Aghd;
        bool1 = false;
        break;
        bool2 = false;
        break label81;
    ...
    for (boolean bool3 = true;; bool3 = false)
    {
      ...
      awen.a("PhotoListPanel", "detectGesture", "2 mActivePointerId x = " + paramMotionEvent.getX() + ",mActivePointerId y = " + paramMotionEvent.getY());
      if ((this.jdField_a_of_type_Aghd != null) || (!bool2) || (!bool3) || (!bool4) || (!bool1)) {
        break label775;
      }
      this.jdField_a_of_type_Boolean = true;
      awen.a("PhotoListPanel", "detectGesture", "return mFlingHandler.");
      return this.jdField_b_of_type_Aghd;
      bool1 = false;
      break;
      label763:
      bool2 = false;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Aghd != null)
    {
      ...
      this.jdField_a_of_type_Aghd = null;
    }
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewVelocityTracker == null)
    {
      ...
      awen.a("PhotoListPanel", "onTouch", " touchFirstActtion,mActivePointerId x = " + paramMotionEvent.getX() + ",mActivePointerId y = " + paramMotionEvent.getY());
      this.jdField_a_of_type_Aghd = null;
  ...
  public void b()
  {
    if ((this.jdField_c_of_type_Aghd != null) && (this.jdField_c_of_type_Aghd.a())) {
      this.jdField_c_of_type_Aghd.b();
    }
    while ((this.jdField_b_of_type_Aghd == null) || (!this.jdField_b_of_type_Aghd.a())) {
      return;
    }
    this.jdField_b_of_type_Aghd.b();
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    awen.a("PhotoListPanel", "onTouch", "x = " + f1 + ",y = " + f2 + ",event = " + paramMotionEvent + ", mPanel.mDisableGuestrueSend = " + this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Boolean);
    ...
    {
      return false;
      awen.a("PhotoListPanel", "onTouch", " ACTION_DOWN,x = " + f1 + ",y = " + f2);
      this.jdField_a_of_type_Float = paramMotionEvent.getX();
      this.jdField_b_of_type_Float = paramMotionEvent.getY();
      if (!this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Boolean)
      {
        awen.a("PhotoListPanel", "onTouch", " ACTION_DOWN,x = " + paramMotionEvent.getX() + ",y = " + paramMotionEvent.getY());
        a(paramMotionEvent);
        continue;
        awen.a("PhotoListPanel", "onTouch", " ACTION_MOVE,x = " + f1 + ",y = " + f2 + ",mGestureHandler = " + this.jdField_a_of_type_Aghd);
        ...
        paramView = (aggv)this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.findViewHolderForAdapterPosition(this.jdField_c_of_type_Int);
        if (paramView == null) {
          return false;
        }
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          {
            this.jdField_a_of_type_Aghd = a(paramMotionEvent, f1 - f3, f2 - f4);
            if (this.jdField_a_of_type_Aghd != null) {
              return this.jdField_a_of_type_Aghd.a(paramView, this.jdField_c_of_type_Int);
            }
          }
        }
        else if (this.jdField_a_of_type_Aghd != null) {
          return this.jdField_a_of_type_Aghd.a(paramMotionEvent);
        }
        awen.a("PhotoListPanel", "onTouch", "f ACTION_MOVE,x = " + f1 + ",y = " + f2);
        continue;
        if (PhotoListPanel.g() == 1) {
          this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
        }
        if (this.jdField_a_of_type_Aghd != null)
        {
          boolean bool2 = this.jdField_a_of_type_Aghd.b(paramMotionEvent);
          this.jdField_a_of_type_Aghd = null;
          bool1 = bool2;
          if (this.jdField_a_of_type_AndroidViewVelocityTracker == null) {
            break;
        ...
        {
          awen.a("PhotoListPanel", "onTouch", " ACTION_UP,eat up event.dx = " + Math.abs(f1 - this.jdField_a_of_type_Float) + ",dy = " + Math.abs(f2 - this.jdField_b_of_type_Float) + ",duration = " + l);
          return true;
        }
        awen.a("PhotoListPanel", "onTouch", "f ACTION_UP,x = " + f1 + ",y = " + f2);
        continue;
        if (PhotoListPanel.g() == 1) {
          this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
        }
