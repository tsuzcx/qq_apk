...
public class aiwu
{
  ...
  public static int a()
  {
    arjq localarjq = arjr.a();
    if (QLog.isColorLevel()) {
      QLog.i("TroopMsgSameFold", 2, "getConfigSwitch = " + localarjq.jdField_a_of_type_Int);
    }
    return localarjq.jdField_a_of_type_Int;
  }
  ...
  public static ChatMessage a(QQAppInterface paramQQAppInterface, Resources paramResources, List<ChatMessage> paramList, int[] paramArrayOfInt)
  {
    ...
    paramList = new avpd((String)localObject, str, paramResources, paramArrayOfInt.istroop, -5040, 2, l);
  ...
  {
    String str3 = paramResources.getString(2131718899);
    String str2 = paramResources.getString(2131718898);
    int i = bhtq.a() - bhtq.a(57.0F) - BaseChatItemLayout.y;
    paramList.size();
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break;
        str1 = bhlg.h(paramQQAppInterface, str5, (String)localObject);
        if (!TextUtils.isEmpty(str1))
        {
          paramList = str1;
        ...
        {
          paramList = bhlg.a(paramQQAppInterface, (String)localObject);
        }
      }
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      bdll.b(null, "dc00898", "", "", "0X800ADF2", "0X800ADF2", paramInt, 1, paramChatMessage.frienduin, "" + paramChatMessage.shmsgseq, "", "");
      return;
    }
  }
  ...
  public static boolean a()
  {
    arjq localarjq = arjr.a();
    if (QLog.isColorLevel()) {
      QLog.i("TroopMsgSameFold", 2, "getConfigSwitch = " + localarjq.jdField_a_of_type_Boolean);
    }
    return localarjq.jdField_a_of_type_Boolean;
  }
  ...
  private static boolean a(DisplayMetrics paramDisplayMetrics, int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      if (QLog.isDevelopLevel())
      {
        ...
        QLog.d("TroopMsgSameFold", 4, "test.a = " + localTextPaint.measureText("a") + ",中 = " + localTextPaint.measureText("中") + ",screenW = " + bhtq.a());
  ...
  public static int b()
  {
    arjq localarjq = arjr.a();
    if (QLog.isColorLevel()) {
      QLog.i("TroopMsgSameFold", 2, "getConfigSwitch = " + localarjq.b);
    }
    return localarjq.b;
  }
