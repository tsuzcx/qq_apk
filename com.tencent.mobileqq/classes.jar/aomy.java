  ...
  extends aojt
{
  ...
  {
    paramQQAppInterface = new aomx(paramQQAppInterface, paramContext);
        ...
        catch (Exception paramaojw)
        {
          for (;;)
          {
            if (QLog.isColorLevel()) {
              QLog.d("WeishiPublicAccountVideoParser", 2, "failed to decode param value,tmps[1] is:" + paramString[0] + ",tmps[1] is:" + paramString[1], paramaojw);
            }
          }
        }
      }
