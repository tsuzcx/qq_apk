...
public class abfw
{
  ...
  private static abfw jdField_a_of_type_Abfw;
  abmk jdField_a_of_type_Abmk;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new abfz(this);
  private Context jdField_a_of_type_AndroidContentContext = BaseApplicationImpl.getContext();
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new abfy(this);
  private BluetoothLeService jdField_a_of_type_ComTencentDeviceQfindBluetoothLeService;
  private List<abmk> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Set<abmk> jdField_a_of_type_JavaUtilSet = new HashSet();
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new abfx(this, Looper.getMainLooper());
  private boolean jdField_a_of_type_Boolean;
  private List<abmk> b = new ArrayList();
  private List<abmk> c = new ArrayList();
  ...
  {
    if ((jdField_a_of_type_Abfw == null) && (BaseApplicationImpl.getContext().getPackageManager().hasSystemFeature("android.hardware.bluetooth_le"))) {
      jdField_a_of_type_Abfw = new abfw();
    }
    return jdField_a_of_type_Abfw;
  }
  ...
  {
    if (jdField_a_of_type_Abfw != null) {
      jdField_a_of_type_Abfw.a();
    }
  }
  
  public abmk a(int paramInt)
  {
    if ((this.jdField_a_of_type_Abmk != null) && (this.jdField_a_of_type_Abmk.jdField_a_of_type_Int == paramInt)) {
      return this.jdField_a_of_type_Abmk;
    }
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    abmk localabmk;
    while (localIterator.hasNext())
    {
      localabmk = (abmk)localIterator.next();
      if (localabmk.jdField_a_of_type_Int == paramInt) {
        return localabmk;
      }
    }
  ...
  public abmk a(String paramString)
  {
    if ((this.jdField_a_of_type_Abmk != null) && (this.jdField_a_of_type_Abmk.a().equals(paramString))) {
      return this.jdField_a_of_type_Abmk;
    }
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    abmk localabmk;
    ...
    {
      localabmk = (abmk)localIterator.next();
      if (localabmk.a().equals(paramString)) {
        return localabmk;
      }
    }
    localIterator = this.jdField_a_of_type_JavaUtilSet.iterator();
  ...
  public void a(abmk paramabmk)
  {
    QLog.i("DeviceBLE2", 2, "disConnectPeer " + paramabmk.a());
    if (this.jdField_a_of_type_JavaUtilList.contains(paramabmk))
    {
      this.jdField_a_of_type_JavaUtilSet.add(paramabmk);
      this.jdField_a_of_type_JavaUtilList.remove(paramabmk);
      this.jdField_a_of_type_ComTencentDeviceQfindBluetoothLeService.a(paramabmk.jdField_a_of_type_Int);
    }
    for (;;)
    {
      ...
      return;
      if (paramabmk == this.jdField_a_of_type_Abmk)
      {
        this.jdField_a_of_type_Abmk = null;
        this.jdField_a_of_type_JavaUtilSet.add(paramabmk);
        this.jdField_a_of_type_ComTencentDeviceQfindBluetoothLeService.a(paramabmk.jdField_a_of_type_Int);
      }
      else if (this.c.contains(paramabmk))
      {
        this.c.remove(paramabmk);
      }
    }
  }
  ...
  public boolean a(abmk paramabmk)
  {
    boolean bool = false;
    if (((this.jdField_a_of_type_Abmk != null) && (this.jdField_a_of_type_Abmk.b.equals(paramabmk.b))) || (this.jdField_a_of_type_JavaUtilList.contains(paramabmk))) {
      bool = true;
    }
    do
    {
      do
      {
        ...
        {
          return bool;
          if (this.jdField_a_of_type_Abmk == null) {
            break;
          }
        } while (this.c.contains(paramabmk));
        this.c.add(paramabmk);
        return false;
        if (this.jdField_a_of_type_ComTencentDeviceQfindBluetoothLeService == null) {
          break;
        }
      } while (!this.jdField_a_of_type_ComTencentDeviceQfindBluetoothLeService.a(paramabmk.jdField_a_of_type_Int, paramabmk.b));
      this.jdField_a_of_type_Abmk = paramabmk;
      return true;
    } while (this.c.contains(paramabmk));
    this.c.add(paramabmk);
    return false;
