...
public class alnv
{
  ...
  public alnv(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.b = paramInt1;
    this.c = paramInt2;
    this.d = paramInt3;
  ...
  public void a(Canvas paramCanvas, Paint paramPaint, alnr paramalnr)
  {
    int i = paramPaint.getColor();
    float f1 = paramPaint.getStrokeWidth();
    paramPaint.setColor(paramalnr.b);
    paramPaint.setStrokeWidth(paramalnr.e);
    paramCanvas.drawLine(this.b, this.d, this.c, this.d, paramPaint);
    paramalnr = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (paramalnr.hasNext())
    {
      Point localPoint = (Point)paramalnr.next();
