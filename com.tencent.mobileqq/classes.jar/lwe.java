...
public class lwe
{
  ...
  static volatile lwe jdField_a_of_type_Lwe;
  ...
  private void c()
  {
    ...
    //   3: dup
    //   4: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   91: aload 4
    //   93: iconst_1
    //   94: invokevirtual 199	lwe:a	(Ljava/lang/String;Z)Z
    //   97: ifne -38 -> 59
    //   100: aload_3
    ...
    //   115: astore_3
    //   116: aload_0
    //   117: getfield 36	lwe:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   194: aload 4
    //   196: aload_0
    //   197: getfield 29	lwe:jdField_a_of_type_Long	J
    ...
    //   253: aload_0
    //   254: aload 4
    //   256: invokespecial 256	lwe:a	(Ljava/lang/String;)Ljava/lang/String;
    //   259: astore_2
    //   260: aload_0
    //   261: getfield 36	lwe:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   319: aload_0
    //   320: aload 4
    //   322: invokespecial 263	lwe:a	(Ljava/lang/String;)V
    //   325: iload_1
    //   326: iconst_1
    //   327: iadd
    //   328: istore_1
    ...
    //   406: invokestatic 295	axrl:a	(Landroid/content/Context;)Laxrl;
    //   409: aload_2
    //   410: ldc_w 297
    //   413: iconst_1
    //   414: lconst_0
    ...
    //   418: ldc 19
    //   420: iconst_1
    //   421: invokevirtual 300	axrl:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   424: aload_0
    //   425: aload 4
    //   427: invokespecial 263	lwe:a	(Ljava/lang/String;)V
    //   430: goto -105 -> 325
    //   433: astore 4
    //   435: goto -306 -> 129
    //   438: astore 4
  ...
  private void d()
  {
    ...
    //   605: iload_2
    //   606: invokevirtual 374	lwe:a	(Ljava/lang/String;JJJJJI)Z
    //   609: pop
    //   610: aload 12
  ...
  boolean a(String paramString, long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, int paramInt)
  {
    ...
    //   185: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   344: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   467: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   586: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   723: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  boolean a(String paramString, boolean paramBoolean)
  {
    ...
    //   27: getstatic 21	lwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   43: invokestatic 442	vyi:b	(Ljava/io/File;)[B
    ...
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 36	lwe:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   213: aload 5
    //   215: aload 7
    //   217: invokevirtual 465	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   220: pop
    //   221: aload_0
    //   222: getfield 38	lwe:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   225: aload 5
    //   227: aload_1
    ...
    //   245: ifnull +7 -> 252
    //   248: aload_1
    //   249: invokevirtual 454	java/io/ByteArrayInputStream:close	()V
    //   252: aload 5
    //   254: ifnull +8 -> 262
    //   257: aload 5
