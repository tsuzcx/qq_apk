  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = paramView.getTag(2131376579);
    if ((localObject1 != null) && ((localObject1 instanceof axzz)))
    {
      localObject7 = (axzz)localObject1;
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          l1 = l2;
          if (((axzz)localObject7).a.getDrawable() != null)
          {
            l1 = l2;
            if ((((axzz)localObject7).a.getDrawable() instanceof URLDrawable))
            {
              localObject3 = (URLDrawable)((axzz)localObject7).a.getDrawable();
              l1 = l2;
          ...
          paramView = (String)paramView.getTag(2131376585);
        } while (TextUtils.isEmpty(paramView));
        String str = bfnx.a(bfnx.a(paramView, "progress", String.valueOf(l1)), "msgId", (String)localObject1);
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            try
            {
              ...
              localObject7 = new nqx();
              ((nqx)localObject7).a = 3;
              ((nqx)localObject7).f = 1;
              localObject7 = nqu.a((nqx)localObject7, this.a.a.message);
              ((nqu)((QQAppInterface)localObject5).a(139)).a((nqx)localObject7, null);
              Long.parseLong((String)localObject1);
              if (this.a.a != null) {
                localObject5 = (axup)((AbsShareMsg)this.a.a).mStructMsgItemLists.get(0);
              }
              ...
              paramView = (nqn)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(88);
              if (paramView == null) {
                break;
              }
