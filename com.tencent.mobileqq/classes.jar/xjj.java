...
public class xjj
{
  ...
  public xjj(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3)
  {
    this.b = paramString1;
  ...
  public View a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (ClassNotFoundException localClassNotFoundException)
      {
        ...
        try
        {
          paramString = (View)localObject.getConstructor(new Class[] { Context.class }).newInstance(new Object[] { this.jdField_a_of_type_Xje });
          return paramString;
        }
  ...
  public void a(myz parammyz, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!mzb.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext(), str, new xjk(this, l, localContext, paramBoolean, parammyz))) && (QLog.isColorLevel())) {
