  ...
  extends aarm
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    {
      bevx.b("TroopFileUploadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult.but stoped");
      return;
    }
    if ((paramResendRspBody == null) || (!paramBoolean))
    {
      bevx.a("TroopFileUploadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult isSuccess:false  errCode:" + paramInt);
      paramResendRspBody = new bfrj(this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, this.a.d, 3, 207);
      this.a.jdField_a_of_type_Bevi.c = 1;
      this.a.jdField_a_of_type_Bevi.d = paramInt;
      this.a.a(true, bfuj.b, bfuj.A, paramResendRspBody);
      return;
    }
    int i = paramResendRspBody.int32_ret_code.get();
    bevx.c("TroopFileUploadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult isSuccess:true  errCode:" + paramInt + " retCode:" + i);
    if (i < 0)
    {
      ...
      for (;;)
      {
        ...
        bevg.b(this.a.d, this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, paramInt);
        this.a.a(false, bfuj.c, i);
        return;
        paramInt = 101;
        continue;
        paramInt = 102;
      ...
      this.a.a(true, bfuj.c, i, paramInt);
      return;
    }
