  ...
  extends ajfb
{
  ...
  ajrv jdField_a_of_type_Ajrv = new xvt(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new xvs(this);
  public HashMap<String, List<xsw>> a;
  private List<Long> jdField_a_of_type_JavaUtilList = new ArrayList();
  public ConcurrentHashMap<Long, MessageRecord> a;
  public xsp a;
  private xsw jdField_a_of_type_Xsw = new xvr(this);
  public xvk a;
  ...
  public xvq(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Xsw);
    this.jdField_a_of_type_Xvo = new xvo(paramQQAppInterface);
    this.jdField_a_of_type_Xvk = new xvk(paramQQAppInterface);
    this.jdField_a_of_type_Xsp = new xsp();
    this.jdField_a_of_type_Xvp = new xvp(paramQQAppInterface);
    a(f, this.jdField_a_of_type_Xsp);
    a(e, this.jdField_a_of_type_Xsp);
    a(g, this.jdField_a_of_type_Xsp);
    a(g, this.jdField_a_of_type_Xvk);
    a(g, this.jdField_a_of_type_Xvp);
    a(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Xvo);
    a(c, this.jdField_a_of_type_Xvo);
    a(d, this.jdField_a_of_type_Xvo);
    a(h, this.jdField_a_of_type_Xvo);
    a("8000-NASDevMusicFile", this.jdField_a_of_type_Xvo);
    a("8001-NASDevVideoFile", this.jdField_a_of_type_Xvo);
    a("8002-NASDevDocumentFile", this.jdField_a_of_type_Xvo);
    a("8003-NASDevCommonFile", this.jdField_a_of_type_Xvo);
    a("", this.jdField_a_of_type_Xvo);
    a("", this.jdField_a_of_type_Xsp);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Ajrv);
    paramQQAppInterface = (ajru)paramQQAppInterface.a(34);
  ...
  private void a()
  {
    DeviceInfo[] arrayOfDeviceInfo = ((xrh)this.app.a(51)).a();
  ...
  {
    MessageForDeviceText localMessageForDeviceText = (MessageForDeviceText)awbi.a(-4508);
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong)
  {
    ...
    String str = aaek.f + "http://maps.google.com/maps?q=" + paramString2 + "," + paramString3 + "&iwloc=A&hl=zh-CN (" + paramString5 + ")";
    if (!paramContext.getResources().getString(2131630691).equals(paramString4)) {}
    for (paramContext = paramContext.getResources().getString(2131625719) + " " + paramString4;; paramContext = paramContext.getResources().getString(2131625719))
    {
      ...
      paramContext = new awui(StructMsgForGeneralShare.class).c(32).a(paramContext).d(str).a("plugin", paramString2, paramString2, paramString2, paramString2).a();
      ...
      paramContext = awbi.a(this.app, this.app.getCurrentAccountUin(), paramString1, this.app.getCurrentAccountUin(), 9501, 100L, paramContext);
  ...
  public xsp a()
  {
    return this.jdField_a_of_type_Xsp;
  }
  
  public xvk a()
  {
    return this.jdField_a_of_type_Xvk;
  }
  
  public xvo a()
  {
    return this.jdField_a_of_type_Xvo;
  }
  
  public xvp a()
  {
    return this.jdField_a_of_type_Xvp;
  }
  ...
  public void a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      long l = ((JSONObject)localObject).optLong("msg_time", awao.a());
  ...
  {
    ArrayList localArrayList = azzz.a(paramString, 560, 20, null, new ArrayList());
    int i = 0;
    if (i < localArrayList.size())
    {
      ...
      paramString = "";
      if (str1 != null) {
        paramString = awbk.a(str1, true, null);
      }
      int j = (int)awao.a();
      ...
      localMessageForDeviceText.shmsgseq = awbk.a(i, paramSessionInfo.jdField_a_of_type_Int);
      ...
      for (;;)
      {
        if (localMessageForDeviceText.extraflag != 32768)
        {
          ...
          ((xrh)paramQQAppInterface.a(51)).a(localMessageForDeviceText.msg, Long.parseLong(localMessageForDeviceText.frienduin), l, localMessageForDeviceText.msgseq);
        }
        i += 1;
        break;
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    default: 
      paramInt = i;
      localMessageForGrayTips = (MessageForGrayTips)awbi.a(paramInt);
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      i = -5001;
      localMessageForNewGrayTips = (MessageForNewGrayTips)awbi.a(i);
  ...
  public boolean a(String paramString, xsw paramxsw)
  {
    ...
    if (!((List)localObject).contains(paramxsw)) {
      ((List)localObject).add(paramxsw);
    }
    return true;
  }
  
  public boolean b(String paramString, xsw paramxsw)
  {
    paramString = (List)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {
      paramString.remove(paramxsw);
    }
    return true;
  }
  ...
  {
    super.onDestroy();
    b(f, this.jdField_a_of_type_Xsp);
    b(e, this.jdField_a_of_type_Xsp);
    b(g, this.jdField_a_of_type_Xsp);
    b(g, this.jdField_a_of_type_Xvk);
    b(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Xvo);
    b(c, this.jdField_a_of_type_Xvo);
    b(d, this.jdField_a_of_type_Xvo);
    b(h, this.jdField_a_of_type_Xvo);
    b("8000-NASDevMusicFile", this.jdField_a_of_type_Xvo);
    b("8001-NASDevVideoFile", this.jdField_a_of_type_Xvo);
    b("8002-NASDevDocumentFile", this.jdField_a_of_type_Xvo);
    b("8003-NASDevCommonFile", this.jdField_a_of_type_Xvo);
    b("", this.jdField_a_of_type_Xvo);
    b("", this.jdField_a_of_type_Xsp);
    this.app.removeObserver(this.jdField_a_of_type_Xsw);
    this.app.getApp().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.app.removeObserver(this.jdField_a_of_type_Ajrv);
    this.jdField_a_of_type_Xvo = null;
    this.jdField_a_of_type_Xvk = null;
    this.jdField_a_of_type_Xsp = null;
    this.jdField_a_of_type_Xvp = null;
  }
