...
{
  public static final String a = anhk.ba + "hotvideo/preview/";
  ...
  public static Drawable a(Context paramContext, HotVideoData paramHotVideoData)
  {
    ...
    paramHotVideoData = avdc.a(paramHotVideoData, 10.0F, paramContext);
  ...
  private void a(File paramFile, HotVideoData paramHotVideoData, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramFile = new bhhf(paramHotVideoData.url.replaceFirst("https", "http"), localFile);
    paramFile.n = true;
    paramFile.b = 2;
    int i = bhhh.a(paramFile, null, null);
    if (i == 0)
    {
      paramFile = azby.a(localFile.getAbsolutePath());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramURLDrawableHandler = azby.a(paramFile.getAbsolutePath());
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    {
      paramDownloadParams.GetPreviewURLAsync((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), 0, "0", new avdb(this, paramDownloadParams, localFile, paramURLDrawableHandler));
      return localFile;
    }
