...
{
  private avda(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  private void a(RelativeLayout paramRelativeLayout, MessageRecord paramMessageRecord)
  {
    if (paramMessageRecord != null)
    {
      ...
      localTextView.setText(bhid.a(this.a.getActivity(), 3, paramMessageRecord.time * 1000L));
  ...
  public avfh a(int paramInt)
  {
    if (QQGamePubAccountFragment.a(this.a).isEmpty())
    {
      synchronized (QQGamePubAccountFragment.b)
      {
        if ((QQGamePubAccountFragment.a(this.a) != null) && (QQGamePubAccountFragment.a(this.a).size() > 0))
        {
          ...
          {
            avfh localavfh = avft.a((MessageRecord)localIterator.next(), this.a.getActivity());
            QQGamePubAccountFragment.a(this.a).add(localavfh);
          }
        }
      }
    ...
    if (paramInt < QQGamePubAccountFragment.a(this.a).size()) {
      return (avfh)QQGamePubAccountFragment.a(this.a).get(paramInt);
    }
    return null;
  }
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (MessageRecord localMessageRecord = (MessageRecord)QQGamePubAccountFragment.a(this.a).get(paramInt);; localMessageRecord = null)
    {
      ...
      if (localMessageRecord != null) {
        localavfh.a(localMessageRecord, this.a.getActivity());
      }
      if (paramInt != i) {
        break;
      }
