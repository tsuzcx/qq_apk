...
public abstract class xvc
{
  ...
  protected String a;
  private List<xvd> jdField_a_of_type_JavaUtilList;
  private xvd jdField_a_of_type_Xvd;
  private xve jdField_a_of_type_Xve;
  private xvg jdField_a_of_type_Xvg;
  ...
  public xvc(xvg paramxvg, boolean paramBoolean, int paramInt, xve paramxve)
  {
    this.jdField_a_of_type_JavaLangString = xvc.class.getSimpleName();
    this.jdField_a_of_type_JavaLangString = getClass().getSimpleName();
    if ((paramxvg == null) || (paramInt == -1)) {
      throw new IllegalArgumentException("no track specified");
    }
    this.jdField_a_of_type_Xvg = paramxvg;
    this.e = paramBoolean;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidMediaMediaFormat = paramxvg.a(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Xve = paramxve;
  ...
  public final xvd a()
  {
    ...
    for (;;)
    {
      ...
      if (i >= 0)
      {
        ...
        xvd localxvd = (xvd)this.jdField_a_of_type_JavaUtilList.get(0);
        localxvd.jdField_a_of_type_Int = i;
        localxvd.jdField_a_of_type_JavaNioByteBuffer = ((ByteBuffer)localObject);
        localxvd.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs;
        localxvd.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
        if (this.d)
        {
          this.d = false;
          localxvd.jdField_b_of_type_Boolean = true;
        }
        if (localxvd.jdField_a_of_type_Boolean)
        {
          Log.d(this.jdField_a_of_type_JavaLangString, "EOS output");
          return localxvd;
        }
        this.jdField_a_of_type_Long = localxvd.jdField_a_of_type_Long;
        return localxvd;
      }
      if (i == -3)
      {
  ...
  protected xvd a(xvj paramxvj, long paramLong, xvg paramxvg, MediaCodec paramMediaCodec)
  {
    ...
    Log.d(this.jdField_a_of_type_JavaLangString, "extractor current position: " + paramxvg.a());
    paramxvg.a(paramLong, paramxvj.a());
    Log.d(this.jdField_a_of_type_JavaLangString, "extractor new position:     " + paramxvg.a());
    this.jdField_a_of_type_Boolean = false;
    this.jdField_b_of_type_Boolean = false;
    paramMediaCodec.flush();
    if (paramxvg.c())
  ...
  public final xvd a(boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  protected final void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_a_of_type_Xvg.a(this.jdField_a_of_type_Int);
      ...
      {
        this.jdField_a_of_type_JavaUtilList.add(new xvd());
        i += 1;
      }
  ...
  public final void a(xvj paramxvj, long paramLong)
  {
    this.jdField_a_of_type_Long = -9223372036854775808L;
    this.jdField_a_of_type_Xvd = a(paramxvj, paramLong, this.jdField_a_of_type_Xvg, this.jdField_a_of_type_AndroidMediaMediaCodec);
  }
  ...
  public final boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          if ((this.jdField_a_of_type_Xvg.b() == -1) || (this.jdField_a_of_type_Xvg.b() == this.jdField_a_of_type_Int)) {
            break;
          }
        } while (!paramBoolean);
        return this.jdField_a_of_type_Xvg.a();
      ...
      if (!this.jdField_a_of_type_Xvg.c()) {
        break;
      }
      this.c = true;
      this.jdField_a_of_type_AndroidMediaMediaCodec.queueInputBuffer(k, 0, 0, 0L, 4);
    } while ((this.jdField_a_of_type_Xvg.b() <= -1L) || (this.jdField_a_of_type_Xve == null));
    this.jdField_a_of_type_Xve.a(this);
    return false;
    if ((this.jdField_a_of_type_Xvg.b() > -1L) && (this.jdField_a_of_type_Xve != null)) {
      this.jdField_a_of_type_Xve.a(this);
    }
    int i = this.jdField_a_of_type_Xvg.a((ByteBuffer)localObject, 0);
    if (i < 0)
    {
    ...
    for (;;)
    {
      ...
      if (!this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Xvg.a();
      }
      return paramBoolean;
      l = this.jdField_a_of_type_Xvg.a();
      paramBoolean = true;
      break;
      label265:
      j = 0;
  ...
  public long b()
  {
    return this.jdField_a_of_type_Xvg.b();
  }
  ...
  public final void b()
  {
    ...
    for (;;)
    {
      int i = this.jdField_a_of_type_Xvg.b();
  ...
  public void b(xvd paramxvd)
  {
    this.jdField_a_of_type_AndroidMediaMediaCodec.releaseOutputBuffer(paramxvd.jdField_a_of_type_Int, false);
    c(paramxvd);
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Xvd != null) {
      a(this.jdField_a_of_type_Xvd, 0L);
    }
  }
  
  protected final void c(xvd paramxvd)
  {
    paramxvd.a();
    this.jdField_a_of_type_JavaUtilList.add(paramxvd);
  }
