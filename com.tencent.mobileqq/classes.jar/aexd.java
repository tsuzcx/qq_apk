  ...
  implements Manager
{
  ...
  private aexa jdField_a_of_type_Aexa;
  ...
  private List<aewi> jdField_a_of_type_JavaUtilList;
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = ThreadManager.getFileThreadHandler();
  private volatile boolean jdField_a_of_type_Boolean;
  private final aexg jdField_b_of_type_Aexg = new aexe(this);
  private File jdField_b_of_type_JavaIoFile;
  private List<aewh> jdField_b_of_type_JavaUtilList = new CopyOnWriteArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private File c;
  private File d;
  
  public aexd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_b_of_type_Boolean = bbjn.D(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    this.jdField_a_of_type_Askd = ((askd)paramQQAppInterface.getManager(14));
    d();
    if (this.jdField_a_of_type_JavaUtilList != null) {
      this.jdField_a_of_type_JavaUtilList.clear();
    }
    a(new aexc(paramQQAppInterface));
    this.jdField_a_of_type_Aewt = new aewt(paramQQAppInterface);
    a(this.jdField_a_of_type_Aewt);
    this.jdField_a_of_type_Aexa = new aexa(paramQQAppInterface);
    a(this.jdField_a_of_type_Aexa);
  }
  ...
  public static aexd a(QQAppInterface paramQQAppInterface)
  {
    return (aexd)paramQQAppInterface.getManager(314);
  }
  ...
  public static File a(String paramString)
  {
    try
    {
      ...
      paramString = new File(aeww.jdField_a_of_type_JavaLangString + paramString);
      return paramString;
    }
  ...
  private List<aewh> a(List<aewh> paramList, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    int i2 = 0;
    int j;
    int m;
    ...
    if (paramStickerRecommendSortEntity != null)
    {
      try
      {
        ...
        arrayOfaewh[i] = ((aewh)paramList.get(i1));
        i += 1;
      }
      ...
      if (n < m)
      {
        ...
        arrayOfaewh[i] = ((aewh)paramList.get(j));
        i += 1;
        break label461;
      }
    }
    for (;;)
    {
      if (i1 < k)
      {
        ...
        if ((i < i3) && (j < i3))
        {
          arrayOfaewh[j] = ((aewh)paramList.get(i));
          i = j + 1;
          break label470;
        }
      }
      ...
      {
        paramList = Arrays.asList(arrayOfaewh);
        return paramList;
        return null;
      }
      i = j;
  ...
  private void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        ((ayrv)localObject).jdField_a_of_type_Aysa = new aexf(this, paramString2, bool, paramString3);
        ((ayrv)localObject).jdField_a_of_type_JavaLangString = paramString1;
        ((ayrv)localObject).jdField_a_of_type_Int = 0;
        ((ayrv)localObject).jdField_c_of_type_JavaLangString = this.d.getAbsolutePath();
        ...
        try
        {
          ...
          ((QQAppInterface)paramString2).getNetEngine(0).a((aysw)localObject);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(boolean paramBoolean, long paramLong)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "StickerRecInitCost", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
  }
  ...
  private void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        Object localObject = (aewi)localIterator.next();
        if (((aewi)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
        {
          localObject = ((aewi)localObject).a(paramString);
          if ((localObject != null) && (!((List)localObject).isEmpty())) {
            localArrayList.addAll((Collection)localObject);
          }
        }
      }
      paramString = aewj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
      ...
      while (paramString.hasNext()) {
        ((aewh)paramString.next()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        localObject = bbjn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "words_version_key805_gray_one", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StickerRecManager", 2, bfnd.a(paramArrayOfByte));
        return;
        if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte, String paramString1, String paramString2, boolean paramBoolean, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    ...
    while (i < localList.size())
    {
      ...
      localaewx.f(localImgInfo.uint32_src_type.get());
      localaewx.f(localImgInfo.bytes_src_desc.get().toStringUtf8());
      localaewx.g(localImgInfo.bytes_web_url.get().toStringUtf8());
      localaewx.h("");
      localaewx.i(localImgInfo.bytes_pack_name.get().toStringUtf8());
      localaewx.g(localImgInfo.uint32_pack_id.get());
      paramArrayOfByte.add(localaewx);
      i += 1;
    }
    ...
    for (paramArrayOfByte = localRspBody.bytes_rsp_other.get().toStringUtf8();; paramArrayOfByte = "999")
    {
      if (paramBoolean)
      {
        this.jdField_b_of_type_Aexg.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
      }
      if (this.jdField_a_of_type_Aexg != null)
      {
        this.jdField_a_of_type_Aexg.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
        break;
      }
      return;
  ...
  public static boolean a(aewh paramaewh)
  {
    return paramaewh.a();
  }
  ...
  private boolean a(File paramFile1, File paramFile2)
  {
    ...
    try
    {
      ...
      nay.a(paramFile1, localFile.getAbsolutePath() + File.separator);
  ...
  public static boolean b(aewh paramaewh)
  {
    return !a(paramaewh);
  }
  ...
  public static String d(String paramString)
  {
    ...
    {
      paramString = Utils.Crc64String(paramString);
      paramString = aeww.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    Object localObject = new File(aeww.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    axrl.a(BaseApplication.getContext()).a(null, "StickerRecEmptyImg", false, 0L, 0L, null, "");
  }
  ...
  {
    return ayla.a(ayla.i(bbjw.c(paramString).toLowerCase()));
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      try
      {
        if (bbdj.a(this.c.getAbsolutePath())) {
          break label116;
        }
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("StickerRecManager", 2, bfnd.a(localException1));
    ...
    l2 = bbjn.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    if ((!bbdj.a(this.jdField_b_of_type_JavaIoFile.getAbsolutePath())) || ((l2 != 0L) && (System.currentTimeMillis() - l2 >= 86400000L)))
    {
      bbjn.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0L);
      localObject1 = new HashSet();
      localObject2 = this.jdField_a_of_type_Askd.b();
      localList = this.jdField_a_of_type_Askd.jdField_a_of_type_JavaUtilList;
      ...
      {
        apvb.c(this.jdField_b_of_type_JavaIoFile.getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataCard = ((ajxn)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
  ...
  public void a(aewi paramaewi)
  {
    ...
    } while (this.jdField_a_of_type_JavaUtilList.contains(paramaewi));
    this.jdField_a_of_type_JavaUtilList.add(paramaewi);
  }
  
  public void a(aexg paramaexg)
  {
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.d("StickerRecManager", 2, bfnd.a(paramIntent));
        continue;
      }
      finally {}
      label122:
      ...
      {
        ((aknv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramFromServiceMsg);
        continue;
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	aexd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +6 -> 16
    //   13: aload_0
    ...
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 65	aexd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 83	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   68: invokestatic 1132	anet:a	(Landroid/content/Context;)Ljava/lang/String;
    //   71: astore 8
    ...
    //   275: dup
    //   276: aload_0
    //   277: getfield 65	aexd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   312: pop
    //   313: aload_0
    //   314: getfield 65	aexd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   317: aload 5
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataCard != null)
        {
          ...
          localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aexi.class);
  ...
  public void a(List<aexj> paramList, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      localObject2 = (aexj)localIterator.next();
      if (localObject2 != null)
      {
        str1 = ((aexj)localObject2).jdField_a_of_type_JavaLangString;
        localObject1 = ((aexj)localObject2).jdField_a_of_type_JavaUtilList;
        ...
        {
          localObject1 = (aewh)((Iterator)localObject5).next();
          if (((aewh)localObject1).b() != null)
          {
            String str2 = ((aewh)localObject1).c();
            if (!TextUtils.isEmpty(str2)) {
              ((StringBuilder)localObject4).append(str2);
            }
            ((StringBuilder)localObject4).append(((aewh)localObject1).b());
            ((StringBuilder)localObject4).append(";");
            if (((aewh)localObject1).a() != null)
            {
              ((StringBuilder)localObject3).append(((aewh)localObject1).a());
              ((StringBuilder)localObject3).append(";");
            }
            if (!((aewh)localObject1).b()) {
              break label599;
            }
            paramList = (List<aexj>)localObject1;
          }
        }
      }
    }
    ...
    for (;;)
    {
      ...
      localObject3 = new aexh();
      ((aexh)localObject3).l = "dc04577";
      ((aexh)localObject3).jdField_b_of_type_JavaLangString = str1;
      ((aexh)localObject3).k = ((aexj)localObject2).jdField_b_of_type_JavaLangString;
      ((aexh)localObject3).jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
      ((aexh)localObject3).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      if (paramList != null)
      {
        ...
        ((aexh)localObject3).f = ((String)localObject1);
        ((aexh)localObject3).g = paramList.a();
      }
      ((aexh)localObject3).d = ((String)localObject4);
      ((aexh)localObject3).e = ((String)localObject5);
      if (paramBoolean)
      {
        if (paramInt != 0) {
          break label536;
        }
        ((aexh)localObject3).h = "c2c";
      }
      for (;;)
      {
        ((aexh)localObject3).j = paramString;
        ((aexh)localObject3).i = "android";
        paramList = ((aexh)localObject3).a();
        localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aexi.class);
        ((NewIntent)localObject1).putExtra("key_cmd", "MQInference.CommonReport");
        ((NewIntent)localObject1).putExtra("key_body", bblm.a(paramList.toString().getBytes()));
        if (QLog.isColorLevel())
        {
          ((aexh)localObject3).jdField_b_of_type_JavaLangString = c(((aexh)localObject3).jdField_b_of_type_JavaLangString);
          QLog.d("StickerRecManager", 2, "report content:" + ((aexh)localObject3).a().toString());
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject1);
        break label22;
        break;
        if (paramInt == 1) {
          ((aexh)localObject3).h = "group";
        } else if (paramInt == 3000) {
          ((aexh)localObject3).h = "discuss";
        } else if (paramInt == 11000) {
          ((aexh)localObject3).h = "qzone";
        } else {
          ((aexh)localObject3).h = "other";
        }
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bbjn.u(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
  }
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (!bool)
      {
        ...
        if ((!paramBoolean2) || (this.jdField_a_of_type_Aexg == null)) {
          break label251;
        }
    ...
    catch (Exception paramString1)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bfnd.a(paramString1));
        }
      }
    }
    return true;
  ...
  {
    return ayla.a(ayla.i(bbjw.c(paramString)));
  }
  ...
  public Collection<String> b()
  {
    ...
    Object localObject1 = ((ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149)).a();
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (("isUpdate".equals(((CustomEmotionData)localObject2).RomaingType)) || ("needDownload".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow_downloaded".equals(((CustomEmotionData)localObject2).RomaingType))) {
          ...
          {
            localObject2 = localaskd.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
  ...
  public void b(List<aexj> paramList)
  {
    paramList = new ArrayList(paramList).iterator();
    while (paramList.hasNext())
    {
      Object localObject1 = (aexj)paramList.next();
      if (localObject1 != null)
      {
        Object localObject2 = ((aexj)localObject1).jdField_a_of_type_JavaLangString;
        StickerRecommendSortEntity localStickerRecommendSortEntity = (StickerRecommendSortEntity)this.jdField_a_of_type_Aukn.a(StickerRecommendSortEntity.class, "usrMessage=?", new String[] { localObject2 });
        Object localObject3;
        if (localStickerRecommendSortEntity != null)
        {
          localStickerRecommendSortEntity.convertToList();
          localObject1 = ((aexj)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (aewh)((Iterator)localObject1).next();
            if (!((aewh)localObject2).a())
            {
              localObject2 = (aewx)localObject2;
              localObject3 = Integer.valueOf(((aewx)localObject2).d());
              if (((aewx)localObject2).b())
              {
          ...
          this.jdField_a_of_type_Aukn.a(localStickerRecommendSortEntity);
        }
        else
        {
          localStickerRecommendSortEntity = new StickerRecommendSortEntity((String)localObject2);
          localObject2 = ((aexj)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            localObject3 = (aewh)((Iterator)localObject2).next();
            if (!((aewh)localObject3).a())
            {
              localObject3 = (aewx)localObject3;
              if (((aewx)localObject3).b()) {
                localStickerRecommendSortEntity.addClicked(Integer.valueOf(((aewx)localObject3).d()));
              } else {
                localStickerRecommendSortEntity.addExposed(Integer.valueOf(((aewx)localObject3).d()));
              }
            }
          }
          localObject1 = ((aexj)localObject1).jdField_b_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (aewh)((Iterator)localObject1).next();
            if (!((aewh)localObject2).a()) {
              localStickerRecommendSortEntity.addNoExpose(Integer.valueOf(((aewx)localObject2).d()));
            }
          }
          if ((localStickerRecommendSortEntity.noExposeList != null) && (localStickerRecommendSortEntity.noExposeList.size() == 0))
          {
          ...
          this.jdField_a_of_type_Aukn.b(localStickerRecommendSortEntity);
        }
      }
    }
  }
  ...
  public void h()
  {
    if (this.jdField_a_of_type_Aexa == null) {
      return;
    }
    this.jdField_a_of_type_Aexa.a();
  }
