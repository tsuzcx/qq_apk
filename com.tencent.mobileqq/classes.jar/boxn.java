...
public class boxn
  ...
  implements Handler.Callback, blgx, bpcf
{
  private float jdField_a_of_type_Float;
  public int a;
  Context jdField_a_of_type_AndroidContentContext;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new boxp(this);
  public View a;
  public ViewGroup a;
  ...
  public boolean a;
  private InputFilter[] jdField_a_of_type_ArrayOfAndroidTextInputFilter = { new boyb(20) };
  ...
  private int j = 580;
  private int k;
  private int l = bomd.jdField_b_of_type_Int;
  private int m;
  private int n;
  
  public boxn(Context paramContext, boolean paramBoolean)
  {
    super(paramContext, 2131755182);
    this.jdField_b_of_type_Int = -1;
    this.jdField_c_of_type_Int = bphv.a(false);
    this.jdField_a_of_type_Bowx = new bowx();
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131559142, null));
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new boya(this, null);
    this.jdField_a_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new boxz(this, null));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout = ((FitSystemWindowsRelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376970));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setFitsSystemWindows(true);
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setOnTouchListener(new boxo(this));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378741);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiPanelEditTextPanel = ((EditTextPanel)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131366032).findViewById(2131372403));
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView = ((PressScaleTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378713));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378714));
    if (this.jdField_d_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setOnClickListener(new boxq(this));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new boxr(this));
    }
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView = ((EditTextPreView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378753));
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setOnClickListener(new boxs(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new boxt(this));
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a(this.jdField_a_of_type_AndroidWidgetEditText);
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new boxu(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new boxv(this));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371921));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setStrokeStrategy(new bphv(), false, 0);
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new boxw(this));
  }
  ...
  private void b()
  {
    ...
    {
      localLayoutParams.height = bpdd.b(getContext());
      if (LiuHaiUtils.f())
      {
  ...
  private void c()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new boxx(this));
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 34)
    {
      ...
      {
        int i1 = this.jdField_a_of_type_Bolc.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(bolc parambolc)
  {
    this.jdField_a_of_type_Bolc = parambolc;
  }
  
  public void a(boxy paramboxy)
  {
    this.jdField_a_of_type_Boxy = paramboxy;
  }
  ...
  public void a(DynamicTextConfigManager.DynamicTextConfigBean paramDynamicTextConfigBean, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (paramDynamicTextConfigBean != null))
    {
      ...
      paramDynamicTextConfigBean = this.jdField_a_of_type_Bolc.a(paramDynamicTextConfigBean.text_id, (List)localObject);
      ...
      if (!(paramDynamicTextConfigBean instanceof bomd)) {
        break label391;
      }
      ((bomd)paramDynamicTextConfigBean).a(this.jdField_c_of_type_Int);
      ...
      if (!this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a().equals(bolc.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c(), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.b()))) {
        break label427;
      }
    ...
    for (;;)
    {
      ...
      return;
      label357:
      localObject = bolc.a(bolc.a(paramDynamicTextConfigBean.text_id), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(DynamicTextItem paramDynamicTextItem, int paramInt)
  {
    ...
    ykq.b("EditTextDialog", "setTextInfo:" + paramDynamicTextItem + " index:" + paramInt + " text:" + str1);
    this.jdField_a_of_type_Bowx.jdField_a_of_type_JavaLangString = str1;
    this.jdField_a_of_type_AndroidWidgetEditText.setText(this.jdField_a_of_type_Bowx.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c() != 0)
    {
      if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a() == null) {
        this.jdField_a_of_type_AndroidWidgetEditText.setFilters(this.jdField_a_of_type_ArrayOfAndroidTextInputFilter);
    ...
    for (;;)
    {
      paramInt = this.jdField_a_of_type_Bolc.a(paramDynamicTextItem);
      ...
      if (!(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem instanceof bomd)) {
        break label494;
      }
      paramDynamicTextItem = (bomd)this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Boxy.a(false);
    this.jdField_a_of_type_Boxy.a(c(), d());
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setPreViewDrawer(null);
    localObject = this.jdField_a_of_type_Boxy;
    DynamicTextItem localDynamicTextItem = this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      ((boxy)localObject).a(localDynamicTextItem, paramBoolean, this.g, this.jdField_c_of_type_Boolean);
  ...
  public int c()
  {
    ...
    ykq.b("EditTextDialog", "getPreViewCenterX:" + i1);
    return i1;
  }
  ...
  public int d()
  {
    ...
    ykq.b("EditTextDialog", "getPreViewCenterY()=" + i1);
    return i1;
  }
  ...
  public void onDetachedFromWindow()
  {
    ...
    if (this.jdField_a_of_type_Boxy == null) {
      return;
    }
  ...
  {
    this.jdField_a_of_type_Int = AIOUtils.dp2px(100.0F, getContext().getResources());
    b();
    a();
