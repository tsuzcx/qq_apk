  ...
  implements ord, owa
{
  ...
  public void H_()
  {
    if (this.jdField_a_of_type_AndroidContentContext != null)
    {
      ...
      if (orc.a(this.jdField_a_of_type_AndroidContentContext, str) >= pqi.jdField_d_of_type_Int) {
        break label51;
      }
      if (this.jdField_a_of_type_Opw != null) {
        this.jdField_a_of_type_Opw.a().o();
      }
    }
    return;
    label51:
    bbmy.a(this.jdField_a_of_type_AndroidContentContext, 0, this.jdField_a_of_type_AndroidContentContext.getString(2131652758), 0).a();
  }
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localpqi = paramBaseArticleInfo.scripCmsInfo;
        if (localpqi == null) {
          break;
        }
        if ((localpqi.jdField_a_of_type_Int == 1) || ((TextUtils.isEmpty(localpqi.g)) && (TextUtils.isEmpty(localpqi.h))))
        {
          paramBaseArticleInfo = new JSONObject(localpqi.jdField_a_of_type_JavaLangString).getJSONArray("S");
          Object localObject = new JSONObject(localpqi.b).getJSONArray("S");
          localJSONObject.put("main_title_rich", a(paramBaseArticleInfo));
          localJSONObject.put("sub_title_rich", a((JSONArray)localObject));
          localJSONObject.put("privacy_text", localpqi.jdField_d_of_type_JavaLangString);
          paramBaseArticleInfo = orc.c();
          ...
          if ((paramInt == 0) && (orc.a() == 1))
          {
            localJSONObject.put("tips_text", ((Context)localObject).getString(2131652683));
            localJSONObject.put("icon_image_url", localpqi.e);
            localJSONObject.put("bg_image_url", localpqi.c);
            localJSONObject.put("animation_url", localpqi.f);
            return localJSONObject;
          }
          localJSONObject.put("tips_text", paramBaseArticleInfo);
          continue;
        }
        localJSONObject.put("main_title_rich", localpqi.g.replace("#$%", orc.a()));
      }
      ...
      {
        if ((paramInt == 0) && (orc.a() == 1)) {}
        for (paramBaseArticleInfo = localpqi.h.replace("#$%", paramBaseArticleInfo.getString(2131652682));; paramBaseArticleInfo = localpqi.h.replace("#$%", orc.b()))
        {
          localJSONObject.put("sub_title_rich", paramBaseArticleInfo);
          localJSONObject.put("bg_image_url", localpqi.i);
          return localJSONObject;
        }
      }
      label415:
  ...
  public void a(int paramInt1, Container paramContainer, opw paramopw, int paramInt2)
  {
    ...
    if ((paramopw != null) && (paramopw.a() != null))
    {
      ...
      if ((((Map)localObject).get("id_lottie_view") == null) || (!(((Map)localObject).get("id_lottie_view") instanceof ozq))) {
        break label102;
      }
    }
    label102:
    for (Object localObject = (ozq)((Map)localObject).get("id_lottie_view");; localObject = null)
    {
      localqoe.a(new ovj(this, (ozq)localObject, paramopw, paramContainer));
      return;
    }
  }
  ...
  public boolean a(int paramInt, Container paramContainer, opw paramopw, ViewBase paramViewBase)
  {
    ...
    default: 
      return false;
    case 1154: 
      paramViewBase.setOnClickListener(new ovk(this, paramopw, paramContainer));
      return true;
    case 1155: 
      paramViewBase.setOnClickListener(new ovl(this, paramContainer));
      return true;
    }
    paramViewBase.setOnClickListener(new ovm(this, paramContainer));
    return true;
  }
}
