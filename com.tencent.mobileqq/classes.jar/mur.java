...
public class mur
{
  static mur jdField_a_of_type_Mur;
  ...
  muz jdField_a_of_type_Muz = null;
  boolean jdField_a_of_type_Boolean = false;
  String jdField_b_of_type_JavaLangString = null;
  public WeakReference<Button> b;
  private boolean jdField_b_of_type_Boolean;
  public WeakReference<mva> c;
  private boolean c;
  public int d;
  private boolean d;
  ...
  public mur(Context paramContext, VideoController paramVideoController, Button paramButton)
  {
    ...
    b(paramButton);
    this.jdField_a_of_type_Muz = new muz(this);
    c();
  ...
  private Drawable a(Resources paramResources, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        paramResources = mrz.a(paramResources, 2130842023, false);
      }
      else
      {
        paramResources = muq.a(paramResources, 2130841973, 2131165964);
        continue;
        if (paramBoolean)
        {
          paramResources = mrz.a(paramResources, 2130842022, false);
        }
        else
        {
          paramResources = muq.a(paramResources, 2130841972, 2131165964);
          continue;
          if (paramBoolean)
          {
            paramResources = mrz.a(paramResources, 2130841971);
          }
          else
          {
            paramResources = muq.a(paramResources, 2130842245, 2131166001);
            continue;
            if (paramBoolean)
            {
              paramResources = mrz.a(paramResources, 2130841975);
            }
            else
            {
              paramResources = muq.a(paramResources, 2130842252, 2131166001);
              continue;
              if (paramBoolean)
              {
                paramResources = mrz.a(paramResources, 2130841974);
              }
              else
              {
                paramResources = muq.a(paramResources, 2130842247, 2131166001);
                continue;
                if (paramBoolean) {
                  paramResources = mrz.a(paramResources, 2130842022, false);
                } else {
                  paramResources = muq.a(paramResources, 2130842250, 2131166001);
                }
              }
            }
          }
  ...
  public static mur a()
  {
    try
    {
      mur localmur = jdField_a_of_type_Mur;
      return localmur;
    }
    finally
    {
  ...
  public static mur a(Context paramContext, VideoController paramVideoController)
  {
    if (jdField_a_of_type_Mur == null) {}
    try
    {
      if (jdField_a_of_type_Mur == null) {
        jdField_a_of_type_Mur = new mur(paramContext, paramVideoController, null);
      }
      return jdField_a_of_type_Mur;
    }
    finally {}
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    for (this.jdField_e_of_type_Boolean = Arrays.asList(paramArrayOfString).contains("DEVICE_BLUETOOTHHEADSET");; this.jdField_e_of_type_Boolean = false)
    {
      if ((this.jdField_e_of_type_Boolean != bool) && (this.jdField_e_of_type_Boolean))
      {
        ...
        bdll.b(null, "CliOper", "", "", "0X8008D1D", "0X8008D1D", 0, 0, "", "", "", "");
      }
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694438), true);
          String str = paramVideoAppInterface.getCurrentAccountUin();
          if (str != null) {
            bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694438) + str, true);
          }
          bool2 = bool1;
        } while (bhkm.a() == 0);
        bool2 = bool1;
      ...
      bool2 = bool1;
    } while (mtd.d(paramVideoAppInterface.getApp()));
    return true;
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              if (paramVideoAppInterface.getCurrentAccountUin() != null)
              {
                ...
                bool1 = bool2;
                if (str != null) {
                  bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694437) + str, true);
                }
              }
              bool2 = bool1;
            } while (bhkm.a() == 0);
          ...
          bool2 = bool1;
        } while (mtd.a(paramVideoAppInterface.getApp()));
        bool2 = bool1;
      } while (mtd.c(paramVideoAppInterface.getApp()));
      bool2 = bool1;
    } while (mtd.d(paramVideoAppInterface.getApp()));
    return true;
  }
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession = new TraeAudioSession((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Muz);
    }
  ...
  public void a(int paramInt)
  {
    ...
    {
      long l = AudioHelper.b();
      QLog.w("TraeSessionHelper", 1, "pressHandFreeBtn, isSpeakerOn[" + ((lff)localObject2).P + "], seq[" + l + "]", (Throwable)localObject1);
      Object localObject3 = ((lff)localObject2).a;
      ...
      if (localObject3 != null) {
        if ((this.jdField_e_of_type_Boolean) && (mtl.a()))
        {
          if (this.jdField_b_of_type_JavaLangRefWeakReference == null) {
            break label717;
          }
      ...
      for (;;)
      {
        ...
        localObject3 = new mux((String[])localObject3);
        if (!TextUtils.isEmpty(((lff)localObject2).r)) {
          ((mux)localObject3).a(((lff)localObject2).r);
        }
        localObject2 = (blir)blji.a((Context)localObject1, null);
        ((blir)localObject2).a(2131695009);
        ListView localListView = new ListView((Context)localObject1);
        if (this.jdField_a_of_type_Muv == null) {
          this.jdField_a_of_type_Muv = new muv((Context)localObject1, (mux)localObject3);
        }
        for (;;)
        {
          localListView.setAdapter(this.jdField_a_of_type_Muv);
          ...
          localListView.setOnItemClickListener(new mus(this, localButton, l, (blir)localObject2));
          ((blir)localObject2).a(localListView);
          ((blir)localObject2).c(2131690580);
          ((blir)localObject2).a(new mut(this));
          ((blir)localObject2).setOnShowListener(new muu(this));
          ((blir)localObject2).show();
          return;
          this.jdField_a_of_type_Muv.a((Context)localObject1, (mux)localObject3);
        }
        int k;
        if (((lff)localObject2).P)
        {
          int i = 0;
          do
          {
  ...
  public void a(long paramLong, lff paramlff)
  {
    if (paramlff == null) {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "switchButton_handFree, isSpeakerOn[" + paramlff.P + "], seq[" + paramLong + "]");
    }
  ...
  public boolean a(long paramLong, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    if ((b(paramVideoAppInterface)) && (a(paramVideoAppInterface.getApp().getApplicationContext())))
    {
      ...
      for (;;)
      {
        ...
        bhkm.a(paramInt1, paramInt2, paramOnCompletionListener);
      }
    }
    return false;
  }
