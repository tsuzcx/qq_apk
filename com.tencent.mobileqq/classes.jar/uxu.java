  ...
  implements uxw
{
  ...
  public uxu(Map<String, Bitmap> paramMap, Bitmap paramBitmap)
  {
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    ...
    //   30: istore 5
    //   32: aload_0
    //   33: getfield 19	uxu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   36: ifnull +445 -> 481
    //   39: aload_0
    //   40: getfield 19	uxu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   104: astore 6
    //   106: aload_0
    //   107: getfield 19	uxu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   110: ifnull +43 -> 153
    //   113: aload_0
    //   114: getfield 19	uxu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   186: aload 7
    //   188: aastore
    //   189: invokestatic 94	ved:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   192: goto -39 -> 153
    //   195: aload 6
    //   197: iconst_0
    ...
    //   210: aconst_null
    //   211: iconst_0
    //   212: invokestatic 103	uyk:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)V
    //   215: aload 6
    //   217: astore 7
    //   219: aload 6
    ...
    //   242: astore 6
    //   244: aload_0
    //   245: getfield 19	uxu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   248: ifnull +47 -> 295
    //   251: aload 7
    //   253: astore 6
    //   255: aload_0
    //   256: getfield 19	uxu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   321: aload 7
    //   323: aastore
    //   324: invokestatic 94	ved:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   327: goto -112 -> 215
    //   330: aload_0
    //   331: getfield 17	uxu:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   334: ifnull +13 -> 347
    //   337: aload_0
    //   338: getfield 17	uxu:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    ...
    //   427: ldc 145
    //   429: aload 6
    //   431: invokestatic 149	ved:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   434: iload_3
    //   435: iconst_2
    //   436: idiv
    //   437: istore_3
    ...
    //   454: ldc 155
    //   456: aload 6
    //   458: invokestatic 149	ved:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   461: aconst_null
    //   462: areturn
    //   463: aload_0
    //   464: getfield 17	uxu:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   467: astore_1
    //   468: aload_1
    //   469: iconst_0
