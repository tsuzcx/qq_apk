  ...
  extends aasp
{
  ...
  public aavi(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(paramList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  private void b(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((localView != null) && (localObject != null)) {
        ((aqqv)localObject).a(localView, paramMessageForDeviceFile);
      }
      for (;;)
      {
        i += 1;
  ...
  {
    paramLong = (aasr)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
    ...
    {
      paramLong = ((QQAppInterface)localAppRuntime).getMessageFacade().getMsgItemByUniseq(paramLong.jdField_a_of_type_JavaLangString, paramLong.jdField_a_of_type_Int, paramLong.jdField_a_of_type_Long);
      if (paramLong == null)
      {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().removeMsgByUniseq(paramMessageForDeviceFile.frienduin, paramMessageForDeviceFile.istroop, paramMessageForDeviceFile.uniseq);
    ArrayList localArrayList = new ArrayList();
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)bbli.a(paramMessageForDeviceFile);
    if ("device_groupchat".equals(paramMessageForDeviceFile.extStr))
    {
      ...
      localMessageForDeviceFile.srcFileName = aszt.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.fileSize = aszt.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.msgStatus = 2;
      localMessageForDeviceFile.nFileStatus = 1;
      localMessageForDeviceFile.progress = 0.0F;
      ((anaj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(13)).a(localMessageForDeviceFile);
      ...
      paramString = bfvo.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bfvo.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, paramString, 160, 160);
      ahff.a(((aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, paramString), localMessageForDeviceFile);
    ...
    localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691442);
    if (paramString.compareTo(aavk.d) == 0)
    {
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691443);
      label361:
      ((anaj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(13)).a(localMessageForDeviceFile);
      paramMessageForDeviceFile = (aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51);
    ...
    for (;;)
    {
      localMessageForDeviceFile.fileSize = aszt.a(str1);
      if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
      {
        localMessageForDeviceFile.nFileStatus = 6;
        localMessageForDeviceFile.msgStatus = 1;
      ...
      break;
      if (paramString.compareTo(aavk.c) != 0) {
        break label361;
      }
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691441);
      ...
      break label361;
      label545:
      if (paramString.compareTo(aavk.f) == 0)
      {
        localMessageForDeviceFile.uSessionID = paramMessageForDeviceFile.a(Long.parseLong(str2), str1, 0);
      }
      else
      {
        paramString = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a(str1, paramString, null, Long.parseLong(str2));
        if (paramString == null) {
          break label236;
        }
  ...
  public void a(View paramView, aqqv paramaqqv)
  {
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localObject1 = (aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51);
      localMessageForDeviceFile = a(Long.valueOf(paramSession.uSessionID));
    } while (localMessageForDeviceFile == null);
    Object localObject2 = ((aara)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    int i = 0;
    long l = 0L;
    ...
    if (paramSession.actionInfo.strServiceName.compareTo(aavk.d) == 0)
    {
    ...
    for (int j = 0;; j = 1)
    {
      abdm.a((AppRuntime)localObject2, l, "Net_SendMsg_Pic", 0, j, i);
      if ((paramSession.actionInfo.strServiceName.compareTo(aavk.c) == 0) && (paramSession.bSend) && (paramBoolean))
      {
        String str = new String(paramSession.vFileMD5Src);
        localObject2 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a(paramSession);
        ...
        ((aara)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin), str, String.valueOf(((Session)localObject2).uSessionID), paramSession.strFileNameSrc, paramSession.emFileType, localBundle);
        localObject1 = (MessageForDeviceFile)bbli.a(-4500);
        ((MessageForDeviceFile)localObject1).strServiceName = aavk.c;
        ...
        ((MessageForDeviceFile)localObject1).time = bbko.a();
        ...
        ((MessageForDeviceFile)localObject1).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691441);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage((MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  public void a(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    } while (((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a(localArrayList));
    aszk.a(2131693467);
  }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    for (paramMessageRecord.msgStatus = 0;; paramMessageRecord.msgStatus = 1)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageRecord.frienduin, 9501, paramMessageRecord.uniseq, paramMessageRecord.msgData);
      b(paramMessageRecord);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    DeviceInfo localDeviceInfo = ((aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    ...
    for (int i = localDeviceInfo.productId;; i = 0)
    {
      ...
      if (paramBoolean)
      {
        ...
        label76:
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691168);
        if (paramString.compareTo(aavk.d) != 0) {
          break label251;
        }
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691172);
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
        ...
        localMessageForDeviceFile.serial();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgContentByUniseq(localMessageForDeviceFile.frienduin, 9501, localMessageForDeviceFile.uniseq, localMessageForDeviceFile.msgData);
        ...
        if (paramString.compareTo(aavk.c) == 0)
        {
          ...
          if (!paramBoolean)
          {
            paramString = (DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50);
            if (localMessageForDeviceFile.isSend())
            {
              if (paramString.a(paramLong) == -5103058) {
                localMessageForDeviceFile.nFileStatus = 7;
              }
              if (aszt.a(localMessageForDeviceFile.filePath) == 0) {
                abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 2, i);
              } else {
                abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 2, i);
              }
            }
            else
            {
              ...
              for (;;)
              {
                abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 2, j, i);
                break;
          ...
          {
            if (aszt.a(localMessageForDeviceFile.filePath) == 0) {
              abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 1, i);
            } else {
              abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 1, i);
            }
          }
          else
          {
            abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 1, 0, i);
          }
        }
      }
    }
  ...
  {
    MessageForStructing localMessageForStructing = bbli.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 9501, 100L, paramAbsStructMsg);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(localMessageForStructing, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ((aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51)).a(Long.parseLong(paramString), paramAbsStructMsg);
  }
  ...
  public void a(String paramString1, String paramString2, List<String> paramList, Bundle paramBundle)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.srcFileName = aszt.a((String)localObject1);
      localMessageForDeviceFile.fileSize = aszt.a((String)localObject1);
      ...
      if (paramString1.compareTo(aavk.d) == 0)
      {
        localMessageForDeviceFile.nFileMsgType = 2;
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691443);
      }
      int i;
      if (paramString1.compareTo(aavk.c) == 0)
      {
        int i3 = 1;
        int i2 = 1;
        int i1 = 1;
      ...
      ((anaj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(13)).a(localMessageForDeviceFile);
      Object localObject2 = (aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51);
      if ((localObject2 != null) && (((aara)localObject2).a(paramString2))) {
        if (paramString1.compareTo(aavk.d) == 0)
        {
          String str = bfvo.a(BaseApplication.getContext(), Uri.parse((String)localObject1));
          bfvo.a(BaseApplication.getContext(), (String)localObject1, str, 160, 160);
          localMessageForDeviceFile.uSessionID = ((aara)localObject2).a(Long.parseLong(paramString2), (String)localObject1, str);
        }
      }
      for (;;)
      {
        ...
        localArrayList.add(localMessageForDeviceFile);
        break;
        if (paramString1.compareTo(aavk.f) == 0)
        {
          localMessageForDeviceFile.uSessionID = ((aara)localObject2).a(Long.parseLong(paramString2), (String)localObject1, 0);
        }
        else
        {
          if (paramString1.compareTo(aavk.c) == 0)
          {
            localObject2 = ((aara)localObject2).a(Long.parseLong(paramString2));
            i = 0;
            if (localObject2 != null) {
              i = ((DeviceInfo)localObject2).productId;
            }
            ...
            abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 0, i);
          }
          for (;;)
          {
            localObject1 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a((String)localObject1, paramString1, null, Long.parseLong(paramString2));
            ...
            break label526;
            label722:
            abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 0, i);
          }
          localObject1 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a((String)localObject1, paramString1, null, Long.parseLong(paramString2));
          if (localObject1 == null) {
            break;
  ...
  public void a(String paramString, List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.srcFileName = aszt.a(str);
      localMessageForDeviceFile.fileSize = aszt.a(str);
      localMessageForDeviceFile.issend = 1;
      localMessageForDeviceFile.isread = true;
      localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      ...
      localMessageForDeviceFile.time = bbko.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694024) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691443));
      localMessageForDeviceFile.nFileMsgType = 2;
      ...
      localMessageForDeviceFile.serial();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(localMessageForDeviceFile, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      str = bfvo.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bfvo.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, str, 160, 160);
      int i = ((aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, str);
      localMessageForDeviceFile.uSessionID = i;
      a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      ahff.a(i, localMessageForDeviceFile);
    }
  }
  ...
  public boolean a(String paramString, List<FileInfo> paramList)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        {
          localMessageForDeviceFile.strServiceName = aavk.b;
          continue;
          label512:
          if (localMessageForDeviceFile.strServiceName.compareTo(aavk.f) == 0)
          {
            localMessageForDeviceFile.uSessionID = localaara.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), 0);
          }
          else
          {
            localObject = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a(((FileInfo)localObject).c(), localMessageForDeviceFile.strServiceName, null, Long.parseLong(paramString));
            if (localObject != null)
            {
    ...
    if ((localaara != null) && (localaara.a(l1, 9))) {}
    for (int i = 1;; i = 0)
    {
      ArrayList localArrayList = new ArrayList();
      paramList = paramList.iterator();
      for (;;)
      {
        ...
        localMessageForDeviceFile.srcFileName = aszt.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.fileSize = aszt.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.issend = 1;
        localMessageForDeviceFile.isread = true;
        localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        ...
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691442);
        localMessageForDeviceFile.nFileMsgType = 1;
        if (localMessageForDeviceFile.strServiceName.compareTo(aavk.d) == 0)
        {
          localMessageForDeviceFile.nFileMsgType = 2;
          localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691443);
        }
        ((anaj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(13)).a(localMessageForDeviceFile);
        if ((localaara == null) || (!localaara.a(paramString))) {
          break label600;
        }
        if (localMessageForDeviceFile.strServiceName.compareTo(aavk.d) != 0) {
          break label512;
        }
        localMessageForDeviceFile.uSessionID = localaara.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), null);
        if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
        {
          localMessageForDeviceFile.nFileStatus = 6;
          localMessageForDeviceFile.msgStatus = 1;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject = ((aara)localObject).a(Long.parseLong(paramBundle.frienduin));
    long l = 0L;
    int i;
    if (localObject != null)
    {
    ...
    {
      int j;
      if (paramBundle.strServiceName.compareTo(aavk.d) == 0)
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (m == 0)
        {
          j = 0;
          abdm.a((AppRuntime)localObject, l, "Net_SendMsg_Pic", 0, j, i);
        }
      }
      else
      {
