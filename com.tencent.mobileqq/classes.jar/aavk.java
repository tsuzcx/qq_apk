...
public abstract class aavk
  extends aawg
  implements aavx, blcd, blce, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, AdapterView.OnItemSelectedListener
{
  protected aavj a;
  protected aavo a;
  protected aavw a;
  ...
  public aavk(Activity paramActivity, aavo paramaavo)
  {
    this.jdField_a_of_type_Aavx = new aavl(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Aavo = paramaavo;
  }
  
  protected aavj a(Context paramContext)
  {
    return new aawc();
  }
  ...
  protected RelativeLayout a()
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131561344, null);
  }
  ...
  public void a(int paramInt)
  {
    if ((this.jdField_a_of_type_Aavw != null) && (this.jdField_a_of_type_Aavw.a())) {
      this.jdField_a_of_type_Aavw.b();
    }
    if ((this.jdField_a_of_type_Aavw != null) && (this.jdField_a_of_type_Aavw.b())) {
      this.jdField_a_of_type_Aavw.c();
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376947));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131367490));
      this.d = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363339);
      this.jdField_a_of_type_Aavj = a(this.jdField_a_of_type_AndroidAppActivity);
      if (this.jdField_a_of_type_Aavj != null) {
        this.jdField_a_of_type_Aavj.a(this.jdField_a_of_type_AndroidAppActivity, this, this.b);
      }
      this.jdField_a_of_type_Aavw = a();
      if (this.jdField_a_of_type_Aavw != null) {
        this.jdField_a_of_type_Aavw.a(this.jdField_a_of_type_AndroidAppActivity, this);
      }
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Aavo);
      if (this.jdField_a_of_type_Aavw != null)
      {
        this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Aavw);
        this.jdField_a_of_type_Aavw.a();
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSpacing(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131297147));
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Aavo.b());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Aawb.a().a());
    ...
    localAlphaAnimation.setAnimationListener(new aavm(this));
  ...
  public void b(boolean paramBoolean)
  {
    if (b())
    {
      a(paramBoolean, this.jdField_a_of_type_Aawb.a().b());
      return;
    }
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setInterpolator(new bkyr());
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Aawb.a().a());
    ...
    localScaleAnimation.setDuration(this.jdField_a_of_type_Aawb.a().a());
    AnimationSet localAnimationSet = new AnimationSet(true);
    localAnimationSet.setFillAfter(true);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.setAnimationListener(new aavn(this));
    this.d.startAnimation(localAlphaAnimation);
  ...
  public boolean d()
  {
    return this.jdField_a_of_type_Aawb.a().a();
  }
  ...
  public boolean e()
  {
    ...
    if (c()) {
      b(false, this.jdField_a_of_type_Aawb.a().c());
    }
    for (;;)
    {
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Aavj != null) && (a())) {
        this.jdField_a_of_type_Aavj.a(paramAdapterView, paramInt);
      }
      this.jdField_a_of_type_Aavo.a(paramInt);
      if ((!d()) && (this.jdField_a_of_type_Aavw != null) && (!this.jdField_a_of_type_Aavw.a())) {
        this.jdField_a_of_type_Aavw.a();
      }
  ...
  public void q()
  {
    if (this.jdField_a_of_type_Aawb.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Aawb.jdField_a_of_type_Boolean = false;
      return;
    }
    b(true, this.jdField_a_of_type_Aawb.jdField_a_of_type_Aavi.c());
  }
