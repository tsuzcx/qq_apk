...
public class atyk
{
  ...
  public static ArrayList<atyi> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)atbg.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)atbg.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            atyi localatyi2 = new atyi();
            localatyi2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localatyi2.jdField_a_of_type_Int != 1) && (localatyi2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localatyi2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localatyi2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localatyi2.c = ((JSONObject)localObject2).optString("subTitle");
            localatyi2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localatyi2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            atyi localatyi1 = new atyi();
            localatyi1.jdField_a_of_type_Int = 1;
            localatyi1.jdField_b_of_type_Int = 2130840962;
            localatyi1.jdField_b_of_type_JavaLangString = ajyc.a(2131707373);
            localArrayList.add(localatyi1);
            localatyi1 = new atyi();
            localatyi1.jdField_a_of_type_Int = 2;
            localatyi1.jdField_b_of_type_Int = 2130840961;
            localatyi1.jdField_b_of_type_JavaLangString = ajyc.a(2131707374);
            localArrayList.add(localatyi1);
          }
  ...
  public static void a(Context paramContext, atyi paramatyi, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramatyi.jdField_a_of_type_Int);
    }
    switch (paramatyi.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramatyi.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    asyr localasyr = asyr.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localasyr != null)
    {
      if (asyr.a(paramContext))
      {
        a(paramContext, localasyr.d);
        return;
      }
      localasyr.f = a(paramString1, paramString2);
      paramContext = new atyb(paramContext);
      paramContext.a(localasyr);
      paramContext.show();
      return;
    }
  ...
  {
    new axra(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        bcpw.a(paramContext, 2131719044, 0).a();
        if (QLog.isColorLevel()) {
      ...
      {
        String str = bbuv.a(ajsf.aW + "photo/" + System.currentTimeMillis() + ".jpg");
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new atyl(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                bcpw.a(paramContext, 2131690593, 0).a();
                return;
              }
            }
          }
  ...
  {
    bcpq localbcpq = new bcpq(paramContext, paramContext.getResources().getDimensionPixelSize(2131298865));
    localbcpq.c(2131694099);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbcpq, paramString2, paramContext, paramString1), 5, null, true);
  }
