...
import cooperation.qzone.webviewplugin.QZoneSharePictureJsPlugin.11;
  ...
  extends bnnn
{
  ...
  private static final String b = anzj.a(2131711207);
  bjig jdField_a_of_type_Bjig = new bnmu(this);
  bnhn jdField_a_of_type_Bnhn = new bnmt(this);
  ...
  private String a(byte[] paramArrayOfByte)
  {
    ...
    //   10: getstatic 79	bnhm:b	Ljava/lang/String;
    ...
    //   19: invokestatic 93	java/lang/String:valueOf	(J)Ljava/lang/String;
    ...
    //   37: dup
    //   38: getstatic 79	bnhm:b	Ljava/lang/String;
    //   41: invokespecial 104	java/io/File:<init>	(Ljava/lang/String;)V
    //   44: astore 4
    //   46: aload 4
    //   48: invokevirtual 108	java/io/File:exists	()Z
    //   51: ifne +9 -> 60
    //   54: aload 4
    //   56: invokevirtual 111	java/io/File:mkdirs	()Z
    //   59: pop
    //   60: new 101	java/io/File
    //   63: dup
    //   64: aload_3
    //   65: invokespecial 104	java/io/File:<init>	(Ljava/lang/String;)V
    //   68: astore 4
    //   70: aload 4
    //   72: invokevirtual 108	java/io/File:exists	()Z
    //   75: ifne +9 -> 84
    //   78: aload 4
    //   80: invokevirtual 114	java/io/File:createNewFile	()Z
    //   83: pop
    //   84: new 116	java/io/FileOutputStream
    //   87: dup
    //   88: aload 4
    //   90: invokespecial 119	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   93: astore 6
    //   95: aload 6
    //   97: astore_3
    //   98: aload 6
    //   100: aload_1
    //   101: invokevirtual 123	java/io/FileOutputStream:write	([B)V
    //   104: aload 6
    //   106: astore_3
    //   107: aload 6
    //   109: invokevirtual 126	java/io/FileOutputStream:flush	()V
    //   112: aload 6
    //   114: ifnull +201 -> 315
    //   117: aload 6
    //   119: invokevirtual 129	java/io/FileOutputStream:close	()V
    //   122: iconst_1
    //   123: istore_2
    //   124: aload 7
    //   126: astore_1
    ...
    //   128: ifeq +9 -> 137
    //   131: aload 4
    //   133: invokevirtual 132	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   136: astore_1
    //   137: aload_1
    //   138: areturn
    //   139: astore_1
    ...
    //   146: dup
    //   147: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   150: ldc 136
    //   152: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   155: aload_1
    //   156: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   159: invokevirtual 99	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   194: aload 5
    //   196: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   199: invokevirtual 99	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   202: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   205: aload_1
    //   206: ifnull +104 -> 310
    //   209: aload_1
    ...
    //   219: ldc 134
    //   221: iconst_1
    //   222: new 75	java/lang/StringBuilder
    //   225: dup
    //   226: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   229: ldc 136
    ...
    //   241: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   244: iconst_0
    //   245: istore_2
    //   246: goto -122 -> 124
    //   249: astore_1
    ...
    //   253: ifnull +7 -> 260
    //   256: aload_3
    //   257: invokevirtual 129	java/io/FileOutputStream:close	()V
    //   260: aload_1
    //   261: athrow
    //   262: astore_3
    //   263: ldc 134
    //   265: iconst_1
    //   266: new 75	java/lang/StringBuilder
    //   269: dup
    //   270: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   273: ldc 136
    //   275: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   278: aload_3
    //   279: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   282: invokevirtual 99	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   285: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   288: goto -28 -> 260
    //   291: astore_1
    //   292: goto -40 -> 252
    //   295: astore 5
  ...
  private void a(bioy parambioy, String... paramVarArgs)
  {
    QLog.i("QZoneSharePictureJsPlugin", 1, "saxon handleGenerateGif start");
    if ((parambioy == null) || (paramVarArgs == null) || (paramVarArgs.length < 1))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = PhotoUtils.a(bigv.a(antf.bg), "IMG", ".gif");
        ...
        if (!bool1)
        {
          ...
          parambioy = a(new File((String)localObject1));
      ...
      catch (Throwable parambioy)
      {
        QLog.e("QZoneSharePictureJsPlugin", 1, "handleGenerateGif fail, compressGIFTask exception.", parambioy);
        return;
      }
      boolean bool1 = false;
    }
    ...
    if (!bool3)
    {
      ...
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambioy, parambioy.length());
      return;
    }
    if (parambioy.length() <= k)
    {
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 不分片callback len=" + parambioy.length());
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambioy, parambioy.length());
      return;
    }
    int m = parambioy.length() / k;
    if (parambioy.length() % k == 0) {
      j = 0;
    }
    for (;;)
    {
      m += j;
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 分片callback pcount＝" + m + ",filelen=" + parambioy.length());
      j = 0;
      label612:
      if (j < m - 1)
      {
        a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, j, parambioy.substring(j * k, (j + 1) * k), parambioy.length());
    ...
    a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, m - 1, parambioy.substring((m - 1) * k), parambioy.length());
    ...
    paramVarArgs = bmtk.a();
    bmtd.a(parambioy.a(), paramVarArgs, (String)localObject1, anzj.a(2131711220), localInterruptedException, -1);
  }
  ...
  private void a(BaseResp paramBaseResp)
  {
    ...
    {
      i = 0;
      paramBaseResp = anzj.a(2131711228);
      a(paramBaseResp);
    }
    for (;;)
    {
      a(this.jdField_a_of_type_JavaLangString, i, paramBaseResp);
      return;
      if (j == -2)
      {
        paramBaseResp = anzj.a(2131711219);
        a(paramBaseResp);
      }
      else
      {
        paramBaseResp = anzj.a(2131711216);
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        try
        {
          ...
          paramString2.put("msg", anzj.a(2131711209));
  ...
  private void a(JSONObject paramJSONObject, String paramString, bioy parambioy)
  {
    ThreadManager.getSubThreadHandler().post(new QZoneSharePictureJsPlugin.7(this, paramJSONObject, paramString, parambioy));
  }
  
  private void a(String... paramVarArgs)
  {
    bnje.a().a(new bnms(this, paramVarArgs));
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 532	java/io/BufferedWriter
    //   5: dup
    //   6: new 534	java/io/OutputStreamWriter
    //   9: dup
    //   10: new 116	java/io/FileOutputStream
    //   13: dup
    //   14: aload_0
    //   15: iconst_1
    //   16: invokespecial 537	java/io/FileOutputStream:<init>	(Ljava/lang/String;Z)V
    //   19: invokespecial 540	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   22: invokespecial 543	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   25: astore_2
    //   26: aload_2
    //   27: astore_0
    //   28: aload_2
    //   29: aload_1
    //   30: invokevirtual 545	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   33: aload_2
    //   34: invokestatic 551	cooperation/qzone/util/DataUtils:closeDataObject	(Ljava/lang/Object;)Z
    //   37: pop
    //   38: iconst_1
    //   39: ireturn
    //   40: astore_3
    ...
    //   48: aload_3
    //   49: iconst_0
    //   50: anewarray 553	java/lang/Object
    //   53: invokestatic 559	cooperation/qzone/util/QZLog:w	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   56: aload_1
    //   57: invokestatic 551	cooperation/qzone/util/DataUtils:closeDataObject	(Ljava/lang/Object;)Z
    //   60: pop
    //   61: iconst_0
    //   62: ireturn
    //   63: astore_0
    ...
    //   65: astore_1
    //   66: aload_1
    //   67: invokestatic 551	cooperation/qzone/util/DataUtils:closeDataObject	(Ljava/lang/Object;)Z
    //   70: pop
    //   71: aload_0
    //   72: athrow
    //   73: astore_2
  ...
  {
    // Byte code:
    //   0: new 562	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: sipush 8192
    //   7: invokespecial 565	java/io/ByteArrayOutputStream:<init>	(I)V
    //   10: astore_3
    //   11: aload_3
    //   12: astore_2
    //   13: aload_0
    //   14: invokevirtual 570	android/graphics/Bitmap:hasAlpha	()Z
    //   17: ifeq +32 -> 49
    //   20: aload_3
    //   21: astore_2
    //   22: aload_0
    //   23: getstatic 576	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   26: iload_1
    //   27: aload_3
    //   28: invokevirtual 580	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   31: pop
    //   32: aload_3
    //   33: astore_2
    //   34: aload_3
    //   35: invokevirtual 584	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   38: astore_0
    //   39: aload_3
    //   40: invokevirtual 585	java/io/ByteArrayOutputStream:flush	()V
    //   43: aload_3
    //   44: invokevirtual 586	java/io/ByteArrayOutputStream:close	()V
    //   47: aload_0
    //   48: areturn
    //   49: aload_3
    //   50: astore_2
    //   51: aload_0
    //   52: getstatic 589	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   55: iload_1
    //   56: aload_3
    //   57: invokevirtual 580	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   60: pop
    //   61: goto -29 -> 32
    //   64: astore_0
    //   65: aload_3
    ...
    //   69: iconst_1
    //   70: aload_0
    //   71: invokevirtual 590	java/lang/Exception:toString	()Ljava/lang/String;
    //   74: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   77: aload_3
    //   78: invokevirtual 585	java/io/ByteArrayOutputStream:flush	()V
    //   81: aload_3
    //   82: invokevirtual 586	java/io/ByteArrayOutputStream:close	()V
    //   85: aconst_null
    //   86: areturn
    //   87: astore_0
    //   88: ldc 134
    //   90: iconst_1
    //   91: aload_0
    //   92: invokevirtual 590	java/lang/Exception:toString	()Ljava/lang/String;
    //   95: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   98: aconst_null
    //   99: areturn
    //   100: astore_2
    //   101: ldc 134
    //   103: iconst_1
    //   104: aload_2
    //   105: invokevirtual 590	java/lang/Exception:toString	()Ljava/lang/String;
    //   108: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   111: aload_0
    //   112: areturn
    //   113: astore_0
    //   114: aconst_null
    ...
    //   120: iconst_1
    //   121: aload_0
    //   122: invokevirtual 591	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
    //   125: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   128: aload_3
    //   129: invokevirtual 585	java/io/ByteArrayOutputStream:flush	()V
    //   132: aload_3
    //   133: invokevirtual 586	java/io/ByteArrayOutputStream:close	()V
    //   136: aconst_null
    //   137: areturn
    //   138: astore_0
    //   139: ldc 134
    //   141: iconst_1
    //   142: aload_0
    //   143: invokevirtual 590	java/lang/Exception:toString	()Ljava/lang/String;
    //   146: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   149: aconst_null
    //   150: areturn
    //   151: astore_0
    //   152: aconst_null
    //   153: astore_2
    //   154: aload_2
    //   155: invokevirtual 585	java/io/ByteArrayOutputStream:flush	()V
    //   158: aload_2
    //   159: invokevirtual 586	java/io/ByteArrayOutputStream:close	()V
    //   162: aload_0
    //   163: athrow
    //   164: astore_2
    //   165: ldc 134
    //   167: iconst_1
    //   168: aload_2
    //   169: invokevirtual 590	java/lang/Exception:toString	()Ljava/lang/String;
    //   172: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   175: goto -13 -> 162
    //   178: astore_0
    //   179: goto -25 -> 154
    //   182: astore_0
  ...
  {
    Bitmap localBitmap1 = bjtt.a(paramString, 120, 120, false);
  ...
  private void b(bioy parambioy, String... paramVarArgs)
  {
    int i = 0;
    Object localObject2;
    Object localObject3;
    label220:
    int j;
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (parambioy != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      String str;
      try
      {
        ...
        try
        {
          ...
          localObject3 = a((byte[])localObject3);
        ...
        {
          QLog.w("QZoneSharePictureJsPlugin", 1, "Base64.decode Exception: " + parambioy.toString());
          a(anzj.a(2131711196));
          return;
        }
      ...
      {
        QLog.w("QZoneSharePictureJsPlugin", 1, "handleSharePicture catch an exception in disPatchMethod", parambioy);
        return;
      }
      QLog.d("QZoneSharePictureJsPlugin", 1, "the filePath is " + (String)localObject3);
      if ((!TextUtils.isEmpty(str)) && (parambioy != null) && (parambioy.a() != null)) {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        i = bmtd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, parambioy, 21);
      ...
      default: 
        ...
        if ((parambioy != null) && ((parambioy instanceof bito)))
        {
          parambioy = ((bito)parambioy).getShare().a();
          if ((parambioy != null) && (parambioy.isShowing())) {
            parambioy.dismiss();
          }
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        auxu.a(parambioy.a(), (Intent)localObject1, paramVarArgs, i, -1, "");
      }
      ...
      a((JSONObject)localObject2, (String)localObject3, parambioy);
      break;
      if (bnhm.a().a())
      {
        ...
        bnhm.a().a(this.jdField_a_of_type_Bnhn);
        bnhm.a().a(BaseApplicationImpl.getContext(), (String)localObject3, (byte[])localObject1, 0);
        break;
      }
      if (parambioy.a() == null) {
        break;
      }
      parambioy.a().post(new QZoneSharePictureJsPlugin.5(this, parambioy));
      break;
      if (bnhm.a().a())
      {
        if (TextUtils.equals(paramVarArgs, "wezone"))
        ...
        bnhm.a().a(this.jdField_a_of_type_Bnhn);
        bnhm.a().a(BaseApplicationImpl.getContext(), (String)localObject3, null, 1);
        break;
      }
      if (parambioy.a() == null) {
        break;
      }
      parambioy.a().post(new QZoneSharePictureJsPlugin.6(this, parambioy));
      break;
      if (parambioy == null)
      {
  ...
  private void b(String paramString)
  {
    ...
    localObject2 = localObject1;
    label113:
    paramString = bmxh.b().a();
    if (TextUtils.isEmpty(paramString))
    {
      a(localObject2, -1, anzj.a(2131711205));
      return;
    }
    try
    {
      localObject1 = new File(paramString);
      if ((!auog.a(paramString)) && (!((File)localObject1).mkdirs()))
      {
    ...
    catch (Exception paramString)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = bmxh.b().a(paramString);
        try
        {
        ...
        long l = bhjx.a((File)localObject1);
      ...
      a(localObject2, -1, anzj.a(2131711226));
      return;
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    a(paramString, -1, anzj.a(2131711212));
  }
  ...
  String a(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 946	java/io/BufferedInputStream
    //   6: dup
    //   7: new 948	java/io/FileInputStream
    //   10: dup
    //   11: aload_1
    //   12: invokespecial 949	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 952	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_2
    //   22: invokevirtual 955	java/io/BufferedInputStream:available	()I
    //   25: newarray byte
    //   27: astore_3
    //   28: aload_2
    //   29: astore_1
    //   30: aload_2
    //   31: aload_3
    //   32: invokevirtual 959	java/io/BufferedInputStream:read	([B)I
    //   35: pop
    //   36: aload_2
    //   37: astore_1
    //   38: aload_3
    //   39: iconst_0
    //   40: invokestatic 963	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   43: astore_3
    //   44: aload_3
    //   45: astore_1
    //   46: aload_2
    //   47: ifnull +9 -> 56
    //   50: aload_2
    //   51: invokevirtual 964	java/io/BufferedInputStream:close	()V
    //   54: aload_3
    //   55: astore_1
    //   56: aload_1
    //   57: areturn
    //   58: astore_1
    //   59: aload_1
    //   60: invokevirtual 967	java/io/IOException:printStackTrace	()V
    //   63: aload_3
    //   64: areturn
    //   65: astore_3
    //   66: aconst_null
    ...
    //   73: ldc_w 771
    //   76: aload_3
    //   77: invokestatic 969	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   80: aload 4
    //   82: astore_1
    //   83: aload_2
    //   84: ifnull -28 -> 56
    //   87: aload_2
    //   88: invokevirtual 964	java/io/BufferedInputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore_1
    //   94: aload_1
    //   95: invokevirtual 967	java/io/IOException:printStackTrace	()V
    //   98: aconst_null
    //   99: areturn
    //   100: astore_3
    //   101: aconst_null
    ...
    //   108: ldc_w 771
    //   111: aload_3
    //   112: invokestatic 969	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   115: aload 4
    //   117: astore_1
    //   118: aload_2
    //   119: ifnull -63 -> 56
    //   122: aload_2
    //   123: invokevirtual 964	java/io/BufferedInputStream:close	()V
    //   126: aconst_null
    //   127: areturn
    //   128: astore_1
    //   129: aload_1
    //   130: invokevirtual 967	java/io/IOException:printStackTrace	()V
    //   133: aconst_null
    //   134: areturn
    //   135: astore_3
    //   136: aconst_null
    ...
    //   143: ldc_w 771
    //   146: aload_3
    //   147: invokestatic 969	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   150: aload 4
    //   152: astore_1
    //   153: aload_2
    //   154: ifnull -98 -> 56
    //   157: aload_2
    //   158: invokevirtual 964	java/io/BufferedInputStream:close	()V
    //   161: aconst_null
    //   162: areturn
    //   163: astore_1
    //   164: aload_1
    //   165: invokevirtual 967	java/io/IOException:printStackTrace	()V
    //   168: aconst_null
    //   169: areturn
    //   170: astore_2
    //   171: aconst_null
    ...
    //   174: ifnull +7 -> 181
    //   177: aload_1
    //   178: invokevirtual 964	java/io/BufferedInputStream:close	()V
    //   181: aload_2
    //   182: athrow
    //   183: astore_1
    //   184: aload_1
    //   185: invokevirtual 967	java/io/IOException:printStackTrace	()V
    //   188: goto -7 -> 181
    //   191: astore_2
    //   192: goto -19 -> 173
    //   195: astore_3
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bnhn != null) {
      bnhm.a().b(this.jdField_a_of_type_Bnhn);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    for (paramIntent = anzj.a(2131711234);; paramIntent = anzj.a(2131711200))
    {
