...
public class ahlw
{
  public static void a(abnt paramabnt, MessageRecord paramMessageRecord, QQMessageFacade paramQQMessageFacade, QQAppInterface paramQQAppInterface)
  {
    if ((paramabnt == null) || (paramMessageRecord == null) || (paramQQMessageFacade == null) || (paramQQAppInterface == null)) {}
    Object localObject;
    int k;
    int i;
    do
    {
      ...
      k = baba.a().b(paramQQAppInterface);
      if (k <= 0) {
        break;
      }
      int j = 0;
    ...
    try
    {
      paramabnt.a((QQMessageFacade.Message)localObject);
      paramQQMessageFacade.a().unReadNum = k;
      return;
    }
    catch (Throwable paramabnt)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopSuspiciousHelper", 2, "add GroupSuspiciousMsg ERROR", paramabnt);
        }
      }
    }
  ...
  public static void a(amha paramamha, QQAppInterface paramQQAppInterface, structmsg.RspNextSystemMsg paramRspNextSystemMsg, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        localMessageRecord.frienduin = aljq.O;
    ...
    localObject = (aubr)paramQQAppInterface.getManager(37);
    boolean bool;
    if (localArrayList.size() > 0)
    {
      if ((localArrayList.size() < 20) && (localObject != null)) {
        ((aubr)localObject).b(true);
      }
      ...
      if ((alsh.a(localArrayList)) && (paramQQAppInterface.isBackground_Stop))
      {
        bool = true;
    ...
    for (;;)
    {
      paramamha.a(4019, true, localArrayList);
      return;
      bool = false;
      break;
      if (localObject != null) {
  ...
  public static void a(amha paramamha, QQAppInterface paramQQAppInterface, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    ...
    baba.a().b(paramQQAppInterface, paramInt);
    paramRspSystemMsgNew = new ArrayList();
    int i = paramList.size();
    Object localObject = (aubr)paramQQAppInterface.getManager(37);
    if (localObject != null) {
      ((aubr)localObject).b(false);
    }
    Collections.sort(paramList, new ahlx());
    paramInt = 0;
    if (paramInt < i)
    {
      localObject = ayvw.a(-2018);
      ((MessageRecord)localObject).msgtype = -2018;
      ((MessageRecord)localObject).selfuin = paramString;
      ((MessageRecord)localObject).frienduin = aljq.O;
    ...
    paramQQAppInterface.a().a(aljq.O, 0);
    if (paramRspSystemMsgNew.size() > 0)
    {
      paramList = paramQQAppInterface.a();
      paramString = String.valueOf(paramString);
      if ((!alsh.a(paramRspSystemMsgNew)) || (!paramQQAppInterface.isBackground_Stop)) {
        break label568;
      }
    }
    label568:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramamha.a(4019, true, paramRspSystemMsgNew);
      return;
    }
  }
  ...
  public static void a(structmsg.StructMsg paramStructMsg, String paramString)
  {
    ...
    {
      bdaj.a("Grp_contacts_news", "notice", paramString, 0, 0, new String[] { str1, str2, paramStructMsg });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = paramQQAppInterface.a().b(aljq.O, 0);
