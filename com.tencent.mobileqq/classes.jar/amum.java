...
public class amum
{
  ...
  public static amum a(String paramString)
  {
    boolean bool2 = true;
    if (paramString == null) {
      return null;
    ...
    try
    {
      ...
      {
        bool1 = true;
        localamum.jdField_a_of_type_Boolean = bool1;
        if (paramString.optInt("compressAndEncrypt", 0) != 1) {
          break label130;
        }
        bool1 = true;
        label56:
        localamum.jdField_b_of_type_Boolean = bool1;
      ...
      {
        localamum.d = bool1;
        localamum.jdField_a_of_type_Long = paramString.optLong("locationSdkCallbackIntervalMillis", 2000L);
        localamum.jdField_b_of_type_Long = paramString.optLong("locationBgTimeoutMillis", 60000L);
        return localamum;
        bool1 = false;
        break;
        bool1 = false;
