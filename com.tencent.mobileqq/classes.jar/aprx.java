...
{
  public aprx(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            apse.a(this.app, str, aprw.e, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            apse.a(this.app, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  private void b(QQAppInterface paramQQAppInterface, aprw paramaprw)
  {
    long l1 = bbko.a();
    ...
    aprw.a(paramQQAppInterface, "redpoint_box_show", l1);
    apse.a(paramQQAppInterface, false, true);
    ...
    paramQQAppInterface = (RecentUser)localanuz.findRecentUser(AppConstants.CONFESS_UIN, 1032);
    int i;
    ...
    for (;;)
    {
      if (i != 0)
      {
        localanuz.saveRecentUser(paramQQAppInterface);
        paramQQAppInterface = this.mApp.getHandler(Conversation.class);
        if (paramQQAppInterface != null) {
          paramQQAppInterface.sendEmptyMessage(1009);
        }
      }
      notifyUI(4, true, paramaprw);
      return;
  ...
  private void c(QQAppInterface paramQQAppInterface, aprw paramaprw)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, "onNeedShowLebaRedPoint");
    }
    aprw.a(paramQQAppInterface, "redpoint_leba_show", bbko.a());
  }
  ...
  public void a(apsm paramapsm)
  {
    ...
    notifyUI(2, true, paramapsm);
  }
  
  public void a(QQAppInterface paramQQAppInterface, aprw paramaprw)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, String.format("onGetNewConfig boxEntry:%d contactEntry:%d", new Object[] { Integer.valueOf(paramaprw.h), Integer.valueOf(paramaprw.i) }));
    }
    if (paramaprw.h == 2) {
      b(paramQQAppInterface, paramaprw);
    }
    if (paramaprw.i == 2) {
      c(paramQQAppInterface, paramaprw);
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo, int paramInt3)
  {
    ...
    if (paramInt3 == -1)
    {
      ...
      bcef.b(this.app, "dc00898", "", "", (String)localObject, (String)localObject, 0, 0, "", "", "", "");
  ...
  public void b(apsm paramapsm)
  {
    ...
    int i;
    if ((paramapsm != null) && (paramapsm.a()))
    {
      localanuz = this.app.getProxyManager().a();
      localRecentUser = (RecentUser)localanuz.findRecentUser(AppConstants.CONFESS_UIN, 1032);
      ...
      localRecentUser.lastmsgtime = paramapsm.a;
      paramapsm = localRecentUser;
      i = 1;
    }
    for (;;)
    {
      if (i != 0)
      {
        localanuz.saveRecentUser(paramapsm);
        paramapsm = this.mApp.getHandler(Conversation.class);
        if (paramapsm != null) {
          paramapsm.sendEmptyMessage(1009);
        }
      }
      notifyUI(1, true, null);
      return;
      label124:
      if (localRecentUser.lastmsgtime < paramapsm.a)
      {
        localRecentUser.lastmsgtime = paramapsm.a;
        paramapsm = localRecentUser;
        i = 1;
