...
public final class bgpf
{
  ...
  {
    a(paramContext, paramString1, paramBoolean1, paramString2, paramBoolean2, 2131692325);
  }
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = paramContext.getString(2131692366);
        if (!paramBoolean2) {
          continue;
        }
        paramString1 = paramContext.getString(2131692361);
        paramString1 = bbcv.a(paramContext, 230, paramString2, paramString1, 2131690596, 2131692364, new bgpg(), null);
      ...
      localbcpw.b(paramContext.getResources().getDimensionPixelSize(2131298865) - (int)(5.0F * paramContext.getResources().getDisplayMetrics().density));
      return;
      paramString1 = paramContext.getString(2131692365);
      continue;
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    ...
    return (paramChatMessage != null) && ((ampv.c.equals(paramChatMessage.ark_app_message.appName)) || ("com.tencent.structmsg".equals(paramChatMessage.ark_app_message.appName)));
  }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bgph((Runnable)localObject2));
