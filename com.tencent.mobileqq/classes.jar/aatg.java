...
{
  public aatg(ChatSettingActivity paramChatSettingActivity, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
        ...
        if (paramBundle != null)
        {
          ...
          if (paramInt != 0)
          {
            ...
            if ((!TextUtils.isEmpty(paramBundle)) && (QLog.isColorLevel()))
            {
              ...
              bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity, 1, paramBundle, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.getTitleBarHeight());
            }
          }
          else
          {
            ...
            if (((JSONObject)localObject).optInt("retcode") == 0)
            {
              ...
              if (this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.jdField_a_of_type_Boolean)
              {
                ...
                ((aset)this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app.getManager(16)).a(0, 1, ChatSettingActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity));
              ...
              paramInt = 2131694535;
              label390:
              bcql.a((Context)localObject, 2, localChatSettingActivity.getString(paramInt), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.getTitleBarHeight());
              if (!QLog.isColorLevel()) {
                return;
              }
    ...
    label653:
    label659:
    for (paramInt = 2131694534;; paramInt = 2131694547)
    {
