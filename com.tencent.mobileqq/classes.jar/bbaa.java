  ...
  implements bayr
{
  ...
  public bbaa(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public bbaa(QQAppInterface paramQQAppInterface, int paramInt1, byte[] paramArrayOfByte, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.c = paramInt1;
  ...
  public static List<bbaa> a(QQAppInterface paramQQAppInterface, List<DynamicDiscovery.Result> paramList, int paramInt)
  {
    ...
    {
      bass.b = ((AladdinConfig)localObject1).getString("SBWord_Source", "Hot_word");
      i = ((AladdinConfig)localObject1).getIntegerFromString("SearchPage_UIType", 0);
      bass.a = ((AladdinConfig)localObject1).getIntegerFromString("SearchPage_RwordNum", 8);
    }
        ...
        case 3: 
          for (;;)
          {
            ...
            for (localObject4 = null;; localObject4 = new HotWordSearchEntryDataModel(paramQQAppInterface, m, ((DynamicDiscovery.Result)localObject4).toByteArray(), paramInt, false))
            {
              ...
              break;
              if (bass.b.contentEquals("Hot_word"))
              {
                ...
                bfyz.a(paramQQAppInterface.getCurrentAccountUin(), (String[])localObject5);
              }
            }
            localObject4 = new bawy(paramQQAppInterface, m, ((DynamicDiscovery.Result)localObject4).toByteArray(), paramInt, false);
    ...
    for (;;)
    {
      boolean bool = a(arrayOfInt, bass.a(paramQQAppInterface, paramInt, false));
      bass.a(paramQQAppInterface, paramInt, bool, false);
      if (bool) {
        bass.a(paramQQAppInterface, paramInt, arrayOfInt, false);
      }
  ...
  public static List<bbaa> b(QQAppInterface paramQQAppInterface, List<UnifySearchDiscovery.Result> paramList, int paramInt)
  {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            bfyz.b(paramQQAppInterface.getCurrentAccountUin(), arrayOfString);
            ...
            continue;
            localObject = new bawy(paramQQAppInterface, k, ((UnifySearchDiscovery.Result)localObject).toByteArray(), paramInt, true);
          }
        }
      }
      boolean bool = a(arrayOfInt, bass.a(paramQQAppInterface, paramInt, true));
      bass.a(paramQQAppInterface, paramInt, bool, true);
      if (bool) {
        bass.a(paramQQAppInterface, paramInt, arrayOfInt, true);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("SearchEntryDataModel", 2, "convertPbDataToModel, modelList = " + localArrayList.size());
  ...
  public void a()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_ArrayOfByte = FileUtils.fileToBytes(BaseApplication.getContext().getFileStreamPath("search_discovery_sp_prefixpref_search_model_data" + localQQAppInterface.getCurrentAccountUin() + "_" + this.c + "_" + this.d));
        a(this.jdField_a_of_type_ArrayOfByte);
        return;
      }
      this.jdField_a_of_type_ArrayOfByte = FileUtils.fileToBytes(BaseApplication.getContext().getFileStreamPath("search_discovery_sp_prefix_unifypref_search_model_data" + localQQAppInterface.getCurrentAccountUin() + "_" + this.c + "_" + this.d));
      a(this.jdField_a_of_type_ArrayOfByte);
    }
  }
