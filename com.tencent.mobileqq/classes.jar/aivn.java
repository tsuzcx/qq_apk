...
public class aivn
{
  ...
  public static aivn a()
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (jdField_a_of_type_Aivn != null) {
        break label71;
      }
    }
    label71:
  ...
  {
    // Byte code:
    //   0: getstatic 84	aivn:jdField_a_of_type_Aivn	Laivn;
    //   3: ifnull +4 -> 7
    //   6: return
    //   7: new 36	java/io/File
    //   10: dup
    //   11: getstatic 54	aivn:b	Ljava/lang/String;
    //   14: invokespecial 99	java/io/File:<init>	(Ljava/lang/String;)V
    //   17: astore_0
    //   18: new 36	java/io/File
    //   21: dup
    //   22: getstatic 58	aivn:c	Ljava/lang/String;
    ...
    //   106: new 2	aivn
    //   109: dup
    //   110: invokespecial 132	aivn:<init>	()V
    //   113: putstatic 84	aivn:jdField_a_of_type_Aivn	Laivn;
    //   116: aload_1
    //   117: astore_0
    //   118: getstatic 84	aivn:jdField_a_of_type_Aivn	Laivn;
    //   121: aload_2
    //   122: iconst_0
    //   123: aaload
    //   124: putfield 134	aivn:d	Ljava/lang/String;
    //   127: aload_1
    //   128: astore_0
    //   129: getstatic 84	aivn:jdField_a_of_type_Aivn	Laivn;
    //   132: aload_2
    //   133: iconst_1
    //   134: aaload
    //   135: putfield 136	aivn:e	Ljava/lang/String;
    //   138: aload_1
    //   139: ifnull -133 -> 6
    //   142: aload_1
    ...
    //   174: astore_0
    //   175: aconst_null
    //   176: putstatic 84	aivn:jdField_a_of_type_Aivn	Laivn;
    //   179: aload_1
    //   180: ifnull -174 -> 6
    //   183: aload_1
