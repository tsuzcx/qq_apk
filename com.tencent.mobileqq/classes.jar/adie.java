  ...
  implements UniformDownloader.IUniformDownloaderListener
{
  ...
  public adie(UniformDownloadNfn paramUniformDownloadNfn, Looper paramLooper, int paramInt, Bundle paramBundle, long paramLong)
  {
    super(paramLooper);
  ...
  public void a(String paramString, long paramLong, Bundle paramBundle)
  {
    ...
    paramBundle = UniformDownloadUtil.a(paramString);
    if (paramBundle != null) {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      ((UniformDownloadMgr)localObject).a(str1, str2, l, localBundle, j, bool);
      this.c = 1;
      continue;
      ...
      if (2 != this.c) {
        UniformDownloadMgr.a().a(this.jdField_a_of_type_AndroidOsBundle.getString("_notify_param_Url"), this.jdField_a_of_type_AndroidOsBundle.getString("_notify_param_Filename"), this.jdField_a_of_type_AndroidOsBundle.getLong("_notify_param_Filesize"), this.jdField_a_of_type_AndroidOsBundle.getBundle("_notify_param_userdata"), this.jdField_a_of_type_Int, false);
      }
      this.c = 2;
      continue;
      ...
      UniformDownloadMgr.a().c(this.jdField_a_of_type_AndroidOsBundle.getString("_notify_param_Url"));
      this.c = 3;
      continue;
