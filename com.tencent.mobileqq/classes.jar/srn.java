  ...
  implements View.OnClickListener
{
  ...
  public srn(Activity paramActivity, View paramView, int paramInt1, int paramInt2, srt paramsrt)
  {
    super(paramView);
    ...
    this.jdField_a_of_type_Anou = new anou(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130845484);
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362427));
    this.jdField_b_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362440));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131362502));
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewRoundCornerLayout = ((RoundCornerLayout)paramView.findViewById(2131362430));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362504));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362499));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362442));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362483));
    this.e = ((TextView)paramView.findViewById(2131362503));
    this.f = ((TextView)paramView.findViewById(2131362485));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362436));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362432);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362441));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362477));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131363997));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363998));
    this.g = ((TextView)paramView.findViewById(2131363999));
    ...
    this.jdField_a_of_type_AndroidOsHandler = new srr(this, Looper.getMainLooper());
    paramActivity = (spq)tdc.a(30);
  ...
  private int a()
  {
    ...
    if (this.jdField_a_of_type_Sqb != null) {
      i = this.jdField_a_of_type_Sqb.e;
    }
    return i;
  }
  
  private int a(List<sqc> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      i = j;
      if (new File(((sqc)paramList.get(j)).jdField_a_of_type_JavaLangString).exists()) {
        break;
      }
      j += 1;
    }
  ...
  private Drawable a(String paramString)
  {
    ...
    //   64: ldc_w 298
    //   67: aload_3
    //   68: invokestatic 303	veg:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   71: aload_2
    //   72: ifnull +49 -> 121
    //   75: aload_2
  ...
  private URLDrawable a(String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean, srn paramsrn)
  {
    QQLiveDrawable.QQLiveDrawableParams localQQLiveDrawableParams = new QQLiveDrawable.QQLiveDrawableParams();
    paramsrn = new sru(paramsrn);
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = this.jdField_a_of_type_Anou;
    if (!paramBoolean) {
    ...
    {
      localQQLiveDrawableParams.mListener = paramsrn;
      localQQLiveDrawableParams.mDownloadListener = paramsrn;
      paramString2 = URLDrawable.URLDrawableOptions.obtain();
      paramString2.mExtraInfo = localQQLiveDrawableParams;
      paramString2.mFailedDrawable = this.jdField_a_of_type_Anou;
      paramString2.mLoadingDrawable = this.jdField_a_of_type_Anou;
  ...
  {
    if (this.jdField_a_of_type_Sqb != null) {
      this.jdField_a_of_type_Sqb.e = paramInt;
    }
  }
  ...
  {
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg :%s", new Object[] { this.jdField_a_of_type_Sqb });
    this.jdField_c_of_type_Int = 3;
    if (paramList.size() == 0)
    {
      veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , no pic list");
      return;
    }
    ...
    {
      veg.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , %s", paramList);
      return;
    }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Sqb.a() == 0) {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetLinearLayout.getVisibility() == 0) && (this.jdField_b_of_type_AndroidWidgetLinearLayout.getAnimation() == null))
    {
      ...
      localAlphaAnimation.setAnimationListener(new sro(this));
    ...
    if (i < 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Sqb.jdField_b_of_type_JavaLangString);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Sqb.a(((List)localObject).size()))) {
        break label364;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(ajyc.a(2131700159), new Object[] { this.jdField_a_of_type_Sqb.jdField_b_of_type_JavaLangString, Integer.valueOf(((List)localObject).size()) }));
    }
    for (;;)
    {
      this.f.setText(String.valueOf(this.jdField_a_of_type_Sqb.b()));
      this.e.setText(this.jdField_a_of_type_Sqb.a());
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView.setLocalDrawable(((sqc)((List)localObject).get(i)).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      break;
      label364:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Sqb.a(((List)localObject).size()));
    }
  }
  ...
  private void e()
  {
    ...
    a(localHashSet);
    tsu.a(this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView, null, this.jdField_b_of_type_JavaLangString, false, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700165));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700167));
  }
  ...
  private void f()
  {
    ...
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845486);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845484);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700174));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700157));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700175));
    this.g.setText(ajyc.a(2131700152));
  }
  ...
  private void g()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845489);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845484);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700168));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700172));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700178));
    this.g.setText(ajyc.a(2131700150));
  }
  ...
  private void h()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845485);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845484);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700176));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700177));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700173));
    this.g.setText(ajyc.a(2131700153));
  }
  ...
  private void i()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845487);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845484);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700163));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700158));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700169));
    this.g.setText(ajyc.a(2131700171));
  }
  
  private void j()
  {
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop :%s", new Object[] { this.jdField_a_of_type_Sqb });
    if ((this.jdField_a_of_type_Sqb == null) || (this.jdField_a_of_type_Sqb.a()))
    {
      veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,album not exist");
      this.jdField_c_of_type_Int = 0;
      return;
    }
    ...
    {
      veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,get pick count not enough ,size = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
      this.jdField_c_of_type_Int = 0;
      return;
    }
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop success ,get pick count = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
  }
  
  private void k()
  {
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayLoop");
    this.jdField_c_of_type_Int = 0;
    ...
    if (this.jdField_a_of_type_Sqb != null)
    {
      localObject = this.jdField_a_of_type_Sqb.a();
      if (((List)localObject).size() <= 0) {
        break label111;
      }
    }
    label111:
    for (Object localObject = ((sqc)((List)localObject).get(0)).jdField_a_of_type_JavaLangString;; localObject = "")
    {
  ...
  private void l()
  {
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayMp4 :%s", new Object[] { this.jdField_a_of_type_Sqb });
    ...
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_Anou;
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_Anou;
  ...
  private void m()
  {
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4");
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_ComTencentImageURLDrawable != null)
    {
      if ((this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable() instanceof QQLiveDrawable))
      {
        ...
        veg.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4 suc");
      }
  ...
  private void o()
  {
    veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayCenterImg");
    this.jdField_c_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Sqb != null) {
      a(this.jdField_a_of_type_Sqb);
    }
  }
  
  public void a(@NonNull sqb paramsqb)
  {
    if ((this.jdField_a_of_type_Sqb != null) && (!this.jdField_a_of_type_Sqb.equals(paramsqb)) && (this.jdField_c_of_type_Int != 0)) {
      c();
    }
    this.jdField_a_of_type_Sqb = paramsqb;
    Object localObject = this.jdField_a_of_type_Sqb.a();
    paramsqb = new ArrayList();
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      sqc localsqc = (sqc)((Iterator)localObject).next();
      if (localsqc.a()) {
        paramsqb.add(localsqc);
      }
    }
    this.jdField_a_of_type_JavaUtilList = paramsqb;
    if (this.jdField_c_of_type_Int == 0)
    {
      if (!this.jdField_a_of_type_Sqb.a()) {
        break label185;
      }
      if (this.jdField_a_of_type_Sqb.jdField_d_of_type_Int == 1) {
        e();
      }
    }
    else
    ...
    if (this.jdField_a_of_type_Sqb.jdField_d_of_type_Int == 3)
    {
      f();
      return;
    }
    if (this.jdField_a_of_type_Sqb.jdField_d_of_type_Int == 2)
    {
      g();
      return;
    }
    if (this.jdField_a_of_type_Sqb.jdField_d_of_type_Int == 5)
    {
      i();
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Sqb == null) {
      veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , startPlay error!");
    }
    do
    {
      do
    ...
    } while (this.jdField_a_of_type_Sqb.jdField_d_of_type_Int != 2);
    a(spm.a().a(spm.jdField_a_of_type_Int));
    return;
    j();
  }
  ...
  {
    if (this.jdField_a_of_type_Sqb == null) {
      veg.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , stopPlay error!");
    }
    while (this.jdField_c_of_type_Int == 0) {
      return;
    }
    veg.a("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stop play :%s", this.jdField_a_of_type_Sqb);
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_Sqb.a()) {
      if (this.jdField_a_of_type_Sqb.jdField_d_of_type_Int == 1) {
        m();
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i < 3)
      {
        ...
        paramView = new srp(this);
        paramView = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, 2131558906, ajyc.a(2131700154), null, ajyc.a(2131700161), ajyc.a(2131700164), paramView, paramView);
      ...
      for (;;)
      {
        vel.a("video_shoot_slides", "delete_smartalbum", 0, 0, new String[] { String.valueOf(this.jdField_a_of_type_Sqb.d()), "1" });
        return;
        if (this.jdField_a_of_type_Srt != null) {
          this.jdField_a_of_type_Srt.b(this.jdField_a_of_type_Sqb);
        }
      }
    } while (vzo.b());
    bjke.a(this.jdField_a_of_type_AndroidViewView, 300L, new srq(this), new float[] { 1.0F, 0.95F, 1.0F });
  }
}
