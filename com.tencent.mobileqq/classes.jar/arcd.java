  ...
  extends BusinessHandler
{
  ...
  public arcd(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(ToServiceMsg paramToServiceMsg, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      if ((localSetMyComicFavorEmotIconsReqBody != null) && (localSetMyComicFavorEmotIconsReqBody.reqs != null))
      {
        ...
        ((arce)this.app.getManager(141)).b(paramToServiceMsg);
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (paramArrayOfByte != null) {
        ...
        {
          localObject = (arce)this.app.getManager(141);
          if (localObject != null)
          {
            paramInt = 0;
            while (paramInt < paramArrayOfByte.rsps.size())
            {
              ...
              ((arce)localObject).a(localVipComicFavorEmoStructMsgInfo);
              paramInt += 1;
            }
          }
        }
  ...
  public void c(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.maintab.has())) {
      bkfe.b(paramArrayOfByte.maintab.get());
    }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!paramFromServiceMsg.isSuccess())
      {
        ...
        {
          bhvw.a().a(str, l2, l3, l1, paramFromServiceMsg.getBusinessFailCode(), Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, paramToServiceMsg, false);
          return;
      ...
      try
      {
        ...
        if (j == 0)
        {
          ...
          bhvw.a().a("GetMyComicFavorEmotIcons", l2, l3, l1, j, Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, paramToServiceMsg, false);
          return;
        }
      }
