...
public class arcd
{
  private static arcd jdField_a_of_type_Arcd;
  ...
  public static arcd a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if ((jdField_a_of_type_Arcd == null) || (!jdField_a_of_type_Arcd.a()) || (!paramQQAppInterface.getCurrentAccountUin().equals(jdField_a_of_type_JavaLangString)))
      {
        jdField_a_of_type_Arcd = new arcd();
        jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
        jdField_a_of_type_Arcd.a(paramQQAppInterface);
      }
      paramQQAppInterface = jdField_a_of_type_Arcd;
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        else
        {
          ...
          do
          {
            ...
            localObject7 = (arce)((Iterator)localObject6).next();
          } while ((((arce)localObject7).b != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType) || (((arce)localObject7).jdField_a_of_type_Int != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType));
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          localObject6 = new arce();
          ((arce)localObject6).b = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType;
          ((arce)localObject6).jdField_a_of_type_Int = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType;
  ...
  {
    if (jdField_a_of_type_Arcd == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      jdField_a_of_type_Arcd.a();
      jdField_a_of_type_Arcd = null;
      return;
    }
  }
  ...
  public int a(String paramString, int paramInt, QQOperationViopTipTask paramQQOperationViopTipTask, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        if ((!acwh.p(paramString.msgtype)) || (paramString.extraflag != 0)) {
          break label221;
        }
  ...
  public arcf a(String paramString, int paramInt1, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean, int paramInt2)
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (paramBoolean)
        {
          ...
          paramList = (arcg)paramQQAppInterface.next();
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject1 = (arce)paramQQAppInterface.next();
          if ((((arce)localObject1).b != paramQQOperationVoipTipsTaskExcuteRecord.uinType) || (((arce)localObject1).jdField_a_of_type_Int != paramQQOperationVoipTipsTaskExcuteRecord.tipType)) {
            continue;
          }
          if (i == 0)
          {
            paramQQAppInterface = new arce();
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    //   114: aload_0
    //   115: invokevirtual 315	arcd:a	()V
    //   118: return
  ...
  public void a(String paramString, int paramInt, ArrayList<arcg> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ((anjo)paramQQAppInterface.a(4)).a(paramString, paramInt, paramArrayList, false);
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    while (localIterator.hasNext())
    {
      arce localarce = (arce)localIterator.next();
      if ((paramInt1 == localarce.b) && (paramInt2 == localarce.jdField_a_of_type_Int)) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, ArrayList<arcg> paramArrayList, boolean paramBoolean, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if ((TextUtils.isEmpty(((QQOperationViopTipTask)localObject3).keywordString)) && (((QQOperationViopTipTask)localObject3).frequencyTime == 0))
      {
        ...
        {
          if (paramQQAppInterface.hasNext()) {
            if (((arcg)paramQQAppInterface.next()).jdField_a_of_type_Int == ((QQOperationViopTipTask)localObject3).taskid)
            {
              paramInt1 = 1;
              label632:
              if (paramInt1 == 0)
              {
                paramQQAppInterface = new arcg();
        ...
        for (;;)
        {
          ...
          if ((TextUtils.isEmpty(localQQOperationViopTipTask.keywordString)) && (localQQOperationViopTipTask.frequencyTime == 0))
          {
            ...
            while (((Iterator)localObject2).hasNext()) {
              if (((arcg)((Iterator)localObject2).next()).jdField_a_of_type_Int == localQQOperationViopTipTask.taskid)
              {
                paramInt2 = 1;
                label1325:
                if (paramInt2 == 0)
                {
                  localObject2 = new arcg();
                  ((arcg)localObject2).jdField_a_of_type_Int = localQQOperationViopTipTask.taskid;
                  ((arcg)localObject2).b = i;
                  ((arcg)localObject2).jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
