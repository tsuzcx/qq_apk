...
public class bfen
  extends Dialog
{
  public bfen(Context paramContext, String paramString)
  {
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    View localView = ((LayoutInflater)localObject1).inflate(2131493317, null);
    try
    {
      Object localObject2 = ((LayoutInflater)localObject1).inflate(2131495863, (ViewGroup)localView, false);
      localObject1 = (RelativeLayout)localView.findViewById(2131311638);
      Object localObject3 = new RelativeLayout.LayoutParams(-1, -1);
      ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131309578);
      ((RelativeLayout)localObject1).addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
      localObject2 = (TextView)localView.findViewById(2131302804);
      IphoneTitleBarActivity.setLayerType((View)localObject2);
      if (localObject2 != null) {
        ((TextView)localObject2).setText(ajjy.a(2131642495));
      }
      localObject3 = (TextView)localView.findViewById(2131302847);
      IphoneTitleBarActivity.setLayerType((View)localObject2);
      ...
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        ...
        new SystemBarCompact(this, true, paramContext.getResources().getColor(2131101315)).init();
    ...
    catch (InflateException paramContext)
    {
      ...
      super.setContentView(2131495863);
