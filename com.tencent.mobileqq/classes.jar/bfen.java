  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   125: astore 8
    //   127: getstatic 22	bfen:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   130: astore 9
    //   132: aload 9
    //   134: arraylength
    //   135: istore 6
    ...
    //   227: astore 8
    //   229: aload_0
    //   230: getfield 31	bfen:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   233: aload 8
    //   235: invokevirtual 137	java/util/HashSet:contains	(Ljava/lang/Object;)Z
    //   238: ifeq +44 -> 282
    //   241: aload_0
    //   242: getfield 31	bfen:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   245: aload 8
    ...
    //   275: aload 7
    //   277: ldc 155
    //   279: invokevirtual 159	bfen:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    ...
    //   489: aload 7
    //   491: ldc 155
    //   493: invokevirtual 159	bfen:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   496: return
    //   497: astore_2
    //   498: goto -67 -> 431
    //   501: astore 8
  ...
  public void service(Intent paramIntent)
  {
    ...
    //   150: getstatic 22	bfen:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   153: astore 9
    //   155: aload 9
    //   157: arraylength
    //   158: istore_3
    ...
    //   271: aload_0
    //   272: getfield 31	bfen:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   275: aload 7
    ...
    //   294: aload_1
    //   295: aload 6
    //   297: invokevirtual 309	bfen:sendToMSF	(Landroid/content/Intent;Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   300: return
    //   301: astore 11
    //   303: aload 9
