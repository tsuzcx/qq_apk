...
public class arwb
{
  ...
  public float a()
  {
    if (this.jdField_a_of_type_Bhhf != null) {
      return this.jdField_a_of_type_Bhhf.jdField_a_of_type_Float;
    }
  ...
  {
    if (this.jdField_a_of_type_Bhhf != null) {
      return this.jdField_a_of_type_Bhhf.a();
    }
    return (Bundle)((bgzk)paramQQAppInterface.getManager(235)).a.a.get(this.jdField_a_of_type_JavaLangString);
  }
