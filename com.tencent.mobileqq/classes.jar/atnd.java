...
public class atnd
  implements atly, atrs
{
  protected int a;
  public long a;
  private atib jdField_a_of_type_Atib = new atne(this);
  public atmi a;
  ...
  public atnd(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  {
    a(1005);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.uniseq, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType, 15, null, paramathx.jdField_a_of_type_Int, paramathx.jdField_a_of_type_JavaLangString);
    ...
    int i = paramathx.jdField_a_of_type_Int;
    String str = paramathx.jdField_a_of_type_JavaLangString;
    if (paramathx.jdField_a_of_type_Int == 0)
    {
      i = 9048;
  ...
  private void a(athx paramathx, List<String> paramList)
  {
    boolean bool2 = false;
    boolean bool3 = true;
    String str1 = null;
    short s = paramathx.jdField_a_of_type_Short;
    boolean bool1;
    if ((atpj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (paramathx.jdField_d_of_type_Int == 2) && (!TextUtils.isEmpty(paramathx.jdField_c_of_type_JavaLangString)))
    {
      str1 = paramathx.jdField_c_of_type_JavaLangString;
      s = paramathx.jdField_b_of_type_Short;
      if (s == 0)
      {
        s = 443;
        bool1 = true;
    ...
    for (;;)
    {
      ...
      localArrayList.add(0, paramathx.jdField_b_of_type_JavaLangString + ":" + s);
      Object localObject = new ArrayList();
      if (paramList != null) {
        ((List)localObject).addAll(paramList);
      }
      ((List)localObject).add(0, paramathx.jdField_b_of_type_JavaLangString);
      if (!d()) {
        this.jdField_c_of_type_Boolean = bool1;
      }
      if (b(paramathx))
      {
        QLog.i("OfflineSendWorker<FileAssistant>", 1, "[IPv6-File] offline upload. is config enable IPv6. domain[" + paramathx.jdField_d_of_type_JavaLangString + "]");
        paramList = new atlc(paramathx.jdField_d_of_type_JavaLangString, s);
        paramList = atlb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 1);
        if ((paramList != null) && (!paramList.a()))
        {
          ...
          atlb.a(paramList.jdField_a_of_type_JavaUtilList, localArrayList, false, false);
          atlb.a(paramList.jdField_a_of_type_JavaUtilList, (List)localObject, true, false);
      ...
      for (;;)
      {
        a(paramathx, bool1, str1, s, localArrayList, (List)localObject, bool2);
        return;
  ...
  private void a(athx paramathx, boolean paramBoolean1, String paramString, short paramShort, List<String> paramList1, List<String> paramList2, boolean paramBoolean2)
  {
    ThreadManager.post(new OfflineSendWorker.4(this, paramathx, paramBoolean1, paramString, paramList1, paramList2, paramShort, paramBoolean2), 5, null, false);
  }
  ...
  private void a(String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    auel.a().execute(new OfflineSendWorker.2(this, paramString, paramLong, paramArrayOfByte3, paramArrayOfByte4, paramArrayOfByte2, paramArrayOfByte1));
    this.jdField_e_of_type_Boolean = false;
    this.jdField_a_of_type_Int = 1;
  }
  
  private void a(String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong, atib paramatib, FileManagerEntity paramFileManagerEntity)
  {
    paramatib = new aucv();
    paramatib.jdField_a_of_type_JavaLangString = paramFileManagerEntity.peerUin;
    paramatib.jdField_b_of_type_ArrayOfByte = paramArrayOfByte2;
    paramatib.jdField_a_of_type_ArrayOfByte = paramArrayOfByte1;
    paramatib.jdField_a_of_type_Long = paramFileManagerEntity.fileSize;
    paramFileManagerEntity.strFileMd5 = atrr.a(paramArrayOfByte3);
    paramatib.jdField_c_of_type_ArrayOfByte = paramArrayOfByte3;
    ...
    while (i != 0)
    {
      ...
      paramatib.jdField_a_of_type_Boolean = true;
      paramatib.jdField_a_of_type_Int = 1700;
      paramString = auea.a(new String(paramArrayOfByte1));
      if (paramString == null)
      {
        a(null, 0);
        return;
      ...
      {
        k();
        paramFileManagerEntity.strFileSHA = atrr.a(paramString);
        a(paramString);
        paramatib.e = paramString;
        a(false, paramatib.e);
        paramatib.jdField_d_of_type_ArrayOfByte = auea.b(new String(paramArrayOfByte1));
        paramatib.f = auea.d(new String(paramArrayOfByte1));
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(paramatib, this.jdField_a_of_type_Atib, paramFileManagerEntity);
      return;
      ...
      {
        paramatib.jdField_a_of_type_Int = 1600;
        arrayOfByte = auea.d(new String(paramArrayOfByte1));
        if (arrayOfByte == null)
        {
          a(null, 0);
          return;
  ...
  private boolean a(athx paramathx)
  {
    return (!paramathx.jdField_b_of_type_Boolean) && ((paramathx.jdField_b_of_type_JavaLangString == null) || (paramathx.jdField_b_of_type_JavaLangString.length() == 0));
  }
  ...
  private void b(athx paramathx)
  {
    ...
    if (paramathx.jdField_a_of_type_JavaLangString != null) {
      str = paramathx.jdField_a_of_type_JavaLangString;
    }
    b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, i, str);
    a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, i, str);
  }
  
  private boolean b(athx paramathx)
  {
    return (!TextUtils.isEmpty(paramathx.jdField_d_of_type_JavaLangString)) && (atlb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1));
  }
  ...
  private void o()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bUseMediaPlatform, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_Atib);
    audz localaudz = new audz();
    localaudz.jdField_b_of_type_JavaLangString = "send_file_suc";
  ...
  public atmi a(athx paramathx, List<String> paramList, int paramInt, boolean paramBoolean, String paramString)
  {
    return null;
  }
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      {
        l1 = l2;
        if (this.jdField_a_of_type_Atmi.a() > this.jdField_a_of_type_Atmi.b()) {
          l1 = this.jdField_a_of_type_Atmi.a() - this.jdField_a_of_type_Atmi.b();
        }
      }
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUp", this.jdField_a_of_type_Long, null, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, null, paramString2, 0, paramString1, null, localBundle);
      return;
    }
    auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUp", this.jdField_a_of_type_Long, this.jdField_a_of_type_Atmi.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Atmi.a(), paramString2, this.jdField_a_of_type_Atmi.b(), paramString1, null, localBundle);
  }
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    {
      paramInt = 9001;
      paramString1 = "[Http_RespValue_Null]" + auea.a();
    }
    for (;;)
    {
  ...
  protected void b(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_a_of_type_Long, null, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, null, null, 0, paramString2, null, localBundle);
      return;
    }
    auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_a_of_type_Long, this.jdField_a_of_type_Atmi.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", l1, paramLong, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Atmi.a(), paramString2, this.jdField_a_of_type_Atmi.b(), paramString1, null, localBundle);
  }
  ...
  protected void b(String paramString)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      {
        l1 = l2;
        if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize > this.jdField_a_of_type_Atmi.b()) {
          l1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize - this.jdField_a_of_type_Atmi.b();
        }
      }
    }
    Bundle localBundle = new Bundle();
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUp", this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, this.jdField_a_of_type_Atmi.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, l1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Atmi.b(), paramString, localBundle);
      if (!d()) {
        auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, this.jdField_a_of_type_Atmi.a(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, l1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Atmi.b(), paramString, localBundle);
      }
    }
    label327:
    do
    ...
    auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileUpDetail", this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, null, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, l1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, 0, paramString, localBundle);
  }
  ...
  public int c()
  {
    ...
    while (this.jdField_a_of_type_Atmi == null) {
      return 0;
    }
    return (int)(this.jdField_a_of_type_Atmi.a() * 100L / this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize);
  }
  ...
  protected int d()
  {
    ...
    return aufd.c(this.jdField_a_of_type_Atmi.a());
  }
  ...
  public void d()
  {
    ...
    l = 0L;
    if (this.jdField_a_of_type_Atmi != null) {
      l = this.jdField_a_of_type_Atmi.a();
    }
    a(l, 9037, str);
    b(l, 9037, str);
  }
  ...
  {
    c(System.currentTimeMillis());
    if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Atmi != null)) {
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Atmi.a();
    }
    o();
  }
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.setCloudType(3);
    a(1003);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.uniseq, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType, 14, new Object[] { this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize), Boolean.valueOf(true), this.jdField_a_of_type_Atmi.a() }, 0, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bUseMediaPlatform, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_Atib);
    audz localaudz = new audz();
    localaudz.jdField_b_of_type_JavaLangString = "send_file_suc";
    localaudz.jdField_a_of_type_Int = 1;
  ...
  public void m()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        arrayOfByte3 = auea.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath());
      ...
      a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, arrayOfByte2, localUnsupportedEncodingException, arrayOfByte3, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this.jdField_a_of_type_Atib, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
