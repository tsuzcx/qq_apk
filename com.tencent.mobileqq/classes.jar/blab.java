...
public class blab
  implements bkxh, QQSpecialAVFilter.MusicWaveformSupporter
{
  private int jdField_a_of_type_Int;
  private blay jdField_a_of_type_Blay;
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private QQFilterRenderManager jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = biho.a();
  ...
  public blab(List<FilterDesc> paramList, MusicItemInfo paramMusicItemInfo, int paramInt1, int paramInt2, PublishVideoEntry paramPublishVideoEntry)
  {
    if (paramList != null)
    {
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null)
    {
      this.jdField_a_of_type_Blay = new blay();
      if (!blba.a()) {
        break label44;
      }
      this.d = true;
    ...
    for (;;)
    {
      ...
      blac localblac = new blac(this);
      try
      {
        long l = SystemClock.elapsedRealtimeNanos();
        boolean bool = this.jdField_a_of_type_Blay.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, localblac, 0);
        if (QLog.isColorLevel()) {
  ...
  public float getCurrentMusicGain()
  {
    try
    {
      if (this.jdField_a_of_type_Blay != null)
      {
        ...
        float f = this.jdField_a_of_type_Blay.a(this.jdField_a_of_type_Int);
        return f;
      }
    }
    catch (Exception localException)
