...
public class aprr
{
  ...
  private static void a(aprs paramaprs)
  {
    if (paramaprs == null) {}
    do
    {
      ...
      {
        return;
        paramaprs = paramaprs.toString();
        if (QLog.isColorLevel()) {
          QLog.d("ArkApp.ArkSecurityReporter", 2, new Object[] { "ArkSafe.report reportRealTime content=", paramaprs });
        }
    ...
    ((apni)localObject).a(paramaprs);
    return;
    Object localObject = new Bundle();
    ((Bundle)localObject).putString("reportContent", paramaprs);
    apqv.a().a("callReportUrlCheck", (Bundle)localObject, null);
  }
  ...
  public static void a(String paramString)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (localInteger != null)
      {
        ...
        bcst.b(null, "dc00898", "", "", "0X8009BCF", "0X8009BCF", 0, localInteger.intValue(), 0, b(), "", paramString, "");
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localInteger != null)
        {
          ...
          bcst.b(null, "dc00898", "", "", "0X8009BD0", "0X8009BD0", 0, localInteger.intValue(), 0, b(), "1", paramString, "");
  ...
  public static void a(String paramString1, String arg1, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArkApp.ArkSecurityReporter", 2, new Object[] { "ArkSafe.report invalid resource url app=", paramString1, ", count=1, result=", Integer.valueOf(paramInt2), ",validType=", Integer.valueOf(paramInt1), ",sender uin=", paramString3, " ,url=", nmj.b(???, new String[0]), " ,QQVersion=", b() });
    }
    bcst.a(null, "dc00898", "", paramString3, "0X8009BCF", "0X8009BCF", paramInt1, paramInt2, b(), "0", paramString1, ???);
    paramString3 = new aprs();
  ...
  public static void b(String paramString1, String arg1, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArkApp.ArkSecurityReporter", 2, new Object[] { "ArkSafe.report invalid navigation url app=", paramString1, ",count=1, result=", Integer.valueOf(paramInt2), ",validType=", Integer.valueOf(paramInt1), ",sender uin=", paramString3, ",r3=1 ,url=", nmj.b(???, new String[0]), " ,QQVersion=", b() });
    }
    bcst.a(null, "dc00898", "", paramString3, "0X8009BD0", "0X8009BD0", paramInt1, paramInt2, b(), "1", paramString1, ???);
    paramString3 = new aprs();
    paramString3.jdField_b_of_type_JavaLangString = paramString1;
    paramString3.jdField_c_of_type_JavaLangString = ???;
  ...
  public static void c(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("ArkApp.ArkSecurityReporter", 2, new Object[] { "ArkSafe.report web url app=", paramString1, ", count=1, result=0, r3=2, url=", nmj.b(paramString2, new String[0]), ",QQVersion=", b() });
      }
      bcst.a(null, "dc00898", "", "", "0X8009BD0", "0X8009BD0", 0, 0, b(), "2", paramString1, "");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("ArkApp.ArkSecurityReporter", 2, new Object[] { "ArkSafe.report web url app=", paramString1, ", count=1, result=", Integer.valueOf(paramInt2), ",validType=", Integer.valueOf(paramInt1), " ,sender uin=", paramString3, " ,r3=2 ,url=", nmj.b(paramString2, new String[0]), " ,QQVersion=", b() });
    }
    bcst.a(null, "dc00898", "", paramString3, "0X8009BD0", "0X8009BD0", paramInt1, paramInt2, b(), "2", paramString1, paramString2);
    paramString3 = new aprs();
    paramString3.jdField_b_of_type_JavaLangString = paramString1;
