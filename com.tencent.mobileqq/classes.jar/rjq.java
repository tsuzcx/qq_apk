...
public class rjq
  extends shb
{
  public rjq(FastWebActivity paramFastWebActivity) {}
  ...
  protected boolean a(Integer paramInteger)
  {
    ...
    if (paramInteger.intValue() == 14)
    {
      ...
      {
        str = "0X8008994";
        rnb.a(localFastWebActivity, str, 9, FastWebActivity.a(this.a));
        rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), -1, 3, false);
      }
    }
    for (;;)
    {
      ...
      if (paramInteger.intValue() == 7)
      {
        ...
        rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), 6, -1, false);
      }
      else if (paramInteger.intValue() == 8)
      {
        FastWebActivity.a(this.a).b(FastWebActivity.a(this.a).mArticleContentUrl);
        rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), 7, -1, false);
      }
      else if (paramInteger.intValue() == 1)
      {
        this.a.a(17, -1, false);
        rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), 0, -1, false);
      }
      else
      {
        if (paramInteger.intValue() == 12)
        {
          ...
          {
            rnb.a(localFastWebActivity, str, 8, FastWebActivity.a(this.a));
            rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), -1, 4, false);
            break;
          }
        }
        if (paramInteger.intValue() == 20)
        {
          ...
          for (str = "0X8008994";; str = "0X800898D")
          {
            rnb.a(localFastWebActivity, str, 10, FastWebActivity.a(this.a));
            rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), -1, 5, false);
            break;
          }
        }
        if (paramInteger.intValue() == 9)
        {
          ...
          for (str = "0X8008994";; str = "0X800898D")
          {
            rnb.a(localFastWebActivity, str, 7, FastWebActivity.a(this.a));
            rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), -1, 0, false);
            break;
          }
        }
        if (paramInteger.intValue() == 10)
        {
          ...
          rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), -1, 1, false);
        }
        else if (paramInteger.intValue() == 13)
        {
          FastWebActivity.a(this.a).d(FastWebActivity.a(this.a).mArticleContentUrl);
          rnr.a(this.a, this.a.getAppInterface(), FastWebActivity.a(this.a), -1, 2, false);
        }
        else if (paramInteger.intValue() == 28)
        {
          ayec.a(1, 2);
          ayec.a(FastWebActivity.a(this.a).mArticleContentUrl, FastWebActivity.a(this.a).mTitle);
        }
        ...
        {
          osj.a().a().a(FastWebActivity.a(this.a).mArticleContentUrl, FastWebActivity.a(this.a).innerUniqueID + "", FastWebActivity.a(this.a).mSubscribeID, paramInteger.intValue(), FastWebActivity.a(this.a));
        }
      }
    }
  }
