...
public class awaa
{
  ...
  public awaa(Settings paramSettings)
  {
  ...
  {
    return awaf.a(paramFloat1, this.jdField_a_of_type_Float / paramFloat2, this.b * paramFloat2);
  }
  
  public awaa a(awac paramawac)
  {
    ...
    if (!awac.a(f9, 0.0F))
    {
      ...
      label202:
      switch (awab.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
