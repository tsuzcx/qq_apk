...
public class bmqa
{
  ...
  private static List<pyk> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131711794);
  ...
  {
    boolean bool = ((Boolean)a(i(), Boolean.valueOf(false))).booleanValue();
    if (QLog.isColorLevel()) {
  ...
  public static int L(AppRuntime paramAppRuntime)
  {
    ...
    if (paramAppRuntime == null)
    {
      ...
      return pgc.jdField_e_of_type_Int;
    }
    A = paramAppRuntime.getInt("key_kandian_ad_exposure_threshold", pgc.jdField_e_of_type_Int);
  ...
  public static int a()
  {
    SharedPreferences localSharedPreferences = a(pha.a(), true, true);
  ...
  public static arcs a(QQAppInterface paramQQAppInterface)
  {
    ...
    else
    {
      ...
      ajvi.a().a(paramQQAppInterface.getApplication().getApplicationContext(), paramQQAppInterface);
      localObject = ajvi.a().a();
    }
    if (localObject != null)
    {
      ...
      {
        localObject = (arcs)paramQQAppInterface.next();
        if ((localObject != null) && (((arcs)localObject).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo != null) && (((arcs)localObject).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.uiResId == 1130L)) {
          return localObject;
        }
      }
    }
  ...
  public static bmqc a(Node paramNode)
  {
    bmqc localbmqc = new bmqc();
    if (TextUtils.equals("setting", paramNode.getNodeName()))
    {
      ...
      if (paramNode != null)
      {
        ...
        for (;;)
        {
          try
          {
            localbmqc.jdField_a_of_type_Int = Integer.parseInt(str2);
          ...
          if (TextUtils.equals(localNumberFormatException1, "title")) {
            localbmqc.jdField_a_of_type_JavaLangString = str2;
          } else if (TextUtils.equals(localNumberFormatException1, "hidden")) {
            try
            {
              localbmqc.jdField_b_of_type_Int = Integer.parseInt(str2);
            }
  ...
  public static bmqd a(Node paramNode)
  {
    bmqd localbmqd = new bmqd();
    if (TextUtils.equals("setting", paramNode.getNodeName()))
    {
      paramNode = paramNode.getFirstChild();
      if (paramNode != null)
      {
        ...
        if (paramNode.getNodeType() == 1)
        {
          ...
          localbmqd.jdField_a_of_type_JavaLangString = str2;
        }
        for (;;)
        {
          paramNode = paramNode.getNextSibling();
          ...
          {
            localbmqd.jdField_b_of_type_JavaLangString = str2;
          }
          else if (TextUtils.equals(str1, "id"))
          {
            try
            {
              localbmqd.jdField_a_of_type_Int = Integer.parseInt(str2);
            }
  ...
  public static bmqe a(AppRuntime paramAppRuntime)
  {
    paramAppRuntime = a(paramAppRuntime, true, true);
    if (paramAppRuntime == null) {
      ...
      try
      {
        ...
        if (((Node)localObject).getNodeType() == 1)
        {
          ...
          if (TextUtils.equals("video_width", str1)) {
            localbmqe.jdField_b_of_type_Int = Integer.parseInt(str2);
          }
        }
        else
        {
        ...
        localbmqe.jdField_b_of_type_Float = Float.parseFloat(str2);
        continue;
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (TextUtils.equals((CharSequence)localObject, "double_video")) {
        for (localObject = localNode.getFirstChild(); localObject != null; localObject = ((Node)localObject).getNextSibling()) {
          if (((Node)localObject).getNodeType() == 1)
          {
            ...
            str2 = ((Node)localObject).getFirstChild().getNodeValue();
            if (TextUtils.equals("aspect_ratio", str1)) {
              localbmqe.jdField_a_of_type_Float = Float.parseFloat(str2);
            }
          }
        }
      }
      if (TextUtils.equals((CharSequence)localObject, "is_play_button_show")) {
        localbmqe.jdField_a_of_type_Boolean = str1.equals("1");
      }
      for (;;)
      {
        label445:
        ...
        if (TextUtils.equals((CharSequence)localObject, "title_label_number_of_lines")) {
          localbmqe.jdField_a_of_type_Int = Integer.parseInt(str1);
        } else if (TextUtils.equals((CharSequence)localObject, "title_hidden")) {
          localbmqe.jdField_b_of_type_Boolean = str1.equals("0");
        } else if (TextUtils.equals((CharSequence)localObject, "play_and_comment_hidden")) {
          localbmqe.jdField_c_of_type_Boolean = str1.equals("0");
        }
      }
      label527:
  ...
  {
    Object localObject = a(pha.a(), false, true);
    if (localObject == null) {
      localObject = null;
    }
  ...
  public static <T> T a(String paramString, T paramT, boolean paramBoolean)
  {
    ...
    SharedPreferences localSharedPreferences = a(pha.a(), paramBoolean, true);
    if (localSharedPreferences == null) {
  ...
  public static String a(long paramLong1, long paramLong2, String paramString1, String paramString2)
  {
    ...
    if ((paramLong1 >= 10000L) && (paramLong1 < paramLong2))
    {
      ...
      if (Math.round(d1) - d1 == 0.0D) {
        return String.valueOf(d1) + anni.a(2131711712);
      }
      return String.valueOf(d1) + anni.a(2131711512);
    }
  ...
  public static List<pyk> a(AppRuntime paramAppRuntime)
  {
        ...
        try
        {
          ...
          if (i2 > 0)
          {
            ...
            while (i1 < i2)
            {
              ...
              localpyk.a(localJSONObject);
              paramAppRuntime.add(localpyk);
              i1 += 1;
            }
  ...
  public static ogz a(AppRuntime paramAppRuntime)
  {
    ...
    return ogz.a(jdField_i_of_type_JavaLangString);
  }
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      ...
      localJSONObject2.put("bettery_level", ray.a());
      localJSONObject2.put("network_type", ray.a());
      localJSONObject2.put("king_card", b());
      localJSONObject2.put("system_brightness", ray.a((Context)localObject));
      localJSONObject2.put("headset_on", ray.a((Context)localObject));
      localJSONObject2.put("volume", ray.b((Context)localObject));
      localObject = phl.a();
      localJSONObject2.put("acceleration", a(((phl)localObject).b()));
      localJSONObject2.put("gyroscope", a(((phl)localObject).a()));
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    while (((!pil.c((int)paramBaseArticleInfo.mChannelID)) && (!a(paramBaseArticleInfo.mChannelID))) || (!y())) {
      return;
    }
  ...
  public static void a(LikeAnimationInfo paramLikeAnimationInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = a(pha.a(), false, true);
      } while (localObject == null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    //   2: monitorenter
    //   3: iload_1
    //   4: putstatic 1372	bmqa:jdField_b_of_type_Boolean	Z
    //   7: aload_0
    //   8: iconst_1
    //   9: invokestatic 614	bmqa:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)Landroid/content/SharedPreferences;
    //   12: astore_2
    //   13: aload_2
    //   14: ifnonnull +7 -> 21
    //   17: ldc 2
    ...
    //   29: ldc_w 1374
    //   32: iload_1
    //   33: invokeinterface 1224 3 0
    //   38: pop
    //   39: aload_2
    //   40: iconst_1
    //   41: invokestatic 245	bmqa:a	(Landroid/content/SharedPreferences$Editor;Z)V
    //   44: aload_0
    //   45: iload_1
    //   46: invokestatic 1376	pha:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Z)V
    //   49: goto -32 -> 17
    //   52: astore_0
    //   53: ldc 2
    //   55: monitorexit
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, niv paramniv)
  {
    ...
    for (int i1 = 0;; i1 = 1)
    {
      ...
      nir.a(paramQQAppInterface, paramniv, localReqBody.toByteArray(), "OidbSvc.0xb86", 2950, 50);
      return;
    }
  }
  ...
  public static <T> void a(String paramString, T paramT, boolean paramBoolean)
  {
    ...
    Object localObject = a(pha.a(), paramBoolean, true);
    if (localObject == null)
    {
  ...
  public static void a(AppRuntime paramAppRuntime)
  {
    if (paramAppRuntime == null)
    {
      snh.jdField_f_of_type_Int = 1000;
      QLog.d("ReadInJoyHelper", 1, "app null update feeds group setting:" + snh.jdField_f_of_type_Int);
      return;
    }
    if (Build.VERSION.SDK_INT >= 11) {}
    for (int i1 = 4;; i1 = 0)
    {
      ...
      {
        snh.jdField_f_of_type_Int = 1000;
        QLog.d("ReadInJoyHelper", 1, "sp null update feeds group setting:" + snh.jdField_f_of_type_Int);
        return;
      }
      snh.jdField_f_of_type_Int = paramAppRuntime.getInt("config_feeds_group_setting", 1000);
      QLog.d("ReadInJoyHelper", 1, "update feeds group setting:" + snh.jdField_f_of_type_Int);
      return;
    }
  }
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, List<pyk> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      if (paramList.size() > 0)
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          paramAppRuntime.put(((pyk)((Iterator)localObject).next()).a());
        }
  ...
  public static void a(AppRuntime paramAppRuntime, ogz paramogz)
  {
    if (paramAppRuntime == null) {
    ...
    {
      return;
      paramogz.jdField_e_of_type_JavaLangString = "1";
      paramogz.jdField_f_of_type_JavaLangString = "1";
      paramogz.jdField_h_of_type_JavaLangString = pha.a();
      paramogz = paramogz.a();
    } while (TextUtils.isEmpty(paramogz));
    jdField_i_of_type_JavaLangString = paramogz;
    L(paramAppRuntime, paramogz);
  ...
  public static boolean a(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        bctj.a(paramAppRuntime.getApplication()).a(null, "actionReadInJoyArkConfig", true, 0L, 0L, localHashMap, null);
        return true;
  ...
  public static String b(int paramInt)
  {
    ...
    if (paramInt < 99989500)
    {
      if (paramInt % 10000 < 500) {
        return paramInt / 10000 + anni.a(2131711640);
      }
      int i1 = paramInt;
      if (paramInt % 500 == 0) {
        i1 = paramInt + 1;
      ...
      if (i1 % 10000 > 9500) {
        return (i1 + 500) / 10000 + anni.a(2131711796);
      }
  ...
  public static List<bmqc> b(AppRuntime paramAppRuntime)
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = a(paramAppRuntime, true, true);
    if (localObject == null) {
  ...
  public static JSONObject b()
  {
    ...
    localJSONObject.put("daily_location", pws.a());
  ...
  public static void b(AppRuntime paramAppRuntime)
  {
    ...
    paramAppRuntime = paramAppRuntime.edit();
    paramAppRuntime.putString("readinjoy_individual_push_date", pha.a.format(Long.valueOf(System.currentTimeMillis())));
    a(paramAppRuntime, true);
  }
  ...
  public static void b(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    a(paramAppRuntime, true);
    if (otw.a == null) {
      otw.a = new AtomicBoolean();
    }
    otw.a.set(paramString.equals("1"));
  }
  ...
  public static boolean b(int paramInt)
  {
    boolean bool1 = true;
    boolean bool2 = true;
    SharedPreferences localSharedPreferences = a(pha.a(), false, true);
    if (localSharedPreferences == null) {
      return bool2;
    }
  ...
  public static List<bmqd> c(AppRuntime paramAppRuntime)
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = a(paramAppRuntime, true, true);
    if (localObject == null) {
  ...
  public static void c(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(str)) {
        pgc.jdField_g_of_type_JavaLangString = str;
      }
      str = paramAppRuntime.getString("readinjoy_social_weburl_messagebox_V3", "");
      if (!TextUtils.isEmpty(str)) {
        pgc.jdField_d_of_type_JavaLangString = str;
      }
  ...
  public static void f()
  {
    ...
    {
      Aladdin.initialize(Aladdin.InitParams.newBuilder().withUserId(pha.a()).withAppVersion("8.4.1").withContext(BaseApplicationImpl.getContext()).withExecutor(pic.a).withRequestHandler(new phy()).withLogger(new phw()).withAppFlavorId(AppSetting.a() + "").build());
  ...
  public static void g()
  {
    ...
    Object localObject2 = a(pha.a(), true, true);
  ...
  {
    return pha.a() + "_" + "readinjoy_ugc_account_create_complete";
  }
  ...
  public static int j(AppRuntime paramAppRuntime)
  {
    ...
    if (paramAppRuntime == null)
    {
      ...
      return pgc.jdField_a_of_type_Int;
    }
    jdField_f_of_type_Int = paramAppRuntime.getInt("kandian_biu_word_count", pgc.jdField_a_of_type_Int);
    return jdField_f_of_type_Int;
  }
  ...
  public static int k(AppRuntime paramAppRuntime)
  {
    ...
    if (paramAppRuntime == null)
    {
      ...
      return pgc.jdField_b_of_type_Int;
    }
    jdField_g_of_type_Int = paramAppRuntime.getInt("kandian_comment_word_count", pgc.jdField_b_of_type_Int);
    return jdField_g_of_type_Int;
  }
  ...
  public static int w(AppRuntime paramAppRuntime)
  {
    ...
    if (paramAppRuntime == null)
    {
      ...
      return pgc.jdField_c_of_type_Int;
    }
    t = paramAppRuntime.getInt("kandian_default_bit_rate", pgc.jdField_c_of_type_Int);
    return t;
  }
