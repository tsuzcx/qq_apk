  ...
  implements Handler.Callback
{
  ...
  private boolean U;
  private boolean V;
  private ajxl jdField_a_of_type_Ajxl = new aeqy(this);
  private akav jdField_a_of_type_Akav = new aeqx(this);
  aoeu jdField_a_of_type_Aoeu = new aeqz(this);
  private MessageRecord jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
  private Comparator<MessageRecord> jdField_a_of_type_JavaUtilComparator = new aeqv(this);
  private Observer jdField_a_of_type_JavaUtilObserver = new aeqw(this);
  ...
  public aequ(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private void br()
  {
    ...
    {
      this.jdField_h_of_type_JavaLangString = aojo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
      ThreadManager.getSubThreadHandler().post(new LimitChatPie.6(this, str));
      this.t = aojo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  private void bs()
  {
    if (this.jdField_a_of_type_Acut != null) {
      this.jdField_a_of_type_Acut.a = Boolean.valueOf(false);
    }
  ...
  private void bu()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = (aoeo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127);
          if (localObject != null) {
            ((aoeo)localObject).a(localArrayList);
          }
        }
        return;
  ...
  public void G()
  {
    ...
    ((akbo)this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.app.getManager(34)).deleteObserver(this.jdField_a_of_type_JavaUtilObserver);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null) {
      if (this.V)
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A695", "0X800A695", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A692", "0X800A692", 0, 0, String.valueOf(l1 - l2), "", this.jdField_h_of_type_JavaLangString, "");
      return;
      String str = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
      break;
      label184:
      if ((this.u > 0) || (this.v > 0)) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A694", "0X800A694", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    super.J();
    ((aoeo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
  }
  ...
  {
    super.O();
    if (((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      bq();
    }
  }
  ...
  public void a(Object paramObject)
  {
    ...
    default: 
      return;
    case 4: 
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AA", "0X80096AA", this.w, 0, "", "", "", "");
      return;
    case 2: 
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096A9", "0X80096A9", this.w, 0, "", "", "", "");
      return;
    case 5: 
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AB", "0X80096AB", this.w, 0, "", "", "", "");
      return;
    case 24: 
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AC", "0X80096AC", this.w, 0, "", "", "", "");
      return;
    }
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80096AD", "0X80096AD", this.w, 0, "", "", "", "");
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bs();
    ((akbo)this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.app.getManager(34)).addObserver(this.jdField_a_of_type_JavaUtilObserver);
    br();
    return paramBoolean;
  }
  ...
  {
    super.b(paramIntent);
    this.e.setOnClickListener(new aera(this));
  }
  
  public void bo()
  {
    int j = 1;
    Object localObject = (aoep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264);
    int m = ((aoep)localObject).b();
    int k;
    if (m > 0)
    {
      k = this.s / m + 1;
    ...
    for (;;)
    {
      if (j != 0)
      {
        String str = ((aoep)localObject).c();
        localObject = ((aoep)localObject).d();
        if (!TextUtils.isEmpty(str))
        {
          aojo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, k);
          this.t = k;
  ...
  public void bp()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A693", "0X800A693", 0, 0, "", "", "", "");
  }
