...
public class bncl
  implements bapy
{
  private static bncl jdField_a_of_type_Bncl;
  public bncn a;
  private HashMap<String, bncm> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private Lock jdField_a_of_type_JavaUtilConcurrentLocksLock = new ReentrantLock();
  
  public bncl()
  {
    this.jdField_a_of_type_Bncn = new bncn(this);
  }
  
  public static bncl a()
  {
    if (jdField_a_of_type_Bncl == null) {
      jdField_a_of_type_Bncl = new bncl();
    }
    return jdField_a_of_type_Bncl;
  }
  ...
  private void a(FilterDesc paramFilterDesc, long paramLong, int paramInt)
  {
    ...
    try
    {
      Object localObject2 = ((blnl)blmf.a(5)).a;
      Object localObject1 = new ArrayList();
      if (localObject2 != null) {
        localObject1 = ((bncq)localObject2).a(0).c;
      }
      ...
      yvu.a("record_filter_download", yvu.a(paramInt, System.currentTimeMillis() - l, paramFilterDesc.resurl, paramLong, paramFilterDesc.name));
  ...
  private void a(FilterDesc paramFilterDesc, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bncm localbncm = (bncm)this.jdField_a_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
        if ((localbncm != null) && (localbncm.jdField_a_of_type_JavaUtilArrayList != null))
        {
          i = 0;
          if (i < localbncm.jdField_a_of_type_JavaUtilArrayList.size())
          {
            bnco localbnco = (bnco)((WeakReference)localbncm.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
            if (localbnco != null) {
              localArrayList.add(localbnco);
            }
          }
          else
          {
            localbncm.jdField_a_of_type_JavaUtilArrayList.clear();
        ...
        else
        {
          ...
          if ((localArrayList != null) && (localArrayList.size() > 0))
          {
            ...
            {
              paramFilterDesc = (bnco)localArrayList.get(i);
              if (paramFilterDesc != null) {
  ...
  {
    String str = paramFilterDesc.getResFold(bngf.b);
    bncp.a();
  ...
  /* Error */
  private boolean a(FilterDesc paramFilterDesc, bnco parambnco)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 26	bncl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 174 1 0
    //   9: aload_0
    //   10: getfield 21	bncl:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   13: aload_1
    ...
    //   33: dup
    //   34: aload_0
    //   35: invokespecial 254	bncm:<init>	(Lbncl;)V
    //   38: astore 4
    //   40: aload 4
    //   42: aload_1
    //   43: putfield 257	bncm:jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc	Lcom/tencent/mobileqq/richmedia/capture/data/FilterDesc;
    //   46: aload 4
    //   48: getfield 181	bncm:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: pop
    //   63: aload_0
    //   64: getfield 21	bncl:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   67: aload_1
    ...
    //   78: istore_3
    //   79: aload_0
    //   80: getfield 26	bncl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   83: invokeinterface 206 1 0
    //   88: iload_3
    //   89: ireturn
    //   90: aload 4
    //   92: getfield 181	bncm:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   112: astore_1
    //   113: aload_0
    //   114: getfield 26	bncl:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   0	124	2	parambnco	bnco
    //   78	31	3	bool	boolean
    //   23	68	4	localbncm	bncm
    // Exception table:
    //   from	to	target	type
    //   9	25	112	finally
    //   30	77	112	finally
  ...
  {
    parambaqw = (FilterDesc)parambaqw.a.a();
    if (parambaqw != null) {
      QLog.e("VideoFilterListDownloader", 2, "MyListDownloaderListener onFailed file: " + parambaqw.resurl);
    }
  }
  
  public void a(FilterDesc paramFilterDesc, bnco parambnco)
  {
    if (!a(paramFilterDesc, parambnco)) {
      a(paramFilterDesc);
    }
  }
}
