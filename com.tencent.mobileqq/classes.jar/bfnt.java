  ...
  implements bfnr
{
  ...
  protected bfnt(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, bfnv parambfnv)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Aahm = new bfnu(this);
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item = paramItem;
    this.jdField_a_of_type_Bfnv = parambfnv;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = bfns.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.Id, paramInt);
    if (auea.a(FileUtil.getExtension(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName)) == 2) {
      this.jdField_b_of_type_Boolean = true;
    }
  }
  
  public static bfnt a(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, bfnv parambfnv)
  {
    if (paramLong == 0L)
    {
    ...
    if (paramInt == 0)
    {
      bfmf.a("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "getWoker. nThumbSize=0");
      return null;
    }
    return new bfnt(paramLong, paramItem, paramInt, parambfnv);
  }
  ...
  public void a()
  {
    ...
    {
      bfmf.c("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop. but had stoped. mStatus:" + this.jdField_b_of_type_Int);
      return;
    }
    this.jdField_a_of_type_Boolean = true;
    bfmf.c("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop fetch. mStatus:" + this.jdField_b_of_type_Int);
    if (this.jdField_b_of_type_Int == 2)
    {
      if (this.jdField_a_of_type_Bfnq == null) {
        break label197;
      }
      this.jdField_a_of_type_Bfnq.c();
      this.jdField_a_of_type_Bfnq = null;
    }
    for (;;)
    {
      g();
      ...
      return;
      label197:
      bfmf.b("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop downloader=null");
    }
  }
  ...
  public void a(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.duration == 0) && (paramInt != 0))
    {
      ...
      this.jdField_a_of_type_Bfnq.b(true);
    }
  }
  ...
  protected void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      bfmf.a("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] startFetch app=null");
      c(bgme.w);
      return;
    }
    FileUtils.deleteFile(this.d);
    ...
    for (paramInt1 = 443;; paramInt1 = i)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS))
      {
        ...
        paramString = new atlc(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS, paramInt1);
        paramString = atlb.a().a(localQQAppInterface, paramString, 3);
        if ((paramString != null) && (!paramString.a()))
        {
          ...
          atlb.a(paramString.a, localArrayList, false, false);
      ...
      {
        long l = bfmd.a();
        bfmf.c("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] startFetch. nSessionId:" + l + " firstIP=" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadIp + " urlParams:" + (String)localObject1 + " mTmpFilePath:" + this.d + " bUseHttps:" + bool1 + " httpsDomain:" + paramString);
        if (this.jdField_a_of_type_Bfnq != null)
        {
          this.jdField_a_of_type_Bfnq.c();
          this.jdField_a_of_type_Bfnq = null;
        }
        this.jdField_a_of_type_Bfnq = bfnq.a(localQQAppInterface, l, this.d, 0L, localArrayList, (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.cookieValue, this.jdField_b_of_type_Boolean, bool1, paramString);
        if (this.jdField_a_of_type_Bfnq != null) {
          break label1171;
        }
        c(bgme.w);
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS))
        {
          if (atlb.a().a(localQQAppInterface, 3))
          {
            ...
            localObject2 = new atlc(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS, 0);
            localObject2 = atlb.a().a(localQQAppInterface, (atlc)localObject2, 3);
            if ((localObject2 != null) && (!((atle)localObject2).a()))
            {
              if (atlb.a())
              {
              ...
              atlb.a(((atle)localObject2).a, localArrayList, true, false);
      ...
      this.jdField_a_of_type_Bfnq.a(this);
      this.jdField_a_of_type_Bfnq.i();
      this.jdField_a_of_type_Bfnq.a(false);
      if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.duration != 0) {
        this.jdField_a_of_type_Bfnq.b(true);
      }
      this.jdField_a_of_type_Bfnq.b();
      b(2);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bfls = null;
    g();
    if ((!paramBoolean) && (!auea.a(new VFSFile(this.d), new VFSFile(this.e))))
    {
      bfmf.a("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] renameFile fail  mFilePath:" + this.e);
    ...
    do
    {
      ...
      b(3);
      f();
      bfmf.c("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFetchSuc  mFilePath:" + this.e);
      if (!paramBoolean) {
        this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.StatusUpdateTimeMs = 0L;
      }
      ...
      bflo.b(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item);
    } while (this.jdField_a_of_type_Bfnv == null);
    this.jdField_a_of_type_Bfnv.a(a(), true, 0, this);
  }
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    bfmf.a("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onHasErr. fetch fail. errCode:" + paramInt + " transferedSize:" + paramLong);
    int i;
    if (paramInt == -5000) {
      i = bgme.h;
    }
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Bfnq.b())
      {
        i = bgme.p;
      }
      else
  ...
  public boolean a()
  {
    bfmf.c("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] start fetch thumb. filename:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName + " filePath:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FilePath);
  ...
  public void b()
  {
    ...
    if (localQQAppInterface == null)
    {
      bfmf.a("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqFetch app=null");
      c(bgme.w);
      return;
    }
    bfmf.c("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqFetch");
    this.jdField_a_of_type_Bfls = aagu.a(localQQAppInterface, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Int, false, false, this.jdField_a_of_type_Aahm);
    b(1);
  }
  ...
  public void c(int paramInt)
  {
    ...
    b(4);
    e();
    bfmf.a("TroopFileDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFetchErr  errCode:" + paramInt);
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.StatusUpdateTimeMs = 0L;
    if (paramInt == bgme.y) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bfnv != null) {
        this.jdField_a_of_type_Bfnv.a(a(), false, paramInt, this);
      }
      return;
      if (paramInt == bgme.p) {
  ...
  {
    bfny.b(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Int);
    boolean bool = bfny.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Int, this.e);
