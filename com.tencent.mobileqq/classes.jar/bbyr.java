...
class bbyr
{
  ...
  bbyr(LoadParam paramLoadParam, LoadParam.LoadItem paramLoadItem)
  {
  ...
  static int a()
  {
    ...
    try
    {
      int i = apub.a().a(526, ((QQAppInterface)localAppRuntime).getLongAccountUin());
      return i;
    }
  ...
  protected static boolean a(@NonNull bbzx parambbzx)
  {
    return (!TextUtils.isEmpty(parambbzx.c)) && (new File(parambbzx.c).exists());
  }
  
  protected static boolean a(@NonNull bbzx parambbzx, @NonNull SoConfig.SoDetailInfo paramSoDetailInfo)
  {
    return (paramSoDetailInfo.relatedFileInfo == null) || ((!TextUtils.isEmpty(parambbzx.f)) && (new File(parambbzx.f).exists()));
  }
  ...
  boolean a(SoConfig.SoInfo paramSoInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("SoLoadWidget.AbsGetSoTask", 2, "[initConfig] isConfValid=" + bool + ",info:" + paramSoInfo + ",is64:" + bbzl.a());
      }
      return bool;
