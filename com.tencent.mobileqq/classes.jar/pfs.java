  ...
  implements phs
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      localObject2 = qol.e(i);
      label78:
      if (bool3)
      {
        localJSONObject.put("left_comment_count", (String)localObject2 + ajyc.a(2131712921));
        localJSONObject.put("left_play_count", qol.c(paramBaseArticleInfo.mVideoPlayCount));
      ...
      if ((!paramBaseArticleInfo.isUseGif) || (!bbev.h(BaseApplicationImpl.getContext()))) {
        break label856;
      }
      bool1 = true;
    }
    ...
    for (;;)
    {
      ...
      if ((paramBaseArticleInfo.isAccountShown) && (paramBaseArticleInfo.mPartnerAccountInfo != null))
      {
        ...
        localObject2 = onk.a(paramBaseArticleInfo.mPartnerAccountInfo.bytes_v_icon_url);
      ...
      if (localObject1 != null)
      {
        ...
        if (bool3)
        {
          localJSONObject.put("right_comment_count", (String)localObject2 + ajyc.a(2131712921));
          localJSONObject.put("right_play_count", qol.c(((BaseArticleInfo)localObject1).mVideoPlayCount));
          localJSONObject.put("play_icon", "ReadInJoy/video_play_icon.png");
        }
        localJSONObject.put("right_article_title", ((BaseArticleInfo)localObject1).mTitle);
        if ((!((BaseArticleInfo)localObject1).isUseGif) || (!bbev.h(BaseApplicationImpl.getContext()))) {
          break label862;
        }
        bool1 = bool2;
        ...
        if ((((BaseArticleInfo)localObject1).isAccountShown) && (((BaseArticleInfo)localObject1).mPartnerAccountInfo != null))
        {
          ...
          localObject2 = onk.a(((BaseArticleInfo)localObject1).mPartnerAccountInfo.bytes_v_icon_url);
          if (!TextUtils.isEmpty((CharSequence)localObject2)) {
  ...
  {
    ArticleInfo localArticleInfo2 = parampax.a();
    ...
    for (ArticleInfo localArticleInfo1 = (ArticleInfo)localArticleInfo2.mSubArtilceList.get(0);; localArticleInfo1 = null)
    {
      if ((localArticleInfo2 != null) && (localArticleInfo2.isAccountShown)) {
        pjp.a(paramContainer, parampax, "id_left_account_name");
      }
      if ((localArticleInfo1 != null) && (localArticleInfo1.isAccountShown)) {
        pjp.a(paramContainer, parampax, "id_right_account_name");
      }
      return;
    }
  }
  ...
  public boolean a(int paramInt, Container paramContainer, pax parampax, ViewBase paramViewBase)
  {
    ...
    case 1120: 
    case 1121: 
      paramViewBase.setOnClickListener(new pft(this, paramInt, localArticleInfo, paramContainer, parampax));
      return true;
    case 1150: 
    case 1151: 
      paramViewBase.setOnClickListener(new pfu(this, paramInt, parampax, localArticleInfo, paramContainer));
      return true;
    }
    paramViewBase.setOnClickListener(new pfv(this, paramInt, parampax, localArticleInfo, paramContainer));
    return true;
  }
}
