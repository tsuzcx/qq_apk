...
public class pfs
{
  ...
  private static volatile pfs jdField_a_of_type_Pfs;
  private static pgd jdField_a_of_type_Pgd = new pgd(null);
  ...
  private pfs()
  {
    this.jdField_a_of_type_Pgh = new pgh(this);
    this.jdField_b_of_type_Pgh = this.jdField_a_of_type_Pgh;
    p();
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < localObject2.length)
        {
          ...
          String str = bhny.a(BaseApplicationImpl.getContext(), localObject2[m]);
  ...
  private String a(bdom parambdom)
  {
    parambdom = parambdom.a.iterator();
    while (parambdom.hasNext())
    {
      bdol localbdol = (bdol)parambdom.next();
      if ((localbdol instanceof StructMsgItemTitle)) {
        return ((StructMsgItemTitle)localbdol).b();
      }
    }
    return "";
  }
  ...
  private String a(List<ChatMessage> paramList)
  {
    ...
    if ((paramList instanceof MessageForStructing))
    {
      ...
      if ((paramList instanceof StructMsgForGeneralShare))
      {
        ...
        {
          Object localObject = (bdol)paramList.next();
          if ((localObject instanceof bdom))
          {
            localObject = a((bdom)localObject);
  ...
  public static pfs a()
  {
    if (jdField_a_of_type_Pfs == null) {}
    try
    {
      if (jdField_a_of_type_Pfs == null) {
        jdField_a_of_type_Pfs = new pfs();
      }
      return jdField_a_of_type_Pfs;
    }
    finally {}
  }
  
  private pfv a(List<ChatMessage> paramList)
  {
    pfv localpfv = new pfv(this);
    int m = 0;
    int n = 0;
    Object localObject = bnrf.a();
    ...
    else
    {
      ...
      localpfv.a = paramList;
      localpfv.b = ((oidb_cmd0x80a.AttributeList)localObject);
      localpfv.c = localAttributeList1;
      localpfv.d = localAttributeList2;
      return localpfv;
    }
    int i2;
  ...
  public static void a(List<pgg> paramList)
  {
    ThreadManager.executeOnSubThread(new ReadinjoySPEventReport.16(paramList));
  }
  
  private void a(pfu parampfu)
  {
    Object localObject = bhlo.e();
    String str;
    ...
    return;
    label95:
    parampfu.a(127, "FeatureFrameworkAttr", str);
  }
  
  private void a(pfu parampfu, int paramInt)
  {
    boolean bool2 = false;
    String str1 = null;
    String str2;
    ...
    for (;;)
    {
      ...
      label97:
      paramInt = oyc.a();
      parampfu = parampfu.a(117, "daily_folderstatus", str2).a(118, "daily_msgbox_pos", String.valueOf(paramInt));
      boolean bool1 = bool2;
      if (paramInt >= 0)
      {
        bool1 = bool2;
        if (paramInt + 1 <= ozs.jdField_a_of_type_Int) {
          bool1 = true;
        }
      }
      parampfu.a(119, "daily_in_screen", bool1);
      return;
    }
  }
  ...
  {
    pgh localpgh = a().jdField_a_of_type_Pgh;
    if (paramInt1 == 0) {}
  ...
  public static void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        boolean bool2;
        m = 0;
        agej.a("onMainFragmentTabClick", "onMainFragmentTabClick", localException1);
        continue;
      }
      try
      {
  ...
  private static boolean c(int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        Pair localPair = bnrf.b();
        paramInt = (int)(Long.valueOf(ozs.a()).longValue() % 100L);
  ...
  public static void d(boolean paramBoolean)
  {
    ...
    } while (pfw.jdField_a_of_type_Int == 2);
    pfw.c();
  ...
  {
    Object localObject = zof.a();
    if (TextUtils.equals((CharSequence)localObject, (String)bnrf.a("dau_report_type_" + paramInt, "")))
    {
      QLog.d("ReadinjoySPEventReport", 2, "has report dau for type today, type :" + paramInt);
      return;
    }
    bnrf.a("dau_report_type_" + paramInt, localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
  ...
  public static void g()
  {
    ...
    try
    {
      ...
      BaseApplicationImpl.getContext().registerReceiver(jdField_a_of_type_Pgd, localIntentFilter);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void m()
  {
    ...
    localAttributeList.att_value.set(oyc.a());
    localArrayList.add(localAttributeList);
    tzq.a(91, localArrayList);
  }
  ...
  private void r()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(this.jdField_a_of_type_Pfv.a);
      localArrayList.add(this.jdField_a_of_type_Pfv.c);
      localArrayList.add(this.jdField_a_of_type_Pfv.d);
      tzq.a(14, localArrayList);
    }
  }
  ...
  public List<oidb_cmd0x80a.AttributeList> a(int paramInt)
  {
    ...
    pfu localpfu = new pfu(this, (List)localObject2);
    if (BaseApplicationImpl.sProcessId != 1) {
      return localObject2;
    }
    localpfu.a(0, "UnreadMsg", String.valueOf(b())).a(100, "FolderStatus", String.valueOf(ozs.jdField_d_of_type_Int)).a(101, "KDInScreen", ozs.c((QQAppInterface)localObject1)).a(102, "KDAttrL", tzq.b()).a(103, "LeftBtmRedPntPulse", pgi.a(this.jdField_b_of_type_JavaUtilList, "`", ":")).a(104, "FirstScnRedPntPulse", pgi.a(this.jdField_c_of_type_JavaUtilList, "`", ":")).a(105, "AIOPulse", pgi.a(this.jdField_d_of_type_JavaUtilList, "`", ":")).a(106, "LastRedExposureTime", ozs.jdField_a_of_type_Long + ":" + ozs.jdField_d_of_type_Int).a(107, "dt_red", a());
    if (a() > 0L) {}
    for (long l1 = a();; l1 = System.currentTimeMillis())
    {
      localpfu.a(108, "last_inforeground_time", String.valueOf(l1 / 1000L));
      localpfu.a(109, "last_in_aio_time", String.valueOf(b()));
      localObject2 = a().a();
      if (localObject2 != null)
      {
        ((pfv)localObject2).b.att_id.set(110);
        localpfu.a(((pfv)localObject2).b);
      }
      localpfu.a(112, "UniversalStateBit", tzq.b()).a(116, "wifiName", zot.c(BaseApplicationImpl.getContext()));
      a(localpfu, paramInt);
      localpfu.a(120, "PushPreviewQ", SettingCloneUtil.readValue(BaseApplicationImpl.getContext(), ozs.a(), "", "qqsetting_notify_showcontent_key", true));
      localpfu.a(121, "NoDisturbAtNight", FriendsStatusUtil.a(BaseApplicationImpl.getApplication()));
      paramInt = bnrf.a((QQAppInterface)ozs.a());
      if (paramInt != -1) {
        localpfu.a(122, "DongTaiKandian", String.valueOf(paramInt));
      }
      localpfu.a(123, "BSSID", bhlo.b(BaseApplicationImpl.getContext()));
      localpfu.a(124, "MsgListFristDataIsVisable", pgi.a(Integer.valueOf(pge.a()), Integer.valueOf(0)));
      a(localpfu);
      localObject2 = b() + "_" + pgi.a(pgi.a(Integer.valueOf(ozs.jdField_d_of_type_Int), Integer.valueOf(1)), "0", "1") + "_" + pgi.a(a(), String.valueOf(1), String.valueOf(0));
      localpfu.a(126, "ScreenInfo", ozs.d(-1)).a(128, "is_jcjj_mode", bdgb.a()).a(129, "network", pon.b() + "").a(130, "battery", c() + "").a(131, "sessionID", l / 1000L + "").a(132, "redDot", (String)localObject2).a(133, "app_install_list", a()).a(134, "is_study_mode", bduy.a());
      localObject1 = (KandianMergeManager)((QQAppInterface)localObject1).getManager(162);
      localpfu.a(135, "kdTabNumRed", ((KandianMergeManager)localObject1).f() + "");
      return localpfu.a();
    }
  }
  ...
  public pfv a()
  {
    pfv localpfv = this.jdField_a_of_type_Pfv;
    this.jdField_a_of_type_Pfv = null;
    return localpfv;
  }
  ...
  public void a(String paramString, bdol parambdol)
  {
    if ("2909288299".equals(paramString))
    {
      b("ClickMsg");
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ubg.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long);
      if (paramBoolean)
      {
  ...
  public void b()
  {
    try
    {
      ...
      boolean bool = ozs.c((QQAppInterface)localObject1);
      oidb_cmd0x80a.AttributeList localAttributeList1 = new oidb_cmd0x80a.AttributeList();
      localAttributeList1.att_id.set(1);
      ...
      for (localObject1 = "1";; localObject1 = "0")
      {
        ...
        ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(ozs.jdField_d_of_type_Int + "");
        localObject2 = new ArrayList(3);
        ((List)localObject2).add(localAttributeList1);
        ((List)localObject2).add(localAttributeList2);
        ((List)localObject2).add(localObject1);
        tzq.a(1, (List)localObject2);
        if (!QLog.isColorLevel()) {
          break;
        }
