  ...
  extends BusinessHandler
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new aofy(this);
  public Handler a;
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public Messenger a;
  SparseArray<aogb> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final ArrayList<aoga> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  aofw(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aofx(this, Looper.getMainLooper(), paramQQAppInterface);
  }
  ...
  private void a(int paramInt1, aogb paramaogb, int paramInt2, int paramInt3)
  {
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage();
    localMessage.what = 1;
    localMessage.obj = new Object[] { Integer.valueOf(paramInt1), paramaogb, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) };
  ...
  {
    aogb localaogb = (aogb)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    if (localaogb == null) {
      return;
    }
    a(paramInt2, localaogb, paramInt1, paramInt3);
  }
  
  public void a(int paramInt, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.append(paramInt, new aogb(this, paramString, paramLong));
    }
    a(paramInt);
  }
  ...
  void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      Object localObject = (aoga)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((aoga)localObject).a();
      localObject = ((aoga)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((aofz)localObject).a(localView, paramLong, paramInt1, paramInt2);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, aofz paramaofz)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      aoga localaoga = (aoga)localIterator.next();
      if (localaoga.a() == paramView)
      {
        localaoga.b = new WeakReference(paramaofz);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new aoga(this, paramView, paramaofz));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    for (Object localObject2 = (StructMsgForGeneralShare)localObject2;; localObject2 = null)
    {
      ...
      {
        ((StructMsgForGeneralShare)localObject2).setSummary(BaseApplication.getContext().getResources().getString(2131690806));
        ((StructMsgForGeneralShare)localObject2).setProgress(paramInt3);
        return;
      }
      paramInt1 = 32772;
      localObject1 = BaseApplication.getContext().getResources().getString(2131690807);
      ...
      for (;;)
      {
        ...
        ((StructMsgForGeneralShare)localObject2).mMsgBrief = (anvx.a(2131715083) + (String)localObject1);
        ...
        if (paramInt2 == 1003)
        {
          localObject1 = BaseApplication.getContext().getResources().getString(2131690805);
          paramInt1 = 32768;
        }
        else if (paramInt2 == 1005)
        {
          localObject1 = BaseApplication.getContext().getResources().getString(2131690804);
          paramInt1 = 32770;
