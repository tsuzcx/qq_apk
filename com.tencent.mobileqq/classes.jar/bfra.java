...
public class bfra
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(bfrd.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(bfrb.class)) {
        paramClass = ((bfrb)localField.getAnnotation(bfrb.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(bfrc.class)) {
        return null;
      }
      localClass1 = ((bfrc)localField.getAnnotation(bfrc.class)).a();
