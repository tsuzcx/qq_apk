  ...
  implements Manager
{
  ...
  public aihp(QQAppInterface paramQQAppInterface)
  {
  ...
  private void c()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("MobileUnityManager", 2, "tryShowBannerInner ve" + this.jdField_a_of_type_Aihr);
    }
    if (((aihr)localObject).c > 0L)
    {
      ((aihr)localObject).c -= 1L;
      a((aihr)localObject);
    }
    label68:
    aiho localaiho;
    ...
    do
    {
      ...
      {
        return;
        if ((localObject != null) && (((aihr)localObject).jdField_a_of_type_Int != -1))
        {
          localaiho = a();
          if (QLog.isColorLevel()) {
            QLog.d("MobileUnityManager", 2, "tryShowBannerInner bd " + localaiho);
          }
          if ((localaiho == null) || (localaiho.e <= 0) || (localaiho.jdField_a_of_type_Int <= 0) || (!localaiho.jdField_a_of_type_Boolean) || (((aihr)localObject).jdField_b_of_type_Long <= 0L)) {
            break;
          }
          int j = 0;
          long l1 = ((aihr)localObject).jdField_a_of_type_Long;
          long l2 = (localaiho.jdField_b_of_type_Int + 1) * 24 * 60 * 60 * 1000;
          long l3 = System.currentTimeMillis();
          int i;
          if (l3 - l1 > l2)
          {
            ((aihr)localObject).jdField_a_of_type_Long = l3;
            ((aihr)localObject).jdField_b_of_type_Long -= 1L;
            ((aihr)localObject).jdField_b_of_type_Int = (localaiho.jdField_a_of_type_Int - 1);
            a((aihr)localObject);
            i = 1;
          }
          for (;;)
          {
            ...
            {
              i = j;
              if (((aihr)localObject).jdField_b_of_type_Int > 0)
              {
                ((aihr)localObject).jdField_b_of_type_Long -= 1L;
                ((aihr)localObject).jdField_b_of_type_Int -= 1;
                a((aihr)localObject);
                i = 1;
              }
            }
  ...
  public aiho a()
  {
    if (this.jdField_a_of_type_Aiho != null) {
      return this.jdField_a_of_type_Aiho;
    }
    Object localObject = a();
    ...
    try
    {
      if (((File)localObject).exists()) {
        this.jdField_a_of_type_Aiho = aiho.a(FileUtils.readFileContent((File)localObject));
      }
      localObject = this.jdField_a_of_type_Aiho;
      return localObject;
    }
  ...
  public aihr a()
  {
    if (this.jdField_a_of_type_Aihr != null) {
      return this.jdField_a_of_type_Aihr;
    }
    aihr localaihr = aihr.a(a().getString("mobileunityversion", ""));
    this.jdField_a_of_type_Aihr = localaihr;
    return localaihr;
  }
  ...
  public void a(int paramInt, String paramString, aiho paramaiho)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      } while (paramaiho == null);
      FileUtils.createFile(str);
      FileUtils.writeFile(str, paramString);
      this.jdField_a_of_type_Aiho = paramaiho;
      if (QLog.isColorLevel()) {
        QLog.d("MobileUnityManager", 2, "saveBannerConfig date = " + this.jdField_a_of_type_Aiho);
      }
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005B71 ", "0X8005B71 ", 0, 0, "", "", "", "");
      paramString = a();
    } while (paramString == null);
    paramString.jdField_a_of_type_Long = 0L;
    paramString.jdField_a_of_type_Int = paramInt;
    paramString.jdField_b_of_type_Long = paramaiho.c;
    paramString.jdField_b_of_type_Int = paramaiho.jdField_a_of_type_Int;
    paramString.c = paramaiho.e;
    a(paramString);
    b();
  }
  
  public void a(aihr paramaihr)
  {
    if (paramaihr == null)
    {
      this.jdField_a_of_type_Aihr = null;
      a().edit().remove("mobileunityversion").commit();
      return;
    }
    this.jdField_a_of_type_Aihr = paramaihr;
    a().edit().putString("mobileunityversion", paramaihr.a()).commit();
  }
