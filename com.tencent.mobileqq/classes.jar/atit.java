...
public class atit
{
  ...
  public static ArrayList<HashMap<String, Object>> a(CharSequence paramCharSequence)
  {
    ...
    localArrayList2.add(new atiu(jdField_a_of_type_JavaUtilRegexPattern));
    localArrayList2.add(new ativ(jdField_e_of_type_JavaUtilRegexPattern));
    Object localObject1 = localArrayList2.iterator();
    while (((Iterator)localObject1).hasNext()) {
      ((atiw)((Iterator)localObject1).next()).a(paramCharSequence.toString());
    }
    ...
    if (i < k)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (localatiw.a(i))
        {
          ...
          localArrayList1.add(localatiw.a(0, true, paramCharSequence));
          i = localatiw.a() - 1;
        }
      }
    }
