...
public final class aluq
  implements alva, Handler.Callback, INetInfoHandler
{
  ...
  public aluq(QQAppInterface paramQQAppInterface)
  {
  ...
  private byte[] a(short paramShort, String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.4.8");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Alur.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Alur.b);
    ...
    try
    {
      paramString = alvx.a(paramString, this.jdField_a_of_type_Alur.jdField_a_of_type_JavaLangString);
  ...
  {
    ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Alur.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Alur.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    alvc localalvc = new alvc();
    localalvc.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Alur.jdField_a_of_type_JavaUtilList;
    localalvc.jdField_a_of_type_Int = this.jdField_a_of_type_Alur.jdField_a_of_type_Int;
    localalvc.b = 10000;
    localalvc.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localalvc);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localalvc);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          ((VasExtensionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(71)).e();
        }
      }
      finally {}
    }
  ...
  public void a(alur paramalur)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Alur = paramalur;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Bjng.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Bjng.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = alvx.b((byte[])localObject, this.jdField_a_of_type_Alur.jdField_a_of_type_JavaLangString);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Bjng.removeMessages(7);
      this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Alur });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Alur != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Bjng.removeMessages(1);
        this.jdField_a_of_type_Bjng.removeMessages(2);
        this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Bjng.removeMessages(1);
      this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_Alur = null;
      }
      i();
      return false;
    case 7: 
