...
{
  aluq(alup paramalup, Activity paramActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Alup.a(String.format((String)localObject1, new Object[] { paramBundle }));
      alup.a(this.jdField_a_of_type_Alup).show();
      return;
      localObject2 = str;
