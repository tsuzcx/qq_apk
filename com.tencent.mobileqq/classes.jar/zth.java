  ...
  extends RecyclerView.ViewHolder
{
  ...
  public zth(zsx paramzsx, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131370259));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131370263));
    this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView = ((RoundImageView)paramView.findViewById(2131370251));
    this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView.setmRadius(ImmersiveUtils.a(8.0F), false);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370270));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363039));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131363772));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367790));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367791));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367789));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367792));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131367793));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367794));
    this.jdField_d_of_type_AndroidWidgetImageView.setColorFilter(1291845632);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367795));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370268));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368103));
    this.f = ((TextView)paramView.findViewById(2131371976));
  }
  
  private void a()
  {
    if (zsx.a(this.jdField_a_of_type_Zsx))
    {
  ...
  private void a(ImageView paramImageView, String paramString)
  {
    ...
    paramImageView.setImageDrawable(URLDrawable.getDrawable(paramString, zsx.a(), zsx.a()));
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      ...
      if (zsx.a(this.jdField_a_of_type_Zsx) == 0)
      {
      ...
      if (zsx.a(this.jdField_a_of_type_Zsx) == 1)
      {
    ...
    } while (zsx.a(this.jdField_a_of_type_Zsx) != 2);
  ...
  public void a(zth paramzth, CertifiedAccountMeta.StFeed paramStFeed)
  {
    String.valueOf(paramStFeed.poster.id.get());
    this.itemView.setOnClickListener(new zti(this, paramStFeed));
  }
}
