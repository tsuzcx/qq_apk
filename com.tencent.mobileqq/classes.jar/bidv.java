...
public abstract class bidv
{
  ...
  private static final Interpolator sDragScrollInterpolator = new bidw();
  private static final Interpolator sDragViewScrollCapInterpolator = new bidx();
  private static final biec sUICallback = new biee();
  ...
  public static biec getDefaultUIUtil()
  {
    return sUICallback;
  }
  ...
  void onDraw(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<bidz> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      bidz localbidz = (bidz)paramList.get(i);
      localbidz.c();
      int k = paramCanvas.save();
      onChildDraw(paramCanvas, paramRecyclerView, localbidz.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbidz.e, localbidz.f, localbidz.jdField_b_of_type_Int, false);
  ...
  void onDrawOver(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<bidz> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      bidz localbidz = (bidz)paramList.get(i);
      int k = paramCanvas.save();
      onChildDrawOver(paramCanvas, paramRecyclerView, localbidz.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbidz.e, localbidz.f, localbidz.jdField_b_of_type_Int, false);
      paramCanvas.restoreToCount(k);
      i += 1;
    }
    if (paramViewHolder != null)
    ...
    if (i >= 0)
    {
      paramCanvas = (bidz)paramList.get(i);
  ...
  public void onMoved(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder1, int paramInt1, RecyclerView.ViewHolder paramViewHolder2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((localLayoutManager instanceof bieb)) {
      ((bieb)localLayoutManager).a(paramViewHolder1.itemView, paramViewHolder2.itemView, paramInt3, paramInt4);
    }
    do
    {
      do
