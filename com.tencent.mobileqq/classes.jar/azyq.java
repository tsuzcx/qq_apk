...
{
  public azyq(AbsProfileHeaderView paramAbsProfileHeaderView, String paramString, int paramInt, View paramView) {}
  ...
  public void onClick(View paramView)
  {
    if ((bbwx.a(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_Int >= 0))
    {
      ...
      azru.a().c(this.jdField_a_of_type_ComTencentMobileqqProfilecardBaseViewAbsProfileHeaderView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
