  ...
  extends xop
{
  ...
  {
    paramFromServiceMsg = bgys.a(paramFromServiceMsg.getWupBuffer());
  ...
  {
    paramFromServiceMsg = bgxx.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
  ...
  private byte[] b(ToServiceMsg paramToServiceMsg)
  {
    ...
    return bblm.a(localUniPacket.encode());
  }
  
  private Object c(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    paramFromServiceMsg = bgxv.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          ...
          l3 = l1;
          return new bgys(l3, l2, localInteger.intValue()).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bgxv(l3, l2, str1, localLong).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bgxx(l3, l2, str1).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
