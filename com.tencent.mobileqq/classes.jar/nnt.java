...
public abstract class nnt
{
  ...
  public nnt(Context paramContext, String paramString)
  {
  ...
  public boolean a(AppInterface paramAppInterface, String paramString)
  {
    try
    {
      ...
      paramAppInterface = ((bgog)((QQAppInterface)paramAppInterface).getManager(47)).a(1);
      paramString = AppConstants.SDCARD_PATH + a() + ".tmp";
      localObject = new bgoe((String)localObject, new File(paramString));
      ((bgoe)localObject).b = 3;
      Bundle localBundle = new Bundle();
      localBundle.putString("file_path", paramString);
      paramAppInterface.a((bgoe)localObject, new nnu(this), localBundle);
      return true;
    }
