  ...
  implements auxw
{
  ...
  public auya(VideoData paramVideoData, QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    try
    {
      int i = Integer.parseInt("8.3.3".replace(".", ""));
      return i;
    }
  ...
  public void a(int paramInt, auxy paramauxy)
  {
    ...
    mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new auyb(this, paramauxy), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public void a(Comments.Comment paramComment, auxx paramauxx)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    if (a(localReqBody))
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new auyd(this, paramauxx, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
    paramauxx.a(paramComment, -1);
  }
  
  public void a(Comments.Comment paramComment, auxz paramauxz)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new auyc(this, paramauxz, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
