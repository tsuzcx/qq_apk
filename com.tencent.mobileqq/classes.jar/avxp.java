...
public class avxp
{
  static final String jdField_a_of_type_JavaLangString = ampn.jdField_a_of_type_JavaLangString + "_Res";
  long jdField_a_of_type_Long = 0L;
  private ampd jdField_a_of_type_Ampd;
  private ampm jdField_a_of_type_Ampm;
  private avxu jdField_a_of_type_Avxu;
  private azby jdField_a_of_type_Azby;
  ...
  public avxp(ScanTorchActivity paramScanTorchActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity = paramScanTorchActivity;
  }
  
  private void a(AppInterface paramAppInterface, ampd paramampd)
  {
    if ((paramampd != null) && ((!paramampd.jdField_a_of_type_Boolean) || (paramampd.a() != null)))
    {
      this.jdField_a_of_type_Ampd = paramampd;
      d(paramAppInterface);
      ampn.a(paramAppInterface).a(paramAppInterface, paramampd.jdField_a_of_type_JavaLangString);
      a(paramAppInterface, this.jdField_a_of_type_Avxu.c());
      return;
    }
  ...
  private void a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      ...
      bool2 = this.jdField_a_of_type_Avxu.b();
      if (this.jdField_a_of_type_ArrayOfInt[0] == 100) {
        bool1 = true;
      }
    ...
    this.jdField_a_of_type_Avxu.a(paramAppInterface);
  }
  ...
  private void a(String paramString, AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Avxu.a(paramAppInterface, false);
    return;
    a("checkAllRes", true);
    if (a())
    {
    ...
    if (!this.jdField_a_of_type_Avxu.a())
    {
    ...
    a();
    this.jdField_a_of_type_Avxu.a(paramAppInterface, true);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Avxu.a("PromotionRes_" + paramString, 0);
  }
  ...
  public ampd a()
  {
    return this.jdField_a_of_type_Ampd;
  }
  ...
  void a()
  {
    ...
    {
      return;
      localButton = (Button)this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity.findViewById(2131365024);
      localButton.setVisibility(0);
    } while (localButton.getTag() != null);
    localButton.setTag(new Object());
    localButton.setOnClickListener(new avxt(this));
  }
  
  public void a(avxu paramavxu)
  {
    this.jdField_a_of_type_Avxu = paramavxu;
  }
  ...
  {
    if (this.jdField_a_of_type_Avxu.c())
    {
    ...
    ampn.a(paramAppInterface).a(paramAppInterface, new avxq(this, paramString, paramAppInterface));
  }
  ...
  public boolean a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = ((ampd)localObject1).a();
    ...
    {
      localObject2 = (ampe)((Map.Entry)((Iterator)localObject1).next()).getValue();
      if (ampk.a(paramAppInterface.getCurrentAccountUin(), (ampe)localObject2)) {
  ...
  public void b(AppInterface paramAppInterface)
  {
    ...
    {
      ampn.a(paramAppInterface).b(this.jdField_a_of_type_Ampm);
      this.jdField_a_of_type_Ampm = null;
    }
    if (this.jdField_a_of_type_Azby != null) {
      azbx.a().a(false, this.jdField_a_of_type_Azby);
    }
    this.jdField_a_of_type_Ampd = null;
  }
  ...
  public void c(AppInterface paramAppInterface)
  {
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 1, "reTry, promotionItem[" + localampd + "], isDownloading[" + bool2 + "], isDownloadError[" + bool1 + "], needShowDownloadProgress[" + this.jdField_a_of_type_Boolean + "], TotalProgress[" + a() + "]");
    this.jdField_a_of_type_Boolean = true;
    if (localampd == null) {}
    while (bool2) {
      return;
    }
    ampn.a(paramAppInterface).a(paramAppInterface, localampd.jdField_a_of_type_JavaLangString);
    a(paramAppInterface, this.jdField_a_of_type_Avxu.c());
  }
  ...
  void d(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Azby = new avxr(this, paramAppInterface);
    azbx.a().a(true, this.jdField_a_of_type_Azby);
    this.jdField_a_of_type_Ampm = new avxs(this, paramAppInterface);
    ampn.a(paramAppInterface).a(this.jdField_a_of_type_Ampm);
  }
