...
public class amcy
  extends anvi
{
  public amcy(SpecailCareListActivity paramSpecailCareListActivity) {}
    ...
    for (boolean bool = Arrays.equals(SpecailCareListActivity.a(this.a), paramArrayOfObject);; bool = false)
    {
        ...
        if (paramArrayOfObject.length >= 1)
        {
          ...
          if (paramBoolean) {
            if (this.a.c != null)
            {
              ...
              this.a.a();
              this.a.jdField_a_of_type_Amde.notifyDataSetChanged();
            }
          }
        }
      }
      while (!paramBoolean)
      {
        do
        {
          ...
          {
            return;
            QQToast.a(BaseApplication.getContext(), 2, 2131698898, 0).b(this.a.getTitleBarHeight());
          }
          if (this.a.c != null)
          {
            QQToast.a(BaseApplication.getContext(), 1, 2131698882, 0).b(this.a.getTitleBarHeight());
            return;
          }
          QQToast.a(BaseApplication.getContext(), 1, 2131698897, 0).b(this.a.getTitleBarHeight());
          return;
        } while (!paramBoolean);
        this.a.a();
        this.a.jdField_a_of_type_Amde.notifyDataSetChanged();
