...
public abstract class asol
  extends asou
{
  private static ason a;
  public int a;
  protected Context a;
  protected SparseArray<View> a;
  
  public asol(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramInt1);
  ...
  {
    if (jdField_a_of_type_Ason != null)
    {
      jdField_a_of_type_Ason.a();
      jdField_a_of_type_Ason = null;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (jdField_a_of_type_Ason == null) {
        jdField_a_of_type_Ason = new ason();
      }
    } while (jdField_a_of_type_Ason.a(paramInt, localView));
  }
  ...
  public View b(int paramInt)
  {
    ...
    if (jdField_a_of_type_Ason != null) {
      localView1 = jdField_a_of_type_Ason.a(i);
    }
