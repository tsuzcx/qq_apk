...
public class aowb
{
  ...
  public aowb(QQAppInterface paramQQAppInterface)
  {
  ...
  private im_msg_body.MsgBody a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: package multi troop file message. " + apvm.a(this.a, paramMessageRecord));
    ...
    for (;;)
    {
      ...
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: package normal troop file message. " + apvm.a(this.a, paramMessageRecord));
      localObject4 = (MessageForTroopFile)paramMessageRecord;
      Object localObject5 = bakx.a(this.a, (MessageForTroopFile)localObject4);
      if (localObject5 == null) {
        continue;
      }
      String str2 = ((azqv)localObject5).e;
      if (!TextUtils.isEmpty(str2))
      {
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).bytes_file_path.set(ByteStringMicro.copyFrom(str2.getBytes()));
        if (QLog.isDebugVersion()) {
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: get troop fileId[" + str2 + "] " + apvm.a(this.a, paramMessageRecord));
        }
        label684:
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).uint32_bus_id.set(((azqv)localObject5).h);
        str2 = ((azqv)localObject5).g;
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).str_file_name.set(str2);
        l = ((azqv)localObject5).c;
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).uint64_file_size.set(l);
        l = ((MessageForTroopFile)localObject4).lastTime;
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).int64_dead_time.set(l);
        localObject5 = ((azqv)localObject5).f;
      ...
      try
      {
        ...
        continue;
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: error, can not get troop fileId. " + apvm.a(this.a, paramMessageRecord));
        break label684;
        label899:
        if (!QLog.isDebugVersion()) {
          break label779;
        }
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: error, can not get sha. " + apvm.a(this.a, paramMessageRecord));
      }
  ...
  private boolean a(hummer_resv_21.ResvAttr paramResvAttr, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      break label182;
      label514:
      paramMessageRecord.saveExtInfoToExtStr("_m_ForwardSha", apgt.a(paramResvAttr.bytes_file_sha1.get().toByteArray()));
      break label207;
      label536:
      paramMessageRecord.saveExtInfoToExtStr("_m_ForwardMd5", apgt.a(paramResvAttr.bytes_file_md5.get().toByteArray()));
      break label232;
      label559:
  ...
  private im_msg_body.MsgBody b(MessageRecord paramMessageRecord)
  {
    ...
    if (a(paramMessageRecord))
    {
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package multi disc file message. " + apvm.a(this.a, paramMessageRecord));
    ...
    for (;;)
    {
      ...
      return localMsgBody;
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package normal disc file message. " + apvm.a(this.a, paramMessageRecord));
  ...
  private im_msg_body.MsgBody c(MessageRecord paramMessageRecord)
  {
    ...
    if (a(paramMessageRecord))
    {
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package multi buddy file message. " + apvm.a(this.a, paramMessageRecord));
      ...
      {
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package multi buddy file message but found online file." + apvm.a(this.a, paramMessageRecord));
        return null;
      }
    ...
    for (;;)
    {
      ...
      return localMsgBody;
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package normal buddy file message. " + apvm.a(this.a, paramMessageRecord));
      localObject2 = this.a.a().a(paramMessageRecord.uniseq, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      if (localObject2 != null)
      {
        ...
        for (;;)
        {
          ...
          i = apug.a(((FileManagerEntity)localObject2).fileName);
          if ((i == 0) || (i == 2))
          {
          ...
          break;
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: offline file name is null. " + apvm.a(this.a, paramMessageRecord));
          break label449;
          label626:
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: offline file uuid is null. " + apvm.a(this.a, paramMessageRecord));
          break label479;
          label662:
  ...
  public im_msg_body.MsgBody a(int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
    default: 
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "attention, this is a default way to handle, peerType[" + paramMessageRecord.istroop + "] " + apvm.a(this.a, paramMessageRecord));
  ...
  public void a(ArrayList<MessageRecord> paramArrayList, ByteStringMicro paramByteStringMicro)
  {
    ...
    do
    {
      try
      {
        ...
        {
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeBuddyFilePBMsg: decode multi buddy file message. " + apvm.a(this.a, localMessageRecord, false));
      ...
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeBuddyFilePBMsg: decode normal buddy file message. " + apvm.a(this.a, localMessageRecord, false));
    ...
    if (paramByteStringMicro.bytes_file_name.has())
    {
      ...
      if (paramByteStringMicro.bytes_file_md5.has()) {
        localMessageRecord.saveExtInfoToExtStr("_backup_ForwardMd5", apgt.a(paramByteStringMicro.bytes_file_md5.get().toByteArray()));
      }
  ...
  public boolean a(ArrayList<MessageRecord> paramArrayList, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      ...
      bbmx.a((byte[])localObject1, 0, arrayOfByte, i + 3, i1);
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          try
          {
            ...
            localObject4 = (MessageForTroopFile)axas.a(-2017);
            ...
            localObject3 = bakx.a((obj_msg.ObjMsg)localObject1);
        ...
        continue;
        label617:
        bajs localbajs = bajs.a(paramMsg.msg_head.group_info.group_code.get());
        Object localObject4 = localbajs.a(this.a, localException3.fileUrl);
        Object localObject2 = localObject4;
        if (localObject4 == null)
        {
          localbajs.a(this.a, localException3.fileUrl, localException3);
          localObject2 = localException3;
        }
        MessageForTroopFile localMessageForTroopFile = (MessageForTroopFile)axas.a(-2017);
        localMessageForTroopFile.msgtype = -2017;
        localMessageForTroopFile.msg = ajya.a(2131704567);
        for (;;)
        {
          try
          {
            localMessageForTroopFile.msgData = akwa.a(localObject2);
    ...
    while (paramMsg.hasNext())
    {
      ...
      else
      {
        ...
        try
        {
          ...
          {
            QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeDiscFilepb: decode multi disc file message. " + apvm.a(this.a, paramMsg, false));
        ...
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeDiscFilepb: decode normal disc file message. " + apvm.a(this.a, paramMsg, false));
        if (((im_msg_body.GroupFile)localObject2).bytes_filename.has())
        {
          ...
          paramMsg.saveExtInfoToExtStr("_backup_ForwardFileName", apug.a((String)localObject3));
          label447:
