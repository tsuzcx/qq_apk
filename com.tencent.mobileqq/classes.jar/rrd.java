...
public class rrd
{
  ...
  private ont jdField_a_of_type_Ont = new rrg(this);
  ...
  public rrd(Activity paramActivity)
  {
  ...
  public rrd(Activity paramActivity, boolean paramBoolean)
  {
    this(paramActivity);
    if (paramBoolean)
    {
  ...
  {
    Object localObject = nzv.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.i, paramInt1, paramInt2, paramBoolean);
    try
    {
      localObject = new JSONObject((String)localObject);
      ((JSONObject)localObject).put("pattern", this.jdField_e_of_type_Int);
      ndn.a(null, "", "0X8009545", "0X8009545", 0, 0, "", String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Long), ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  {
    paramBoolean1 = nzv.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.i, paramInt1, paramInt2, paramBoolean, paramBoolean1);
    ndn.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Long), paramBoolean1, false);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      bbmy.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131653595), 0).a();
    ...
    } while (bfqn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localBundle, null));
    vvp.a(1, 2131623975);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (obz.a(paramString5)) {
      paramString4 = obz.a(paramString5, 260, 520, 1);
    }
    ...
    paramString5.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131630985, new Object[] { paramString1 }));
    ...
    for (paramString1 = "";; paramString1 = paramString7.trim())
    {
      ...
      paramString5.putExtra("stuctmsg_bytes", awuw.a(paramString5.getExtras()).getBytes());
  ...
  {
    str3 = nzv.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.i, paramInt1, paramInt2, paramBoolean);
    try
    {
      ...
      {
        paramInt1 = nzv.a(obz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    ...
    ndn.a(null, "", "0X8009A79", "0X8009A79", 0, 0, "", String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Long), str1, false);
  }
  ...
  private void b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (this.jdField_a_of_type_Bbms == null) {
      this.jdField_a_of_type_Bbms = new bbms(this.jdField_a_of_type_AndroidAppActivity, localActivity.getResources().getDimensionPixelSize(2131167766));
    }
  ...
  public bahv a(ArticleInfo paramArticleInfo)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo = paramArticleInfo;
    this.i = paramArticleInfo.innerUniqueID;
    this.jdField_a_of_type_JavaLangString = obz.e(this.i);
    ...
    this.jdField_b_of_type_JavaLangString = ajjy.a(2131639210);
    ...
    if ((paramArticleInfo.mGalleryFeedsInfo != null) && (paramArticleInfo.mGalleryFeedsInfo.uint32_is_account_derelict.get() == 1))
    {
      ...
      this.g = (obb.k + Base64.encodeToString(this.k.getBytes(), 0));
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Rug == null) {
        this.jdField_a_of_type_Rug = new rug(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, new rrh(this));
      }
      this.jdField_a_of_type_Rug.a.a("biu出去让更多好友看到");
      this.jdField_a_of_type_Rug.a.a(new rre(this));
      return this.jdField_a_of_type_Rug.a(a());
      this.f = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131633581);
  ...
  public ppa a(ArrayList<DislikeInfo> paramArrayList)
  {
    ppa localppa = new ppa();
    if (!TextUtils.isEmpty(this.i)) {
      localppa.jdField_a_of_type_JavaLangString = this.i;
    }
    localppa.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
  ...
  public void a(String paramString1, String paramString2, String paramString3, Bitmap paramBitmap, boolean paramBoolean, run paramrun)
  {
    int i1 = 0;
    int n = 0;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            paramrun = new rrf(this, str, paramrun);
          ...
          if (bgmq.t(obz.a()) == 1)
          {
            paramrun = WXShareHelper.a();
            if (paramBoolean) {}
            for (m = n;; m = 1)
            {
              paramrun.b(str, paramString1, paramBitmap, paramString2, paramString3, m);
              break;
            }
          }
          paramrun = WxShareHelperFromReadInjoy.a();
          if (paramBoolean) {}
          for (m = i1;; m = 1)
          {
            paramrun.a(str, paramString1, paramBitmap, paramString2, paramString3, m);
            break;
          }
          label266:
          m = -1;
  ...
  public void a(String paramString, boolean paramBoolean, run paramrun)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
    ThreadManager.post(new GalleryShareHelper.3(this, paramString, paramBoolean, new HashMap(1), paramrun), 8, null, false);
  }
  
  public void a(qnr paramqnr)
  {
    this.jdField_a_of_type_Qnr = paramqnr;
  }
