  ...
  extends Dialog
{
  ...
  private bfpi jdField_a_of_type_Bfpi;
  private bfpj jdField_a_of_type_Bfpj;
  private bfpk jdField_a_of_type_Bfpk;
  private bfpl jdField_a_of_type_Bfpl;
  private CharSequence jdField_a_of_type_JavaLangCharSequence;
  public Object a;
  private ArrayList<Pair<CharSequence, Integer>> jdField_a_of_type_JavaUtilArrayList;
  private HashMap<CharSequence, bfpb> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new bfpf(this);
  ...
  protected bfpc(Context paramContext)
  {
    this(paramContext, false, false);
  }
  
  protected bfpc(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true, -1, null);
  }
  
  @TargetApi(14)
  protected bfpc(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    super(paramContext, 2131755221);
    this.jdField_d_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bfpg(this);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361916));
  ...
  public static bfpc a(Context paramContext)
  {
    paramContext = new bfpc(paramContext, false, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  }
  
  public static bfpc a(Context paramContext, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    paramContext = new bfpc(paramContext, false, false, true, paramInt, paramLayoutParams);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfpc a(Context paramContext, boolean paramBoolean)
  {
    paramContext = new bfpc(paramContext, false, true, paramBoolean, -1, null);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131691120) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131691122) + paramTextView.getText());
  }
  
  public static bfpc b(Context paramContext)
  {
    paramContext = new bfpc(paramContext, false, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfpc c(Context paramContext)
  {
    paramContext = new bfpc(paramContext, true, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfpc d(Context paramContext)
  {
    paramContext = new bfpc(paramContext, true, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setOnClickListener(new bfpd(this));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131361926));
      ...
      {
        localObject2 = (TextView)((View)localObject1).findViewById(2131361923);
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          ...
          if (((Integer)((Pair)localObject1).second).intValue() == 65537)
          {
            ...
            localObject2 = (TextView)localView.findViewById(2131361913);
            localObject3 = (TextView)localView.findViewById(2131376703);
            ...
            if ((m >= 0) && (m < ((CharSequence)((Pair)localObject1).first).length()))
            {
              ...
              localView.findViewById(2131363757).setContentDescription(((TextView)localObject2).getText());
              label408:
              baww.b(localView.findViewById(2131363757), LinearLayout.class.getName());
              label424:
              if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
              {
                localObject3 = (bfpb)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
                if ((localObject3 != null) && (((bfpb)localObject3).jdField_b_of_type_Int != 0)) {
                  ((TextView)localObject2).setId(((bfpb)localObject3).jdField_b_of_type_Int);
                }
              }
              localObject3 = (ImageView)localView.findViewById(2131361924);
              localObject4 = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
              ...
              label565:
              localObject3 = (ImageView)localView.findViewById(2131361925);
              localObject4 = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
              ...
              {
                ((RelativeLayout.LayoutParams)localObject4).width = baxn.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).height = baxn.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).addRule(15);
              }
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
              ((ImageView)localObject3).setLayoutParams((ViewGroup.LayoutParams)localObject4);
              ...
              if (this.jdField_a_of_type_Boolean)
              {
                ...
                localView.findViewById(2131361914).setVisibility(0);
          ...
          for (;;)
          {
            ...
            localObject2 = (TextView)localView.findViewById(2131361913);
            ((TextView)localObject2).setText((CharSequence)((Pair)localObject1).first);
            baww.b((View)localObject2, Button.class.getName());
            break label424;
            label1002:
  ...
  protected int a(int paramInt)
  {
    ...
    return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165654);
  }
  ...
  public bfpb a(CharSequence paramCharSequence)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      return null;
    }
    return (bfpb)this.jdField_a_of_type_JavaUtilHashMap.get(paramCharSequence);
  }
  ...
  public void a(int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    if ((paramInt1 >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131361913);
  ...
  public void a(bfpb parambfpb, int paramInt)
  {
    if (parambfpb == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(parambfpb.a, parambfpb);
    a(parambfpb.a, paramInt);
  }
  
  public void a(bfph parambfph)
  {
    this.jdField_a_of_type_Bfph = parambfph;
  }
  
  public void a(bfpi parambfpi)
  {
    this.jdField_a_of_type_Bfpi = parambfpi;
  }
  
  public void a(bfpj parambfpj)
  {
    this.jdField_a_of_type_Bfpj = parambfpj;
  }
  
  public void a(bfpk parambfpk)
  {
    this.jdField_a_of_type_Bfpk = parambfpk;
  }
  
  public void a(bfpl parambfpl)
  {
    this.jdField_a_of_type_Bfpl = parambfpl;
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      ((VerticalCenterImageSpan)localObject).setPadding(actj.a(10.0F, this.jdField_a_of_type_AndroidContentResResources), 0);
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131361914).setVisibility(8);
          a((TextView)localView.findViewById(2131361913), false);
        }
        i += 1;
      }
    }
  ...
  public void d(int paramInt)
  {
    if ((paramInt >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (this.jdField_a_of_type_AndroidUtilSparseArray != null)
      {
        ...
        {
          localView.findViewById(2131361914).setVisibility(0);
          a((TextView)localView.findViewById(2131361913), true);
        }
      }
    }
  }
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bfpk != null) {
      this.jdField_a_of_type_Bfpk.ak_();
    }
    if (this.g)
    {
      this.g = false;
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 696	android/app/Dialog:dismiss	()V
    //   4: aload_0
    //   5: invokestatic 701	zzp:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 701	zzp:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 701	zzp:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
