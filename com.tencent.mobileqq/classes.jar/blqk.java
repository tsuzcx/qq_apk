  ...
  implements bmau, bmub
{
  ...
  private blwe jdField_a_of_type_Blwe = new blqq(this);
  private blwf jdField_a_of_type_Blwf;
  private blwi jdField_a_of_type_Blwi = new blqp(this);
  bmhg jdField_a_of_type_Bmhg;
  private bmnv jdField_a_of_type_Bmnv = new blqo(this);
  ...
  public blqk(AppInterface paramAppInterface, View paramView, bmhg parambmhg)
  {
    this.jdField_a_of_type_Blsd = new blqn(this);
    if (paramView == null) {
      throw new IllegalStateException("rootView is null");
    }
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Bmhg = parambmhg;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView = ((EffectsCameraCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363890));
    this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView = ((QIMProviderContainerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372385));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131366817));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363950));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364908);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131366575);
    this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)paramView.findViewById(2131363940));
    this.jdField_c_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)paramView.findViewById(2131376338));
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131365399));
        this.jdField_a_of_type_AndroidViewViewStub.inflate();
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363942));
        ...
        blzf.a().a(0, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      {
        l1 = System.currentTimeMillis();
        this.jdField_b_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131373315));
        ...
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = ((ProviderViewEditContainer)this.jdField_a_of_type_AndroidViewView.findViewById(2131372387));
        ...
        ((DoodleEditView)localObject).setDoodleEditViewListener(new blql(this));
        this.jdField_a_of_type_AndroidViewView.findViewById(2131365574).setOnTouchListener(new blqm(this));
        l2 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidViewView.getContext(), alud.a(2131710167), 0).a();
  ...
  public void a(int paramInt, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if (paramInt != -1)
    {
      localObject = (VideoFilterViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131366530);
      if (localObject != null) {
    ...
    if (paramQIMFilterCategoryItem != null)
    {
      ...
      while (paramQIMFilterCategoryItem.hasNext())
      {
        ...
        if (EffectsCameraCaptureView.a(bnhb.a().a((String)localObject))) {
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (paramInt == 104)
    {
      paramObject = (QIMMusicConfigManager)blqr.a(2);
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, String paramString)
  {
    ...
    else
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView != null) {
        if ((azjh.a(bnpl.a)) && (paramPtvTemplateInfo != null))
        {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_Blwa.b())
    {
      this.jdField_a_of_type_Blwa.e();
      return true;
    }
    return false;
  }
  ...
  public void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Blwf.a().a(true, (Activity)this.jdField_a_of_type_AndroidViewView.getContext());
    }
  ...
  public void n()
  {
    ...
    bnhb.a().a(0);
    VideoFilterViewPager localVideoFilterViewPager = (VideoFilterViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131366530);
  ...
  public void u()
  {
    ...
    MusicProviderView localMusicProviderView = (MusicProviderView)this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView.a(MusicProviderView.class);
    DoodleLayout localDoodleLayout = blzf.a().a(0);
  ...
  public void x()
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView.b(this.jdField_c_of_type_Int, blra.jdField_b_of_type_Int, blra.jdField_b_of_type_JavaLangString);
