...
public class aems
  extends aodj
{
  public aems(PhoneUnityBindInfoActivity paramPhoneUnityBindInfoActivity) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt != 0) {
      if (paramInt == 39)
      {
        bhdj.a(this.a, 230, this.a.getString(2131694564), this.a.getString(2131694567), null, this.a.getString(2131691969), new aemt(this), null).show();
        PhoneUnityBindInfoActivity.a(this.a).a = false;
        PhoneUnityBindInfoActivity.a(this.a).setChecked(false);
        bdla.b(this.a.app, "dc00898", "", "", "0X800B320", "0X800B320", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramString)) {
        str = this.a.getString(2131694547);
      }
      ...
      bdla.b(this.a.app, "dc00898", "", "", "0X800B31E", "0X800B31E", 0, 0, "", "", "", "");
    }
  }
  ...
  public void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      return;
      PhoneUnityBindInfoActivity.a(this.a, 2131694461);
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      if (paramBoolean1) {
        bdla.b(this.a.app, "dc00898", "", "", "0X800B31A", "0X800B31A", 0, 0, "", "", "", "");
      }
    ...
    {
      ((ajcp)localObject).b = paramBoolean2;
      if (!paramBoolean1) {
        break;
      }
      bdla.b(this.a.app, "dc00898", "", "", "0X800B31B", "0X800B31B", 0, 0, "", "", "", "");
      break;
      paramBoolean2 = false;
      break label114;
    }
  ...
  protected void b(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      PhoneUnityBindInfoActivity.a(this.a).setChecked(false);
      PhoneUnityBindInfoActivity.a(this.a).a = false;
      bdla.b(this.a.app, "dc00898", "", "", "0X800B31F", "0X800B31F", 0, 0, "", "", "", "");
      PhoneUnityBindInfoActivity.a(this.a).setOnCheckedChangeListener(this.a);
    ...
    for (;;)
    {
      PhoneUnityBindInfoActivity.a(this.a).setChecked(true);
      PhoneUnityBindInfoActivity.a(this.a).a = true;
      bdla.b(this.a.app, "dc00898", "", "", "0X800B321", "0X800B321", 0, 0, "", "", "", "");
      break;
      label220:
      String str = paramString;
      if (TextUtils.isEmpty(paramString)) {
        str = this.a.getString(2131694562);
      }
      QQToast.a(this.a, str, 0).b(this.a.getTitleBarHeight());
    }
  }
