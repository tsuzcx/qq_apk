...
{
  public akkg(JumpAction paramJumpAction) {}
  ...
  protected void j(boolean paramBoolean, HashMap paramHashMap)
  {
    JumpAction.a(this.a).removeObserver(this.a.jdField_a_of_type_ComTencentQidianControllerQidianBusinessObserver);
    String str2;
    Intent localIntent;
  ...
  protected void k(boolean paramBoolean, HashMap paramHashMap)
  {
    JumpAction.a(this.a).removeObserver(this.a.jdField_a_of_type_ComTencentQidianControllerQidianBusinessObserver);
    if ((paramBoolean) && (paramHashMap != null))
    {
      paramHashMap = (String)paramHashMap.get("cipher_text");
      JumpAction.a(this.a).put("uin", paramHashMap);
      if (JumpAction.a(this.a).containsKey("isPrivate")) {
        JumpAction.a(this.a).remove("isPrivate");
      }
      JumpAction.b(this.a);
      return;
    }
    QQToast.a(BaseApplicationImpl.getContext(), 1, BaseApplicationImpl.getContext().getString(2131434471), 0).a();
  }
}
