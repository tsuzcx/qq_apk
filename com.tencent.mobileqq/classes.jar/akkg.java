  ...
  extends akie
{
  ...
  public akge a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akkk(this);
  ...
  public akkg(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new akkh(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368209)).setOnClickListener(new akki(this));
    Button localButton = (Button)findViewById(2131363745);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new akkj(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Akge = new akge(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Blha, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akge);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new akkl(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new akkm(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new akkn(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new akko(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Akge.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Akge.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(anzj.a(2131713965));
        ...
        {
          this.jdField_a_of_type_Akge.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Akge.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Akge.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Akge.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Akge.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(anzj.a(2131713967));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373040).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Akge.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Akge.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akge);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
