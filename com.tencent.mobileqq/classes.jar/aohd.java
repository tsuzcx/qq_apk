  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      localaohe.a(paramFromServiceMsg, 2);
      label649:
      localBundle.putInt("key_rt_type", i);
      notifyObserver(paramIntent, 113, true, localBundle, aohf.class);
      return;
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), aohd.class);
            ...
            if (localObject != null)
            {
              ...
              if ((i == 0) && (((oidb_sso.OIDBSSOPkg)localObject).bytes_bodybuffer.has()) && (((oidb_sso.OIDBSSOPkg)localObject).bytes_bodybuffer.get() != null))
              {
                ...
                try
                {
                  ...
                  paramIntent = (aohe)getAppRuntime().getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS);
