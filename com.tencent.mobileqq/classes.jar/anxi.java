  ...
  extends BaseAdapter
{
  ...
  protected List<aoam> a;
  protected Map<Integer, ArrayList<View>> a;
  public int b;
  protected List<aoam> b;
  protected int c;
  protected List<aoam> c;
  public int d;
  protected int e;
  ...
  public anxi(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, anyg paramanyg)
  {
  ...
  public abstract View a(anxj paramanxj, int paramInt, View paramView, ViewGroup paramViewGroup);
  ...
  public RelativeLayout a()
  {
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        ((TextView)localObject1).setId(2131365588);
      ...
      ((URLImageView)localObject1).setId(2131365583);
      ...
      localLayoutParams.addRule(2, 2131365588);
      ...
      ((ImageView)localObject1).setId(2131365589);
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          ...
          while (i < ((ArrayList)localObject).size())
          {
            ...
            Integer localInteger = (Integer)localView.getTag(2131365627);
            if (aoau.jdField_a_of_type_Int == localInteger.intValue()) {
              aoau.a().a(j, localView);
            }
            i += 1;
          }
        }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    do
    {
      ...
      paramView.setTag(2131365627, Integer.valueOf(this.d));
  ...
  public void a(View paramView, aoam paramaoam)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramaoam = (URLImageView)paramView.findViewById(2131365583);
      long l = System.currentTimeMillis();
      localObject2 = ((anyh)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Float);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "getDrawable cost = " + (System.currentTimeMillis() - l));
      }
      paramaoam.setImageDrawable((Drawable)localObject2);
      paramaoam.setVisibility(0);
    } while (!(localObject1 instanceof aobp));
    paramaoam = (aobp)localObject1;
    Object localObject1 = (TextView)paramView.findViewById(2131365588);
    if (paramaoam.a != null)
    {
      localObject2 = paramaoam.a.name;
  ...
  {
    if (paramView == null) {}
    for (anxj localanxj = a();; localanxj = (anxj)paramView.getTag()) {
      return a(localanxj, paramInt, paramView, paramViewGroup);
    }
  }
}
