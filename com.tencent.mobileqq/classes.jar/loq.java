  ...
  implements lop
{
  ...
  private final List<low> jdField_a_of_type_JavaUtilList = new ArrayList(11);
  private final lov jdField_a_of_type_Lov = new lov();
  private final lqh jdField_a_of_type_Lqh;
  ...
  public loq(lqh paramlqh, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("AEFilterAVWrapperImpl", 2, "AEFilterAVWrapperImpl, mode[" + paramInt + "]");
    }
    this.jdField_a_of_type_Lqh = paramlqh;
  ...
  private void e()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Lov.a(0, this.jdField_a_of_type_JavaUtilList);
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      boolean bool2 = false;
      boolean bool1 = false;
      while (localIterator.hasNext())
      {
        low locallow = (low)localIterator.next();
        if (locallow != null)
        {
          boolean bool3;
          switch (locallow.jdField_a_of_type_Int)
          {
          default: 
            bool3 = bool2;
            bool2 = bool1;
          ...
          for (;;)
          {
            ...
            bool1 = bool3;
            break;
            localAEFilterManager.setSmoothLevel(locallow.jdField_d_of_type_Int);
            bool3 = bool1;
            bool1 = bool2;
            bool2 = bool3;
            continue;
            localAEFilterManager.setBeautyOrTransformLevel(locallow.jdField_a_of_type_ComTencentTtpicOpenapiConfigBeautyRealConfig$TYPE, locallow.jdField_d_of_type_Int);
            if (locallow.jdField_d_of_type_Int == locallow.jdField_c_of_type_Int) {
              break label116;
            }
            bool1 = bool2;
            bool2 = true;
  ...
  public int a(int paramInt, boolean paramBoolean1, lpk paramlpk, boolean paramBoolean2)
  {
    int i;
    if (this.jdField_a_of_type_Int < 1)
    {
    ...
    paramlpk.a(a(), (float)a(), paramBoolean2);
    return paramInt;
  }
  ...
  {
    boolean bool;
    if ((!lqf.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) || (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != paramVideoMaterial))
    {
      ...
      if (this.jdField_a_of_type_Lqh != null) {
        this.jdField_a_of_type_Lqh.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem.getGestureType());
      }
      label157:
      if (this.jdField_a_of_type_Lqh != null) {
        this.jdField_a_of_type_Lqh.a(false);
      }
  ...
  public void a(FilterDesc paramFilterDesc)
  {
    ...
    if (!lqf.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, paramFilterDesc))
    {
  ...
  public void a(lpe paramlpe, lpk paramlpk)
  {
    String str2 = "";
    String str1 = "";
    ...
    {
      boolean bool2 = lhw.a().b();
      if ((lid.a(localVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
          QLog.i("AEFilterAVWrapperImpl", 4, "processTip, cnt[" + paramlpk.jdField_a_of_type_Int + "], bIsPendantHasFace[" + bool1 + "], gesture[" + this.jdField_b_of_type_Boolean + "], gestureType[" + str2 + "], gestureWording[" + str1);
        }
        if (this.jdField_a_of_type_Lqh != null)
        {
          int i = this.jdField_a_of_type_Lqh.a(paramlpe, paramlpk.jdField_a_of_type_Int, this.jdField_b_of_type_Boolean, bool1, str1, str2);
        ...
        this.jdField_a_of_type_Lqh.a(true);
        return;
      }
    }
  }
  ...
  public boolean a(lov paramlov)
  {
    if (paramlov == null) {
      this.jdField_a_of_type_Lov.c();
    }
    for (;;)
    {
      return this.jdField_a_of_type_Lov.b();
      this.jdField_a_of_type_Lov.a(paramlov);
    }
  }
