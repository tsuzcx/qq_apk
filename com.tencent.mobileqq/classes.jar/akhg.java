  ...
  implements Handler.Callback, Manager
{
  ...
  private aner jdField_a_of_type_Aner;
  private anxn jdField_a_of_type_Anxn;
  private anxo jdField_a_of_type_Anxo = new akhh(this);
  ...
  public akhg(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Anxn = ((anxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(148));
    this.jdField_a_of_type_Aner = new aner(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppAsyncdbDBDelayManager);
    this.jdField_a_of_type_Bfum = new bfum(ThreadManagerV2.getSubThreadLooper(), this);
    this.jdField_a_of_type_Bfum.sendEmptyMessage(1);
  ...
  {
    // Byte code:
    //   0: new 175	java/io/ObjectInputStream
    //   3: dup
    //   4: new 177	java/io/ByteArrayInputStream
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 180	java/io/ByteArrayInputStream:<init>	([B)V
    //   12: invokespecial 183	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   15: astore_1
    //   16: aload_1
    //   17: astore_0
    //   18: aload_1
    //   19: invokevirtual 187	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: astore_0
    //   25: aload_2
    ...
    //   33: astore_0
    //   34: aload_2
    //   35: checkcast 189	com/tencent/mobileqq/applets/data/AppletInfo
    //   38: astore_2
    //   39: aload_1
    //   40: ifnull +7 -> 47
    //   43: aload_1
    //   44: invokevirtual 192	java/io/ObjectInputStream:close	()V
    //   47: aload_2
    //   48: areturn
    //   49: astore_0
    //   50: aload_0
    //   51: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   54: aload_2
    //   55: areturn
    //   56: aload_1
    //   57: ifnull +7 -> 64
    //   60: aload_1
    //   61: invokevirtual 192	java/io/ObjectInputStream:close	()V
    //   64: aconst_null
    //   65: areturn
    //   66: astore_0
    //   67: aload_0
    //   68: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   71: goto -7 -> 64
    //   74: astore_2
    //   75: aconst_null
    //   76: astore_1
    ...
    //   78: astore_0
    //   79: aload_2
    //   80: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   83: aload_1
    //   84: ifnull +7 -> 91
    //   87: aload_1
    //   88: invokevirtual 192	java/io/ObjectInputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore_0
    //   94: aload_0
    //   95: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   98: goto -7 -> 91
    //   101: astore_2
    //   102: aconst_null
    //   103: astore_1
    ...
    //   105: astore_0
    //   106: aload_2
    //   107: invokevirtual 196	java/lang/ClassNotFoundException:printStackTrace	()V
    //   110: aload_1
    //   111: ifnull -20 -> 91
    //   114: aload_1
    //   115: invokevirtual 192	java/io/ObjectInputStream:close	()V
    //   118: goto -27 -> 91
    //   121: astore_0
    //   122: aload_0
    ...
    //   133: ifnull +7 -> 140
    //   136: aload_0
    //   137: invokevirtual 192	java/io/ObjectInputStream:close	()V
    //   140: aload_1
    //   141: athrow
    //   142: astore_0
    //   143: aload_0
    //   144: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   147: goto -7 -> 140
    //   150: astore_1
    //   151: goto -19 -> 132
    //   154: astore_2
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      apvj localapvj = (apvj)apub.a().a(597);
      if (localapvj == null) {
        break label85;
      }
      if (!localapvj.jdField_a_of_type_Boolean) {
        break label80;
      }
      i = 1;
  ...
  public static byte[] a(com.tencent.mobileqq.applets.data.AppletInfo paramAppletInfo)
  {
    ...
    //   10: aload_1
    //   11: areturn
    //   12: new 256	java/io/ByteArrayOutputStream
    //   15: dup
    //   16: invokespecial 257	java/io/ByteArrayOutputStream:<init>	()V
    //   19: astore_3
    //   20: new 259	java/io/ObjectOutputStream
    //   23: dup
    //   24: aload_3
    //   25: invokespecial 262	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   28: astore_2
    //   29: aload_2
    //   30: astore_1
    //   31: aload_2
    //   32: aload_0
    //   33: invokevirtual 266	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   36: aload_2
    //   37: astore_1
    //   38: aload_3
    //   39: invokevirtual 270	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   42: astore_0
    //   43: aload_0
    //   44: astore_1
    //   45: aload_2
    //   46: ifnull -36 -> 10
    //   49: aload_2
    //   50: invokevirtual 271	java/io/ObjectOutputStream:close	()V
    //   53: aload_0
    //   54: areturn
    //   55: astore_1
    //   56: aload_1
    //   57: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   60: aload_0
    //   61: areturn
    //   62: astore_3
    //   63: aconst_null
    ...
    //   75: ifnull -65 -> 10
    //   78: aload_0
    //   79: invokevirtual 271	java/io/ObjectOutputStream:close	()V
    //   82: aconst_null
    //   83: areturn
    //   84: astore_0
    //   85: aload_0
    //   86: invokevirtual 195	java/io/IOException:printStackTrace	()V
    //   89: aconst_null
    //   90: areturn
    //   91: astore_0
    //   92: aconst_null
    ...
    //   95: ifnull +7 -> 102
    //   98: aload_1
    //   99: invokevirtual 271	java/io/ObjectOutputStream:close	()V
    //   102: aload_0
    //   103: athrow
    //   104: astore_1
    //   105: aload_1
  ...
  public int a(QQMessageFacade.Message paramMessage)
  {
    ...
    {
      str = paramMessage.getExtInfoFromExtStr(bbkv.A);
  ...
  public int a(QQMessageFacade.Message paramMessage, RecentUser paramRecentUser)
  {
    ...
    if (paramMessage != null)
    {
      paramMessage = paramMessage.getExtInfoFromExtStr(bbkv.A);
  ...
  {
    paramString = this.jdField_a_of_type_Aner.a(paramString);
  ...
  public void a(AppletsAccountInfo paramAppletsAccountInfo)
  {
    if (paramAppletsAccountInfo != null)
    {
      ...
      this.jdField_a_of_type_Aner.a(paramAppletsAccountInfo);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(RecentUser paramRecentUser)
  {
    if (paramRecentUser != null)
    {
      ...
      this.jdField_a_of_type_Bfum.obtainMessage(3, 0, 0, paramRecentUser).sendToTarget();
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    this.jdField_a_of_type_Anxn.a(localArrayList);
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Aner != null) {
      this.jdField_a_of_type_Aner.b();
    }
