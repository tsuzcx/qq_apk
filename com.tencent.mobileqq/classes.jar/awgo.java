...
public class awgo
  extends QIPCModule
{
  private ArrayList<awgr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      ...
      try
      {
        ...
        if (paramBundle != null) {
          synchronized (this.jdField_a_of_type_JavaUtilArrayList)
          {
            ...
            {
              awgr localawgr = (awgr)localIterator.next();
              if (localawgr != null) {
                localawgr.a(paramBundle);
              }
            }
          }
        }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ListenTogetherIPCModuleWebClient", 2, "register callback:" + paramawgr);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramawgr)) {}
    for (;;)
    {
      return;
      ...
      catch (Exception localException)
      {
        synchronized (this.jdField_a_of_type_JavaUtilArrayList)
        {
          this.jdField_a_of_type_JavaUtilArrayList.add(paramawgr);
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  public void b(awgr paramawgr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ListenTogetherIPCModuleWebClient", 2, "unregister callback:" + paramawgr + " mHasRegistered:" + this.jdField_a_of_type_Boolean);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramawgr)) {}
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramawgr);
      if (QLog.isColorLevel()) {
    ...
    {
      QLog.e("ListenTogetherIPCModuleWebClient", 1, "unregister ipc module error.", paramawgr);
    }
    paramawgr = finally;
    throw paramawgr;
  }
