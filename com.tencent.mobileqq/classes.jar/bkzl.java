  ...
  extends RemoteCommand
{
  ...
  public bkzl(String paramString, boolean paramBoolean)
  {
    super(paramString);
    this.a = paramBoolean;
  }
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = bggl.a(paramResources, 2130843512);
  ...
  private Bundle a(Bundle paramBundle1, Bundle paramBundle2, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (Bundle localBundle = new Bundle();; localBundle = paramBundle2)
    {
      ...
      if (!TextUtils.isEmpty(paramBundle2))
      {
        ...
        if (!TextUtils.isEmpty(paramBundle2))
        {
          localObject1 = bgbw.a(paramBundle2, BaseApplicationImpl.getContext().getResources(), i, j, bool1);
          if (localObject1 != null) {
            localBundle.putString("path", zvc.a(BaseApplicationImpl.getContext(), paramBundle2.hashCode() + "", (Bitmap)localObject1));
          }
        }
      }
      if (QLog.isColorLevel())
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        {
          SosoInterface.a(new bkzm(this, 3, true, true, 300000L, false, false, "buscardLocation", localBundle, paramOnInvokeFinishLinstener));
          break;
        }
        Object localObject2;
        if (paramBundle2.equals("publicAccount"))
        {
          ...
          for (paramBundle2 = (Bundle)localObject1;; paramBundle2 = "null")
          {
            ...
            tzo.a(a(), a().getApp(), (String)localObject1, new bkzn(this, localBundle, paramOnInvokeFinishLinstener));
            break;
          }
        }
        ...
        else
        {
          ...
          if (a() != null)
          {
            ...
            if (!TextUtils.isEmpty(paramBundle2))
            {
              localObject2 = (anrs)a().getManager(56);
              if (localObject2 != null) {
                bool1 = ((anrs)localObject2).a(Long.valueOf(paramBundle2));
              }
              bool2 = bool1;
              if (QLog.isColorLevel())
              {
  ...
  public static void a()
  {
    ...
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand"))) {
      localPluginCommunicationHandler.register(new bkzl("com.tencent.nfc.buscard.remotecommand", true));
    }
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand.async"))) {
      localPluginCommunicationHandler.register(new bkzl("com.tencent.nfc.buscard.remotecommand.async", false));
    }
  }
