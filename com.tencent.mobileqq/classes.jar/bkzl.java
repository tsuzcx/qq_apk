...
public abstract class bkzl
{
  ...
  public bkzl(Context paramContext)
  {
    this(paramContext, 3);
  }
  
  public bkzl(Context paramContext, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidHardwareSensor != null) {
      this.jdField_a_of_type_AndroidHardwareSensorEventListener = new bkzm(this);
    }
  }
