  ...
  extends wzn
{
  ...
  private View.OnFocusChangeListener jdField_a_of_type_AndroidViewView$OnFocusChangeListener = new wzm(this);
  View jdField_a_of_type_AndroidViewView;
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new wzl(this);
  ...
  public wzk(GoldMsgSettingActivity paramGoldMsgSettingActivity, Context paramContext, Intent paramIntent, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangString = String.format(paramContext.getString(2131432302), new Object[] { NumAnim.formatNumber(this.jdField_b_of_type_Long / 100.0D, false) });
    this.jdField_b_of_type_JavaLangString = String.format(paramContext.getString(2131432301), new Object[] { NumAnim.formatNumber(this.jdField_a_of_type_Long / 100.0D, false) });
  ...
  private void a(boolean paramBoolean)
  {
    ...
    label82:
    label87:
    for (int i = 2131432309;; i = 2131432306)
    {
  ...
  private boolean b()
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (bool)) {
      localQQToast1 = QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432314, 0);
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localQQToast2 = QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432288, 0);
        }
        break;
  ...
  {
    long l2 = 1L;
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetValueSelector = ((ValueSelector)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364738));
    ...
    for (long l1 = paramView.jdField_a_of_type_Long;; l1 = 1L)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364739);
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364741));
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormEditItem = ((FormEditItem)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364742));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364744));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364743));
      if (this.e)
      {
  ...
  void a(boolean paramBoolean, GoldMsgGetReq paramGoldMsgGetReq, GoldMsgGetRsp paramGoldMsgGetRsp)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432317, 0).a();
      return;
      label124:
      l1 = l2;
    }
  ...
  void a(boolean paramBoolean, GoldMsgSetReq paramGoldMsgSetReq, GoldMsgSetRsp paramGoldMsgSetRsp)
  {
    ...
    if (paramBoolean)
    {
      ...
      label139:
      for (int i = 2131432315;; i = 2131432316)
      {
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432289, 0).a();
  }
