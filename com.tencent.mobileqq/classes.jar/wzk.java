...
public class wzk
{
  private static SparseArray<wzs> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = weg.a("StorySvc.report_comment");
    b = weg.a(2131699185);
  ...
  public static int a(StoryVideoItem paramStoryVideoItem, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new bbkx(2000000, (PublishVideoEntry)localObject1);
      ((bbkx)localObject1).b(0);
      localObject2 = new bbkv();
      localObject3 = vzh.k + paramStoryVideoItem.mVid + ".mp4";
      paramInt = ((bbkv)localObject2).a(paramStoryVideoItem.mLocalVideoPath, (String)localObject3, (bbkx)localObject1);
      if (paramInt == 0) {
        break label481;
      }
      if (paramInt == -1) {
      ...
      ykq.b("Q.qqstory.player.PlayModeUtils", new Throwable("MergeVideoError"), "watermarkVideoByMediaCodec() error after mergeVideo() return, errorCode=%d", new Object[] { Integer.valueOf(paramInt) });
      return paramInt;
      localObject1 = localObject2;
    }
    zeb.c(paramStoryVideoItem.mLocalVideoPath, paramString);
    label481:
    for (paramInt = 0;; paramInt = zfp.a((String)localObject3, paramStoryVideoItem.mLocalVideoPath, paramString, 0))
    {
      if (paramInt == 0) {
        zeb.a(BaseApplication.getContext(), new File(paramString));
      }
  ...
  public static ShareGroupItem a(String paramString, wqo paramwqo)
  {
    ShareGroupItem localShareGroupItem = ((xti)wjs.a(7)).a(paramString);
    if ((localShareGroupItem != null) || (paramwqo == null)) {
      return localShareGroupItem;
    }
    paramString = new wqm(paramString, String.valueOf(System.currentTimeMillis()));
    paramString.a(new wzm(paramwqo));
    paramString.a();
    return null;
  }
  ...
  {
    paramString = ((wke)wjs.a(2)).b(paramString);
    if (paramString == null)
    {
  ...
  @NonNull
  public static wzs a(int paramInt)
  {
    wzs localwzs2 = (wzs)jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    wzs localwzs1 = localwzs2;
    if (localwzs2 == null)
    {
      localwzs1 = new wzs();
      jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localwzs1);
    }
    return localwzs1;
  }
  ...
  public static void a(Context paramContext, CommentEntry paramCommentEntry)
  {
    ...
    do
    {
      do
      {
        ...
        QQToast.a(BaseApplicationImpl.getContext(), 1, anvx.a(2131707669), 0).a();
        ykv.b("story_net", jdField_a_of_type_JavaLangString, 0, 99980, new String[] { "", "0", ykv.a(BaseApplication.getContext()) });
      } while (!QLog.isColorLevel());
      QLog.w("Q.qqstory.player.PlayModeUtils", 2, "reportVideoCommemt - isNetSupport is false----");
      return;
      paramContext = (bkzi)bkzz.b(paramContext, null);
      paramContext.a(anvx.a(2131707661), 5);
      paramContext.a(anvx.a(2131707680), 5);
      paramContext.a(anvx.a(2131707677), 5);
      paramContext.a(anvx.a(2131707665), 5);
      paramContext.c(2131690697);
      paramContext.a(new wzq(paramCommentEntry, paramContext));
  ...
  {
    if (!NetworkUtil.isNetSupport(BaseApplicationImpl.getContext())) {
      QQToast.a(BaseApplicationImpl.getContext(), 1, anvx.a(2131707678), 0).a();
    }
    do
    {
      return;
      paramContext = (bkzi)bkzz.b(paramContext, null);
      paramContext.a(anvx.a(2131707676), 5);
      paramContext.a(anvx.a(2131707670), 5);
      paramContext.a(anvx.a(2131707683), 5);
      paramContext.a(anvx.a(2131707660), 5);
      paramContext.c(2131690697);
      paramContext.a(new wzp(paramQQUserUIItem, paramContext));
  ...
  {
    if (!NetworkUtil.isNetSupport(BaseApplicationImpl.getContext())) {
      QQToast.a(BaseApplicationImpl.getContext(), 1, anvx.a(2131707663), 0).a();
    }
    do
    {
      return;
      paramContext = (bkzi)bkzz.b(paramContext, null);
      paramContext.a(anvx.a(2131707659), 5);
      paramContext.a(anvx.a(2131707662), 5);
      paramContext.a(anvx.a(2131707681), 5);
      paramContext.a(anvx.a(2131707682), 5);
      paramContext.c(2131690697);
      paramContext.a(new wzr(paramStoryVideoItem, paramContext));
      paramContext.setOnDismissListener(paramOnDismissListener);
    } while (paramContext.isShowing());
    paramContext.show();
  }
  ...
  public static void a(Resources paramResources, QQUserUIItem paramQQUserUIItem, ImageView paramImageView, float paramFloat1, TextView paramTextView, float paramFloat2, float paramFloat3, boolean paramBoolean, String paramString)
  {
    ...
    if (wel.a())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        paramTextView.setText(((wka)wjs.a(23)).a(paramQQUserUIItem, paramString, false, true));
      }
    }
    for (;;)
    {
      ...
      localObject = paramResources.getDrawable(2130846844);
  ...
  public static final void a(ImageView paramImageView, QQUserUIItem paramQQUserUIItem)
  {
    ...
    paramQQUserUIItem = wel.a(paramQQUserUIItem);
  ...
  protected static void a(ImageView paramImageView, String paramString1, int paramInt1, int paramInt2, boolean paramBoolean, Drawable paramDrawable, DownloadParams.DecodeHandler paramDecodeHandler, Object paramObject, String paramString2, wzw paramwzw)
  {
    for (;;)
    {
      try
    ...
    paramString1.setURLDrawableListener(new wzl(System.currentTimeMillis(), paramwzw));
  }
  ...
  protected static void a(ImageView paramImageView, String paramString1, int paramInt1, int paramInt2, boolean paramBoolean, DownloadParams.DecodeHandler paramDecodeHandler, Object paramObject, String paramString2, wzw paramwzw)
  {
    a(paramImageView, paramString1, paramInt1, paramInt2, paramBoolean, new ColorDrawable(0), paramDecodeHandler, paramObject, paramString2, paramwzw);
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, String paramString2, boolean paramBoolean, wzw paramwzw)
  {
    String str = null;
    ...
    for (;;)
    {
      a(paramImageView, paramString1, ScreenUtil.SCREEN_WIDTH / 2, ScreenUtil.SCREEN_HIGHT / 2, bool, localDecodeHandler, arrayOfInt, str, paramwzw);
      return;
      localDecodeHandler = null;
      break;
      label73:
  ...
  public static void a(ShareFromMemoryPlayInfo paramShareFromMemoryPlayInfo, wzv paramwzv)
  {
    wsv localwsv = new wsv();
    localwsv.jdField_c_of_type_JavaLangString = paramShareFromMemoryPlayInfo.uid;
    localwsv.d = "";
    localwsv.jdField_c_of_type_Int = 20;
    localwsv.jdField_e_of_type_Int = paramShareFromMemoryPlayInfo.shareTimeZone;
    localwsv.jdField_e_of_type_JavaLangString = paramShareFromMemoryPlayInfo.feedId;
    localwsv.f = paramShareFromMemoryPlayInfo.identify;
    localwsv.g = paramShareFromMemoryPlayInfo.videoListOrder;
    wfi.a().a(localwsv, new wzo(paramwzv));
  }
  ...
  protected static final void a(FFmpeg paramFFmpeg, String paramString1, StoryVideoItem paramStoryVideoItem, String paramString2, int paramInt, String paramString3)
  {
    try
    {
      wzu localwzu = new wzu(paramString2, paramStoryVideoItem, paramString3);
      paramFFmpeg.setCurrentTaskUni(paramString2);
      paramFFmpeg.watermark(FFmpegUtils.getVideoDownloadWatermarkPath(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt), paramString1, paramString2, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, localwzu);
      return;
    }
    catch (Exception paramFFmpeg)
    {
      paramString1 = new wzt(paramString3, 3, paramStoryVideoItem);
      wad.a().dispatch(paramString1);
      QLog.e("Q.qqstory.player.PlayModeUtils", 2, paramFFmpeg.getMessage());
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, wzx paramwzx)
  {
    ...
    ntb.a(paramQQAppInterface, paramwzx, localReqBatchGetVideoFullInfoList.toByteArray(), wtz.jdField_a_of_type_JavaLangString, paramString);
  }
  ...
  public static boolean a(StoryVideoItem paramStoryVideoItem, Context paramContext)
  {
    ...
    ykq.a("Q.qqstory.player.PlayModeUtils", "onClickRetryUploadBtn=%s", paramStoryVideoItem);
    ykv.a("mystory", "clk_retry", 0, 0, new String[0]);
    if (wcx.a(paramStoryVideoItem.mUpLoadFailedError))
    {
      ykq.d("Q.qqstory.player.PlayModeUtils", "video file not exist, vid:%s", new Object[] { paramStoryVideoItem.mVid });
      String str = paramStoryVideoItem.mVid;
      paramContext = bhdj.a(paramContext, 230);
      paramContext.setTitle(anvx.a(2131707668));
      if (wcx.b(paramStoryVideoItem.mUpLoadFailedError)) {
        paramContext.setMessage(anvx.a(2131707675));
      }
      for (;;)
      {
        paramContext.setPositiveButton(anvx.a(2131707674), new wzn(paramStoryVideoItem, str));
        paramContext.setCancelable(false);
        paramContext.getWindow().setBackgroundDrawable(new ColorDrawable(0));
        paramContext.show();
        return false;
        paramContext.setMessage(anvx.a(2131707671));
      }
    }
    return wcn.a(paramStoryVideoItem, paramContext);
  }
  
  public static final String b(QQUserUIItem paramQQUserUIItem)
  {
    return wel.b(paramQQUserUIItem);
  }
  ...
  {
    a(paramImageView, paramString1, paramInt1, paramInt2, paramBoolean, bheg.b(), paramDecodeHandler, paramObject, paramString2);
  }
  ...
  public static void b(ImageView paramImageView, String paramString1, String paramString2, boolean paramBoolean, wzw paramwzw)
  {
    String str = null;
    boolean bool = FileUtil.isFileExists(paramString1);
    DownloadParams.DecodeHandler localDecodeHandler;
    ...
    for (;;)
    {
      a(paramImageView, paramString1, ScreenUtil.SCREEN_WIDTH, ScreenUtil.SCREEN_HIGHT, bool, localDecodeHandler, arrayOfInt, str, paramwzw);
      return;
      localDecodeHandler = null;
      break;
      label69:
  ...
  public static void b(StoryVideoItem paramStoryVideoItem, int paramInt, String paramString)
  {
    ...
    {
      paramStoryVideoItem = new wzt(paramString, 3, paramStoryVideoItem);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          paramString = new wzt(paramString, 2, paramStoryVideoItem);
          paramString.b = str2;
          wad.a().dispatch(paramString);
          long l2 = paramStoryVideoItem.mVideoDuration;
          ykv.a("play_video", "down_watermark_time", 1, 0, new String[] { String.valueOf(SystemClock.uptimeMillis() - l1), String.valueOf(l2) });
          ykv.a("play_video", "down_watermark", 1, 0, new String[0]);
          ykv.a("play_video", "down_suc", 1, 0, new String[] { "", "", "", paramStoryVideoItem.mVid });
          return;
        }
      }
      catch (IllegalStateException localIllegalStateException)
      {
        ...
        Object localObject1 = vzh.k + paramStoryVideoItem.mVid + ".mp4";
        FFmpeg localFFmpeg = FFmpeg.getInstance(a());
        if (localFFmpeg.isFFmpegCommandRunning())
        {
          if (!localFFmpeg.checkSameTask(str2))
          {
            paramStoryVideoItem = new wzt(paramString, 1, paramStoryVideoItem);
            wad.a().dispatch(paramStoryVideoItem);
          }
        }
        else
        {
          if (zeb.c(str2))
          {
            paramStoryVideoItem = new wzt(paramString, 2, paramStoryVideoItem);
            paramStoryVideoItem.b = str2;
            wad.a().dispatch(paramStoryVideoItem);
            return;
          }
          if (zeb.c((String)localObject1))
          {
          ...
          for (;;)
          {
            try
            {
              localObject1 = new wzu(str2, paramStoryVideoItem, paramString);
              localFFmpeg.setCurrentTaskUni(str2);
              paramInt = zfl.b(paramStoryVideoItem.mLocalVideoPath);
          ...
          str1 = vzh.k + "hflip" + paramStoryVideoItem.mVid + ".mp4";
          if (!zeb.c(str1))
          {
            ...
            localObject4 = new wzt(paramString, 0, paramStoryVideoItem);
            wad.a().dispatch((Dispatcher.Dispatchable)localObject4);
          }
  ...
  {
    wzt localwzt = new wzt(paramString, 0, paramStoryVideoItem);
