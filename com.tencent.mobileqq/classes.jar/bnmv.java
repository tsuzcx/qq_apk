...
public class bnmv
{
  ...
  static
  {
    jdField_a_of_type_Bnhn = new bnmw();
  }
  
  private static int a(Context paramContext, String paramString, int paramInt, bioy parambioy)
  {
    int i = 2;
  ...
  public static void a(Context paramContext, bioy parambioy)
  {
    parambioy = bhlq.a(paramContext, 0);
    parambioy.setMessage(paramContext.getString(2131718703));
    parambioy.setPositiveButton(paramContext.getString(2131691651), new bnmx(paramContext));
    parambioy.setNegativeButton(paramContext.getString(2131692956), new bnmy(parambioy));
    try
    {
      if (!parambioy.isShowing()) {
        parambioy.show();
      }
      return;
    }
  ...
  /* Error */
  private static void a(bioy parambioy, String paramString)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   110: pop
    //   111: aload_0
    //   112: invokevirtual 300	bioy:a	()Landroid/app/Activity;
    //   115: astore_0
    //   116: aload_0
    //   117: ifnull -111 -> 6
    //   120: aload_0
  ...
  static void a(bioy parambioy, String... paramVarArgs)
  {
    if ((parambioy != null) && (parambioy.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        Object localObject1 = parambioy.a(parambioy.a());
        ...
        jdField_a_of_type_ComTencentBizPubaccountCustomWebView = parambioy.a();
        ...
        paramVarArgs = new QZoneWebViewJsHandleLogic.2(parambioy, localHashMap, str2, str3, paramVarArgs, str1, (String)localObject1);
        if (TextUtils.isEmpty((CharSequence)localObject2))
        {
          paramVarArgs.run();
          return;
        }
        ThreadManager.post(new QZoneWebViewJsHandleLogic.3((String)localObject2, localHashMap, parambioy, paramVarArgs), 8, null, false);
        return;
      }
      catch (Exception parambioy)
      {
        QZLog.e("QZoneWebViewJsHandleLogic", "shareMiniProgramFromQzone error", parambioy);
      }
    }
  }
  
  private static void a(WebViewPlugin paramWebViewPlugin, bioy parambioy, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (parambioy == null) || (paramVarArgs.length <= 0)) {}
    Object localObject5;
    Object localObject2;
    Object localObject3;
    Object localObject4;
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              paramVarArgs = parambioy.a().getUrl();
              if (!bnkq.a().a(paramVarArgs, (String)localObject1))
              {
            ...
            if (bool)
            {
              ...
              try
              {
                if (((String)localObject2).indexOf("uin=") != -1)
                {
                  ...
                  bmtd.a((Context)localObject4, bmtk.a(), paramWebViewPlugin, 0, 0, 0);
                  return;
                }
              }
        ...
        parambioy = parambioy.a((Activity)localObject4);
        if (!(parambioy instanceof bioz)) {
          break label1115;
        }
        i = ((bioz)parambioy).switchRequestCode(paramWebViewPlugin, (byte)3);
        if (TextUtils.isEmpty(paramVarArgs))
        {
          bmtd.a((Activity)localObject4, bmtk.a(), (String)localObject1, i);
          return;
        }
        bmtd.a((Activity)localObject4, bmtk.a(), (String)localObject1, i, paramVarArgs);
        return;
      ...
      localObject6 = parambioy.a((Activity)localObject4);
      if (!(localObject6 instanceof bioz)) {
        break label1120;
      }
      i = ((bioz)localObject6).switchRequestCode(paramWebViewPlugin, (byte)3);
      paramWebViewPlugin = bmtk.a();
      paramWebViewPlugin.jdField_a_of_type_JavaLangString = parambioy.a().getAccount();
      parambioy = new Bundle();
      parambioy.putString("source", paramVarArgs.getQueryParameter("source"));
      parambioy.putString("bypassparam", paramVarArgs.getQueryParameter("bypassparam"));
      parambioy.putAll(localBundle);
      bmtd.a((Activity)localObject4, paramWebViewPlugin, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject5, i, parambioy);
      return;
      if (!"mqzone://arouse/dynamicnickname".equalsIgnoreCase((String)localObject2)) {
        break;
      }
    } while ((parambioy == null) || (parambioy.a() == null) || (parambioy.a() == null));
    bmtd.a(parambioy.a(), parambioy.a().getAccount());
    return;
    if (((String)localObject2).startsWith("mqzone://arouse/uploadphoto"))
    {
      bmtd.a(paramWebViewPlugin, parambioy, parambioy.a(), parambioy.a().getAccount(), (String)localObject2);
      return;
    }
    if ((((String)localObject2).startsWith("mqzone://arouse/facade")) || (((String)localObject2).startsWith("mqzonev2://arouse/facade")))
    {
      a(parambioy.a(), (String)localObject2, 81, parambioy);
      return;
    }
    if (((String)localObject2).startsWith("mqzone://arouse/moodVoiceRecord"))
    {
      bmtd.b(paramWebViewPlugin, parambioy, parambioy.a(), parambioy.a().getAccount(), (String)localObject2);
      return;
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        i = bnmz.a(paramWebViewPlugin, parambioy, 4);
        bmtd.a((Activity)localObject4, bmtk.a(), paramVarArgs, i, bool);
        return;
      }
      bmtd.a((Activity)localObject4, bmtk.a(), paramVarArgs, -1, bool);
      return;
      label1084:
  ...
  public static boolean a(WebViewPlugin paramWebViewPlugin, bioy parambioy, String paramString, String... paramVarArgs)
  {
    if ("updateFeedContainer".equalsIgnoreCase(paramString)) {
      f(parambioy, paramVarArgs);
    }
    do
    {
      return true;
  ...
  private static void b(bioy parambioy, String... paramVarArgs)
  {
    if ((parambioy != null) && (parambioy.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      parambioy = new Intent("qzone.pickgamemates");
      parambioy.putExtra("gamemates", paramVarArgs[0]);
      BaseApplicationImpl.getApplication().sendBroadcast(parambioy);
      if (QLog.isColorLevel()) {
  ...
  private static void c(bioy parambioy, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambioy = new Intent("updateIsSpecialFollow");
      parambioy.putExtra("isSpecialFollow", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambioy);
      if (QLog.isColorLevel()) {
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleUpdateIsSpecialFollow catch an exception. ", parambioy);
    }
  }
  ...
  private static void d(bioy parambioy, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambioy = new Intent("showFollowActionSheet");
      parambioy.putExtra("followStatus", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambioy);
      if (QLog.isColorLevel()) {
        QLog.d("QZoneWebViewJsHandleLogic", 1, "followStatus = " + i);
      }
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleShowFollowActionSheet catch an exception. ", parambioy);
    }
  }
  
  private static void e(bioy parambioy, String... paramVarArgs)
  {
    Activity localActivity;
    if ((parambioy != null) && (parambioy.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localActivity = parambioy.a();
      if (bhny.a(localActivity, "com.tencent.weishi"))
      {
        parambioy = "";
        try
        {
          paramVarArgs = new JSONObject(paramVarArgs[0]).optString("schema");
          parambioy = paramVarArgs;
          if (!TextUtils.isEmpty(paramVarArgs))
          {
            parambioy = paramVarArgs;
            Intent localIntent = new Intent();
        ...
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, "handleClickWeiShiWidget catch an exception. weishi schema is " + parambioy, paramVarArgs);
          return;
        }
      }
    }
  ...
  private static void f(bioy parambioy, String... paramVarArgs)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            if (!(parambioy.a().getParent() instanceof RelativeLayout)) {
              continue;
            }
            ((RelativeLayout)parambioy.a().getParent()).setVisibility(8);
          }
        }
        catch (JSONException parambioy)
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, parambioy, new Object[0]);
          return;
        }
      }
    } while (!(parambioy.a().getParent() instanceof RelativeLayout));
    ((RelativeLayout)parambioy.a().getParent()).setVisibility(0);
  }
  
  private static void g(bioy parambioy, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0) && (localJSONArray != null) && (localJSONArray.length() == paramVarArgs.length()))
          {
            ...
            parambioy.a().setResult(-1, localIntent);
            parambioy.a().finish();
            if (QLog.isColorLevel())
            {
  ...
  private static void h(bioy parambioy, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    }
  ...
  private static void i(bioy parambioy, String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty(str1)) {
            ((StringBuilder)localObject2).append(bjwo.b).append("=").append(str1);
          }
          if (!TextUtils.isEmpty(paramVarArgs)) {
            ((StringBuilder)localObject2).append("&").append(bjwo.f).append("=").append(paramVarArgs);
          }
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            ((StringBuilder)localObject2).append("&").append(bjwo.c).append("=").append((String)localObject1);
          }
          if (!TextUtils.isEmpty(str2)) {
            ((StringBuilder)localObject2).append("&").append(bjwo.d).append("=").append(str2);
          }
          if (!TextUtils.isEmpty(str3)) {
            ((StringBuilder)localObject2).append("&").append(bjwo.i).append("=").append(str3);
          }
          if (!TextUtils.isEmpty(str4)) {
            ((StringBuilder)localObject2).append("&").append(bjwo.e).append("=").append(str4);
          }
          if (!TextUtils.isEmpty(str5)) {
            ((StringBuilder)localObject2).append("&").append(bjwo.B).append("=").append(str5);
          }
          ...
          bmtd.a((Bundle)localObject1);
          bjqz.a(parambioy.a(), (Bundle)localObject1);
          return;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("QZoneWebViewJsHandleLogic", 2, "json 解析异常", parambioy);
        }
      }
    }
  }
