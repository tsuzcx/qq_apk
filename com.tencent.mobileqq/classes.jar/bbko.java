...
{
  public bbko(TroopBarReplyActivity paramTroopBarReplyActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.k) {
        bcmc.a("reply_page", "fail", this.a.o, "4", "", "");
      }
      return;
      ...
      if (this.a.k) {
        bcmc.a("reply_page", "suc", this.a.o, "", ((StringBuffer)localObject).toString(), "");
      }
      paramBundle = this.a.getString(2131696747, new Object[] { Integer.valueOf(9992) });
    }
  }
