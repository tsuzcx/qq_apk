...
public class ayke
{
  ...
  private List<aykj> jdField_a_of_type_JavaUtilList;
  ...
  public ayke(String paramString, int paramInt)
  {
  ...
  private ayke a(aykj paramaykj)
  {
    if (paramaykj != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramaykj);
    }
  ...
  private void a(StringBuilder paramStringBuilder, int paramInt)
  {
    ...
    while (paramInt < m)
    {
      if ((paramStringBuilder.charAt(paramInt) == '<') && (paramInt < k - 2))
      {
        ...
        if ((i == 36) && (paramInt < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new aykh(paramStringBuilder.substring(paramInt, paramInt + 4), i, n));
            paramInt += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt + 6) == '>')
            {
              ...
              a(new ayki(paramStringBuilder.substring(paramInt, paramInt + 7), j, n));
              i = 2;
              if (i < 5)
              {
          ...
          else if (j == 250)
          {
            ...
            a(new aykh(paramStringBuilder.substring(paramInt, paramInt + 4), 10, n));
            paramInt += 4;
          }
        }
        else if (((i == 37) || (i == 38)) && (paramInt < k - 6))
        {
          a(new aykg(paramStringBuilder.substring(paramInt, paramInt + 7)));
          paramInt += 7;
        }
      }
      else
      {
        ...
        {
          a(new aykd(paramStringBuilder.substring(paramInt, paramInt + 2)));
          paramInt += 2;
          continue;
        }
        a(new aykf(String.valueOf(paramStringBuilder.charAt(paramInt))));
      }
      label637:
      paramInt += 1;
    }
  ...
  public ayke a(int paramInt)
  {
    ayke localayke = new ayke();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      aykj localaykj = (aykj)localIterator.next();
      if (localaykj.a() == paramInt) {
        localayke.a(localaykj);
      }
    }
    return localayke;
  }
  ...
  @NonNull
  public aykj a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (aykj)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
  ...
  public String a()
  {
    ...
    {
      aykj localaykj = (aykj)localIterator.next();
      if ((localaykj.a() == 0) || (localaykj.a() == 1)) {
        localStringBuilder.append(localaykj.a());
      }
    }
    return localStringBuilder.toString();
  }
  
  public ayke b(int paramInt)
  {
    ayke localayke = new ayke();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
  ...
  public String b()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localStringBuilder.append(((aykj)localIterator.next()).a());
    }
    return localStringBuilder.toString();
  }
