...
public class ainq
  extends ainh
  implements aiof, aios, aira, bcoq
{
  private int jdField_a_of_type_Int;
  private aioh jdField_a_of_type_Aioh;
  private airf jdField_a_of_type_Airf;
  private amsu jdField_a_of_type_Amsu = new ainx(this);
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new ainr(this));
  ...
  public ainq(Activity paramActivity)
  {
    super(paramActivity);
    ...
    this.jdField_a_of_type_Aioh = new aioh(localamvo.b("sp_mayknow_entry_list_recommend"), bcoo.a());
    int i;
    if (localamvo.b())
    {
      i = 2;
    ...
    label192:
    for (paramActivity = new aisd(paramActivity);; paramActivity = new airw(paramActivity))
    {
      this.jdField_a_of_type_Airf = paramActivity;
      this.jdField_a_of_type_Airf.a(new ains(this));
  ...
  {
    int i = this.jdField_a_of_type_Aioh.b(1);
    if (this.jdField_a_of_type_Aioh.a())
    {
      int m = bfyz.ai(a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
      int j = 0;
      ...
      {
        i = this.jdField_a_of_type_Aioh.b(1);
        k = i;
        if (QLog.isColorLevel()) {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      int i = this.jdField_a_of_type_Aioh.a(this.jdField_b_of_type_Int);
      if (a())
      {
        i = this.jdField_a_of_type_Aioh.b(i);
        if ((i == -1) || (paramBoolean2)) {
          i = a(paramBoolean1);
        }
        c(i);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Aioh.jdField_a_of_type_JavaUtilArrayList.size());
      }
  ...
  private boolean a()
  {
    ...
    amvo localamvo = (amvo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
    if (localamvo != null) {
      bool1 = localamvo.b("sp_mayknow_entry_list_recommend");
    }
    for (boolean bool1 = this.jdField_a_of_type_Aioh.a(bool1, bcoo.a());; bool1 = false)
    {
      if (bool1)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPagerAdapter.a(this.jdField_a_of_type_Aioh.jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Aioh.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Aioh.jdField_a_of_type_ArrayOfInt);
      }
      bool2 = bool1;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ContactsViewController", 2, "checkAndUpdateRecommendTabShow. mCurrentTabPos:" + this.jdField_b_of_type_Int + " isShowRecommendTab:" + this.jdField_a_of_type_Aioh.a() + " changed:" + bool1);
      return bool1;
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Airf.d();
    this.jdField_d_of_type_Int = paramInt;
    if (this.jdField_d_of_type_Int == 2) {}
    for (Object localObject = new aisd(this.jdField_a_of_type_AndroidAppActivity);; localObject = new airw(this.jdField_a_of_type_AndroidAppActivity))
    {
      this.jdField_a_of_type_Airf = ((airf)localObject);
      this.jdField_a_of_type_Airf.a(new aint(this));
      this.jdField_a_of_type_Airf.b();
      this.jdField_a_of_type_Airf.a(this.jdField_a_of_type_AndroidViewView);
      if (!this.jdField_c_of_type_Boolean) {
        break;
      }
      this.jdField_a_of_type_Airf.b(false);
      return;
    }
  }
  ...
  private static boolean b()
  {
    ...
    return (localapys != null) && (localapys.e());
  }
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      str = "";
      switch (this.jdField_a_of_type_Aioh.a(paramInt))
      {
      }
    }
    for (;;)
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator = ((SimpleSlidingIndicator)paramView.findViewById(2131377570));
    k();
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView = ((HeaderScrollView)paramView.findViewById(2131365020));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager = ((ContactsViewPager)paramView.findViewById(2131365023));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPagerAdapter = new ContactsViewPagerAdapter(((SplashActivity)a()).getSupportFragmentManager(), ((SplashActivity)a()).app, (BaseActivity)a(), this.jdField_a_of_type_Aioh.jdField_a_of_type_JavaUtilArrayList);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Aioh.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager.setOnPageChangeListener(new ainu(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Aioh.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Aioh.jdField_a_of_type_ArrayOfInt);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshCommonRefreshLayout = ((CommonRefreshLayout)paramView.findViewById(2131378047));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new ainv(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_Airf.a(paramView);
    if (b()) {
      n();
    }
    c(a(false));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView.setOnScrollListener(new ainw(this));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      amvo localamvo = (amvo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      if ((localamvo == null) || (localamvo.b("sp_mayknow_entry_list_recommend") == this.jdField_a_of_type_Aioh.a())) {
        break label251;
      }
    }
    label251:
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Airf.a(paramQQAppInterface);
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Airf.b(paramBoolean);
  ...
  public void f()
  {
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.a(2131365032, uex.a());
  ...
  public void g()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView != null)
    {
      View localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView.findViewById(2131371699);
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPagerAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager != null))
    {
      ...
      if ((i == this.jdField_a_of_type_Aioh.b(1)) || (i == this.jdField_a_of_type_Aioh.b(2)) || (i == this.jdField_a_of_type_Aioh.b(0))) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView.scrollTo(0, 0);
      }
    }
    this.h = false;
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Airf.a(bool);
    if (this.jdField_a_of_type_ComTencentMobileqqMiniEntryContactsMiniAppEntryManager != null) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setCurrentPosition(this.jdField_a_of_type_Aioh.b(3), false);
    }
  }
