...
public class ainq
  implements aior
{
  public static List<ainq> a;
  private int jdField_a_of_type_Int;
  private ainx jdField_a_of_type_Ainx;
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new ainw(this);
  ...
  public ainq(int paramInt1, int paramInt2, String arg3)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    aipj localaipj = aing.a(paramInt2);
    if (localaipj != null) {
      localaipj.b(0);
    }
    if ("effect".equals(???)) {
      if (localaipj != null) {
        this.jdField_a_of_type_Ainx = new ainx(paramInt2);
      }
    }
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        a(1);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new ainr(this));
      }
    }
  }
  
  private void a(aioq paramaioq, JSONObject paramJSONObject)
  {
    if (paramaioq != null) {
      paramaioq.a(paramJSONObject);
    }
  }
  ...
  public String a()
  {
    try
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Ainx != null)
        {
          this.jdField_a_of_type_Ainx.c();
          this.jdField_a_of_type_Ainx = null;
          return null;
        }
      }
  ...
  public JSONObject a(int paramInt, JSONObject paramJSONObject, aioq paramaioq)
  {
    int i;
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new ains(this, paramJSONObject, paramaioq));
  ...
  public JSONObject a(aioq paramaioq, JSONObject paramJSONObject)
  {
      ...
      try
      {
        if (paramJSONObject.optInt("N_R_OBJ") == this.jdField_a_of_type_Int)
        {
          ...
          if ("cs.audio_play.local".equals(str)) {
            return b(paramJSONObject, paramaioq);
          }
          ...
          if ("cs.audio_load.local".equals(str)) {
            return c(paramJSONObject, paramaioq);
          }
          ...
          if ("cs.audio_seek.local".equals(str)) {
            return a(paramJSONObject.optInt("seek"), paramJSONObject, paramaioq);
          }
          if ("cs.audio_src.local".equals(str)) {
            return a(paramJSONObject.optString("src"), paramJSONObject, paramaioq);
          }
          ...
          if ("cs.audio_destroy.local".equals(str)) {
            return b(paramaioq, paramJSONObject);
          }
          if ("cs.audio_onend.local".equals(str)) {
            return e(paramJSONObject, paramaioq);
          }
          ...
          {
            paramaioq = a(paramJSONObject, paramaioq);
            return paramaioq;
          }
        }
      }
      catch (Throwable paramaioq)
      {
        QLog.e("CmGameAudioPlayer", 1, "audio failed", paramaioq);
      }
    }
    return null;
  }
  
  public JSONObject a(String paramString, JSONObject paramJSONObject, aioq paramaioq)
  {
      ...
      try
      {
        ...
        if (localaipj != null)
        {
          ...
          for (;;)
          {
            ...
            a(2);
            return paramJSONObject;
            paramString = ailn.a(paramString, localaipj.a(), str1, false);
          }
        }
  ...
  public JSONObject a(JSONObject paramJSONObject, aioq paramaioq)
  {
    try
    {
      if (paramJSONObject.has("src")) {
        a(paramJSONObject.optString("src"), paramJSONObject, paramaioq);
      }
      ...
      if (paramJSONObject.has("currentTime")) {
        d(paramJSONObject, paramaioq);
      }
      return paramJSONObject;
    }
    catch (Throwable paramaioq)
    {
      QLog.e("CmGameAudioPlayer", 1, paramaioq, new Object[0]);
    }
    return paramJSONObject;
  }
  ...
  public JSONObject a(boolean paramBoolean, float paramFloat1, float paramFloat2, JSONObject paramJSONObject)
  {
    ...
    } while (this.jdField_a_of_type_Ainx == null);
    Object localObject = this.jdField_a_of_type_Ainx;
    if ((paramBoolean) || ((Float.compare(paramFloat1, 0.0F) == 0) && (Float.compare(paramFloat2, 0.0F) == 0))) {}
    for (int i = 0;; i = 1)
    {
      ((ainx)localObject).a(i, BaseActivity.sTopActivity.getAppInterface());
      return paramJSONObject;
    }
  }
  ...
  public JSONObject b(aioq arg1, JSONObject paramJSONObject)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
  ...
  public JSONObject b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      if (paramJSONObject.optBoolean("auto", true)) {
        this.jdField_a_of_type_Ainx.a();
      } else {
        this.jdField_a_of_type_Ainx.a(i, null);
      }
    }
  }
  
  public JSONObject b(JSONObject paramJSONObject, aioq paramaioq)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      i = a();
    ...
    while (this.jdField_a_of_type_Ainx == null) {
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new aint(this));
        }
    ...
    a(true);
    return this.jdField_a_of_type_Ainx.a(paramaioq, paramJSONObject);
  }
  ...
  public JSONObject c(JSONObject paramJSONObject, aioq paramaioq)
  {
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && ((a() == 2) || (a() == 6)))
    {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new ainu(this, paramJSONObject, paramaioq));
  ...
  public JSONObject d(JSONObject paramJSONObject, aioq paramaioq)
  {
    int i;
  ...
  public JSONObject e(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Ainx != null)
    {
      this.jdField_a_of_type_Ainx.c(paramJSONObject.optInt("id"), null);
      this.jdField_a_of_type_Ainx.a(paramJSONObject);
    }
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
  ...
  public JSONObject e(JSONObject paramJSONObject, aioq paramaioq)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new ainv(this, paramaioq, paramJSONObject));
    }
    return null;
  }
  ...
  public JSONObject f(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Ainx != null)
    {
      if (paramJSONObject.optBoolean("audo", true)) {
        this.jdField_a_of_type_Ainx.b();
      }
    }
    else {
      return paramJSONObject;
    }
    this.jdField_a_of_type_Ainx.b(paramJSONObject.optInt("id"), null);
    return paramJSONObject;
  }
}
