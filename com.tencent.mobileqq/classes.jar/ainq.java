...
public class ainq
  extends aiml
{
  protected ainq(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("PhotoListActivity", 2, "PhotoListLogicDataline isConfirmed=" + paramBoolean + " allowUploadInXGTime=" + ayyu.b);
        }
        if ((!bdee.b(BaseApplicationImpl.getContext())) || (paramBoolean) || (i == 0)) {
          break;
        }
        paramArrayList = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131719738);
        paramIntent = new PhotoListLogicDataline.1(this, paramIntent, i2, (String)localObject1, (String)localObject2);
        if (bevd.a(this.mActivity, 4, new ainr(this, paramIntent))) {
          bdcd.a(this.mActivity, 232, null, paramArrayList, new ains(this, paramIntent), new aint(this)).show();
        }
        if (QLog.isColorLevel()) {
      ...
      azmj.b(null, "CliOper", "", "", "0X8009AB0", "0X8009AB0", i2, 0, (String)localObject1, (String)localObject2, "", "");
      return;
    }
  }
}
