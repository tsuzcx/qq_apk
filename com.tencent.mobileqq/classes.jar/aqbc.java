  ...
  extends aqbe
{
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!bbbr.a(localRecentUser.uin)) && (localRecentUser.getType() != 1008) && (localRecentUser.getType() != 1005) && ((localRecentUser.getType() != 1006) || (a(aqau.h))) && (localRecentUser.getType() != 1009) && (localRecentUser.getType() != 1021) && (localRecentUser.getType() != 10004) && (localRecentUser.getType() != 7000) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 0) || (!naz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType())))) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    alsz.a(paramQQAppInterface, this.jdField_a_of_type_AndroidOsBundle.getString("forward_ark_app_name"), this.jdField_a_of_type_AndroidOsBundle.getString("forward_ark_app_view"));
  }
  ...
  protected boolean a(String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      paramString2 = (ArkAppMessage)alsw.a(2, paramString2, this.jdField_a_of_type_AndroidOsBundle, paramString1);
      ...
      for (;;)
      {
        ...
        {
          aanz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo, paramString1, paramInt1);
          return true;
          label602:
  ...
  protected void d()
  {
    ...
    {
      return;
      axqy.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, str1, ForwardUtils.b(i), str2, "");
  ...
  public void e()
  {
    ...
    if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2))) {
      aloy.a(str1, str3, str2, new aqbd(this));
    }
  }
}
