...
public abstract class aqbc
  implements DialogInterface.OnDismissListener, aqar, aqas, aqbt
{
  ...
  public long a;
  ajvl jdField_a_of_type_Ajvl = new aqbf(this);
  public Activity a;
  public Context a;
  ...
  public aqbc(Intent paramIntent)
  {
  ...
  private void H()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131719410);
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("app_name");
    Object localObject1 = localObject2;
    if (str != null) {
      localObject1 = (String)localObject2 + str;
    }
    localObject2 = new aqbd(this);
    this.jdField_a_of_type_Xnz.a((String)localObject1, (DialogInterface.OnClickListener)localObject2);
    this.jdField_a_of_type_Xnz.a((DialogInterface.OnClickListener)localObject2);
  ...
  private void K()
  {
    aqdb localaqdb = new aqdb(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Bbgg = localaqdb;
    if (!d()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      localaqdb.b(210);
      localaqdb.a(a());
      localaqdb.setCanceledOnTouchOutside(false);
      localaqdb.a(c(), d(), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(a()), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(b()), a(), b());
      a(localaqdb);
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        localaqdb.show();
      }
      this.jdField_a_of_type_Bbgg.setOnDismissListener(this);
      return;
    }
  }
  ...
  private void a(Bundle paramBundle, int paramInt, String paramString)
  {
    ...
    {
      axqw.b(null, "dc00899", str, "", "video_tab", "videoark_share", 0, 0, paramString, paramBundle, "", "");
      return;
      paramBundle = l + "";
      break;
      bool = false;
  ...
  private void a(bbhl parambbhl)
  {
    ...
    String str3 = ajyc.a(2131704735);
    Object localObject = str1;
    if (str1.startsWith(str3)) {
      localObject = str1.substring(str3.length());
    }
    localObject = ((String)localObject).trim();
    parambbhl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, str2, i, (String)localObject, bool);
    return;
    if (((List)localObject).size() == 1)
    {
      localObject = (ResultRecord)((List)localObject).get(0);
      parambbhl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, ((ResultRecord)localObject).jdField_a_of_type_JavaLangString, ((ResultRecord)localObject).a(), ((ResultRecord)localObject).jdField_b_of_type_JavaLangString, false);
      return;
    }
    parambbhl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, (List)localObject, true);
  }
  ...
  private void a(MessageForPic paramMessageForPic, String paramString)
  {
    ...
    for (Object localObject = Long.valueOf(paramMessageForPic.uniseq);; localObject = "")
    {
      ...
      if (paramMessageForPic != null)
      {
        ...
        localObject = new Bundle();
        ((Bundle)localObject).putBoolean("extra.EXTRA_NOT_CLEAR_TOP", true);
        a((Bundle)localObject, paramString, aehy.a(paramMessageForPic));
        D();
      }
      return;
    }
  ...
  private void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_AndroidContentIntent != null) && (("ChatActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))) || ("SplashActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))))) {
      advu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F55", paramString);
    }
    ...
    advu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F56", paramString);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      axqw.b(null, "dc00899", str, "", "music_tab", "musicark_share", 0, 0, paramString, "", "", "");
      return;
      bool = false;
      break;
      str = "Grp_AIO";
  ...
  public void A()
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A7EB", "0X800A7EB", i, 0, "", "", String.valueOf(j), str);
  }
  ...
  public void B()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      int m = a(str3, k);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", str3, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
      if (QLog.isColorLevel())
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", (String)localObject, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
        if (QLog.isColorLevel()) {
  ...
  public void C()
  {
    ...
    int k = a(i);
    Object localObject1 = "";
    if ((this.jdField_a_of_type_Bbgg instanceof bbhb))
    {
      localObject1 = ((bbhb)this.jdField_a_of_type_Bbgg).getInputValue();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          {
            axqw.b(localQQAppInterface, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
            if (QLog.isColorLevel()) {
            ...
            localObject1 = str1;
            break label230;
            if (!(this.jdField_a_of_type_Bbgg instanceof aqdb)) {
              break;
            }
            localObject1 = ((aqdb)this.jdField_a_of_type_Bbgg).getInputValue();
            break;
          }
        }
      }
      else
      {
        ...
        localObject1 = "1";
        axqw.b((QQAppInterface)localObject2, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
        if (QLog.isColorLevel()) {
  ...
  public void D()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BE9", "0X8009BE9", this.jdField_b_of_type_Int, 0, "", "", "", "");
  }
  
  public void E()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BEA", "0X8009BEA", this.jdField_b_of_type_Int, 0, "", "", "", "");
    C();
  }
  ...
  public void F()
  {
    ...
    do
    {
      ...
      axqw.b(null, "dc00898", "", "", "0X800A27", "0X800A27", 0, 0, "", ForwardUtils.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype")), str, ForwardUtils.b(i));
  ...
  protected final DialogInterface.OnClickListener a()
  {
    if (this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new aqbg(this);
    }
  ...
  protected View.OnClickListener a(aqbo paramaqbo)
  {
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    if (this.jdField_a_of_type_AndroidViewView$OnClickListener == null) {
      this.jdField_a_of_type_AndroidViewView$OnClickListener = new aqbj(this, str, paramaqbo);
    }
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!bbbd.a(localRecentUser.uin)) && (localRecentUser.getType() != 1020) && (localRecentUser.getType() != 1008) && (localRecentUser.getType() != 1005) && ((localRecentUser.getType() != 1006) || (a(aqas.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 1009) && (localRecentUser.getType() != 1021) && (localRecentUser.getType() != 1001) && (localRecentUser.getType() != 10002) && (localRecentUser.getType() != 10004) && (localRecentUser.getType() != 1022) && (localRecentUser.getType() != 1032) && (localRecentUser.getType() != 1033) && (localRecentUser.getType() != 1034) && (localRecentUser.getType() != 7000) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1) || (!a(localRecentUser.uin))) && ((localRecentUser.getType() != 0) || (!nbc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) && (((localRecentUser.getType() != 1004) && (localRecentUser.getType() != 1000)) || (this.jdField_b_of_type_Boolean))) {
  ...
  public void a(int paramInt)
  {
    if (this.jdField_b_of_type_Bcpq == null) {
      this.jdField_b_of_type_Bcpq = new bcpq(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
    }
  ...
  {
    if (paramBoolean) {
      aywk.a((URLDrawable)paramDrawable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
    }
    if (paramDrawable == null) {}
    while (paramBoolean) {
      return;
    }
    paramDrawable.setBounds(bbdr.a(paramDrawable, 36, 100, this.jdField_a_of_type_Float));
  }
  ...
  {
    bgkh.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, paramAIOImageProviderService, paramAIORichMediaData, 19001, 4);
  }
  ...
  protected void a(Bundle paramBundle, String paramString, er paramer)
  {
    ...
    paramBundle = "";
    if ((this.jdField_a_of_type_Bbgg instanceof bbhb)) {
      paramBundle = ((bbhb)this.jdField_a_of_type_Bbgg).getInputValue();
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(paramBundle))
      {
        ...
        int i = localajuo.a().b(paramString, localBundle, paramer);
        if (QLog.isColorLevel()) {
      ...
      return;
      if ((this.jdField_a_of_type_Bbgg instanceof aqdb)) {
        paramBundle = ((aqdb)this.jdField_a_of_type_Bbgg).getInputValue();
      }
    }
  }
  
  public void a(bbgg parambbgg) {}
  ...
  protected final void a(String paramString, bbgg parambbgg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "addSourceNameView start! sourceName =" + paramString);
    }
    if ((paramString == null) || ("".equals(paramString)) || (parambbgg == null)) {
      return;
    }
    ...
    parambbgg.addView(localTextView);
  }
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    localBundle.putString("uinname", ajyc.a(2131704734) + paramString2);
    a(aqas.jdField_d_of_type_JavaLangInteger.intValue(), localBundle);
  }
  ...
  public boolean a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_c_of_type_Boolean) || ((this instanceof aqfo)) || ((this instanceof aqbp)) || (this.jdField_a_of_type_AndroidOsBundle.getInt("cmshow_game_id") > 0));
    ...
    if (paramInt1 == 1) {
      if (((bakk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramString, true).jdField_a_of_type_Boolean)
      {
        bool1 = false;
        bool2 = bool1;
        if (bool1)
        {
          bool2 = bool1;
          if ((this instanceof aqce))
          {
            paramString = (aqce)this;
            bool2 = bool1;
  ...
  protected final DialogInterface.OnClickListener b()
  {
    if (this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new aqbh(this);
    }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false))
      {
        ...
        paramInt = localajuo.a().a(str, localBundle, localaqbm);
      ...
      for (;;)
      {
        ...
        b(localIntent);
        localBundle.putAll(localIntent.getExtras());
        paramInt = localajuo.a().b(str, localBundle, localaqbm);
        a(localBundle, str, null);
        break label257;
        label359:
        break;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle != null) {
      a(paramBundle.getInt("key_forward_ability_type", aqas.a.intValue()), paramBundle);
    }
  }
  
  protected void b(String paramString) {}
  
  protected final void b(String paramString, bbgg parambbgg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "updateImageView: filepath=" + paramString);
    }
    ThreadManager.post(new ForwardBaseOption.8(this, paramString, parambbgg), 8, null, false);
    if (QLog.isColorLevel()) {
  ...
  protected boolean b(String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Bbgg instanceof bbhb))
    {
      str = ((bbhb)this.jdField_a_of_type_Bbgg).getInputValue();
      if (TextUtils.isEmpty(str)) {
        break label270;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (!(this instanceof aqgb)) {
        adgf.a().a((SessionInfo)localObject, str, i);
      }
      return true;
      if (!(this.jdField_a_of_type_Bbgg instanceof aqdb)) {
        break;
      }
      str = ((aqdb)this.jdField_a_of_type_Bbgg).getInputValue();
      break;
      label241:
  ...
  protected final DialogInterface.OnClickListener c()
  {
    if (this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new aqbi(this);
    }
  ...
  public void c()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "0", "", "", "");
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajyc.a(2131704727));
  ...
  protected void c(String paramString)
  {
    ...
    Object localObject2 = ((yak)localObject1).a(Long.parseLong(paramString));
    ((yak)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, (DeviceInfo)localObject2, false);
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false)) {
  ...
  protected void d(int paramInt)
  {
    ...
    x();
    aqbe localaqbe = new aqbe(this);
    if (this.jdField_a_of_type_Xoc == null) {
      this.jdField_a_of_type_Xoc = new xoc(this.jdField_a_of_type_AndroidAppActivity);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Xoc.a((String)localObject, localaqbe);
      this.jdField_a_of_type_Xoc.a(2131692230);
      localObject = this.jdField_a_of_type_Xoc;
      boolean bool;
      if (paramInt == 0)
      {
        bool = true;
        ((xoc)localObject).a(bool);
        this.jdField_a_of_type_Xoc.a(2131719498);
        this.jdField_a_of_type_Xoc.b(0);
        this.jdField_a_of_type_Xoc.c(2131719499);
        this.jdField_a_of_type_Xoc.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131694894), localaqbe);
      }
      try
      {
        this.jdField_a_of_type_Xoc.show();
        return;
  ...
  public void d(String paramString)
  {
    ...
    do
    {
      ...
      axqw.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, paramString, ForwardUtils.b(i), str, "");
    } while (!QLog.isColorLevel());
  ...
  protected boolean e()
  {
    ...
    if ((this.jdField_a_of_type_Xoc != null) && (this.jdField_a_of_type_Xoc.isShowing())) {
      this.jdField_a_of_type_Xoc.dismiss();
    }
    x();
    return true;
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A220", "0X800A220", 0, 0, "0", "", "", "");
    }
    B();
  }
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_Bbgg instanceof bbfx)) {
      ((bbfx)this.jdField_a_of_type_Bbgg).a(0);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Bbgg instanceof bbfx)) {
      ((bbfx)this.jdField_a_of_type_Bbgg).a(1);
    }
  ...
  protected boolean k()
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajvk)localObject).a();
  ...
  public final void l()
  {
    ...
    if (i == 0)
    {
      ...
      if ((i == 27) || (i == 39))
      {
        this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
        this.jdField_a_of_type_Bbgg.setMessage("");
        this.jdField_a_of_type_Bbgg.setNegativeButton(2131690596, b());
        this.jdField_a_of_type_Bbgg.setPositiveButton(2131690745, a());
        this.jdField_a_of_type_Bbgg.show();
      }
    }
    for (;;)
    {
      if ((this.jdField_a_of_type_Bbgg instanceof bbhl)) {
        a((bbhl)this.jdField_a_of_type_Bbgg);
      }
      Object localObject1 = d();
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        this.jdField_a_of_type_Bbgg.setEditLint((String)localObject1);
      }
      if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("miniAppNeedOnlyPreview", false))
      {
        ((bbfx)this.jdField_a_of_type_Bbgg).a(c());
        ((bbfx)this.jdField_a_of_type_Bbgg).a();
      }
      this.jdField_a_of_type_Bbgg.setOnDismissListener(this);
      this.jdField_a_of_type_Bbgg.adjustTitle();
      b();
      this.jdField_a_of_type_Bbgg.setMsgMaxLineWithEnd(this.jdField_a_of_type_JavaLangString, 3);
      if (a(this.jdField_a_of_type_Bbgg)) {
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.getInt(jdField_e_of_type_JavaLangString, 0) == 1) {
        this.jdField_a_of_type_Bbgg.setPreviewImageScaleType(true);
      }
      if (this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        break;
      }
      this.jdField_a_of_type_Bbgg.show();
      return;
      this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), d(), a(), b(), a(), b());
      continue;
      if (i == 1)
      {
        m();
        ...
        this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b());
        continue;
      }
      if (i == 2)
      {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
          altd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, "AIOArkSdkSelectSend", 1, 0, 0L, 0L, 0L, (String)localObject2, "");
        }
        label690:
        this.jdField_a_of_type_Bbgg.setMessage("");
        this.jdField_a_of_type_Bbgg.setNegativeButton(2131690596, b());
        ...
        this.jdField_a_of_type_Bbgg.show();
        continue;
        this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
        ...
        localObject1 = (bbhb)this.jdField_a_of_type_Bbgg;
        ((bbhb)localObject1).b();
        ((bbhb)localObject1).getEditText().setHint(ajyc.a(2131704729));
        continue;
        if (i == 3)
        {
          this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          continue;
        }
        if (i == 4)
        {
          ...
          this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), (String)localObject1, (String)localObject2, (ArrayList)localObject3, null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          continue;
        }
        if (i == 5)
        {
          i = this.jdField_a_of_type_AndroidOsBundle.getInt("key_hiboom_id");
          this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), "", null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          localObject1 = new HiBoomTextView(this.jdField_a_of_type_AndroidAppActivity);
          ((HiBoomTextView)localObject1).setHiBoom(i, 0, aqxh.jdField_a_of_type_Aqxa);
          ((HiBoomTextView)localObject1).setText(this.jdField_a_of_type_JavaLangString);
          ((HiBoomTextView)localObject1).setMaxSize(aqxh.jdField_a_of_type_Int);
          localObject2 = new LinearLayout.LayoutParams(500, 500);
          ((LinearLayout.LayoutParams)localObject2).gravity = 17;
          this.jdField_a_of_type_Bbgg.addView((View)localObject1, (LinearLayout.LayoutParams)localObject2);
          continue;
        }
        this.jdField_a_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
      }
  ...
  protected boolean m()
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajxn)localObject).e();
      if (localObject != null)
      {
  ...
  protected boolean o()
  {
    ...
    do
    {
      ...
      {
        bool1 = bool2;
        if (((yak)localObject).a())
        {
          localObject = ((yak)localObject).a();
          bool1 = bool2;
          if (localObject != null)
          {
            bool1 = bool2;
  ...
  protected void q()
  {
    ...
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8009AAE", "0X8009AAE", i, 0, "", "", "", "");
      return;
      label80:
      if (j == 1) {
        i = 2;
  ...
  protected void t()
  {
    this.jdField_a_of_type_Bbgg.setImageOnClickListener(a(new aqbl(this)));
  }
  ...
  protected void v()
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004047", "0X8004047", 0, 0, "", "", "", "");
  }
