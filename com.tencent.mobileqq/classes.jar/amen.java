...
public class amen
{
  ...
  public static FullMessageSearchResult.SearchResultItem a(QQAppInterface paramQQAppInterface, awbw paramawbw, Cursor paramCursor, String paramString1, int paramInt, String paramString2, amel paramamel)
  {
    ...
    {
      if ((paramamel.c == 3) || (paramamel.c == 2)) {
        return null;
      }
    ...
    for (;;)
    {
      ...
      if (paramInt != 0)
      {
        ...
        {
          paramString1 = (MessageRecord)paramawbw.a(MessageRecord.class, null, paramCursor);
              ...
              if (bool)
              {
                ...
                if (TextUtils.isEmpty(paramString2))
                {
                  ...
                  if ((localObject instanceof AbsStructMsg))
                  {
                    ...
                    paramString1 = paramamel.a;
                    paramawbw = paramQQAppInterface;
                    if (paramString1 == null) {
                      break;
                    }
