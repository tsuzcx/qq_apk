...
public class pvf
{
  ...
  public static List<BaseArticleInfo> a(List<BaseArticleInfo> paramList)
  {
    ...
    if (i < j)
    {
      ...
      if (!pay.h(localBaseArticleInfo1)) {
      ...
      for (;;)
      {
        ...
        while ((i + 1 < j) && (pay.a(localBaseArticleInfo1, (BaseArticleInfo)paramList.get(i + 1))))
        {
        ...
        if ((pay.l(localBaseArticleInfo1)) && (localArticleInfo.mGroupSubArticleList.size() >= 1))
        {
          localArrayList.add(localArticleInfo);
          if (QLog.isColorLevel()) {
            QLog.d("PolymericSmallVideo_" + pvf.class.getSimpleName(), 2, localStringBuilder.toString());
          }
        }
    ...
    if ((localArrayList.size() > 1) && (pay.j((BaseArticleInfo)localArrayList.get(localArrayList.size() - 1)))) {
  ...
  static void a(BaseArticleInfo paramBaseArticleInfo)
  {
    if ((paramBaseArticleInfo.mNewPolymericInfo != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      try
      {
        ...
        {
          localrdn = (rdn)((Iterator)localObject).next();
          ...
          localArticleInfo.mAlgorithmID = localrdn.b;
          localArticleInfo.innerUniqueID = localrdn.g;
          localArticleInfo.mArticleContentUrl = localrdn.jdField_d_of_type_JavaLangString;
          localArticleInfo.mSubscribeID = localrdn.e;
          if (localrdn.jdField_c_of_type_Int == 1)
          {
            bool = true;
            localArticleInfo.mIsPolymericGallery = bool;
            localArticleInfo.mGalleryPicNumber = localrdn.jdField_d_of_type_Int;
            localArticleInfo.mSinglePicture = pay.a(localrdn.jdField_c_of_type_JavaLangString);
            if (localrdn.jdField_a_of_type_Rdq != null)
            {
              localArticleInfo.mVideoCoverUrl = pay.a(localrdn.jdField_c_of_type_JavaLangString);
              localArticleInfo.mVideoVid = localrdn.jdField_a_of_type_Rdq.a;
            }
            localArticleInfo.mNewPolymericInfo = new rdm();
      ...
      catch (Exception localException1)
      {
        try
        {
          for (;;)
          {
            ...
            localArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.add((rdn)localrdn.clone());
            if (pgb.g(paramBaseArticleInfo))
            {
              localrdn.jdField_a_of_type_Boolean = true;
  ...
  public void a(Integer paramInteger, List<Long> paramList)
  {
    ...
    for (;;)
    {
      if (i < k)
      {
        localObject1 = this.jdField_a_of_type_Ptv.a(paramInteger, (Long)paramList.get(i));
  ...
  public void a(Integer paramInteger, List<ArticleInfo> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        paramInteger = this.jdField_a_of_type_Ptv.a(paramInteger.intValue(), 10, localArticleInfo1.mRecommendSeq, true).iterator();
        while (paramInteger.hasNext())
        {
