...
public class pvf
{
  ...
  private static pvf a;
  
  static
  {
    jdField_a_of_type_JavaLangString = pvf.class.getName();
    jdField_a_of_type_JavaLangObject = new Object();
  }
  
  public static pvf a()
  {
    if (jdField_a_of_type_Pvf == null) {}
    try
    {
      if (jdField_a_of_type_Pvf == null) {
        jdField_a_of_type_Pvf = new pvf();
      }
      return jdField_a_of_type_Pvf;
    }
    finally {}
  }
  ...
  public void a(List<Long> paramList, tcr paramtcr)
  {
    oidb_0xc90.ReqBody localReqBody = new oidb_0xc90.ReqBody();
    localReqBody.uint64_community_bid.set(paramList);
    nir.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), new pvh(this, paramtcr), localReqBody.toByteArray(), "OidbSvc.0xc90", 3216, 1, null, 0L);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    nir.a((AppInterface)BaseApplicationImpl.getApplication().getRuntime(), new pvg(this, paramBoolean), localReqBody.toByteArray(), "OidbSvc.0xb7e", 2942, 0, null, 0L);
  }
}
