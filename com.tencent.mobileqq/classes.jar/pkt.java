...
public class pkt
  extends pkl<DynamicChannelDataModel>
{
  ...
  protected TemplateBean a(DynamicChannelDataModel paramDynamicChannelDataModel)
  {
    ...
    if ((paramDynamicChannelDataModel.mTemplateBean != null) && (!((teh)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getTemplateFactory()).a(paramDynamicChannelDataModel.mTemplateBean))) {
    ...
    {
      localJSONObject = pkn.a(paramDynamicChannelDataModel.proteusData);
      localTemplateBean = pkn.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, localJSONObject, ReadInJoyDynamicChannelBaseFragment.a(paramDynamicChannelDataModel.channelID));
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, DynamicChannelDataModel paramDynamicChannelDataModel, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        if (!localTemplateBean.equals(localObject))
        {
          ...
          if (paramDynamicChannelDataModel != null)
          {
            paramDynamicChannelDataModel.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841683));
    ...
    if (localTemplateBean != null) {
      pfr.a((Container)localObject, paramDynamicChannelDataModel, localTemplateBean);
    }
    pfr.a((Container)localObject, paramVafContext, localTemplateBean);
    bkpj.a();
  }
