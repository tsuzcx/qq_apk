...
public class ydh
  implements Runnable
{
  public ydh(VideoFramesRetriever paramVideoFramesRetriever) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ydi localydi;
        localObject2 = VideoFramesRetriever.a(this.a).getFrameAtTime((localydi.jdField_a_of_type_Int + localydi.b) / 2 * 1000L);
        if (localObject2 == null)
        {
          ...
          localydi = (ydi)VideoFramesRetriever.a(this.a).take();
        ...
        if (((Bitmap)localObject2).getWidth() > ((Bitmap)localObject2).getHeight())
        {
          ...
          ((FramesProcessor.Frame)localObject2).jdField_a_of_type_Int = (localydi.jdField_a_of_type_Int / VideoFramesRetriever.b(this.a));
          ...
          VideoFramesRetriever.a(this.a).remove(Integer.valueOf(localydi.jdField_a_of_type_Int));
          continue;
        }
        int i = 0;
      }
