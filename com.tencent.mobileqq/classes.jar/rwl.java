...
public class rwl
{
  ...
  private static ArrayList<rwo> jdField_a_of_type_JavaUtilArrayList;
  private static AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private static JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private static rwp jdField_a_of_type_Rwp;
  ...
  private static ArrayList<rwo> a()
  {
    ...
    try
    {
      ...
      {
        rwo localrwo = new rwo();
        Object localObject = (JSONObject)localJSONArray.get(i);
        localrwo.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("vid");
        localrwo.jdField_a_of_type_Long = ((JSONObject)localObject).getLong("bitrate");
        localrwo.jdField_b_of_type_Long = ((JSONObject)localObject).getLong("timeout_ms");
        localrwo.jdField_a_of_type_Float = Float.valueOf(((JSONObject)localObject).getString("hevc_level")).floatValue();
        localrwo.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("max_hashdiff");
        localrwo.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("tag");
        localObject = ((JSONObject)localObject).getJSONArray("frameInfo");
        int j = 0;
        while (j < ((JSONArray)localObject).length())
        {
          rww localrww = new rww();
          JSONObject localJSONObject = (JSONObject)((JSONArray)localObject).get(j);
          localrww.jdField_a_of_type_Int = localJSONObject.getInt("index");
          localrww.jdField_a_of_type_Long = localJSONObject.getLong("serverHash");
          localrwo.jdField_a_of_type_JavaUtilArrayList.add(localrww);
          j += 1;
        }
        localArrayList.add(localrwo);
        i += 1;
      }
  ...
  private static boolean a()
  {
    ...
    //   0: ldc 219
    //   2: ldc 221
    //   4: invokestatic 226	bmqa:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   63: putstatic 37	rwl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   66: getstatic 37	rwl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   69: ldc 241
    //   71: invokevirtual 68	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   74: astore 5
    //   76: getstatic 37	rwl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   79: ldc 243
    //   81: invokevirtual 102	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   84: istore_0
    //   85: getstatic 37	rwl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   88: ldc 245
    ...
    //   103: ifne -51 -> 52
    //   106: aconst_null
    //   107: invokestatic 250	bgnt:a	(Landroid/content/Context;)I
    //   110: iconst_1
    ...
    //   130: ldc 254
    //   132: ldc 221
    //   134: invokestatic 226	bmqa:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   192: putstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   195: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   198: ldc_w 258
    //   201: ldc 221
    //   203: invokevirtual 261	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   206: astore 6
    //   208: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   211: ldc_w 263
    //   214: iconst_0
    //   215: invokevirtual 267	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   218: istore_2
    //   219: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   222: ldc_w 269
    //   225: iconst_0
    ...
    //   274: ifne +48 -> 322
    //   277: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   280: ldc_w 258
    //   283: aload 5
    //   285: invokevirtual 278	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   288: pop
    //   289: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   292: ldc_w 263
    //   295: iconst_0
    //   296: invokevirtual 281	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   299: pop
    //   300: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   303: ldc_w 269
    //   306: iconst_0
    //   307: invokevirtual 281	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   310: pop
    //   311: ldc 254
    //   313: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   316: invokevirtual 282	org/json/JSONObject:toString	()Ljava/lang/String;
    //   319: invokestatic 285	bmqa:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   322: invokestatic 287	rwl:a	()Ljava/util/ArrayList;
    //   325: putstatic 288	rwl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   328: getstatic 288	rwl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   331: ifnull +71 -> 402
    //   334: iconst_1
    //   335: istore 4
    //   337: iload 4
    ...
    //   347: putstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   350: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   353: ldc_w 258
    //   356: aload 5
    //   358: invokevirtual 278	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   361: pop
    //   362: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   365: ldc_w 263
    //   368: iconst_0
    //   369: invokevirtual 281	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   372: pop
    //   373: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   376: ldc_w 269
    //   379: iconst_0
    //   380: invokevirtual 281	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   383: pop
    //   384: ldc 254
    //   386: getstatic 135	rwl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   389: invokevirtual 282	org/json/JSONObject:toString	()Ljava/lang/String;
    //   392: invokestatic 285	bmqa:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   395: goto -73 -> 322
    //   398: astore 5
    //   400: iconst_0
    //   401: ireturn
  ...
  public static void b()
  {
    ...
    if ((jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)) && (jdField_a_of_type_Rwp != null))
    {
      jdField_a_of_type_Rwp.b();
      jdField_a_of_type_Rwp = null;
    }
  }
  
  private static void b(Context paramContext, rwo paramrwo, int paramInt, String paramString, HashMap<Integer, rww> paramHashMap)
  {
    ...
    try
    {
      ...
      localJSONObject.put("subversion", "8.4.1");
      if (jdField_a_of_type_OrgJsonJSONObject == null) {
        break label631;
      }
      localObject = jdField_a_of_type_OrgJsonJSONObject.optString("version");
      localJSONObject.put("server_version", localObject);
      localJSONObject.put("video_tag", paramrwo.jdField_b_of_type_JavaLangString);
      localJSONObject.put("video_vid", paramrwo.jdField_a_of_type_JavaLangString);
      localJSONObject.put("video_bitrate", paramrwo.jdField_a_of_type_Long);
      localJSONObject.put("video_width", paramrwo.jdField_b_of_type_Int);
      localJSONObject.put("video_height", paramrwo.c);
      ...
      if (bool1)
      {
        ...
        {
          localObject = (rww)paramString.next();
          if (((rww)localObject).jdField_b_of_type_Int > paramrwo.jdField_a_of_type_Int) {
            bool1 = false;
          }
          i += ((rww)localObject).jdField_b_of_type_Int;
          k = j;
          if (j > ((rww)localObject).jdField_b_of_type_Int) {
            k = ((rww)localObject).jdField_b_of_type_Int;
          }
          if (paramInt >= ((rww)localObject).jdField_b_of_type_Int) {
            break label644;
          }
          paramInt = ((rww)localObject).jdField_b_of_type_Int;
          break label624;
        }
      ...
      paramrwo = new JSONArray();
      paramString = paramHashMap.values().iterator();
      while (paramString.hasNext())
      {
        paramHashMap = (rww)paramString.next();
        ...
        paramrwo.put(localObject);
        continue;
        localHashMap.put("param_content", localJSONObject.toString());
      }
    }
    catch (Exception paramrwo) {}
    for (;;)
    {
      localHashMap.put("param_device", rwi.a());
      if (QLog.isColorLevel()) {
        QLog.d("VideoExtractFrame", 2, "灯塔数据上报 reportMap = " + localHashMap.toString());
      }
      paramrwo = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      if (paramrwo != null) {
        bctj.a(paramContext).a(paramrwo.c(), "actKandianVideoExtractFrame", true, -1L, 0L, localHashMap, null);
      }
      return;
      localJSONObject.put("detail_list", paramrwo);
    }
    label644:
    for (;;)
    {
  ...
  private static void b(rwo paramrwo, String paramString, HashMap<Integer, rww> paramHashMap, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoExtractFrame", 2, "innerDoExtractFrame start() videoInfo.tag = " + paramrwo.jdField_b_of_type_JavaLangString);
    }
    jdField_a_of_type_Long = System.currentTimeMillis();
    jdField_a_of_type_Rwp = new rwp(BaseApplication.getContext(), paramString, paramHashMap, paramLong);
    jdField_a_of_type_Rwp.a(new rwn(paramrwo));
    jdField_a_of_type_Rwp.a();
  }
  ...
  private static void c()
  {
    try
    {
      ...
      bmqa.a("kandian_video_extract_frame_local_result", jdField_b_of_type_OrgJsonJSONObject.toString());
      float f = rwi.a();
      Object localObject = jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        if (((rwo)((Iterator)localObject).next()).jdField_a_of_type_Float > f) {
      ...
      localObject = (rwo)jdField_a_of_type_JavaUtilArrayList.get(i);
      HashMap localHashMap = new HashMap();
      Iterator localIterator = ((rwo)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext())
      {
        rww localrww = (rww)localIterator.next();
        localHashMap.put(Integer.valueOf(localrww.jdField_a_of_type_Int), localrww);
      }
      slm.a().a(((rwo)localObject).jdField_a_of_type_JavaLangString, new rwm((rwo)localObject, localHashMap));
      return;
    }
    catch (Exception localException) {}
  }
