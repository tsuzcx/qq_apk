...
public abstract class rrn<BEAN, HOLDER extends rro>
  extends BaseAdapter
{
  @NotNull
  ...
  public rrn(@NotNull Context paramContext)
  {
  ...
  public View getView(int paramInt, @Nullable View paramView, @Nullable ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      a(this.jdField_a_of_type_JavaUtilList.get(paramInt), (rro)localObject);
