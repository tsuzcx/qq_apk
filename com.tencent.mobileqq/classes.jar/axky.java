...
public class axky
{
  ...
  private static void a(BaseActivity paramBaseActivity, axld paramaxld)
  {
    ThreadManagerV2.postImmediately(new MultiAIOStarter.2(paramBaseActivity, paramaxld), null, false);
  }
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (!((axlc)BaseApplicationImpl.getApplication().getRuntime().getManager(325)).a())
    {
      if (QLog.isColorLevel()) {
    ...
    if (axkr.a(paramInt))
    {
      ...
      axld localaxld = axld.a(localQQAppInterface);
      Bitmap localBitmap = a(paramContext);
      int i = a(paramContext);
      a = true;
      localaxld.a(localBitmap);
      localaxld.a(i);
      a((BaseActivity)paramContext, localaxld);
      localaxld.a((QQAppInterface)localQQAppInterface, (FragmentActivity)paramContext, paramString3, paramInt, paramString1, paramString2);
      localaxld.a(new axkz(paramContext));
      localIntent.putExtra("OPEN_MULTI_AIO_CONTEXT", localaxld.a());
      if ("open_from_aio".equals(paramString3)) {
        localIntent.putExtra("OPEN_MULTI_AIO_LIST_VIEW_SPECIFY_BOTTOM", a(paramContext));
      }
      afez.a(paramContext, localIntent, PublicTransFragmentActivity.class, MultiAIOFragment.class);
      return true;
    }
    return false;
  }
  ...
  private static int[] a(Context paramContext)
  {
    ...
    if ((paramContext instanceof BaseActivity))
    {
      paramContext = (ListView)((BaseActivity)paramContext).findViewById(2131370020);
      if (paramContext != null)
      {
