  ...
  implements Handler.Callback
{
  ...
  public axkz a;
  private axla jdField_a_of_type_Axla = new axla(null);
  axld jdField_a_of_type_Axld;
  ...
  public axky()
  {
    this.jdField_a_of_type_Axkz = new axkz();
    f();
  ...
  private axls a()
  {
    axls localaxls = this.jdField_a_of_type_Axkz.a.b();
    if (localaxls != null) {
      return localaxls;
    }
    localaxls = this.jdField_a_of_type_Axkz.a.a();
    if (localaxls != null)
    {
      this.jdField_a_of_type_Axld.a(localaxls.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localaxls;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Axla.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Axla.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Axla.jdField_b_of_type_Int = 0;
    aiay.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Axla.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (axkz.a(this.jdField_a_of_type_Axkz))
    {
      Object localObject2 = axkz.a(this.jdField_a_of_type_Axkz);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Axld != null) {
      this.jdField_a_of_type_Axld.c();
    }
    this.jdField_a_of_type_Axld = null;
    c();
  ...
  public void a(int paramInt1, int paramInt2, ahxm paramahxm)
  {
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Axld = new axld();
        this.jdField_a_of_type_Axld.a(false, false);
        d();
      }
      axjp.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (ahxm)paramMessage.obj);
      this.h = true;
      if (this.i) {
        a(a());
      }
    ...
    do
    {
      do
      {
        ...
        f();
        this.jdField_a_of_type_Axkz.a();
        this.jdField_a_of_type_Axkz.a = null;
        this.jdField_a_of_type_Axla.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Axla.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Axla.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (j != 0)
    {
      aiay.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
      return true;
    }
    if (this.jdField_a_of_type_Axld != null) {
      axjp.a(PtvFilterUtils.a() / 1000L);
    }
    boolean bool1;
    if (paramMessage.obj != null)
    {
      ...
      for (;;)
      {
        ...
        aiay.a("handleMessage:[copyDataToByteBuffer] steptime=" + l1 + " us");
        axjp.d(l1);
        ...
        if (this.jdField_a_of_type_Axkz.a != null) {
          break;
        }
        aiay.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
        if (paramMessage.arg1 == 1) {
          localObject = ((axiq)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
        }
      }
      ...
      if (localaxls != null)
      {
        this.jdField_a_of_type_Axld.a(localaxls.jdField_a_of_type_Int);
        aiay.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] bindTextureId=" + localaxls.jdField_a_of_type_Int);
        aiay.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] Begin drawFrame mWidth=" + this.jdField_a_of_type_Int + " mHeight=" + this.jdField_b_of_type_Int);
        e();
        aiay.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] End drawFrame");
        if (!jdField_a_of_type_Boolean) {}
        AVIOStruct localAVIOStruct;
        for (bool1 = true;; bool1 = false)
        {
          PtvFilterUtils.a(bool1);
          aiay.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] glSyncCommand OK: sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
          if (paramMessage.arg1 != 1) {
            break label1126;
          }
          localAVIOStruct = ((axiq)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
        ...
        {
          this.jdField_a_of_type_Axla.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        bool1 = true;
        label739:
        localaxls.a(j, localObject, bool1);
        localaxls.e();
        bool1 = this.jdField_a_of_type_Axkz.a.a();
        aiay.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Axla.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Axla.jdField_a_of_type_Boolean) {
            a((AVIOStruct)localObject);
          }
          localaxls.a();
        }
        aiay.a("handleMessage:writeVideoFrame frameBufferTime=" + l2 + "  sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
      }
      l1 = (PtvFilterUtils.a() - l1) / 1000L;
      axjp.c(l1);
    ...
    for (;;)
    {
      ...
      break label739;
      label1143:
      aiay.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
    }
  }
}
