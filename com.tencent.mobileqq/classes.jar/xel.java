  ...
  extends wov
{
  ...
  public final List<xem> a;
  public final boolean a;
  public final byte[] a;
  
  public xel(qqstory_service.RspGetEmoticonPackList paramRspGetEmoticonPackList, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    else
    {
      for (;;)
      {
        ...
        xem localxem = new xem((qqstory_struct.EmoticonPack)paramRspGetEmoticonPackList.next());
        if (localxem.a())
        {
          localArrayList.add(localxem);
          continue;
          bool = false;
          break;
        }
        yuk.d("GetEmojiPackInfoListResponse", "found invalid data we ignore it : " + localxem);
      }
    }
    label151:
