...
public class ajgr
{
  ...
  public static void a()
  {
    ...
    {
      return;
      localObject1 = ((QQAppInterface)localObject1).getMessageFacade().getAllMessages(AppConstants.TROOP_SYSTEM_MSG_UIN, 0, null);
  ...
  public static void a(Context paramContext, ajgu paramajgu, Object... paramVarArgs)
  {
    if (paramContext == null) {
      return;
    }
    bhdj.a(paramContext, paramContext.getString(2131719691), paramContext.getString(2131719690), null, 2131690697, 2131694617, new ajgs(paramajgu, paramVarArgs), new ajgt()).show();
  }
  ...
  public static boolean a(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "troopNotificationConfig = " + localaqxt.toString() });
    }
    if (!localaqxt.jdField_a_of_type_Boolean)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramInt < localaqxt.c) || (localaqxt.c == 0))
    {
      if (QLog.isColorLevel()) {
        QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "undealMsgCount =", Integer.valueOf(paramInt), "todoGroupVerifyMsgLevel =", Integer.valueOf(localaqxt.c) });
      }
      return false;
    }
    if (a())
    ...
    for (;;)
    {
      ...
      while ((System.currentTimeMillis() - b()) / 1000L < localaqxt.jdField_a_of_type_Long)
      {
        if (QLog.isColorLevel()) {
      ...
      if ((1 == j) && (6 == i) && (b() >= localaqxt.b))
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "RemindCntOfOneDay =", Integer.valueOf(b()), "totalRemindCntOfOneDay =", Integer.valueOf(localaqxt.b) });
        }
        return false;
      }
      if ((1 == j) && (3 == paramInt) && (a() >= localaqxt.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "RemindCntOfOneWeak =", Integer.valueOf(b()), "totalRemindCntOfOneWeak =", Integer.valueOf(localaqxt.jdField_a_of_type_Int) });
        }
        return false;
      }
      return true;
  ...
  public static boolean a(structmsg.StructMsg paramStructMsg, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (paramStructMsg != null)
    {
      ...
      if (paramQQAppInterface != null)
      {
        ...
        bdla.b(null, "dc00898", "", "", "0x800B47E", "0x800B47E", 0, 0, "", "", "", "");
        bool1 = true;
      }
    }
    return bool1;
  ...
  public static int c()
  {
    ...
    ArrayList localArrayList = new ArrayList();
    localObject = (ajfn)((QQAppInterface)localObject).getManager(QQManagerFactory.TROOP_NOTIFICATION_MANAGER);
    if (localObject != null) {}
    for (localObject = ((ajfn)localObject).a();; localObject = null)
    {
      long l = a();
