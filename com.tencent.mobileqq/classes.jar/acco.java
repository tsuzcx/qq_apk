...
public class acco
{
  ...
  public acco()
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new accp(this);
    this.jdField_a_of_type_MqqAppAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    this.c = false;
  }
  
  public acco(Activity paramActivity)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new accp(this);
  ...
  public acco(Activity paramActivity, accq paramaccq)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new accp(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Accq = paramaccq;
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AppActivity))
    {
      this.jdField_a_of_type_MqqAppAppRuntime = ((AppActivity)this.jdField_a_of_type_AndroidAppActivity).getAppRuntime();
      this.c = true;
  ...
  public static String a(Resources paramResources, LightAppSettingInfo paramLightAppSettingInfo, String paramString)
  {
    ...
    {
      str = paramResources.getString(2131691377);
    }
    if ((!TextUtils.isEmpty(paramLightAppSettingInfo.b)) && (!TextUtils.isEmpty(paramLightAppSettingInfo.jdField_a_of_type_JavaLangString)) && (biub.a(paramLightAppSettingInfo.b))) {
      return paramResources.getString(2131691379, new Object[] { str });
    }
    return paramResources.getString(2131691378, new Object[] { str });
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    {
      biub.a(paramActivity, paramString1);
      return;
    }
    ...
    biqa.b(paramActivity, localBundle);
  }
  ...
  private void d()
  {
    ...
    {
      acda.a((String)localObject, localBundle, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqObserverBusinessObserver);
      return;
    }
  }
  ...
  public LightAppSettingInfo a(DeviceInfo paramDeviceInfo)
  {
    ...
    if (localLightAppSettingInfo2 == null)
    {
      ...
      if (!this.c)
      {
        ...
        {
          a(((abqn)((QQAppInterface)localAppRuntime).a(51)).a());
  ...
  public void a()
  {
    ...
    {
      localObject1 = ((abqn)((QQAppInterface)localObject1).a(51)).a();
  ...
  public void a(DeviceInfo paramDeviceInfo, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    {
      if (this.jdField_a_of_type_Accq != null) {
        this.jdField_a_of_type_Accq.a(false);
      }
      return;
    }
    if (paramBundle != null) {}
    for (boolean bool = paramBundle.getBoolean("showProgress", true);; bool = true)
    {
      ...
      for (;;)
      {
        if ((str == null) && (0 == 0))
        {
          ...
          accz.a(null, "Net_LiteApp_Setting", 0, 1, localLightAppSettingInfo.jdField_c_of_type_Int);
          if (str != null) {
            break label713;
          }
          ...
          this.jdField_a_of_type_Accq.a(true);
          return;
        ...
        for (Intent localIntent = new Intent();; localIntent = null)
        {
          ...
          for (;;)
          {
            ...
            break;
            localIntent.putExtra("uinname", acda.a(paramDeviceInfo));
          }
          label713:
          ...
          bmqo.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), paramDeviceInfo, str, -1, null, SmartDevicePluginProxyActivity.class);
          break label247;
          label794:
          break;
          ...
          biti.a().a(2131691382);
          if ((this.jdField_a_of_type_Biau != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Biau.c(2131691381);
      this.jdField_a_of_type_Biau.show();
    }
    while (this.jdField_a_of_type_MqqAppAppRuntime == null)
    {
      bisy.d("LightAppUtil", "app == null when dologin");
      if (this.jdField_a_of_type_Accq != null) {
        this.jdField_a_of_type_Accq.a(false);
      }
      return;
