...
public class bjkm
{
  ...
  public static String a(List<bjkm> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localStringBuilder.append(((bjkm)paramList.next()).a()).append(";");
    }
    return localStringBuilder.toString();
  }
  
  public static List<bjkm> a(String paramString)
  {
