...
public class bjkm
{
  ...
  public static Bitmap a(String paramString)
  {
    ...
    bjko.b("ImageUtil", "100_url:" + str1 + " icon_path=" + str2);
    if (new File(str2).exists()) {
      return bjkk.a(str2, 72, 72, false);
    }
    paramString = a(paramString, 75);
    str1 = ImageCache.a("app", paramString);
    bjko.b("ImageUtil", "75_url:" + paramString + " icon_path=" + str1);
    if (new File(str1).exists()) {
      return bjkk.a(str1, 72, 72, false);
    }
    return null;
  }
  ...
  public static String a(String paramString, int paramInt)
  {
    ...
    bjko.b("opensdk", ">>iconUrl=" + paramString);
    return paramString;
  }
