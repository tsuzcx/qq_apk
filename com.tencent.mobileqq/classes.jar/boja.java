...
{
  public boja(QIMMusicConfigManager paramQIMMusicConfigManager, bohc parambohc) {}
  ...
  public void a(VSBaseRequest paramVSBaseRequest, boolean paramBoolean, long paramLong, String paramString, CLIENT.StBatchGetMusicInfoRsp paramStBatchGetMusicInfoRsp)
  {
    if ((!paramBoolean) || (paramStBatchGetMusicInfoRsp.vecMusic.size() == 0)) {
      this.jdField_a_of_type_Bohc.a(false, new FlowMusic());
    }
    while (this.jdField_a_of_type_Bohc == null) {
      return;
    }
    ...
    this.jdField_a_of_type_Bohc.a(true, paramVSBaseRequest);
  }
}
