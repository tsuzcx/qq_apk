  ...
  extends amob
{
  ...
  public amoc(QQAppInterface paramQQAppInterface, amof paramamof)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localalto.b((String)localObject3))
          {
        ...
        else if (bdih.a(MessageRecord.getTableName((String)localObject3, i), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b()))
        {
          localArrayList.add(localFTSEntity);
  ...
  private void a(FTSMessage paramFTSMessage, int paramInt)
  {
    try
    {
      ...
      if ((paramFTSMessage.istroop == 0) && (!((alto)localObject).b(paramFTSMessage.senderuin)))
      {
        ...
        azri.a(BaseApplicationImpl.getContext()).a(null, "actStrangerFtsMsg", true, 0L, 0L, (HashMap)localObject, "");
      }
      return;
    }
      ...
      synchronized (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList)
      {
        ...
        if (!localThrowable.isEmpty())
        {
          ...
          if ((QLog.isColorLevel()) || (paramLong > 60000L))
          {
            ...
            azri.a(BaseApplication.getContext()).a(null, "actFTSMsgCost", true, paramLong, 0L, (HashMap)localObject3, null, false);
  ...
  private boolean a(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    paramSQLiteDatabase = ((awgf)localObject).a(FTSMessageSync.class, "msg_sync_log", false, "_id>?", new String[] { String.valueOf(this.jdField_a_of_type_Int) }, null, null, "_id", String.valueOf(300));
    ((awgf)localObject).a();
    int i;
    if (QLog.isColorLevel())
    {
  ...
  private boolean b(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    paramSQLiteDatabase = ((awgf)localObject1).a(FTSMessageDelete.class, "msg_del_log", false, "_id>?", new String[] { String.valueOf(this.jdField_b_of_type_Int) }, null, null, "_id", String.valueOf(50));
    ((awgf)localObject1).a();
    if (QLog.isColorLevel())
    {
  ...
  public ArrayList<FTSEntity> a(long paramLong, Pair<CharSequence, CharSequence> paramPair)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      localObject = amoa.a(FTSMessage.class, String.valueOf(paramLong));
      localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a((awho)localObject);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = bdpr.a(str);
        paramString = amoa.a(paramString, (String[])((ArrayList)localObject1).toArray(new String[((ArrayList)localObject1).size()]), paramClass, paramBoolean1, paramBoolean2);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString = bdpr.a((String)localObject);
        if (QLog.isColorLevel()) {
          QLog.i("Q.fts.FTSMsgOperator", 2, "query segments = " + Arrays.toString(paramString));
        }
        ...
        localObject = bdpr.a((String)localObject);
        paramString = amoa.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt);
  ...
  public ArrayList<FTSEntity> a(String paramString1, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString1 = bdpr.a((String)localObject);
        if (QLog.isColorLevel()) {
        ...
        localObject = bdpr.a((String)localObject);
        paramString1 = amoa.a(paramString1, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt, paramString2);
  ...
  public void a(amnw paramamnw, awgf paramawgf)
  {
    Object localObject1;
    Object localObject2;
    if ((paramamnw.c != null) && (!TextUtils.isEmpty(paramamnw.c)))
    {
      if (paramamnw.jdField_a_of_type_AndroidContentContentValues == null) {
        return;
      }
      localObject1 = "SELECT * FROM " + paramamnw.b + " WHERE " + paramamnw.c + ";";
      localObject2 = new String[paramamnw.jdField_a_of_type_ArrayOfJavaLangString.length];
      int i = 0;
      while (i < paramamnw.jdField_a_of_type_ArrayOfJavaLangString.length)
      {
        localObject2[i] = paramamnw.jdField_a_of_type_ArrayOfJavaLangString[i];
        i += 1;
      }
      localObject1 = a().a((String)localObject1, paramamnw.b, paramamnw.c, (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if ((localObject1 != null) && (bdpr.a(paramamnw.jdField_a_of_type_AndroidContentContentValues))) {
        paramamnw = ((List)localObject1).iterator();
      }
    }
    while (paramamnw.hasNext())
    {
      localObject1 = (MessageRecord)paramamnw.next();
      if ((((MessageRecord)localObject1).isSupportFTS()) && (((MessageRecord)localObject1).isValid) && (((MessageRecord)localObject1).msgtype != -2006) && (!((MessageRecord)localObject1).isMultiMsg))
      {
        ...
        paramawgf.b(FTSMessageCodec.a((FTSMessage)localObject1));
        if (QLog.isColorLevel()) {
          QLog.d("Q.fts.FTSMsgOperator", 2, "updateMessageSync 1 msg:" + ((FTSMessage)localObject1).toString());
        }
        a((FTSMessage)localObject1, 2);
        continue;
        if ((localObject1 != null) && (bdpr.b(paramamnw.jdField_a_of_type_AndroidContentContentValues)))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((((MessageRecord)localObject3).isSupportFTS()) && (((MessageRecord)localObject3).isValid) && (((MessageRecord)localObject3).msgtype != -2006) && (!((MessageRecord)localObject3).isMultiMsg))
            {
              ...
              paramawgf.b(FTSMessageCodec.a((FTSMessage)localObject2));
              localObject3 = bdpr.a(paramamnw.jdField_a_of_type_AndroidContentContentValues, (MessageRecord)localObject3);
              ((FTSMessage)localObject3).insertOpt();
              paramawgf.b(FTSMessageCodec.a((FTSMessage)localObject3));
              if (QLog.isColorLevel()) {
  ...
  {
    if (((paramawge instanceof MessageRecord)) && (((MessageRecord)paramawge).isSupportFTS()))
    {
      paramawge = (MessageRecord)paramawge;
      paramawge.saveExtInfoToExtStr("ExtraFTSMsgCounter", String.valueOf(b(paramawge.frienduin)));
    }
  }
  
  public void a(awge paramawge, awgf paramawgf)
  {
    if (((paramawge instanceof MessageRecord)) && (((MessageRecord)paramawge).isSupportFTS()) && (((MessageRecord)paramawge).isValid) && (((MessageRecord)paramawge).msgtype != -2006) && (!((MessageRecord)paramawge).isMultiMsg))
    {
      paramawge = FTSMessageCodec.a((MessageRecord)paramawge);
      paramawge.insertOpt();
      paramawgf.b(FTSMessageCodec.a(paramawge));
      if (QLog.isColorLevel()) {
        QLog.d("Q.fts.FTSMsgOperator", 2, "insertMessageSync msg:" + paramawge.toString());
      }
      a(paramawge, 1);
    }
  }
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Amoi = new amod(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
  ...
  public long b(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
    {
      ...
      if (((FTSMsgCounter)localObject).mMsgCnt > 1000L)
      {
        ...
        this.jdField_a_of_type_Awgn.a((awge)localObject);
      }
      for (;;)
      {
    ...
    ((awgf)localObject).b(localFTSMsgCounter);
    ((awgf)localObject).a();
    if ((System.currentTimeMillis() - this.jdField_c_of_type_Long > 30000L) && (QLog.isColorLevel()))
    {
  ...
  public void b()
  {
    if (bdpr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
    {
      if (!a()) {
        break label30;
      }
  ...
  public void b(amnw paramamnw, awgf paramawgf)
  {
    Object localObject;
    if ((paramamnw.c != null) && (!TextUtils.isEmpty(paramamnw.c)))
    {
      localObject = "SELECT * FROM " + paramamnw.b + " WHERE " + paramamnw.c + ";";
      String[] arrayOfString = new String[paramamnw.jdField_a_of_type_ArrayOfJavaLangString.length];
      int i = 0;
      while (i < paramamnw.jdField_a_of_type_ArrayOfJavaLangString.length)
      {
        arrayOfString[i] = paramamnw.jdField_a_of_type_ArrayOfJavaLangString[i];
        i += 1;
      }
      try
      {
        paramamnw = a().a((String)localObject, paramamnw.b, paramamnw.c, arrayOfString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (paramamnw == null) {
          break label288;
        }
        paramamnw = paramamnw.iterator();
        while (paramamnw.hasNext())
        {
          localObject = (MessageRecord)paramamnw.next();
          if ((((MessageRecord)localObject).isSupportFTS()) && (((MessageRecord)localObject).isValid) && (((MessageRecord)localObject).msgtype != -2006))
          {
            ...
            paramawgf.b(FTSMessageCodec.a((FTSMessage)localObject));
          }
        }
      }
      catch (OutOfMemoryError paramamnw)
      {
        for (;;)
        {
          QLog.e("Q.fts.FTSMsgOperator", 2, paramamnw, new Object[0]);
          paramamnw = null;
        }
      }
    }
    ...
    try
    {
      ((FTSMessage)localObject).uin = mto.a(paramamnw.jdField_a_of_type_JavaLangString);
      ((FTSMessage)localObject).istroop = paramamnw.jdField_a_of_type_Int;
      ((FTSMessage)localObject).deleteOpt();
      paramawgf.b(FTSMessageCodec.a((FTSMessage)localObject));
      label288:
      return;
    }
    catch (NumberFormatException paramamnw) {}
  }
  
  public void c()
  {
    super.c();
    if (1 == bdpr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_a_of_type_Amof.obtainMessage(1, this).sendToTarget();
    }
  }
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      for (int i = 0;; i = -1)
      {
        ...
        for (int j = 0;; j = -1)
        {
          ...
          Object localObject = localawgf.a(FTSMsgCounter.class, false, null, null, null, null, null, null);
          if (localObject != null)
          {
  ...
  public void e()
  {
    if ((!amnu.jdField_a_of_type_Boolean) && (bdpr.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + amnu.jdField_a_of_type_Boolean + ", FTSUpgradeFlag = " + bdpr.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
  ...
  {
    // Byte code:
    //   0: getstatic 801	amnu:jdField_a_of_type_Boolean	Z
    //   3: ifne +64 -> 67
    //   6: aload_0
    //   7: getfield 71	amoc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10: invokestatic 813	bdpr:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   13: ifeq +54 -> 67
    ...
    //   38: getstatic 801	amnu:jdField_a_of_type_Boolean	Z
    ...
    //   50: aload_0
    //   51: getfield 71	amoc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: invokestatic 813	bdpr:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    ...
    //   66: return
    //   67: aload_0
    //   68: getfield 71	amoc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 517	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   74: astore 9
    //   76: aload_0
    //   77: getfield 71	amoc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   80: invokevirtual 77	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawgg;
    //   83: invokevirtual 388	awgg:createEntityManager	()Lawgf;
    //   86: astore 7
    ...
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 356	amoc:jdField_a_of_type_Int	I
    ...
    //   135: iconst_0
    //   136: aload_0
    //   137: getfield 356	amoc:jdField_a_of_type_Int	I
    ...
    //   146: ldc_w 394
    //   149: aconst_null
    //   150: invokevirtual 399	awgf:a	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   153: astore 8
    //   155: aload 9
    //   157: ldc_w 452
    //   160: ldc_w 380
    ...
    //   168: iconst_0
    //   169: aload_0
    //   170: getfield 286	amoc:jdField_b_of_type_Int	I
    ...
    //   198: iconst_0
    //   199: aload_0
    //   200: getfield 286	amoc:jdField_b_of_type_Int	I
    ...
    //   209: ldc_w 394
    //   212: aconst_null
    //   213: invokevirtual 399	awgf:a	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   216: astore 9
    ...
    //   238: aload_0
    //   239: getfield 261	amoc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   242: ifnull +271 -> 513
    //   245: aload_0
    //   246: getfield 261	amoc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    ...
    //   286: istore_1
    //   287: aload_0
    //   288: getfield 261	amoc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   291: aload 11
    //   293: iconst_1
    //   294: iload_1
    ...
    //   299: aload_0
    //   300: aload_0
    //   301: getfield 356	amoc:jdField_a_of_type_Int	I
    //   304: iload_1
    //   305: iadd
    //   306: putfield 356	amoc:jdField_a_of_type_Int	I
    ...
    //   363: istore_1
    //   364: aload_0
    //   365: getfield 261	amoc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   368: aload 11
    //   370: iconst_2
    //   371: iload_1
    ...
    //   376: aload_0
    //   377: aload_0
    //   378: getfield 286	amoc:jdField_b_of_type_Int	I
    //   381: iload_1
    //   382: iadd
    //   383: putfield 286	amoc:jdField_b_of_type_Int	I
    ...
    //   428: aload_0
    //   429: getfield 299	amoc:d	I
    //   432: i2l
    //   433: lstore 5
    //   435: aload_0
    //   436: aload_0
    //   437: getfield 261	amoc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   440: ldc_w 366
    //   443: invokevirtual 369	com/tencent/mobileqq/persistence/fts/FTSDatatbase:b	(Ljava/lang/String;)I
    //   446: putfield 299	amoc:d	I
    ...
    //   513: aload 7
    //   515: invokevirtual 401	awgf:a	()V
    //   518: return
    //   519: iconst_0
    //   520: istore_1
    //   521: goto -234 -> 287
    ...
    //   555: aload 7
    //   557: invokevirtual 401	awgf:a	()V
    //   560: return
    //   561: astore 8
    //   563: aload 7
    //   565: invokevirtual 401	awgf:a	()V
    //   568: aload 8
    //   570: athrow
