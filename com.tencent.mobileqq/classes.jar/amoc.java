...
public final class amoc
  implements amom, Handler.Callback, INetInfoHandler
{
  ...
  {
    if (this.jdField_a_of_type_Amod == null)
    {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.4.1");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Amod.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Amod.b);
    ...
    try
    {
      paramString = ampj.a(paramString, this.jdField_a_of_type_Amod.jdField_a_of_type_JavaLangString);
  ...
  {
    ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Amod.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Amod.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    amoo localamoo = new amoo();
    localamoo.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Amod.jdField_a_of_type_JavaUtilList;
    localamoo.jdField_a_of_type_Int = this.jdField_a_of_type_Amod.jdField_a_of_type_Int;
    localamoo.b = 10000;
    localamoo.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localamoo);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localamoo);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!bgnt.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
  ...
  public void a(amod paramamod)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Amod = paramamod;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Bkgm.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Bkgm.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = ampj.b((byte[])localObject, this.jdField_a_of_type_Amod.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = bgnt.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Bkgm.removeMessages(7);
      this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Amod });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Amod != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Bkgm.removeMessages(1);
        this.jdField_a_of_type_Bkgm.removeMessages(2);
        this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Bkgm.removeMessages(1);
      this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public void onNetMobile2None()
  {
    ...
    this.jdField_a_of_type_Bkgm.sendEmptyMessage(4);
  }
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    this.jdField_a_of_type_Bkgm.removeMessages(5);
    this.jdField_a_of_type_Bkgm.sendEmptyMessage(5);
  }
