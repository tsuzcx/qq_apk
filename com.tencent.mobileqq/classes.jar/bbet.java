...
public class bbet
{
  ...
  public static int a(MessageForScribble paramMessageForScribble)
  {
    ...
    if (!paramMessageForScribble.mExistInfo.mInit) {
      bool1 = atwl.a(b(paramMessageForScribble));
    }
    boolean bool2 = paramMessageForScribble.mExistInfo.mCombineFileExist;
    if (!paramMessageForScribble.mExistInfo.mInit) {
      bool2 = atwl.a(a(paramMessageForScribble));
    }
    if ((bool1) && (bool2)) {
      return c;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, Bitmap paramBitmap, int paramInt2, bbeu parambbeu)
  {
    a();
    new bbev(paramQQAppInterface, paramString, paramInt1, paramBitmap, paramInt2, parambbeu).execute(new Void[0]);
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForScribble paramMessageForScribble)
  {
    ...
    do
    {
      ...
      localbbep = new bbep(paramQQAppInterface);
      localMessageForScribble = localbbep.a(paramMessageForScribble);
  ...
  public static int b(MessageForScribble paramMessageForScribble)
  {
    ...
    if (bbfc.a(str1, paramMessageForScribble.offSet, str2)) {
      return d;
    }
    return e;
  }
