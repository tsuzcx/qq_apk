...
public class bbet
{
  ...
  private static int a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    paramQQAppInterface = (TransFileInfo)((aukn)localObject).a(TransFileInfo.class, new String[] { String.valueOf(paramMessage.time), String.valueOf(paramMessage.msgseq), paramQQAppInterface.getCurrentAccountUin(), paramMessage.frienduin });
    ((aukn)localObject).a();
    if (paramQQAppInterface == null) {
      return 0;
    }
    paramQQAppInterface.status = apue.b(paramQQAppInterface.status);
  ...
  private static String a(Context paramContext, QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    paramContext = paramQQAppInterface.a().a(bbbo.a(paramMessage.shareAppID));
  ...
  private static String a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (SystemMsg.isSystemMessage(paramMessage.msgtype))
    {
      ...
      default: 
        paramContext = str1;
        String str2 = bbbc.a(paramString);
        str1 = paramString;
        if (str2 != null)
        {
          str1 = paramString;
          if (!"".equals(str2.trim()))
          {
            ...
            {
              paramQQAppInterface = bbcl.b(paramQQAppInterface, paramMessage.senderuin, true);
    ...
    do
    {
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  break;
                  paramContext = paramContext.getString(2131718679);
                  break;
                ...
                paramContext = bbbc.b(paramString);
                str1 = paramString;
          ...
          paramQQAppInterface = bbcl.b(paramQQAppInterface, paramContext, true);
          str1 = paramString;
        } while (paramQQAppInterface == "");
        str1 = paramString;
      } while (paramQQAppInterface.equals(""));
      return bbbc.a(paramString, paramContext, paramQQAppInterface);
    ...
    label462:
    paramString = bbbc.a(paramString, paramQQAppInterface);
    paramMessage = bbbc.b(paramString);
    ...
    if (paramMessage != null)
    {
      ...
      if (!"".equals(paramMessage.trim()))
      {
        ...
        {
          paramQQAppInterface = bbcl.b(paramQQAppInterface, paramMessage, true);
          paramContext = paramString;
          if (paramQQAppInterface != "")
          {
            paramContext = paramString;
            if (!paramQQAppInterface.equals("")) {
              paramContext = bbbc.a(paramString, paramMessage, paramQQAppInterface);
            }
          }
        }
      }
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    if (i > 0) {
      ((StringBuffer)localObject).append(i).append(paramContext.getString(2131693359));
    }
    if (j > 0) {
      ((StringBuffer)localObject).append(j).append(paramContext.getString(2131694291));
    }
    ((StringBuffer)localObject).append(k).append(paramContext.getString(2131719129));
    ...
    for (int i = 1;; i = 2)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
          default: 
            paramString1 = paramContext.getResources().getString(2131695866);
            if ((paramInt == 1) || (paramInt == 5000)) {
              paramString1 = paramContext.getResources().getString(2131695889);
            }
          ...
          case 13: 
            ...
            paramArrayOfString = paramQQAppInterface.getApp().getString(2131695891);
            paramArrayOfString = ":" + paramArrayOfString;
            return paramString1.replace(paramQQAppInterface.getApp().getString(2131695889), paramArrayOfString);
          }
        }
      ...
      paramString2 = bbcl.a(paramQQAppInterface, paramString2, paramString1, i, 0);
      paramString1 = paramContext.getResources().getString(2131695866);
      if ((paramInt == 1) || (paramInt == 5000)) {
        paramString1 = paramContext.getResources().getString(2131695889);
      }
      ...
      for (paramContext = paramContext + "...";; paramContext = paramString2)
      {
        ...
        if ((paramInt == 1) || (paramInt == 5000))
        {
          paramString1 = paramContext.getResources().getString(2131695886);
          break;
        }
        paramString1 = paramContext.getResources().getString(2131695818);
        break;
        label352:
        paramArrayOfString = paramQQAppInterface.getApp().getString(2131695886);
        break label150;
        label366:
        return "";
        paramInt = 0;
      ...
      if (paramMessageForPic.picExtraData != null)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          if (QLog.isColorLevel()) {
            QLog.d("msgSummary", 2, "textSummary: " + bbbd.a(str));
          }
          return str;
        }
      }
      if ((paramMessageForPic.picExtraData != null) && ((paramMessageForPic.picExtraData.isHotPics()) || (paramMessageForPic.picExtraData.isCustomFace()) || (aezn.b(paramMessageForPic)) || (anod.b(paramMessageForPic)) || (aexd.a(paramMessageForPic)))) {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = ajyc.a(2131706981);
  ...
  public static String a(String[] paramArrayOfString, Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramArrayOfString.length > 1) {
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramArrayOfString.length > 3)
          {
            ...
            default: 
              ...
              paramContext = paramContext.getResources().getString(2131696229);
        ...
        if (paramContext.getString(2131720751).equals(paramArrayOfString[0]))
        {
          if (j != 0) {
        ...
        if (j != 0) {
          return paramContext.getResources().getString(2131696229) + " " + paramArrayOfString[0];
        }
        return paramContext.getResources().getString(2131695674) + " " + paramArrayOfString[0];
        if (paramArrayOfString[0] == null) {
          break label930;
        }
        if (paramContext.getString(2131720755).equals(paramArrayOfString[0]))
        {
          if (j != 0)
          {
            if (paramBoolean2) {
            ...
            return paramContext.getResources().getString(2131696241);
          }
          if (paramBoolean2) {
            return paramContext.getResources().getString(2131695683);
          }
          return paramContext.getResources().getString(2131695682);
        }
        if (j != 0) {
          return paramContext.getResources().getString(2131696229) + " " + paramArrayOfString[0];
        }
        ...
        if (j != 0) {
          return paramContext.getResources().getString(2131696229);
        }
        return paramContext.getResources().getString(2131695674);
        if (j != 0) {
          return paramContext.getResources().getString(2131696230);
        }
        return paramContext.getResources().getString(2131695676);
        if (j != 0) {
          return paramContext.getResources().getString(2131696245);
        }
        return paramContext.getResources().getString(2131695687);
        if (paramArrayOfString[0] == null) {
          break label930;
        }
        if (paramContext.getString(2131720751).equals(paramArrayOfString[0]))
        ...
        return paramContext.getResources().getString(2131695674) + " " + paramArrayOfString[0];
        label913:
        paramContext = paramContext.getResources().getString(2131695674);
      }
    }
    return "";
    label930:
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage, int paramInt, MsgSummary paramMsgSummary, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   7: astore 16
    //   9: aload_2
    //   10: invokestatic 503	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   13: ifeq +7703 -> 7716
    //   16: aload 5
    ...
    //   35: iconst_1
    //   36: invokestatic 505	bbcl:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    //   84: ifnull +13 -> 97
    //   87: aload 16
    //   89: invokestatic 521	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Lmyf;
    //   92: getfield 525	myf:b	Ljava/lang/String;
    //   95: astore 5
    //   97: aload 5
    //   99: astore 16
    //   101: aload 5
    ...
    //   106: ifeq +7610 -> 7716
    //   109: aload_2
    //   110: invokestatic 521	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Lmyf;
    //   113: getfield 525	myf:b	Ljava/lang/String;
    //   116: astore 5
    //   118: aload 5
    //   120: astore 16
    //   122: iload 6
    ...
    //   170: invokestatic 536	akpy:k	(I)Z
    //   173: ifeq +6 -> 179
    //   176: aconst_null
    //   177: astore 16
    //   179: aload_2
    //   180: invokestatic 541	bajb:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Lbajc;
    //   183: astore 5
    //   185: aload 5
    //   187: ifnull +10 -> 197
    //   190: aload 5
    //   192: getfield 545	bajc:c	Ljava/lang/String;
    //   195: astore 16
    //   197: aload 16
    //   199: invokestatic 546	bbet:b	(Ljava/lang/String;)Ljava/lang/String;
    //   202: astore 19
    //   204: aload_2
    ...
    //   308: istore_3
    //   309: aload_0
    //   310: invokestatic 568	aszn:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   313: ifeq +21 -> 334
    //   316: aconst_null
    //   317: aconst_null
    //   318: aload_0
    //   319: checkcast 570	com/tencent/mobileqq/data/MessageForStructing
    //   322: invokestatic 573	aszn:a	(Lcom/tencent/mobileqq/data/MessageForStructing;)Ljava/lang/String;
    //   325: iconst_0
    //   326: iconst_0
    //   327: aload 4
    //   329: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   332: iconst_1
    //   333: istore_3
    //   334: aload_0
    //   335: invokestatic 579	baja:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   338: ifeq +18 -> 356
    //   341: aconst_null
    //   342: aconst_null
    //   343: aload_2
    ...
    //   348: iconst_0
    //   349: aload 4
    //   351: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   354: iconst_1
    //   355: istore_3
    //   356: iload_3
    //   357: ifne -353 -> 4
    //   360: aload_1
    //   361: aload_2
    //   362: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   365: istore 6
    //   367: aload_1
    //   368: aload_2
    //   369: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   372: istore 7
    //   374: aload 19
    //   376: aconst_null
    //   377: aload_2
    ...
    //   383: iload 7
    //   385: aload 4
    //   387: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   390: return
    //   391: aload_2
    ...
    //   437: invokestatic 587	akpy:a	(Ljava/lang/String;I)Z
    //   440: ifeq +7273 -> 7713
    //   443: aload_2
    ...
    //   473: astore 5
    //   475: aload_1
    //   476: invokevirtual 590	com/tencent/mobileqq/app/QQAppInterface:a	()Layvv;
    //   479: aload 17
    //   481: aload_2
    //   482: getfield 31	com/tencent/mobileqq/app/message/QQMessageFacade$Message:uniseq	J
    //   485: invokevirtual 595	ayvv:a	(Ljava/lang/String;J)Lbbmi;
    //   488: astore_1
    //   489: aload_1
    //   490: astore 5
    //   492: aload_2
    ...
    //   544: ifeq +260 -> 804
    //   547: aload 16
    //   549: checkcast 600	ayoz
    //   552: astore_1
    //   553: aload_1
    //   554: invokevirtual 602	ayoz:c	()J
    //   557: ldc2_w 603
    //   560: lcmp
    //   561: ifeq +7140 -> 7701
    //   564: iconst_1
    ...
    //   570: ifeq +60 -> 630
    //   573: aload_1
    //   574: getfield 607	ayoz:a	Laywa;
    //   577: ifnull +219 -> 796
    //   580: aload_1
    //   581: getfield 607	ayoz:a	Laywa;
    //   584: getfield 610	aywa:jdField_a_of_type_Long	J
    //   587: lstore 14
    //   589: ldc_w 612
    //   592: iconst_2
    ...
    //   617: aload_1
    //   618: invokevirtual 618	ayoz:a	()Ljava/lang/String;
    ...
    //   637: astore_1
    //   638: aload_2
    //   639: invokestatic 622	ajyk:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   642: ifne +10 -> 652
    //   645: aload_2
    //   646: invokestatic 625	ajwd:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   649: ifeq +11 -> 660
    //   652: aload_0
    //   653: ldc_w 626
    ...
    //   677: astore_1
    //   678: aload 5
    //   680: invokestatic 629	bbet:a	(Lcom/tencent/mobileqq/data/MessageForPic;)Ljava/lang/String;
    //   683: astore_0
    //   684: aload_0
    ...
    //   694: iload 6
    //   696: aload 4
    //   698: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   701: return
    //   702: aload 16
    ...
    //   742: astore 5
    //   744: aload_1
    //   745: checkcast 600	ayoz
    //   748: invokevirtual 602	ayoz:c	()J
    //   751: lstore 14
    //   753: lload 14
    //   755: l2i
    //   756: istore_3
    ...
    //   895: invokestatic 587	akpy:a	(Ljava/lang/String;I)Z
    //   898: ifeq +6795 -> 7693
    //   901: aload_2
    ...
    //   1012: aastore
    //   1013: invokestatic 657	anmg:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   1016: aload 19
    //   1018: aload_0
    //   1019: aconst_null
    //   1020: iload 6
    //   1022: iload 7
    //   1024: aload 4
    //   1026: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   1029: return
    //   1030: aload 5
    //   1032: astore_0
    //   1033: aload 17
    ...
    //   1040: ifgt +6647 -> 7687
    //   1043: aload_1
    //   1044: invokevirtual 590	com/tencent/mobileqq/app/QQAppInterface:a	()Layvv;
    //   1047: aload 16
    //   1049: aload 17
    ...
    //   1059: invokevirtual 664	ayvv:b	(Ljava/lang/String;Ljava/lang/String;J)I
    //   1062: istore_3
    //   1063: iload_3
    //   1064: sipush 1005
    ...
    //   1112: aastore
    //   1113: invokestatic 657	anmg:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   1116: aload 5
    //   1118: astore_0
    //   1119: iload 6
    //   1121: istore 10
    ...
    //   1270: invokestatic 679	bbbg:a	(I)Z
    //   1273: ifeq +28 -> 1301
    //   1276: aload 19
    //   1278: aload_0
    //   1279: aload_1
    //   1280: aload_2
    //   1281: invokestatic 681	bbet:a	(Landroid/content/Context;Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   1284: aconst_null
    //   1285: aload_1
    //   1286: aload_2
    //   1287: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1290: aload_1
    //   1291: aload_2
    //   1292: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1295: aload 4
    //   1297: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   1300: return
    //   1301: aload_2
    ...
    //   1333: invokestatic 587	akpy:a	(Ljava/lang/String;I)Z
    //   1336: ifeq +8 -> 1344
    //   1339: aload_2
    ...
    //   1386: aload_1
    //   1387: aload_2
    //   1388: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1391: aload_1
    //   1392: aload_2
    //   1393: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1396: aload 4
    //   1398: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   1401: return
    //   1402: aload_2
    //   1403: getfield 174	com/tencent/mobileqq/app/message/QQMessageFacade$Message:msgtype	I
    //   1406: invokestatic 687	bbbg:b	(I)Z
    //   1409: ifeq +35 -> 1444
    //   1412: aload_2
    //   1413: getfield 549	com/tencent/mobileqq/app/message/QQMessageFacade$Message:msg	Ljava/lang/String;
    //   1416: invokestatic 692	aywi:a	(Ljava/lang/String;)[Ljava/lang/String;
    //   1419: astore_1
    //   1420: aload_1
    //   1421: ifnull -1417 -> 4
    //   1424: aload 4
    ...
    //   1432: invokestatic 696	bbet:b	(I)Z
    //   1435: iload 7
    //   1437: invokestatic 698	bbet:a	([Ljava/lang/String;Landroid/content/Context;ZZ)Ljava/lang/String;
    ...
    //   1448: invokestatic 700	bbbg:c	(I)Z
    //   1451: ifeq +39 -> 1490
    //   1454: aload_2
    //   1455: getfield 549	com/tencent/mobileqq/app/message/QQMessageFacade$Message:msg	Ljava/lang/String;
    //   1458: invokestatic 692	aywi:a	(Ljava/lang/String;)[Ljava/lang/String;
    //   1461: astore 5
    //   1463: aload 5
    //   1465: ifnull -1461 -> 4
    //   1468: aload 4
    ...
    //   1482: iload_3
    //   1483: invokestatic 702	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   1494: invokestatic 704	bbbg:d	(I)Z
    //   1497: ifeq +134 -> 1631
    //   1500: aload_1
    //   1501: aload_2
    //   1502: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1505: istore 6
    //   1507: aload_1
    //   1508: aload_2
    //   1509: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1512: istore 7
    //   1514: aload_2
    //   1515: ldc_w 706
    ...
    //   1537: aload_0
    //   1538: aload_2
    //   1539: invokestatic 719	anqu:a	(Landroid/content/Context;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   1542: astore_0
    //   1543: aload_2
    ...
    //   1564: ldc_w 720
    //   1567: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   1587: iload 7
    //   1589: aload 4
    //   1591: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   1594: return
    //   1595: new 160	java/lang/StringBuilder
    //   1598: dup
    //   1599: invokespecial 161	java/lang/StringBuilder:<init>	()V
    //   1602: ldc_w 721
    //   1605: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   1622: aload_0
    //   1623: aload_2
    //   1624: invokestatic 719	anqu:a	(Landroid/content/Context;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   1627: astore_0
    //   1628: goto -47 -> 1581
    //   1631: aload_2
    ...
    //   1645: aload_1
    //   1646: aload_2
    //   1647: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1650: istore 12
    //   1652: aload_1
    //   1653: aload_2
    //   1654: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   1657: istore 13
    //   1659: iconst_0
    //   1660: istore 8
    //   1662: aload 18
    ...
    //   1760: invokestatic 742	akwb:a	([B)Ljava/lang/Object;
    //   1763: instanceof 744
    //   1766: ifeq +75 -> 1841
    //   1769: aload 18
    //   1771: astore 17
    ...
    //   1783: aload_0
    //   1784: aload_2
    //   1785: invokestatic 719	anqu:a	(Landroid/content/Context;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   1788: astore 5
    //   1790: aload 18
    //   1792: astore 17
    //   1794: aload_2
    ...
    //   1819: ldc_w 745
    //   1822: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   1881: aload_2
    //   1882: aload 4
    //   1884: invokestatic 748	com/tencent/mobileqq/emoticon/EmojiStickerManager:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;Lcom/tencent/mobileqq/activity/recent/MsgSummary;)Layki;
    //   1887: astore_0
    ...
    //   1916: pop
    //   1917: aload_2
    //   1918: invokestatic 503	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   1921: ifne +16 -> 1937
    //   1924: iload 12
    //   1926: ifeq +98 -> 2024
    //   1929: aload_1
    ...
    //   1936: pop
    //   1937: aload_0
    //   1938: checkcast 752	ayki
    //   1941: aload_1
    //   1942: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1945: iconst_1
    //   1946: iconst_0
    //   1947: newarray int
    //   1949: invokevirtual 755	ayki:a	(Ljava/lang/String;Z[I)Layki;
    //   1952: astore_1
    //   1953: aload_1
    //   1954: astore_0
    //   1955: aload_0
    ...
    //   1967: iload 13
    //   1969: aload 4
    //   1971: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   1974: return
    //   1975: aload 18
    //   1977: astore 17
    ...
    //   1986: ldc_w 756
    //   1989: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   2012: aload_0
    //   2013: aload_2
    //   2014: invokestatic 719	anqu:a	(Landroid/content/Context;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   2017: astore 5
    //   2019: iconst_1
    //   2020: istore_3
    //   2021: goto -180 -> 1841
    ...
    //   2074: astore 17
    //   2076: aload_2
    //   2077: invokestatic 766	com/tencent/mobileqq/emoticon/EmojiStickerManager:a	(Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Layki;
    //   2080: astore_0
    //   2081: aload_0
    //   2082: ifnull -2078 -> 4
    //   2085: aload 5
    ...
    //   2128: astore 17
    //   2130: aload_2
    //   2131: invokestatic 503	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   2134: ifne +20 -> 2154
    //   2137: iload 12
    //   2139: ifeq +63 -> 2202
    //   2142: aload 5
    ...
    //   2156: astore 17
    //   2158: aload_0
    //   2159: checkcast 752	ayki
    //   2162: aload_1
    //   2163: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   2166: iconst_1
    //   2167: iconst_0
    //   2168: newarray int
    //   2170: invokevirtual 755	ayki:a	(Ljava/lang/String;Z[I)Layki;
    //   2173: astore_0
    //   2174: aload 5
    //   2176: astore 17
    //   2178: aload 4
    ...
    //   2194: iload 13
    //   2196: aload 4
    //   2198: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   2201: return
    //   2202: iload 13
    //   2204: ifeq -50 -> 2154
    //   2207: aload 5
    ...
    //   2265: invokestatic 587	akpy:a	(Ljava/lang/String;I)Z
    //   2268: ifeq +5410 -> 7678
    //   2271: aload 18
    //   2273: astore 16
    //   2275: aload_2
    ...
    //   2309: astore 16
    //   2311: aload_1
    //   2312: invokevirtual 590	com/tencent/mobileqq/app/QQAppInterface:a	()Layvv;
    //   2315: aload 17
    //   2317: aload_2
    //   2318: getfield 31	com/tencent/mobileqq/app/message/QQMessageFacade$Message:uniseq	J
    //   2321: invokevirtual 595	ayvv:a	(Ljava/lang/String;J)Lbbmi;
    //   2324: astore_1
    //   2325: aload_1
    //   2326: astore 16
    //   2328: aload_2
    ...
    //   2381: astore 17
    //   2383: aload_1
    //   2384: checkcast 600	ayoz
    //   2387: astore_1
    //   2388: aload 5
    //   2390: astore 17
    //   2392: aload_1
    //   2393: invokevirtual 602	ayoz:c	()J
    //   2396: ldc2_w 603
    //   2399: lcmp
    //   2400: ifeq +6 -> 2406
    //   2403: iconst_1
    ...
    //   2422: astore 17
    //   2424: aload_1
    //   2425: getfield 607	ayoz:a	Laywa;
    //   2428: ifnull +5319 -> 7747
    //   2431: aload 5
    //   2433: astore 17
    //   2435: aload_1
    //   2436: getfield 607	ayoz:a	Laywa;
    //   2439: getfield 610	aywa:jdField_a_of_type_Long	J
    //   2442: lstore 14
    //   2444: aload 5
    //   2446: astore 17
    //   2448: ldc_w 612
    ...
    //   2476: aload_1
    //   2477: invokevirtual 618	ayoz:a	()Ljava/lang/String;
    ...
    //   2507: astore 17
    //   2509: aload_2
    //   2510: invokestatic 622	ajyk:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   2513: ifne +14 -> 2527
    //   2516: aload 5
    //   2518: astore 17
    //   2520: aload_2
    //   2521: invokestatic 625	ajwd:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   2524: ifeq +15 -> 2539
    //   2527: aload 5
    //   2529: astore 17
    //   2531: aload_0
    ...
    //   2549: iload 6
    //   2551: aload 4
    //   2553: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   2556: return
    //   2557: aload_1
    //   2558: astore 16
    //   2560: aload 20
    ...
    //   2592: astore 16
    //   2594: aload_1
    //   2595: checkcast 600	ayoz
    //   2598: invokevirtual 602	ayoz:c	()J
    //   2601: lstore 14
    //   2603: lload 14
    //   2605: l2i
    //   2606: istore_3
    ...
    //   2712: invokestatic 771	bbbg:e	(I)Z
    //   2715: ifeq +267 -> 2982
    ...
    //   2741: aload_1
    //   2742: aload_2
    //   2743: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   2746: istore 6
    //   2748: aload_1
    //   2749: aload_2
    //   2750: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   2753: istore 7
    //   2755: aload 5
    ...
    //   2763: ifeq +209 -> 2972
    //   2766: ldc_w 782
    //   2769: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    //   2772: astore_0
    //   2773: aload 5
    ...
    //   2804: ldc_w 786
    //   2807: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   2825: iload 7
    //   2827: aload 4
    //   2829: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   2832: return
    ...
    //   2870: ldc_w 792
    //   2873: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   2952: ldc_w 801
    //   2955: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   3012: iconst_0
    //   3013: aload 4
    //   3015: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3018: return
    //   3019: aload_2
    ...
    //   3049: iconst_0
    //   3050: aload 4
    //   3052: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3055: return
    //   3056: aload_2
    ...
    //   3106: aload_1
    //   3107: aload_2
    //   3108: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   3111: istore 6
    //   3113: aload_1
    //   3114: aload_2
    //   3115: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   3118: istore 7
    //   3120: aload 19
    //   3122: aconst_null
    //   3123: aload_0
    ...
    //   3129: iload 7
    //   3131: aload 4
    //   3133: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3136: return
    ...
    //   3259: aload_1
    //   3260: aload_2
    //   3261: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   3264: istore 6
    //   3266: aload_1
    //   3267: aload_2
    //   3268: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   3271: istore 7
    //   3273: aload 19
    //   3275: aconst_null
    //   3276: aload_0
    ...
    //   3282: iload 7
    //   3284: aload 4
    //   3286: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3289: return
    ...
    //   3414: astore_0
    //   3415: ldc_w 833
    //   3418: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    //   3421: pop
    //   3422: aload_0
    ...
    //   3433: aload_1
    //   3434: aload_2
    //   3435: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   3438: aload_1
    //   3439: aload_2
    //   3440: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   3443: aload 4
    //   3445: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3448: return
    ...
    //   3553: iconst_0
    //   3554: aload 4
    //   3556: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3559: return
    //   3560: aload_2
    ...
    //   3574: astore_0
    //   3575: getstatic 845	ajsf:aj	Ljava/lang/String;
    //   3578: aload_0
    ...
    //   3590: aload_0
    //   3591: astore 5
    //   3593: getstatic 848	ajsf:H	Ljava/lang/String;
    //   3596: aload_0
    //   3597: invokevirtual 147	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   3600: ifeq +59 -> 3659
    //   3603: getstatic 845	ajsf:aj	Ljava/lang/String;
    //   3606: aload_2
    ...
    //   3620: getstatic 845	ajsf:aj	Ljava/lang/String;
    //   3623: aload_2
    ...
    //   3709: iconst_0
    //   3710: aload 4
    //   3712: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3715: return
    //   3716: aload_2
    ...
    //   3820: iconst_0
    //   3821: aload 4
    //   3823: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3826: return
    //   3827: aload_2
    ...
    //   3875: iconst_0
    //   3876: aload 4
    //   3878: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3881: return
    //   3882: aload_2
    ...
    //   3931: iconst_0
    //   3932: aload 4
    //   3934: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   3937: return
    //   3938: aload_2
    ...
    //   4007: iconst_0
    //   4008: aload 4
    //   4010: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   4013: return
    //   4014: aload_1
    ...
    //   4134: iconst_0
    //   4135: aload 4
    //   4137: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   4140: return
    //   4141: aload_2
    ...
    //   4188: iconst_0
    //   4189: aload 4
    //   4191: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   4194: return
    //   4195: aload_2
    ...
    //   4214: ldc_w 905
    //   4217: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   4230: ldc_w 906
    //   4233: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   4243: iconst_0
    //   4244: aload 4
    //   4246: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   4249: return
    //   4250: aload_2
    ...
    //   4269: ldc_w 907
    //   4272: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   4285: ldc_w 908
    //   4288: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   4298: iconst_0
    //   4299: aload 4
    //   4301: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   4304: return
    //   4305: aload_2
    ...
    //   4407: aload_1
    //   4408: aload_2
    //   4409: invokestatic 915	apue:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   4412: astore 5
    //   4414: aload_1
    //   4415: aload_2
    //   4416: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   4419: istore 6
    //   4421: aload_1
    //   4422: aload_2
    //   4423: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   4426: istore 7
    //   4428: aload 19
    //   4430: aload_0
    //   4431: ldc_w 916
    ...
    //   4440: iload 7
    //   4442: aload 4
    //   4444: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   4447: aload 5
    //   4449: ifnull -4445 -> 4
    //   4452: aload 4
    //   4454: aload 5
    ...
    //   5019: iload 7
    //   5021: aload 4
    //   5023: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   5026: return
    //   5027: iload 6
    //   5029: istore 7
    //   5031: aload_2
    ...
    //   5344: ldc_w 983
    //   5347: invokestatic 372	ajyc:a	(I)Ljava/lang/String;
    ...
    //   5464: iconst_0
    //   5465: aload 4
    //   5467: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   5470: return
    //   5471: aload_2
    ...
    //   5494: invokestatic 587	akpy:a	(Ljava/lang/String;I)Z
    //   5497: ifeq +8 -> 5505
    //   5500: aload_2
    ...
    //   5546: iconst_0
    //   5547: aload 4
    //   5549: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   5552: return
    //   5553: aload_2
    ...
    //   5727: invokestatic 587	akpy:a	(Ljava/lang/String;I)Z
    //   5730: ifeq +9 -> 5739
    //   5733: aload_2
    ...
    //   5795: iload 6
    //   5797: aload 4
    //   5799: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   5802: return
    //   5803: aload_1
    ...
    //   5828: aload_1
    //   5829: invokestatic 1026	awgw:a	(Lcom/tencent/mobileqq/data/MessageForScribble;)I
    //   5832: istore_3
    //   5833: getstatic 1028	awgw:c	I
    //   5836: istore 8
    //   5838: iload_3
    //   5839: iload 8
    ...
    //   5867: aload_1
    //   5868: aload_2
    //   5869: invokestatic 1031	asyn:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   5872: ifeq +18 -> 5890
    //   5875: aload 19
    //   5877: aload_2
    ...
    //   5883: iconst_0
    //   5884: aload 4
    //   5886: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   5889: return
    //   5890: aload_2
    ...
    //   5941: iconst_0
    //   5942: aload 4
    //   5944: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   5947: return
    //   5948: aload_2
    ...
    //   6012: aload_1
    //   6013: invokevirtual 1044	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzw;
    //   6016: aload_2
    //   6017: invokevirtual 1047	awzw:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   6020: ifne +150 -> 6170
    //   6023: iconst_1
    //   6024: istore 6
    //   6026: iload 11
    ...
    //   6034: astore_0
    //   6035: aload_2
    //   6036: invokestatic 1050	balw:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   6039: ifeq +1618 -> 7657
    //   6042: aload_2
    //   6043: invokestatic 1052	balw:d	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   6046: ifne +7 -> 6053
    //   6049: aload_2
    //   6050: invokestatic 1055	balw:a	(Lcom/tencent/mobileqq/data/MessageRecord;)V
    //   6053: aload_2
    //   6054: invokestatic 1058	balw:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Ljava/lang/String;
    //   6057: astore_1
    //   6058: aload_1
    ...
    //   6106: pop
    //   6107: aload_2
    //   6108: invokestatic 503	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   6111: ifne +16 -> 6127
    //   6114: iload 6
    //   6116: ifeq +89 -> 6205
    //   6119: aload_1
    ...
    //   6131: ifeq +90 -> 6221
    //   6134: aload_0
    //   6135: checkcast 752	ayki
    //   6138: aload_1
    //   6139: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   6142: iconst_1
    //   6143: iconst_0
    //   6144: newarray int
    //   6146: invokevirtual 755	ayki:a	(Ljava/lang/String;Z[I)Layki;
    //   6149: astore_0
    //   6150: aload 4
    //   6152: iconst_1
    ...
    //   6162: iload 7
    //   6164: aload 4
    //   6166: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6169: return
    //   6170: iconst_1
    //   6171: istore 7
    //   6173: iload 10
    ...
    //   6257: iload 7
    //   6259: aload 4
    //   6261: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6264: return
    //   6265: aload_2
    ...
    //   6282: iconst_0
    //   6283: aload 4
    //   6285: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6288: return
    //   6289: aload_2
    ...
    //   6359: iconst_0
    //   6360: aload 4
    //   6362: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6365: return
    //   6366: aload_2
    ...
    //   6454: iconst_0
    //   6455: aload 4
    //   6457: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6460: return
    //   6461: ldc 119
    ...
    //   6493: iconst_0
    //   6494: aload 4
    //   6496: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6499: return
    //   6500: aload_2
    ...
    //   6538: iconst_0
    //   6539: aload 4
    //   6541: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6544: return
    //   6545: aload_2
    ...
    //   6614: aload_1
    //   6615: aload_2
    //   6616: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   6619: istore 6
    //   6621: aload_1
    //   6622: aload_2
    //   6623: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   6626: istore 7
    //   6628: aload 19
    //   6630: aload 4
    ...
    //   6638: iload 7
    //   6640: aload 4
    //   6642: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6645: return
    ...
    //   6678: aload_1
    //   6679: aload_2
    //   6680: invokestatic 582	bbet:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   6683: istore 6
    //   6685: aload_1
    //   6686: aload_2
    //   6687: invokestatic 584	bbet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Z
    //   6690: istore 7
    //   6692: aload_2
    ...
    //   6772: aload_2
    //   6773: aload 4
    //   6775: invokestatic 748	com/tencent/mobileqq/emoticon/EmojiStickerManager:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;Lcom/tencent/mobileqq/activity/recent/MsgSummary;)Layki;
    //   6778: astore_0
    ...
    //   6807: pop
    //   6808: aload_2
    //   6809: invokestatic 503	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   6812: ifne +16 -> 6828
    //   6815: iload 6
    //   6817: ifeq +222 -> 7039
    //   6820: aload_1
    ...
    //   6836: iconst_0
    //   6837: newarray int
    //   6839: invokevirtual 755	ayki:a	(Ljava/lang/String;Z[I)Layki;
    //   6842: aconst_null
    //   6843: iload 6
    //   6845: iload 7
    //   6847: aload 4
    //   6849: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6852: return
    //   6853: aload 19
    //   6855: ldc 119
    //   6857: aload_2
    ...
    //   6863: iload 7
    //   6865: aload 4
    //   6867: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6870: return
    //   6871: aload_2
    ...
    //   6926: iload 7
    //   6928: aload 4
    //   6930: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6933: return
    //   6934: aload 19
    //   6936: aload_0
    //   6937: ldc_w 619
    ...
    //   6945: iconst_0
    //   6946: aload 4
    //   6948: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   6951: return
    //   6952: ldc_w 649
    //   6955: iconst_3
    ...
    //   6981: aastore
    //   6982: invokestatic 657	anmg:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   6985: aload_0
    //   6986: ldc_w 639
    ...
    //   7001: invokestatic 1126	bbbd:a	(Ljava/lang/Object;Ljava/lang/Object;)Z
    //   7004: ifeq +22 -> 7026
    //   7007: iload_3
    //   7008: ifeq +18 -> 7026
    //   7011: aload 19
    ...
    //   7018: iload 7
    //   7020: aload 4
    //   7022: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   7025: return
    //   7026: aload 19
    //   7028: aload_0
    //   7029: ldc 119
    ...
    //   7032: iconst_0
    //   7033: aload 4
    //   7035: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   7038: return
    //   7039: iload 7
    //   7041: ifeq -213 -> 6828
    //   7044: aload_1
    ...
    //   7059: astore 5
    //   7061: aload_2
    //   7062: invokestatic 1050	balw:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   7065: ifeq +589 -> 7654
    //   7068: aload_2
    //   7069: invokestatic 1052	balw:d	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   7072: ifne +7 -> 7079
    //   7075: aload_2
    //   7076: invokestatic 1055	balw:a	(Lcom/tencent/mobileqq/data/MessageRecord;)V
    //   7079: aload_2
    //   7080: invokestatic 1058	balw:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Ljava/lang/String;
    //   7083: astore 16
    //   7085: aload 16
    ...
    //   7137: pop
    //   7138: aload_2
    //   7139: invokestatic 503	mye:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   7142: ifne +16 -> 7158
    //   7145: iload 6
    //   7147: ifeq +299 -> 7446
    //   7150: aload_0
    ...
    //   7180: iconst_0
    //   7181: aload 5
    //   7183: checkcast 752	ayki
    //   7186: getfield 1127	ayki:jdField_a_of_type_Int	I
    //   7189: iastore
    //   7190: dup
    //   7191: iconst_1
    //   7192: bipush 16
    ...
    //   7197: iconst_1
    //   7198: iastore
    //   7199: invokevirtual 755	ayki:a	(Ljava/lang/String;Z[I)Layki;
    //   7202: astore_0
    //   7203: aload 4
    //   7205: iconst_1
    ...
    //   7323: getfield 1140	com/tencent/mobileqq/graytip/MessageForUniteGrayTip:tipParam	Laquz;
    //   7326: ifnull +38 -> 7364
    //   7329: aload 5
    //   7331: astore_0
    //   7332: aload 16
    //   7334: checkcast 1136	com/tencent/mobileqq/graytip/MessageForUniteGrayTip
    //   7337: getfield 1140	com/tencent/mobileqq/graytip/MessageForUniteGrayTip:tipParam	Laquz;
    //   7340: getfield 1144	aquz:b	I
    //   7343: invokestatic 1147	asxk:b	(I)Z
    //   7346: ifeq +18 -> 7364
    //   7349: aload_1
    ...
    //   7360: invokestatic 1150	asyn:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/text/SpannableStringBuilder;
    //   7363: astore_0
    //   7364: aload_2
    //   7365: getfield 174	com/tencent/mobileqq/app/message/QQMessageFacade$Message:msgtype	I
    //   7368: invokestatic 1152	akpy:i	(I)Z
    //   7371: ifeq +271 -> 7642
    //   7374: aload_1
    ...
    //   7402: getfield 1140	com/tencent/mobileqq/graytip/MessageForUniteGrayTip:tipParam	Laquz;
    //   7405: ifnull +237 -> 7642
    //   7408: aload_1
    //   7409: checkcast 1136	com/tencent/mobileqq/graytip/MessageForUniteGrayTip
    //   7412: getfield 1140	com/tencent/mobileqq/graytip/MessageForUniteGrayTip:tipParam	Laquz;
    //   7415: getfield 1144	aquz:b	I
    //   7418: ldc_w 1153
    ...
    //   7438: iload 7
    //   7440: aload 4
    //   7442: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   7445: return
    //   7446: iload 7
    //   7448: ifeq -290 -> 7158
    //   7451: aload_0
    ...
    //   7505: astore 5
    //   7507: getstatic 1157	ajsf:G	Ljava/lang/String;
    //   7510: aload_2
    ...
    //   7535: aload 5
    //   7537: aload_2
    //   7538: invokestatic 1162	bbet:a	(Landroid/content/Context;Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lcom/tencent/mobileqq/app/message/QQMessageFacade$Message;)Ljava/lang/String;
    //   7541: astore_0
    //   7542: aload 19
    //   7544: aconst_null
    //   7545: aload_0
    //   7546: iload 6
    //   7548: aload_1
    //   7549: invokevirtual 1044	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzw;
    //   7552: aload_2
    //   7553: invokevirtual 1047	awzw:b	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   7556: aload 4
    //   7558: invokestatic 576	bbet:a	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLcom/tencent/mobileqq/activity/recent/MsgSummary;)V
    //   7561: aload_2
    ...
    //   7590: iconst_1
    //   7591: bipush 16
    //   7593: invokespecial 1165	ayki:<init>	(Ljava/lang/CharSequence;II)V
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    if (akpy.a(paramMessage.frienduin, paramMessage.istroop))
    {
      localMessage = paramMessage;
      if (paramMessage.senderuin != null)
      {
        if (akpy.c(paramMessage.senderuin)) {
          return false;
        }
    ...
    if (localMessage.msgtype == -2017)
    {
      ...
      if ((paramMessage != null) && ((paramMessage instanceof MessageForTroopFile)))
      {
        ...
        {
          paramQQAppInterface = bakj.a(paramQQAppInterface, paramMessage);
    ...
    if (((paramMessage instanceof aypf)) && (localMessage.isSendFromLocal()) && (paramMessage != null) && (((aypf)paramMessage).f() >= 0) && (((aypf)paramMessage).f() != 100)) {
      return true;
    }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic, boolean paramBoolean)
  {
    ...
    if (paramMessageForPic.size <= 0L)
    {
      ...
      {
        long l = ((ayoz)paramQQAppInterface).c();
  ...
  private static boolean b(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        } while (akpy.c(paramMessage.senderuin));
