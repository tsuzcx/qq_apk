...
public final class apwy
{
  ...
  public apwy(@NotNull List<apdr> paramList, @NotNull List<String> paramList1)
  {
    this.a = paramList;
    this.b = paramList1;
  }
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof apwy))
      {
        paramObject = (apwy)paramObject;
