  ...
  implements View.OnClickListener
{
  ...
  public apwy(Activity paramActivity, ViewGroup paramViewGroup, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    ((LayoutInflater)this.jdField_a_of_type_AndroidAppActivity.getSystemService("layout_inflater")).inflate(2131560490, paramViewGroup, true);
    this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo = paramTeamWorkFileImportInfo;
    this.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131364768);
  ...
  private void c()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364773));
    a();
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698191);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131698192);
  }
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder().append(paramInt).append(ajyc.a(2131703376));
    if (paramBoolean) {}
    for (paramString = ajyc.a(2131698193);; paramString = ajyc.a(2131703384))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131698190);
      return;
    }
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131703367);
  }
  ...
  public void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      if (this.c)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.setInterpolator(new AccelerateDecelerateInterpolator());
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addListener(new apwz(this));
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.setDuration(180L);
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.start();
      }
      return;
  ...
  public void onClick(View paramView)
  {
    if (!bbev.d(BaseApplication.getContext())) {
      bcpw.a(this.jdField_a_of_type_AndroidAppActivity, ajyc.a(2131703379), 0).a();
    }
    label195:
    do
    {
    ...
    ayhk.a(null, "0X800ABA6");
    ayec.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo, null);
  }
}
