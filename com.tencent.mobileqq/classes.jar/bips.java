  ...
  extends LinearLayout
{
  ...
  public bips(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bipb parambipb)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = biqy.a(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = biqy.a(getContext(), 7.0F);
      }
  ...
  public void a(biox parambiox, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject = parambiox.a(paramInt2);
      localImageView.setTag(2131311070, localObject);
      localImageView.setTag(2131311062, Integer.valueOf(paramInt2));
      if (parambiox.a(paramInt2) != 1) {
        break label252;
      }
      if (!(getContext() instanceof EditPicActivity)) {
        break label158;
      }
      localObject = parambiox.b(paramInt2);
      localImageView.setTag(2131311070, localObject);
      bikl.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      localObject = baop.a(BaseApplicationImpl.sApplication.getRuntime(), (String)localObject, "-Dynamic-", null, new int[] { 13 }, "-Dynamic-", null);
      if (localObject != null)
      {
