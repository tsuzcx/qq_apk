...
public class abcu
  extends bqgi
  implements abbs, Handler.Callback, View.OnClickListener, bqch
{
  public float a;
  public int a;
  private long jdField_a_of_type_Long;
  private abbr jdField_a_of_type_Abbr;
  ...
  private bqgu jdField_a_of_type_Bqgu;
  ...
  private String jdField_d_of_type_JavaLangString = (String)abac.a().a("KEY_SMART_MUSIC_ENTER_ANIM_DOWNLOAD_URL", "https://down.qq.com/video_story/smart_music_anim.zip");
  ...
  public abcu(@NonNull bqgk parambqgk)
  {
    super(parambqgk);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new abdb(this);
  }
  ...
  private bqgu a()
  {
    if (this.jdField_a_of_type_Bqgu == null) {
      this.jdField_a_of_type_Bqgu = ((bqgu)this.jdField_a_of_type_Bqgk.a(bqgu.class));
    }
    return this.jdField_a_of_type_Bqgu;
  }
  ...
  private void a(int paramInt, abdg paramabdg)
  {
    if (paramabdg == null) {
      paramabdg = (abdg)this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.findViewHolderForAdapterPosition(paramInt);
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramInt;
      this.jdField_a_of_type_Abdg = paramabdg;
      if ((this.jdField_a_of_type_Abdg != null) && (!this.jdField_a_of_type_Boolean))
      {
  ...
  private void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Abbr != null)
          {
            this.jdField_a_of_type_Abbr.c();
            i();
          }
          ...
          if (this.jdField_a_of_type_Abdd.a() <= 0) {
            break label280;
          }
          i = 1;
          if (i == 0) {
          ...
          if (this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int, paramIntent))
          {
          ...
          this.jdField_d_of_type_Int = (this.jdField_a_of_type_Abdd.a(paramIntent.mSongMid) + a());
          if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView == null) {
            break;
          }
    ...
    this.jdField_a_of_type_Abdd.a((ArrayList)localObject1);
  }
  
  private void a(VsMusicItemInfo paramVsMusicItemInfo, int paramInt, abdg paramabdg)
  {
  ...
  private void a(ArrayList<FrameVideoHelper.FrameBuffer> paramArrayList)
  {
    ...
    paramArrayList = new SmartMusicMatchRequest(paramArrayList, bopi.a().a(), this.jdField_f_of_type_Boolean, this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
    this.jdField_c_of_type_JavaLangString = paramArrayList.getCmdName();
    VSNetworkHelper.a().a(a(), paramArrayList, new abda(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Abdd != null) {
      this.jdField_a_of_type_Abdd.a(paramArrayList, true);
    }
  }
  ...
  {
    Object localObject;
    if ((this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a instanceof EditTakeVideoSource))
    {
      localObject = (EditTakeVideoSource)this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a;
      ...
      this.jdField_a_of_type_Abbr = new abbr();
      this.jdField_a_of_type_Abbr.a(this);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null)
      {
        this.jdField_a_of_type_Abbr.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
        a(anzj.a(2131702722) + "\n视频时长：" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration / 1000L + "s");
        a(anzj.a(2131702739) + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaWidth + "  " + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaHeight);
        bozv.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration / 1000L);
      }
      if (this.g) {
        this.jdField_a_of_type_Abbr.a(60000);
      }
      this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Bqgk.a().getSerializable("KEY_VIDEO_STORY_CAPTYRE_FRAMES"));
      if (this.jdField_a_of_type_Bqgk.a().getInt("KEY_VIDEO_STORY_CAMERA_TYPE", 2) != 2) {
        break label345;
      }
    }
    label345:
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Bqgk.a().getLong("KEY_VIDEO_STORY_CAPTYRE_FRAMES_SIZE");
      k();
      return;
      ...
      localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a;
  ...
  private void k()
  {
    ...
    l();
    if ((this.jdField_a_of_type_JavaIoFile.exists()) || (bhsr.a(this.jdField_d_of_type_JavaLangString)))
    {
  ...
  private void n()
  {
    this.jdField_e_of_type_AndroidViewView = a(2131380974);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131379737));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131380079));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131380961));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131369305));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131369285));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131379956));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)a(2131369202));
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetEasylyricSingleLyricView = ((SingleLyricView)a(2131377805));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)a(2131377815));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = a().getResources().getDrawable(2130850773);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = a().getResources().getDrawable(2130850772);
    this.jdField_c_of_type_AndroidViewView = a(2131370212);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131370205);
    this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)a(2131366750));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_Bqgk.jdField_a_of_type_Bqhs.getActivity().findViewById(2131363547);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bqgk.jdField_a_of_type_Bqhs.getActivity().findViewById(2131363545);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(this);
    o();
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new abcw(this));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new abcx(this));
    if ((this.jdField_c_of_type_AndroidViewView != null) && (this.g)) {
      this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    }
    QLog.d("EditVideoSmartMusicPart", 2, "getRealHeight" + bdep.c(a()) + "ScreenUtil.getRealWidth(getContext())" + bdep.e(a()));
    int i;
    int m;
    int k;
    int j;
    if (bdep.c(a()) / bdep.e(a()) >= 2.0F)
    {
      LiuHaiUtils.c((Activity)a());
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
      if ((!born.c.a(this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f)) || ((!this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c()) && (!this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()) && (!this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b()))) {
        break label667;
      }
      i = agej.a(105.0F, a().getResources());
      m = agej.a(34.0F, a().getResources());
      k = agej.a(19.0F, a().getResources());
      j = i;
    }
    for (;;)
    {
      ...
      return;
      if ((this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams() == null)) {
        break;
      }
      this.jdField_e_of_type_AndroidViewView.setPadding(0, 0, 0, this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams().height);
      break;
      label667:
      j = agej.a(17.0F, a().getResources());
      i = agej.a(0.0F, a().getResources());
      k = agej.a(-15.0F, a().getResources());
      m = i;
    }
  }
  ...
  private void o()
  {
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView = ((SmartMusicRecyclerView)a(2131365218));
    this.jdField_a_of_type_Abdd = ((abdd)this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.getAdapter());
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.setListener(new abcy(this));
  }
  ...
  private void p()
  {
    ...
    {
      return;
      localVsMusicItemInfo = this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int);
    ...
    try
    {
      ...
      abbe.a("mystatus_edit", "aimusic_exp_clk", 0, 0, new String[] { String.valueOf(localVsMusicItemInfo.jdField_a_of_type_Int), "", localJSONObject.toString() });
      this.jdField_f_of_type_Long = System.currentTimeMillis();
      yuk.c("EditVideoSmartMusicPart", "reportSmartMusic   reportClickMusic() args3:" + localJSONObject.toString());
      return;
    }
  ...
  private void q()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0))
    {
      ...
      this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper.a(this.jdField_e_of_type_Long, new abcz(this));
      return;
    }
  ...
  private void r()
  {
    ...
    {
      q();
      abbe.a("mystatus_edit", "musiclib_entry_clk", 0, 0, new String[0]);
    }
    if (!this.jdField_a_of_type_Boolean) {
      bool = true;
    }
  ...
  private void v()
  {
    ...
    else if (this.jdField_a_of_type_Abdg != null)
    {
      localObject = this.jdField_a_of_type_Abdg;
      if (this.jdField_a_of_type_Boolean) {
        break label74;
      }
    }
  ...
  private void w()
  {
    ...
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { bhlo.a(), "", Integer.valueOf(6) }));
  ...
  private void x()
  {
    ...
    {
      this.jdField_e_of_type_AndroidViewView.setBackgroundResource(2130838781);
  ...
  private void y()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int - 1) != null) {
        localJSONObject.put("mid1", this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int - 1).mSongMid);
      }
      if (this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int) != null) {
        localJSONObject.put("mid2", this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int).mSongMid);
      }
      if (this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int + 1) != null) {
        localJSONObject.put("mid3", this.jdField_a_of_type_Abdd.a(this.jdField_a_of_type_Int + 1).mSongMid);
      }
    }
    catch (JSONException localJSONException)
    {
    ...
    abbe.a("mystatus_edit", "aimusic_exp", 0, 0, new String[] { "", "", localJSONObject.toString() });
    yuk.c("EditVideoSmartMusicPart", "reportSmartMusic   reportShowMusic() args3:" + localJSONObject.toString());
  }
  ...
  public int a()
  {
    if ((this.jdField_a_of_type_Abdd.a() == null) || (this.jdField_a_of_type_Abdd.a().size() == 0)) {
      return 0;
    }
    return (int)(Math.floor(this.jdField_a_of_type_Abdd.getItemCount() / this.jdField_a_of_type_Abdd.a().size() / 2) * this.jdField_a_of_type_Abdd.a().size());
  }
  ...
  {
    super.a();
    this.jdField_f_of_type_Boolean = this.jdField_a_of_type_Bqgk.b();
    this.g = this.jdField_a_of_type_Bqgk.c();
    n();
    j();
    a(bqch.class, this);
    ...
    this.jdField_b_of_type_Int = ((Long)abac.a().a("SmartMatchMusicSwitch", Long.valueOf(0L))).intValue();
  ...
  public void a(int paramInt, bqua parambqua)
  {
    boolean bool2 = false;
    ...
    Object localObject = parambqua.a;
    boolean bool1;
    if (!this.jdField_b_of_type_Boolean)
    {
      bool1 = true;
      ((PublishVideoEntry)localObject).putExtra("isMixOriginal", Boolean.valueOf(bool1));
      localObject = parambqua.a;
      bool1 = bool2;
      if (!this.jdField_b_of_type_Boolean) {
        bool1 = true;
      }
      ((PublishVideoEntry)localObject).isMixOriginal = bool1;
      parambqua.a.isMuteRecordVoice = this.jdField_b_of_type_Boolean;
      parambqua.a.putExtra("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH", this.jdField_a_of_type_Bqgk.a().getString("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH"));
      parambqua.a.putExtra("KEY_FROM_PIC_TO_VIDEO", Boolean.valueOf(this.g));
      parambqua.a.putExtra("KEY_VIDEO_STORY_CAMERA_TYPE", Boolean.valueOf(this.jdField_a_of_type_Bqgk.a().isLandTakePicToVideo()));
      if (!this.jdField_a_of_type_Boolean) {
        break label200;
      }
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null) {
        this.jdField_a_of_type_Bqgk.a().setVideoDuration(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
      }
      return;
      bool1 = false;
      break;
      label200:
      if ((this.jdField_a_of_type_Abbr != null) && (this.jdField_a_of_type_Abbr.a() != null))
      {
        localObject = this.jdField_a_of_type_Abbr.a();
        parambqua.a.backgroundMusicOffset = ((VsMusicItemInfo)localObject).musicStart;
        ...
        if (!this.g)
        {
          ...
          j = Math.min(j, (int)this.jdField_a_of_type_Bqgk.a(paramInt));
        }
        parambqua.a.backgroundMusicDuration = j;
        parambqua.a.backgroundMusicPath = ((VsMusicItemInfo)localObject).getLocalPath();
        parambqua.a.putExtra("vs_publish_entry_json_key_music_id", Integer.valueOf(((VsMusicItemInfo)localObject).mItemId));
        parambqua.a.putExtra("vs_publish_entry_json_key_music_mid_id", ((VsMusicItemInfo)localObject).mSongMid);
        parambqua.a.putExtra("vs_publish_entry_json_key_song_name", ((VsMusicItemInfo)localObject).mMusicName);
        parambqua.a.putExtra("vs_publish_entry_json_key_music_album_pic", ((VsMusicItemInfo)localObject).mAlbumUrl);
        parambqua.a.putExtra("vs_publish_entry_json_key_music_download_url", ((VsMusicItemInfo)localObject).mUrl);
        parambqua.a.putExtra("vs_publish_entry_json_key_music_source_from", Integer.valueOf(((VsMusicItemInfo)localObject).jdField_a_of_type_Int));
        parambqua.a.putExtra("originalRecordVolume", Float.valueOf(a(1)));
        parambqua.a.putExtra("backgroundVolume", Float.valueOf(a(2)));
        this.jdField_a_of_type_Bqgk.a().setSongMid(((VsMusicItemInfo)localObject).mSongMid);
        this.jdField_a_of_type_Bqgk.a().setMusicType(((VsMusicItemInfo)localObject).jdField_a_of_type_Int);
        this.jdField_a_of_type_Bqgk.a().setMusciPlayTime(System.currentTimeMillis() - this.jdField_f_of_type_Long);
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Abbr != null) {
      this.jdField_a_of_type_Abbr.b(paramLong);
    }
  }
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    do
    {
      ...
      a(paramVsMusicItemInfo);
      if (this.jdField_a_of_type_Abdg != null) {
        this.jdField_a_of_type_Abdg.b(true);
      }
    } while ((this.jdField_a_of_type_Abbr == null) || (this.jdField_a_of_type_Boolean));
    this.jdField_a_of_type_Abbr.a(a(2));
    this.jdField_a_of_type_Abbr.a(paramVsMusicItemInfo);
  }
  ...
  public void a(List<META.StMusic> paramList)
  {
    ...
    if (((paramList == null) || (paramList.size() == 0)) && (this.jdField_a_of_type_Abdd.a() == 0))
    {
  ...
  public void b()
  {
    ...
    while (this.jdField_a_of_type_Abbr == null) {
      return;
    }
    if (this.jdField_a_of_type_Abdg != null)
    {
