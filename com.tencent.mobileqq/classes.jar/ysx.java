...
public class ysx
  implements Runnable
{
  public ysx(ApolloGameInvitation paramApolloGameInvitation) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (new File(((StringBuilder)localObject1).toString()).exists()) {
        ...
        localObject1 = BitmapManager.b(BaseApplicationImpl.getApplication().getResources(), 2130838152);
      }
    }
    ...
    while (localException != null)
    {
      ...
      try
      {
        ...
        WXShareHelper.a().a(new ysy(this));
