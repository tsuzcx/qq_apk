...
public class bdzg
{
  private bdze jdField_a_of_type_Bdze = new bdze();
  ...
  private List<String> a(QQAppInterface paramQQAppInterface)
  {
    ...
    localArrayList.add(alof.aX + paramQQAppInterface + File.separator);
  ...
  private void a(String paramString)
  {
    ...
    {
      paramString = new File(bdzf.a(paramString));
  ...
  private void c(Context paramContext)
  {
    ...
    Iterator localIterator = bdzj.a.iterator();
  ...
  private void d()
  {
    for (;;)
    {
      try
      {
        File[] arrayOfFile = new File(alof.aX).listFiles();
        if (arrayOfFile == null) {
          return;
        }
  ...
  public final void a()
  {
    Iterator localIterator = bdzj.b.iterator();
    while (localIterator.hasNext()) {
  ...
  public void a(Context paramContext)
  {
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        this.jdField_a_of_type_Bdze.reportError(new Throwable("FileSystemManager proxy", paramContext));
  ...
  public void b(Context paramContext)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      FileSystemManager.setStatisticsCallback(this.jdField_a_of_type_Bdze);
    }
    if (BaseApplicationImpl.sProcessId == 1) {}
    for (;;)
    {
