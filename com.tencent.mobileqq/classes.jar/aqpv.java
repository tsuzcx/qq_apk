  ...
  implements axne
{
  ...
  public aqpv(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private void a(QQAppInterface paramQQAppInterface, SingTogetherSession paramSingTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.SingChangePushInfo paramSingChangePushInfo)
  {
    axmt localaxmt = (axmt)paramQQAppInterface.getManager(339);
    localaxmt.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    Object localObject = (SingTogetherSession)localaxmt.a(paramSingTogetherSession.jdField_d_of_type_Int, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString);
    if (localObject != null)
    {
      ...
      if (((paramInt == 1) || (paramInt == 2) || (paramInt == 5)) && (!TextUtils.isEmpty(paramSingTogetherSession.jdField_f_of_type_JavaLangString))) {
    ...
    for (;;)
    {
      if (paramInt == 1)
      {
        axng.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
        label160:
        if (paramSingTogetherSession.jdField_e_of_type_Int != 2) {
          break label302;
        }
        localObject = ((ajjj)paramQQAppInterface.getManager(51)).b(paramSingTogetherSession.jdField_e_of_type_JavaLangString);
      ...
      {
        return;
        localaxmt.a(paramSingTogetherSession.jdField_d_of_type_Int, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramSingTogetherSession);
        break;
        if (paramInt == 2)
        {
          paramSingTogetherSession.g = 3;
          paramSingTogetherSession.h = 3;
          axng.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
          break label160;
        }
      ...
      localObject = localaxmt.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      ((axmz)localObject).jdField_a_of_type_AndroidOsBundle.putInt("action_type", paramInt);
      ((axmz)localObject).jdField_a_of_type_AndroidOsBundle.putString("tips", paramString);
      ((axmz)localObject).jdField_a_of_type_AndroidOsBundle.putLong("seq", paramLong2);
      ((axmz)localObject).jdField_a_of_type_AndroidOsBundle.putLong("msgSeq", paramLong3);
      ((axmz)localObject).jdField_a_of_type_JavaLangObject = paramSingChangePushInfo;
      ...
      localaxmt.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      return;
      label445:
      paramSingTogetherSession = (SingTogetherSession)localObject;
    }
  ...
  private void a(boolean paramBoolean, SingTogetherSession paramSingTogetherSession, int paramInt, String paramString)
  {
    axmt localaxmt = (axmt)this.a.getManager(339);
    axmz localaxmz = localaxmt.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003))
    {
      ...
      localaxmt.a(paramSingTogetherSession, i, str, l1, l2, localaxmz.jdField_a_of_type_JavaLangObject);
      localaxmt.b(paramSingTogetherSession, i, str, l1, l2, localaxmz.jdField_a_of_type_JavaLangObject);
    }
    if (paramSingTogetherSession.g == 3) {
      axng.a(this.a, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
    }
    for (;;)
    {
      localaxmt.a(paramBoolean, paramSingTogetherSession, paramInt, paramString);
      localaxmt.b(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      axng.a(this.a, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
    }
  }
    ...
    do
    {
      ...
      if (localSingChangePushInfo != null)
      {
        ...
        for (paramObject = localSingChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((axmt)paramQQAppInterface.getManager(339)).a(4, 1, l2);
          if (l1 >= l4) {
            break label353;
          }
          if (!QLog.isColorLevel()) {
        ...
        SingTogetherSession localSingTogetherSession = (SingTogetherSession)axng.a(4, 1, String.valueOf(l2));
        if ((i == 1) || (i == 2) || (i == 5)) {
          if (l3 != -1L) {
            break label496;
          }
        ...
        for (String str = "";; str = String.valueOf(l3))
        {
          ...
          aqqn.a(paramQQAppInterface, l2, 1, paramObject, i, paramLong1, paramLong2, 131087);
          return;
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      l4 = ((axmt)paramQQAppInterface.getManager(339)).a(4, 2, l2);
      if (l3 >= l4) {
        break label670;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    label670:
    SingTogetherSession localSingTogetherSession = (SingTogetherSession)axng.a(4, 2, String.valueOf(l2));
    if ((j != 1) && (j != 2))
    {
      if (j != 5) {
        break label852;
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        aqqn.a(paramQQAppInterface, l2, 0, paramArrayOfByte, j, paramLong1, paramLong2, 131087);
        return;
        do
        {
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    label131:
    boolean bool2 = false;
    Object localObject3 = (axmt)this.a.getManager(339);
    paramToServiceMsg = (SingTogetherSession)((axmt)localObject3).a(4, j, (String)localObject2);
    Object localObject1 = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject1 = (SingTogetherSession)axng.a(4, j, (String)localObject2);
      ((axmt)localObject3).a(4, j, (String)localObject2, (axnf)localObject1);
    }
    boolean bool1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (!TextUtils.isEmpty(((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString))
          {
            ...
            babh.p(this.a, ((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString);
            bool2 = bool1;
            paramRspLatestPlayingState = paramToServiceMsg;
          }
          label815:
      ...
      for (paramToServiceMsg = ((aio_media.ResultInfo)localObject2).bytes_errmsg.get().toStringUtf8();; paramToServiceMsg = "")
      {
        ...
        babh.h(this.a, ((SingTogetherSession)localObject1).jdField_e_of_type_JavaLangString, ((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString);
        paramRspLatestPlayingState = paramToServiceMsg;
        bool2 = bool1;
        break label815;
        break label958;
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      paramObject = ((axmt)this.a.getManager(339)).a(4, 2, String.valueOf(paramObject));
    } while (!(paramObject instanceof SingTogetherSession));
    paramObject.g = 3;
    paramObject.h = 3;
    axng.a(this.a, paramObject.jdField_e_of_type_JavaLangString, false, paramObject.jdField_e_of_type_Int, 16777216);
    a(true, (SingTogetherSession)paramObject, 1007, "");
  }
  
  public void a(String paramString, int paramInt)
  {
    paramString = ((axmt)this.a.getManager(339)).a(4, 1, paramString);
    if ((paramString instanceof SingTogetherSession))
    {
      paramString.g = 3;
      paramString.h = 3;
      axng.a(this.a, paramString.jdField_e_of_type_JavaLangString, false, paramString.jdField_e_of_type_Int, 16777216);
