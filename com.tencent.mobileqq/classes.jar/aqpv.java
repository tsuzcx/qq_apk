  ...
  extends aqkz<aqpu>
{
  ...
  public static aqpu a()
  {
    return (aqpu)aqlk.a().a(425);
  }
  ...
  @NonNull
  public aqpu a(int paramInt)
  {
    return new aqpu();
  }
  
  @Nullable
  public aqpu a(aqlg[] paramArrayOfaqlg)
  {
    if ((paramArrayOfaqlg != null) && (paramArrayOfaqlg.length > 0))
    {
      new aqpu();
      return aqpu.a(paramArrayOfaqlg);
    }
    return null;
  }
  
  public void a(aqpu paramaqpu)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MiniAppConfProcessor", 2, "onUpdate " + paramaqpu.toString());
    }
    paramaqpu = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramaqpu instanceof QQAppInterface))
    {
      paramaqpu = (MiniAppEntryHandler)((QQAppInterface)paramaqpu).a(149);
      if (paramaqpu != null) {
        paramaqpu.notifyUI(0, true, null);
      }
    }
  }
  
  public Class<aqpu> clazz()
  {
    return aqpu.class;
  }
