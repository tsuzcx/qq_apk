...
public class aqpv
{
  ...
  private HashMap<String, aqqs> jdField_a_of_type_JavaUtilHashMap;
  ...
  private aqqp a(String paramString1, int paramInt, String paramString2, MessageRecord paramMessageRecord)
  {
    ...
    paramString2 = new aqqp(this, paramString2, paramString1, paramInt, paramMessageRecord);
    paramString1 = paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFilePath");
    if (a(paramString1)) {
      if (paramInt == 0) {
        paramString1 = new aqqd(this, paramMessageRecord);
      }
    }
    for (;;)
    {
      ...
      if (paramInt == 3000)
      {
        paramString1 = new aqqm(this, paramMessageRecord);
      }
      else if (paramInt == 1)
      {
        paramString1 = new aqqw(this, paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName"), paramString1, null);
      }
      else
      {
        do
        {
          do
          {
            ...
            if (paramInt == 0)
            {
              paramString1 = new aqpx(this, paramMessageRecord);
              break;
            }
            if (paramInt == 3000)
            {
              paramString1 = new aqpz(this, paramMessageRecord);
              break;
            }
          } while (paramInt != 1);
          paramString1 = new aqqb(this, paramMessageRecord);
          break;
          if (paramInt == 0)
          {
            paramString1 = new aqqg(this, paramMessageRecord);
            break;
          }
          if (paramInt == 3000)
          {
            paramString1 = new aqqi(this, paramMessageRecord);
            break;
          }
        } while (paramInt != 1);
        paramString1 = new aqqk(this, paramMessageRecord);
      }
    }
    if (paramInt == 0) {
      paramInt = 3;
    ...
    for (;;)
    {
      paramString1 = new aqqu(this, paramMessageRecord, paramInt, null);
      break label76;
      if (paramInt == 3000)
      {
        paramInt = 106;
  ...
  private static void b(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, aqqr paramaqqr)
  {
    if (paramaqqr == null)
    {
    ...
    ypf.a(paramQQAppInterface, paramLong1, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, new aqpw(paramString, paramaqqr, paramLong2));
  }
  ...
  public void a(aqya paramaqya, HashMap<String, ArrayList<MessageRecord>> paramHashMap)
  {
    if ((paramHashMap == null) || (paramHashMap.size() <= 0)) {
      QLog.i("FileMultiMsgManager<FileAssistant>", 1, "addMultiFileUploadRequest: file message record list is null");
    }
    this.jdField_a_of_type_AndroidOsHandler.post(new QFileMsgForwardManager.1(this, paramaqya));
  }
  
  public void a(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    if (aroo.a(paramMessageRecord1)) {
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        continue;
        paramMessageRecord1 = (MessageForTroopFile)arni.a((ChatMessage)paramMessageRecord1);
        paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1).a);
        continue;
      }
      Object localObject;
      ...
      else if ((paramMessageRecord1 instanceof MessageForTroopFile))
      {
        ...
        localObject = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1);
        if (localObject != null)
        {
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_750_", ((bbpe)localObject).c);
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_384_", ((bbpe)localObject).d);
          if (((paramMessageRecord1.width == 0) || (paramMessageRecord1.height == 0)) && (((bbpe)localObject).e > 0) && (((bbpe)localObject).f > 0))
          {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgWidth", String.valueOf(paramMessageRecord1.width));
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgHeight", String.valueOf(paramMessageRecord1.height));
          }
          paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", ((bbpe)localObject).a);
          if ((((bbpe)localObject).b == 2) || (((bbpe)localObject).b == 3)) {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardStatusPaused", "1");
          }
        }
      }
