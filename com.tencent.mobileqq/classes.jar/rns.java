...
{
  public rns(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void OnCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 0)
    {
      ...
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131436587), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.getHandler(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131436588), 0).b(this.a.getTitleBarHeight());
  }
}
