  ...
  implements bfsh
{
  ...
  public agmz(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Agnt.a(paramInt);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      while (i >= paramInt2)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Agnt.a(i), this.jdField_a_of_type_Boolean);
    ...
    if (i < j)
    {
      ...
      localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Agnt.a(i);
      ...
      if (PhotoListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity))
      {
        if (vtz.a().a().isEmpty())
        {
          ...
          if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.getHeight() - ((View)localObject).getY() < this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_Int)) {
            this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.smoothScrollBy(vtz.jdField_a_of_type_Int, 500);
          }
        }
        vtz.a().b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_JavaUtilArrayList, PhotoListActivity.jdField_a_of_type_JavaUtilHashMap);
      }
