  ...
  extends axuq
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int i = actj.a(10.0F, localResources);
    if (paramView == null)
    {
      paramBundle = new LinearLayout(paramContext);
      paramBundle.setOrientation(1);
      axyr localaxyr = new axyr(null);
      paramBundle.setTag(2131373585, localaxyr);
      ...
      if (paramView == null)
      {
        ...
        paramContext.setCompoundDrawablePadding(actj.a(5.0F, localResources));
        localObject = localResources.getDrawable(2130846409);
        ((Drawable)localObject).setBounds(0, 0, actj.a(18.0F, localResources), actj.a(10.0F, localResources));
        ...
        localaxyr.jdField_a_of_type_AndroidWidgetTextView = paramView;
        localaxyr.b = localTextView;
        localaxyr.jdField_a_of_type_AndroidWidgetImageView = localImageView;
        localaxyr.c = paramContext;
        localaxyr.jdField_a_of_type_AndroidWidgetLinearLayout = paramBundle;
        paramView = localaxyr;
    ...
    for (;;)
    {
      ...
      paramView = (axyr)paramContext.getTag(2131373585);
      break label443;
      label517:
      paramContext.setPadding(0, 0, 0, 0);
      break label462;
      label528:
      i = actj.a(24.0F, localResources);
      try
      {
        ...
        paramBundle.setDecodeHandler(bavw.a);
        ...
        paramView.c.setText(ajya.a(2131714621));
