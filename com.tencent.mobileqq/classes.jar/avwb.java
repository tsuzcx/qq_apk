...
public class avwb
{
  ...
  public avwb(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Avwf = new avwf();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Avwf.a((RelativeLayout)localView.findViewById(2131362136));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new avwd(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new avwd(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new avwc(this));
            if (j == 0) {
