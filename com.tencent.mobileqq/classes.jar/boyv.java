...
public final class boyv
{
  ...
  public static void a(Bitmap paramBitmap, boyz paramboyz)
  {
    a(paramBitmap, paramboyz, false);
  }
  
  public static void a(Bitmap paramBitmap, boyz paramboyz, boolean paramBoolean)
  {
    if (paramboyz == null) {
      return;
    }
    ...
    a(new FaceChangeUtils.5(paramBitmap, paramboyz), paramBoolean, "GLThread-cropFace");
  }
  
  public static void a(Bitmap paramBitmap, List<String> paramList, boyw paramboyw)
  {
    if ((paramBitmap == null) || (paramList == null) || (paramList.isEmpty()))
    {
      ...
      paramboyw.a(new ArrayList());
      return;
    }
    a(new FaceChangeUtils.2(paramList, paramBitmap, paramboyw), false, "GLThread-changeFaceBatch");
  }
  ...
  private static boyx b(Bitmap paramBitmap, String paramString)
  {
    if ((paramBitmap == null) || (paramString == null))
    {
      bpam.d("FaceChangeUtils", "changeFaceInternal---null parameters: userFace, materialDir");
      return boyx.a(-1, "null parameters, material=" + paramString);
    }
    ...
    {
      bpam.d("FaceChangeUtils", "changeFaceInternal---failed to parse CrazyFace: " + paramString);
      return boyx.a(-2, "failed to parse material, material=" + paramString);
    }
    ...
    {
      bpam.d("FaceChangeUtils", "changeFaceInternal---failed to detect face");
      return boyx.a(-3, "failed to detect face");
    }
    Object localObject3 = a(((PTFaceAttr)localObject1).getAllFacePoints(), ((PTFaceAttr)localObject1).getFaceDetectScale());
    if (((List)localObject3).isEmpty())
    {
      bpam.d("FaceChangeUtils", "changeFaceInternal---userFacePointsList is empty");
      return boyx.a(-4, "no face points");
    }
    ...
    bpam.b("FaceChangeUtils", "success : + result");
    return boyx.a(paramString);
  }
  ...
  private static void c(Bitmap paramBitmap, boyz paramboyz)
  {
    ...
    paramboyz.a((Bitmap)localObject2);
  }
}
