...
public class nji
  implements Runnable
{
  public nji(NewFriendsPlayMode paramNewFriendsPlayMode, boolean paramBoolean, StoryVideoItem paramStoryVideoItem, String paramString, VideoListFeedItem paramVideoListFeedItem) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryPlaymodeChildNewFriendsPlayMode.a().a(2131433083).a(new njj(this, this.jdField_a_of_type_ComTencentBizQqstoryPlaymodeChildNewFriendsPlayMode)).a((ShareModeBase)localObject).a();
      if (!this.jdField_a_of_type_Boolean) {
        break label138;
      }
    }
