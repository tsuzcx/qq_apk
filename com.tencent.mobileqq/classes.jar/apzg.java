  ...
  extends ArkPlayer
{
  ...
  private static final Set<WeakReference<apzg>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  ...
  static
  {
    jdField_a_of_type_ComTencentArkArk$PlayerStubFactory = new apzh();
  }
  ...
  public static void a()
  {
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (apzg)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((apzg)localObject2).c();
          }
        }
