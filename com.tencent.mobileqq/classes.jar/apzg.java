...
public class apzg
  extends apxc
{
  public apzg(ExtendFriendEditFragment paramExtendFriendEditFragment) {}
  ...
  protected void a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      apwx localapwx = (apwx)this.a.getActivity().app.getManager(264);
      this.a.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment$ExtendFriendInfo.jdField_a_of_type_Long = localapwx.c();
  ...
  protected void a(boolean paramBoolean, apyo paramapyo, int paramInt)
  {
    if ((paramBoolean) && (paramapyo != null)) {
      this.a.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment.a(ExtendFriendEditFragment.a(this.a).app, paramapyo);
    }
  }
