...
public class ajai
  extends anmu
{
  public ajai(SystemMsgListView paramSystemMsgListView) {}
  ...
  public void onGetConnectionsPerson(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramBoolean)
    {
      localaixu = SystemMsgListView.a(this.a).a();
      if ((localaixu != null) && (localaixu.a()) && (localaixu.a == paramInt2) && (!SystemMsgListView.a(this.a, paramInt2, paramInt3))) {
