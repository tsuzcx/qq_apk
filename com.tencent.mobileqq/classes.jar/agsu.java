  ...
  implements azgc
{
  ...
  public agsu(MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  public static void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if (paramMessageRecord != null)
    {
      ...
      agwj.a(paramQQAppInterface, paramMessageRecord);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    if (bool)
    {
      ((azfo)paramQQAppInterface.getManager(223)).a(new agsu(paramMessageForQQWalletMsg), false);
      return true;
    }
    return false;
  }
  ...
  public static boolean a(Object paramObject, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((i == 7) || (i == 8) || (i == 11) || (i == 12))
    {
      ...
      if ((!agqo.a().a()) && (!paramQQAppInterface.c().equals(paramObject.senderuin)))
      {
  ...
  public void a(BaseChatPie paramBaseChatPie, axbz paramaxbz)
  {
    agwj.a(agwj.a(), "212", "only.animation.show");
    String str = agss.a() + this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.body.feedId + ".zip";
    ...
    paramaxbz = new agsv(this, paramaxbz);
    this.jdField_a_of_type_JavaLangRunnable = new SpecifyRedPacketAnimMsg.2(this, paramaxbz);
    ThreadManager.getUIHandler().postDelayed(this.jdField_a_of_type_JavaLangRunnable, 10000L);
    PreloadManager.a().c(str, new agsw(this, localWeakReference, paramaxbz, paramBaseChatPie));
  }
