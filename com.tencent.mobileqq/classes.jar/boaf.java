...
import dov.com.qq.im.aeeditor.module.filter.AEEditorResourceManager.5;
...
public final class boaf
  extends bnuu
{
  private static volatile boaf jdField_a_of_type_Boaf;
  ...
  private final int b = ((Integer)bobx.b(Integer.valueOf(3), Integer.valueOf(5), Integer.valueOf(7))).intValue();
  ...
  static
  {
    jdField_d_of_type_JavaLangString = bnss.b + File.separator + "frame";
  }
  
  private boaf()
  {
    super("camera/ae_camera_editor_download_resources.json", bnss.b, 4, "AEEditorResourceManager");
    this.jdField_d_of_type_JavaUtilMap = new LinkedHashMap();
  }
  
  public static boaf a()
  {
    if (jdField_a_of_type_Boaf == null) {}
    try
    {
      if (jdField_a_of_type_Boaf == null) {
        jdField_a_of_type_Boaf = new boaf();
      }
      return jdField_a_of_type_Boaf;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      bnrh.b("AEEditorResourceManager", "setupFrameEnv---pag file is already copied");
      return;
    }
  ...
  private void e()
  {
    bnrh.b(this.jdField_c_of_type_JavaLangString, "setupDisplayFilterList--BEGIN");
    QIPCClientHelper.getInstance().callServer("AEEditorEffectIpcModule", "action_get_effect_list", new Bundle(), new boag(this));
  }
  ...
  private void f()
  {
    synchronized (this.e)
    {
      ...
      {
        bnrh.d(this.jdField_c_of_type_JavaLangString, "setupFontListConfig---read assets json content empty");
        return;
      }
    }
    Object localObject2 = (List)GsonUtils.json2Obj(str2, new boai(this).getType());
  ...
  private void g()
  {
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaUtilMap)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          bnrh.d(this.jdField_c_of_type_JavaLangString, "ensureSetupPagStickerConfig---read assets json content empty");
      ...
      localObject2 = (AEEditorPagStickerGroupWrapper)GsonUtils.json2Obj(str, new boaj(this).getType());
      if ((localObject2 == null) || (CollectionUtils.isEmpty(((AEEditorPagStickerGroupWrapper)localObject2).stickerGroupList)))
      {
        localObject2 = new LinkedList();
        bnrh.d(this.jdField_c_of_type_JavaLangString, "ensureSetupPagStickerConfig---parsed result invalid");
      }
      else
      {
    ...
    {
      bnrh.b((String)localObject3, localObject2);
      return;
  ...
  public Pair<String, String> a(@NonNull String paramString, int paramInt)
  {
    ...
    for (localObject = b((AEEditorDownloadResBean)localObject);; localObject = null)
    {
      ...
      {
        bnrh.d("AEEditorResourceManager", "font not find.");
      ...
      if (b(paramString))
      {
        bnrh.d("AEEditorResourceManager", "fontExceededLimit.");
  ...
  {
    return (AEEditorPagStickerConfig)GsonUtils.json2Obj(b(paramString), new boak(this).getType());
  }
    ...
    if (a().getValue() != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localAEEditorFilterBean.getEditorEffectItem().getPreDownload() == 1) {
          paramList.add(bnut.a(localAEEditorFilterBean));
        }
      }
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, String paramString)
  {
    ...
    {
      if (!TextUtils.isEmpty(str1)) {
        bnqm.a().a(paramBoolean, 3, str1, paramString, paramInt, paramLong);
      }
      return;
  ...
  {
    return a(bnut.a(paramAEEditorFilterBean)) + File.separator + "effectInfo.json";
  }
  ...
  public String c(AEEditorFilterBean paramAEEditorFilterBean)
  {
    ...
    if (!TextUtils.isEmpty(paramAEEditorFilterBean.getEffectExtendBean().getMotionID())) {
      str = a(bnut.a(paramAEEditorFilterBean)) + File.separator + paramAEEditorFilterBean.getEffectExtendBean().getMotionID();
    }
    return str;
  }
