  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  akly jdField_a_of_type_Akly;
  akmd jdField_a_of_type_Akmd = new akmd();
  ...
  private hg jdField_a_of_type_Hg = new hg();
  ...
  private akmf[] jdField_a_of_type_ArrayOfAkmf = new akmf[300];
  ...
  public akme(aklt paramaklt)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Aklt = paramaklt;
    this.jdField_a_of_type_Akly = paramaklt.a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Akmd.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130843989, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Aklt.a().getResources(), 2130843990, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Akly.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Akly.c = 0L;
    this.jdField_a_of_type_Akly.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Akmd != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Akmd.a(paramSize.getHeight(), paramSize.getWidth(), akwv.jdField_a_of_type_Int, akwv.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localakmf2 = this.jdField_a_of_type_ArrayOfAkmf[i4];
      if ((localakmf2 != null) && (!localakmf2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localakmf2.jdField_b_of_type_Float * 0.35F - Math.abs(localakmf2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localakmf2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localakmf2 != null)
        {
          localakmf1 = localakmf2;
          i3 = i2;
          if (!localakmf2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localakmf2.jdField_b_of_type_Float;
      localakmf2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localakmf2.jdField_b_of_type_Float + f2 + f4);
      if (localakmf2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localakmf2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localakmf2 == null)
      {
        localakmf1 = new akmf(this);
        this.jdField_a_of_type_ArrayOfAkmf[i4] = localakmf1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localakmf1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localakmf1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localakmf1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localakmf1 == null) || (localakmf1.jdField_a_of_type_Boolean) || (localakmf1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAkmf[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAkmf[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localakmf1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        a(this.jdField_a_of_type_ArrayOfFloat, this.jdField_a_of_type_Hg.a(), this.jdField_a_of_type_Hg.d(), this.jdField_a_of_type_Hg.b(), paramGL10, this.jdField_a_of_type_Hg.b(), this.jdField_a_of_type_Hg.c());
        a(0, this.jdField_a_of_type_Hg.a());
        d();
        e();
        f();
      ...
      if (this.jdField_a_of_type_Akly.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Akly.c > this.jdField_a_of_type_Akly.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Akly;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Akmd != null) && (this.u == 2)) {
        this.jdField_a_of_type_Akmd.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
