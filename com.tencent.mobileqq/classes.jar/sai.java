...
{
  public sai(ChatSettingForTroop paramChatSettingForTroop) {}
        ...
        try
        {
          ...
          if (TextUtils.equals(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, paramContext))
          {
            ...
            if ("troopProfile".equals(str1)) {
              ThreadManager.post(new saj(this, str3, str2, i, str4, (String)localObject), 8, null, false);
            }
            ...
            if ("bindGames".equals(paramIntent))
            {
              ...
              try
              {
                ...
                ThreadManager.post(new sak(this, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin), 5, null, false);
                return;
              }
