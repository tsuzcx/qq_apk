...
public class aobq
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aobr(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private anxj jdField_a_of_type_Anxj = new aobs(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public aobq(String paramString)
  {
    try
    {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Anxj);
    }
    try
    {
