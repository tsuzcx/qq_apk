...
public class bpqr
{
  private static bpqr jdField_a_of_type_Bpqr;
  ...
  public static bpqr a()
  {
    if (jdField_a_of_type_Bpqr == null) {}
    try
    {
      if (jdField_a_of_type_Bpqr == null) {
        jdField_a_of_type_Bpqr = new bpqr();
      }
      return jdField_a_of_type_Bpqr;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                zfn.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + zfn.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
