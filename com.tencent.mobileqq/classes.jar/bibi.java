  ...
  implements View.OnClickListener
{
  ...
  public bibi(@NonNull bigb parambigb)
  {
    super(parambigb);
  ...
  public void a()
  {
    ...
    d();
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)a(2131310022));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131310017));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131310018));
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)a(2131301454));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new bibj(this));
  }
  
  public void a(@NonNull bitz parambitz)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_Boolean)
      {
        parambitz.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
        parambitz.a.d = this.jdField_a_of_type_Boolean;
        if (QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_Bigb.jdField_a_of_type_Int == 21)
    {
      ...
      if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      ...
      paramInt = (int)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131310018: 
      do
      {
        return;
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      } while (this.jdField_a_of_type_Bigb.jdField_a_of_type_Int != 21);
      this.jdField_a_of_type_Bigb.a(0);
      return;
    }
    a();
