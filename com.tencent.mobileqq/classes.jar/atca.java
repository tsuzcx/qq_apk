  ...
  extends WebViewPlugin
{
  ...
  public long a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new atcf(this);
  protected Context a;
  private Handler jdField_a_of_type_AndroidOsHandler = new atcd(this, Looper.getMainLooper());
  ...
  private void a(long paramLong, String paramString)
  {
    ...
    this.jdField_a_of_type_Atbj.a(str + "/av_" + System.currentTimeMillis() + this.jdField_a_of_type_Atbj.a(), new atcc(this));
    ...
    catch (JSONException paramString2)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          atbn.a(paramString2, this.e, String.valueOf(this.jdField_a_of_type_Long), this.jdField_a_of_type_JavaLangString, str1, (String)localObject1, String.valueOf(this.jdField_b_of_type_Long), this.jdField_b_of_type_JavaLangString, new atce(this, paramLong, paramString1));
          return;
  ...
  {
    int i = this.jdField_a_of_type_Atbj.c();
  ...
  {
    atcg.a.jdField_a_of_type_Int = -1;
    if (paramString == null) {
      return;
    }
    JSONObject localJSONObject = new JSONObject();
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            ...
            {
              bdne.b(this.mRuntime.a().getApp().getApplicationContext());
              atcg.a.a(this.mRuntime.a(), paramString1.getQueryParameter("p"));
              a(this.d, 0);
            ...
            {
              atcg.a.b(this.mRuntime.a(), paramString1.getQueryParameter("p"));
              this.d = paramJsBridgeListener;
              if (atcg.a.jdField_a_of_type_Int != -1)
              {
                a(this.d, atcg.a.jdField_a_of_type_Int);
                return false;
              }
              atcg.a.a(this.mRuntime.a(), new atcb(this));
              return false;
            }
          }
        }
    ...
    atcg.a.jdField_a_of_type_Boolean = false;
    atcg.a.a(11, null);
    return false;
  }
  ...
  public void onCreate()
  {
    ...
    a(" onCreate");
    this.jdField_a_of_type_Atbj = new atbj(this.jdField_a_of_type_AndroidContentContext, 1);
    this.jdField_a_of_type_Aszh = new aszh();
    ...
    IntentFilter localIntentFilter = new IntentFilter(atav.a(this.f));
    localIntentFilter.addAction(atav.b(this.f));
    localIntentFilter.addAction(atav.c(this.f));
    localIntentFilter.addAction(atav.d(this.f));
