  ...
  extends QQCustomDialog
{
  ...
  public bfmy(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bfnc(this);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    requestWindowFeature(1);
    paramActivity = new ColorDrawable();
    paramActivity.setAlpha(0);
    getWindow().setBackgroundDrawable(paramActivity);
    setContentView(2131559520);
    this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new bfnd(this);
    this.jdField_b_of_type_Boolean = bibr.b();
    biby.a();
    setOnKeyListener(new bfmz(this));
    a();
    bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 1, 100));
    bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 2, 100));
    bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 3, 100));
    bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 4, 100));
    bhwl.a().a(16, bhwn.a(10010, jdField_b_of_type_Int, 1, 100));
    bhwl.a().a(16, bhwn.a(10010, jdField_b_of_type_Int, 2, 100));
    bhwl.a().a(16, bhwn.a(10010, jdField_b_of_type_Int, 3, 100));
    bhwl.a().a(16, bhwn.a(10010, jdField_b_of_type_Int, 4, 100));
    if (jdField_b_of_type_Int == 2)
    {
      bcef.b(null, "dc00898", "", "", "0X8008F7F", "0X8008F7F", 0, 0, "", "", "", "");
      return;
    }
    bcef.b(null, "dc00898", "", "", "0X8008F82", "0X8008F82", 0, 0, "", "", "", "");
  }
  ...
  {
    jdField_c_of_type_Boolean = bfyr.a();
  ...
  private void a(int paramInt)
  {
    ...
    default: 
      return;
    case 2: 
      this.f.setText(amtj.a(2131706685));
      return;
    case 1: 
    case 20: 
      this.f.setText(amtj.a(2131706697));
      return;
    case 3: 
      this.f.setText(amtj.a(2131706695));
      return;
    case 4: 
      this.f.setText(amtj.a(2131706699));
      return;
    }
    this.f.setText(amtj.a(2131706692));
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    Object localObject1 = bfng.a().a();
    if ((localObject1 == null) || (((UpgradeDetailWrapper)localObject1).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo == null) || (((UpgradeDetailWrapper)localObject1).jdField_a_of_type_Bfnl == null))
    {
      bhzt.a().a(amtj.a(2131706689));
      return false;
    }
    Bundle localBundle = new Bundle();
    localBundle.putInt("sdkShowNotification", 0);
    localBundle.putBoolean("showNetworkDialog", false);
    localBundle.putString("appName", ((UpgradeDetailWrapper)localObject1).jdField_a_of_type_Bfnl.jdField_a_of_type_JavaLangString);
    ...
    int j = ((UpgradeDetailWrapper)localObject1).jdField_a_of_type_Bfnl.jdField_a_of_type_Int;
    int i = j;
    if (j == 999) {
      i = 718;
    }
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if ((localObject1 != null) && (((File)localObject1).exists()))
      {
        ...
        bibs.a(localBundle, "biz_src_jc_update", bfng.a().a().jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail);
        return true;
      }
    }
    if ((bibr.h()) || (bicl.a().g())) {
    ...
    {
      return true;
      UpgradeDetailActivity.a(paramActivity, bfng.a().a(), false, true, true);
    }
  }
  ...
  private void e()
  {
    bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 3, 300));
    bhwl.a().a(21, bhwn.a(10010, jdField_b_of_type_Int, 3, 300));
    DownloadInfo localDownloadInfo = biby.a().a("1101070898");
    biby.a().c(localDownloadInfo);
  }
  ...
  private void g()
  {
    ...
    {
      if (!bhzh.b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get())) {
        bhzt.a().a(amtj.a(2131706684));
      }
    }
    else {
      return;
    ...
    a(2);
    biby.a().a(biby.a().a("1101070898"));
  }
  
  private void h()
  {
    bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 3, 200));
    bhwl.a().a(17, bhwn.a(10010, jdField_b_of_type_Int, 3, 200));
    if (jdField_b_of_type_Int == 2) {
      bcef.b(null, "dc00898", "", "", "0X8008F81", "0X8008F81", 0, 0, "", "", "", "");
    }
    while (bicl.a().b())
    {
      ...
      return;
      bcef.b(null, "dc00898", "", "", "0X8008F84", "0X8008F84", 0, 0, "", "", "", "");
    }
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        bhzm.b("NewUpgradeDialog", bhwn.a(10010, jdField_b_of_type_Int, 3, 500));
        bhwl.a().a(18, bhwn.a(10010, jdField_b_of_type_Int, 3, 500));
        bicl.a().a((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), "ANDROIDQQ.NEWYYB.QQUPDATE", true);
      }
    }
    for (;;)
    {
  ...
  private void i()
  {
    ...
    if ((localObject == null) || (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo == null) || (((UpgradeDetailWrapper)localObject).jdField_a_of_type_Bfnl == null))
    {
      bhzt.a().a(amtj.a(2131706694));
      return;
    }
    int k = ((UpgradeDetailWrapper)localObject).jdField_a_of_type_Bfnl.jdField_a_of_type_Int;
    int i = k;
    if (k == 999) {
      i = 718;
    }
  ...
  private void j()
  {
    ...
    this.f.setText(amtj.a(2131706688));
  ...
  private void k()
  {
    ...
    if ((localUpgradeDetailWrapper == null) || (localUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo == null) || (localUpgradeDetailWrapper.jdField_a_of_type_Bfnl == null))
    {
      bhzt.a().a(amtj.a(2131706687));
      return;
    }
    Bundle localBundle = new Bundle();
    localBundle.putInt("sdkShowNotification", 0);
    localBundle.putBoolean("showNetworkDialog", false);
    localBundle.putString("appName", localUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_JavaLangString);
    ...
    localBundle.putLong("OuterCall_DownloadApi_DoDownloadActionByMyApp", System.currentTimeMillis());
    localBundle.putBoolean("autoInstall", true);
    int j = localUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_Int;
    int i = j;
    if (j == 999) {
      i = 718;
    }
  ...
  public bfmy a(long paramLong)
  {
    String str = a((float)paramLong, true, 2);
    if (!TextUtils.isEmpty(str)) {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131706691) + str);
    }
    return this;
  }
  
  public bfmy a(DialogInterface.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(new bfnb(this, paramOnClickListener, paramBoolean));
    return this;
  }
  
  public bfmy a(CharSequence paramCharSequence)
  {
  ...
  {
    int i = 100;
    bhzm.c("NewUpgradeDialog", "updateView--progress--" + paramInt1 + " state = " + paramInt2);
  ...
  public bfmy b(CharSequence paramCharSequence)
  {
    if (!TextUtils.isEmpty(paramCharSequence)) {
  ...
  public bfmy c(CharSequence paramCharSequence)
  {
    if (!TextUtils.isEmpty(paramCharSequence)) {
  ...
  public void dismiss()
  {
    try
    {
      ...
      {
        this.jdField_d_of_type_Boolean = false;
        biby.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener);
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380042));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365552));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380038));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365541));
    this.f = ((TextView)findViewById(2131365547));
    ...
    this.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(0);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131368519));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bfna(this));
  }
}
