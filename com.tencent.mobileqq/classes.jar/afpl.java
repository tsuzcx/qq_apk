  ...
  extends BaseAdapter
{
  ...
  public afpl(QQAppInterface paramQQAppInterface, Context paramContext, ChatHistoryBaseFragment paramChatHistoryBaseFragment)
  {
  ...
  private void a(afpn paramafpn, TroopLinkElement paramTroopLinkElement)
  {
    if (!TextUtils.isEmpty(paramTroopLinkElement.iconUrl))
    {
      a(afpn.a(paramafpn), paramTroopLinkElement.iconUrl);
      if (TextUtils.isEmpty(paramTroopLinkElement.title)) {
        break label245;
      }
      afpn.a(paramafpn).setText(paramTroopLinkElement.title);
    }
    for (;;)
    {
      ...
      afpn.b(paramafpn).setText((CharSequence)localObject);
      ...
      afpn.c(paramafpn).setText((CharSequence)localObject);
      afpn.a(paramafpn).setOnClickListener(new afpm(this, paramTroopLinkElement, paramafpn));
      if (!this.jdField_a_of_type_Boolean) {
        break label259;
      }
      afpn.a(paramafpn).setVisibility(0);
      boolean bool = this.b.contains(paramTroopLinkElement);
      afpn.a(paramafpn).setChecked(bool);
      paramTroopLinkElement = (LinearLayout.LayoutParams)afpn.a(paramafpn).getLayoutParams();
      paramTroopLinkElement.setMargins(paramTroopLinkElement.leftMargin, paramTroopLinkElement.topMargin, vms.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), paramTroopLinkElement.bottomMargin);
      afpn.a(paramafpn).setLayoutParams(paramTroopLinkElement);
      return;
      afpn.a(paramafpn).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849110));
      break;
      label245:
      afpn.a(paramafpn).setText(paramTroopLinkElement.url);
    }
    label259:
    afpn.a(paramafpn).setVisibility(8);
    paramTroopLinkElement = (LinearLayout.LayoutParams)afpn.a(paramafpn).getLayoutParams();
    paramTroopLinkElement.setMargins(paramTroopLinkElement.leftMargin, paramTroopLinkElement.topMargin, vms.a(this.jdField_a_of_type_AndroidContentContext, 50.0F), paramTroopLinkElement.bottomMargin);
    afpn.a(paramafpn).setLayoutParams(paramTroopLinkElement);
  }
  ...
  public static void a(ImageView paramImageView, String paramString)
  {
    ...
    Drawable localDrawable = localBaseApplication.getResources().getDrawable(2130838481);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof TroopLinkElement))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof afpn)))
      {
        paramViewGroup = (afpn)paramView.getTag();
    ...
    do
    {
      ...
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493168, null);
      paramViewGroup = new afpn(paramView);
    ...
    for (;;)
    {
      ...
      return paramViewGroup;
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493167, null);
