...
public class aqjq
  implements bkzq
{
  public aqjq(BusinessCardEditActivity paramBusinessCardEditActivity, String paramString, bkzi parambkzi) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqBusinessCardActivityBusinessCardEditActivity.a(2131693230, 1);
        continue;
        if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_JavaLangString.length() > 0))
        {
