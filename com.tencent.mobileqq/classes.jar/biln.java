  ...
  extends bioy
{
  ...
  public biln(List<Friend> paramList)
  {
    Object localObject;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getLayoutInflater().inflate(2131562871, paramViewGroup, false);
      paramView = new bilq();
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131369143));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131379779));
      paramView.b = ((TextView)localView.findViewById(2131379915));
    ...
    while ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      ...
      return localView;
      localObject1 = (bilq)paramView.getTag();
      localView = paramView;
    ...
    if ((((Friend)localObject1).c == null) || ("".equals(((Friend)localObject1).c)))
    {
      ...
      if ((((Friend)localObject1).d == null) || ("".equals(((Friend)localObject1).d))) {
        ((Friend)localObject1).d = biph.a(this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), ((Friend)localObject1).a);
      }
      localObject2 = bipe.a().a(((Friend)localObject1).d);
      ...
      bipe.a().a(((Friend)localObject1).d, new bilo(this, (ImageView)localObject2));
      label274:
      if (!this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a.a(((Friend)localObject1).a)) {
        break label331;
      }
      paramView.b.setText(2131691601);
    }
    for (;;)
    {
      break;
