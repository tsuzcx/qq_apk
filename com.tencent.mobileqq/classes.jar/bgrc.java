...
{
  public bgrc(TroopGiftActionButton paramTroopGiftActionButton, TextView paramTextView) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      paramMotionEvent.setAnimationListener(new bgrd(this));
      ...
      ((ScaleAnimation)localObject).setAnimationListener(new bgre(this, paramMotionEvent));
