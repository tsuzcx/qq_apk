  ...
  extends PopupWindow
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new avba(this);
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private avbb jdField_a_of_type_Avbb;
  private String jdField_a_of_type_JavaLangString;
  
  public avaz(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramContext);
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2131559447, null);
  ...
  private void a(Context paramContext, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363561));
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)paramView.findViewById(2131368178).getLayoutParams();
    ...
    for (;;)
    {
      ...
      setBackgroundDrawable(paramContext.getResources().getDrawable(2130850072));
      return;
