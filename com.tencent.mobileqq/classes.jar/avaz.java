  ...
  extends auzh
{
  ...
  protected void a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("LyricsController", 2, "onLyricModuleSwitchChange, newUserClosed:" + paramBoolean1 + " type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.a.jdField_a_of_type_Avas);
      }
      if ((this.a.jdField_a_of_type_Avas.a(paramInt, paramString)) && (this.a.jdField_a_of_type_Avas.jdField_b_of_type_Boolean != paramBoolean1))
      {
        this.a.jdField_a_of_type_Avas.jdField_b_of_type_Boolean = paramBoolean1;
        avau.a(this.a);
        if ((!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString)) && (!paramBoolean1) && (paramBoolean2))
        {
          avau.a(this.a, this.a.jdField_b_of_type_JavaLangString);
          if (this.a.jdField_a_of_type_JavaLangBoolean != null) {
            avau.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.c, this.a.jdField_a_of_type_JavaLangBoolean.booleanValue());
          }
          avau.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.i);
        }
      }
      if (paramBoolean2) {
  ...
  protected void a(ListenTogetherSession paramListenTogetherSession)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.a.jdField_a_of_type_Avas.a = ((String)localObject1);
      avau.a(this.a);
      return;
    }
  }
  ...
  protected void a(ISong paramISong)
  {
    ...
    avau.a(this.a, paramISong.a());
    this.a.jdField_a_of_type_Avas.a = paramISong.d();
    avau.a(this.a);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      avau.b(this.a, paramString, paramInt);
      bday.a().a();
      return;
      if (paramInt == 3)
      {
  ...
  {
    avau.a(this.a, paramString, paramInt1, paramInt2);
  }
  ...
  protected void a(boolean paramBoolean, ListenTogetherSession paramListenTogetherSession)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Avas.a = paramListenTogetherSession;
      this.a.a(i, str);
      return;
    }
    this.a.b(i, str);
