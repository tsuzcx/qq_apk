    ...
    do
    {
      do
      {
        ...
        if ((this.jdField_a_of_type_ComTencentBizWebviewpluginShare.jdField_a_of_type_AndroidAppActivity instanceof SwiftWebViewFragmentSupporter))
        {
          ...
          {
            paramMessage.a.jdField_a_of_type_AndroidViewView.findViewById(2131366432).setVisibility(8);
            paramMessage.a.jdField_a_of_type_AndroidViewView.findViewById(2131366434).setVisibility(0);
          }
        }
