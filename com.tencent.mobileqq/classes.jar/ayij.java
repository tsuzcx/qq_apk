  ...
  extends ayjm
{
  ...
  public ayij()
  {
    this.jdField_c_of_type_Int = 2131166976;
  ...
  public ayij(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131166976;
    this.jdField_f_of_type_Int = -1;
    this.jdField_a_of_type_ArrayOfInt = new int[3];
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bfua.a((QQAppInterface)localObject3, this.jdField_i_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bfua.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bfua.b(this.jdField_i_of_type_Int)) && (!bfua.c(this.jdField_i_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131696620);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = ayqr.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = ayrd.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new ayqs(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = ayrd.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((ayqs)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = ayrd.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((ayqs)localObject).a(this.jdField_c_of_type_JavaLangString, true);
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699970);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699972);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699970);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699971);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof aydp))
      {
        localObject3 = (aydp)localObject2;
        if (((aydp)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((aydp)localObject3).a();
        if (!(localObject1 instanceof aydo)) {
          break label2491;
        }
      }
      break;
    ...
    label2485:
    label2491:
    for (Object localObject1 = (aydo)localObject1;; localObject1 = null)
    {
      label204:
      Object localObject4;
      switch (((aydp)localObject3).a())
      {
      default: 
        if (d() == 268435456)
        {
          ayrd.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_g_of_type_Int + 1) });
          if (((paramView.getContext() instanceof UniteSearchActivity)) && (aydw.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
          {
            localObject1 = (aydx)aydw.jdField_b_of_type_JavaUtilHashMap.get(this);
            localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ...
      do
      {
        try
        {
          for (;;)
          {
            ((JSONObject)localObject4).put("project", aynt.a());
            ((JSONObject)localObject4).put("event_src", "client");
            ((JSONObject)localObject4).put("obj_lct", ((aydx)localObject1).jdField_a_of_type_Int);
            ((JSONObject)localObject4).put("get_src", "native");
            aynt.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((aydx)localObject1).jdField_a_of_type_Long + "").obj2(((aydx)localObject1).jdField_b_of_type_JavaLangString).ver1(((aydx)localObject1).jdField_a_of_type_JavaLangString).ver2(aynt.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(((JSONObject)localObject4).toString()).session_id(((QQAppInterface)localObject3).getCurrentAccountUin() + aydw.jdField_a_of_type_Long));
            ...
            return;
            ayrd.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_g_of_type_Int, paramView);
            if (this.jdField_l_of_type_Int == 1)
            {
              azmj.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
              azmj.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
              break;
            }
            azmj.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
            azmj.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
            break;
            ayrd.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_g_of_type_Int, paramView);
            break;
            ayrd.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_n_of_type_JavaLangString, e(), e());
            ayrd.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_g_of_type_Int, paramView);
            if ((this.jdField_n_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_n_of_type_JavaLangString)))
            {
              aynt.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            ...
            {
              aynt.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            aynt.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
            QQAppInterface localQQAppInterface;
            JSONObject localJSONObject;
            if ((aydw.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
            {
              localObject4 = (aydx)aydw.jdField_b_of_type_JavaUtilHashMap.get(this);
            ...
            try
            {
              ...
              localJSONObject.put("obj_lct", ((aydx)localObject4).jdField_a_of_type_Int);
              localJSONObject.put("get_src", "web");
              aynt.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((aydx)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(aynt.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + aydw.jdField_a_of_type_Long));
              if (ayrd.a(this.jdField_a_of_type_Long)) {
                if (aydw.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
                {
                  localObject4 = (aydx)aydw.jdField_a_of_type_JavaUtilHashMap.get(this);
                  if (((aydx)localObject4).jdField_b_of_type_Boolean)
                  {
                    i1 = 2;
                    ayrd.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((aydx)localObject4).jdField_b_of_type_JavaLangString + "", ((aydx)localObject4).jdField_a_of_type_Int + "" });
                  }
                }
                else
                {
                  if ((localObject1 == null) || (!((aydo)localObject1).b())) {
                    break label204;
                  }
                  ((aydo)localObject1).a(true);
                  ayrd.a("all_result", "clk_first_result", new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
                }
              }
            }
            catch (JSONException localJSONException2)
            {
              ...
              if (aydw.jdField_b_of_type_Boolean) {}
              for (i1 = 2;; i1 = 1)
              {
                ayrd.a("all_result", "clk_content", i1, 0, new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "", ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
                if ((localObject1 == null) || (!((aydo)localObject1).b())) {
                  break;
                }
                ((aydo)localObject1).a(true);
                ayrd.a("all_result", "clk_first_result", new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
                break;
              }
            }
          }
          ...
          {
            ((aydo)localObject1).a(true);
            ayrd.a("all_result", "clk_tab_first_result", new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
          }
          ayrd.a("all_result", "clk_tab_result", new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "", ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
          break label204;
          if ((localObject1 != null) && (((aydo)localObject1).b()))
          {
            ((aydo)localObject1).a(true);
            ayrd.a("sub_result", "clk_sub_first_result", new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
          }
          ayrd.a("sub_result", "clk_result", new String[] { ((aydp)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), ayrd.a("dynamic_tab_search.1", ((aydp)localObject3).a()) });
        }
        catch (JSONException localJSONException1)
        {
          for (;;)
          ...
          {
            paramView = bdds.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
            if (paramView != null)
            {
              paramView.c();
              return;
        ...
        {
          ayrd.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
          return;
        }
        if (this.jdField_a_of_type_Long == 1001L)
        {
          ...
          if (bcgx.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
          {
      ...
      for (i2 = 113;; i2 = 104)
      {
        ...
        bclo.a(paramView.getContext(), (Bundle)localObject1, 2);
        return;
      }
    }
  }
  ...
  {
    Object localObject = new ayqs(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_g_of_type_JavaLangString = ayrd.a(this.jdField_g_of_type_JavaLangString);
    SpannableString localSpannableString = ((ayqs)localObject).a(this.jdField_g_of_type_JavaLangString);
    localObject = localSpannableString;
    if (localSpannableString == null) {
      localObject = "";
    }
  ...
  {
    boolean bool = false;
    ayqs localayqs = new ayqs(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = ayrd.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localayqs.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localayqs.jdField_a_of_type_Int > 0) {
      bool = true;
    }
    this.h = bool;
    if (localSpannableString == null) {
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new ayqs(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
