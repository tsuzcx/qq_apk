  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Integer, auqd> a;
  
  public auqe(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ajnm = ((ajnm)paramQQAppInterface.a(56));
  }
  ...
  private void a(long[] paramArrayOfLong, auqd paramauqd, String paramString, boolean paramBoolean)
  {
    ThreadManager.post(new NumRedMsgManager.2(this, paramArrayOfLong, paramauqd, paramBoolean, paramString), 5, null, false);
  }
  ...
  {
    boolean bool = bace.a(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "NumRedMsgFileName_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramNumMsgRspBody.toByteArray(), false);
    if (bool) {
  ...
  public void a(NumRedMsg.NumMsgRspBody paramNumMsgRspBody, ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      paramNumMsgRspBody = (auqd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
      if (paramNumMsgRspBody == null) {
        break;
      }
  ...
  public void a(List<Submsgtype0x89.NumRedBusiInfo> paramList, String paramString, auqd paramauqd)
  {
    ThreadManager.post(new NumRedMsgManager.1(this, paramList, paramauqd, paramString), 5, null, false);
  }
  
  public void a(long[] paramArrayOfLong, String paramString, auqd paramauqd)
  {
    a(paramArrayOfLong, paramauqd, paramString, false);
  }
