...
public class mso
{
  ...
  {
    if (QLog.isDevelopLevel()) {
      QLog.w("RedBagReport", 1, "reportClickEvent, key[" + "0X800897F" + "], fromType[" + jdField_a_of_type_Int + "], mSucAboutGame[" + parammsq.jdField_a_of_type_Boolean + "], mExceptionType[" + parammsq.jdField_f_of_type_Int + "], mRoomId[" + jdField_a_of_type_JavaLangString + "]");
    }
    int i = jdField_a_of_type_Int;
    int j = parammsq.jdField_f_of_type_Int;
  ...
  public static void b(msq parammsq)
  {
