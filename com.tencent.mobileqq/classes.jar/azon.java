  ...
  implements View.OnClickListener
{
  ...
  public azon()
  {
    ...
    this.jdField_a_of_type_Ajxl = new azoq(this, null);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    mxi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new azoo(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, acut paramacut, ChatXListView paramChatXListView)
  {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).topMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131372953);
      ((RelativeLayout.LayoutParams)localObject).addRule(11);
      ((RelativeLayout.LayoutParams)localObject).height = bawz.a(this.jdField_a_of_type_AndroidContentContext, 41.0F);
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    int i = bawz.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
    ...
    if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130849555);
    }
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843066);
      ...
      return;
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130849556);
    }
  }
  ...
  public void c()
  {
    ...
    localLayoutParams.leftMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 3.0F);
    localLayoutParams.rightMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 8.0F);
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843067);
    localLayoutParams.leftMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 11.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131697918);
  }
  ...
  public void e()
  {
    ...
    {
      axqw.b(localQQAppInterface, "P_CliOper", "Grp_public", "", "oper", str1, 0, 0, "", "", "", str2);
      return;
