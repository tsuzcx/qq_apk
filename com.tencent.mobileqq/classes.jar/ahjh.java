...
public class ahjh
{
  ...
  private static int a()
  {
    if (c == 0)
    {
      c = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131166799);
      return c;
    }
    return c;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    alrg.a(this.jdField_b_of_type_AndroidGraphicsMatrix, jdField_a_of_type_Boolean, this.jdField_b_of_type_Int, paramInt3, paramInt4, paramInt1, paramInt2);
