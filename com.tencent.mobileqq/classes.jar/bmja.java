  ...
  extends RemoteCommand
{
  ...
  public bmja(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bundle a(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    paramBundle = this.a.getMessageFacade().getMessages(paramOnInvokeFinishLinstener, 1, 100);
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        bdla.b(this.a, "P_CliOper", "BizTechReport", "", "troop_member_card_plugin", "plugin_cmd_exp", 0, 0, paramBundle.getClass().getName(), null, null, null);
        return null;
      }
      ...
      localBundle.putSerializable("card", ((TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER)).a((String)localObject1, paramBundle));
      paramBundle = localBundle;
      continue;
      localObject1 = paramBundle.getString("troopUin");
      localObject2 = paramBundle.getString("memUin");
      paramBundle = (HWTroopMemberCard)paramBundle.getSerializable("card");
      ((TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER)).a((String)localObject1, (String)localObject2, paramBundle);
      paramBundle = localBundle;
      continue;
      localObject1 = paramBundle.getString("troopUin");
      localObject2 = paramBundle.getString("memUin");
      byte b = paramBundle.getByte("flag");
      localBundle.putBoolean("result", ((TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER)).a((String)localObject1, (String)localObject2, b));
      paramBundle = localBundle;
      continue;
      localObject1 = paramBundle.getString("troopUin");
      localObject2 = paramBundle.getString("memUin");
      ...
      ((TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER)).a((String)localObject1, (String)localObject2, str1, i);
      paramBundle = localBundle;
      continue;
      paramBundle = paramBundle.getString("troopCode");
      localObject1 = (TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER);
      this.a.getMessageFacade().clearHistory(paramBundle, 1);
      ((TroopManager)localObject1).a(paramBundle);
      bhdf.a().a(this.a, paramBundle, this.a.getCurrentAccountUin(), this.a.getApp());
      paramBundle = localBundle;
      continue;
      ...
      localObject1 = (anvk)this.a.getManager(QQManagerFactory.FRIENDS_MANAGER);
      localObject2 = ((anvk)localObject1).b(paramBundle);
      if ((localObject2 == null) || (!((Friends)localObject2).isFriend())) {
        break label1420;
      }
      paramBundle = ((anvk)localObject1).a(paramBundle);
    ...
    for (long l1 = bcrg.a();; l1 = 0L)
    {
      ...
      paramBundle.gatherContacts((short)1, (List)localObject2, bool, true);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("uin");
      ...
      if (bhbx.b(paramBundle)) {
        bdla.b(this.a, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
      }
      ...
      ((TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER)).c((String)localObject1, (String)paramBundle.get(0));
      paramBundle = localBundle;
      break;
      localObject1 = paramBundle.getString("troopUin");
      ...
      ((TroopManager)this.a.getManager(QQManagerFactory.TROOP_MANAGER)).a((String)localObject1, (String)localObject2, str1, i, str2, str3, j, k, m, l1, l2);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((aoep)this.a.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).l(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((aoep)this.a.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).k(paramBundle);
      paramBundle = localBundle;
      break;
      localObject1 = paramBundle.getString("uin");
      paramBundle = "";
      localObject1 = axlr.a(this.a, (String)localObject1, false);
      if (localObject1 != null)
      {
        if (((axms)localObject1).a == 1L) {
          paramBundle = this.a.getApp().getString(2131693302);
        }
        for (;;)
        {
          i = ((axms)localObject1).c;
          localBundle.putString("bind_name", paramBundle);
          localBundle.putInt("bind_icon", i);
          paramBundle = localBundle;
          break;
          if (((axms)localObject1).a == 2L) {
            paramBundle = this.a.getApp().getString(2131693300);
          } else if (((axms)localObject1).a == 3L) {
            paramBundle = this.a.getApp().getString(2131693301);
          } else if (((axms)localObject1).a == 26L) {
            paramBundle = this.a.getApp().getString(2131693303);
          }
        }
      }
      label1420:
