...
public class bdqz
{
  ...
  public static int a()
  {
    try
    {
      ...
      bdnw.a("getDeviceBenchmarkLevel", "getDeviceBenchmarkLevel coreNum:" + k + " cpuFreq:" + m + " ramSize:" + n + " score:" + i);
      return i;
    }
    catch (Throwable localThrowable)
    {
      bdnw.d("getDeviceBenchmarkLevel", "getDeviceBenchmarkLevel error", localThrowable);
    }
    return -1;
  }
  ...
  private static void a(java.lang.String paramString)
  {
    ...
    //   100: aload 6
    //   102: astore 9
    //   104: getstatic 72	bdqz:jdField_a_of_type_Long	J
    //   107: lload_3
    //   108: lcmp
    //   109: ifge +15 -> 124
    //   112: aload 5
    ...
    //   118: astore 9
    //   120: lload_3
    //   121: putstatic 72	bdqz:jdField_a_of_type_Long	J
    //   124: aload 5
    //   126: astore 7
    //   128: aload 6
    //   130: astore 9
    ...
    //   160: invokestatic 64	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   163: aload 5
    //   165: ifnull +8 -> 173
    //   168: aload 5
  ...
  {
    // Byte code:
    //   0: getstatic 174	bdqz:c	J
    //   3: lconst_0
    //   4: lcmp
    //   5: ifle +7 -> 12
    //   8: getstatic 174	bdqz:c	J
    //   11: lreturn
    //   12: iconst_0
    //   13: istore_0
    //   14: invokestatic 24	bdqz:b	()I
    //   17: istore_1
    //   18: getstatic 174	bdqz:c	J
    //   21: lconst_0
    //   22: lcmp
    //   23: ifgt +126 -> 149
    //   26: iload_0
    ...
    //   88: putstatic 174	bdqz:c	J
    //   91: getstatic 174	bdqz:c	J
    //   94: ldc2_w 152
    //   97: ldiv
    //   98: putstatic 174	bdqz:c	J
    //   101: aload_2
    //   102: ifnull +7 -> 109
    //   105: aload_2
    ...
    //   183: invokestatic 64	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   186: getstatic 174	bdqz:c	J
    //   189: lreturn
    //   190: astore_2
    //   191: goto -82 -> 109
    //   194: astore_3
  ...
  private static final int d()
  {
    try
    {
      int i = new File("/sys/devices/system/cpu/").listFiles(new bdra()).length;
      return i;
    }
