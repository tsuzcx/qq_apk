...
public class azry
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, Card paramCard)
  {
    for (;;)
    {
      try
      {
        ...
        localObject = ((anvk)localObject).b(paramString2);
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, Intent paramIntent, int paramInt)
  {
    ...
    Object localObject = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).e(str2);
    ...
    {
      paramQQAppInterface.a = aaqo.a(str1, 1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    if (((bgls)paramQQAppInterface.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER)).b(paramString2))
    {
      bghs.a(paramContext, paramString1, paramString2);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    Object localObject2 = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramString2);
    ...
    {
      paramQQAppInterface.a = aaqo.a(paramString1, 1);
  ...
  public static boolean a(TroopInfo paramTroopInfo, TroopMemberCard paramTroopMemberCard, TextView paramTextView)
  {
    ...
    if (!TextUtils.isEmpty(paramTroopMemberCard.mUniqueTitle))
    {
      ...
      paramTroopMemberCard = bfkd.a().a(bool2, bool3);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label49;
        label195:
        if ((bool5) && (!bghd.a(paramTroopMemberCard.titleId))) {
          break;
        }
        bfke localbfke = bfkd.a().a(paramTroopMemberCard.titleId, bool1, bool2, bool3);
        if (localbfke != null)
        {
          str = localbfke.jdField_a_of_type_JavaLangString;
          j = localbfke.b;
