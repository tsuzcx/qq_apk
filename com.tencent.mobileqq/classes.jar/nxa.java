  ...
  implements oxx
{
  ...
  private nxd jdField_a_of_type_Nxd = new nxd();
  private Map<Integer, List<nxc>> b = new HashMap();
  ...
  public void a(int paramInt, nxc paramnxc)
  {
    if (this.b != null) {
    ...
    {
      if (!((List)localObject).contains(paramnxc)) {
        ((List)localObject).add(paramnxc);
      }
  ...
  public void b(int paramInt, nxc paramnxc)
  {
    if ((this.b != null) && (this.b.get(Integer.valueOf(paramInt)) != null)) {
      ((List)this.b.get(Integer.valueOf(paramInt))).remove(paramnxc);
    }
  }
