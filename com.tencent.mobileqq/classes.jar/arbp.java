...
public class arbp
{
  ...
  public arbp(QQAppInterface paramQQAppInterface, arsf paramarsf, long paramLong)
  {
    ...
    Object localObject1 = (HashMap)paramarsf.a().get("OnlinePreView");
    ...
    paramarsf = (HashMap)paramarsf.a().get("OfflineConfig");
    localObject1 = paramarsf.keySet().iterator();
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject3 = paramarsf.get(localObject2);
  ...
  {
    long l1 = Long.parseLong(arrr.c("OfflineConfigFlowSize"));
    try
    {
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    return arrr.c(paramString);
  }
  
  public static String a(Context paramContext, String paramString1, String paramString2)
  {
    return a(paramContext, "OnlinePreView", arso.a(paramString1).replace(".", ""), paramString2);
  }
  ...
  {
    long l1 = Long.parseLong(arrr.c("OfflineConfigFlowTime"));
    try
    {
  ...
  {
    long l1 = Long.parseLong(arrr.c("OfflineConfigFtnThumbMaxSize"));
    try
    {
