  ...
  extends arac<arbo>
{
  ...
  {
    arbo localarbo = (arbo)aran.a().a(67);
    arbo.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), false, localarbo);
  }
  ...
  @Nullable
  public arbo a(araj[] paramArrayOfaraj)
  {
    return arbo.a(paramArrayOfaraj);
  }
  
  public void a(arbo paramarbo)
  {
    QLog.w("ApolloConfig_GlobalProcessor", 1, "onUpdate");
    arbo.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), true, paramarbo);
  }
