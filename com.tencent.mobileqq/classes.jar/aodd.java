...
public class aodd
  extends aodh
{
  public aodd(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  protected void a(View paramView, acju paramacju, ChatMessage paramChatMessage, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        paramView = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
    ...
    apbf.a(paramView).a(false, this.jdField_a_of_type_AndroidContentContext, new aode(this, paramView));
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          paramChatMessage = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        } while (paramChatMessage == null);
        i = apck.a(paramChatMessage.fileName);
      } while ((i == 0) || (i == 2));
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      default: 
        ...
        if (paramChatMessage.nOpType == 0) {
          ...
          {
            if (bace.b(paramChatMessage.strFilePath)) {
              break label447;
            }
          }
        }
      ...
      label447:
      for (boolean bool1 = bool3; (!bool1) || (!bace.b(paramChatMessage.strFilePath)); bool1 = false)
      {
        return bool1;
        bool2 = true;
        break label383;
