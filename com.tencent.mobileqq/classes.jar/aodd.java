...
public class aodd
  extends aobw
  implements aobr, aoce
{
  aocw jdField_a_of_type_Aocw;
  FaceDownloader jdField_a_of_type_ComTencentMobileqqAppFaceFaceDownloader;
  NearbyAppInterface jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface;
  
  public aodd(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDownloader = ((aocs)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a();
  ...
  public Bitmap a(int paramInt1, String paramString, int paramInt2, byte paramByte)
  {
    ...
    Bitmap localBitmap = ((aocs)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(paramString);
    axei.a(4, "Q.qqhead.NearbyFaceDecoder", "getBitmapFromcache", new Object[] { paramString, localBitmap });
    return localBitmap;
  }
  ...
  public void a(AppInterface paramAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    do
    {
      ...
      if ((paramFaceInfo.jdField_a_of_type_Int == 32) && (paramFaceInfo.jdField_a_of_type_AvatarInfoQQHeadInfo == null) && ((FaceInfo)this.jdField_a_of_type_JavaUtilHashtable.get(paramFaceInfo.b()) != null)) {
        ((aocq)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(4)).a(paramFaceInfo);
      }
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    for (long l = localObject.jdField_a_of_type_ArrayOfLong[FaceInfo.r] - localObject.jdField_a_of_type_ArrayOfLong[FaceInfo.j];; l = 0L)
    {
      ...
      {
        if (localObject != null) {
          bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getCurrentAccountUin(), (String)localObject, true, l, 0L, null, "");
        }
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Aobx.onDecodeTaskCompleted(this.b + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramFaceInfo.jdField_a_of_type_Int, paramFaceInfo.jdField_a_of_type_JavaLangString, paramBitmap);
        return;
        i = FaceInfo.g;
        break label117;
        if (i == 2) {
  ...
  protected void e()
  {
    ...
    axei.a("Q.qqhead.NearbyFaceDecoder", new Object[] { "runNextTask", localThrowable1, localObject1 });
  }
}
