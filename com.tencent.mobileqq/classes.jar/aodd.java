  ...
  extends View
{
  ...
  public aodd(ScreenShot paramScreenShot, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(Canvas paramCanvas)
  {
    ...
    do
    {
      try
      {
        ...
        {
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131718149, 1).show();
          return;
        }
      }
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getString(2131718926), getWidth() / 2, m + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (int i = ((Rect)localObject).top;; i = 0)
    {
      ...
      {
        bdla.b(null, "CliOper", "", "", "0X8005007", "0X8005007", 0, 0, (String)localObject, "", "", "");
        invalidate();
        return;
