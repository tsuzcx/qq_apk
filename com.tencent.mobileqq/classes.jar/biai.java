  ...
  extends SQLiteOpenHelper
{
  ...
  public biai(Context paramContext)
  {
    super(paramContext, "appcenterImagedb.db", null, 4);
  }
  
  protected bial a(Cursor paramCursor)
  {
    bial localbial = new bial();
    localbial.jdField_a_of_type_JavaLangString = paramCursor.getString(0);
    localbial.jdField_a_of_type_Long = paramCursor.getLong(1);
    localbial.b = paramCursor.getLong(2);
    localbial.jdField_c_of_type_Long = paramCursor.getLong(3);
    localbial.jdField_c_of_type_JavaLangString = paramCursor.getString(4);
    return localbial;
  }
  
  /* Error */
  public bial a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   6: aconst_null
    //   7: astore 6
    //   9: getstatic 30	biai:jdField_a_of_type_ArrayOfByte	[B
    //   12: astore 7
    //   14: aload 7
    //   16: monitorenter
    //   17: aload_0
    //   18: invokevirtual 72	biai:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   21: astore_2
    //   22: aload_2
    //   23: getstatic 14	biai:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   26: getstatic 28	biai:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   29: ldc 74
    //   31: iconst_1
    ...
    //   65: aload_0
    //   66: aload_3
    //   67: invokevirtual 90	biai:a	(Landroid/database/Cursor;)Lbial;
    //   70: astore_1
    //   71: aload_3
    //   72: ifnull +9 -> 81
    //   75: aload_3
  ...
  public void a(bial parambial)
  {
    ...
    //   2: aconst_null
    //   3: astore_2
    //   4: getstatic 30	biai:jdField_a_of_type_ArrayOfByte	[B
    //   7: astore 6
    //   9: aload 6
    //   11: monitorenter
    //   12: aload_1
    ...
    //   19: return
    //   20: aload_0
    //   21: invokevirtual 101	biai:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   24: astore 4
    //   26: aload 4
    //   28: astore_2
    //   29: aload 4
    ...
    //   49: ldc 18
    //   51: aload_1
    //   52: getfield 50	bial:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   66: ldc 20
    //   68: aload_1
    //   69: getfield 57	bial:jdField_a_of_type_Long	J
    ...
    //   106: ldc 24
    //   108: aload_1
    //   109: getfield 63	bial:jdField_c_of_type_Long	J
    ...
    //   126: ldc 26
    //   128: aload_1
    //   129: getfield 65	bial:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   181: invokestatic 138	bhzm:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   184: aload 4
    //   186: astore_3
    //   187: aload 4
    //   189: getstatic 14	biai:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   204: aload_1
    //   205: getfield 50	bial:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   229: astore_3
    //   230: aload 4
    //   232: getstatic 14	biai:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   235: aconst_null
    //   236: aload 7
    ...
    //   267: astore_3
    //   268: aload_1
    //   269: getfield 50	bial:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   272: astore 5
    //   274: goto -111 -> 163
    //   277: astore_1
    //   278: aload 4
    ...
    //   296: ldc 152
    //   298: aload_1
    //   299: invokestatic 155	bhzm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   302: aload_2
    //   303: ifnull -51 -> 252
    //   306: aload_2
