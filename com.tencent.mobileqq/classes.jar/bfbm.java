...
public class bfbm
{
  ...
  public static bfbm a()
  {
    try
    {
      if (jdField_a_of_type_Bfbm == null) {
        jdField_a_of_type_Bfbm = new bfbm();
      }
      bfbm localbfbm = jdField_a_of_type_Bfbm;
      return localbfbm;
    }
    finally {}
  }
  ...
  public long a()
  {
    try
    {
      ...
      bflp.b("CommonDataAdapter", "get uin from app runtim succ:" + this.jdField_a_of_type_Long);
      label46:
  ...
  protected void a()
  {
    ...
    {
      bflp.e("AppUpdate", "getPackageInfo NameNotFoundException : " + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
      bflp.e("AppUpdate", "getPackageInfo exception : " + localException.toString());
    }
  }
  ...
  public void a(String paramString, Context paramContext, WebView paramWebView)
  {
    try
    {
      ...
      localJSONObject2.put("imei", bfmw.c());
      localJSONObject2.put("imsi", bfmw.d());
      localJSONObject2.put("mac_addr", bfmw.a());
      localJSONObject2.put("model_info", Build.MODEL);
      localJSONObject2.put("network_type", bflk.a(a().a()));
      localJSONObject2.put("network_operater", "");
      localJSONObject2.put("location", bfmw.f());
    ...
    {
      bflp.e("AppUpdate", "getUpdateApp parse H5 params error : " + localJSONException.toString());
      if (!paramContext.getSharedPreferences("appcenter_app_report", 0).getBoolean("is_app_last_fullReport_success", false))
      {
        bflp.c("AppUpdate", "getUpdateApp will do full report");
        bfmz.a(paramContext, paramString, paramWebView, String.valueOf(a().a()), false);
        return;
      ...
      {
        bflp.c("AppUpdate", "getUpdateApp will do incremental report");
        bfmz.a(paramContext, null, 0, paramString, paramWebView, String.valueOf(a().a()));
        return;
      }
      bflp.c("AppUpdate", "getUpdateApp will get update app directly");
      bfnb.a(paramContext, paramWebView, paramString, true, String.valueOf(a().a()));
    }
  }
