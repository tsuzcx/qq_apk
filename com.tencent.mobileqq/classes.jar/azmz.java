...
public class azmz
{
  ...
  private static volatile azmz jdField_a_of_type_Azmz;
  ...
  aznc jdField_a_of_type_Aznc = new aznc();
  ...
  private LinkedList<aznb> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private Stack<String> jdField_a_of_type_JavaUtilStack = new Stack();
  boolean jdField_a_of_type_Boolean = false;
  private azne[] jdField_a_of_type_ArrayOfAzne = { new azne("com.tencent.mtt", "qqBrowser"), new azne("com.tencent.android.qqdownloader", "qqMarket"), new azne("com.tencent.qqgame", "qqGame"), new azne("com.tencent.qqmusic", "qqMusic"), new azne("com.tencent.news", "qqNews"), new azne("com.qq.reader", "qqReader"), new azne("com.tencent.qqlive", "qqVideo"), new azne("com.tencent.wblog", "qqMicroblog"), new azne("com.tencent.qqphonebook", "qqPhonebook") };
  private int jdField_b_of_type_Int;
  private StringBuilder jdField_b_of_type_JavaLangStringBuilder = new StringBuilder("Thread info:\n");
  private String jdField_d_of_type_JavaLangString;
  
  protected azmz(Context paramContext)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private azmz(Context paramContext, long paramLong)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  ...
  public static azmz a(Context paramContext)
  {
    return a(paramContext, 3000L);
  }
  
  public static azmz a(Context paramContext, long paramLong)
  {
    if (jdField_a_of_type_Azmz == null) {}
    for (;;)
    {
      try
      {
        ...
        {
          if (alun.a()) {
            jdField_a_of_type_Azmz = new azmz(BaseApplicationImpl.getApplication(), paramLong);
          }
        }
        else if (jdField_a_of_type_Azmz == null) {}
      }
      finally {}
      try
      {
        if ((alun.a()) && ((jdField_a_of_type_Azmz instanceof aznd))) {
          jdField_a_of_type_Azmz = new azmz(BaseApplicationImpl.getApplication(), paramLong);
        }
        return jdField_a_of_type_Azmz;
      }
      finally {}
      jdField_a_of_type_Azmz = new aznd(BaseApplicationImpl.getApplication());
    }
  }
  ...
  private static Map<String, String> a()
  {
    ...
    localHashMap.put("param_MODEL", bdcb.d());
    localHashMap.put("param_manu", bdcb.k());
    localHashMap.put("param_OS", bdcb.e());
    localHashMap.put("param_Resolution", MsfSdkUtils.getResolutionString(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_IMEI", bdcb.a());
    localHashMap.put("param_IMSI", bdcb.b());
    localHashMap.put("param_NetworkType", "" + bdee.b(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_ProductVersion", "" + AppSetting.a());
    localHashMap.put("param_CPU", bdcb.g());
    localHashMap.put("param_totalmemory", MsfSdkUtils.getTotalMemory());
    localHashMap.put("param_availmemory", String.valueOf(bdcb.e() / 1024L) + "kB");
    ...
    localHashMap.put("param_Camera", "" + bdcb.c());
    return localHashMap;
  }
  ...
  {
    Object localObject1 = bdmb.a("android.app.ActivityThread", "currentActivityThread", new Object[0], new Class[0]);
    paramContext = paramContext.getPackageName();
    paramContext = (Map)bdmb.a("android.app.LoadedApk", ((WeakReference)((Map)bdmb.a("android.app.ActivityThread", localObject1, "mPackages")).get(paramContext)).get(), "mReceivers");
  ...
  void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aznc.jdField_a_of_type_Boolean = ((JSONObject)localObject).getBoolean("control_switch");
      this.jdField_a_of_type_Aznc.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("control_level");
      this.jdField_a_of_type_Aznc.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("control_window");
      this.jdField_a_of_type_Aznc.c = ((JSONObject)localObject).getInt("control_freq");
      ...
      ((StringBuilder)localObject).append(",switch=").append(this.jdField_a_of_type_Aznc.jdField_a_of_type_Boolean);
      ((StringBuilder)localObject).append(",level=").append(this.jdField_a_of_type_Aznc.jdField_a_of_type_Int);
      ((StringBuilder)localObject).append(",window=").append(this.jdField_a_of_type_Aznc.jdField_b_of_type_Int);
      ((StringBuilder)localObject).append(",Freq=").append(this.jdField_a_of_type_Aznc.c);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      paramString1 = new aznb(System.currentTimeMillis(), paramString1, paramString2);
      ...
      for (this.jdField_b_of_type_Int = (paramString1.jdField_a_of_type_Int + i); (this.jdField_b_of_type_Int > 15360L) && (this.jdField_a_of_type_JavaUtilLinkedList.size() > 1); this.jdField_b_of_type_Int -= paramString1.jdField_a_of_type_Int) {
        paramString1 = (aznb)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      }
    }
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean1, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap, String paramString3, boolean paramBoolean2)
  {
    ...
    abqu.a(paramString2, paramHashMap);
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    Object localObject = new NewIntent(paramAppRuntime.getApplication(), ayxz.class);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramAppRuntime.getApplication(), ayxz.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      paramString2 = new NewIntent(paramAppRuntime.getApplication(), ayxz.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), ayxz.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString, Map<String, Integer> paramMap)
  {
    ...
    paramMap = new NewIntent(paramAppRuntime.getApplication(), ayxz.class);
  ...
  void b()
  {
    if (!this.jdField_a_of_type_Aznc.jdField_a_of_type_Boolean) {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aznc.jdField_a_of_type_Int == 2) && ((TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).contains("QQBroadcastReceiver"))))
      {
    ...
    if ((l1 <= 0L) || (l2 <= l1) || (i < 0) || (l2 - l1 > this.jdField_a_of_type_Aznc.jdField_b_of_type_Int * 1000))
    {
      i = 1;
      l1 = l2;
    }
    for (;;)
    {
      if (i > this.jdField_a_of_type_Aznc.c) {
  ...
  void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      localSharedPreferences.edit().putLong("starttime", l1).putInt("crashcount", i).putBoolean("allowpreload", bool1).putInt("controlwindow", this.jdField_a_of_type_Aznc.jdField_b_of_type_Int).commit();
      return;
      i += 1;
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    CrashReport.initCrashReport(jdField_a_of_type_AndroidContentContext, new azna(this), null, bool, (CrashStrategyBean)localObject, 30000L);
    try
    {
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchInstallStatus", String.valueOf(aarg.jdField_a_of_type_Int));
      if (!TextUtils.isEmpty(aarg.jdField_a_of_type_JavaLangString)) {
        CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchNameInstalled", aarg.jdField_a_of_type_JavaLangString);
      }
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Revision", AppSetting.g());
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Version.buildNum", "8.3.3.4515");
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "topActivity", aluv.a());
