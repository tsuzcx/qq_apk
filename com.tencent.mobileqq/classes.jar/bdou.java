...
public class bdou
{
  public static HashMap<String, bdow> a;
  ...
  static
  {
    ...
    jdField_a_of_type_JavaUtilHashMap.put("1", new bdow(2, true, 1, 1));
    jdField_a_of_type_JavaUtilHashMap.put("2", new bdow(2, false, 1, 2));
    jdField_a_of_type_JavaUtilHashMap.put("3", new bdow(3, true, 2, 3));
    jdField_a_of_type_JavaUtilHashMap.put("4", new bdow(3, true, 1, 4));
    jdField_a_of_type_JavaUtilHashMap.put("5", new bdow(3, true, 1, 5));
  }
