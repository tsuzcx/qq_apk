  ...
  extends bafb
{
  ...
  public bagl(Context paramContext, int paramInt)
  {
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText = ((ClearableEditText)findViewById(2131302566));
  }
  ...
  public bafb setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bagm(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
