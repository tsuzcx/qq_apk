...
public class arch
{
  ...
  public TdsReaderView a(Activity paramActivity, String paramString, arcj paramarcj)
  {
    ...
    this.jdField_a_of_type_ComTencentKwstudioOfficePreviewTdsReaderView = TdsReaderView.newInstance(new arck(paramActivity, false, paramarcj, null));
    if (this.jdField_a_of_type_ComTencentKwstudioOfficePreviewTdsReaderView != null)
    {
  ...
  public boolean a(Activity paramActivity, String paramString, arcj paramarcj, boolean paramBoolean)
  {
    boolean bool = false;
    paramBoolean = bool;
    ...
    for (paramActivity = "pre open file true! wait callback!";; paramActivity = "pre open file false! strPath=" + paramString)
    {
      ...
      if (paramarcj != null) {
        paramarcj.a(paramBoolean);
      }
      return paramBoolean;
      paramActivity = TdsReaderView.newInstance(new arck(paramActivity, true, null, null));
