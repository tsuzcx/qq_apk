...
public class arch
{
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, long paramLong, arcl paramarcl)
  {
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    YTAGReflectLiveCheckInterface.getLiveCheckType(paramContext.getApplicationContext(), new arcj(localAtomicBoolean, paramString1, paramString2, paramString3, paramLong, paramarcl));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, oidb_0x5e1.RspBody paramRspBody, FaceSecureCheck.SecureCheckResponse paramSecureCheckResponse, Runnable paramRunnable)
  {
    if (((oidb_0x5e1.UdcUinData)paramRspBody.rpt_msg_uin_data.get(0)).user_login_guard_face.get() == 0)
    {
      if ((paramSecureCheckResponse == null) || (!paramSecureCheckResponse.bool_sec_pass.get()))
      {
        ...
        {
          axby.b(paramQQAppInterface, new arci(paramActivity, paramString, paramRunnable));
          return;
        }
  ...
  private static void b(int paramInt, String paramString1, String paramString2, String paramString3, long paramLong, String paramString4, arcl paramarcl)
  {
    ...
    if (paramInt != 0)
    {
      ...
      QIPCClientHelper.getInstance().callServer("IdentificationIpcServer_Model", "action_app_conf", localBundle, new arck(paramarcl));
    }
  }
}
