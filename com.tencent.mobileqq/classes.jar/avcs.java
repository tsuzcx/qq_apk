  ...
  extends avcn
{
  ...
  public void a()
  {
    ...
    new avdj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_JavaLangString + "&num=" + 10, new avcu(this));
  }
  ...
  public void b()
  {
    ...
    new avdj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_JavaLangString + "&num=" + 10, new avct(this));
  }
}
