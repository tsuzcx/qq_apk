...
public class abqw
{
  ...
  private static abqw jdField_a_of_type_Abqw;
  ...
  private final RecyclablePool jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(abqz.class, 4);
  private AbstractUnifiedMonitor.ThreadMonitorCallback jdField_a_of_type_MqqUtilAbstractUnifiedMonitor$ThreadMonitorCallback = new abqy(this);
  ...
  {
    if (jdField_a_of_type_Abqw == null) {}
    try
    {
      if (jdField_a_of_type_Abqw == null) {
        jdField_a_of_type_Abqw = new abqw();
      }
      return jdField_a_of_type_Abqw;
    }
    finally {}
  }
  ...
  {
    bjxs.a().a(paramString, paramLong2, paramArrayOfLong, paramLong1);
    if (QLog.isColorLevel()) {
    ...
    if (jdField_a_of_type_Long > 0L)
    {
      ...
      localHashMap.put("hcState", String.valueOf(absd.a().a()));
    ...
    {
      if (azjg.e != 0L) {
        paramArrayOfLong = String.valueOf(paramLong1 - azjg.e);
      }
      if (azjg.d != 0L) {
        str1 = String.valueOf(paramLong1 - azjg.d);
      }
      if (azjg.g != 0L) {
        str2 = String.valueOf(paramLong1 - azjg.g);
      }
      if (azjg.f != 0L) {
        str3 = String.valueOf(paramLong1 - azjg.f);
      }
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Abqz != null)
    {
      if (this.jdField_a_of_type_Abqz.jdField_b_of_type_Long == 0L) {
        this.jdField_a_of_type_Abqz.jdField_b_of_type_Long = paramLong;
      }
    }
    ...
    for (;;)
    {
      ...
      Object localObject = this.jdField_a_of_type_Abqz;
      ((abqz)localObject).jdField_a_of_type_Long += 1L;
      localObject = this.jdField_a_of_type_Abqz.jdField_a_of_type_ArrayOfLong;
      localObject[i] += 1L;
      this.jdField_a_of_type_Abqz.jdField_c_of_type_Long = paramLong;
      break;
      label186:
  ...
  {
    if (!absd.jdField_a_of_type_Boolean) {
    ...
    } while ((!this.jdField_a_of_type_Boolean) || ((this.jdField_a_of_type_Abqz != null) && (this.jdField_a_of_type_Abqz.jdField_a_of_type_JavaLangString.equals(paramString))));
    if (paramString.equals("qzone_homepage")) {
      absd.a().a(0, 1, 1, 0, 1500, 701, 32L, Process.myTid(), "qzoneList", false);
    }
    for (;;)
    {
      this.jdField_a_of_type_Abqz = ((abqz)this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(abqz.class));
      this.jdField_a_of_type_Abqz.jdField_a_of_type_JavaLangString = paramString;
      ...
      if (paramString.equals("list_photo")) {
        absd.a().a(0, 1, 1, 0, 1500, 702, 32L, Process.myTid(), "photoList", false);
      }
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Abqz != null)
    {
      if (!paramBoolean)
      {
        long l = a(this.jdField_a_of_type_Abqz.jdField_c_of_type_Long - this.jdField_a_of_type_Abqz.jdField_b_of_type_Long);
        if ((this.jdField_a_of_type_Abqz.jdField_a_of_type_Long > 0L) && (l > a()))
        {
          paramString = a(paramString, l, (this.jdField_a_of_type_Abqz.jdField_c_of_type_Long - this.jdField_a_of_type_Abqz.jdField_b_of_type_Long) / this.jdField_c_of_type_Long + 1L - this.jdField_a_of_type_Abqz.jdField_a_of_type_Long, this.jdField_a_of_type_Abqz.jdField_a_of_type_ArrayOfLong);
          abrf.a().a(paramString);
        }
      }
      this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.recycle(this.jdField_a_of_type_Abqz);
      this.jdField_a_of_type_Abqz = null;
    }
    if (!this.jdField_b_of_type_Boolean)
    {
      this.jdField_a_of_type_AndroidViewChoreographer.removeFrameCallback(this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback);
  ...
  public void c()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new abqx(this);
