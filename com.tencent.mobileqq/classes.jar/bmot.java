...
public class bmot
{
  ...
  private bmnv jdField_a_of_type_Bmnv = new bmnv();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bmnv.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bmnv.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public bmoq a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Bmnv.a(paramFloat1, paramFloat2);
    ...
    return new bmoq(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public bmoq a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Bmnv.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bmnv.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bmnv.a(paramFloat1, paramFloat2);
      bmoq localbmoq = new bmoq(paramFloat1, paramFloat2, c(), a());
      localbmoq.a(bmnu.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbmoq;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bmnv.c()) {}
  ...
  {
    this.jdField_a_of_type_Bmnv.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bmnv.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bmnv.a(false);
      this.jdField_a_of_type_Bmnv.b(true);
      this.jdField_a_of_type_Bmnv.c(false);
      return paramBoolean;
    }
  }
  ...
  public bmoq b(float paramFloat1, float paramFloat2)
  {
    return new bmoq(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Bmnv.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Bmnv.c(paramBoolean);
  }
  ...
  public bmoq c(float paramFloat1, float paramFloat2)
  {
    bmoq localbmoq = new bmoq(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bmnv.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bmnv.d())
    {
      ...
      localbmoq.a(bmnu.a(localRectF1, localRectF2));
      return localbmoq;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Bmnv.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bmnv.a(paramFloat1, paramFloat2));
      localbmoq.a(bmnu.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbmoq;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localbmoq.a(bmnu.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localbmoq;
  }
  ...
  {
    this.jdField_a_of_type_Bmnv.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bmnv.d(true);
  }
