  ...
  extends JobSegment<List<String>, List<Bitmap>>
{
  ...
  public ulc(@Nullable Bitmap paramBitmap, String paramString, int paramInt, ula paramula)
  {
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_JavaLangString = (this.jdField_a_of_type_JavaLangString + "[" + paramString + "]");
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Ula = paramula;
  }
  ...
  protected void a(JobContext paramJobContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      ukj.b(this.jdField_a_of_type_JavaLangString, "bitmapListSize = %d, stubBitmap = %s", Integer.valueOf(i), this.jdField_a_of_type_AndroidGraphicsBitmap);
      Handler localHandler = new Handler(ThreadManager.getSubThreadLooper(), new ule(this, null));
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!"stub_url".equals(str)) {
          this.jdField_a_of_type_Ula.a(str, i, i, new uld(this, paramJobContext, paramList, localHandler));
        }
      }
    }
  }
