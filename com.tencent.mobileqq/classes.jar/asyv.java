  ...
  implements PluginManagerUpdater
{
  ...
  public asyv(Context paramContext, String paramString1, String paramString2)
  {
    this.d = paramString2;
  ...
  private boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   199: aload_0
    //   200: getfield 39	asyv:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    ...
    //   220: aload_0
    //   221: getfield 41	asyv:d	Ljava/lang/String;
  ...
  public File getLatest()
  {
    if (a())
    {
      ...
      atcy localatcy = ateg.a().a().b("copy_pm");
      String str;
      if (bool)
      {
        str = "0";
