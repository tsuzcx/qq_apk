...
public class axur
{
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, axuv paramaxuv)
  {
    ...
    for (;;)
    {
      ...
      if (!paramString.exists()) {
        try
        {
          ...
          {
            b(paramActivity, paramFile, paramString, paramaxuv);
            return;
          }
        }
    ...
    bdcd.a(paramActivity, 230).setTitle(paramActivity.getString(2131719323)).setMessage(paramActivity.getString(2131695341)).setPositiveButton(paramActivity.getString(2131719197), new axut(paramActivity, paramFile, paramString, paramaxuv)).setNegativeButton(paramActivity.getString(2131694804), new axus()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, RichMediaBrowserInfo paramRichMediaBrowserInfo, boolean paramBoolean, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      bizm.a(paramActivity, localbizt, paramBoolean, paramString3, paramString2, paramInt, paramString1, paramRichMediaBrowserInfo, l2, l1, -1);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt1, List<MessageForPic> paramList, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      i = 1;
      label145:
      paramString1 = baul.a(localMessageForPic, i, "chatthumb");
      if (paramString1 == null) {
        break label384;
      }
      paramString1 = bame.d(paramString1.toString());
      if (paramString1 == null) {
        break label366;
      }
    ...
    for (;;)
    {
      ...
      break label112;
      bizm.a(paramActivity, localbizt, bool, paramString3, paramString2, paramInt1, localArrayList1, localArrayList2, localArrayList3, localArrayList4, paramInt2);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    bizm.a(paramActivity, paramString, 0, 0, paramArrayList, paramActivity.getResources().getString(2131718616), paramInt);
  }
  
  private static void b(Activity paramActivity, File paramFile1, File paramFile2, axuv paramaxuv)
  {
    new axuu(paramFile1, paramFile2, paramActivity, paramaxuv).execute(new Void[0]);
  }
}
