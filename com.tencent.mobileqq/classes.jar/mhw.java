...
public class mhw
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mhx(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new mhy(this);
  ...
  private mjg jdField_a_of_type_Mjg;
  ...
  public mhw(View paramView, ViewStub paramViewStub, int paramInt, VideoController paramVideoController, AVActivity paramAVActivity)
  {
    ...
    this.jdField_a_of_type_Mjg = new mjg(paramVideoController, paramAVActivity);
    this.jdField_a_of_type_Mjg.a();
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373557);
    String str = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695313);
    Object localObject = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp();
    if (paramBoolean) {}
    for (int i = 2131695312;; i = 2131695311)
    {
      localObject = ((BaseApplication)localObject).getString(i);
      mie localmie = new mie(this);
      SpannableString localSpannableString = new SpannableString((CharSequence)localObject);
      localSpannableString.setSpan(localmie, 0, ((String)localObject).length(), 18);
  ...
  private void h()
  {
    Object localObject4 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373727);
    Object localObject3 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373730);
    Object localObject2 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373736);
    Object localObject1 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373732);
    int i = (int)mvk.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 4.0F);
    int j = (int)mvk.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 132.0F);
    int k = (int)mvk.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 8.0F);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.width = j;
    ((RelativeLayout)localObject4).setLayoutParams(localLayoutParams);
    localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131373727);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(5, 2131373727);
    ((RelativeLayout.LayoutParams)localObject3).addRule(7, 2131373727);
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131373727);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(5, 2131373730);
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131373730);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131373730);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(8, 2131373738);
    ((RelativeLayout.LayoutParams)localObject1).addRule(14, -1);
    ((RelativeLayout.LayoutParams)localObject1).bottomMargin = k;
    ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373739)).setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject1).addRule(8, 2131373734);
    ((RelativeLayout.LayoutParams)localObject1).addRule(14, -1);
    ((RelativeLayout.LayoutParams)localObject1).bottomMargin = k;
    ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373735)).setLayoutParams((ViewGroup.LayoutParams)localObject1);
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373728));
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[1] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373731));
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[2] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373738));
      ...
      ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373739)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
      if (AndroidCodec.sIsSupportHwCodec1080P)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373732).setVisibility(0);
        this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[3] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373734));
        ...
        ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373735)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
        h();
      }
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new mid(this));
  ...
  private void j()
  {
    ...
    label164:
    label171:
    for (int i = 2130842290;; i = 2130842289)
    {
      localImageView.setBackgroundDrawable(localResources.getDrawable(i));
      return;
      i = 2130842287;
  ...
  private void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController != null)
    {
      ...
      if (locallfe != null) {
        this.jdField_a_of_type_ComTencentAvVideoController.a(Long.valueOf(locallfe.jdField_d_of_type_JavaLangString).longValue(), this.jdField_b_of_type_Int);
      }
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localObject == null) || (((lfe)localObject).jdField_d_of_type_Int != 2) || (((lfe)localObject).A()) || ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean)) || ((this.jdField_a_of_type_ComTencentAvVideoController.a().w != 0) && (this.jdField_a_of_type_ComTencentAvVideoController.a().w != 2)) || (this.jdField_a_of_type_ComTencentAvUiAVActivity.b() != 2));
          localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373638);
        } while (((localObject != null) && (((View)localObject).getVisibility() == 0)) || (this.jdField_a_of_type_AndroidViewView.findViewById(2131373765).getVisibility() != 0));
        if (paramInt < 2) {
          break;
        }
      ...
      this.jdField_a_of_type_ComTencentAvUiAVActivity.a.D(AudioHelper.b());
      localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373556);
      a(true);
      ((RelativeLayout)localObject).setVisibility(0);
      this.jdField_c_of_type_Boolean = true;
      bdla.b(null, "CliOper", "", "", "0X800AA5D", "0X800AA5D", 4, 0, "", "", "", "");
      return;
    } while ((paramInt < 1) || (this.jdField_b_of_type_Boolean));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onNetworkQualityChanged. networkQuality = " + paramInt);
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.L();
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.D(AudioHelper.b());
    Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373556);
    a(true);
    ((RelativeLayout)localObject).setVisibility(0);
    this.jdField_b_of_type_Boolean = true;
    bdla.b(null, "CliOper", "", "", "0X800AA5D", "0X800AA5D", 3, 0, "", "", "", "");
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        } while ((locallfe == null) || (locallfe.jdField_d_of_type_Int != 2) || (locallfe.A()));
      ...
      mbf.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695532));
      this.e = true;
      bdla.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 4, 0, "", "", "", "");
      return;
    } while ((paramInt1 < 1280) || (paramInt2 < 720) || (this.d));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onRecvVideoResolutionChanged. w = " + paramInt1 + ", h = " + paramInt2);
    mbf.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695533));
    this.d = true;
    bdla.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 3, 0, "", "", "", "");
  }
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() < 5)
    {
      ...
      if (((Long)localIterator.next()).longValue() >= mtr.b()) {
        break label239;
      }
    ...
    for (;;)
    {
      ...
      if (paramLong1 >= 4L)
      {
        ...
        if (paramLong2 - this.jdField_a_of_type_Long > 10000L)
        {
          ...
          mbf.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, anvx.a(2131708366));
          bdla.b(null, "CliOper", "", "", "0X800A346", "0X800A346", 0, 0, "", "", "", "");
        }
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (!paramBoolean)
    {
      if ((paramInt1 != 0) && (!TextUtils.isEmpty(paramString))) {
        mbf.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, paramString);
      }
      return;
    }
    int i;
    ...
    {
      if (paramInt1 == 10000) {
        bdla.b(null, "CliOper", "", "", "0X800AA5F", "0X800AA5F", 4, 0, "", "", "", "");
      }
  ...
  public void b()
  {
    ...
    localObjectAnimator.addListener(new mib(this));
  ...
  public void d()
  {
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373556)).setVisibility(4);
    i();
    boolean bool = this.jdField_a_of_type_Mjg.a();
    ...
    {
      i = 3;
      bdla.b(null, "CliOper", "", "", "0X800AA5E", "0X800AA5E", i + 1, 0, "", "", "", "");
    ...
    Object localObject = new mic(this);
    localObject = bhdj.a(this.jdField_a_of_type_ComTencentAvUiAVActivity, 0, anvx.a(2131708361), null, anvx.a(2131708362), anvx.a(2131708363), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
    if (localObject != null) {
  ...
  public void e()
  {
    if (this.jdField_a_of_type_Mjg != null) {
      this.jdField_a_of_type_Mjg.b();
    }
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Mjg != null)
    {
      this.jdField_a_of_type_Mjg.e();
      this.jdField_a_of_type_Mjg = null;
    }
