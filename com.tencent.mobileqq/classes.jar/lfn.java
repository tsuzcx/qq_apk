...
public class lfn
{
  ...
  public lfn(VideoAppInterface paramVideoAppInterface)
  {
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "av_qua_low_memory", true, 0L, 0L, (HashMap)localObject1, "", true);
      ...
      {
        String str3 = ((lgf)localObject2).d;
        localObject2 = ((lgf)localObject2).c;
      ...
      axpw.a(null, "dc02660", (String)localObject1);
      return;
    }
  ...
  public void b()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidContentComponentCallbacks == null)
      {
        this.jdField_a_of_type_AndroidContentComponentCallbacks = new lfo(this);
