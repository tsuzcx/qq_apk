...
{
  public bhpv(AuthorityActivity paramAuthorityActivity, boolean paramBoolean, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    QLog.d("AuthorityActivity", 1, "-->doAuthorize-onReceive, ssoAccount: " + (String)localObject + " | uin: " + this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bifi.b((byte[])localObject, this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej);
        if (localObject != null)
        {
          ...
          if (localAuthorizeResponse != null)
          {
            ...
            if (localAuthorizeResponse.ret.get() == 0) {
              bifi.a(AuthorityActivity.e, this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString, localAuthorizeResponse.expires_in.get(), (byte[])localObject);
            }
      ...
      catch (Exception paramBundle)
      {
        ...
        ((Message)localObject).obj = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.getResources().getString(2131694263);
        ...
        QLog.d("AuthorityActivity", 1, "rec | cmd: " + this.jdField_a_of_type_JavaLangString + " | uin : *" + bhwf.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + paramInt, paramBundle);
      ...
      try
      {
        ...
        biaz.a().a("agent_authority", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.h, l1, l2, 0, Long.parseLong(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString), "1000069", "ret: " + i);
        bibc.a().a(0, "LOGIN_AUTH", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString, AuthorityActivity.e, null, Long.valueOf(SystemClock.elapsedRealtime()), i, 1, null);
      ...
      {
        bhzm.c("AuthorityActivity", "-->success report exception cmd: agent_authority", paramBundle);
        continue;
      }
      QLog.d("AuthorityActivity", 1, "rec | cmd: " + this.jdField_a_of_type_JavaLangString + " | uin : *" + bhwf.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + paramInt);
      this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.i = SystemClock.elapsedRealtime();
      bhzm.c("Authority_TimeCost", "<TimeStamp> authority cost : " + (this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.i - this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.h));
      return;
      paramBundle = "1";
      continue;
      QLog.d("AuthorityActivity", 1, "rec | cmd: " + this.jdField_a_of_type_JavaLangString + " | uin : *" + bhwf.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString) + " | ret : failed | code : " + paramInt + " | mDoAuthorizeRetryCount : " + this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.d);
      if ((paramInt == 1002) && (this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.d < 1))
      {
        paramBundle = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity;
        paramBundle.d += 1;
      ...
      paramBundle.obj = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.getResources().getString(2131694263);
      ...
      AuthorityActivity.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity, "KEY_AUTHORIZE_REQUEST", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.d, false);
      paramBundle = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.getResources().getString(2131694263);
      try
      {
        biaz.a().a("agent_authority", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.h, 0L, 0L, paramInt, Long.parseLong(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString), "1000069", paramBundle);
        bibc.a().a(1, "LOGIN_AUTH", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString, AuthorityActivity.e, null, Long.valueOf(SystemClock.elapsedRealtime()), 3002, 1, paramBundle);
        bhvw.a().a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Biej.jdField_a_of_type_JavaLangString, "", AuthorityActivity.e, "1", "6", "" + 3002, false);
      }
      catch (Exception paramBundle)
      {
        bhzm.c("AuthorityActivity", "-->failed report exception cmd: agent_authority", paramBundle);
      }
    }
  }
}
