...
public class mpy
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    Bitmap localBitmap = bawu.a(paramString, localOptions);
    if (localBitmap == null) {
  ...
  public static mpc a(VideoAppInterface paramVideoAppInterface)
  {
    return (mpc)paramVideoAppInterface.a(7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramBundle = new aquz((String)localObject, paramQQAppInterface.getCurrentAccountUin(), paramBundle, i, -5040, 65560, 0L);
  ...
  public static boolean a()
  {
    ...
    if ((!lpz.a(4, 1800000L)) && (!lpz.a(8, 1400000L))) {}
    for (;;)
    {
  ...
  {
    boolean bool = muf.a(paramVideoAppInterface).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
