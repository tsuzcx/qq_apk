...
{
  cd(LiteActivity paramLiteActivity) {}
  ...
  protected Uri a(Object... paramVarArgs)
  {
    ...
    //   28: astore 12
    //   30: getstatic 30	ajed:bp	Ljava/lang/String;
    //   33: astore 10
    //   35: aload 11
    ...
    //   86: aload 10
    //   88: invokestatic 62	bace:a	(Ljava/lang/String;)Z
    //   91: ifne +16 -> 107
    //   94: new 64	java/io/File
    //   97: dup
    //   98: aload 10
    //   100: invokespecial 67	java/io/File:<init>	(Ljava/lang/String;)V
    //   103: invokevirtual 70	java/io/File:mkdirs	()Z
    //   106: pop
    //   107: new 72	java/io/FileOutputStream
    //   110: dup
    //   111: new 64	java/io/File
    //   114: dup
    ...
    //   135: invokespecial 67	java/io/File:<init>	(Ljava/lang/String;)V
    //   138: invokespecial 86	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   141: astore 5
    //   143: aload 7
    //   145: astore_3
    //   146: aload 8
    ...
    //   223: iconst_0
    //   224: iload_2
    //   225: invokevirtual 108	java/io/FileOutputStream:write	([BII)V
    //   228: goto -34 -> 194
    //   231: astore 4
    //   233: aload 5
    //   235: astore_1
    ...
    //   250: ifnull +7 -> 257
    //   253: aload_1
    //   254: invokevirtual 113	java/io/FileOutputStream:close	()V
    ...
    //   308: astore_1
    //   309: aload 5
    //   311: invokevirtual 124	java/io/FileOutputStream:flush	()V
    //   314: aload 4
    //   316: ifnull +8 -> 324
    //   319: aload 4
    ...
    //   326: ifnull +8 -> 334
    //   329: aload 5
    //   331: invokevirtual 113	java/io/FileOutputStream:close	()V
    ...
    //   413: ifnull +8 -> 421
    //   416: aload 5
    //   418: invokevirtual 113	java/io/FileOutputStream:close	()V
