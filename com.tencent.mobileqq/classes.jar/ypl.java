  ...
  extends nac
{
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((List)localObject1).add(new bbnr((oidb_0x6d8.GetFileListRspBody.Item)((Iterator)localObject2).next()));
    }
    a(true, bool, i, paramInt, j, paramArrayOfByte, (List)localObject1, paramBundle);
  }
  
  public abstract void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, int paramInt3, ByteStringMicro paramByteStringMicro, List<bbnr> paramList, Bundle paramBundle);
}
