...
public class bbwm
  implements bbwe, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener
{
  public long a;
  ...
  private bbwg jdField_a_of_type_Bbwg;
  private ISuperPlayer jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
  public AtomicInteger a;
  private long b;
  private long c;
  
  public bbwm(Context paramContext, long paramLong, bbwg parambbwg, bbwc parambbwc)
  {
  ...
  private void c()
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Bbwd.jdField_a_of_type_Boolean = true;
        MediaInfo localMediaInfo = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.getMediaInfo();
        if (localMediaInfo != null)
        {
          this.jdField_a_of_type_Bbwd.i = localMediaInfo.getDurationMs();
          this.jdField_a_of_type_Bbwd.jdField_k_of_type_Int = localMediaInfo.getVideoWidth();
          this.jdField_a_of_type_Bbwd.jdField_l_of_type_Int = localMediaInfo.getVideoHeight();
          this.jdField_a_of_type_Bbwd.jdField_j_of_type_Long = localMediaInfo.getVideoBitRate();
          this.jdField_a_of_type_Bbwd.jdField_c_of_type_JavaLangString = localMediaInfo.getVideoCodec();
          this.jdField_a_of_type_Bbwd.jdField_d_of_type_JavaLangString = localMediaInfo.getVideoProfile();
          this.jdField_a_of_type_Bbwd.jdField_k_of_type_Long = localMediaInfo.getAudioBitRate();
          this.jdField_a_of_type_Bbwd.m = localMediaInfo.getChannels();
          this.jdField_a_of_type_Bbwd.e = localMediaInfo.getAudioCodec();
          this.jdField_a_of_type_Bbwd.f = localMediaInfo.getAudioProfile();
          this.jdField_a_of_type_Bbwd.jdField_l_of_type_Long = localMediaInfo.getSampleRate();
          this.jdField_a_of_type_Bbwd.jdField_g_of_type_JavaLangString = localMediaInfo.getContainerFormat();
        }
        this.jdField_a_of_type_Bbwd.jdField_d_of_type_Long = System.currentTimeMillis();
      }
  ...
  private void d()
  {
    try
    {
      ...
      a(3);
      this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer = SuperPlayerFactory.createMediaPlayer(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_Bbwg.jdField_a_of_type_Int, (ISPlayerVideoView)this.jdField_a_of_type_AndroidViewView);
  ...
  private void e()
  {
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Bbwd = new bbwd();
        this.jdField_a_of_type_Bbwd.jdField_a_of_type_Bbwg = this.jdField_a_of_type_Bbwg;
        this.jdField_a_of_type_Bbwd.jdField_g_of_type_Long = System.currentTimeMillis();
        if ((this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer != null) && (this.jdField_a_of_type_Bbwg != null))
        {
          a(3);
          if (this.jdField_a_of_type_Bbwg.jdField_b_of_type_Long <= 0L) {
            continue;
          }
          this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.setLoopback(this.jdField_a_of_type_Bbwg.jdField_a_of_type_Boolean, 0L, this.jdField_a_of_type_Bbwg.jdField_b_of_type_Long);
          this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.setOutputMute(this.jdField_a_of_type_Bbwg.jdField_c_of_type_Boolean);
          if (!this.jdField_a_of_type_Bbwg.jdField_b_of_type_Boolean) {
            break label249;
          }
          if (this.jdField_a_of_type_Bbwg.jdField_a_of_type_JavaLangString != null)
          {
            SuperPlayerVideoInfo localSuperPlayerVideoInfo = new SuperPlayerVideoInfo(3, 3, null);
            localSuperPlayerVideoInfo.setVideoInfo(this.jdField_a_of_type_Bbwg.jdField_a_of_type_JavaLangString, 101);
            ...
            this.jdField_a_of_type_Bbwg.jdField_c_of_type_Long = 0L;
            QLog.d(a(), 2, "openPlayer, videoPath = " + this.jdField_a_of_type_Bbwg.jdField_a_of_type_JavaLangString);
          }
        }
        return;
        this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.setLoopback(this.jdField_a_of_type_Bbwg.jdField_a_of_type_Boolean);
        continue;
        if (this.jdField_a_of_type_Bbwg.jdField_a_of_type_ArrayOfJavaLangString == null) {
          continue;
        }
      }
      finally {}
      label249:
      this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.openMediaPlayerByUrl(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bbwg.jdField_a_of_type_ArrayOfJavaLangString, 0L, this.jdField_a_of_type_Bbwg.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bbwg.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_Bbwg.jdField_c_of_type_Long = 0L;
      if (QLog.isColorLevel())
      {
        StringBuilder localStringBuilder = new StringBuilder();
        String[] arrayOfString = this.jdField_a_of_type_Bbwg.jdField_a_of_type_ArrayOfJavaLangString;
        ...
        QLog.d(a(), 2, "openPlayer, mVideoParam.mSavePath = " + this.jdField_a_of_type_Bbwg.jdField_b_of_type_JavaLangString + " urls = " + localStringBuilder.toString());
      }
    }
  }
  ...
  private void f()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 292	bbwh:a	()Lbbwh;
    //   5: invokevirtual 294	bbwh:a	()Z
    //   8: ifeq +14 -> 22
    //   11: aload_0
    //   12: aload_0
    //   13: invokespecial 296	bbwm:b	()Landroid/view/View;
    //   16: putfield 191	bbwm:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   19: aload_0
    //   20: monitorexit
    //   21: return
    //   22: aload_0
    //   23: getfield 41	bbwm:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   26: instanceof 298
    //   29: ifeq -10 -> 19
    //   32: aload_0
    //   33: iconst_1
    //   34: invokevirtual 172	bbwm:a	(I)V
    //   37: invokestatic 292	bbwh:a	()Lbbwh;
    //   40: aload_0
    //   41: getfield 41	bbwm:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   44: checkcast 298	android/app/Activity
    //   47: aload_0
    //   48: invokevirtual 301	bbwh:a	(Landroid/app/Activity;Lbbwe;)V
    //   51: goto -32 -> 19
    //   54: astore_1
    //   55: aload_0
    //   56: monitorexit
  ...
  public bbwg a()
  {
    return this.jdField_a_of_type_Bbwg;
  }
  
  public String a()
  {
    return "[VideoPlatForm]VideoPlayerProxy[" + b() + "][state:" + bbwb.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + "]";
  }
  ...
  protected void a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(a(), 2, "changeState() , newState = " + bbwb.a(paramInt));
      }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Bbwd != null)
        {
          bbwd localbbwd = this.jdField_a_of_type_Bbwd;
          if (!paramBoolean2)
          {
            paramBoolean2 = true;
            localbbwd.a(paramBoolean2);
          }
        }
        else
        {
  ...
  public void onCompletion(ISuperPlayer paramISuperPlayer)
  {
    try
    {
      ...
      a(8);
      if (this.jdField_a_of_type_Bbwd != null) {
        this.jdField_a_of_type_Bbwd.a(true);
      }
      return;
    }
    finally {}
  ...
  public boolean onError(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    //   54: astore_1
    //   55: aload_0
    //   56: invokevirtual 180	bbwm:a	()Ljava/lang/String;
    //   59: iconst_1
    ...
    //   89: aload_0
    //   90: bipush 7
    //   92: invokevirtual 172	bbwm:a	(I)V
    //   95: aload_0
    //   96: getfield 45	bbwm:jdField_a_of_type_Bbwg	Lbbwg;
    //   99: ifnull +33 -> 132
    //   102: aload_0
    //   103: getfield 45	bbwm:jdField_a_of_type_Bbwg	Lbbwg;
    //   106: getfield 439	bbwg:jdField_a_of_type_Bbwl	Lbbwl;
    //   109: ifnull +23 -> 132
    //   112: aload_0
    //   113: getfield 45	bbwm:jdField_a_of_type_Bbwg	Lbbwg;
    //   116: getfield 439	bbwg:jdField_a_of_type_Bbwl	Lbbwl;
    //   119: aload_0
    //   120: getfield 43	bbwm:jdField_a_of_type_Long	J
    //   123: iload 4
    //   125: aload 5
    //   127: invokeinterface 444 5 0
    //   132: aload_0
    //   133: getfield 74	bbwm:jdField_a_of_type_Bbwd	Lbbwd;
    //   136: ifnull +37 -> 173
    //   139: aload_0
    //   140: getfield 74	bbwm:jdField_a_of_type_Bbwd	Lbbwd;
    //   143: iload 4
    //   145: putfield 446	bbwd:jdField_c_of_type_Int	I
    //   148: aload_0
    //   149: getfield 74	bbwm:jdField_a_of_type_Bbwd	Lbbwd;
    //   152: iload_3
    //   153: putfield 447	bbwd:jdField_a_of_type_Int	I
    //   156: aload_0
    //   157: getfield 74	bbwm:jdField_a_of_type_Bbwd	Lbbwd;
    //   160: iload_2
    //   161: putfield 449	bbwd:jdField_b_of_type_Int	I
    //   164: aload_0
    //   165: getfield 74	bbwm:jdField_a_of_type_Bbwd	Lbbwd;
    //   168: aload 5
    //   170: putfield 450	bbwd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   173: aload_0
    //   174: iconst_0
    //   175: iconst_1
    //   176: invokevirtual 452	bbwm:a	(ZZ)V
    //   179: aload_0
    //   180: monitorexit
    //   181: iconst_0
    //   182: ireturn
    //   183: ldc_w 454
    //   186: aload_1
    //   187: invokestatic 459	axrd:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   190: goto -101 -> 89
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
  ...
  public boolean onInfo(ISuperPlayer paramISuperPlayer, int paramInt, long paramLong1, long paramLong2, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Bbwd != null) && (this.jdField_a_of_type_Bbwd.h == 0L))
      {
        this.jdField_a_of_type_Bbwd.h = System.currentTimeMillis();
        continue;
        if (QLog.isColorLevel()) {
          QLog.d(a(), 2, "onInfo, SuperPlayerMsg.PLAYER_INFO_VIDEO_DECODER_TYPE ");
        }
        if ((paramLong1 == 102L) && (this.jdField_a_of_type_Bbwd != null))
        {
          this.jdField_a_of_type_Bbwd.jdField_g_of_type_Int = 102;
          this.jdField_a_of_type_Bbwd.jdField_j_of_type_Int = 1;
        }
        if (QLog.isColorLevel()) {
        ...
        if (this.jdField_a_of_type_Bbwd != null)
        {
          paramISuperPlayer = this.jdField_a_of_type_Bbwd;
        ...
        if ((this.jdField_b_of_type_Long > 0L) && (this.jdField_c_of_type_Long > 0L) && (this.jdField_a_of_type_Bbwd != null))
        {
          paramISuperPlayer = this.jdField_a_of_type_Bbwd;
        ...
        if ((this.jdField_a_of_type_Bbwg != null) && (this.jdField_a_of_type_Bbwg.jdField_a_of_type_Bbwl != null))
        {
          this.jdField_a_of_type_Bbwg.jdField_a_of_type_Bbwl.a(this.jdField_a_of_type_Long);
          continue;
          if ((paramObject instanceof TPPlayerMsg.TPDownLoadProgressInfo))
          {
            ...
            if ((this.jdField_a_of_type_Bbwg != null) && (this.jdField_a_of_type_Bbwg.jdField_a_of_type_Bbwl != null))
            {
              this.jdField_a_of_type_Bbwg.jdField_a_of_type_Bbwl.b(this.jdField_a_of_type_Long, paramLong1);
              continue;
              if (QLog.isColorLevel()) {
                QLog.d(a(), 2, "onInfo, SuperPlayerMsg.PLAYER_INFO_CURRENT_LOOP_END ");
              }
              if ((this.jdField_a_of_type_Bbwg != null) && (this.jdField_a_of_type_Bbwg.jdField_a_of_type_Bbwl != null) && (this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer != null)) {
                this.jdField_a_of_type_Bbwg.jdField_a_of_type_Bbwl.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.getCurrentPositionMs());
              }
            }
          }
        }
