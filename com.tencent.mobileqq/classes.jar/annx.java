  ...
  implements Runnable
{
  ...
  public annx(TroopHWJsPlugin paramTroopHWJsPlugin, HashMap paramHashMap)
  {
  ...
  public void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        annz localannz = new annz(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.e, this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.d);
        TroopHWJsPlugin.UploadMediaEntry localUploadMediaEntry = this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin, i, localException, null, localannz, 1);
