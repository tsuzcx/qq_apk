  ...
  implements bdvf
{
  ...
  public bdvs(@NotNull BaseActivity paramBaseActivity)
  {
    ...
    a();
    a().a((bdvf)this);
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800ADD4", "0X800ADD4", 0, 0, "", "", "", "");
  }
  ...
  {
    return (bdve)this.c.getValue();
  }
  
  private final void a()
  {
    a().setOnClickListener((View.OnClickListener)new bdvt(this));
    a().setOnClickListener((View.OnClickListener)new bdvu(this));
    setOnDismissListener((DialogInterface.OnDismissListener)new bdvv(this));
  }
  ...
  private final void b()
  {
    if (a().a())
    {
      QQToast.a((Context)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, 2131718613, 0).a();
      return;
    }
    if (bduz.a() == 2)
    {
      QQToast.a((Context)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, 2131719013, 0).a();
      dismiss();
      return;
    }
    int i = bdfk.c();
    bdvh localbdvh = a().a((Activity)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, i, true);
    if ((!localbdvh.a()) && (localbdvh.a() == localbdvh.b()))
    {
      QQToast.a((Context)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, 2131719013, 0).a();
      dismiss();
    }
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800ADD5", "0X800ADD5", 0, 0, "", "", "", "");
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, @NotNull String paramString)
  {
    ...
    for (paramInt1 = 2;; paramInt1 = 1)
    {
      ...
      paramString = this.jdField_a_of_type_Bisl;
      if (paramString != null) {
        paramString.dismiss();
      }
      dismiss();
  ...
  {
    bdvg.a(this, paramBoolean1, paramBoolean2, paramBoolean3, paramInt);
  }
  
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, @Nullable String paramString)
  {
    bdvg.a(this, paramBoolean1, paramBoolean2, paramBoolean3, paramInt, paramString);
  }
  
  public void b(int paramInt1, int paramInt2)
  {
    bisl localbisl = this.jdField_a_of_type_Bisl;
    if ((localbisl != null) && (localbisl.isShowing() == true))
    {
      localbisl = this.jdField_a_of_type_Bisl;
      if (localbisl != null) {
        localbisl.dismiss();
      }
    }
    this.jdField_a_of_type_Bisl = new bisl((Context)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    localbisl = this.jdField_a_of_type_Bisl;
    if (localbisl == null) {
      Intrinsics.throwNpe();
    }
    Window localWindow = localbisl.getWindow();
    if (localWindow != null) {
