...
{
  private awrt jdField_a_of_type_Awrt;
  private awsr jdField_a_of_type_Awsr;
  private awsr b;
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.b == null) {
      this.b = new awsr(this);
    }
    if (this.b.a(paramArrayOfByte1, paramArrayOfByte2, paramInt1, paramInt2, paramInt3, paramInt4, paramFloat, paramBoolean)) {}
    try
    {
      this.jdField_a_of_type_Awsr = null;
      this.jdField_a_of_type_Awsr = this.b;
      if (QLog.isColorLevel()) {
        QLog.d("GLRender", 2, "func copyFrame2Render ends, mCurData:" + this.jdField_a_of_type_Awsr);
      }
      return;
    }
    finally {}
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    //   33: aload_0
    //   34: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   37: ifnull +10 -> 47
    //   40: aload_0
    //   41: getfield 66	awsq:jdField_a_of_type_Awrt	Lawrt;
    //   44: ifnonnull +52 -> 96
    ...
    //   68: aload_0
    //   69: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    ...
    //   80: aload_0
    //   81: getfield 66	awsq:jdField_a_of_type_Awrt	Lawrt;
    ...
    //   95: return
    //   96: aload_0
    //   97: getfield 66	awsq:jdField_a_of_type_Awrt	Lawrt;
    //   100: aload_0
    //   101: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   104: getfield 73	awsr:jdField_a_of_type_ArrayOfByte	[B
    //   107: aload_0
    //   108: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   111: getfield 75	awsr:jdField_b_of_type_ArrayOfByte	[B
    //   114: aload_0
    //   115: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   118: getfield 79	awsr:c	I
    //   121: aload_0
    //   122: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   125: getfield 81	awsr:d	I
    //   128: aload_0
    //   129: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   132: getfield 83	awsr:jdField_a_of_type_Int	I
    //   135: aload_0
    //   136: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   139: getfield 85	awsr:jdField_b_of_type_Int	I
    //   142: aload_0
    //   143: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   146: getfield 88	awsr:jdField_a_of_type_Float	F
    //   149: aload_0
    //   150: getfield 56	awsq:jdField_a_of_type_Awsr	Lawsr;
    //   153: getfield 91	awsr:jdField_a_of_type_Boolean	Z
    //   156: invokevirtual 95	awrt:a	([B[BIIIIFZ)V
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    try
    {
      this.jdField_a_of_type_Awrt = new awrt();
      this.jdField_a_of_type_Awsr = null;
