...
public class akof
  extends akoo
{
  public akof(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(long paramLong, akoi paramakoi)
  {
    ArrayList localArrayList = paramakoi.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    try
    {
        ...
        if (-56 == ((MsgItem)localObject1).cType)
        {
          ...
          if (PushType.PUSH_TYPE_VOTE_INCR.value() == ((PushCardMsg)localObject2).ePushType)
          {
            ...
            if (((PushVoteIncreaseInfo)localObject1).iIncrement > 0)
            {
              ...
              localObject2 = (ajtk)((QQAppInterface)localObject2).a(2);
              if (localObject2 != null) {
                ((ajtk)localObject2).a((PushVoteIncreaseInfo)localObject1, String.valueOf(paramLong), String.valueOf(paramakoi.jdField_a_of_type_Long));
              }
            }
          }
        }
    ...
    catch (Exception paramakoi)
    {
      paramakoi.printStackTrace();
    }
  }
  
  private void a(long paramLong, akoi paramakoi, SvcGetMsgInfo paramSvcGetMsgInfo, boolean paramBoolean)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = paramakoi.jdField_a_of_type_JavaUtilArrayList;
    String str2 = paramakoi.jdField_a_of_type_JavaLangString;
    int m = 0;
    int i = -1000;
    Object localObject3;
    String str1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        QLog.w("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp msgItem.MsgContent:" + bbdm.a(((MsgItem)localObject3).MsgContent));
        localObject3 = null;
        j = i;
        continue;
        if (paramakoi.jdField_a_of_type_Int != 201) {
          continue;
        }
        localObject2 = bbbg.a((String)localObject3, str2);
        if (j != -2000) {
          continue;
        }
        i = -1032;
        ...
        l1 = l2;
        continue;
        if (paramakoi.jdField_a_of_type_Int != 6) {
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp accostMsg.eAccostType" + paramakoi.jdField_a_of_type_Int + "accostMsg.msgId: " + paramakoi.jdField_b_of_type_Long + " accostMsg.time" + paramakoi.c + " msgConten: " + bbbd.a((String)localObject3));
        }
        l2 = paramakoi.jdField_a_of_type_Long;
        if (paramakoi.jdField_a_of_type_Int != 1) {
          continue;
        }
        l1 = 9999L;
        i = j;
        localObject1 = localObject3;
        localObject3 = axaq.a(i);
        ((MessageRecord)localObject3).init(paramLong, l1, paramakoi.jdField_a_of_type_Long, (String)localObject1, paramakoi.c, i, 1001, 0L);
        ((MessageRecord)localObject3).shmsgseq = paramakoi.jdField_b_of_type_Long;
      ...
      if (((MsgItem)localObject3).MsgContent != null)
      {
        localObject1 = new String(axas.a(((MsgItem)localObject3).MsgContent), "utf-8");
        break label953;
        localObject1 = aywi.a(str1, 0L, 1, false, str1);
        i = -2000;
        continue;
        localObject1 = aywi.a(str1, 0L, 2, false, str1);
        i = -2002;
        continue;
        a(paramLong, paramBoolean, paramakoi);
        return;
        if (localArrayList1.size() <= 0) {
          continue;
        }
        boolean bool = akau.a(localArrayList1);
        i = akpy.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramakoi = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramakoi.a(localArrayList1, String.valueOf(paramLong), paramBoolean);
  ...
  private void a(long paramLong1, ArrayList<AccostMsg> paramArrayList, ArrayList<akoh> paramArrayList1, ArrayList<SvcGetMsgInfo> paramArrayList2, long paramLong2, String paramString)
  {
    int i = 0;
    ...
    {
      Object localObject = new akoh();
      ((akoh)localObject).jdField_a_of_type_Long = localAccostMsg.lFromMID;
      ((akoh)localObject).jdField_b_of_type_Long = localAccostMsg.lToMID;
      ((akoh)localObject).c = localAccostMsg.uMsgID;
      ((akoh)localObject).jdField_a_of_type_Short = localAccostMsg.shMsgType;
      paramArrayList1.add(localObject);
      boolean bool = a(String.valueOf(paramLong1), String.valueOf(localAccostMsg.lFromMID));
      if (QLog.isColorLevel())
      {
        akau.a("Q.msg.BaseMessageProcessor", paramString, localAccostMsg.uMsgID, String.valueOf(paramLong1), String.valueOf(localAccostMsg.lToMID));
      ...
      {
        a(paramLong1, new akoi(paramLong2, j, localAccostMsg.uMsgID, localAccostMsg.iMsgTime, localArrayList, ((RichMsg)localObject).sAction), localSvcGetMsgInfo, false);
        break;
      }
      return;
    }
  ...
  private void a(long paramLong, boolean paramBoolean, akoi paramakoi)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      int j = 0;
      while (j < paramakoi.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ((StringBuffer)localObject).append(new String(((MsgItem)paramakoi.jdField_a_of_type_JavaUtilArrayList.get(j)).MsgContent));
        if (j < paramakoi.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
    ...
    localSystemMsg.auth = paramakoi.jdField_a_of_type_ArrayOfByte;
    localSystemMsg.lToMobile = paramakoi.e;
    localSystemMsg.strNickName = paramakoi.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, addUin=" + paramakoi.d + ", msgUid=" + paramakoi.jdField_b_of_type_Long + ", msg=" + localSystemMsg.sMsg);
    }
    Object localObject = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(String.valueOf(l));
    label320:
    MessageRecord localMessageRecord;
    if (localObject != null)
    {
      localObject = bbcl.a((Friends)localObject);
      ...
      localObject = bbdm.a(((JceOutputStream)localObject).toByteArray());
      if (localObject != null)
      {
        localMessageRecord = axaq.a(-1011);
        localMessageRecord.init(paramLong, 9998L, l, (String)localObject, 0L, -1011, 0, paramakoi.c);
        localMessageRecord.shmsgseq = 187L;
        localMessageRecord.msgUid = paramakoi.jdField_b_of_type_Long;
        if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      {
        i = akpy.a(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      label599:
      if (QLog.isColorLevel()) {
        QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, the message is remove by msgFilter, addUin=" + paramakoi.d + ", msgUid=" + localMessageRecord.msgUid + ", msg=" + localSystemMsg.sMsg);
      }
    }
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getUin() == null)
    {
      ...
      if (QLog.isColorLevel()) {
        akau.a("Q.msg.BaseMessageProcessor", (String)paramFromServiceMsg.getAttribute("_tag_LOGSTR"), paramObject.stMsg.uMsgID, paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID));
      }
      if (!bool) {
    ...
    for (;;)
    {
      ...
      if ((paramObject.bResend != 1) || (!a(paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID), paramObject.stMsg.uMsgID)))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.VecMsg != null))
        {
          ...
          localObject = new akoi(paramObject.stMsg.lFromMID, paramObject.stMsg.eAccostType, paramObject.stMsg.uMsgID, paramObject.stMsg.iMsgTime, (ArrayList)localObject, paramFromServiceMsg.sAction);
          if (paramFromServiceMsg.stSender != null)
          {
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "handlePushAccostMsg richMsg.stSender is null");
            }
            ((akoi)localObject).d = paramFromServiceMsg.stSender.lMobileUin;
            ((akoi)localObject).jdField_a_of_type_ArrayOfByte = paramFromServiceMsg.stSender.sig;
            ((akoi)localObject).jdField_b_of_type_JavaLangString = paramFromServiceMsg.stSender.nickname;
          }
          ((akoi)localObject).e = paramObject.stMsg.lFromMID;
          a(Long.valueOf(paramToServiceMsg).longValue(), (akoi)localObject, null, false);
          continue;
          paramFromServiceMsg = a(paramObject.stMsg.strMsg);
          if (paramFromServiceMsg != null)
          {
            paramFromServiceMsg = new akoi(paramObject.stMsg.lFromMID, paramFromServiceMsg.VecMsg);
  ...
  {
    paramString = bdey.a(paramString);
    ...
    {
      if (str != null) {
        bdjo.a().a(String.valueOf(paramLong), str, paramString, "100", paramBoolean);
      }
      return;
    }
  }
  ...
  {
    paramString1 = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString2);
  ...
  {
    aukn localaukn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory(String.valueOf(paramString1)).createEntityManager();
    paramString1 = localaukn.a(false, MessageRecord.getTableName(paramString2, 1001), null, "msgseq=?", new String[] { String.valueOf(paramLong) }, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = localaukn.a(false, MessageRecord.getTableName(paramString2, 10002), null, "msgseq=?", new String[] { String.valueOf(paramLong) }, null, null, null, null);
        int j = 0;
        if (paramString1 != null) {}
        return false;
      }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    a(false, false, false, 0L, new akog(this, paramArrayOfByte, paramInt));
  }
