...
public class bcgq
{
  ...
  public static ArrayList<bcgr> a(long paramLong, DataInputStream paramDataInputStream, int paramInt1, int paramInt2)
  {
                ...
                if (!TextUtils.isEmpty(localObject4))
                {
                  ...
                  if (l != -1L)
                  {
                    ...
                    if (localObject1 == null) {
                      localObject3 = new bcgr();
                    }
                    ((bcgr)localObject3).jdField_a_of_type_Long = paramLong;
                    ((bcgr)localObject3).jdField_a_of_type_Int = paramInt2;
                    ((bcgr)localObject3).b = l;
                    ((bcgr)localObject3).jdField_a_of_type_JavaLangString = localObject4;
  ...
  public static ArrayList<bcgr> a(long paramLong, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      ...
      while (j < k)
      {
        bcgr localbcgr = (bcgr)localArrayList2.get(j);
        if (!localHashMap.containsKey(Long.valueOf(localbcgr.b)))
        {
          localArrayList1.add(localbcgr);
          localHashMap.put(Long.valueOf(localbcgr.b), Boolean.valueOf(true));
        }
        j += 1;
      }
      i += 1;
