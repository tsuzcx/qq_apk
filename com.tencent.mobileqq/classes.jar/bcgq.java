  ...
  implements bcfh
{
  ...
  public bcgq(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public bcgq(QQAppInterface paramQQAppInterface, int paramInt1, byte[] paramArrayOfByte, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.c = paramInt1;
  ...
  public static List<bcgq> a(QQAppInterface paramQQAppInterface, List<DynamicDiscovery.Result> paramList, int paramInt)
  {
    ...
    {
      bbzh.b = ((AladdinConfig)localObject1).getString("SBWord_Source", "Hot_word");
      i = ((AladdinConfig)localObject1).getIntegerFromString("SearchPage_UIType", 0);
      bbzh.a = ((AladdinConfig)localObject1).getIntegerFromString("SearchPage_RwordNum", 8);
    }
        ...
        case 3: 
          for (;;)
          {
            ...
            for (localObject4 = null;; localObject4 = new HotWordSearchEntryDataModel(paramQQAppInterface, m, ((DynamicDiscovery.Result)localObject4).toByteArray(), paramInt, false))
            {
              ...
              break;
              if (bbzh.b.contentEquals("Hot_word"))
              {
                ...
                bhhr.a(paramQQAppInterface.getCurrentAccountUin(), (String[])localObject5);
              }
            }
            localObject4 = new bcdo(paramQQAppInterface, m, ((DynamicDiscovery.Result)localObject4).toByteArray(), paramInt, false);
    ...
    for (;;)
    {
      boolean bool = a(arrayOfInt, bbzh.a(paramQQAppInterface, paramInt, false));
      bbzh.a(paramQQAppInterface, paramInt, bool, false);
      if (bool) {
        bbzh.a(paramQQAppInterface, paramInt, arrayOfInt, false);
      }
  ...
  public static List<bcgq> b(QQAppInterface paramQQAppInterface, List<UnifySearchDiscovery.Result> paramList, int paramInt)
  {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            bhhr.b(paramQQAppInterface.getCurrentAccountUin(), arrayOfString);
            ...
            continue;
            localObject = new bcdo(paramQQAppInterface, k, ((UnifySearchDiscovery.Result)localObject).toByteArray(), paramInt, true);
          }
        }
      }
      boolean bool = a(arrayOfInt, bbzh.a(paramQQAppInterface, paramInt, true));
      bbzh.a(paramQQAppInterface, paramInt, bool, true);
      if (bool) {
        bbzh.a(paramQQAppInterface, paramInt, arrayOfInt, true);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("SearchEntryDataModel", 2, "convertPbDataToModel, modelList = " + localArrayList.size());
