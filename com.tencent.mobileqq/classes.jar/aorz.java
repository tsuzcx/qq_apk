...
public class aorz
  extends aczo
{
  public aorz(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(long paramLong, aosc paramaosc)
  {
    ArrayList localArrayList = paramaosc.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    try
    {
        ...
        if (-56 == ((MsgItem)localObject1).cType)
        {
          ...
          if (PushType.PUSH_TYPE_VOTE_INCR.value() == ((PushCardMsg)localObject2).ePushType)
          {
            ...
            if (((PushVoteIncreaseInfo)localObject1).iIncrement > 0)
            {
              ...
              localObject2 = (anum)((QQAppInterface)localObject2).a(2);
              if (localObject2 != null) {
                ((anum)localObject2).a((PushVoteIncreaseInfo)localObject1, String.valueOf(paramLong), String.valueOf(paramaosc.jdField_a_of_type_Long));
              }
            }
          }
        }
    ...
    catch (Exception paramaosc)
    {
      paramaosc.printStackTrace();
    }
  }
  
  private void a(long paramLong, aosc paramaosc, SvcGetMsgInfo paramSvcGetMsgInfo, boolean paramBoolean)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = paramaosc.jdField_a_of_type_JavaUtilArrayList;
    String str2 = paramaosc.jdField_a_of_type_JavaLangString;
    int m = 0;
    int i = -1000;
    Object localObject3;
    String str1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        QLog.w("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp msgItem.MsgContent:" + bhml.a(((MsgItem)localObject3).MsgContent));
        localObject3 = null;
        j = i;
        continue;
        if (paramaosc.jdField_a_of_type_Int != 201) {
          continue;
        }
        localObject2 = bhka.a((String)localObject3, str2);
        if (j != -2000) {
          continue;
        }
        i = -1032;
        ...
        l1 = l2;
        continue;
        if (paramaosc.jdField_a_of_type_Int != 6) {
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp accostMsg.eAccostType" + paramaosc.jdField_a_of_type_Int + "accostMsg.msgId: " + paramaosc.jdField_b_of_type_Long + " accostMsg.time" + paramaosc.c + " msgConten: " + bhjx.a((String)localObject3));
        }
        l2 = paramaosc.jdField_a_of_type_Long;
        if (paramaosc.jdField_a_of_type_Int != 1) {
          continue;
        }
        l1 = 9999L;
        i = j;
        localObject1 = localObject3;
        localObject3 = bcry.a(i);
        ((MessageRecord)localObject3).init(paramLong, l1, paramaosc.jdField_a_of_type_Long, (String)localObject1, paramaosc.c, i, 1001, 0L);
        ((MessageRecord)localObject3).shmsgseq = paramaosc.jdField_b_of_type_Long;
      ...
      if (((MsgItem)localObject3).MsgContent != null)
      {
        localObject1 = new String(bcsa.a(((MsgItem)localObject3).MsgContent), "utf-8");
        break label954;
        localObject1 = beyo.a(str1, 0L, 1, false, str1);
        i = -2000;
        continue;
        localObject1 = beyo.a(str1, 0L, 2, false, str1);
        i = -2002;
        continue;
        a(paramLong, paramBoolean, paramaosc);
        return;
        if (localArrayList1.size() <= 0) {
          continue;
        }
        boolean bool = aoci.a(localArrayList1);
        i = adak.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramaosc = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramaosc.a(localArrayList1, String.valueOf(paramLong), paramBoolean);
  ...
  private void a(long paramLong1, ArrayList<AccostMsg> paramArrayList, ArrayList<aosb> paramArrayList1, ArrayList<SvcGetMsgInfo> paramArrayList2, long paramLong2, String paramString)
  {
    int i = 0;
    ...
    {
      Object localObject = new aosb();
      ((aosb)localObject).jdField_a_of_type_Long = localAccostMsg.lFromMID;
      ((aosb)localObject).jdField_b_of_type_Long = localAccostMsg.lToMID;
      ((aosb)localObject).c = localAccostMsg.uMsgID;
      ((aosb)localObject).jdField_a_of_type_Short = localAccostMsg.shMsgType;
      paramArrayList1.add(localObject);
      boolean bool = a(String.valueOf(paramLong1), String.valueOf(localAccostMsg.lFromMID));
      if (QLog.isColorLevel())
      {
        aoci.a("Q.msg.BaseMessageProcessor", paramString, localAccostMsg.uMsgID, String.valueOf(paramLong1), String.valueOf(localAccostMsg.lToMID));
      ...
      {
        a(paramLong1, new aosc(paramLong2, j, localAccostMsg.uMsgID, localAccostMsg.iMsgTime, localArrayList, ((RichMsg)localObject).sAction), localSvcGetMsgInfo, false);
        break;
      }
      return;
    }
  ...
  private void a(long paramLong, boolean paramBoolean, aosc paramaosc)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      int j = 0;
      while (j < paramaosc.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ((StringBuffer)localObject).append(new String(((MsgItem)paramaosc.jdField_a_of_type_JavaUtilArrayList.get(j)).MsgContent));
        if (j < paramaosc.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
    ...
    localSystemMsg.auth = paramaosc.jdField_a_of_type_ArrayOfByte;
    localSystemMsg.lToMobile = paramaosc.e;
    localSystemMsg.strNickName = paramaosc.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, addUin=" + paramaosc.d + ", msgUid=" + paramaosc.jdField_b_of_type_Long + ", msg=" + localSystemMsg.sMsg);
    }
    Object localObject = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(String.valueOf(l));
    label320:
    ...
    if (localObject != null)
    {
      ...
      localSystemMsg.message = (l + BaseApplication.getContext().getString(2131689584));
      ...
      localObject = bhml.a(((JceOutputStream)localObject).toByteArray());
      if (localObject != null)
      {
        localMessageRecord = bcry.a(-1011);
        localMessageRecord.init(paramLong, 9998L, l, (String)localObject, 0L, -1011, 0, paramaosc.c);
        localMessageRecord.shmsgseq = 187L;
        localMessageRecord.msgUid = paramaosc.jdField_b_of_type_Long;
        if (paramBoolean) {
        ...
        if (aoci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, true)) {
          break label599;
        }
    ...
    for (;;)
    {
      ...
      {
        i = adak.a(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      break;
      label558:
      localSystemMsg.message = ((String)localObject + BaseApplication.getContext().getString(2131689584));
      break label320;
      label593:
      i = 0;
      break label427;
      label599:
      if (QLog.isColorLevel()) {
        QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, the message is remove by msgFilter, addUin=" + paramaosc.d + ", msgUid=" + localMessageRecord.msgUid + ", msg=" + localSystemMsg.sMsg);
      }
    }
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getUin() == null)
    {
      ...
      if (QLog.isColorLevel()) {
        aoci.a("Q.msg.BaseMessageProcessor", (String)paramFromServiceMsg.getAttribute("_tag_LOGSTR"), paramObject.stMsg.uMsgID, paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID));
      }
      if (!bool) {
    ...
    for (;;)
    {
      ...
      if ((paramObject.bResend != 1) || (!a(paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID), paramObject.stMsg.uMsgID)))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.VecMsg != null))
        {
          ...
          localObject = new aosc(paramObject.stMsg.lFromMID, paramObject.stMsg.eAccostType, paramObject.stMsg.uMsgID, paramObject.stMsg.iMsgTime, (ArrayList)localObject, paramFromServiceMsg.sAction);
          if (paramFromServiceMsg.stSender != null)
          {
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "handlePushAccostMsg richMsg.stSender is null");
            }
            ((aosc)localObject).d = paramFromServiceMsg.stSender.lMobileUin;
            ((aosc)localObject).jdField_a_of_type_ArrayOfByte = paramFromServiceMsg.stSender.sig;
            ((aosc)localObject).jdField_b_of_type_JavaLangString = paramFromServiceMsg.stSender.nickname;
          }
          ((aosc)localObject).e = paramObject.stMsg.lFromMID;
          a(Long.valueOf(paramToServiceMsg).longValue(), (aosc)localObject, null, false);
          continue;
          paramFromServiceMsg = a(paramObject.stMsg.strMsg);
          if (paramFromServiceMsg != null)
          {
            paramFromServiceMsg = new aosc(paramObject.stMsg.lFromMID, paramFromServiceMsg.VecMsg);
  ...
  {
    paramString = bjrc.a(paramString);
    ...
    {
      if (str != null) {
        bjvq.a().a(String.valueOf(paramLong), str, paramString, "100", paramBoolean);
      }
      return;
    }
  }
  ...
  {
    paramString1 = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString2);
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    a(false, false, false, 0L, new aosa(this, paramArrayOfByte, paramInt));
  }
