  ...
  implements lgm
{
  ...
  {
    ((lip)paramVideoAppInterface.a(0)).b();
  ...
  private boolean b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        ...
        lbc.c("EffectZimuManager", "parse ZIMU:" + paramString);
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    ((lfq)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1)).a();
    new mcd(paramLong, "onSessionStatusChanged", 2, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
  }
  ...
  public void a(String paramString, long paramLong)
  {
    if (this.b)
    {
      lft locallft = (lft)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
      locallft.a(paramString, paramLong, "TransInfo.ExitSession", null);
      locallft.onDestroy();
      ((lfq)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1)).a();
    }
    this.b = false;
  ...
  public void a(String paramString1, boolean paramBoolean, long paramLong, String paramString2)
  {
    ...
    if (!this.b)
    {
      lfq locallfq = (lfq)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1);
      locallfq.a(paramString1, "TransInfoCreate.CreateSession", paramLong, paramString2);
      locallfq.onDestroy();
      this.c = paramBoolean;
    }
    this.b = true;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      if ((!lio.a(localZimuItem.getId())) || (localZimuItem.isUsable() == paramBoolean)) {
        break label82;
      }
  ...
  public boolean a(long paramLong, ZimuItem paramZimuItem)
  {
    ...
    else
    {
      ...
      if (this.jdField_a_of_type_Lgj != null) {
        break label208;
      }
    }
    label208:
    for (int i = 4;; i = 5)
    {
      ...
      if (paramZimuItem != null)
      {
        ...
        if (localObject != null) {
          ((lgl)localObject).a(3001, paramZimuItem.getId());
        }
      }
      return bool;
  ...
  public void b(String paramString, long paramLong)
  {
    ...
    {
      lft locallft = (lft)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
      locallft.a(paramString, paramLong, "TransInfo.ChangeSession", null);
      locallft.onDestroy();
    }
  }
