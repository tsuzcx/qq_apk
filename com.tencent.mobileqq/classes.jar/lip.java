...
public class lip
{
  ...
  public lip(RandomWebProtocol paramRandomWebProtocol)
  {
    ...
    this.jdField_a_of_type_JavaLangString = "8.2.6";
  ...
  lip(RandomWebProtocol paramRandomWebProtocol, lip paramlip)
  {
    this.jdField_a_of_type_Int = paramlip.jdField_a_of_type_Int;
    this.jdField_a_of_type_JavaLangString = paramlip.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_Boolean = paramlip.jdField_a_of_type_Boolean;
    this.jdField_a_of_type_Long = paramlip.jdField_a_of_type_Long;
    this.jdField_b_of_type_JavaLangString = paramlip.jdField_b_of_type_JavaLangString;
    this.jdField_b_of_type_Int = paramlip.jdField_b_of_type_Int;
    this.jdField_a_of_type_OrgJsonJSONObject = paramlip.jdField_a_of_type_OrgJsonJSONObject;
    this.c = paramlip.c;
    this.d = paramlip.d;
    this.e = paramlip.e;
  }
