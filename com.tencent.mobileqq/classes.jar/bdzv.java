  ...
  extends bdzt
{
  ...
  public bdzv(SpriteNativeView paramSpriteNativeView, String paramString)
  {
  ...
  public boolean c()
  {
    ...
    a(this.jdField_a_of_type_Bdyc);
    float f1 = this.jdField_a_of_type_Bdyc.jdField_a_of_type_Float;
    float f2 = b();
    float f3 = this.jdField_a_of_type_Float / 2.0F;
    float f4 = this.f;
    float f5 = this.jdField_a_of_type_Bdyc.b;
    float f6 = b();
