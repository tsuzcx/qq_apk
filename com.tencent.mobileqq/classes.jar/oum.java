...
public class oum
{
  static oum jdField_a_of_type_Oum;
  ...
  public static oum a()
  {
    try
    {
      if (jdField_a_of_type_Oum == null) {
        jdField_a_of_type_Oum = new oum();
      }
      return jdField_a_of_type_Oum;
    }
    finally {}
  }
  ...
  public Fragment a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    if (paramTabChannelCoverInfo.mChannelCoverId == pab.a()) {
    ...
    for (;;)
    {
      ...
      {
      default: 
        if (rwa.a(paramTabChannelCoverInfo.mChannelJumpUrl))
        {
      ...
      case 41450: 
        ...
        if (paramTabChannelCoverInfo.bid > 0L)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((oqm)localObject2).b("cgi"))) {}
