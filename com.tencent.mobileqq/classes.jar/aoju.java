public class aoju
{
  ...
  public static com.tencent.mobileqq.ar.aidl.ArCloudConfigInfo a(java.lang.String paramString1, java.lang.String paramString2)
  {
    ...
    //   41: ldc 36
    //   43: invokestatic 41	amtj:a	(I)Ljava/lang/String;
    ...
    //   139: aload_0
    //   140: invokestatic 77	aogq:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/ar/aidl/ArCloudConfigInfo;
    //   143: astore_0
    //   144: ldc 64
    //   146: iconst_1
  ...
  public static void a(java.lang.String paramString1, java.lang.String paramString2)
  {
    ...
    //   425: aload 7
    //   427: aload 8
    //   429: invokestatic 201	com/tencent/mobileqq/utils/FileUtils:renameFile	(Ljava/io/File;Ljava/io/File;)Z
    //   432: ifne +139 -> 571
    //   435: aload 7
    //   437: aload 8
    //   439: invokestatic 204	com/tencent/mobileqq/utils/FileUtils:copyFile	(Ljava/io/File;Ljava/io/File;)Z
    //   442: pop
    //   443: goto +128 -> 571
    //   446: astore 5
    //   448: aconst_null
    ...
    //   461: iconst_0
    //   462: ifeq +11 -> 473
    //   465: new 206	java/lang/NullPointerException
    //   468: dup
    //   469: invokespecial 207	java/lang/NullPointerException:<init>	()V
    //   472: athrow
    //   473: iconst_0
    //   474: ifeq +11 -> 485
    //   477: new 206	java/lang/NullPointerException
    //   480: dup
    //   481: invokespecial 207	java/lang/NullPointerException:<init>	()V
    //   484: athrow
    //   485: aload_0
    //   486: ifnull +7 -> 493
    //   489: aload_0
  ...
  public static boolean a(java.lang.String paramString1, java.lang.String paramString2, java.lang.String paramString3)
  {
    ...
    //   54: dup
    //   55: aload_1
    //   56: invokevirtual 211	java/io/File:getParent	()Ljava/lang/String;
    ...
    //   85: astore 4
    //   87: aload_1
    //   88: invokevirtual 214	java/io/File:createNewFile	()Z
    //   91: pop
    //   92: aload 6
    //   94: astore 4
    ...
    //   105: aload_1
    //   106: aload_0
    //   107: invokevirtual 218	java/lang/String:getBytes	()[B
    //   110: invokevirtual 221	java/io/FileOutputStream:write	([B)V
    //   113: aload_1
    //   114: ifnull +7 -> 121
    //   117: aload_1
    ...
    //   138: astore 4
    //   140: aload_1
    //   141: invokevirtual 222	java/lang/Exception:printStackTrace	()V
    //   144: iconst_0
    //   145: istore_3
    //   146: aload_0
    //   147: ifnull -24 -> 123
