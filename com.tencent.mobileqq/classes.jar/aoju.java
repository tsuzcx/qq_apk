  ...
  extends anud
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new aojw(this);
  public Handler a;
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public Messenger a;
  SparseArray<aojz> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final ArrayList<aojy> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  aoju(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidOsMessenger = null;
    this.jdField_b_of_type_AndroidOsMessenger = null;
    this.jdField_a_of_type_AndroidOsHandler = new aojv(this, Looper.getMainLooper(), paramQQAppInterface);
  }
  ...
  private void a(int paramInt1, aojz paramaojz, int paramInt2, int paramInt3)
  {
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage();
    localMessage.what = 1;
    localMessage.obj = new Object[] { Integer.valueOf(paramInt1), paramaojz, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) };
  ...
  private void b()
  {
    ...
    bmtd.a(this.app, this.jdField_a_of_type_AndroidContentServiceConnection);
  }
  ...
  {
    aojz localaojz = (aojz)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    if (localaojz == null) {
      return;
    }
    a(paramInt2, localaojz, paramInt1, paramInt3);
  }
  
  public void a(int paramInt, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.append(paramInt, new aojz(this, paramString, paramLong));
    }
    a(paramInt);
  }
  ...
  void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      Object localObject = (aojy)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((aojy)localObject).a();
      localObject = ((aojy)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((aojx)localObject).a(localView, paramLong, paramInt1, paramInt2);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, aojx paramaojx)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      aojy localaojy = (aojy)localIterator.next();
      if (localaojy.a() == paramView)
      {
        localaojy.b = new WeakReference(paramaojx);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new aojy(this, paramView, paramaojx));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    for (Object localObject2 = (StructMsgForGeneralShare)localObject2;; localObject2 = null)
    {
      ...
      for (;;)
      {
        ...
        ((StructMsgForGeneralShare)localObject2).mMsgBrief = (anzj.a(2131714503) + (String)localObject1);
