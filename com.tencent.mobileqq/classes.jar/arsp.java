...
public class arsp
  extends Handler
{
  public arsp(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      return;
    case 3: 
      this.a.jdField_a_of_type_Arsq.a(1, false);
      return;
    case 4: 
      i = paramMessage.arg1;
      k = paramMessage.arg2;
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        paramMessage = (artk)paramMessage.obj;
        if (paramMessage.a)
        {
          i = 2;
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        {
          this.a.jdField_a_of_type_Arsq.c();
          bool1 = true;
        }
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_Arsq.a(paramMessage, ((Boolean)localObject).booleanValue(), i, bool2, bool1);
          ...
          paramMessage = (arti)paramMessage.obj;
          if (this.a.b == 0)
          {
          ...
          for (;;)
          {
            ...
            this.a.jdField_c_of_type_JavaUtilHashMap.put(paramMessage.e, Integer.valueOf(i));
            break label444;
            if (this.a.jdField_a_of_type_Amuu == null) {
              break;
            }
            this.a.jdField_a_of_type_Amuu.a(this.a.app.getCurrentAccountUin(), true);
            ...
            paramMessage = this.a.getResources().getString(2131691993);
            QQToast.a(this.a, 0, paramMessage, 0).b(this.a.getTitleBarHeight());
            return;
            this.a.a();
            return;
            this.a.jdField_a_of_type_Arsq.b();
            return;
            this.a.f();
            return;
            Face2FaceAddFriendActivity.a(this.a, (arti)paramMessage.obj);
            return;
            Face2FaceAddFriendActivity.a(this.a, paramMessage.arg1);
            return;
            this.a.a((artf)paramMessage.obj);
            return;
            paramMessage = this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
            while (paramMessage.hasNext())
            {
              localObject = (arti)paramMessage.next();
              if ((((arti)localObject).a == 1) && (Face2FaceAddFriendActivity.a(this.a, ((arti)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((arti)localObject).a);
              } else if ((((arti)localObject).a == 2) && (this.a.a(((arti)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((arti)localObject).a);
              }
            }
            long l = this.a.o;
            paramMessage = new artj(l + 2396794490L + "", "Member " + this.a.o, 1, 1, "");
            localObject = this.a;
            ...
            return;
            if (!(paramMessage.obj instanceof artj)) {
              break;
            }
            paramMessage = (artj)paramMessage.obj;
            this.a.a(paramMessage);
            return;
            if (!(paramMessage.obj instanceof artj)) {
              break;
            }
            this.a.jdField_a_of_type_JavaUtilArrayList.add((artj)paramMessage.obj);
            return;
            if (!(paramMessage.obj instanceof artj)) {
              break;
            }
            Face2FaceAddFriendActivity.a(this.a).a((artj)paramMessage.obj);
            return;
