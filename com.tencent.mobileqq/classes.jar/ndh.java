  ...
  implements Manager
{
  ...
  public String a;
  HashMap<String, ndj> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public ndh(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Baho = new ndi(this);
  ...
  public ndj a(String paramString, long paramLong)
  {
    ndj localndj2 = (ndj)this.jdField_a_of_type_JavaUtilHashMap.get(paramString + paramLong);
    ndj localndj1 = localndj2;
    if (localndj2 == null)
    {
      localndj1 = new ndj(this);
      localndj1.jdField_a_of_type_JavaLangString = paramString;
      localndj1.jdField_a_of_type_Long = paramLong;
      this.jdField_a_of_type_JavaUtilHashMap.put(localndj1.a(), localndj1);
    }
    return localndj1;
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    new bahn("http://now.qq.com/cgi-bin/now/web/room/get_live_room_url", "GET", this.jdField_a_of_type_Baho, 1001, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    paramString2.put("CONTEXT", MobileQQ.getContext());
    new bahn("http://now.qq.com/cgi-bin/now/web/room/check_live_stat", "GET", this.jdField_a_of_type_Baho, 1003, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public boolean b()
  {
    ...
    Iterator localIterator = ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a().iterator();
