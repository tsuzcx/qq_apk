  ...
  extends ajtb
{
  ...
  public void a(String paramString1, long paramLong, String paramString2, ndi paramndi)
  {
    this.jdField_a_of_type_Ndi = null;
    this.jdField_a_of_type_Ndi = paramndi;
    ...
    paramndi = new ilive_get_record_info_svr.GetRoomStateReq();
    paramndi.source.set(paramString1);
    paramndi.roomid.set((int)paramLong);
    ...
    paramString1.busi_buf.set(ByteStringMicro.copyFrom(((ilive_get_record_info_svr.GetRoomStateReq)paramndi.get()).toByteArray()));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (this.jdField_a_of_type_Ndi != null) {
      this.jdField_a_of_type_Ndi.a(paramBoolean, paramString2, paramString1, paramLong, paramString3);
    }
  }
