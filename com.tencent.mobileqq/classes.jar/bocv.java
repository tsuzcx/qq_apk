...
public class bocv
{
  ...
  public static String a(List<bocv> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localStringBuilder.append(((bocv)paramList.next()).a()).append(";");
    }
    return localStringBuilder.toString();
  }
  
  public static List<bocv> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      break;
      label56:
      bocv localbocv = new bocv();
      localbocv.a(localCharSequence);
      localArrayList.add(localbocv);
    }
  }
