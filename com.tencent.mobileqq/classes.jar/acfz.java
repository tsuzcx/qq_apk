...
public class acfz
  extends ajxl
{
  public acfz(TroopAssistantActivity paramTroopAssistantActivity) {}
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    do
    {
      return;
      int i;
      if (("batch_setting".equals(this.a.b)) && (this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.size() > 0) && (this.a.jdField_a_of_type_Bbix != null))
      {
        i = 0;
        for (;;)
        {
          ...
          if (((Boolean)this.a.jdField_a_of_type_Bbix.c.get(paramMap)).booleanValue()) {
            break;
          }
          i += 1;
        }
        bcpw.a(this.a.app.getApp(), 2, ajyc.a(2131715204), 0).b(this.a.getTitleBarHeight());
    ...
    if (paramBoolean)
    {
      bcpw.a(this.a.app.getApp(), 2, this.a.getString(2131720539), 0).b(this.a.getTitleBarHeight());
      return;
    }
