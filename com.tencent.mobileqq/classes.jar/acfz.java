  ...
  extends PublicBaseFragment
{
  ...
  public static void a(Activity paramActivity, JSONObject paramJSONObject, Class<? extends acfz> paramClass)
  {
    if ((paramActivity == null) || (paramJSONObject == null))
    {
      acho.b("GdtBaseBannerFragment", "start error");
      return;
    }
    acho.b("GdtBaseBannerFragment", "start");
    ...
    aeow.a(paramActivity, paramJSONObject, PublicFragmentActivityForTool.class, paramClass);
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBundle = (qq_ad_get.QQAdGet)qq_ad_get.QQAdGet.class.cast(achn.a(new qq_ad_get.QQAdGet(), paramBundle));
      ...
      catch (JSONException paramLayoutInflater)
      {
        for (;;)
        {
          acho.d("GdtBaseBannerFragment", "createParams error", paramLayoutInflater);
        }
      }
      paramLayoutInflater = new Button(getActivity());
      paramLayoutInflater.setText("load");
      paramLayoutInflater.setOnClickListener(new acga(this));
      paramViewGroup = new Button(getActivity());
      paramViewGroup.setText("show");
      paramViewGroup.setOnClickListener(new acgb(this));
