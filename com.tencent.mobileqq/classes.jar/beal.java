...
public class beal
{
  ...
  private List<beba> jdField_a_of_type_JavaUtilList = new ArrayList();
  private List<String> b = new ArrayList();
  
  public beal(JSONObject paramJSONObject)
  {
      ...
      try
      {
        ...
        if (localObject != null)
        {
          ...
          if (i < ((JSONArray)localObject).length())
          {
            ...
            this.jdField_a_of_type_JavaUtilList.add(new beba(localJSONObject));
            break label248;
          }
        }
  ...
  public boolean a(Object paramObject)
  {
    if (!this.jdField_a_of_type_JavaUtilList.isEmpty())
    {
      ...
      {
        beba localbeba = (beba)localIterator.next();
        if (!localbeba.a()) {
          return false;
        }
        if (!localbeba.a(paramObject)) {
          return false;
        }
      }
      return true;
