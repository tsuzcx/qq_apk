  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  private afis jdField_a_of_type_Afis = new afip(this);
  ...
  public afim(QQAppInterface paramQQAppInterface, EmoticonGroupStoreFragment paramEmoticonGroupStoreFragment, int paramInt, View paramView, ViewPager paramViewPager, Button paramButton)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131298008));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302332));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312637));
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new afin(this));
    this.jdField_b_of_type_AndroidWidgetButton = paramButton;
    this.jdField_a_of_type_Anbu = ((anbu)paramQQAppInterface.getManager(259));
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_ComTencentMobileqqActivityEmogroupstoreEmoticonGroupStoreFragment.a.size() > 0)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843494));
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(true);
      return;
      label234:
      paramInt1 = this.jdField_a_of_type_ComTencentMobileqqActivityEmogroupstoreEmoticonGroupStoreFragment.a.size();
      if (this.jdField_a_of_type_Anbu.jdField_b_of_type_Int <= paramInt1)
      {
        if (300 == ance.jdField_a_of_type_Int)
        {
          bbmy.a(this.jdField_a_of_type_AndroidContentContext, 2131624149, 0).b(2131167766);
        }
        else if (144 == ance.jdField_a_of_type_Int)
        {
          localObject = new afio(this);
          localObject = babr.a(this.jdField_a_of_type_AndroidContentContext, 0, ajjy.a(2131642373), this.jdField_a_of_type_AndroidContentContext.getString(2131624148), ajjy.a(2131642374), ajjy.a(2131642376), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
          if (localObject != null) {
      ...
      {
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, "单次最多收藏20个表情哦~", 0).b(2131167766);
      }
    }
    this.jdField_b_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBFBFBF"));
    this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843495));
  ...
  private void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (1 == paramEmoticonFromGroupEntity.fromType)
    {
      ...
      paramEmoticonFromGroupEntity = babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramEmoticonFromGroupEntity.troopUin, true);
    }
    for (;;)
    {
      ...
      if (3000 == paramEmoticonFromGroupEntity.fromType)
      {
        ...
        paramEmoticonFromGroupEntity = babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramEmoticonFromGroupEntity.troopUin);
      }
      else
      {
  ...
  private void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity, int paramInt1, int paramInt2)
  {
    ...
    if (-1 != paramEmoticonFromGroupEntity.status)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131642370));
        this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843495));
    ...
    for (;;)
    {
      j += 1;
      break label138;
      this.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131642371));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843494));
  ...
  private void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    if (paramEmoticonFromGroupEntity.status == 0)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131642377));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843495));
      this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131642375));
    this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843494));
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
  }
  ...
  public void a(Map<String, List<EmoticonFromGroupEntity>> paramMap, List<EmoticonFromGroupEntity> paramList)
  {
    ...
    while (paramMap.hasNext())
    {
      ...
      String str = (String)((Map.Entry)localObject).getKey();
      localObject = (List)((Map.Entry)localObject).getValue();
      this.jdField_b_of_type_JavaUtilMap.put(str, this.jdField_a_of_type_Anbw.a(str, ((List)localObject).size(), "  "));
    }
    notifyDataSetChanged();
  ...
  {
    if ((paramViewHolder instanceof afit))
    {
      afit localafit = (afit)paramViewHolder;
      List localList = (List)this.e.get(Integer.valueOf(paramInt));
      int j = localList.size();
      int i = 0;
      if (i < 3)
      {
        RelativeLayout localRelativeLayout = (RelativeLayout)localafit.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].getParent();
        if (i < j)
        {
          localRelativeLayout.setVisibility(0);
          localafit.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageDrawable(this.jdField_a_of_type_Anbw.a((EmoticonFromGroupEntity)localList.get(i), 65537, this.jdField_a_of_type_Int, null));
          this.jdField_b_of_type_Int = ((EmoticonFromGroupEntity)((List)this.e.get(Integer.valueOf(paramInt))).get(i)).status;
          if (this.jdField_b_of_type_Int == 0)
          {
            ((afit)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(4);
            ((afit)paramViewHolder).b[i].setVisibility(0);
        ...
        for (;;)
        {
          ...
          {
            ((afit)paramViewHolder).b[i].setVisibility(4);
            if (this.jdField_b_of_type_Int > 0)
            {
              ((afit)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(0);
              ((afit)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setCheckedNumber(this.jdField_b_of_type_Int);
            }
            else
            {
              ((afit)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setChecked(false);
              ((afit)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(0);
            }
          }
          else
    ...
    {
      return;
      if ((paramViewHolder instanceof afiq))
      {
        ((afiq)paramViewHolder).jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)this.jdField_b_of_type_JavaUtilMap.get(this.d.get(Integer.valueOf(paramInt))));
        return;
      }
    } while (!(paramViewHolder instanceof afir));
    ((afir)paramViewHolder).jdField_a_of_type_AndroidWidgetTextView.setText("仅保留最新的300个聊天表情，\n更多表情请在消息记录中查找哦～");
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    default: 
      return null;
    case 0: 
      return new afiq(this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495907, paramViewGroup, false));
    case 1: 
      paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495908, paramViewGroup, false);
      ...
      paramViewGroup = new afit(paramViewGroup);
      paramViewGroup.a(this.jdField_a_of_type_Afis);
      return paramViewGroup;
    }
    return new afir(this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495911, paramViewGroup, false));
  }
}
