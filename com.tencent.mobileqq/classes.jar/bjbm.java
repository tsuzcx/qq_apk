  ...
  extends BaseAdapter
{
  ...
  public static final int c = bbll.b(10.0F);
  float jdField_a_of_type_Float;
  private Context jdField_a_of_type_AndroidContentContext;
  private ArrayList<bjbn> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  ...
  static
  {
    jdField_a_of_type_Int = bbll.b(40.0F);
    jdField_b_of_type_Int = bbll.b(5.0F);
  }
  
  public bjbm(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      localObject3 = new bjbn();
      ((bjbn)localObject3).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject1);
      ((bjbn)localObject3).jdField_a_of_type_AndroidViewView = localFrameLayout;
      ((bjbn)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject2);
      ((bjbn)localObject3).jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
  ...
  private void b(ImageView paramImageView, String paramString)
  {
    ...
    localObject1 = bbqz.a(BaseApplicationImpl.sApplication.getRuntime(), (String)localObject1 + (String)localObject2, paramString, null, new int[] { 16 }, "-Transition-", null);
  ...
  public void a()
  {
    TransitionCategoryItem localTransitionCategoryItem = bkrf.a().a();
    ...
    {
      localbjbn = (bjbn)localIterator.next();
      if (localbjbn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem == null) {
        break label116;
      }
      if (localTransitionCategoryItem == null) {
        break label111;
      }
      bool2 = TextUtils.equals(localTransitionCategoryItem.a, localbjbn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.a);
      bool1 = bool2;
      if (!bool2)
      {
        if (((localTransitionCategoryItem != null) && (!localTransitionCategoryItem.c())) || (!localbjbn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.c())) {
          break label105;
        }
        bool1 = true;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (this.jdField_b_of_type_Float = ((this.jdField_a_of_type_Float - paramViewGroup.getPaddingLeft() - paramViewGroup.getPaddingRight()) / 3.2F + 0.5F);; this.jdField_b_of_type_Float = ((this.jdField_a_of_type_Float - paramViewGroup.getPaddingLeft() - paramViewGroup.getPaddingRight()) / 4.0F + 0.5F))
    {
      ...
      if ((paramViewGroup.getTag() != null) && ((paramViewGroup.getTag() instanceof bjbn))) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    bjbn localbjbn = (bjbn)paramViewGroup.getTag();
    TextView localTextView = localbjbn.jdField_a_of_type_AndroidWidgetTextView;
    URLImageView localURLImageView = localbjbn.jdField_a_of_type_ComTencentImageURLImageView;
    ...
    localbjbn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem = localTransitionCategoryItem;
    paramView = bkrf.a().a();
    if (paramView != null) {}
    for (boolean bool1 = TextUtils.equals(paramView.a, localTransitionCategoryItem.a);; bool1 = false)
    {
      ...
      try
      {
        ...
        paramViewGroup.setContentDescription(localTransitionCategoryItem.b + ajya.a(2131715074));
        return paramViewGroup;
      }
