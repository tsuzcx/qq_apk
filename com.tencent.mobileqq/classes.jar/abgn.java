...
public class abgn
  extends ajtq
{
  public abgn(FriendProfileMoreInfoActivity paramFriendProfileMoreInfoActivity) {}
  
  protected void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    if ((paramBoolean) && ((paramObject instanceof Card)) && (bbbd.a(this.a.app.getCurrentAccountUin(), ((Card)paramObject).uin)))
    {
      FriendProfileMoreInfoActivity.a(this.a, (Card)paramObject, true);
      if (!this.a.i)
      {
        paramObject = (amdk)this.a.app.getManager(112);
  ...
  {
    if ((paramBoolean) && (paramCard != null) && (bbbd.a(this.a.app.getCurrentAccountUin(), paramCard.uin))) {
  ...
  protected void onGetQZonePhotoWall(boolean paramBoolean, String paramString1, mobile_sub_get_photo_wall_rsp parammobile_sub_get_photo_wall_rsp, String paramString2)
  {
    if ((paramBoolean) && (parammobile_sub_get_photo_wall_rsp != null))
    {
      ...
      parammobile_sub_get_photo_wall_rsp = this.a.jdField_a_of_type_Bfnk.obtainMessage(1002);
      parammobile_sub_get_photo_wall_rsp.obj = paramString1;
      this.a.jdField_a_of_type_Bfnk.sendMessage(parammobile_sub_get_photo_wall_rsp);
    }
  }
  ...
  protected void onSetDetailInfo(boolean paramBoolean, int paramInt, Card paramCard)
  {
    ...
    if (((paramBoolean) && (paramInt == 0)) || ((!paramBoolean) && (paramInt == 34)))
    {
      ...
      {
        this.a.removeObserver(this.a.jdField_a_of_type_Ajtq);
        this.a.jdField_b_of_type_Boolean = false;
      }
      if ((!this.a.jdField_a_of_type_Boolean) || (this.a.jdField_b_of_type_Bcpq == null)) {
        break label762;
      }
      if (paramBoolean)
      {
        axqw.b(this.a.app, "dc00898", "", "", "0X8007EC3", "0X8007EC3", 0, 0, "", "", "", "");
        String str;
        if (this.a.jdField_a_of_type_Abgz.jdField_b_of_type_Boolean)
        {
        ...
        if (this.a.jdField_c_of_type_Boolean) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007EC8", "0X8007EC8", 0, 0, "", "", "", "");
        }
        if (this.a.jdField_d_of_type_Boolean) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007EC9", "0X8007EC9", 0, 0, "", "", "", "");
        }
        if (this.a.e) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007ECA", "0X8007ECA", 0, 0, "", "", "", "");
        }
        if (this.a.jdField_b_of_type_Abgz.jdField_b_of_type_Boolean) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007ECB", "0X8007ECB", 0, 0, "", "", "", "");
        }
        if (this.a.jdField_c_of_type_Abgz.jdField_b_of_type_Boolean) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007ECC", "0X8007ECC", 0, 0, "", "", "", "");
        }
        if (this.a.f) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007ECD", "0X8007ECD", 0, 0, "", "", "", "");
        }
        if (this.a.g) {
          axqw.b(this.a.app, "dc00898", "", "", "0X8007ECE", "0X8007ECE", 0, 0, "", "", "", "");
        }
        if (this.a.jdField_d_of_type_Abgz.jdField_b_of_type_Boolean)
        {
    ...
    {
      if (this.a.h) {
        axqw.b(this.a.app, "dc00898", "", "", "0X8007ED0", "0X8007ED0", 0, 0, "", "", "", "");
      }
      ...
      this.a.jdField_b_of_type_Bcpq.dismiss();
      if (this.a.isFinishing()) {
        break;
      }
      this.a.finish();
      return;
      this.a.a(2131695446, 1);
      break label86;
      label692:
      axqw.b(this.a.app, "dc00898", "", "", "0X8007EC7", "0X8007EC7", 0, 0, "", "", "", "");
      break label219;
      label727:
      axqw.b(this.a.app, "dc00898", "", "", "0X8007ECF", "0X8007ECF", 0, 0, "", "", "", "");
    }
    label762:
    FriendProfileMoreInfoActivity.a(this.a, paramCard, true);
  }
  ...
  protected void onSetNick(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (!TextUtils.isEmpty(paramString)) && (this.a.jdField_a_of_type_AndroidWidgetEditText != null) && (!paramString.equals(this.a.jdField_a_of_type_AndroidWidgetEditText.getText().toString())))
    {
      ...
      this.a.jdField_a_of_type_Abgz.jdField_b_of_type_Boolean = true;
    }
  }
}
