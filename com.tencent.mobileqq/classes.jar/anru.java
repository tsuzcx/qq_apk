...
class anru
  extends ayvz
{
  anru(anrs paramanrs, Looper paramLooper, CameraEmotionData paramCameraEmotionData)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (anrs.b(this.jdField_a_of_type_Anrs) == null) {
      label19:
      return;
    }
    if ((localayqm == null) || (localayqm.c != this.jdField_a_of_type_Anrs.a()))
    {
      anrs.c(this.jdField_a_of_type_Anrs).a().b(this);
      return;
    }
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        anrs.d(this.jdField_a_of_type_Anrs).a().b(this);
        ((ajth)anrs.e(this.jdField_a_of_type_Anrs).a(160)).a(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData, true);
        ((HashMap)localObject3).put("sucFlag", "1");
        ((HashMap)localObject3).put("retCode", String.valueOf(paramMessage.what));
        axrl.a(BaseApplication.getContext()).a(null, "CamEmoRealUpload", true, 0L, 0L, (HashMap)localObject3, null);
        return;
      }
      anrs.f(this.jdField_a_of_type_Anrs).a().b(this);
      QLog.i("CameraEmoRoamingManager", 1, "upload camera emo error:" + localCommFileExtRsp.int32_retcode.get());
      ((ajth)anrs.g(this.jdField_a_of_type_Anrs).a(160)).a(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData, false);
      ((HashMap)localObject3).put("sucFlag", "0");
      ((HashMap)localObject3).put("retCode", String.valueOf(localCommFileExtRsp.int32_retcode.get()));
      axrl.a(BaseApplication.getContext()).a(null, "CamEmoRealUpload", false, 0L, 0L, (HashMap)localObject3, null);
      return;
      anrs.h(this.jdField_a_of_type_Anrs).a().b(this);
      QLog.i("CameraEmoRoamingManager", 1, "upload camera emo cancel:" + (String)localObject2);
      ((ajth)anrs.i(this.jdField_a_of_type_Anrs).a(160)).a(this.jdField_a_of_type_ComTencentMobileqqDataCameraEmotionData, false);
      ((HashMap)localObject3).put("sucFlag", "0");
      ((HashMap)localObject3).put("retCode", String.valueOf(paramMessage.what));
      axrl.a(BaseApplication.getContext()).a(null, "CamEmoRealUpload", false, 0L, 0L, (HashMap)localObject3, null);
      return;
