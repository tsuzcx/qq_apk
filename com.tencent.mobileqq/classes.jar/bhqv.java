  ...
  extends bhrq
{
  ...
  private static final String b = ajyc.a(2131712324);
  bhls jdField_a_of_type_Bhls = new bhqw(this);
  ...
  private String a(byte[] paramArrayOfByte)
  {
    ...
    //   10: getstatic 76	bhlr:b	Ljava/lang/String;
    ...
    //   37: dup
    //   38: getstatic 76	bhlr:b	Ljava/lang/String;
  ...
  private void a(bcdb parambcdb, String... paramVarArgs)
  {
    QLog.i("QZoneSharePictureJsPlugin", 1, "saxon handleGenerateGif start");
    if ((parambcdb == null) || (paramVarArgs == null) || (paramVarArgs.length < 1))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = PhotoUtils.a(bbuv.a(ajsf.bc), "IMG", ".gif");
        ...
        if (!bool1)
        {
          ...
          parambcdb = a(new File((String)localObject1));
      ...
      catch (Throwable parambcdb)
      {
        QLog.e("QZoneSharePictureJsPlugin", 1, "handleGenerateGif fail, compressGIFTask exception.", parambcdb);
        return;
      }
      boolean bool1 = false;
    }
    ...
    if (!bool3)
    {
      ...
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambcdb, parambcdb.length());
      return;
    }
    if (parambcdb.length() <= k)
    {
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 不分片callback len=" + parambcdb.length());
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambcdb, parambcdb.length());
      return;
    }
    int m = parambcdb.length() / k;
    if (parambcdb.length() % k == 0) {
      j = 0;
    }
    for (;;)
    {
      m += j;
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 分片callback pcount＝" + m + ",filelen=" + parambcdb.length());
      j = 0;
      label578:
      if (j < m - 1)
      {
        a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, j, parambcdb.substring(j * k, (j + 1) * k), parambcdb.length());
    ...
    a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, m - 1, parambcdb.substring((m - 1) * k), parambcdb.length());
    ...
    paramVarArgs = bgyf.a();
    bgxy.a(parambcdb.a(), paramVarArgs, (String)localObject1, ajyc.a(2131712337), localInterruptedException, -1);
  }
  ...
  private void a(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a() != null)) {
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getContext(), paramString, 0).a();
    }
  }
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        try
        {
          ...
          paramString2.put("msg", ajyc.a(2131712326));
  ...
  private void a(JSONObject paramJSONObject, String paramString, bcdb parambcdb)
  {
    ThreadManager.getSubThreadHandler().post(new QZoneSharePictureJsPlugin.7(this, paramJSONObject, paramString, parambcdb));
  }
  
  private void a(String... paramVarArgs)
  {
    bhni.a().a(new bhqx(this, paramVarArgs));
  }
  ...
  {
    Bitmap localBitmap1 = bdhp.a(paramString, 120, 120, false);
  ...
  private void b(bcdb parambcdb, String... paramVarArgs)
  {
    int i = 0;
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (parambcdb != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      String str;
      try
      {
        ...
        {
          QLog.w("QZoneSharePictureJsPlugin", 1, "Base64.decode Exception: " + parambcdb.toString());
          a(ajyc.a(2131712313));
          return;
        }
      ...
      {
        QLog.w("QZoneSharePictureJsPlugin", 1, "handleSharePicture catch an exception in disPatchMethod", parambcdb);
        return;
      }
      QLog.d("QZoneSharePictureJsPlugin", 1, "the filePath is " + (String)localObject);
      label206:
      if ((!TextUtils.isEmpty(str)) && (parambcdb != null) && (parambcdb.a() != null)) {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        for (;;)
        {
          ...
          i = bgxy.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, parambcdb, 21);
          aqbc.a(parambcdb.a(), localIntent, i);
          continue;
          a(paramVarArgs, (String)localObject, parambcdb);
          continue;
          if (bhlr.a().a())
          {
            bhlr.a().a(this.jdField_a_of_type_Bhls);
            parambcdb = a((String)localObject);
            bhlr.a().a((String)localObject, parambcdb, 0);
          }
          else if (parambcdb.a() != null)
          {
            parambcdb.a().post(new QZoneSharePictureJsPlugin.5(this, parambcdb));
            continue;
            if (bhlr.a().a())
            {
              bhlr.a().a(this.jdField_a_of_type_Bhls);
              bhlr.a().a((String)localObject, null, 1);
            }
            else if (parambcdb.a() != null)
            {
              parambcdb.a().post(new QZoneSharePictureJsPlugin.6(this, parambcdb));
            }
          }
        }
      }
  ...
  private void b(String paramString)
  {
    ...
    localObject2 = localObject1;
    label113:
    paramString = bhbp.b().a();
    if (TextUtils.isEmpty(paramString))
    {
      a(localObject2, -1, ajyc.a(2131712322));
      return;
    }
    try
    {
      localObject1 = new File(paramString);
      if ((!apvb.a(paramString)) && (!((File)localObject1).mkdirs()))
      {
    ...
    catch (Exception paramString)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = bhbp.b().a(paramString);
        try
        {
        ...
        long l = bbbd.a((File)localObject1);
      ...
      a(localObject2, -1, ajyc.a(2131712343));
      return;
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    a(paramString, -1, ajyc.a(2131712329));
  }
  ...
  {
    super.a();
    if (this.jdField_a_of_type_Bhls != null) {
      bhlr.a().b(this.jdField_a_of_type_Bhls);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    for (paramIntent = ajyc.a(2131712351);; paramIntent = ajyc.a(2131712317))
    {
