...
public class bhqv
{
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramContext = bhrj.a();
      if ((paramContext instanceof bhqx)) {
        ((bhqx)paramContext).b();
      }
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((localObject1 instanceof QQAppInterface)) {
          ((VasQuickUpdateManager)((AppRuntime)localObject1).getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).downloadItem(1004L, "GLDrawableV848", "gldrawable");
        }
        return;
      }
      finally {}
      Object localObject1 = new bhqw();
