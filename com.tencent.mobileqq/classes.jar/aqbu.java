  ...
  implements ArkViewImplement.InputCallback
{
  ...
  public void onFocusChanged(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838705);
      Object localObject1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838704);
  ...
  public void onSelectChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838705).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838704).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      localbhjq.a(0, anvx.a(2131700213));
      localbhjq.a(1, anvx.a(2131700208));
      localbhjq.a(2, anvx.a(2131700214));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = bhcw.a(paramView, paramInt1, paramInt2, paramInt3 + BaseApplicationImpl.getApplication().getResources().getDrawable(2130838704).getIntrinsicHeight(), localbhjq, new aqbv(this, paramInt4, (ArkViewImplement.ArkViewInterface)paramView));
      return;
      if (paramInt4 == 1)
      {
        localbhjq.a(0, anvx.a(2131700207));
        localbhjq.a(1, anvx.a(2131700209));
        localbhjq.a(2, anvx.a(2131700210));
      }
      else
      {
        localbhjq.a(0, anvx.a(2131700212));
      }
    }
  }
}
