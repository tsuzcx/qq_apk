...
public class aikm
  extends bdul
{
  public aikm(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  protected void handlePendantAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Bdrg != null) {
        this.a.jdField_a_of_type_Bdrg.c = -1;
      }
      azqs.b(this.a.app, "CliOper", "", "", "0X8005FD4", "0X8005FD4", 0, 0, "", "", "", "");
      if ((this.a.jdField_a_of_type_Akhf != null) && (this.a.jdField_a_of_type_JavaUtilList != null))
      {
        paramObject = ((AvatarPendantManager)this.a.app.getManager(46)).a();
        this.a.jdField_a_of_type_Akhf.a(paramObject, this.a.jdField_a_of_type_JavaUtilList);
      }
    } while ((this.a.jdField_a_of_type_Bdrf == null) || (!this.a.jdField_a_of_type_Bdrf.jdField_a_of_type_Boolean));
    localObject = bdtg.a("linkPendantSet");
    paramObject = localObject;
    if (localObject != null) {
      paramObject = ((String)localObject).replace("[id]", String.valueOf(this.a.jdField_a_of_type_Bdrf.jdField_a_of_type_Int));
    }
    ...
    azqs.b(this.a.app, "CliOper", "", "", "0X8006517", "0X8006517", 0, 0, "", "", "", "");
    return;
    this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131719864);
    ...
    {
      azqs.b((QQAppInterface)localObject, "CliOper", "", "", "0X8005FD6", "0X8005FD6", 0, 0, paramObject, "", "", "");
      if (!this.a.d) {
        break;
      }
      this.a.d = false;
