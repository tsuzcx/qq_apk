  ...
  implements View.OnAttachStateChangeListener, View.OnLayoutChangeListener
{
  ...
  static
  {
    if (!ztf.class.desiredAssertionStatus()) {}
  ...
  public ztf(Context paramContext, int paramInt)
  {
  ...
  protected void b()
  {
    ...
    yuk.b("InteractPasterWidget", "relayoutWidgetView view center (%.2f, %.2f) rotation(%.2f) scale(%.2f, %.2f) widgets(%d, %d)", new Object[] { Float.valueOf(f1), Float.valueOf(f2), Float.valueOf(this.jdField_b_of_type_Float), Float.valueOf(this.g), Float.valueOf(this.h), Integer.valueOf(i), Integer.valueOf(j) });
    yuk.a("InteractPasterWidget", "relayoutPollView offset(%.2f, %.2f)", Float.valueOf(this.c), Float.valueOf(this.d));
  }
  ...
  public final void onLayoutChange(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    ...
    {
      yuk.b("InteractPasterWidget", "attendWidget onLayoutChange (%d, %d, %d, %d) -> (%d, %d, %d, %d)", new Object[] { Integer.valueOf(paramInt5), Integer.valueOf(paramInt6), Integer.valueOf(paramInt7), Integer.valueOf(paramInt8), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4) });
      c();
      return;
    }
    yuk.b("InteractPasterWidget", "onLayoutChange (%d, %d, %d, %d) -> (%d, %d, %d, %d)", new Object[] { Integer.valueOf(paramInt5), Integer.valueOf(paramInt6), Integer.valueOf(paramInt7), Integer.valueOf(paramInt8), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4) });
    a();
  }
