  ...
  implements vuf
{
  ...
  public List<PromoteTaskEntry> a(String paramString, int paramInt)
  {
    ...
    {
      xvv.a("StoryPromoteTaskManager", "findPromoteTaskListByFeedIdInner(%s, %d) return null", paramString, Integer.valueOf(paramInt));
  ...
  {
    xvv.a("StoryPromoteTaskManager", "findPromoteTaskListByFeedIds(%s, %d)", paramList, Integer.valueOf(paramInt));
    a();
  ...
  public void a()
  {
    ...
    this.jdField_b_of_type_JavaLangString = ((String)((vuq)vux.a(10)).b("key_story_player_promote_url", this.jdField_b_of_type_JavaLangString));
    xvv.a("StoryPromoteTaskManager", "onInit() mUrl = %s", this.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      if ((a()) && (localObject1 != null))
      {
        ...
        xvv.a("StoryPromoteTaskManager", "onInit() update memory count from DB; %s", this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
      }
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      xvv.a("StoryPromoteTaskManager", "refreshPromoteTask, time not expire now: %s(%d), expire: %s(%d), won't request!", ypb.a(l), Long.valueOf(l), ypb.a(this.jdField_a_of_type_Long), Long.valueOf(this.jdField_a_of_type_Long));
      return;
    }
    xvv.a("StoryPromoteTaskManager", "refreshPromoteTask(clear=%b), time expire, will request new list, now: %d, expire: %d", Boolean.valueOf(paramBoolean), Long.valueOf(l), Long.valueOf(this.jdField_a_of_type_Long));
    if (paramBoolean) {
      this.jdField_a_of_type_JavaLangString = "";
    }
    wfq localwfq = new wfq(this.jdField_a_of_type_JavaLangString);
    vqn.a().a(localwfq, new vuw(this));
  }
  ...
  public boolean a()
  {
    ...
    String str = ypb.a();
    if (TextUtils.equals((String)((vuq)localObject).b("key_story_promote_task_date", ""), str))
    {
      xvv.a("StoryPromoteTaskManager", "ensureCountValidate() date is %s, keep last promoteCount", str);
      return true;
    }
    xvv.a("StoryPromoteTaskManager", "ensureCountValidate() date is %s new date, so mTaskIdCounts should be empty, taskIdCounts=%s", str, this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    ((vuq)localObject).b("key_story_promote_task_date", str);
    ...
    xvv.a("StoryPromoteTaskManager", "ensureCountValidate() exec sql: taskEntry updated sql=%s", localObject);
  ...
  {
    xvv.a("StoryPromoteTaskManager", "markTaskIdPromoted(%s)", Long.valueOf(paramLong));
  ...
  public boolean a(PromoteTaskEntry paramPromoteTaskEntry)
  {
    ...
    for (;;)
    {
      ...
      xvv.a("StoryPromoteTaskManager", "updateEntry %s, return %b", paramPromoteTaskEntry, Boolean.valueOf(bool));
      return bool;
      bool = false;
      continue;
      ...
      {
        xvv.e("StoryPromoteTaskManager", "updateEntry error: entry status unknown: %d", new Object[] { Integer.valueOf(paramPromoteTaskEntry.getStatus()) });
        bool = false;
      }
    }
  }
  ...
  public boolean a(qqstory_service.RspGetPromoteTaskList paramRspGetPromoteTaskList)
  {
    ...
    {
      Object localObject = vwd.a((qqstory_service.PromoteTask)paramRspGetPromoteTaskList.get(i));
      Long localLong = (Long)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(((vwd)localObject).jdField_a_of_type_Long));
      if (localLong != null) {}
      for (((vwd)localObject).e = localLong.longValue();; ((vwd)localObject).e = 0L)
      {
        localArrayList.remove(Long.valueOf(((vwd)localObject).jdField_a_of_type_Long));
        localObject = ((vwd)localObject).a();
        a((PromoteTaskEntry)localObject);
        xvv.a("StoryPromoteTaskManager", "overwriteEntries() [%d] taskEntry updated %s", Integer.valueOf(i), localObject);
        i += 1;
        break;
      }
    }
    ...
    {
      xvv.b("StoryPromoteTaskManager", "overwriteEntries() taskIds not empty, will delete it");
      a(localArrayList);
    }
    return true;
  }
  ...
  {
    xvv.a("StoryPromoteTaskManager", "deleteListOfTasks(%s)", paramList);
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      xvv.a("StoryPromoteTaskManager", "deleteListOfTasks() exec sql: taskEntry updated %s", paramList);
  ...
  {
    xvv.a("StoryPromoteTaskManager", "findPromoteTaskByUnionId(%s, %d)", paramString, Integer.valueOf(paramInt));
    a();
    ...
    xvv.a("StoryPromoteTaskManager", "findPromoteTaskListByUnionId(%s, %d) return null", paramString, Integer.valueOf(paramInt));
    return Collections.emptyList();
  }
  ...
  {
    xvv.a("StoryPromoteTaskManager", "markEntryPromoted(%s)", paramPromoteTaskEntry);
    if (paramPromoteTaskEntry == null)
    {
      xvv.b("StoryPromoteTaskManager", "markEntryPromoted entry is null!");
      return false;
    }
    if (paramPromoteTaskEntry.promoteCount >= paramPromoteTaskEntry.limitPromoteCount)
    {
      xvv.e("StoryPromoteTaskManager", "Error: entry.promoteCount >= entry.limitPromoteCount");
      return false;
    }
  ...
  public void c()
  {
    ((vuq)vux.a(10)).b("key_story_promote_task_date", "");
  }
}
