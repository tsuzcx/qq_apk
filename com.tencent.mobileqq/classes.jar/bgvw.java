...
public class bgvw
{
  ...
  private static bgvv a(Cursor paramCursor)
  {
    bgvv localbgvv = new bgvv();
    localbgvv.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbgvv.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbgvv.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbgvv.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbgvv.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbgvv.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbgvv.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbgvv.f = paramCursor.getString(7);
    localbgvv.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbgvv.g = paramCursor.getString(9);
    localbgvv.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbgvv.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbgvv.h = paramCursor.getString(12);
    localbgvv.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbgvv.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbgvv.i = paramCursor.getString(15);
    localbgvv.j = paramCursor.getString(16);
    localbgvv.k = paramCursor.getString(17);
    localbgvv.l = paramCursor.getString(18);
    return localbgvv;
  }
  
  /* Error */
  public static java.util.ArrayList<bgvv> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	bgvx:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	bgvw:a	(Landroid/database/Cursor;)Lbgvv;
