...
class aogn
  implements acvn
{
  aogn(aogd paramaogd, long paramLong1, long paramLong2, structmsg.ReqSystemMsgRead paramReqSystemMsgRead) {}
  
  public ToServiceMsg a()
  {
    ToServiceMsg localToServiceMsg = aogd.c(this.jdField_a_of_type_Aogd).createToServiceMsg("ProfileService.Pb.ReqSystemMsgRead");
