...
public class oxt
{
  ...
  {
    if ((!onk.a(paramListView.getContext())) || (paramListView.getChildCount() <= 0)) {}
    for (;;)
    {
      return;
      int i = 0;
  ...
  private static void e(ListView paramListView)
  {
    ...
    if (i < paramListView.getChildCount())
    {
      ...
      if (((localView instanceof oxn)) && (omu.a(localView) >= 60.0F))
      {
      ...
      if (i != -1)
      {
        ...
        for (;;)
        {
          if (j < paramListView.getChildCount())
          {
            ...
            if (((localView instanceof oxn)) && (j != i)) {
              ((oxn)localView).a();
            }
            j += 1;
            continue;
