...
public class oxt
{
  public static boolean a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = ((osl)localObject).a().b();
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    if (("2".equals(str1)) && (!TextUtils.isEmpty(str2))) {
      if (oxw.a(paramContext, paramString))
      {
  ...
  private static boolean b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (i < localList.size())
      {
        localqaq = (qaq)localList.get(i);
        j = 0;
      }
      while (j < localqaq.a.size())
      {
        if (paramInt == ((TabChannelCoverInfo)localqaq.a.get(j)).mChannelCoverId)
        {
          bool1 = true;
          return bool1;
        }
  ...
  private static boolean c(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = (qaq)((List)localObject).get(0);
        i = 0;
      }
    }
    for (;;)
    {
      bool1 = bool2;
      if (i < ((qaq)localObject).a.size())
      {
        if (paramInt == ((TabChannelCoverInfo)((qaq)localObject).a.get(i)).mChannelCoverId) {
          bool1 = true;
        }
      }
      else {
