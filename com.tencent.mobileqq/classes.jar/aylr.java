...
public class aylr
{
  ...
  public aylr(Context paramContext, QQAppInterface paramQQAppInterface, Activity paramActivity, aylu paramaylu)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Aylu = paramaylu;
  }
  ...
  private String a()
  {
    ...
    try
    {
      ...
      str = yyi.a(this.jdField_a_of_type_AndroidAppActivity, str, this.jdField_a_of_type_AndroidGraphicsBitmap);
      localObject = str;
    }
  ...
  public void a(DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    {
      ayls localayls = new ayls(this);
      paramOnDismissListener = new aylt(this, paramOnDismissListener);
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setItemClickListener(localayls);
