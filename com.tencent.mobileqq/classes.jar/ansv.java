...
public class ansv
  extends bhzs
  implements aglp, amwd, View.OnClickListener
{
  ...
  public ansv(BaseChatPie paramBaseChatPie)
  {
  ...
  public static void a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    ((ofe)paramQQAppInterface.a(88)).a(paramInt, "", "", "", "", 0L, false);
  }
  ...
  private boolean a(int paramInt, String paramString)
  {
    ...
    return bmup.a(localBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramInt, paramString);
  }
  ...
  private boolean a(String paramString)
  {
    ...
    return bmup.b(localBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramString);
  }
  ...
  private void d()
  {
    ...
    ofe localofe = (ofe)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88);
    String str = Integer.toString(oek.a(((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int));
    ...
    {
      localofe.a(134247330, "", str, (String)localObject, "", 0L, false);
      return;
    }
  }
  ...
  public void a()
  {
    ...
    oek localoek = (oek)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    ((VasExtensionHandler)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(localoek.b);
  }
  ...
  public void a(String paramString)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)View.inflate(BaseApplicationImpl.getContext(), 2131558680, null);
    ...
    do
    {
      ...
      {
        return;
        Object localObject = (ImageView)localLinearLayout.findViewById(2131369455);
        TextView localTextView = (TextView)localLinearLayout.findViewById(2131369257);
        ((ImageView)localObject).setOnClickListener(this);
        localTextView.setOnClickListener(this);
        localObject = (URLImageView)localLinearLayout.findViewById(2131369108);
  ...
  public void b()
  {
    ...
    oek localoek = (oek)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    if (QLog.isColorLevel()) {
      QLog.d("ChatApolloViewListener", 2, "currentDelay:" + localoek.c);
    }
    ...
    if (localoek.c > 0)
    {
      ((MqqHandler)localObject).postDelayed(this.jdField_a_of_type_JavaLangRunnable, localoek.c * 1000);
      return;
    }
    c();
  ...
  protected void onChangeUserApolloStatus(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        anfz.a(localBaseChatPie.a(), "cmshow_status", true);
        return;
      }
    } while (1 != ((Integer)paramObject.second).intValue());
    anfz.a(localBaseChatPie.a(), "cmshow_status", false);
    ...
    ((amst)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).e();
  }
      ...
      if ((localObject1 == null) || (((BaseChatPie)localObject1).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
        ...
        case 2131368110: 
          if (((BaseChatPie)localObject1).c == null)
          {
            ...
            ((BaseChatPie)localObject1).c = new bjbs(((BaseChatPie)localObject1).jdField_a_of_type_AndroidContentContext, i);
          }
          ((BaseChatPie)localObject1).c.a(anzj.a(2131700493));
          ((BaseChatPie)localObject1).c.show();
          c();
          Object localObject2 = (oek)((BaseChatPie)localObject1).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
          ...
          {
            ((VasExtensionHandler)localObject3).a(((oek)localObject2).b, ((BaseChatPie)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, ((BaseChatPie)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b);
            localObject2 = (ofe)((BaseChatPie)localObject1).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88);
            localObject3 = Integer.toString(oek.a(((BaseChatPie)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int));
            ...
            {
              ((ofe)localObject2).a(134247331, "", (String)localObject3, (String)localObject1, Integer.toString(oek.b()), 0L, false);
              break;
            }
          }
          break;
    ...
    do
    {
      ...
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    QQToast.a(BaseApplicationImpl.getContext(), anzj.a(2131700495), 1).a();
                    return;
                  }
          ...
          QQToast.a(BaseApplicationImpl.getContext(), anzj.a(2131700494), 1).a();
          return;
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (!bgpj.b(paramString))) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localBaseChatPie = (BaseChatPie)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        } while ((localBaseChatPie == null) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (localBaseChatPie.jdField_a_of_type_Amuy == null) || (!localBaseChatPie.jdField_a_of_type_Amuy.a()) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null));
        if (!bhnv.g(localBaseChatPie.jdField_a_of_type_AndroidContentContext))
        {
          ApolloItemBuilder.a(localBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131690009), 1, localBaseChatPie.jdField_a_of_type_AndroidContentContext);
          return;
        }
        localObject = angi.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (localObject == null) {
          break;
        }
        localObject = ((angf)localObject).a();
      } while ((localObject != null) && (((angg)localObject).a()));
      localObject = (amsx)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
      ...
      if (((amsx)localObject).b(paramString) != 1)
      {
        ApolloItemBuilder.a(localBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131690048), 1, localBaseChatPie.jdField_a_of_type_AndroidContentContext);
        return;
      }
    } while (amsx.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString) == 2);
    if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject = bhlg.m(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      localBaseChatPie.jdField_a_of_type_Amuy.b();
      ...
      if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) {
        localObject = bhlg.e(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString);
      } else if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) {
        localObject = bhlg.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
      } else {
        localObject = "";
      }
    }
  ...
  public void onNotifyStatusChanged(int paramInt, String paramString)
  {
    ...
    case 11: 
      while (bool1)
      {
        ...
        return;
        bool1 = bool2;
        if (((amsx)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(str))
        {
          bool1 = a(str);
          continue;
          ApolloBaseInfo localApolloBaseInfo = ((amsx)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(str);
          bool1 = bool2;
          if (localApolloBaseInfo != null)
          {
            localamxm = localApolloBaseInfo.getApolloPetDress();
            if ((localamxm == null) || (!localApolloBaseInfo.hasPet) || (localamxm.jdField_a_of_type_JavaUtilHashMap == null) || (localamxm.jdField_a_of_type_JavaUtilHashMap.isEmpty())) {
              break label696;
            }
          }
        }
    ...
    label696:
    for (bool1 = a(localamxm.jdField_a_of_type_Int, paramString);; bool1 = false)
    {
      break label136;
      paramString = (amst)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211);
      ...
      bool1 = bool2;
      if (paramString.jdField_a_of_type_Anlm == null) {
        break label136;
      }
      paramString = paramString.jdField_a_of_type_Anlm.a();
      bool1 = bool2;
      if (paramString == null) {
        break label136;
      }
      ...
      amsx.a(102, String.valueOf(paramString.tianshuAdId), paramString.tianshuTraceInfo);
      bool1 = bool2;
      break label136;
      paramString = angi.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (paramString != null) {
        paramString.a(angi.a(paramInt), null, str);
      }
      paramString = (angf)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
      if (paramString == null) {
        break;
      }
  ...
  protected void onQueryUserApolloAction(boolean paramBoolean, Object paramObject)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      amsx.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel()) {
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    angf localangf = (angf)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    if (localangf.a() != null) {
      anmq.a(angi.b(localangf.a().e), 100, 0, new Object[] { "onSurfaceReady" });
    }
    if (!localBaseChatPie.jdField_a_of_type_Amuy.jdField_a_of_type_Boolean)
    {
      anpx.a("TraceReport_initApolloSurfaceView_PreLoadJS");
