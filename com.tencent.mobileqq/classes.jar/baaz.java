  ...
  implements TextWatcher
{
  ...
  public baaz(StickyNotePublishFragment paramStickyNotePublishFragment) {}
  
  public void afterTextChanged(Editable paramEditable)
  {
    if ((this.jdField_a_of_type_JavaLangCharSequence != null) && (behh.a(String.valueOf(this.jdField_a_of_type_JavaLangCharSequence), 3) > 300))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqProfileStickynotePublishUiStickyNotePublishFragment.getActivity(), 1, 2131690196, 0).a();
      paramEditable.delete(this.jdField_a_of_type_Int, this.b);
    }
    paramEditable = baah.a(StickyNotePublishFragment.a(this.jdField_a_of_type_ComTencentMobileqqProfileStickynotePublishUiStickyNotePublishFragment));
