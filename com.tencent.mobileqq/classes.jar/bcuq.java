...
public abstract class bcuq
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler a;
  private static String a;
  public static final DownloadParams.DecodeHandler b = new bcvc();
  public static final DownloadParams.DecodeHandler c = new bcvh();
  public static final DownloadParams.DecodeHandler d = new bcvi();
  public static final DownloadParams.DecodeHandler e = new bcvj();
  public static final DownloadParams.DecodeHandler f = new bcvk();
  public static final DownloadParams.DecodeHandler g = new bcvl();
  public static final DownloadParams.DecodeHandler h = new bcvm();
  public static final DownloadParams.DecodeHandler i = new bcvn();
  public static final DownloadParams.DecodeHandler j = new bcus();
  public static final DownloadParams.DecodeHandler k = new bcut();
  public static final DownloadParams.DecodeHandler l = new bcuu();
  public static final DownloadParams.DecodeHandler m = new bcuv();
  public static final DownloadParams.DecodeHandler n = new bcuw();
  public static final DownloadParams.DecodeHandler o = new bcux();
  public static final DownloadParams.DecodeHandler p = new bcuy();
  public static final DownloadParams.DecodeHandler q = new bcuz();
  public static final DownloadParams.DecodeHandler r = new bcva();
  public static final DownloadParams.DecodeHandler s = new bcvo(10);
  public static final DownloadParams.DecodeHandler t = new bcvo(20);
  public static final DownloadParams.DecodeHandler u = new bcvb();
  public static final DownloadParams.DecodeHandler v = new bcvd();
  public static final DownloadParams.DecodeHandler w = new bcvp();
  public static final DownloadParams.DecodeHandler x = new bcve();
  public static final DownloadParams.DecodeHandler y = new bcvf();
  public static final DownloadParams.DecodeHandler z = new bcvg();
  
  static
  {
    jdField_a_of_type_JavaLangString = "URLDrawableDecodeHandler";
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new bcur();
  }
