...
public class aoyh
  implements aoyi
{
  aoyf jdField_a_of_type_Aoyf;
  aoyg jdField_a_of_type_Aoyg;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  aoyh(QQAppInterface paramQQAppInterface, aoyg paramaoyg)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aoyg = paramaoyg;
    this.jdField_a_of_type_Aoyf = this.jdField_a_of_type_Aoyg.jdField_a_of_type_Aoyf;
  }
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Aoyg.a(localArrayList))
    {
