...
final class beac
{
  ...
  public beac(File paramFile, bead parambead)
  {
    this.jdField_a_of_type_JavaIoFile = paramFile;
    this.jdField_a_of_type_Bead = parambead;
  }
  
  private Pair<String, beaw> a(XmlPullParser paramXmlPullParser)
  {
    try
    {
      ...
      localbeaw.jdField_a_of_type_Int = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "AttrType"));
      localbeaw.b = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "Category"));
      localbeaw.c = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "SubCategory"));
      localbeaw.d = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "Action"));
      localbeaw.jdField_a_of_type_Long = Long.parseLong(paramXmlPullParser.getAttributeValue(null, "ExpireTime"));
      paramXmlPullParser = paramXmlPullParser.getAttributeValue(null, "ExtraInfo");
      if (!TextUtils.isEmpty(paramXmlPullParser)) {
        localbeaw.jdField_a_of_type_ArrayOfByte = Base64.decode(paramXmlPullParser, 0);
      }
      paramXmlPullParser = new Pair(str, localbeaw);
  ...
  public void a()
  {
    ...
    //   54: dup
    //   55: aload_0
    //   56: getfield 14	beac:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   159: aload_0
    //   160: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   163: ifnull +10 -> 173
    //   166: aload_0
    //   167: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   170: invokevirtual 182	bead:a	()V
    //   173: return
    //   174: iconst_1
    //   175: istore_1
    //   176: iload_1
    ...
    //   213: aload_0
    //   214: aload 8
    //   216: invokespecial 189	beac:a	(Lorg/xmlpull/v1/XmlPullParser;)Lcom/tencent/util/Pair;
    //   219: astore 5
    //   221: goto -45 -> 176
    //   224: aload 5
    //   226: astore 6
    ...
    //   264: ifnull -82 -> 182
    //   267: aload_0
    //   268: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   271: ifnull +33 -> 304
    //   274: aload_0
    //   275: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   278: aload 5
    ...
    //   291: checkcast 36	beaw
    //   294: invokevirtual 199	bead:a	(Ljava/lang/String;Lbeaw;)Z
    //   297: istore 4
    //   299: iload 4
    //   301: ifeq -152 -> 149
    //   304: aconst_null
    ...
    //   342: aload_0
    //   343: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   346: ifnull -173 -> 173
    //   349: aload_0
    //   350: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   353: invokevirtual 182	bead:a	()V
    //   356: return
    //   357: astore 5
    //   359: aload 5
    ...
    //   382: aload_0
    //   383: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   386: ifnull +10 -> 396
    //   389: aload_0
    //   390: getfield 16	beac:jdField_a_of_type_Bead	Lbead;
    //   393: invokevirtual 182	bead:a	()V
    //   396: aload 5
    //   398: athrow
    //   399: astore 6
    //   401: aload 6
