...
public class asfu
  implements asgl, Manager
{
  public static ashx a;
  ...
  private aniz jdField_a_of_type_Aniz = new asfv(this);
  private asgd jdField_a_of_type_Asgd;
  private asgf jdField_a_of_type_Asgf = new asfy(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131703059);
  }
  
  public asfu(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Asgg = new asgg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Asgg.a(this);
    this.jdField_a_of_type_Asjw = new asjw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2);
    this.jdField_b_of_type_Asjw = new asjw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
  ...
  private static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null) {
      i = bgsg.a(paramQQAppInterface.getCurrentAccountUin(), "extend_friend_config_785").getInt("sp_extend_friend_forbid_flag", 0);
    }
    return i;
  }
  ...
  private static long a(QQAppInterface paramQQAppInterface)
  {
    long l = 0L;
    if (paramQQAppInterface != null) {
      l = bgsg.a(paramQQAppInterface.getCurrentAccountUin(), "extend_friend_config_785").getLong("sp_extend_friend_forbid_end_time", 0L);
    }
    return l;
  }
  ...
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder(paramBaseActivity.getString(2131697918));
    if (paramBoolean) {
    ...
    int i = bgtn.a(20.0F);
    Drawable localDrawable = paramBaseActivity.getResources().getDrawable(2130841366);
    ...
    localSpannableStringBuilder.append(" ");
    paramBaseActivity = paramBaseActivity.getString(2131697919);
  ...
  private asgd a(String paramString)
  {
    int j = 0;
    asgd localasgd = new asgd();
    for (;;)
    {
      int i;
      try
      {
        ...
        localasgd.jdField_a_of_type_JavaLangString = paramString.optString("contactEntranceTitle");
        localasgd.jdField_b_of_type_JavaLangString = paramString.optString("contactEntranceLine1");
        localasgd.jdField_c_of_type_JavaLangString = paramString.optString("contactEntranceLine2");
        localasgd.jdField_d_of_type_JavaLangString = paramString.optString("addEntranceTitle");
        localasgd.jdField_e_of_type_JavaLangString = paramString.optString("addEntranceLine1");
        localasgd.jdField_a_of_type_Int = paramString.optInt("maxPlayers");
        localasgd.jdField_b_of_type_Int = paramString.optInt("minPlayers");
        localasgd.jdField_c_of_type_Int = paramString.optInt("voiceMaxLength");
        localasgd.jdField_d_of_type_Int = paramString.optInt("maxSlipTimes");
        localasgd.jdField_e_of_type_Int = paramString.optInt("redisplayInterval");
        localasgd.jdField_f_of_type_JavaLangString = paramString.optString("defaultDecleration");
        localasgd.jdField_f_of_type_Int = paramString.optInt("declerationMinLen");
        localasgd.jdField_g_of_type_Int = paramString.optInt("isExpandEntranceOnTop");
        localasgd.jdField_g_of_type_JavaLangString = paramString.optString("resourceURL");
        localasgd.jdField_h_of_type_JavaLangString = paramString.optString("resourceMD5");
        localasgd.jdField_h_of_type_Int = paramString.optInt("isShowGroup");
        localasgd.jdField_j_of_type_JavaLangString = paramString.optString("ExpandExamImg");
        localasgd.jdField_m_of_type_Int = paramString.optInt("exposureTimeLimit", 2);
        localasgd.jdField_a_of_type_Boolean = paramString.optBoolean("showVipIcon", false);
        localasgd.n = paramString.optInt("GrayTipsMsgCount", 50);
        localasgd.jdField_k_of_type_JavaLangString = paramString.optString("GrayTipsMsg");
        localasgd.jdField_l_of_type_JavaLangString = paramString.optString("GrayTipsMsgLight");
        localasgd.o = paramString.optInt("IceBreakSwitch", 1);
        localasgd.jdField_m_of_type_JavaLangString = paramString.optString("BeatWarning");
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendManager", 2, "parseConfig config.exposureTimeLimit:" + localasgd.jdField_m_of_type_Int);
        }
        localasgd.jdField_a_of_type_JavaUtilList.clear();
        ...
        if (localJSONArray != null)
        {
          ...
          {
            localasgd.jdField_a_of_type_JavaUtilList.add(localJSONArray.optString(i));
            i += 1;
            continue;
          }
        }
        localasgd.jdField_b_of_type_JavaUtilList.clear();
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            localasgd.jdField_b_of_type_JavaUtilList.add(localJSONArray.optString(i));
            i += 1;
            continue;
          }
        }
        localasgd.jdField_i_of_type_JavaLangString = paramString.optString("searchHint");
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            asge localasge = new asge(this);
            localasge.jdField_a_of_type_JavaLangString = localJSONObject.optString("name");
            if ("aioVideo".equals(localasge.jdField_a_of_type_JavaLangString))
            {
              localasge.jdField_b_of_type_JavaLangString = localJSONObject.optString("resourceURLAndroid");
              localasge.jdField_c_of_type_JavaLangString = localJSONObject.optString("resourceMD5Android");
              if (QLog.isColorLevel()) {
                QLog.d("ExtendFriendManager", 2, String.format("aiovideo use android url:%s", new Object[] { localasge.jdField_b_of_type_JavaLangString }));
              }
              if (!localasge.a()) {
                break label733;
              }
              localasgd.jdField_a_of_type_JavaUtilHashMap.put(localasge.jdField_a_of_type_JavaLangString, localasge);
              break label733;
            }
            localasge.jdField_b_of_type_JavaLangString = localJSONObject.optString("resourceURL");
            localasge.jdField_c_of_type_JavaLangString = localJSONObject.optString("resourceMD5");
            continue;
          }
        }
        localasgd.jdField_i_of_type_Int = paramString.optInt("ExpandMatchSwitch");
      }
      ...
      localasgd.jdField_j_of_type_Int = paramString.optInt("isNuanSSFirst");
      localasgd.jdField_k_of_type_Int = paramString.optInt("isVoiceMatchOpen");
      localasgd.jdField_l_of_type_Int = paramString.optInt("isSignalOpen");
      return localasgd;
      label733:
      i += 1;
    }
  ...
  private static ArrayList<String> a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if (paramLong > 86400L)
    {
      ...
      localArrayList.add(paramQQAppInterface.getApp().getString(2131691292));
      return localArrayList;
    }
    if (paramLong > 3600L)
    {
      localArrayList.add(String.valueOf((paramLong + 3600L - 1L) / 3600L));
      localArrayList.add(paramQQAppInterface.getApp().getString(2131692933));
      return localArrayList;
    }
    if (paramLong > 60L)
    {
      localArrayList.add(String.valueOf((paramLong + 60L - 1L) / 60L));
      localArrayList.add(paramQQAppInterface.getApp().getString(2131693716));
      return localArrayList;
    }
    if (paramLong > 0L)
    {
      localArrayList.add(String.valueOf(paramLong));
      localArrayList.add(paramQQAppInterface.getApp().getString(2131717659));
      return localArrayList;
    }
  ...
  private void a(Context paramContext, asmh paramasmh)
  {
    if (paramasmh == null) {
      return;
    }
    ...
    if ((!bgnt.d(paramContext)) || (!aslj.a()))
    {
      a(false, null, paramasmh);
      return;
    }
    ...
    if (l - this.jdField_d_of_type_Long < 3600000L)
    {
      ...
      paramContext = aoor.a("extend_friend");
      if ((paramContext != null) && (paramContext.a != null))
      {
        a(true, paramContext, paramasmh);
        return;
      }
    }
    this.jdField_d_of_type_Long = l;
    aoor.a(new asgb(this, "extend_friend", false, paramasmh));
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    if (paramQQAppInterface != null)
    {
      paramQQAppInterface = bgsg.a(paramQQAppInterface.getCurrentAccountUin(), "extend_friend_config_785").edit();
  ...
  public static void a(String paramString, boolean paramBoolean)
  {
    ...
    bgsg.g(paramString).edit().putBoolean("sp_extend_friend_question", paramBoolean).apply();
  }
  ...
  private void a(oidb_0xdb1.SchoolInfo paramSchoolInfo)
  {
    ...
    {
      this.jdField_a_of_type_Azfw = new azfw();
      Object localObject = this.jdField_a_of_type_Azfw;
      int i;
      if (paramSchoolInfo.uint32_idx.has())
      {
        i = paramSchoolInfo.uint32_idx.get();
        ((azfw)localObject).jdField_a_of_type_Int = i;
        localObject = this.jdField_a_of_type_Azfw;
        i = j;
        if (paramSchoolInfo.uint32_category.has()) {
          i = paramSchoolInfo.uint32_category.get();
        }
        ((azfw)localObject).jdField_b_of_type_Int = i;
        azfw localazfw = this.jdField_a_of_type_Azfw;
        if (!paramSchoolInfo.str_school_id.has()) {
          break label147;
        }
        localObject = paramSchoolInfo.str_school_id.get();
        label104:
        localazfw.jdField_a_of_type_JavaLangString = ((String)localObject);
        localObject = this.jdField_a_of_type_Azfw;
      ...
      {
        ((azfw)localObject).jdField_b_of_type_JavaLangString = paramSchoolInfo;
        return;
        i = 0;
        break;
        localObject = "";
    ...
    this.jdField_a_of_type_Azfw = null;
  }
  
  private void a(boolean paramBoolean, SosoInterface.SosoLbsInfo paramSosoLbsInfo, asmh paramasmh)
  {
    paramasmh.a(paramBoolean, asgr.a(paramSosoLbsInfo));
  }
  ...
  public static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bgpa localbgpa = bglp.a(paramBaseActivity, 230);
      SpannableStringBuilder localSpannableStringBuilder = a(paramBaseActivity, paramQQAppInterface, bool, l);
      localbgpa.setTitle(paramBaseActivity.getString(2131697920)).setMessage(localSpannableStringBuilder).setPositiveButton(paramBaseActivity.getString(2131697917), new asfx(paramBaseActivity)).setOnKeyListener(new asfw(paramBaseActivity));
      localbgpa.show();
      bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800B076", "0X800B076", (int)(l / 86400L), 0, "", "", "", "");
      return true;
    }
  ...
  {
    boolean bool = bgsg.g(paramString).getBoolean("sp_extend_friend_question", true);
    if (QLog.isColorLevel()) {
  ...
  {
    ((asfs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).notifyUI(5, true, Boolean.valueOf(paramBoolean));
  }
  
  private void e(boolean paramBoolean)
  {
    bgsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "extend_friend_config_785").edit().putBoolean("sp_extend_friend_is_user_student", paramBoolean).commit();
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      this.jdField_d_of_type_Boolean = bgsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "extend_friend_config_785").getBoolean("sp_extend_friend_is_user_student", false);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendManager", 2, String.format("checkToDownloadResource mConfig=%s mDownloader=%s", new Object[] { this.jdField_a_of_type_Asgd, this.jdField_a_of_type_Asgg }));
    }
    if ((this.jdField_a_of_type_Asgd != null) && (this.jdField_a_of_type_Asgg != null)) {
      try
      {
        this.jdField_a_of_type_Asgg.a(this.jdField_a_of_type_Asgd.jdField_g_of_type_JavaLangString, this.jdField_a_of_type_Asgd.jdField_h_of_type_JavaLangString);
        if (!this.jdField_a_of_type_Asgg.a())
        {
  ...
  private void k()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Asgd == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Asgd.jdField_j_of_type_JavaLangString))) {
        break label152;
      }
      i = bhhh.a(new bhhf(this.jdField_a_of_type_Asgd.jdField_j_of_type_JavaLangString, localFile), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (i != 0) {
        break;
      }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      try
      {
        Card localCard = ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
        if (localCard != null)
        {
          ...
          if (jdField_a_of_type_Ashx != null)
          {
            jdField_a_of_type_Ashx.jdField_a_of_type_Boolean = bool1;
            jdField_a_of_type_Ashx.jdField_b_of_type_Boolean = bool2;
          }
        }
      }
      catch (Exception localException)
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ExtendFriendManager", 2, String.format("updateSwitchInCacheData %s", new Object[] { jdField_a_of_type_Ashx }));
      }
      return;
      bool1 = false;
    }
  ...
  private void n()
  {
    ...
    if (l1 > 0L)
    {
      ...
      {
        long l2 = bbyp.a();
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AE99", "0X800AE99", 0, 0, String.valueOf(l2 - l1), "", "", "");
  ...
  public asgd a()
  {
    return this.jdField_a_of_type_Asgd;
  }
  
  public asgr a()
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = aoor.a("extend_friend");
    asgr localasgr = null;
    if (localSosoLbsInfo != null) {
      localasgr = asgr.a(localSosoLbsInfo);
    }
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendManager", 2, "getExtendFriendLocationInfoSync " + localasgr);
    }
    long l = System.currentTimeMillis();
    if ((bgnt.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext())) && (aslj.a()) && (l - this.jdField_d_of_type_Long > 3600000L))
    {
      if (QLog.isColorLevel()) {
  ...
  public asgs a()
  {
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      {
        asgs localasgs2 = (asgs)localIterator.next();
        if (l - localasgs2.jdField_a_of_type_Long > 86400L)
        {
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendManager", 2, "checkAndGetLatestSignalBombCardData remove timeout data " + localasgs2.jdField_a_of_type_JavaLangString);
          }
    ...
    {
      asgs localasgs1 = (asgs)this.jdField_b_of_type_JavaUtilList.remove(0);
      return localasgs1;
    }
    label163:
    return null;
  ...
  public asjw a()
  {
    return this.jdField_a_of_type_Asjw;
  }
  
  public azfw a()
  {
    return this.jdField_a_of_type_Azfw;
  }
  ...
  public List<String> a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      String[] arrayOfString = bcbv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    asme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramInt2);
  }
  ...
  public void a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Azfw.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_Azfw.jdField_b_of_type_JavaLangString = paramString1;
    this.jdField_a_of_type_Azfw.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_Azfw.jdField_b_of_type_Int = paramInt2;
  }
  ...
  public void a(asgs paramasgs)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendManager", 2, "addExtendFriendSignalBombCardData " + paramasgs);
    }
    if (paramasgs != null) {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        this.jdField_b_of_type_JavaUtilList.add(0, paramasgs);
        return;
      }
    }
  }
  ...
  public void a(ashh paramashh)
  {
    ...
    if (paramashh != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramashh.jdField_b_of_type_JavaLangString, paramashh.jdField_a_of_type_JavaLangString, paramashh.jdField_a_of_type_ArrayOfByte);
      if (k())
      {
        a(asgs.a(paramashh));
        if (paramashh.jdField_a_of_type_Asgn != null)
        {
          ...
          str = paramashh.jdField_b_of_type_JavaLangString;
          i = paramashh.jdField_a_of_type_Asgn.jdField_d_of_type_Int;
          if (!this.jdField_d_of_type_Boolean) {
            break label264;
          }
          localObject1 = "1";
          bcst.b((QQAppInterface)localObject2, "dc00898", "", str, "0X800AE9A", "0X800AE9A", i, 0, "", (String)localObject1, paramashh.jdField_a_of_type_Asgn.jdField_j_of_type_JavaLangString, paramashh.jdField_a_of_type_Asgn.jdField_k_of_type_JavaLangString);
        }
        n();
      }
      avsr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramashh.jdField_b_of_type_JavaLangString);
      avsr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramashh.jdField_b_of_type_JavaLangString, 1044);
      if (((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramashh.jdField_b_of_type_JavaLangString)) {
        break label272;
      }
      avsr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramashh, paramashh.jdField_a_of_type_Long, 1);
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject2 = paramashh.jdField_b_of_type_JavaLangString;
      j = paramashh.jdField_b_of_type_Int;
      str = paramashh.jdField_f_of_type_JavaLangString;
      if (TextUtils.isEmpty(paramashh.jdField_c_of_type_JavaLangString)) {
        break label285;
      }
      bool = true;
      label220:
    ...
    label285:
    label291:
    for (int i = paramashh.jdField_a_of_type_Asgn.jdField_c_of_type_Int;; i = -1)
    {
      avsr.a((QQAppInterface)localObject1, (String)localObject2, j, str, bool, i, true, 4);
      bglf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramashh.jdField_b_of_type_JavaLangString, true);
      return;
      localObject1 = "2";
      break;
  ...
  public void a(String arg1)
  {
    ...
    {
      this.jdField_a_of_type_Asgd = localasgd;
      this.jdField_b_of_type_Boolean = true;
      boolean bool = aslb.a(this.jdField_a_of_type_Asgd);
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    ((asfs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).a(paramString1, paramString2, paramInt);
  }
  ...
  public void a(oidb_0xdb1.RspBody paramRspBody)
  {
    ...
    for (paramRspBody = (oidb_0xdb1.matchTaskInfo)paramRspBody.msg_task_info.get();; paramRspBody = null)
    {
      ...
      if (paramRspBody != null)
      {
        ...
        {
          localaskj = new askj();
          localaskj.jdField_a_of_type_Int = 1;
          localaskj.jdField_b_of_type_Int = paramRspBody.msg_base_info.uint32_task_match_times.get();
          localaskj.jdField_a_of_type_JavaLangString = paramRspBody.msg_base_info.str_msg.get();
          localaskj.jdField_c_of_type_Int = paramRspBody.msg_base_info.uint32_task_status.get();
          localArrayList.add(localaskj);
        }
        if (paramRspBody.msg_kuolie_school.has())
        {
          localaskj = new askj();
          localaskj.jdField_a_of_type_Int = 2;
          localaskj.jdField_b_of_type_Int = paramRspBody.msg_kuolie_school.uint32_task_match_times.get();
          localaskj.jdField_a_of_type_JavaLangString = paramRspBody.msg_kuolie_school.str_msg.get();
          localaskj.jdField_c_of_type_Int = paramRspBody.msg_kuolie_school.uint32_task_status.get();
          localArrayList.add(localaskj);
        }
        if (paramRspBody.msg_kuolie_declaration.has())
        {
          localaskj = new askj();
          localaskj.jdField_a_of_type_Int = 3;
          localaskj.jdField_b_of_type_Int = paramRspBody.msg_kuolie_declaration.uint32_task_match_times.get();
          localaskj.jdField_a_of_type_JavaLangString = paramRspBody.msg_kuolie_declaration.str_msg.get();
          localaskj.jdField_c_of_type_Int = paramRspBody.msg_kuolie_declaration.uint32_task_status.get();
          localArrayList.add(localaskj);
        }
        if (paramRspBody.msg_personal_label.has())
        {
          localaskj = new askj();
          localaskj.jdField_a_of_type_Int = 4;
          localaskj.jdField_b_of_type_Int = paramRspBody.msg_personal_label.uint32_task_match_times.get();
          localaskj.jdField_a_of_type_JavaLangString = paramRspBody.msg_personal_label.str_msg.get();
          localaskj.jdField_c_of_type_Int = paramRspBody.msg_personal_label.uint32_task_status.get();
          localArrayList.add(localaskj);
        }
        if (paramRspBody.msg_photo.has())
        {
          localaskj = new askj();
          localaskj.jdField_a_of_type_Int = 5;
          localaskj.jdField_b_of_type_Int = paramRspBody.msg_photo.uint32_task_match_times.get();
          localaskj.jdField_a_of_type_JavaLangString = paramRspBody.msg_photo.str_msg.get();
          localaskj.jdField_c_of_type_Int = paramRspBody.msg_photo.uint32_task_status.get();
          localArrayList.add(localaskj);
        }
      }
  ...
  public boolean a(asgd paramasgd)
  {
    boolean bool = true;
    if ((paramasgd == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return false;
    }
    for (;;)
    {
      try
      {
        paramasgd = bgsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "extend_friend_config_785");
        int i = paramasgd.getInt("sp_extend_friend_entry_contact", 0);
        int j = paramasgd.getInt("sp_extend_friend_entry_add_friend", 0);
        if ((i != 1) || (j != 1)) {
          break label88;
        }
        return bool;
      }
      catch (Exception paramasgd)
      {
        paramasgd.printStackTrace();
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ExtendFriendManager", 2, paramasgd.getMessage());
      return false;
      label88:
      bool = false;
    }
  ...
  public int b()
  {
    ...
    if (localIterator.hasNext())
    {
      if (((askj)localIterator.next()).jdField_c_of_type_Int == 2) {
        break label79;
      }
      i += 1;
    }
  ...
  public asjw b()
  {
    return this.jdField_b_of_type_Asjw;
  }
  ...
  public String b()
  {
    ...
    if (b())
    {
      ...
      if (localasgd != null) {
        localObject1 = localasgd.jdField_i_of_type_JavaLangString;
      }
    }
    localObject2 = localObject1;
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = anni.a(2131703056);
    }
    return localObject2;
  }
  ...
  public void b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 672	asfu:jdField_b_of_type_Boolean	Z
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: aload_0
    //   9: getfield 93	asfu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   12: invokevirtual 519	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   15: aload_0
    //   16: getfield 93	asfu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   19: invokevirtual 145	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   22: ldc 147
    //   24: invokestatic 1470	bgld:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   27: astore_1
    //   28: aload_1
    //   29: invokestatic 814	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   32: ifne +76 -> 108
    //   35: aload_0
    //   36: aload_1
    //   37: invokespecial 1310	asfu:a	(Ljava/lang/String;)Lasgd;
    //   40: astore_2
    //   41: getstatic 51	asfu:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   44: astore_1
    //   45: aload_1
    //   46: monitorenter
    //   47: aload_0
    //   48: getfield 672	asfu:jdField_b_of_type_Boolean	Z
    //   51: ifne +13 -> 64
    //   54: aload_0
    //   55: aload_2
    //   56: putfield 280	asfu:jdField_a_of_type_Asgd	Lasgd;
    //   59: aload_0
    //   60: iconst_1
    //   61: putfield 672	asfu:jdField_b_of_type_Boolean	Z
    //   64: aload_1
    //   65: monitorexit
    //   66: invokestatic 409	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   69: ifeq -62 -> 7
    //   72: ldc_w 411
    //   75: iconst_2
    //   76: ldc_w 1472
    //   79: invokestatic 767	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   82: return
    //   83: astore_1
    //   84: invokestatic 409	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   87: ifeq -80 -> 7
    //   90: ldc_w 411
    //   93: iconst_2
    //   94: aload_1
    //   95: invokevirtual 1456	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   98: aload_1
    //   99: invokestatic 1474	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   102: return
    //   103: astore_2
    //   104: aload_1
    //   105: monitorexit
    //   106: aload_2
    //   107: athrow
    //   108: getstatic 51	asfu:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   111: astore_1
    //   112: aload_1
    //   113: monitorenter
    //   114: aload_0
    //   115: getfield 672	asfu:jdField_b_of_type_Boolean	Z
    //   118: ifne +8 -> 126
    //   121: aload_0
    //   122: iconst_1
    //   123: putfield 672	asfu:jdField_b_of_type_Boolean	Z
    //   126: aload_1
    //   127: monitorexit
    //   128: ldc_w 411
    //   131: iconst_2
    //   132: ldc_w 1476
    //   135: invokestatic 792	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   138: goto -72 -> 66
    //   141: astore_2
    //   142: aload_1
    //   143: monitorexit
  ...
  public int c()
  {
    if (this.jdField_a_of_type_Int == 0) {
      if ((this.jdField_a_of_type_Asgd == null) || (this.jdField_a_of_type_Asgd.jdField_a_of_type_Int <= 0)) {
        break label66;
      }
    }
    label66:
    for (this.jdField_a_of_type_Int = (this.jdField_a_of_type_Asgd.jdField_b_of_type_Int + new Random().nextInt(this.jdField_a_of_type_Asgd.jdField_a_of_type_Int - this.jdField_a_of_type_Asgd.jdField_b_of_type_Int));; this.jdField_a_of_type_Int = new Random().nextInt(10000000)) {
  ...
  public String c()
  {
    ...
    if (b())
    {
      str1 = str2;
      if (this.jdField_a_of_type_Asgd != null) {
        str1 = this.jdField_a_of_type_Asgd.jdField_k_of_type_JavaLangString;
      }
    }
    return str1;
  }
  ...
  public void c()
  {
    ...
    ((asfs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).notifyUI(18, true, null);
  }
  ...
  public int d()
  {
    ...
    if (b())
    {
      i = j;
      if (this.jdField_a_of_type_Asgd != null) {
        i = this.jdField_a_of_type_Asgd.n;
      }
    }
    return i;
  }
  ...
  public String d()
  {
    ...
    if (b())
    {
      str1 = str2;
      if (this.jdField_a_of_type_Asgd != null) {
        str1 = this.jdField_a_of_type_Asgd.jdField_l_of_type_JavaLangString;
      }
    }
    return str1;
  }
  ...
  public String e()
  {
    ...
    if (b())
    {
      str1 = str2;
      if (this.jdField_a_of_type_Asgd != null) {
        str1 = this.jdField_a_of_type_Asgd.jdField_m_of_type_JavaLangString;
      }
    }
    return str1;
  }
  ...
  {
    f(true);
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), new asfz(this));
    m();
  }
  
  public boolean e()
  {
    if ((b()) && (this.jdField_a_of_type_Asgd != null)) {}
    for (int i = this.jdField_a_of_type_Asgd.o;; i = 1) {
      return i == 1;
    }
  }
  ...
  {
    boolean bool2 = false;
    boolean bool3 = asme.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    boolean bool1 = bool2;
    if (bool3) {
  ...
  {
    if (this.jdField_a_of_type_Azfw != null) {
      return this.jdField_a_of_type_Azfw.jdField_b_of_type_JavaLangString;
    }
    return "";
  }
  ...
  public void g()
  {
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), new asga(this));
  }
  
  public boolean g()
  {
    if (this.jdField_a_of_type_Asgd == null) {}
    while (this.jdField_a_of_type_Asgd.jdField_i_of_type_Int != 1) {
      return false;
    }
    return true;
  }
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Asgd != null) && (this.jdField_a_of_type_Asgd.jdField_k_of_type_Int == 1)) {}
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Asgd != null) && (this.jdField_a_of_type_Asgd.jdField_l_of_type_Int == 1)) {}
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Asgg != null)
    {
      ...
      this.jdField_a_of_type_Asgg.a(null);
      this.jdField_a_of_type_Asgg = null;
      this.jdField_a_of_type_Boolean = false;
    }
    jdField_a_of_type_Ashx = null;
