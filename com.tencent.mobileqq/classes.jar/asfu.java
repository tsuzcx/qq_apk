...
public class asfu
  ...
  implements Handler.Callback, bket
{
  ...
  public asfu(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559128, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Asgl = new asgl(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = new Dialog(this.jdField_a_of_type_AndroidContentContext, 2131755259);
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559134, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aekt.a(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ((ImageView)((View)localObject).findViewById(2131368161)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131379002);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(asjc.a(-16733441, 1593879295));
      ...
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364247);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131378650);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131378795);
      localTextView3.setTextColor(asjc.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new asfx(this, paramString1));
      localTextView2.setOnClickListener(new asfy(this, paramString4));
      localTextView1.setOnClickListener(new asfz(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new asga(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      aact.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      aact.a(akro.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(alpo.a(2131710701));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = aekt.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131710685));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131710687));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = aekt.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131710688));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846639);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846639);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(aekt.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, aekt.a(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131710678));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = aekt.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131710703));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131710695));
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Bked != null) {
      bkel.b(this.jdField_a_of_type_Bked);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131710696));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof asgl)) {
        ((asgl)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    label27:
      ...
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof asgd)) && (!(paramViewHolder instanceof asgb))) {
              break;
            }
          ...
          if ((localFeedsItemData.type == 1) || (localFeedsItemData.type == 2) || (localFeedsItemData.type == 3))
          {
            ...
            aact.a(akro.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
            return;
          }
        } while (localFeedsItemData.type != 4);
        ((asgb)paramViewHolder).a(this, localFeedsItemData, paramInt);
        paramViewHolder = new HashMap();
        aact.a(paramViewHolder, localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
        ...
        aact.a(akro.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
        return;
      } while (!(paramViewHolder instanceof ashm));
      localFeedsItemData = a(paramInt);
    } while (localFeedsItemData == null);
    ((ashm)paramViewHolder).a(localFeedsItemData);
    paramViewHolder = new HashMap();
    aact.a(paramViewHolder, localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Asgl;
      }
      return new asfv(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new asfw(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(aekt.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aekt.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject3).setId(2131377884);
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      Object localObject4 = new RelativeLayout.LayoutParams(-1, aekt.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(aekt.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setId(2131362919);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((TextView)localObject4).setMaxWidth(aekt.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(aekt.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aekt.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams2.addRule(3, 2131377884);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131371304);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.leftMargin = aekt.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      localLayoutParams2.addRule(6, 2131362919);
      localLayoutParams2.addRule(1, 2131362919);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(10.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131367041);
      ((TextView)localObject4).setBackgroundColor(1270796256);
      ((TextView)localObject4).setPadding(aekt.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, aekt.a(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131362919);
      ...
      ((CornerImageView)localObject2).setId(2131368042);
      localLayoutParams = new LinearLayout.LayoutParams(0, aekt.a(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, aekt.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131365353);
      ((ImageView)localObject1).setPadding(aekt.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = aekt.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new asgb(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return ashr.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new asgd(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559127, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof asgd))
    {
      paramViewHolder = (asgd)paramViewHolder;
      if ((paramViewHolder.a != null) && (asii.a().a() == paramViewHolder.a))
      {
        paramViewHolder.a.i();
        paramViewHolder.a.l();
      }
