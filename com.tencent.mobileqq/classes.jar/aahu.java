  ...
  implements AdQQMINIProgramAdapter
{
  public AdError show(AdQQMINIProgramAdapter.Params paramParams)
  {
    ...
    {
      aanp.d("GdtQQMINIProgramAdapter", "show error");
      return new AdError(4);
    }
    GdtAd localGdtAd = (GdtAd)GdtAd.class.cast(paramParams.ad);
    aanp.b("GdtQQMINIProgramAdapter", String.format("show %s", new Object[] { localGdtAd.getUrlForLandingPage() }));
    AdReporterForAnalysis.reportForLaunchQQMINIProgramStart((Context)paramParams.context.get(), localGdtAd);
    MiniAppLauncher.startMiniApp((Context)paramParams.context.get(), localGdtAd.getUrlForLandingPage(), 2054, new aahv(this, paramParams, localGdtAd));
