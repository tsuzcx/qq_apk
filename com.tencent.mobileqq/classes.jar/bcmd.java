  ...
  extends AutoCompleteTextView
{
  ...
  public bcmd(DropdownView paramDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public bcmd(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public bcmd(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
