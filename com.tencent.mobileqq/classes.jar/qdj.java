...
public class qdj
{
  ...
  public qdj(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static qdj a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    qdj localqdj = null;
    if (paramBannerItem.uint32_banner_type.has())
    {
      if (paramBannerItem.uint32_banner_type.get() == 2) {
        localqdj = qdn.b(paramBannerItem);
      }
    }
    else {
      return localqdj;
    }
    return qdl.b(paramBannerItem);
  }
  
  protected static void a(qdj paramqdj, oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    boolean bool = true;
    if (paramqdj != null)
    {
      ...
      for (;;)
      {
        paramqdj.jdField_a_of_type_Boolean = bool;
        paramqdj.jdField_a_of_type_Long = paramBannerItem.uint64_banner_id.get();
        localObject = paramBannerItem.msg_ad_click_report.get();
        if ((localObject == null) || (((List)localObject).size() <= 0)) {
          break;
        }
        paramqdj.jdField_a_of_type_JavaUtilList = new ArrayList();
        localObject = ((List)localObject).iterator();
        while (((Iterator)localObject).hasNext())
        {
          oidb_cmd0xbc9.AdReport localAdReport = (oidb_cmd0xbc9.AdReport)((Iterator)localObject).next();
          paramqdj.jdField_a_of_type_JavaUtilList.add(qdi.a(localAdReport));
        }
        bool = false;
      }
      ...
      {
        paramqdj.jdField_b_of_type_JavaUtilList = new ArrayList();
        ...
        while (paramBannerItem.hasNext())
        {
          ...
          paramqdj.jdField_b_of_type_JavaUtilList.add(qdi.a((oidb_cmd0xbc9.AdReport)localObject));
        }
      }
    }
  }
  
  public static void a(oidb_cmd0xbc9.BannerItem paramBannerItem, qdj paramqdj)
  {
    if (paramBannerItem.bytes_superscript_color.has()) {
      paramqdj.jdField_a_of_type_JavaLangString = paramBannerItem.bytes_superscript_color.get().toStringUtf8();
    }
    if (paramBannerItem.bytes_superscript_text.has()) {
      paramqdj.jdField_b_of_type_JavaLangString = paramBannerItem.bytes_superscript_text.get().toStringUtf8();
    }
    if (paramBannerItem.bytes_banner_title.has()) {
      paramqdj.d = paramBannerItem.bytes_banner_title.get().toStringUtf8();
    }
  }
  
  public List<String> a(List<qdi> paramList)
  {
    ...
    while (paramList.hasNext()) {
      localArrayList.add(((qdi)paramList.next()).jdField_a_of_type_JavaLangString);
    }
  ...
  protected void a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      while (localIterator.hasNext()) {
        ((List)localObject).add(((qdi)localIterator.next()).a());
      }
    }
