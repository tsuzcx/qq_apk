  ...
  implements Animatable
{
  ...
  Property<bmzg, Integer> jdField_a_of_type_AndroidUtilProperty = new bmzh(this, Integer.class, "bfIndex");
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<bmzm> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  Property<bmzg, Integer> jdField_b_of_type_AndroidUtilProperty = new bmzi(this, Integer.class, "textAlpha");
  ...
  Property<bmzg, Float> jdField_c_of_type_AndroidUtilProperty = new bmzj(this, Float.class, "textPos");
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bmzk(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bmzl(this));
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841182));
    this.jdField_a_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841183));
    this.jdField_a_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841184));
    this.jdField_a_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841185));
    this.jdField_a_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841186));
    this.jdField_a_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841209));
    this.jdField_b_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841226));
    this.jdField_b_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841227));
    this.jdField_b_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841228));
    this.jdField_b_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841229));
    this.jdField_b_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841230));
    this.jdField_b_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841231));
  }
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbmzm = (bmzm)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbmzm == null);
    localbmzm.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.getNumberOfFrames());
  }
  ...
  public boolean a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, bmzm parambmzm)
  {
    b();
    a(paramContext);
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambmzm);
    b(paramContext);
