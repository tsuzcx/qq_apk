...
public class wgg
{
  ...
  public String b;
  private List<wgh> jdField_b_of_type_JavaUtilList = new ArrayList();
  public int c;
  private long c;
  public String c;
  public int d;
  ...
  public wgg(int paramInt, List<wgh> paramList)
  {
    this.jdField_a_of_type_Long = -1L;
    this.jdField_c_of_type_Int = 6;
    this.jdField_d_of_type_Int = 0;
    if ((paramList == null) || (paramList.isEmpty())) {
      znw.a("It not allowed to new the story album by null picList", new Object[0]);
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramInt;
  ...
  public static wgg a(int paramInt)
  {
    wgg localwgg = new wgg(-1);
    localwgg.jdField_d_of_type_Int = paramInt;
    return localwgg;
  }
  
  public static wgg a(StoryAlbumEntry paramStoryAlbumEntry)
  {
    wgg localwgg = new wgg(paramStoryAlbumEntry.albumType);
    localwgg.jdField_b_of_type_Long = paramStoryAlbumEntry.startTime;
    localwgg.jdField_c_of_type_Long = paramStoryAlbumEntry.endTime;
    localwgg.jdField_b_of_type_JavaLangString = paramStoryAlbumEntry.albumName;
    localwgg.jdField_a_of_type_JavaLangString = paramStoryAlbumEntry.transId;
    localwgg.jdField_b_of_type_Int = paramStoryAlbumEntry.textId;
    localwgg.jdField_c_of_type_JavaLangString = paramStoryAlbumEntry.albumDesc;
    localwgg.jdField_d_of_type_JavaLangString = paramStoryAlbumEntry.geoHashStr;
    localwgg.f = paramStoryAlbumEntry.state;
    localwgg.jdField_c_of_type_Int = paramStoryAlbumEntry.minCount;
    localwgg.e = paramStoryAlbumEntry.debugInfo;
    localwgg.jdField_a_of_type_Long = paramStoryAlbumEntry.getId();
    localwgg.a(paramStoryAlbumEntry.extraInfo);
    return localwgg;
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    while (i < paramArrayOfByte.size())
    {
      ...
      localwgh.a((SerializationPB.PicInfo)paramArrayOfByte.get(i));
      ((List)localObject).add(localwgh);
      i += 1;
    }
  ...
  {
    return TextUtils.equals(paramString1.substring(0, paramString1.indexOf(anzj.a(2131713201))), paramString2.substring(0, paramString2.indexOf(anzj.a(2131713198))));
  }
  ...
  private byte[] a()
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.size() > 0))
    {
      ...
      {
        localArrayList.add(((wgh)this.jdField_b_of_type_JavaUtilList.get(i)).a());
        i += 1;
      }
  ...
  public String a()
  {
    ...
    long l1 = ((wgh)this.jdField_b_of_type_JavaUtilList.get(0)).jdField_b_of_type_Long;
    long l2 = ((wgh)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).jdField_b_of_type_Long;
    ...
    boolean bool = zof.a(l1 * 1000L);
    if (bool) {}
    for (localObject1 = str1.substring(str1.indexOf(anzj.a(2131713195)) + 1);; localObject1 = str1)
    {
      ...
      if (!TextUtils.equals(str1.substring(0, str1.indexOf(anzj.a(2131713197))), str2.substring(0, str2.indexOf(anzj.a(2131713200))))) {
        break label273;
      }
      return (String)localObject1 + "-" + str2.substring(str2.indexOf(anzj.a(2131713196)) + 1);
    }
    label273:
    return (String)localObject1 + "-" + str2.substring(str2.indexOf(anzj.a(2131713199)) + 1);
    label316:
  ...
  {
    yuk.d("Q.qqstory.recommendAlbum.logic.StoryAlbum", "setState:" + paramInt);
    this.f = paramInt;
  }
  ...
  public void a(List<wgh> paramList)
  {
    ...
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    wfv.b(this.jdField_b_of_type_JavaUtilList);
  }
  
  public void a(wgg paramwgg)
  {
    a(paramwgg.b(), paramwgg.c());
    if (!TextUtils.isEmpty(paramwgg.jdField_d_of_type_JavaLangString)) {
      this.jdField_d_of_type_JavaLangString = paramwgg.jdField_d_of_type_JavaLangString;
    }
    if (paramwgg.jdField_a_of_type_JavaUtilList != null) {
      this.jdField_a_of_type_JavaUtilList = paramwgg.jdField_a_of_type_JavaUtilList;
    }
  }
  
  public void a(wgu paramwgu)
  {
    this.e = paramwgu.toString();
  }
  ...
  public void a(whd paramwhd)
  {
    ...
    if (paramwhd != null)
    {
      if ((paramwhd.jdField_a_of_type_JavaUtilList == null) || (paramwhd.jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break label85;
      }
      i = new Random().nextInt(paramwhd.jdField_a_of_type_JavaUtilList.size());
    }
    label85:
    for (this.jdField_a_of_type_JavaLangString = ((String)paramwhd.jdField_a_of_type_JavaUtilList.get(i));; this.jdField_a_of_type_JavaLangString = paramwhd.jdField_b_of_type_JavaLangString)
    {
      this.jdField_c_of_type_JavaLangString = paramwhd.jdField_a_of_type_JavaLangString;
      this.jdField_c_of_type_Int = paramwhd.jdField_b_of_type_Int;
      this.jdField_b_of_type_Int = paramwhd.jdField_c_of_type_Int;
      return;
    }
  }
  ...
  {
    znw.a(paramwgg);
    yuk.a("Q.qqstory.recommendAlbum.logic.StoryAlbum", "%s merge album %s", this, paramwgg);
    this.f = 0;
    paramwgg = paramwgg.jdField_b_of_type_JavaUtilList.iterator();
    while (paramwgg.hasNext())
    {
      wgh localwgh = (wgh)paramwgg.next();
      if (!this.jdField_b_of_type_JavaUtilList.contains(localwgh)) {
        this.jdField_b_of_type_JavaUtilList.add(localwgh);
      }
    }
    wfv.b(this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public boolean c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (new File(localwgh.jdField_a_of_type_JavaLangString).exists()) {
  ...
  public long d()
  {
    ...
    return ((wgh)this.jdField_b_of_type_JavaUtilList.get(0)).jdField_b_of_type_Long;
  }
  ...
  public long e()
  {
    ...
    return ((wgh)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).d;
  }
  
  public boolean equals(Object paramObject)
  {
    boolean bool = true;
    if ((paramObject instanceof wgg))
    {
      if ((a()) && (((wgg)paramObject).a())) {
        return this.jdField_d_of_type_Int == ((wgg)paramObject).jdField_d_of_type_Int;
      }
      if (this.jdField_a_of_type_Long == ((wgg)paramObject).jdField_a_of_type_Long) {}
      for (;;)
      {
        return bool;
        bool = false;
  ...
  public long g()
  {
    ...
    return ((wgh)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).jdField_b_of_type_Long;
  }
