...
{
  public zik(SubscribePersonalDetailFragment paramSubscribePersonalDetailFragment) {}
  ...
  public void a(VSBaseRequest paramVSBaseRequest, boolean paramBoolean, long paramLong, String paramString, CertifiedAccountRead.StGetMainPageRsp paramStGetMainPageRsp)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        xvv.c("SubscribePersonalDetail", "sendRequest GetMainPage success");
        ...
        if (paramStGetMainPageRsp.user.type.get() == 0) {
          zxp.b(paramStGetMainPageRsp.user.id.get(), "auth_person", "user_exp", 0, 0, new String[0]);
        }
      }
      zxp.a("subscribe_personal_detail_page_request", zxp.a(0L, System.currentTimeMillis() - SubscribePersonalDetailFragment.a(this.a)));
      return;
    }
    xvv.c("SubscribePersonalDetail", "sendRequest GetMainPage error");
    paramVSBaseRequest = paramString;
    if (!TextUtils.isEmpty(paramString)) {
      paramVSBaseRequest = amtj.a(2131713680);
    }
    if (this.a.getActivity() != null) {
      QQToast.a(this.a.getActivity(), paramVSBaseRequest, 0).a();
    }
    zxp.a("subscribe_personal_detail_page_request", zxp.a(paramLong, System.currentTimeMillis() - SubscribePersonalDetailFragment.a(this.a)));
  }
}
