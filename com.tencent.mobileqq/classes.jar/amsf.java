...
public class amsf
{
  ...
  public amsf(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(anct paramanct, int paramInt1, int paramInt2, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    for (paramInt1 = 14;; paramInt1 = 5)
    {
      ...
      anck.a(paramanct, paramInt1, paramAppInterface);
      return 0;
    }
  }
