  ...
  implements annk
{
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)annl.a(this.a).get();
    ...
    synchronized (annl.a(this.a))
    {
      if ((Bundle)annl.a(this.a).get(Long.valueOf(l)) != null)
      {
        annl.a(this.a).remove(Long.valueOf(l));
        annl.a(this.a).removeMessages(1, localObject1);
    ...
    for (??? = "1";; ??? = "2")
    {
      ...
      azmz.a(BaseApplicationImpl.getApplication()).a(null, "actAsyncShareCallback", true, 0L, 0L, (HashMap)localObject2, null);
      if (!paramBoolean) {
        break;
      }
    ...
    annl.a(this.a, localQQAppInterface, (MessageForArkApp)localObject1);
  }
}
