  ...
  implements annf
{
  ...
  {
    anng localanng = this.jdField_a_of_type_Anmr.a();
    if (localanng != null) {
      localanng.b(paramList);
    }
  }
  
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Anmr.a();
    if (localObject != null)
    {
      localObject = ((anng)localObject).a();
      if (localObject != null) {
  ...
  {
    this.jdField_a_of_type_Anmr = paramanmr;
    paramanmr = this.jdField_a_of_type_Anmr.a();
    if (paramanmr != null) {
      paramanmr.a(this);
    }
  ...
  {
    anne localanne = this.jdField_a_of_type_Anmr.a();
    if (localanne != null)
    {
      localanne.a(paramList);
      localanne.b(paramList);
    }
  }
