...
{
  awzp(awzl paramawzl, long paramLong, String paramString, Context paramContext, int paramInt) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d(this.jdField_a_of_type_Awzl.getClass().getSimpleName(), 2, "onReceive");
    }
    new Bundle();
    ...
    if (paramBoolean)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Awzl.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
        this.jdField_a_of_type_Awzl.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
        this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_JavaLangString);
        ...
        if (paramBundle.access_token.has())
        {
          ...
          this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString.replace("$AT$", (CharSequence)localObject2);
        }
        if (paramBundle.pay_token.has())
        {
          localObject2 = paramBundle.pay_token.get();
          this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString.replace("$PT$", (CharSequence)localObject2);
        }
        if (paramBundle.openid.has())
        {
          localObject2 = paramBundle.openid.get();
          this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString.replace("$OPID$", (CharSequence)localObject2);
        }
        for (;;)
        {
          if (paramBundle.pfkey.has())
          {
            ...
            this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString.replace("$PF$", (CharSequence)localObject2);
          }
          if (paramBundle.encrykey.has())
          {
            localObject2 = paramBundle.encrykey.get();
            this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString.replace("$ESK$", (CharSequence)localObject2);
          }
          if (QLog.isColorLevel()) {
            QLog.d(this.jdField_a_of_type_Awzl.getClass().getSimpleName(), 2, "mParams=" + this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString);
          }
          ...
          QLog.d(this.jdField_a_of_type_Awzl.getClass().getSimpleName(), 2, "cant't start app pkg invalide");
          return;
          localObject2 = new StringBuilder();
          ((StringBuilder)localObject2).append("ret=").append(paramBundle.ret.get()).append(", ");
          ((StringBuilder)localObject2).append("msg=").append(paramBundle.msg.get()).append(", ");
      ...
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          QLog.d(this.jdField_a_of_type_Awzl.getClass().getSimpleName(), 2, localInvalidProtocolBufferMicroException1.getMessage());
          localObject1 = paramBundle;
        }
        for (;;)
        {
          paramBundle = awzl.a(this.jdField_a_of_type_Awzl.jdField_a_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d(getClass().getSimpleName(), 2, "lauchApp now");
          }
          bdjl.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject1, paramBundle, this.jdField_a_of_type_Int);
          awzl.jdField_a_of_type_Boolean = false;
          ...
          try
          {
            QLog.d(this.jdField_a_of_type_Awzl.getClass().getSimpleName(), 4, "pkg=" + paramBundle);
            localObject1 = paramBundle;
          }
      ...
      label1163:
      QLog.d(this.jdField_a_of_type_Awzl.getClass().getSimpleName(), 4, "start without login state");
    }
    for (;;)
    {
      break;
