  ...
  extends ImageBase
{
  ...
  private qtr jdField_a_of_type_Qtr = new qtr();
  
  public qgx(VafContext paramVafContext)
  {
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Qtr.a.a() == null) || (this.jdField_a_of_type_Qtr.a.a().mSocialFeedInfo == null) || (this.jdField_a_of_type_Qtr.a.a().mSocialFeedInfo.a == null))
    {
    ...
    if (this.jdField_a_of_type_Qtr.a.a().mSocialFeedInfo.a.a.size() > 0)
    {
      i = ((rfk)this.jdField_a_of_type_Qtr.a.a().mSocialFeedInfo.a.a.get(0)).a;
      int m = ((rfk)this.jdField_a_of_type_Qtr.a.a().mSocialFeedInfo.a.a.get(0)).b;
      f2 = AIOUtils.dp2px(i / 2, localResources);
      f1 = AIOUtils.dp2px(m / 2, localResources);
      i = ((rfk)this.jdField_a_of_type_Qtr.a.a().mSocialFeedInfo.a.a.get(0)).c;
    ...
    for (;;)
    {
      if (i == 1)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717547);
      }
      ...
      if ((f2 < j) && (f1 > k))
      {
        if (f1 / f2 > 4.0F)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717548);
        }
        else
        {
          f2 *= k / f1;
      ...
      else if ((f2 > j) && (f1 < k))
      {
        if (f2 / f1 > 4.0F)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717549);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        else
        {
