  ...
  extends aczo
{
  ...
  public aoti(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private String a()
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(antf.M, 0);
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      {
        bdzh.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool1);
        localajka = (ajka)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
        i = localajka.c();
        bdzh.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, k);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.M, 0);
        localajka.b();
        a(4014, true, null);
        return;
      }
    ...
    if ((i != k) && (k == 0)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.M, 0, true, true);
    }
    localajka.a(new ajma(paramToServiceMsg, l1));
    return;
    label884:
    i = j;
    if (k == 0)
    ...
    bdzh.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    label1328:
    label1334:
    label1340:
    label1876:
    if (i == 0)
    {
      ...
      if (paramRspSystemMsgNew.size() > 0)
      {
        ...
        l3 = bdzh.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.M, 0, l3);
        localObject2 = paramFromServiceMsg.iterator();
        if (i < 20) {
          while (((Iterator)localObject2).hasNext())
          {
            localObject1 = (ChatMessage)((Iterator)localObject2).next();
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(antf.M, 0, ((ChatMessage)localObject1).uniseq, false);
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(antf.M, 0, ((ChatMessage)localObject3).uniseq, false);
            ((Iterator)localObject2).remove();
          }
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            if ((i == 13) && (((anyw)localObject1).b(str)))
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(antf.M, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
        ...
        {
          bdzh.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l2);
          ...
          if ((!aoci.a(paramRspSystemMsgNew)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop)) {
            break label1925;
          }
          bool2 = true;
          ...
          localajka.a(new ajma(paramObject, l1));
        }
      }
    }
    for (;;)
    {
      ...
      bdzh.a().a(true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label1925:
      bool2 = false;
      break label1842;
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    RecentUser localRecentUser = (RecentUser)localapaw.findRecentUserByUin(antf.D, 4000);
    localRecentUser.msgType = 26;
    localRecentUser.displayName = ajka.jdField_a_of_type_JavaLangString;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      i1 = Math.max(i, 0);
      i = bdzi.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (QLog.isColorLevel()) {
      ...
      if (m == 3)
      {
        ajrj.a(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew, paramFromServiceMsg, i1, str1);
        return;
      }
      ajrj.a(paramRspSystemMsgNew, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    } while (n == 0);
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_seq", paramRspSystemMsgNew.latest_group_seq.get());
    bdzi.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i1);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(antf.W, 9000, i1 - i);
    ...
    if (paramToServiceMsg.getServiceCmd().equals("ProfileService.Pb.ReqSystemMsgNew"))
    {
      ...
      j = 1;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.N, 0, true, true);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.S, 0, true, true);
      ...
      ajqw.a();
      bdzi.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      i = j;
      if (localaxfw != null)
      {
        localaxfw.a(false);
    ...
    Collections.sort(paramFromServiceMsg, new aotj(this));
    j = 0;
    if (j < n)
    {
      localObject1 = bcry.a(-2018);
      ((MessageRecord)localObject1).msgtype = -2018;
      ((MessageRecord)localObject1).selfuin = str1;
      ((MessageRecord)localObject1).frienduin = antf.N;
      ...
      if ((m == 1) && (!bool1)) {
        if ((k == 2) && (i3 == 2))
        {
          ...
          if (((TroopManager)localObject4).b(str2) == null)
          {
            ...
            localObject5 = (aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
            ((aoip)localObject5).a(paramToServiceMsg.troopuin, false, "", true, true, true, false);
            ((aoip)localObject5).a(1, antz.a(paramToServiceMsg.troopuin), 0L, 2, 0, 0, true);
            ((aoip)localObject5).f(str2);
            ((aoip)localObject5).notifyUI(127, true, new Object[] { str2 });
          }
          if (((MessageForSystemMsg)localObject2).structMsg.msg.msg_invite_extinfo.has())
          {
            ...
            if ((k == 2) || (k == 4))
            {
              ...
              avpe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForSystemMsg)localObject2, paramToServiceMsg, str2);
              if (QLog.isColorLevel()) {
            ...
            bool1 = false;
            label1796:
            paramToServiceMsg = (aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
            if (paramToServiceMsg != null) {
        ...
        else
        {
          ...
          else
          {
            ...
            if ((k == 2) && (i3 == 2))
            {
              ...
              {
                if ((k == 2) || (k == 4)) {
                  avpe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForSystemMsg)localObject2, paramToServiceMsg, String.valueOf(l1));
                }
                bool2 = bool3;
                if (k == 4) {
                  bool2 = false;
            ...
            else if ((k == 13) || (k == 6))
            {
              ...
              if ((paramToServiceMsg != null) && (!paramToServiceMsg.a(((structmsg.StructMsg)localObject3).msg.group_code.get(), ((structmsg.StructMsg)localObject3).msg_time.get())))
              {
                ...
                if (localObject5 != null) {
                  ((aoip)localObject5).a(str2, (String)localObject4, true);
                }
                paramToServiceMsg.a(((structmsg.StructMsg)localObject3).msg.group_code.get(), ((structmsg.StructMsg)localObject3).msg_time.get());
              }
            }
    ...
    localObject1 = (aofz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
    ...
    if (paramToServiceMsg != null)
    {
      bdzi.a().a(paramToServiceMsg);
      l1 = paramToServiceMsg.msg_time.get();
      if ((i1 != 0) || (i != 0)) {
        ((aofz)localObject1).a(antf.W, 9000, anzj.a(2131690949), l1, l1);
      }
    }
    paramToServiceMsg = null;
    localObject1 = ajqw.d();
      ...
      try
      {
        ...
        if (paramObject.size() > 0)
        {
          ...
          if ((paramToServiceMsg != null) && (paramToServiceMsg.size() > 0))
          {
            ...
            if ((!aoci.a(paramObject)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop)) {
              break label4166;
            }
            bool1 = true;
          ...
          if (!TextUtils.isEmpty(paramRspSystemMsgNew.grp_msg_display.get())) {
            bdzi.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew.grp_msg_display.get());
          }
        }
        if ((paramRspSystemMsgNew.msg_ribbon_group.has()) && (paramRspSystemMsgNew.msg_ribbon_group.get() != null))
        {
          ...
          paramToServiceMsg = bcry.a(-2018);
          paramToServiceMsg.selfuin = str1;
          paramToServiceMsg.frienduin = antf.S;
        ...
        new ArrayList();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.N, 0, null);
        paramToServiceMsg = (arbc)aran.a().a(634);
        if ((localaxfw.a()) || (i == 0) || (paramToServiceMsg == null) || (!paramToServiceMsg.a)) {
          break;
        }
        if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    a(true, true, false, 0L, new aoto(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = (axfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
      i = 4;
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, String paramString)
  {
    ...
    paramSystemMsgActionInfo = new bevx();
    ...
    paramSystemMsgActionInfo.jdField_a_of_type_Bevw = new aotm(this);
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, structmsg.StructMsg paramStructMsg, boolean paramBoolean)
  {
    ...
    localbevx.a();
    localbevx.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgAction.Friend";
    localbevx.jdField_a_of_type_ArrayOfByte = ((structmsg.ReqSystemMsgAction)localObject).toByteArray();
    ...
    localbevx.jdField_a_of_type_JavaLangObject = localObject;
    localbevx.jdField_a_of_type_Bevw = new aotn(this, paramInt6, paramInt3, paramSystemMsgActionInfo, paramStructMsg, paramLong2);
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    {
      avpe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte, paramLong1, paramLong2, paramMsgHead);
      b(2001, true, null);
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, short paramShort, int paramInt1, msg_comm.Msg paramMsg, int paramInt2)
  {
    ...
    while (paramShort != 190)
    {
      ...
      localObject = SystemMsg.decode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bhml.a((byte[])localObject), str, paramInt1);
      if (localObject != null) {}
      for (localObject = ((SystemMsg)localObject).strGameName;; localObject = "")
      {
        localFriendListHandler.a(str, 0, 3999, (String)localObject, true, false, paramMsg.msg_head.msg_time.get());
        ajkp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong1, paramLong2, paramShort, paramMsg, paramInt2);
        return;
      }
    }
    ((anyw)localObject).a(str, false);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.M, 0);
        ((ajka)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).b();
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_suspicious_seq");; l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_seq"))
    {
      ...
      bevx localbevx = new bevx();
      localbevx.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Group";
      localbevx.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
      localbevx.jdField_a_of_type_Bevw = new aotq(this, l2, l3, l1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localbevx);
      return;
    }
  }
  ...
  public void b()
  {
    ...
    bevx localbevx = new bevx();
    localbevx.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Friend";
    localbevx.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
    localbevx.jdField_a_of_type_Bevw = new aotp(this, l1, l2, l3);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localbevx);
  }
  ...
  public void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject = new bevx();
      ((bevx)localObject).a();
      ((bevx)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Group";
      ((bevx)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
      ((bevx)localObject).jdField_a_of_type_JavaLangObject = new Integer(paramInt);
      ((bevx)localObject).jdField_a_of_type_Bevw = new aotl(this);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((bevx)localObject);
      return;
  ...
  public void d()
  {
    ...
    a(true, true, false, 0L, new aotr(this, l, localReqSystemMsgRead));
  }
  ...
  public void e()
  {
    ...
    a(true, true, false, 0L, new aots(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void g()
  {
    ...
    localObject = new bevx();
    ((bevx)localObject).a();
    ((bevx)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Friend";
    ((bevx)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
    ((bevx)localObject).jdField_a_of_type_Bevw = new aotk(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((bevx)localObject);
  }
