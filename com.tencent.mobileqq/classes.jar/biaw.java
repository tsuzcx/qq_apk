...
public class biaw
{
  ...
  private WeakReference<biax> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.4.10";
  ...
  public biaw(String paramString, int paramInt, biax parambiax)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambiax);
  }
  ...
  private biao a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new biao((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new biao();
        ((biao)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  private void a(biao parambiao)
  {
    if ((parambiao != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambiao);
    }
    ...
    if (parambiao != null)
    {
      i = parambiao.jdField_a_of_type_Int;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject = (biax)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambiao, (biax)localObject));
  }
