  ...
  implements View.OnClickListener
{
  ...
  public asci a;
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new ascf(this);
  ...
  public asce(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, boolean paramBoolean, asci paramasci, int paramInt)
  {
    ...
    this.jdField_a_of_type_Asci = paramasci;
    if ((paramBoolean) && (this.jdField_a_of_type_Asci != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Asci.b))) {}
    ...
    this.jdField_b_of_type_Int = agej.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.c = agej.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = agej.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = agej.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = new ascg(null);
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
          paramView = new ViewGroup.LayoutParams(this.jdField_b_of_type_Int, this.c);
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(paramView);
          ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView = new URLImageView(this.jdField_a_of_type_AndroidContentContext);
          paramView = new RelativeLayout.LayoutParams(this.d, this.e);
          paramView.addRule(13, -1);
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView, paramView);
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar = new ProgressBar(this.jdField_a_of_type_AndroidContentContext);
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminateDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839410));
          paramView = new RelativeLayout.LayoutParams((int)(this.jdField_a_of_type_Float * 30.0F), (int)(this.jdField_a_of_type_Float * 30.0F));
          paramView.addRule(13, -1);
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((ascg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar, paramView);
          paramView = ((ascg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout;
          paramView.setTag(localObject1);
          ((ascg)localObject1).jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = localDoutuData;
          ((ascg)localObject1).jdField_a_of_type_Int = paramInt;
          ((ascg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ...
        try
        {
          ...
          if (localURL == null)
          {
            ...
            paramView = localURL;
            continue;
            localObject1 = (ascg)paramView.getTag();
          }
        }
    ...
    label566:
    ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject2);
    ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this.jdField_a_of_type_ComTencentImageURLDrawableDownListener);
    ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setTag(localObject1);
    ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusable(true);
    ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusableInTouchMode(true);
    ...
    for (;;)
    {
      ...
      break;
      label627:
      ((ascg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(4);
      ...
      break label566;
      label675:
      ((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject1 != null) && ((localObject1 instanceof ascg))) {}
    for (localObject1 = (ascg)localObject1;; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        return;
        DoutuData localDoutuData = ((ascg)localObject1).jdField_a_of_type_ComTencentMobileqqDoutuDoutuData;
        if ((localDoutuData != null) && (localDoutuData.thumb_down_url != null))
        {
          Object localObject2 = (URLDrawable)((ascg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.getDrawable();
          if (localObject2 != null)
          {
            ...
            if (localObject2 != null)
            {
              ...
              bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", String.valueOf(((ascg)localObject1).jdField_a_of_type_Int + 1), localDoutuData.pic_md5, localDoutuData.pic_down_url);
