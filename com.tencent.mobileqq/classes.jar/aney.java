...
public class aney
  implements bliz
{
  public aney(CmGameFloatView paramCmGameFloatView) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      if ((this.a.jdField_a_of_type_Ande != null) && (this.a.jdField_a_of_type_Ande.a()))
      {
        QLog.d("cmframe_CmGameFloatView", 1, "pack up game");
        this.a.f();
        if (this.a.jdField_a_of_type_Amzn != null) {
          this.a.jdField_a_of_type_Amzn.c();
        }
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        return;
        paramView = this.a.jdField_a_of_type_Ande.a();
      ...
      if ((this.a.jdField_a_of_type_Ande != null) && (this.a.jdField_a_of_type_Ande.a()) && (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {}
      try
      {
        ...
        this.a.jdField_a_of_type_Ande.b(paramView.toString());
        if (this.a.jdField_a_of_type_Amzn != null) {
          this.a.jdField_a_of_type_Amzn.b();
        }
        if (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
        {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        PublicFragmentActivity.a(this.a.jdField_a_of_type_Ande.a(), paramView, ApolloGameInfoFragment.class, 10000);
        if (this.a.jdField_a_of_type_Amzn == null) {
          break;
        }
        this.a.jdField_a_of_type_Amzn.d();
        return;
        paramInt = 0;
        break label518;
      }
      ...
      if ((!TextUtils.isEmpty(paramView)) && (localActivity != null)) {
        anbd.b(localActivity, paramView);
      }
      for (paramInt = 0;; paramInt = 1)
      {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        if ((bool2) || (!amxt.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam))) {
          break label1082;
        }
        paramView.b(true);
        return;
