  ...
  extends BaseBubbleBuilder
{
  ...
  protected final int c = 2131379391;
  protected final int d = 2131379387;
  protected final int e = 2131379390;
  protected final int f = 2131379389;
  protected final int g = 2131379386;
  protected final int h = 2131379388;
  protected int i;
  protected int j;
  protected int k;
  protected int l;
  ...
  public ahvg(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahvh(this);
  ...
  {
    paramaggl = (ahvi)paramaggl;
    paramBaseChatItemLayout = (MessageForTroopFee)paramChatMessage;
    if ((paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (paramaggl.jdField_a_of_type_Long == paramChatMessage.uniseq)) {
      return paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    ...
    {
      paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView);
      paramaggl.b = paramChatMessage.frienduin;
      paramaggl.jdField_a_of_type_Long = paramChatMessage.uniseq;
      paramView = (TextView)paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379390);
      TextView localTextView1 = (TextView)paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379389);
      ImageView localImageView = (ImageView)paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379387);
      TextView localTextView2 = (TextView)paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379388);
      localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379391);
      ...
      localImageView.setImageResource(2130847250);
    ...
    {
      localQQWalletTransferBubbleView.setBubbleBackground(2130847248, i1, bool);
      paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramBaseChatItemLayout.title + paramBaseChatItemLayout.summary + paramBaseChatItemLayout.source);
      ...
      return paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout;
      paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout = a(this.jdField_a_of_type_AndroidContentContext);
      break;
      label378:
      if (f1 <= this.m * 14) {
        break label210;
  ...
  protected RelativeLayout a(Context paramContext)
  {
    ...
    ((QQWalletTransferBubbleView)localObject1).setId(2131379391);
    ...
    ((ImageView)localObject2).setId(2131379387);
    ((QQWalletTransferBubbleView)localObject1).addView((View)localObject2);
    localObject2 = new LinearLayout(paramContext);
    localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(0, 2131379387);
    ...
    ((TextView)localObject3).setId(2131379390);
    ...
    ((TextView)localObject3).setId(2131379389);
    ((LinearLayout)localObject2).addView((View)localObject3);
    ((QQWalletTransferBubbleView)localObject1).addView((View)localObject2);
    localRelativeLayout.addView((View)localObject1);
    localObject1 = new RelativeLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(this.i, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131379391);
    ((RelativeLayout)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject2);
    ((RelativeLayout)localObject1).setBackgroundResource(2130847249);
    ((RelativeLayout)localObject1).setId(2131379386);
