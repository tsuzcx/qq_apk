...
public class zhb
{
  ...
  private wkf jdField_a_of_type_Wkf = new wkf();
  ArrayList<bilc> b;
  private ArrayList<zhr> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = antf.ba + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public zhb(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bilc(k, (String)localObject4, (String)localObject5, 0, j, 1, new bild(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bilc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bilc)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bilc)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bilc)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bilc)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bilc)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bilc)localObject5).jdField_a_of_type_Int))) {
          ((bilc)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bilc)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bhyh.a(((JSONObject)localObject4).getString("QQVersion"), "8.4.5"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bilc)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bilc)localObject3).d = 1;
            ((bilc)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bilc)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bilc)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bilc)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bilc)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bilc)localObject3).jdField_a_of_type_Bild.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bhwl.jdField_b_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bilc)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bilc)localObject4).jdField_a_of_type_Int))) {
            ((bilc)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bilc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bilc)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bilc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bilc)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new zhc(this, this.jdField_a_of_type_Wkf, l).executeOnExecutor(Bosses.get().getExecutor(16), new wvj[] { new wvj(str1, str2, null) });
  }
  ...
  public void a(zhr paramzhr)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        bhmi.a(new File((String)localObject1), localFile);
      }
      localObject2 = new bilb((String)localObject2, i, 64000, 2, paramzhr.c);
      bile.a(BaseApplicationImpl.getContext(), (bilb)localObject2, jdField_c_of_type_JavaLangString, new zhd(paramzhr, (String)localObject1), new bilg(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramzhr.c);
      ajap.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        bhmi.a(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bilc localbilc = (bilc)localIterator.next();
        if (localbilc.jdField_b_of_type_Int == 2)
        {
          zhr localzhr = new zhr(4, localbilc.jdField_a_of_type_JavaLangString, localbilc.jdField_a_of_type_Bild.jdField_a_of_type_Int, localbilc.jdField_a_of_type_Int);
          if ((localbilc.jdField_a_of_type_Bild.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbilc.jdField_a_of_type_Bild.jdField_a_of_type_JavaLangString))) {
            localzhr.g = (jdField_b_of_type_JavaLangString + localbilc.jdField_a_of_type_Bild.jdField_a_of_type_JavaLangString.substring(localbilc.jdField_a_of_type_Bild.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localzhr);
        }
      }
    }
