...
public class bbma
{
  ...
  public static Pair<CharSequence, CharSequence> a(awoc paramawoc)
  {
    if ((paramawoc instanceof awmr)) {
      return ((awmr)paramawoc).a();
    }
    if ((paramawoc instanceof awmq)) {
      return ((awmq)paramawoc).a();
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      {
      default: 
        return bbcl.a(paramQQAppInterface, paramString1, paramInt);
      }
      if (ajsf.G.equals(paramString1)) {
        return paramContext.getString(2131719974);
      }
      if (ajsf.J.equals(paramString1)) {
        return paramContext.getString(2131719973);
      }
      if (ajsf.E.equals(paramString1)) {
        return paramContext.getString(2131720040);
      }
      if (paramInt != 1000) {
        break;
      }
    ...
    return bbcl.a(paramQQAppInterface, paramString1, paramContext.b(paramString2), paramString2, true, null);
    if (paramInt == 1004)
    {
      paramContext = bbcl.c(paramQQAppInterface, paramString2, paramString1);
      if ((paramContext != null) && (paramContext.equals(paramString1))) {
        return bbcl.b(paramQQAppInterface, paramString1, true);
      }
    }
    else
    {
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localaqlh = new aqlh(new StringReader(paramString), paramString.length());
        paramString = null;
      }
  ...
  public static ArrayList<bbmc> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        localObject2 = bbcl.b(paramQQAppInterface, (String)localObject1, true);
        ...
        localArrayList.add(new bbmc((String)localObject1, 0, new Pair(localObject2, null)));
        i = m + 1;
      }
      label193:
      paramQQAppInterface = new awts(paramQQAppInterface, 10001, 29, null);
      paramQQAppInterface.a();
      paramQQAppInterface = paramQQAppInterface.a(new awvg(paramString));
    ...
    for (;;)
    {
      ...
      {
        paramString = (awoc)((Iterator)localObject1).next();
        if ((paramString.b() & 0xFFFFFFFF & 0xFF000000) >> 24 != 2L) {
          if (localArrayList.size() < i)
          {
            if ((paramString.d() == 0) || (paramString.d() == 1004))
            {
              ...
              localArrayList.add(new bbmc(paramString.b(), paramString.d(), paramQQAppInterface));
              j = m;
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                localArrayList.add(new bbmc((String)localObject1, 0, new Pair(localObject2, localObject3)));
                i = m + 1;
                break label193;
              }
              Object localObject3 = awvy.a((String)localObject2, paramString, 1);
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
              ...
              localObject3 = awvy.a((String)localObject2, paramString, 2);
              i = m;
              if (localObject3[0] != 0) {
                break label193;
              }
              ...
              i = m + 1;
              break label193;
              localArrayList.add(new bbmc(paramString.b(), paramString.d(), null));
              m = j;
              break label349;
              label767:
  ...
  public static void a(View paramView)
  {
    ...
    bbmb.jdField_c_of_type_Int = a(paramView.getContext());
    paramView = (Integer)paramView.getTag(2131379209);
    if (paramView != null) {}
    for (int i = paramView.intValue();; i = -1)
    {
      bbmb.jdField_e_of_type_Int = i + 1;
      if (bbmb.jdField_f_of_type_Int == 1)
      {
        bbmb.jdField_a_of_type_Long = bbmb.jdField_d_of_type_Long + (System.nanoTime() - bbmb.jdField_c_of_type_Long) / 1000000L;
        bbmb.jdField_b_of_type_Long = bbmb.jdField_f_of_type_Long + (System.nanoTime() - bbmb.jdField_e_of_type_Long) / 1000000L;
      }
      if (bbmb.jdField_d_of_type_Int == 1)
      {
        bbmb.h = -1;
        bbmb.i = -1;
        bbmb.j = -1;
      }
      localHashMap.put("keyNum", String.valueOf(bbmb.jdField_a_of_type_Int));
      localHashMap.put("firstKeyLen", String.valueOf(bbmb.jdField_b_of_type_Int));
      localHashMap.put("itemPage", String.valueOf(bbmb.jdField_c_of_type_Int));
      localHashMap.put("itemSearchStrategy", String.valueOf(bbmb.jdField_d_of_type_Int));
      localHashMap.put("itemPosition", String.valueOf(bbmb.jdField_e_of_type_Int));
      localHashMap.put("itemType", String.valueOf(bbmb.jdField_f_of_type_Int));
      localHashMap.put("itemUinType", String.valueOf(bbmb.g));
      if (bbmb.jdField_f_of_type_Int == 1)
      {
        localHashMap.put("totalCost", String.valueOf(bbmb.jdField_a_of_type_Long));
        localHashMap.put("searchCost", String.valueOf(bbmb.jdField_b_of_type_Long));
      }
      localHashMap.put("senderNum", String.valueOf(bbmb.h));
      localHashMap.put("friendNum", String.valueOf(bbmb.i));
      localHashMap.put("friendIndex", String.valueOf(bbmb.j));
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "actFtsItemClickEvent", true, bbmb.jdField_a_of_type_Long, bbmb.jdField_b_of_type_Long, localHashMap, "", false);
      if ((bbmb.jdField_f_of_type_Int == 1) && (QLog.isColorLevel())) {
        QLog.d("Q.fts.utils", 2, "actFtsItemClickEvent: totalCost = " + bbmb.jdField_a_of_type_Long + ", searchCost = " + bbmb.jdField_b_of_type_Long);
      }
      return;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (a())
    {
      ...
      if (!e((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject1).put("param_ROM", bbct.j());
        axrl.a(BaseApplication.getContext()).a(null, "actQQInstallExternal", true, -1L, 0L, (HashMap)localObject1, null, false);
        c((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), true);
      }
    }
    Object localObject1 = bbct.a();
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (!f((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject2).put("param_ROM", bbct.j());
        ...
        axrl.a(BaseApplication.getContext()).a(null, "actLowRomForFTS", true, -1L, 0L, (HashMap)localObject2, null, false);
  ...
  public static String[] b(String paramString)
  {
    ...
    paramString = new aqli(new StringReader(paramString));
    try
    {
      for (;;)
      {
        aqle localaqle = paramString.a();
        if (localaqle == null) {
          break;
        }
        if (!TextUtils.isEmpty(localaqle.a()))
        {
          ((StringBuilder)localObject).append(localaqle.a());
