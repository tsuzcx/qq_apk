...
public class alti
{
  ...
  public static String a(long paramLong1, long paramLong2, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        int i = bnlk.a(new String[] { "-y", "-i", paramString, "-ss", a(paramLong1), "-t", a(paramLong2), "-c", "copy", str });
        if (i == 0) {
          break label182;
        }
  ...
  public static String a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    //   200: bipush 8
    //   202: lload_0
    //   203: invokestatic 85	alti:a	(J)Ljava/lang/String;
    //   206: aastore
    //   207: dup
    //   208: bipush 9
    //   210: ldc 89
    ...
    //   219: dup
    //   220: bipush 11
    //   222: getstatic 33	alti:a	Ljava/lang/String;
    //   225: aastore
    //   226: invokestatic 96	bnlk:a	([Ljava/lang/String;)I
    //   229: istore 5
    ...
    //   402: goto -16 -> 386
    //   405: getstatic 33	alti:a	Ljava/lang/String;
    //   408: areturn
    //   409: astore_2
    //   410: goto -34 -> 376
    //   413: astore 9
  ...
  public static String a(String paramString)
  {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (new File(paramString).exists()))
    {
      ...
      int i = bnlk.a(new String[] { "-y", "-i", paramString, "-an", "-c", "copy", str });
      if (i != 0) {
  ...
  public static String a(List<String> paramList)
  {
    ...
    //   280: aload_0
    //   281: aastore
    //   282: invokestatic 96	bnlk:a	([Ljava/lang/String;)I
    //   285: istore_1
  ...
  public static String b(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        int i = bnlk.a(new String[] { "-y", "-i", paramString, "-vn", "-c", "copy", "-map", "0:a:0", str });
        if (i == 0) {
          return str;
        }
  ...
  public static String c(String paramString)
  {
    if ((paramString != null) && (new File(paramString).exists()))
    {
      ...
      int i = bnlk.a(new String[] { "-y", "-i", paramString, "-c:a", "aac", str });
      if (i != 0)
      {
