  ...
  extends BusinessHandler
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new andh(this);
  public Handler a;
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public Messenger a;
  SparseArray<andk> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final ArrayList<andj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  andf(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidOsMessenger = null;
    this.jdField_b_of_type_AndroidOsMessenger = null;
    this.jdField_a_of_type_AndroidOsHandler = new andg(this, Looper.getMainLooper(), paramQQAppInterface);
  }
  ...
  private void a(int paramInt1, andk paramandk, int paramInt2, int paramInt3)
  {
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage();
    localMessage.what = 1;
    localMessage.obj = new Object[] { Integer.valueOf(paramInt1), paramandk, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) };
  ...
  private void b()
  {
    ...
    QZoneHelper.bindQzonePublishQueueService(this.app, this.jdField_a_of_type_AndroidContentServiceConnection);
  }
  ...
  {
    andk localandk = (andk)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    if (localandk == null) {
      return;
    }
    a(paramInt2, localandk, paramInt1, paramInt3);
  }
  
  public void a(int paramInt, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.append(paramInt, new andk(this, paramString, paramLong));
    }
    a(paramInt);
  }
  ...
  void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      Object localObject = (andj)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((andj)localObject).a();
      localObject = ((andj)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((andi)localObject).a(localView, paramLong, paramInt1, paramInt2);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, andi paramandi)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      andj localandj = (andj)localIterator.next();
      if (localandj.a() == paramView)
      {
        localandj.b = new WeakReference(paramandi);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new andj(this, paramView, paramandi));
  }
  ...
  {
    Object localObject1 = paramQQAppInterface.getMessageFacade().getMsgItemByUniseq(paramString, 1, paramLong);
    ...
    for (Object localObject2 = (StructMsgForGeneralShare)localObject2;; localObject2 = null)
    {
      ...
      {
        ((StructMsgForGeneralShare)localObject2).setSummary(BaseApplication.getContext().getResources().getString(2131690729));
        ((StructMsgForGeneralShare)localObject2).setProgress(paramInt3);
        return;
      }
      paramInt1 = 32772;
      localObject1 = BaseApplication.getContext().getResources().getString(2131690730);
      ...
      for (;;)
      {
        ...
        ((StructMsgForGeneralShare)localObject2).mMsgBrief = (amtj.a(2131714735) + (String)localObject1);
        paramQQAppInterface.getMsgCache().a(paramString, 1, paramLong);
        paramQQAppInterface.getMessageFacade().updateMsgExtraFlagByUniseq(paramString, 1, paramLong, paramInt1, 0);
        paramQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramString, 1, paramLong, ((StructMsgForGeneralShare)localObject2).getBytes());
        notifyUI(999, true, paramString);
        return;
        if (paramInt2 == 1003)
        {
          localObject1 = BaseApplication.getContext().getResources().getString(2131690728);
          paramInt1 = 32768;
        }
        else if (paramInt2 == 1005)
        {
          localObject1 = BaseApplication.getContext().getResources().getString(2131690727);
          paramInt1 = 32770;
  ...
  public boolean a()
  {
    ...
    try
    {
      QZoneHelper.stopQzonePublishQueueService(this.app.getApp());
