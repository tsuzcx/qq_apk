  ...
  implements Manager
{
  ...
  public araf(NearbyAppInterface paramNearbyAppInterface)
  {
  ...
  {
    return ((Integer)axws.a(paramQQAppInterface.getCurrentAccountUin(), "nearby_usercard_tab_host", Integer.valueOf(0))).intValue();
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    return ((Integer)axws.a(paramQQAppInterface.getCurrentAccountUin(), "face_score_switch", Integer.valueOf(0))).intValue() == 1;
  }
  
  public static int b(QQAppInterface paramQQAppInterface)
  {
    return ((Integer)axws.a(paramQQAppInterface.getCurrentAccountUin(), "nearby_usercard_tab_guest", Integer.valueOf(-1))).intValue();
  }
  ...
  public void a(NearbyAppInterface paramNearbyAppInterface, oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    for (i = 0;; i = 1)
    {
      axws.a(paramNearbyAppInterface.getAccount(), "self_gender", Integer.valueOf(i));
      return;
    }
  }
