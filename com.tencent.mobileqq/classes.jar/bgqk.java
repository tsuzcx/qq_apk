...
public class bgqk
{
  ...
  private WeakReference<bgql> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private final String b = "a4d7xwsbelhregistercard";
  private final String c = "https://proxy.vip.qq.com/cgi-bin/srfentry.fcgi";
  
  public bgqk(String paramString, bgql parambgql)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambgql);
  }
  ...
  private bgqf a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bgqf((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bgqf();
        ((bgqf)localObject).a = i;
        return localObject;
      }
    }
  ...
  private void a(bgqf parambgqf)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject1 = (bgql)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject1 != null) {
        break label159;
      }
      return;
      localObject1 = parambgqf.toString();
      break;
      i = -30009;
      break label63;
    }
    label159:
    ThreadManagerV2.getUIHandlerV2().post(new CheckRegisterLiangHao.2(this, (bgql)localObject1, parambgqf));
  }
