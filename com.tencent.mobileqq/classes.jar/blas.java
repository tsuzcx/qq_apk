...
public class blas
  implements bkxy, QQSpecialAVFilter.MusicWaveformSupporter
{
  private int jdField_a_of_type_Int;
  private blbp jdField_a_of_type_Blbp;
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private QQFilterRenderManager jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = biif.a();
  ...
  public blas(List<FilterDesc> paramList, MusicItemInfo paramMusicItemInfo, int paramInt1, int paramInt2, PublishVideoEntry paramPublishVideoEntry)
  {
    if (paramList != null)
    {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      blat localblat = new blat(this);
      try
      {
        long l = SystemClock.elapsedRealtimeNanos();
        boolean bool = this.jdField_a_of_type_Blbp.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, localblat, 0);
        if (QLog.isColorLevel()) {
  ...
  public float getCurrentMusicGain()
  {
    try
    {
      if (this.jdField_a_of_type_Blbp != null)
      {
        ...
        float f = this.jdField_a_of_type_Blbp.a(this.jdField_a_of_type_Int);
        return f;
      }
    }
    catch (Exception localException)
