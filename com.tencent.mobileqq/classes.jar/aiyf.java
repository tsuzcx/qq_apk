...
public class aiyf
{
  ...
  {
    this.jdField_a_of_type_Aiyl = new ApolloGameInterfaceProxy(this, paramString);
  ...
  {
    if (aiye.a(this.jdField_a_of_type_JavaLangString))
    {
      paramString2 = aiye.b(paramString2);
      if (QLog.isColorLevel()) {
        QLog.d("ApolloJSContext", 1, "[notifyJSEVent] " + paramString1 + " " + paramString2);
      }
      a(String.format("if(window.__dispatchEvent){window.__dispatchEvent(%s,'%s','%s')}", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 }), new aiyg(this));
      return;
    }
  ...
  {
    if ((paramCustomWebView != null) && (this.jdField_a_of_type_Aiyl != null))
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Aiyl, "__browserMsg");
        return;
      }
  ...
  {
    if ((this.jdField_a_of_type_Aiyl != null) && ((this.jdField_a_of_type_Aiyl instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Aiyl).send(paramString2, paramString1);
    }
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Aiyl != null) && ((this.jdField_a_of_type_Aiyl instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Aiyl).h();
    }
  ...
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Aiyl != null)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Aiyl.a(this);
        return;
        label36:
        d();
      }
