  ...
  extends aqyy<aqzc>
{
  ...
  private aqzn jdField_a_of_type_Aqzn;
  private Long jdField_a_of_type_JavaLangLong;
  private Runnable jdField_a_of_type_JavaLangRunnable;
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(true);
  private int b;
  
  public aqzm(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt, long paramLong, aqyu paramaqyu)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", "uinType = [" + paramInt + "], sessionUin = [" + paramLong + "], locationItem = [" + paramaqyu + "]" });
    }
    RoomOperate.ReqReportLocation localReqReportLocation = new RoomOperate.ReqReportLocation();
    qq_lbs_share.RoomKey localRoomKey = ardf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, paramLong);
    localReqReportLocation.room_key.set(localRoomKey);
    localReqReportLocation.room_key.setHasFlag(true);
    localReqReportLocation.direction.set(paramaqyu.a());
    paramaqyu = paramaqyu.a();
    if (paramaqyu == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", " latLng: ", paramaqyu });
      }
      return;
    }
    localReqReportLocation.lat.set(paramaqyu.latitude);
    localReqReportLocation.lon.set(paramaqyu.longitude);
    paramaqyu = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "QQLBSShareSvc.report_location");
    paramaqyu.putWupBuffer(localReqReportLocation.toByteArray());
    a().sendPbReq(paramaqyu);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (a(paramToServiceMsg, paramFromServiceMsg, paramObject))
    {
      try
      {
        ...
        if (ardf.a((qq_lbs_share.ResultInfo)paramToServiceMsg.msg_result.get()))
        {
  ...
  public void a(String paramString, aqzn paramaqzn)
  {
    this.jdField_a_of_type_Aqzn = paramaqzn;
  ...
  public boolean a(aqyw paramaqyw)
  {
    ...
    return new aqyw(this.b, "" + this.jdField_a_of_type_JavaLangLong).equals(paramaqyw);
  }
