...
public class mlu
{
  ...
  {
    paramQQAppInterface = baxt.a(paramQQAppInterface, paramString, (byte)2).a();
  ...
  public static void a(QQAppInterface paramQQAppInterface, View paramView, Message paramMessage, boolean paramBoolean)
  {
    ...
    View localView = paramView.findViewById(2131370540);
    TextView localTextView = (TextView)paramView.findViewById(2131370518);
    ImageView localImageView = (ImageView)paramView.findViewById(2131370517);
    int i;
    int j;
    boolean bool;
    if ((paramMessage != null) && (paramMessage.obj != null))
    {
      ...
      localObject = (LinearLayout)paramView.findViewById(2131370514);
      if (i == 2)
      {
        paramMessage = paramQQAppInterface.a().a(l);
        ((LinearLayout)localObject).setVisibility(0);
        localObject = new ImageView[3];
        localObject[0] = ((ImageView)paramView.findViewById(2131362941));
        localObject[1] = ((ImageView)paramView.findViewById(2131362943));
        localObject[2] = ((ImageView)paramView.findViewById(2131362945));
        ...
        while (i < j)
        {
          ...
          localObject[0].setImageBitmap(a(String.valueOf(((lnq)paramMessage.get(0)).a), paramQQAppInterface));
        }
      }
    }
    else
    {
      ...
      lzj.a(localView, bool, paramBoolean);
    }
    label401:
    label925:
    for (;;)
    {
      axqw.a(paramQQAppInterface, "dc00898", "", "", "0X8009EE1", "0X8009EE1", 1, 0, "", "", "", "");
      return;
      label426:
      if (paramMessage.size() == 2)
      {
        ...
        localObject[2].setVisibility(8);
        localObject[0].setImageBitmap(a(String.valueOf(((lnq)paramMessage.get(0)).a), paramQQAppInterface));
        localObject[1].setImageBitmap(a(String.valueOf(((lnq)paramMessage.get(1)).a), paramQQAppInterface));
        break;
      }
      i = 0;
      while (i < localObject.length)
      {
        ...
        localObject[i].setImageBitmap(a(String.valueOf(((lnq)paramMessage.get(i)).a), paramQQAppInterface));
        i += 1;
      }
      break;
      ((LinearLayout)localObject).setVisibility(0);
      ...
      if (j == 6)
      {
        localTextView.setText(paramQQAppInterface.getApp().getString(2131695999));
        lzj.a(localView, bool, paramBoolean);
      }
      else if (j >= 5)
      {
        paramView = paramQQAppInterface.getApp().getString(2131695997);
        paramView = paramView + " ";
      ...
      {
        localTextView.setText(paramQQAppInterface.getApp().getString(2131695690));
        lzj.a(localView, bool, paramBoolean);
      }
      else
      {
        ...
        if (i == 2) {
          paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131720358), paramQQAppInterface.getApp().getString(2131720359));
        }
        muf.a(localView, paramView);
        label978:
        lzj.a(localView, bool, paramBoolean);
      }
    }
    ...
    for (;;)
    {
      ...
      {
        lzj.a(localView, false, paramBoolean);
        return;
        if (j == 1)
        {
          ...
          paramView = paramView.replace(paramQQAppInterface.getApp().getString(2131720358), paramQQAppInterface.getApp().getString(2131720359));
          localImageView.setImageDrawable(null);
          continue;
        }
        if (!QLog.isColorLevel()) {
      ...
      paramMessage = paramQQAppInterface.getApp().getString(2131692969);
      paramView = paramMessage;
      if (i == 2) {
        paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131720358), paramQQAppInterface.getApp().getString(2131720359));
      }
      ...
      {
        if (paramQQAppInterface.a().f()) {
          localTextView.setText(2131696266);
        }
        for (;;)
        {
          muf.a(localView, paramQQAppInterface.getApp().getString(2131690271));
          lzj.a(localView, bool, paramBoolean);
          break;
          paramView = paramQQAppInterface.a().e();
          paramMessage = paramQQAppInterface.getApp().getString(2131695681);
          localTextView.setText(paramMessage + " " + paramView);
        }
      }
      if ((i == 2) && (!paramQQAppInterface.a().k()))
      {
        ...
        for (;;)
        {
          ...
          break;
          paramView = paramQQAppInterface.a().e();
          paramMessage = paramQQAppInterface.getApp().getString(2131696240);
          localTextView.setText(paramMessage + " " + paramView);
        }
      }
      lzj.a(localView, false, paramBoolean);
