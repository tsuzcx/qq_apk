...
{
  public mlu(VideoLayerUI paramVideoLayerUI, View paramView)
  {
    super(paramView);
  }
  ...
  private Rect a(int paramInt)
  {
    ...
    if ((this.a.jdField_a_of_type_ArrayOfMep != null) && (this.a.jdField_a_of_type_ArrayOfMep[paramInt].a() == 0)) {
      localRect.set(this.a.jdField_a_of_type_ArrayOfMep[paramInt].b());
    }
    return localRect;
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ArrayOfMep != null) && (paramInt >= 0) && (paramInt < this.a.jdField_a_of_type_ArrayOfMep.length))
    {
      int i = -1;
      ...
      for (;;)
      {
        ...
        str2 = this.a.jdField_a_of_type_ArrayOfMep[paramInt].b();
        if (str2 == null) {
          break label214;
        }
        if (!str2.equals(str1)) {
        ...
        return localResources.getString(2131693925) + localResources.getString(2131694956);
        if (j == 1) {
          i = 1000;
        } else if (j == 0) {
          i = 0;
      ...
      return this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getDisplayName(i, str2, String.valueOf(this.a.jdField_a_of_type_ComTencentAvVideoController.a().g)) + localResources.getString(2131694956);
    }
    label214:
    return "";
  }
  ...
  {
    if (this.a.jdField_a_of_type_ArrayOfMep != null)
    {
      int i = this.a.jdField_a_of_type_ArrayOfMep.length - 1;
      while (i >= 0)
      {
        if ((this.a.jdField_a_of_type_ArrayOfMep[i].a() == 0) && (this.a.jdField_a_of_type_ArrayOfMep[i].b().contains((int)paramFloat1, (int)paramFloat2))) {
          return i;
        }
        i -= 1;
      }
  ...
  public void getVisibleVirtualViews(List<Integer> paramList)
  {
    if (this.a.jdField_a_of_type_ArrayOfMep != null)
    {
      int j = this.a.jdField_a_of_type_ArrayOfMep.length;
      int i = 0;
      while (i < j)
      {
