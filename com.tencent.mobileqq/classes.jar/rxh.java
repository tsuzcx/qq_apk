  ...
  implements bfot
{
  ...
  public rxh(BridgeModule paramBridgeModule)
  {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (((JSONArray)localObject2).length() > 0)
          {
            ...
            ((bfol)localObject1).c(((JSONArray)localObject2).getString(j));
            j += 1;
            continue;
          }
        }
        ...
        if (!TextUtils.isEmpty(paramJSONObject)) {
          ((bfol)localObject1).d(paramJSONObject);
        }
        ((bfol)localObject1).a(new rxi(this, paramString));
        ((bfol)localObject1).a(new rxj(this, paramString));
        ((bfol)localObject1).setOnCancelListener(new rxk(this, paramString));
