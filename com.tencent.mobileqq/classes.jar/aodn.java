...
public class aodn
{
  ...
  public aodn(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3, aodo paramaodo)
  {
    ...
    this.jdField_a_of_type_Aodo = paramaodo;
    ...
    this.jdField_a_of_type_JavaUtilSet = alxx.a(paramQQAppInterface);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anmw.b(this.jdField_a_of_type_JavaUtilArrayList);
    ((bgzk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(this.jdField_a_of_type_JavaUtilArrayList);
    this.jdField_a_of_type_Anmw.a(this.d, this.jdField_a_of_type_Long, this.jdField_a_of_type_Boolean);
    ...
    for (;;)
    {
      alxx.a(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      alxx.b(this.jdField_b_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      alxx.a(this.jdField_a_of_type_JavaUtilMap, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      alxx.c(this.jdField_c_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject2 = this.jdField_a_of_type_Anmw.a(String.valueOf(paramFriends.uin));
    ...
    if (localObject2 == null)
    {
      ...
      ((ExtensionInfo)localObject1).uVipFont = gc.a(paramFriendInfo.uFounderFont);
      ((ExtensionInfo)localObject1).vipFontType = gc.b(paramFriendInfo.uFounderFont);
    ...
    for (;;)
    {
      ...
      boolean bool3 = this.jdField_a_of_type_Aodo.a(paramFriendInfo.vecRing, (ExtensionInfo)localObject1, paramFriends, this.jdField_a_of_type_JavaUtilSet, this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilList, this.jdField_a_of_type_JavaUtilMap, this.jdField_c_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilMap, (SpecialCareInfo)localObject2, this.jdField_a_of_type_Long);
      if (((SpecialCareInfo)localObject2).globalSwitch != 0) {
        this.d.add(localObject2);
      }
      boolean bool4 = bool2 | bool3 | axas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFriends, (ExtensionInfo)localObject1, paramFriendInfo.vecIntimateInfo);
      bool3 = bool4;
      if (this.jdField_b_of_type_Int == 0) {
        bool3 = afyc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Anmw, paramFriends, (ExtensionInfo)localObject1, paramFriends.uin, paramFriendInfo.vecExtSnsFrdData) | bool4;
      }
      bool4 = bool3;
      if (this.jdField_c_of_type_Int == 0) {
        bool4 = bool3 | awzr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Anmw, paramFriends, (ExtensionInfo)localObject1, paramFriends.uin, paramFriendInfo.vecMutualMarkData);
      }
      if (QLog.isColorLevel())
      {
      ...
      return;
      if ((((ExtensionInfo)localObject2).pendantId == paramFriendInfo.ulFaceAddonId) && (((ExtensionInfo)localObject2).uVipFont == gc.a(paramFriendInfo.uFounderFont)) && (((ExtensionInfo)localObject2).vipFontType == gc.b(paramFriendInfo.uFounderFont)) && (((ExtensionInfo)localObject2).colorRingId == paramFriendInfo.uColorRing) && (((ExtensionInfo)localObject2).magicFont == i) && (((ExtensionInfo)localObject2).latestPLUpdateTimestamp == paramFriendInfo.uTagUpdateTime))
      {
      ...
      else
      {
        ...
        ((ExtensionInfo)localObject2).uVipFont = gc.a(paramFriendInfo.uFounderFont);
        ((ExtensionInfo)localObject2).vipFontType = gc.b(paramFriendInfo.uFounderFont);
