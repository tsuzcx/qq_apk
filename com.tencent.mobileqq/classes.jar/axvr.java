  ...
  implements Manager
{
  ...
  protected HashMap<Long, axvw> a;
  protected HashSet<String> a;
  protected boolean a;
  protected boolean b = true;
  
  public axvr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Axvy = new axvy();
  ...
  {
    bdll.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "pay_like", paramString1, 0, 0, paramString3, paramString4, paramString5, paramString6);
  ...
  {
    if ((this.jdField_a_of_type_Axvy == null) || (this.jdField_a_of_type_Axvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg == null)) {
      return null;
    }
    return a(this.jdField_a_of_type_Axvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_first_info.get());
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Axvy.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Axvy.c = paramInt2;
        this.jdField_a_of_type_Axvy.d = paramInt3;
        if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        axvw localaxvw = (axvw)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localaxvw == null)
        {
          if ((paramInt1 > 0) || (paramInt2 > 0))
          {
            localaxvw = new axvw();
            localaxvw.jdField_a_of_type_Long = paramLong;
            localaxvw.jdField_a_of_type_Int += paramInt1;
            localaxvw.b += paramInt2;
            localaxvw.c += this.jdField_a_of_type_Axvy.b * paramInt2;
            this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localaxvw);
            localObject2 = this.jdField_a_of_type_Axvy;
            ((axvy)localObject2).f += 1;
            localObject2 = this.jdField_a_of_type_Axvy;
            ((axvy)localObject2).e -= this.jdField_a_of_type_Axvy.b * paramInt2;
          }
          if (QLog.isColorLevel())
          {
      ...
      localObject1.c += this.jdField_a_of_type_Axvy.b * paramInt2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localObject1);
      Object localObject2 = this.jdField_a_of_type_Axvy;
      ((axvy)localObject2).e -= this.jdField_a_of_type_Axvy.b * paramInt2;
      continue;
      label377:
      boolean bool = false;
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString1, axvz paramaxvz, String paramString2)
  {
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyLikeLimitManager", 2, "checkCanDoVote, uin=" + paramString1 + ", from=" + paramString2 + ", mLimitInfo=" + this.jdField_a_of_type_Axvy);
        }
        ...
        if ((bool1) && (c()))
        {
          ...
          if (i != 0)
          {
            paramActivity = bhlq.a(paramActivity, 0, null, localSpannableString, anzj.a(2131706095), anzj.a(2131706091), anzj.a(2131706090), new axvs(this, bool1, paramString1, paramaxvz, paramQQAppInterface, paramString2, paramActivity), new axvt(this, paramActivity, paramQQAppInterface, paramString2));
        ...
        if (a())
        {
          ...
          paramaxvz.a(paramString1, false);
  ...
  {
    bhlq.a(paramActivity, 230).setTitle(anzj.a(2131706096)).setMessage(anzj.a(2131706092)).setNegativeButton(anzj.a(2131706094), new axvv(this)).setPositiveButton(anzj.a(2131706093), new axvu(this, paramActivity)).show();
  }
  
  public void a(axvy paramaxvy, List<axvw> paramList, int paramInt)
  {
    try
    {
      ...
      paramaxvy = new StringBuilder();
      if ((paramList != null) && (paramList.size() > 0))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          axvw localaxvw = (axvw)paramList.next();
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localaxvw.jdField_a_of_type_Long), localaxvw);
          if (QLog.isColorLevel()) {
            paramaxvy.append(localaxvw).append(" | ");
          }
        }
      }
      if (!QLog.isColorLevel()) {
    ...
    QLog.d("NearbyLikeLimitManager", 2, "updateFromServer, mLimitInfo=" + this.jdField_a_of_type_Axvy + ", mLikeItemMap=[" + paramaxvy + "]");
    label165:
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Axvy.e >= this.jdField_a_of_type_Axvy.b)
        {
          bool1 = bool2;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Axvy.f < this.jdField_a_of_type_Axvy.c) {
          break label165;
        }
        bool1 = true;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        bool1 = false;
        break label219;
        if ((this.jdField_a_of_type_Axvy.f >= this.jdField_a_of_type_Axvy.c) && (localObject.b > 0))
        {
  ...
  public boolean a(String paramString)
  {
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 35	axvr:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   61: aload_1
  ...
  public SpannableString b()
  {
    ...
    return a(this.jdField_a_of_type_Axvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_user_num_limit_info.get());
  }
  ...
  public boolean b(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        axvw localaxvw = (axvw)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        boolean bool1;
        if ((this.jdField_a_of_type_Axvy == null) || (localaxvw == null))
        {
          if (QLog.isColorLevel())
          {
        ...
        if (localaxvw.jdField_a_of_type_Int >= this.jdField_a_of_type_Axvy.d)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public SpannableString c()
  {
    ...
    return a(this.jdField_a_of_type_Axvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_zan_limit_info.get());
  }
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Axvy != null) && (this.jdField_a_of_type_Axvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	axvr:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: lload_1
    ...
    //   13: checkcast 335	axvw
    //   16: astore 5
    //   18: aload_0
    //   19: getfield 25	axvr:jdField_a_of_type_Axvy	Laxvy;
    //   22: astore 6
    //   24: aload 6
    //   26: ifnull +8 -> 34
    //   29: aload 5
    ...
    //   16	27	5	localaxvw	axvw
    //   64	5	5	localObject	Object
    //   22	3	6	localaxvy	axvy
    // Exception table:
    //   from	to	target	type
    //   2	24	64	finally
    //   42	48	64	finally
  ...
  public boolean d()
  {
    if ((this.b) && (this.jdField_a_of_type_Axvy != null) && (this.jdField_a_of_type_Axvy.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    try
    {
      this.jdField_a_of_type_Axvy = null;
      this.jdField_a_of_type_JavaUtilHashMap.clear();
      if (QLog.isColorLevel()) {
