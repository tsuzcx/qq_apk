  ...
  implements View.OnClickListener, bhqg
{
  public int a;
  public long a;
  MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new axvt(this);
  public ImageView a;
  public LinearLayout a;
  public RelativeLayout a;
  public SeekBar a;
  public TextView a;
  private axum jdField_a_of_type_Axum;
  public axwe a;
  ...
  public axvr(Activity paramActivity, axum paramaxum)
  {
    super(paramActivity, paramaxum);
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Axum = paramaxum;
  }
  ...
  private void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Axum.a(paramLong, paramInt1, 1);
  }
  
  private void a(Uri paramUri, ArrayList<ShareActionSheetBuilder.ActionSheetItem> paramArrayList)
  {
    if ((this.mContext == null) || (this.mContext.isFinishing()) || (this.jdField_a_of_type_Axum.getGallery() == null)) {
      return;
    }
    Object localObject3 = this.jdField_a_of_type_Axum.getGallery().getSelectedView();
    ...
    label119:
    Matrix localMatrix;
    if ((localObject3 != null) && ((((View)localObject3).getTag() instanceof axwd)))
    {
      localObject1 = ((axwd)((View)localObject3).getTag()).a;
      ...
      if (j >= k * 2)
      {
        ...
        localMatrix.set(this.jdField_a_of_type_Axum.getGallery().getChildMatrix((View)localObject3));
    ...
    for (;;)
    {
      try
      {
        localObject1 = ((GalleryUrlImageView)localObject1).getRegionBmp((Rect)localObject3, localMatrix, this.jdField_a_of_type_Axum.getGallery().getWidth(), this.jdField_a_of_type_Axum.getGallery().getHeight());
  ...
  {
    Object localObject2 = new axue();
    Object localObject1 = ((axue)localObject2).a(paramAIOPictureData, 4);
    if (localObject1 == null) {
      localObject1 = ((axue)localObject2).a(paramAIOPictureData, 2);
    }
    for (;;)
    {
      if ((localObject1 == null) && (axtu.a().a())) {
        return;
      }
      if (localObject1 != null) {
        this.jdField_b_of_type_JavaLangString = ((File)localObject1).getPath();
      }
      localObject2 = bhpy.c(this.mContext);
      if (abot.a(axtu.a().a()) != 1032)
      {
        localObject2 = new ArrayList();
        ArrayList localArrayList = new ArrayList();
        if (localObject1 != null)
        {
          if ((axtu.a().a() != 1037) && (abot.a(axtu.a().a()) != 1044)) {
            bdig.a(2, (ArrayList)localObject2);
          }
          if ((axtu.a().a() != 1037) && (abot.a(axtu.a().a()) != 1044))
          {
            if (paramAIOPictureData.jdField_e_of_type_JavaLangString != null) {
              bdig.a(50, (ArrayList)localObject2);
            }
            if ((this.jdField_a_of_type_Boolean) && (paramAIOPictureData.jdField_e_of_type_JavaLangString != null)) {
              bdig.a(51, (ArrayList)localObject2);
            }
          }
          bdig.a(27, (ArrayList)localObject2);
          if ((PicShareToWX.a().a()) && (PicShareToWX.a().a((File)localObject1))) {
            bdig.a(9, (ArrayList)localObject2);
          }
          ...
          if (!this.jdField_b_of_type_Boolean) {
            bdig.a(6, localArrayList);
          }
          if ((axtu.a().a() != 1037) && (abot.a(axtu.a().a()) != 1044))
          {
            if ((axtu.a().g()) && (!TextUtils.isEmpty(axtu.a().c())) && (!axtu.a().c())) {
              bdig.a(54, localArrayList);
            }
            if (this.jdField_c_of_type_Boolean) {
              bdig.a(52, localArrayList);
            }
          ...
          if ((axtu.a().a() != 1037) && (abot.a(axtu.a().a()) != 1044))
          {
            if (this.jdField_a_of_type_Axum != null) {
              break label660;
            }
        ...
        for (;;)
        {
          ...
          return;
          if ((axtu.a().c()) || (axtu.a().a() == 1037) || (!axtu.a().g()) || (TextUtils.isEmpty(axtu.a().c())) || (abot.a(axtu.a().a()) == 1044)) {
            break;
          }
          bdig.a(54, localArrayList);
          break;
          ...
          break label485;
          label660:
          paramAIOPictureData = this.jdField_a_of_type_Axum.a(paramRichMediaBrowserInfo, this.mContext);
          break label530;
          label676:
      ...
      if ((abot.a(axtu.a().a()) == 1032) && (localObject1 != null)) {
        ((bhpy)localObject2).b(2131693495);
      }
      ((bhpy)localObject2).c(2131692989);
      ((bhpy)localObject2).a(new axvw(this, (bhpy)localObject2));
      ((bhpy)localObject2).show();
      ((bhpy)localObject2).a(this);
      return;
    }
  }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, String paramString, URLDrawable paramURLDrawable, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Axum.mActiveDrawable.put(Integer.valueOf(paramInt), paramURLDrawable);
      paramString = this.jdField_a_of_type_Axum;
      axum.updateRotation(this.galleryView, paramURLDrawable, paramRichMediaBrowserInfo.orientation);
      this.jdField_a_of_type_Axum.onLoadFinish(paramInt, true);
      return;
    }
  ...
  private boolean a(AIOPictureData paramAIOPictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    if (localaxue.a(paramAIOPictureData, 8) != null)
    {
      ...
      try
      {
        localObject2 = URLDrawable.getDrawable(localaxue.a(paramAIOPictureData, 8), (URLDrawable.URLDrawableOptions)localObject2);
      ...
      catch (Exception localException)
      {
        ...
        BrowserLogHelper.getInstance().getGalleryLog().d("AIOPictureView", 4, "getView(): url is " + localaxue.a(paramAIOPictureData, 8) + ", file type is " + 8);
      }
  ...
  private boolean b(AIOPictureData paramAIOPictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    Object localObject2 = new axue();
    if (((axue)localObject2).a(paramAIOPictureData, 1) != null)
    {
      ...
      localObject2 = ((axue)localObject2).a(paramAIOPictureData, 1);
      paramAIOPictureData = null;
      try
      {
  ...
  private boolean c(AIOPictureData paramAIOPictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    if ((paramAIOPictureData.jdField_f_of_type_Boolean) || (paramAIOPictureData.jdField_e_of_type_Boolean) || (paramAIOPictureData.jdField_d_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_Axum.onLoadFinish(this.jdField_a_of_type_Axum.getSelectedIndex(), false);
      bool = true;
    }
    return bool;
  }
  ...
  private void j()
  {
    Object localObject = this.jdField_a_of_type_Axum.getSelectedItem();
    if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 100))
    {
      ...
      if (new axue().a((AIOPictureData)localObject, 4))
      {
        if (((AIOPictureData)localObject).jdField_c_of_type_Long <= 0L) {
          break label98;
        }
        a(String.format(Locale.CHINA, this.mContext.getString(2131695500), new Object[] { arof.a(((AIOPictureData)localObject).jdField_c_of_type_Long) }));
      }
    }
    return;
    label98:
  ...
  private void k()
  {
    ...
    if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 100))
    {
      ...
      {
        bngr.a(this.mContext, ((AIOPictureData)localObject).o);
        azmj.b(null, "dc00898", "", "", "0X800A91F", "0X800A91F", 1, 0, "", "", ((AIOPictureData)localObject).o, "");
      }
    }
  }
  ...
  {
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Axum.getSelectedItem();
  ...
  {
    a(bdcd.a(this.mContext, 230, this.mContext.getString(2131719312), this.mContext.getString(2131719311), new axwb(this, paramInt, paramObject), new axwc(this)));
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Axum.getItem(paramInt);
    Object localObject3;
    Object localObject2;
    Object localObject4;
    Object localObject1;
    if ((localRichMediaBrowserInfo != null) && (localRichMediaBrowserInfo.baseData != null) && (localRichMediaBrowserInfo.baseData.getType() == 100) && (this.galleryView != null) && ((this.galleryView.getTag() instanceof axwd)))
    {
      localObject3 = ((axwd)this.galleryView.getTag()).a;
      localObject2 = (AIOPictureData)localRichMediaBrowserInfo.baseData;
      localObject4 = new axue();
    ...
    for (;;)
    {
      ...
      {
        ((GalleryUrlImageView)localObject3).setImageDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130837967));
        this.jdField_a_of_type_Axum.onLoadFinish(paramInt, false);
        this.jdField_a_of_type_Axum.a().d();
      }
      BrowserLogHelper.getInstance().getGalleryLog().d("AIOPictureView", 4, "AIOGalleryAdapter.updateView(): IMAGE_FILE_ERROR");
      return;
      label213:
      File localFile = ((axue)localObject4).a((AIOPictureData)localObject2, 2);
      if (localFile != null)
      {
        localObject1 = ((axue)localObject4).a((AIOPictureData)localObject2, 2);
        if (!paramBoolean) {
          break label724;
        }
      ...
      for (;;)
      {
        try
        {
          ...
          {
            localObject4 = ((axue)localObject4).a((AIOPictureData)localObject2, 1);
        ...
        catch (Exception localException2)
        {
          try
          {
            ...
            this.jdField_a_of_type_Axum.onLoadFinish(paramInt, true);
            localObject3 = this.jdField_a_of_type_Axum;
            axum.updateRotation(this.galleryView, (URLDrawable)localObject4, localRichMediaBrowserInfo.orientation);
            localObject3 = bdcs.b(((AIOPictureData)localObject2).jdField_b_of_type_JavaLangString);
            ...
            this.jdField_a_of_type_Axum.a().c();
            return;
        ...
        if (((axue)localObject4).a((AIOPictureData)localObject2, 1) == null) {
          break;
        }
        ((GalleryUrlImageView)localObject3).setImageDrawable(URLDrawable.getDrawable(((axue)localObject4).a((AIOPictureData)localObject2, 1), URLDrawable.URLDrawableOptions.obtain()));
        return;
      }
      label727:
      localObject2 = null;
  ...
  {
    this.jdField_a_of_type_Axwe = paramaxwe;
  }
  
  public void a(URLDrawable paramURLDrawable, int paramInt)
  {
    if (this.jdField_a_of_type_Axum.mActiveDrawable.get(Integer.valueOf(paramInt)) != null) {
      this.jdField_a_of_type_Axum.mActiveDrawable.put(Integer.valueOf(paramInt), paramURLDrawable);
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new axvx(this, paramAIOPictureData, paramRichMediaBrowserInfo, paramFile));
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setCancelListener(new axwa(this));
  }
  ...
  public void as_()
  {
    this.jdField_a_of_type_Axum.updateSystemUIVisablity();
  }
  ...
  public boolean b()
  {
    ...
    if (super.b())
    {
      localObject = this.jdField_a_of_type_Axum.getSelectedItem();
      if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 100))
      {
        AIOPictureData localAIOPictureData = (AIOPictureData)((RichMediaBrowserInfo)localObject).baseData;
        axue localaxue = new axue();
        localObject = localaxue.a(localAIOPictureData, 4);
        if (localObject != null) {
          break label109;
        }
        localObject = localaxue.a(localAIOPictureData, 2);
      }
    }
    label109:
    for (;;)
    {
      if ((localObject == null) && (axtu.a().a())) {
        return false;
      }
      return (!axtu.a().a()) && (!axtu.a().c());
    }
  }
  ...
  public boolean back()
  {
    ...
    if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 100))
    {
      ...
      if (((AIOPictureData)localObject).status == 2)
      {
        ...
        this.jdField_a_of_type_Axum.a(((AIOPictureData)localObject).jdField_a_of_type_Long, ((AIOPictureData)localObject).jdField_a_of_type_Int, 0);
      }
    }
    return super.back();
  }
  ...
  public boolean c()
  {
    if ((this.mContext.getIntent().getBooleanExtra("extra.FROM_AIO", false)) || (axtu.a().c() == 3) || (axtu.a().c() == 2) || (axtu.a().c() == 6)) {}
    for (int i = 1;; i = 0)
    {
  ...
  {
    this.jdField_a_of_type_Axum.mActiveDrawable.clear();
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Axum.c())
    {
      this.jdField_a_of_type_Axum.a().jdField_a_of_type_Boolean = false;
      return;
    }
    showContentView(false);
    this.jdField_a_of_type_Axum.a().g();
  }
  ...
  public void g()
  {
    if (this.contentView == null)
    {
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.contentView.findViewById(2131363904));
      ...
      this.jdField_d_of_type_AndroidWidgetImageButton = ((ImageButton)this.contentView.findViewById(2131373460));
      ...
      c(a(this.jdField_a_of_type_Axum.getSelectedItem()));
      f(c());
      b(b());
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof axwd)))
    {
      this.galleryView = ((RelativeLayout)paramView);
      localGalleryUrlImageView = ((axwd)paramView.getTag()).a;
    }
    ...
    for (;;)
    {
      ...
      localRichMediaBrowserInfo = this.jdField_a_of_type_Axum.getItem(paramInt);
    ...
    if (localRichMediaBrowserInfo.baseData.getType() == 100)
    {
      ...
      localObject2 = new axue();
      paramView = this.jdField_a_of_type_Axum.a();
      if ((paramView != null) && ((paramView.baseData instanceof AIOPictureData)))
      {
        ...
        azmj.b(null, "dc00898", "", "", "0X8009EEF", "0X8009EEF", 1, 0, "", "", "", "");
    ...
    for (;;)
    {
      ...
      localObject1 = null;
      paramView = null;
      paramViewGroup = (URLDrawable)this.jdField_a_of_type_Axum.mActiveDrawable.get(Integer.valueOf(paramInt));
      if ((paramViewGroup != null) && (paramViewGroup.getStatus() == 1))
      {
        localGalleryUrlImageView.setImageDrawable(paramViewGroup);
        paramView = ((axue)localObject2).a(localAIOPictureData, 4);
        ...
        try
        {
          ...
          paramView = this.jdField_a_of_type_Axum;
          axum.updateRotation(this.galleryView, paramViewGroup, localRichMediaBrowserInfo.orientation);
          if (localGalleryUrlImageView.isOriginalImage())
          {
            paramView = localAIOPictureData.jdField_c_of_type_JavaLangString;
            paramView = bdcs.b(paramView);
            BrowserLogHelper.getInstance().getGalleryLog().d("AIOPictureView", 4, "getView(): cache url is " + (String)localObject1 + ", cache type is " + ((axue)localObject2).a(localAIOPictureData, paramViewGroup.getURL().getFile()) + ",extName = + " + paramView);
            ...
            if (paramInt != 0)
            {
              ...
              this.jdField_a_of_type_Axum.a(paramInt);
              paramViewGroup = this.jdField_a_of_type_Axum.a();
              paramViewGroup.a(paramInt);
              paramViewGroup.a(paramInt, localAIOPictureData.jdField_e_of_type_Long, localAIOPictureData.jdField_f_of_type_Long);
              paramViewGroup.b(paramInt, bilx.a(localAIOPictureData.jdField_c_of_type_Int));
    ...
    Object localObject3 = ((axue)localObject2).a(localAIOPictureData, 4);
    int i;
    if (localObject3 != null)
    {
      if (localObject3 != null)
      {
        ...
        if (((axue)localObject2).a(localAIOPictureData, 1) == null) {
          break label1175;
        }
        ...
        paramView = null;
        localObject1 = ((axue)localObject2).a(localAIOPictureData, 4);
      }
      try
      {
      ...
      localGalleryUrlImageView.setGalleryImageListener(new axvu(this, localRichMediaBrowserInfo, paramViewGroup, paramView, localAIOPictureData, localGalleryUrlImageView));
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        break label972;
        label1212:
        File localFile = ((axue)localObject2).a(localAIOPictureData, 2);
        if (localFile != null)
        {
          if (localObject3 != null)
          {
          ...
          catch (Throwable paramView)
          {
            for (;;)
            {
              ...
              {
                localRichMediaBrowserInfo.orientation = JpegExifReader.readOrientation(localFile.getAbsolutePath());
                this.jdField_a_of_type_Axum.mActiveDrawable.put(Integer.valueOf(paramInt), paramViewGroup);
                localObject1 = this.jdField_a_of_type_Axum;
                axum.updateRotation(this.galleryView, paramViewGroup, localRichMediaBrowserInfo.orientation);
                localGalleryUrlImageView.setImageDrawable(paramViewGroup);
                this.jdField_a_of_type_Axum.onLoadFinish(paramInt, true);
                paramInt = 1;
                ...
                break label1242;
                label1507:
                localObject2 = ((axue)localObject2).a(localAIOPictureData, 2);
      ...
      if (((axue)localObject2).a(localAIOPictureData, 8) != null)
      {
        if ((!a(localAIOPictureData, localGalleryUrlImageView)) && (!b(localAIOPictureData, localGalleryUrlImageView)) && (!c(localAIOPictureData, localGalleryUrlImageView))) {
          a(localGalleryUrlImageView);
        }
  ...
  public void h()
  {
    ...
    {
      localObject = (AIOPictureData)((RichMediaBrowserInfo)localObject).baseData;
      this.jdField_a_of_type_Axum.a(((AIOPictureData)localObject).jdField_a_of_type_Long, ((AIOPictureData)localObject).jdField_a_of_type_Int, 2);
                  ...
                  if (axld.a())
                  {
                    ...
                    if (ShortVideoUtils.g())
                    {
                      ...
                      if (!TextUtils.isEmpty(localAIOPictureData.o))
                      {
                        ...
                        {
                          azmj.b(null, "dc00898", "", "", "0X800A91E", "0X800A91E", 1, 0, "", "", localAIOPictureData.o, "");
  ...
  void i()
  {
    Object localObject1 = this.jdField_a_of_type_Axum.getSelectedItem();
    Object localObject2;
    if ((localObject1 != null) && (((RichMediaBrowserInfo)localObject1).baseData != null) && (((RichMediaBrowserInfo)localObject1).baseData.getType() == 100))
    {
      ...
      axue localaxue = new axue();
      localObject2 = localaxue.a(localAIOPictureData, 4);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = localaxue.a(localAIOPictureData, 2);
      }
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = localaxue.a(localAIOPictureData, 1);
      }
      if (localObject2 != null) {}
    }
    else
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131364338: 
      do
      {
        ...
        {
          return;
          paramView = this.jdField_a_of_type_Axum.getSelectedItem();
        ...
        this.jdField_a_of_type_Axum.back();
        return;
        paramView = this.jdField_a_of_type_Axum.getSelectedItem();
      ...
      for (;;)
      {
        this.jdField_a_of_type_Axum.a(paramView.jdField_a_of_type_Long, paramView.jdField_a_of_type_Int, 0);
        updateUI();
        return;
        if (RichMediaBrowserManager.getInstance().getProvider() != null)
        {
    ...
    case 2131373456: 
      ...
      if ((paramView != null) && (paramView.baseData != null)) {
        MiniChatActivity.a(this.mContext, axtu.a().a(), axtu.a().a(), false, 26, ((AIOPictureData)paramView.baseData).jdField_d_of_type_Long, 0L);
      }
      this.jdField_a_of_type_Axum.j();
      return;
    }
    if ((this.mContext instanceof AIOGalleryActivity))
    {
      ...
      if (Build.VERSION.SDK_INT >= 23)
      {
        ...
        {
          paramView.requestPermissions(new axvv(this), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return;
        }
        k();
        return;
  ...
  {
    Object localObject = (URLDrawable)this.jdField_a_of_type_Axum.mActiveDrawable.get(Integer.valueOf(paramInt));
    if (localObject != null) {
    ...
    for (;;)
    {
      ...
      label261:
      for (paramRichMediaBrowserInfo = URLDrawable.getDrawable(localaxue.a(localAIOPictureData, 2) + "#" + "PART", (URLDrawable.URLDrawableOptions)localObject);; paramRichMediaBrowserInfo = URLDrawable.getDrawable(paramRichMediaBrowserInfo, (URLDrawable.URLDrawableOptions)localObject))
      {
        paramRichMediaBrowserInfo.setTag(Integer.valueOf(1));
        paramRichMediaBrowserInfo.startDownload();
        this.jdField_a_of_type_Axum.mActiveDrawable.put(Integer.valueOf(paramInt), paramRichMediaBrowserInfo);
        return null;
        i = 0;
        break;
      }
      ...
      if (localaxue.a(localAIOPictureData, 1) != null)
      {
        paramRichMediaBrowserInfo = URLDrawable.URLDrawableOptions.obtain();
        paramRichMediaBrowserInfo.mLoadingDrawable = baul.a;
        paramRichMediaBrowserInfo.mFailedDrawable = baul.a;
        if ((localAIOPictureData.jdField_d_of_type_Int == 1) && ((localAIOPictureData.jdField_f_of_type_Int & 0x2) == 2)) {
          paramRichMediaBrowserInfo.mUseAutoScaleParams = false;
        }
        URLDrawable.getDrawable(localaxue.a(localAIOPictureData, 1), paramRichMediaBrowserInfo).startDownload();
        if ((!bdee.h(this.mContext)) || (bilx.a(localAIOPictureData.jdField_c_of_type_Int)) || (RichMediaBrowserManager.getInstance().getProvider() == null)) {
          break;
        }
        RichMediaBrowserManager.getInstance().getProvider().downloadMedia(localAIOPictureData.jdField_a_of_type_Long, localAIOPictureData.jdField_a_of_type_Int, 2);
        return null;
  ...
  {
    paramView = (URLDrawable)this.jdField_a_of_type_Axum.mActiveDrawable.get(Integer.valueOf(paramInt));
    if (paramView != null)
    {
      if (paramView.getStatus() == 0) {
        paramView.cancelDownload(true);
      }
      this.jdField_a_of_type_Axum.mActiveDrawable.remove(Integer.valueOf(paramInt));
    }
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((paramView != null) && ((paramView.getTag() instanceof axwd)))
    {
      paramAdapterView = (axwd)paramView.getTag();
      if (paramAdapterView.a != null)
      {
        ...
        if ((!paramView.isOriginalImage()) && (localRichMediaBrowserInfo != null) && (localRichMediaBrowserInfo.baseData != null) && (localRichMediaBrowserInfo.baseData.getType() == 100))
        {
          ...
          if (((paramAdapterView instanceof SkinnableBitmapDrawable)) && (paramView.jdField_b_of_type_Int == 1) && (paramView.jdField_c_of_type_Long > aqxg.c()) && (this.jdField_a_of_type_Axum.getGallery() != null))
          {
            this.jdField_a_of_type_Axum.getGallery().enableDoubleTap(false);
            this.jdField_a_of_type_Axum.getGallery().enableScaleGesture(false);
          }
        }
      }
      updateUI();
  ...
  public void onShowAreaChanged(int paramInt, View paramView, RegionDrawableData paramRegionDrawableData)
  {
    if ((paramView != null) && ((paramView.getTag() instanceof axwd)))
    {
      paramView = ((axwd)paramView.getTag()).a.getDrawable();
  ...
  public void onViewDetached(int paramInt, View paramView, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    {
      paramView = ((axwd)paramView.getTag()).a.getDrawable();
      if ((paramRichMediaBrowserInfo != null) && ((paramView instanceof URLDrawable)) && (this.jdField_a_of_type_Axum.a() != null)) {
        this.jdField_a_of_type_Axum.a().b(paramRichMediaBrowserInfo.hashCode());
      }
    }
    if (this.jdField_a_of_type_Axum.a() != null) {
      this.jdField_a_of_type_Axum.a().a();
    }
  }
  ...
  public void onscaleBegin(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView != null) && ((paramView.getTag() instanceof axwd)))
    {
      paramView = ((axwd)paramView.getTag()).a;
  ...
  public void updateUI()
  {
    ...
    case 1: 
      ...
      b(false);
      f(false);
      this.jdField_a_of_type_Axum.onLoadStart(this.jdField_a_of_type_Axum.getSelectedIndex(), localAIOPictureData.progress);
      return;
    case 2: 
      this.jdField_a_of_type_Axum.onLoadFinish(this.jdField_a_of_type_Axum.getSelectedIndex(), true);
      e(false);
      b(false);
      c(false);
      f(false);
      this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(localAIOPictureData.progress / 100);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700422) + localAIOPictureData.progress / 100 + "%");
    ...
    case 3: 
      ...
      f(false);
      this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(localAIOPictureData.progress / 100);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131700406) + localAIOPictureData.progress / 100 + "%");
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      return;
    }
    this.jdField_a_of_type_Axum.onLoadFinish(this.jdField_a_of_type_Axum.getSelectedIndex(), true);
    ...
    h(true);
    axue localaxue = new axue();
    if ((localaxue.a(localAIOPictureData, 2) != null) || (localaxue.a(localAIOPictureData, 4) != null)) {
      g(true);
    }
    while ((localaxue.a(localAIOPictureData, 4)) && (localaxue.a(localAIOPictureData, 4) == null))
    {
      e(true);
      return;
      g(false);
