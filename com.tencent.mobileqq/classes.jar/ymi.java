...
public class ymi
{
  ...
  public ymi()
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new ymj(this);
    this.jdField_a_of_type_MqqAppAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    this.c = false;
  }
  
  public ymi(Activity paramActivity)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new ymj(this);
  ...
  public ymi(Activity paramActivity, ymk paramymk)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new ymj(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  ...
  public static String a(Resources paramResources, LightAppSettingInfo paramLightAppSettingInfo, String paramString)
  {
    ...
    {
      str = paramResources.getString(2131691571);
    }
    if ((!TextUtils.isEmpty(paramLightAppSettingInfo.b)) && (!TextUtils.isEmpty(paramLightAppSettingInfo.jdField_a_of_type_JavaLangString)) && (bdjl.a(paramLightAppSettingInfo.b))) {
      return paramResources.getString(2131691573, new Object[] { str });
    }
    return paramResources.getString(2131691572, new Object[] { str });
  }
  
  public static void a(Activity paramActivity, String paramString1, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (bdjl.a(paramString1)))
    {
      bdjl.a(paramActivity, paramString1);
      return;
    }
    ...
    bdfk.b(paramActivity, localBundle);
  }
  ...
  private void d()
  {
    ...
    {
      ymu.a((String)localObject, localBundle, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqObserverBusinessObserver);
      return;
    }
  }
  ...
  public LightAppSettingInfo a(DeviceInfo paramDeviceInfo)
  {
    ...
    if (localLightAppSettingInfo2 == null)
    {
      ...
      if (!this.c)
      {
        ...
        {
          a(((yah)((QQAppInterface)localAppRuntime).a(51)).a());
  ...
  public void a()
  {
    ...
    {
      localObject1 = ((yah)((QQAppInterface)localObject1).a(51)).a();
  ...
  public void a(DeviceInfo paramDeviceInfo, Bundle paramBundle, boolean paramBoolean)
  {
    if (paramDeviceInfo == null)
    {
      if (this.jdField_a_of_type_Ymk != null) {
        this.jdField_a_of_type_Ymk.a(false);
      }
      return;
    }
    if (paramBundle != null) {}
    for (boolean bool = paramBundle.getBoolean("showProgress", true);; bool = true)
    {
      ...
      for (;;)
      {
        if ((str == null) && (0 == 0))
        {
          ...
          ymt.a(null, "Net_LiteApp_Setting", 0, 1, localLightAppSettingInfo.jdField_c_of_type_Int);
          if (str != null) {
            break label713;
          }
          ...
          this.jdField_a_of_type_Ymk.a(true);
          return;
        ...
        for (Intent localIntent = new Intent();; localIntent = null)
        {
          ...
          for (;;)
          {
            ...
            break;
            localIntent.putExtra("uinname", ymu.a(paramDeviceInfo));
          }
          label713:
          ...
          bhwm.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), paramDeviceInfo, str, -1, null, SmartDevicePluginProxyActivity.class);
          break label247;
          label794:
          break;
          ...
          bdis.a().a(2131691576);
          if ((this.jdField_a_of_type_Bcqf != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bcqf.c(2131691575);
      this.jdField_a_of_type_Bcqf.show();
    }
    while (this.jdField_a_of_type_MqqAppAppRuntime == null)
    {
      bdii.d("LightAppUtil", "app == null when dologin");
      if (this.jdField_a_of_type_Ymk != null) {
        this.jdField_a_of_type_Ymk.a(false);
      }
      return;
