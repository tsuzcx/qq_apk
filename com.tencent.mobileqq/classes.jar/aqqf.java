...
public class aqqf
{
  ...
  public static aqqr a(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static List<ColorNote> a(int paramInt)
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        if (aqoq.a(localColorNote, (ColorNote)localIterator2.next())) {
  ...
  public static void a(ColorNote paramColorNote)
  {
    ...
    paramColorNote = aqoq.c(paramColorNote);
    paramColorNote.setType(2);
    aqns localaqns = new aqns();
    localaqns.a(paramColorNote.getServiceType(), paramColorNote.getSubType(), 2);
    localaqns.a(new aqqg(localaqns, paramColorNote));
  ...
  private static void a(List<ColorNote> paramList)
  {
    if ((paramList != null) && (paramList.size() >= 20))
    {
      ...
      while (i < paramList.size())
      {
        ...
        localaqns.a(localColorNote.getServiceType(), localColorNote.getSubType(), 2);
        i += 1;
      }
    }
  }
