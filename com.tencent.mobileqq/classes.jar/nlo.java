...
public class nlo
{
  ...
  {
    File localFile = new File(anhk.ba + "photo/");
    if ((!localFile.exists()) && (!localFile.mkdirs()))
    {
      a();
      QQToast.a(paramActivity, 1, paramActivity.getString(2131690591), 0).a();
      return;
    }
    ...
    a(paramActivity, localIntent, 2131690578);
  }
  ...
  private void a(Activity paramActivity, String paramString)
  {
    ...
    a(paramActivity, localIntent, 2131690592);
  }
  
  private void b(Activity paramActivity)
  {
    Object localObject = new File(anhk.ba + "photo/");
    ...
    a(paramActivity, (Intent)localObject, 2131690578);
  }
  
  private void c(Activity paramActivity)
  {
    a(paramActivity, new Intent("android.provider.MediaStore.RECORD_SOUND"), 2131690593);
  }
  ...
  public void a(Activity paramActivity, int paramInt, ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (paramInt != 0)
      {
        paramString2 = bkho.a(paramActivity);
        paramString2.a(new nlp(this));
        paramString2.setOnCancelListener(new nlq(this));
        if (paramValueCallback.equals("camera"))
        {
          paramString2.a(paramActivity.getString(2131718399), 0);
          paramString2.a(paramActivity.getString(2131692180), 0);
          paramString2.a(new nlr(this, paramActivity, paramString1, paramString2));
        }
        for (;;)
        {
          paramString2.show();
          ...
          {
            paramString2.a(paramActivity.getString(2131717768), 0);
            paramString2.a(paramActivity.getString(2131692180), 0);
            paramString2.a(new nls(this, paramActivity, paramString1, paramString2));
          }
          else if (paramValueCallback.equals("microphone"))
          {
            paramString2.a(paramActivity.getString(2131717284), 0);
            paramString2.a(paramActivity.getString(2131692180), 0);
            paramString2.a(new nlt(this, paramActivity, paramString1, paramString2));
          }
        }
      }
      a(paramActivity, paramString1);
