  ...
  extends ReportDialog
{
  ...
  public bkrb(Context paramContext)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidWidgetTextView != null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131692085);
      }
      label140:
      paramContext = (FadeIconImageView)paramContext.findViewById(2131369082);
      if (paramContext != null)
      {
        paramContext.setVisibility(0);
        paramContext.setImageResource(2130840316);
      }
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableAnimatable = ((Animatable)this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839447));
