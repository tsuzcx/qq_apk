  ...
  implements bmim
{
  ...
  public static bmim a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.smartdevice.ipc.ISmartDeviceService");
    if ((localIInterface != null) && ((localIInterface instanceof bmim))) {
      return (bmim)localIInterface;
    }
    return new bmio(paramIBinder);
  }
