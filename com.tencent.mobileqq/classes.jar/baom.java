...
public class baom
{
  ...
  {
    boolean bool = false;
    paramString = bmll.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_JavaLangString).getString("splash_union_banner_res_path_" + paramString, "");
  ...
  public boolean a()
  {
    ...
    {
      if ((bool1) && (bmll.a(this.l)) && (!a(this.jdField_b_of_type_JavaLangString))) {
        bool1 = bool2;
      }
      for (;;)
      {
  ...
  public boolean b()
  {
    ...
    if (!a(this.h, true))
    {
      ...
      {
        bool1 = bool2;
        if (!baol.a(this.jdField_d_of_type_JavaLangString)) {
          bool1 = true;
        }
      }
    }
