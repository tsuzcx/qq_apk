...
public class bpgu
{
  public static Intent a(String paramString1, String paramString2, bptq parambptq, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("uin", parambptq.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("troop_uin", parambptq.b);
    localIntent.putExtra("uintype", parambptq.jdField_a_of_type_Int);
    localIntent.putExtra("from_uin_type", parambptq.jdField_a_of_type_Int);
    ...
    paramString3 = bgmj.a(atvo.e(paramString2));
    ...
    parambptq.g = str;
    parambptq = new bqiu();
    int i = bqit.a(paramString1, parambptq);
    if (i != 0)
    {
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3)
  {
    ...
    String str2 = bgmj.a(atvo.e(paramString1));
    if (str2 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return;
    }
    String str1 = bgmj.a(atvo.e(paramString2));
    if (str1 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return;
    ...
    int i = bqit.a(paramString1, localbqiu);
    if (i != 0)
    {
      QLog.e("ShortVideoForwardManager", 1, new Object[] { "video file getRotationDegree fail, code:", Integer.valueOf(i) });
      return;
    ...
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      {
        localIntent.putExtra("qq_camera_scheme", bqcc.a(paramString1));
        localIntent.putExtra("widgetinfo", paramString1);
        paramString1 = paramActivity.getIntent().getStringExtra("key_camera_material_name");
        bnzb.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString1);
        if (TextUtils.isEmpty(paramString1)) {
          break label628;
        }
    ...
    if (((paramActivity instanceof PublicFragmentActivityForPeak)) || ((paramActivity instanceof QQBrowserActivity)))
    {
      ...
      for (;;)
      {
        if (paramActivity.getIntent() == null)
        {
          ...
          paramString3 = "";
          label691:
          bnzb.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString3);
        }
        try
        {
          if (paramString2.startsWith("http"))
          {
            ...
            localIntent.putExtra("qq_camera_scheme", bqcc.a(paramString2));
            if (!TextUtils.isEmpty(paramString3))
            {
        ...
        catch (UnsupportedEncodingException paramString1)
        {
          for (;;)
          {
            ...
            continue;
            if ((!bgsp.a(paramString2)) && (!bgsp.a(paramString1)))
            {
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramActivity != null) && (paramActivity.getIntent() != null))
      {
        ...
        if (paramString2 != null)
        {
          ...
          bnzb.b("ShortVideoForwardManager", "gotoForwardPicUI---activity=" + paramActivity + ", takeSameName=" + paramString2);
          if (TextUtils.isEmpty(paramString2)) {
            break label485;
          }
    ...
    for (;;)
    {
      ...
      aufz.a(paramActivity, "caller_aecamera", localIntent, 21, 100200);
      return;
      if (!paramBoolean2) {
        break;
      }
      localIntent.putExtra("forward_summary_extra", anni.a(2131712804));
      break;
      label485:
      localIntent.putExtra("qq_camera_top_title", "魔法视频");
    }
    label500:
    aufz.a(paramActivity, localIntent, 21, 100200);
  }
}
