  ...
  implements HttpResponseListener<BaseObject>
{
  ...
  public void a(int paramInt, BaseObject paramBaseObject)
  {
    ...
    if ((paramBaseObject instanceof Geo2AddressResultObject))
    {
      ...
      if ((paramBaseObject.result != null) && (paramBaseObject.result.pois != null))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          localObject2 = LocationRoom.Venue.a(awln.a(this.a).app.getCurrentUin(), (Poi)localObject2);
          awln.a(this.a).add(localObject2);
        }
        localObject1 = this.a;
        ...
        bool1 = true;
        awln.b((awln)localObject1, bool1);
      }
    }
    label235:
    label368:
      ...
      do
      {
        do
        {
          if (QLog.isDevelopLevel()) {
            QLog.i("LocationPoiDataFromMapHelper", 4, "[venue][poi-data] fetch onSuccess: mVenueList size = " + awln.a(this.a).size() + ", mHashMore = " + awln.a(this.a));
          }
          if (awln.a(this.a) != null) {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          localObject2 = LocationRoom.Venue.a(awln.a(this.a).app.getCurrentUin(), (SuggestionResultObject.SuggestionData)localObject2);
          awln.a(this.a).add(localObject2);
        }
        localObject1 = this.a;
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = LocationRoom.Venue.a(awln.a(this.a).app.getCurrentUin(), (SearchResultObject.SearchResultData)localObject2);
      awln.a(this.a).add(localObject2);
    }
    localObject1 = this.a;
    if (paramBaseObject.count >= 20) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    awln.a(this.a, false);
    if (QLog.isDevelopLevel()) {
      QLog.i("LocationPoiDataFromMapHelper", 4, "[venue][poi-data] fetch onFailure: mVenueList size = " + awln.a(this.a).size() + ", mHashMore = " + awln.a(this.a));
    }
    if (awln.a(this.a) != null) {
