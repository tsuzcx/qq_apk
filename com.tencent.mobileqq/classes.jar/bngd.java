  ...
  implements bnfv, bnfw, bnfx
{
  ...
  {
    return bdzx.a("https://downv6.qq.com/shadow_qqcamera/Android/image/ae_camera_circle_no_photo_tip_light.png");
  }
  ...
  private void a()
  {
    ...
    if (!a().isEmpty())
    {
      bnzb.a("AEPhotoListLogicBase", "mPhotoCommonData.selectedPhotoList.size() = " + a().size());
    ...
    for (;;)
    {
      bnzb.a("AEPhotoListLogicBase", "!mPhotoCommonData.selectedPhotoList.isEmpty(), lastImagePosition = " + i);
      if (i >= 0)
      {
        this.jdField_c_of_type_JavaLangString = str;
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.notifyDataSetChanged();
      }
      b(str, false, false);
      return;
      label151:
  ...
  private void a(int paramInt, bnfk parambnfk)
  {
    boolean bool1 = true;
    bnzb.a("AEPhotoListLogicBase", "handlePhotoItemClick, position = " + paramInt);
    LocalMediaInfo localLocalMediaInfo = (LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    if ((!parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambnfk.c.getVisibility() == 8))
    {
      bnzb.a("AEPhotoListLogicBase", "没有选中，没有focus，点击后变选中且focus, position = " + paramInt);
      if ((a() != null) && (a().size() >= this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum))
      {
        bnzb.a("AEPhotoListLogicBase", "handlePhotoItemClick, exceededPhotoLimit");
        a(localLocalMediaInfo, parambnfk);
      }
    }
    label258:
    do
    {
      ...
      if (!bool1)
      {
        i = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetGridLayoutManager.findFirstVisibleItemPosition();
        paramInt = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildAt(paramInt - i).getTop();
        this.jdField_a_of_type_Int = (DisplayUtil.dip2px(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2.0F) + paramInt);
      }
      if (bool1)
      {
        paramInt = 0;
        d(paramInt);
        parambnfk = localLocalMediaInfo.path;
        if (bool1) {
          break label258;
        }
      }
      ...
      if ((parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambnfk.c.getVisibility() == 8))
      {
        bnzb.a("AEPhotoListLogicBase", "选中，没有focus，点击后变选中且focus, position = " + paramInt);
        a(parambnfk);
        boolean bool2 = f();
        c(paramInt);
        if (!bool2)
      ...
      if ((parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) && (parambnfk.c.getVisibility() == 0))
      {
        if (a().size() > 1)
        {
          bnzb.a("AEPhotoListLogicBase", "选中，有focus，选中的图大于一张，点击后变未选中且无focus, position = " + paramInt);
          b(parambnfk);
          b(localLocalMediaInfo, parambnfk);
          a();
          return;
        }
        bnzb.a("AEPhotoListLogicBase", "选中，有focus，选中的图只有这一张，点击后变未选但有focus, position = " + paramInt);
        b(localLocalMediaInfo, parambnfk);
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.notifyDataSetChanged();
        return;
      }
    } while ((parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked()) || (parambnfk.c.getVisibility() != 0));
    bnzb.a("AEPhotoListLogicBase", "没有选中，有focus，点击后变选中且focus, position = " + paramInt);
    a(localLocalMediaInfo, parambnfk);
    d(0);
  }
  
  private void a(bnfk parambnfk)
  {
    parambnfk.c.setVisibility(0);
  }
  
  private void a(LocalMediaInfo paramLocalMediaInfo, bnfk parambnfk)
  {
    bnzb.a("AEPhotoListLogicBase", "[setSelected], photoPath=" + paramLocalMediaInfo.path);
    parambnfk.jdField_a_of_type_Bnfj.onClick(parambnfk.jdField_a_of_type_AndroidViewView);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setImageBitmap(BitmapUtils.decodeSampledBitmapFromFileCheckExif(paramString, 1440, 1440));
    this.jdField_a_of_type_Float = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
    this.jdField_b_of_type_Float = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.b();
    b(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a());
    bnez localbnez = a(paramString);
    if ((localbnez != null) && (localbnez.jdField_a_of_type_AndroidGraphicsMatrix != null) && (a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList, paramString))) {
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setImageMatrix(localbnez.jdField_a_of_type_AndroidGraphicsMatrix);
    }
    for (;;)
    {
      if (paramBoolean) {
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
      }
      if (!e()) {
        break;
      }
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeViewAECompoundButton.setVisibility(8);
      return;
      b(paramString);
    }
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeViewAECompoundButton.setVisibility(0);
  }
  ...
  private void b(bnfk parambnfk)
  {
    parambnfk.c.setVisibility(8);
  }
  
  private void b(LocalMediaInfo paramLocalMediaInfo, bnfk parambnfk)
  {
    parambnfk.jdField_a_of_type_Bnfj.onClick(parambnfk.jdField_a_of_type_AndroidViewView);
    bnzb.a("AEPhotoListLogicBase", "cancelSelected image.path = " + paramLocalMediaInfo.path);
  ...
  private void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setVisibility(4);
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a());
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
    } while (!e());
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeViewAECompoundButton.setVisibility(8);
    return;
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setVisibility(0);
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
  }
  ...
  private void c(int paramInt)
  {
    ...
    {
      bnzb.a("AEPhotoListLogicBase", "!currentFocusedImagePath.equals(mAllImages.get(position).path), position = " + paramInt);
      ...
      if (i >= 0) {
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.notifyItemChanged(i);
      }
    }
  }
  ...
  private void d(int paramInt)
  {
    ...
    {
      if (paramInt > 0) {
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.postDelayed(new AEPhotoListLogicBase.8(this), paramInt);
      }
    }
    else {
      return;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size() > 1) {
          bool1 = bnyp.a().a("sp_key_ae_ratio_toasted", true, 0);
        }
      }
    }
    return bool1;
  ...
  {
    if (paramInt == 1) {
      QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getString(2131689673), 1).a();
    }
    while (paramInt != 2) {
      return;
    }
    QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getString(2131689674), 1).a();
  }
  ...
  private boolean f()
  {
    return ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.a();
  }
  
  public Intent a(View paramView, int paramInt)
  {
    paramView = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a(paramInt);
    Intent localIntent = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
    ...
    PhotoListBaseData.sPhotoListFirstPos = ((GridLayoutManager)((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
    ...
    localIntent.setClass(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).a());
  ...
  public View a()
  {
    View localView = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558486, null);
    localView.setLayoutParams(new ViewGroup.LayoutParams(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Int, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Int));
    return localView;
  }
  
  @Nullable
  protected bnez a(@NonNull String paramString)
  {
    bnzb.a("AEPhotoListLogicBase", "[queryPhotoCropInfo]");
    if ((this.jdField_a_of_type_JavaUtilMap == null) || (this.jdField_a_of_type_JavaUtilMap.size() == 0)) {
      return null;
    }
    return (bnez)this.jdField_a_of_type_JavaUtilMap.get(paramString);
  }
  
  protected EditorPicInfo a(@NonNull String paramString)
  {
    bnzb.a("AEPhotoListLogicBase", "[prepareEditorPicInfo]");
    Object localObject = a(paramString);
    if ((localObject == null) || (((bnez)localObject).jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo == null))
    {
    ...
    return ((bnez)localObject).jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo;
  }
  ...
  String a(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    return ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131694275, new Object[] { Integer.valueOf(i) });
  }
  ...
  public List<LocalMediaInfo> a()
  {
    ...
    List localList2 = QAlbumUtil.getAlbumMedias(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName, i, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.filterVideoDurationLimit);
  ...
  {
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumPreviewMaskLayout.setAlpha(paramFloat);
    paramFloat = 1.0F - paramFloat;
    if ((this.jdField_a_of_type_Int != 0) && (this.jdField_b_of_type_Int == 2)) {
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.scrollBy(0, (int)(this.jdField_a_of_type_Int * (paramFloat - this.jdField_c_of_type_Float)));
    }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumPreviewMaskLayout.setVisibility(0);
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeViewAECompoundButton.setVisibility(8);
    }
  }
  
  @SuppressLint({"ClickableViewAccessibility"})
  public void a(int paramInt, bnfk parambnfk, bnfj parambnfj)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum > 100) {
      parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setTextSize(10.0F);
    }
    parambnfk.jdField_a_of_type_Bnfj = parambnfj;
    Object localObject1;
    label327:
    int i;
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_c_of_type_JavaLangString = ((LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).path;
      parambnfk.c.setVisibility(0);
      if ((!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isSingleMode) && (parambnfk.jdField_a_of_type_AndroidViewView != null)) {
        parambnfk.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      parambnfj = new bnge(this, parambnfk, paramInt);
      parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setOnTouchListener(parambnfj);
      parambnfk.jdField_a_of_type_AndroidViewView.setOnTouchListener(parambnfj);
      parambnfk.jdField_a_of_type_Bnfj.a(paramInt);
      parambnfk.jdField_a_of_type_Bnfj.a(parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
      parambnfk.itemView.setOnClickListener(new bngf(this, paramInt, parambnfk));
      localObject1 = parambnfk.jdField_b_of_type_AndroidWidgetImageView;
      ((ImageView)localObject1).setAdjustViewBounds(false);
      parambnfj = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a(paramInt);
      Object localObject2 = QAlbumUtil.createContentDescription(0, parambnfj, paramInt);
      parambnfk.itemView.setContentDescription((CharSequence)localObject2);
      if (parambnfj != null)
      {
        parambnfk.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.showGifTypeIcon) || (!((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(parambnfj))) {
          break label723;
        }
        if (parambnfk.jdField_b_of_type_AndroidWidgetTextView == null)
        {
          parambnfk.jdField_b_of_type_AndroidWidgetTextView = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a();
          parambnfk.jdField_b_of_type_AndroidWidgetTextView.setText("GIF");
          localObject2 = new RelativeLayout.LayoutParams(-2, -2);
          ((RelativeLayout.LayoutParams)localObject2).addRule(11);
          ((RelativeLayout.LayoutParams)localObject2).addRule(12);
          ((RelativeLayout)parambnfk.itemView).addView(parambnfk.jdField_b_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject2);
        }
        parambnfk.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        i = AlbumThumbDownloader.THUMB_WIDHT;
        parambnfj.thumbHeight = i;
        parambnfj.thumbWidth = i;
        localObject2 = parambnfk.jdField_a_of_type_ComTencentImageURLDrawable;
        StringBuilder localStringBuilder = new StringBuilder("albumthumb");
        localStringBuilder.append("://");
        localStringBuilder.append(parambnfj.path);
        if ((localObject2 == null) || (!((URLDrawable)localObject2).getURL().toString().equals(localStringBuilder.toString())))
        {
          localObject2 = QAlbumUtil.generateAlbumThumbURL(parambnfj);
          if (QLog.isColorLevel()) {
            QLog.d("PhotoListActivity", 2, "photoGridAdapter,getView(),image url :" + ((URL)localObject2).toString());
          }
          localObject2 = bdzx.a((URL)localObject2, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          ((URLDrawable)localObject2).setTag(parambnfj);
          ((ImageView)localObject1).setImageDrawable((Drawable)localObject2);
          ((URLImageView)localObject1).setURLDrawableDownListener(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi);
          parambnfk.jdField_a_of_type_ComTencentImageURLDrawable = ((URLDrawable)localObject2);
        }
        i = parambnfj.selectStatus;
        if (i != 1) {
          break label742;
        }
        parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setCheckedNumber(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.indexOf(parambnfj.path) + 1);
        if (parambnfk.itemView.getBackground() != null) {
          parambnfk.itemView.setBackgroundDrawable(null);
        }
      }
    }
    for (;;)
    {
      ...
      {
        localObject1 = QAlbumUtil.createContentDescriptionWithCheckBox(0, parambnfj, paramInt, parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.isChecked());
        parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setContentDescription((CharSequence)localObject1);
      }
      parambnfj.visableTime = SystemClock.uptimeMillis();
      parambnfj.listViewPosition = paramInt;
      a(parambnfk, parambnfj);
      ...
      parambnfk.jdField_b_of_type_AndroidWidgetImageView.setAlpha(0.3F);
      return;
      parambnfj = parambnfk.c;
      if (this.jdField_c_of_type_JavaLangString.equals(((LocalMediaInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).path)) {}
      for (i = 0;; i = 8)
      {
        parambnfj.setVisibility(i);
        break;
      }
      label723:
      if (parambnfk.jdField_b_of_type_AndroidWidgetTextView == null) {
      ...
      parambnfk.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      break label327;
      label742:
      if (i == 3)
      {
        parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
      }
      else
      {
        parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
    ...
    label788:
    parambnfk.jdField_b_of_type_AndroidWidgetImageView.setAlpha(1.0F);
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramInt == 2) && (paramBoolean))
    {
      ...
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumPreviewMaskLayout.setVisibility(8);
      if (e()) {
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeViewAECompoundButton.setVisibility(8);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().finish();
    QAlbumUtil.anim(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), false, false);
  }
  ...
  public void a(View paramView, int paramInt, CheckBox paramCheckBox)
  {
    ...
    do
    {
      ...
      localLocalMediaInfo = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a(paramInt);
    ...
    QQToast.a(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), a(localLocalMediaInfo), 0).b(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
    ...
    if (i == 1)
    {
      ...
      paramView = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
    ...
    for (;;)
    {
      paramView.put(paramCheckBox, Integer.valueOf(((GridLayoutManager)((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition()));
      ...
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt, bool1);
      paramView = (bnff)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (!bool1) {}
  ...
  protected void a(@NonNull String paramString, @NonNull bnez parambnez)
  {
    bnzb.a("AEPhotoListLogicBase", "[addOrUpdatePhotoCropInfo], inner");
    this.jdField_a_of_type_JavaUtilMap.put(paramString, parambnez);
  }
  
  protected void a(@NonNull String paramString, @NonNull EditorPicInfo paramEditorPicInfo, Matrix paramMatrix)
  {
    bnzb.a("AEPhotoListLogicBase", "[addOrUpdatePhotoCropInfo]");
    if (this.jdField_a_of_type_JavaUtilMap == null)
    {
      bnzb.a("AEPhotoListLogicBase", "[addOrUpdatePhotoCropInfo], cropInfoMap=null");
      return;
    }
    bnez localbnez = a(paramString);
    if (localbnez != null) {}
    for (;;)
    {
      localbnez.jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo = paramEditorPicInfo;
      localbnez.jdField_a_of_type_AndroidGraphicsMatrix = paramMatrix;
      a(paramString, localbnez);
      return;
      localbnez = new bnez();
    }
  }
  ...
  protected void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.post(new AEPhotoListLogicBase.9(this, paramString, paramBoolean1));
  }
  ...
  public void a(ArrayList<LocalMediaInfo> paramArrayList)
  {
    ...
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null))
    {
      ...
      while (bgkc.getMediaType(localLocalMediaInfo) != 0)
      {
        i += 1;
        break;
      }
    ...
    for (;;)
    {
      ...
      if (i > 0) {
        ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.post(new AEPhotoListLogicBase.1(this, i));
      }
      return;
      label130:
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      int i = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetGridLayoutManager.findFirstVisibleItemPosition();
      i = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildAt(0 - i).getTop();
      this.jdField_a_of_type_Int = (DisplayUtil.dip2px(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2.0F) + i);
    }
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
  }
  ...
  void a(boolean paramBoolean, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      PhotoListBaseData.sPhotoListFirstPos = ((GridLayoutManager)((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
      paramIntent.setClass(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).a());
      paramIntent.addFlags(603979776);
      c(paramIntent);
      QAlbumUtil.anim(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), true, true);
      return;
  ...
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity() == null)) {
      return false;
    }
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.5(this));
    Object localObject;
    if (paramList == null)
    {
      ...
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a((List)localObject);
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.6(this));
      return false;
    }
    ...
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a(paramList);
    boolean bool = paramList.isEmpty();
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.7(this, bool));
    return true;
  }
  
  public View b()
  {
    View localView = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558487, null);
    localView.setLayoutParams(new ViewGroup.LayoutParams(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Int, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Int));
    return localView;
  }
  ...
  protected void b(int paramInt)
  {
    if (paramInt == 1)
    {
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setGestureEnabled(true);
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setMinZoom(this.jdField_b_of_type_Float);
    }
    while (paramInt != 2) {
      return;
    }
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setGestureEnabled(false);
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.setMinZoom(this.jdField_a_of_type_Float);
  }
  
  public void b(int paramInt, bnfk parambnfk, bnfj parambnfj)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum > 100) {
      parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setTextSize(10.0F);
    }
    parambnfk.itemView.setOnClickListener(new bngg(this, parambnfk, paramInt));
    LocalMediaInfo localLocalMediaInfo;
    label195:
    int i;
    if (c())
    {
      parambnfk.c.setVisibility(0);
      parambnfk.jdField_a_of_type_Bnfj = parambnfj;
      if (parambnfk.jdField_a_of_type_AndroidViewView != null) {
        parambnfk.jdField_a_of_type_AndroidViewView.setOnClickListener(parambnfk.jdField_a_of_type_Bnfj);
      }
      if ((!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isSingleMode) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isSupportVideoCheckbox) && (parambnfk.jdField_a_of_type_AndroidViewView != null)) {
        parambnfk.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      parambnfk.jdField_a_of_type_Bnfj.a(paramInt);
      parambnfk.jdField_a_of_type_Bnfj.a(parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
      ImageView localImageView = parambnfk.jdField_b_of_type_AndroidWidgetImageView;
      localImageView.setAdjustViewBounds(false);
      localLocalMediaInfo = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a(paramInt);
      parambnfj = QAlbumUtil.createContentDescription(1, localLocalMediaInfo, paramInt);
      parambnfk.itemView.setContentDescription(parambnfj);
      if (!localLocalMediaInfo.isSystemMeidaStore) {
        break label537;
      }
      parambnfj = QAlbumUtil.generateAlbumThumbURL(localLocalMediaInfo, "VIDEO");
      i = AlbumThumbDownloader.THUMB_WIDHT;
      localLocalMediaInfo.thumbHeight = i;
      localLocalMediaInfo.thumbWidth = i;
      URLDrawable localURLDrawable = parambnfk.jdField_a_of_type_ComTencentImageURLDrawable;
      if ((localURLDrawable == null) || (!localURLDrawable.getURL().equals(parambnfj)))
      {
        if (QLog.isColorLevel()) {
          QLog.d("PhotoListActivity", 2, "PhotoListAdapter,getView(),vedio url :" + parambnfj.toString());
        }
        parambnfj = bdzx.a(parambnfj, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        parambnfj.setTag(localLocalMediaInfo);
        localImageView.setImageDrawable(parambnfj);
        ((URLImageView)localImageView).setURLDrawableDownListener(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi);
        parambnfk.jdField_a_of_type_ComTencentImageURLDrawable = parambnfj;
        if (localURLDrawable != null) {
          localURLDrawable.cancelDownload();
        }
      }
      parambnfj = parambnfk.jdField_a_of_type_AndroidWidgetTextView;
      if ((localLocalMediaInfo.isSystemMeidaStore) || (localLocalMediaInfo.mDuration > 0L)) {
        break label549;
      }
      parambnfj.setVisibility(8);
      parambnfj = MediaScanner.getInstance(BaseApplicationImpl.getContext());
      if (parambnfj != null) {
        parambnfj.queryMediaInfoDuration(this, localLocalMediaInfo, paramInt);
      }
      label406:
      i = localLocalMediaInfo.selectStatus;
      if (i != 1) {
      ...
      parambnfk.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setCheckedNumber(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.indexOf(localLocalMediaInfo.path) + 1);
      if (parambnfk.itemView.getBackground() != null) {
        parambnfk.itemView.setBackgroundDrawable((Drawable)null);
      }
    }
    for (;;)
    {
      ...
      break;
      label537:
      parambnfj = QAlbumUtil.generateAlbumThumbURL(localLocalMediaInfo, "APP_VIDEO");
      break label195;
      label549:
      parambnfj.setVisibility(0);
      parambnfj.setText(AbstractPhotoListActivity.formatTimeToString(localLocalMediaInfo.mDuration));
      break label406;
      label569:
      if (i == 3)
      {
  ...
  {
    a(false, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent());
  }
  ...
  public void b(View paramView, int paramInt)
  {
    ...
    {
      return;
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
      ...
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramView.path);
    ...
    Object localObject1 = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.a(paramInt);
    ...
    paramView.setClass(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).a());
    paramView.addFlags(603979776);
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).startActivity(paramView);
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().finish();
    QAlbumUtil.anim(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), true, true);
  }
  ...
  {
    bnzb.a("AEPhotoListLogicBase", "[removePhotoCropInfo]");
    if ((this.jdField_a_of_type_JavaUtilMap != null) && (this.jdField_a_of_type_JavaUtilMap.size() > 0)) {
  ...
  public View c()
  {
    ImageView localImageView = new ImageView(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity());
    localImageView.setLayoutParams(new ViewGroup.LayoutParams(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Int, ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Int));
  ...
  public void c(int paramInt, bnfk parambnfk, bnfj parambnfj) {}
  
  public void c(Intent paramIntent)
  {
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).startActivity(paramIntent);
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().finish();
  }
  ...
  public void d()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      return;
      str = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131694260);
      break;
    }
  }
  ...
  {
    int i = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
    label66:
    label94:
    String str;
    ...
    if (i == 1)
    {
      ...
      if (d())
      {
        bnyp.a().a("sp_key_ae_ratio_toasted", false, 0);
        e(i);
      }
      if (i != 1) {
        break label283;
    ...
    label511:
    ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
  }
  ...
  public void e()
  {
    ...
    {
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().runOnUiThread(new AEPhotoListLogicBase.10(this));
      return;
    }
  ...
  public void e(View paramView)
  {
    ...
    if (i < ((List)localObject).size())
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        bnez localbnez = a(str);
        if ((localbnez != null) && (localbnez.jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo != null) && (new File(str).exists())) {
          paramView.add(localbnez.jdField_a_of_type_DovComQqImAeeditorModuleClipImageEditorPicInfo);
        }
      }
    }
    if (CollectionUtils.isEmpty(paramView))
    {
      QQToast.a(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2131689729, 0).a();
      return;
    }
    localObject = new Bundle();
    ((Bundle)localObject).putSerializable("AEEditorConstants_CLIPPED_PIC_INFOS", paramView);
    i = bnqb.y.a();
    if (bnqb.k(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent())) {
      i = bnqb.A.a();
    }
    bnzo.a(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 0, (Bundle)localObject, i);
  }
  
  public void f()
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.backPressed) {
      AlbumThumbManager.getInstance(((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity()).clear();
    }
    if (((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi != null)
    {
      int i = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bnfi.getItemCount();
    ...
    if (((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidOsAsyncTask != null) {
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidOsAsyncTask.cancel(true);
    }
    if (this.jdField_a_of_type_JavaUtilMap != null) {
  ...
  public void g()
  {
    if (((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b()) {
      ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAEAlbumLinearLayout.b();
    }
  }
  ...
  protected void h()
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      localEditorPicInfo = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a(localEditorPicInfo);
      Matrix localMatrix = ((bnff)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumNocropperAECropperView.a();
