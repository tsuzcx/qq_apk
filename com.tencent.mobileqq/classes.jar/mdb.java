  ...
  implements mcz
{
  ...
  public mdb(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
  ...
  protected int a(Paint paramPaint, String paramString)
  {
    ...
    float f2 = 0.0F;
    float f1 = f3;
    if (this.jdField_a_of_type_Mda != null) {
      f1 = this.jdField_a_of_type_Mda.jdField_a_of_type_Float;
    }
  ...
  {
    krx.c(this.jdField_a_of_type_JavaLangString, "start:" + paramLong);
  }
  
  protected abstract void a(Canvas paramCanvas, int paramInt1, int paramInt2);
  
  public void a(Typeface paramTypeface, int paramInt, mda parammda)
  {
    ...
    this.jdField_a_of_type_Mda = parammda;
    this.jdField_a_of_type_AndroidGraphicsPaint.setTextSize(paramInt);
    d();
    if (this.jdField_a_of_type_Kws != null) {}
    for (paramTypeface = this.jdField_a_of_type_Kws.a;; paramTypeface = null)
    {
  ...
  public void a(kws paramkws)
  {
    ...
    if (this.jdField_a_of_type_Kws != null)
    {
      localObject = this.jdField_a_of_type_Kws.b;
      localObject = (String)localObject;
      this.jdField_a_of_type_Kws = paramkws;
      if ((this.jdField_a_of_type_Kws != null) && (!this.jdField_a_of_type_Kws.a()) && (paramkws != null) && (TextUtils.isEmpty(paramkws.b)) && (localObject != null) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        this.jdField_a_of_type_Kws.b = ((CharSequence)localObject);
      }
      if (this.jdField_a_of_type_Kws == null) {
        break label124;
      }
    ...
    label124:
    for (paramkws = this.jdField_a_of_type_Kws.a;; paramkws = null)
    {
      paramkws = (String)paramkws;
      this.c = a(this.jdField_a_of_type_AndroidGraphicsPaint, paramkws);
      return;
      localObject = null;
      break;
    }
  ...
  Bitmap b()
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_Kws.a)) {
    ...
    do
    {
      ...
      {
        return localObject3;
        krx.c(this.jdField_a_of_type_JavaLangString, "build:" + toString());
  ...
  public void d()
  {
    krx.c(this.jdField_a_of_type_JavaLangString, "releaseBitmap:" + this.jdField_a_of_type_AndroidGraphicsBitmap);
  ...
  {
    return "ZimuItemView{mFontPara=" + this.jdField_a_of_type_Mda.toString() + ", getTypeface=" + this.jdField_a_of_type_AndroidGraphicsPaint.getTypeface() + ", mTextSize=" + this.jdField_a_of_type_Int + ", mAlpha=" + this.b + ", mWidth=" + this.c + ", mHeight=" + this.d + ", mCurrentX=" + this.e + ", mCurrentY=" + this.f + ", mSentenceInfo=" + this.jdField_a_of_type_Kws.toString() + ", mBitmapCache=" + this.jdField_a_of_type_AndroidGraphicsBitmap + '}';
  }
}
