...
{
  mdb(mcz parammcz, VideoPlayerWrapper paramVideoPlayerWrapper, long paramLong, ThirdVideoManager paramThirdVideoManager) {}
  ...
  public void a(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    VideoFeedsPlayManager.VideoPlayParam localVideoPlayParam = VideoFeedsPlayManager.a(this.jdField_a_of_type_Mcz.a);
    if ((localVideoPlayParam != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayerWrapper == VideoFeedsPlayManager.a(this.jdField_a_of_type_Mcz.a)) && (paramString2.equals(localVideoPlayParam.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a))) {
      if (TextUtils.isEmpty(paramString1)) {
        if (VideoFeedsPlayManager.a(this.jdField_a_of_type_Mcz.a) != null) {
          VideoFeedsPlayManager.a(this.jdField_a_of_type_Mcz.a).a(null, 123, 107, 0, "UUIDToUrlCallback vid2url ERROR ", null);
        }
      }
    }
    while (!QLog.isColorLevel()) {
      ...
      {
        return;
        VideoPreDownloadMgr localVideoPreDownloadMgr = VideoFeedsPlayManager.a(this.jdField_a_of_type_Mcz.a);
