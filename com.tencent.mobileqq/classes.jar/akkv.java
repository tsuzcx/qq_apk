...
public class akkv
  extends akkr
{
  public akkv(QQAppInterface paramQQAppInterface, akkq paramakkq)
  {
    super(paramQQAppInterface, paramakkq, RoamDate.class);
  }
  ...
  {
    paramauko = (RoamDate)paramauko;
    return paramauko.uin + "&" + paramauko.date;
  }
  ...
  public Calendar a(String paramString, Calendar paramCalendar, List<Map.Entry<String, auko>> paramList)
  {
  ...
  public void a(String paramString)
  {
    ...
    paramString = ((aukp)localObject).a(RoamDate.class, false, "uin=?", new String[] { paramString }, null, null, null, null);
    ((aukp)localObject).a();
    if (paramString != null)
    {
      c();
  ...
  public boolean a(String paramString, Calendar paramCalendar, List<Map.Entry<String, auko>> paramList)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    int j;
  ...
  public Calendar b(String paramString, Calendar paramCalendar, List<Map.Entry<String, auko>> paramList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = paramList;
