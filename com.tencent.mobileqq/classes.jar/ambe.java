...
public class ambe
{
  ...
  public static ambe a;
  public static boolean a;
  public final int a;
  public final Handler a;
  public final Runnable a;
  public final Map<String, String> a;
  public final ConcurrentHashMap<Integer, HashMap<String, amcl>> a;
  public final CopyOnWriteArrayList<amcy> a;
  ...
  public static ambe a()
  {
    if (jdField_a_of_type_Ambe == null) {}
    try
    {
      if (jdField_a_of_type_Ambe == null) {
        jdField_a_of_type_Ambe = new ambe();
      }
      return jdField_a_of_type_Ambe;
    }
    finally {}
  }
  
  public Bitmap a(amcy paramamcy, amcm paramamcm)
  {
    if ((paramamcy == null) || (paramamcm == null)) {
      return null;
    }
    paramamcy = "BubbleDiyFetcher_" + paramamcm.jdField_a_of_type_Int + "_" + paramamcm.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramamcm = (Bitmap)BaseApplicationImpl.sImageCache.get(paramamcy);
    if (paramamcm != null)
    {
      this.c.remove(paramamcy);
      return paramamcm;
    }
    this.c.add(paramamcy);
    paramamcy = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramamcy instanceof QQAppInterface)) {
      a((QQAppInterface)paramamcy, 500);
    }
    return null;
  }
  
  public String a(amcy paramamcy, String paramString)
  {
    Object localObject;
    if ((paramamcy == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamcy);
    paramamcy = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramamcy instanceof QQAppInterface)) {
      a((QQAppInterface)paramamcy, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localamcy != null) && (localamcy.getCallback() != null) && (a(localamcy.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localamcy.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, ajte paramajte)
  {
    ...
    ((ambf)paramQQAppInterface.a(70)).a((List)localObject, paramajte);
  }
  ...
  public Bitmap b(amcy paramamcy, amcm paramamcm)
  {
    if ((paramamcy == null) || (paramamcm == null) || (TextUtils.isEmpty(paramamcy.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramamcy.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramamcy.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramamcm.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramamcm.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramamcy.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramamcm.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramamcm = "BubbleDiyFetcher_" + paramamcm.jdField_a_of_type_Int + "_" + paramamcm.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramamcm);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramamcm);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramamcm);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramamcm);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramamcy.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramamcy.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        BubbleDiyEntity localBubbleDiyEntity = (BubbleDiyEntity)((aukp)localObject2).a(BubbleDiyEntity.class, (String)((ArrayList)localObject1).get(i));
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = baxi.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (amcl)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = baxi.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
