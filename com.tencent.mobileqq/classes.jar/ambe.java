...
public class ambe
  extends alpd
{
  public ambe(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
          ...
          for (;;)
          {
            ...
            if (paramObject.msg_quota.has())
            {
              ...
              if (paramObject.uint32_comm_quota.has()) {
                akey.a(paramObject.uint32_comm_quota.get(), this.app);
              }
              if (paramObject.uint32_svip_quota.has()) {
                akey.b(paramObject.uint32_svip_quota.get(), this.app);
              }
              akey.b(this.app);
              continue;
                ...
                if ((localObject1 != null) && (((List)localObject1).size() > 0))
                {
                  ...
                  while (((Iterator)localObject1).hasNext())
                  {
                    ...
                    if ((((RemindPB.RemindItem)localObject2).uint64_uin.has()) && (((RemindPB.RemindItem)localObject2).uint32_id.has()))
                    {
                      ...
                      paramObject.add(str);
                      akey.a(str, ((RemindPB.RemindItem)localObject2).uint32_id.get(), this.app);
                    }
                  }
                  akey.a(paramObject, this.app);
                  continue;
                  if (paramObject.rep_clear_uin.has())
                  {
                    ...
                    if ((localObject1 != null) && (((List)localObject1).size() > 0))
                    {
                      ...
                      while (((Iterator)localObject1).hasNext())
                      {
                        ...
                        akey.c((String)localObject2, this.app);
                      }
                      akey.b(paramObject, this.app);
                    }
                  }
                }
              }
    ...
    bfhz.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, alud.a(2131711784), true);
  }
