...
public class aaet
  extends aabs<CertifiedAccountMeta.StComment>
  implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener, IEventReceiver
{
  private static final String jdField_a_of_type_JavaLangString = aaet.class.getSimpleName();
  ...
  private aadr jdField_a_of_type_Aadr;
  protected aaec a;
  private final aafa jdField_a_of_type_Aafa;
  private aafb jdField_a_of_type_Aafb;
  private aafc jdField_a_of_type_Aafc;
  private aafd jdField_a_of_type_Aafd;
  private aafz jdField_a_of_type_Aafz;
  private aagb jdField_a_of_type_Aagb;
  private aagg jdField_a_of_type_Aagg;
  private final Activity jdField_a_of_type_AndroidAppActivity;
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new aaew(this);
  private ViewStub jdField_a_of_type_AndroidViewViewStub;
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new aaev(this);
  public ListView a;
  ...
  public aaet(Activity paramActivity, boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed, aafc paramaafc, ExtraTypeInfo paramExtraTypeInfo)
  {
    super(paramActivity, paramBoolean);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Aafa = new aafa(this);
    wfo.a().registerSubscriber(this.jdField_a_of_type_Aafa);
    this.jdField_a_of_type_Aafc = paramaafc;
  ...
  private aaec a()
  {
    if (this.jdField_a_of_type_Aaec == null)
    {
      this.jdField_a_of_type_Aaec = new aaec();
      this.jdField_e_of_type_Int = this.jdField_a_of_type_Aaec.hashCode();
    }
    return this.jdField_a_of_type_Aaec;
  }
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(a(), 1, a().getResources().getString(2131693957), 0).a();
      return;
    }
  ...
  private void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Aagg == null) {
      this.jdField_a_of_type_Aagg = new aagg((Activity)this.jdField_a_of_type_AndroidContentContext);
    }
    String str2;
    String str1;
    if (paramStReply != null) {
      ...
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692041), new Object[] { paramStReply.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
        ...
        this.jdField_a_of_type_Aagg.b(str1);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Aagg.a(new aaex(this, paramStComment, paramStReply));
      c(paramStComment, paramStReply);
      this.jdField_a_of_type_Aagg.a(paramBoolean2);
      return;
      if ((paramStComment != null) && (paramStComment.postUser != null))
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692041), new Object[] { paramStComment.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
          str1 = str2.substring(0, 10);
      ...
      {
        this.jdField_a_of_type_Aagg.b(this.jdField_a_of_type_AndroidContentContext.getString(2131692036));
      }
    }
  }
  ...
  private void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    for (paramStComment = paramStReply;; paramStComment = str)
    {
      ...
      aain.a(this.jdField_a_of_type_AndroidContentContext, paramStReply);
      return;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Aagg != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Aagg.a());
      }
      return;
      k = 0;
    }
  ...
  private void a(Object[] paramArrayOfObject)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (paramArrayOfObject[3] != null)
                    {
                      ...
                      if (this.jdField_a_of_type_Aafc != null) {
                        this.jdField_a_of_type_Aafc.a((CertifiedAccountRead.StGetFeedDetailRsp)localObject2, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if ((paramArrayOfObject.length >= 6) && (paramArrayOfObject[5] != null))
                      {
                        ...
                        if (((COMM.StCommonExt)localObject1).mapInfo.size() > 0)
                        {
                          ...
                          h();
                          zwp.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), (CertifiedAccountMeta.StReply)localObject1));
                          this.i = true;
                          this.j = true;
                        }
                      }
                    ...
                    for (;;)
                    {
                      ...
                      break;
                      h();
                      zwp.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), null));
                      break;
                      a(new CommentPresenter.12(this));
                      break;
                      QLog.w(jdField_a_of_type_JavaLangString, 1, "get feed detail response failed");
                      if (this.jdField_a_of_type_Aafc != null) {
                        this.jdField_a_of_type_Aafc.a(null, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if (!this.h) {
                  ...
                  if (this.jdField_a_of_type_Aagg != null) {
                    this.jdField_a_of_type_Aagg.b(this.jdField_a_of_type_AndroidWidgetTextView);
                  }
                ...
                if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp))
                {
                  ...
                  if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Aafz != null) && (this.jdField_a_of_type_Aafz.a(String.valueOf(paramArrayOfObject[4])))) {
                    m();
                  }
                  if (localLong.longValue() == 0L)
                  {
                    if ((this.jdField_a_of_type_Aafz != null) && (this.jdField_a_of_type_Aafz.a(String.valueOf(paramArrayOfObject[4]), (CertifiedAccountMeta.StComment)localObject2))) {
                      m();
                    }
                    b(1);
                  }
                }
                a(localLong.longValue(), anni.a(2131701000), (String)localObject1);
              ...
              if ((localLong.longValue() == 0L) && ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp)))
              {
                ...
                if ((this.jdField_a_of_type_Aafz != null) && (this.jdField_a_of_type_Aafz.a(paramArrayOfObject))) {
                  m();
                }
                b(-1);
              }
              a(localLong.longValue(), anni.a(2131700994), anni.a(2131701003));
              return;
            ...
            if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoReplyRsp))
            {
              ...
              if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Aafz != null) && (this.jdField_a_of_type_Aafz.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject))) {
                m();
              }
              if ((localLong.longValue() == 0L) && (this.jdField_a_of_type_Aafz != null) && (this.jdField_a_of_type_Aafz.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject, (CertifiedAccountMeta.StReply)localObject1))) {
                m();
              }
            }
            a(localLong.longValue(), anni.a(2131700993), anni.a(2131701004));
            return;
          } while (a(5, paramArrayOfObject));
          a(localLong.longValue(), anni.a(2131700999), anni.a(2131701006));
      ...
      } while ((localLong.longValue() != 0L) || (this.jdField_a_of_type_Aafz == null) || (TextUtils.isEmpty(paramArrayOfObject)) || (TextUtils.isEmpty((CharSequence)localObject1)));
      this.jdField_a_of_type_Aafz.a(paramArrayOfObject, (String)localObject1);
      m();
      return;
    ...
    label1207:
    for (paramArrayOfObject = this.jdField_a_of_type_Aaec.a((List)localObject1, (String)paramArrayOfObject[5]);; paramArrayOfObject = (Object[])localObject1)
    {
      this.jdField_a_of_type_Aafz.a(paramArrayOfObject);
      m();
      return;
    }
  }
  ...
  {
    if ((paramStUser != null) && (zzz.a() != null) && (paramStUser.id.get().equals(zzz.a().id.get()))) {}
  ...
  private void b(int paramInt)
  {
    ...
    wfo.a().dispatch(new aaep(5, new Object[] { b(), Integer.valueOf(this.jdField_d_of_type_Int) }));
  }
  ...
  private void c(int paramInt)
  {
    ...
    if (paramInt == 0) {
      this.jdField_a_of_type_Aafz.a(a().poster.id.get());
    }
  ...
  private void c(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Aagg.setOnShowListener(new aaey(this, paramStComment, paramStReply));
    this.jdField_a_of_type_Aagg.a(new aaez(this, paramStComment, paramStReply));
  }
  ...
  private void n()
  {
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)a(2131366339));
    this.jdField_b_of_type_AndroidViewView = a(2131364757);
    this.jdField_e_of_type_AndroidViewView = a(2131366340);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131364787));
    this.jdField_c_of_type_AndroidViewView = a(2131364768);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131378525));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131363774);
    ...
    this.jdField_a_of_type_Aafd = new aafd(this);
    this.jdField_a_of_type_Aafz = new aafz(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Aafd);
    this.jdField_a_of_type_Aafz.a(this.jdField_d_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Aafz);
    this.jdField_a_of_type_AndroidWidgetListView.setEmptyView(this.jdField_c_of_type_AndroidViewView);
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new aaeu(this));
    }
  }
  ...
  private void p()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 294	aaet:jdField_a_of_type_Aaec	Laaec;
    //   6: ifnonnull +16 -> 22
    //   9: getstatic 65	aaet:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: iconst_1
    //   13: ldc_w 902
    ...
    //   22: aload_0
    //   23: aload_0
    //   24: invokespecial 307	aaet:a	()Laaec;
    //   27: aload_0
    //   28: invokespecial 329	aaet:b	()Ljava/lang/String;
    //   31: invokevirtual 617	aaec:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   34: putfield 335	aaet:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   37: aload_0
    //   38: aload_0
    //   39: invokespecial 307	aaet:a	()Laaec;
    //   42: aload_0
    //   43: invokespecial 329	aaet:b	()Ljava/lang/String;
    //   46: invokevirtual 905	aaec:a	(Ljava/lang/String;)LNS_COMM/COMM$StCommonExt;
    //   49: putfield 286	aaet:jdField_a_of_type_NS_COMMCOMM$StCommonExt	LNS_COMM/COMM$StCommonExt;
    //   52: aload_0
    //   53: getfield 335	aaet:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   56: ifnull -37 -> 19
    //   59: aload_0
    //   60: getfield 311	aaet:jdField_a_of_type_Aafz	Laafz;
    //   63: ifnull +44 -> 107
    //   66: aload_0
    //   67: getfield 311	aaet:jdField_a_of_type_Aafz	Laafz;
    //   70: invokevirtual 907	aafz:a	()V
    //   73: aload_0
    //   74: getfield 311	aaet:jdField_a_of_type_Aafz	Laafz;
    //   77: aload_0
    //   78: getfield 335	aaet:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   81: invokevirtual 765	aafz:a	(Ljava/util/Collection;)Z
    //   84: pop
    //   85: aload_0
    //   86: getfield 662	aaet:i	Z
    //   89: ifeq +11 -> 100
    //   92: aload_0
    //   93: getfield 311	aaet:jdField_a_of_type_Aafz	Laafz;
    //   96: iconst_0
    //   97: invokevirtual 909	aafz:a	(I)V
    //   100: aload_0
    //   101: getfield 311	aaet:jdField_a_of_type_Aafz	Laafz;
    //   104: invokevirtual 912	aafz:notifyDataSetChanged	()V
    //   107: aload_0
    //   108: getfield 339	aaet:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   111: ifnull +47 -> 158
    //   114: aload_0
    //   115: getfield 97	aaet:jdField_g_of_type_Int	I
    //   118: aload_0
    //   119: invokevirtual 149	aaet:a	()I
    //   122: if_icmpeq +36 -> 158
    //   125: aload_0
    //   126: getfield 662	aaet:i	Z
    //   129: ifeq +29 -> 158
    //   132: aload_0
    //   133: aload_0
    //   134: invokevirtual 149	aaet:a	()I
    //   137: putfield 97	aaet:jdField_g_of_type_Int	I
    //   140: getstatic 65	aaet:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   143: iconst_1
    //   144: ldc_w 914
    //   147: invokestatic 373	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 339	aaet:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   154: iconst_0
    //   155: invokevirtual 917	android/widget/ListView:setSelection	(I)V
    //   158: aload_0
    //   159: getfield 335	aaet:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   162: ifnull -143 -> 19
    //   165: aload_0
    //   166: getfield 335	aaet:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   169: invokevirtual 632	java/util/ArrayList:size	()I
    //   172: ifle -153 -> 19
    //   175: aload_0
    //   176: aload_0
    //   177: invokespecial 307	aaet:a	()Laaec;
    //   180: aload_0
    //   181: invokespecial 329	aaet:b	()Ljava/lang/String;
    //   184: invokevirtual 781	aaec:a	(Ljava/lang/String;)I
    //   187: putfield 131	aaet:jdField_d_of_type_Int	I
    //   190: goto -171 -> 19
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(aafw.a(this.jdField_d_of_type_Int));
          ...
          if (this.jdField_a_of_type_Aafz.getCount() == 0)
          {
            bool = true;
            b(bool);
          }
  ...
  private void r()
  {
    if ((this.jdField_b_of_type_AndroidViewView != null) && (!this.jdField_f_of_type_Boolean))
    {
      ...
      zwp.a().a(new CommentListShowStateEvent(false));
    }
  ...
  public void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    String str = b();
    if ((!bgsp.a(str)) && (a() != null) && (a().vecComment.size() == 0) && (a().commentCount.get() != 0))
    {
  ...
  public void a(aafb paramaafb)
  {
    this.jdField_a_of_type_Aafb = paramaafb;
  }
  
  public void a(aagb paramaagb)
  {
    this.jdField_a_of_type_Aagb = paramaagb;
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_Aagg != null) && (this.jdField_a_of_type_Aagg.isShowing());
  }
  
  protected void e()
  {
    wfo.a().unRegisterSubscriber(this.jdField_a_of_type_Aafa);
    a().a();
    this.jdField_a_of_type_Aaec = null;
  ...
  public void onAnimationStart(Animation paramAnimation)
  {
    ...
    ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).mSystemBarComp.setStatusBarMask(new PorterDuffColorFilter(a().getColor(2131167162), PorterDuff.Mode.SRC_ATOP));
  }
