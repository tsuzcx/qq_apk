  ...
  extends BusinessHandler
{
  ...
  public azff(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg != null) {
          ((azcb)this.mApp.getManager(QQManagerFactory.ONLINE_STATUS_PERMISSION_MANAGER)).a(new OnlineStatusFriendsPermissionItem(paramFromServiceMsg.isAllHasPermission(), paramFromServiceMsg.getPermissionUins()));
        }
        ...
        {
          paramFromServiceMsg = (azbv)this.mApp.getManager(QQManagerFactory.ONLINE_STATUS_MANAGER);
        ...
        this.app.updateOnlineStatus(AppRuntime.Status.online, k);
      }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          paramToServiceMsg = (azbv)this.mApp.getManager(QQManagerFactory.ONLINE_STATUS_MANAGER);
          if (l > 40000L)
          {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((azbv)this.mApp.getManager(QQManagerFactory.ONLINE_STATUS_MANAGER)).a(-1L, j);
          if (!((Boolean)paramToServiceMsg.getAttribute("from_register", Boolean.valueOf(false))).booleanValue())
          {
            this.app.updateOnlineStatus(AppRuntime.Status.online, -1L);
            break label244;
  ...
  private void e(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      if (b == 0)
      {
        ...
        ((azbv)this.mApp.getManager(QQManagerFactory.ONLINE_STATUS_MANAGER)).c();
  ...
  public awpy a(String paramString)
  {
    awpy localawpy2 = awqg.a(paramString, true);
    awpy localawpy1 = localawpy2;
    if (localawpy2 == null) {
  ...
  public void a(azfg paramazfg)
  {
    long l = a().a(this.app);
    if (QLog.isColorLevel()) {
      QLog.d("OnlineStatusHandler", 2, new Object[] { "pushMusicStatus curExtStatus:", Long.valueOf(l), ", ", paramazfg });
    }
    Object localObject = paramazfg;
    if (paramazfg == null) {
      localObject = new azfg();
    }
    if (l == 1028L)
    {
      paramazfg = new StatSvcStatSong.ReqBody();
      paramazfg.bool_need_convert.set(((azfg)localObject).jdField_a_of_type_Boolean);
      paramazfg.uint32_song_type.set(((azfg)localObject).jdField_a_of_type_Int);
      paramazfg.uint32_remaining_time.set(((azfg)localObject).jdField_b_of_type_Int);
      paramazfg.uint32_source_type.set(((azfg)localObject).jdField_c_of_type_Int);
      paramazfg.bytes_song_id.set(ByteStringMicro.copyFromUtf8(((azfg)localObject).jdField_a_of_type_JavaLangString));
      paramazfg.bytes_song_name.set(ByteStringMicro.copyFromUtf8(((azfg)localObject).jdField_b_of_type_JavaLangString));
      paramazfg.bytes_singer_name.set(ByteStringMicro.copyFromUtf8(((azfg)localObject).jdField_c_of_type_JavaLangString));
      paramazfg.bool_pause_flag.set(((azfg)localObject).jdField_b_of_type_Boolean);
      paramazfg.uint32_song_play_time.set(((azfg)localObject).d);
      ...
      ((ToServiceMsg)localObject).putWupBuffer(paramazfg.toByteArray());
  ...
  public void a(QQAppInterface paramQQAppInterface, AppRuntime.Status paramStatus, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    try
    {
      if (paramQQAppInterface.getExtOnlineStatus() != 1000L) {
        paramQQAppInterface.setPowerConnect(azbj.c());
      }
  ...
  public void a(Friends paramFriends)
  {
    ...
    if (azfe.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
    {
      QLog.e("OnlineStatusHandler", 1, "getMusicLyric return, getting status");
      return;
    }
    this.a = paramFriends;
    azfe.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, new awpy(0, 0, null));
  ...
  public void a(MusicInfo paramMusicInfo, int paramInt, boolean paramBoolean, long paramLong)
  {
    ...
    azfg localazfg = new azfg();
    localazfg.jdField_a_of_type_Boolean = true;
    localazfg.jdField_a_of_type_JavaLangString = paramMusicInfo.jdField_a_of_type_JavaLangString;
    localazfg.jdField_b_of_type_JavaLangString = paramMusicInfo.jdField_b_of_type_JavaLangString;
    localazfg.jdField_a_of_type_Int = 1;
    if ((paramMusicInfo.jdField_a_of_type_JavaUtilList != null) && (!paramMusicInfo.jdField_a_of_type_JavaUtilList.isEmpty())) {
      localazfg.jdField_c_of_type_JavaLangString = ((String)paramMusicInfo.jdField_a_of_type_JavaUtilList.get(0));
    }
    localazfg.jdField_b_of_type_Int = paramInt;
    localazfg.jdField_c_of_type_Int = azfe.a().jdField_a_of_type_Int;
    localazfg.jdField_b_of_type_Boolean = paramBoolean;
    localazfg.d = ((int)paramLong);
    a(localazfg);
  }
  ...
  public void a(SongInfo paramSongInfo, int paramInt, boolean paramBoolean, long paramLong)
  {
    ...
    azfg localazfg = new azfg();
    localazfg.jdField_a_of_type_Boolean = false;
    localazfg.jdField_a_of_type_JavaLangString = paramSongInfo.jdField_a_of_type_JavaLangString;
    ...
    {
      localazfg.jdField_a_of_type_JavaLangString = a(paramSongInfo.f);
      if (TextUtils.isEmpty(localazfg.jdField_a_of_type_JavaLangString))
      {
        QLog.d("OnlineStatusHandler", 1, "pushMusicStatus, songMid is null");
        return;
      }
    }
    localazfg.jdField_b_of_type_JavaLangString = paramSongInfo.jdField_c_of_type_JavaLangString;
    localazfg.jdField_a_of_type_Int = 1;
    if (TextUtils.isEmpty(paramSongInfo.h)) {}
    for (paramSongInfo = paramSongInfo.d;; paramSongInfo = paramSongInfo.h)
    {
      localazfg.jdField_c_of_type_JavaLangString = paramSongInfo;
      if (localazfg.jdField_c_of_type_JavaLangString == null) {
        localazfg.jdField_c_of_type_JavaLangString = "";
      }
      localazfg.jdField_b_of_type_Int = paramInt;
      localazfg.jdField_c_of_type_Int = azfe.a().jdField_a_of_type_Int;
      localazfg.jdField_b_of_type_Boolean = paramBoolean;
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          azfe.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(str);
          return;
        }
        ...
        paramFromServiceMsg = new awpy(0, 0, new ArrayList());
        ...
        if (paramToServiceMsg != null) {
          azfe.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, paramToServiceMsg);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if ((bool1) && (this.a != null) && (str.equals(this.a.songId)))
      {
        this.a.songName = "";
        this.a.singerName = "";
        azfe.a().jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(this.a.songId);
        ((FriendListHandler)this.app.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).getOnlineInfo(this.a.uin, false);
      }
    }
  }
  ...
  public void b(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (k == 1)
        {
          paramFromServiceMsg = this.app.getMessageFacade().getCurrChatUin();
          i = j;
          if (paramObject != null)
          {
          ...
          QLog.d("OnlineStatusHandler", 1, new Object[] { "handleRecvMusicStatusPush, uin:", StringUtil.getSimpleUinForPrint(paramObject), " currentChatUin:", StringUtil.getSimpleUinForPrint(paramFromServiceMsg), " needRefresh:", Integer.valueOf(k), " isContactShown:", Boolean.valueOf(bool) });
          return;
        }
      }
      catch (Exception paramFromServiceMsg)
