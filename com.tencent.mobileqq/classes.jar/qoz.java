...
public class qoz
{
  private static qoz jdField_a_of_type_Qoz;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new qpa(this, "Module_VideoFeedsIPCServer");
  private List<qpb> jdField_a_of_type_JavaUtilList = new Vector();
  ...
  public static qoz a()
  {
    if (jdField_a_of_type_Qoz == null) {}
    try
    {
      jdField_a_of_type_Qoz = new qoz();
      return jdField_a_of_type_Qoz;
    }
    finally {}
  }
  ...
  public void a(qpb paramqpb)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramqpb);
      return;
    }
  }
  
  public void b(qpb paramqpb)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramqpb);
      return;
    }
  }
}
