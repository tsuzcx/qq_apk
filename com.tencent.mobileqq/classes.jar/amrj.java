  ...
  implements ampc<String>
{
  ...
  public ConcurrentHashMap<String, altl> a;
  public boolean a;
  public String b;
    ...
    try
    {
      ...
      if ((localObject1 != null) && (((JSONArray)localObject1).length() > 0))
      {
        ...
        if (i < ((JSONArray)localObject1).length())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            localObject3 = new altl();
            ((altl)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject2);
            ((altl)localObject3).jdField_a_of_type_Int = k;
