  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (TextUtils.isEmpty(azxu.a(this.a)))
    {
    ...
    for (;;)
    {
      ...
      {
        if (((String)paramContext.get(i)).equals(azxu.a(this.a)))
        {
          azxu.a(this.a, (String)paramIntent.get(i));
          j = 1;
        }
      }
      else
      {
        if ((j == 0) || (!azxu.a(this.a))) {
          break;
        }
        azxu.a(this.a, azxu.b(this.a));
        return;
      }
      i += 1;
    }
