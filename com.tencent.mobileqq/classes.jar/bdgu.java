...
public class bdgu
{
  ...
  public static void a(Context paramContext, DownloadInfo paramDownloadInfo)
  {
    ...
    {
      return;
      axtn.a().addDownloadURL(paramDownloadInfo.jdField_d_of_type_JavaLangString);
    ...
    localHashMap.put("NetworkType", bbev.b(paramContext) + "");
    Object localObject1;
    if (a(paramContext)) {
      localObject1 = "1";
    }
    ...
    for (;;)
    {
      ...
      {
        axrl.a(paramContext).a(null, "UniformDownloadEvent_NO_SOURCE", true, 0L, 0L, localHashMap, "");
        ...
        {
          axqw.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
          if (!QLog.isColorLevel()) {
            break label1158;
          }
      ...
      label943:
      axrl.a(paramContext).a(null, "UniformDownloadEvent", true, 0L, 0L, localHashMap, "");
      paramDownloadInfo = (String)localHashMap.get("isForeground");
      localObject1 = (String)localHashMap.get("isAPK");
      localObject2 = ((StringBuilder)localObject2).toString();
      localObject3 = new StringBuilder().append((String)localHashMap.get("Stack"));
      ...
      for (paramContext = (String)localHashMap.get("Stack1");; paramContext = "")
      {
        axqw.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
        break label598;
        label1158:
        break;
      }
  ...
  public static void a(Context paramContext, WadlParams paramWadlParams)
  {
    ...
    axtn.a().addDownloadURL(paramWadlParams.jdField_b_of_type_JavaLangString);
    HashMap localHashMap = new HashMap();
