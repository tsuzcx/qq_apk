  ...
  extends bcgx
{
  ...
  private TextViewWrapLayout a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(this.c)) {
      paramContext.setBackgroundResource(2130839475);
    }
    d(paramContext);
    return paramContext;
  }
  ...
  private void a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    int m = localResources.getDimensionPixelSize(2131298978);
    int n = localResources.getDimensionPixelSize(2131298979);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      Object localObject11 = (bcgw)((Iterator)localObject10).next();
      if ((localObject11 instanceof bciz))
      {
        localObject11 = (bciz)localObject11;
        if (((bciz)localObject11).t == bciz.s) {
          ((bciz)localObject11).t = bciz.q;
        }
      }
    }
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      localObject4 = (bcgw)((Iterator)localObject9).next();
      ((bcgw)localObject4).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      localObject5 = ((bcgw)localObject4).jdField_a_of_type_JavaLangString;
      if ((("picture".equals(localObject5)) || ("vote".equals(localObject5)) || ("video".equals(localObject5))) && (localObject3 == null)) {
        localObject3 = ((bcgw)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131368518), paramBundle);
      }
    }
    for (;;)
    {
      ...
      if (("title".equals(localObject5)) && (localObject2 == null))
      {
        ...
        localObject2 = (TextView)((bcgw)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131379877), paramBundle);
      }
      else if (localObject1 == null)
      {
        if (("summary".equals(localObject5)) || ("timer".equals(localObject5)))
        {
          localObject1 = (TextView)((bcgw)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131379856), paramBundle);
        }
        else if ("checklist".equals(localObject5))
        {
          paramView = (LinearLayout)((bcgw)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131379517), paramBundle);
          continue;
          ...
          {
            localObject5 = (bcgw)((Iterator)localObject10).next();
            ((bcgw)localObject5).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject6 = ((bcgw)localObject5).jdField_a_of_type_JavaLangString;
            if ((("picture".equals(localObject6)) || ("vote".equals(localObject6)) || ("video".equals(localObject6))) && (localObject3 == null)) {
              localObject3 = ((bcgw)localObject5).a(paramContext, null, paramBundle);
            }
          }
          for (;;)
          {
            ...
            if (("title".equals(localObject6)) && (localObject2 == null))
            {
              ...
              localObject2 = (TextView)((bcgw)localObject5).a(paramContext, null, paramBundle);
            }
            else if (localObject1 == null)
            {
              if (("summary".equals(localObject6)) || ("timer".equals(localObject6)))
              {
                localObject1 = (TextView)((bcgw)localObject5).a(paramContext, null, paramBundle);
              }
              else if ("checklist".equals(localObject6))
              {
                paramView = (LinearLayout)((bcgw)localObject5).a(paramContext, null, paramBundle);
                continue;
                ...
                if ((this.o == 1) || (this.o == 3)) {
                  if (this.o == 1)
                  {
                    ...
                    if (localObject6 != null)
                    {
                      ...
                      i = k;
                      if ((paramContext instanceof bclv))
                      {
                        paramContext = (bclv)paramContext;
                        i = k;
                        if (paramContext != null)
                        {
                          if (TextUtils.isEmpty(paramContext.b())) {
                    ...
                    if (!(paramContext instanceof bcmn)) {
                      break label1809;
                    }
                    paramContext = ((bcmn)paramContext).jdField_a_of_type_JavaUtilArrayList;
