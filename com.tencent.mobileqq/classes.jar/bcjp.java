...
public class bcjp
  extends bcka
{
  public bcjp(OpenSdkVirtualManager.2 param2) {}
  
  protected void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    QLog.d("OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.deleteVirtual.result:", paramString1 });
    apmt.a("KEY_DELETE_VIRTUAL_D18", this.a.jdField_a_of_type_Bciz, paramBoolean);
    int i = paramInt;
    if (paramBoolean) {}
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          if (this.a.jdField_a_of_type_Bcjw != null) {
            this.a.jdField_a_of_type_Bcjw.a(paramBoolean, paramInt);
          }
          return;
        }
      }
