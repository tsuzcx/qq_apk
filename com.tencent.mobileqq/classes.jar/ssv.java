  ...
  implements ajte
{
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    label58:
    label68:
    for (String str = ajya.a(2131710972);; str = ajya.a(2131710970))
    {
      bdis.a().a(paramString + str + ajya.a(2131710973));
      return;
      paramString = ajya.a(2131710971);
      break;
    }
  }
              ...
              do
              {
                do
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    localObject1 = ((tdl)localObject3).b(((UserInfo)localObject2).uid);
                  ...
                  for (paramInt = i;; paramInt = 0)
                  {
                    ...
                    ((tdl)localObject3).a(paramObject);
                  ...
                  if (paramBoolean)
                  {
                    Bosses.get().postJob(new ssw(this, "QQStoryObserver", paramObject, (Boolean)localObject1, paramBoolean, paramInt));
                    return;
                  }
                  localObject1 = ((tdl)tcz.a(2)).b(paramObject);
                  if (localObject1 != null)
                  {
