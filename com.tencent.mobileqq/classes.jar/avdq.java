  ...
  implements Handler.Callback, SimpleEventReceiver, Observer
{
  ...
  public static avdq a()
  {
    if (jdField_a_of_type_Avdq == null) {}
    try
    {
      if (jdField_a_of_type_Avdq == null) {
        jdField_a_of_type_Avdq = new avdq();
      }
      return jdField_a_of_type_Avdq;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    label61:
    while ((!((GameArkView)localObject).a()) || (!aves.a(((GameArkView)localObject).a()))) {
      return;
    }
    try
    {
  ...
  public void a(int paramInt)
  {
    ...
    albi.a().a("com.tencent.gamecenter.newvideo");
    albi.a().addObserver(this);
  }
  ...
  public void e()
  {
    ...
    albi.a().b("gc_ark_video_play");
    albi.a().deleteObserver(this);
    this.b = null;
    this.jdField_a_of_type_MqqUtilWeakReference = null;
    jdField_a_of_type_Avdq = null;
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    try
    {
      if ((paramObject instanceof albk))
      {
        paramObservable = ((albk)paramObject).jdField_a_of_type_JavaLangString;
        String str = ((albk)paramObject).b;
        paramObject = ((albk)paramObject).c;
