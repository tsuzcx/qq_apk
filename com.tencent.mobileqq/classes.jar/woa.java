...
{
  public woa(C2CMessageSearchDialog paramC2CMessageSearchDialog) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (paramEditable.length() == 0)
    {
      ...
      this.a.findViewById(2131368256).setVisibility(8);
    ...
    String str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131433796, new Object[] { paramEditable });
    int i = str.indexOf(paramEditable);
    SpannableString localSpannableString = new SpannableString(str);
    localSpannableString.setSpan(new ForegroundColorSpan(2131494257), 0, i, 18);
    localSpannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#0079ff")), i, paramEditable.length() + i, 34);
    localSpannableString.setSpan(new ForegroundColorSpan(2131494257), paramEditable.length() + i, str.length(), 33);
    this.a.jdField_a_of_type_AndroidWidgetTextView.setText(localSpannableString);
    C2CMessageSearchDialog.a(this.a, 1, null);
    this.a.findViewById(2131368256).setVisibility(0);
