...
public class tgk
  extends syv<tgl>
{
  static final String a = sxp.a("StorySvc.msgtab_node_click");
  public long b;
  public String b;
  public int c;
  ...
  public syq a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new tgl(localRspMsgTabNodeWatched);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      veg.d("Q.qqstory.msgTab:ReqMsgTabNodeClick", "" + paramArrayOfByte);
    }
    return null;
  }
