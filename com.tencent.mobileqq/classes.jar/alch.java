...
public class alch
{
  ...
  public alch(SkinInfo paramSkinInfo)
  {
  ...
  public alch(String paramString)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_a_of_type_WalletSkinInfo = new SkinInfo();
  ...
  public static int a(List<alch> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      alch localalch = (alch)paramList.next();
      if (c == localalch.jdField_a_of_type_WalletSkinInfo.skin_id) {
        return localalch.jdField_a_of_type_WalletSkinInfo.skin_id;
      }
    }
    return -1;
  }
  
  public static void a(List<alch> paramList)
  {
    Collections.sort(paramList, new alci());
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof alch)) {
        break;
      }
    } while (this.jdField_a_of_type_WalletSkinInfo.skin_id == ((alch)paramObject).jdField_a_of_type_WalletSkinInfo.skin_id);
    return false;
