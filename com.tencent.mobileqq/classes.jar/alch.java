  ...
  implements Handler.Callback, Manager
{
  ...
  public String a;
  private Vector<WeakReference<alcv>> jdField_a_of_type_JavaUtilVector = new Vector();
  private boolean jdField_a_of_type_Boolean;
  private Handler b;
  
  public alch(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaLangString = albv.a();
    this.jdField_a_of_type_Aukp = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager();
    ThreadManager.post(new ArResourceManager.1(this), 8, null, true);
    this.jdField_a_of_type_Alcd = new alcd(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this);
  }
  ...
  public ArDownloadInfo a(String paramString)
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 102	alch:jdField_a_of_type_Aukp	Laukp;
    //   21: ldc 167
    //   23: aload_1
    //   24: invokevirtual 172	aukp:a	(Ljava/lang/Class;Ljava/lang/String;)Lauko;
    ...
    for (;;)
    {
      try
      {
        if (paramInt2 < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((alcv)((WeakReference)localObject1).get()).a(paramInt1);
          }
        }
        else
        {
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((alcv)((WeakReference)localObject1).get()).a(paramLong1, paramLong2);
          }
        }
        else
        {
  ...
  {
    if (paramalcv != null) {
      this.jdField_a_of_type_JavaUtilVector.add(new WeakReference(paramalcv));
    }
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          ((alcv)((WeakReference)localObject2).get()).a(paramArConfigInfo);
          break label600;
        }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          ((alcv)((WeakReference)localObject).get()).a(paramArEffectConfig);
          break label134;
        }
        return;
      }
  ...
  public void a(ArDownloadInfo paramArDownloadInfo)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 102	alch:jdField_a_of_type_Aukp	Laukp;
    //   13: invokevirtual 388	aukp:a	()Laukr;
    //   16: astore_2
    //   17: aload_2
    //   18: invokevirtual 391	aukr:a	()V
    //   21: aload_0
    //   22: getfield 102	alch:jdField_a_of_type_Aukp	Laukp;
    //   25: aload_1
    //   26: invokevirtual 394	aukp:b	(Lauko;)V
    //   29: aload_2
    //   30: invokevirtual 396	aukr:c	()V
    //   33: aload_2
    //   34: invokevirtual 397	aukr:b	()V
    //   37: goto -31 -> 6
    //   40: astore_1
    //   41: aload_0
    //   42: monitorexit
    ...
    //   56: aload_2
    //   57: invokevirtual 397	aukr:b	()V
    //   60: goto -54 -> 6
    //   63: astore_1
    //   64: aload_2
    //   65: invokevirtual 397	aukr:b	()V
    //   68: aload_1
    //   69: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      {
        paramString.a();
        this.jdField_a_of_type_Aukp.a(localArDownloadInfo);
        paramString.c();
        paramString.b();
        continue;
        label133:
  ...
  public boolean a()
  {
    boolean bool1 = false;
    boolean bool2 = true;
    if (this.jdField_a_of_type_Albw == null) {}
    for (int i = 3; i == 1; i = this.jdField_a_of_type_Albw.a) {
      return true;
    }
  ...
  public boolean a(ArConfigInfo paramArConfigInfo)
  {
    ...
    //   34: aload_1
    //   35: aload_0
    //   36: getfield 34	alch:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   48: aload_0
    //   49: aload_1
    //   50: putfield 131	alch:jdField_a_of_type_ComTencentMobileqqArAidlArConfigInfo	Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;
    //   53: iconst_1
    //   54: istore_2
    //   55: aload_0
    //   56: monitorexit
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return bool1;
        i = this.jdField_a_of_type_Albw.b;
        break;
        j = this.jdField_a_of_type_Albw.c;
        break label55;
      }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArAidlArEffectConfig != null)
    {
      ...
      akxb.a().a(this.jdField_a_of_type_ComTencentMobileqqArAidlArEffectConfig);
    }
    ArEffectConfig.a();
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          else if (((WeakReference)localObject).get() == paramalcv)
          {
  ...
  public void b(ArConfigInfo paramArConfigInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        if (!bbfj.d(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp()))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  {
    if (this.jdField_a_of_type_Albw == null) {}
    for (int i = 1; i == 1; i = this.jdField_a_of_type_Albw.e) {
      return true;
    }
    return false;
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Albw == null)
    {
      this.jdField_a_of_type_Albw = new albw();
    ...
    try
    {
      ...
      this.jdField_a_of_type_Albw.a = Integer.valueOf(localObject[4]).intValue();
      this.jdField_a_of_type_Albw.b = Integer.valueOf(localObject[5]).intValue();
      this.jdField_a_of_type_Albw.c = Integer.valueOf(localObject[6]).intValue();
      this.jdField_a_of_type_Albw.jdField_d_of_type_Int = Integer.valueOf(localObject[7]).intValue();
      this.jdField_a_of_type_Albw.e = Integer.valueOf(localObject[8]).intValue();
      i = 0;
    }
    catch (Exception localException)
    {
    ...
    if (i != 0)
    {
      this.jdField_a_of_type_Albw.a = 3;
      this.jdField_a_of_type_Albw.b = 3;
      this.jdField_a_of_type_Albw.c = 1000;
      this.jdField_a_of_type_Albw.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_Albw.e = 1;
    }
    if (this.jdField_a_of_type_Albw.jdField_d_of_type_Int == 1)
    {
      augv.a(bool);
      if (QLog.isColorLevel()) {
        QLog.d("ArConfig_ArResourceManager", 2, "loadDPCConfig|dpc:" + this.jdField_a_of_type_Albw.toString());
      }
      return;
    }
  }
  ...
  public int d()
  {
    ...
    return this.jdField_a_of_type_Albw.a;
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((alcv)((WeakReference)localObject1).get()).b();
          }
        }
        else
        {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      albv.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, i);
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        for (paramMessage = "1";; paramMessage = "0")
        {
          ...
          axrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), "olympic_ar_native_so_report", bool1, 0L, 0L, (HashMap)localObject, null);
        ...
        for (;;)
        {
          try
          {
            ...
            if (bbdx.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.c)) {
              break label432;
            }
            bool1 = false;
            albv.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, bool2);
          ...
          {
            bool1 = bbdx.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f);
            if (!bool1)
            {
              bool1 = true;
              bool2 = false;
