  ...
  implements Handler.Callback
{
  ...
  private bril jdField_a_of_type_Bril;
  private int b;
  private int c;
  
  public brik(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bril != null) {
        this.jdField_a_of_type_Bril.a(this.jdField_a_of_type_Bril, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
