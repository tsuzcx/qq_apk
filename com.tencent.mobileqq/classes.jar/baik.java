...
public class baik
{
  ...
  public baik(View paramView, int paramInt, baim parambaim)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Baim = parambaim;
    b();
  }
  ...
  public static int a(int paramInt)
  {
    int i;
    if (paramInt == 0) {
      i = aciy.a(210.0F, BaseApplicationImpl.getContext().getResources());
    }
    do
    {
      return i;
  ...
  private static int b()
  {
    ...
    if (bepu.a(localBaseApplication)) {
      i = bepu.a(localBaseApplication);
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bail(this);
  }
  ...
  public int a()
  {
    ...
    if (localSharedPreferences.contains("key_height"))
    {
      ...
      this.jdField_a_of_type_Baim.a(i, true);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
