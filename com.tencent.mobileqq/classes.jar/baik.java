...
public class baik
{
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          paramQQAppInterface = localaukn.a(TroopAIONotifyItem.class, false, "troopUin=?", new String[] { paramString }, null, null, null, null);
          localaukn.a();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localakhq.e(Long.valueOf(paramString).longValue());
      balq.a(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localakhq), 8, null, true);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    ...
    //   21: return
    //   22: aload_0
    //   23: invokevirtual 22	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lauko;
    //   26: invokevirtual 28	auko:createEntityManager	()Laukn;
    //   29: astore_0
    //   30: iconst_0
    //   31: istore_2
    //   32: iload_2
    ...
    //   45: checkcast 239	aukm
    //   48: invokevirtual 241	aukn:b	(Laukm;)Z
    //   51: pop
    //   52: iload_2
    //   53: iconst_1
    //   54: iadd
