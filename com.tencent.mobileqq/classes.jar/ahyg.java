...
public class ahyg
  extends amab
{
  public ahyg(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  {
    if (!bdal.a(String.valueOf(paramLong1), this.a.jdField_c_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localahyq.a = (localGroupFeeMember.uint64_uin.get() + "");
      localahyq.b = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Ahzg != null) {
        this.a.jdField_a_of_type_Ahzg.a(localahyq);
      }
  ...
  protected void b(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.isHomeworkTroop()))
    {
      ...
      this.a.g = bclo.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo, paramList, false);
      paramList = this.a;
