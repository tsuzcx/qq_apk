...
public class txh
{
  private static final String jdField_a_of_type_JavaLangString = txh.class.getName();
  private static txh jdField_a_of_type_Txh;
  ...
  public static txh a()
  {
    if (jdField_a_of_type_Txh == null) {
      jdField_a_of_type_Txh = new txh();
    }
    return jdField_a_of_type_Txh;
  }
