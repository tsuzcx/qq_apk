...
public class anlk
{
  ...
  public static int a(int paramInt, String paramString)
  {
    ...
    paramString = new File(annv.g, paramInt + "/" + paramString + "/");
    ...
    for (;;)
    {
      ...
      int i = awxv.a(localObject.length);
      ...
      try
      {
        ...
        if (paramInt >= annv.jdField_a_of_type_Int) {
          if (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/action/" + annv.R)) {
            continue;
          }
        }
        for (;;)
        {
          return j;
          if ((!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + annv.x)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + annv.w)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + annv.y))) {
            break;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((amsx)paramQQAppInterface.getManager(153)).a(paramString);
    if (paramString == null)
    {
      if (QLog.isColorLevel()) {
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(annv.F);
      localStringBuilder.append("/");
      localStringBuilder.append(paramInt2);
      localStringBuilder.append("/dress");
      return localStringBuilder.toString();
  ...
  public static String a(String paramString)
  {
    ...
    int i = awxv.a(paramString.countTokens());
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (amsx.a(paramQQAppInterface, paramString) == 2) {
      return "3D";
    }
    return "2D";
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      localObject = ((annx)paramQQAppInterface.getManager(155)).a(paramSpriteTaskParam.f);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      localObject = new File(annv.c + (String)localObject);
      if (!((File)localObject).exists())
      {
        QLog.d("ApolloActionHelper", 1, new Object[] { "[checkBasicActionExit] rsc file not exist:", ((File)localObject).toString() });
        aniv.a(paramQQAppInterface, paramQQAppInterface.c(), null, 0, null, -1, -1, true);
        return false;
      }
      i += 1;
    }
  ...
  public static boolean a(String paramString, int paramInt, int[] paramArrayOfInt, QQAppInterface paramQQAppInterface, anje paramanje)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (!bool)
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            paramanje = ((amsx)paramQQAppInterface.getManager(153)).a();
          }
        }
        for (;;)
        {
          aniv.a(paramQQAppInterface, paramString, paramanje, paramInt, paramArrayOfInt, -1, -1, false);
          if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString1, QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString2)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((amsx)paramQQAppInterface.getManager(153)).b(paramString1);
  ...
  public static Object[] a(String paramString, int paramInt, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject = ((amsx)paramQQAppInterface.getManager(153)).b(paramString);
    if (localObject != null)
    {
      localObject = ((ApolloBaseInfo)localObject).getApolloDress3D();
      if (localObject != null)
      {
        paramInt = ((amxm)localObject).jdField_a_of_type_Int;
        localObject = ((amxm)localObject).a();
        if ((paramInt > annv.jdField_a_of_type_Int) && (localObject != null) && (localObject.length > 0) && ((!paramBoolean) || (a(paramString, paramInt, (int[])localObject, paramQQAppInterface))))
        {
          if (QLog.isColorLevel()) {
  ...
  public static Object[] a(String paramString, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject2 = ((amsx)paramQQAppInterface.getManager(153)).b(paramString);
      ...
      if (amsx.a((ApolloBaseInfo)localObject2)) {
        break label301;
      }
      return new Object[] { Integer.valueOf(i), localObject1 };
      if (angb.b(paramQQAppInterface, paramString))
      {
        localObject1 = "-2";
        break;
      }
    ...
    if ((paramBoolean) && (((ApolloBaseInfo)localObject2).apolloLocalTS != ((ApolloBaseInfo)localObject2).apolloServerTS))
    {
      ...
      amsx.a(paramQQAppInterface, paramString, "getRoleDressIdByUin");
    }
    ...
    for (int j = 1;; j = 0)
    {
      if (j == 0)
      {
        localObject2 = aniv.a(localObject3[0].jdField_a_of_type_Int);
        ...
        if (QLog.isColorLevel())
        {
          ...
          for (;;)
          {
            if (i < paramQQAppInterface.length)
            {
              ...
              j += 1;
              break;
              angi.a(110, new Object[] { "basicDresses is not vaild" });
  ...
  public static String[] a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      ...
      default: 
        ...
        if ((paramBoolean) || (paramInt2 < 21)) {
          if (localStringBuilder.indexOf(annv.u) > -1) {
            localStringBuilder.append("/action");
          }
        }
        break;
    ...
    for (;;)
    {
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(annv.u);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      ...
      break label177;
      if (paramInt4 != 0) {
        localStringBuilder.append(annv.u).append(annv.G);
      }
      for (;;)
      {
        paramInt3 = 1;
        paramInt4 = 1;
        break;
        localStringBuilder.append("def/basic/").append(annv.G);
      }
      localStringBuilder.append(annv.u).append(annv.G);
      paramInt3 = 1;
      paramInt4 = 1;
      break label177;
      int i = a(paramInt3, annv.G);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(annv.G);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(annv.u).append(annv.I);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(annv.I);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      if (paramInt4 != 0)
      {
        localStringBuilder.append(annv.u).append(annv.K);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(annv.K);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      i = a(paramInt3, annv.H);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(annv.H);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
  ...
  public static String b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((amsx)paramQQAppInterface.getManager(153)).b(paramString);
    if (paramString != null)
    {
