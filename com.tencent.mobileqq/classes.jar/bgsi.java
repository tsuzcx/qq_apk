...
public class bgsi
  implements bgsq
{
  public bgsi(QQPimBridgeActivity paramQQPimBridgeActivity) {}
  
  public void a()
  {
    if (QLog.isColorLevel()) {
      QLog.i(bgsj.a, 2, "QQPimBridgeActivity.hasInstalled()");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i(bgsj.a, 2, "QQPimBridgeActivity.downloadError()");
    }
