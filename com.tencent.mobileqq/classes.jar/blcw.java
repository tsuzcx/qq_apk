...
{
  public blcw(AEVideoShelfEditFragment paramAEVideoShelfEditFragment) {}
  ...
  protected void a(Void paramVoid)
  {
    ...
    {
      blfg.c("AEVideoShelfEditFrag", "init NodeGroup Error!");
      return;
    }
    ...
    AEVideoShelfEditFragment.a(this.a, new blee(this.a.getActivity(), paramVoid, AEVideoShelfEditFragment.a(this.a).getVideoWidth(), AEVideoShelfEditFragment.a(this.a).getVideoHeight()));
