  ...
  public static Intent a(Intent paramIntent, Bundle paramBundle, Activity paramActivity)
  {
    ...
    do
    {
      ...
      if (paramBundle.getString("widgetinfo") != null)
      {
        ...
        paramIntent.putExtra("qq_camera_scheme", bkuq.a(paramBundle.getString("widgetinfo")));
      ...
      if ((localObject == null) || (((ViewGroup)localObject).findViewById(2131378957) == null)) {
        break;
      }
      localObject = (LinkerSummaryView)((ViewGroup)localObject).findViewById(2131378957);
    } while ((localObject == null) || (((LinkerSummaryView)localObject).jdField_a_of_type_Bkja == null));
    paramIntent.putExtra("share_url_target_url", ((LinkerSummaryView)localObject).jdField_a_of_type_Bkja.jdField_a_of_type_JavaLangString);
    paramIntent.putExtra("share_url_name", ((LinkerSummaryView)localObject).jdField_a_of_type_Bkja.b);
    paramIntent.putExtra("share_url_text", ((LinkerSummaryView)localObject).jdField_a_of_type_Bkja.c);
    paramIntent.putExtra("share_url_thumb_url", ((LinkerSummaryView)localObject).jdField_a_of_type_Bkja.d);
