  ...
  implements ajfi, ajfm
{
  ...
  public ajff(ajez paramajez, ajfo paramajfo)
  {
  ...
  public void a()
  {
    ...
    if ((this.jdField_b_of_type_Int > 0) && (this.jdField_a_of_type_Ajez != null)) {
      VipUtils.a(this.jdField_a_of_type_Ajez.a(), "cmshow", "Apollo", "play_times", ApolloUtil.b(this.jdField_a_of_type_Ajez.jdField_a_of_type_Int), 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), this.jdField_a_of_type_Ajez.jdField_a_of_type_JavaLangString });
    }
  ...
  {
    if ((paramajfn != null) && (this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null))
    {
      if (this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramajfn)) {
    ...
    this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramajfn);
  }
  
  public void a(SpriteTaskParam paramSpriteTaskParam)
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_Ajez == null)) {
      QLog.w("cmshow_scripted_SpriteTaskHandler", 1, "[addTask], fail. null param");
    }
    do
    {
      return;
      if ((1 == this.jdField_a_of_type_Ajez.d) && (paramSpriteTaskParam.g != 1))
      {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, paramSpriteTaskParam);
        if ((this.jdField_a_of_type_Ajfo instanceof SpriteUIHandler)) {
          ((SpriteUIHandler)this.jdField_a_of_type_Ajfo).a(false, true, null);
        }
        localObject1 = this.jdField_a_of_type_Ajez.a();
        localObject2 = Integer.toString(ApolloUtil.b(this.jdField_a_of_type_Ajez.jdField_a_of_type_Int));
    ...
    int i = ApolloUtil.b(this.jdField_a_of_type_Ajez.jdField_a_of_type_Int);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Ajfo != null) {
      this.jdField_a_of_type_Ajfo.a(paramString, paramString.jdField_a_of_type_Long);
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localajfn != null) {
        localajfn.a(paramString, paramString.jdField_a_of_type_Long);
      }
    }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Ajfo != null) {
      this.jdField_a_of_type_Ajfo.a(paramString, paramString.jdField_a_of_type_Long, paramInt2);
    }
    ...
    while (localIterator.hasNext())
    {
      ajfn localajfn = (ajfn)localIterator.next();
      if (localajfn != null) {
        localajfn.a(paramString, paramString.jdField_a_of_type_Long, paramInt2);
      }
    }
    a(paramInt1);
  }
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Ajez == null) || (!this.jdField_a_of_type_Ajez.c()))
    {
