...
public class ajff
  extends ajgl<CameraEmotionData>
{
  private ConcurrentHashMap<Integer, CameraEmotionData> a = new ConcurrentHashMap();
  
  public ajff(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((anbh)this.app.getManager(334)).a(localCameraEmotionData);
          ...
          paramToServiceMsg = awrn.a(BaseApplication.getContext());
          if (i != 0) {
            break label643;
          }
          bool = true;
  ...
  private void a(List<CameraEmotionRoaming_sso.ImgInfo> paramList, List<ajfg> paramList1, List<String> paramList2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!baip.a(str4))
      {
        ...
        paramList = "";
        label134:
        localajfg.b = paramList;
        if (str2 != null) {
          break label233;
        }
        paramList = "";
        label148:
        localajfg.c = paramList;
        if (str3 != null) {
          break label239;
        }
      }
  ...
  public void a()
  {
    ...
    String str = ((anbh)this.app.getManager(334)).a();
    ...
    localReqBody.bytes_version.set(ByteStringMicro.copyFrom("8.2.6".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).bytes_version.set(ByteStringMicro.copyFrom("8.2.6".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, boolean paramBoolean)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).bytes_version.set(ByteStringMicro.copyFrom("8.2.6".getBytes()));
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    paramList.bytes_version.set(ByteStringMicro.copyFrom("8.2.6".getBytes()));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    case 3: 
      if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
      {
        ...
        for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
        {
          ...
          arnz.e(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
          return;
        }
        arnz.d("3002", 2);
        return;
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
      {
        ...
        arnz.d(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
        return;
      }
      arnz.d("3003", 2);
      return;
