...
class aktf
  implements absf
{
  aktf(akta paramakta, String paramString, long paramLong) {}
  ...
  public void onSuccess(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject1 = akro.a(akta.a(this.jdField_a_of_type_Akta));
          if (localObject1 == null)
          {
            QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + akta.a(this.jdField_a_of_type_Akta));
            return;
          }
          localObject1 = ((aktr)localObject1).a();
          localObject2 = new akqa(paramJSONObject.optString("avatarUrl"), paramJSONObject.optString("nickName"), ((CmGameInitParams)localObject1).openId);
          akta.a(this.jdField_a_of_type_Akta).put(((CmGameInitParams)localObject1).openId, localObject2);
      ...
      if ("cs.get_app_friends.local".equals(this.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((paramJSONObject != null) && (paramJSONObject.length() != 0))
        {
          ...
          while (i < j)
          {
            ...
            localObject3 = new akqa(((JSONObject)localObject2).optString("avatarUrl"), ((JSONObject)localObject2).optString("nickName"), (String)localObject3);
            akta.a(this.jdField_a_of_type_Akta).put(((JSONObject)localObject2).optString("openid"), localObject3);
