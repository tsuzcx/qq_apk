  ...
  implements Handler.Callback
{
  ...
  private void b()
  {
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Akzu.c();
        this.jdField_a_of_type_Akzu = null;
      }
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Akzu != null) {
          this.jdField_a_of_type_Akzu.a(2);
        }
      }
    }
  }
  ...
  private void b(long paramLong)
  {
    ...
    catch (Exception localException)
    {
      ...
      this.jdField_a_of_type_Akzu.a(4);
    }
  }
  ...
  private void b(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Akzu.a(3);
    }
  }
  ...
  public void a(avyy paramavyy, akzu paramakzu)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoEncoderCore.a(paramavyy, paramakzu);
      if (this.jdField_a_of_type_Akzu != null) {
        this.jdField_a_of_type_Akzu.a();
      }
      return;
    }
    catch (Exception paramavyy)
    {
      for (;;)
      {
        QLog.e("VideoEncoder", 1, "startRecording start encoder fail.", paramavyy);
        if (this.jdField_a_of_type_Akzu != null) {
          this.jdField_a_of_type_Akzu.a(1);
        }
      }
    }
  }
