  ...
  implements avja, avuz<aooz>
{
  ...
  private avva<aooz> jdField_a_of_type_Avva;
  ...
  private List<avin> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean;
  private List<aysk> jdField_c_of_type_JavaUtilList;
  private boolean jdField_c_of_type_Boolean;
  private volatile boolean d = true;
  
  public aoov(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, int paramInt, aoor paramaoor)
  {
    this.jdField_a_of_type_Ajey = new aoow(this);
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong, List<Long> paramList, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      ((ajex)paramQQAppInterface.a(22)).a("GroupFileAppSvr.GetFileSearch", paramList.toByteArray(), (Bundle)localObject);
  ...
  private void a(boolean paramBoolean, List<aysk> paramList)
  {
  ...
  private void b(String paramString)
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aviv = null;
      label96:
      QLog.i("TroopFileSearchEngine<QFile>", 4, "execSearch. success.");
      this.jdField_a_of_type_Aviv = new aviv(paramString, paramString, this.jdField_b_of_type_JavaUtilList, this);
      this.jdField_a_of_type_Aviv.a();
    }
  }
  ...
  public List<aooz> a(avvn paramavvn)
  {
    return null;
  }
  ...
  public void a(avvn paramavvn, avva<aooz> paramavva)
  {
