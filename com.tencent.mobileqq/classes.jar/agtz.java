  ...
  implements agvc, agvp
{
  ...
  public agtz(aguw paramaguw, BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_Long = bhlo.i();
    this.b = bhlo.j();
    paramaguw.a(this);
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (paramInt = i;; paramInt = 0)
    {
      ...
      anfr localanfr = angi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localanfr != null) {
        localanfr.a(this.jdField_a_of_type_Long, this.b, angi.b(), angi.a());
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Amuy == null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Amuy = new amuy();
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Amuy.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
      return;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      localObject = bdow.a(paramIntent.getByteArrayExtra("stuctmsg_bytes"));
      if (localObject != null) {}
    }
    do
    {
      do
      {
        for (;;)
        {
          ...
          bhse.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramInt1, (AbsStructMsg)localObject, null);
          ...
          else if (paramInt1 == 14003)
          {
            if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
            {
              ...
              ((amsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(null);
            }
          }
    ...
    for (int i = Integer.parseInt((String)((Map)localObject1).get("textType"));; i = 0)
    {
      ...
      for (int j = Integer.parseInt(paramObject);; j = 0)
      {
        ...
        for (float f = Float.parseFloat(paramObject);; f = 0.0F)
        {
          ...
          {
            paramObject = (annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
            Object localObject3 = (amsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
            ...
            {
            default: 
              String str3 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690026);
              String str4 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690026);
              paramObject = str3;
              localObject1 = str4;
              localObject3 = str2;
              ...
              this.jdField_a_of_type_Bhpc = bhlq.a(this.jdField_a_of_type_AndroidAppActivity, 0, paramObject, (CharSequence)localObject1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694462), (String)localObject3, (DialogInterface.OnClickListener)localObject2, new agub(this));
            ...
            case 31006: 
              ...
              if (TextUtils.isEmpty(paramObject)) {
                paramObject = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690018);
              }
              break;
            }
            for (;;)
            {
              ...
              str2 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690017);
              localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690017);
              localObject2 = new agua(this, (String)localObject1, m);
              ...
              paramObject = str2;
              break label579;
              QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690008), 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299011));
              if (!QLog.isColorLevel()) {
                break;
              }
