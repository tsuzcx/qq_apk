  ...
  implements Manager
{
  ...
  ajjh jdField_a_of_type_Ajjh = new sgk(this);
  ...
  private Map<Long, ssm> jdField_a_of_type_JavaUtilMap;
  private Set<Long> jdField_a_of_type_JavaUtilSet;
  private sxu jdField_a_of_type_Sxu;
  
  public sgj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    b();
  }
  
  private int a(List<ssm> paramList, ssm paramssm)
  {
    int i = 0;
    while (i < paramList.size())
    {
      if (paramssm.jdField_b_of_type_Long == ((ssm)paramList.get(i)).jdField_b_of_type_Long) {
        return i;
      }
      i += 1;
    }
  ...
  private int a(ssm paramssm)
  {
    boolean bool1 = b(paramssm);
    if (!bool1) {}
    boolean bool2;
    do
    {
  ...
  private boolean a(@Nullable ssm paramssm)
  {
    if (paramssm == null) {}
    while (paramssm.jdField_b_of_type_Int <= 0) {
      return true;
    }
    return false;
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_Sxu = new sxu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private boolean b(@Nullable ssm paramssm)
  {
    if (paramssm == null) {}
    while (paramssm.a.size() <= 0) {
      return false;
    }
    return true;
  }
  
  private boolean c(@Nullable ssm paramssm)
  {
    if (paramssm == null) {}
    long l1;
    long l3;
  ...
  public long a()
  {
    ...
    if (this.jdField_a_of_type_JavaLangDouble == null) {
      str = baig.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    }
    try
    {
      b(str);
  ...
  public List<ssm> a()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      localssm.a(localMsgTabHaloEntity);
  ...
  @Nullable
  public ssm a(@NonNull String paramString)
  {
  ...
  @Nullable
  public ssm a(@NonNull ssm paramssm)
  {
    MsgTabHaloEntity localMsgTabHaloEntity = null;
    List localList = QQStoryContext.a().a().createEntityManager().a(MsgTabHaloEntity.class, MsgTabHaloEntity.class.getSimpleName(), false, MsgTabHaloEntity.getSelection(), MsgTabHaloEntity.getSelectionArgs(paramssm), null, null, null, null);
    if (QLog.isColorLevel()) {
      QLog.i("StoryHaloManager", 2, "dbQueryUserNode: invoked. Message: msgTabHaloEntities: " + localList);
    }
    paramssm = localMsgTabHaloEntity;
    if (localList != null)
    {
      paramssm = localMsgTabHaloEntity;
      if (localList.size() > 0)
      {
        localMsgTabHaloEntity = (MsgTabHaloEntity)localList.get(0);
        paramssm = new ssm();
        paramssm.a(localMsgTabHaloEntity);
      }
    }
    return paramssm;
  }
  ...
  public void a()
  {
    sxv localsxv = new sxv(true);
    sgi.a().dispatch(localsxv);
  }
  ...
  public void a(RecentItemChatMsgData paramRecentItemChatMsgData)
  {
    ...
    try
    {
      ...
      localObject = (ssm)this.jdField_a_of_type_JavaUtilMap.get(Long.valueOf(l));
      int i = a((ssm)localObject);
      if (QLog.isColorLevel()) {
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    int j = baig.aD(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str;
    if (i != j)
    {
    ...
    {
      return;
      baig.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramConfig.version.get(), str);
      try
      {
        b(str);
        return;
  ...
  public void a(@NonNull List<ssm> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ssm localssm1 = (ssm)paramList.next();
      if (localssm1.e != 1)
      {
        b(localssm1);
      }
      ...
      {
        ssm localssm2 = (ssm)localConcurrentHashMap.get(Long.valueOf(localssm1.jdField_b_of_type_Long));
        if (localssm2 == null)
        {
          localssm1 = a(String.valueOf(localssm1.jdField_b_of_type_Long));
          if (QLog.isColorLevel()) {
            QLog.i("StoryHaloManager", 2, "updateHaloStateMap: invoked. use db cache. dbMsgNode: " + localssm1);
          }
          b(localssm1);
        }
        else
        {
          if (QLog.isColorLevel()) {
            QLog.i("StoryHaloManager", 2, "updateHaloStateMap: invoked. use memory cache. backupNode: " + localssm2);
          }
          b(localssm2);
        }
      }
  ...
  public void a(List<ssm> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localatmp.a((atmo)localObject, null, null);
        Iterator localIterator = paramList.iterator();
        if (!localIterator.hasNext()) {
          break;
        }
        localObject = (ssm)localIterator.next();
        paramList = (List<ssm>)localObject;
        int i;
        if (((ssm)localObject).e == 1)
        {
          i = a(localList, (ssm)localObject);
          if (i != -1) {
            break label174;
          }
          paramList = (List<ssm>)localObject;
        ...
        localatmp.b(paramList.a());
        continue;
        paramList = (ssm)localList.get(i);
      }
      finally
      {
        localatmp.a().b();
  ...
  public void a(@NonNull ssm paramssm)
  {
    if (QLog.isColorLevel()) {
      QLog.i("StoryHaloManager", 2, "handlePushPacket: invoked. Message: msgTabNodeInfo: " + paramssm);
    }
    d(paramssm);
    ssm localssm = a(paramssm);
    if ((localssm != null) && (localssm.c < paramssm.c))
    {
      c(paramssm);
      b(paramssm);
    }
    while ((localssm != null) || (paramssm == null)) {
      return;
    }
    c(paramssm);
    b(paramssm);
  ...
  @Nullable
  public ssm b(@NonNull String paramString)
  {
    MsgTabHaloEntity localMsgTabHaloEntity = null;
  ...
  public void b(ssm paramssm)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("StoryHaloManager", 2, "tinkerHaloStateMap: invoked.  msgTabNodeInfo: " + paramssm);
      }
      return;
    }
    long l = paramssm.jdField_b_of_type_Long;
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(l), paramssm);
  }
  ...
  public void c(ssm paramssm)
  {
    ...
    QQStoryContext.a().a().createEntityManager().b(paramssm.a());
  }
  
  public void d(ssm paramssm)
  {
    if (paramssm == null) {}
    do
    {
    ...
    for (int i = 1;; i = 2)
    {
      urp.a("msg_tab", "circle_exp", 0, i, new String[] { String.valueOf(paramssm.jdField_b_of_type_Long) });
      return;
    }
  }
