...
public final class sgj
{
  ...
  public final int a(@Nullable ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    do
    {
      return paramInt;
      qhv localqhv = qhv.a();
      Intrinsics.checkExpressionValueIsNotNull(localqhv, "PTSLiteSwitchManager.getInstance()");
      if ((localqhv.a()) && (qgg.a((BaseArticleInfo)paramArticleInfo))) {
        return qgg.a(paramArticleInfo);
      }
      if (qai.a(paramArticleInfo)) {
        return sel.a.a(paramArticleInfo);
      }
    ...
    {
      paramInt = pab.a((BaseArticleInfo)paramArticleInfo);
      if ((paramInt == 21) || (paramInt == 22)) {
        return ozs.a(paramArticleInfo, true);
      }
      if (paramInt == 11) {
        return 33;
      }
      if (ozs.g(paramArticleInfo))
      {
      ...
      if (ozs.d(paramArticleInfo)) {
        if ((paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg.jdField_a_of_type_JavaUtilArrayList == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg.jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
          break label2443;
        }
      }
    }
    label2440:
    label2443:
    for (paramInt = ComponentContentGridImage.a(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg.jdField_a_of_type_JavaUtilArrayList.size(), paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Int);; paramInt = 0)
    {
      if (paramInt != 0)
      {
        switch (paramInt)
      ...
      if ((paramInt == 27) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyk != null))
      {
        if (!TextUtils.isEmpty((CharSequence)paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyk.c)) {
          return 94;
        }
        return 95;
      }
      if ((paramInt == 32) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxv != null)) {
        return 26;
      }
      ...
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.jdField_a_of_type_Int == 1)
      {
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.c.size() > 0) {
          return 108;
        }
        return 24;
      }
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.jdField_a_of_type_Int == 3) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.jdField_a_of_type_Int == 2))
      {
      ...
      if ((sel.g((BaseArticleInfo)paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo != null)) {
        return sel.a(paramArticleInfo);
      }
      ...
      if ((ozs.e(paramArticleInfo)) || (ozs.f(paramArticleInfo))) {
        return sel.b(paramArticleInfo);
      }
      ...
      {
        if ((paramArticleInfo.mChannelID == 0L) && (paramArticleInfo.mSimpleVideoColumnInfo != null) && (ozs.a((BaseArticleInfo)paramArticleInfo))) {
          return 128;
        }
        if ((paramArticleInfo.mChannelID == 0L) && (paramArticleInfo.mVideoColumnInfo != null) && (ozs.a((BaseArticleInfo)paramArticleInfo))) {
          return 118;
        }
        ...
        if ((ozs.a((BaseArticleInfo)paramArticleInfo)) && (paramArticleInfo.mPictures != null) && (paramArticleInfo.mPictures.length >= 3) && (paramArticleInfo.mChannelID == 0L)) {
          return 14;
        }
        if (ozs.a((BaseArticleInfo)paramArticleInfo))
        {
        ...
        if (ozs.b((BaseArticleInfo)paramArticleInfo))
        {
        ...
        if (paramArticleInfo.mShowBigPicture)
        {
          if (paramArticleInfo.mIsGallery == 0)
          {
            ...
            if (AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) {
              return tqa.b((AdvertisementInfo)paramArticleInfo);
            }
            return 2;
          }
        ...
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (tqa.g((AdvertisementInfo)paramArticleInfo))) {
          return 116;
        }
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (tqa.h((AdvertisementInfo)paramArticleInfo))) {
          return 39;
        }
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (tqa.i((AdvertisementInfo)paramArticleInfo))) {
          return 117;
        }
        if (ozs.i(paramArticleInfo))
        {
          if (ozs.j(paramArticleInfo)) {
            return 91;
          }
          return 90;
        }
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (tqa.j((AdvertisementInfo)paramArticleInfo))) {
          return 127;
        }
        if (tqa.a((BaseArticleInfo)paramArticleInfo)) {
          return 140;
        }
        if (tqa.c((BaseArticleInfo)paramArticleInfo)) {
          return 144;
        }
        if (tqa.e((BaseArticleInfo)paramArticleInfo)) {
          return 145;
        }
        if (tqa.b((BaseArticleInfo)paramArticleInfo)) {
          return 146;
        }
        if (tqa.f((BaseArticleInfo)paramArticleInfo)) {
          return 143;
        }
        if (tqa.d((BaseArticleInfo)paramArticleInfo)) {
          return 141;
        }
        ...
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (tqa.k((AdvertisementInfo)paramArticleInfo))) {
          return 122;
        }
        ...
        if (paramArticleInfo.mIsGallery == 0)
        {
          if (AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo))
          {
            if (nzq.a((BaseArticleInfo)paramArticleInfo)) {
              return 106;
            }
            return 104;
          }
