...
public abstract class akbx
{
  ...
  protected abstract void addBusinessObserver(ToServiceMsg paramToServiceMsg, ajtg paramajtg, boolean paramBoolean);
  ...
  public ToServiceMsg makeOIDBPkg(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte, long paramLong, ajtg paramajtg, boolean paramBoolean)
  {
    ...
    addBusinessObserver(paramString, paramajtg, paramBoolean);
    return paramString;
  }
}
