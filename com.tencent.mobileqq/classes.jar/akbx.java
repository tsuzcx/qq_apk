  ...
  extends QIPCModule
{
  ...
  public static akbx a()
  {
    if (jdField_a_of_type_Akbx == null) {}
    try
    {
      if (jdField_a_of_type_Akbx == null) {
        jdField_a_of_type_Akbx = new akbx();
      }
      return jdField_a_of_type_Akbx;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (aneo)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (aewa)paramQQAppInterface.getManager(321);
    ...
    case 12: 
      ...
      if (paramBundle != null)
      {
        ...
        paramQQAppInterface = (aewa)paramQQAppInterface.getManager(321);
        if (paramQQAppInterface != null) {
          paramQQAppInterface.a(aevc.a(paramBundle).hashCode());
        }
      }
      return null;
    case 13: 
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new akcc(this, paramInt));
      return null;
    case 8: 
    ...
    case 17: 
      ...
      if (bool)
      {
        paramQQAppInterface = new bbza(paramQQAppInterface, paramBundle).a();
        paramBundle = new Bundle();
        paramBundle.putSerializable("res", paramQQAppInterface);
        return EIPCResult.createSuccessResult(paramBundle);
      }
      new bbyv(paramQQAppInterface, paramBundle).a(new akcd(this, paramInt));
      return null;
    case 18: 
      paramInt = akfu.a(paramBundle.getString("path"));
    ...
    case 6: 
      ...
      paramQQAppInterface = (akcq)paramQQAppInterface.getManager(273);
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(paramBundle);
      }
      return null;
    case 16: 
      ...
      {
        paramBundle = (ajyk)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    case 15: 
      localObject = paramBundle.getString("key");
      paramInt = paramBundle.getInt("code");
      paramBundle = new akce(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
      paramQQAppInterface = (ajyg)paramQQAppInterface.getManager(245);
      if (paramQQAppInterface != null)
      {
        if ((this.jdField_a_of_type_JavaUtilMap != null) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt)))) {
    ...
    paramBundle = new akcf(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((amsw)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
      if (!TextUtils.isEmpty(paramBundle))
      {
        localObject1 = (TroopManager)paramQQAppInterface.getManager(52);
        localObject2 = ((amsw)localObject2).e(str);
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (ajyg)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new akch(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new akcg(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new akby(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new akbz(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
      ...
      else
      {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (ampm)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new akcb(this, (Bundle)localObject, i, paramString, paramBundle));
              }
