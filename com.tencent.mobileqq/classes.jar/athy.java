...
public class athy
  implements atib
{
  public athy(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3, String paramString4, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Atzf != null) {
        this.a.jdField_a_of_type_Atzf.jdField_f_of_type_Long = System.currentTimeMillis();
      }
      this.a.d = true;
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          if (this.a.jdField_a_of_type_Atzf != null)
          {
            this.a.jdField_a_of_type_Atzf.jdField_a_of_type_Boolean = false;
            this.a.jdField_a_of_type_Atzf.jdField_c_of_type_Long = (this.a.jdField_a_of_type_Atzf.jdField_f_of_type_Long - this.a.jdField_a_of_type_Atzf.jdField_e_of_type_Long);
            this.a.jdField_a_of_type_Atzf.jdField_d_of_type_JavaLangString = String.valueOf(paramLong);
            this.a.jdField_a_of_type_Atzf.h = paramString3;
            this.a.jdField_a_of_type_Atzf.jdField_c_of_type_JavaLangString = paramString6;
            this.a.jdField_a_of_type_Atzf.jdField_d_of_type_Long = (System.currentTimeMillis() - this.a.jdField_a_of_type_Atzf.jdField_a_of_type_Long);
            this.a.jdField_a_of_type_Atzf.a();
          }
          ...
          return;
          this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131703463));
        }
      }
      paramBoolean = false;
      ...
      for (this.a.jdField_a_of_type_JavaLangString = ("https://" + paramString3 + ":" + paramString2 + "/ftn_doc_previewer/" + this.a.i);; this.a.jdField_a_of_type_JavaLangString = ("http://" + paramString3 + ":" + paramString2 + "/ftn_doc_previewer/" + this.a.i))
      {
        ...
        if (this.a.jdField_a_of_type_Atzf != null)
        {
          this.a.jdField_a_of_type_Atzf.jdField_a_of_type_Boolean = true;
          this.a.jdField_a_of_type_Atzf.jdField_f_of_type_JavaLangString = paramString4;
          this.a.jdField_a_of_type_Atzf.h = "";
          this.a.jdField_a_of_type_Atzf.jdField_f_of_type_Long = System.currentTimeMillis();
          this.a.jdField_a_of_type_Atzf.jdField_c_of_type_Long = (this.a.jdField_a_of_type_Atzf.jdField_f_of_type_Long - this.a.jdField_a_of_type_Atzf.jdField_e_of_type_Long);
          this.a.jdField_a_of_type_Atzf.b = paramString3;
          this.a.jdField_a_of_type_Atzf.jdField_e_of_type_JavaLangString = this.a.jdField_a_of_type_JavaLangString;
          this.a.jdField_a_of_type_Atzf.jdField_c_of_type_JavaLangString = paramString6;
          this.a.jdField_a_of_type_Atzf.jdField_d_of_type_Long = (System.currentTimeMillis() - this.a.jdField_a_of_type_Atzf.jdField_a_of_type_Long);
          this.a.jdField_a_of_type_Atzf.a();
        }
    ...
    } while (this.a.jdField_a_of_type_Atzf == null);
    this.a.jdField_a_of_type_Atzf.jdField_e_of_type_Long = System.currentTimeMillis();
    this.a.jdField_a_of_type_Atzf.k = "2";
  }
}
