  ...
  implements blfk
{
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (mur.a(this.a) != null) {
      mur.a(this.a).a(paramString);
    }
  }
  ...
  public void a(int paramInt, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvVideoController != null)
      {
        ...
        mur.a(this.a, paramArrayOfString);
        mur.a(this.a, paramString2, paramString1);
        if (paramArrayOfString != null)
        {
          ...
          while (paramInt < paramArrayOfString.length)
          {
            if (paramArrayOfString[paramInt].equals("DEVICE_WIREDHEADSET")) {
              mru.k(this.a.jdField_a_of_type_ComTencentAvVideoController);
            }
            paramInt += 1;
          }
        }
  ...
  public void a(long paramLong, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = "";
        String[] arrayOfString = ((lff)localObject).a;
        if (((lff)localObject).c != 3)
        {
          paramString2 = ((lff)localObject).q;
          ((lff)localObject).b("onDeviceListUpdate", paramString1);
        }
        ((lff)localObject).a = paramArrayOfString;
        ((lff)localObject).r = paramString3;
        mur.a(this.a, paramArrayOfString);
        mur.a(this.a, paramString2, paramString1);
        if (mur.a(this.a) != null) {
          mur.a(this.a).notifyDataSetChanged();
        }
        this.a.a();
      ...
      } while (mur.a(this.a) == null);
      mur.a(this.a).a(null, new mux(paramArrayOfString));
    } while (this.a.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null);
