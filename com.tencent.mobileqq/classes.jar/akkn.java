  ...
  extends akif
{
  ...
  protected akkn(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  protected void d()
  {
    if ("FromFastImage".equals(this.jdField_a_of_type_Akic.from))
    {
      bcst.b(null, "CliOper", "", "", "0X8004D93", "0X8004D93", 0, 0, "", "", "", "");
      akgm.d();
    }
    if ("FromCamera".equals(this.jdField_a_of_type_Akic.from)) {
      akgm.b();
    }
    super.d();
    bcst.b(null, "CliOper", "", "", "0X8005147", "0X8005147", 0, 0, "", "", "", "");
  }
  ...
  public void initData(Intent paramIntent)
  {
    ...
    label236:
    for (this.jdField_a_of_type_Akic.f = 1037;; this.jdField_a_of_type_Akic.f = 1008)
    {
      ...
      {
        ((PresendPicMgr)localObject).a(str, this.jdField_a_of_type_Akic.f);
        if (QLog.isColorLevel()) {
          QLog.d("PhotoPreviewActivity", 2, "  initData , presendMgr = " + localObject + ",picpath = " + str + ",from = " + this.jdField_a_of_type_Akic.from + ",mBusiType = " + this.jdField_a_of_type_Akic.f);
        }
      }
  ...
  {
    super.initUI();
    ((NewPhotoPreviewActivity)this.mActivity).backToPhotoListBtn.setText(2131694293);
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    if (this.jdField_a_of_type_Akic.a != null)
    {
      ...
      if (this.jdField_a_of_type_Boolean) {
        bcst.b(null, "CliOper", "", "", "0X8004D95", "0X8004D95", 0, 0, "", "", "", "");
      }
    }
