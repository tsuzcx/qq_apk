...
{
  public akkn(AuthorityActivity paramAuthorityActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (str = "s_a_a_emp";; str = "s_a_a")
    {
      if (paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          catch (Exception paramBundle)
          {
            ...
            ((Message)localObject1).obj = this.a.getResources().getString(2131435586);
      ...
      for (;;)
      {
        ...
        paramBundle.obj = this.a.getResources().getString(2131435586);
        this.a.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.sendMessage(paramBundle);
        paramBundle = this.a.getResources().getString(2131435586);
        try
        {
