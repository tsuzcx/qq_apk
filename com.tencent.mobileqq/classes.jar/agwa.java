...
public class agwa
  implements agvz, Handler.Callback
{
  int jdField_a_of_type_Int = xee.b(BaseApplicationImpl.getContext(), 50.0F);
  private aekn jdField_a_of_type_Aekn;
  private agvy jdField_a_of_type_Agvy;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new agwb(this);
  ...
  private ArrayList<agwc> jdField_a_of_type_JavaUtilArrayList;
  public List<QQOperationViopTipTask> a;
  private Observer jdField_a_of_type_JavaUtilObserver;
  protected final MqqHandler a;
  int jdField_b_of_type_Int = xee.b(BaseApplicationImpl.getContext(), 30.0F);
  Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  Animation c;
  
  public agwa(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aekn paramaekn, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
  ...
  private RelativeLayout a()
  {
    ...
    //   23: putfield 111	agwa:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    ...
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 111	agwa:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
  ...
  private boolean a(agwc paramagwc)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramagwc.b());
    int i = -1;
    int[] arrayOfInt = paramagwc.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Agvy != null) {
        i = this.jdField_a_of_type_Agvy.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramagwc instanceof agvy)) && (this.jdField_a_of_type_Agvy != null) && (this.jdField_a_of_type_Agvy.a() > ((agvy)paramagwc).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Agvy != null) {
      return this.jdField_a_of_type_Agvy.b();
    }
    return -1;
  }
  ...
  public agvy a()
  {
    return this.jdField_a_of_type_Agvy;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Aekn != null) {
        this.jdField_a_of_type_Aekn.a(this.jdField_a_of_type_Agvy);
      }
      this.jdField_a_of_type_Agvy = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((agwc)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(agwc paramagwc)
  {
    if (paramagwc == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramagwc));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramagwc);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131367716);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364137));
    }
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367716) == null) {
  ...
  public boolean a(agve paramagve, Object... paramVarArgs)
  {
    if (paramagve != null)
    {
      if (a(paramagve)) {
    ...
    {
      return false;
      paramVarArgs = paramagve.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramVarArgs, paramVarArgs.selfuin);
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramagve.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramagve.b()));
    return false;
  }
  
  public boolean a(agvy paramagvy, Object... paramVarArgs)
  {
    if (aekt.l) {}
    label136:
    do
    {
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramagvy.a(paramVarArgs);
        this.jdField_a_of_type_Aekn.a(paramVarArgs, paramagvy);
        this.jdField_a_of_type_Agvy = paramagvy;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramagvy.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramagvy, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378262);
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378256);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (i = j + k;; i = j)
        {
          ...
          localLayoutParams.rightMargin = xee.b(BaseApplicationImpl.getContext(), 40.0F);
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367716) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366601));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366602));
