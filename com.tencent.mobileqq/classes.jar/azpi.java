...
public final class azpi
{
  ...
  public azpi(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public azpi(group_file_common.FolderInfo paramFolderInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public azpi(oidb_0x6d8.GetFileListRspBody.Item paramItem)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  {
    String str = bbkp.b(paramContext, paramLong);
    paramContext = str;
    int i1;
    int i2;
    if (str != null)
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.n == null)
        {
          ...
          if (i1 != 0)
          {
            this.n = bbcz.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
            if (this.n.length() <= 10)
            {
              i1 = i5;
              break label307;
  ...
  public String a()
  {
    return bakx.a(this.jdField_a_of_type_Long);
  }
  
  public String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    return bbcz.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
  }
  ...
  public void a(azpi paramazpi)
  {
    if (paramazpi != null)
    {
      if ((paramazpi.jdField_e_of_type_Int != 8) && (paramazpi.jdField_e_of_type_Int != 9)) {
        break label45;
      }
      if (paramazpi.jdField_b_of_type_JavaLangString != null) {
        this.jdField_a_of_type_JavaUtilMap.put(paramazpi.jdField_b_of_type_JavaLangString, paramazpi);
      }
    }
    label45:
    while (((paramazpi.jdField_e_of_type_Int != 11) && (paramazpi.jdField_e_of_type_Int != 10) && (paramazpi.jdField_e_of_type_Int != 12)) || (paramazpi.jdField_b_of_type_JavaLangString == null)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(paramazpi.jdField_b_of_type_JavaLangString);
  }
  
  public void a(azqv paramazqv, QQAppInterface paramQQAppInterface)
  {
    this.jdField_i_of_type_JavaLangString = paramazqv.jdField_b_of_type_JavaLangString;
    this.j = paramazqv.jdField_c_of_type_JavaLangString;
    this.k = paramazqv.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_Int = paramazqv.jdField_b_of_type_Int;
    this.jdField_h_of_type_JavaLangString = paramazqv.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_Long = paramazqv.jdField_d_of_type_Long;
    this.jdField_f_of_type_Int = paramazqv.jdField_c_of_type_Int;
    this.jdField_c_of_type_Boolean = paramazqv.jdField_a_of_type_Boolean;
    if (this.jdField_b_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = paramazqv.jdField_d_of_type_Int;
      this.l = a(BaseApplicationImpl.getApplication(), this.jdField_b_of_type_Int * 1000L);
    }
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = paramazqv.jdField_e_of_type_JavaLangString;
    }
    if (this.jdField_f_of_type_JavaLangString == null) {
      this.jdField_f_of_type_JavaLangString = paramazqv.jdField_i_of_type_JavaLangString;
    }
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = paramazqv.jdField_c_of_type_Long;
    }
    if (this.jdField_c_of_type_JavaLangString == null) {
      this.jdField_c_of_type_JavaLangString = paramazqv.jdField_g_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Int == 0) || (azpj.a(paramazqv.jdField_b_of_type_Int))) {
      this.jdField_a_of_type_Int = paramazqv.jdField_h_of_type_Int;
    }
    if ((this.jdField_b_of_type_Long == 0L) && (azpj.a(paramazqv.jdField_b_of_type_Int))) {}
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (NumberFormatException paramazqv)
    {
  ...
  {
    return (bakx.a(paramQQAppInterface, paramLong)) && (this.jdField_d_of_type_Boolean);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    boolean bool2 = bakx.a(paramQQAppInterface, paramLong);
  ...
  public void b(azpi paramazpi)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = paramazpi.jdField_b_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = paramazpi.jdField_f_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = paramazpi.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramazpi.jdField_a_of_type_Int;
    this.jdField_b_of_type_Long = paramazpi.jdField_b_of_type_Long;
    this.jdField_c_of_type_Long = paramazpi.jdField_c_of_type_Long;
    this.jdField_a_of_type_Long = paramazpi.jdField_a_of_type_Long;
    this.jdField_b_of_type_Int = paramazpi.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramazpi.jdField_c_of_type_Int;
    this.jdField_i_of_type_Int = paramazpi.jdField_i_of_type_Int;
    this.jdField_d_of_type_Int = paramazpi.jdField_d_of_type_Int;
    this.jdField_e_of_type_JavaLangString = paramazpi.jdField_e_of_type_JavaLangString;
    this.jdField_h_of_type_Int = paramazpi.jdField_h_of_type_Int;
    this.jdField_d_of_type_JavaLangString = paramazpi.jdField_d_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = paramazpi.jdField_d_of_type_Boolean;
    this.l = paramazpi.l;
    this.m = paramazpi.m;
  }
  ...
  {
    return (bakx.a(paramQQAppInterface, paramLong)) && (!this.jdField_d_of_type_Boolean) && (!paramBoolean) && (!azpj.a(this.jdField_e_of_type_Int)) && (!azpj.b(this.jdField_e_of_type_Int));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject == null) || (!(paramObject instanceof azpi))) {
      return false;
    }
    paramObject = (azpi)paramObject;
