...
public class rrx
  extends anyu
{
  private rrx(VideoFeedsRecommendFragment paramVideoFeedsRecommendFragment) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        for (localObject1 = bhlg.b((QQAppInterface)localObject1, paramString, false);; localObject1 = null)
        {
