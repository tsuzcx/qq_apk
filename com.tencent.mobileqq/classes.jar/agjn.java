...
class agjn
  implements agxe
{
  agjn(agjk paramagjk, ArrayList paramArrayList, SessionInfo paramSessionInfo) {}
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      localGetBroadCastHbIdiomReq.qqVersion = "8.2.6";
      agkg.a(localGetBroadCastHbIdiomReq, new agjo(this));
      return;
