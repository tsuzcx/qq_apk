...
public class bhke
{
  ...
  public bhke(QQAppInterface paramQQAppInterface, Context paramContext, Handler paramHandler)
  {
    ...
    bhkh.a(paramContext, this.jdField_a_of_type_JavaUtilMap);
  }
  ...
  private void a(UPDATE_INFO paramUPDATE_INFO, PluginRecord paramPluginRecord)
  {
    ...
    paramPluginRecord.mInstalledPath = bhkh.a(BaseApplicationImpl.getContext(), paramPluginRecord.id).getAbsolutePath();
  }
  
  private void a(PluginRecord paramPluginRecord)
  {
    File localFile = bhkh.c(BaseApplicationImpl.getContext(), paramPluginRecord.id);
    if ((localFile != null) && (localFile.exists())) {
      localFile.delete();
    }
    bhkh.a(paramPluginRecord);
    LpReportInfo_dc01500.reportConfig(paramPluginRecord.id, paramPluginRecord.old_ver, paramPluginRecord.ver, 0);
  }
  
  private void a(String paramString)
  {
    paramString = bhkh.c(BaseApplicationImpl.getContext(), paramString);
  ...
  {
    PluginIntent localPluginIntent = new PluginIntent(BaseApplicationImpl.getContext(), bhih.class);
    localPluginIntent.a = a();
    localPluginIntent.b = bhgt.a().a();
    localPluginIntent.a(new bhkf(this));
  ...
  public void a(bhkg parambhkg)
  {
    this.jdField_a_of_type_Bhkg = parambhkg;
  }
