  ...
  extends anii
{
  ...
  public bhke(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.a = paramQQAppInterface;
  }
  
  private void a(int paramInt, VipFunCallAndRing.TSsoRsp paramTSsoRsp, String paramString, bhjt parambhjt)
  {
    long l;
    if (paramInt == 0)
    {
      ...
      paramTSsoRsp = bhjt.a(this.a, 1, null);
    ...
    if (localObject != null)
    {
      parambhjt.a(this.a, 0, this.app.getAccount(), ((VipFunCallAndRing.TUserInfo)localObject).i32_common_id.get(), ((VipFunCallAndRing.TUserInfo)localObject).i32_ring_id.get(), null, l);
      paramString = (VipFunCallAndRing.TSourceInfo)((VipFunCallAndRing.TUserInfo)localObject).st_src_info.get();
      bhjt.a(this.a, ((VipFunCallAndRing.TUserInfo)localObject).i32_common_id.get(), null, paramString, true);
      ...
      if ((paramString != null) && (paramString.size() > 0))
      {
        ...
        while (paramString.hasNext())
        {
          ...
          parambhjt.a(this.a, 1, null, localTGroupInfo.i32_group_id.get(), localTGroupInfo.i32_ring_id.get(), localTGroupInfo.u64_group_uins.get(), 0L);
          VipFunCallAndRing.TSourceInfo localTSourceInfo = (VipFunCallAndRing.TSourceInfo)localTGroupInfo.st_src_info.get();
          bhjt.a(this.a, localTGroupInfo.i32_group_id.get(), null, localTSourceInfo, true);
        }
      }
      if (bhjt.b()) {
        parambhjt.a(((VipFunCallAndRing.TUserInfo)localObject).i32_common_id.get(), ((VipFunCallAndRing.TUserInfo)localObject).i32_ring_id.get(), false, 0, null);
      }
    }
  ...
  private void a(VipFunCallAndRing.TSsoReq paramTSsoReq, int paramInt1, Bundle paramBundle, int paramInt2, VipFunCallAndRing.TSsoRsp paramTSsoRsp, bhjt parambhjt)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      parambhjt.a(this.a, 1, null, paramTSsoReq.i32_funcall_id.get(), paramTSsoReq.i32_ring_id.get(), paramTSsoReq.rpt_uins.get(), 0L);
    }
    if (1 == paramInt1)
    {
  ...
  private void a(VipFunCallAndRing.TSsoReq paramTSsoReq, int paramInt, VipFunCallAndRing.TSsoRsp paramTSsoRsp, bhjt parambhjt)
  {
    if (paramInt == 0)
    {
      ...
      parambhjt.a(this.a, 2, null, paramTSsoReq.i32_funcall_id.get(), 0, null, 0L);
    }
  }
  
  private void a(FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte, int paramInt1, Bundle paramBundle, int paramInt2)
  {
    QLog.e("VipSetFunCallHandler", 1, "onReceive~ isSuccess=false ,data=" + bgva.a(paramArrayOfByte) + ", funcType=" + paramInt1);
    bipi.a().a("FunCallSvr.call", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, anni.a(2131715444), true);
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      if (paramInt2 == 0) {
        bhjt.a(this.a, paramString, 2, this.a.getAccount(), paramInt1);
      }
    }
    else {
      return;
    }
    bhjt.a(this.a, paramString, 1, this.a.getAccount(), paramInt1);
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    localTSsoReq.str_qq_ver.set("8.4.1");
    ...
    case 1: 
      ...
      long l = bhjt.a(this.a, 1, null).getLong("local_version", 0L);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramFromServiceMsg = (bhjt)this.app.getManager(84);
    label390:
    boolean bool;
    if (QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        ...
        m = bhjt.a(this.a, paramToServiceMsg, 6, true, null);
        paramFromServiceMsg.a(this.a, 0, paramToServiceMsg, i, ((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject2).i32_ring_id.get(), null, 0L);
        bhjt.a(this.a, ((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject2).i32_funcall_id.get(), null, (VipFunCallAndRing.TSourceInfo)((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject2).st_src_info.get(), true);
        if (bhjt.b()) {
