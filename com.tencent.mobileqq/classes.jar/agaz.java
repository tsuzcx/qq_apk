  ...
  implements ValueAnimator.AnimatorUpdateListener
{
  ...
  public agaz(Context paramContext, ListView paramListView, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131362410);
  ...
  public agaz a(int paramInt1, int paramInt2)
  {
    int j = 0;
    int k = 0;
