...
public abstract class rgt
{
  ...
  pkt jdField_a_of_type_Pkt = new rgu(this);
  private rgv jdField_a_of_type_Rgv;
  ...
  private void a(Bundle paramBundle, rri paramrri, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramrri.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramrri.a()).toString());
      ...
      odq.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, rri paramrri, rgv paramrgv)
  {
    String str1 = paramrri.a();
    String str2 = paramrri.b();
    String str3 = paramrri.c();
    String str4 = paramrri.d();
    String str5 = paramrri.e();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Rgv = paramrgv;
    if (paramBundle == null) {}
