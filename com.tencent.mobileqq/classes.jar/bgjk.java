...
public class bgjk
{
  ...
  public static void a(int paramInt1, QQVipMsgInfo paramQQVipMsgInfo, int paramInt2)
  {
    ...
    anxs.a(paramInt1, paramInt2, str, paramQQVipMsgInfo.triggerInfo);
  }
  ...
  {
    Object localObject = (amxz)((QQAppInterface)a()).getManager(56);
    if (localObject != null)
    {
      localObject = ((amxz)localObject).b(AppConstants.QQ_VIP_UIN);
      if (localObject != null) {
  ...
  public static void c(Context paramContext)
  {
    ...
    paramContext = new NewIntent(paramContext, odw.class);
    ...
    try
    {
      ...
      paramContext.setObserver(new bgjl(localQQAppInterface));
