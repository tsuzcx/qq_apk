...
public class bgjk
{
  ...
  public static int a;
  private static bgjp jdField_a_of_type_Bgjp;
  ...
  private static final String c = anni.a(2131713398);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Bgjp = new bgjp();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bgjk:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bgjn parambgjn, afzq paramafzq)
  {
    jdField_a_of_type_Bgjp.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bgjp.jdField_a_of_type_Afzq = paramafzq;
    parambgjn.a(paramafzq);
    parambgjn.a(new bgjm());
  }
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 1) && (paramSessionInfo.jdField_a_of_type_Int != 3000) && (paramSessionInfo.jdField_a_of_type_Int != 0) && (!acwh.e(paramSessionInfo.jdField_a_of_type_Int)))
    {
    ...
    paramViewGroup.setOnDragListener(new bgjl(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bgjo b(Context paramContext, afwr paramafwr)
  {
    long l = 0L;
    Object localObject1;
    if ((paramafwr instanceof ahfg))
    {
      localObject1 = atwt.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = bgmg.a((String)localObject1);
      paramafwr = paramafwr.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramafwr instanceof ahfi))
        {
          localObject1 = atwt.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = bgmg.a((String)localObject1);
          paramafwr = ((ahfi)paramafwr).a;
          continue;
        }
        if ((paramafwr instanceof agrv))
        {
          localObject2 = (MessageForPic)paramafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = atvo.a((String)localObject3);
          int i = bley.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!bgmg.d(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramafwr = ((agrv)paramafwr).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramafwr instanceof ahhx))
        {
          localObject2 = (MessageForShortVideo)paramafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramafwr = ((ahhx)paramafwr).a;
          continue;
        }
        if ((paramafwr instanceof ahin))
        {
          localObject2 = (MessageForShortVideo)paramafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramafwr = ((ahin)paramafwr).a;
        }
      }
      else
      {
        ...
        return new bgjo((File)localObject2, paramafwr, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramafwr = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView = new ReportProgressDialog(paramContext, 2131755823);
    paramImageView.setCancelable(true);
    paramImageView.setContentView(2131559567);
    ((TextView)paramImageView.findViewById(2131372466)).setText(anni.a(2131713397));
