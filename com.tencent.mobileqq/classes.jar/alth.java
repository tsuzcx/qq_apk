...
public class alth
{
  ...
  private ArkAppPreloader.PreloadAppCallback jdField_a_of_type_ComTencentArkArkAppPreloader$PreloadAppCallback = new altj(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private ConcurrentHashMap<String, altl> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(8);
  ...
  private void a(altl paramaltl)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new ArkAppPreDownloadMgr.3(this, paramaltl));
  }
  ...
  private void c()
  {
    ...
    ArkAppPreloader.preloadCommon(alsz.a(), str2, str1);
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localaltl.a)) {
          if (TextUtils.isEmpty(ArkAppMgr.getInstance().getAppPathByNameFromLocal(localaltl.a, "", null, false))) {
            a(localaltl);
          } else {
            QLog.d("ArkApp.ArkAppPreDownloadMgr", 1, new Object[] { "profiling ark app predowloaded,app=", localaltl.a });
          }
        }
      }
    }
  ...
  {
    if ((paramamqp != null) && (paramamqp.a() != null)) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = paramamqp.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          axrn.a(BaseApplicationImpl.getApplication()).a(str, "ark_app_predownload_first_hit", true, 0L, 0L, localHashMap, "", false);
        ...
        continue;
        axrn.a(BaseApplicationImpl.getApplication()).a(str, "ark_app_predownload_first_hit", false, 0L, 0L, localHashMap, "", false);
      }
      finally {}
      label193:
      continue;
