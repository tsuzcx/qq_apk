...
public class alth
  extends ambm
  implements akof, View.OnClickListener, View.OnLongClickListener, awna
{
  private static final altm jdField_a_of_type_Altm = new altm(null);
  private final int jdField_a_of_type_Int;
  altp jdField_a_of_type_Altp = null;
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new altj(this);
  ...
  public alth(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if (this.jdField_a_of_type_Altp == null) {
        this.jdField_a_of_type_Altp = new altp(this, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      paramViewGroup.jdField_a_of_type_JavaLangString = ((TroopMemberInfo)localObject2).memberuin;
      localObject1 = bglf.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TroopMemberInfo)localObject2).troopuin, ((TroopMemberInfo)localObject2).memberuin);
      a(paramViewGroup, this.jdField_a_of_type_Altp.a((TroopMemberInfo)localObject2));
      label234:
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject1 + anni.a(2131712512));
      }
      return paramView;
      ...
      localObject1 = bglf.a((Friends)localObject2);
    ...
    label502:
    paramView.setContentDescription((String)localObject1 + anni.a(2131712489));
    return paramView;
  }
  
  private void a(List<altk> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Altm);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + anni.a(2131712504));
      }
      return paramView;
      paramViewGroup = (alto)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (altn)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
  ...
  private void c()
  {
    ...
    for (;;)
    {
      Object localObject2 = aknz.a(this, bool, 0, 0);
      Object localObject3 = ((HashMap)localObject2).get(aknz.jdField_a_of_type_JavaLangString);
      Object localObject1 = null;
      if (localObject3 != null) {
        localObject1 = (ArrayList)localObject3;
      }
      localObject2 = ((HashMap)localObject2).get(aknz.b);
      ...
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              ...
              {
                localObject4 = ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(((PfaFriend)localObject4).uin);
        ...
        if (!((ArrayList)localObject2).isEmpty())
        {
          ...
          ((Groups)localObject1).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131692402);
  ...
  private void e()
  {
    ArrayList localArrayList = vtj.a().b();
    if ((localArrayList != null) && (localArrayList.size() > 0))
    {
      Groups localGroups = new Groups();
      localGroups.group_id = 1009;
      localGroups.group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131697278);
  ...
  private void g()
  {
    ...
    ((Groups)localObject).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131694226);
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Beow.a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_a_of_type_AndroidUtilSparseArray);
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new altk((Friends)((Iterator)localObject5).next(), -1));
          }
          d();
          break;
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((altk)((Iterator)localObject4).next()).a);
        }
  ...
  {
    altl localaltl = (altl)paramView.getTag();
    if (localaltl == null)
    {
      localaltl = new altl();
      paramView.findViewById(2131369120).setVisibility(0);
      localaltl.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367657));
      paramView.setTag(localaltl);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localaltl.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      if (this.jdField_b_of_type_ComTencentWidgetExpandableListView != null) {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_d_of_type_Int == 33) {
      aknz.a(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app);
    }
    if (this.jdField_a_of_type_Altp != null)
    {
      this.jdField_a_of_type_Altp.a();
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (a(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_a_of_type_Beow.b(paramInt1, paramInt2, paramView, paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_AndroidViewView$OnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (altl)paramView.getTag();
      ...
      if (AppSetting.c)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + anni.a(2131712508));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + anni.a(2131712499));
    }
  }
  ...
  {
    Object localObject = (altl)paramView.getTag();
    if (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(((altl)localObject).jdField_a_of_type_Int)) {
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.b(((altl)localObject).jdField_a_of_type_Int);
    }
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentWidgetExpandableListView.a(((altl)localObject).jdField_a_of_type_Int);
        localObject = (Groups)getGroup(((altl)localObject).jdField_a_of_type_Int);
        if (((Groups)localObject).group_id == 1003)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0) {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 1, 0, "", "", "", "");
          } else {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 2, 0, "", "", "", "");
          }
        }
        else if (((Groups)localObject).group_id == 1002)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0) {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 1, 0, "", "", "", "");
          } else {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 2, 0, "", "", "", "");
          }
        }
        else if (((Groups)localObject).group_id == 0)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0) {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 1, 0, "", "", "", "");
          } else {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 2, 0, "", "", "", "");
          }
        }
        else if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0) {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 1, 0, "", "", "", "");
        } else {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 2, 0, "", "", "", "");
        }
      }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    bgkw.a(paramView, localbguh, this.jdField_b_of_type_AndroidViewView$OnClickListener, new alti(this));
    return true;
  }
