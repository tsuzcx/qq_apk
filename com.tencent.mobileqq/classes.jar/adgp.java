  ...
  extends RecyclerView.Adapter
{
  ...
  public adgp(HotPicPageView paramHotPicPageView, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
  }
  
  public adgz a(ViewGroup paramViewGroup, int paramInt)
  {
  ...
  public void a(adgz paramadgz, int paramInt)
  {
    HotPicPageView.MyVideoViewHolder localMyVideoViewHolder;
    Object localObject1;
    if ((paramadgz instanceof HotPicPageView.MyVideoViewHolder))
    {
      localMyVideoViewHolder = (HotPicPageView.MyVideoViewHolder)paramadgz;
    ...
    for (;;)
    {
      ...
      ViewGroup.MarginLayoutParams localMarginLayoutParams1 = (ViewGroup.MarginLayoutParams)paramadgz.d.getLayoutParams();
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          {
            paramadgz = this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicTagInfo.position + "_" + paramInt;
            if (!this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_JavaUtilSet.contains(paramadgz)) {
              break label1037;
            }
          }
        }
        ...
        while (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_AndroidSupportV4ViewViewPager == null)
        {
          ...
          if (((HotVideoData)localObject2).url.isEmpty())
          {
            ...
            ((HotVideoData)localObject2).GetPreviewURLAsync(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, "0", new adgq(this, (HotVideoData)localObject2, localMyVideoViewHolder, (URLDrawable)localObject1));
            break label564;
          }
          j = 1;
          i = j;
          ...
          break label696;
          paramadgz.d.setImageDrawable((Drawable)localObject1);
          break label717;
        }
        label976:
        label988:
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_AndroidSupportV4ViewViewPager.getCurrentItem() == this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicTagInfo.position)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_JavaUtilSet.add(paramadgz);
          return;
        }
        label1025:
        label1037:
