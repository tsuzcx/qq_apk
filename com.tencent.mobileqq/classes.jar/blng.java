...
public abstract class blng
{
  public int a;
  protected SegmentKeeper a;
  public Object a;
  public ArrayList<blnh> a;
  public int b;
  protected int c;
  
  public blng(Object paramObject)
  {
  ...
  public void a()
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((blnh)localIterator.next()).a(this);
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      if (localIterator.hasNext()) {
        ((blnh)localIterator.next()).a(this, paramInt);
      }
    }
  }
  ...
  public void a(blnh paramblnh)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramblnh)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramblnh);
      }
      return;
    }
  }
  ...
  public void b()
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      if (localIterator.hasNext()) {
        ((blnh)localIterator.next()).b(this);
      }
    }
  }
