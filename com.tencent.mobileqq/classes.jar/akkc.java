...
public class akkc
{
  ...
  private final TreeMap<Integer, akkd> jdField_a_of_type_JavaUtilTreeMap = new TreeMap();
  public boolean a;
  public long b;
  public String b;
  public long c = 0L;
  ...
  public String toString()
  {
    ...
    if (QLog.isDevelopLevel())
    {
      ...
      {
        akkd localakkd = (akkd)((Iterator)localObject).next();
        str = str + "\n" + localakkd;
      }
