  ...
  implements owp
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull pan parampan, @NotNull pay parampay, @NotNull ViewBase paramViewBase)
  {
    ...
    if ((paramViewBase instanceof peh))
    {
      ((peh)paramViewBase).a(parampan, (View)paramContainer);
      if (opu.a(parampay)) {
        paramViewBase.setOnClickListener((ViewBase.OnClickListener)new oxk(parampan, paramContainer, parampay));
      }
    }
  }
}
