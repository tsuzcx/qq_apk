...
public class pyh
  extends BaseAdapter
{
  private pyh(ComponentPolymericView paramComponentPolymericView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      i = 1;
      localObject2 = new pbi((Context)localObject1, (ArticleInfo)localObject2, j, k, i, paramInt, false, getCount(), null, ComponentPolymericView.a(this.a).a.a());
      localObject1 = pqq.a(paramInt, localObject2, getItemViewType(paramInt), paramView, ComponentPolymericView.a(this.a), ComponentPolymericView.a(this.a).a.a(), ComponentPolymericView.a(this.a).a.a().a());
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131379208, localObject2);
        ComponentPolymericView.a(this.a).a.a().a(paramViewGroup, (pax)localObject2, System.currentTimeMillis(), paramInt);
      }
      ...
      if (((onk.o(paramViewGroup)) || (onk.p(paramViewGroup))) && (!ComponentPolymericView.a(this.a)[paramInt].booleanValue())) {
    ...
    for (;;)
    {
      try
      {
        localObject3 = (qbr)paramViewGroup.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.get(0);
        ((JSONObject)localObject2).put("channel_id", paramViewGroup.mChannelID);
        if (((qbr)localObject3).jdField_a_of_type_Qbs == null) {
          continue;
        }
        paramView = ((qbr)localObject3).jdField_a_of_type_Qbs.a;
        ((JSONObject)localObject2).put("rowkey", paramView);
        if (((qbr)localObject3).jdField_a_of_type_Qbt == null) {
          continue;
        }
        i = ((qbr)localObject3).jdField_a_of_type_Qbt.b;
      ...
      if (!onk.o(paramViewGroup)) {
        continue;
      }
      paramView = "1";
      noo.a(null, "CliOper", "", "", "0X8009829", "0X8009829", 0, 0, (String)localObject3, paramView, paramViewGroup.mStrategyId + "", ((JSONObject)localObject2).toString(), false);
      ComponentPolymericView.a(this.a)[paramInt] = Boolean.valueOf(true);
      if ((onk.i(paramViewGroup)) && (paramViewGroup.mPolymericInfo != null)) {
