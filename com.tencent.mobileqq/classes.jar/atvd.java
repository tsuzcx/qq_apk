  ...
  extends BaseAdapter
{
  ...
  {
    int i = 0;
    TextView localTextView = (TextView)LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560893, paramViewGroup, false);
    atwv localatwv = (atwv)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    Object localObject = localatwv.a;
    ...
    localSpannableStringBuilder.append("：").append(localatwv.c);
    paramView = localTextView.getPaint();
    localObject = new ArrayList();
    if (this.jdField_a_of_type_Int == 0) {
      this.jdField_a_of_type_Int = (vzl.a(localTextView.getContext()) - vzl.a(localTextView.getContext(), 85.0F));
    }
    paramInt = 0;
    ...
    localTextView.setOnClickListener(new atve(this, paramViewGroup));
