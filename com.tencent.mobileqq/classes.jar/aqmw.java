...
public class aqmw
{
  ...
  public static aqmw a()
  {
    ...
    {
      if (jdField_a_of_type_Aqmw == null) {
        jdField_a_of_type_Aqmw = new aqmw();
      }
      return jdField_a_of_type_Aqmw;
    }
    finally {}
  }
  ...
  public int a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      return paramInt1;
      if (aqmv.a().jdField_b_of_type_Int != -1)
      {
        paramInt1 = aqmv.a().jdField_b_of_type_Int;
        QLog.d("Q.camera.CameraWrapper", 2, "reset FRONT Cam frontCamRotate0 = " + paramInt1);
        continue;
        if (aqmv.a().jdField_c_of_type_Int != -1)
        {
          paramInt1 = aqmv.a().jdField_c_of_type_Int;
          ...
          if (aqmv.a().d != -1)
          {
            ...
            if (aqmv.a().e != -1)
            {
              ...
              case 0: 
                ...
                break;
              case 90: 
                if (aqmv.a().jdField_g_of_type_Int != -1)
                {
                  paramInt1 = aqmv.a().jdField_g_of_type_Int;
  ...
  {
    aqmv.a().a(aqmy.a(BaseApplicationImpl.getContext()), paramBoolean);
  }
  ...
  public boolean a()
  {
    ...
    boolean bool3 = false;
    if (QLog.isColorLevel()) {
      QLog.i("Q.camera.CameraWrapper", 2, "[isSysVersionValid] ENTER sysCamerOn=" + aqmv.a().jdField_b_of_type_Boolean + " sysMinVersion=" + aqmv.a().a + " sysMaxVersion=" + aqmv.a().jdField_b_of_type_JavaLangString + " currVersion=" + Build.VERSION.RELEASE);
    }
    aqmv.a().a();
    boolean bool1 = bool3;
    if (aqmv.a().jdField_b_of_type_Boolean) {}
    try
    {
      String[] arrayOfString2 = aqmv.a().a.split("\\.");
      String[] arrayOfString3 = aqmv.a().jdField_b_of_type_JavaLangString.split("\\.");
  ...
  public int b()
  {
    ...
    SharedPreferences localSharedPreferences = aqmy.b(BaseApplicationImpl.getContext());
    int i;
  ...
  {
    aqmv.a().e();
    return aqmv.a().jdField_g_of_type_Boolean;
  }
  
  public boolean c()
  {
    aqmv.a().b();
    return aqmv.a().jdField_c_of_type_Boolean;
  }
}
