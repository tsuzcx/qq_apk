...
public class ajjd
{
  private SparseArray<aiui> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private VasWebviewJsPlugin jdField_a_of_type_ComTencentMobileqqVaswebviewpluginVasWebviewJsPlugin;
  
  public ajjd(VasWebviewJsPlugin paramVasWebviewJsPlugin)
  {
  ...
  private void a(int[] paramArrayOfInt, String paramString, JSONArray paramJSONArray)
  {
    ...
    if (paramArrayOfInt != null)
    {
      ...
      {
        aiua localaiua = aitz.a().a(8, paramArrayOfInt[i]);
        if (localaiua == null) {
          j = 1;
        }
        for (;;)
      ...
      if (j != 0)
      {
        ...
        paramArrayOfInt = new ajji(this, i, paramArrayOfInt, localArrayList, localAppInterface, paramJSONArray, paramString);
        this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramArrayOfInt);
        aiue.a().a(i, paramArrayOfInt);
        aiue.a().a(localAppInterface, i, true);
      }
    }
    else
    {
    ...
    if (localArrayList.isEmpty())
    {
      ...
      a(paramString, ajya.a(2131700499), paramJSONArray);
      return;
    }
    aiub.a(localAppInterface, "", new ajjk(this, paramArrayOfInt, paramJSONArray, paramString), localArrayList, false, null);
  }
  ...
  private byte[] a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        byte[] arrayOfByte = bbdx.a(((File)localObject3).getAbsolutePath());
        if (arrayOfByte != null)
        {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Uri)localObject7).isHierarchical())
        {
          ...
          {
            localObject3 = bdik.d(URLDecoder.decode((String)localObject8));
            localObject3 = new File(ajms.j + (String)localObject3 + File.separator + (String)localObject3 + ".zip");
            ...
            if (localObject6 != null)
            {
              ...
              if (((JSONArray)localObject6).length() > 0)
              {
                ...
                if (k < i1)
                {
                  ...
                  localObject4 = aitz.a().a(8, localObject2[k]);
                  if ((localObject4 == null) || (!((aiua)localObject4).a())) {
                    break label1319;
                  }
                  m = 1;
          ...
          if (i3 != 0)
          {
            ...
            localObject3 = a(i, 1, ajms.g + i + File.separator, false);
            if (localObject3 == null) {
              break label1325;
            }
            ((ByteArrayOutputStream)localObject2).write((byte[])localObject3);
            ...
            localObject3 = a(k, 2, ajms.f + k + File.separator, false);
            if (localObject3 == null) {
              break label1335;
            }
            ((ByteArrayOutputStream)localObject2).write((byte[])localObject3);
            ...
            {
              localObject1 = (aiua)((List)localObject7).get(i);
              localObject1 = a(((aiua)localObject1).b, 8, ajms.h + ((aiua)localObject1).b + File.separator, false);
          ...
          if ((i > 0) || ((localObject1 != null) && (localObject1.length > 0))) {
            ajhu.b(localAppInterface, "", new ajje(this, (JSONArray)localObject2, (File)localObject3, localAppInterface, (String)localObject8, (int[])localObject4, str1), i, (int[])localObject1, -1, -1, false);
          }
        }
        else
        {
          localObject1 = new WebResourceResponse("application/octet-stream", "utf-8", new ajkg(null, null, null));
          a((WebResourceResponse)localObject1);
          return localObject1;
        }
      }
      catch (Exception localException)
      {
        ...
        localWebResourceResponse = new WebResourceResponse("application/octet-stream", "utf-8", new ajkg(null, null, null));
        a(localWebResourceResponse);
        QLog.e("ApolloPluginRscLoader", 1, "getCombination url 解析失败:" + paramString);
        a(d(paramString), -1, ajya.a(2131700509));
        return localWebResourceResponse;
      }
      if ((localObject3 != null) && (!((File)localObject3).exists()))
      {
        ajhu.a(localAppInterface, (String)localObject8, new ajjh(this, (String)localObject8, (File)localObject3, (JSONArray)localObject2, (int[])localObject4, str1));
      }
      else
      {
        if (!TextUtils.isEmpty((CharSequence)localObject8)) {
        ...
        {
          a(str1, ajya.a(2131700495), (JSONArray)localObject2);
        }
        else
        {
  ...
  public WebResourceResponse a(String paramString)
  {
    ...
    do
    {
      ...
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Room/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Room/")))
      {
        ...
        localObject2 = ajms.h + i + File.separator + (String)localObject1;
        ...
        localObject2 = aitz.a().a(8, i);
        if (localObject2 == null)
        {
          QLog.i("ApolloPluginRscLoader", 1, "idolRscItem == null ");
          int j = ((File)localObject1).hashCode();
          aiue.a().a(localAppInterface, j, true);
          aiue.a().a(j, new ajjl(this, i, paramString, localAppInterface, (File)localObject1));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajkg(null, null, null));
          a(paramString);
          return paramString;
          if (((aiua)localObject2).a())
          {
            if (((File)localObject1).exists())
            {
            ...
            a((String)localObject1, 1, i + ajya.a(2131700494));
          }
          else
          {
            localObject3 = new ArrayList();
            ((List)localObject3).add(localObject2);
            aiub.a(localAppInterface, "", new ajjn(this, paramString, (File)localObject1, i), (List)localObject3, false, null);
          }
        }
      }
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Role/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Role/")))
      {
        ...
        localObject2 = ajms.g + i + File.separator + (String)localObject1;
        localObject1 = new File((String)localObject2);
        if (QLog.isColorLevel()) {
          QLog.d("ApolloPluginRscLoader", 2, "getApolloRsc path:" + (String)localObject2);
        }
        ...
        if (ApolloUtil.d(i)) {
          a((String)localObject2, 1, i + ajya.a(2131700503));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajkg(null, null, null));
          ...
          ajhu.b(localAppInterface, null, new ajjo(this, (File)localObject1, (String)localObject2), i, null, -1, -1, false);
        }
      }
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Dress/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Dress/")))
      {
        ...
        localObject2 = ajms.f + i + File.separator + (String)localObject1;
        localObject1 = new File((String)localObject2);
        if (QLog.isColorLevel()) {
          QLog.d("ApolloPluginRscLoader", 2, "getApolloRsc path:" + (String)localObject2);
        }
        ...
        if (ApolloUtil.c(i)) {
          a((String)localObject2, 1, i + ajya.a(2131700515));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajkg(null, null, null));
          ...
          ajhu.b(localAppInterface, null, new ajjp(this, i, (File)localObject1, (String)localObject2), -1, new int[] { i }, -1, -1, false);
        }
      }
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Action/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Action/")))
      {
        ...
        localObject2 = ajms.d + i + File.separator + (String)localObject1;
        localObject1 = new File((String)localObject2);
        if (QLog.isColorLevel()) {
          QLog.d("ApolloPluginRscLoader", 2, "getApolloRsc path:" + (String)localObject2);
        }
        ...
        if (ApolloUtil.a(i, 0)) {
          a((String)localObject2, 1, i + ajya.a(2131700504));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajkg(null, null, null));
          ...
          ajhu.b(localAppInterface, null, new ajjq(this, (File)localObject1, (String)localObject2), -1, null, i, -1, false);
        }
      }
    ...
    try
    {
      ...
      paramString = (String)localObject3;
      localObject1 = localObject2;
      String str2 = bdik.d((String)localObject3);
    ...
    catch (Exception localException)
    {
      ...
      paramString = ajms.j + (String)localObject4 + File.separator + str3;
      localObject1 = new File(paramString);
      if (!QLog.isColorLevel()) {
        break label2612;
      }
    ...
    for (paramString = "application/json";; paramString = "application/octet-stream")
    {
      ...
      ajhu.a(localAppInterface, str1, new ajjg(this, (File)localObject1, paramString));
      localObject1 = new ajkg(null, null, null);
      if (str3.endsWith(".json")) {}
      for (paramString = "application/json";; paramString = "application/octet-stream")
      {
        paramString = new WebResourceResponse(paramString, "utf-8", (InputStream)localObject1);
