...
public class suw
  implements AdapterView.OnItemClickListener, rmb
{
  ...
  private qeg jdField_a_of_type_Qeg = new sva(this);
  ...
  public suw(Activity paramActivity)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_AndroidContentContext = paramActivity;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyLogicKandianFavoriteBroadcastReceiver = new KandianFavoriteBroadcastReceiver(this.jdField_a_of_type_Qeg);
  ...
  {
    paramString = (StructMsgForGeneralShare)bdof.a(paramBundle.getByteArray("STRUCT_MSG_BYTES"));
    if (paramString == null) {
      return new Intent();
    }
    if ((!TextUtils.isEmpty(paramString.mMsgBrief)) && (paramString.mMsgBrief.indexOf(anvx.a(2131715735)) == -1)) {
      paramString.mMsgBrief = (anvx.a(2131715730) + paramString.mMsgBrief);
    }
    usj.a(paramString);
  ...
  {
    String str1 = new suu(null, paramBaseArticleInfo.mSubscribeID, paramBaseArticleInfo.mVideoVid, String.valueOf(paramBaseArticleInfo.innerUniqueID), this.jdField_a_of_type_Spg.a(), paramBaseArticleInfo.mVideoDuration * 1000).e(paramBaseArticleInfo.mAlgorithmID).c(paramBaseArticleInfo.mStrategyId).a(this.jdField_b_of_type_Int).a().a();
    Object localObject;
    String str2;
    if ((paramInt1 != 1) && (paramInt1 != 11) && (paramInt1 != 6))
    {
      ...
      localObject = new rqg();
      ((rqg)localObject).d = ((int)this.jdField_a_of_type_Spg.a());
      ((rqg)localObject).e = (paramBaseArticleInfo.getVideoDuration() * 1000);
      if (l == 0L)
      {
        paramInt1 = 1;
        ((rqg)localObject).c = paramInt1;
        omx.a(paramBaseArticleInfo, this.jdField_b_of_type_Int, 26, -1L, (rqg)localObject);
      }
    }
    else
    {
    ...
    {
      olh.a(null, (String)localObject, "0X800740F", "0X800740F", 0, 0, "1", str2, paramBaseArticleInfo, str1, false);
      return;
      paramInt1 = 2;
      break;
    }
  ...
  private void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("network", pih.a(this.jdField_a_of_type_AndroidContentContext));
      ((JSONObject)localObject).put("os", "1");
      ((JSONObject)localObject).put("uin", String.valueOf(pkh.a()));
      ...
      ((JSONObject)localObject).put("version", omx.a);
    ...
    localObject = new suu((String)localObject);
    olh.a(null, "", "0X8009546", "0X8009546", 0, 0, "", String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mArticleID), String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mAlgorithmID), ((suu)localObject).a().a(), false);
  }
  ...
  private void a(int paramInt, BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramBaseArticleInfo.mVideoPlayCount > 0) {
        ((StringBuilder)localObject).append(six.b(paramBaseArticleInfo.mVideoPlayCount)).append(" ");
      }
      ...
      for (;;)
      {
        omy.a(localBaseActivity, str, (String)localObject, paramString, localBitmap, bool2, paramBaseArticleInfo.innerUniqueID, bool1, null);
        return;
        if (paramInt == 9)
        {
  ...
  private void a(Bundle paramBundle, String paramString1, int paramInt, String paramString2)
  {
    ...
    {
      aupt.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, 21);
      return;
    }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localObject[1] = anvx.a(2131715749);
    localObject[2] = anvx.a(2131715747);
    localObject[3] = anvx.a(2131715744);
    localObject[4] = anvx.a(2131715720);
    localObject[5] = anvx.a(2131715740);
    localObject[6] = anvx.a(2131715748);
    localObject[7] = anvx.a(2131715751);
    localObject[8] = anvx.a(2131715755);
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidUtilSparseArray.put(13, new svr(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(72, new svu(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(2, new svn(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(73, new svo(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(3, new svq(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(9, new svw(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(10, new svv(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(12, new svt(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(5, new sve(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(4, new svf(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(26, new svp(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(1, new svd(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(6, new svb(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(11, new svg(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(44, new svh(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(161, new svm(this));
    this.jdField_a_of_type_AndroidUtilSparseArray.put(134, new svc(this));
  }
  
  private void c()
  {
    if (this.jdField_a_of_type_Uuw == null) {
      this.jdField_a_of_type_Uuw = new uuw(this.jdField_a_of_type_AndroidAppActivity, a(), new svx(this));
    }
    this.jdField_a_of_type_Uuw.a().setActionSheetTitle("biu出去让更多好友看到");
    this.jdField_a_of_type_Uuw.a().setOnDismissListener(new sux(this));
    this.jdField_a_of_type_Uuw.a().setCancelListener(new suy(this));
    this.jdField_a_of_type_Uuw.a(a(), 14);
    d();
  }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new suz(this));
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, Bundle paramBundle, spg paramspg, sqc paramsqc, int paramInt)
  {
    a(paramBaseArticleInfo, paramBundle, paramspg, paramsqc, paramInt, true);
  }
  
  public void a(BaseArticleInfo paramBaseArticleInfo, Bundle paramBundle, spg paramspg, sqc paramsqc, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ogr = ((ogr)a().getBusinessHandler(BusinessHandlerFactory.ENCRYPT_UIN_HANDLER));
    if (this.jdField_a_of_type_Ogr != null) {
  ...
  public boolean a(int paramInt, @NotNull ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    int j = localsuv.a();
    int k = localsuv.b();
    localsuv.a(paramInt, localBaseArticleInfo, a(localBaseArticleInfo), paramActionSheetItem);
  ...
  public List<Integer>[] a()
  {
    ...
    if (rth.a(a(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.isForbidReprint)) {
