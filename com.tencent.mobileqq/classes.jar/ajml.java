...
public class ajml
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((str != null) && (str.equals(paramString1))) {
      return ajjy.a(2131640836);
    }
    paramString2 = babh.a(paramQQAppInterface, paramString1, paramString2, 1, 0);
    if (paramString2 == paramString1)
    {
      paramQQAppInterface = ((ajjj)paramQQAppInterface.getManager(51)).e(paramString1);
      if (paramQQAppInterface != null) {
        return babh.a(paramQQAppInterface);
      }
    }
    return paramString2;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    while (localObject1 == null)
    {
      ...
      {
        localObject1 = awbg.a((MessageForPtt)paramMessageRecord);
        i = ((MessageForPtt)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2007)
      {
        localObject1 = awbg.a((MessageForMarketFace)paramMessageRecord);
      ...
      {
        localObject1 = awbg.a((MessageForApollo)paramMessageRecord);
        i = 0;
      }
      else if ((paramMessageRecord.msgtype == -2011) || (paramMessageRecord.msgtype == -2051) || (paramMessageRecord.msgtype == -7002))
      {
        localObject1 = awbg.a((MessageForStructing)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2010)
      {
        localObject1 = awbg.a((MessageForFunnyFace)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2020)
      {
        localObject1 = awbg.a((MessageForShakeWindow)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2022)
      {
        localObject1 = awbg.a((MessageForShortVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2071)
      {
        localObject1 = awbg.a((MessageForLightVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localObject1 = awbg.a((ChatMessage)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5013)
      {
        localObject1 = awbg.c((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localObject1 = awbg.d((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5012)
      {
        localObject1 = awbg.e((MessageForPoke)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5018)
      {
        localObject1 = awbg.f((MessageForPokeEmo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localObject1 = awbg.a((MessageForLongTextMsg)paramMessageRecord, true);
        i = 0;
      }
      ...
      {
        localObject1 = awbg.a((MessageForMixedMsg)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2057)
      {
        localObject1 = awbg.a((MessageForTroopStory)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7001)
      {
        localObject1 = awbg.g((MessageForScribble)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localObject1 = awbg.c((MessageForArkBabyqReply)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localObject1 = awbg.b((MessageForArkApp)paramMessageRecord, false);
        i = 0;
      }
      else
      {
        ...
        localObject1 = awbg.b((MessageForLimitChatConfirm)paramMessageRecord);
        i = 0;
      }
    }
    if (QLog.isColorLevel()) {
    ...
    if (mnf.a(paramMessageRecord))
    {
      ...
      localObject4 = mnf.a(paramMessageRecord);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_flags.set(((mng)localObject4).jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(((mng)localObject4).jdField_a_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_id.set(ByteStringMicro.copyFrom(((mng)localObject4).jdField_a_of_type_JavaLangString.getBytes()));
      }
      if (!TextUtils.isEmpty(((mng)localObject4).jdField_b_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_nick.set(ByteStringMicro.copyFrom(((mng)localObject4).jdField_b_of_type_JavaLangString.getBytes()));
      }
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_head_portrait.set(((mng)localObject4).jdField_b_of_type_Int);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_expire_time.set(((mng)localObject4).jdField_c_of_type_Int);
      if (!TextUtils.isEmpty(((mng)localObject4).jdField_c_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_rank_color.set(ByteStringMicro.copyFrom(((mng)localObject4).jdField_c_of_type_JavaLangString.getBytes()));
      }
    ...
    do
    {
      localObject2 = amvy.a(paramMessageRecord);
      ...
      localObject2 = (akhf)paramQQAppInterface.getManager(199);
      if ((localObject2 != null) && (((akhf)localObject2).a()) && (((akhf)localObject2).a() == 1L) && ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 3000)))
      {
        localObject2 = ((akhf)localObject2).a();
        if (localObject2 != null)
        {
      ...
      if (((ajjj)paramQQAppInterface.getManager(51)).a)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject1 = awbg.a(paramQQAppInterface, paramMessageRecord, (im_msg_body.RichText)localObject1, i);
      if ((localObject1 != null) && ((paramMessageRecord instanceof MessageForStructing)))
      {
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && (rvq.a(((MessageForStructing)localObject2).structingMsg)))
        {
      ...
      localObject4 = (ajjj)paramQQAppInterface.getManager(51);
      ...
      {
        localObject3 = alyc.b(paramMessageRecord);
    ...
    for (;;)
    {
      try
      {
        localObject2 = (String)asfc.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        k = ((Integer)asfc.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        j = ((Integer)asfc.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((j >= 0) && (k >= 0)) {
          continue;
        }
        localFriends = ((ajjj)localObject4).e(paramQQAppInterface.getCurrentAccountUin());
      ...
      if (paramMessageRecord.msgtype == -2011)
      {
        ...
        k = 0;
        continue;
        localObject4 = ((ajjj)localObject4).b(paramQQAppInterface.getCurrentAccountUin());
      ...
      if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034))
      {
        ...
        alyc.a(localElem, paramMessageRecord);
      ...
      im_msg_body.Elem localElem = alyc.a(paramMessageRecord);
      if (localElem != null) {
        ((im_msg_body.RichText)localObject1).elems.add(localElem);
      }
      if (!QLog.isColorLevel()) {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, aaep paramaaep)
  {
    int i = 0;
    Object localObject1;
    boolean bool1;
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandlerUtils", 2, String.format("getPbSendReqFromBlessMsg, hongbao param, temp_id: %d, video_len: %d, redbag_id: %s, redbag_amount: %d, has_readbag: %d, has_video: %d", new Object[] { Long.valueOf(paramaaep.jdField_a_of_type_Long), Long.valueOf(paramaaep.jdField_b_of_type_Long), paramaaep.jdField_a_of_type_ArrayOfByte, Long.valueOf(paramaaep.c), Integer.valueOf(paramaaep.jdField_a_of_type_Int), Integer.valueOf(paramaaep.jdField_b_of_type_Int) }));
      }
      ((msg_svc.MultiMsgAssist)localObject1).uint64_temp_id.set(paramaaep.jdField_a_of_type_Long);
      ((msg_svc.MultiMsgAssist)localObject1).uint64_vedio_len.set(paramaaep.jdField_b_of_type_Long);
      ((msg_svc.MultiMsgAssist)localObject1).uint32_has_readbag.set(paramaaep.jdField_a_of_type_Int);
      if (paramaaep.jdField_a_of_type_Int == 1)
      {
        if (paramaaep.jdField_a_of_type_ArrayOfByte != null) {
          ((msg_svc.MultiMsgAssist)localObject1).bytes_redbag_id.set(ByteStringMicro.copyFrom(paramaaep.jdField_a_of_type_ArrayOfByte));
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint64_redbag_amount.set(paramaaep.c);
      }
      ((msg_svc.MultiMsgAssist)localObject1).uint32_has_vedio.set(paramaaep.jdField_b_of_type_Int);
    }
    int j = awbk.a(paramMessageRecord.msgUid);
    int k = (short)(int)paramMessageRecord.msgseq;
    paramaaep = paramQQAppInterface.a().a();
    ...
    if (paramaaep != null) {
      paramArrayList.sync_cookie.set(ByteStringMicro.copyFrom(paramaaep));
    }
    if (paramArrayList != null)
    {
      i = paramArrayList.toByteArray().length;
      paramaaep = (ajrm)paramQQAppInterface.a(13);
      j = paramaaep.d();
    ...
    for (;;)
    {
      ...
      if ((paramArrayList.msg_body.has()) && (((im_msg_body.MsgBody)paramArrayList.msg_body.get()).rich_text.has()))
      {
        ...
        {
          paramaaep = new im_msg_body.GeneralFlags();
          localObject1 = new generalflags.ResvAttr();
          if ((!bool1) || ((j > 0) && ((i + 7 >= j) || (j <= 0))) || (paramMessageRecord.vipBubbleDiyTextId <= 0)) {
            break label1203;
          }
          j = 1;
          paramaaep.uint32_bubble_diy_text_id.set(paramMessageRecord.vipBubbleDiyTextId);
          i = j;
          if (QLog.isColorLevel()) {
      ...
      for (i = j;; i = 0)
      {
        ...
        {
          j = 1;
          paramaaep.uint32_bubble_sub_id.set(paramMessageRecord.vipSubBubbleId);
          i = j;
          if (QLog.isColorLevel())
          {
        ...
        for (;;)
        {
          ...
          {
            i = 1;
            paramaaep.bytes_pb_reserve.set(ByteStringMicro.copyFrom(((generalflags.ResvAttr)localObject1).toByteArray()));
          }
          if (i != 0)
          {
            paramMessageRecord = new im_msg_body.Elem();
            paramMessageRecord.general_flags.set(paramaaep);
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject1 = paramMessageRecord.getExtInfoFromExtStr(awav.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localGeneralFlags.babyq_guide_msg_cookie.set(ByteStringMicro.copyFrom(paramQQAppInterface.toByteArray()));
        return localGeneralFlags;
        paramQQAppInterface = azzz.a(paramMessageRecord.msg);
        if (paramQQAppInterface == null) {
          continue;
        }
      ...
      if (paramPbSendMsgReq != null)
      {
        ...
        localObject2 = (ajrm)paramQQAppInterface.a(13);
        k = ((ajrm)localObject2).d();
        m = ((ajrm)localObject2).b();
        if (m <= 0) {
          break label3296;
        }
        localObject1 = ((BubbleManager)localObject1).a(m, false);
        if ((localObject1 != null) && ((localObject1 == null) || (((almq)localObject1).a == null) || (((almq)localObject1).a.size() <= 0))) {
          break label2164;
        }
      }
      label1866:
        ...
        for (j = k;; j = 0) {
          for (;;)
          {
            ...
            if ((paramMessageRecord instanceof MessageForFoldMsg))
            {
              i1 = i;
              n = j;
              if (agjk.a(paramQQAppInterface))
              {
                bool = agjk.b(paramQQAppInterface);
                localObject2 = (agjk)paramQQAppInterface.getManager(125);
                ...
                if (((MessageForFoldMsg)localObject1).redBagId != null)
                {
                  k = i;
                  m = j;
                  if (agjk.b(paramQQAppInterface))
                  {
                    n = 1;
                    i1 = 1;
                    if ((!bool) || (((agjk)localObject2).e)) {
                      break label2170;
                    }
                    i = 1;
                    label1018:
            ...
            if ((paramMessageRecord instanceof MessageForLongTextMsg))
            {
              ...
              localObject1 = ((ajjj)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.c());
              k = j;
              j = i;
              if (localObject1 != null)
              {
                ...
                m = 1;
                localResvAttr.uint32_mobile_custom_font.set(fv.a((ExtensionInfo)localObject1));
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if ((k & 0x1) == 1)
                  {
                    ...
                    if (!((azks)paramQQAppInterface.getManager(203)).a(paramMessageRecord)) {
                      break label2338;
                    }
                    ...
                    awbg.a(paramPbSendMsgReq, ((MessageForPtt)localObject1).mInputContent, ((MessageForPtt)localObject1).atInfoList);
                    i = k;
                ...
                catch (NumberFormatException localNumberFormatException)
                {
                  ...
                  {
                    k = i;
                    if (aeor.b((MessageForPic)paramMessageRecord))
                    {
                      i = 1;
                  ...
                  catch (Exception paramQQAppInterface)
                  {
                    try
                    {
                      ...
                      localResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(baeh.a(paramQQAppInterface.waveformArray).toByteArray()));
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localMessageRecord != null) && (localMessageRecord.msgtype == paramMessageRecord.msgtype) && (azzz.a(localMessageRecord.msg, paramMessageRecord.msg)))
        {
          ...
          befa.a().h(System.currentTimeMillis() - l);
          return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 1026) || (paramMessageRecord.istroop == 3000))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            if (akbm.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, false, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (akbm.c(paramMessageRecord.istroop))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          localObject = ((List)localObject).iterator();
          while (((Iterator)localObject).hasNext()) {
            if (akbm.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (paramMessageRecord.istroop == 7220)
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          } while (!akbm.a((MessageRecord)paramQQAppInterface.next(), paramMessageRecord, true));
          if ((QLog.isColorLevel()) && (localStringBuilder != null))
          {
            localStringBuilder.append(" filterType: other");
            QLog.w("Q.msg.MessageHandlerUtils", 2, localStringBuilder.toString());
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ArrayList<MessageRecord> paramArrayList)
  {
    return false;
  }
