  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public vqv(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Vqw = new vqw();
    this.jdField_a_of_type_Vqw.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Vqw.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Vqw.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Vqw = null;
  ...
  {
    this.jdField_a_of_type_Vqw.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Vqw.a("before updateTexImage");
