...
public class acgl
  extends mxk
{
  public acgl(TroopAssistantActivity paramTroopAssistantActivity) {}
      ...
      try
      {
        ...
        if (localRspGetGroupDynamicEntrancePicture.cover_url.has())
        {
          ...
          else
          {
            ...
            vzo.a(this.a.jdField_a_of_type_AndroidWidgetImageView, paramArrayOfByte, 68, 68, 4, vzo.b, "TroopStorySnap");
            return paramBundle;
          }
        }
      }
