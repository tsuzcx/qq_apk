...
public class amjw
  extends BaseAdapter
{
  private amjx jdField_a_of_type_Amjx;
  ...
  public amjw(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, amjx paramamjx)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentWidgetXListView = paramXListView;
    this.jdField_a_of_type_Amjx = paramamjx;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562071, this.jdField_a_of_type_ComTencentWidgetXListView, false);
      paramView = new amjy();
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131369304));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380224));
      paramView.b = ((TextView)localView.findViewById(2131380225));
      ...
      if (localObject != null)
      {
        ...
        label134:
        localView.setContentDescription(anvx.a(2131714404) + a(((SignatureManager.TopicInfo)localObject).topicStr) + anvx.a(2131714403));
      }
      if (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null)) {
        break label262;
      }
      localView.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839450));
    }
    for (;;)
    {
      EventCollector.getInstance().onListGetView(paramInt, localView, paramViewGroup, getItemId(paramInt));
      return localView;
      localObject = (amjy)paramView.getTag();
      localView = paramView;
      ...
      break label134;
      label262:
      localView.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839449));
    }
  }
}
