  ...
  implements Manager
{
  ...
  public banp(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bace.a(str, paramString1);
        if (!bool) {
          continue;
        }
        baig.c(BaseApplicationImpl.getContext(), paramInt, paramString2);
        return;
      }
      finally {}
    }
