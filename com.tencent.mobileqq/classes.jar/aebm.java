...
public class aebm
  extends Handler
{
  public aebm(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((TroopMemberListActivity.b(this.a)) && (TroopMemberListActivity.d(this.a)))
        {
          ...
          paramMessage.obj = this.a.jdField_a_of_type_Aecg.a();
          TroopMemberListActivity.a(this.a, paramMessage);
        }
        return;
        this.a.k();
        ...
        {
          if (this.a.jdField_a_of_type_Aecg.b != null) {
            this.a.jdField_a_of_type_Aecg.b.clear();
          }
      ...
      return;
    } while (this.a.jdField_a_of_type_Aecg == null);
    this.a.jdField_a_of_type_Aecg.a();
    return;
    ...
    for (this.a.n = "0"; this.a.jdField_a_of_type_Aecg != null; this.a.n = "1")
    {
      label1133:
      this.a.jdField_a_of_type_Aecg.a();
      return;
