...
public class aebm
  implements bfug
{
  public aebm(StructingMsgItemBuilder paramStructingMsgItemBuilder, ChatMessage paramChatMessage, Activity paramActivity, AbsStructMsg paramAbsStructMsg) {}
  ...
  public void a(bfuf parambfuf)
  {
    ...
    localSubscribeRequest.index.set(parambfuf.a);
    long l1 = 0L;
    try
    {
    ...
    localNewIntent.setObserver(new aebn(this, str));
