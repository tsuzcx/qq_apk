...
public class bnpk
{
  private static bnpk jdField_a_of_type_Bnpk;
  ...
  public static bnpk a()
  {
    if (jdField_a_of_type_Bnpk == null) {}
    try
    {
      if (jdField_a_of_type_Bnpk == null) {
        jdField_a_of_type_Bnpk = new bnpk();
      }
      return jdField_a_of_type_Bnpk;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                xsx.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + xsx.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
