...
public class aaej
{
  ...
  {
    aadg.a("1001" + paramString);
    aadg.a("1001" + paramString, new aalv(paramString));
  ...
  private static boolean a(Context paramContext, CertifiedAccountMeta.StFeed paramStFeed, ExtraTypeInfo paramExtraTypeInfo, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        aadg.a("1002" + paramStFeed.id.get());
        aadg.a("1002" + paramStFeed.id.get(), new aalt(paramStFeed));
      }
      if (bool2)
      {
        ...
        paramContext.startActivity(paramIntent, aame.a());
