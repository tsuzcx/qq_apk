...
public class aqsz
{
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Boolean localBoolean = (Boolean)bmqa.a("local_kd_tab_has_set");
    boolean bool3 = TextUtils.equals("1", paramString);
    bmqa.a(paramQQAppInterface, "remote_kd_tab_switch", Boolean.valueOf(bool3));
    boolean bool2;
  ...
  public void a(aqlg[] paramArrayOfaqlg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int j = 0;
        if (j < paramArrayOfaqlg.length)
        {
          if (TextUtils.isEmpty(paramArrayOfaqlg[j].a))
          {
          ...
          try
          {
            str2 = paramArrayOfaqlg[j].a.trim();
            ...
            bmqa.c(localQQAppInterface, str1);
            continue;
            if (!QLog.isColorLevel()) {
              continue;
            }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("ReadinjoyCommonConfProcessor", 2, "received readinjoy cropandgroup config error,cmd : 92" + paramArrayOfaqlg.toString());
        }
      }
      if (TextUtils.equals((CharSequence)localObject2, "feeds_group"))
      {
        bmqa.a(localQQAppInterface, str1);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "remind_only_wifi"))
      {
        bmqa.b(localQQAppInterface, str1);
      }
      ...
      {
        bmqa.d(localQQAppInterface, TextUtils.equals(str1, "1"));
      }
      else
      {
        ...
        else
        {
          ...
          if (TextUtils.equals((CharSequence)localObject2, "socializeWebUrl"))
          {
            ...
            if (localObject1 != null)
            {
              if (((Node)localObject1).getNodeType() == 1)
              {
                ...
                if (!bmqa.a((String)localObject2)) {
                  break label641;
                }
                bmqa.a(localQQAppInterface, (String)localObject2, (String)localObject3);
              }
              for (;;)
              {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_tt"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bmqa.j(localQQAppInterface, true);
            } else {
              bmqa.j(localQQAppInterface, false);
            }
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_user_apps_switch"))
          {
            ...
            bmqa.a("kandian_report_user_apps_switch", localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_times"))
          {
            ...
            bmqa.h(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_feeds"))
          {
            ...
            bmqa.i(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "feedsbackWebUrl"))
          {
            bmqa.b(localQQAppInterface, (String)localObject2, (String)localObject1);
            if (QLog.isColorLevel()) {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsSwitch"))
          {
            ...
            bmqa.k(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsName"))
          {
            ...
            bmqa.d(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsWebUrl"))
          {
            ...
            bmqa.e(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "badgeNumber"))
          {
            ...
            bmqa.y(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_word_count"))
          {
            ...
            bmqa.f(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "new_channel_style"))
          {
            ...
            bmqa.l(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time"))
          {
            ...
            bmqa.b(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds"))
          {
            ...
            bmqa.z(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi"))
          {
            ...
            bmqa.c(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_weishi"))
          {
            ...
            bmqa.A(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandianWebPreLoadData"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bmqa.o(localQQAppInterface, true);
            } else {
              bmqa.o(localQQAppInterface, false);
            }
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "ExitAIO_Android_Uin")) && (localObject1 != null))
          {
            ...
            if (localObject1.length >= 2) {
              bmqa.b(Integer.valueOf(localObject1[0]).intValue(), Integer.valueOf(localObject1[1]).intValue());
            }
          }
          ...
          {
            bmqa.a(localQQAppInterface, "remote_kd_tab_type", localObject1);
            ...
            if (!bool)
            {
              bmqa.a(localQQAppInterface, "local_kd_tab_type", localObject1);
          ...
          {
            bmqa.G(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump"))
          {
            bmqa.a(localQQAppInterface, "kd_topic_recommend_card_jump_switch", Boolean.valueOf(((String)localObject1).equals("1")));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump_url"))
          {
            bmqa.a(localQQAppInterface, "kd_topic_recommend_card_jump_url", localObject1);
          }
          ...
          else if ((TextUtils.equals((CharSequence)localObject2, "KW")) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            pha.a("kandian_aio_sp_word", localObject2, true);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_gif_switch"))
          {
            ...
            bmqa.h(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "ugc_gif_switch"))
          {
            ...
            bmqa.i(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_at_switch"))
          {
            ...
            bmqa.n(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "UGC_at_switch"))
          {
            ...
            bmqa.m(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_at_switch"))
          {
            ...
            bmqa.v(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_profile_switch"))
          {
            ...
            bmqa.o(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_BiuMsg"))
          {
            ...
            bmqa.b(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_InteractiveMsg"))
          {
            ...
            bmqa.c(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_SubscribeMsg"))
          {
            ...
            bmqa.d((String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_support"))
          {
            bmqa.p(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_preload"))
          {
            bmqa.q(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "arkapp_enable_switch"))
          {
            ...
            bmqa.b(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "exposure_strengthen"))
          {
            bmqa.r(localQQAppInterface, "1".equals(localObject1));
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "diandian_publish_switch_new"))
          {
            ...
            bmqa.p(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_publish_switch_new"))
          {
            ...
            bmqa.q(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_QA_square_autoTimeval"))
          {
            ...
            bmqa.r(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "WXShareFromKandian_Switch"))
          {
            ...
            bmqa.s(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "zhitu"))
          {
            ...
            bmqa.j(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_biu_switch"))
          {
            ...
            bmqa.t(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "native_comment_biu"))
          {
            ...
            bmqa.u(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_width_height_ratio"))
          {
            ...
            bmqa.b(localQQAppInterface, Float.valueOf((String)localObject1).floatValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_max_duration_limit"))
          {
            ...
            bmqa.w(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "record_duration_count"))
          {
            ...
            bmqa.g(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandiansettings"))
          {
            ...
            bmqa.C(localQQAppInterface, str2);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "is_show_weishi_entrance"))
          {
            ...
            bmqa.D(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_jump_to_video_content"))
          {
            ...
            bmqa.K(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_Red_Pnt_Push_Article_Preload_Switch"))
          {
            ...
            bmqa.l(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "video_switch"))
          {
            ...
            try
            {
              ...
              bool = true;
              label4507:
              bmqa.a("sp_key_readinjoy_video_entrance_reddot_button_switch", Boolean.valueOf(bool));
            }
          ...
          else
          {
            ...
            if (bool)
            {
              try
              {
                bmqa.a("sp_key_readinjoy_video_entrance_reddot_button_color", Integer.valueOf(Color.parseColor(localNumberFormatException1)));
              }
            ...
            {
              bmqa.a("sp_key_readinjoy_video_entrance_reddot_expire_time_list", localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_guanzhu_Auto_Refresh_Time_Duration"))
            {
              ...
              bmqa.a("sp_key_kandian_subscribe_auto_refresh_config", Integer.valueOf(i));
            ...
            else if (TextUtils.equals((CharSequence)localObject2, "weishi_with_channel_discovery_switch"))
            {
              ...
              bmqa.e(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ugc_upload_lbs_switch"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bmqa.a(own.READINJOY_UGC_LBS, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi_recommend"))
            {
              ...
              bmqa.b(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_counts_weishi_recommend"))
            {
              ...
              bmqa.c(localIllegalArgumentException);
            }
            else
            {
              ...
              bmqa.a("should_request_aladdin_config", Boolean.valueOf(TextUtils.equals("1", localIllegalArgumentException)));
            }
          }
        }
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              for (;;)
              {
                for (;;)
                {
                  for (;;)
                  {
                    for (;;)
                    {
                      try
                      {
                        ...
                        bool = true;
                        bmqa.a("sp_key_create_topic_switch", Boolean.valueOf(bool));
                      }
                      ...
                      {
                        bmqa.a("readinjoy_coin_item_jump_url", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                      ...
                      {
                        bmqa.a("readinjoy_coin_item_title", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                    ...
                    {
                      bmqa.a("kandianreport_ON", Integer.valueOf(Integer.parseInt(localNumberFormatException2)));
                      break;
                    }
                  ...
                  {
                    bmqa.a("kandian_daily_fast_web_bottom_share", localException3);
                    break;
                  }
                  ...
                  try
                  {
                    bmqa.f(Integer.parseInt(localException3));
                  }
                ...
                try
                {
                  bmqa.g(Integer.parseInt(localException4));
                }
              ...
              try
              {
                bmqa.h(Integer.parseInt(localException5));
              }
            ...
            try
            {
              ...
              bmqa.a("readinjoy_video_ff_probesize", Long.valueOf(Long.parseLong(localException6)));
            }
          ...
          try
          {
            ...
            bmqa.a("readinjoy_video_is_ff_probelist_switch", Integer.valueOf(Integer.parseInt(localException7)));
          }
        ...
        try
        {
          ...
          bmqa.a("readinjoy_video_is_download_async_io", Integer.valueOf(Integer.parseInt(localException8)));
        }
      ...
      {
        bmqa.a("kandian_daily_wrapper_alpha", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_default_text"))
      {
        bmqa.a("kandian_daily_wrapper_default_text", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_drag_text"))
      {
        bmqa.a("kandian_daily_wrapper_drag_text", localException9);
        break;
      }
      ...
      bmqa.a("kandian_video_extract_frame", localException9);
      break;
      label6364:
