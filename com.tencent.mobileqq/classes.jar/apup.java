  ...
  extends apov
{
  ...
  public apup(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, appt paramappt, BaseChatPie paramBaseChatPie, int paramInt4)
  {
  ...
  private int a(List<apsj> paramList, int paramInt)
  {
    return a(paramList, -1, paramInt);
  }
  
  private int a(List<apsj> paramList, int paramInt1, int paramInt2)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (m < n)
      {
        Object localObject = (apsj)paramList.get(m);
        if ((localObject instanceof apur))
        {
          localObject = (apur)localObject;
          if ((!((apur)localObject).jdField_b_of_type_Boolean) && (((apur)localObject).jdField_b_of_type_Int == paramInt2) && ((paramInt1 == -1) || (paramInt1 == ((apur)localObject).jdField_a_of_type_Int))) {
            return m;
          }
        }
        m += 1;
  ...
  public View a(apow paramapow, int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    apuq localapuq = (apuq)paramapow;
    if (getItemViewType(paramInt) == 0)
    {
      paramapow = paramView;
      if (paramView == null)
      {
        paramapow = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        ...
        paramViewGroup.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166979));
        paramapow.addView(paramViewGroup, paramView);
        localapuq.jdField_a_of_type_AndroidWidgetTextView = paramViewGroup;
        paramapow.setTag(localapuq);
      }
      paramView = (apsj)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int * paramInt);
    ...
    label1161:
    label1205:
    for (paramView = (apur)paramView;; paramView = null)
    {
      if (paramView != null) {}
      for (paramView = paramView.d;; paramView = "")
      {
        localapuq.jdField_a_of_type_AndroidWidgetTextView.setText(paramView);
        paramView = paramapow;
        int m;
        long l2;
        label750:
        do
        {
          ...
          if (paramView == null)
          {
            ...
            if (paramView == null)
            {
              ...
              paramapow = new EmoticonPanelLinearLayout(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.k);
              paramapow.setPanelType(EmoticonPanelLinearLayout.jdField_a_of_type_Int);
            ...
            for (;;)
            {
              ...
              localapuq.jdField_a_of_type_ArrayOfComTencentMobileqqEmoticonviewEmoticonImageView = new EmoticonImageView[this.jdField_a_of_type_Int];
              m = 0;
              while (m < this.jdField_a_of_type_Int)
              {
                localapuq.jdField_a_of_type_ArrayOfComTencentMobileqqEmoticonviewEmoticonImageView[m] = ((EmoticonImageView)paramView.getChildAt(m));
                m += 1;
              }
              paramapow = paramView;
              if (QLog.isColorLevel())
        ...
        if (n > this.jdField_a_of_type_JavaUtilList.size() - 1) {
          localapuq.jdField_a_of_type_ArrayOfComTencentMobileqqEmoticonviewEmoticonImageView[m].setVisibility(8);
        }
        for (;;)
        {
          m += 1;
          ...
          m = (int)(7.0F * this.jdField_a_of_type_Float);
          break;
          EmoticonImageView localEmoticonImageView = localapuq.jdField_a_of_type_ArrayOfComTencentMobileqqEmoticonviewEmoticonImageView[m];
          paramViewGroup = (apsj)this.jdField_a_of_type_JavaUtilList.get(n);
          paramView = null;
          if ((paramViewGroup instanceof apur)) {
            paramView = (apur)paramViewGroup;
          }
          if (paramView == null)
          {
          ...
          {
            localapuq.jdField_a_of_type_ArrayOfComTencentMobileqqEmoticonviewEmoticonImageView[m].setTag(paramView);
            ...
            else
            {
              ...
              if (paramViewGroup != localEmoticonImageView.getTag(2131379913))
              {
                localEmoticonImageView.setTag(2131379913, paramViewGroup);
                ...
                for (;;)
                {
                  ...
                  paramViewGroup = apog.a(paramView.jdField_b_of_type_Int);
                ...
                if (paramView.jdField_a_of_type_Int == 2) {
                  localEmoticonImageView.setContentDescription(apnz.a(paramView.jdField_b_of_type_Int));
                } else {
                  localEmoticonImageView.setContentDescription(alpo.a(2131715082));
                }
              }
            }
          }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    Object localObject = (apsj)this.jdField_a_of_type_JavaUtilList.get(m * paramInt);
    if ((localObject instanceof apur)) {}
    for (localObject = (apur)localObject;; localObject = null)
    {
      if (localObject != null)
      {
        if (((apur)localObject).jdField_a_of_type_Int == 3) {
          return 0;
        }
        return 1;
      }
