...
public class aszt
  implements Handler.Callback, awbw, bayp
{
  ...
  {
    atbp.a("NearbyIconDecoder", "notifyGetIcon", new Object[] { paramString, paramBitmap });
  ...
  {
    atbp.a("NearbyIconDecoder", "onDecodeBitmap", new Object[] { paramString1, paramString2, paramBitmap, Integer.valueOf(paramInt) });
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    atbp.a("NearbyIconDecoder", "MSG_GET_ICON_URL", new Object[] { Integer.valueOf(this.b.size()), Integer.valueOf(this.c.size()) });
