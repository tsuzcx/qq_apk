...
public class lqo
{
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      lcl.e("TipsInfo", "ProcessGestureSDK pandentInfo.gestureType drawable insert, drawable" + String.valueOf(localObject));
      return;
      label79:
      if (GestureFilterManager.sGestureType.equals("palmup")) {
        ...
        localObject = new BitmapDrawable(apvb.a(axgw.a() + paramString + ".png"));
      }
    }
  }
  ...
  public void a(lpz paramlpz, int paramInt, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    if (4 == paramlpz.a())
    {
      a(false);
    ...
    if ((paramInt > 0) || (!paramBoolean2))
    {
      ...
      if (paramBoolean1)
      {
        paramlpz = GestureMgrRecognize.getInstance().getGestureInfo();
        if ((!paramlpz.vaild) || (!paramlpz.type.equals(paramString2)))
        {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Liu.c(0);
  }
  ...
  public void b()
  {
    ...
    lcl.c("TipsInfo", "processTips showfaceTips");
    this.jdField_a_of_type_Liu.b(liu.a);
    this.b = true;
  }
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      lcl.c("TipsInfo", "showGestureTips showGestureTips mHasGestureTipsShow[" + this.jdField_a_of_type_Boolean + "]");
      if (this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_Liu.a(paramString1);
    ...
    this.jdField_a_of_type_Liu.a(localDrawable, paramString1);
  ...
  public void c()
  {
    ...
    lcl.c("TipsInfo", "processTips hideFaceTips");
    this.jdField_a_of_type_Liu.c(0);
    this.b = false;
  }
}
