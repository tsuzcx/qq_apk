...
public class mna
{
  ...
  private mnb jdField_a_of_type_Mnb;
  ...
  public mna(int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = mnd.a(paramArrayOfByte, this.d, this.e, this.f, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c);
    try
    {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if (!paramString1.exists())
    {
      ...
      if (this.jdField_a_of_type_Mnb != null) {
        this.jdField_a_of_type_Mnb.a(-2);
      }
      return;
    }
    int i;
    for (;;)
    {
      try
      {
        for (;;)
        {
          ...
          try
          {
            ...
            this.jdField_a_of_type_Mnb.a(-1);
            return;
          }
          catch (Throwable paramString2)
          {
            ...
            {
              if (this.jdField_a_of_type_Mnb != null) {
                this.jdField_a_of_type_Mnb.a(-5);
              }
      ...
      this.jdField_a_of_type_Mnb.a(-3);
      return;
      label281:
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      catch (IOException paramString2)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Mnb != null) {
            this.jdField_a_of_type_Mnb.a(this.jdField_a_of_type_JavaLangString);
          }
          ...
          catch (Throwable paramString1)
          {
            ...
            if (this.jdField_a_of_type_Mnb != null)
            {
              this.jdField_a_of_type_Mnb.a(-6);
              i = j;
            }
          }
          b();
          if ((i == 0) || (this.jdField_a_of_type_Mnb == null)) {
            break;
          }
          this.jdField_a_of_type_Mnb.b(this.jdField_b_of_type_JavaLangString);
          return;
        }
      ...
      this.jdField_a_of_type_Mnb.a(-4);
      return;
      label652:
      i = 1;
    }
