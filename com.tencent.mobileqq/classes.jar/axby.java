  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      localObject = awzq.a(paramFromServiceMsg.getWupBuffer());
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        paramFromServiceMsg = (axbv)paramIntent.getManager(12);
        if (paramFromServiceMsg != null)
        {
          ...
          notifyObserver(null, 10000, true, paramFromServiceMsg, atzn.class);
          QLog.e("Q.lebatab.GameCenterServlet", 2, "[red dot] 1");
          if (paramIntent != null)
          {
            paramFromServiceMsg = new HashMap();
            axrn.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", true, this.b - this.a, 0L, paramFromServiceMsg, "");
          }
        }
      }
      else if (paramIntent != null)
      {
        paramFromServiceMsg = "|wufbuf: " + bbea.a(paramFromServiceMsg.getWupBuffer());
        ...
        axrn.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", false, this.b - this.a, 0L, (HashMap)localObject, "");
      }
    }
    for (;;)
    {
      ...
      notifyObserver(null, 10000, false, paramIntent, atzn.class);
      return;
      if (paramIntent != null)
      {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if ((str != null) && (str.equals("gc_get_newandunreadmsg"))) {
      awzq.a(paramPacket, paramIntent);
    }
  ...
  public void service(Intent paramIntent)
  {
    ...
    if ((str != null) && ("gc_refresh_ui".equals(str)))
    {
      ...
      notifyObserver(null, 10000, true, paramIntent, atzn.class);
