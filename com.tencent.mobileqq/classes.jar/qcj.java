  ...
  implements Cloneable
{
  ...
  public SpannableStringBuilder a(ArticleInfo paramArticleInfo, String paramString, pbj parampbj)
  {
    return SocializeFeedsInfo.a(paramArticleInfo, paramString, parampbj, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public qcj a()
  {
    try
    {
      qcj localqcj = (qcj)super.clone();
      try
      {
        localqcj.jdField_a_of_type_JavaUtilList = new ArrayList();
        ...
        while (localIterator.hasNext())
        {
          ...
          localqcj.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo.a());
        }
        return localqcj;
      }
