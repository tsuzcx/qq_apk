...
class aacg
  extends mxj
{
  aacg(aacf paramaacf, asiw paramasiw) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i("DoraemonOpenAPI.permissionHelper.jobApiPermission", 2, "onResult type=" + this.jdField_a_of_type_Asiw.jdField_a_of_type_Int + ", appid=" + this.jdField_a_of_type_Asiw.jdField_a_of_type_JavaLangString + ", code=" + paramInt);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      aacf.a(this.jdField_a_of_type_Aacf, new AppInfoError(6, "jobApiPermission req error"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        aacf.b(this.jdField_a_of_type_Aacf, new AppInfoError(6, "jobApiPermission rsp invalid"));
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      {
        aacf.c(this.jdField_a_of_type_Aacf, new AppInfoError(6, "jobApiPermission parse rsp error"));
      }
      if (QLog.isColorLevel())
      {
        ...
        paramArrayOfByte = aabx.a();
        paramArrayOfByte.a(paramBundle.get_privilege_rsp.api_groups.get(), this.jdField_a_of_type_Asiw.jdField_a_of_type_JavaUtilSet);
        if (paramBundle.get_privilege_rsp.api_names.size() > 0)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (aabx.a(paramArrayOfByte, str)) {
              this.jdField_a_of_type_Asiw.jdField_a_of_type_JavaUtilSet.add(str);
            }
          }
        }
        this.jdField_a_of_type_Asiw.c = (NetConnInfoCenter.getServerTimeMillis() + Math.max(paramBundle.get_privilege_rsp.next_req_duration.get() * 1000L, 300000L));
        asjb.a().a(this.jdField_a_of_type_Asiw);
        aacf.a(this.jdField_a_of_type_Aacf, this.jdField_a_of_type_Asiw);
        return;
        label513:
        paramBundle = "";
      }
