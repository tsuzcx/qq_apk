...
public class aarj
{
  ...
  public aarj(AppInterface paramAppInterface)
  {
  ...
  private JSONObject a(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokestatic 73	nvf:a	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_3
    //   7: aload_3
    ...
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual 102	aarj:c	(Ljava/lang/String;)V
    //   54: aconst_null
    //   55: areturn
    //   56: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +42 -> 101
    //   62: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload_1
    //   66: invokevirtual 113	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   69: ifeq +32 -> 101
    //   72: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   75: aload_1
    ...
    //   138: astore_3
    //   139: aload 4
    //   141: invokestatic 137	nwj:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   144: astore_2
    //   145: aload 4
    //   147: astore_3
    //   148: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   151: ifnull +15 -> 166
    //   154: aload 4
    //   156: astore_3
    //   157: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   160: aload_1
    //   161: aload_2
    //   162: invokevirtual 141	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   165: pop
    //   166: aload_2
    //   167: astore_3
    //   168: aload 4
    //   170: ifnull -87 -> 83
    //   173: aload 4
    //   175: invokevirtual 144	java/io/BufferedInputStream:close	()V
    //   178: aload_2
    //   179: astore_3
    //   180: goto -97 -> 83
    //   183: astore_3
    //   184: aload_3
    //   185: invokevirtual 147	java/io/IOException:printStackTrace	()V
    //   188: aload_2
    //   189: astore_3
    //   190: goto -107 -> 83
    //   193: astore 5
    ...
    //   201: aload 4
    //   203: astore_3
    //   204: invokestatic 152	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   207: ifeq +16 -> 223
    //   210: aload 4
    //   212: astore_3
    //   213: ldc 154
    ...
    //   216: ldc 38
    //   218: aload 5
    //   220: invokestatic 158	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   223: aload_2
    //   224: astore_3
    //   225: aload 4
    //   227: ifnull -144 -> 83
    //   230: aload 4
    //   232: invokevirtual 144	java/io/BufferedInputStream:close	()V
    //   235: aload_2
    //   236: astore_3
    //   237: goto -154 -> 83
    //   240: astore_3
    ...
    //   252: ifnull +7 -> 259
    //   255: aload_2
    //   256: invokevirtual 144	java/io/BufferedInputStream:close	()V
    //   259: aload_1
    //   260: athrow
    //   261: astore_2
    //   262: aload_2
    //   263: invokevirtual 147	java/io/IOException:printStackTrace	()V
    //   266: goto -7 -> 259
    //   269: astore_1
    //   270: invokestatic 152	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   273: ifeq +12 -> 285
    //   276: ldc 154
    //   278: iconst_2
    //   279: ldc 38
    //   281: aload_1
    //   282: invokestatic 158	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   285: aconst_null
    //   286: astore_1
    //   287: goto -188 -> 99
    //   290: aload_0
    //   291: aload_1
    //   292: invokevirtual 102	aarj:c	(Ljava/lang/String;)V
    //   295: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   298: ifnull -284 -> 14
    //   301: getstatic 107	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   304: aload_1
    //   305: invokevirtual 161	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   308: pop
    //   309: aconst_null
    //   310: areturn
    //   311: astore_1
  ...
  public static void c()
  {
    try
    {
      Object localObject = new File(BaseApplicationImpl.getApplication().getApplicationContext().getFilesDir(), bhln.e.jdField_a_of_type_JavaLangString);
  ...
  public void a(OfflineWebRes paramOfflineWebRes)
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject1 = nvf.a(paramOfflineWebRes.bid);
          ...
          if (((File)localObject1).exists())
          {
            ...
            FileUtils.copyFile((File)localObject1, new File((File)localObject2, paramOfflineWebRes.hashName));
            if (QLog.isColorLevel()) {
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = nuz.d(paramString);
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = nwj.a(((MessageDigest)localObject3).digest());
        ...
        try
        {
          ...
          QLog.i("OfflineWebResManager", 2, "add or update url " + nuz.d(paramString) + ", cost: " + (System.currentTimeMillis() - l));
          return;
        }
