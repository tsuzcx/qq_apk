...
public class ylo
{
  ...
  private void a(DecodeConfig paramDecodeConfig, bafx parambafx, int paramInt)
  {
    ...
    paramInt = Math.min(parambafx.a, parambafx.b);
    int i = Math.max(parambafx.a, parambafx.b);
    parambafx.a = paramInt;
    parambafx.b = i;
    paramDecodeConfig.width = parambafx.a;
  ...
  public boolean a(com.tencent.biz.qqstory.takevideo.slideshow.SlideItemInfo arg1)
  {
    ...
    //   14: ifeq +12 -> 26
    //   17: getstatic 17	ylo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   20: iconst_2
    //   21: ldc 89
    ...
    //   33: new 95	bnzy
    //   36: dup
    //   37: invokespecial 96	bnzy:<init>	()V
    //   40: putfield 98	ylo:jdField_a_of_type_Bnzy	Lbnzy;
    ...
    //   165: invokevirtual 138	ylo:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 4
    //   170: new 27	bafx
    //   173: dup
    //   174: aload 12
    ...
    //   194: invokespecial 146	bafx:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 13
    //   199: aload 13
    //   201: sipush 720
    //   204: putfield 36	bafx:a	I
    //   207: aload 13
    //   209: sipush 1280
    //   212: putfield 38	bafx:b	I
    //   215: aload_1
    ...
    //   288: sipush 720
    //   291: sipush 1280
    //   294: invokestatic 152	yqs:a	(IIII)Z
    //   297: ifeq +9 -> 306
    //   300: aload 13
    //   302: iconst_1
    //   303: putfield 153	bafx:c	Z
    ...
    //   336: aload 13
    //   338: iload 4
    //   340: invokespecial 158	ylo:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lbafx;I)V
    //   343: aload 14
    //   345: iconst_1
    ...
    //   368: invokevirtual 67	ylo:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   377: ifeq +101 -> 478
    //   380: getstatic 17	ylo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   383: iconst_2
    ...
    //   478: aload_0
    //   479: getfield 98	ylo:jdField_a_of_type_Bnzy	Lbnzy;
    //   482: aload 14
    //   484: aload 13
    //   486: new 206	ylp
    //   489: dup
    //   490: aload_0
    //   491: invokespecial 209	ylp:<init>	(Lylo;)V
    //   494: aconst_null
    //   495: invokevirtual 212	bnzy:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lbafx;Lbagj;Lbnzz;)V
    //   498: aload_0
    //   499: getfield 23	ylo:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   502: astore_1
    //   503: aload_1
    //   504: monitorenter
    //   505: aload_0
    //   506: getfield 58	ylo:c	Z
    //   509: ifne +83 -> 592
    //   512: aload_0
    //   513: getfield 60	ylo:jdField_a_of_type_Boolean	Z
    //   516: ifne +76 -> 592
    //   519: aload_0
    //   520: getfield 63	ylo:b	Z
    //   523: istore 5
    //   525: iload 5
    //   527: ifne +65 -> 592
    //   530: aload_0
    //   531: getfield 23	ylo:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   593: monitorexit
    //   594: aload_0
    //   595: invokespecial 220	ylo:a	()Z
    //   598: istore 6
    //   600: iload 6
    //   602: istore 5
    //   604: invokestatic 87	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   607: ifeq -578 -> 29
    //   610: getstatic 17	ylo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   613: iconst_2
