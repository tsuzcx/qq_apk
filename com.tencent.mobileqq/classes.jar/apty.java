  ...
  implements Manager
{
  ...
  public apty(QQAppInterface paramQQAppInterface)
  {
  ...
  public List<EmosmPb.SmallYellowItem> a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() < 1))
    {
      ...
      if (i < this.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        if (j > apsp.a())
        {
          ...
          label180:
          if (!apsj.a().a(((EmosmPb.SmallYellowItem)localObject2).type.get()).a(((EmosmPb.SmallYellowItem)localObject2).id.get())) {
            break label307;
          }
          if (QLog.isColorLevel()) {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (localList != null))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (apsj.a().a(localSmallYellowItem.type.get()).a(localSmallYellowItem.id.get())) {
  ...
  public List<EmosmPb.SmallYellowItem> a(List<EmosmPb.SmallYellowItem> paramList1, List<EmosmPb.SmallYellowItem> paramList2)
  {
    ...
    for (List<EmosmPb.SmallYellowItem> localList = paramList2;; localList = null)
    {
      ...
      for (;;)
      {
        ...
        Collections.sort(localList, new aptz(this));
        d(localList);
        ...
        while (paramList2.hasNext())
        {
          ...
          if ((paramList1.contains(str)) || (apsj.a().a(localSmallYellowItem.type.get()).a(localSmallYellowItem.id.get()))) {
            paramList2.remove();
          } else {
            paramList1.add(str);
          }
  ...
  public void a(File paramFile1, File paramFile2)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      localObject2 = bdhb.a(paramFile1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if (localSmallYellowItem.id.get() == bamd.c[i]) {
            ((Iterator)localObject2).remove();
          }
        }
        else
        {
          ...
          bdhb.a(paramFile2.getAbsolutePath(), paramFile1.toByteArray(), false);
          return;
        }
      }
  ...
  public void a(List<EmosmPb.SmallYellowItem> paramList)
  {
    ...
    this.jdField_a_of_type_Boolean = apzf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    if (QLog.isColorLevel())
    {
  ...
  public List<EmosmPb.SmallYellowItem> c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      localObject3 = bdhb.a((File)localObject3);
