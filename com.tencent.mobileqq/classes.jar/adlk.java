...
public class adlk
  ...
  implements adkv
{
  private List<adlj> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  protected void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new adli());
      this.jdField_a_of_type_JavaUtilList.add(new adln());
      this.jdField_a_of_type_JavaUtilList.add(new adlm());
      return;
    }
