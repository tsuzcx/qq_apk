  ...
  implements Handler.Callback, INetEngine.IBreakDownFix, INetEngine.INetEngineListener, Manager
{
  ...
  public abvh(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(abvq paramabvq)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 54	abvq:b	()Z
    //   4: ifne +4 -> 8
    //   7: return
    //   8: aload_1
    //   9: invokevirtual 57	abvq:b	()Ljava/lang/String;
    ...
    //   112: invokestatic 106	abvg:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   115: aload_2
    //   116: astore_1
    //   117: aload_2
    //   118: aload 5
    ...
    //   133: invokestatic 106	abvg:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   136: aload_2
    //   137: astore_1
    //   138: aload_2
    //   139: aload 6
    ...
    //   154: invokestatic 106	abvg:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   157: aload_2
    //   158: astore_1
    //   159: aload_2
    //   160: ldc 108
    ...
    //   214: aload 5
    //   216: invokestatic 106	abvg:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   219: aload_2
    //   220: ifnull -213 -> 7
    //   223: aload_2
    ...
    //   252: invokestatic 106	abvg:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   255: goto -36 -> 219
    //   258: astore_3
    //   259: aload_2
    //   260: astore_1
  ...
  {
    abvi localabvi = (abvi)paramNetResp.mReq.getUserData();
    if ((localabvi == null) || (localabvi.jdField_a_of_type_Abvq == null))
    {
    ...
    long l2 = localabvi.jdField_a_of_type_Long;
    String str3 = localabvi.jdField_a_of_type_Abvq.b();
    String str1 = localabvi.jdField_a_of_type_Abvq.c();
    int i = localabvi.jdField_a_of_type_Abvq.c();
    ...
    for (;;)
    {
      try
      {
        ...
        boolean bool2 = true;
        boolean bool1 = bool2;
        if (!localabvi.jdField_a_of_type_Abvq.b())
        {
          bool1 = bool2;
          if (PatchCommonUtil.isArtGeN()) {
            bool1 = abvj.a(localabvi.jdField_a_of_type_Abvq);
          }
        }
        bool2 = bool1;
        if (bool1) {
          bool2 = PatchChecker.checkPatchValid(localabvi.jdField_a_of_type_JavaLangString, str3);
        }
        if (bool2)
        {
          a(localabvi.jdField_a_of_type_Abvq);
          aafi.c();
          aafi.a(amtj.a(2131707012));
      ...
      if (paramNetResp.exists())
      {
        ...
        if (paramNetResp.mResult != 0)
        {
          ...
          if (l2 - l1 > 21600000L)
          {
            bcdb.a(new RuntimeException(), str3);
        ...
        if (localabvi.jdField_a_of_type_Int < 3)
        {
          a(localabvi.jdField_a_of_type_Int, localabvi.jdField_a_of_type_JavaLangString, localabvi.jdField_a_of_type_Abvq);
          return;
        }
        aafi.c();
  ...
  public void a(int paramInt, String paramString, abvq paramabvq)
  {
    String str1 = paramabvq.d();
    String str2 = paramabvq.c();
    ...
    localHttpNetReq.setUserData(new abvi(this, paramInt + 1, SystemClock.elapsedRealtime(), paramString, paramabvq));
