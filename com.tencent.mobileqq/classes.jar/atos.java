  ...
  extends Handler
{
  ...
  public atos(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        do
        {
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              ...
                              do
                              {
                                ...
                                localatov = (atov)paramMessage.obj;
                              } while (localatov == null);
                              ...
                              for (paramMessage = "null";; paramMessage = QQMusicPlayService.b().a())
                              {
                                ...
                                {
                                  localatov.a.release();
                                  if (QQMusicPlayService.a() == localatov.a) {
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.b())) && ((QQMusicPlayService.e() == 2) || (QQMusicPlayService.e() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          atoq.a(i, bdin.b((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        atoq.b(QQMusicPlayService.b(), QQMusicPlayService.d());
                      }
          ...
          } while (!bdin.g(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
