...
public class aouk
{
  private static final String jdField_a_of_type_JavaLangString = aouk.class.getSimpleName();
  ...
  public void a(Context paramContext)
  {
    ...
    int i = apff.a(jdField_a_of_type_JavaLangString, paramContext, 35633, "attribute vec4 a_Position;\nattribute vec2 a_TexCoord;\n\nvarying vec2 v_TexCoord;\n\nvoid main() {\n   gl_Position = a_Position;\n   v_TexCoord = a_TexCoord;\n}");
    int j = apff.a(jdField_a_of_type_JavaLangString, paramContext, 35632, "\n#extension GL_OES_EGL_image_external : require\n\nprecision mediump float;\nvarying vec2 v_TexCoord;\nuniform samplerExternalOES sTexture;\n\n\nvoid main() {\n    gl_FragColor = texture2D(sTexture, v_TexCoord);\n}");
    ...
    apff.a(jdField_a_of_type_JavaLangString, "program creation");
    ...
    apff.a(jdField_a_of_type_JavaLangString, "program parameters");
  }
  
  public void a(FloatBuffer paramFloatBuffer)
  {
    apff.a(jdField_a_of_type_JavaLangString, "before draw");
    ...
    apff.a(jdField_a_of_type_JavaLangString, "after draw");
  }
}
