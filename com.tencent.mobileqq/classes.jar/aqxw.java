  ...
  extends Handler
{
  ...
  public aqxw(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        do
        {
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                paramMessage = (aqxz)paramMessage.obj;
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.a())) && ((QQMusicPlayService.d() == 2) || (QQMusicPlayService.d() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          aqxu.a(i, badq.b((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        aqxu.b(QQMusicPlayService.b(), QQMusicPlayService.c());
                      }
          ...
          } while (!badq.g(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
