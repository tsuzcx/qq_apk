...
public class uhp
  extends uhj
{
  public uhp(View paramView, BaseData paramBaseData, WeakReference<Context> paramWeakReference)
  {
  ...
  {
    ViewFactory.findClickableViewListener(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), new uhq(this, paramBaseData, paramContext));
  }
