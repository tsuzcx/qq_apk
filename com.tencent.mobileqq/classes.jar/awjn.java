...
public class awjn
{
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong, TroopTips0x857.NotifyMsgBody paramNotifyMsgBody)
  {
    ...
    if (i == 4)
    {
      awni.b(paramQQAppInterface, String.valueOf(l));
      localawiz.notifyUI(5, true, new Object[] { Integer.valueOf(1), String.valueOf(l) });
      awnj.a(paramQQAppInterface);
    }
    for (;;)
    {
      localawiz.notifyUI(3, true, new Object[] { paramNotifyMsgBody });
      return;
      if ((i == 1) || (i == 2))
      {
        awnj.a(paramQQAppInterface, 1, String.valueOf(l), true);
      }
      else
      {
        if (i == 5)
        {
          ...
          awni.b(paramQQAppInterface, String.valueOf(l));
          localawiz.notifyUI(6, true, new Object[] { Integer.valueOf(1), String.valueOf(l), Integer.valueOf(paramInt) });
          awnj.a(paramQQAppInterface);
          continue;
        }
        if (i == 3) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 == paramQQAppInterface.getLongAccountUin()) {
      awiz.a(paramQQAppInterface).a(new awit(1, String.valueOf(paramLong2)), false);
    }
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, TroopTips0x857.LbsShareChangePushInfo paramLbsShareChangePushInfo, int paramInt)
  {
    ...
    paramLbsShareChangePushInfo = new awit(1, String.valueOf(l1));
