...
public class awjn
{
  ...
  public static Pair<awje, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((awje)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((awje)localObject4).a;
        }
      }
      localObject3 = paramString;
  ...
  {
    if (bdag.a()) {
      return aljq.aX + "pddata/prd/" + "res_precover";
    }
