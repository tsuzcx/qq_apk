  ...
  extends blbl
{
  ...
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { alpo.a(2131689857), alpo.a(2131689858), alpo.a(2131689859) };
  ...
  public bkxe(Activity paramActivity, View paramView, blbm paramblbm)
  {
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    localAnimationSet.setAnimationListener(new bkxg(this, paramRunnable));
  ...
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (blev.a().a("has_enter_aio_gif", false, 0)) {
      return false;
    }
    return true;
  }
  ...
  private void e()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new bkxf(this));
  ...
  private void f()
  {
    ...
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.setAnimationListener(new bkxh(this));
    this.jdField_b_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  private void k()
  {
    ...
    blev.a().a("has_enter_aio_gif", true, 0);
  }
  ...
  protected void a()
  {
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131366499);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367193);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131367194));
  }
