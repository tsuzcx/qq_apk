  ...
  extends mpl
{
  ...
  private boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    //   1: astore 12
    //   3: aload_0
    //   4: getfield 113	mpn:i	Ljava/lang/String;
    //   7: astore 6
    ...
    //   61: ifnull +708 -> 769
    //   64: ldc 139
    //   66: invokestatic 144	amtj:a	(I)Ljava/lang/String;
    //   69: aload_2
    ...
    //   274: aload_0
    //   275: invokevirtual 206	mpn:a	()Lmpe;
    //   278: astore 14
    //   280: aload_2
    //   281: astore 13
    //   283: aload 9
    ...
    //   324: astore 11
    //   326: aload 14
    //   328: getfield 211	mpe:a	Lmpk;
    //   331: getfield 217	mpk:jdField_c_of_type_Boolean	Z
    //   334: ifeq +59 -> 393
    //   337: aload_2
    //   338: astore 13
    //   340: aload 9
    ...
    //   346: astore 11
    //   348: aload 14
    //   350: getfield 211	mpe:a	Lmpk;
    //   353: getfield 219	mpk:a	Ljava/lang/String;
    //   356: aload_0
    //   357: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   360: getfield 225	mqb:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   363: invokestatic 228	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   366: ifeq +27 -> 393
    //   369: ldc 230
    //   371: astore 13
    //   373: aload 14
    //   375: getfield 211	mpe:a	Lmpk;
    //   378: getfield 233	mpk:b	Ljava/lang/String;
    //   381: astore 11
    //   383: aload 14
    //   385: getfield 211	mpe:a	Lmpk;
    //   388: getfield 234	mpk:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   391: astore 12
    //   393: aload 13
    //   395: aload 11
    //   397: aload 12
    //   399: invokestatic 236	mpn:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   402: istore_3
    //   403: aload_0
    //   404: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   407: aload 13
    //   409: putfield 237	mqb:i	Ljava/lang/String;
    //   412: aload_0
    //   413: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   416: aload 8
    //   418: putfield 238	mqb:h	Ljava/lang/String;
    //   421: aload_0
    //   422: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   425: aload 10
    //   427: putfield 239	mqb:g	Ljava/lang/String;
    //   430: aload_0
    //   431: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   434: aload 11
    //   436: putfield 242	mqb:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   439: aload_0
    //   440: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   443: aload 12
    //   445: putfield 245	mqb:f	Ljava/lang/String;
    //   448: aload_0
    //   449: getfield 113	mpn:i	Ljava/lang/String;
    //   452: iconst_1
    ...
    //   495: aload_0
    //   496: getfield 190	mpn:g	Ljava/lang/String;
    ...
    //   507: aload_0
    //   508: getfield 194	mpn:h	Ljava/lang/String;
    ...
    //   590: istore 4
    //   592: aload_0
    //   593: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   596: iload 4
    //   598: putfield 269	mqb:jdField_e_of_type_Int	I
    //   601: aload_0
    //   602: invokevirtual 271	mpn:b	()V
    //   605: aload_0
    //   606: getfield 221	mpn:jdField_a_of_type_Mqb	Lmqb;
    //   609: invokestatic 276	mpz:b	(Lmqb;)V
    //   612: iconst_1
    //   613: ireturn
    //   614: iconst_0
    //   615: istore 5
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Mqb.jdField_e_of_type_Int = 4;
    b();
  }
  
  public boolean a(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity, mqb parammqb, WeakReference<mpo> paramWeakReference)
  {
    ...
    long l = mqa.a(paramVideoAppInterface);
    if (l == 0L)
    {
      QLog.w(this.i, 1, "GetRedBag, userId为空");
      parammqb.jdField_e_of_type_Int = 2;
      return false;
    }
    ...
    try
    {
      ...
      localJSONObject2.put("listid", parammqb.jdField_c_of_type_JavaLangString);
      localJSONObject2.put("authkey", parammqb.d);
      ...
      if ((paramAVActivity != null) && (paramAVActivity.b() != -1) && (paramAVActivity.b() != 5))
      {
        ...
        QLog.w(this.i, 1, "GetRedBag, userName[" + str + "], userId[" + l + "], redPocketId[" + parammqb.jdField_c_of_type_JavaLangString + "], json[" + AudioHelper.a(localJSONObject1) + "], Activity[" + paramAVActivity + "]");
        parammqb.jdField_e_of_type_Int = 1;
        return true;
      }
    }
  ...
  void b()
  {
    ...
    {
      mpo localmpo = (mpo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localmpo != null) {
        localmpo.a(this);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ltf.b(bool, this.jdField_a_of_type_Mqb.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Mqb.f);
      return;
    }
  }
}
