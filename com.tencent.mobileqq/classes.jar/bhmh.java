  ...
  extends MSFServlet
{
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    localObject2 = new bhmg((String)localObject2, str3, 2020014, paramIntent.getLong("uin"), str1, str2, str5, localArrayList, l, str4, i, localMap, ((QZoneShareData)localObject1).jdField_b_of_type_JavaUtilMap);
    localObject1 = ((bhmg)localObject2).encode();
    paramIntent = (Intent)localObject1;
    if (localObject1 == null) {
      paramIntent = new byte[4];
    }
    paramPacket.setTimeout(60000L);
    paramPacket.setSSOCommand("SQQzoneSvc." + ((bhmg)localObject2).uniKey());
