...
{
  public bijz(QQComicPluginBridge.1 param1) {}
  ...
  {
    if ((this.a.a != null) && (this.a.a.jdField_a_of_type_Bika != null)) {
      this.a.a.jdField_a_of_type_Bika.a(98, "载入中,（我会越来越快的>_<）");
    }
  }
  ...
  public void onInstallDownloadProgress(String paramString, int paramInt1, int paramInt2)
  {
    if ((this.a.a != null) && (paramInt1 > 0) && (paramInt2 > 0))
    {
      ...
      if (this.a.a.jdField_a_of_type_Bika != null)
      {
        paramInt1 = (int)(paramInt1 / paramInt2 * 95.0F);
        this.a.a.jdField_a_of_type_Bika.a(paramInt1, "加载中,（别紧张啊我很小的>_<）");
      }
    }
  }
  ...
  public void onInstallFinish(String arg1)
  {
    synchronized ()
    {
      ...
      if (this.a.a != null)
      {
        ...
        if (this.a.a.jdField_a_of_type_Bika != null) {
          this.a.a.jdField_a_of_type_Bika.a(99, "载入中,（我会越来越快的>_<）");
        }
      }
      if (QLog.isColorLevel()) {
