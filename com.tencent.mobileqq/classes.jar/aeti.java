  ...
  extends BaseAdapter
{
  ...
  public ArrayList<bdzc> a;
  public boolean a;
  public int b;
  
  public aeti(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      while (i < this.jdField_a_of_type_Int)
      {
        ...
        ((LinearLayout)localObject1).addView(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560785, null), (ViewGroup.LayoutParams)localObject2);
        i += 1;
    ...
    for (;;)
    {
      ...
      for (paramViewGroup = (bdzc)this.jdField_a_of_type_JavaUtilArrayList.get(k);; paramViewGroup = null)
      {
