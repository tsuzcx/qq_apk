...
public class apuw
{
  ...
  public static apux a(int paramInt1, int paramInt2, apuy paramapuy, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramapuy.jdField_a_of_type_Int)
        {
        default: 
          paramapuy = new apux();
          paramapuy.jdField_a_of_type_Int = paramInt1;
          paramapuy.b = paramInt2;
          return paramapuy;
        }
      }
      break;
  ...
  public static apux a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    ...
    if (bbdj.b(paramString))
    {
      ...
      localapux.jdField_a_of_type_Int = localOptions.outWidth;
      localapux.b = localOptions.outHeight;
      paramString = localapux;
  ...
  public static apux a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      apuy localapuy = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localapuy, false);
      i = paramInt1;
    }
  }
  
  public static apux a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (bbdj.b(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localapux.jdField_a_of_type_Int = localOptions.outWidth;
      localapux.b = localOptions.outHeight;
      paramFileManagerEntity = localapux;
  ...
  private static apuy a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      apuy localapuy = new apuy();
      localapuy.jdField_a_of_type_Int = paramInt2;
      localapuy.b = paramInt1;
      return localapuy;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = bfkp.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = bfkp.a(paramFileManagerEntity.Uuid);
      }
      else if (apvb.b(paramFileManagerEntity.getFilePath()))
      {
        localObject = apue.d(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = bbdm.a((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = bfkp.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = bbdm.a(apue.d(paramString));
      a();
      str1 = apti.a().d() + a(5, str1);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            if (!bbdj.b(str2)) {
              auoy.a(paramString, str2, true, "", 1);
            }
            if ((!bbdj.b(str2)) || (bbdj.b(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        auoy.a(paramString1, str, true, "", paramInt);
        if (bbdj.b(str)) {
          break label220;
        }
      ...
      continue;
      label220:
      if (!bbdj.b(new File(str), new File(paramString2)))
      {
        bbdj.a(str, true);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = bbdm.a(apue.d(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = apti.a().d() + a(5, bfkp.a((String)localObject2));
    if ((bbdj.b(str)) && (!apvb.b(paramFileManagerEntity.strMiddleThumPath)) && (bbdj.b(new File(str), new File((String)localObject1)) == true)) {
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, apti.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  public static boolean a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    while ((paramFileManagerEntity.cloudType == 1) && (apue.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
