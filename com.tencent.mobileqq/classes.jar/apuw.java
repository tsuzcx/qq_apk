  ...
  extends appw
{
  ...
  public static List<appw> a(int[] paramArrayOfInt)
  {
    ...
    {
      apuw localapuw = new apuw();
      localapuw.jdField_a_of_type_Int = paramArrayOfInt[i];
      localapuw.jdField_c_of_type_Int = 1;
      localArrayList.add(localapuw);
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < m)
        {
          ...
          if ((n < 0) || (n >= bahu.jdField_a_of_type_Int)) {
            break label218;
          }
          int k = i + 1;
          paramAppRuntime[i] = n;
  ...
  {
    return baiy.a(this.jdField_a_of_type_Int, false);
  }
  
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    if (this.d == 1) {
      azmj.b(null, "CliOper", "", "", "0X8005507", "0X8005507", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      int i = paramEditText.getSelectionStart();
      int j = paramEditText.getSelectionEnd();
      paramEditText.getEditableText().replace(i, j, baiy.c(this.jdField_a_of_type_Int));
      paramEditText.requestFocus();
      return;
      if (this.d == 2) {
        azmj.b(null, "CliOper", "", "", "0X8005508", "0X8005508", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    return baiy.a(this.jdField_a_of_type_Int, true);
  }
}
