  ...
  extends utm<uud>
{
  ...
  private void a(RecyclerView paramRecyclerView, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      if ((localObject instanceof uvf))
      {
        localObject = (uvf)localObject;
        localstSimpleMetaPerson = ((uvf)localObject).a();
      ...
      for (;;)
      {
        i += 1;
        break;
        if ((localObject instanceof uvb))
        {
          localObject = (uvb)localObject;
          localstSimpleMetaPerson = ((uvb)localObject).a();
          if ((localstSimpleMetaPerson != null) && (TextUtils.equals(localstSimpleMetaPerson.id, paramString))) {
            ((uvb)localObject).b();
          }
        }
  ...
  {
    if ((a() == null) || (((uud)a()).a() == null)) {}
    RecyclerViewWithHeaderFooter localRecyclerViewWithHeaderFooter;
    do
    {
      return;
      localRecyclerViewWithHeaderFooter = ((uud)a()).a().a();
    ...
    if (i < j)
    {
      ...
      a(((upf)localViewHolder).a(), paramString);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label99:
      if ((localViewHolder instanceof upc)) {
        a(((upc)localViewHolder).a(), paramString);
      }
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    Iterator localIterator = ((uud)a()).a().a().iterator();
    label42:
    StringBuilder localStringBuilder;
    while (localIterator.hasNext())
    {
      localObject = (bjwy)localIterator.next();
      if ((localObject instanceof uou))
      {
        localObject = (uou)localObject;
        ((uou)localObject).a(paramBoolean);
        localStringBuilder = new StringBuilder().append("updateMuteStatus title:");
        if (((uou)localObject).a == null) {
          break label124;
        }
      }
    }
    label124:
    for (Object localObject = ((uou)localObject).a.d;; localObject = "videoInfo is null!")
    {
      uya.e("WSFollowPresenter", (String)localObject);
      break label42;
      break;
    }
  }
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      RecyclerViewWithHeaderFooter localRecyclerViewWithHeaderFooter = ((uud)a()).a().a();
      if (localRecyclerViewWithHeaderFooter != null)
      {
        ...
        while (i < j)
        {
          ...
          {
            localObject = (uou)localObject;
            stFeed localstFeed = ((uou)localObject).a();
  ...
  private void c(WSSimpleBaseEvent paramWSSimpleBaseEvent)
  {
    ...
    if (localWSFriendFeedExposureEvent == null)
    {
      ...
      uya.b("WSFollowPresenter", paramWSSimpleBaseEvent);
    ...
    for (;;)
    {
      ...
      break;
      label68:
      paramWSSimpleBaseEvent = ((uud)a()).a();
      if ((paramWSSimpleBaseEvent != null) && (paramWSSimpleBaseEvent.a() != null))
      {
        ...
        if ((paramWSSimpleBaseEvent != null) && (paramWSSimpleBaseEvent.a() != null))
        {
          ...
          for (;;)
          {
            ...
            if ((localObject instanceof upc))
            {
              paramWSSimpleBaseEvent = ((upc)localObject).a();
      ...
      if (localRecyclerViewWithHeaderFooter != null)
      {
        ...
        while (i < j)
        {
          ...
          if ((localObject instanceof uou))
          {
            ...
            {
              uya.b("WSFollowPresenter", "updateLikeStatus");
              ((uou)localObject).e();
            }
          }
          i += 1;
        ...
        if ((localObject2 != null) && (((XRecyclerView)localObject2).a() != null))
        {
          ...
          while (i < localList.size())
          {
            if (((stFeed)localList.get(i)).feed == localObject1)
            {
              ...
              uya.b("WSFollowPresenter", "receive item expose event, position: " + i + ", feed: " + ((stSimpleMetaFeed)localObject1).feed_desc);
              return;
            }
            i += 1;
          }
      ...
      if (localRecyclerViewWithHeaderFooter != null)
      {
        ...
        while (i < j)
        {
          ...
          if ((localObject instanceof uou))
          {
            ...
            stFeed localstFeed = ((uou)localObject).a();
            if ((localstFeed != null) && (localstFeed.feed != null) && (TextUtils.equals(localstFeed.feed.id, paramString))) {
              ((uou)localObject).a(localstFeed.feed);
            }
          }
          i += 1;
        }
  ...
  {
    uya.b("WSFollowPresenter", "[handleOnReceiveEventForFollow]");
    paramWSSimpleBaseEvent = (FollowEvent)paramWSSimpleBaseEvent;
    Object localObject1 = ((uud)a()).a();
    if ((localObject1 == null) || (((ujh)localObject1).a() == null)) {
      return;
    }
    localObject1 = ((ujh)localObject1).a();
    int i = 0;
    label50:
    Object localObject2;
  ...
  private void f(WSSimpleBaseEvent paramWSSimpleBaseEvent)
  {
    ...
    uya.b("WSFollowPresenter", "handleVideoPlayEvent mCurrentPosition: " + paramWSSimpleBaseEvent.mCurrentPosition);
  }
  
  private void g(WSSimpleBaseEvent paramWSSimpleBaseEvent)
  {
    paramWSSimpleBaseEvent = (LikeRspEvent)paramWSSimpleBaseEvent;
    uya.b("WSFollowPresenter", "handleLikeEvent feedId: " + paramWSSimpleBaseEvent.getFeedId() + " isDing:" + paramWSSimpleBaseEvent.getRspIsDing());
    Object localObject = ((uud)a()).a();
    if ((localObject == null) || (((ujh)localObject).a() == null)) {
      return;
    }
    localObject = ((ujh)localObject).a();
    int i = 0;
    label83:
    stFeed localstFeed;
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    unc.a().a(paramBoolean1, paramBoolean2, "", 9, l, new utq(this, paramBoolean1));
  }
}
