...
public class bdbx
{
  ...
  public ArrayList<TroopMemberCardInfo> a(QQAppInterface paramQQAppInterface, String paramString, ArrayList<friendlist.stUinInfo> paramArrayList)
  {
    ...
    //   24: astore 8
    //   26: aload_1
    //   27: invokevirtual 138	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   30: invokevirtual 144	awbx:createEntityManager	()Lawbw;
    //   33: astore 6
    //   35: aload 6
    //   37: invokevirtual 169	awbw:a	()Lawby;
    //   40: astore 7
    //   42: aload 7
    //   44: invokevirtual 172	awby:a	()V
    //   47: iconst_0
    //   48: istore 4
    //   50: iload 4
    //   52: aload_3
    ...
    //   92: aastore
    //   93: invokevirtual 151	awbw:a	(Ljava/lang/Class;[Ljava/lang/String;)Lawbv;
    ...
    //   242: aload 6
    //   244: aload_1
    //   245: invokevirtual 238	awbw:a	(Lawbv;)Z
    //   248: pop
    //   249: aload 8
    //   251: aload_1
    ...
    //   279: aload 6
    //   281: aload_1
    //   282: invokevirtual 246	awbw:a	(Lawbv;)V
    //   285: goto -36 -> 249
    //   288: astore_1
    //   289: aload_1
    //   290: invokevirtual 156	java/lang/Exception:printStackTrace	()V
    //   293: aload 7
    //   295: invokevirtual 248	awby:b	()V
    //   298: aload 6
    //   300: invokevirtual 153	awbw:a	()V
    //   303: aconst_null
    //   304: areturn
    //   305: aload 7
    //   307: invokevirtual 251	awby:c	()V
    //   310: aload 7
    //   312: invokevirtual 248	awby:b	()V
    //   315: aload 6
    //   317: invokevirtual 153	awbw:a	()V
    //   320: aload 8
    //   322: areturn
    //   323: astore_1
    //   324: aload 7
    //   326: invokevirtual 248	awby:b	()V
    //   329: aload 6
    //   331: invokevirtual 153	awbw:a	()V
    //   334: aload_1
    //   335: athrow
    ...
    //   48	213	4	i	int
    //   105	170	5	j	int
    //   33	297	6	localawbw	awbw
    //   40	285	7	localawby	awby
  ...
  public Map<String, Integer> a(List<String> paramList, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    alxj localalxj = (alxj)paramQQAppInterface.getManager(40);
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        RoamSetting localRoamSetting = localalxj.a(str2);
    ...
    if (localArrayList.size() > 0) {
      this.a.a(new DBUtils.1(this, localArrayList, localalxj));
    }
    return localHashMap;
  }
  ...
  public void a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    ((alxj)paramQQAppInterface.getManager(40)).a(paramInt);
  }
  
  public void a(Context paramContext)
  {
    int i = aowf.a(paramContext);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, Context paramContext)
  {
    ...
    paramString2.commit();
    ((alxj)paramQQAppInterface.getManager(40)).a(paramString1);
  }
  ...
  public void a(ArrayList<Setting> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      label223:
      RoamSetting localRoamSetting = localalxj.a(str, paramQQAppInterface);
      if (localRoamSetting != null) {
      ...
      if (("message.ring.switch".equals(str)) || ("message.vibrate.switch".equals(str)) || ("message.ring.care".equals(str)))
      {
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            {
              ThreadManager.post(new DBUtils.2(this, localalxj, localArrayList), 5, null, false);
              if (localObject == null) {}
            }
            try
            {
    ...
    for (;;)
    {
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject = (TroopMemberCardInfo)localawbw.a(TroopMemberCardInfo.class, new String[] { paramString, String.valueOf(localstTroopRemarkInfo.MemberUin) });
          int j;
          if (localObject != null)
          {
            j = 1;
            ...
            ((TroopMemberCardInfo)localObject).colorNick = bdnm.a(localstTroopRemarkInfo.sName.getBytes());
            if (((TroopMemberCardInfo)localObject).colorNick == null) {
              ((TroopMemberCardInfo)localObject).colorNick = localstTroopRemarkInfo.sName;
            }
            ((TroopMemberCardInfo)localObject).name = bdnm.b(((TroopMemberCardInfo)localObject).colorNick);
            ...
            if (j != 0)
            {
              ...
              TroopMemberInfo localTroopMemberInfo = (TroopMemberInfo)localawbw.a(TroopMemberInfo.class, new String[] { paramString, String.valueOf(localstTroopRemarkInfo.MemberUin) });
