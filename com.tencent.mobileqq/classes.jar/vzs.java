  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  public vzs(Activity paramActivity)
  {
    super(paramActivity, 2131689851);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131493113, null);
    a();
    setCancelable(true);
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131299226));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131297984));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText = ((CommentEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131311296));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnInputBackListener(new vzt(this));
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131298021));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131298061));
    ...
    this.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("GroupSoftKeyboardHeight", aciy.a(250.0F, getContext().getResources()));
    QLog.d("CommentInputPopupWindow", 1, "mEmojiPanel initView() step1 :" + this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_a_of_type_Int = awmc.a(250.0F);
      QLog.d("CommentInputPopupWindow", 1, "mEmojiPanel initView() step2 :" + this.jdField_a_of_type_Int);
    }
    this.jdField_a_of_type_ComTencentBizSubscribeCommentEmoView = ((EmoView)this.jdField_a_of_type_AndroidViewView.findViewById(2131299983));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131297748);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new vzu(this));
  ...
  private void f()
  {
    this.jdField_a_of_type_Wbj = new wbj(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_Wbj.a(new vzv(this));
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnEditorActionListener(new vzw(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.addTextChangedListener(new vzx(this));
  }
  ...
  public void a(vze paramvze)
  {
    this.jdField_a_of_type_Vze = paramvze;
  }
  
  public void a(vzy paramvzy)
  {
    this.jdField_a_of_type_Vzy = paramvzy;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131298061: 
      do
      {
        ...
        return;
      } while (this.jdField_a_of_type_Vze == null);
  ...
  {
    this.jdField_a_of_type_Wbj.a();
    this.jdField_a_of_type_Wbj = null;
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetImageButton.setVisibility(0);
