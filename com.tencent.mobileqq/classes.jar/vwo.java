...
public class vwo
{
  ...
  public vwo(qqstory_struct.VideoSpreadGroupList paramVideoSpreadGroupList)
  {
  ...
  public vwo(List<String> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  public static boolean a(vwo paramvwo)
  {
    return (paramvwo == null) || (paramvwo.jdField_a_of_type_JavaUtilList == null) || (paramvwo.jdField_a_of_type_JavaUtilList.isEmpty());
  }
