...
final class aunl
  implements auok
{
  aunl(QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public long a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, String paramString5, long paramLong1, int paramInt3, long paramLong2, int paramInt4)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = auog.a(auog.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()), aunj.a(paramString5));
      bhmi.d(paramString5, localDataLineMsgRecord.thumbPath);
    }
    ...
    for (localDataLineMsgRecord.nOpType = 29;; localDataLineMsgRecord.nOpType = 31)
    {
      ...
      paramString1 = (anvu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
      ...
      paramString1.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)anvu.b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (paramInt != 0)
    {
      ...
      {
        auna.c(BaseApplicationImpl.getContext().getString(2131692324));
        paramBoolean = false;
      }
    }
    else
