  ...
  extends aunh
{
  ...
  String b()
  {
    ...
    {
      localObject = new auob();
      ((auob)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      ((auob)localObject).d = this.d;
      ((auob)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      ((auob)localObject).f = this.f;
      localObject = aywk.a((auob)localObject, n, null);
      if (localObject == null) {
        break label129;
      }
    ...
    Object localObject = aywk.a(this, n, null);
    if (localObject != null) {
      return ((URL)localObject).toString();
    }
    label129:
