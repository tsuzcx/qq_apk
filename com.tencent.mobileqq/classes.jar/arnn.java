  ...
  extends WebViewPlugin
{
  ...
  private void a(String paramString)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        arno localarno = new arno(this, (String)localObject);
        i = amav.a().a(localarno);
        ...
        try
        {
          ...
          {
            amba.a(this.jdField_a_of_type_AndroidAppActivity, str1, paramString, i);
            return;
          }
          if (TextUtils.isEmpty(str2)) {
            break label183;
          }
          bbfd.a(this.jdField_a_of_type_AndroidAppActivity, str2, null, paramString, i);
          return;
        }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if ((paramLong == 8L) && (paramString != null)) {
      try
      {
        if (((amax)ampm.a().a(416)).a(paramString))
        {
