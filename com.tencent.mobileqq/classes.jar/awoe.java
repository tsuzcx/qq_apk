...
public class awoe
{
  ...
  public awoe(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static awoe a(appoint_define.InterestTag paramInterestTag)
  {
    awoe localawoe = null;
    if (paramInterestTag != null)
    {
      localawoe = new awoe(paramInterestTag.uint32_tag_type.get());
  ...
  public static awoe a(JSONObject paramJSONObject)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      if (i < paramJSONObject.length())
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            localawoe.jdField_a_of_type_JavaUtilArrayList.add(localObject);
            break label140;
            label114:
            localObject = null;
          }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!bftf.a(this.jdField_a_of_type_JavaUtilArrayList.get(i), paramObject.jdField_a_of_type_JavaUtilArrayList.get(i))) {
        break;
      }
      i += 1;
    }
