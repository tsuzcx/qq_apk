...
public class qiy
{
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      {
        paramBaseArticleInfo = blhn.a(paramBaseArticleInfo);
        ...
        {
          paramBaseArticleInfo = (String)blhn.a(Uri.decode(str)).get("rowkey");
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.d = bhny.a(BaseApplicationImpl.getApplication(), "com.tencent.reading");
      c = false;
      return;
      bool = false;
    }
  ...
  public String a(String paramString)
  {
    ...
    {
      return paramString;
      str = (String)blhn.a(paramString).get("rowkey");
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    b(pfa.a().a(Integer.valueOf(paramInt), paramList));
  }
