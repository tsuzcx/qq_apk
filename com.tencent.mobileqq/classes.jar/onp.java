...
public class onp
{
  ...
  private oow jdField_a_of_type_Oow = new oow();
  
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.atlas.." + onp.class.getSimpleName();
    b = ajjy.a(2131647110);
    c = ajjy.a(2131647021);
    d = ajjy.a(2131647181);
  ...
  public static onp a()
  {
    if (jdField_a_of_type_Onp == null) {}
    try
    {
      if (jdField_a_of_type_Onp == null) {
        jdField_a_of_type_Onp = new onp();
      }
      return jdField_a_of_type_Onp;
    }
    finally {}
  }
  ...
  {
    new bfhl(6).a("nLinkType", 0).b("sTitle", paramString2).b("sUrl", paramString6).a("bAppShare", false).a("lAppId", 0L).b("sPublisher", paramString4).b("sBrief", paramString3).b("sPath", paramString5).b("sResUrl", paramString6).a("lCategory", 8L).b("sBizDataList", paramArrayList).b(paramActivity, paramString1, -1, null);
  }
  
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    boolean bool = false;
    if (obz.a(BaseApplicationImpl.getApplication().getRuntime(), "Key_First_ReadInJoy_Favorite", true) == null)
    {
      obz.a("Key_First_ReadInJoy_Favorite", Integer.valueOf(1), true);
      if (!paramBoolean) {
        babr.a(paramContext, 230, paramContext.getString(2131626764), "你可在看点内点击“我的”找到“我的收藏”。\n收藏的内容将会上传保存，在其他手机上登录QQ，也可以在看点内找到你收藏的内容。\n", 2131625035, 2131626762, new onr(), null).setMessageCount(null).show();
      }
      bool = true;
    }
    return bool;
  ...
  public void a(Activity paramActivity, String paramString1, int paramInt, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    new bfhl(6).a("sCIDListToBeDelete", paramArrayList).b("sBizDataList", paramString2).a(paramActivity, paramString1, -1, null);
  }
  
  public void a(List<String> paramList, ons paramons)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "getAtlasFavoriteStatus, rowKeyList = " + paramList + ", callback = " + paramons);
    }
    ...
    mmj.a((AppInterface)BaseApplicationImpl.getApplication().getRuntime(), new onq(this, paramons), localReqBody.toByteArray(), "OidbSvc.0xb40", 2880, 1, paramList, 0L);
  }
}
