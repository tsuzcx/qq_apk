  ...
  implements ark.ModuleCallbackWrapper
{
  ...
  protected Map<String, Set<anfu>> a;
  protected long b;
  public String b;
  public String c;
  ...
  protected anft(ark.Application paramApplication, long paramLong)
  {
  ...
  protected void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    {
      paramString.add(new anfu(this, paramLong1, paramLong2));
      return;
    }
  }
  ...
  public void a(List<anhq> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        anhq localanhq = (anhq)paramList.next();
        a(localanhq.jdField_a_of_type_JavaLangString, localanhq.jdField_a_of_type_Long, localanhq.jdField_b_of_type_Long);
      }
    }
  }
  ...
  protected boolean a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        anfu localanfu = (anfu)((Iterator)localObject).next();
        if (!localanfu.a())
        {
          QLog.i("ArkApp", 2, String.format("ModuleBase.checkFrequency.Refuse:%s,%s ", new Object[] { paramString, localanfu.toString() }));
          return false;
        }
      }
      return true;
