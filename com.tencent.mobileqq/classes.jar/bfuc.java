...
public class bfuc
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bfuc.class.getSimpleName();
  }
  
  public bfuc(List<ParagraphInfo> paramList, bfsg parambfsg, String paramString)
  {
        ...
        try
        {
          ...
          if ((k >= 0) && (k < ((List)localObject).size()))
          {
            ...
            if (this.jdField_a_of_type_Bfsg != null) {
              this.jdField_a_of_type_Bfsg.a((WordInfo)localObject);
            }
          }
