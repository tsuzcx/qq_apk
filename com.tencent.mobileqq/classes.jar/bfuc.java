...
{
  public bfuc(QZoneMsgFragment paramQZoneMsgFragment) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent.getAction() == "com.qzone.sync_comment_like")
    {
      ...
      if ((this.a.jdField_a_of_type_Bfua != null) && (!TextUtils.isEmpty(paramContext))) {
        i = 0;
      }
    }
    for (;;)
    {
      if (i < this.a.jdField_a_of_type_Bfua.getCount())
      {
        paramIntent = (MQMsg)this.a.jdField_a_of_type_Bfua.getItem(i);
        if ((paramIntent.msgInteractData != null) && (paramIntent.msgInteractData.likeCell != null) && (paramIntent.msgInteractData.likeCell.likeKey.equals(paramContext)))
        {
          ...
          ((bfug)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(293)).a(paramIntent);
        }
      }
      else
      {
        this.a.jdField_a_of_type_Bfua.notifyDataSetChanged();
        return;
      }
      i += 1;
    }
