...
public class aole
{
  ...
  public aole(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_JavaUtilSet = amci.a(paramQQAppInterface);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anvk.b(this.jdField_a_of_type_JavaUtilArrayList);
    ((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a(this.jdField_a_of_type_JavaUtilArrayList);
    this.jdField_a_of_type_Anvk.a(this.d, this.jdField_a_of_type_Long, this.jdField_a_of_type_Boolean);
    ...
    for (;;)
    {
      amci.a(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      amci.b(this.jdField_b_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      amci.a(this.jdField_a_of_type_JavaUtilMap, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      amci.c(this.jdField_c_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject2 = this.jdField_a_of_type_Anvk.a(String.valueOf(paramFriends.uin));
    ...
    for (;;)
    {
      ...
      boolean bool3 = aolc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFriendInfo.vecRing, (ExtensionInfo)localObject1, paramFriends, this.jdField_a_of_type_JavaUtilSet, this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilList, this.jdField_a_of_type_JavaUtilMap, this.jdField_c_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilMap, (SpecialCareInfo)localObject2, this.jdField_a_of_type_Long);
      if (((SpecialCareInfo)localObject2).globalSwitch != 0) {
        this.d.add(localObject2);
      }
      boolean bool4 = bool2 | bool3 | axmv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFriends, (ExtensionInfo)localObject1, paramFriendInfo.vecIntimateInfo);
      bool3 = bool4;
      if (this.jdField_b_of_type_Int == 0) {
        bool3 = afse.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Anvk, paramFriends, (ExtensionInfo)localObject1, paramFriends.uin, paramFriendInfo.vecExtSnsFrdData) | bool4;
      }
      bool4 = bool3;
      if (this.jdField_c_of_type_Int == 0) {
        bool4 = bool3 | axlt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Anvk, paramFriends, (ExtensionInfo)localObject1, paramFriends.uin, paramFriendInfo.vecMutualMarkData);
      }
      if (QLog.isColorLevel())
      {
        ...
        QLog.i("Q.contacttab.friend.ExtensionInfoBatchUpdater", 1, ((StringBuilder)localObject2).toString());
      }
      if (bool4) {
        this.jdField_a_of_type_JavaUtilArrayList.add(localObject1);
      }
