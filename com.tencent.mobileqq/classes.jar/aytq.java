...
public class aytq
{
  ...
  private ayts jdField_a_of_type_Ayts;
  ...
  public aytq(AppInterface paramAppInterface, ayts paramayts, String paramString1, byte[] paramArrayOfByte1, String paramString2, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      axrn.a(BaseApplication.getContext()).a(null, "PtvGuideUpload", true, l, this.jdField_b_of_type_Long + this.jdField_c_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    while (QLog.isColorLevel())
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "PtvGuideUpload", false, l, this.jdField_b_of_type_Long + this.jdField_c_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public boolean a()
  {
    ...
    //   30: putfield 64	aytq:jdField_a_of_type_Long	J
    //   33: aload_0
    //   34: getfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   37: ifnonnull +77 -> 114
    //   40: aload_0
    //   41: new 212	java/io/RandomAccessFile
    //   44: dup
    //   45: aload_0
    //   46: getfield 39	aytq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   49: ldc 214
    //   51: invokespecial 217	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   54: putfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   57: aload_0
    //   58: getfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   61: ifnonnull +53 -> 114
    //   64: aload_0
    //   65: sipush 9303
    //   68: putfield 61	aytq:jdField_d_of_type_Int	I
    //   71: aload_0
    //   72: ldc 219
    //   74: putfield 189	aytq:f	Ljava/lang/String;
    //   77: aload_0
    //   78: getfield 35	aytq:jdField_a_of_type_Ayts	Layts;
    //   81: aload_0
    //   82: getfield 61	aytq:jdField_d_of_type_Int	I
    //   85: aload_0
    //   86: getfield 189	aytq:f	Ljava/lang/String;
    //   89: invokeinterface 224 3 0
    //   94: aload_0
    //   95: iconst_0
    //   96: invokespecial 79	aytq:a	(Z)V
    //   99: iconst_0
    //   100: ireturn
    //   101: astore_3
    //   102: aload_3
    ...
    //   106: aload_0
    //   107: aconst_null
    //   108: putfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   111: goto -54 -> 57
    //   114: aload_0
    //   115: getfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   118: ifnonnull +77 -> 195
    //   121: aload_0
    //   122: new 212	java/io/RandomAccessFile
    //   125: dup
    //   126: aload_0
    //   127: getfield 37	aytq:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   130: ldc 214
    //   132: invokespecial 217	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: putfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   138: aload_0
    //   139: getfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   142: ifnonnull +53 -> 195
    //   145: aload_0
    //   146: sipush 9303
    //   149: putfield 61	aytq:jdField_d_of_type_Int	I
    //   152: aload_0
    //   153: ldc 231
    //   155: putfield 189	aytq:f	Ljava/lang/String;
    //   158: aload_0
    //   159: getfield 35	aytq:jdField_a_of_type_Ayts	Layts;
    //   162: aload_0
    //   163: getfield 61	aytq:jdField_d_of_type_Int	I
    //   166: aload_0
    //   167: getfield 189	aytq:f	Ljava/lang/String;
    //   170: invokeinterface 224 3 0
    //   175: aload_0
    //   176: iconst_0
    //   177: invokespecial 79	aytq:a	(Z)V
    //   180: iconst_0
    //   181: ireturn
    //   182: astore_3
    //   183: aload_3
    ...
    //   187: aload_0
    //   188: aconst_null
    //   189: putfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   192: goto -54 -> 138
    //   195: aload_0
    //   196: getfield 43	aytq:jdField_a_of_type_ArrayOfByte	[B
    //   199: arraylength
    //   200: aload_0
    //   201: getfield 41	aytq:jdField_b_of_type_ArrayOfByte	[B
    //   204: arraylength
    //   205: iadd
    //   206: newarray byte
    //   208: astore_3
    //   209: aload_0
    //   210: getfield 43	aytq:jdField_a_of_type_ArrayOfByte	[B
    //   213: iconst_0
    //   214: aload_3
    //   215: iconst_0
    //   216: aload_0
    //   217: getfield 43	aytq:jdField_a_of_type_ArrayOfByte	[B
    //   220: arraylength
    //   221: invokestatic 235	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   224: aload_0
    //   225: getfield 41	aytq:jdField_b_of_type_ArrayOfByte	[B
    //   228: iconst_0
    //   229: aload_3
    //   230: aload_0
    //   231: getfield 43	aytq:jdField_a_of_type_ArrayOfByte	[B
    //   234: arraylength
    //   235: aload_0
    //   236: getfield 41	aytq:jdField_b_of_type_ArrayOfByte	[B
    //   239: arraylength
    ...
    //   268: astore 9
    //   270: aload_0
    //   271: getfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   274: invokevirtual 250	java/io/RandomAccessFile:length	()J
    //   277: l2i
    //   278: newarray byte
    //   280: astore_3
    //   281: aload_0
    //   282: getfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   285: invokevirtual 250	java/io/RandomAccessFile:length	()J
    //   288: l2i
    //   289: newarray byte
    //   291: astore 5
    //   293: aload_0
    //   294: getfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   297: invokevirtual 250	java/io/RandomAccessFile:length	()J
    //   300: aload_0
    //   301: getfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    ...
    //   311: astore 10
    //   313: aload_0
    //   314: getfield 210	aytq:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   317: aload_3
    //   318: invokevirtual 254	java/io/RandomAccessFile:read	([B)I
    //   321: pop
    //   322: aload_0
    //   323: getfield 229	aytq:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   326: aload 5
    ...
    //   453: aload_0
    //   454: getfield 57	aytq:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   525: dup
    //   526: aload_0
    //   527: getfield 37	aytq:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   557: aload_0
    //   558: getfield 41	aytq:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   572: aload_0
    //   573: getfield 43	aytq:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   601: putfield 97	aytq:jdField_b_of_type_Long	J
    //   604: aload 4
    ...
    //   609: aload_0
    //   610: getfield 47	aytq:jdField_b_of_type_Int	I
    ...
    //   621: aload_0
    //   622: getfield 45	aytq:jdField_a_of_type_Int	I
    ...
    //   674: aload_0
    //   675: getfield 49	aytq:jdField_c_of_type_Int	I
    //   678: invokevirtual 320	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   681: new 256	java/io/File
    //   684: dup
    //   685: aload_0
    //   686: getfield 39	aytq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   713: putfield 107	aytq:jdField_c_of_type_Long	J
    //   716: aload_3
    ...
    //   734: aload_0
    //   735: aload 9
    //   737: invokespecial 414	aytr:<init>	(Laytq;Ljava/lang/String;)V
    //   740: astore 4
    //   742: aload_0
    //   743: new 416	com/tencent/mobileqq/highway/transaction/Transaction
    //   746: dup
    //   747: aload_0
    //   748: getfield 57	aytq:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   751: bipush 12
    //   753: aload 9
    //   755: iconst_0
    //   756: aload_0
    //   757: getfield 41	aytq:jdField_b_of_type_ArrayOfByte	[B
    //   760: aload 4
    //   762: aload_3
    //   763: iconst_1
    ...
    //   767: putfield 68	aytq:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   770: aload_0
    //   771: getfield 33	aytq:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   774: invokevirtual 423	com/tencent/common/app/AppInterface:getHwEngine	()Lcom/tencent/mobileqq/highway/HwEngine;
    //   777: aload_0
    //   778: getfield 68	aytq:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   817: aload_0
    //   818: getfield 68	aytq:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   833: aload_0
    //   834: getfield 41	aytq:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   849: aload_0
    //   850: getfield 68	aytq:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   880: aload_0
    //   881: iload_1
    //   882: putfield 61	aytq:jdField_d_of_type_Int	I
    //   885: aload_0
    //   886: ldc_w 451
    //   889: putfield 189	aytq:f	Ljava/lang/String;
    //   892: aload_0
    //   893: getfield 35	aytq:jdField_a_of_type_Ayts	Layts;
    //   896: aload_0
    //   897: getfield 61	aytq:jdField_d_of_type_Int	I
    //   900: aload_0
    //   901: getfield 189	aytq:f	Ljava/lang/String;
    //   904: invokeinterface 224 3 0
    //   909: aload_0
    //   910: iconst_0
    //   911: invokespecial 79	aytq:a	(Z)V
    //   914: iconst_0
    //   915: ireturn
    //   916: astore 5
    //   918: aload 5
