...
public class aytq
  extends ayts
{
  private aoct jdField_a_of_type_Aoct = new aytr(this);
  ...
  public aytq(QQAppInterface paramQQAppInterface)
  {
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2)
  {
    ...
    NotificationCompat.Builder localBuilder = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_HIDE_BADGE").setSmallIcon(2130841130).setAutoCancel(true).setOngoing(true).setWhen(System.currentTimeMillis());
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((i >= 512) && (i <= 522))
    {
      ...
      if (aljq.u.equals(paramIntent.getStringExtra("uin"))) {
        break label857;
      }
    ...
    for (;;)
    {
      ...
      if ((bool2) && ((k == 1001) || (k == 10002)))
      {
        ...
        if (bcyt.a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
        {
      ...
      for (;;)
      {
        ...
        if (k == 1030)
        {
          ...
          paramBitmap = bcwc.a(BaseApplication.getContext().getResources(), 2130840157);
        ...
        Bitmap localBitmap = bcwc.a(paramBitmap.getResources(), 2130840157);
  ...
  private void c(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (!bdlz.e)
    {
      paramToServiceMsg = bdlw.a().a(localIntent, localBitmap, arrayOfString[0], arrayOfString[1], arrayOfString[2], this.c, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      label155:
      if (!SettingCloneUtil.readValue(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), BaseApplication.getContext().getString(2131719346), "qqsetting_notify_showcontent_key", true)) {
        break label1245;
      }
      if (j != 1008) {
        break label394;
    ...
    for (;;)
    {
      ...
      else if (j == 1030)
      {
        ...
        Object localObject2 = new azme();
        ((azme)localObject2).e = "0X800923F";
        ((azme)localObject2).d = "Android系统通知曝光";
        if (QLog.isColorLevel()) {
          QLog.d("CampusNoticeManager", 2, new Object[] { "notification url :", localIntent.getStringExtra("url") });
        }
        azmd.a(localIntent.getStringExtra("url"), (azme)localObject2);
        azmd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (azme)localObject2);
        localObject2 = (anxa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(240);
      ...
      else if ((j == 1035) || (j == 1041) || (j == 1042))
      {
        ...
        atvq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localIntent.getStringExtra("push_notice_service_id"), localIntent.getStringExtra("push_notice_content_id"), localIntent.getStringExtra("url"), "0X800923F", "Android系统通知曝光");
        if (QLog.isColorLevel()) {
      ...
      else
      {
        if ((j == 0) && (localIntent.getBooleanExtra("key_reactive_push_tip", false))) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 2, 0, "", "", "", "");
        }
        if ((bhpd.a(j)) && (bhpd.a(str)))
        {
          j = localIntent.getIntExtra("param_notifyid", 0);
          a(275);
  ...
  protected void a()
  {
    ...
    {
      super.a();
      a(new bkvh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new aywe(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayuk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayvx(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayux(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new aywl());
      aywg localaywg = new aywg();
      a(localaywg);
      localaywg.a(this.jdField_a_of_type_Aoct);
      a(new ayue());
      a(new aywq());
      a(new ayuj());
      a(new aytw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayub());
      a(new ayud());
      a(new nbo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new aywi());
      a(new aywj());
      a(new ayua());
      a(new aywh());
      a(new aywu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      super.d();
      return;
    }
    finally
  ...
  {
    atvl.a().a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  
  public void a(ToServiceMsg paramToServiceMsg)
  {
    b(paramToServiceMsg, this.jdField_a_of_type_Aoct, aocv.class);
  }
  ...
  protected void a(ToServiceMsg paramToServiceMsg, aoct paramaoct, Class<? extends MSFServlet> paramClass)
  {
    ...
    super.a(paramToServiceMsg, paramaoct, aocv.class);
  }
  ...
  void a(String paramString1, int paramInt1, Notification paramNotification, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        awwg localawwg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localawwg == null) {
          break label305;
        }
        i = localawwg.a();
      ...
      if (bhnv.a(BaseApplicationImpl.getApplication().getApplicationContext())) {
        bhnv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i, paramNotification);
      }
      if (!TextUtils.isEmpty(paramString1))
      {
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aoct = null;
    super.c();
  }
}
