...
public class wqv
{
  ...
  private wqv(JSONObject paramJSONObject)
  {
    int j;
    try
    {
  ...
  public static wqv a(@Nullable String paramString)
  {
    try
    {
  ...
  public static wqv a(JSONObject paramJSONObject)
  {
    try
    {
      paramJSONObject = new wqv(paramJSONObject);
