...
{
  public affa(ArkAppView paramArkAppView) {}
  ...
  public void onFocusChanged(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = this.a.getResources().getDrawable(2130838549);
      Object localObject1 = this.a.getResources().getDrawable(2130838548);
  ...
  public void onSelectChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = this.a.getResources().getDrawable(2130838549).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = this.a.getResources().getDrawable(2130838548).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      localbdkz.a(0, alpo.a(2131701019));
      localbdkz.a(1, alpo.a(2131701015));
      localbdkz.a(2, alpo.a(2131701016));
    }
    for (;;)
    {
      int i = this.a.getResources().getDrawable(2130838548).getIntrinsicHeight();
      ArkViewImplement.ArkViewInterface localArkViewInterface = (ArkViewImplement.ArkViewInterface)paramView;
      ArkAppView.a(this.a, bdbk.a(paramView, paramInt1, paramInt2, paramInt3 + i, localbdkz, new affb(this, paramInt4, localArkViewInterface)));
      return;
      if (paramInt4 == 1)
      {
        localbdkz.a(0, alpo.a(2131701018));
        localbdkz.a(1, alpo.a(2131701014));
        localbdkz.a(2, alpo.a(2131701017));
      }
      else
      {
        localbdkz.a(0, alpo.a(2131701020));
      }
    }
  }
}
