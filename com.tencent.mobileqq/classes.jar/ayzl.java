...
{
  private Map<String, ayzj> a;
  
  protected ayzl(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject = (ayzj)this.a.get(str);
    } while (localObject == null);
    ((ayzj)localObject).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramToServiceMsg != null)
      {
        ...
        {
          ((ayzj)paramFromServiceMsg.next()).a(bool, paramToServiceMsg);
          continue;
          bool = false;
          continue;
        }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (localObject != null)
    {
      localObject = (ayzj)this.a.get(localObject);
      if (localObject != null) {
        ((ayzj)localObject).b(paramToServiceMsg, paramFromServiceMsg, paramObject);
      }
    }
  }
  
  public ayzj a(String paramString)
  {
    ayzj localayzj = null;
    if (this.a != null) {
      localayzj = (ayzj)this.a.get(paramString);
    }
    return localayzj;
  }
  ...
  {
    this.a = new HashMap();
    this.a.put("AssistantSwitchImpl", new azge(this.app, this));
  }
  ...
  public void b()
  {
    ...
    for (boolean bool = false; localIterator.hasNext(); bool = ((ayzj)localIterator.next()).a((oidb_0x5eb.ReqBody)localObject) | bool) {}
    if (QLog.isColorLevel()) {
