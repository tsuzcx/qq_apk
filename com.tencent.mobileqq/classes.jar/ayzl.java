...
public class ayzl
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ayzl.class.getSimpleName();
  }
  
  public ayzl(List<ParagraphInfo> paramList, ayxp paramayxp, String paramString)
  {
        ...
        try
        {
          ...
          if ((k >= 0) && (k < ((List)localObject).size()))
          {
            ...
            if (this.jdField_a_of_type_Ayxp != null) {
              this.jdField_a_of_type_Ayxp.a((WordInfo)localObject);
            }
          }
