  ...
  implements vln
{
  ...
  public vlj(DoodleView paramDoodleView)
  {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    veg.b("BaseLayer", "layer size,width=" + paramInt1 + ",height=" + paramInt2);
  ...
  public void f()
  {
    veg.b("BaseLayer", getClass().getName() + " onDestroy.");
  }
  ...
  public void h()
  {
    veg.b("BaseLayer", getClass().getName() + " onPause.");
    this.b = false;
  }
  
  public void i()
  {
    veg.b("BaseLayer", getClass().getName() + " onResume.");
    this.b = true;
  }
}
