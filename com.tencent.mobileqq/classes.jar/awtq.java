  ...
  implements Manager
{
  ...
  public awtq(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return new awts(this, paramBaseChatPie, paramShort);
  }
  ...
  private void a(SessionInfo paramSessionInfo, short paramShort, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
    if (!a(a(paramShort)))
    {
      paramSessionInfo = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131719302), new Object[] { paramString, paramString });
      paramSessionInfo = bhdj.a(paramBaseChatPie.mContext, 230, anvx.a(2131714201), paramSessionInfo, 2131719300, 2131719301, a(paramBaseChatPie, paramShort), a(paramBaseChatPie, paramShort));
      paramSessionInfo.setOnCancelListener(new awtr(this, paramBaseChatPie));
      paramSessionInfo.setCanceledOnTouchOutside(false);
      paramSessionInfo.show();
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009977", "0X8009977", a(paramShort), a(paramShort), "", "", "", "");
    }
  ...
  public void a(SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
    ...
    default: 
      return;
    case 1000: 
      a(paramSessionInfo, (short)-23308, anvx.a(2131714200), i, paramBaseChatPie);
      return;
    case 1006: 
      a(paramSessionInfo, (short)-23310, anvx.a(2131714198), i, paramBaseChatPie);
      return;
    case 1001: 
    case 1003: 
      a(paramSessionInfo, (short)-23312, anvx.a(2131714197), i, paramBaseChatPie);
      return;
    case 10002: 
      a(paramSessionInfo, (short)-23166, anvx.a(2131714199), i, paramBaseChatPie);
      return;
    case 10010: 
      a(paramSessionInfo, (short)-23161, anvx.a(2131694137), i, paramBaseChatPie);
      return;
    case 1005: 
      a(paramSessionInfo, (short)-23309, "QQ咨询", i, paramBaseChatPie);
      return;
    case 10008: 
      a(paramSessionInfo, (short)-23168, anvx.a(2131719158), i, paramBaseChatPie);
      return;
    }
    a(paramSessionInfo, (short)-23158, ((avds)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAME_CENTER_MSG_MANAGER)).a(), i, paramBaseChatPie);
  }
  ...
  public void a(SessionInfo paramSessionInfo, String paramString, int paramInt, short paramShort)
  {
    ...
    if (paramInt == 1000)
    {
      ...
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131719307), new Object[] { str });
      localObject = new avhz(paramSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.curType, -5023, 655381, bcrg.a());
      ...
      ((avhz)localObject).a(5, str.length() + 5, localBundle);
      ...
      ((avhz)localObject).a(paramString.length() - 5, paramString.length() - 1, paramSessionInfo);
    ...
    for (;;)
    {
      ...
      return;
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131719306), new Object[] { paramString });
      paramSessionInfo = new avhz(paramSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.curType, -5023, 655381, bcrg.a());
  ...
  public void a(short paramShort, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      ((anri)localObject).a(paramShort, paramBoolean1);
      return;
      this.jdField_a_of_type_JavaUtilMap.put(localObject, Boolean.valueOf(paramBoolean1));
      break;
    }
