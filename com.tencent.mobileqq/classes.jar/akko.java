  ...
  implements akio
{
  ...
  protected akko(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void a_(SlideItemInfo paramSlideItemInfo)
  {
    ...
    if (i < this.jdField_a_of_type_Akic.paths.size()) {
      if (!((String)this.jdField_a_of_type_Akic.paths.get(i)).equals(paramSlideItemInfo.b)) {}
    }
    for (;;)
    {
      if ((i >= 0) && (i < this.jdField_a_of_type_Akic.paths.size()) && (this.jdField_a_of_type_JavaUtilHashMap != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Akic.paths.get(i));
      }
      return;
      i += 1;
      break;
  ...
  public void at_()
  {
    ...
    if (i != -1)
    {
      String str = (String)this.jdField_a_of_type_Akic.paths.get(i);
      if (this.c)
      {
  ...
  protected void d()
  {
    ...
    if ((this.c) && (this.mPhotoCommonData.selectedPhotoList != null) && (this.mPhotoCommonData.selectedPhotoList.isEmpty()) && (((ArrayList)localObject1).size() == 1))
    {
      ...
      if ((((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)localObject2) == 1) && (!bgkc.a(this.mActivity, a(), (LocalMediaInfo)localObject3, this.e)))
      {
    ...
    {
      akgm.a(((ArrayList)localObject1).size(), this.jdField_a_of_type_Akic.totalPicCount);
      akgm.a(((NewPhotoPreviewActivity)this.mActivity).getIntent(), ((ArrayList)localObject1).size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoPreviewActivity)this.mActivity).getIntent();
    if (localObject1 != null) {
      alkm.a((List)localObject1);
    }
    if ((this.c) || (((akib)this.mOtherCommonData).a()))
    {
  ...
  {
    this.jdField_a_of_type_Akic.c = true;
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 != -1) {
      this.jdField_a_of_type_Akic.a = ((String)this.jdField_a_of_type_Akic.paths.get(paramInt1));
    }
    if (this.jdField_a_of_type_Akic.a != null)
    {
    ...
    label594:
    for (paramView = (LocalMediaInfo)this.mPhotoCommonData.selectedMediaInfoHashMap.get(this.jdField_a_of_type_Akic.a);; paramView = null)
    {
      if ((this.jdField_a_of_type_Boolean) && (bgkc.getMediaType(paramView) == 1) && (this.c) && (this.jdField_a_of_type_Akic.c))
      {
        ...
        paramBundle.putExtra("file_send_path", this.jdField_a_of_type_Akic.a);
      ...
      for (;;)
      {
        ...
        paramView.putExtra("PhotoConst.SEND_BUSINESS_TYPE", this.jdField_a_of_type_Akic.b);
        ...
        return;
        if (this.jdField_a_of_type_Akic.c)
        {
          paramView = new HashMap(1);
          if ((this.mPhotoCommonData.selectedMediaInfoHashMap != null) && ((LocalMediaInfo)this.mPhotoCommonData.selectedMediaInfoHashMap.get(this.jdField_a_of_type_Akic.a) != null)) {
            paramView.put("param_localmediainfo", this.mPhotoCommonData.selectedMediaInfoHashMap.get(this.jdField_a_of_type_Akic.a));
          }
          if (this.c) {
            paramView = QzoneEditPictureActivity.a(this.mActivity, this.jdField_a_of_type_Akic.a);
          } else {
            paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Akic.a, true, true, true, true, true, 3, 99, 4, paramView);
          }
        }
        else
        {
  ...
  public void onSelectClick(View paramView)
  {
    ...
    if (i != -1) {}
    for (String str = (String)this.jdField_a_of_type_Akic.paths.get(i);; str = "")
    {
      LocalMediaInfo localLocalMediaInfo = ((NewPhotoPreviewActivity)this.mActivity).getMediaInfo(str);
      if ((this.c) && (this.jdField_a_of_type_Akic.paths != null) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType(str) == 1) && (!bgkc.a(this.mActivity, a(), localLocalMediaInfo, ((akib)this.mOtherCommonData).a())))
      {
      ...
      str = (String)this.jdField_a_of_type_Akic.paths.get(i);
      if ((!this.c) && (!((akib)this.mOtherCommonData).a())) {
        break;
      }
      if (this.mPhotoCommonData.selectedMediaInfoHashMap == null) {
  ...
  public void updateButton()
  {
    ...
    {
      localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131698356);
      if (this.jdField_a_of_type_Int == 1) {
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694281);
      }
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((this.c) && (this.jdField_a_of_type_Akic.paths != null)) {
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        c();
        return;
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694260);
        break;
        bool1 = false;
        break label132;
      }
