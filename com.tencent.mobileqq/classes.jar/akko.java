...
{
  public akko(AuthorityActivity paramAuthorityActivity) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131435587), new Object[] { Integer.valueOf(i) });
            if (i == 110405)
            {
              this.a.a(paramMessage, new akkp(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131435592), new Object[] { localGetAuthApiListResponse.msg.get(), Integer.valueOf(i) });
            continue;
          }
          ...
          this.a.a(paramMessage, new akkq(this, localGetAuthApiListResponse, (JSONObject)localObject1));
          continue;
        ...
        if (i != 0)
        {
          ...
          try
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              ...
              this.a.a(paramMessage, new akkr(this));
            }
            do
            {
              this.a.b(i, paramMessage);
              return true;
              paramMessage = String.format(this.a.getResources().getString(2131435592), new Object[] { localObject2, Integer.valueOf(i) });
              break;
      ...
      for (;;)
      {
        try
        {
          ...
          if (k >= 100)
          {
            localObject1 = (GetAppInfoProto.MsgIconsurl)paramMessage.iconsURL.get(i);
            if (localObject1 != null) {
              ThreadManager.executeOnNetWorkThread(new akks(this, (GetAppInfoProto.MsgIconsurl)localObject1));
            }
            ...
            ThreadManager.executeOnNetWorkThread(new akkt(this, (String)localObject1));
          }
        }
        ...
        this.a.a();
        break;
        ThreadManager.postImmediately(new akku(this), null, true);
        break;
        i = paramMessage.arg1;
        paramMessage = (String)paramMessage.obj;
        this.a.b(i, paramMessage);
