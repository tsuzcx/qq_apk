...
public class qym
{
  ...
  public qym(Context paramContext, szd paramszd)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_Qyu = new qyw().a(this.jdField_a_of_type_Szd).a(this.jdField_a_of_type_JavaUtilHashMap).b(this.jdField_b_of_type_JavaUtilHashMap).a();
    this.jdField_a_of_type_Qyr = new qys().a(this.jdField_a_of_type_Szd).a(this.jdField_a_of_type_JavaUtilHashMap).b(this.jdField_b_of_type_JavaUtilHashMap).a();
    this.jdField_a_of_type_ComTencentPtsCoreLiteIPTSLiteEventListener = new qyn(this);
  }
  
  private void c()
  {
    c.clear();
    Object localObject = raj.a().a("default_feeds");
    if (localObject == null)
    {
      QLog.i("PTSLiteItemViewBuilder", 1, "[initViewTypeCount], pageNameList is null.");
      return;
    }
    jdField_a_of_type_Int = this.jdField_a_of_type_Szd.a().a() + 147;
  ...
  public View a(View paramView, ArticleInfo paramArticleInfo, int paramInt, qhk paramqhk)
  {
    if (paramArticleInfo == null)
    {
    ...
    if ((localPTSItemData != null) && (localPTSComposer != null)) {
      if ((paramView instanceof PTSLitePlayableCardView))
      {
        ...
        rab.a.a(paramView.a());
        rab.a.a(paramqhk, paramView, this.jdField_a_of_type_Szd);
    ...
    for (;;)
    {
      paramView.setTag(2131369656, this.jdField_a_of_type_Szd.a());
      return paramView;
      paramView = new PTSLitePlayableCardView(this.jdField_a_of_type_AndroidContentContext);
      break;
      QLog.e("PTSLiteItemViewBuilder", 1, "[getView] error, ptsItemData is null or ptsComposer is null, hide the itemView, " + qyx.a(paramArticleInfo));
      paramView = new PTSLitePlayableCardView(this.jdField_a_of_type_AndroidContentContext);
  ...
  public void a()
  {
    ...
    int i = this.jdField_a_of_type_Szd.a();
    QLog.i("PTSLiteItemViewBuilder", 1, "[destroy] channelId = " + i);
    if ((i == 41505) || (i == 41697))
    {
      qyx.b(pvj.a().b(Integer.valueOf(41505)));
      qyx.b(pvj.a().b(Integer.valueOf(41697)));
      return;
    }
    qyx.b(pvj.a().b(Integer.valueOf(i)));
  }
}
