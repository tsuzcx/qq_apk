...
public class abvz
  extends mml
{
  public abvz(TroopAssistantActivity paramTroopAssistantActivity) {}
      ...
      try
      {
        ...
        if (localRspGetGroupDynamicEntrancePicture.cover_url.has())
        {
          ...
          else
          {
            ...
            vms.a(this.a.jdField_a_of_type_AndroidWidgetImageView, paramArrayOfByte, 68, 68, 4, vms.b, "TroopStorySnap");
            return paramBundle;
          }
        }
      }
