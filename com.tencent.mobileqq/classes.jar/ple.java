...
public class ple
{
  ...
  private static volatile ple jdField_a_of_type_Ple;
  private static plp jdField_a_of_type_Plp = new plp(null);
  ...
  private ple()
  {
    this.jdField_a_of_type_Plt = new plt(this);
    this.jdField_b_of_type_Plt = this.jdField_a_of_type_Plt;
    p();
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < localObject2.length)
        {
          ...
          String str = bfwv.a(BaseApplicationImpl.getContext(), localObject2[m]);
  ...
  private String a(bcgx parambcgx)
  {
    parambcgx = parambcgx.a.iterator();
    while (parambcgx.hasNext())
    {
      bcgw localbcgw = (bcgw)parambcgx.next();
      if ((localbcgw instanceof StructMsgItemTitle)) {
        return ((StructMsgItemTitle)localbcgw).b();
      }
    }
    return "";
  }
  ...
  private String a(List<ChatMessage> paramList)
  {
    ...
    if ((paramList instanceof MessageForStructing))
    {
      ...
      if ((paramList instanceof StructMsgForGeneralShare))
      {
        ...
        {
          Object localObject = (bcgw)paramList.next();
          if ((localObject instanceof bcgx))
          {
            localObject = a((bcgx)localObject);
  ...
  public static ple a()
  {
    if (jdField_a_of_type_Ple == null) {}
    try
    {
      if (jdField_a_of_type_Ple == null) {
        jdField_a_of_type_Ple = new ple();
      }
      return jdField_a_of_type_Ple;
    }
    finally {}
  }
  
  private plh a(List<ChatMessage> paramList)
  {
    plh localplh = new plh(this);
    int m = 0;
    int n = 0;
    Object localObject = bkwm.a();
    ...
    else
    {
      ...
      localplh.a = paramList;
      localplh.b = ((oidb_cmd0x80a.AttributeList)localObject);
      localplh.c = localAttributeList1;
      localplh.d = localAttributeList2;
      return localplh;
    }
    int i2;
  ...
  private void a(plg paramplg)
  {
    ...
    return;
    label95:
    paramplg.a(127, "FeatureFrameworkAttr", str);
  }
  
  private void a(plg paramplg, int paramInt)
  {
    boolean bool2 = false;
    String str1 = null;
    String str2;
    ...
    for (;;)
    {
      ...
      label97:
      paramInt = ozh.a();
      paramplg = paramplg.a(117, "daily_folderstatus", str2).a(118, "daily_msgbox_pos", String.valueOf(paramInt));
      boolean bool1 = bool2;
      if (paramInt >= 0)
      {
        bool1 = bool2;
        if (paramInt + 1 <= pay.jdField_a_of_type_Int) {
          bool1 = true;
        }
      }
      paramplg.a(119, "daily_in_screen", bool1);
      return;
    }
  }
  ...
  {
    plt localplt = a().jdField_a_of_type_Plt;
    if (paramInt1 == 0) {}
  ...
  private static boolean c(int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        Pair localPair = bkwm.b();
        paramInt = (int)(Long.valueOf(pay.a()).longValue() % 100L);
  ...
  public static void d(boolean paramBoolean)
  {
    ...
    } while (pli.jdField_a_of_type_Int == 2);
    pli.c();
  ...
  {
    Object localObject = ypb.a();
    if (TextUtils.equals((CharSequence)localObject, (String)bkwm.a("dau_report_type_" + paramInt, "")))
    {
      QLog.d("ReadinjoySPEventReport", 2, "has report dau for type today, type :" + paramInt);
      return;
    }
    bkwm.a("dau_report_type_" + paramInt, localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
  ...
  public static void g()
  {
    ...
    try
    {
      ...
      BaseApplicationImpl.getContext().registerReceiver(jdField_a_of_type_Plp, localIntentFilter);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void m()
  {
    ...
    localAttributeList.att_value.set(ozh.a());
    localArrayList.add(localAttributeList);
    ugf.a(91, localArrayList);
  }
  ...
  private void r()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(this.jdField_a_of_type_Plh.a);
      localArrayList.add(this.jdField_a_of_type_Plh.c);
      localArrayList.add(this.jdField_a_of_type_Plh.d);
      ugf.a(14, localArrayList);
    }
  }
  ...
  public List<oidb_cmd0x80a.AttributeList> a(int paramInt)
  {
    ...
    plg localplg = new plg(this, (List)localObject2);
    if (BaseApplicationImpl.sProcessId != 1) {
      return localObject2;
    }
    localplg.a(0, "UnreadMsg", String.valueOf(b())).a(100, "FolderStatus", String.valueOf(pay.jdField_d_of_type_Int)).a(101, "KDInScreen", pay.c((QQAppInterface)localObject1)).a(102, "KDAttrL", ugf.b()).a(103, "LeftBtmRedPntPulse", plu.a(this.jdField_b_of_type_JavaUtilList, ":", "`")).a(104, "FirstScnRedPntPulse", plu.a(this.jdField_c_of_type_JavaUtilList, ":", "`")).a(105, "AIOPulse", plu.a(this.jdField_d_of_type_JavaUtilList, ":", "`")).a(106, "LastRedExposureTime", pay.jdField_a_of_type_Long + ":" + pay.jdField_d_of_type_Int).a(107, "dt_red", a());
    if (a() > 0L) {}
    for (long l1 = a();; l1 = System.currentTimeMillis())
    {
      localplg.a(108, "last_inforeground_time", String.valueOf(l1 / 1000L));
      localplg.a(109, "last_in_aio_time", String.valueOf(b()));
      localObject2 = a().a();
      if (localObject2 != null)
      {
        ((plh)localObject2).b.att_id.set(110);
        localplg.a(((plh)localObject2).b);
      }
      localplg.a(112, "UniversalStateBit", ugf.b()).a(116, "wifiName", ypp.c(BaseApplicationImpl.getContext()));
      a(localplg, paramInt);
      localplg.a(120, "PushPreviewQ", SettingCloneUtil.readValue(BaseApplicationImpl.getContext(), pay.a(), "", "qqsetting_notify_showcontent_key", true));
      localplg.a(121, "NoDisturbAtNight", FriendsStatusUtil.a(BaseApplicationImpl.getApplication()));
      paramInt = bkwm.a((QQAppInterface)pay.a());
      if (paramInt != -1) {
        localplg.a(122, "DongTaiKandian", String.valueOf(paramInt));
      }
      localplg.a(123, "BSSID", DeviceInfoUtil.getBSSID(BaseApplicationImpl.getContext()));
      localplg.a(124, "MsgListFristDataIsVisable", plu.a(Integer.valueOf(plq.a()), Integer.valueOf(0)));
      a(localplg);
      localObject2 = b() + "_" + plu.a(plu.a(Integer.valueOf(pay.jdField_d_of_type_Int), Integer.valueOf(1)), "0", "1") + "_" + plu.a(a(), String.valueOf(1), String.valueOf(0));
      localplg.a(126, "ScreenInfo", pay.d(-1)).a(128, "is_jcjj_mode", bbyp.a()).a(129, "network", ptv.b() + "").a(130, "battery", c() + "").a(131, "sessionID", l / 1000L + "").a(132, "redDot", (String)localObject2).a(133, "app_install_list", a()).a(134, "is_study_mode", bcoo.a());
      localObject1 = (KandianMergeManager)((QQAppInterface)localObject1).getManager(162);
      localplg.a(135, "kdTabNumRed", ((KandianMergeManager)localObject1).f() + "");
      return localplg.a();
    }
  }
  ...
  public plh a()
  {
    plh localplh = this.jdField_a_of_type_Plh;
  ...
  {
    sra.a(2);
    if ((paramInt1 == 0) && ((this.jdField_d_of_type_JavaUtilList.isEmpty()) || (((Integer)((Pair)this.jdField_d_of_type_JavaUtilList.get(this.jdField_d_of_type_JavaUtilList.size() - 1)).second).intValue() == 0))) {
      return;
    }
  ...
  public void a(String paramString, bcgw parambcgw)
  {
    if ("2909288299".equals(paramString))
    {
      b("ClickMsg");
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      uhv.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long);
      if (paramBoolean)
      {
  ...
  public void b()
  {
    try
    {
      ...
      boolean bool = pay.c((QQAppInterface)localObject1);
      oidb_cmd0x80a.AttributeList localAttributeList1 = new oidb_cmd0x80a.AttributeList();
      localAttributeList1.att_id.set(1);
      ...
      for (localObject1 = "1";; localObject1 = "0")
      {
        ...
        ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(pay.jdField_d_of_type_Int + "");
        localObject2 = new ArrayList(3);
        ((List)localObject2).add(localAttributeList1);
        ((List)localObject2).add(localAttributeList2);
        ((List)localObject2).add(localObject1);
        ugf.a(1, (List)localObject2);
        if (!QLog.isColorLevel()) {
          break;
        }
