...
public class ppz
  implements bhbn
{
  public ppz(ReadInJoySelfFragment paramReadInJoySelfFragment) {}
    ...
    do
    {
      ...
      if (paramInt1 >= ReadInJoySelfFragment.a(this.a))
      {
        ...
        for (float f = 1.0F;; f = paramInt1 * 0.33F / ReadInJoySelfFragment.a(this.a))
        {
          ...
          ReadInJoySelfFragment.a(this.a).setBackgroundResource(2130843007);
      ...
      ReadInJoySelfFragment.a(this.a).setBackgroundResource(2130843008);
