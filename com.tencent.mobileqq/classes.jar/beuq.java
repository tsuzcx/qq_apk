...
{
  beuq(beup parambeup, ITDownloadListener paramITDownloadListener, String paramString1, String paramString2) {}
  ...
  public void onDownloadSucceed(int paramInt, String paramString, Map<String, List<String>> paramMap)
  {
    ...
    {
      if (bool) {
        this.jdField_a_of_type_ComTencentMobileqqTritonSdkDownloadITDownloadListener.onSuccess(this.jdField_a_of_type_JavaLangString, paramInt, null, beiu.a().e(this.b));
      }
    }
    else {
      return;
