  ...
  extends Animation
{
  ...
  private beur jdField_a_of_type_Beur;
  private final boolean jdField_a_of_type_Boolean;
  private final float b;
  private final float c;
  
  public beuq(float paramFloat1, float paramFloat2, boolean paramBoolean, int paramInt)
  {
  ...
  public void a(beur parambeur)
  {
    this.jdField_a_of_type_Beur = parambeur;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    int i = 1;
    if (this.jdField_a_of_type_Beur != null) {
      this.jdField_a_of_type_Beur.a(paramFloat);
    }
    float f1;
    float f2;
