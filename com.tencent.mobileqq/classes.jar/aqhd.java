...
public class aqhd
  implements arqg
{
  public aqhd(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        bdcd.a(this.a, 233, this.a.getString(2131719359), "是否下载文件:\n" + paramString1 + "(" + arof.a(paramLong) + ")", new aqhe(this, paramString2, (aqwa)localObject2, (Bundle)localObject3), new aqhf(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!arof.b(((FileManagerEntity)localObject3).getFilePath()));
    paramString1 = new arnh();
    paramString1.jdField_b_of_type_JavaLangString = "file_viewer_in";
    paramString1.jdField_a_of_type_Int = 73;
    paramString1.c = arof.a(((FileManagerEntity)localObject3).fileName);
    paramString1.jdField_a_of_type_Long = ((FileManagerEntity)localObject3).fileSize;
    arng.a(this.a.app.getCurrentAccountUin(), paramString1);
    arng.a("0X8004AE4");
