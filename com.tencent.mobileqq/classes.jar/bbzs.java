  ...
  extends ajtb
{
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    localTSsoReq.str_qq_ver.set("8.3.0");
    ...
    case 1: 
      ...
      long l = bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, null).getLong("local_version", 0L);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((VipFunCallAndRing.TSsoReq)localObject2).i32_cmd.has())
        {
          ...
          QLog.e("VipSetFunCallHandler", 1, "onReceive~ isSuccess=false ,data=" + bbmx.a((byte[])paramObject) + ", funcType=" + j);
          bdes.a().a("FunCallSvr.call", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, ajya.a(2131716783), true);
    ...
    paramFromServiceMsg = (bbzh)this.app.getManager(84);
    label457:
    boolean bool;
    if (QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        ...
        paramObject = ((ajxl)localObject1).a(paramToServiceMsg);
        ...
        ((ajxl)localObject1).a(paramFromServiceMsg);
        return;
        if (k != 0) {
          break label1647;
        }
        ...
        paramToServiceMsg = bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, null);
        ...
        else
        {
          ...
          if (localObject2 != null)
          {
            ...
            bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((VipFunCallAndRing.TUserInfo)localObject2).i32_common_id.get(), null, (VipFunCallAndRing.TSourceInfo)localObject3, true);
            ...
            if ((localObject3 != null) && (((List)localObject3).size() > 0))
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTGroupInfo.i32_group_id.get(), null, localTSourceInfo, true);
              }
            }
            if (bbzh.b()) {
          ...
          m = bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, 6, true, null);
          ...
          bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject3).i32_funcall_id.get(), null, (VipFunCallAndRing.TSourceInfo)((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject3).st_src_info.get(), true);
          if (bbzh.b()) {
          ...
          if (i != m)
          {
            ...
            bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, 2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), i);
          }
          for (;;)
          {
            ...
            break;
            label1227:
            bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, 1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), i);
          }
