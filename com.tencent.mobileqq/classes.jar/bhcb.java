...
public class bhcb
  extends bhbw
{
  public static bhcb a;
  public static final HashMap<Integer, String> a;
  
  static
  {
    jdField_a_of_type_Bhcb = new bhcb();
  ...
  public Bitmap a(Context paramContext, int paramInt, String paramString)
  {
    ...
    paramString = new bggm();
    bggl.a(paramContext, localOptions, paramString);
  ...
  public boolean a(Context paramContext, int paramInt)
  {
    ...
    paramContext = jdField_a_of_type_Bhcb.getDir(paramContext, (String)localObject);
