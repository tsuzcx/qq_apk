...
public class pfk
{
  ...
  public static int a()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localRecentUserBaseData != null) && (localRecentUserBaseData.mUser != null) && (localRecentUserBaseData.mUser.getType() == 1008) && (tue.b((QQAppInterface)pha.a(), localRecentUserBaseData.mUser.uin))) {
    ...
    if (i < ((List)localObject1).size())
    {
      ...
      while ((((RecentUserBaseData)localObject2).mUser == null) || (((RecentUserBaseData)localObject2).mUser.getType() != 1008) || (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, anhk.aR)))
      {
        i += 1;
        break;
      }
  ...
  public static void a()
  {
    ...
    {
      return;
      localMessageRecord = localQQAppInterface.a().b(anhk.aR, 1008);
    ...
    for (Object localObject1 = str3;; localObject2 = null)
    {
      ...
      for (;;)
      {
        ...
        for (i = 1;; i = 0)
        {
          ...
          oat.a(null, "CliOper", "", "", paramString, paramString, 0, 0, str4, localObject3, str1, localJSONObject.toString(), false);
          ...
          new pyq(null, null, qnd.a(), null).a(paramString);
          return;
          localObject1 = null;
          break;
        }
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    {
      return;
      Collections.sort(paramList, new pfl());
      localStringBuilder = new StringBuilder(1024);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
        if ((pha.a(localArticleInfo) > 0) && (paramList1.contains(Long.valueOf(localArticleInfo.mRecommendSeq))))
        {
  ...
  {
    return "" + bmqa.a("readinjoy_daily_mode_channel_id", Integer.valueOf(41505));
  }
  ...
  private static Map<String, String> b()
  {
    ...
    localObject = ((QQAppInterface)localObject).a().b(anhk.aR, 1008);
    if (localObject == null) {
      return localHashMap;
    }
