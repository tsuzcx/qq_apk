  ...
  implements ShareActionSheet.OnItemClickListener
{
  ...
  bads(QQBrowserActivity paramQQBrowserActivity, WebView paramWebView, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, ShareActionSheet.OnItemClickListener paramOnItemClickListener)
  {
  ...
  public void onItemClick(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem, ShareActionSheet paramShareActionSheet)
  {
    ...
    {
      badt.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo, paramActionSheetItem, "0X8009F34");
      ...
      if (i == 1)
      {
        badt.a(paramActionSheetItem.getIntent(), "0X800A16F");
        return;
      }
      if ((i == 2) || (i == 9) || (i == 10) || (i == 3) || (i == 12))
      {
        badt.a(paramActionSheetItem.getIntent(), "0X800A16E");
        return;
      }
      if (i == 6)
      {
        badt.a(paramActionSheetItem.getIntent(), "0X800A170");
        return;
      }
      if (i != 5) {
        break;
      }
      badt.a(paramActionSheetItem.getIntent(), "0X800A171");
      return;
    }
  }
}
