...
public class ptl
  extends ptk
{
  public ptl(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  public pqq d()
  {
    ...
    if ((this.jdField_a_of_type_Pqp != null) && ((this.jdField_a_of_type_Pqp instanceof ComponentContentSmall)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((ComponentContentSmall)this.jdField_a_of_type_Pqp).setLayoutParams((ViewGroup.LayoutParams)localObject);
      localRelativeLayout.addView((ComponentContentSmall)this.jdField_a_of_type_Pqp);
      localObject = new RelativeLayout.LayoutParams(-1, -2);
      ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, 0, 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      ((RelativeLayout.LayoutParams)localObject).addRule(9);
      ((RelativeLayout.LayoutParams)localObject).addRule(0, ((ComponentContentSmall)this.jdField_a_of_type_Pqp).getId());
      ...
      localRelativeLayout.setOnClickListener(new ptm(this));
      localRelativeLayout.setDuplicateParentStateEnabled(true);
      localRelativeLayout.setOnTouchListener(new ptn(this, localRelativeLayout));
      localLinearLayout2.setOnTouchListener(new pto(this, localRelativeLayout));
      ...
      localLinearLayout2.setOnTouchListener(new ptp(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new ptq(this, localLinearLayout2, localRelativeLayout));
    }
    localLinearLayout2.setOnClickListener(new ptr(this));
