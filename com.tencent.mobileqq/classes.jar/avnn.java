      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (avnm)localField.getAnnotation(avnm.class);
            if (localObject4 != null) {
              paramClass = ((avnm)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (avnm)((Field)localObject1).getAnnotation(avnm.class);
        if (localObject2 != null)
        {
          localObject2 = ((avnm)localObject2).a();
