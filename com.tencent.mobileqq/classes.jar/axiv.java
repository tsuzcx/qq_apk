...
public class axiv
  extends axis
{
  public axiv(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public axgr a()
  {
    ...
    if (str1 == null)
    {
      ...
      localaxgr.jdField_a_of_type_Boolean = false;
      return localaxgr;
    }
    String str2 = a(str1);
    ...
    localaxgr.jdField_a_of_type_Boolean = bool1;
    localaxgr.jdField_a_of_type_JavaLangString = str2;
    return localaxgr;
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (!TextUtils.isEmpty(str1))
        {
          try
          {
            paramMsgBackupResEntity = beqz.d(new URL(paramMsgBackupResEntity, null, str1).toString());
  ...
  public String a(String paramString)
  {
    try
    {
      ...
      paramString = axjg.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
