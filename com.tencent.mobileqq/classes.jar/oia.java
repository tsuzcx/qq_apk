...
public class oia
{
  ...
  static void a(AbsListView paramAbsListView)
  {
    ...
    localoic.jdField_a_of_type_Int = b();
    localoic.jdField_b_of_type_Int = Math.abs(jdField_b_of_type_Int - jdField_a_of_type_Int);
    localoic.jdField_a_of_type_Long = (jdField_b_of_type_Long - jdField_a_of_type_Long);
    localoic.c = (j - i);
    localoic.jdField_b_of_type_Long = jdField_b_of_type_Long;
    localoic.d = j;
    oib.a(localoic);
  }
  ...
  public static void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while ((oib.jdField_a_of_type_Long < 0L) || (oib.jdField_b_of_type_Long < 0L));
      switch (paramInt)
      {
      default: 
        return;
