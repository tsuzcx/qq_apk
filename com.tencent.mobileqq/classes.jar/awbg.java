...
public class awbg
{
    ...
    for (;;)
    {
      ...
      if ((str.charAt(k) == '\024') && (k + 1 < str.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + j + ",max len:" + awbk.a.length);
        }
        if ((j >= 0) && (j < awbk.a.length))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "---faceIndex:" + awbk.a[j]);
          }
          paramString = new im_msg_body.Face();
          paramString.index.set(awbk.a[j]);
        ...
        arrayOfInt = anam.a((char[])localObject2);
      ...
      for (paramString = paramString.getSharedPreferences("Last_Login", j).getString("uin", "");; paramString = null) {
        for (;;)
        {
          try
          {
            ...
            localObject1 = axkd.jdField_c_of_type_JavaLangString;
            if (paramString == null) {
              break label1013;
            }
            paramString = (arnz)paramString.getManager(14);
            if (paramString == null) {
              break label1019;
            }
  ...
  public static long a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (long l1 = bakz.a(arrayOfByte, 0);; l1 = 0L)
    {
  ...
  public static awaw a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, long paramLong1, boolean paramBoolean1, boolean paramBoolean2, long paramLong2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        if (!paramMessageHandler.app.a().a((aonz)localObject))
        {
          if (QLog.isColorLevel()) {
        ...
        if (!((aonz)localObject).jdField_b_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        paramMessageHandler.app.a().b(i, String.valueOf(paramLong1), paramMsg, l, s, paramBoolean1, 0, null, (aonz)localObject, paramLong2, paramInt);
      }
      else
      {
        if (QLog.isColorLevel()) {
  ...
  public static awbm a(msg_comm.Msg paramMsg)
  {
    awbm localawbm = new awbm();
    int i = -1;
    ...
    if (!localC2CTmpMsgHead.c2c_type.has())
    {
      ...
      localawbm.jdField_b_of_type_Int = localC2CTmpMsgHead.direction_flag.get();
      ...
      default: 
        label284:
        localawbm.jdField_a_of_type_Int = i;
        localawbm.jdField_a_of_type_Long = -1L;
        localawbm.jdField_b_of_type_Long = -1L;
        switch (k)
        {
        }
        break;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        ...
        paramMsg.append(" c2cType:").append(j).append(" serviceType:").append(k).append("direction_flag:").append(localawbm.jdField_b_of_type_Int).append(" info:").append(localawbm.toString());
      ...
      break label284;
      i = 1024;
      if ((!mnz.a(BaseApplicationImpl.getContext(), String.valueOf(paramMsg.msg_head.from_uin.get()))) && (!mnz.a(BaseApplicationImpl.getContext(), String.valueOf(paramMsg.msg_head.to_uin.get())))) {
        break label284;
      }
      i = 1025;
      break label284;
      ...
      i = 1044;
      break label284;
      localawbm.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localawbm.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
      continue;
      localawbm.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localawbm.jdField_b_of_type_Long = localC2CTmpMsgHead.group_code.get();
      continue;
      localawbm.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localawbm.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
    }
  ...
  public static MessageRecord a(MessageHandler paramMessageHandler, byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForNearbyLiveTip)awbi.a(-2053);
        if (localMsgBody.uint32_anchor_status.get() == 1)
        {
          ...
          paramArrayOfByte.senderuin = String.valueOf(ajed.l + l1);
          paramArrayOfByte.frienduin = String.valueOf(ajed.l + l1);
          ...
          awqx.b(null, "dc00899", "grp_lbs", "", "msg_box", "view_live_message", 0, 0, "", "", "", "");
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, aylt paramaylt)
  {
    ...
    paramList = (MessageForMixedMsg)awbi.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((paramaylt != null) && (paramaylt.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = paramaylt.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      azef.a(paramaylt.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
    if (paramArrayOfByte != null) {
      paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bach.a(paramArrayOfByte));
    }
    paramList.parse();
    return paramList;
  }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + awbk.a.length);
        }
        j = i;
        if (k >= 0)
        {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, awbn paramawbn, long paramLong, int paramInt2)
  {
    if (paramawbn == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | paramawbn.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + paramawbn);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(paramawbn.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(paramawbn.jdField_a_of_type_Int);
        paramString = paramString.replace("+", "");
        ((msg_svc.Trans0x211)localObject).to_uin.set(mfy.a(paramString));
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(paramawbn.jdField_a_of_type_ArrayOfByte));
      ...
      paramawbn = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (paramawbn == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(paramawbn));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = awbk.a(l);
      localawao = paramQQAppInterface.a();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramQQAppInterface = localawao.a();
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = awwf.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131628152);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131628153), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = ajjy.a(2131640863);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = bach.a(akhp.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((awum)localObject2).a;
              if (localObject2 != null)
              {
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)akhp.a(bach.a((String)localObject4));
  ...
  {
    kso localkso = kso.a();
    localkso.a(0L, paramLong1, paramLong2);
    localkso.a(paramInt, 2, paramLong2);
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          ((ajrx)paramMessageHandler.app.a(18)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          ...
          return;
          ((axaf)paramMessageHandler.app.getManager(17)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          ...
          ((ajtg)paramMessageHandler.app.a(20)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          if (QLog.isColorLevel()) {
          ...
          agkl.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramMessageHandler, paramLong, i, l1, j);
          return;
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        localObject2 = (amvw)paramMessageHandler.app.getManager(71);
        if (localObject2 != null) {
          ((amvw)localObject2).a().a((SubMsgType0x6f.MCardNotificationLike)localObject4);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          ((ajve)paramMessageHandler.app.a(27)).a((String)localObject4, (String)localObject2);
          break label1906;
          if ((i == 2003) && (((SubMsgType0x6f.ForwardBody)localObject2).msg_push_lost_dev_found.has()))
          {
            ...
            ((xrh)paramMessageHandler.app.a(51)).a(111, (Bundle)localObject4);
            break label1906;
          }
          ...
          ((QIMNotifyAddFriend)localObject4).pushTime = awao.a();
          if (QLog.isColorLevel()) {
            QLog.d("QIMNewNotifyPush_offLine", 2, "receive data= " + ((QIMNotifyAddFriend)localObject4).toString());
          }
          ((ajph)paramMessageHandler.app.getManager(257)).a((QIMNotifyAddFriend)localObject4);
          break label1906;
          if (QLog.isColorLevel()) {
            QLog.d("TurnBrand", 2, "decode recv msg0x210.Submsgtype0x6e");
          }
          localObject2 = (ajqt)paramMessageHandler.app.getManager(22);
          if (localObject2 != null) {
            ((ajqt)localObject2).a();
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          ...
          try
          {
            ...
            if (((submsgtype0x67.MsgBody)localObject4).rpt_msg_grpinfo.has())
            {
              ...
              localObject4 = (ajlf)paramMessageHandler.app.a(3);
              if (localObject4 != null) {
                ((ajlf)localObject4).a((List)localObject2);
              }
            }
            a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
            return;
          ...
          ((ajpl)paramMessageHandler.app.a(47)).a(true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
          ...
          try
          {
            ...
            ((avyq)paramMessageHandler.app.getManager(94)).a(paramMsg, 1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        }
        ...
        try
        {
          ...
          if (((SubMsgType0x87.MsgBody)localObject4).rpt_msg_msg_notify.has()) {
            aexw.a(paramMessageHandler.app, (SubMsgType0x87.MsgBody)localObject4);
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        try
        {
          ...
          ((aqae)paramMessageHandler.app.getManager(156)).a((SubMsgType0xaa.MsgBody)localObject4, true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        label4673:
        paramMsg = ((akbt)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray());
        if (TextUtils.isEmpty(paramMsg)) {
          break;
        }
        paramBoolean1 = ((ajjj)paramMessageHandler.app.getManager(51)).b(paramMsg);
        if (QLog.isColorLevel()) {
        ...
        ((akbt)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "handleMsgType0x210SubMsgType0xee receive 0xee push message");
        }
        ((akbt)paramMessageHandler.a("businessbase_processor")).b(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        localObject4 = (akbt)paramMessageHandler.a("businessbase_processor");
        ...
        ((akbt)localObject4).a(localException5.msg_content.get().toByteArray(), 2, (MsgInfo)localObject5);
        ...
        ((MsgInfo)localObject5).lMsgUid = paramMsg.msg_head.msg_uid.get();
        ((MsgInfo)localObject5).shMsgType = ((short)paramMsg.msg_head.msg_type.get());
        ((akbt)localObject4).a(localException5.msg_content.get().toByteArray(), 2);
        a(paramMessageHandler, ((MsgInfo)localObject5).lFromUin, ((MsgInfo)localObject5).shMsgSeq, ((MsgInfo)localObject5).lMsgUid, ((MsgInfo)localObject5).shMsgType);
        return;
        if (QLog.isColorLevel()) {
        ...
        paramMsg = new akcb(paramLong, i, l1, j, k, false);
        ((akbt)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg);
        a(paramMessageHandler, paramLong, i, l1, j);
        return;
        if (QLog.isColorLevel()) {
        ...
        if ((localObject3 == null) || (ajml.a(paramMessageHandler.app, (MessageRecord)localObject3, true)) || (((MessageRecord)localObject3).msgtype != -2053)) {
          break;
        }
        ...
        localObject4 = (aifg)paramMessageHandler.app.getManager(153);
        if (localObject4 != null) {
          ((aifg)localObject4).a(((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray());
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        ...
        try
        {
          ...
          paramMessageHandler = (aiga)paramMessageHandler.app.getManager(227);
      ...
      paramMessageHandler = (sfy)paramMessageHandler.app.getManager(253);
      ...
      try
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (paramMessageHandler.app != null) {
            ((atdg)paramMessageHandler.app.getManager(266)).b((NowPushMsgList.NowPushMsg)localObject4);
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        ajls.a(paramMessageHandler.app, (byte[])localObject3);
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
      catch (Exception paramMessageHandler)
      ...
      aqvt.a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
      localObject4 = ((axmt)paramMessageHandler.app.getManager(339)).a(4);
      if (localObject4 != null) {
        ((axne)localObject4).a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      }
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = amvs.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = amww.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (!QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (!axfs.a(paramMsg.msg_head.msg_seq.get()))
        {
          axfs.a(paramMessageHandler.app, (SubMsgType0x119.MsgBody)localObject4);
      ...
      {
        aqay.a(paramMessageHandler, (byte[])localObject3, (MsgInfo)localObject4, paramBoolean1);
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        ((anod)paramMessageHandler.app.a(127)).a((submsgtype0x128.MsgBody)localObject4);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!paramMessageHandler.a().a(str))
        {
          ...
          if ((paramInt1 == 241) || (awbk.a(str, paramInt1)))
          {
            ...
            paramMsg = (MessageForPic)awbi.a(-2000);
        ...
        for (;;)
        {
          ...
          QLog.d("Q.msg.MessageHandler", 2, localStringBuilder.toString());
          return;
          if ((paramInt1 != 242) && (!awbk.b(str, paramInt1))) {
            break;
          }
          ...
          for (;;)
          {
            paramMsg = axwb.a((String)localObject1, paramLong1, 2, false, (String)localObject1, null, "ftn");
            ...
            localObject1 = (MessageForPtt)awbi.a(-2002);
            ...
            axte.a(paramMessageHandler.app, 1, false, 4);
            break;
            if (QLog.isColorLevel()) {
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg)
  {
    ...
    Object localObject4;
    long l2;
    if (axaf.a(paramMessageHandler.app))
    {
      i4 = 1;
      l1 = -1L;
      localObject2 = "";
      ...
      i2 = localObject7[i1];
      i1 += 1;
      i5 = bakz.a((byte[])localObject7, i1);
      i6 = i1 + 2;
      if (i2 != 3) {
        break label514;
      }
      localObject4 = new byte[i5];
      bakz.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
      l2 = bakz.a((byte[])localObject4, 0);
      if (l2 > 0L) {
        l1 = l2;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i2 == 9)
      {
        localObject4 = new byte[i5];
        bakz.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        n = bahn.b(azzz.a(bakz.a((byte[])localObject4, 0)));
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else if (i2 == 8)
      {
        localObject4 = new byte[i5];
        bakz.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        m = (int)bakz.a((byte[])localObject4, 0);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else
      {
        ...
        bakz.a((byte[])localObject5, 0, (byte[])localObject7, i6, i5);
    ...
    for (;;)
    {
      ...
      for (localObject4 = ((ByteStringMicro)localObject4).toStringUtf8();; localObject4 = "") {
        for (;;)
        {
          ...
          {
            i1 = 1;
            awqx.b(paramMessageHandler.app, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "8.2.6");
            ...
            localObject8 = bach.a(((im_msg_body.Ptt)localObject6).bytes_file_md5.get().toByteArray());
          }
          try
          {
            ...
            for (;;)
            {
              try
              {
                ...
                if (((generalflags.ResvAttr)localObject6).bytes_pb_ptt_waveform.has())
                {
                  ...
                  ((MessageForPtt)localObject5).waveformArray = baeh.a((ptt_waveform.PttWaveform)localObject7);
                  if (QLog.isColorLevel())
                  {
            ...
            if (localRichText.elems.has())
            {
              ...
              while (paramList.hasNext())
              {
                ...
                if ((((im_msg_body.Elem)localObject3).common_elem.has()) && (21 == ((im_msg_body.Elem)localObject3).common_elem.uint32_service_type.get()))
                {
                  ...
                  alyc.a(paramMsg, (im_msg_body.Elem)localObject3, localArrayList, paramMessageHandler.app);
                }
              }
            }
            agwx.b((String)localObject1, (MessageRecord)localObject4);
            return;
          }
        }
      }
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = baak.a((msg_comm.PluginInfo)localObject1);
      if (QLog.isColorLevel()) {
      ...
      if (localObject2 == null)
      {
        paramMessageHandler.a().a((atmo)localObject1);
        if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject2 = BaseApplication.getContext().getString(2131653588);
          ...
          for (localObject1 = localObject4;; localObject1 = null)
          {
            if (localObject1 != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                localObject2 = localObject1;
                ((PBStringField)localObject4).set((String)localObject2);
                localObject2 = axwb.a((String)localObject1, j, 1, false, (String)localObject1);
                if (QLog.isColorLevel()) {
            ...
            for (localObject1 = localObject3;; localObject1 = localObject3)
            {
              ...
              for (;;)
              {
                ...
                {
                  paramMessageHandler.a().b((atmo)localObject2);
                  paramMessageHandler.a().a((atmo)localObject1);
                  if (!QLog.isColorLevel()) {
                    break;
                  }
                ...
                else if (((im_msg_body.Elem)localObject1).custom_face.has())
                {
                  ...
                  localObject7 = bach.a((byte[])localObject7);
                  localObject5 = bach.a((byte[])localObject5);
                  localObject6 = bach.a((byte[])localObject6);
                  if (QLog.isColorLevel()) {
                  ...
                  {
                    ((PBStringField)localObject4).set((String)localObject2);
                    localObject2 = axwb.a((String)localObject1, 0L, 1, false, (String)localObject1);
                    paramBoolean = true;
                    break;
                    localObject2 = "";
                    break label1455;
                  ...
                  for (;;)
                  {
                    ...
                    do
                    {
                      ...
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)awbi.a(-1000);
                    ...
                    paramMessageHandler.d(String.valueOf(baak.b(l1)));
                    paramMsg = baac.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                    ...
                    localObject1 = baac.a((String)localObject2, (String)localObject1, l1, paramMsg.jdField_a_of_type_JavaLangString);
                    if (QLog.isColorLevel()) {
                      QLog.d("Q.msg.MessageHandler", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject2 + ",encodeMsg:" + (String)localObject1);
                    }
                    localObject2 = awbi.a(paramMsg.jdField_b_of_type_Int);
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      paramMessageHandler = BaseApplication.getContext().getString(2131624749);
      paramMsg = new awbd().a((List)localObject);
      if (TextUtils.isEmpty(paramMsg)) {
        break;
      }
      paramMessageHandler = paramMessageHandler + " " + paramMsg;
      paramMsg = awbi.a(-10000);
    ...
    do
    {
      ...
      do
      {
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  try
                  {
                    ...
                    if (!paramBoolean4)
                    {
                      ((ajgm)paramMessageHandler.app.a(8)).a(paramMsg, paramList);
                      return;
                    }
                  }
                  catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        ...
        try
        {
          ...
          if (paramMsg != null)
          {
            aonm.a(String.valueOf(paramLong1), paramMsg);
            paramList = (List<MessageRecord>)localObject1;
          }
        }
      ...
      ((xrh)paramMessageHandler.app.a(51)).a(paramLong1, paramLong2, paramInt, l1, i, "im_push.msg_push", (byte[])localObject2);
    } while (!QLog.isColorLevel());
    label801:
    label943:
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, awbm paramawbm, awam paramawam)
  {
    ...
    do
    {
      ...
      if ((paramawam.d) || (paramawbm.jdField_a_of_type_Int != 1006)) {
        break label260;
      }
    ...
    return;
    label222:
    babh.a(paramMessageHandler.app, ((msg_comm.C2CTmpMsgHead)localObject1).from_phone.get(), paramawam.e + "");
    label260:
    if ((!paramawam.d) && (((msg_comm.C2CTmpMsgHead)localObject1).sig.has()))
    {
      localObject3 = ((msg_comm.C2CTmpMsgHead)localObject1).sig.get().toByteArray();
      localObject1 = localObject3;
      if (QLog.isDevelopLevel()) {
        QLog.d("Q.msg.MessageHandler", 4, "tempHead.sig.get()----> sig:" + bach.a((byte[])localObject3) + ",length:" + localObject3.length);
      }
    }
    label520:
    label1269:
    ...
    for (localObject1 = localObject3;; localObject2 = null)
    {
      ...
      {
        if (localObject1 != null) {}
        switch (paramawbm.jdField_a_of_type_Int)
        {
        default: 
          k = 0;
          i = k;
        ...
        for (i = 1;; i = 0)
        {
          ...
          if (paramawam.jdField_b_of_type_Boolean) {
            break;
          }
          paramMessageHandler = BaseApplication.getContext().getString(2131624749) + " " + paramMessageHandler.str.get().toStringUtf8();
          paramMsg = awbi.a(-10000);
          paramMsg.msgtype = -10000;
          paramMsg.msg = paramMessageHandler;
          paramList.add(paramMsg);
          ...
          bakz.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().a(String.valueOf(paramawam.e), (byte[])localObject3);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bakz.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().b(String.valueOf(paramawam.e), (byte[])localObject3);
          break label520;
          paramMessageHandler.app.a().c(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bakz.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().e(String.valueOf(paramawam.e), (byte[])localObject3);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bakz.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().f(String.valueOf(paramawam.e), (byte[])localObject3);
          break label520;
          paramMessageHandler.app.a().g(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().h(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().i(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().j(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().m(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().o(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().l(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().k(String.valueOf(paramawam.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().a(String.valueOf(paramawam.e), String.valueOf(paramawam.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().b(String.valueOf(paramawam.e), String.valueOf(paramawam.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().c(String.valueOf(paramawam.e), String.valueOf(paramawam.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
        }
        if (paramawbm == null) {
          break;
        ...
        {
          paramawam = ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.get().toByteArray();
          localObject1 = new im_msg_body.TmpPtt();
          try
          {
            paramawam = (im_msg_body.TmpPtt)((im_msg_body.TmpPtt)localObject1).mergeFrom(paramawam);
            if ((paramawam == null) || (!paramawam.uint32_file_type.has()) || (paramawam.uint32_file_type.get() != 4) || (!paramawam.bytes_file_uuid.has())) {
              break;
            }
            localObject1 = paramawam.bytes_file_uuid.get().toStringUtf8();
            if (QLog.isColorLevel()) {
            ...
            localPttRec.localPath.set(paramawam.bytes_file_uuid.get().toStringUtf8());
            localPttRec.size.set(paramawam.uint32_file_size.get());
            ...
            i = 0;
            k = i;
            if (paramawam.uint32_user_type.has())
            {
              j = paramawam.uint32_user_type.get();
              if (j != 1)
              {
                k = i;
                if (j != 2) {}
            ...
            localObject3 = "";
            localObject1 = localObject3;
            if (paramawam.bytes_pb_reserve.has())
            {
            ...
            try
            {
              ((ptt_reserve.ReserveStruct)localObject1).mergeFrom(paramawam.bytes_pb_reserve.get().toByteArray());
              j = n;
              i = m;
            ...
            localPttRec.busiType.set(paramawam.uint32_busi_type.get());
            localPttRec.autototext_voice.set(j);
            localPttRec.sttText.set((String)localObject1);
            localObject1 = awbi.a(-2002);
            ((MessageRecord)localObject1).msgtype = -2002;
            ((MessageRecord)localObject1).msgData = localPttRec.toByteArray();
            ((MessageForPtt)localObject1).parse();
            if ((paramawam.uint64_msg_id.has()) && (paramawam.uint64_msg_id.get() != 0L)) {
              ((MessageRecord)localObject1).saveExtInfoToExtStr("pa_msgId", paramawam.uint64_msg_id.get() + "");
            }
            alyc.a(paramMsg, (MessageRecord)localObject1, paramMessageHandler.app);
            bcri.a(paramawbm, paramMsg, (MessageRecord)localObject1);
            paramList.add(localObject1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramawam)
          {
            for (;;)
            {
              paramawam.printStackTrace();
              paramawam = null;
            }
          }
        }
      }
      localObject1 = new aylt();
      ((aylt)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(paramawam.e);
      a(paramMessageHandler, paramList, paramMsg, true, paramawam.jdField_b_of_type_Boolean, (aylt)localObject1, paramawbm);
      return;
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, aylt paramaylt)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, paramaylt, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, aylt paramaylt, awbm paramawbm)
  {
    ...
    for (;;)
    {
      if (paramList.isEmpty()) {
        localawbd.g(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      }
      if (paramList.isEmpty()) {
        localawbd.i(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      }
      localawbd.a(localList, paramList);
      if (awbc.a((ArrayList)localObject2)) {
        localawbd.a((ArrayList)localObject2, localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt, paramawbm);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      return;
      localawbd.a(localList, paramList, (StringBuilder)localObject1, paramBoolean2);
      continue;
      localawbd.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localawbd.b(localList, paramList, (StringBuilder)localObject1, paramBoolean1);
      continue;
      localawbd.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localawbd.d(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.c(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.e(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.c(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.a(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.d(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.h(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.b(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localawbd.f(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.h(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.i(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.g(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt, paramBoolean1);
      continue;
      localawbd.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt, paramBoolean1);
      continue;
      localawbd.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.i(localList, paramList, (StringBuilder)localObject1, paramMsg, paramaylt);
      continue;
      localawbd.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localawbd.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localawbd.e(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.f(localList, paramList, (StringBuilder)localObject1);
      continue;
      if (paramBoolean1)
      {
        ...
        {
          localawbd.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramMessageHandler);
          break;
        }
      }
      if (paramaylt != null) {}
      for (paramMessageHandler = paramaylt.jdField_a_of_type_JavaLangString;; paramMessageHandler = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      localawbd.g(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.c(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      alyx.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localawbd.j(localList, paramList, (StringBuilder)localObject1);
      continue;
      localawbd.b(localList, paramList, (StringBuilder)localObject1);
      continue;
      arde.a(paramMessageHandler.app, localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1, paramaylt);
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awam paramawam)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        i = ktk.a(arrayOfByte2, 4);
        int j = arrayOfByte1.length - 8 - i;
        if (j >= 0)
        {
          arrayOfByte2 = new byte[j];
          System.arraycopy(arrayOfByte1, i + 8, arrayOfByte2, 0, j);
          bool = lbb.a(arrayOfByte2);
          if (((!paramawam.jdField_a_of_type_Boolean) && (!paramawam.f)) || ((paramawam.jdField_a_of_type_Long != paramawam.jdField_b_of_type_Long) || ((paramawam.jdField_a_of_type_Long == paramawam.jdField_b_of_type_Long) && (!bool))))
          {
            if (QLog.isColorLevel()) {
              QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_SharpVideo return null:,isReaded:" + paramawam.jdField_a_of_type_Boolean + "syncOther:" + paramawam.f + ",isSharpRequest" + bool);
            }
          }
          else
          {
            ...
            else
            {
              ...
              try
              {
                ...
                if (-1 == i)
                {
                  VideoMsgTools.a(paramMessageHandler.app, 0, 6, true, paramawam, String.valueOf(l4), false, null, false, new Object[] { paramMsg });
                  a(l4, l2, 208);
                  if (!QLog.isColorLevel()) {
                    continue;
                  }
    ...
    {
      VideoMsgTools.a(paramMessageHandler.app, 0, 6, bool, paramawam, String.valueOf(l2), false, null, false, new Object[] { paramMsg });
      break;
    }
    label775:
    if (bool) {
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList)
  {
    ...
    for (Object localObject5 = ((ByteStringMicro)localObject5).toStringUtf8();; localObject5 = "")
    {
      ...
      Object localObject6 = bach.a((byte[])localObject1);
      ...
      for (localObject1 = localPtt.bytes_group_file_key.get().toByteArray();; localMessageRecord = null) {
        try
        {
          ...
          if (localObject6 == null)
          {
            ...
            if (localPtt.bytes_pb_reserve.has())
            {
              ...
              ((RichMsg.PttRec)localObject7).voiceLength.set(azzz.a(l1));
              ...
              new awbd().a((List)localObject3, paramList);
              agwx.b((String)localObject2, (MessageRecord)localObject1);
              if (localObject1 == null)
              {
                return;
                m = 0;
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          for (;;)
          {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if (paramList.uint32_holiday_flag.has())
                  {
                    ...
                    if (j == 1) {
                      localMessageRecord.saveExtInfoToExtStr(awav.jdField_c_of_type_JavaLangString, String.valueOf(j));
                    }
                    if (QLog.isColorLevel()) {
                ...
                try
                {
                  ...
                  ((MessageForPtt)localMessageRecord).waveformArray = baeh.a((ptt_waveform.PttWaveform)localObject2);
                  if (QLog.isColorLevel())
                  {
                    ...
                    for (;;)
                    {
                      if (j < k)
                      {
                        ...
                        new awbd().a((List)localObject5, paramMsg, (StringBuilder)localObject4);
                        break;
                      }
                    }
            ...
            bool = ((azks)paramMessageHandler.app.getManager(203)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
            ...
            alyc.a(paramMsg, localMessageRecord, paramMessageHandler.app);
            if (QLog.isColorLevel())
            {
              QLog.d("Q.msg.MessageHandler", 2, ((StringBuilder)localObject4).toString());
              return;
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean)
  {
    ...
    ((ajgm)paramMessageHandler.app.a(8)).a(paramMsg);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Submsgtype0x8a.ReqBody paramReqBody, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!((ArrayList)localObject2).isEmpty())
      {
        ...
        axat localaxat = (axat)paramQQAppInterface.getManager(61);
        if (localaxat != null)
        {
          List localList = localaxat.a(str1);
          paramReqBody = null;
          localObject1 = null;
          ...
          for (;;)
          {
            ...
            localObject2 = ajjy.a(2131640869);
            localObject3 = (SubAccountMessage)((SubAccountMessage)localObject1).deepCopyByReflect();
            ((SubAccountMessage)localObject3).msg = ((String)localObject2).concat(BaseApplicationImpl.getApplication().getString(2131628768));
            ...
            ((SubAccountMessage)localObject3).mTimeString = baiu.a(((SubAccountMessage)localObject3).time * 1000L, true, axam.jdField_a_of_type_JavaLangString);
            ((SubAccountMessage)localObject3).mEmoRecentMsg = new axkd(((SubAccountMessage)localObject3).msg, 0);
            if (localaxat != null) {
              localaxat.a((SubAccountMessage)localObject3);
            }
            axam.a(paramQQAppInterface, str1, 6);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if ((TroopNotificationCache)paramArrayOfByte.a(TroopNotificationCache.class, "troopUin=? and feedsId=?", new String[] { String.valueOf(l2), str }) != null)
      {
        ...
        azkm.a(paramQQAppInterface, i, l1, l2, l3, str, j, "OidbSvc.0x852_35", (short)23, false, false);
      }
    }
    paramArrayOfByte.a();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramQQAppInterface = ((awao)localObject1).b(paramMessageRecord.frienduin);
      ...
      if (paramQQAppInterface != null)
      {
        ...
        bakz.a(paramMessageRecord, 0, paramQQAppInterface, 2, paramQQAppInterface.length - 2);
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "wpa------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      continue;
      paramQQAppInterface = ((awao)localObject1).c(paramMessageRecord.frienduin);
      ...
      continue;
      Object localObject2 = ((awao)localObject1).d(paramMessageRecord.frienduin);
      paramQQAppInterface = new msg_svc.BusinessWPATmp();
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "conversation------>sig:" + bach.a((byte[])localObject2) + ",length:" + localObject2.length);
        }
      ...
      for (;;)
      {
        ...
        break;
        paramMessageRecord = ((awao)localObject1).e(paramMessageRecord.frienduin);
        if (paramMessageRecord != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "conversation------>sigt:" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
          }
      ...
      paramMessageRecord = ((awao)localObject1).f(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      continue;
      paramQQAppInterface = ((awao)localObject1).a(paramMessageRecord.frienduin);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).j(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
      ...
      paramQQAppInterface = ((awao)localObject1).m(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送附近人临时会消息 有keyLBSFriend------>" + bach.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramQQAppInterface = ((awao)localObject1).k(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送兴趣部落临时会消息 有key------>" + bach.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramMessageRecord = ((awao)localObject1).l(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "movieTicket------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).g(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "circleGroup------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).i(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "friendValidation------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface = ((awao)localObject1).p(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_dating", 4, "发送附近人约会临时会话消息 有keyNearbyDating------>" + bach.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).o(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_assistant", 4, "发送附近人助手临时会话消息 有NearbyAssistantKey------>" + bach.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).n(paramMessageRecord.frienduin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).a(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).b(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awao)localObject1).c(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
  ...
  {
    Object localObject2 = paramQQAppInterface.a().b(ajed.ac, 0);
        ...
        for (;;)
        {
          ...
          if (paramArrayOfByte.hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForActivateFriends))
            {
              ...
              paramQQAppInterface.a().b(ajed.ac, 0, ((MessageForActivateFriends)localObject2).uniseq);
              continue;
              return false;
            }
          }
    ...
    do
    {
      ...
      break label113;
      paramArrayOfByte = awbi.a(-5003);
      paramArrayOfByte.selfuin = paramQQAppInterface.getCurrentAccountUin();
      paramArrayOfByte.frienduin = ajed.ac;
      paramArrayOfByte.istroop = 9002;
      paramArrayOfByte.senderuin = "";
      localObject2 = (ajjj)paramQQAppInterface.getManager(51);
      localajvm = (ajvm)paramQQAppInterface.getManager(85);
      if (j != 1) {
        break label584;
      }
      ...
      ((MessageForActivateFriends)localObject2).msg = ajvm.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      break label883;
      awqx.b(paramQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject2, localajvm.jdField_a_of_type_Int, 0, "", "", "", "");
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (j == 2)
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msg = ajvm.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      else
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msgData = ((SubMsgType0x76.MsgBody)localObject1).toByteArray();
          localMessageForActivateFriends.msg = ajvm.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          awqx.b(paramQQAppInterface, "dc00898", "", "", "0X8007AD4", "0X8007AD4", (int)((SubMsgType0x76.OneMemorialDayInfo)localObject2).uint32_type.get(), 0, "", "", "", "");
        }
        else
        {
          if (!QLog.isColorLevel()) {
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(ajjy.a(2131640866)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = awwf.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    if (((MessageForArkApp)localObject1).ark_app_message.containStructMsg != null)
    {
      ...
      if (!"1".equals(paramChatMessage.getExtInfoFromExtStr(awav.e))) {
        break label469;
      }
    }
    label469:
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131628153), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(azzz.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(azzz.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(azzz.a(localApolloMessage.peer_ts));
    ...
    localObject1 = ajjy.a(2131640867);
  ...
  public static void b(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awam paramawam)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        else
        {
          ...
          int i = ktk.a((byte[])localObject1, 4);
          int j = ktk.a((byte[])localObject2, 4);
          if ((i <= 0) || (j <= 0))
          {
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            catch (Exception localException)
            {
              ...
              boolean bool = lbb.a(paramMsg);
              if (((!paramawam.jdField_a_of_type_Boolean) && (!paramawam.f)) || ((paramawam.jdField_a_of_type_Long != paramawam.jdField_b_of_type_Long) || ((paramawam.jdField_a_of_type_Long == paramawam.jdField_b_of_type_Long) && (!bool))))
              {
                if (QLog.isColorLevel()) {
                  QLog.e("decodeC2CMsgPkg_QCall", 2, "<---decodeC2CMsgPkg_QCall return null:,isReaded:" + paramawam.jdField_a_of_type_Boolean + "syncOther:" + paramawam.f + ",isSharpRequest" + bool);
                }
              }
              else
              {
                ...
                try
                {
                  new lnd(BaseApplicationImpl.getContext()).a(new awbh(paramMsg, l3 - l1, paramMessageHandler, l4, l2, l1, bool));
                  return;
                }
                catch (Exception paramMessageHandler) {}
              }
  ...
  private static void b(QQAppInterface paramQQAppInterface, submsgtype0xb1.InviteInfo paramInviteInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramInviteInfo.putExtra("memberType", mje.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), localInviteInfo.uint64_group_code.get() + ""));
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = awwf.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(awbk.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = awwf.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static void c(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awam paramawam)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has()) || (paramawam.jdField_a_of_type_Boolean) || (paramawam.f)) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_Video return null:hasBody:" + paramMsg.msg_body.has() + ",hasMsgContent" + ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has() + ",isReaded:" + paramawam.jdField_a_of_type_Boolean + "syncOther:" + paramawam.f);
      }
    }
    long l1;
    long l2;
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          return;
          localHashMap = (HashMap)paramawam.a(1000);
          paramawam = (HashSet)paramawam.a(1001);
          if (i != 1) {
            break label511;
          }
          if (lbk.c()) {
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = ajjy.a(2131640865);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = ajjy.a(2131640870);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(ajjy.a(2131640862)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
