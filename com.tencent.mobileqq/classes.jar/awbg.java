...
public class awbg
{
  private static HashMap<String, awbg> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new awbh(this);
  ...
  private awbg(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = awaj.a();
  ...
  public static awbg a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      awbg localawbg = (awbg)jdField_a_of_type_JavaUtilHashMap.get(str);
      paramString1 = localawbg;
      if (localawbg == null)
      {
        paramString1 = new awbg(paramContext.getApplicationContext(), a(paramContext), paramString2);
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (awbj.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          awbj.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", anzj.a(2131704535) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", anzj.a(2131704549) + k);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", anzj.a(2131704531));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(anzj.a(2131704537));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  {
    Intent localIntent = new Intent(awax.c(this.jdField_b_of_type_JavaLangString));
    int i;
    if (paramBoolean)
    {
      i = 1;
      ...
      if (!paramBoolean)
      {
        if (!awax.a(this.jdField_b_of_type_JavaLangString)) {
          break label64;
        }
        awbj.a("2714209");
      }
    ...
    label64:
    while (!awax.b(this.jdField_b_of_type_JavaLangString))
    {
      return;
      i = 0;
      break;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_Awbi != null) {
      this.jdField_a_of_type_Awbi.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", anzj.a(2131704551));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", anzj.a(2131704539) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", anzj.a(2131704546) + (String)localObject3 + " mPluginVersion:" + this.e);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!"huiyin".equals(this.d)) || (bhnv.a(this.jdField_a_of_type_AndroidContentContext)) || (!bool)) {
          break label559;
        }
        return;
      }
      ...
      if (awbk.jdField_a_of_type_JavaUtilMap.get(this.d) != null) {
        awbj.b(String.valueOf(((awbk)awbk.jdField_a_of_type_JavaUtilMap.get(this.d)).g));
      }
      localObject3 = null;
      break;
      label553:
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", anzj.a(2131704545));
