...
public class qca
{
  ...
  public static qca a(articlesummary.RecommendFollowInfos paramRecommendFollowInfos)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      localqca.jdField_a_of_type_Boolean = bool;
      if (paramRecommendFollowInfos.bytes_account_next_cookie.has()) {
        localqca.jdField_a_of_type_ArrayOfByte = paramRecommendFollowInfos.bytes_account_next_cookie.get().toByteArray();
      }
      localqca.jdField_a_of_type_Int = paramRecommendFollowInfos.uint32_card_style.get();
      localqca.jdField_a_of_type_JavaLangString = paramRecommendFollowInfos.bytes_card_title.get().toStringUtf8();
      localqca.jdField_b_of_type_JavaLangString = paramRecommendFollowInfos.bytes_jump_url.get().toStringUtf8();
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        localqca.jdField_a_of_type_JavaUtilList.add(localRecommendFollowInfo);
        if ((localqca.jdField_a_of_type_Int == 2) && (!TextUtils.isEmpty(localRecommendFollowInfo.className)))
        {
    ...
    if (!((HashMap)localObject2).isEmpty())
    {
      ...
      while (paramRecommendFollowInfos.hasNext())
      {
        ...
        {
          localObject3 = new qbe();
          ((qbe)localObject3).jdField_a_of_type_JavaLangString = ((String)((Map.Entry)localObject1).getKey());
          ((qbe)localObject3).jdField_a_of_type_JavaUtilList = ((List)localObject2);
          localqca.jdField_b_of_type_JavaUtilList.add(localObject3);
        }
      }
    }
    return localqca;
  ...
  public static qca a(oidb_0xc2f.GetFollowUserRecommendListRsp paramGetFollowUserRecommendListRsp)
  {
    qca localqca = new qca();
    localqca.jdField_b_of_type_JavaLangString = paramGetFollowUserRecommendListRsp.bytes_jump_url.get().toStringUtf8();
