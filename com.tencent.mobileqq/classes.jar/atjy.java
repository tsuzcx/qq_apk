  ...
  extends atjm
{
  ...
  private atkz jdField_a_of_type_Atkz;
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    atka localatka = (atka)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = b(paramInt1, paramInt2 * 4 + i, paramBoolean, localatka.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new atka(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (Object localObject1 = (WeiYunFileInfo)paramViewGroup;; localObject2 = null)
    {
      if (localObject1 == null)
      {
        ...
        if (this.jdField_a_of_type_Atkz.c()) {
          return null;
        }
        ...
        paramViewGroup.setOnClickListener(this.jdField_a_of_type_Atkz.a(paramView.jdField_a_of_type_AndroidWidgetTextView));
        paramViewGroup.setTag(paramView);
        if ((this.jdField_b_of_type_JavaUtilLinkedHashMap.size() == 0) && (!this.jdField_a_of_type_Atkz.a()))
        {
          paramViewGroup.setVisibility(8);
          if (!this.jdField_a_of_type_Atkz.b()) {
            break label295;
          }
      ...
      for (;;)
      {
        try
        {
          ...
          paramViewGroup = paramView;
          localObject3 = new atjl();
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131368320));
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368337));
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368334));
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.jdField_c_of_type_AndroidViewView$OnClickListener);
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject3);
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_AndroidWidgetImageView.setTag(localObject3);
          paramViewGroup = paramView;
          ((atjl)localObject3).jdField_a_of_type_Boolean = false;
          paramViewGroup = paramView;
        ...
        try
        {
          ...
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setDefaultImage(2130847845);
          ...
          if ((((WeiYunFileInfo)localObject1).h != null) && (((WeiYunFileInfo)localObject1).h.length() > 0) && (auog.b(((WeiYunFileInfo)localObject1).h))) {
          ...
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692166) + ((WeiYunFileInfo)localObject1).c;
          if (!this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.f()) {
            continue;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          if (!atyw.a((WeiYunFileInfo)localObject1)) {
            continue;
          }
          localObject1 = (String)localObject3 + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692167);
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840495);
        ...
        return paramViewGroup;
        paramViewGroup = paramView;
        localObject3 = (atjl)paramView.getTag();
        paramViewGroup = paramView;
        if (!((atjl)localObject3).jdField_a_of_type_Boolean) {
          continue;
        }
        paramViewGroup = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560889, null);
        ...
        paramViewGroup = (ViewGroup)localObject3;
        continue;
        localObject2 = (String)localObject3 + anzj.a(2131708605);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845705);
  ...
  public int getChildrenCount(int paramInt)
  {
    ...
    do
    {
      ...
      break;
      paramInt = j;
    } while (this.jdField_a_of_type_Atkz.c());
    return 1;
  }
