...
public class rqz
  implements Runnable
{
  public rqz(BaseChatPie paramBaseChatPie, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    BaseChatPie.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).setOnTouchListener(new rra(this));
    ...
    localAnimationSet.setAnimationListener(new rrb(this));
