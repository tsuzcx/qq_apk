...
public class bbua
{
  ...
  private static bbua jdField_a_of_type_Bbua;
  ...
  {
    int j = 0;
    if (!bbua.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          Object localObject = apju.b(BaseApplicationImpl.getContext());
  ...
  public static bbua a()
  {
    if (jdField_a_of_type_Bbua == null) {}
    try
    {
      if (jdField_a_of_type_Bbua == null) {
        jdField_a_of_type_Bbua = new bbua();
      }
      return jdField_a_of_type_Bbua;
    }
    finally {}
  }
