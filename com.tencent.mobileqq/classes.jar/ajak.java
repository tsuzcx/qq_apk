  ...
  implements ajay
{
  ...
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new ajam(this);
  ...
  public ajak(AppInterface paramAppInterface, int paramInt)
  {
  ...
  public int a(aivy paramaivy, int paramInt1, int paramInt2, String paramString, long paramLong, int paramInt3, float paramFloat)
  {
    ...
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (localObject1 == null) || (!ajae.d()) || (paramaivy == null)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (localObject1 = null;; localObject1 = null)
      {
        ...
        try
        {
          ...
          {
            localObject1 = ((ApolloSurfaceView)paramaivy).getRender();
            if (localObject1 == null) {
              continue;
            }
          ...
          for (localObject1 = paramString;; localObject1 = ((File)localObject1).getPath())
          {
            ...
            localObject1 = ((ApolloTextureView)paramaivy).getRender();
            break;
        ...
        {
          QLog.e(jdField_a_of_type_JavaLangString, 1, "[playMusic], errInfo->" + paramaivy.getMessage());
          return -1;
        }
        label368:
        ...
        if (paramString != null)
        {
          ...
          localObject1 = ajae.a();
          if (localObject1 != null) {
            ((ApolloCmdChannel)localObject1).playMusicInner(paramaivy, paramString.hashCode(), paramLong);
          }
        ...
        for (;;)
        {
          try
          {
            ...
            synchronized (this.jdField_a_of_type_JavaLangObject)
            {
              ...
              if (paramInt2 == 2147483647)
              {
                ...
                if (paramInt2 != 2147483647)
                {
                  paramString.setOnCompletionListener(new ajal(this, paramInt2, paramaivy, paramLong));
                  if (QLog.isColorLevel()) {
          ...
          {
            QLog.e(jdField_a_of_type_JavaLangString, 1, "prepare - start :", paramaivy);
            return -1;
          }
        }
      }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) || (ajae.b()) || (ajae.c()) || (!ajae.d())) {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "DO NOT play music.");
      }
    }
