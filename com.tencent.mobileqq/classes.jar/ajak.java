  ...
  extends WebViewPlugin
{
  ...
  public ajak()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ajal(this);
        ...
        else if ("sendBlessText".equals(paramString3))
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
            try
            {
              ...
              ajam.a(this.mRuntime.a(), paramString1, paramJsBridgeListener);
            }
            catch (JSONException paramJsBridgeListener)
            {
              paramJsBridgeListener.printStackTrace();
        ...
        else if ("sendBlessPtv".equals(paramString3))
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
            try
            {
              ...
              ajam.a(localAppInterface, localActivity, paramString1, paramString2, paramString3, paramVarArgs, str1, str2, str3, str4, str5, str6, (String)localObject, paramJsBridgeListener);
            }
            catch (JSONException paramJsBridgeListener)
            {
              paramJsBridgeListener.printStackTrace();
