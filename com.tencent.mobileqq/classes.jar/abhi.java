  ...
  extends WebViewPlugin
{
  ...
  private abhk jdField_a_of_type_Abhk = new abhk();
  private abhl jdField_a_of_type_Abhl;
  private Handler jdField_a_of_type_AndroidOsHandler = new abhj(this, Looper.getMainLooper());
  public String a;
  ...
  private void a(Bundle paramBundle)
  {
    ...
    for (CustomWebView localCustomWebView = this.mRuntime.a();; localCustomWebView = null)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        QLog.e("WebSoPlugin", 1, "QZoneWebViewPlugin onReceive 503, now it reload url! " + noe.c(str2, new String[0]));
      ...
      {
        QLog.d("WebSoPlugin", 1, bool1 + ") currentUrl(" + str3 + ") cache hit(" + bool4 + ") hasLoadCache(" + this.jdField_b_of_type_Boolean + ") load Url: " + noe.c(str2, new String[0]) + ",silent_mode:" + paramBundle.getBoolean("is_silent_mode", false) + ",isLocalData:" + bool2);
        if ((localWebSo3 == null) || (!localWebSo3.jdField_a_of_type_Boolean)) {
          break;
        }
        this.jdField_a_of_type_Abhk.a(this, localWebSo3);
        return;
      }
      this.jdField_a_of_type_Abhk.a();
      if ((!bool3) && (Build.VERSION.SDK_INT >= 17))
      {
        if (!bool2) {
          break label481;
        }
        if (this.jdField_a_of_type_Abhl == null)
        {
          this.jdField_a_of_type_Abhl = new abhl(this, localCustomWebView);
          localCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Abhl, "_webso");
          if (QLog.isColorLevel()) {
            QLog.d("WebSoPlugin", 1, "js method : " + Arrays.toString(this.jdField_a_of_type_Abhl.getClass().getDeclaredMethods()));
          }
        }
      }
      label426:
      if ((!this.jdField_b_of_type_Boolean) && (!bool3) && (i != 0))
      {
        ...
        if (bool2) {}
        for (paramBundle = bitb.a(str2, str1);; paramBundle = bitb.b(str2, str1))
        {
          ...
          this.jdField_a_of_type_Abhl.a(str1);
          return;
        }
      }
      if (bool4)
      {
        ...
        if (this.jdField_a_of_type_Abhl != null) {
          this.jdField_a_of_type_Abhl.a("{\"code\":0,\"data\":null}");
        }
      ...
      label770:
      for (paramBundle = bitb.b(str2, str1);; paramBundle = str1)
      {
        a(localCustomWebView, str2, paramBundle);
        return;
  ...
  public static void a(CustomWebView paramCustomWebView, String paramString1, String paramString2)
  {
    ...
    {
      paramCustomWebView.setTag(2131374474, paramString2);
      paramCustomWebView.setTag(2131374475, Long.valueOf(System.currentTimeMillis()));
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if ((localObject instanceof FragmentActivity))
    {
      ...
      if ((localObject != null) && (((WebViewFragment)localObject).mUIStyleHandler != null))
      {
        ...
        {
          birg localbirg = ((WebViewFragment)localObject).mUIStyleHandler;
          if (!paramBoolean) {}
        ...
        {
          ((birg)localObject).d = paramBoolean;
          return;
        }
      }
      b(paramBoolean);
  ...
  private boolean a(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    do
    {
      ...
      {
        QLog.e("WebSoPlugin", 1, "now onHandleEventBeforeLoaded current url is not null! so return! " + noe.c(paramMap, new String[0]));
        return false;
      }
      a(paramString);
    } while ((!bitb.b(paramString)) || (bitb.e(paramString)));
  ...
  {
    if ((this.mRuntime == null) || (this.mRuntime.a() == null) || (this.mRuntime.a().getRootView() == null) || (this.mRuntime.a().getRootView().findViewById(2131381335) == null)) {}
    View localView;
    do
    {
      return;
      localView = this.mRuntime.a().getRootView().findViewById(2131381335).findViewById(2131373049);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if ((paramString2 != null) && ("WebSo".equals(paramString2)))
    {
      ...
      do
      {
        ...
        {
          bitb.a("js call getData");
          this.jdField_a_of_type_Abhk.a(this, paramJsBridgeListener);
          return true;
        }
        if ("updateWebsoCache".equals(paramString3)) {}
        try
        {
          bitb.a("js call updateWebsoCache");
          if (this.jdField_a_of_type_Abhk.a() != null)
          {
            if (this.mRuntime != null) {
        ...
        if ("updateScreenshot".equals(paramString3)) {
          try
          {
            bitb.a("js call updateScreenshot");
            if (this.mRuntime != null)
            {
              paramString1 = this.mRuntime.a();
              paramString2 = paramString1.getUrl();
              if (bitb.b(paramString2)) {
