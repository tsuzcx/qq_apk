...
public class brhq
{
  private static brhq jdField_a_of_type_Brhq;
  ...
  static
  {
    jdField_a_of_type_JavaIoFile = a(new File(alwf.d), "qqstroy_follow_capture");
    d();
  }
  
  public static brhq a()
  {
    if (jdField_a_of_type_Brhq == null) {}
    try
    {
      if (jdField_a_of_type_Brhq == null) {
        jdField_a_of_type_Brhq = new brhq();
      }
      return jdField_a_of_type_Brhq;
    }
    finally {}
  }
  ...
  public static void a(String paramString, brhs parambrhs)
  {
    ...
    for (;;)
    {
      ...
      if (!b(str2, str1))
      {
        ...
        localbeum.jdField_a_of_type_Beuq = new brhr(str2, str1, parambrhs);
        ...
        try
        {
          parambrhs = BaseApplicationImpl.getApplication().getRuntime();
          if (QQAppInterface.class.isInstance(parambrhs))
          {
            ((QQAppInterface)parambrhs).getNetEngine(0).a(localbeum);
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(wta.d());
  }
