...
public class asme
{
  ...
  public static void a(Activity paramActivity, asfs paramasfs, String paramString, EditExtendFriendInfo.SchoolInfo paramSchoolInfo)
  {
    ...
    paramString = String.format(paramActivity.getString(2131697887), new Object[] { paramString });
    bglp.a(paramActivity, 230).setMessage(paramString).setPositiveButton(paramActivity.getString(2131697888), new asmg(paramasfs, paramSchoolInfo)).setNegativeButton(paramActivity.getString(2131690586), new asmf()).show();
  }
