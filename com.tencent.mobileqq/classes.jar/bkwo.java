  ...
  implements ChannelProxy
{
  ...
  private volatile zqi jdField_a_of_type_Zqi;
  ...
  private bnwr a(TianShuAccess.AdItem paramAdItem, String paramString, int paramInt)
  {
  ...
  {
    return new bkxb(paramAsyncResult);
  }
  ...
  private void a(Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (paramMiniAppInfo != null)
    {
      ...
      if (paramMiniAppInfo != null)
      {
        ...
        if (!TextUtils.isEmpty(paramPublishMoodInfo.mPath))
        {
          ...
          paramPublishMoodInfo = paramActivity.getResources().getString(2131693706);
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("button_txt", paramActivity.getResources().getString(2131693715));
  ...
  public void JudgeTiming(String paramString1, int paramInt1, int paramInt2, int paramInt3, long paramLong, int paramInt4, String paramString2, int paramInt5, String paramString3, int paramInt6, COMM.StCommonExt paramStCommonExt, String paramString4, String paramString5, AsyncResult paramAsyncResult)
  {
    ...
    MiniAppSSOCmdHelper.sendSSOCmdRequest("LightAppSvc.mini_app_growguard.JudgeTiming", paramString1, paramString4, INTERFACE.StJudgeTimingRsp.class, new bkwu(this, paramAsyncResult));
  }
  ...
  public void ReportExecute(String paramString1, int paramInt, String paramString2, String paramString3, AsyncResult paramAsyncResult)
  {
    ...
    MiniAppSSOCmdHelper.sendSSOCmdRequest("LightAppSvc.mini_app_growguard.ReportExecute", paramString1, localStReportExecuteReq, INTERFACE.StReportExecuteRsp.class, new bkwv(this, paramAsyncResult));
  }
  ...
  public void addGroupApp(IMiniAppContext paramIMiniAppContext, AsyncResult paramAsyncResult)
  {
    ...
    return;
    label198:
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "query_user_troop_info", new Bundle(), new bkwt(this, paramIMiniAppContext, str, paramAsyncResult));
  }
  ...
  {
    akxq.a(new FocusMpIdReq(paramString1, paramString2), new bkxa(this, paramAsyncResult));
    return true;
  }
  ...
  public void ffmpegExecCommand(String[] paramArrayOfString, ChannelProxy.ICommandListenr paramICommandListenr)
  {
    try
    {
      ...
      this.jdField_a_of_type_Zqi.a(paramArrayOfString, new bkws(this, paramICommandListenr));
      return;
    }
  ...
  {
    MiniAppCmdUtil.getInstance().getAuthList(null, paramString, new bkwp(this, paramAuthListResult));
  }
  ...
  {
    afez.a(paramActivity, paramIntent, PublicFragmentActivityForMini.class, AddPhoneNumberFragment.class, paramInt);
  }
  
  public void launchPhoneNumberManagementFragment(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    afez.a(paramActivity, paramIntent, PublicFragmentActivityForMini.class, PhoneNumberManagementFragment.class, paramInt);
  }
  ...
  public boolean openGroup(Context paramContext, String paramString, AsyncResult paramAsyncResult)
  {
    if ((paramContext instanceof Activity))
    {
      ...
      paramString.addActivityResultListener(new bkwz(this, paramString, paramAsyncResult));
  ...
  {
    bgpy.a(paramContext, paramString1, paramString2);
    return true;
  }
  ...
  {
    MiniAppSendSmsCodeServlet.sendSmsCodeRequest(paramString1, paramString2, new bkww(this, paramAsyncResult));
  }
  ...
  {
    MiniAppSendSmsCodeServlet.sendVerifySmsCodeRequest(paramString1, paramString2, paramString3, new bkwx(this, paramAsyncResult));
  }
  ...
  {
    bnwq.a().a(a(paramAdItem, paramString, paramInt));
    return true;
  }
  ...
  public boolean tianshuRequestAdv(Context paramContext, String paramString, int paramInt1, int paramInt2, int paramInt3, AsyncResult paramAsyncResult)
  {
    ...
    try
    {
      ...
      MiniTianShuManager.requestAdv(Collections.singletonList(paramContext), new bkwy(this, paramAsyncResult));
      return true;
    }
