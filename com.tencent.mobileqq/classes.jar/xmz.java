    ...
    for (;;)
    {
      try
      {
        ...
        if ("share".equals(paramJsBridgeListener.optString("type")))
        {
          ...
          bded.a().a(paramJsBridgeListener, "", this.mRuntime.a().getAccount(), false);
        }
        paramJsBridgeListener = this.mRuntime.a(this.mRuntime.a());
        if ((paramJsBridgeListener == null) || (!(paramJsBridgeListener instanceof bchm))) {
          break label747;
        }
        paramString1 = (bchm)paramJsBridgeListener;
        if (QLog.isColorLevel()) {
          QLog.d("ShareApiPlugin", 2, "Share JS deal cost=" + (System.currentTimeMillis() - paramString1.b()));
        }
        if (!(paramJsBridgeListener instanceof bchr)) {
          break label747;
        }
        paramJsBridgeListener = (bchr)paramJsBridgeListener;
        ...
        else if ((TextUtils.isEmpty(this.c)) || (TextUtils.isEmpty(this.b)) || (TextUtils.isEmpty(this.d)) || (TextUtils.isEmpty(this.a)) || (this.c.startsWith("http://")) || (this.c.startsWith("https://")))
        {
          ...
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), arpc.class);
          ...
          paramString1.setObserver(new xna(this, paramJsBridgeListener));
