...
public final class bmkn
  extends bmfc
{
  private static volatile bmkn jdField_a_of_type_Bmkn;
  ...
  private final int b = ((Integer)bmmf.b(Integer.valueOf(3), Integer.valueOf(5), Integer.valueOf(7))).intValue();
  ...
  static
  {
    jdField_d_of_type_JavaLangString = bmda.b + File.separator + "frame";
  }
  
  private bmkn()
  {
    super("camera/ae_camera_editor_download_resources.json", bmda.b, 4, "AEEditorResourceManager");
    this.jdField_d_of_type_JavaUtilMap = new LinkedHashMap();
  }
  
  public static bmkn a()
  {
    if (jdField_a_of_type_Bmkn == null) {}
    try
    {
      if (jdField_a_of_type_Bmkn == null) {
        jdField_a_of_type_Bmkn = new bmkn();
      }
      return jdField_a_of_type_Bmkn;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      bmbx.b("AEEditorResourceManager", "setupFrameEnv---pag file is already copied");
      return;
    }
  ...
  private void e()
  {
    bmbx.b(this.jdField_c_of_type_JavaLangString, "setupDisplayFilterList--BEGIN");
    QIPCClientHelper.getInstance().callServer("AEEditorEffectIpcModule", "action_get_effect_list", new Bundle(), new bmko(this));
  }
  ...
  private void f()
  {
    synchronized (this.e)
    {
      ...
      {
        bmbx.d(this.jdField_c_of_type_JavaLangString, "setupFontListConfig---read assets json content empty");
        return;
      }
    }
    Object localObject2 = (List)GsonUtils.json2Obj(str2, new bmkq(this).getType());
  ...
  private void g()
  {
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaUtilMap)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          bmbx.d(this.jdField_c_of_type_JavaLangString, "ensureSetupPagStickerConfig---read assets json content empty");
      ...
      localObject2 = (AEEditorPagStickerGroupWrapper)GsonUtils.json2Obj(str, new bmkr(this).getType());
      if ((localObject2 == null) || (CollectionUtils.isEmpty(((AEEditorPagStickerGroupWrapper)localObject2).stickerGroupList)))
      {
        localObject2 = new LinkedList();
        bmbx.d(this.jdField_c_of_type_JavaLangString, "ensureSetupPagStickerConfig---parsed result invalid");
      }
      else
      {
    ...
    {
      bmbx.b((String)localObject3, localObject2);
      return;
  ...
  public Pair<String, String> a(@NonNull String paramString, int paramInt)
  {
    ...
    for (localObject = b((AEEditorDownloadResBean)localObject);; localObject = null)
    {
      ...
      {
        bmbx.d("AEEditorResourceManager", "font not find.");
      ...
      if (b(paramString))
      {
        bmbx.d("AEEditorResourceManager", "fontExceededLimit.");
  ...
  {
    return (AEEditorPagStickerConfig)GsonUtils.json2Obj(b(paramString), new bmks(this).getType());
  }
    ...
    if (a().getValue() != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localAEEditorFilterBean.getEditorEffectItem().getPreDownload() == 1) {
          paramList.add(bmfb.a(localAEEditorFilterBean));
        }
      }
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, String paramString)
  {
    ...
    {
      if (!TextUtils.isEmpty(str1)) {
        bmbc.a().a(paramBoolean, 3, str1, paramString, paramInt, paramLong);
      }
      return;
  ...
  {
    return a(bmfb.a(paramAEEditorFilterBean)) + File.separator + "effectInfo.json";
  }
  ...
  public String c(AEEditorFilterBean paramAEEditorFilterBean)
  {
    ...
    if (!TextUtils.isEmpty(paramAEEditorFilterBean.getEffectExtendBean().getMotionID())) {
      str = a(bmfb.a(paramAEEditorFilterBean)) + File.separator + paramAEEditorFilterBean.getEffectExtendBean().getMotionID();
    }
    return str;
  }
