  ...
  extends alko
{
  ...
  public ambd(QQAppInterface paramQQAppInterface)
  {
  ...
  private static PayRuleCfg a(String arg0, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (paramString2 != null) {
        return (PayRuleCfg)bjpy.a(PayRuleCfg.class, paramString2);
      }
    }
    return null;
  }
  ...
  public static String a(PayRuleCfg paramPayRuleCfg)
  {
    ...
    return Base64.encodeToString(bjpy.a(paramPayRuleCfg), 2) + "\n" + paramPayRuleCfg;
  }
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    localbkcj.b = (str + "_" + l1);
    localbkcj.jdField_a_of_type_Int = 1;
    localbkcj.jdField_e_of_type_JavaLangString = "tianshu.47";
    localbkcj.jdField_f_of_type_JavaLangString = "tianshu.47";
    localbkcj.g = paramString;
    localbkcj.h = "";
    localbkcj.jdField_a_of_type_Long = l1;
  ...
  private void a(@NonNull PrivExtV2Rsp paramPrivExtV2Rsp, String paramString)
  {
    ...
    Friends localFriends = localaloz.d(paramString);
    ...
    {
      paramString = (alqr)this.app.getManager(131);
    ...
    for (;;)
    {
      bdvo.a().a(this.app, paramPrivExtV2Rsp);
      return;
      label508:
      paramString.apply();
    }
  ...
  private void a(VipMedalList paramVipMedalList, String paramString)
  {
    ...
    aloz localaloz = (aloz)this.app.getManager(51);
    paramString = localaloz.d(paramString);
  ...
  private static boolean a(PayRuleCfg paramPayRuleCfg1, PayRuleCfg paramPayRuleCfg2)
  {
    ...
    return Arrays.equals(bjpy.a(paramPayRuleCfg1), bjpy.a(paramPayRuleCfg2));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, PayRuleCfg paramPayRuleCfg, boolean paramBoolean)
  {
    ...
    for (paramQQAppInterface = Boolean.valueOf(false);; paramQQAppInterface = Integer.valueOf(paramPayRuleCfg.enable))
    {
      ...
      return false;
      long l1 = bdwk.a(paramQQAppInterface, "last_pull_pay_rule", 0L);
  ...
  private static void b(String paramString1, String arg1, PayRuleCfg paramPayRuleCfg)
  {
    ...
    paramPayRuleCfg = bjpy.a(paramPayRuleCfg);
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      bdcs.a(paramPayRuleCfg, paramString1.getAbsolutePath());
      return;
    }
  }
  ...
  public void a(UniGetReq paramUniGetReq, alkr paramalkr, boolean paramBoolean)
  {
    paramalkr = createToServiceMsg("QCUniBusinessLogic.uniGet", paramalkr, paramBoolean);
    paramUniGetReq.stLogin = a();
    paramalkr.extraData.putSerializable("req", paramUniGetReq);
    send(paramalkr);
  }
  
  public void a(UniSetReq paramUniSetReq, alkr paramalkr, boolean paramBoolean)
  {
    paramalkr = createToServiceMsg("QCUniBusinessLogic.uniSet", paramalkr, paramBoolean);
    paramUniSetReq.stLogin = a();
    paramalkr.extraData.putSerializable("req", paramUniSetReq);
    send(paramalkr);
  }
          ...
          do
          {
            ...
            if ("ClubInfoSvc.queryPrivExt".equals(localObject1))
            {
              ...
              if (i1 == 1)
              {
                ...
                bdvr.a(((PrivExtV2Rsp)localObject1).trafficResult, paramToServiceMsg.extraData);
                if ((localObject2 != null) && (((VipUserInfo)localObject2).bUpdate == 1) && (((PrivExtV2Rsp)localObject1).trafficResult != null) && (((PrivExtV2Rsp)localObject1).trafficResult.bUpdate == 1) && (((PrivExtV2Rsp)localObject1).medalInfoList != null) && (((PrivExtV2Rsp)localObject1).medalInfoList.bUpdate == 1)) {
                  bdwk.a(this.app, "setting_me_get_vip_info_sequence", NetConnInfoCenter.getServerTime());
                }
                bdwk.a(this.app, "setting_me_last_request_success_time", NetConnInfoCenter.getServerTime());
                bdwk.a(this.app, "setting_me_vip_sync_freq", ((PrivExtV2Rsp)localObject1).iSyncFreq);
                if ((((PrivExtV2Rsp)localObject1).medalInfoList != null) && (((PrivExtV2Rsp)localObject1).medalInfoList.bUpdate == 1))
                {
                  ...
                  l1 = 1L;
                  bdwk.a(this.app, "key_long_setting_me_vip_medal_list_record", l1);
                }
                paramToServiceMsg = ((PrivExtV2Rsp)localObject1).itemCfgList;
                if (paramToServiceMsg != null)
                {
                  l1 = bdwk.a(this.app, "name_plate_config_version", 0L);
                  ...
                  {
                    bdwk.a(this.app, "name_plate_config_version", paramToServiceMsg.iItemCfgVer);
                ...
                {
                  bdwk.a(this.app, "last_pull_pay_rule", NetConnInfoCenter.getServerTime());
              ...
              for (bool2 = bool1;; bool2 = bool1)
              {
                ...
                bfdq.a().a("ClubInfoSvc.queryPrivExt", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, "[CMD:ClubInfoSvc.queryPrivExtfailed]", true);
              }
            }
