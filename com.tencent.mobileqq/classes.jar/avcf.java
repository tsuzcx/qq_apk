  ...
  implements avbz
{
  ...
  public avcf(Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_Avca = paramavca;
  }
  
  public void a(avcb paramavcb)
  {
    this.jdField_a_of_type_Avcb = paramavcb;
  }
  
  public void a(avcc paramavcc)
  {
    this.jdField_a_of_type_Avcc = paramavcc;
  }
  ...
  {
    this.jdField_a_of_type_Avce = paramavce;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    do
    {
      ...
      String str = uja.a(paramString1, 0);
      this.b = paramString2;
      this.c = paramString3;
      ...
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
      {
        ...
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new avcg(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new avch(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new avci(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new avcj(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new avck(this, paramString2, paramString1, paramString3));
      }
      paramString1 = a(str, paramString2, paramLong);
      paramString1.setConfigMap("keep_last_frame", "true");
      if ((!TextUtils.isEmpty(paramString2)) && (ujb.a(new File(paramString2))))
      {
    ...
    {
      Bosses.get().postJob(new avcl(this, "VideoViewTVKImpl", paramString3, paramString1));
      return;
    }
    this.c = bavf.b(this.c.replace("https://", "http://"), 1012);
