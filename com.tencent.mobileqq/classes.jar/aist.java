...
{
  public aist(ClassificationSearchActivity paramClassificationSearchActivity) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (int i = 8;; i = 0)
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getResources().getString(2131690697));
      if (AppSetting.c) {
    ...
    if (!str.equals("")) {}
    for (paramEditable = this.a.getResources().getString(2131718388);; paramEditable = this.a.getResources().getString(2131690697))
    {
