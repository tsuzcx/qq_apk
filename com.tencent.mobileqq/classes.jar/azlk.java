...
public class azlk
  implements Handler.Callback, axrb
{
  private static azlk jdField_a_of_type_Azlk;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  public int a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  public ConcurrentHashMap<String, awwm> a;
  ...
  public static azlk a()
  {
    if (jdField_a_of_type_Azlk == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Azlk == null) {
        jdField_a_of_type_Azlk = new azlk();
      }
      return jdField_a_of_type_Azlk;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView)
  {
    ...
    if ((!TextUtils.isEmpty(paramFriends.songName)) && (System.currentTimeMillis() < paramFriends.songEndTime))
    {
      ...
      {
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131697727), new Object[] { paramFriends.songName, paramFriends.singerName });
        if (!(paramTextView instanceof OnlineStatusLyricView)) {
          break label152;
        }
        ((azll)bplg.a().getBusinessHandler(174)).a(paramFriends);
        ((OnlineStatusLyricView)paramTextView).setFriendSession(paramFriends, paramQQAppInterface);
      }
      for (;;)
      {
        bdll.b(null, "dc00898", "", "", "0X800AC92", "0X800AC92", paramFriends.songSourceType, 0, "", "0", "0", "");
        return paramQQAppInterface;
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131697728), new Object[] { paramFriends.songName });
        break;
        label152:
        paramQQAppInterface = aqvy.a(paramTextView.getPaint(), paramQQAppInterface, bhtq.a(200.0F));
      }
    }
    return paramQQAppInterface.getString(2131697729);
  }
  ...
  public void a(Activity paramActivity, String paramString)
  {
    ...
    bdll.b(null, "dc00898", "", "", "0X800ABB2", "0X800ABB2", 0, 0, "", "0", "0", "");
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      {
        localazll.a((MusicInfo)localObject, j, bool, QQMusicPlayService.a());
    ...
    azll localazll = (azll)a().a(174);
    Object localObject = QQPlayerService.b();
    if (paramMessage.arg1 == 1) {}
    for (boolean bool = true;; bool = false)
    {
      localazll.a((SongInfo)localObject, i, bool, QQPlayerService.d());
