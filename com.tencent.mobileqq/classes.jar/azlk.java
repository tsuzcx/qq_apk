...
public class azlk
{
  ...
  public azlk(QQAppInterface paramQQAppInterface)
  {
  ...
  public ArrayList<aukm> a(String paramString)
  {
    ...
    Object localObject2 = (aktn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(2);
    Object localObject1 = ((aktn)localObject2).a(paramString);
    ...
    if (j < ((List)localObject1).size())
    {
      ...
      {
        localObject6 = ((aktg)localObject4).a(((TroopIndex)localObject5).mTroopUin, 1);
    ...
    for (float f2 = f1;; f2 = 0.0F)
    {
      ...
      localObject7 = ((aktn)localObject2).b((String)localObject7);
      ...
      if ((((ajxn)localObject1).b(((TroopIndex)localObject8).mMemberUin)) && (!((String)localObject6).equals(((TroopIndex)localObject8).mMemberUin)) && (!paramString.equals(((TroopIndex)localObject8).mMemberUin)))
      {
        if (((HashMap)localObject5).containsKey(((TroopIndex)localObject8).mMemberUin)) {
          break label668;
        }
        azln localazln = new azln(this, f3);
        localazln.b = f2;
        localazln.jdField_a_of_type_Int = 1;
        RecentUser localRecentUser = ((aktg)localObject4).a(((TroopIndex)localObject8).mMemberUin, 0);
        if (localRecentUser != null) {
          localazln.jdField_a_of_type_Long = localRecentUser.lastmsgtime;
        }
        ((HashMap)localObject5).put(((TroopIndex)localObject8).mMemberUin, localazln);
      }
      for (;;)
      {
        j += 1;
        break;
        localObject8 = (azln)((HashMap)localObject5).get(((TroopIndex)localObject8).mMemberUin);
        ((azln)localObject8).jdField_a_of_type_Int += 1;
        ((azln)localObject8).b += f2;
      }
      if (QLog.isColorLevel()) {
      ...
      Collections.sort(paramString, new azll(this));
      i = paramString.size();
      if ((i > 1) && (((azln)((Map.Entry)paramString.get(i - 1)).getValue()).a() == ((azln)((Map.Entry)paramString.get(0)).getValue()).a())) {}
      for (i = 1;; i = 0)
      {
        if (i != 0)
        {
          ...
          Collections.sort(paramString, new azlm(this));
        }
        localObject2 = new ArrayList();
        i = 0;
        if (i < paramString.size())
        {
          localObject3 = (azln)((Map.Entry)paramString.get(i)).getValue();
          localObject4 = ((ajxn)localObject1).b((String)((Map.Entry)paramString.get(i)).getKey());
          if (localObject4 != null)
          {
            ((ArrayList)localObject2).add(localObject4);
            if ((i < 20) && (QLog.isColorLevel())) {
              QLog.i("RelationFriendsSearchHelper", 2, "top20:uin" + bbjw.e(((Friends)localObject4).uin) + ",scores:" + ((azln)localObject3).a() + ",frequency:" + ((azln)localObject3).jdField_a_of_type_Int + ",activefactor:" + ((azln)localObject3).b + ",c2clastmsgtime:" + ((azln)localObject3).jdField_a_of_type_Long);
            }
          }
          for (;;)
          {
