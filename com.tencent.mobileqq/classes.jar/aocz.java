...
{
  public aocz(SVIPHandler.1 param1, aqhg paramaqhg) {}
        ...
        if (paramObject.size() > 0)
        {
          ...
          while (paramObject.hasNext())
          {
            ...
            if (!TextUtils.isEmpty(((BubbleDiyEntity)localObject).topLeftId))
            {
              ...
              this.jdField_a_of_type_Aqhg.b.add(str2);
            }
            ...
            if (!TextUtils.isEmpty(((BubbleDiyEntity)localObject).bottomLeftId))
            {
              ...
              this.jdField_a_of_type_Aqhg.b.add(localObject);
            }
          }
        }
      }
