  ...
  implements GestureDetector.OnGestureListener
{
  ...
  private mlv(VideoLayerUI paramVideoLayerUI) {}
  ...
  public boolean onScroll(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    {
      bdll.b(null, "CliOper", "", "", "0X8009F62", "0X8009F62", 0, 0, "", "", "", "");
  ...
  public boolean onSingleTapUp(MotionEvent paramMotionEvent)
  {
    ...
    if (VideoLayerUI.e(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI))
    {
      ...
      paramMotionEvent = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMep[0];
      ...
      if (((ArrayList)localObject1).size() > VideoLayerUI.f(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI))
      {
        ...
        bdll.b(null, "CliOper", "", "", "0X800A069", "0X800A069", 0, 0, "", "", "", "");
      ...
      localObject2 = (mma)((ArrayList)localObject1).get(j + 1);
      boolean bool2;
      if (localObject2 != null)
      {
        bool2 = ((mma)localObject2).c();
        if (localObject2 == null) {
          break label760;
        }
        if ((!str.equalsIgnoreCase(String.valueOf(((mma)localObject2).jdField_a_of_type_Long))) || (((mma)localObject2).b() != k)) {
          break label754;
        }
        bool1 = true;
        label363:
        ...
        {
          bool1 = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Mjj.a();
          if ((!bool1) || (!bool2)) {
            break label766;
          }
          bdll.b(null, "CliOper", "", "", "0X8009F63", "0X8009F63", 0, 0, "", "", "", "");
          str = paramMotionEvent.b();
          i = Integer.valueOf(paramMotionEvent.h()).intValue();
          long l = ((mma)localObject2).jdField_a_of_type_Long;
          k = Integer.valueOf(((mma)localObject2).b()).intValue();
          ...
          if (!bool2)
          {
            if (!((mma)localObject2).a()) {
              break label846;
            }
            if (((mma)localObject2).a() != this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) {
              break label823;
            }
            bool1 = true;
            if (!bool1) {
            ...
            mbb.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1051);
      ...
      for (;;)
      {
        bdll.b(null, "CliOper", "", "", "0X800A068", "0X800A068", 0, 0, "", "", "", "");
        return true;
        bool2 = false;
        break;
        label754:
        ...
        break label669;
        label829:
        mbb.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1052);
        break label688;
        label846:
        mbb.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1053);
    ...
    {
      i = j + 1;
      if ((this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMep == null) || (i <= 0) || (i >= this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMep.length)) {
        return true;
      }
      localObject2 = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMep[0];
      paramMotionEvent = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMep[i];
      if ((localObject2 == null) || (paramMotionEvent == null)) {
        return true;
      }
      if (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Mjj.a())
      {
        bdll.b(null, "CliOper", "", "", "0X8009F63", "0X8009F63", 0, 0, "", "", "", "");
        localObject1 = ((mep)localObject2).b();
        j = Integer.valueOf(((mep)localObject2).h()).intValue();
      ...
      QLog.d(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_JavaLangString, 1, "condition print onSingleTapUp mTargetIndex:=" + this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.q + ",canSwitchView=" + this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Mjj.a());
    }
    for (;;)
    {
      return true;
