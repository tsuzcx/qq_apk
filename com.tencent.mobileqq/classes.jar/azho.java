...
public class azho
{
  ...
  public static final HashMap<String, azhq> a;
  public static Hashtable<String, TroopBarPublishActivity.Pic_list> a;
  protected static final String b;
  public static final HashMap<String, azhq> b;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131649437);
    jdField_b_of_type_JavaLangString = ajjy.a(2131649447);
    jdField_c_of_type_JavaLangString = ajjy.a(2131649428);
    d = ajjy.a(2131649424);
  ...
  public static final Uri a(BaseActivity paramBaseActivity, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      for (boolean bool = true; (bool) && (paramString.canWrite()); bool = paramString.mkdirs()) {
        try
        {
          ...
          Uri localUri = FileProvider7Helper.setSystemCapture(paramBaseActivity, new File(ajed.ba + System.currentTimeMillis() + ".jpg"), paramString);
    ...
    bbmy.a(paramBaseActivity, 2131630858, 1).b(paramBaseActivity.getTitleBarHeight());
    return null;
  }
  ...
  public static final String a(EditText paramEditText)
  {
    ...
    if ((paramEditText.getEditableText() instanceof axkn))
    {
      axkn localaxkn = (axkn)paramEditText.getEditableText();
      if (localaxkn != null)
      {
        int i = localaxkn.length();
        Object localObject1 = new char[i];
        localaxkn.getChars(0, i, (char[])localObject1, 0);
        paramEditText = new StringBuffer();
        paramEditText.append((char[])localObject1);
        localObject1 = (axkk[])localaxkn.getSpans(0, i, axkk.class);
        if (((localaxkn instanceof Spanned)) && (Build.VERSION.SDK_INT >= 24)) {
          Arrays.sort((Object[])localObject1, new azhp(localaxkn));
        }
        int k = 0;
        if (j < localObject1.length)
        {
          ...
          int m;
          if (((axkk)localObject2).c == 1)
          {
            i = localaxkn.getSpanStart(localObject2);
            m = localaxkn.getSpanEnd(localObject2);
            localObject2 = axjs.a[(localObject2.a & 0x7FFFFFFF)];
          ...
          for (;;)
          {
            ...
            break;
            i = k;
            if (((axkk)localObject2).c == 2)
            {
              i = localaxkn.getSpanStart(localObject2);
              m = localaxkn.getSpanEnd(localObject2);
              localObject2 = ((axkk)localObject2).a();
              paramEditText.replace(i + k, m + k, (String)localObject2);
              i = k + (((String)localObject2).length() - (m - i));
            }
          }
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          if (paramString.indexOf(axjs.a[i]) != -1) {
            str = paramString.replace(axjs.a[i], "\024" + (char)i);
          }
          i += 1;
          paramString = str;
        }
  ...
  public static final JSONObject a(String paramString1, Context paramContext, String paramString2, String paramString3, String paramString4, Map<String, String> paramMap)
  {
    ...
    for (paramContext = new HashMap();; paramContext = paramMap)
    {
      ...
      paramString1 = mpl.a(paramString1, paramString3, paramString4, paramContext, localHashMap2, localHashMap1);
      if (QLog.isColorLevel())
      {
        QLog.d("TroopBar", 2, "singleUploadImage t = " + (System.currentTimeMillis() - l) + ", path = " + paramString2 + ", size = " + apdh.a(paramString2));
  ...
  {
    int i = badq.b(paramContext);
    awqx.b(null, "P_CliOper", "BizTechReport", "", paramString1, paramString2, 0, paramInt, "" + i, paramString3, paramString4, paramString5);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle1, String paramString3, int paramInt, Bundle paramBundle2, azgl paramazgl, String paramString4)
  {
    if ((paramBundle1 != null) && (!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      paramBundle1.putString("version", "8.2.6");
      ...
      new azgk(paramString3, paramString4, paramazgl, paramInt, paramBundle2).execute(new HashMap[] { paramString1 });
    }
  ...
  public static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, azgl paramazgl)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, paramazgl, "GET");
  }
  
  protected static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString1, int paramInt, Bundle paramBundle2, azgl paramazgl, String paramString2)
  {
    AppRuntime localAppRuntime = paramBaseActivity.getAppRuntime();
    String str = localAppRuntime.getAccount();
    a(paramBaseActivity, str, ((TicketManager)localAppRuntime.getManager(2)).getSkey(str), paramBundle1, paramString1, paramInt, paramBundle2, paramazgl, paramString2);
  }
  ...
  {
    awqx.b(null, "P_CliOper", paramString1, "", paramString2, paramString3, 0, 0, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public static void b(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, azgl paramazgl)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, paramazgl, "POST");
  }
  ...
  {
    awqx.b(null, "dc00899", "Grp_tribe", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
}
