...
public class bgny
{
  ...
  static String g = amtj.a(2131699296);
  static String h = amtj.a(2131699294);
  static String i = amtj.a(2131699295);
  static String j = amtj.a(2131699293);
  public int a;
  public long a;
  ...
  public static bgny a()
  {
    if (jdField_a_of_type_Bgny == null) {}
    try
    {
      if (jdField_a_of_type_Bgny == null) {
        jdField_a_of_type_Bgny = new bgny();
      }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramInt1 = bbjb.jdField_a_of_type_Int;
      bbjb.jdField_a_of_type_Int = paramInt1 + 1;
      ...
      localMessageRecord.msgUid = aszt.b();
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null) {
        break label249;
      }
    }
    ...
    label230:
    label249:
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = bbko.a())
    {
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    {
      atif.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
      localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
      if (localObject1 != null)
      {
        avsp.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", avsp.jdField_a_of_type_JavaLangString);
        avsp.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", avsp.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      if (localObject1 != null)
      {
        bfua.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + bfua.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        areb.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", areb.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        areb.jdField_b_of_type_Boolean = bool1;
      ...
      if (localObject1 != null) {
        bghf.a().a((JSONArray)localObject1);
      }
      arfm.a(paramAppRuntime.optJSONArray("h5MagicTips"));
      return;
    }
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((bbyp.b()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.curType)
      {
