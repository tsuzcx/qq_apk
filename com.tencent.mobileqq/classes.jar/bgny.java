...
public class bgny
{
  ...
  public bgny(AppRuntime paramAppRuntime, String paramString1, String paramString2)
  {
    this.c = paramString1;
  ...
  private void d()
  {
    String str1 = aopg.a(apck.a(new String(this.c))).toLowerCase();
    int i = badq.b(BaseApplicationImpl.getContext());
    File localFile = new File(this.c);
    JSONObject localJSONObject = bgnv.a(this.jdField_a_of_type_MqqAppAppRuntime, localFile.getName(), this.d, str1);
    Object localObject;
    if ((localJSONObject != null) && (localJSONObject.optInt("retcode") == 0))
    {
      ...
      if (localObject == null)
      {
        ...
        azld.a("grp_hw", "upload_video", "-1", "", i + "", "");
        if (this.jdField_a_of_type_Bgnx != null) {
          this.jdField_a_of_type_Bgnx.b(2);
        }
      }
    }
    do
      ...
      do
      {
        do
        {
            ...
            do
            {
              for (;;)
              {
                ...
                if (TextUtils.isEmpty(str2))
                {
                  ...
                  azld.a("grp_hw", "upload_video", "-2", "", i + "", "");
                  if (this.jdField_a_of_type_Bgnx != null) {
                    this.jdField_a_of_type_Bgnx.b(2);
                  }
                }
                  ...
                  if (!TextUtils.isEmpty((CharSequence)localObject)) {
                    try
                    {
                      ...
                      if ((l != 0L) && (localFile.length() > l))
                      {
                        ...
                        azld.a("grp_hw", "upload_video", "-3", "", i + "", "");
                        if (this.jdField_a_of_type_Bgnx == null) {
                          continue;
                        }
                        this.jdField_a_of_type_Bgnx.b(3);
                      }
                    }
              ...
              j = bgnv.a(localJSONObject, this.c, str1);
              if (j != 0) {
                break;
              }
              if (QLog.isColorLevel()) {
              ...
              azld.a("grp_hw", "upload_video", "0", "1", i + "", "");
            } while (this.jdField_a_of_type_Bgnx == null);
            this.jdField_a_of_type_Bgnx.a(str2);
            return;
            if (QLog.isColorLevel()) {
              QLog.w("TroopHomeworkHelper", 2, "doPutCOSData failed, putResult =" + j);
            }
            azld.a("grp_hw", "upload_video", "-4", "", i + "", "");
          } while (this.jdField_a_of_type_Bgnx == null);
          this.jdField_a_of_type_Bgnx.b(5);
          return;
          ...
          default: 
            ...
            azld.a("grp_hw", "upload_video", "-6", "", i + "", "");
          }
        } while (this.jdField_a_of_type_Bgnx == null);
        this.jdField_a_of_type_Bgnx.b(2);
        return;
  ...
  private void e()
  {
    ...
    int i = badq.b(BaseApplicationImpl.getContext());
    File localFile = new File(this.c);
    Object localObject = bgnv.c(this.c);
    localObject = bgnv.b(this.jdField_a_of_type_MqqAppAppRuntime, localFile.getName(), this.d, (String)localObject);
  ...
  private void f()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 276	bgny:jdField_a_of_type_ComSquareupOkhttpOkHttpClient	Lcom/squareup/okhttp/OkHttpClient;
    //   4: ifnonnull +53 -> 57
    //   7: aload_0
    //   8: new 278	com/squareup/okhttp/OkHttpClient
    //   11: dup
    //   12: invokespecial 279	com/squareup/okhttp/OkHttpClient:<init>	()V
    //   15: putfield 276	bgny:jdField_a_of_type_ComSquareupOkhttpOkHttpClient	Lcom/squareup/okhttp/OkHttpClient;
    //   18: aload_0
    //   19: getfield 276	bgny:jdField_a_of_type_ComSquareupOkhttpOkHttpClient	Lcom/squareup/okhttp/OkHttpClient;
    //   22: ldc2_w 280
    ...
    //   31: aload_0
    //   32: getfield 276	bgny:jdField_a_of_type_ComSquareupOkhttpOkHttpClient	Lcom/squareup/okhttp/OkHttpClient;
    //   35: ldc2_w 280
    ...
    //   44: aload_0
    //   45: getfield 276	bgny:jdField_a_of_type_ComSquareupOkhttpOkHttpClient	Lcom/squareup/okhttp/OkHttpClient;
    //   48: ldc2_w 280
    ...
    //   60: invokestatic 96	badq:b	(Landroid/content/Context;)I
    //   63: istore_3
    //   64: aload_0
    //   65: aload_0
    //   66: getfield 264	bgny:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   69: ldc_w 299
    //   72: invokevirtual 59	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   75: putfield 301	bgny:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   78: aload_0
    //   79: aload_0
    //   80: getfield 264	bgny:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   83: ldc 163
    //   85: invokevirtual 59	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   88: putfield 258	bgny:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   91: aload_0
    //   92: getfield 264	bgny:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   95: ldc_w 303
    //   98: invokevirtual 307	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   101: astore 14
    //   103: aload_0
    //   104: iconst_3
    //   105: putfield 309	bgny:jdField_a_of_type_Int	I
    //   108: new 311	java/io/RandomAccessFile
    //   111: dup
    //   112: aload_0
    //   113: getfield 27	bgny:c	Ljava/lang/String;
    //   116: ldc_w 313
    ...
    //   137: astore 13
    //   139: aload_0
    //   140: getfield 33	bgny:jdField_a_of_type_Long	J
    //   143: lstore 5
    //   145: aload 12
    //   147: astore 13
    //   149: aload_0
    //   150: getfield 33	bgny:jdField_a_of_type_Long	J
    //   153: lload 9
    //   155: lcmp
    //   156: ifge +663 -> 819
    //   159: aload 12
    //   161: astore 13
    //   163: aload_0
    //   164: getfield 23	bgny:jdField_a_of_type_Boolean	Z
    //   167: istore 11
    //   169: iload 11
    //   171: ifeq +22 -> 193
    //   174: aload 12
    ...
    //   197: lload 9
    //   199: aload_0
    //   200: getfield 33	bgny:jdField_a_of_type_Long	J
    //   203: lsub
    //   204: ldc2_w 324
    //   207: lcmp
    //   208: ifle +121 -> 329
    ...
    //   215: aload_0
    //   216: aload_0
    //   217: getfield 33	bgny:jdField_a_of_type_Long	J
    //   220: ldc2_w 326
    //   223: ladd
    //   224: putfield 33	bgny:jdField_a_of_type_Long	J
    //   227: aload 12
    //   229: astore 13
    //   231: aload_0
    //   232: getfield 33	bgny:jdField_a_of_type_Long	J
    //   235: lload 5
    //   237: lsub
    //   238: lstore 7
    //   240: aload 12
    ...
    //   333: aload_0
    //   334: lload 9
    //   336: putfield 33	bgny:jdField_a_of_type_Long	J
    //   339: goto -112 -> 227
    //   342: astore 13
    //   344: aload_0
    //   345: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   348: ifnull +14 -> 362
    //   351: aload_0
    //   352: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   355: bipush 6
    ...
    //   390: ldc 136
    //   392: invokestatic 154	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   395: aload_0
    //   396: lconst_0
    //   397: putfield 33	bgny:jdField_a_of_type_Long	J
    //   400: aload 12
    //   402: ifnull -218 -> 184
    //   405: aload 12
    ...
    //   481: aload_0
    //   482: getfield 258	bgny:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   505: ldc_w 368
    //   508: aload_0
    //   509: getfield 301	bgny:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   539: l2i
    //   540: aload 14
    //   542: invokespecial 382	bgny:a	(ILorg/json/JSONArray;)Ljava/lang/String;
    ...
    //   560: astore 13
    //   562: aload_0
    //   563: getfield 276	bgny:jdField_a_of_type_ComSquareupOkhttpOkHttpClient	Lcom/squareup/okhttp/OkHttpClient;
    //   566: aload 15
    ...
    //   590: astore 13
    //   592: aload_0
    //   593: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   596: ifnull +97 -> 693
    //   599: aload 12
    //   601: astore 13
    //   603: aload_0
    //   604: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   607: iload_2
    //   608: i2l
    //   609: lload 5
    //   611: ladd
    ...
    //   627: astore 13
    //   629: aload_0
    //   630: getfield 33	bgny:jdField_a_of_type_Long	J
    //   633: lload 9
    //   635: lcmp
    //   636: iflt +57 -> 693
    //   639: aload 12
    ...
    //   671: ldc 136
    //   673: invokestatic 154	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   676: aload 12
    //   678: astore 13
    //   680: aload_0
    //   681: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   684: aload_0
    //   685: getfield 258	bgny:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   688: invokeinterface 215 2 0
    //   693: aload 12
    //   695: astore 13
    //   697: aload_0
    //   698: iconst_3
    //   699: putfield 309	bgny:jdField_a_of_type_Int	I
    //   702: aload 12
    //   704: astore 13
    //   706: aload_0
    //   707: getfield 33	bgny:jdField_a_of_type_Long	J
    //   710: lstore 7
    //   712: lload 7
    //   714: lstore 5
    //   716: goto +506 -> 1222
    ...
    //   721: astore 13
    //   723: aload_0
    //   724: getfield 309	bgny:jdField_a_of_type_Int	I
    //   727: iconst_1
    //   728: isub
    //   729: istore_1
    //   730: aload 12
    ...
    //   734: aload_0
    //   735: iload_1
    //   736: putfield 309	bgny:jdField_a_of_type_Int	I
    //   739: iload_1
    //   740: ifgt +98 -> 838
    //   743: aload 12
    //   745: astore 13
    ...
    //   775: ldc 136
    //   777: invokestatic 154	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   780: aload 12
    //   782: astore 13
    //   784: aload_0
    //   785: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   788: ifnull +434 -> 1222
    //   791: aload 12
    //   793: astore 13
    //   795: aload_0
    //   796: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   799: aload 15
    ...
    //   813: aload_0
    //   814: lload 5
    //   816: putfield 33	bgny:jdField_a_of_type_Long	J
    //   819: aload 12
    //   821: ifnull -637 -> 184
    //   824: aload 12
    ...
    //   842: aload_0
    //   843: lload 5
    //   845: putfield 33	bgny:jdField_a_of_type_Long	J
    //   848: goto -703 -> 145
    //   851: astore 13
    //   853: aload 12
    //   855: astore 13
    //   857: aload_0
    //   858: getfield 309	bgny:jdField_a_of_type_Int	I
    //   861: iconst_1
    //   862: isub
    //   863: istore_1
    //   864: aload 12
    ...
    //   868: aload_0
    //   869: iload_1
    //   870: putfield 309	bgny:jdField_a_of_type_Int	I
    //   873: iload_1
    //   874: ifgt +172 -> 1046
    //   877: aload 12
    //   879: astore 13
    ...
    //   909: ldc 136
    //   911: invokestatic 154	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   914: aload 12
    //   916: astore 13
    //   918: aload_0
    //   919: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   922: ifnull +300 -> 1222
    //   925: aload 12
    //   927: astore 13
    //   929: aload_0
    //   930: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   933: bipush 6
    ...
    //   944: aload_0
    //   945: lload 5
    //   947: putfield 33	bgny:jdField_a_of_type_Long	J
    //   950: goto -131 -> 819
    //   953: astore 13
    //   955: aload 12
    //   957: astore 13
    //   959: aload_0
    //   960: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   963: ifnull +18 -> 981
    //   966: aload 12
    //   968: astore 13
    //   970: aload_0
    //   971: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   974: bipush 6
    ...
    //   1013: ldc 136
    //   1015: invokestatic 154	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1018: aload 12
    //   1020: astore 13
    //   1022: aload_0
    //   1023: lconst_0
    //   1024: putfield 33	bgny:jdField_a_of_type_Long	J
    //   1027: aload 12
    //   1029: ifnull -845 -> 184
    //   1032: aload 12
    ...
    //   1050: aload_0
    //   1051: lload 5
    //   1053: putfield 33	bgny:jdField_a_of_type_Long	J
    //   1056: goto -911 -> 145
    //   1059: astore 13
    //   1061: aload 12
    //   1063: astore 13
    //   1065: aload_0
    //   1066: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   1069: ifnull +18 -> 1087
    //   1072: aload 12
    //   1074: astore 13
    //   1076: aload_0
    //   1077: getfield 156	bgny:jdField_a_of_type_Bgnx	Lbgnx;
    //   1080: bipush 6
    ...
    //   1119: ldc 136
    //   1121: invokestatic 154	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1124: aload 12
    //   1126: astore 13
    //   1128: aload_0
    //   1129: lconst_0
    //   1130: putfield 33	bgny:jdField_a_of_type_Long	J
    //   1133: aload 12
    //   1135: ifnull -951 -> 184
    //   1138: aload 12
  ...
  public void a()
  {
    ...
    File localFile = new File(this.c);
    if (((!localFile.exists()) || (localFile.length() == 0L)) && (this.jdField_a_of_type_Bgnx != null))
    {
      this.jdField_a_of_type_Bgnx.b(-1);
      int i = badq.b(BaseApplicationImpl.getContext());
      azld.a("grp_hw", "upload_video", "-13", "", i + "", "");
      return;
    }
  ...
  public void a(bgnx parambgnx)
  {
    this.jdField_a_of_type_Bgnx = parambgnx;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bgnx.a(this.jdField_a_of_type_JavaLangString);
    return;
    f();
    return;
    label167:
