  ...
  extends MSFServlet
{
  ...
  {
    Object localObject = new NewIntent(paramQQAppInterface.getApp(), azwh.class);
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          paramLong = azmz.a(BaseApplication.getContext());
          ...
          if (paramMessageForPtt.istroop == 0)
          {
            ...
            ((HashMap)localObject).put("appversion", "8.3.3");
        ...
        catch (Exception paramQQAppInterface)
        {
          try
          {
            ...
            for (;;)
            {
              paramQQAppInterface = azmz.a(BaseApplication.getContext());
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      notifyObserver(paramIntent, k, bool2, paramFromServiceMsg, azwd.class);
      return;
      break;
    }
  }
