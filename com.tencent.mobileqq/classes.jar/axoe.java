  ...
  implements bllu
{
  ...
  public axoe(MultiCardRootLayout paramMultiCardRootLayout) {}
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        axof localaxof = (axof)MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout).get();
        if (localaxof != null) {
          MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout, localaxof.a(paramMotionEvent));
        }
      }
