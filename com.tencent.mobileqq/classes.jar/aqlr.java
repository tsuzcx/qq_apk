...
public class aqlr
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    ExtensionInfo localExtensionInfo = localanvk.a(paramString, true);
  ...
  {
    aqlj localaqlj = aqlk.a();
    if (QLog.isColorLevel()) {
      QLog.d("C2CShortcutBarSwitcher", 2, new Object[] { "isKuoLieEnable() isKuoLieEnable = ", Boolean.valueOf(localaqlj.b()) });
    }
    return localaqlj.b();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (boolean bool = localSharedPreferences.getBoolean(str, true);; bool = aqlk.a().a())
    {
      if (QLog.isColorLevel()) {
  ...
  {
    paramQQAppInterface = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramString, true);
  ...
  public static boolean b()
  {
    aqlj localaqlj = aqlk.a();
    if (QLog.isColorLevel()) {
      QLog.d("C2CShortcutBarSwitcher", 2, new Object[] { "isShowGlobalEntrance() isShowAssistantEntrance = ", Boolean.valueOf(localaqlj.a()) });
    }
    return localaqlj.a();
  }
