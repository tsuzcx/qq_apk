  ...
  implements agpa
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new agak(this, null);
  bggc jdField_a_of_type_Bggc = new agab(this);
  ...
  VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new agao(this);
  Runnable jdField_a_of_type_JavaLangRunnable = null;
  private float jdField_b_of_type_Float = 1.0F;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new agan(this);
  ...
  public afzw(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  {
    Object localObject2 = new File(agkg.e + paramMessageForPoke.subId + "/pressed.png");
    URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    Object localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847325);
    ...
    paramMessageForPoke = new File(agkg.e + paramMessageForPoke.subId + "/normal.png");
    ...
    paramMessageForPoke.setURLDrawableListener(new agah(this, (StateListDrawable)localObject1));
  ...
  @NotNull
  private CustomFrameAnimationDrawable a(agaj paramagaj, MessageForPoke paramMessageForPoke, String paramString)
  {
    if (paramagaj.jdField_a_of_type_Float == 2.0F)
    {
      paramagaj = new BitmapFactory.Options();
      paramagaj.inSampleSize = 1;
      paramagaj.inMutable = true;
      try
      {
        paramagaj = bfvo.a(PokeBigResHandler.b + "/chuo_caidan/chuo_caidan_" + "01.png", paramagaj);
        paramagaj = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramagaj, agkc.a().a(), paramMessageForPoke.mFrameState, paramString, agkg.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
        a(paramagaj);
        return paramagaj;
      }
      catch (OutOfMemoryError paramagaj)
      {
        for (;;)
        {
          if (QLog.isColorLevel()) {
            QLog.d("GivingHeart", 2, paramagaj.toString());
          }
          paramagaj = null;
        }
      }
    }
    paramagaj = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838528);
    paramagaj = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramagaj, agkc.a().a(), paramMessageForPoke.mFrameState, paramString, agkg.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
    a(paramagaj);
    return paramagaj;
  }
  ...
  @NotNull
  private CustomFrameAnimationDrawable a(agaj paramagaj, MessageForPoke paramMessageForPoke, String paramString1, String paramString2, int paramInt)
  {
    ...
    try
    {
      Bitmap localBitmap = bfvo.a(paramString2 + "01.png", localOptions);
      paramString1 = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localBitmap, agkc.a().a(), paramMessageForPoke.mFrameState, paramString1, agkg.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
      paramString1.i();
      i = 40;
    ...
    try
    {
      paramagaj = bfvo.a(paramString1.a(paramMessageForPoke.mFrameState.jdField_a_of_type_Int).jdField_a_of_type_JavaLangString, localOptions);
      paramString1.a(paramagaj);
      return paramString1;
    }
    catch (OutOfMemoryError paramagaj)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("GivingHeart", 2, paramagaj, new Object[0]);
        }
        paramagaj = null;
      }
    }
    catch (NullPointerException paramagaj)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
  ...
  private void a(long paramLong, MessageForPoke paramMessageForPoke)
  {
    if (this.jdField_a_of_type_AndroidUtilLruCache == null) {
      this.jdField_a_of_type_AndroidUtilLruCache = new afzx(this, jdField_e_of_type_Int);
    }
    this.jdField_a_of_type_AndroidUtilLruCache.put(Long.valueOf(paramLong), paramMessageForPoke);
  }
  
  private void a(agaj paramagaj, SixCombolEffectView paramSixCombolEffectView)
  {
    paramSixCombolEffectView = paramSixCombolEffectView.a();
    if ((paramSixCombolEffectView != null) && (paramagaj.jdField_a_of_type_ComTencentMobileqqDataChatMessage == paramSixCombolEffectView))
    {
  ...
  private void a(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    ...
    if ((paramagaj.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke))) {
      paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    for (;;)
    {
  ...
  private void a(agaj paramagaj, MessageForPoke paramMessageForPoke, RelativeLayout.LayoutParams paramLayoutParams)
  {
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setLayoutParams(paramLayoutParams);
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.removeAllAnimatorListener();
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new agag(this, paramagaj, paramMessageForPoke));
  }
  
  private void a(agaj paramagaj, MessageForPoke paramMessageForPoke, RelativeLayout.LayoutParams paramLayoutParams1, RelativeLayout.LayoutParams paramLayoutParams2, RelativeLayout.LayoutParams paramLayoutParams3)
  {
    ...
    case 0: 
      ...
      paramLayoutParams3.topMargin = ((int)(ScreenUtil.dip2px(80.0F) * paramagaj.jdField_a_of_type_Float - ScreenUtil.dip2px(34.0F)));
      return;
    case 1: 
      ...
      paramLayoutParams3.topMargin = ((int)(ScreenUtil.dip2px(80.0F) * paramagaj.jdField_a_of_type_Float - ScreenUtil.dip2px(35.0F)));
      return;
    case 2: 
      ...
      paramLayoutParams3.topMargin = ((int)(ScreenUtil.dip2px(80.0F) * paramagaj.jdField_a_of_type_Float - ScreenUtil.dip2px(36.0F)));
      return;
    }
    ...
    paramLayoutParams3.topMargin = ((int)(ScreenUtil.dip2px(80.0F) * paramagaj.jdField_a_of_type_Float - ScreenUtil.dip2px(38.0F)));
  }
  
  private void a(agaj paramagaj, MessageForPoke paramMessageForPoke, RelativeLayout.LayoutParams paramLayoutParams1, RelativeLayout.LayoutParams paramLayoutParams2, RelativeLayout.LayoutParams paramLayoutParams3, RelativeLayout.LayoutParams paramLayoutParams4, RelativeLayout.LayoutParams paramLayoutParams5)
  {
    ...
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleType(ImageView.ScaleType.FIT_CENTER);
    paramagaj.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
    ...
    if ((this.jdField_c_of_type_JavaUtilMap != null) && (!this.jdField_c_of_type_JavaUtilMap.isEmpty()) && (this.jdField_c_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramMessageForPoke.subId))))
    {
      ...
      if ((4 == i) || (5 == i))
      {
        paramLayoutParams1 = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838251);
        paramLayoutParams2 = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838252);
        paramLayoutParams1 = bjmh.a(this.jdField_a_of_type_AndroidContentContext.getResources(), paramLayoutParams1, paramLayoutParams2);
        paramagaj.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(paramLayoutParams1);
      }
    }
    else
    {
      ...
      paramagaj.jdField_a_of_type_AndroidWidgetImageView.setScaleX(1.0F);
      paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(1.0F);
      ...
      paramLayoutParams1 = a(paramMessageForPoke, paramagaj.jdField_a_of_type_AndroidWidgetImageView);
      if (agkg.a("bubble", paramMessageForPoke.subId)) {
        break label516;
      }
      i = 1;
      if (agkg.a("/normal.png", paramMessageForPoke.subId)) {
        break label522;
      }
      j = 1;
      label339:
      ...
      d(paramagaj, paramMessageForPoke);
    }
    for (;;)
    {
      paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(paramLayoutParams1);
      return;
      paramLayoutParams1 = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838249);
      paramLayoutParams2 = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838250);
      paramLayoutParams1 = bjmh.a(this.jdField_a_of_type_AndroidContentContext.getResources(), paramLayoutParams1, paramLayoutParams2);
      break;
      label410:
      paramagaj.jdField_a_of_type_AndroidWidgetImageView.setScaleX(-1.0F);
      ...
      paramLayoutParams5.topMargin = ((int)(ScreenUtil.dip2px(80.0F) * paramagaj.jdField_a_of_type_Float - ScreenUtil.dip2px(34.0F)));
      break label298;
      label516:
      i = 0;
      break label324;
      ...
      label528:
      if ((i != 0) || (j != 0)) {
        if ((agkg.c.contains(Integer.valueOf(paramMessageForPoke.subId))) || (agkg.d.contains(Integer.valueOf(paramMessageForPoke.subId)))) {
          paramagaj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        } else {
          paramagaj.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        }
      }
    }
  }
  
  private void a(agaj paramagaj, MessageForPoke paramMessageForPoke, RelativeLayout.LayoutParams paramLayoutParams1, RelativeLayout.LayoutParams paramLayoutParams2, RelativeLayout.LayoutParams paramLayoutParams3, RelativeLayout.LayoutParams paramLayoutParams4, RelativeLayout.LayoutParams paramLayoutParams5, RelativeLayout.LayoutParams paramLayoutParams6, RelativeLayout.LayoutParams paramLayoutParams7)
  {
    paramLayoutParams1.height = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams1.width = a(paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getContext(), paramagaj);
    paramLayoutParams1.topMargin = ScreenUtil.dip2px(0.0F);
    paramLayoutParams1.bottomMargin = ScreenUtil.dip2px(0.0F);
    paramLayoutParams6.height = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams3.width = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams3.height = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams7.width = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams7.height = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams4.width = ScreenUtil.dip2px(80.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams4.height = ScreenUtil.dip2px(70.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams4.topMargin = ScreenUtil.dip2px(10.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams4.bottomMargin = ScreenUtil.dip2px(10.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams2.height = ScreenUtil.dip2px(90.0F * paramagaj.jdField_a_of_type_Float);
    paramLayoutParams4.leftMargin = 0;
    paramLayoutParams4.rightMargin = 0;
    paramagaj.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramagaj.jdField_a_of_type_AndroidWidgetImageView.setScaleX(1.0F);
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(1.0F);
    paramLayoutParams1 = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838249);
    paramLayoutParams2 = bfvo.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838250);
    ...
    if (paramMessageForPoke.isSendFromLocal())
    {
      ...
      paramLayoutParams3.leftMargin = 0;
      paramLayoutParams1 = agkg.a(paramMessageForPoke.interactType, paramMessageForPoke.isSend(), this.jdField_a_of_type_AndroidContentContext.getResources());
      paramagaj.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramLayoutParams1);
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a(paramMessageForPoke, paramagaj.jdField_a_of_type_Float);
      return;
    }
    if ((paramagaj.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke)))
    {
      ...
      if (!paramMessageForPoke.hasQuickBackShowed)
      {
        ...
        bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "0X8008912", "0X8008912", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      paramLayoutParams3.leftMargin = ScreenUtil.dip2px(10.0F * paramagaj.jdField_a_of_type_Float);
      paramLayoutParams3.rightMargin = 0;
      paramLayoutParams5.rightMargin = 0;
      a(paramagaj, paramMessageForPoke, paramLayoutParams3, paramLayoutParams4, paramLayoutParams5);
      break;
      paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    }
  }
  ...
  private void a(agaj paramagaj, MessageForPoke paramMessageForPoke, CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    ...
    paramCustomFrameAnimationDrawable.a(new agaf(this, paramagaj, paramMessageForPoke));
  ...
  private void a(BaseChatItemLayout paramBaseChatItemLayout, aezf paramaezf, MessageForPoke paramMessageForPoke)
  {
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)paramaezf.a.getLayoutParams();
    ...
    for (;;)
    {
      paramaezf.a.setLayoutParams(localLayoutParams);
      return;
  ...
  private void a(ChatMessage paramChatMessage, agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
    if ((paramMessageForPoke.isPlayed) && (!paramMessageForPoke.mFrameState.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a.containsKey(Long.valueOf(paramMessageForPoke.uniseq)))) {
      b(paramagaj, paramMessageForPoke);
    }
    Object localObject;
    label187:
    label196:
    do
    {
      ...
      agai localagai = a(paramMessageForPoke);
      String str = localagai.jdField_a_of_type_JavaLangString;
      int i = localagai.jdField_a_of_type_Int;
      if ((paramMessageForPoke.interactType == 1) || (paramMessageForPoke.interactType <= 0) || (paramMessageForPoke.interactType > 6))
      {
        localObject = a(paramagaj, paramMessageForPoke, (String)localObject);
      ...
      for (;;)
      {
        ...
        a(paramagaj, paramMessageForPoke, (CustomFrameAnimationDrawable)localObject);
        return;
        localObject = a(paramagaj, paramMessageForPoke, (String)localObject, str, i);
        break;
        ((CustomFrameAnimationDrawable)localObject).a(2);
      }
      if (paramMessageForPoke.mFrameState.c)
      {
        a(paramagaj, paramMessageForPoke);
        return;
      }
    } while (AIOUtils.isForbidPokeMessageAnimationPlay);
    a(paramChatMessage, paramagaj, paramMessageForPoke, (CustomFrameAnimationDrawable)localObject);
  }
  
  private void a(ChatMessage paramChatMessage, agaj paramagaj, MessageForPoke paramMessageForPoke, CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    boolean bool1 = true;
    ...
    paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
    paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
    paramCustomFrameAnimationDrawable.a(new agae(this, paramagaj, paramMessageForPoke));
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(paramCustomFrameAnimationDrawable);
  ...
  private boolean a(Context paramContext, agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    boolean bool = false;
    if ((!PokeBigResHandler.jdField_a_of_type_Boolean) || ((paramContext instanceof ChatHistoryActivity)))
    {
      ...
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      paramContext = (PokeBigResHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(117);
  ...
  private String b(ChatMessage paramChatMessage)
  {
    ...
    for (paramChatMessage = amtj.a(2131704401);; paramChatMessage = paramChatMessage.msg.substring(1, paramChatMessage.msg.length() - 1)) {
      try
      {
  ...
  private void b(agaj paramagaj)
  {
    if (SixCombolEffectView.jdField_a_of_type_Int > 0)
    {
      a(paramagaj, ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131362294)).a());
      return;
    }
    a(paramagaj);
  }
  
  private void b(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    if (QLog.isColorLevel()) {
    ...
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
    paramagaj.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
    if ((paramagaj.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (paramMessageForPoke.interactType != 126) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke))) {
      paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    for (;;)
    {
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new agac(this));
    paramContext = new RelativeLayout.LayoutParams(1, 1);
    ViewGroup localViewGroup = (ViewGroup)((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131362294);
    ...
    this.jdField_b_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new agad(this);
    e();
    if (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bggc);
    }
  }
  
  private boolean b(Context paramContext, agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    boolean bool = false;
    int i = 0;
    if (126 == paramMessageForPoke.interactType)
    {
      ...
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((!paramMessageForPoke.isSend()) && (paramagaj.jdField_b_of_type_Int == f) && (paramMessageForPoke.isPlayed) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke))) {
        paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if ((!paramMessageForPoke.isPlayed) && (!paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.isAnimating())) {
        if (ambc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).d != 1) {
          break label194;
        }
      }
    }
    for (;;)
    {
      if (i != 0)
      {
        amat.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "vas_poke", true);
        if (QLog.isColorLevel()) {
          QLog.i("GivingHeart.sprite", 2, "hide sprite (normal) in play.");
        }
      }
      agkg.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramContext, paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView, paramagaj, paramMessageForPoke.subId, "bubble");
      bool = true;
      return bool;
      label194:
      i = 1;
  ...
  private String c(ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(paramChatMessage.msg)) {}
    for (paramChatMessage = amtj.a(2131704400);; paramChatMessage = paramChatMessage.msg.substring(1, paramChatMessage.msg.length() - 1)) {
      try
      {
        Integer.parseInt(paramChatMessage);
  ...
  private void c(agaj paramagaj)
  {
    SixCombolEffectView localSixCombolEffectView = ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131362294)).a();
    if (SixCombolEffectView.jdField_a_of_type_Int == 0)
    {
      if (!AIOUtils.isForbidPokeMessageAnimationPlay)
      {
        ...
        AIOUtils.pokeAnimatingCount += 1;
        localSixCombolEffectView.a(paramagaj, agkg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
      return;
    }
    a(paramagaj, localSixCombolEffectView);
  }
  
  private void c(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    RelativeLayout.LayoutParams localLayoutParams1 = (RelativeLayout.LayoutParams)paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams2 = (RelativeLayout.LayoutParams)((ViewGroup)paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getParent()).getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams3 = (RelativeLayout.LayoutParams)paramagaj.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams4 = (RelativeLayout.LayoutParams)paramagaj.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams5 = (RelativeLayout.LayoutParams)paramagaj.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams6 = (RelativeLayout.LayoutParams)paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams7 = (RelativeLayout.LayoutParams)paramagaj.jdField_c_of_type_AndroidViewView.getLayoutParams();
    paramagaj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    paramagaj.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramagaj.jdField_c_of_type_AndroidViewView.setVisibility(8);
    this.jdField_b_of_type_Float = a(paramMessageForPoke);
    paramagaj.jdField_a_of_type_Float = this.jdField_b_of_type_Float;
    f();
    if (126 == paramMessageForPoke.interactType) {
      a(paramagaj, paramMessageForPoke, localLayoutParams1, localLayoutParams2, localLayoutParams3, localLayoutParams4, localLayoutParams5);
    }
    for (;;)
    {
      paramagaj.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(localLayoutParams3);
      a(paramagaj, paramMessageForPoke, localLayoutParams1);
      return;
      a(paramagaj, paramMessageForPoke, localLayoutParams1, localLayoutParams2, localLayoutParams3, localLayoutParams4, localLayoutParams5, localLayoutParams6, localLayoutParams7);
    }
  }
  
  private void d(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    if (agkg.a.contains(Integer.valueOf(paramMessageForPoke.subId)))
    {
      if ((agkg.c.contains(Integer.valueOf(paramMessageForPoke.subId))) || (agkg.d.contains(Integer.valueOf(paramMessageForPoke.subId))))
      {
        paramagaj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
    ...
    agkg.a.add(Integer.valueOf(paramMessageForPoke.subId));
    agkg.c.add(Integer.valueOf(paramMessageForPoke.subId));
    agkg.d.add(Integer.valueOf(paramMessageForPoke.subId));
    paramagaj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
    paramagaj = (VasQuickUpdateManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(184);
    paramagaj.downloadItem(21L, "poke.item.effect." + paramMessageForPoke.subId, "getbubbleview");
    paramagaj.downloadItem(21L, "poke.item.res." + paramMessageForPoke.subId, "getbubbleview");
    paramagaj.addCallBacker(this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker);
  }
  ...
  private void e(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    if ((paramMessageForPoke.isPlayed) && (!paramMessageForPoke.mUnlimitedState.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a.containsKey(Long.valueOf(paramMessageForPoke.uniseq)))) {
      i(paramagaj, paramMessageForPoke);
    }
    label110:
    do
    {
      ...
      {
        localUnlimitedBladeWorks.a(localContext, bool, agkg.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface), paramagaj.jdField_a_of_type_Float);
        if (!paramMessageForPoke.mUnlimitedState.jdField_a_of_type_Boolean) {
          break;
        }
        h(paramagaj, paramMessageForPoke);
        return;
      }
      if (paramMessageForPoke.mUnlimitedState.b)
      {
        g(paramagaj, paramMessageForPoke);
        return;
      }
    } while (AIOUtils.isForbidPokeMessageAnimationPlay);
    f(paramagaj, paramMessageForPoke);
  }
  ...
  private void f()
  {
    List localList;
    int i;
    if ((this.jdField_a_of_type_AndroidWidgetBaseAdapter != null) && ((this.jdField_a_of_type_AndroidWidgetBaseAdapter instanceof aezn)))
    {
      localList = ((aezn)this.jdField_a_of_type_AndroidWidgetBaseAdapter).a();
      if (localList != null) {
        i = localList.size() - 1;
      }
    }
  ...
  private void f(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    AIOUtils.pokeAnimatingCount += 1;
    ...
    paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramagaj.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
    paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new afzz(this, paramagaj, paramMessageForPoke));
    if (QLog.isColorLevel()) {
  ...
  private void g(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
  ...
  private void h(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    boolean bool2 = true;
    paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(0);
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
    ...
    paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramagaj.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
    UnlimitedBladeWorks localUnlimitedBladeWorks = paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
    if (!paramMessageForPoke.isSend())
    {
      bool1 = true;
      localUnlimitedBladeWorks.setMirror(bool1);
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new agaa(this, paramagaj, paramMessageForPoke));
      localUnlimitedBladeWorks = paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
      if (paramMessageForPoke.isSend()) {
        break label147;
      }
    ...
    {
      localUnlimitedBladeWorks.a(paramMessageForPoke, bool1, paramagaj.jdField_a_of_type_Float);
      if (QLog.isColorLevel()) {
  ...
  private void i(agaj paramagaj, MessageForPoke paramMessageForPoke)
  {
    boolean bool = false;
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
    paramagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
    ...
    {
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
      if (paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a())
      {
        UnlimitedBladeWorks localUnlimitedBladeWorks = paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
        if (!paramMessageForPoke.isSend()) {
          bool = true;
  ...
  int a(Context paramContext, agaj paramagaj)
  {
    int i = ((MessageForPoke)paramagaj.jdField_a_of_type_ComTencentMobileqqDataChatMessage).interactType;
    paramContext = paramContext.getResources();
    switch (i)
    {
    default: 
      return AIOUtils.dp2px(paramagaj.jdField_a_of_type_Float * 100.0F, paramContext);
    case 0: 
    case 1: 
      if (paramagaj.jdField_a_of_type_Float == 2.0F) {
        return AIOUtils.dp2px(150.0F * paramagaj.jdField_a_of_type_Float, paramContext);
      }
      return AIOUtils.dp2px(paramagaj.jdField_a_of_type_Float * 100.0F, paramContext);
    case 2: 
      return AIOUtils.dp2px(280.0F * paramagaj.jdField_a_of_type_Float, paramContext);
    case 3: 
      return AIOUtils.dp2px(90.0F * paramagaj.jdField_a_of_type_Float, paramContext);
    case 4: 
      return AIOUtils.dp2px(paramagaj.jdField_a_of_type_Float * 100.0F, paramContext);
    case 6: 
      return 0;
    }
    return AIOUtils.dp2px(230.0F * paramagaj.jdField_a_of_type_Float, paramContext);
  }
  ...
  agai a(MessageForPoke paramMessageForPoke)
  {
    int i = 0;
    switch (paramMessageForPoke.interactType)
    {
    default: 
      paramMessageForPoke = agkc.jdField_a_of_type_JavaLangString + "/chuo_icon/chuo_icon_";
    }
    for (;;)
    {
      return new agai(paramMessageForPoke, i);
      ...
      paramMessageForPoke = agkc.jdField_a_of_type_JavaLangString + "/dazhao_icon/dazhao_icon_";
    }
  }
  ...
  public View a(ChatMessage paramChatMessage, aezf paramaezf, View paramView, BaseChatItemLayout paramBaseChatItemLayout, afce paramafce)
  {
    ...
    if (paramView == null)
    {
      ...
      localagaj.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)localObject4);
      ...
      ((ImageView)localObject3).setId(2131374617);
      paramView = bfvo.a(((Context)localObject1).getResources(), 2130838249);
      Object localObject2 = bfvo.a(((Context)localObject1).getResources(), 2130838250);
      ((ImageView)localObject3).setImageDrawable(bjmh.a(((Context)localObject1).getResources(), paramView, (Bitmap)localObject2));
      localagaj.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localObject3);
      paramaezf.addView((View)localObject3);
      UnlimitedBladeWorks localUnlimitedBladeWorks = new UnlimitedBladeWorks((Context)localObject1);
      localagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks = localUnlimitedBladeWorks;
      paramaezf.addView(localUnlimitedBladeWorks);
      RelativeLayout localRelativeLayout = new RelativeLayout((Context)localObject1);
      localRelativeLayout.setId(2131372832);
      ImageView localImageView = new ImageView((Context)localObject1);
      localagaj.jdField_a_of_type_AndroidWidgetImageView = localImageView;
      ...
      ((ProgressBar)localObject2).setIndeterminateDrawable(((Context)localObject1).getResources().getDrawable(2130839449));
      localagaj.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)localObject2);
      localRelativeLayout.addView((View)localObject2);
      paramView = new ImageView((Context)localObject1);
      paramView.setId(2131378172);
      paramView.setImageResource(2130847326);
      localagaj.jdField_b_of_type_AndroidWidgetImageView = paramView;
      localRelativeLayout.addView(paramView);
      localagaj.jdField_a_of_type_AndroidWidgetRelativeLayout = localRelativeLayout;
      paramaezf.addView(localRelativeLayout);
      View localView = new View((Context)localObject1);
      paramaezf.addView(localView);
      localagaj.jdField_c_of_type_AndroidViewView = localView;
    ...
    paramaezf.setTag(localagaj);
    c(localagaj, paramBaseChatItemLayout);
    localagaj.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    ...
    localagaj.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(c(paramChatMessage));
    if (jdField_e_of_type_Boolean)
    {
      if ((localagaj.jdField_b_of_type_JavaLangStringBuilder != null) && (localagaj.jdField_b_of_type_JavaLangStringBuilder.length() > 0)) {
        localagaj.jdField_b_of_type_JavaLangStringBuilder.setLength(0);
      }
      paramaezf.setContentDescription(b(paramChatMessage));
    }
    return paramaezf;
  }
  ...
  public void a()
  {
    ...
    if (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bggc);
    }
  ...
  public void a(agaj paramagaj)
  {
    if (paramagaj != null)
    {
      paramagaj.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramagaj.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((paramagaj.jdField_b_of_type_Int != f) || (paramagaj.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || ((this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) || (b(paramagaj.jdField_a_of_type_ComTencentMobileqqDataChatMessage))) {
        break label106;
      }
      paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    ...
    {
      paramagaj.jdField_c_of_type_AndroidViewView.setVisibility(8);
      if (!((MessageForPoke)paramagaj.jdField_a_of_type_ComTencentMobileqqDataChatMessage).isPlayed) {
        ((MessageForPoke)paramagaj.jdField_a_of_type_ComTencentMobileqqDataChatMessage).setPlayed(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      return;
      label106:
      paramagaj.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, aezf paramaezf, int paramInt1, int paramInt2)
  {
    ...
    if (b(paramContext, localagaj, localMessageForPoke)) {
      return;
    }
    ...
    for (;;)
    {
      a(paramBaseChatItemLayout, paramaezf, localMessageForPoke);
      if (a(paramContext, localagaj, localMessageForPoke)) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.d("PokeMsg", 2, "Strength holder = " + localagaj.jdField_a_of_type_Float);
      }
      if (a(localagaj, localMessageForPoke)) {
        break;
      }
      if (localMessageForPoke.interactType != 6) {
        break label269;
      }
      e(localagaj, localMessageForPoke);
      return;
      jdField_b_of_type_JavaUtilMap.put(Long.valueOf(localMessageForPoke.uniseq), localMessageForPoke);
    }
    label269:
    a(paramChatMessage, localagaj, localMessageForPoke);
  }
