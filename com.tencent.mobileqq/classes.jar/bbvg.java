...
public class bbvg
  extends bbvs
{
  private bbvg(SignatureHistoryFragment paramSignatureHistoryFragment) {}
  ...
  protected void a(boolean paramBoolean, List<byte[]> paramList, List<Integer> paramList1)
  {
    ...
    SignatureHistoryFragment.a(this.a).setText(2131718897);
    SignatureHistoryFragment.b(this.a, false);
