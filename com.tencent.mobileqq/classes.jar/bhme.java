...
public class bhme
  extends bhmb
  implements SeekBar.OnSeekBarChangeListener, bhlo, IVideoOuterStatusListener
{
  ...
  public bhme(Context paramContext)
  {
    super(paramContext);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_e_of_type_AndroidWidgetImageView != null)
        {
          ...
          if (paramBoolean)
          {
            ...
            this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130838073);
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(localResources.getColor(2131166961));
          return;
          ((ViewGroup.LayoutParams)localObject).width = -1;
          ((ViewGroup.LayoutParams)localObject).height = -1;
          this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130846148);
          break label64;
          m = 40;
          k = 16;
          if (localResources == null) {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130846149);
        return;
      }
    } while (localResources == null);
    label235:
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(localResources.getColor(2131167276));
    label265:
    label275:
    label277:
    return;
  ...
  private void b()
  {
    ...
    do
    {
      ...
      {
        if ((this.jdField_a_of_type_Bhlz == null) || (!this.jdField_a_of_type_Bhlz.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())))
        {
  ...
  private void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166961));
    }
    if (this.jdField_f_of_type_AndroidWidgetImageView != null)
    {
      if (!a(paramInt)) {
      ...
      this.jdField_f_of_type_AndroidWidgetImageView.setImageResource(2130846147);
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidWidgetTextView != null)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131698774);
      }
      return;
      label138:
    ...
    if (paramInt == 401)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131698775);
      return;
    }
    if (paramInt == 402)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131698777);
      return;
    }
    if (paramInt == 403)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131698776);
      return;
    }
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131698775);
  }
  ...
  private void c(boolean paramBoolean)
  {
    if (Build.VERSION.SDK_INT >= 21) {
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer != null)
      {
        ...
        if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_AndroidContentContext.getResources() != null))
        {
          ...
          arog.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846143));
        }
      }
    }
    for (;;)
    {
      ...
      return;
      label97:
      arog.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846142));
    }
  }
  ...
  private void d(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addUpdateListener(new bhmg(this, f2, f1));
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addListener(new bhmh(this, paramInt));
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Bhly != null) {
      this.jdField_a_of_type_Bhly.a();
    }
  ...
  private void h()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(amtj.a(2131703755));
          return;
        }
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(amtj.a(2131703756));
        return;
      }
      if (this.jdField_f_of_type_Int == 0)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(amtj.a(2131703759));
        return;
      }
    } while (this.jdField_f_of_type_Int != 1);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(amtj.a(2131703753));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetFrameLayout.setId(2131374272);
    this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_b_of_type_AndroidWidgetImageView.setId(2131374258);
    this.jdField_b_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374262));
    this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(amtj.a(2131703761));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374261));
    this.jdField_d_of_type_AndroidWidgetImageView.setContentDescription(amtj.a(2131703757));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374268));
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(amtj.a(2131703758));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374267));
    this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(amtj.a(2131703754));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374265));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374263));
    this.jdField_e_of_type_AndroidWidgetImageView.setContentDescription(amtj.a(2131703760));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374269));
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374264));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374271));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374270));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374274));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar.setThumb(paramContext.getResources().getDrawable(2130849678));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgressDrawable(paramContext.getResources().getDrawable(2130845939));
  ...
  public void a(bhly parambhly)
  {
    this.jdField_a_of_type_Bhly = parambhly;
  }
  
  public void a(bhlz parambhlz)
  {
    super.a(parambhlz);
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(0, new bhmf(this));
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      else if (k == 2131374262)
      {
        f();
        bhlw.f();
      }
      else if (k == 2131374268)
      {
        j();
        bhlw.h();
      }
      else if (k == 2131374267)
      {
        k();
        bhlw.h();
      }
      else if (k == 2131374263)
      {
        j();
      }
      else if (k == 2131374266)
      {
        b();
      }
    }
  ...
  public void onVideoStart(int paramInt)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_AndroidContentContext.getResources() != null)) {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167276));
        }
      }
