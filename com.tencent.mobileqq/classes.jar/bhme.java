...
public class bhme
{
  ...
  public bhme(WebViewFragment paramWebViewFragment)
  {
  ...
  private void b(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getActivity() != null)) {
      bglp.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getActivity(), 230).setMessage(paramString).setPositiveButton(2131693414, new bhmf(this)).show();
    }
  }
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          if (this.jdField_a_of_type_Int == 0)
          {
            ...
            if (this.jdField_a_of_type_Int == 0)
            {
              ...
              lax.a(localJSONObject, "startListenAioShareMusic", null);
            }
          }
          else
          {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          lax.a(localJSONObject, "checkAioShareMusic", null);
          return;
        }
      }
      catch (JSONException paramIntent)
  ...
  public void b(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      str3 = "";
      label75:
      bcst.b(null, "dc00899", str1, "", "music_tab", str2, 0, 0, str3, "", "", "");
    ...
    label176:
    label183:
    for (paramIntent = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131697764);; paramIntent = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131697740))
    {
      a(String.format(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693280), new Object[] { paramIntent }));
      return;
      str1 = "Grp_AIO";
      break;
      str2 = "clk_share_grp";
    ...
    {
      a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693278));
      return;
    }
    if (this.jdField_a_of_type_Int == 1)
    {
      ...
      {
        b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693276));
        return;
      }
      if ((this.jdField_c_of_type_Int == 3) && (!bool) && (this.jdField_c_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
      {
        b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693277));
        return;
      }
      if ((this.jdField_c_of_type_Int != 3) && (!bool) && (!this.jdField_d_of_type_Boolean))
      {
        b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693275));
        return;
      }
      if ((this.jdField_c_of_type_Int != 3) && (!a()) && (!bool) && (this.jdField_d_of_type_Boolean))
      {
        ...
        {
          a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693279));
          return;
        }
  ...
  public void b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131694157));
      continue;
      a(String.format(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693280), new Object[] { str }));
      continue;
      a(str);
      continue;
      b(str);
