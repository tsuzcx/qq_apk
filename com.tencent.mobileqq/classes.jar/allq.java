  ...
  implements amlr
{
  ...
  public allq(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Allr = new allr(this);
  }
  ...
  public static amlu a(UpgradeInfo paramUpgradeInfo)
  {
  ...
  private void a(awbw paramawbw, GetResourceRespInfo paramGetResourceRespInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      return;
      localAppShareID = bdaw.a(paramGetResourceRespInfo);
    } while (localAppShareID == null);
    if (QLog.isColorLevel()) {
      QLog.d("share_appid", 2, "parser share appid from resp info, result:  " + localAppShareID);
    }
    paramGetResourceRespInfo = (AppShareID)paramawbw.a(AppShareID.class, "strPkgName=?", new String[] { paramGetResourceRespInfo.strPkgName });
    if (paramGetResourceRespInfo == null)
    {
      paramawbw.a(localAppShareID);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        paramawbw.b(paramGetResourceRespInfo);
        paramawbw.a(localAppShareID);
        if (QLog.isColorLevel()) {
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          bdcs.d(new File(this.app.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          bdcs.d(aeqc.b);
          bool1 = false;
          aeqc.a().a(this.app.getApplication());
  ...
  private void b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    do
    {
        ...
        for (;;)
        {
          ...
          if (localUpgradeInfo != null)
          {
            ...
            if ((localUpgradeInfo.iUpgradeType > 0) && (localUpgradeInfo.bNewSwitch == 1))
            {
              ...
              localObject = "1";
              azmj.b(localQQAppInterface, "CliOper", "", "", "0X8004DA5", "0X8004DA5", 0, 0, (String)localObject, "", amlp.a(), "");
            ...
            for (;;)
            {
              ...
              ((Intent)localObject).putExtra("StrTitle", alpo.a(2131702798));
              ((Intent)localObject).putExtra("StrUpgradeDesc", alpo.a(2131702801));
      ...
      if (paramUpgradeDetailWrapper.jdField_a_of_type_ComTencentMobileqqAppNewUpgradeConfig.dialog.jdField_a_of_type_Boolean)
      {
        ...
        bfko.a().a(BaseActivity.sTopActivity, "biz_src_yyb");
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   183: aload_0
    //   184: aload 12
    //   186: invokespecial 731	allq:a	(Landroid/content/Intent;)V
    //   189: aload_0
    //   190: bipush 11
    //   192: iload 8
    //   194: iload 6
    //   196: invokestatic 382	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: invokevirtual 273	allq:notifyUI	(IZLjava/lang/Object;)V
    //   202: return
    //   203: iconst_0
    //   204: istore 8
    //   206: goto -180 -> 26
    ...
    //   433: invokestatic 901	bhmb:a	(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Z
    //   436: istore 6
    ...
    //   721: invokestatic 942	bhmb:a	(Landroid/content/Context;)Z
    //   724: pop
    //   725: iload 5
    //   727: istore 6
    //   729: goto -684 -> 45
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localakcf = (akcf)this.app.getManager(114);
    ...
    this.app.a(new ConfigHandler.3(this, paramGetResourceRespInfo, localakcf, l1));
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        amlp.a().a(bool1, str2, paramToServiceMsg);
        return;
        i = 0;
        break;
  ...
  {
    aqxh.jdField_a_of_type_Boolean = true;
      ...
      while (QLog.isColorLevel())
      {
        ...
        if (i == 10)
        {
          ...
          for (paramObject = paramObject.string_tips_action_url.get();; paramObject = "")
          {
            ...
            paramObject = (aqbb)this.app.getManager(292);
            paramObject.a(bool1);
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      localaxzt = (axzt)this.app.getManager(15);
    } while (localaxzt == null);
    if (!localaxzt.a(paramGetResourceRespInfo.uiNewVer))
    {
      notifyUI(7, true, Integer.valueOf(100));
      return;
    }
    ...
    this.app.a(new ConfigHandler.6(this, str, localaxzt, paramGetResourceRespInfo));
  }
  ...
  public int a(ArrayList<GetResourceReqInfo> paramArrayList, GetResourceReqInfo... paramVarArgs)
  {
    ...
    i = ayts.jdField_a_of_type_Int;
    ayts.jdField_a_of_type_Int = i + 1;
  ...
  public void a(int paramInt, UpgradeDetailWrapper paramUpgradeDetailWrapper, amlp paramamlp)
  {
    paramamlp = paramUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo;
    if ((paramInt == 0) && (paramamlp != null))
    {
      BaseApplicationImpl.sApplication.getPackageName();
      a(paramamlp);
      a(this.app, paramamlp.strNewTipsDescURL, paramamlp.iTipsWaitDay);
      b(this.app, paramamlp.strBannerPicUrl, paramamlp.iDisplayDay);
  ...
  public void a(String paramString, int paramInt, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    Object localObject2 = aouu.a(this.app);
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      QQOperationViopTipTask localQQOperationViopTipTask = ((aouu)localObject2).a(((QQOperationViopTipTask)paramArrayList.next()).taskid);
      ...
      ((aouu)localObject2).a(this.app, localQQOperationVoipTipsTaskExcuteRecord);
    }
    notifyUI(8, true, localObject1);
  }
  
  public void a(String paramString, int paramInt, ArrayList<aoux> paramArrayList, boolean paramBoolean)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
      ...
      try
      {
        ...
        if (paramInt == 3000)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            if (paramArrayList.hasNext())
            {
              aoux localaoux = (aoux)paramArrayList.next();
              MobileTips.TaskInfo localTaskInfo = new MobileTips.TaskInfo();
              localTaskInfo.task_id.set(localaoux.jdField_a_of_type_Int);
              localTaskInfo.msgcnt.set(localaoux.b);
              localTaskInfo.keywords.set(localaoux.jdField_a_of_type_JavaUtilArrayList);
  ...
  public boolean a()
  {
    boolean bool = bhmb.b(BaseApplicationImpl.sApplication);
    if (QLog.isDevelopLevel()) {
    ...
    try
    {
      localObject2 = bhlw.a(new File(BaseApplicationImpl.sApplication.getPackageResourcePath()));
    ...
    ((ToServiceMsg)localObject2).extraData.putInt("mv", aowf.a(this.app.getApp()));
    ((ToServiceMsg)localObject2).extraData.putInt("sv", bdcb.a());
  ...
  public boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    localToServiceMsg.extraData.putInt("mv", aowf.a(this.app.getApp()));
    localToServiceMsg.extraData.putInt("sv", bdcb.a());
  ...
  {
    Object localObject = (axzt)this.app.getManager(15);
    if (localObject == null) {
      return null;
    }
    long l = ((axzt)localObject).a();
  ...
  public void d()
  {
    ...
    try
    {
      ...
      ((ByteBuffer)localObject).putInt(bdal.a(Long.parseLong(this.app.getAccount()))).putShort((short)16);
  ...
  {
    allj localallj = (allj)this.app.getManager(59);
    if (localallj == null) {
      return null;
    }
    GetResourceReqInfo localGetResourceReqInfo = new GetResourceReqInfo();
    ...
    localGetResourceReqInfo.uiCurVer = localallj.a(true);
    localGetResourceReqInfo.sResType = 2;
    localGetResourceReqInfo.sLanType = 0;
    localGetResourceReqInfo.sReqType = 1;
    return localGetResourceReqInfo;
  ...
  public void e()
  {
    ...
    do
    {
      ...
      {
        return;
        if (apwu.a().a(this.app, BaseApplicationImpl.getApplication()) != 0) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    else
    {
      ...
      if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
        ((allj)this.app.getManager(59)).a(null);
      }
    }
    label119:
    do
    ...
    for (;;)
    {
      ...
      else if (paramFromServiceMsg.sResType == 2)
      {
        ...
        {
          paramObject = (allj)this.app.getManager(59);
          if (paramObject != null) {
      ...
      {
        paramObject = (apgj)this.app.getManager(77);
        if (paramObject != null) {
          paramObject.a(paramFromServiceMsg);
        }
      }
