...
public class allq
{
  ...
  {
    allq localallq = a();
    BackgroundProbeManager.1 local1 = new BackgroundProbeManager.1(localallq);
    BackgroundProbeManager.2 local2 = new BackgroundProbeManager.2(localallq);
    boolean bool = localallq.a();
    if (QLog.isColorLevel()) {
      QLog.i("BackgroundProbeManager", 2, "onRunningBackground: invoked.  probeEnabled: " + bool);
    }
    if (bool) {
      ayjf.a(local1, 180000L);
    }
    ayjf.a(local2, 181000L);
  }
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((c) && (b()) && (!jdField_b_of_type_Boolean) && (i != 0) && (paramIntent.getComponent() == null))
      {
        ...
        awpu.a(localBackgroundException, "intent: " + paramIntent.toString());
  ...
  private void b()
  {
    ...
    {
      awpu.a(new BackgroundException("startProbeService failed"));
    }
  }
