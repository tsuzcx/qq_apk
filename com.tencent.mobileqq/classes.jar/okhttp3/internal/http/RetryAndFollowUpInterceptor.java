  ...
  implements Interceptor
{
  ...
  public Response intercept(okhttp3.Interceptor.Chain paramChain)
  {
    ...
    //   39: aload_0
    //   40: aload 4
    //   42: invokevirtual 163	okhttp3/Request:url	()Lokhttp3/HttpUrl;
    ...
    //   60: aload_0
    //   61: aload_1
    //   62: putfield 292	okhttp3/internal/http/RetryAndFollowUpInterceptor:streamAllocation	Lokhttp3/internal/connection/StreamAllocation;
    //   65: iconst_0
    //   66: istore_2
    //   67: aconst_null
    //   68: astore 5
    //   70: aload_0
    //   71: getfield 290	okhttp3/internal/http/RetryAndFollowUpInterceptor:canceled	Z
    //   74: ifeq +18 -> 92
    //   77: aload_1
    //   78: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   81: new 244	java/io/IOException
    //   84: dup
    //   85: ldc_w 327
    //   88: invokespecial 328	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   91: athrow
    //   92: aload 7
    //   94: aload 4
    //   96: aload_1
    //   97: aconst_null
    //   98: aconst_null
    //   99: invokevirtual 332	okhttp3/internal/http/RealInterceptorChain:proceed	(Lokhttp3/Request;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpCodec;Lokhttp3/internal/connection/RealConnection;)Lokhttp3/Response;
    //   102: astore 6
    //   104: aload 6
    //   106: astore 4
    //   108: aload 5
    //   110: ifnull +28 -> 138
    //   113: aload 6
    //   115: invokevirtual 335	okhttp3/Response:newBuilder	()Lokhttp3/Response$Builder;
    //   118: aload 5
    //   120: invokevirtual 335	okhttp3/Response:newBuilder	()Lokhttp3/Response$Builder;
    //   123: aconst_null
    //   124: invokevirtual 340	okhttp3/Response$Builder:body	(Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;
    //   127: invokevirtual 342	okhttp3/Response$Builder:build	()Lokhttp3/Response;
    //   130: invokevirtual 345	okhttp3/Response$Builder:priorResponse	(Lokhttp3/Response;)Lokhttp3/Response$Builder;
    //   133: invokevirtual 342	okhttp3/Response$Builder:build	()Lokhttp3/Response;
    //   136: astore 4
    //   138: aload_0
    //   139: aload 4
    //   141: aload_1
    //   142: invokevirtual 349	okhttp3/internal/connection/StreamAllocation:route	()Lokhttp3/Route;
    //   145: invokespecial 351	okhttp3/internal/http/RetryAndFollowUpInterceptor:followUpRequest	(Lokhttp3/Response;Lokhttp3/Route;)Lokhttp3/Request;
    //   148: astore 6
    //   150: aload 6
    //   152: ifnonnull +90 -> 242
    //   155: aload_1
    //   156: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   159: aload 4
    //   161: areturn
    //   162: astore 6
    //   164: aload_0
    //   165: aload 6
    //   167: invokevirtual 355	okhttp3/internal/connection/RouteException:getLastConnectException	()Ljava/io/IOException;
    //   170: aload_1
    //   171: iconst_0
    //   172: aload 4
    //   174: invokespecial 357	okhttp3/internal/http/RetryAndFollowUpInterceptor:recover	(Ljava/io/IOException;Lokhttp3/internal/connection/StreamAllocation;ZLokhttp3/Request;)Z
    //   177: ifne -107 -> 70
    //   180: aload 6
    //   182: invokevirtual 360	okhttp3/internal/connection/RouteException:getFirstConnectException	()Ljava/io/IOException;
    //   185: athrow
    //   186: astore 4
    //   188: aload_1
    //   189: aconst_null
    //   190: invokevirtual 260	okhttp3/internal/connection/StreamAllocation:streamFailed	(Ljava/io/IOException;)V
    //   193: aload_1
    //   194: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   197: aload 4
    //   199: athrow
    //   200: astore 6
    //   202: aload 6
    ...
    //   216: iload_3
    //   217: aload 4
    //   219: invokespecial 357	okhttp3/internal/http/RetryAndFollowUpInterceptor:recover	(Ljava/io/IOException;Lokhttp3/internal/connection/StreamAllocation;ZLokhttp3/Request;)Z
    //   222: ifne -152 -> 70
    //   225: aload 6
    //   227: athrow
    //   228: iconst_0
    ...
    //   233: astore 4
    //   235: aload_1
    //   236: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   239: aload 4
    //   241: athrow
    //   242: aload 4
    //   244: invokevirtual 365	okhttp3/Response:body	()Lokhttp3/ResponseBody;
    //   247: invokestatic 371	okhttp3/internal/Util:closeQuietly	(Ljava/io/Closeable;)V
    //   250: iload_2
    //   251: iconst_1
    //   252: iadd
    //   253: istore_2
    ...
    //   260: aload_1
    //   261: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   264: new 126	java/net/ProtocolException
    //   267: dup
    //   268: new 373	java/lang/StringBuilder
    //   271: dup
    //   272: invokespecial 374	java/lang/StringBuilder:<init>	()V
    //   275: ldc_w 376
    //   278: invokevirtual 380	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   281: iload_2
    //   282: invokevirtual 383	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   285: invokevirtual 386	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   288: invokespecial 131	java/net/ProtocolException:<init>	(Ljava/lang/String;)V
    //   291: athrow
    //   292: aload 6
    //   294: invokevirtual 220	okhttp3/Request:body	()Lokhttp3/RequestBody;
    //   297: instanceof 225
    //   300: ifeq +23 -> 323
    //   303: aload_1
    //   304: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   307: new 388	java/net/HttpRetryException
    //   310: dup
    //   311: ldc_w 390
    //   314: aload 4
    //   316: invokevirtual 100	okhttp3/Response:code	()I
    //   319: invokespecial 393	java/net/HttpRetryException:<init>	(Ljava/lang/String;I)V
    //   322: athrow
    //   323: aload_0
    //   324: aload 4
    //   326: aload 6
    //   328: invokevirtual 163	okhttp3/Request:url	()Lokhttp3/HttpUrl;
    //   331: invokespecial 208	okhttp3/internal/http/RetryAndFollowUpInterceptor:sameConnection	(Lokhttp3/Response;Lokhttp3/HttpUrl;)Z
    //   334: ifne +55 -> 389
    //   337: aload_1
    //   338: invokevirtual 325	okhttp3/internal/connection/StreamAllocation:release	()V
    //   341: new 256	okhttp3/internal/connection/StreamAllocation
    //   344: dup
    //   345: aload_0
    //   346: getfield 25	okhttp3/internal/http/RetryAndFollowUpInterceptor:client	Lokhttp3/OkHttpClient;
    //   349: invokevirtual 315	okhttp3/OkHttpClient:connectionPool	()Lokhttp3/ConnectionPool;
    //   352: aload_0
    //   353: aload 6
    //   355: invokevirtual 163	okhttp3/Request:url	()Lokhttp3/HttpUrl;
    //   358: invokespecial 317	okhttp3/internal/http/RetryAndFollowUpInterceptor:createAddress	(Lokhttp3/HttpUrl;)Lokhttp3/Address;
    //   361: aload 8
    //   363: aload 9
    //   365: aload_0
    //   366: getfield 319	okhttp3/internal/http/RetryAndFollowUpInterceptor:callStackTrace	Ljava/lang/Object;
    //   369: invokespecial 322	okhttp3/internal/connection/StreamAllocation:<init>	(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/Call;Lokhttp3/EventListener;Ljava/lang/Object;)V
    //   372: astore_1
    //   373: aload_0
    //   374: aload_1
    //   375: putfield 292	okhttp3/internal/http/RetryAndFollowUpInterceptor:streamAllocation	Lokhttp3/internal/connection/StreamAllocation;
    //   378: aload 4
    //   380: astore 5
    //   382: aload 6
    //   384: astore 4
    //   386: goto -316 -> 70
    //   389: aload_1
    //   390: invokevirtual 397	okhttp3/internal/connection/StreamAllocation:codec	()Lokhttp3/internal/http/HttpCodec;
    //   393: ifnull +38 -> 431
    //   396: new 94	java/lang/IllegalStateException
    //   399: dup
    //   400: new 373	java/lang/StringBuilder
    //   403: dup
    //   404: invokespecial 374	java/lang/StringBuilder:<init>	()V
    //   407: ldc_w 399
    //   410: invokevirtual 380	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   413: aload 4
    //   415: invokevirtual 402	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   418: ldc_w 404
    //   421: invokevirtual 380	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   424: invokevirtual 386	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   427: invokespecial 405	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   430: athrow
    //   431: goto -53 -> 378
