...
public class ssg
  extends AsyncTask<ssi, ssk, ssj>
{
  public final shd a;
  
  public ssg(shd paramshd)
  {
    if (paramshd == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	urk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	ssg:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    urk.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    urk.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    urk.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected ssj a(ssi... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new ssj(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new ssh(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        vlm.d(paramVarArgs.b);
        return new ssj(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new ssj(paramVarArgs, i, "error=" + i);
  }
}
