...
public class ajkk
{
  ...
  public static int a(int paramInt, String paramString)
  {
    ...
    paramString = new File(ajmu.g, paramInt + "/" + paramString + "/");
    ...
    for (;;)
    {
      ...
      int i = ascj.a(localObject.length);
      ...
      try
      {
        ...
        if (paramInt >= ajmu.jdField_a_of_type_Int) {
          if (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/action/" + ajmu.R)) {
            continue;
          }
        }
        for (;;)
        {
          return j;
          if ((!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + ajmu.x)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + ajmu.w)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + ajmu.y))) {
            break;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((airz)paramQQAppInterface.getManager(153)).a(paramString);
    if (paramString == null)
    {
      if (QLog.isColorLevel()) {
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(ajmu.F);
      localStringBuilder.append("/");
      localStringBuilder.append(paramInt2);
      localStringBuilder.append("/dress");
      return localStringBuilder.toString();
  ...
  public static String a(String paramString)
  {
    ...
    int i = ascj.a(paramString.countTokens());
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (airz.a(paramQQAppInterface, paramString) == 2) {
      return "3D";
    }
    return "2D";
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      localObject = ((ajmw)paramQQAppInterface.getManager(155)).a(paramSpriteTaskParam.f);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      localObject = new File(ajmu.c + (String)localObject);
      if (!((File)localObject).exists())
      {
        QLog.d("ApolloActionHelper", 1, new Object[] { "[checkBasicActionExit] rsc file not exist:", ((File)localObject).toString() });
        ajhw.a(paramQQAppInterface, paramQQAppInterface.c(), null, 0, null, -1, -1, true);
        return false;
      }
      i += 1;
    }
  ...
  public static boolean a(String paramString, int paramInt, int[] paramArrayOfInt, QQAppInterface paramQQAppInterface, ajie paramajie)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (!bool)
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            paramajie = ((airz)paramQQAppInterface.getManager(153)).a();
          }
        }
        for (;;)
        {
          ajhw.a(paramQQAppInterface, paramString, paramajie, paramInt, paramArrayOfInt, -1, -1, false);
          if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString, QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((airz)paramQQAppInterface.getManager(153)).b(paramString);
  ...
  public static Object[] a(String paramString, int paramInt, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject = ((airz)paramQQAppInterface.getManager(153)).b(paramString);
    if (localObject != null)
    {
      localObject = ((ApolloBaseInfo)localObject).getApolloDress3D();
      if (localObject != null)
      {
        paramInt = ((aiwn)localObject).jdField_a_of_type_Int;
        localObject = ((aiwn)localObject).a();
        if ((paramInt > ajmu.jdField_a_of_type_Int) && (localObject != null) && (localObject.length > 0) && ((!paramBoolean) || (a(paramString, paramInt, (int[])localObject, paramQQAppInterface))))
        {
          if (QLog.isColorLevel()) {
  ...
  public static Object[] a(String paramString, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject2 = ((airz)paramQQAppInterface.getManager(153)).b(paramString);
    aiwn[] arrayOfaiwn;
    if (localObject2 != null)
    {
      ...
      if (!airz.a((ApolloBaseInfo)localObject2)) {
      ...
      if ((paramBoolean) && (((ApolloBaseInfo)localObject2).apolloLocalTS != ((ApolloBaseInfo)localObject2).apolloServerTS))
      {
        ...
        airz.a(paramQQAppInterface, paramString, "getRoleDressIdByUin");
      }
      arrayOfaiwn = ((ApolloBaseInfo)localObject2).getApolloDress(false);
      if ((arrayOfaiwn != null) && (arrayOfaiwn.length > 0))
      {
        j = arrayOfaiwn.length;
        i = 0;
        label439:
        if (i >= j) {
          break label749;
        }
        aiwn localaiwn = arrayOfaiwn[i];
        localObject2 = localaiwn.a();
        if (a(paramString, localaiwn.jdField_a_of_type_Int, (int[])localObject2, paramQQAppInterface))
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if (j == 0)
      {
        localObject2 = ajhw.a(arrayOfaiwn[0].jdField_a_of_type_Int);
        if (a(paramString, arrayOfaiwn[0].jdField_a_of_type_Int, (int[])localObject2, paramQQAppInterface))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloActionHelper", 2, "valid basic dress.");
          }
          j = arrayOfaiwn[0].jdField_a_of_type_Int;
          paramString = (String)localObject2;
          i = j;
          if (QLog.isColorLevel())
          {
      ...
      for (paramString = (String)localObject2;; paramString = (String)localObject1)
      {
        ...
        i += 1;
        break label439;
        ajfj.a(110, new Object[] { "basicDresses is not vaild" });
      }
      if (QLog.isColorLevel()) {
  ...
  public static String[] a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      ...
      default: 
        ...
        if ((paramBoolean) || (paramInt2 < 21)) {
          if (localStringBuilder.indexOf(ajmu.u) > -1) {
            localStringBuilder.append("/action");
          }
        }
        break;
    ...
    for (;;)
    {
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(ajmu.u);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      ...
      break label177;
      if (paramInt4 != 0) {
        localStringBuilder.append(ajmu.u).append(ajmu.G);
      }
      for (;;)
      {
        paramInt3 = 1;
        paramInt4 = 1;
        break;
        localStringBuilder.append("def/basic/").append(ajmu.G);
      }
      localStringBuilder.append(ajmu.u).append(ajmu.G);
      paramInt3 = 1;
      paramInt4 = 1;
      break label177;
      int i = a(paramInt3, ajmu.G);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(ajmu.G);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(ajmu.u).append(ajmu.I);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(ajmu.I);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      if (paramInt4 != 0)
      {
        localStringBuilder.append(ajmu.u).append(ajmu.K);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(ajmu.K);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      i = a(paramInt3, ajmu.H);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(ajmu.H);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
  ...
  public static String b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((airz)paramQQAppInterface.getManager(153)).b(paramString);
    if (paramString != null)
    {
