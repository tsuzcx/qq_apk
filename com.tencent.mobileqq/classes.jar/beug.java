...
public class beug
  extends acvo
{
  public Comparator b = new beuh(this);
  
  public beug(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private long a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1, ArrayList<MessageRecord> paramArrayList2, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        try
        {
          paramArrayList = a(paramArrayList, (ArrayList)localObject, localbbzk, true, localbepr);
          if (paramArrayList != null) {
  ...
  private void a(long paramLong1, long paramLong2, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if ((i != 2) || (paramMessageRecord == null)) {
        ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).c(Long.parseLong(paramString));
      }
      return;
      label145:
      ...
      for (int j = 1;; j = 0)
      {
        ...
        if (((ArrayList)localObject2).size() > 0)
        {
          ...
          if (i >= 0)
          {
            ...
            if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((njo.a((MessageRecord)localObject3)) && (njo.b((MessageRecord)localObject3))))
            {
              if (njo.a((MessageRecord)localObject3))
              {
                ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                localObject4 = njo.a((MessageRecord)localObject3);
                njo.a().a(((MessageRecord)localObject3).frienduin, ((MessageRecord)localObject3).vipBubbleID, ((njp)localObject4).jdField_b_of_type_Int, ((njp)localObject4).jdField_b_of_type_JavaLangString, ((njp)localObject4).jdField_c_of_type_Int, ((njp)localObject4).a, ((njp)localObject4).jdField_c_of_type_JavaLangString);
              }
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (paramPbGetGroupMsgResp != null) && (paramPbGetGroupMsgResp.size() > 0))
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
              bbyp.a.a = new ConcurrentHashMap();
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
            bbyp.a.a.put(localObject1, paramPbGetGroupMsgResp);
          }
          if (paramToServiceMsg.size() > 0)
          {
            ...
            paramArrayList = (acvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1);
            ...
            while (i < k)
            {
              ...
              if ((paramPbGetGroupMsgResp instanceof MessageForMarketFace)) {
                awmq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramPbGetGroupMsgResp);
              }
            ...
            i = acwh.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        ...
        for (;;)
        {
          if ((j != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject1) == 1))
          {
            ...
            if (paramArrayList != null)
            {
              ...
              ((acvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1)).b((String)localObject1, 1, l2);
            }
          }
          if (l1 >= 0L)
          {
          ...
          bool2 = anqc.b(paramToServiceMsg);
          ...
          if (paramToServiceMsg.size() > 0) {
            aofl.a((MessageRecord)paramToServiceMsg.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          return;
          bool1 = false;
          break;
  ...
  private void a(ToServiceMsg paramToServiceMsg, msg_svc.PbGetGroupMsgResp paramPbGetGroupMsgResp, ArrayList<msg_comm.Msg> paramArrayList, String paramString)
  {
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.TroopMessageProcessor", 2, "<---refreshTroopHead_PB : fromUin:" + l4 + ",toUin:" + l3 + ",msgTime:" + l5 + ",msgSeq:" + l1 + ",msgUid:" + l2 + ",userActive:" + i + ",fromInstid:" + j + ",groupCode:" + l6 + ",groupType:" + k + ",groupSeq:" + l7 + ",Hascard:" + ((msg_comm.GroupInfo)localObject2).group_card.has() + ",cardName:" + bgjw.a((String)localObject3) + ",hasAppShare:" + paramArrayList.appshare_info.has() + ",hasMsgBody:" + paramArrayList.msg_body.has());
          }
          localObject2 = new ArrayList();
          localObject3 = new bbzk();
          ((bbzk)localObject3).jdField_e_of_type_Long = paramPbGetGroupMsgResp.group_code.get();
          ((bbzk)localObject3).jdField_e_of_type_Int = 1;
          ((bbzk)localObject3).f = k;
          if (paramArrayList.content_head.has())
          {
            msg_comm.ContentHead localContentHead = (msg_comm.ContentHead)paramArrayList.content_head.get();
            i = localContentHead.div_seq.get();
          ...
          try
          {
            paramArrayList = a(paramArrayList, (ArrayList)localObject2, (bbzk)localObject3, true, localbepr);
            if (paramArrayList != null)
            {
    ...
    ((awne)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList, localbepr);
    ...
    ((bgzk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramString);
  }
  ...
  private void a(String paramString, MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    if (paramMessageRecord1.msgtype == -2011)
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)localObject1).tipParam != null) && (((MessageForUniteGrayTip)localObject1).tipParam.jdField_b_of_type_Int == 3276802))
      {
        ...
        QLog.i("Q.msg.TroopMessageProcessor" + bdhn.i, 1, "updateGroupMsgSeqAndTime. docs gray msg. shmsgseq = " + paramMessageRecord1.shmsgseq + ", grayMsgType = " + -5020 + ", grayUniSeq = " + ((MessageRecord)localObject1).uniseq);
      }
    }
    label356:
    label375:
    while (paramMessageRecord1.msgtype != -2000)
    {
      ...
      localObject1 = acwh.a(paramMessageRecord2, paramMessageRecord1);
      ...
      agjf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord2.uniseq);
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramMessageRecord2)) {
        break label915;
      }
      a(paramMessageRecord2);
      bmvi.a().a(paramMessageRecord2.getExtInfoFromExtStr("report_key_bytes_oac_msg_extend"));
    ...
    for (;;)
    {
      ...
      break;
      break;
      if ((bcxa.a(paramMessageRecord2)) || (paramMessageRecord2.msgtype == -2048))
      {
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = new ArrayList();
        bbzk localbbzk = new bbzk();
        localbbzk.jdField_e_of_type_Long = l8;
        localbbzk.jdField_e_of_type_Int = 1;
        localbbzk.f = n;
        Object localObject4;
        if (QLog.isColorLevel())
        ...
        label473:
        paramPbPushMsg = (awne)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
        if (!MessageHandler.b)
        {
          if (paramBoolean) {
            break label608;
        ...
        paramFromServiceMsg = new bepr();
        try
        {
          a(paramMsg, (ArrayList)localObject1, localbbzk, true, paramFromServiceMsg);
          ...
          if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0))
          {
            ...
            if (i < j)
            {
              ...
              if ((localObject3 instanceof MessageForMarketFace)) {
                awmq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)localObject3);
              }
              if (QLog.isColorLevel())
              {
              ...
              if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((njo.a((MessageRecord)localObject3)) && (njo.b((MessageRecord)localObject3))))
              {
                if (njo.a((MessageRecord)localObject3))
                {
                  ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                  localObject4 = njo.a((MessageRecord)localObject3);
                  njo.a().a(String.valueOf(localbbzk.jdField_e_of_type_Long), ((MessageRecord)localObject3).vipBubbleID, ((njp)localObject4).jdField_b_of_type_Int, ((njp)localObject4).jdField_b_of_type_JavaLangString, ((njp)localObject4).jdField_c_of_type_Int, ((njp)localObject4).a, ((njp)localObject4).jdField_c_of_type_JavaLangString);
                }
              ...
              for (;;)
              {
                ...
                if ((localObject3 instanceof MessageForTroopFile)) {
                  ((bdkg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(272)).a((ChatMessage)localObject3);
                }
              }
            }
          }
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramMsg);
          bool1 = anqc.a(paramMsg);
          bool2 = anqc.b(paramMsg);
          i = acwh.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
        {
          ...
          ((bftx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203)).c(paramFromServiceMsg);
        }
        if (n == 127) {
          break;
        }
        ...
        ((bgzk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((List)localObject2);
        l1 = System.currentTimeMillis() - l1;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.TroopMessageProcessor", 2, "decodecMsg cost:" + l1);
        }
        aofl.a("actGroupDecodeCost", l1);
        if (((ArrayList)localObject2).size() <= 0) {
          break;
        }
        aofl.a((MessageRecord)((ArrayList)localObject2).get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      }
      label1694:
      i = 0;
  ...
  public void a(GroupMsgReadedNotify paramGroupMsgReadedNotify)
  {
    ...
    paramGroupMsgReadedNotify = (bfrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
