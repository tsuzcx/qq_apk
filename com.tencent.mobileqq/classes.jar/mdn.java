...
class mdn
  implements Runnable
{
  mdn(mdl parammdl, VideoPlayManager.VideoPlayParam paramVideoPlayParam, JSONObject paramJSONObject, VideoRecommendManager paramVideoRecommendManager) {}
  ...
  public void run()
  {
    ...
    for (localObject = "1";; localObject = "0")
    {
      ...
      this.jdField_a_of_type_OrgJsonJSONObject.put("play_index", VideoPlayManager.a(this.jdField_a_of_type_Mdl.a));
      this.jdField_a_of_type_OrgJsonJSONObject.put("from", VideoReporter.jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(VideoPlayManager.a(this.jdField_a_of_type_Mdl.a))) {
        this.jdField_a_of_type_OrgJsonJSONObject.put("video_session_id", VideoPlayManager.a(this.jdField_a_of_type_Mdl.a));
      }
      if ((VideoPlayManager.a(this.jdField_a_of_type_Mdl.a) == null) || (VideoPlayManager.a(this.jdField_a_of_type_Mdl.a).getIntent() == null)) {
        break label695;
      }
      l = VideoPlayManager.a(this.jdField_a_of_type_Mdl.a).getIntent().getLongExtra("READINJOY_VIDEO_FORCE_INSERT_ARTICLE_ID", 0L);
      ...
      if (VideoPlayManager.a(this.jdField_a_of_type_Mdl.a) != null)
      {
        ...
        if (VideoPlayManager.a(this.jdField_a_of_type_Mdl.a).a()) {
          break label675;
        }
        bool = true;
