...
public class bfcx
{
  ...
  public static bfcx a()
  {
    if (jdField_a_of_type_Bfcx == null) {}
    try
    {
      if (jdField_a_of_type_Bfcx == null) {
        jdField_a_of_type_Bfcx = new bfcx();
      }
      return jdField_a_of_type_Bfcx;
    }
    finally {}
  }
  ...
  {
    paramString = bfcy.a().a(paramString);
  ...
  public String a(String paramString, bfcy parambfcy)
  {
    String str1 = paramString;
    if (parambfcy.c != null) {
      str1 = paramString.replace("<$FROM>", parambfcy.c);
    }
    paramString = str1;
    if (parambfcy.a != null) {
      paramString = str1.replace("<$GC>", parambfcy.a);
    }
    str1 = paramString;
    if (parambfcy.e != null) {
      str1 = paramString.replace("<$NICK>", parambfcy.e);
    }
    paramString = str1;
    if (parambfcy.d != null) {
      paramString = str1.replace("<$TYPE>", parambfcy.d);
    }
    str1 = paramString;
    if (parambfcy.b != null) {
      str1 = paramString.replace("<$UIN>", parambfcy.b);
    }
    paramString = str1;
    if (parambfcy.f != null) {
      paramString = str1.replace("<$CATEID>", parambfcy.f);
    }
    str1 = paramString;
    if (parambfcy.g != null) {
      str1 = paramString.replace("<$SUBID>", parambfcy.g);
    }
    paramString = str1;
    if (parambfcy.j != null) {
      paramString = str1.replace("<$GRAY>", parambfcy.j);
    }
    str1 = paramString;
    if (parambfcy.h != null) {}
    try
    {
      str1 = paramString.replace("<$TITLE>", URLEncoder.encode(parambfcy.h, "UTF-8").replaceAll("\\+", "%20"));
      paramString = str1;
      if (parambfcy.i == null) {}
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = str1.replace("<$CONTENT>", URLEncoder.encode(parambfcy.i, "UTF-8").replaceAll("\\+", "%20"));
          return paramString;
        }
  ...
  {
    paramString1 = bfcy.a().b(paramString2).a(paramString1);
  ...
  {
    paramString3 = bfcy.a().a(paramString1).b(paramString2).e(paramString3).d("3").c("aio");
  ...
  {
    Object localObject = bfcy.a().a(paramString);
    if (paramBoolean) {}
    for (paramString = "1";; paramString = "0")
    {
      paramString = ((bfcy)localObject).f(paramString);
  ...
  public String b(String paramString, bfcy parambfcy)
  {
