  ...
  extends yfm
{
  ...
  yfi jdField_a_of_type_Yfi;
  yfs jdField_a_of_type_Yfs = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (localDoodleItem != null) {
      localyfr = new yfr(localDoodleItem, paramVideoMaterial.getDataPath());
    }
    return localyfr;
  }
  ...
  {
    return new yfq(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    if (localBitmap != null)
    {
      ...
      localBitmap.recycle();
      return yoy.a((Bitmap)localObject, this.jdField_c_of_type_Int, this.jdField_d_of_type_Int, true);
    }
    return null;
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Yfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Yfs.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && ((this.jdField_a_of_type_Yfi instanceof yfk)))
    {
      ((yfk)this.jdField_a_of_type_Yfi).h();
      a(true);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, yfs paramyfs)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(paramyfs.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    paramyfs.jdField_a_of_type_Boolean = true;
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, yfs paramyfs)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = paramyfs.jdField_d_of_type_Boolean;
    localArrayList.addAll(paramyfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramyfs.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof yfr))
    {
      localObject = (yfr)localObject;
      ((yfr)localObject).a(localArrayList);
      ((yfr)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((yfr)localObject).a(paramyfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((yfr)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        paramyfs.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!paramyfs.jdField_d_of_type_Boolean) || (!paramyfs.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = paramyfs.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof yfp))
      {
        localObject = (yfp)localObject;
        ((yfp)localObject).a();
        ((yfp)localObject).a(localArrayList, bool, paramyfs);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((yfp)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((yfp)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          paramyfs.b();
        }
      }
      else if ((localObject instanceof yfq))
      {
        localObject = (yfq)localObject;
        ((yfq)localObject).a(localArrayList);
        yfu.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((yfq)localObject).a();
        yfu.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((yfq)localObject).a(paramyfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          yfu.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          paramyfs.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Yfi != null) {
        this.jdField_a_of_type_Yfi.a(paramVideoMaterial);
      }
      return;
    }
  ...
  public void a(yfs paramyfs)
  {
    if ((paramyfs.jdField_d_of_type_Boolean) && (paramyfs.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!paramyfs.jdField_a_of_type_Boolean) && (paramyfs.jdField_b_of_type_Boolean))
      {
        if (paramyfs.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramyfs);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (paramyfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramyfs);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Yfs == null) || (!this.jdField_a_of_type_Yfs.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    QQToast.a(QQStoryContext.a().getApp(), amtj.a(2131707079), 0).a();
    return true;
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    if (paramMotionEvent.getAction() == 2) {
      if (this.jdField_a_of_type_Yfs != null)
      {
        a(f1, f2, false);
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        ...
        {
          this.jdField_a_of_type_Yfs = new yfs(102, this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId());
          this.jdField_f_of_type_Int += 1;
          this.jdField_a_of_type_Yfs.jdField_c_of_type_Boolean = true;
          if (this.jdField_a_of_type_Yfi != null) {
            this.jdField_a_of_type_Yfi.a(this.jdField_a_of_type_Yfs);
          }
          a(f1, f2, false);
          this.jdField_e_of_type_Int = 0;
        }
      }
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Yfs != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (localBitmap == null)
      {
        ...
        xvv.e("PersonalityOperator", "saveTextureToBitmap failed, bitmapFromTexture is null");
        return;
      }
      localBitmap = yoy.a(localBitmap, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Yfi != null)
      {
        this.jdField_a_of_type_Yfi.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_Yfi != null) && ((this.jdField_a_of_type_Yfi instanceof yfk))) {
      ((yfk)this.jdField_a_of_type_Yfi).f();
    }
    Object localObject4;
    Object localObject5;
    Bitmap localBitmap1;
    ...
    try
    {
      ...
      if (localBitmap2 != null)
      {
        localObject3 = localObject4;
        localObject2 = localObject5;
        localBitmap1 = yoy.a(localBitmap2, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      }
      localObject3 = localBitmap1;
      localObject2 = localBitmap1;
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Yfi != null) {
        this.jdField_a_of_type_Yfi.a(localBitmap1);
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Yfi != null) {
          this.jdField_a_of_type_Yfi.a((Bitmap)localObject3);
        }
      }
    }
    finally
    {
      ...
      this.jdField_a_of_type_Yfi.a((Bitmap)localObject2);
    }
