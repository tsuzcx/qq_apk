...
public class aksj
{
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - agej.a(65.0F, paramActivity.getResources());
  ...
  public static String a()
  {
    ...
    if (bhjr.a())
    {
      localStringBuilder.append(antf.cX).append("tmp/").append(System.currentTimeMillis()).append("_photo.tmp");
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131717918);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131695432);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131695431);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131695433);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131695430);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131695414);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131695415);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131695412);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131695416);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131693028);
    }
    return paramContext.getString(2131695429);
  }
  
  public static String a(List<akps> paramList, TroopInfo paramTroopInfo)
  {
    String str = akps.a;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(akps.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static URL a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = bevg.a(paramString);
        return paramString;
      }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(bgpj.b(bgpj.a(str, paramString2, 1)));
    if (localURL != null)
    {
      paramInt = a(paramString1, beqz.d(localURL.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
        com.tencent.TMG.utils.QLog.d("TroopPhotoUtil", 0, "cacheFileFromLocal origin photo,result:" + paramInt);
      }
    }
    paramString2 = a(bgpj.a(bgpj.a(str, paramString2, 1)));
    if (paramString2 != null)
    {
      paramInt = b(paramString1, beqz.d(paramString2.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent, String paramString, int paramInt)
  {
    ...
    PhotoUtils.a(paramIntent, paramActivity, paramActivity.getClass().getName(), localPoint.x, localPoint.y, 640, 640, paramString, a());
  }
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (azul.a(paramString[0])) && (azul.a(paramString[1])) && (azul.a(paramString[2])) && (azul.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = bhmq.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = bhmq.a(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        int i = bguq.a(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = bhmq.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          bhmq.a(paramString1, paramString2);
          return 0;
        }
      }
  ...
  public static void b(Activity paramActivity, int paramInt)
  {
    ...
    PhotoUtils.a(localIntent, paramActivity, paramActivity.getClass().getName(), localPoint.x, localPoint.y, 640, 640, a());
  }
