  ...
  extends bmqi
{
  protected double a;
  public int a;
  bmqe jdField_a_of_type_Bmqe;
  bmrc jdField_a_of_type_Bmrc = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (paramVideoMaterial != null)
    {
      ...
      if (localDoodleItem != null) {
        localObject1 = new bmrb(localDoodleItem, paramVideoMaterial.getDataPath());
      }
    }
    return localObject1;
  }
  ...
  {
    return new bmra(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bmrc.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Bmrc.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bmqe != null) {
      this.jdField_a_of_type_Bmqe.a();
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, bmrc parambmrc)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap == null) || (this.jdField_a_of_type_JavaUtilHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(parambmrc.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    parambmrc.jdField_a_of_type_Boolean = true;
  }
  
  public void a(bmrc parambmrc)
  {
    if ((parambmrc.jdField_d_of_type_Boolean) && (parambmrc.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!parambmrc.jdField_a_of_type_Boolean) && (parambmrc.jdField_b_of_type_Boolean))
      {
        if (parambmrc.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, parambmrc);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (parambmrc.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, parambmrc);
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, bmrc parambmrc)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap == null) || (this.jdField_a_of_type_JavaUtilHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = parambmrc.jdField_d_of_type_Boolean;
    localArrayList.addAll(parambmrc.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilHashMap.get(parambmrc.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof bmrb))
    {
      localObject = (bmrb)localObject;
      ((bmrb)localObject).a(localArrayList);
      ((bmrb)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((bmrb)localObject).a(parambmrc.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((bmrb)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        parambmrc.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!parambmrc.jdField_d_of_type_Boolean) || (!parambmrc.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = parambmrc.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof bmqz))
      {
        localObject = (bmqz)localObject;
        ((bmqz)localObject).a();
        ((bmqz)localObject).a(localArrayList, bool, parambmrc);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((bmqz)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((bmqz)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          parambmrc.b();
        }
      }
      else if ((localObject instanceof bmra))
      {
        localObject = (bmra)localObject;
        ((bmra)localObject).a(localArrayList);
        bmre.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((bmra)localObject).a();
        bmre.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((bmra)localObject).a(parambmrc.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          bmre.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          parambmrc.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Bmqe != null) {
        this.jdField_a_of_type_Bmqe.a(paramVideoMaterial);
      }
      return;
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Bmrc == null) || (!this.jdField_a_of_type_Bmrc.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    QQToast.a(QQStoryContext.a().getApp(), alpo.a(2131708335), 0).a();
    return true;
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    int i;
    if (paramMotionEvent.getAction() == 2) {
      if (this.jdField_a_of_type_Bmrc != null)
      {
        a(f1, f2, false);
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        if ((this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId())))
        {
          ...
          if (this.jdField_a_of_type_Bmqe != null) {}
          for (i = this.jdField_a_of_type_Bmqe.a();; i = 0)
          {
            this.jdField_a_of_type_Bmrc = new bmrc(102, paramMotionEvent, i);
            this.jdField_f_of_type_Int += 1;
            this.jdField_a_of_type_Bmrc.jdField_c_of_type_Boolean = true;
            if (this.jdField_a_of_type_Bmqe != null) {
              this.jdField_a_of_type_Bmqe.a(this.jdField_a_of_type_Bmrc);
            }
            a(f1, f2, false);
      ...
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Bmrc != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bmqe != null)
      {
        this.jdField_a_of_type_Bmqe.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 86	bmrd:jdField_f_of_type_Boolean	Z
    //   4: ifeq +29 -> 33
    //   7: aload_0
    //   8: aload_0
    //   9: getfield 70	bmrd:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   12: invokevirtual 318	com/tencent/aekit/openrender/internal/Frame:getFBO	()I
    //   15: aload_0
    //   16: getfield 70	bmrd:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   19: invokevirtual 143	com/tencent/aekit/openrender/internal/Frame:getTextureId	()I
    //   22: aload_0
    //   23: getfield 88	bmrd:jdField_a_of_type_Int	I
    //   26: aload_0
    //   27: getfield 203	bmrd:jdField_b_of_type_Int	I
    //   30: invokevirtual 359	bmrd:a	(IIII)V
    //   33: aload_0
    //   34: getfield 66	bmrd:jdField_b_of_type_ComTencentFilterBaseFilter	Lcom/tencent/filter/BaseFilter;
    //   37: aload_0
    //   38: getfield 70	bmrd:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   41: invokevirtual 143	com/tencent/aekit/openrender/internal/Frame:getTextureId	()I
    //   44: aload_0
    //   45: getfield 29	bmrd:jdField_c_of_type_Int	I
    //   48: aload_0
    //   49: getfield 31	bmrd:jdField_d_of_type_Int	I
    //   52: iconst_0
    //   53: aload_0
    //   54: getfield 35	bmrd:jdField_a_of_type_Double	D
    //   57: aload_0
    //   58: getfield 68	bmrd:jdField_c_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   61: invokevirtual 314	com/tencent/filter/BaseFilter:RenderProcess	(IIIIDLcom/tencent/aekit/openrender/internal/Frame;)V
    //   64: aload_0
    //   65: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   68: ifnull +23 -> 91
    //   71: aload_0
    //   72: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   75: instanceof 539
    //   78: ifeq +13 -> 91
    //   81: aload_0
    //   82: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   85: checkcast 539	bmqg
    //   88: invokevirtual 541	bmqg:f	()V
    //   91: aload_0
    //   92: getfield 219	bmrd:jdField_g_of_type_Boolean	Z
    //   95: ifeq +285 -> 380
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 219	bmrd:jdField_g_of_type_Boolean	Z
    //   103: aconst_null
    //   104: astore 8
    //   106: aconst_null
    //   107: astore 7
    ...
    //   130: astore 6
    //   132: aload_0
    //   133: getfield 29	bmrd:jdField_c_of_type_Int	I
    //   136: aload_0
    //   137: getfield 31	bmrd:jdField_d_of_type_Int	I
    //   140: imul
    ...
    //   151: iconst_0
    //   152: aload_0
    //   153: getfield 29	bmrd:jdField_c_of_type_Int	I
    //   156: aload_0
    //   157: getfield 31	bmrd:jdField_d_of_type_Int	I
    //   160: sipush 6408
    //   163: sipush 5121
    //   166: aload 9
    ...
    //   184: astore 6
    //   186: aload_0
    //   187: getfield 29	bmrd:jdField_c_of_type_Int	I
    //   190: aload_0
    //   191: getfield 31	bmrd:jdField_d_of_type_Int	I
    ...
    //   223: astore 6
    //   225: aload_0
    //   226: getfield 90	bmrd:jdField_g_of_type_Int	I
    //   229: i2f
    //   230: fconst_1
    //   231: fmul
    //   232: aload_0
    //   233: getfield 29	bmrd:jdField_c_of_type_Int	I
    //   236: i2f
    //   237: fdiv
    //   238: fstore_1
    //   239: aload 8
    ...
    //   317: aload_0
    //   318: iconst_0
    //   319: putfield 460	bmrd:jdField_d_of_type_Boolean	Z
    //   322: aload_0
    //   323: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   326: ifnull +14 -> 340
    //   329: aload_0
    //   330: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   333: aload 6
    ...
    //   413: aload_0
    //   414: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   417: ifnull -77 -> 340
    //   420: aload_0
    //   421: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   424: aload 6
    ...
    //   478: aload_0
    //   479: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   482: ifnull -142 -> 340
    //   485: aload_0
    //   486: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   489: aload 7
    ...
    //   507: astore 6
    //   509: aload_0
    //   510: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   513: ifnull +14 -> 527
    //   516: aload_0
    //   517: getfield 92	bmrd:jdField_a_of_type_Bmqe	Lbmqe;
    //   520: aload 7
