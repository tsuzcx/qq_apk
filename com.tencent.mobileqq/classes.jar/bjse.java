...
public class bjse
{
  ...
  {
    bjtx.a("DownloadJSApi", "doDownloadActionBySDK pParmas =" + paramBundle);
    String str3 = paramBundle.getString(bjwo.b);
    String str4 = paramBundle.getString(bjwo.j);
    String str5 = paramBundle.getString(bjwo.f);
    int i = paramBundle.getInt(bjwo.k);
    String str6 = paramBundle.getString(bjwo.i);
    String str7 = paramBundle.getString(bjwo.l);
    paramBundle.getString(bjwo.m);
    String str2 = paramBundle.getString(bjwo.D);
    int j = paramBundle.getInt(bjwo.H);
    String str1 = paramBundle.getString(bjwo.I);
    boolean bool1 = paramBundle.getBoolean(bjwo.o);
    boolean bool2 = paramBundle.getBoolean(bjwo.y, true);
    boolean bool3 = paramBundle.getBoolean(bjwo.h, true);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bjtx.c("DownloadJSApi", "doDownloadAction action == Downloader.ACTION_DOWNLOAD");
      ...
      for (;;)
      {
        bjtx.c("DownloadJSApi", "doDownloadAction action == Downloader.ACTION_UPDATE " + bool1);
        break;
        if (bool2) {
          bjrz.a().a(paramString, paramApkUpdateDetail);
        } else {
          bjrz.a().a(paramString);
        }
      }
