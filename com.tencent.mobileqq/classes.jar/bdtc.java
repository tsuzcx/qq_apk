...
public class bdtc
  extends bdsx
{
  bktt jdField_a_of_type_Bktt = new bktt();
  ArrayList<bdyf> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bdtc(bdsv parambdsv, bdzn parambdzn)
  {
    super(parambdsv, parambdzn);
    this.jdField_c_of_type_Boolean = true;
    this.f = false;
    c(parambdzn.jdField_c_of_type_JavaLangString + parambdzn.jdField_a_of_type_Long);
    this.jdField_c_of_type_Boolean = parambdzn.jdField_e_of_type_Boolean;
  }
  ...
  protected bdvs a(byte[] paramArrayOfByte)
  {
    ...
    localbdvs.jdField_a_of_type_JavaLangString = a(paramArrayOfByte);
    localbdvs.jdField_a_of_type_Int = 1;
    localbdvs.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    ...
    localbdvs.l = true;
    localbdvs.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + this.jdField_s_of_type_Long + "-");
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, paramInt, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, paramInt, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, paramInt, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, paramInt, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  {
    this.jdField_a_of_type_Bedj.j = paramString4;
    this.jdField_a_of_type_Bedj.k = paramString5;
    this.jdField_a_of_type_Bedj.l = paramString6;
    this.jdField_a_of_type_Bedj.jdField_c_of_type_JavaLangString = String.valueOf(paramInt);
    this.jdField_a_of_type_Bedj.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_Bedj.jdField_b_of_type_JavaLangString = paramString3;
    this.jdField_a_of_type_Bedj.jdField_b_of_type_Long = this.q;
  ...
  public void b(HashMap<String, String> paramHashMap)
  {
    ...
    this.jdField_a_of_type_Bedj.m = ((String)paramHashMap.get("param_Ip_ConnCost"));
    ...
    this.jdField_o_of_type_Long = this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.mTransReport.timeCost_Cache;
  }
  ...
  boolean h()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 131	bdtc:jdField_a_of_type_Bdzn	Lbdzn;
    //   4: getfield 411	bdzn:i	Ljava/lang/String;
    //   7: astore 4
    //   9: new 413	java/io/FileInputStream
    //   12: dup
    //   13: aload 4
    //   15: invokespecial 415	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   18: astore_3
    //   19: aload_3
    //   20: astore_2
    //   21: aload_0
    //   22: aload_3
    //   23: aload_0
    //   24: getfield 418	bdtc:jdField_a_of_type_Bduk	Lbduk;
    //   27: getfield 421	bduk:jdField_a_of_type_Long	J
    //   30: invokestatic 427	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   33: putfield 429	bdtc:jdField_b_of_type_ArrayOfByte	[B
    //   36: aload_3
    //   37: astore_2
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 429	bdtc:jdField_b_of_type_ArrayOfByte	[B
    //   43: invokestatic 434	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   46: putfield 436	bdtc:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   49: aload_3
    //   50: astore_2
    //   51: aload_0
    //   52: aload_0
    //   53: getfield 436	bdtc:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   56: putfield 437	bdtc:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   59: aload_3
    //   60: astore_2
    //   61: aload_0
    //   62: getfield 418	bdtc:jdField_a_of_type_Bduk	Lbduk;
    //   65: aload_0
    //   66: getfield 436	bdtc:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   69: putfield 439	bduk:f	Ljava/lang/String;
    //   72: aload_3
    //   73: astore_2
    //   74: aload_0
    ...
    //   82: aload_0
    //   83: getfield 436	bdtc:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   95: aload_0
    //   96: getfield 442	bdtc:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   105: putfield 436	bdtc:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   108: aload_3
    //   109: ifnull +7 -> 116
    //   112: aload_3
    //   113: invokevirtual 443	java/io/FileInputStream:close	()V
    //   116: iconst_1
    //   117: istore_1
    //   118: iload_1
    //   119: ireturn
    ...
    //   121: aload_3
    //   122: astore_2
    //   123: new 445	java/io/File
    //   126: dup
    //   127: aload 4
    //   129: invokespecial 446	java/io/File:<init>	(Ljava/lang/String;)V
    //   132: astore 4
    //   134: aload_3
    //   135: astore_2
    //   136: aload 4
    //   138: invokevirtual 449	java/io/File:exists	()Z
    //   141: istore_1
    //   142: iload_1
    //   143: ifeq -107 -> 36
    //   146: aload_3
    //   147: astore_2
    //   148: aload 4
    //   150: invokestatic 454	bkcx:a	(Ljava/io/File;)Ljava/lang/String;
    //   153: astore 4
    //   155: aload 4
    //   157: ifnull +17 -> 174
    //   160: aload_3
    ...
    //   162: aload_0
    //   163: aload 4
    //   165: invokestatic 458	com/qq/taf/jce/HexUtil:hexStr2Bytes	(Ljava/lang/String;)[B
    //   168: putfield 429	bdtc:jdField_b_of_type_ArrayOfByte	[B
    //   171: goto -135 -> 36
    //   174: ldc_w 375
    //   177: astore 4
    //   179: goto -19 -> 160
    //   182: astore_2
    //   183: aload_2
    //   184: invokevirtual 236	java/io/IOException:printStackTrace	()V
    //   187: goto -71 -> 116
    //   190: astore 4
    //   192: aconst_null
    //   193: astore_3
    ...
    //   196: aload_0
    //   197: aconst_null
    //   198: putfield 429	bdtc:jdField_b_of_type_ArrayOfByte	[B
    //   201: aload_3
    //   202: astore_2
    //   203: aload_0
    //   204: aload 4
    //   206: invokevirtual 233	bdtc:a	(Ljava/io/IOException;)V
    //   209: iconst_0
    //   210: istore_1
    //   211: aload_3
    //   212: ifnull -94 -> 118
    //   215: aload_3
    //   216: invokevirtual 443	java/io/FileInputStream:close	()V
    //   219: iconst_0
    //   220: ireturn
    //   221: astore_2
    //   222: aload_2
    //   223: invokevirtual 236	java/io/IOException:printStackTrace	()V
    //   226: iconst_0
    //   227: ireturn
    //   228: astore_3
    //   229: aconst_null
    ...
    //   232: ifnull +7 -> 239
    //   235: aload_2
    //   236: invokevirtual 443	java/io/FileInputStream:close	()V
    //   239: aload_3
    //   240: athrow
    //   241: astore_2
    //   242: aload_2
    //   243: invokevirtual 236	java/io/IOException:printStackTrace	()V
    //   246: goto -7 -> 239
    //   249: astore_3
    //   250: goto -19 -> 231
    //   253: astore 4
  ...
  protected void i()
  {
    try
    {
      ...
      {
        i = SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getHttpconn_sig_session().length;
        this.jdField_d_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getHttpconn_sig_session(), 0, this.jdField_d_of_type_ArrayOfByte, 0, i);
      }
      if (SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getSessionKey() != null)
      {
        i = SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getSessionKey().length;
        this.jdField_c_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getSessionKey(), 0, this.jdField_c_of_type_ArrayOfByte, 0, i);
      }
      return;
    }
    finally {}
  ...
  protected void p()
  {
    ...
    if ((this.w == 2) && (!this.jdField_a_of_type_JavaUtilHashMap.containsKey("param_BdhTrans"))) {
      if ((this.n > 0L) && (this.jdField_o_of_type_Long > 0L))
      {
        ...
        localStringBuilder.append("sn:").append(this.jdField_o_of_type_Int).append(";").append("tc_s:").append(this.n).append(";").append("tc_h:").append(this.jdField_m_of_type_Long).append(";").append("tc_p:").append(this.jdField_o_of_type_Long).append(";");
