  ...
  extends bdnu
{
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if ((paramView != null) && ((paramView instanceof ViewGroup)))
      {
        ...
        localObject = (bdnu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localObject instanceof bdsw))
        {
          localbdsw = (bdsw)localObject;
          localView = localbdsw.a(paramContext, null, paramBundle);
      ...
      {
        ((TextView)localView).setGravity(localbdsw.p);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    while (i < j)
    {
      ...
      {
        localObject = bdoe.a((String)localObject);
        if (localObject != null)
        {
  ...
  {
    boolean bool2 = false;
    Object localObject1 = parambdpl.a("mode");
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
    boolean bool1;
    try
    {
      this.q = Integer.valueOf((String)localObject1).intValue();
      localObject1 = parambdpl.a("margin");
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        do
        {
          ...
          localObject1 = parambdpl.a("hidden");
          ...
          while (i < parambdpl.a())
          {
            localObject1 = parambdpl.a(i);
            if ((localObject1 != null) && ("td".equals(((bdpl)localObject1).b)))
            {
              localObject2 = bdoe.a(((bdpl)localObject1).b);
              bool1 = bool2;
              if (localObject2 == null) {
                return bool1;
              }
              bool1 = bool2;
              if (!((bdnu)localObject2).a((bdpl)localObject1)) {
                return bool1;
              }
              a((bdnu)localObject2);
            }
