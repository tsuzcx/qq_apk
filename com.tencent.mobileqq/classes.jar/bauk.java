  ...
  extends bgqa
{
  ...
  public bauk(String paramString1, View paramView, String paramString2)
  {
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        urk.e("DIYProfileTemplate.ProfileTemplateNickNameViewModule", "pf_name font id illegal :" + paramString2 + " error=" + paramString1);
        return;
      }
      if ("ft".equals(paramString1)) {
        ...
        {
          urk.e("DIYProfileTemplate.ProfileTemplateNickNameViewModule", "pf_name font type illegal :" + paramString2 + " error=" + paramString1);
          return;
        }
      }
    }
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      ...
      return;
      label112:
      urk.e("DIYProfileTemplate.ProfileTemplateNickNameViewModule", "profile nick name set font error because font id=" + this.c + " type=" + this.d + " is illegal!");
    }
  }
}
