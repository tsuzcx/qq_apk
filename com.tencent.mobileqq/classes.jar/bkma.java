...
public class bkma
{
  ...
  public bkma(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bkmb(this, Looper.getMainLooper());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bkmc(this);
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    return bbef.a(paramBitmap, i, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  }
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    if (TextUtils.isEmpty(paramString))
    {
      ved.e("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable uin is null!");
      return null;
    }
    ...
    {
      localwbq = (wbq)this.jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
      if (localwbq != null)
      {
        ved.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, hit cache:" + paramString);
        return localwbq;
      }
    }
    ved.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, not in cache:" + paramString);
    wbq localwbq = new wbq(paramInt1, paramInt2);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache.put(paramString, localwbq);
  ...
  public void a()
  {
    ved.c("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory");
    try
    {
    ...
    {
      ved.e("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory:" + localException.toString());
    }
  }
  ...
  {
    ved.b("Q.qqstory.record.StoryFaceDrawableFactory", "sendQQHeadRequest uin:%s.", paramString);
