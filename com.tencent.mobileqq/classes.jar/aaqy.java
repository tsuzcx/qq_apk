...
public class aaqy
{
  public aaqy(NewerGuidePlugin paramNewerGuidePlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void deniedReadContacts()
  {
    ...
    try
    {
      ...
      QQCustomDialog.showPermissionSettingDialog(this.jdField_a_of_type_AndroidAppActivity, anvx.a(2131706903));
      return;
    }
