...
public class aaqy
  extends aoeg
{
  public aaqy(FollowTextView paramFollowTextView) {}
  ...
  public void onUnfollowPublicAccount(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (FollowTextView.a(this.a) != null)
      {
        ...
        aaak.a().a(new FollowUpdateEvent(0, FollowTextView.a(this.a).poster.id.get()));
      }
      return;
    }
    QQToast.a(this.a.getContext(), 2131690629, 0).a();
  }
}
