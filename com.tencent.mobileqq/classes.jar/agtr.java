  ...
  implements URLDrawableDownListener
{
  ...
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    agtq.a(this.a, paramURLDrawable, l1);
    paramView = paramView.getTag();
    if (agug.b((agtk)paramView))
    {
      paramView = (agua)paramView;
      if ((agug.b(paramView)) && (!agtq.a(this.a).contains(paramView.j())))
      {
        agtq.a(this.a).add(paramView.j());
        paramURLDrawable = paramView.l();
        agtq.a(this.a).add(new StickerRecCacheEntity(paramURLDrawable, System.currentTimeMillis(), paramView.j()));
      }
    }
  }
}
