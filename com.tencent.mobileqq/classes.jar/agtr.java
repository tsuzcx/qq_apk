  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        {
          paramString = ((agtd)localAppRuntime.getManager(343)).a();
        ...
        {
          paramBundle = (agtd)localAppRuntime.getManager(343);
        ...
        {
          paramString = (agtd)localAppRuntime.getManager(343);
          paramBundle = new EIPCResult();
          localObject1 = new Bundle();
        ...
        paramBundle = (agtk)localAppRuntime.getManager(342);
