  ...
  extends alpd
{
  ...
  public amdj(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramString = bdhb.a(paramString);
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, ThemeAuth.DiyThemeDetail paramDiyThemeDetail)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString1))
      {
        ...
        if (paramInt1 == 2) {
          aeqq.a(localMobileQQ, this.app.getAccount(), null, str2);
        }
      }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "Theme Auth themeId=" + str1 + ",version=" + "20000000" + ", userThemeId=" + str3 + ",currentThemeResPath=" + str2 + ", usr=" + banh.a(this.mApp.getAccount(), 2) + ", oldTime=" + l1);
      if ("1000".equals(str1)) {
        break label964;
      }
    ...
    do
    {
      ...
      i = 1;
      baop.a(null, "theme_detail", "205", 157, j, i, str1, "20000000", "1", "");
      return;
      ...
      ((ThemeAuth.ReqBody)localObject3).str_qq_version.set("8.3.5.4555");
      ((ThemeAuth.ReqBody)localObject3).uint32_qq_version.set(Integer.parseInt("4555"));
    ...
    for (int i = 1;; i = -1)
    {
      baop.a(null, "theme_sp_speed", "204", 153, -1, i, String.valueOf(l2 - l1), "6653", "read", "");
      if ((paramBundle.isDirectory()) && (localObject1 != null))
      {
        ...
        baop.a(this.app, "theme_detail", "204", 157, bdin.a(null), 101, str1, "665", String.valueOf(i), String.valueOf(((ThemeUtil.ThemeInfo)localObject1).fileNum));
        break;
        label964:
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    {
      if (!banm.a(paramString1, paramString2)) {
        a(paramString1, paramString2);
      }
      while (ThemeUtil.isFixTheme(paramString1)) {
        return;
      }
      baos.a(this.app, paramString1, "20000000");
      return;
    }
    a(paramString1, paramString2);
  }
  ...
  public void a()
  {
    ...
    else
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "sendThemeAuth init: , skThemeId:" + ((Bundle)localObject4).getString("themeId") + ", skVersion:" + ((Bundle)localObject4).getString("version") + ", qqVersion:" + "8.3.5");
      ...
      if (azmk.a((String)localObject2))
      {
        localObject3 = baos.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject4).putString("themePath", new baoo().a().d());
    }
    label559:
    Object localObject2 = new baoo().a((String)localObject3);
    ((VasQuickUpdateManager)this.app.getManager(184)).queryItemVersion(3, ((baoo)localObject2).b(), true, false, 0L, new amdl(this, (baoo)localObject2, localMobileQQ, (Bundle)localObject4));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return;
      label110:
      ThemeSwitcher.a(paramString1, paramString2, new amdk(this));
    }
  }
  
  /* Error */
  public void a(String paramString1, String paramString2, String paramString3, Bundle paramBundle, bapb parambapb)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 7
    ...
    //   85: aload_0
    //   86: aload 5
    //   88: putfield 738	amdj:jdField_a_of_type_Bapb	Lbapb;
    //   91: aload_0
    //   92: aload 4
    //   94: putfield 740	amdj:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    ...
    //   361: ldc_w 476
    //   364: aload_0
    //   365: getfield 126	amdj:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   386: aload_0
    //   387: aload_2
    //   388: invokespecial 504	alpd:sendPbReq	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1.str_qq_version.set("8.3.5.4555");
        paramString1.uint32_qq_version.set(Integer.parseInt("4555"));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.i("Theme.ThemeHandler", 2, "onReceive~ handleThemeAuth res.isSuccess=" + paramFromServiceMsg.isSuccess() + ",data=" + bdqa.a((byte[])paramObject));
      }
      String str1;
      String str2;
      Object localObject2;
      for (;;)
      {
        try
        {
          ...
          if (((ThemeAuth.RspBody)localObject1).uint32_sub_cmd.has())
          {
            ...
            if (k == 0)
            {
              ...
              QLog.e("Theme.ThemeHandler", 1, "onReceive Error: isSuccess=false, data=" + bdqa.a((byte[])paramObject) + ", subCmd=" + j);
              if (3 != j) {
                break;
              }
            }
            ...
            bdut.a(this.app, "individual_v2_theme_auth_fail", String.valueOf(j), String.valueOf(j), null, 0.0F);
            paramFromServiceMsg = new HashMap();
            paramFromServiceMsg.put("authResult", String.valueOf(j));
            azri.a(BaseApplication.getContext()).a("", "individual_v2_theme_auth_fail", false, 0L, -1L, paramFromServiceMsg, "", true);
            baop.a(this.app, "theme_detail", "204", 157, bdin.a(null), 0 - j, str1, str2, "1", "");
          }
        }
        ...
        try
        {
          ...
          localObject2 = azri.a(this.mApp.getApplication());
          str3 = this.mApp.getAccount();
          if (j != 0) {
            break label2737;
          }
          bool = true;
          ((azri)localObject2).a(str3, "VipThemeAuthHandleError", bool, 1L, 0L, paramFromServiceMsg, "", false);
        }
        ...
        try
        {
          paramToServiceMsg = new baoo().a(str1).a(this.mApp.getApplication());
          bdhb.a(paramToServiceMsg, true);
      ...
      break label2743;
      if (bool) {
        azqs.b(null, "CliOper", "", "", "theme", "0X8007234", 0, 0, String.valueOf(i), "", "", "");
      }
      if (!TextUtils.isEmpty(paramToServiceMsg)) {
        break label2728;
      }
      paramToServiceMsg = alud.a(2131715306);
      if (bool)
      {
      ...
      {
        aeqq.a(this.mApp.getApplication(), this.app.getAccount(), null, "null");
    ...
    azqs.b(this.app, "CliOper", "", "", "0X8005B9E", "0X8005B9E", 0, 0, "", "", "", "");
    paramFromServiceMsg = new Message();
    ...
    if (3 == j)
    {
      paramFromServiceMsg = alud.a(2131715309);
      if (k != 0)
      {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_Bapb != null) && (this.jdField_a_of_type_AndroidOsBundle != null)) {
          break;
        }
        QLog.e("Theme.ThemeHandler", 1, "handleThemeAuth Set result:null == service || null == reqbundle, result:" + i);
        this.jdField_a_of_type_AndroidOsBundle = null;
        this.jdField_a_of_type_Bapb = null;
        return;
      ...
      if ((!TextUtils.isEmpty(paramFromServiceMsg)) && (paramFromServiceMsg.equals(this.jdField_a_of_type_AndroidOsBundle.getString("themeId"))))
      {
        ...
        paramToServiceMsg = this.jdField_a_of_type_Bapb;
        if (i != 0) {
          break label2789;
        }
      }
