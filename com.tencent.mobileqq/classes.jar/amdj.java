  ...
  implements Manager
{
  ...
  ayvx jdField_a_of_type_Ayvx = null;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected ArrayList<auvq> a;
    ...
    if (paramBusinessCard != null)
    {
      ...
      if (str != null)
      {
        ...
        if (str.length() != 0)
        {
          ...
          this.jdField_a_of_type_Aukp.b(paramBusinessCard);
          bool1 = bool2;
  ...
  {
    if (paramBusinessCard != null) {
      this.jdField_a_of_type_Aukp.a(paramBusinessCard);
    }
  }
  ...
  {
    List localList = this.jdField_a_of_type_Aukp.a(BusinessCard.class);
  ...
  public void a(ArrayList<auvq> paramArrayList)
  {
  ...
  public void a(List<BusinessCard> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean) {
        this.jdField_a_of_type_Aukp.a(BusinessCard.class.getSimpleName());
      }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Aukp.a(BusinessCard.class);
  }
  ...
  public BusinessCard d(String paramString)
  {
    ...
    BusinessCard localBusinessCard2 = (BusinessCard)this.jdField_a_of_type_Aukp.a(BusinessCard.class, paramString);
