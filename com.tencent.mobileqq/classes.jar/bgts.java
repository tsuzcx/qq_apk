...
public class bgts
{
  ...
  private static HashMap<String, bgtr> d;
  ...
  public static bgtr a(QQAppInterface paramQQAppInterface, String paramString)
  {
    Object localObject;
    if (paramString == null)
    {
      QLog.e("TroopNotificationHelper", 1, "HasUnReadRepeatTroopNotification, troopUin is NULL!");
      localObject = (bgtr)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      if (localObject == null) {
        break label141;
      }
      ...
      {
        paramString = new StringBuilder().append("HasUnReadRepeatTroopNotification. found in mTroopNotificationRepeatAIOFlag. type = ").append(((bgtr)localObject).jdField_a_of_type_Int).append(", feedsId = ");
        if (!TextUtils.isEmpty(((bgtr)localObject).jdField_a_of_type_JavaLangString)) {
          break label133;
        }
        paramQQAppInterface = "";
        label78:
    ...
    do
    {
      do
      {
        ...
        break;
        paramQQAppInterface = ((bgtr)localObject).jdField_a_of_type_JavaLangString;
        break label78;
        ...
        paramString = (bgtr)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      ...
      return null;
      paramString = new bgtr(((TroopInfo)localObject).feeds_id, ((TroopInfo)localObject).troopRepeatType);
      paramQQAppInterface = paramString;
    } while (!QLog.isColorLevel());
  ...
  public static bgtt a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static bgtt a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    boolean bool1 = true;
    boolean bool2 = false;
    label846:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new bgtt();
          ((bgtt)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((bgtt)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((bgtt)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((bgtt)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((bgtt)localObject5).jdField_a_of_type_Int = 1;
          if (!localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            break label894;
          }
          i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          ((bgtt)localObject5).jdField_e_of_type_Int = i;
          ...
          paramBoolean = bool1;
          ((bgtt)localObject5).jdField_a_of_type_Boolean = paramBoolean;
          break label891;
        }
        if (i == 22)
        {
          ...
          localObject3 = new bgtt();
          ((bgtt)localObject3).jdField_b_of_type_JavaLangString = paramString;
          ((bgtt)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
          ((bgtt)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
          ((bgtt)localObject3).jdField_a_of_type_Int = 2;
          ((bgtt)localObject3).jdField_b_of_type_Long = l1;
          ((bgtt)localObject3).jdField_d_of_type_Int = i;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has())
          {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
            ((bgtt)localObject3).jdField_e_of_type_Int = i;
            if ((!localGroupFeedsMessage.memo_ctrl_info.has()) || (!((group_feeds.GroupFeedsMessage.MemoCtrlInfo)localGroupFeedsMessage.memo_ctrl_info.get()).uint32_need_confirmation.has())) {
              break;
            }
            paramBoolean = bool2;
            ...
            ((bgtt)localObject3).jdField_a_of_type_Boolean = paramBoolean;
            break;
          }
        }
        return null;
  ...
  public static TroopNotificationCache a(bgtt parambgtt, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (parambgtt != null)
    {
      if (parambgtt.jdField_a_of_type_Int == 1)
      {
        String str2 = a(parambgtt.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(parambgtt.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(parambgtt.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(parambgtt.jdField_c_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = parambgtt.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = parambgtt.jdField_a_of_type_Long;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = parambgtt.jdField_c_of_type_Int;
        localTroopNotificationCache.feedsId = parambgtt.jdField_b_of_type_JavaLangString;
        localTroopNotificationCache.serviceID = 27;
        localTroopNotificationCache.needConfirm = parambgtt.jdField_a_of_type_Boolean;
        String str3 = new SimpleDateFormat("M-d HH:mm").format(new Date(localTroopNotificationCache.time * 1000L));
        if (TextUtils.isEmpty(parambgtt.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, parambgtt.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (parambgtt.jdField_a_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = parambgtt.jdField_a_of_type_Long;
        paramString.troopUin = paramLong;
        paramString.time = parambgtt.jdField_c_of_type_Int;
        paramString.feedsId = parambgtt.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = parambgtt.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = parambgtt.jdField_a_of_type_ArrayOfByte;
        paramString.src = parambgtt.jdField_d_of_type_Int;
        paramString.filterID = parambgtt.jdField_b_of_type_Long;
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        QLog.d(bgts.class.getSimpleName(), 2, paramQQAppInterface.getMessage());
        continue;
      }
      return null;
      label337:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString1, int paramInt2, String paramString2, short paramShort, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(bgts.class.getSimpleName(), 2, localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((bgtt)localObject).jdField_a_of_type_Int == 1) || (((bgtt)localObject).jdField_a_of_type_Int == 2)) {
          paramArrayOfByte = a((bgtt)localObject, paramString, 23, paramInt1, paramLong2);
        }
        QQMessageFacade localQQMessageFacade = paramQQAppInterface.a();
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(paramArrayOfByte);
        paramInt1 = (int)bcrg.a();
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((bgtt)localObject).jdField_e_of_type_Int, ((bgtt)localObject).jdField_b_of_type_JavaLangString);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((aoip)paramQQAppInterface.a(20)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramQQAppInterface = new bgtr(paramString1, paramInt);
      ...
      for (;;)
      {
        ...
        do
        {
          do
          {
            ...
            {
              paramList = agdu.a();
              if ((paramList != null) && (paramList.h() < 5) && (paramList.c().equals(paramString1)))
              {
                if (QLog.isColorLevel()) {
        ...
        if (paramInt2 == 1)
        {
          ...
          paramQQAppInterface = alni.a(paramString1.uin, paramString1.getType());
          alni.a().a(paramQQAppInterface);
          if (paramInt2 != 1) {
            break label537;
          }
          i = 29;
          paramString1.msgType = i;
          if (!(paramString1.msg instanceof alqr)) {
            break label557;
          }
          localObject1 = (alqr)paramString1.msg;
          if (!bool1) {
            break label544;
          }
          paramQQAppInterface = BaseApplication.getContext().getString(2131718712);
          label470:
          ((alqr)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface;
        }
        for (;;)
        {
          ((alqr)paramString1.msg).jdField_c_of_type_Int = paramInt2;
          paramString1.lastmsgtime = paramInt1;
          paramString2.a().saveRecentUser(paramString1);
          paramList.sendEmptyMessage(1009);
          return;
          if ((!(paramString1.msg instanceof alqr)) || (((alqr)paramString1.msg).jdField_c_of_type_Int != 1)) {
            break;
          }
          return;
          i = 11;
          break label430;
          paramQQAppInterface = BaseApplication.getContext().getString(2131718711);
          break label470;
          paramString1.msg = new alqr(BaseApplication.getContext(), bool1);
        }
      }
    }
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, bgts.class.getSimpleName() + "-->clearTroopNotification. troop = " + paramString);
  }
  ...
  public static byte[] a(long paramLong, short paramShort, byte[] paramArrayOfByte, String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(bgts.class.getSimpleName(), 2, paramArrayOfByte.getMessage());
      }
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(bgts.class.getSimpleName(), 2, "handGetTroopAuth");
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      aaud.b("https://gdynamic.qpic.cn/gdynamic/");
      return;
      if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    } while (((paramString2.msg instanceof alqr)) && (((alqr)paramString2.msg).jdField_c_of_type_Int == 1));
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "setUnReadRepeatTroopNotificationPre, update recent user list");
    }
    Object localObject = alni.a(paramString2.uin, paramString2.getType());
    alni.a().a((String)localObject);
    paramString2.msgType = 11;
    localObject = new alqr(BaseApplication.getContext(), true);
    ((alqr)localObject).jdField_c_of_type_Int = 0;
