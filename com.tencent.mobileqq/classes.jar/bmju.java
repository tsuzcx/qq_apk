  ...
  implements bhgu, bhjk
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bmjv(this);
  private bhjj jdField_a_of_type_Bhjj;
  private bmjw jdField_a_of_type_Bmjw;
  ...
  public bmju(Context paramContext, bmjw parambmjw)
  {
    this.jdField_a_of_type_Int = 360000;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_Bmjw = parambmjw;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (this.jdField_a_of_type_Bhjj != null) {
      return;
    }
    ...
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Bhjj = new bhjj(paramString, localHandler, i);
      this.jdField_a_of_type_Bhjj.a(BaseApplication.getContext());
  ...
  {
    a();
    if (this.jdField_a_of_type_Bmjw == null) {
      return;
    }
    if (this.jdField_b_of_type_Int > 0)
    {
      this.jdField_a_of_type_Bmjw.b(this.jdField_b_of_type_Int, paramString);
      this.jdField_b_of_type_Int = 0;
      return;
    }
    this.jdField_a_of_type_Bmjw.a(3, this.e);
  }
  ...
  public void a(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Bmjw != null) && (!TextUtils.isEmpty(str1)))
    {
      this.jdField_a_of_type_Bmjw.a(1, paramString);
      c(str1);
      return;
    }
  ...
  {
    bahi.b(paramString);
    this.jdField_a_of_type_Bmjw.a(paramString, paramDouble);
  }
  
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    bahi.a(paramString1);
    this.jdField_a_of_type_Bmjw.c();
  }
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        QQToast.a(BaseApplication.getContext(), 2131718343, 0).a();
        return;
      }
    }
    QQToast.a(BaseApplication.getContext(), 2131694317, 0).a();
  }
