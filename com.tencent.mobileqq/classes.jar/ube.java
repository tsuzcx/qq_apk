  ...
  extends BusinessHandler
{
  ...
  public ube(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(long paramLong, String paramString1, String paramString2, int paramInt1, int paramInt2, ubg paramubg)
  {
    ThreadManagerV2.executeOnSubThread(new BarrageHandler.1(this, paramLong, paramString1, paramString2, paramInt1, paramubg, paramInt2));
  }
  
  public void a(long paramLong, String paramString1, String paramString2, int paramInt1, ubg paramubg, int paramInt2)
  {
    try
    {
      if (QLog.isColorLevel()) {
      ...
      if (paramubg != null)
      {
        if (!TextUtils.isEmpty(paramubg.jdField_a_of_type_JavaLangString)) {
          localReqBody.bytes_cookie.set(ByteStringMicro.copyFromUtf8(paramubg.jdField_a_of_type_JavaLangString));
        }
        if (!TextUtils.isEmpty(paramubg.b)) {
          localReqBody.bytes_common_data.set(ByteStringMicro.copyFromUtf8(paramubg.b));
        }
      }
  ...
  public void a(long paramLong, String paramString1, String paramString2, ubg paramubg)
  {
    a(paramLong, paramString1, paramString2, 0, 0, paramubg);
  }
