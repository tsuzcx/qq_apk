...
public class ube
{
  ...
  public static int b;
  public static final Map<Long, Map<Long, ubj>> b;
  ...
  public static String a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("channel_id", pfk.b());
  ...
  {
    if ((pil.a((int)paramLong)) || (bmqa.a(paramLong))) {
      return "0X8009CCB";
    }
    if (a(paramLong)) {
      return "0X8009356";
  ...
  public static String a(Context paramContext, long paramLong1, long paramLong2, int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3, String paramString3)
  {
    try
    {
      ...
      for (;;)
      {
        if (pil.c(paramInt2))
        {
          paramLong1 = ((Long)bmqa.a("readinjoy_daily_article_first_exposure_" + paramLong1, Long.valueOf(0L))).longValue();
          if (paramLong1 != 0L) {
            localJSONObject.put("daily_article_first_timestamp", paramLong1 + "");
          }
        }
        och.a(localJSONObject);
        return localJSONObject.toString();
  ...
  public static Map<Long, ubj> a(int paramInt)
  {
  ...
  public static Map<Long, ubj> a(long paramLong)
  {
  ...
  public static JSONObject a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    try
    {
      ...
      if ((paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha != null)) {}
      for (long l = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha.jdField_a_of_type_Long;; l = 0L)
      {
  ...
  public static phi a(TemplateBean paramTemplateBean, String paramString)
  {
    ...
    if (paramTemplateBean != null)
    {
      ...
      if ((paramTemplateBean != null) && (paramTemplateBean.entrySet() != null))
      {
        ...
        while ((paramTemplateBean != null) && (paramTemplateBean.hasNext()))
        {
          ...
          localphi.b((String)paramString.getKey(), paramString.getValue().toString());
        }
      }
    }
    return localphi;
  ...
  public static void a()
  {
    ...
    localAttributeList.att_value.set(pha.d + "");
    localArrayList.add(localAttributeList);
    tzo.a(10, localArrayList);
    if (QLog.isColorLevel()) {
      QLog.d("ReadinjoyReportUtils", 2, "reportKandianDelete  , foldStatus :  " + pha.d);
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2, long paramLong, HashMap<String, Object> paramHashMap)
  {
    ...
    if (paramHashMap != null)
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject))) {
          localphi.b(str, (String)localObject);
        }
      }
    }
    paramHashMap = localphi.a();
    ...
    oat.a(null, "", "0X800ACB9", "0X800ACB9", paramInt2, 0, String.valueOf(paramInt1), String.valueOf(paramLong), "", paramHashMap, false);
  }
  ...
  {
    if ((paramInt == 1008) && (anhk.aR.equals(paramString1)))
    {
      if (!bgjw.a(paramString2, paramResources.getString(alcd.a[3]))) {
        break label57;
      }
      oat.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
    }
    label57:
    while (!bgjw.a(paramString2, paramResources.getString(alcd.a[2]))) {
      return;
    }
    oat.a(null, null, "0X8009885", "0X8009885", 0, 0, "", "", "", a(), false);
  }
  
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if ((paramInt == 1008) && (anhk.aR.equals(paramString)))
    {
      if (paramBoolean) {
        oat.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    pmy.a().jdField_a_of_type_Pnn.a(paramBoolean1);
    long l;
    if (paramBoolean1)
    {
      pmy.n();
      ...
      if (paramInt1 == 0)
      {
        ...
        if (pha.d != 1)
        {
          ...
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(pha.a.b);
          localArrayList.add(localObject);
          localObject = new oidb_cmd0x80a.AttributeList();
          ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
          ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("AlgorithmID");
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(pha.a.jdField_a_of_type_JavaLangString);
          localArrayList.add(localObject);
          paramLong = NetConnInfoCenter.getServerTime();
          l = pha.a.jdField_a_of_type_Long;
          localObject = new oidb_cmd0x80a.AttributeList();
      ...
      label483:
      for (paramLong = System.currentTimeMillis() - pmy.a().d();; paramLong = System.currentTimeMillis() - pmy.jdField_a_of_type_Long)
      {
        ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(paramLong + "");
        localArrayList.add(localObject);
        paramInt2 = 4;
        tzo.a(paramInt2, localArrayList);
        if (QLog.isColorLevel()) {
    ...
    ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(String.valueOf(pmy.a(paramLong)));
    localArrayList.add(localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
    ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
    ...
    localArrayList.add(localObject);
    if (pha.a.jdField_a_of_type_Int != 1)
    {
      localObject = new oidb_cmd0x80a.AttributeList();
      ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(5);
      ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("StrategyID");
    ...
    if (((pnn)localObject).jdField_a_of_type_Long > 0L)
    {
      paramLong = ((pnn)localObject).jdField_a_of_type_Long - ((pnn)localObject).d;
      label971:
      ...
      if (((pnn)localObject).c <= 0L) {
        break label1206;
      }
    }
    label1206:
    for (paramLong = ((pnn)localObject).e - ((pnn)localObject).c;; paramLong = 0L)
    {
      localAttributeList.att_value.set(paramLong + "");
      localArrayList.add(localAttributeList);
      localAttributeList = new oidb_cmd0x80a.AttributeList();
      ...
      localAttributeList.att_value.set(((pnn)localObject).a());
      localArrayList.add(localAttributeList);
      localAttributeList = new oidb_cmd0x80a.AttributeList();
      localAttributeList.att_id.set(11);
      localAttributeList.att_name.set("scrollInfoList");
      localAttributeList.att_value.set(((pnn)localObject).b());
      localArrayList.add(localAttributeList);
      paramInt2 = 5;
      break;
      paramLong = 0L;
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    if ((snh.g(paramArticleInfo)) || (snh.i(paramArticleInfo)) || (snh.j(paramArticleInfo)) || (snh.k(paramArticleInfo)))
    {
      ...
      if (paramArticleInfo.mSocialFeedInfo != null)
      {
        ...
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rhs != null) {
          localObject1 = Long.toString(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rhs.jdField_a_of_type_Long);
        }
      }
    }
    for (;;)
    {
      ...
      int i = pha.b(paramArticleInfo);
      localObject2 = new JSONObject();
      try
      {
        pha.a((JSONObject)localObject2, paramArticleInfo);
        ((JSONObject)localObject2).put("touin", localObject1);
        ((JSONObject)localObject2).put("entry_mode", String.valueOf(i));
        oat.a(null, "", "0X8009846", "0X8009846", 0, 0, String.valueOf(l1), String.valueOf(l2), String.valueOf(l3), ((JSONObject)localObject2).toString(), false);
        return;
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    try
    {
      if (qhe.a(paramArticleInfo)) {}
      for (paramInt = 2;; paramInt = 1)
      {
        localJSONObject.put("click_type", paramInt);
        oat.a(null, null, "0X800B1A7", "0X800B1A7", 0, 0, "", "", "", localJSONObject.toString(), false);
        return;
      }
      return;
    }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.bindShowFollowButton)) {
      oat.a(null, null, "0X800B1A6", "0X800B1A6", 0, 0, "", "", "", a(paramBaseArticleInfo, paramInt).toString(), false);
    }
  }
  
  public static void a(BaseArticleInfo paramBaseArticleInfo, long paramLong)
  {
    if (((Long)bmqa.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(0L))).longValue() == 0L) {
      bmqa.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(System.currentTimeMillis() / 1000L));
    }
    synchronized (jdField_b_of_type_JavaUtilMap)
    {
      Map localMap2 = a(paramBaseArticleInfo.mChannelID);
      ubj localubj = (ubj)localMap2.get(Long.valueOf(paramBaseArticleInfo.mArticleID));
      if (localubj != null)
      {
        long l = paramLong;
        if (localubj.jdField_a_of_type_Long > paramLong) {
          l = localubj.jdField_a_of_type_Long;
        }
        localubj.jdField_a_of_type_Long = l;
        return;
      }
      localubj = new ubj(pha.d());
      localubj.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo = paramBaseArticleInfo;
      localubj.jdField_a_of_type_Long = paramLong;
      localMap2.put(Long.valueOf(paramBaseArticleInfo.mArticleID), localubj);
    }
  }
  ...
  public static void a(TemplateBean paramTemplateBean, String paramString1, String paramString2)
  {
    ...
    {
      return;
      localphi = a(paramTemplateBean, paramString1);
      paramTemplateBean = a(paramTemplateBean, paramString1, paramString2);
    } while (paramTemplateBean == null);
    oat.a(null, "CliOper", "", "", paramTemplateBean, paramTemplateBean, 0, 0, "", "", "", localphi.a(), false);
  }
  
  public static void a(RecentItemChatMsgData paramRecentItemChatMsgData)
  {
    if (!jdField_a_of_type_Boolean) {}
    while ((paramRecentItemChatMsgData == null) || (paramRecentItemChatMsgData.mUser == null) || (!anhk.aQ.equals(paramRecentItemChatMsgData.mUser.uin))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          oat.a(null, paramQQAppInterface, (String)localObject, (String)localObject, 0, 0, "", "", "", localphi.a(), false);
          return;
        }
      }
  ...
  public static void a(String paramString)
  {
    ...
    {
      oat.a(null, null, "0X800978D", "0X800978D", 0, 0, "", "", "", a(), false);
      pmy.l();
    }
    while (!anhk.aR.equals(paramString)) {
      return;
    }
    oat.a(null, null, "0X8009886", "0X8009886", 0, 0, "", "", "", a(), false);
    pmy.m();
  }
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      Collections.sort(paramList, new ubh());
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    Collections.sort(paramList, new ubg());
  ...
  public static void a(Map<Long, ubj> paramMap)
  {
    a(paramMap, false);
  }
  
  public static void a(Map<Long, ubj> paramMap, boolean paramBoolean)
  {
    Iterator localIterator = paramMap.values().iterator();
    while (localIterator.hasNext())
    {
      ubj localubj = (ubj)localIterator.next();
      ArticleInfo localArticleInfo = (ArticleInfo)localubj.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo;
      if ((!pha.s(localArticleInfo)) || (!localArticleInfo.mNewPolymericInfo.jdField_a_of_type_Boolean))
      {
        String str1 = pha.d(localArticleInfo);
        paramMap = localArticleInfo.innerUniqueID;
        Object localObject = paramMap;
        if (pha.j(localArticleInfo))
        {
        ...
        String str2 = pha.f(localArticleInfo);
        if (((snh.g(localArticleInfo)) || (snh.i(localArticleInfo)) || (snh.j(localArticleInfo)) || (snh.k(localArticleInfo))) && (!snh.o(localArticleInfo))) {
          paramMap = String.valueOf(localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rhs.jdField_a_of_type_Long);
        }
        for (;;)
        {
          for (;;)
          {
            localObject = pha.a(localArticleInfo.mAlgorithmID, pha.a(localArticleInfo), (int)localArticleInfo.mChannelID, NetworkState.isWifiConn(), str1, (String)localObject, str2, 0, localubj.jdField_a_of_type_Int, localArticleInfo);
            str1 = a(localArticleInfo.mChannelID);
            try
            {
              ((JSONObject)localObject).put("exposure_time", "" + (float)localubj.jdField_a_of_type_Long / 1000.0F);
              if (pil.c((int)localArticleInfo.mChannelID)) {
                ((JSONObject)localObject).put("cmd", bmqa.h());
              }
              oat.a(null, "CliOper", "", paramMap, str1, str1, 0, 0, Long.toString(localArticleInfo.mFeedId), localArticleInfo.mArticleID + "", localArticleInfo.mStrategyId + "", ((JSONObject)localObject).toString(), false);
            }
          ...
          break;
          if ((pha.i(localArticleInfo)) && (localArticleInfo.mPolymericInfo.jdField_a_of_type_Int == 6)) {
            paramMap = localArticleInfo.mPolymericInfo.b + "";
          } else if (pha.l(localArticleInfo)) {
            paramMap = "";
          } else {
