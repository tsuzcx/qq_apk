...
public class qmx
{
  ...
  private static volatile qmx jdField_a_of_type_Qmx;
  private volatile boolean jdField_a_of_type_Boolean;
  private final String b = noe.a("4044") + "4044";
  private final String c = BaseApplicationImpl.getApplication().getFilesDir().getParent() + "/txlib/" + "readinjoy_pts_jsc";
  
  public static qmx a()
  {
    if (jdField_a_of_type_Qmx == null) {}
    try
    {
      if (jdField_a_of_type_Qmx == null) {
        jdField_a_of_type_Qmx = new qmx();
      }
      return jdField_a_of_type_Qmx;
    }
    finally {}
  }
  ...
  private boolean b()
  {
    ...
    boolean bool2 = qmz.a((String)localObject);
    jdField_a_of_type_JavaLangString = qmz.b((String)localObject);
