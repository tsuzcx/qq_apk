  ...
  implements qrq
{
  ...
  public qmx(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, qxb paramqxb, VideoFeedsPlayManager paramVideoFeedsPlayManager, ViewGroup paramViewGroup)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new qmy(this));
  ...
  private void i()
  {
    try
    {
      this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new qna(this));
      return;
    }
  ...
  public void a(AnchorData paramAnchorData)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
    {
      ...
      qol.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 100);
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager != null) && (bbev.h(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity))) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager.h(true);
      }
      this.jdField_a_of_type_Boolean = true;
      if (this.jdField_a_of_type_Qnb != null) {
        this.jdField_a_of_type_Qnb.a(true);
      }
      return;
    }
  }
  
  public void a(qnb paramqnb)
  {
    this.jdField_a_of_type_Qnb = paramqnb;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = (qol.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) - this.jdField_a_of_type_Int);
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(qrr.a());
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(2);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new qmz(this), this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  public void f()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Qnb != null) {
        this.jdField_a_of_type_Qnb.a(false);
      }
    }
  }
