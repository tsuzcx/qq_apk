  ...
  implements Handler.Callback, IEventReceiver
{
  ...
  public HashMap<String, bjct> b;
  public Handler c;
  public ArrayList<QIMFilterCategoryItem> c;
  public HashMap<String, bjby> c;
  public ArrayList<QIMFilterCategoryItem> d;
  public HashMap<String, bjda> d;
  ArrayList<bjce> e;
  public HashMap<String, ArrayList<bjcg>> e;
  ...
  public bjcb()
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bjcd(this));
    ...
    this.jdField_a_of_type_ArrayOfBjcf = new bjcf[5];
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfBjcf.length)
    {
      this.jdField_a_of_type_ArrayOfBjcf[i] = new bjcf(i);
      i += 1;
    }
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), new bjcc(this));
  ...
  {
    bjcq localbjcq = bkrf.a().a[paramInt];
    if (localbjcq != null) {
      localbjcq.a(paramActivity, paramInt);
    }
    bkrf.a().a(null, paramActivity, paramInt);
  }
  ...
  {
    bjck localbjck = (bjck)bjav.a(15);
    bjda localbjda = localbjck.a();
    if (localbjda != null)
    {
      localbjda.a(paramActivity, paramInt);
      if (paramInt == 0) {
        localbjck.a(null);
      }
    }
  ...
  public bjby a(FilterDesc paramFilterDesc)
  {
    bjby localbjby2 = (bjby)this.jdField_c_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
    bjby localbjby1 = localbjby2;
    if (localbjby2 == null)
    {
      localbjby1 = new bjby(paramFilterDesc);
      this.jdField_c_of_type_JavaUtilHashMap.put(paramFilterDesc.name, localbjby1);
    }
    return localbjby1;
  }
  
  public bjcf a(int paramInt)
  {
    return this.jdField_a_of_type_ArrayOfBjcf[paramInt];
  }
  
  public bjcq a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    bjcq localbjcq2 = (bjcq)this.jdField_a_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    Object localObject1 = localbjcq2;
    Object localObject2;
    Object localObject3;
    int j;
    int i;
    ...
    if (localbjcq2 == null)
    {
      localbjcq2 = new bjcq(paramQIMFilterCategoryItem);
      localObject1 = paramQIMFilterCategoryItem.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (String)((Iterator)localObject1).next();
        localObject3 = bkrf.a().a((String)localObject2);
        if (localObject3 != null) {
          localbjcq2.c(a((FilterDesc)localObject3));
        ...
        if (k < n)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              localObject3 = bjfh.a(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, (String)localObject4, (String)localObject1, f1, f2, f3);
              if (localObject3 != null)
              {
                ((bjbw)localObject3).a((SegmentKeeper)localObject2);
                localbjcq2.c((bjbw)localObject3);
                k += 1;
                break;
              }
              m = 1;
      ...
      if (paramQIMFilterCategoryItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = i;
            localObject3 = bjfh.a((String)localObject2);
            if (localObject3 != null)
            {
              k = i;
              localbjcq2.c((bjbw)localObject3);
      ...
      if (paramQIMFilterCategoryItem.c != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = j;
            localObject3 = bjfh.b((String)localObject2);
            if (localObject3 != null)
            {
              k = j;
              localbjcq2.c((bjbw)localObject3);
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            j = i;
            localObject2 = bjfh.a(str3, (List)localObject3, f1, f2, f3);
            if (localObject2 != null)
            {
              j = i;
              ((bjbw)localObject2).a((SegmentKeeper)localObject4);
              j = i;
              localbjcq2.c((bjbw)localObject2);
              k = i;
            }
            else
            {
          ...
          if (j == 0) {
            this.jdField_a_of_type_JavaUtilHashMap.put(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, localbjcq2);
          }
          bjcq localbjcq1 = localbjcq2;
          localbjcq1.jdField_a_of_type_JavaLangObject = paramQIMFilterCategoryItem;
          return localbjcq1;
          label1280:
          break;
          label1283:
  ...
  public bjcq a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    bjcb localbjcb = (bjcb)bjav.a(5);
    bjcq localbjcq = localbjcb.a(paramQIMFilterCategoryItem);
    localbjcq.b(paramActivity, paramBundle.getInt("capture_scene", -1));
    localbjcq.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    localbjcb.a(paramQIMFilterCategoryItem);
    switch (localbjcq.jdField_a_of_type_Int)
    {
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("QCombo", 2, "applyCombo state = " + localbjcq.jdField_a_of_type_Int);
      }
      return localbjcq;
      a(new bjcg(localbjcq, paramBundle, paramActivity));
      paramQIMFilterCategoryItem = Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, localbjcq);
  ...
  public bjcq a(String paramString)
  {
    Object localObject1 = null;
    bjcq localbjcq = null;
    Object localObject2 = this.jdField_a_of_type_Bkrg;
    if (localObject2 != null)
    {
      localObject2 = ((bkrg)localObject2).a.jdField_a_of_type_JavaUtilArrayList.iterator();
      localObject1 = localbjcq;
      if (((Iterator)localObject2).hasNext())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (TextUtils.equals(localQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, paramString)) {
            localbjcq = a(localQIMFilterCategoryItem);
          }
        }
      }
    }
  ...
  public bjct a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject2 = bkrf.a().a((String)localObject2);
      if (localObject2 != null) {
        localArrayList.add(localObject2);
      }
    }
    Object localObject2 = (bjct)this.jdField_b_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new bjct(paramQIMFilterCategoryItem);
      localObject2 = localArrayList.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((bjct)localObject1).c(a((FilterDesc)((Iterator)localObject2).next()));
      }
  ...
  public bjct a(String paramString)
  {
    Object localObject = this.jdField_a_of_type_Bkrg;
    if (localObject != null)
    {
      localObject = ((bkrg)localObject).a.jdField_c_of_type_JavaUtilArrayList.iterator();
  ...
  public bjda a(QIMTemplateItem paramQIMTemplateItem)
  {
    Object localObject2 = (bjda)this.jdField_d_of_type_JavaUtilHashMap.get(paramQIMTemplateItem.jdField_a_of_type_JavaLangString);
    ...
    if (localObject2 == null)
    {
      localObject1 = new bjda(paramQIMTemplateItem);
      if (QLog.isColorLevel()) {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = bkrf.a().a((String)localObject3);
        if (localObject4 != null) {
          ((bjda)localObject1).d(a((FilterDesc)localObject4));
        } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.jdField_a_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bjfh.a(paramQIMTemplateItem.jdField_a_of_type_JavaLangString, (String)localObject5, (String)localObject2, f1, f2, f3);
            if (localObject4 != null)
            {
              ((bjbw)localObject4).a((SegmentKeeper)localObject3);
              ((bjda)localObject1).d((bjbw)localObject4);
            }
            else if (QLog.isColorLevel())
            {
      ...
      if (paramQIMTemplateItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bjfh.a((String)localObject3);
            if (localObject4 != null) {
              ((bjda)localObject1).d((bjbw)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.c != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bjfh.b((String)localObject3);
            if (localObject4 != null) {
              ((bjda)localObject1).d((bjbw)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            localObject3 = bjfh.a(str3, (List)localObject4, f1, f2, f3);
            if (localObject3 != null)
            {
              ((bjbw)localObject3).a((SegmentKeeper)localObject5);
              ((bjda)localObject1).d((bjbw)localObject3);
            }
            else if (QLog.isColorLevel())
            {
          ...
          ((bjda)localObject1).jdField_a_of_type_JavaLangObject = paramQIMTemplateItem;
          return localObject1;
          label1086:
          i += 1;
          break;
  ...
  public bjda a(QIMTemplateItem paramQIMTemplateItem, Activity paramActivity, Bundle paramBundle)
  {
    paramQIMTemplateItem = ((bjcb)bjav.a(5)).a(paramQIMTemplateItem);
    ...
    for (;;)
    {
      ...
      a(new bjcg(paramQIMTemplateItem, paramBundle, paramActivity));
  ...
  public bkrh a()
  {
    if (this.jdField_a_of_type_Bkrg != null) {
      return this.jdField_a_of_type_Bkrg.a;
    }
    return null;
  }
  ...
  public QIMFilterCategoryItem a(int paramInt)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_Bkrg;
    if (localObject1 == null) {
      return null;
    }
    localObject1 = ((bkrg)localObject1).a;
    if (localObject1 == null) {
      return null;
    }
    localObject1 = ((bkrh)localObject1).jdField_a_of_type_JavaUtilArrayList;
    if (localObject1 != null)
    {
  ...
  public QIMFilterCategoryItem a(Activity paramActivity, bigp parambigp, int paramInt)
  {
    parambigp = (ComboProviderView)paramActivity.findViewById(2131363881);
    if (parambigp != null)
    {
      parambigp.b();
      parambigp = bjji.a().a(parambigp.g);
      if ((parambigp != null) && (parambigp.a() != null))
      {
        parambigp.a().a();
        parambigp.a().a();
        parambigp.a().a();
    ...
    parambigp = (StaticStickerProviderView)paramActivity.findViewById(2131363892);
    if (parambigp != null) {
      parambigp.b();
    }
    parambigp = (QIMFilterProviderView)paramActivity.findViewById(2131363883);
    if (parambigp != null) {
      parambigp.b();
    }
    paramActivity = (MusicProviderView)paramActivity.findViewById(2131363891);
    if (paramActivity != null) {
      paramActivity.b();
    }
    return bkrf.a().a(paramInt);
  }
  
  public QIMFilterCategoryItem a(bjcq parambjcq, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    ...
    if (parambjcq != null)
    {
      ...
      if ((parambjcq.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem))
      {
        localObject3 = (QIMFilterCategoryItem)parambjcq.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = parambjcq)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMFilterCategoryItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        parambjcq = (bjcq)localObject2;
        do
        {
          localObject2 = parambjcq;
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          {
            parambjcq = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambjcq.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambjcq.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambjcq;
              return localObject1;
              label176:
  ...
  public QIMFilterCategoryItem a(bjda parambjda, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = localObject3;
    ...
    {
      localObject1 = localObject3;
      if ((parambjda.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem))
      {
        localObject3 = (QIMTemplateItem)parambjda.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = parambjda)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMTemplateItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        parambjda = (bjda)localObject2;
        do
        {
          localObject2 = parambjda;
          if (!((Iterator)localObject3).hasNext()) {
            break;
          }
          localObject2 = (String)((Iterator)localObject3).next();
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          while (paramArrayList.hasNext())
          {
            parambjda = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambjda.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambjda.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambjda;
              return localObject1;
              label176:
              Iterator localIterator1 = paramArrayList.iterator();
              parambjda = null;
  ...
  {
    Object localObject = bkrf.a().a(paramInt);
    if (localObject != null)
    {
      localObject = a((QIMFilterCategoryItem)localObject);
      if ((localObject != null) && (((bjcq)localObject).jdField_a_of_type_Int == 1))
      {
        localObject = new Bundle();
        ((Bundle)localObject).putInt("capture_scene", paramInt);
        bjcq localbjcq = bkrf.a().a[paramInt];
        if (localbjcq != null) {
          a((QIMFilterCategoryItem)localbjcq.jdField_a_of_type_JavaLangObject, paramActivity, (Bundle)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    bjcf[] arrayOfbjcf = this.jdField_a_of_type_ArrayOfBjcf;
    int j = arrayOfbjcf.length;
    int i = 0;
    while (i < j)
    {
      arrayOfbjcf[i].c(paramActivity);
      i += 1;
    }
  }
  ...
  public void a(bjce parambjce)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_e_of_type_JavaUtilArrayList.contains(parambjce)) {
        this.jdField_e_of_type_JavaUtilArrayList.add(parambjce);
      }
      return;
    }
  }
  ...
  public void a(bjcg parambjcg)
  {
    ...
    {
      String str = parambjcg.jdField_a_of_type_Bjcj.b();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboSuccess captureSet " + parambjcj);
    }
    if ((parambjcj.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambjcj.jdField_a_of_type_JavaLangObject);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboFailed captureset " + parambjcj);
    }
    if ((parambjcj.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
  ...
  public void a(bjcq parambjcq)
  {
    ...
    while (localIterator.hasNext()) {
      ((bjce)localIterator.next()).a(parambjcq);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateSuccess templateSet " + parambjda);
    }
    if ((parambjda.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambjda.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, parambjda).sendToTarget();
      return;
    }
  }
  
  public void a(bjda parambjda, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateFailed templateSet " + parambjda + ", error " + paramInt);
    }
    if ((parambjda.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambjda.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, parambjda).sendToTarget();
      return;
    }
  }
  ...
  public void a(bkrg parambkrg)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (parambkrg != null)
      {
        this.jdField_a_of_type_Bkrg = parambkrg;
        this.jdField_a_of_type_DovComQqImCaptureDataComboLockManager.a(parambkrg);
        Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 9, parambkrg).sendToTarget();
      }
      a(1);
      return;
    }
  ...
  public void a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    ...
    QIMFilterCategoryItem localQIMFilterCategoryItem = bkrf.a().b(i);
    boolean bool1;
    boolean bool2;
    ...
    for (;;)
    {
      ...
      break label58;
      label171:
      paramQIMFilterCategoryItem = ((bjcb)bjav.a(5)).a(paramQIMFilterCategoryItem);
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        a(new bjcg(paramQIMFilterCategoryItem, paramBundle, paramActivity));
        ...
        else
        {
          ...
          continue;
          a(new bjcg(paramQIMFilterCategoryItem, paramBundle, paramActivity));
          bjld.a(paramQIMFilterCategoryItem).a();
  ...
  public boolean a()
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaUtilArrayList)
      {
        ...
        if (((bjcj)???).jdField_a_of_type_Int == 1)
        {
          int j = ((bjcj)???).a();
          if (j != ((bjcj)???).jdField_a_of_type_Int)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMFilterCategoryItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bjcj)???).jdField_b_of_type_Int);
            }
            ((bjcj)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bjcj)???).a());
          if (j != ((bjcj)???).jdField_b_of_type_Int)
          {
            ((bjcj)???).jdField_b_of_type_Int = j;
            if (QLog.isColorLevel()) {
              QLog.i("QCombo", 2, "buildComboBatch progress: " + j + ", progress: " + ((bjcj)???).jdField_b_of_type_Int);
            }
          }
          bool = true;
          i -= 1;
      ...
      if (((bjcj)???).jdField_a_of_type_Int == 2)
      {
        ((bjcj)???).a();
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bjcj)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bjcj)???).jdField_a_of_type_Int == 3)
      {
        ((bjcj)???).a();
        ((bjcj)???).jdField_b_of_type_Int = 10000;
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        bjld.a(???).b();
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bjcj)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label470:
  ...
  public boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      label411:
      int j;
      if ((paramMessage.obj instanceof bjct))
      {
        paramMessage = (bjct)paramMessage.obj;
        if (i == 0)
        {
        ...
        else
        {
          for (;;)
          {
            ...
            i = ((bjcg)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
            ??? = bkrf.a().b(i);
            if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_Boolean))
            {
              ...
              ((bigy)bjav.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
              ??? = (Activity)((bjcg)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get();
              if (??? != null)
              {
                ...
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bjce)((Iterator)???).next()).a(paramMessage, true, 0, ((bjcg)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
                bjld.a(paramMessage).c();
                break;
              }
            }
          }
          this.jdField_a_of_type_Bjct = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject2).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (bjcg)((Iterator)localObject2).next();
          j = ((bjcg)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = bkrf.a().b(j);
          if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)))
          {
            ...
            ((bigy)bjav.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
            if ((Activity)((bjcg)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get() != null) {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ??? = this.jdField_e_of_type_JavaUtilArrayList.iterator();
                if (((Iterator)???).hasNext()) {
                  ((bjce)((Iterator)???).next()).a(paramMessage, false, i, ((bjcg)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
              }
            }
            bcql.a(BaseApplicationImpl.sApplication, ajya.a(2131701354), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bjcq))
      {
        paramMessage = (bjcq)paramMessage.obj;
        if (i == 0)
        {
          bjld.a(paramMessage).b();
          localObject1 = (QIMFilterCategoryItem)paramMessage.jdField_a_of_type_JavaLangObject;
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            if (??? != null)
            {
              ...
              if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
              {
                ...
                ((bigy)bjav.a(13)).b(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString);
                b((Activity)???, i);
                if (!bjby.a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
          ...
          label982:
          this.jdField_a_of_type_Bjcq = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
          {
            ...
            if (??? != null)
            {
              ...
              ??? = (bjcb)bjav.a(5);
              ??? = ((bjcb)???).jdField_a_of_type_Bjcq;
              if (??? != null) {
                ((bjcb)???).a((QIMFilterCategoryItem)((bjcq)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((bjcg)localObject3).jdField_a_of_type_AndroidOsBundle);
              }
            }
            bcql.a(BaseApplicationImpl.sApplication, ajya.a(2131701356), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bjda))
      {
        localObject1 = (bjck)bjav.a(15);
        paramMessage = (bjda)paramMessage.obj;
        if (i == 0)
        {
          bjld.a(paramMessage).b();
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            ??? = (bjcg)((Iterator)localObject3).next();
            ??? = (Activity)((bjcg)???).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (??? != null)
            {
              i = ((bjcg)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
              ??? = ((bjck)localObject1).a(i);
              if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
              {
                ...
                a((Activity)???, i);
                if (!((bjck)localObject1).a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bjce)((Iterator)???).next()).a(paramMessage, true, 0, ((bjcg)???).jdField_a_of_type_AndroidOsBundle);
                }
                bjld.a(paramMessage).c();
                break;
              }
          ...
          label1590:
          ((bjck)localObject1).a(paramMessage);
          continue;
        }
        localObject3 = ((ArrayList)???).iterator();
        ...
        {
          ??? = (bjcg)((Iterator)localObject3).next();
          j = ((bjcg)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = ((bjck)localObject1).a(j);
          if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
            ...
            if (??? != null)
            {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ...
                if (((Iterator)localObject7).hasNext()) {
                  ((bjce)((Iterator)localObject7).next()).a(paramMessage, false, i, ((bjcg)???).jdField_a_of_type_AndroidOsBundle);
                }
              }
              ??? = ((bjck)localObject1).a();
              Object localObject7 = (bjcb)bjav.a(5);
              if (??? != null) {
                ((bjcb)localObject7).a((QIMTemplateItem)((bjda)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((bjcg)???).jdField_a_of_type_AndroidOsBundle);
              }
            }
            bcql.a(BaseApplicationImpl.sApplication, ajya.a(2131701355), 0).a();
          }
        }
        paramMessage = (bkrg)paramMessage.obj;
        try
        {
          localObject1 = this.jdField_e_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext()) {
            ((bjce)((Iterator)localObject1).next()).a(paramMessage);
          }
        }
        finally {}
      }
  ...
  public void b(bjce parambjce)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      this.jdField_e_of_type_JavaUtilArrayList.remove(parambjce);
      return;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadBegin combo " + parambjcj);
    }
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambjcj.jdField_a_of_type_JavaLangObject);
  ...
  public void b(bjda parambjda)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadTemplateBegin templateSet " + parambjda);
    }
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambjda.jdField_a_of_type_JavaLangObject);
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilArrayList)
      {
        ...
        if (((bjcj)???).jdField_a_of_type_Int == 1)
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMTemplateItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bjcj)???).jdField_b_of_type_Int);
            }
            ((bjcj)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bjcj)???).a());
      ...
      if (((bjcj)???).jdField_a_of_type_Int == 2)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bjcj)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bjcj)???).jdField_a_of_type_Int == 3)
      {
        ...
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bjcj)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label458:
  ...
  public void c()
  {
    bkrf.a().a(BaseApplicationImpl.getContext(), null, false);
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Tbk.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Tbk.b);
  }
  ...
  public void e()
  {
    bkrg localbkrg = this.jdField_a_of_type_Bkrg;
    if (QLog.isColorLevel()) {
      QLog.d("QCombo", 2, "randomliseData " + localbkrg);
    }
    if (localbkrg != null)
    {
      localbkrg.a();
  ...
  public void f()
  {
    a().notifyObservers(bjch.class, 971, true, null);
  }
