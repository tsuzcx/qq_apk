  ...
  extends afrj
{
  ...
  public afpq(Context paramContext, beez parambeez, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      MessageForText localMessageForText = awbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localTroopLinkElement.uin, "", 0, (byte)1, (byte)0, (short)0, localTroopLinkElement.description());
      localMessageForText.msgData = ayjf.a(localTroopLinkElement);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131493645, null);
    ...
    for (;;)
    {
      try
      {
        localObject1 = ayjf.a(((MessageRecord)localObject1).msgData);
        if (localObject1 != null)
        {
          ...
          localObject2 = localafss.a(localTroopLinkElement.title, -11353092);
          ...
          localObject1 = String.format(ajjy.a(2131640323), new Object[] { localObject2, localObject1 });
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(localafss.a((String)localObject1, -11353092));
          if (!TextUtils.isEmpty(localTroopLinkElement.iconUrl))
          {
            afpl.a(paramViewGroup.jdField_a_of_type_AndroidWidgetImageView, localTroopLinkElement.iconUrl);
            return paramView;
            paramViewGroup = (afrk)paramView.getTag();
            break;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849110));
          return paramView;
        }
      }
