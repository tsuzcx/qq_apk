      ...
      if ((??? != null) && (???.length > 0) && (!this.a.jdField_c_of_type_Boolean))
      {
        ...
        if (i < j) {
          try
          {
            ...
            {
              localObject5 = new aohz();
              ((aohz)localObject5).jdField_a_of_type_Boolean = true;
              ((aohz)localObject5).jdField_b_of_type_Int = this.a.jdField_f_of_type_Int;
              localObject6 = this.a;
              ((aohw)localObject6).jdField_f_of_type_Int += 1;
              ((aohz)localObject5).jdField_a_of_type_ComTencentYTFaceModelFaceStatus = ???[i];
              this.a.jdField_b_of_type_JavaUtilList.add(localObject5);
              localObject3[i] = ???[i].xys;
              if (QLog.isColorLevel()) {
                QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_DETECT_AND_RECOVER_FACE  add a tempFace ,faceInfo.faceID = " + ((aohz)localObject5).jdField_b_of_type_Int);
              }
            }
    ...
    case 3: 
      ...
      synchronized (this.a.jdField_a_of_type_JavaLangObject)
      {
        ...
        do
        {
          ...
          localObject4 = (aohz)((Iterator)localObject3).next();
          if (!((aohz)localObject4).jdField_a_of_type_Boolean) {
            break label1284;
          }
          if ((QLog.isColorLevel()) && (aohw.jdField_a_of_type_Boolean)) {
          ...
          l2 = SystemClock.uptimeMillis();
          i = this.a.jdField_a_of_type_ComTencentYTFaceClusterFaceCluster.trackSingleFace2((byte[])localObject2, this.a.jdField_a_of_type_Int, this.a.jdField_b_of_type_Int, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus, this.a.jdField_c_of_type_Int);
          l2 = SystemClock.uptimeMillis() - l2;
          if ((QLog.isColorLevel()) && (aohw.jdField_a_of_type_Boolean))
          {
          ...
          if (QLog.isColorLevel()) {
            QLog.i("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Lost realFace  faceInfo.lostCount = " + ((aohz)localObject4).jdField_c_of_type_Int);
          }
          ((aohz)localObject4).jdField_c_of_type_Int += 1;
        } while (((aohz)localObject4).jdField_c_of_type_Int <= 0);
        ((aohz)localObject4).jdField_a_of_type_Boolean = false;
        ((aohz)localObject4).jdField_c_of_type_Int = 0;
        localObject4 = this.a;
        ((aohw)localObject4).d += 1;
      }
      ((aohz)localObject4).jdField_c_of_type_Int = 0;
      if ((QLog.isColorLevel()) && (aohw.jdField_a_of_type_Boolean)) {
        QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Track realFace success,update");
      }
      localObject5 = new aodj();
      ((aodj)localObject5).jdField_a_of_type_ArrayOfFloat = ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys;
      ((aodj)localObject5).jdField_a_of_type_JavaLangString = ((aohz)localObject4).jdField_a_of_type_JavaLangString;
      ((aodj)localObject5).jdField_a_of_type_AndroidGraphicsRect = new Rect(((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x + ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.width, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y + ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.height);
      ((aodj)localObject5).jdField_a_of_type_AndroidGraphicsRectF = aodj.a(((aodj)localObject5).jdField_a_of_type_AndroidGraphicsRect, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys);
      ((aodj)localObject5).jdField_a_of_type_Int = ((aohz)localObject4).jdField_b_of_type_Int;
      ((aodj)localObject5).jdField_c_of_type_JavaLangString = ((aohz)localObject4).jdField_b_of_type_JavaLangString;
      ((aodj)localObject5).jdField_b_of_type_JavaLangString = ((aohz)localObject4).jdField_c_of_type_JavaLangString;
      ((aodj)localObject5).g = ((aohz)localObject4).f;
      if (((aohz)localObject4).jdField_a_of_type_Int != 2) {}
      break;
    }
    for (boolean bool = true;; bool = false)
    {
      ((aodj)localObject5).jdField_b_of_type_Boolean = bool;
      if (((aodj)localObject5).jdField_b_of_type_Boolean)
      {
        ((aodj)localObject5).jdField_c_of_type_Boolean = this.a.a(((aodj)localObject5).jdField_b_of_type_JavaLangString);
        if (((aodj)localObject5).jdField_c_of_type_Boolean)
        {
          localObject6 = this.a.a(((aodj)localObject5).jdField_b_of_type_JavaLangString);
          if (localObject6 != null)
          {
            ((aodj)localObject5).h = ((ARScanStarFaceActInfo)localObject6).f;
            ((aodj)localObject5).f = ((ARScanStarFaceActInfo)localObject6).jdField_e_of_type_JavaLangString;
          }
        }
        ((aodj)localObject5).d = ((aohz)localObject4).jdField_e_of_type_JavaLangString;
        ((aodj)localObject5).jdField_e_of_type_JavaLangString = ((aohz)localObject4).d;
      }
      ((aodj)localObject5).jdField_a_of_type_Float = ((aohz)localObject4).jdField_a_of_type_Float;
      ...
      if (aohw.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
      ...
      aohw.jdField_a_of_type_AndroidOsHandler.sendMessage((Message)localObject4);
      break label726;
      label1404:
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (((aohz)localObject4).jdField_a_of_type_Boolean)
        {
          ...
          if (i != 0)
          {
            ...
            if ((((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus != null) && (((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.nativeFaceAlignmentPtr != 0L)) {
              FaceCluster.getInstance().releaseNativeFaceStatus(((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus);
            }
          }
          else
          {
            if ((QLog.isColorLevel()) && (aohw.jdField_a_of_type_Boolean)) {
              QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Track tmpFace success,update ,faceInfo.faceID = " + ((aohz)localObject4).jdField_b_of_type_Int);
            }
            localObject5 = new aodj();
            ((aodj)localObject5).jdField_a_of_type_ArrayOfFloat = ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys;
            ((aodj)localObject5).jdField_a_of_type_JavaLangString = ((aohz)localObject4).jdField_a_of_type_JavaLangString;
            ...
            ((aodj)localObject5).jdField_a_of_type_AndroidGraphicsRect = new Rect(((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x + ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.width, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y + ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.height);
            ((aodj)localObject5).jdField_a_of_type_AndroidGraphicsRectF = aodj.a(((aodj)localObject5).jdField_a_of_type_AndroidGraphicsRect, ((aohz)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys);
            ((aodj)localObject5).jdField_e_of_type_Boolean = true;
            paramMessage.add(localObject5);
          }
        }
      ...
      l2 = System.currentTimeMillis();
      if ((!this.a.jdField_c_of_type_Boolean) && (this.a.jdField_a_of_type_Aohy != null))
      {
        ??? = new aoia();
        ((aoia)???).jdField_a_of_type_JavaUtilArrayList = paramMessage;
        ((aoia)???).jdField_a_of_type_Long = this.a.jdField_b_of_type_Long;
        this.a.jdField_a_of_type_Aohy.a((aoia)???);
