...
public class une
  extends QQUIEventReceiver<StoryPickerFragment, tjj>
{
  public une(@NonNull StoryPickerFragment paramStoryPickerFragment)
  {
    super(paramStoryPickerFragment);
  }
  
  public void a(@NonNull StoryPickerFragment paramStoryPickerFragment, @NonNull tjj paramtjj)
  {
    boolean bool1 = false;
    if (!TextUtils.equals(paramStoryPickerFragment.jdField_a_of_type_JavaLangString, paramtjj.jdField_a_of_type_JavaLangString)) {
      return;
    }
    boolean bool2 = paramtjj.jdField_a_of_type_ComTencentBizQqstoryBaseErrorMessage.isSuccess();
    Object localObject = new ArrayList(paramtjj.jdField_a_of_type_JavaUtilList.size());
    List localList = paramtjj.jdField_a_of_type_JavaUtilList;
    int i = 0;
    while (i < localList.size())
    {
      ...
      if (localVideoCollectionItem.collectionType == 1)
      {
        ...
        {
          uuc localuuc = (uuc)localVideoCollectionItem.collectionVideoUIItemList.get(j);
    ...
    if ((bool2) && (paramtjj.e))
    {
      ...
      paramStoryPickerFragment.jdField_a_of_type_Unn.a((List)localObject);
    }
    for (;;)
    {
      if (paramtjj.c) {
      ...
      if (!paramtjj.jdField_a_of_type_Boolean) {
        bool1 = true;
      }
      ((wdb)localObject).a(bool2, bool1);
      ...
      break;
      label347:
      paramStoryPickerFragment.jdField_a_of_type_Unn.b((List)localObject);
    }
  }
