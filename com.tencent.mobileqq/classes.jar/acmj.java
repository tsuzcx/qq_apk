  ...
  implements ackq
{
  ...
  public acmj(Context paramContext, GdtInterstitialParams paramGdtInterstitialParams, GdtInterstitialStatus paramGdtInterstitialStatus)
  {
  ...
  private static ArkView a(Context paramContext, GdtInterstitialParams paramGdtInterstitialParams, GdtInterstitialStatus paramGdtInterstitialStatus)
  {
    ...
    //   29: iconst_0
    //   30: istore_3
    //   31: invokestatic 36	acmb:a	()Lacmb;
    //   34: invokevirtual 39	acmb:a	()Laclt;
    //   37: astore 9
    //   39: iconst_1
    //   40: istore_3
    //   41: aload_0
    //   42: aload_1
    //   43: invokestatic 42	acmj:a	(Landroid/content/Context;Lcom/tencent/gdtad/api/interstitial/GdtInterstitialParams;)Ljava/lang/String;
    //   46: astore 10
    //   48: ldc 44
    //   50: ldc 46
    //   52: iconst_3
    ...
    //   57: iconst_0
    //   58: aload 9
    //   60: getfield 51	aclt:a	Ljava/lang/String;
    //   63: aastore
    //   64: dup
    //   65: iconst_1
    //   66: aload 9
    //   68: getfield 54	aclt:b	Ljava/lang/String;
    //   71: aastore
    //   72: dup
    //   73: iconst_2
    //   74: aload 9
    //   76: getfield 57	aclt:c	Ljava/lang/String;
    //   79: aastore
    //   80: invokestatic 63	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   83: invokestatic 68	acqy:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   169: aload_0
    //   170: aload 9
    //   172: getfield 51	aclt:a	Ljava/lang/String;
    //   175: aload 9
    //   177: getfield 54	aclt:b	Ljava/lang/String;
    //   180: aload 9
    //   182: getfield 57	aclt:c	Ljava/lang/String;
    //   185: aload 10
    //   187: aconst_null
    //   188: new 99	acmk
    //   191: dup
    ...
    //   197: aload 7
    //   199: aload_1
    //   200: invokespecial 102	acmk:<init>	(JLjava/lang/String;Ljava/lang/ref/WeakReference;Ljava/lang/ref/WeakReference;Lcom/tencent/gdtad/api/interstitial/GdtInterstitialParams;)V
    ...
    //   235: iload_3
    //   236: invokestatic 119	acrl:a	(Landroid/content/Context;Lcom/tencent/gdtad/api/interstitial/GdtInterstitialParams;Lcom/tencent/gdtad/api/interstitial/GdtInterstitialStatus;I)V
    //   239: aload_0
    //   240: areturn
    //   241: aconst_null
    //   242: astore_2
  ...
  private static String a(Context paramContext, GdtInterstitialParams paramGdtInterstitialParams)
  {
    ...
    {
      acqy.d("GdtInterstitialView", "getMetaData error");
      return null;
    }
    String str;
    ...
    for (;;)
    {
      ...
      {
        int i = acsj.a(paramContext, paramGdtInterstitialParams.b);
        int j = acsj.a(paramContext, paramGdtInterstitialParams.c);
        acqy.b("GdtInterstitialView", String.format("getMetaData width:%d height:%d ptWidth:%d ptHeight:%d", new Object[] { Integer.valueOf(paramGdtInterstitialParams.b), Integer.valueOf(paramGdtInterstitialParams.c), Integer.valueOf(i), Integer.valueOf(j) }));
        try
        {
          paramContext = new JSONObject();
          paramContext.put("screenType", str);
          paramGdtInterstitialParams = acqx.a(paramGdtInterstitialParams.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Options.a.info);
        ...
        {
          acqy.d("GdtInterstitialView", "getMetaData", paramContext);
          return null;
        }
      }
      str = null;
  ...
  {
    acqy.b("GdtInterstitialView", "pause");
    if (this.a != null) {
      this.a.onPause();
    }
  }
  ...
  {
    acqy.b("GdtInterstitialView", "resume");
    if (this.a != null) {
      this.a.onResume();
    }
  }
  ...
  {
    acqy.b("GdtInterstitialView", "destroy");
    if (this.a != null) {
      this.a.onDestroy();
    }
  }
