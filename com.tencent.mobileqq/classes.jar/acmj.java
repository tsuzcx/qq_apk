...
{
  public acmj(IntimateTitleSwitchView paramIntimateTitleSwitchView, String paramString) {}
  ...
  public void onCompositionLoaded(LottieComposition paramLottieComposition)
  {
    ...
    {
      return;
      int i = aciy.a(75.0F, this.jdField_a_of_type_ComTencentMobileqqActivityAioIntimateTitleSwitchView.getResources());
      int j = aciy.a(90.0F, this.jdField_a_of_type_ComTencentMobileqqActivityAioIntimateTitleSwitchView.getResources());
      Rect localRect = paramLottieComposition.getBounds();
      float f1 = i / localRect.width();
      float f2 = j / localRect.height();
      this.jdField_a_of_type_ComTencentMobileqqActivityAioIntimateTitleSwitchView.a.setImageAssetDelegate(new acmk(this));
