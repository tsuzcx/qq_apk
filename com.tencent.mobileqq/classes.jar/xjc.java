...
public class xjc
  extends RecyclerView.Adapter<xjf>
  implements Handler.Callback
{
  ...
  public xjf a(ViewGroup paramViewGroup, int paramInt)
  {
    return new xjf(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131562595, null));
  }
  ...
  {
    VSNetworkHelper.a().a(new BatchGetMusicInfoRequest(paramArrayList), new xje(this, paramBoolean));
  }
  ...
  public void a(xjb paramxjb)
  {
    this.jdField_a_of_type_Xjb = paramxjb;
  }
  
  public void a(xjf paramxjf, int paramInt)
  {
    if (a() == 0) {}
    int i;
    ...
    for (;;)
    {
      vzo.a(xjf.a(paramxjf), localVsMusicItemInfo.mAlbumUrl, vzo.a(paramxjf.itemView.getContext(), 60.0F), vzo.a(paramxjf.itemView.getContext(), 60.0F), vzo.a(paramxjf.itemView.getContext(), 30.0F), paramxjf.itemView.getContext().getResources().getDrawable(2130838555), null);
      paramxjf.itemView.setOnClickListener(new xjd(this, paramInt, localVsMusicItemInfo));
      return;
      i = a(paramInt);
      break;
      paramxjf.b(false);
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Xir = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
