...
public class bcus
{
  ...
  public bcus(AppInterface paramAppInterface)
  {
  ...
  private boolean h(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str = behh.b(paramToServiceMsg);
    try
    {
      byte[] arrayOfByte = str.getBytes("utf-8");
      if (arrayOfByte.length > 120) {}
      for (localModifyGroupInfoReq.strFingerMemo = nod.a(arrayOfByte, 120);; localModifyGroupInfoReq.strFingerMemo = str)
      {
        localModifyGroupInfoReq.strRichFingerMemo = nnr.a(paramToServiceMsg);
