  ...
  extends DynamicTextItem
{
  ...
  bomt jdField_b_of_type_Bomt;
  private String jdField_b_of_type_JavaLangString = "05/09";
  bomt jdField_c_of_type_Bomt;
  ...
  static
  {
    ...
    int n = bpdd.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - bowf.a - n * 2;
  }
  
  public bomm(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
    ...
    if (paramTypeface == null)
    {
      ...
      this.jdField_c_of_type_Bomt = new bomt(0);
      this.jdField_c_of_type_Bomt.a(new bome(-1, this.l, this.m));
      ...
      this.jdField_b_of_type_JavaLangString = bond.a();
      ...
      this.jdField_b_of_type_Bomt = new bomt(0);
      this.jdField_b_of_type_Bomt.a(new bome(-16777216, this.l, this.m));
      this.jdField_b_of_type_Bomt.a(this.jdField_b_of_type_JavaLangString, jdField_c_of_type_Int, this.i, localTextPaint);
      if (paramList != null) {
        break label541;
      }
    }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bomn(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_Bomt.a(new bome(-16777216, this.l, this.m));
      this.jdField_a_of_type_Bomt.a(paramString, jdField_c_of_type_Int, this.k, this.jdField_b_of_type_AndroidTextTextPaint);
      this.jdField_a_of_type_Float = Math.max(this.jdField_a_of_type_Bomt.a(), this.jdField_b_of_type_Bomt.a());
      this.jdField_a_of_type_Float = Math.max(this.jdField_c_of_type_Bomt.a(), this.jdField_a_of_type_Float);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Bomt.b() + this.g + this.jdField_b_of_type_Bomt.b() + this.h + this.jdField_c_of_type_Bomt.b());
      return;
    }
  ...
  {
    this.e = 0;
    this.jdField_a_of_type_Bomt.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_a_of_type_Bomt.b()));
    this.e += this.g;
    this.jdField_b_of_type_Bomt.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_b_of_type_Bomt.b()));
    this.e += this.h;
    this.jdField_c_of_type_Bomt.a(paramCanvas, 0, this.e);
    if (super.b(1))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.set(this.jdField_c_of_type_Bomt.a(2, this.jdField_c_of_type_Bomt.a()));
    ...
    this.e = ((int)(this.e + this.jdField_c_of_type_Bomt.b()));
    if (super.b(0))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.left = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.top = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.right = this.jdField_a_of_type_Bomt.a();
      this.jdField_a_of_type_AndroidGraphicsRectF.bottom = this.jdField_a_of_type_Bomt.b();
