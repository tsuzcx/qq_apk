  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      localObject = awzo.a(paramFromServiceMsg.getWupBuffer());
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        paramFromServiceMsg = (axbt)paramIntent.getManager(12);
        if (paramFromServiceMsg != null)
        {
          ...
          notifyObserver(null, 10000, true, paramFromServiceMsg, atzl.class);
          QLog.e("Q.lebatab.GameCenterServlet", 2, "[red dot] 1");
          if (paramIntent != null)
          {
            paramFromServiceMsg = new HashMap();
            axrl.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", true, this.b - this.a, 0L, paramFromServiceMsg, "");
          }
        }
      }
      else if (paramIntent != null)
      {
        paramFromServiceMsg = "|wufbuf: " + bbdm.a(paramFromServiceMsg.getWupBuffer());
        ...
        axrl.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", false, this.b - this.a, 0L, (HashMap)localObject, "");
      }
    }
    for (;;)
    {
      ...
      notifyObserver(null, 10000, false, paramIntent, atzl.class);
      return;
      if (paramIntent != null)
      {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if ((str != null) && (str.equals("gc_get_newandunreadmsg"))) {
      awzo.a(paramPacket, paramIntent);
    }
  ...
  public void service(Intent paramIntent)
  {
    ...
    if ((str != null) && ("gc_refresh_ui".equals(str)))
    {
      ...
      notifyObserver(null, 10000, true, paramIntent, atzl.class);
