...
public class auif
{
  ...
  public static Drawable a(Bitmap paramBitmap)
  {
    ...
    Bitmap localBitmap = bgmo.a(paramBitmap, paramBitmap.getWidth(), paramBitmap.getHeight());
  ...
  {
    Object localObject = null;
    Bitmap localBitmap = bgmo.a(paramBitmap, a(0, paramDouble));
    paramBitmap = localObject;
    if (localBitmap != null) {
      paramBitmap = new BitmapDrawable(BaseApplicationImpl.getApplication().getResources(), localBitmap);
    }
  ...
  {
    return a(bgjc.a(paramDrawable), paramDouble);
  }
  ...
  public static List<MessageRecord> a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        if (l != -1L)
        {
          MessageRecord localMessageRecord = paramQQAppInterface.a().b(((MessageForArkApp)localObject).frienduin, ((MessageForArkApp)localObject).istroop, l);
          ...
          else
          {
            ...
            localMessageForArkApp.saveExtInfoToExtStr(bbyw.w, Integer.toString(0));
            ...
            paramQQAppInterface.a().a(localMessageRecord.frienduin, localMessageRecord.istroop, localMessageForArkApp, localContentValues, new int[] { 2, 3 });
            ...
            paramQQAppInterface.a().a(localMessageRecord.frienduin, localMessageRecord.istroop, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForArkApp paramMessageForArkApp, int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramMessageForArkApp.getExtInfoFromExtStr(bbyw.y)))
    {
      QLog.d("SDK_SHARE.ForwardOptionUtils", 1, "updateFailFakeMsg fakeShareInfo empty，return");
      return;
    }
    paramMessageForArkApp.extraflag = 32768;
    paramMessageForArkApp.saveExtInfoToExtStr(bbyw.w, String.valueOf(paramInt));
    paramMessageForArkApp.saveExtInfoToExtStr(bbyw.x, paramString);
