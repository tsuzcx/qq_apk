...
class auif
  implements bmsc<WeiyunPB.LibInfoListGetMsgRsp>
{
  auif(auie paramauie, String paramString) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    auie.a(this.jdField_a_of_type_Auie).getFileManagerNotifyCenter().a(false, 31, new Object[] { Integer.valueOf(paramInt), paramString, this.jdField_a_of_type_JavaLangString });
  }
  ...
  public void a(WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localWeiYunFileInfo.jdField_b_of_type_JavaLangString = bmua.a(((WeiyunPB.FileItem)localObject2).pdir_key.get());
      ...
      localWeiYunFileInfo.i = bmua.a(((WeiyunPB.FileItem)localObject2).file_md5.get());
      localWeiYunFileInfo.j = bmua.a(((WeiyunPB.FileItem)localObject2).file_sha.get());
      if (!auie.a(this.jdField_a_of_type_Auie).containsKey(localWeiYunFileInfo.jdField_a_of_type_JavaLangString))
      {
        auie.a(this.jdField_a_of_type_Auie).put(localWeiYunFileInfo.jdField_a_of_type_JavaLangString, localWeiYunFileInfo);
        localArrayList.add(localWeiYunFileInfo);
      }
    }
    localObject1 = auie.a(this.jdField_a_of_type_Auie).getFileManagerNotifyCenter();
    Object localObject2 = this.jdField_a_of_type_JavaLangString;
    if (paramLibInfoListGetMsgRsp.finish_flag.get() == 1) {}
    for (boolean bool = true;; bool = false)
    {
      ((atlh)localObject1).a(true, 31, new Object[] { localObject2, Boolean.valueOf(bool), Integer.valueOf(paramLibInfoListGetMsgRsp.FileItem_items.size()), paramLibInfoListGetMsgRsp.server_version.get(), localArrayList, Integer.valueOf(auie.a(this.jdField_a_of_type_Auie)) });
      return;
    }
  }
}
