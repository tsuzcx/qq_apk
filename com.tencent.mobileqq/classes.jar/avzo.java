  ...
  extends MSFServlet
{
  ...
  {
    if (avpm.c.contains(paramString1)) {
      a(paramString2, paramInt, paramString3, paramString4, paramString5, paramLong, paramBusinessObserver);
    }
    do
    {
      return;
      NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), avzo.class);
  ...
  private static void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, long paramLong, BusinessObserver paramBusinessObserver)
  {
    ...
    bcvh.a(paramString1, paramLong, Base64.encodeToString(localAppConfRequest.toByteArray(), 11), new avzp(paramBusinessObserver, paramInt));
  }
