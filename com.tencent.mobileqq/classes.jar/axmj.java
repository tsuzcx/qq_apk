  ...
  extends axmi
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new axmk(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = axmj.class.getSimpleName();
  }
  
  public axmj(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      if (awia.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.app, this.c.getBytes(), paramString.getBytes(), this.d, this.jdField_a_of_type_MqqObserverWtloginObserver) != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717527, 1);
      }
      return;
    }
