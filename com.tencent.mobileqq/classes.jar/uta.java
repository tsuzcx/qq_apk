...
public class uta
{
  ...
  private uta(JSONObject paramJSONObject)
  {
    int j;
    try
    {
  ...
  public static uta a(@Nullable String paramString)
  {
    try
    {
  ...
  public static uta a(JSONObject paramJSONObject)
  {
    try
    {
      paramJSONObject = new uta(paramJSONObject);
