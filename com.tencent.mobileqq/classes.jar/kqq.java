  ...
  extends kqj
{
  ...
  public static void a(Context paramContext, Header[] paramArrayOfHeader, List<String> paramList, String paramString, kpy paramkpy)
  {
    paramList = new StringEntity(a(paramList, paramString), "UTF-8");
    a().a(paramContext, "http://api.microsofttranslator.com/V2/Http.svc/TranslateArray", paramArrayOfHeader, paramList, "application/xml", paramkpy);
  }
  
  public static void a(Context paramContext, Header[] paramArrayOfHeader, Map<String, String> paramMap, kqa paramkqa)
  {
    ...
    a().a(paramContext, "https://datamarket.accesscontrol.windows.net/v2/OAuth2-13", paramArrayOfHeader, paramMap, "application/x-www-form-urlencoded", paramkqa);
  }
}
