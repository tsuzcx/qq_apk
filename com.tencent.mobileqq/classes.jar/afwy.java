...
{
  private afxx jdField_a_of_type_Afxx;
  ...
  public afwy(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Afxx = new afxx(paramContext);
    this.jdField_a_of_type_Afxx.a(new afwz(this));
  }
  ...
  {
    this.jdField_a_of_type_JavaLangString = axlz.a(paramQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new afxb(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), paramQQAppInterface, new afxc(this));
      return;
    }
  ...
  public void a(afxj paramafxj)
  {
    ...
    if (axlz.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c))
    {
      a(localQQAppInterface);
      paramafxj.a(true);
      return;
    }
    axlz.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c, new afxa(this, paramafxj));
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Afxx != null)
    {
      this.jdField_a_of_type_Afxx.b();
      this.jdField_a_of_type_Afxx.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Afxx != null) && (this.jdField_a_of_type_Afxx.a())) {
      this.jdField_a_of_type_Afxx.d();
    }
