  ...
  implements aobv
{
  ...
  private static aiko jdField_a_of_type_Aiko = new aikm();
  private static SparseArrayCompat<aiko> jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat;
  ...
  public afwy(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Agwz = new agwz(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    for (long l = NetConnInfoCenter.getServerTime();; l = paramBaseChatPie.a())
    {
      ...
      this.jdField_a_of_type_Alqg = new alqg(this, paramQQAppInterface);
      this.jdField_a_of_type_Alqi = new alqi(paramBaseChatPie);
      this.jdField_a_of_type_Afwz = new afwz(this);
      return;
    }
  }
  ...
  private ChatMessage a(List<ChatMessage> paramList)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ChatAdapter1", 2, "create time: " + this.jdField_b_of_type_Long);
    }
    long l1 = 0L;
    int i = 0;
    if (i < paramList.size())
    {
      ...
      label85:
      Object localObject2;
      if ((bbzj.b(localChatMessage.msgtype)) && (localChatMessage.needShowTimeStamp()))
      {
        j = 1;
        if ((j == 0) || ((i != 0) && ((localChatMessage.time >= this.jdField_b_of_type_Long) || (localChatMessage.time - l1 <= 300L)) && ((localChatMessage.time < this.jdField_b_of_type_Long) || (localChatMessage.time - l1 <= 300L) || ((localObject1 != null) && (localChatMessage.time - localObject1.time <= 60L))) && ((!this.jdField_a_of_type_AndroidSupportV4UtilArraySet.contains(Long.valueOf(localChatMessage.uniseq))) || (l1 / 60L == localChatMessage.time / 60L)))) {
          break label473;
        }
        bool = true;
        label212:
  ...
  protected static void a(MessageForStructing paramMessageForStructing, afwr paramafwr, View paramView, boolean paramBoolean)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return;
    }
    e();
    aiko localaiko2 = (aiko)jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramMessageForStructing.structingMsg.mMsgServiceID);
    aiko localaiko1 = localaiko2;
    if (localaiko2 == null) {
      localaiko1 = jdField_a_of_type_Aiko;
    }
    localaiko1.a(paramMessageForStructing, paramafwr, paramView, paramBoolean);
  }
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (arpm.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(arpm.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_Agwz.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131364392);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((bbzj.a(localChatMessage1.msgtype)) || (acwh.j(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!bbzj.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!acwh.j(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    paramCharSequence = (anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))) {
      ((armt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(214)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramInt);
    }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Alqi.c();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Afwz.a != null)
    {
      alqt localalqt = this.jdField_a_of_type_Afwz.a.a();
      if ((localalqt == null) || (!localalqt.c())) {
        break label41;
      }
      localalqt.d();
    }
    label41:
    while (!this.jdField_a_of_type_Afwz.a.a()) {
      return;
    }
    this.jdField_a_of_type_Afwz.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return agwz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      bgso.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName());
      Object localObject2 = this.jdField_a_of_type_Agwz.a(localChatMessage, this);
      if (paramInt != 0)
      {
      ...
      localObject1 = ((afxi)localObject2).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Afwz);
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131364392, localChatMessage);
        if (((localObject2 instanceof afuu)) && ((localObject1 instanceof ajzh))) {
          localObject2 = (ajzh)localObject1;
        }
      }
      bgso.a("AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName(), null);
    }
  }
