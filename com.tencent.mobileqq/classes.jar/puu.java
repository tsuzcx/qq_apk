  ...
  implements DrawableUtil.DrawableHelper
{
  public Drawable getDrawable(Context paramContext, String paramString, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    ...
    if (paramString.startsWith("http"))
    {
      ...
      return URLDrawable.getDrawable(swu.a(paramString, 3), paramContext);
    }
  ...
  public Drawable getDrawableFromNet(Context paramContext, String paramString, Drawable paramDrawable1, Drawable paramDrawable2, int paramInt1, int paramInt2, DrawableUtil.DrawableCallBack paramDrawableCallBack)
  {
    if (paramString.startsWith("http"))
    {
      ...
      paramContext = URLDrawable.getDrawable(swu.a(paramString, 3), paramContext);
      paramContext.setCallback(new puv(this, paramDrawableCallBack, paramContext));
      paramContext.setURLDrawableListener(new puw(this, paramString, paramDrawableCallBack));
      paramContext.setDownloadListener(new pux(this, paramString, paramDrawableCallBack, paramContext));
