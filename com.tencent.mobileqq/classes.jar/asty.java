  ...
  implements Comparator<ChatMessage>
{
  ...
  private static asty jdField_a_of_type_Asty;
  public static final String a;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  public int a;
  private bfms<Integer> jdField_a_of_type_Bfms;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajsf.aW + "fight/pic_expire.png";
  }
  ...
  public static asty a()
  {
    if (jdField_a_of_type_Asty == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asty == null) {
        jdField_a_of_type_Asty = new asty();
      }
      return jdField_a_of_type_Asty;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bbdj.a(paramQQAppInterface.getApp(), 2130841059, jdField_a_of_type_JavaLangString);
      paramQQAppInterface = bbdj.c(jdField_a_of_type_JavaLangString);
      paramQQAppInterface = ayog.d("chatthumb:" + paramQQAppInterface);
      bbdj.d(jdField_a_of_type_JavaLangString, paramQQAppInterface);
    }
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    //   42: aload_0
    //   43: getfield 159	asty:jdField_a_of_type_Bfms	Lbfms;
    //   46: ifnull +40 -> 86
    //   49: aload_0
    //   50: getfield 159	asty:jdField_a_of_type_Bfms	Lbfms;
    //   53: lload_1
    //   54: iconst_0
    //   55: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   58: invokevirtual 170	bfms:a	(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    //   71: ifeq +18 -> 89
    //   74: aload_0
    //   75: getfield 159	asty:jdField_a_of_type_Bfms	Lbfms;
    //   78: lload_1
    //   79: iload_3
    //   80: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   83: invokevirtual 177	bfms:a	(JLjava/lang/Object;)V
    //   86: aload_0
    //   87: monitorexit
    //   88: return
    //   89: aload_0
    //   90: getfield 159	asty:jdField_a_of_type_Bfms	Lbfms;
    //   93: lload_1
    //   94: invokevirtual 180	bfms:b	(J)V
    //   97: goto -11 -> 86
    //   100: astore 4
    //   102: aload_0
    //   103: monitorexit
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, int paramInt2, @Nullable Bundle paramBundle)
  {
    ...
    localaywa.jdField_b_of_type_JavaLangString = paramQQAppInterface.getAccount();
    localaywa.c = paramString;
    localaywa.jdField_a_of_type_Int = paramInt1;
    localaywa.jdField_b_of_type_Int = 2;
    localaywa.jdField_a_of_type_Long = ((MessageRecord)paramArrayList.get(0)).uniseq;
    ...
    {
      localaywa.n = k;
      localaywa.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((MessageRecord)paramArrayList.get(0));
      localMessageForPtt.mInputContent = "";
      localaywa.jdField_a_of_type_Auoo = new asud(paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramInt2, this, null);
      localaywa.jdField_e_of_type_Boolean = false;
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, akav paramakav, ArrayList<MessageRecord> paramArrayList, boolean paramBoolean, int paramInt2)
  {
    ...
    paramakav = paramQQAppInterface.a().a().a(paramArrayList, paramHashMap, paramBoolean);
    if (paramakav == null)
    {
    ...
    do
    {
      ...
      if (paramInt2 == 0) {
        paramHashMap = new asuc(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
      }
      for (;;)
      {
        if (a(paramQQAppInterface, paramakav, paramQQAppInterface.getCurrentAccountUin(), paramString, paramString, paramInt1, paramMessageRecord.uniseq, 1035, paramHashMap))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (paramInt2 == 2)
          {
            paramHashMap = new asub(paramQQAppInterface, paramMessageRecord, paramString, paramInt1, paramArrayList, paramHashMap);
          }
          else if (paramInt2 == 5)
          {
            paramHashMap = new avpf(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
          }
          else
          {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<aunn> paramArrayList1, int paramInt2)
  {
    aunt localaunt = aunj.a(8, 7);
    localaunt.a(paramArrayList1);
    localaunt.a(new astz(this, paramInt2, paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramHashMap));
    aunj.a(localaunt, paramQQAppInterface);
  }
  
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<axdt> paramArrayList1, axeg paramaxeg, int paramInt2)
  {
    ...
    localaxeg.a(new asua(this, paramArrayList, paramMessageRecord, paramQQAppInterface, paramString, paramInt1, paramHashMap, paramInt2));
    axdo.a(localaxeg, paramQQAppInterface);
  }
  ...
  private boolean a(long paramLong)
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool1;
        if (((Integer)this.jdField_a_of_type_Bfms.a(paramLong, Integer.valueOf(0))).intValue() == 0)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  private boolean a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2, auoo paramauoo)
  {
    if (QLog.isColorLevel()) {
    ...
    localaywa.h = 0;
    localaywa.jdField_b_of_type_ArrayOfByte = paramArrayOfByte;
    localaywa.jdField_b_of_type_JavaLangString = paramString1;
    localaywa.c = paramString2;
    localaywa.d = paramString3;
    localaywa.jdField_a_of_type_Int = paramInt1;
    localaywa.jdField_a_of_type_Long = paramLong;
    localaywa.jdField_e_of_type_Int = paramInt2;
  ...
  public MessageForStructing a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, AbsStructMsg paramAbsStructMsg)
  {
    ...
    paramQQAppInterface = axaq.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, 0L, paramAbsStructMsg);
  ...
  public List<ChatMessage> a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramString != null) {
      akpy.a(paramString, paramInt, (List)localObject, paramQQAppInterface);
    }
    ...
    while (paramString.hasNext())
    {
      ...
      if ((localObject instanceof MessageForStructing))
      {
        ...
        if (localMessageForStructing.structingMsg == null) {
          localMessageForStructing.structingMsg = axuy.a(((MessageRecord)localObject).msgData);
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      k = bbjn.a(paramQQAppInterface.c(), "multimsg_config");
      if (k > 0) {
    ...
    catch (NumberFormatException paramQQAppInterface)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramQQAppInterface))
        {
          ...
          if (DeviceProfileManager.a(paramQQAppInterface, (Object[])localObject, new ajvg()) >= localObject.length)
          {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    ((awan)paramQQAppInterface.getManager(326)).a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramArrayList);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, String paramString2, AbsStructMsg paramAbsStructMsg, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      break;
      if (k != 0) {
        axqw.b(paramQQAppInterface, "CliOper", "", "", "0X800662C", "0X800662C", 0, 1, 0, "", "", "", "");
      }
      ArrayList localArrayList = new ArrayList();
      ...
      if (paramInt2 == 2)
      {
        ...
        k = awyl.jdField_a_of_type_Int;
        awyl.jdField_a_of_type_Int = k + 1;
        localObject1 = axaq.a(paramQQAppInterface, (String)localObject1, paramString1, (String)localObject1, 1040, k, paramAbsStructMsg);
        ((MessageRecord)localObject1).msg = aaod.a(localArrayList, (Map)localObject2);
      }
      for (;;)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject3 = bbjj.a(paramQQAppInterface, paramString1, paramInt1, paramAbsStructMsg);
        }
        if (localObject3 == null) {
          break;
        }
        ((MessageRecord)localObject3).isReMultiMsg = true;
        adgf.a().a(((MessageRecord)localObject3).uniseq, 0L, paramInt3);
        if (paramBoolean) {
        ...
        if ((paramInt2 == 0) || (paramInt2 == 2))
        {
          ...
          ((asue)localObject1).jdField_a_of_type_Int = 0;
          ((asue)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = ((SessionInfo)localObject4);
          ((asue)localObject1).jdField_a_of_type_JavaUtilList = localArrayList;
          ((asue)localObject1).jdField_a_of_type_JavaUtilMap = ((Map)localObject2);
          ((asue)localObject1).jdField_b_of_type_Int = paramInt2;
          ((asue)localObject1).jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = paramAbsStructMsg;
          ((asue)localObject1).jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = ((MessageForStructing)localObject3);
          paramQQAppInterface.a().e((asue)localObject1);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  public void a(QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean)
  {
    ...
    for (int k = 0;; k = 1)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "multiMsgReceive", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
    axrl.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "multiMsgReceive", paramBoolean, 0L, 0L, localHashMap, "");
  }
  ...
  public void a(MessageForStructing paramMessageForStructing, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.h != 0) && (aunq.a(paramQQAppInterface, paramMessageForStructing.istroop, paramMessageForStructing.frienduin) == 1));
  ...
  public void a(HashMap<String, String> paramHashMap, long paramLong, QQAppInterface paramQQAppInterface)
  {
    ...
    //   111: goto -81 -> 30
    //   114: aload 4
    //   116: invokevirtual 554	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lauko;
    //   119: invokevirtual 560	auko:createEntityManager	()Laukn;
    //   122: astore 4
    //   124: aload 4
    //   126: invokevirtual 961	aukn:a	()Laukp;
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 965	aukp:a	()V
    //   134: aload 5
    ...
    //   163: invokevirtual 968	aukn:b	(Laukm;)V
    //   166: goto -25 -> 141
    //   169: astore 5
    //   171: aload 5
    //   173: invokevirtual 971	java/lang/Exception:printStackTrace	()V
    //   176: aload_1
    //   177: invokevirtual 972	aukp:b	()V
    //   180: aload 4
    //   182: invokevirtual 973	aukn:a	()V
    //   185: return
    //   186: aload_1
    //   187: invokevirtual 975	aukp:c	()V
    //   190: aload_1
    //   191: invokevirtual 972	aukp:b	()V
    //   194: goto -14 -> 180
    //   197: astore 4
    //   199: aload_1
    //   200: invokevirtual 972	aukp:b	()V
    //   203: aload 4
    //   205: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  {
    axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8006628", "0X8006628", 0, 1, 0, "", "", "", "");
    return a(paramQQAppInterface, paramLong).size() > 0;
  }
  
  public boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, long paramLong, int paramInt2, aumy paramaumy)
  {
    ...
    localaywa.jdField_b_of_type_Int = 131078;
    localaywa.jdField_l_of_type_JavaLangString = paramString1;
    localaywa.jdField_b_of_type_JavaLangString = paramString2;
    localaywa.c = paramString3;
    localaywa.d = paramString4;
    localaywa.jdField_a_of_type_Int = paramInt1;
    localaywa.jdField_a_of_type_Long = paramLong;
    localaywa.jdField_e_of_type_Int = paramInt2;
  ...
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      Collections.sort(paramList, jdField_a_of_type_Asty);
    }
  }
  ...
  public boolean b(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
    {
      ...
      if (localIterator1.hasNext())
      {
        ...
        for (;;)
        {
          if ((paramQQAppInterface != null) && (!aywk.a(null, paramQQAppInterface, 65537)))
          {
            if (QLog.isColorLevel()) {
        ...
        for (paramQQAppInterface = (MessageForPic)paramQQAppInterface;; paramQQAppInterface = (QQAppInterface)localObject)
        {
          ...
          for (;;)
          {
            ...
            if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof StructMsgForImageShare)))
            {
              ...
              if ((localObject != null) && (((axwt)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic == null))
              {
                if (((axwt)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare == null) {
                  ((axwt)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare = ((StructMsgForImageShare)paramQQAppInterface);
                }
                ((axwt)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic = ((axwt)localObject).a();
                paramQQAppInterface = ((axwt)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
                break label99;
              }
            }
  ...
  public int c()
  {
    ...
    {
      break;
      m = asuf.a(localChatMessage);
      break label64;
      asuf.b("checkMap.size = %d,count= %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilHashMap.size()), Integer.valueOf(k) });
      return k;
    }
  }
}
