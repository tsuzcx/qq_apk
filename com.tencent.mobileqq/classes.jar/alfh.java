  ...
  implements alfd
{
  ...
  private alfb jdField_a_of_type_Alfb;
  ...
  public FloatBuffer a(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool2 = true;
    if ((this.jdField_a_of_type_ComHuaweiHiarARSession == null) || (this.jdField_a_of_type_Alfb == null))
    {
      ...
      if (this.jdField_a_of_type_ComHuaweiHiarARSession == null)
      {
        ...
        if (this.jdField_a_of_type_Alfb != null) {
          break label92;
        }
      }
      label92:
  ...
  {
    if (this.jdField_a_of_type_Alfb == null) {
      this.jdField_a_of_type_Alfb = new alfb(BaseApplicationImpl.getContext());
    }
    this.jdField_a_of_type_Alfb.a(paramInt1, paramInt2);
  ...
  public boolean a(Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_ComHuaweiHiarARSession == null)
    {
      if (!alff.b((Activity)paramContext)) {
        break label151;
      }
      try
      {
