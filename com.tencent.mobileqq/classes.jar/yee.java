...
{
  public yee(DeviceMsgSettingActivity paramDeviceMsgSettingActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBundle == null)
        {
          bdid.a().a(this.a.getString(2131694682));
          DeviceMsgSettingActivity.b(this.a);
          return;
        }
      }
      ...
      while (paramInt < paramBundle.length())
      {
        ...
        yeg localyeg = new yeg(this.a, null);
        localyeg.jdField_a_of_type_Int = localJSONObject.getInt("id");
        localyeg.jdField_a_of_type_JavaLangString = localJSONObject.getString("name");
        localyeg.b = localJSONObject.getInt("enable");
        this.a.jdField_a_of_type_JavaUtilArrayList.add(localyeg);
        paramInt += 1;
      }
    }
  }
