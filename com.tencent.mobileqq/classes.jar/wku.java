  ...
  implements wnq, woq
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = wku.class.getSimpleName();
  }
  
  public wku(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  private boolean a(long paramLong, CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      ...
      if (wit.a(paramStFeed.status.get())) {
        return false;
      }
    } while (!wit.a(paramStFeed.poster.attr.get()));
    return false;
  }
  ...
  private void k()
  {
    ...
    if ((a() instanceof SubscribeBaseFragment)) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.setShareClickListener(new wkv(this));
    }
  ...
  public wkm a(int paramInt)
  {
    boolean bool = true;
    wkm localwkm = new wkm();
    localwkm.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed = this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed;
    localwkm.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    localwkm.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare = this.jdField_b_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare;
    if (paramInt == 1) {}
    for (;;)
    {
      localwkm.jdField_a_of_type_Boolean = bool;
      localwkm.jdField_a_of_type_Int = paramInt;
      return localwkm;
      bool = false;
    }
  }
  ...
  public wso a()
  {
    return this.jdField_a_of_type_Wso;
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    b("share_key_subscribe_feeds_update", new wpf(paramStFeed));
    if ((a() instanceof SubscribeBaseFragment)) {
      ((SubscribeBaseFragment)a()).b(paramStFeed);
    }
    if (this.jdField_a_of_type_Wso != null) {
      this.jdField_a_of_type_Wso.a(paramStFeed.poster);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      b("share_key_subscribe_feeds_update", new wpf(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed));
      if (!this.c)
      {
        this.jdField_a_of_type_ComTencentBizSubscribeWidgetStatusView = a().a();
        paramBundle = wit.a() + File.separator + a(a()) + ".png";
      ...
      k();
      this.jdField_a_of_type_Wso = new wso(a());
      return;
    }
  ...
  protected void c()
  {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.a(a().getActivity(), this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, new wkw(this), this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo);
  ...
  public void c(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    if ((!wit.a(paramStFeed.poster.attr.get())) && (a() != null))
    {
      wtj.a().a(a(), "subscribe_freshman_interaction_guide", 5000, new wlb(this, paramStFeed));
      a().runOnUiThread(new DetailBaseAdapter.6(this));
      wtj.a().a(a(), "subscribe_freshman_share_guide", 10000, new wlc(this));
    }
  }
  ...
  public void e()
  {
    wsa.a().a((String)wim.b.get("follow_guide_pics"), 4000, new wkx(this), true);
  }
  
  public void f()
  {
    wsa.a().a((String)wim.b.get("praise_guide_pics"), 4000, new wkz(this), true);
  }
