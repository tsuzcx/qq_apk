  ...
  extends bmnh
{
  ...
  public bmnp(@NonNull bmnj parambmnj)
  {
    super(parambmnj);
  }
  ...
  public static void a(PublishVideoEntry paramPublishVideoEntry, int paramInt, String paramString, ArrayList<String> paramArrayList, List<String> paramList)
  {
    ...
    try
    {
      for (;;)
      {
        ...
        wxe.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionType:" + paramInt);
        wxe.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionUinList:" + paramArrayList.toString());
        wxe.b("Q.qqstory.publish.edit.EditVideoPermission", "atUinList:" + paramList.toString());
        ...
        if (!paramList.isEmpty())
        {
          ...
          while (paramArrayList.hasNext())
          {
            ...
            {
              wxe.e("Q.qqstory.publish.edit.EditVideoPermission", "PERMISSION_TYPE_ONLY_ME , can't format uin:%s", new Object[] { str });
            }
          }
          paramArrayList = (ArrayList<String>)localObject;
          paramInt = 2;
        ...
        else
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            {
              wxe.e("Q.qqstory.publish.edit.EditVideoPermission", "PERMISSION_TYPE_CAN_SEE , can't format uin:%s", new Object[] { str });
            }
          }
          paramInt = 2;
          continue;
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            {
              wxe.e("Q.qqstory.publish.edit.EditVideoPermission", "PERMISSION_TYPE_CANNOT_SEE , can't format uin:%s", new Object[] { str });
            }
          }
          paramInt = 3;
        }
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      for (;;)
      {
        wxe.e("Q.qqstory.publish.edit.EditVideoPermission", "MyUin , can't format uin:%s", new Object[] { paramString });
      }
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    default: 
      ...
      paramInt = 1;
      switch (this.jdField_a_of_type_Bmnj.a.c())
      {
      case 2: 
      default: 
        wxe.e("Q.qqstory.publish.edit.EditVideoPermission", "unKnown entrance:%s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Bmnj.a.c()) });
        i = 99;
      }
      break;
    }
  ...
  private void j()
  {
    ...
    {
    default: 
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130846250);
      return;
    case 10004: 
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130846254);
      return;
    case 10000: 
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130846250);
      return;
    case 10001: 
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130846260);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130846258);
  }
  
  public void a()
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)a(2131371712));
  ...
  public void a(int paramInt, @NonNull bnaz parambnaz)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    bmkz localbmkz = (bmkz)a(bmkz.class);
    if (localbmkz != null) {
      localArrayList.addAll(localbmkz.a(paramInt));
    }
    a(parambnaz.a, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilArrayList, localArrayList);
    if ((paramInt == 0) && (this.b != this.jdField_a_of_type_Int))
    {
      wxe.b("Q.qqstory.publish.edit.EditVideoPermission", "user has changed permission during editing session. default permission is %d, new permission is %d.", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.b));
      a(this.b);
    }
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    for (paramInt = 1;; paramInt = 2)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        ((uvt)uwa.a(10)).b("key_has_show_publish_permission_red_dot", Boolean.valueOf(true));
        wxj.a("pub_control", "clk_buble_guide", 0, 0, new String[0]);
      }
      d();
      return;
    }
