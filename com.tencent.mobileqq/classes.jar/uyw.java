...
public class uyw
{
  ...
  public static boolean a(stSimpleMetaFeed paramstSimpleMetaFeed, Context paramContext)
  {
    ...
    if ((localArrayList != null) && (localArrayList.size() > 0) && (localArrayList.get(0) != null) && (((stSimpleMetaFeed)localArrayList.get(0)).poster != null) && (paramstSimpleMetaFeed.poster != null) && (TextUtils.equals(((stSimpleMetaFeed)localArrayList.get(0)).poster.id, uyo.f()))) {}
