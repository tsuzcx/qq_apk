  ...
  implements amxv, amxz, amyf
{
  ...
  public void a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Amxt != null)) {
      this.jdField_a_of_type_Amxt.c();
    }
  ...
  public void a(long paramLong, amyj paramamyj)
  {
    ...
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Amxs != null)) {
        this.jdField_a_of_type_Amxs.a(paramLong, paramamyj);
      }
      return;
    }
  }
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    } while (this.jdField_a_of_type_Amxt == null);
    this.jdField_a_of_type_Amxt.a(paramLong, paramArrayOfByte);
  }
  ...
  public boolean a()
  {
    ...
    if ((this.jdField_a_of_type_Amxt != null) && (!this.jdField_a_of_type_Amxt.b()))
    {
      this.jdField_b_of_type_Boolean = false;
  ...
  public boolean a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Amxt != null)) {
      return this.jdField_a_of_type_Amxt.c();
    }
    if (((0x1000 & paramLong) != 0L) && (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {
  ...
  public boolean a(amxf paramamxf)
  {
    ...
    return this.jdField_a_of_type_Amxt.a(paramamxf);
  }
  
  public boolean a(Context arg1, long paramLong, int paramInt1, int paramInt2, ArConfigInfo paramArConfigInfo, ArrayList<ArCloudConfigInfo> paramArrayList, ARScanStarFaceConfigInfo paramARScanStarFaceConfigInfo, amxs paramamxs)
  {
    ...
    this.jdField_a_of_type_Amxs = paramamxs;
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalMarkerRecog != null) || (this.jdField_a_of_type_Amxt != null) || (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {}
      for (this.jdField_a_of_type_Boolean = true;; this.jdField_a_of_type_Boolean = false)
      {
        ...
        amzf.a().a(System.currentTimeMillis() - l, this.jdField_a_of_type_Boolean);
  ...
  {
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Amxt != null)) {
      return this.jdField_a_of_type_Amxt.d();
    }
    return true;
  }
