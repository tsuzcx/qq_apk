...
public class xom
{
  ...
  public static int a(String paramString)
  {
    ...
    try
    {
      ...
      {
        wsv.d("Q.qqstory.publish.VideoUtils", "cannot get metadata from video. rotation = " + paramString + " width = " + str2 + " height = " + str3);
        return -1;
      }
    }
    catch (IllegalArgumentException paramString)
    {
      wsv.b("Q.qqstory.publish.VideoUtils", "media exception", paramString);
      return -1;
    }
    ...
    for (;;)
    {
      wsv.d("Q.qqstory.publish.VideoUtils", "getVideoToPortraitRotation. neeRotate = " + bool1 + " orgRotation = " + i + " return = " + (i + 90) % 360);
      if (!bool1) {
        break;
      }
      return (i + 90) % 360;
  ...
  public static Pair<Integer, Integer> a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    return new Pair(Integer.valueOf(axld.a(paramInt1)), Integer.valueOf(axld.a(paramInt2)));
  }
  
  @TargetApi(16)
  public static ArrayList<xon> a(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString.containsKey("durationUs"))
        {
          ...
          wsv.b("Q.qqstory.publish.VideoUtils", "getClosetKeyFramePosArray() find it video index = " + i);
          if (i >= 0) {
            break label172;
          }
          wsv.e("Q.qqstory.publish.VideoUtils", "getClosetKeyFramePosArray() Can not find video track index.");
      ...
      {
        wsv.c("Q.qqstory.publish.VideoUtils", "Open file error in getClosetKeyFramePosArray() file = " + paramString, localIOException);
        localMediaExtractor.release();
        return null;
      }
      wsv.e("Q.qqstory.publish.VideoUtils", "getClosetKeyFramePosArray() Can not find duration.");
      localMediaExtractor.release();
      return null;
      label165:
      i += 1;
      ...
      if (l1 - l2 < paramLong)
      {
        paramString.add(new xon(l2, l1 - l2));
        i = 0;
        label237:
      ...
      label302:
      for (((xon)paramString.get(i)).b = (l1 - l2);; ((xon)paramString.get(i)).b = (((xon)paramString.get(i + 1)).a - ((xon)paramString.get(i)).a))
      {
        i += 1;
        break label237;
        paramString.add(new xon(l2, paramLong));
        l2 += paramLong;
        break;
      }
      label341:
  ...
  public static int[] a(String paramString)
  {
    ...
    try
    {
      ...
      {
        wsv.d("Q.qqstory.publish.VideoUtils", "retriever.release error" + paramString);
        return arrayOfInt;
      }
      try
      {
      ...
      catch (RuntimeException localRuntimeException)
      {
        for (;;)
        {
          wsv.d("Q.qqstory.publish.VideoUtils", "retriever.release error" + localRuntimeException);
        }
      }
    }
    catch (Exception paramString)
    {
      ...
      wsv.b("Q.qqstory.publish.VideoUtils", "exception", paramString);
      try
      {
        localMediaMetadataRetriever.release();
        return null;
