...
public class bfmw
{
  ...
  public static String e()
  {
    ...
    WindowManager localWindowManager = (WindowManager)bfbm.a().a().getSystemService("window");
  ...
  public static String f()
  {
    ...
    {
      bflp.c("getLocation", "getLocation>>>", localException);
    }
    return "";
  }
  ...
  public static String h()
  {
    try
    {
      ...
      String str = bflk.b(localContext);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localStringBuilder.append("wifi=").append(bflk.e(localContext));
  ...
  public static String i()
  {
    ...
    try
    {
      localJSONObject.put("qua", bfbm.a().f());
      localJSONObject.put("longitude", f());
      localJSONObject.put("platform", bfbm.a().g());
      localJSONObject.put("uin", bfbm.a().a());
      localJSONObject.put("imei", c());
      localJSONObject.put("imei", c());
      localJSONObject.put("resolution", e());
      localJSONObject.put("network", bflk.a(bfbm.a().a()));
      ...
      localJSONObject.put("qua", bfbm.a().f());
      localJSONObject.put("qz_ver", bfbm.a().c());
      localJSONObject.put("imsi", d());
      localJSONObject.put("androidID", Settings.Secure.getString(bfbm.a().a().getContentResolver(), "android_id"));
      localJSONObject.put("os_api_level", Build.VERSION.SDK_INT);
      localJSONObject.put("sdkVersionCode", 1);
      localJSONObject.put("QVersionCode", bfbm.a().a());
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bflp.e("getMobileInfo", "gather mobile info exception.");
      }
    }
  }
}
