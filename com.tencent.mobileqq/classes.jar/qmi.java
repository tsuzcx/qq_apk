  ...
  implements PolymericContainer
{
  ...
  private EventCallback jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerPolymericEventCallback = new qmp(this);
  public PolymericContainerHelper a;
  private VafContext jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext;
  protected Map<String, Integer> a;
  private opq jdField_a_of_type_Opq = new opq();
  protected pxk a;
  private qmr jdField_a_of_type_Qmr;
  ...
  public qmi(VafContext paramVafContext)
  {
  ...
  {
    QLog.d("RecycleViewAdapterHelper", 1, "addExportItem curPosition: " + paramInt + "  model :" + this.jdField_a_of_type_Pxk);
    ...
    if ((this.jdField_a_of_type_Pxk != null) && (this.jdField_a_of_type_Pxk.a() != null) && (localTemplateBean != null)) {}
    try
    {
      if ((this.jdField_a_of_type_Pxk.a().mGroupSubArticleList != null) && (this.jdField_a_of_type_Pxk.a().mGroupSubArticleList.size() > paramInt) && (pha.s(this.jdField_a_of_type_Pxk.a())) && (this.jdField_a_of_type_Pxk.a().mNewPolymericInfo.jdField_a_of_type_Boolean)) {
        a((BaseArticleInfo)this.jdField_a_of_type_Pxk.a().mGroupSubArticleList.get(paramInt), paramInt);
      }
      for (;;)
      {
        ...
        {
          return;
          localObject2 = (List)c.get(Long.valueOf(this.jdField_a_of_type_Pxk.a().mArticleID));
          localObject1 = localObject2;
          if (localObject2 == null)
          {
            localObject1 = new ArrayList();
            c.put(Long.valueOf(this.jdField_a_of_type_Pxk.a().mArticleID), localObject1);
          }
        } while (paramInt < ((List)localObject1).size());
        Object localObject2 = this.jdField_a_of_type_Pxk.a().clone();
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Pxk.a().getContext();
    ...
    for (int i = 1;; i = 0)
    {
      localObject = new pya((Context)localObject, localArticleInfo, j, k, i, paramInt, false, a(), null, this.jdField_a_of_type_Pxk.a());
      this.jdField_a_of_type_Pxk.a().a(paramBaseArticleInfo, (pxk)localObject, System.currentTimeMillis(), paramInt);
      return;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Opq != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext != null)) {
      this.jdField_a_of_type_Opq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getContext(), this.jdField_a_of_type_Pxk, paramInt, nxw.jdField_b_of_type_Int);
    }
  }
  
  private void b(pxk parampxk)
  {
    if ((this.jdField_a_of_type_Pxk != null) && (this.jdField_a_of_type_Pxk != parampxk) && (this.jdField_a_of_type_Pxk.a() != null) && (this.jdField_a_of_type_Pxk.a().getId() != parampxk.a().getId()) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView != null)) {
  ...
  public void a(pxk parampxk)
  {
    ...
    } while (this.jdField_a_of_type_Pxk.a() == null);
    a(this.jdField_a_of_type_Pxk.a().mGroupSubArticleList);
  }
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    int i = a(paramInt);
    Object localObject1;
    if ((paramViewHolder instanceof qmt))
    {
    ...
    for (;;)
    {
      ...
      a(i);
      b(i);
      Object localObject2 = (qmt)paramViewHolder;
      Container localContainer = (Container)((qmt)localObject2).itemView;
      BindDataUtil.bindDynamicValueWithoutRecursion(localContainer, ((qmt)localObject2).a, (TemplateBean)localObject1);
      ...
      ViewFactory.findClickableViewListener(((Container)((qmt)localObject2).itemView).getVirtualView(), new qmj(this, i, (TemplateBean)localObject1));
      continue;
      if ((paramViewHolder instanceof qmq))
      {
        localObject1 = (qmq)paramViewHolder;
        localObject2 = ((qmq)localObject1).itemView.getLayoutParams();
        if (localObject2 != null)
        {
          ((ViewGroup.LayoutParams)localObject2).width = 0;
          ((ViewGroup.LayoutParams)localObject2).height = 0;
          ((qmq)localObject1).itemView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        }
      }
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    return new qmt(this, (Container)localObject, null);
  }
