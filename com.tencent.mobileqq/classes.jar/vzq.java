...
public class vzq
  extends vzg
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new vzt(this);
  ...
  private void a(View paramView)
  {
    ...
    uxp.a().a(paramView, new vzu(this, localStFeed), new vzv(this));
  }
  ...
  public void a(ViewStub paramViewStub)
  {
    if (paramViewStub != null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleExpandableTextView = ((QCircleExpandableTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373801));
      paramViewStub = (QCircleAsyncTextView)this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleExpandableTextView.a();
      if (paramViewStub != null)
      {
        paramViewStub.c();
        paramViewStub.setOnLongClickListener(new vzr(this));
      }
    }
  }
  ...
  public void a(Object paramObject, int paramInt)
  {
    ...
    boolean bool = d();
    this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleExpandableTextView.setText(paramObject.content.get(), bool, new vzs(this));
