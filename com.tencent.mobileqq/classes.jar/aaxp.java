...
public class aaxp
  implements View.OnClickListener, biyy
{
  protected Dialog a;
  ...
  @TargetApi(11)
  public aaxp(TroopGiftPanel paramTroopGiftPanel, Context paramContext)
  {
    ...
    paramContext = LayoutInflater.from(paramContext).inflate(2131560615, null);
    this.jdField_a_of_type_AndroidAppDialog.setContentView(paramContext);
    this.jdField_a_of_type_AndroidAppDialog.setCancelable(true);
    paramContext = (InputMethodLinearLayout)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131367575);
    paramContext.setOnSizeChangedListenner(this);
    this.b = ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131364961));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131364159));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131367581));
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_AndroidWidgetEditText.setCustomSelectionActionModeCallback(new aaxq(this, paramTroopGiftPanel));
    }
    this.jdField_a_of_type_AndroidWidgetEditText.setOnEditorActionListener(new aaxr(this, paramTroopGiftPanel));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    paramContext.setOnClickListener(new aaxs(this, paramTroopGiftPanel));
  }
  
  public void a()
  {
    this.jdField_a_of_type_AndroidAppDialog.setOnShowListener(new aaxt(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new aaxo(this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel, 5) });
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.jdField_a_of_type_Aaxw.a();
    }
    for (;;)
    {
  ...
  {
    int i;
    if (nlj.a().a(this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a()))
    {
      i = 2;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.k >= 4) {
          aocz.a("gift_store", "sure_num", this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a(), this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a() + "", "", "");
        } else {
