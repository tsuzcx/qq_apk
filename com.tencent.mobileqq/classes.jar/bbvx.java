  ...
  public static void b()
  {
    ...
    if ((g > 5) && (!jdField_c_of_type_Boolean))
    {
      ...
      if (jdField_c_of_type_Int > 0)
      {
        ...
        bbvw.a("sv_filter_face_track", d1 / jdField_c_of_type_Int);
      }
      if (jdField_d_of_type_Int > 0)
      {
        ...
        bbvw.a("sv_filter_draw_frame", d1 / jdField_d_of_type_Int);
      }
      if (jdField_e_of_type_Int > 0)
      {
        ...
        bbvw.a("sv_filter_total_draw", d1 / jdField_e_of_type_Int);
      }
      if (jdField_f_of_type_Int > 0)
      {
        ...
        bbvw.a("sv_filter_no_filter_total_draw", d1 / jdField_f_of_type_Int);
      }
      if (g > 0)
      {
        l1 = l2;
        ...
        bbvw.a("sv_filter_total_process_frame", d1 / g);
      }
      if (jdField_b_of_type_Int == 0) {
        jdField_b_of_type_Int = 1;
      }
      bbvw.a("sv_filter_track_ratio", jdField_a_of_type_Int * 1000 / jdField_b_of_type_Int);
    }
  }
