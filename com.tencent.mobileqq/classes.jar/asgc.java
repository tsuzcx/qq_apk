...
public class asgc
{
  public static final String g = ajyc.a(2131713941);
  ...
  public asgc(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    AbsShareMsg localAbsShareMsg = new axuk(StructMsgForGeneralShare.class).c(114).a(this.jdField_b_of_type_JavaLangString).e(this.jdField_a_of_type_JavaLangString).a();
    localAbsShareMsg.mSourceName = this.e;
    localAbsShareMsg.mSourceAction = "web";
    localAbsShareMsg.mSourceUrl = this.f;
    Object localObject = axux.a(2);
    ((axuo)localObject).a(this.d, this.jdField_b_of_type_JavaLangString, this.c);
  ...
  private void b()
  {
    ...
    bgyu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localBundle, null);
  }
  ...
  {
    if (!a()) {
      bcpw.a(this.jdField_a_of_type_AndroidContentContext, ajyc.a(2131713942), 0).a();
    }
    do
    {
      for (;;)
      {
        ...
        {
          asgd localasgd = new asgd(this);
          paramOnDismissListener = new asge(this, paramOnDismissListener);
          ...
          this.jdField_a_of_type_Bbjc.a(localasgd);
