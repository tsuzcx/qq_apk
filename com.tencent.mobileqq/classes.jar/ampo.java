...
public abstract class ampo<DATA, CONFIG extends amqi>
{
  ...
  protected final PriorityQueue<amps> a;
  protected boolean a;
  protected float b;
  protected int b;
  protected long b;
  ...
  private void j()
  {
    try
    {
      this.jdField_a_of_type_Amqi = this.jdField_a_of_type_Ampx.a(a());
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof ampq)) {
          ((ampq)localObject).a();
        }
      }
  ...
  public long a()
  {
    return this.jdField_a_of_type_Amrg.a();
  }
  ...
  public final void a(long paramLong1, long paramLong2)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilPriorityQueue.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        amps localamps = (amps)localIterator.next();
        localamps.jdField_a_of_type_Long -= paramLong1;
        if (localamps.jdField_a_of_type_Long <= 0L)
        {
          localIterator.remove();
          localamps.jdField_a_of_type_Ampr.a(this);
        }
      }
    }
  }
  
  public void a(amrg paramamrg)
  {
    this.jdField_a_of_type_Amrg = paramamrg;
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    while (paramLong - this.jdField_b_of_type_Long < this.jdField_a_of_type_Amrg.a()) {
      return false;
    }
    return true;
  }
  ...
  {
    return (this.jdField_a_of_type_Long > 0L) && (paramLong - this.jdField_a_of_type_Long >= this.jdField_a_of_type_Amrg.a());
  }
  ...
  {
    this.jdField_a_of_type_Amrg.a(paramFloat);
  }
  ...
  public boolean e()
  {
    return (this.jdField_a_of_type_Boolean) && (amqn.a());
  }
  ...
  public void f()
  {
    ...
    {
      amrq.c("BaseDanmaku", "onFirstExposure, danmaku = " + toString());
      i();
      this.jdField_d_of_type_Boolean = true;
    }
    if ((this.jdField_a_of_type_Ampp != null) && (f1 <= 0.0F))
    {
      this.jdField_a_of_type_Ampp.a(this);
      this.jdField_a_of_type_Ampp = null;
    }
  }
  ...
  protected void i()
  {
    if (this.jdField_a_of_type_Ampx != null) {
      this.jdField_a_of_type_Ampx.a(this);
    }
  }
  
  public String toString()
  {
    return "BaseDanmaku" + this.jdField_a_of_type_Int + "[left:" + b() + ",top:" + c() + ",right:" + d() + ",bottom:" + e() + ", time:" + this.jdField_b_of_type_Long + ", mData=" + String.valueOf(this.jdField_a_of_type_JavaLangObject) + ", mType=" + a() + ", playerTime=" + this.jdField_a_of_type_Ampx.a() + "]";
  }
}
