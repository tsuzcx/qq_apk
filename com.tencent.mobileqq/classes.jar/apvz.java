...
public class apvz
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bhgg.a(anhk.ba + ".Rock/");
  }
  ...
  public static EntityManager a()
  {
    if (jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager == null) {
      jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = new apwg().createEntityManager();
    }
  ...
  public static void a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), apwf.class);
    ...
    localNewIntent.setObserver(new apwa(paramRockDownloaderTask));
  ...
  private static void b(RockDownloaderTask paramRockDownloaderTask, DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (bool2))
      {
        ...
        localObject = (DownloadInfo)bisa.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("RockDownloader", 2, new Object[] { "removedDownload=", localObject });
        }
        biry.a().a(paramDownloadInfo.jdField_b_of_type_JavaLangString);
  ...
  private static void b(@NonNull RockDownloaderTask paramRockDownloaderTask, String paramString)
  {
    ...
    if (localObject != null)
    {
      localStringBuilder.append(((RockDownloadInfo)localObject).getBusinessName()).append("&").append(((RockDownloadInfo)localObject).getBusinessScene()).append("&").append(((RockDownloadInfo)localObject).getPackageName()).append("&").append(bkfy.a("0"));
      ...
      localHashMap.put("IMEI", bkfy.a("0"));
    ...
    try
    {
      ...
      {
        bcst.b((QQAppInterface)paramRockDownloaderTask.getRuntime(), "dc00898", "", ((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        bctj.a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).getApp()).a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
        ...
        bcst.b(null, "dc00898", "", paramRockDownloaderTask.getRuntime().getAccount(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        bctj.a(paramRockDownloaderTask.getRuntime().getApplication()).a(paramRockDownloaderTask.getRuntime().getAccount(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
    }
    catch (Throwable paramRockDownloaderTask)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          bcst.b(null, "dc00898", "", "", paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
          bctj.a(BaseApplicationImpl.context).a("", "RockDownloader", true, 0L, 0L, localHashMap, "");
        }
      }
  ...
  private static void b(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2, boolean paramBoolean, RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), anni.a(2131712265), 10010);
    }
    for (;;)
    {
      paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      paramString = (DownloadInfo)bisa.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
  ...
  private static void b(List<DownloadInfo> paramList, boolean paramBoolean, RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    paramRockDownloaderTask.getRockDownloadListener().onDownloadProceedOn(paramRockDownloaderTask.getDownloadInfo(), localDownloadInfo.f);
  }
  ...
  private static void d(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    {
      localapwb = new apwb(paramRockDownloaderTask, bool);
      Iterator localIterator = bisa.a().a().values().iterator();
      ...
      bisa.a().b(localDownloadInfo1);
      if (bool)
      {
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), anni.a(2131712262), 10011);
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      }
      return;
    }
  ...
  {
    Object localObject = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), apwf.class);
