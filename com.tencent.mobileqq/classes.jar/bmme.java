  ...
  implements View.OnClickListener
{
  ...
  bmmg jdField_a_of_type_Bmmg = null;
  ...
  public bmme(Activity paramActivity, bmmg parambmmg, int paramInt1, int paramInt2, AppRuntime paramAppRuntime)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_Bmmg = parambmmg;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_MqqAppAppRuntime = paramAppRuntime;
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet == null)
    {
      parambmmg = new ShareActionSheetV2.Param();
      parambmmg.context = paramActivity;
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet = ShareActionSheetFactory.create(parambmmg);
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setActionSheetTitle(paramActivity.getString(2131692536));
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bmmf(this));
    }
    b();
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bmmg != null) {
      b(this.jdField_a_of_type_Bmmg.a());
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bmmg != null)
    {
      localObject1 = this.jdField_a_of_type_Bmmg.a();
  ...
  protected void a(int paramInt, ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    case 72: 
      ...
      this.jdField_a_of_type_Bmmg.a(localBundle);
      return;
    case 26: 
      this.jdField_a_of_type_Bmmg.g();
      return;
    case 39: 
      this.jdField_a_of_type_Bmmg.f();
      return;
    case 130: 
      this.jdField_a_of_type_Bmmg.h();
      return;
    case 131: 
      this.jdField_a_of_type_Bmmg.n();
      return;
    case 94: 
      this.jdField_a_of_type_Bmmg.a();
      return;
    case 129: 
      this.jdField_a_of_type_Bmmg.b();
      return;
    case 70: 
      this.jdField_a_of_type_Bmmg.c();
      return;
    case 82: 
      this.jdField_a_of_type_Bmmg.d();
      return;
    case 55: 
      this.jdField_a_of_type_Bmmg.j();
      return;
    case 52: 
      this.jdField_a_of_type_Bmmg.i();
      return;
    case 56: 
      this.jdField_a_of_type_Bmmg.k();
      return;
    }
    this.jdField_a_of_type_Bmmg.m();
  }
