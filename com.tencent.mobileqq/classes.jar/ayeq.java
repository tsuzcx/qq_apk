...
public class ayeq
{
  ...
  private ayeq(ayes paramayes)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic = paramayes.jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView = paramayes.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView;
    this.jdField_a_of_type_ArrayOfInt = paramayes.jdField_a_of_type_ArrayOfInt;
    this.jdField_a_of_type_Afxu = paramayes.jdField_a_of_type_Afxu;
  }
  ...
  private URLDrawable a(File paramFile)
  {
    ...
    float f1 = i2 / 160.0F;
    URL localURL = this.jdField_a_of_type_Afxu.jdField_a_of_type_JavaNetURL;
    boolean bool1 = this.jdField_a_of_type_Afxu.jdField_a_of_type_Boolean;
    boolean bool2 = bkkh.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.imageType);
    if (bool1) {}
    label453:
    label710:
    for (;;)
    {
      ...
      try
      {
        ...
        paramFile = new aqwu(localResources, ((SkinnableBitmapDrawable)URLDrawableHelper.getLoadingDrawable()).getBitmap(), j, i, -921103);
        paramFile = URLDrawableHelper.getDrawable(localURL, j, i, paramFile, URLDrawableHelper.getFailedDrawable(), true, f1);
        paramFile.setProgressDrawable(new bhgf(URLDrawableHelper.getCommonProgressBitmap(), 0, false));
      ...
      try
      {
        bfvo.a(paramFile.getAbsolutePath(), localOptions);
      ...
      if ((j >= n) || (i >= i1))
      {
        ...
        if (localObject.height() < i)
        {
          ...
          if ((URLDrawableHelper.getLoadingDrawable() instanceof BitmapDrawable)) {
            paramFile = new aqwu(localResources, ((BitmapDrawable)URLDrawableHelper.getLoadingDrawable()).getBitmap(), j, i, -921103);
          } else {}
        }
      }
    }
  ...
  private URLDrawable b()
  {
    ...
    URLDrawable localURLDrawable = URLDrawableHelper.getDrawable(this.jdField_a_of_type_Afxu.jdField_a_of_type_JavaNetURL, 0, 0, null, null, true, 12.0F * f);
    if (this.jdField_a_of_type_ArrayOfInt != null)
    {
  ...
  private URLDrawable c()
  {
      ...
      if ((n < j) || (i1 < k)) {
        if (n < i1)
        {
          ...
          if (k > i)
          {
            ...
            localObject = new aqwu(localResources, ((SkinnableBitmapDrawable)URLDrawableHelper.getLoadingDrawable()).getBitmap(), j, i, -921103);
          }
        }
      }
    }
    for (;;)
    {
      ...
      ((URLDrawable)localObject).setProgressDrawable(new bhgf(URLDrawableHelper.getCommonProgressBitmap(), 0, false));
      return localObject;
      i = k;
      break;
      j = (int)(k / i1 * n + 0.5F);
      ...
      label574:
      if ((URLDrawableHelper.getLoadingDrawable() instanceof BitmapDrawable)) {
        localObject = new aqwu(localResources, ((BitmapDrawable)URLDrawableHelper.getLoadingDrawable()).getBitmap(), j, i, -921103);
      }
    }
  }
  ...
  public URLDrawable a()
  {
    if (this.jdField_a_of_type_Afxu == null) {
      this.jdField_a_of_type_Afxu = new afxu(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic);
    }
    Object localObject = this.jdField_a_of_type_Afxu.jdField_a_of_type_JavaNetURL.toString();
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView != null) {
