  ...
  extends FrameLayout
{
  ...
  public xcm(@NonNull Context paramContext, QQWalletTroopHbItem paramQQWalletTroopHbItem)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130844243);
  ...
  public void a(RedPackGrapInfo paramRedPackGrapInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQWalletTroopHbItem != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQWalletTroopHbItem.a((FrameLayout)localObject, paramRedPackGrapInfo, new xcn(this));
    }
    label116:
