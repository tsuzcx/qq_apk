  ...
  extends alcf
{
  ...
  public void a(RecentItemRecommendTroopData paramRecentItemRecommendTroopData, alby paramalby)
  {
    ...
    if (paramRecentItemRecommendTroopData.mUser.uin.equals("sp_uin_for_title"))
    {
      ...
      if (AppSetting.c)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(anni.a(2131711981));
      }
      return;
    }
    ...
    if (paramalby == null)
    {
      paramalby = null;
      label225:
      this.jdField_a_of_type_ComTencentWidgetThemeImageView.setImageDrawable(paramalby);
    ...
    label609:
    label621:
    for (paramalby = (RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo;; paramalby = null)
    {
      if (paramalby == null)
      {
        QLog.d("RecentRecommendTroopIte", 1, "bindData, troopItem == null");
        return;
        paramalby = paramalby.a(paramRecentItemRecommendTroopData);
        break label225;
      }
      if (paramalby.activity > 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setVisibility(0);
        this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setHotLevel(paramalby.activity);
        ArrayList localArrayList = njn.a((RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo);
        ...
        label366:
        if (!paramalby.isJoined()) {
          break label535;
        }
        this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131698406);
        this.jdField_a_of_type_AndroidWidgetButton.setMinWidth(bgtn.a(60.0F));
        this.jdField_a_of_type_AndroidWidgetButton.setMinWidth(bgtn.a(29.0F));
        ...
        if (TextUtils.isEmpty(paramalby.intro)) {
          break label609;
        }
        this.jdField_a_of_type_ComTencentMobileqqWidgetFolderTextView.setText(new bdnt(paramalby.intro, 11, 16));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131698404);
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839317);
        break label445;
