...
public class svr
{
  private static QQHashMap<String, suz> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap = new QQHashMap(2019, 10, 10000);
  public static String a;
  private static Map<String, svs> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static suz a(String paramString)
  {
    try
    {
      paramString = (suz)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static svs a(String paramString)
  {
    svs localsvs = (svs)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localsvs != null) {
      return localsvs;
    }
    localsvs = new svs();
    ...
    if (str == null)
    {
      ...
      localsvs.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localsvs);
      return localsvs;
    }
    str = str + paramString;
  ...
  public static void a(String paramString, suz paramsuz)
  {
    try
    {
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(paramString, paramsuz);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.4.5");
      paramString3.add(Integer.valueOf(Integer.parseInt("4745")));
  ...
  {
    String str = bnrf.a("default_feeds_proteus_offline_bid");
    bhmi.a(nmp.a(str) + str);
  }
}
