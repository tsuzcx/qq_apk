  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public body(bqai parambqai, bqah parambqah)
  {
    super(parambqai, parambqah);
    this.jdField_a_of_type_Bqaa = new bqaa(10012, 105, 11);
  ...
  public void I()
  {
    ...
    localIntent.putExtras(this.jdField_a_of_type_Bqai.a().getIntent().getExtras());
    localIntent.putExtra("qq_sub_business_id", this.jdField_a_of_type_Bqaa.c);
    localIntent.putExtra("entrance_type", this.jdField_a_of_type_Bqaa.jdField_b_of_type_Int);
    ...
    localIntent.putExtra("ALBUM_NAME", bhkc.RECENT_ALBUM_NAME);
  ...
  public View a()
  {
    ...
    Object localObject1 = bfek.a(this.jdField_a_of_type_Bqai.a().getIntent().getExtras());
    ...
    localObject1 = this.jdField_a_of_type_Bqai.a().getIntent().getExtras();
    try
    {
      ...
      this.jdField_a_of_type_Bqai.a().getIntent().putExtras((Bundle)localObject1);
    }
  ...
  protected bbhn a()
  {
    ...
    if (bdbt.r > 2000000)
    {
      localbbhn.j(2000000);
      bdbt.r = 2000000;
      yuk.b("QIMTribeEffectsCameraCaptureUnit", "maxrate:" + bdbt.r);
    }
    localbbhn.b(false);
    return localbbhn;
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      return;
      if (paramInt1 != bfct.jdField_a_of_type_Int) {
        break label87;
      }
      if (paramInt2 != -1) {
        break;
    ...
    if ((paramInt1 == 10012) && (paramInt2 == -1))
    {
      ...
      localActivity.startActivityForResult(localIntent, bfct.jdField_a_of_type_Int);
      return;
    }
    yuk.d("QIMTribeEffectsCameraCaptureUnit", "onActivityResult, requestCode=%d, resultCode=%d, data=%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramIntent });
  }
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.jdField_a_of_type_Bqaa.jdField_b_of_type_Int != 102)
    {
      ...
      bool2 = true;
      localObject = new bqag().a(false).e(bool1).f(bool2).g(true).h(this.h).a();
      localBundle = this.jdField_a_of_type_Bqai.a().getIntent().getExtras();
  ...
  protected void w()
  {
    ThreadManager.post(new QIMTribeEffectsCameraCaptureUnit.1(this, this.jdField_a_of_type_Bqai.a()), 5, null, true);
  }
}
