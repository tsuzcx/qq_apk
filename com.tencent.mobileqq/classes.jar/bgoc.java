...
public class bgoc
{
  ...
  public static ArrayList<bgod> a(String paramString)
  {
  ...
  public static ArrayList<bgod> a(JSONArray paramJSONArray)
  {
    Object localObject2;
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramJSONArray.length())
        {
          ...
          {
            localArrayList.add(new bgod(str1));
            localObject2 = str1;
          }
          localArrayList.add(new bgod(str1, str3, str2, str4));
          i += 1;
  ...
  public static LinkedHashMap<String, Integer> a(String[] paramArrayOfString, List<bgod> paramList)
  {
    int j = 0;
    ...
    {
      bgod localbgod = (bgod)paramList.next();
      if (localLinkedHashMap.containsKey(localbgod.jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        localLinkedHashMap.put(localbgod.jdField_a_of_type_JavaLangString, Integer.valueOf(i));
        i += 1;
      }
    }
