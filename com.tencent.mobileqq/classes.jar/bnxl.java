...
public final class bnxl
{
  ...
  public static void a(Bitmap paramBitmap, bnxp parambnxp)
  {
    a(paramBitmap, parambnxp, false);
  }
  
  public static void a(Bitmap paramBitmap, bnxp parambnxp, boolean paramBoolean)
  {
    if (parambnxp == null) {
      return;
    }
    ...
    a(new FaceChangeUtils.5(paramBitmap, parambnxp), paramBoolean, "GLThread-cropFace");
  }
  
  public static void a(Bitmap paramBitmap, List<String> paramList, bnxm parambnxm)
  {
    if ((paramBitmap == null) || (paramList == null) || (paramList.isEmpty()))
    {
      ...
      parambnxm.a(new ArrayList());
      return;
    }
    a(new FaceChangeUtils.2(paramList, paramBitmap, parambnxm), false, "GLThread-changeFaceBatch");
  }
  ...
  private static bnxn b(Bitmap paramBitmap, String paramString)
  {
    if ((paramBitmap == null) || (paramString == null))
    {
      bnzb.d("FaceChangeUtils", "changeFaceInternal---null parameters: userFace, materialDir");
      return bnxn.a(-1, "null parameters, material=" + paramString);
    }
    ...
    {
      bnzb.d("FaceChangeUtils", "changeFaceInternal---failed to parse CrazyFace: " + paramString);
      return bnxn.a(-2, "failed to parse material, material=" + paramString);
    }
    ...
    {
      bnzb.d("FaceChangeUtils", "changeFaceInternal---failed to detect face");
      return bnxn.a(-3, "failed to detect face");
    }
    Object localObject3 = a(((PTFaceAttr)localObject1).getAllFacePoints(), ((PTFaceAttr)localObject1).getFaceDetectScale());
    if (((List)localObject3).isEmpty())
    {
      bnzb.d("FaceChangeUtils", "changeFaceInternal---userFacePointsList is empty");
      return bnxn.a(-4, "no face points");
    }
    ...
    bnzb.b("FaceChangeUtils", "success : + result");
    return bnxn.a(paramString);
  }
  ...
  private static void c(Bitmap paramBitmap, bnxp parambnxp)
  {
    ...
    parambnxp.a((Bitmap)localObject2);
  }
}
