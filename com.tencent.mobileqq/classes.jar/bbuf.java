...
public class bbuf
  implements Observer
{
  public bbuf(SignatureEditFragment paramSignatureEditFragment) {}
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    while (SignatureEditFragment.a(this.a) == null)
    {
      ...
      {
        paramObject = bbvh.a().jdField_b_of_type_ComTencentMobileqqRichstatusRichStatus;
        if (paramObject != null)
        {
      ...
      if (paramObservable != null)
      {
        ...
        bbvh.a().a(this.a.jdField_b_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
      }
      ...
      if ((i == 100) || (i == 0))
      {
        ...
        bbvh.a().b(this.a.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus);
      }
      for (;;)
      {
