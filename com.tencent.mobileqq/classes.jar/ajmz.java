...
public class ajmz
{
  ...
  public static Object a(AppInterface paramAppInterface, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, xfp paramxfp)
  {
    ...
    {
      ardv.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + localRespHeader.eReplyCode);
      localUserData = null;
      bool = false;
      if (localRespHeader == null) {
        break label488;
      ...
      if (!(paramxfp instanceof awal)) {
        break label385;
      }
      ((awal)paramxfp).a[i] = localUserData;
      label140:
      if (asfl.b())
      {
        ...
        label154:
        asfl.a("NearbyCmdHelper", new Object[] { "decodeGetEncounter", Integer.valueOf(i), paramAppInterface });
      }
      if (localUserData != null)
      {
        amvv.a(paramToServiceMsg.extraData.getString("account"), localUserData.iLon, localUserData.iLat, localUserData.lTime);
    ...
    for (;;)
    {
      ...
      ardv.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + null);
      break;
      label385:
      if (!(paramxfp instanceof awaj)) {
        break label140;
      }
      ((awaj)paramxfp).a[i] = localUserData;
      break label140;
      label407:
      ...
      ajnd.a(paramAppInterface, i);
      paramAppInterface = localUserData;
      continue;
      label488:
      ajnd.a(paramAppInterface, -1111);
      return null;
      label497:
      bool = true;
      paramAppInterface = paramFromServiceMsg;
  ...
  public static Object a(xfp paramxfp, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramxfp = (RespGetPoint)paramxfp.a(paramFromServiceMsg.getWupBuffer(), "RespGetPoint", new RespGetPoint());
      if (paramxfp != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.nearby", 2, "LBSService --> decodeGetPointInfo(), url: " + new String(paramxfp.stUDLinfo.SOSOUrl) + " , cityId = " + paramxfp.stUDLinfo.cityId);
        }
        return paramxfp;
      }
    }
  ...
  public static void a(ajfb paramajfb, byte paramByte)
  {
    try
    {
      long l = Long.parseLong(paramajfb.getCurrentAccountUin());
      Object localObject = new byte[13];
      bakz.a((byte[])localObject, 0, l);
      localObject[4] = 0;
      bakz.a((byte[])localObject, 5, (short)1);
      bakz.a((byte[])localObject, 7, 40493);
      bakz.a((byte[])localObject, 9, (short)2);
      bakz.a((byte[])localObject, 11, (short)paramByte);
      localObject = paramajfb.makeOIDBPkg("OidbSvc.0x4ff_9", 1279, 9, (byte[])localObject);
      ...
      paramajfb.sendPbReq((ToServiceMsg)localObject);
      amvy.a("send_oidb_0x4ff_9", new Object[] { Byte.valueOf(paramByte) });
      return;
    }
    catch (Exception paramajfb)
    {
      while (!QLog.isColorLevel()) {}
      QLog.w("Q.dating", 2, "send_oidb_0x4ff_9 error", paramajfb);
    }
  }
  
  public static void a(ajfb paramajfb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject != null) && (paramFromServiceMsg.isSuccess()))
    {
      ...
      if (bool1) {
        if ((paramObject != null) && (paramObject.SOSOUrl.length > 0)) {
          paramajfb.notifyUI(paramInt, true, paramObject.SOSOUrl);
        }
      }
    }
    do
    {
      ...
      if (paramObject.cityId != null)
      {
        ...
        if (paramObject.cityId.length == 16)
        {
          ...
          paramToServiceMsg[0] = ajfw.a(localByteBuffer.getInt());
          paramToServiceMsg[1] = ajfw.a(localByteBuffer.getInt());
          paramToServiceMsg[2] = ajfw.a(localByteBuffer.getInt());
          paramToServiceMsg[3] = "0";
        }
      }
      paramajfb.notifyUI(paramInt, true, new Object[] { "", paramObject.strProvince, paramObject.strCity, paramObject.strDistrict, paramObject.strTown, "", paramObject.strRoad, "", Integer.valueOf(paramFromServiceMsg.stGps.iLat), Integer.valueOf(paramFromServiceMsg.stGps.iLon), Integer.valueOf(paramFromServiceMsg.stGps.iAlt), paramToServiceMsg });
      return;
      if (bool1)
      {
        paramajfb.notifyUI(paramInt, false, null);
        return;
      }
    } while (!bool2);
    paramajfb.notifyUI(paramInt, false, null);
  ...
  public static void a(ajfb paramajfb, int paramInt1, List<asjg> paramList, int paramInt2, int paramInt3)
  {
    if (paramList == null)
    {
      c(paramajfb, paramInt1, null, null, null);
      return;
    }
    ...
    {
      asjg localasjg = (asjg)paramList.get(paramInt1);
      if (localasjg != null) {
        localReqBody.rpt_msg_tags.add(localasjg.a());
      }
      paramInt1 += 1;
    }
    paramList = paramajfb.makeOIDBPkg("OidbSvc.0x9c7_0", 2503, 0, localReqBody.toByteArray());
    paramList.extraData.putInt("set_mode", paramInt2);
    paramList.extraData.putInt("test_mode", paramInt3);
    paramajfb.sendPbReq(paramList);
  }
  
  public static void a(ajfb paramajfb, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    Object localObject = new cmd0x682.ReqBody();
    ((cmd0x682.ReqBody)localObject).rpt_uint64_touinlist.add(Long.valueOf(paramLong));
    localObject = paramajfb.makeOIDBPkg("OidbSvc.0x682", 1666, 0, ((cmd0x682.ReqBody)localObject).toByteArray());
    ((ToServiceMsg)localObject).extraData.putByteArray("showlove_chat_sig", paramArrayOfByte);
    paramajfb.sendPbReq((ToServiceMsg)localObject);
    a(paramajfb.mApp, paramInt);
    amvy.c("getShowLove", new Object[] { "from type " + paramInt });
  }
  
  public static void a(ajfb paramajfb, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2)
  {
    if ((!paramBoolean1) && (!paramBoolean2)) {
      return;
    }
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", paramajfb.getCurrentAccountUin(), "NeighborSvc.ReqGetPoint");
    ...
    for (;;)
    {
      paramajfb.send(localToServiceMsg);
      return;
  ...
  private static void a(AppInterface paramAppInterface, int paramInt)
  {
    ...
    if ((paramInt & 0x4) == 4)
    {
      ...
      amvy.c("getShowLove", new Object[] { "report value ", str });
      str = "";
      if ((paramInt & 0x1) != 1) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      {
        paramAppInterface.reportClickEvent("CliOper", "", "", str, str, 0, 0, "", "", "", "");
        amvy.c("getShowLove", new Object[] { "report value2 ", str });
      }
      return;
      if ((paramInt & 0x8) == 8)
      {
  ...
  public static boolean a(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, xfp paramxfp)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyCmdHelper", 2, "handleGetEncounter start...");
    }
    if (paramToServiceMsg.extraData.getBoolean("isCheckInReq", false)) {
      return b(paramAppInterface, paramToServiceMsg, paramUniPacket, paramxfp);
    }
    int i = a(paramToServiceMsg);
    if ((paramxfp instanceof awal)) {
      paramxfp = ((awal)paramxfp).a[i];
    }
    label155:
    label1454:
    for (;;)
    {
      ...
      if (asfl.b())
      {
        if (paramxfp == null)
        {
          ...
          asfl.a("NearbyCmdHelper", new Object[] { "handleGetEncounter", Integer.valueOf(i), localObject1 });
        }
      }
      else
      {
        ...
        localReqHeader.lMID = xfp.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      label1784:
      label1919:
      for (Object localObject2 = new UserData();; localObject2 = paramxfp)
      {
        ...
        if (localObject5 != null)
        {
          ...
          if (localObject5.length > 0)
          {
            ...
            paramxfp = ((awaj)paramxfp).a[i];
            break;
            localObject1 = paramxfp.strProvince;
            break label75;
        ...
        if ((QLog.isColorLevel()) && (paramxfp != null)) {
          QLog.d("NearbyCmdHelper", 2, "request stUserData.lTime=" + paramxfp.lTime + " iLat=" + paramxfp.iLat + " iLon" + paramxfp.iLon + " lOriginGrid=" + paramxfp.lOriginGrid + " lNextGrid=" + paramxfp.lNextGrid + " strProvince=" + paramxfp.strProvince + " strCookie" + paramxfp.strCookie);
        }
        if (asfl.b()) {
          asfl.a("NearbyCmdHelper", "handleGetEncounter interest", new Object[] { Byte.valueOf(b2), Long.valueOf(l2) });
        }
        paramToServiceMsg = (DatingFilters)paramToServiceMsg.extraData.getParcelable("datingFilter");
        paramxfp = new cmd0x5fb.ReqInfo();
        if (paramToServiceMsg != null)
        {
          paramxfp.uint32_time.set(paramToServiceMsg.jdField_b_of_type_Int);
          paramxfp.uint32_subject.set(paramToServiceMsg.d);
          paramxfp.uint32_gender.set(paramToServiceMsg.jdField_a_of_type_Int);
          paramxfp.uint32_age_low.set(DatingFilters.jdField_b_of_type_ArrayOfInt[paramToServiceMsg.e]);
          paramxfp.uint32_age_up.set(DatingFilters.jdField_a_of_type_ArrayOfInt[paramToServiceMsg.e]);
          PBUInt32Field localPBUInt32Field = paramxfp.uint32_profession;
          if (paramToServiceMsg.f >= 0) {
            break label1687;
          }
          i = 0;
          localPBUInt32Field.set(i);
          paramxfp.bytes_cookie.set(ByteStringMicro.copyFrom(new byte[0]));
          if ((paramToServiceMsg.jdField_a_of_type_AppointDefineAppoint_define$LocaleInfo != null) && (paramToServiceMsg.d == 5)) {
            paramxfp.msg_destination.set(paramToServiceMsg.jdField_a_of_type_AppointDefineAppoint_define$LocaleInfo);
          }
        }
        if (((Boolean)asfc.a(paramAppInterface.getAccount(), "is_nearby_novice", Boolean.valueOf(false))).booleanValue())
        {
          i = 1;
          if (QLog.isColorLevel()) {
          ...
          paramToServiceMsg = new ReqGetEncounterV2(localReqUserInfo1, (UserData)localObject2, k, -1, (ArrayList)localObject3, new byte[1], (byte)j, 2000, -1, 0, null, (byte[])localObject4, 0, (byte)1, b1, b3, b4, m, n, i2, i3, (byte)1, i1, localReqUserInfo2, 15, paramxfp.toByteArray(), (byte)0, (byte)0, b2, (String)localObject5, l1, 0L, b5, i, i4, l2);
        ...
        for (paramToServiceMsg = "lbs is not null";; paramToServiceMsg = "isUseGps is true")
        {
          ...
          paramUniPacket.put("param_NetType", badq.a(null) + "");
          awrn.a(BaseApplicationImpl.getContext()).a(paramAppInterface.getCurrentAccountUin(), "GET_ENCOUNTER_LOCATION", true, 0L, 0L, paramUniPacket, "");
          return true;
          i = paramToServiceMsg.f;
          break;
          i = 0;
          break label1454;
          paramToServiceMsg = new ReqGetEncounterV2(localReqUserInfo1, (UserData)localObject2, k, -1, (ArrayList)localObject3, new byte[1], (byte)0, 2000, -1, 0, null, (byte[])localObject4, 0, (byte)1, b1, b3, b4, m, n, i2, i3, (byte)1, i1, null, 15, paramxfp.toByteArray(), (byte)0, (byte)0, b2, (String)localObject5, l1, 0L, b5, i, i4, l2);
          break label1567;
        }
        if (QLog.isColorLevel()) {
        ...
        paramToServiceMsg.put("param_NetType", badq.a(null) + "");
        awrn.a(BaseApplicationImpl.getContext()).a(paramAppInterface.getCurrentAccountUin(), "GET_ENCOUNTER_LOCATION", false, 0L, 0L, paramToServiceMsg, "");
        return false;
      }
      label946:
      paramxfp = null;
  ...
  public static boolean a(xfp paramxfp, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    boolean bool1 = false;
    int j = 0;
    ...
    {
      paramxfp = new NeighborSvc.ReqHeader();
      paramxfp.shVersion = 2;
      paramxfp.lMID = xfp.a(Long.parseLong(paramToServiceMsg.getUin()));
      paramxfp.iAppID = AppSetting.a();
      paramxfp.eBusiType = 0;
      paramxfp.eMqqSysType = 2;
      ...
      for (i = 1;; i = 0) {
        for (;;)
        {
          ...
          paramUniPacket.put("ReqHeader", paramxfp);
          ...
          akfu.a(new ajna("LBSService.Point", paramToServiceMsg));
          try
          {
            paramToServiceMsg.wait();
            Object localObject2 = asct.a(true, akfu.a("LBSService.Point"));
    ...
    paramxfp = new FromServiceMsg(paramToServiceMsg.getUin(), paramToServiceMsg.getServiceCmd());
    paramxfp.setMsgFail();
    try
    {
      paramToServiceMsg.actionListener.onActionResult(paramxfp);
      return false;
    }
    catch (RemoteException paramxfp) {}
    return false;
  }
  ...
  private static byte[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return localObject;
      label100:
      localObject = a(asct.a());
    }
  }
  
  public static void b(ajfb paramajfb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2 = false;
    int i = -1;
    try
    {
      ...
      if (bool1)
      {
        ...
        if (localRspBody.uint32_config_seq.has())
        {
          ...
          asfc.a(paramajfb.mApp.getAccount(), "toplist_hide_boygod_seq", Integer.valueOf(j));
        }
        if (localRspBody.uint32_config_time.has())
        {
          j = localRspBody.uint32_config_time.get();
          asfc.a(paramajfb.mApp.getAccount(), "key_last_config_time", Integer.valueOf(j));
        }
        ...
        if ((i == 2) && (localRspBody.msg_charm_event.has()))
        {
          ...
          if (!(paramajfb.mApp instanceof NearbyAppInterface)) {
            break label600;
          }
        }
        int k;
        ...
        for (;;)
        {
          ...
          paramajfb.notifyUI(paramInt, true, new Object[] { Boolean.valueOf(false), Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i1), paramToServiceMsg });
          paramToServiceMsg = "0X80052B1";
          if (k - i < 0) {
            paramToServiceMsg = "0X80052B2";
          }
          paramajfb.mApp.reportClickEvent("CliOper", "", "", paramToServiceMsg, paramToServiceMsg, 0, 0, "", "", "", "");
          return;
          ...
          break;
          label600:
          if ((paramajfb.mApp instanceof QQAppInterface)) {
            ((QQAppInterface)paramajfb.mApp).a().a(paramToServiceMsg.getUin(), paramFromServiceMsg, paramObject, (Oidb_0x686.CharmEvent)localObject1, (Oidb_0x686.NearbyCharmNotify)localObject2);
          }
        }
        label637:
        if ((localObject2 != null) && (((Oidb_0x686.NearbyCharmNotify)localObject2).uint32_pop_flag.get() == 1))
        {
          ...
          paramajfb.notifyUI(paramInt, true, new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i1), Integer.valueOf(i2), Integer.valueOf(i3), paramToServiceMsg });
  ...
  protected static boolean b(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, xfp paramxfp)
  {
    ...
    if ((i != 0) && (j != 0))
    {
      ...
      paramAppInterface.lMID = xfp.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      paramxfp = new ReqGetEncounterV2();
      paramxfp.stUserData = new UserData();
      paramxfp.stUserInfo = paramToServiceMsg;
      paramxfp.eNewListType = 100;
      paramxfp.neighbor_list_source = 4;
      paramUniPacket.setEncodeName("utf-8");
      paramUniPacket.setServantName("EncounterObj");
      paramUniPacket.setFuncName("CMD_GET_ENCOUNTERV2");
      paramUniPacket.put("ReqHeader", paramAppInterface);
      paramUniPacket.put("ReqGetEncounterV2", paramxfp);
      return true;
    }
    return false;
  }
  
  public static void c(ajfb paramajfb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      paramajfb.notifyUI(paramInt, false, new Object[] { "", null, ajjy.a(2131641334), Integer.valueOf(-1), Integer.valueOf(-1) });
      return;
    }
    int i;
    int j;
    ...
    if (paramToServiceMsg.extraData == null)
    {
      ...
      m = ajfb.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
      if (m != 0) {
        break label472;
      }
    ...
    for (paramFromServiceMsg = localRspBody.rpt_msg_tags.get();; paramFromServiceMsg = null)
    {
      ...
      {
        asjg localasjg = asjg.a((appoint_define.InterestTag)paramFromServiceMsg.get(k));
        if (localasjg != null) {
          paramObject.add(localasjg);
        }
        k += 1;
      }
    ...
    {
      paramajfb.notifyUI(4, false, new Object[] { "", null, ajjy.a(2131641335), Integer.valueOf(i), Integer.valueOf(j) });
      asfl.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), null, paramToServiceMsg });
      return;
    }
    if ((paramajfb.mApp instanceof NearbyAppInterface)) {
      ((NearbyAppInterface)paramajfb.mApp).a().a(localRspBody);
    }
    for (;;)
    {
      paramajfb.notifyUI(paramInt, true, new Object[] { paramToServiceMsg, paramObject, "", Integer.valueOf(i), Integer.valueOf(j) });
      asfl.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), paramObject, paramToServiceMsg });
      return;
      if (paramajfb.app != null) {
        paramajfb.app.a().a(localRspBody);
      }
    }
    label472:
    ...
    {
      paramajfb.notifyUI(paramInt, false, new Object[] { "", null, paramToServiceMsg, Integer.valueOf(i), Integer.valueOf(j) });
      return;
    }
  }
  
  public static void d(ajfb paramajfb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2 = true;
    boolean bool1;
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          if ((i == 0) && (paramFromServiceMsg.bytes_bodybuffer.has()) && (paramFromServiceMsg.bytes_bodybuffer.get() != null))
          {
            ...
            if (4 <= paramFromServiceMsg.length)
            {
              ...
              if ((paramFromServiceMsg == null) || (!paramFromServiceMsg.equals(paramajfb.getCurrentAccountUin())))
              {
                if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if ((paramajfb.mApp instanceof QQAppInterface)) {
        if (paramInt == 7)
        {
          ...
          if (bool1)
          {
            paramToServiceMsg = ((QQAppInterface)paramajfb.mApp).a();
            if (paramInt != 0) {
              break label294;
            }
            paramToServiceMsg.a(bool2);
          }
          paramajfb.notifyUI(7, bool1, null);
        }
      }
      for (;;)
      {
        ...
        if ((paramajfb.mApp instanceof NearbyAppInterface))
        {
          paramFromServiceMsg = (NearbyAppInterface)paramajfb.mApp;
          if (paramInt == 10)
          {
            ...
            paramajfb.notifyUI(10, bool1, null);
          }
        }
      }
      label364:
  ...
  public static void e(ajfb paramajfb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    cmd0x682.RspBody localRspBody = new cmd0x682.RspBody();
    int i = ajfb.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    amvy.a("getShowLove", new Object[] { "handleGetShowLoveLimit result = " + i });
    int n;
    if ((i == 0) && (localRspBody.rpt_msg_chatinfo.has()) && (localRspBody.rpt_msg_chatinfo.size() > 0))
    {
      ...
      if ((paramajfb instanceof asft)) {
        paramajfb.notifyUI(9, true, new Object[] { Long.valueOf(l), Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramToServiceMsg, paramFromServiceMsg, paramObject });
      }
      if (QLog.isColorLevel()) {
      ...
      if (i1 == 1) {
        paramajfb.mApp.reportClickEvent("CliOper", "", "", "0X8005290", "0X8005290", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (n == 1)
      {
        paramajfb.mApp.reportClickEvent("CliOper", "", "", "0X8005291", "0X8005291", 0, 0, "", "", "", "");
        continue;
        paramajfb.notifyUI(paramInt, false, null);
      }
    }
