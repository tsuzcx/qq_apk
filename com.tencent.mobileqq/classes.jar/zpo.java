...
{
  public zpo(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (PhoneContactManagerImp.a(this.a) == null) {
      PhoneContactManagerImp.a(this.a, new zqg(this.a, null));
    }
  ...
  {
    if (PhoneContactManagerImp.a(this.a) == null) {
      QLog.e("PhoneContact.Manager", 1, "onQueryBindState app is null");
    }
    do
    {
      return;
    ...
    if (this.a.jdField_a_of_type_Boolean) {
      ThreadManager.getSubThreadHandler().post(new zpq(this));
    }
