...
public class amla
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new amlb(this, Looper.getMainLooper());
  ...
  public boolean a()
  {
    ...
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localamle);
      this.jdField_a_of_type_Int = localamle.a();
      this.jdField_a_of_type_JavaUtilArrayList = localamle.a();
      return true;
    }
