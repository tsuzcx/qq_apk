...
public class amla
{
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    ...
    azri.a(BaseApplication.getContext()).a(null, "actInvalidMessageRecord", false, 0L, 0L, localHashMap, "");
  }
  ...
  public static void a(String paramString)
  {
    if (!a)
    {
      ...
      azpo.a(new RuntimeException(), paramString);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    {
      paramQQAppInterface = ((alto)paramQQAppInterface.getManager(51)).c(paramString);
