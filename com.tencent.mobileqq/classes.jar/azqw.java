  ...
  extends azpm
{
  ...
  private long a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "picSize==0,fix by pisSizeAvg");
        l1 = paramLong;
      }
    }
    return l1;
  ...
  private void a(int paramInt, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    if (paramInt == 1)
    {
      ...
      for (paramLong1 = 0L;; paramLong1 = this.A)
      {
        ...
        paramLong2 = this.z;
        paramLong1 = this.A;
        azqi.a("4gFlowPre", this.z, false);
        azqi.a("4gFlowWaste", this.A, paramBoolean);
        if (QLog.isColorLevel()) {
          azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "updateFlow", "networkType=" + paramInt + ", preFlowPre=" + l2 + " preFlowWaste=" + l1 + "flowPre=" + paramLong2 + ", flowWaste:" + paramLong1);
        }
        return;
        paramLong1 = this.z;
        break;
    ...
    for (paramLong1 = 0L;; paramLong1 = this.C)
    {
      ...
      paramLong2 = this.B;
      paramLong1 = this.C;
      azqi.a("xgFlowPre", this.B, false);
      azqi.a("xgFlowWaste", this.C, paramBoolean);
      break;
      paramLong1 = this.B;
      break label270;
      paramLong1 = this.B;
  ...
  {
    this.jdField_a_of_type_Azqq.a(paramInt1, paramInt2, paramMessageForPic.mNotPredownloadReason);
    paramMessageForPic.preDownState = 2;
    a(paramMessageForPic);
    if (paramInt1 == 0)
    {
      this.K += 1L;
      azqi.a("wifiHitCount", this.K, true);
      if (QLog.isColorLevel()) {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
      ...
      this.G += 1L;
      this.E -= paramLong;
      azqi.a("accFlowWasteTotal", this.E, false);
      azqi.a("xgHitCount", this.G, true);
    } while (!QLog.isColorLevel());
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ",uniseq:" + paramMessageForPic.uniseq);
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  private void b(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    if (this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (localPicPreDownloader != null)
      {
        ...
        this.jdField_a_of_type_Azqq.e(paramInt1, i1);
        this.jdField_a_of_type_Azqq.a(paramInt1, i1);
        this.jdField_a_of_type_Azqq.c(paramInt1, paramInt2);
      }
    }
    ...
    {
      this.L += 1L;
      azqi.a("wifiMissCount", this.L, true);
      azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ",wifiMissCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
    }
    label164:
    do
    {
      return;
      this.jdField_a_of_type_Azqq.a(paramMessageForPic.preDownNetworkType, paramMessageForPic.mNotPredownloadReason);
      ...
      this.H += 1L;
      azqi.a("xgMissCount", this.H, true);
    } while (!QLog.isColorLevel());
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ", xgMissCount:" + this.H + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void c(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ",uniseq:" + paramMessageForPic.uniseq);
  }
  
  private void d(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_Azqq.d(paramInt1, paramInt2);
    paramMessageForPic.preDownState = 6;
    a(paramMessageForPic);
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ", uniseq:" + paramMessageForPic.uniseq);
  }
  
  private void f()
  {
    this.z = azqi.a("4gFlowPre", this.r);
    this.A = azqi.a("4gFlowWaste", 0L);
    this.B = azqi.a("xgFlowPre", this.x);
    this.C = azqi.a("xgFlowWaste", 0L);
    this.K = azqi.a("wifiHitCount", this.K);
    this.L = azqi.a("wifiMissCount", this.L);
    this.M = azqi.a("wifiManualClickCount", this.M);
    this.J = azqi.a("wifiPreDownCount", this.J);
    this.G = azqi.a("xgHitCount", this.G);
    this.H = azqi.a("xgMissCount", this.H);
    this.I = azqi.a("xgManualClickCount", this.I);
    this.F = azqi.a("xgPreDownCount", this.F);
    this.D = azqi.a("accFlowPreTotal", this.D);
    this.E = azqi.a("accFlowWasteTotal", this.E);
    this.N = azqi.a("requestListOverLimitCount", this.N);
    if (QLog.isColorLevel()) {
  ...
  private void g()
  {
    Object localObject1 = azqi.a("flowCombination", "12000|600|20000|400|6000|300|20000|200");
    if (QLog.isColorLevel()) {
    ...
    else
    {
      ...
      this.t = azqi.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxPDFlow3G", 614400L);
      this.u = azqi.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxWFlow3G", 716800L);
      this.v = 0L;
      this.w = 0L;
      this.n = this.t;
      this.p = 0L;
      ...
      localObject1 = azqi.a("troopCombination", "20|10|50|10");
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaLangLong = Long.valueOf(azqi.a("maxRequest", 100L));
      this.h = azqi.a("xGPreDownPolicy", 1374942199L);
      this.i = azqi.a("AFBFlowHitXG", 150L);
      this.j = azqi.a("AFBFlowMissXG", 40960L);
      this.k = this.j;
      this.l = azqi.a("APicAvgSize", 71680L);
      this.m = azqi.a("APicMaxSize", 204800L);
      this.jdField_b_of_type_Boolean = azqi.a("enablePeakFlow", Boolean.valueOf(false)).booleanValue();
      this.jdField_a_of_type_ArrayOfLong = azqi.a();
      this.S = azqi.a("PeakFlowMaxPicSize", 921600L);
      if (QLog.isColorLevel())
      {
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    if (azpr.a(null, paramBoolean, paramInt3))
    {
      if (paramInt2 == 0) {}
      for (paramBoolean = true; this.jdField_a_of_type_Azpr.a(paramBoolean, paramLong); paramBoolean = false) {
        return -11;
      }
      return 2;
    }
    ...
    boolean bool = a();
    if (QLog.isColorLevel()) {
      azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "NetworkType:" + paramInt2 + " isInDPCWhiteList:" + bool);
    }
    if (paramInt2 == 0)
    {
      paramInt1 = paramInt3;
      if (QLog.isColorLevel())
      {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "Wifi, result=" + 0);
        paramInt1 = paramInt3;
      }
    }
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "InDPCWhiteList, result=" + 0);
        paramInt1 = paramInt3;
      }
    }
    long l3 = a(paramLong);
    ...
    {
      if (QLog.isColorLevel()) {
        azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit", "result:" + paramInt3 + ",FlowWaste +picSize=" + (l2 + l3) + ",FlowWasteLimit：" + paramLong + ",FlowPre:" + l1 + ",picSize:" + l3 + ",FlowWaste:" + l2 + ",uinType:" + paramInt1 + ",networkType:" + paramInt2 + ",isDynamic:" + paramBoolean);
      }
      paramInt1 = paramInt3;
      break;
      paramLong = this.u;
  ...
  public HashMap<String, String> a()
  {
    ...
    long l1 = azqi.a("4gFlowPre", this.z);
    long l2 = azqi.a("4gFlowWaste", this.A);
    long l3 = azqi.a("xgFlowPre", this.B);
    long l4 = azqi.a("xgFlowWaste", this.C);
    long l5 = azqi.a("accFlowPreTotal", this.D);
    long l6 = azqi.a("xgPreDownCount", this.F);
    long l7 = azqi.a("xgHitCount", this.G);
    long l8 = azqi.a("xgMissCount", this.H);
    long l9 = azqi.a("wifiPreDownCount", this.J);
    long l10 = azqi.a("wifiHitCount", this.K);
    long l11 = azqi.a("wifiMissCount", this.L);
    long l12 = azqi.a("xgManualClickCount", this.I);
    long l13 = azqi.a("wifiManualClickCount", this.M);
    long l14 = azqi.a("requestListOverLimitCount", this.N);
    if (QLog.isColorLevel()) {
      azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "getReportInfo", "\n|- sp4gFlowPre:" + l1 + "\n|- sp4gFlowWaste:" + l2 + "\n|- spXgFlowPre:" + l3 + "\n|-  spXgFlowWaste：" + l4 + "\n|-  spFlowPreTotal:" + l5 + "\n|-  spXgPreDownCount：" + l6 + "\n|-  spXgHitCount:" + l7 + "\n|-  spXgMissCount：" + l8 + "\n|-  spWifiPreDownCount:" + l9 + "\n|-  spWifiHitCount：" + l10 + "\n|-  spWifiMissCount:" + l11 + "\n|-  spXgManulClickCount：" + l12 + "\n|-  spWifiManulClickCount:" + l13 + "\n|-  spRequestOverLimitCount:" + l14);
    }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      this.J += 1L;
      azqi.a("wifiPreDownCount", this.J, true);
    }
    do
    {
      return;
      ...
      this.E += paramLong;
      this.F += 1L;
      azqi.a("accFlowPreTotal", this.D, false);
      azqi.a("accFlowWasteTotal", this.E, false);
      azqi.a("xgPreDownCount", this.F, true);
    } while (!QLog.isColorLevel());
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "networkType:" + paramInt + ",wifiPreDownCount:" + this.J + ",xgPreDownCount:" + this.F);
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Azqq = ((azqq)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(73));
    this.jdField_a_of_type_Aolk = ((aolk)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().getCache(3));
    this.jdField_a_of_type_Azpr = new azpr();
    g();
    f();
    long l1 = System.currentTimeMillis();
    if (l1 - azqi.a("lastDayTime", 0L) > 86400000L)
    {
      String str = paramQQAppInterface.getCurrentAccountUin();
      azqi.a("lastDayTime", l1, true);
      azqj.a(str, a());
      e();
      ((azqq)paramQQAppInterface.getManager(73)).a();
    }
    if (QLog.isColorLevel()) {
      azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "init", "");
    }
  }
  
  public void a(MessageForPic paramMessageForPic)
  {
    azqi.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic);
  }
  ...
  public void a(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    do
    {
      ...
      this.E -= paramLong;
      azqi.a("accFlowPreTotal", this.D, false);
      azqi.a("accFlowWasteTotal", this.E, true);
    } while (!QLog.isColorLevel());
    azpw.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "fixPicSizeAfter", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      return;
      localTroopStatisticsInfo = this.jdField_a_of_type_Aolk.a(paramString);
    ...
    {
      this.jdField_a_of_type_Aolk.addCache(paramString);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    if (azqi.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin) != 0) {}
    label346:
    for (;;)
    {
      return true;
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      QLog.d("PIC_TAG_PRELOAD_TROOP", 2, "DPC has not been initialized");
      return true;
      paramString = this.jdField_a_of_type_Aolk.a(paramString);
  ...
  public boolean[] a(int paramInt1, int paramInt2)
  {
    ...
    if ((a()) && (paramInt2 != 3))
    {
      i2 = azqi.a(0, paramInt1, 0);
      i1 = azqi.a(0, paramInt1, 1);
      if ((this.h >> i2 & 1L) != 1L) {
        break label172;
      }
      bool1 = true;
    ...
    {
      if (QLog.isColorLevel()) {
        azpw.a("PIC_TAG_PRELOAD", "isPreDownload", "netWorkType:" + paramInt2 + ",uinType:" + paramInt1 + ",preDownThumb:" + bool1 + ",preDownBig:" + bool2 + ",xGPreDownPolicy:" + this.h);
      }
      return new boolean[] { bool1, bool2 };
      i2 = azqi.a(paramInt2, paramInt1, 0);
      i1 = azqi.a(paramInt2, paramInt1, 1);
      break;
      bool1 = false;
      break label44;
    }
  ...
  {
    if (this.jdField_a_of_type_Azqq == null) {}
    int i1;
    do
    {
      do
      {
        return;
      } while ((paramMessageForPic.isSendFromLocal()) || (paramMessageForPic.subVersion < 5) || (azpr.a(paramMessageForPic)));
      i1 = azqi.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin);
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Aolk == null);
      if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("PIC_TAG_PRELOAD_TROOP", 2, "DPC has not been initialized");
    return;
    TroopStatisticsInfo localTroopStatisticsInfo = this.jdField_a_of_type_Aolk.a(paramString);
    long l1;
    if (localTroopStatisticsInfo != null)
    {
    ...
    for (paramString = localTroopStatisticsInfo;; paramString = localTroopStatisticsInfo)
    {
      this.jdField_a_of_type_Aolk.updateCache(paramString);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void e()
  {
    ...
    this.I = 0L;
    this.F = 0L;
    azqi.a("requestListOverLimitCount", this.N, false);
    azqi.a("wifiHitCount", this.K, false);
    azqi.a("wifiMissCount", this.L, false);
    azqi.a("wifiManualClickCount", this.M, false);
    azqi.a("wifiPreDownCount", this.J, false);
    azqi.a("4gFlowWaste", this.A, false);
    azqi.a("xgFlowWaste", this.C, false);
    azqi.a("xgHitCount", this.G, false);
    azqi.a("xgMissCount", this.H, false);
    azqi.a("xgManualClickCount", this.I, false);
    azqi.a("xgPreDownCount", this.F, true);
  }
}
