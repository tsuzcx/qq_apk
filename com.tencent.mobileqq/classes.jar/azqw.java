...
public class azqw
{
  ...
  private static void a(azqq paramazqq)
  {
    boolean bool = a(paramazqq.jdField_a_of_type_JavaLangCharSequence);
    if (((paramazqq.jdField_b_of_type_Boolean) && (paramazqq.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramazqq.jdField_c_of_type_Int = 0;
      return;
    }
    paramazqq.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<azqq> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new azqx());
    ...
    azqq localazqq = new azqq();
    localazqq.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localazqq.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localazqq.jdField_e_of_type_Int = 2;
      localazqq.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localazqq.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localazqq.jdField_b_of_type_Boolean = true;
        localazqq.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localazqq.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localazqq.jdField_b_of_type_Boolean = true;
        if (localazqq.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localazqq.jdField_a_of_type_Float = (m * paramFloat);
            localazqq.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localazqq.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localazqq.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localazqq.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localazqq);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localazqq.d = true;
            localazqq.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localazqq.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (azqq)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (azqq)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new azqq();
                ((azqq)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((azqq)localObject2).jdField_c_of_type_Boolean = true;
                ((azqq)localObject2).jdField_b_of_type_Boolean = false;
                ((azqq)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((azqq)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
