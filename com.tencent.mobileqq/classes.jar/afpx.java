...
{
  public afpx(SubLoginActivity paramSubLoginActivity) {}
  ...
  public void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      this.a.e();
      this.a.b(this.a.getString(2131718449));
    ...
    for (;;)
    {
      ...
      if (!SubLoginActivity.a(this.a))
      {
        ...
        bdwt.a(this.a.app, (byte)1, paramString2);
        bdwt.a(this.a.app, paramString2, 7);
        bdws.b(this.a.app);
        bdws.a(this.a.app);
        this.a.setTitle("");
        bdws.a(this.a.app, this.a, paramString2);
        this.a.finish();
      }
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString2, "");
      ...
      try
      {
        ...
        {
          this.a.b(this.a.getString(2131693963));
          return;
      ...
      catch (Exception paramString1)
      {
        ...
        bdll.a(this.a.app, "dc00898", "", "", "0X800B296", "0X800B296", 0, 0, "", "", paramString4, "");
        this.a.b(this.a.getResources().getString(2131717567), paramString4, null);
      }
    }
  }
  ...
  public void onLoginTimeout(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1.put("fail_location", "subLogin");
    bdmc.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString1, "");
    if (!this.a.getActivity().isFinishing()) {}
    try
    {
      this.a.e();
