  ...
  extends ainp
{
  ...
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new ainx(this);
  private Button b;
  
  public ainw(aini paramaini, QQAppInterface paramQQAppInterface, SharedPreferences paramSharedPreferences)
  {
  ...
  private void e()
  {
    if (a().a())
    {
      aioe.a("0X800A1D8", 2, 0);
      return;
    }
    aioe.a("0X800A1D8", 1, 0);
  }
  ...
  private void f()
  {
    if (a().a())
    {
      aioe.a("0X800A1D9", 2, 0);
      return;
    }
    aioe.a("0X800A1D9", 1, 0);
  }
  
  private void g()
  {
    if (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null)) {
      this.b.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167059));
    }
  }
  ...
  {
    b(false);
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131718523);
  }
  
  public void a(VoiceTextPanel paramVoiceTextPanel)
  {
    super.a(paramVoiceTextPanel);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramVoiceTextPanel.findViewById(2131377339));
    this.b = ((Button)paramVoiceTextPanel.findViewById(2131364250));
    this.b.setOnClickListener(new ainy(this));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new ainz(this));
    this.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramVoiceTextPanel.findViewById(2131364612));
  ...
  public void c()
  {
    ...
    if (bool)
    {
      ...
      a().c(true);
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131718525);
      a(true);
      return;
    }
