  ...
  extends amgf
{
  ...
  public alxj(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562851, paramViewGroup, false);
      localalxk = new alxk(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
      paramView.setTag(localalxk);
      localalxk.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376837));
      localalxk.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379987));
      localalxk.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131364612));
      localalxk.c = ((ImageView)paramView.findViewById(2131368381));
      localalxk.b = ((TextView)paramView.findViewById(2131371803));
    }
    for (;;)
    {
      localalxk = (alxk)paramView.getTag();
      Object localObject;
      if (i < 0)
      {
        i = -(i + 1) - 1;
        ...
        {
          localalxk.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
          localalxk.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          localalxk.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          localalxk.c.setImageBitmap(a(((Friends)localObject).uin));
          localalxk.b.setText(((Friends)localObject).getFriendNick());
          localalxk.jdField_a_of_type_JavaLangString = ((Friends)localObject).uin;
          ...
          localalxk.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          label309:
          if ((AppSetting.c) && (localalxk.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            if (!localalxk.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
              break label416;
            }
            paramView.setContentDescription(((Friends)localObject).getFriendNick() + anvx.a(2131704349));
          }
          label368:
      ...
      for (;;)
      {
        ...
        return paramView;
        localalxk.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break;
        label404:
        localalxk.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
        break label309;
        label416:
        paramView.setContentDescription(((Friends)localObject).getFriendNick() + anvx.a(2131704352));
        break label368;
        localalxk.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        localalxk.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
        localalxk.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        localalxk.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691767), new Object[] { ((String)localObject).toLowerCase() }));
      }
    }
  }
}
